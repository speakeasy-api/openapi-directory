...
class ComputeHttpHealthChecksUpdateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\HttpHealthCheck1 $httpHealthCheck1 = null;
