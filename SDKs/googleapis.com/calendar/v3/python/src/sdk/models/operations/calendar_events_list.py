...
class CalendarEventsListQueryParams:
    ...
    order_by: Optional[CalendarEventsListOrderByEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'orderBy', 'style': 'form', 'explode': True }})
...
class CalendarEventsListSecurity:
    option1: Optional[CalendarEventsListSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CalendarEventsListSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[CalendarEventsListSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[CalendarEventsListSecurityOption4] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class CalendarEventsListRequest:
    path_params: CalendarEventsListPathParams = dataclasses.field()
    query_params: CalendarEventsListQueryParams = dataclasses.field()
    security: CalendarEventsListSecurity = dataclasses.field()
