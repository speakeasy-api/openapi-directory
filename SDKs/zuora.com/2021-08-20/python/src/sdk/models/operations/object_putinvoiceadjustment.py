...
from ..shared import proxymodifyinvoiceadjustment as shared_proxymodifyinvoiceadjustment
...
class ObjectPUTInvoiceAdjustmentRequest:
    ...
    r"""Object id"""  
    proxy_modify_invoice_adjustment: shared_proxymodifyinvoiceadjustment.ProxyModifyInvoiceAdjustment = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
