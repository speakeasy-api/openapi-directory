 ...
 */
export class DescribeReservedInstancesOfferingsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
 ...
 */
export enum DescribeReservedInstancesOfferingsRequestInstanceTenancyEnum {
  Default = "default",
  Dedicated = "dedicated",
  Host = "host",
}
 ...
 */
export enum DescribeReservedInstancesOfferingsRequestOfferingTypeEnum {
 ...
 */
export class DescribeReservedInstancesOfferingsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
