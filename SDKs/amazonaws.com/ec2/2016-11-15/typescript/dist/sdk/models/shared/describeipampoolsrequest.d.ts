 ...
 */
export declare class DescribeIpamPoolsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeIpamPoolsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeIpamPoolsRequestFilters[];
    ipamPoolIds?: string[];
    maxResults?: number;
    nextToken?: string;
}
