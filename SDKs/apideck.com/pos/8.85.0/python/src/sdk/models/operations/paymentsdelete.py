...
from ..shared import deletepospaymentresponse as shared_deletepospaymentresponse
...
class PaymentsDeleteRequest:
    headers: PaymentsDeleteHeaders = dataclasses.field()
    path_params: PaymentsDeletePathParams = dataclasses.field()
    query_params: PaymentsDeleteQueryParams = dataclasses.field()
    security: PaymentsDeleteSecurity = dataclasses.field()
...
class PaymentsDeleteResponse:
    ...
    delete_pos_payment_response: Optional[shared_deletepospaymentresponse.DeletePosPaymentResponse] = dataclasses.field(default=None)
