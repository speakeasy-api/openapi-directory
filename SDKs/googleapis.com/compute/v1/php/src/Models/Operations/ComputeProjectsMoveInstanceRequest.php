...
class ComputeProjectsMoveInstanceRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\InstanceMoveRequest $instanceMoveRequest = null;
