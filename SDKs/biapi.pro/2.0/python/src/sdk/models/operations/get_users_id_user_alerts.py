...
class GetUsersIDUserAlertsRequest:
...
class GetUsersIDUserAlerts200ApplicationJSON:
    ...
    alerts: list[shared_alert.Alert] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('alerts') }})  
...
@dataclasses.dataclass
class GetUsersIDUserAlertsResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    get_users_id_user_alerts_200_application_json_object: Optional[GetUsersIDUserAlerts200ApplicationJSON] = dataclasses.field(default=None)
    r"""alerts"""  
