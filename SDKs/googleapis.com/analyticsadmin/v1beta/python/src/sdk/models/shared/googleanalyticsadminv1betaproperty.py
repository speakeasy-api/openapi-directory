...
class GoogleAnalyticsAdminV1betaPropertyIndustryCategoryEnum(str, Enum):
...
class GoogleAnalyticsAdminV1betaPropertyPropertyTypeEnum(str, Enum):
...
class GoogleAnalyticsAdminV1betaPropertyServiceLevelEnum(str, Enum):
...
class GoogleAnalyticsAdminV1betaProperty:
    r"""GoogleAnalyticsAdminV1betaProperty
    ...
    industry_category: Optional[GoogleAnalyticsAdminV1betaPropertyIndustryCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('industryCategory') }})
    ...
    property_type: Optional[GoogleAnalyticsAdminV1betaPropertyPropertyTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('propertyType') }})
    service_level: Optional[GoogleAnalyticsAdminV1betaPropertyServiceLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('serviceLevel') }})
...
class GoogleAnalyticsAdminV1betaPropertyInput:
    r"""GoogleAnalyticsAdminV1betaPropertyInput
    A resource message representing a Google Analytics GA4 property.
    """
