...
func (e GoogleCloudDialogflowCxV3beta1TestCaseResultTestResultEnum) ToPointer() *GoogleCloudDialogflowCxV3beta1TestCaseResultTestResultEnum {
	return &e
}
...
func (e *GoogleCloudDialogflowCxV3beta1TestCaseResultTestResultEnum) UnmarshalJSON(data []byte) error {
	...
	case "PASSED":
		fallthrough
	case "FAILED":
		*e = GoogleCloudDialogflowCxV3beta1TestCaseResultTestResultEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudDialogflowCxV3beta1TestCaseResultTestResultEnum: %v", v)
	}
}
