...
class SyncV1ServiceSyncStream:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Sync Stream resource."""  
    ...
    r"""The identity of the Stream's creator. If the Stream is created from the client SDK, the value matches the Access Token's `identity` field. If the Stream was created from the REST API, the value is 'system'."""  
    ...
    r"""The date and time in GMT when the Message Stream expires and will be deleted, specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. If the Message Stream does not expire, this value is `null`. The Stream might not be deleted immediately after it expires."""  
    ...
    r"""The URLs of the Stream's nested resources."""  
    ...
    r"""The unique string that we created to identify the Sync Stream resource."""  
    ...
    r"""The absolute URL of the Message Stream resource."""  
