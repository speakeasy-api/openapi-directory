...
from ..shared import plantingactivities as shared_plantingactivities
...
class GetV4LayersAsPlantedResponse:
    ...
    planting_activities: Optional[shared_plantingactivities.PlantingActivities] = dataclasses.field(default=None)
    r"""OK"""  
