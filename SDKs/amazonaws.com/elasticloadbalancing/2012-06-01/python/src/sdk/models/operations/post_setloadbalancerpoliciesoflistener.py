...
class PostSetLoadBalancerPoliciesOfListenerQueryParams:
    action: PostSetLoadBalancerPoliciesOfListenerActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostSetLoadBalancerPoliciesOfListenerVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostSetLoadBalancerPoliciesOfListenerRequest:
    headers: PostSetLoadBalancerPoliciesOfListenerHeaders = dataclasses.field()
    query_params: PostSetLoadBalancerPoliciesOfListenerQueryParams = dataclasses.field()
