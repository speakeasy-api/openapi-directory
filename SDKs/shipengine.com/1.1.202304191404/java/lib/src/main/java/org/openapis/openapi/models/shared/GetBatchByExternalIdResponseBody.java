...
public class GetBatchByExternalIdResponseBody {
    ...
    public GetBatchByExternalIdResponseBody(@JsonProperty("batch_errors_url") GetBatchByExternalIdResponseBodyOptionalLink batchErrorsUrl, @JsonProperty("batch_id") String batchId, @JsonProperty("batch_labels_url") OptionalLink batchLabelsUrl, @JsonProperty("batch_notes") String batchNotes, @JsonProperty("batch_number") String batchNumber, @JsonProperty("batch_shipments_url") OptionalLink batchShipmentsUrl, @JsonProperty("completed") Integer completed, @JsonProperty("count") Integer count, @JsonProperty("created_at") OffsetDateTime createdAt, @JsonProperty("errors") Integer errors, @JsonProperty("external_batch_id") String externalBatchId, @JsonProperty("form_download") GetBatchByExternalIdResponseBodyOptionalLink formDownload, @JsonProperty("forms") Integer forms, @JsonProperty("label_download") GetBatchByExternalIdResponseBodyLabelDownload labelDownload, @JsonProperty("label_format") GetBatchByExternalIdResponseBodyLabelFormatEnum labelFormat, @JsonProperty("label_layout") GetBatchByExternalIdResponseBodyLabelLayoutEnum labelLayout, @JsonProperty("processed_at") OffsetDateTime processedAt, @JsonProperty("status") GetBatchByExternalIdResponseBodyBatchStatusEnum status, @JsonProperty("warnings") Integer warnings) {
        this.batchErrorsUrl = batchErrorsUrl;
        this.batchId = batchId;
        this.batchLabelsUrl = batchLabelsUrl;
        this.batchNotes = batchNotes;
