...
public class ConfirmPaymentOfTransaction1RequestBody {
    ...
    public ConfirmPaymentOfTransaction1RequestBody(@JsonProperty("confirmTransaction") String confirmTransaction, @JsonProperty("transaction_id") String transactionId) {
        this.confirmTransaction = confirmTransaction;
        this.transactionId = transactionId;
  }
}
