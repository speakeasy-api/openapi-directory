...
export class SDK {
  ...
  getClip(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetClipResponse = new operations.GetClipResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getClipOutput = utils.objectToClass(
              httpRes?.data,
              shared.GetClipOutput
            );
          }
          break;
  ...
  getDASHStreamingSessionURL(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/getDASHStreamingSessionURL";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetDASHStreamingSessionURLResponse =
        new operations.GetDASHStreamingSessionURLResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getDASHStreamingSessionURLOutput = utils.objectToClass(
              httpRes?.data,
              shared.GetDASHStreamingSessionURLOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  getHLSStreamingSessionURL(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/getHLSStreamingSessionURL";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetHLSStreamingSessionURLResponse =
        new operations.GetHLSStreamingSessionURLResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getHLSStreamingSessionURLOutput = utils.objectToClass(
              httpRes?.data,
              shared.GetHLSStreamingSessionURLOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  getImages(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/getImages";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getImagesOutput = utils.objectToClass(
              httpRes?.data,
              shared.GetImagesOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  getMediaForFragmentList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetMediaForFragmentListResponse =
        new operations.GetMediaForFragmentListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getMediaForFragmentListOutput = utils.objectToClass(
              httpRes?.data,
              shared.GetMediaForFragmentListOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  listFragments(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListFragmentsResponse =
        new operations.ListFragmentsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listFragmentsOutput = utils.objectToClass(
              httpRes?.data,
              shared.ListFragmentsOutput
            );
          }
          break;
        case httpRes?.status == 480:
