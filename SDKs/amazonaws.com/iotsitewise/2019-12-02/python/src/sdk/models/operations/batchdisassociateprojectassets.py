...
class BatchDisassociateProjectAssetsRequestBody:
    ...
    r"""The IDs of the assets to be disassociated from the project."""  
...
class BatchDisassociateProjectAssetsRequest:
    ...
    r"""The ID of the project from which to disassociate the assets."""  
    request_body: BatchDisassociateProjectAssetsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
