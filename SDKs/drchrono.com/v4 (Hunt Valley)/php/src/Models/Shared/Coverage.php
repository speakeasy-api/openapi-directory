...
class Coverage
{
     ...
     * @var ?string $cobLevel
     */
	#[\JMS\Serializer\Annotation\SerializedName('cob_level')]
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $cobLevel = null;
     ...
     * 
     * @var ?string $coverageDetails
     */
	#[\JMS\Serializer\Annotation\SerializedName('coverage_details')]
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $coverageDetails = null;
    
    /**
     * A variable size object containing subscriber information, if returned by the clearinghouse that ran the eligibility check
     * 
     * @var ?string $coverageSubscriber
     */
	#[\JMS\Serializer\Annotation\SerializedName('coverage_subscriber')]
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $coverageSubscriber = null;
     ...
     */
	#[\JMS\Serializer\Annotation\SerializedName('query_date')]
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CoverageRequestServiceTypeEnum $requestServiceType
     */
	#[\JMS\Serializer\Annotation\SerializedName('request_service_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CoverageRequestServiceTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CoverageRequestServiceTypeEnum $requestServiceType = null;
    
	#[\JMS\Serializer\Annotation\SerializedName('service_type_description')]
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $serviceTypeDescription = null;
	...
	public function __construct()
	{
		...
		$this->coverageSubscriber = null;
		$this->eligibility = null;
		$this->patient = null;
		$this->payerName = null;
		$this->queryDate = null;
		$this->requestServiceType = null;
