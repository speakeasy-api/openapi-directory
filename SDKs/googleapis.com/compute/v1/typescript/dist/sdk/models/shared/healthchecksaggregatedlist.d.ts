...
import { HealthChecksScopedList } from "./healthchecksscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum HealthChecksAggregatedListWarningCodeEnum {
...
export declare class HealthChecksAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class HealthChecksAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: HealthChecksAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: HealthChecksAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class HealthChecksAggregatedList extends SpeakeasyBase {
    /**
