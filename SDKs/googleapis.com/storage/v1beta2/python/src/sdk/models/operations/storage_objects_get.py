...
class StorageObjectsGetRequest:
    path_params: StorageObjectsGetPathParams = dataclasses.field()
    query_params: StorageObjectsGetQueryParams = dataclasses.field()
    security: StorageObjectsGetSecurity = dataclasses.field()
