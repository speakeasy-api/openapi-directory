...
type POSTPaymentMethodRequestAccountHolderInfo struct {
...
// POSTPaymentMethodRequestBankAccountTypeEnum - The type of bank account associated with the ACH payment. This field is only required if the `type` field is set to `ACH`.
type POSTPaymentMethodRequestBankAccountTypeEnum string

const (
	POSTPaymentMethodRequestBankAccountTypeEnumBusinessChecking POSTPaymentMethodRequestBankAccountTypeEnum = "BusinessChecking"
	POSTPaymentMethodRequestBankAccountTypeEnumChecking         POSTPaymentMethodRequestBankAccountTypeEnum = "Checking"
	POSTPaymentMethodRequestBankAccountTypeEnumSaving           POSTPaymentMethodRequestBankAccountTypeEnum = "Saving"
)

func (e *POSTPaymentMethodRequestBankAccountTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Checking":
		fallthrough
	case "Saving":
		*e = POSTPaymentMethodRequestBankAccountTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTPaymentMethodRequestBankAccountTypeEnum: %s", s)
	}
}

// POSTPaymentMethodRequestMitConsentAgreementSrcEnum - Required if you set the `mitProfileAction` field.
type POSTPaymentMethodRequestMitConsentAgreementSrcEnum string

const (
	POSTPaymentMethodRequestMitConsentAgreementSrcEnumExternal POSTPaymentMethodRequestMitConsentAgreementSrcEnum = "External"
)

func (e *POSTPaymentMethodRequestMitConsentAgreementSrcEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	switch s {
	case "External":
		*e = POSTPaymentMethodRequestMitConsentAgreementSrcEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTPaymentMethodRequestMitConsentAgreementSrcEnum: %s", s)
	}
}

// POSTPaymentMethodRequestMitProfileActionEnum - If you set this field, Zuora creates a stored credential profile within the payment method.
//
...
type POSTPaymentMethodRequestMitProfileActionEnum string

const (
	POSTPaymentMethodRequestMitProfileActionEnumActivate POSTPaymentMethodRequestMitProfileActionEnum = "Activate"
	POSTPaymentMethodRequestMitProfileActionEnumPersist  POSTPaymentMethodRequestMitProfileActionEnum = "Persist"
)

func (e *POSTPaymentMethodRequestMitProfileActionEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Activate":
		fallthrough
	case "Persist":
		*e = POSTPaymentMethodRequestMitProfileActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTPaymentMethodRequestMitProfileActionEnum: %s", s)
	}
}
...
type POSTPaymentMethodRequestMitProfileTypeEnum string

const (
	POSTPaymentMethodRequestMitProfileTypeEnumRecurring   POSTPaymentMethodRequestMitProfileTypeEnum = "Recurring"
	POSTPaymentMethodRequestMitProfileTypeEnumUnscheduled POSTPaymentMethodRequestMitProfileTypeEnum = "Unscheduled"
)

func (e *POSTPaymentMethodRequestMitProfileTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Recurring":
		fallthrough
	case "Unscheduled":
		*e = POSTPaymentMethodRequestMitProfileTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTPaymentMethodRequestMitProfileTypeEnum: %s", s)
	}
}
...
type POSTPaymentMethodRequest struct {
	...
	AccountHolderInfo *POSTPaymentMethodRequestAccountHolderInfo `json:"accountHolderInfo,omitempty"`
	...
	//
	BankAccountType *POSTPaymentMethodRequestBankAccountTypeEnum `json:"bankAccountType,omitempty"`
	...
	//
	MitConsentAgreementSrc *POSTPaymentMethodRequestMitConsentAgreementSrcEnum `json:"mitConsentAgreementSrc,omitempty"`
	...
	// * `Persist` - Use this value if the stored credential profile represents a stored credential profile in an external system. The status of the payment method's stored credential profile will be `Active`.
	//
	MitProfileAction *POSTPaymentMethodRequestMitProfileActionEnum `json:"mitProfileAction,omitempty"`
	...
	//
	MitProfileType *POSTPaymentMethodRequestMitProfileTypeEnum `json:"mitProfileType,omitempty"`
