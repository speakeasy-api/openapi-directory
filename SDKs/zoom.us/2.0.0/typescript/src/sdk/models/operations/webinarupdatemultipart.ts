...
export class WebinarUpdateMultipartSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum WebinarUpdateMultipartFormDataRecurrenceMonthlyWeekEnum {
  Minus1 = "-1",
  One = "1",
  Two = "2",
  Three = "3",
 ...
 */
export enum WebinarUpdateMultipartFormDataRecurrenceMonthlyWeekDayEnum {
  One = "1",
  Two = "2",
  Three = "3",
  Four = "4",
 ...
 */
export enum WebinarUpdateMultipartFormDataRecurrenceTypeEnum {
  One = "1",
  Two = "2",
  Three = "3",
}
 ...
 */
export enum WebinarUpdateMultipartFormDataTypeEnum1 {
  Five = "5",
  Six = "6",
  Nine = "9",
}
 ...
 */
export class WebinarUpdateMultipartFormData3 extends SpeakeasyBase {
  /**
   * Webinar description.
   */
...
export class WebinarUpdateMultipartRequest extends SpeakeasyBase {
  /**
   * Webinar.
   */
...
export class WebinarUpdateMultipartResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
