...
public class GetPostsQueryParams {
    ...
    public GetPostsQueryParams withDateMax(OffsetDateTime dateMax) {
    ...
    public GetPostsQueryParams withDateMin(OffsetDateTime dateMin) {
    ...
    public GetPostsQueryParams withDevicePixelRatio(Double devicePixelRatio) {
    ...
    public GetPostsQueryParams withGroupIds(String groupIds) {
    ...
    public GetPostsQueryParams withIncludeReposts(Long includeReposts) {
    ...
    public GetPostsQueryParams withLatitude(Double latitude) {
    ...
    public GetPostsQueryParams withLongitude(Double longitude) {
    ...
    public GetPostsQueryParams withOutcomes(String outcomes) {
    ...
    public Long perPage;
    public GetPostsQueryParams withPerPage(Long perPage) {
    ...
    public GetPostsQueryParams withRadius(Double radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetPostsQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetPostsQueryParams withSources(String sources) {
    ...
    public String types;
    public GetPostsQueryParams withTypes(String types) {
        this.types = types;
        return this;
    }
    ...
    public GetPostsQueryParams withUserState(String userState) {
