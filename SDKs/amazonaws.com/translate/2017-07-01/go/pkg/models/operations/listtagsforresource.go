...
const (
	ListTagsForResourceXAmzTargetEnumAwsShineFrontendService20170701ListTagsForResource ListTagsForResourceXAmzTargetEnum = "AWSShineFrontendService_20170701.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "AWSShineFrontendService_20170701.ListTagsForResource":
