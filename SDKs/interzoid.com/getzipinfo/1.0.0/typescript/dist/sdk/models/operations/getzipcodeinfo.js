...
exports.GetzipcodeinfoResponse = exports.GetzipcodeinfoRequest = exports.Getzipcodeinfo200ApplicationJson = exports.GetzipcodeinfoQueryParams = void 0;
...
exports.GetzipcodeinfoQueryParams = GetzipcodeinfoQueryParams;
var Getzipcodeinfo200ApplicationJson = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=AreaSquareMiles" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ElderlyHouseholdPercent" }),
        __metadata("design:type", String)
    ], Getzipcodeinfo200ApplicationJson.prototype, "elderlyHouseholdPercent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=FarmerHouseholdPercent" }),
        __metadata("design:type", String)
    ], Getzipcodeinfo200ApplicationJson.prototype, "farmerHouseholdPercent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=IncomePercent100k" }),
        __metadata("design:type", String)
    ], Getzipcodeinfo200ApplicationJson.prototype, "incomePercent100k", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=IncomePercent200k" }),
        __metadata("design:type", String)
    ], Getzipcodeinfo200ApplicationJson.prototype, "incomePercent200k", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=IncomePercent50k" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MarriedHouseholdPercent" }),
        __metadata("design:type", String)
    ], Getzipcodeinfo200ApplicationJson.prototype, "marriedHouseholdPercent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Population" }),
        __metadata("design:type", String)
