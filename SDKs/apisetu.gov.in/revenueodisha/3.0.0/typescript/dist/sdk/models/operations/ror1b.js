...
var Ror1bRequestBodyCertificateParameters = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=khatano" }),
        __metadata("design:type", String)
    ], Ror1bRequestBodyCertificateParameters.prototype, "khatano", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=level1" }),
        __metadata("design:type", String)
    ], Ror1bRequestBodyCertificateParameters.prototype, "level1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=level2" }),
        __metadata("design:type", String)
    ], Ror1bRequestBodyCertificateParameters.prototype, "level2", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=level3" }),
        __metadata("design:type", String)
