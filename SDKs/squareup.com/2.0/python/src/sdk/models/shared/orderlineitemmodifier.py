...
class OrderLineItemModifier:
    r"""A [CatalogModifier](https://developer.squareup.com/reference/square_2021-08-18/objects/CatalogModifier)."""
    ...
    r"""The version of the catalog object that this modifier references."""  
    ...
    r"""A unique ID that identifies the modifier only within this order."""  
