...
from ..shared import security as shared_security
from ..shared import liststepsresponse as shared_liststepsresponse
...
class ToolresultsProjectsHistoriesExecutionsStepsListRequest:
    path_params: ToolresultsProjectsHistoriesExecutionsStepsListPathParams = dataclasses.field()
    query_params: ToolresultsProjectsHistoriesExecutionsStepsListQueryParams = dataclasses.field()
    security: ToolresultsProjectsHistoriesExecutionsStepsListSecurity = dataclasses.field()
...
class ToolresultsProjectsHistoriesExecutionsStepsListResponse:
    ...
    list_steps_response: Optional[shared_liststepsresponse.ListStepsResponse] = dataclasses.field(default=None)
