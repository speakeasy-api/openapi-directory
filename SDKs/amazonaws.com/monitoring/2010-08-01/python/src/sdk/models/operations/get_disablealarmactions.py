...
class GetDisableAlarmActionsQueryParams:
    action: GetDisableAlarmActionsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    alarm_names: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'AlarmNames', 'style': 'form', 'explode': True }})
    version: GetDisableAlarmActionsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDisableAlarmActionsRequest:
    headers: GetDisableAlarmActionsHeaders = dataclasses.field()
    query_params: GetDisableAlarmActionsQueryParams = dataclasses.field()
