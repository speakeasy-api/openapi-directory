...
class ProjectsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ProjectsListOrderEnum $order
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=order')]
    public ?ProjectsListOrderEnum $order = null;
    
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=order_direction')]
    public ?ProjectsListOrderDirectionEnum $orderDirection = null;
