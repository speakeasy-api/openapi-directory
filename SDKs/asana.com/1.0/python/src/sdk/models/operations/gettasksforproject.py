...
class GetTasksForProjectRequest:
    ...
    r"""Only return tasks that are either incomplete or that have been completed since this time. Accepts a date-time string or the keyword *now*."""  
...
class GetTasksForProject200ApplicationJSON:
    r"""Successfully retrieved the requested project's tasks."""
