...
export class CloudassetResourcesSearchAllSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudassetResourcesSearchAllRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudassetResourcesSearchAllResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
