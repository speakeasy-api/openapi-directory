...
import { NodeTypesScopedList } from "./nodetypesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum NodeTypeAggregatedListWarningCodeEnum {
...
export declare class NodeTypeAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodeTypeAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: NodeTypeAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: NodeTypeAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class NodeTypeAggregatedList extends SpeakeasyBase {
    /**
