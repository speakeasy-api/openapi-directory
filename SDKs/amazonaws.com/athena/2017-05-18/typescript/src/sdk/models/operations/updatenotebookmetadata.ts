...
export enum UpdateNotebookMetadataXAmzTargetEnum {
  AmazonAthenaUpdateNotebookMetadata = "AmazonAthena.UpdateNotebookMetadata",
}

export class UpdateNotebookMetadataRequest extends SpeakeasyBase {
...
export class UpdateNotebookMetadataResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
