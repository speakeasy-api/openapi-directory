 ...
 */
export enum SubnetworksScopedListWarningCodeEnum {
...
export class SubnetworksScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SubnetworksScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: SubnetworksScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: SubnetworksScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => SubnetworksScopedListWarningData)
  data?: SubnetworksScopedListWarningData[];
...
export class SubnetworksScopedList extends SpeakeasyBase {
  /**
