 ...
 */
export class StageAccessLogSettings extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum StageDefaultRouteSettingsLoggingLevelEnum {
  Error = "ERROR",
  Info = "INFO",
  Off = "OFF",
}
 ...
 */
export class StageDefaultRouteSettings extends SpeakeasyBase {
  @SpeakeasyMetadata()
