...
class SDK:
    ...
    def create_assessments(self, request: operations.CreateAssessmentsRequest) -> operations.CreateAssessmentsResponse:
        ...
        base_url = operations.CREATE_ASSESSMENTS_SERVERS[0]
        if request.server_url is not None:
            base_url = request.server_url
        
        
        url = base_url.removesuffix("/") + "/v1/Accounts/Assessments"
        ...
        res = operations.CreateAssessmentsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1Assessments])
                res.flex_v1_assessments = out
