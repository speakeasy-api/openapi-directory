...
class ConversationsV1Conversation:
    ...
    state: Optional[shared_conversation_enum_state_enum.ConversationEnumStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})  
