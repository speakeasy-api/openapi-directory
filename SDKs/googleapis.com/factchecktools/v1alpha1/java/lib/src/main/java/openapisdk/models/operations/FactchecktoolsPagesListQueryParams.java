...
public class FactchecktoolsPagesListQueryParams {
    ...
    public FactchecktoolsPagesListQueryParams withDollarXgafv(openapisdk.models.shared.XgafvEnum dollarXgafv) {
    ...
    public FactchecktoolsPagesListQueryParams withAlt(openapisdk.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
