...
class AssociateMacSecKeyRequest:
    ...
    associate_mac_sec_key_request: shared_associatemacseckeyrequest.AssociateMacSecKeyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
