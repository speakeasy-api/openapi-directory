...
public class UserAuth {
     ...
     * 
    **/
    public openapisdk.models.operations.PostV05UsersAuthNotifyResponse postV05UsersAuthNotify(openapisdk.models.operations.PostV05UsersAuthNotifyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v0.5/users/auth/notify");
        ...
        openapisdk.models.operations.PostV05UsersAuthNotifyResponse res = new openapisdk.models.operations.PostV05UsersAuthNotifyResponse() {{
            errorResponse = null;
            body = null;
            errorResponse = null;
            body = null;
     ...
     * 
    **/
    public openapisdk.models.operations.PostV05UsersAuthOnConfirmResponse postV05UsersAuthOnConfirm(openapisdk.models.operations.PostV05UsersAuthOnConfirmRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.PostV05UsersAuthOnConfirmRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v0.5/users/auth/on-confirm");
        ...
        openapisdk.models.operations.PostV05UsersAuthOnConfirmResponse res = new openapisdk.models.operations.PostV05UsersAuthOnConfirmResponse() {{
            errorResponse = null;
            body = null;
            errorResponse = null;
            body = null;
     ...
     * 
    **/
    public openapisdk.models.operations.PostV05UsersAuthOnFetchModesResponse postV05UsersAuthOnFetchModes(openapisdk.models.operations.PostV05UsersAuthOnFetchModesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v0.5/users/auth/on-fetch-modes");
        ...
        openapisdk.models.operations.PostV05UsersAuthOnFetchModesResponse res = new openapisdk.models.operations.PostV05UsersAuthOnFetchModesResponse() {{
            errorResponse = null;
            errorResponse = null;
            body = null;
            errorResponse = null;
     ...
     * 
    **/
    public openapisdk.models.operations.PostV05UsersAuthOnInitResponse postV05UsersAuthOnInit(openapisdk.models.operations.PostV05UsersAuthOnInitRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.PostV05UsersAuthOnInitRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v0.5/users/auth/on-init");
        ...
        openapisdk.models.operations.PostV05UsersAuthOnInitResponse res = new openapisdk.models.operations.PostV05UsersAuthOnInitResponse() {{
            errorResponse = null;
            body = null;
            errorResponse = null;
            body = null;
