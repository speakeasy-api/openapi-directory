...
export class AdditionalRates {
  ...
  addOrUpdateAdditionalRates(
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.AddOrUpdateAdditionalRatesSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AddOrUpdateAdditionalRatesResponse =
        new operations.AddOrUpdateAdditionalRatesResponse({
