...
export class PostPortfolioOptimizationMaximumReturnSubsetResamplingBasedRequestBodyConstraints extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum PostPortfolioOptimizationMaximumReturnSubsetResamplingBasedRequestBodySubsetPortfoliosAggregationMethodEnum {
  Average = "average",
  Median = "median",
}
 ...
 */
export enum PostPortfolioOptimizationMaximumReturnSubsetResamplingBasedRequestBodySubsetPortfoliosEnumerationMethodEnum {
  Complete = "complete",
  RandomSampling = "randomSampling",
}

export class PostPortfolioOptimizationMaximumReturnSubsetResamplingBasedRequestBody extends SpeakeasyBase {
  /**
  ...
  @Type(
    () =>
      PostPortfolioOptimizationMaximumReturnSubsetResamplingBasedRequestBodyConstraints
  )
 ...
 * OK
 */
export class PostPortfolioOptimizationMaximumReturnSubsetResamplingBased200ApplicationJSON extends SpeakeasyBase {
  /**
...
export class PostPortfolioOptimizationMaximumReturnSubsetResamplingBasedResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
