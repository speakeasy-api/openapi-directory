...
from ..shared import updatemodifiergroupresponse as shared_updatemodifiergroupresponse
...
class ModifierGroupsUpdateRequest:
    headers: ModifierGroupsUpdateHeaders = dataclasses.field()
    path_params: ModifierGroupsUpdatePathParams = dataclasses.field()
    query_params: ModifierGroupsUpdateQueryParams = dataclasses.field()
    request: shared_modifiergroup.ModifierGroupInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: ModifierGroupsUpdateSecurity = dataclasses.field()
...
class ModifierGroupsUpdateResponse:
    ...
    update_modifier_group_response: Optional[shared_updatemodifiergroupresponse.UpdateModifierGroupResponse] = dataclasses.field(default=None)
