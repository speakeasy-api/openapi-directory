 ...
 */
public enum WebinarCreate201ApplicationJSONRecurrenceWebinarMonthlyWeekEnum {
    MINUS1("-1"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private WebinarCreate201ApplicationJSONRecurrenceWebinarMonthlyWeekEnum(String value) {
        this.value = value;
    }
}
