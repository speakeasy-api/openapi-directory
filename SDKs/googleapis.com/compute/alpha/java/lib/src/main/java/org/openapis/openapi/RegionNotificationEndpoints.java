...
public class RegionNotificationEndpoints {
     ...
     */
    public org.openapis.openapi.models.operations.ComputeRegionNotificationEndpointsAggregatedListResponse computeRegionNotificationEndpointsAggregatedList(org.openapis.openapi.models.operations.ComputeRegionNotificationEndpointsAggregatedListRequest request, org.openapis.openapi.models.operations.ComputeRegionNotificationEndpointsAggregatedListSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeRegionNotificationEndpointsAggregatedListRequest.class, baseUrl, "/projects/{project}/aggregated/notificationEndpoints", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeRegionNotificationEndpointsAggregatedListRequest.class, request, null);
        if (queryParams != null) {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeRegionNotificationEndpointsTestIamPermissionsResponse computeRegionNotificationEndpointsTestIamPermissions(org.openapis.openapi.models.operations.ComputeRegionNotificationEndpointsTestIamPermissionsRequest request, org.openapis.openapi.models.operations.ComputeRegionNotificationEndpointsTestIamPermissionsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeRegionNotificationEndpointsTestIamPermissionsRequest.class, baseUrl, "/projects/{project}/regions/{region}/notificationEndpoints/{resource}/testIamPermissions", request, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeRegionNotificationEndpointsTestIamPermissionsRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
