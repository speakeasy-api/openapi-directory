...
export class Users {
   ...
   */
  usersBlock(
    req: operations.UsersBlockRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UsersBlockResponse> {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersBlockResponse =
        new operations.UsersBlockResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
   ...
   */
  usersCheckBlocked(
    req: operations.UsersCheckBlockedRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UsersCheckBlockedResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersCheckBlockedResponse =
        new operations.UsersCheckBlockedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  usersListBlockedByAuthenticatedUser(
    req: operations.UsersListBlockedByAuthenticatedUserRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UsersListBlockedByAuthenticatedUserResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UsersListBlockedByAuthenticatedUserRequest(req);
    }

    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/user/blocks";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersListBlockedByAuthenticatedUserResponse =
        new operations.UsersListBlockedByAuthenticatedUserResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  usersSetPrimaryEmailVisibilityForAuthenticatedUser(
    req: operations.UsersSetPrimaryEmailVisibilityForAuthenticatedUserRequestBody,
    config?: AxiosRequestConfig
  ): Promise<operations.UsersSetPrimaryEmailVisibilityForAuthenticatedUserResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.UsersSetPrimaryEmailVisibilityForAuthenticatedUserRequestBody(
          req
        );
    }

    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/user/email/visibility";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersSetPrimaryEmailVisibilityForAuthenticatedUserResponse =
        new operations.UsersSetPrimaryEmailVisibilityForAuthenticatedUserResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
   ...
   */
  usersUnblock(
    req: operations.UsersUnblockRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UsersUnblockResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersUnblockResponse =
        new operations.UsersUnblockResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
