...
var Transactions = /** @class */ (function () {
    ...
    **/
    Transactions.prototype.getTransaction = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetTransactionRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/transactions/{id}", req.pathParams);
    ...
    **/
    Transactions.prototype.getTransactionCost = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetTransactionCostRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/transactions/{id}/cost", req.pathParams);
        var client = this._securityClient;
    ...
    **/
    Transactions.prototype.getTransactions = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/transactions";
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getTransactions200ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
