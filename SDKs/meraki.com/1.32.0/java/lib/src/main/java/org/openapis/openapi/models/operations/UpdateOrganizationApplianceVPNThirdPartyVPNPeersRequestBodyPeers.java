...
public class UpdateOrganizationApplianceVPNThirdPartyVPNPeersRequestBodyPeers {
    ...
    public UpdateOrganizationApplianceVPNThirdPartyVPNPeersRequestBodyPeers(@JsonProperty("name") String name, @JsonProperty("privateSubnets") String[] privateSubnets, @JsonProperty("secret") String secret) {
        this.name = name;
        this.privateSubnets = privateSubnets;
        this.secret = secret;
  }
