 ...
 * 
 */
enum DomainVerificationDetailCertificateAuthorityAuthorizationRecommendationsEnum: string
{
    case ADD_CA_TO_CAA = 'ADD_CA_TO_CAA';
    case CREATE_TARGET_DOMAIN_CAA = 'CREATE_TARGET_DOMAIN_CAA';
    case DISABLE_DNSSEC = 'DISABLE_DNSSEC';
    case FIX_CRITICAL_TAG = 'FIX_CRITICAL_TAG';
    case VALIDATE_SOA = 'VALIDATE_SOA';
}
