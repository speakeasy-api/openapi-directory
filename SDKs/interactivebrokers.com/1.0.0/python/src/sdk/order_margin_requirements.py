...
class OrderMarginRequirements:
    ...
    def post_accounts_account_order_impact(self, request: operations.PostAccountsAccountOrderImpactRequest) -> operations.PostAccountsAccountOrderImpactResponse:
        ...
        url = utils.generate_url(operations.PostAccountsAccountOrderImpactRequest, base_url, '/accounts/{account}/order_impact', request)
        ...
        res = operations.PostAccountsAccountOrderImpactResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.PostAccountsAccountOrderImpact200ApplicationJSON])
