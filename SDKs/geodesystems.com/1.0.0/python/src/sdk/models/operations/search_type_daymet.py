...
class SearchTypeDaymetQueryParams:
...
@dataclasses.dataclass
class SearchTypeDaymetRequest:
    query_params: SearchTypeDaymetQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeDaymetResponse:
