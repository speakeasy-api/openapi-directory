...
class DescribeAccountModificationsRequest:
    ...
    describe_account_modifications_request: shared_describeaccountmodificationsrequest.DescribeAccountModificationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
