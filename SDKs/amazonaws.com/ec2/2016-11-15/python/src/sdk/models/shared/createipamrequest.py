...
class CreateIpamRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateIpamRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateIpamRequestTagSpecifications:
    ...
    resource_type: Optional[CreateIpamRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateIpamRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateIpamRequest:
    ...
    tag_specifications: Optional[list[CreateIpamRequestTagSpecifications]] = dataclasses.field(default=None)  
