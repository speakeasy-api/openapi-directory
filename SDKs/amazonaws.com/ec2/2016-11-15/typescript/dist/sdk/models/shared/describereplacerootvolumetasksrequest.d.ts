 ...
 */
export declare class DescribeReplaceRootVolumeTasksRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeReplaceRootVolumeTasksRequest extends SpeakeasyBase {
    dryRun?: boolean;
