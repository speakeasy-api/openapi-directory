...
public class CreateReplicationSetResponse {
    ...
    public org.openapis.openapi.models.shared.CreateReplicationSetOutput createReplicationSetOutput;

    public CreateReplicationSetResponse withCreateReplicationSetOutput(org.openapis.openapi.models.shared.CreateReplicationSetOutput createReplicationSetOutput) {
    ...
    public CreateReplicationSetResponse withStatusCode(Integer statusCode) {
    ...
    public CreateReplicationSetResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public CreateReplicationSetResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
