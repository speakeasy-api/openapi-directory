...
public class GETDeleteVerifiedAccessTrustProviderQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=Action")
    public GETDeleteVerifiedAccessTrustProviderActionEnum action;
    public GETDeleteVerifiedAccessTrustProviderQueryParams withAction(GETDeleteVerifiedAccessTrustProviderActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETDeleteVerifiedAccessTrustProviderQueryParams withClientToken(String clientToken) {
    ...
    public GETDeleteVerifiedAccessTrustProviderQueryParams withDryRun(Boolean dryRun) {
        this.dryRun = dryRun;
        return this;
    }
    ...
    public GETDeleteVerifiedAccessTrustProviderQueryParams withVerifiedAccessTrustProviderId(String verifiedAccessTrustProviderId) {
    ...
    public GETDeleteVerifiedAccessTrustProviderQueryParams withVersion(GETDeleteVerifiedAccessTrustProviderVersionEnum version) {
