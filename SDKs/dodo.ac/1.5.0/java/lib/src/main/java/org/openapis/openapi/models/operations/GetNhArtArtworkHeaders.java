...
public class GetNhArtArtworkHeaders {
    /**
    ...
    public GetNhArtArtworkHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhArtArtworkHeaders withXApiKey(String xApiKey) {
