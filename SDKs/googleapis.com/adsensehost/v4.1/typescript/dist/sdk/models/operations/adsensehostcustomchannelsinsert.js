...
exports.AdsensehostCustomchannelsInsertResponse = exports.AdsensehostCustomchannelsInsertRequest = exports.AdsensehostCustomchannelsInsertSecurity = void 0;
...
var AdsensehostCustomchannelsInsertRequest = /** @class */ (function (_super) {
    ...
    ], AdsensehostCustomchannelsInsertRequest.prototype, "customChannel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=adClientId",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsInsertRequest.prototype, "adClientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsInsertRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsInsertRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsInsertRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsInsertRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdsensehostCustomchannelsInsertRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsInsertRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsInsertRequest.prototype, "userIp", void 0);
...
var AdsensehostCustomchannelsInsertResponse = /** @class */ (function (_super) {
    ...
    ], AdsensehostCustomchannelsInsertResponse.prototype, "rawResponse", void 0);
