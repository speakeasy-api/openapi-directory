...
class ReactionsListForTeamDiscussionInOrgContentEnum(str, Enum):
    r"""Returns a single [reaction type](https://docs.github.com/enterprise-server@3.4/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a team discussion."""
    PLUS_1 = '+1'
    MINUS_1 = '-1'
    LAUGH = 'laugh'
    CONFUSED = 'confused'
...
class ReactionsListForTeamDiscussionInOrgRequest:
    ...
    content: Optional[ReactionsListForTeamDiscussionInOrgContentEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'content', 'style': 'form', 'explode': True }})
    r"""Returns a single [reaction type](https://docs.github.com/enterprise-server@3.4/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a team discussion."""  
