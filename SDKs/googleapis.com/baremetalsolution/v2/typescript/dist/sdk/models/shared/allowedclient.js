...
var AllowedClient = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "allowDev" }),
        __metadata("design:type", Boolean)
    ], AllowedClient.prototype, "allowDev", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "allowSuid" }),
        __metadata("design:type", Boolean)
    ], AllowedClient.prototype, "allowSuid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "allowedClientsCidr" }),
        __metadata("design:type", String)
    ], AllowedClient.prototype, "allowedClientsCidr", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "mountPermissions" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "nfsPath" }),
        __metadata("design:type", String)
    ], AllowedClient.prototype, "nfsPath", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "noRootSquash" }),
        __metadata("design:type", Boolean)
    ], AllowedClient.prototype, "noRootSquash", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "shareIp" }),
        __metadata("design:type", String)
