...
import dataclasses
from ..shared import googlecloudretailv2betalocalinventory as shared_googlecloudretailv2betalocalinventory
...
class GoogleCloudRetailV2betaAddLocalInventoriesRequest:
    ...
    local_inventories: Optional[list[shared_googlecloudretailv2betalocalinventory.GoogleCloudRetailV2betaLocalInventory]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('localInventories'), 'exclude': lambda f: f is None }})
