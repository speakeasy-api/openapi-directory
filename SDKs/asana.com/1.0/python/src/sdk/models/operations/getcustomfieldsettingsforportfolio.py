...
class GetCustomFieldSettingsForPortfolioRequest:
    path_params: GetCustomFieldSettingsForPortfolioPathParams = dataclasses.field()
    query_params: GetCustomFieldSettingsForPortfolioQueryParams = dataclasses.field()
