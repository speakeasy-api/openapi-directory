 ...
 */
export class DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({
    elemType:
      DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequestFilters,
  })
