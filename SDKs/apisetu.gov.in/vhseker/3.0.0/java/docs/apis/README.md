...
* [vochse](#vochse) - Vocational Higher Secondary
...
import org.openapis.openapi.models.operations.VochseRequestBody;
import org.openapis.openapi.models.operations.VochseRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.VochseRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.VochseResponse;
import org.openapis.openapi.models.operations.VochseSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            VochseRequestBody req = new VochseRequestBody(VochseRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new VochseRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "123456", "2020", "MARCH,SAY");;
            ...
            VochseResponse res = sdk.apIs.vochse(req, new VochseSecurity("maiores", "molestiae") {{
