...
public class FetchEvidenceContentRequest {
    ...
    public FetchEvidenceContentRequest(@JsonProperty("evidence_id") String evidenceId, @JsonProperty("file_id") String fileId, @JsonProperty("payment_dispute_id") String paymentDisputeId) {
        this.evidenceId = evidenceId;
        this.fileId = fileId;
        this.paymentDisputeId = paymentDisputeId;
  }
