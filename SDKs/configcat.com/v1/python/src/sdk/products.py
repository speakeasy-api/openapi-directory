...
class Products:
    ...
    def create_product(self, request: operations.CreateProductRequest) -> operations.CreateProductResponse:
        ...
        url = utils.generate_url(operations.CreateProductRequest, base_url, '/v1/organizations/{organizationId}/products', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "create_product_request", 'json')
        ...
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/hal+json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ProductModelHaljson])
                res.product_model_haljson = out
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ProductModel])
    ...
    def delete_product(self, request: operations.DeleteProductRequest) -> operations.DeleteProductResponse:
        ...
        url = utils.generate_url(operations.DeleteProductRequest, base_url, '/v1/products/{productId}', request)
    ...
    def get_product(self, request: operations.GetProductRequest) -> operations.GetProductResponse:
        ...
        url = utils.generate_url(operations.GetProductRequest, base_url, '/v1/products/{productId}', request)
    ...
    def get_products(self) -> operations.GetProductsResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/hal+json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.ProductModelHaljson]])
                res.product_model_haljsons = out
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.ProductModel]])
    ...
    def update_product(self, request: operations.UpdateProductRequest) -> operations.UpdateProductResponse:
        ...
        url = utils.generate_url(operations.UpdateProductRequest, base_url, '/v1/products/{productId}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "update_product_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
