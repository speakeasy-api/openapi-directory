 ...
 */
export class DescribeClientVpnEndpointsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeClientVpnEndpointsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: DescribeClientVpnEndpointsRequestFilters })
