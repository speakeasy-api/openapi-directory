 ...
 */
public enum WebinarCreate201ApplicationXMLSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private WebinarCreate201ApplicationXMLSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
