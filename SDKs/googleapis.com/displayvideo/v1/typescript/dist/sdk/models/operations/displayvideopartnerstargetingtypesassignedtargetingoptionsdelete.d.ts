...
export declare class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
/**
 ...
 */
export declare enum DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum {
...
export declare class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
