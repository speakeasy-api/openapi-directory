...
export class Folders {
  ...
  cloudresourcemanagerFoldersDelete(
    ...
    security: operations.CloudresourcemanagerFoldersDeleteSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.CloudresourcemanagerFoldersDeleteSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CloudresourcemanagerFoldersDeleteResponse =
        new operations.CloudresourcemanagerFoldersDeleteResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  cloudresourcemanagerFoldersGet(
    ...
    security: operations.CloudresourcemanagerFoldersGetSecurity,
    config?: AxiosRequestConfig
    ...
    const url: string = utils.generateURL(baseURL, "/v2/{name}", req);
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.CloudresourcemanagerFoldersGetSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CloudresourcemanagerFoldersGetResponse =
        new operations.CloudresourcemanagerFoldersGetResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  cloudresourcemanagerFoldersGetIamPolicy(
    ...
    security: operations.CloudresourcemanagerFoldersGetIamPolicySecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.CloudresourcemanagerFoldersGetIamPolicySecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CloudresourcemanagerFoldersGetIamPolicyResponse =
        new operations.CloudresourcemanagerFoldersGetIamPolicyResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  cloudresourcemanagerFoldersMove(
    ...
    security: operations.CloudresourcemanagerFoldersMoveSecurity,
    config?: AxiosRequestConfig
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v2/{name}:move", req);
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.CloudresourcemanagerFoldersMoveSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CloudresourcemanagerFoldersMoveResponse =
        new operations.CloudresourcemanagerFoldersMoveResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  cloudresourcemanagerFoldersPatch(
    ...
    security: operations.CloudresourcemanagerFoldersPatchSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.CloudresourcemanagerFoldersPatchSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CloudresourcemanagerFoldersPatchResponse =
        new operations.CloudresourcemanagerFoldersPatchResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  cloudresourcemanagerFoldersSetIamPolicy(
    ...
    security: operations.CloudresourcemanagerFoldersSetIamPolicySecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.CloudresourcemanagerFoldersSetIamPolicySecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CloudresourcemanagerFoldersSetIamPolicyResponse =
        new operations.CloudresourcemanagerFoldersSetIamPolicyResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  cloudresourcemanagerFoldersTestIamPermissions(
    ...
    security: operations.CloudresourcemanagerFoldersTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.CloudresourcemanagerFoldersTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.CloudresourcemanagerFoldersTestIamPermissionsRequest(
        req
      );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.CloudresourcemanagerFoldersTestIamPermissionsSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CloudresourcemanagerFoldersTestIamPermissionsResponse =
        new operations.CloudresourcemanagerFoldersTestIamPermissionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  cloudresourcemanagerFoldersUndelete(
    ...
    security: operations.CloudresourcemanagerFoldersUndeleteSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.CloudresourcemanagerFoldersUndeleteSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CloudresourcemanagerFoldersUndeleteResponse =
        new operations.CloudresourcemanagerFoldersUndeleteResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
