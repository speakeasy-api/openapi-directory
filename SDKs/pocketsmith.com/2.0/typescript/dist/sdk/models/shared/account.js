...
exports.Account = exports.AccountTypeEnum = void 0;
...
(function (AccountTypeEnum) {
    ...
    AccountTypeEnum["OtherAsset"] = "other_asset";
...
var Account = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "current_balance_date" }),
        __metadata("design:type", String)
    ], Account.prototype, "currentBalanceDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "current_balance_exchange_rate" }),
        __metadata("design:type", Number)
    ], Account.prototype, "currentBalanceExchangeRate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "current_balance_in_base_currency" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "is_net_worth" }),
        __metadata("design:type", Boolean)
    ], Account.prototype, "isNetWorth", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "primary_scenario" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "primary_transaction_account" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "safe_balance" }),
        __metadata("design:type", Number)
    ], Account.prototype, "safeBalance", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "safe_balance_in_base_currency" }),
        __metadata("design:type", Number)
    ], Account.prototype, "safeBalanceInBaseCurrency", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: scenario_1.Scenario }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: transactionaccount_1.TransactionAccount }),
        (0, class_transformer_1.Expose)({ name: "transaction_accounts" }),
        (0, class_transformer_1.Type)(function () { return transactionaccount_1.TransactionAccount; }),
        __metadata("design:type", Array)
