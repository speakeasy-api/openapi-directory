...
type AndroidpublisherMonetizationSubscriptionsBasePlansActivateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidpublisherMonetizationSubscriptionsBasePlansActivatePathParams struct {
...
type AndroidpublisherMonetizationSubscriptionsBasePlansActivateQueryParams struct {
	// V1 error format.
...
type AndroidpublisherMonetizationSubscriptionsBasePlansActivateRequest struct {
...
type AndroidpublisherMonetizationSubscriptionsBasePlansActivateResponse struct {
	ContentType string
	StatusCode  int
