...
public class FetchGroupsQueryParams {
    /**
     * Group name
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=filter[name]")
    public String filterName;
    public FetchGroupsQueryParams withFilterName(String filterName) {
    ...
    public FetchGroupsQueryParams withFilterOrganization(String filterOrganization) {
