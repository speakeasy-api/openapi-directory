...
class CloudPoolAllocationStateEnum(str, Enum):
    r"""Whether the pool is resizing."""
    STEADY = 'steady'
    RESIZING = 'resizing'
    STOPPING = 'stopping'
...
class CloudPool:
    ...
    r"""The time at which the pool entered its current allocation state."""  
    ...
    r"""The creation time of the pool."""  
    ...
    r"""The number of compute nodes currently in the pool."""  
    ...
    r"""The last modified time of the pool."""  
    ...
    r"""The time at which the pool entered its current state."""  
