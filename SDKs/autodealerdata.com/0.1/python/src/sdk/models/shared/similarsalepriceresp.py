...
from ..shared import similarsalepricedata as shared_similarsalepricedata


@dataclass_json
@dataclasses.dataclass
class SimilarSalePriceResp:
    data: shared_similarsalepricedata.SimilarSalePriceData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
