...
var Priorities = /** @class */ (function () {
    function Priorities(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Priorities.prototype.getOrganizationBrandingPoliciesPriorities = function (req, config) {
    ...
    **/
    Priorities.prototype.updateOrganizationBrandingPoliciesPriorities = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
