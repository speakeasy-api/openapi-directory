...
public class DealerSearchRequest {
    ...
    public DealerSearchRequest withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public String city;
    public DealerSearchRequest withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public DealerSearchRequest withCountry(org.openapis.openapi.models.shared.NonDefaultCountryEnum country) {
    ...
    public DealerSearchRequest withDealerType(org.openapis.openapi.models.shared.DealerTypeEnum dealerType) {
    ...
    public DealerSearchRequest withFacets(String facets) {
        this.facets = facets;
        return this;
    }
    ...
    public DealerSearchRequest withInventoryUrl(String inventoryUrl) {
    ...
    public DealerSearchRequest withLatitude(Double latitude) {
    ...
    public DealerSearchRequest withListingCountRange(String listingCountRange) {
    ...
    public DealerSearchRequest withLongitude(Double longitude) {
    ...
    public DealerSearchRequest withProvider(Boolean provider) {
    ...
    public DealerSearchRequest withRadius(Integer radius) {
        this.radius = radius;
        return this;
    }
    ...
    public DealerSearchRequest withRangeFacets(String rangeFacets) {
    ...
    public Integer rows;
    public DealerSearchRequest withRows(Integer rows) {
        this.rows = rows;
        return this;
    }
    ...
    public DealerSearchRequest withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public DealerSearchRequest withSortOrder(org.openapis.openapi.models.shared.SortOrderEnum sortOrder) {
    ...
    public DealerSearchRequest withStart(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public String state;
    public DealerSearchRequest withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public String zip;
    public DealerSearchRequest withZip(String zip) {
        this.zip = zip;
        return this;
    }
