...
from ..shared import balanceplatform as shared_balanceplatform
...
class GetBalancePlatformsIDResponse:
    ...
    balance_platform: Optional[shared_balanceplatform.BalancePlatform] = dataclasses.field(default=None)
