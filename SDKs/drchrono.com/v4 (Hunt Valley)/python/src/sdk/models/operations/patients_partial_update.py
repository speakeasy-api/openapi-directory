...
class PatientsPartialUpdatePathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PatientsPartialUpdateQueryParams:
...
@dataclasses.dataclass
class PatientsPartialUpdateSecurity:
    drchrono_oauth2: shared_security.SchemeDrchronoOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class PatientsPartialUpdateRequest:
    path_params: PatientsPartialUpdatePathParams = dataclasses.field()
    query_params: PatientsPartialUpdateQueryParams = dataclasses.field()
    security: PatientsPartialUpdateSecurity = dataclasses.field()
    

@dataclasses.dataclass
class PatientsPartialUpdateResponse:
