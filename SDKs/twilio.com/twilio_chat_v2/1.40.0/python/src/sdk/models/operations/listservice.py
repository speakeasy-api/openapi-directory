...
class ListServiceListServiceResponse:
    ...
    services: Optional[list[shared_chat_v2_service.ChatV2Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('services'), 'exclude': lambda f: f is None }})  
