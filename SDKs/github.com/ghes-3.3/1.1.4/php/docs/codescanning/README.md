...
try {
    ...
    $request->alertNumber = 557369;
    $request->owner = 'assumenda';
    $request->page = 860552;
    $request->perPage = 379034;
    $request->ref = 'libero';
    $request->repo = 'quasi';
...
try {
    ...
    $request->toolGuid = 'magnam';
    $request->toolName = 'odio';
...
try {
    ...
    $request->owner = 'eius';
    $request->page = 458515;
    $request->perPage = 456141;
    $request->ref = 'rem';
    $request->repo = 'fuga';
    $request->sarifId = '6c81cd8e-b078-4ac3-a3be-1dad7dbd0b53';
    $request->toolGuid = 'reprehenderit';
    $request->toolName = 'quidem';
...
try {
    ...
    $request->requestBody->commitSha = 'eos';
    $request->requestBody->ref = 'praesentium';
    $request->requestBody->sarif = 'quisquam';
    $request->requestBody->startedAt = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-12-11T06:00:38.230Z');
    $request->requestBody->toolName = 'id';
