...
class ListServiceRequest:
    ...
    r"""The string that identifies the Service resources to read."""  
...
class ListServiceListServiceResponse:
    ...
    services: Optional[list[shared_notify_v1_service.NotifyV1Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('services'), 'exclude': lambda f: f is None }})  
