...
var TrackingField = /** @class */ (function () {
    ...
    **/
    TrackingField.prototype.trackingfieldCreate = function (req, config) {
        var _a;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.trackingField = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
     ...
     * * Business, Education, API or higher plan
    **/
    TrackingField.prototype.trackingfieldDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TrackingfieldDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/tracking_fields/{fieldId}", req.pathParams);
        var client = this._securityClient;
     ...
     *
    **/
    TrackingField.prototype.trackingfieldGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * * Business, Education, API or higher plan
    **/
    TrackingField.prototype.trackingfieldList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.trackingFieldList = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.matchContentType(contentType, "application/xml")) {
                        var resBody = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, null, 0);
                        var out = new Uint8Array(resBody.length);
     ...
     * * Business, Education, API or higher plan
    **/
    TrackingField.prototype.trackingfieldUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
