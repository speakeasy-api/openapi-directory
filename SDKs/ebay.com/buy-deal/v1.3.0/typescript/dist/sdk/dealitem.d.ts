...
export declare class DealItem {
     ...
     */
    getDealItems(req: operations.GetDealItemsRequest, security: operations.GetDealItemsSecurity, config?: AxiosRequestConfig): Promise<operations.GetDealItemsResponse>;
}
