...
export class GetGenericAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGenericAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGenericAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGenericAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
