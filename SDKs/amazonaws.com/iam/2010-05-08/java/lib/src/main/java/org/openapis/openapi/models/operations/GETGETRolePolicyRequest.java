...
public class GETGETRolePolicyRequest {
    ...
    public GETGETRolePolicyRequest(@JsonProperty("Action") GETGETRolePolicyActionEnum action, @JsonProperty("PolicyName") String policyName, @JsonProperty("RoleName") String roleName, @JsonProperty("Version") GETGETRolePolicyVersionEnum version) {
        this.action = action;
        this.policyName = policyName;
        this.roleName = roleName;
        this.version = version;
