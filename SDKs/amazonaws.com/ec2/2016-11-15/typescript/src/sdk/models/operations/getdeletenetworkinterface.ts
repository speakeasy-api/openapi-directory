...
export enum GETDeleteNetworkInterfaceActionEnum {
  DeleteNetworkInterface = "DeleteNetworkInterface",
}

export enum GETDeleteNetworkInterfaceVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETDeleteNetworkInterfaceRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETDeleteNetworkInterfaceResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
