...
@dataclasses.dataclass
class Adexchangebuyer2AccountsCreativesListQueryParams:
...
class Adexchangebuyer2AccountsCreativesListRequest:
    path_params: Adexchangebuyer2AccountsCreativesListPathParams = dataclasses.field()
    query_params: Adexchangebuyer2AccountsCreativesListQueryParams = dataclasses.field()
    security: Adexchangebuyer2AccountsCreativesListSecurity = dataclasses.field()
