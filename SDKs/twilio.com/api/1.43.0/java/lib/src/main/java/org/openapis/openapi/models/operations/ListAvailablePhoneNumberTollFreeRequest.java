...
public class ListAvailablePhoneNumberTollFreeRequest {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withAccountSid(String accountSid) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withAreaCode(Long areaCode) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withBeta(Boolean beta) {
        this.beta = beta;
        return this;
    }
    ...
    public ListAvailablePhoneNumberTollFreeRequest withContains(String contains) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withCountryCode(String countryCode) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withDistance(Long distance) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withExcludeAllAddressRequired(Boolean excludeAllAddressRequired) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withExcludeForeignAddressRequired(Boolean excludeForeignAddressRequired) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withExcludeLocalAddressRequired(Boolean excludeLocalAddressRequired) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withFaxEnabled(Boolean faxEnabled) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withInLata(String inLata) {
        this.inLata = inLata;
        return this;
    }
    ...
    public ListAvailablePhoneNumberTollFreeRequest withInLocality(String inLocality) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withInPostalCode(String inPostalCode) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withInRateCenter(String inRateCenter) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withInRegion(String inRegion) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withMmsEnabled(Boolean mmsEnabled) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withNearLatLong(String nearLatLong) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withNearNumber(String nearNumber) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListAvailablePhoneNumberTollFreeRequest withPageSize(Long pageSize) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withPageToken(String pageToken) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withSmsEnabled(Boolean smsEnabled) {
    ...
    public ListAvailablePhoneNumberTollFreeRequest withVoiceEnabled(Boolean voiceEnabled) {
        this.voiceEnabled = voiceEnabled;
        return this;
    }
    
    public ListAvailablePhoneNumberTollFreeRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("CountryCode") String countryCode) {
        this.accountSid = accountSid;
        this.countryCode = countryCode;
  }
}
