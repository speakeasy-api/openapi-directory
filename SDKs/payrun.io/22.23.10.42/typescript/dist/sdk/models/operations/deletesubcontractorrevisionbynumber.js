...
exports.DeleteSubContractorRevisionByNumberResponse = exports.DeleteSubContractorRevisionByNumberRequest = void 0;
...
var DeleteSubContractorRevisionByNumberRequest = /** @class */ (function (_super) {
    ...
    ], DeleteSubContractorRevisionByNumberRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeleteSubContractorRevisionByNumberRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeleteSubContractorRevisionByNumberRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RevisionNumber",
        }),
        __metadata("design:type", String)
    ], DeleteSubContractorRevisionByNumberRequest.prototype, "revisionNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], DeleteSubContractorRevisionByNumberRequest.prototype, "subContractorId", void 0);
...
var DeleteSubContractorRevisionByNumberResponse = /** @class */ (function (_super) {
    ...
    ], DeleteSubContractorRevisionByNumberResponse.prototype, "rawResponse", void 0);
