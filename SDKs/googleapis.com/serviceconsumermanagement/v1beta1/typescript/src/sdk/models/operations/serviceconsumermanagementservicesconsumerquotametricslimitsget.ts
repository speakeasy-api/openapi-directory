...
export class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsGetViewEnum {
  QuotaViewUnspecified = "QUOTA_VIEW_UNSPECIFIED",
  Basic = "BASIC",
  Full = "FULL",
}

export class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
