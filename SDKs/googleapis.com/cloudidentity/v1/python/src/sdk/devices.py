...
class Devices:
    ...
    def cloudidentity_devices_create(self, request: operations.CloudidentityDevicesCreateRequest, security: operations.CloudidentityDevicesCreateSecurity) -> operations.CloudidentityDevicesCreateResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "google_apps_cloudidentity_devices_v1_device_input", 'json')
    ...
    def cloudidentity_devices_device_users_approve(self, request: operations.CloudidentityDevicesDeviceUsersApproveRequest, security: operations.CloudidentityDevicesDeviceUsersApproveSecurity) -> operations.CloudidentityDevicesDeviceUsersApproveResponse:
        ...
        url = utils.generate_url(operations.CloudidentityDevicesDeviceUsersApproveRequest, base_url, '/v1/{name}:approve', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "google_apps_cloudidentity_devices_v1_approve_device_user_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
    ...
    def cloudidentity_devices_device_users_block(self, request: operations.CloudidentityDevicesDeviceUsersBlockRequest, security: operations.CloudidentityDevicesDeviceUsersBlockSecurity) -> operations.CloudidentityDevicesDeviceUsersBlockResponse:
        ...
        url = utils.generate_url(operations.CloudidentityDevicesDeviceUsersBlockRequest, base_url, '/v1/{name}:block', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "google_apps_cloudidentity_devices_v1_block_device_user_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
    ...
    def cloudidentity_devices_device_users_cancel_wipe(self, request: operations.CloudidentityDevicesDeviceUsersCancelWipeRequest, security: operations.CloudidentityDevicesDeviceUsersCancelWipeSecurity) -> operations.CloudidentityDevicesDeviceUsersCancelWipeResponse:
        ...
        url = utils.generate_url(operations.CloudidentityDevicesDeviceUsersCancelWipeRequest, base_url, '/v1/{name}:cancelWipe', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "google_apps_cloudidentity_devices_v1_cancel_wipe_device_user_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
    ...
    def cloudidentity_devices_device_users_client_states_list(self, request: operations.CloudidentityDevicesDeviceUsersClientStatesListRequest, security: operations.CloudidentityDevicesDeviceUsersClientStatesListSecurity) -> operations.CloudidentityDevicesDeviceUsersClientStatesListResponse:
        r"""Lists the client states for the given search query."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.CloudidentityDevicesDeviceUsersClientStatesListRequest, base_url, '/v1/{parent}/clientStates', request)
        
        query_params = utils.get_query_params(operations.CloudidentityDevicesDeviceUsersClientStatesListRequest, request)
        ...
        res = operations.CloudidentityDevicesDeviceUsersClientStatesListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GoogleAppsCloudidentityDevicesV1ListClientStatesResponse])
    ...
    def cloudidentity_devices_device_users_list(self, request: operations.CloudidentityDevicesDeviceUsersListRequest, security: operations.CloudidentityDevicesDeviceUsersListSecurity) -> operations.CloudidentityDevicesDeviceUsersListResponse:
        ...
        url = utils.generate_url(operations.CloudidentityDevicesDeviceUsersListRequest, base_url, '/v1/{parent}/deviceUsers', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse])
    ...
    def cloudidentity_devices_device_users_lookup(self, request: operations.CloudidentityDevicesDeviceUsersLookupRequest, security: operations.CloudidentityDevicesDeviceUsersLookupSecurity) -> operations.CloudidentityDevicesDeviceUsersLookupResponse:
        ...
        url = utils.generate_url(operations.CloudidentityDevicesDeviceUsersLookupRequest, base_url, '/v1/{parent}:lookup', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponse])
    ...
    def cloudidentity_devices_device_users_wipe(self, request: operations.CloudidentityDevicesDeviceUsersWipeRequest, security: operations.CloudidentityDevicesDeviceUsersWipeSecurity) -> operations.CloudidentityDevicesDeviceUsersWipeResponse:
        ...
        url = utils.generate_url(operations.CloudidentityDevicesDeviceUsersWipeRequest, base_url, '/v1/{name}:wipe', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "google_apps_cloudidentity_devices_v1_wipe_device_user_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
    ...
    def cloudidentity_devices_list(self, request: operations.CloudidentityDevicesListRequest, security: operations.CloudidentityDevicesListSecurity) -> operations.CloudidentityDevicesListResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GoogleAppsCloudidentityDevicesV1ListDevicesResponse])
