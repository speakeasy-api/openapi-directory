...
class DetachTypedLinkRequestBodyTypedLinkSpecifier:
    r"""DetachTypedLinkRequestBodyTypedLinkSpecifier
...
class DetachTypedLinkRequestBody:
    typed_link_specifier: DetachTypedLinkRequestBodyTypedLinkSpecifier = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('TypedLinkSpecifier') }})
    

@dataclasses.dataclass
class DetachTypedLinkRequest:
    headers: DetachTypedLinkHeaders = dataclasses.field()
    request: DetachTypedLinkRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
