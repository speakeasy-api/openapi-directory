...
type AnalyticsadminPropertiesDeleteConnectedSiteTagRequest struct {
	...
	GoogleAnalyticsAdminV1alphaDeleteConnectedSiteTagRequest *shared.GoogleAnalyticsAdminV1alphaDeleteConnectedSiteTagRequest `request:"mediaType=application/json"`
	// OAuth access token.
