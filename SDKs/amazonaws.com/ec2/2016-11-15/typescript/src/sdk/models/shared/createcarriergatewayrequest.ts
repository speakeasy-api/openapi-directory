 ...
 */
export enum CreateCarrierGatewayRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateCarrierGatewayRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateCarrierGatewayRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateCarrierGatewayRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken?: string;
  ...
  @SpeakeasyMetadata({ elemType: CreateCarrierGatewayRequestTagSpecifications })
