...
public class ListAvailablePhoneNumberTollFreeQueryParams {
    ...
    public Long page;
    public ListAvailablePhoneNumberTollFreeQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListAvailablePhoneNumberTollFreeQueryParams withPageToken(String pageToken) {
