...
from ..shared import deletedatasetresponse as shared_deletedatasetresponse
...
class DeleteDatasetResponse:
    ...
    delete_dataset_response: Optional[shared_deletedatasetresponse.DeleteDatasetResponse] = dataclasses.field(default=None)
