...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetItemFeedRequest req = new GetItemFeedRequest("illum", "vel", "error", "deserunt", "suscipit") {{
                date = "iure";
            }};            

            GetItemFeedResponse res = sdk.item.getItemFeed(req, new GetItemFeedSecurity("magnam") {{
