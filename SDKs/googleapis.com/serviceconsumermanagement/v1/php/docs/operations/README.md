...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\ServiceconsumermanagementOperationsListRequest;
use \OpenAPI\OpenAPI\Models\Shared\XgafvEnum;
use \OpenAPI\OpenAPI\Models\Shared\AltEnum;
use \OpenAPI\OpenAPI\Models\Operations\ServiceconsumermanagementOperationsListSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ServiceconsumermanagementOperationsListRequest();
    $request->dollarXgafv = XgafvEnum::TWO;
    ...
    $requestSecurity = new ServiceconsumermanagementOperationsListSecurity();
    $requestSecurity->oauth2 = 'Bearer YOUR_ACCESS_TOKEN_HERE';
    $requestSecurity->oauth2c = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->operations->serviceconsumermanagementOperationsList($request, $requestSecurity);
