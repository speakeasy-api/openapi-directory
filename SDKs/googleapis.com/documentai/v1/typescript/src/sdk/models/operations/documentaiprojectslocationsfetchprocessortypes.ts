...
export class DocumentaiProjectsLocationsFetchProcessorTypesSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DocumentaiProjectsLocationsFetchProcessorTypesRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DocumentaiProjectsLocationsFetchProcessorTypesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
