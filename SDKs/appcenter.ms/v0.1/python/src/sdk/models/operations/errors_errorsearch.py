...
class ErrorsErrorSearchSecurity:
    
    api_token: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'X-API-Token' }})  
    
class ErrorsErrorSearchOrderEnum(str, Enum):
    r"""It controls the order of sorting"""
    DESC = 'desc'
    ASC = 'asc'

class ErrorsErrorSearchSortEnum(str, Enum):
...
class ErrorsErrorSearchRequest:
    ...
    order: Optional[ErrorsErrorSearchOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    r"""It controls the order of sorting"""  
    q: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'q', 'style': 'form', 'explode': True }})
    r"""A query string"""  
    sort: Optional[ErrorsErrorSearchSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""It controls the sort based on specified field"""  
    
class ErrorsErrorSearchDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
@dataclasses.dataclass
class ErrorsErrorSearchDefaultApplicationJSONError:
    
    code: ErrorsErrorSearchDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
...
class ErrorsErrorSearchDefaultApplicationJSON:
    ...
    error: ErrorsErrorSearchDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
...
class ErrorsErrorSearch200ApplicationJSON:
    ...
    errors: Optional[list[ErrorsErrorSearch200ApplicationJSONErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errors'), 'exclude': lambda f: f is None }})  
...
class ErrorsErrorSearchResponse:
    ...
    errors_error_search_200_application_json_object: Optional[ErrorsErrorSearch200ApplicationJSON] = dataclasses.field(default=None)
    r"""List of errors"""  
    errors_error_search_default_application_json_object: Optional[ErrorsErrorSearchDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error code with reason"""  
