...
exports.ExportPackagesResponse = exports.ExportPackagesRequest = exports.ExportPackagesSortEnum = exports.ExportPackagesSecurity = void 0;
...
var ExportPackagesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ExportPackagesRequest.prototype, "filterName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[summary]",
        }),
        __metadata("design:type", String)
    ], ExportPackagesRequest.prototype, "filterSummary", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[systems_installed]",
        }),
        __metadata("design:type", String)
    ], ExportPackagesRequest.prototype, "filterSystemsInstalled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[systems_updatable]",
        }),
        __metadata("design:type", String)
    ], ExportPackagesRequest.prototype, "filterSystemsUpdatable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=search",
        }),
        __metadata("design:type", String)
    ], ExportPackagesRequest.prototype, "search", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], ExportPackagesRequest.prototype, "sort", void 0);
...
var ExportPackagesResponse = /** @class */ (function (_super) {
    ...
    ], ExportPackagesResponse.prototype, "rawResponse", void 0);
    __decorate([
