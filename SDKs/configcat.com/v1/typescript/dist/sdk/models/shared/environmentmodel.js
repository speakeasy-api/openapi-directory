...
var EnvironmentModel = /** @class */ (function (_super) {
    __extends(EnvironmentModel, _super);
    ...
    ], EnvironmentModel.prototype, "environmentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], EnvironmentModel.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=product" }),
        __metadata("design:type", productmodel_1.ProductModel)
    ], EnvironmentModel.prototype, "product", void 0);
