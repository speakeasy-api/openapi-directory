 ...
 */
export enum TargetPoolsScopedListWarningCodeEnum {
...
export class TargetPoolsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetPoolsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: TargetPoolsScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: TargetPoolsScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => TargetPoolsScopedListWarningData)
  data?: TargetPoolsScopedListWarningData[];
...
export class TargetPoolsScopedList extends SpeakeasyBase {
  /**
   * A list of target pools contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: TargetPool })
