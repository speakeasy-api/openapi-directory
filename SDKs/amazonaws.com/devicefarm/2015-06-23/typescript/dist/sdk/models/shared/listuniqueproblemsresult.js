...
var ListUniqueProblemsResult = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: uniqueproblem_1.UniqueProblem, elemDepth: 2 }),
        (0, class_transformer_1.Expose)({ name: "uniqueProblems" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], uniqueproblem_1.UniqueProblem);
            }
            return obj;
        }, { toClassOnly: true }),
