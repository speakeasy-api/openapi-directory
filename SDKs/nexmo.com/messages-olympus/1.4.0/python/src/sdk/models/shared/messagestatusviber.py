...
class MessageStatusViberChannelEnum(str, Enum):
...
class MessageStatusViberStatusEnum(str, Enum):
    SUBMITTED = 'submitted'
    DELIVERED = 'delivered'
    REJECTED = 'rejected'
...
class MessageStatusViberUsageCurrencyEnum(str, Enum):
...
class MessageStatusViberUsage:
    ...
    currency: Optional[MessageStatusViberUsageCurrencyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('currency'), 'exclude': lambda f: f is None }})
    r"""The charge currency in ISO 4217 format."""  
...
class MessageStatusViber:
    ...
    channel: MessageStatusViberChannelEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('channel') }})
    r"""The channel sending to."""  
    ...
    status: MessageStatusViberStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
    ...
    error: Optional[MessageStatusViberError] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error'), 'exclude': lambda f: f is None }})
    r"""If the message encountered a problem a descriptive error will be supplied in this object."""  
    usage: Optional[MessageStatusViberUsage] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('usage'), 'exclude': lambda f: f is None }})  
