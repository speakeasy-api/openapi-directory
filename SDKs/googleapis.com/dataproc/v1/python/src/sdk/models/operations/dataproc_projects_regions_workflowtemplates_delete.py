...
class DataprocProjectsRegionsWorkflowTemplatesDeleteRequest:
    path_params: DataprocProjectsRegionsWorkflowTemplatesDeletePathParams = dataclasses.field()
    query_params: DataprocProjectsRegionsWorkflowTemplatesDeleteQueryParams = dataclasses.field()
    security: DataprocProjectsRegionsWorkflowTemplatesDeleteSecurity = dataclasses.field()
