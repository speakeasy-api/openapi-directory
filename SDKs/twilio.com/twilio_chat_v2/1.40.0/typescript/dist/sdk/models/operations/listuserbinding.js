...
exports.ListUserBindingResponse = exports.ListUserBindingListUserBindingResponse = exports.ListUserBindingListUserBindingResponseMeta = exports.ListUserBindingRequest = exports.ListUserBindingSecurity = exports.ListUserBindingServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListUserBindingServerList = ["https://chat.twilio.com"];
var ListUserBindingSecurity = /** @class */ (function (_super) {
    ...
    ], ListUserBindingSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListUserBindingSecurity.prototype, "username", void 0);
...
var ListUserBindingRequest = /** @class */ (function (_super) {
    ...
    ], ListUserBindingRequest.prototype, "bindingType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListUserBindingRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListUserBindingRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListUserBindingRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListUserBindingRequest.prototype, "serviceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=UserSid",
        }),
        __metadata("design:type", String)
    ], ListUserBindingRequest.prototype, "userSid", void 0);
...
var ListUserBindingListUserBindingResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ChatV2ServiceUserUserBinding }),
        (0, class_transformer_1.Expose)({ name: "bindings" }),
        (0, class_transformer_1.Type)(function () { return shared.ChatV2ServiceUserUserBinding; }),
        __metadata("design:type", Array)
    ], ListUserBindingListUserBindingResponse.prototype, "bindings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListUserBindingListUserBindingResponseMeta; }),
...
var ListUserBindingResponse = /** @class */ (function (_super) {
    ...
    ], ListUserBindingResponse.prototype, "rawResponse", void 0);
