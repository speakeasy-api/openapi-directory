...
export class PatientsReadPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class PatientsReadQueryParams extends SpeakeasyBase {
...
export class PatientsReadSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" })
  drchronoOauth2: shared.SchemeDrchronoOauth2;
}


export class PatientsReadRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class PatientsReadResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
