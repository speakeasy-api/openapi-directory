...
import { TargetVpnGatewaysScopedList } from "./targetvpngatewaysscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum TargetVpnGatewayAggregatedListWarningCodeEnum {
...
export declare class TargetVpnGatewayAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetVpnGatewayAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: TargetVpnGatewayAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: TargetVpnGatewayAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class TargetVpnGatewayAggregatedList extends SpeakeasyBase {
    /**
