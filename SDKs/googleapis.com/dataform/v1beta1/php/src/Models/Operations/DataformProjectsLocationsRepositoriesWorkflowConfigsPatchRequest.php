...
class DataformProjectsLocationsRepositoriesWorkflowConfigsPatchRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\WorkflowConfigInput $workflowConfigInput = null;
