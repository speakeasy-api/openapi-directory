...
class PutFunctionConcurrencyRequestBody:
    ...
    reserved_concurrent_executions: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ReservedConcurrentExecutions') }})
    r"""The number of simultaneous executions to reserve for the function."""  
...
class PutFunctionConcurrencyRequest:
    ...
    request_body: PutFunctionConcurrencyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
