...
from ..shared import listappversionresourcemappingsresponse as shared_listappversionresourcemappingsresponse
...
class ListAppVersionResourceMappingsRequestBody:
...
class ListAppVersionResourceMappingsRequest:
    ...
    request_body: ListAppVersionResourceMappingsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListAppVersionResourceMappingsResponse:
    ...
    list_app_version_resource_mappings_response: Optional[shared_listappversionresourcemappingsresponse.ListAppVersionResourceMappingsResponse] = dataclasses.field(default=None)
    r"""Success"""  
