...
from ..shared import passwordresetrequest as shared_passwordresetrequest
...
class ResetPasswordRequest:
    ...
    password_reset_request: shared_passwordresetrequest.PasswordResetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
