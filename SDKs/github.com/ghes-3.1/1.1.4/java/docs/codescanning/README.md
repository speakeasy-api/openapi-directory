...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningDeleteAnalysisRequest req = new CodeScanningDeleteAnalysisRequest(785153L, "doloribus", "ut") {{
                confirmDelete = "facilis";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetAlertRequest req = new CodeScanningGetAlertRequest(586410L, "qui", "quae");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetAnalysisRequest req = new CodeScanningGetAnalysisRequest(512393L, "odio", "occaecati");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetSarifRequest req = new CodeScanningGetSarifRequest("voluptatibus", "quisquam", "vero");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListAlertInstancesRequest req = new CodeScanningListAlertInstancesRequest(606476L, "quis", "ipsum") {{
                page = 961571L;
                perPage = 455169L;
                ref = "consectetur";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListAlertsForRepoRequest req = new CodeScanningListAlertsForRepoRequest("vero", "tenetur") {{
                page = 492268L;
                perPage = 941378L;
                ref = "distinctio";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListRecentAnalysesRequest req = new CodeScanningListRecentAnalysesRequest("facilis", "vero") {{
                page = 498140L;
                perPage = 293020L;
                ref = "quibusdam";
    ...
    public static void main(String[] args) {
        try {
            ...
            CodeScanningUpdateAlertRequest req = new CodeScanningUpdateAlertRequest(                new CodeScanningUpdateAlertRequestBody(CodeScanningAlertSetStateEnum.DISMISSED) {{
                            ...
                            }};, 13236L, "voluptatibus", "exercitationem");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningUploadSarifRequest req = new CodeScanningUploadSarifRequest(                new CodeScanningUploadSarifRequestBody("nulla", "fugit", "porro") {{
                                checkoutUri = "file:///github/workspace/";
                                startedAt = OffsetDateTime.parse("2020-01-18T09:21:05.997Z");
                                toolName = "iusto";
                            }};, "eligendi", "ducimus");            
