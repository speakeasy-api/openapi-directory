...
export const ListShortCodeServerList = ["https://api.twilio.com"] as const;
...
export class ListShortCodeRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=ShortCode",
  })
  shortCode?: string;
}
...
export class ListShortCodeListShortCodeResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.ApiV2010AccountShortCode })
  @Expose({ name: "short_codes" })
  @Type(() => shared.ApiV2010AccountShortCode)
