...
export class GetCompaniesCompanyIdWebhooksSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetCompaniesCompanyIdWebhooksRequest extends SpeakeasyBase {
  /**
...
export class GetCompaniesCompanyIdWebhooksResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
