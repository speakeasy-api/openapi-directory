 ...
 */
export declare enum CreateTransitGatewayPeeringAttachmentRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateTransitGatewayPeeringAttachmentRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateTransitGatewayPeeringAttachmentRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateTransitGatewayPeeringAttachmentRequest extends SpeakeasyBase {
    dryRun?: boolean;
