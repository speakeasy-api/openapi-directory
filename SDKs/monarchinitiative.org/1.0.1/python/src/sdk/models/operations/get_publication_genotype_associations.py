...
class GetPublicationGenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPublicationGenotypeAssociationsQueryParams:
...
@dataclasses.dataclass
class GetPublicationGenotypeAssociationsRequest:
    path_params: GetPublicationGenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetPublicationGenotypeAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetPublicationGenotypeAssociationsResponse:
