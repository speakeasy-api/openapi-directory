...
type EventarcProjectsLocationsChannelConnectionsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type EventarcProjectsLocationsChannelConnectionsListPathParams struct {
	// Required. The parent collection from which to list channel connections.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type EventarcProjectsLocationsChannelConnectionsListQueryParams struct {
	// V1 error format.
...
type EventarcProjectsLocationsChannelConnectionsListRequest struct {
...
type EventarcProjectsLocationsChannelConnectionsListResponse struct {
	ContentType string
	// Successful response
