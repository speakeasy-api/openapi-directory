...
class Scopes:
    ...
    new_accounts: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('new_accounts'), 'exclude': lambda f: f is None }})
    r"""Allow access to newly opened accounts as they are opened. If unset, defaults to `true`."""  
    product_access: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('product_access'), 'exclude': lambda f: f is None }})
