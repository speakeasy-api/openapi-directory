...
class SubmitTaskStateChangeRequest:
    ...
    submit_task_state_change_request: shared_submittaskstatechangerequest.SubmitTaskStateChangeRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
