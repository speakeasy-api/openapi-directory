...
from ..shared import progresscounters as shared_progresscounters
...
class AutomationExecution:
    r"""Detailed information about the current state of an individual Automation execution."""
    ...
    progress_counters: Optional[shared_progresscounters.ProgressCounters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ProgressCounters'), 'exclude': lambda f: f is None }})  
    ...
    step_executions_truncated: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StepExecutionsTruncated'), 'exclude': lambda f: f is None }})  
