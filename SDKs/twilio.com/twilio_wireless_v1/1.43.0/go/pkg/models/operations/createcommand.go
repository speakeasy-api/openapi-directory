...
func (e CreateCommandCreateCommandRequestCallbackMethodEnum) ToPointer() *CreateCommandCreateCommandRequestCallbackMethodEnum {
	return &e
}
...
func (e *CreateCommandCreateCommandRequestCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateCommandCreateCommandRequestCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCommandCreateCommandRequestCallbackMethodEnum: %v", v)
	}
}
