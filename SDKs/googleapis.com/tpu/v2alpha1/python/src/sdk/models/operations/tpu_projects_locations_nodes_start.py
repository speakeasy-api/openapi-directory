...
class TpuProjectsLocationsNodesStartRequest:
    path_params: TpuProjectsLocationsNodesStartPathParams = dataclasses.field()
    query_params: TpuProjectsLocationsNodesStartQueryParams = dataclasses.field()
    security: TpuProjectsLocationsNodesStartSecurity = dataclasses.field()
