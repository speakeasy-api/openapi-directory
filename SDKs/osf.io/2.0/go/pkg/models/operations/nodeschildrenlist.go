...
type NodesChildrenListNodeAttributesCategoryEnum string

const (
	NodesChildrenListNodeAttributesCategoryEnumAnalysis           NodesChildrenListNodeAttributesCategoryEnum = "analysis"
	NodesChildrenListNodeAttributesCategoryEnumCommunication      NodesChildrenListNodeAttributesCategoryEnum = "communication"
	NodesChildrenListNodeAttributesCategoryEnumData               NodesChildrenListNodeAttributesCategoryEnum = "data"
	NodesChildrenListNodeAttributesCategoryEnumHypothesis         NodesChildrenListNodeAttributesCategoryEnum = "hypothesis"
	NodesChildrenListNodeAttributesCategoryEnumInstrumentation    NodesChildrenListNodeAttributesCategoryEnum = "instrumentation"
	NodesChildrenListNodeAttributesCategoryEnumMethodsAndMeasures NodesChildrenListNodeAttributesCategoryEnum = "methods and measures"
	NodesChildrenListNodeAttributesCategoryEnumProcedure          NodesChildrenListNodeAttributesCategoryEnum = "procedure"
	NodesChildrenListNodeAttributesCategoryEnumProject            NodesChildrenListNodeAttributesCategoryEnum = "project"
	NodesChildrenListNodeAttributesCategoryEnumSoftware           NodesChildrenListNodeAttributesCategoryEnum = "software"
	NodesChildrenListNodeAttributesCategoryEnumOther              NodesChildrenListNodeAttributesCategoryEnum = "other"
)

func (e NodesChildrenListNodeAttributesCategoryEnum) ToPointer() *NodesChildrenListNodeAttributesCategoryEnum {
	return &e
}

func (e *NodesChildrenListNodeAttributesCategoryEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "software":
		fallthrough
	case "other":
		*e = NodesChildrenListNodeAttributesCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NodesChildrenListNodeAttributesCategoryEnum: %v", v)
	}
}

// NodesChildrenListNodeAttributes - The properties of the node entity.
type NodesChildrenListNodeAttributes struct {
...
type NodesChildrenListNodeLinks struct {
...
type NodesChildrenListNodeRelationships struct {
...
type NodesChildrenListNode struct {
