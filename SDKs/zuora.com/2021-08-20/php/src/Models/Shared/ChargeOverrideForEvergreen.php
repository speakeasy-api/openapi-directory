...
class ChargeOverrideForEvergreen
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ChargeOverrideForEvergreenBilling $billing
     */
	#[\JMS\Serializer\Annotation\SerializedName('billing')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\ChargeOverrideForEvergreenBilling')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ChargeOverrideForEvergreenBilling $billing = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ChargeOverrideForEvergreenPricing $pricing
     */
	#[\JMS\Serializer\Annotation\SerializedName('pricing')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\ChargeOverrideForEvergreenPricing')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ChargeOverrideForEvergreenPricing $pricing = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ChargeOverrideForEvergreenRevRecTriggerConditionEnum $revRecTriggerCondition
     */
	#[\JMS\Serializer\Annotation\SerializedName('revRecTriggerCondition')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ChargeOverrideForEvergreenRevRecTriggerConditionEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ChargeOverrideForEvergreenRevRecTriggerConditionEnum $revRecTriggerCondition = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ChargeOverrideForEvergreenRevenueRecognitionRuleNameEnum $revenueRecognitionRuleName
     */
	#[\JMS\Serializer\Annotation\SerializedName('revenueRecognitionRuleName')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ChargeOverrideForEvergreenRevenueRecognitionRuleNameEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ChargeOverrideForEvergreenRevenueRecognitionRuleNameEnum $revenueRecognitionRuleName = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\TriggerParams $startDate
     */
	#[\JMS\Serializer\Annotation\SerializedName('startDate')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\TriggerParams')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?TriggerParams $startDate = null;
