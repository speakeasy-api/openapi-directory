...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksCreateSuiteRequest req = new ChecksCreateSuiteRequest(                new ChecksCreateSuiteRequestBody("ipsum");, "delectus", "voluptate");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksGetRequest req = new ChecksGetRequest(231701L, "vero", "tenetur");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksGetSuiteRequest req = new ChecksGetSuiteRequest(492268L, "hic", "distinctio");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListAnnotationsRequest req = new ChecksListAnnotationsRequest(799203L, "odio", "similique") {{
                page = 708548L;
                perPage = 874288L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListForRefRequest req = new ChecksListForRefRequest("ducimus", "dolore", "quibusdam") {{
                appId = 848944L;
                checkName = "sequi";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListForSuiteRequest req = new ChecksListForSuiteRequest(347233L, "nulla", "fugit") {{
                checkName = "porro";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListSuitesForRefRequest req = new ChecksListSuitesForRefRequest("ducimus", "alias", "officia") {{
                appId = 269479L;
                checkName = "ipsam";
                page = 410492L;
                perPage = 136900L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksRerequestRunRequest req = new ChecksRerequestRunRequest(428224L, "possimus", "magnam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksRerequestSuiteRequest req = new ChecksRerequestSuiteRequest(189848L, "ex", "laudantium");            
        ...
        try {
            ...
            ChecksSetSuitesPreferencesRequest req = new ChecksSetSuitesPreferencesRequest(                new ChecksSetSuitesPreferencesRequestBody() {{
                                autoTriggerChecks = new org.openapis.openapi.models.operations.ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks[]{{
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(980700L, false) {{
                                        appId = 224317L;
                                        setting = false;
                                    }}),
                                }};
