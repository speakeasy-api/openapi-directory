...
class JobScheduling
{
     ...
     * 
     * @var ?int $maxFailuresPerHour
     */
	#[\JMS\Serializer\Annotation\SerializedName('maxFailuresPerHour')]
    #[\JMS\Serializer\Annotation\Type('int')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?int $maxFailuresPerHour = null;
     ...
     * 
     * @var ?int $maxFailuresTotal
     */
	#[\JMS\Serializer\Annotation\SerializedName('maxFailuresTotal')]
    #[\JMS\Serializer\Annotation\Type('int')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?int $maxFailuresTotal = null;
