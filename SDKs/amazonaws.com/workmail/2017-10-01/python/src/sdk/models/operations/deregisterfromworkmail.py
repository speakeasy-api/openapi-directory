...
class DeregisterFromWorkMailRequest:
    ...
    deregister_from_work_mail_request: shared_deregisterfromworkmailrequest.DeregisterFromWorkMailRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
