...
class DeleteSubnetGroupRequest:
    ...
    delete_subnet_group_request: shared_deletesubnetgrouprequest.DeleteSubnetGroupRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
