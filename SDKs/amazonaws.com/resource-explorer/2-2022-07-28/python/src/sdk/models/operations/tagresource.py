...
class TagResourceRequestBody:
    ...
    r"""A list of tag key and value pairs that you want to attach to the specified view or index."""  
...
class TagResourceRequest:
    ...
    r"""The Amazon Resource Name (ARN) of the view or index that you want to attach tags to."""  
