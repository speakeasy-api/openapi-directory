...
type DialogflowProjectsLocationsConversationsSuggestionsSuggestConversationSummaryRequest struct {
	...
	GoogleCloudDialogflowV2beta1SuggestConversationSummaryRequest *shared.GoogleCloudDialogflowV2beta1SuggestConversationSummaryRequest `request:"mediaType=application/json"`
	// OAuth access token.
