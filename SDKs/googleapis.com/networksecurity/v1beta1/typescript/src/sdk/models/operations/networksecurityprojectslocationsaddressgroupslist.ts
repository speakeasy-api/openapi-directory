...
export class NetworksecurityProjectsLocationsAddressGroupsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsAddressGroupsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsAddressGroupsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
