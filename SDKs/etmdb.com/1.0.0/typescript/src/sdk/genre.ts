...
export class Genre {
  ...
  genreSearchRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GenreSearchReadResponse =
        new operations.GenreSearchReadResponse({
  ...
  genreSearchallRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GenreSearchallReadResponse =
        new operations.GenreSearchallReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
