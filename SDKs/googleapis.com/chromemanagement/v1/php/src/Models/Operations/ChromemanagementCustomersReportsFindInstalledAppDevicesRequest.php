...
class ChromemanagementCustomersReportsFindInstalledAppDevicesRequest
{
     ...
     * Type of the app.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsFindInstalledAppDevicesAppTypeEnum $appType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=appType')]
    public ?ChromemanagementCustomersReportsFindInstalledAppDevicesAppTypeEnum $appType = null;
