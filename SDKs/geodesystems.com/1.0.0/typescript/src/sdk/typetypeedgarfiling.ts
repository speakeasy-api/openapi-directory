...
export class TypeTypeEdgarFiling {
  ...
  searchTypeEdgarFiling(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_edgar_filing";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeEdgarFilingResponse =
        new operations.SearchTypeEdgarFilingResponse({
