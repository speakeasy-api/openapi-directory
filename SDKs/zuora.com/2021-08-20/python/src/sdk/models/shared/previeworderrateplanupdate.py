...
class PreviewOrderRatePlanUpdate:
    ...
    charge_updates: Optional[list[shared_previeworderchargeupdate.PreviewOrderChargeUpdate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('chargeUpdates'), 'exclude': lambda f: f is None }})
    r"""Array of the JSON objects containing the information for a charge update in the `updateProduct` type of order action.
