...
public class ClientApiDeleteRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ClientApiDeleteRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public ClientApiDeleteRawHeaders withXAuthSecret(String xAuthSecret) {
