...
from ..shared import deregisterorganizationdelegatedadminrequest as shared_deregisterorganizationdelegatedadminrequest
from enum import Enum
from typing import Any, Optional

class DeregisterOrganizationDelegatedAdminXAmzTargetEnum(str, Enum):
    COM_AMAZONAWS_CLOUDTRAIL_V20131101_CLOUD_TRAIL_20131101_DEREGISTER_ORGANIZATION_DELEGATED_ADMIN = 'com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.DeregisterOrganizationDelegatedAdmin'


@dataclasses.dataclass
class DeregisterOrganizationDelegatedAdminRequest:
    
    deregister_organization_delegated_admin_request: shared_deregisterorganizationdelegatedadminrequest.DeregisterOrganizationDelegatedAdminRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    x_amz_target: DeregisterOrganizationDelegatedAdminXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})  
...
class DeregisterOrganizationDelegatedAdminResponse:
    ...
    account_not_registered_exception: Optional[Any] = dataclasses.field(default=None)
    r"""AccountNotRegisteredException"""  
    ...
    r"""ConflictException"""  
    deregister_organization_delegated_admin_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
