...
exports.SandboxItemFireWebhookRequest = exports.SandboxItemFireWebhookRequestWebhookCodeEnum = void 0;
...
**/
var SandboxItemFireWebhookRequest = /** @class */ (function (_super) {
    __extends(SandboxItemFireWebhookRequest, _super);
    ...
    ], SandboxItemFireWebhookRequest.prototype, "accessToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=client_id" }),
        __metadata("design:type", String)
    ], SandboxItemFireWebhookRequest.prototype, "clientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=secret" }),
        __metadata("design:type", String)
    ], SandboxItemFireWebhookRequest.prototype, "secret", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=webhook_code" }),
        __metadata("design:type", String)
    ], SandboxItemFireWebhookRequest.prototype, "webhookCode", void 0);
