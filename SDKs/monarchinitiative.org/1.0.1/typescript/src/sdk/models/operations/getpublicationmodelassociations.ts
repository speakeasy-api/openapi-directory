...
export class GetPublicationModelAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetPublicationModelAssociationsQueryParams extends SpeakeasyBase {
...
export class GetPublicationModelAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  pathParams: GetPublicationModelAssociationsPathParams;

  @SpeakeasyMetadata()
  queryParams: GetPublicationModelAssociationsQueryParams;
}


export class GetPublicationModelAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
