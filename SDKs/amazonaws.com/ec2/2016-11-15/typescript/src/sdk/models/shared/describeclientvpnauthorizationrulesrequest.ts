 ...
 */
export class DescribeClientVpnAuthorizationRulesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeClientVpnAuthorizationRulesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
