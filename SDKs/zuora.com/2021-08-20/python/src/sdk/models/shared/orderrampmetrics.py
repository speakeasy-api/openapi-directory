...
class OrderRampMetrics:
    ...
    intervals: Optional[list[shared_orderrampintervalmetrics.OrderRampIntervalMetrics]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('intervals'), 'exclude': lambda f: f is None }})
    r"""The ramp metrics for each ramp intervals in its timeline."""  
