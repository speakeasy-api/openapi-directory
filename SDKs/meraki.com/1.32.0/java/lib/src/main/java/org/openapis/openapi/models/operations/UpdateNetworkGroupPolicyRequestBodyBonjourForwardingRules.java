...
public class UpdateNetworkGroupPolicyRequestBodyBonjourForwardingRules {
    ...
    public UpdateNetworkGroupPolicyRequestBodyBonjourForwardingRules(@JsonProperty("services") UpdateNetworkGroupPolicyRequestBodyBonjourForwardingRulesServicesEnum[] services, @JsonProperty("vlanId") String vlanId) {
        this.services = services;
        this.vlanId = vlanId;
  }
}
