...
from ..shared import updateordertyperesponse as shared_updateordertyperesponse
...
class OrderTypesUpdateRequest:
    headers: OrderTypesUpdateHeaders = dataclasses.field()
    path_params: OrderTypesUpdatePathParams = dataclasses.field()
    query_params: OrderTypesUpdateQueryParams = dataclasses.field()
    request: shared_ordertype.OrderTypeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: OrderTypesUpdateSecurity = dataclasses.field()
...
class OrderTypesUpdateResponse:
    ...
    update_order_type_response: Optional[shared_updateordertyperesponse.UpdateOrderTypeResponse] = dataclasses.field(default=None)
