...
class PoolListRequest:
    headers: PoolListHeaders = dataclasses.field()
    query_params: PoolListQueryParams = dataclasses.field()
...
class PoolListResponse:
    ...
    cloud_pool_list_result: Optional[Any] = dataclasses.field(default=None)
