...
class DeleteRetentionPolicyRequest:
    ...
    delete_retention_policy_request: shared_deleteretentionpolicyrequest.DeleteRetentionPolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
