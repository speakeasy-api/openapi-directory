...
class Service:
    ...
    service_address: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_address'), 'exclude': lambda f: f is None }})  
    service_asset_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_asset_id'), 'exclude': lambda f: f is None }})  
    ...
    service_created_at: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_created_at'), 'exclude': lambda f: f is None }})  
    service_data: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_data'), 'exclude': lambda f: f is None }})  
    service_link: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_link'), 'exclude': lambda f: f is None }})  
    service_port: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_port'), 'exclude': lambda f: f is None }})  
    ...
    service_protocol: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_protocol'), 'exclude': lambda f: f is None }})  
    service_screenshot_link: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_screenshot_link'), 'exclude': lambda f: f is None }})  
    service_summary: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_summary'), 'exclude': lambda f: f is None }})  
    service_transport: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_transport'), 'exclude': lambda f: f is None }})  
    service_updated_at: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_updated_at'), 'exclude': lambda f: f is None }})  
    service_vhost: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_vhost'), 'exclude': lambda f: f is None }})  
