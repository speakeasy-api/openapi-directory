 ...
 */
export declare enum UpdateShipmentResponseBodyDeliveryConfirmationEnum {
    None = "none",
    Delivery = "delivery",
    Signature = "signature",
 ...
 */
export declare enum UpdateShipmentResponseBodyInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export declare enum UpdateShipmentResponseBodyInternationalShipmentOptionsNonDeliveryEnum {
...
export declare class UpdateShipmentResponseBodyInternationalShipmentOptions extends SpeakeasyBase {
     ...
     */
    contents: UpdateShipmentResponseBodyInternationalShipmentOptionsPackageContentsEnum;
    /**
     ...
     */
    nonDelivery: UpdateShipmentResponseBodyInternationalShipmentOptionsNonDeliveryEnum;
}
/**
 * The possible insurance provider values
 */
export declare enum UpdateShipmentResponseBodyInsuranceProviderEnum {
    None = "none",
 ...
 */
export declare enum UpdateShipmentResponseBodyOriginTypeEnum {
    Pickup = "pickup",
    DropOff = "drop_off"
}
/**
 ...
 */
export declare enum UpdateShipmentResponseBodyShipmentStatusEnum {
    Pending = "pending",
...
export declare class UpdateShipmentResponseBody extends SpeakeasyBase {
     ...
     */
    confirmation: UpdateShipmentResponseBodyDeliveryConfirmationEnum;
    /**
     ...
     *
     */
    insuranceProvider: UpdateShipmentResponseBodyInsuranceProviderEnum;
    /**
     ...
     * Indicates if the package will be picked up or dropped off by the carrier
     */
    originType?: UpdateShipmentResponseBodyOriginTypeEnum;
    /**
     ...
     */
    shipmentStatus: UpdateShipmentResponseBodyShipmentStatusEnum;
    /**
