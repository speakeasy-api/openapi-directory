...
func (e NewCustomerRequestCustomerContractTypeEnum) ToPointer() *NewCustomerRequestCustomerContractTypeEnum {
	return &e
}
...
func (e *NewCustomerRequestCustomerContractTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "free":
		fallthrough
	case "pay":
		*e = NewCustomerRequestCustomerContractTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NewCustomerRequestCustomerContractTypeEnum: %v", v)
	}
}
