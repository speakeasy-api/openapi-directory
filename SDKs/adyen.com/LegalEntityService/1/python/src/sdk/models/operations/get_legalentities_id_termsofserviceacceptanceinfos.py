...
from ..shared import gettermsofserviceacceptanceinfosresponse as shared_gettermsofserviceacceptanceinfosresponse
...
class GetLegalEntitiesIDTermsOfServiceAcceptanceInfosSecurity:
...
@dataclasses.dataclass
class GetLegalEntitiesIDTermsOfServiceAcceptanceInfosResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    get_terms_of_service_acceptance_infos_response: Optional[shared_gettermsofserviceacceptanceinfosresponse.GetTermsOfServiceAcceptanceInfosResponse] = dataclasses.field(default=None)
