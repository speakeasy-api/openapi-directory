...
from ..shared import carlocation as shared_carlocation
...
class UKBaseListing:
    r"""Minimal set of attributes describing a listing"""
    ...
    car_location: Optional[shared_carlocation.CarLocation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('car_location'), 'exclude': lambda f: f is None }})  
    ...
    co2_emissions: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('co2_emissions'), 'exclude': lambda f: f is None }})
    r"""CO2 emissions by car"""  
    ...
    r"""Distance of the car's location from the specified user lcoation"""  
    ...
    in_transit: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('in_transit'), 'exclude': lambda f: f is None }})
    r"""in_transit of the listing"""  
    insurance_group: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('insurance_group'), 'exclude': lambda f: f is None }})
    r"""Insurance Group of car"""  
    ...
    r"""Certified car"""  
    is_translated: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('is_translated'), 'exclude': lambda f: f is None }})
    r"""is_translated of the listing"""  
    ...
    model_code: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_code'), 'exclude': lambda f: f is None }})
    r"""model_code of the listing"""  
    ...
    r"""MSRP for the car"""  
    num_owners: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('num_owners'), 'exclude': lambda f: f is None }})
    r"""Number of owners"""  
    ...
    title_type: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('title_type'), 'exclude': lambda f: f is None }})
    r"""title_type of the listing"""  
    uvc_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('uvc_id'), 'exclude': lambda f: f is None }})
    r"""UVC ID of the car"""  
