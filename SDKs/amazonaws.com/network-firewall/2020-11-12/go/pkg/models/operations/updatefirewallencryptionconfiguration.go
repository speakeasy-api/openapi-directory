...
type UpdateFirewallEncryptionConfigurationHeaders struct {
...
type UpdateFirewallEncryptionConfigurationRequest struct {
	Headers UpdateFirewallEncryptionConfigurationHeaders
	Request shared.UpdateFirewallEncryptionConfigurationRequest `request:"mediaType=application/json"`
}
