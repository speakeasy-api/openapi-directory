...
class GetQuestionsIdsQueryParams:
    ...
    order: Optional[GetQuestionsIdsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetQuestionsIdsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetQuestionsIdsRequest:
    path_params: GetQuestionsIdsPathParams = dataclasses.field()
    query_params: GetQuestionsIdsQueryParams = dataclasses.field()
