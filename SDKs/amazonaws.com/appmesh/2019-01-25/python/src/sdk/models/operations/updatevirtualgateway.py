...
class UpdateVirtualGatewayRequestBody:
    spec: UpdateVirtualGatewayRequestBodySpec = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('spec') }})
    client_token: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('clientToken') }})
    

@dataclasses.dataclass
class UpdateVirtualGatewayRequest:
    headers: UpdateVirtualGatewayHeaders = dataclasses.field()
    path_params: UpdateVirtualGatewayPathParams = dataclasses.field()
    query_params: UpdateVirtualGatewayQueryParams = dataclasses.field()
    request: UpdateVirtualGatewayRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
