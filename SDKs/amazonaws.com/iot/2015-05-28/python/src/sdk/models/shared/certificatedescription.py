...
class CertificateDescription:
    ...
    previous_owned_by: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('previousOwnedBy'), 'exclude': lambda f: f is None }})  
    ...
    transfer_data: Optional[shared_transferdata.TransferData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transferData'), 'exclude': lambda f: f is None }})  
