...
export class NetworksecurityProjectsLocationsClientTlsPoliciesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsClientTlsPoliciesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsClientTlsPoliciesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
