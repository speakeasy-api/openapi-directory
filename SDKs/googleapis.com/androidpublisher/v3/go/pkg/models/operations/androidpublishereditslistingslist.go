...
type AndroidpublisherEditsListingsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidpublisherEditsListingsListPathParams struct {
...
type AndroidpublisherEditsListingsListQueryParams struct {
	// V1 error format.
...
type AndroidpublisherEditsListingsListRequest struct {
...
type AndroidpublisherEditsListingsListResponse struct {
	ContentType string
	// Successful response
