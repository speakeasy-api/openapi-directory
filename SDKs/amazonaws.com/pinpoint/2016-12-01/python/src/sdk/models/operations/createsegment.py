...
class CreateSegmentRequestBody:
    ...
    write_segment_request: CreateSegmentRequestBodyWriteSegmentRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('WriteSegmentRequest') }})
    r"""Specifies the configuration, dimension, and other settings for a segment. A WriteSegmentRequest object can include a Dimensions object or a SegmentGroups object, but not both."""  
