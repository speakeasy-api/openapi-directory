...
class Asn1Subject:
    ...
    distinguished_name_qualifier: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DistinguishedNameQualifier') }})
    generation_qualifier: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('GenerationQualifier') }})
    ...
    pseudonym: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Pseudonym') }})
