...
exports.CloudMonitoring = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var CloudMonitoring = /** @class */ (function () {
    function CloudMonitoring(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Imports event logs related to the onboarding app into elastisearch
     */
    CloudMonitoring.prototype.createOrganizationInventoryOnboardingCloudMonitoringExportEvent = function (req, config) {
        var _a;
     ...
     * Commits the import operation to complete the onboarding of a device into Dashboard for monitoring.
     */
    CloudMonitoring.prototype.createOrganizationInventoryOnboardingCloudMonitoringImport = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
     ...
     * Check the status of a committed Import operation
     */
    CloudMonitoring.prototype.getOrganizationInventoryOnboardingCloudMonitoringImports = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
     ...
     * Returns list of networks eligible for adding cloud monitored device
     */
    CloudMonitoring.prototype.getOrganizationInventoryOnboardingCloudMonitoringNetworks = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
