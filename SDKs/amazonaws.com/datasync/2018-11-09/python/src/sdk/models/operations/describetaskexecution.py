...
class DescribeTaskExecutionRequest:
    ...
    describe_task_execution_request: shared_describetaskexecutionrequest.DescribeTaskExecutionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
