...
func (e CreateDeviceSwitchRoutingInterfaceRequestBodyMulticastRoutingEnum) ToPointer() *CreateDeviceSwitchRoutingInterfaceRequestBodyMulticastRoutingEnum {
	return &e
}
...
func (e *CreateDeviceSwitchRoutingInterfaceRequestBodyMulticastRoutingEnum) UnmarshalJSON(data []byte) error {
	...
	case "disabled":
		fallthrough
	case "enabled":
		*e = CreateDeviceSwitchRoutingInterfaceRequestBodyMulticastRoutingEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDeviceSwitchRoutingInterfaceRequestBodyMulticastRoutingEnum: %v", v)
	}
}
