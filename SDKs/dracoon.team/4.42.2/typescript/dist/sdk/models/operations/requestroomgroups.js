...
exports.RequestRoomGroupsResponse = exports.RequestRoomGroupsRequest = void 0;
...
var RequestRoomGroupsRequest = /** @class */ (function (_super) {
    ...
    ], RequestRoomGroupsRequest.prototype, "xSdsAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], RequestRoomGroupsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], RequestRoomGroupsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], RequestRoomGroupsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=room_id",
        }),
        __metadata("design:type", Number)
    ], RequestRoomGroupsRequest.prototype, "roomId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], RequestRoomGroupsRequest.prototype, "sort", void 0);
    return RequestRoomGroupsRequest;
}(utils_1.SpeakeasyBase));
exports.RequestRoomGroupsRequest = RequestRoomGroupsRequest;
var RequestRoomGroupsResponse = /** @class */ (function (_super) {
    ...
    ], RequestRoomGroupsResponse.prototype, "rawResponse", void 0);
    return RequestRoomGroupsResponse;
}(utils_1.SpeakeasyBase));
exports.RequestRoomGroupsResponse = RequestRoomGroupsResponse;
