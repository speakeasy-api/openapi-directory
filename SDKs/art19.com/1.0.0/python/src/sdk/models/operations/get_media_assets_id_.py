...
class GetMediaAssetsIDRequest:
    ...
    r"""The ID of the media asset resource to load."""  
...
class GetMediaAssetsID200ApplicationVndAPIPlusJSON:
    ...
    data: Optional[shared_mediaasset.MediaAsset] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
