...
type RecommenderProjectsLocationsRecommendersRecommendationsMarkFailedRequest struct {
	...
	GoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest *shared.GoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest `request:"mediaType=application/json"`
	// OAuth access token.
