...
type GamesRevisionsCheckSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type GamesRevisionsCheckQueryParams struct {
	// V1 error format.
	...
	ClientRevision string `queryParam:"style=form,explode=true,name=clientRevision"`
