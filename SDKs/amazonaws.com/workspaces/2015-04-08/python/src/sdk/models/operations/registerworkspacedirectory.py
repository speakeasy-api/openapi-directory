...
class RegisterWorkspaceDirectoryRequest:
    ...
    register_workspace_directory_request: shared_registerworkspacedirectoryrequest.RegisterWorkspaceDirectoryRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
