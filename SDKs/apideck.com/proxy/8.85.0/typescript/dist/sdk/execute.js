...
var Execute = /** @class */ (function () {
     ...
     *
    **/
    Execute.prototype.deleteProxy = function (req, config) {
     ...
     *
    **/
    Execute.prototype.getProxy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Execute.prototype.optionsProxy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Execute.prototype.patchProxy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Execute.prototype.postProxy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Execute.prototype.putProxy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
