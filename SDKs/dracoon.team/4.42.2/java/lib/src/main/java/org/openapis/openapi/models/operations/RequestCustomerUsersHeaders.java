...
public class RequestCustomerUsersHeaders {
    /**
    ...
    public RequestCustomerUsersHeaders withXSdsDateFormat(RequestCustomerUsersXSdsDateFormatEnum xSdsDateFormat) {
    ...
    public RequestCustomerUsersHeaders withXSdsServiceToken(String xSdsServiceToken) {
