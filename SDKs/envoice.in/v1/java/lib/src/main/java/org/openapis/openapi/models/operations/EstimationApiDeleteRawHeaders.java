...
public class EstimationApiDeleteRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public EstimationApiDeleteRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public EstimationApiDeleteRawHeaders withXAuthSecret(String xAuthSecret) {
