...
class UpdateParallelDataRequest:
    ...
    update_parallel_data_request: shared_updateparalleldatarequest.UpdateParallelDataRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
