...
class GetMeTagsTagsTopQuestionsQueryParams:
    ...
    order: Optional[GetMeTagsTagsTopQuestionsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeTagsTagsTopQuestionsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetMeTagsTagsTopQuestionsRequest:
    path_params: GetMeTagsTagsTopQuestionsPathParams = dataclasses.field()
    query_params: GetMeTagsTagsTopQuestionsQueryParams = dataclasses.field()
