...
export class ConnectorsProjectsLocationsConnectionsRuntimeActionSchemasListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ConnectorsProjectsLocationsConnectionsRuntimeActionSchemasListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ConnectorsProjectsLocationsConnectionsRuntimeActionSchemasListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
