...
export class Tags {
   ...
   */
  collectionTagsAll(
    req: operations.CollectionTagsAllRequest,
    security: operations.CollectionTagsAllSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.CollectionTagsAllResponse> {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CollectionTagsAllResponse =
        new operations.CollectionTagsAllResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getCollectionTagsResponse = utils.objectToClass(
              httpRes?.data,
              shared.GetCollectionTagsResponse
            );
          }
          break;
