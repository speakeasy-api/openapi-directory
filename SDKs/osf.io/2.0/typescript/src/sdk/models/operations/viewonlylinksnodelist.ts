 ...
 */
export enum ViewOnlyLinksNodeListNodeAttributesCategoryEnum {
  Analysis = "analysis",
 ...
 */
export class ViewOnlyLinksNodeListNodeAttributes extends SpeakeasyBase {
  /**
   * The category of the node, as selected by project contributors.
   */
  @SpeakeasyMetadata()
  category: ViewOnlyLinksNodeListNodeAttributesCategoryEnum;
 ...
 */
export class ViewOnlyLinksNodeListNodeLinks extends SpeakeasyBase {
  /**
 ...
 */
export class ViewOnlyLinksNodeListNodeRelationships extends SpeakeasyBase {
  /**
...
export class ViewOnlyLinksNodeListNode extends SpeakeasyBase {
  /**
   * The properties of the node entity.
   */
  @SpeakeasyMetadata()
  attributes: ViewOnlyLinksNodeListNodeAttributes;
   ...
   */
  @SpeakeasyMetadata()
  links?: ViewOnlyLinksNodeListNodeLinks;

  /**
   * URLs to other entities or entity collections that have a relationship to the node entity.
   */
  @SpeakeasyMetadata()
  relationships?: ViewOnlyLinksNodeListNodeRelationships;
