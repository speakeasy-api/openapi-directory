...
class GetPostsIdsPathParams:
    ids: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ids', 'style': 'simple', 'explode': False }})
    
class GetPostsIdsOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetPostsIdsSortEnum(str, Enum):
    ACTIVITY = "activity"
    CREATION = "creation"
    VOTES = "votes"
...
class GetPostsIdsQueryParams:
    ...
    order: Optional[GetPostsIdsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetPostsIdsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetPostsIdsRequest:
    path_params: GetPostsIdsPathParams = dataclasses.field()
    query_params: GetPostsIdsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetPostsIdsResponse:
