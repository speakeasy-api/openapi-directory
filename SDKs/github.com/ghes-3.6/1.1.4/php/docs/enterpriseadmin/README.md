...
try {
    ...
    $request->enterprise = 'impedit';
    $request->orgId = 131055;
    $request->runnerGroupId = 376226;
...
try {
    ...
    $request->runnerGroupId = 491025;
    $request->runnerId = 115484;
...
try {
    ...
    $request->license = 'maiores';
    $request->password = 'natus';
    $request->settings = 'velit';
...
try {
    ...
    $request->config->contentType = 'voluptatibus';
    $request->config->insecureSsl = 'voluptas';
    $request->config->secret = 'asperiores';
    $request->config->url = 'aperiam';
    $request->events = [
        'quaerat',
        'consequuntur',
    ];
    $request->name = 'Luke Schoen';
...
try {
    ...
    $request->enforcement = 'vel';
    $request->environment = [
        'quos' => 'vel',
        'labore' => 'possimus',
    ];
    $request->name = 'Felipe Johns';
    $request->script = 'reiciendis';
...
try {
    ...
    $request->email = 'Sim_Feest@hotmail.com';
...
try {
    ...
    $request->preReceiveEnvironmentId = 272437;
...
try {
    ...
    $request->preReceiveHookId = 132815;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\EnterpriseAdminDeleteScimGroupFromEnterpriseRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new EnterpriseAdminDeleteScimGroupFromEnterpriseRequest();
    $request->scimGroupId = '7fce0092-d52e-4f76-b727-3955bd72c939';

    $response = $sdk->enterpriseAdmin->enterpriseAdminDeleteScimGroupFromEnterprise($request);
...
try {
    ...
    $request->username = 'Marilou.Ferry50';
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\EnterpriseAdminDeleteUserFromEnterpriseRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new EnterpriseAdminDeleteUserFromEnterpriseRequest();
    $request->scimUserId = 'in';

    $response = $sdk->enterpriseAdmin->enterpriseAdminDeleteUserFromEnterprise($request);
...
try {
    ...
    $request->maintenance = 'blanditiis';
...
try {
    ...
    $request->enterprise = 'quas';
    $request->orgId = 942584;
...
try {
    ...
    $request->preReceiveEnvironmentId = 699575;
...
try {
    ...
    $request->preReceiveEnvironmentId = 131852;
...
try {
    ...
    $request->preReceiveHookId = 994401;
...
try {
    ...
    $request->org = 'facilis';
    $request->preReceiveHookId = 451822;
...
try {
    ...
    $request->preReceiveHookId = 70869;
    $request->repo = 'iste';
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\EnterpriseAdminGetProvisioningInformationForEnterpriseGroupRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new EnterpriseAdminGetProvisioningInformationForEnterpriseGroupRequest();
    $request->excludedAttributes = 'members';
    $request->scimGroupId = '7fce0092-d52e-4f76-b727-3955bd72c939';

    $response = $sdk->enterpriseAdmin->enterpriseAdminGetProvisioningInformationForEnterpriseGroup($request);

    if ($response->scimEnterpriseGroupResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\EnterpriseAdminGetProvisioningInformationForEnterpriseUserRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new EnterpriseAdminGetProvisioningInformationForEnterpriseUserRequest();
    $request->scimUserId = 'dolore';

    $response = $sdk->enterpriseAdmin->enterpriseAdminGetProvisioningInformationForEnterpriseUser($request);

    if ($response->scimEnterpriseUserResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\EnterpriseAdminListProvisionedGroupsEnterpriseRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new EnterpriseAdminListProvisionedGroupsEnterpriseRequest();
    $request->count = 1;
    $request->excludedAttributes = 'members';
    $request->filter = 'non';
    $request->startIndex = 1;

    $response = $sdk->enterpriseAdmin->enterpriseAdminListProvisionedGroupsEnterprise($request);

    if ($response->scimEnterpriseGroupList !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\EnterpriseAdminListProvisionedIdentitiesEnterpriseRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new EnterpriseAdminListProvisionedIdentitiesEnterpriseRequest();
    $request->count = 1;
    $request->excludedAttributes = 'members';
    $request->filter = 'officiis';
    $request->startIndex = 1;

    $response = $sdk->enterpriseAdmin->enterpriseAdminListProvisionedIdentitiesEnterprise($request);

    if ($response->scimEnterpriseUserList !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->page = 708609;
    $request->perPage = 310381;
    $request->since = 'incidunt';
...
try {
    ...
    $request->page = 333507;
    $request->perPage = 329543;
    $request->visibleToOrganization = 'recusandae';
...
try {
    ...
    $request->enterprise = 'aperiam';
    $request->page = 901483;
    $request->perPage = 253642;
    $request->runnerGroupId = 329935;
...
use \OpenAPI\OpenAPI\Models\Shared\GroupSchemasEnum;
...
try {
    $request = new Group();
    $request->displayName = 'Engineering';
    $request->externalId = '8aa1a0c0-c4c3-4bc0-b4a5-2ef676900159';
    $request->members = [
        new GroupMembers(),
        new GroupMembers(),
        new GroupMembers(),
    ...
    $request->schemas = [
        GroupSchemasEnum::URN_IETF_PARAMS_SCIM_SCHEMAS_CORE20_GROUP,
        GroupSchemasEnum::URN_IETF_PARAMS_SCIM_SCHEMAS_CORE20_GROUP,
        GroupSchemasEnum::URN_IETF_PARAMS_SCIM_SCHEMAS_CORE20_GROUP,
    ];

    $response = $sdk->enterpriseAdmin->enterpriseAdminProvisionEnterpriseGroup($request);
...
use \OpenAPI\OpenAPI\Models\Shared\UserEmails;
use \OpenAPI\OpenAPI\Models\Shared\UserName;
use \OpenAPI\OpenAPI\Models\Shared\UserRole;
use \OpenAPI\OpenAPI\Models\Shared\UserRoleValueEnum;
use \OpenAPI\OpenAPI\Models\Shared\UserSchemasEnum;
...
try {
    $request = new User();
    $request->active = true;
    $request->displayName = 'Mona Lisa';
    $request->emails = [
        new UserEmails(),
        new UserEmails(),
    ];
    $request->externalId = 'E012345';
    $request->name = new UserName();
    $request->name->familyName = 'Octocat';
    $request->name->formatted = 'Ms. Mona Lisa Octocat';
    $request->name->givenName = 'Mona';
    $request->name->middleName = 'Lisa';
    $request->roles = [
        new UserRole(),
        new UserRole(),
        new UserRole(),
    ...
    $request->schemas = [
        UserSchemasEnum::URN_IETF_PARAMS_SCIM_SCHEMAS_CORE20_USER,
        UserSchemasEnum::URN_IETF_PARAMS_SCIM_SCHEMAS_CORE20_USER,
        UserSchemasEnum::URN_IETF_PARAMS_SCIM_SCHEMAS_CORE20_USER,
    ];
    $request->userName = 'E012345';

    $response = $sdk->enterpriseAdmin->enterpriseAdminProvisionEnterpriseUser($request);
...
try {
    ...
    $request->authorizedKey = 'expedita';
...
try {
    ...
    $request->enterprise = 'debitis';
    $request->name = 'Sonya Heaney';
    $request->runnerId = 548361;
...
try {
    ...
    $request->orgId = 272683;
    $request->runnerGroupId = 543678;
...
try {
    ...
    $request->org = 'fugit';
    $request->preReceiveHookId = 282699;
...
try {
    ...
    $request->preReceiveHookId = 30235;
    $request->repo = 'culpa';
...
try {
    ...
    $request->enterprise = 'expedita';
    $request->runnerGroupId = 299643;
    $request->runnerId = 7884;
...
try {
    ...
    $request->enterprise = 'blanditiis';
    $request->runnerId = 405942;
...
try {
    ...
    $request->requestBody->enabledOrganizations = EnabledOrganizationsEnum::ALL;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\EnterpriseAdminSetInformationForProvisionedEnterpriseGroupRequest;
use \OpenAPI\OpenAPI\Models\Shared\Group;
use \OpenAPI\OpenAPI\Models\Shared\GroupMembers;
use \OpenAPI\OpenAPI\Models\Shared\GroupSchemasEnum;
...
try {
    $request = new EnterpriseAdminSetInformationForProvisionedEnterpriseGroupRequest();
    $request->group = new Group();
    $request->group->displayName = 'Engineering';
    $request->group->externalId = '8aa1a0c0-c4c3-4bc0-b4a5-2ef676900159';
    $request->group->members = [
        new GroupMembers(),
        new GroupMembers(),
    ];
    $request->group->schemas = [
        GroupSchemasEnum::URN_IETF_PARAMS_SCIM_SCHEMAS_CORE20_GROUP,
        GroupSchemasEnum::URN_IETF_PARAMS_SCIM_SCHEMAS_CORE20_GROUP,
        GroupSchemasEnum::URN_IETF_PARAMS_SCIM_SCHEMAS_CORE20_GROUP,
        GroupSchemasEnum::URN_IETF_PARAMS_SCIM_SCHEMAS_CORE20_GROUP,
    ...
    $response = $sdk->enterpriseAdmin->enterpriseAdminSetInformationForProvisionedEnterpriseGroup($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\EnterpriseAdminSetInformationForProvisionedEnterpriseUserRequest;
use \OpenAPI\OpenAPI\Models\Shared\User;
use \OpenAPI\OpenAPI\Models\Shared\UserEmails;
use \OpenAPI\OpenAPI\Models\Shared\UserName;
use \OpenAPI\OpenAPI\Models\Shared\UserRole;
...
try {
    $request = new EnterpriseAdminSetInformationForProvisionedEnterpriseUserRequest();
    $request->scimUserId = 'error';
    $request->user = new User();
    $request->user->active = true;
    $request->user->displayName = 'Mona Lisa';
    $request->user->emails = [
        new UserEmails(),
    ];
    $request->user->externalId = 'E012345';
    $request->user->name = new UserName();
    $request->user->name->familyName = 'Octocat';
    $request->user->name->formatted = 'Ms. Mona Lisa Octocat';
    $request->user->name->givenName = 'Mona';
    $request->user->name->middleName = 'Lisa';
    $request->user->roles = [
        new UserRole(),
        new UserRole(),
    ];
    ...
    $request->user->userName = 'E012345';

    $response = $sdk->enterpriseAdmin->enterpriseAdminSetInformationForProvisionedEnterpriseUser($request);
...
try {
    ...
    $request->enterprise = 'dicta';
    $request->runnerGroupId = 99416;
...
try {
    ...
    $request->preReceiveEnvironmentId = 600392;
...
try {
    ...
    $request->requestBody->reason = 'reiciendis';
    $request->username = 'Laila_Skiles1';
...
try {
    ...
    $request->username = 'Maurine_Kiehn50';
...
try {
    ...
    $request->requestBody->reason = 'mollitia';
    $request->username = 'Estella_Barrows9';
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\EnterpriseAdminUpdateAttributeForEnterpriseGroupRequest;
use \OpenAPI\OpenAPI\Models\Shared\PatchSchema;
use \OpenAPI\OpenAPI\Models\Shared\PatchSchemaOperations;
use \OpenAPI\OpenAPI\Models\Shared\PatchSchemaOperationsOpEnum;
use \OpenAPI\OpenAPI\Models\Shared\PatchSchemaSchemasEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new EnterpriseAdminUpdateAttributeForEnterpriseGroupRequest();
    $request->patchSchema = new PatchSchema();
    $request->patchSchema->operations = [
        new PatchSchemaOperations(),
        new PatchSchemaOperations(),
        new PatchSchemaOperations(),
    ];
    $request->patchSchema->schemas = [
        PatchSchemaSchemasEnum::URN_IETF_PARAMS_SCIM_API_MESSAGES20_PATCH_OP,
        PatchSchemaSchemasEnum::URN_IETF_PARAMS_SCIM_API_MESSAGES20_PATCH_OP,
    ];
    $request->scimGroupId = '7fce0092-d52e-4f76-b727-3955bd72c939';

    $response = $sdk->enterpriseAdmin->enterpriseAdminUpdateAttributeForEnterpriseGroup($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\EnterpriseAdminUpdateAttributeForEnterpriseUserRequest;
use \OpenAPI\OpenAPI\Models\Shared\PatchSchema;
use \OpenAPI\OpenAPI\Models\Shared\PatchSchemaOperations;
use \OpenAPI\OpenAPI\Models\Shared\PatchSchemaOperationsOpEnum;
use \OpenAPI\OpenAPI\Models\Shared\PatchSchemaSchemasEnum;
...
try {
    $request = new EnterpriseAdminUpdateAttributeForEnterpriseUserRequest();
    $request->patchSchema = new PatchSchema();
    $request->patchSchema->operations = [
        new PatchSchemaOperations(),
        new PatchSchemaOperations(),
    ...
    $request->scimUserId = 'suscipit';

    $response = $sdk->enterpriseAdmin->enterpriseAdminUpdateAttributeForEnterpriseUser($request);
...
try {
    ...
    $request->requestBody->config->contentType = 'quidem';
    $request->requestBody->config->insecureSsl = 'maxime';
    $request->requestBody->config->secret = 'et';
    $request->requestBody->config->url = 'esse';
    $request->requestBody->events = [
        'assumenda',
    ];
    $request->hookId = 410301;
...
try {
    ...
    $request->requestBody->ldapDn = 'atque';
    $request->teamId = 623295;
...
try {
    ...
    $request->requestBody->ldapDn = 'officiis';
    $request->username = 'Sherman.Thompson';
...
try {
    ...
    $request->requestBody->login = 'aspernatur';
    $request->org = 'ex';
...
try {
    ...
    $request->requestBody->imageUrl = 'maiores';
    $request->requestBody->name = 'Wilfred Mueller';
    $request->preReceiveEnvironmentId = 922348;
...
try {
    ...
    $request->requestBody->enforcement = 'atque';
    $request->requestBody->environment = [
        'sunt' => 'recusandae',
        'dolorum' => 'repellendus',
        'labore' => 'reiciendis',
    ];
    $request->requestBody->name = 'Mr. Elvira Buckridge';
    $request->requestBody->script = 'enim';
    $request->requestBody->scriptRepository = [
        'velit' => 'a',
        'molestias' => 'magnam',
    ];
    $request->preReceiveHookId = 906355;
...
try {
    ...
    $request->requestBody->allowDownstreamConfiguration = false;
    $request->requestBody->enforcement = 'consequuntur';
    $request->org = 'occaecati';
    $request->preReceiveHookId = 886305;
...
try {
    ...
    $request->owner = 'in';
    $request->preReceiveHookId = 238043;
...
try {
    ...
    $request->requestBody->allowsPublicRepositories = false;
    $request->requestBody->name = 'Carlos Considine';
    $request->requestBody->restrictedToWorkflows = false;
    $request->requestBody->selectedWorkflows = [
        'octo-org/octo-repo/.github/workflows/deploy.yaml@main',
        'octo-org/octo-repo/.github/workflows/deploy.yaml@main',
...
try {
    ...
    $request->requestBody->login = 'quidem';
    $request->username = 'Tamara.Franey43';
