...
class PublicT 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetpublicdataRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\GetpublicdataSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\GetpublicdataResponse
     */
	public function getpublicdata(
        \OpenAPI\OpenAPI\Models\Operations\GetpublicdataRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\GetpublicdataSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\GetpublicdataResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/getpublicdata');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\GetpublicdataRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetpublicdataResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->naPublicDataResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\NAPublicDataResponse', 'json');
            }
        }
