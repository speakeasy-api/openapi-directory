...
@dataclasses.dataclass
class GamesManagementScoresResetForAllPlayersQueryParams:
...
class GamesManagementScoresResetForAllPlayersRequest:
    path_params: GamesManagementScoresResetForAllPlayersPathParams = dataclasses.field()
    query_params: GamesManagementScoresResetForAllPlayersQueryParams = dataclasses.field()
    security: GamesManagementScoresResetForAllPlayersSecurity = dataclasses.field()
