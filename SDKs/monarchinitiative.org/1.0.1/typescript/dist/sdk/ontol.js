...
exports.Ontol = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var Ontol = /** @class */ (function () {
    function Ontol(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Ontol.prototype.getExtractOntologySubgraphResource = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetExtractOntologySubgraphResourceRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ontol/subgraph/{ontology}/{node}", req.pathParams);
    ...
    **/
    Ontol.prototype.getInformationContentResource = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetInformationContentResourceRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ontol/information_content/{subject_category}/{object_category}/{subject_taxon}", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    **/
    Ontol.prototype.postExtractOntologySubgraphResource = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
