...
export class ConnectorsProjectsLocationsConnectionsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum ConnectorsProjectsLocationsConnectionsListViewEnum {
  ConnectionViewUnspecified = "CONNECTION_VIEW_UNSPECIFIED",
  Basic = "BASIC",
  Full = "FULL",
}

export class ConnectorsProjectsLocationsConnectionsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ConnectorsProjectsLocationsConnectionsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
