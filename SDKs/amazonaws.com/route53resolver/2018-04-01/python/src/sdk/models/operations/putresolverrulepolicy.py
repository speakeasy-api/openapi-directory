...
class PutResolverRulePolicyRequest:
    ...
    put_resolver_rule_policy_request: shared_putresolverrulepolicyrequest.PutResolverRulePolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
