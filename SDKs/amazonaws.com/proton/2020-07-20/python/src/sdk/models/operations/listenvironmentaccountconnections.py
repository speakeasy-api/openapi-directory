...
class ListEnvironmentAccountConnectionsRequest:
    ...
    list_environment_account_connections_input: shared_listenvironmentaccountconnectionsinput.ListEnvironmentAccountConnectionsInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
