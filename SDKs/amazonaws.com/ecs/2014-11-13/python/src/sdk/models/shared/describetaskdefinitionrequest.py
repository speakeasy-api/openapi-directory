...
class DescribeTaskDefinitionRequest:
    ...
    include: Optional[list[shared_taskdefinitionfield_enum.TaskDefinitionFieldEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('include'), 'exclude': lambda f: f is None }})  
