...
export class CreateInternationalScheduledPaymentConsentsRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateInternationalScheduledPaymentConsentsRawRequest extends SpeakeasyBase {
  /**
...
export class CreateInternationalScheduledPaymentConsentsRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
