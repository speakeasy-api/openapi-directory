...
class CreateCompositionSettingsRequest:
    security: CreateCompositionSettingsSecurity = dataclasses.field()
    request: Optional[CreateCompositionSettingsCreateCompositionSettingsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
