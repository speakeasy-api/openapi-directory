...
type DisplayvideoAdvertisersManualTriggersPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DisplayvideoAdvertisersManualTriggersPatchPathParams struct {
...
type DisplayvideoAdvertisersManualTriggersPatchQueryParams struct {
	// V1 error format.
...
type DisplayvideoAdvertisersManualTriggersPatchResponse struct {
	ContentType string
	// Successful response
