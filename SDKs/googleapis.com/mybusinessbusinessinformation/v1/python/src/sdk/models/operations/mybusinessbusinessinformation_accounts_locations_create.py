...
class MybusinessbusinessinformationAccountsLocationsCreateRequest:
    ...
    r"""Required. The name of the account in which to create this location."""  
    ...
    r"""Optional. A unique request ID for the server to detect duplicated requests. We recommend using UUIDs. Max length is 50 characters."""  
    ...
    r"""Optional. If true, the request is validated without actually creating the location."""  
