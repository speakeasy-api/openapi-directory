...
class OBWriteDomesticConsent4DataAuthorisation:
    ...
    authorisation_type: OBWriteDomesticConsent4DataAuthorisationAuthorisationTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AuthorisationType') }})
    r"""Type of authorisation flow requested."""  
...
class OBWriteDomesticConsent4DataInitiation:
    ...
    creditor_account: OBWriteDomesticConsent4DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreditorAccount') }})
    r"""Unambiguous identification of the account of the creditor to which a credit entry will be posted as a result of the payment transaction."""  
    ...
    """  
    instructed_amount: OBWriteDomesticConsent4DataInitiationInstructedAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InstructedAmount') }})
    r"""Amount of money to be moved between the debtor and creditor, before deduction of charges, expressed in the currency as ordered by the initiating party.
    Usage: This amount has to be transported unchanged through the transaction chain.
    """  
    ...
    debtor_account: Optional[OBWriteDomesticConsent4DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DebtorAccount'), 'exclude': lambda f: f is None }})
    r"""Unambiguous identification of the account of the debtor to which a debit entry will be made as a result of the transaction."""  
    ...
    """  
    remittance_information: Optional[OBWriteDomesticConsent4DataInitiationRemittanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RemittanceInformation'), 'exclude': lambda f: f is None }})
    r"""Information supplied to enable the matching of an entry with the items that the transfer is intended to settle, such as commercial invoices in an accounts' receivable system."""  
...
class OBWriteDomesticConsent4Data:
    ...
    initiation: OBWriteDomesticConsent4DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Initiation') }})
    r"""The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds from the debtor account to a creditor for a single domestic payment."""  
    authorisation: Optional[OBWriteDomesticConsent4DataAuthorisation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Authorisation'), 'exclude': lambda f: f is None }})
    r"""The authorisation type request from the TPP."""  
    read_refund_account: Optional[OBWriteDomesticConsent4DataReadRefundAccountEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ReadRefundAccount'), 'exclude': lambda f: f is None }})
    r"""Specifies to share the refund account details with PISP"""  
...
class OBWriteDomesticConsent4:
    ...
    data: OBWriteDomesticConsent4Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Data') }})  
