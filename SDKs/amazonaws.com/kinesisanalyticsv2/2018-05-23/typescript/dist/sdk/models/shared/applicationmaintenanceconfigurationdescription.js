...
exports.ApplicationMaintenanceConfigurationDescription = void 0;
var utils_1 = require("../../../internal/utils");
var class_transformer_1 = require("class-transformer");
/**
 * The details of the maintenance configuration for the application.
 */
var ApplicationMaintenanceConfigurationDescription = /** @class */ (function (_super) {
    __extends(ApplicationMaintenanceConfigurationDescription, _super);
    function ApplicationMaintenanceConfigurationDescription() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ApplicationMaintenanceWindowEndTime" }),
        __metadata("design:type", String)
    ], ApplicationMaintenanceConfigurationDescription.prototype, "applicationMaintenanceWindowEndTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ApplicationMaintenanceWindowStartTime" }),
        __metadata("design:type", String)
