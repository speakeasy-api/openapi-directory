...
class DisassociateMembersHeaders:
...
class DisassociateMembersRequest:
    headers: DisassociateMembersHeaders = dataclasses.field()
    request: DisassociateMembersRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DisassociateMembersResponse:
    ...
    disassociate_members_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
