...
export declare class IpGeolocationWithConfidenceAreaApiRequest extends SpeakeasyBase {
    /**
...
export declare class IpGeolocationWithConfidenceAreaApiResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
