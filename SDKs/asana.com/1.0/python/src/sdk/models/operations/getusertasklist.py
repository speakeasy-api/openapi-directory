...
class GetUserTaskListRequest:
    ...
    r"""Globally unique identifier for the user task list."""  
...
class GetUserTaskList200ApplicationJSON:
    r"""Successfully retrieved the user task list."""
    
    data: Optional[shared_usertasklistresponse.UserTaskListResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
