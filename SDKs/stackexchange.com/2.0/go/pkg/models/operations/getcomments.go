...
func (e *GetCommentsOrderEnum) UnmarshalJSON(data []byte) error {
	...
	case "desc":
		fallthrough
	case "asc":
		*e = GetCommentsOrderEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCommentsOrderEnum: %s", s)
	}
}
...
func (e *GetCommentsSortEnum) UnmarshalJSON(data []byte) error {
	...
	case "creation":
		fallthrough
	case "votes":
		*e = GetCommentsSortEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCommentsSortEnum: %s", s)
	}
}
