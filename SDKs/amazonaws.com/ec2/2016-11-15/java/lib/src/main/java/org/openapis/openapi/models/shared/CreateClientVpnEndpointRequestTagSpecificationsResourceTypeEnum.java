 ...
 */
public enum CreateClientVpnEndpointRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateClientVpnEndpointRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
