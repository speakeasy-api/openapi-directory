...
class DeleteAlternateContactRequestBodyAlternateContactTypeEnum(str, Enum):
    r"""Specifies which of the alternate contacts to delete."""
    BILLING = 'BILLING'
...
class DeleteAlternateContactRequestBody:
    ...
    alternate_contact_type: DeleteAlternateContactRequestBodyAlternateContactTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AlternateContactType') }})
    r"""Specifies which of the alternate contacts to delete."""  
...
class DeleteAlternateContactRequest:
    ...
    request_body: DeleteAlternateContactRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
