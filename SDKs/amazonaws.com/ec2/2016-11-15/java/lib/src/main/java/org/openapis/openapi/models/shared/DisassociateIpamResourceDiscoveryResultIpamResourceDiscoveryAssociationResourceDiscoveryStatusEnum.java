 ...
 */
public enum DisassociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationResourceDiscoveryStatusEnum {
    ACTIVE("active"),
    NOT_FOUND("not-found");
    ...
    private DisassociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationResourceDiscoveryStatusEnum(String value) {
        this.value = value;
    }
}
