...
export class DisplayvideoAdvertisersChannelsSitesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersChannelsSitesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersChannelsSitesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
