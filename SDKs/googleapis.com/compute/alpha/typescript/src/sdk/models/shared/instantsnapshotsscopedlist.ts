 ...
 */
export enum InstantSnapshotsScopedListWarningCodeEnum {
...
export class InstantSnapshotsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstantSnapshotsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstantSnapshotsScopedListWarningData })
  @Expose({ name: "data" })
...
export class InstantSnapshotsScopedList extends SpeakeasyBase {
  /**
   * [Output Only] A list of instantSnapshots contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: InstantSnapshot })
  @Expose({ name: "instantSnapshots" })
