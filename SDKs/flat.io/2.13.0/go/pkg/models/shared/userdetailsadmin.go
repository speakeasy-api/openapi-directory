...
func (e UserDetailsAdminTypeEnum) ToPointer() *UserDetailsAdminTypeEnum {
	return &e
}
...
func (e *UserDetailsAdminTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "user":
		fallthrough
	case "guest":
		*e = UserDetailsAdminTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UserDetailsAdminTypeEnum: %v", v)
	}
}
