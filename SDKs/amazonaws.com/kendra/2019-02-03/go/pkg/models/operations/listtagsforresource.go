...
const (
	ListTagsForResourceXAmzTargetEnumAwsKendraFrontendServiceListTagsForResource ListTagsForResourceXAmzTargetEnum = "AWSKendraFrontendService.ListTagsForResource"
)
