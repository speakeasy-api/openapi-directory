...
public class FetchEntityRequest {
    ...
    public FetchEntityRequest withIdentity(String identity) {
    ...
    public FetchEntityRequest withServiceSid(String serviceSid) {
        this.serviceSid = serviceSid;
        return this;
    }
    
    public FetchEntityRequest(@JsonProperty("Identity") String identity, @JsonProperty("ServiceSid") String serviceSid) {
        this.identity = identity;
        this.serviceSid = serviceSid;
  }
}
