 ...
 */
export enum GetNetworkConnectionStatsBandEnum {
  Two4 = "2.4",
  Five = "5",
}

export class GetNetworkConnectionStatsRequest extends SpeakeasyBase {
  /**
  ...
  band?: GetNetworkConnectionStatsBandEnum;
...
export class GetNetworkConnectionStatsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getNetworkConnectionStats200ApplicationJSONObject?: Record<string, any>;
}
