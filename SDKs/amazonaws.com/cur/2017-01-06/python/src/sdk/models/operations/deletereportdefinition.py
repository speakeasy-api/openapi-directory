...
class DeleteReportDefinitionRequest:
    ...
    delete_report_definition_request: shared_deletereportdefinitionrequest.DeleteReportDefinitionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
