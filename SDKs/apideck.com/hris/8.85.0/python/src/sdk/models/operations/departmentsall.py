...
from ..shared import getdepartmentsresponse as shared_getdepartmentsresponse
...
class DepartmentsAllQueryParams:
...
@dataclasses.dataclass
class DepartmentsAllRequest:
    headers: DepartmentsAllHeaders = dataclasses.field()
    query_params: DepartmentsAllQueryParams = dataclasses.field()
    security: DepartmentsAllSecurity = dataclasses.field()
    

@dataclasses.dataclass
class DepartmentsAllResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    get_departments_response: Optional[shared_getdepartmentsresponse.GetDepartmentsResponse] = dataclasses.field(default=None)
