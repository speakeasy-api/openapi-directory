 ...
 */
public class GetCurrentUserPosts200ApplicationJSON {
    /**
    ...
    public GetCurrentUserPosts200ApplicationJSON withEndIndex(Long endIndex) {
    ...
    public GetCurrentUserPosts200ApplicationJSON withGroupIds(String[] groupIds) {
    ...
    public GetCurrentUserPosts200ApplicationJSON withLastListingsView(OffsetDateTime lastListingsView) {
    ...
    public GetCurrentUserPosts200ApplicationJSON withNumPages(Long numPages) {
    ...
    public GetCurrentUserPosts200ApplicationJSON withNumPosts(Long numPosts) {
    ...
    @JsonProperty("page")
    public Long page;
    public GetCurrentUserPosts200ApplicationJSON withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetCurrentUserPosts200ApplicationJSON withPerPage(Long perPage) {
    ...
    public GetCurrentUserPosts200ApplicationJSON withPosts(org.openapis.openapi.models.shared.Post[] posts) {
        this.posts = posts;
        return this;
    }
    ...
    public GetCurrentUserPosts200ApplicationJSON withStartIndex(Long startIndex) {
