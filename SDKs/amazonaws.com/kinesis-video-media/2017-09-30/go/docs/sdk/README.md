...
func main() {
    ...
    res, err := s.SDK.GetMedia(ctx, operations.GetMediaRequest{
        RequestBody: operations.GetMediaRequestBody{
            StartSelector: operations.GetMediaRequestBodyStartSelector{
                AfterFragmentNumber: sdk.String("debitis"),
                ContinuationToken: sdk.String("ipsa"),
                StartSelectorType: shared.StartSelectorTypeEnumContinuationToken.ToPointer(),
                StartTimestamp: types.MustTimeFromString("2022-08-14T01:03:07.567Z"),
            },
            StreamARN: sdk.String("molestiae"),
            StreamName: sdk.String("minus"),
        },
