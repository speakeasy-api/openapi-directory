...
class UpdateDeveloperMetadataRequest:
    ...
    r"""The filters matching the developer metadata entries to update."""  
    ...
    r"""The fields that should be updated. At least one field must be specified. The root `developerMetadata` is implied and should not be specified. A single `\\"*\\"` can be used as short-hand for listing every field."""  
