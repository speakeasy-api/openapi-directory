...
export class GoogleCloudRetailV2alphaSearchRequest extends SpeakeasyBase {
  ...
  @Type(() => GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec)
   ...
   */
  @SpeakeasyMetadata({
    elemType: GoogleCloudRetailV2alphaSearchRequestFacetSpec,
  })
  @Expose({ name: "facetSpecs" })
  @Type(() => GoogleCloudRetailV2alphaSearchRequestFacetSpec)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "queryExpansionSpec" })
  @Type(() => GoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "relevanceThreshold" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "spellCorrectionSpec" })
