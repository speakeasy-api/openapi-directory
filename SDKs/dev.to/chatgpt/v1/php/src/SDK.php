...
class SDK
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetArticlesResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/api/articles/search');
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/vnd.forem.api-v1+json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getArticlesResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetArticlesResponse', 'json');
            }
        }
