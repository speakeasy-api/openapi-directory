...
export class Adexchangebuyer2BiddersFilterSetsImpressionMetricsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class Adexchangebuyer2BiddersFilterSetsImpressionMetricsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class Adexchangebuyer2BiddersFilterSetsImpressionMetricsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
