...
class Error401PIISAdditionalErrors:
    ...
    code: shared_messagecode401_piis_enum.MessageCode401PIISEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})
...
class Error401PIIS:
    ...
    additional_errors: Optional[list[Error401PIISAdditionalErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalErrors'), 'exclude': lambda f: f is None }})
