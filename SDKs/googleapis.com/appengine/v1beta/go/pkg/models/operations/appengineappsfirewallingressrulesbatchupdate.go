...
type AppengineAppsFirewallIngressRulesBatchUpdateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AppengineAppsFirewallIngressRulesBatchUpdatePathParams struct {
...
type AppengineAppsFirewallIngressRulesBatchUpdateQueryParams struct {
	// V1 error format.
...
type AppengineAppsFirewallIngressRulesBatchUpdateRequest struct {
	...
	Request     *shared.BatchUpdateIngressRulesRequest `request:"mediaType=application/json"`
	Security    AppengineAppsFirewallIngressRulesBatchUpdateSecurity
}

type AppengineAppsFirewallIngressRulesBatchUpdateResponse struct {
	// Successful response
