...
class StartDeliveryStreamEncryptionRequest:
    ...
    start_delivery_stream_encryption_input: shared_startdeliverystreamencryptioninput.StartDeliveryStreamEncryptionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
