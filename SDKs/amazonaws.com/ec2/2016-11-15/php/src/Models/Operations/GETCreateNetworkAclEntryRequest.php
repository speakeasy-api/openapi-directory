...
class GETCreateNetworkAclEntryRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GETCreateNetworkAclEntryIcmp $icmp
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=Icmp')]
    public ?GETCreateNetworkAclEntryIcmp $icmp = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GETCreateNetworkAclEntryPortRange $portRange
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=PortRange')]
    public ?GETCreateNetworkAclEntryPortRange $portRange = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\GETCreateNetworkAclEntryRuleActionEnum $ruleAction
     */
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETCreateNetworkAclEntryActionEnum::CREATE_NETWORK_ACL_ENTRY;
		$this->cidrBlock = null;
		$this->dryRun = null;
		$this->egress = false;
		$this->icmp = null;
		...
		$this->portRange = null;
		$this->protocol = "";
		$this->ruleAction = \OpenAPI\OpenAPI\Models\Operations\GETCreateNetworkAclEntryRuleActionEnum::ALLOW;
		$this->ruleNumber = 0;
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETCreateNetworkAclEntryVersionEnum::TWO_THOUSAND_AND_SIXTEEN1115;
