 ...
 */
export class DescribeLocalGatewayVirtualInterfaceGroupsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeLocalGatewayVirtualInterfaceGroupsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({
    elemType: DescribeLocalGatewayVirtualInterfaceGroupsRequestFilters,
  })
  filters?: DescribeLocalGatewayVirtualInterfaceGroupsRequestFilters[];
