...
public class TeamsDeleteMembershipSecurity {
    ...
    public TeamsDeleteMembershipSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public TeamsDeleteMembershipSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public TeamsDeleteMembershipSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public TeamsDeleteMembershipSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
