...
exports.GetNetworkWirelessClientLatencyHistoryResponse = exports.GetNetworkWirelessClientLatencyHistoryRequest = void 0;
...
var GetNetworkWirelessClientLatencyHistoryRequest = /** @class */ (function (_super) {
    ...
    ], GetNetworkWirelessClientLatencyHistoryRequest.prototype, "clientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=networkId",
        }),
        __metadata("design:type", String)
    ], GetNetworkWirelessClientLatencyHistoryRequest.prototype, "networkId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=resolution",
        }),
        __metadata("design:type", Number)
    ], GetNetworkWirelessClientLatencyHistoryRequest.prototype, "resolution", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t0" }),
        __metadata("design:type", String)
    ], GetNetworkWirelessClientLatencyHistoryRequest.prototype, "t0", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t1" }),
        __metadata("design:type", String)
    ], GetNetworkWirelessClientLatencyHistoryRequest.prototype, "t1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timespan",
        }),
        __metadata("design:type", Number)
    ], GetNetworkWirelessClientLatencyHistoryRequest.prototype, "timespan", void 0);
...
var GetNetworkWirelessClientLatencyHistoryResponse = /** @class */ (function (_super) {
    ...
    ], GetNetworkWirelessClientLatencyHistoryResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Array)
    ], GetNetworkWirelessClientLatencyHistoryResponse.prototype, "getNetworkWirelessClientLatencyHistory200ApplicationJSONObjects", void 0);
