...
func (e GetDocumentIDAspectIDCivixIndexIDCivixDocumentIDSearchSearchStringAspectIDEnum) ToPointer() *GetDocumentIDAspectIDCivixIndexIDCivixDocumentIDSearchSearchStringAspectIDEnum {
	return &e
}
...
func (e *GetDocumentIDAspectIDCivixIndexIDCivixDocumentIDSearchSearchStringAspectIDEnum) UnmarshalJSON(data []byte) error {
	...
	case "hscr":
		fallthrough
	case "arch_oic":
		*e = GetDocumentIDAspectIDCivixIndexIDCivixDocumentIDSearchSearchStringAspectIDEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDocumentIDAspectIDCivixIndexIDCivixDocumentIDSearchSearchStringAspectIDEnum: %v", v)
	}
}
