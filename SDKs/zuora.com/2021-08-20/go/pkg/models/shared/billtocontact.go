...
type BillToContactOtherPhoneTypeEnum string

const (
	BillToContactOtherPhoneTypeEnumWork   BillToContactOtherPhoneTypeEnum = "Work"
	BillToContactOtherPhoneTypeEnumMobile BillToContactOtherPhoneTypeEnum = "Mobile"
	BillToContactOtherPhoneTypeEnumHome   BillToContactOtherPhoneTypeEnum = "Home"
	BillToContactOtherPhoneTypeEnumOther  BillToContactOtherPhoneTypeEnum = "Other"
)

func (e *BillToContactOtherPhoneTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Home":
		fallthrough
	case "Other":
		*e = BillToContactOtherPhoneTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for BillToContactOtherPhoneTypeEnum: %s", s)
	}
}

// BillToContact - Container for custom fields of a Contact object.
type BillToContact struct {
	...
	//
	OtherPhoneType *BillToContactOtherPhoneTypeEnum `json:"otherPhoneType,omitempty"`
