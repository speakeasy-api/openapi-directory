...
export declare enum Onev21monitoring1alertsPostRequestBodyContentApplication1jsonSchemaCompareEnum {
    GreaterThan = "GreaterThan",
    LessThan = "LessThan"
}
export declare enum Onev21monitoring1alertsPostRequestBodyContentApplication1jsonSchemaTypeEnum {
...
export declare enum Onev21monitoring1alertsPostRequestBodyContentApplication1jsonSchemaWindowEnum {
    Fivem = "5m",
    Tenm = "10m",
    Thirtym = "30m",
    Oneh = "1h"
}
export declare class Onev21monitoring1alertsPostRequestBodyContentApplication1jsonSchema extends SpeakeasyBase {
