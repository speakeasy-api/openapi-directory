...
class PowerOutlet:
    ...
    connected_port: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connected_port'), 'exclude': lambda f: f is None }})  
