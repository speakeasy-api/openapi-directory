...
from ..shared import createupdateprofilerequests as shared_createupdateprofilerequests
...
class UpdateCustomerProfileRequest:
    ...
    create_update_profile_requests: shared_createupdateprofilerequests.CreateUpdateProfileRequests = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
