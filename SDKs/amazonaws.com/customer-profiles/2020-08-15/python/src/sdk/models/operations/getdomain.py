...
from ..shared import getdomainresponse as shared_getdomainresponse
...
class GetDomainResponse:
    ...
    get_domain_response: Optional[shared_getdomainresponse.GetDomainResponse] = dataclasses.field(default=None)
