...
type GetOrganizationCustomRulePolicyHeaders struct {
...
type GetOrganizationCustomRulePolicyRequest struct {
	Headers GetOrganizationCustomRulePolicyHeaders
	Request shared.GetOrganizationCustomRulePolicyRequest `request:"mediaType=application/json"`
}
