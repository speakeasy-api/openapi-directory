...
var SubscriptionPurchase = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=autoRenewing" }),
        __metadata("design:type", Boolean)
    ], SubscriptionPurchase.prototype, "autoRenewing", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=autoResumeTimeMillis" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=expiryTimeMillis" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=introductoryPriceInfo" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=obfuscatedExternalAccountId" }),
        __metadata("design:type", String)
    ], SubscriptionPurchase.prototype, "obfuscatedExternalAccountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=obfuscatedExternalProfileId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=paymentState" }),
        __metadata("design:type", Number)
    ], SubscriptionPurchase.prototype, "paymentState", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=priceAmountMicros" }),
        __metadata("design:type", String)
    ], SubscriptionPurchase.prototype, "priceAmountMicros", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=priceChange" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=priceCurrencyCode" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=promotionCode" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=userCancellationTimeMillis" }),
        __metadata("design:type", String)
