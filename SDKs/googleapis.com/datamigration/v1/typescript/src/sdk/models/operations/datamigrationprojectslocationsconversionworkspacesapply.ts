...
export class DatamigrationProjectsLocationsConversionWorkspacesApplySecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatamigrationProjectsLocationsConversionWorkspacesApplyRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatamigrationProjectsLocationsConversionWorkspacesApplyResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
