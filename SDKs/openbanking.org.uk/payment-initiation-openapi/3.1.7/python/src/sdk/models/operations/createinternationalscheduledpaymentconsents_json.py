...
class CreateInternationalScheduledPaymentConsentsJSONSecurity:
...
class CreateInternationalScheduledPaymentConsentsJSONRequest:
    ...
    ob_write_international_scheduled_consent5: shared_obwriteinternationalscheduledconsent5.OBWriteInternationalScheduledConsent5 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Default"""  
...
@dataclasses.dataclass
class CreateInternationalScheduledPaymentConsentsJSONResponse:
