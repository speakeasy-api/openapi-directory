...
class CreateReplicationInstanceRequest:
    headers: CreateReplicationInstanceHeaders = dataclasses.field()
    request: shared_createreplicationinstancemessage.CreateReplicationInstanceMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
