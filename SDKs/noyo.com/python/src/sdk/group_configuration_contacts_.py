...
class GroupConfigurationContacts:
    ...
    def create_contact(self, request: operations.CreateContactRequest) -> operations.CreateContactResponse:
        ...
        url = utils.generate_url(operations.CreateContactRequest, base_url, '/api/v1/groups/{group_id}/contacts', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "contact_create_request", 'json')
        ...
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ContactResult])
    ...
    def edit_contact(self, request: operations.EditContactRequest) -> operations.EditContactResponse:
        ...
        url = utils.generate_url(operations.EditContactRequest, base_url, '/api/v1/groups/{group_id}/contacts/{contact_id}/{version}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "contact_edit_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.EditContactResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_contact(self, request: operations.GetContactRequest) -> operations.GetContactResponse:
        ...
        url = utils.generate_url(operations.GetContactRequest, base_url, '/api/v1/groups/{group_id}/contacts/{contact_id}', request)
    ...
    def get_contact_list(self, request: operations.GetContactListRequest) -> operations.GetContactListResponse:
        ...
        url = utils.generate_url(operations.GetContactListRequest, base_url, '/api/v1/groups/{group_id}/contacts', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PaginatedContactResult])
