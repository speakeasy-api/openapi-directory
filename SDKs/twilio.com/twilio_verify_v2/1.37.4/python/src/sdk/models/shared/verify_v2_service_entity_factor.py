...
class VerifyV2ServiceEntityFactor:
    ...
    factor_type: Optional[shared_factor_enum_factor_types_enum.FactorEnumFactorTypesEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('factor_type') }})
    ...
    status: Optional[shared_factor_enum_factor_statuses_enum.FactorEnumFactorStatusesEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
