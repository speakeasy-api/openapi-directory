...
type IntegrationsProjectsLocationsProductsIntegrationsExecutionsSuspensionsResolveSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type IntegrationsProjectsLocationsProductsIntegrationsExecutionsSuspensionsResolvePathParams struct {
...
type IntegrationsProjectsLocationsProductsIntegrationsExecutionsSuspensionsResolveQueryParams struct {
	// V1 error format.
...
type IntegrationsProjectsLocationsProductsIntegrationsExecutionsSuspensionsResolveResponse struct {
	ContentType string
	// Successful response
	GoogleCloudIntegrationsV1alphaResolveSuspensionResponse map[string]interface{}
	StatusCode                                              int
