...
**/
var ItemLocation = /** @class */ (function (_super) {
    __extends(ItemLocation, _super);
    ...
    ], ItemLocation.prototype, "countryCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=location" }),
        __metadata("design:type", String)
    ], ItemLocation.prototype, "location", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=postalCode" }),
        __metadata("design:type", String)
    ], ItemLocation.prototype, "postalCode", void 0);
    return ItemLocation;
