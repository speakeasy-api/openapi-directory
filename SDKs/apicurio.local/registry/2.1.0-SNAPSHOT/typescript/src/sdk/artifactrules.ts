...
export class ArtifactRules {
  ...
  **/
  createArtifactRule(
    ...
    const url: string = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/rules", req.pathParams);
  ...
  **/
  deleteArtifactRule(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/rules/{rule}", req.pathParams);
  ...
  **/
  testUpdateArtifact(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/test", req.pathParams);
