...
class GetSendCustomVerificationEmailQueryParams:
    action: GetSendCustomVerificationEmailActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetSendCustomVerificationEmailVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    configuration_set_name: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'ConfigurationSetName', 'style': 'form', 'explode': True }})
...
class GetSendCustomVerificationEmailRequest:
    headers: GetSendCustomVerificationEmailHeaders = dataclasses.field()
    query_params: GetSendCustomVerificationEmailQueryParams = dataclasses.field()
