...
export class DeleteOrganisationsPartyIdAddressesAddressIdRequest extends SpeakeasyBase {
  /**
...
export class DeleteOrganisationsPartyIdAddressesAddressIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
