...
class Groups:
    ...
    def create_group(self, request: shared.GroupCreateRequest) -> operations.CreateGroupResponse:
        r"""Create new Group
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GroupResult])
    ...
    def edit_group(self, request: operations.EditGroupRequest) -> operations.EditGroupResponse:
        ...
        url = utils.generate_url(operations.EditGroupRequest, base_url, '/api/v1/groups/{group_id}/{version}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "group_edit_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.EditGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_group(self, request: operations.GetGroupRequest) -> operations.GetGroupResponse:
        ...
        url = utils.generate_url(operations.GetGroupRequest, base_url, '/api/v1/groups/{group_id}', request)
    ...
    def get_groups(self, request: operations.GetGroupsRequest) -> operations.GetGroupsResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PaginatedGroupResult])
