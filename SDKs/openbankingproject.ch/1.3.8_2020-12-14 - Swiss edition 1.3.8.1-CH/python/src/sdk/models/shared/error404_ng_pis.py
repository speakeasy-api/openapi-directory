...
class Error404NGPIS:
    ...
    tpp_messages: Optional[list[shared_tppmessage404_pis.TppMessage404PIS]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tppMessages'), 'exclude': lambda f: f is None }})  
