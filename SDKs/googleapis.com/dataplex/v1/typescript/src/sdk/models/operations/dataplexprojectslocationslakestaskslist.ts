...
export class DataplexProjectsLocationsLakesTasksListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsLakesTasksListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsLakesTasksListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
