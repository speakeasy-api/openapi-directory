 ...
 */
export class UsersListUserAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class UsersListUserLinks extends SpeakeasyBase {
  /**
 ...
 */
export class UsersListUserRelationships extends SpeakeasyBase {
  /**
...
export class UsersListUser extends SpeakeasyBase {
  /**
   * The properties of the user entity.
   */
  @SpeakeasyMetadata()
