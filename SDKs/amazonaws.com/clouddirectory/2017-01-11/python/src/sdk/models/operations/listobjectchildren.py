...
class ListObjectChildrenRequestBody:
    ...
    object_reference: ListObjectChildrenRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ObjectReference') }})
    r"""The reference that identifies an object."""  
...
class ListObjectChildrenRequest:
    ...
    request_body: ListObjectChildrenRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
