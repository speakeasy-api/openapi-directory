...
exports.GetSnippetsWorkspaceEncodedIdRevisionDiffResponse = exports.GetSnippetsWorkspaceEncodedIdRevisionDiffRequest = exports.GetSnippetsWorkspaceEncodedIdRevisionDiffSecurity = void 0;
...
var GetSnippetsWorkspaceEncodedIdRevisionDiffRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetSnippetsWorkspaceEncodedIdRevisionDiffRequest.prototype, "encodedId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=path" }),
        __metadata("design:type", String)
    ], GetSnippetsWorkspaceEncodedIdRevisionDiffRequest.prototype, "path", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=revision",
        }),
        __metadata("design:type", String)
    ], GetSnippetsWorkspaceEncodedIdRevisionDiffRequest.prototype, "revision", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], GetSnippetsWorkspaceEncodedIdRevisionDiffRequest.prototype, "workspace", void 0);
...
var GetSnippetsWorkspaceEncodedIdRevisionDiffResponse = /** @class */ (function (_super) {
    ...
    ], GetSnippetsWorkspaceEncodedIdRevisionDiffResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
