...
public class Withdrawal {
    ...
    **/
    public openapisdk.models.operations.CreateWithdrawalResponse createWithdrawal(openapisdk.models.operations.CreateWithdrawalRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/tenant/transactions/v1/create/Withdrawal");
        ...
        openapisdk.models.operations.CreateWithdrawalResponse res = new openapisdk.models.operations.CreateWithdrawalResponse() {{
            rootTypeForWithdrawalCreationResponse = null;
            createWithdrawal400ApplicationJSONAny = null;
            createWithdrawal401ApplicationJSONAny = null;
            createWithdrawal403ApplicationJSONAny = null;
            createWithdrawal404ApplicationJSONAny = null;
            createWithdrawal409ApplicationJSONAny = null;
            createWithdrawal429ApplicationJSONAny = null;
            createWithdrawal500ApplicationJSONAny = null;
        }};
