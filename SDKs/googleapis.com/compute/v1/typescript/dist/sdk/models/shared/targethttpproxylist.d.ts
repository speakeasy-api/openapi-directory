 ...
 */
export declare enum TargetHttpProxyListWarningCodeEnum {
...
export declare class TargetHttpProxyListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetHttpProxyListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: TargetHttpProxyListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: TargetHttpProxyListWarningData[];
    /**
 ...
 */
export declare class TargetHttpProxyList extends SpeakeasyBase {
    /**
