...
class GetSystemTemplateResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetSystemTemplateResponse $getSystemTemplateResponse
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetSystemTemplateResponse $getSystemTemplateResponse = null;
	...
	{
		$this->contentType = "";
		$this->getSystemTemplateResponse = null;
