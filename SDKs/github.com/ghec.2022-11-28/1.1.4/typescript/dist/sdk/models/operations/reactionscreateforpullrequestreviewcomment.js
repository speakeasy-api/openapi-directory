...
exports.ReactionsCreateForPullRequestReviewCommentResponse = exports.ReactionsCreateForPullRequestReviewCommentRequest = exports.ReactionsCreateForPullRequestReviewCommentRequestBody = exports.ReactionsCreateForPullRequestReviewCommentRequestBodyContentEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
/**
 * The [reaction type](https://docs.github.com/enterprise-cloud@latest//rest/reference/reactions#reaction-types) to add to the pull request review comment.
 */
...
var ReactionsCreateForPullRequestReviewCommentRequest = /** @class */ (function (_super) {
    ...
    ], ReactionsCreateForPullRequestReviewCommentRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=comment_id",
        }),
        __metadata("design:type", Number)
    ], ReactionsCreateForPullRequestReviewCommentRequest.prototype, "commentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=owner",
        }),
        __metadata("design:type", String)
    ], ReactionsCreateForPullRequestReviewCommentRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], ReactionsCreateForPullRequestReviewCommentRequest.prototype, "repo", void 0);
...
var ReactionsCreateForPullRequestReviewCommentResponse = /** @class */ (function (_super) {
    ...
    ], ReactionsCreateForPullRequestReviewCommentResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
