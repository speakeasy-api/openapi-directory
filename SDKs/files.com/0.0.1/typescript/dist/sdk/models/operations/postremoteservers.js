...
exports.PostRemoteServersResponse = exports.PostRemoteServersRequestBody = exports.PostRemoteServersRequestBodySslEnum = exports.PostRemoteServersRequestBodyServerTypeEnum = exports.PostRemoteServersRequestBodyServerCertificateEnum = exports.PostRemoteServersRequestBodyOneDriveAccountTypeEnum = exports.PostRemoteServersRequestBodyFilesAgentPermissionSetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Local permissions for files agent. read_only, write_only, or read_write
 */
var PostRemoteServersRequestBodyFilesAgentPermissionSetEnum;
(function (PostRemoteServersRequestBodyFilesAgentPermissionSetEnum) {
    PostRemoteServersRequestBodyFilesAgentPermissionSetEnum["ReadWrite"] = "read_write";
    PostRemoteServersRequestBodyFilesAgentPermissionSetEnum["ReadOnly"] = "read_only";
    PostRemoteServersRequestBodyFilesAgentPermissionSetEnum["WriteOnly"] = "write_only";
})(PostRemoteServersRequestBodyFilesAgentPermissionSetEnum = exports.PostRemoteServersRequestBodyFilesAgentPermissionSetEnum || (exports.PostRemoteServersRequestBodyFilesAgentPermissionSetEnum = {}));
/**
...
(function (PostRemoteServersRequestBodyServerTypeEnum) {
    ...
    PostRemoteServersRequestBodyServerTypeEnum["AzureFiles"] = "azure_files";
    PostRemoteServersRequestBodyServerTypeEnum["FilesAgent"] = "files_agent";
    PostRemoteServersRequestBodyServerTypeEnum["Filebase"] = "filebase";
...
var PostRemoteServersRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], PostRemoteServersRequestBody.prototype, "azureBlobStorageSasToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "multipart_form, name=azure_files_storage_access_key",
        }),
        __metadata("design:type", String)
    ], PostRemoteServersRequestBody.prototype, "azureFilesStorageAccessKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "multipart_form, name=azure_files_storage_account",
        }),
        __metadata("design:type", String)
    ], PostRemoteServersRequestBody.prototype, "azureFilesStorageAccount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "multipart_form, name=azure_files_storage_sas_token",
        }),
        __metadata("design:type", String)
    ], PostRemoteServersRequestBody.prototype, "azureFilesStorageSasToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "multipart_form, name=azure_files_storage_share_name",
        }),
        __metadata("design:type", String)
    ], PostRemoteServersRequestBody.prototype, "azureFilesStorageShareName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], PostRemoteServersRequestBody.prototype, "filebaseAccessKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=filebase_bucket" }),
        __metadata("design:type", String)
    ], PostRemoteServersRequestBody.prototype, "filebaseBucket", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=filebase_secret_key" }),
        __metadata("design:type", String)
    ], PostRemoteServersRequestBody.prototype, "filebaseSecretKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "multipart_form, name=files_agent_permission_set",
        }),
        __metadata("design:type", String)
    ], PostRemoteServersRequestBody.prototype, "filesAgentPermissionSet", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=files_agent_root" }),
        __metadata("design:type", String)
    ], PostRemoteServersRequestBody.prototype, "filesAgentRoot", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
    ...
    __decorate([
        ...
        __metadata("design:type", Boolean)
    ], PostRemoteServersRequestBody.prototype, "pinToSiteRegion", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], PostRemoteServersRequestBody.prototype, "privateKeyPassphrase", void 0);
    __decorate([
...
var PostRemoteServersResponse = /** @class */ (function (_super) {
    ...
    ], PostRemoteServersResponse.prototype, "rawResponse", void 0);
