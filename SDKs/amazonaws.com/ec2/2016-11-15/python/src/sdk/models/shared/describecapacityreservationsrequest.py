...
class DescribeCapacityReservationsRequest:
    ...
    capacity_reservation_ids: Optional[list[str]] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeCapacityReservationsRequestFilters]] = dataclasses.field(default=None)  
