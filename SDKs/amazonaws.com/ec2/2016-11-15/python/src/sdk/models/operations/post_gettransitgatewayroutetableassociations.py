...
class PostGetTransitGatewayRouteTableAssociationsQueryParams:
    action: PostGetTransitGatewayRouteTableAssociationsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetTransitGatewayRouteTableAssociationsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetTransitGatewayRouteTableAssociationsRequest:
    headers: PostGetTransitGatewayRouteTableAssociationsHeaders = dataclasses.field()
    query_params: PostGetTransitGatewayRouteTableAssociationsQueryParams = dataclasses.field()
