 ...
 * 
 */
public enum GetZRLocationSettings200ApplicationXML2DigitalSignagePlayListActionEnum {
    ADD("add"),
    UPDATE("update"),
    DELETE("delete");
    ...
    private GetZRLocationSettings200ApplicationXML2DigitalSignagePlayListActionEnum(String value) {
        this.value = value;
    }
}
