...
class DcimFrontPortsListQueryParams:
...
class DcimFrontPortsList200ApplicationJSON:
    ...
    results: list[shared_frontport.FrontPort] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    next: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('next') }})
    previous: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('previous') }})
    

@dataclasses.dataclass
class DcimFrontPortsListRequest:
    query_params: DcimFrontPortsListQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class DcimFrontPortsListResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    dcim_front_ports_list_200_application_json_object: Optional[DcimFrontPortsList200ApplicationJSON] = dataclasses.field(default=None)
