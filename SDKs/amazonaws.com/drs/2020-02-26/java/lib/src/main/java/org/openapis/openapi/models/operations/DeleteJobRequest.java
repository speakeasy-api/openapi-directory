...
public class DeleteJobRequest {
    ...
    public DeleteJobRequest withRequestBody(DeleteJobRequestBody requestBody) {
    ...
    public DeleteJobRequest(@JsonProperty("RequestBody") DeleteJobRequestBody requestBody) {
        this.requestBody = requestBody;
  }
}
