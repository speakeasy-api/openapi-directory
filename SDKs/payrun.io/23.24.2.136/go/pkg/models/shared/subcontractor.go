...
func (e SubContractorSubContractorBusinessTypeEnum) ToPointer() *SubContractorSubContractorBusinessTypeEnum {
	return &e
}
...
func (e *SubContractorSubContractorBusinessTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Partnership":
		fallthrough
	case "Trust":
		*e = SubContractorSubContractorBusinessTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SubContractorSubContractorBusinessTypeEnum: %v", v)
	}
}
...
func (e SubContractorSubContractorPayFrequencyEnum) ToPointer() *SubContractorSubContractorPayFrequencyEnum {
	return &e
}
...
func (e *SubContractorSubContractorPayFrequencyEnum) UnmarshalJSON(data []byte) error {
	...
	case "Monthly":
		fallthrough
	case "Weekly":
		*e = SubContractorSubContractorPayFrequencyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SubContractorSubContractorPayFrequencyEnum: %v", v)
	}
}
...
func (e SubContractorSubContractorPaymentMethodEnum) ToPointer() *SubContractorSubContractorPaymentMethodEnum {
	return &e
}
...
func (e *SubContractorSubContractorPaymentMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "FasterPayments":
		fallthrough
	case "Other":
		*e = SubContractorSubContractorPaymentMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SubContractorSubContractorPaymentMethodEnum: %v", v)
	}
}
...
func (e SubContractorSubContractorRegionEnum) ToPointer() *SubContractorSubContractorRegionEnum {
	return &e
}
...
func (e *SubContractorSubContractorRegionEnum) UnmarshalJSON(data []byte) error {
	...
	case "Scotland":
		fallthrough
	case "Wales":
		*e = SubContractorSubContractorRegionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SubContractorSubContractorRegionEnum: %v", v)
	}
}
...
func (e SubContractorSubContractorTaxationStatusEnum) ToPointer() *SubContractorSubContractorTaxationStatusEnum {
	return &e
}
...
func (e *SubContractorSubContractorTaxationStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "Net":
		fallthrough
	case "Gross":
		*e = SubContractorSubContractorTaxationStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SubContractorSubContractorTaxationStatusEnum: %v", v)
	}
}
...
func (e SubContractorSubContractorTerritoryEnum) ToPointer() *SubContractorSubContractorTerritoryEnum {
	return &e
}
...
func (e *SubContractorSubContractorTerritoryEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "UnitedKingdom":
		*e = SubContractorSubContractorTerritoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SubContractorSubContractorTerritoryEnum: %v", v)
	}
}
