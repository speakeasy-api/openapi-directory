...
func main() {
    ...
    res, err := s.Users.UsersListPublicKeysForUser(ctx, operations.UsersListPublicKeysForUserRequest{
        Page: sdk.Int64(876840),
        PerPage: sdk.Int64(985109),
        Username: "Omari_Sawayn96",
    })
    if err != nil {
        log.Fatal(err)
    }
