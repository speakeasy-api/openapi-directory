...
class Sessions:
    ...
    def create_credit_session(self, request: shared.SessionCreateInput) -> operations.CreateCreditSessionResponse:
    ...
    def read_credit_session(self, request: operations.ReadCreditSessionRequest) -> operations.ReadCreditSessionResponse:
    ...
    def update_credit_session(self, request: operations.UpdateCreditSessionRequest) -> operations.UpdateCreditSessionResponse:
