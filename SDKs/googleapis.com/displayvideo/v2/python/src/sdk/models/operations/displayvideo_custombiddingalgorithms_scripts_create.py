...
@dataclasses.dataclass
class DisplayvideoCustomBiddingAlgorithmsScriptsCreateQueryParams:
...
class DisplayvideoCustomBiddingAlgorithmsScriptsCreateRequest:
    path_params: DisplayvideoCustomBiddingAlgorithmsScriptsCreatePathParams = dataclasses.field()
    query_params: DisplayvideoCustomBiddingAlgorithmsScriptsCreateQueryParams = dataclasses.field()
    security: DisplayvideoCustomBiddingAlgorithmsScriptsCreateSecurity = dataclasses.field()
    request: Optional[shared_custombiddingscript.CustomBiddingScriptInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DisplayvideoCustomBiddingAlgorithmsScriptsCreateResponse:
    ...
    custom_bidding_script: Optional[shared_custombiddingscript.CustomBiddingScript] = dataclasses.field(default=None)
