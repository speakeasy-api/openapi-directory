 ...
 */
public enum CreateLocalGatewayRouteTableRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateLocalGatewayRouteTableRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
