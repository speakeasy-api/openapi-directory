...
class DeleteProfileObjectRequestBody:
    ...
    profile_object_unique_key: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ProfileObjectUniqueKey') }})
    r"""The unique identifier of the profile object generated by the service."""  
...
class DeleteProfileObjectRequest:
    ...
    request_body: DeleteProfileObjectRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
