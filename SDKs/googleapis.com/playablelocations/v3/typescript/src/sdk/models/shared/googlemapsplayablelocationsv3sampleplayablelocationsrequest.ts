 ...
 */
export class GoogleMapsPlayablelocationsV3SamplePlayableLocationsRequest extends SpeakeasyBase {
  /**
   * Specifies the area to search for playable locations.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "areaFilter" })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleMapsPlayablelocationsV3SampleCriterion })
