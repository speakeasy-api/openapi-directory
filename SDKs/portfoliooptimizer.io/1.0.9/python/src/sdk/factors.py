...
class Factors:
    ...
    def post_factors_residualization(self, request: operations.PostFactorsResidualizationRequestBody) -> operations.PostFactorsResidualizationResponse:
        r"""Residualization
        ...
        * [Catalina B. Garcia, Román Salmeron, Claudia Garcia & Jose Garcia (2019): Residualization: justification, properties and application, Journal of Applied Statistics](https://doi.org/10.1080/02664763.2019.1701638)
        ...
        res = operations.PostFactorsResidualizationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.PostFactorsResidualization200ApplicationJSON])
