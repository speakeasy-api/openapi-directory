...
class CalendarEventsMoveRequest:
    path_params: CalendarEventsMovePathParams = dataclasses.field()
    query_params: CalendarEventsMoveQueryParams = dataclasses.field()
    security: CalendarEventsMoveSecurity = dataclasses.field()
