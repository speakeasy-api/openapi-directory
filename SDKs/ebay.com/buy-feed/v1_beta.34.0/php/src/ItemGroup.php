...
class ItemGroup 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetItemGroupFeedRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\GetItemGroupFeedSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\GetItemGroupFeedResponse
     */
	public function getItemGroupFeed(
        \OpenAPI\OpenAPI\Models\Operations\GetItemGroupFeedRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\GetItemGroupFeedSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\GetItemGroupFeedResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/item_group');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\GetItemGroupFeedRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetItemGroupFeedResponse();
        ...
        if ($httpResponse->getStatusCode() === 200 or $httpResponse->getStatusCode() === 206) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->itemGroupResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ItemGroupResponse', 'json');
            }
