...
class Token:
    ...
    def create_token(self, request: operations.CreateTokenRequestBody, security: operations.CreateTokenSecurity) -> operations.CreateTokenResponse:
        r"""Create token
    ...
    def delete_token(self, request: operations.DeleteTokenRequest, security: operations.DeleteTokenSecurity) -> operations.DeleteTokenResponse:
        r"""Delete token
        Delete a token by 'number'
        """
        base_url = self._server_url
        
        url = utils.generate_url(operations.DeleteTokenRequest, base_url, '/token/{tokenNumber}', request)
    ...
    def get_token(self, request: operations.GetTokenRequest, security: operations.GetTokenSecurity) -> operations.GetTokenResponse:
        r"""Get token
        Return a token by 'tokenNumber'
        """
        base_url = self._server_url
        
        url = utils.generate_url(operations.GetTokenRequest, base_url, '/token/{tokenNumber}', request)
    ...
    def list_tokens(self) -> operations.ListTokensResponse:
        r"""List Tokens
