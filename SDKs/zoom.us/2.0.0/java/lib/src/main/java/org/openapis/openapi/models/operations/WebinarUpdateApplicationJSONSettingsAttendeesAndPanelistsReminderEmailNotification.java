...
public class WebinarUpdateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotification {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    public WebinarUpdateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum type;
    public WebinarUpdateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotification withType(WebinarUpdateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum type) {
        this.type = type;
        return this;
    }
