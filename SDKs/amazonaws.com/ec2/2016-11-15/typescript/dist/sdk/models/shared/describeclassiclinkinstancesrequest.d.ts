 ...
 */
export declare class DescribeClassicLinkInstancesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeClassicLinkInstancesRequest extends SpeakeasyBase {
    dryRun?: boolean;
