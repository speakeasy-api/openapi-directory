...
public class ProjectsCreateForAuthenticatedUser415ApplicationJSON {
    ...
    public ProjectsCreateForAuthenticatedUser415ApplicationJSON(@JsonProperty("documentation_url") String documentationUrl, @JsonProperty("message") String message) {
        this.documentationUrl = documentationUrl;
        this.message = message;
  }
}
