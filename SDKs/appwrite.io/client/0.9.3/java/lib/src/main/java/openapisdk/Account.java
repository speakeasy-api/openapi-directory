...
public class Account {
    ...
    **/
    public openapisdk.models.operations.AccountCreateAnonymousSessionResponse accountCreateAnonymousSession(openapisdk.models.operations.AccountCreateAnonymousSessionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/account/sessions/anonymous");
        ...
        openapisdk.models.operations.AccountCreateAnonymousSessionResponse res = new openapisdk.models.operations.AccountCreateAnonymousSessionResponse() {{
            session = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.AccountCreateJwtResponse accountCreateJwt(openapisdk.models.operations.AccountCreateJwtRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/account/jwt");
        ...
        openapisdk.models.operations.AccountCreateJwtResponse res = new openapisdk.models.operations.AccountCreateJwtResponse() {{
            jwt = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 201) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.Jwt out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.Jwt.class);
                res.jwt = out;
            }
        }
     ...
     * 
    **/
    public openapisdk.models.operations.AccountCreateOAuth2SessionResponse accountCreateOAuth2Session(openapisdk.models.operations.AccountCreateOAuth2SessionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/account/sessions/oauth2/{provider}", request.pathParams);
        ...
        openapisdk.models.operations.AccountCreateOAuth2SessionResponse res = new openapisdk.models.operations.AccountCreateOAuth2SessionResponse() {{
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.AccountCreateSessionResponse accountCreateSession(openapisdk.models.operations.AccountCreateSessionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        openapisdk.models.operations.AccountCreateSessionResponse res = new openapisdk.models.operations.AccountCreateSessionResponse() {{
            session = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
