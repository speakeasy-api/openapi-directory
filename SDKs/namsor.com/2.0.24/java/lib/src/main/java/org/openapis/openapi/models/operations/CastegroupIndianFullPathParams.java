...
public class CastegroupIndianFullPathParams {
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=personalNameFull")
    public String personalNameFull;
    public CastegroupIndianFullPathParams withPersonalNameFull(String personalNameFull) {
    ...
    public CastegroupIndianFullPathParams withSubDivisionIso31662(String subDivisionIso31662) {
