...
exports.GetJournalLinesFromPayRunResponse = exports.GetJournalLinesFromPayRunRequest = void 0;
...
var GetJournalLinesFromPayRunRequest = /** @class */ (function (_super) {
    ...
    ], GetJournalLinesFromPayRunRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetJournalLinesFromPayRunRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetJournalLinesFromPayRunRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayRunId",
        }),
        __metadata("design:type", String)
    ], GetJournalLinesFromPayRunRequest.prototype, "payRunId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayScheduleId",
        }),
        __metadata("design:type", String)
    ], GetJournalLinesFromPayRunRequest.prototype, "payScheduleId", void 0);
...
var GetJournalLinesFromPayRunResponse = /** @class */ (function (_super) {
    ...
    ], GetJournalLinesFromPayRunResponse.prototype, "rawResponse", void 0);
