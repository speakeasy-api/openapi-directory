...
var Operations = /** @class */ (function () {
     ...
     */
    Operations.prototype.servicemanagementOperationsGet = function (req, security, config) {
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.ServicemanagementOperationsGetSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.ServicemanagementOperationsGetResponse({
     ...
     */
    Operations.prototype.servicemanagementOperationsList = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.ServicemanagementOperationsListSecurity(security);
        }
        var client = utils.createSecurityClient(this._defaultClient, security);
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ServicemanagementOperationsListResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
