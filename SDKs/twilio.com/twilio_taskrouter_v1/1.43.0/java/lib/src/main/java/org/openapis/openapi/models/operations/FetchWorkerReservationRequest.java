...
public class FetchWorkerReservationRequest {
    ...
    public FetchWorkerReservationRequest(@JsonProperty("Sid") String sid, @JsonProperty("WorkerSid") String workerSid, @JsonProperty("WorkspaceSid") String workspaceSid) {
        this.sid = sid;
        this.workerSid = workerSid;
        this.workspaceSid = workspaceSid;
  }
