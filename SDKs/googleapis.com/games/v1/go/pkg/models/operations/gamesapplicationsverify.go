...
type GamesApplicationsVerifySecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type GamesApplicationsVerifyPathParams struct {
	// The application ID from the Google Play developer console.
	ApplicationID string `pathParam:"style=simple,explode=false,name=applicationId"`
}

type GamesApplicationsVerifyQueryParams struct {
	// V1 error format.
...
type GamesApplicationsVerifyRequest struct {
...
type GamesApplicationsVerifyResponse struct {
	// Successful response
