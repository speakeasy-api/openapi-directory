...
class CreateVpcPeeringConnectionRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateVpcPeeringConnectionRequestTagSpecifications:
    ...
    resource_type: Optional[CreateVpcPeeringConnectionRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateVpcPeeringConnectionRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateVpcPeeringConnectionRequest:
    ...
    peer_owner_id: Optional[str] = dataclasses.field(default=None)  
    peer_region: Optional[str] = dataclasses.field(default=None)  
    peer_vpc_id: Optional[str] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateVpcPeeringConnectionRequestTagSpecifications]] = dataclasses.field(default=None)  
