...
class CreateVpcPeeringConnectionRequest:
    ...
    create_vpc_peering_connection_input: shared_createvpcpeeringconnectioninput.CreateVpcPeeringConnectionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
