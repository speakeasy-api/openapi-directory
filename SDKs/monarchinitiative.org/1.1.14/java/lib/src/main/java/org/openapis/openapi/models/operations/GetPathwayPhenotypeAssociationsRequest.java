...
public class GetPathwayPhenotypeAssociationsRequest {
    ...
    public GetPathwayPhenotypeAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPathwayPhenotypeAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPathwayPhenotypeAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPathwayPhenotypeAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPathwayPhenotypeAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPathwayPhenotypeAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsRequest withRelation(String relation) {
    ...
    public GetPathwayPhenotypeAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPathwayPhenotypeAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPathwayPhenotypeAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
