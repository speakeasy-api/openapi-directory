 ...
 */
public enum DeclinedTransactionDeclinedTransactionSourceCardDeclineNetworkDetailsVisaPointOfServiceEntryModeEnum {
    MANUAL("manual"),
    ...
    private DeclinedTransactionDeclinedTransactionSourceCardDeclineNetworkDetailsVisaPointOfServiceEntryModeEnum(String value) {
        this.value = value;
    }
}
