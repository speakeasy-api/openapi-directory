...
from ..shared import transferfundsresponse as shared_transferfundsresponse
...
class PostTransferFundsResponse:
    ...
    transfer_funds_response: Optional[shared_transferfundsresponse.TransferFundsResponse] = dataclasses.field(default=None)
