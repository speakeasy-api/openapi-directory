...
type POSTDescribeTrafficSourcesActionEnum string
...
type POSTDescribeTrafficSourcesVersionEnum string
...
type POSTDescribeTrafficSourcesQueryParams struct {
...
type POSTDescribeTrafficSourcesHeaders struct {
...
type POSTDescribeTrafficSourcesRequest struct {
	QueryParams POSTDescribeTrafficSourcesQueryParams
	Headers     POSTDescribeTrafficSourcesHeaders
	Request     []byte `request:"mediaType=text/xml"`
}

type POSTDescribeTrafficSourcesResponse struct {
	Body        []byte
	ContentType string
	StatusCode  int
