...
var FundingAudit = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: fundingevent_1.FundingEvent }),
        (0, class_transformer_1.Expose)({ name: "events" }),
        (0, class_transformer_1.Type)(function () { return fundingevent_1.FundingEvent; }),
        __metadata("design:type", Array)
    ], FundingAudit.prototype, "events", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fundingAccountName" }),
        __metadata("design:type", String)
    ], FundingAudit.prototype, "fundingAccountName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fundingType" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "topupType" }),
        __metadata("design:type", String)
