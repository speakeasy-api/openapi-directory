...
class UpdateAPIResponseCorsConfiguration:
    r"""UpdateAPIResponseCorsConfiguration
...
class UpdateAPIResponse:
    ...
    cors_configuration: Optional[UpdateAPIResponseCorsConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CorsConfiguration') }})
