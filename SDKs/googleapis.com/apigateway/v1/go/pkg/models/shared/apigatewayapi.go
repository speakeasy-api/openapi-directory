...
func (e ApigatewayAPIStateEnum) ToPointer() *ApigatewayAPIStateEnum {
	return &e
}
...
func (e *ApigatewayAPIStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "DELETING":
		fallthrough
	case "UPDATING":
		*e = ApigatewayAPIStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ApigatewayAPIStateEnum: %v", v)
	}
}
