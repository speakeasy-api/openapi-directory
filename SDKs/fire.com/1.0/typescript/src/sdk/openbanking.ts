...
export class OpenBanking {
  ...
  getListOfAspsps(
    ...
    const url: string = baseURL.replace(/\/$/, "") + "/v1/aspsps";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetListOfAspspsResponse =
        new operations.GetListOfAspspsResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.aspsps = utils.objectToClass(
              httpRes?.data,
              operations.GetListOfAspspsAspsps
            );
          }
          break;
      }
  ...
  getPaymentDetails(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetPaymentDetailsResponse =
        new operations.GetPaymentDetailsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.paymentRequest = utils.objectToClass(
              httpRes?.data,
              operations.GetPaymentDetailsPaymentRequest
            );
          }
          break;
      }
   ...
   */
  newPaymentRequest(
    req: operations.NewPaymentRequestNewPaymentRequest,
    config?: AxiosRequestConfig
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/paymentrequests";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.NewPaymentRequestResponse =
        new operations.NewPaymentRequestResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.newPaymentRequestResponse = utils.objectToClass(
              httpRes?.data,
              operations.NewPaymentRequestNewPaymentRequestResponse
            );
          }
          break;
      }
