...
exports.FetchWorkerInstanceStatisticsResponse = exports.FetchWorkerInstanceStatisticsRequest = exports.FetchWorkerInstanceStatisticsSecurity = exports.FetchWorkerInstanceStatisticsServerList = void 0;
...
var FetchWorkerInstanceStatisticsSecurity = /** @class */ (function (_super) {
    ...
    ], FetchWorkerInstanceStatisticsSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], FetchWorkerInstanceStatisticsSecurity.prototype, "username", void 0);
...
var FetchWorkerInstanceStatisticsRequest = /** @class */ (function (_super) {
    ...
    ], FetchWorkerInstanceStatisticsRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Minutes",
        }),
        __metadata("design:type", Number)
    ], FetchWorkerInstanceStatisticsRequest.prototype, "minutes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], FetchWorkerInstanceStatisticsRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskChannel",
        }),
        __metadata("design:type", String)
    ], FetchWorkerInstanceStatisticsRequest.prototype, "taskChannel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkerSid",
        }),
        __metadata("design:type", String)
    ], FetchWorkerInstanceStatisticsRequest.prototype, "workerSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], FetchWorkerInstanceStatisticsRequest.prototype, "workspaceSid", void 0);
...
var FetchWorkerInstanceStatisticsResponse = /** @class */ (function (_super) {
    ...
    ], FetchWorkerInstanceStatisticsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
