...
const (
	...
	SignInAttemptCategoryEnumSsoFailed               SignInAttemptCategoryEnum = "sso_failed"
...
func (e SignInAttemptCategoryEnum) ToPointer() *SignInAttemptCategoryEnum {
	return &e
}
...
func (e *SignInAttemptCategoryEnum) UnmarshalJSON(data []byte) error {
	...
	case "firewall_reported_success":
		*e = SignInAttemptCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SignInAttemptCategoryEnum: %v", v)
	}
}
...
const (
	...
	SignInAttemptTypeEnumServiceAccountSsoDenied SignInAttemptTypeEnum = "service_account_sso_denied"
	SignInAttemptTypeEnumNonSsoUser              SignInAttemptTypeEnum = "non_sso_user"
	SignInAttemptTypeEnumSsoUserMismatch         SignInAttemptTypeEnum = "sso_user_mismatch"
...
func (e SignInAttemptTypeEnum) ToPointer() *SignInAttemptTypeEnum {
	return &e
}
...
func (e *SignInAttemptTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "duo_native_bad":
		fallthrough
	case "service_account_sso_denied":
		fallthrough
	case "non_sso_user":
		fallthrough
	case "sso_user_mismatch":
		fallthrough
	...
	case "modern_version_old":
		*e = SignInAttemptTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SignInAttemptTypeEnum: %v", v)
	}
}
