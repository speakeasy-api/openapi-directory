...
class ListConversationMessageRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ConversationMessageEnumOrderTypeEnum $order
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=Order')]
    public ?\OpenAPI\OpenAPI\Models\Shared\ConversationMessageEnumOrderTypeEnum $order = null;
