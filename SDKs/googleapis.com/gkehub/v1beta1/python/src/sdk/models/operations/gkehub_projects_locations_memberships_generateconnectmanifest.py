...
class GkehubProjectsLocationsMembershipsGenerateConnectManifestQueryParams:
    ...
    connect_agent_name: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'connectAgent.name', 'style': 'form', 'explode': True }})
    connect_agent_namespace: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'connectAgent.namespace', 'style': 'form', 'explode': True }})
    connect_agent_proxy: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'connectAgent.proxy', 'style': 'form', 'explode': True }})
...
class GkehubProjectsLocationsMembershipsGenerateConnectManifestRequest:
    path_params: GkehubProjectsLocationsMembershipsGenerateConnectManifestPathParams = dataclasses.field()
    query_params: GkehubProjectsLocationsMembershipsGenerateConnectManifestQueryParams = dataclasses.field()
    security: GkehubProjectsLocationsMembershipsGenerateConnectManifestSecurity = dataclasses.field()
