...
export class PolicysimulatorProjectsLocationsReplaysCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PolicysimulatorProjectsLocationsReplaysCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class PolicysimulatorProjectsLocationsReplaysCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
