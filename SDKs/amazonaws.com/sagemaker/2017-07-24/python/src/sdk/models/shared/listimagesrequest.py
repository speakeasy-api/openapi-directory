...
from ..shared import imagesortby_enum as shared_imagesortby_enum
from ..shared import imagesortorder_enum as shared_imagesortorder_enum
...
class ListImagesRequest:
    ...
    sort_by: Optional[shared_imagesortby_enum.ImageSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
    sort_order: Optional[shared_imagesortorder_enum.ImageSortOrderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortOrder'), 'exclude': lambda f: f is None }})  
