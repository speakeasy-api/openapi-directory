 ...
 */
export declare enum ResourcePoliciesScopedListWarningCodeEnum {
...
export declare class ResourcePoliciesScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ResourcePoliciesScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class ResourcePoliciesScopedList extends SpeakeasyBase {
    /**
