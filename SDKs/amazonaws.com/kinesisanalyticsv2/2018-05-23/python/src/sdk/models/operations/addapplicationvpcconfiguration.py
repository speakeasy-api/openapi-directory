...
class AddApplicationVpcConfigurationRequest:
    ...
    add_application_vpc_configuration_request: shared_addapplicationvpcconfigurationrequest.AddApplicationVpcConfigurationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
