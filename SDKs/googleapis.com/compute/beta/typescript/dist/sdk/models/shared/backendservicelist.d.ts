 ...
 */
export declare enum BackendServiceListWarningCodeEnum {
...
export declare class BackendServiceListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class BackendServiceListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class BackendServiceList extends SpeakeasyBase {
    /**
