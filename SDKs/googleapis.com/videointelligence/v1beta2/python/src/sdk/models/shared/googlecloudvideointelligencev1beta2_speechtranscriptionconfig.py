...
from ..shared import googlecloudvideointelligencev1beta2_speechcontext as shared_googlecloudvideointelligencev1beta2_speechcontext


@dataclass_json
@dataclasses.dataclass
class GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig:
    r"""GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig
    ...
    speech_contexts: Optional[list[shared_googlecloudvideointelligencev1beta2_speechcontext.GoogleCloudVideointelligenceV1beta2SpeechContext]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('speechContexts') }})
