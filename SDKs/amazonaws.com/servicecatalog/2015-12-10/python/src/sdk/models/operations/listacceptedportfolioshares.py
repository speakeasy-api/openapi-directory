...
class ListAcceptedPortfolioSharesRequest:
    ...
    list_accepted_portfolio_shares_input: shared_listacceptedportfoliosharesinput.ListAcceptedPortfolioSharesInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
