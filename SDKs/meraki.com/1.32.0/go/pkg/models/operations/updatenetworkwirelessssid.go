...
func (e UpdateNetworkWirelessSsidRequestBodyAuthModeEnum) ToPointer() *UpdateNetworkWirelessSsidRequestBodyAuthModeEnum {
	return &e
}
...
func (e *UpdateNetworkWirelessSsidRequestBodyAuthModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "open-with-radius":
		fallthrough
	case "psk":
		*e = UpdateNetworkWirelessSsidRequestBodyAuthModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSsidRequestBodyAuthModeEnum: %v", v)
	}
}
...
func (e UpdateNetworkWirelessSsidRequestBodyEncryptionModeEnum) ToPointer() *UpdateNetworkWirelessSsidRequestBodyEncryptionModeEnum {
	return &e
}
...
func (e *UpdateNetworkWirelessSsidRequestBodyEncryptionModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "wep":
		fallthrough
	case "wpa":
		*e = UpdateNetworkWirelessSsidRequestBodyEncryptionModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSsidRequestBodyEncryptionModeEnum: %v", v)
	}
}
...
func (e UpdateNetworkWirelessSsidRequestBodyEnterpriseAdminAccessEnum) ToPointer() *UpdateNetworkWirelessSsidRequestBodyEnterpriseAdminAccessEnum {
	return &e
}
...
func (e *UpdateNetworkWirelessSsidRequestBodyEnterpriseAdminAccessEnum) UnmarshalJSON(data []byte) error {
	...
	case "access disabled":
		fallthrough
	case "access enabled":
		*e = UpdateNetworkWirelessSsidRequestBodyEnterpriseAdminAccessEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSsidRequestBodyEnterpriseAdminAccessEnum: %v", v)
	}
}
...
func (e UpdateNetworkWirelessSsidRequestBodyRadiusAttributeForGroupPoliciesEnum) ToPointer() *UpdateNetworkWirelessSsidRequestBodyRadiusAttributeForGroupPoliciesEnum {
	return &e
}
...
func (e *UpdateNetworkWirelessSsidRequestBodyRadiusAttributeForGroupPoliciesEnum) UnmarshalJSON(data []byte) error {
	...
	case "Filter-Id":
		fallthrough
	case "Reply-Message":
		*e = UpdateNetworkWirelessSsidRequestBodyRadiusAttributeForGroupPoliciesEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSsidRequestBodyRadiusAttributeForGroupPoliciesEnum: %v", v)
	}
}
...
func (e UpdateNetworkWirelessSsidRequestBodyRadiusFailoverPolicyEnum) ToPointer() *UpdateNetworkWirelessSsidRequestBodyRadiusFailoverPolicyEnum {
	return &e
}
...
func (e *UpdateNetworkWirelessSsidRequestBodyRadiusFailoverPolicyEnum) UnmarshalJSON(data []byte) error {
	...
	case "Allow access":
		fallthrough
	case "Deny access":
		*e = UpdateNetworkWirelessSsidRequestBodyRadiusFailoverPolicyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSsidRequestBodyRadiusFailoverPolicyEnum: %v", v)
	}
}
...
func (e UpdateNetworkWirelessSsidRequestBodyRadiusLoadBalancingPolicyEnum) ToPointer() *UpdateNetworkWirelessSsidRequestBodyRadiusLoadBalancingPolicyEnum {
	return &e
}
...
func (e *UpdateNetworkWirelessSsidRequestBodyRadiusLoadBalancingPolicyEnum) UnmarshalJSON(data []byte) error {
	...
	case "Strict priority order":
		*e = UpdateNetworkWirelessSsidRequestBodyRadiusLoadBalancingPolicyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSsidRequestBodyRadiusLoadBalancingPolicyEnum: %v", v)
	}
}
...
func (e UpdateNetworkWirelessSsidRequestBodySplashPageEnum) ToPointer() *UpdateNetworkWirelessSsidRequestBodySplashPageEnum {
	return &e
}
...
func (e *UpdateNetworkWirelessSsidRequestBodySplashPageEnum) UnmarshalJSON(data []byte) error {
	...
	case "Systems Manager Sentry":
		*e = UpdateNetworkWirelessSsidRequestBodySplashPageEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSsidRequestBodySplashPageEnum: %v", v)
	}
}

// UpdateNetworkWirelessSsidRequestBodyWpaEncryptionModeEnum - The types of WPA encryption. ('WPA1 only', 'WPA1 and WPA2', 'WPA2 only', 'WPA3 Transition Mode', 'WPA3 only' or 'WPA3 192-bit Security')
...
const (
	...
	UpdateNetworkWirelessSsidRequestBodyWpaEncryptionModeEnumWpa3192BitSecurity UpdateNetworkWirelessSsidRequestBodyWpaEncryptionModeEnum = "WPA3 192-bit Security"
...
func (e UpdateNetworkWirelessSsidRequestBodyWpaEncryptionModeEnum) ToPointer() *UpdateNetworkWirelessSsidRequestBodyWpaEncryptionModeEnum {
	return &e
}
...
func (e *UpdateNetworkWirelessSsidRequestBodyWpaEncryptionModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "WPA3 Transition Mode":
		fallthrough
	case "WPA3 only":
		*e = UpdateNetworkWirelessSsidRequestBodyWpaEncryptionModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSsidRequestBodyWpaEncryptionModeEnum: %v", v)
	}
}
