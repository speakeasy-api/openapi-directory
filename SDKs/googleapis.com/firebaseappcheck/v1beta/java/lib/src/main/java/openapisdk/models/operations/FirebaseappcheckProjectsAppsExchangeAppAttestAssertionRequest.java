...
public class FirebaseappcheckProjectsAppsExchangeAppAttestAssertionRequest {
    ...
    public openapisdk.models.shared.GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest request;
    public FirebaseappcheckProjectsAppsExchangeAppAttestAssertionRequest withRequest(openapisdk.models.shared.GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest request) {
