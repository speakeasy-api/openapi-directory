...
class GetDeleteVpcPeeringConnectionQueryParams:
    action: GetDeleteVpcPeeringConnectionActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDeleteVpcPeeringConnectionVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteVpcPeeringConnectionRequest:
    headers: GetDeleteVpcPeeringConnectionHeaders = dataclasses.field()
    query_params: GetDeleteVpcPeeringConnectionQueryParams = dataclasses.field()
