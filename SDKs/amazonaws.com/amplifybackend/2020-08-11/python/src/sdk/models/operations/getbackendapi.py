...
from ..shared import getbackendapiresponse as shared_getbackendapiresponse
...
class GetBackendAPIRequestBodyResourceConfigConflictResolution:
    r"""GetBackendAPIRequestBodyResourceConfigConflictResolution
...
@dataclass_json
@dataclasses.dataclass
class GetBackendAPIRequestBodyResourceConfigDefaultAuthTypeSettings:
    r"""GetBackendAPIRequestBodyResourceConfigDefaultAuthTypeSettings
...
class GetBackendAPIRequestBodyResourceConfigDefaultAuthType:
    r"""GetBackendAPIRequestBodyResourceConfigDefaultAuthType
    ...
    settings: Optional[GetBackendAPIRequestBodyResourceConfigDefaultAuthTypeSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Settings') }})
...
class GetBackendAPIRequestBodyResourceConfig:
    ...
    conflict_resolution: Optional[GetBackendAPIRequestBodyResourceConfigConflictResolution] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ConflictResolution') }})
    default_auth_type: Optional[GetBackendAPIRequestBodyResourceConfigDefaultAuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DefaultAuthType') }})
...
class GetBackendAPIRequestBody:
    ...
    resource_config: Optional[GetBackendAPIRequestBodyResourceConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceConfig') }})
    

@dataclasses.dataclass
class GetBackendAPIRequest:
    headers: GetBackendAPIHeaders = dataclasses.field()
    path_params: GetBackendAPIPathParams = dataclasses.field()
    request: GetBackendAPIRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetBackendAPIResponse:
    ...
    get_backend_api_response: Optional[shared_getbackendapiresponse.GetBackendAPIResponse] = dataclasses.field(default=None)
