...
class ProjectSaveAsTemplateRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\ProjectSaveAsTemplateRequestBody $requestBody
     */
	...
	{
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\ProjectSaveAsTemplateRequestBody();
		$this->optFields = null;
		$this->optPretty = null;
		$this->projectGid = "";
	}
