...
class PointPointDailyEveningData
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PointPointDailyEveningCloudCoverData')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PointPointDailyEveningPrecipitationData')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PointPointDailyEveningProbData')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PointPointDailyEveningWindData')]
	...
	{
		$this->cloudCover = new \OpenAPI\OpenAPI\Models\Shared\PointPointDailyEveningCloudCoverData();
		$this->dewPoint = null;
		$this->feelsLike = null;
		$this->humidity = null;
		$this->icon = null;
		$this->ozone = null;
		$this->precipitation = new \OpenAPI\OpenAPI\Models\Shared\PointPointDailyEveningPrecipitationData();
		$this->pressure = null;
		$this->probability = new \OpenAPI\OpenAPI\Models\Shared\PointPointDailyEveningProbData();
		$this->snowDepth = null;
		...
		$this->weather = null;
		$this->wind = new \OpenAPI\OpenAPI\Models\Shared\PointPointDailyEveningWindData();
		$this->windChill = null;
	}
}
