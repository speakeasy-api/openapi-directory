...
public class AndroidpublisherEditsApksUploadRequest {
    ...
    public AndroidpublisherEditsApksUploadRequest withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public AndroidpublisherEditsApksUploadRequest withAccessToken(String accessToken) {
    ...
    public AndroidpublisherEditsApksUploadRequest withCallback(String callback) {
    ...
    public AndroidpublisherEditsApksUploadRequest withUploadType(String uploadType) {
    ...
    public AndroidpublisherEditsApksUploadRequest withUploadProtocol(String uploadProtocol) {
        this.uploadProtocol = uploadProtocol;
        return this;
    }
    
    public AndroidpublisherEditsApksUploadRequest(@JsonProperty("editId") String editId, @JsonProperty("packageName") String packageName) {
        this.editId = editId;
        this.packageName = packageName;
  }
}
