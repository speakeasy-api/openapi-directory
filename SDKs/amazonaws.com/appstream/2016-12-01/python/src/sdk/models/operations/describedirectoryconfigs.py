...
class DescribeDirectoryConfigsRequest:
    ...
    describe_directory_configs_request: shared_describedirectoryconfigsrequest.DescribeDirectoryConfigsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
