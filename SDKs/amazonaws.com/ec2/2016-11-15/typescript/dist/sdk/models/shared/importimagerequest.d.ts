...
import { ImportImageLicenseSpecificationListRequest } from "./importimagelicensespecificationlistrequest";
import { UserBucket } from "./userbucket";
/**
 * Describes the disk container object for an import image task.
 */
export declare class ImportImageRequestDiskContainers extends SpeakeasyBase {
    description?: string;
    deviceName?: string;
    format?: string;
    snapshotId?: string;
 ...
 */
export declare enum ImportImageRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class ImportImageRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class ImportImageRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: ImportImageRequestTagSpecificationsResourceTypeEnum;
    tags?: ImportImageRequestTagSpecificationsTags[];
}
export declare class ImportImageRequest extends SpeakeasyBase {
    architecture?: string;
