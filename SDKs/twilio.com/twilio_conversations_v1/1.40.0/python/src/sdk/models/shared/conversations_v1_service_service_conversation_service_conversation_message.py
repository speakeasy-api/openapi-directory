...
class ConversationsV1ServiceServiceConversationServiceConversationMessage:
    ...
    r"""The index of the message within the [Conversation](https://www.twilio.com/docs/conversations/api/conversation-resource)."""  
    ...
    r"""An absolute API resource URL for this message."""  
