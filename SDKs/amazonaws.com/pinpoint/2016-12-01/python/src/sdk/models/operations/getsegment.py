...
from ..shared import getsegmentresponse as shared_getsegmentresponse
...
class GetSegmentRequest:
    headers: GetSegmentHeaders = dataclasses.field()
...
class GetSegmentResponse:
    ...
    get_segment_response: Optional[shared_getsegmentresponse.GetSegmentResponse] = dataclasses.field(default=None)
