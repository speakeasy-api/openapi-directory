...
public class GetUsersIdInboxRequest {
    ...
    public GetUsersIdInboxRequest withCallback(String callback) {
    ...
    public GetUsersIdInboxRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdInboxRequest withId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public GetUsersIdInboxRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdInboxRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdInboxRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    public GetUsersIdInboxRequest(@JsonProperty("id") Long id, @JsonProperty("site") String site) {
        this.id = id;
        this.site = site;
  }
}
