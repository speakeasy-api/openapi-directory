...
public class PostApiInvoiceDeletecategoryRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PostApiInvoiceDeletecategoryRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public PostApiInvoiceDeletecategoryRawHeaders withXAuthSecret(String xAuthSecret) {
