...
var Identification = /** @class */ (function () {
     ...
     *
     */
    Identification.prototype.postV05PatientsFindJson = function (req, config) {
        var _a;
        ...
        try {
            _a = utils.serializeRequestBody(req, "patientIdentificationRequest", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostV05PatientsFindJsonResponse({
     ...
     *
     */
    Identification.prototype.postV05PatientsFindRaw = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostV05PatientsFindRawResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
