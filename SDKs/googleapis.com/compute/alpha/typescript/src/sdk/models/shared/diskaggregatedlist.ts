 ...
 */
export enum DiskAggregatedListWarningCodeEnum {
...
export class DiskAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class DiskAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: DiskAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class DiskAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: DisksScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, DisksScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], DisksScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
