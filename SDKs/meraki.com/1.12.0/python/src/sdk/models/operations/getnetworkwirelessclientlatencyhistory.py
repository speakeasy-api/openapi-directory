...
class GetNetworkWirelessClientLatencyHistoryRequest:
    path_params: GetNetworkWirelessClientLatencyHistoryPathParams = dataclasses.field()
    query_params: GetNetworkWirelessClientLatencyHistoryQueryParams = dataclasses.field()
...
class GetNetworkWirelessClientLatencyHistoryResponse:
    ...
    get_network_wireless_client_latency_history_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
