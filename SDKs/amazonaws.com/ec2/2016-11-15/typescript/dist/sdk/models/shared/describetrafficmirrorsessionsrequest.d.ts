 ...
 */
export declare class DescribeTrafficMirrorSessionsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTrafficMirrorSessionsRequest extends SpeakeasyBase {
    dryRun?: boolean;
