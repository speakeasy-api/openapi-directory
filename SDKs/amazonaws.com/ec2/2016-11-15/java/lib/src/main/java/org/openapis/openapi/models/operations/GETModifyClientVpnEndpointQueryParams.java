...
public class GETModifyClientVpnEndpointQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=Action")
    public GETModifyClientVpnEndpointActionEnum action;
    public GETModifyClientVpnEndpointQueryParams withAction(GETModifyClientVpnEndpointActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETModifyClientVpnEndpointQueryParams withClientConnectOptions(GETModifyClientVpnEndpointClientConnectOptions clientConnectOptions) {
    ...
    public GETModifyClientVpnEndpointQueryParams withClientLoginBannerOptions(GETModifyClientVpnEndpointClientLoginBannerOptions clientLoginBannerOptions) {
    ...
    public GETModifyClientVpnEndpointQueryParams withClientVpnEndpointId(String clientVpnEndpointId) {
    ...
    public GETModifyClientVpnEndpointQueryParams withConnectionLogOptions(GETModifyClientVpnEndpointConnectionLogOptions connectionLogOptions) {
    ...
    public GETModifyClientVpnEndpointQueryParams withDescription(String description) {
    ...
    public GETModifyClientVpnEndpointQueryParams withDnsServers(GETModifyClientVpnEndpointDNSServers dnsServers) {
    ...
    public GETModifyClientVpnEndpointQueryParams withDryRun(Boolean dryRun) {
        this.dryRun = dryRun;
        return this;
    }
    ...
    public GETModifyClientVpnEndpointQueryParams withSecurityGroupId(String[] securityGroupId) {
    ...
    public GETModifyClientVpnEndpointQueryParams withSelfServicePortal(GETModifyClientVpnEndpointSelfServicePortalEnum selfServicePortal) {
    ...
    public GETModifyClientVpnEndpointQueryParams withServerCertificateArn(String serverCertificateArn) {
    ...
    public GETModifyClientVpnEndpointQueryParams withSessionTimeoutHours(Long sessionTimeoutHours) {
    ...
    public GETModifyClientVpnEndpointQueryParams withSplitTunnel(Boolean splitTunnel) {
    ...
    public GETModifyClientVpnEndpointQueryParams withVersion(GETModifyClientVpnEndpointVersionEnum version) {
    ...
    public String vpcId;
    public GETModifyClientVpnEndpointQueryParams withVpcId(String vpcId) {
        this.vpcId = vpcId;
        return this;
    }
    ...
    public Long vpnPort;
    public GETModifyClientVpnEndpointQueryParams withVpnPort(Long vpnPort) {
