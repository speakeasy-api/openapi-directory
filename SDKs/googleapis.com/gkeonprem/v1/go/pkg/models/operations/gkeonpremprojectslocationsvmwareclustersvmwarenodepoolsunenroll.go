...
type GkeonpremProjectsLocationsVmwareClustersVmwareNodePoolsUnenrollSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type GkeonpremProjectsLocationsVmwareClustersVmwareNodePoolsUnenrollRequest struct {
	// V1 error format.
...
type GkeonpremProjectsLocationsVmwareClustersVmwareNodePoolsUnenrollResponse struct {
	ContentType string
	// Successful response
