...
class GetPeopleIDRequest:
    ...
    r"""The ID of the person resource to load."""  
...
class GetPeopleID200ApplicationVndAPIPlusJSON:
    ...
    data: Optional[shared_person.Person] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
