...
from ..shared import schedulepayoutrequestv3 as shared_schedulepayoutrequestv3
...
class ScheduleForPayoutRequest:
    ...
    r"""Id of the payout"""  
    schedule_payout_request_v3: Optional[shared_schedulepayoutrequestv3.SchedulePayoutRequestV3] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    r"""schedule payout parameters"""  
    

@dataclasses.dataclass
class ScheduleForPayoutResponse:
