...
class DescribeAccountAssignmentCreationStatusRequest:
    ...
    describe_account_assignment_creation_status_request: shared_describeaccountassignmentcreationstatusrequest.DescribeAccountAssignmentCreationStatusRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
