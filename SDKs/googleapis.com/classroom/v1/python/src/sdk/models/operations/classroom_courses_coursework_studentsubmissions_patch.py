...
class ClassroomCoursesCourseWorkStudentSubmissionsPatchRequest:
    ...
    student_submission: Optional[shared_studentsubmission.StudentSubmission] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    ...
    r"""Mask that identifies which fields on the student submission to update. This field is required to do an update. The update fails if invalid fields are specified. The following fields may be specified by teachers: * `draft_grade` * `assigned_grade`"""  
