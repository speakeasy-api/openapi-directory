...
type ResourceDetails1 struct {
	...
	AwsEc2NetworkInterface            *AwsEc2NetworkInterfaceDetails1           `json:"AwsEc2NetworkInterface,omitempty"`
	...
	AwsRdsDbInstance                  *AwsRdsDbInstanceDetails1                 `json:"AwsRdsDbInstance,omitempty"`
