...
**/
var CloudSqlConnectionProfile = /** @class */ (function (_super) {
    __extends(CloudSqlConnectionProfile, _super);
    function CloudSqlConnectionProfile() {
 ...
 * Specifies required connection parameters, and, optionally, the parameters required to create a Cloud SQL destination database instance.
**/
var CloudSqlConnectionProfileInput = /** @class */ (function (_super) {
    __extends(CloudSqlConnectionProfileInput, _super);
    function CloudSqlConnectionProfileInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=settings" }),
