...
public class Tags {
     ...
     */
    public org.openapis.openapi.models.operations.CollectionTagsAllResponse collectionTagsAll(org.openapis.openapi.models.operations.CollectionTagsAllRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.CollectionTagsAllPathParams.class, baseUrl, "/issue-tracking/collections/{collection_id}/tags", request.pathParams, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.CollectionTagsAllQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
