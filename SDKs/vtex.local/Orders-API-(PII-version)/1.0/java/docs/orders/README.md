...
* [cancelOrder2](#cancelorder2) - Cancel order
* [getOrder2](#getorder2) - Get order
* [listOrders2](#listorders2) - List orders
* [startHandling2](#starthandling2) - Start handling order
...
import org.openapis.openapi.models.operations.CancelOrder2Request;
import org.openapis.openapi.models.operations.CancelOrder2RequestBody;
import org.openapis.openapi.models.operations.CancelOrder2Response;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CancelOrder2Request req = new CancelOrder2Request("application/json", "application/json", "70caf3941s6df1") {{
                requestBody = new CancelOrder2RequestBody() {{
                    reason = "Unexpected stock shortage";
                }};;
            }};            

            CancelOrder2Response res = sdk.orders.cancelOrder2(req);

            if (res.cancelOrder2200ApplicationJSONObject != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.GetOrder2Request;
import org.openapis.openapi.models.operations.GetOrder2Response;
import org.openapis.openapi.models.shared.Security;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetOrder2Request req = new GetOrder2Request("application/json", "application/json", "70caf3941s6df1") {{
                reason = "data-validation";
            }};            

            GetOrder2Response res = sdk.orders.getOrder2(req);

            if (res.getOrder2200ApplicationJSONObject != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.ListOrders2Request;
import org.openapis.openapi.models.operations.ListOrders2RequestBody;
import org.openapis.openapi.models.operations.ListOrders2Response;
import org.openapis.openapi.models.shared.Security;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ListOrders2Request req = new ListOrders2Request("application/json", "application/json") {{
                requestBody = new ListOrders2RequestBody("creationDate:[2021-11-01T00:00:00.000Z TO 2022-11-10T02:00:00.000Z]", 1L, 15L) {{
                    q = "Postman Test";
                }};;
                fHasInputInvoice = false;
            }};            

            ListOrders2Response res = sdk.orders.listOrders2(req);
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.StartHandling2Request;
import org.openapis.openapi.models.operations.StartHandling2Response;
import org.openapis.openapi.models.shared.Security;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            StartHandling2Request req = new StartHandling2Request("application/json", "application/json", "70caf3941s6df1");            

            StartHandling2Response res = sdk.orders.startHandling2(req);
