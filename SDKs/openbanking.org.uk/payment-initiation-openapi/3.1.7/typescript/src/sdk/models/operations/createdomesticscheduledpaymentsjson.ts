...
export class CreateDomesticScheduledPaymentsJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateDomesticScheduledPaymentsJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateDomesticScheduledPaymentsJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
