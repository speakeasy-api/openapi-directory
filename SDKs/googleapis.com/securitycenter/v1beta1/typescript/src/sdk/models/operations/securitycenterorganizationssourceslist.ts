...
export class SecuritycenterOrganizationsSourcesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SecuritycenterOrganizationsSourcesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SecuritycenterOrganizationsSourcesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
