...
func (s *operationsT) ServicenetworkingOperationsCancel(ctx context.Context, request operations.ServicenetworkingOperationsCancelRequest) (*operations.ServicenetworkingOperationsCancelResponse, error) {
	baseURL := s.serverURL
