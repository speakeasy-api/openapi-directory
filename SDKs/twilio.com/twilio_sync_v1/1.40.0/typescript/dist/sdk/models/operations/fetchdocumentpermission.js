...
exports.FetchDocumentPermissionResponse = exports.FetchDocumentPermissionRequest = exports.FetchDocumentPermissionSecurity = exports.FetchDocumentPermissionServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.FetchDocumentPermissionServerList = [
...
var FetchDocumentPermissionSecurity = /** @class */ (function (_super) {
    ...
    ], FetchDocumentPermissionSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], FetchDocumentPermissionSecurity.prototype, "username", void 0);
    return FetchDocumentPermissionSecurity;
}(utils_1.SpeakeasyBase));
exports.FetchDocumentPermissionSecurity = FetchDocumentPermissionSecurity;
var FetchDocumentPermissionRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], FetchDocumentPermissionRequest.prototype, "documentSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=Identity",
        }),
        __metadata("design:type", String)
    ], FetchDocumentPermissionRequest.prototype, "identity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], FetchDocumentPermissionRequest.prototype, "serviceSid", void 0);
    return FetchDocumentPermissionRequest;
}(utils_1.SpeakeasyBase));
exports.FetchDocumentPermissionRequest = FetchDocumentPermissionRequest;
var FetchDocumentPermissionResponse = /** @class */ (function (_super) {
    ...
    ], FetchDocumentPermissionResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.FetchDocumentPermissionResponse = FetchDocumentPermissionResponse;
