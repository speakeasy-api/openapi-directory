...
var Mds = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "mds" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "sold_vins" }),
        __metadata("design:type", Array)
    ], Mds.prototype, "soldVins", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "total_active_cars_for_ymmt" }),
        __metadata("design:type", Number)
    ], Mds.prototype, "totalActiveCarsForYmmt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "total_cars_sold_in_last_45_days" }),
        __metadata("design:type", Number)
