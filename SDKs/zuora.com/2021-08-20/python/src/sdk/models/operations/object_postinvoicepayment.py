...
class ObjectPOSTInvoicePaymentRequest:
    ...
    proxy_create_invoice_payment: shared_proxycreateinvoicepayment.ProxyCreateInvoicePayment = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
