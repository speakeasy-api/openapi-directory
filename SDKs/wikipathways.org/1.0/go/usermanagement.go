...
func (s *UserManagement) GetGetUserByOrcid(ctx context.Context, request operations.GetGetUserByOrcidRequest) (*operations.GetGetUserByOrcidResponse, error) {
...
func (s *UserManagement) GetLogin(ctx context.Context, request operations.GetLoginRequest) (*operations.GetLoginResponse, error) {
	baseURL := s._serverURL
