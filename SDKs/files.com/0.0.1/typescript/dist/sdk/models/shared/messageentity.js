...
var MessageEntity = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: messagecommententity_1.MessageCommentEntity }),
        (0, class_transformer_1.Expose)({ name: "comments" }),
        (0, class_transformer_1.Type)(function () { return messagecommententity_1.MessageCommentEntity; }),
