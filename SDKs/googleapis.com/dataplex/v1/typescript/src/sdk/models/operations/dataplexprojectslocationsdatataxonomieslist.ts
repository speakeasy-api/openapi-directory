...
export class DataplexProjectsLocationsDataTaxonomiesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsDataTaxonomiesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsDataTaxonomiesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
