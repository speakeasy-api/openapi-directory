...
type DatalabelingProjectsDatasetsDataItemsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DatalabelingProjectsDatasetsDataItemsListPathParams struct {
	// Required. Name of the dataset to list data items, format: projects/{project_id}/datasets/{dataset_id}
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type DatalabelingProjectsDatasetsDataItemsListQueryParams struct {
	// V1 error format.
...
type DatalabelingProjectsDatasetsDataItemsListRequest struct {
...
type DatalabelingProjectsDatasetsDataItemsListResponse struct {
	ContentType string
	// Successful response
