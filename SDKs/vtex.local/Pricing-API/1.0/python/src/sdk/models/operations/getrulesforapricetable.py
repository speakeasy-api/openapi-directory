...
GETRULESFORAPRICETABLE_SERVERS = [
	"https://api.vtex.com/{account}/pricing",
]


@dataclasses.dataclass
class GetrulesforapricetableRequest:
...
@dataclasses.dataclass
class Getrulesforapricetable200ApplicationJSONRulesContextDateRange:
...
class Getrulesforapricetable200ApplicationJSONRulesContext:
    ...
    date_range: Optional[Getrulesforapricetable200ApplicationJSONRulesContextDateRange] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dateRange'), 'exclude': lambda f: f is None }})
    r"""The rule will be active during this time range."""  
    ...
    markup_range: Optional[Getrulesforapricetable200ApplicationJSONRulesContextMarkupRange] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('markupRange'), 'exclude': lambda f: f is None }})
    r"""For an item to be eligible to the rule, it's markup should be in this Markup Range."""  
...
class Getrulesforapricetable200ApplicationJSONRules:
    ...
    context: Optional[Getrulesforapricetable200ApplicationJSONRulesContext] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('context'), 'exclude': lambda f: f is None }})
    r"""Rule Context is a group of filters to be checked at an item level when applying the rule. If all those filters check out, the rule will be applied for that item, unless there is a fixed price for that item."""  
...
class Getrulesforapricetable200ApplicationJSON:
    ...
    rules: Optional[list[Getrulesforapricetable200ApplicationJSONRules]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rules'), 'exclude': lambda f: f is None }})
...
@dataclasses.dataclass
class GetrulesforapricetableResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    getrulesforapricetable_200_application_json_object: Optional[Getrulesforapricetable200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""  
