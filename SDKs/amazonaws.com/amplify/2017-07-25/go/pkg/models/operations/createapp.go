...
func (e CreateAppRequestBodyPlatformEnum) ToPointer() *CreateAppRequestBodyPlatformEnum {
	return &e
}
...
func (e *CreateAppRequestBodyPlatformEnum) UnmarshalJSON(data []byte) error {
	...
	case "WEB_DYNAMIC":
		fallthrough
	case "WEB_COMPUTE":
		*e = CreateAppRequestBodyPlatformEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateAppRequestBodyPlatformEnum: %v", v)
	}
}
