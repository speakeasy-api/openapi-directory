...
type IamProjectsLocationsWorkloadIdentityPoolsProvidersListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type IamProjectsLocationsWorkloadIdentityPoolsProvidersListPathParams struct {
	// Required. The pool to list providers for.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type IamProjectsLocationsWorkloadIdentityPoolsProvidersListQueryParams struct {
	// V1 error format.
...
type IamProjectsLocationsWorkloadIdentityPoolsProvidersListRequest struct {
...
type IamProjectsLocationsWorkloadIdentityPoolsProvidersListResponse struct {
	ContentType string
	// Successful response
