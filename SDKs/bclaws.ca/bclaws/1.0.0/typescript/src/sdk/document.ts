...
export class Document {
  ...
  getDocumentIdAspectIdCivixIndexIdCivixDocumentId(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdRequest(
          req
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdResponse =
        new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdResponse(
          {
  ...
  getDocumentIdAspectIdCivixIndexIdCivixDocumentIdSearchSearchString(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdSearchSearchStringRequest(
          req
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdSearchSearchStringResponse =
        new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdSearchSearchStringResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  getDocumentIdAspectIdCivixIndexIdCivixDocumentIdXml(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdXmlRequest(
          req
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdXmlResponse =
        new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdXmlResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  getDocumentIdAspectIdCivixIndexIdCivixDocumentIdXmlSearchSearchString(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdXmlSearchSearchStringRequest(
          req
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdXmlSearchSearchStringResponse =
        new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdXmlSearchSearchStringResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
