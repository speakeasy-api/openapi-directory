...
class PatchSpacesSpaceIdFoldersFolderIdPayrollsDocumentIdRequest
{
     ...
     * A payroll to modify
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PatchSpacesSpaceIdFoldersFolderIdPayrollsDocumentIdRequestBody $requestBody
     */
	#[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?PatchSpacesSpaceIdFoldersFolderIdPayrollsDocumentIdRequestBody $requestBody = null;
