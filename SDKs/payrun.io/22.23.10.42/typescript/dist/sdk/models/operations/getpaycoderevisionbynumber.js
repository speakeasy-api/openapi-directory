...
exports.GetPayCodeRevisionByNumberResponse = exports.GetPayCodeRevisionByNumberRequest = void 0;
...
var GetPayCodeRevisionByNumberRequest = /** @class */ (function (_super) {
    ...
    ], GetPayCodeRevisionByNumberRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetPayCodeRevisionByNumberRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetPayCodeRevisionByNumberRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayCodeId",
        }),
        __metadata("design:type", String)
    ], GetPayCodeRevisionByNumberRequest.prototype, "payCodeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RevisionNumber",
        }),
        __metadata("design:type", String)
    ], GetPayCodeRevisionByNumberRequest.prototype, "revisionNumber", void 0);
...
var GetPayCodeRevisionByNumberResponse = /** @class */ (function (_super) {
    ...
    ], GetPayCodeRevisionByNumberResponse.prototype, "rawResponse", void 0);
