...
class ListServiceListServiceResponse:
    ...
    services: Optional[list[shared_conversations_v1_service.ConversationsV1Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('services') }})
