...
exports.OneToOneNatRules = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var OneToOneNatRules = /** @class */ (function () {
    function OneToOneNatRules(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    OneToOneNatRules.prototype.getNetworkApplianceFirewallOneToOneNatRules = function (req, config) {
    ...
    **/
    OneToOneNatRules.prototype.updateNetworkApplianceFirewallOneToOneNatRules = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return OneToOneNatRules;
}());
exports.OneToOneNatRules = OneToOneNatRules;
