...
class GetGeneVariantAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGeneVariantAssociationsQueryParams:
...
class GetGeneVariantAssociationsRequest:
    path_params: GetGeneVariantAssociationsPathParams = dataclasses.field()
    query_params: GetGeneVariantAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetGeneVariantAssociationsResponse:
