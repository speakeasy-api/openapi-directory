...
func (s *Users) UsersBlock(ctx context.Context, request operations.UsersBlockRequest) (*operations.UsersBlockResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/user/blocks/{username}", request.PathParams)
...
func (s *Users) UsersListBlockedByAuthenticated(ctx context.Context) (*operations.UsersListBlockedByAuthenticatedResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.UsersListBlockedByAuthenticatedResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	...
	case httpRes.StatusCode == 415:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.UsersListBlockedByAuthenticated415ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Users) UsersSetPrimaryEmailVisibilityForAuthenticated(ctx context.Context, request operations.UsersSetPrimaryEmailVisibilityForAuthenticatedRequest) (*operations.UsersSetPrimaryEmailVisibilityForAuthenticatedResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.UsersSetPrimaryEmailVisibilityForAuthenticatedResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
