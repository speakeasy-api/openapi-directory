...
from ..shared import tppmessage405_sbs as shared_tppmessage405_sbs
...
class Error405NgSbs:
    ...
    tpp_messages: Optional[list[shared_tppmessage405_sbs.TppMessage405Sbs]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tppMessages') }})
