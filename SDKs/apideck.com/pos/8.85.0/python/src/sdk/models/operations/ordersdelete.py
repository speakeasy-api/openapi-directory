...
from ..shared import deleteorderresponse as shared_deleteorderresponse
...
class OrdersDeleteRequest:
    headers: OrdersDeleteHeaders = dataclasses.field()
    path_params: OrdersDeletePathParams = dataclasses.field()
    query_params: OrdersDeleteQueryParams = dataclasses.field()
    security: OrdersDeleteSecurity = dataclasses.field()
...
class OrdersDeleteResponse:
    ...
    delete_order_response: Optional[shared_deleteorderresponse.DeleteOrderResponse] = dataclasses.field(default=None)
