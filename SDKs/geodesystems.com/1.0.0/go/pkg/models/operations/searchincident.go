...
type SearchIncidentQueryParams struct {
	...
	// Cause
	SearchIncidentCause *string `queryParam:"style=form,explode=true,name=search.incident.cause"`
	// Incident Type
	SearchIncidentIncidenttype *string `queryParam:"style=form,explode=true,name=search.incident.incidenttype"`
	// State
	SearchIncidentState *string `queryParam:"style=form,explode=true,name=search.incident.state"`
	// Number to skip
...
type SearchIncidentRequest struct {
	QueryParams SearchIncidentQueryParams
}

type SearchIncidentResponse struct {
	ContentType string
	StatusCode  int
