...
class AdSizeSizeTypeEnum(str, Enum):
    r"""The size type of the ad slot."""
...
class AdSize:
    ...
    size_type: Optional[AdSizeSizeTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sizeType'), 'exclude': lambda f: f is None }})
    r"""The size type of the ad slot."""  
