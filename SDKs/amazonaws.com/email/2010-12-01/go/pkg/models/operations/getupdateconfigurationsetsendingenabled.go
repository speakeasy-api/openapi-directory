...
func (e GETUpdateConfigurationSetSendingEnabledActionEnum) ToPointer() *GETUpdateConfigurationSetSendingEnabledActionEnum {
	return &e
}
...
func (e *GETUpdateConfigurationSetSendingEnabledActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "UpdateConfigurationSetSendingEnabled":
		*e = GETUpdateConfigurationSetSendingEnabledActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETUpdateConfigurationSetSendingEnabledActionEnum: %v", v)
	}
}
...
func (e GETUpdateConfigurationSetSendingEnabledVersionEnum) ToPointer() *GETUpdateConfigurationSetSendingEnabledVersionEnum {
	return &e
}
...
func (e *GETUpdateConfigurationSetSendingEnabledVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2010-12-01":
		*e = GETUpdateConfigurationSetSendingEnabledVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETUpdateConfigurationSetSendingEnabledVersionEnum: %v", v)
	}
}
