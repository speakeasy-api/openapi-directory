 ...
 */
public enum GoogleCloudRetailV2betaCatalogAttributeRetrievableOptionEnum {
    ...
    private GoogleCloudRetailV2betaCatalogAttributeRetrievableOptionEnum(String value) {
        this.value = value;
    }
}
