...
class SecretScanning:
    ...
    def secret_scanning_update_alert(self, request: operations.SecretScanningUpdateAlertRequest) -> operations.SecretScanningUpdateAlertResponse:
        ...
        res = operations.SecretScanningUpdateAlertResponse(status_code=r.status_code, content_type=content_type)
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.SecretScanningUpdateAlert503ApplicationJSON])
