...
class ImportSSHPublicKeyRequest:
    ...
    import_ssh_public_key_request: shared_importsshpublickeyrequest.ImportSSHPublicKeyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
