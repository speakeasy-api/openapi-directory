...
public class GetCommandsRequest {
    ...
    public GetCommandsRequest withAll(Boolean all) {
        this.all = all;
        return this;
    }
    ...
    public GetCommandsRequest withDeviceId(Long deviceId) {
    ...
    public GetCommandsRequest withGroupId(Long groupId) {
    ...
    public GetCommandsRequest withRefresh(Boolean refresh) {
    ...
    public GetCommandsRequest withUserId(Long userId) {
        this.userId = userId;
        return this;
    }
