...
class UpdateNetworkSwitchAccessPolicyRequestBodyDot1xControlDirectionEnum(str, Enum):
...
class UpdateNetworkSwitchAccessPolicyRequestBodyDot1x:
    r"""802.1x Settings"""
    
    control_direction: Optional[UpdateNetworkSwitchAccessPolicyRequestBodyDot1xControlDirectionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('controlDirection'), 'exclude': lambda f: f is None }})
    r"""Supports either 'both' or 'inbound'. Set to 'inbound' to allow unauthorized egress on the switchport. Set to 'both' to control both traffic directions with authorization. Defaults to 'both'"""  
...
class UpdateNetworkSwitchAccessPolicyRequestBodyRadius:
    ...
    critical_auth: Optional[UpdateNetworkSwitchAccessPolicyRequestBodyRadiusCriticalAuth] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('criticalAuth'), 'exclude': lambda f: f is None }})
    r"""Critical auth settings for when authentication is rejected by the RADIUS server"""  
...
class UpdateNetworkSwitchAccessPolicyRequestBody:
    ...
    access_policy_type: Optional[UpdateNetworkSwitchAccessPolicyRequestBodyAccessPolicyTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('accessPolicyType'), 'exclude': lambda f: f is None }})
    r"""Access Type of the policy. Automatically 'Hybrid authentication' when hostMode is 'Multi-Domain'."""  
    dot1x: Optional[UpdateNetworkSwitchAccessPolicyRequestBodyDot1x] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dot1x'), 'exclude': lambda f: f is None }})
    r"""802.1x Settings"""  
    ...
    host_mode: Optional[UpdateNetworkSwitchAccessPolicyRequestBodyHostModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('hostMode'), 'exclude': lambda f: f is None }})
    r"""Choose the Host Mode for the access policy."""  
    ...
    radius: Optional[UpdateNetworkSwitchAccessPolicyRequestBodyRadius] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radius'), 'exclude': lambda f: f is None }})
    r"""Object for RADIUS Settings"""  
    ...
    radius_accounting_servers: Optional[list[UpdateNetworkSwitchAccessPolicyRequestBodyRadiusAccountingServers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radiusAccountingServers'), 'exclude': lambda f: f is None }})
    ...
    radius_servers: Optional[list[UpdateNetworkSwitchAccessPolicyRequestBodyRadiusServers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radiusServers'), 'exclude': lambda f: f is None }})
...
class UpdateNetworkSwitchAccessPolicyRequest:
    ...
    request_body: Optional[UpdateNetworkSwitchAccessPolicyRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    
class UpdateNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum(str, Enum):
    r"""Access Type of the policy. Automatically 'Hybrid authentication' when hostMode is 'Multi-Domain'."""
    EIGHT_HUNDRED_AND_TWO_1X = '802.1x'
    HYBRID_AUTHENTICATION = 'Hybrid authentication'
    MAC_AUTHENTICATION_BYPASS = 'MAC authentication bypass'

class UpdateNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum(str, Enum):
    r"""Supports either 'both' or 'inbound'. Set to 'inbound' to allow unauthorized egress on the switchport. Set to 'both' to control both traffic directions with authorization. Defaults to 'both'"""
    BOTH = 'both'
    INBOUND = 'inbound'
...
class UpdateNetworkSwitchAccessPolicy200ApplicationJSONDot1x:
    ...
    control_direction: Optional[UpdateNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('controlDirection'), 'exclude': lambda f: f is None }})
    r"""Supports either 'both' or 'inbound'. Set to 'inbound' to allow unauthorized egress on the switchport. Set to 'both' to control both traffic directions with authorization. Defaults to 'both'"""  
    
class UpdateNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum(str, Enum):
    r"""Choose the Host Mode for the access policy."""
    MULTI_AUTH = 'Multi-Auth'
    MULTI_DOMAIN = 'Multi-Domain'
    MULTI_HOST = 'Multi-Host'
...
class UpdateNetworkSwitchAccessPolicy200ApplicationJSONRadius:
    ...
    critical_auth: Optional[UpdateNetworkSwitchAccessPolicy200ApplicationJSONRadiusCriticalAuth] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('criticalAuth'), 'exclude': lambda f: f is None }})
    r"""Critical auth settings for when authentication is rejected by the RADIUS server"""  
    failed_auth_vlan_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failedAuthVlanId'), 'exclude': lambda f: f is None }})
    r"""VLAN that clients will be placed on when RADIUS authentication fails. Will be null if hostMode is Multi-Auth"""  
    re_authentication_interval: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reAuthenticationInterval'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateNetworkSwitchAccessPolicy200ApplicationJSONRadiusAccountingServers:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateNetworkSwitchAccessPolicy200ApplicationJSONRadiusServers:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateNetworkSwitchAccessPolicy200ApplicationJSON:
    r"""Successful operation"""
    
    access_policy_type: Optional[UpdateNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('accessPolicyType'), 'exclude': lambda f: f is None }})
    r"""Access Type of the policy. Automatically 'Hybrid authentication' when hostMode is 'Multi-Domain'."""  
    dot1x: Optional[UpdateNetworkSwitchAccessPolicy200ApplicationJSONDot1x] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dot1x'), 'exclude': lambda f: f is None }})
    r"""802.1x Settings"""  
    guest_vlan_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('guestVlanId'), 'exclude': lambda f: f is None }})
    r"""ID for the guest VLAN allow unauthorized devices access to limited network resources"""  
    host_mode: Optional[UpdateNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('hostMode'), 'exclude': lambda f: f is None }})
    r"""Choose the Host Mode for the access policy."""  
    increase_access_speed: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('increaseAccessSpeed'), 'exclude': lambda f: f is None }})
    r"""Enabling this option will make switches execute 802.1X and MAC-bypass authentication simultaneously so that clients authenticate faster. Only required when accessPolicyType is 'Hybrid Authentication."""  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})
    r"""Name of the access policy"""  
    radius: Optional[UpdateNetworkSwitchAccessPolicy200ApplicationJSONRadius] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radius'), 'exclude': lambda f: f is None }})
    r"""Object for RADIUS Settings"""  
    radius_accounting_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radiusAccountingEnabled'), 'exclude': lambda f: f is None }})
    r"""Enable to send start, interim-update and stop messages to a configured RADIUS accounting server for tracking connected clients"""  
    radius_accounting_servers: Optional[list[UpdateNetworkSwitchAccessPolicy200ApplicationJSONRadiusAccountingServers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radiusAccountingServers'), 'exclude': lambda f: f is None }})
    r"""List of RADIUS accounting servers to require connecting devices to authenticate against before granting network access"""  
    radius_coa_support_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radiusCoaSupportEnabled'), 'exclude': lambda f: f is None }})
    r"""Change of authentication for RADIUS re-authentication and disconnection"""  
    radius_group_attribute: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radiusGroupAttribute'), 'exclude': lambda f: f is None }})
    r"""Acceptable values are `\\"\\"` for None, or `\\"11\\"` for Group Policies ACL"""  
    radius_servers: Optional[list[UpdateNetworkSwitchAccessPolicy200ApplicationJSONRadiusServers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radiusServers'), 'exclude': lambda f: f is None }})
    r"""List of RADIUS servers to require connecting devices to authenticate against before granting network access"""  
    radius_testing_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radiusTestingEnabled'), 'exclude': lambda f: f is None }})
    r"""If enabled, Meraki devices will periodically send access-request messages to these RADIUS servers"""  
    url_redirect_walled_garden_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('urlRedirectWalledGardenEnabled'), 'exclude': lambda f: f is None }})
...
class UpdateNetworkSwitchAccessPolicyResponse:
    ...
    update_network_switch_access_policy_200_application_json_object: Optional[UpdateNetworkSwitchAccessPolicy200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
