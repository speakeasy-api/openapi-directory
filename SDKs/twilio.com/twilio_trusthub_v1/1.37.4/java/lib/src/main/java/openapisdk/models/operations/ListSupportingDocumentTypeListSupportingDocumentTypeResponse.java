...
public class ListSupportingDocumentTypeListSupportingDocumentTypeResponse {
    ...
    public openapisdk.models.shared.TrusthubV1SupportingDocumentType[] supportingDocumentTypes;
    public ListSupportingDocumentTypeListSupportingDocumentTypeResponse withSupportingDocumentTypes(openapisdk.models.shared.TrusthubV1SupportingDocumentType[] supportingDocumentTypes) {
