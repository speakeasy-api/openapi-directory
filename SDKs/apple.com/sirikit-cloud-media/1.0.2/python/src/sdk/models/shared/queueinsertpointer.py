...
class QueueInsertPointer:
    ...
    after_identifier: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('afterIdentifier'), 'exclude': lambda f: f is None }})  
