 ...
 */
public enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsLocalStorageEnum {
    INCLUDED("included"),
    REQUIRED("required"),
    EXCLUDED("excluded");
    ...
    private RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsLocalStorageEnum(String value) {
        this.value = value;
    }
}
