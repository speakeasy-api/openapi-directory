...
from ..shared import proxycreateproductrateplancharge as shared_proxycreateproductrateplancharge
...
class ObjectPOSTProductRatePlanChargeRequest:
    ...
    proxy_create_product_rate_plan_charge: shared_proxycreateproductrateplancharge.ProxyCreateProductRatePlanCharge = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
