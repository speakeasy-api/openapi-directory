...
class ExchangeAssignedTargetingOptionDetailsExchangeEnum(str, Enum):
    r"""Required. The enum value for the exchange."""
...
class ExchangeAssignedTargetingOptionDetails:
    ...
    exchange: Optional[ExchangeAssignedTargetingOptionDetailsExchangeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('exchange'), 'exclude': lambda f: f is None }})
    r"""Required. The enum value for the exchange."""  
