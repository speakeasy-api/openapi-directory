...
export class SourceDefinitionSpecification {
  ...
  getSourceDefinitionSpecification(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1/source_definition_specifications/get";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetSourceDefinitionSpecificationResponse =
        new operations.GetSourceDefinitionSpecificationResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.sourceDefinitionSpecificationRead = utils.objectToClass(
              httpRes?.data,
              shared.SourceDefinitionSpecificationRead
            );
          }
          break;
