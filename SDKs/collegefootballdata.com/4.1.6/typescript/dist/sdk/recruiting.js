...
exports.Recruiting = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var Recruiting = /** @class */ (function () {
    function Recruiting(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Recruiting.prototype.getRecruitingGroups = function (req, config) {
    ...
    **/
    Recruiting.prototype.getRecruitingPlayers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Recruiting.prototype.getRecruitingTeams = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
