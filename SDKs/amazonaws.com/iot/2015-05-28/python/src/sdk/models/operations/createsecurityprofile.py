...
class CreateSecurityProfileRequest:
    headers: CreateSecurityProfileHeaders = dataclasses.field()
    path_params: CreateSecurityProfilePathParams = dataclasses.field()
    request: CreateSecurityProfileRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
