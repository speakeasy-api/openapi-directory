...
class BucketAccessControl:
    ...
    project_team: Optional[BucketAccessControlProjectTeam] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('projectTeam'), 'exclude': lambda f: f is None }})
    r"""The project team associated with the entity, if any."""  
