...
export class Creative extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "detectedAdvertiserIds" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "detectedProductCategories" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "detectedSensitiveCategories" })
   ...
   */
  @SpeakeasyMetadata({ elemType: ServingRestriction })
