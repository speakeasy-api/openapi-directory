...
class PullRequestReviewLinks:
    html: PullRequestReviewLinksHTML = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('html') }})
    pull_request: PullRequestReviewLinksPullRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('pull_request') }})
    

@dataclass_json
@dataclasses.dataclass
class PullRequestReviewSimpleUser:
    r"""PullRequestReviewSimpleUser
    Simple User
    """
...
class PullRequestReview:
    ...
    links: PullRequestReviewLinks = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links') }})
    ...
    user: PullRequestReviewSimpleUser = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('user') }})
    ...
    submitted_at: Optional[datetime] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('submitted_at'), 'encoder': utils.datetimeisoformat(True), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso') }})
