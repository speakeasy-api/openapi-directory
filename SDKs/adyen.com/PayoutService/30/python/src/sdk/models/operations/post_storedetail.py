...
from ..shared import storedetailresponse as shared_storedetailresponse
...
class PostStoreDetailResponse:
    ...
    store_detail_response: Optional[shared_storedetailresponse.StoreDetailResponse] = dataclasses.field(default=None)
