 ...
 */
export enum SecurityPoliciesScopedListWarningCodeEnum {
...
export class SecurityPoliciesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SecurityPoliciesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: SecurityPoliciesScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: SecurityPoliciesScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => SecurityPoliciesScopedListWarningData)
  data?: SecurityPoliciesScopedListWarningData[];
...
export class SecurityPoliciesScopedList extends SpeakeasyBase {
  /**
   * A list of SecurityPolicies contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: SecurityPolicy })
  @Expose({ name: "securityPolicies" })
  @Type(() => SecurityPolicy)
