...
import dataclasses
from ..shared import ecommerceproduct as shared_ecommerceproduct
...
class GetProductsResponse:
    ...
    data: list[shared_ecommerceproduct.EcommerceProduct] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
