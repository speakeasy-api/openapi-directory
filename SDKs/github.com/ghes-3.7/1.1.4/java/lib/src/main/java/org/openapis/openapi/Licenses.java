...
public class Licenses {
    ...
    /**
     * Get a license
     * https://docs.github.com/enterprise-server@3.7/rest/reference/licenses#get-a-license - API method documentation
     ...
     * https://docs.github.com/enterprise-server@3.7/rest/reference/licenses#get-all-commonly-used-licenses - API method documentation
     * @param request the request object containing all of the parameters for the API call
     * @return the response from the API call
     * @throws Exception if the API call fails
     */
     ...
     * https://docs.github.com/enterprise-server@3.7/rest/reference/licenses/#get-the-license-for-a-repository - API method documentation
     * @param request the request object containing all of the parameters for the API call
     * @return the response from the API call
     * @throws Exception if the API call fails
     */
