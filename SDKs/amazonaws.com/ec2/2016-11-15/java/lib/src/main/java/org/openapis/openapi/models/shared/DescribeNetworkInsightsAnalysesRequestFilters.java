...
public class DescribeNetworkInsightsAnalysesRequestFilters {
    ...
    public DescribeNetworkInsightsAnalysesRequestFilters withValues(String[] values) {
        this.values = values;
        return this;
    }
    
    public DescribeNetworkInsightsAnalysesRequestFilters(){}
}
