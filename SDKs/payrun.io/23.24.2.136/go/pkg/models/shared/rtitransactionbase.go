...
func (e RtiTransactionBaseRtiTransactionBaseTransactionStatusEnum) ToPointer() *RtiTransactionBaseRtiTransactionBaseTransactionStatusEnum {
	return &e
}
...
func (e *RtiTransactionBaseRtiTransactionBaseTransactionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "CompletedWithSuccess":
		fallthrough
	case "TimeOut":
		*e = RtiTransactionBaseRtiTransactionBaseTransactionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RtiTransactionBaseRtiTransactionBaseTransactionStatusEnum: %v", v)
	}
}
