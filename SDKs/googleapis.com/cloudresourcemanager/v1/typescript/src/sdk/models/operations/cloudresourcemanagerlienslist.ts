...
export class CloudresourcemanagerLiensListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudresourcemanagerLiensListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudresourcemanagerLiensListSecurity extends SpeakeasyBase {
...
export class CloudresourcemanagerLiensListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudresourcemanagerLiensListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
