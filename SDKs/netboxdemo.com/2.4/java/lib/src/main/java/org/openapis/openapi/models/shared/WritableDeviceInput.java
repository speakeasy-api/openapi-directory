...
public class WritableDeviceInput {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("face")
    public WritableDeviceRackFaceEnum face;
    public WritableDeviceInput withFace(WritableDeviceRackFaceEnum face) {
        this.face = face;
        return this;
    }
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("status")
    public WritableDeviceStatusEnum status;
    public WritableDeviceInput withStatus(WritableDeviceStatusEnum status) {
        this.status = status;
        return this;
    }
