...
class UpdateAssessmentTargetRequest:
    ...
    update_assessment_target_request: shared_updateassessmenttargetrequest.UpdateAssessmentTargetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
