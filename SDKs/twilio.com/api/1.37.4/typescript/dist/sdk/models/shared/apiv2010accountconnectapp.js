...
var ApiV2010AccountConnectApp = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=authorize_redirect_url" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=deauthorize_callback_method" }),
        __metadata("design:type", String)
    ], ApiV2010AccountConnectApp.prototype, "deauthorizeCallbackMethod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=deauthorize_callback_url" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=homepage_url" }),
        __metadata("design:type", String)
