...
class BankTransferListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\BankTransferDirectionEnum $direction
     */
	#[\JMS\Serializer\Annotation\SerializedName('direction')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\BankTransferDirectionEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?BankTransferDirectionEnum $direction = null;
