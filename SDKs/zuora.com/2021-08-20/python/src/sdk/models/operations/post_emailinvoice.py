...
class POSTEmailInvoiceRequest:
    ...
    r"""The ID of the invoice. For example, 2c92c8955bd63cc1015bd7c151af02ab."""  
    post_invoice_email_request_type: shared_postinvoiceemailrequesttype.PostInvoiceEmailRequestType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
