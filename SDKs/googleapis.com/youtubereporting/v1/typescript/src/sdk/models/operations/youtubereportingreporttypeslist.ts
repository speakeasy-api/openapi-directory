...
export class YoutubereportingReportTypesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class YoutubereportingReportTypesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class YoutubereportingReportTypesListSecurity extends SpeakeasyBase {
...
export class YoutubereportingReportTypesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class YoutubereportingReportTypesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
