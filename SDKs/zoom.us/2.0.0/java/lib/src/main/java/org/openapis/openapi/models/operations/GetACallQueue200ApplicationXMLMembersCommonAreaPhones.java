...
public class GetACallQueue200ApplicationXMLMembersCommonAreaPhones {
    /**
    ...
    public String id;
    public GetACallQueue200ApplicationXMLMembersCommonAreaPhones withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public String name;
    public GetACallQueue200ApplicationXMLMembersCommonAreaPhones withName(String name) {
        this.name = name;
        return this;
    }
