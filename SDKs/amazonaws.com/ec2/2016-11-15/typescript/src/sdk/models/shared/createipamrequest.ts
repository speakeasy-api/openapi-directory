 ...
 */
export enum CreateIpamRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateIpamRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateIpamRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateIpamRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateIpamRequestTagSpecificationsTags })
  tags?: CreateIpamRequestTagSpecificationsTags[];
}

export class CreateIpamRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken?: string;
  ...
  @SpeakeasyMetadata({ elemType: CreateIpamRequestTagSpecifications })
