...
public class GetSearchCarAuctionActiveQueryParams {
    ...
    public GetSearchCarAuctionActiveQueryParams withCarType(org.openapis.openapi.models.shared.CarCarTypeEnum carType) {
    ...
    public GetSearchCarAuctionActiveQueryParams withCarfax1Owner(org.openapis.openapi.models.shared.Carfax1OwnerEnum carfax1Owner) {
    ...
    public GetSearchCarAuctionActiveQueryParams withCarfaxCleanTitle(org.openapis.openapi.models.shared.CarfaxCleanTitleEnum carfaxCleanTitle) {
    ...
    public GetSearchCarAuctionActiveQueryParams withCountry(org.openapis.openapi.models.shared.CarCountryEnum country) {
    ...
    public GetSearchCarAuctionActiveQueryParams withDealerId(String dealerId) {
    ...
    public GetSearchCarAuctionActiveQueryParams withDealerType(org.openapis.openapi.models.shared.DealerTypeEnum dealerType) {
    ...
    public GetSearchCarAuctionActiveQueryParams withEngineSizeRange(String engineSizeRange) {
    ...
    public GetSearchCarAuctionActiveQueryParams withExcludeDealerIds(String excludeDealerIds) {
    ...
    public GetSearchCarAuctionActiveQueryParams withExcludeSources(String excludeSources) {
    ...
    public GetSearchCarAuctionActiveQueryParams withFacetSort(org.openapis.openapi.models.shared.FacetSortEnum facetSort) {
    ...
    public GetSearchCarAuctionActiveQueryParams withInTransit(org.openapis.openapi.models.shared.InTransitEnum inTransit) {
    ...
    public GetSearchCarAuctionActiveQueryParams withInventoryCountRange(String inventoryCountRange) {
    ...
    public GetSearchCarAuctionActiveQueryParams withMinPhotoLinks(String minPhotoLinks) {
    ...
    public GetSearchCarAuctionActiveQueryParams withMinPhotoLinksCached(String minPhotoLinksCached) {
    ...
    public GetSearchCarAuctionActiveQueryParams withPhotoLinksCached(Boolean photoLinksCached) {
    ...
    public GetSearchCarAuctionActiveQueryParams withSeatingCapacity(String seatingCapacity) {
    ...
    public GetSearchCarAuctionActiveQueryParams withSortOrder(org.openapis.openapi.models.shared.SortOrderEnum sortOrder) {
    ...
    public GetSearchCarAuctionActiveQueryParams withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public GetSearchCarAuctionActiveQueryParams withTitleType(GetSearchCarAuctionActiveTitleTypeEnum titleType) {
    ...
    public GetSearchCarAuctionActiveQueryParams withYearRange(String yearRange) {
