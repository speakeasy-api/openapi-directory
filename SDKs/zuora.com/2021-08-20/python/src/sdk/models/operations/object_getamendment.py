...
from ..shared import proxygetamendment as shared_proxygetamendment
...
class ObjectGETAmendmentResponse:
    ...
    proxy_get_amendment: Optional[shared_proxygetamendment.ProxyGetAmendment] = dataclasses.field(default=None)  
