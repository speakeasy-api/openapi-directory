...
export enum POSTDescribeServiceUpdatesActionEnum {
  DescribeServiceUpdates = "DescribeServiceUpdates",
}

export enum POSTDescribeServiceUpdatesVersionEnum {
  TwoThousandAndFifteen0202 = "2015-02-02",
}

export class POSTDescribeServiceUpdatesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class POSTDescribeServiceUpdatesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
