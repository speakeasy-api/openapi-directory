...
type AccessapprovalProjectsApprovalRequestsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AccessapprovalProjectsApprovalRequestsGetPathParams struct {
...
type AccessapprovalProjectsApprovalRequestsGetQueryParams struct {
	// V1 error format.
...
type AccessapprovalProjectsApprovalRequestsGetRequest struct {
...
type AccessapprovalProjectsApprovalRequestsGetResponse struct {
	// Successful response
