...
public class PaymentInstructionV3 {
    ...
    public PaymentInstructionV3(@JsonProperty("amount") Long amount, @JsonProperty("currency") String currency, @JsonProperty("remoteId") String remoteId, @JsonProperty("sourceAccountName") String sourceAccountName) {
        this.amount = amount;
        this.currency = currency;
        this.remoteId = remoteId;
        this.sourceAccountName = sourceAccountName;
