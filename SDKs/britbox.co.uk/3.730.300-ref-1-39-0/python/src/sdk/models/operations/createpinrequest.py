...
from ..shared import eecreatepinrequest as shared_eecreatepinrequest
from ..shared import eecreatepinresponse as shared_eecreatepinresponse
...
class CreatePinRequestRequest:
    ...
    ee_create_pin_request: shared_eecreatepinrequest.EeCreatePinRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreatePinRequestResponse:
    ...
    ee_create_pin_response: Optional[shared_eecreatepinresponse.EeCreatePinResponse] = dataclasses.field(default=None)
