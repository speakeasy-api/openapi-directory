...
class PoolStopResizeRequest:
    headers: PoolStopResizeHeaders = dataclasses.field()
    path_params: PoolStopResizePathParams = dataclasses.field()
    query_params: PoolStopResizeQueryParams = dataclasses.field()
