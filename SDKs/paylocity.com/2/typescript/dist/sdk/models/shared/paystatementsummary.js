...
var PayStatementSummary = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=beginDate" }),
        __metadata("design:type", String)
    ], PayStatementSummary.prototype, "beginDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=checkDate" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=directDepositAmount" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=grossPay" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=netCheck" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=overtimeDollars" }),
        __metadata("design:type", Number)
    ], PayStatementSummary.prototype, "overtimeDollars", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=overtimeHours" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=regularDollars" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=transactionNumber" }),
        __metadata("design:type", Number)
    ], PayStatementSummary.prototype, "transactionNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=voucherNumber" }),
        __metadata("design:type", Number)
    ], PayStatementSummary.prototype, "voucherNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=workersCompCode" }),
        __metadata("design:type", String)
