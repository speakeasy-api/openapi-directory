...
public class GetIntegrationResponseRequest {
    ...
    public GetIntegrationResponseRequest(@JsonProperty("apiId") String apiId, @JsonProperty("integrationId") String integrationId, @JsonProperty("integrationResponseId") String integrationResponseId) {
        this.apiId = apiId;
        this.integrationId = integrationId;
        this.integrationResponseId = integrationResponseId;
  }
