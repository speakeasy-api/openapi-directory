...
var Jobs = /** @class */ (function () {
    ...
    Jobs.prototype.getJob = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/jobs/{job_gid}", req);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getJob200ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetJob200ApplicationJSON);
                    }
                    break;
