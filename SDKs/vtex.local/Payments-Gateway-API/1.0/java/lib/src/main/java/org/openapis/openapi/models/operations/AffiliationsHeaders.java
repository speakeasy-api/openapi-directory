...
public class AffiliationsHeaders {
    /**
    ...
    public AffiliationsHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public AffiliationsHeaders withContentType(String contentType) {
    ...
    public AffiliationsHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public AffiliationsHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
