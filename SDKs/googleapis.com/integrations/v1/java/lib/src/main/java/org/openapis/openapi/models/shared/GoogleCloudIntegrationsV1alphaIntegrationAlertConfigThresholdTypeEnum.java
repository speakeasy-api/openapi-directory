 ...
 */
public enum GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdTypeEnum {
    ...
    private GoogleCloudIntegrationsV1alphaIntegrationAlertConfigThresholdTypeEnum(String value) {
        this.value = value;
    }
}
