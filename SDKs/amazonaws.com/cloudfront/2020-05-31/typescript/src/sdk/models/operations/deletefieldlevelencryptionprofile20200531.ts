...
export class DeleteFieldLevelEncryptionProfile20200531Request extends SpeakeasyBase {
  /**
...
export class DeleteFieldLevelEncryptionProfile20200531Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
