...
class ReleasesGetLatestPrivateReleaseSecurity:
...
class ReleasesGetLatestPrivateReleaseRequest:
    ...
    r"""When passing `udid` in the query string, a provisioning check for the given device ID will be done. Will be ignored for non-iOS platforms."""  
    
class ReleasesGetLatestPrivateRelease404ApplicationJSONCodeEnum(str, Enum):
...
class ReleasesGetLatestPrivateRelease404ApplicationJSON:
    ...
    code: ReleasesGetLatestPrivateRelease404ApplicationJSONCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
...
class ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationTypeEnum(str, Enum):
...
class ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationsDestinationTypeEnum(str, Enum):
    r"""Destination can be either store or group."""
    GROUP = 'group'
    STORE = 'store'
    TESTER = 'tester'

class ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationsTypeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ReleasesGetLatestPrivateRelease200ApplicationJSONDestinations:
    ...
    destination_type: Optional[ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationsDestinationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destination_type'), 'exclude': lambda f: f is None }})
    r"""Destination can be either store or group."""  
    ...
    type: Optional[ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationsTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""type of the distribution store currently stores type can be intune, googleplay or windows."""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionGroups:
...
class ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionStoresTypeEnum(str, Enum):
    r"""type of the distribution store currently stores type can be intune, googleplay or windows."""
    INTUNE = 'intune'
    GOOGLEPLAY = 'googleplay'
    APPLE = 'apple'
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionStores:
    ...
    publishing_status: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('publishing_status'), 'exclude': lambda f: f is None }})
    r"""publishing status of the release in the store."""  
    type: Optional[ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionStoresTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""type of the distribution store currently stores type can be intune, googleplay or windows."""  
    
class ReleasesGetLatestPrivateRelease200ApplicationJSONOriginEnum(str, Enum):
    r"""The release's origin"""
    HOCKEYAPP = 'hockeyapp'
    APPCENTER = 'appcenter'

class ReleasesGetLatestPrivateRelease200ApplicationJSONProvisioningProfileTypeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ReleasesGetLatestPrivateRelease200ApplicationJSON:
    ...
    r"""The app's OS."""  
    build: Optional[ReleasesGetLatestPrivateRelease200ApplicationJSONBuild] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('build'), 'exclude': lambda f: f is None }})
    r"""Contains metadata about the build that produced the release being uploaded"""  
    ...
    destination_type: Optional[ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destination_type'), 'exclude': lambda f: f is None }})
    r"""OBSOLETE. Will be removed in next version. The destination type.<br>
    <b>group</b>: The release distributed to internal groups and distribution_groups details will be returned.<br>
    <b>store</b>: The release distributed to external stores and distribution_stores details will be returned.<br>
    <b>tester</b>: The release distributed testers details will be returned.<br>
    """  
    destinations: Optional[list[ReleasesGetLatestPrivateRelease200ApplicationJSONDestinations]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destinations'), 'exclude': lambda f: f is None }})
    ...
    distribution_groups: Optional[list[ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionGroups]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('distribution_groups'), 'exclude': lambda f: f is None }})
    r"""OBSOLETE. Will be removed in next version. A list of distribution groups that are associated with this release."""  
    distribution_stores: Optional[list[ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionStores]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('distribution_stores'), 'exclude': lambda f: f is None }})
    ...
    origin: Optional[ReleasesGetLatestPrivateRelease200ApplicationJSONOriginEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin'), 'exclude': lambda f: f is None }})
    r"""The release's origin"""  
    ...
    provisioning_profile_type: Optional[ReleasesGetLatestPrivateRelease200ApplicationJSONProvisioningProfileTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('provisioning_profile_type'), 'exclude': lambda f: f is None }})
    r"""The type of the provisioning profile for the requested app version."""  
...
class ReleasesGetLatestPrivateReleaseResponse:
    ...
    releases_get_latest_private_release_200_application_json_object: Optional[ReleasesGetLatestPrivateRelease200ApplicationJSON] = dataclasses.field(default=None)
    r"""Return the full release details of the latest release that was distributed to the current user (from all the private distribution groups)."""  
    releases_get_latest_private_release_404_application_json_object: Optional[ReleasesGetLatestPrivateRelease404ApplicationJSON] = dataclasses.field(default=None)
    r"""Error codes:
    - `not_found` - A release or an app can't be found.
    - `no_releases_for_user` - No releases available for that user.
    """  
