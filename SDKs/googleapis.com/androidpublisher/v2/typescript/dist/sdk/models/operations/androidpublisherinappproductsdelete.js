...
exports.AndroidpublisherInappproductsDeleteResponse = exports.AndroidpublisherInappproductsDeleteRequest = exports.AndroidpublisherInappproductsDeleteSecurity = void 0;
...
var AndroidpublisherInappproductsDeleteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AndroidpublisherInappproductsDeleteRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AndroidpublisherInappproductsDeleteRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AndroidpublisherInappproductsDeleteRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AndroidpublisherInappproductsDeleteRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=packageName",
        }),
        __metadata("design:type", String)
    ], AndroidpublisherInappproductsDeleteRequest.prototype, "packageName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AndroidpublisherInappproductsDeleteRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AndroidpublisherInappproductsDeleteRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=sku" }),
        __metadata("design:type", String)
    ], AndroidpublisherInappproductsDeleteRequest.prototype, "sku", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AndroidpublisherInappproductsDeleteRequest.prototype, "userIp", void 0);
...
var AndroidpublisherInappproductsDeleteResponse = /** @class */ (function (_super) {
    ...
    ], AndroidpublisherInappproductsDeleteResponse.prototype, "rawResponse", void 0);
