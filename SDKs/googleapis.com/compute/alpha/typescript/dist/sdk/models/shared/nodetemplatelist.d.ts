 ...
 */
export declare enum NodeTemplateListWarningCodeEnum {
...
export declare class NodeTemplateListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodeTemplateListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class NodeTemplateList extends SpeakeasyBase {
    /**
