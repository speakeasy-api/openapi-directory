...
public class Destiny2GetLeaderboardsPathParams {
    /**
     * The Destiny membershipId of the user to retrieve.
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=destinyMembershipId")
    public Long destinyMembershipId;
    public Destiny2GetLeaderboardsPathParams withDestinyMembershipId(Long destinyMembershipId) {
    ...
    public Destiny2GetLeaderboardsPathParams withMembershipType(Integer membershipType) {
