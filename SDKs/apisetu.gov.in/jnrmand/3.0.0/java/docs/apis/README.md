...
* [trcer](#trcer) - Transfer Certificate
    ...
    public static void main(String[] args) {
        try {
            ...
            TrcerRequestBody req = new TrcerRequestBody(TrcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new TrcerRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "12PO0012");;
            ...
            TrcerResponse res = sdk.apIs.trcer(req, new TrcerSecurity("maiores", "molestiae") {{
