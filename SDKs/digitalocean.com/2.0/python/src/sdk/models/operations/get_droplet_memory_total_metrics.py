...
class GetDropletMemoryTotalMetrics200ApplicationJSONData:
    result: list[GetDropletMemoryTotalMetrics200ApplicationJSONDataResult] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('result') }})
    result_type: GetDropletMemoryTotalMetrics200ApplicationJSONDataResultTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('resultType') }})
...
class GetDropletMemoryTotalMetrics200ApplicationJSON:
    data: GetDropletMemoryTotalMetrics200ApplicationJSONData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
    status: GetDropletMemoryTotalMetrics200ApplicationJSONStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class GetDropletMemoryTotalMetricsRequest:
    query_params: GetDropletMemoryTotalMetricsQueryParams = dataclasses.field()
...
class GetDropletMemoryTotalMetricsResponse:
    ...
    get_droplet_memory_total_metrics_200_application_json_object: Optional[GetDropletMemoryTotalMetrics200ApplicationJSON] = dataclasses.field(default=None)
    get_droplet_memory_total_metrics_401_application_json_object: Optional[GetDropletMemoryTotalMetrics401ApplicationJSON] = dataclasses.field(default=None)
