...
class WritableInterfaceTemplateFormFactorEnum(str, Enum):
    ZERO = '0'
    TWO_HUNDRED = '200'
    EIGHT_HUNDRED = '800'
    ONE_THOUSAND = '1000'
...
class WritableInterfaceTemplateInput:
    ...
    form_factor: Optional[WritableInterfaceTemplateFormFactorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('form_factor'), 'exclude': lambda f: f is None }})  
