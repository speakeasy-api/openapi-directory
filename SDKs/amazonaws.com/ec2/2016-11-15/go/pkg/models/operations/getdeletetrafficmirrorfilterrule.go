...
func (e GETDeleteTrafficMirrorFilterRuleActionEnum) ToPointer() *GETDeleteTrafficMirrorFilterRuleActionEnum {
	return &e
}
...
func (e *GETDeleteTrafficMirrorFilterRuleActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DeleteTrafficMirrorFilterRule":
		*e = GETDeleteTrafficMirrorFilterRuleActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDeleteTrafficMirrorFilterRuleActionEnum: %v", v)
	}
}
...
func (e GETDeleteTrafficMirrorFilterRuleVersionEnum) ToPointer() *GETDeleteTrafficMirrorFilterRuleVersionEnum {
	return &e
}
...
func (e *GETDeleteTrafficMirrorFilterRuleVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2016-11-15":
		*e = GETDeleteTrafficMirrorFilterRuleVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDeleteTrafficMirrorFilterRuleVersionEnum: %v", v)
	}
}
