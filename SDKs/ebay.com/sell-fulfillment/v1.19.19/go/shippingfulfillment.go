...
func (s *shippingFulfillment) CreateShippingFulfillment(ctx context.Context, request operations.CreateShippingFulfillmentRequest, security operations.CreateShippingFulfillmentSecurity) (*operations.CreateShippingFulfillmentResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/order/{orderId}/shipping_fulfillment", request, nil)
...
func (s *shippingFulfillment) GetShippingFulfillment(ctx context.Context, request operations.GetShippingFulfillmentRequest, security operations.GetShippingFulfillmentSecurity) (*operations.GetShippingFulfillmentResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/order/{orderId}/shipping_fulfillment/{fulfillmentId}", request, nil)
