...
class GroupV2EditOptionalConversationRequest:
    ...
    conversation_id: int = dataclasses.field(metadata={'path_param': { 'field_name': 'conversationId', 'style': 'simple', 'explode': False }})
    r"""Conversation Id of the channel being edited."""  
