...
class CreateWebACLMigrationStackRequest:
    ...
    create_web_acl_migration_stack_request: shared_createwebaclmigrationstackrequest.CreateWebACLMigrationStackRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
