...
public class PostFloatingIpsIdActionsChangeDnsPtrActionResponseAction {
    ...
    public PostFloatingIpsIdActionsChangeDnsPtrActionResponseAction(@JsonProperty("command") String command, @JsonProperty("error") PostFloatingIpsIdActionsChangeDnsPtrActionResponseActionError error, @JsonProperty("finished") String finished, @JsonProperty("id") Long id, @JsonProperty("progress") Double progress, @JsonProperty("resources") PostFloatingIpsIdActionsChangeDnsPtrActionResponseActionResources[] resources, @JsonProperty("started") String started, @JsonProperty("status") PostFloatingIpsIdActionsChangeDnsPtrActionResponseActionStatusEnum status) {
        this.command = command;
        this.error = error;
        this.finished = finished;
        this.id = id;
