...
public class GetSuggestionPathParams {
    /**
    ...
    public GetSuggestionPathParams withSellerId(String sellerId) {
    ...
    public GetSuggestionPathParams withSellerSkuId(String sellerSkuId) {
