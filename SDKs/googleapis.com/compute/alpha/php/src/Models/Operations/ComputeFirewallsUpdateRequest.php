...
class ComputeFirewallsUpdateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\Firewall $firewall1 = null;
     ...
     * 
     * @var string $firewallPathParameter
     */
