...
class AnalyticsManagementWebpropertyUserLinksListSecurity:
    option1: Optional[AnalyticsManagementWebpropertyUserLinksListSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementWebpropertyUserLinksListSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class AnalyticsManagementWebpropertyUserLinksListRequest:
    path_params: AnalyticsManagementWebpropertyUserLinksListPathParams = dataclasses.field()
    query_params: AnalyticsManagementWebpropertyUserLinksListQueryParams = dataclasses.field()
    security: AnalyticsManagementWebpropertyUserLinksListSecurity = dataclasses.field()
