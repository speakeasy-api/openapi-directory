...
public class GetNetworkDevicesLatencyStatsRequest {
    ...
    public GetNetworkDevicesLatencyStatsRequest withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkDevicesLatencyStatsBandEnum band;

    public GetNetworkDevicesLatencyStatsRequest withBand(GetNetworkDevicesLatencyStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public GetNetworkDevicesLatencyStatsRequest withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public GetNetworkDevicesLatencyStatsRequest withNetworkId(String networkId) {
    ...
    public GetNetworkDevicesLatencyStatsRequest withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public GetNetworkDevicesLatencyStatsRequest withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public GetNetworkDevicesLatencyStatsRequest withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkDevicesLatencyStatsRequest withTimespan(Float timespan) {
    ...
    public GetNetworkDevicesLatencyStatsRequest withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
    
    public GetNetworkDevicesLatencyStatsRequest(@JsonProperty("networkId") String networkId) {
        this.networkId = networkId;
  }
}
