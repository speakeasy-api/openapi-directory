...
class GetDeleteLaunchTemplateQueryParams:
    action: GetDeleteLaunchTemplateActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDeleteLaunchTemplateVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteLaunchTemplateRequest:
    headers: GetDeleteLaunchTemplateHeaders = dataclasses.field()
    query_params: GetDeleteLaunchTemplateQueryParams = dataclasses.field()
