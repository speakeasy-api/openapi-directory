...
class GetVariantPhenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetVariantPhenotypeAssociationsQueryParams:
...
class GetVariantPhenotypeAssociationsRequest:
    path_params: GetVariantPhenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetVariantPhenotypeAssociationsQueryParams = dataclasses.field()
