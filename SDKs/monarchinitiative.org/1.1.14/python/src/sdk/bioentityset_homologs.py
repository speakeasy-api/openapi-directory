...
class BioentitysetHomologs:
    ...
    def get_entity_set_homologs(self, request: operations.GetEntitySetHomologsRequest) -> operations.GetEntitySetHomologsResponse:
        ...
        query_params = utils.get_query_params(operations.GetEntitySetHomologsRequest, request)
        ...
        res = operations.GetEntitySetHomologsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
