...
from ..shared import groupsv2_groupmemberleaveresult as shared_groupsv2_groupmemberleaveresult
...
@dataclasses.dataclass
class GroupV2KickMember200Wildcard:
    ...
    response: Optional[shared_groupsv2_groupmemberleaveresult.GroupsV2GroupMemberLeaveResult] = dataclasses.field(default=None)  
