...
class DeleteDatasetContentRequest:
    ...
    r"""The name of the dataset whose content is deleted."""  
    version_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'versionId', 'style': 'form', 'explode': True }})
    r"""The version of the dataset whose content is deleted. You can also use the strings \\"$LATEST\\" or \\"$LATEST_SUCCEEDED\\" to delete the latest or latest successfully completed data set. If not specified, \\"$LATEST_SUCCEEDED\\" is the default."""  
