...
public class GETSwitchoverBlueGreenDeploymentRequest {
    ...
    public GETSwitchoverBlueGreenDeploymentRequest(@JsonProperty("Action") GETSwitchoverBlueGreenDeploymentActionEnum action, @JsonProperty("BlueGreenDeploymentIdentifier") String blueGreenDeploymentIdentifier, @JsonProperty("Version") GETSwitchoverBlueGreenDeploymentVersionEnum version) {
        this.action = action;
        this.blueGreenDeploymentIdentifier = blueGreenDeploymentIdentifier;
        this.version = version;
  }
