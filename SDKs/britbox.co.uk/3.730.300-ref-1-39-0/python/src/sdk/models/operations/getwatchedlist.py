...
class GetWatchedListRequest:
    ...
    r"""Filter by whether an item has been fully watched (completed) or not.
    ...
    order_by: Optional[GetWatchedListOrderByEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order_by', 'style': 'form', 'explode': True }})
    r"""What to order by.
