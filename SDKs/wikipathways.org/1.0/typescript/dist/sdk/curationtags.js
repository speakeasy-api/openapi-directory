...
exports.CurationTags = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var CurationTags = /** @class */ (function () {
    function CurationTags(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CurationTags.prototype.getGetCurationTagHistory = function (req, config) {
    ...
    **/
    CurationTags.prototype.getGetCurationTags = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    CurationTags.prototype.getGetCurationTagsByName = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    CurationTags.prototype.getGetOntologyTermsByPathway = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    CurationTags.prototype.getSaveCurationTag = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.CurationTags = CurationTags;
