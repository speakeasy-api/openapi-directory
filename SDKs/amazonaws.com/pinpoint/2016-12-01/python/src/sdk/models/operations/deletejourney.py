...
from ..shared import deletejourneyresponse as shared_deletejourneyresponse
...
class DeleteJourneyRequest:
    headers: DeleteJourneyHeaders = dataclasses.field()
    path_params: DeleteJourneyPathParams = dataclasses.field()
...
class DeleteJourneyResponse:
    ...
    delete_journey_response: Optional[shared_deletejourneyresponse.DeleteJourneyResponse] = dataclasses.field(default=None)
