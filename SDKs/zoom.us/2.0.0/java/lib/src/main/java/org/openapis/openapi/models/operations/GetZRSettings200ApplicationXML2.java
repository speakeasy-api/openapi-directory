...
public class GetZRSettings200ApplicationXML2 {
    /**
    ...
    public GetZRSettings200ApplicationXML2ClientAlert clientAlert;
    public GetZRSettings200ApplicationXML2 withClientAlert(GetZRSettings200ApplicationXML2ClientAlert clientAlert) {
        this.clientAlert = clientAlert;
        return this;
    }
    
    
    public GetZRSettings200ApplicationXML2DigitalSignage digitalSignage;
    public GetZRSettings200ApplicationXML2 withDigitalSignage(GetZRSettings200ApplicationXML2DigitalSignage digitalSignage) {
    ...
    public GetZRSettings200ApplicationXML2Notification notification;
    public GetZRSettings200ApplicationXML2 withNotification(GetZRSettings200ApplicationXML2Notification notification) {
