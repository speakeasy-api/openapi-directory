...
func main() {
    ...
    res, err := s.SDK.AddAttachmentsToSet(ctx, operations.AddAttachmentsToSetRequest{
        AddAttachmentsToSetRequest: shared.AddAttachmentsToSetRequest{
            AttachmentSetID: sdk.String("ipsa"),
            Attachments: []shared.Attachment{
                ...
                shared.Attachment{
                    ...
                    FileName: sdk.String("minus"),
                },
                shared.Attachment{
                    Data: sdk.String("placeat"),
                    FileName: sdk.String("voluptatum"),
                },
                shared.Attachment{
                    Data: sdk.String("iusto"),
                    FileName: sdk.String("excepturi"),
                },
            },
        },
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.AddCommunicationToCase(ctx, operations.AddCommunicationToCaseRequest{
        AddCommunicationToCaseRequest: shared.AddCommunicationToCaseRequest{
            AttachmentSetID: sdk.String("perferendis"),
            CaseID: sdk.String("ipsam"),
        ...
        XAmzTarget: operations.AddCommunicationToCaseXAmzTargetEnumAwsSupport20130415AddCommunicationToCase,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.AddCommunicationToCaseResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.SDK.CreateCase(ctx, operations.CreateCaseRequest{
        CreateCaseRequest: shared.CreateCaseRequest{
            AttachmentSetID: sdk.String("dolorum"),
            CategoryCode: sdk.String("dicta"),
            CcEmailAddresses: []string{
                "officia",
                "occaecati",
                "fugit",
            },
            CommunicationBody: "deleniti",
            IssueType: sdk.String("hic"),
            Language: sdk.String("optio"),
            ServiceCode: sdk.String("totam"),
            SeverityCode: sdk.String("beatae"),
            Subject: "commodi",
        },
        ...
        XAmzTarget: operations.CreateCaseXAmzTargetEnumAwsSupport20130415CreateCase,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DescribeAttachment(ctx, operations.DescribeAttachmentRequest{
        DescribeAttachmentRequest: shared.DescribeAttachmentRequest{
            AttachmentID: "excepturi",
        },
        ...
        XAmzTarget: operations.DescribeAttachmentXAmzTargetEnumAwsSupport20130415DescribeAttachment,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DescribeAttachmentResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DescribeCases(ctx, operations.DescribeCasesRequest{
        DescribeCasesRequest: shared.DescribeCasesRequest{
            AfterTime: sdk.String("natus"),
            BeforeTime: sdk.String("laboriosam"),
            CaseIDList: []string{
                "saepe",
                "fuga",
                "in",
            ...
            DisplayID: sdk.String("iste"),
            IncludeCommunications: sdk.Bool(false),
            IncludeResolvedCases: sdk.Bool(false),
            Language: sdk.String("iure"),
            MaxResults: sdk.Int64(902349),
        ...
        XAmzTarget: operations.DescribeCasesXAmzTargetEnumAwsSupport20130415DescribeCases,
    ...
    if res.DescribeCasesResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DescribeCommunications(ctx, operations.DescribeCommunicationsRequest{
        DescribeCommunicationsRequest: shared.DescribeCommunicationsRequest{
            AfterTime: sdk.String("explicabo"),
            BeforeTime: sdk.String("nobis"),
            CaseID: "enim",
        ...
        XAmzTarget: operations.DescribeCommunicationsXAmzTargetEnumAwsSupport20130415DescribeCommunications,
    ...
    if res.DescribeCommunicationsResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.SDK.DescribeServices(ctx, operations.DescribeServicesRequest{
        ...
        XAmzTarget: operations.DescribeServicesXAmzTargetEnumAwsSupport20130415DescribeServices,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DescribeSeverityLevels(ctx, operations.DescribeSeverityLevelsRequest{
        ...
        XAmzTarget: operations.DescribeSeverityLevelsXAmzTargetEnumAwsSupport20130415DescribeSeverityLevels,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DescribeSeverityLevelsResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DescribeTrustedAdvisorCheckRefreshStatuses(ctx, operations.DescribeTrustedAdvisorCheckRefreshStatusesRequest{
        ...
        XAmzTarget: operations.DescribeTrustedAdvisorCheckRefreshStatusesXAmzTargetEnumAwsSupport20130415DescribeTrustedAdvisorCheckRefreshStatuses,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DescribeTrustedAdvisorCheckRefreshStatusesResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DescribeTrustedAdvisorCheckResult(ctx, operations.DescribeTrustedAdvisorCheckResultRequest{
        ...
        XAmzTarget: operations.DescribeTrustedAdvisorCheckResultXAmzTargetEnumAwsSupport20130415DescribeTrustedAdvisorCheckResult,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DescribeTrustedAdvisorCheckResultResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DescribeTrustedAdvisorCheckSummaries(ctx, operations.DescribeTrustedAdvisorCheckSummariesRequest{
        ...
        XAmzTarget: operations.DescribeTrustedAdvisorCheckSummariesXAmzTargetEnumAwsSupport20130415DescribeTrustedAdvisorCheckSummaries,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DescribeTrustedAdvisorCheckSummariesResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DescribeTrustedAdvisorChecks(ctx, operations.DescribeTrustedAdvisorChecksRequest{
        ...
        XAmzTarget: operations.DescribeTrustedAdvisorChecksXAmzTargetEnumAwsSupport20130415DescribeTrustedAdvisorChecks,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DescribeTrustedAdvisorChecksResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.RefreshTrustedAdvisorCheck(ctx, operations.RefreshTrustedAdvisorCheckRequest{
        ...
        XAmzTarget: operations.RefreshTrustedAdvisorCheckXAmzTargetEnumAwsSupport20130415RefreshTrustedAdvisorCheck,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.RefreshTrustedAdvisorCheckResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.ResolveCase(ctx, operations.ResolveCaseRequest{
        ResolveCaseRequest: shared.ResolveCaseRequest{
            CaseID: sdk.String("voluptates"),
        },
        ...
        XAmzTarget: operations.ResolveCaseXAmzTargetEnumAwsSupport20130415ResolveCase,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.ResolveCaseResponse != nil {
        // handle response
    }
}
```
