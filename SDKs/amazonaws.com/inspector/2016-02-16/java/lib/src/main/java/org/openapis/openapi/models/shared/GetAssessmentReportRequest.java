...
public class GetAssessmentReportRequest {
    ...
    public GetAssessmentReportRequest(@JsonProperty("assessmentRunArn") String assessmentRunArn, @JsonProperty("reportFileFormat") ReportFileFormatEnum reportFileFormat, @JsonProperty("reportType") ReportTypeEnum reportType) {
        this.assessmentRunArn = assessmentRunArn;
        this.reportFileFormat = reportFileFormat;
        this.reportType = reportType;
  }
