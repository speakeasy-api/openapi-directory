...
exports.PostGeomarksCopyResponse = exports.PostGeomarksCopyRequest = exports.PostGeomarksCopyQueryParams = exports.PostGeomarksCopyResultFormatEnum = exports.PostGeomarksCopyBufferJoinEnum = exports.PostGeomarksCopyBufferCapEnum = void 0;
...
var PostGeomarksCopyQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=allowOverlap" }),
        __metadata("design:type", Boolean)
    ], PostGeomarksCopyQueryParams.prototype, "allowOverlap", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=bufferCap" }),
        __metadata("design:type", String)
    ], PostGeomarksCopyQueryParams.prototype, "bufferCap", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=bufferJoin" }),
        __metadata("design:type", String)
    ], PostGeomarksCopyQueryParams.prototype, "bufferJoin", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=bufferMetres" }),
        __metadata("design:type", Number)
    ], PostGeomarksCopyQueryParams.prototype, "bufferMetres", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=bufferMitreLimit" }),
        __metadata("design:type", Number)
    ], PostGeomarksCopyQueryParams.prototype, "bufferMitreLimit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=bufferSegments" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=failureRedirectUrl" }),
        __metadata("design:type", String)
    ], PostGeomarksCopyQueryParams.prototype, "failureRedirectUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=geomarkUrl" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=resultFormat" }),
        __metadata("design:type", String)
    ], PostGeomarksCopyQueryParams.prototype, "resultFormat", void 0);
    return PostGeomarksCopyQueryParams;
}(utils_1.SpeakeasyBase));
exports.PostGeomarksCopyQueryParams = PostGeomarksCopyQueryParams;
