...
class Neosentry:
    ...
    def retrieve_sentry_risk_data(self, request: operations.RetrieveSentryRiskDataRequest) -> operations.RetrieveSentryRiskDataResponse:
        ...
        query_params = utils.get_query_params(operations.RetrieveSentryRiskDataRequest, request)
        ...
        res = operations.RetrieveSentryRiskDataResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SentryObjectPagingDto])
    ...
    def retrieve_sentry_risk_data_by_id(self, request: operations.RetrieveSentryRiskDataByIDRequest) -> operations.RetrieveSentryRiskDataByIDResponse:
        ...
        url = utils.generate_url(operations.RetrieveSentryRiskDataByIDRequest, base_url, '/rest/v1/neo/sentry/{asteroid_id}', request)
        ...
        res = operations.RetrieveSentryRiskDataByIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SentryImpactRiskObject])
