...
class OpenBadgeClassCriteria:
    ...
    narrative: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('narrative'), 'exclude': lambda f: f is None }})  
...
class OpenBadgeClass:
    ...
    criteria: Optional[OpenBadgeClassCriteria] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('criteria'), 'exclude': lambda f: f is None }})  
