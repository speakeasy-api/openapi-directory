...
export class AccesscontextmanagerOrganizationsGcpUserAccessBindingsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AccesscontextmanagerOrganizationsGcpUserAccessBindingsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AccesscontextmanagerOrganizationsGcpUserAccessBindingsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
