...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/rawg.io/v1.0/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/rawg.io/v1.0/typescript
```
