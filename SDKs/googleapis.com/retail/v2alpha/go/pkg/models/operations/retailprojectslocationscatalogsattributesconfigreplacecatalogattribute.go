...
type RetailProjectsLocationsCatalogsAttributesConfigReplaceCatalogAttributeSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RetailProjectsLocationsCatalogsAttributesConfigReplaceCatalogAttributePathParams struct {
	// Required. Full AttributesConfig resource name. Format: `projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}/attributesConfig`
	AttributesConfig string `pathParam:"style=simple,explode=false,name=attributesConfig"`
}

type RetailProjectsLocationsCatalogsAttributesConfigReplaceCatalogAttributeQueryParams struct {
	// V1 error format.
...
type RetailProjectsLocationsCatalogsAttributesConfigReplaceCatalogAttributeRequest struct {
	...
	Request     *shared.GoogleCloudRetailV2alphaReplaceCatalogAttributeRequestInput `request:"mediaType=application/json"`
	Security    RetailProjectsLocationsCatalogsAttributesConfigReplaceCatalogAttributeSecurity
}

type RetailProjectsLocationsCatalogsAttributesConfigReplaceCatalogAttributeResponse struct {
	ContentType string
	// Successful response
