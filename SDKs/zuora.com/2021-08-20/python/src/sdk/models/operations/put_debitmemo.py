...
from ..shared import putdebitmemotype as shared_putdebitmemotype
...
class PUTDebitMemoRequest:
    ...
    put_debit_memo_type: shared_putdebitmemotype.PUTDebitMemoType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
