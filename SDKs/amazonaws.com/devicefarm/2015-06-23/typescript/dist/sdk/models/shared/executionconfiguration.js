...
exports.ExecutionConfiguration = void 0;
...
var ExecutionConfiguration = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=accountsCleanup" }),
        __metadata("design:type", Boolean)
    ], ExecutionConfiguration.prototype, "accountsCleanup", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=appPackagesCleanup" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=videoCapture" }),
        __metadata("design:type", Boolean)
