...
@dataclasses.dataclass
class RunNamespacesRevisionsListQueryParams:
...
class RunNamespacesRevisionsListRequest:
    path_params: RunNamespacesRevisionsListPathParams = dataclasses.field()
    query_params: RunNamespacesRevisionsListQueryParams = dataclasses.field()
    security: RunNamespacesRevisionsListSecurity = dataclasses.field()
