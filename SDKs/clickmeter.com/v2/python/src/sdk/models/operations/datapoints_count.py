...
class DataPointsCountRequest:
    ...
    status: Optional[DataPointsCountStatusEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'status', 'style': 'form', 'explode': True }})
    r"""Status of the datapoint"""  
    ...
    type: Optional[DataPointsCountTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
    r"""Type of the datapoint (\\"tp\\"/\\"tl\\")"""  
