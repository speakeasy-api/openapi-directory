...
try {
    ...
    $request->q = 'dolorum';
    $request->sort = SearchIssuesAndPullRequestsSortEnum::CREATED;
...
try {
    ...
    $request->order = OrderEnum::DESC;
    $request->page = 715143;
    $request->perPage = 481375;
    $request->q = 'quas';
    $request->sort = SearchReposSortEnum::STARS;
...
try {
    ...
    $request->q = 'aut';
    $request->sort = SearchUsersSortEnum::REPOSITORIES;
