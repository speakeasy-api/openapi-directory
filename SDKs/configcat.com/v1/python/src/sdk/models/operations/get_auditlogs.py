...
class GetAuditlogsAuditLogTypeEnum(str, Enum):
...
class GetAuditlogsRequest:
    ...
    audit_log_type: Optional[GetAuditlogsAuditLogTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'auditLogType', 'style': 'form', 'explode': True }})
    r"""Filter Audit logs by Audit log type."""  
