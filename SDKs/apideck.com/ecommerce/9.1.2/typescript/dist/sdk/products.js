...
var Products = /** @class */ (function () {
     ...
     * List Products
     */
    Products.prototype.productsAll = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ProductsAllRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/ecommerce/products";
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.ProductsAllSecurity(security);
        }
     ...
     * Get Product
     */
    Products.prototype.productsOne = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ProductsOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ecommerce/products/{id}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.ProductsOneSecurity(security);
        }
        var client = utils.createSecurityClient(this._defaultClient, security);
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req)), config === null || config === void 0 ? void 0 : config.headers);
        var queryParams = utils.serializeQueryParams(req);
