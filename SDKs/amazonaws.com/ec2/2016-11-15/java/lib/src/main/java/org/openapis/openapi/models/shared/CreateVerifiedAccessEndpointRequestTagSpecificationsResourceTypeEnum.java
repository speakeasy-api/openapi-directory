 ...
 */
public enum CreateVerifiedAccessEndpointRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateVerifiedAccessEndpointRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
