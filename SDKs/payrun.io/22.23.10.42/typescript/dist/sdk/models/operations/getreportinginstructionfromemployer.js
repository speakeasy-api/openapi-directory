...
exports.GetReportingInstructionFromEmployerResponse = exports.GetReportingInstructionFromEmployerRequest = void 0;
...
var GetReportingInstructionFromEmployerRequest = /** @class */ (function (_super) {
    ...
    ], GetReportingInstructionFromEmployerRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetReportingInstructionFromEmployerRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetReportingInstructionFromEmployerRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ReportingInstructionId",
        }),
        __metadata("design:type", String)
    ], GetReportingInstructionFromEmployerRequest.prototype, "reportingInstructionId", void 0);
    return GetReportingInstructionFromEmployerRequest;
}(utils_1.SpeakeasyBase));
exports.GetReportingInstructionFromEmployerRequest = GetReportingInstructionFromEmployerRequest;
var GetReportingInstructionFromEmployerResponse = /** @class */ (function (_super) {
    ...
    ], GetReportingInstructionFromEmployerResponse.prototype, "rawResponse", void 0);
    return GetReportingInstructionFromEmployerResponse;
}(utils_1.SpeakeasyBase));
exports.GetReportingInstructionFromEmployerResponse = GetReportingInstructionFromEmployerResponse;
