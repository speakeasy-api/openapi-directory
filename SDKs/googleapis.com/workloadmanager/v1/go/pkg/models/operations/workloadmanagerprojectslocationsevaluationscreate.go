...
type WorkloadmanagerProjectsLocationsEvaluationsCreateQueryParams struct {
...
type WorkloadmanagerProjectsLocationsEvaluationsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type WorkloadmanagerProjectsLocationsEvaluationsCreateRequest struct {
	...
	Request     *shared.EvaluationInput `request:"mediaType=application/json"`
	Security    WorkloadmanagerProjectsLocationsEvaluationsCreateSecurity
}

type WorkloadmanagerProjectsLocationsEvaluationsCreateResponse struct {
	ContentType string
