...
export declare class GetNhClothingClothingRequest extends SpeakeasyBase {
    /**
...
export declare class GetNhClothingClothingResponse extends SpeakeasyBase {
    contentType: string;
    /**
