...
public class IncomeVerificationDocumentsDownloadRequest {
    ...
    public IncomeVerificationDocumentsDownloadRequest withAccessToken(String accessToken) {
    ...
    public IncomeVerificationDocumentsDownloadRequest withDocumentId(String documentId) {
