...
exports.SearchProjectSoftwarepackageResponse = exports.SearchProjectSoftwarepackageRequest = exports.SearchProjectSoftwarepackageQueryParams = void 0;
...
var SearchProjectSoftwarepackageQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.project_softwarepackage.capabilities" }),
        __metadata("design:type", String)
    ], SearchProjectSoftwarepackageQueryParams.prototype, "searchProjectSoftwarepackageCapabilities", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.project_softwarepackage.domain" }),
        __metadata("design:type", String)
    ], SearchProjectSoftwarepackageQueryParams.prototype, "searchProjectSoftwarepackageDomain", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.project_softwarepackage.license" }),
        __metadata("design:type", String)
    ], SearchProjectSoftwarepackageQueryParams.prototype, "searchProjectSoftwarepackageLicense", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.project_softwarepackage.platform" }),
        __metadata("design:type", String)
    ], SearchProjectSoftwarepackageQueryParams.prototype, "searchProjectSoftwarepackagePlatform", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.project_softwarepackage.software_type" }),
        __metadata("design:type", String)
    ], SearchProjectSoftwarepackageQueryParams.prototype, "searchProjectSoftwarepackageSoftwareType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.project_softwarepackage.software_use" }),
        __metadata("design:type", String)
    ], SearchProjectSoftwarepackageQueryParams.prototype, "searchProjectSoftwarepackageSoftwareUse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.project_softwarepackage.status" }),
        __metadata("design:type", String)
...
exports.SearchProjectSoftwarepackageQueryParams = SearchProjectSoftwarepackageQueryParams;
...
exports.SearchProjectSoftwarepackageRequest = SearchProjectSoftwarepackageRequest;
...
exports.SearchProjectSoftwarepackageResponse = SearchProjectSoftwarepackageResponse;
