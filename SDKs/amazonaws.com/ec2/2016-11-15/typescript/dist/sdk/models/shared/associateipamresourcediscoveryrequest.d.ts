 ...
 */
export declare enum AssociateIpamResourceDiscoveryRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class AssociateIpamResourceDiscoveryRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class AssociateIpamResourceDiscoveryRequestTagSpecifications extends SpeakeasyBase {
...
export declare class AssociateIpamResourceDiscoveryRequest extends SpeakeasyBase {
    clientToken?: string;
    dryRun?: boolean;
    ipamId: string;
