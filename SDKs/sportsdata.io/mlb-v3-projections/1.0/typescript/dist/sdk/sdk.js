...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.projectedPlayerGameStatsByDateWInjuriesLineupsDfsSalaries = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.projectedPlayerSeasonStatsWithAdp = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
