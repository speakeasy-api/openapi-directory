...
func (s *Repos) ReposCheckVulnerabilityAlerts(ctx context.Context, request operations.ReposCheckVulnerabilityAlertsRequest) (*operations.ReposCheckVulnerabilityAlertsResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/vulnerability-alerts", request.PathParams)
...
func (s *Repos) ReposCompareCommits(ctx context.Context, request operations.ReposCompareCommitsRequest) (*operations.ReposCompareCommitsResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/compare/{base}...{head}", request.PathParams)
...
func (s *Repos) ReposCreateDeployment(ctx context.Context, request operations.ReposCreateDeploymentRequest) (*operations.ReposCreateDeploymentResponse, error) {
	...
	case httpRes.StatusCode == 409:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.ReposCreateDeployment409ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Repos) ReposCreateOrUpdateEnvironment(ctx context.Context, request operations.ReposCreateOrUpdateEnvironmentRequest) (*operations.ReposCreateOrUpdateEnvironmentResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/environments/{environment_name}", request.PathParams)
...
func (s *Repos) ReposDisableAutomatedSecurityFixes(ctx context.Context, request operations.ReposDisableAutomatedSecurityFixesRequest) (*operations.ReposDisableAutomatedSecurityFixesResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/automated-security-fixes", request.PathParams)
...
func (s *Repos) ReposGetAllEnvironments(ctx context.Context, request operations.ReposGetAllEnvironmentsRequest) (*operations.ReposGetAllEnvironmentsResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/environments", request.PathParams)
...
func (s *Repos) ReposGetClones(ctx context.Context, request operations.ReposGetClonesRequest) (*operations.ReposGetClonesResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/traffic/clones", request.PathParams)
...
func (s *Repos) ReposGetCommunityProfileMetrics(ctx context.Context, request operations.ReposGetCommunityProfileMetricsRequest) (*operations.ReposGetCommunityProfileMetricsResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/community/profile", request.PathParams)
...
func (s *Repos) ReposGetPullRequestReviewProtection(ctx context.Context, request operations.ReposGetPullRequestReviewProtectionRequest) (*operations.ReposGetPullRequestReviewProtectionResponse, error) {
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/vnd.github.luke-cage-preview+json`):
...
// READMEs support [custom media types](https://docs.github.com/rest/reference/repos#custom-media-types) for retrieving the raw content or rendered HTML.
// https://docs.github.com/rest/reference/repos#get-a-repository-readme - API method documentation
func (s *Repos) ReposGetReadmeFromAltPath(ctx context.Context, request operations.ReposGetReadmeFromAltPathRequest) (*operations.ReposGetReadmeFromAltPathResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.ReposGetReadmeFromAltPathResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Repos) ReposGetTopPaths(ctx context.Context, request operations.ReposGetTopPathsRequest) (*operations.ReposGetTopPathsResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/traffic/popular/paths", request.PathParams)
...
func (s *Repos) ReposGetTopReferrers(ctx context.Context, request operations.ReposGetTopReferrersRequest) (*operations.ReposGetTopReferrersResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/traffic/popular/referrers", request.PathParams)
...
func (s *Repos) ReposGetViews(ctx context.Context, request operations.ReposGetViewsRequest) (*operations.ReposGetViewsResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/traffic/views", request.PathParams)
...
func (s *Repos) ReposMerge(ctx context.Context, request operations.ReposMergeRequest) (*operations.ReposMergeResponse, error) {
	...
	case httpRes.StatusCode == 404:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.ReposMerge404ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 409:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.ReposMerge409ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
