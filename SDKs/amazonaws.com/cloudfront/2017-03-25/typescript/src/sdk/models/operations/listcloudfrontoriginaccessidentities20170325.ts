...
export class ListCloudFrontOriginAccessIdentities20170325Request extends SpeakeasyBase {
  /**
...
export class ListCloudFrontOriginAccessIdentities20170325Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
