...
var PhysicalNetworkInterface = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ipAddressAssignment" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "netmask" }),
        __metadata("design:type", String)
    ], PhysicalNetworkInterface.prototype, "netmask", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "physicalConnectorType" }),
        __metadata("design:type", String)
    ], PhysicalNetworkInterface.prototype, "physicalConnectorType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "physicalNetworkInterfaceId" }),
        __metadata("design:type", String)
