...
class BackTestAnomalyDetectorRequest:
    headers: BackTestAnomalyDetectorHeaders = dataclasses.field()
    request: BackTestAnomalyDetectorRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class BackTestAnomalyDetectorResponse:
    ...
    back_test_anomaly_detector_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
