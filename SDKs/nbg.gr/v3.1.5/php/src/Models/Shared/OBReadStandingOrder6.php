...
class OBReadStandingOrder6
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBReadDataStandingOrder5')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\OBReadDataStandingOrder5();
		$this->links = null;
		$this->meta = null;
	}
}
