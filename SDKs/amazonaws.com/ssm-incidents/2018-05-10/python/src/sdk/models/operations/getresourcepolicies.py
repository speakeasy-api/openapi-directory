...
from ..shared import getresourcepoliciesoutput as shared_getresourcepoliciesoutput
...
class GetResourcePoliciesRequest:
    ...
    request: GetResourcePoliciesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetResourcePoliciesResponse:
    ...
    get_resource_policies_output: Optional[shared_getresourcepoliciesoutput.GetResourcePoliciesOutput] = dataclasses.field(default=None)
