...
from ..shared import createresourcepolicyresponse as shared_createresourcepolicyresponse
...
class CreateResourcePolicyRequest:
    headers: CreateResourcePolicyHeaders = dataclasses.field()
    path_params: CreateResourcePolicyPathParams = dataclasses.field()
    request: CreateResourcePolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateResourcePolicyResponse:
    ...
    create_resource_policy_response: Optional[shared_createresourcepolicyresponse.CreateResourcePolicyResponse] = dataclasses.field(default=None)
