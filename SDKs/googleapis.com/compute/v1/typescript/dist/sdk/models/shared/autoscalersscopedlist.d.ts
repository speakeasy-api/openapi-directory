 ...
 */
export declare enum AutoscalersScopedListWarningCodeEnum {
...
export declare class AutoscalersScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class AutoscalersScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class AutoscalersScopedList extends SpeakeasyBase {
    /**
