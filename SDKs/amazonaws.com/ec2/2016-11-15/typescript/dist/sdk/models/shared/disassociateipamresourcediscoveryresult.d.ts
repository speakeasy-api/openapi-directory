 ...
 */
export declare enum DisassociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationResourceDiscoveryStatusEnum {
    Active = "active",
    NotFound = "not-found"
}
/**
 ...
 */
export declare enum DisassociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationStateEnum {
 ...
 * Describes a tag.
 */
export declare class DisassociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class DisassociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociation extends SpeakeasyBase {
    ipamArn?: string;
    ipamId?: string;
    ipamRegion?: string;
 ...
 * Success
 */
export declare class DisassociateIpamResourceDiscoveryResult extends SpeakeasyBase {
