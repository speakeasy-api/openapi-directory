 ...
 */
export class ECSServiceRecommendationOption extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: ContainerRecommendation })
  @Expose({ name: "containerRecommendations" })
  ...
  @SpeakeasyMetadata({ elemType: ECSServiceProjectedUtilizationMetric })
