...
from ..shared import beezup_common_exceptiondetail as shared_beezup_common_exceptiondetail
...
class BeezUpCommonErrorSummary:
    ...
    exception_detail: Optional[shared_beezup_common_exceptiondetail.BeezUpCommonExceptionDetail] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('exceptionDetail') }})
