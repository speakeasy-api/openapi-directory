...
class GetTokensRequest:
    query_params: GetTokensQueryParams = dataclasses.field()
...
class GetTokensResponse:
    ...
    get_tokens_200_application_json_object: Optional[GetTokens200ApplicationJSON] = dataclasses.field(default=None)
