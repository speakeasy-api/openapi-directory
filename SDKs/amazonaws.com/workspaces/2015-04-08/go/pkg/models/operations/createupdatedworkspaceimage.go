...
func (e CreateUpdatedWorkspaceImageXAmzTargetEnum) ToPointer() *CreateUpdatedWorkspaceImageXAmzTargetEnum {
	return &e
}
...
func (e *CreateUpdatedWorkspaceImageXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "WorkspacesService.CreateUpdatedWorkspaceImage":
		*e = CreateUpdatedWorkspaceImageXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateUpdatedWorkspaceImageXAmzTargetEnum: %v", v)
	}
}
