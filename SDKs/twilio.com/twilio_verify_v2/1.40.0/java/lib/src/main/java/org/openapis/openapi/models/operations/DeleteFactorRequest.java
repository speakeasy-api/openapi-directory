...
public class DeleteFactorRequest {
    ...
    public DeleteFactorRequest withIdentity(String identity) {
    ...
    public DeleteFactorRequest withServiceSid(String serviceSid) {
    ...
    public String sid;
    public DeleteFactorRequest withSid(String sid) {
        this.sid = sid;
        return this;
    }
