...
class TestUpdateArtifactRequest
{
     ...
     * * XML Schema (`XSD`)
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\TestUpdateArtifactXRegistryArtifactTypeEnum $xRegistryArtifactType
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Registry-ArtifactType')]
    public ?TestUpdateArtifactXRegistryArtifactTypeEnum $xRegistryArtifactType = null;
