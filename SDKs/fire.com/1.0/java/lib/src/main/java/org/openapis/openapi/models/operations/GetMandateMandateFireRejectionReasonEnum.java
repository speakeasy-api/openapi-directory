...
/**
 * GetMandateMandateFireRejectionReasonEnum - Rejection reason if transaction is rejected
 */
public enum GetMandateMandateFireRejectionReasonEnum {
    ...
    private GetMandateMandateFireRejectionReasonEnum(String value) {
        this.value = value;
    }
}
