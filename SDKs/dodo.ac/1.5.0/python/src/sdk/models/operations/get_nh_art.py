...
from ..shared import nhartwork as shared_nhartwork
from typing import Optional


@dataclasses.dataclass
class GetNhArtRequest:
    ...
    r"""When set to `true`, only artwork names are returned. Instead of an array of objects with all details, the return will be an array of strings."""  
    hasfake: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'hasfake', 'style': 'form', 'explode': True }})
    r"""When set to `true`, only artwork that has a fake will be returned. When set to `false`, only artwork without fakes will be returned."""  
...
class GetNhArtResponse:
    ...
    nh_artworks: Optional[list[shared_nhartwork.NHArtwork]] = dataclasses.field(default=None)
    r"""A JSON array of artwork."""  
