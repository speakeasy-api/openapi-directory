...
exports.GetRestoreTableFromClusterSnapshotResponse = exports.GetRestoreTableFromClusterSnapshotRequest = exports.GetRestoreTableFromClusterSnapshotHeaders = exports.GetRestoreTableFromClusterSnapshotQueryParams = exports.GetRestoreTableFromClusterSnapshotVersionEnum = exports.GetRestoreTableFromClusterSnapshotActionEnum = void 0;
...
var GetRestoreTableFromClusterSnapshotQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=EnableCaseSensitiveIdentifier" }),
        __metadata("design:type", Boolean)
    ], GetRestoreTableFromClusterSnapshotQueryParams.prototype, "enableCaseSensitiveIdentifier", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=NewTableName" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=SourceDatabaseName" }),
        __metadata("design:type", String)
    ], GetRestoreTableFromClusterSnapshotQueryParams.prototype, "sourceDatabaseName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=SourceSchemaName" }),
        __metadata("design:type", String)
    ], GetRestoreTableFromClusterSnapshotQueryParams.prototype, "sourceSchemaName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=SourceTableName" }),
        __metadata("design:type", String)
    ], GetRestoreTableFromClusterSnapshotQueryParams.prototype, "sourceTableName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=TargetDatabaseName" }),
        __metadata("design:type", String)
    ], GetRestoreTableFromClusterSnapshotQueryParams.prototype, "targetDatabaseName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=TargetSchemaName" }),
        __metadata("design:type", String)
...
exports.GetRestoreTableFromClusterSnapshotQueryParams = GetRestoreTableFromClusterSnapshotQueryParams;
...
exports.GetRestoreTableFromClusterSnapshotHeaders = GetRestoreTableFromClusterSnapshotHeaders;
