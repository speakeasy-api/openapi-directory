...
export class PutPlaylistsPlaylistIdPathParams extends SpeakeasyBase {
...
export class PutPlaylistsPlaylistId200ApplicationJson extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=tracks", elemType: PutPlaylistsPlaylistId200ApplicationJsonTracks })
