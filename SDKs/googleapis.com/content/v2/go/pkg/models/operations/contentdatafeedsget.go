...
type ContentDatafeedsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentDatafeedsGetPathParams struct {
...
type ContentDatafeedsGetQueryParams struct {
	// V1 error format.
