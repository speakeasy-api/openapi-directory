...
class CreateDistributionWithTags20170325RequestBodyDistributionConfigWithTags:
...
class CreateDistributionWithTags20170325RequestBody:
    ...
    distribution_config_with_tags: CreateDistributionWithTags20170325RequestBodyDistributionConfigWithTags = dataclasses.field()
    r"""A distribution Configuration and a list of tags to be associated with the distribution."""  
    
class CreateDistributionWithTags20170325WithTagsEnum(str, Enum):
    TRUE = 'true'
...
class CreateDistributionWithTags20170325Request:
    ...
    with_tags: CreateDistributionWithTags20170325WithTagsEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'WithTags', 'style': 'form', 'explode': True }})  
