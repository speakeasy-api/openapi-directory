...
class PostDescribeDbEngineVersionsQueryParams:
    action: PostDescribeDbEngineVersionsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeDbEngineVersionsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeDbEngineVersionsRequest:
    headers: PostDescribeDbEngineVersionsHeaders = dataclasses.field()
    query_params: PostDescribeDbEngineVersionsQueryParams = dataclasses.field()
