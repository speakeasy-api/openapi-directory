...
public class ContainerProjectsZonesClustersMasterPathParams {
    /**
     * Required. Deprecated. The name of the cluster to upgrade. This field has been deprecated and replaced by the name field.
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=clusterId")
    public String clusterId;
    public ContainerProjectsZonesClustersMasterPathParams withClusterId(String clusterId) {
    ...
    public ContainerProjectsZonesClustersMasterPathParams withProjectId(String projectId) {
    ...
    public String zone;
    public ContainerProjectsZonesClustersMasterPathParams withZone(String zone) {
        this.zone = zone;
        return this;
    }
