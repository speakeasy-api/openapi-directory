...
class GetDeploymentGroupRequest:
    headers: GetDeploymentGroupHeaders = dataclasses.field()
    request: shared_getdeploymentgroupinput.GetDeploymentGroupInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
