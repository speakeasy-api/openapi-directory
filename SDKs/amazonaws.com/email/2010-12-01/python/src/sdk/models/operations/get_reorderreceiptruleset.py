...
class GetReorderReceiptRuleSetQueryParams:
    action: GetReorderReceiptRuleSetActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetReorderReceiptRuleSetVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetReorderReceiptRuleSetRequest:
    headers: GetReorderReceiptRuleSetHeaders = dataclasses.field()
    query_params: GetReorderReceiptRuleSetQueryParams = dataclasses.field()
