...
type DatastreamProjectsLocationsFetchStaticIpsSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DatastreamProjectsLocationsFetchStaticIpsPathParams struct {
	// Required. The name resource of the Response type. Must be in the format `projects/*/locations/*`.
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type DatastreamProjectsLocationsFetchStaticIpsQueryParams struct {
	// V1 error format.
...
type DatastreamProjectsLocationsFetchStaticIpsRequest struct {
...
type DatastreamProjectsLocationsFetchStaticIpsResponse struct {
	ContentType string
	// Successful response
