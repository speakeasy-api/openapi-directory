...
//
//	being decompressed.
func (s *Images) CreateCustomImage(ctx context.Context, request operations.CreateCustomImageRequest) (*operations.CreateCustomImageResponse, error) {
...
func (s *Images) DeleteImage(ctx context.Context, request operations.DeleteImageRequest) (*operations.DeleteImageResponse, error) {
	baseURL := s._serverURL
...
func (s *Images) GetImagesList(ctx context.Context, request operations.GetImagesListRequest) (*operations.GetImagesListResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/images"
...
func (s *Images) UpdateImage(ctx context.Context, request operations.UpdateImageRequest) (*operations.UpdateImageResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/images/{image_id}", request.PathParams)
