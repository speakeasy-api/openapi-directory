...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsCheckMembershipForUserRequest req = new OrgsCheckMembershipForUserRequest("facilis", "cum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsCheckPublicMembershipForUserRequest req = new OrgsCheckPublicMembershipForUserRequest("commodi", "in");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsConvertMemberToOutsideCollaboratorRequest req = new OrgsConvertMemberToOutsideCollaboratorRequest("corporis", "reiciendis");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsDeleteWebhookRequest req = new OrgsDeleteWebhookRequest(449083L, "exercitationem");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsGetRequest req = new OrgsGetRequest("earum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsGetMembershipForAuthenticatedUserRequest req = new OrgsGetMembershipForAuthenticatedUserRequest("facere");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsGetMembershipForUserRequest req = new OrgsGetMembershipForUserRequest("numquam", "doloribus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsGetWebhookRequest req = new OrgsGetWebhookRequest(381760L, "reiciendis");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListAppInstallationsRequest req = new OrgsListAppInstallationsRequest("necessitatibus", "dolore") {{
                page = 121059L;
                perPage = 992012L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListForUserRequest req = new OrgsListForUserRequest("amet") {{
                page = 105906L;
                perPage = 489509L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListMembersRequest req = new OrgsListMembersRequest("a") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListOutsideCollaboratorsRequest req = new OrgsListOutsideCollaboratorsRequest("libero") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListPublicMembersRequest req = new OrgsListPublicMembersRequest("tempora") {{
                page = 132815L;
                perPage = 379057L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListWebhooksRequest req = new OrgsListWebhooksRequest("voluptas") {{
                page = 374296L;
                perPage = 324405L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsPingWebhookRequest req = new OrgsPingWebhookRequest(748789L, "dolorum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsRemoveMemberRequest req = new OrgsRemoveMemberRequest("adipisci", "minus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsRemoveMembershipForUserRequest req = new OrgsRemoveMembershipForUserRequest("dolores", "blanditiis");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsRemoveOutsideCollaboratorRequest req = new OrgsRemoveOutsideCollaboratorRequest("in", "dolore");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsRemovePublicMembershipForAuthenticatedUserRequest req = new OrgsRemovePublicMembershipForAuthenticatedUserRequest("aliquam", "officiis");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsSetMembershipForUserRequest req = new OrgsSetMembershipForUserRequest("temporibus", "ullam") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsSetPublicMembershipForAuthenticatedUserRequest req = new OrgsSetPublicMembershipForAuthenticatedUserRequest("cum", "blanditiis");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsUpdateRequest req = new OrgsUpdateRequest("quas") {{
                requestBody = new OrgsUpdateRequestBody() {{
                    billingEmail = "hic";
                    blog = ""http://github.blog"";
                    company = "Nader LLC";
                    defaultRepositoryPermission = OrgsUpdateRequestBodyDefaultRepositoryPermissionEnum.NONE;
                    description = "totam";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsUpdateMembershipForAuthenticatedUserRequest req = new OrgsUpdateMembershipForAuthenticatedUserRequest(                new OrgsUpdateMembershipForAuthenticatedUserRequestBody(OrgsUpdateMembershipForAuthenticatedUserRequestBodyStateEnum.ACTIVE);, "iste");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsUpdateWebhookRequest req = new OrgsUpdateWebhookRequest(292794L, "laborum") {{
