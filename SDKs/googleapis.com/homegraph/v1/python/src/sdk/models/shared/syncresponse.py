...
class SyncResponse:
    ...
    payload: Optional[shared_syncresponsepayload.SyncResponsePayload] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('payload') }})
