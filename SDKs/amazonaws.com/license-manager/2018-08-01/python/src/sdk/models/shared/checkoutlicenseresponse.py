...
class CheckoutLicenseResponse:
    ...
    checkout_type: Optional[shared_checkouttype_enum.CheckoutTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CheckoutType'), 'exclude': lambda f: f is None }})  
