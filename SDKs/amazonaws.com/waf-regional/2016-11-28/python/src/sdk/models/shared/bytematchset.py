...
class ByteMatchSet:
    ...
    byte_match_tuples: list[shared_bytematchtuple.ByteMatchTuple] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ByteMatchTuples') }})  
