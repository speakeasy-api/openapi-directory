...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/pan/3.0.0/python
```
...
req = operations.PancrRequestBody(
    certificate_parameters=operations.PancrRequestBodyCertificateParameters(
        ...
        gender="M",
        pan_full_name="RAMESHWAR KUMAR SINGH",
        uid="123412341234",
        panno="ABCD123EF",
    ),
...
res = s.ap_is.pancr(req, operations.PancrSecurity(
