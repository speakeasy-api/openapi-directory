...
class ListDNSAuthorizationsResponse:
    ...
    dns_authorizations: Optional[list[shared_dnsauthorization.DNSAuthorization]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dnsAuthorizations'), 'exclude': lambda f: f is None }})
    r"""A list of dns authorizations for the parent resource."""  
