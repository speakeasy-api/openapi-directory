...
class YoutubeLiveBroadcastsTransitionBroadcastStatusEnum(str, Enum):
    r"""The status to which the broadcast is going to transition."""
...
class YoutubeLiveBroadcastsTransitionRequest:
    ...
    r"""Broadcast to transition."""  
    part: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'part', 'style': 'form', 'explode': True }})
    r"""The *part* parameter specifies a comma-separated list of one or more liveBroadcast resource properties that the API response will include. The part names that you can include in the parameter value are id, snippet, contentDetails, and status."""  
