...
from ..shared import updatecommentresponse as shared_updatecommentresponse
from typing import Optional


@dataclasses.dataclass
class CollectionTicketCommentsUpdateSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class CollectionTicketCommentsUpdateRequest:
...
class CollectionTicketCommentsUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_comment_response: Optional[shared_updatecommentresponse.UpdateCommentResponse] = dataclasses.field(default=None)
    r"""Update a Comment"""  
