...
class APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFreeCapabilities:
    r"""APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFreeCapabilities
...
class APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFree:
    ...
    capabilities: Optional[APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFreeCapabilities] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('capabilities') }})
