...
class NumbersV2RegulatoryComplianceSupportingDocument:
    ...
    status: Optional[shared_supporting_document_enum_status_enum.SupportingDocumentEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
