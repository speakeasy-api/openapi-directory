 ...
 */
export enum MetalsSpotHistoryGETFormatEnum {
  Json = "json",
  Xml = "xml",
}
 ...
 * dwt=pennyweight
 */
export enum MetalsSpotHistoryGETUnitofmeasureEnum {
  Mg = "mg",
  G = "g",
  Kg = "kg",
  Gr = "gr",
...
export class MetalsSpotHistoryGETRequest extends SpeakeasyBase {
  /**
  ...
  format?: MetalsSpotHistoryGETFormatEnum;
  ...
  unitofmeasure?: MetalsSpotHistoryGETUnitofmeasureEnum;
}

export class MetalsSpotHistoryGETResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
