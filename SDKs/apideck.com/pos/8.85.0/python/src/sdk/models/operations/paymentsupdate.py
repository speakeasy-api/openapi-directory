...
from ..shared import pospayment as shared_pospayment
...
from ..shared import updatepospaymentresponse as shared_updatepospaymentresponse
...
class PaymentsUpdateRequest:
    headers: PaymentsUpdateHeaders = dataclasses.field()
    path_params: PaymentsUpdatePathParams = dataclasses.field()
    query_params: PaymentsUpdateQueryParams = dataclasses.field()
    request: shared_pospayment.PosPaymentInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: PaymentsUpdateSecurity = dataclasses.field()
...
class PaymentsUpdateResponse:
    ...
    update_pos_payment_response: Optional[shared_updatepospaymentresponse.UpdatePosPaymentResponse] = dataclasses.field(default=None)
