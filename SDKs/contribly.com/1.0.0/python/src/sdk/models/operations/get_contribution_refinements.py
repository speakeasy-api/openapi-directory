...
class GetContributionRefinementsRequest:
    ...
    refinements: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'refinements', 'style': 'form', 'explode': True }})
    r"""Comma seperated list of refinement names."""  
    refinement_size: Optional[float] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'refinementSize', 'style': 'form', 'explode': True }})
    r"""Number of refinement options to return."""  
...
@dataclasses.dataclass
class GetContributionRefinementsResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    get_contribution_refinements_200_application_json_object: Optional[dict[str, list[str]]] = dataclasses.field(default=None)
    r"""A map of refinement names to lists of options"""  
