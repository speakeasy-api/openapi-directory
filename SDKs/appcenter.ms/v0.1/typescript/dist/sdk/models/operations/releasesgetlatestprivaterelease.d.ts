...
export declare class ReleasesGetLatestPrivateReleaseSecurity extends SpeakeasyBase {
    apiToken: string;
}
export declare class ReleasesGetLatestPrivateReleaseRequest extends SpeakeasyBase {
    /**
...
export declare enum ReleasesGetLatestPrivateRelease404ApplicationJSONCodeEnum {
 ...
 *
 */
export declare class ReleasesGetLatestPrivateRelease404ApplicationJSON extends SpeakeasyBase {
    code: ReleasesGetLatestPrivateRelease404ApplicationJSONCodeEnum;
    message: string;
}
/**
 * Contains metadata about the build that produced the release being uploaded
 */
export declare class ReleasesGetLatestPrivateRelease200ApplicationJSONBuild extends SpeakeasyBase {
    /**
 ...
 *
 */
export declare enum ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationTypeEnum {
    Group = "group",
    Store = "store",
    Tester = "tester"
}
 ...
 */
export declare enum ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationsDestinationTypeEnum {
    Group = "group",
    Store = "store",
    Tester = "tester"
}
 ...
 */
export declare enum ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationsTypeEnum {
    Intune = "intune",
 ...
 */
export declare class ReleasesGetLatestPrivateRelease200ApplicationJSONDestinations extends SpeakeasyBase {
    /**
     * Destination can be either store or group.
     */
    destinationType?: ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationsDestinationTypeEnum;
    /**
     ...
     * type of the distribution store currently stores type can be intune, googleplay or windows.
     */
    type?: ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationsTypeEnum;
}
export declare class ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionGroups extends SpeakeasyBase {
    /**
 ...
 * type of the distribution store currently stores type can be intune, googleplay or windows.
 */
export declare enum ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionStoresTypeEnum {
    Intune = "intune",
    Googleplay = "googleplay",
    Apple = "apple",
    None = "none"
}
export declare class ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionStores extends SpeakeasyBase {
    /**
     * ID identifying a unique distribution store.
     */
    id: string;
     ...
     * type of the distribution store currently stores type can be intune, googleplay or windows.
     */
    type?: ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionStoresTypeEnum;
}
/**
 * The release's origin
 */
export declare enum ReleasesGetLatestPrivateRelease200ApplicationJSONOriginEnum {
    Hockeyapp = "hockeyapp",
    Appcenter = "appcenter"
}
/**
 ...
 */
export declare enum ReleasesGetLatestPrivateRelease200ApplicationJSONProvisioningProfileTypeEnum {
    Adhoc = "adhoc",
 ...
 */
export declare class ReleasesGetLatestPrivateRelease200ApplicationJSON extends SpeakeasyBase {
    /**
     ...
     * Contains metadata about the build that produced the release being uploaded
     */
    build?: ReleasesGetLatestPrivateRelease200ApplicationJSONBuild;
    /**
     ...
     *
     */
    destinationType?: ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationTypeEnum;
    /**
     * A list of distribution groups or stores.
     */
    destinations?: ReleasesGetLatestPrivateRelease200ApplicationJSONDestinations[];
    /**
     ...
     */
    distributionGroups?: ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionGroups[];
    /**
     * OBSOLETE. Will be removed in next version. A list of distribution stores that are associated with this release.
     */
    distributionStores?: ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionStores[];
    /**
     ...
     * The release's origin
     */
    origin?: ReleasesGetLatestPrivateRelease200ApplicationJSONOriginEnum;
    /**
     ...
     * The type of the provisioning profile for the requested app version.
     */
    provisioningProfileType?: ReleasesGetLatestPrivateRelease200ApplicationJSONProvisioningProfileTypeEnum;
    /**
...
export declare class ReleasesGetLatestPrivateReleaseResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
