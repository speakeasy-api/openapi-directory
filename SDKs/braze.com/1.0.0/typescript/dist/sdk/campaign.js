...
var Campaign = /** @class */ (function () {
    ...
    **/
    Campaign.prototype.campaignAnalytics = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CampaignAnalyticsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/campaigns/data_series";
     ...
     * ```
    **/
    Campaign.prototype.campaignDetails = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CampaignDetailsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/campaigns/details";
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     * ```
    **/
    Campaign.prototype.campaignList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CampaignListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/campaigns/list";
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     * ```
    **/
    Campaign.prototype.sendAnalytics = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SendAnalyticsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/sends/data_series";
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
