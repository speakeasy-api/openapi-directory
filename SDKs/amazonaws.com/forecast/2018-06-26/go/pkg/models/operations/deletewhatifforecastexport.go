...
func (e DeleteWhatIfForecastExportXAmzTargetEnum) ToPointer() *DeleteWhatIfForecastExportXAmzTargetEnum {
	return &e
}
...
func (e *DeleteWhatIfForecastExportXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonForecast.DeleteWhatIfForecastExport":
		*e = DeleteWhatIfForecastExportXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DeleteWhatIfForecastExportXAmzTargetEnum: %v", v)
	}
}
