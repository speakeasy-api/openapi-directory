...
class EmployeePayrollsOneRequest:
    headers: EmployeePayrollsOneHeaders = dataclasses.field()
    path_params: EmployeePayrollsOnePathParams = dataclasses.field()
    query_params: EmployeePayrollsOneQueryParams = dataclasses.field()
    security: EmployeePayrollsOneSecurity = dataclasses.field()
