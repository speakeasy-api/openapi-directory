...
public class OneCreateanewtransactionHeaders {
    /**
    ...
    public OneCreateanewtransactionHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public OneCreateanewtransactionHeaders withContentType(String contentType) {
    ...
    public OneCreateanewtransactionHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public OneCreateanewtransactionHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
