...
class GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest:
    ...
    features: Optional[list[GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestFeaturesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('features'), 'exclude': lambda f: f is None }})
    ...
    video_context: Optional[shared_googlecloudvideointelligencev1p1beta1_videocontext.GoogleCloudVideointelligenceV1p1beta1VideoContext] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('videoContext'), 'exclude': lambda f: f is None }})
