...
@dataclasses.dataclass
class DeploymentmanagerDeploymentsUpdateQueryParams:
...
class DeploymentmanagerDeploymentsUpdateRequest:
    path_params: DeploymentmanagerDeploymentsUpdatePathParams = dataclasses.field()
    query_params: DeploymentmanagerDeploymentsUpdateQueryParams = dataclasses.field()
    security: DeploymentmanagerDeploymentsUpdateSecurity = dataclasses.field()
