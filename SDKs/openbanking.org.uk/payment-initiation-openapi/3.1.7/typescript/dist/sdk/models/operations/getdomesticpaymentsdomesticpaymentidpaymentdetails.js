...
exports.GetDomesticPaymentsDomesticPaymentIdPaymentDetailsResponse = exports.GetDomesticPaymentsDomesticPaymentIdPaymentDetailsRequest = exports.GetDomesticPaymentsDomesticPaymentIdPaymentDetailsSecurity = void 0;
...
exports.GetDomesticPaymentsDomesticPaymentIdPaymentDetailsSecurity = GetDomesticPaymentsDomesticPaymentIdPaymentDetailsSecurity;
var GetDomesticPaymentsDomesticPaymentIdPaymentDetailsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetDomesticPaymentsDomesticPaymentIdPaymentDetailsRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=DomesticPaymentId",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentsDomesticPaymentIdPaymentDetailsRequest.prototype, "domesticPaymentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentsDomesticPaymentIdPaymentDetailsRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentsDomesticPaymentIdPaymentDetailsRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentsDomesticPaymentIdPaymentDetailsRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentsDomesticPaymentIdPaymentDetailsRequest.prototype, "xFapiInteractionId", void 0);
    return GetDomesticPaymentsDomesticPaymentIdPaymentDetailsRequest;
}(utils_1.SpeakeasyBase));
exports.GetDomesticPaymentsDomesticPaymentIdPaymentDetailsRequest = GetDomesticPaymentsDomesticPaymentIdPaymentDetailsRequest;
var GetDomesticPaymentsDomesticPaymentIdPaymentDetailsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetDomesticPaymentsDomesticPaymentIdPaymentDetailsResponse.prototype, "rawResponse", void 0);
    return GetDomesticPaymentsDomesticPaymentIdPaymentDetailsResponse;
}(utils_1.SpeakeasyBase));
exports.GetDomesticPaymentsDomesticPaymentIdPaymentDetailsResponse = GetDomesticPaymentsDomesticPaymentIdPaymentDetailsResponse;
