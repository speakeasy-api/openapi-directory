...
var ContractDiscountInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "amountCodePromoDiscount" }),
        __metadata("design:type", Number)
    ], ContractDiscountInfo.prototype, "amountCodePromoDiscount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "amountCodePromoDiscountPerMonth" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "couponDiscountId" }),
        __metadata("design:type", Number)
    ], ContractDiscountInfo.prototype, "couponDiscountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "customerHasActualDiscount" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "isCouponDiscountLinkedToCouponOffer" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "promotionalCodeValidity" }),
        __metadata("design:type", String)
