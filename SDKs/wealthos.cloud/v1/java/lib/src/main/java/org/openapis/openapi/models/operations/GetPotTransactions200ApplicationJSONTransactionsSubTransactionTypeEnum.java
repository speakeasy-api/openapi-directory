 ...
 */
public enum GetPotTransactions200ApplicationJSONTransactionsSubTransactionTypeEnum {
    ...
    private GetPotTransactions200ApplicationJSONTransactionsSubTransactionTypeEnum(String value) {
        this.value = value;
    }
}
