...
var PaymentMethod = /** @class */ (function () {
    function PaymentMethod(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    PaymentMethod.prototype.getPaymentMethod = function (req, config) {
    ...
    **/
    PaymentMethod.prototype.listPaymentMethods = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PaymentMethod.prototype.updatePaymentMethod = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
