...
SERVERS = [
    ...
    r"""The Amazon FSx multi-region endpoint"""
    "https://fsx.{region}.amazonaws.com",
    r"""The Amazon FSx multi-region endpoint"""
    "http://fsx.{region}.amazonaws.com.cn",
    r"""The Amazon FSx endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    r"""Amazon FSx is a fully managed service that makes it easy for storage and application administrators to launch and use shared file storage.
    ...
    def associate_file_system_aliases(self, request: operations.AssociateFileSystemAliasesRequest) -> operations.AssociateFileSystemAliasesResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "associate_file_system_aliases_request", 'json')
        ...
        res = operations.AssociateFileSystemAliasesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AssociateFileSystemAliasesResponse])
    ...
    def cancel_data_repository_task(self, request: operations.CancelDataRepositoryTaskRequest) -> operations.CancelDataRepositoryTaskResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "cancel_data_repository_task_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CancelDataRepositoryTaskResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CancelDataRepositoryTaskResponse])
    ...
    def copy_backup(self, request: operations.CopyBackupRequest) -> operations.CopyBackupResponse:
        ...
        res = operations.CopyBackupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CopyBackupResponse])
    ...
    def create_backup(self, request: operations.CreateBackupRequest) -> operations.CreateBackupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_backup_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateBackupResponse])
    ...
    def create_data_repository_association(self, request: operations.CreateDataRepositoryAssociationRequest) -> operations.CreateDataRepositoryAssociationResponse:
        ...
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateDataRepositoryAssociation'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_data_repository_association_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateDataRepositoryAssociationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateDataRepositoryAssociationResponse])
                res.create_data_repository_association_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.bad_request = out
    ...
    def create_data_repository_task(self, request: operations.CreateDataRepositoryTaskRequest) -> operations.CreateDataRepositoryTaskResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_data_repository_task_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateDataRepositoryTaskResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateDataRepositoryTaskResponse])
    ...
    def create_file_cache(self, request: operations.CreateFileCacheRequest) -> operations.CreateFileCacheResponse:
        ...
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateFileCache'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_file_cache_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateFileCacheResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateFileCacheResponse])
                res.create_file_cache_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.bad_request = out
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.missing_file_cache_configuration = out
    ...
    def create_file_system(self, request: operations.CreateFileSystemRequest) -> operations.CreateFileSystemResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_file_system_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateFileSystemResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateFileSystemResponse])
    ...
    def create_file_system_from_backup(self, request: operations.CreateFileSystemFromBackupRequest) -> operations.CreateFileSystemFromBackupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_file_system_from_backup_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateFileSystemFromBackupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateFileSystemFromBackupResponse])
    ...
    def create_snapshot(self, request: operations.CreateSnapshotRequest) -> operations.CreateSnapshotResponse:
        ...
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateSnapshot'
    ...
    def create_storage_virtual_machine(self, request: operations.CreateStorageVirtualMachineRequest) -> operations.CreateStorageVirtualMachineResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_storage_virtual_machine_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateStorageVirtualMachineResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateStorageVirtualMachineResponse])
    ...
    def create_volume(self, request: operations.CreateVolumeRequest) -> operations.CreateVolumeResponse:
        r"""Creates an FSx for ONTAP or Amazon FSx for OpenZFS storage volume."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateVolume'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_volume_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateVolumeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateVolumeResponse])
    ...
    def create_volume_from_backup(self, request: operations.CreateVolumeFromBackupRequest) -> operations.CreateVolumeFromBackupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_volume_from_backup_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateVolumeFromBackupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateVolumeFromBackupResponse])
    ...
    def delete_data_repository_association(self, request: operations.DeleteDataRepositoryAssociationRequest) -> operations.DeleteDataRepositoryAssociationResponse:
        r"""Deletes a data repository association on an Amazon FSx for Lustre file system. Deleting the data repository association unlinks the file system from the Amazon S3 bucket. When deleting a data repository association, you have the option of deleting the data in the file system that corresponds to the data repository association. Data repository associations are supported only for file systems with the <code>Persistent_2</code> deployment type."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DeleteDataRepositoryAssociation'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_data_repository_association_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteDataRepositoryAssociationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteDataRepositoryAssociationResponse])
                res.delete_data_repository_association_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.bad_request = out
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.data_repository_association_not_found = out
        elif http_res.status_code == 483:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.service_limit_exceeded = out
    ...
    def delete_file_cache(self, request: operations.DeleteFileCacheRequest) -> operations.DeleteFileCacheResponse:
        ...
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DeleteFileCache'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_file_cache_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteFileCacheResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteFileCacheResponse])
                res.delete_file_cache_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.bad_request = out
    ...
    def delete_file_system(self, request: operations.DeleteFileSystemRequest) -> operations.DeleteFileSystemResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_file_system_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteFileSystemResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteFileSystemResponse])
    ...
    def delete_snapshot(self, request: operations.DeleteSnapshotRequest) -> operations.DeleteSnapshotResponse:
        r"""<p>Deletes an Amazon FSx for OpenZFS snapshot. After deletion, the snapshot no longer exists, and its data is gone. Deleting a snapshot doesn't affect snapshots stored in a file system backup. </p> <p>The <code>DeleteSnapshot</code> operation returns instantly. The snapshot appears with the lifecycle status of <code>DELETING</code> until the deletion is complete.</p>"""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DeleteSnapshot'
    ...
    def delete_storage_virtual_machine(self, request: operations.DeleteStorageVirtualMachineRequest) -> operations.DeleteStorageVirtualMachineResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_storage_virtual_machine_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteStorageVirtualMachineResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteStorageVirtualMachineResponse])
    ...
    def delete_volume(self, request: operations.DeleteVolumeRequest) -> operations.DeleteVolumeResponse:
        r"""Deletes an Amazon FSx for NetApp ONTAP or Amazon FSx for OpenZFS volume."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DeleteVolume'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_volume_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteVolumeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteVolumeResponse])
    ...
    def describe_data_repository_associations(self, request: operations.DescribeDataRepositoryAssociationsRequest) -> operations.DescribeDataRepositoryAssociationsResponse:
        ...
        res = operations.DescribeDataRepositoryAssociationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeDataRepositoryAssociationsResponse])
                res.describe_data_repository_associations_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.bad_request = out
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.invalid_data_repository_type = out
        elif http_res.status_code == 484:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.internal_server_error = out
    ...
    def describe_data_repository_tasks(self, request: operations.DescribeDataRepositoryTasksRequest) -> operations.DescribeDataRepositoryTasksResponse:
        ...
        res = operations.DescribeDataRepositoryTasksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeDataRepositoryTasksResponse])
    ...
    def describe_file_caches(self, request: operations.DescribeFileCachesRequest) -> operations.DescribeFileCachesResponse:
        ...
        res = operations.DescribeFileCachesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeFileCachesResponse])
                res.describe_file_caches_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.bad_request = out
    ...
    def describe_file_system_aliases(self, request: operations.DescribeFileSystemAliasesRequest) -> operations.DescribeFileSystemAliasesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_file_system_aliases_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeFileSystemAliasesRequest, request)
        ...
        res = operations.DescribeFileSystemAliasesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeFileSystemAliasesResponse])
    ...
    def describe_file_systems(self, request: operations.DescribeFileSystemsRequest) -> operations.DescribeFileSystemsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_file_systems_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeFileSystemsRequest, request)
        ...
        res = operations.DescribeFileSystemsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeFileSystemsResponse])
    ...
    def describe_storage_virtual_machines(self, request: operations.DescribeStorageVirtualMachinesRequest) -> operations.DescribeStorageVirtualMachinesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_storage_virtual_machines_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeStorageVirtualMachinesRequest, request)
        ...
        res = operations.DescribeStorageVirtualMachinesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeStorageVirtualMachinesResponse])
    ...
    def describe_volumes(self, request: operations.DescribeVolumesRequest) -> operations.DescribeVolumesResponse:
        r"""Describes one or more Amazon FSx for NetApp ONTAP or Amazon FSx for OpenZFS volumes."""
        base_url = self._server_url
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeVolumesRequest, request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeVolumesResponse])
    ...
    def disassociate_file_system_aliases(self, request: operations.DisassociateFileSystemAliasesRequest) -> operations.DisassociateFileSystemAliasesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "disassociate_file_system_aliases_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DisassociateFileSystemAliasesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DisassociateFileSystemAliasesResponse])
    ...
    def release_file_system_nfs_v3_locks(self, request: operations.ReleaseFileSystemNfsV3LocksRequest) -> operations.ReleaseFileSystemNfsV3LocksResponse:
        r"""Releases the file system lock from an Amazon FSx for OpenZFS file system."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.ReleaseFileSystemNfsV3Locks'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "release_file_system_nfs_v3_locks_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ReleaseFileSystemNfsV3LocksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ReleaseFileSystemNfsV3LocksResponse])
                res.release_file_system_nfs_v3_locks_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.bad_request = out
    ...
    def restore_volume_from_snapshot(self, request: operations.RestoreVolumeFromSnapshotRequest) -> operations.RestoreVolumeFromSnapshotResponse:
        r"""Returns an Amazon FSx for OpenZFS volume to the state saved by the specified snapshot."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.RestoreVolumeFromSnapshot'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "restore_volume_from_snapshot_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RestoreVolumeFromSnapshotResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.RestoreVolumeFromSnapshotResponse])
                res.restore_volume_from_snapshot_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.bad_request = out
    ...
    def update_data_repository_association(self, request: operations.UpdateDataRepositoryAssociationRequest) -> operations.UpdateDataRepositoryAssociationResponse:
        r"""Updates the configuration of an existing data repository association on an Amazon FSx for Lustre file system. Data repository associations are supported only for file systems with the <code>Persistent_2</code> deployment type."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.UpdateDataRepositoryAssociation'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_data_repository_association_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateDataRepositoryAssociationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateDataRepositoryAssociationResponse])
                res.update_data_repository_association_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.bad_request = out
    ...
    def update_file_cache(self, request: operations.UpdateFileCacheRequest) -> operations.UpdateFileCacheResponse:
        r"""Updates the configuration of an existing Amazon File Cache resource. You can update multiple properties in a single request."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.UpdateFileCache'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_file_cache_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateFileCacheResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateFileCacheResponse])
                res.update_file_cache_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.bad_request = out
    ...
    def update_file_system(self, request: operations.UpdateFileSystemRequest) -> operations.UpdateFileSystemResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_file_system_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateFileSystemResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateFileSystemResponse])
    ...
    def update_snapshot(self, request: operations.UpdateSnapshotRequest) -> operations.UpdateSnapshotResponse:
        r"""Updates the name of an Amazon FSx for OpenZFS snapshot."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.UpdateSnapshot'
    ...
    def update_storage_virtual_machine(self, request: operations.UpdateStorageVirtualMachineRequest) -> operations.UpdateStorageVirtualMachineResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_storage_virtual_machine_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateStorageVirtualMachineResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateStorageVirtualMachineResponse])
    ...
    def update_volume(self, request: operations.UpdateVolumeRequest) -> operations.UpdateVolumeResponse:
        r"""Updates the configuration of an Amazon FSx for NetApp ONTAP or Amazon FSx for OpenZFS volume."""
        base_url = self._server_url
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateVolumeResponse])
