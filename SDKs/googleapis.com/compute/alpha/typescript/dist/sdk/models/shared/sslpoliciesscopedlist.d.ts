 ...
 */
export declare enum SslPoliciesScopedListWarningCodeEnum {
...
export declare class SslPoliciesScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class SslPoliciesScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class SslPoliciesScopedList extends SpeakeasyBase {
    /**
