...
class GetGenotypeModelAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGenotypeModelAssociationsQueryParams:
...
class GetGenotypeModelAssociationsRequest:
    path_params: GetGenotypeModelAssociationsPathParams = dataclasses.field()
    query_params: GetGenotypeModelAssociationsQueryParams = dataclasses.field()
