...
class DeleteRemediationConfigurationRequest:
    ...
    delete_remediation_configuration_request: shared_deleteremediationconfigurationrequest.DeleteRemediationConfigurationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DeleteRemediationConfigurationResponse:
    ...
    r"""RemediationInProgressException"""  
