...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.getEntitlements = function (req, config) {
        ...
        try {
            _a = utils.serializeRequestBody(req, "getEntitlementsRequest", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getEntitlementsResult = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetEntitlementsResult);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 480:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.invalidParameterException = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.InvalidParameterException);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 481:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.throttlingException = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ThrottlingException);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 482:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.internalServiceErrorException = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.InternalServiceErrorException);
                    }
                    break;
            }
            return res;
