...
export class Facets {
   ...
   */
  facetscategory(
    req: operations.FacetscategoryRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.FacetscategoryResponse> {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.FacetscategoryResponse =
        new operations.FacetscategoryResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.facetscategory200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Facetscategory200ApplicationJSON
            );
          }
          break;
      }
  ...
  getApiCatalogSystemPubFacetsCategoryCategoryId(
    req: operations.GetApiCatalogSystemPubFacetsCategoryCategoryIdRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetApiCatalogSystemPubFacetsCategoryCategoryIdResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetApiCatalogSystemPubFacetsCategoryCategoryIdRequest(
          req
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetApiCatalogSystemPubFacetsCategoryCategoryIdResponse =
        new operations.GetApiCatalogSystemPubFacetsCategoryCategoryIdResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            ...
            res.getApiCatalogSystemPubFacetsCategoryCategoryId200ApplicationJSONObjects =
              utils.objectToClass(
                httpRes?.data,
                operations.GetApiCatalogSystemPubFacetsCategoryCategoryId200ApplicationJSON,
                resFieldDepth
              );
          }
          break;
