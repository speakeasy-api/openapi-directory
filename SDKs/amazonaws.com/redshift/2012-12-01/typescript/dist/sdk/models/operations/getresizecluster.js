...
exports.GetResizeClusterResponse = exports.GetResizeClusterRequest = exports.GetResizeClusterHeaders = exports.GetResizeClusterQueryParams = exports.GetResizeClusterVersionEnum = exports.GetResizeClusterActionEnum = void 0;
...
var GetResizeClusterQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Classic" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ClusterType" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=NumberOfNodes" }),
...
exports.GetResizeClusterQueryParams = GetResizeClusterQueryParams;
...
exports.GetResizeClusterHeaders = GetResizeClusterHeaders;
