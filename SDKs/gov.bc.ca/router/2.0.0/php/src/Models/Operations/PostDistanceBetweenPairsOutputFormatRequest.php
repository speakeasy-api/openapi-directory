...
class PostDistanceBetweenPairsOutputFormatRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostDistanceBetweenPairsOutputFormatCriteriaEnum $criteria
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=criteria')]
    public ?PostDistanceBetweenPairsOutputFormatCriteriaEnum $criteria = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostDistanceBetweenPairsOutputFormatDistanceUnitEnum $distanceUnit
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=distanceUnit')]
    public ?PostDistanceBetweenPairsOutputFormatDistanceUnitEnum $distanceUnit = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\PostDistanceBetweenPairsOutputFormatOutputFormatEnum $outputFormat
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostDistanceBetweenPairsOutputFormatOutputSrsEnum $outputSRS
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=outputSRS')]
    public ?PostDistanceBetweenPairsOutputFormatOutputSrsEnum $outputSRS = null;
	...
	public function __construct()
	{
		...
		$this->fromPoints = "";
		$this->maxPairs = null;
		$this->outputFormat = \OpenAPI\OpenAPI\Models\Operations\PostDistanceBetweenPairsOutputFormatOutputFormatEnum::JSON;
		$this->outputSRS = null;
