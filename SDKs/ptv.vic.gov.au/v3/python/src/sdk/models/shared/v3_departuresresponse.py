...
class V3DeparturesResponse:
    ...
    departures: Optional[list[shared_v3_departure.V3Departure]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('departures'), 'exclude': lambda f: f is None }})
    ...
    stops: Optional[dict[str, shared_v3_stopmodel.V3StopModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('stops'), 'exclude': lambda f: f is None }})
