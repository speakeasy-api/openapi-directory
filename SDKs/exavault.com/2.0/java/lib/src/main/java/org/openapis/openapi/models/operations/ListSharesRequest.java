...
public class ListSharesRequest {
    ...
    public ListSharesRequest withEvAccessToken(String evAccessToken) {
    ...
    public ListSharesRequest withEvApiKey(String evApiKey) {
    ...
    public ListSharesRequest withInclude(String include) {
    ...
    public ListSharesRequest withMessage(String message) {
    ...
    public String name;
    public ListSharesRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListSharesRequest withRecipient(String recipient) {
    ...
    public ListSharesRequest withScope(ListSharesScopeEnum scope) {
        this.scope = scope;
        return this;
    }
    ...
    public ListSharesRequest withSearch(String search) {
        this.search = search;
        return this;
    }
    ...
    public ListSharesRequest withSort(ListSharesSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public ListSharesRequest withType(ListSharesTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public ListSharesRequest withUsername(String username) {
