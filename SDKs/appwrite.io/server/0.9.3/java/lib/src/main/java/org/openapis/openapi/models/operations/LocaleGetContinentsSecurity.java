...
public class LocaleGetContinentsSecurity {
    ...
    public LocaleGetContinentsSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public LocaleGetContinentsSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public LocaleGetContinentsSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public LocaleGetContinentsSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
