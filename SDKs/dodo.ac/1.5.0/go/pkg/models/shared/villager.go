...
func (e *VillagerAppearancesEnum) UnmarshalJSON(data []byte) error {
	...
	case "HHD":
		fallthrough
	case "PC":
		*e = VillagerAppearancesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for VillagerAppearancesEnum: %s", s)
	}
}
...
func (e *VillagerDebutEnum) UnmarshalJSON(data []byte) error {
	...
	case "HHD":
		fallthrough
	case "PC":
		*e = VillagerDebutEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for VillagerDebutEnum: %s", s)
	}
}
...
func (e *VillagerGenderEnum) UnmarshalJSON(data []byte) error {
	...
	case "Male":
		fallthrough
	case "Female":
		*e = VillagerGenderEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for VillagerGenderEnum: %s", s)
	}
}
...
func (e *VillagerNhDetailsHobbyEnum) UnmarshalJSON(data []byte) error {
	...
	case "Nature":
		fallthrough
	case "Play":
		*e = VillagerNhDetailsHobbyEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for VillagerNhDetailsHobbyEnum: %s", s)
	}
}
...
func (e *VillagerNhDetailsSubPersonalityEnum) UnmarshalJSON(data []byte) error {
	...
	case "A":
		fallthrough
	case "B":
		*e = VillagerNhDetailsSubPersonalityEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for VillagerNhDetailsSubPersonalityEnum: %s", s)
	}
}
...
const (
	...
	VillagerPersonalityEnumSisterly VillagerPersonalityEnum = "Sisterly"
...
func (e *VillagerPersonalityEnum) UnmarshalJSON(data []byte) error {
	...
	case "Smug":
		fallthrough
	case "Snooty":
		*e = VillagerPersonalityEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for VillagerPersonalityEnum: %s", s)
	}
}
...
func (e *VillagerSignEnum) UnmarshalJSON(data []byte) error {
	...
	case "Aquarius":
		fallthrough
	case "Pisces":
		*e = VillagerSignEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for VillagerSignEnum: %s", s)
	}
}
...
const (
	...
	VillagerSpeciesEnumCub       VillagerSpeciesEnum = "Cub"
	...
	VillagerSpeciesEnumRhino     VillagerSpeciesEnum = "Rhino"
...
func (e *VillagerSpeciesEnum) UnmarshalJSON(data []byte) error {
	...
	case "Tiger":
		fallthrough
	case "Wolf":
		*e = VillagerSpeciesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for VillagerSpeciesEnum: %s", s)
	}
}
