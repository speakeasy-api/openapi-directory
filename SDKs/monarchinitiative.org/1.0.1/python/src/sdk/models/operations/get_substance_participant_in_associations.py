...
class GetSubstanceParticipantInAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetSubstanceParticipantInAssociationsQueryParams:
...
@dataclasses.dataclass
class GetSubstanceParticipantInAssociationsRequest:
    path_params: GetSubstanceParticipantInAssociationsPathParams = dataclasses.field()
    query_params: GetSubstanceParticipantInAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetSubstanceParticipantInAssociationsResponse:
