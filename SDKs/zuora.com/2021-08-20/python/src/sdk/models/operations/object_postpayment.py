...
from ..shared import proxycreatepayment as shared_proxycreatepayment
...
class ObjectPOSTPaymentRequest:
    ...
    proxy_create_payment: shared_proxycreatepayment.ProxyCreatePayment = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
