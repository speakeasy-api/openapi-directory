...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.shared.CloseAccountRequest req = new CloseAccountRequest("voluptates");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.shared.CreateAccountRequest req = new CreateAccountRequest("delectus") {{
                bankAccountUUID = "qui";
                description = "delectus";
                metadata = new java.util.HashMap<String, String>() {{
                    put("ipsum", "laboriosam");
                    put("doloremque", "sed");
                }};
                payoutMethodCode = "voluptatum";
                payoutSchedule = CreateAccountRequestPayoutScheduleEnum.WEEKLY_SUN_TO_THU_AU;
                payoutScheduleReason = "a";
                payoutSpeed = CreateAccountRequestPayoutSpeedEnum.STANDARD;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.shared.UpdateAccountRequest req = new UpdateAccountRequest("eveniet") {{
                bankAccountUUID = "repellat";
                description = "cupiditate";
                metadata = new java.util.HashMap<String, String>() {{
                    put("aliquam", "illo");
                }};
                payoutMethodCode = "veniam";
                payoutSchedule = new UpdatePayoutScheduleRequest(UpdatePayoutScheduleRequestScheduleEnum.DAILY_AU) {{
                    action = UpdatePayoutScheduleRequestActionEnum.UPDATE;
                    reason = "possimus";
                }};;
                payoutSpeed = UpdateAccountRequestPayoutSpeedEnum.SAME_DAY;
            }};            
