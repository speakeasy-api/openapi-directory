...
@dataclasses.dataclass
class DNSResponsePoliciesCreateQueryParams:
...
@dataclasses.dataclass
class DNSResponsePoliciesCreateSecurity:
    option1: Optional[DNSResponsePoliciesCreateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSResponsePoliciesCreateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DNSResponsePoliciesCreateRequest:
    path_params: DNSResponsePoliciesCreatePathParams = dataclasses.field()
    query_params: DNSResponsePoliciesCreateQueryParams = dataclasses.field()
    security: DNSResponsePoliciesCreateSecurity = dataclasses.field()
