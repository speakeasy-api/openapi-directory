...
exports.PutShippingMethodsIdJsonResponse = exports.PutShippingMethodsIdJsonRequest = void 0;
...
var PutShippingMethodsIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], PutShippingMethodsIdJsonRequest.prototype, "shippingMethodEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PutShippingMethodsIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PutShippingMethodsIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PutShippingMethodsIdJsonRequest.prototype, "login", void 0);
    return PutShippingMethodsIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PutShippingMethodsIdJsonRequest = PutShippingMethodsIdJsonRequest;
var PutShippingMethodsIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], PutShippingMethodsIdJsonResponse.prototype, "rawResponse", void 0);
    return PutShippingMethodsIdJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PutShippingMethodsIdJsonResponse = PutShippingMethodsIdJsonResponse;
