...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DfareportingUserRolePermissionGroupsGetRequest req = new DfareportingUserRolePermissionGroupsGetRequest("ullam", "quidem") {{
            ...
            DfareportingUserRolePermissionGroupsGetResponse res = sdk.userRolePermissionGroups.dfareportingUserRolePermissionGroupsGet(req, new DfareportingUserRolePermissionGroupsGetSecurity("officiis", "hic") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DfareportingUserRolePermissionGroupsListRequest req = new DfareportingUserRolePermissionGroupsListRequest("eveniet") {{
                dollarXgafv = XgafvEnum.ONE;
                accessToken = "itaque";
                alt = AltEnum.PROTO;
                callback = "corporis";
            ...
            DfareportingUserRolePermissionGroupsListResponse res = sdk.userRolePermissionGroups.dfareportingUserRolePermissionGroupsList(req, new DfareportingUserRolePermissionGroupsListSecurity("libero", "ab") {{
                oauth2 = "Bearer YOUR_ACCESS_TOKEN_HERE";
                oauth2c = "Bearer YOUR_ACCESS_TOKEN_HERE";
            }});
