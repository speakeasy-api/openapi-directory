...
class SetUserSettingsRequest:
    headers: SetUserSettingsHeaders = dataclasses.field()
    request: shared_setusersettingsrequest.SetUserSettingsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
