...
public class NegativeKeywordPagedCollectionResponse {
    ...
    @JsonProperty("href")
    public String href;
    public NegativeKeywordPagedCollectionResponse withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public NegativeKeywordPagedCollectionResponse withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public NegativeKeywordPagedCollectionResponse withNegativeKeywords(NegativeKeyword[] negativeKeywords) {
    ...
    @JsonProperty("next")
    public String next;
    public NegativeKeywordPagedCollectionResponse withNext(String next) {
        this.next = next;
        return this;
    }
    ...
    public NegativeKeywordPagedCollectionResponse withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    @JsonProperty("prev")
    public String prev;
    public NegativeKeywordPagedCollectionResponse withPrev(String prev) {
        this.prev = prev;
        return this;
    }
    ...
    public NegativeKeywordPagedCollectionResponse withTotal(Integer total) {
        this.total = total;
        return this;
    }
