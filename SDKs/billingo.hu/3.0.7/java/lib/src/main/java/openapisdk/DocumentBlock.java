...
public class DocumentBlock {
	...
	public DocumentBlock(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    **/
    public openapisdk.models.operations.ListDocumentBlockResponse listDocumentBlock(openapisdk.models.operations.ListDocumentBlockRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/document-blocks");
        ...
        openapisdk.models.operations.ListDocumentBlockResponse res = new openapisdk.models.operations.ListDocumentBlockResponse() {{
            documentBlockList = null;
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.DocumentBlockList out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DocumentBlockList.class);
