...
@dataclasses.dataclass
class DataprocProjectsRegionsJobsCancelQueryParams:
...
class DataprocProjectsRegionsJobsCancelRequest:
    path_params: DataprocProjectsRegionsJobsCancelPathParams = dataclasses.field()
    query_params: DataprocProjectsRegionsJobsCancelQueryParams = dataclasses.field()
    security: DataprocProjectsRegionsJobsCancelSecurity = dataclasses.field()
