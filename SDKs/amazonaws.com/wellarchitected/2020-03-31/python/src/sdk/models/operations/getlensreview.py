...
from ..shared import getlensreviewoutput as shared_getlensreviewoutput
...
class GetLensReviewRequest:
    headers: GetLensReviewHeaders = dataclasses.field()
    path_params: GetLensReviewPathParams = dataclasses.field()
    query_params: GetLensReviewQueryParams = dataclasses.field()
...
class GetLensReviewResponse:
    ...
    get_lens_review_output: Optional[shared_getlensreviewoutput.GetLensReviewOutput] = dataclasses.field(default=None)
