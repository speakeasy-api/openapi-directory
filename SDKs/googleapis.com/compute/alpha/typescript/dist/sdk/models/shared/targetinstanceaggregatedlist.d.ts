...
import { TargetInstancesScopedList } from "./targetinstancesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum TargetInstanceAggregatedListWarningCodeEnum {
...
export declare class TargetInstanceAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetInstanceAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: TargetInstanceAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: TargetInstanceAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class TargetInstanceAggregatedList extends SpeakeasyBase {
    /**
