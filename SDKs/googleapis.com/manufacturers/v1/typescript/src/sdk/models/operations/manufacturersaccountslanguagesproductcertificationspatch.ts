...
export class ManufacturersAccountsLanguagesProductCertificationsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ManufacturersAccountsLanguagesProductCertificationsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ManufacturersAccountsLanguagesProductCertificationsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
