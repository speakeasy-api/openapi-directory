...
type DisplayvideoCombinedAudiencesGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DisplayvideoCombinedAudiencesGetPathParams struct {
	// Required. The ID of the combined audience to fetch.
	CombinedAudienceID string `pathParam:"style=simple,explode=false,name=combinedAudienceId"`
}

type DisplayvideoCombinedAudiencesGetQueryParams struct {
	// V1 error format.
...
type DisplayvideoCombinedAudiencesGetRequest struct {
...
type DisplayvideoCombinedAudiencesGetResponse struct {
	// Successful response
