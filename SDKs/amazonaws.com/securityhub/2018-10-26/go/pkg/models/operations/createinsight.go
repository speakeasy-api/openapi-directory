...
type CreateInsightHeaders struct {
...
type CreateInsightRequestBodyFilters struct {
	...
	ResourceAwsIamUserUserName                     map[string]interface{} `json:"ResourceAwsIamUserUserName,omitempty"`
...
type CreateInsightRequestBody struct {
	Filters          CreateInsightRequestBodyFilters `json:"Filters"`
...
type CreateInsightRequest struct {
	...
	Request CreateInsightRequestBody `request:"mediaType=application/json"`
}
