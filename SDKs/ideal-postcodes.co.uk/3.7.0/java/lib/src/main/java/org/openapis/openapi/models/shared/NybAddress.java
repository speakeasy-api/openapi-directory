...
public class NybAddress {
    ...
    public NybAddress withAdministrativeCounty(String administrativeCounty) {
    ...
    public NybAddress withBuildingName(String buildingName) {
    ...
    public NybAddress withBuildingNumber(String buildingNumber) {
        this.buildingNumber = buildingNumber;
        return this;
    }
    
    @JsonProperty("country")
    public NybAddressCountryEnum country;
    public NybAddress withCountry(NybAddressCountryEnum country) {
        this.country = country;
        return this;
    }
    
    @JsonProperty("country_iso")
    public NybAddressCountryIsoEnum countryIso;
    public NybAddress withCountryIso(NybAddressCountryIsoEnum countryIso) {
        this.countryIso = countryIso;
        return this;
    }
    
    @JsonProperty("country_iso_2")
    public NybAddressCountryIso2Enum countryIso2;
    public NybAddress withCountryIso2(NybAddressCountryIso2Enum countryIso2) {
    ...
    public NybAddress withCounty(String county) {
        this.county = county;
        return this;
    }
    ...
    public NybAddress withCountyCode(String countyCode) {
        this.countyCode = countyCode;
        return this;
    }
    
    @JsonProperty("dataset")
    public NybAddressDatasetEnum dataset;
    public NybAddress withDataset(NybAddressDatasetEnum dataset) {
    ...
    public NybAddress withDeliveryPointSuffix(String deliveryPointSuffix) {
    ...
    public NybAddress withDepartmentName(String departmentName) {
    ...
    public NybAddress withDependantLocality(String dependantLocality) {
    ...
    public NybAddress withDependantThoroughfare(String dependantThoroughfare) {
    ...
    public NybAddress withDistrict(String district) {
    ...
    public NybAddress withDoubleDependantLocality(String doubleDependantLocality) {
    ...
    public NybAddress withEastings(Object eastings) {
    ...
    @JsonProperty("id")
    public String id;
    public NybAddress withId(String id) {
        this.id = id;
        return this;
    }
    
    @JsonProperty("language")
    public NybAddressLanguageEnum language;
    public NybAddress withLanguage(NybAddressLanguageEnum language) {
    ...
    public NybAddress withLatitude(Object latitude) {
    ...
    @JsonProperty("line_1")
    public String line1;
    public NybAddress withLine1(String line1) {
        this.line1 = line1;
        return this;
    }
    ...
    @JsonProperty("line_2")
    public String line2;
    public NybAddress withLine2(String line2) {
        this.line2 = line2;
        return this;
    }
    ...
    @JsonProperty("line_3")
    public String line3;
    public NybAddress withLine3(String line3) {
        this.line3 = line3;
        return this;
    }
    ...
    public NybAddress withLongitude(Object longitude) {
    ...
    public NybAddress withNorthings(Object northings) {
    ...
    public NybAddress withOrganisationName(String organisationName) {
    ...
    @JsonProperty("po_box")
    public String poBox;
    public NybAddress withPoBox(String poBox) {
        this.poBox = poBox;
        return this;
    }
    ...
    public NybAddress withPostTown(String postTown) {
    ...
    public NybAddress withPostalCounty(String postalCounty) {
    ...
    public NybAddress withPostcode(String postcode) {
    ...
    public NybAddress withPostcodeInward(String postcodeInward) {
    ...
    public NybAddress withPostcodeOutward(String postcodeOutward) {
    ...
    public NybAddress withPostcodeType(PafPostcodeTypeEnum postcodeType) {
    ...
    public NybAddress withPremise(String premise) {
    ...
    public NybAddress withSuOrganisationIndicator(String suOrganisationIndicator) {
    ...
    public NybAddress withSubBuildingName(String subBuildingName) {
    ...
    public NybAddress withThoroughfare(String thoroughfare) {
    ...
    public NybAddress withTraditionalCounty(String traditionalCounty) {
    ...
    public NybAddress withUdprn(Integer udprn) {
        this.udprn = udprn;
        return this;
    }
    ...
    @JsonProperty("umprn")
    public Object umprn;
    public NybAddress withUmprn(Object umprn) {
        this.umprn = umprn;
        return this;
    }
    ...
    @JsonProperty("uprn")
    public String uprn;
    public NybAddress withUprn(String uprn) {
        this.uprn = uprn;
        return this;
    }
    ...
    @JsonProperty("ward")
    public String ward;
    public NybAddress withWard(String ward) {
        this.ward = ward;
        return this;
    }
