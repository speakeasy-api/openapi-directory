...
var DeviceSettings = /** @class */ (function () {
    ...
    DeviceSettings.prototype.nightModesettings = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.NightModesettingsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.example17 = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.Example17);
                    }
                    break;
            }
            return res;
    ...
    DeviceSettings.prototype.rebootandFactoryReset = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.RebootandFactoryResetResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    DeviceSettings.prototype.setEurekaInfo = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.SetEurekaInfoResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
