...
class DescribeCapacityReservationsResultCapacityReservationsCapacityAllocationsAllocationTypeEnum(str, Enum):
...
class DescribeCapacityReservationsResultCapacityReservationsCapacityAllocations:
    ...
    allocation_type: Optional[DescribeCapacityReservationsResultCapacityReservationsCapacityAllocationsAllocationTypeEnum] = dataclasses.field(default=None)  
    count: Optional[int] = dataclasses.field(default=None)  
    
class DescribeCapacityReservationsResultCapacityReservationsEndDateTypeEnum(str, Enum):
...
class DescribeCapacityReservationsResultCapacityReservationsInstanceMatchCriteriaEnum(str, Enum):
...
class DescribeCapacityReservationsResultCapacityReservationsInstancePlatformEnum(str, Enum):
...
class DescribeCapacityReservationsResultCapacityReservationsStateEnum(str, Enum):
...
class DescribeCapacityReservationsResultCapacityReservationsTenancyEnum(str, Enum):
...
class DescribeCapacityReservationsResultCapacityReservations:
    r"""Describes a Capacity Reservation."""
    ...
    capacity_allocations: Optional[list[DescribeCapacityReservationsResultCapacityReservationsCapacityAllocations]] = dataclasses.field(default=None)  
    ...
    end_date_type: Optional[DescribeCapacityReservationsResultCapacityReservationsEndDateTypeEnum] = dataclasses.field(default=None)  
    ephemeral_storage: Optional[bool] = dataclasses.field(default=None)  
    instance_match_criteria: Optional[DescribeCapacityReservationsResultCapacityReservationsInstanceMatchCriteriaEnum] = dataclasses.field(default=None)  
    instance_platform: Optional[DescribeCapacityReservationsResultCapacityReservationsInstancePlatformEnum] = dataclasses.field(default=None)  
    ...
    state: Optional[DescribeCapacityReservationsResultCapacityReservationsStateEnum] = dataclasses.field(default=None)  
    tags: Optional[list[DescribeCapacityReservationsResultCapacityReservationsTags]] = dataclasses.field(default=None)  
    tenancy: Optional[DescribeCapacityReservationsResultCapacityReservationsTenancyEnum] = dataclasses.field(default=None)  
...
class DescribeCapacityReservationsResult:
    ...
    capacity_reservations: Optional[list[DescribeCapacityReservationsResultCapacityReservations]] = dataclasses.field(default=None)  
