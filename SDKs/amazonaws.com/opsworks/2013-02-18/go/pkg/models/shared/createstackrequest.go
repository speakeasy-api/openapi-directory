...
// CreateStackRequestConfigurationManager
// Describes the configuration manager.
type CreateStackRequestConfigurationManager struct {
...
type CreateStackRequest struct {
	...
	ConfigurationManager      *CreateStackRequestConfigurationManager `json:"ConfigurationManager,omitempty"`
