 ...
 */
public enum UpdateNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum {
    BOTH("both"),
    INBOUND("inbound");
    ...
    private UpdateNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum(String value) {
        this.value = value;
    }
}
