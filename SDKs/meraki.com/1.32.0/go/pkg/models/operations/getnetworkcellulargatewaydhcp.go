...
func (e GetNetworkCellularGatewayDhcp200ApplicationJSONDhcpLeaseTimeEnum) ToPointer() *GetNetworkCellularGatewayDhcp200ApplicationJSONDhcpLeaseTimeEnum {
	return &e
}
...
func (e *GetNetworkCellularGatewayDhcp200ApplicationJSONDhcpLeaseTimeEnum) UnmarshalJSON(data []byte) error {
	...
	case "30 minutes":
		fallthrough
	case "4 hours":
		*e = GetNetworkCellularGatewayDhcp200ApplicationJSONDhcpLeaseTimeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkCellularGatewayDhcp200ApplicationJSONDhcpLeaseTimeEnum: %v", v)
	}
}
...
func (e GetNetworkCellularGatewayDhcp200ApplicationJSONDNSNameserversEnum) ToPointer() *GetNetworkCellularGatewayDhcp200ApplicationJSONDNSNameserversEnum {
	return &e
}
...
func (e *GetNetworkCellularGatewayDhcp200ApplicationJSONDNSNameserversEnum) UnmarshalJSON(data []byte) error {
	...
	case "opendns":
		fallthrough
	case "upstream_dns":
		*e = GetNetworkCellularGatewayDhcp200ApplicationJSONDNSNameserversEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkCellularGatewayDhcp200ApplicationJSONDNSNameserversEnum: %v", v)
	}
}
