...
class GetCaseVariantAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetCaseVariantAssociationsQueryParams:
...
class GetCaseVariantAssociationsRequest:
    path_params: GetCaseVariantAssociationsPathParams = dataclasses.field()
    query_params: GetCaseVariantAssociationsQueryParams = dataclasses.field()
