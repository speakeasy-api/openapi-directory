...
class DescribeNetworkInterfacesRequestFilters:
...
class DescribeNetworkInterfacesRequest:
    r"""Contains the parameters for DescribeNetworkInterfaces."""
    
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeNetworkInterfacesRequestFilters]] = dataclasses.field(default=None)  
