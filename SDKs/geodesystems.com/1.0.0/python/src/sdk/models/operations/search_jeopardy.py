...
class SearchJeopardyQueryParams:
    ...
    search_db_jeopardy_air_date: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_jeopardy.air_date', 'style': 'form', 'explode': True }})
    search_db_jeopardy_answer: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_jeopardy.answer', 'style': 'form', 'explode': True }})
    search_db_jeopardy_category: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_jeopardy.category', 'style': 'form', 'explode': True }})
    search_db_jeopardy_question: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_jeopardy.question', 'style': 'form', 'explode': True }})
    search_db_jeopardy_round: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_jeopardy.round', 'style': 'form', 'explode': True }})
...
class SearchJeopardyRequest:
    query_params: SearchJeopardyQueryParams = dataclasses.field()
