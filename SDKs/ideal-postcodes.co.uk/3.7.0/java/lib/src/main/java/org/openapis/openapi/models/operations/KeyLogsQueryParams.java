...
public class KeyLogsQueryParams {
    /**
    ...
    public Integer end;
    public KeyLogsQueryParams withEnd(Integer end) {
        this.end = end;
        return this;
    }
    ...
    public KeyLogsQueryParams withLicensee(String licensee) {
    ...
    public KeyLogsQueryParams withStart(Integer start) {
        this.start = start;
        return this;
    }
