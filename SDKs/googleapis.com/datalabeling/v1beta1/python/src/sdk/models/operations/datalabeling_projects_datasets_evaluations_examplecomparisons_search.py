...
class DatalabelingProjectsDatasetsEvaluationsExampleComparisonsSearchRequest:
    ...
    r"""Required. Name of the Evaluation resource to search for example comparisons from. Format: \\"projects/{project_id}/datasets/{dataset_id}/evaluations/ {evaluation_id}\\" """  
    ...
    google_cloud_datalabeling_v1beta1_search_example_comparisons_request: Optional[shared_googleclouddatalabelingv1beta1searchexamplecomparisonsrequest.GoogleCloudDatalabelingV1beta1SearchExampleComparisonsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
