...
class GetAPIV1DomainBlocksSecurity:
    
    bearer_auth: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'http', 'sub_type': 'bearer', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class GetAPIV1DomainBlocksRequest:
...
class GetAPIV1DomainBlocksResponse:
    ...
    get_api_v1_domain_blocks_200_application_json_strings: Optional[list[str]] = dataclasses.field(default=None)
    r"""success"""  
