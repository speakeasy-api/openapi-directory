...
class ItemsUpdateRequestBody:
    ...
    order_items: Optional[list[ItemsUpdateRequestBodyOrderItems]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('orderItems'), 'exclude': lambda f: f is None }})
    r"""Array containing the cart items. Each object inside this array corresponds to a different item."""  
...
class ItemsUpdateRequest:
    ...
    r"""ID of the `orderForm` corresponding to the cart whose items you want to update."""  
    request_body: ItemsUpdateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    allowed_outdated_data: Optional[list[Any]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'allowedOutdatedData', 'style': 'form', 'explode': True }})
    r"""In order to optimize performance, this parameter allows some information to not be updated when there are changes in the minicart. For instance, if a shopper adds another unit of a given SKU to the cart, it may not be necessary to recalculate payment information, which could impact performance.
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONAvailableAddresses:
    ...
    geo_coordinates: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('geoCoordinates'), 'exclude': lambda f: f is None }})
    r"""List with the two geocoordinates."""  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONClientPreferencesData:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONClientProfileData:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONItemMetadataItems:
...
class ItemsUpdate200ApplicationJSONItemMetadata:
    ...
    items: Optional[list[ItemsUpdate200ApplicationJSONItemMetadataItems]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
    r"""List of objects containing metadata on each item in the order."""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONItemsAdditionalInfo:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONItemsBundleItems:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONItemsPriceDefinitionSellingPrices:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONItemsPriceDefinition:
    ...
    selling_prices: Optional[list[ItemsUpdate200ApplicationJSONItemsPriceDefinitionSellingPrices]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sellingPrices'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONItemsPriceTags:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONItems:
    
    additional_info: Optional[ItemsUpdate200ApplicationJSONItemsAdditionalInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalInfo'), 'exclude': lambda f: f is None }})
    r"""Additional information."""  
    ...
    r"""Availability."""  
    bundle_items: Optional[list[ItemsUpdate200ApplicationJSONItemsBundleItems]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bundleItems'), 'exclude': lambda f: f is None }})
    ...
    price: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price'), 'exclude': lambda f: f is None }})
    r"""Price in cents."""  
    price_definition: Optional[ItemsUpdate200ApplicationJSONItemsPriceDefinition] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('priceDefinition'), 'exclude': lambda f: f is None }})
    r"""Price information for all units of a specific item."""  
    price_tags: Optional[list[ItemsUpdate200ApplicationJSONItemsPriceTags]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('priceTags'), 'exclude': lambda f: f is None }})
    ...
    product_categories: Optional[ItemsUpdate200ApplicationJSONItemsProductCategories] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('productCategories'), 'exclude': lambda f: f is None }})
    r"""Object, where each field is an ID from `productCategoryIds`."""  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONItemsOrdination:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONMarketingData:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONPaymentDataGiftCards:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONPaymentDataTransactionsPayments:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONPaymentDataTransactions:
    ...
    r"""Merchant name."""  
    payments: Optional[list[ItemsUpdate200ApplicationJSONPaymentDataTransactionsPayments]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payments'), 'exclude': lambda f: f is None }})
...
class ItemsUpdate200ApplicationJSONPaymentData:
    ...
    gift_cards: Optional[list[ItemsUpdate200ApplicationJSONPaymentDataGiftCards]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('giftCards'), 'exclude': lambda f: f is None }})
    r"""Gift card information, if it applies to the order."""  
    transactions: Optional[list[ItemsUpdate200ApplicationJSONPaymentDataTransactions]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transactions'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONSellers:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONShippingDataAddress:
    ...
    geo_coordinates: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('geoCoordinates'), 'exclude': lambda f: f is None }})
    r"""Array with two strings with geocoordinates, first latitude, then longitude."""  
    is_disposable: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('isDisposable'), 'exclude': lambda f: f is None }})
    r"""Indicates whether address is disposable."""  
    neighborhood: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('neighborhood'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONShippingDataAvailableAddresses:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoDeliveryChannels:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlasDeliveryIds:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlasPickupStoreInfoAddress:
    r"""Address information."""
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlasPickupStoreInfo:
    ...
    r"""Additional information."""  
    address: Optional[ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlasPickupStoreInfoAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address'), 'exclude': lambda f: f is None }})
    r"""Address information."""  
    dock_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dockId'), 'exclude': lambda f: f is None }})
...
class ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlas:
    ...
    r"""Delivery channel."""  
    delivery_ids: Optional[list[ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlasDeliveryIds]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deliveryIds'), 'exclude': lambda f: f is None }})
    ...
    r"""Pickup point ID."""  
    pickup_store_info: Optional[ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlasPickupStoreInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pickupStoreInfo'), 'exclude': lambda f: f is None }})
    r"""Information on the pickup store."""  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONShippingDataLogisticsInfo:
    
    address_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('addressId'), 'exclude': lambda f: f is None }})
    r"""Address ID."""  
    delivery_channels: Optional[list[ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoDeliveryChannels]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deliveryChannels'), 'exclude': lambda f: f is None }})
    ...
    slas: Optional[list[ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlas]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('slas'), 'exclude': lambda f: f is None }})
    r"""Information on available SLAs."""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ItemsUpdate200ApplicationJSONShippingDataSelectedAddresses:
...
class ItemsUpdate200ApplicationJSONShippingData:
    ...
    address: Optional[ItemsUpdate200ApplicationJSONShippingDataAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address'), 'exclude': lambda f: f is None }})
    r"""Address information."""  
    available_addresses: Optional[list[ItemsUpdate200ApplicationJSONShippingDataAvailableAddresses]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('availableAddresses'), 'exclude': lambda f: f is None }})
    r"""Array with information on the available addresses for the order."""  
    logistics_info: Optional[list[ItemsUpdate200ApplicationJSONShippingDataLogisticsInfo]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logisticsInfo'), 'exclude': lambda f: f is None }})
    ...
    selected_addresses: Optional[list[ItemsUpdate200ApplicationJSONShippingDataSelectedAddresses]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('selectedAddresses'), 'exclude': lambda f: f is None }})
...
class ItemsUpdate200ApplicationJSON:
    ...
    available_addresses: Optional[list[ItemsUpdate200ApplicationJSONAvailableAddresses]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('availableAddresses'), 'exclude': lambda f: f is None }})
    ...
    client_preferences_data: Optional[ItemsUpdate200ApplicationJSONClientPreferencesData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('clientPreferencesData'), 'exclude': lambda f: f is None }})
    r"""Object containing preferences from the client who placed the order."""  
    client_profile_data: Optional[ItemsUpdate200ApplicationJSONClientProfileData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('clientProfileData'), 'exclude': lambda f: f is None }})
    r"""Customer's profile information."""  
    ...
    item_metadata: Optional[ItemsUpdate200ApplicationJSONItemMetadata] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('itemMetadata'), 'exclude': lambda f: f is None }})
    r"""Item metadata."""  
    items: Optional[list[ItemsUpdate200ApplicationJSONItems]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
    r"""Information on each item in the order."""  
    items_ordination: Optional[ItemsUpdate200ApplicationJSONItemsOrdination] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('itemsOrdination'), 'exclude': lambda f: f is None }})
    r"""Object containing information about the ordering of items within the `orderForm`."""  
    ...
    marketing_data: Optional[ItemsUpdate200ApplicationJSONMarketingData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('marketingData'), 'exclude': lambda f: f is None }})
    r"""Object containing promotion data such as coupon tracking information and internal or external UTMs."""  
    ...
    payment_data: Optional[ItemsUpdate200ApplicationJSONPaymentData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('paymentData'), 'exclude': lambda f: f is None }})
    r"""Information on the order's payment."""  
    ...
    r"""Profile provider."""  
    rates_and_benefits_data: Optional[ItemsUpdate200ApplicationJSONRatesAndBenefitsData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ratesAndBenefitsData'), 'exclude': lambda f: f is None }})
    r"""Information on rates and benefits that apply to the order."""  
    ...
    sellers: Optional[list[ItemsUpdate200ApplicationJSONSellers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sellers'), 'exclude': lambda f: f is None }})
    r"""Information on each seller."""  
    shipping_data: Optional[ItemsUpdate200ApplicationJSONShippingData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shippingData'), 'exclude': lambda f: f is None }})
    r"""Shipping information pertinent to the order."""  
    ...
    r"""User type."""  
    value: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value'), 'exclude': lambda f: f is None }})
    r"""Total value of the order without separating cents. For example, $24.99 is represented as `2499`."""  
...
class ItemsUpdateResponse:
    ...
    items_update_200_application_json_object: Optional[ItemsUpdate200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""  
