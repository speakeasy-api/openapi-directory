...
type CreateClientAddressPathParams struct {
...
type CreateClientAddressQueryParams struct {
...
type CreateClientAddressHeaders struct {
...
type CreateClientAddressRequest struct {
	PathParams  CreateClientAddressPathParams
	QueryParams CreateClientAddressQueryParams
	Headers     CreateClientAddressHeaders
	Request     *shared.Address `request:"mediaType=application/json"`
}

type CreateClientAddressResponse struct {
	ContentType string
	// Created
	CreateClientAddress201ApplicationJSONObject map[string]interface{}
	StatusCode                                  int
