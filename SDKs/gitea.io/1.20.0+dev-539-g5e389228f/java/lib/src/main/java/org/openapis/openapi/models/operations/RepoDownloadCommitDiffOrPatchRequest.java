...
public class RepoDownloadCommitDiffOrPatchRequest {
    ...
    public RepoDownloadCommitDiffOrPatchRequest(@JsonProperty("diffType") RepoDownloadCommitDiffOrPatchDiffTypeEnum diffType, @JsonProperty("owner") String owner, @JsonProperty("repo") String repo, @JsonProperty("sha") String sha) {
        this.diffType = diffType;
        this.owner = owner;
        this.repo = repo;
        this.sha = sha;
