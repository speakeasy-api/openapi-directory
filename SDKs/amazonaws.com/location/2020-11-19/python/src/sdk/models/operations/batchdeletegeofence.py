...
class BatchDeleteGeofenceRequestBody:
    ...
    geofence_ids: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('GeofenceIds') }})
    r"""The batch of geofences to be deleted."""  
...
class BatchDeleteGeofenceRequest:
    ...
    r"""The geofence collection storing the geofences to be deleted."""  
    request_body: BatchDeleteGeofenceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
