...
class LinkTokenCreateRequest:
    ...
    """  
    additional_consented_products: Optional[list[shared_products_enum.ProductsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additional_consented_products'), 'exclude': lambda f: f is None }})
    r"""(Beta) This field has no effect unless you are participating in the Product Scope Transparency beta program.
    ...
    r"""List of Plaid product(s) you wish to use. If launching Link in update mode, should be omitted; required otherwise.
    ...
    r"""The destination URL to which any webhooks should be sent."""  
