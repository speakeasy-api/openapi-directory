...
public class GetOrderHistoryRequest {
    ...
    public GetOrderHistoryRequest withIfNoneMatch(String ifNoneMatch) {
    ...
    public GetOrderHistoryRequest withAccountId(Integer accountId) {
    ...
    public GetOrderHistoryRequest withBeezUPOrderId(String beezUPOrderId) {
    ...
    public GetOrderHistoryRequest withMarketplaceTechnicalCode(String marketplaceTechnicalCode) {
        this.marketplaceTechnicalCode = marketplaceTechnicalCode;
        return this;
    }
    
    public GetOrderHistoryRequest(@JsonProperty("accountId") Integer accountId, @JsonProperty("beezUPOrderId") String beezUPOrderId, @JsonProperty("marketplaceTechnicalCode") String marketplaceTechnicalCode) {
        this.accountId = accountId;
        this.beezUPOrderId = beezUPOrderId;
        this.marketplaceTechnicalCode = marketplaceTechnicalCode;
  }
