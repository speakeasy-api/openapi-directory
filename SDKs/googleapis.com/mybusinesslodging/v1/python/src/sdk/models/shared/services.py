...
class Services:
    ...
    languages_spoken: Optional[list[shared_languagespoken.LanguageSpoken]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('languagesSpoken') }})
