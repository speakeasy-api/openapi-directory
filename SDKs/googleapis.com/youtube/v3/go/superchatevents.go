...
func (s *superChatEvents) YoutubeSuperChatEventsList(ctx context.Context, request operations.YoutubeSuperChatEventsListRequest, security operations.YoutubeSuperChatEventsListSecurity) (*operations.YoutubeSuperChatEventsListResponse, error) {
	baseURL := s.serverURL
