...
class CreateMessagingConfigurationRequest:
    ...
    request_body: Optional[CreateMessagingConfigurationCreateMessagingConfigurationRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
