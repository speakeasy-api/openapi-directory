...
exports.ThirdPartyTransaction = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var shared = __importStar(require("./models/shared"));
var ThirdPartyTransaction = /** @class */ (function () {
    function ThirdPartyTransaction(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    ThirdPartyTransaction.prototype.deleteThirdPartyTransactionTag = function (req, config) {
     ...
     */
    ThirdPartyTransaction.prototype.getAllThirdPartyTransactionTags = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    ThirdPartyTransaction.prototype.getAllThirdPartyTransactionsWithTag = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    ThirdPartyTransaction.prototype.getTagFromThirdPartyTransaction = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    ThirdPartyTransaction.prototype.getTagsFromThirdPartyTransaction = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    ThirdPartyTransaction.prototype.putThirdPartyTransactionTag = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.ThirdPartyTransaction = ThirdPartyTransaction;
