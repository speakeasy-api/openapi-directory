...
class AddInternalNumbersApplicationJSONInternalNumbers
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\AddInternalNumbersApplicationJSONInternalNumbersLanguagesEnum $languages
     */
	#[\JMS\Serializer\Annotation\SerializedName('languages')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\AddInternalNumbersApplicationJSONInternalNumbersLanguagesEnum>')]
     ...
     * * `1` : tollfree 
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\AddInternalNumbersApplicationJSONInternalNumbersTypeEnum $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\AddInternalNumbersApplicationJSONInternalNumbersTypeEnum>')]
	...
	public function __construct()
	{
		...
		$this->displayNumber = "";
		$this->labels = "";
		$this->languages = \OpenAPI\OpenAPI\Models\Operations\AddInternalNumbersApplicationJSONInternalNumbersLanguagesEnum::EN_GB;
		$this->number = "";
		$this->type = \OpenAPI\OpenAPI\Models\Operations\AddInternalNumbersApplicationJSONInternalNumbersTypeEnum::ZERO;
		$this->visible = null;
	}
}
