...
var Credits = /** @class */ (function () {
    function Credits(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
     */
    Credits.prototype.postCreditTransfer = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new shared.TransferEntry(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/credit/transfer";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostCreditTransferResponse({
