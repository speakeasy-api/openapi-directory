...
export class UpdateSigningBasketPsuDataPathParams extends SpeakeasyBase {
...
export class UpdateSigningBasketPsuDataHeaders extends SpeakeasyBase {
...
export class UpdateSigningBasketPsuDataSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=http;subtype=bearer" })
  bearerAuthOAuth?: shared.SchemeBearerAuthOAuth;
}


export class UpdateSigningBasketPsuDataRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateSigningBasketPsuDataResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
