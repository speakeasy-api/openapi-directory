...
class AnalyticsManagementFiltersGetSecurity:
    option1: Optional[AnalyticsManagementFiltersGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementFiltersGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class AnalyticsManagementFiltersGetRequest:
    path_params: AnalyticsManagementFiltersGetPathParams = dataclasses.field()
    query_params: AnalyticsManagementFiltersGetQueryParams = dataclasses.field()
    security: AnalyticsManagementFiltersGetSecurity = dataclasses.field()
