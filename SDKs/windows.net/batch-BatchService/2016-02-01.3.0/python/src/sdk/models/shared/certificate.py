...
class CertificatePreviousStateEnum(str, Enum):
    r"""The previous state of the certificate. This property is not set if the certificate is in its initial Active state."""
    ACTIVE = 'active'
    DELETING = 'deleting'
    DELETEFAILED = 'deletefailed'

class CertificateStateEnum(str, Enum):
    r"""The current state of the certificate."""
    ACTIVE = 'active'
    DELETING = 'deleting'
    DELETEFAILED = 'deletefailed'
...
class Certificate:
    ...
    r"""The time at which the certificate entered its previous state. This property is not set if the certificate is in its initial Active state."""  
    ...
    r"""The public part of the certificate as a base-64 encoded .cer file."""  
    ...
    r"""The time at which the certificate entered its current state."""  
