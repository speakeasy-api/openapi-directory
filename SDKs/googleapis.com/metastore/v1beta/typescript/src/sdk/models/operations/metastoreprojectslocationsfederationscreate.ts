...
export class MetastoreProjectsLocationsFederationsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsFederationsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=federationId",
  })
  federationId?: string;
...
export class MetastoreProjectsLocationsFederationsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
