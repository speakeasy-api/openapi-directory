...
class PeriodicPaymentRequestExecutionRuleEnum(str, Enum):
    r"""Behavior when periodic payment dates fall on holiday."""
    FOLLOWING = 'following'
    PRECEDING = 'preceding'

class PeriodicPaymentRequestFrequencyEnum(str, Enum):
    DAILY = 'Daily'
    WEEKLY = 'Weekly'
...
class PeriodicPaymentRequest:
    ...
    execution_rule: Optional[PeriodicPaymentRequestExecutionRuleEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('execution_rule'), 'exclude': lambda f: f is None }})
    r"""Behavior when periodic payment dates fall on holiday."""  
    frequency: Optional[PeriodicPaymentRequestFrequencyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('frequency'), 'exclude': lambda f: f is None }})  
