...
class DescribeSavingsPlanRatesResponse:
    ...
    search_results: Optional[list[shared_savingsplanrate.SavingsPlanRate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('searchResults'), 'exclude': lambda f: f is None }})  
