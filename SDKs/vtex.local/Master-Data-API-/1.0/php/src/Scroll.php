...
class Scroll 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\ScrolldocumentsResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/api/dataentities/{dataEntityName}/scroll', \OpenAPI\OpenAPI\Models\Operations\ScrolldocumentsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ScrolldocumentsRequest::class, $request, null));
