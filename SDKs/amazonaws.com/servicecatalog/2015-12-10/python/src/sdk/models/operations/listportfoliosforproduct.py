...
class ListPortfoliosForProductRequest:
    ...
    list_portfolios_for_product_input: shared_listportfoliosforproductinput.ListPortfoliosForProductInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
