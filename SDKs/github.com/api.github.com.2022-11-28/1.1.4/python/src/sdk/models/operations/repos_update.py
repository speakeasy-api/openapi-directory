...
class ReposUpdateRequestBodySecurityAndAnalysisAdvancedSecurity:
    r"""Use the `status` property to enable or disable GitHub Advanced Security for this repository. For more information, see \\"[About GitHub Advanced Security](/github/getting-started-with-github/learning-about-github/about-github-advanced-security).\\" """
    
    status: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""Can be `enabled` or `disabled`."""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ReposUpdateRequestBodySecurityAndAnalysisSecretScanning:
    r"""Use the `status` property to enable or disable secret scanning for this repository. For more information, see \\"[About secret scanning](/code-security/secret-security/about-secret-scanning).\\" """
...
class ReposUpdateRequestBodySecurityAndAnalysisSecretScanningPushProtection:
    r"""Use the `status` property to enable or disable secret scanning push protection for this repository. For more information, see \\"[Protecting pushes with secret scanning](/code-security/secret-scanning/protecting-pushes-with-secret-scanning).\\" """
...
class ReposUpdateRequestBodySecurityAndAnalysis:
    r"""Specify which security and analysis features to enable or disable for the repository.
    ...
    advanced_security: Optional[ReposUpdateRequestBodySecurityAndAnalysisAdvancedSecurity] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('advanced_security'), 'exclude': lambda f: f is None }})
    r"""Use the `status` property to enable or disable GitHub Advanced Security for this repository. For more information, see \\"[About GitHub Advanced Security](/github/getting-started-with-github/learning-about-github/about-github-advanced-security).\\" """  
    secret_scanning: Optional[ReposUpdateRequestBodySecurityAndAnalysisSecretScanning] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('secret_scanning'), 'exclude': lambda f: f is None }})
    r"""Use the `status` property to enable or disable secret scanning for this repository. For more information, see \\"[About secret scanning](/code-security/secret-security/about-secret-scanning).\\" """  
    secret_scanning_push_protection: Optional[ReposUpdateRequestBodySecurityAndAnalysisSecretScanningPushProtection] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('secret_scanning_push_protection'), 'exclude': lambda f: f is None }})
    r"""Use the `status` property to enable or disable secret scanning push protection for this repository. For more information, see \\"[Protecting pushes with secret scanning](/code-security/secret-scanning/protecting-pushes-with-secret-scanning).\\" """  
...
class ReposUpdateRequestBody:
    ...
    **Note**: You will get a `422` error if the organization restricts [changing repository visibility](https://docs.github.com/articles/repository-permission-levels-for-an-organization#changing-the-visibility-of-repositories) to organization owners and a non-owner tries to change the value of private.
    """  
    security_and_analysis: Optional[ReposUpdateRequestBodySecurityAndAnalysis] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('security_and_analysis'), 'exclude': lambda f: f is None }})
    r"""Specify which security and analysis features to enable or disable for the repository.
