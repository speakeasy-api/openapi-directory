...
export class CloudshellUsersEnvironmentsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudshellUsersEnvironmentsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudshellUsersEnvironmentsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
