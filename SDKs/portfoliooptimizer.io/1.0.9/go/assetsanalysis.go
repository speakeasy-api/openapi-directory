...
func (s *assetsAnalysis) PostAssetsAnalysisAbsorptionRatio(ctx context.Context, request operations.PostAssetsAnalysisAbsorptionRatioRequestBody) (*operations.PostAssetsAnalysisAbsorptionRatioResponse, error) {
	baseURL := s.serverURL
...
func (s *assetsAnalysis) PostAssetsAnalysisTurbulenceIndex(ctx context.Context, request operations.PostAssetsAnalysisTurbulenceIndexRequestBody) (*operations.PostAssetsAnalysisTurbulenceIndexResponse, error) {
	baseURL := s.serverURL
