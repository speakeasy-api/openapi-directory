...
class GetBlobRequest:
    ...
    get_blob_input: shared_getblobinput.GetBlobInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
