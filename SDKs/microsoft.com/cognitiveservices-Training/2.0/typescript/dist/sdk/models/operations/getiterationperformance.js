...
exports.GetIterationPerformanceResponse = exports.GetIterationPerformanceRequest = void 0;
...
var GetIterationPerformanceRequest = /** @class */ (function (_super) {
    ...
    ], GetIterationPerformanceRequest.prototype, "trainingKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=iterationId",
        }),
        __metadata("design:type", String)
    ], GetIterationPerformanceRequest.prototype, "iterationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=overlapThreshold",
        }),
        __metadata("design:type", Number)
    ], GetIterationPerformanceRequest.prototype, "overlapThreshold", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=projectId",
        }),
        __metadata("design:type", String)
    ], GetIterationPerformanceRequest.prototype, "projectId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=threshold",
        }),
        __metadata("design:type", Number)
    ], GetIterationPerformanceRequest.prototype, "threshold", void 0);
    return GetIterationPerformanceRequest;
}(utils_1.SpeakeasyBase));
exports.GetIterationPerformanceRequest = GetIterationPerformanceRequest;
var GetIterationPerformanceResponse = /** @class */ (function (_super) {
    ...
    ], GetIterationPerformanceResponse.prototype, "rawResponse", void 0);
    return GetIterationPerformanceResponse;
}(utils_1.SpeakeasyBase));
exports.GetIterationPerformanceResponse = GetIterationPerformanceResponse;
