...
export class Error500ErrorErrorSource extends SpeakeasyBase {
  /**
 ...
 */
export class Error500Error extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "source" })
  @Type(() => Error500ErrorErrorSource)
  source?: Error500ErrorErrorSource;
...
export class Error500 extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: Error500Error })
  @Expose({ name: "errors" })
  @Type(() => Error500Error)
  errors?: Error500Error[];
}
