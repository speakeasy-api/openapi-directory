...
import { RoutersScopedList } from "./routersscopedlist";
import { Expose, Transform, Type } from "class-transformer";

/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export enum RouterAggregatedListWarningCodeEnum {
...
export class RouterAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class RouterAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: RouterAggregatedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: RouterAggregatedListWarningData })
  @Expose({ name: "data" })
  @Type(() => RouterAggregatedListWarningData)
  data?: RouterAggregatedListWarningData[];
 ...
 */
export class RouterAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: RoutersScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, RoutersScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], RoutersScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
