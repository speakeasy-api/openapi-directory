...
exports.SetLoggingOptionsResponse = exports.SetLoggingOptionsRequest = exports.SetLoggingOptionsRequestBody = exports.SetLoggingOptionsRequestBodyLoggingOptionsPayload = void 0;
...
exports.SetLoggingOptionsRequestBodyLoggingOptionsPayload = SetLoggingOptionsRequestBodyLoggingOptionsPayload;
var SetLoggingOptionsRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "loggingOptionsPayload" }),
        (0, class_transformer_1.Type)(function () { return SetLoggingOptionsRequestBodyLoggingOptionsPayload; }),
...
exports.SetLoggingOptionsRequestBody = SetLoggingOptionsRequestBody;
var SetLoggingOptionsRequest = /** @class */ (function (_super) {
    ...
    ], SetLoggingOptionsRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], SetLoggingOptionsRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], SetLoggingOptionsRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], SetLoggingOptionsRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], SetLoggingOptionsRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], SetLoggingOptionsRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], SetLoggingOptionsRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], SetLoggingOptionsRequest.prototype, "xAmzSignedHeaders", void 0);
    return SetLoggingOptionsRequest;
}(utils_1.SpeakeasyBase));
exports.SetLoggingOptionsRequest = SetLoggingOptionsRequest;
var SetLoggingOptionsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], SetLoggingOptionsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.SetLoggingOptionsResponse = SetLoggingOptionsResponse;
