...
class SiteSkippableSetting:
    ...
    r"""Identifies what kind of resource this is. Value: the fixed string \\"dfareporting#siteSkippableSetting\\"."""  
    ...
    r"""Whether the user can skip creatives served to this site. This will act as default for new placements created under this site."""  
