...
class GetUsersIdsQuestionsFeaturedPathParams:
    ids: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ids', 'style': 'simple', 'explode': False }})
    
class GetUsersIdsQuestionsFeaturedOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetUsersIdsQuestionsFeaturedSortEnum(str, Enum):
    ACTIVITY = "activity"
    CREATION = "creation"
    VOTES = "votes"
...
@dataclasses.dataclass
class GetUsersIdsQuestionsFeaturedQueryParams:
    ...
    order: Optional[GetUsersIdsQuestionsFeaturedOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetUsersIdsQuestionsFeaturedSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetUsersIdsQuestionsFeaturedRequest:
    path_params: GetUsersIdsQuestionsFeaturedPathParams = dataclasses.field()
    query_params: GetUsersIdsQuestionsFeaturedQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetUsersIdsQuestionsFeaturedResponse:
