...
public class GetPathwayPhenotypeAssociationsQueryParams {
    /**
    ...
    public GetPathwayPhenotypeAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPathwayPhenotypeAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetPathwayPhenotypeAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPathwayPhenotypeAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetPathwayPhenotypeAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public String q;
    public GetPathwayPhenotypeAssociationsQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsQueryParams withRelation(String relation) {
    ...
    public Long rows;
    public GetPathwayPhenotypeAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetPathwayPhenotypeAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public String sort;
    public GetPathwayPhenotypeAssociationsQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetPathwayPhenotypeAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetPathwayPhenotypeAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPathwayPhenotypeAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPathwayPhenotypeAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
