...
type CreateFilePaymentsRawSecurity struct {
	PSUOAuth2Security shared.SchemePsuoAuth2Security `security:"scheme,type=oauth2"`
}

type CreateFilePaymentsRawHeaders struct {
...
type CreateFilePaymentsRawRequest struct {
	Headers CreateFilePaymentsRawHeaders
	// Default
	Request  []byte `request:"mediaType=application/jose+jwe"`
	Security CreateFilePaymentsRawSecurity
}

type CreateFilePaymentsRawResponse struct {
	Body        []byte
	ContentType string
