...
from ..shared import calculatetermsofservicestatusresponse as shared_calculatetermsofservicestatusresponse
...
class GetLegalEntitiesIDTermsOfServiceStatusSecurity:
...
@dataclasses.dataclass
class GetLegalEntitiesIDTermsOfServiceStatusRequest:
...
class GetLegalEntitiesIDTermsOfServiceStatusResponse:
    ...
    calculate_terms_of_service_status_response: Optional[shared_calculatetermsofservicestatusresponse.CalculateTermsOfServiceStatusResponse] = dataclasses.field(default=None)
