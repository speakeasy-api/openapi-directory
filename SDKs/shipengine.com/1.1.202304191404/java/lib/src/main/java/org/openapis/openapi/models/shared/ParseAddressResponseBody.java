...
public class ParseAddressResponseBody {
    ...
    public ParseAddressResponseBody(@JsonProperty("address") PartialAddress address, @JsonProperty("entities") RecognizedEntity[] entities, @JsonProperty("score") Double score) {
        this.address = address;
        this.entities = entities;
        this.score = score;
  }
