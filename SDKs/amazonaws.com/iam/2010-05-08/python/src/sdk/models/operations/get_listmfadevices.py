...
class GetListMfaDevicesQueryParams:
    action: GetListMfaDevicesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetListMfaDevicesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListMfaDevicesRequest:
    headers: GetListMfaDevicesHeaders = dataclasses.field()
    query_params: GetListMfaDevicesQueryParams = dataclasses.field()
