...
exports.PutProductsIdVariantsVariantIdJsonResponse = exports.PutProductsIdVariantsVariantIdJsonRequest = void 0;
...
var PutProductsIdVariantsVariantIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], PutProductsIdVariantsVariantIdJsonRequest.prototype, "variantEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PutProductsIdVariantsVariantIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PutProductsIdVariantsVariantIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PutProductsIdVariantsVariantIdJsonRequest.prototype, "login", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=variant_id",
        }),
        __metadata("design:type", Number)
    ], PutProductsIdVariantsVariantIdJsonRequest.prototype, "variantId", void 0);
    return PutProductsIdVariantsVariantIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PutProductsIdVariantsVariantIdJsonRequest = PutProductsIdVariantsVariantIdJsonRequest;
var PutProductsIdVariantsVariantIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], PutProductsIdVariantsVariantIdJsonResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.PutProductsIdVariantsVariantIdJsonResponse = PutProductsIdVariantsVariantIdJsonResponse;
