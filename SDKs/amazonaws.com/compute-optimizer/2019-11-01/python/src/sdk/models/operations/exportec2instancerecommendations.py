...
class ExportEc2InstanceRecommendationsRequest:
    ...
    export_ec2_instance_recommendations_request: shared_exportec2instancerecommendationsrequest.ExportEc2InstanceRecommendationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
