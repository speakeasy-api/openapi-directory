...
try {
    ...
    $request->requestBody->assignee = 'sapiente';
    $request->requestBody->assignees = [
        'vitae',
        'rerum',
        'tempora',
    ...
    $request->requestBody->body = 'inventore';
    $request->requestBody->labels = [
        new IssuesCreateRequestBodyLabels2(),
    ];
    $request->requestBody->milestone = 'perferendis';
...
try {
    ...
    $request->requestBody->color = 'sapiente';
    $request->requestBody->description = 'eum';
    $request->requestBody->name = 'Cathy Breitenberg';
    $request->owner = 'earum';
    $request->repo = 'soluta';
...
try {
    ...
    $request->requestBody->dueOn = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-11-04T12:05:06.853Z');
...
try {
    ...
    $request->name = 'Denise Runolfsdottir';
    $request->owner = 'animi';
...
try {
    ...
    $request->milestoneNumber = 862063;
...
try {
    ...
    $request->milestoneNumber = 479754;
    $request->owner = 'esse';
...
try {
    ...
    $request->owned = false;
    $request->page = 99958;
    $request->perPage = 857125;
    $request->pulls = false;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-11-19T04:18:55.408Z');
...
try {
    ...
    $request->issueNumber = 58870;
    $request->owner = 'laborum';
    $request->page = 123844;
    $request->perPage = 344718;
    $request->repo = 'fugiat';
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-03-15T05:49:38.899Z');
...
try {
    ...
    $request->owner = 'suscipit';
    $request->page = 399161;
    $request->perPage = 21973;
    $request->repo = 'eum';
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-05-21T16:44:14.214Z');
...
try {
    ...
    $request->issueNumber = 70042;
    $request->owner = 'error';
    $request->page = 822407;
    $request->perPage = 913992;
...
try {
    ...
    $request->filter = IssuesListForAuthenticatedUserFilterEnum::CREATED;
    $request->labels = 'ad';
    $request->page = 713927;
    $request->perPage = 29950;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-07-11T19:18:20.130Z');
    $request->sort = IssuesListForAuthenticatedUserSortEnum::UPDATED;
...
try {
    ...
    $request->direction = DirectionEnum::DESC;
    $request->filter = IssuesListForOrgFilterEnum::SUBSCRIBED;
    $request->labels = 'veritatis';
    $request->org = 'rerum';
    $request->page = 665678;
    $request->perPage = 634786;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-01-15T21:54:49.962Z');
...
try {
    ...
    $request->assignee = 'fuga';
    $request->creator = 'pariatur';
    $request->direction = DirectionEnum::DESC;
    $request->labels = 'voluptatem';
    $request->mentioned = 'alias';
    $request->milestone = 'deleniti';
    $request->owner = 'earum';
    $request->page = 404244;
    $request->perPage = 958308;
    $request->repo = 'rem';
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-11-27T05:10:30.323Z');
...
try {
    ...
    $request->milestoneNumber = 355225;
...
try {
    ...
    $request->issueNumber = 222864;
    $request->owner = 'aliquam';
    $request->page = 80532;
    $request->perPage = 537279;
...
try {
    ...
    $request->issueNumber = 456410;
    $request->name = 'Aaron Hartmann';
    $request->owner = 'eum';
    $request->repo = 'vel';
...
try {
    ...
    $request->requestBody->assignee = 'recusandae';
    $request->requestBody->assignees = [
        'voluptatem',
    ];
    ...
    $request->requestBody->milestone = 192718;
    ...
    $request->requestBody->title = 759283;
    $request->issueNumber = 579681;
    $request->owner = 'nemo';
...
try {
    ...
    $request->requestBody->body = 'blanditiis';
    $request->commentId = 642352;
...
try {
    ...
    $request->requestBody->color = 'nemo';
    $request->requestBody->description = 'quos';
    $request->requestBody->newName = 'eius';
    $request->name = 'Caroline Dooley';
...
try {
    ...
    $request->requestBody->dueOn = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-08-25T11:14:44.041Z');
    $request->requestBody->state = IssuesUpdateMilestoneRequestBodyStateEnum::OPEN;
    $request->requestBody->title = 'Mr.';
    $request->milestoneNumber = 233078;
