...
from ..shared import itemcustommetadata as shared_itemcustommetadata
...
class ItemDetail:
    ...
    type: ItemDetailTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type of item"""  
    ...
    r"""Copyright information about this item"""  
    credits: Optional[list[shared_credit.Credit]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credits'), 'exclude': lambda f: f is None }})
    r"""A list of credits associated with this item."""  
    ...
    """  
    custom_metadata: Optional[list[shared_itemcustommetadata.ItemCustomMetadata]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('customMetadata'), 'exclude': lambda f: f is None }})
    r"""An ordered list of custom name-value-pair item metadata.
    
    Usually displayed on an item detail page.
    """  
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('description'), 'exclude': lambda f: f is None }})
    r"""The description of this item."""  
    ...
    r"""The distributor of this item."""  
    ...
    episodes: Optional[shared_itemlist.ItemList] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('episodes'), 'exclude': lambda f: f is None }})
    ...
    r"""The optional date of an event.
    Specific to a Program item type.
    """  
    genre_paths: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('genrePaths'), 'exclude': lambda f: f is None }})
    r"""An array of genre paths mapping to the values within the `genres` array from ItemSummary."""  
    ...
    r"""The optional location (e.g. city) of an event.
    Specific to a Program item type.
    """  
    ...
    season: Optional[ItemDetail] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('season'), 'exclude': lambda f: f is None }})  
    ...
    seasons: Optional[shared_itemlist.ItemList] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('seasons'), 'exclude': lambda f: f is None }})
    r"""A pageable list of items."""  
    ...
    show: Optional[ItemDetail] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('show'), 'exclude': lambda f: f is None }})  
    ...
    total_user_ratings: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('totalUserRatings'), 'exclude': lambda f: f is None }})
    r"""The total number of users who have rated this item."""  
    trailers: Optional[list[shared_itemsummary.ItemSummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('trailers'), 'exclude': lambda f: f is None }})
    r"""A list of trailers associated with this item."""  
    ...
    r"""The optional venue of an event.
    Specific to a Program item type.
    """  
