 ...
 *
 */
export class CreditMemoTaxItemFromInvoiceTaxItemTypeFinanceInformation extends SpeakeasyBase {
  /**
 ...
 *
 */
export enum CreditMemoTaxItemFromInvoiceTaxItemTypeTaxRateTypeEnum {
  Percentage = "Percentage",
  FlatFee = "FlatFee",
}

export class CreditMemoTaxItemFromInvoiceTaxItemType extends SpeakeasyBase {
  /**
