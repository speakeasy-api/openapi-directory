...
exports.BypassActivationLockAttempts = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var BypassActivationLockAttempts = /** @class */ (function () {
    function BypassActivationLockAttempts(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    BypassActivationLockAttempts.prototype.createNetworkSmBypassActivationLockAttempt = function (req, config) {
        var _a;
    ...
    **/
    BypassActivationLockAttempts.prototype.getNetworkSmBypassActivationLockAttempt = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.BypassActivationLockAttempts = BypassActivationLockAttempts;
