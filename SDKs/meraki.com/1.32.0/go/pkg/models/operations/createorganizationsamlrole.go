...
func (e CreateOrganizationSamlRoleRequestBodyNetworksAccessEnum) ToPointer() *CreateOrganizationSamlRoleRequestBodyNetworksAccessEnum {
	return &e
}
...
func (e *CreateOrganizationSamlRoleRequestBodyNetworksAccessEnum) UnmarshalJSON(data []byte) error {
	...
	case "read-only":
		fallthrough
	case "ssid-admin":
		*e = CreateOrganizationSamlRoleRequestBodyNetworksAccessEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOrganizationSamlRoleRequestBodyNetworksAccessEnum: %v", v)
	}
}
...
func (e CreateOrganizationSamlRoleRequestBodyOrgAccessEnum) ToPointer() *CreateOrganizationSamlRoleRequestBodyOrgAccessEnum {
	return &e
}
...
func (e *CreateOrganizationSamlRoleRequestBodyOrgAccessEnum) UnmarshalJSON(data []byte) error {
	...
	case "none":
		fallthrough
	case "read-only":
		*e = CreateOrganizationSamlRoleRequestBodyOrgAccessEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOrganizationSamlRoleRequestBodyOrgAccessEnum: %v", v)
	}
}
...
func (e CreateOrganizationSamlRoleRequestBodyTagsAccessEnum) ToPointer() *CreateOrganizationSamlRoleRequestBodyTagsAccessEnum {
	return &e
}
...
func (e *CreateOrganizationSamlRoleRequestBodyTagsAccessEnum) UnmarshalJSON(data []byte) error {
	...
	case "monitor-only":
		fallthrough
	case "read-only":
		*e = CreateOrganizationSamlRoleRequestBodyTagsAccessEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOrganizationSamlRoleRequestBodyTagsAccessEnum: %v", v)
	}
}
