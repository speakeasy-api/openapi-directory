...
from ..shared import deleteapnschannelresponse as shared_deleteapnschannelresponse
...
class DeleteApnsChannelRequest:
    headers: DeleteApnsChannelHeaders = dataclasses.field()
    path_params: DeleteApnsChannelPathParams = dataclasses.field()
...
class DeleteApnsChannelResponse:
    ...
    delete_apns_channel_response: Optional[shared_deleteapnschannelresponse.DeleteApnsChannelResponse] = dataclasses.field(default=None)
