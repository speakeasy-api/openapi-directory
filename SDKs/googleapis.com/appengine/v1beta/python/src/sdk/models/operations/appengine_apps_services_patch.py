...
class AppengineAppsServicesPatchPathParams:
...
@dataclasses.dataclass
class AppengineAppsServicesPatchQueryParams:
...
class AppengineAppsServicesPatchRequest:
    path_params: AppengineAppsServicesPatchPathParams = dataclasses.field()
    query_params: AppengineAppsServicesPatchQueryParams = dataclasses.field()
    security: AppengineAppsServicesPatchSecurity = dataclasses.field()
