...
public class StorageObjectsUpdateQueryParams {
    ...
    public StorageObjectsUpdatePredefinedAclEnum predefinedAcl;
    public StorageObjectsUpdateQueryParams withPredefinedAcl(StorageObjectsUpdatePredefinedAclEnum predefinedAcl) {
    ...
    public StorageObjectsUpdateQueryParams withUploadType(String uploadType) {
    ...
    public StorageObjectsUpdateQueryParams withUserProject(String userProject) {
