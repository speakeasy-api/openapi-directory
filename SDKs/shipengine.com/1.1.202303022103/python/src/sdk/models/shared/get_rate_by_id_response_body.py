...
class GetRateByIDResponseBodyRateTypeEnum(str, Enum):
    r"""The possible rate type values"""
    CHECK = 'check'
    SHIPMENT = 'shipment'

class GetRateByIDResponseBodyValidationStatusEnum(str, Enum):
...
class GetRateByIDResponseBody:
    ...
    r"""carrier nickname"""  
    confirmation_amount: GetRateByIDResponseBodyMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('confirmation_amount') }})
    ...
    insurance_amount: GetRateByIDResponseBodyMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('insurance_amount') }})
    ...
    other_amount: GetRateByIDResponseBodyMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('other_amount') }})
    ...
    rate_type: GetRateByIDResponseBodyRateTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rate_type') }})  
    ...
    r"""service type"""  
    shipping_amount: GetRateByIDResponseBodyMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shipping_amount') }})
    ...
    validation_status: GetRateByIDResponseBodyValidationStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('validation_status') }})  
    ...
    r"""ship date"""  
    tax_amount: Optional[GetRateByIDResponseBodyMonetaryValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tax_amount'), 'exclude': lambda f: f is None }})
