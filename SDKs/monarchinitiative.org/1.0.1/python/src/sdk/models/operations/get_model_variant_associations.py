...
class GetModelVariantAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetModelVariantAssociationsQueryParams:
...
@dataclasses.dataclass
class GetModelVariantAssociationsRequest:
    path_params: GetModelVariantAssociationsPathParams = dataclasses.field()
    query_params: GetModelVariantAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetModelVariantAssociationsResponse:
