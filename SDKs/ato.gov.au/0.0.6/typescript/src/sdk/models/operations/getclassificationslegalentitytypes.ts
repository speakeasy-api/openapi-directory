...
export class GetClassificationsLegalEntityTypesRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class GetClassificationsLegalEntityTypesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: shared.LegalEntityType })
