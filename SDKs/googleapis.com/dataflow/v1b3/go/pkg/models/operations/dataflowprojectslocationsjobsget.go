...
func (e DataflowProjectsLocationsJobsGetViewEnum) ToPointer() *DataflowProjectsLocationsJobsGetViewEnum {
	return &e
}
...
func (e *DataflowProjectsLocationsJobsGetViewEnum) UnmarshalJSON(data []byte) error {
	...
	case "JOB_VIEW_DESCRIPTION":
		*e = DataflowProjectsLocationsJobsGetViewEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DataflowProjectsLocationsJobsGetViewEnum: %v", v)
	}
}
