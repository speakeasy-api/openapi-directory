...
from ..shared import putlifecyclepolicyinput as shared_putlifecyclepolicyinput
...
class PutLifecyclePolicyRequest:
    ...
    request: shared_putlifecyclepolicyinput.PutLifecyclePolicyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class PutLifecyclePolicyResponse:
    ...
    put_lifecycle_policy_output: Optional[dict[str, Any]] = dataclasses.field(default=None)
