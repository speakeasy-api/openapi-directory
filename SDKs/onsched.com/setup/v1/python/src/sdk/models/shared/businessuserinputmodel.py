...
class BusinessUserInputModel:
    ...
    send_registration_invite: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sendRegistrationInvite'), 'exclude': lambda f: f is None }})  
