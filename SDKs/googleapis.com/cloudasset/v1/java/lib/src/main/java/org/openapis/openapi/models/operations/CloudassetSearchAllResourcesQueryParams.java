...
public class CloudassetSearchAllResourcesQueryParams {
    /**
     * V1 error format.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=$.xgafv")
    public org.openapis.openapi.models.shared.XgafvEnum dollarXgafv;
    public CloudassetSearchAllResourcesQueryParams withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public CloudassetSearchAllResourcesQueryParams withAccessToken(String accessToken) {
    ...
    public CloudassetSearchAllResourcesQueryParams withAlt(org.openapis.openapi.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
    ...
    public CloudassetSearchAllResourcesQueryParams withAssetTypes(String[] assetTypes) {
    ...
    public CloudassetSearchAllResourcesQueryParams withCallback(String callback) {
    ...
    public CloudassetSearchAllResourcesQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public String key;
    public CloudassetSearchAllResourcesQueryParams withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public CloudassetSearchAllResourcesQueryParams withOauthToken(String oauthToken) {
    ...
    public CloudassetSearchAllResourcesQueryParams withOrderBy(String orderBy) {
    ...
    public CloudassetSearchAllResourcesQueryParams withPageSize(Long pageSize) {
    ...
    public CloudassetSearchAllResourcesQueryParams withPageToken(String pageToken) {
    ...
    public CloudassetSearchAllResourcesQueryParams withPrettyPrint(Boolean prettyPrint) {
    ...
    public String query;
    public CloudassetSearchAllResourcesQueryParams withQuery(String query) {
        this.query = query;
        return this;
    }
    ...
    public CloudassetSearchAllResourcesQueryParams withQuotaUser(String quotaUser) {
    ...
    public CloudassetSearchAllResourcesQueryParams withReadMask(String readMask) {
    ...
    public CloudassetSearchAllResourcesQueryParams withUploadType(String uploadType) {
    ...
    public CloudassetSearchAllResourcesQueryParams withUploadProtocol(String uploadProtocol) {
