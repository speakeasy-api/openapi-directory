...
exports.FetchVerificationAttemptsSummaryResponse = exports.FetchVerificationAttemptsSummaryRequest = exports.FetchVerificationAttemptsSummarySecurity = exports.FetchVerificationAttemptsSummaryServerList = void 0;
...
var FetchVerificationAttemptsSummarySecurity = /** @class */ (function (_super) {
    ...
    ], FetchVerificationAttemptsSummarySecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], FetchVerificationAttemptsSummarySecurity.prototype, "username", void 0);
...
var FetchVerificationAttemptsSummaryRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], FetchVerificationAttemptsSummaryRequest.prototype, "channel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Country",
        }),
        __metadata("design:type", String)
    ], FetchVerificationAttemptsSummaryRequest.prototype, "country", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreatedAfter;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], FetchVerificationAttemptsSummaryRequest.prototype, "dateCreatedAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreatedBefore;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], FetchVerificationAttemptsSummaryRequest.prototype, "dateCreatedBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DestinationPrefix",
        }),
        __metadata("design:type", String)
    ], FetchVerificationAttemptsSummaryRequest.prototype, "destinationPrefix", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=VerifyServiceSid",
        }),
        __metadata("design:type", String)
    ], FetchVerificationAttemptsSummaryRequest.prototype, "verifyServiceSid", void 0);
...
var FetchVerificationAttemptsSummaryResponse = /** @class */ (function (_super) {
    ...
    ], FetchVerificationAttemptsSummaryResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
