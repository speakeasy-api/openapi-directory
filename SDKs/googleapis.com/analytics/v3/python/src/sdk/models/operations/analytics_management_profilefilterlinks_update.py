...
class AnalyticsManagementProfileFilterLinksUpdateRequest:
    ...
    profile_filter_link_input: Optional[shared_profilefilterlink.ProfileFilterLinkInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
