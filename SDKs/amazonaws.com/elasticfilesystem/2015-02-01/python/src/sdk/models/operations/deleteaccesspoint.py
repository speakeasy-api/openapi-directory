...
class DeleteAccessPointPathParams:
    access_point_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'AccessPointId', 'style': 'simple', 'explode': False }})
...
class DeleteAccessPointRequest:
    headers: DeleteAccessPointHeaders = dataclasses.field()
    path_params: DeleteAccessPointPathParams = dataclasses.field()
