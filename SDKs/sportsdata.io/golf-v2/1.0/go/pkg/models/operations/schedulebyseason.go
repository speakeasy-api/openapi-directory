...
func (e ScheduleBySeasonFormatEnum) ToPointer() *ScheduleBySeasonFormatEnum {
	return &e
}
...
func (e *ScheduleBySeasonFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = ScheduleBySeasonFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ScheduleBySeasonFormatEnum: %v", v)
	}
}
