 ...
 */
export class ListGatewaySecurityPolicyRulesResponse extends SpeakeasyBase {
  /**
   * List of GatewaySecurityPolicyRule resources.
   */
  @SpeakeasyMetadata({ elemType: GatewaySecurityPolicyRule })
  @Expose({ name: "gatewaySecurityPolicyRules" })
