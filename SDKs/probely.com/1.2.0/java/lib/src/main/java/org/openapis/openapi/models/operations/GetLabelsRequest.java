...
public class GetLabelsRequest {
    ...
    public Long length;
    public GetLabelsRequest withLength(Long length) {
        this.length = length;
        return this;
    }
    ...
    public GetLabelsRequest withOrdering(String ordering) {
    ...
    public Long page;
    public GetLabelsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetLabelsRequest withSearch(String search) {
        this.search = search;
        return this;
    }
