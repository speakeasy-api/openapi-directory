...
export class GetGenotypeDiseaseAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGenotypeDiseaseAssociationsQueryParams extends SpeakeasyBase {
