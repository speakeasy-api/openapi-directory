...
class CreateConversationRequest:
    ...
    request_body: Optional[CreateConversationCreateConversationRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
