...
public class BillingAccounts {
    ...
    **/
    public openapisdk.models.operations.BillingbudgetsBillingAccountsBudgetsCreateResponse billingbudgetsBillingAccountsBudgetsCreate(openapisdk.models.operations.BillingbudgetsBillingAccountsBudgetsCreateRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/{parent}/budgets", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GoogleCloudBillingBudgetsV1Budget out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GoogleCloudBillingBudgetsV1Budget.class);
    ...
    public openapisdk.models.operations.BillingbudgetsBillingAccountsBudgetsListResponse billingbudgetsBillingAccountsBudgetsList(openapisdk.models.operations.BillingbudgetsBillingAccountsBudgetsListRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GoogleCloudBillingBudgetsV1ListBudgetsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GoogleCloudBillingBudgetsV1ListBudgetsResponse.class);
