...
class PostTestNotificationConfigurationRequest:
    security: PostTestNotificationConfigurationSecurity = dataclasses.field()
...
class PostTestNotificationConfigurationResponse:
    ...
    test_notification_configuration_response: Optional[Any] = dataclasses.field(default=None)
