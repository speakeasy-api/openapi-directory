...
export class KeepNotesPermissionsBatchDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class KeepNotesPermissionsBatchDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class KeepNotesPermissionsBatchDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
