 ...
 */
public enum CreateTransitGatewayRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateTransitGatewayRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
