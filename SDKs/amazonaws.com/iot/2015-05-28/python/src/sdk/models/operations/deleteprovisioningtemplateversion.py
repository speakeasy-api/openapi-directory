...
class DeleteProvisioningTemplateVersionRequest:
    headers: DeleteProvisioningTemplateVersionHeaders = dataclasses.field()
    path_params: DeleteProvisioningTemplateVersionPathParams = dataclasses.field()
...
class DeleteProvisioningTemplateVersionResponse:
    ...
    delete_provisioning_template_version_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
