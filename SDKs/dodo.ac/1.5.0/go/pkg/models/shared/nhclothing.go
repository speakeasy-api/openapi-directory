...
func (e *NHClothingCategoryEnum) UnmarshalJSON(data []byte) error {
	...
	case "Bags":
		fallthrough
	case "Umbrellas":
		*e = NHClothingCategoryEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for NHClothingCategoryEnum: %s", s)
	}
}
...
func (e *NHClothingLabelThemesEnum) UnmarshalJSON(data []byte) error {
	...
	case "Vacation":
		fallthrough
	case "Work":
		*e = NHClothingLabelThemesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for NHClothingLabelThemesEnum: %s", s)
	}
}
...
func (e *NHClothingStylesEnum) UnmarshalJSON(data []byte) error {
	...
	case "Gorgeous":
		fallthrough
	case "Simple":
		*e = NHClothingStylesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for NHClothingStylesEnum: %s", s)
	}
}

// NHClothingVariationTotalEnum - The total number of variations the clothing has, between 0 and 8.
type NHClothingVariationTotalEnum string
...
func (e *NHClothingVariationTotalEnum) UnmarshalJSON(data []byte) error {
	...
	case "7":
		fallthrough
	case "8":
		*e = NHClothingVariationTotalEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for NHClothingVariationTotalEnum: %s", s)
	}
}
...
func (e *NHClothingVariationsColorsEnum) UnmarshalJSON(data []byte) error {
	...
	case "White":
		fallthrough
	case "Yellow":
		*e = NHClothingVariationsColorsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for NHClothingVariationsColorsEnum: %s", s)
	}
}
