...
export class SDK {
  ...
  **/
  playByPlay(
    ...
    const url: string = utils.generateURL(baseURL, "/{format}/PlayByPlay/{gameid}", req.pathParams);
  ...
  **/
  playByPlayDelta(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{format}/PlayByPlayDelta/{date}/{minutes}", req.pathParams);
