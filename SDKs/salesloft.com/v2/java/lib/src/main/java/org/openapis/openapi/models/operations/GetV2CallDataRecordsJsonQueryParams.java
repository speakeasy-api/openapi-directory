...
public class GetV2CallDataRecordsJsonQueryParams {
    /**
    ...
    public GetV2CallDataRecordsJsonQueryParams withCreatedAt(String[] createdAt) {
    ...
    public GetV2CallDataRecordsJsonQueryParams withHasCall(Boolean hasCall) {
    ...
    public Long[] ids;
    public GetV2CallDataRecordsJsonQueryParams withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2CallDataRecordsJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2CallDataRecordsJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public Long page;
    public GetV2CallDataRecordsJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2CallDataRecordsJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2CallDataRecordsJsonQueryParams withPersonId(Long[] personId) {
    ...
    public GetV2CallDataRecordsJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2CallDataRecordsJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public GetV2CallDataRecordsJsonQueryParams withUpdatedAt(String[] updatedAt) {
    ...
    public GetV2CallDataRecordsJsonQueryParams withUserGuid(String[] userGuid) {
