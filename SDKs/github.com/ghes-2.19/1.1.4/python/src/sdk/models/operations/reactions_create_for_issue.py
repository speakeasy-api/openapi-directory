...
class ReactionsCreateForIssueRequestBodyContentEnum(str, Enum):
    r"""The [reaction type](https://docs.github.com/enterprise-server@2.19/rest/reference/reactions#reaction-types) to add to the issue."""
    PLUS_1 = '+1'
    MINUS_1 = '-1'
    LAUGH = 'laugh'
    CONFUSED = 'confused'
...
class ReactionsCreateForIssueRequestBody:
    ...
    content: ReactionsCreateForIssueRequestBodyContentEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('content') }})
    r"""The [reaction type](https://docs.github.com/enterprise-server@2.19/rest/reference/reactions#reaction-types) to add to the issue."""  
...
class ReactionsCreateForIssueRequest:
    ...
    request_body: ReactionsCreateForIssueRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ReactionsCreateForIssueResponse:
    ...
    r"""Response"""  
    reactions_create_for_issue_415_application_json_object: Optional[ReactionsCreateForIssue415ApplicationJSON] = dataclasses.field(default=None)
    r"""Preview header missing"""  
