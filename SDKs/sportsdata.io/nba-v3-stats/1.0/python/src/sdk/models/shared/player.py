...
class Player:
    ...
    depth_chart_order: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DepthChartOrder'), 'exclude': lambda f: f is None }})  
    depth_chart_position: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DepthChartPosition'), 'exclude': lambda f: f is None }})  
    ...
    nba_dot_com_player_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('NbaDotComPlayerID'), 'exclude': lambda f: f is None }})  
