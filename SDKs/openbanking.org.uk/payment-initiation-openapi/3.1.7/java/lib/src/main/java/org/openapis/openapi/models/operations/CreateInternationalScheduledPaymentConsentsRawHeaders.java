...
public class CreateInternationalScheduledPaymentConsentsRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateInternationalScheduledPaymentConsentsRawHeaders withAuthorization(String authorization) {
    ...
    public CreateInternationalScheduledPaymentConsentsRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateInternationalScheduledPaymentConsentsRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateInternationalScheduledPaymentConsentsRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateInternationalScheduledPaymentConsentsRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateInternationalScheduledPaymentConsentsRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateInternationalScheduledPaymentConsentsRawHeaders withXJwsSignature(String xJwsSignature) {
