...
class ScheduledSplit:
    ...
    group_weights: Optional[dict[str, int]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('groupWeights'), 'exclude': lambda f: f is None }})  
