...
class ListDistributionConfigurationsResponse:
    ...
    distribution_configuration_summary_list: Optional[list[shared_distributionconfigurationsummary.DistributionConfigurationSummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('distributionConfigurationSummaryList'), 'exclude': lambda f: f is None }})  
