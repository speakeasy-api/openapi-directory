...
public class ListShortCodeListShortCodeResponse {
    ...
    public openapisdk.models.shared.ProxyV1ServiceShortCode[] shortCodes;
    public ListShortCodeListShortCodeResponse withShortCodes(openapisdk.models.shared.ProxyV1ServiceShortCode[] shortCodes) {
