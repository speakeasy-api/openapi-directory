...
class PostFloatingIpsIDActionsChangeProtectionChangeProtectionRequest:
    ...
    r"""If true, prevents the Floating IP from being deleted"""  
...
class PostFloatingIpsIDActionsChangeProtectionRequest:
    ...
    request_body: Optional[PostFloatingIpsIDActionsChangeProtectionChangeProtectionRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class PostFloatingIpsIDActionsChangeProtectionActionResponseAction:
    ...
    error: PostFloatingIpsIDActionsChangeProtectionActionResponseActionError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    r"""Error message for the Action if error occurred, otherwise null"""  
    ...
    resources: list[PostFloatingIpsIDActionsChangeProtectionActionResponseActionResources] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources') }})
    ...
    status: PostFloatingIpsIDActionsChangeProtectionActionResponseActionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Status of the Action"""  
...
class PostFloatingIpsIDActionsChangeProtectionActionResponse:
    ...
    action: PostFloatingIpsIDActionsChangeProtectionActionResponseAction = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action') }})  
