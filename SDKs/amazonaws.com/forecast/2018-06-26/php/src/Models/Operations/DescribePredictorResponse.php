...
class DescribePredictorResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\DescribePredictorResponse $describePredictorResponse
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\DescribePredictorResponse $describePredictorResponse = null;
	...
	{
		$this->contentType = "";
		$this->describePredictorResponse = null;
