...
public class CreateInternationalScheduledPaymentConsentsJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateInternationalScheduledPaymentConsentsJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateInternationalScheduledPaymentConsentsJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateInternationalScheduledPaymentConsentsJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateInternationalScheduledPaymentConsentsJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateInternationalScheduledPaymentConsentsJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateInternationalScheduledPaymentConsentsJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateInternationalScheduledPaymentConsentsJsonHeaders withXJwsSignature(String xJwsSignature) {
