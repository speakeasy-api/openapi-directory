...
func (e IdpProjectedPlayerGameStatsByWeekWInjuriesLineupsDfsSalariesFormatEnum) ToPointer() *IdpProjectedPlayerGameStatsByWeekWInjuriesLineupsDfsSalariesFormatEnum {
	return &e
}
...
func (e *IdpProjectedPlayerGameStatsByWeekWInjuriesLineupsDfsSalariesFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = IdpProjectedPlayerGameStatsByWeekWInjuriesLineupsDfsSalariesFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for IdpProjectedPlayerGameStatsByWeekWInjuriesLineupsDfsSalariesFormatEnum: %v", v)
	}
}
