...
class ApplicantsAddRequest:
    headers: ApplicantsAddHeaders = dataclasses.field()
    query_params: ApplicantsAddQueryParams = dataclasses.field()
    request: shared_applicant.ApplicantInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: ApplicantsAddSecurity = dataclasses.field()
