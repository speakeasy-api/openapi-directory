...
exports.SiteToSiteVpn = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var SiteToSiteVpn = /** @class */ (function () {
    function SiteToSiteVpn(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    SiteToSiteVpn.prototype.getNetworkApplianceVpnSiteToSiteVpn = function (req, config) {
     ...
     */
    SiteToSiteVpn.prototype.updateNetworkApplianceVpnSiteToSiteVpn = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.SiteToSiteVpn = SiteToSiteVpn;
