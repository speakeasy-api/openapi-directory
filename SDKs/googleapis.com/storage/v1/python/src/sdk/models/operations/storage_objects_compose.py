...
class StorageObjectsComposeQueryParams:
    ...
    destination_predefined_acl: Optional[StorageObjectsComposeDestinationPredefinedACLEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'destinationPredefinedAcl', 'style': 'form', 'explode': True }})
...
class StorageObjectsComposeSecurity:
    ...
    option3: Optional[StorageObjectsComposeSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
