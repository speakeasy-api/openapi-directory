...
try {
    ...
    $request->analysisId = 35362;
    $request->confirmDelete = 'porro';
    $request->owner = 'eum';
    $request->repo = 'quas';
...
try {
    ...
    $request->alertNumber = 325685;
    $request->owner = 'nisi';
    $request->page = 147014;
    $request->perPage = 956406;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\CodeScanningListAlertsForOrgRequest;
use \OpenAPI\OpenAPI\Models\Shared\DirectionEnum;
use \OpenAPI\OpenAPI\Models\Operations\CodeScanningListAlertsForOrgSortEnum;
...
try {
    $request = new CodeScanningListAlertsForOrgRequest();
    $request->after = 'explicabo';
    $request->before = 'saepe';
    $request->direction = DirectionEnum::DESC;
    $request->org = 'atque';
    $request->page = 92260;
    $request->perPage = 456911;
    $request->sort = CodeScanningListAlertsForOrgSortEnum::UPDATED;
    $request->state = CodeScanningAlertStateEnum::FIXED;
    $request->toolGuid = 'veritatis';
    $request->toolName = 'esse';

    $response = $sdk->codeScanning->codeScanningListAlertsForOrg($request);

    if ($response->codeScanningOrganizationAlertItems !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\Models\Shared\DirectionEnum;
use \OpenAPI\OpenAPI\Models\Operations\CodeScanningListAlertsForRepoSortEnum;
use \OpenAPI\OpenAPI\Models\Shared\CodeScanningAlertStateEnum;
...
try {
    ...
    $request->owner = 'nam';
    $request->page = 877131;
    $request->perPage = 399025;
    $request->ref = 'quasi';
    $request->repo = 'saepe';
    $request->sort = CodeScanningListAlertsForRepoSortEnum::CREATED;
    $request->state = CodeScanningAlertStateEnum::DISMISSED;
    $request->toolGuid = 'molestiae';
    $request->toolName = 'rerum';
...
try {
    ...
    $request->page = 327720;
    $request->perPage = 716244;
    $request->ref = 'eligendi';
    $request->repo = 'sit';
    $request->sarifId = '6c81cd8e-b078-4ac3-a3be-1dad7dbd0b53';
    $request->toolGuid = 'culpa';
    $request->toolName = 'tempore';
...
try {
    ...
    $request->requestBody->dismissedComment = 'adipisci';
    $request->requestBody->dismissedReason = CodeScanningAlertDismissedReasonEnum::USED_IN_TESTS;
    $request->requestBody->state = CodeScanningAlertSetStateEnum::OPEN;
    $request->alertNumber = 9766;
    $request->owner = 'minus';
...
try {
    ...
    $request->requestBody->commitSha = 'sapiente';
    $request->requestBody->ref = 'consectetur';
    $request->requestBody->sarif = 'esse';
    $request->requestBody->startedAt = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-10-26T13:57:26.455Z');
    $request->requestBody->toolName = 'a';
    $request->owner = 'nulla';
    $request->repo = 'quas';
