...
var Decision = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cancelTimerDecisionAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cancelWorkflowExecutionDecisionAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=completeWorkflowExecutionDecisionAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=continueAsNewWorkflowExecutionDecisionAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=decisionType" }),
        __metadata("design:type", String)
    ], Decision.prototype, "decisionType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=failWorkflowExecutionDecisionAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=recordMarkerDecisionAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=requestCancelActivityTaskDecisionAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=requestCancelExternalWorkflowExecutionDecisionAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=scheduleActivityTaskDecisionAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=scheduleLambdaFunctionDecisionAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=signalExternalWorkflowExecutionDecisionAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startChildWorkflowExecutionDecisionAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startTimerDecisionAttributes" }),
