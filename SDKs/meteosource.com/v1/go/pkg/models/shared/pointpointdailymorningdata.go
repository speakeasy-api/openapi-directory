...
type PointPointDailyMorningData struct {
	CloudCover PointPointDailyMorningCloudCoverData `json:"cloud_cover"`
	...
	Precipitation PointPointDailyMorningPrecipitationData `json:"precipitation"`
	// Atmospheric pressure at mean sea level. (morning avg)
	// Units: metric = hPa, us = Hg, uk = hPa, ca = kPa
	Pressure    *float64                       `json:"pressure,omitempty"`
	Probability PointPointDailyMorningProbData `json:"probability"`
	...
	Wind    PointPointDailyMorningWindData `json:"wind"`
	// Temperature 2 metres above ground. (morning avg)
	// Units: metric = °C, us = °F, uk = °C, ca = °C
