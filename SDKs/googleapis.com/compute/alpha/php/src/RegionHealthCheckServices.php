...
class RegionHealthCheckServices 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionHealthCheckServicesAggregatedListRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionHealthCheckServicesAggregatedListSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeRegionHealthCheckServicesAggregatedListResponse
     */
	public function computeRegionHealthCheckServicesAggregatedList(
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionHealthCheckServicesAggregatedListRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionHealthCheckServicesAggregatedListSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeRegionHealthCheckServicesAggregatedListResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/aggregated/healthCheckServices', \OpenAPI\OpenAPI\Models\Operations\ComputeRegionHealthCheckServicesAggregatedListRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeRegionHealthCheckServicesAggregatedListRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeRegionHealthCheckServicesAggregatedListResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->healthCheckServiceAggregatedList = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\HealthCheckServiceAggregatedList', 'json');
            }
        }
