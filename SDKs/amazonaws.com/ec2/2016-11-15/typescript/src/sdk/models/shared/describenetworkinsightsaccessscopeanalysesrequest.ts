 ...
 */
export class DescribeNetworkInsightsAccessScopeAnalysesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeNetworkInsightsAccessScopeAnalysesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
