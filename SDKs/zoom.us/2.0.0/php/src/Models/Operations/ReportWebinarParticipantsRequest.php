...
class ReportWebinarParticipantsRequest
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ReportWebinarParticipantsIncludeFieldsEnum $includeFields
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=include_fields')]
    public ?ReportWebinarParticipantsIncludeFieldsEnum $includeFields = null;
