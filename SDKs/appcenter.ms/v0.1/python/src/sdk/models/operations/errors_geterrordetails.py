...
class ErrorsGetErrorDetailsSecurity:
    
    api_token: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'X-API-Token' }})  
    

@dataclasses.dataclass
class ErrorsGetErrorDetailsRequest:
...
class ErrorsGetErrorDetailsDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
class ErrorsGetErrorDetailsDefaultApplicationJSONError:
    ...
    code: ErrorsGetErrorDetailsDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
...
class ErrorsGetErrorDetailsDefaultApplicationJSON:
    ...
    error: ErrorsGetErrorDetailsDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
    
class ErrorsGetErrorDetails200ApplicationJSONReasonFramesLanguageEnum(str, Enum):
...
class ErrorsGetErrorDetails200ApplicationJSONReasonFrames:
    ...
    language: Optional[ErrorsGetErrorDetails200ApplicationJSONReasonFramesLanguageEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('language'), 'exclude': lambda f: f is None }})
    r"""programming language of the frame"""  
...
class ErrorsGetErrorDetails200ApplicationJSON:
    ...
    reason_frames: Optional[list[ErrorsGetErrorDetails200ApplicationJSONReasonFrames]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reasonFrames'), 'exclude': lambda f: f is None }})  
...
class ErrorsGetErrorDetailsResponse:
    ...
    errors_get_error_details_200_application_json_object: Optional[ErrorsGetErrorDetails200ApplicationJSON] = dataclasses.field(default=None)
    r"""Error details."""  
    errors_get_error_details_default_application_json_object: Optional[ErrorsGetErrorDetailsDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error code with reason"""  
