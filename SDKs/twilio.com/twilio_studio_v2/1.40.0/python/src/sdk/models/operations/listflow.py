...
class ListFlowListFlowResponse:
    ...
    flows: Optional[list[shared_studio_v2_flow.StudioV2Flow]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flows'), 'exclude': lambda f: f is None }})  
