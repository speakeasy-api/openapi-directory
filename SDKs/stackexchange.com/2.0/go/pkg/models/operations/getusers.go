...
func (e GetUsersOrderEnum) ToPointer() *GetUsersOrderEnum {
	return &e
}

func (e *GetUsersOrderEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "desc":
		fallthrough
	case "asc":
		*e = GetUsersOrderEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersOrderEnum: %v", v)
	}
}
...
func (e GetUsersSortEnum) ToPointer() *GetUsersSortEnum {
	return &e
}

func (e *GetUsersSortEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "name":
		fallthrough
	case "modified":
		*e = GetUsersSortEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersSortEnum: %v", v)
	}
}
