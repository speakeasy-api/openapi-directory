...
from ..shared import flex_v1_insights_conversations as shared_flex_v1_insights_conversations
from dataclasses_json import Undefined, dataclass_json
from sdk import utils
from typing import Optional

LIST_INSIGHTS_CONVERSATIONS_SERVERS = [
	"https://flex-api.twilio.com",
]


@dataclasses.dataclass
class ListInsightsConversationsSecurity:
...
@dataclasses.dataclass
class ListInsightsConversationsRequest:
    ...
    r"""Unique Id of the segment for which conversation details needs to be fetched"""  
...
@dataclasses.dataclass
class ListInsightsConversationsListInsightsConversationsResponseMeta:
...
class ListInsightsConversationsListInsightsConversationsResponse:
    ...
    conversations: Optional[list[shared_flex_v1_insights_conversations.FlexV1InsightsConversations]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conversations'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListInsightsConversationsListInsightsConversationsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
...
class ListInsightsConversationsResponse:
    ...
    list_insights_conversations_response: Optional[ListInsightsConversationsListInsightsConversationsResponse] = dataclasses.field(default=None)
    r"""OK"""  
