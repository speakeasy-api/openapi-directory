...
exports.GetPayoutsForPayorV3Response = exports.GetPayoutsForPayorV3Request = exports.GetPayoutsForPayorV3StatusEnum = void 0;
...
var GetPayoutsForPayorV3Request = /** @class */ (function (_super) {
    ...
    ], GetPayoutsForPayorV3Request.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageSize",
        }),
        __metadata("design:type", Number)
    ], GetPayoutsForPayorV3Request.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=payorId",
        }),
        __metadata("design:type", String)
    ], GetPayoutsForPayorV3Request.prototype, "payorId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=payoutMemo",
        }),
        __metadata("design:type", String)
    ], GetPayoutsForPayorV3Request.prototype, "payoutMemo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetPayoutsForPayorV3Request.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], GetPayoutsForPayorV3Request.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=submittedDateFrom;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetPayoutsForPayorV3Request.prototype, "submittedDateFrom", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=submittedDateTo;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetPayoutsForPayorV3Request.prototype, "submittedDateTo", void 0);
...
var GetPayoutsForPayorV3Response = /** @class */ (function (_super) {
    ...
    ], GetPayoutsForPayorV3Response.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
