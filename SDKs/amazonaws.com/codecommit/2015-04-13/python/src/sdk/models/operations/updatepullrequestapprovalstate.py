...
class UpdatePullRequestApprovalStateRequest:
    headers: UpdatePullRequestApprovalStateHeaders = dataclasses.field()
    request: shared_updatepullrequestapprovalstateinput.UpdatePullRequestApprovalStateInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
