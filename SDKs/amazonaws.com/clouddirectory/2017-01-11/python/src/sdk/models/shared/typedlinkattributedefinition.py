...
class TypedLinkAttributeDefinition:
    r"""A typed link attribute definition."""
    
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Name') }})  
    required_behavior: shared_requiredattributebehavior_enum.RequiredAttributeBehaviorEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RequiredBehavior') }})  
