...
import dataclasses
from ..shared import filevo as shared_filevo
...
class FileListResponseVO:
    r"""Java type: com.noosh.nooshapi.vo.file.FileListResponseVO"""
    
    result: Optional[list[shared_filevo.FileVO]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})  
