...
class DfareportingBillingAssignmentsInsertRequest:
    ...
    r"""Billing profile ID of this billing assignment."""  
    ...
    billing_assignment: Optional[shared_billingassignment.BillingAssignment] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
