...
class HttpHealthChecks 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeHttpHealthChecksTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeHttpHealthChecksTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeHttpHealthChecksTestIamPermissionsResponse
     */
	public function computeHttpHealthChecksTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeHttpHealthChecksTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeHttpHealthChecksTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeHttpHealthChecksTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/httpHealthChecks/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeHttpHealthChecksTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeHttpHealthChecksTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeHttpHealthChecksTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
