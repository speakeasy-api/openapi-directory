...
var Settings = /** @class */ (function () {
    ...
    Settings.prototype.deleteWebhooksV3AppIdSettingsClear = function (req, config) {
    ...
    Settings.prototype.getWebhooksV3AppIdSettingsGetAll = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    Settings.prototype.putWebhooksV3AppIdSettingsConfigure = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
