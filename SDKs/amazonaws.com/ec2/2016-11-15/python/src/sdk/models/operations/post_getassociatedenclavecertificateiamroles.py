...
class PostGetAssociatedEnclaveCertificateIamRolesQueryParams:
    action: PostGetAssociatedEnclaveCertificateIamRolesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetAssociatedEnclaveCertificateIamRolesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetAssociatedEnclaveCertificateIamRolesRequest:
    headers: PostGetAssociatedEnclaveCertificateIamRolesHeaders = dataclasses.field()
    query_params: PostGetAssociatedEnclaveCertificateIamRolesQueryParams = dataclasses.field()
