...
class RequestCancelActivityTaskFailedEventAttributes:
    r"""Provides the details of the <code>RequestCancelActivityTaskFailed</code> event."""
    
    activity_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('activityId') }})  
    cause: shared_requestcancelactivitytaskfailedcause_enum.RequestCancelActivityTaskFailedCauseEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cause') }})  
