...
export class DeleteIndividualsPartyIdLicensesProductIdRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class DeleteIndividualsPartyIdLicensesProductIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
