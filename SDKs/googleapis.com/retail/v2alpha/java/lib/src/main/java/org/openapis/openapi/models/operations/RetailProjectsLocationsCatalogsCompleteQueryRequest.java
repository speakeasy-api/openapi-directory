...
public class RetailProjectsLocationsCatalogsCompleteQueryRequest {
    ...
    public RetailProjectsLocationsCatalogsCompleteQueryRequest withBanner(String banner) {
        this.banner = banner;
        return this;
    }
    ...
    public RetailProjectsLocationsCatalogsCompleteQueryRequest withEnableAttributeSuggestions(Boolean enableAttributeSuggestions) {
