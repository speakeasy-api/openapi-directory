...
public class GetConnectorResourceResponse {
    ...
    public GetConnectorResourceResponse(@JsonProperty("data") ConnectorResource data, @JsonProperty("status") String status, @JsonProperty("status_code") Long statusCode) {
        this.data = data;
        this.status = status;
        this.statusCode = statusCode;
  }
