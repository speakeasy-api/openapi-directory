...
public class ContainerProjectsZonesClustersResourceLabelsPathParams {
    /**
    ...
    public ContainerProjectsZonesClustersResourceLabelsPathParams withClusterId(String clusterId) {
    ...
    public ContainerProjectsZonesClustersResourceLabelsPathParams withProjectId(String projectId) {
    ...
    public String zone;
    public ContainerProjectsZonesClustersResourceLabelsPathParams withZone(String zone) {
        this.zone = zone;
        return this;
    }
