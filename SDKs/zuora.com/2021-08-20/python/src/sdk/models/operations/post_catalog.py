...
class POSTCatalogRequest:
    ...
    post_catalog_type: shared_postcatalogtype.POSTCatalogType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    product_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'product-id', 'style': 'simple', 'explode': False }})
    r"""The unique ID of the product you want to share. For example, 8a808255575bdae4015774e9602e16fe."""  
