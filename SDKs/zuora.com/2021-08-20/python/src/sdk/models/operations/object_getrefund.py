...
from ..shared import proxygetrefund as shared_proxygetrefund
...
class ObjectGETRefundResponse:
    ...
    proxy_get_refund: Optional[shared_proxygetrefund.ProxyGetRefund] = dataclasses.field(default=None)  
