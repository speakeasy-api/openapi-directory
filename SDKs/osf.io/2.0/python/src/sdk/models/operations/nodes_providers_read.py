...
@dataclasses.dataclass
class NodesProvidersReadFileLinks:
...
class NodesProvidersReadFile:
    ...
    attributes: Optional[NodesProvidersReadFileAttributes] = dataclasses.field(default=None)
    r"""The properties of the file entity."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The identifier of the file entity."""  
    links: Optional[NodesProvidersReadFileLinks] = dataclasses.field(default=None)
    r"""Links to alternative representations of the file entity."""  
    relationships: Optional[NodesProvidersReadFileRelationships] = dataclasses.field(default=None)
    r"""Links to other entities or entity collections that have a relationship to the file entity."""  
