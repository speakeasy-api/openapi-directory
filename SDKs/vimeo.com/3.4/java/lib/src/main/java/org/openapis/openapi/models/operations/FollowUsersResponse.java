...
public class FollowUsersResponse {
    ...
    public FollowUsersResponse withStatusCode(Integer statusCode) {
    ...
    public FollowUsersResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public FollowUsersResponse withError(org.openapis.openapi.models.shared.Error error) {
        this.error = error;
        return this;
    }
