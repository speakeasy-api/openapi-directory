...
type RegistrationsChildrenListRegistrationAttributesCategoryEnum string

const (
	RegistrationsChildrenListRegistrationAttributesCategoryEnumAnalysis           RegistrationsChildrenListRegistrationAttributesCategoryEnum = "analysis"
	RegistrationsChildrenListRegistrationAttributesCategoryEnumCommunication      RegistrationsChildrenListRegistrationAttributesCategoryEnum = "communication"
	RegistrationsChildrenListRegistrationAttributesCategoryEnumData               RegistrationsChildrenListRegistrationAttributesCategoryEnum = "data"
	RegistrationsChildrenListRegistrationAttributesCategoryEnumHypothesis         RegistrationsChildrenListRegistrationAttributesCategoryEnum = "hypothesis"
	RegistrationsChildrenListRegistrationAttributesCategoryEnumInstrumentation    RegistrationsChildrenListRegistrationAttributesCategoryEnum = "instrumentation"
	RegistrationsChildrenListRegistrationAttributesCategoryEnumMethodsAndMeasures RegistrationsChildrenListRegistrationAttributesCategoryEnum = "methods and measures"
	RegistrationsChildrenListRegistrationAttributesCategoryEnumProcedure          RegistrationsChildrenListRegistrationAttributesCategoryEnum = "procedure"
	RegistrationsChildrenListRegistrationAttributesCategoryEnumProject            RegistrationsChildrenListRegistrationAttributesCategoryEnum = "project"
	RegistrationsChildrenListRegistrationAttributesCategoryEnumSoftware           RegistrationsChildrenListRegistrationAttributesCategoryEnum = "software"
	RegistrationsChildrenListRegistrationAttributesCategoryEnumOther              RegistrationsChildrenListRegistrationAttributesCategoryEnum = "other"
)

func (e RegistrationsChildrenListRegistrationAttributesCategoryEnum) ToPointer() *RegistrationsChildrenListRegistrationAttributesCategoryEnum {
	return &e
}

func (e *RegistrationsChildrenListRegistrationAttributesCategoryEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "software":
		fallthrough
	case "other":
		*e = RegistrationsChildrenListRegistrationAttributesCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RegistrationsChildrenListRegistrationAttributesCategoryEnum: %v", v)
	}
}

// RegistrationsChildrenListRegistrationAttributes - The properties of the registration entity.
type RegistrationsChildrenListRegistrationAttributes struct {
...
type RegistrationsChildrenListRegistrationLinks struct {
...
type RegistrationsChildrenListRegistrationRelationships struct {
...
type RegistrationsChildrenListRegistration struct {
