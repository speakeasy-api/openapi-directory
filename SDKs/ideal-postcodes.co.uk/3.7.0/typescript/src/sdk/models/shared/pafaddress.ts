...
export enum PafAddressCountryEnum {
  England = "England",
  Scotland = "Scotland",
  Wales = "Wales",
...
export enum PafAddressCountryIsoEnum {
  Gbr = "GBR",
  Imn = "IMN",
  Jey = "JEY",
  Ggy = "GGY",
...
export enum PafAddressCountryIso2Enum {
  Gb = "GB",
  Im = "IM",
  Je = "JE",
  Gg = "GG",
...
export enum PafAddressDatasetEnum {
  Paf = "paf",
}

export enum PafAddressLanguageEnum {
  En = "en",
}
 ...
 */
export class PafAddress extends SpeakeasyBase {
  /**
