...
export class ComputeRegionCommitmentsUpdateSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ComputeRegionCommitmentsUpdateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ComputeRegionCommitmentsUpdateSecurity extends SpeakeasyBase {
...
export class ComputeRegionCommitmentsUpdateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ComputeRegionCommitmentsUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
