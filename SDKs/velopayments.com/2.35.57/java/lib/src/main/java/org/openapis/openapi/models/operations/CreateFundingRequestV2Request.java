...
public class CreateFundingRequestV2Request {
    ...
    public CreateFundingRequestV2Request(@JsonProperty("FundingRequestV2") org.openapis.openapi.models.shared.FundingRequestV2 fundingRequestV2, @JsonProperty("sourceAccountId") String sourceAccountId) {
        this.fundingRequestV2 = fundingRequestV2;
        this.sourceAccountId = sourceAccountId;
  }
}
