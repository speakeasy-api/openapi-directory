...
public class Meeting200ApplicationXMLSettingsLanguageInterpretationInterpreters {
    /**
     * Email address of the interpreter.
     */
    
    public String email;
    public Meeting200ApplicationXMLSettingsLanguageInterpretationInterpreters withEmail(String email) {
        this.email = email;
        return this;
    }
    ...
    public Meeting200ApplicationXMLSettingsLanguageInterpretationInterpreters withLanguages(String languages) {
