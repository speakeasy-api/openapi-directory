...
export class CurrentUser extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "email_message_delay" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "email_post_reminders" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "email_posts_frequency" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "email_search_alerts" })
  emailSearchAlerts?: boolean;

  @SpeakeasyMetadata()
  @Expose({ name: "feedback" })
  @Type(() => CurrentUserFeedback)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "profile_image_source" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "public_post_sources" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "show_all_group_posts" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "uses_fair_offer_policy" })
