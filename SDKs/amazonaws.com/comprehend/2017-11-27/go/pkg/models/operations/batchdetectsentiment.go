...
func (e BatchDetectSentimentXAmzTargetEnum) ToPointer() *BatchDetectSentimentXAmzTargetEnum {
	return &e
}
...
func (e *BatchDetectSentimentXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "Comprehend_20171127.BatchDetectSentiment":
		*e = BatchDetectSentimentXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for BatchDetectSentimentXAmzTargetEnum: %v", v)
	}
}
