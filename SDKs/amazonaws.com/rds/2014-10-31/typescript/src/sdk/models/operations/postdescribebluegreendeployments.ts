...
export enum POSTDescribeBlueGreenDeploymentsActionEnum {
  DescribeBlueGreenDeployments = "DescribeBlueGreenDeployments",
}

export enum POSTDescribeBlueGreenDeploymentsVersionEnum {
  TwoThousandAndFourteen1031 = "2014-10-31",
}

export class POSTDescribeBlueGreenDeploymentsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class POSTDescribeBlueGreenDeploymentsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
