...
public class GetPaymentCancellationScaStatusPathParams {
    /**
     * Resource identification of the related SCA.
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=authorisationId")
    public String authorisationId;
    public GetPaymentCancellationScaStatusPathParams withAuthorisationId(String authorisationId) {
    ...
    public GetPaymentCancellationScaStatusPathParams withPaymentProduct(org.openapis.openapi.models.shared.PaymentProductEnum paymentProduct) {
    ...
    public GetPaymentCancellationScaStatusPathParams withPaymentService(org.openapis.openapi.models.shared.PaymentServiceEnum paymentService) {
    ...
    public GetPaymentCancellationScaStatusPathParams withPaymentId(String paymentId) {
