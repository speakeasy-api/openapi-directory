 ...
 *
 */
export enum GETDebitMemoTypeStatusEnum {
  Draft = "Draft",
  Posted = "Posted",
  Canceled = "Canceled",
  Error = "Error",
 ...
 *
 */
export enum GETDebitMemoTypeTaxStatusEnum {
  Complete = "Complete",
  Error = "Error",
}
 ...
 *
 */
export enum GETDebitMemoTypeTransferredToAccountingEnum {
 ...
 *
 */
export class GETDebitMemoType extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "status" })
  status?: GETDebitMemoTypeStatusEnum;
  ...
  taxStatus?: GETDebitMemoTypeTaxStatusEnum;
  ...
  transferredToAccounting?: GETDebitMemoTypeTransferredToAccountingEnum;
