...
class Drives 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DriveDrivesCreateRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\DriveDrivesCreateSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\DriveDrivesCreateResponse
     */
	public function driveDrivesCreate(
        \OpenAPI\OpenAPI\Models\Operations\DriveDrivesCreateRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\DriveDrivesCreateSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\DriveDrivesCreateResponse
    {
        ...
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DriveDrivesCreateRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DriveDrivesCreateResponse();
