...
import dataclasses
from ..shared import storagelocation as shared_storagelocation
from enum import Enum
from typing import Optional

class CreateFpgaImageRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateFpgaImageRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateFpgaImageRequestTagSpecifications:
    ...
    resource_type: Optional[CreateFpgaImageRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateFpgaImageRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateFpgaImageRequest:
    
    input_storage_location: shared_storagelocation.StorageLocation = dataclasses.field()  
    client_token: Optional[str] = dataclasses.field(default=None)  
    description: Optional[str] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    logs_storage_location: Optional[shared_storagelocation.StorageLocation] = dataclasses.field(default=None)  
    name: Optional[str] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateFpgaImageRequestTagSpecifications]] = dataclasses.field(default=None)  
