...
class ChecksCreateSuiteRequest:
    ...
    request_body: Optional[ChecksCreateSuiteRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class ChecksCreateSuiteResponse:
    ...
    r"""when the suite already existed"""  
