...
class GetRepositoriesWorkspaceRepoSlugEffectiveBranchingModelSecurity:
...
@dataclasses.dataclass
class GetRepositoriesWorkspaceRepoSlugEffectiveBranchingModelRequest:
...
class GetRepositoriesWorkspaceRepoSlugEffectiveBranchingModelResponse:
    ...
    effective_repo_branching_model: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""The effective branching model object"""  
