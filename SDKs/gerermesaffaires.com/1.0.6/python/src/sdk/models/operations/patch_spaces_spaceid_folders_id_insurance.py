...
class PatchSpacesSpaceIDFoldersIDInsuranceRequestBodyLevelEnum(str, Enum):
...
class PatchSpacesSpaceIDFoldersIDInsuranceRequestBody:
    r"""Insurance to modify (except name, class and archivaldate)"""
    ...
    level: Optional[PatchSpacesSpaceIDFoldersIDInsuranceRequestBodyLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Level'), 'exclude': lambda f: f is None }})  
...
@dataclasses.dataclass
class PatchSpacesSpaceIDFoldersIDInsuranceRequest:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""Id of the folder"""  
    request_body: PatchSpacesSpaceIDFoldersIDInsuranceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Insurance to modify (except name, class and archivaldate)"""  
...
@dataclasses.dataclass
class PatchSpacesSpaceIDFoldersIDInsuranceResponse:
