...
from ..shared import api_v2010_account_available_phone_number_country_available_phone_number_national as shared_api_v2010_account_available_phone_number_country_available_phone_number_national
...
class ListAvailablePhoneNumberNationalRequest:
    path_params: ListAvailablePhoneNumberNationalPathParams = dataclasses.field()
    query_params: ListAvailablePhoneNumberNationalQueryParams = dataclasses.field()
    security: ListAvailablePhoneNumberNationalSecurity = dataclasses.field()
...
class ListAvailablePhoneNumberNationalResponse:
    ...
    list_available_phone_number_national_response: Optional[ListAvailablePhoneNumberNationalListAvailablePhoneNumberNationalResponse] = dataclasses.field(default=None)
