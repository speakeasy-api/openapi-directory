...
class GetNetworkWirelessClientsLatencyStatsPathParams:
    network_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'networkId', 'style': 'simple', 'explode': False }})
    
class GetNetworkWirelessClientsLatencyStatsBandEnum(str, Enum):
    TWO_4 = "2.4"
    FIVE = "5"


@dataclasses.dataclass
class GetNetworkWirelessClientsLatencyStatsQueryParams:
    ap_tag: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'apTag', 'style': 'form', 'explode': True }})
    band: Optional[GetNetworkWirelessClientsLatencyStatsBandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'band', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class GetNetworkWirelessClientsLatencyStatsRequest:
    path_params: GetNetworkWirelessClientsLatencyStatsPathParams = dataclasses.field()
    query_params: GetNetworkWirelessClientsLatencyStatsQueryParams = dataclasses.field()
...
class GetNetworkWirelessClientsLatencyStatsResponse:
    ...
    get_network_wireless_clients_latency_stats_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
