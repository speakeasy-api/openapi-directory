...
class ActivityListEventsForAuthenticatedUserRequest:
    path_params: ActivityListEventsForAuthenticatedUserPathParams = dataclasses.field()
    query_params: ActivityListEventsForAuthenticatedUserQueryParams = dataclasses.field()
