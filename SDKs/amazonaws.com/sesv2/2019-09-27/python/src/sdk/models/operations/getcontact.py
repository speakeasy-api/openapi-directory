...
from ..shared import getcontactresponse as shared_getcontactresponse
...
class GetContactRequest:
    headers: GetContactHeaders = dataclasses.field()
...
class GetContactResponse:
    ...
    get_contact_response: Optional[shared_getcontactresponse.GetContactResponse] = dataclasses.field(default=None)
