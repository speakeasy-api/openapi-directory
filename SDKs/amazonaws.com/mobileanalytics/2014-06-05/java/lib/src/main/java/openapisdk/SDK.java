...
/** SDK Documentation: https://docs.aws.amazon.com/mobileanalytics/ - Amazon Web Services documentation**/
public class SDK {
    ...
    **/
    public openapisdk.models.operations.PutEventsResponse putEvents(openapisdk.models.operations.PutEventsRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/2014-06-05/events#x-amz-Client-Context");
