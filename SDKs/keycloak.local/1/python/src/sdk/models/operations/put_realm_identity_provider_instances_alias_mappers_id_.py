...
class PutRealmIdentityProviderInstancesAliasMappersIDRequest:
    ...
    r"""Mapper id"""  
    identity_provider_mapper_representation: shared_identityprovidermapperrepresentation.IdentityProviderMapperRepresentation = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
