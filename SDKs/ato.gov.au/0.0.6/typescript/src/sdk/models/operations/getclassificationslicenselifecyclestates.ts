...
export class GetClassificationsLicenseLifecycleStatesRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class GetClassificationsLicenseLifecycleStatesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: shared.LicenseLifecycleState })
