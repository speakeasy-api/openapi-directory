...
class ListServiceListServiceResponse:
    ...
    services: Optional[list[shared_proxy_v1_service.ProxyV1Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('services') }})
