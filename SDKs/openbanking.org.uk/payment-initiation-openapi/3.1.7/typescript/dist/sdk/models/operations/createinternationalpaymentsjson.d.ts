...
export declare class CreateInternationalPaymentsJsonSecurity extends SpeakeasyBase {
    psuoAuth2Security: string;
}
export declare class CreateInternationalPaymentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateInternationalPaymentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
