...
public class FirebaseappcheckProjectsAppsPlayIntegrityConfigBatchGetPathParams {
    /**
    ...
    public FirebaseappcheckProjectsAppsPlayIntegrityConfigBatchGetPathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
