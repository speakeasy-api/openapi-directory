...
class PutRepositoryCatalogDataRequest:
    ...
    put_repository_catalog_data_request: shared_putrepositorycatalogdatarequest.PutRepositoryCatalogDataRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
