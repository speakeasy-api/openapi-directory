 ...
 */
export declare class DescribeMovingAddressesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeMovingAddressesRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeMovingAddressesRequestFilters[];
    maxResults?: number;
    nextToken?: string;
    publicIps?: string[];
}
