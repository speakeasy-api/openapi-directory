...
public class SearchPostsQueryParams {
    /**
    ...
    public SearchPostsQueryParams withDateMax(OffsetDateTime dateMax) {
    ...
    public SearchPostsQueryParams withDateMin(OffsetDateTime dateMin) {
    ...
    public SearchPostsQueryParams withDevicePixelRatio(Double devicePixelRatio) {
    ...
    public SearchPostsQueryParams withGroupIds(String groupIds) {
    ...
    public SearchPostsQueryParams withIncludeReposts(Long includeReposts) {
    ...
    public SearchPostsQueryParams withLatitude(Double latitude) {
    ...
    public SearchPostsQueryParams withLongitude(Double longitude) {
    ...
    public SearchPostsQueryParams withOutcomes(String outcomes) {
    ...
    public Long page;
    public SearchPostsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public SearchPostsQueryParams withPerPage(Long perPage) {
    ...
    public SearchPostsQueryParams withRadius(Double radius) {
        this.radius = radius;
        return this;
    }
    ...
    public SearchPostsQueryParams withSearch(String search) {
        this.search = search;
        return this;
    }
    ...
    public SearchPostsQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public SearchPostsQueryParams withSources(String sources) {
    ...
    public String types;
    public SearchPostsQueryParams withTypes(String types) {
        this.types = types;
        return this;
    }
    ...
    public SearchPostsQueryParams withUserState(String userState) {
