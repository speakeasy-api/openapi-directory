...
class StartPHIDetectionJobRequest:
    ...
    start_phi_detection_job_request: shared_startphidetectionjobrequest.StartPHIDetectionJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
