 ...
 */
public class UpdateOrganizationLoginSecurity200ApplicationJSON {
    /**
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSON withAccountLockoutAttempts(Long accountLockoutAttempts) {
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSONApiAuthentication apiAuthentication;

    public UpdateOrganizationLoginSecurity200ApplicationJSON withApiAuthentication(UpdateOrganizationLoginSecurity200ApplicationJSONApiAuthentication apiAuthentication) {
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSON withEnforceAccountLockout(Boolean enforceAccountLockout) {
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSON withEnforceDifferentPasswords(Boolean enforceDifferentPasswords) {
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSON withEnforceIdleTimeout(Boolean enforceIdleTimeout) {
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSON withEnforceLoginIpRanges(Boolean enforceLoginIpRanges) {
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSON withEnforcePasswordExpiration(Boolean enforcePasswordExpiration) {
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSON withEnforceStrongPasswords(Boolean enforceStrongPasswords) {
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSON withEnforceTwoFactorAuth(Boolean enforceTwoFactorAuth) {
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSON withIdleTimeoutMinutes(Long idleTimeoutMinutes) {
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSON withLoginIpRanges(String[] loginIpRanges) {
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSON withNumDifferentPasswords(Long numDifferentPasswords) {
    ...
    public UpdateOrganizationLoginSecurity200ApplicationJSON withPasswordExpirationDays(Long passwordExpirationDays) {
        this.passwordExpirationDays = passwordExpirationDays;
        return this;
    }
    
    public UpdateOrganizationLoginSecurity200ApplicationJSON(){}
}
