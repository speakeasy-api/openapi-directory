...
func (e GETRebuildEnvironmentActionEnum) ToPointer() *GETRebuildEnvironmentActionEnum {
	return &e
}
...
func (e *GETRebuildEnvironmentActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "RebuildEnvironment":
		*e = GETRebuildEnvironmentActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETRebuildEnvironmentActionEnum: %v", v)
	}
}
...
func (e GETRebuildEnvironmentVersionEnum) ToPointer() *GETRebuildEnvironmentVersionEnum {
	return &e
}
...
func (e *GETRebuildEnvironmentVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2010-12-01":
		*e = GETRebuildEnvironmentVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETRebuildEnvironmentVersionEnum: %v", v)
	}
}
