...
var ListSupportingDocumentListSupportingDocumentResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.TrusthubV1SupportingDocument }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return shared.TrusthubV1SupportingDocument; }),
