...
class BaremetalsolutionOperationsListRequest:
    path_params: BaremetalsolutionOperationsListPathParams = dataclasses.field()
    query_params: BaremetalsolutionOperationsListQueryParams = dataclasses.field()
    security: BaremetalsolutionOperationsListSecurity = dataclasses.field()
