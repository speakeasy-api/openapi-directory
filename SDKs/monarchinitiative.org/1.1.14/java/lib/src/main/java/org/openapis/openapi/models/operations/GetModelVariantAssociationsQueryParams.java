...
public class GetModelVariantAssociationsQueryParams {
    /**
    ...
    public GetModelVariantAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetModelVariantAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetModelVariantAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetModelVariantAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetModelVariantAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetModelVariantAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetModelVariantAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public String q;
    public GetModelVariantAssociationsQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetModelVariantAssociationsQueryParams withRelation(String relation) {
    ...
    public Long rows;
    public GetModelVariantAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetModelVariantAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public String sort;
    public GetModelVariantAssociationsQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetModelVariantAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetModelVariantAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetModelVariantAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetModelVariantAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
