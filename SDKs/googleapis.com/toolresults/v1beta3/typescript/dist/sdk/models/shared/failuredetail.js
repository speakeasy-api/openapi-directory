...
var FailureDetail = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "deviceOutOfMemory" }),
        __metadata("design:type", Boolean)
    ], FailureDetail.prototype, "deviceOutOfMemory", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "failedRoboscript" }),
        __metadata("design:type", Boolean)
    ], FailureDetail.prototype, "failedRoboscript", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "notInstalled" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "unableToCrawl" }),
        __metadata("design:type", Boolean)
