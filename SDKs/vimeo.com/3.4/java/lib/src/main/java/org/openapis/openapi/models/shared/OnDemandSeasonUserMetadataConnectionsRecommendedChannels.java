 ...
 */
public class OnDemandSeasonUserMetadataConnectionsRecommendedChannels {
    /**
     * An array of HTTP methods permitted on this URI. This data requires a bearer token with the `private` scope.
     */
    @JsonProperty("options")
    public String[] options;
    public OnDemandSeasonUserMetadataConnectionsRecommendedChannels withOptions(String[] options) {
    ...
    @JsonProperty("total")
    public Double total;
    public OnDemandSeasonUserMetadataConnectionsRecommendedChannels withTotal(Double total) {
        this.total = total;
        return this;
    }
    ...
    @JsonProperty("uri")
    public String uri;
    public OnDemandSeasonUserMetadataConnectionsRecommendedChannels withUri(String uri) {
        this.uri = uri;
        return this;
    }
