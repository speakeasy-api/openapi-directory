...
class DisruptionsGetDisruptionsByStopQueryParams:
    ...
    disruption_status: Optional[DisruptionsGetDisruptionsByStopDisruptionStatusEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'disruption_status', 'style': 'form', 'explode': True }})
...
class DisruptionsGetDisruptionsByStopRequest:
    path_params: DisruptionsGetDisruptionsByStopPathParams = dataclasses.field()
    query_params: DisruptionsGetDisruptionsByStopQueryParams = dataclasses.field()
