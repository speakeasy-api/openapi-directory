...
class SearchTypePointNoaaFlaskEventQueryParams:
    ...
    search_type_point_noaa_flask_event_lab_id_number: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_flask_event.lab_id_number', 'style': 'form', 'explode': True }})
    search_type_point_noaa_flask_event_measurement_group: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_flask_event.measurement_group', 'style': 'form', 'explode': True }})
    search_type_point_noaa_flask_event_parameter: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_flask_event.parameter', 'style': 'form', 'explode': True }})
    search_type_point_noaa_flask_event_project: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_flask_event.project', 'style': 'form', 'explode': True }})
    search_type_point_noaa_flask_event_site_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_flask_event.site_id', 'style': 'form', 'explode': True }})
...
class SearchTypePointNoaaFlaskEventRequest:
    query_params: SearchTypePointNoaaFlaskEventQueryParams = dataclasses.field()
