...
public class TrcerSecurity {
    ...
    public TrcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public TrcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public TrcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
