...
import dataclasses
from ..shared import conformancepackcompliancescoresfilters as shared_conformancepackcompliancescoresfilters
...
class ListConformancePackComplianceScoresRequest:
    ...
    filters: Optional[shared_conformancepackcompliancescoresfilters.ConformancePackComplianceScoresFilters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Filters'), 'exclude': lambda f: f is None }})  
