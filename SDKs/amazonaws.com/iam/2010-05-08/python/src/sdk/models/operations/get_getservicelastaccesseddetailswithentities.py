...
class GetGetServiceLastAccessedDetailsWithEntitiesRequest:
    headers: GetGetServiceLastAccessedDetailsWithEntitiesHeaders = dataclasses.field()
    query_params: GetGetServiceLastAccessedDetailsWithEntitiesQueryParams = dataclasses.field()
