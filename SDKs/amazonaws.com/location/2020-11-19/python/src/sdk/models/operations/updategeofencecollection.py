...
class UpdateGeofenceCollectionRequestBody:
    ...
    r"""Updates the description for the geofence collection."""  
    pricing_plan: Optional[UpdateGeofenceCollectionRequestBodyPricingPlanEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PricingPlan'), 'exclude': lambda f: f is None }})
    r"""No longer used. If included, the only allowed value is <code>RequestBasedUsage</code>."""  
...
class UpdateGeofenceCollectionRequest:
    ...
    r"""The name of the geofence collection to update."""  
    request_body: UpdateGeofenceCollectionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
