...
class ExperimentAction:
    ...
    state: Optional[shared_experimentactionstate.ExperimentActionState] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
