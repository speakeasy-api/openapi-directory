...
class TargetTcpProxies 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeTargetTcpProxiesTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeTargetTcpProxiesTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeTargetTcpProxiesTestIamPermissionsResponse
     */
	public function computeTargetTcpProxiesTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeTargetTcpProxiesTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeTargetTcpProxiesTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeTargetTcpProxiesTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/targetTcpProxies/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeTargetTcpProxiesTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeTargetTcpProxiesTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeTargetTcpProxiesTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
