...
from ..shared import sortexperimentsby_enum as shared_sortexperimentsby_enum
...
class ListExperimentsRequest:
    ...
    sort_by: Optional[shared_sortexperimentsby_enum.SortExperimentsByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
