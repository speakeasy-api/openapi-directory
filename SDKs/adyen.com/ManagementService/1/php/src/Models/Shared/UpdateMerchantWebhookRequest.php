...
class UpdateMerchantWebhookRequest
{
     ...
     * * **json** 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UpdateMerchantWebhookRequestCommunicationFormatEnum $communicationFormat
     */
	#[\JMS\Serializer\Annotation\SerializedName('communicationFormat')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateMerchantWebhookRequestCommunicationFormatEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateMerchantWebhookRequestCommunicationFormatEnum $communicationFormat = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UpdateMerchantWebhookRequestNetworkTypeEnum $networkType
     */
	#[\JMS\Serializer\Annotation\SerializedName('networkType')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateMerchantWebhookRequestNetworkTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateMerchantWebhookRequestNetworkTypeEnum $networkType = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UpdateMerchantWebhookRequestSslVersionEnum $sslVersion
     */
	#[\JMS\Serializer\Annotation\SerializedName('sslVersion')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateMerchantWebhookRequestSslVersionEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateMerchantWebhookRequestSslVersionEnum $sslVersion = null;
