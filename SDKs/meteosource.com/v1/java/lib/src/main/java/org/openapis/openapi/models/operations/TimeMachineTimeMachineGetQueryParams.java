...
public class TimeMachineTimeMachineGetQueryParams {
    /**
    ...
    public TimeMachineTimeMachineGetQueryParams withDate(LocalDate date) {
        this.date = date;
        return this;
    }
    ...
    public String key;
    public TimeMachineTimeMachineGetQueryParams withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public String lat;
    public TimeMachineTimeMachineGetQueryParams withLat(String lat) {
        this.lat = lat;
        return this;
    }
    ...
    public String lon;
    public TimeMachineTimeMachineGetQueryParams withLon(String lon) {
        this.lon = lon;
        return this;
    }
    ...
    public TimeMachineTimeMachineGetQueryParams withPlaceId(String placeId) {
    ...
    public TimeMachineTimeMachineGetQueryParams withTimezone(String timezone) {
    ...
    public TimeMachineTimeMachineGetQueryParams withUnits(TimeMachineTimeMachineGetUnitsUnitsEnum units) {
        this.units = units;
        return this;
    }
