...
public class ResourcePolicy {
    ...
    public java.util.Map<String, Object> diskConsistencyGroupPolicy;
    public ResourcePolicy withDiskConsistencyGroupPolicy(java.util.Map<String, Object> diskConsistencyGroupPolicy) {
