...
class QueryResponse:
    ...
    payload: Optional[shared_queryresponsepayload.QueryResponsePayload] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('payload') }})
