...
class PendingTransactionPendingTransactionSourceCardAuthorization
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\PendingTransactionPendingTransactionSourceCardAuthorizationCurrencyEnum $currency
     */
	#[\JMS\Serializer\Annotation\SerializedName('currency')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\PendingTransactionPendingTransactionSourceCardAuthorizationCurrencyEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\PendingTransactionPendingTransactionSourceCardAuthorizationNetworkEnum $network
     */
	#[\JMS\Serializer\Annotation\SerializedName('network')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\PendingTransactionPendingTransactionSourceCardAuthorizationNetworkEnum>')]
    public PendingTransactionPendingTransactionSourceCardAuthorizationNetworkEnum $network;
    
    /**
     * Fields specific to the `network`
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\PendingTransactionPendingTransactionSourceCardAuthorizationNetworkDetails $networkDetails
     */
	#[\JMS\Serializer\Annotation\SerializedName('network_details')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PendingTransactionPendingTransactionSourceCardAuthorizationNetworkDetails')]
