...
class ProvisionByoipCidrRequestPoolTagSpecificationsResourceTypeEnum(str, Enum):
...
class ProvisionByoipCidrRequestPoolTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class ProvisionByoipCidrRequestPoolTagSpecifications:
    ...
    resource_type: Optional[ProvisionByoipCidrRequestPoolTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[ProvisionByoipCidrRequestPoolTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class ProvisionByoipCidrRequest:
    ...
    cidr_authorization_context: Optional[shared_cidrauthorizationcontext.CidrAuthorizationContext] = dataclasses.field(default=None)  
    description: Optional[str] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    multi_region: Optional[bool] = dataclasses.field(default=None)  
    pool_tag_specifications: Optional[list[ProvisionByoipCidrRequestPoolTagSpecifications]] = dataclasses.field(default=None)  
