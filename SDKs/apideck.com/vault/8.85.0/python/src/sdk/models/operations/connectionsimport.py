...
class ConnectionsImportRequest:
    headers: ConnectionsImportHeaders = dataclasses.field()
    path_params: ConnectionsImportPathParams = dataclasses.field()
    request: shared_connectionimportdata.ConnectionImportData = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: ConnectionsImportSecurity = dataclasses.field()
