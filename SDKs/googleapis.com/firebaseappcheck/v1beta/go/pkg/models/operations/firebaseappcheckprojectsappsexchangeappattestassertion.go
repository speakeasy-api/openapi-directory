...
type FirebaseappcheckProjectsAppsExchangeAppAttestAssertionRequest struct {
	...
	GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest *shared.GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest `request:"mediaType=application/json"`
	// OAuth access token.
