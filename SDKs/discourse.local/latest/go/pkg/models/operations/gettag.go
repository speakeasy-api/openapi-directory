...
type GetTag200ApplicationJSONTopicListTopicsPosters struct {
...
type GetTag200ApplicationJSONTopicListTopics struct {
	...
	Posters            []GetTag200ApplicationJSONTopicListTopicsPosters `json:"posters,omitempty"`
...
type GetTag200ApplicationJSONTopicList struct {
	...
	Tags           []GetTag200ApplicationJSONTopicListTags   `json:"tags,omitempty"`
	Topics         []GetTag200ApplicationJSONTopicListTopics `json:"topics,omitempty"`
}

type GetTag200ApplicationJSONUsers struct {
...
type GetTag200ApplicationJSON struct {
	...
	TopicList     *GetTag200ApplicationJSONTopicList `json:"topic_list,omitempty"`
	Users         []GetTag200ApplicationJSONUsers    `json:"users,omitempty"`
}
