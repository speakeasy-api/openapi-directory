...
var PricingV1MessagingMessagingCountryInstanceOutboundSmsPrices = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=prices", elemType: PricingV1MessagingMessagingCountryInstanceOutboundSmsPricesPrices }),
...
var PricingV1MessagingMessagingCountryInstance = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=inbound_sms_prices", elemType: PricingV1MessagingMessagingCountryInstanceInboundSmsPrices }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=outbound_sms_prices", elemType: PricingV1MessagingMessagingCountryInstanceOutboundSmsPrices }),
        __metadata("design:type", Array)
