...
class CalendarACLUpdateRequest:
    path_params: CalendarACLUpdatePathParams = dataclasses.field()
    query_params: CalendarACLUpdateQueryParams = dataclasses.field()
    security: CalendarACLUpdateSecurity = dataclasses.field()
