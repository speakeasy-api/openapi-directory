...
public class GetDeploymentVariablesRequest {
    ...
    public GetDeploymentVariablesRequest(@JsonProperty("environment_uuid") String environmentUuid, @JsonProperty("repo_slug") String repoSlug, @JsonProperty("workspace") String workspace) {
        this.environmentUuid = environmentUuid;
        this.repoSlug = repoSlug;
        this.workspace = workspace;
  }
