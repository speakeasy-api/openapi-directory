...
class POSTCMTaxationItemsRequest:
    ...
    post_taxation_item_list_for_cm_type: shared_posttaxationitemlistforcmtype.POSTTaxationItemListForCMType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
