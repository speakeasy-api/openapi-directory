 ...
 */
public enum CreateNetworkInterfaceRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateNetworkInterfaceRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
