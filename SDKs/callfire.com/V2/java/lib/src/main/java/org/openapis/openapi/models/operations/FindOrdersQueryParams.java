...
public class FindOrdersQueryParams {
    /**
     * Limit fields received in response. E.g. fields: id, name or fields items (id, name), see more at [partial response](https://developers.callfire.com/docs.html#partial-response) page.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=fields")
    public String fields;
    public FindOrdersQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public FindOrdersQueryParams withIntervalBegin(Long intervalBegin) {
    ...
    public FindOrdersQueryParams withIntervalEnd(Long intervalEnd) {
    ...
    public FindOrdersQueryParams withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public FindOrdersQueryParams withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public FindOrdersQueryParams withStatus(String[] status) {
        this.status = status;
        return this;
    }
