...
var PersonAttributes = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "avatar_id" }),
        __metadata("design:type", String)
    ], PersonAttributes.prototype, "avatarId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "biography" }),
        __metadata("design:type", String)
    ], PersonAttributes.prototype, "biography", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "born" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "died" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "from_country" }),
        __metadata("design:type", String)
    ], PersonAttributes.prototype, "fromCountry", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "from_locality" }),
        __metadata("design:type", String)
    ], PersonAttributes.prototype, "fromLocality", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "from_region" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "public_email" }),
        __metadata("design:type", String)
...
var PersonRelationships = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return PersonRelationshipsAvatar; }),
...
var Person = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return PersonAttributes; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return PersonRelationships; }),
