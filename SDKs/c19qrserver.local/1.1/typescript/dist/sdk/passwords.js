...
var Passwords = /** @class */ (function () {
    function Passwords(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Passwords.prototype.postChangePassword = function (req, config) {
        var _a;
     ...
     *
    **/
    Passwords.prototype.postRequestPasswordReset = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Passwords.prototype.postVerifyPasswordChange = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
