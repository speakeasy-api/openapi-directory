...
class ClientAPIDeleteRawRequest:
...
class ClientAPIDeleteRawResponse:
    ...
    client_api_delete_raw_200_application_json_int32_integer: Optional[int] = dataclasses.field(default=None)
    r"""OK"""  
    client_api_delete_raw_200_text_json_int32_integer: Optional[int] = dataclasses.field(default=None)
    r"""OK"""  
