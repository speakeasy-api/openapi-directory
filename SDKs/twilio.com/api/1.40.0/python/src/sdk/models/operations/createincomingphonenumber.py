...
class CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequest:
    ...
    r"""The desired area code for your new incoming phone number. Can be any three-digit, US or Canada area code. We will provision an available phone number within this area code for you. **You must provide an `area_code` or a `phone_number`.** (US and Canada only)."""  
    ...
    r"""A descriptive string that you created to describe the new phone number. It can be up to 64 characters long. By default, this is a formatted version of the new phone number."""  
...
class CreateIncomingPhoneNumberRequest:
    ...
    request_body: Optional[CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
