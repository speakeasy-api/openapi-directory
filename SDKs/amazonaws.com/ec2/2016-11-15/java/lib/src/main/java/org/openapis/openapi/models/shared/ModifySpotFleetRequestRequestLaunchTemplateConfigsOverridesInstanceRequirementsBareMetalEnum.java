 ...
 */
public enum ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsBareMetalEnum {
    INCLUDED("included"),
    REQUIRED("required"),
    EXCLUDED("excluded");
    ...
    private ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsBareMetalEnum(String value) {
        this.value = value;
    }
}
