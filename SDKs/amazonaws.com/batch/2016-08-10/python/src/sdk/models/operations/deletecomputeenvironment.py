...
class DeleteComputeEnvironmentRequest:
    headers: DeleteComputeEnvironmentHeaders = dataclasses.field()
    request: DeleteComputeEnvironmentRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteComputeEnvironmentResponse:
    ...
    delete_compute_environment_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
