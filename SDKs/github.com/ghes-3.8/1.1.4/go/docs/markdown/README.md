...
<https://docs.github.com/enterprise-server@3.8/rest/reference/markdown#render-a-markdown-document>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/markdown#render-a-markdown-document-in-raw-mode>
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Markdown.MarkdownRenderRaw(ctx, "facilis")
    if err != nil {
        log.Fatal(err)
    }
