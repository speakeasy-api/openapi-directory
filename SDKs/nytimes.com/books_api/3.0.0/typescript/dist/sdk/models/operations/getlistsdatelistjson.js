...
exports.GetListsDateListJsonResponse = exports.GetListsDateListJsonRequest = exports.GetListsDateListJson200ApplicationJson = exports.GetListsDateListJson200ApplicationJsonResults = exports.GetListsDateListJson200ApplicationJsonResultsBooks = exports.GetListsDateListJson200ApplicationJsonResultsBooksIsbns = exports.GetListsDateListJsonSecurity = exports.GetListsDateListJsonQueryParams = exports.GetListsDateListJsonSortOrderEnum = exports.GetListsDateListJsonPathParams = void 0;
...
var GetListsDateListJsonPathParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=list" }),
        __metadata("design:type", String)
    ], GetListsDateListJsonPathParams.prototype, "list", void 0);
    return GetListsDateListJsonPathParams;
}(utils_1.SpeakeasyBase));
exports.GetListsDateListJsonPathParams = GetListsDateListJsonPathParams;
...
var GetListsDateListJsonQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=list-name" }),
        __metadata("design:type", String)
...
exports.GetListsDateListJsonQueryParams = GetListsDateListJsonQueryParams;
...
var GetListsDateListJson200ApplicationJsonResultsBooks = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=book_image" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=isbns", elemType: GetListsDateListJson200ApplicationJsonResultsBooksIsbns }),
...
var GetListsDateListJson200ApplicationJsonResults = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=books", elemType: GetListsDateListJson200ApplicationJsonResultsBooks }),
        __metadata("design:type", Array)
    ], GetListsDateListJson200ApplicationJsonResults.prototype, "books", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=corrections" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=normal_list_ends_at" }),
        __metadata("design:type", Number)
