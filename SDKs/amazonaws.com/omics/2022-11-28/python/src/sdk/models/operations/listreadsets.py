...
from ..shared import listreadsetsresponse as shared_listreadsetsresponse
...
class ListReadSetsRequestBodyFilter:
    ...
    status: Optional[shared_readsetstatus_enum.ReadSetStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
...
class ListReadSetsRequestBody:
    ...
    filter: Optional[ListReadSetsRequestBodyFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filter'), 'exclude': lambda f: f is None }})
    r"""A filter for read sets."""  
...
class ListReadSetsRequest:
    ...
    request_body: ListReadSetsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    ...
    r"""The maximum number of read sets to return in one page of results."""  
...
class ListReadSetsResponse:
    ...
    list_read_sets_response: Optional[shared_listreadsetsresponse.ListReadSetsResponse] = dataclasses.field(default=None)
    r"""Success"""  
