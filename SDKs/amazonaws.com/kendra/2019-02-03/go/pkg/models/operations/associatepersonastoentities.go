...
func (e *AssociatePersonasToEntitiesXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSKendraFrontendService.AssociatePersonasToEntities":
		*e = AssociatePersonasToEntitiesXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for AssociatePersonasToEntitiesXAmzTargetEnum: %s", s)
	}
}

type AssociatePersonasToEntitiesHeaders struct {
...
type AssociatePersonasToEntitiesRequest struct {
	Headers AssociatePersonasToEntitiesHeaders
	Request shared.AssociatePersonasToEntitiesRequest `request:"mediaType=application/json"`
}
