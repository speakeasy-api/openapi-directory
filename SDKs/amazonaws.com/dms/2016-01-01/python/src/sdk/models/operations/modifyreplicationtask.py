...
class ModifyReplicationTaskRequest:
    ...
    modify_replication_task_message: shared_modifyreplicationtaskmessage.ModifyReplicationTaskMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
