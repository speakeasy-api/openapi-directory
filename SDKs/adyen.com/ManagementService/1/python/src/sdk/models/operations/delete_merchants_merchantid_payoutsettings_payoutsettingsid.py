...
class DeleteMerchantsMerchantIDPayoutSettingsPayoutSettingsIDSecurity:
...
@dataclasses.dataclass
class DeleteMerchantsMerchantIDPayoutSettingsPayoutSettingsIDRequest:
    ...
    payout_settings_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'payoutSettingsId', 'style': 'simple', 'explode': False }})
    r"""The unique identifier of the payout setting."""  
    

@dataclasses.dataclass
class DeleteMerchantsMerchantIDPayoutSettingsPayoutSettingsIDResponse:
