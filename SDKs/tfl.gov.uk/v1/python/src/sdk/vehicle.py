...
class Vehicle:
    ...
    def vehicle_get(self, request: operations.VehicleGetRequest) -> operations.VehicleGetResponse:
        ...
        url = utils.generate_url(operations.VehicleGetRequest, base_url, '/Vehicle/{ids}/Arrivals', request)
        ...
        res = operations.VehicleGetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
