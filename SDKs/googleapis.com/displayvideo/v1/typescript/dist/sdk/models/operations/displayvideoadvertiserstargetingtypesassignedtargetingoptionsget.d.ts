...
export declare class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
/**
 ...
 */
export declare enum DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum {
...
export declare class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
     ...
     * Required. Identifies the type of this assigned targeting option. Supported targeting types: * `TARGETING_TYPE_CHANNEL` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_OMID` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` * `TARGETING_TYPE_YOUTUBE_VIDEO` * `TARGETING_TYPE_YOUTUBE_CHANNEL`
     */
    targetingType: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum;
    /**
...
export declare class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetResponse extends SpeakeasyBase {
    /**
     * Successful response
     */
