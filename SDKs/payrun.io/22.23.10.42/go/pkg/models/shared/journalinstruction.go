...
func (e *JournalInstructionJournalInstructionAccountingTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Credit":
		fallthrough
	case "Debit":
		*e = JournalInstructionJournalInstructionAccountingTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for JournalInstructionJournalInstructionAccountingTypeEnum: %s", s)
	}
}
