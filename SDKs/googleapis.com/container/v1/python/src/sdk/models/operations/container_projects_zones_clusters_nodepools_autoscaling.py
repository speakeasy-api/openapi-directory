...
from ..shared import setnodepoolautoscalingrequest as shared_setnodepoolautoscalingrequest
from typing import Optional


@dataclasses.dataclass
class ContainerProjectsZonesClustersNodePoolsAutoscalingSecurity:
...
@dataclasses.dataclass
class ContainerProjectsZonesClustersNodePoolsAutoscalingRequest:
    ...
    r"""Deprecated. The name of the node pool to upgrade. This field has been deprecated and replaced by the name field."""  
    ...
    set_node_pool_autoscaling_request: Optional[shared_setnodepoolautoscalingrequest.SetNodePoolAutoscalingRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class ContainerProjectsZonesClustersNodePoolsAutoscalingResponse:
