...
public class VisionFilesAsyncBatchAnnotateRequest {
    ...
    public openapisdk.models.shared.GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest request;
    public VisionFilesAsyncBatchAnnotateRequest withRequest(openapisdk.models.shared.GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest request) {
