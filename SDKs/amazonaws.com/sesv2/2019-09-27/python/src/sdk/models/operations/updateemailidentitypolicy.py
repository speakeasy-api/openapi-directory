...
class UpdateEmailIdentityPolicyRequest:
    headers: UpdateEmailIdentityPolicyHeaders = dataclasses.field()
    path_params: UpdateEmailIdentityPolicyPathParams = dataclasses.field()
    request: UpdateEmailIdentityPolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
