...
class ConnectorResource:
    ...
    custom_fields_supported: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('custom_fields_supported'), 'exclude': lambda f: f is None }})
    ...
    downstream_unsupported_operations: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('downstream_unsupported_operations'), 'exclude': lambda f: f is None }})
