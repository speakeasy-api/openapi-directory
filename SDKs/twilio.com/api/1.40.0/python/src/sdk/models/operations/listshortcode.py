...
class ListShortCodeRequest:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the ShortCode resource(s) to read."""  
    ...
    r"""The string that identifies the ShortCode resources to read."""  
    ...
    r"""Only show the ShortCode resources that match this pattern. You can specify partial numbers and use '*' as a wildcard for any digit."""  
...
class ListShortCodeListShortCodeResponse:
    ...
    short_codes: Optional[list[shared_api_v2010_account_short_code.APIV2010AccountShortCode]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('short_codes'), 'exclude': lambda f: f is None }})  
