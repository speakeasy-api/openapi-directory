...
class AndroidenterpriseEnterprisesCreateEnrollmentTokenRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\AndroidenterpriseEnterprisesCreateEnrollmentTokenDeviceTypeEnum $deviceType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=deviceType')]
    public ?AndroidenterpriseEnterprisesCreateEnrollmentTokenDeviceTypeEnum $deviceType = null;
