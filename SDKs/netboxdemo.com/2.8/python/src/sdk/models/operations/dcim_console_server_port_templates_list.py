...
class DcimConsoleServerPortTemplatesList200ApplicationJSON:
    ...
    results: list[shared_consoleserverporttemplate.ConsoleServerPortTemplate] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results') }})  
