...
class DescribeProblemObservationsRequest:
    ...
    describe_problem_observations_request: shared_describeproblemobservationsrequest.DescribeProblemObservationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
