...
class GoogleFirebaseAppcheckV1ListServicesResponse:
    ...
    services: Optional[list[shared_googlefirebaseappcheckv1service.GoogleFirebaseAppcheckV1Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('services'), 'exclude': lambda f: f is None }})
