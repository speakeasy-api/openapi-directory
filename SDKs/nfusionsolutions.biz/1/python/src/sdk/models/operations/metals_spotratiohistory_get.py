...
class MetalsSpotRatioHistoryGETFormatEnum(str, Enum):
...
class MetalsSpotRatioHistoryGETRequest:
    ...
    format: Optional[MetalsSpotRatioHistoryGETFormatEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'format', 'style': 'form', 'explode': True }})
    r"""to override content negotiation specify a value of json or xml"""  
