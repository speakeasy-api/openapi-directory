...
type RealtimebiddingBiddersBiddingFunctionsArchiveSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RealtimebiddingBiddersBiddingFunctionsArchivePathParams struct {
...
type RealtimebiddingBiddersBiddingFunctionsArchiveQueryParams struct {
	// V1 error format.
...
type RealtimebiddingBiddersBiddingFunctionsArchiveRequest struct {
...
type RealtimebiddingBiddersBiddingFunctionsArchiveResponse struct {
	// Successful response
