...
export class RealtimebiddingBiddersPretargetingConfigsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RealtimebiddingBiddersPretargetingConfigsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RealtimebiddingBiddersPretargetingConfigsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
