...
try {
    $response = $sdk->citations->citationsStylesList();
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\CitationsStylesReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CitationsStylesReadRequest();
    $request->styleId = 'corrupti';

    $response = $sdk->citations->citationsStylesRead($request);
