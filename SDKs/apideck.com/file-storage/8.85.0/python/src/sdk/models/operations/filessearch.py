...
from ..shared import filessearch as shared_filessearch
from ..shared import badrequestresponse as shared_badrequestresponse
from ..shared import getfilesresponse as shared_getfilesresponse
...
@dataclasses.dataclass
class FilesSearchSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class FilesSearchRequest:
    headers: FilesSearchHeaders = dataclasses.field()
    request: shared_filessearch.FilesSearch = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: FilesSearchSecurity = dataclasses.field()
...
class FilesSearchResponse:
    ...
    get_files_response: Optional[shared_getfilesresponse.GetFilesResponse] = dataclasses.field(default=None)
