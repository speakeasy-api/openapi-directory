...
class MetalsBenchmarkHistoryGETFormatEnum(str, Enum):
    r"""to override content negotiation specify a value of json or xml"""
    JSON = 'json'
    XML = 'xml'

class MetalsBenchmarkHistoryGETUnitofmeasureEnum(str, Enum):
...
class MetalsBenchmarkHistoryGETRequest:
    ...
    format: Optional[MetalsBenchmarkHistoryGETFormatEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'format', 'style': 'form', 'explode': True }})
    r"""to override content negotiation specify a value of json or xml"""  
    ...
    """  
    unitofmeasure: Optional[MetalsBenchmarkHistoryGETUnitofmeasureEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'unitofmeasure', 'style': 'form', 'explode': True }})
    r"""unit of meaure, defaults to troy ounces. allowed values are:
    mg=milligram
    g=gram
    kg=kilogram
