...
class SearchTripReportQueryParams:
...
@dataclasses.dataclass
class SearchTripReportRequest:
    query_params: SearchTripReportQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTripReportResponse:
