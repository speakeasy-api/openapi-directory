...
class CreateActivityRequest:
    ...
    create_activity_input: shared_createactivityinput.CreateActivityInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
