...
export declare class PredictImageUrlWithNoStoreFormRequest extends SpeakeasyBase {
    /**
...
export declare class PredictImageUrlWithNoStoreFormResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    /**
     * OK
