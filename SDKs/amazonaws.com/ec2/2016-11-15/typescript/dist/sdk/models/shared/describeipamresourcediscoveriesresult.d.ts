 ...
 */
export declare class DescribeIpamResourceDiscoveriesResultIpamResourceDiscoveriesOperatingRegions extends SpeakeasyBase {
    regionName?: string;
}
/**
 ...
 */
export declare enum DescribeIpamResourceDiscoveriesResultIpamResourceDiscoveriesStateEnum {
 ...
 * Describes a tag.
 */
export declare class DescribeIpamResourceDiscoveriesResultIpamResourceDiscoveriesTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class DescribeIpamResourceDiscoveriesResultIpamResourceDiscoveries extends SpeakeasyBase {
    description?: string;
 ...
 * Success
 */
export declare class DescribeIpamResourceDiscoveriesResult extends SpeakeasyBase {
