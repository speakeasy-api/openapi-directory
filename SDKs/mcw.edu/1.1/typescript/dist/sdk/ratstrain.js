...
exports.RatStrain = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var RatStrain = /** @class */ (function () {
    function RatStrain(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    RatStrain.prototype.getAllStrainsUsingGet = function (config) {
    ...
    **/
    RatStrain.prototype.getStrainByRgdIdUsingGet = function (req, config) {
    ...
    **/
    RatStrain.prototype.getStrainsByPositionUsingGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
