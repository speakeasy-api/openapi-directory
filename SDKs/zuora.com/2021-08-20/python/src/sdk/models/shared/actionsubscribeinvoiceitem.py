...
class ActionSubscribeInvoiceItem:
    ...
    **Values**: inherited from `RatePlanCharge.AccountingCode`
    ...
    r"""The charge number that the discount charge is applied to. This field is only for the invoice items that are discount charges. This field is only returned in subscription previews.
