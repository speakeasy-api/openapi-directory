    ...
    public static void main(String[] args) {
        try {
            ...
            AlsfcRequestBody req = new AlsfcRequestBody(AlsfcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new AlsfcRequestBodyCertificateParameters("123412341234", "SAS2F2803");;
            ...
            AlsfcResponse res = sdk.apIs.alsfc(req, new AlsfcSecurity("molestiae", "minus") {{
