...
class DomainTransferability:
    r"""A complex type that contains information about whether the specified domain can be transferred to Route 53."""
    
    transferable: Optional[shared_transferable_enum.TransferableEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Transferable'), 'exclude': lambda f: f is None }})
