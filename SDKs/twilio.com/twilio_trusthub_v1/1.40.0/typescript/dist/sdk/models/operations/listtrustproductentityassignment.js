...
exports.ListTrustProductEntityAssignmentResponse = exports.ListTrustProductEntityAssignmentListTrustProductEntityAssignmentResponse = exports.ListTrustProductEntityAssignmentListTrustProductEntityAssignmentResponseMeta = exports.ListTrustProductEntityAssignmentRequest = exports.ListTrustProductEntityAssignmentSecurity = exports.ListTrustProductEntityAssignmentServerList = void 0;
...
var ListTrustProductEntityAssignmentSecurity = /** @class */ (function (_super) {
    ...
    ], ListTrustProductEntityAssignmentSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListTrustProductEntityAssignmentSecurity.prototype, "username", void 0);
...
var ListTrustProductEntityAssignmentRequest = /** @class */ (function (_super) {
    ...
    ], ListTrustProductEntityAssignmentRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListTrustProductEntityAssignmentRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListTrustProductEntityAssignmentRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TrustProductSid",
        }),
        __metadata("design:type", String)
    ], ListTrustProductEntityAssignmentRequest.prototype, "trustProductSid", void 0);
...
var ListTrustProductEntityAssignmentListTrustProductEntityAssignmentResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.TrusthubV1TrustProductTrustProductEntityAssignment,
        }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return shared.TrusthubV1TrustProductTrustProductEntityAssignment; }),
...
var ListTrustProductEntityAssignmentResponse = /** @class */ (function (_super) {
    ...
    ], ListTrustProductEntityAssignmentResponse.prototype, "rawResponse", void 0);
