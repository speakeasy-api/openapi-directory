...
class DescribeDeploymentsRequest:
    ...
    describe_deployments_request: shared_describedeploymentsrequest.DescribeDeploymentsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
