...
use \OpenAPI\OpenAPI\Models\Operations\LlcerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\LlcerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\LlcerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\LlcerSecurity;
...
try {
    ...
    $request->certificateParameters = new LlcerRequestBodyCertificateParameters();
    $request->certificateParameters->udf1 = '547';
    $request->certificateParameters->udf2 = '1';
    $request->certificateParameters->udf3 = '2020';
    ...
    $request->format = LlcerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new LlcerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->llcer($request, $requestSecurity);
