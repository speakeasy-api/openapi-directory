...
var PricingData = /** @class */ (function () {
    function PricingData(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    PricingData.prototype.getAvgListPriceListPriceGet = function (req, config) {
     ...
     * The available brand and region names can be retrieved from their respective endpoints.
    **/
    PricingData.prototype.getAvgSalePriceSalePriceGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PricingData.prototype.getMarket3SimilarSalePriceGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PricingData.prototype.getModelSaleBucketsSalePriceHistogramGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
