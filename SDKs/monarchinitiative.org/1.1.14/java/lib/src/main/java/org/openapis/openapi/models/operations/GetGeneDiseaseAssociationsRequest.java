...
public class GetGeneDiseaseAssociationsRequest {
    ...
    public GetGeneDiseaseAssociationsRequest withAssociationType(GetGeneDiseaseAssociationsAssociationTypeEnum associationType) {
    ...
    public GetGeneDiseaseAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGeneDiseaseAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGeneDiseaseAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGeneDiseaseAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGeneDiseaseAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGeneDiseaseAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGeneDiseaseAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGeneDiseaseAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGeneDiseaseAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGeneDiseaseAssociationsRequest withRelation(String relation) {
    ...
    public GetGeneDiseaseAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGeneDiseaseAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGeneDiseaseAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetGeneDiseaseAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGeneDiseaseAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGeneDiseaseAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGeneDiseaseAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGeneDiseaseAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
