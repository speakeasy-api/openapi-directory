...
public class TransactionsGetRequest {
    ...
    public TransactionsGetRequest(@JsonProperty("access_token") String accessToken, @JsonProperty("end_date") LocalDate endDate, @JsonProperty("start_date") LocalDate startDate) {
        this.accessToken = accessToken;
        this.endDate = endDate;
        this.startDate = startDate;
  }
