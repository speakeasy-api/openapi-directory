...
class ScriptProjectsGetMetricsRequest
{
     ...
     * 
     * @var ?string $metricsFilterDeploymentId
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=metricsFilter.deploymentId')]
    public ?string $metricsFilterDeploymentId = null;
    
    /**
     * Required field indicating what granularity of metrics are returned.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ScriptProjectsGetMetricsMetricsGranularityEnum $metricsGranularity
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=metricsGranularity')]
    public ?ScriptProjectsGetMetricsMetricsGranularityEnum $metricsGranularity = null;
	...
	public function __construct()
	{
		...
		$this->fields = null;
		$this->key = null;
		$this->metricsFilterDeploymentId = null;
		$this->metricsGranularity = null;
