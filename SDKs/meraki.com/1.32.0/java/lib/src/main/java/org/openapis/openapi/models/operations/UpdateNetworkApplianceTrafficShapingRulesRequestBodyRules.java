...
public class UpdateNetworkApplianceTrafficShapingRulesRequestBodyRules {
    ...
    public UpdateNetworkApplianceTrafficShapingRulesRequestBodyRules(@JsonProperty("definitions") UpdateNetworkApplianceTrafficShapingRulesRequestBodyRulesDefinitions[] definitions) {
        this.definitions = definitions;
  }
}
