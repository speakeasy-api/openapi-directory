...
from ..shared import usage_record_last_month_enum_category_enum as shared_usage_record_last_month_enum_category_enum
from ..shared import security as shared_security
from ..shared import api_v2010_account_usage_usage_record_usage_record_last_month as shared_api_v2010_account_usage_usage_record_usage_record_last_month
...
class ListUsageRecordLastMonthQueryParams:
    category: Optional[shared_usage_record_last_month_enum_category_enum.UsageRecordLastMonthEnumCategoryEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'Category', 'style': 'form', 'explode': True }})
...
class ListUsageRecordLastMonthListUsageRecordLastMonthResponse:
    ...
    usage_records: Optional[list[shared_api_v2010_account_usage_usage_record_usage_record_last_month.APIV2010AccountUsageUsageRecordUsageRecordLastMonth]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usage_records') }})
    

@dataclasses.dataclass
class ListUsageRecordLastMonthRequest:
    path_params: ListUsageRecordLastMonthPathParams = dataclasses.field()
    query_params: ListUsageRecordLastMonthQueryParams = dataclasses.field()
    security: ListUsageRecordLastMonthSecurity = dataclasses.field()
...
class ListUsageRecordLastMonthResponse:
    ...
    list_usage_record_last_month_response: Optional[ListUsageRecordLastMonthListUsageRecordLastMonthResponse] = dataclasses.field(default=None)
