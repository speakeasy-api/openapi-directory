...
var BatchGetQueryExecutionOutput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: queryexecution_1.QueryExecution }),
        (0, class_transformer_1.Expose)({ name: "QueryExecutions" }),
        (0, class_transformer_1.Type)(function () { return queryexecution_1.QueryExecution; }),
        __metadata("design:type", Array)
    ], BatchGetQueryExecutionOutput.prototype, "queryExecutions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: unprocessedqueryexecutionid_1.UnprocessedQueryExecutionId }),
        (0, class_transformer_1.Expose)({ name: "UnprocessedQueryExecutionIds" }),
        (0, class_transformer_1.Type)(function () { return unprocessedqueryexecutionid_1.UnprocessedQueryExecutionId; }),
        __metadata("design:type", Array)
