...
from ..shared import obwritedomesticstandingorder3 as shared_obwritedomesticstandingorder3
from ..shared import obwritedomesticstandingorderresponse6 as shared_obwritedomesticstandingorderresponse6
from typing import Optional


@dataclasses.dataclass
class CreateDomesticStandingOrdersJSONSecurity:
    
    psuo_auth2_security: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class CreateDomesticStandingOrdersJSONRequest:
    
    authorization: str = dataclasses.field(metadata={'header': { 'field_name': 'Authorization', 'style': 'simple', 'explode': False }})
    r"""An Authorisation Token as per https://tools.ietf.org/html/rfc6750"""  
    ob_write_domestic_standing_order3: shared_obwritedomesticstandingorder3.OBWriteDomesticStandingOrder3 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Default"""  
