...
exports.SearchTasksResponse = exports.SearchTasksRequest = exports.SearchTasksQueryParams = void 0;
...
var SearchTasksQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_tasks.assignedto" }),
        __metadata("design:type", String)
    ], SearchTasksQueryParams.prototype, "searchDbTasksAssignedto", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_tasks.complete" }),
        __metadata("design:type", Number)
    ], SearchTasksQueryParams.prototype, "searchDbTasksComplete", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_tasks.enddate" }),
        __metadata("design:type", String)
    ], SearchTasksQueryParams.prototype, "searchDbTasksEnddate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_tasks.priority" }),
        __metadata("design:type", String)
    ], SearchTasksQueryParams.prototype, "searchDbTasksPriority", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_tasks.startdate" }),
        __metadata("design:type", String)
    ], SearchTasksQueryParams.prototype, "searchDbTasksStartdate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_tasks.status" }),
        __metadata("design:type", String)
    ], SearchTasksQueryParams.prototype, "searchDbTasksStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_tasks.title" }),
        __metadata("design:type", String)
...
exports.SearchTasksQueryParams = SearchTasksQueryParams;
