...
type NodesForksListNodeAttributesCategoryEnum string

const (
	NodesForksListNodeAttributesCategoryEnumAnalysis           NodesForksListNodeAttributesCategoryEnum = "analysis"
	NodesForksListNodeAttributesCategoryEnumCommunication      NodesForksListNodeAttributesCategoryEnum = "communication"
	NodesForksListNodeAttributesCategoryEnumData               NodesForksListNodeAttributesCategoryEnum = "data"
	NodesForksListNodeAttributesCategoryEnumHypothesis         NodesForksListNodeAttributesCategoryEnum = "hypothesis"
	NodesForksListNodeAttributesCategoryEnumInstrumentation    NodesForksListNodeAttributesCategoryEnum = "instrumentation"
	NodesForksListNodeAttributesCategoryEnumMethodsAndMeasures NodesForksListNodeAttributesCategoryEnum = "methods and measures"
	NodesForksListNodeAttributesCategoryEnumProcedure          NodesForksListNodeAttributesCategoryEnum = "procedure"
	NodesForksListNodeAttributesCategoryEnumProject            NodesForksListNodeAttributesCategoryEnum = "project"
	NodesForksListNodeAttributesCategoryEnumSoftware           NodesForksListNodeAttributesCategoryEnum = "software"
	NodesForksListNodeAttributesCategoryEnumOther              NodesForksListNodeAttributesCategoryEnum = "other"
)

func (e NodesForksListNodeAttributesCategoryEnum) ToPointer() *NodesForksListNodeAttributesCategoryEnum {
	return &e
}

func (e *NodesForksListNodeAttributesCategoryEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "software":
		fallthrough
	case "other":
		*e = NodesForksListNodeAttributesCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NodesForksListNodeAttributesCategoryEnum: %v", v)
	}
}

// NodesForksListNodeAttributes - The properties of the node entity.
type NodesForksListNodeAttributes struct {
...
type NodesForksListNodeLinks struct {
...
type NodesForksListNodeRelationships struct {
...
type NodesForksListNode struct {
