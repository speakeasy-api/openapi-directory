 ...
 */
export enum CreatePublicIpv4PoolRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreatePublicIpv4PoolRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreatePublicIpv4PoolRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreatePublicIpv4PoolRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: CreatePublicIpv4PoolRequestTagSpecifications })
