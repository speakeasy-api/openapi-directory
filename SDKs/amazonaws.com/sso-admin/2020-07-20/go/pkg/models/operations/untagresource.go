...
const (
	UntagResourceXAmzTargetEnumSwbExternalServiceUntagResource UntagResourceXAmzTargetEnum = "SWBExternalService.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "SWBExternalService.UntagResource":
