...
public class UpdateGatewayCapabilityConfigurationRequest {
    ...
    public UpdateGatewayCapabilityConfigurationRequest(@JsonProperty("RequestBody") UpdateGatewayCapabilityConfigurationRequestBody requestBody, @JsonProperty("gatewayId") String gatewayId) {
        this.requestBody = requestBody;
        this.gatewayId = gatewayId;
  }
}
