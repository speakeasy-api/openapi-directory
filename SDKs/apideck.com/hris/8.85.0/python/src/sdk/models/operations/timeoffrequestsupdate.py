...
class TimeOffRequestsUpdateRequest:
    headers: TimeOffRequestsUpdateHeaders = dataclasses.field()
    path_params: TimeOffRequestsUpdatePathParams = dataclasses.field()
    query_params: TimeOffRequestsUpdateQueryParams = dataclasses.field()
    request: shared_timeoffrequest.TimeOffRequestInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: TimeOffRequestsUpdateSecurity = dataclasses.field()
