...
func (e PortfolioRequestColorEnum) ToPointer() *PortfolioRequestColorEnum {
	return &e
}
...
func (e *PortfolioRequestColorEnum) UnmarshalJSON(data []byte) error {
	...
	case "light-warm-gray":
		*e = PortfolioRequestColorEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PortfolioRequestColorEnum: %v", v)
	}
}
