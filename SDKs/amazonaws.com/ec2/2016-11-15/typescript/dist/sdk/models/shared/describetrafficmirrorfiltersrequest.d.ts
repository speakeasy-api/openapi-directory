 ...
 */
export declare class DescribeTrafficMirrorFiltersRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTrafficMirrorFiltersRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeTrafficMirrorFiltersRequestFilters[];
    maxResults?: number;
    nextToken?: string;
