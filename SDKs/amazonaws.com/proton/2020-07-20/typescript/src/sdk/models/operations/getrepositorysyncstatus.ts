...
export enum GetRepositorySyncStatusXAmzTargetEnum {
  AwsProton20200720GetRepositorySyncStatus = "AwsProton20200720.GetRepositorySyncStatus",
}

export class GetRepositorySyncStatusRequest extends SpeakeasyBase {
...
export class GetRepositorySyncStatusResponse extends SpeakeasyBase {
  /**
