 ...
 */
export enum NetworkEndpointGroupListWarningCodeEnum {
...
export class NetworkEndpointGroupListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NetworkEndpointGroupListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NetworkEndpointGroupListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class NetworkEndpointGroupList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: NetworkEndpointGroup })
  @Expose({ name: "items" })
