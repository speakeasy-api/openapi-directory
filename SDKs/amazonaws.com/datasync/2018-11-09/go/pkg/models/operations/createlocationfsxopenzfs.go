...
func (e *CreateLocationFsxOpenZfsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "FmrsService.CreateLocationFsxOpenZfs":
		*e = CreateLocationFsxOpenZfsXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateLocationFsxOpenZfsXAmzTargetEnum: %s", s)
	}
}

type CreateLocationFsxOpenZfsHeaders struct {
...
type CreateLocationFsxOpenZfsRequest struct {
	Headers CreateLocationFsxOpenZfsHeaders
	Request shared.CreateLocationFsxOpenZfsRequest `request:"mediaType=application/json"`
}
