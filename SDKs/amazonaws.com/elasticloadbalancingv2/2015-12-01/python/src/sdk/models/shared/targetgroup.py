...
from ..shared import targetgroupipaddresstypeenum_enum as shared_targetgroupipaddresstypeenum_enum
...
class TargetGroup:
    r"""Information about a target group."""
    ...
    ip_address_type: Optional[shared_targetgroupipaddresstypeenum_enum.TargetGroupIPAddressTypeEnumEnum] = dataclasses.field(default=None)  
