...
exports.GetTicketsResponse = exports.GetTicketsRequest = exports.GetTicketsTypeEnum = void 0;
...
var GetTicketsRequest = /** @class */ (function (_super) {
    ...
    ], GetTicketsRequest.prototype, "closed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=createdEnd",
        }),
        __metadata("design:type", String)
    ], GetTicketsRequest.prototype, "createdEnd", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=createdStart",
        }),
        __metadata("design:type", String)
    ], GetTicketsRequest.prototype, "createdStart", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetTicketsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], GetTicketsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sourceDomainOrIp",
        }),
        __metadata("design:type", String)
    ], GetTicketsRequest.prototype, "sourceDomainOrIp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=target",
        }),
        __metadata("design:type", String)
    ], GetTicketsRequest.prototype, "target", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=type" }),
        __metadata("design:type", String)
    ], GetTicketsRequest.prototype, "type", void 0);
...
var GetTicketsResponse = /** @class */ (function (_super) {
    ...
    ], GetTicketsResponse.prototype, "rawResponse", void 0);
