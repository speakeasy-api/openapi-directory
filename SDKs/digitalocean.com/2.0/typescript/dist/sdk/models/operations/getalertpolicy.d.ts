...
export declare class GetAlertPolicyPathParams extends SpeakeasyBase {
    alertUuid: string;
}
export declare class GetAlertPolicy401ApplicationJson extends SpeakeasyBase {
    id: string;
    message: string;
    requestId?: string;
}
export declare class GetAlertPolicyRequest extends SpeakeasyBase {
    pathParams: GetAlertPolicyPathParams;
}
export declare class GetAlertPolicyResponse extends SpeakeasyBase {
    contentType: string;
