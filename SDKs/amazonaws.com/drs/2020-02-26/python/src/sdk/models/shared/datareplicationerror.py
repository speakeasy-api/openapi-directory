...
class DataReplicationError:
    ...
    error: Optional[shared_datareplicationerrorstring_enum.DataReplicationErrorStringEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error'), 'exclude': lambda f: f is None }})  
