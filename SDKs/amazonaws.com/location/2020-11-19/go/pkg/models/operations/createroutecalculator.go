...
func (e CreateRouteCalculatorRequestBodyPricingPlanEnum) ToPointer() *CreateRouteCalculatorRequestBodyPricingPlanEnum {
	return &e
}
...
func (e *CreateRouteCalculatorRequestBodyPricingPlanEnum) UnmarshalJSON(data []byte) error {
	...
	case "MobileAssetManagement":
		*e = CreateRouteCalculatorRequestBodyPricingPlanEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateRouteCalculatorRequestBodyPricingPlanEnum: %v", v)
	}
}
...
type CreateRouteCalculatorRequest struct {
	RequestBody       CreateRouteCalculatorRequestBody `request:"mediaType=application/json"`
