...
type ClassroomCoursesAnnouncementsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ClassroomCoursesAnnouncementsCreatePathParams struct {
	// Identifier of the course. This identifier can be either the Classroom-assigned identifier or an alias.
	CourseID string `pathParam:"style=simple,explode=false,name=courseId"`
}

type ClassroomCoursesAnnouncementsCreateQueryParams struct {
	// V1 error format.
...
type ClassroomCoursesAnnouncementsCreateRequest struct {
...
type ClassroomCoursesAnnouncementsCreateResponse struct {
	// Successful response
