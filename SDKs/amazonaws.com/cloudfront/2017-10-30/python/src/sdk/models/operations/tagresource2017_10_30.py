...
class TagResource20171030QueryParams:
    operation: TagResource20171030OperationEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
...
class TagResource20171030Request:
    headers: TagResource20171030Headers = dataclasses.field()
    query_params: TagResource20171030QueryParams = dataclasses.field()
