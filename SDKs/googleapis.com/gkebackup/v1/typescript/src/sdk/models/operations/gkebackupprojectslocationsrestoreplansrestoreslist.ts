...
export class GkebackupProjectsLocationsRestorePlansRestoresListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsRestorePlansRestoresListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsRestorePlansRestoresListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
