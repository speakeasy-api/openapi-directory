...
export declare class ProdTtSasportalNodesNodesDevicesListSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalNodesNodesDevicesListSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalNodesNodesDevicesListSecurity extends SpeakeasyBase {
    option1?: ProdTtSasportalNodesNodesDevicesListSecurityOption1;
    option2?: ProdTtSasportalNodesNodesDevicesListSecurityOption2;
}
