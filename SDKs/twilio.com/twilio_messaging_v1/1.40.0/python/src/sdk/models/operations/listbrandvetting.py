...
class ListBrandVettingListBrandVettingResponse:
    ...
    data: Optional[list[shared_messaging_v1_brand_registrations_brand_vetting.MessagingV1BrandRegistrationsBrandVetting]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListBrandVettingListBrandVettingResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
