...
exports.InvoiceApiAllResponse = exports.InvoiceApiAllRequest = void 0;
...
var InvoiceApiAllRequest = /** @class */ (function (_super) {
    ...
    ], InvoiceApiAllRequest.prototype, "queryOptionsPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=queryOptions.pageSize",
        }),
        __metadata("design:type", Number)
    ], InvoiceApiAllRequest.prototype, "queryOptionsPageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-key",
        }),
        __metadata("design:type", String)
    ], InvoiceApiAllRequest.prototype, "xAuthKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-secret",
        }),
        __metadata("design:type", String)
    ], InvoiceApiAllRequest.prototype, "xAuthSecret", void 0);
    return InvoiceApiAllRequest;
}(utils_1.SpeakeasyBase));
exports.InvoiceApiAllRequest = InvoiceApiAllRequest;
var InvoiceApiAllResponse = /** @class */ (function (_super) {
    ...
    ], InvoiceApiAllResponse.prototype, "rawResponse", void 0);
    return InvoiceApiAllResponse;
}(utils_1.SpeakeasyBase));
exports.InvoiceApiAllResponse = InvoiceApiAllResponse;
