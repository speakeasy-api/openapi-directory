...
import { FirewallLogConfig } from "./firewalllogconfig";
export declare class FirewallAllowed extends SpeakeasyBase {
    /**
...
export declare class FirewallDenied extends SpeakeasyBase {
    /**
     * The IP protocol to which this rule applies. The protocol type is required when creating a firewall rule. This value can either be one of the following well known protocol strings (tcp, udp, icmp, esp, ah, ipip, sctp) or the IP protocol number.
     */
    ipProtocol?: string;
 ...
 */
export declare enum FirewallDirectionEnum {
    Egress = "EGRESS",
    Ingress = "INGRESS"
}
/**
