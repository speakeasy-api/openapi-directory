...
type StartBuildBatchInput struct {
	...
	BuildBatchConfigOverride         *ProjectBuildBatchConfig      `json:"buildBatchConfigOverride,omitempty"`
	BuildTimeoutInMinutesOverride    *int64                        `json:"buildTimeoutInMinutesOverride,omitempty"`
