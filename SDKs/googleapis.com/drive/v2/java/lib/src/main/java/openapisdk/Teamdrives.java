...
public class Teamdrives {
    ...
    **/
    public openapisdk.models.operations.DriveTeamdrivesInsertResponse driveTeamdrivesInsert(openapisdk.models.operations.DriveTeamdrivesInsertRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        openapisdk.models.operations.DriveTeamdrivesInsertResponse res = new openapisdk.models.operations.DriveTeamdrivesInsertResponse() {{
            teamDrive = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
