...
var TriggerInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "eventDataContentType" }),
        __metadata("design:type", String)
    ], TriggerInput.prototype, "eventDataContentType", void 0);
    __decorate([
...
var Trigger = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: statecondition_1.StateCondition }),
        (0, class_transformer_1.Expose)({ name: "conditions" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], statecondition_1.StateCondition);
            }
            return obj;
        }, { toClassOnly: true }),
        __metadata("design:type", Object)
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "eventDataContentType" }),
        __metadata("design:type", String)
    ], Trigger.prototype, "eventDataContentType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: eventfilter_1.EventFilter }),
        (0, class_transformer_1.Expose)({ name: "eventFilters" }),
        (0, class_transformer_1.Type)(function () { return eventfilter_1.EventFilter; }),
