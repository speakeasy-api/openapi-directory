...
class ListImagePipelinesResponse:
    ...
    image_pipeline_list: Optional[list[shared_imagepipeline.ImagePipeline]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('imagePipelineList'), 'exclude': lambda f: f is None }})  
