...
class ReleasesGetLatestByHash200ApplicationJSON
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONBuild $build
     */
	#[\JMS\Serializer\Annotation\SerializedName('build')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONBuild')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ReleasesGetLatestByHash200ApplicationJSONBuild $build = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONDestinationTypeEnum $destinationType
     */
	#[\JMS\Serializer\Annotation\SerializedName('destination_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONDestinationTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ReleasesGetLatestByHash200ApplicationJSONDestinationTypeEnum $destinationType = null;
    
    /**
     * A list of distribution groups or stores.
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONDestinations> $destinations
     */
	#[\JMS\Serializer\Annotation\SerializedName('destinations')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONDestinations>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONDistributionGroups> $distributionGroups
     */
	#[\JMS\Serializer\Annotation\SerializedName('distribution_groups')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONDistributionGroups>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONDistributionStores> $distributionStores
     */
	#[\JMS\Serializer\Annotation\SerializedName('distribution_stores')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONDistributionStores>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONOriginEnum $origin
     */
	#[\JMS\Serializer\Annotation\SerializedName('origin')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONOriginEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ReleasesGetLatestByHash200ApplicationJSONOriginEnum $origin = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONProvisioningProfileTypeEnum $provisioningProfileType
     */
	#[\JMS\Serializer\Annotation\SerializedName('provisioning_profile_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\ReleasesGetLatestByHash200ApplicationJSONProvisioningProfileTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ReleasesGetLatestByHash200ApplicationJSONProvisioningProfileTypeEnum $provisioningProfileType = null;
