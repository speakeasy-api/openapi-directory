...
type ProxyModifyAccountCustomerTypeNSEnum string

const (
	ProxyModifyAccountCustomerTypeNSEnumCompany    ProxyModifyAccountCustomerTypeNSEnum = "Company"
	ProxyModifyAccountCustomerTypeNSEnumIndividual ProxyModifyAccountCustomerTypeNSEnum = "Individual"
)

func (e *ProxyModifyAccountCustomerTypeNSEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Company":
		fallthrough
	case "Individual":
		*e = ProxyModifyAccountCustomerTypeNSEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ProxyModifyAccountCustomerTypeNSEnum: %s", s)
	}
}
...
type ProxyModifyAccountStatusEnum string

const (
	ProxyModifyAccountStatusEnumDraft    ProxyModifyAccountStatusEnum = "Draft"
	ProxyModifyAccountStatusEnumActive   ProxyModifyAccountStatusEnum = "Active"
	ProxyModifyAccountStatusEnumCanceled ProxyModifyAccountStatusEnum = "Canceled"
)

func (e *ProxyModifyAccountStatusEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Active":
		fallthrough
	case "Canceled":
		*e = ProxyModifyAccountStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ProxyModifyAccountStatusEnum: %s", s)
	}
}

// ProxyModifyAccountSynctoNetSuiteNSEnum - Specifies whether the account should be synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).
type ProxyModifyAccountSynctoNetSuiteNSEnum string

const (
	ProxyModifyAccountSynctoNetSuiteNSEnumYes ProxyModifyAccountSynctoNetSuiteNSEnum = "Yes"
	ProxyModifyAccountSynctoNetSuiteNSEnumNo  ProxyModifyAccountSynctoNetSuiteNSEnum = "No"
)

func (e *ProxyModifyAccountSynctoNetSuiteNSEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Yes":
		fallthrough
	case "No":
		*e = ProxyModifyAccountSynctoNetSuiteNSEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ProxyModifyAccountSynctoNetSuiteNSEnum: %s", s)
	}
}
...
type ProxyModifyAccount struct {
	...
	//
	CustomerTypeNS *ProxyModifyAccountCustomerTypeNSEnum `json:"CustomerType__NS,omitempty"`
	...
	// - You cannot update the Active or Cancelled status of an account to `Draft`.
	//
	Status *ProxyModifyAccountStatusEnum `json:"Status,omitempty"`
	...
	//
	SynctoNetSuiteNS *ProxyModifyAccountSynctoNetSuiteNSEnum `json:"SynctoNetSuite__NS,omitempty"`
