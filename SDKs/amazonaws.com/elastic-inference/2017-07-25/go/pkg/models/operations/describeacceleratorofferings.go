...
type DescribeAcceleratorOfferingsHeaders struct {
...
func (e *DescribeAcceleratorOfferingsRequestBodyLocationTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "availability-zone-id":
		*e = DescribeAcceleratorOfferingsRequestBodyLocationTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeAcceleratorOfferingsRequestBodyLocationTypeEnum: %s", s)
	}
}
...
type DescribeAcceleratorOfferingsRequest struct {
	Headers DescribeAcceleratorOfferingsHeaders
	Request DescribeAcceleratorOfferingsRequestBody `request:"mediaType=application/json"`
}
