...
from ..shared import updateanomalydetectorresponse as shared_updateanomalydetectorresponse
...
class UpdateAnomalyDetectorRequestBody:
    ...
    anomaly_detector_config: Optional[UpdateAnomalyDetectorRequestBodyAnomalyDetectorConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('AnomalyDetectorConfig') }})
...
class UpdateAnomalyDetectorRequest:
    headers: UpdateAnomalyDetectorHeaders = dataclasses.field()
    request: UpdateAnomalyDetectorRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateAnomalyDetectorResponse:
    ...
    update_anomaly_detector_response: Optional[shared_updateanomalydetectorresponse.UpdateAnomalyDetectorResponse] = dataclasses.field(default=None)
