...
class GetWorkspaceMembership200ApplicationJSON:
    r"""Successfully retrieved the requested workspace membership."""
    
    data: Optional[shared_workspacemembershipresponse.WorkspaceMembershipResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
