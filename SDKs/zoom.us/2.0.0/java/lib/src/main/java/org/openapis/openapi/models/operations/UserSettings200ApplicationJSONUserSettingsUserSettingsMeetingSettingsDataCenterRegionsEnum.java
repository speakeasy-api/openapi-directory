 ...
 * 
 */
public enum UserSettings200ApplicationJSONUserSettingsUserSettingsMeetingSettingsDataCenterRegionsEnum {
    HK("HK"),
    AU("AU"),
    IN("IN"),
    TY("TY"),
    ...
    private UserSettings200ApplicationJSONUserSettingsUserSettingsMeetingSettingsDataCenterRegionsEnum(String value) {
        this.value = value;
    }
}
