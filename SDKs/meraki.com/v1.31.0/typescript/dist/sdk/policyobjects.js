...
exports.PolicyObjects = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var PolicyObjects = /** @class */ (function () {
    function PolicyObjects(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Creates a new Policy Object.
     */
    PolicyObjects.prototype.createOrganizationPolicyObject = function (req, config) {
        var _a;
     ...
     * Creates a new Policy Object Group.
     */
    PolicyObjects.prototype.createOrganizationPolicyObjectsGroup = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Deletes a Policy Object.
     */
    PolicyObjects.prototype.deleteOrganizationPolicyObject = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Deletes a Policy Object Group.
     */
    PolicyObjects.prototype.deleteOrganizationPolicyObjectsGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Shows details of a Policy Object.
     */
    PolicyObjects.prototype.getOrganizationPolicyObject = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Lists Policy Objects belonging to the organization.
     */
    PolicyObjects.prototype.getOrganizationPolicyObjects = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Shows details of a Policy Object Group.
     */
    PolicyObjects.prototype.getOrganizationPolicyObjectsGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Lists Policy Object Groups belonging to the organization.
     */
    PolicyObjects.prototype.getOrganizationPolicyObjectsGroups = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Updates a Policy Object.
     */
    PolicyObjects.prototype.updateOrganizationPolicyObject = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Updates a Policy Object Group.
     */
    PolicyObjects.prototype.updateOrganizationPolicyObjectsGroup = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.PolicyObjects = PolicyObjects;
