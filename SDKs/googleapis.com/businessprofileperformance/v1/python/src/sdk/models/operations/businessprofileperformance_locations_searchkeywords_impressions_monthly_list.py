...
class BusinessprofileperformanceLocationsSearchkeywordsImpressionsMonthlyListRequest:
    path_params: BusinessprofileperformanceLocationsSearchkeywordsImpressionsMonthlyListPathParams = dataclasses.field()
    query_params: BusinessprofileperformanceLocationsSearchkeywordsImpressionsMonthlyListQueryParams = dataclasses.field()
