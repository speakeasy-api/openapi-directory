...
class PutEmailIdentityDkimAttributesRequest:
    headers: PutEmailIdentityDkimAttributesHeaders = dataclasses.field()
    path_params: PutEmailIdentityDkimAttributesPathParams = dataclasses.field()
    request: PutEmailIdentityDkimAttributesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
