...
public class PatchContainersGroupsNameOrIdRequest {
    ...
    public PatchContainersGroupsNameOrIdRequest(@JsonProperty("ContainersGroupsNameOrIdPatchUpdatedInfo") org.openapis.openapi.models.shared.ContainersGroupsNameOrIdPatchUpdatedInfo containersGroupsNameOrIdPatchUpdatedInfo, @JsonProperty("X-Auth-Project-Id") String xAuthProjectId, @JsonProperty("X-Auth-Token") String xAuthToken, @JsonProperty("name_or_id") String nameOrId) {
        this.containersGroupsNameOrIdPatchUpdatedInfo = containersGroupsNameOrIdPatchUpdatedInfo;
        this.xAuthProjectId = xAuthProjectId;
        this.xAuthToken = xAuthToken;
        this.nameOrId = nameOrId;
