    ...
    public static void main(String[] args) {
        try {
            ...
            PhcerRequestBody req = new PhcerRequestBody(PhcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new PhcerRequestBodyCertificateParameters("Sunil Kumar", "0101-I");;
            ...
            PhcerResponse res = sdk.apIs.phcer(req, new PhcerSecurity("molestiae", "minus") {{
...
* [phcer](docs/apis/README.md#phcer) - Pharmacist Registration Certificate
* [rpcer](docs/apis/README.md#rpcer) - Pharmacist Renewal certificate
