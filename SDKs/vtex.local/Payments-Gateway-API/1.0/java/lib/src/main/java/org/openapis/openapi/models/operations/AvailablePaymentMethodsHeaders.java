...
public class AvailablePaymentMethodsHeaders {
    /**
    ...
    public AvailablePaymentMethodsHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public AvailablePaymentMethodsHeaders withContentType(String contentType) {
    ...
    public AvailablePaymentMethodsHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public AvailablePaymentMethodsHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
