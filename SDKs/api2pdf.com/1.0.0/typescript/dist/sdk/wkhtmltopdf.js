...
exports.Wkhtmltopdf = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var Wkhtmltopdf = /** @class */ (function () {
    function Wkhtmltopdf(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Wkhtmltopdf.prototype.wkhtmltopdfFromHtmlPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.WkhtmltopdfFromHtmlPostRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/wkhtmltopdf/html";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.apiResponseSuccess = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.apiResponseFailure = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Wkhtmltopdf.prototype.wkhtmltopdfFromUrlGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.WkhtmltopdfFromUrlGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/wkhtmltopdf/url";
        var client = this._securityClient;
     ...
     * **Authorization: YOUR-API-KEY**
    **/
    Wkhtmltopdf.prototype.wkhtmltopdfFromUrlPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
