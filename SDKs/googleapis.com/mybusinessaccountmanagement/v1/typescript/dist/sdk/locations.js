...
var Locations = /** @class */ (function () {
    ...
    **/
    Locations.prototype.mybusinessaccountmanagementLocationsAdminsCreate = function (req, config) {
        var _a;
    ...
    **/
    Locations.prototype.mybusinessaccountmanagementLocationsAdminsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Locations.prototype.mybusinessaccountmanagementLocationsAdminsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Locations.prototype.mybusinessaccountmanagementLocationsAdminsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Locations.prototype.mybusinessaccountmanagementLocationsTransfer = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
