...
class Authentication:
    ...
    def get_tlskey(self, request: operations.GetTlskeyRequest) -> operations.GetTlskeyResponse:
        ...
        res = operations.GetTlskeyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def put_tlskey_refresh(self, request: operations.PutTlskeyRefreshRequest) -> operations.PutTlskeyRefreshResponse:
        ...
        res = operations.PutTlskeyRefreshResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CertificateRefresh])
