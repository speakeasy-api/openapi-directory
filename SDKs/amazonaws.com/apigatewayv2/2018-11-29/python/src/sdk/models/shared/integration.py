...
class IntegrationConnectionTypeEnum(str, Enum):
...
class IntegrationContentHandlingStrategyEnum(str, Enum):
...
class IntegrationIntegrationTypeEnum(str, Enum):
...
class IntegrationPassthroughBehaviorEnum(str, Enum):
...
class Integration:
    ...
    connection_type: Optional[IntegrationConnectionTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ConnectionType'), 'exclude': lambda f: f is None }})  
    content_handling_strategy: Optional[IntegrationContentHandlingStrategyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ContentHandlingStrategy'), 'exclude': lambda f: f is None }})  
    ...
    integration_type: Optional[IntegrationIntegrationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('IntegrationType'), 'exclude': lambda f: f is None }})  
    ...
    passthrough_behavior: Optional[IntegrationPassthroughBehaviorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PassthroughBehavior'), 'exclude': lambda f: f is None }})  
    ...
    tls_config: Optional[IntegrationTLSConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TlsConfig'), 'exclude': lambda f: f is None }})  
