...
class RatesInformationRate
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\RatesInformationRateMonetaryValue $confirmationAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('confirmation_amount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\RatesInformationRateMonetaryValue')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\RatesInformationRateMonetaryValue $insuranceAmount
     */
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\RatesInformationRateMonetaryValue $otherAmount
     */
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\RatesInformationRateRateTypeEnum>')]
     ...
     * The shipping amount
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\RatesInformationRateMonetaryValue $shippingAmount
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RatesInformationRateMonetaryValue $taxAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('tax_amount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\RatesInformationRateMonetaryValue')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?RatesInformationRateMonetaryValue $taxAmount = null;
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\RatesInformationRateValidationStatusEnum>')]
	...
	public function __construct()
	{
		...
		$this->confirmationAmount = new \OpenAPI\OpenAPI\Models\Shared\RatesInformationRateMonetaryValue();
		$this->deliveryDays = null;
		$this->errorMessages = [];
		$this->estimatedDeliveryDate = null;
		$this->guaranteedService = false;
		$this->insuranceAmount = new \OpenAPI\OpenAPI\Models\Shared\RatesInformationRateMonetaryValue();
		$this->negotiatedRate = false;
		$this->otherAmount = new \OpenAPI\OpenAPI\Models\Shared\RatesInformationRateMonetaryValue();
		$this->packageType = "";
		$this->rateId = "";
		$this->rateType = \OpenAPI\OpenAPI\Models\Shared\RatesInformationRateRateTypeEnum::CHECK;
		$this->serviceCode = "";
		$this->serviceType = "";
		$this->shipDate = null;
		$this->shippingAmount = new \OpenAPI\OpenAPI\Models\Shared\RatesInformationRateMonetaryValue();
		$this->taxAmount = null;
		$this->trackable = false;
		$this->validationStatus = \OpenAPI\OpenAPI\Models\Shared\RatesInformationRateValidationStatusEnum::VALID;
