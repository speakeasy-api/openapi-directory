...
from ..shared import instructpayoutrequestv3 as shared_instructpayoutrequestv3
...
class InstructPayoutV3Request:
    ...
    r"""Id of the payout"""  
    instruct_payout_request_v3: Optional[shared_instructpayoutrequestv3.InstructPayoutRequestV3] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
