...
class Roles:
    ...
    def get_classifications_roles(self, request: operations.GetClassificationsRolesRequest) -> operations.GetClassificationsRolesResponse:
        r"""Retrieve a list of roles"""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/classifications/roles'
        ...
        res = operations.GetClassificationsRolesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
