...
import { FutureReservationsScopedList } from "./futurereservationsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum FutureReservationsAggregatedListResponseWarningCodeEnum {
...
export declare class FutureReservationsAggregatedListResponseWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class FutureReservationsAggregatedListResponseWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: FutureReservationsAggregatedListResponseWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: FutureReservationsAggregatedListResponseWarningData[];
    /**
 ...
 */
export declare class FutureReservationsAggregatedListResponse extends SpeakeasyBase {
    etag?: string;
    /**
     ...
     */
    items?: Record<string, FutureReservationsScopedList>;
    /**
     ...
     * [Output Only] Informational warning message.
     */
    warning?: FutureReservationsAggregatedListResponseWarning;
}
