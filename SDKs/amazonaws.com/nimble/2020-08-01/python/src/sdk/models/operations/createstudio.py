...
class CreateStudioRequestBodyStudioEncryptionConfiguration:
    ...
    key_type: Optional[shared_studioencryptionconfigurationkeytype_enum.StudioEncryptionConfigurationKeyTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('keyType') }})
    

@dataclass_json
@dataclasses.dataclass
class CreateStudioRequestBody:
    admin_role_arn: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('adminRoleArn') }})
    display_name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('displayName') }})
    studio_name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('studioName') }})
    user_role_arn: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('userRoleArn') }})
    studio_encryption_configuration: Optional[CreateStudioRequestBodyStudioEncryptionConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('studioEncryptionConfiguration') }})
    tags: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tags') }})
    

@dataclasses.dataclass
class CreateStudioRequest:
    headers: CreateStudioHeaders = dataclasses.field()
    request: CreateStudioRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
