...
class AssignedIssueEvent
{
     ...
     * A GitHub user.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\SimpleUser $assignee
     */
     ...
     * A GitHub user.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\SimpleUser $assigner
     */
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\Integration $performedViaGithubApp
     */
	#[\JMS\Serializer\Annotation\SerializedName('performed_via_github_app')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\Integration')]
	...
	public function __construct()
	{
		...
		$this->assignee = new \OpenAPI\OpenAPI\Models\Shared\SimpleUser();
		$this->assigner = new \OpenAPI\OpenAPI\Models\Shared\SimpleUser();
		$this->commitId = "";
		$this->commitUrl = "";
		$this->createdAt = "";
		$this->event = "";
		$this->id = 0;
		$this->nodeId = "";
		$this->performedViaGithubApp = new \OpenAPI\OpenAPI\Models\Shared\Integration();
		$this->url = "";
	}
}
