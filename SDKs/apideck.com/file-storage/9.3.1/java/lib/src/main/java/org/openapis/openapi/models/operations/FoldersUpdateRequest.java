...
public class FoldersUpdateRequest {
    ...
    public FoldersUpdateRequest(@JsonProperty("UpdateFolderRequestInput") org.openapis.openapi.models.shared.UpdateFolderRequestInput updateFolderRequestInput, @JsonProperty("id") String id, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.updateFolderRequestInput = updateFolderRequestInput;
        this.id = id;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
