...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Tapcn(ctx, operations.TapcnRequestBody{
        CertificateParameters: &operations.TapcnRequestBodyCertificateParameters{
        ...
        Format: operations.TapcnRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.TapcnSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Tdlcs(ctx, operations.TdlcsRequestBody{
        CertificateParameters: &operations.TdlcsRequestBodyCertificateParameters{
        ...
        Format: operations.TdlcsRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.TdlcsSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Ugdcn(ctx, operations.UgdcnRequestBody{
        CertificateParameters: &operations.UgdcnRequestBodyCertificateParameters{
            DocumentNumber: "12345678",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
            Consent: shared.ConsentArtifactSchemaConsent{
        ...
        Format: operations.UgdcnRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.UgdcnSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
