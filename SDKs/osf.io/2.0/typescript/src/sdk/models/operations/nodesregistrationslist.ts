 ...
 */
export enum NodesRegistrationsListRegistrationAttributesCategoryEnum {
  Analysis = "analysis",
 ...
 */
export class NodesRegistrationsListRegistrationAttributes extends SpeakeasyBase {
  /**
   * The category of the registered node.
   */
  @SpeakeasyMetadata()
 ...
 */
export class NodesRegistrationsListRegistrationLinks extends SpeakeasyBase {
  /**
 ...
 */
export class NodesRegistrationsListRegistrationRelationships extends SpeakeasyBase {
  /**
...
export class NodesRegistrationsListRegistration extends SpeakeasyBase {
  /**
   * The properties of the registration entity.
   */
  @SpeakeasyMetadata()
