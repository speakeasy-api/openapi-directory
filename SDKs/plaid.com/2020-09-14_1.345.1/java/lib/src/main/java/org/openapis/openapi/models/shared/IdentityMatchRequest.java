...
public class IdentityMatchRequest {
    ...
    public IdentityMatchRequest withIdentityVerificationId(String identityVerificationId) {
    ...
    public IdentityMatchRequest(@JsonProperty("access_token") String accessToken) {
        this.accessToken = accessToken;
  }
}
