...
export class Divisions {
  ...
  civicinfoDivisionsSearch(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CivicinfoDivisionsSearchResponse =
        new operations.CivicinfoDivisionsSearchResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.divisionSearchResponse = utils.objectToClass(
              httpRes?.data,
              shared.DivisionSearchResponse
            );
          }
          break;
      }
