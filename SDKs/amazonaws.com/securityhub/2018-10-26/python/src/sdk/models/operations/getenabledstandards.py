...
class GetEnabledStandardsRequestBody:
    ...
    standards_subscription_arns: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('StandardsSubscriptionArns') }})
    

@dataclasses.dataclass
class GetEnabledStandardsRequest:
    headers: GetEnabledStandardsHeaders = dataclasses.field()
    query_params: GetEnabledStandardsQueryParams = dataclasses.field()
    request: GetEnabledStandardsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
