...
public class Replies {
    ...
    **/
    public openapisdk.models.operations.DriveRepliesCreateResponse driveRepliesCreate(openapisdk.models.operations.DriveRepliesCreateRequest request) throws Exception {
        ...
        openapisdk.models.operations.DriveRepliesCreateResponse res = new openapisdk.models.operations.DriveRepliesCreateResponse() {{
            reply = null;
        }};
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.Reply out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.Reply.class);
                res.reply = out;
            }
        }
    ...
    public openapisdk.models.operations.DriveRepliesListResponse driveRepliesList(openapisdk.models.operations.DriveRepliesListRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.ReplyList out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ReplyList.class);
                res.replyList = out;
            }
        }
