 ...
 */
export enum InstanceListReferrersWarningCodeEnum {
...
export class InstanceListReferrersWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceListReferrersWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceListReferrersWarningData })
  @Expose({ name: "data" })
 ...
 */
export class InstanceListReferrers extends SpeakeasyBase {
  /**
