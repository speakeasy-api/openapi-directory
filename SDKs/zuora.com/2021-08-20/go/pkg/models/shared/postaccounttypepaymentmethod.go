...
type POSTAccountTypePaymentMethodAccountHolderInfo struct {
...
type POSTAccountTypePaymentMethodBankAccountTypeEnum string

const (
	POSTAccountTypePaymentMethodBankAccountTypeEnumBusinessChecking POSTAccountTypePaymentMethodBankAccountTypeEnum = "BusinessChecking"
	POSTAccountTypePaymentMethodBankAccountTypeEnumChecking         POSTAccountTypePaymentMethodBankAccountTypeEnum = "Checking"
	POSTAccountTypePaymentMethodBankAccountTypeEnumSaving           POSTAccountTypePaymentMethodBankAccountTypeEnum = "Saving"
)

func (e *POSTAccountTypePaymentMethodBankAccountTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Checking":
		fallthrough
	case "Saving":
		*e = POSTAccountTypePaymentMethodBankAccountTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTAccountTypePaymentMethodBankAccountTypeEnum: %s", s)
	}
}

// POSTAccountTypePaymentMethodMitConsentAgreementSrcEnum - Required if you set the `mitProfileAction` field.
type POSTAccountTypePaymentMethodMitConsentAgreementSrcEnum string

const (
	POSTAccountTypePaymentMethodMitConsentAgreementSrcEnumExternal POSTAccountTypePaymentMethodMitConsentAgreementSrcEnum = "External"
)

func (e *POSTAccountTypePaymentMethodMitConsentAgreementSrcEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	switch s {
	case "External":
		*e = POSTAccountTypePaymentMethodMitConsentAgreementSrcEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTAccountTypePaymentMethodMitConsentAgreementSrcEnum: %s", s)
	}
}

// POSTAccountTypePaymentMethodMitProfileActionEnum - If you set this field, Zuora creates a stored credential profile within the payment method.
//
...
type POSTAccountTypePaymentMethodMitProfileActionEnum string

const (
	POSTAccountTypePaymentMethodMitProfileActionEnumActivate POSTAccountTypePaymentMethodMitProfileActionEnum = "Activate"
	POSTAccountTypePaymentMethodMitProfileActionEnumPersist  POSTAccountTypePaymentMethodMitProfileActionEnum = "Persist"
)

func (e *POSTAccountTypePaymentMethodMitProfileActionEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Activate":
		fallthrough
	case "Persist":
		*e = POSTAccountTypePaymentMethodMitProfileActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTAccountTypePaymentMethodMitProfileActionEnum: %s", s)
	}
}
...
type POSTAccountTypePaymentMethodMitProfileTypeEnum string

const (
	POSTAccountTypePaymentMethodMitProfileTypeEnumRecurring   POSTAccountTypePaymentMethodMitProfileTypeEnum = "Recurring"
	POSTAccountTypePaymentMethodMitProfileTypeEnumUnscheduled POSTAccountTypePaymentMethodMitProfileTypeEnum = "Unscheduled"
)

func (e *POSTAccountTypePaymentMethodMitProfileTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Recurring":
		fallthrough
	case "Unscheduled":
		*e = POSTAccountTypePaymentMethodMitProfileTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTAccountTypePaymentMethodMitProfileTypeEnum: %s", s)
	}
}

// POSTAccountTypePaymentMethod - Container for custom fields of a payment method object.
type POSTAccountTypePaymentMethod struct {
	...
	AccountHolderInfo *POSTAccountTypePaymentMethodAccountHolderInfo `json:"accountHolderInfo,omitempty"`
	...
	//
	BankAccountType *POSTAccountTypePaymentMethodBankAccountTypeEnum `json:"bankAccountType,omitempty"`
	...
	//
	MitConsentAgreementSrc *POSTAccountTypePaymentMethodMitConsentAgreementSrcEnum `json:"mitConsentAgreementSrc,omitempty"`
	...
	// * `Persist` - Use this value if the stored credential profile represents a stored credential profile in an external system. The status of the payment method's stored credential profile will be `Active`.
	//
	MitProfileAction *POSTAccountTypePaymentMethodMitProfileActionEnum `json:"mitProfileAction,omitempty"`
	...
	//
	MitProfileType *POSTAccountTypePaymentMethodMitProfileTypeEnum `json:"mitProfileType,omitempty"`
