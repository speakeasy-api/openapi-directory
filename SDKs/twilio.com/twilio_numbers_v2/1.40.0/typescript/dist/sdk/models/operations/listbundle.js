...
exports.ListBundleResponse = exports.ListBundleListBundleResponse = exports.ListBundleListBundleResponseMeta = exports.ListBundleRequest = exports.ListBundleSecurity = exports.ListBundleServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListBundleServerList = ["https://numbers.twilio.com"];
var ListBundleSecurity = /** @class */ (function (_super) {
    ...
    ], ListBundleSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListBundleSecurity.prototype, "username", void 0);
...
var ListBundleRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListBundleRequest.prototype, "friendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=HasValidUntilDate",
        }),
        __metadata("design:type", Boolean)
    ], ListBundleRequest.prototype, "hasValidUntilDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=IsoCountry",
        }),
        __metadata("design:type", String)
    ], ListBundleRequest.prototype, "isoCountry", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=NumberType",
        }),
        __metadata("design:type", String)
    ], ListBundleRequest.prototype, "numberType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListBundleRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListBundleRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListBundleRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=RegulationSid",
        }),
        __metadata("design:type", String)
    ], ListBundleRequest.prototype, "regulationSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SortBy",
        }),
        __metadata("design:type", String)
    ], ListBundleRequest.prototype, "sortBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SortDirection",
        }),
        __metadata("design:type", String)
    ], ListBundleRequest.prototype, "sortDirection", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListBundleRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ValidUntilDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ListBundleRequest.prototype, "validUntilDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ValidUntilDate<;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ListBundleRequest.prototype, "validUntilDateLessThan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ValidUntilDate>;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ListBundleRequest.prototype, "validUntilDateGreaterThan", void 0);
...
var ListBundleListBundleResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListBundleListBundleResponseMeta; }),
        __metadata("design:type", ListBundleListBundleResponseMeta)
    ], ListBundleListBundleResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.NumbersV2RegulatoryComplianceBundle }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return shared.NumbersV2RegulatoryComplianceBundle; }),
...
var ListBundleResponse = /** @class */ (function (_super) {
    ...
    ], ListBundleResponse.prototype, "rawResponse", void 0);
