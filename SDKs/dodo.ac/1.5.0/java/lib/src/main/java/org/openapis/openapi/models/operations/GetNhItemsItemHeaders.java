...
public class GetNhItemsItemHeaders {
    /**
    ...
    public GetNhItemsItemHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhItemsItemHeaders withXApiKey(String xApiKey) {
