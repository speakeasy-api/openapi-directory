...
exports.ChannelsEssentials = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ChannelsEssentials = /** @class */ (function () {
    function ChannelsEssentials(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ChannelsEssentials.prototype.createChannel = function (req, config) {
        var _a;
    ...
    **/
    ChannelsEssentials.prototype.deleteChannel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ChannelsEssentials.prototype.editChannel = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ChannelsEssentials.prototype.getChannel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ChannelsEssentials.prototype.getChannelSubscriptions = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetChannelSubscriptionsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{user_id}/channels", req.pathParams);
        var client = this._securityClient;
    ...
    **/
    ChannelsEssentials.prototype.getChannelSubscriptionsAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetChannelSubscriptionsAlt1Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/me/channels";
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    **/
    ChannelsEssentials.prototype.getChannels = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.ChannelsEssentials = ChannelsEssentials;
