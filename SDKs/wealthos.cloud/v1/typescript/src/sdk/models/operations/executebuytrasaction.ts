...
export class ExecuteBuyTrasactionBuyTransactionRequest extends SpeakeasyBase {
  ...
  @Type(() => ExecuteBuyTrasactionBuyTransactionRequestInstructionBuySell)
 ...
 */
export class ExecuteBuyTrasaction500ApplicationJSON extends SpeakeasyBase {
  /**
   * Optional error code
   */
  @SpeakeasyMetadata()
 ...
 */
export class ExecuteBuyTrasaction429ApplicationJSON extends SpeakeasyBase {
  /**
   * Optional error code
   */
  @SpeakeasyMetadata()
 ...
 */
export enum ExecuteBuyTrasaction409ApplicationJSONStatusEnum {
 ...
 * Duplicate request
 */
export class ExecuteBuyTrasaction409ApplicationJSON extends SpeakeasyBase {
  /**
   * Human readable description of the error
   */
  @SpeakeasyMetadata()
 ...
 */
export class ExecuteBuyTrasaction404ApplicationJSON extends SpeakeasyBase {
  /**
   * Optional error code
   */
  @SpeakeasyMetadata()
 ...
 */
export class ExecuteBuyTrasaction403ApplicationJSON extends SpeakeasyBase {
  /**
   * Optional error code
   */
  @SpeakeasyMetadata()
 ...
 */
export class ExecuteBuyTrasaction401ApplicationJSON extends SpeakeasyBase {
  /**
   * Optional error code
   */
  @SpeakeasyMetadata()
 ...
 */
export class ExecuteBuyTrasaction400ApplicationJSON extends SpeakeasyBase {
  /**
   * Optional error code
   */
  @SpeakeasyMetadata()
 ...
 *
 */
export enum ExecuteBuyTrasaction200ApplicationJSONStatusEnum {
  Submitted = "submitted",
 ...
 */
export enum ExecuteBuyTrasaction200ApplicationJSONTransactionsDirectionEnum {
  In = "in",
  Out = "out",
}
 ...
 */
export enum ExecuteBuyTrasaction200ApplicationJSONTransactionsOriginEnum {
  Api = "api",
  AdminUi = "admin_ui",
...
export enum ExecuteBuyTrasaction200ApplicationJSONTransactionsPrimaryTransactionTypeEnum {
  Fees = "Fees",
  Buy = "Buy",
  Sell = "Sell",
  Transfers = "Transfers",
...
export enum ExecuteBuyTrasaction200ApplicationJSONTransactionsStatusEnum {
  Submitted = "submitted",
  Failed = "failed",
}
 ...
 */
export enum ExecuteBuyTrasaction200ApplicationJSONTransactionsSubTransactionTypeEnum {
 ...
 */
export enum ExecuteBuyTrasaction200ApplicationJSONTransactionsSubTypeEnum {
 ...
 */
export enum ExecuteBuyTrasaction200ApplicationJSONTransactionsTypeEnum {
  Pending = "pending",
  Archived = "archived",
}

export class ExecuteBuyTrasaction200ApplicationJSONTransactions extends SpeakeasyBase {
  /**
 ...
 * success
 */
export class ExecuteBuyTrasaction200ApplicationJSON extends SpeakeasyBase {
  /**
  ...
  @Type(() => ExecuteBuyTrasaction200ApplicationJSONTransactions)
