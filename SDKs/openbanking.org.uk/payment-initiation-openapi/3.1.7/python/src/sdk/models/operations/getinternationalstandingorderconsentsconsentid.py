...
class GetInternationalStandingOrderConsentsConsentIDRequest:
    headers: GetInternationalStandingOrderConsentsConsentIDHeaders = dataclasses.field()
    path_params: GetInternationalStandingOrderConsentsConsentIDPathParams = dataclasses.field()
    security: GetInternationalStandingOrderConsentsConsentIDSecurity = dataclasses.field()
