...
exports.DealInput = exports.Deal = exports.DealDealTypeEnum = void 0;
...
var privateauctionterms_2 = require("./privateauctionterms");
...
var Deal = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=creativeRequirements" }),
        __metadata("design:type", creativerequirements_1.CreativeRequirements)
    ], Deal.prototype, "creativeRequirements", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dealType" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=privateAuctionTerms" }),
...
var DealInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=privateAuctionTerms" }),
        __metadata("design:type", privateauctionterms_2.PrivateAuctionTermsInput)
