...
class PutAppValidationConfigurationRequest:
    ...
    put_app_validation_configuration_request: shared_putappvalidationconfigurationrequest.PutAppValidationConfigurationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
