...
public class ListSmsCommandQueryParams {
    ...
    public ListSmsCommandQueryParams withDirection(org.openapis.openapi.models.shared.SmsCommandEnumDirectionEnum direction) {
    ...
    public Long page;
    public ListSmsCommandQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListSmsCommandQueryParams withPageToken(String pageToken) {
    ...
    public ListSmsCommandQueryParams withStatus(org.openapis.openapi.models.shared.SmsCommandEnumStatusEnum status) {
        this.status = status;
        return this;
    }
