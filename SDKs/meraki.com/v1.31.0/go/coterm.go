...
func newCoterm(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *coterm {
	return &coterm{
...
func (s *coterm) GetOrganizationLicensingCotermLicenses(ctx context.Context, request operations.GetOrganizationLicensingCotermLicensesRequest) (*operations.GetOrganizationLicensingCotermLicensesResponse, error) {
	baseURL := s.serverURL
...
func (s *coterm) MoveOrganizationLicensingCotermLicenses(ctx context.Context, request operations.MoveOrganizationLicensingCotermLicensesRequest) (*operations.MoveOrganizationLicensingCotermLicensesResponse, error) {
	baseURL := s.serverURL
