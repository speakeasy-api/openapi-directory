...
export const ListSigningKeyServerList = ["https://api.twilio.com"] as const;
...
export class ListSigningKeyListSigningKeyResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.ApiV2010AccountSigningKey })
  @Expose({ name: "signing_keys" })
  @Type(() => shared.ApiV2010AccountSigningKey)
