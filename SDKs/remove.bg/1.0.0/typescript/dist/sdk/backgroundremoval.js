...
exports.BackgroundRemoval = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var BackgroundRemoval = /** @class */ (function () {
    function BackgroundRemoval(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    BackgroundRemoval.prototype.postRemovebg = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostRemovebgRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/removebg";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.removeBgJsonResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
