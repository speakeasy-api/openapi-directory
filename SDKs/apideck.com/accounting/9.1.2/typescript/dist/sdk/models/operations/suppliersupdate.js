...
exports.SuppliersUpdateResponse = exports.SuppliersUpdateRequest = exports.SuppliersUpdateSecurity = void 0;
...
exports.SuppliersUpdateSecurity = SuppliersUpdateSecurity;
var SuppliersUpdateRequest = /** @class */ (function (_super) {
    ...
    ], SuppliersUpdateRequest.prototype, "supplierInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], SuppliersUpdateRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], SuppliersUpdateRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], SuppliersUpdateRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], SuppliersUpdateRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], SuppliersUpdateRequest.prototype, "xApideckServiceId", void 0);
    return SuppliersUpdateRequest;
}(utils_1.SpeakeasyBase));
exports.SuppliersUpdateRequest = SuppliersUpdateRequest;
var SuppliersUpdateResponse = /** @class */ (function (_super) {
    ...
    ], SuppliersUpdateResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.SuppliersUpdateResponse = SuppliersUpdateResponse;
