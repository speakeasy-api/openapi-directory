...
type DialogflowProjectsLocationsConversationsSuggestionsSuggestConversationSummaryRequest struct {
	...
	GoogleCloudDialogflowV2SuggestConversationSummaryRequest *shared.GoogleCloudDialogflowV2SuggestConversationSummaryRequest `request:"mediaType=application/json"`
	// OAuth access token.
