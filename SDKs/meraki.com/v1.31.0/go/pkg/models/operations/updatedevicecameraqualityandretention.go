...
func (e *UpdateDeviceCameraQualityAndRetentionRequestBodyMotionDetectorVersionEnum) UnmarshalJSON(data []byte) error {
	...
	case "1":
		fallthrough
	case "2":
		*e = UpdateDeviceCameraQualityAndRetentionRequestBodyMotionDetectorVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDeviceCameraQualityAndRetentionRequestBodyMotionDetectorVersionEnum: %s", s)
	}
}
...
func (e *UpdateDeviceCameraQualityAndRetentionRequestBodyQualityEnum) UnmarshalJSON(data []byte) error {
	...
	case "High":
		fallthrough
	case "Standard":
		*e = UpdateDeviceCameraQualityAndRetentionRequestBodyQualityEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDeviceCameraQualityAndRetentionRequestBodyQualityEnum: %s", s)
	}
}
...
func (e *UpdateDeviceCameraQualityAndRetentionRequestBodyResolutionEnum) UnmarshalJSON(data []byte) error {
	...
	case "2880x2880":
		fallthrough
	case "3840x2160":
		*e = UpdateDeviceCameraQualityAndRetentionRequestBodyResolutionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDeviceCameraQualityAndRetentionRequestBodyResolutionEnum: %s", s)
	}
}
