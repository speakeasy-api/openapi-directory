...
use \OpenAPI\OpenAPI\Models\Operations\PodocRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\PodocRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\PodocRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\PodocSecurity;
...
try {
    ...
    $request->certificateParameters = new PodocRequestBodyCertificateParameters();
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->policyNumber = '1574564656';
    ...
    $request->format = PodocRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new PodocSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->podoc($request, $requestSecurity);
