...
class DescribeRulesPackagesRequest:
    ...
    describe_rules_packages_request: shared_describerulespackagesrequest.DescribeRulesPackagesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
