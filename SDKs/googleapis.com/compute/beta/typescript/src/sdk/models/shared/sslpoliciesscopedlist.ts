 ...
 */
export enum SslPoliciesScopedListWarningCodeEnum {
...
export class SslPoliciesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SslPoliciesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: SslPoliciesScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: SslPoliciesScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => SslPoliciesScopedListWarningData)
  data?: SslPoliciesScopedListWarningData[];
...
export class SslPoliciesScopedList extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "warning" })
  @Type(() => SslPoliciesScopedListWarning)
