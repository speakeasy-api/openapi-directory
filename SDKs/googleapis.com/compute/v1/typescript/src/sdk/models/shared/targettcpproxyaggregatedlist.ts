 ...
 */
export enum TargetTcpProxyAggregatedListWarningCodeEnum {
...
export class TargetTcpProxyAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetTcpProxyAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetTcpProxyAggregatedListWarningData })
  @Expose({ name: "data" })
  @Type(() => TargetTcpProxyAggregatedListWarningData)
 ...
 * Successful response
 */
export class TargetTcpProxyAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetTcpProxiesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, TargetTcpProxiesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], TargetTcpProxiesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
