 ...
 */
export enum IpOwnerListWarningCodeEnum {
...
export class IpOwnerListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class IpOwnerListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: IpOwnerListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class IpOwnerList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: InternalIpOwner })
  @Expose({ name: "items" })
