...
export class Api {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.createApi200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.CreateApi200ApplicationJSON
            );
          }
          break;
      }
  ...
  deleteAnApi(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/apis/{apiId}", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DeleteAnApiResponse =
        new operations.DeleteAnApiResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.deleteAnApi200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.DeleteAnApi200ApplicationJSON
            );
          }
          break;
      }
  ...
  getAllApIs(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetAllApIsResponse =
        new operations.GetAllApIsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  singleApi(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SingleApiResponse =
        new operations.SingleApiResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.singleApi200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SingleApi200ApplicationJSON
            );
          }
          break;
      }
  ...
  updateAnApi(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UpdateAnApiResponse =
        new operations.UpdateAnApiResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.updateAnApi200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.UpdateAnApi200ApplicationJSON
            );
          }
          break;
      }
