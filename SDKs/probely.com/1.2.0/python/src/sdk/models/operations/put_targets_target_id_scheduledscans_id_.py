...
class PutTargetsTargetIDScheduledscansIDPathParams:
...
class PutTargetsTargetIDScheduledscansIDRequest:
    path_params: PutTargetsTargetIDScheduledscansIDPathParams = dataclasses.field()
    request: PutTargetsTargetIDScheduledscansIDRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
