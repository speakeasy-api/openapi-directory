...
public class StorageObjectsPatchQueryParams {
    ...
    public StorageObjectsPatchQueryParams withPredefinedAcl(StorageObjectsPatchPredefinedAclEnum predefinedAcl) {
    ...
    public StorageObjectsPatchQueryParams withUploadType(String uploadType) {
    ...
    public StorageObjectsPatchQueryParams withUserProject(String userProject) {
