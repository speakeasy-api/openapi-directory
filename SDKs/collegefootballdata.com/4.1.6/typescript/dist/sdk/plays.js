...
exports.Plays = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var Plays = /** @class */ (function () {
    function Plays(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Type of play stats
    **/
    Plays.prototype.getPlayStatTypes = function (config) {
    ...
    **/
    Plays.prototype.getPlayStats = function (req, config) {
     ...
     * Types of plays
    **/
    Plays.prototype.getPlayTypes = function (config) {
        var baseURL = this._serverURL;
    ...
    **/
    Plays.prototype.getPlays = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
