...
exports.ListingViolationSummary = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ListingViolationSummary = /** @class */ (function () {
    function ListingViolationSummary(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ListingViolationSummary.prototype.getListingViolationsSummary = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetListingViolationsSummaryRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/listing_violation_summary";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json;charset=UTF-8")) {
                        res.complianceSummary = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
...
exports.ListingViolationSummary = ListingViolationSummary;
