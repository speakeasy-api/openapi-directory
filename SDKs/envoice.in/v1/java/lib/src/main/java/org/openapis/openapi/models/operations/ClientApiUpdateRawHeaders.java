...
public class ClientApiUpdateRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ClientApiUpdateRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public ClientApiUpdateRawHeaders withXAuthSecret(String xAuthSecret) {
