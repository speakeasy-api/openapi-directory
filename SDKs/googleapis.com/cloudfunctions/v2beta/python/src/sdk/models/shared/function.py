...
class Function:
    ...
    state_messages: Optional[list[shared_googlecloudfunctionsv2betastatemessage.GoogleCloudFunctionsV2betaStateMessage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('stateMessages') }})
