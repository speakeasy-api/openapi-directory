...
class AttachObjectRequestBody:
    ...
    child_reference: AttachObjectRequestBodyChildReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ChildReference') }})
    r"""The reference that identifies an object."""  
    link_name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('LinkName') }})
    r"""The link name with which the child object is attached to the parent."""  
    parent_reference: AttachObjectRequestBodyParentReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ParentReference') }})
    r"""The reference that identifies an object."""  
...
class AttachObjectRequest:
    ...
    request_body: AttachObjectRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    x_amz_data_partition: str = dataclasses.field(metadata={'header': { 'field_name': 'x-amz-data-partition', 'style': 'simple', 'explode': False }})
    r"""Amazon Resource Name (ARN) that is associated with the <a>Directory</a> where both objects reside. For more information, see <a>arns</a>."""  
