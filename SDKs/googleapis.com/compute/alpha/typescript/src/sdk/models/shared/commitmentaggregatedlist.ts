 ...
 */
export enum CommitmentAggregatedListWarningCodeEnum {
...
export class CommitmentAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class CommitmentAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: CommitmentAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class CommitmentAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: CommitmentsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, CommitmentsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], CommitmentsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
