...
from ..shared import liststagesresult as shared_liststagesresult
...
class ListStagesResponse:
    ...
    list_stages_result: Optional[shared_liststagesresult.ListStagesResult] = dataclasses.field(default=None)
    r"""Success"""  
