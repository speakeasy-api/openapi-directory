...
var detections_1 = require("./detections");
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.detections = new detections_1.Detections(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
