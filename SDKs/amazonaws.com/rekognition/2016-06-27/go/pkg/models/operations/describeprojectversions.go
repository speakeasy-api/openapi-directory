...
func (e DescribeProjectVersionsXAmzTargetEnum) ToPointer() *DescribeProjectVersionsXAmzTargetEnum {
	return &e
}
...
func (e *DescribeProjectVersionsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "RekognitionService.DescribeProjectVersions":
		*e = DescribeProjectVersionsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeProjectVersionsXAmzTargetEnum: %v", v)
	}
}

type DescribeProjectVersionsRequest struct {
	DescribeProjectVersionsRequest shared.DescribeProjectVersionsRequest `request:"mediaType=application/json"`
	// Pagination limit
