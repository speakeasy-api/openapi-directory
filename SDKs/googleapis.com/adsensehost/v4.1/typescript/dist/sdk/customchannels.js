...
var Customchannels = /** @class */ (function () {
    ...
    **/
    Customchannels.prototype.adsensehostCustomchannelsDelete = function (req, config) {
    ...
    **/
    Customchannels.prototype.adsensehostCustomchannelsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Customchannels.prototype.adsensehostCustomchannelsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Customchannels.prototype.adsensehostCustomchannelsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Customchannels.prototype.adsensehostCustomchannelsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Customchannels.prototype.adsensehostCustomchannelsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
