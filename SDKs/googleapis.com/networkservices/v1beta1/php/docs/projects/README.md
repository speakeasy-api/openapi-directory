...
try {
    ...
    $request->endpointPolicyInput->endpointMatcher->metadataLabelMatcher->metadataLabelMatchCriteria = MetadataLabelMatcherMetadataLabelMatchCriteriaEnum::MATCH_ALL;
