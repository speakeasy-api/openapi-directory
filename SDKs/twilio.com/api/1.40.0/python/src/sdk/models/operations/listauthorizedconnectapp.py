...
class ListAuthorizedConnectAppRequest:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the AuthorizedConnectApp resources to read."""  
...
class ListAuthorizedConnectAppListAuthorizedConnectAppResponse:
    ...
    authorized_connect_apps: Optional[list[shared_api_v2010_account_authorized_connect_app.APIV2010AccountAuthorizedConnectApp]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authorized_connect_apps'), 'exclude': lambda f: f is None }})  
