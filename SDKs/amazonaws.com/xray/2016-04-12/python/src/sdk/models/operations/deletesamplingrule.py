...
class DeleteSamplingRuleRequestBody:
    ...
    r"""The ARN of the sampling rule. Specify a rule by either name or ARN, but not both."""  
    ...
    r"""The name of the sampling rule. Specify a rule by either name or ARN, but not both."""  
    

@dataclasses.dataclass
class DeleteSamplingRuleRequest:
    
    request_body: DeleteSamplingRuleRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
