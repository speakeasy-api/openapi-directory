...
export class TranslateProjectsLocationsGlossariesGlossaryEntriesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class TranslateProjectsLocationsGlossariesGlossaryEntriesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class TranslateProjectsLocationsGlossariesGlossaryEntriesListSecurity extends SpeakeasyBase {
...
export class TranslateProjectsLocationsGlossariesGlossaryEntriesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class TranslateProjectsLocationsGlossariesGlossaryEntriesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
