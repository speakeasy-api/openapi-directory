...
from ..shared import enableallfeaturesresponse as shared_enableallfeaturesresponse
...
class EnableAllFeaturesRequest:
    ...
    x_amz_target: EnableAllFeaturesXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})  
...
class EnableAllFeaturesResponse:
    ...
    enable_all_features_response: Optional[shared_enableallfeaturesresponse.EnableAllFeaturesResponse] = dataclasses.field(default=None)
    r"""Success"""  
