...
public class RequestreportbyscheduleQueryParams {
    /**
    ...
    public RequestreportbyscheduleQueryParams withBeginDate(Integer beginDate) {
    ...
    public RequestreportbyscheduleQueryParams withEndDate(Integer endDate) {
    ...
    public RequestreportbyscheduleQueryParams withRequesterEmail(String requesterEmail) {
