 ...
 */
export declare enum UsersNodesListNodeAttributesCategoryEnum {
    Analysis = "analysis",
 ...
 */
export declare class UsersNodesListNodeAttributes extends SpeakeasyBase {
    /**
     * The category of the node, as selected by project contributors.
     */
    category: UsersNodesListNodeAttributesCategoryEnum;
    /**
 ...
 */
export declare class UsersNodesListNodeLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class UsersNodesListNodeRelationships extends SpeakeasyBase {
    /**
...
export declare class UsersNodesListNode extends SpeakeasyBase {
    /**
     * The properties of the node entity.
     */
    attributes: UsersNodesListNodeAttributes;
    /**
     ...
     * URLs to alternative representations of the node entity.
     */
    links?: UsersNodesListNodeLinks;
    /**
     * URLs to other entities or entity collections that have a relationship to the node entity.
     */
    relationships?: UsersNodesListNodeRelationships;
    /**
