...
export class PutVolumesIdUpdateVolumeRequest extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "labels" })
  @Type(() => PutVolumesIdUpdateVolumeRequestLabels)
...
export class PutVolumesId200ApplicationJSONVolume extends SpeakeasyBase {
  ...
  @Type(() => PutVolumesId200ApplicationJSONVolumeLocation)
  ...
  @Type(() => PutVolumesId200ApplicationJSONVolumeProtection)
...
export class PutVolumesId200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "volume" })
  @Type(() => PutVolumesId200ApplicationJSONVolume)
