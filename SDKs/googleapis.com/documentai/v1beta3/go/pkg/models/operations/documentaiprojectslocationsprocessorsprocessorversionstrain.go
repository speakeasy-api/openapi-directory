...
type DocumentaiProjectsLocationsProcessorsProcessorVersionsTrainRequest struct {
	...
	GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequest *shared.GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequest `request:"mediaType=application/json"`
	// OAuth access token.
