...
exports.DeletePensionRevisionByNumberResponse = exports.DeletePensionRevisionByNumberRequest = void 0;
...
var DeletePensionRevisionByNumberRequest = /** @class */ (function (_super) {
    ...
    ], DeletePensionRevisionByNumberRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeletePensionRevisionByNumberRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeletePensionRevisionByNumberRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PensionId",
        }),
        __metadata("design:type", String)
    ], DeletePensionRevisionByNumberRequest.prototype, "pensionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RevisionNumber",
        }),
        __metadata("design:type", String)
    ], DeletePensionRevisionByNumberRequest.prototype, "revisionNumber", void 0);
...
var DeletePensionRevisionByNumberResponse = /** @class */ (function (_super) {
    ...
    ], DeletePensionRevisionByNumberResponse.prototype, "rawResponse", void 0);
