...
type TranslateProjectsLocationsGlossariesCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type TranslateProjectsLocationsGlossariesCreatePathParams struct {
	// Required. The project name.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type TranslateProjectsLocationsGlossariesCreateQueryParams struct {
	// V1 error format.
...
type TranslateProjectsLocationsGlossariesCreateResponse struct {
	ContentType string
	// Successful response
