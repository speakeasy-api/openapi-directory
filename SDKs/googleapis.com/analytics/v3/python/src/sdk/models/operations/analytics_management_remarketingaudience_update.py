...
class AnalyticsManagementRemarketingAudienceUpdatePathParams:
...
@dataclasses.dataclass
class AnalyticsManagementRemarketingAudienceUpdateQueryParams:
...
@dataclasses.dataclass
class AnalyticsManagementRemarketingAudienceUpdateSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class AnalyticsManagementRemarketingAudienceUpdateRequest:
    path_params: AnalyticsManagementRemarketingAudienceUpdatePathParams = dataclasses.field()
    query_params: AnalyticsManagementRemarketingAudienceUpdateQueryParams = dataclasses.field()
    security: AnalyticsManagementRemarketingAudienceUpdateSecurity = dataclasses.field()
...
@dataclasses.dataclass
class AnalyticsManagementRemarketingAudienceUpdateResponse:
