...
var DraftPickHometownInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=countryFips" }),
...
var DraftPick = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=collegeAthleteId" }),
        __metadata("design:type", Number)
    ], DraftPick.prototype, "collegeAthleteId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=collegeConference" }),
        __metadata("design:type", String)
    ], DraftPick.prototype, "collegeConference", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=collegeId" }),
        __metadata("design:type", Number)
    ], DraftPick.prototype, "collegeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=collegeTeam" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=nflAthleteId" }),
        __metadata("design:type", Number)
    ], DraftPick.prototype, "nflAthleteId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=nflTeam" }),
        __metadata("design:type", String)
    ], DraftPick.prototype, "nflTeam", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=overall" }),
        __metadata("design:type", Number)
    ], DraftPick.prototype, "overall", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=pick" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=preDraftGrade" }),
        __metadata("design:type", Number)
    ], DraftPick.prototype, "preDraftGrade", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=preDraftPositionRanking" }),
        __metadata("design:type", Number)
    ], DraftPick.prototype, "preDraftPositionRanking", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=preDraftRanking" }),
        __metadata("design:type", Number)
    ], DraftPick.prototype, "preDraftRanking", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=round" }),
        __metadata("design:type", Number)
