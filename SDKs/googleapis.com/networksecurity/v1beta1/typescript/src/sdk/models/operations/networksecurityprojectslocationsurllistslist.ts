...
export class NetworksecurityProjectsLocationsUrlListsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsUrlListsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsUrlListsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
