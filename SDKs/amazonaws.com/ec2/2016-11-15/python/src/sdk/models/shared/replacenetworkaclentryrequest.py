...
class ReplaceNetworkACLEntryRequestRuleActionEnum(str, Enum):
...
class ReplaceNetworkACLEntryRequest:
    ...
    rule_action: ReplaceNetworkACLEntryRequestRuleActionEnum = dataclasses.field()  
    ...
    icmp_type_code: Optional[ReplaceNetworkACLEntryRequestIcmpTypeCode] = dataclasses.field(default=None)  
    ipv6_cidr_block: Optional[str] = dataclasses.field(default=None)  
    port_range: Optional[ReplaceNetworkACLEntryRequestPortRange] = dataclasses.field(default=None)  
