...
class UntagResourceRequest:
    ...
    r"""The ARN of the Elastic Inference Accelerator to untag."""  
    tag_keys: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'tagKeys', 'style': 'form', 'explode': True }})
    r"""The list of tags to remove from the Elastic Inference Accelerator."""  
...
class UntagResourceResponse:
    ...
    untag_resource_result: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
