...
func (s *campaign) CloneCampaign(ctx context.Context, request operations.CloneCampaignRequest) (*operations.CloneCampaignResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/clone", request.PathParams, nil)
...
func (s *campaign) DeleteCampaign(ctx context.Context, request operations.DeleteCampaignRequest) (*operations.DeleteCampaignResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}", request.PathParams, nil)
...
func (s *campaign) EndCampaign(ctx context.Context, request operations.EndCampaignRequest) (*operations.EndCampaignResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/end", request.PathParams, nil)
...
func (s *campaign) PauseCampaign(ctx context.Context, request operations.PauseCampaignRequest) (*operations.PauseCampaignResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/pause", request.PathParams, nil)
...
func (s *campaign) ResumeCampaign(ctx context.Context, request operations.ResumeCampaignRequest) (*operations.ResumeCampaignResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/resume", request.PathParams, nil)
...
func (s *campaign) SuggestItems(ctx context.Context, request operations.SuggestItemsRequest) (*operations.SuggestItemsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/suggest_items", request.PathParams, nil)
...
func (s *campaign) UpdateAdRateStrategy(ctx context.Context, request operations.UpdateAdRateStrategyRequest) (*operations.UpdateAdRateStrategyResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/update_ad_rate_strategy", request.PathParams, nil)
...
func (s *campaign) UpdateCampaignBudget(ctx context.Context, request operations.UpdateCampaignBudgetRequest) (*operations.UpdateCampaignBudgetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/update_campaign_budget", request.PathParams, nil)
...
func (s *campaign) UpdateCampaignIdentification(ctx context.Context, request operations.UpdateCampaignIdentificationRequest) (*operations.UpdateCampaignIdentificationResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/update_campaign_identification", request.PathParams, nil)
