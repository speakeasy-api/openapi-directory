...
from ..shared import deletebotversionresponse as shared_deletebotversionresponse
...
class DeleteBotVersionRequest:
    headers: DeleteBotVersionHeaders = dataclasses.field()
    path_params: DeleteBotVersionPathParams = dataclasses.field()
    query_params: DeleteBotVersionQueryParams = dataclasses.field()
...
class DeleteBotVersionResponse:
    ...
    delete_bot_version_response: Optional[shared_deletebotversionresponse.DeleteBotVersionResponse] = dataclasses.field(default=None)
