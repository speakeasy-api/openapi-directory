...
export class DialogflowProjectsLocationsConversationsMessagesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsConversationsMessagesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class DialogflowProjectsLocationsConversationsMessagesListSecurity extends SpeakeasyBase {
...
export class DialogflowProjectsLocationsConversationsMessagesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsConversationsMessagesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
