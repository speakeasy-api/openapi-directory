...
class ServiceInventoriesCollection:
    data: Optional[list[shared_serviceinventory.ServiceInventory]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
