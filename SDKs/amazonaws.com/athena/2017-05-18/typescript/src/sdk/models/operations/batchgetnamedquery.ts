...
export enum BatchGetNamedQueryXAmzTargetEnum {
  AmazonAthenaBatchGetNamedQuery = "AmazonAthena.BatchGetNamedQuery",
}

export class BatchGetNamedQueryRequest extends SpeakeasyBase {
...
export class BatchGetNamedQueryResponse extends SpeakeasyBase {
  /**
   * Success
   */
  @SpeakeasyMetadata()
