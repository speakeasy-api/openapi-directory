...
class DeleteRateBasedRuleRequest:
    ...
    delete_rate_based_rule_request: shared_deleteratebasedrulerequest.DeleteRateBasedRuleRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
