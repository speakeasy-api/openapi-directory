...
public class DescribeBundleTasksRequestFilters {
    ...
    public DescribeBundleTasksRequestFilters withValues(String[] values) {
        this.values = values;
        return this;
    }
    
    public DescribeBundleTasksRequestFilters(){}
}
