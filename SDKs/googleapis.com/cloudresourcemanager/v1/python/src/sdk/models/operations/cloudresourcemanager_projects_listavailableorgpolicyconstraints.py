...
class CloudresourcemanagerProjectsListAvailableOrgPolicyConstraintsRequest:
    ...
    r"""Name of the resource to list `Constraints` for."""  
    ...
    list_available_org_policy_constraints_request: Optional[shared_listavailableorgpolicyconstraintsrequest.ListAvailableOrgPolicyConstraintsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
