...
class ObjectPutInvoiceAdjustmentPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectPutInvoiceAdjustmentQueryParams:
...
@dataclasses.dataclass
class ObjectPutInvoiceAdjustmentHeaders:
...
class ObjectPutInvoiceAdjustmentRequest:
    headers: ObjectPutInvoiceAdjustmentHeaders = dataclasses.field()
    path_params: ObjectPutInvoiceAdjustmentPathParams = dataclasses.field()
    query_params: ObjectPutInvoiceAdjustmentQueryParams = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class ObjectPutInvoiceAdjustmentResponse:
