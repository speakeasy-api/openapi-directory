...
export class ContentOrdersCreatetestreturnSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentOrdersCreatetestreturnRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentOrdersCreatetestreturnResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
