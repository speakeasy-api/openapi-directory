 ...
 * Profile attributes
 */
export class UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyProfile extends SpeakeasyBase {
  /**
...
export class UpdateOrganizationConfigTemplateSwitchProfilePortRequestBody extends SpeakeasyBase {
  ...
  @Expose({ name: "profile" })
  @Type(
    () => UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyProfile
  )
 ...
 * The type of the access policy of the switch profile port. Only applicable to access ports. Can be one of 'Open', 'Custom access policy', 'MAC allow list' or 'Sticky MAC allow list'.
 */
export enum UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONAccessPolicyTypeEnum {
  CustomAccessPolicy = "Custom access policy",
  MACAllowList = "MAC allow list",
  Open = "Open",
  StickyMACAllowList = "Sticky MAC allow list",
 ...
 * Profile attributes
 */
export class UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONProfile extends SpeakeasyBase {
  /**
   * When enabled, override this port's configuration with a port profile.
   */
  @SpeakeasyMetadata()
 ...
 * The state of the STP guard ('disabled', 'root guard', 'bpdu guard' or 'loop guard').
 */
export enum UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONStpGuardEnum {
  BpduGuard = "bpdu guard",
  Disabled = "disabled",
  LoopGuard = "loop guard",
  RootGuard = "root guard",
 ...
 * The type of the switch profile port ('trunk' or 'access').
 */
export enum UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONTypeEnum {
  Access = "access",
  Trunk = "trunk",
}
 ...
 * The action to take when Unidirectional Link is detected (Alert only, Enforce). Default configuration is Alert only.
 */
export enum UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum {
  AlertOnly = "Alert only",
  Enforce = "Enforce",
}
 ...
 */
export class UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSON extends SpeakeasyBase {
  /**
   * The number of a custom access policy to configure on the switch profile port. Only applicable when 'accessPolicyType' is 'Custom access policy'.
   */
  @SpeakeasyMetadata()
  ...
  @Type(
    () =>
      UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONProfile
  )
