...
var Console = /** @class */ (function () {
    function Console(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    Console.prototype.getAemProductInfo = function (config) {
    ...
    Console.prototype.getConfigMgr = function (config) {
        var baseURL = this._serverURL;
    ...
    Console.prototype.postBundle = function (req, config) {
    ...
    Console.prototype.postJmxRepository = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    Console.prototype.postSamlConfiguration = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "text/plain")) {
                        res.samlConfigurationInfo = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
