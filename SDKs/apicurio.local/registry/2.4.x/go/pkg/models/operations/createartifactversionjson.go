...
type CreateArtifactVersionJSONPathParams struct {
...
type CreateArtifactVersionJSONHeaders struct {
...
type CreateArtifactVersionJSONRequest struct {
	PathParams CreateArtifactVersionJSONPathParams
	Headers    CreateArtifactVersionJSONHeaders
...
type CreateArtifactVersionJSONResponse struct {
	ContentType string
