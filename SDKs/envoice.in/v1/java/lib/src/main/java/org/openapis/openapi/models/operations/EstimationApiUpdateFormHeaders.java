...
public class EstimationApiUpdateFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public EstimationApiUpdateFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public EstimationApiUpdateFormHeaders withXAuthSecret(String xAuthSecret) {
