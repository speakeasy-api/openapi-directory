...
import { TargetTcpProxiesScopedList } from "./targettcpproxiesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum TargetTcpProxyAggregatedListWarningCodeEnum {
...
export declare class TargetTcpProxyAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetTcpProxyAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: TargetTcpProxyAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: TargetTcpProxyAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class TargetTcpProxyAggregatedList extends SpeakeasyBase {
    /**
     ...
     */
    items?: Record<string, TargetTcpProxiesScopedList>;
    /**
