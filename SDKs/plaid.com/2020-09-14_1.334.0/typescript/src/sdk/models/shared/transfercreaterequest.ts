 ...
 */
export enum TransferCreateRequestACHClassEnum {
  Ccd = "ccd",
  Ppd = "ppd",
  Tel = "tel",
  Web = "web",
 ...
 */
export enum TransferCreateRequestTransferNetworkEnum {
  Ach = "ach",
 ...
 */
export enum TransferCreateRequestTransferTypeEnum {
  Debit = "debit",
  Credit = "credit",
}
 ...
 */
export class TransferCreateRequest extends SpeakeasyBase {
  /**
