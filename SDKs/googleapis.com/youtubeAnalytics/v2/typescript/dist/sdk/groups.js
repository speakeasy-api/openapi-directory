...
var Groups = /** @class */ (function () {
    ...
    **/
    Groups.prototype.youtubeAnalyticsGroupsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.YoutubeAnalyticsGroupsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v2/groups";
    ...
    **/
    Groups.prototype.youtubeAnalyticsGroupsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Groups.prototype.youtubeAnalyticsGroupsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Groups.prototype.youtubeAnalyticsGroupsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
