...
class ListCompanyAPICredentialsResponse:
    ...
    data: Optional[list[shared_companyapicredential.CompanyAPICredential]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
