...
public class GetPersonalizedRankingRequestBody {
    ...
    public GetPersonalizedRankingRequestBody(@JsonProperty("campaignArn") String campaignArn, @JsonProperty("inputList") String[] inputList, @JsonProperty("userId") String userId) {
        this.campaignArn = campaignArn;
        this.inputList = inputList;
        this.userId = userId;
  }
