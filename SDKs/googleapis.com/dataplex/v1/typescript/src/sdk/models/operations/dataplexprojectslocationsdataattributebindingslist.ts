...
export class DataplexProjectsLocationsDataAttributeBindingsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsDataAttributeBindingsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsDataAttributeBindingsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
