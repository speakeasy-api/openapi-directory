...
public class GetTruckRouteOutputFormatQueryParams {
    ...
    public GetTruckRouteOutputFormatQueryParams withOutputSRS(GetTruckRouteOutputFormatOutputSrsEnum outputSRS) {
    ...
    public GetTruckRouteOutputFormatQueryParams withPartition(String partition) {
    ...
    public GetTruckRouteOutputFormatQueryParams withTruckRouteMultiplier(Long truckRouteMultiplier) {
