...
class CreateStudioSessionMappingInput:
    ...
    identity_type: shared_identitytype_enum.IdentityTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('IdentityType') }})  
    session_policy_arn: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SessionPolicyArn') }})  
