...
class RegisterWorkflowTypeRequest:
    ...
    register_workflow_type_input: shared_registerworkflowtypeinput.RegisterWorkflowTypeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
