...
export class DatamigrationProjectsLocationsConversionWorkspacesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatamigrationProjectsLocationsConversionWorkspacesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatamigrationProjectsLocationsConversionWorkspacesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
