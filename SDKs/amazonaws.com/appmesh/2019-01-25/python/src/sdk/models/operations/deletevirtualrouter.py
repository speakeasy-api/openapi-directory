...
from ..shared import deletevirtualrouteroutput as shared_deletevirtualrouteroutput
...
class DeleteVirtualRouterRequest:
    headers: DeleteVirtualRouterHeaders = dataclasses.field()
    path_params: DeleteVirtualRouterPathParams = dataclasses.field()
    query_params: DeleteVirtualRouterQueryParams = dataclasses.field()
...
class DeleteVirtualRouterResponse:
    ...
    delete_virtual_router_output: Optional[shared_deletevirtualrouteroutput.DeleteVirtualRouterOutput] = dataclasses.field(default=None)
