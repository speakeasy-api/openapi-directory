...
func (s *operationsT) CloudshellOperationsCancel(ctx context.Context, request operations.CloudshellOperationsCancelRequest) (*operations.CloudshellOperationsCancelResponse, error) {
	baseURL := s.serverURL
...
func (s *operationsT) CloudshellOperationsDelete(ctx context.Context, request operations.CloudshellOperationsDeleteRequest) (*operations.CloudshellOperationsDeleteResponse, error) {
	baseURL := s.serverURL
