...
public class GetTagsTagsSynonymsRequest {
    ...
    public GetTagsTagsSynonymsRequest withCallback(String callback) {
    ...
    public GetTagsTagsSynonymsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetTagsTagsSynonymsRequest withFromdate(Long fromdate) {
    ...
    public GetTagsTagsSynonymsRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetTagsTagsSynonymsRequest withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetTagsTagsSynonymsOrderEnum order;

    public GetTagsTagsSynonymsRequest withOrder(GetTagsTagsSynonymsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetTagsTagsSynonymsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetTagsTagsSynonymsRequest withPagesize(Long pagesize) {
    ...
    public GetTagsTagsSynonymsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetTagsTagsSynonymsSortEnum sort;

    public GetTagsTagsSynonymsRequest withSort(GetTagsTagsSynonymsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetTagsTagsSynonymsRequest withTags(String tags) {
        this.tags = tags;
        return this;
    }
    ...
    public GetTagsTagsSynonymsRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetTagsTagsSynonymsRequest(@JsonProperty("site") String site, @JsonProperty("tags") String tags) {
        this.site = site;
        this.tags = tags;
  }
}
