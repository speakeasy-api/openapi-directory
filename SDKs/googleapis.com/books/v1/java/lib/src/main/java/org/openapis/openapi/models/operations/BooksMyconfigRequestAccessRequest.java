...
public class BooksMyconfigRequestAccessRequest {
    ...
    public BooksMyconfigRequestAccessRequest(@JsonProperty("cpksver") String cpksver, @JsonProperty("nonce") String nonce, @JsonProperty("source") String source, @JsonProperty("volumeId") String volumeId) {
        this.cpksver = cpksver;
        this.nonce = nonce;
        this.source = source;
        this.volumeId = volumeId;
