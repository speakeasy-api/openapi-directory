...
@dataclass_json
@dataclasses.dataclass
class GetDomainRecord401ApplicationJSON:
...
class GetDomainRecordRequest:
    path_params: GetDomainRecordPathParams = dataclasses.field()
...
class GetDomainRecordResponse:
    ...
    get_domain_record_200_application_json_any: Optional[Any] = dataclasses.field(default=None)
    get_domain_record_401_application_json_object: Optional[GetDomainRecord401ApplicationJSON] = dataclasses.field(default=None)
