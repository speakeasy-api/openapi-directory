...
from ..shared import getnotificationconfigurationlistresponse as shared_getnotificationconfigurationlistresponse
...
class PostGetNotificationConfigurationListResponse:
    ...
    get_notification_configuration_list_response: Optional[shared_getnotificationconfigurationlistresponse.GetNotificationConfigurationListResponse] = dataclasses.field(default=None)
