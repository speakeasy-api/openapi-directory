...
class APIV2010AccountUsageUsageRecordUsageRecordYearly:
    ...
    category: Optional[shared_usage_record_yearly_enum_category_enum.UsageRecordYearlyEnumCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('category') }})
