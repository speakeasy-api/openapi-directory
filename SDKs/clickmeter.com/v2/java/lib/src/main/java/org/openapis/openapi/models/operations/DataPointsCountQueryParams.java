...
public class DataPointsCountQueryParams {
    /**
    ...
    public DataPointsCountQueryParams withCreatedAfter(String createdAfter) {
    ...
    public DataPointsCountQueryParams withCreatedBefore(String createdBefore) {
    ...
    public DataPointsCountQueryParams withOnlyFavorites(Boolean onlyFavorites) {
    ...
    public DataPointsCountQueryParams withStatus(DataPointsCountStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public String tags;
    public DataPointsCountQueryParams withTags(String tags) {
        this.tags = tags;
        return this;
    }
    ...
    public DataPointsCountQueryParams withTextSearch(String textSearch) {
    ...
    public DataPointsCountQueryParams withType(DataPointsCountTypeEnum type) {
        this.type = type;
        return this;
    }
