...
class ListUserConversationListUserConversationResponse:
    ...
    conversations: Optional[list[shared_conversations_v1_user_user_conversation.ConversationsV1UserUserConversation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conversations'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListUserConversationListUserConversationResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
...
class ListUserConversationResponse:
    ...
    list_user_conversation_response: Optional[ListUserConversationListUserConversationResponse] = dataclasses.field(default=None)
    r"""OK"""  
