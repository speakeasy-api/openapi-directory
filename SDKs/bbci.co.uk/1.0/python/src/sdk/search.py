...
class Search:
    ...
    def search_suggest_(self, request: operations.SearchSuggestRequest) -> operations.SearchSuggestResponse:
        ...
        query_params = utils.get_query_params(operations.SearchSuggestRequest, request)
        ...
        res = operations.SearchSuggestResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
