...
class GetNetworkWirelessDevicesConnectionStats200ApplicationJSON:
    ...
    connection_stats: Optional[GetNetworkWirelessDevicesConnectionStats200ApplicationJSONConnectionStats] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connectionStats'), 'exclude': lambda f: f is None }})
    r"""The connection stats of the device"""  
...
class GetNetworkWirelessDevicesConnectionStatsResponse:
    ...
    get_network_wireless_devices_connection_stats_200_application_json_objects: Optional[list[GetNetworkWirelessDevicesConnectionStats200ApplicationJSON]] = dataclasses.field(default=None)
