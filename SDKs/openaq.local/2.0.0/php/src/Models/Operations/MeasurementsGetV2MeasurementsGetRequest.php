...
class MeasurementsGetV2MeasurementsGetRequest
{
     ...
     * An enumeration.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MeasurementsGetV2MeasurementsGetOrderByMeasOrderEnum $orderBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=order_by')]
    public ?MeasurementsGetV2MeasurementsGetOrderByMeasOrderEnum $orderBy = null;
     ...
     * An enumeration.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MeasurementsGetV2MeasurementsGetSortSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?MeasurementsGetV2MeasurementsGetSortSortEnum $sort = null;
