...
export class MetastoreProjectsLocationsServicesBackupsDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsServicesBackupsDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsServicesBackupsDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
