 ...
 */
export enum NodeTemplateListWarningCodeEnum {
...
export class NodeTemplateListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NodeTemplateListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: NodeTemplateListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: NodeTemplateListWarningData })
  @Expose({ name: "data" })
  @Type(() => NodeTemplateListWarningData)
  data?: NodeTemplateListWarningData[];
 ...
 */
export class NodeTemplateList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: NodeTemplate })
  @Expose({ name: "items" })
  @Type(() => NodeTemplate)
  items?: NodeTemplate[];
