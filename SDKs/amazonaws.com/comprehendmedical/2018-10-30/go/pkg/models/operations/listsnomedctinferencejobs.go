...
type ListSNOMEDCTInferenceJobsHeaders struct {
...
type ListSNOMEDCTInferenceJobsRequest struct {
	Headers ListSNOMEDCTInferenceJobsHeaders
	Request shared.ListSNOMEDCTInferenceJobsRequest `request:"mediaType=application/json"`
}
