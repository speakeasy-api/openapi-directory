...
class AnalyticsManagementExperimentsGetSecurity:
    option1: Optional[AnalyticsManagementExperimentsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementExperimentsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[AnalyticsManagementExperimentsGetSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class AnalyticsManagementExperimentsGetRequest:
    path_params: AnalyticsManagementExperimentsGetPathParams = dataclasses.field()
    query_params: AnalyticsManagementExperimentsGetQueryParams = dataclasses.field()
    security: AnalyticsManagementExperimentsGetSecurity = dataclasses.field()
