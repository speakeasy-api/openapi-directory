...
export const DeleteLinkshorteningMessagingServiceServerList = [
  "https://messaging.twilio.com",
] as const;

export class DeleteLinkshorteningMessagingServiceSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DeleteLinkshorteningMessagingServiceRequest extends SpeakeasyBase {
  /**
...
export class DeleteLinkshorteningMessagingServiceResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
