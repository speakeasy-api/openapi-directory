...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AddLFTagsToResourceRequestBody:
    ...
    r"""The LF-tags to attach to the resource."""  
    resource: AddLFTagsToResourceRequestBodyResource = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Resource') }})
    r"""A structure for the resource."""  
...
class AddLFTagsToResourceRequest:
    ...
    request_body: AddLFTagsToResourceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
