...
public class GetAdGroupPathParams {
    /**
    ...
    public GetAdGroupPathParams withAdGroupId(String adGroupId) {
    ...
    public GetAdGroupPathParams withCampaignId(String campaignId) {
