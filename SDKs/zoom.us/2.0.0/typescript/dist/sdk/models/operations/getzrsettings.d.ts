 ...
 */
export declare class GetZRSettings200ApplicationXml2ClientAlert extends SpeakeasyBase {
    /**
 ...
 */
export declare class GetZRSettings200ApplicationXml2DigitalSignageBanner extends SpeakeasyBase {
    /**
 ...
 */
export declare class GetZRSettings200ApplicationXml2DigitalSignageDisplayPeriod extends SpeakeasyBase {
    /**
 ...
 *
 */
export declare enum GetZRSettings200ApplicationXml2DigitalSignagePlayListActionEnum {
    Add = "add",
    Update = "update",
    Delete = "delete"
}
 ...
 * Content list.
 */
export declare class GetZRSettings200ApplicationXml2DigitalSignagePlayListContents extends SpeakeasyBase {
    /**
     * Content Id.
     */
    contentId?: string;
...
export declare class GetZRSettings200ApplicationXml2DigitalSignagePlayList extends SpeakeasyBase {
    /**
     * Specify an action for the content list. The value can be one of the following:<br>
     *
     * @remarks
     ...
     *
     */
    action?: GetZRSettings200ApplicationXml2DigitalSignagePlayListActionEnum;
    contents?: GetZRSettings200ApplicationXml2DigitalSignagePlayListContents[];
    /**
...
export declare class GetZRSettings200ApplicationXml2DigitalSignage extends SpeakeasyBase {
    /**
     * Specifies the elements that you want to display in the top banner.
     */
    banner?: GetZRSettings200ApplicationXml2DigitalSignageBanner;
    /**
     * Display period object lets you define the number of minutes before or after the scheduled meeting time you would like the content to display.
     */
    displayPeriod?: GetZRSettings200ApplicationXml2DigitalSignageDisplayPeriod;
    /**
     ...
     * Content list.
     */
    playList?: GetZRSettings200ApplicationXml2DigitalSignagePlayList[];
}
/**
 ...
 */
export declare class GetZRSettings200ApplicationXml2Notification extends SpeakeasyBase {
    /**
...
export declare class GetZRSettings200ApplicationXml2 extends SpeakeasyBase {
    /**
     * The Client Alert Settings section includes alerts that display on the TV screen of the Zoom Room. Disable these settings if you have deliberately disconnected one or more peripheral devices or have never enabled them.
     */
    clientAlert?: GetZRSettings200ApplicationXml2ClientAlert;
    digitalSignage?: GetZRSettings200ApplicationXml2DigitalSignage;
    /**
     * [Notifications Settings](https://support.zoom.us/hc/en-us/articles/205394099-Zoom-Room-Alerts#h_b430b5f2-5150-4522-9c96-c77f22ab70bc) includes the circumstances in which the room sends an email alert to the support team to notify them of a potentially urgent issue. These issues can affect the operation of the room, but do not display on the TV screen. The email alert is sent to the email address specified in the Notification Email Recipients section.
     */
    notification?: GetZRSettings200ApplicationXml2Notification;
}
/**
 ...
 */
export declare enum GetZRSettings200ApplicationXml1MeetingSecurityEncryptionTypeEnum {
    EnhancedEncryption = "enhanced_encryption",
    E2ee = "e2ee"
}
export declare class GetZRSettings200ApplicationXml1MeetingSecurity extends SpeakeasyBase {
    /**
     * Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
     *
     * @remarks
     ...
     * `e2ee`: [End-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871). The encryption key is stored in your local device and can not be obtained by anyone else. Enabling this setting also **disables** the following features: join before host, cloud recording, streaming, live transcription, breakout rooms, polling, 1:1 private chat, and meeting reactions.
     */
    encryptionType?: GetZRSettings200ApplicationXml1MeetingSecurityEncryptionTypeEnum;
    /**
...
export declare class GetZRSettings200ApplicationXml1ZoomRooms extends SpeakeasyBase {
    /**
...
export declare class GetZRSettings200ApplicationXml1 extends SpeakeasyBase {
    meetingSecurity?: GetZRSettings200ApplicationXml1MeetingSecurity;
    zoomRooms?: GetZRSettings200ApplicationXml1ZoomRooms;
}
/**
 * The Client Alert Settings section includes alerts that display on the TV screen of the Zoom Room. Disable these settings if you have deliberately disconnected one or more peripheral devices or have never enabled them.
 */
export declare class GetZRSettings200ApplicationJson2ClientAlert extends SpeakeasyBase {
    /**
     * Display an alert message when an issue is detected with a bluetooth microphone.
     */
    detectBluetoothMicrophoneErrorAlert?: boolean;
 ...
 * Specifies the elements that you want to display in the top banner.
 */
export declare class GetZRSettings200ApplicationJson2DigitalSignageBanner extends SpeakeasyBase {
    /**
     * Display or hide banner room name.
     */
    bannerRoomName?: boolean;
 ...
 * Display period object lets you define the number of minutes before or after the scheduled meeting time you would like the content to display.
 */
export declare class GetZRSettings200ApplicationJson2DigitalSignageDisplayPeriod extends SpeakeasyBase {
    /**
     * Start displaying digital signage content after certain duration after the meeting ends. The value of this field indicates the duration in minutes.
     */
    startDisplayingContent?: number;
 ...
 *
 */
export declare enum GetZRSettings200ApplicationJson2DigitalSignagePlayListActionEnum {
    Add = "add",
    Update = "update",
    Delete = "delete"
}
 ...
 * Content list.
 */
export declare class GetZRSettings200ApplicationJson2DigitalSignagePlayListContents extends SpeakeasyBase {
    /**
     * Content Id.
     */
    contentId?: string;
...
export declare class GetZRSettings200ApplicationJson2DigitalSignagePlayList extends SpeakeasyBase {
    /**
     * Specify an action for the content list. The value can be one of the following:<br>
     *
     * @remarks
     ...
     *
     */
    action?: GetZRSettings200ApplicationJson2DigitalSignagePlayListActionEnum;
    contents?: GetZRSettings200ApplicationJson2DigitalSignagePlayListContents[];
    /**
     * Specify the display end time for the content list in GMT.
     */
    endTime?: string;
...
export declare class GetZRSettings200ApplicationJson2DigitalSignage extends SpeakeasyBase {
    /**
     * Specifies the elements that you want to display in the top banner.
     */
    banner?: GetZRSettings200ApplicationJson2DigitalSignageBanner;
    /**
     * Display period object lets you define the number of minutes before or after the scheduled meeting time you would like the content to display.
     */
    displayPeriod?: GetZRSettings200ApplicationJson2DigitalSignageDisplayPeriod;
    /**
     * [Indicates whether digital signage is on or off,](https://support.zoom.us/hc/en-us/articles/360000030683-Zoom-Rooms-digital-signage#h_767fbb33-82a8-45a8-8392-a1bfa9687edd). <br>
     *
     * @remarks
     ...
     * Content list.
     */
    playList?: GetZRSettings200ApplicationJson2DigitalSignagePlayList[];
}
/**
 * [Notifications Settings](https://support.zoom.us/hc/en-us/articles/205394099-Zoom-Room-Alerts#h_b430b5f2-5150-4522-9c96-c77f22ab70bc) includes the circumstances in which the room sends an email alert to the support team to notify them of a potentially urgent issue. These issues can affect the operation of the room, but do not display on the TV screen. The email alert is sent to the email address specified in the Notification Email Recipients section.
 */
export declare class GetZRSettings200ApplicationJson2Notification extends SpeakeasyBase {
    /**
     * Send an alert when the audio echo test result meets usability threshold.
     */
    audioMeetUsabilityThreshold?: boolean;
...
export declare class GetZRSettings200ApplicationJson2 extends SpeakeasyBase {
    /**
     * The Client Alert Settings section includes alerts that display on the TV screen of the Zoom Room. Disable these settings if you have deliberately disconnected one or more peripheral devices or have never enabled them.
     */
    clientAlert?: GetZRSettings200ApplicationJson2ClientAlert;
    digitalSignage?: GetZRSettings200ApplicationJson2DigitalSignage;
    /**
     * [Notifications Settings](https://support.zoom.us/hc/en-us/articles/205394099-Zoom-Room-Alerts#h_b430b5f2-5150-4522-9c96-c77f22ab70bc) includes the circumstances in which the room sends an email alert to the support team to notify them of a potentially urgent issue. These issues can affect the operation of the room, but do not display on the TV screen. The email alert is sent to the email address specified in the Notification Email Recipients section.
     */
    notification?: GetZRSettings200ApplicationJson2Notification;
}
/**
 * Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
 *
 ...
 * `e2ee`: [End-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871). The encryption key is stored in your local device and can not be obtained by anyone else. Enabling this setting also **disables** the following features: join before host, cloud recording, streaming, live transcription, breakout rooms, polling, 1:1 private chat, and meeting reactions.
 */
export declare enum GetZRSettings200ApplicationJson1MeetingSecurityEncryptionTypeEnum {
    EnhancedEncryption = "enhanced_encryption",
    E2ee = "e2ee"
}
export declare class GetZRSettings200ApplicationJson1MeetingSecurity extends SpeakeasyBase {
    /**
     * Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
     *
     * @remarks
     ...
     * `e2ee`: [End-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871). The encryption key is stored in your local device and can not be obtained by anyone else. Enabling this setting also **disables** the following features: join before host, cloud recording, streaming, live transcription, breakout rooms, polling, 1:1 private chat, and meeting reactions.
     */
    encryptionType?: GetZRSettings200ApplicationJson1MeetingSecurityEncryptionTypeEnum;
    /**
     * Allow use of end-to-end encryption for meetings. If set to `true`, you can specify the encryption type in `encryption_type` field.
     */
    endToEndEncryptedMeetings?: boolean;
}
export declare class GetZRSettings200ApplicationJson1ZoomRooms extends SpeakeasyBase {
    /**
     * Enable multiple participants to [share content simultaneously](https://support.zoom.us/hc/en-us/articles/360017767812-Sharing-Multiple-Screens-in-a-Zoom-Room) by default.
     */
    allowMultipleContentSharing?: boolean;
...
export declare class GetZRSettings200ApplicationJson1 extends SpeakeasyBase {
    meetingSecurity?: GetZRSettings200ApplicationJson1MeetingSecurity;
    zoomRooms?: GetZRSettings200ApplicationJson1ZoomRooms;
}
export declare class GetZRSettingsResponse extends SpeakeasyBase {
     ...
     */
    getZRSettings200ApplicationJSONObject?: any;
}
