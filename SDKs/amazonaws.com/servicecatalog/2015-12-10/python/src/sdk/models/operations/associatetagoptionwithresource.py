...
class AssociateTagOptionWithResourceRequest:
    ...
    associate_tag_option_with_resource_input: shared_associatetagoptionwithresourceinput.AssociateTagOptionWithResourceInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
