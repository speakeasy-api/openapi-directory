...
class GetEditorialImageLicenseListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetEditorialImageLicenseListDownloadAvailabilityEnum $downloadAvailability
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=download_availability')]
    public ?GetEditorialImageLicenseListDownloadAvailabilityEnum $downloadAvailability = null;
     ...
     * Sort order
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetEditorialImageLicenseListSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?GetEditorialImageLicenseListSortEnum $sort = null;
