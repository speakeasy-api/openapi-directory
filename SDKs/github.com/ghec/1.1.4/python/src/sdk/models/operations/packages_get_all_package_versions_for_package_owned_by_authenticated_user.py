...
class PackagesGetAllPackageVersionsForPackageOwnedByAuthenticatedUserRequest:
    ...
    state: Optional[PackagesGetAllPackageVersionsForPackageOwnedByAuthenticatedUserStateEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'state', 'style': 'form', 'explode': True }})
    r"""The state of the package, either active or deleted."""  
