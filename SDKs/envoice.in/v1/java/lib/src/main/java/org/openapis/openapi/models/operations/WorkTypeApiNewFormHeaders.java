...
public class WorkTypeApiNewFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public WorkTypeApiNewFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public WorkTypeApiNewFormHeaders withXAuthSecret(String xAuthSecret) {
