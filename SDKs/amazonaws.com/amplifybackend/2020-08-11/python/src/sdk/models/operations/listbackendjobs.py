...
from ..shared import listbackendjobsresponse as shared_listbackendjobsresponse
...
class ListBackendJobsRequest:
    headers: ListBackendJobsHeaders = dataclasses.field()
    path_params: ListBackendJobsPathParams = dataclasses.field()
    query_params: ListBackendJobsQueryParams = dataclasses.field()
    request: ListBackendJobsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class ListBackendJobsResponse:
    ...
    list_backend_jobs_response: Optional[shared_listbackendjobsresponse.ListBackendJobsResponse] = dataclasses.field(default=None)
