...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCheckFollowingForUserRequest req = new UsersCheckFollowingForUserRequest("esse", "debitis");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCheckPersonIsFollowedByAuthenticatedRequest req = new UsersCheckPersonIsFollowedByAuthenticatedRequest("facere");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCreateGpgKeyForAuthenticatedUserRequestBody req = new UsersCreateGpgKeyForAuthenticatedUserRequestBody("quisquam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCreatePublicSshKeyForAuthenticatedUserRequestBody req = new UsersCreatePublicSshKeyForAuthenticatedUserRequestBody("cumque") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersDeleteGpgKeyForAuthenticatedUserRequest req = new UsersDeleteGpgKeyForAuthenticatedUserRequest(319834L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersDeletePublicSshKeyForAuthenticatedUserRequest req = new UsersDeletePublicSshKeyForAuthenticatedUserRequest(970411L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersFollowRequest req = new UsersFollowRequest("sequi");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetByUsernameRequest req = new UsersGetByUsernameRequest("porro");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetContextForUserRequest req = new UsersGetContextForUserRequest("laborum") {{
                subjectId = "nobis";
                subjectType = UsersGetContextForUserSubjectTypeEnum.PULL_REQUEST;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetGpgKeyForAuthenticatedUserRequest req = new UsersGetGpgKeyForAuthenticatedUserRequest(607624L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetPublicSshKeyForAuthenticatedUserRequest req = new UsersGetPublicSshKeyForAuthenticatedUserRequest(16252L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListFollowersForUserRequest req = new UsersListFollowersForUserRequest("nisi") {{
                page = 474185L;
                perPage = 154130L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListFollowingForUserRequest req = new UsersListFollowingForUserRequest("laudantium") {{
                page = 152742L;
                perPage = 140439L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListGpgKeysForUserRequest req = new UsersListGpgKeysForUserRequest("eos") {{
                page = 830477L;
                perPage = 199879L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListPublicKeysForUserRequest req = new UsersListPublicKeysForUserRequest("dolore") {{
                page = 457063L;
                perPage = 38044L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersUnfollowRequest req = new UsersUnfollowRequest("quam");            
