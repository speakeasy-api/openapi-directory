...
**/
public class UpdateASharedLineGroupMultipartFormDataPrimaryNumber {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("id")
    public String id;
    public UpdateASharedLineGroupMultipartFormDataPrimaryNumber withId(String id) {
        this.id = id;
        return this;
    }
    @JsonInclude(Include.NON_ABSENT)
    ...
    public UpdateASharedLineGroupMultipartFormDataPrimaryNumber withNumber(String number) {
        this.number = number;
        return this;
    }
}