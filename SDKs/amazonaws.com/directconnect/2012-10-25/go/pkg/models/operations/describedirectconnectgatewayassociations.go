...
func (e *DescribeDirectConnectGatewayAssociationsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "OvertureService.DescribeDirectConnectGatewayAssociations":
		*e = DescribeDirectConnectGatewayAssociationsXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeDirectConnectGatewayAssociationsXAmzTargetEnum: %s", s)
	}
}
