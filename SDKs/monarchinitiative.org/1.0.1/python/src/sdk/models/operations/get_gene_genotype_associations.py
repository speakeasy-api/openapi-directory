...
class GetGeneGenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGeneGenotypeAssociationsQueryParams:
...
class GetGeneGenotypeAssociationsRequest:
    path_params: GetGeneGenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetGeneGenotypeAssociationsQueryParams = dataclasses.field()
