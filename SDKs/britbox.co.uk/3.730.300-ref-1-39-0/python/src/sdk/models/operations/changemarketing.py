...
from ..shared import itvchangemarketingrequest as shared_itvchangemarketingrequest
...
class ChangeMarketingRequest:
    ...
    itv_change_marketing_request: shared_itvchangemarketingrequest.ItvChangeMarketingRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
