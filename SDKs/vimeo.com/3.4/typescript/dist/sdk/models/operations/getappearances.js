...
exports.GetAppearancesResponse = exports.GetAppearancesRequest = exports.GetAppearancesSortEnum = exports.GetAppearancesFilterEnum = exports.GetAppearancesDirectionEnum = void 0;
...
var GetAppearancesRequest = /** @class */ (function (_super) {
    ...
    ], GetAppearancesRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetAppearancesRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter_embeddable",
        }),
        __metadata("design:type", Boolean)
    ], GetAppearancesRequest.prototype, "filterEmbeddable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetAppearancesRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetAppearancesRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=query" }),
        __metadata("design:type", String)
    ], GetAppearancesRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetAppearancesRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=user_id",
        }),
        __metadata("design:type", Number)
    ], GetAppearancesRequest.prototype, "userId", void 0);
...
var GetAppearancesResponse = /** @class */ (function (_super) {
    ...
    ], GetAppearancesResponse.prototype, "rawResponse", void 0);
    __decorate([
