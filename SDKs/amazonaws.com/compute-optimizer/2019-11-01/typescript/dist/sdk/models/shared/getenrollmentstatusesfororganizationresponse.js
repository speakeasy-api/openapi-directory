...
var GetEnrollmentStatusesForOrganizationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: accountenrollmentstatus_1.AccountEnrollmentStatus }),
        (0, class_transformer_1.Expose)({ name: "accountEnrollmentStatuses" }),
        (0, class_transformer_1.Type)(function () { return accountenrollmentstatus_1.AccountEnrollmentStatus; }),
