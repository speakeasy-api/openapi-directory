...
class ContentDirectoryTypeEnum(str, Enum):
    DIR = 'dir'
    FILE = 'file'
    SUBMODULE = 'submodule'
    SYMLINK = 'symlink'
...
class ContentDirectory:
    ...
    links: ContentDirectoryLinks = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('_links') }})  
    ...
    type: ContentDirectoryTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})  
