...
class Message:
    ...
    def get_messages(self, request: operations.GetMessagesRequest, security: operations.GetMessagesSecurity) -> operations.GetMessagesResponse:
        r"""Retrieve Messages
    ...
    def get_messages_send(self, request: operations.GetMessagesSendRequest, security: operations.GetMessagesSendSecurity) -> operations.GetMessagesSendResponse:
        ...
        query_params = utils.get_query_params(operations.GetMessagesSendRequest, request)
        ...
        res = operations.GetMessagesSendResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_messages_id_related_received_messages(self, request: operations.GetMessagesIDRelatedReceivedMessagesRequest, security: operations.GetMessagesIDRelatedReceivedMessagesSecurity) -> operations.GetMessagesIDRelatedReceivedMessagesResponse:
        ...
        url = utils.generate_url(operations.GetMessagesIDRelatedReceivedMessagesRequest, base_url, '/messages/{id}/relatedReceivedMessages', request)
        ...
        res = operations.GetMessagesIDRelatedReceivedMessagesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_messages(self, request: operations.PostMessagesRequest, security: operations.PostMessagesSecurity) -> operations.PostMessagesResponse:
        r"""Send Messages
        ...
        *Field based templates* allow you to create a message with place-holders for custom fields.  Fields are identified by a zero based index; the first field is `F0`, the second is `F1` and so on.  
        ...
        query_params = utils.get_query_params(operations.PostMessagesRequest, request)
