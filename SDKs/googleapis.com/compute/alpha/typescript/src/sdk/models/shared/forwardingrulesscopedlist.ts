 ...
 */
export enum ForwardingRulesScopedListWarningCodeEnum {
...
export class ForwardingRulesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ForwardingRulesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: ForwardingRulesScopedListWarningData })
  @Expose({ name: "data" })
...
export class ForwardingRulesScopedList extends SpeakeasyBase {
  /**
   * A list of forwarding rules contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: ForwardingRule })
