...
public class MembershipFeatureState {
    ...
    public MeteringMembershipState metering;
    public MembershipFeatureState withMetering(MeteringMembershipState metering) {
    ...
    public PolicyControllerMembershipState policycontroller;
    public MembershipFeatureState withPolicycontroller(PolicyControllerMembershipState policycontroller) {
