...
class PaginatedMemberElectionResultMeta:
    r"""PaginatedMemberElectionResultMeta
...
class PaginatedMemberElectionResult:
    meta: PaginatedMemberElectionResultMeta = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    response: list[shared_memberelectionresult.MemberElectionResult] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('response') }})
