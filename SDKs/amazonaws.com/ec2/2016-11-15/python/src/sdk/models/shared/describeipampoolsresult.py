...
class DescribeIpamPoolsResultIpamPoolsAddressFamilyEnum(str, Enum):
...
class DescribeIpamPoolsResultIpamPoolsAllocationResourceTags:
...
class DescribeIpamPoolsResultIpamPoolsAwsServiceEnum(str, Enum):
...
class DescribeIpamPoolsResultIpamPoolsIpamScopeTypeEnum(str, Enum):
...
class DescribeIpamPoolsResultIpamPoolsPublicIPSourceEnum(str, Enum):
...
class DescribeIpamPoolsResultIpamPoolsStateEnum(str, Enum):
...
@dataclasses.dataclass
class DescribeIpamPoolsResultIpamPoolsTags:
    r"""Describes a tag."""
...
class DescribeIpamPoolsResultIpamPools:
    r"""In IPAM, a pool is a collection of contiguous IP addresses CIDRs. Pools enable you to organize your IP addresses according to your routing and security needs. For example, if you have separate routing and security needs for development and production applications, you can create a pool for each."""
    
    address_family: Optional[DescribeIpamPoolsResultIpamPoolsAddressFamilyEnum] = dataclasses.field(default=None)  
    ...
    allocation_resource_tags: Optional[list[DescribeIpamPoolsResultIpamPoolsAllocationResourceTags]] = dataclasses.field(default=None)  
    auto_import: Optional[bool] = dataclasses.field(default=None)  
    aws_service: Optional[DescribeIpamPoolsResultIpamPoolsAwsServiceEnum] = dataclasses.field(default=None)  
    ...
    ipam_scope_type: Optional[DescribeIpamPoolsResultIpamPoolsIpamScopeTypeEnum] = dataclasses.field(default=None)  
    ...
    public_ip_source: Optional[DescribeIpamPoolsResultIpamPoolsPublicIPSourceEnum] = dataclasses.field(default=None)  
    ...
    state: Optional[DescribeIpamPoolsResultIpamPoolsStateEnum] = dataclasses.field(default=None)  
    state_message: Optional[str] = dataclasses.field(default=None)  
    tags: Optional[list[DescribeIpamPoolsResultIpamPoolsTags]] = dataclasses.field(default=None)  
...
class DescribeIpamPoolsResult:
    ...
    ipam_pools: Optional[list[DescribeIpamPoolsResultIpamPools]] = dataclasses.field(default=None)  
