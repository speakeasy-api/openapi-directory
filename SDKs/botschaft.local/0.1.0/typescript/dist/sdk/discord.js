...
var Discord = /** @class */ (function () {
    ...
    Discord.prototype.discordGetDiscordGet = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.DiscordGetDiscordGetResponse({
    ...
    Discord.prototype.discordPostDiscordPost = function (req, config) {
        ...
        try {
            _a = utils.serializeRequestBody(req, "discordMessageRequest", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.DiscordPostDiscordPostResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
