...
var Tasks = /** @class */ (function () {
    ...
    **/
    Tasks.prototype.tasksTasksClear = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TasksTasksClearRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/tasks/v1/lists/{tasklist}/clear", req.pathParams);
    ...
    **/
    Tasks.prototype.tasksTasksDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TasksTasksDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/tasks/v1/lists/{tasklist}/tasks/{task}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
    ...
    **/
    Tasks.prototype.tasksTasksGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Tasks.prototype.tasksTasksInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TasksTasksInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/tasks/v1/lists/{tasklist}/tasks", req.pathParams);
    ...
    **/
    Tasks.prototype.tasksTasksList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Tasks.prototype.tasksTasksMove = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TasksTasksMoveRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/tasks/v1/lists/{tasklist}/tasks/{task}/move", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "post" }, requestConfig));
    ...
    **/
    Tasks.prototype.tasksTasksPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Tasks.prototype.tasksTasksUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
