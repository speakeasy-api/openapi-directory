...
func (e PostSpacesSpaceIDFoldersIDSocialContractsApplicationJSON2AccountingWorkbookEnum) ToPointer() *PostSpacesSpaceIDFoldersIDSocialContractsApplicationJSON2AccountingWorkbookEnum {
	return &e
}
...
func (e *PostSpacesSpaceIDFoldersIDSocialContractsApplicationJSON2AccountingWorkbookEnum) UnmarshalJSON(data []byte) error {
	...
	case "other":
		fallthrough
	case "permanent":
		*e = PostSpacesSpaceIDFoldersIDSocialContractsApplicationJSON2AccountingWorkbookEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostSpacesSpaceIDFoldersIDSocialContractsApplicationJSON2AccountingWorkbookEnum: %v", v)
	}
}
