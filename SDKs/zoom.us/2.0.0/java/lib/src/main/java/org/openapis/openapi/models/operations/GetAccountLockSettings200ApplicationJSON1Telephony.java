...
public class GetAccountLockSettings200ApplicationJSON1Telephony {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("telephony_regions")
    public Boolean telephonyRegions;
    public GetAccountLockSettings200ApplicationJSON1Telephony withTelephonyRegions(Boolean telephonyRegions) {
    ...
    public GetAccountLockSettings200ApplicationJSON1Telephony withThirdPartyAudio(Boolean thirdPartyAudio) {
