 ...
 */
export declare enum CreateTrafficMirrorSessionRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateTrafficMirrorSessionRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateTrafficMirrorSessionRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateTrafficMirrorSessionRequest extends SpeakeasyBase {
    clientToken?: string;
    description?: string;
    dryRun?: boolean;
