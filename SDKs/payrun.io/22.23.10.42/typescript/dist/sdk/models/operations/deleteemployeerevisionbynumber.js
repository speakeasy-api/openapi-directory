...
exports.DeleteEmployeeRevisionByNumberResponse = exports.DeleteEmployeeRevisionByNumberRequest = void 0;
...
var DeleteEmployeeRevisionByNumberRequest = /** @class */ (function (_super) {
    ...
    ], DeleteEmployeeRevisionByNumberRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeleteEmployeeRevisionByNumberRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], DeleteEmployeeRevisionByNumberRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeleteEmployeeRevisionByNumberRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RevisionNumber",
        }),
        __metadata("design:type", String)
    ], DeleteEmployeeRevisionByNumberRequest.prototype, "revisionNumber", void 0);
...
var DeleteEmployeeRevisionByNumberResponse = /** @class */ (function (_super) {
    ...
    ], DeleteEmployeeRevisionByNumberResponse.prototype, "rawResponse", void 0);
