...
var CollectionResponseExternalUnifiedEvent = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: externalunifiedevent_1.ExternalUnifiedEvent }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return externalunifiedevent_1.ExternalUnifiedEvent; }),
