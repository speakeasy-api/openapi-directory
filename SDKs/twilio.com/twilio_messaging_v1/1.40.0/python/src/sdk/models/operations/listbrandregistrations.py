...
class ListBrandRegistrationsListBrandRegistrationsResponse:
    ...
    data: Optional[list[shared_messaging_v1_brand_registrations.MessagingV1BrandRegistrations]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListBrandRegistrationsListBrandRegistrationsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
