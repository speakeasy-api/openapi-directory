...
type DialogflowProjectsLocationsAgentEntityTypesEntitiesBatchCreateRequest struct {
	...
	GoogleCloudDialogflowV2beta1BatchCreateEntitiesRequest *shared.GoogleCloudDialogflowV2beta1BatchCreateEntitiesRequest `request:"mediaType=application/json"`
	// OAuth access token.
