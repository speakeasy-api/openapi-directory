...
public class CreateServiceConversationScopedWebhookRequest {
    ...
    public CreateServiceConversationScopedWebhookRequest(@JsonProperty("ChatServiceSid") String chatServiceSid, @JsonProperty("ConversationSid") String conversationSid) {
        this.chatServiceSid = chatServiceSid;
        this.conversationSid = conversationSid;
  }
}
