...
class GETRefundPaymentTypeFinanceInformationTransferredToAccountingEnum(str, Enum):
...
class GETRefundPaymentTypeFinanceInformation:
    ...
    transferred_to_accounting: Optional[GETRefundPaymentTypeFinanceInformationTransferredToAccountingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transferredToAccounting'), 'exclude': lambda f: f is None }})
    r"""Whether the refund was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite."""  
...
class GETRefundPaymentTypeGatewayStateEnum(str, Enum):
...
class GETRefundPaymentTypeMethodTypeEnum(str, Enum):
...
class GETRefundPaymentTypeStatusEnum(str, Enum):
...
class GETRefundPaymentTypeTypeEnum(str, Enum):
...
class GETRefundPaymentType:
    ...
    r"""The ID of the credit memo associated with the refund."""  
    finance_information: Optional[GETRefundPaymentTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the refund."""  
    ...
    gateway_state: Optional[GETRefundPaymentTypeGatewayStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('gatewayState'), 'exclude': lambda f: f is None }})
    r"""The status of the refund in the gateway."""  
    ...
    method_type: Optional[GETRefundPaymentTypeMethodTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('methodType'), 'exclude': lambda f: f is None }})
    r"""How an external refund was issued to a customer."""  
    ...
    r"""A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi."""  
    status: Optional[GETRefundPaymentTypeStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The status of the refund."""  
    ...
    type: Optional[GETRefundPaymentTypeTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of the refund."""  
    ...
    r"""The ID of the the Zuora user who last updated the refund."""  
