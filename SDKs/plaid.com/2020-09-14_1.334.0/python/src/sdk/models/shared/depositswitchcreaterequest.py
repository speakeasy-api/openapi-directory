...
class DepositSwitchCreateRequest:
    ...
    country_code: Optional[DepositSwitchCreateRequestCountryCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('country_code'), 'exclude': lambda f: f is None }})
    r"""ISO-3166-1 alpha-2 country code standard."""  
