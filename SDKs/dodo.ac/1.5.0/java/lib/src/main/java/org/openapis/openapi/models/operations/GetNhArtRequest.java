...
public class GetNhArtRequest {
    ...
    public GetNhArtRequest withAcceptVersion(String acceptVersion) {
    ...
    public GetNhArtRequest withXApiKey(String xApiKey) {
    ...
    public GetNhArtRequest withExcludedetails(String excludedetails) {
    ...
    public GetNhArtRequest withHasfake(String hasfake) {
    ...
    public GetNhArtRequest withThumbsize(Long thumbsize) {
