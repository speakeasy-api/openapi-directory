...
type IamProjectsServiceAccountsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type IamProjectsServiceAccountsCreatePathParams struct {
	// Required. The resource name of the project associated with the service accounts, such as `projects/my-project-123`.
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type IamProjectsServiceAccountsCreateQueryParams struct {
	// V1 error format.
...
type IamProjectsServiceAccountsCreateResponse struct {
	ContentType string
	// Successful response
