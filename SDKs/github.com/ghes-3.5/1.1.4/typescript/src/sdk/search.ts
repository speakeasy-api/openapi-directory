...
export class Search {
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.5/rest/reference/search#search-code} - API method documentation
   */
  searchCode(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.5/rest/reference/search#search-commits} - API method documentation
   */
  searchCommits(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.5/rest/reference/search#search-issues-and-pull-requests} - API method documentation
   */
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.5/rest/reference/search#search-labels} - API method documentation
   */
  searchLabels(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.5/rest/reference/search#search-repositories} - API method documentation
   */
  searchRepos(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.5/rest/reference/search#search-topics} - API method documentation
   */
  searchTopics(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.5/rest/reference/search#search-users} - API method documentation
   */
  searchUsers(
