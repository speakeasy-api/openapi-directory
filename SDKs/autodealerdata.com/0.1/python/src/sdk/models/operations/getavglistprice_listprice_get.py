...
class GetAvgListPriceListPriceGetQueryParams:
...
@dataclasses.dataclass
class GetAvgListPriceListPriceGetRequest:
    query_params: GetAvgListPriceListPriceGetQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetAvgListPriceListPriceGetResponse:
