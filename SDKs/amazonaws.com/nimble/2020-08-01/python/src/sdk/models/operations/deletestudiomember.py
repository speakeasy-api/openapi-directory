...
@dataclasses.dataclass
class DeleteStudioMemberHeaders:
...
class DeleteStudioMemberRequest:
    headers: DeleteStudioMemberHeaders = dataclasses.field()
    path_params: DeleteStudioMemberPathParams = dataclasses.field()
...
class DeleteStudioMemberResponse:
    ...
    delete_studio_member_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
