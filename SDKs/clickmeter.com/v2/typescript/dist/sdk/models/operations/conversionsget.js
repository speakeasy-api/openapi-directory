...
exports.ConversionsGetResponse = exports.ConversionsGetRequest = exports.ConversionsGetStatusEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Status of conversion ("deleted"/"active")
 */
var ConversionsGetStatusEnum;
(function (ConversionsGetStatusEnum) {
    ConversionsGetStatusEnum["Deleted"] = "deleted";
    ConversionsGetStatusEnum["Active"] = "active";
})(ConversionsGetStatusEnum = exports.ConversionsGetStatusEnum || (exports.ConversionsGetStatusEnum = {}));
var ConversionsGetRequest = /** @class */ (function (_super) {
    ...
    ], ConversionsGetRequest.prototype, "createdAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=createdBefore",
        }),
        __metadata("design:type", String)
    ], ConversionsGetRequest.prototype, "createdBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], ConversionsGetRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], ConversionsGetRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], ConversionsGetRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=textSearch",
        }),
        __metadata("design:type", String)
    ], ConversionsGetRequest.prototype, "textSearch", void 0);
    return ConversionsGetRequest;
}(utils_1.SpeakeasyBase));
exports.ConversionsGetRequest = ConversionsGetRequest;
var ConversionsGetResponse = /** @class */ (function (_super) {
    ...
    ], ConversionsGetResponse.prototype, "rawResponse", void 0);
    return ConversionsGetResponse;
}(utils_1.SpeakeasyBase));
exports.ConversionsGetResponse = ConversionsGetResponse;
