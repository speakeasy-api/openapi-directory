...
class ListTrunkListTrunkResponse:
    ...
    meta: Optional[ListTrunkListTrunkResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    trunks: Optional[list[shared_trunking_v1_trunk.TrunkingV1Trunk]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('trunks'), 'exclude': lambda f: f is None }})  
