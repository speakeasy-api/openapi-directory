...
export declare class KeepNotesPermissionsBatchDeleteSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class KeepNotesPermissionsBatchDeleteRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class KeepNotesPermissionsBatchDeleteResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
