...
class CreatePublicIpv4PoolRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreatePublicIpv4PoolRequestTagSpecifications:
    ...
    resource_type: Optional[CreatePublicIpv4PoolRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreatePublicIpv4PoolRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreatePublicIpv4PoolRequest:
    ...
    tag_specifications: Optional[list[CreatePublicIpv4PoolRequestTagSpecifications]] = dataclasses.field(default=None)  
