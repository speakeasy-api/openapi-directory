...
export class AutomlProjectsLocationsModelsModelEvaluationsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AutomlProjectsLocationsModelsModelEvaluationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AutomlProjectsLocationsModelsModelEvaluationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
