...
class DescribeTransitGatewayRouteTablesRequestFilters:
...
class DescribeTransitGatewayRouteTablesRequest:
    ...
    filters: Optional[list[DescribeTransitGatewayRouteTablesRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    transit_gateway_route_table_ids: Optional[list[str]] = dataclasses.field(default=None)  
