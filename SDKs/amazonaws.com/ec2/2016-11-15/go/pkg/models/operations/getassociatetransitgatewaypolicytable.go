...
type GETAssociateTransitGatewayPolicyTableQueryParams struct {
...
type GETAssociateTransitGatewayPolicyTableHeaders struct {
...
type GETAssociateTransitGatewayPolicyTableRequest struct {
	QueryParams GETAssociateTransitGatewayPolicyTableQueryParams
	Headers     GETAssociateTransitGatewayPolicyTableHeaders
}
