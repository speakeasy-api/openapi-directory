...
class CreateEnumOptionForCustomFieldRequest:
    ...
    """  
    request_body: Optional[CreateEnumOptionForCustomFieldRequestBodyInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    r"""The enum option object to create."""  
...
class CreateEnumOptionForCustomField201ApplicationJSON:
    r"""Custom field enum option successfully created."""
