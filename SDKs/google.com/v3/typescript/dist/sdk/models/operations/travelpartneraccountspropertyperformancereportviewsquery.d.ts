...
export declare class TravelpartnerAccountsPropertyPerformanceReportViewsQueryRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class TravelpartnerAccountsPropertyPerformanceReportViewsQueryResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
