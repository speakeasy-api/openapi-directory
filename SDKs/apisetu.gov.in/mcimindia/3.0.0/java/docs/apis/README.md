...
* [govid](#govid) - ID Card
* [phcer](#phcer) - Pharmacist Registration Certificate
    ...
    public static void main(String[] args) {
        try {
            ...
            GovidRequestBody req = new GovidRequestBody(GovidRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new GovidRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "I-99-A", "123412341234");;
...
import java.time.OffsetDateTime;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.PhcerRequestBody;
import org.openapis.openapi.models.operations.PhcerRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.PhcerRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.PhcerResponse;
import org.openapis.openapi.models.operations.PhcerSecurity;
import org.openapis.openapi.models.shared.ConsentArtifactSchema;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsent;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentData;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentDataConsumer;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PhcerRequestBody req = new PhcerRequestBody(PhcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new PhcerRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "I-99-A", "123412341234");;
            ...
            PhcerResponse res = sdk.apIs.phcer(req, new PhcerSecurity("qui", "impedit") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
