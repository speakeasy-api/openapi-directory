...
class GetStatsUnitEnum(str, Enum):
    r"""Specifies the unit of aggregation in the returned results."""
    MINUTE = 'minute'
    HOUR = 'hour'
    DAY = 'day'
    MONTH = 'month'
...
class GetStatsRequest:
    ...
    unit: Optional[GetStatsUnitEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'unit', 'style': 'form', 'explode': True }})
    r"""Specifies the unit of aggregation in the returned results."""  
