...
export const ListRateLimitServerList = ["https://verify.twilio.com"] as const;
...
export class ListRateLimitListRateLimitResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListRateLimitListRateLimitResponseMeta)
  meta?: ListRateLimitListRateLimitResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.VerifyV2ServiceRateLimit })
  @Expose({ name: "rate_limits" })
  @Type(() => shared.VerifyV2ServiceRateLimit)
