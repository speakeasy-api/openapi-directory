...
@dataclasses.dataclass
class BaremetalsolutionProjectsLocationsVolumesLunsEvictRequest:
    
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'name', 'style': 'simple', 'explode': False }})
    r"""Required. The name of the lun."""  
...
@dataclasses.dataclass
class BaremetalsolutionProjectsLocationsVolumesLunsEvictResponse:
