...
class CalendarSettingsWatchSecurity:
    option1: Optional[CalendarSettingsWatchSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CalendarSettingsWatchSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[CalendarSettingsWatchSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class CalendarSettingsWatchRequest:
    query_params: CalendarSettingsWatchQueryParams = dataclasses.field()
    security: CalendarSettingsWatchSecurity = dataclasses.field()
