...
exports.OptIns = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var OptIns = /** @class */ (function () {
    function OptIns(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Create a new early access feature opt-in for an organization
     */
    OptIns.prototype.createOrganizationEarlyAccessFeaturesOptIn = function (req, config) {
        var _a;
     ...
     * Delete an early access feature opt-in
     */
    OptIns.prototype.deleteOrganizationEarlyAccessFeaturesOptIn = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Show an early access feature opt-in for an organization
     */
    OptIns.prototype.getOrganizationEarlyAccessFeaturesOptIn = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * List the early access feature opt-ins for an organization
     */
    OptIns.prototype.getOrganizationEarlyAccessFeaturesOptIns = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update an early access feature opt-in for an organization
     */
    OptIns.prototype.updateOrganizationEarlyAccessFeaturesOptIn = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
