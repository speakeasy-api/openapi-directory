...
class SubscriptionApprovalNotification
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\SubscriptionApprovalNotificationNotification')]
	...
	{
		$this->notification = new \OpenAPI\OpenAPI\Models\Shared\SubscriptionApprovalNotificationNotification();
		$this->requestId = "";
