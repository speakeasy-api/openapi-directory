...
public class ListPresetsRequest {
    ...
    public ListPresetsRequest withXAmzAlgorithm(String xAmzAlgorithm) {
    ...
    public ListPresetsRequest withXAmzContentSha256(String xAmzContentSha256) {
    ...
    public ListPresetsRequest withXAmzCredential(String xAmzCredential) {
    ...
    public ListPresetsRequest withXAmzDate(String xAmzDate) {
    ...
    public ListPresetsRequest withXAmzSecurityToken(String xAmzSecurityToken) {
    ...
    public ListPresetsRequest withXAmzSignature(String xAmzSignature) {
    ...
    public ListPresetsRequest withXAmzSignedHeaders(String xAmzSignedHeaders) {
