...
public class GetSitesRequest {
    ...
    public GetSitesRequest withCallback(String callback) {
    ...
    public GetSitesRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public Long page;
    public GetSitesRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetSitesRequest withPagesize(Long pagesize) {
