...
class StorageDefaultObjectAccessControlsGetSecurity:
    option1: Optional[StorageDefaultObjectAccessControlsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageDefaultObjectAccessControlsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class StorageDefaultObjectAccessControlsGetRequest:
    path_params: StorageDefaultObjectAccessControlsGetPathParams = dataclasses.field()
    query_params: StorageDefaultObjectAccessControlsGetQueryParams = dataclasses.field()
    security: StorageDefaultObjectAccessControlsGetSecurity = dataclasses.field()
