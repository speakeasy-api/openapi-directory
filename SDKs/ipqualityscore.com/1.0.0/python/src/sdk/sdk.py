...
from .malicious_url_scanner import MaliciousURLScanner
...
class SDK:
    ...
    malicious_url_scanner: MaliciousURLScanner
    ...
    def _init_sdks(self):
        ...
        self.malicious_url_scanner = MaliciousURLScanner(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.phone_validation = PhoneValidation(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
