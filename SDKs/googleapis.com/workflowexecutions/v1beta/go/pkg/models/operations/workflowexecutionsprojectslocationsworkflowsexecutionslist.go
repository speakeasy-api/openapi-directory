...
func (e WorkflowexecutionsProjectsLocationsWorkflowsExecutionsListViewEnum) ToPointer() *WorkflowexecutionsProjectsLocationsWorkflowsExecutionsListViewEnum {
	return &e
}
...
func (e *WorkflowexecutionsProjectsLocationsWorkflowsExecutionsListViewEnum) UnmarshalJSON(data []byte) error {
	...
	case "BASIC":
		fallthrough
	case "FULL":
		*e = WorkflowexecutionsProjectsLocationsWorkflowsExecutionsListViewEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for WorkflowexecutionsProjectsLocationsWorkflowsExecutionsListViewEnum: %v", v)
	}
}
