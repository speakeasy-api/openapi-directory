...
type SmartdevicemanagementEnterprisesStructuresRoomsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type SmartdevicemanagementEnterprisesStructuresRoomsGetPathParams struct {
	// The name of the room requested. For example: "enterprises/XYZ/structures/ABC/rooms/123".
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type SmartdevicemanagementEnterprisesStructuresRoomsGetQueryParams struct {
	// V1 error format.
...
type SmartdevicemanagementEnterprisesStructuresRoomsGetRequest struct {
...
type SmartdevicemanagementEnterprisesStructuresRoomsGetResponse struct {
	ContentType string
	// Successful response
