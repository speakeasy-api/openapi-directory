...
class JDBCConnectorTarget:
    r"""Specifies a data target that writes to Amazon S3 in Apache Parquet columnar storage."""
    
    connection_name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ConnectionName') }})  
    connection_table: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ConnectionTable') }})  
