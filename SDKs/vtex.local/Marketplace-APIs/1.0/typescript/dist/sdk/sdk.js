...
var matchedoffers_1 = require("./matchedoffers");
var shared = __importStar(require("./models/shared"));
var notification_1 = require("./notification");
var saleschannelmapping_1 = require("./saleschannelmapping");
var sellercommissions_1 = require("./sellercommissions");
var sellerinvite_1 = require("./sellerinvite");
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.matchedOffers = new matchedoffers_1.MatchedOffers(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.salesChannelMapping = new saleschannelmapping_1.SalesChannelMapping(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.sellerCommissions = new sellercommissions_1.SellerCommissions(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.sellerInvite = new sellerinvite_1.SellerInvite(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.sellers = new sellers_1.Sellers(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
