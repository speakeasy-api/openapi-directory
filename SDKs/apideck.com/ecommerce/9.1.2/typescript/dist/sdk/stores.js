...
var Stores = /** @class */ (function () {
     ...
     * Get Store
     */
    Stores.prototype.storesOne = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.StoresOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/ecommerce/store";
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.StoresOneSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.StoresOneResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getStoreResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetStoreResponse);
                    }
                    break;
