...
var CandidateHistory = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=address_city" }),
        __metadata("design:type", String)
    ], CandidateHistory.prototype, "addressCity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=address_state" }),
        __metadata("design:type", String)
    ], CandidateHistory.prototype, "addressState", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=address_street_1" }),
        __metadata("design:type", String)
    ], CandidateHistory.prototype, "addressStreet1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=address_street_2" }),
        __metadata("design:type", String)
    ], CandidateHistory.prototype, "addressStreet2", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=address_zip" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=fec_cycles_in_election" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rounded_election_years" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=two_year_period" }),
        __metadata("design:type", Number)
