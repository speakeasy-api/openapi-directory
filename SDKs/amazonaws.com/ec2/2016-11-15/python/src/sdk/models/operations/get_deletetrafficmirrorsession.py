...
class GetDeleteTrafficMirrorSessionQueryParams:
    action: GetDeleteTrafficMirrorSessionActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteTrafficMirrorSessionVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteTrafficMirrorSessionRequest:
    headers: GetDeleteTrafficMirrorSessionHeaders = dataclasses.field()
    query_params: GetDeleteTrafficMirrorSessionQueryParams = dataclasses.field()
