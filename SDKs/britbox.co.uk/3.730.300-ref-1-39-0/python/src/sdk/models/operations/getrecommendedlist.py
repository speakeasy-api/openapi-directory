...
class GetRecommendedListRequest:
    ...
    """  
    item_types: Optional[list[str]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'item_types', 'style': 'form', 'explode': False }})
    r"""List of item types to filter the recommendation list"""  
