...
class DeleteFunctionEventInvokeConfigRequest:
    headers: DeleteFunctionEventInvokeConfigHeaders = dataclasses.field()
    path_params: DeleteFunctionEventInvokeConfigPathParams = dataclasses.field()
    query_params: DeleteFunctionEventInvokeConfigQueryParams = dataclasses.field()
