...
class GetAssociateClientVpnTargetNetworkQueryParams:
    action: GetAssociateClientVpnTargetNetworkActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetAssociateClientVpnTargetNetworkVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAssociateClientVpnTargetNetworkRequest:
    headers: GetAssociateClientVpnTargetNetworkHeaders = dataclasses.field()
    query_params: GetAssociateClientVpnTargetNetworkQueryParams = dataclasses.field()
