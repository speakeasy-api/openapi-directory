...
from ..shared import updatevirtualinterfaceattributesrequest as shared_updatevirtualinterfaceattributesrequest
...
class UpdateVirtualInterfaceAttributesHeaders:
    x_amz_target: UpdateVirtualInterfaceAttributesXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateVirtualInterfaceAttributesRequest:
    headers: UpdateVirtualInterfaceAttributesHeaders = dataclasses.field()
    request: shared_updatevirtualinterfaceattributesrequest.UpdateVirtualInterfaceAttributesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
