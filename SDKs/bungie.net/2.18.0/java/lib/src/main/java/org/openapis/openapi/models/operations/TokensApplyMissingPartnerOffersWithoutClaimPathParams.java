...
public class TokensApplyMissingPartnerOffersWithoutClaimPathParams {
    /**
    ...
    public TokensApplyMissingPartnerOffersWithoutClaimPathParams withPartnerApplicationId(Integer partnerApplicationId) {
    ...
    public TokensApplyMissingPartnerOffersWithoutClaimPathParams withTargetBnetMembershipId(Long targetBnetMembershipId) {
