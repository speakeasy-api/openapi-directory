...
from ..shared import efilingspage as shared_efilingspage
...
class GetEfileFilingsRequest:
    query_params: GetEfileFilingsQueryParams = dataclasses.field()
...
class GetEfileFilingsResponse:
    ...
    e_filings_page: Optional[shared_efilingspage.EFilingsPage] = dataclasses.field(default=None)
