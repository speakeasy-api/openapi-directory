...
class AggregatedGetConversionsSummaryRequest:
    ...
    time_frame: AggregatedGetConversionsSummaryTimeFrameEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'timeFrame', 'style': 'form', 'explode': True }})
    r"""Timeframe of the request. See list at $timeframeList"""  
    ...
    r"""Field to sort by"""  
    sort_direction: Optional[AggregatedGetConversionsSummarySortDirectionEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sortDirection', 'style': 'form', 'explode': True }})
    r"""Direction of sort \\"asc\\" or \\"desc\\" """  
    status: Optional[AggregatedGetConversionsSummaryStatusEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'status', 'style': 'form', 'explode': True }})
    r"""Status of conversion (\\"deleted\\"/\\"active\\")"""  
