...
public class GetSiteApiKeysRequest {
    ...
    public GetSiteApiKeysRequest withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public GetSiteApiKeysRequest withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetSiteApiKeysRequest withFilterGt(java.util.Map<String, Object> filterGt) {
    ...
    public GetSiteApiKeysRequest withFilterGteq(java.util.Map<String, Object> filterGteq) {
    ...
    public GetSiteApiKeysRequest withFilterLike(java.util.Map<String, Object> filterLike) {
    ...
    public GetSiteApiKeysRequest withFilterLt(java.util.Map<String, Object> filterLt) {
    ...
    public GetSiteApiKeysRequest withFilterLteq(java.util.Map<String, Object> filterLteq) {
    ...
    public GetSiteApiKeysRequest withPerPage(Integer perPage) {
    ...
    public GetSiteApiKeysRequest withSortBy(java.util.Map<String, Object> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetSiteApiKeysRequest withUserId(Integer userId) {
        this.userId = userId;
        return this;
    }
