 ...
 */
export enum LicenseEditorialContentRequestCountry2Enum {
  Af = "AF",
  Ax = "AX",
  Al = "AL",
  Dz = "DZ",
 ...
 * A valid ISO 3166-1 Alpha-2 or ISO 3166-1 Alpha-3 code.
 */
export enum LicenseEditorialContentRequestCountry1Enum {
  Abw = "ABW",
  Afg = "AFG",
  Ago = "AGO",
  Aia = "AIA",
...
export class LicenseEditorialContentRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: LicenseEditorialContent })
  @Expose({ name: "editorial" })
  @Type(() => LicenseEditorialContent)
