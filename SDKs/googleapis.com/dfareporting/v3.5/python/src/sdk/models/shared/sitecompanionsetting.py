...
class SiteCompanionSetting:
    ...
    r"""Whether companions are disabled for this site template."""  
    ...
    r"""Allowlist of companion sizes to be served via this site template. Set this list to null or empty to serve all companion sizes."""  
    ...
    r"""Identifies what kind of resource this is. Value: the fixed string \\"dfareporting#siteCompanionSetting\\"."""  
