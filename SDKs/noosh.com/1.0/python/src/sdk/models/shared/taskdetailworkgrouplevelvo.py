...
class TaskDetailWorkgroupLevelVO:
    r"""Java type: com.noosh.nooshapi.vo.TaskDetailWorkgroupLevelVO"""
    
    actual_duration: Optional[Any] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('actual_duration'), 'exclude': lambda f: f is None }})
    ...
    creator_workgroup_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('creator_workgroup_name'), 'exclude': lambda f: f is None }})  
    ...
    last_updated_by: Optional[shared_personvo.PersonVO] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('last_updated_by'), 'exclude': lambda f: f is None }})
    r"""Java type: com.noosh.nooshapi.vo.PersonVO"""  
    ...
    percent_complete: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('percent_complete'), 'exclude': lambda f: f is None }})  
    plan_duration: Optional[Any] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('plan_duration'), 'exclude': lambda f: f is None }})
    r"""Java type: java.math.BigDecimal"""  
    ...
    requested_by: Optional[shared_personvo.PersonVO] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('requested_by'), 'exclude': lambda f: f is None }})
    r"""Java type: com.noosh.nooshapi.vo.PersonVO"""  
