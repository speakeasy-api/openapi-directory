...
exports.DeprecateThingTypeResponse = exports.DeprecateThingTypeRequest = exports.DeprecateThingTypeRequestBody = void 0;
...
var DeprecateThingTypeRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "undoDeprecate" }),
        __metadata("design:type", Boolean)
    ], DeprecateThingTypeRequestBody.prototype, "undoDeprecate", void 0);
    return DeprecateThingTypeRequestBody;
}(utils_1.SpeakeasyBase));
exports.DeprecateThingTypeRequestBody = DeprecateThingTypeRequestBody;
var DeprecateThingTypeRequest = /** @class */ (function (_super) {
    ...
    ], DeprecateThingTypeRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], DeprecateThingTypeRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], DeprecateThingTypeRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], DeprecateThingTypeRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], DeprecateThingTypeRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], DeprecateThingTypeRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], DeprecateThingTypeRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], DeprecateThingTypeRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=thingTypeName",
        }),
        __metadata("design:type", String)
    ], DeprecateThingTypeRequest.prototype, "thingTypeName", void 0);
    return DeprecateThingTypeRequest;
}(utils_1.SpeakeasyBase));
exports.DeprecateThingTypeRequest = DeprecateThingTypeRequest;
var DeprecateThingTypeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], DeprecateThingTypeResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.DeprecateThingTypeResponse = DeprecateThingTypeResponse;
