...
class CalendarEventsInsertRequest:
    path_params: CalendarEventsInsertPathParams = dataclasses.field()
    query_params: CalendarEventsInsertQueryParams = dataclasses.field()
    security: CalendarEventsInsertSecurity = dataclasses.field()
