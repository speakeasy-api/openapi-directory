...
class GetStageResponseDefaultRouteSettingsLoggingLevelEnum(str, Enum):
...
class GetStageResponseDefaultRouteSettings:
    ...
    logging_level: Optional[GetStageResponseDefaultRouteSettingsLoggingLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('LoggingLevel'), 'exclude': lambda f: f is None }})  
...
class GetStageResponse:
    ...
    access_log_settings: Optional[GetStageResponseAccessLogSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AccessLogSettings'), 'exclude': lambda f: f is None }})  
    ...
    default_route_settings: Optional[GetStageResponseDefaultRouteSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DefaultRouteSettings'), 'exclude': lambda f: f is None }})  
