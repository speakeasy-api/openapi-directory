...
export class QuoteOfTheDay {
  ...
  **/
  getQod(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetQodResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  getQodCategories(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetQodCategoriesResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            break;
          case httpRes?.status == 400:
  ...
  **/
  getQodLanguages(
    req: operations.GetQodLanguagesRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetQodLanguagesResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetQodLanguagesRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetQodLanguagesResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            break;
        }
