...
class GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsResponse:
    ...
    change_history_events: Optional[list[shared_googleanalyticsadminv1betachangehistoryevent.GoogleAnalyticsAdminV1betaChangeHistoryEvent]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('changeHistoryEvents'), 'exclude': lambda f: f is None }})
