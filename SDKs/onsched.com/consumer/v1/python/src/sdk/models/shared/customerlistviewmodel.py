...
class CustomerListViewModel:
    ...
    data: Optional[list[shared_customerviewmodel.CustomerViewModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
