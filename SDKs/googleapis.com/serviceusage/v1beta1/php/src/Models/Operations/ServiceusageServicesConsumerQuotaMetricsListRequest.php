...
class ServiceusageServicesConsumerQuotaMetricsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ServiceusageServicesConsumerQuotaMetricsListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?ServiceusageServicesConsumerQuotaMetricsListViewEnum $view = null;
