  ...
  **/
  getHistoryExportsId(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetHistoryExportsIdResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  postHistoryExports(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostHistoryExportsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
