...
from ..shared import getmodifiergroupresponse as shared_getmodifiergroupresponse
...
class ModifierGroupsOneSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class ModifierGroupsOneRequest:
...
class ModifierGroupsOneResponse:
    ...
    r"""Bad Request"""  
    get_modifier_group_response: Optional[shared_getmodifiergroupresponse.GetModifierGroupResponse] = dataclasses.field(default=None)
    r"""ModifierGroups"""  
