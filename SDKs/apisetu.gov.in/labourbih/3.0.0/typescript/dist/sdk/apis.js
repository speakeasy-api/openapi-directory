...
var ApIs = /** @class */ (function () {
    ...
    **/
    ApIs.prototype.alsbl = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ApIs.prototype.alsfc = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ApIs.prototype.apptu = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ApIs.prototype.noocl = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
