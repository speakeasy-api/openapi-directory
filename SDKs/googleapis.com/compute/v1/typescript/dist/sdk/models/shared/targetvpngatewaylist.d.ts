 ...
 */
export declare enum TargetVpnGatewayListWarningCodeEnum {
...
export declare class TargetVpnGatewayListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetVpnGatewayListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class TargetVpnGatewayList extends SpeakeasyBase {
    /**
