...
public class GetMssqlDbMissedRecoverableRangesRequest {
    /**
    ...
    public GetMssqlDbMissedRecoverableRangesRequest withAfterTime(OffsetDateTime afterTime) {
    ...
    public GetMssqlDbMissedRecoverableRangesRequest withBeforeTime(OffsetDateTime beforeTime) {
    ...
    public GetMssqlDbMissedRecoverableRangesRequest withId(String id) {
        this.id = id;
        return this;
    }
    
    public GetMssqlDbMissedRecoverableRangesRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
