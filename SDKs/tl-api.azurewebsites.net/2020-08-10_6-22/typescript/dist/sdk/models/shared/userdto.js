...
var UserDTO = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "externalEntityNumber" }),
        __metadata("design:type", String)
    ], UserDTO.prototype, "externalEntityNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "guardian" }),
        __metadata("design:type", Number)
    ], UserDTO.prototype, "guardian", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "gymNumber" }),
        __metadata("design:type", String)
    ], UserDTO.prototype, "gymNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "introduceBy" }),
        __metadata("design:type", Number)
