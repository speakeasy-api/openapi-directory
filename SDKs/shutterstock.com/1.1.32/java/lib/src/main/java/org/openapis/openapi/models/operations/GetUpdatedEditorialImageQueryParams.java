...
public class GetUpdatedEditorialImageQueryParams {
    /**
     * Show only editorial content that is available for distribution in a certain country
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=country")
    public String country;
    public GetUpdatedEditorialImageQueryParams withCountry(String country) {
    ...
    public GetUpdatedEditorialImageQueryParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public GetUpdatedEditorialImageQueryParams withDateTakenEnd(LocalDate dateTakenEnd) {
    ...
    public GetUpdatedEditorialImageQueryParams withDateTakenStart(LocalDate dateTakenStart) {
    ...
    public GetUpdatedEditorialImageQueryParams withDateUpdatedEnd(OffsetDateTime dateUpdatedEnd) {
    ...
    public GetUpdatedEditorialImageQueryParams withDateUpdatedStart(OffsetDateTime dateUpdatedStart) {
    ...
    public Long perPage;
    public GetUpdatedEditorialImageQueryParams withPerPage(Long perPage) {
    ...
    public GetUpdatedEditorialImageQueryParams withSort(GetUpdatedEditorialImageSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetUpdatedEditorialImageQueryParams withSupplierCode(String[] supplierCode) {
    ...
    public GetUpdatedEditorialImageQueryParams withType(GetUpdatedEditorialImageTypeEnum type) {
        this.type = type;
        return this;
    }
