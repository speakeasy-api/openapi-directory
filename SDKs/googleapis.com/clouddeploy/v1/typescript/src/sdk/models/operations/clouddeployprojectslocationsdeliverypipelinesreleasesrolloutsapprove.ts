...
export class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsApprovePathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=name" })
  name: string;
}


export class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsApproveQueryParams extends SpeakeasyBase {
...
export class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsApproveSecurity extends SpeakeasyBase {
...
export class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsApproveRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
