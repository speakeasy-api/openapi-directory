...
class GETDisableTransitGatewayRouteTablePropagationRequest
{
     ...
     * 
     * @var ?string $transitGatewayRouteTableAnnouncementId
     */
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETDisableTransitGatewayRouteTablePropagationActionEnum::DISABLE_TRANSIT_GATEWAY_ROUTE_TABLE_PROPAGATION;
		$this->dryRun = null;
		$this->transitGatewayAttachmentId = null;
		$this->transitGatewayRouteTableAnnouncementId = null;
		$this->transitGatewayRouteTableId = "";
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETDisableTransitGatewayRouteTablePropagationVersionEnum::TWO_THOUSAND_AND_SIXTEEN1115;
