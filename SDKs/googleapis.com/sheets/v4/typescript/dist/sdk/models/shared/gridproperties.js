...
var GridProperties = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=columnGroupControlAfter" }),
        __metadata("design:type", Boolean)
    ], GridProperties.prototype, "columnGroupControlAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=frozenColumnCount" }),
        __metadata("design:type", Number)
    ], GridProperties.prototype, "frozenColumnCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=frozenRowCount" }),
        __metadata("design:type", Number)
    ], GridProperties.prototype, "frozenRowCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=hideGridlines" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rowGroupControlAfter" }),
        __metadata("design:type", Boolean)
