 ...
 */
export declare class DescribeStoreImageTasksRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeStoreImageTasksRequest extends SpeakeasyBase {
    dryRun?: boolean;
