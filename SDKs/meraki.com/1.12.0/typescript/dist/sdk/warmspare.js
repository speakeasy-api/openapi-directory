...
exports.WarmSpare = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var WarmSpare = /** @class */ (function () {
    function WarmSpare(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    WarmSpare.prototype.getDeviceSwitchWarmSpare = function (req, config) {
    ...
    **/
    WarmSpare.prototype.getNetworkApplianceWarmSpare = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    WarmSpare.prototype.swapNetworkApplianceWarmSpare = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    WarmSpare.prototype.updateDeviceSwitchWarmSpare = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    WarmSpare.prototype.updateNetworkApplianceWarmSpare = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
