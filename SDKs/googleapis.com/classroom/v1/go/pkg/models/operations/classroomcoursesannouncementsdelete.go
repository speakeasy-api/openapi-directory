...
type ClassroomCoursesAnnouncementsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ClassroomCoursesAnnouncementsDeletePathParams struct {
...
type ClassroomCoursesAnnouncementsDeleteQueryParams struct {
	// V1 error format.
...
type ClassroomCoursesAnnouncementsDeleteRequest struct {
...
type ClassroomCoursesAnnouncementsDeleteResponse struct {
	ContentType string
	// Successful response
