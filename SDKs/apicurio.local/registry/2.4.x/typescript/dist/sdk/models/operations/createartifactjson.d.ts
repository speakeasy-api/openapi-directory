 ...
 */
export declare enum CreateArtifactJsonXRegistryHashAlgorithmEnum {
    Sha256 = "SHA256",
    Md5 = "MD5"
}
export declare class CreateArtifactJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateArtifactJsonResponse extends SpeakeasyBase {
    /**
