...
class UpdateObjectAttributesRequestBody:
    ...
    object_reference: UpdateObjectAttributesRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ObjectReference') }})
    r"""The reference that identifies an object."""  
...
class UpdateObjectAttributesRequest:
    ...
    request_body: UpdateObjectAttributesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
