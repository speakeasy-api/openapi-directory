...
class ListAccountRequest:
    ...
    r"""Only return the Account resources with friendly names that exactly match this name."""  
...
class ListAccountListAccountResponse:
    ...
    accounts: Optional[list[shared_api_v2010_account.APIV2010Account]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('accounts'), 'exclude': lambda f: f is None }})  
