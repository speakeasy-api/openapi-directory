...
public class IPAllocationPolicy {
    ...
    public IPAllocationPolicy withAdditionalPodRangesConfig(AdditionalPodRangesConfig additionalPodRangesConfig) {
    ...
    public IPAllocationPolicy withPodCidrOverprovisionConfig(PodCIDROverprovisionConfig podCidrOverprovisionConfig) {
