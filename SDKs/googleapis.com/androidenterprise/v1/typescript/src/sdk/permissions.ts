...
export class Permissions {
  ...
  androidenterprisePermissionsGet(
    ...
    security: operations.AndroidenterprisePermissionsGetSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.AndroidenterprisePermissionsGetSecurity(
        security
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AndroidenterprisePermissionsGetResponse =
        new operations.AndroidenterprisePermissionsGetResponse({
