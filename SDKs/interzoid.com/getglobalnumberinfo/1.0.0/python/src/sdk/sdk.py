...
from .global_phone_number_information import GlobalPhoneNumberInformation
...
class SDK:
    ...
    global_phone_number_information: GlobalPhoneNumberInformation
    ...
    def _init_sdks(self):
        ...
        self.global_phone_number_information = GlobalPhoneNumberInformation(
            self._client,
