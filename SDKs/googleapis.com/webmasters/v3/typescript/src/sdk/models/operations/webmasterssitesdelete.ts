...
export class WebmastersSitesDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class WebmastersSitesDeleteRequest extends SpeakeasyBase {
  /**
...
export class WebmastersSitesDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
