...
public class GetTagsTagTopAskersPeriodQueryParams {
    /**
    ...
    public GetTagsTagTopAskersPeriodQueryParams withCallback(String callback) {
    ...
    public GetTagsTagTopAskersPeriodQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public Long page;
    public GetTagsTagTopAskersPeriodQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetTagsTagTopAskersPeriodQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetTagsTagTopAskersPeriodQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
