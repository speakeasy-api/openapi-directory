...
var ItemDraft = /** @class */ (function () {
    function ItemDraft(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ItemDraft.prototype.createItemDraft = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateItemDraftRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/item_draft/";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.itemDraftResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
