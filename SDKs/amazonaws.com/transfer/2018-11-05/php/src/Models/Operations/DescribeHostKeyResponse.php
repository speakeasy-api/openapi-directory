...
class DescribeHostKeyResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\DescribeHostKeyResponse $describeHostKeyResponse
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\DescribeHostKeyResponse $describeHostKeyResponse = null;
	...
	{
		$this->contentType = "";
		$this->describeHostKeyResponse = null;
