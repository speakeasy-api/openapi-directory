...
export class MybusinessAccountsLocationsQuestionsAnswersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinessAccountsLocationsQuestionsAnswersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
