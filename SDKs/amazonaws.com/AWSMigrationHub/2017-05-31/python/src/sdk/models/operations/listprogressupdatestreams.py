...
class ListProgressUpdateStreamsRequest:
    ...
    list_progress_update_streams_request: shared_listprogressupdatestreamsrequest.ListProgressUpdateStreamsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
