...
export declare class SystemPoliciesConfig {
     ...
     *
     */
    changeClassificationPoliciesConfig(req: operations.ChangeClassificationPoliciesConfigRequest, config?: AxiosRequestConfig): Promise<operations.ChangeClassificationPoliciesConfigResponse>;
    /**
     ...
     * None.
     */
    changeGuestUsersPoliciesConfig(req: operations.ChangeGuestUsersPoliciesConfigRequest, config?: AxiosRequestConfig): Promise<operations.ChangeGuestUsersPoliciesConfigResponse>;
    /**
     * Change MFA policies
     *
     * @remarks
     ...
     * None.
     */
    changeMfaPoliciesConfig(req: operations.ChangeMfaPoliciesConfigRequest, config?: AxiosRequestConfig): Promise<operations.ChangeMfaPoliciesConfigResponse>;
    /**
     ...
     *
     */
    requestClassificationPoliciesConfig(req: operations.RequestClassificationPoliciesConfigRequest, config?: AxiosRequestConfig): Promise<operations.RequestClassificationPoliciesConfigResponse>;
    /**
     ...
     * None.
     */
    requestGuestUsersPoliciesConfig(req: operations.RequestGuestUsersPoliciesConfigRequest, config?: AxiosRequestConfig): Promise<operations.RequestGuestUsersPoliciesConfigResponse>;
    /**
     ...
     * None.
     */
    requestMfaPoliciesConfig(req: operations.RequestMfaPoliciesConfigRequest, config?: AxiosRequestConfig): Promise<operations.RequestMfaPoliciesConfigResponse>;
    /**
