...
public class UpdateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv21Mv71 {
    ...
    public UpdateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv21Mv71(@JsonProperty("quality") UpdateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv21Mv71QualityEnum quality, @JsonProperty("resolution") UpdateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv21Mv71ResolutionEnum resolution) {
        this.quality = quality;
        this.resolution = resolution;
  }
}
