...
exports.GetProductsCategoryCategoryIdCountJsonResponse = exports.GetProductsCategoryCategoryIdCountJsonRequest = void 0;
...
var GetProductsCategoryCategoryIdCountJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetProductsCategoryCategoryIdCountJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=category_id",
        }),
        __metadata("design:type", Number)
    ], GetProductsCategoryCategoryIdCountJsonRequest.prototype, "categoryId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locale",
        }),
        __metadata("design:type", String)
    ], GetProductsCategoryCategoryIdCountJsonRequest.prototype, "locale", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetProductsCategoryCategoryIdCountJsonRequest.prototype, "login", void 0);
    return GetProductsCategoryCategoryIdCountJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetProductsCategoryCategoryIdCountJsonRequest = GetProductsCategoryCategoryIdCountJsonRequest;
var GetProductsCategoryCategoryIdCountJsonResponse = /** @class */ (function (_super) {
    ...
    ], GetProductsCategoryCategoryIdCountJsonResponse.prototype, "rawResponse", void 0);
    return GetProductsCategoryCategoryIdCountJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetProductsCategoryCategoryIdCountJsonResponse = GetProductsCategoryCategoryIdCountJsonResponse;
