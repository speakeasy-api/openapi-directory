...
class AgentLocationResultAddress:
    ...
    state: AgentLocationResultAddressStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
    r"""State postal code of the address"""  
...
class AgentLocationResult:
    ...
    address: AgentLocationResultAddress = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address') }})
    r"""Address of the agent location"""  
