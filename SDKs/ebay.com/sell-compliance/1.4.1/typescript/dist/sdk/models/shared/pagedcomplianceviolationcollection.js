...
var PagedComplianceViolationCollection = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: complianceviolation_1.ComplianceViolation }),
        (0, class_transformer_1.Expose)({ name: "listingViolations" }),
        (0, class_transformer_1.Type)(function () { return complianceviolation_1.ComplianceViolation; }),
