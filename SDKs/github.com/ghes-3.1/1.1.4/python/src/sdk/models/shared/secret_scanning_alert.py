...
class SecretScanningAlert:
    ...
    resolution: Optional[shared_secret_scanning_alert_resolution_enum.SecretScanningAlertResolutionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('resolution') }})
