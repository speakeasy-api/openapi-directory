...
func (e UsageRecordEnumGroupEnum) ToPointer() *UsageRecordEnumGroupEnum {
	return &e
}
...
func (e *UsageRecordEnumGroupEnum) UnmarshalJSON(data []byte) error {
	...
	case "network":
		fallthrough
	case "isoCountry":
		*e = UsageRecordEnumGroupEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UsageRecordEnumGroupEnum: %v", v)
	}
}
