...
export enum GETRestoreImageFromRecycleBinActionEnum {
  RestoreImageFromRecycleBin = "RestoreImageFromRecycleBin",
}

export enum GETRestoreImageFromRecycleBinVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETRestoreImageFromRecycleBinRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETRestoreImageFromRecycleBinResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
