...
type AndroidenterpriseGrouplicenseusersListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseGrouplicenseusersListPathParams struct {
...
type AndroidenterpriseGrouplicenseusersListQueryParams struct {
	// V1 error format.
...
type AndroidenterpriseGrouplicenseusersListRequest struct {
...
type AndroidenterpriseGrouplicenseusersListResponse struct {
	ContentType string
	// Successful response
