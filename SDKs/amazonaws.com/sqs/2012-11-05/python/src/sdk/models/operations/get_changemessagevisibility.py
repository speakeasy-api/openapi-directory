...
class GetChangeMessageVisibilityRequest:
    headers: GetChangeMessageVisibilityHeaders = dataclasses.field()
    path_params: GetChangeMessageVisibilityPathParams = dataclasses.field()
    query_params: GetChangeMessageVisibilityQueryParams = dataclasses.field()
