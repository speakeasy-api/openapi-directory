...
func main() {
    ...
    res, err := s.SDK.AssociateNode(ctx, operations.AssociateNodeRequest{
...
func main() {
    ...
    res, err := s.SDK.CreateBackup(ctx, operations.CreateBackupRequest{
        ...
        XAmzTarget: operations.CreateBackupXAmzTargetEnumOpsWorksCmV20161101CreateBackup,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.CreateServer(ctx, operations.CreateServerRequest{
        CreateServerRequest: shared.CreateServerRequest{
            ...
            BackupID: sdk.String("qui"),
            BackupRetentionCount: sdk.Int64(774234),
            CustomCertificate: sdk.String("cum"),
            CustomDomain: sdk.String("esse"),
            CustomPrivateKey: sdk.String("ipsum"),
            DisableAutomatedBackup: sdk.Bool(false),
            Engine: "excepturi",
            EngineAttributes: []shared.EngineAttribute{
                shared.EngineAttribute{
            ...
            EngineModel: sdk.String("natus"),
            EngineVersion: sdk.String("laboriosam"),
            InstanceProfileArn: "hic",
            InstanceType: "saepe",
            KeyPair: sdk.String("fuga"),
            PreferredBackupWindow: sdk.String("in"),
            PreferredMaintenanceWindow: sdk.String("corporis"),
            SecurityGroupIds: []string{
                "iure",
                "saepe",
                "quidem",
            },
            ServerName: "architecto",
            ServiceRoleArn: "ipsa",
            SubnetIds: []string{
                "est",
                "mollitia",
        ...
        XAmzTarget: operations.CreateServerXAmzTargetEnumOpsWorksCmV20161101CreateServer,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.DeleteBackup(ctx, operations.DeleteBackupRequest{
        ...
        XAmzTarget: operations.DeleteBackupXAmzTargetEnumOpsWorksCmV20161101DeleteBackup,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.DeleteServer(ctx, operations.DeleteServerRequest{
        ...
        XAmzTarget: operations.DeleteServerXAmzTargetEnumOpsWorksCmV20161101DeleteServer,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DeleteServerResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.SDK.DescribeAccountAttributes(ctx, operations.DescribeAccountAttributesRequest{
        ...
        XAmzTarget: operations.DescribeAccountAttributesXAmzTargetEnumOpsWorksCmV20161101DescribeAccountAttributes,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.DescribeBackups(ctx, operations.DescribeBackupsRequest{
        DescribeBackupsRequest: shared.DescribeBackupsRequest{
            BackupID: sdk.String("sequi"),
            MaxResults: sdk.Int64(949572),
            NextToken: sdk.String("ipsam"),
            ServerName: sdk.String("id"),
        },
        ...
        XAmzTarget: operations.DescribeBackupsXAmzTargetEnumOpsWorksCmV20161101DescribeBackups,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.DescribeEvents(ctx, operations.DescribeEventsRequest{
        ...
        XAmzTarget: operations.DescribeEventsXAmzTargetEnumOpsWorksCmV20161101DescribeEvents,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DescribeNodeAssociationStatus(ctx, operations.DescribeNodeAssociationStatusRequest{
        DescribeNodeAssociationStatusRequest: shared.DescribeNodeAssociationStatusRequest{
            NodeAssociationStatusToken: "maiores",
            ServerName: "dicta",
        },
        ...
        XAmzTarget: operations.DescribeNodeAssociationStatusXAmzTargetEnumOpsWorksCmV20161101DescribeNodeAssociationStatus,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DescribeNodeAssociationStatusResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.SDK.DescribeServers(ctx, operations.DescribeServersRequest{
        ...
        XAmzTarget: operations.DescribeServersXAmzTargetEnumOpsWorksCmV20161101DescribeServers,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DescribeServersResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DisassociateNode(ctx, operations.DisassociateNodeRequest{
        ...
        XAmzSignedHeaders: sdk.String("modi"),
        XAmzTarget: operations.DisassociateNodeXAmzTargetEnumOpsWorksCmV20161101DisassociateNode,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DisassociateNodeResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.ExportServerEngineAttribute(ctx, operations.ExportServerEngineAttributeRequest{
        ExportServerEngineAttributeRequest: shared.ExportServerEngineAttributeRequest{
            ExportAttributeName: "qui",
            InputAttributes: []shared.EngineAttribute{
                shared.EngineAttribute{
        ...
        XAmzTarget: operations.ExportServerEngineAttributeXAmzTargetEnumOpsWorksCmV20161101ExportServerEngineAttribute,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.ExportServerEngineAttributeResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.SDK.ListTagsForResource(ctx, operations.ListTagsForResourceRequest{
        ...
        XAmzTarget: operations.ListTagsForResourceXAmzTargetEnumOpsWorksCmV20161101ListTagsForResource,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.RestoreServer(ctx, operations.RestoreServerRequest{
        RestoreServerRequest: shared.RestoreServerRequest{
            BackupID: "rerum",
            InstanceType: sdk.String("dicta"),
            KeyPair: sdk.String("magnam"),
            ServerName: "cumque",
        },
        ...
        XAmzTarget: operations.RestoreServerXAmzTargetEnumOpsWorksCmV20161101RestoreServer,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.RestoreServerResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.StartMaintenance(ctx, operations.StartMaintenanceRequest{
        ...
        XAmzTarget: operations.StartMaintenanceXAmzTargetEnumOpsWorksCmV20161101StartMaintenance,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.StartMaintenanceResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.SDK.TagResource(ctx, operations.TagResourceRequest{
        ...
        XAmzTarget: operations.TagResourceXAmzTargetEnumOpsWorksCmV20161101TagResource,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.UntagResource(ctx, operations.UntagResourceRequest{
        ...
        XAmzTarget: operations.UntagResourceXAmzTargetEnumOpsWorksCmV20161101UntagResource,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.UpdateServer(ctx, operations.UpdateServerRequest{
        UpdateServerRequest: shared.UpdateServerRequest{
            BackupRetentionCount: sdk.Int64(141264),
            DisableAutomatedBackup: sdk.Bool(false),
            PreferredBackupWindow: sdk.String("nemo"),
            PreferredMaintenanceWindow: sdk.String("quasi"),
            ServerName: "iure",
        },
        ...
        XAmzTarget: operations.UpdateServerXAmzTargetEnumOpsWorksCmV20161101UpdateServer,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.UpdateServerEngineAttributes(ctx, operations.UpdateServerEngineAttributesRequest{
        ...
        XAmzTarget: operations.UpdateServerEngineAttributesXAmzTargetEnumOpsWorksCmV20161101UpdateServerEngineAttributes,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.UpdateServerEngineAttributesResponse != nil {
        // handle response
    }
}
```
