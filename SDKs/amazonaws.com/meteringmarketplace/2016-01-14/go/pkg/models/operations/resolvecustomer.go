...
func (e ResolveCustomerXAmzTargetEnum) ToPointer() *ResolveCustomerXAmzTargetEnum {
	return &e
}
...
func (e *ResolveCustomerXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSMPMeteringService.ResolveCustomer":
		*e = ResolveCustomerXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ResolveCustomerXAmzTargetEnum: %v", v)
	}
}
