...
class GetTimePeriodRequest:
    ...
    r"""Globally unique identifier for the time period."""  
...
class GetTimePeriod200ApplicationJSON:
    r"""Successfully retrieved the record for a single time period."""
    
    data: Optional[shared_timeperiodresponse.TimePeriodResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
