...
public class RegistryListApiSpecRevisionsRequest {
    ...
    public RegistryListApiSpecRevisionsRequest(@JsonProperty("api") String api, @JsonProperty("location") String location, @JsonProperty("project") String project, @JsonProperty("spec") String spec, @JsonProperty("version") String version) {
        this.api = api;
        this.location = location;
        this.project = project;
        this.spec = spec;
