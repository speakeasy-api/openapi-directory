...
type DescribeNotificationConfigurationHeaders struct {
...
type DescribeNotificationConfigurationRequest struct {
	Headers DescribeNotificationConfigurationHeaders
	Request DescribeNotificationConfigurationRequestBody `request:"mediaType=application/json"`
}
