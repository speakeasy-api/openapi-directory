...
@dataclasses.dataclass
class BloggerBlogsListQueryParams:
...
class BloggerBlogsListRequest:
    path_params: BloggerBlogsListPathParams = dataclasses.field()
    query_params: BloggerBlogsListQueryParams = dataclasses.field()
    security: BloggerBlogsListSecurity = dataclasses.field()
