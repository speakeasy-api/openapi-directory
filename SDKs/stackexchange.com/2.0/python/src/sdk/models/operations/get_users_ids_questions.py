...
class GetUsersIdsQuestionsSortEnum(str, Enum):
    ACTIVITY = "activity"
    CREATION = "creation"
    VOTES = "votes"
...
class GetUsersIdsQuestionsQueryParams:
    ...
    order: Optional[GetUsersIdsQuestionsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetUsersIdsQuestionsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetUsersIdsQuestionsRequest:
    path_params: GetUsersIdsQuestionsPathParams = dataclasses.field()
    query_params: GetUsersIdsQuestionsQueryParams = dataclasses.field()
