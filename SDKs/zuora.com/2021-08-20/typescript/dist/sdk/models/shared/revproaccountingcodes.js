...
var RevproAccountingCodes = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "adjustmentLiabilityAccount" }),
        __metadata("design:type", String)
    ], RevproAccountingCodes.prototype, "adjustmentLiabilityAccount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "adjustmentRevenueAccount" }),
        __metadata("design:type", String)
    ], RevproAccountingCodes.prototype, "adjustmentRevenueAccount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "contractAssetAccount" }),
        __metadata("design:type", String)
    ], RevproAccountingCodes.prototype, "contractAssetAccount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "contractLiabilityAccount" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "unbilledReceivablesAccount" }),
        __metadata("design:type", String)
