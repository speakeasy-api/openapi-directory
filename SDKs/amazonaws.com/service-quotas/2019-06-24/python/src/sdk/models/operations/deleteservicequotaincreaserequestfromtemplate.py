...
class DeleteServiceQuotaIncreaseRequestFromTemplateRequest:
    ...
    delete_service_quota_increase_request_from_template_request: shared_deleteservicequotaincreaserequestfromtemplaterequest.DeleteServiceQuotaIncreaseRequestFromTemplateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
