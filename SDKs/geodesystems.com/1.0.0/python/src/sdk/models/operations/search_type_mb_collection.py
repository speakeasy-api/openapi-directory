...
class SearchTypeMbCollectionQueryParams:
...
@dataclasses.dataclass
class SearchTypeMbCollectionRequest:
    query_params: SearchTypeMbCollectionQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeMbCollectionResponse:
