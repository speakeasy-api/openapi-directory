...
public class Reviews {
    ...
    **/
    public openapisdk.models.operations.AndroidpublisherReviewsGetResponse androidpublisherReviewsGet(openapisdk.models.operations.AndroidpublisherReviewsGetRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/androidpublisher/v3/applications/{packageName}/reviews/{reviewId}", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.Review out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.Review.class);
                res.review = out;
            }
        }
    ...
    **/
    public openapisdk.models.operations.AndroidpublisherReviewsListResponse androidpublisherReviewsList(openapisdk.models.operations.AndroidpublisherReviewsListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/androidpublisher/v3/applications/{packageName}/reviews", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.ReviewsListResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ReviewsListResponse.class);
    ...
    **/
    public openapisdk.models.operations.AndroidpublisherReviewsReplyResponse androidpublisherReviewsReply(openapisdk.models.operations.AndroidpublisherReviewsReplyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/androidpublisher/v3/applications/{packageName}/reviews/{reviewId}:reply", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.ReviewsReplyResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ReviewsReplyResponse.class);
