...
try {
    ...
    $request->certificateParameters->cent = 'B18-006';
    $request->certificateParameters->mName = 'Sana Khan';
    $request->certificateParameters->name = 'Abdul Khan';
    $request->certificateParameters->rroll = 'XXX6';
