...
type GetRepositorySyncStatusHeaders struct {
...
type GetRepositorySyncStatusRequest struct {
	Headers GetRepositorySyncStatusHeaders
	Request shared.GetRepositorySyncStatusInput `request:"mediaType=application/json"`
}
