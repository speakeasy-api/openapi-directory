...
export class PutOrganisationsPartyIdLicensesProductIdRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class PutOrganisationsPartyIdLicensesProductIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
