...
public class WtrblSecurity {
    ...
    public WtrblSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public WtrblSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public WtrblSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
