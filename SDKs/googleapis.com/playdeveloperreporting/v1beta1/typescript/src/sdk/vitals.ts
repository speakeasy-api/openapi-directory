      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googlePlayDeveloperReportingV1beta1SearchErrorIssuesResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GooglePlayDeveloperReportingV1beta1SearchErrorIssuesResponse
              );
          }
          break;
      }
  ...
  playdeveloperreportingVitalsErrorsReportsSearch(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googlePlayDeveloperReportingV1beta1SearchErrorReportsResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GooglePlayDeveloperReportingV1beta1SearchErrorReportsResponse
              );
          }
          break;
      }
  ...
  playdeveloperreportingVitalsStuckbackgroundwakelockrateGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googlePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet =
              utils.objectToClass(
                httpRes?.data,
                shared.GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet
              );
          }
          break;
      }
  ...
  playdeveloperreportingVitalsStuckbackgroundwakelockrateQuery(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googlePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetResponse
              );
          }
          break;
      }
