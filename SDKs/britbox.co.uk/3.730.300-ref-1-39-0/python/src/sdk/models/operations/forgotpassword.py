...
from ..shared import passwordresetemailrequest as shared_passwordresetemailrequest
...
class ForgotPasswordRequest:
    ...
    password_reset_email_request: shared_passwordresetemailrequest.PasswordResetEmailRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
