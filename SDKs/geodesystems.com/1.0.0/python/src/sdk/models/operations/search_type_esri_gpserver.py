...
class SearchTypeEsriGpserverQueryParams:
...
@dataclasses.dataclass
class SearchTypeEsriGpserverRequest:
    query_params: SearchTypeEsriGpserverQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeEsriGpserverResponse:
