...
class RejectInvitationRequest:
    headers: RejectInvitationHeaders = dataclasses.field()
    request: RejectInvitationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
