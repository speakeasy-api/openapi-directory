...
type DialogflowProjectsLocationsConversationsSuggestionsSuggestConversationSummaryRequest struct {
	...
	Request     *shared.GoogleCloudDialogflowV2SuggestConversationSummaryRequest `request:"mediaType=application/json"`
...
type DialogflowProjectsLocationsConversationsSuggestionsSuggestConversationSummaryResponse struct {
	ContentType                                               string
	GoogleCloudDialogflowV2SuggestConversationSummaryResponse *shared.GoogleCloudDialogflowV2SuggestConversationSummaryResponse
	StatusCode                                                int64
}
