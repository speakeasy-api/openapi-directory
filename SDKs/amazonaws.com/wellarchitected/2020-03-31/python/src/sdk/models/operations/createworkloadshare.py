...
class CreateWorkloadShareRequestBody:
    ...
    permission_type: CreateWorkloadShareRequestBodyPermissionTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('PermissionType') }})
    shared_with: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SharedWith') }})
    

@dataclasses.dataclass
class CreateWorkloadShareRequest:
    headers: CreateWorkloadShareHeaders = dataclasses.field()
    path_params: CreateWorkloadSharePathParams = dataclasses.field()
    request: CreateWorkloadShareRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
