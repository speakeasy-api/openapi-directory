...
class GetTransitGatewayRouteTablePropagationsRequestFilters:
...
class GetTransitGatewayRouteTablePropagationsRequest:
    ...
    filters: Optional[list[GetTransitGatewayRouteTablePropagationsRequestFilters]] = dataclasses.field(default=None)  
