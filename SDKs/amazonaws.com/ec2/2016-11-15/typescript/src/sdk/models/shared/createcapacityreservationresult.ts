 ...
 */
export enum CreateCapacityReservationResultCapacityReservationCapacityAllocationsAllocationTypeEnum {
  Used = "used",
}
 ...
 */
export class CreateCapacityReservationResultCapacityReservationCapacityAllocations extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum CreateCapacityReservationResultCapacityReservationEndDateTypeEnum {
  Unlimited = "unlimited",
  Limited = "limited",
}
 ...
 */
export enum CreateCapacityReservationResultCapacityReservationInstanceMatchCriteriaEnum {
  Open = "open",
  Targeted = "targeted",
}
 ...
 */
export enum CreateCapacityReservationResultCapacityReservationInstancePlatformEnum {
 ...
 */
export enum CreateCapacityReservationResultCapacityReservationStateEnum {
  Active = "active",
  Expired = "expired",
  Cancelled = "cancelled",
  Pending = "pending",
 ...
 * Describes a tag.
 */
export class CreateCapacityReservationResultCapacityReservationTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export enum CreateCapacityReservationResultCapacityReservationTenancyEnum {
  Default = "default",
  Dedicated = "dedicated",
}
...
export class CreateCapacityReservationResultCapacityReservation extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({
    elemType:
      CreateCapacityReservationResultCapacityReservationCapacityAllocations,
  })
