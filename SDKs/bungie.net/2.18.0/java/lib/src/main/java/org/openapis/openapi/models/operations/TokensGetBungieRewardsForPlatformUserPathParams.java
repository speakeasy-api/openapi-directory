...
public class TokensGetBungieRewardsForPlatformUserPathParams {
    /**
    ...
    public TokensGetBungieRewardsForPlatformUserPathParams withMembershipId(Long membershipId) {
    ...
    public TokensGetBungieRewardsForPlatformUserPathParams withMembershipType(Integer membershipType) {
