...
export const ListWebhookServerList = ["https://verify.twilio.com"] as const;
...
export class ListWebhookListWebhookResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.VerifyV2ServiceWebhook })
  @Expose({ name: "webhooks" })
  @Type(() => shared.VerifyV2ServiceWebhook)
