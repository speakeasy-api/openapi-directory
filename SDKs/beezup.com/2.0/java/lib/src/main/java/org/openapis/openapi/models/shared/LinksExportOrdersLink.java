...
public class LinksExportOrdersLink {
    ...
    public LinksExportOrdersLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksExportOrdersLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksExportOrdersLink withDescription(String description) {
    ...
    public LinksExportOrdersLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksExportOrdersLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksExportOrdersLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksExportOrdersLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksExportOrdersLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksExportOrdersLink withOperationId(String operationId) {
    ...
    public LinksExportOrdersLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksExportOrdersLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksExportOrdersLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
