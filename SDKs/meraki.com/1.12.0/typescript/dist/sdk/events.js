...
var Events = /** @class */ (function () {
    ...
    **/
    Events.prototype.getNetworkApplianceClientSecurityEvents = function (req, config) {
    ...
    **/
    Events.prototype.getNetworkApplianceSecurityEvents = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Events.prototype.getNetworkEvents = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Events.prototype.getNetworkEventsEventTypes = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Events.prototype.getOrganizationApplianceSecurityEvents = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
