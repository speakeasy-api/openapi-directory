...
class RequestUserKeyPairRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestUserKeyPairXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestUserKeyPairXSdsDateFormatEnum $xSdsDateFormat = null;
