...
public class ProductApiAllHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ProductApiAllHeaders withXAuthKey(String xAuthKey) {
    ...
    public ProductApiAllHeaders withXAuthSecret(String xAuthSecret) {
