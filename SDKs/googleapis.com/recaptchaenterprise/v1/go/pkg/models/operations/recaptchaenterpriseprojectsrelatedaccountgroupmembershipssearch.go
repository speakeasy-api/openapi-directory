...
type RecaptchaenterpriseProjectsRelatedaccountgroupmembershipsSearchRequest struct {
	...
	GoogleCloudRecaptchaenterpriseV1SearchRelatedAccountGroupMembershipsRequest *shared.GoogleCloudRecaptchaenterpriseV1SearchRelatedAccountGroupMembershipsRequest `request:"mediaType=application/json"`
	// OAuth access token.
