...
class ScriptProjectsDeploymentsGetSecurity:
    ...
    option1: Optional[ScriptProjectsDeploymentsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[ScriptProjectsDeploymentsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
