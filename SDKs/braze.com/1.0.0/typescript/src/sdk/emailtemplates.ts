...
export class EmailTemplates {
  ...
  listAvailableEmailTemplates(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ListAvailableEmailTemplatesResponse =
        new operations.ListAvailableEmailTemplatesResponse({
  ...
  seeEmailTemplateInformation(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SeeEmailTemplateInformationResponse =
        new operations.SeeEmailTemplateInformationResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
