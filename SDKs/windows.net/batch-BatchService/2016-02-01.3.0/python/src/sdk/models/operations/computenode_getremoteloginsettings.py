...
from ..shared import computenodegetremoteloginsettingsresult as shared_computenodegetremoteloginsettingsresult
...
class ComputeNodeGetRemoteLoginSettingsRequest:
    ...
    r"""The id of the compute node for which to obtain the remote login settings."""  
...
class ComputeNodeGetRemoteLoginSettingsResponse:
    ...
    compute_node_get_remote_login_settings_result: Optional[shared_computenodegetremoteloginsettingsresult.ComputeNodeGetRemoteLoginSettingsResult] = dataclasses.field(default=None)  
