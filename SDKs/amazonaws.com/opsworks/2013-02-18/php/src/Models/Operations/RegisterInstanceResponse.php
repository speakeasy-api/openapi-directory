...
class RegisterInstanceResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RegisterInstanceResult $registerInstanceResult
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\RegisterInstanceResult $registerInstanceResult = null;
	...
	{
		$this->contentType = "";
		$this->registerInstanceResult = null;
