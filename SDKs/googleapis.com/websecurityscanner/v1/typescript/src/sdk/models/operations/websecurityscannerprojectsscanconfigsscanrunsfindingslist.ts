...
export class WebsecurityscannerProjectsScanConfigsScanRunsFindingsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class WebsecurityscannerProjectsScanConfigsScanRunsFindingsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class WebsecurityscannerProjectsScanConfigsScanRunsFindingsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
