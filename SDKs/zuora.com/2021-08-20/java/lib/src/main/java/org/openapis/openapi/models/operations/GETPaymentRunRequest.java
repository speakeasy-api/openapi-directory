...
public class GETPaymentRunRequest {
    ...
    public GETPaymentRunRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETPaymentRunRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETPaymentRunRequest withPaymentRunId(String paymentRunId) {
