...
from ..shared import getrefundtype as shared_getrefundtype
from ..shared import putrefundtype as shared_putrefundtype
...
class PUTUpdateRefundRequest:
    ...
    put_refund_type: shared_putrefundtype.PUTRefundType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class PUTUpdateRefundResponse:
    ...
    get_refund_type: Optional[shared_getrefundtype.GETRefundType] = dataclasses.field(default=None)  
