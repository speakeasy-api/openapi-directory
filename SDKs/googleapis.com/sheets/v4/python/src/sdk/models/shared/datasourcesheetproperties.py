...
class DataSourceSheetProperties:
    ...
    columns: Optional[list[shared_datasourcecolumn.DataSourceColumn]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('columns'), 'exclude': lambda f: f is None }})
    r"""The columns displayed on the sheet, corresponding to the values in RowData."""  
    ...
    r"""ID of the DataSource the sheet is connected to."""  
