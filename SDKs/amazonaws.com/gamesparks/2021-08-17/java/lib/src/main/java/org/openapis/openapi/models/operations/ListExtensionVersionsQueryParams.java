...
public class ListExtensionVersionsQueryParams {
    /**
    ...
    public ListExtensionVersionsQueryParams withMaxResults(Long maxResults) {
    ...
    public ListExtensionVersionsQueryParams withNextToken(String nextToken) {
