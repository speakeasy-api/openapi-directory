...
class PatchRemoteServersIdRequestBody
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PatchRemoteServersIdRequestBodyFilesAgentPermissionSetEnum $filesAgentPermissionSet
     */
	#[SpeakeasyMetadata('multipartForm:name=files_agent_permission_set')]
    public ?PatchRemoteServersIdRequestBodyFilesAgentPermissionSetEnum $filesAgentPermissionSet = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PatchRemoteServersIdRequestBodyOneDriveAccountTypeEnum $oneDriveAccountType
     */
	#[SpeakeasyMetadata('multipartForm:name=one_drive_account_type')]
    public ?PatchRemoteServersIdRequestBodyOneDriveAccountTypeEnum $oneDriveAccountType = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PatchRemoteServersIdRequestBodyServerCertificateEnum $serverCertificate
     */
	#[SpeakeasyMetadata('multipartForm:name=server_certificate')]
    public ?PatchRemoteServersIdRequestBodyServerCertificateEnum $serverCertificate = null;
     ...
     * Remote server type.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PatchRemoteServersIdRequestBodyServerTypeEnum $serverType
     */
	#[SpeakeasyMetadata('multipartForm:name=server_type')]
    public ?PatchRemoteServersIdRequestBodyServerTypeEnum $serverType = null;
    
    /**
     * Should we require SSL?
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PatchRemoteServersIdRequestBodySslEnum $ssl
     */
	#[SpeakeasyMetadata('multipartForm:name=ssl')]
    public ?PatchRemoteServersIdRequestBodySslEnum $ssl = null;
