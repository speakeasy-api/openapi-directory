...
func (e *PosPaymentExternalDetailsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "food_voucher":
		fallthrough
	case "other":
		*e = PosPaymentExternalDetailsTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PosPaymentExternalDetailsTypeEnum: %s", s)
	}
}
...
func (e *PosPaymentProcessingFeesTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "initial":
		fallthrough
	case "adjustment":
		*e = PosPaymentProcessingFeesTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PosPaymentProcessingFeesTypeEnum: %s", s)
	}
}
...
func (e *PosPaymentSourceEnum) UnmarshalJSON(data []byte) error {
	...
	case "external":
		fallthrough
	case "other":
		*e = PosPaymentSourceEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PosPaymentSourceEnum: %s", s)
	}
}
...
func (e *PosPaymentStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "failed":
		fallthrough
	case "other":
		*e = PosPaymentStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PosPaymentStatusEnum: %s", s)
	}
}
...
func (e *PosPaymentWalletDetailsStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "failed":
		fallthrough
	case "other":
		*e = PosPaymentWalletDetailsStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PosPaymentWalletDetailsStatusEnum: %s", s)
	}
}
