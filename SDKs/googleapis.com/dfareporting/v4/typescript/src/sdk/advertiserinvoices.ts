...
export class AdvertiserInvoices {
  ...
  dfareportingAdvertiserInvoicesList(
    ...
    security: operations.DfareportingAdvertiserInvoicesListSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DfareportingAdvertiserInvoicesListSecurity(
        security
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DfareportingAdvertiserInvoicesListResponse =
        new operations.DfareportingAdvertiserInvoicesListResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.advertiserInvoicesListResponse = utils.objectToClass(
              httpRes?.data,
              shared.AdvertiserInvoicesListResponse
            );
          }
          break;
      }
