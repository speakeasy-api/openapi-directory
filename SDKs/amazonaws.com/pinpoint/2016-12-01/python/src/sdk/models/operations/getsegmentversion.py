...
from ..shared import getsegmentversionresponse as shared_getsegmentversionresponse
...
class GetSegmentVersionRequest:
    headers: GetSegmentVersionHeaders = dataclasses.field()
    path_params: GetSegmentVersionPathParams = dataclasses.field()
...
class GetSegmentVersionResponse:
    ...
    get_segment_version_response: Optional[shared_getsegmentversionresponse.GetSegmentVersionResponse] = dataclasses.field(default=None)
