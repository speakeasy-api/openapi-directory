...
class Facets:
    ...
    def facetscategory(self, request: operations.FacetscategoryRequest) -> operations.FacetscategoryResponse:
        r"""Search by Store Facets
        ...
        url = utils.generate_url(operations.FacetscategoryRequest, base_url, '/api/catalog_system/pub/facets/search/{term}', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.FacetscategoryRequest, request)
        ...
        res = operations.FacetscategoryResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.Facetscategory200ApplicationJSON])
                res.facetscategory_200_application_json_object = out

        return res

    def get_api_catalog_system_pub_facets_category_category_id_(self, request: operations.GetAPICatalogSystemPubFacetsCategoryCategoryIDRequest) -> operations.GetAPICatalogSystemPubFacetsCategoryCategoryIDResponse:
        r"""Get Category Facets
        ...
        url = utils.generate_url(operations.GetAPICatalogSystemPubFacetsCategoryCategoryIDRequest, base_url, '/api/catalog_system/pub/facets/category/{categoryId}', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.GetAPICatalogSystemPubFacetsCategoryCategoryIDRequest, request)
        ...
        res = operations.GetAPICatalogSystemPubFacetsCategoryCategoryIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[operations.GetAPICatalogSystemPubFacetsCategoryCategoryID200ApplicationJSON]])
                res.get_api_catalog_system_pub_facets_category_category_id_200_application_json_objects = out
