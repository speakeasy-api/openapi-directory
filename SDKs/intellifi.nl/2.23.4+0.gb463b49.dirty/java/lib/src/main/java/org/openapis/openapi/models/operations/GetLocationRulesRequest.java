...
public class GetLocationRulesRequest {
    ...
    public GetLocationRulesRequest withAfter(OffsetDateTime after) {
        this.after = after;
        return this;
    }
    ...
    public GetLocationRulesRequest withAfterId(String afterId) {
    ...
    public GetLocationRulesRequest withBefore(String before) {
        this.before = before;
        return this;
    }
    ...
    public GetLocationRulesRequest withBeforeId(String beforeId) {
    ...
    public GetLocationRulesRequest withEnabled(Boolean enabled) {
    ...
    public GetLocationRulesRequest withFrom(String from) {
        this.from = from;
        return this;
    }
    ...
    public GetLocationRulesRequest withFromId(String fromId) {
        this.fromId = fromId;
        return this;
    }
    ...
    public GetLocationRulesRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetLocationRulesRequest withIdOnly(Boolean idOnly) {
        this.idOnly = idOnly;
        return this;
    }
    ...
    public GetLocationRulesRequest withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public GetLocationRulesRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetLocationRulesRequest withPopulate(String populate) {
    ...
    public GetLocationRulesRequest withResultsOnly(Boolean resultsOnly) {
    ...
    public GetLocationRulesRequest withSelect(String select) {
        this.select = select;
        return this;
    }
    ...
    public GetLocationRulesRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetLocationRulesRequest withTimeCreated(String timeCreated) {
    ...
    public GetLocationRulesRequest withTimeUpdated(String timeUpdated) {
    ...
    public GetLocationRulesRequest withTimeoutS(Double timeoutS) {
    ...
    public GetLocationRulesRequest withType(org.openapis.openapi.models.shared.LocationRuleTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GetLocationRulesRequest withUntil(String until) {
        this.until = until;
        return this;
    }
    ...
    public GetLocationRulesRequest withUntilId(String untilId) {
        this.untilId = untilId;
        return this;
    }
    
    public GetLocationRulesRequest(){}
}
