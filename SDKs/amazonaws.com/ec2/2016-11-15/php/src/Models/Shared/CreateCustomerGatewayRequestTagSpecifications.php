 ...
 * @access public
 */
class CreateCustomerGatewayRequestTagSpecifications
{
	
    public ?CreateCustomerGatewayRequestTagSpecificationsResourceTypeEnum $resourceType = null;
    
    /**
     * $tags
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Shared\CreateCustomerGatewayRequestTagSpecificationsTags> $tags
     */
