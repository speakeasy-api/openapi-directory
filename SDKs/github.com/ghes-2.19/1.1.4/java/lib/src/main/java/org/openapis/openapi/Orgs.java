...
public class Orgs {
    ...
    public org.openapis.openapi.models.operations.OrgsUpdateResponse orgsUpdate(org.openapis.openapi.models.operations.OrgsUpdateRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.OrgsUpdate415ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.OrgsUpdate415ApplicationJSON.class);
