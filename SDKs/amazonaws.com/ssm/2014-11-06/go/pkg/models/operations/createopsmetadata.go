...
func (e CreateOpsMetadataXAmzTargetEnum) ToPointer() *CreateOpsMetadataXAmzTargetEnum {
	return &e
}
...
func (e *CreateOpsMetadataXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonSSM.CreateOpsMetadata":
		*e = CreateOpsMetadataXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOpsMetadataXAmzTargetEnum: %v", v)
	}
}

type CreateOpsMetadataRequest struct {
	CreateOpsMetadataRequest shared.CreateOpsMetadataRequest `request:"mediaType=application/json"`
