...
class PreprintProviders:
    ...
    def preprint_provider_detail(self, request: operations.PreprintProviderDetailRequest) -> operations.PreprintProviderDetailResponse:
        ...
        url = utils.generate_url(operations.PreprintProviderDetailRequest, base_url, '/preprint_providers/{preprint_provider_id}/', request)
        ...
        res = operations.PreprintProviderDetailResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def preprint_provider_licenses_list(self, request: operations.PreprintProviderLicensesListRequest) -> operations.PreprintProviderLicensesListResponse:
        ...
        url = utils.generate_url(operations.PreprintProviderLicensesListRequest, base_url, '/preprint_providers/{preprint_provider_id}/licenses/', request)
        ...
        res = operations.PreprintProviderLicensesListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def preprint_provider_list(self) -> operations.PreprintProviderListResponse:
        ...
        res = operations.PreprintProviderListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def preprint_provider_taxonomies_list(self, request: operations.PreprintProviderTaxonomiesListRequest) -> operations.PreprintProviderTaxonomiesListResponse:
        ...
        url = utils.generate_url(operations.PreprintProviderTaxonomiesListRequest, base_url, '/preprint_providers/{preprint_provider_id}/taxonomies/', request)
        ...
        res = operations.PreprintProviderTaxonomiesListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def preprint_providers_preprints_list(self, request: operations.PreprintProvidersPreprintsListRequest) -> operations.PreprintProvidersPreprintsListResponse:
        ...
        url = utils.generate_url(operations.PreprintProvidersPreprintsListRequest, base_url, '/preprint_providers/{preprint_provider_id}/preprints/', request)
        ...
        res = operations.PreprintProvidersPreprintsListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
