...
export class ListCloudFrontOriginAccessIdentities20180618Request extends SpeakeasyBase {
  /**
...
export class ListCloudFrontOriginAccessIdentities20180618Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
