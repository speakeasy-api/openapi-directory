...
func (e UpdateBackendStorageRequestBodyResourceConfigServiceNameEnum) ToPointer() *UpdateBackendStorageRequestBodyResourceConfigServiceNameEnum {
	return &e
}
...
func (e *UpdateBackendStorageRequestBodyResourceConfigServiceNameEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "S3":
		*e = UpdateBackendStorageRequestBodyResourceConfigServiceNameEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateBackendStorageRequestBodyResourceConfigServiceNameEnum: %v", v)
	}
}
