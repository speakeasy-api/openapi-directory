...
class DrivelabelsLabelsEnableRequest:
    ...
    google_apps_drive_labels_v2beta_enable_label_request: Optional[shared_googleappsdrivelabelsv2betaenablelabelrequest.GoogleAppsDriveLabelsV2betaEnableLabelRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
