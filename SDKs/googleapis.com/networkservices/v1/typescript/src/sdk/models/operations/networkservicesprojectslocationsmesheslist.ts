...
export class NetworkservicesProjectsLocationsMeshesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworkservicesProjectsLocationsMeshesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworkservicesProjectsLocationsMeshesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
