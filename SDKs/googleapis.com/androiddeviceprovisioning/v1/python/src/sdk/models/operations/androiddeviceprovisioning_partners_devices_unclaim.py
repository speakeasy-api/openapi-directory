...
from ..shared import unclaimdevicerequest as shared_unclaimdevicerequest
...
class AndroiddeviceprovisioningPartnersDevicesUnclaimRequest:
    path_params: AndroiddeviceprovisioningPartnersDevicesUnclaimPathParams = dataclasses.field()
    query_params: AndroiddeviceprovisioningPartnersDevicesUnclaimQueryParams = dataclasses.field()
    request: Optional[shared_unclaimdevicerequest.UnclaimDeviceRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
