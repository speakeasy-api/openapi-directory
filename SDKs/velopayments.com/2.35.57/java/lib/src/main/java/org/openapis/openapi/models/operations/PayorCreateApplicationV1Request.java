...
public class PayorCreateApplicationV1Request {
    ...
    public PayorCreateApplicationV1Request(@JsonProperty("PayorCreateApplicationRequest") org.openapis.openapi.models.shared.PayorCreateApplicationRequest payorCreateApplicationRequest, @JsonProperty("payorId") String payorId) {
        this.payorCreateApplicationRequest = payorCreateApplicationRequest;
        this.payorId = payorId;
  }
}
