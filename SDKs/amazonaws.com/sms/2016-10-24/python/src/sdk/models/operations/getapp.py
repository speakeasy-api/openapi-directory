...
from ..shared import getapprequest as shared_getapprequest
...
class GetAppHeaders:
    x_amz_target: GetAppXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
@dataclasses.dataclass
class GetAppRequest:
    headers: GetAppHeaders = dataclasses.field()
    request: shared_getapprequest.GetAppRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
