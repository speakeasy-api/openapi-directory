...
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetRequest:
    ...
    r"""Required. An identifier unique to the targeting type in this partner that identifies the assigned targeting option being requested."""  
    ...
    targeting_type: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
    r"""Required. Identifies the type of this assigned targeting option. Supported targeting types: * `TARGETING_TYPE_CHANNEL`"""  
