...
class GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDActivityRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDActivityPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDActivitySecurity = dataclasses.field()
