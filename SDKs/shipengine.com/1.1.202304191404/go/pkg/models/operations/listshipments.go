...
func (e ListShipmentsSortDirSortDirEnum) ToPointer() *ListShipmentsSortDirSortDirEnum {
	return &e
}
...
func (e *ListShipmentsSortDirSortDirEnum) UnmarshalJSON(data []byte) error {
	...
	case "asc":
		fallthrough
	case "desc":
		*e = ListShipmentsSortDirSortDirEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListShipmentsSortDirSortDirEnum: %v", v)
	}
}
