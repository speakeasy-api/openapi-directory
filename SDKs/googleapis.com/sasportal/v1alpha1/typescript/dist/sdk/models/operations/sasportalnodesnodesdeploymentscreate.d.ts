...
export declare class SasportalNodesNodesDeploymentsCreateSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesNodesDeploymentsCreateSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesNodesDeploymentsCreateSecurity extends SpeakeasyBase {
    option1?: SasportalNodesNodesDeploymentsCreateSecurityOption1;
    option2?: SasportalNodesNodesDeploymentsCreateSecurityOption2;
}
