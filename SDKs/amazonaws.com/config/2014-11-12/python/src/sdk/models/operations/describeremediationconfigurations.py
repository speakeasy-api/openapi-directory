...
class DescribeRemediationConfigurationsRequest:
    ...
    describe_remediation_configurations_request: shared_describeremediationconfigurationsrequest.DescribeRemediationConfigurationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
