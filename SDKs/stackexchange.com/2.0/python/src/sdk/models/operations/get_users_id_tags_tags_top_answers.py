...
class GetUsersIDTagsTagsTopAnswersPathParams:
    id: int = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    tags: str = dataclasses.field(metadata={'path_param': { 'field_name': 'tags', 'style': 'simple', 'explode': False }})
    
class GetUsersIDTagsTagsTopAnswersOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetUsersIDTagsTagsTopAnswersSortEnum(str, Enum):
    ACTIVITY = "activity"
    CREATION = "creation"
    VOTES = "votes"
...
@dataclasses.dataclass
class GetUsersIDTagsTagsTopAnswersQueryParams:
    ...
    order: Optional[GetUsersIDTagsTagsTopAnswersOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetUsersIDTagsTagsTopAnswersSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetUsersIDTagsTagsTopAnswersRequest:
    path_params: GetUsersIDTagsTagsTopAnswersPathParams = dataclasses.field()
    query_params: GetUsersIDTagsTagsTopAnswersQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetUsersIDTagsTagsTopAnswersResponse:
