...
class TaskrouterV1WorkspaceTaskQueueTaskQueueCumulativeStatistics:
    ...
    wait_duration_in_queue_until_accepted: Optional[Any] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('wait_duration_in_queue_until_accepted') }})
