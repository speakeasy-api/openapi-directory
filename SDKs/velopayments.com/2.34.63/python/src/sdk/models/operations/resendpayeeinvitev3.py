...
from ..shared import invitepayeerequestv3 as shared_invitepayeerequestv3
...
class ResendPayeeInviteV3Request:
    ...
    invite_payee_request_v3: shared_invitepayeerequestv3.InvitePayeeRequestV3 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
