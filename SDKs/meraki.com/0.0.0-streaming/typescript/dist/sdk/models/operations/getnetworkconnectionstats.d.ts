 ...
 */
export declare enum GetNetworkConnectionStatsBandEnum {
    Two4 = "2.4",
    Five = "5"
}
export declare class GetNetworkConnectionStatsRequest extends SpeakeasyBase {
    /**
...
export declare class GetNetworkConnectionStatsResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
