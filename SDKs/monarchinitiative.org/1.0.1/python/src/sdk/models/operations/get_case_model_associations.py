...
class GetCaseModelAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetCaseModelAssociationsQueryParams:
...
@dataclasses.dataclass
class GetCaseModelAssociationsRequest:
    path_params: GetCaseModelAssociationsPathParams = dataclasses.field()
    query_params: GetCaseModelAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetCaseModelAssociationsResponse:
