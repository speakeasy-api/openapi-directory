...
type MrAddressCountryEnum string

const (
	MrAddressCountryEnumEngland         MrAddressCountryEnum = "England"
	MrAddressCountryEnumScotland        MrAddressCountryEnum = "Scotland"
	MrAddressCountryEnumWales           MrAddressCountryEnum = "Wales"
	MrAddressCountryEnumNorthernIreland MrAddressCountryEnum = "Northern Ireland"
	MrAddressCountryEnumJersey          MrAddressCountryEnum = "Jersey"
	MrAddressCountryEnumGuernsey        MrAddressCountryEnum = "Guernsey"
	MrAddressCountryEnumIsleOfMan       MrAddressCountryEnum = "Isle of Man"
)

func (e *MrAddressCountryEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Guernsey":
		fallthrough
	case "Isle of Man":
		*e = MrAddressCountryEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for MrAddressCountryEnum: %s", s)
	}
}

type MrAddressCountryIsoEnum string

const (
	MrAddressCountryIsoEnumGbr MrAddressCountryIsoEnum = "GBR"
	MrAddressCountryIsoEnumImn MrAddressCountryIsoEnum = "IMN"
	MrAddressCountryIsoEnumJey MrAddressCountryIsoEnum = "JEY"
	MrAddressCountryIsoEnumGgy MrAddressCountryIsoEnum = "GGY"
)

func (e *MrAddressCountryIsoEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "JEY":
		fallthrough
	case "GGY":
		*e = MrAddressCountryIsoEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for MrAddressCountryIsoEnum: %s", s)
	}
}

type MrAddressCountryIso2Enum string

const (
	MrAddressCountryIso2EnumGb MrAddressCountryIso2Enum = "GB"
	MrAddressCountryIso2EnumIm MrAddressCountryIso2Enum = "IM"
	MrAddressCountryIso2EnumJe MrAddressCountryIso2Enum = "JE"
	MrAddressCountryIso2EnumGg MrAddressCountryIso2Enum = "GG"
)

func (e *MrAddressCountryIso2Enum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "JE":
		fallthrough
	case "GG":
		*e = MrAddressCountryIso2Enum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for MrAddressCountryIso2Enum: %s", s)
	}
}

type MrAddressDatasetEnum string

const (
	MrAddressDatasetEnumMr MrAddressDatasetEnum = "mr"
)

func (e *MrAddressDatasetEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	switch s {
	case "mr":
		*e = MrAddressDatasetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for MrAddressDatasetEnum: %s", s)
	}
}

type MrAddressLanguageEnum string

const (
	MrAddressLanguageEnumEn MrAddressLanguageEnum = "en"
)

func (e *MrAddressLanguageEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	switch s {
	case "en":
		*e = MrAddressLanguageEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for MrAddressLanguageEnum: %s", s)
	}
}
...
type MrAddress struct {
	...
	Country        MrAddressCountryEnum     `json:"country"`
	CountryIso     MrAddressCountryIsoEnum  `json:"country_iso"`
	CountryIso2    MrAddressCountryIso2Enum `json:"country_iso_2"`
	...
	Dataset    MrAddressDatasetEnum `json:"dataset"`
	...
	ID       string                `json:"id"`
	Language MrAddressLanguageEnum `json:"language"`
