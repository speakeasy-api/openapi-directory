...
export declare class GetUnmaskedProfileByVersionRequest extends SpeakeasyBase {
    /**
...
export declare class GetUnmaskedProfileByVersionResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * OK
     */
