...
from ..shared import createleadresponse as shared_createleadresponse
...
class LeadsAddRequest:
    ...
    lead_input: shared_lead.LeadInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class LeadsAddResponse:
    ...
    r"""Bad Request"""  
    create_lead_response: Optional[shared_createleadresponse.CreateLeadResponse] = dataclasses.field(default=None)
    r"""Lead created"""  
