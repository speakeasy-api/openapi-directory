...
class GetSearchVersionNumberSearchQueryExtRequest:
    path_params: GetSearchVersionNumberSearchQueryExtPathParams = dataclasses.field()
    query_params: GetSearchVersionNumberSearchQueryExtQueryParams = dataclasses.field()
