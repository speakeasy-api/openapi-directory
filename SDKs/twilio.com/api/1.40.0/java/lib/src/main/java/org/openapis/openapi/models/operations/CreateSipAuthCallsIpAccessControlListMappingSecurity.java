...
public class CreateSipAuthCallsIpAccessControlListMappingSecurity {
    ...
    public CreateSipAuthCallsIpAccessControlListMappingSecurity withPassword(String password) {
    ...
    public CreateSipAuthCallsIpAccessControlListMappingSecurity withUsername(String username) {
