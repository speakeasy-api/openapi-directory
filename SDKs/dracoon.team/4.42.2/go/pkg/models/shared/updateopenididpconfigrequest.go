...
func (e *UpdateOpenIDIdpConfigRequestFlowEnum) UnmarshalJSON(data []byte) error {
	...
	case "authorization_code":
		fallthrough
	case "hybrid":
		*e = UpdateOpenIDIdpConfigRequestFlowEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOpenIDIdpConfigRequestFlowEnum: %s", s)
	}
}
...
func (e *UpdateOpenIDIdpConfigRequestUserInfoSourceEnum) UnmarshalJSON(data []byte) error {
	...
	case "user_info_endpoint":
		fallthrough
	case "id_token":
		*e = UpdateOpenIDIdpConfigRequestUserInfoSourceEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOpenIDIdpConfigRequestUserInfoSourceEnum: %s", s)
	}
}
