...
from ..shared import actiondefinition as shared_actiondefinition
...
class CustomAction:
    ...
    action_definition: shared_actiondefinition.ActionDefinition = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ActionDefinition') }})
