...
public class GetversionRequest {
    ...
    public GetversionRequest(@JsonProperty("Accept") String accept, @JsonProperty("Content-Type") String contentType, @JsonProperty("dataEntityName") String dataEntityName, @JsonProperty("id") String id, @JsonProperty("versionId") String versionId) {
        this.accept = accept;
        this.contentType = contentType;
        this.dataEntityName = dataEntityName;
        this.id = id;
