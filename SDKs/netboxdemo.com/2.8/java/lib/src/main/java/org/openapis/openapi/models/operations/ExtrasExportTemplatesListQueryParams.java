...
public class ExtrasExportTemplatesListQueryParams {
    ...
    public ExtrasExportTemplatesListQueryParams withContentTypeN(String contentTypeN) {
    ...
    public String id;
    public ExtrasExportTemplatesListQueryParams withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public String idGt;
    public ExtrasExportTemplatesListQueryParams withIdGt(String idGt) {
        this.idGt = idGt;
        return this;
    }
    ...
    public String idGte;
    public ExtrasExportTemplatesListQueryParams withIdGte(String idGte) {
        this.idGte = idGte;
        return this;
    }
    ...
    public String idLt;
    public ExtrasExportTemplatesListQueryParams withIdLt(String idLt) {
        this.idLt = idLt;
        return this;
    }
    ...
    public String idLte;
    public ExtrasExportTemplatesListQueryParams withIdLte(String idLte) {
        this.idLte = idLte;
        return this;
    }
    ...
    public String idN;
    public ExtrasExportTemplatesListQueryParams withIdN(String idN) {
        this.idN = idN;
        return this;
    }
    ...
    public ExtrasExportTemplatesListQueryParams withNameIc(String nameIc) {
        this.nameIc = nameIc;
        return this;
    }
    ...
    public ExtrasExportTemplatesListQueryParams withNameIe(String nameIe) {
        this.nameIe = nameIe;
        return this;
    }
    ...
    public ExtrasExportTemplatesListQueryParams withNameIew(String nameIew) {
    ...
    public ExtrasExportTemplatesListQueryParams withNameIsw(String nameIsw) {
    ...
    public String nameN;
    public ExtrasExportTemplatesListQueryParams withNameN(String nameN) {
        this.nameN = nameN;
        return this;
    }
    ...
    public ExtrasExportTemplatesListQueryParams withNameNic(String nameNic) {
    ...
    public ExtrasExportTemplatesListQueryParams withNameNie(String nameNie) {
    ...
    public ExtrasExportTemplatesListQueryParams withNameNiew(String nameNiew) {
    ...
    public ExtrasExportTemplatesListQueryParams withNameNisw(String nameNisw) {
    ...
    public ExtrasExportTemplatesListQueryParams withTemplateLanguage(String templateLanguage) {
    ...
    public ExtrasExportTemplatesListQueryParams withTemplateLanguageN(String templateLanguageN) {
