...
public class LinksGetOfferLink {
    /**
    ...
    public LinksGetOfferLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksGetOfferLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksGetOfferLink withDescription(String description) {
    ...
    public LinksGetOfferLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksGetOfferLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksGetOfferLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksGetOfferLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksGetOfferLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksGetOfferLink withOperationId(String operationId) {
    ...
    public LinksGetOfferLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksGetOfferLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksGetOfferLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
