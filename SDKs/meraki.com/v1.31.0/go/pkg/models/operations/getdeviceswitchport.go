...
func (e *GetDeviceSwitchPort200ApplicationJSONAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Sticky MAC allow list":
		*e = GetDeviceSwitchPort200ApplicationJSONAccessPolicyTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDeviceSwitchPort200ApplicationJSONAccessPolicyTypeEnum: %s", s)
	}
}
...
func (e *GetDeviceSwitchPort200ApplicationJSONStpGuardEnum) UnmarshalJSON(data []byte) error {
	...
	case "loop guard":
		fallthrough
	case "root guard":
		*e = GetDeviceSwitchPort200ApplicationJSONStpGuardEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDeviceSwitchPort200ApplicationJSONStpGuardEnum: %s", s)
	}
}
...
func (e *GetDeviceSwitchPort200ApplicationJSONTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "access":
		fallthrough
	case "trunk":
		*e = GetDeviceSwitchPort200ApplicationJSONTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDeviceSwitchPort200ApplicationJSONTypeEnum: %s", s)
	}
}
...
func (e *GetDeviceSwitchPort200ApplicationJSONUdldEnum) UnmarshalJSON(data []byte) error {
	...
	case "Alert only":
		fallthrough
	case "Enforce":
		*e = GetDeviceSwitchPort200ApplicationJSONUdldEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDeviceSwitchPort200ApplicationJSONUdldEnum: %s", s)
	}
}
