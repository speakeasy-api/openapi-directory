...
class BatchDeleteImportDataRequest:
    ...
    batch_delete_import_data_request: shared_batchdeleteimportdatarequest.BatchDeleteImportDataRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
