...
public class CreateFilePaymentConsentsJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateFilePaymentConsentsJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateFilePaymentConsentsJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateFilePaymentConsentsJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateFilePaymentConsentsJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateFilePaymentConsentsJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateFilePaymentConsentsJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateFilePaymentConsentsJsonHeaders withXJwsSignature(String xJwsSignature) {
