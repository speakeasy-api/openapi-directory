...
class GetWorkspaceSlugActivitiesAffiliationEnum(str, Enum):
    MEMBER = 'member'
    TEAMMATE = 'teammate'

class GetWorkspaceSlugActivitiesDirectionEnum(str, Enum):
    ASC = 'ASC'
    DESC = 'DESC'

class GetWorkspaceSlugActivitiesIdentityEnum(str, Enum):
    GITHUB = 'github'
    TWITTER = 'twitter'
    EMAIL = 'email'
    DISCOURSE = 'discourse'
...
class GetWorkspaceSlugActivitiesItemsEnum(str, Enum):
    TEN = '10'
    FIFTY = '50'
    ONE_HUNDRED = '100'

class GetWorkspaceSlugActivitiesSortEnum(str, Enum):
...
class GetWorkspaceSlugActivitiesRequest:
    ...
    activity_type: Optional[GetWorkspaceSlugActivitiesActivityTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'activity_type', 'style': 'form', 'explode': True }})
    r"""Comma separated list of activity types"""  
    affiliation: Optional[GetWorkspaceSlugActivitiesAffiliationEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'affiliation', 'style': 'form', 'explode': True }})  
    ...
    direction: Optional[GetWorkspaceSlugActivitiesDirectionEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'direction', 'style': 'form', 'explode': True }})  
    ...
    identity: Optional[GetWorkspaceSlugActivitiesIdentityEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'identity', 'style': 'form', 'explode': True }})  
    items: Optional[GetWorkspaceSlugActivitiesItemsEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'items', 'style': 'form', 'explode': True }})  
    ...
    sort: Optional[GetWorkspaceSlugActivitiesSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})  
...
@dataclasses.dataclass
class GetWorkspaceSlugActivitiesResponse:
