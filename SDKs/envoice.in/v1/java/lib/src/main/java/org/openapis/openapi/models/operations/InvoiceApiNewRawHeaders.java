...
public class InvoiceApiNewRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiNewRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiNewRawHeaders withXAuthSecret(String xAuthSecret) {
