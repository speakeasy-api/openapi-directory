...
public class PutFunctionEventInvokeConfigRequest {
    ...
    public PutFunctionEventInvokeConfigRequest(@JsonProperty("FunctionName") String functionName, @JsonProperty("RequestBody") PutFunctionEventInvokeConfigRequestBody requestBody) {
        this.functionName = functionName;
        this.requestBody = requestBody;
  }
}
