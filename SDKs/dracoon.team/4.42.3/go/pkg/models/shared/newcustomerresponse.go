...
func (e NewCustomerResponseCustomerContractTypeEnum) ToPointer() *NewCustomerResponseCustomerContractTypeEnum {
	return &e
}

func (e *NewCustomerResponseCustomerContractTypeEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "free":
		fallthrough
	case "pay":
		*e = NewCustomerResponseCustomerContractTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NewCustomerResponseCustomerContractTypeEnum: %v", v)
	}
}
