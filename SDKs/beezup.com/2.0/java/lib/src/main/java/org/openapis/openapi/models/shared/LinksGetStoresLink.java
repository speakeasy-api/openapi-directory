...
public class LinksGetStoresLink {
    ...
    public LinksGetStoresLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksGetStoresLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksGetStoresLink withDescription(String description) {
    ...
    public LinksGetStoresLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksGetStoresLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksGetStoresLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksGetStoresLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksGetStoresLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksGetStoresLink withOperationId(String operationId) {
    ...
    public LinksGetStoresLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksGetStoresLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksGetStoresLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
