...
class JobsProjectsCompleteRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\JobsProjectsCompleteScopeEnum $scope
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=scope')]
    public ?JobsProjectsCompleteScopeEnum $scope = null;
    
    /**
     * Optional. The completion topic. The default is CompletionType.COMBINED.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\JobsProjectsCompleteTypeEnum $type
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=type')]
    public ?JobsProjectsCompleteTypeEnum $type = null;
