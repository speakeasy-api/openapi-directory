...
export declare class DetectImageUrlWithNoStoreFormRequest extends SpeakeasyBase {
    /**
...
export declare class DetectImageUrlWithNoStoreFormResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    /**
     * Error response
