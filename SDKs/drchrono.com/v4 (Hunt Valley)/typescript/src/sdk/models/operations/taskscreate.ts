...
export class TasksCreateQueryParams extends SpeakeasyBase {
...
export class TasksCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" })
  drchronoOauth2: shared.SchemeDrchronoOauth2;
}


export class TasksCreateRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class TasksCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
