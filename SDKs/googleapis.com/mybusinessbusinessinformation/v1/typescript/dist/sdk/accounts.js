...
var Accounts = /** @class */ (function () {
    ...
    **/
    Accounts.prototype.mybusinessbusinessinformationAccountsLocationsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MybusinessbusinessinformationAccountsLocationsCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/locations", req.pathParams);
    ...
    **/
    Accounts.prototype.mybusinessbusinessinformationAccountsLocationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
