...
class SiteVerificationWebResourceUpdateRequest:
    ...
    site_verification_web_resource_resource: Optional[shared_siteverificationwebresourceresource.SiteVerificationWebResourceResource] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
