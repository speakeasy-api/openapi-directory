...
export class VmmigrationProjectsLocationsSourcesMigratingVmsCutoverJobsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsSourcesMigratingVmsCutoverJobsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsSourcesMigratingVmsCutoverJobsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
