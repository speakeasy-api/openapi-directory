...
type GetRecommendationPreferencesQueryParams struct {
	// Pagination limit
...
func (e *GetRecommendationPreferencesXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "ComputeOptimizerService.GetRecommendationPreferences":
		*e = GetRecommendationPreferencesXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetRecommendationPreferencesXAmzTargetEnum: %s", s)
	}
}

type GetRecommendationPreferencesHeaders struct {
...
type GetRecommendationPreferencesRequest struct {
	QueryParams GetRecommendationPreferencesQueryParams
	Headers     GetRecommendationPreferencesHeaders
	Request     shared.GetRecommendationPreferencesRequest `request:"mediaType=application/json"`
}
