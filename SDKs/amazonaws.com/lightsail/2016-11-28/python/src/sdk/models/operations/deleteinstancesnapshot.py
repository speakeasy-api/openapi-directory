...
class DeleteInstanceSnapshotRequest:
    ...
    delete_instance_snapshot_request: shared_deleteinstancesnapshotrequest.DeleteInstanceSnapshotRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
