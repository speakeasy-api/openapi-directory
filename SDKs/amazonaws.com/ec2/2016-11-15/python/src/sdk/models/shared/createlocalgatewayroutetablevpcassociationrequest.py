...
class CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecifications:
    ...
    resource_type: Optional[CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateLocalGatewayRouteTableVpcAssociationRequest:
    ...
    tag_specifications: Optional[list[CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecifications]] = dataclasses.field(default=None)  
