...
type UpdateScheduleHeaders struct {
...
type UpdateScheduleRequestBodyFlexibleTimeWindow struct {
...
type UpdateScheduleRequestBodyStateEnum string

const (
	UpdateScheduleRequestBodyStateEnumEnabled  UpdateScheduleRequestBodyStateEnum = "ENABLED"
...
type UpdateScheduleRequestBodyTarget struct {
...
type UpdateScheduleRequestBody struct {
	...
	FlexibleTimeWindow UpdateScheduleRequestBodyFlexibleTimeWindow `json:"FlexibleTimeWindow"`
	...
	State *UpdateScheduleRequestBodyStateEnum `json:"State,omitempty"`
	// The schedule's target. EventBridge Scheduler supports templated target that invoke common API operations, as well as universal targets that you can customize to invoke over 6,000 API operations across more than 270 services. You can only specify one templated or universal target for a schedule.
	Target UpdateScheduleRequestBodyTarget `json:"Target"`
}

type UpdateScheduleRequest struct {
	PathParams UpdateSchedulePathParams
	Headers    UpdateScheduleHeaders
	Request    UpdateScheduleRequestBody `request:"mediaType=application/json"`
}
