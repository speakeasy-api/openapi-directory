...
public class StopEntitiesDetectionV2JobRequest {
    ...
    public StopEntitiesDetectionV2JobRequest(@JsonProperty("StopEntitiesDetectionV2JobRequest") org.openapis.openapi.models.shared.StopEntitiesDetectionV2JobRequest stopEntitiesDetectionV2JobRequest, @JsonProperty("X-Amz-Target") StopEntitiesDetectionV2JobXAmzTargetEnum xAmzTarget) {
        this.stopEntitiesDetectionV2JobRequest = stopEntitiesDetectionV2JobRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
