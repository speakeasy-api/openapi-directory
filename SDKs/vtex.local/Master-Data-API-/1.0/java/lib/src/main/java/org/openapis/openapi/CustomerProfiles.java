...
public class CustomerProfiles {
    ...
    public org.openapis.openapi.models.operations.CreateNewCustomerProfilev2Response createNewCustomerProfilev2(org.openapis.openapi.models.operations.CreateNewCustomerProfilev2Request request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.CreateNewCustomerProfilev2QueryParams.class, request.queryParams, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.DeleteCustomerProfileResponse deleteCustomerProfile(org.openapis.openapi.models.operations.DeleteCustomerProfileRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.DeleteCustomerProfilePathParams.class, baseUrl, "/api/dataentities/Client/documents/{id}", request.pathParams, null);
    ...
    public org.openapis.openapi.models.operations.UpdateCustomerProfileResponse updateCustomerProfile(org.openapis.openapi.models.operations.UpdateCustomerProfileRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.UpdateCustomerProfilePathParams.class, baseUrl, "/api/dataentities/Client/documents/{id}", request.pathParams, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.UpdateCustomerProfileQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
