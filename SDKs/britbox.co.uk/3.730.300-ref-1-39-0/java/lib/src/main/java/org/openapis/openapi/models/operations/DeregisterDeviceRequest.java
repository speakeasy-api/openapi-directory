...
public class DeregisterDeviceRequest {
    ...
    public DeregisterDeviceRequest withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public DeregisterDeviceRequest withLang(String lang) {
        this.lang = lang;
        return this;
    }
    
    public DeregisterDeviceRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
