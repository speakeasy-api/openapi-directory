...
type IdentitytoolkitRelyingpartySendVerificationCodeSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type IdentitytoolkitRelyingpartySendVerificationCodeQueryParams struct {
...
type IdentitytoolkitRelyingpartySendVerificationCodeRequest struct {
	...
	Request     *shared.IdentitytoolkitRelyingpartySendVerificationCodeRequest `request:"mediaType=application/json"`
