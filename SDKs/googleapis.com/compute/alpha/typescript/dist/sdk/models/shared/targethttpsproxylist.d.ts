 ...
 */
export declare enum TargetHttpsProxyListWarningCodeEnum {
...
export declare class TargetHttpsProxyListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetHttpsProxyListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: TargetHttpsProxyListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: TargetHttpsProxyListWarningData[];
    /**
 ...
 */
export declare class TargetHttpsProxyList extends SpeakeasyBase {
    /**
