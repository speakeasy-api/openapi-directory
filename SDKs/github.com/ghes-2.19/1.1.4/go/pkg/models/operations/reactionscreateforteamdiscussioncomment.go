...
func (e ReactionsCreateForTeamDiscussionCommentRequestBodyContentEnum) ToPointer() *ReactionsCreateForTeamDiscussionCommentRequestBodyContentEnum {
	return &e
}
...
func (e *ReactionsCreateForTeamDiscussionCommentRequestBodyContentEnum) UnmarshalJSON(data []byte) error {
	...
	case "rocket":
		fallthrough
	case "eyes":
		*e = ReactionsCreateForTeamDiscussionCommentRequestBodyContentEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ReactionsCreateForTeamDiscussionCommentRequestBodyContentEnum: %v", v)
	}
}
...
type ReactionsCreateForTeamDiscussionCommentRequest struct {
	RequestBody ReactionsCreateForTeamDiscussionCommentRequestBody `request:"mediaType=application/json"`
