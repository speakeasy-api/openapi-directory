...
func (s *V1) Cancel(ctx context.Context, request operations.CancelRequest) (*operations.CancelResponse, error) {
	...
	url := utils.GenerateURL(ctx, baseURL, "/v1/subscriptions/{subscriptionId}", request.PathParams)
...
func (s *V1) Update(ctx context.Context, request operations.UpdateRequest) (*operations.UpdateResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/subscriptions/{subscriptionId}", request.PathParams)
