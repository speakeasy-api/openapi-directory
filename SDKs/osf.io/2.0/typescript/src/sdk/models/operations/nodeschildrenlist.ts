 ...
 */
export enum NodesChildrenListNodeAttributesCategoryEnum {
  Analysis = "analysis",
 ...
 */
export class NodesChildrenListNodeAttributes extends SpeakeasyBase {
  /**
   * The category of the node, as selected by project contributors.
   */
  @SpeakeasyMetadata()
 ...
 */
export class NodesChildrenListNodeLinks extends SpeakeasyBase {
  /**
 ...
 */
export class NodesChildrenListNodeRelationships extends SpeakeasyBase {
  /**
...
export class NodesChildrenListNode extends SpeakeasyBase {
  /**
   * The properties of the node entity.
   */
  @SpeakeasyMetadata()
