...
class StartSpeechSynthesisTaskRequestBodyEngineEnum(str, Enum):
    r"""Specifies the engine (<code>standard</code> or <code>neural</code>) for Amazon Polly to use when processing input text for speech synthesis. Using a voice that is not supported for the engine selected will result in an error."""
    STANDARD = 'standard'
    NEURAL = 'neural'
...
class StartSpeechSynthesisTaskRequestBodyOutputFormatEnum(str, Enum):
    r"""The format in which the returned output will be encoded. For audio stream, this will be mp3, ogg_vorbis, or pcm. For speech marks, this will be json."""
    JSON = 'json'
    MP3 = 'mp3'
...
class StartSpeechSynthesisTaskRequestBodyTextTypeEnum(str, Enum):
    r"""Specifies whether the input text is plain text or SSML. The default value is plain text."""
    SSML = 'ssml'
    TEXT = 'text'

class StartSpeechSynthesisTaskRequestBodyVoiceIDEnum(str, Enum):
    r"""Voice ID to use for the synthesis."""
    ADITI = 'Aditi'
    AMY = 'Amy'
    ASTRID = 'Astrid'
    BIANCA = 'Bianca'
...
class StartSpeechSynthesisTaskRequestBody:
    ...
    output_format: StartSpeechSynthesisTaskRequestBodyOutputFormatEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('OutputFormat') }})
    r"""The format in which the returned output will be encoded. For audio stream, this will be mp3, ogg_vorbis, or pcm. For speech marks, this will be json."""  
    output_s3_bucket_name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('OutputS3BucketName') }})
    r"""Amazon S3 bucket name to which the output file will be saved."""  
    text: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Text') }})
    r"""The input text to synthesize. If you specify ssml as the TextType, follow the SSML format for the input text."""  
    voice_id: StartSpeechSynthesisTaskRequestBodyVoiceIDEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VoiceId') }})
    r"""Voice ID to use for the synthesis."""  
    engine: Optional[StartSpeechSynthesisTaskRequestBodyEngineEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Engine'), 'exclude': lambda f: f is None }})
    r"""Specifies the engine (<code>standard</code> or <code>neural</code>) for Amazon Polly to use when processing input text for speech synthesis. Using a voice that is not supported for the engine selected will result in an error."""  
    language_code: Optional[StartSpeechSynthesisTaskRequestBodyLanguageCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('LanguageCode'), 'exclude': lambda f: f is None }})
    r"""<p>Optional language code for the Speech Synthesis request. This is only necessary if using a bilingual voice, such as Aditi, which can be used for either Indian English (en-IN) or Hindi (hi-IN). </p> <p>If a bilingual voice is used and no language code is specified, Amazon Polly uses the default language of the bilingual voice. The default language for any voice is the one returned by the <a href=\\"https://docs.aws.amazon.com/polly/latest/dg/API_DescribeVoices.html\\">DescribeVoices</a> operation for the <code>LanguageCode</code> parameter. For example, if no language code is specified, Aditi will use Indian English rather than Hindi.</p>"""  
    ...
    r"""List of one or more pronunciation lexicon names you want the service to apply during synthesis. Lexicons are applied only if the language of the lexicon is the same as the language of the voice."""  
    ...
    r"""The Amazon S3 key prefix for the output speech file."""  
    ...
    r"""ARN for the SNS topic optionally used for providing status notification for a speech synthesis task."""  
    ...
    text_type: Optional[StartSpeechSynthesisTaskRequestBodyTextTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TextType'), 'exclude': lambda f: f is None }})
    r"""Specifies whether the input text is plain text or SSML. The default value is plain text."""  
...
class StartSpeechSynthesisTaskRequest:
    ...
    request_body: StartSpeechSynthesisTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
