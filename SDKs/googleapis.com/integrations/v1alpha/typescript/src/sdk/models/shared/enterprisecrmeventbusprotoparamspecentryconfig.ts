...
export class EnterpriseCrmEventbusProtoParamSpecEntryConfig extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "hideDefaultValue" })
  hideDefaultValue?: boolean;

  @SpeakeasyMetadata()
  @Expose({ name: "inputDisplayOption" })
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "parameterNameOption" })
