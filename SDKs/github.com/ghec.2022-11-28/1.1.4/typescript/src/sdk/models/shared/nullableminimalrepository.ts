...
export class NullableMinimalRepositoryLicense extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "key" })
  key?: string;
...
export class NullableMinimalRepositoryPermissions extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "admin" })
  admin?: boolean;
 ...
 * Minimal Repository
 */
export class NullableMinimalRepository extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "license" })
  @Type(() => NullableMinimalRepositoryLicense)
  ...
  @Type(() => NullableMinimalRepositoryPermissions)
