...
exports.FetchEvidenceContentResponse = exports.FetchEvidenceContentRequest = exports.FetchEvidenceContentSecurity = exports.FetchEvidenceContentServerList = void 0;
...
var FetchEvidenceContentRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], FetchEvidenceContentRequest.prototype, "evidenceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=file_id",
        }),
        __metadata("design:type", String)
    ], FetchEvidenceContentRequest.prototype, "fileId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=payment_dispute_id",
        }),
        __metadata("design:type", String)
    ], FetchEvidenceContentRequest.prototype, "paymentDisputeId", void 0);
...
var FetchEvidenceContentResponse = /** @class */ (function (_super) {
    ...
    ], FetchEvidenceContentResponse.prototype, "rawResponse", void 0);
