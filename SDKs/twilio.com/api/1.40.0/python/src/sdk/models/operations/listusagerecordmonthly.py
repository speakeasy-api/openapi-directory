...
from ..shared import api_v2010_account_usage_usage_record_usage_record_monthly as shared_api_v2010_account_usage_usage_record_usage_record_monthly
from ..shared import usage_record_monthly_enum_category_enum as shared_usage_record_monthly_enum_category_enum
from dataclasses_json import Undefined, dataclass_json
from datetime import date
from sdk import utils
from typing import Optional

LIST_USAGE_RECORD_MONTHLY_SERVERS = [
	"https://api.twilio.com",
]


@dataclasses.dataclass
class ListUsageRecordMonthlySecurity:
...
@dataclasses.dataclass
class ListUsageRecordMonthlyRequest:
    ...
    category: Optional[shared_usage_record_monthly_enum_category_enum.UsageRecordMonthlyEnumCategoryEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'Category', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class ListUsageRecordMonthlyListUsageRecordMonthlyResponse:
    r"""OK"""
    ...
    usage_records: Optional[list[shared_api_v2010_account_usage_usage_record_usage_record_monthly.APIV2010AccountUsageUsageRecordUsageRecordMonthly]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('usage_records'), 'exclude': lambda f: f is None }})  
...
class ListUsageRecordMonthlyResponse:
    ...
    list_usage_record_monthly_response: Optional[ListUsageRecordMonthlyListUsageRecordMonthlyResponse] = dataclasses.field(default=None)
    r"""OK"""  
