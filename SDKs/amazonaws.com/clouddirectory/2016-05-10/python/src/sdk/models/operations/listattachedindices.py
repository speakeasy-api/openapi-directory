...
class ListAttachedIndicesRequestBody:
    target_reference: ListAttachedIndicesRequestBodyTargetReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('TargetReference') }})
...
class ListAttachedIndicesRequest:
    headers: ListAttachedIndicesHeaders = dataclasses.field()
    query_params: ListAttachedIndicesQueryParams = dataclasses.field()
    request: ListAttachedIndicesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
