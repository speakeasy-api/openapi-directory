...
var HpcerRequestBodyCertificateParameters = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=exsession" }),
        __metadata("design:type", String)
    ], HpcerRequestBodyCertificateParameters.prototype, "exsession", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rollnumber" }),
        __metadata("design:type", String)
    ], HpcerRequestBodyCertificateParameters.prototype, "rollnumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=totalmarks" }),
        __metadata("design:type", String)
    ], HpcerRequestBodyCertificateParameters.prototype, "totalmarks", void 0);
    __decorate([
...
(function (HpcerRequestBodyFormatEnum) {
    HpcerRequestBodyFormatEnum["Xml"] = "xml";
...
var HpcerResponse = /** @class */ (function (_super) {
    ...
    ], HpcerResponse.prototype, "body", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", String)
