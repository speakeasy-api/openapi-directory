...
class Adloox:
    ...
    excluded_adloox_categories: Optional[list[AdlooxExcludedAdlooxCategoriesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('excludedAdlooxCategories') }})
