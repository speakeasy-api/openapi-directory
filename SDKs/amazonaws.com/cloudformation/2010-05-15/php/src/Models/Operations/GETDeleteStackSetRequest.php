...
class GETDeleteStackSetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GETDeleteStackSetCallAsEnum $callAs
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=CallAs')]
    public ?GETDeleteStackSetCallAsEnum $callAs = null;
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETDeleteStackSetActionEnum::DELETE_STACK_SET;
		$this->callAs = null;
		$this->stackSetName = "";
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETDeleteStackSetVersionEnum::TWO_THOUSAND_AND_TEN0515;
