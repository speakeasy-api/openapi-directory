...
@dataclasses.dataclass
class PutConfigurationSetReputationOptionsHeaders:
...
class PutConfigurationSetReputationOptionsRequest:
    headers: PutConfigurationSetReputationOptionsHeaders = dataclasses.field()
    path_params: PutConfigurationSetReputationOptionsPathParams = dataclasses.field()
    request: PutConfigurationSetReputationOptionsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
