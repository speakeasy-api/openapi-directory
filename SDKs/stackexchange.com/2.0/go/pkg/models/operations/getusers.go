...
func (e *GetUsersOrderEnum) UnmarshalJSON(data []byte) error {
	...
	case "desc":
		fallthrough
	case "asc":
		*e = GetUsersOrderEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersOrderEnum: %s", s)
	}
}
...
func (e *GetUsersSortEnum) UnmarshalJSON(data []byte) error {
	...
	case "name":
		fallthrough
	case "modified":
		*e = GetUsersSortEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersSortEnum: %s", s)
	}
}
