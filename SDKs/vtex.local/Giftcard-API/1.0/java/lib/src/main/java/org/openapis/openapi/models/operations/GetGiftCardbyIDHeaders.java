...
public class GetGiftCardbyIDHeaders {
    /**
    ...
    public GetGiftCardbyIDHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public GetGiftCardbyIDHeaders withContentType(String contentType) {
