...
exports.TaskrouterV1Workspace = void 0;
var utils_1 = require("../../../internal/utils");
var workspaceenumqueueorderenum_1 = require("./workspaceenumqueueorderenum");
var TaskrouterV1Workspace = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=default_activity_name" }),
        __metadata("design:type", String)
    ], TaskrouterV1Workspace.prototype, "defaultActivityName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=default_activity_sid" }),
        __metadata("design:type", String)
    ], TaskrouterV1Workspace.prototype, "defaultActivitySid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=event_callback_url" }),
        __metadata("design:type", String)
    ], TaskrouterV1Workspace.prototype, "eventCallbackUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=events_filter" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=multi_task_enabled" }),
        __metadata("design:type", Boolean)
    ], TaskrouterV1Workspace.prototype, "multiTaskEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=prioritize_queue_order" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timeout_activity_name" }),
        __metadata("design:type", String)
    ], TaskrouterV1Workspace.prototype, "timeoutActivityName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timeout_activity_sid" }),
        __metadata("design:type", String)
...
exports.TaskrouterV1Workspace = TaskrouterV1Workspace;
