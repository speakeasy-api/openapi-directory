...
func (e *ProjectedPlayerGameStatsByPlayerWInjuriesLineupsDfsSalariesFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = ProjectedPlayerGameStatsByPlayerWInjuriesLineupsDfsSalariesFormatEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ProjectedPlayerGameStatsByPlayerWInjuriesLineupsDfsSalariesFormatEnum: %s", s)
	}
}
