 ...
 */
export enum GetNetworkClientLatencyStatsBandEnum {
  Two4 = "2.4",
  Five = "5",
}

export class GetNetworkClientLatencyStatsRequest extends SpeakeasyBase {
  /**
...
export class GetNetworkClientLatencyStatsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
