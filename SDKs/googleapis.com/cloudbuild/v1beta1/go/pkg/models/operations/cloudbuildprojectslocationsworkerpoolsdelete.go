...
type CloudbuildProjectsLocationsWorkerPoolsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudbuildProjectsLocationsWorkerPoolsDeletePathParams struct {
...
type CloudbuildProjectsLocationsWorkerPoolsDeleteQueryParams struct {
	// V1 error format.
...
type CloudbuildProjectsLocationsWorkerPoolsDeleteRequest struct {
...
type CloudbuildProjectsLocationsWorkerPoolsDeleteResponse struct {
	ContentType string
	// Successful response
