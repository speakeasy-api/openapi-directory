...
export class TypeCommunityResource {
  ...
  searchCommunityResource(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/community_resource";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchCommunityResourceResponse =
        new operations.SearchCommunityResourceResponse({
