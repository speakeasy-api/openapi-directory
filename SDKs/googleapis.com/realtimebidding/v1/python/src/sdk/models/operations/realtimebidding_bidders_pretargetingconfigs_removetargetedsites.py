...
from ..shared import security as shared_security
from ..shared import removetargetedsitesrequest as shared_removetargetedsitesrequest
...
class RealtimebiddingBiddersPretargetingConfigsRemoveTargetedSitesRequest:
    path_params: RealtimebiddingBiddersPretargetingConfigsRemoveTargetedSitesPathParams = dataclasses.field()
    query_params: RealtimebiddingBiddersPretargetingConfigsRemoveTargetedSitesQueryParams = dataclasses.field()
    security: RealtimebiddingBiddersPretargetingConfigsRemoveTargetedSitesSecurity = dataclasses.field()
    request: Optional[shared_removetargetedsitesrequest.RemoveTargetedSitesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
