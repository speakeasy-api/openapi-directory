...
from ..shared import error404 as shared_error404
...
class GetNhSeaSeaCreatureRequest:
    ...
    sea_creature: str = dataclasses.field(metadata={'path_param': { 'field_name': 'sea_creature', 'style': 'simple', 'explode': False }})
    r"""The name of the sea creature you wish to retrieve information about."""  
...
@dataclasses.dataclass
class GetNhSeaSeaCreatureResponse:
    ...
    error404: Optional[shared_error404.Error404] = dataclasses.field(default=None)
    r"""Could not find the specified sea creature."""  
    ...
    nh_sea_creature: Optional[shared_nhseacreature.NHSeaCreature] = dataclasses.field(default=None)
