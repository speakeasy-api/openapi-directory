...
exports.GetSubContractorRevisionByNumberResponse = exports.GetSubContractorRevisionByNumberRequest = void 0;
...
var GetSubContractorRevisionByNumberRequest = /** @class */ (function (_super) {
    ...
    ], GetSubContractorRevisionByNumberRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetSubContractorRevisionByNumberRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetSubContractorRevisionByNumberRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RevisionNumber",
        }),
        __metadata("design:type", String)
    ], GetSubContractorRevisionByNumberRequest.prototype, "revisionNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], GetSubContractorRevisionByNumberRequest.prototype, "subContractorId", void 0);
...
var GetSubContractorRevisionByNumberResponse = /** @class */ (function (_super) {
    ...
    ], GetSubContractorRevisionByNumberResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
