...
func main() {
    ...
    res, err := s.Checks.ChecksListAnnotations(ctx, operations.ChecksListAnnotationsRequest{
        CheckRunID: 878870,
        Owner: "tenetur",
        Page: sdk.Int64(492268),
        PerPage: sdk.Int64(941378),
        Repo: "distinctio",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Checks.ChecksListForRef(ctx, operations.ChecksListForRefRequest{
        AppID: sdk.Int64(799203),
        CheckName: sdk.String("odio"),
        Filter: operations.ChecksListForRefFilterEnumAll.ToPointer(),
        Owner: "facilis",
        Page: sdk.Int64(874288),
        PerPage: sdk.Int64(498140),
        Ref: "dolore",
        Repo: "quibusdam",
...
func main() {
    ...
    res, err := s.Checks.ChecksListSuitesForRef(ctx, operations.ChecksListSuitesForRefRequest{
        AppID: sdk.Int64(780427),
        CheckName: sdk.String("maiores"),
        Owner: "doloribus",
