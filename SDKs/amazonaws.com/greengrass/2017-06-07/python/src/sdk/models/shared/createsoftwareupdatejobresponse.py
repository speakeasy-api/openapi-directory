...
class CreateSoftwareUpdateJobResponse:
    ...
    platform_software_version: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PlatformSoftwareVersion'), 'exclude': lambda f: f is None }})  
