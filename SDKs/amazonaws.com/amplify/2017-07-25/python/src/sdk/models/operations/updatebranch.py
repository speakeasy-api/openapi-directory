...
class UpdateBranchRequestBody:
    ...
    stage: Optional[UpdateBranchRequestBodyStageEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('stage'), 'exclude': lambda f: f is None }})
    r"""Describes the current stage for the branch."""  
...
class UpdateBranchRequest:
    ...
    request_body: UpdateBranchRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
