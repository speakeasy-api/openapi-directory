...
class ListShortCodeListShortCodeResponse:
    ...
    short_codes: Optional[list[shared_proxy_v1_service_short_code.ProxyV1ServiceShortCode]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('short_codes') }})
