...
type RecommenderProjectsLocationsRecommendersRecommendationsMarkClaimedRequest struct {
	...
	GoogleCloudRecommenderV1MarkRecommendationClaimedRequest *shared.GoogleCloudRecommenderV1MarkRecommendationClaimedRequest `request:"mediaType=application/json"`
	// OAuth access token.
