...
public class JobGetAllJobsLifetimeStatisticsHeaders {
    ...
    public JobGetAllJobsLifetimeStatisticsHeaders withOcpDate(String ocpDate) {
    ...
    public JobGetAllJobsLifetimeStatisticsHeaders withReturnClientRequestId(Boolean returnClientRequestId) {
