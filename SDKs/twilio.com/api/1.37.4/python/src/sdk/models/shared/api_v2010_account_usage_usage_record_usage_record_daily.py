...
class APIV2010AccountUsageUsageRecordUsageRecordDaily:
    ...
    category: Optional[shared_usage_record_daily_enum_category_enum.UsageRecordDailyEnumCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('category') }})
