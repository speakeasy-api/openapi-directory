...
var GroupsVideos = /** @class */ (function () {
    ...
    **/
    GroupsVideos.prototype.addVideoToGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddVideoToGroupRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/{group_id}/videos/{video_id}", req.pathParams);
    ...
    **/
    GroupsVideos.prototype.deleteVideoFromGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    GroupsVideos.prototype.getGroupVideos = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/{group_id}/videos", req.pathParams);
        var client = this._securityClient;
