...
var Privilege = /** @class */ (function () {
    function Privilege(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    Privilege.prototype.getPrivileges = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/privilege";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.sellingPrivileges = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.SellingPrivileges);
                    }
                    break;
