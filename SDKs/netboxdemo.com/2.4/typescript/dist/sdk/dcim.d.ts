...
export declare class Dcim {
    ...
    dcimDevicesCreate(req: shared.WritableDeviceInput, config?: AxiosRequestConfig): Promise<operations.DcimDevicesCreateResponse>;
    ...
    dcimInterfaceConnectionsCreate(req: shared.WritableInterfaceConnectionInput, config?: AxiosRequestConfig): Promise<operations.DcimInterfaceConnectionsCreateResponse>;
    ...
    dcimInterfacesCreate(req: shared.WritableInterfaceInput, config?: AxiosRequestConfig): Promise<operations.DcimInterfacesCreateResponse>;
