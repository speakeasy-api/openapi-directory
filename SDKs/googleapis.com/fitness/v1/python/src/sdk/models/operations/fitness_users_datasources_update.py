...
class FitnessUsersDataSourcesUpdateRequest:
    ...
    r"""The data stream ID of the data source to update."""  
    user_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'userId', 'style': 'simple', 'explode': False }})
    r"""Update the data source for the person identified. Use me to indicate the authenticated user. Only me is supported at this time."""  
