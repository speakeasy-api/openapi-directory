...
var Organizations = /** @class */ (function () {
    ...
    **/
    Organizations.prototype.getOrganization = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/organizations/{id}", req.pathParams);
    ...
    **/
    Organizations.prototype.getOrganizations = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Organizations.prototype.patchOrganization = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
