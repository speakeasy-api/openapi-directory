...
class GetDisassociateEnclaveCertificateIamRoleQueryParams:
    action: GetDisassociateEnclaveCertificateIamRoleActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDisassociateEnclaveCertificateIamRoleVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDisassociateEnclaveCertificateIamRoleRequest:
    headers: GetDisassociateEnclaveCertificateIamRoleHeaders = dataclasses.field()
    query_params: GetDisassociateEnclaveCertificateIamRoleQueryParams = dataclasses.field()
