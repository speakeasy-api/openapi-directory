...
exports.LineItemsReadResponse = exports.LineItemsReadRequest = exports.LineItemsReadSecurity = void 0;
...
var LineItemsReadRequest = /** @class */ (function (_super) {
    ...
    ], LineItemsReadRequest.prototype, "appointment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=doctor",
        }),
        __metadata("design:type", Number)
    ], LineItemsReadRequest.prototype, "doctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], LineItemsReadRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=office",
        }),
        __metadata("design:type", Number)
    ], LineItemsReadRequest.prototype, "office", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=patient",
        }),
        __metadata("design:type", Number)
    ], LineItemsReadRequest.prototype, "patient", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=posted_date",
        }),
        __metadata("design:type", String)
    ], LineItemsReadRequest.prototype, "postedDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=service_date",
        }),
        __metadata("design:type", String)
    ], LineItemsReadRequest.prototype, "serviceDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=since" }),
        __metadata("design:type", String)
    ], LineItemsReadRequest.prototype, "since", void 0);
...
var LineItemsReadResponse = /** @class */ (function (_super) {
    ...
    ], LineItemsReadResponse.prototype, "rawResponse", void 0);
