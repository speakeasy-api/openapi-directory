...
class CodespacesDeleteFromOrganizationRequest:
...
class CodespacesDeleteFromOrganizationResponse:
    ...
    codespaces_delete_from_organization_202_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Accepted"""  
