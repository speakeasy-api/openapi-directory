...
export class GetSearchCarFsboActiveQueryParams extends SpeakeasyBase {
...
export class GetSearchCarFsboActiveRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: GetSearchCarFsboActiveQueryParams;
}


export class GetSearchCarFsboActiveResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
