...
// ### Further Information:
// None.
func (s *user) ConfirmTotpSetup(ctx context.Context, request operations.ConfirmTotpSetupRequest) (*operations.ConfirmTotpSetupResponse, error) {
	baseURL := s.serverURL
	...
	res := &operations.ConfirmTotpSetupResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
func (s *user) DeleteMfaTotpSetup(ctx context.Context, request operations.DeleteMfaTotpSetupRequest) (*operations.DeleteMfaTotpSetupResponse, error) {
	...
	res := &operations.DeleteMfaTotpSetupResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// ### Further Information:
// None.
func (s *user) GetMfaStatusForUser(ctx context.Context, request operations.GetMfaStatusForUserRequest) (*operations.GetMfaStatusForUserResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/account/mfa"
	...
	res := &operations.GetMfaStatusForUserResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.UserMfaStatusResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// ### Further Information:
// None.
func (s *user) GetTotpSetupInformation(ctx context.Context, request operations.GetTotpSetupInformationRequest) (*operations.GetTotpSetupInformationResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/account/mfa/totp"
	...
	res := &operations.GetTotpSetupInformationResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 201:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.TotpSetupResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *user) RequestCustomerKeyPair(ctx context.Context, request operations.RequestCustomerKeyPairRequest) (*operations.RequestCustomerKeyPairResponse, error) {
	baseURL := s.serverURL
...
// ### Further Information:
// The private key is password-based encrypted with `AES256` / `PBKDF2`.
func (s *user) RequestUserKeyPair(ctx context.Context, request operations.RequestUserKeyPairRequest) (*operations.RequestUserKeyPairResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/account/keypair"
...
// ### Further Information:
// None.
func (s *user) RequestUserKeyPairs(ctx context.Context, request operations.RequestUserKeyPairsRequest) (*operations.RequestUserKeyPairsResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/account/keypairs"
...
//
// ### Further Information:
func (s *user) UseEmergencyCode(ctx context.Context, request operations.UseEmergencyCodeRequest) (*operations.UseEmergencyCodeResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/account/mfa"
	...
	res := &operations.UseEmergencyCodeResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
