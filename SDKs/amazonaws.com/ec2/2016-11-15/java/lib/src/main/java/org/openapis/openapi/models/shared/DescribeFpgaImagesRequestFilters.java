 ...
 */
public class DescribeFpgaImagesRequestFilters {
    
    public String name;

    public DescribeFpgaImagesRequestFilters withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DescribeFpgaImagesRequestFilters withValues(String[] values) {
        this.values = values;
        return this;
    }
    
    public DescribeFpgaImagesRequestFilters(){}
}
