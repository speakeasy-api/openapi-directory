 ...
 */
public enum MeetingCreate201ApplicationJSONSettingsRegistrationTypeEnum {
    ONE("1"),
    TWO("2"),
    THREE("3");
    ...
    private MeetingCreate201ApplicationJSONSettingsRegistrationTypeEnum(String value) {
        this.value = value;
    }
}
