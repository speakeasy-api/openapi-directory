...
type GetSubstanceTreatsAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetSubstanceTreatsAssociationsQueryParams struct {
