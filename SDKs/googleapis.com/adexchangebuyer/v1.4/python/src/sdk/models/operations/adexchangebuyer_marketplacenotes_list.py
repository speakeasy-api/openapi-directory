...
class AdexchangebuyerMarketplacenotesListRequest:
    ...
    r"""The proposalId to get notes for. To search across all proposals specify order_id = '-' as part of the URL."""  
    ...
    r"""Query string to retrieve specific notes. To search the text contents of notes, please use syntax like \\"WHERE note.note = \\"foo\\" or \\"WHERE note.note LIKE \\"%bar%\\" """  
