...
public class GetPaymentInformationRequest {
    ...
    public GetPaymentInformationRequest withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public GetPaymentInformationRequest withPSUAccept(String psuAccept) {
    ...
    public GetPaymentInformationRequest withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public GetPaymentInformationRequest withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public GetPaymentInformationRequest withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public GetPaymentInformationRequest withPSUDeviceID(String psuDeviceID) {
    ...
    public GetPaymentInformationRequest withPSUGeoLocation(String psuGeoLocation) {
    ...
    public GetPaymentInformationRequest withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public GetPaymentInformationRequest withPSUIPAddress(String psuIPAddress) {
    ...
    public GetPaymentInformationRequest withPSUIPPort(String psuIPPort) {
    ...
    public GetPaymentInformationRequest withPSUUserAgent(String psuUserAgent) {
    ...
    public GetPaymentInformationRequest withSignature(String signature) {
    ...
    public GetPaymentInformationRequest withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public GetPaymentInformationRequest withXRequestID(String xRequestID) {
    ...
    public GetPaymentInformationRequest withPaymentProduct(org.openapis.openapi.models.shared.PaymentProductEnum paymentProduct) {
    ...
    public GetPaymentInformationRequest withPaymentService(org.openapis.openapi.models.shared.PaymentServiceEnum paymentService) {
