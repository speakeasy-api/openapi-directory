...
public class Actions {
     ...
     * 
    **/
    public openapisdk.models.operations.ActionPosTamendResponse actionPosTamend(openapisdk.models.operations.ActionPosTamendRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/action/amend");
        ...
        openapisdk.models.operations.ActionPosTamendResponse res = new openapisdk.models.operations.ActionPosTamendResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                ...
                openapisdk.models.shared.ProxyActionamendResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ProxyActionamendResponse.class);
     ...
     * 
    **/
    public openapisdk.models.operations.ActionPosTcreateResponse actionPosTcreate(openapisdk.models.operations.ActionPosTcreateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/action/create");
        ...
        openapisdk.models.operations.ActionPosTcreateResponse res = new openapisdk.models.operations.ActionPosTcreateResponse() {{
            saveResults = null;
            proxyUnauthorizedResponse = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.SaveResult[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.SaveResult[].class);
                res.saveResults = out;
            }
        }
        else if (httpRes.statusCode() == 401) {
     ...
     * 
    **/
    public openapisdk.models.operations.ActionPosTdeleteResponse actionPosTdelete(openapisdk.models.operations.ActionPosTdeleteRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/action/delete");
        ...
        openapisdk.models.operations.ActionPosTdeleteResponse res = new openapisdk.models.operations.ActionPosTdeleteResponse() {{
            deleteResults = null;
            proxyUnauthorizedResponse = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DeleteResult[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DeleteResult[].class);
     ...
     * 
    **/
    public openapisdk.models.operations.ActionPosTexecuteResponse actionPosTexecute(openapisdk.models.operations.ActionPosTexecuteRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/action/execute");
        ...
        openapisdk.models.operations.ActionPosTexecuteResponse res = new openapisdk.models.operations.ActionPosTexecuteResponse() {{
            executeResults = null;
            proxyUnauthorizedResponse = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.ExecuteResult[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ExecuteResult[].class);
     ...
     * 
    **/
    public openapisdk.models.operations.ActionPosTgenerateResponse actionPosTgenerate(openapisdk.models.operations.ActionPosTgenerateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/action/generate");
        ...
        openapisdk.models.operations.ActionPosTgenerateResponse res = new openapisdk.models.operations.ActionPosTgenerateResponse() {{
            saveResults = null;
            proxyUnauthorizedResponse = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
     ...
     * 
    **/
    public openapisdk.models.operations.ActionPosTqueryResponse actionPosTquery(openapisdk.models.operations.ActionPosTqueryRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/action/query");
        ...
        openapisdk.models.operations.ActionPosTqueryResponse res = new openapisdk.models.operations.ActionPosTqueryResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.ProxyActionqueryResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ProxyActionqueryResponse.class);
     ...
     * 
    **/
    public openapisdk.models.operations.ActionPosTqueryMoreResponse actionPosTqueryMore(openapisdk.models.operations.ActionPosTqueryMoreRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/action/queryMore");
        ...
        openapisdk.models.operations.ActionPosTqueryMoreResponse res = new openapisdk.models.operations.ActionPosTqueryMoreResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.ProxyActionqueryMoreResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ProxyActionqueryMoreResponse.class);
     ...
     * 
    **/
    public openapisdk.models.operations.ActionPosTsubscribeResponse actionPosTsubscribe(openapisdk.models.operations.ActionPosTsubscribeRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/action/subscribe");
        ...
        openapisdk.models.operations.ActionPosTsubscribeResponse res = new openapisdk.models.operations.ActionPosTsubscribeResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.SubscribeResult[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.SubscribeResult[].class);
     ...
     * 
    **/
    public openapisdk.models.operations.ActionPosTupdateResponse actionPosTupdate(openapisdk.models.operations.ActionPosTupdateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/action/update");
        ...
        openapisdk.models.operations.ActionPosTupdateResponse res = new openapisdk.models.operations.ActionPosTupdateResponse() {{
            saveResults = null;
            proxyUnauthorizedResponse = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
