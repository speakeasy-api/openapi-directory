...
func (e PensionPensionCertificationEnum) ToPointer() *PensionPensionCertificationEnum {
	return &e
}
...
func (e *PensionPensionCertificationEnum) UnmarshalJSON(data []byte) error {
	...
	case "Set2":
		fallthrough
	case "Set3":
		*e = PensionPensionCertificationEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PensionPensionCertificationEnum: %v", v)
	}
}
...
func (e PensionPensionProRataMethodEnum) ToPointer() *PensionPensionProRataMethodEnum {
	return &e
}
...
func (e *PensionPensionProRataMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "WeekDaysPerCalendarMonth":
		*e = PensionPensionProRataMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PensionPensionProRataMethodEnum: %v", v)
	}
}
...
func (e PensionPensionRasRoundingOverrideEnum) ToPointer() *PensionPensionRasRoundingOverrideEnum {
	return &e
}
...
func (e *PensionPensionRasRoundingOverrideEnum) UnmarshalJSON(data []byte) error {
	...
	case "Floor":
		fallthrough
	case "Ceiling":
		*e = PensionPensionRasRoundingOverrideEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PensionPensionRasRoundingOverrideEnum: %v", v)
	}
}
...
func (e PensionPensionRoundingOptionEnum) ToPointer() *PensionPensionRoundingOptionEnum {
	return &e
}
...
func (e *PensionPensionRoundingOptionEnum) UnmarshalJSON(data []byte) error {
	...
	case "Floor":
		fallthrough
	case "Ceiling":
		*e = PensionPensionRoundingOptionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PensionPensionRoundingOptionEnum: %v", v)
	}
}
...
func (e PensionPensionTaxationMethodEnum) ToPointer() *PensionPensionTaxationMethodEnum {
	return &e
}
...
func (e *PensionPensionTaxationMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "TaxReliefExcluded":
		*e = PensionPensionTaxationMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PensionPensionTaxationMethodEnum: %v", v)
	}
}
