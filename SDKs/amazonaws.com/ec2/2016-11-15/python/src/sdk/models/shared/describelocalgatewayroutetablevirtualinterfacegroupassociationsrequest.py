...
class DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequestFilters:
...
class DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest:
    ...
    filters: Optional[list[DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequestFilters]] = dataclasses.field(default=None)  
    local_gateway_route_table_virtual_interface_group_association_ids: Optional[list[str]] = dataclasses.field(default=None)  
