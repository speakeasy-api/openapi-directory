...
from ..shared import deleteappversionresourceresponse as shared_deleteappversionresourceresponse
...
class DeleteAppVersionResourceRequestBody:
    ...
    logical_resource_id: Optional[DeleteAppVersionResourceRequestBodyLogicalResourceID] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logicalResourceId'), 'exclude': lambda f: f is None }})
    r"""Defines a logical resource identifier."""  
...
class DeleteAppVersionResourceRequest:
    ...
    request_body: DeleteAppVersionResourceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DeleteAppVersionResourceResponse:
    ...
    r"""ConflictException"""  
    delete_app_version_resource_response: Optional[shared_deleteappversionresourceresponse.DeleteAppVersionResourceResponse] = dataclasses.field(default=None)
    r"""Success"""  
