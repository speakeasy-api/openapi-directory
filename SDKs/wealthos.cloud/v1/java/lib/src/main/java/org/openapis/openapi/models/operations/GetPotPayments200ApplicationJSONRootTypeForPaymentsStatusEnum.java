 ...
 */
public enum GetPotPayments200ApplicationJSONRootTypeForPaymentsStatusEnum {
    ...
    private GetPotPayments200ApplicationJSONRootTypeForPaymentsStatusEnum(String value) {
        this.value = value;
    }
}
