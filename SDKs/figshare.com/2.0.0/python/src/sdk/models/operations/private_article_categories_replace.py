...
class PrivateArticleCategoriesReplacePathParams:
...
class PrivateArticleCategoriesReplaceRequest:
    path_params: PrivateArticleCategoriesReplacePathParams = dataclasses.field()
    request: shared_categoriescreator.CategoriesCreator = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: PrivateArticleCategoriesReplaceSecurity = dataclasses.field()
