...
class StoreDetailRequestEntityTypeEnum(str, Enum):
...
class StoreDetailRequest:
    ...
    """  
    entity_type: StoreDetailRequestEntityTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entityType') }})
    r"""The type of the entity the payout is processed for."""  
