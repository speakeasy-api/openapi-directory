...
from ..shared import invitepayeerequestv4 as shared_invitepayeerequestv4
...
class ResendPayeeInviteV4Request:
    ...
    invite_payee_request_v4: shared_invitepayeerequestv4.InvitePayeeRequestV4 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Provide Payor Id in body of request"""  
