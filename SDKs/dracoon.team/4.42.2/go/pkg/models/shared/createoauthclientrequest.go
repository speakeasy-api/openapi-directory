...
func (e *CreateOAuthClientRequestClientTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "confidential":
		fallthrough
	case "public":
		*e = CreateOAuthClientRequestClientTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOAuthClientRequestClientTypeEnum: %s", s)
	}
}
...
func (e *CreateOAuthClientRequestGrantTypesEnum) UnmarshalJSON(data []byte) error {
	...
	case "password":
		fallthrough
	case "refresh_token":
		*e = CreateOAuthClientRequestGrantTypesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOAuthClientRequestGrantTypesEnum: %s", s)
	}
}
