...
var PriceInsights = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "predictedClicksChangeFraction" }),
        __metadata("design:type", Number)
    ], PriceInsights.prototype, "predictedClicksChangeFraction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "predictedConversionsChangeFraction" }),
        __metadata("design:type", Number)
    ], PriceInsights.prototype, "predictedConversionsChangeFraction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "predictedGrossProfitChangeFraction" }),
        __metadata("design:type", Number)
    ], PriceInsights.prototype, "predictedGrossProfitChangeFraction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "predictedImpressionsChangeFraction" }),
        __metadata("design:type", Number)
    ], PriceInsights.prototype, "predictedImpressionsChangeFraction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "predictedMonthlyGrossProfitChangeCurrencyCode" }),
        __metadata("design:type", String)
    ], PriceInsights.prototype, "predictedMonthlyGrossProfitChangeCurrencyCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "predictedMonthlyGrossProfitChangeMicros" }),
        __metadata("design:type", String)
    ], PriceInsights.prototype, "predictedMonthlyGrossProfitChangeMicros", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "suggestedPriceCurrencyCode" }),
        __metadata("design:type", String)
    ], PriceInsights.prototype, "suggestedPriceCurrencyCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "suggestedPriceMicros" }),
        __metadata("design:type", String)
    ], PriceInsights.prototype, "suggestedPriceMicros", void 0);
    return PriceInsights;
}(utils_1.SpeakeasyBase));
exports.PriceInsights = PriceInsights;
