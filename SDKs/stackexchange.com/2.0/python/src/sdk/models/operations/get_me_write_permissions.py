...
class GetMeWritePermissionsQueryParams:
...
@dataclasses.dataclass
class GetMeWritePermissionsRequest:
    query_params: GetMeWritePermissionsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetMeWritePermissionsResponse:
