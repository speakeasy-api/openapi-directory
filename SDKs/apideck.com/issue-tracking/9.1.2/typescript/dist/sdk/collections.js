...
var Collections = /** @class */ (function () {
     ...
     * List Collections
     */
    Collections.prototype.collectionsAll = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CollectionsAllRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/issue-tracking/collections";
     ...
     * Get Collection
     */
    Collections.prototype.collectionsOne = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CollectionsOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/issue-tracking/collections/{collection_id}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
