...
func (s *Providers) GetAllProviders(ctx context.Context, request operations.GetAllProvidersRequest) (*operations.GetAllProvidersResponse, error) {
	...
	res := &operations.GetAllProvidersResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json;charset=UTF-8`):
			var out *shared.ProviderResponse
...
func (s *Providers) GetProvider(ctx context.Context, request operations.GetProviderRequest) (*operations.GetProviderResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/providers/{providerId}", request.PathParams)
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json;charset=UTF-8`):
			var out *shared.ProviderDetailResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Providers) GetProvidersCount(ctx context.Context, request operations.GetProvidersCountRequest) (*operations.GetProvidersCountResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/providers/count"
	...
	res := &operations.GetProvidersCountResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json;charset=UTF-8`):
			var out *shared.ProvidersCountResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
