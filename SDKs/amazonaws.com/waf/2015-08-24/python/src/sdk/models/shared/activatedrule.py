...
class ActivatedRule:
    ...
    excluded_rules: Optional[list[shared_excludedrule.ExcludedRule]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ExcludedRules') }})
    ...
    type: Optional[shared_wafruletype_enum.WafRuleTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Type') }})
