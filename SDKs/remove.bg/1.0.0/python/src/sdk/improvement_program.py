...
class ImprovementProgram:
    ...
    def post_improve_form(self, request: shared.ImprovementProgramJSON) -> operations.PostImproveFormResponse:
        ...
        * Get better results for similiar images in the future
        ...
        res = operations.PostImproveFormResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code in [200, 400, 403, 429]:
            if utils.match_content_type(content_type, '*/*'):
                res.body = http_res.content

        return res

    def post_improve_json(self, request: shared.ImprovementProgramJSON) -> operations.PostImproveJSONResponse:
        r"""Submit an image to the remove.bg Improvement program
        * Contribute an image that remove.bg is currently not able to remove the background from properly
        * Help us make remove.bg better
        * Get better results for similiar images in the future
        ...
        res = operations.PostImproveJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_improve_multipart(self, request: shared.ImprovementProgramMultipart) -> operations.PostImproveMultipartResponse:
        r"""Submit an image to the remove.bg Improvement program
        * Contribute an image that remove.bg is currently not able to remove the background from properly
        * Help us make remove.bg better
        * Get better results for similiar images in the future
        ...
        res = operations.PostImproveMultipartResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
