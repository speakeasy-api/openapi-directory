...
class GoogleCloudDocumentaiV1DocumentPageAnchorPageRef:
    ...
    layout_type: Optional[GoogleCloudDocumentaiV1DocumentPageAnchorPageRefLayoutTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('layoutType'), 'exclude': lambda f: f is None }})
    r"""Optional. The type of the layout element that is being referenced if any."""  
