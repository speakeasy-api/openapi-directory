...
var updateactionenum_1 = require("./updateactionenum");
 ...
 */
var UpdateInstruction = /** @class */ (function (_super) {
    __extends(UpdateInstruction, _super);
    ...
    ], UpdateInstruction.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "role" }),
        __metadata("design:type", String)
    ], UpdateInstruction.prototype, "role", void 0);
    __decorate([
    ...
    ], UpdateInstruction.prototype, "users", void 0);
