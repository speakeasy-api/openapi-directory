...
exports.AdsenseAlertsListResponse = exports.AdsenseAlertsListRequest = exports.AdsenseAlertsListSecurity = exports.AdsenseAlertsListSecurityOption2 = exports.AdsenseAlertsListSecurityOption1 = void 0;
...
exports.AdsenseAlertsListSecurityOption1 = AdsenseAlertsListSecurityOption1;
...
exports.AdsenseAlertsListSecurityOption2 = AdsenseAlertsListSecurityOption2;
...
exports.AdsenseAlertsListSecurity = AdsenseAlertsListSecurity;
var AdsenseAlertsListRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AdsenseAlertsListRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdsenseAlertsListRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdsenseAlertsListRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locale",
        }),
        __metadata("design:type", String)
    ], AdsenseAlertsListRequest.prototype, "locale", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdsenseAlertsListRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdsenseAlertsListRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdsenseAlertsListRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdsenseAlertsListRequest.prototype, "userIp", void 0);
    return AdsenseAlertsListRequest;
}(utils_1.SpeakeasyBase));
exports.AdsenseAlertsListRequest = AdsenseAlertsListRequest;
var AdsenseAlertsListResponse = /** @class */ (function (_super) {
    ...
    ], AdsenseAlertsListResponse.prototype, "rawResponse", void 0);
    return AdsenseAlertsListResponse;
}(utils_1.SpeakeasyBase));
exports.AdsenseAlertsListResponse = AdsenseAlertsListResponse;
