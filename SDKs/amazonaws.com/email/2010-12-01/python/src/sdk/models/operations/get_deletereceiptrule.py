...
class GetDeleteReceiptRuleQueryParams:
    action: GetDeleteReceiptRuleActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteReceiptRuleVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteReceiptRuleRequest:
    headers: GetDeleteReceiptRuleHeaders = dataclasses.field()
    query_params: GetDeleteReceiptRuleQueryParams = dataclasses.field()
