...
func (e LegacyBoxScoreFormatEnum) ToPointer() *LegacyBoxScoreFormatEnum {
	return &e
}
...
func (e *LegacyBoxScoreFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = LegacyBoxScoreFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for LegacyBoxScoreFormatEnum: %v", v)
	}
}
