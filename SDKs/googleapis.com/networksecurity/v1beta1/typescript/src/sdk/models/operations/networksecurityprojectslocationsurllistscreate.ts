...
export class NetworksecurityProjectsLocationsUrlListsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsUrlListsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsUrlListsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
