...
public class Iam {
    ...
    **/
    public openapisdk.models.operations.PolicytroubleshooterIamTroubleshootResponse policytroubleshooterIamTroubleshoot(openapisdk.models.operations.PolicytroubleshooterIamTroubleshootRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1beta/iam:troubleshoot");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyResponse.class);
