...
public class PostTruckRouteOutputFormatQueryParams {
    ...
    public PostTruckRouteOutputFormatQueryParams withOutputSRS(PostTruckRouteOutputFormatOutputSrsEnum outputSRS) {
    ...
    public PostTruckRouteOutputFormatQueryParams withPartition(String partition) {
    ...
    public PostTruckRouteOutputFormatQueryParams withTruckRouteMultiplier(Long truckRouteMultiplier) {
