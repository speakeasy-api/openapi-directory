...
class ConversationsV1UserUserConversation:
    ...
    conversation_state: Optional[shared_user_conversation_enum_state_enum.UserConversationEnumStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conversation_state'), 'exclude': lambda f: f is None }})  
    ...
    notification_level: Optional[shared_user_conversation_enum_notification_level_enum.UserConversationEnumNotificationLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('notification_level'), 'exclude': lambda f: f is None }})  
