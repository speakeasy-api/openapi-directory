...
export class GetcampaignaudiencesRequest extends SpeakeasyBase {
  /**
 ...
 */
export class Getcampaignaudiences200ApplicationJSONLastModified extends SpeakeasyBase {
  /**
 ...
 */
export class Getcampaignaudiences200ApplicationJSONTargetConfigurationsAffiliates extends SpeakeasyBase {
  /**
   * Affiliate ID.
   */
  @SpeakeasyMetadata()
 ...
 */
export class Getcampaignaudiences200ApplicationJSONTargetConfigurationsBrands extends SpeakeasyBase {
  /**
   * Brand ID.
   */
  @SpeakeasyMetadata()
 ...
 */
export class Getcampaignaudiences200ApplicationJSONTargetConfigurationsCategories extends SpeakeasyBase {
  /**
   * Category ID.
   */
  @SpeakeasyMetadata()
 ...
 */
export class Getcampaignaudiences200ApplicationJSONTargetConfigurationsCollections extends SpeakeasyBase {
  /**
   * Collection ID.
   */
  @SpeakeasyMetadata()
 ...
 */
export class Getcampaignaudiences200ApplicationJSONTargetConfigurationsPaymentsMethods extends SpeakeasyBase {
  /**
   * Payment Method ID.
   */
  @SpeakeasyMetadata()
 ...
 */
export class Getcampaignaudiences200ApplicationJSONTargetConfigurationsProducts extends SpeakeasyBase {
  /**
   * Product ID.
   */
  @SpeakeasyMetadata()
 ...
 */
export class Getcampaignaudiences200ApplicationJSONTargetConfigurationsSkus extends SpeakeasyBase {
  /**
   * SKU ID.
   */
  @SpeakeasyMetadata()
 ...
 */
export class Getcampaignaudiences200ApplicationJSONTargetConfigurationsZipCodeRanges extends SpeakeasyBase {
  /**
 ...
 */
export class Getcampaignaudiences200ApplicationJSONTargetConfigurations extends SpeakeasyBase {
  /**
   * Marketplace order identifier. The discount will apply to selected affiliates.
   */
  @SpeakeasyMetadata({
    elemType:
      Getcampaignaudiences200ApplicationJSONTargetConfigurationsAffiliates,
  })
  ...
  @Expose({ name: "brands" })
  @Type(() => Getcampaignaudiences200ApplicationJSONTargetConfigurationsBrands)
  ...
  @SpeakeasyMetadata({
    elemType:
      Getcampaignaudiences200ApplicationJSONTargetConfigurationsCategories,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      Getcampaignaudiences200ApplicationJSONTargetConfigurationsCollections,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      Getcampaignaudiences200ApplicationJSONTargetConfigurationsPaymentsMethods,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      Getcampaignaudiences200ApplicationJSONTargetConfigurationsProducts,
  })
  ...
  @Expose({ name: "skus" })
  @Type(() => Getcampaignaudiences200ApplicationJSONTargetConfigurationsSkus)
  ...
  @SpeakeasyMetadata({
    elemType:
      Getcampaignaudiences200ApplicationJSONTargetConfigurationsZipCodeRanges,
  })
 ...
 */
export class Getcampaignaudiences200ApplicationJSON extends SpeakeasyBase {
  /**
  ...
  @Type(() => Getcampaignaudiences200ApplicationJSONLastModified)
  ...
  @Type(() => Getcampaignaudiences200ApplicationJSONTargetConfigurations)
  targetConfigurations?: Getcampaignaudiences200ApplicationJSONTargetConfigurations[];
}

export class GetcampaignaudiencesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   * OK
   */
  @SpeakeasyMetadata({ elemType: Getcampaignaudiences200ApplicationJSON })
