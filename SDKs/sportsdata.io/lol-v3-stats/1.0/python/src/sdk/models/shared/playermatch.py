...
class PlayerMatch:
    ...
    champion_level: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ChampionLevel'), 'exclude': lambda f: f is None }})  
    ...
    lane: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Lane'), 'exclude': lambda f: f is None }})  
    ...
    spells: Optional[list[shared_spell.Spell]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Spells'), 'exclude': lambda f: f is None }})  
