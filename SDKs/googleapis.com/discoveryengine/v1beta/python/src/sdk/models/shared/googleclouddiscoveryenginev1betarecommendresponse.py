...
class GoogleCloudDiscoveryengineV1betaRecommendResponse:
    r"""GoogleCloudDiscoveryengineV1betaRecommendResponse
    ...
    results: Optional[list[shared_googleclouddiscoveryenginev1betarecommendresponserecommendationresult.GoogleCloudDiscoveryengineV1betaRecommendResponseRecommendationResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
