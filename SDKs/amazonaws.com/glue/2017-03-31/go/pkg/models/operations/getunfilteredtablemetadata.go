...
type GetUnfilteredTableMetadataHeaders struct {
...
type GetUnfilteredTableMetadataRequest struct {
	Headers GetUnfilteredTableMetadataHeaders
	Request shared.GetUnfilteredTableMetadataRequest `request:"mediaType=application/json"`
}
