...
public class GetMeQuestionsUnansweredRequest {
    ...
    public GetMeQuestionsUnansweredRequest withCallback(String callback) {
    ...
    public GetMeQuestionsUnansweredRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeQuestionsUnansweredRequest withFromdate(Long fromdate) {
    ...
    public GetMeQuestionsUnansweredRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetMeQuestionsUnansweredRequest withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetMeQuestionsUnansweredOrderEnum order;

    public GetMeQuestionsUnansweredRequest withOrder(GetMeQuestionsUnansweredOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetMeQuestionsUnansweredRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeQuestionsUnansweredRequest withPagesize(Long pagesize) {
    ...
    public GetMeQuestionsUnansweredRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetMeQuestionsUnansweredSortEnum sort;

    public GetMeQuestionsUnansweredRequest withSort(GetMeQuestionsUnansweredSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetMeQuestionsUnansweredRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetMeQuestionsUnansweredRequest(@JsonProperty("site") String site) {
        this.site = site;
  }
}
