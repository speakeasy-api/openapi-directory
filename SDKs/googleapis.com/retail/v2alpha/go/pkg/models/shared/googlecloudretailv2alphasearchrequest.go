...
func (e GoogleCloudRetailV2alphaSearchRequestRelevanceThresholdEnum) ToPointer() *GoogleCloudRetailV2alphaSearchRequestRelevanceThresholdEnum {
	return &e
}

func (e *GoogleCloudRetailV2alphaSearchRequestRelevanceThresholdEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "LOW":
		fallthrough
	case "LOWEST":
		*e = GoogleCloudRetailV2alphaSearchRequestRelevanceThresholdEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudRetailV2alphaSearchRequestRelevanceThresholdEnum: %v", v)
	}
}
...
func (e GoogleCloudRetailV2alphaSearchRequestSearchModeEnum) ToPointer() *GoogleCloudRetailV2alphaSearchRequestSearchModeEnum {
	return &e
}

func (e *GoogleCloudRetailV2alphaSearchRequestSearchModeEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "FACETED_SEARCH_ONLY":
		*e = GoogleCloudRetailV2alphaSearchRequestSearchModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudRetailV2alphaSearchRequestSearchModeEnum: %v", v)
	}
}
