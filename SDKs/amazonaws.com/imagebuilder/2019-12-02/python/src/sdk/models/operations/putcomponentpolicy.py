...
class PutComponentPolicyRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the component that this policy should be applied to."""  
...
class PutComponentPolicyRequest:
    ...
    request_body: PutComponentPolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
