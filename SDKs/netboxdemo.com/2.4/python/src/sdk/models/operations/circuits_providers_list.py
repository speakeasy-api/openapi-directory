...
class CircuitsProvidersList200ApplicationJSON:
    ...
    results: list[shared_provider.Provider] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class CircuitsProvidersListRequest:
    query_params: CircuitsProvidersListQueryParams = dataclasses.field()
