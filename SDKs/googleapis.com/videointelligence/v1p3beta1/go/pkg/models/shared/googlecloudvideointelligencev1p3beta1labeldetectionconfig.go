...
// GoogleCloudVideointelligenceV1p3beta1LabelDetectionConfigLabelDetectionModeEnum - What labels should be detected with LABEL_DETECTION, in addition to video-level labels or segment-level labels. If unspecified, defaults to `SHOT_MODE`.
...
func (e GoogleCloudVideointelligenceV1p3beta1LabelDetectionConfigLabelDetectionModeEnum) ToPointer() *GoogleCloudVideointelligenceV1p3beta1LabelDetectionConfigLabelDetectionModeEnum {
	return &e
}

func (e *GoogleCloudVideointelligenceV1p3beta1LabelDetectionConfigLabelDetectionModeEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "SHOT_AND_FRAME_MODE":
		*e = GoogleCloudVideointelligenceV1p3beta1LabelDetectionConfigLabelDetectionModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudVideointelligenceV1p3beta1LabelDetectionConfigLabelDetectionModeEnum: %v", v)
	}
}
