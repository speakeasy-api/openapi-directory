...
class ArticleSearchOrderEnum(str, Enum):
...
class ArticleSearchOrderDirectionEnum(str, Enum):
    ASC = "asc"
    DESC = "desc"
...
class ArticleSearch:
    ...
    order: Optional[ArticleSearchOrderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('order') }})
    order_direction: Optional[ArticleSearchOrderDirectionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('order_direction') }})
