...
class ListChannelWebhookListChannelWebhookResponse:
    ...
    webhooks: Optional[list[shared_ip_messaging_v2_service_channel_channel_webhook.IPMessagingV2ServiceChannelChannelWebhook]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('webhooks'), 'exclude': lambda f: f is None }})  
