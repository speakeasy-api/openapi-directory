 ...
 */
export class UsersAddonsListUserAddonAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class UsersAddonsListUserAddonLinks extends SpeakeasyBase {
  /**
...
export class UsersAddonsListUserAddon extends SpeakeasyBase {
  /**
   * The properties of the user addon entity.
   */
  @SpeakeasyMetadata()
