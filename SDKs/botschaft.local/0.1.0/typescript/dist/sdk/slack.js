...
var Slack = /** @class */ (function () {
    ...
    Slack.prototype.slackGetSlackGet = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.SlackGetSlackGetResponse({
    ...
    Slack.prototype.slackPostSlackPost = function (req, config) {
        ...
        try {
            _a = utils.serializeRequestBody(req, "slackMessageRequest", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.SlackPostSlackPostResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
