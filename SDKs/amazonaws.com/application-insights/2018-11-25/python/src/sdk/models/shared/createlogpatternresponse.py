...
class CreateLogPatternResponse:
    ...
    log_pattern: Optional[shared_logpattern.LogPattern] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('LogPattern'), 'exclude': lambda f: f is None }})  
