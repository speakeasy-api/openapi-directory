 ...
 */
export class DescribeTransitGatewayVpcAttachmentsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeTransitGatewayVpcAttachmentsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
