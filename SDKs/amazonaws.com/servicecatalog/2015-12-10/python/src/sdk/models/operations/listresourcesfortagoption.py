...
class ListResourcesForTagOptionRequest:
    ...
    list_resources_for_tag_option_input: shared_listresourcesfortagoptioninput.ListResourcesForTagOptionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
