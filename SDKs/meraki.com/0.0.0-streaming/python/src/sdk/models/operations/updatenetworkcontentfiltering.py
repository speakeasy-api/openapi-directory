...
class UpdateNetworkContentFilteringRequestBodyURLCategoryListSizeEnum(str, Enum):
...
class UpdateNetworkContentFilteringRequestBody:
    ...
    url_category_list_size: Optional[UpdateNetworkContentFilteringRequestBodyURLCategoryListSizeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('urlCategoryListSize'), 'exclude': lambda f: f is None }})
    r"""URL category list size which is either 'topSites' or 'fullList'"""  
...
class UpdateNetworkContentFilteringRequest:
    ...
    request_body: Optional[UpdateNetworkContentFilteringRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    

@dataclasses.dataclass
class UpdateNetworkContentFilteringResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None)  
    update_network_content_filtering_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
