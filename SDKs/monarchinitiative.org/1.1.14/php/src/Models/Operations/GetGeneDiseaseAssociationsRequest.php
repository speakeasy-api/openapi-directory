...
class GetGeneDiseaseAssociationsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetGeneDiseaseAssociationsAssociationTypeEnum $associationType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=association_type')]
    public ?GetGeneDiseaseAssociationsAssociationTypeEnum $associationType = null;
