...
from ..shared import deletedrivegroupresponse as shared_deletedrivegroupresponse
...
@dataclasses.dataclass
class DriveGroupsDeleteSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class DriveGroupsDeleteRequest:
    headers: DriveGroupsDeleteHeaders = dataclasses.field()
    path_params: DriveGroupsDeletePathParams = dataclasses.field()
    query_params: DriveGroupsDeleteQueryParams = dataclasses.field()
    security: DriveGroupsDeleteSecurity = dataclasses.field()
    

@dataclasses.dataclass
class DriveGroupsDeleteResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    delete_drive_group_response: Optional[shared_deletedrivegroupresponse.DeleteDriveGroupResponse] = dataclasses.field(default=None)
