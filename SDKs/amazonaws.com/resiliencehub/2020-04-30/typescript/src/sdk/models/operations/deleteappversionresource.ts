 ...
 */
export class DeleteAppVersionResourceRequestBodyLogicalResourceId extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class DeleteAppVersionResourceRequestBody extends SpeakeasyBase {
  /**
  ...
  @Type(() => DeleteAppVersionResourceRequestBodyLogicalResourceId)
...
export class DeleteAppVersionResourceRequest extends SpeakeasyBase {
...
export class DeleteAppVersionResourceResponse extends SpeakeasyBase {
  /**
