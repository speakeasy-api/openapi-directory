...
var AccountAccess = /** @class */ (function () {
    function AccountAccess(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    AccountAccess.prototype.deleteAccountAccessConsentsConsentId = function (req, config) {
    ...
    **/
    AccountAccess.prototype.getAccountAccessConsentsConsentId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    AccountAccess.prototype.postAccountAccessConsents = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
