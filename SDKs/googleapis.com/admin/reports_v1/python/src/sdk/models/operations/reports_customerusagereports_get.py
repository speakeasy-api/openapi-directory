...
@dataclasses.dataclass
class ReportsCustomerUsageReportsGetQueryParams:
...
class ReportsCustomerUsageReportsGetRequest:
    path_params: ReportsCustomerUsageReportsGetPathParams = dataclasses.field()
    query_params: ReportsCustomerUsageReportsGetQueryParams = dataclasses.field()
    security: ReportsCustomerUsageReportsGetSecurity = dataclasses.field()
