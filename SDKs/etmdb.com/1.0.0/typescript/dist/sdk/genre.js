...
var Genre = /** @class */ (function () {
    function Genre(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Genre.prototype.genreSearchRead = function (req, config) {
     ...
     * [ref]: https://etmdb.com/en/movie-list/-updated_date
    **/
    Genre.prototype.genreSearchallRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
