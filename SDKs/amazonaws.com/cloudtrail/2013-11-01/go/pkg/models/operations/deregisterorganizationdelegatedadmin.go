...
type DeregisterOrganizationDelegatedAdminHeaders struct {
...
type DeregisterOrganizationDelegatedAdminRequest struct {
	Headers DeregisterOrganizationDelegatedAdminHeaders
	Request shared.DeregisterOrganizationDelegatedAdminRequest `request:"mediaType=application/json"`
}
