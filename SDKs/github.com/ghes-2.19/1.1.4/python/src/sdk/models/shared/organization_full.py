...
class OrganizationFull:
    ...
    members_can_create_private_pages: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('members_can_create_private_pages') }})
    members_can_create_public_pages: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('members_can_create_public_pages') }})
