...
class GetTransactionsRequest:
    ...
    r"""A query document. Example: {'userId':'1'} matches all the transactions that have the userId '1'."""  
    sort: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""A sort document. Example: {'date':1} sorts the results by total in ascending order"""  
