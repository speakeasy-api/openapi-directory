...
class AndroidpublisherMonetizationSubscriptionsPatchRequest:
    path_params: AndroidpublisherMonetizationSubscriptionsPatchPathParams = dataclasses.field()
    query_params: AndroidpublisherMonetizationSubscriptionsPatchQueryParams = dataclasses.field()
    security: AndroidpublisherMonetizationSubscriptionsPatchSecurity = dataclasses.field()
