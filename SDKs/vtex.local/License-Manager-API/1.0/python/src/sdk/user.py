...
class User:
    ...
    def create_user(self, request: shared.CreateUserRequest) -> operations.CreateUserResponse:
        ...
        url = base_url.removesuffix('/') + '/api/license-manager/users'
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.CreateUser400ApplicationJSON])
                res.create_user_400_application_json_object = out
    ...
    def get_list_users(self, request: operations.GetListUsersRequest) -> operations.GetListUsersResponse:
        ...
        url = base_url.removesuffix('/') + '/api/license-manager/site/pvt/logins/list/paged'
    ...
    def get_user(self, request: operations.GetUserRequest) -> operations.GetUserResponse:
        ...
        url = utils.generate_url(operations.GetUserRequest, base_url, '/api/license-manager/users/{userId}', request)
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetUser400ApplicationJSON])
                res.get_user_400_application_json_object = out
