...
class GoogleCloudDialogflowV2OutputAudio:
    ...
    r"""The natural language speech audio."""  
    config: Optional[shared_googleclouddialogflowv2outputaudioconfig.GoogleCloudDialogflowV2OutputAudioConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('config'), 'exclude': lambda f: f is None }})
