...
export class OAuth2PermissionGrantCreate {
  ...
  oAuth2PermissionGrantCreate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.OAuth2PermissionGrantCreateResponse =
        new operations.OAuth2PermissionGrantCreateResponse({
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.oAuth2PermissionGrant = utils.objectToClass(
              httpRes?.data,
              shared.OAuth2PermissionGrant
            );
          }
          break;
      }
