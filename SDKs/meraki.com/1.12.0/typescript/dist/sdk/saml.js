...
var Saml = /** @class */ (function () {
    function Saml(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Saml.prototype.createOrganizationSamlIdp = function (req, config) {
        var _a;
    ...
    **/
    Saml.prototype.deleteOrganizationSamlIdp = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Saml.prototype.getOrganizationSaml = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Saml.prototype.getOrganizationSamlIdp = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Saml.prototype.getOrganizationSamlIdps = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Saml.prototype.updateOrganizationSaml = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Saml.prototype.updateOrganizationSamlIdp = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
