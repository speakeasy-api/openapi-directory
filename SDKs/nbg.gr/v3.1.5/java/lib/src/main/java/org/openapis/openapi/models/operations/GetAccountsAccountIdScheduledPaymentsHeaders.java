...
public class GetAccountsAccountIdScheduledPaymentsHeaders {
    /**
     * The unique id of the sandbox to be used
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=sandbox-id")
    public String sandboxId;
    public GetAccountsAccountIdScheduledPaymentsHeaders withSandboxId(String sandboxId) {
    ...
    public GetAccountsAccountIdScheduledPaymentsHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public GetAccountsAccountIdScheduledPaymentsHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public GetAccountsAccountIdScheduledPaymentsHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public GetAccountsAccountIdScheduledPaymentsHeaders withXFapiInteractionId(String xFapiInteractionId) {
