...
class MigrationcenterProjectsLocationsReportConfigsCreateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\ReportConfigInput $reportConfigInput = null;
