...
exports.GetRealmGroupsIdMembersResponse = exports.GetRealmGroupsIdMembersRequest = void 0;
...
var GetRealmGroupsIdMembersRequest = /** @class */ (function (_super) {
    ...
    ], GetRealmGroupsIdMembersRequest.prototype, "briefRepresentation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=first" }),
        __metadata("design:type", Number)
    ], GetRealmGroupsIdMembersRequest.prototype, "first", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], GetRealmGroupsIdMembersRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=max" }),
        __metadata("design:type", Number)
    ], GetRealmGroupsIdMembersRequest.prototype, "max", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=realm",
        }),
        __metadata("design:type", String)
    ], GetRealmGroupsIdMembersRequest.prototype, "realm", void 0);
    return GetRealmGroupsIdMembersRequest;
}(utils_1.SpeakeasyBase));
exports.GetRealmGroupsIdMembersRequest = GetRealmGroupsIdMembersRequest;
var GetRealmGroupsIdMembersResponse = /** @class */ (function (_super) {
    ...
    ], GetRealmGroupsIdMembersResponse.prototype, "rawResponse", void 0);
    __decorate([
...
exports.GetRealmGroupsIdMembersResponse = GetRealmGroupsIdMembersResponse;
