...
export declare class ReleasesGetLatestPublicReleaseRequest extends SpeakeasyBase {
    /**
     * The secret of the target application
     */
    appSecret: string;
}
export declare enum ReleasesGetLatestPublicRelease404ApplicationJSONCodeEnum {
 ...
 *
 */
export declare class ReleasesGetLatestPublicRelease404ApplicationJSON extends SpeakeasyBase {
 ...
 */
export declare class ReleasesGetLatestPublicRelease200ApplicationJSONBuild extends SpeakeasyBase {
    /**
 ...
 *
 */
export declare enum ReleasesGetLatestPublicRelease200ApplicationJSONDestinationTypeEnum {
    Group = "group",
    Store = "store",
    Tester = "tester"
}
 ...
 */
export declare enum ReleasesGetLatestPublicRelease200ApplicationJSONDestinationsDestinationTypeEnum {
    Group = "group",
    Store = "store",
    Tester = "tester"
}
 ...
 */
export declare enum ReleasesGetLatestPublicRelease200ApplicationJSONDestinationsTypeEnum {
    Intune = "intune",
 ...
 */
export declare class ReleasesGetLatestPublicRelease200ApplicationJSONDestinations extends SpeakeasyBase {
    /**
     * Destination can be either store or group.
     */
...
export declare class ReleasesGetLatestPublicRelease200ApplicationJSONDistributionGroups extends SpeakeasyBase {
    /**
 ...
 * type of the distribution store currently stores type can be intune, googleplay or windows.
 */
export declare enum ReleasesGetLatestPublicRelease200ApplicationJSONDistributionStoresTypeEnum {
    Intune = "intune",
    Googleplay = "googleplay",
    Apple = "apple",
    None = "none"
}
export declare class ReleasesGetLatestPublicRelease200ApplicationJSONDistributionStores extends SpeakeasyBase {
    /**
     * ID identifying a unique distribution store.
     */
    id: string;
 ...
 */
export declare enum ReleasesGetLatestPublicRelease200ApplicationJSONOriginEnum {
    Hockeyapp = "hockeyapp",
    Appcenter = "appcenter"
}
/**
 ...
 */
export declare enum ReleasesGetLatestPublicRelease200ApplicationJSONProvisioningProfileTypeEnum {
    Adhoc = "adhoc",
 ...
 */
export declare class ReleasesGetLatestPublicRelease200ApplicationJSON extends SpeakeasyBase {
    /**
...
export declare class ReleasesGetLatestPublicReleaseResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
