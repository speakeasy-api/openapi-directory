...
class CountOpenWorkflowExecutionsRequest:
    ...
    count_open_workflow_executions_input: shared_countopenworkflowexecutionsinput.CountOpenWorkflowExecutionsInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
