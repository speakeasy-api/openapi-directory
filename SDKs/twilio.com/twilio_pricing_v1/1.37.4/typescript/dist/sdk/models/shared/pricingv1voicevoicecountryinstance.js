...
var PricingV1VoiceVoiceCountryInstance = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=inbound_call_prices", elemType: PricingV1VoiceVoiceCountryInstanceInboundCallPrices }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=outbound_prefix_prices", elemType: PricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices }),
        __metadata("design:type", Array)
