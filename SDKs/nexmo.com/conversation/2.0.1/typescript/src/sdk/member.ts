      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.createMember201ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.CreateMember201ApplicationJSON
            );
          }
          break;
      }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.deleteMember200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data
            );
          }
          break;
  ...
  getMember(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getMember200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.GetMember200ApplicationJSON
            );
          }
          break;
      }
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            ...
            res.getMembers200ApplicationJSONObjects = utils.objectToClass(
              httpRes?.data,
  ...
  updateMember(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.updateMember200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.UpdateMember200ApplicationJSON
            );
          }
          break;
      }
