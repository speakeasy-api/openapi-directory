...
func (e CalendarEventsDeleteSendUpdatesEnum) ToPointer() *CalendarEventsDeleteSendUpdatesEnum {
	return &e
}
...
func (e *CalendarEventsDeleteSendUpdatesEnum) UnmarshalJSON(data []byte) error {
	...
	case "externalOnly":
		fallthrough
	case "none":
		*e = CalendarEventsDeleteSendUpdatesEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CalendarEventsDeleteSendUpdatesEnum: %v", v)
	}
}
