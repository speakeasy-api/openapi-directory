...
```bash
go get github.com/speakeasy-api/openapi-directory/SDKs/apisetu.gov.in/igrmaharashtra/3.0.0/go
```
...
func main() {
    ...
    res, err := s.APIs.Llcer(ctx, operations.LlcerRequestBody{
        ...
        Format: operations.LlcerRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.LlcerSecurity{
...
* [Llcer](docs/apis/README.md#llcer) - Leave and License Certificate
