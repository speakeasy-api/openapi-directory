...
export declare class PostRemovebgJson400WildcardErrors extends SpeakeasyBase {
    /**
     * Error code
     */
    code?: string;
 ...
 */
export declare class PostRemovebgJson400Wildcard extends SpeakeasyBase {
    errors?: PostRemovebgJson400WildcardErrors[];
}
export declare class PostRemovebgJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
