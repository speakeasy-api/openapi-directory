...
export class ReleasesGetLatestByUserSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ReleasesGetLatestByUserRequest extends SpeakeasyBase {
  /**
...
export enum ReleasesGetLatestByUser404ApplicationJSONCodeEnum {
 ...
 *
 */
export class ReleasesGetLatestByUser404ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
...
export enum ReleasesGetLatestByUser400ApplicationJSONCodeEnum {
  BadRequest = "BadRequest",
  Conflict = "Conflict",
  NotAcceptable = "NotAcceptable",
  NotFound = "NotFound",
 ...
 *
 */
export class ReleasesGetLatestByUser400ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
 ...
 */
export class ReleasesGetLatestByUser200ApplicationJSONBuild extends SpeakeasyBase {
  /**
 ...
 *
 */
export enum ReleasesGetLatestByUser200ApplicationJSONDestinationTypeEnum {
  Group = "group",
  Store = "store",
  Tester = "tester",
}
 ...
 */
export enum ReleasesGetLatestByUser200ApplicationJSONDestinationsDestinationTypeEnum {
  Group = "group",
  Store = "store",
  Tester = "tester",
}
 ...
 */
export enum ReleasesGetLatestByUser200ApplicationJSONDestinationsTypeEnum {
  Intune = "intune",
 ...
 */
export class ReleasesGetLatestByUser200ApplicationJSONDestinations extends SpeakeasyBase {
  /**
   * Destination can be either store or group.
   */
  @SpeakeasyMetadata()
...
export class ReleasesGetLatestByUser200ApplicationJSONDistributionGroups extends SpeakeasyBase {
  /**
 ...
 * type of the distribution store currently stores type can be intune, googleplay or windows.
 */
export enum ReleasesGetLatestByUser200ApplicationJSONDistributionStoresTypeEnum {
  Intune = "intune",
  Googleplay = "googleplay",
  Apple = "apple",
  None = "none",
...
export class ReleasesGetLatestByUser200ApplicationJSONDistributionStores extends SpeakeasyBase {
  /**
   * ID identifying a unique distribution store.
   */
  @SpeakeasyMetadata()
 ...
 */
export enum ReleasesGetLatestByUser200ApplicationJSONOriginEnum {
  Hockeyapp = "hockeyapp",
  Appcenter = "appcenter",
}
 ...
 */
export enum ReleasesGetLatestByUser200ApplicationJSONProvisioningProfileTypeEnum {
  Adhoc = "adhoc",
 ...
 */
export class ReleasesGetLatestByUser200ApplicationJSON extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "build" })
  @Type(() => ReleasesGetLatestByUser200ApplicationJSONBuild)
  ...
  @Type(() => ReleasesGetLatestByUser200ApplicationJSONDestinations)
  ...
  @Type(() => ReleasesGetLatestByUser200ApplicationJSONDistributionGroups)
  ...
  @Type(() => ReleasesGetLatestByUser200ApplicationJSONDistributionStores)
...
export class ReleasesGetLatestByUserResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
