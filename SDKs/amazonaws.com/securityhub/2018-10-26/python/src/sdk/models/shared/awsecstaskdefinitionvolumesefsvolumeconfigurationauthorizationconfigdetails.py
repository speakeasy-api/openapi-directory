...
class AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationAuthorizationConfigDetails:
    r"""AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationAuthorizationConfigDetails
    <p/>
    """
    ...
    iam: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Iam') }})
