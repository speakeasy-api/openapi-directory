...
var PagedEligibleItemCollection = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: eligibleitem_1.EligibleItem }),
        (0, class_transformer_1.Expose)({ name: "eligibleItems" }),
        (0, class_transformer_1.Type)(function () { return eligibleitem_1.EligibleItem; }),
