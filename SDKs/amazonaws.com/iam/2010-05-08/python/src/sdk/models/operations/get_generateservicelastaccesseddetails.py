...
class GetGenerateServiceLastAccessedDetailsQueryParams:
...
@dataclasses.dataclass
class GetGenerateServiceLastAccessedDetailsHeaders:
...
class GetGenerateServiceLastAccessedDetailsRequest:
    headers: GetGenerateServiceLastAccessedDetailsHeaders = dataclasses.field()
    query_params: GetGenerateServiceLastAccessedDetailsQueryParams = dataclasses.field()
