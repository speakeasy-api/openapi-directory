...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetPathParams:
    ...
    targeting_type: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetRequest:
    path_params: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetSecurity = dataclasses.field()
