...
func (e *POSTDescribeClientVpnConnectionsActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DescribeClientVpnConnections":
		*e = POSTDescribeClientVpnConnectionsActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTDescribeClientVpnConnectionsActionEnum: %s", s)
	}
}
...
func (e *POSTDescribeClientVpnConnectionsVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2016-11-15":
		*e = POSTDescribeClientVpnConnectionsVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTDescribeClientVpnConnectionsVersionEnum: %s", s)
	}
}
