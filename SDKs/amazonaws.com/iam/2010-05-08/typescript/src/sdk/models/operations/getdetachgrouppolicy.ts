...
export enum GETDetachGroupPolicyActionEnum {
  DetachGroupPolicy = "DetachGroupPolicy",
}

export enum GETDetachGroupPolicyVersionEnum {
  TwoThousandAndTen0508 = "2010-05-08",
}

export class GETDetachGroupPolicyRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETDetachGroupPolicyResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
