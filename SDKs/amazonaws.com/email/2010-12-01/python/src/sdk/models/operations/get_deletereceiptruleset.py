...
class GetDeleteReceiptRuleSetQueryParams:
    action: GetDeleteReceiptRuleSetActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    rule_set_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'RuleSetName', 'style': 'form', 'explode': True }})
    version: GetDeleteReceiptRuleSetVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteReceiptRuleSetRequest:
    headers: GetDeleteReceiptRuleSetHeaders = dataclasses.field()
    query_params: GetDeleteReceiptRuleSetQueryParams = dataclasses.field()
