...
export enum DeregisterComputeXAmzTargetEnum {
  GameLiftDeregisterCompute = "GameLift.DeregisterCompute",
}

export class DeregisterComputeRequest extends SpeakeasyBase {
...
export class DeregisterComputeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
