...
func (s *Customers) ProdTtSasportalCustomersList(ctx context.Context, request operations.ProdTtSasportalCustomersListRequest) (*operations.ProdTtSasportalCustomersListResponse, error) {
