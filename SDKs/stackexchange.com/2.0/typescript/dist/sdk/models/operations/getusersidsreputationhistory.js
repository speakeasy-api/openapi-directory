...
exports.GetUsersIdsReputationHistoryResponse = exports.GetUsersIdsReputationHistoryRequest = void 0;
...
var GetUsersIdsReputationHistoryRequest = /** @class */ (function (_super) {
    ...
    ], GetUsersIdsReputationHistoryRequest.prototype, "callback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetUsersIdsReputationHistoryRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=ids" }),
        __metadata("design:type", String)
    ], GetUsersIdsReputationHistoryRequest.prototype, "ids", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetUsersIdsReputationHistoryRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pagesize",
        }),
        __metadata("design:type", Number)
    ], GetUsersIdsReputationHistoryRequest.prototype, "pagesize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=site" }),
        __metadata("design:type", String)
    ], GetUsersIdsReputationHistoryRequest.prototype, "site", void 0);
...
var GetUsersIdsReputationHistoryResponse = /** @class */ (function (_super) {
    ...
    ], GetUsersIdsReputationHistoryResponse.prototype, "rawResponse", void 0);
