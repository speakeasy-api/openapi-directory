...
class DeleteSipAuthCallsCredentialListMappingRequest:
    path_params: DeleteSipAuthCallsCredentialListMappingPathParams = dataclasses.field()
    security: DeleteSipAuthCallsCredentialListMappingSecurity = dataclasses.field()
