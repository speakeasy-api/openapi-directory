 ...
 */
export declare enum InstanceListReferrersWarningCodeEnum {
...
export declare class InstanceListReferrersWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InstanceListReferrersWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InstanceListReferrersWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InstanceListReferrersWarningData[];
    /**
 ...
 */
export declare class InstanceListReferrers extends SpeakeasyBase {
    /**
