...
var Bgp = /** @class */ (function () {
    function Bgp(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return a Hub BGP Configuration
     */
    Bgp.prototype.getNetworkApplianceVpnBgp = function (req, config) {
     ...
     * Update a Hub BGP Configuration
     */
    Bgp.prototype.updateNetworkApplianceVpnBgp = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
