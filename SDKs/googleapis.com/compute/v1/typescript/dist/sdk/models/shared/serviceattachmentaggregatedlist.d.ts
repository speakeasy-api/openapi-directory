...
import { ServiceAttachmentsScopedList } from "./serviceattachmentsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum ServiceAttachmentAggregatedListWarningCodeEnum {
...
export declare class ServiceAttachmentAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ServiceAttachmentAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: ServiceAttachmentAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: ServiceAttachmentAggregatedListWarningData[];
    /**
 ...
 */
export declare class ServiceAttachmentAggregatedList extends SpeakeasyBase {
    /**
     ...
     */
    items?: Record<string, ServiceAttachmentsScopedList>;
    /**
     * Type of resource.
     */
    kind?: string;
