 ...
 */
public enum InboundRealTimePaymentsTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCategoryEnum {
    ...
    private InboundRealTimePaymentsTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCategoryEnum(String value) {
        this.value = value;
    }
}
