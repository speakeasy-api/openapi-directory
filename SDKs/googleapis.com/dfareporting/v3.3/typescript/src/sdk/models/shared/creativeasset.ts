...
export class CreativeAsset extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "customStartTimeValue" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "hideSelectionBoxes" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "horizontallyLocked" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "progressiveServingUrl" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "streamingServingUrl" })
