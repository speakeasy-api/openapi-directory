 ...
 */
export enum ReservationAggregatedListWarningCodeEnum {
...
export class ReservationAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ReservationAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: ReservationAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class ReservationAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: ReservationsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, ReservationsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], ReservationsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
