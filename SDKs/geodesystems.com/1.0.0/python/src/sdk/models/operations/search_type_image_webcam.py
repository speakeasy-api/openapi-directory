...
class SearchTypeImageWebcamQueryParams:
...
@dataclasses.dataclass
class SearchTypeImageWebcamRequest:
    query_params: SearchTypeImageWebcamQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeImageWebcamResponse:
