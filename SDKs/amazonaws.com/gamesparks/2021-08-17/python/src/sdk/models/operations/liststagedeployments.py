...
from ..shared import liststagedeploymentsresult as shared_liststagedeploymentsresult
...
class ListStageDeploymentsResponse:
    ...
    list_stage_deployments_result: Optional[shared_liststagedeploymentsresult.ListStageDeploymentsResult] = dataclasses.field(default=None)
    r"""Success"""  
