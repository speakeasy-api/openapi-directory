...
class UpdateRegexMatchSetRequest:
    ...
    update_regex_match_set_request: shared_updateregexmatchsetrequest.UpdateRegexMatchSetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
