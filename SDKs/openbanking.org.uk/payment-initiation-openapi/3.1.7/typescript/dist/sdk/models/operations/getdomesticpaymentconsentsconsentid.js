...
exports.GetDomesticPaymentConsentsConsentIdResponse = exports.GetDomesticPaymentConsentsConsentIdRequest = exports.GetDomesticPaymentConsentsConsentIdSecurity = void 0;
...
exports.GetDomesticPaymentConsentsConsentIdSecurity = GetDomesticPaymentConsentsConsentIdSecurity;
var GetDomesticPaymentConsentsConsentIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetDomesticPaymentConsentsConsentIdRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConsentId",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentConsentsConsentIdRequest.prototype, "consentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentConsentsConsentIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentConsentsConsentIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentConsentsConsentIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentConsentsConsentIdRequest.prototype, "xFapiInteractionId", void 0);
    return GetDomesticPaymentConsentsConsentIdRequest;
}(utils_1.SpeakeasyBase));
exports.GetDomesticPaymentConsentsConsentIdRequest = GetDomesticPaymentConsentsConsentIdRequest;
var GetDomesticPaymentConsentsConsentIdResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetDomesticPaymentConsentsConsentIdResponse.prototype, "rawResponse", void 0);
    return GetDomesticPaymentConsentsConsentIdResponse;
}(utils_1.SpeakeasyBase));
exports.GetDomesticPaymentConsentsConsentIdResponse = GetDomesticPaymentConsentsConsentIdResponse;
