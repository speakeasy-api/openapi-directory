...
var BillingPreviewRun = /** @class */ (function () {
    ...
    **/
    BillingPreviewRun.prototype.getBillingPreviewRun = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/billing-preview-runs/{billingPreviewRunId}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.getBillingPreviewRunResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    BillingPreviewRun.prototype.postBillingPreviewRun = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.postBillingPreviewRun200ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
