...
exports.GetPullRequestHostedPropertyValueResponse = exports.GetPullRequestHostedPropertyValueRequest = void 0;
...
var GetPullRequestHostedPropertyValueRequest = /** @class */ (function (_super) {
    ...
    ], GetPullRequestHostedPropertyValueRequest.prototype, "appKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=property_name",
        }),
        __metadata("design:type", String)
    ], GetPullRequestHostedPropertyValueRequest.prototype, "propertyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=pullrequest_id",
        }),
        __metadata("design:type", String)
    ], GetPullRequestHostedPropertyValueRequest.prototype, "pullrequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], GetPullRequestHostedPropertyValueRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], GetPullRequestHostedPropertyValueRequest.prototype, "workspace", void 0);
...
var GetPullRequestHostedPropertyValueResponse = /** @class */ (function (_super) {
    ...
    ], GetPullRequestHostedPropertyValueResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetPullRequestHostedPropertyValueResponse.prototype, "applicationProperty", void 0);
