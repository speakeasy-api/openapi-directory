...
export class PostApiRnbPvtImportCalculatorConfigurationRequest extends SpeakeasyBase {
  /**
...
export class PostApiRnbPvtImportCalculatorConfigurationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
