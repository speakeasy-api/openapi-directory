...
exports.POSTDescribeDBSnapshotAttributesResponse = exports.POSTDescribeDBSnapshotAttributesRequest = exports.POSTDescribeDBSnapshotAttributesVersionEnum = exports.POSTDescribeDBSnapshotAttributesActionEnum = void 0;
...
var POSTDescribeDBSnapshotAttributesRequest = /** @class */ (function (_super) {
    ...
    ], POSTDescribeDBSnapshotAttributesRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=text/xml" }),
        __metadata("design:type", Uint8Array)
    ], POSTDescribeDBSnapshotAttributesRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], POSTDescribeDBSnapshotAttributesRequest.prototype, "version", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], POSTDescribeDBSnapshotAttributesRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], POSTDescribeDBSnapshotAttributesRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], POSTDescribeDBSnapshotAttributesRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], POSTDescribeDBSnapshotAttributesRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], POSTDescribeDBSnapshotAttributesRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], POSTDescribeDBSnapshotAttributesRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], POSTDescribeDBSnapshotAttributesRequest.prototype, "xAmzSignedHeaders", void 0);
...
var POSTDescribeDBSnapshotAttributesResponse = /** @class */ (function (_super) {
    ...
    ], POSTDescribeDBSnapshotAttributesResponse.prototype, "rawResponse", void 0);
