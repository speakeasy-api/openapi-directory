...
public class IgcerSecurity {
    ...
    public IgcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public IgcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public IgcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
