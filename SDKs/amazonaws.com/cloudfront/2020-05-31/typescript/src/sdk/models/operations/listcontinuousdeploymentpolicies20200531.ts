...
export class ListContinuousDeploymentPolicies20200531Request extends SpeakeasyBase {
  /**
...
export class ListContinuousDeploymentPolicies20200531Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
