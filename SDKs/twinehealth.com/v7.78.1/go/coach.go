...
func newCoach(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *coach {
	return &coach{
...
func (s *coach) FetchCoach(ctx context.Context, request operations.FetchCoachRequest) (*operations.FetchCoachResponse, error) {
	...
	res := &operations.FetchCoachResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/vnd.api+json`):
			var out *shared.FetchCoachResponse
...
func (s *coach) FetchCoaches(ctx context.Context, request operations.FetchCoachesRequest) (*operations.FetchCoachesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/coach"
	...
	res := &operations.FetchCoachesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
