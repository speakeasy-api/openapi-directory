...
export class Dates {
  ...
  getCalendarDates(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetCalendarDatesResponse =
        new operations.GetCalendarDatesResponse({
      ...
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.calendarDatePage = utils.objectToClass(
              httpRes?.data,
              shared.CalendarDatePage
            );
          }
          break;
      }
  ...
  getCalendarDatesExport(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetCalendarDatesExportResponse =
        new operations.GetCalendarDatesExportResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getElectionDates(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetElectionDatesResponse =
        new operations.GetElectionDatesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getElectionDatesDefaultApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetElectionDatesDefaultApplicationJSON
              );
          }
          break;
      }
  ...
  getReportingDates(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetReportingDatesResponse =
        new operations.GetReportingDatesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getReportingDatesDefaultApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetReportingDatesDefaultApplicationJSON
              );
          }
          break;
      }
