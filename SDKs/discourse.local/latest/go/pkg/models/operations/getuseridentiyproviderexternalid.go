...
type GetUserIdentiyProviderExternalID200ApplicationJSONUserGroupUsers struct {
...
type GetUserIdentiyProviderExternalID200ApplicationJSONUserGroups struct {
...
type GetUserIdentiyProviderExternalID200ApplicationJSONUserUserAuthTokens struct {
...
type GetUserIdentiyProviderExternalID200ApplicationJSONUserUserFields struct {
	One string `json:"1"`
	Two string `json:"2"`
}

type GetUserIdentiyProviderExternalID200ApplicationJSONUserUserNotificationSchedule struct {
...
type GetUserIdentiyProviderExternalID200ApplicationJSONUserUserOption struct {
...
type GetUserIdentiyProviderExternalID200ApplicationJSONUser struct {
	...
	CreatedAt                    string                                                                         `json:"created_at"`
	CustomFields                 GetUserIdentiyProviderExternalID200ApplicationJSONUserCustomFields             `json:"custom_fields"`
	...
	FlairURL                     string                                                                         `json:"flair_url"`
	GroupUsers                   []GetUserIdentiyProviderExternalID200ApplicationJSONUserGroupUsers             `json:"group_users"`
	Groups                       []GetUserIdentiyProviderExternalID200ApplicationJSONUserGroups                 `json:"groups"`
	...
	UserAuthTokens               []GetUserIdentiyProviderExternalID200ApplicationJSONUserUserAuthTokens         `json:"user_auth_tokens"`
	UserFields                   *GetUserIdentiyProviderExternalID200ApplicationJSONUserUserFields              `json:"user_fields,omitempty"`
	UserNotificationSchedule     GetUserIdentiyProviderExternalID200ApplicationJSONUserUserNotificationSchedule `json:"user_notification_schedule"`
	UserOption                   GetUserIdentiyProviderExternalID200ApplicationJSONUserUserOption               `json:"user_option"`
...
type GetUserIdentiyProviderExternalID200ApplicationJSON struct {
	User       GetUserIdentiyProviderExternalID200ApplicationJSONUser `json:"user"`
	UserBadges []interface{}                                          `json:"user_badges"`
}

type GetUserIdentiyProviderExternalIDResponse struct {
	ContentType string
	StatusCode  int
