...
class GetDescribeEventCategoriesQueryParams:
    action: GetDescribeEventCategoriesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDescribeEventCategoriesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeEventCategoriesRequest:
    headers: GetDescribeEventCategoriesHeaders = dataclasses.field()
    query_params: GetDescribeEventCategoriesQueryParams = dataclasses.field()
