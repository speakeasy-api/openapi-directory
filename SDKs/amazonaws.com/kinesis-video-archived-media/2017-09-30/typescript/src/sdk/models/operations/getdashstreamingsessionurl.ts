...
export class GetDASHStreamingSessionURLRequestBodyDASHFragmentSelector extends SpeakeasyBase {
  ...
  @Type(() => shared.DASHTimestampRange)
...
export class GetDASHStreamingSessionURLRequestBody extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "DASHFragmentSelector" })
  @Type(() => GetDASHStreamingSessionURLRequestBodyDASHFragmentSelector)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "DisplayFragmentNumber" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "DisplayFragmentTimestamp" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "MaxManifestFragmentResults" })
...
export class GetDASHStreamingSessionURLRequest extends SpeakeasyBase {
  ...
  requestBody: GetDASHStreamingSessionURLRequestBody;
