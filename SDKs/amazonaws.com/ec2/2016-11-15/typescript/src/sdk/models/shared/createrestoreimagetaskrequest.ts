 ...
 */
export enum CreateRestoreImageTaskRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateRestoreImageTaskRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateRestoreImageTaskRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateRestoreImageTaskRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  bucket: string;
