...
export declare enum AccountHolderTransactionListRequestTransactionStatusesEnum {
...
export declare class AccountHolderTransactionListRequest extends SpeakeasyBase {
    /**
