...
class CancelGiftCardTransactionRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\CancelGiftCardTransactionRequest $cancelGiftCardTransactionRequest;
	...
	{
		$this->accept = "";
		$this->cancelGiftCardTransactionRequest = new \OpenAPI\OpenAPI\Models\Shared\CancelGiftCardTransactionRequest();
		$this->contentType = "";
		$this->giftCardID = "";
		$this->transactionID = "";
	}
