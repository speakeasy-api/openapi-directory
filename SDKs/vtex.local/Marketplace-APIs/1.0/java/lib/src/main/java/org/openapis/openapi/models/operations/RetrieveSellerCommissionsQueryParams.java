...
public class RetrieveSellerCommissionsQueryParams {
    /**
    ...
    public RetrieveSellerCommissionsQueryParams withAccountName(String accountName) {
    ...
    public RetrieveSellerCommissionsQueryParams withEnvironment(String environment) {
