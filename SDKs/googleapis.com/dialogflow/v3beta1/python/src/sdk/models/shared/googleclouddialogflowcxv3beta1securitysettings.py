...
import dataclasses
from ..shared import googleclouddialogflowcxv3beta1securitysettingsaudioexportsettings as shared_googleclouddialogflowcxv3beta1securitysettingsaudioexportsettings
from ..shared import googleclouddialogflowcxv3beta1securitysettingsinsightsexportsettings as shared_googleclouddialogflowcxv3beta1securitysettingsinsightsexportsettings
...
class GoogleCloudDialogflowCxV3beta1SecuritySettings:
    ...
    audio_export_settings: Optional[shared_googleclouddialogflowcxv3beta1securitysettingsaudioexportsettings.GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('audioExportSettings'), 'exclude': lambda f: f is None }})
    ...
    insights_export_settings: Optional[shared_googleclouddialogflowcxv3beta1securitysettingsinsightsexportsettings.GoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('insightsExportSettings'), 'exclude': lambda f: f is None }})
    ...
    purge_data_types: Optional[list[GoogleCloudDialogflowCxV3beta1SecuritySettingsPurgeDataTypesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('purgeDataTypes'), 'exclude': lambda f: f is None }})
    r"""List of types of data to remove when retention settings triggers purge."""  
    redaction_scope: Optional[GoogleCloudDialogflowCxV3beta1SecuritySettingsRedactionScopeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('redactionScope'), 'exclude': lambda f: f is None }})
    r"""Defines the data for which Dialogflow applies redaction. Dialogflow does not redact data that it does not have access to – for example, Cloud logging."""  
    redaction_strategy: Optional[GoogleCloudDialogflowCxV3beta1SecuritySettingsRedactionStrategyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('redactionStrategy'), 'exclude': lambda f: f is None }})
    r"""Strategy that defines how we do redaction."""  
    ...
    r"""Retains data in interaction logging for the specified number of days. This does not apply to Cloud logging, which is owned by the user - not Dialogflow. User must set a value lower than Dialogflow's default 365d TTL (30 days for Agent Assist traffic), higher value will be ignored and use default. Setting a value higher than that has no effect. A missing value or setting to 0 also means we use default TTL."""  
