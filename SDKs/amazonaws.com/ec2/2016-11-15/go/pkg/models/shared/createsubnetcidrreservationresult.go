...
func (e CreateSubnetCidrReservationResultSubnetCidrReservationReservationTypeEnum) ToPointer() *CreateSubnetCidrReservationResultSubnetCidrReservationReservationTypeEnum {
	return &e
}
...
func (e *CreateSubnetCidrReservationResultSubnetCidrReservationReservationTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "prefix":
		fallthrough
	case "explicit":
		*e = CreateSubnetCidrReservationResultSubnetCidrReservationReservationTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateSubnetCidrReservationResultSubnetCidrReservationReservationTypeEnum: %v", v)
	}
}
