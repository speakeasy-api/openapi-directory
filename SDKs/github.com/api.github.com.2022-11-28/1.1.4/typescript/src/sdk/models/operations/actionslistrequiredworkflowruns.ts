...
export class ActionsListRequiredWorkflowRunsRequest extends SpeakeasyBase {
  /**
 ...
 * Response
 */
export class ActionsListRequiredWorkflowRuns200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class ActionsListRequiredWorkflowRunsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
