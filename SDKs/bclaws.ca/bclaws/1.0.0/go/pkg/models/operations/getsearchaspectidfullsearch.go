...
func (e GetSearchAspectIDFullsearchAspectIDEnum) ToPointer() *GetSearchAspectIDFullsearchAspectIDEnum {
	return &e
}
...
func (e *GetSearchAspectIDFullsearchAspectIDEnum) UnmarshalJSON(data []byte) error {
	...
	case "hscr":
		fallthrough
	case "arch_oic":
		*e = GetSearchAspectIDFullsearchAspectIDEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSearchAspectIDFullsearchAspectIDEnum: %v", v)
	}
}
