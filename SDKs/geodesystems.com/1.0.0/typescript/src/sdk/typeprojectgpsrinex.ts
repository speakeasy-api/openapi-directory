...
export class TypeProjectGpsRinex {
  ...
  searchProjectGpsRinex(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/project_gps_rinex";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchProjectGpsRinexResponse =
        new operations.SearchProjectGpsRinexResponse({
