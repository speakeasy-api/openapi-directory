...
class GetGeneOrthologPhenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGeneOrthologPhenotypeAssociationsQueryParams:
...
class GetGeneOrthologPhenotypeAssociationsRequest:
    path_params: GetGeneOrthologPhenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetGeneOrthologPhenotypeAssociationsQueryParams = dataclasses.field()
