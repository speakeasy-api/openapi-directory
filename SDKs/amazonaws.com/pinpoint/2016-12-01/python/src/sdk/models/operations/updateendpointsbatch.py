...
class UpdateEndpointsBatchRequestBodyEndpointBatchRequest:
    r"""Specifies a batch of endpoints to create or update and the settings and attributes to set or change for each endpoint."""
    
    item: Optional[list[shared_endpointbatchitem.EndpointBatchItem]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Item'), 'exclude': lambda f: f is None }})  
...
class UpdateEndpointsBatchRequestBody:
    ...
    endpoint_batch_request: UpdateEndpointsBatchRequestBodyEndpointBatchRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EndpointBatchRequest') }})
    r"""Specifies a batch of endpoints to create or update and the settings and attributes to set or change for each endpoint."""  
...
class UpdateEndpointsBatchRequest:
    ...
    request_body: UpdateEndpointsBatchRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
