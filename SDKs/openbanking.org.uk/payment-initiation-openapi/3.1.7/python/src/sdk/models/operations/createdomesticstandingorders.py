...
class CreateDomesticStandingOrdersRequests:
    ...
    ob_write_domestic_standing_order3: Optional[shared_obwritedomesticstandingorder3.ObWriteDomesticStandingOrder3] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    ob_write_domestic_standing_order4: Optional[shared_obwritedomesticstandingorder3.ObWriteDomesticStandingOrder3] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class CreateDomesticStandingOrdersRequest:
    headers: CreateDomesticStandingOrdersHeaders = dataclasses.field()
    request: CreateDomesticStandingOrdersRequests = dataclasses.field()
    security: CreateDomesticStandingOrdersSecurity = dataclasses.field()
