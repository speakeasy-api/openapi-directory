...
// GetLabelByIDResponseBodyDisplaySchemeEnum - The display format that the label should be shown in.
type GetLabelByIDResponseBodyDisplaySchemeEnum string

const (
	GetLabelByIDResponseBodyDisplaySchemeEnumLabel          GetLabelByIDResponseBodyDisplaySchemeEnum = "label"
	GetLabelByIDResponseBodyDisplaySchemeEnumQrCode         GetLabelByIDResponseBodyDisplaySchemeEnum = "qr_code"
	GetLabelByIDResponseBodyDisplaySchemeEnumLabelAndQrCode GetLabelByIDResponseBodyDisplaySchemeEnum = "label_and_qr_code"
)

func (e *GetLabelByIDResponseBodyDisplaySchemeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "label_and_qr_code":
		*e = GetLabelByIDResponseBodyDisplaySchemeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetLabelByIDResponseBodyDisplaySchemeEnum: %s", s)
	}
}

// GetLabelByIDResponseBodyOptionalLink - A link to a related resource, or an empty object if there is no resource to link to
...
// GetLabelByIDResponseBodyMonetaryValue - A monetary value, such as the price of a shipping label, the insured value of a package, or an account balance.
...
// GetLabelByIDResponseBodyLabelFormatEnum - The possible file formats in which shipping labels can be downloaded.  We recommend `pdf` format because it is supported by all carriers, whereas some carriers do not support the `png` or `zpl` formats.
//
...
type GetLabelByIDResponseBodyLabelFormatEnum string

const (
	GetLabelByIDResponseBodyLabelFormatEnumPdf GetLabelByIDResponseBodyLabelFormatEnum = "pdf"
	GetLabelByIDResponseBodyLabelFormatEnumPng GetLabelByIDResponseBodyLabelFormatEnum = "png"
	GetLabelByIDResponseBodyLabelFormatEnumZpl GetLabelByIDResponseBodyLabelFormatEnum = "zpl"
)

func (e *GetLabelByIDResponseBodyLabelFormatEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "png":
		fallthrough
	case "zpl":
		*e = GetLabelByIDResponseBodyLabelFormatEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetLabelByIDResponseBodyLabelFormatEnum: %s", s)
	}
}

// GetLabelByIDResponseBodyLabelLayoutEnum - The available layouts (sizes) in which shipping labels can be downloaded.  The label format determines which sizes are supported.  `4x6` is supported for all label formats, whereas `letter` (8.5" x 11") is only supported for `pdf` format.
type GetLabelByIDResponseBodyLabelLayoutEnum string

const (
	GetLabelByIDResponseBodyLabelLayoutEnumFourx6 GetLabelByIDResponseBodyLabelLayoutEnum = "4x6"
	GetLabelByIDResponseBodyLabelLayoutEnumLetter GetLabelByIDResponseBodyLabelLayoutEnum = "letter"
)

func (e *GetLabelByIDResponseBodyLabelLayoutEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "4x6":
		fallthrough
	case "letter":
		*e = GetLabelByIDResponseBodyLabelLayoutEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetLabelByIDResponseBodyLabelLayoutEnum: %s", s)
	}
}

// GetLabelByIDResponseBodyLabelStatusEnum - The possible statuses that a [shipping label](https://www.shipengine.com/docs/labels/create-a-label/) can be in.
//
// |Status       |Description
// |:------------|:-----------------------------------------------------
...
type GetLabelByIDResponseBodyLabelStatusEnum string

const (
	GetLabelByIDResponseBodyLabelStatusEnumProcessing GetLabelByIDResponseBodyLabelStatusEnum = "processing"
	GetLabelByIDResponseBodyLabelStatusEnumCompleted  GetLabelByIDResponseBodyLabelStatusEnum = "completed"
	GetLabelByIDResponseBodyLabelStatusEnumError      GetLabelByIDResponseBodyLabelStatusEnum = "error"
	GetLabelByIDResponseBodyLabelStatusEnumVoided     GetLabelByIDResponseBodyLabelStatusEnum = "voided"
)

func (e *GetLabelByIDResponseBodyLabelStatusEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "error":
		fallthrough
	case "voided":
		*e = GetLabelByIDResponseBodyLabelStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetLabelByIDResponseBodyLabelStatusEnum: %s", s)
	}
}

// GetLabelByIDResponseBodyTrackingStatusEnum - The different statuses that can apply to a shipment.
type GetLabelByIDResponseBodyTrackingStatusEnum string

const (
	GetLabelByIDResponseBodyTrackingStatusEnumUnknown   GetLabelByIDResponseBodyTrackingStatusEnum = "unknown"
	GetLabelByIDResponseBodyTrackingStatusEnumInTransit GetLabelByIDResponseBodyTrackingStatusEnum = "in_transit"
	GetLabelByIDResponseBodyTrackingStatusEnumError     GetLabelByIDResponseBodyTrackingStatusEnum = "error"
	GetLabelByIDResponseBodyTrackingStatusEnumDelivered GetLabelByIDResponseBodyTrackingStatusEnum = "delivered"
)

func (e *GetLabelByIDResponseBodyTrackingStatusEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "error":
		fallthrough
	case "delivered":
		*e = GetLabelByIDResponseBodyTrackingStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetLabelByIDResponseBodyTrackingStatusEnum: %s", s)
	}
}
...
type GetLabelByIDResponseBodyOutput struct {
	...
	DisplayScheme *GetLabelByIDResponseBodyDisplaySchemeEnum `json:"display_scheme,omitempty"`
	...
	//
	LabelFormat *GetLabelByIDResponseBodyLabelFormatEnum `json:"label_format,omitempty"`
	...
	//
	LabelLayout *GetLabelByIDResponseBodyLabelLayoutEnum `json:"label_layout,omitempty"`
	...
	Status     *GetLabelByIDResponseBodyLabelStatusEnum `json:"status,omitempty"`
	...
	TrackingStatus *GetLabelByIDResponseBodyTrackingStatusEnum `json:"tracking_status,omitempty"`
