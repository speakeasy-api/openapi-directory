...
class FirebaseappcheckProjectsAppsExchangeRecaptchaV3TokenRequest:
    ...
    google_firebase_appcheck_v1beta_exchange_recaptcha_v3_token_request: Optional[shared_googlefirebaseappcheckv1betaexchangerecaptchav3tokenrequest.GoogleFirebaseAppcheckV1betaExchangeRecaptchaV3TokenRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
