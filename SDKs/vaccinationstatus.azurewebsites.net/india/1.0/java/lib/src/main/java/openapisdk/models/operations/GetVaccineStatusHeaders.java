...
public class GetVaccineStatusHeaders {
    ...
    @SpeakeasyMetadata("header:style=simple,explode=false,name=cowinApiKey")
    public String cowinApiKey;
    public GetVaccineStatusHeaders withCowinApiKey(String cowinApiKey) {
        this.cowinApiKey = cowinApiKey;
        return this;
    }
}