...
class CancelthetransactionRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\CancelthetransactionRequest $cancelthetransactionRequest;
	...
	{
		$this->accept = "";
		$this->cancelthetransactionRequest = new \OpenAPI\OpenAPI\Models\Shared\CancelthetransactionRequest();
		$this->contentType = "";
