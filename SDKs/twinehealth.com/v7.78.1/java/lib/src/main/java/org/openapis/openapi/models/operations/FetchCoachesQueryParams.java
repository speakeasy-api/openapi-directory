...
public class FetchCoachesQueryParams {
    /**
    ...
    public FetchCoachesQueryParams withFilterGroups(String filterGroups) {
    ...
    public FetchCoachesQueryParams withFilterOrganization(String filterOrganization) {
