...
func (e *POSTDescribeDBClusterParameterGroupsActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DescribeDBClusterParameterGroups":
		*e = POSTDescribeDBClusterParameterGroupsActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTDescribeDBClusterParameterGroupsActionEnum: %s", s)
	}
}
...
func (e *POSTDescribeDBClusterParameterGroupsVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2014-10-31":
		*e = POSTDescribeDBClusterParameterGroupsVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTDescribeDBClusterParameterGroupsVersionEnum: %s", s)
	}
}
