...
class DisassociateWebACLRequest:
    ...
    disassociate_web_acl_request: shared_disassociatewebaclrequest.DisassociateWebACLRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
