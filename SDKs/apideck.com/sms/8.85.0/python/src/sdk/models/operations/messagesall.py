...
from ..shared import getmessagesresponse as shared_getmessagesresponse
...
class MessagesAllRequest:
    headers: MessagesAllHeaders = dataclasses.field()
    query_params: MessagesAllQueryParams = dataclasses.field()
    security: MessagesAllSecurity = dataclasses.field()
...
class MessagesAllResponse:
    ...
    get_messages_response: Optional[shared_getmessagesresponse.GetMessagesResponse] = dataclasses.field(default=None)
