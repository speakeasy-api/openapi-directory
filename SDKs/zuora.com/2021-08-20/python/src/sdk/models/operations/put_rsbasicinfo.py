...
from ..shared import putrsbasicinfotype as shared_putrsbasicinfotype
...
class PUTRSBasicInfoRequest:
    ...
    putrs_basic_info_type: shared_putrsbasicinfotype.PUTRSBasicInfoType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
