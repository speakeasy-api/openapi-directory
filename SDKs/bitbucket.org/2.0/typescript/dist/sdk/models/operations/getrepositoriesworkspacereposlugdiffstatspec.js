...
exports.GetRepositoriesWorkspaceRepoSlugDiffstatSpecResponse = exports.GetRepositoriesWorkspaceRepoSlugDiffstatSpecRequest = exports.GetRepositoriesWorkspaceRepoSlugDiffstatSpecSecurity = void 0;
...
var GetRepositoriesWorkspaceRepoSlugDiffstatSpecRequest = /** @class */ (function (_super) {
    ...
    ], GetRepositoriesWorkspaceRepoSlugDiffstatSpecRequest.prototype, "ignoreWhitespace", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=merge" }),
        __metadata("design:type", Boolean)
    ], GetRepositoriesWorkspaceRepoSlugDiffstatSpecRequest.prototype, "merge", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=path" }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugDiffstatSpecRequest.prototype, "path", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=renames",
        }),
        __metadata("design:type", Boolean)
    ], GetRepositoriesWorkspaceRepoSlugDiffstatSpecRequest.prototype, "renames", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugDiffstatSpecRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=spec",
        }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugDiffstatSpecRequest.prototype, "spec", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=topic" }),
        __metadata("design:type", Boolean)
    ], GetRepositoriesWorkspaceRepoSlugDiffstatSpecRequest.prototype, "topic", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugDiffstatSpecRequest.prototype, "workspace", void 0);
...
var GetRepositoriesWorkspaceRepoSlugDiffstatSpecResponse = /** @class */ (function (_super) {
    ...
    ], GetRepositoriesWorkspaceRepoSlugDiffstatSpecResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
