...
class ProductOrderWithOptionRequest:
    ...
    r"""Product option (e.g. Accounts year) from a previous Availability call"""  
...
@dataclasses.dataclass
class ProductOrderWithOptionDefaultApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ProductOrderWithOption200ApplicationJSON:
...
class ProductOrderWithOptionResponse:
    ...
    product_order_with_option_200_application_json_object: Optional[ProductOrderWithOption200ApplicationJSON] = dataclasses.field(default=None)
    r"""Product order details"""  
    product_order_with_option_default_application_json_object: Optional[ProductOrderWithOptionDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Detailed information about the error"""  
