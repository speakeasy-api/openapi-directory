...
public class CreateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv22XMv72X {
    ...
    public CreateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv22XMv72X(@JsonProperty("quality") CreateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv22XMv72XQualityEnum quality, @JsonProperty("resolution") CreateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv22XMv72XResolutionEnum resolution) {
        this.quality = quality;
        this.resolution = resolution;
  }
}
