...
public class TaxApiDeleteFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public TaxApiDeleteFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public TaxApiDeleteFormHeaders withXAuthSecret(String xAuthSecret) {
