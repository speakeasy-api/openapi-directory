...
**/
var BackfillAllStrategy = /** @class */ (function (_super) {
    __extends(BackfillAllStrategy, _super);
    function BackfillAllStrategy() {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=postgresqlExcludedObjects" }),
        __metadata("design:type", postgresqlrdbms_1.PostgresqlRdbms)
    ], BackfillAllStrategy.prototype, "postgresqlExcludedObjects", void 0);
