...
class MigrationcenterProjectsLocationsSourcesErrorFramesListRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MigrationcenterProjectsLocationsSourcesErrorFramesListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?MigrationcenterProjectsLocationsSourcesErrorFramesListViewEnum $view = null;
