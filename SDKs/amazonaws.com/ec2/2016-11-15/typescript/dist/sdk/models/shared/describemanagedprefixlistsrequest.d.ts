 ...
 */
export declare class DescribeManagedPrefixListsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeManagedPrefixListsRequest extends SpeakeasyBase {
    dryRun?: boolean;
