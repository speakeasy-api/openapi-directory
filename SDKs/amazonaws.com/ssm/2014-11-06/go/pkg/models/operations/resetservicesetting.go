...
func (e ResetServiceSettingXAmzTargetEnum) ToPointer() *ResetServiceSettingXAmzTargetEnum {
	return &e
}
...
func (e *ResetServiceSettingXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonSSM.ResetServiceSetting":
		*e = ResetServiceSettingXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ResetServiceSettingXAmzTargetEnum: %v", v)
	}
}
