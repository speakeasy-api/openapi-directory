...
const (
	UpdateFilterRequestBodyActionEnumNone     UpdateFilterRequestBodyActionEnum = "NONE"
	UpdateFilterRequestBodyActionEnumSuppress UpdateFilterRequestBodyActionEnum = "SUPPRESS"
)

func (e UpdateFilterRequestBodyActionEnum) ToPointer() *UpdateFilterRequestBodyActionEnum {
	return &e
}

func (e *UpdateFilterRequestBodyActionEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "NONE":
		fallthrough
	case "SUPPRESS":
		*e = UpdateFilterRequestBodyActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateFilterRequestBodyActionEnum: %v", v)
	}
}

// UpdateFilterRequestBodyFilterCriteria - Details on the criteria used to define the filter.
type UpdateFilterRequestBodyFilterCriteria struct {
...
type UpdateFilterRequestBody struct {
	// Specifies the action that is to be applied to the findings that match the filter.
	Action *UpdateFilterRequestBodyActionEnum `json:"action,omitempty"`
	// A description of the filter.
	Description *string `json:"description,omitempty"`
	// The Amazon Resource Number (ARN) of the filter to update.
	FilterArn string `json:"filterArn"`
	// Details on the criteria used to define the filter.
	FilterCriteria *UpdateFilterRequestBodyFilterCriteria `json:"filterCriteria,omitempty"`
