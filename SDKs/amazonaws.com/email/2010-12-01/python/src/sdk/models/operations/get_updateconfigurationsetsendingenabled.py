...
class GetUpdateConfigurationSetSendingEnabledQueryParams:
    action: GetUpdateConfigurationSetSendingEnabledActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetUpdateConfigurationSetSendingEnabledVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetUpdateConfigurationSetSendingEnabledRequest:
    headers: GetUpdateConfigurationSetSendingEnabledHeaders = dataclasses.field()
    query_params: GetUpdateConfigurationSetSendingEnabledQueryParams = dataclasses.field()
