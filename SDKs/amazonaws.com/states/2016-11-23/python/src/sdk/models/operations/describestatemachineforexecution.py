...
class DescribeStateMachineForExecutionRequest:
    ...
    describe_state_machine_for_execution_input: shared_describestatemachineforexecutioninput.DescribeStateMachineForExecutionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
