...
class AnalyticsTracking:
    ...
    def get_store_tracked_clicks(self, request: operations.GetStoreTrackedClicksRequest) -> operations.GetStoreTrackedClicksResponse:
        ...
        url = utils.generate_url(base_url, "/v2/user/analytics/{storeId}/tracking/clicks", request.path_params)
        ...
        res = operations.GetStoreTrackedClicksResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrackedClicks])
    ...
    def get_store_tracked_external_orders(self, request: operations.GetStoreTrackedExternalOrdersRequest) -> operations.GetStoreTrackedExternalOrdersResponse:
        ...
        url = utils.generate_url(base_url, "/v2/user/analytics/{storeId}/tracking/externalorders", request.path_params)
        ...
        res = operations.GetStoreTrackedExternalOrdersResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrackedExternalOrders])
    ...
    def get_store_tracked_orders(self, request: operations.GetStoreTrackedOrdersRequest) -> operations.GetStoreTrackedOrdersResponse:
        ...
        url = utils.generate_url(base_url, "/v2/user/analytics/{storeId}/tracking/orders", request.path_params)
        ...
        res = operations.GetStoreTrackedOrdersResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrackedOrders])
    ...
    def get_store_tracking_status(self, request: operations.GetStoreTrackingStatusRequest) -> operations.GetStoreTrackingStatusResponse:
        ...
        url = utils.generate_url(base_url, "/v2/user/analytics/{storeId}/tracking/status", request.path_params)
        ...
        res = operations.GetStoreTrackingStatusResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StoreTrackingStatus])
    ...
    def get_tracking_status(self) -> operations.GetTrackingStatusResponse:
        ...
        res = operations.GetTrackingStatusResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrackingStatus])
