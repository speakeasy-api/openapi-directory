...
// APIV2010AccountNotificationRequestMethodEnum - The HTTP method used to generate the notification. If the notification was generated during a phone call, this is the HTTP Method used to request the resource on your server. If the notification was generated by your use of our REST API, this is the HTTP method used to call the resource on our servers.
...
func (e APIV2010AccountNotificationRequestMethodEnum) ToPointer() *APIV2010AccountNotificationRequestMethodEnum {
	return &e
}

func (e *APIV2010AccountNotificationRequestMethodEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountNotificationRequestMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountNotificationRequestMethodEnum: %v", v)
	}
}
