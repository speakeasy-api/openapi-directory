...
class CreateImagesFromFilesJSONRequest:
    ...
    image_file_create_batch: shared_imagefilecreatebatch.ImageFileCreateBatch = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclasses.dataclass
class CreateImagesFromFilesJSONResponse:
