...
public class GetZRAccountSettings200ApplicationXML2 {
    /**
    ...
    public GetZRAccountSettings200ApplicationXML2ClientAlert clientAlert;
    public GetZRAccountSettings200ApplicationXML2 withClientAlert(GetZRAccountSettings200ApplicationXML2ClientAlert clientAlert) {
        this.clientAlert = clientAlert;
        return this;
    }
    
    
    public GetZRAccountSettings200ApplicationXML2DigitalSignage digitalSignage;
    public GetZRAccountSettings200ApplicationXML2 withDigitalSignage(GetZRAccountSettings200ApplicationXML2DigitalSignage digitalSignage) {
    ...
    public GetZRAccountSettings200ApplicationXML2Notification notification;
    public GetZRAccountSettings200ApplicationXML2 withNotification(GetZRAccountSettings200ApplicationXML2Notification notification) {
