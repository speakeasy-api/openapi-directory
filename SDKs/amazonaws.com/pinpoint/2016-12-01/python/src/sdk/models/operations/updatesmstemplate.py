...
from ..shared import updatesmstemplateresponse as shared_updatesmstemplateresponse
...
@dataclasses.dataclass
class UpdateSmsTemplateQueryParams:
...
@dataclasses.dataclass
class UpdateSmsTemplateHeaders:
...
class UpdateSmsTemplateRequestBody:
    sms_template_request: UpdateSmsTemplateRequestBodySmsTemplateRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SMSTemplateRequest') }})
    

@dataclasses.dataclass
class UpdateSmsTemplateRequest:
    headers: UpdateSmsTemplateHeaders = dataclasses.field()
    path_params: UpdateSmsTemplatePathParams = dataclasses.field()
    query_params: UpdateSmsTemplateQueryParams = dataclasses.field()
    request: UpdateSmsTemplateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateSmsTemplateResponse:
    ...
    update_sms_template_response: Optional[shared_updatesmstemplateresponse.UpdateSmsTemplateResponse] = dataclasses.field(default=None)
