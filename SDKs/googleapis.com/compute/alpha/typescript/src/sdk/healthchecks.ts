...
export class HealthChecks {
  ...
  computeHealthChecksTestIamPermissions(
    req: operations.ComputeHealthChecksTestIamPermissionsRequest,
    security: operations.ComputeHealthChecksTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeHealthChecksTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.ComputeHealthChecksTestIamPermissionsSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeHealthChecksTestIamPermissionsResponse =
        new operations.ComputeHealthChecksTestIamPermissionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
