...
func (e CreateSipDomainCreateSipDomainRequestVoiceFallbackMethodEnum) ToPointer() *CreateSipDomainCreateSipDomainRequestVoiceFallbackMethodEnum {
	return &e
}
...
func (e *CreateSipDomainCreateSipDomainRequestVoiceFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateSipDomainCreateSipDomainRequestVoiceFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateSipDomainCreateSipDomainRequestVoiceFallbackMethodEnum: %v", v)
	}
}
...
func (e CreateSipDomainCreateSipDomainRequestVoiceMethodEnum) ToPointer() *CreateSipDomainCreateSipDomainRequestVoiceMethodEnum {
	return &e
}
...
func (e *CreateSipDomainCreateSipDomainRequestVoiceMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateSipDomainCreateSipDomainRequestVoiceMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateSipDomainCreateSipDomainRequestVoiceMethodEnum: %v", v)
	}
}
...
func (e CreateSipDomainCreateSipDomainRequestVoiceStatusCallbackMethodEnum) ToPointer() *CreateSipDomainCreateSipDomainRequestVoiceStatusCallbackMethodEnum {
	return &e
}
...
func (e *CreateSipDomainCreateSipDomainRequestVoiceStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateSipDomainCreateSipDomainRequestVoiceStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateSipDomainCreateSipDomainRequestVoiceStatusCallbackMethodEnum: %v", v)
	}
}
