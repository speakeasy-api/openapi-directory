...
class AnalyticsManagementCustomDimensionsPatchRequest:
    path_params: AnalyticsManagementCustomDimensionsPatchPathParams = dataclasses.field()
    query_params: AnalyticsManagementCustomDimensionsPatchQueryParams = dataclasses.field()
    security: AnalyticsManagementCustomDimensionsPatchSecurity = dataclasses.field()
