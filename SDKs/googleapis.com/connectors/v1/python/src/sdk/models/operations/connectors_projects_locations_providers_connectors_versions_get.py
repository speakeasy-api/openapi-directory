...
class ConnectorsProjectsLocationsProvidersConnectorsVersionsGetViewEnum(str, Enum):
    r"""Specifies which fields of the ConnectorVersion are returned in the response. Defaults to `CUSTOMER` view."""
...
class ConnectorsProjectsLocationsProvidersConnectorsVersionsGetRequest:
    ...
    r"""Required. Resource name of the form: `projects/*/locations/*/providers/*/connectors/*/versions/*` Only global location is supported for ConnectorVersion resource."""  
