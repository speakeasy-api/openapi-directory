...
class HostedOnboardingPage:
    ...
    def post_get_onboarding_url(self, request: shared.GetOnboardingURLRequest, security: operations.PostGetOnboardingURLSecurity) -> operations.PostGetOnboardingURLResponse:
        ...
        res = operations.PostGetOnboardingURLResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetOnboardingURLResponse])
