 ...
 */
public class PresetsUserMetadataConnectionsRecommendedChannels {
    /**
     * An array of HTTP methods permitted on this URI. This data requires a bearer token with the `private` scope.
     */
    @JsonProperty("options")
    public String[] options;
    public PresetsUserMetadataConnectionsRecommendedChannels withOptions(String[] options) {
    ...
    @JsonProperty("total")
    public Double total;
    public PresetsUserMetadataConnectionsRecommendedChannels withTotal(Double total) {
        this.total = total;
        return this;
    }
    ...
    @JsonProperty("uri")
    public String uri;
    public PresetsUserMetadataConnectionsRecommendedChannels withUri(String uri) {
        this.uri = uri;
        return this;
    }
