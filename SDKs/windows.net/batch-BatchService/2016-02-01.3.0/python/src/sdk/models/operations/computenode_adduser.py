...
from ..shared import computenodeuser as shared_computenodeuser
...
class ComputeNodeAddUserRequest:
    ...
    compute_node_user: shared_computenodeuser.ComputeNodeUser = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The user account to be created."""  
    node_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'nodeId', 'style': 'simple', 'explode': False }})
    r"""The id of the machine on which you want to create a user account."""  
