...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.workflowsProjectsLocationsList = function (req, config) {
    ...
    **/
    Projects.prototype.workflowsProjectsLocationsOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.workflowsProjectsLocationsWorkflowsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.WorkflowsProjectsLocationsWorkflowsCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/workflows", req.pathParams);
    ...
    **/
    Projects.prototype.workflowsProjectsLocationsWorkflowsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.workflowsProjectsLocationsWorkflowsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.workflowsProjectsLocationsWorkflowsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.workflowsProjectsLocationsWorkflowsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
