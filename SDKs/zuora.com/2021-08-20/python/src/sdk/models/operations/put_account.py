...
from ..shared import putaccounttype as shared_putaccounttype
...
class PUTAccountRequest:
    ...
    put_account_type: shared_putaccounttype.PUTAccountType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
