...
exports.GetCrawlStatisticsByFrequencyResponse = exports.GetCrawlStatisticsByFrequencyRequest = exports.GetCrawlStatisticsByFrequencyFrequencyEnum = void 0;
...
var GetCrawlStatisticsByFrequencyRequest = /** @class */ (function (_super) {
    ...
    ], GetCrawlStatisticsByFrequencyRequest.prototype, "analysisSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=frequency",
        }),
        __metadata("design:type", String)
    ], GetCrawlStatisticsByFrequencyRequest.prototype, "frequency", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetCrawlStatisticsByFrequencyRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=project_slug",
        }),
        __metadata("design:type", String)
    ], GetCrawlStatisticsByFrequencyRequest.prototype, "projectSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=username",
        }),
        __metadata("design:type", String)
    ], GetCrawlStatisticsByFrequencyRequest.prototype, "username", void 0);
...
var GetCrawlStatisticsByFrequencyResponse = /** @class */ (function (_super) {
    ...
    ], GetCrawlStatisticsByFrequencyResponse.prototype, "rawResponse", void 0);
