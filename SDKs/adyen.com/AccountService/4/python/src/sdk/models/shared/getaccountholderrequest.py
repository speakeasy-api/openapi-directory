...
class GetAccountHolderRequest:
    ...
    """  
    show_details: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('showDetails'), 'exclude': lambda f: f is None }})
    r"""True if the request should return the account holder details"""  
