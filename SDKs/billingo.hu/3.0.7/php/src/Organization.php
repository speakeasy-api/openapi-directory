...
class Organization 
{
     ...
     * 
     * @return \OpenAPI\OpenAPI\Models\Operations\GetOrganizationDataResponse
     */
	public function getOrganizationData(
    ): \OpenAPI\OpenAPI\Models\Operations\GetOrganizationDataResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/organization');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetOrganizationDataResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->organizationData = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\OrganizationData', 'json');
            }
        }
