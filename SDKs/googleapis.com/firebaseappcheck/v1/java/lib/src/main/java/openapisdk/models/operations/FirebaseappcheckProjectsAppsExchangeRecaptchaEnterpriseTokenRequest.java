...
public class FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenRequest {
    ...
    public openapisdk.models.shared.GoogleFirebaseAppcheckV1ExchangeRecaptchaEnterpriseTokenRequest request;
    public FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenRequest withRequest(openapisdk.models.shared.GoogleFirebaseAppcheckV1ExchangeRecaptchaEnterpriseTokenRequest request) {
