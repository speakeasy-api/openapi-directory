...
class ListActivityTypesRequest:
    headers: ListActivityTypesHeaders = dataclasses.field()
    query_params: ListActivityTypesQueryParams = dataclasses.field()
    request: shared_listactivitytypesinput.ListActivityTypesInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
