...
class BatchGetQueryExecutionRequest:
    ...
    batch_get_query_execution_input: shared_batchgetqueryexecutioninput.BatchGetQueryExecutionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
