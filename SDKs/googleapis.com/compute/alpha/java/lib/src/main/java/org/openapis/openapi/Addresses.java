...
public class Addresses {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeAddressesTestIamPermissionsResponse computeAddressesTestIamPermissions(org.openapis.openapi.models.operations.ComputeAddressesTestIamPermissionsRequest request, org.openapis.openapi.models.operations.ComputeAddressesTestIamPermissionsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeAddressesTestIamPermissionsRequest.class, baseUrl, "/projects/{project}/regions/{region}/addresses/{resource}/testIamPermissions", request, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeAddressesTestIamPermissionsRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
