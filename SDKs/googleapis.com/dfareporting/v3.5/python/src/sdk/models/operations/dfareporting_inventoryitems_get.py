...
@dataclasses.dataclass
class DfareportingInventoryItemsGetQueryParams:
...
class DfareportingInventoryItemsGetRequest:
    path_params: DfareportingInventoryItemsGetPathParams = dataclasses.field()
    query_params: DfareportingInventoryItemsGetQueryParams = dataclasses.field()
    security: DfareportingInventoryItemsGetSecurity = dataclasses.field()
