...
class CopySnapshotRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CopySnapshotRequestTagSpecifications:
    ...
    resource_type: Optional[CopySnapshotRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CopySnapshotRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CopySnapshotRequest:
    ...
    source_snapshot_id: str = dataclasses.field()  
    ...
    presigned_url: Optional[str] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CopySnapshotRequestTagSpecifications]] = dataclasses.field(default=None)  
