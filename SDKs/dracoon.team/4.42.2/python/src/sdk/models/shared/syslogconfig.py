...
class SyslogConfig:
    ...
    protocol: Optional[SyslogConfigProtocolEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol'), 'exclude': lambda f: f is None }})
    r"""Protocol to connect to syslog server"""  
