...
import dataclasses
from ..shared import destiny_sockets_destinyitemplugbase as shared_destiny_sockets_destinyitemplugbase
...
class DestinyComponentsItemsDestinyItemReusablePlugsComponent:
    ...
    plugs: Optional[dict[str, list[shared_destiny_sockets_destinyitemplugbase.DestinySocketsDestinyItemPlugBase]]] = dataclasses.field(default=None)
    r"""If the item supports reusable plugs, this is the list of plugs that are allowed to be used for the socket, and any relevant information about whether they are \\"enabled\\", whether they are allowed to be inserted, and any other information such as objectives.
