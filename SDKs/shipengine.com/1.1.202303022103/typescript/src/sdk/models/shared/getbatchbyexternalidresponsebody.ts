 ...
 *
 */
export enum GetBatchByExternalIdResponseBodyLabelFormatEnum {
  Pdf = "pdf",
  Png = "png",
  Zpl = "zpl",
}
 ...
 *
 */
export enum GetBatchByExternalIdResponseBodyLabelLayoutEnum {
  Fourx6 = "4x6",
  Letter = "letter",
}
 ...
 */
export enum GetBatchByExternalIdResponseBodyBatchStatusEnum {
  Open = "open",
  Queued = "queued",
...
export class GetBatchByExternalIdResponseBody extends SpeakeasyBase {
  ...
  @Type(() => GetBatchByExternalIdResponseBodyOptionalLink)
  ...
  @Type(() => GetBatchByExternalIdResponseBodyLabelDownload)
  labelDownload: GetBatchByExternalIdResponseBodyLabelDownload;

  @SpeakeasyMetadata()
  @Expose({ name: "label_format" })
  labelFormat: GetBatchByExternalIdResponseBodyLabelFormatEnum;
  ...
  labelLayout: GetBatchByExternalIdResponseBodyLabelLayoutEnum;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "status" })
  status: GetBatchByExternalIdResponseBodyBatchStatusEnum;
