...
var Tags = /** @class */ (function () {
    ...
    Tags.prototype.deleteTransactionsTransactionIdRelationshipsTags = function (req, config) {
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
                new operations.DeleteTransactionsTransactionIdRelationshipsTagsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/transactions/{transactionId}/relationships/tags", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "updateTransactionTagsRequest", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.DeleteTransactionsTransactionIdRelationshipsTagsResponse({
    ...
    Tags.prototype.postTransactionsTransactionIdRelationshipsTags = function (req, config) {
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
                new operations.PostTransactionsTransactionIdRelationshipsTagsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/transactions/{transactionId}/relationships/tags", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostTransactionsTransactionIdRelationshipsTagsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
