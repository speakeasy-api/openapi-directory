...
class InvoiceCreateAttachmentAPIModelTypeEnum(str, Enum):
...
class InvoiceCreateAttachmentAPIModel:
    ...
    type: Optional[InvoiceCreateAttachmentAPIModelTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Type'), 'exclude': lambda f: f is None }})
    r"""Type of the link (Attached or external)"""  
