...
var Areas = /** @class */ (function () {
    function Areas(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Areas.prototype.areasGet = function (req, config) {
    ...
    **/
    Areas.prototype.getVVersionAreasAreaIds = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
