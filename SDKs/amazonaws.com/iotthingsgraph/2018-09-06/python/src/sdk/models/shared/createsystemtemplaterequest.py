...
class CreateSystemTemplateRequest:
    ...
    compatible_namespace_version: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('compatibleNamespaceVersion'), 'exclude': lambda f: f is None }})  
