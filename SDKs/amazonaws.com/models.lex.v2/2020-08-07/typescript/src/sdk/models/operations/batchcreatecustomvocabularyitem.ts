...
export class BatchCreateCustomVocabularyItemRequestBody extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: shared.NewCustomVocabularyItem })
  @Expose({ name: "customVocabularyItemList" })
  @Type(() => shared.NewCustomVocabularyItem)
  customVocabularyItemList: shared.NewCustomVocabularyItem[];
}

export class BatchCreateCustomVocabularyItemRequest extends SpeakeasyBase {
