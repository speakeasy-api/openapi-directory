...
type AdminCustomersChromePrintServersPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AdminCustomersChromePrintServersPatchPathParams struct {
...
type AdminCustomersChromePrintServersPatchQueryParams struct {
	// V1 error format.
...
type AdminCustomersChromePrintServersPatchResponse struct {
	ContentType string
	// Successful response
