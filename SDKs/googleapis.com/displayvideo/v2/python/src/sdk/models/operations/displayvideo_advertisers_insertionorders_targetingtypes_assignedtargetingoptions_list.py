...
from ..shared import security as shared_security
from ..shared import listinsertionorderassignedtargetingoptionsresponse as shared_listinsertionorderassignedtargetingoptionsresponse

class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum(str, Enum):
...
class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListPathParams:
    ...
    targeting_type: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListQueryParams:
...
@dataclasses.dataclass
class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListSecurity:
...
class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListRequest:
    path_params: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListSecurity = dataclasses.field()
...
class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListResponse:
    ...
    list_insertion_order_assigned_targeting_options_response: Optional[shared_listinsertionorderassignedtargetingoptionsresponse.ListInsertionOrderAssignedTargetingOptionsResponse] = dataclasses.field(default=None)
