...
class Vitals:
    ...
    def playdeveloperreporting_vitals_errors_issues_search(self, request: operations.PlaydeveloperreportingVitalsErrorsIssuesSearchRequest, security: operations.PlaydeveloperreportingVitalsErrorsIssuesSearchSecurity) -> operations.PlaydeveloperreportingVitalsErrorsIssuesSearchResponse:
        ...
        url = utils.generate_url(operations.PlaydeveloperreportingVitalsErrorsIssuesSearchRequest, base_url, '/v1beta1/{parent}/errorIssues:search', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GooglePlayDeveloperReportingV1beta1SearchErrorIssuesResponse])
                res.google_play_developer_reporting_v1beta1_search_error_issues_response = out
    ...
    def playdeveloperreporting_vitals_errors_reports_search(self, request: operations.PlaydeveloperreportingVitalsErrorsReportsSearchRequest, security: operations.PlaydeveloperreportingVitalsErrorsReportsSearchSecurity) -> operations.PlaydeveloperreportingVitalsErrorsReportsSearchResponse:
        ...
        url = utils.generate_url(operations.PlaydeveloperreportingVitalsErrorsReportsSearchRequest, base_url, '/v1beta1/{parent}/errorReports:search', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GooglePlayDeveloperReportingV1beta1SearchErrorReportsResponse])
                res.google_play_developer_reporting_v1beta1_search_error_reports_response = out
    ...
    def playdeveloperreporting_vitals_stuckbackgroundwakelockrate_get(self, request: operations.PlaydeveloperreportingVitalsStuckbackgroundwakelockrateGetRequest, security: operations.PlaydeveloperreportingVitalsStuckbackgroundwakelockrateGetSecurity) -> operations.PlaydeveloperreportingVitalsStuckbackgroundwakelockrateGetResponse:
        ...
        url = utils.generate_url(operations.PlaydeveloperreportingVitalsStuckbackgroundwakelockrateGetRequest, base_url, '/v1beta1/{name}', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet])
    ...
    def playdeveloperreporting_vitals_stuckbackgroundwakelockrate_query(self, request: operations.PlaydeveloperreportingVitalsStuckbackgroundwakelockrateQueryRequest, security: operations.PlaydeveloperreportingVitalsStuckbackgroundwakelockrateQuerySecurity) -> operations.PlaydeveloperreportingVitalsStuckbackgroundwakelockrateQueryResponse:
        ...
        url = utils.generate_url(operations.PlaydeveloperreportingVitalsStuckbackgroundwakelockrateQueryRequest, base_url, '/v1beta1/{name}:query', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "google_play_developer_reporting_v1beta1_query_stuck_background_wakelock_rate_metric_set_request", 'json')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetResponse])
