 ...
 */
public class HdfsSnapshotDetail {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("archivalLocationIds")
    public String[] archivalLocationIds;

    public HdfsSnapshotDetail withArchivalLocationIds(String[] archivalLocationIds) {
    ...
    public HdfsSnapshotDetail withCloudState(Long cloudState) {
    ...
    public HdfsSnapshotDetail withCloudStorageTier(SnapshotCloudStorageTierEnum cloudStorageTier) {
    ...
    public HdfsSnapshotDetail withConsistencyLevel(String consistencyLevel) {
    ...
    public HdfsSnapshotDetail withDate(OffsetDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public HdfsSnapshotDetail withExpirationDate(OffsetDateTime expirationDate) {
    ...
    public HdfsSnapshotDetail withFileCount(Long fileCount) {
    ...
    public HdfsSnapshotDetail withHdfsName(String hdfsName) {
    ...
    public HdfsSnapshotDetail withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public HdfsSnapshotDetail withIndexState(Long indexState) {
    ...
    public HdfsSnapshotDetail withIsCustomRetentionApplied(Boolean isCustomRetentionApplied) {
    ...
    public HdfsSnapshotDetail withIsOnDemandSnapshot(Boolean isOnDemandSnapshot) {
    ...
    public HdfsSnapshotDetail withIsPlacedOnLegalHold(Boolean isPlacedOnLegalHold) {
    ...
    public HdfsSnapshotDetail withIsRetainedByRetentionLockSla(Boolean isRetainedByRetentionLockSla) {
    ...
    public HdfsSnapshotDetail withLastModified(OffsetDateTime lastModified) {
    ...
    public HdfsSnapshotDetail withParentSnapshotId(String parentSnapshotId) {
    ...
    public HdfsSnapshotDetail withReplicationLocationIds(String[] replicationLocationIds) {
    ...
    public HdfsSnapshotDetail withSize(Long size) {
        this.size = size;
        return this;
    }
    ...
    public HdfsSnapshotDetail withSlaId(String slaId) {
        this.slaId = slaId;
        return this;
    }
    ...
    public HdfsSnapshotDetail withSlaName(String slaName) {
    ...
    public HdfsSnapshotDetail withSnapshotRetentionInfo(SnapshotRetentionInfo snapshotRetentionInfo) {
    ...
    public HdfsSnapshotDetail withSourceObjectType(String sourceObjectType) {
        this.sourceObjectType = sourceObjectType;
        return this;
    }
    
    public HdfsSnapshotDetail(@JsonProperty("date") OffsetDateTime date, @JsonProperty("hdfsName") String hdfsName, @JsonProperty("id") String id, @JsonProperty("isCustomRetentionApplied") Boolean isCustomRetentionApplied, @JsonProperty("isOnDemandSnapshot") Boolean isOnDemandSnapshot, @JsonProperty("lastModified") OffsetDateTime lastModified, @JsonProperty("replicationLocationIds") String[] replicationLocationIds, @JsonProperty("size") Long size, @JsonProperty("slaId") String slaId, @JsonProperty("slaName") String slaName) {
        this.date = date;
        this.hdfsName = hdfsName;
        this.id = id;
        this.isCustomRetentionApplied = isCustomRetentionApplied;
