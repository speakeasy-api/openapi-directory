...
export class GetGenotypeModelAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGenotypeModelAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGenotypeModelAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGenotypeModelAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
