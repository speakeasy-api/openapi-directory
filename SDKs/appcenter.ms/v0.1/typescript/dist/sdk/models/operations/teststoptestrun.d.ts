...
export declare class TestStopTestRunSecurity extends SpeakeasyBase {
    apiToken: string;
}
export declare class TestStopTestRunRequest extends SpeakeasyBase {
    /**
 ...
 */
export declare class TestStopTestRunTestRunTestRunStatistics extends SpeakeasyBase {
    /**
 ...
 * Summary single test run on Xamarin Test Cloud
 */
export declare class TestStopTestRunTestRun extends SpeakeasyBase {
    /**
...
export declare class TestStopTestRunResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
