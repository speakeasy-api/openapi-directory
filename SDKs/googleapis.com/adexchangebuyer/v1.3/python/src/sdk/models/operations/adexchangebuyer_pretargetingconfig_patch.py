...
class AdexchangebuyerPretargetingConfigPatchRequest:
    path_params: AdexchangebuyerPretargetingConfigPatchPathParams = dataclasses.field()
    query_params: AdexchangebuyerPretargetingConfigPatchQueryParams = dataclasses.field()
    security: AdexchangebuyerPretargetingConfigPatchSecurity = dataclasses.field()
