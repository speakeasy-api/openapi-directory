...
from ..shared import putscoresrequest as shared_putscoresrequest
...
class PutscoresRequest:
    ...
    request_body: list[shared_putscoresrequest.PutscoresRequest] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    

@dataclasses.dataclass
class PutscoresResponse:
