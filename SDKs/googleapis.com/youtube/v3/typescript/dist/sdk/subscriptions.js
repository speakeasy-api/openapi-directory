...
var Subscriptions = /** @class */ (function () {
    ...
    **/
    Subscriptions.prototype.youtubeSubscriptionsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.YoutubeSubscriptionsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/youtube/v3/subscriptions";
    ...
    **/
    Subscriptions.prototype.youtubeSubscriptionsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Subscriptions.prototype.youtubeSubscriptionsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
