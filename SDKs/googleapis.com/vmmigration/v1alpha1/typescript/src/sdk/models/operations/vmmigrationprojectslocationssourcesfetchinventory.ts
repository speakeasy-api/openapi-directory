...
export class VmmigrationProjectsLocationsSourcesFetchInventorySecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsSourcesFetchInventoryRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsSourcesFetchInventoryResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
