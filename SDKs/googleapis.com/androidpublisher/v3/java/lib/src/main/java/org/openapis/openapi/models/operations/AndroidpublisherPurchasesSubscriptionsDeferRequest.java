...
public class AndroidpublisherPurchasesSubscriptionsDeferRequest {
    ...
    public AndroidpublisherPurchasesSubscriptionsDeferRequest(@JsonProperty("packageName") String packageName, @JsonProperty("subscriptionId") String subscriptionId, @JsonProperty("token") String token) {
        this.packageName = packageName;
        this.subscriptionId = subscriptionId;
        this.token = token;
  }
