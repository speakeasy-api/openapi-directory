...
from ..shared import closeaccountresponse as shared_closeaccountresponse
...
class PostCloseAccountResponse:
    ...
    close_account_response: Optional[shared_closeaccountresponse.CloseAccountResponse] = dataclasses.field(default=None)
