...
public class ReturnPolicy {
    ...
    **/
    public openapisdk.models.operations.CreateReturnPolicyResponse createReturnPolicy(openapisdk.models.operations.CreateReturnPolicyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/return_policy");
        ...
        openapisdk.models.operations.CreateReturnPolicyResponse res = new openapisdk.models.operations.CreateReturnPolicyResponse() {{
        ...
        if (httpRes.statusCode() == 201) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.SetReturnPolicyResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.SetReturnPolicyResponse.class);
    ...
    **/
    public openapisdk.models.operations.DeleteReturnPolicyResponse deleteReturnPolicy(openapisdk.models.operations.DeleteReturnPolicyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/return_policy/{return_policy_id}", request.pathParams);
        ...
        openapisdk.models.operations.DeleteReturnPolicyResponse res = new openapisdk.models.operations.DeleteReturnPolicyResponse() {{
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.GetReturnPoliciesResponse getReturnPolicies(openapisdk.models.operations.GetReturnPoliciesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/return_policy");
        ...
        openapisdk.models.operations.GetReturnPoliciesResponse res = new openapisdk.models.operations.GetReturnPoliciesResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.ReturnPolicyResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ReturnPolicyResponse.class);
    ...
    **/
    public openapisdk.models.operations.GetReturnPolicyResponse getReturnPolicy(openapisdk.models.operations.GetReturnPolicyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/return_policy/{return_policy_id}", request.pathParams);
        ...
        openapisdk.models.operations.GetReturnPolicyResponse res = new openapisdk.models.operations.GetReturnPolicyResponse() {{
            returnPolicy = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.ReturnPolicy out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ReturnPolicy.class);
    ...
    **/
    public openapisdk.models.operations.GetReturnPolicyByNameResponse getReturnPolicyByName(openapisdk.models.operations.GetReturnPolicyByNameRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/return_policy/get_by_policy_name");
        ...
        openapisdk.models.operations.GetReturnPolicyByNameResponse res = new openapisdk.models.operations.GetReturnPolicyByNameResponse() {{
            returnPolicy = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.UpdateReturnPolicyResponse updateReturnPolicy(openapisdk.models.operations.UpdateReturnPolicyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/return_policy/{return_policy_id}", request.pathParams);
        ...
        openapisdk.models.operations.UpdateReturnPolicyResponse res = new openapisdk.models.operations.UpdateReturnPolicyResponse() {{
            setReturnPolicyResponse = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
