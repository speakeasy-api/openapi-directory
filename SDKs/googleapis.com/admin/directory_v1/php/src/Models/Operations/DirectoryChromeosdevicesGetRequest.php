...
class DirectoryChromeosdevicesGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DirectoryChromeosdevicesGetProjectionEnum $projection
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=projection')]
    public ?DirectoryChromeosdevicesGetProjectionEnum $projection = null;
