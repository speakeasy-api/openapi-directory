...
class GetOperationResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetOperationOutput $getOperationOutput
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetOperationOutput $getOperationOutput = null;
