...
import { ReservationsScopedList } from "./reservationsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum ReservationAggregatedListWarningCodeEnum {
...
export declare class ReservationAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ReservationAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: ReservationAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: ReservationAggregatedListWarningData[];
    /**
 ...
 */
export declare class ReservationAggregatedList extends SpeakeasyBase {
    /**
