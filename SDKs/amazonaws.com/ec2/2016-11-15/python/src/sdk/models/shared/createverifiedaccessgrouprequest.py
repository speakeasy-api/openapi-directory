...
class CreateVerifiedAccessGroupRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateVerifiedAccessGroupRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateVerifiedAccessGroupRequestTagSpecifications:
    ...
    resource_type: Optional[CreateVerifiedAccessGroupRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateVerifiedAccessGroupRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateVerifiedAccessGroupRequest:
    ...
    tag_specifications: Optional[list[CreateVerifiedAccessGroupRequestTagSpecifications]] = dataclasses.field(default=None)  
