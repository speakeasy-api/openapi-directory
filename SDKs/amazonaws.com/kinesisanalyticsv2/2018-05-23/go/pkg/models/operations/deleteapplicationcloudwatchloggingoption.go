...
func (e DeleteApplicationCloudWatchLoggingOptionXAmzTargetEnum) ToPointer() *DeleteApplicationCloudWatchLoggingOptionXAmzTargetEnum {
	return &e
}

func (e *DeleteApplicationCloudWatchLoggingOptionXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "KinesisAnalytics_20180523.DeleteApplicationCloudWatchLoggingOption":
		*e = DeleteApplicationCloudWatchLoggingOptionXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DeleteApplicationCloudWatchLoggingOptionXAmzTargetEnum: %v", v)
	}
}

type DeleteApplicationCloudWatchLoggingOptionRequest struct {
	DeleteApplicationCloudWatchLoggingOptionRequest shared.DeleteApplicationCloudWatchLoggingOptionRequest `request:"mediaType=application/json"`
