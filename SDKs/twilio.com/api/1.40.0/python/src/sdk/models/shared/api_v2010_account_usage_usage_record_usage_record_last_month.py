...
class APIV2010AccountUsageUsageRecordUsageRecordLastMonth:
    ...
    category: Optional[shared_usage_record_last_month_enum_category_enum.UsageRecordLastMonthEnumCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category'), 'exclude': lambda f: f is None }})  
