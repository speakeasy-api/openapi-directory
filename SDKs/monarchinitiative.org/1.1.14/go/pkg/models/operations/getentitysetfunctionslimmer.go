...
func (e GetEntitySetFunctionSlimmerRelationshipTypeEnum) ToPointer() *GetEntitySetFunctionSlimmerRelationshipTypeEnum {
	return &e
}
...
func (e *GetEntitySetFunctionSlimmerRelationshipTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "acts_upstream_of_or_within":
		*e = GetEntitySetFunctionSlimmerRelationshipTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetEntitySetFunctionSlimmerRelationshipTypeEnum: %v", v)
	}
}
