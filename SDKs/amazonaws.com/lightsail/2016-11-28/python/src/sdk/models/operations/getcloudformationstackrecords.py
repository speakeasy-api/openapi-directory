...
class GetCloudFormationStackRecordsRequest:
    ...
    get_cloud_formation_stack_records_request: shared_getcloudformationstackrecordsrequest.GetCloudFormationStackRecordsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
