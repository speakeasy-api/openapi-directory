...
from ..shared import deleteapplicationinput as shared_deleteapplicationinput
...
class DeleteApplicationRequest:
    ...
    request: shared_deleteapplicationinput.DeleteApplicationInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
