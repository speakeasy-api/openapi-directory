...
export class PatchMerchantsMerchantIdStoresReferenceTerminalLogosSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PatchMerchantsMerchantIdStoresReferenceTerminalLogosRequest extends SpeakeasyBase {
...
export class PatchMerchantsMerchantIdStoresReferenceTerminalLogosResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
