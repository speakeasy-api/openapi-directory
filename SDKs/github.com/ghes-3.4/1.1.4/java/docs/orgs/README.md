...
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#check-organization-membership-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsCheckMembershipForUserRequest req = new OrgsCheckMembershipForUserRequest("enim", "sint");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#check-public-organization-membership-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsCheckPublicMembershipForUserRequest req = new OrgsCheckPublicMembershipForUserRequest("nulla", "deserunt");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#convert-an-organization-member-to-outside-collaborator>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsConvertMemberToOutsideCollaboratorRequest req = new OrgsConvertMemberToOutsideCollaboratorRequest("esse", "nemo") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#create-an-organization-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#delete-an-organization-webhook>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsDeleteWebhookRequest req = new OrgsDeleteWebhookRequest(945027L, "necessitatibus");            
...
To see many of the organization response values, you need to be an authenticated organization owner with the `admin:org` scope. When the value of `two_factor_requirement_enabled` is `true`, the organization requires all members, billing managers, and outside collaborators to enable [two-factor authentication](https://docs.github.com/enterprise-server@3.4/articles/securing-your-account-with-two-factor-authentication-2fa/).
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-an-organization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsGetRequest req = new OrgsGetRequest("asperiores");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-audit-log>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsGetAuditLogRequest req = new OrgsGetAuditLogRequest("ex") {{
                after = "voluptas";
                before = "debitis";
                include = AuditLogIncludeEnum.ALL;
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-an-organization-membership-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsGetMembershipForAuthenticatedUserRequest req = new OrgsGetMembershipForAuthenticatedUserRequest("consectetur");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-organization-membership-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsGetMembershipForUserRequest req = new OrgsGetMembershipForUserRequest("velit", "atque");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-an-organization-webhook>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsGetWebhookRequest req = new OrgsGetWebhookRequest(216457L, "impedit");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-a-webhook-configuration-for-an-organization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsGetWebhookConfigForOrgRequest req = new OrgsGetWebhookConfigForOrgRequest(166047L, "soluta");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-a-webhook-delivery-for-an-organization-webhook>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsGetWebhookDeliveryRequest req = new OrgsGetWebhookDeliveryRequest(922757L, 721430L, "dolore");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-organizations>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-app-installations-for-an-organization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListAppInstallationsRequest req = new OrgsListAppInstallationsRequest("sequi") {{
                page = 493958L;
                perPage = 205566L;
            }};            
...
For more information on custom repository roles, see "[About custom repository roles](https://docs.github.com/enterprise-server@3.4/organizations/managing-peoples-access-to-your-organization-with-roles/about-custom-repository-roles)."

API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-custom-repository-roles-in-an-organization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListCustomRolesRequest req = new OrgsListCustomRolesRequest("quo");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-organizations-for-the-authenticated-user>
...
List [public organization memberships](https://docs.github.com/enterprise-server@3.4/articles/publicizing-or-concealing-organization-membership) for the specified user.
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-organizations-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListForUserRequest req = new OrgsListForUserRequest("iure") {{
                page = 139072L;
                perPage = 974990L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-organization-members>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListMembersRequest req = new OrgsListMembersRequest("vel") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-organization-memberships-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-outside-collaborators-for-an-organization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListOutsideCollaboratorsRequest req = new OrgsListOutsideCollaboratorsRequest("quia") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-public-organization-members>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListPublicMembersRequest req = new OrgsListPublicMembersRequest("illo") {{
                page = 36561L;
                perPage = 424663L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-deliveries-for-an-organization-webhook>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListWebhookDeliveriesRequest req = new OrgsListWebhookDeliveriesRequest(406922L, "beatae") {{
                cursor = "vero";
                perPage = 568218L;
                redelivery = false;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-organization-webhooks>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsListWebhooksRequest req = new OrgsListWebhooksRequest("eum") {{
                page = 246557L;
                perPage = 284086L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#ping-an-organization-webhook>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsPingWebhookRequest req = new OrgsPingWebhookRequest(596433L, "earum");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#redeliver-a-delivery-for-an-organization-webhook>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsRedeliverWebhookDeliveryRequest req = new OrgsRedeliverWebhookDeliveryRequest(117525L, 772266L, "voluptatibus");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#remove-an-organization-member>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsRemoveMemberRequest req = new OrgsRemoveMemberRequest("iste", "itaque");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#remove-organization-membership-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsRemoveMembershipForUserRequest req = new OrgsRemoveMembershipForUserRequest("alias", "nisi");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#remove-outside-collaborator-from-an-organization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsRemoveOutsideCollaboratorRequest req = new OrgsRemoveOutsideCollaboratorRequest("itaque", "velit");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#remove-public-organization-membership-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsRemovePublicMembershipForAuthenticatedUserRequest req = new OrgsRemovePublicMembershipForAuthenticatedUserRequest("laborum", "non");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#set-organization-membership-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsSetMembershipForUserRequest req = new OrgsSetMembershipForUserRequest("dolor", "iusto") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#set-public-organization-membership-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsSetPublicMembershipForAuthenticatedUserRequest req = new OrgsSetPublicMembershipForAuthenticatedUserRequest("doloremque", "consequatur");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#update-an-organization>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#update-an-organization-membership-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsUpdateMembershipForAuthenticatedUserRequest req = new OrgsUpdateMembershipForAuthenticatedUserRequest(                new OrgsUpdateMembershipForAuthenticatedUserRequestBody(OrgsUpdateMembershipForAuthenticatedUserRequestBodyStateEnum.ACTIVE);, "esse");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#update-an-organization-webhook>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsUpdateWebhookRequest req = new OrgsUpdateWebhookRequest(288570L, "veritatis") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#update-a-webhook-configuration-for-an-organization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OrgsUpdateWebhookConfigForOrgRequest req = new OrgsUpdateWebhookConfigForOrgRequest(212434L, "ad") {{
