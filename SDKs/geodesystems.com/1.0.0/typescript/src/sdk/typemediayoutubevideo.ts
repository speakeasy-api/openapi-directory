...
export class TypeMediaYoutubevideo {
  ...
  searchMediaYoutubevideo(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/media_youtubevideo";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchMediaYoutubevideoResponse =
        new operations.SearchMediaYoutubevideoResponse({
