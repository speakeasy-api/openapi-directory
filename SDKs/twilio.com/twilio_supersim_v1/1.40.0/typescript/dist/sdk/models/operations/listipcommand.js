...
exports.ListIpCommandResponse = exports.ListIpCommandListIpCommandResponse = exports.ListIpCommandListIpCommandResponseMeta = exports.ListIpCommandRequest = exports.ListIpCommandSecurity = exports.ListIpCommandServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListIpCommandServerList = ["https://supersim.twilio.com"];
var ListIpCommandSecurity = /** @class */ (function (_super) {
    ...
    ], ListIpCommandSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListIpCommandSecurity.prototype, "username", void 0);
...
var ListIpCommandRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListIpCommandRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListIpCommandRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListIpCommandRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListIpCommandRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Sim" }),
        __metadata("design:type", String)
    ], ListIpCommandRequest.prototype, "sim", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SimIccid",
        }),
        __metadata("design:type", String)
    ], ListIpCommandRequest.prototype, "simIccid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListIpCommandRequest.prototype, "status", void 0);
...
var ListIpCommandListIpCommandResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.SupersimV1IpCommand }),
        (0, class_transformer_1.Expose)({ name: "ip_commands" }),
        (0, class_transformer_1.Type)(function () { return shared.SupersimV1IpCommand; }),
        __metadata("design:type", Array)
    ], ListIpCommandListIpCommandResponse.prototype, "ipCommands", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListIpCommandListIpCommandResponseMeta; }),
...
var ListIpCommandResponse = /** @class */ (function (_super) {
    ...
    ], ListIpCommandResponse.prototype, "rawResponse", void 0);
