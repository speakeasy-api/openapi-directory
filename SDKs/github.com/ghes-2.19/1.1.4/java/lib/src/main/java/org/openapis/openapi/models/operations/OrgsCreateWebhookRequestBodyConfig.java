...
/**
 * OrgsCreateWebhookRequestBodyConfig - Key/value pairs to provide settings for this webhook. [These are defined below](https://docs.github.com/enterprise-server@2.19/rest/reference/orgs#create-hook-config-params).
 */
public class OrgsCreateWebhookRequestBodyConfig {
    ...
    public OrgsCreateWebhookRequestBodyConfig(@JsonProperty("url") String url) {
        this.url = url;
  }
}
