...
export class ContainerProjectsZonesOperationsCancelSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContainerProjectsZonesOperationsCancelRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsZonesOperationsCancelResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
