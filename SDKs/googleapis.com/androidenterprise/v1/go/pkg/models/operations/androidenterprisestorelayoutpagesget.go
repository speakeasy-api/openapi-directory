...
type AndroidenterpriseStorelayoutpagesGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseStorelayoutpagesGetPathParams struct {
...
type AndroidenterpriseStorelayoutpagesGetQueryParams struct {
	// V1 error format.
...
type AndroidenterpriseStorelayoutpagesGetRequest struct {
...
type AndroidenterpriseStorelayoutpagesGetResponse struct {
	ContentType string
	StatusCode  int
