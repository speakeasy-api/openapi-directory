...
exports.UpsSettingsResponseBody = void 0;
...
**/
var UpsSettingsResponseBody = /** @class */ (function (_super) {
    __extends(UpsSettingsResponseBody, _super);
    function UpsSettingsResponseBody() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=account_postal_code" }),
        __metadata("design:type", String)
    ], UpsSettingsResponseBody.prototype, "accountPostalCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=invoice" }),
        __metadata("design:type", upsinvoice_1.UpsInvoice)
    ], UpsSettingsResponseBody.prototype, "invoice", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=is_primary_account" }),
        __metadata("design:type", Boolean)
    ], UpsSettingsResponseBody.prototype, "isPrimaryAccount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mail_innovations_cost_center" }),
        __metadata("design:type", String)
    ], UpsSettingsResponseBody.prototype, "mailInnovationsCostCenter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mail_innovations_endorsement" }),
        __metadata("design:type", String)
    ], UpsSettingsResponseBody.prototype, "mailInnovationsEndorsement", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=nickname" }),
        __metadata("design:type", String)
    ], UpsSettingsResponseBody.prototype, "nickname", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=pickup_type" }),
        __metadata("design:type", String)
    ], UpsSettingsResponseBody.prototype, "pickupType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=use_carbon_neutral_shipping_program" }),
        __metadata("design:type", Boolean)
    ], UpsSettingsResponseBody.prototype, "useCarbonNeutralShippingProgram", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=use_consolidation_services" }),
        __metadata("design:type", Boolean)
    ], UpsSettingsResponseBody.prototype, "useConsolidationServices", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=use_ground_freight_pricing" }),
        __metadata("design:type", Boolean)
    ], UpsSettingsResponseBody.prototype, "useGroundFreightPricing", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=use_negotiated_rates" }),
        __metadata("design:type", Boolean)
    ], UpsSettingsResponseBody.prototype, "useNegotiatedRates", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=use_order_number_on_mail_innovations_labels" }),
        __metadata("design:type", Boolean)
    ], UpsSettingsResponseBody.prototype, "useOrderNumberOnMailInnovationsLabels", void 0);
    return UpsSettingsResponseBody;
}(utils_1.SpeakeasyBase));
exports.UpsSettingsResponseBody = UpsSettingsResponseBody;
