...
import org.openapis.openapi.models.operations.RsbycRequest;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            RsbycRequest req = new RsbycRequest() {{
                security = new RsbycSecurity() {{
            ...
            RsbycResponse res = sdk.apIs.rsbyc(req);
