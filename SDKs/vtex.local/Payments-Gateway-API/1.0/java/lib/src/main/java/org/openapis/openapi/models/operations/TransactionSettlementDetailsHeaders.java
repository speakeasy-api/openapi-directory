...
public class TransactionSettlementDetailsHeaders {
    /**
    ...
    public TransactionSettlementDetailsHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public TransactionSettlementDetailsHeaders withContentType(String contentType) {
    ...
    public TransactionSettlementDetailsHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public TransactionSettlementDetailsHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
