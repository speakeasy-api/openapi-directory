...
exports.ByUsage = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var ByUsage = /** @class */ (function () {
    function ByUsage(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return metrics for organization's top 10 clients by data usage (in mb) over given time range.
     */
    ByUsage.prototype.getOrganizationSummaryTopClientsByUsage = function (req, config) {
     ...
     * Return metrics for organization's top clients by data usage (in mb) over given time range, grouped by manufacturer.
     */
    ByUsage.prototype.getOrganizationSummaryTopClientsManufacturersByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
     ...
     */
    ByUsage.prototype.getOrganizationSummaryTopDevicesByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    ByUsage.prototype.getOrganizationSummaryTopDevicesModelsByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    ByUsage.prototype.getOrganizationSummaryTopSsidsByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
