...
type UpdateSourceServerReplicationTypeHeaders struct {
...
type UpdateSourceServerReplicationTypeRequest struct {
	Headers UpdateSourceServerReplicationTypeHeaders
	Request UpdateSourceServerReplicationTypeRequestBody `request:"mediaType=application/json"`
}
