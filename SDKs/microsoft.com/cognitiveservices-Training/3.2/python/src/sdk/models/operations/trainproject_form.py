...
class TrainProjectFormTrainingTypeEnum(str, Enum):
...
class TrainProjectFormRequest:
    ...
    training_parameters: Optional[shared_trainingparameters.TrainingParameters] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
    r"""Additional training parameters passed in to control how the project is trained."""  
    training_type: Optional[TrainProjectFormTrainingTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'trainingType', 'style': 'form', 'explode': True }})
    r"""The type of training to use to train the project (default: Regular)."""  
    

@dataclasses.dataclass
class TrainProjectFormResponse:
