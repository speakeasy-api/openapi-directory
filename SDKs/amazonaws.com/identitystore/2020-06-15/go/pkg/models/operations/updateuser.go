...
const (
	UpdateUserXAmzTargetEnumAwsIdentityStoreUpdateUser UpdateUserXAmzTargetEnum = "AWSIdentityStore.UpdateUser"
)
...
func (e *UpdateUserXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "AWSIdentityStore.UpdateUser":
...
type UpdateUserResponse struct {
	...
	// Success
	UpdateUserResponse map[string]interface{}
	// ValidationException
