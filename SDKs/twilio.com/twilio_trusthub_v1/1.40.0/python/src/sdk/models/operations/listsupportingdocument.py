...
class ListSupportingDocumentListSupportingDocumentResponse:
    ...
    results: Optional[list[shared_trusthub_v1_supporting_document.TrusthubV1SupportingDocument]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
