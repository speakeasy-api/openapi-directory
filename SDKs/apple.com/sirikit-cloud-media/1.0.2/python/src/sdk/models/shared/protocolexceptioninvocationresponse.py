...
from ..shared import protocolexception as shared_protocolexception
...
class ProtocolExceptionInvocationResponse:
    exception: shared_protocolexception.ProtocolException = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('exception') }})
