...
export class BaremetalsolutionProjectsLocationsNfsSharesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BaremetalsolutionProjectsLocationsNfsSharesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BaremetalsolutionProjectsLocationsNfsSharesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
