...
export declare class DetectImageUrlWithNoStoreRawRequest extends SpeakeasyBase {
    /**
...
export declare class DetectImageUrlWithNoStoreRawResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    /**
     * Error response
