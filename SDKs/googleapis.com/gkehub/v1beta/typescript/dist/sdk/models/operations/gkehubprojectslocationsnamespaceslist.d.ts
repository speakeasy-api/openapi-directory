...
export declare class GkehubProjectsLocationsNamespacesListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class GkehubProjectsLocationsNamespacesListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class GkehubProjectsLocationsNamespacesListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
