 ...
 * *Conditional*
**/
var StoryResponseDates = /** @class */ (function (_super) {
    __extends(StoryResponseDates, _super);
    function StoryResponseDates() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=due_at" }),
        __metadata("design:type", Date)
    ], StoryResponseDates.prototype, "dueAt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=due_on" }),
        __metadata("design:type", Date)
    ], StoryResponseDates.prototype, "dueOn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=start_on" }),
        __metadata("design:type", Date)
    ], StoryResponseDates.prototype, "startOn", void 0);
