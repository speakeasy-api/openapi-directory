...
export class CloudidentityDevicesDeviceUsersBlockSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudidentityDevicesDeviceUsersBlockRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
  ...
  blockDeviceUserRequest?: shared.BlockDeviceUserRequest;
...
export class CloudidentityDevicesDeviceUsersBlockResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
