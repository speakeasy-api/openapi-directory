...
public enum VcenterSummaryConflictResolutionAuthzEnum {
    ...
    private VcenterSummaryConflictResolutionAuthzEnum(String value) {
        this.value = value;
    }
}
