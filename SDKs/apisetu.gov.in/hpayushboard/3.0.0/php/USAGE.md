...
use \OpenAPI\OpenAPI\Models\Operations\PhcerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\PhcerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\PhcerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\PhcerSecurity;
...
try {
    ...
    $request->certificateParameters = new PhcerRequestBodyCertificateParameters();
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->registrationNo = '0101-I';
    ...
    $request->format = PhcerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new PhcerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->phcer($request, $requestSecurity);
