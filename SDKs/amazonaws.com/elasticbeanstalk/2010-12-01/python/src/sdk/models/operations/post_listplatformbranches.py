...
class PostListPlatformBranchesQueryParams:
    action: PostListPlatformBranchesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostListPlatformBranchesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostListPlatformBranchesRequest:
    headers: PostListPlatformBranchesHeaders = dataclasses.field()
    query_params: PostListPlatformBranchesQueryParams = dataclasses.field()
