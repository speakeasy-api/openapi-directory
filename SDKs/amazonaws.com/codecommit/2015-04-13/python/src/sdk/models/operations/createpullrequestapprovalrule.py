...
class CreatePullRequestApprovalRuleRequest:
    headers: CreatePullRequestApprovalRuleHeaders = dataclasses.field()
    request: shared_createpullrequestapprovalruleinput.CreatePullRequestApprovalRuleInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
