...
class ListImportsResponse:
    ...
    import_summaries: Optional[list[shared_importsummary.ImportSummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('importSummaries'), 'exclude': lambda f: f is None }})  
