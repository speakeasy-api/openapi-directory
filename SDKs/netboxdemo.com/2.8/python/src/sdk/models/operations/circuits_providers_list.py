...
class CircuitsProvidersListQueryParams:
    ...
    account_ic: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'account__ic', 'style': 'form', 'explode': True }})
    account_ie: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'account__ie', 'style': 'form', 'explode': True }})
    account_iew: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'account__iew', 'style': 'form', 'explode': True }})
    account_isw: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'account__isw', 'style': 'form', 'explode': True }})
    account_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'account__n', 'style': 'form', 'explode': True }})
    account_nic: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'account__nic', 'style': 'form', 'explode': True }})
    account_nie: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'account__nie', 'style': 'form', 'explode': True }})
    account_niew: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'account__niew', 'style': 'form', 'explode': True }})
    account_nisw: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'account__nisw', 'style': 'form', 'explode': True }})
