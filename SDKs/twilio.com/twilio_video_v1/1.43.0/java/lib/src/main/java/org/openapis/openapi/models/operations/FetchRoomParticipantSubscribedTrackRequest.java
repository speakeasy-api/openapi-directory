...
public class FetchRoomParticipantSubscribedTrackRequest {
    ...
    public FetchRoomParticipantSubscribedTrackRequest(@JsonProperty("ParticipantSid") String participantSid, @JsonProperty("RoomSid") String roomSid, @JsonProperty("Sid") String sid) {
        this.participantSid = participantSid;
        this.roomSid = roomSid;
        this.sid = sid;
  }
