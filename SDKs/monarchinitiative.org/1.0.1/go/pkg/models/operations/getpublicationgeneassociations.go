...
type GetPublicationGeneAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetPublicationGeneAssociationsQueryParams struct {
