...
class ListSyncSyncMapPermissionListSyncSyncMapPermissionResponse:
    ...
    meta: Optional[ListSyncSyncMapPermissionListSyncSyncMapPermissionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    permissions: Optional[list[shared_preview_sync_service_sync_map_sync_map_permission.PreviewSyncServiceSyncMapSyncMapPermission]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('permissions'), 'exclude': lambda f: f is None }})  
