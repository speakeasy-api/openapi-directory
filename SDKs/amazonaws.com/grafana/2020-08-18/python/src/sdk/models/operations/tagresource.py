...
class TagResourceRequestBody:
    ...
    r"""The list of tag keys and values to associate with the resource. You can associate tag keys only, tags (key and values) only or a combination of tag keys and tags."""  
...
class TagResourceRequest:
    ...
    r"""The ARN of the resource the tag is associated with."""  
