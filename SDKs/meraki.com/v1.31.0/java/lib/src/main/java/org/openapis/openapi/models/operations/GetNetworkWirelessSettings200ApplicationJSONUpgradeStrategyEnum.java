 ...
 */
public enum GetNetworkWirelessSettings200ApplicationJSONUpgradeStrategyEnum {
    ...
    private GetNetworkWirelessSettings200ApplicationJSONUpgradeStrategyEnum(String value) {
        this.value = value;
    }
}
