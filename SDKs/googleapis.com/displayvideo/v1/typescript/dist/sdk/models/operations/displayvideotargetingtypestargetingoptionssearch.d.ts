...
export declare class DisplayvideoTargetingTypesTargetingOptionsSearchSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
/**
 ...
 */
export declare enum DisplayvideoTargetingTypesTargetingOptionsSearchTargetingTypeEnum {
...
export declare class DisplayvideoTargetingTypesTargetingOptionsSearchRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class DisplayvideoTargetingTypesTargetingOptionsSearchResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
