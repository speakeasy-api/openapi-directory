...
exports.Softwares = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var Softwares = /** @class */ (function () {
    function Softwares(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Softwares.prototype.getNetworkSmDeviceSoftwares = function (req, config) {
    ...
    **/
    Softwares.prototype.getNetworkSmUserSoftwares = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
