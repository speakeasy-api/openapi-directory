...
type DataplexProjectsLocationsLakesContentitemsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DataplexProjectsLocationsLakesContentitemsListPathParams struct {
	// Required. The resource name of the parent lake: projects/{project_id}/locations/{location_id}/lakes/{lake_id}
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type DataplexProjectsLocationsLakesContentitemsListQueryParams struct {
	// V1 error format.
...
type DataplexProjectsLocationsLakesContentitemsListRequest struct {
...
type DataplexProjectsLocationsLakesContentitemsListResponse struct {
	ContentType string
	// Successful response
