...
public class LinkTokenCreateRequest {
    ...
    public LinkTokenCreateRequest(@JsonProperty("client_name") String clientName, @JsonProperty("country_codes") CountryCodeEnum[] countryCodes, @JsonProperty("language") String language, @JsonProperty("user") LinkTokenCreateRequestUser user) {
        this.clientName = clientName;
        this.countryCodes = countryCodes;
        this.language = language;
        this.user = user;
