...
public class Collections {
     ...
     */
    public org.openapis.openapi.models.operations.CollectionsAllResponse collectionsAll(org.openapis.openapi.models.operations.CollectionsAllRequest request, org.openapis.openapi.models.operations.CollectionsAllSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/issue-tracking/collections");
        ...
        org.openapis.openapi.models.operations.CollectionsAllResponse res = new org.openapis.openapi.models.operations.CollectionsAllResponse() {{
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.CollectionsOneResponse collectionsOne(org.openapis.openapi.models.operations.CollectionsOneRequest request, org.openapis.openapi.models.operations.CollectionsOneSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.CollectionsOneRequest.class, baseUrl, "/issue-tracking/collections/{collection_id}", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.CollectionsOneRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.CollectionsOneResponse res = new org.openapis.openapi.models.operations.CollectionsOneResponse() {{
