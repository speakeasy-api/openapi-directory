...
class InsertAddressesforSubscriptionRequest:
    ...
    additional_components: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalComponents') }})  
    ...
    geo_coordinate: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('geoCoordinate') }})  
