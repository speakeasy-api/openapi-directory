...
class RemoveDependentsForTaskRequestBody:
    r"""The list of tasks to remove as dependents."""
...
class RemoveDependentsForTaskRequest:
    ...
    request_body: RemoveDependentsForTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The list of tasks to remove as dependents."""  
...
class RemoveDependentsForTask200ApplicationJSON:
    r"""Successfully unlinked the specified tasks as dependents."""
