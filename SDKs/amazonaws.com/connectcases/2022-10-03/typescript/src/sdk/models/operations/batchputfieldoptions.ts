...
export class BatchPutFieldOptionsRequestBody extends SpeakeasyBase {
  /**
   * A list of <code>FieldOption</code> objects.
   */
  @SpeakeasyMetadata({ elemType: shared.FieldOption })
  @Expose({ name: "options" })
  @Type(() => shared.FieldOption)
  options: shared.FieldOption[];
}

export class BatchPutFieldOptionsRequest extends SpeakeasyBase {
