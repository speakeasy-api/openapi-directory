...
class POSTUploadFileForCreditMemoRequestBody:
    ...
    r"""The PDF file to upload for the credit memo."""  
...
class POSTUploadFileForCreditMemoRequest:
    ...
    r"""The ID of the credit memo that you want to upload a PDF file for. For example, 402890555a7e9791015a879f064a0054."""  
    request_body: Optional[POSTUploadFileForCreditMemoRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})  
