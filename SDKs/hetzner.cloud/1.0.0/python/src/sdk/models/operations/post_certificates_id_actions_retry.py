...
class PostCertificatesIDActionsRetryActionResponseAction:
    ...
    error: PostCertificatesIDActionsRetryActionResponseActionError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    r"""Error message for the Action if error occurred, otherwise null"""  
    ...
    resources: list[PostCertificatesIDActionsRetryActionResponseActionResources] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources') }})
    ...
    status: PostCertificatesIDActionsRetryActionResponseActionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Status of the Action"""  
...
class PostCertificatesIDActionsRetryActionResponse:
    r"""The `action` key contains the resulting Action"""
    
    action: PostCertificatesIDActionsRetryActionResponseAction = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action') }})  
