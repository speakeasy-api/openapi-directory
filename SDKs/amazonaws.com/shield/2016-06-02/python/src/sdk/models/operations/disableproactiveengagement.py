...
class DisableProactiveEngagementHeaders:
    x_amz_target: DisableProactiveEngagementXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisableProactiveEngagementRequest:
    headers: DisableProactiveEngagementHeaders = dataclasses.field()
...
class DisableProactiveEngagementResponse:
    ...
    disable_proactive_engagement_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
