...
@dataclasses.dataclass
class ListAccountSecretRequest:
...
@dataclasses.dataclass
class ListAccountSecretListAccountSecretResponseMeta:
...
class ListAccountSecretListAccountSecretResponse:
    ...
    meta: Optional[ListAccountSecretListAccountSecretResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    secrets: Optional[list[shared_microvisor_v1_account_secret.MicrovisorV1AccountSecret]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('secrets'), 'exclude': lambda f: f is None }})  
...
class ListAccountSecretResponse:
    ...
    list_account_secret_response: Optional[ListAccountSecretListAccountSecretResponse] = dataclasses.field(default=None)
    r"""OK"""  
