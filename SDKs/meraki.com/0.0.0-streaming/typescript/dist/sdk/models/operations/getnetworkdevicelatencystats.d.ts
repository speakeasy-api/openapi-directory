 ...
 */
export declare enum GetNetworkDeviceLatencyStatsBandEnum {
    Two4 = "2.4",
    Five = "5"
}
export declare class GetNetworkDeviceLatencyStatsRequest extends SpeakeasyBase {
    /**
...
export declare class GetNetworkDeviceLatencyStatsResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
