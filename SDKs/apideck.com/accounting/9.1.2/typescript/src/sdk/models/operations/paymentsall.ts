...
export class PaymentsAllSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PaymentsAllRequest extends SpeakeasyBase {
  /**
...
export class PaymentsAllResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
