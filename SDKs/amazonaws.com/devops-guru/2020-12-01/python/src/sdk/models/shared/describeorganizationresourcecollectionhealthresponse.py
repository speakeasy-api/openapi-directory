...
import dataclasses
from ..shared import accounthealth as shared_accounthealth
...
class DescribeOrganizationResourceCollectionHealthResponse:
    ...
    account: Optional[list[shared_accounthealth.AccountHealth]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Account'), 'exclude': lambda f: f is None }})  
