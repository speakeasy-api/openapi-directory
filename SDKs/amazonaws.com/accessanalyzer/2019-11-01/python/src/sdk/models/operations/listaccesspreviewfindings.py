...
class ListAccessPreviewFindingsRequestBody:
    ...
    r"""The <a href=\\"https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources\\">ARN of the analyzer</a> used to generate the access."""  
    ...
    r"""Criteria to filter the returned findings."""  
...
class ListAccessPreviewFindingsRequest:
    ...
    request_body: ListAccessPreviewFindingsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
