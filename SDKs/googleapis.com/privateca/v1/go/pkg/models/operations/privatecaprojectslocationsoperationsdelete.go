...
type PrivatecaProjectsLocationsOperationsDeleteRequest struct {
	...
	IgnoreDependentResources *bool `queryParam:"style=form,explode=true,name=ignoreDependentResources"`
	...
	SkipGracePeriod *bool `queryParam:"style=form,explode=true,name=skipGracePeriod"`
