...
public class IssueComment {
    ...
    public IssueComment withPerformedViaGithubApp(java.util.Map<String, Object> performedViaGithubApp) {
    ...
    @JsonProperty("user")
    public IssueCommentSimpleUser user;
    public IssueComment withUser(IssueCommentSimpleUser user) {
        this.user = user;
        return this;
    }
}