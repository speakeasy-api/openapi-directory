...
// addressSearch - Global address autocomplete, for search-as-you-type
...
func newAddressSearch(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *addressSearch {
...
func (s *addressSearch) AddressAutocomplete(ctx context.Context, request operations.AddressAutocompleteRequest) (*operations.AddressAutocompleteResponse, error) {
	baseURL := s.serverURL
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.AutocompleteResponse
...
func (s *addressSearch) Resolve(ctx context.Context, request operations.ResolveRequest) (*operations.ResolveResponse, error) {
	...
	res := &operations.ResolveResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GbrResolveAddressResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *addressSearch) ResolveUsa(ctx context.Context, request operations.ResolveUsaRequest) (*operations.ResolveUsaResponse, error) {
	...
	res := &operations.ResolveUsaResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.UsaResolveAddressResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
