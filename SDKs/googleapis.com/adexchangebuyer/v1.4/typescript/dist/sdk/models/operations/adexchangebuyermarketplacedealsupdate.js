...
exports.AdexchangebuyerMarketplacedealsUpdateResponse = exports.AdexchangebuyerMarketplacedealsUpdateRequest = exports.AdexchangebuyerMarketplacedealsUpdateSecurity = void 0;
...
var AdexchangebuyerMarketplacedealsUpdateRequest = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerMarketplacedealsUpdateRequest.prototype, "editAllOrderDealsRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsUpdateRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsUpdateRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsUpdateRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsUpdateRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdexchangebuyerMarketplacedealsUpdateRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=proposalId",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsUpdateRequest.prototype, "proposalId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsUpdateRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsUpdateRequest.prototype, "userIp", void 0);
...
var AdexchangebuyerMarketplacedealsUpdateResponse = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerMarketplacedealsUpdateResponse.prototype, "rawResponse", void 0);
