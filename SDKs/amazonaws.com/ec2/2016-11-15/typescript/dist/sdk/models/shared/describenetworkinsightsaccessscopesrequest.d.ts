 ...
 */
export declare class DescribeNetworkInsightsAccessScopesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeNetworkInsightsAccessScopesRequest extends SpeakeasyBase {
    dryRun?: boolean;
