...
class GetRecommendationSummariesRequest:
    ...
    get_recommendation_summaries_request: shared_getrecommendationsummariesrequest.GetRecommendationSummariesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
