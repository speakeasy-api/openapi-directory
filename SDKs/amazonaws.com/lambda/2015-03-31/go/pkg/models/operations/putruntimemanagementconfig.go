...
type PutRuntimeManagementConfigHeaders struct {
...
type PutRuntimeManagementConfigRequest struct {
	PathParams  PutRuntimeManagementConfigPathParams
	QueryParams PutRuntimeManagementConfigQueryParams
	Headers     PutRuntimeManagementConfigHeaders
	Request     PutRuntimeManagementConfigRequestBody `request:"mediaType=application/json"`
}
