...
public class UpdateInventoryForAnItemHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public UpdateInventoryForAnItemHeaders withAuthorization(String authorization) {
    ...
    public UpdateInventoryForAnItemHeaders withWmConsumerChannelType(String wmCONSUMERCHANNELTYPE) {
    ...
    public UpdateInventoryForAnItemHeaders withWmQosCorrelationId(String wmQOSCORRELATIONID) {
    ...
    public UpdateInventoryForAnItemHeaders withWmSecAccessToken(String wmSECACCESSTOKEN) {
    ...
    public UpdateInventoryForAnItemHeaders withWmSvcName(String wmSVCNAME) {
