...
class CreateTrailRequest:
    r"""Specifies the settings for each trail."""
    ...
    enable_log_file_validation: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EnableLogFileValidation'), 'exclude': lambda f: f is None }})  
