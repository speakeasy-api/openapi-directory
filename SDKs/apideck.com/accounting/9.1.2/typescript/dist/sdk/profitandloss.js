...
exports.ProfitAndLoss = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var shared = __importStar(require("./models/shared"));
var ProfitAndLoss = /** @class */ (function () {
    function ProfitAndLoss(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Get Profit and Loss
     */
    ProfitAndLoss.prototype.profitAndLossOne = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ProfitAndLossOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/accounting/profit-and-loss";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.ProfitAndLossOneResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getProfitAndLossResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetProfitAndLossResponse);
                    }
                    break;
