...
class GetPutRolePolicyQueryParams:
    action: GetPutRolePolicyActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetPutRolePolicyVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetPutRolePolicyRequest:
    headers: GetPutRolePolicyHeaders = dataclasses.field()
    query_params: GetPutRolePolicyQueryParams = dataclasses.field()
