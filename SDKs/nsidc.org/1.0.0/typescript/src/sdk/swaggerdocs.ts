...
export class SwaggerDocs {
  ...
  facets(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.FacetsResponse = new operations.FacetsResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            utils.matchContentType(contentType, `application/nsidcfacets+xml`)
          ) {
            res.facets200ApplicationNsidcfacetsPlusXmlString = JSON.stringify(
              httpRes?.data
            );
          }
          break;
  ...
  id(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.IdResponse = new operations.IdResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.id200ApplicationXSuggestionsPlusJsonString = JSON.stringify(
              httpRes?.data
            );
          }
          break;
  ...
  openSearch(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.OpenSearchResponse =
        new operations.OpenSearchResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/atom+xml`)) {
            res.openSearch200ApplicationAtomPlusXmlString = JSON.stringify(
              httpRes?.data
            );
          }
          break;
  ...
  opensearchDescription(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.OpensearchDescriptionResponse =
        new operations.OpensearchDescriptionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
