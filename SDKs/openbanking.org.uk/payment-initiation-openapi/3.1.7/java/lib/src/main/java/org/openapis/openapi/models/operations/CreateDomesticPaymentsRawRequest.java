...
public class CreateDomesticPaymentsRawRequest {
    ...
    public CreateDomesticPaymentsRawRequest withAuthorization(String authorization) {
    ...
    public CreateDomesticPaymentsRawRequest withRequestBody(byte[] requestBody) {
    ...
    public CreateDomesticPaymentsRawRequest withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticPaymentsRawRequest withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticPaymentsRawRequest withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateDomesticPaymentsRawRequest withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateDomesticPaymentsRawRequest withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticPaymentsRawRequest withXJwsSignature(String xJwsSignature) {
        this.xJwsSignature = xJwsSignature;
        return this;
    }
    
    public CreateDomesticPaymentsRawRequest(@JsonProperty("Authorization") String authorization, @JsonProperty("RequestBody") byte[] requestBody, @JsonProperty("x-idempotency-key") String xIdempotencyKey, @JsonProperty("x-jws-signature") String xJwsSignature) {
        this.authorization = authorization;
        this.requestBody = requestBody;
        this.xIdempotencyKey = xIdempotencyKey;
        this.xJwsSignature = xJwsSignature;
