...
exports.PostCustomFieldsIdSelectOptionsJsonResponse = exports.PostCustomFieldsIdSelectOptionsJsonRequest = void 0;
...
var PostCustomFieldsIdSelectOptionsJsonRequest = /** @class */ (function (_super) {
    ...
    ], PostCustomFieldsIdSelectOptionsJsonRequest.prototype, "customFieldSelectOptionEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PostCustomFieldsIdSelectOptionsJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], PostCustomFieldsIdSelectOptionsJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PostCustomFieldsIdSelectOptionsJsonRequest.prototype, "login", void 0);
    return PostCustomFieldsIdSelectOptionsJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PostCustomFieldsIdSelectOptionsJsonRequest = PostCustomFieldsIdSelectOptionsJsonRequest;
var PostCustomFieldsIdSelectOptionsJsonResponse = /** @class */ (function (_super) {
    ...
    ], PostCustomFieldsIdSelectOptionsJsonResponse.prototype, "rawResponse", void 0);
    return PostCustomFieldsIdSelectOptionsJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PostCustomFieldsIdSelectOptionsJsonResponse = PostCustomFieldsIdSelectOptionsJsonResponse;
