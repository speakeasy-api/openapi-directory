...
from ..shared import listsoprecommendationsresponse as shared_listsoprecommendationsresponse
...
class ListSopRecommendationsRequest:
    ...
    request_body: ListSopRecommendationsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListSopRecommendationsResponse:
    ...
    list_sop_recommendations_response: Optional[shared_listsoprecommendationsresponse.ListSopRecommendationsResponse] = dataclasses.field(default=None)
    r"""Success"""  
