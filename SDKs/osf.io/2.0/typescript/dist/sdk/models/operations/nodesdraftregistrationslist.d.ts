...
export declare class NodesDraftRegistrationsListRequest extends SpeakeasyBase {
    /**
     * The unique identifier of the node.
     */
    nodeId: string;
}
export declare class NodesDraftRegistrationsListDraftRegistrationAttributesNodeLicense extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodesDraftRegistrationsListDraftRegistrationAttributes extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodesDraftRegistrationsListDraftRegistrationLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodesDraftRegistrationsListDraftRegistrationRelationships extends SpeakeasyBase {
    /**
...
export declare class NodesDraftRegistrationsListDraftRegistration extends SpeakeasyBase {
    /**
     * The properties of the Draft Registration entity.
     */
...
export declare class NodesDraftRegistrationsListResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
