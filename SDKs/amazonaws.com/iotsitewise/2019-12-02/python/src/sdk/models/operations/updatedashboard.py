...
class UpdateDashboardRequest:
    headers: UpdateDashboardHeaders = dataclasses.field()
    path_params: UpdateDashboardPathParams = dataclasses.field()
    request: UpdateDashboardRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
