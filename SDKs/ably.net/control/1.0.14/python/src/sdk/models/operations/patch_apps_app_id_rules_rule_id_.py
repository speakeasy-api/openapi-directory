...
from ..shared import http_rule_patch as shared_http_rule_patch
from ..shared import zapier_rule_patch as shared_zapier_rule_patch
from ..shared import cloudflare_worker_rule_patch as shared_cloudflare_worker_rule_patch
from ..shared import azure_function_rule_patch as shared_azure_function_rule_patch
from ..shared import google_cloud_function_rule_patch as shared_google_cloud_function_rule_patch
from ..shared import aws_lambda_rule_patch as shared_aws_lambda_rule_patch
from ..shared import aws_kinesis_rule_patch as shared_aws_kinesis_rule_patch
from ..shared import aws_sqs_rule_patch as shared_aws_sqs_rule_patch
from ..shared import amqp_rule_patch as shared_amqp_rule_patch
from ..shared import amqp_external_rule_patch as shared_amqp_external_rule_patch
...
class PatchAppsAppIDRulesRuleIDRequest:
    path_params: PatchAppsAppIDRulesRuleIDPathParams = dataclasses.field()
    security: PatchAppsAppIDRulesRuleIDSecurity = dataclasses.field()
