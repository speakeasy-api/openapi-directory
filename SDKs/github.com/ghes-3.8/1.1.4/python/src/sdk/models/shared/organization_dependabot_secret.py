...
class OrganizationDependabotSecretVisibilityEnum(str, Enum):
...
class OrganizationDependabotSecret:
    r"""Secrets for GitHub Dependabot for an organization."""
    ...
    visibility: OrganizationDependabotSecretVisibilityEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('visibility') }})
    r"""Visibility of a secret"""  
