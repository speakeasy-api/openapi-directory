...
class SubscribeToDatasetPathParams:
...
@dataclasses.dataclass
class SubscribeToDatasetHeaders:
...
class SubscribeToDatasetRequest:
    headers: SubscribeToDatasetHeaders = dataclasses.field()
    path_params: SubscribeToDatasetPathParams = dataclasses.field()
