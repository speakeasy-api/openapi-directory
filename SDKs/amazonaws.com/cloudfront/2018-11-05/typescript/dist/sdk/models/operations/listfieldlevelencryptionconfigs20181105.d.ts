...
export declare class ListFieldLevelEncryptionConfigs20181105Request extends SpeakeasyBase {
    /**
...
export declare class ListFieldLevelEncryptionConfigs20181105Response extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
