...
// CreateNetworkFirmwareUpgradesStagedEventRequestBodyProductsSwitchNextUpgradeToVersion - The version to be updated to for switch devices
...
func (e CreateNetworkFirmwareUpgradesStagedEvent200ApplicationJSONReasonsCategoryEnum) ToPointer() *CreateNetworkFirmwareUpgradesStagedEvent200ApplicationJSONReasonsCategoryEnum {
	return &e
}
...
func (e *CreateNetworkFirmwareUpgradesStagedEvent200ApplicationJSONReasonsCategoryEnum) UnmarshalJSON(data []byte) error {
	...
	case "unifying networks versions":
		*e = CreateNetworkFirmwareUpgradesStagedEvent200ApplicationJSONReasonsCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkFirmwareUpgradesStagedEvent200ApplicationJSONReasonsCategoryEnum: %v", v)
	}
}
