...
type GetResourceEvaluationSummaryHeaders struct {
...
type GetResourceEvaluationSummaryRequest struct {
	Headers GetResourceEvaluationSummaryHeaders
	Request shared.GetResourceEvaluationSummaryRequest `request:"mediaType=application/json"`
}
