...
func (e DeletedNodeSummaryTypeEnum) ToPointer() *DeletedNodeSummaryTypeEnum {
	return &e
}
...
func (e *DeletedNodeSummaryTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "folder":
		fallthrough
	case "file":
		*e = DeletedNodeSummaryTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DeletedNodeSummaryTypeEnum: %v", v)
	}
}
