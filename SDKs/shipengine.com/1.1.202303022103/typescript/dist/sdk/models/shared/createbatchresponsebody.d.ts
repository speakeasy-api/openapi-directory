 ...
 *
 */
export declare enum CreateBatchResponseBodyLabelFormatEnum {
    Pdf = "pdf",
    Png = "png",
    Zpl = "zpl"
}
 ...
 *
 */
export declare enum CreateBatchResponseBodyLabelLayoutEnum {
    Fourx6 = "4x6",
    Letter = "letter"
}
/**
 ...
 */
export declare enum CreateBatchResponseBodyBatchStatusEnum {
    Open = "open",
    Queued = "queued",
...
export declare class CreateBatchResponseBody extends SpeakeasyBase {
    ...
    labelFormat: CreateBatchResponseBodyLabelFormatEnum;
    /**
     * label layout
     */
    labelLayout: CreateBatchResponseBodyLabelLayoutEnum;
    /**
     * The date and time the batch was processed in ShipEngine
     */
    processedAt: Date;
    status: CreateBatchResponseBodyBatchStatusEnum;
    /**
