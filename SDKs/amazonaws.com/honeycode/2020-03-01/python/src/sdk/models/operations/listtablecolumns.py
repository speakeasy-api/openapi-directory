...
from ..shared import listtablecolumnsresult as shared_listtablecolumnsresult
...
class ListTableColumnsRequest:
    headers: ListTableColumnsHeaders = dataclasses.field()
    path_params: ListTableColumnsPathParams = dataclasses.field()
    query_params: ListTableColumnsQueryParams = dataclasses.field()
...
class ListTableColumnsResponse:
    ...
    list_table_columns_result: Optional[shared_listtablecolumnsresult.ListTableColumnsResult] = dataclasses.field(default=None)
