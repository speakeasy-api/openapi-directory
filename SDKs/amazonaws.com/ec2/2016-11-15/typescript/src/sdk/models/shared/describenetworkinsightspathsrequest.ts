 ...
 */
export class DescribeNetworkInsightsPathsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeNetworkInsightsPathsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeNetworkInsightsPathsRequestFilters })
