...
class SearchProjectSurveylocationQueryParams:
...
@dataclasses.dataclass
class SearchProjectSurveylocationRequest:
    query_params: SearchProjectSurveylocationQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectSurveylocationResponse:
