...
// https://docs.github.com/enterprise-server@3.8/rest/reference/checks#create-a-check-run - API method documentation
...
// https://docs.github.com/enterprise-server@3.8/rest/reference/checks#create-a-check-suite - API method documentation
...
// https://docs.github.com/enterprise-server@3.8/rest/reference/checks#get-a-check-run - API method documentation
...
// https://docs.github.com/enterprise-server@3.8/rest/reference/checks#get-a-check-suite - API method documentation
...
// https://docs.github.com/enterprise-server@3.8/rest/reference/checks#list-check-run-annotations - API method documentation
...
// https://docs.github.com/enterprise-server@3.8/rest/reference/checks#list-check-runs-for-a-git-reference - API method documentation
...
// https://docs.github.com/enterprise-server@3.8/rest/reference/checks#list-check-runs-in-a-check-suite - API method documentation
...
// https://docs.github.com/enterprise-server@3.8/rest/reference/checks#list-check-suites-for-a-git-reference - API method documentation
...
// https://docs.github.com/enterprise-server@3.8/rest/reference/checks#rerequest-a-check-run - API method documentation
...
// https://docs.github.com/enterprise-server@3.8/rest/reference/checks#rerequest-a-check-suite - API method documentation
...
// https://docs.github.com/enterprise-server@3.8/rest/reference/checks#update-repository-preferences-for-check-suites - API method documentation
...
// https://docs.github.com/enterprise-server@3.8/rest/reference/checks#update-a-check-run - API method documentation
