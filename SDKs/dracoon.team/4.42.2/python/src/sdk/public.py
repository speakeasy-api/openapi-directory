...
class Public:
    ...
    def cancel_file_upload_via_share(self, request: operations.CancelFileUploadViaShareRequest) -> operations.CancelFileUploadViaShareResponse:
        ...
        url = utils.generate_url(operations.CancelFileUploadViaShareRequest, base_url, '/v4/public/shares/uploads/{access_key}/{upload_id}', request)
        ...
        res = operations.CancelFileUploadViaShareResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 204:
            pass
        elif http_res.status_code in [400, 404, 406, 504, 507]:
    ...
    def check_public_download_share_password(self, request: operations.CheckPublicDownloadSharePasswordRequest) -> operations.CheckPublicDownloadSharePasswordResponse:
        r"""Check public Download Share password
        ...
        url = utils.generate_url(operations.CheckPublicDownloadSharePasswordRequest, base_url, '/v4/public/shares/downloads/{access_key}', request)
        
        query_params = utils.get_query_params(operations.CheckPublicDownloadSharePasswordRequest, request)
        ...
        res = operations.CheckPublicDownloadSharePasswordResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def complete_file_upload_via_share(self, request: operations.CompleteFileUploadViaShareRequest) -> operations.CompleteFileUploadViaShareResponse:
        ...
        url = utils.generate_url(operations.CompleteFileUploadViaShareRequest, base_url, '/v4/public/shares/uploads/{access_key}/{upload_id}', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "user_file_key_list", 'json')
        ...
        res = operations.CompleteFileUploadViaShareResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code in [201, 202]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PublicUploadedFileData])
                res.public_uploaded_file_data = out
        elif http_res.status_code in [400, 403, 404, 406, 412, 504, 507]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def complete_s3_file_upload_via_share(self, request: operations.CompleteS3FileUploadViaShareRequest) -> operations.CompleteS3FileUploadViaShareResponse:
        ...
        url = utils.generate_url(operations.CompleteS3FileUploadViaShareRequest, base_url, '/v4/public/shares/uploads/{access_key}/{upload_id}/s3', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "complete_s3_share_upload_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        ...
        res = operations.CompleteS3FileUploadViaShareResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 202:
            pass
        elif http_res.status_code in [400, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def create_share_upload_channel(self, request: operations.CreateShareUploadChannelRequest) -> operations.CreateShareUploadChannelResponse:
        ...
        * Illegal characters in names:  
        ...
        url = utils.generate_url(operations.CreateShareUploadChannelRequest, base_url, '/v4/public/shares/uploads/{access_key}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "create_share_upload_channel_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateShareUploadChannelResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateShareUploadChannelResponse])
    ...
    def download_file_via_token_public(self, request: operations.DownloadFileViaTokenPublicRequest) -> operations.DownloadFileViaTokenPublicResponse:
        ...
        url = utils.generate_url(operations.DownloadFileViaTokenPublicRequest, base_url, '/v4/public/shares/downloads/{access_key}/{token}', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.DownloadFileViaTokenPublicRequest, request)
        ...
        res = operations.DownloadFileViaTokenPublicResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code in [200, 206]:
            pass
        elif http_res.status_code in [400, 404, 406, 416]:
    ...
    def download_file_via_token_public_1(self, request: operations.DownloadFileViaTokenPublic1Request) -> operations.DownloadFileViaTokenPublic1Response:
        ...
        url = utils.generate_url(operations.DownloadFileViaTokenPublic1Request, base_url, '/v4/public/shares/downloads/{access_key}/{token}', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.DownloadFileViaTokenPublic1Request, request)
        ...
        res = operations.DownloadFileViaTokenPublic1Response(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def generate_download_url_public(self, request: operations.GenerateDownloadURLPublicRequest) -> operations.GenerateDownloadURLPublicResponse:
        ...
        url = utils.generate_url(operations.GenerateDownloadURLPublicRequest, base_url, '/v4/public/shares/downloads/{access_key}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "public_download_token_generate_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        ...
        res = operations.GenerateDownloadURLPublicResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PublicDownloadTokenGenerateResponse])
    ...
    def generate_presigned_urls_public(self, request: operations.GeneratePresignedUrlsPublicRequest) -> operations.GeneratePresignedUrlsPublicResponse:
        ...
        url = utils.generate_url(operations.GeneratePresignedUrlsPublicRequest, base_url, '/v4/public/shares/uploads/{access_key}/{upload_id}/s3_urls', request)
        ...
        res = operations.GeneratePresignedUrlsPublicResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_active_directory_auth_info(self, request: operations.RequestActiveDirectoryAuthInfoRequest) -> operations.RequestActiveDirectoryAuthInfoResponse:
        ...
        query_params = utils.get_query_params(operations.RequestActiveDirectoryAuthInfoRequest, request)
        ...
        res = operations.RequestActiveDirectoryAuthInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ActiveDirectoryAuthInfo])
    ...
    def request_open_id_auth_info(self, request: operations.RequestOpenIDAuthInfoRequest) -> operations.RequestOpenIDAuthInfoResponse:
        ...
        query_params = utils.get_query_params(operations.RequestOpenIDAuthInfoRequest, request)
        ...
        res = operations.RequestOpenIDAuthInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.OpenIDAuthInfo])
    ...
    def request_public_download_share_info(self, request: operations.RequestPublicDownloadShareInfoRequest) -> operations.RequestPublicDownloadShareInfoResponse:
        ...
        url = utils.generate_url(operations.RequestPublicDownloadShareInfoRequest, base_url, '/v4/public/shares/downloads/{access_key}', request)
        ...
        res = operations.RequestPublicDownloadShareInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PublicDownloadShare])
    ...
    def request_public_upload_share_info(self, request: operations.RequestPublicUploadShareInfoRequest) -> operations.RequestPublicUploadShareInfoResponse:
        ...
        * `userUserPublicKeyList` (if parent is end-to-end encrypted)
        ...
        url = utils.generate_url(operations.RequestPublicUploadShareInfoRequest, base_url, '/v4/public/shares/uploads/{access_key}', request)
        ...
        res = operations.RequestPublicUploadShareInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PublicUploadShare])
                res.public_upload_share = out
        elif http_res.status_code in [400, 401, 404, 406]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def request_software_version(self, request: operations.RequestSoftwareVersionRequest) -> operations.RequestSoftwareVersionResponse:
        ...
        * **Core** (referred to as _\"Server\"_)
        ...
        res = operations.RequestSoftwareVersionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SoftwareVersionData])
    ...
    def request_system_info(self, request: operations.RequestSystemInfoRequest) -> operations.RequestSystemInfoResponse:
        ...
        query_params = utils.get_query_params(operations.RequestSystemInfoRequest, request)
        ...
        res = operations.RequestSystemInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SystemInfo])
                res.system_info = out
        elif http_res.status_code in [400, 406]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
    ...
    def request_system_time(self, request: operations.RequestSystemTimeRequest) -> operations.RequestSystemTimeResponse:
        ...
        res = operations.RequestSystemTimeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SdsServerTime])
    ...
    def request_third_party_dependencies(self) -> operations.RequestThirdPartyDependenciesResponse:
        ...
        res = operations.RequestThirdPartyDependenciesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.ThirdPartyDependenciesData]])
    ...
    def request_upload_status_public(self, request: operations.RequestUploadStatusPublicRequest) -> operations.RequestUploadStatusPublicResponse:
        ...
        url = utils.generate_url(operations.RequestUploadStatusPublicRequest, base_url, '/v4/public/shares/uploads/{access_key}/{upload_id}', request)
        ...
        res = operations.RequestUploadStatusPublicResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.S3ShareUploadStatus])
    ...
    def upload_file_as_multipart_public_1(self, request: operations.UploadFileAsMultipartPublic1Request) -> operations.UploadFileAsMultipartPublic1Response:
        ...
        * any other `Content-Type`  
        ...
        url = utils.generate_url(operations.UploadFileAsMultipartPublic1Request, base_url, '/v4/public/shares/uploads/{access_key}/{upload_id}', request)
        ...
        res = operations.UploadFileAsMultipartPublic1Response(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        ...
        elif http_res.status_code in [400, 404, 406, 412, 507]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
