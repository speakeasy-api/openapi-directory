    ...
    public org.openapis.openapi.models.operations.GetRightsResponse getRights(org.openapis.openapi.models.operations.GetRightsRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.FunctionalityRightInfo[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.FunctionalityRightInfo[].class);
