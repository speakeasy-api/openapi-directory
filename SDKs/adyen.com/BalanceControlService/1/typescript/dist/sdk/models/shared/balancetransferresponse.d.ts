 ...
 */
export declare enum BalanceTransferResponseStatusEnum {
    Error = "error",
    Failed = "failed",
 ...
 */
export declare enum BalanceTransferResponseTypeEnum {
    Tax = "tax",
    Fee = "fee",
 ...
 */
export declare class BalanceTransferResponse extends SpeakeasyBase {
    amount: Amount;
    /**
