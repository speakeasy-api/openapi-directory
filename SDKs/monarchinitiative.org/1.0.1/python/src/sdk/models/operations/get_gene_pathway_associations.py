...
class GetGenePathwayAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGenePathwayAssociationsQueryParams:
...
class GetGenePathwayAssociationsRequest:
    path_params: GetGenePathwayAssociationsPathParams = dataclasses.field()
    query_params: GetGenePathwayAssociationsQueryParams = dataclasses.field()
