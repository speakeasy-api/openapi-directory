...
type RecommenderProjectsLocationsRecommendersRecommendationsMarkSucceededRequest struct {
	...
	GoogleCloudRecommenderV1MarkRecommendationSucceededRequest *shared.GoogleCloudRecommenderV1MarkRecommendationSucceededRequest `request:"mediaType=application/json"`
	// OAuth access token.
