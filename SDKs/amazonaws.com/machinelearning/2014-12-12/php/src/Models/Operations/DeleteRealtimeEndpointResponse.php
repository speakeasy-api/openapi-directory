...
class DeleteRealtimeEndpointResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\DeleteRealtimeEndpointOutput $deleteRealtimeEndpointOutput
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\DeleteRealtimeEndpointOutput $deleteRealtimeEndpointOutput = null;
	...
	{
		$this->contentType = "";
		$this->deleteRealtimeEndpointOutput = null;
