...
public class GetSearchRvAutoCompleteQueryParams {
    ...
    public GetSearchRvAutoCompleteQueryParams withFacetMinCount(Double facetMinCount) {
    ...
    public GetSearchRvAutoCompleteQueryParams withField(GetSearchRvAutoCompleteFieldEnum field) {
        this.field = field;
        return this;
    }
    ...
    public GetSearchRvAutoCompleteQueryParams withInventoryType(org.openapis.openapi.models.shared.InventoryTypeEnum inventoryType) {
    ...
    public GetSearchRvAutoCompleteQueryParams withRadius(Integer radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetSearchRvAutoCompleteQueryParams withSellerType(String sellerType) {
    ...
    public GetSearchRvAutoCompleteQueryParams withSortBy(GetSearchRvAutoCompleteSortByEnum sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public String zip;
    public GetSearchRvAutoCompleteQueryParams withZip(String zip) {
        this.zip = zip;
        return this;
    }
