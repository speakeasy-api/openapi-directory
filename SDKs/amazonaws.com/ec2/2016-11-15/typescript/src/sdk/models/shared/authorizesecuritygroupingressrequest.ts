 ...
 */
export enum AuthorizeSecurityGroupIngressRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class AuthorizeSecurityGroupIngressRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class AuthorizeSecurityGroupIngressRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class AuthorizeSecurityGroupIngressRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  cidrIp?: string;
