 ...
 */
public enum CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
