...
class WeatherMaps:
    ...
    def map_map_get(self, request: operations.MapMapGetRequest, security: operations.MapMapGetSecurity) -> operations.MapMapGetResponse:
        r"""Returns PNG weather map for given area and variable
        ...
        * Weather maps are only supported for forecasts, not for archive data.
        ...
        url = base_url.removesuffix('/') + '/map'
        
        query_params = utils.get_query_params(operations.MapMapGetRequest, request)
        ...
        res = operations.MapMapGetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'image/png'):
                res.map_map_get_200_image_png_string = http_res.content
