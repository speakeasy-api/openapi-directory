 ...
 */
public enum TransactionTransactionSourceACHTransferReturnReturnReasonCodeEnum {
    ...
    private TransactionTransactionSourceACHTransferReturnReturnReasonCodeEnum(String value) {
        this.value = value;
    }
}
