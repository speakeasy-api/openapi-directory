...
class DisplayvideoAdvertisersLocationListsPatchRequest:
    path_params: DisplayvideoAdvertisersLocationListsPatchPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersLocationListsPatchQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersLocationListsPatchSecurity = dataclasses.field()
