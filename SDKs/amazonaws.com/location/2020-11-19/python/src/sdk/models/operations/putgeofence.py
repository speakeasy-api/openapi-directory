...
class PutGeofenceRequestBody:
    geometry: PutGeofenceRequestBodyGeometry = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Geometry') }})
    

@dataclasses.dataclass
class PutGeofenceRequest:
    headers: PutGeofenceHeaders = dataclasses.field()
    path_params: PutGeofencePathParams = dataclasses.field()
    request: PutGeofenceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
