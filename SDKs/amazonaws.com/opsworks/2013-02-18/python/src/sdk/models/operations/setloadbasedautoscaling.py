...
class SetLoadBasedAutoScalingRequest:
    ...
    set_load_based_auto_scaling_request: shared_setloadbasedautoscalingrequest.SetLoadBasedAutoScalingRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
