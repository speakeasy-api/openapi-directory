 ...
 */
export declare enum DependabotAlertWithRepositoryDependencyScopeEnum {
 ...
 */
export declare class DependabotAlertWithRepositoryDependency extends SpeakeasyBase {
    /**
 ...
 */
export declare enum DependabotAlertWithRepositoryDismissedReasonEnum {
 ...
 */
export declare enum DependabotAlertWithRepositoryStateEnum {
    Dismissed = "dismissed",
    Fixed = "fixed",
    Open = "open"
}
 ...
 * A Dependabot alert.
 */
export declare class DependabotAlertWithRepository extends SpeakeasyBase {
    /**
