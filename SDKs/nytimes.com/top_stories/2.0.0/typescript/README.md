...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/nytimes.com/top_stories/2.0.0/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/nytimes.com/top_stories/2.0.0/typescript
```
