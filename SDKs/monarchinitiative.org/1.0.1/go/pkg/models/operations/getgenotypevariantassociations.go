...
type GetGenotypeVariantAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetGenotypeVariantAssociationsQueryParams struct {
