...
export class DialogflowProjectsLocationsAgentSessionsDeleteContextsSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsAgentSessionsDeleteContextsSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class DialogflowProjectsLocationsAgentSessionsDeleteContextsSecurity extends SpeakeasyBase {
...
export class DialogflowProjectsLocationsAgentSessionsDeleteContextsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsAgentSessionsDeleteContextsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
