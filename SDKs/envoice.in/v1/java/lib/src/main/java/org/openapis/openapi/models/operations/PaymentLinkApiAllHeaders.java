...
public class PaymentLinkApiAllHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PaymentLinkApiAllHeaders withXAuthKey(String xAuthKey) {
    ...
    public PaymentLinkApiAllHeaders withXAuthSecret(String xAuthSecret) {
