...
class GetDescribeServiceAccessPoliciesQueryParams:
    action: GetDescribeServiceAccessPoliciesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    domain_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'DomainName', 'style': 'form', 'explode': True }})
    version: GetDescribeServiceAccessPoliciesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeServiceAccessPoliciesRequest:
    headers: GetDescribeServiceAccessPoliciesHeaders = dataclasses.field()
    query_params: GetDescribeServiceAccessPoliciesQueryParams = dataclasses.field()
