...
public class GetTruckDistanceOutputFormatQueryParams {
    ...
    public GetTruckDistanceOutputFormatQueryParams withOutputSRS(GetTruckDistanceOutputFormatOutputSrsEnum outputSRS) {
    ...
    public GetTruckDistanceOutputFormatQueryParams withTruckRouteMultiplier(Long truckRouteMultiplier) {
