...
func (e CompanyIDSuperLangEnum) ToPointer() *CompanyIDSuperLangEnum {
	return &e
}
...
func (e *CompanyIDSuperLangEnum) UnmarshalJSON(data []byte) error {
	...
	case "OG":
		fallthrough
	case "EN":
		*e = CompanyIDSuperLangEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CompanyIDSuperLangEnum: %v", v)
	}
}
