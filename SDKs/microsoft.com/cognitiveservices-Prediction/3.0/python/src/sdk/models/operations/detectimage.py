...
class DetectImageRequestBody:
    ...
    r"""Binary image data. Supported formats are JPEG, GIF, PNG, and BMP. Supports images up to 4MB."""  
...
class DetectImageRequest:
    ...
    request_body: DetectImageRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'multipart/form-data' }})  
