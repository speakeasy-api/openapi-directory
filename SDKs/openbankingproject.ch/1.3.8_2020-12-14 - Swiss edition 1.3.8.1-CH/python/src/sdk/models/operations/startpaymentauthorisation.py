...
class StartPaymentAuthorisationPathParams:
...
@dataclasses.dataclass
class StartPaymentAuthorisationHeaders:
...
@dataclasses.dataclass
class StartPaymentAuthorisationRequest:
    headers: StartPaymentAuthorisationHeaders = dataclasses.field()
    path_params: StartPaymentAuthorisationPathParams = dataclasses.field()
    security: StartPaymentAuthorisationSecurity = dataclasses.field()
    request: Optional[Any] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class StartPaymentAuthorisationResponse:
