...
class ListIPAccessControlListRequest:
    ...
    r"""The SID of the Trunk from which to read the IP Access Control Lists."""  
...
class ListIPAccessControlListListIPAccessControlListResponse:
    ...
    ip_access_control_lists: Optional[list[shared_trunking_v1_trunk_ip_access_control_list.TrunkingV1TrunkIPAccessControlList]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ip_access_control_lists'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListIPAccessControlListListIPAccessControlListResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
