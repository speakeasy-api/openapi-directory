...
class EnvironmentFile
{
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\EnvironmentFileTypeEnum>')]
	...
	{
		$this->type = \OpenAPI\OpenAPI\Models\Shared\EnvironmentFileTypeEnum::S3;
		$this->value = "";
	}
}
