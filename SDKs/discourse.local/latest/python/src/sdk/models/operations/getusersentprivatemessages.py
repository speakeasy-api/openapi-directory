...
@dataclasses.dataclass
class GetUserSentPrivateMessages200ApplicationJSONTopicListTopicsPosters:
...
class GetUserSentPrivateMessages200ApplicationJSONTopicListTopics:
    ...
    allowed_user_count: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('allowed_user_count'), 'exclude': lambda f: f is None }})  
    ...
    participants: Optional[list[Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('participants'), 'exclude': lambda f: f is None }})  
    ...
    posters: Optional[list[GetUserSentPrivateMessages200ApplicationJSONTopicListTopicsPosters]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('posters'), 'exclude': lambda f: f is None }})  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetUserSentPrivateMessages200ApplicationJSONTopicList:
    ...
    topics: Optional[list[GetUserSentPrivateMessages200ApplicationJSONTopicListTopics]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('topics'), 'exclude': lambda f: f is None }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetUserSentPrivateMessages200ApplicationJSONUsers:
...
class GetUserSentPrivateMessages200ApplicationJSON:
    ...
    topic_list: Optional[GetUserSentPrivateMessages200ApplicationJSONTopicList] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('topic_list'), 'exclude': lambda f: f is None }})  
    users: Optional[list[GetUserSentPrivateMessages200ApplicationJSONUsers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('users'), 'exclude': lambda f: f is None }})  
...
class GetUserSentPrivateMessagesResponse:
    ...
    get_user_sent_private_messages_200_application_json_object: Optional[GetUserSentPrivateMessages200ApplicationJSON] = dataclasses.field(default=None)
    r"""private messages"""  
