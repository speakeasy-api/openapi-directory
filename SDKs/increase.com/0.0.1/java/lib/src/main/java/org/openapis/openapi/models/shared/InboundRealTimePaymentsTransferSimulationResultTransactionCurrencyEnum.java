 ...
 */
public enum InboundRealTimePaymentsTransferSimulationResultTransactionCurrencyEnum {
    CAD("CAD"),
    CHF("CHF"),
    EUR("EUR"),
    GBP("GBP"),
    ...
    private InboundRealTimePaymentsTransferSimulationResultTransactionCurrencyEnum(String value) {
        this.value = value;
    }
}
