...
public class InventoryCategoriesList200ApplicationJSON {
    ...
    @JsonProperty("data")
    public org.openapis.openapi.models.shared.InventoryCategory[] data;

    public InventoryCategoriesList200ApplicationJSON withData(org.openapis.openapi.models.shared.InventoryCategory[] data) {
        this.data = data;
        return this;
    }
    ...
    public InventoryCategoriesList200ApplicationJSON(){}
}
