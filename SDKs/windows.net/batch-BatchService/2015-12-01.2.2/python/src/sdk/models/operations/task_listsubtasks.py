...
from ..shared import cloudtasklistsubtasksresult as shared_cloudtasklistsubtasksresult
...
class TaskListSubtasksResponse:
    ...
    cloud_task_list_subtasks_result: Optional[shared_cloudtasklistsubtasksresult.CloudTaskListSubtasksResult] = dataclasses.field(default=None)  
