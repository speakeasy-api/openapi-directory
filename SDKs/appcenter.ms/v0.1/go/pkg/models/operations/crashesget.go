...
type CrashesGetPathParams struct {
...
type CrashesGetQueryParams struct {
...
type CrashesGetRequest struct {
	PathParams  CrashesGetPathParams
	QueryParams CrashesGetQueryParams
	Security    CrashesGetSecurity
}
