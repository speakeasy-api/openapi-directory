...
func (e *UserResponseMfaStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "REGISTERED":
		fallthrough
	case "UNREGISTERED":
		*e = UserResponseMfaStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UserResponseMfaStatusEnum: %s", s)
	}
}
...
func (e *UserResponseMfaTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "YUBIKEY":
		fallthrough
	case "TOTP":
		*e = UserResponseMfaTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UserResponseMfaTypeEnum: %s", s)
	}
}
...
func (e *UserResponseStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "DISABLED":
		fallthrough
	case "PENDING":
		*e = UserResponseStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UserResponseStatusEnum: %s", s)
	}
}
...
func (e *UserResponseUserTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "PAYOR":
		fallthrough
	case "PAYEE":
		*e = UserResponseUserTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UserResponseUserTypeEnum: %s", s)
	}
}
