...
**/
public class MeetingLiveStreamStatusUpdateMultipartFormDataSettings {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("active_speaker_name")
    public Boolean activeSpeakerName;
    public MeetingLiveStreamStatusUpdateMultipartFormDataSettings withActiveSpeakerName(Boolean activeSpeakerName) {
    ...
    public MeetingLiveStreamStatusUpdateMultipartFormDataSettings withDisplayName(String displayName) {
