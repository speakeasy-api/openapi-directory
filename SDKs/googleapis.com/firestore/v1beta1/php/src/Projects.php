...
class Projects 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsBatchGetResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{database}/documents:batchGet', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsBatchGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{database}/documents:batchWrite', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsBatchWriteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{database}/documents:beginTransaction', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsBeginTransactionRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{database}/documents:commit', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsCommitRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}/{collectionId}', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsCreateDocumentRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}:listCollectionIds', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsListCollectionIdsRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}/{collectionId}', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsListDocumentsRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{database}/documents:listen', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsListenRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}:partitionQuery', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsPartitionQueryRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{database}/documents:rollback', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsRollbackRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}:runAggregationQuery', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsRunAggregationQueryRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}:runQuery', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsRunQueryRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{database}/documents:write', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesDocumentsWriteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}:exportDocuments', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesExportDocumentsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirestoreAdminV1beta1ExportDocumentsRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}:importDocuments', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesImportDocumentsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirestoreAdminV1beta1ImportDocumentsRequest", "json");
        $options = array_merge_recursive($options, $body);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesCreateRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesCreateSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesCreateResponse
     */
	public function firestoreProjectsDatabasesIndexesCreate(
        \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesCreateRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesCreateSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesCreateResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}/indexes', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesCreateRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirestoreAdminV1beta1Index", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesCreateRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesCreateResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * Deletes an index.
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesDeleteRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesDeleteSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesDeleteResponse
     */
	public function firestoreProjectsDatabasesIndexesDelete(
        \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesDeleteRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesDeleteSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesDeleteResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesDeleteRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesDeleteRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesDeleteResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * Gets an index.
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesGetRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesGetSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesGetResponse
     */
	public function firestoreProjectsDatabasesIndexesGet(
        \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesGetRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesGetSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesGetResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesGetRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesGetRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesGetResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirestoreAdminV1beta1Index = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirestoreAdminV1beta1Index', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesListRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesListSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesListResponse
     */
	public function firestoreProjectsDatabasesIndexesList(
        \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesListRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesListSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesListResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}/indexes', \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesListRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesListRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\FirestoreProjectsDatabasesIndexesListResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirestoreAdminV1beta1ListIndexesResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirestoreAdminV1beta1ListIndexesResponse', 'json');
            }
        }
