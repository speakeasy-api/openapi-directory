...
public class BatchUpdateCustomVocabularyItemPathParams {
    /**
     * The identifier of the bot associated with this custom vocabulary
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=botId")
    public String botId;
    public BatchUpdateCustomVocabularyItemPathParams withBotId(String botId) {
        this.botId = botId;
        return this;
    }
    ...
    public BatchUpdateCustomVocabularyItemPathParams withBotVersion(String botVersion) {
    ...
    public BatchUpdateCustomVocabularyItemPathParams withLocaleId(String localeId) {
