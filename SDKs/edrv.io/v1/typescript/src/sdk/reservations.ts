...
export class Reservations {
  ...
  getReservation(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetReservationResponse =
        new operations.GetReservationResponse({
  ...
  getReservations(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetReservationsResponse =
        new operations.GetReservationsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  updatereservation(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UpdatereservationResponse =
        new operations.UpdatereservationResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.updatereservation201ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Updatereservation201ApplicationJSON
            );
          }
          break;
