...
class GetGenotypeCaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGenotypeCaseAssociationsQueryParams:
...
class GetGenotypeCaseAssociationsRequest:
    path_params: GetGenotypeCaseAssociationsPathParams = dataclasses.field()
    query_params: GetGenotypeCaseAssociationsQueryParams = dataclasses.field()
