...
class NodesForksCreateNodeAttributesInput:
    ...
    category: NodesForksCreateNodeAttributesCategoryEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('category') }})
...
class NodesForksCreateNodeInput:
    attributes: NodesForksCreateNodeAttributesInput = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('attributes') }})
    type: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
    

@dataclasses.dataclass
class NodesForksCreateRequest:
    path_params: NodesForksCreatePathParams = dataclasses.field()
    request: NodesForksCreateNodeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
