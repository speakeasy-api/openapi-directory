...
class GetSubscriptionPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetSubscriptionRequest:
    path_params: GetSubscriptionPathParams = dataclasses.field()
...
class GetSubscriptionResponse:
    ...
    subscription_index: Optional[shared_subscriptionindex.SubscriptionIndex] = dataclasses.field(default=None)
