...
@dataclasses.dataclass
class GetSigningBasketAuthorisationSecurity:
...
class GetSigningBasketAuthorisationRequest:
    headers: GetSigningBasketAuthorisationHeaders = dataclasses.field()
    path_params: GetSigningBasketAuthorisationPathParams = dataclasses.field()
    security: GetSigningBasketAuthorisationSecurity = dataclasses.field()
