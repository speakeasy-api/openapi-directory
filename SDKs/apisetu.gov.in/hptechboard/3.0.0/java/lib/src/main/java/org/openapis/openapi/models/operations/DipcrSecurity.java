...
public class DipcrSecurity {
    ...
    public DipcrSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public DipcrSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public DipcrSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
