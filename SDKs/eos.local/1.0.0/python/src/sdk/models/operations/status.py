...
class StatusRequestBody:
    ...
    r"""the endpoint to get the status for, to expressed as either IP address or URL"""  
...
class Status200ApplicationJSON:
    ...
    last_handshake: Optional[Status200ApplicationJSONLastHandshake] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('last_handshake'), 'exclude': lambda f: f is None }})
    r"""Structure holding detailed information about the connection"""  
