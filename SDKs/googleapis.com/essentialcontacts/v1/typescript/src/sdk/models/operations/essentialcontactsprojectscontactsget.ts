...
export class EssentialcontactsProjectsContactsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class EssentialcontactsProjectsContactsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class EssentialcontactsProjectsContactsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
