...
class ComputeGlobalPublicDelegatedPrefixesPatchRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\PublicDelegatedPrefix $publicDelegatedPrefix1 = null;
     ...
     * 
     * @var string $publicDelegatedPrefixPathParameter
     */
	#[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=publicDelegatedPrefix')]
    public string $publicDelegatedPrefixPathParameter;
	...
	public function __construct()
	{
		...
		$this->publicDelegatedPrefix1 = null;
		...
		$this->project = "";
		$this->publicDelegatedPrefixPathParameter = "";
		$this->quotaUser = null;
		$this->requestId = null;
