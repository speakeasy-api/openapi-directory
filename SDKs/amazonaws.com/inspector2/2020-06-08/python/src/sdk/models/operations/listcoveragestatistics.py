...
from ..shared import listcoveragestatisticsresponse as shared_listcoveragestatisticsresponse
...
class ListCoverageStatisticsRequestBodyGroupByEnum(str, Enum):
    r"""The value to group the results by."""
...
class ListCoverageStatisticsRequestBody:
    ...
    filter_criteria: Optional[ListCoverageStatisticsRequestBodyFilterCriteria] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filterCriteria'), 'exclude': lambda f: f is None }})
    r"""A structure that identifies filter criteria for <code>GetCoverageStatistics</code>."""  
    group_by: Optional[ListCoverageStatisticsRequestBodyGroupByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('groupBy'), 'exclude': lambda f: f is None }})
    r"""The value to group the results by."""  
...
class ListCoverageStatisticsRequest:
    ...
    request_body: ListCoverageStatisticsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListCoverageStatisticsResponse:
    ...
    list_coverage_statistics_response: Optional[shared_listcoveragestatisticsresponse.ListCoverageStatisticsResponse] = dataclasses.field(default=None)
    r"""Success"""  
