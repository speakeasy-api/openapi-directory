...
public class DirectoryMobiledevicesGetPathParams {
    /**
    ...
    public DirectoryMobiledevicesGetPathParams withCustomerId(String customerId) {
    ...
    public DirectoryMobiledevicesGetPathParams withResourceId(String resourceId) {
