    ...
    public static void main(String[] args) {
        try {
            ...
            HscerRequestBody req = new HscerRequestBody(HscerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HscerRequestBodyCertificateParameters("6374638", "31-12-1980", "Sunil Kumar", "1234567/001", "123412341234", "2016");;
    ...
    public static void main(String[] args) {
        try {
            ...
            HsmgrRequestBody req = new HsmgrRequestBody(HsmgrRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HsmgrRequestBodyCertificateParameters("6374638", "31-12-1980", "Sunil Kumar", "1234567/001", "123412341234", "2016");;
            ...
            HsmgrResponse res = sdk.apIs.hsmgr(req, new HsmgrSecurity("iure", "saepe") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            SpcerRequestBody req = new SpcerRequestBody(SpcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SpcerRequestBodyCertificateParameters("6374638", "31-12-1980", "Sunil Kumar", "1234567/001", "123412341234", "2016");;
            ...
            SpcerResponse res = sdk.apIs.spcer(req, new SpcerSecurity("culpa", "doloribus") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            SscerRequestBody req = new SscerRequestBody(SscerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SscerRequestBodyCertificateParameters("6374638", "31-12-1980", "Sunil Kumar", "1234567/001", "123412341234", "2016");;
