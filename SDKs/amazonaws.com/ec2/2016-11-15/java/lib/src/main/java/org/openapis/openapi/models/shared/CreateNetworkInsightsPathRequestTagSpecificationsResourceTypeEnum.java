 ...
 */
public enum CreateNetworkInsightsPathRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateNetworkInsightsPathRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
