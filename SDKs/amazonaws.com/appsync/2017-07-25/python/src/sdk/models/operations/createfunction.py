...
from ..shared import createfunctionresponse as shared_createfunctionresponse
...
class CreateFunctionRequestBody:
    ...
    sync_config: Optional[CreateFunctionRequestBodySyncConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('syncConfig') }})
...
class CreateFunctionResponse:
    ...
    create_function_response: Optional[shared_createfunctionresponse.CreateFunctionResponse] = dataclasses.field(default=None)
