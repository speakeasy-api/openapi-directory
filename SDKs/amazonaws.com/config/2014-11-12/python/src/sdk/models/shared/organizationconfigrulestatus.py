...
class OrganizationConfigRuleStatus:
    ...
    organization_rule_status: shared_organizationrulestatus_enum.OrganizationRuleStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('OrganizationRuleStatus') }})
