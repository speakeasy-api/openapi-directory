...
class GetShipmentByIDResponseBodyInternationalShipmentOptions:
    r"""GetShipmentByIDResponseBodyInternationalShipmentOptions
...
class GetShipmentByIDResponseBodyWeight:
    r"""GetShipmentByIDResponseBodyWeight
...
class GetShipmentByIDResponseBody:
    ...
    customs: GetShipmentByIDResponseBodyInternationalShipmentOptions = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('customs') }})
    ...
    total_weight: GetShipmentByIDResponseBodyWeight = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('total_weight') }})
