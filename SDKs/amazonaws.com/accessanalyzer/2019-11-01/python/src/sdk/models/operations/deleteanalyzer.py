...
class DeleteAnalyzerRequest:
    headers: DeleteAnalyzerHeaders = dataclasses.field()
    path_params: DeleteAnalyzerPathParams = dataclasses.field()
    query_params: DeleteAnalyzerQueryParams = dataclasses.field()
