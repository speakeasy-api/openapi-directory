...
from ..shared import proxygetfeature as shared_proxygetfeature
...
class ObjectGETFeatureResponse:
    ...
    proxy_get_feature: Optional[shared_proxygetfeature.ProxyGetFeature] = dataclasses.field(default=None)  
