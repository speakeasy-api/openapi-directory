...
class ProjectArtifacts:
    r"""Information about the build output artifacts for the build project."""
    
    type: shared_artifactstype_enum.ArtifactsTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})  
    ...
    namespace_type: Optional[shared_artifactnamespace_enum.ArtifactNamespaceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('namespaceType'), 'exclude': lambda f: f is None }})  
    ...
    packaging: Optional[shared_artifactpackaging_enum.ArtifactPackagingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('packaging'), 'exclude': lambda f: f is None }})  
