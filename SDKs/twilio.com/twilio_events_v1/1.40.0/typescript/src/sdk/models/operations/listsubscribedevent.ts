...
export class ListSubscribedEventListSubscribedEventResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListSubscribedEventListSubscribedEventResponseMeta)
  meta?: ListSubscribedEventListSubscribedEventResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.EventsV1SubscriptionSubscribedEvent })
  @Expose({ name: "types" })
  @Type(() => shared.EventsV1SubscriptionSubscribedEvent)
