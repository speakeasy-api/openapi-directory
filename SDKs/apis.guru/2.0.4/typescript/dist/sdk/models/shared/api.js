...
var Api = /** @class */ (function (_super) {
    ...
    ], Api.prototype, "added", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "preferred" }),
        __metadata("design:type", String)
    ], Api.prototype, "preferred", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: apiversion_1.ApiVersion }),
        (0, class_transformer_1.Expose)({ name: "versions" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], apiversion_1.ApiVersion);
            }
            return obj;
        }, { toClassOnly: true }),
