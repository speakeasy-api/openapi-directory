...
public class GetNetworkSnmpResponse {
    ...
    public GetNetworkSnmpResponse withStatusCode(Integer statusCode) {
    ...
    public GetNetworkSnmpResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public GetNetworkSnmpResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
