 ...
 */
export enum ModifySpotFleetRequestRequestExcessCapacityTerminationPolicyEnum {
 ...
 * The launch template.
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigsLaunchTemplateSpecification extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorCount extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
...
export enum ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorManufacturersEnum {
  Nvidia = "nvidia",
  Amd = "amd",
...
export enum ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorNamesEnum {
  A100 = "a100",
  V100 = "v100",
  K80 = "k80",
  T4 = "t4",
 ...
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorTotalMemoryMiB extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
...
export enum ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorTypesEnum {
  Gpu = "gpu",
  Fpga = "fpga",
  Inference = "inference",
}
 ...
 */
export enum ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsBareMetalEnum {
  Included = "included",
  Required = "required",
  Excluded = "excluded",
}
 ...
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsBaselineEbsBandwidthMbps extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export enum ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsBurstablePerformanceEnum {
  Included = "included",
  Required = "required",
  Excluded = "excluded",
}

export enum ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsCpuManufacturersEnum {
  Intel = "intel",
  Amd = "amd",
  AmazonWebServices = "amazon-web-services",
}

export enum ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsInstanceGenerationsEnum {
  Current = "current",
  Previous = "previous",
}
 ...
 */
export enum ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsLocalStorageEnum {
  Included = "included",
  Required = "required",
  Excluded = "excluded",
}

export enum ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsLocalStorageTypesEnum {
  Hdd = "hdd",
  Ssd = "ssd",
}
 ...
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsMemoryGiBPerVCpu extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsMemoryMiB extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsNetworkBandwidthGbps extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsNetworkInterfaceCount extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsTotalLocalStorageGB extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsVCpuCount extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirements extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 * The instance type.
 */
export enum ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceTypeEnum {
  A1Medium = "a1.medium",
  A1Large = "a1.large",
  A1Xlarge = "a1.xlarge",
 ...
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverrides extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class ModifySpotFleetRequestRequestLaunchTemplateConfigs extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class ModifySpotFleetRequestRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  context?: string;
