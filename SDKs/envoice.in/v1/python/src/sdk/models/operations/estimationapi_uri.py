...
from ..shared import estimationuriapimodel as shared_estimationuriapimodel
...
class EstimationAPIURIResponse:
    ...
    estimation_uri_api_model: Optional[shared_estimationuriapimodel.EstimationURIAPIModel] = dataclasses.field(default=None)
    r"""OK"""  
