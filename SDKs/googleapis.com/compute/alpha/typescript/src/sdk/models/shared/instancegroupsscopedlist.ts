 ...
 */
export enum InstanceGroupsScopedListWarningCodeEnum {
...
export class InstanceGroupsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceGroupsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceGroupsScopedListWarningData })
  @Expose({ name: "data" })
...
export class InstanceGroupsScopedList extends SpeakeasyBase {
  /**
