...
from ..shared import security as shared_security
from ..shared import listadvertiserassignedtargetingoptionsresponse as shared_listadvertiserassignedtargetingoptionsresponse
...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListPathParams:
    ...
    targeting_type: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListQueryParams:
...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListRequest:
    path_params: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListSecurity = dataclasses.field()
...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListResponse:
    ...
    list_advertiser_assigned_targeting_options_response: Optional[shared_listadvertiserassignedtargetingoptionsresponse.ListAdvertiserAssignedTargetingOptionsResponse] = dataclasses.field(default=None)
