...
exports.CreateCheckInput = exports.CreateCheckInputTypeEnum = exports.CreateCheckInputRegionEnum = exports.CreateCheckInputCountryEnum = void 0;
var utils_1 = require("../../../internal/utils");
/**
 * Document country
 */
var CreateCheckInputCountryEnum;
...
})(CreateCheckInputCountryEnum = exports.CreateCheckInputCountryEnum || (exports.CreateCheckInputCountryEnum = {}));
/**
 ...
 */
var CreateCheckInputRegionEnum;
...
})(CreateCheckInputRegionEnum = exports.CreateCheckInputRegionEnum || (exports.CreateCheckInputRegionEnum = {}));
/**
 * Background check type
 */
var CreateCheckInputTypeEnum;
...
})(CreateCheckInputTypeEnum = exports.CreateCheckInputTypeEnum || (exports.CreateCheckInputTypeEnum = {}));
/**
...
var CreateCheckInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=birth_certificate" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "birthCertificate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=company_name" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=diplomatic_id" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "diplomaticId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=driver_license" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "driverLicense", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=escrow" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=force_creation" }),
        __metadata("design:type", Boolean)
    ], CreateCheckInput.prototype, "forceCreation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=foreign_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=license_plate" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "licensePlate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=national_id" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "nationalId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=native_country" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "nativeCountry", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=owner_document_id" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "ownerDocumentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=owner_document_type" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "ownerDocumentType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=passport" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=pep" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=professional_card" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "professionalCard", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=ptp" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=report_id" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "reportId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=state_id" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "stateId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=tax_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=user_authorized" }),
        __metadata("design:type", Boolean)
    ], CreateCheckInput.prototype, "userAuthorized", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=vehicle_id" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "vehicleId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=verification_code" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "verificationCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=watch" }),
        __metadata("design:type", String)
    ], CreateCheckInput.prototype, "watch", void 0);
    return CreateCheckInput;
}(utils_1.SpeakeasyBase));
exports.CreateCheckInput = CreateCheckInput;
