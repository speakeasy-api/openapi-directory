...
class DeleteWatchedRequest:
    ...
    """  
    item_ids: Optional[list[str]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'item_ids', 'style': 'form', 'explode': False }})
    r"""List of `itemId`s to delete. Omit this parameter to delete all items"""  
