...
var Users = /** @class */ (function () {
     ...
     */
    Users.prototype.getUsersMe = function (config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetUsersMeResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.userContactV2 = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetUsersMeUserContactV2);
                    }
                    break;
            }
            return res;
