...
public class UploadSessionsUploadRequest {
    ...
    public UploadSessionsUploadRequest(@JsonProperty("RequestBody") byte[] requestBody, @JsonProperty("id") String id, @JsonProperty("part_number") Double partNumber, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.requestBody = requestBody;
        this.id = id;
        this.partNumber = partNumber;
        this.xApideckAppId = xApideckAppId;
