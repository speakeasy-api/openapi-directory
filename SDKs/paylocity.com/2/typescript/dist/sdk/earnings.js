...
var Earnings = /** @class */ (function () {
    function Earnings(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Earnings.prototype.addOrUpdateAnEmployeeEarning = function (req, config) {
        var _a;
    ...
    **/
    Earnings.prototype.deleteEarningByEarningCodeAndStartDate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Earnings.prototype.getAllEarnings = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Earnings.prototype.getEarningByEarningCodeAndStartDate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Earnings.prototype.getEarningsByEarningCode = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
