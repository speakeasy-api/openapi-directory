...
public class CreateDomesticStandingOrderConsentsRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticStandingOrderConsentsRawHeaders withAuthorization(String authorization) {
    ...
    public CreateDomesticStandingOrderConsentsRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticStandingOrderConsentsRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticStandingOrderConsentsRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateDomesticStandingOrderConsentsRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateDomesticStandingOrderConsentsRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticStandingOrderConsentsRawHeaders withXJwsSignature(String xJwsSignature) {
