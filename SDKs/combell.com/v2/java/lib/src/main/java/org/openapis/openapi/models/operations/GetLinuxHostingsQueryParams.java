...
public class GetLinuxHostingsQueryParams {
    /**
     * The number of items to skip in the resultset.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=skip")
    public Integer skip;
    public GetLinuxHostingsQueryParams withSkip(Integer skip) {
        this.skip = skip;
        return this;
    }
    ...
    public Integer take;
    public GetLinuxHostingsQueryParams withTake(Integer take) {
        this.take = take;
        return this;
    }
