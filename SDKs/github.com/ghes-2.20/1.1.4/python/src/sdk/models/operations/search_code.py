...
class SearchCodeSortEnum(str, Enum):
    r"""Sorts the results of your query. Can only be `indexed`, which indicates how recently a file has been indexed by the GitHub Enterprise Server search infrastructure. Default: [best match](https://docs.github.com/enterprise-server@2.20/rest/reference/search#ranking-search-results)"""
    INDEXED = 'indexed'
...
class SearchCode200ApplicationJSON:
    ...
    items: list[shared_code_search_result_item.CodeSearchResultItem] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items') }})  
