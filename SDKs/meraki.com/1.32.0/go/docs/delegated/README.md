...
func main() {
    ...
    res, err := s.Delegated.CreateNetworkAppliancePrefixesDelegatedStatic(ctx, operations.CreateNetworkAppliancePrefixesDelegatedStaticRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Delegated.DeleteNetworkAppliancePrefixesDelegatedStatic(ctx, operations.DeleteNetworkAppliancePrefixesDelegatedStaticRequest{
        NetworkID: "fuga",
        StaticDelegatedPrefixID: "odio",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Delegated.GetDeviceAppliancePrefixesDelegated(ctx, operations.GetDeviceAppliancePrefixesDelegatedRequest{
        Serial: "unde",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Delegated.GetDeviceAppliancePrefixesDelegatedVlanAssignments(ctx, operations.GetDeviceAppliancePrefixesDelegatedVlanAssignmentsRequest{
        Serial: "sapiente",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Delegated.GetNetworkAppliancePrefixesDelegatedStatic(ctx, operations.GetNetworkAppliancePrefixesDelegatedStaticRequest{
        NetworkID: "ab",
        StaticDelegatedPrefixID: "ipsam",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Delegated.GetNetworkAppliancePrefixesDelegatedStatics(ctx, operations.GetNetworkAppliancePrefixesDelegatedStaticsRequest{
        NetworkID: "quia",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Delegated.UpdateNetworkAppliancePrefixesDelegatedStatic(ctx, operations.UpdateNetworkAppliancePrefixesDelegatedStaticRequest{
        RequestBody: &operations.UpdateNetworkAppliancePrefixesDelegatedStaticRequestBody{
            ...
            Prefix: sdk.String("et"),
        },
        NetworkID: "quo",
        StaticDelegatedPrefixID: "alias",
    })
    if err != nil {
        log.Fatal(err)
    }
