...
export class DnsResponsePolicyRulesPatchSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DnsResponsePolicyRulesPatchSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class DnsResponsePolicyRulesPatchSecurity extends SpeakeasyBase {
...
export class DnsResponsePolicyRulesPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DnsResponsePolicyRulesPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
