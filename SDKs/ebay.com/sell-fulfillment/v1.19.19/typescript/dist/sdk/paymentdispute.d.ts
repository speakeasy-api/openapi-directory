...
export declare class PaymentDispute {
     ...
     */
    acceptPaymentDispute(req: operations.AcceptPaymentDisputeRequest, security: operations.AcceptPaymentDisputeSecurity, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.AcceptPaymentDisputeResponse>;
    /**
     ...
     */
    addEvidence(req: operations.AddEvidenceRequest, security: operations.AddEvidenceSecurity, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.AddEvidenceResponse>;
    /**
     ...
     */
    contestPaymentDispute(req: operations.ContestPaymentDisputeRequest, security: operations.ContestPaymentDisputeSecurity, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.ContestPaymentDisputeResponse>;
    /**
     ...
     */
    fetchEvidenceContent(req: operations.FetchEvidenceContentRequest, security: operations.FetchEvidenceContentSecurity, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.FetchEvidenceContentResponse>;
    /**
     ...
     */
    getActivities(req: operations.GetActivitiesRequest, security: operations.GetActivitiesSecurity, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.GetActivitiesResponse>;
    /**
     ...
     */
    getPaymentDispute(req: operations.GetPaymentDisputeRequest, security: operations.GetPaymentDisputeSecurity, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.GetPaymentDisputeResponse>;
    /**
     ...
     */
    getPaymentDisputeSummaries(req: operations.GetPaymentDisputeSummariesRequest, security: operations.GetPaymentDisputeSummariesSecurity, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.GetPaymentDisputeSummariesResponse>;
    /**
     * Update evidence
     *
     * @remarks
     ...
     */
    updateEvidence(req: operations.UpdateEvidenceRequest, security: operations.UpdateEvidenceSecurity, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.UpdateEvidenceResponse>;
    /**
     ...
     */
    uploadEvidenceFile(req: operations.UploadEvidenceFileRequest, security: operations.UploadEvidenceFileSecurity, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.UploadEvidenceFileResponse>;
}
