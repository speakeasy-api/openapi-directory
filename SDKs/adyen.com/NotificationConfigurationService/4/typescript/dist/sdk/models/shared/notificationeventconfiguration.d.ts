 ...
 */
export declare enum NotificationEventConfigurationEventTypeEnum {
 ...
 */
export declare enum NotificationEventConfigurationIncludeModeEnum {
    Exclude = "EXCLUDE",
    Include = "INCLUDE"
}
export declare class NotificationEventConfiguration extends SpeakeasyBase {
    /**
     * The type of event.
     *
     * @remarks
