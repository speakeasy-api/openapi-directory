...
var EvaluationResult = /** @class */ (function (_super) {
    ...
    ], EvaluationResult.prototype, "details", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "entityId" }),
        __metadata("design:type", String)
    ], EvaluationResult.prototype, "entityId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "feature" }),
        __metadata("design:type", String)
    ], EvaluationResult.prototype, "feature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "project" }),
        __metadata("design:type", String)
    ], EvaluationResult.prototype, "project", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "reason" }),
        __metadata("design:type", String)
    ], EvaluationResult.prototype, "reason", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "value" }),
        (0, class_transformer_1.Type)(function () { return variablevalue_1.VariableValue; }),
        __metadata("design:type", variablevalue_1.VariableValue)
    ], EvaluationResult.prototype, "value", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "variation" }),
        __metadata("design:type", String)
    ], EvaluationResult.prototype, "variation", void 0);
