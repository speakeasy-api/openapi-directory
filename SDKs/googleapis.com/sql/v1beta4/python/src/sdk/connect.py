...
class Connect:
    ...
    def sql_connect_generate_ephemeral(self, request: operations.SQLConnectGenerateEphemeralRequest) -> operations.SQLConnectGenerateEphemeralResponse:
        ...
        url = utils.generate_url(base_url, "/sql/v1beta4/projects/{project}/instances/{instance}:generateEphemeralCert", request.path_params)
    ...
    def sql_connect_get(self, request: operations.SQLConnectGetRequest) -> operations.SQLConnectGetResponse:
        ...
        url = utils.generate_url(base_url, "/sql/v1beta4/projects/{project}/instances/{instance}/connectSettings", request.path_params)
