...
class GetV4LayersScoutingObservationsRequest:
    headers: GetV4LayersScoutingObservationsHeaders = dataclasses.field()
    query_params: GetV4LayersScoutingObservationsQueryParams = dataclasses.field()
    security: GetV4LayersScoutingObservationsSecurity = dataclasses.field()
...
class GetV4LayersScoutingObservationsResponse:
    ...
    scouting_observations: Optional[Any] = dataclasses.field(default=None)
