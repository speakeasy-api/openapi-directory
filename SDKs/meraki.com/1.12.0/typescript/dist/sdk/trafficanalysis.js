...
exports.TrafficAnalysis = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var TrafficAnalysis = /** @class */ (function () {
    function TrafficAnalysis(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TrafficAnalysis.prototype.getNetworkTrafficAnalysis = function (req, config) {
    ...
    **/
    TrafficAnalysis.prototype.updateNetworkTrafficAnalysis = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.TrafficAnalysis = TrafficAnalysis;
