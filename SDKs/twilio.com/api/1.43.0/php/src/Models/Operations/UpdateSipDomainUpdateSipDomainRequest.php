...
class UpdateSipDomainUpdateSipDomainRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\UpdateSipDomainUpdateSipDomainRequestVoiceFallbackMethodEnum $voiceFallbackMethod
     */
	#[SpeakeasyMetadata('form:name=VoiceFallbackMethod')]
    public ?UpdateSipDomainUpdateSipDomainRequestVoiceFallbackMethodEnum $voiceFallbackMethod = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\UpdateSipDomainUpdateSipDomainRequestVoiceMethodEnum $voiceMethod
     */
	#[SpeakeasyMetadata('form:name=VoiceMethod')]
    public ?UpdateSipDomainUpdateSipDomainRequestVoiceMethodEnum $voiceMethod = null;
    
    /**
     * The HTTP method we should use to call `voice_status_callback_url`. Can be: `GET` or `POST`.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\UpdateSipDomainUpdateSipDomainRequestVoiceStatusCallbackMethodEnum $voiceStatusCallbackMethod
     */
	#[SpeakeasyMetadata('form:name=VoiceStatusCallbackMethod')]
    public ?UpdateSipDomainUpdateSipDomainRequestVoiceStatusCallbackMethodEnum $voiceStatusCallbackMethod = null;
