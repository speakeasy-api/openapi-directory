...
class TrunkingV1TrunkCredentialList:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the CredentialList resource."""  
    ...
    r"""The unique string that we created to identify the CredentialList resource."""  
    ...
    r"""The SID of the Trunk the credential list in associated with."""  
