    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetNetworkSwitchMtuResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->getNetworkSwitchMtu200ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\GetNetworkSwitchMtu200ApplicationJSON', 'json');
            }
        }
