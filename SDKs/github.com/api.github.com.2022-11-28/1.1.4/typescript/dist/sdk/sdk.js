...
var codespaces_1 = require("./codespaces");
var dependabot_1 = require("./dependabot");
 ...
 *
 * @see {@link https://docs.github.com/rest/} - GitHub v3 REST API
 */
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.codespaces = new codespaces_1.Codespaces(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.dependabot = new dependabot_1.Dependabot(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.dependencyGraph = new dependencygraph_1.DependencyGraph(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.interactions = new interactions_1.Interactions(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.migrations = new migrations_1.Migrations(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.oidc = new oidc_1.Oidc(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.packages = new packages_1.Packages(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
