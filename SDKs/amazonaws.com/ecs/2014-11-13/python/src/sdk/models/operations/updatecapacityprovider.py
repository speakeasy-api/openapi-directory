...
class UpdateCapacityProviderRequest:
    ...
    update_capacity_provider_request: shared_updatecapacityproviderrequest.UpdateCapacityProviderRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
