 ...
 */
public class GetZRSettings200ApplicationJSON2Notification {
    /**
    ...
    public GetZRSettings200ApplicationJSON2Notification withAudioMeetUsabilityThreshold(Boolean audioMeetUsabilityThreshold) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withAudioNotMeetUsabilityThreshold(Boolean audioNotMeetUsabilityThreshold) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withBatteryIsCharging(Boolean batteryIsCharging) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withBatteryLowAndNotCharging(Boolean batteryLowAndNotCharging) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withBatteryPercentage(String batteryPercentage) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withControllerSchedulingDisconnected(Boolean controllerSchedulingDisconnected) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withControllerSchedulingReconnected(Boolean controllerSchedulingReconnected) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withCpuUsageHighDetected(Boolean cpuUsageHighDetected) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withMicSpeakerCameraDisconnected(Boolean micSpeakerCameraDisconnected) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withMicSpeakerCameraReconnected(Boolean micSpeakerCameraReconnected) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withNetworkUnstableDetected(Boolean networkUnstableDetected) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withSipRegistrationFailed(Boolean sipRegistrationFailed) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withSipRegistrationReEnabled(Boolean sipRegistrationReEnabled) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withZoomRoomComeBackOnline(Boolean zoomRoomComeBackOnline) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withZoomRoomDisplayDisconnected(Boolean zoomRoomDisplayDisconnected) {
    ...
    public GetZRSettings200ApplicationJSON2Notification withZoomRoomOffline(Boolean zoomRoomOffline) {
