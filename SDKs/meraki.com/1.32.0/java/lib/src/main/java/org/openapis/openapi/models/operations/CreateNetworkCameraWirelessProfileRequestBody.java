...
public class CreateNetworkCameraWirelessProfileRequestBody {
    ...
    public CreateNetworkCameraWirelessProfileRequestBody(@JsonProperty("name") String name, @JsonProperty("ssid") CreateNetworkCameraWirelessProfileRequestBodySsid ssid) {
        this.name = name;
        this.ssid = ssid;
  }
}
