...
class SensitiveCategoryTargetingOptionDetails:
    ...
    sensitive_category: Optional[SensitiveCategoryTargetingOptionDetailsSensitiveCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sensitiveCategory') }})
