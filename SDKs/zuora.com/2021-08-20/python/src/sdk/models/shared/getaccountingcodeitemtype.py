...
class GETAccountingCodeItemTypeCategoryEnum(str, Enum):
...
class GETAccountingCodeItemTypeStatusEnum(str, Enum):
    r"""The accounting code status."""
    ACTIVE = 'Active'
    INACTIVE = 'Inactive'

class GETAccountingCodeItemTypeTypeEnum(str, Enum):
...
class GETAccountingCodeItemType:
    ...
    category: Optional[GETAccountingCodeItemTypeCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category'), 'exclude': lambda f: f is None }})
    r"""The category associated with the accounting code."""  
    ...
    status: Optional[GETAccountingCodeItemTypeStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The accounting code status."""  
    success: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('success'), 'exclude': lambda f: f is None }})
    r"""Returns `true` if the request was processed successfully."""  
    type: Optional[GETAccountingCodeItemTypeTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Accounting code type.
