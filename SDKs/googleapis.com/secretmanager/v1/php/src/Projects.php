...
class Projects 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsLocationsListResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}/locations', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsLocationsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}:addVersion', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsAddVersionRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/secrets', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{resource}:getIamPolicy', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsGetIamPolicyRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/secrets', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{resource}:setIamPolicy', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsSetIamPolicyRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{resource}:testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsTestIamPermissionsRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}:access', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsVersionsAccessRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}:destroy', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsVersionsDestroyRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "destroySecretVersionRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}:disable', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsVersionsDisableRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "disableSecretVersionRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}:enable', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsVersionsEnableRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "enableSecretVersionRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsVersionsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/versions', \OpenAPI\OpenAPI\Models\Operations\SecretmanagerProjectsSecretsVersionsListRequest::class, $request);
