...
class ClassroomCoursesTopicsGetSecurity:
    option1: Optional[ClassroomCoursesTopicsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ClassroomCoursesTopicsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class ClassroomCoursesTopicsGetRequest:
    path_params: ClassroomCoursesTopicsGetPathParams = dataclasses.field()
    query_params: ClassroomCoursesTopicsGetQueryParams = dataclasses.field()
    security: ClassroomCoursesTopicsGetSecurity = dataclasses.field()
