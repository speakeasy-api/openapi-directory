...
public class GetCallBroadcastStatsQueryParams {
    /**
    ...
    public Long begin;
    public GetCallBroadcastStatsQueryParams withBegin(Long begin) {
        this.begin = begin;
        return this;
    }
    ...
    public Long end;
    public GetCallBroadcastStatsQueryParams withEnd(Long end) {
        this.end = end;
        return this;
    }
    ...
    public GetCallBroadcastStatsQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
