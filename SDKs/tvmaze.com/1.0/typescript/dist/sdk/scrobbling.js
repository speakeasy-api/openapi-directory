...
exports.Scrobbling = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var Scrobbling = /** @class */ (function () {
    function Scrobbling(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Scrobbling.prototype.getScrobbleShowsShowId = function (req, config) {
     ...
     * This endpoint can be used by all users, even without premium
    **/
    Scrobbling.prototype.postScrobbleEpisodes = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Scrobbling.prototype.postScrobbleShows = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * This endpoint can be used by all users, even without premium
    **/
    Scrobbling.prototype.putScrobbleEpisodesEpisodeId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
