...
class DeleteCustomVerificationEmailTemplateRequest:
    headers: DeleteCustomVerificationEmailTemplateHeaders = dataclasses.field()
    path_params: DeleteCustomVerificationEmailTemplatePathParams = dataclasses.field()
...
class DeleteCustomVerificationEmailTemplateResponse:
    ...
    delete_custom_verification_email_template_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
