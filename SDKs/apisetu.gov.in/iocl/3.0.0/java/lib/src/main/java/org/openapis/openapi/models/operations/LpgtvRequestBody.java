...
public class LpgtvRequestBody {
    ...
    public LpgtvRequestBody withConsentArtifact(org.openapis.openapi.models.shared.ConsentArtifactSchema consentArtifact) {
    ...
    public LpgtvRequestBody(@JsonProperty("format") LpgtvRequestBodyFormatEnum format, @JsonProperty("txnId") String txnId) {
        this.format = format;
        this.txnId = txnId;
  }
}
