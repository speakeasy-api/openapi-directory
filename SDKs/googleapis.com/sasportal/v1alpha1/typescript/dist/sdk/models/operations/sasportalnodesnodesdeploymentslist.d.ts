...
export declare class SasportalNodesNodesDeploymentsListSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesNodesDeploymentsListSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesNodesDeploymentsListSecurity extends SpeakeasyBase {
    option1?: SasportalNodesNodesDeploymentsListSecurityOption1;
    option2?: SasportalNodesNodesDeploymentsListSecurityOption2;
}
