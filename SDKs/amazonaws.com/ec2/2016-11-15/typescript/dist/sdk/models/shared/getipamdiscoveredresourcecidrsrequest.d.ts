 ...
 */
export declare class GetIpamDiscoveredResourceCidrsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetIpamDiscoveredResourceCidrsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: GetIpamDiscoveredResourceCidrsRequestFilters[];
