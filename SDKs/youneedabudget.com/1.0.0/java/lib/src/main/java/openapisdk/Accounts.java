...
public class Accounts {
    ...
    **/
    public openapisdk.models.operations.CreateAccountResponse createAccount(openapisdk.models.operations.CreateAccountRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/budgets/{budget_id}/accounts", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.GetAccountByIdResponse getAccountById(openapisdk.models.operations.GetAccountByIdRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/budgets/{budget_id}/accounts/{account_id}", request.pathParams);
    ...
    public openapisdk.models.operations.GetAccountsResponse getAccounts(openapisdk.models.operations.GetAccountsRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.AccountsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.AccountsResponse.class);
