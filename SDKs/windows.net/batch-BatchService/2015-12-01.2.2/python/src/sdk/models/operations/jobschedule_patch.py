...
from ..shared import jobschedulepatchparameter as shared_jobschedulepatchparameter
...
class JobSchedulePatchRequest:
    ...
    r"""The id of the job schedule to update."""  
    job_schedule_patch_parameter: shared_jobschedulepatchparameter.JobSchedulePatchParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
