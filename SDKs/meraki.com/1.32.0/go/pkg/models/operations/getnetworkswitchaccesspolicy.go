...
func (e GetNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum) ToPointer() *GetNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum {
	return &e
}
...
func (e *GetNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "MAC authentication bypass":
		*e = GetNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum: %v", v)
	}
}
...
func (e GetNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum) ToPointer() *GetNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum {
	return &e
}
...
func (e *GetNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "both":
		fallthrough
	case "inbound":
		*e = GetNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum: %v", v)
	}
}
...
func (e GetNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum) ToPointer() *GetNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum {
	return &e
}
...
func (e *GetNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Multi-Host":
		fallthrough
	case "Single-Host":
		*e = GetNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum: %v", v)
	}
}
