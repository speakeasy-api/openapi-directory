...
class TaskAddCollectionRequest:
    headers: TaskAddCollectionHeaders = dataclasses.field()
    path_params: TaskAddCollectionPathParams = dataclasses.field()
    query_params: TaskAddCollectionQueryParams = dataclasses.field()
...
class TaskAddCollectionResponse:
    ...
    task_add_collection_result: Optional[Any] = dataclasses.field(default=None)
