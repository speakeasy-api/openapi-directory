...
class CloudchannelAccountsCustomersListPurchasableSkusChangeOfferPurchaseChangeTypeEnum(str, Enum):
    r"""Required. Change Type for the entitlement."""
...
class CloudchannelAccountsCustomersListPurchasableSkusRequest:
    ...
    r"""Required. The resource name of the customer to list SKUs for. Format: accounts/{account_id}/customers/{customer_id}."""  
    ...
    r"""Required. Resource name of the entitlement. Format: accounts/{account_id}/customers/{customer_id}/entitlements/{entitlement_id}"""  
    ...
    r"""Required. List SKUs belonging to this Product. Format: products/{product_id}. Supports products/- to retrieve SKUs for all products."""  
    ...
    r"""Optional. Requested page size. Server might return fewer results than requested. If unspecified, returns at most 100 SKUs. The maximum value is 1000; the server will coerce values above 1000."""  
