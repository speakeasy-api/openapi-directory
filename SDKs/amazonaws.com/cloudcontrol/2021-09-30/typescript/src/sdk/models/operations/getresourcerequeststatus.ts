...
export enum GetResourceRequestStatusXAmzTargetEnum {
  CloudApiServiceGetResourceRequestStatus = "CloudApiService.GetResourceRequestStatus",
}

export class GetResourceRequestStatusRequest extends SpeakeasyBase {
...
export class GetResourceRequestStatusResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
