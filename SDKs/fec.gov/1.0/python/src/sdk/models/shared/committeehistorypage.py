...
class CommitteeHistoryPage:
    ...
    results: Optional[list[shared_committeehistory.CommitteeHistory]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
