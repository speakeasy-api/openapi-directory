 ...
 */
export declare enum PacketMirroringListWarningCodeEnum {
...
export declare class PacketMirroringListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class PacketMirroringListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: PacketMirroringListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: PacketMirroringListWarningData[];
    /**
 ...
 */
export declare class PacketMirroringList extends SpeakeasyBase {
    /**
