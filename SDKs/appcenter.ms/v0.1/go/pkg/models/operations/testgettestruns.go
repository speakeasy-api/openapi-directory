...
type TestGetTestRunsSecurity struct {
	APIToken shared.SchemeAPIToken `security:"scheme,type=apiKey,subtype=header"`
}

type TestGetTestRunsPathParams struct {
...
type TestGetTestRunsRequest struct {
	PathParams TestGetTestRunsPathParams
	Security   TestGetTestRunsSecurity
}

// TestGetTestRunsTestRunTestRunStatistics - Summary single test run on Xamarin Test Cloud
type TestGetTestRunsTestRunTestRunStatistics struct {
...
type TestGetTestRunsTestRun struct {
	...
	Stats *TestGetTestRunsTestRunTestRunStatistics `json:"stats,omitempty"`
...
type TestGetTestRunsResponse struct {
	ContentType string
	StatusCode  int
