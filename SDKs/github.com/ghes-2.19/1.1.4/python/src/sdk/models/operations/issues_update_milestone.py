...
class IssuesUpdateMilestoneRequestBody:
    ...
    state: Optional[IssuesUpdateMilestoneRequestBodyStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
    r"""The state of the milestone. Either `open` or `closed`."""  
...
class IssuesUpdateMilestoneRequest:
    ...
    request_body: Optional[IssuesUpdateMilestoneRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
