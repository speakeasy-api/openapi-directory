...
class TestGetDeviceSetOfUserDeviceSetDeviceConfigurations:
    ...
    image: Optional[TestGetDeviceSetOfUserDeviceSetDeviceConfigurationsImage] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('image'), 'exclude': lambda f: f is None }})  
    model: Optional[TestGetDeviceSetOfUserDeviceSetDeviceConfigurationsModel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model'), 'exclude': lambda f: f is None }})  
...
class TestGetDeviceSetOfUserDeviceSet:
    ...
    device_configurations: list[TestGetDeviceSetOfUserDeviceSetDeviceConfigurations] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deviceConfigurations') }})  
    id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id') }})
    r"""Identifier of the device set"""  
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})
    r"""Name of the device set"""  
    owner: TestGetDeviceSetOfUserDeviceSetDeviceSetOwner = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('owner') }})
    r"""The owner of a device set"""  
...
class TestGetDeviceSetOfUserResponse:
    ...
    device_set: Optional[TestGetDeviceSetOfUserDeviceSet] = dataclasses.field(default=None)
    r"""OK"""  
