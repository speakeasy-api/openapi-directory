...
var ListInteractionChannelParticipantSecurity = /** @class */ (function (_super) {
    ...
    ], ListInteractionChannelParticipantSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListInteractionChannelParticipantSecurity.prototype, "username", void 0);
...
var ListInteractionChannelParticipantRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListInteractionChannelParticipantRequest.prototype, "channelSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=InteractionSid",
        }),
        __metadata("design:type", String)
    ], ListInteractionChannelParticipantRequest.prototype, "interactionSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListInteractionChannelParticipantRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListInteractionChannelParticipantRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListInteractionChannelParticipantRequest.prototype, "pageToken", void 0);
...
var ListInteractionChannelParticipantListInteractionChannelParticipantResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.FlexV1InteractionInteractionChannelInteractionChannelParticipant,
        }),
        (0, class_transformer_1.Expose)({ name: "participants" }),
        (0, class_transformer_1.Type)(function () {
            return shared.FlexV1InteractionInteractionChannelInteractionChannelParticipant;
        }),
...
var ListInteractionChannelParticipantResponse = /** @class */ (function (_super) {
    ...
    ], ListInteractionChannelParticipantResponse.prototype, "rawResponse", void 0);
