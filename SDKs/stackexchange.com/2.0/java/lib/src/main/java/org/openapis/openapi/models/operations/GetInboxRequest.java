...
public class GetInboxRequest {
    ...
    public GetInboxRequest withCallback(String callback) {
    ...
    public GetInboxRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetInboxRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetInboxRequest withPagesize(Long pagesize) {
