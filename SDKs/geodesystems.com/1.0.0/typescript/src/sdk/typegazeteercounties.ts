...
export class TypeGazeteerCounties {
  ...
  searchGazeteerCounties(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/gazeteer_counties";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchGazeteerCountiesResponse =
        new operations.SearchGazeteerCountiesResponse({
