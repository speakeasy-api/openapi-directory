...
func (e GetLabelDetectionXAmzTargetEnum) ToPointer() *GetLabelDetectionXAmzTargetEnum {
	return &e
}
...
func (e *GetLabelDetectionXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "RekognitionService.GetLabelDetection":
		*e = GetLabelDetectionXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetLabelDetectionXAmzTargetEnum: %v", v)
	}
}
