...
import dataclasses
from ..shared import employeepayroll as shared_employeepayroll
...
class GetEmployeePayrollResponse:
    ...
    data: shared_employeepayroll.EmployeePayroll = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
