...
class VisionProjectsLocationsFilesAsyncBatchAnnotateRequest:
    ...
    google_cloud_vision_v1p1beta1_async_batch_annotate_files_request: Optional[shared_googlecloudvisionv1p1beta1asyncbatchannotatefilesrequest.GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
