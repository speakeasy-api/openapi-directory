...
class GetNhClothingClothingRequest:
    ...
    clothing: str = dataclasses.field(metadata={'path_param': { 'field_name': 'clothing', 'style': 'simple', 'explode': False }})
    r"""The name of the clothing you wish to retrieve information about."""  
...
class GetNhClothingClothingResponse:
    ...
    nh_clothing: Optional[shared_nhclothing.NHClothing] = dataclasses.field(default=None)
