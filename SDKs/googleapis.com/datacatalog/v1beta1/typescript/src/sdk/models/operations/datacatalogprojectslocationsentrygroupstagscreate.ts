...
export class DatacatalogProjectsLocationsEntryGroupsTagsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatacatalogProjectsLocationsEntryGroupsTagsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatacatalogProjectsLocationsEntryGroupsTagsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
