...
public class Config {
    ...
    **/
    public openapisdk.models.operations.ConfigListResponse configList() throws Exception {
        ...
        openapisdk.models.operations.ConfigListResponse res = new openapisdk.models.operations.ConfigListResponse() {{
        }};
