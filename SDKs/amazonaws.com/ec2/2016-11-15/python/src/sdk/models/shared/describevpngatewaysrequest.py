...
class DescribeVpnGatewaysRequest:
    r"""Contains the parameters for DescribeVpnGateways."""
    
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeVpnGatewaysRequestFilters]] = dataclasses.field(default=None)  
    vpn_gateway_ids: Optional[list[str]] = dataclasses.field(default=None)  
