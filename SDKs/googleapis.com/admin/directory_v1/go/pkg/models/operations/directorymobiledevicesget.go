...
func (e DirectoryMobiledevicesGetProjectionEnum) ToPointer() *DirectoryMobiledevicesGetProjectionEnum {
	return &e
}
...
func (e *DirectoryMobiledevicesGetProjectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "BASIC":
		fallthrough
	case "FULL":
		*e = DirectoryMobiledevicesGetProjectionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DirectoryMobiledevicesGetProjectionEnum: %v", v)
	}
}
