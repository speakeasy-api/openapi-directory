...
class ListMemberListMemberResponse:
    members: Optional[list[shared_chat_v2_service_channel_member.ChatV2ServiceChannelMember]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('members') }})
