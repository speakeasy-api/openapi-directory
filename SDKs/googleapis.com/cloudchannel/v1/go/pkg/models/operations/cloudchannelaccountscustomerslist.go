...
type CloudchannelAccountsCustomersListPathParams struct {
...
type CloudchannelAccountsCustomersListQueryParams struct {
	// V1 error format.
...
type CloudchannelAccountsCustomersListRequest struct {
	PathParams  CloudchannelAccountsCustomersListPathParams
	QueryParams CloudchannelAccountsCustomersListQueryParams
	Security    CloudchannelAccountsCustomersListSecurity
}
