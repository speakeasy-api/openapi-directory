...
class PostUsersRequestBodySslRequiredEnum(str, Enum):
    USE_SYSTEM_SETTING = "use_system_setting"
    ALWAYS_REQUIRE = "always_require"
    NEVER_REQUIRE = "never_require"
...
class PostUsersRequestBody:
    ...
    authentication_method: Optional[PostUsersRequestBodyAuthenticationMethodEnum] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'authentication_method' }})
    avatar_delete: Optional[bool] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'avatar_delete' }})
    avatar_file: Optional[PostUsersRequestBodyAvatarFile] = dataclasses.field(default=None, metadata={'multipart_form': { 'file': True }})
    ...
    require_2fa: Optional[PostUsersRequestBodyRequire2faEnum] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'require_2fa' }})
    ...
    ssl_required: Optional[PostUsersRequestBodySslRequiredEnum] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'ssl_required' }})
...
class PostUsersRequest:
    request: Optional[PostUsersRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})
