...
type ClassroomUserProfilesGuardianInvitationsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ClassroomUserProfilesGuardianInvitationsCreatePathParams struct {
	// ID of the student (in standard format)
	StudentID string `pathParam:"style=simple,explode=false,name=studentId"`
}

type ClassroomUserProfilesGuardianInvitationsCreateQueryParams struct {
	// V1 error format.
...
type ClassroomUserProfilesGuardianInvitationsCreateRequest struct {
...
type ClassroomUserProfilesGuardianInvitationsCreateResponse struct {
	ContentType string
	// Successful response
