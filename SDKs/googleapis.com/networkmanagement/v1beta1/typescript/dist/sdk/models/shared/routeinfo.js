...
var RouteInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "destIpRange" }),
        __metadata("design:type", String)
    ], RouteInfo.prototype, "destIpRange", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "destPortRanges" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "nextHop" }),
        __metadata("design:type", String)
    ], RouteInfo.prototype, "nextHop", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "nextHopType" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "srcIpRange" }),
        __metadata("design:type", String)
    ], RouteInfo.prototype, "srcIpRange", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "srcPortRanges" }),
        __metadata("design:type", Array)
