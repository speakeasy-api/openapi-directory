...
public class FindContactsQueryParams {
    /**
    ...
    public FindContactsQueryParams withContactListId(Long contactListId) {
    ...
    public FindContactsQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public Long[] id;
    public FindContactsQueryParams withId(Long[] id) {
        this.id = id;
        return this;
    }
    ...
    public FindContactsQueryParams withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public FindContactsQueryParams withNumber(String[] number) {
        this.number = number;
        return this;
    }
    ...
    public FindContactsQueryParams withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public FindContactsQueryParams withPropertyName(String propertyName) {
    ...
    public FindContactsQueryParams withPropertyValue(String propertyValue) {
