...
class KmsKeyConfiguration:
    ...
    grants: Optional[list[shared_kmsgrantconfiguration.KmsGrantConfiguration]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('grants') }})
    key_policies: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('keyPolicies') }})
