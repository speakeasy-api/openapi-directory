...
export enum DomainVerificationDetailCertificateAuthorityAuthorizationRecommendationsEnum {
...
export enum DomainVerificationDetailCertificateAuthorityAuthorizationStatusEnum {
    Pending = "PENDING",
 ...
 * 
**/
export class DomainVerificationDetailCertificateAuthorityAuthorization extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=completedAt" })
  completedAt?: string;

  @SpeakeasyMetadata({ data: "json, name=queryPaths" })
  queryPaths?: string[];
...
export enum DomainVerificationDetailStatusEnum {
    Completed = "COMPLETED",
...
export enum DomainVerificationDetailTypeEnum {
...
export enum DomainVerificationDetailUsageEnum {
    CommonName = "COMMON_NAME",
    SubjectAlternativeName = "SUBJECT_ALTERNATIVE_NAME"
}


export class DomainVerificationDetail extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=certificateAuthorityAuthorization" })
  certificateAuthorityAuthorization?: DomainVerificationDetailCertificateAuthorityAuthorization;

  @SpeakeasyMetadata({ data: "json, name=createdAt" })
  createdAt: string;

  @SpeakeasyMetadata({ data: "json, name=dceToken" })
  dceToken?: string;

  @SpeakeasyMetadata({ data: "json, name=domain" })
  domain: string;

  @SpeakeasyMetadata({ data: "json, name=domainEntityId" })
