...
class Secrets:
    ...
    def secrets_choices_list(self) -> operations.SecretsChoicesListResponse:
        ...
        res = operations.SecretsChoicesListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def secrets_choices_read(self, request: operations.SecretsChoicesReadRequest) -> operations.SecretsChoicesReadResponse:
        ...
        url = utils.generate_url(operations.SecretsChoicesReadRequest, base_url, '/secrets/_choices/{id}/', request)
        ...
        res = operations.SecretsChoicesReadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
