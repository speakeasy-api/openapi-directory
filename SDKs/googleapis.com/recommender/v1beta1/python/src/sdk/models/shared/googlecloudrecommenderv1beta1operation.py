...
class GoogleCloudRecommenderV1beta1Operation:
    ...
    path_value_matchers: Optional[dict[str, shared_googlecloudrecommenderv1beta1valuematcher.GoogleCloudRecommenderV1beta1ValueMatcher]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pathValueMatchers'), 'exclude': lambda f: f is None }})
    ...
    value_matcher: Optional[shared_googlecloudrecommenderv1beta1valuematcher.GoogleCloudRecommenderV1beta1ValueMatcher] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('valueMatcher'), 'exclude': lambda f: f is None }})
