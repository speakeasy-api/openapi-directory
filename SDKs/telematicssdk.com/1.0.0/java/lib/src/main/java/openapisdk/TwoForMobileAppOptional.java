...
public class TwoForMobileAppOptional {
     ...
     * Trips - trip details
    **/
    public openapisdk.models.operations.TripsTripDetailsResponse tripsTripDetails(openapisdk.models.operations.TripsTripDetailsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/mobilesdk/stage/track/get_track/v1");
        ...
        openapisdk.models.operations.TripsTripDetailsResponse res = new openapisdk.models.operations.TripsTripDetailsResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.operations.TripsTripDetails200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.TripsTripDetails200ApplicationJson.class);
    ...
    **/
    public openapisdk.models.operations.UserSafeScoringAccumulatedValueV1ScoringsIndividualResponse userSafeScoringAccumulatedValueV1ScoringsIndividual(openapisdk.models.operations.UserSafeScoringAccumulatedValueV1ScoringsIndividualRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/statistics/v1/Scorings/individual/");
        ...
        openapisdk.models.operations.UserSafeScoringAccumulatedValueV1ScoringsIndividualResponse res = new openapisdk.models.operations.UserSafeScoringAccumulatedValueV1ScoringsIndividualResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.UserSafeScoringAccumulatedValueV1ScoringsIndividual200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.UserSafeScoringAccumulatedValueV1ScoringsIndividual200ApplicationJson.class);
    ...
    **/
    public openapisdk.models.operations.UserSafeScoringDailyValueV1ScoringsIndividualDailyResponse userSafeScoringDailyValueV1ScoringsIndividualDaily(openapisdk.models.operations.UserSafeScoringDailyValueV1ScoringsIndividualDailyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/statistics/v1/Scorings/individual/daily");
        ...
        openapisdk.models.operations.UserSafeScoringDailyValueV1ScoringsIndividualDailyResponse res = new openapisdk.models.operations.UserSafeScoringDailyValueV1ScoringsIndividualDailyResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.UserSafeScoringDailyValueV1ScoringsIndividualDaily200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.UserSafeScoringDailyValueV1ScoringsIndividualDaily200ApplicationJson.class);
