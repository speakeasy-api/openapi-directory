...
var Auth = /** @class */ (function () {
    ...
    **/
    Auth.prototype.getAuthIntrospect = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAuthIntrospectRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/auth/introspect";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.introspection = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
