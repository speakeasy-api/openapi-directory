...
class SMSChannelResponse:
    ...
    promotional_messages_per_second: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PromotionalMessagesPerSecond'), 'exclude': lambda f: f is None }})  
    ...
    transactional_messages_per_second: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TransactionalMessagesPerSecond'), 'exclude': lambda f: f is None }})  
