...
class GetAdminMappingsStubMappingID200ApplicationJSONRequest:
    ...
    basic_auth_credentials: Optional[GetAdminMappingsStubMappingID200ApplicationJSONRequestBasicAuthCredentials] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('basicAuthCredentials'), 'exclude': lambda f: f is None }})
    r"""Pre-emptive basic auth credentials to match against"""  
...
class GetAdminMappingsStubMappingID200ApplicationJSONResponseDelayDistributionUniformTypeEnum(str, Enum):
    UNIFORM = 'uniform'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetAdminMappingsStubMappingID200ApplicationJSONResponseDelayDistributionUniform:
    ...
    type: Optional[GetAdminMappingsStubMappingID200ApplicationJSONResponseDelayDistributionUniformTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class GetAdminMappingsStubMappingID200ApplicationJSONResponseDelayDistributionLogNormalTypeEnum(str, Enum):
    LOGNORMAL = 'lognormal'
...
class GetAdminMappingsStubMappingID200ApplicationJSONResponseDelayDistributionLogNormal:
    ...
    type: Optional[GetAdminMappingsStubMappingID200ApplicationJSONResponseDelayDistributionLogNormalTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class GetAdminMappingsStubMappingID200ApplicationJSONResponse:
    ...
    fault: Optional[GetAdminMappingsStubMappingID200ApplicationJSONResponseFaultEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fault'), 'exclude': lambda f: f is None }})
    r"""The fault to apply (instead of a full, valid response)."""  
...
class GetAdminMappingsStubMappingID200ApplicationJSON:
    ...
    request: Optional[GetAdminMappingsStubMappingID200ApplicationJSONRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('request'), 'exclude': lambda f: f is None }})  
    ...
    response: Optional[GetAdminMappingsStubMappingID200ApplicationJSONResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response'), 'exclude': lambda f: f is None }})  
