...
var GameLinesLines = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=awayMoneyline" }),
        __metadata("design:type", Number)
    ], GameLinesLines.prototype, "awayMoneyline", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=formattedSpread" }),
        __metadata("design:type", String)
    ], GameLinesLines.prototype, "formattedSpread", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=homeMoneyline" }),
        __metadata("design:type", Number)
    ], GameLinesLines.prototype, "homeMoneyline", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=overUnder" }),
        __metadata("design:type", Number)
    ], GameLinesLines.prototype, "overUnder", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=overUnderOpen" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=spreadOpen" }),
        __metadata("design:type", Number)
...
var GameLines = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=lines", elemType: GameLinesLines }),
