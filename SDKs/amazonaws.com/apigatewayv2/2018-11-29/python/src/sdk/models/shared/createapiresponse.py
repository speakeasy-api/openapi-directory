...
class CreateAPIResponseProtocolTypeEnum(str, Enum):
    r"""The API protocol."""
    WEBSOCKET = 'WEBSOCKET'
    HTTP = 'HTTP'
...
class CreateAPIResponse:
    ...
    cors_configuration: Optional[CreateAPIResponseCorsConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CorsConfiguration'), 'exclude': lambda f: f is None }})  
    ...
    protocol_type: Optional[CreateAPIResponseProtocolTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ProtocolType'), 'exclude': lambda f: f is None }})  
