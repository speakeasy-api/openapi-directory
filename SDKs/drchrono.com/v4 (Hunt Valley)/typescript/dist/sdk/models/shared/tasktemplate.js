...
var TaskTemplate = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "default_assignee_group" }),
        __metadata("design:type", Number)
    ], TaskTemplate.prototype, "defaultAssigneeGroup", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "default_assignee_user" }),
        __metadata("design:type", String)
    ], TaskTemplate.prototype, "defaultAssigneeUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "default_category" }),
        __metadata("design:type", Number)
    ], TaskTemplate.prototype, "defaultCategory", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "default_due_date_offset" }),
        __metadata("design:type", String)
    ], TaskTemplate.prototype, "defaultDueDateOffset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "default_note" }),
        __metadata("design:type", String)
    ], TaskTemplate.prototype, "defaultNote", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "default_priority" }),
        __metadata("design:type", String)
    ], TaskTemplate.prototype, "defaultPriority", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "default_status" }),
        __metadata("design:type", Number)
    ], TaskTemplate.prototype, "defaultStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "default_title" }),
        __metadata("design:type", String)
