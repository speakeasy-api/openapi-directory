...
class AdexchangebuyerPretargetingConfigUpdateRequest:
    ...
    r"""The account id to update the pretargeting config for."""  
    config_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'configId', 'style': 'simple', 'explode': False }})
    r"""The specific id of the configuration to update."""  
    ...
    pretargeting_config: Optional[shared_pretargetingconfig.PretargetingConfig] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
