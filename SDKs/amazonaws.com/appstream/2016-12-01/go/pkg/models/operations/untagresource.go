...
const (
	UntagResourceXAmzTargetEnumPhotonAdminProxyServiceUntagResource UntagResourceXAmzTargetEnum = "PhotonAdminProxyService.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "PhotonAdminProxyService.UntagResource":
