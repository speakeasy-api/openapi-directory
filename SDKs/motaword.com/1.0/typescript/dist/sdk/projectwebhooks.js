...
exports.ProjectWebhooks = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ProjectWebhooks = /** @class */ (function () {
    function ProjectWebhooks(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ProjectWebhooks.prototype.deleteProjectWebhook = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteProjectWebhookRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/projects/{id}/webhooks", req.pathParams);
    ...
    **/
    ProjectWebhooks.prototype.getProjectWebhooks = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ProjectWebhooks.prototype.postProjectWebhook = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update project webhook URL
    **/
    ProjectWebhooks.prototype.updateProjectWebhook = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.ProjectWebhooks = ProjectWebhooks;
