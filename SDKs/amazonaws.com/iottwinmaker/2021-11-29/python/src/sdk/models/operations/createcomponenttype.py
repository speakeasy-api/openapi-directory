...
from ..shared import createcomponenttyperesponse as shared_createcomponenttyperesponse
...
class CreateComponentTypeRequestBody:
    ...
    r"""A friendly name for the component type."""  
    ...
    r"""Specifies the parent component type to extend."""  
    ...
    r"""Metadata that you can use to manage the component type."""  
...
class CreateComponentTypeRequest:
    ...
    request_body: CreateComponentTypeRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    workspace_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'workspaceId', 'style': 'simple', 'explode': False }})
    r"""The ID of the workspace that contains the component type."""  
...
class CreateComponentTypeResponse:
    ...
    r"""ConflictException"""  
    create_component_type_response: Optional[shared_createcomponenttyperesponse.CreateComponentTypeResponse] = dataclasses.field(default=None)
    r"""Success"""  
