 ...
 */
export declare class UpdateZoomRoomAccSettingsApplicationJson2ClientAlert extends SpeakeasyBase {
    /**
...
export declare class UpdateZoomRoomAccSettingsApplicationJson2DigitalSignageBanner extends SpeakeasyBase {
 ...
 */
export declare class UpdateZoomRoomAccSettingsApplicationJson2DigitalSignageDisplayPeriod extends SpeakeasyBase {
    /**
 ...
 *
 */
export declare enum UpdateZoomRoomAccSettingsApplicationJson2DigitalSignagePlayListActionEnum {
    Add = "add",
    Update = "update",
    Delete = "delete"
}
 ...
 * Content list.
 */
export declare class UpdateZoomRoomAccSettingsApplicationJson2DigitalSignagePlayListContents extends SpeakeasyBase {
    /**
...
export declare class UpdateZoomRoomAccSettingsApplicationJson2DigitalSignagePlayList extends SpeakeasyBase {
    /**
     * Specify an action for the content list. The value can be one of the following:<br>
     *
     * @remarks
...
export declare class UpdateZoomRoomAccSettingsApplicationJson2DigitalSignage extends SpeakeasyBase {
 ...
 */
export declare class UpdateZoomRoomAccSettingsApplicationJson2Notification extends SpeakeasyBase {
    /**
...
export declare class UpdateZoomRoomAccSettingsApplicationJson2 extends SpeakeasyBase {
    /**
     * The Client Alert Settings section includes alerts that display on the TV screen of the Zoom Room. Disable these settings if you have deliberately disconnected one or more peripheral devices or have never enabled them.
     */
...
export declare class UpdateZoomRoomAccSettingsApplicationJson1ZoomRooms extends SpeakeasyBase {
    /**
...
export declare class UpdateZoomRoomAccSettingsApplicationJson1 extends SpeakeasyBase {
