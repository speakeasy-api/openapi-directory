...
from ..shared import getjourneyexecutionmetricsresponse as shared_getjourneyexecutionmetricsresponse


@dataclasses.dataclass
class GetJourneyExecutionMetricsPathParams:
...
@dataclasses.dataclass
class GetJourneyExecutionMetricsQueryParams:
...
@dataclasses.dataclass
class GetJourneyExecutionMetricsHeaders:
...
class GetJourneyExecutionMetricsRequest:
    headers: GetJourneyExecutionMetricsHeaders = dataclasses.field()
    path_params: GetJourneyExecutionMetricsPathParams = dataclasses.field()
    query_params: GetJourneyExecutionMetricsQueryParams = dataclasses.field()
...
class GetJourneyExecutionMetricsResponse:
    ...
    get_journey_execution_metrics_response: Optional[shared_getjourneyexecutionmetricsresponse.GetJourneyExecutionMetricsResponse] = dataclasses.field(default=None)
