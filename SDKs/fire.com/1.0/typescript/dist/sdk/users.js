...
var Users = /** @class */ (function () {
    ...
    Users.prototype.getUser = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/user/{userId}", req);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.user = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetUserUser);
                    }
                    break;
            }
            return res;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        ...
                        res.users = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetUsersUser, resFieldDepth);
                    }
                    break;
            }
            return res;
