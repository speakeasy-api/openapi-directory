...
class ListLoggingConfigurationsRequest:
    ...
    list_logging_configurations_request: shared_listloggingconfigurationsrequest.ListLoggingConfigurationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
