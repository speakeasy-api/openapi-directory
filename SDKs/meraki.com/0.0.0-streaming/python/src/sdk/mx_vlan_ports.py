...
class MXVLANPorts:
    ...
    def get_network_appliance_port(self, request: operations.GetNetworkAppliancePortRequest) -> operations.GetNetworkAppliancePortResponse:
        ...
        url = utils.generate_url(operations.GetNetworkAppliancePortRequest, base_url, '/networks/{networkId}/appliancePorts/{appliancePortId}', request)
    ...
    def get_network_appliance_ports(self, request: operations.GetNetworkAppliancePortsRequest) -> operations.GetNetworkAppliancePortsResponse:
        ...
        url = utils.generate_url(operations.GetNetworkAppliancePortsRequest, base_url, '/networks/{networkId}/appliancePorts', request)
    ...
    def update_network_appliance_port(self, request: operations.UpdateNetworkAppliancePortRequest) -> operations.UpdateNetworkAppliancePortResponse:
        ...
        url = utils.generate_url(operations.UpdateNetworkAppliancePortRequest, base_url, '/networks/{networkId}/appliancePorts/{appliancePortId}', request)
