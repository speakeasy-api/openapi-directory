...
public class WorkTypeApiUpdateJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public WorkTypeApiUpdateJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public WorkTypeApiUpdateJsonHeaders withXAuthSecret(String xAuthSecret) {
