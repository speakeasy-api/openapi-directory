...
export class ChatSpacesMessagesPatchSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ChatSpacesMessagesPatchSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ChatSpacesMessagesPatchSecurity extends SpeakeasyBase {
...
export class ChatSpacesMessagesPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ChatSpacesMessagesPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
