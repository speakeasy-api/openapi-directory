...
@dataclasses.dataclass
class StorageObjectAccessControlsInsertQueryParams:
...
class StorageObjectAccessControlsInsertRequest:
    path_params: StorageObjectAccessControlsInsertPathParams = dataclasses.field()
    query_params: StorageObjectAccessControlsInsertQueryParams = dataclasses.field()
    security: StorageObjectAccessControlsInsertSecurity = dataclasses.field()
