...
func (e VmxNetworkDevicesClaimRequestBodySizeEnum) ToPointer() *VmxNetworkDevicesClaimRequestBodySizeEnum {
	return &e
}
...
func (e *VmxNetworkDevicesClaimRequestBodySizeEnum) UnmarshalJSON(data []byte) error {
	...
	case "medium":
		fallthrough
	case "small":
		*e = VmxNetworkDevicesClaimRequestBodySizeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for VmxNetworkDevicesClaimRequestBodySizeEnum: %v", v)
	}
}
