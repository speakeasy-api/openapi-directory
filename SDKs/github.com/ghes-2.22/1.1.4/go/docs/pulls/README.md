...
func main() {
    ...
    res, err := s.Pulls.PullsListCommentsForReview(ctx, operations.PullsListCommentsForReviewRequest{
        Owner: "debitis",
        Page: sdk.Int64(966148),
        PerPage: sdk.Int64(65082),
        PullNumber: 791880,
        Repo: "fuga",
        ReviewID: 675689,
    })
...
func main() {
    ...
    res, err := s.Pulls.PullsListCommits(ctx, operations.PullsListCommitsRequest{
        Owner: "consectetur",
        Page: sdk.Int64(244889),
        PerPage: sdk.Int64(538869),
        PullNumber: 216457,
        Repo: "impedit",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Pulls.PullsListFiles(ctx, operations.PullsListFilesRequest{
        Owner: "magni",
        Page: sdk.Int64(746585),
        PerPage: sdk.Int64(922757),
        PullNumber: 721430,
        Repo: "dolore",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Pulls.PullsListReviewComments(ctx, operations.PullsListReviewCommentsRequest{
        ...
        Owner: "deleniti",
        Page: sdk.Int64(844235),
        PerPage: sdk.Int64(437814),
        PullNumber: 139072,
        Repo: "voluptatibus",
        Since: types.MustTimeFromString("2022-09-13T04:46:56.015Z"),
...
func main() {
    ...
    res, err := s.Pulls.PullsListReviewCommentsForRepo(ctx, operations.PullsListReviewCommentsForRepoRequest{
        ...
        Repo: "voluptatibus",
        Since: types.MustTimeFromString("2022-03-21T12:53:49.231Z"),
