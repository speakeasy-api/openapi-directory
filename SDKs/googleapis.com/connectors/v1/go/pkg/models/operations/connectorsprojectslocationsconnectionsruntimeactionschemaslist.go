...
type ConnectorsProjectsLocationsConnectionsRuntimeActionSchemasListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ConnectorsProjectsLocationsConnectionsRuntimeActionSchemasListPathParams struct {
...
type ConnectorsProjectsLocationsConnectionsRuntimeActionSchemasListQueryParams struct {
	// V1 error format.
...
type ConnectorsProjectsLocationsConnectionsRuntimeActionSchemasListRequest struct {
...
type ConnectorsProjectsLocationsConnectionsRuntimeActionSchemasListResponse struct {
	ContentType string
	// Successful response
