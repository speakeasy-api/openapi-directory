...
class GetVirtualMachineResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetVirtualMachineOutput $getVirtualMachineOutput
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetVirtualMachineOutput $getVirtualMachineOutput = null;
	...
	{
		$this->contentType = "";
		$this->getVirtualMachineOutput = null;
