...
func (e UpdateServiceSettingsRequestBodyLinuxSubscriptionsDiscoveryEnum) ToPointer() *UpdateServiceSettingsRequestBodyLinuxSubscriptionsDiscoveryEnum {
	return &e
}
...
func (e *UpdateServiceSettingsRequestBodyLinuxSubscriptionsDiscoveryEnum) UnmarshalJSON(data []byte) error {
	...
	case "Enabled":
		fallthrough
	case "Disabled":
		*e = UpdateServiceSettingsRequestBodyLinuxSubscriptionsDiscoveryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateServiceSettingsRequestBodyLinuxSubscriptionsDiscoveryEnum: %v", v)
	}
}
