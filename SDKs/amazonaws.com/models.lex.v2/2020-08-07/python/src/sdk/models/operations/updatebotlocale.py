...
class UpdateBotLocaleRequestBody:
    ...
    voice_settings: Optional[UpdateBotLocaleRequestBodyVoiceSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voiceSettings') }})
    

@dataclasses.dataclass
class UpdateBotLocaleRequest:
    headers: UpdateBotLocaleHeaders = dataclasses.field()
    path_params: UpdateBotLocalePathParams = dataclasses.field()
    request: UpdateBotLocaleRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
