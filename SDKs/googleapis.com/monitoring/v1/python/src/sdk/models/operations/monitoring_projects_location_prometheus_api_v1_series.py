...
class MonitoringProjectsLocationPrometheusAPIV1SeriesRequest:
    ...
    query_series_request: Optional[shared_queryseriesrequest.QuerySeriesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
