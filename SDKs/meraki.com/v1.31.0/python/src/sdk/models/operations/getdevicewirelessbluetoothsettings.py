...
@dataclasses.dataclass
class GetDeviceWirelessBluetoothSettings200ApplicationJSON:
...
class GetDeviceWirelessBluetoothSettingsResponse:
    ...
    get_device_wireless_bluetooth_settings_200_application_json_object: Optional[GetDeviceWirelessBluetoothSettings200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
