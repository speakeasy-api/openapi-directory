...
var correlatedcolumn_1 = require("./correlatedcolumn");
...
var ColumnSpec = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "dataStats" }),
        (0, class_transformer_1.Type)(function () { return datastats_1.DataStats; }),
        __metadata("design:type", datastats_1.DataStats)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: correlatedcolumn_1.CorrelatedColumn }),
        (0, class_transformer_1.Expose)({ name: "topCorrelatedColumns" }),
        (0, class_transformer_1.Type)(function () { return correlatedcolumn_1.CorrelatedColumn; }),
