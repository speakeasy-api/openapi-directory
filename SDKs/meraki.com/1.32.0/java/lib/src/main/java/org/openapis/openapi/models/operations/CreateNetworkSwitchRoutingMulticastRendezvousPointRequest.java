...
public class CreateNetworkSwitchRoutingMulticastRendezvousPointRequest {
    ...
    public CreateNetworkSwitchRoutingMulticastRendezvousPointRequest(@JsonProperty("RequestBody") CreateNetworkSwitchRoutingMulticastRendezvousPointRequestBody requestBody, @JsonProperty("networkId") String networkId) {
        this.requestBody = requestBody;
        this.networkId = networkId;
  }
}
