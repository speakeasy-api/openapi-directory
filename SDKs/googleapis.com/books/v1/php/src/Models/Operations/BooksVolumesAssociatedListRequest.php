...
class BooksVolumesAssociatedListRequest
{
     ...
     * Association type.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\BooksVolumesAssociatedListAssociationEnum $association
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=association')]
    public ?BooksVolumesAssociatedListAssociationEnum $association = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\BooksVolumesAssociatedListMaxAllowedMaturityRatingEnum $maxAllowedMaturityRating
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=maxAllowedMaturityRating')]
    public ?BooksVolumesAssociatedListMaxAllowedMaturityRatingEnum $maxAllowedMaturityRating = null;
