...
export class MybusinessAccountsLocationsMediaCustomersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinessAccountsLocationsMediaCustomersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
