...
class AppengineAppsAuthorizedCertificatesDeleteRequest:
    path_params: AppengineAppsAuthorizedCertificatesDeletePathParams = dataclasses.field()
    query_params: AppengineAppsAuthorizedCertificatesDeleteQueryParams = dataclasses.field()
    security: AppengineAppsAuthorizedCertificatesDeleteSecurity = dataclasses.field()
