...
class ReactionsListForTeamDiscussionLegacyRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ReactionsListForTeamDiscussionLegacyContentEnum $content
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=content')]
    public ?ReactionsListForTeamDiscussionLegacyContentEnum $content = null;
