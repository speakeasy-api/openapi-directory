 ...
 */
public class PreprintsReadPreprintRelationships {
    /**
    ...
    public PreprintsReadPreprintRelationships withBibliographicContributors(String bibliographicContributors) {
    ...
    public PreprintsReadPreprintRelationships withCitation(String citation) {
    ...
    public PreprintsReadPreprintRelationships withIdentifiers(String identifiers) {
    ...
    public PreprintsReadPreprintRelationships withLicense(String license) {
    ...
    public PreprintsReadPreprintRelationships withNode(String node) {
        this.node = node;
        return this;
    }
    ...
    public PreprintsReadPreprintRelationships withPrimaryFile(String primaryFile) {
    ...
    public PreprintsReadPreprintRelationships withProvider(String provider) {
        this.provider = provider;
        return this;
    }
    
    public PreprintsReadPreprintRelationships(@JsonProperty("node") String node, @JsonProperty("primary_file") String primaryFile, @JsonProperty("provider") String provider) {
        this.node = node;
        this.primaryFile = primaryFile;
        this.provider = provider;
  }
