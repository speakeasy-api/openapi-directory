...
public class CreateCertificateAuthorityAuditReportRequest {
    ...
    public CreateCertificateAuthorityAuditReportRequest(@JsonProperty("CreateCertificateAuthorityAuditReportRequest") org.openapis.openapi.models.shared.CreateCertificateAuthorityAuditReportRequest createCertificateAuthorityAuditReportRequest, @JsonProperty("X-Amz-Target") CreateCertificateAuthorityAuditReportXAmzTargetEnum xAmzTarget) {
        this.createCertificateAuthorityAuditReportRequest = createCertificateAuthorityAuditReportRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
