 ...
 */
public class PostLoadBalancersIdActionsAddTargetAddTargetRequestLoadBalancerTargetIP {
    /**
    ...
    public PostLoadBalancersIdActionsAddTargetAddTargetRequestLoadBalancerTargetIP withIp(String ip) {
        this.ip = ip;
        return this;
    }
    
    public PostLoadBalancersIdActionsAddTargetAddTargetRequestLoadBalancerTargetIP(@JsonProperty("ip") String ip) {
        this.ip = ip;
  }
}
