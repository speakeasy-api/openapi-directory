...
type NodesReadNodeAttributesCategoryEnum string

const (
	NodesReadNodeAttributesCategoryEnumAnalysis           NodesReadNodeAttributesCategoryEnum = "analysis"
	NodesReadNodeAttributesCategoryEnumCommunication      NodesReadNodeAttributesCategoryEnum = "communication"
	NodesReadNodeAttributesCategoryEnumData               NodesReadNodeAttributesCategoryEnum = "data"
	NodesReadNodeAttributesCategoryEnumHypothesis         NodesReadNodeAttributesCategoryEnum = "hypothesis"
	NodesReadNodeAttributesCategoryEnumInstrumentation    NodesReadNodeAttributesCategoryEnum = "instrumentation"
	NodesReadNodeAttributesCategoryEnumMethodsAndMeasures NodesReadNodeAttributesCategoryEnum = "methods and measures"
	NodesReadNodeAttributesCategoryEnumProcedure          NodesReadNodeAttributesCategoryEnum = "procedure"
	NodesReadNodeAttributesCategoryEnumProject            NodesReadNodeAttributesCategoryEnum = "project"
	NodesReadNodeAttributesCategoryEnumSoftware           NodesReadNodeAttributesCategoryEnum = "software"
	NodesReadNodeAttributesCategoryEnumOther              NodesReadNodeAttributesCategoryEnum = "other"
)

func (e NodesReadNodeAttributesCategoryEnum) ToPointer() *NodesReadNodeAttributesCategoryEnum {
	return &e
}

func (e *NodesReadNodeAttributesCategoryEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "software":
		fallthrough
	case "other":
		*e = NodesReadNodeAttributesCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NodesReadNodeAttributesCategoryEnum: %v", v)
	}
}

// NodesReadNodeAttributes - The properties of the node entity.
type NodesReadNodeAttributes struct {
...
type NodesReadNodeLinks struct {
...
type NodesReadNodeRelationships struct {
