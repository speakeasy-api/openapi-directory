...
from ..shared import watched as shared_watched
...
class SetItemWatchedStatusRequest:
    ...
    r"""The id of the item being watched."""  
    position: int = dataclasses.field(metadata={'query_param': { 'field_name': 'position', 'style': 'form', 'explode': True }})
    r"""The playhead position to record."""  
...
class SetItemWatchedStatusResponse:
    ...
    r"""Bad request."""  
    watched: Optional[shared_watched.Watched] = dataclasses.field(default=None)
    r"""OK."""  
