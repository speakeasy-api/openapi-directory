...
export declare class SasportalNodesNodesPatchSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesNodesPatchSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesNodesPatchSecurity extends SpeakeasyBase {
    option1?: SasportalNodesNodesPatchSecurityOption1;
    option2?: SasportalNodesNodesPatchSecurityOption2;
}
