 ...
 */
public enum ExportConfigurationsList200ApplicationJSONValuesExportConfigurationTypeEnum {
    ...
    private ExportConfigurationsList200ApplicationJSONValuesExportConfigurationTypeEnum(String value) {
        this.value = value;
    }
}
