...
export class GoogleCloudDialogflowCxV3Experiment extends SpeakeasyBase {
  ...
  @Type(() => GoogleCloudDialogflowCxV3RolloutConfig)
  ...
  @Type(() => GoogleCloudDialogflowCxV3RolloutState)
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudDialogflowCxV3VariantsHistory })
