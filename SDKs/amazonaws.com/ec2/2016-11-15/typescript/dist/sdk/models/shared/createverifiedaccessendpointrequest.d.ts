...
import { CreateVerifiedAccessEndpointEniOptions } from "./createverifiedaccessendpointenioptions";
import { CreateVerifiedAccessEndpointLoadBalancerOptions } from "./createverifiedaccessendpointloadbalanceroptions";
import { VerifiedAccessEndpointAttachmentTypeEnum } from "./verifiedaccessendpointattachmenttypeenum";
import { VerifiedAccessEndpointTypeEnum } from "./verifiedaccessendpointtypeenum";
/**
 * The type of resource to tag on creation.
 */
export declare enum CreateVerifiedAccessEndpointRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateVerifiedAccessEndpointRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateVerifiedAccessEndpointRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateVerifiedAccessEndpointRequest extends SpeakeasyBase {
