...
from ..shared import taskupdateparameter as shared_taskupdateparameter
...
class TaskUpdateRequest:
    ...
    r"""The id of the job containing the task."""  
    task_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'taskId', 'style': 'simple', 'explode': False }})
    r"""The id of the task to update."""  
    task_update_parameter: shared_taskupdateparameter.TaskUpdateParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
