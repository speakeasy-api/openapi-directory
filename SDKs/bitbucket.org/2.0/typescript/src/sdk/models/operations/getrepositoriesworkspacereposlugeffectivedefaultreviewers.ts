...
export class GetRepositoriesWorkspaceRepoSlugEffectiveDefaultReviewersSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetRepositoriesWorkspaceRepoSlugEffectiveDefaultReviewersRequest extends SpeakeasyBase {
  /**
...
export class GetRepositoriesWorkspaceRepoSlugEffectiveDefaultReviewersResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
