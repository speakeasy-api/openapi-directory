...
public class GETReceiveMessageQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=Action")
    public GETReceiveMessageActionEnum action;
    public GETReceiveMessageQueryParams withAction(GETReceiveMessageActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETReceiveMessageQueryParams withAttributeNames(GETReceiveMessageAttributeNamesEnum[] attributeNames) {
    ...
    public GETReceiveMessageQueryParams withMaxNumberOfMessages(Long maxNumberOfMessages) {
    ...
    public GETReceiveMessageQueryParams withMessageAttributeNames(String[] messageAttributeNames) {
    ...
    public GETReceiveMessageQueryParams withReceiveRequestAttemptId(String receiveRequestAttemptId) {
    ...
    public GETReceiveMessageQueryParams withVersion(GETReceiveMessageVersionEnum version) {
    ...
    public GETReceiveMessageQueryParams withVisibilityTimeout(Long visibilityTimeout) {
    ...
    public GETReceiveMessageQueryParams withWaitTimeSeconds(Long waitTimeSeconds) {
