 ...
 */
export declare enum MetalsSpotHistoryGETFormatEnum {
    Json = "json",
    Xml = "xml"
}
/**
 ...
 * dwt=pennyweight
 */
export declare enum MetalsSpotHistoryGETUnitofmeasureEnum {
    Mg = "mg",
    G = "g",
    Kg = "kg",
    Gr = "gr",
...
export declare class MetalsSpotHistoryGETRequest extends SpeakeasyBase {
    /**
...
export declare class MetalsSpotHistoryGETResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    /**
     * Success
