...
class OBWriteInternationalScheduledResponse6DataExchangeRateInformation:
    ...
    rate_type: OBWriteInternationalScheduledResponse6DataExchangeRateInformationRateTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RateType') }})
    r"""Specifies the type used to complete the currency exchange."""  
...
class OBWriteInternationalScheduledResponse6DataInitiationExchangeRateInformation:
    ...
    rate_type: OBWriteInternationalScheduledResponse6DataInitiationExchangeRateInformationRateTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RateType') }})
    r"""Specifies the type used to complete the currency exchange."""  
    unit_currency: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('UnitCurrency') }})
    r"""Currency in which the rate of exchange is expressed in a currency exchange. In the example 1GBP = xxxCUR, the unit currency is GBP."""  
    contract_identification: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ContractIdentification'), 'exclude': lambda f: f is None }})
...
class OBWriteInternationalScheduledResponse6DataInitiation:
    ...
    creditor_account: OBWriteInternationalScheduledResponse6DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreditorAccount') }})
    r"""Unambiguous identification of the account of the creditor to which a credit entry will be posted as a result of the payment transaction."""  
    ...
    instructed_amount: OBWriteInternationalScheduledResponse6DataInitiationInstructedAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InstructedAmount') }})
    r"""Amount of money to be moved between the debtor and creditor, before deduction of charges, expressed in the currency as ordered by the initiating party.
    Usage: This amount has to be transported unchanged through the transaction chain.
    """  
    ...
    r"""Specifies which party/parties will bear the charges associated with the processing of the payment transaction."""  
    creditor: Optional[OBWriteInternationalScheduledResponse6DataInitiationCreditor] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Creditor'), 'exclude': lambda f: f is None }})
    r"""Party to which an amount of money is due."""  
    creditor_agent: Optional[OBWriteInternationalScheduledResponse6DataInitiationCreditorAgent] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreditorAgent'), 'exclude': lambda f: f is None }})
    r"""Financial institution servicing an account for the creditor."""  
    debtor_account: Optional[OBWriteInternationalScheduledResponse6DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DebtorAccount'), 'exclude': lambda f: f is None }})
    r"""Unambiguous identification of the account of the debtor to which a debit entry will be made as a result of the transaction."""  
    ...
    """  
    exchange_rate_information: Optional[OBWriteInternationalScheduledResponse6DataInitiationExchangeRateInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ExchangeRateInformation'), 'exclude': lambda f: f is None }})
    r"""Provides details on the currency exchange rate and contract."""  
    ...
    instruction_priority: Optional[OBWriteInternationalScheduledResponse6DataInitiationInstructionPriorityEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InstructionPriority'), 'exclude': lambda f: f is None }})
    r"""Indicator of the urgency or order of importance that the instructing party would like the instructed party to apply to the processing of the instruction."""  
    ...
    """  
    remittance_information: Optional[OBWriteInternationalScheduledResponse6DataInitiationRemittanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RemittanceInformation'), 'exclude': lambda f: f is None }})
    r"""Information supplied to enable the matching of an entry with the items that the transfer is intended to settle, such as commercial invoices in an accounts' receivable system."""  
...
class OBWriteInternationalScheduledResponse6DataMultiAuthorisation:
    ...
    status: OBWriteInternationalScheduledResponse6DataMultiAuthorisationStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Status') }})
    r"""Specifies the status of the authorisation flow in code form."""  
    expiration_date_time: Optional[datetime] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ExpirationDateTime'), 'encoder': utils.datetimeisoformat(True), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso'), 'exclude': lambda f: f is None }})
...
class OBWriteInternationalScheduledResponse6DataRefund:
    ...
    account: OBWriteInternationalScheduledResponse6DataRefundAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Account') }})
    r"""Provides the details to identify an account."""  
    agent: Optional[OBWriteInternationalScheduledResponse6DataRefundAgent] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Agent'), 'exclude': lambda f: f is None }})
    r"""Set of elements used to uniquely and unambiguously identify a financial institution or a branch of a financial institution."""  
    creditor: Optional[OBWriteInternationalScheduledResponse6DataRefundCreditor] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Creditor'), 'exclude': lambda f: f is None }})
    r"""Set of elements used to identify a person or an organisation."""  
...
class OBWriteInternationalScheduledResponse6Data:
    ...
    2017-04-05T10:43:07+00:00
    """  
    initiation: OBWriteInternationalScheduledResponse6DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Initiation') }})
    r"""The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds from the debtor account to a creditor for a single scheduled international payment."""  
    international_scheduled_payment_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InternationalScheduledPaymentId') }})
    r"""OB: Unique identification as assigned by the ASPSP to uniquely identify the international scheduled payment resource."""  
    status: OBWriteInternationalScheduledResponse6DataStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Status') }})
    r"""Specifies the status of the payment order resource."""  
    ...
    2017-04-05T10:43:07+00:00
    """  
    charges: Optional[list[OBWriteInternationalScheduledResponse6DataCharges]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Charges'), 'exclude': lambda f: f is None }})  
    ...
    exchange_rate_information: Optional[OBWriteInternationalScheduledResponse6DataExchangeRateInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ExchangeRateInformation'), 'exclude': lambda f: f is None }})
    r"""Further detailed information on the exchange rate that has been used in the payment transaction."""  
    ...
    2017-04-05T10:43:07+00:00
    """  
    multi_authorisation: Optional[OBWriteInternationalScheduledResponse6DataMultiAuthorisation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MultiAuthorisation'), 'exclude': lambda f: f is None }})
    r"""The multiple authorisation flow response from the ASPSP."""  
    refund: Optional[OBWriteInternationalScheduledResponse6DataRefund] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Refund'), 'exclude': lambda f: f is None }})  
...
class OBWriteInternationalScheduledResponse6:
    ...
    data: OBWriteInternationalScheduledResponse6Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Data') }})  
