...
public class StartStackResponse {
    ...
    public StartStackResponse withStatusCode(Integer statusCode) {
    ...
    public StartStackResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public StartStackResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
