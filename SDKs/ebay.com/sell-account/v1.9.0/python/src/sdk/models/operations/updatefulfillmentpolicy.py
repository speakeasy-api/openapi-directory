...
class UpdateFulfillmentPolicyRequest:
    ...
    r"""This path parameter specifies the ID of the fulfillment policy you want to update."""  
    fulfillment_policy_request: shared_fulfillmentpolicyrequest.FulfillmentPolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Fulfillment policy request"""  
