...
func (e CreateOrganizationAlertsProfileRequestBodyAlertConditionInterfaceEnum) ToPointer() *CreateOrganizationAlertsProfileRequestBodyAlertConditionInterfaceEnum {
	return &e
}
...
func (e *CreateOrganizationAlertsProfileRequestBodyAlertConditionInterfaceEnum) UnmarshalJSON(data []byte) error {
	...
	case "wan1":
		fallthrough
	case "wan2":
		*e = CreateOrganizationAlertsProfileRequestBodyAlertConditionInterfaceEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOrganizationAlertsProfileRequestBodyAlertConditionInterfaceEnum: %v", v)
	}
}
...
func (e CreateOrganizationAlertsProfileRequestBodyTypeEnum) ToPointer() *CreateOrganizationAlertsProfileRequestBodyTypeEnum {
	return &e
}
...
func (e *CreateOrganizationAlertsProfileRequestBodyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "wanStatus":
		fallthrough
	case "wanUtilization":
		*e = CreateOrganizationAlertsProfileRequestBodyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOrganizationAlertsProfileRequestBodyTypeEnum: %v", v)
	}
}
