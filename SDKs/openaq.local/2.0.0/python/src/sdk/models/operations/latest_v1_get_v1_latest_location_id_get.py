...
class LatestV1GetV1LatestLocationIDGetRequest:
    path_params: LatestV1GetV1LatestLocationIDGetPathParams = dataclasses.field()
    query_params: LatestV1GetV1LatestLocationIDGetQueryParams = dataclasses.field()
