...
func (e *ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesPatchForceOnlyEnum) UnmarshalJSON(data []byte) error {
	...
	case "LIMIT_DECREASE_PERCENTAGE_TOO_HIGH":
		*e = ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesPatchForceOnlyEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesPatchForceOnlyEnum: %s", s)
	}
}
