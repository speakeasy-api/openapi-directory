...
class RemoveCustomFieldSettingForPortfolioRequest:
    ...
    request_body: RemoveCustomFieldSettingForPortfolioRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Information about the custom field setting being removed."""  
...
class RemoveCustomFieldSettingForPortfolio200ApplicationJSON:
    r"""Successfully removed the custom field from the portfolio."""
