...
from ..shared import gethriscompanyresponse as shared_gethriscompanyresponse
...
class CompaniesOneRequest:
    headers: CompaniesOneHeaders = dataclasses.field()
    path_params: CompaniesOnePathParams = dataclasses.field()
    query_params: CompaniesOneQueryParams = dataclasses.field()
    security: CompaniesOneSecurity = dataclasses.field()
...
class CompaniesOneResponse:
    ...
    get_hris_company_response: Optional[shared_gethriscompanyresponse.GetHrisCompanyResponse] = dataclasses.field(default=None)
