...
class Task:
    ...
    def show_task(self, request: operations.ShowTaskRequest) -> operations.ShowTaskResponse:
        ...
        url = utils.generate_url(operations.ShowTaskRequest, base_url, '/tasks/{id}', request)
        ...
        res = operations.ShowTaskResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_task(self, request: operations.UpdateTaskRequest) -> operations.UpdateTaskResponse:
        ...
        url = utils.generate_url(operations.UpdateTaskRequest, base_url, '/tasks/{id}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "task_input", 'json')
        ...
        if http_res.status_code in [204, 400]:
            pass
        elif http_res.status_code == 404:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorNotFound])
