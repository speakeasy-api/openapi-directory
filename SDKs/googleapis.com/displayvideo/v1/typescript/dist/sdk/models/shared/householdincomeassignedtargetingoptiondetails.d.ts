 ...
 */
export declare enum HouseholdIncomeAssignedTargetingOptionDetailsHouseholdIncomeEnum {
 ...
 */
export declare class HouseholdIncomeAssignedTargetingOptionDetails extends SpeakeasyBase {
    /**
     * The household income of the audience. Output only in v1. Required in v2.
     */
