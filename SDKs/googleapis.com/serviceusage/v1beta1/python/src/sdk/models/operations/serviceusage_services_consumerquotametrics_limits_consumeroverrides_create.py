...
class ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesCreateSecurity:
    ...
    option1: Optional[ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesCreateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesCreateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesCreateRequest:
    ...
    force_only: Optional[list[ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesCreateForceOnlyEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'forceOnly', 'style': 'form', 'explode': True }})
