...
public class TaxRatesUpdateRequest {
    ...
    public TaxRatesUpdateRequest(@JsonProperty("TaxRateInput") org.openapis.openapi.models.shared.TaxRateInput taxRateInput, @JsonProperty("id") String id, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.taxRateInput = taxRateInput;
        this.id = id;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
