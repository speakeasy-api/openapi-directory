...
exports.Metaschemas = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var Metaschemas = /** @class */ (function () {
    function Metaschemas(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Metaschemas.prototype.metaschemasList = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/metaschemas/";
    ...
    **/
    Metaschemas.prototype.metaschemasRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MetaschemasReadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/metaschemas/{metaschema_id}", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
...
exports.Metaschemas = Metaschemas;
