...
class CreateCertificateAuthorityAuditReportRequest:
    ...
    create_certificate_authority_audit_report_request: shared_createcertificateauthorityauditreportrequest.CreateCertificateAuthorityAuditReportRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
