...
public class OBWriteInternationalScheduledConsentResponse6DataInitiationDebtorAccount {
    ...
    public OBWriteInternationalScheduledConsentResponse6DataInitiationDebtorAccount(@JsonProperty("Identification") String identification, @JsonProperty("SchemeName") String schemeName) {
        this.identification = identification;
        this.schemeName = schemeName;
  }
}
