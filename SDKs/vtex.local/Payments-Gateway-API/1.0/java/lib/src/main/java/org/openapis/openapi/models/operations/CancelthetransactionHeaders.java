...
public class CancelthetransactionHeaders {
    /**
    ...
    public CancelthetransactionHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public CancelthetransactionHeaders withContentType(String contentType) {
    ...
    public CancelthetransactionHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public CancelthetransactionHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
