...
exports.CodeScanningListAlertInstancesResponse = exports.CodeScanningListAlertInstances503ApplicationJSON = exports.CodeScanningListAlertInstancesRequest = void 0;
...
var CodeScanningListAlertInstancesRequest = /** @class */ (function (_super) {
    ...
    ], CodeScanningListAlertInstancesRequest.prototype, "alertNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=owner",
        }),
        __metadata("design:type", String)
    ], CodeScanningListAlertInstancesRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], CodeScanningListAlertInstancesRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], CodeScanningListAlertInstancesRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ref" }),
        __metadata("design:type", String)
    ], CodeScanningListAlertInstancesRequest.prototype, "ref", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], CodeScanningListAlertInstancesRequest.prototype, "repo", void 0);
...
var CodeScanningListAlertInstancesResponse = /** @class */ (function (_super) {
    ...
    ], CodeScanningListAlertInstancesResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
