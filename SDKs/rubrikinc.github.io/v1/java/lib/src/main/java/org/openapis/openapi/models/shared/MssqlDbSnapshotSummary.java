...
public class MssqlDbSnapshotSummary {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("archivalLocationIds")
    public String[] archivalLocationIds;

    public MssqlDbSnapshotSummary withArchivalLocationIds(String[] archivalLocationIds) {
        this.archivalLocationIds = archivalLocationIds;
        return this;
    }
    
    @JsonProperty("canLiveMount")
    public Boolean canLiveMount;

    public MssqlDbSnapshotSummary withCanLiveMount(Boolean canLiveMount) {
        this.canLiveMount = canLiveMount;
        return this;
    }
    ...
    public MssqlDbSnapshotSummary withCloudState(Long cloudState) {
    ...
    public MssqlDbSnapshotSummary withCloudStorageTier(SnapshotCloudStorageTierEnum cloudStorageTier) {
    ...
    public MssqlDbSnapshotSummary withConsistencyLevel(String consistencyLevel) {
    ...
    public MssqlDbSnapshotSummary withDatabaseName(String databaseName) {
    ...
    public MssqlDbSnapshotSummary withDate(OffsetDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public MssqlDbSnapshotSummary withExpirationDate(OffsetDateTime expirationDate) {
    ...
    public MssqlDbSnapshotSummary withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public MssqlDbSnapshotSummary withIndexState(Long indexState) {
    ...
    public MssqlDbSnapshotSummary withIsCustomRetentionApplied(Boolean isCustomRetentionApplied) {
    ...
    public MssqlDbSnapshotSummary withIsOnDemandSnapshot(Boolean isOnDemandSnapshot) {
    ...
    public MssqlDbSnapshotSummary withIsPlacedOnLegalHold(Boolean isPlacedOnLegalHold) {
    ...
    public MssqlDbSnapshotSummary withIsRetainedByRetentionLockSla(Boolean isRetainedByRetentionLockSla) {
    ...
    public MssqlDbSnapshotSummary withParentSnapshotId(String parentSnapshotId) {
    ...
    public MssqlDbSnapshotSummary withReplicationLocationIds(String[] replicationLocationIds) {
    ...
    public MssqlDbSnapshotSummary withSlaId(String slaId) {
        this.slaId = slaId;
        return this;
    }
    ...
    public MssqlDbSnapshotSummary withSlaName(String slaName) {
    ...
    public MssqlDbSnapshotSummary withSnapshotRetentionInfo(SnapshotRetentionInfo snapshotRetentionInfo) {
    ...
    public MssqlDbSnapshotSummary withSourceObjectType(String sourceObjectType) {
        this.sourceObjectType = sourceObjectType;
        return this;
    }
    
    public MssqlDbSnapshotSummary(@JsonProperty("canLiveMount") Boolean canLiveMount, @JsonProperty("databaseName") String databaseName, @JsonProperty("date") OffsetDateTime date, @JsonProperty("id") String id, @JsonProperty("isCustomRetentionApplied") Boolean isCustomRetentionApplied, @JsonProperty("isOnDemandSnapshot") Boolean isOnDemandSnapshot, @JsonProperty("replicationLocationIds") String[] replicationLocationIds, @JsonProperty("slaId") String slaId, @JsonProperty("slaName") String slaName) {
        this.canLiveMount = canLiveMount;
        this.databaseName = databaseName;
        this.date = date;
        this.id = id;
