...
export class Gitignore {
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@2.22/rest/reference/gitignore#get-all-gitignore-templates} - API method documentation
   */
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@2.22/rest/reference/gitignore#get-a-gitignore-template} - API method documentation
   */
