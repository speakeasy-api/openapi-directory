...
public class InvoiceApiDetailsHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiDetailsHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiDetailsHeaders withXAuthSecret(String xAuthSecret) {
