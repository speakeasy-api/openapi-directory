...
exports.TimerCanceledEventAttributes = void 0;
var utils_1 = require("../../../internal/utils");
// TimerCanceledEventAttributes
/**
 *  Provides the details of the <code>TimerCanceled</code> event.
**/
var TimerCanceledEventAttributes = /** @class */ (function (_super) {
    __extends(TimerCanceledEventAttributes, _super);
    ...
    ], TimerCanceledEventAttributes.prototype, "decisionTaskCompletedEventId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startedEventId" }),
        __metadata("design:type", Number)
    ], TimerCanceledEventAttributes.prototype, "startedEventId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timerId" }),
        __metadata("design:type", String)
    ], TimerCanceledEventAttributes.prototype, "timerId", void 0);
