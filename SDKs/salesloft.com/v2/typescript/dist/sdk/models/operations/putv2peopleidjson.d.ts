...
export declare class PutV2PeopleIdJsonRequestBody extends SpeakeasyBase {
    /**
...
export declare class PutV2PeopleIdJsonRequest extends SpeakeasyBase {
    requestBody?: PutV2PeopleIdJsonRequestBody;
    /**
     * Person id
     */
    id: string;
}
export declare class PutV2PeopleIdJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
