...
from ..shared import getsharedlinksresponse as shared_getsharedlinksresponse
...
class SharedLinksAllQueryParams:
...
@dataclasses.dataclass
class SharedLinksAllSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class SharedLinksAllRequest:
    headers: SharedLinksAllHeaders = dataclasses.field()
    query_params: SharedLinksAllQueryParams = dataclasses.field()
    security: SharedLinksAllSecurity = dataclasses.field()
    

@dataclasses.dataclass
class SharedLinksAllResponseOutput:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    get_shared_links_response: Optional[shared_getsharedlinksresponse.GetSharedLinksResponseOutput] = dataclasses.field(default=None)
