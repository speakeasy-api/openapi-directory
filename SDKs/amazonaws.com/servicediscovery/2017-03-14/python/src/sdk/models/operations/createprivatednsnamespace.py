...
class CreatePrivateDNSNamespaceRequest:
    ...
    create_private_dns_namespace_request: shared_createprivatednsnamespacerequest.CreatePrivateDNSNamespaceRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
