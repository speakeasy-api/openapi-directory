...
class UploadSessionsAddRequest:
    headers: UploadSessionsAddHeaders = dataclasses.field()
    query_params: UploadSessionsAddQueryParams = dataclasses.field()
    request: shared_createuploadsessionrequest.CreateUploadSessionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: UploadSessionsAddSecurity = dataclasses.field()
