...
func (e CreateNetworkCameraWirelessProfileRequestBodySsidAuthModeEnum) ToPointer() *CreateNetworkCameraWirelessProfileRequestBodySsidAuthModeEnum {
	return &e
}
...
func (e *CreateNetworkCameraWirelessProfileRequestBodySsidAuthModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "8021x-radius":
		fallthrough
	case "psk":
		*e = CreateNetworkCameraWirelessProfileRequestBodySsidAuthModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkCameraWirelessProfileRequestBodySsidAuthModeEnum: %v", v)
	}
}
