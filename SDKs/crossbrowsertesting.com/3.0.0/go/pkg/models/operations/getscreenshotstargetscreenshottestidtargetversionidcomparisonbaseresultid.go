...
type GetScreenshotsTargetScreenshotTestIDTargetVersionIDComparisonBaseResultIDSecurity struct {
	BasicAuth shared.SchemeBasicAuth `security:"scheme,type=http,subtype=basic"`
}

type GetScreenshotsTargetScreenshotTestIDTargetVersionIDComparisonBaseResultIDPathParams struct {
...
type GetScreenshotsTargetScreenshotTestIDTargetVersionIDComparisonBaseResultIDQueryParams struct {
...
type GetScreenshotsTargetScreenshotTestIDTargetVersionIDComparisonBaseResultIDRequest struct {
	PathParams  GetScreenshotsTargetScreenshotTestIDTargetVersionIDComparisonBaseResultIDPathParams
	QueryParams GetScreenshotsTargetScreenshotTestIDTargetVersionIDComparisonBaseResultIDQueryParams
	Security    GetScreenshotsTargetScreenshotTestIDTargetVersionIDComparisonBaseResultIDSecurity
}

type GetScreenshotsTargetScreenshotTestIDTargetVersionIDComparisonBaseResultIDResponse struct {
	ContentType string
	StatusCode  int
