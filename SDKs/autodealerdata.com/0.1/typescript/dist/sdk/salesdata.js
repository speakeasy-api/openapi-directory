...
exports.SalesData = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var SalesData = /** @class */ (function () {
    function SalesData(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    SalesData.prototype.getDealerSalesRegionDailySalesGet = function (req, config) {
     ...
     * Data availability depends on region and goes back up to 2016.
    **/
    SalesData.prototype.getDealerSalesRegionSalesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SalesData.prototype.getModelUsedDistModelYearDistGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SalesData.prototype.getRegionBrandMarketShareGetRegionBrandMarketShareGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SalesData.prototype.getRegionMarketShareGetRegionMarketShareGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SalesData.prototype.getTopModelsTopModelsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
