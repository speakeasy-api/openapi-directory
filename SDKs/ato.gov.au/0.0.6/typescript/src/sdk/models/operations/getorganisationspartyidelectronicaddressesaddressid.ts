...
export class GetOrganisationsPartyIdElectronicAddressesAddressIdRequest extends SpeakeasyBase {
  /**
...
export class GetOrganisationsPartyIdElectronicAddressesAddressIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
