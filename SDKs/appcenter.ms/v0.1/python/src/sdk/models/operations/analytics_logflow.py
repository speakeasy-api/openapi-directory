...
class AnalyticsLogFlowDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
class AnalyticsLogFlowDefaultApplicationJSONError:
    ...
    code: AnalyticsLogFlowDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
...
class AnalyticsLogFlowDefaultApplicationJSON:
    ...
    error: AnalyticsLogFlowDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
...
class AnalyticsLogFlow200ApplicationJSONLogsTypeEnum(str, Enum):
    r"""Log type."""
    EVENT = 'event'
    PAGE = 'page'
...
class AnalyticsLogFlow200ApplicationJSONLogs:
    ...
    device: AnalyticsLogFlow200ApplicationJSONLogsDevice = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('device') }})
    r"""Device characteristics."""  
    ...
    type: AnalyticsLogFlow200ApplicationJSONLogsTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Log type."""  
...
class AnalyticsLogFlow200ApplicationJSON:
    ...
    logs: list[AnalyticsLogFlow200ApplicationJSONLogs] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logs') }})
    r"""the list of logs"""  
...
class AnalyticsLogFlowResponse:
    ...
    analytics_log_flow_200_application_json_object: Optional[AnalyticsLogFlow200ApplicationJSON] = dataclasses.field(default=None)
    r"""List of logs for the requested time range."""  
    analytics_log_flow_default_application_json_object: Optional[AnalyticsLogFlowDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error code with reason"""  
