...
from ..shared import batchimportfindingsresponse as shared_batchimportfindingsresponse
...
class BatchImportFindingsRequest:
    headers: BatchImportFindingsHeaders = dataclasses.field()
    request: BatchImportFindingsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class BatchImportFindingsResponse:
    ...
    batch_import_findings_response: Optional[shared_batchimportfindingsresponse.BatchImportFindingsResponse] = dataclasses.field(default=None)
