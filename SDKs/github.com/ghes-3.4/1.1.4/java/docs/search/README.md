...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCodeRequest req = new SearchCodeRequest("cumque") {{
                order = OrderEnum.ASC;
                page = 312511L;
                perPage = 985379L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCommitsRequest req = new SearchCommitsRequest("quia") {{
                order = OrderEnum.ASC;
                page = 651467L;
                perPage = 765070L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchIssuesAndPullRequestsRequest req = new SearchIssuesAndPullRequestsRequest("enim") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchLabelsRequest req = new SearchLabelsRequest("sit", 487148L) {{
                order = OrderEnum.ASC;
                page = 990369L;
                perPage = 924293L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchReposRequest req = new SearchReposRequest("praesentium") {{
                order = OrderEnum.DESC;
                page = 144179L;
                perPage = 25190L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchTopicsRequest req = new SearchTopicsRequest("necessitatibus") {{
                page = 148975L;
                perPage = 537170L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchUsersRequest req = new SearchUsersRequest("sunt") {{
                order = OrderEnum.DESC;
                page = 963913L;
                perPage = 673653L;
