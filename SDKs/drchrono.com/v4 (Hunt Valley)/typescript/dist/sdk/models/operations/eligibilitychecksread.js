...
exports.EligibilityChecksReadResponse = exports.EligibilityChecksReadRequest = exports.EligibilityChecksReadSecurity = void 0;
...
var EligibilityChecksReadRequest = /** @class */ (function (_super) {
    ...
    ], EligibilityChecksReadRequest.prototype, "appointment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=appointment_date",
        }),
        __metadata("design:type", String)
    ], EligibilityChecksReadRequest.prototype, "appointmentDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=appointment_date_range",
        }),
        __metadata("design:type", String)
    ], EligibilityChecksReadRequest.prototype, "appointmentDateRange", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=doctor",
        }),
        __metadata("design:type", Number)
    ], EligibilityChecksReadRequest.prototype, "doctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], EligibilityChecksReadRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=patient",
        }),
        __metadata("design:type", Number)
    ], EligibilityChecksReadRequest.prototype, "patient", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=query_date",
        }),
        __metadata("design:type", String)
    ], EligibilityChecksReadRequest.prototype, "queryDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=query_date_range",
        }),
        __metadata("design:type", String)
    ], EligibilityChecksReadRequest.prototype, "queryDateRange", void 0);
...
var EligibilityChecksReadResponse = /** @class */ (function (_super) {
    ...
    ], EligibilityChecksReadResponse.prototype, "rawResponse", void 0);
