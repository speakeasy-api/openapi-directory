...
var MonitorV1Alert = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=alert_text" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=date_generated" }),
        __metadata("design:type", Date)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=log_level" }),
        __metadata("design:type", String)
