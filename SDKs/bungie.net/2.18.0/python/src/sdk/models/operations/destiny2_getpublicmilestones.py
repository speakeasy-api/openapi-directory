...
from ..shared import destiny_milestones_destinypublicmilestone as shared_destiny_milestones_destinypublicmilestone
...
class Destiny2GetPublicMilestones200Wildcard:
    ...
    response: Optional[dict[str, shared_destiny_milestones_destinypublicmilestone.DestinyMilestonesDestinyPublicMilestone]] = dataclasses.field(default=None)  
    throttle_seconds: Optional[int] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class Destiny2GetPublicMilestonesResponse:
