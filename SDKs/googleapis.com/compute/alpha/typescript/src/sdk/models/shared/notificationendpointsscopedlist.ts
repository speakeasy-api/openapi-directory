 ...
 */
export enum NotificationEndpointsScopedListWarningCodeEnum {
...
export class NotificationEndpointsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NotificationEndpointsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NotificationEndpointsScopedListWarningData })
  @Expose({ name: "data" })
...
export class NotificationEndpointsScopedList extends SpeakeasyBase {
  /**
