...
class DeleteDirectConnectGatewayAssociationProposalRequest:
    ...
    delete_direct_connect_gateway_association_proposal_request: shared_deletedirectconnectgatewayassociationproposalrequest.DeleteDirectConnectGatewayAssociationProposalRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
