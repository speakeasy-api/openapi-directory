...
public class TypeaheadQueryParams {
    ...
    public TypeaheadQueryParams withSafeMode(TypeaheadSafeModeEnum safeMode) {
    ...
    public TypeaheadQueryParams withShowGenres(TypeaheadShowGenresEnum showGenres) {
    ...
    public TypeaheadQueryParams withShowPodcasts(TypeaheadShowPodcastsEnum showPodcasts) {
