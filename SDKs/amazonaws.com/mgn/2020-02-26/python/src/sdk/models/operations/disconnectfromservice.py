...
class DisconnectFromServiceRequest:
    headers: DisconnectFromServiceHeaders = dataclasses.field()
    request: DisconnectFromServiceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
