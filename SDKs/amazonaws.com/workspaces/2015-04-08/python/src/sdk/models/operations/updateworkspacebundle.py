...
class UpdateWorkspaceBundleRequest:
    ...
    update_workspace_bundle_request: shared_updateworkspacebundlerequest.UpdateWorkspaceBundleRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
