...
class CreateLongTermPricingRequest:
    ...
    create_long_term_pricing_request: shared_createlongtermpricingrequest.CreateLongTermPricingRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
