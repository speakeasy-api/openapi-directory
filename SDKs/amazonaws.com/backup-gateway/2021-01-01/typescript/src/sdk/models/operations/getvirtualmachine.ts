...
export enum GetVirtualMachineXAmzTargetEnum {
  BackupOnPremisesV20210101GetVirtualMachine = "BackupOnPremises_v20210101.GetVirtualMachine",
}

export class GetVirtualMachineRequest extends SpeakeasyBase {
...
export class GetVirtualMachineResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
