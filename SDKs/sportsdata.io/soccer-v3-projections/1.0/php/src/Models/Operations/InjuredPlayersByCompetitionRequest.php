...
class InjuredPlayersByCompetitionRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\InjuredPlayersByCompetitionFormatEnum $format
     */
	...
	{
		$this->competition = "";
		$this->format = \OpenAPI\OpenAPI\Models\Operations\InjuredPlayersByCompetitionFormatEnum::XML;
	}
}
