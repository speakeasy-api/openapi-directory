...
export class DisplayvideoAdvertisersListAssignedTargetingOptionsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersListAssignedTargetingOptionsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersListAssignedTargetingOptionsResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
