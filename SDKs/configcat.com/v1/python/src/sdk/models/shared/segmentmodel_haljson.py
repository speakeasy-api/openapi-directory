...
class SegmentModelHaljsonEmbeddedProductEmbeddedOrganizationLinks:
...
class SegmentModelHaljsonEmbeddedProductEmbeddedOrganization:
    ...
    links: Optional[SegmentModelHaljsonEmbeddedProductEmbeddedOrganizationLinks] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('_links'), 'exclude': lambda f: f is None }})  
...
class SegmentModelHaljsonEmbeddedProductEmbedded:
    ...
    organization: Optional[SegmentModelHaljsonEmbeddedProductEmbeddedOrganization] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('organization'), 'exclude': lambda f: f is None }})  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SegmentModelHaljsonEmbeddedProduct:
    
    embedded: Optional[SegmentModelHaljsonEmbeddedProductEmbedded] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('_embedded'), 'exclude': lambda f: f is None }})  
    links: Optional[SegmentModelHaljsonEmbeddedProductLinks] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('_links'), 'exclude': lambda f: f is None }})  
...
class SegmentModelHaljsonEmbedded:
    ...
    product: Optional[SegmentModelHaljsonEmbeddedProduct] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('product'), 'exclude': lambda f: f is None }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SegmentModelHaljsonLinks:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SegmentModelHaljson:
    r"""When the creation was successful."""
    
    embedded: Optional[SegmentModelHaljsonEmbedded] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('_embedded'), 'exclude': lambda f: f is None }})  
    links: Optional[SegmentModelHaljsonLinks] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('_links'), 'exclude': lambda f: f is None }})  
