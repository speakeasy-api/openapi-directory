...
from ..shared import updateleadresponse as shared_updateleadresponse
...
class LeadsUpdateRequest:
    headers: LeadsUpdateHeaders = dataclasses.field()
    path_params: LeadsUpdatePathParams = dataclasses.field()
    query_params: LeadsUpdateQueryParams = dataclasses.field()
    request: shared_lead.LeadInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: LeadsUpdateSecurity = dataclasses.field()
...
class LeadsUpdateResponse:
    ...
    update_lead_response: Optional[shared_updateleadresponse.UpdateLeadResponse] = dataclasses.field(default=None)
