...
var RecordingGroup = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=allSupported" }),
        __metadata("design:type", Boolean)
    ], RecordingGroup.prototype, "allSupported", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=includeGlobalResourceTypes" }),
        __metadata("design:type", Boolean)
