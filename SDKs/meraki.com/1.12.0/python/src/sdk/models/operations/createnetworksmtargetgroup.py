...
class CreateNetworkSmTargetGroupRequest:
    path_params: CreateNetworkSmTargetGroupPathParams = dataclasses.field()
    request: Optional[CreateNetworkSmTargetGroupRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
