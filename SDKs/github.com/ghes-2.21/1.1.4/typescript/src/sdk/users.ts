...
export class Users {
  ...
  usersAddEmailForAuthenticated(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.UsersAddEmailForAuthenticatedResponse =
        new operations.UsersAddEmailForAuthenticatedResponse({
  ...
  usersCreateGpgKeyForAuthenticated(
    req: operations.UsersCreateGpgKeyForAuthenticatedRequestBody,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersCreateGpgKeyForAuthenticatedResponse =
        new operations.UsersCreateGpgKeyForAuthenticatedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  usersCreatePublicSshKeyForAuthenticated(
    req: operations.UsersCreatePublicSshKeyForAuthenticatedRequestBody,
    config?: AxiosRequestConfig
  ): Promise<operations.UsersCreatePublicSshKeyForAuthenticatedResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UsersCreatePublicSshKeyForAuthenticatedRequestBody(
        req
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersCreatePublicSshKeyForAuthenticatedResponse =
        new operations.UsersCreatePublicSshKeyForAuthenticatedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  usersDeleteEmailForAuthenticated(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersDeleteEmailForAuthenticatedResponse =
        new operations.UsersDeleteEmailForAuthenticatedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  usersDeleteGpgKeyForAuthenticated(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersDeleteGpgKeyForAuthenticatedResponse =
        new operations.UsersDeleteGpgKeyForAuthenticatedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  usersDeletePublicSshKeyForAuthenticated(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersDeletePublicSshKeyForAuthenticatedResponse =
        new operations.UsersDeletePublicSshKeyForAuthenticatedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  usersGetGpgKeyForAuthenticated(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersGetGpgKeyForAuthenticatedResponse =
        new operations.UsersGetGpgKeyForAuthenticatedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  usersGetPublicSshKeyForAuthenticated(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersGetPublicSshKeyForAuthenticatedResponse =
        new operations.UsersGetPublicSshKeyForAuthenticatedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  usersListEmailsForAuthenticated(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersListEmailsForAuthenticatedResponse =
        new operations.UsersListEmailsForAuthenticatedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  usersListFollowedByAuthenticated(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersListFollowedByAuthenticatedResponse =
        new operations.UsersListFollowedByAuthenticatedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  usersListGpgKeysForAuthenticated(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersListGpgKeysForAuthenticatedResponse =
        new operations.UsersListGpgKeysForAuthenticatedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  usersListPublicEmailsForAuthenticated(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersListPublicEmailsForAuthenticatedResponse =
        new operations.UsersListPublicEmailsForAuthenticatedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  usersListPublicSshKeysForAuthenticated(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersListPublicSshKeysForAuthenticatedResponse =
        new operations.UsersListPublicSshKeysForAuthenticatedResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
