...
class PointPointDailyAllDayCloudCoverData:
    ...
    r"""Percentage of sky covered by high clouds. (allday avg)
    Unit: \%
    """  
    ...
    r"""Percentage of sky covered by low clouds. (allday avg)
    Unit: \%
    """  
    ...
    r"""Percentage of sky covered by middle clouds. (allday avg)
    Unit: \%
    """  
    ...
    r"""Percentage of sky covered by clouds. (allday avg)
    Unit: \%
    """  
