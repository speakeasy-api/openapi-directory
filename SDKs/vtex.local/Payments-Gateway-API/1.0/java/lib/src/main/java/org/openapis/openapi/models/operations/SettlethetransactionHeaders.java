...
public class SettlethetransactionHeaders {
    /**
    ...
    public SettlethetransactionHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public SettlethetransactionHeaders withContentType(String contentType) {
    ...
    public SettlethetransactionHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public SettlethetransactionHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
