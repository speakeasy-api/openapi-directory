...
class ListExecutionListExecutionResponse:
    ...
    executions: Optional[list[shared_studio_v1_flow_execution.StudioV1FlowExecution]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('executions'), 'exclude': lambda f: f is None }})  
