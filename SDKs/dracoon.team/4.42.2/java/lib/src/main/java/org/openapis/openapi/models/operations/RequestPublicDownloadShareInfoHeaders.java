...
public class RequestPublicDownloadShareInfoHeaders {
    /**
    ...
    public RequestPublicDownloadShareInfoHeaders withXSdsDateFormat(RequestPublicDownloadShareInfoXSdsDateFormatEnum xSdsDateFormat) {
