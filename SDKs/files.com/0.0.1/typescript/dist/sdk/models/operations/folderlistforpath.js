...
exports.FolderListForPathResponse = exports.FolderListForPathRequest = exports.FolderListForPathQueryParams = exports.FolderListForPathPathParams = void 0;
...
exports.FolderListForPathPathParams = FolderListForPathPathParams;
var FolderListForPathQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=preview_size" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search_all" }),
        __metadata("design:type", Boolean)
    ], FolderListForPathQueryParams.prototype, "searchAll", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=with_previews" }),
        __metadata("design:type", Boolean)
    ], FolderListForPathQueryParams.prototype, "withPreviews", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=with_priority_color" }),
        __metadata("design:type", Boolean)
    ], FolderListForPathQueryParams.prototype, "withPriorityColor", void 0);
    return FolderListForPathQueryParams;
}(utils_1.SpeakeasyBase));
exports.FolderListForPathQueryParams = FolderListForPathQueryParams;
...
exports.FolderListForPathRequest = FolderListForPathRequest;
var FolderListForPathResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.FileEntity }),
...
exports.FolderListForPathResponse = FolderListForPathResponse;
