...
var GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "claimReviewAuthor" }),
        (0, class_transformer_1.Type)(function () { return googlefactcheckingfactchecktoolsv1alpha1claimreviewauthor_1.GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewAuthor; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: googlefactcheckingfactchecktoolsv1alpha1claimreviewmarkup_1.GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkup,
        }),
        (0, class_transformer_1.Expose)({ name: "claimReviewMarkups" }),
        (0, class_transformer_1.Type)(function () { return googlefactcheckingfactchecktoolsv1alpha1claimreviewmarkup_1.GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkup; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "pageUrl" }),
        __metadata("design:type", String)
