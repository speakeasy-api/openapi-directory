...
from ..shared import upsertsellercommissionsrequest as shared_upsertsellercommissionsrequest
...
class UpsertSellerCommissionsRequest:
    ...
    r"""ID of the category in which the comission will be applied."""  
    ...
    upsert_seller_commissions_request: shared_upsertsellercommissionsrequest.UpsertSellerCommissionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
