...
class GoogleCloudVideointelligenceV1AnnotateVideoRequest:
    ...
    features: Optional[list[GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('features') }})
    ...
    video_context: Optional[shared_googlecloudvideointelligencev1_videocontext.GoogleCloudVideointelligenceV1VideoContext] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('videoContext') }})
