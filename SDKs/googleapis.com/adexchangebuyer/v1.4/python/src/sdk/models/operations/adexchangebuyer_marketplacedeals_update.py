...
class AdexchangebuyerMarketplacedealsUpdateRequest:
    ...
    r"""The proposalId to edit deals on."""  
    alt: Optional[shared_alt_enum.AltEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'alt', 'style': 'form', 'explode': True }})
    r"""Data format for the response."""  
    edit_all_order_deals_request: Optional[shared_editallorderdealsrequest.EditAllOrderDealsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
