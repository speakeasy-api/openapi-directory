...
class Devices:
    ...
    def get_agent_devices(self, request: operations.GetAgentDevicesRequest) -> operations.GetAgentDevicesResponse:
        ...
        url = utils.generate_url(operations.GetAgentDevicesRequest, base_url, '/hardware/devices/{deviceId}/agent-devices', request)
        ...
        res = operations.GetAgentDevicesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_device(self, request: operations.GetDeviceRequest) -> operations.GetDeviceResponse:
        ...
        url = utils.generate_url(operations.GetDeviceRequest, base_url, '/hardware/devices/{deviceId}', request)
    ...
    def get_device_agent(self, request: operations.GetDeviceAgentRequest) -> operations.GetDeviceAgentResponse:
        ...
        url = utils.generate_url(operations.GetDeviceAgentRequest, base_url, '/hardware/devices/{deviceId}/agent', request)
        ...
        res = operations.GetDeviceAgentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_device_energy_usage(self, request: operations.GetDeviceEnergyUsageRequest) -> operations.GetDeviceEnergyUsageResponse:
        ...
        url = utils.generate_url(operations.GetDeviceEnergyUsageRequest, base_url, '/hardware/energy-usage/{deviceId}', request)
        
        query_params = utils.get_query_params(operations.GetDeviceEnergyUsageRequest, request)
        ...
        res = operations.GetDeviceEnergyUsageResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_device_monitors(self, request: operations.GetDeviceMonitorsRequest) -> operations.GetDeviceMonitorsResponse:
        ...
        url = utils.generate_url(operations.GetDeviceMonitorsRequest, base_url, '/hardware/device-monitors/{deviceId}', request)
        ...
        res = operations.GetDeviceMonitorsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_device_parameter_history(self, request: operations.GetDeviceParameterHistoryRequest) -> operations.GetDeviceParameterHistoryResponse:
        ...
        url = utils.generate_url(operations.GetDeviceParameterHistoryRequest, base_url, '/hardware/devices/{deviceId}/parameter-history', request)
        
        query_params = utils.get_query_params(operations.GetDeviceParameterHistoryRequest, request)
        ...
        res = operations.GetDeviceParameterHistoryResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_devices_summary(self) -> operations.GetDevicesSummaryResponse:
        ...
        res = operations.GetDevicesSummaryResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_heating_margin_coverage(self, request: operations.GetHeatingMarginCoverageRequest) -> operations.GetHeatingMarginCoverageResponse:
        ...
        query_params = utils.get_query_params(operations.GetHeatingMarginCoverageRequest, request)
        ...
        res = operations.GetHeatingMarginCoverageResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
