...
public class CreatePayorLinkRequest {
    ...
    public CreatePayorLinkRequest(@JsonProperty("fromPayorId") String fromPayorId, @JsonProperty("linkType") CreatePayorLinkRequestLinkTypeEnum linkType, @JsonProperty("toPayorId") String toPayorId) {
        this.fromPayorId = fromPayorId;
        this.linkType = linkType;
        this.toPayorId = toPayorId;
  }
