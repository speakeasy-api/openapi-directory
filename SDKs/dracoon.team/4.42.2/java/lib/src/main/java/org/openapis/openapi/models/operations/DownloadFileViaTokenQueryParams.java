...
public class DownloadFileViaTokenQueryParams {
    /**
    ...
    public DownloadFileViaTokenQueryParams withGenericMimetype(Boolean genericMimetype) {
    ...
    public DownloadFileViaTokenQueryParams withInline(Boolean inline) {
        this.inline = inline;
        return this;
    }
