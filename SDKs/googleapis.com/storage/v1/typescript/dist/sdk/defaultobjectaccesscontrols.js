...
var DefaultObjectAccessControls = /** @class */ (function () {
    ...
    **/
    DefaultObjectAccessControls.prototype.storageDefaultObjectAccessControlsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.StorageDefaultObjectAccessControlsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/b/{bucket}/defaultObjectAcl/{entity}", req.pathParams);
    ...
    **/
    DefaultObjectAccessControls.prototype.storageDefaultObjectAccessControlsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.objectAccessControl = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    DefaultObjectAccessControls.prototype.storageDefaultObjectAccessControlsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.StorageDefaultObjectAccessControlsInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/b/{bucket}/defaultObjectAcl", req.pathParams);
    ...
    **/
    DefaultObjectAccessControls.prototype.storageDefaultObjectAccessControlsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.objectAccessControls = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    DefaultObjectAccessControls.prototype.storageDefaultObjectAccessControlsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    DefaultObjectAccessControls.prototype.storageDefaultObjectAccessControlsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
