...
func (e UpdateNetworkFirmwareUpgradesRequestBodyUpgradeWindowDayOfWeekEnum) ToPointer() *UpdateNetworkFirmwareUpgradesRequestBodyUpgradeWindowDayOfWeekEnum {
	return &e
}
...
func (e *UpdateNetworkFirmwareUpgradesRequestBodyUpgradeWindowDayOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "wed":
		fallthrough
	case "wednesday":
		*e = UpdateNetworkFirmwareUpgradesRequestBodyUpgradeWindowDayOfWeekEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkFirmwareUpgradesRequestBodyUpgradeWindowDayOfWeekEnum: %v", v)
	}
}
...
func (e UpdateNetworkFirmwareUpgradesRequestBodyUpgradeWindowHourOfDayEnum) ToPointer() *UpdateNetworkFirmwareUpgradesRequestBodyUpgradeWindowHourOfDayEnum {
	return &e
}
...
func (e *UpdateNetworkFirmwareUpgradesRequestBodyUpgradeWindowHourOfDayEnum) UnmarshalJSON(data []byte) error {
	...
	case "8:00":
		fallthrough
	case "9:00":
		*e = UpdateNetworkFirmwareUpgradesRequestBodyUpgradeWindowHourOfDayEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkFirmwareUpgradesRequestBodyUpgradeWindowHourOfDayEnum: %v", v)
	}
}
...
func (e UpdateNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowDayOfWeekEnum) ToPointer() *UpdateNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowDayOfWeekEnum {
	return &e
}
...
func (e *UpdateNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowDayOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "wed":
		fallthrough
	case "wednesday":
		*e = UpdateNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowDayOfWeekEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowDayOfWeekEnum: %v", v)
	}
}
...
func (e UpdateNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowHourOfDayEnum) ToPointer() *UpdateNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowHourOfDayEnum {
	return &e
}
...
func (e *UpdateNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowHourOfDayEnum) UnmarshalJSON(data []byte) error {
	...
	case "8:00":
		fallthrough
	case "9:00":
		*e = UpdateNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowHourOfDayEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowHourOfDayEnum: %v", v)
	}
}
