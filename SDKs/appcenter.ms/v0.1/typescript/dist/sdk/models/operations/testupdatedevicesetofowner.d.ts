...
export declare class TestUpdateDeviceSetOfOwnerSecurity extends SpeakeasyBase {
    apiToken: string;
}
/**
 * The name of the device set and the list of device IDs
 */
export declare class TestUpdateDeviceSetOfOwnerDeviceSetUpdateInformation extends SpeakeasyBase {
    /**
     * List of device IDs
     */
    devices: string[];
...
export declare class TestUpdateDeviceSetOfOwnerRequest extends SpeakeasyBase {
 ...
 */
export declare class TestUpdateDeviceSetOfOwnerTestCloudErrorDetails extends SpeakeasyBase {
    /**
...
export declare class TestUpdateDeviceSetOfOwnerDeviceSetDeviceConfigurationsImage extends SpeakeasyBase {
    thumb?: string;
}
export declare class TestUpdateDeviceSetOfOwnerDeviceSetDeviceConfigurationsModel extends SpeakeasyBase {
    formFactor?: string;
    manufacturer?: string;
    name?: string;
    releaseDate?: string;
}
export declare class TestUpdateDeviceSetOfOwnerDeviceSetDeviceConfigurations extends SpeakeasyBase {
    /**
 ...
 */
export declare class TestUpdateDeviceSetOfOwnerDeviceSetDeviceSetOwner extends SpeakeasyBase {
    /**
 ...
 */
export declare class TestUpdateDeviceSetOfOwnerDeviceSet extends SpeakeasyBase {
...
export declare class TestUpdateDeviceSetOfOwnerResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * OK
     */
