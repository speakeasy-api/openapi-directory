...
export declare enum TransactionRuleInfoEntryModesEnum {
    Barcode = "barcode",
    Chip = "chip",
    Cof = "cof",
...
export declare enum TransactionRuleInfoProcessingTypesEnum {
 ...
 */
export declare enum TransactionRuleInfoStatusEnum {
    Active = "active",
    Inactive = "inactive"
}
/**
 ...
 *
 */
export declare enum TransactionRuleInfoTypeEnum {
    AllowList = "allowList",
    BlockList = "blockList",
    MaxUsage = "maxUsage",
    Velocity = "velocity"
}
export declare class TransactionRuleInfo extends SpeakeasyBase {
    amount?: Amount;
    /**
