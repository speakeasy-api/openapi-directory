...
public class ShippingFulfillment {
     ...
     */
    public org.openapis.openapi.models.operations.CreateShippingFulfillmentResponse createShippingFulfillment(org.openapis.openapi.models.operations.CreateShippingFulfillmentRequest request, org.openapis.openapi.models.operations.CreateShippingFulfillmentSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.CreateShippingFulfillmentRequest.class, baseUrl, "/order/{orderId}/shipping_fulfillment", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "shippingFulfillmentDetails", "json");
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.GetShippingFulfillmentResponse getShippingFulfillment(org.openapis.openapi.models.operations.GetShippingFulfillmentRequest request, org.openapis.openapi.models.operations.GetShippingFulfillmentSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetShippingFulfillmentRequest.class, baseUrl, "/order/{orderId}/shipping_fulfillment/{fulfillmentId}", request, null);
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.GetShippingFulfillmentsResponse getShippingFulfillments(org.openapis.openapi.models.operations.GetShippingFulfillmentsRequest request, org.openapis.openapi.models.operations.GetShippingFulfillmentsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetShippingFulfillmentsRequest.class, baseUrl, "/order/{orderId}/shipping_fulfillment", request, null);
