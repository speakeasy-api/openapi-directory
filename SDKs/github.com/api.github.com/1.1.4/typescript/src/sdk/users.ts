...
export class Users {
  ...
  **/
  usersBlock(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/user/blocks/{username}", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UsersBlockResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  usersCheckBlocked(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UsersCheckBlockedResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 204:
            break;
          case httpRes?.status == 304:
  ...
  **/
  usersListBlockedByAuthenticated(
    config?: AxiosRequestConfig
  ): Promise<operations.UsersListBlockedByAuthenticatedResponse> {
    const baseURL: string = this._serverURL;
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UsersListBlockedByAuthenticatedResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.simpleUsers = httpRes?.data;
          ...
          case httpRes?.status == 415:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.usersListBlockedByAuthenticated415ApplicationJSONObject = httpRes?.data;
            }
            break;
        }
  ...
  **/
  usersSetPrimaryEmailVisibilityForAuthenticated(
    req: operations.UsersSetPrimaryEmailVisibilityForAuthenticatedRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UsersSetPrimaryEmailVisibilityForAuthenticatedResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UsersSetPrimaryEmailVisibilityForAuthenticatedRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UsersSetPrimaryEmailVisibilityForAuthenticatedResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.emails = httpRes?.data;
  ...
  **/
  usersUnblock(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UsersUnblockResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 204:
            break;
          case httpRes?.status == 304:
