...
var BatchGetBuildBatchesOutput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: buildbatch_1.BuildBatch }),
        (0, class_transformer_1.Expose)({ name: "buildBatches" }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "buildBatchesNotFound" }),
        __metadata("design:type", Array)
