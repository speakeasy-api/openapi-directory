 ...
 */
public enum UpdateOrganizationBrandingPolicy200ApplicationJSONAdminSettingsAppliesToEnum {
    ...
    private UpdateOrganizationBrandingPolicy200ApplicationJSONAdminSettingsAppliesToEnum(String value) {
        this.value = value;
    }
}
