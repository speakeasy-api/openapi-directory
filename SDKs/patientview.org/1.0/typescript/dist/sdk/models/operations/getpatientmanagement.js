...
exports.GetPatientManagementResponse = exports.GetPatientManagementRequest = void 0;
...
var GetPatientManagementRequest = /** @class */ (function (_super) {
    ...
    ], GetPatientManagementRequest.prototype, "groupId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=identifierId",
        }),
        __metadata("design:type", Number)
    ], GetPatientManagementRequest.prototype, "identifierId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=userId",
        }),
        __metadata("design:type", Number)
    ], GetPatientManagementRequest.prototype, "userId", void 0);
    return GetPatientManagementRequest;
}(utils_1.SpeakeasyBase));
exports.GetPatientManagementRequest = GetPatientManagementRequest;
var GetPatientManagementResponse = /** @class */ (function (_super) {
    ...
    ], GetPatientManagementResponse.prototype, "rawResponse", void 0);
    return GetPatientManagementResponse;
}(utils_1.SpeakeasyBase));
exports.GetPatientManagementResponse = GetPatientManagementResponse;
