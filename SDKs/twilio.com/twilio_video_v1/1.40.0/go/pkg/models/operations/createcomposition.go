...
func (e *CreateCompositionCreateCompositionRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateCompositionCreateCompositionRequestStatusCallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCompositionCreateCompositionRequestStatusCallbackMethodEnum: %s", s)
	}
}
