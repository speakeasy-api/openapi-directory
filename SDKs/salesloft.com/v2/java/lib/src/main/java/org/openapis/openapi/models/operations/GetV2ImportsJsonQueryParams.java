...
public class GetV2ImportsJsonQueryParams {
    /**
    ...
    public Long[] ids;
    public GetV2ImportsJsonQueryParams withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2ImportsJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2ImportsJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public Long page;
    public GetV2ImportsJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2ImportsJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2ImportsJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2ImportsJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public Long[] userIds;
    public GetV2ImportsJsonQueryParams withUserIds(Long[] userIds) {
