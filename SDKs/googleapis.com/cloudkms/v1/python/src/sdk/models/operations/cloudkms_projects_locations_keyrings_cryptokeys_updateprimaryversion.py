...
class CloudkmsProjectsLocationsKeyRingsCryptoKeysUpdatePrimaryVersionRequest:
    ...
    r"""Required. The resource name of the CryptoKey to update."""  
    ...
    update_crypto_key_primary_version_request: Optional[shared_updatecryptokeyprimaryversionrequest.UpdateCryptoKeyPrimaryVersionRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
