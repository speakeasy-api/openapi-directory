...
var MessagingV1Service = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=area_code_geomatch" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=fallback_method" }),
        __metadata("design:type", String)
    ], MessagingV1Service.prototype, "fallbackMethod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=fallback_to_long_code" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=inbound_request_url" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mms_converter" }),
        __metadata("design:type", Boolean)
    ], MessagingV1Service.prototype, "mmsConverter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=scan_message_content" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=smart_encoding" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sticky_sender" }),
        __metadata("design:type", Boolean)
    ], MessagingV1Service.prototype, "stickySender", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=synchronous_validation" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=us_app_to_person_registered" }),
        __metadata("design:type", Boolean)
    ], MessagingV1Service.prototype, "usAppToPersonRegistered", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=use_inbound_webhook_on_number" }),
        __metadata("design:type", Boolean)
    ], MessagingV1Service.prototype, "useInboundWebhookOnNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=usecase" }),
        __metadata("design:type", String)
    ], MessagingV1Service.prototype, "usecase", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=validity_period" }),
