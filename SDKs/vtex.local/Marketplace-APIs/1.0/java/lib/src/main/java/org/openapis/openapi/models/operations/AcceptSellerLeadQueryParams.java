...
public class AcceptSellerLeadQueryParams {
    /**
    ...
    public AcceptSellerLeadQueryParams withAccountName(String accountName) {
    ...
    public AcceptSellerLeadQueryParams withEnvironment(String environment) {
