...
class StartCallAnalyticsJobRequest:
    ...
    start_call_analytics_job_request: shared_startcallanalyticsjobrequest.StartCallAnalyticsJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
