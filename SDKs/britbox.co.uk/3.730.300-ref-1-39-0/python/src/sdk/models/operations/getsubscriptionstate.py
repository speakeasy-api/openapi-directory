...
from ..shared import itvsubscriptionstate as shared_itvsubscriptionstate
...
class GetSubscriptionStateResponse:
    ...
    itv_subscription_state: Optional[shared_itvsubscriptionstate.ItvSubscriptionState] = dataclasses.field(default=None)
