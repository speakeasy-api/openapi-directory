...
class Error:
    r"""A container that defines the elements of error and warning messages."""
    ...
    r"""Name of the domain ,or primary system, of the service or application where the error occurred."""  
    ...
    r"""A more detailed explanation of the error than given in the <code>message</code> error field."""  
    ...
    r"""This optional list of name/value pairs that contain context-specific <code>ErrorParameter</code> objects, with each item in the list being a parameter (or input field name) that caused an error condition. Each <code>ErrorParameter</code> object consists of two fields, a <code>name</code> and a <code>value</code>."""  
    ...
    r"""If present, indicates the subsystem in which the error occurred."""  
