...
export class DatastreamProjectsLocationsConnectionProfilesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatastreamProjectsLocationsConnectionProfilesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatastreamProjectsLocationsConnectionProfilesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
