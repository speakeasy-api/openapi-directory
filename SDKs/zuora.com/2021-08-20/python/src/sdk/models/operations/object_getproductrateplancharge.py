...
from ..shared import proxygetproductrateplancharge as shared_proxygetproductrateplancharge
...
class ObjectGETProductRatePlanChargeRequest:
    ...
    r"""The unique ID of a product rate plan charge to be retrieved. For example, 2c93808457d787030157e031fcd34e19."""  
...
class ObjectGETProductRatePlanChargeResponse:
    ...
    proxy_get_product_rate_plan_charge: Optional[shared_proxygetproductrateplancharge.ProxyGetProductRatePlanCharge] = dataclasses.field(default=None)  
