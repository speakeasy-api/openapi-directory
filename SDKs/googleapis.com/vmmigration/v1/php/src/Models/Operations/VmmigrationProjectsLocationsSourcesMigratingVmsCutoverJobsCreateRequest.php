...
class VmmigrationProjectsLocationsSourcesMigratingVmsCutoverJobsCreateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\CutoverJobInput $cutoverJobInput = null;
