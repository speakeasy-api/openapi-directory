...
export class DeleteOriginAccessControl20200531Request extends SpeakeasyBase {
  /**
...
export class DeleteOriginAccessControl20200531Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
