...
export class ContainerProjectsZonesClustersSetMasterAuthSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContainerProjectsZonesClustersSetMasterAuthRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsZonesClustersSetMasterAuthResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
