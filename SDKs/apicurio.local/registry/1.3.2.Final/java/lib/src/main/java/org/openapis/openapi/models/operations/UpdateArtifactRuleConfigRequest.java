...
public class UpdateArtifactRuleConfigRequest {
    ...
    public UpdateArtifactRuleConfigRequest(@JsonProperty("Rule1") org.openapis.openapi.models.shared.Rule rule1, @JsonProperty("artifactId") String artifactId, @JsonProperty("rulePathParameter") UpdateArtifactRuleConfigRuleEnum rulePathParameter) {
        this.rule1 = rule1;
        this.artifactId = artifactId;
        this.rulePathParameter = rulePathParameter;
  }
