...
export class GetarchivedbycouponcodeRequest extends SpeakeasyBase {
  /**
 ...
 * OK
 */
export class Getarchivedbycouponcode200ApplicationJSON extends SpeakeasyBase {
  /**
   * Coupon code.
   */
  @SpeakeasyMetadata()
...
export class GetarchivedbycouponcodeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
