...
func (e UpdateOrganizationAdaptivePolicyPolicyRequestBodyLastEntryRuleEnum) ToPointer() *UpdateOrganizationAdaptivePolicyPolicyRequestBodyLastEntryRuleEnum {
	return &e
}
...
func (e *UpdateOrganizationAdaptivePolicyPolicyRequestBodyLastEntryRuleEnum) UnmarshalJSON(data []byte) error {
	...
	case "default":
		fallthrough
	case "deny":
		*e = UpdateOrganizationAdaptivePolicyPolicyRequestBodyLastEntryRuleEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationAdaptivePolicyPolicyRequestBodyLastEntryRuleEnum: %v", v)
	}
}
...
type UpdateOrganizationAdaptivePolicyPolicyRequest struct {
	RequestBody    *UpdateOrganizationAdaptivePolicyPolicyRequestBody `request:"mediaType=application/json"`
