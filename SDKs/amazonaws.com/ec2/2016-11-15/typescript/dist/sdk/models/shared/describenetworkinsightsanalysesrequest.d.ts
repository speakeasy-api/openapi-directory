 ...
 */
export declare class DescribeNetworkInsightsAnalysesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeNetworkInsightsAnalysesRequest extends SpeakeasyBase {
    analysisEndTime?: Date;
    analysisStartTime?: Date;
    dryRun?: boolean;
    filters?: DescribeNetworkInsightsAnalysesRequestFilters[];
    maxResults?: number;
