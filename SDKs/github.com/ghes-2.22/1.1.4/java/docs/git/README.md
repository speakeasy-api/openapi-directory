...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateBlobRequest req = new GitCreateBlobRequest(                new GitCreateBlobRequestBody("deleniti") {{
                                encoding = "itaque";
                            }};, "dolorum", "architecto");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateCommitRequest req = new GitCreateCommitRequest(                new GitCreateCommitRequestBody("omnis", "tenetur") {{
                                author = new GitCreateCommitRequestBodyAuthor("quasi", "at") {{
                                    date = OffsetDateTime.parse("2022-07-19T05:32:14.038Z");
                                }};;
                                committer = new GitCreateCommitRequestBodyCommitter() {{
                                    date = OffsetDateTime.parse("2022-09-03T18:06:00.164Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateRefRequest req = new GitCreateRefRequest(                new GitCreateRefRequestBody("numquam", "impedit") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateTagRequest req = new GitCreateTagRequest(                new GitCreateTagRequestBody("aut", "dignissimos", "dicta", GitCreateTagRequestBodyTypeEnum.BLOB) {{
                                tagger = new GitCreateTagRequestBodyTagger("natus", "velit") {{
                                    date = OffsetDateTime.parse("2021-11-17T02:47:10.534Z");
                                }};;
                            }};, "asperiores", "aperiam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitDeleteRefRequest req = new GitDeleteRefRequest("labore", "ab", "adipisci");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetBlobRequest req = new GitGetBlobRequest("fuga", "id", "suscipit");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetCommitRequest req = new GitGetCommitRequest("velit", "culpa", "est");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetRefRequest req = new GitGetRefRequest("recusandae", "totam", "fugiat");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetTagRequest req = new GitGetTagRequest("vel", "ducimus", "quos");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetTreeRequest req = new GitGetTreeRequest("vel", "labore", "possimus") {{
                recursive = "facilis";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitListMatchingRefsRequest req = new GitListMatchingRefsRequest("cum", "commodi", "in") {{
                page = 360545L;
                perPage = 968904L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitUpdateRefRequest req = new GitUpdateRefRequest(                new GitUpdateRefRequestBody("assumenda") {{
                                force = false;
                            }};, "nemo", "recusandae", "aliquid");            
