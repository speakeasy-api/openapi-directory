...
exports.DownloadFileViaTokenResponse = exports.DownloadFileViaTokenRequest = void 0;
...
var DownloadFileViaTokenRequest = /** @class */ (function (_super) {
    ...
    ], DownloadFileViaTokenRequest.prototype, "range", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=generic_mimetype",
        }),
        __metadata("design:type", Boolean)
    ], DownloadFileViaTokenRequest.prototype, "genericMimetype", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=inline",
        }),
        __metadata("design:type", Boolean)
    ], DownloadFileViaTokenRequest.prototype, "inline", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=token",
        }),
        __metadata("design:type", String)
    ], DownloadFileViaTokenRequest.prototype, "token", void 0);
    return DownloadFileViaTokenRequest;
}(utils_1.SpeakeasyBase));
exports.DownloadFileViaTokenRequest = DownloadFileViaTokenRequest;
var DownloadFileViaTokenResponse = /** @class */ (function (_super) {
    ...
    ], DownloadFileViaTokenResponse.prototype, "rawResponse", void 0);
    return DownloadFileViaTokenResponse;
}(utils_1.SpeakeasyBase));
exports.DownloadFileViaTokenResponse = DownloadFileViaTokenResponse;
