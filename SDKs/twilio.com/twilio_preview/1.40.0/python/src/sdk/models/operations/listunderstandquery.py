...
class ListUnderstandQueryListUnderstandQueryResponse:
    ...
    meta: Optional[ListUnderstandQueryListUnderstandQueryResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    queries: Optional[list[shared_preview_understand_assistant_query.PreviewUnderstandAssistantQuery]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('queries'), 'exclude': lambda f: f is None }})  
