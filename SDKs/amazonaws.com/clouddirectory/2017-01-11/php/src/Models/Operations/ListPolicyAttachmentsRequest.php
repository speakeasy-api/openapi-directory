...
class ListPolicyAttachmentsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ListPolicyAttachmentsXAmzConsistencyLevelEnum $xAmzConsistencyLevel
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=x-amz-consistency-level')]
    public ?ListPolicyAttachmentsXAmzConsistencyLevelEnum $xAmzConsistencyLevel = null;
	...
	public function __construct()
	{
		...
		$this->nextToken = null;
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\ListPolicyAttachmentsRequestBody();
