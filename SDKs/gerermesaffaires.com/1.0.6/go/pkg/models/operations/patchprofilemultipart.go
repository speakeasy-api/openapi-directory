...
func (e PatchProfileMultipartFormDataSexEnum) ToPointer() *PatchProfileMultipartFormDataSexEnum {
	return &e
}
...
func (e *PatchProfileMultipartFormDataSexEnum) UnmarshalJSON(data []byte) error {
	...
	case "male":
		fallthrough
	case "female":
		*e = PatchProfileMultipartFormDataSexEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PatchProfileMultipartFormDataSexEnum: %v", v)
	}
}
