...
class VmwareVMDetails:
    ...
    r"""Output only. The VM Boot Option."""  
    committed_storage: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('committedStorage'), 'exclude': lambda f: f is None }})
