...
class ErrorHandlingConfig:
    ...
    fail_on_first_destination_error: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('failOnFirstDestinationError') }})
