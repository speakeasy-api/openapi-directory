...
exports.PatchReviewsReviewIdResponse = exports.PatchReviewsReviewIdRequest = void 0;
...
var PatchReviewsReviewIdRequest = /** @class */ (function (_super) {
    ...
    ], PatchReviewsReviewIdRequest.prototype, "customData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=description",
        }),
        __metadata("design:type", String)
    ], PatchReviewsReviewIdRequest.prototype, "description", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=headline",
        }),
        __metadata("design:type", String)
    ], PatchReviewsReviewIdRequest.prototype, "headline", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=rating",
        }),
        __metadata("design:type", Number)
    ], PatchReviewsReviewIdRequest.prototype, "rating", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=reviewId",
        }),
        __metadata("design:type", String)
    ], PatchReviewsReviewIdRequest.prototype, "reviewId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userAccountId",
        }),
        __metadata("design:type", String)
    ], PatchReviewsReviewIdRequest.prototype, "userAccountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userId",
        }),
        __metadata("design:type", String)
    ], PatchReviewsReviewIdRequest.prototype, "userId", void 0);
...
var PatchReviewsReviewIdResponse = /** @class */ (function (_super) {
    ...
    ], PatchReviewsReviewIdResponse.prototype, "rawResponse", void 0);
