...
export class DatalabelingProjectsDatasetsTextLabelSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatalabelingProjectsDatasetsTextLabelRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatalabelingProjectsDatasetsTextLabelResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
