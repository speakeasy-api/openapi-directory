...
class ListRecordHistoryInput:
    ...
    search_filter: Optional[shared_listrecordhistorysearchfilter.ListRecordHistorySearchFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SearchFilter'), 'exclude': lambda f: f is None }})  
