...
public class RateTable {
    ...
    **/
    public openapisdk.models.operations.GetRateTablesResponse getRateTables(openapisdk.models.operations.GetRateTablesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/rate_table");
        ...
        openapisdk.models.operations.GetRateTablesResponse res = new openapisdk.models.operations.GetRateTablesResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.RateTableResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.RateTableResponse.class);
