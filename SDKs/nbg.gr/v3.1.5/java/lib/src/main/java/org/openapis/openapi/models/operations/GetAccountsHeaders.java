...
public class GetAccountsHeaders {
    ...
    public GetAccountsHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public GetAccountsHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public GetAccountsHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public GetAccountsHeaders withXFapiInteractionId(String xFapiInteractionId) {
