...
type CreateParticipantTokenHeaders struct {
...
type CreateParticipantTokenRequest struct {
	Headers CreateParticipantTokenHeaders
	Request CreateParticipantTokenRequestBody `request:"mediaType=application/json"`
}
