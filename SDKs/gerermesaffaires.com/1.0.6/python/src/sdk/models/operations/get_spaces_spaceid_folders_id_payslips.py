...
class GetSpacesSpaceIDFoldersIDPayslipsRequest:
...
class GetSpacesSpaceIDFoldersIDPayslipsResponse:
    ...
    get_spaces_space_id_folders_id_payslips_200_application_json_all_ofs: Optional[list[shared_payslip.PaySlip]] = dataclasses.field(default=None)
    r"""A list of payslips of the folder employee"""  
