...
class Organization 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\FetchOrganizationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\FetchOrganizationResponse
     */
	public function fetchOrganization(
        \OpenAPI\OpenAPI\Models\Operations\FetchOrganizationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\FetchOrganizationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/organization/{id}', \OpenAPI\OpenAPI\Models\Operations\FetchOrganizationRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\FetchOrganizationResponse();
