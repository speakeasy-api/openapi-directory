...
export class Node extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: Extension })
  ...
  @Expose({ name: "listeningAddresses" })
  @Type(() => Address)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "userAgentBuildVersion" })
  @Type(() => BuildVersion)
