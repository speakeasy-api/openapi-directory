...
export class FirebaseProjectsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseProjectsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class FirebaseProjectsListSecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class FirebaseProjectsListSecurityOption4 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class FirebaseProjectsListSecurity extends SpeakeasyBase {
...
export class FirebaseProjectsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseProjectsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
