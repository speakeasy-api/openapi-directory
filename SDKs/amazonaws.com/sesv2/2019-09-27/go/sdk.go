...
func (s *SDK) BatchGetMetricData(ctx context.Context, request operations.BatchGetMetricDataRequest) (*operations.BatchGetMetricDataResponse, error) {
	...
	res := &operations.BatchGetMetricDataResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.BatchGetMetricDataResponse
...
func (s *SDK) GetDedicatedIPPool(ctx context.Context, request operations.GetDedicatedIPPoolRequest) (*operations.GetDedicatedIPPoolResponse, error) {
	...
	res := &operations.GetDedicatedIPPoolResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetDedicatedIPPoolResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) PutAccountVdmAttributes(ctx context.Context, request operations.PutAccountVdmAttributesRequest) (*operations.PutAccountVdmAttributesResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PutAccountVdmAttributesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
func (s *SDK) PutConfigurationSetVdmOptions(ctx context.Context, request operations.PutConfigurationSetVdmOptionsRequest) (*operations.PutConfigurationSetVdmOptionsResponse, error) {
	...
	res := &operations.PutConfigurationSetVdmOptionsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
