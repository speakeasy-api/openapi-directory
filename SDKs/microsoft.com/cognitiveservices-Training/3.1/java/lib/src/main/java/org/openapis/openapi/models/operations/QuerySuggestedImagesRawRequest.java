...
public class QuerySuggestedImagesRawRequest {
    ...
    public QuerySuggestedImagesRawRequest withTrainingKey(String trainingKey) {
    ...
    public QuerySuggestedImagesRawRequest(@JsonProperty("RequestBody") byte[] requestBody, @JsonProperty("Training-Key") String trainingKey, @JsonProperty("iterationId") String iterationId, @JsonProperty("projectId") String projectId) {
        this.requestBody = requestBody;
        this.trainingKey = trainingKey;
        this.iterationId = iterationId;
        this.projectId = projectId;
