...
class ListFleetRequest:
    ...
    r"""The SID or unique name of the Network Access Profile that controls which cellular networks the Fleet's SIMs can connect to."""  
...
class ListFleetListFleetResponse:
    ...
    fleets: Optional[list[shared_supersim_v1_fleet.SupersimV1Fleet]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fleets'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListFleetListFleetResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
