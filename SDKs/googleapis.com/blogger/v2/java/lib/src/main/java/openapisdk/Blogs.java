...
public class Blogs {
    ...
    **/
    public openapisdk.models.operations.BloggerBlogsGetResponse bloggerBlogsGet(openapisdk.models.operations.BloggerBlogsGetRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v2/blogs/{blogId}", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.BloggerBlogsListResponse bloggerBlogsList(openapisdk.models.operations.BloggerBlogsListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v2/users/{userId}/blogs", request.pathParams);
        ...
        openapisdk.models.operations.BloggerBlogsListResponse res = new openapisdk.models.operations.BloggerBlogsListResponse() {{
            blogList = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
