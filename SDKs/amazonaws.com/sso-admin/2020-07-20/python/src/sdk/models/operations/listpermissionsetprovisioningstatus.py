...
class ListPermissionSetProvisioningStatusRequest:
    ...
    list_permission_set_provisioning_status_request: shared_listpermissionsetprovisioningstatusrequest.ListPermissionSetProvisioningStatusRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
