...
```bash
go get github.com/speakeasy-api/openapi-directory/SDKs/apisetu.gov.in/jeecup/3.0.0/go
```
...
func main() {
    ...
    res, err := s.APIs.Adcrd(ctx, operations.AdcrdRequestBody{
        ...
        Format: operations.AdcrdRequestBodyFormatEnumPdf,
...
* [Adcrd](docs/apis/README.md#adcrd) - Admit Card
