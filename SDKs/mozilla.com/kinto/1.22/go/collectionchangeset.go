...
func newCollectionChangeset(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *collectionChangeset {
...
func (s *collectionChangeset) GetCollectionChangeset(ctx context.Context, request operations.GetCollectionChangesetRequest) (*operations.GetCollectionChangesetResponse, error) {
	...
	res := &operations.GetCollectionChangesetResponse{
