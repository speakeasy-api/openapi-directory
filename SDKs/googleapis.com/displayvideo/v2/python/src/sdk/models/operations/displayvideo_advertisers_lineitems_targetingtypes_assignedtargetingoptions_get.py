...
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetRequest:
    ...
    r"""Required. The ID of the advertiser the line item belongs to."""  
    ...
    r"""Required. An identifier unique to the targeting type in this line item that identifies the assigned targeting option being requested."""  
    line_item_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'lineItemId', 'style': 'simple', 'explode': False }})
    r"""Required. The ID of the line item the assigned targeting option belongs to."""  
