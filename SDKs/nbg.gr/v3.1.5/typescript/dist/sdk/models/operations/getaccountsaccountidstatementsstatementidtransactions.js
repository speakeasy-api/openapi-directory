...
exports.GetAccountsAccountIdStatementsStatementIdTransactionsResponse = exports.GetAccountsAccountIdStatementsStatementIdTransactionsRequest = exports.GetAccountsAccountIdStatementsStatementIdTransactionsSecurity = void 0;
...
var GetAccountsAccountIdStatementsStatementIdTransactionsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdTransactionsRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=sandbox-id",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdTransactionsRequest.prototype, "sandboxId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=statementId",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdTransactionsRequest.prototype, "statementId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdTransactionsRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdTransactionsRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdTransactionsRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdTransactionsRequest.prototype, "xFapiInteractionId", void 0);
...
var GetAccountsAccountIdStatementsStatementIdTransactionsResponse = /** @class */ (function (_super) {
    ...
    ], GetAccountsAccountIdStatementsStatementIdTransactionsResponse.prototype, "rawResponse", void 0);
