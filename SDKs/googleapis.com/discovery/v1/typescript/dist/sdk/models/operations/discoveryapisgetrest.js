...
exports.DiscoveryApisGetRestResponse = exports.DiscoveryApisGetRestRequest = void 0;
...
var DiscoveryApisGetRestRequest = /** @class */ (function (_super) {
    ...
    ], DiscoveryApisGetRestRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=api" }),
        __metadata("design:type", String)
    ], DiscoveryApisGetRestRequest.prototype, "api", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], DiscoveryApisGetRestRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], DiscoveryApisGetRestRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], DiscoveryApisGetRestRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], DiscoveryApisGetRestRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], DiscoveryApisGetRestRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], DiscoveryApisGetRestRequest.prototype, "userIp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=version",
        }),
        __metadata("design:type", String)
    ], DiscoveryApisGetRestRequest.prototype, "version", void 0);
    return DiscoveryApisGetRestRequest;
}(utils_1.SpeakeasyBase));
exports.DiscoveryApisGetRestRequest = DiscoveryApisGetRestRequest;
var DiscoveryApisGetRestResponse = /** @class */ (function (_super) {
    ...
    ], DiscoveryApisGetRestResponse.prototype, "rawResponse", void 0);
    return DiscoveryApisGetRestResponse;
}(utils_1.SpeakeasyBase));
exports.DiscoveryApisGetRestResponse = DiscoveryApisGetRestResponse;
