...
public class PsnocRequestBody {
    ...
    public PsnocRequestBody withConsentArtifact(org.openapis.openapi.models.shared.ConsentArtifactSchema consentArtifact) {
    ...
    public PsnocRequestBody(@JsonProperty("format") PsnocRequestBodyFormatEnum format, @JsonProperty("txnId") String txnId) {
        this.format = format;
        this.txnId = txnId;
  }
}
