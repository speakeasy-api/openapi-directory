    ...
    public static void main(String[] args) {
        try {
            ...
            CripcRequestBody req = new CripcRequestBody(CripcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new CripcRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "0317002620P100108515", "DD-MM-YYYY", "1234234234", "123412341234");;
    ...
    public static void main(String[] args) {
        try {
            ...
            TwipcRequestBody req = new TwipcRequestBody(TwipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new TwipcRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "0317002620P100108515", "DD-MM-YYYY", "1234234234", "123412341234");;
            ...
            TwipcResponse res = sdk.apIs.twipc(req, new TwipcSecurity("qui", "impedit") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
