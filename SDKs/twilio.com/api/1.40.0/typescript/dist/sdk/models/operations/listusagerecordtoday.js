...
exports.ListUsageRecordTodayResponse = exports.ListUsageRecordTodayListUsageRecordTodayResponse = exports.ListUsageRecordTodayRequest = exports.ListUsageRecordTodaySecurity = exports.ListUsageRecordTodayServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListUsageRecordTodayServerList = [
...
var ListUsageRecordTodaySecurity = /** @class */ (function (_super) {
    ...
    ], ListUsageRecordTodaySecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordTodaySecurity.prototype, "username", void 0);
    return ListUsageRecordTodaySecurity;
}(utils_1.SpeakeasyBase));
exports.ListUsageRecordTodaySecurity = ListUsageRecordTodaySecurity;
var ListUsageRecordTodayRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListUsageRecordTodayRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Category",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordTodayRequest.prototype, "category", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EndDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListUsageRecordTodayRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=IncludeSubaccounts",
        }),
        __metadata("design:type", Boolean)
    ], ListUsageRecordTodayRequest.prototype, "includeSubaccounts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListUsageRecordTodayRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListUsageRecordTodayRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordTodayRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListUsageRecordTodayRequest.prototype, "startDate", void 0);
    return ListUsageRecordTodayRequest;
}(utils_1.SpeakeasyBase));
exports.ListUsageRecordTodayRequest = ListUsageRecordTodayRequest;
/**
 * OK
 */
var ListUsageRecordTodayListUsageRecordTodayResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.ApiV2010AccountUsageUsageRecordUsageRecordToday,
        }),
        (0, class_transformer_1.Expose)({ name: "usage_records" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountUsageUsageRecordUsageRecordToday; }),
...
exports.ListUsageRecordTodayListUsageRecordTodayResponse = ListUsageRecordTodayListUsageRecordTodayResponse;
var ListUsageRecordTodayResponse = /** @class */ (function (_super) {
    ...
    ], ListUsageRecordTodayResponse.prototype, "rawResponse", void 0);
    return ListUsageRecordTodayResponse;
}(utils_1.SpeakeasyBase));
exports.ListUsageRecordTodayResponse = ListUsageRecordTodayResponse;
