...
type ToolresultsProjectsHistoriesExecutionsClustersListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ToolresultsProjectsHistoriesExecutionsClustersListPathParams struct {
...
type ToolresultsProjectsHistoriesExecutionsClustersListQueryParams struct {
	// V1 error format.
...
type ToolresultsProjectsHistoriesExecutionsClustersListRequest struct {
...
type ToolresultsProjectsHistoriesExecutionsClustersListResponse struct {
	ContentType string
	// Successful response
