...
public class ListCatalogQueryParams {
    /**
    ...
    public ListCatalogQueryParams withCatalogVersion(Long catalogVersion) {
    ...
    public ListCatalogQueryParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public String types;
    public ListCatalogQueryParams withTypes(String types) {
        this.types = types;
        return this;
    }
