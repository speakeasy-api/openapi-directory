 ...
 */
export class DescribeEgressOnlyInternetGatewaysRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeEgressOnlyInternetGatewaysRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
