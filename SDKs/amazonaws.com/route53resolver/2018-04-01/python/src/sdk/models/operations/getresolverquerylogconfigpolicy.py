...
class GetResolverQueryLogConfigPolicyRequest:
    ...
    get_resolver_query_log_config_policy_request: shared_getresolverquerylogconfigpolicyrequest.GetResolverQueryLogConfigPolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
