...
class LoginResponseResponse:
    ...
    r"""The WebID of the user who has logged in."""  
...
class LoginResponse:
    ...
    response: LoginResponseResponse = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response') }})  
    status: LoginResponseStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
