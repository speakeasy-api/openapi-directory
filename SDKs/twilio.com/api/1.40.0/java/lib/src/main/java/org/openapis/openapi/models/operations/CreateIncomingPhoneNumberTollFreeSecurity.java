...
public class CreateIncomingPhoneNumberTollFreeSecurity {
    ...
    public CreateIncomingPhoneNumberTollFreeSecurity withPassword(String password) {
    ...
    public CreateIncomingPhoneNumberTollFreeSecurity withUsername(String username) {
