...
class DescribeAggregationAuthorizationsRequest:
    ...
    describe_aggregation_authorizations_request: shared_describeaggregationauthorizationsrequest.DescribeAggregationAuthorizationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
