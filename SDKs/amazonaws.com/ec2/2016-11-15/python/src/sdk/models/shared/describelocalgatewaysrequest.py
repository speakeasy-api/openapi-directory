...
class DescribeLocalGatewaysRequest:
    ...
    filters: Optional[list[DescribeLocalGatewaysRequestFilters]] = dataclasses.field(default=None)  
    local_gateway_ids: Optional[list[str]] = dataclasses.field(default=None)  
