...
class DescribeAcceleratorAttributesRequest:
    ...
    describe_accelerator_attributes_request: shared_describeacceleratorattributesrequest.DescribeAcceleratorAttributesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
