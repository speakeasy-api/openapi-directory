...
class GetOrganizationApplianceSecurityEventsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetOrganizationApplianceSecurityEventsSortOrderEnum $sortOrder
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortOrder')]
    public ?GetOrganizationApplianceSecurityEventsSortOrderEnum $sortOrder = null;
