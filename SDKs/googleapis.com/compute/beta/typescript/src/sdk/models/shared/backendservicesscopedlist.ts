 ...
 */
export enum BackendServicesScopedListWarningCodeEnum {
...
export class BackendServicesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class BackendServicesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: BackendServicesScopedListWarningData })
  @Expose({ name: "data" })
...
export class BackendServicesScopedList extends SpeakeasyBase {
  /**
   * A list of BackendServices contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: BackendService })
  @Expose({ name: "backendServices" })
  @Type(() => BackendService)
