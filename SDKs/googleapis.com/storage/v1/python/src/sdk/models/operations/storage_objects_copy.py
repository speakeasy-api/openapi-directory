...
class StorageObjectsCopyDestinationPredefinedACLEnum(str, Enum):
...
class StorageObjectsCopyQueryParams:
    ...
    destination_predefined_acl: Optional[StorageObjectsCopyDestinationPredefinedACLEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'destinationPredefinedAcl', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class StorageObjectsCopySecurityOption3:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
...
class StorageObjectsCopySecurity:
    ...
    option3: Optional[StorageObjectsCopySecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
