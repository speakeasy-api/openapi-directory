...
export class BigquerydatatransferProjectsTransferConfigsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BigquerydatatransferProjectsTransferConfigsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BigquerydatatransferProjectsTransferConfigsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
