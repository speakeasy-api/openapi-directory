...
class ListWirelessRatePlanListWirelessRatePlanResponse:
    ...
    meta: Optional[ListWirelessRatePlanListWirelessRatePlanResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    rate_plans: Optional[list[shared_preview_wireless_rate_plan.PreviewWirelessRatePlan]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rate_plans'), 'exclude': lambda f: f is None }})  
