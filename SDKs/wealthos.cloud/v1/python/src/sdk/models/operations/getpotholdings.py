...
@dataclasses.dataclass
class GetPotHoldings500ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetPotHoldings429ApplicationJSON:
...
class GetPotHoldings200ApplicationJSON:
    ...
    holdings: list[GetPotHoldings200ApplicationJSONHoldings] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('holdings') }})
...
class GetPotHoldingsResponse:
    ...
    get_pot_holdings_200_application_json_object: Optional[GetPotHoldings200ApplicationJSON] = dataclasses.field(default=None)
    r"""success"""  
    get_pot_holdings_400_application_json_object: Optional[GetPotHoldings400ApplicationJSON] = dataclasses.field(default=None)
    r"""Request is not complete and may have one or more validations errors. Please check the error message and the code"""  
    get_pot_holdings_401_application_json_object: Optional[GetPotHoldings401ApplicationJSON] = dataclasses.field(default=None)
    r"""You do not have permissions to access this resource."""  
    get_pot_holdings_403_application_json_object: Optional[GetPotHoldings403ApplicationJSON] = dataclasses.field(default=None)
    r"""Your authentication information is missing or invalid. Please check the keys are properly set and its correct"""  
    get_pot_holdings_404_application_json_object: Optional[GetPotHoldings404ApplicationJSON] = dataclasses.field(default=None)
    r"""The specified resource was not found"""  
    get_pot_holdings_429_application_json_object: Optional[GetPotHoldings429ApplicationJSON] = dataclasses.field(default=None)
    r"""You have sent too many requests to the system. Please retry later. If you need to increase your throtteling limits, please contact WOS support"""  
    get_pot_holdings_500_application_json_object: Optional[GetPotHoldings500ApplicationJSON] = dataclasses.field(default=None)
    r"""System error. Retry later. If the error persist, contact WOS support"""  
