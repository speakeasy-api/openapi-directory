...
export class Licenses {
   ...
   *
   * https://docs.github.com/enterprise-server@2.19/rest/reference/licenses#get-a-license - API method documentation
  **/
  licensesGet(
   ...
   *
   * https://docs.github.com/enterprise-server@2.19/rest/reference/licenses#get-all-commonly-used-licenses - API method documentation
  **/
   ...
   *
   * https://docs.github.com/enterprise-server@2.19/rest/reference/licenses/#get-the-license-for-a-repository - API method documentation
  **/
  licensesGetForRepo(
