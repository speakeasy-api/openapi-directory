...
class GetPhenotypeGenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPhenotypeGenotypeAssociationsQueryParams:
...
@dataclasses.dataclass
class GetPhenotypeGenotypeAssociationsRequest:
    path_params: GetPhenotypeGenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetPhenotypeGenotypeAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetPhenotypeGenotypeAssociationsResponse:
