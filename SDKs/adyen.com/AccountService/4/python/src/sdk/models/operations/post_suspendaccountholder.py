...
from ..shared import suspendaccountholderresponse as shared_suspendaccountholderresponse
...
class PostSuspendAccountHolderResponse:
    ...
    suspend_account_holder_response: Optional[shared_suspendaccountholderresponse.SuspendAccountHolderResponse] = dataclasses.field(default=None)
