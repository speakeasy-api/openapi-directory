...
func (e *OAuthClientClientTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "confidential":
		fallthrough
	case "public":
		*e = OAuthClientClientTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for OAuthClientClientTypeEnum: %s", s)
	}
}
...
func (e *OAuthClientGrantTypesEnum) UnmarshalJSON(data []byte) error {
	...
	case "password":
		fallthrough
	case "refresh_token":
		*e = OAuthClientGrantTypesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for OAuthClientGrantTypesEnum: %s", s)
	}
}
