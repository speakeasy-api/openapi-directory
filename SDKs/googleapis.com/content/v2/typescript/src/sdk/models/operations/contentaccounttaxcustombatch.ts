...
export class ContentAccounttaxCustombatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentAccounttaxCustombatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentAccounttaxCustombatchResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
