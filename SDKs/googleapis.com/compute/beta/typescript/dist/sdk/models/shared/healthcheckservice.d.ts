 ...
 */
export declare enum HealthCheckServiceHealthStatusAggregationPolicyEnum {
    And = "AND",
 ...
 */
export declare enum HealthCheckServiceHealthStatusAggregationStrategyEnum {
    And = "AND",
    NoAggregation = "NO_AGGREGATION"
}
/**
 ...
 */
export declare class HealthCheckService extends SpeakeasyBase {
    /**
