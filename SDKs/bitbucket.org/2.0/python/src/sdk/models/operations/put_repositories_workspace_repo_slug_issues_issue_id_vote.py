...
class PutRepositoriesWorkspaceRepoSlugIssuesIssueIDVoteRequest:
    path_params: PutRepositoriesWorkspaceRepoSlugIssuesIssueIDVotePathParams = dataclasses.field()
    security: PutRepositoriesWorkspaceRepoSlugIssuesIssueIDVoteSecurity = dataclasses.field()
