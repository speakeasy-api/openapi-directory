...
export declare class DisplayvideoAdvertisersYoutubeAdGroupAdsListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class DisplayvideoAdvertisersYoutubeAdGroupAdsListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class DisplayvideoAdvertisersYoutubeAdGroupAdsListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
