...
class UpdateInsightRequestBody:
    filters: Optional[UpdateInsightRequestBodyFilters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Filters') }})
    group_by_attribute: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('GroupByAttribute') }})
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Name') }})
    

@dataclasses.dataclass
class UpdateInsightRequest:
    headers: UpdateInsightHeaders = dataclasses.field()
    path_params: UpdateInsightPathParams = dataclasses.field()
    request: UpdateInsightRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateInsightResponse:
    ...
    update_insight_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
