...
public class ListCallLogsMetricsRequest {
    ...
    public String from;
    public ListCallLogsMetricsRequest withFrom(String from) {
        this.from = from;
        return this;
    }
    ...
    public ListCallLogsMetricsRequest withNextPageToken(String nextPageToken) {
    ...
    public ListCallLogsMetricsRequest withPageSize(Long pageSize) {
    ...
    public ListCallLogsMetricsRequest withQualityType(String qualityType) {
    ...
    public ListCallLogsMetricsRequest withSiteId(String siteId) {
        this.siteId = siteId;
        return this;
    }
    ...
    public String to;
    public ListCallLogsMetricsRequest withTo(String to) {
        this.to = to;
        return this;
    }
