...
class GetListOpenIDConnectProviderTagsQueryParams:
    action: GetListOpenIDConnectProviderTagsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetListOpenIDConnectProviderTagsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListOpenIDConnectProviderTagsRequest:
    headers: GetListOpenIDConnectProviderTagsHeaders = dataclasses.field()
    query_params: GetListOpenIDConnectProviderTagsQueryParams = dataclasses.field()
