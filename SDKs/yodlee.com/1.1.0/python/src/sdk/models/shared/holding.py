...
from ..shared import assetclassification as shared_assetclassification

class HoldingHoldingTypeEnum(str, Enum):
    STOCK = "stock"
...
class HoldingOptionTypeEnum(str, Enum):
    PUT = "put"
    CALL = "call"
    UNKNOWN = "unknown"
    OTHER = "other"
...
class Holding:
    ...
    asset_classification: Optional[list[shared_assetclassification.AssetClassification]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('assetClassification') }})
    ...
    holding_type: Optional[HoldingHoldingTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('holdingType') }})
    ...
    option_type: Optional[HoldingOptionTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('optionType') }})
