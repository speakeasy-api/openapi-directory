...
public class GetV2CrmActivitiesJsonRequest {
    ...
    public GetV2CrmActivitiesJsonRequest withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2CrmActivitiesJsonRequest withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2CrmActivitiesJsonRequest withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public GetV2CrmActivitiesJsonRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetV2CrmActivitiesJsonRequest withPerPage(Long perPage) {
    ...
    public GetV2CrmActivitiesJsonRequest withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2CrmActivitiesJsonRequest withSortDirection(String sortDirection) {
    ...
    public GetV2CrmActivitiesJsonRequest withUpdatedAt(String[] updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    
    public GetV2CrmActivitiesJsonRequest(){}
}
