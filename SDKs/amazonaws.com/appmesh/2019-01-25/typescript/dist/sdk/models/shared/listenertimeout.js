...
var tcptimeout_1 = require("./tcptimeout");
// ListenerTimeout
/**
 * An object that represents timeouts for different protocols.
**/
var ListenerTimeout = /** @class */ (function (_super) {
    __extends(ListenerTimeout, _super);
    ...
    ], ListenerTimeout.prototype, "grpc", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=http" }),
        __metadata("design:type", httptimeout_1.HttpTimeout)
    ], ListenerTimeout.prototype, "http", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=http2" }),
        __metadata("design:type", httptimeout_1.HttpTimeout)
    ], ListenerTimeout.prototype, "http2", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=tcp" }),
        __metadata("design:type", tcptimeout_1.TcpTimeout)
    ], ListenerTimeout.prototype, "tcp", void 0);
