...
class DowngradeUserProofreaderPathParams:
    user_id: int = dataclasses.field(metadata={'path_param': { 'field_name': 'userId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class DowngradeUserProofreaderSecurity:
    mwo_auth: shared_security.SchemeMwoAuth = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class DowngradeUserProofreaderRequest:
    path_params: DowngradeUserProofreaderPathParams = dataclasses.field()
    security: DowngradeUserProofreaderSecurity = dataclasses.field()
    

@dataclasses.dataclass
class DowngradeUserProofreaderResponse:
