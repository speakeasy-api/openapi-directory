...
class GetBundleNotificationsResponse:
    ...
    bundle_notification_entities: Optional[list[shared_bundlenotificationentity.BundleNotificationEntity]] = dataclasses.field(default=None)
    r"""A list of BundleNotifications objects."""  
