...
import { NodeTemplatesScopedList } from "./nodetemplatesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum NodeTemplateAggregatedListWarningCodeEnum {
...
export declare class NodeTemplateAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodeTemplateAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: NodeTemplateAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: NodeTemplateAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class NodeTemplateAggregatedList extends SpeakeasyBase {
    /**
