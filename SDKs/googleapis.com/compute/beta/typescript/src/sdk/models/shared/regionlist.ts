 ...
 */
export enum RegionListWarningCodeEnum {
...
export class RegionListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class RegionListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: RegionListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: RegionListWarningData })
  @Expose({ name: "data" })
  @Type(() => RegionListWarningData)
  data?: RegionListWarningData[];
 ...
 */
export class RegionList extends SpeakeasyBase {
  /**
