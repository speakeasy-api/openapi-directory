...
class GetPageRequest:
    ...
    """  
    item_detail_expand: Optional[GetPageItemDetailExpandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'item_detail_expand', 'style': 'form', 'explode': True }})
    r"""Only relevant when loading item detail pages as these embed a detailed item in the main page entry.
    ...
    If an expand is specified which is not relevant to the item type, it will be ignored.
    """  
    item_detail_select_season: Optional[GetPageItemDetailSelectSeasonEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'item_detail_select_season', 'style': 'form', 'explode': True }})
    r"""Only relevant when loading show detail pages as these embed a detailed item in the main page entry.
    ...
    text_entry_format: Optional[GetPageTextEntryFormatEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'text_entry_format', 'style': 'form', 'explode': True }})
    r"""Only relevant to page entries of type `TextEntry`.
