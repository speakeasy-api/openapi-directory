...
exports.ListResourceDataSyncResponse = exports.ListResourceDataSyncRequest = exports.ListResourceDataSyncXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var ListResourceDataSyncXAmzTargetEnum;
...
})(ListResourceDataSyncXAmzTargetEnum = exports.ListResourceDataSyncXAmzTargetEnum || (exports.ListResourceDataSyncXAmzTargetEnum = {}));
var ListResourceDataSyncRequest = /** @class */ (function (_super) {
    ...
    ], ListResourceDataSyncRequest.prototype, "listResourceDataSyncRequest", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListResourceDataSyncRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], ListResourceDataSyncRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], ListResourceDataSyncRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], ListResourceDataSyncRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], ListResourceDataSyncRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], ListResourceDataSyncRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], ListResourceDataSyncRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], ListResourceDataSyncRequest.prototype, "xAmzTarget", void 0);
...
var ListResourceDataSyncResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ListResourceDataSyncResponse.prototype, "rawResponse", void 0);
    return ListResourceDataSyncResponse;
}(utils_1.SpeakeasyBase));
exports.ListResourceDataSyncResponse = ListResourceDataSyncResponse;
