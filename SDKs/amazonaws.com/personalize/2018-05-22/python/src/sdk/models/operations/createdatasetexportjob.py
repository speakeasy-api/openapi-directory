...
class CreateDatasetExportJobRequest:
    ...
    create_dataset_export_job_request: shared_createdatasetexportjobrequest.CreateDatasetExportJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
