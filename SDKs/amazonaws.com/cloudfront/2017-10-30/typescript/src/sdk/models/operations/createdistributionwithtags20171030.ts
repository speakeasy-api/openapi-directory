 ...
 */
export class CreateDistributionWithTags20171030RequestBodyDistributionConfigWithTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateDistributionWithTags20171030RequestBody extends SpeakeasyBase {
  /**
   * A distribution Configuration and a list of tags to be associated with the distribution.
   */
  @SpeakeasyMetadata()
...
export enum CreateDistributionWithTags20171030WithTagsEnum {
  True = "true",
}
