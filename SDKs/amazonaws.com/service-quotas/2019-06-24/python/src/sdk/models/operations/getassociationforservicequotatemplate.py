...
from ..shared import getassociationforservicequotatemplateresponse as shared_getassociationforservicequotatemplateresponse
...
class GetAssociationForServiceQuotaTemplateHeaders:
    x_amz_target: GetAssociationForServiceQuotaTemplateXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAssociationForServiceQuotaTemplateRequest:
    headers: GetAssociationForServiceQuotaTemplateHeaders = dataclasses.field()
...
class GetAssociationForServiceQuotaTemplateResponse:
    ...
    get_association_for_service_quota_template_response: Optional[shared_getassociationforservicequotatemplateresponse.GetAssociationForServiceQuotaTemplateResponse] = dataclasses.field(default=None)
