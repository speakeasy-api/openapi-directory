...
class FlightObjectListResponse:
    ...
    resources: Optional[list[shared_flightobject.FlightObject]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources'), 'exclude': lambda f: f is None }})
