 ...
 */
public class CreateCachePolicy20200531RequestBodyCachePolicyConfig {
    
    public String comment;
    public CreateCachePolicy20200531RequestBodyCachePolicyConfig withComment(String comment) {
    ...
    public CreateCachePolicy20200531RequestBodyCachePolicyConfig withDefaultTTL(Long defaultTTL) {
    ...
    public Long maxTTL;
    public CreateCachePolicy20200531RequestBodyCachePolicyConfig withMaxTTL(Long maxTTL) {
        this.maxTTL = maxTTL;
        return this;
    }
    ...
    public Long minTTL;
    public CreateCachePolicy20200531RequestBodyCachePolicyConfig withMinTTL(Long minTTL) {
        this.minTTL = minTTL;
        return this;
    }
    ...
    public String name;
    public CreateCachePolicy20200531RequestBodyCachePolicyConfig withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateCachePolicy20200531RequestBodyCachePolicyConfig withParametersInCacheKeyAndForwardedToOrigin(org.openapis.openapi.models.shared.ParametersInCacheKeyAndForwardedToOrigin parametersInCacheKeyAndForwardedToOrigin) {
