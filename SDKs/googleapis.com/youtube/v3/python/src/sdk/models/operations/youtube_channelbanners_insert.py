...
from ..shared import security as shared_security
from ..shared import channelbannerresource as shared_channelbannerresource
...
class YoutubeChannelBannersInsertSecurity:
    option1: Optional[YoutubeChannelBannersInsertSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubeChannelBannersInsertSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[YoutubeChannelBannersInsertSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class YoutubeChannelBannersInsertRequest:
    query_params: YoutubeChannelBannersInsertQueryParams = dataclasses.field()
    security: YoutubeChannelBannersInsertSecurity = dataclasses.field()
    request: Optional[YoutubeChannelBannersInsertRequests] = dataclasses.field(default=None)
...
class YoutubeChannelBannersInsertResponse:
    ...
    channel_banner_resource: Optional[shared_channelbannerresource.ChannelBannerResource] = dataclasses.field(default=None)
