...
func (e DescribePullThroughCacheRulesXAmzTargetEnum) ToPointer() *DescribePullThroughCacheRulesXAmzTargetEnum {
	return &e
}
...
func (e *DescribePullThroughCacheRulesXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonEC2ContainerRegistry_V20150921.DescribePullThroughCacheRules":
		*e = DescribePullThroughCacheRulesXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribePullThroughCacheRulesXAmzTargetEnum: %v", v)
	}
}
