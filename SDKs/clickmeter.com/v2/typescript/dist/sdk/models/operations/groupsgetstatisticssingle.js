...
exports.GroupsGetStatisticsSingleResponse = exports.GroupsGetStatisticsSingleRequest = exports.GroupsGetStatisticsSingleTimeFrameEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Timeframe of the request. See list at $timeframeList
 */
var GroupsGetStatisticsSingleTimeFrameEnum;
...
})(GroupsGetStatisticsSingleTimeFrameEnum = exports.GroupsGetStatisticsSingleTimeFrameEnum || (exports.GroupsGetStatisticsSingleTimeFrameEnum = {}));
var GroupsGetStatisticsSingleRequest = /** @class */ (function (_super) {
    ...
    ], GroupsGetStatisticsSingleRequest.prototype, "fromDay", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=hourly",
        }),
        __metadata("design:type", Boolean)
    ], GroupsGetStatisticsSingleRequest.prototype, "hourly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GroupsGetStatisticsSingleRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeFrame",
        }),
        __metadata("design:type", String)
    ], GroupsGetStatisticsSingleRequest.prototype, "timeFrame", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=toDay" }),
        __metadata("design:type", String)
    ], GroupsGetStatisticsSingleRequest.prototype, "toDay", void 0);
    return GroupsGetStatisticsSingleRequest;
}(utils_1.SpeakeasyBase));
exports.GroupsGetStatisticsSingleRequest = GroupsGetStatisticsSingleRequest;
var GroupsGetStatisticsSingleResponse = /** @class */ (function (_super) {
    ...
    ], GroupsGetStatisticsSingleResponse.prototype, "rawResponse", void 0);
    return GroupsGetStatisticsSingleResponse;
}(utils_1.SpeakeasyBase));
exports.GroupsGetStatisticsSingleResponse = GroupsGetStatisticsSingleResponse;
