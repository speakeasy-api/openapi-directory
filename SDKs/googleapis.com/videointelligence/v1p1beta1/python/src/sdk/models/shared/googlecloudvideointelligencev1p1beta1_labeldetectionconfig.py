...
class GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig:
    ...
    label_detection_mode: Optional[GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfigLabelDetectionModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('labelDetectionMode') }})
