...
var PricingV2TrunkingCountryInstanceOriginatingCallPrices = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=current_price" }),
        __metadata("design:type", Number)
...
var PricingV2TrunkingCountryInstanceTerminatingPrefixPrices = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=destination_prefixes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=origination_prefixes" }),
        __metadata("design:type", Array)
...
var PricingV2TrunkingCountryInstance = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=originating_call_prices", elemType: PricingV2TrunkingCountryInstanceOriginatingCallPrices }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=terminating_prefix_prices", elemType: PricingV2TrunkingCountryInstanceTerminatingPrefixPrices }),
        __metadata("design:type", Array)
