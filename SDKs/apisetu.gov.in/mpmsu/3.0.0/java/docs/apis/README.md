...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            MicerResponse res = sdk.apIs.micer(req, new MicerSecurity("maiores", "molestiae") {{
    ...
    public static void main(String[] args) {
        try {
            ...
            PvcerRequestBody req = new PvcerRequestBody(PvcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new PvcerRequestBodyCertificateParameters("MMIG1907220002", "11-11-1990", "MG005M010916003", "1938805");;
            ...
            PvcerResponse res = sdk.apIs.pvcer(req, new PvcerSecurity("qui", "impedit") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
