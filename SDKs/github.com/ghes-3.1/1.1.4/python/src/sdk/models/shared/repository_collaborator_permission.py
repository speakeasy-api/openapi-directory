...
class RepositoryCollaboratorPermissionSimpleUser:
    r"""RepositoryCollaboratorPermissionSimpleUser
    Simple User
    """
...
class RepositoryCollaboratorPermission:
    ...
    user: RepositoryCollaboratorPermissionSimpleUser = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('user') }})
