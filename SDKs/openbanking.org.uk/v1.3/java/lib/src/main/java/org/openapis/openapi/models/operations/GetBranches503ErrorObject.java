...
public class GetBranches503ErrorObject {
    ...
    public GetBranches503ErrorObject(@JsonProperty("description") GetBranches503ErrorObjectDescriptionEnum description, @JsonProperty("status") GetBranches503ErrorObjectStatusEnum status, @JsonProperty("title") GetBranches503ErrorObjectTitleEnum title) {
        this.description = description;
        this.status = status;
        this.title = title;
  }
