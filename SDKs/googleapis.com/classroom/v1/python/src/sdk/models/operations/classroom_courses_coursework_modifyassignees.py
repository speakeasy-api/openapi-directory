...
class ClassroomCoursesCourseWorkModifyAssigneesRequest:
    ...
    r"""Identifier of the coursework."""  
    ...
    modify_course_work_assignees_request: Optional[shared_modifycourseworkassigneesrequest.ModifyCourseWorkAssigneesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
