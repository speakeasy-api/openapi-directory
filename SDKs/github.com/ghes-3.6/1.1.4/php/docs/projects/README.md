...
try {
    ...
    $request->projectId = 980486;
    $request->username = 'Ashleigh_Boyer';
...
try {
    ...
    $request->requestBody->name = 'Bernice Yundt';
    $request->org = 'enim';
...
try {
    ...
    $request->requestBody->name = 'Willard Larson';
    $request->owner = 'eaque';
    $request->repo = 'saepe';
...
try {
    ...
    $request->projectId = 244032;
    $request->username = 'Alisa_Windler21';
...
try {
    ...
    $request->page = 512905;
    $request->perPage = 140384;
    $request->state = ProjectsListForUserStateEnum::ALL;
    $request->username = 'Danika24';
...
try {
    ...
    $request->projectId = 395233;
    $request->username = 'Wilbert_Hahn';
...
try {
    ...
    $request->requestBody->organizationPermission = ProjectsUpdateRequestBodyOrganizationPermissionEnum::WRITE;
    $request->requestBody->private = false;
    $request->requestBody->state = 'open';
    $request->projectId = 335977;
