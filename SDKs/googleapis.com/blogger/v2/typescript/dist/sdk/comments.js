...
var Comments = /** @class */ (function () {
    ...
    **/
    Comments.prototype.bloggerCommentsGet = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/blogs/{blogId}/posts/{postId}/comments/{commentId}", req.pathParams);
    ...
    **/
    Comments.prototype.bloggerCommentsList = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2/blogs/{blogId}/posts/{postId}/comments", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
