...
func (e GetNetworkWirelessFailedConnectionsBandEnum) ToPointer() *GetNetworkWirelessFailedConnectionsBandEnum {
	return &e
}
...
func (e *GetNetworkWirelessFailedConnectionsBandEnum) UnmarshalJSON(data []byte) error {
	...
	case "5":
		fallthrough
	case "6":
		*e = GetNetworkWirelessFailedConnectionsBandEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessFailedConnectionsBandEnum: %v", v)
	}
}
