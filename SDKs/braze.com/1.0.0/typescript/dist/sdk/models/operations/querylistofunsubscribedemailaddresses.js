...
exports.QueryListOfUnsubscribedEmailAddressesResponse = exports.QueryListOfUnsubscribedEmailAddressesRequest = void 0;
...
var QueryListOfUnsubscribedEmailAddressesRequest = /** @class */ (function (_super) {
    ...
    ], QueryListOfUnsubscribedEmailAddressesRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=end_date",
        }),
        __metadata("design:type", String)
    ], QueryListOfUnsubscribedEmailAddressesRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", String)
    ], QueryListOfUnsubscribedEmailAddressesRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", String)
    ], QueryListOfUnsubscribedEmailAddressesRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_direction",
        }),
        __metadata("design:type", String)
    ], QueryListOfUnsubscribedEmailAddressesRequest.prototype, "sortDirection", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=start_date",
        }),
        __metadata("design:type", String)
    ], QueryListOfUnsubscribedEmailAddressesRequest.prototype, "startDate", void 0);
...
var QueryListOfUnsubscribedEmailAddressesResponse = /** @class */ (function (_super) {
    ...
    ], QueryListOfUnsubscribedEmailAddressesResponse.prototype, "rawResponse", void 0);
