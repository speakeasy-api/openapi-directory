...
exports.DescribeConnectorEntityResponse = exports.DescribeConnectorEntityRequest = exports.DescribeConnectorEntityRequestBody = exports.DescribeConnectorEntityRequestBodyConnectorTypeEnum = void 0;
 ...
 */
var DescribeConnectorEntityRequestBodyConnectorTypeEnum;
(function (DescribeConnectorEntityRequestBodyConnectorTypeEnum) {
    ...
    DescribeConnectorEntityRequestBodyConnectorTypeEnum["CustomConnector"] = "CustomConnector";
    DescribeConnectorEntityRequestBodyConnectorTypeEnum["Pardot"] = "Pardot";
})(DescribeConnectorEntityRequestBodyConnectorTypeEnum = exports.DescribeConnectorEntityRequestBodyConnectorTypeEnum || (exports.DescribeConnectorEntityRequestBodyConnectorTypeEnum = {}));
var DescribeConnectorEntityRequestBody = /** @class */ (function (_super) {
    ...
    ], DescribeConnectorEntityRequestBody.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "connectorEntityName" }),
        __metadata("design:type", String)
...
exports.DescribeConnectorEntityRequestBody = DescribeConnectorEntityRequestBody;
var DescribeConnectorEntityRequest = /** @class */ (function (_super) {
    ...
    ], DescribeConnectorEntityRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], DescribeConnectorEntityRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], DescribeConnectorEntityRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], DescribeConnectorEntityRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], DescribeConnectorEntityRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], DescribeConnectorEntityRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], DescribeConnectorEntityRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], DescribeConnectorEntityRequest.prototype, "xAmzSignedHeaders", void 0);
...
var DescribeConnectorEntityResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], DescribeConnectorEntityResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
