...
public class UpdateCustomerHeaders {
    /**
    ...
    public UpdateCustomerHeaders withXSdsDateFormat(UpdateCustomerXSdsDateFormatEnum xSdsDateFormat) {
    ...
    public UpdateCustomerHeaders withXSdsServiceToken(String xSdsServiceToken) {
