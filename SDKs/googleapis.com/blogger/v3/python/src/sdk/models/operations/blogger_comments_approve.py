...
class BloggerCommentsApprovePathParams:
...
@dataclasses.dataclass
class BloggerCommentsApproveQueryParams:
...
@dataclasses.dataclass
class BloggerCommentsApproveSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class BloggerCommentsApproveRequest:
    path_params: BloggerCommentsApprovePathParams = dataclasses.field()
    query_params: BloggerCommentsApproveQueryParams = dataclasses.field()
    security: BloggerCommentsApproveSecurity = dataclasses.field()
    

@dataclasses.dataclass
class BloggerCommentsApproveResponse:
