...
class SnapshotStorageTierEnum(str, Enum):
...
class Snapshot:
    ...
    state: Optional[SnapshotStateEnum] = dataclasses.field(default=None)  
    state_message: Optional[str] = dataclasses.field(default=None)  
    storage_tier: Optional[SnapshotStorageTierEnum] = dataclasses.field(default=None)  
    tags: Optional[list[SnapshotTags]] = dataclasses.field(default=None)  
