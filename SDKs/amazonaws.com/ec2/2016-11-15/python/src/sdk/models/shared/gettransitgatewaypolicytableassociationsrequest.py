...
class GetTransitGatewayPolicyTableAssociationsRequestFilters:
...
class GetTransitGatewayPolicyTableAssociationsRequest:
    ...
    filters: Optional[list[GetTransitGatewayPolicyTableAssociationsRequestFilters]] = dataclasses.field(default=None)  
