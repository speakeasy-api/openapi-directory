...
exports.GetUserByIdResponse = exports.GetUserByIdRequest = exports.GetUserByIdHeaders = exports.GetUserByIdQueryParams = exports.GetUserByIdPathParams = void 0;
...
exports.GetUserByIdPathParams = GetUserByIdPathParams;
var GetUserByIdQueryParams = /** @class */ (function (_super) {
    __extends(GetUserByIdQueryParams, _super);
    function GetUserByIdQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=include" }),
        __metadata("design:type", String)
    ], GetUserByIdQueryParams.prototype, "include", void 0);
    return GetUserByIdQueryParams;
}(utils_1.SpeakeasyBase));
exports.GetUserByIdQueryParams = GetUserByIdQueryParams;
var GetUserByIdHeaders = /** @class */ (function (_super) {
    __extends(GetUserByIdHeaders, _super);
    function GetUserByIdHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "header, style=simple;explode=false;name=ev-access-token" }),
        __metadata("design:type", String)
    ], GetUserByIdHeaders.prototype, "evAccessToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "header, style=simple;explode=false;name=ev-api-key" }),
        __metadata("design:type", String)
    ], GetUserByIdHeaders.prototype, "evApiKey", void 0);
    return GetUserByIdHeaders;
}(utils_1.SpeakeasyBase));
...
var GetUserByIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", GetUserByIdQueryParams)
    ], GetUserByIdRequest.prototype, "queryParams", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", GetUserByIdHeaders)
    ], GetUserByIdRequest.prototype, "headers", void 0);
...
var GetUserByIdResponse = /** @class */ (function (_super) {
    ...
    ], GetUserByIdResponse.prototype, "userResponse", void 0);
    return GetUserByIdResponse;
}(utils_1.SpeakeasyBase));
exports.GetUserByIdResponse = GetUserByIdResponse;
