    ...
    public static void main(String[] args) {
        try {
            ...
            PatchBusinessLinesIdRequest req = new PatchBusinessLinesIdRequest("quibusdam") {{
                businessLineInfoUpdateInput = new BusinessLineInfoUpdateInput() {{
                    capability = "unde";
                    industryCode = "nulla";
                    legalEntityId = "corrupti";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.shared.BusinessLineInfoInput req = new BusinessLineInfoInput("molestiae", "minus", "placeat") {{
                salesChannels = new String[]{{
                    add("iusto"),
                    add("excepturi"),
                    add("nisi"),
                ...
                sourceOfFunds = new SourceOfFunds() {{
                    acquiringBusinessLineId = "recusandae";
                    adyenProcessedFunds = false;
