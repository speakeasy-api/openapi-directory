...
class ConnectionPasswordEncryption:
    ...
    return_connection_password_encrypted: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ReturnConnectionPasswordEncrypted') }})  
    aws_kms_key_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AwsKmsKeyId'), 'exclude': lambda f: f is None }})  
