...
class PostPortfolioOptimizationMaximumReturnRequestBody:
    ...
    assets_covariance_matrix: Optional[list[list[float]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('assetsCovarianceMatrix') }})
    constraints: Optional[PostPortfolioOptimizationMaximumReturnRequestBodyConstraints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('constraints') }})
...
class PostPortfolioOptimizationMaximumReturnRequest:
    request: PostPortfolioOptimizationMaximumReturnRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
