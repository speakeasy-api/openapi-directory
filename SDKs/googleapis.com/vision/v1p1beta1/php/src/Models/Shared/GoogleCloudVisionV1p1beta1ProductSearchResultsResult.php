...
class GoogleCloudVisionV1p1beta1ProductSearchResultsResult
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GoogleCloudVisionV1p1beta1Product $product
     */
	#[\JMS\Serializer\Annotation\SerializedName('product')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GoogleCloudVisionV1p1beta1Product')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GoogleCloudVisionV1p1beta1Product $product = null;
