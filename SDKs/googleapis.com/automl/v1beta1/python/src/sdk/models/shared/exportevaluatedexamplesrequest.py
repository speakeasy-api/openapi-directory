...
import dataclasses
from ..shared import exportevaluatedexamplesoutputconfig as shared_exportevaluatedexamplesoutputconfig
...
class ExportEvaluatedExamplesRequest:
    r"""Request message for AutoMl.ExportEvaluatedExamples."""
    
    output_config: Optional[shared_exportevaluatedexamplesoutputconfig.ExportEvaluatedExamplesOutputConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('outputConfig'), 'exclude': lambda f: f is None }})
