...
func (s *Projects) ServicedirectoryProjectsLocationsNamespacesServicesEndpointsCreate(ctx context.Context, request operations.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsCreateRequest) (*operations.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsCreateResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{parent}/endpoints", request.PathParams)
...
func (s *Projects) ServicedirectoryProjectsLocationsNamespacesServicesResolve(ctx context.Context, request operations.ServicedirectoryProjectsLocationsNamespacesServicesResolveRequest) (*operations.ServicedirectoryProjectsLocationsNamespacesServicesResolveResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{name}:resolve", request.PathParams)
...
func (s *Projects) ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicy(ctx context.Context, request operations.ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicyRequest) (*operations.ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicyResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicyResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Projects) ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicy(ctx context.Context, request operations.ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicyRequest) (*operations.ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicyResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicyResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Projects) ServicedirectoryProjectsLocationsRegistrationPoliciesTestIamPermissions(ctx context.Context, request operations.ServicedirectoryProjectsLocationsRegistrationPoliciesTestIamPermissionsRequest) (*operations.ServicedirectoryProjectsLocationsRegistrationPoliciesTestIamPermissionsResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.ServicedirectoryProjectsLocationsRegistrationPoliciesTestIamPermissionsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
