...
class LicensingLicenseAssignmentsListForProductRequest:
    path_params: LicensingLicenseAssignmentsListForProductPathParams = dataclasses.field()
    query_params: LicensingLicenseAssignmentsListForProductQueryParams = dataclasses.field()
    security: LicensingLicenseAssignmentsListForProductSecurity = dataclasses.field()
