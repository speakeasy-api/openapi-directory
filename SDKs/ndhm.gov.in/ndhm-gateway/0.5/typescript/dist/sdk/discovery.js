...
var Discovery = /** @class */ (function () {
     ...
     *
     */
    Discovery.prototype.postV05CareContextsDiscoverJson = function (req, config) {
        var _a;
     ...
     *
     */
    Discovery.prototype.postV05CareContextsDiscoverRaw = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
     */
    Discovery.prototype.postV05CareContextsOnDiscoverJson = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
     */
    Discovery.prototype.postV05CareContextsOnDiscoverRaw = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
