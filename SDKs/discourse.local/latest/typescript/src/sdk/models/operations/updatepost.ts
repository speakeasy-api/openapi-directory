...
export class UpdatePostRequestBodyPost extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdatePostRequestBody extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "post" })
  @Type(() => UpdatePostRequestBodyPost)
...
export class UpdatePost200ApplicationJSONPostActionsSummary extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "can_act" })
  canAct?: boolean;
...
export class UpdatePost200ApplicationJSONPost extends SpeakeasyBase {
  @SpeakeasyMetadata({
    elemType: UpdatePost200ApplicationJSONPostActionsSummary,
  })
  @Expose({ name: "actions_summary" })
  @Type(() => UpdatePost200ApplicationJSONPostActionsSummary)
...
export class UpdatePost200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "post" })
  @Type(() => UpdatePost200ApplicationJSONPost)
