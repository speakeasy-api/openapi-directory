...
export class TestGetAllTestRunsForSeriesSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class TestGetAllTestRunsForSeriesRequest extends SpeakeasyBase {
  /**
 ...
 */
export class TestGetAllTestRunsForSeriesTestRunTestRunStatistics extends SpeakeasyBase {
  /**
 ...
 * Summary single test run on Xamarin Test Cloud
 */
export class TestGetAllTestRunsForSeriesTestRun extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "stats" })
  @Type(() => TestGetAllTestRunsForSeriesTestRunTestRunStatistics)
...
export class TestGetAllTestRunsForSeriesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   * OK
   */
  @SpeakeasyMetadata({ elemType: TestGetAllTestRunsForSeriesTestRun })
