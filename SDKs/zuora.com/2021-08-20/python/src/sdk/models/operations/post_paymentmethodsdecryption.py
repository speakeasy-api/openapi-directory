...
class POSTPaymentMethodsDecryptionRequest:
    ...
    post_payment_method_decryption: shared_postpaymentmethoddecryption.POSTPaymentMethodDecryption = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
