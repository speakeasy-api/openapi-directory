 ...
 */
public enum DescribeIpamResourceDiscoveriesResultIpamResourceDiscoveriesStateEnum {
    ...
    private DescribeIpamResourceDiscoveriesResultIpamResourceDiscoveriesStateEnum(String value) {
        this.value = value;
    }
}
