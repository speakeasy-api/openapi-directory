 ...
 */
export declare enum DescribeInstanceTypeOfferingsResultInstanceTypeOfferingsInstanceTypeEnum {
    A1Medium = "a1.medium",
    A1Large = "a1.large",
    A1Xlarge = "a1.xlarge",
 ...
 * The location type.
 */
export declare enum DescribeInstanceTypeOfferingsResultInstanceTypeOfferingsLocationTypeEnum {
    Region = "region",
 ...
 */
export declare class DescribeInstanceTypeOfferingsResultInstanceTypeOfferings extends SpeakeasyBase {
 ...
 * Success
 */
export declare class DescribeInstanceTypeOfferingsResult extends SpeakeasyBase {
