...
class GetVariantDiseaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetVariantDiseaseAssociationsQueryParams:
...
@dataclasses.dataclass
class GetVariantDiseaseAssociationsRequest:
    path_params: GetVariantDiseaseAssociationsPathParams = dataclasses.field()
    query_params: GetVariantDiseaseAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetVariantDiseaseAssociationsResponse:
