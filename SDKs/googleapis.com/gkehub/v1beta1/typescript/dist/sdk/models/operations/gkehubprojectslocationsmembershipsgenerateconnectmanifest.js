...
var GkehubProjectsLocationsMembershipsGenerateConnectManifestQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=connectAgent.name" }),
        __metadata("design:type", String)
    ], GkehubProjectsLocationsMembershipsGenerateConnectManifestQueryParams.prototype, "connectAgentName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=connectAgent.namespace" }),
        __metadata("design:type", String)
    ], GkehubProjectsLocationsMembershipsGenerateConnectManifestQueryParams.prototype, "connectAgentNamespace", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=connectAgent.proxy" }),
        __metadata("design:type", String)
