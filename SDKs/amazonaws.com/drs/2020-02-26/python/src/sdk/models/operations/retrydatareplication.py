...
class RetryDataReplicationRequestBody:
    ...
    r"""The ID of the Source Server whose data replication should be retried."""  
    

@dataclasses.dataclass
class RetryDataReplicationRequest:
    
    request_body: RetryDataReplicationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
