...
export class DialogflowProjectsLocationsAgentsIntentsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsAgentsIntentsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class DialogflowProjectsLocationsAgentsIntentsListSecurity extends SpeakeasyBase {
 ...
 */
export enum DialogflowProjectsLocationsAgentsIntentsListIntentViewEnum {
  IntentViewUnspecified = "INTENT_VIEW_UNSPECIFIED",
  IntentViewPartial = "INTENT_VIEW_PARTIAL",
  IntentViewFull = "INTENT_VIEW_FULL",
}

export class DialogflowProjectsLocationsAgentsIntentsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsAgentsIntentsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
