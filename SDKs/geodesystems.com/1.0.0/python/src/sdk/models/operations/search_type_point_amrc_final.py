...
class SearchTypePointAmrcFinalQueryParams:
    ...
    search_type_point_amrc_final_argos_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_amrc_final.argos_id', 'style': 'form', 'explode': True }})
    search_type_point_amrc_final_site_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_amrc_final.site_id', 'style': 'form', 'explode': True }})
    search_type_point_amrc_final_site_name: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_amrc_final.site_name', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchTypePointAmrcFinalRequest:
    query_params: SearchTypePointAmrcFinalQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypePointAmrcFinalResponse:
