...
var DistrictStatus = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "instant_login" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "launch_date" }),
        __metadata("design:type", String)
    ], DistrictStatus.prototype, "launchDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "pause_end" }),
        __metadata("design:type", String)
    ], DistrictStatus.prototype, "pauseEnd", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "pause_start" }),
        __metadata("design:type", String)
    ], DistrictStatus.prototype, "pauseStart", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "sis_type" }),
        __metadata("design:type", String)
