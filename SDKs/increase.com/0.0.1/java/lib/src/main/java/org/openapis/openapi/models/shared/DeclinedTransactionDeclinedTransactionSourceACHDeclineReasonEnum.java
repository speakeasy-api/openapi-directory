 ...
 */
public enum DeclinedTransactionDeclinedTransactionSourceACHDeclineReasonEnum {
    ...
    private DeclinedTransactionDeclinedTransactionSourceACHDeclineReasonEnum(String value) {
        this.value = value;
    }
}
