...
export class MetastoreProjectsLocationsServicesBackupsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsServicesBackupsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsServicesBackupsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
