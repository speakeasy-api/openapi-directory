...
class GetAppearancesRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetAppearancesDirectionEnum $direction
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=direction')]
    public ?GetAppearancesDirectionEnum $direction = null;
    
    /**
     * The attribute by which to filter the results.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetAppearancesFilterEnum $filter
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=filter')]
    public ?GetAppearancesFilterEnum $filter = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetAppearancesSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?GetAppearancesSortEnum $sort = null;
