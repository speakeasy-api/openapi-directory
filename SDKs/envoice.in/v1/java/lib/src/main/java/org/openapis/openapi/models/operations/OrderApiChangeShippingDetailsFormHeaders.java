...
public class OrderApiChangeShippingDetailsFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public OrderApiChangeShippingDetailsFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public OrderApiChangeShippingDetailsFormHeaders withXAuthSecret(String xAuthSecret) {
