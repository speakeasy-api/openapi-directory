...
class LoadBalancerTLSCertificateRenewalSummary:
    ...
    domain_validation_options: Optional[list[shared_loadbalancertlscertificatedomainvalidationoption.LoadBalancerTLSCertificateDomainValidationOption]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('domainValidationOptions') }})
    renewal_status: Optional[shared_loadbalancertlscertificaterenewalstatus_enum.LoadBalancerTLSCertificateRenewalStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('renewalStatus') }})
