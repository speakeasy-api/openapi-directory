...
export class CloudchannelAccountsReportsRunSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsReportsRunRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsReportsRunResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
