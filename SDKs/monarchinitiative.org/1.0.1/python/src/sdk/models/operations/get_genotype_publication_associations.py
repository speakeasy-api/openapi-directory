...
class GetGenotypePublicationAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGenotypePublicationAssociationsQueryParams:
...
@dataclasses.dataclass
class GetGenotypePublicationAssociationsRequest:
    path_params: GetGenotypePublicationAssociationsPathParams = dataclasses.field()
    query_params: GetGenotypePublicationAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetGenotypePublicationAssociationsResponse:
