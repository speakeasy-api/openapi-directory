...
export declare class RateLimit {
     ...
     */
    getRateLimits(req: operations.GetRateLimitsRequest, security: operations.GetRateLimitsSecurity, config?: AxiosRequestConfig): Promise<operations.GetRateLimitsResponse>;
}
