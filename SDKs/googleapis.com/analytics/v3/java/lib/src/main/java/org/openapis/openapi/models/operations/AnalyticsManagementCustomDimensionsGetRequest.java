...
public class AnalyticsManagementCustomDimensionsGetRequest {
    ...
    public AnalyticsManagementCustomDimensionsGetRequest(@JsonProperty("accountId") String accountId, @JsonProperty("customDimensionId") String customDimensionId, @JsonProperty("webPropertyId") String webPropertyId) {
        this.accountId = accountId;
        this.customDimensionId = customDimensionId;
        this.webPropertyId = webPropertyId;
  }
