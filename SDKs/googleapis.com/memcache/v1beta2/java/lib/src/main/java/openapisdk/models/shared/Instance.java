...
public class Instance {
    ...
    public GoogleCloudMemcacheV1beta2MaintenancePolicy maintenancePolicy;
    public Instance withMaintenancePolicy(GoogleCloudMemcacheV1beta2MaintenancePolicy maintenancePolicy) {
    ...
    public Instance withUpdateAvailable(Boolean updateAvailable) {
