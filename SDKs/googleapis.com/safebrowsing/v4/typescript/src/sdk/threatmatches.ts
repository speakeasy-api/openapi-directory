...
export class ThreatMatches {
  ...
  safebrowsingThreatMatchesFind(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SafebrowsingThreatMatchesFindResponse =
        new operations.SafebrowsingThreatMatchesFindResponse({
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleSecuritySafebrowsingV4FindThreatMatchesResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleSecuritySafebrowsingV4FindThreatMatchesResponse
              );
          }
          break;
      }
