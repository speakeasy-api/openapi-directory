...
public class Subscriptions {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.PostV05SubscriptionRequestsHiuOnInitResponse postV05SubscriptionRequestsHiuOnInit(org.openapis.openapi.models.operations.PostV05SubscriptionRequestsHiuOnInitRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/v0.5/subscription-requests/hiu/on-init");
