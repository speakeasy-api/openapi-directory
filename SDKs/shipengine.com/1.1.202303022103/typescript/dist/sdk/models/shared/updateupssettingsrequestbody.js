...
var UpdateUpsSettingsRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "mail_innovations_cost_center" }),
        __metadata("design:type", String)
    ], UpdateUpsSettingsRequestBody.prototype, "mailInnovationsCostCenter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "mail_innovations_endorsement" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "use_carbon_neutral_shipping_program" }),
        __metadata("design:type", Boolean)
    ], UpdateUpsSettingsRequestBody.prototype, "useCarbonNeutralShippingProgram", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "use_consolidation_services" }),
        __metadata("design:type", Boolean)
    ], UpdateUpsSettingsRequestBody.prototype, "useConsolidationServices", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "use_ground_freight_pricing" }),
        __metadata("design:type", Boolean)
    ], UpdateUpsSettingsRequestBody.prototype, "useGroundFreightPricing", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "use_negotiated_rates" }),
        __metadata("design:type", Boolean)
    ], UpdateUpsSettingsRequestBody.prototype, "useNegotiatedRates", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "use_order_number_on_mail_innovations_labels" }),
        __metadata("design:type", Boolean)
