...
use \OpenAPI\OpenAPI\Models\Operations\GetSchemaResponsesSchemaResponseIdActionsSchemaResponseActionIdRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetSchemaResponsesSchemaResponseIdActionsSchemaResponseActionIdRequest();
    $request->schemaResponseActionId = 'porro';
    $request->schemaResponseId = 'consequuntur';

    $response = $sdk->schemaResponseActions->getSchemaResponsesSchemaResponseIdActionsSchemaResponseActionId($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\PostSchemaResponsesSchemaResponseIdActionsRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new PostSchemaResponsesSchemaResponseIdActionsRequest();
    $request->schemaResponseId = 'blanditiis';

    $response = $sdk->schemaResponseActions->postSchemaResponsesSchemaResponseIdActions($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\SchemaResponseActionReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new SchemaResponseActionReadRequest();
    $request->schemaResponseId = 'error';

    $response = $sdk->schemaResponseActions->schemaResponseActionRead($request);
