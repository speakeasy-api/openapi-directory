...
import { SpreadLevelEnum } from "./spreadlevelenum";

/**
 * The placement strategy.
 */
export enum CreatePlacementGroupRequestStrategyEnum {
  Cluster = "cluster",
  Spread = "spread",
  Partition = "partition",
}
 ...
 */
export enum CreatePlacementGroupRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreatePlacementGroupRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreatePlacementGroupRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreatePlacementGroupRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
  ...
  @SpeakeasyMetadata({ elemType: CreatePlacementGroupRequestTagSpecifications })
