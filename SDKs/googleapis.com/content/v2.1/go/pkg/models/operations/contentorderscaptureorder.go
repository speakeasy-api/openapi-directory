...
type ContentOrdersCaptureOrderSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentOrdersCaptureOrderPathParams struct {
...
type ContentOrdersCaptureOrderQueryParams struct {
	// V1 error format.
...
type ContentOrdersCaptureOrderRequest struct {
...
type ContentOrdersCaptureOrderResponse struct {
	// Successful response
