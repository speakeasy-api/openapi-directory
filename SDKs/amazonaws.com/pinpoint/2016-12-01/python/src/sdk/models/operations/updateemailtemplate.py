...
class UpdateEmailTemplateRequestBody:
    email_template_request: UpdateEmailTemplateRequestBodyEmailTemplateRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('EmailTemplateRequest') }})
...
class UpdateEmailTemplateRequest:
    ...
    query_params: UpdateEmailTemplateQueryParams = dataclasses.field()
