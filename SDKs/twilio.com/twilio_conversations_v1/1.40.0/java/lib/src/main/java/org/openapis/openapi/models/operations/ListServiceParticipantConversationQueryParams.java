...
public class ListServiceParticipantConversationQueryParams {
    ...
    public Long page;
    public ListServiceParticipantConversationQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListServiceParticipantConversationQueryParams withPageToken(String pageToken) {
