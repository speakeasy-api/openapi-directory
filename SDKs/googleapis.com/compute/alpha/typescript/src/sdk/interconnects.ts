...
export class Interconnects {
  ...
  computeInterconnectsGetIamPolicy(
    req: operations.ComputeInterconnectsGetIamPolicyRequest,
    security: operations.ComputeInterconnectsGetIamPolicySecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeInterconnectsGetIamPolicyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ComputeInterconnectsGetIamPolicyRequest(req);
    }

    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(
      baseURL,
      "/projects/{project}/global/interconnects/{resource}/getIamPolicy",
      req
    );
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.ComputeInterconnectsGetIamPolicySecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeInterconnectsGetIamPolicyResponse =
        new operations.ComputeInterconnectsGetIamPolicyResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  computeInterconnectsGetMacsecConfig(
    req: operations.ComputeInterconnectsGetMacsecConfigRequest,
    security: operations.ComputeInterconnectsGetMacsecConfigSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeInterconnectsGetMacsecConfigResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ComputeInterconnectsGetMacsecConfigRequest(req);
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.ComputeInterconnectsGetMacsecConfigSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeInterconnectsGetMacsecConfigResponse =
        new operations.ComputeInterconnectsGetMacsecConfigResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.interconnectsGetMacsecConfigResponse = utils.objectToClass(
              httpRes?.data,
              shared.InterconnectsGetMacsecConfigResponse
            );
          }
          break;
      }
  ...
  computeInterconnectsSetIamPolicy(
    req: operations.ComputeInterconnectsSetIamPolicyRequest,
    security: operations.ComputeInterconnectsSetIamPolicySecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeInterconnectsSetIamPolicyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ComputeInterconnectsSetIamPolicyRequest(req);
    }

    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(
      baseURL,
      "/projects/{project}/global/interconnects/{resource}/setIamPolicy",
      req
    );
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.ComputeInterconnectsSetIamPolicySecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeInterconnectsSetIamPolicyResponse =
        new operations.ComputeInterconnectsSetIamPolicyResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  computeInterconnectsTestIamPermissions(
    req: operations.ComputeInterconnectsTestIamPermissionsRequest,
    security: operations.ComputeInterconnectsTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeInterconnectsTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/projects/{project}/global/interconnects/{resource}/testIamPermissions",
      req
    );
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.ComputeInterconnectsTestIamPermissionsSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeInterconnectsTestIamPermissionsResponse =
        new operations.ComputeInterconnectsTestIamPermissionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
