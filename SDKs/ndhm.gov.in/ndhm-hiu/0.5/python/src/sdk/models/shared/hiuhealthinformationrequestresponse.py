...
class HIUHealthInformationRequestResponseHiRequest:
    ...
    session_status: HIUHealthInformationRequestResponseHiRequestSessionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sessionStatus') }})  
...
class HIUHealthInformationRequestResponse:
    ...
    hi_request: Optional[HIUHealthInformationRequestResponseHiRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('hiRequest'), 'exclude': lambda f: f is None }})  
