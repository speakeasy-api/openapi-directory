...
class DcimRearPortsList200ApplicationJSON:
    ...
    results: list[shared_rearport.RearPort] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class DcimRearPortsListRequest:
    query_params: DcimRearPortsListQueryParams = dataclasses.field()
...
class DcimRearPortsListResponse:
    ...
    dcim_rear_ports_list_200_application_json_object: Optional[DcimRearPortsList200ApplicationJSON] = dataclasses.field(default=None)
