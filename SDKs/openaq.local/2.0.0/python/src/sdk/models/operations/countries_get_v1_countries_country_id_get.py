...
class CountriesGetV1CountriesCountryIDGetRequest:
    path_params: CountriesGetV1CountriesCountryIDGetPathParams = dataclasses.field()
    query_params: CountriesGetV1CountriesCountryIDGetQueryParams = dataclasses.field()
