...
var Outlets = /** @class */ (function () {
    function Outlets(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Outlets.prototype.outletsGetAllOutlets = function (req, config) {
    ...
    **/
    Outlets.prototype.outletsGetOutletsByGeolocation = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
