...
@dataclasses.dataclass
class GetAssociationBySubjectCategorySearchRequest:
    path_params: GetAssociationBySubjectCategorySearchPathParams = dataclasses.field()
    query_params: GetAssociationBySubjectCategorySearchQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetAssociationBySubjectCategorySearchResponse:
