...
class Installation:
    ...
    suspended_at: datetime = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('suspended_at'), 'encoder': utils.datetimeisoformat(False), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso') }})
    suspended_by: InstallationSimpleUser = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('suspended_by') }})
