...
class CustomColumn
{
     ...
     * 
     * @var ?array<string> $catalogColumnDependencies
     */
	#[\JMS\Serializer\Annotation\SerializedName('catalogColumnDependencies')]
    #[\JMS\Serializer\Annotation\Type('array<string>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?array $catalogColumnDependencies = null;
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CustomColumnLinks')]
	...
	{
		$this->catalogColumnDependencies = null;
		$this->configuration = new \OpenAPI\OpenAPI\Models\Shared\ColumnConfiguration();
		$this->id = "";
		$this->links = new \OpenAPI\OpenAPI\Models\Shared\CustomColumnLinks();
		$this->userColumName = "";
	}
}
