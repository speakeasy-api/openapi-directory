...
public class TeamsRemoveUserPathParams {
    /**
     * The organization's name
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=org_name")
    public String orgName;
    public TeamsRemoveUserPathParams withOrgName(String orgName) {
    ...
    public TeamsRemoveUserPathParams withTeamName(String teamName) {
    ...
    public TeamsRemoveUserPathParams withUserName(String userName) {
