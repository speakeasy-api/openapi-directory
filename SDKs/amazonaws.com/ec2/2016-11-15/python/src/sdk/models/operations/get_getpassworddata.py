...
class GetGetPasswordDataQueryParams:
    action: GetGetPasswordDataActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    instance_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'InstanceId', 'style': 'form', 'explode': True }})
    version: GetGetPasswordDataVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetGetPasswordDataRequest:
    headers: GetGetPasswordDataHeaders = dataclasses.field()
    query_params: GetGetPasswordDataQueryParams = dataclasses.field()
