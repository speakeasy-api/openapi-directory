...
export enum StopEdgeDeploymentStageXAmzTargetEnum {
  SageMakerStopEdgeDeploymentStage = "SageMaker.StopEdgeDeploymentStage",
}

export class StopEdgeDeploymentStageRequest extends SpeakeasyBase {
...
export class StopEdgeDeploymentStageResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
