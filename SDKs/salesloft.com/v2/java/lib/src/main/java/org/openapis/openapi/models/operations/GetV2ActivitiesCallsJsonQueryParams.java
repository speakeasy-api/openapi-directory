...
public class GetV2ActivitiesCallsJsonQueryParams {
    /**
    ...
    public GetV2ActivitiesCallsJsonQueryParams withCreatedAt(String[] createdAt) {
    ...
    public GetV2ActivitiesCallsJsonQueryParams withDisposition(String[] disposition) {
    ...
    public Long[] ids;
    public GetV2ActivitiesCallsJsonQueryParams withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2ActivitiesCallsJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2ActivitiesCallsJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public Long page;
    public GetV2ActivitiesCallsJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2ActivitiesCallsJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2ActivitiesCallsJsonQueryParams withPersonId(Long[] personId) {
    ...
    public GetV2ActivitiesCallsJsonQueryParams withSentiment(String[] sentiment) {
    ...
    public GetV2ActivitiesCallsJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2ActivitiesCallsJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public GetV2ActivitiesCallsJsonQueryParams withUpdatedAt(String[] updatedAt) {
    ...
    public GetV2ActivitiesCallsJsonQueryParams withUserGuid(String[] userGuid) {
