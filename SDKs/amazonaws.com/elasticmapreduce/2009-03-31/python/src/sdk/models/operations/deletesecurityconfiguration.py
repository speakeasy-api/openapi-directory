...
from ..shared import deletesecurityconfigurationinput as shared_deletesecurityconfigurationinput
...
class DeleteSecurityConfigurationRequest:
    ...
    delete_security_configuration_input: shared_deletesecurityconfigurationinput.DeleteSecurityConfigurationInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DeleteSecurityConfigurationResponse:
    ...
    delete_security_configuration_output: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
