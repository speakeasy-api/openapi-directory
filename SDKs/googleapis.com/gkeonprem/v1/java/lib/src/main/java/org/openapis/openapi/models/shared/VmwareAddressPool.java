...
public class VmwareAddressPool {
    ...
    public VmwareAddressPool withAddresses(String[] addresses) {
    ...
    public VmwareAddressPool withAvoidBuggyIps(Boolean avoidBuggyIps) {
    ...
    public VmwareAddressPool withManualAssign(Boolean manualAssign) {
    ...
    public VmwareAddressPool withPool(String pool) {
        this.pool = pool;
        return this;
    }
    
    public VmwareAddressPool(){}
}
