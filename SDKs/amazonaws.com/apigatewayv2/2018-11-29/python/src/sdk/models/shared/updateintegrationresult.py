...
class UpdateIntegrationResultTLSConfig:
    r"""UpdateIntegrationResultTLSConfig
...
class UpdateIntegrationResult:
    ...
    tls_config: Optional[UpdateIntegrationResultTLSConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('TlsConfig') }})
