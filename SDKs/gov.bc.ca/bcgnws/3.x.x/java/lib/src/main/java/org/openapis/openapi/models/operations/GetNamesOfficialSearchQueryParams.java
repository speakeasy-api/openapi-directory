...
public class GetNamesOfficialSearchQueryParams {
    ...
    public GetNamesOfficialSearchQueryParams withEmbed(GetNamesOfficialSearchEmbedEnum embed) {
        this.embed = embed;
        return this;
    }
    ...
    public GetNamesOfficialSearchQueryParams withExactSpelling(GetNamesOfficialSearchExactSpellingEnum exactSpelling) {
    ...
    public GetNamesOfficialSearchQueryParams withOutputSRS(GetNamesOfficialSearchOutputSrsEnum outputSRS) {
