...
public class CitiesGetV2CitiesGetQueryParams {
    ...
    public CitiesGetV2CitiesGetQueryParams withOrderBy(CitiesGetV2CitiesGetOrderByCitiesOrderEnum orderBy) {
    ...
    public CitiesGetV2CitiesGetQueryParams withSort(CitiesGetV2CitiesGetSortSortEnum sort) {
        this.sort = sort;
        return this;
    }
