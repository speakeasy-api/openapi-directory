...
public class GetAs2OutgoingMessagesQueryParams {
    /**
    ...
    public GetAs2OutgoingMessagesQueryParams withAs2PartnerId(Integer as2PartnerId) {
    ...
    public GetAs2OutgoingMessagesQueryParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public GetAs2OutgoingMessagesQueryParams withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetAs2OutgoingMessagesQueryParams withFilterGt(java.util.Map<String, Object> filterGt) {
    ...
    public GetAs2OutgoingMessagesQueryParams withFilterGteq(java.util.Map<String, Object> filterGteq) {
    ...
    public GetAs2OutgoingMessagesQueryParams withFilterLike(java.util.Map<String, Object> filterLike) {
    ...
    public GetAs2OutgoingMessagesQueryParams withFilterLt(java.util.Map<String, Object> filterLt) {
    ...
    public GetAs2OutgoingMessagesQueryParams withFilterLteq(java.util.Map<String, Object> filterLteq) {
    ...
    public GetAs2OutgoingMessagesQueryParams withPerPage(Integer perPage) {
    ...
    public GetAs2OutgoingMessagesQueryParams withSortBy(java.util.Map<String, Object> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
