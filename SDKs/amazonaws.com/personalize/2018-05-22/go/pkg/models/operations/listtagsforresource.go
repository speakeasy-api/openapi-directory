...
const (
	ListTagsForResourceXAmzTargetEnumAmazonPersonalizeListTagsForResource ListTagsForResourceXAmzTargetEnum = "AmazonPersonalize.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AmazonPersonalize.ListTagsForResource":
