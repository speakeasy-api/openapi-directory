...
class ServicebrokerProjectsBrokersV2ServiceInstancesCreateRequest:
    ...
    r"""Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`."""  
    ...
    r"""Value indicating that API client supports asynchronous operations. If
    ...
    google_cloud_servicebroker_v1beta1_service_instance: Optional[shared_googlecloudservicebrokerv1beta1_serviceinstance.GoogleCloudServicebrokerV1beta1ServiceInstance] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
