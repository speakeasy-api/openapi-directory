...
class ContentOrdersCancellineitemRequest:
    ...
    orders_cancel_line_item_request: Optional[shared_orderscancellineitemrequest.OrdersCancelLineItemRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
