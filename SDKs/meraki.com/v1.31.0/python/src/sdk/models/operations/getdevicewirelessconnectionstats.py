...
class GetDeviceWirelessConnectionStatsRequest:
    ...
    band: Optional[GetDeviceWirelessConnectionStatsBandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'band', 'style': 'form', 'explode': True }})
    r"""Filter results by band (either '2.4', '5' or '6'). Note that data prior to February 2020 will not have band information."""  
...
class GetDeviceWirelessConnectionStats200ApplicationJSONConnectionStats:
    r"""The connection stats of the device"""
...
class GetDeviceWirelessConnectionStats200ApplicationJSON:
    ...
    connection_stats: Optional[GetDeviceWirelessConnectionStats200ApplicationJSONConnectionStats] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connectionStats'), 'exclude': lambda f: f is None }})
    r"""The connection stats of the device"""  
    ...
    r"""The serial number for the device"""  
...
class GetDeviceWirelessConnectionStatsResponse:
    ...
    get_device_wireless_connection_stats_200_application_json_object: Optional[GetDeviceWirelessConnectionStats200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
