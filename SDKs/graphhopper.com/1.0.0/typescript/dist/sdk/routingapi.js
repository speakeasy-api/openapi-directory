...
var RoutingApi = /** @class */ (function () {
    function RoutingApi(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    RoutingApi.prototype.getRoute = function (req, config) {
     ...
     *
    **/
    RoutingApi.prototype.getRouteInfo = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/route/info";
        var client = this._securityClient;
     ...
     *
    **/
    RoutingApi.prototype.postRoute = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
