...
class DisassociateAssetsRequestBody:
    ...
    r"""The ID of the child asset to disassociate."""  
    hierarchy_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('hierarchyId') }})
    r"""The ID of a hierarchy in the parent asset's model. Hierarchies allow different groupings of assets to be formed that all come from the same asset model. You can use the hierarchy ID to identify the correct asset to disassociate. For more information, see <a href=\\"https://docs.aws.amazon.com/iot-sitewise/latest/userguide/asset-hierarchies.html\\">Asset hierarchies</a> in the <i>IoT SiteWise User Guide</i>."""  
...
class DisassociateAssetsRequest:
    ...
    r"""The ID of the parent asset from which to disassociate the child asset."""  
    request_body: DisassociateAssetsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
