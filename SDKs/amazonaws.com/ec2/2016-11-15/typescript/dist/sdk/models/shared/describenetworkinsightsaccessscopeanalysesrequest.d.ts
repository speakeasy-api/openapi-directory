 ...
 */
export declare class DescribeNetworkInsightsAccessScopeAnalysesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeNetworkInsightsAccessScopeAnalysesRequest extends SpeakeasyBase {
