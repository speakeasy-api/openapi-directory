...
public class Addresses {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeAddressesMoveResponse computeAddressesMove(org.openapis.openapi.models.operations.ComputeAddressesMoveRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeAddressesMovePathParams.class, baseUrl, "/projects/{project}/regions/{region}/addresses/{address}/move", request.pathParams, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeAddressesMoveQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.ComputeAddressesMoveResponse res = new org.openapis.openapi.models.operations.ComputeAddressesMoveResponse() {{
            operation = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeAddressesTestIamPermissionsResponse computeAddressesTestIamPermissions(org.openapis.openapi.models.operations.ComputeAddressesTestIamPermissionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeAddressesTestIamPermissionsPathParams.class, baseUrl, "/projects/{project}/regions/{region}/addresses/{resource}/testIamPermissions", request.pathParams, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeAddressesTestIamPermissionsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.ComputeAddressesTestIamPermissionsResponse res = new org.openapis.openapi.models.operations.ComputeAddressesTestIamPermissionsResponse() {{
