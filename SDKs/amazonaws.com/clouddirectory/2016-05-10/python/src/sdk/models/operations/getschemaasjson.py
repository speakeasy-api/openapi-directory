...
from ..shared import getschemaasjsonresponse as shared_getschemaasjsonresponse
...
class GetSchemaAsJSONRequest:
    headers: GetSchemaAsJSONHeaders = dataclasses.field()
...
class GetSchemaAsJSONResponse:
    ...
    get_schema_as_json_response: Optional[shared_getschemaasjsonresponse.GetSchemaAsJSONResponse] = dataclasses.field(default=None)
