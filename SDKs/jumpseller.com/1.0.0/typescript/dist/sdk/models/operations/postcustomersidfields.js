...
exports.PostCustomersIdFieldsResponse = exports.PostCustomersIdFieldsRequest = void 0;
...
var PostCustomersIdFieldsRequest = /** @class */ (function (_super) {
    ...
    ], PostCustomersIdFieldsRequest.prototype, "customerAdditionalFieldEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PostCustomersIdFieldsRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PostCustomersIdFieldsRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PostCustomersIdFieldsRequest.prototype, "login", void 0);
    return PostCustomersIdFieldsRequest;
}(utils_1.SpeakeasyBase));
exports.PostCustomersIdFieldsRequest = PostCustomersIdFieldsRequest;
var PostCustomersIdFieldsResponse = /** @class */ (function (_super) {
    ...
    ], PostCustomersIdFieldsResponse.prototype, "rawResponse", void 0);
    return PostCustomersIdFieldsResponse;
}(utils_1.SpeakeasyBase));
exports.PostCustomersIdFieldsResponse = PostCustomersIdFieldsResponse;
