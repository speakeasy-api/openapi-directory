...
exports.Candidate = exports.CandidatePrincipalCommittees = void 0;
...
var CandidatePrincipalCommittees = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=affiliated_committee_name" }),
        __metadata("design:type", String)
    ], CandidatePrincipalCommittees.prototype, "affiliatedCommitteeName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=candidate_ids" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cycles" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=designation_full" }),
        __metadata("design:type", String)
    ], CandidatePrincipalCommittees.prototype, "designationFull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=filing_frequency" }),
        __metadata("design:type", String)
    ], CandidatePrincipalCommittees.prototype, "filingFrequency", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=first_file_date" }),
        __metadata("design:type", Date)
    ], CandidatePrincipalCommittees.prototype, "firstFileDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_f1_date" }),
        __metadata("design:type", Date)
    ], CandidatePrincipalCommittees.prototype, "lastF1Date", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_file_date" }),
        __metadata("design:type", Date)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=organization_type" }),
        __metadata("design:type", String)
    ], CandidatePrincipalCommittees.prototype, "organizationType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=organization_type_full" }),
        __metadata("design:type", String)
...
exports.CandidatePrincipalCommittees = CandidatePrincipalCommittees;
var Candidate = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=active_through" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=candidate_inactive" }),
        __metadata("design:type", Boolean)
    ], Candidate.prototype, "candidateInactive", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=candidate_status" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=district_number" }),
        __metadata("design:type", Number)
    ], Candidate.prototype, "districtNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=election_districts" }),
        __metadata("design:type", Array)
    ], Candidate.prototype, "electionDistricts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=election_years" }),
        __metadata("design:type", Array)
    ], Candidate.prototype, "electionYears", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=federal_funds_flag" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=has_raised_funds" }),
        __metadata("design:type", Boolean)
    ], Candidate.prototype, "hasRaisedFunds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=inactive_election_years" }),
        __metadata("design:type", Array)
    ], Candidate.prototype, "inactiveElectionYears", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=incumbent_challenge" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_f2_date" }),
        __metadata("design:type", Date)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=office_full" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=principal_committees", elemType: CandidatePrincipalCommittees }),
        __metadata("design:type", Array)
