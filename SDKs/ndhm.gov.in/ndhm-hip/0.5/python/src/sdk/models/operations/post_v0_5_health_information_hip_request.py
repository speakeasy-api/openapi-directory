...
from ..shared import hiphealthinformationrequest as shared_hiphealthinformationrequest
...
class PostV05HealthInformationHipRequestRequests:
    ...
    hip_health_information_request: Optional[shared_hiphealthinformationrequest.HipHealthInformationRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
