...
public class UpdateAssetPropertyRequest {
    ...
    public UpdateAssetPropertyRequest(@JsonProperty("RequestBody") UpdateAssetPropertyRequestBody requestBody, @JsonProperty("assetId") String assetId, @JsonProperty("propertyId") String propertyId) {
        this.requestBody = requestBody;
        this.assetId = assetId;
        this.propertyId = propertyId;
  }
