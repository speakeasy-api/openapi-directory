...
public class ChromemanagementCustomersReportsCountPrintJobsByUserPathParams {
    /**
    ...
    public ChromemanagementCustomersReportsCountPrintJobsByUserPathParams withCustomer(String customer) {
