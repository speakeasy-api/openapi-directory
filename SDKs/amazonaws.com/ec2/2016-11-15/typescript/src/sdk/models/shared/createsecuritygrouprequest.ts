 ...
 */
export enum CreateSecurityGroupRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateSecurityGroupRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateSecurityGroupRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateSecurityGroupRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  description: string;
  ...
  @SpeakeasyMetadata({ elemType: CreateSecurityGroupRequestTagSpecifications })
