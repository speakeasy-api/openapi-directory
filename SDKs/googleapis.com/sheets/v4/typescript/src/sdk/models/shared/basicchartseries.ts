...
export class BasicChartSeries extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: BasicSeriesDataPointStyleOverride })
  @Expose({ name: "styleOverrides" })
  @Type(() => BasicSeriesDataPointStyleOverride)
