...
public class Statistics {
    ...
    **/
    public openapisdk.models.operations.GetStatisticsResponse getStatistics(openapisdk.models.operations.GetStatisticsRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/statistics");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.Statistics[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.Statistics[].class);
                res.statistics = out;
            }
        }
