...
class ListSubscriptionRequest:
    ...
    r"""The SID of the sink that the list of Subscriptions should be filtered by."""  
...
class ListSubscriptionListSubscriptionResponse:
    ...
    meta: Optional[ListSubscriptionListSubscriptionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    subscriptions: Optional[list[shared_events_v1_subscription.EventsV1Subscription]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('subscriptions'), 'exclude': lambda f: f is None }})  
