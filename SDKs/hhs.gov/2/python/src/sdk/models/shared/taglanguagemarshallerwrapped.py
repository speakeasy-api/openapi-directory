...
class TagLanguageMarshallerWrapped:
    ...
    results: Optional[list[shared_taglanguagemarshaller.TagLanguageMarshaller]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
