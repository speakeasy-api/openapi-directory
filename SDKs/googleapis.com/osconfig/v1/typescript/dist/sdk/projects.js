...
var Projects = /** @class */ (function () {
    ...
    Projects.prototype.osconfigProjectsLocationsInstancesInventoriesList = function (req, security, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/{parent}/inventories", req);
    ...
    Projects.prototype.osconfigProjectsLocationsInstancesVulnerabilityReportsList = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/vulnerabilityReports", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security =
    ...
    Projects.prototype.osconfigProjectsLocationsOsPolicyAssignmentsCreate = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/osPolicyAssignments", req);
    ...
    Projects.prototype.osconfigProjectsPatchDeploymentsCreate = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/patchDeployments", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Projects.prototype.osconfigProjectsPatchJobsExecute = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/patchJobs:execute", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Projects.prototype.osconfigProjectsPatchJobsInstanceDetailsList = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/instanceDetails", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security =
    ...
    Projects.prototype.osconfigProjectsPatchJobsList = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/patchJobs", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
