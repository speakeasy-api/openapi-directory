...
class DescribeFleetEventsResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\DescribeFleetEventsOutput $describeFleetEventsOutput
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\DescribeFleetEventsOutput $describeFleetEventsOutput = null;
	...
	{
		$this->contentType = "";
		$this->describeFleetEventsOutput = null;
