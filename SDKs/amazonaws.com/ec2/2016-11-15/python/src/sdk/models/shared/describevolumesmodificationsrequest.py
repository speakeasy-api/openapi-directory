...
class DescribeVolumesModificationsRequest:
    ...
    filters: Optional[list[DescribeVolumesModificationsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    volume_ids: Optional[list[str]] = dataclasses.field(default=None)  
