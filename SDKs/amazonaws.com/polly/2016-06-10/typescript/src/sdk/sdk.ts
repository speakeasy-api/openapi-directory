...
export class SDK {
  ...
  deleteLexicon(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DeleteLexiconResponse =
        new operations.DeleteLexiconResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.deleteLexiconOutput = utils.objectToClass(httpRes?.data);
          }
          break;
  ...
  describeVoices(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DescribeVoicesResponse =
        new operations.DescribeVoicesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.describeVoicesOutput = utils.objectToClass(
              httpRes?.data,
              shared.DescribeVoicesOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  getLexicon(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetLexiconResponse =
        new operations.GetLexiconResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getLexiconOutput = utils.objectToClass(
              httpRes?.data,
              shared.GetLexiconOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  getSpeechSynthesisTask(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSpeechSynthesisTaskResponse =
        new operations.GetSpeechSynthesisTaskResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getSpeechSynthesisTaskOutput = utils.objectToClass(
              httpRes?.data,
              shared.GetSpeechSynthesisTaskOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  listLexicons(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListLexiconsResponse =
        new operations.ListLexiconsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listLexiconsOutput = utils.objectToClass(
              httpRes?.data,
              shared.ListLexiconsOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  listSpeechSynthesisTasks(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListSpeechSynthesisTasksResponse =
        new operations.ListSpeechSynthesisTasksResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listSpeechSynthesisTasksOutput = utils.objectToClass(
              httpRes?.data,
              shared.ListSpeechSynthesisTasksOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  putLexicon(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PutLexiconResponse =
        new operations.PutLexiconResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.putLexiconOutput = utils.objectToClass(httpRes?.data);
          }
          break;
        case httpRes?.status == 480:
          if (utils.matchContentType(contentType, `application/json`)) {
  ...
  startSpeechSynthesisTask(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.StartSpeechSynthesisTaskResponse =
        new operations.StartSpeechSynthesisTaskResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.startSpeechSynthesisTaskOutput = utils.objectToClass(
              httpRes?.data,
              shared.StartSpeechSynthesisTaskOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  synthesizeSpeech(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SynthesizeSpeechResponse =
        new operations.SynthesizeSpeechResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.synthesizeSpeechOutput = utils.objectToClass(
              httpRes?.data,
              shared.SynthesizeSpeechOutput
            );
          }
          break;
        case httpRes?.status == 480:
