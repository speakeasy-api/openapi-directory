...
func NewOralQuestionTimes(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *OralQuestionTimes {
...
func (s *OralQuestionTimes) PublishedOralQuestionTimeGet(ctx context.Context, request operations.PublishedOralQuestionTimeGetRequest) (*operations.PublishedOralQuestionTimeGetResponse, error) {
