...
class Quota:
    ...
    def get_containers_quota(self, request: operations.GetContainersQuotaRequest) -> operations.GetContainersQuotaResponse:
        ...
        res = operations.GetContainersQuotaResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ContainersQuotaInfo])
    ...
    def get_containers_usage(self, request: operations.GetContainersUsageRequest) -> operations.GetContainersUsageResponse:
        ...
        res = operations.GetContainersUsageResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ContainersUsageInfo])
    ...
    def put_containers_quota(self, request: operations.PutContainersQuotaRequest) -> operations.PutContainersQuotaResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "containers_quota_list", 'json')
        ...
        res = operations.PutContainersQuotaResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
