...
class DescribeConnectionsRequest:
    ...
    query_params: DescribeConnectionsQueryParams = dataclasses.field()
    request: shared_describeconnectionsmessage.DescribeConnectionsMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
