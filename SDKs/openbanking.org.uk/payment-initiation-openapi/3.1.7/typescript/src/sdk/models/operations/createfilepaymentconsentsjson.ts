...
export class CreateFilePaymentConsentsJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateFilePaymentConsentsJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateFilePaymentConsentsJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
