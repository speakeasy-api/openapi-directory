...
type SearchTypePointOceanCsvSadoMeteoQueryParams struct {
...
type SearchTypePointOceanCsvSadoMeteoRequest struct {
	QueryParams SearchTypePointOceanCsvSadoMeteoQueryParams
}

type SearchTypePointOceanCsvSadoMeteoResponse struct {
	ContentType string
	StatusCode  int
