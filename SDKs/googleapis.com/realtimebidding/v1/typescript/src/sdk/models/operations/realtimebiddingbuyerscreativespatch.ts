...
export class RealtimebiddingBuyersCreativesPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RealtimebiddingBuyersCreativesPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RealtimebiddingBuyersCreativesPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
