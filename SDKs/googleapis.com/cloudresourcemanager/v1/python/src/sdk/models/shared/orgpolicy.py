...
class OrgPolicy:
    ...
    boolean_policy: Optional[shared_booleanpolicy.BooleanPolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('booleanPolicy'), 'exclude': lambda f: f is None }})
    ...
    list_policy: Optional[shared_listpolicy.ListPolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('listPolicy'), 'exclude': lambda f: f is None }})
