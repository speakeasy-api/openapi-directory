...
class AggregateFamilyValueEnum(str, Enum):
    FOUR = '4'
    SIX = '6'
...
class AggregateFamily:
    ...
    label: AggregateFamilyLabelEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label') }})  
    value: AggregateFamilyValueEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value') }})  
...
class Aggregate:
    ...
    family: Optional[AggregateFamily] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('family'), 'exclude': lambda f: f is None }})  
