...
class BackfillError:
    ...
    code: Optional[shared_backfillerrorcode_enum.BackfillErrorCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Code') }})
    partitions: Optional[list[shared_partitionvaluelist.PartitionValueList]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Partitions') }})
