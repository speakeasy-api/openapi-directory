...
export class ClouddeployProjectsLocationsTargetsDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ClouddeployProjectsLocationsTargetsDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ClouddeployProjectsLocationsTargetsDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
