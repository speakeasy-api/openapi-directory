...
export class ClouddeployProjectsLocationsDeliveryPipelinesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ClouddeployProjectsLocationsDeliveryPipelinesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ClouddeployProjectsLocationsDeliveryPipelinesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
