...
var AlloyDbSettings = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "initialUser" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "primaryInstanceSettings" }),
        (0, class_transformer_1.Type)(function () { return primaryinstancesettings_1.PrimaryInstanceSettings; }),
...
var AlloyDbSettingsInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "initialUser" }),
        (0, class_transformer_1.Type)(function () { return userpassword_1.UserPasswordInput; }),
        __metadata("design:type", userpassword_1.UserPasswordInput)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "primaryInstanceSettings" }),
        (0, class_transformer_1.Type)(function () { return primaryinstancesettings_1.PrimaryInstanceSettingsInput; }),
        __metadata("design:type", primaryinstancesettings_1.PrimaryInstanceSettingsInput)
