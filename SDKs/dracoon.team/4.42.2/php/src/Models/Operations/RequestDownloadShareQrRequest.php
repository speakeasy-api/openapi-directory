...
class RequestDownloadShareQrRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestDownloadShareQrXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestDownloadShareQrXSdsDateFormatEnum $xSdsDateFormat = null;
