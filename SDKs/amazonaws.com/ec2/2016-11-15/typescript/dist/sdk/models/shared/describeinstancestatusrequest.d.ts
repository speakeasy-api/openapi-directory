 ...
 */
export declare class DescribeInstanceStatusRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeInstanceStatusRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeInstanceStatusRequestFilters[];
