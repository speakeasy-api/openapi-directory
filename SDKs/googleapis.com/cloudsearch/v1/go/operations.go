...
func (s *Operations) CloudsearchOperationsGet(ctx context.Context, request operations.CloudsearchOperationsGetRequest) (*operations.CloudsearchOperationsGetResponse, error) {
...
func (s *Operations) CloudsearchOperationsLroList(ctx context.Context, request operations.CloudsearchOperationsLroListRequest) (*operations.CloudsearchOperationsLroListResponse, error) {
	baseURL := s._serverURL
