...
class GetNetworkClientLatencyStatsBandEnum(str, Enum):
...
class GetNetworkClientLatencyStatsRequest:
    ...
    band: Optional[GetNetworkClientLatencyStatsBandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'band', 'style': 'form', 'explode': True }})
    r"""Filter results by band (either '2.4' or '5'). Note that data prior to February 2020 will not have band information."""  
...
@dataclasses.dataclass
class GetNetworkClientLatencyStatsResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    get_network_client_latency_stats_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
