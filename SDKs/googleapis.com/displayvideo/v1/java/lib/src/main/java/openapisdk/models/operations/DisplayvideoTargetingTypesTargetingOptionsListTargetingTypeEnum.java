...
public enum DisplayvideoTargetingTypesTargetingOptionsListTargetingTypeEnum {
    ...
    private DisplayvideoTargetingTypesTargetingOptionsListTargetingTypeEnum(String value) {
        this.value = value;
    }
}
