 ...
 */
export declare enum RegionInstanceGroupManagersListInstanceConfigsRespWarningCodeEnum {
...
export declare class RegionInstanceGroupManagersListInstanceConfigsRespWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class RegionInstanceGroupManagersListInstanceConfigsRespWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: RegionInstanceGroupManagersListInstanceConfigsRespWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: RegionInstanceGroupManagersListInstanceConfigsRespWarningData[];
    /**
 ...
 * Successful response
 */
export declare class RegionInstanceGroupManagersListInstanceConfigsResp extends SpeakeasyBase {
    /**
