...
try {
    ...
    $request->botAlias = 'tempora';
    $request->botName = 'suscipit';
...
try {
    ...
    $request->botAlias = 'temporibus';
    $request->botName = 'ab';
    $request->checkpointLabelFilter = 'quis';
    $request->userId = 'veritatis';
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\PostContentRequest;
use \OpenAPI\OpenAPI\Models\Operations\PostContentRequestBody;
...
try {
    ...
    $request->requestBody = new PostContentRequestBody();
    $request->requestBody->inputStream = 'ipsam';
    ...
    $request->botAlias = 'molestiae';
    $request->botName = 'quod';
    $request->userId = 'quod';
    $request->xAmzLexActiveContexts = 'esse';
    $request->xAmzLexRequestAttributes = 'totam';
    $request->xAmzLexSessionAttributes = 'porro';

    $response = $sdk->sdk->postContent($request);

    if ($response->postContentResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\PostTextRequest;
use \OpenAPI\OpenAPI\Models\Operations\PostTextRequestBody;
...
try {
    $request = new PostTextRequest();
    $request->requestBody = new PostTextRequestBody();
    $request->requestBody->activeContexts = [
        new ActiveContext(),
        new ActiveContext(),
        new ActiveContext(),
    ];
    $request->requestBody->inputText = 'dicta';
    $request->requestBody->requestAttributes = [
        'officia' => 'occaecati',
        'fugit' => 'deleniti',
        'hic' => 'optio',
    ];
    $request->requestBody->sessionAttributes = [
        'beatae' => 'commodi',
        'molestiae' => 'modi',
        'qui' => 'impedit',
    ];
    ...
    $request->botAlias = 'natus';
    $request->botName = 'sed';
    $request->userId = 'iste';

    $response = $sdk->sdk->postText($request);

    if ($response->postTextResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\Models\Shared\ActiveContext;
use \OpenAPI\OpenAPI\Models\Shared\ActiveContextTimeToLive;
use \OpenAPI\OpenAPI\Models\Operations\PutSessionRequestBodyDialogAction;
use \OpenAPI\OpenAPI\Models\Shared\FulfillmentStateEnum;
use \OpenAPI\OpenAPI\Models\Shared\MessageFormatTypeEnum;
use \OpenAPI\OpenAPI\Models\Shared\DialogActionTypeEnum;
use \OpenAPI\OpenAPI\Models\Shared\IntentSummary;
use \OpenAPI\OpenAPI\Models\Shared\ConfirmationStatusEnum;
...
try {
    ...
    $request->requestBody->dialogAction = new PutSessionRequestBodyDialogAction();
    $request->requestBody->dialogAction->fulfillmentState = FulfillmentStateEnum::FAILED;
    $request->requestBody->dialogAction->intentName = 'hic';
    $request->requestBody->dialogAction->message = 'saepe';
    $request->requestBody->dialogAction->messageFormat = MessageFormatTypeEnum::SSML;
    $request->requestBody->dialogAction->slotToElicit = 'in';
    $request->requestBody->dialogAction->slots = [
        'iste' => 'iure',
        'saepe' => 'quidem',
    ];
    $request->requestBody->dialogAction->type = DialogActionTypeEnum::ELICIT_INTENT;
    $request->requestBody->recentIntentSummaryView = [
        new IntentSummary(),
    ];
    $request->requestBody->sessionAttributes = [
        'est' => 'mollitia',
    ...
    $request->botAlias = 'culpa';
    $request->botName = 'doloribus';
