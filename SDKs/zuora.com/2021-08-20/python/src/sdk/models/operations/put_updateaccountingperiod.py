...
from ..shared import putaccountingperiodtype as shared_putaccountingperiodtype
...
class PUTUpdateAccountingPeriodRequest:
    ...
    r"""ID of the accounting period you want to update."""  
    put_accounting_period_type: shared_putaccountingperiodtype.PUTAccountingPeriodType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
