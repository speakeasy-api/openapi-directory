...
exports.ChecksListSuitesForRefResponse = exports.ChecksListSuitesForRef200ApplicationJSON = exports.ChecksListSuitesForRefRequest = void 0;
...
var ChecksListSuitesForRefRequest = /** @class */ (function (_super) {
    ...
    ], ChecksListSuitesForRefRequest.prototype, "appId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=check_name",
        }),
        __metadata("design:type", String)
    ], ChecksListSuitesForRefRequest.prototype, "checkName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=owner",
        }),
        __metadata("design:type", String)
    ], ChecksListSuitesForRefRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], ChecksListSuitesForRefRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], ChecksListSuitesForRefRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=ref" }),
        __metadata("design:type", String)
    ], ChecksListSuitesForRefRequest.prototype, "ref", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], ChecksListSuitesForRefRequest.prototype, "repo", void 0);
...
var ChecksListSuitesForRef200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.CheckSuite }),
        (0, class_transformer_1.Expose)({ name: "check_suites" }),
        (0, class_transformer_1.Type)(function () { return shared.CheckSuite; }),
...
var ChecksListSuitesForRefResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ChecksListSuitesForRefResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
