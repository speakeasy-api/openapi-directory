...
class GoogleCloudVideointelligenceV1beta2LabelDetectionConfig:
    ...
    label_detection_mode: Optional[GoogleCloudVideointelligenceV1beta2LabelDetectionConfigLabelDetectionModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('labelDetectionMode'), 'exclude': lambda f: f is None }})
    r"""What labels should be detected with LABEL_DETECTION, in addition to video-level labels or segment-level labels. If unspecified, defaults to `SHOT_MODE`."""  
