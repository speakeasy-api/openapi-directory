...
class Webhooks:
    ...
    def webhooks_unsubscribe(self, request: operations.WebhooksUnsubscribeRequest) -> operations.WebhooksUnsubscribeResponse:
        r"""Unsubscribe to message events
        Delete subscription for receiving notifications
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, "/accounts/{accountId}/webhooks/{url}", request.path_params)
        ...
        res = operations.WebhooksUnsubscribeResponse(status_code=r.status_code, content_type=content_type)
