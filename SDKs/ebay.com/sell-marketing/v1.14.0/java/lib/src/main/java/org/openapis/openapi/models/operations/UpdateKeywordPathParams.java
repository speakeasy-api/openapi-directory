...
public class UpdateKeywordPathParams {
    /**
    ...
    public UpdateKeywordPathParams withCampaignId(String campaignId) {
    ...
    public UpdateKeywordPathParams withKeywordId(String keywordId) {
