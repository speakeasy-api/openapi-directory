...
from ..shared import listsequencestoresresponse as shared_listsequencestoresresponse
...
class ListSequenceStoresRequestBodyFilter:
    r"""A filter for a sequence store."""
...
class ListSequenceStoresRequestBody:
    ...
    filter: Optional[ListSequenceStoresRequestBodyFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filter'), 'exclude': lambda f: f is None }})
    r"""A filter for a sequence store."""  
...
class ListSequenceStoresRequest:
    ...
    request_body: ListSequenceStoresRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListSequenceStoresResponse:
    ...
    list_sequence_stores_response: Optional[shared_listsequencestoresresponse.ListSequenceStoresResponse] = dataclasses.field(default=None)
    r"""Success"""  
