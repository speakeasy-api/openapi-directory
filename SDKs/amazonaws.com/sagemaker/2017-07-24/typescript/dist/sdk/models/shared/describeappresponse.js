...
exports.DescribeAppResponse = void 0;
...
var DescribeAppResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "LastHealthCheckTimestamp" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "LastUserActivityTimestamp" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DescribeAppResponse.prototype, "spaceName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
