...
public class ProductApiNewJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ProductApiNewJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public ProductApiNewJsonHeaders withXAuthSecret(String xAuthSecret) {
