...
public class GetAs2IncomingMessagesRequest {
    ...
    public GetAs2IncomingMessagesRequest withAs2PartnerId(Integer as2PartnerId) {
    ...
    public GetAs2IncomingMessagesRequest withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public GetAs2IncomingMessagesRequest withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetAs2IncomingMessagesRequest withFilterGt(java.util.Map<String, Object> filterGt) {
    ...
    public GetAs2IncomingMessagesRequest withFilterGteq(java.util.Map<String, Object> filterGteq) {
    ...
    public GetAs2IncomingMessagesRequest withFilterLike(java.util.Map<String, Object> filterLike) {
    ...
    public GetAs2IncomingMessagesRequest withFilterLt(java.util.Map<String, Object> filterLt) {
    ...
    public GetAs2IncomingMessagesRequest withFilterLteq(java.util.Map<String, Object> filterLteq) {
    ...
    public GetAs2IncomingMessagesRequest withPerPage(Integer perPage) {
    ...
    public GetAs2IncomingMessagesRequest withSortBy(java.util.Map<String, Object> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
