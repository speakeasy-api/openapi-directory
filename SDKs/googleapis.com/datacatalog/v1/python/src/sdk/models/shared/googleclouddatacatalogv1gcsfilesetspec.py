...
import dataclasses
from ..shared import googleclouddatacatalogv1gcsfilespec as shared_googleclouddatacatalogv1gcsfilespec
...
class GoogleCloudDatacatalogV1GcsFilesetSpec:
    ...
    sample_gcs_file_specs: Optional[list[shared_googleclouddatacatalogv1gcsfilespec.GoogleCloudDatacatalogV1GcsFileSpec]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sampleGcsFileSpecs'), 'exclude': lambda f: f is None }})
