...
exports.ListWirelessSimResponse = exports.ListWirelessSimListWirelessSimResponse = exports.ListWirelessSimListWirelessSimResponseMeta = exports.ListWirelessSimRequest = exports.ListWirelessSimSecurity = exports.ListWirelessSimServerList = void 0;
...
var ListWirelessSimSecurity = /** @class */ (function (_super) {
    ...
    ], ListWirelessSimSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListWirelessSimSecurity.prototype, "username", void 0);
...
var ListWirelessSimRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListWirelessSimRequest.prototype, "eId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Iccid" }),
        __metadata("design:type", String)
    ], ListWirelessSimRequest.prototype, "iccid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListWirelessSimRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListWirelessSimRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListWirelessSimRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=RatePlan",
        }),
        __metadata("design:type", String)
    ], ListWirelessSimRequest.prototype, "ratePlan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SimRegistrationCode",
        }),
        __metadata("design:type", String)
    ], ListWirelessSimRequest.prototype, "simRegistrationCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListWirelessSimRequest.prototype, "status", void 0);
...
var ListWirelessSimListWirelessSimResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListWirelessSimListWirelessSimResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.PreviewWirelessSim }),
        (0, class_transformer_1.Expose)({ name: "sims" }),
        (0, class_transformer_1.Type)(function () { return shared.PreviewWirelessSim; }),
...
var ListWirelessSimResponse = /** @class */ (function (_super) {
    ...
    ], ListWirelessSimResponse.prototype, "rawResponse", void 0);
