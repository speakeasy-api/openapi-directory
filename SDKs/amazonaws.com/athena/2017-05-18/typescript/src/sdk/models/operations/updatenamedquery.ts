...
export enum UpdateNamedQueryXAmzTargetEnum {
  AmazonAthenaUpdateNamedQuery = "AmazonAthena.UpdateNamedQuery",
}

export class UpdateNamedQueryRequest extends SpeakeasyBase {
...
export class UpdateNamedQueryResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
