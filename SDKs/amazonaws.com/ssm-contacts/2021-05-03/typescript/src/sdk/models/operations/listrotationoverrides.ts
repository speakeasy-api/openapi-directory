...
export enum ListRotationOverridesXAmzTargetEnum {
  SSMContactsListRotationOverrides = "SSMContacts.ListRotationOverrides",
}

export class ListRotationOverridesRequest extends SpeakeasyBase {
...
export class ListRotationOverridesResponse extends SpeakeasyBase {
  /**
