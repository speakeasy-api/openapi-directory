...
class RealtimebiddingBiddersPretargetingConfigsAddTargetedSitesRequest:
    ...
    add_targeted_sites_request: Optional[shared_addtargetedsitesrequest.AddTargetedSitesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
