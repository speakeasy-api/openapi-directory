...
class ProfileFilterLinks:
    r"""A profile filter link collection lists profile filter links between profiles and filters. Each resource in the collection corresponds to a profile filter link."""
    
    items: Optional[list[shared_profilefilterlink.ProfileFilterLink]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
    r"""A list of profile filter links."""  
    ...
    r"""Link to next page for this profile filter link collection."""  
    ...
    r"""Link to previous page for this profile filter link collection."""  
