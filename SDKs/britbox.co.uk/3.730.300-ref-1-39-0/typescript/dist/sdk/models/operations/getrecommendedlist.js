...
exports.GetRecommendedListResponse = exports.GetRecommendedListRequest = exports.GetRecommendedListSecurity = void 0;
...
exports.GetRecommendedListSecurity = GetRecommendedListSecurity;
var GetRecommendedListRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetRecommendedListRequest.prototype, "device", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=false;name=ff" }),
        __metadata("design:type", Array)
    ], GetRecommendedListRequest.prototype, "ff", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=item_types",
        }),
        __metadata("design:type", Array)
    ], GetRecommendedListRequest.prototype, "itemTypes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=lang" }),
        __metadata("design:type", String)
    ], GetRecommendedListRequest.prototype, "lang", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetRecommendedListRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], GetRecommendedListRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=segments",
        }),
        __metadata("design:type", Array)
    ], GetRecommendedListRequest.prototype, "segments", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sub" }),
        __metadata("design:type", String)
    ], GetRecommendedListRequest.prototype, "sub", void 0);
    return GetRecommendedListRequest;
}(utils_1.SpeakeasyBase));
exports.GetRecommendedListRequest = GetRecommendedListRequest;
var GetRecommendedListResponse = /** @class */ (function (_super) {
    ...
    ], GetRecommendedListResponse.prototype, "rawResponse", void 0);
    return GetRecommendedListResponse;
}(utils_1.SpeakeasyBase));
exports.GetRecommendedListResponse = GetRecommendedListResponse;
