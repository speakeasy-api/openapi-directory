...
var ReturnPolicy = /** @class */ (function () {
    ...
    **/
    ReturnPolicy.prototype.createReturnPolicy = function (req, config) {
        var _a;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.setReturnPolicyResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    ReturnPolicy.prototype.deleteReturnPolicy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteReturnPolicyRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/return_policy/{return_policy_id}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
    ...
    **/
    ReturnPolicy.prototype.getReturnPolicies = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ReturnPolicy.prototype.getReturnPolicy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ReturnPolicy.prototype.getReturnPolicyByName = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ReturnPolicy.prototype.updateReturnPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
