...
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#create-reaction-for-a-commit-comment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#create-reaction-for-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#create-reaction-for-an-issue-comment>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsCreateForIssueComment(ctx, operations.ReactionsCreateForIssueCommentRequest{
        RequestBody: operations.ReactionsCreateForIssueCommentRequestBody{
            Content: operations.ReactionsCreateForIssueCommentRequestBodyContentEnumLaugh,
        },
        CommentID: 57470,
        Owner: "quisquam",
        Repo: "tenetur",
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#create-reaction-for-a-pull-request-review-comment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions/#create-reaction-for-a-release>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#create-reaction-for-a-team-discussion-comment>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsCreateForTeamDiscussionCommentInOrg(ctx, operations.ReactionsCreateForTeamDiscussionCommentInOrgRequest{
        ...
        CommentNumber: 795546,
        DiscussionNumber: 417539,
        Org: "eveniet",
        TeamSlug: "porro",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions/#create-reaction-for-a-team-discussion-comment-legacy>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsCreateForTeamDiscussionCommentLegacy(ctx, operations.ReactionsCreateForTeamDiscussionCommentLegacyRequest{
        RequestBody: operations.ReactionsCreateForTeamDiscussionCommentLegacyRequestBody{
            Content: operations.ReactionsCreateForTeamDiscussionCommentLegacyRequestBodyContentEnumHooray,
        },
        CommentNumber: 693747,
        DiscussionNumber: 265930,
        TeamID: 916341,
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#create-reaction-for-a-team-discussion>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions/#create-reaction-for-a-team-discussion-legacy>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsCreateForTeamDiscussionLegacy(ctx, operations.ReactionsCreateForTeamDiscussionLegacyRequest{
        RequestBody: operations.ReactionsCreateForTeamDiscussionLegacyRequestBody{
            Content: operations.ReactionsCreateForTeamDiscussionLegacyRequestBodyContentEnumEyes,
        },
        DiscussionNumber: 459875,
        TeamID: 500021,
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#delete-a-commit-comment-reaction>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#delete-an-issue-reaction>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#delete-an-issue-comment-reaction>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#delete-a-pull-request-comment-reaction>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions/#delete-a-release-reaction>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#delete-team-discussion-reaction>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#delete-team-discussion-comment-reaction>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsDeleteForTeamDiscussionComment(ctx, operations.ReactionsDeleteForTeamDiscussionCommentRequest{
        CommentNumber: 748023,
        DiscussionNumber: 620054,
        Org: "minus",
        ReactionID: 154389,
        TeamSlug: "magnam",
    })
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#list-reactions-for-a-commit-comment>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForCommitComment(ctx, operations.ReactionsListForCommitCommentRequest{
        ...
        Owner: "quos",
        Page: sdk.Int64(548846),
        PerPage: sdk.Int64(227870),
        Repo: "molestiae",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#list-reactions-for-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#list-reactions-for-an-issue-comment>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForIssueComment(ctx, operations.ReactionsListForIssueCommentRequest{
        CommentID: 564627,
        Content: operations.ReactionsListForIssueCommentContentEnumLaugh.ToPointer(),
        Owner: "sunt",
        Page: sdk.Int64(982991),
        PerPage: sdk.Int64(205011),
        Repo: "odit",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#list-reactions-for-a-pull-request-review-comment>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForPullRequestReviewComment(ctx, operations.ReactionsListForPullRequestReviewCommentRequest{
        ...
        Owner: "ipsam",
        Page: sdk.Int64(51053),
        PerPage: sdk.Int64(350387),
        Repo: "veniam",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions/#list-reactions-for-a-release>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForRelease(ctx, operations.ReactionsListForReleaseRequest{
        ...
        Owner: "ad",
        Page: sdk.Int64(394161),
        PerPage: sdk.Int64(946808),
        ReleaseID: 338281,
        Repo: "quibusdam",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#list-reactions-for-a-team-discussion-comment>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForTeamDiscussionCommentInOrg(ctx, operations.ReactionsListForTeamDiscussionCommentInOrgRequest{
        CommentNumber: 366480,
        Content: operations.ReactionsListForTeamDiscussionCommentInOrgContentEnumConfused.ToPointer(),
        DiscussionNumber: 866459,
        Org: "sit",
        Page: sdk.Int64(694728),
        PerPage: sdk.Int64(831031),
        TeamSlug: "perferendis",
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions/#list-reactions-for-a-team-discussion-comment-legacy>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForTeamDiscussionCommentLegacy(ctx, operations.ReactionsListForTeamDiscussionCommentLegacyRequest{
        CommentNumber: 660536,
        Content: operations.ReactionsListForTeamDiscussionCommentLegacyContentEnumEyes.ToPointer(),
        DiscussionNumber: 152364,
        Page: sdk.Int64(823572),
        PerPage: sdk.Int64(996072),
        TeamID: 921060,
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions#list-reactions-for-a-team-discussion>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForTeamDiscussionInOrg(ctx, operations.ReactionsListForTeamDiscussionInOrgRequest{
        ...
        DiscussionNumber: 240696,
        Org: "pariatur",
        Page: sdk.Int64(688463),
        PerPage: sdk.Int64(294266),
        TeamSlug: "voluptatibus",
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/reactions/#list-reactions-for-a-team-discussion-legacy>
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForTeamDiscussionLegacy(ctx, operations.ReactionsListForTeamDiscussionLegacyRequest{
        ...
        DiscussionNumber: 127087,
        Page: sdk.Int64(795457),
        PerPage: sdk.Int64(746688),
        TeamID: 677509,
    })
    if err != nil {
        log.Fatal(err)
