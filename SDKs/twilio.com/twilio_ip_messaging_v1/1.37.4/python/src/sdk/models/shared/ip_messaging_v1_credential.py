...
class IPMessagingV1Credential:
    ...
    type: Optional[shared_credential_enum_push_service_enum.CredentialEnumPushServiceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
