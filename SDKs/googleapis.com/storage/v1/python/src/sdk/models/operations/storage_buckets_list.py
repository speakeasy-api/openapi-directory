...
class StorageBucketsListRequest:
    ...
    r"""Maximum number of buckets to return in a single response. The service will use this parameter or 1,000 items, whichever is smaller."""  
    ...
    r"""Filter results to buckets whose names begin with this prefix."""  
