...
from ..shared import getentityresponse as shared_getentityresponse
...
class GetEntityResponse:
    ...
    get_entity_response: Optional[shared_getentityresponse.GetEntityResponse] = dataclasses.field(default=None)
    r"""Success"""  
