...
export class GetGenotypeGeneAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGenotypeGeneAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGenotypeGeneAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGenotypeGeneAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
