...
public class GeneralApiCountriesHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public GeneralApiCountriesHeaders withXAuthKey(String xAuthKey) {
    ...
    public GeneralApiCountriesHeaders withXAuthSecret(String xAuthSecret) {
