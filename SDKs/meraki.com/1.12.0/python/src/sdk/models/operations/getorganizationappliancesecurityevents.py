...
class GetOrganizationApplianceSecurityEventsRequest:
    path_params: GetOrganizationApplianceSecurityEventsPathParams = dataclasses.field()
    query_params: GetOrganizationApplianceSecurityEventsQueryParams = dataclasses.field()
...
class GetOrganizationApplianceSecurityEventsResponse:
    ...
    get_organization_appliance_security_events_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
