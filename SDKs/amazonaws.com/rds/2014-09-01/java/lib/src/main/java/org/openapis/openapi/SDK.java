...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.POSTCopyOptionGroupResponse postCopyOptionGroup(org.openapis.openapi.models.operations.POSTCopyOptionGroupRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.POSTCopyOptionGroupRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.POSTCopyOptionGroupResponse res = new org.openapis.openapi.models.operations.POSTCopyOptionGroupResponse(contentType, httpRes.statusCode()) {{
            body = null;
        }};
        res.rawResponse = httpRes;
