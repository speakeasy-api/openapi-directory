 ...
 */
export declare enum CreateVpcPeeringConnectionRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateVpcPeeringConnectionRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateVpcPeeringConnectionRequestTagSpecifications extends SpeakeasyBase {
