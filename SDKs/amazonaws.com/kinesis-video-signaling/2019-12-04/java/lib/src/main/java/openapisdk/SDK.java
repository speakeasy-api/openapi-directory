...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.GetIceServerConfigResponse getIceServerConfig(openapisdk.models.operations.GetIceServerConfigRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/get-ice-server-config");
        ...
        openapisdk.models.operations.GetIceServerConfigResponse res = new openapisdk.models.operations.GetIceServerConfigResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GetIceServerConfigResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetIceServerConfigResponse.class);
    ...
    **/
    public openapisdk.models.operations.SendAlexaOfferToMasterResponse sendAlexaOfferToMaster(openapisdk.models.operations.SendAlexaOfferToMasterRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/send-alexa-offer-to-master");
        ...
        openapisdk.models.operations.SendAlexaOfferToMasterResponse res = new openapisdk.models.operations.SendAlexaOfferToMasterResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.SendAlexaOfferToMasterResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.SendAlexaOfferToMasterResponse.class);
