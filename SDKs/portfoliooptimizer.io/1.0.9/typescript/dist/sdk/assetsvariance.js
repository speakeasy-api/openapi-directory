...
exports.AssetsVariance = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var AssetsVariance = /** @class */ (function () {
    function AssetsVariance(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    AssetsVariance.prototype.postAssetsVariance = function (req, config) {
        var _a;
     ...
     *
    **/
    AssetsVariance.prototype.postAssetsVarianceSample = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.AssetsVariance = AssetsVariance;
