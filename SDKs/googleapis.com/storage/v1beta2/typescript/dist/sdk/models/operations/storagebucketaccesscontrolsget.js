...
exports.StorageBucketAccessControlsGetResponse = exports.StorageBucketAccessControlsGetRequest = exports.StorageBucketAccessControlsGetSecurity = void 0;
...
var StorageBucketAccessControlsGetRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], StorageBucketAccessControlsGetRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=bucket",
        }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsGetRequest.prototype, "bucket", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=entity",
        }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsGetRequest.prototype, "entity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsGetRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsGetRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsGetRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], StorageBucketAccessControlsGetRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsGetRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsGetRequest.prototype, "userIp", void 0);
...
var StorageBucketAccessControlsGetResponse = /** @class */ (function (_super) {
    ...
    ], StorageBucketAccessControlsGetResponse.prototype, "rawResponse", void 0);
