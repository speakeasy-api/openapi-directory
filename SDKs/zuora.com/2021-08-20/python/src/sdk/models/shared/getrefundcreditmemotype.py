...
class GETRefundCreditMemoTypeFinanceInformationTransferredToAccountingEnum(str, Enum):
...
class GETRefundCreditMemoTypeFinanceInformation:
    ...
    transferred_to_accounting: Optional[GETRefundCreditMemoTypeFinanceInformationTransferredToAccountingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transferredToAccounting'), 'exclude': lambda f: f is None }})
    r"""Whether the refund was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite."""  
...
class GETRefundCreditMemoTypeGatewayStateEnum(str, Enum):
...
class GETRefundCreditMemoTypeMethodTypeEnum(str, Enum):
...
class GETRefundCreditMemoTypeStatusEnum(str, Enum):
...
class GETRefundCreditMemoTypeTypeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GETRefundCreditMemoType:
    r"""Container for custom fields of a Refund object."""
    
    account_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('accountId'), 'exclude': lambda f: f is None }})
    r"""The ID of the account associated with this refund. Zuora associates the refund automatically with the account from the associated payment."""  
    ...
    r"""The date and time when the refund was created, in `yyyy-mm-dd hh:mm:ss` format. For example, 2017-03-06 15:31:10."""  
    ...
    finance_information: Optional[GETRefundCreditMemoTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the refund."""  
    ...
    r"""The response code returned from the payment gateway for the refund. This code is gateway-dependent."""  
    gateway_state: Optional[GETRefundCreditMemoTypeGatewayStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('gatewayState'), 'exclude': lambda f: f is None }})
    r"""The status of the refund in the gateway."""  
    id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is None }})
    r"""The ID of the created refund."""  
    ...
    method_type: Optional[GETRefundCreditMemoTypeMethodTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('methodType'), 'exclude': lambda f: f is None }})
    r"""How an external refund was issued to a customer."""  
    ...
    r"""The ID of the payment associated with the refund."""  
    ...
    r"""The date when the refund takes effect, in yyyy-mm-dd format."""  
    ...
    r"""A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi."""  
    status: Optional[GETRefundCreditMemoTypeStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The status of the refund."""  
    ...
    type: Optional[GETRefundCreditMemoTypeTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of the refund."""  
    ...
    r"""The date and time when the refund was last updated, in `yyyy-mm-dd hh:mm:ss` format. For example, 2017-03-07 15:36:10."""  
