...
class GetVariantGenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetVariantGenotypeAssociationsQueryParams:
...
class GetVariantGenotypeAssociationsRequest:
    path_params: GetVariantGenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetVariantGenotypeAssociationsQueryParams = dataclasses.field()
