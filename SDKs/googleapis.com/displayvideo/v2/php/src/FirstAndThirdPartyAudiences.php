...
class FirstAndThirdPartyAudiences 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DisplayvideoFirstAndThirdPartyAudiencesCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/firstAndThirdPartyAudiences');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/firstAndThirdPartyAudiences/{firstAndThirdPartyAudienceId}:editCustomerMatchMembers', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoFirstAndThirdPartyAudiencesEditCustomerMatchMembersRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/firstAndThirdPartyAudiences/{firstAndThirdPartyAudienceId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoFirstAndThirdPartyAudiencesGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/firstAndThirdPartyAudiences/{firstAndThirdPartyAudienceId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoFirstAndThirdPartyAudiencesPatchRequest::class, $request);
