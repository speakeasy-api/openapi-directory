 ...
 */
public enum InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCheckDeclineReasonEnum {
    ...
    private InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCheckDeclineReasonEnum(String value) {
        this.value = value;
    }
}
