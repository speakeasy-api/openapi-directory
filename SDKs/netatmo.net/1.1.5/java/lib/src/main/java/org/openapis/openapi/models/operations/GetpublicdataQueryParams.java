...
public class GetpublicdataQueryParams {
    /**
     * True to exclude stations with abnormal temperature measures. Default is false.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=filter")
    public Boolean filter;
    public GetpublicdataQueryParams withFilter(Boolean filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetpublicdataQueryParams withLatNe(Integer latNe) {
        this.latNe = latNe;
        return this;
    }
    ...
    public GetpublicdataQueryParams withLatSw(Integer latSw) {
        this.latSw = latSw;
        return this;
    }
    ...
    public GetpublicdataQueryParams withLonNe(Integer lonNe) {
        this.lonNe = lonNe;
        return this;
    }
    ...
    public GetpublicdataQueryParams withLonSw(Integer lonSw) {
        this.lonSw = lonSw;
        return this;
    }
    ...
    public GetpublicdataQueryParams withRequiredData(GetpublicdataRequiredDataEnum[] requiredData) {
