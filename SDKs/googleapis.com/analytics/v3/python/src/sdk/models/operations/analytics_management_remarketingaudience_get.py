...
class AnalyticsManagementRemarketingAudienceGetRequest:
    ...
    r"""The account ID of the remarketing audience to retrieve."""  
    ...
    r"""The ID of the remarketing audience to retrieve."""  
    web_property_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'webPropertyId', 'style': 'simple', 'explode': False }})
    r"""The web property ID of the remarketing audience to retrieve."""  
