...
class RunProjectsLocationsDomainmappingsListPathParams:
    parent: str = dataclasses.field(metadata={'path_param': { 'field_name': 'parent', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class RunProjectsLocationsDomainmappingsListQueryParams:
...
class RunProjectsLocationsDomainmappingsListRequest:
    path_params: RunProjectsLocationsDomainmappingsListPathParams = dataclasses.field()
    query_params: RunProjectsLocationsDomainmappingsListQueryParams = dataclasses.field()
    security: RunProjectsLocationsDomainmappingsListSecurity = dataclasses.field()
