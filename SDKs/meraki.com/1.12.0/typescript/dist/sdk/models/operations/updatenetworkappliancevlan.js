...
exports.UpdateNetworkApplianceVlanResponse = exports.UpdateNetworkApplianceVlanRequest = exports.UpdateNetworkApplianceVlanRequestBody = exports.UpdateNetworkApplianceVlanRequestBodyReservedIpRanges = exports.UpdateNetworkApplianceVlanRequestBodyDhcpOptions = exports.UpdateNetworkApplianceVlanRequestBodyDhcpOptionsTypeEnum = exports.UpdateNetworkApplianceVlanRequestBodyDhcpLeaseTimeEnum = exports.UpdateNetworkApplianceVlanRequestBodyDhcpHandlingEnum = exports.UpdateNetworkApplianceVlanPathParams = void 0;
...
exports.UpdateNetworkApplianceVlanPathParams = UpdateNetworkApplianceVlanPathParams;
...
var UpdateNetworkApplianceVlanRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dhcpBootFilename" }),
        __metadata("design:type", String)
    ], UpdateNetworkApplianceVlanRequestBody.prototype, "dhcpBootFilename", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dhcpBootNextServer" }),
        __metadata("design:type", String)
    ], UpdateNetworkApplianceVlanRequestBody.prototype, "dhcpBootNextServer", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dhcpBootOptionsEnabled" }),
        __metadata("design:type", Boolean)
    ], UpdateNetworkApplianceVlanRequestBody.prototype, "dhcpBootOptionsEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dhcpHandling" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dhcpOptions", elemType: UpdateNetworkApplianceVlanRequestBodyDhcpOptions }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reservedIpRanges", elemType: UpdateNetworkApplianceVlanRequestBodyReservedIpRanges }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=vpnNatSubnet" }),
        __metadata("design:type", String)
