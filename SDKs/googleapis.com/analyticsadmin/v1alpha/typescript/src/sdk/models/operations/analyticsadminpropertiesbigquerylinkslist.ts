...
export class AnalyticsadminPropertiesBigQueryLinksListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesBigQueryLinksListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class AnalyticsadminPropertiesBigQueryLinksListSecurity extends SpeakeasyBase {
...
export class AnalyticsadminPropertiesBigQueryLinksListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesBigQueryLinksListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
