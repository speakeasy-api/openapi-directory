...
var Course = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "courseGroupEmail" }),
        __metadata("design:type", String)
    ], Course.prototype, "courseGroupEmail", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: coursematerialset_1.CourseMaterialSet }),
        (0, class_transformer_1.Expose)({ name: "courseMaterialSets" }),
        (0, class_transformer_1.Type)(function () { return coursematerialset_1.CourseMaterialSet; }),
        __metadata("design:type", Array)
    ], Course.prototype, "courseMaterialSets", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "courseState" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "gradebookSettings" }),
        (0, class_transformer_1.Type)(function () { return gradebooksettings_1.GradebookSettings; }),
        __metadata("design:type", gradebooksettings_1.GradebookSettings)
    ], Course.prototype, "gradebookSettings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "guardiansEnabled" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "teacherFolder" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "teacherGroupEmail" }),
        __metadata("design:type", String)
