...
export declare class ItemsUpdateRequestBodyOrderItems extends SpeakeasyBase {
    /**
...
export declare class ItemsUpdateRequestBody extends SpeakeasyBase {
    /**
...
export declare class ItemsUpdateRequest extends SpeakeasyBase {
     ...
     */
    contentType: string;
    requestBody: ItemsUpdateRequestBody;
    /**
...
export declare class ItemsUpdate200ApplicationJSONAvailableAddresses extends SpeakeasyBase {
    /**
     * Address ID.
     */
    addressId?: string;
 ...
 */
export declare class ItemsUpdate200ApplicationJSONClientPreferencesData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ItemsUpdate200ApplicationJSONClientProfileData extends SpeakeasyBase {
    /**
...
export declare class ItemsUpdate200ApplicationJSONItemMetadataItems extends SpeakeasyBase {
    /**
     * Detail URL.
     */
    detailUrl?: string;
 ...
 * Item metadata.
 */
export declare class ItemsUpdate200ApplicationJSONItemMetadata extends SpeakeasyBase {
    /**
     * List of objects containing metadata on each item in the order.
     */
    items?: ItemsUpdate200ApplicationJSONItemMetadataItems[];
}
/**
 * Additional information.
 */
export declare class ItemsUpdate200ApplicationJSONItemsAdditionalInfo extends SpeakeasyBase {
    /**
     * Brand ID.
     */
    brandId?: string;
...
export declare class ItemsUpdate200ApplicationJSONItemsBundleItems extends SpeakeasyBase {
    /**
     * Service identifier.
     */
    id?: number;
...
export declare class ItemsUpdate200ApplicationJSONItemsPriceDefinitionSellingPrices extends SpeakeasyBase {
    /**
 ...
 */
export declare class ItemsUpdate200ApplicationJSONItemsPriceDefinition extends SpeakeasyBase {
    /**
     ...
     */
    sellingPrices?: ItemsUpdate200ApplicationJSONItemsPriceDefinitionSellingPrices[];
    /**
     * Total value for all units of the item in cents.
     */
    total?: number;
}
export declare class ItemsUpdate200ApplicationJSONItemsPriceTags extends SpeakeasyBase {
    /**
 ...
 */
export declare class ItemsUpdate200ApplicationJSONItemsProductCategories extends SpeakeasyBase {
    /**
     * Product category corresponding to the ID in the field key.
     */
    id?: string;
}
export declare class ItemsUpdate200ApplicationJSONItems extends SpeakeasyBase {
    /**
     * Additional information.
     */
    additionalInfo?: ItemsUpdate200ApplicationJSONItemsAdditionalInfo;
    /**
     ...
     */
    bundleItems?: ItemsUpdate200ApplicationJSONItemsBundleItems[];
    /**
     * Detail URL.
     */
    detailUrl?: string;
     ...
     * Price information for all units of a specific item.
     */
    priceDefinition?: ItemsUpdate200ApplicationJSONItemsPriceDefinition;
    /**
     ...
     */
    priceTags?: ItemsUpdate200ApplicationJSONItemsPriceTags[];
    /**
     ...
     * Object, where each field is an ID from `productCategoryIds`.
     */
    productCategories?: ItemsUpdate200ApplicationJSONItemsProductCategories;
    /**
 ...
 */
export declare class ItemsUpdate200ApplicationJSONItemsOrdination extends SpeakeasyBase {
    /**
 ...
 */
export declare class ItemsUpdate200ApplicationJSONMarketingData extends SpeakeasyBase {
    /**
...
export declare class ItemsUpdate200ApplicationJSONPaymentDataGiftCards extends SpeakeasyBase {
    /**
...
export declare class ItemsUpdate200ApplicationJSONPaymentDataTransactionsPayments extends SpeakeasyBase {
    /**
     * Account ID.
     */
    accountId?: string;
...
export declare class ItemsUpdate200ApplicationJSONPaymentDataTransactions extends SpeakeasyBase {
    /**
     ...
     */
    payments?: ItemsUpdate200ApplicationJSONPaymentDataTransactionsPayments[];
    /**
 ...
 */
export declare class ItemsUpdate200ApplicationJSONPaymentData extends SpeakeasyBase {
    /**
     * Gift card information, if it applies to the order.
     */
    giftCards?: ItemsUpdate200ApplicationJSONPaymentDataGiftCards[];
    /**
     * Information on each transaction pertinent to the order.
     */
    transactions?: ItemsUpdate200ApplicationJSONPaymentDataTransactions[];
}
/**
 * Information on rates and benefits that apply to the order.
 */
export declare class ItemsUpdate200ApplicationJSONRatesAndBenefitsData extends SpeakeasyBase {
    /**
...
export declare class ItemsUpdate200ApplicationJSONSellers extends SpeakeasyBase {
    /**
     * Seller ID.
     */
    id?: string;
 ...
 * Address information.
 */
export declare class ItemsUpdate200ApplicationJSONShippingDataAddress extends SpeakeasyBase {
    /**
     * Address ID.
     */
    addressId?: string;
...
export declare class ItemsUpdate200ApplicationJSONShippingDataAvailableAddresses extends SpeakeasyBase {
    /**
     * Address ID.
     */
    addressId?: string;
...
export declare class ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoDeliveryChannels extends SpeakeasyBase {
    /**
     * Delivery channel ID.
     */
    id?: string;
}
export declare class ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlasDeliveryIds extends SpeakeasyBase {
    /**
     * Courier ID.
     */
    courierId?: string;
 ...
 * Address information.
 */
export declare class ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlasPickupStoreInfoAddress extends SpeakeasyBase {
    /**
     * Type of address. For example, `Residential` or `Pickup`.
     */
    addressType?: string;
 ...
 */
export declare class ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlasPickupStoreInfo extends SpeakeasyBase {
    /**
     * Additional information.
     */
     ...
     * Address information.
     */
    address?: ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlasPickupStoreInfoAddress;
    /**
...
export declare class ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlas extends SpeakeasyBase {
    /**
     * Delivery channel.
     */
     ...
     */
    deliveryIds?: ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlasDeliveryIds[];
    /**
     * SLA ID.
     */
    id?: string;
     ...
     * Information on the pickup store.
     */
    pickupStoreInfo?: ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlasPickupStoreInfo;
    /**
     * Polygon name.
     */
    polygonName?: string;
...
export declare class ItemsUpdate200ApplicationJSONShippingDataLogisticsInfo extends SpeakeasyBase {
    /**
     * Address ID.
     */
    addressId?: string;
     ...
     */
    deliveryChannels?: ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoDeliveryChannels[];
    /**
     * Item ID.
     */
    itemId?: string;
     ...
     */
    slas?: ItemsUpdate200ApplicationJSONShippingDataLogisticsInfoSlas[];
}
export declare class ItemsUpdate200ApplicationJSONShippingDataSelectedAddresses extends SpeakeasyBase {
    /**
     * Address ID.
     */
    addressId?: string;
 ...
 */
export declare class ItemsUpdate200ApplicationJSONShippingData extends SpeakeasyBase {
    /**
     * Address information.
     */
    address?: ItemsUpdate200ApplicationJSONShippingDataAddress;
    /**
     * Array with information on the available addresses for the order.
     */
    availableAddresses?: ItemsUpdate200ApplicationJSONShippingDataAvailableAddresses[];
    /**
     ...
     */
    logisticsInfo?: ItemsUpdate200ApplicationJSONShippingDataLogisticsInfo[];
    /**
     * Array with information on the selected addresses for the order.
     */
    selectedAddresses?: ItemsUpdate200ApplicationJSONShippingDataSelectedAddresses[];
}
/**
 * OK
 */
export declare class ItemsUpdate200ApplicationJSON extends SpeakeasyBase {
    /**
     ...
     */
    availableAddresses?: ItemsUpdate200ApplicationJSONAvailableAddresses[];
    /**
     * Data can be edited.
     */
    canEditData?: boolean;
     ...
     * Object containing preferences from the client who placed the order.
     */
    clientPreferencesData?: ItemsUpdate200ApplicationJSONClientPreferencesData;
    /**
     * Customer's profile information.
     */
    clientProfileData?: ItemsUpdate200ApplicationJSONClientProfileData;
    /**
     ...
     * Item metadata.
     */
    itemMetadata?: ItemsUpdate200ApplicationJSONItemMetadata;
    /**
     * Information on each item in the order.
     */
    items?: ItemsUpdate200ApplicationJSONItems[];
    /**
     * Object containing information about the ordering of items within the `orderForm`.
     */
    itemsOrdination?: ItemsUpdate200ApplicationJSONItemsOrdination;
    /**
     ...
     * Object containing promotion data such as coupon tracking information and internal or external UTMs.
     */
    marketingData?: ItemsUpdate200ApplicationJSONMarketingData;
    /**
     ...
     * Information on the order's payment.
     */
    paymentData?: ItemsUpdate200ApplicationJSONPaymentData;
    /**
     * Profile provider.
     */
     ...
     * Information on rates and benefits that apply to the order.
     */
    ratesAndBenefitsData?: ItemsUpdate200ApplicationJSONRatesAndBenefitsData;
    /**
     ...
     */
    sellers?: ItemsUpdate200ApplicationJSONSellers[];
    /**
     * Shipping information pertinent to the order.
     */
    shippingData?: ItemsUpdate200ApplicationJSONShippingData;
    /**
     * ID of the store.
     */
    storeId?: string;
