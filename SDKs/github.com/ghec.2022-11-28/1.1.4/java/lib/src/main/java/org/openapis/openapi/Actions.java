...
public class Actions {
    ...
    public org.openapis.openapi.models.operations.ActionsSetActionsOidcCustomIssuerPolicyForEnterpriseResponse actionsSetActionsOidcCustomIssuerPolicyForEnterprise(org.openapis.openapi.models.operations.ActionsSetActionsOidcCustomIssuerPolicyForEnterpriseRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ActionsSetActionsOidcCustomIssuerPolicyForEnterpriseRequest.class, baseUrl, "/enterprises/{enterprise}/actions/oidc/customization/issuer", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("PUT");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "actionsOidcCustomIssuerPolicyForEnterprise", "json");
        if (serializedRequestBody == null) {
            throw new Exception("Request body is required");
        }
        req.setBody(serializedRequestBody);
