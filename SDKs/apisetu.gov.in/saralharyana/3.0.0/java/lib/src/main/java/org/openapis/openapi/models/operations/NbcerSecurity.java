...
public class NbcerSecurity {
    ...
    public NbcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public NbcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public NbcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
