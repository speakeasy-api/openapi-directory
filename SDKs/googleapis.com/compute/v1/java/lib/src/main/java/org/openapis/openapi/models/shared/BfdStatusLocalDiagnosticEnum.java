...
/**
 * BfdStatusLocalDiagnosticEnum - The diagnostic code specifies the local system's reason for the last change in session state. This allows remote systems to determine the reason that the previous session failed, for example. These diagnostic codes are specified in section 4.1 of RFC5880
 */
public enum BfdStatusLocalDiagnosticEnum {
    ...
    private BfdStatusLocalDiagnosticEnum(String value) {
        this.value = value;
    }
}
