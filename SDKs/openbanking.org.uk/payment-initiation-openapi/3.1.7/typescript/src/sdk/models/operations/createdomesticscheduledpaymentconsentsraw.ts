...
export class CreateDomesticScheduledPaymentConsentsRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateDomesticScheduledPaymentConsentsRawRequest extends SpeakeasyBase {
  /**
...
export class CreateDomesticScheduledPaymentConsentsRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
