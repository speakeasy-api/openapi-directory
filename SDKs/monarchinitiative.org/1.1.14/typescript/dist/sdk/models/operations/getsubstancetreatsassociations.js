...
exports.GetSubstanceTreatsAssociationsResponse = exports.GetSubstanceTreatsAssociationsRequest = void 0;
...
var GetSubstanceTreatsAssociationsRequest = /** @class */ (function (_super) {
    ...
    ], GetSubstanceTreatsAssociationsRequest.prototype, "direct", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=evidence",
        }),
        __metadata("design:type", String)
    ], GetSubstanceTreatsAssociationsRequest.prototype, "evidence", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=exclude_automatic_assertions",
        }),
        __metadata("design:type", Boolean)
    ], GetSubstanceTreatsAssociationsRequest.prototype, "excludeAutomaticAssertions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=facet" }),
        __metadata("design:type", Boolean)
    ], GetSubstanceTreatsAssociationsRequest.prototype, "facet", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=facet_fields",
        }),
        __metadata("design:type", Array)
    ], GetSubstanceTreatsAssociationsRequest.prototype, "facetFields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fetch_objects",
        }),
        __metadata("design:type", Boolean)
    ], GetSubstanceTreatsAssociationsRequest.prototype, "fetchObjects", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], GetSubstanceTreatsAssociationsRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=rows" }),
        __metadata("design:type", Number)
    ], GetSubstanceTreatsAssociationsRequest.prototype, "rows", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=slim" }),
        __metadata("design:type", Array)
    ], GetSubstanceTreatsAssociationsRequest.prototype, "slim", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=start" }),
        __metadata("design:type", Number)
    ], GetSubstanceTreatsAssociationsRequest.prototype, "start", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=unselect_evidence",
        }),
        __metadata("design:type", Boolean)
    ], GetSubstanceTreatsAssociationsRequest.prototype, "unselectEvidence", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=use_compact_associations",
        }),
        __metadata("design:type", Boolean)
    ], GetSubstanceTreatsAssociationsRequest.prototype, "useCompactAssociations", void 0);
...
var GetSubstanceTreatsAssociationsResponse = /** @class */ (function (_super) {
    ...
    ], GetSubstanceTreatsAssociationsResponse.prototype, "rawResponse", void 0);
