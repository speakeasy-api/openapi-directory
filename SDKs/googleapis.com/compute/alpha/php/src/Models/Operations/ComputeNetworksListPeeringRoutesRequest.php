...
class ComputeNetworksListPeeringRoutesRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListPeeringRoutesDirectionEnum $direction
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=direction')]
    public ?ComputeNetworksListPeeringRoutesDirectionEnum $direction = null;
