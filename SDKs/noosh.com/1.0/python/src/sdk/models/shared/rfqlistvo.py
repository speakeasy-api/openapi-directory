...
import dataclasses
from ..shared import rfqsimplevo as shared_rfqsimplevo
...
class RfqListVO:
    r"""Java type: com.noosh.nooshapi.vo.RfqListVO"""
    
    result: Optional[list[shared_rfqsimplevo.RfqSimpleVO]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})  
