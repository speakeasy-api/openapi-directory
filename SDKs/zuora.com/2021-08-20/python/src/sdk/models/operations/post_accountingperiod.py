...
from ..shared import postaccountingperiodtype as shared_postaccountingperiodtype
...
class POSTAccountingPeriodRequest:
    ...
    post_accounting_period_type: shared_postaccountingperiodtype.POSTAccountingPeriodType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
