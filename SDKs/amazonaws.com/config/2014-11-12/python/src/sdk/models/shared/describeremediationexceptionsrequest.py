...
class DescribeRemediationExceptionsRequest:
    ...
    resource_keys: Optional[list[shared_remediationexceptionresourcekey.RemediationExceptionResourceKey]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ResourceKeys'), 'exclude': lambda f: f is None }})  
