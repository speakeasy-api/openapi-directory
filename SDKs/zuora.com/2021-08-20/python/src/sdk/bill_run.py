...
class BillRun:
    ...
    def object_delete_bill_run(self, request: operations.ObjectDeleteBillRunRequest) -> operations.ObjectDeleteBillRunResponse:
        r"""CRUD: Delete a bill run
        Deletes a bill run. 
        ...
        url = utils.generate_url(base_url, "/v1/object/bill-run/{id}", request.path_params)
        ...
        res = operations.ObjectDeleteBillRunResponse(status_code=r.status_code, content_type=content_type)
    ...
    def object_get_bill_run(self, request: operations.ObjectGetBillRunRequest) -> operations.ObjectGetBillRunResponse:
        r"""CRUD: Retrieve a bill run
        ...
        res = operations.ObjectGetBillRunResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyGetBillRun])
                res.proxy_get_bill_run = out
        elif r.status_code == 401:
            res.headers = r.headers
    ...
    def object_post_bill_run(self, request: operations.ObjectPostBillRunRequest) -> operations.ObjectPostBillRunResponse:
        r"""CRUD: Create a bill run
        ...
        url = base_url.removesuffix("/") + "/v1/object/bill-run"
        ...
        res = operations.ObjectPostBillRunResponse(status_code=r.status_code, content_type=content_type)
    ...
    def object_put_bill_run(self, request: operations.ObjectPutBillRunRequest) -> operations.ObjectPutBillRunResponse:
        r"""CRUD: Post or cancel a bill run
        ...
        * Canceling a bill run with a `Pending` status.
        ...
        res = operations.ObjectPutBillRunResponse(status_code=r.status_code, content_type=content_type)
    ...
    def post_email_billing_documentsfrom_bill_run(self, request: operations.PostEmailBillingDocumentsfromBillRunRequest) -> operations.PostEmailBillingDocumentsfromBillRunResponse:
        r"""Email billing documents generated from a bill run
        ...
        url = utils.generate_url(base_url, "/v1/bill-runs/{billRunId}/emails", request.path_params)
        ...
        res = operations.PostEmailBillingDocumentsfromBillRunResponse(status_code=r.status_code, content_type=content_type)
