...
public class PostPortfolioOptimizationMinimumVarianceRequestBody {
    ...
    public PostPortfolioOptimizationMinimumVarianceRequestBody(@JsonProperty("assets") Long assets, @JsonProperty("assetsCovarianceMatrix") Double[][] assetsCovarianceMatrix) {
        this.assets = assets;
        this.assetsCovarianceMatrix = assetsCovarianceMatrix;
  }
}
