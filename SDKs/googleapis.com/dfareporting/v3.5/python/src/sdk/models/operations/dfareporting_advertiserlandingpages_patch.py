...
class DfareportingAdvertiserLandingPagesPatchRequest:
    path_params: DfareportingAdvertiserLandingPagesPatchPathParams = dataclasses.field()
    query_params: DfareportingAdvertiserLandingPagesPatchQueryParams = dataclasses.field()
    security: DfareportingAdvertiserLandingPagesPatchSecurity = dataclasses.field()
