...
class AuthorizedbuyersmarketplaceBuyersProposalsAddNotePathParams:
    proposal: str = dataclasses.field(metadata={'path_param': { 'field_name': 'proposal', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class AuthorizedbuyersmarketplaceBuyersProposalsAddNoteQueryParams:
...
class AuthorizedbuyersmarketplaceBuyersProposalsAddNoteRequest:
    path_params: AuthorizedbuyersmarketplaceBuyersProposalsAddNotePathParams = dataclasses.field()
    query_params: AuthorizedbuyersmarketplaceBuyersProposalsAddNoteQueryParams = dataclasses.field()
    security: AuthorizedbuyersmarketplaceBuyersProposalsAddNoteSecurity = dataclasses.field()
