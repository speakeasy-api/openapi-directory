...
from ..shared import terminalmodelsresponse as shared_terminalmodelsresponse
from typing import Optional


@dataclasses.dataclass
class GetMerchantsMerchantIDTerminalModelsSecurity:
...
class GetMerchantsMerchantIDTerminalModelsResponse:
    ...
    terminal_models_response: Optional[shared_terminalmodelsresponse.TerminalModelsResponse] = dataclasses.field(default=None)
