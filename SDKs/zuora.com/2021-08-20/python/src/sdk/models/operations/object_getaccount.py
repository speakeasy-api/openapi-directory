...
from ..shared import proxygetaccount as shared_proxygetaccount
...
class ObjectGETAccountResponse:
    ...
    proxy_get_account: Optional[shared_proxygetaccount.ProxyGetAccount] = dataclasses.field(default=None)  
