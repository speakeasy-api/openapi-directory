...
from ..shared import listtemplatestepgroupsresponse as shared_listtemplatestepgroupsresponse
...
class ListTemplateStepGroupsResponse:
    ...
    list_template_step_groups_response: Optional[shared_listtemplatestepgroupsresponse.ListTemplateStepGroupsResponse] = dataclasses.field(default=None)
    r"""Success"""  
