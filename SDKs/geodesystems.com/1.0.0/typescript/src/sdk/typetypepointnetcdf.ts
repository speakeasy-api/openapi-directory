...
export class TypeTypePointNetcdf {
  ...
  searchTypePointNetcdf(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_point_netcdf";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypePointNetcdfResponse =
        new operations.SearchTypePointNetcdfResponse({
