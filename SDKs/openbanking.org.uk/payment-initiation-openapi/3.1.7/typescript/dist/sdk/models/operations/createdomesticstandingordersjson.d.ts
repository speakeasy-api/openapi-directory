...
export declare class CreateDomesticStandingOrdersJsonSecurity extends SpeakeasyBase {
    psuoAuth2Security: string;
}
export declare class CreateDomesticStandingOrdersJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateDomesticStandingOrdersJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
