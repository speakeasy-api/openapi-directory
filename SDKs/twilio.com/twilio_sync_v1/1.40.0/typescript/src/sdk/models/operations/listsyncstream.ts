...
export const ListSyncStreamServerList = ["https://sync.twilio.com"] as const;
...
export class ListSyncStreamListSyncStreamResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListSyncStreamListSyncStreamResponseMeta)
  meta?: ListSyncStreamListSyncStreamResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.SyncV1ServiceSyncStream })
  @Expose({ name: "streams" })
  @Type(() => shared.SyncV1ServiceSyncStream)
