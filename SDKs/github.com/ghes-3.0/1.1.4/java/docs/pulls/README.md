...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCheckIfMergedRequest req = new PullsCheckIfMergedRequest("harum", 192718L, "doloribus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateRequest req = new PullsCreateRequest(                new PullsCreateRequestBody("repudiandae", "optio") {{
                                body = "occaecati";
                                draft = false;
                                issue = 1L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReplyForReviewCommentRequest req = new PullsCreateReplyForReviewCommentRequest(                new PullsCreateReplyForReviewCommentRequestBody("officia");, 376389L, "numquam", 364912L, "quos");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReviewRequest req = new PullsCreateReviewRequest("eius", 131903L, "ducimus") {{
                requestBody = new PullsCreateReviewRequestBody() {{
                    ...
                    comments = new org.openapis.openapi.models.operations.PullsCreateReviewRequestBodyComments[]{{
                        add(new PullsCreateReviewRequestBodyComments("rem", "fugiat") {{
                            body = "laudantium";
                            line = 28L;
                            path = "incidunt";
                            position = 97493L;
                        ...
                        add(new PullsCreateReviewRequestBodyComments("consectetur", "aperiam") {{
                            body = "dicta";
                            line = 28L;
                            path = "nisi";
                            position = 159845L;
                        ...
                        add(new PullsCreateReviewRequestBodyComments("alias", "omnis") {{
                            body = "cupiditate";
                            line = 28L;
                            path = "reiciendis";
                            position = 746837L;
                    ...
                    commitId = "eos";
                    event = PullsCreateReviewRequestBodyEventEnum.REQUEST_CHANGES;
                }};;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReviewCommentRequest req = new PullsCreateReviewCommentRequest(                new PullsCreateReviewCommentRequestBody("iste") {{
                                commitId = "magni";
                                inReplyTo = 2L;
                                line = 81369L;
                                path = "fuga";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDeletePendingReviewRequest req = new PullsDeletePendingReviewRequest("maxime", 300403L, "temporibus", 549501L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDeleteReviewCommentRequest req = new PullsDeleteReviewCommentRequest(415280L, "itaque", "commodi");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDismissReviewRequest req = new PullsDismissReviewRequest(                new PullsDismissReviewRequestBody("totam") {{
                                event = ""APPROVE"";
                            }};, "earum", 267207L, "nam", 877399L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetRequest req = new PullsGetRequest("voluptatem", 371919L, "vel");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetReviewRequest req = new PullsGetReviewRequest("alias", 93894L, "non", 978548L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetReviewCommentRequest req = new PullsGetReviewCommentRequest(318233L, "sint", "nulla");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListRequest req = new PullsListRequest("deserunt", "esse") {{
                base = "nemo";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListCommentsForReviewRequest req = new PullsListCommentsForReviewRequest("hic", 900103L, "asperiores", 404306L) {{
                page = 376741L;
                perPage = 895346L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListCommitsRequest req = new PullsListCommitsRequest("delectus", 65082L, "minus") {{
                page = 685478L;
                perPage = 675689L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListFilesRequest req = new PullsListFilesRequest("consectetur", 244889L, "atque") {{
                page = 216457L;
                perPage = 773035L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListRequestedReviewersRequest req = new PullsListRequestedReviewersRequest("magni", 746585L, "repudiandae") {{
                page = 721430L;
                perPage = 294076L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewCommentsRequest req = new PullsListReviewCommentsRequest("iusto", 453094L, "sequi") {{
                direction = PullsListReviewCommentsDirectionEnum.ASC;
                page = 205566L;
                perPage = 778172L;
                since = OffsetDateTime.parse("2021-04-24T17:00:12.334Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewCommentsForRepoRequest req = new PullsListReviewCommentsForRepoRequest("odit", "voluptatibus") {{
                direction = PullsListReviewCommentsForRepoDirectionEnum.ASC;
                page = 300824L;
                perPage = 842855L;
                since = OffsetDateTime.parse("2022-03-08T10:01:41.504Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewsRequest req = new PullsListReviewsRequest("architecto", 975425L, "quia") {{
                page = 782090L;
                perPage = 304198L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsMergeRequest req = new PullsMergeRequest("velit", 75359L, "accusantium") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsRequestReviewersRequest req = new PullsRequestReviewersRequest("alias", 391797L, "itaque") {{
    ...
    public static void main(String[] args) {
        try {
            ...
            PullsSubmitReviewRequest req = new PullsSubmitReviewRequest(                new PullsSubmitReviewRequestBody(PullsSubmitReviewRequestBodyEventEnum.APPROVE) {{
                                body = "officia";
                            }};, "recusandae", 408303L, "quidem", 377406L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateRequest req = new PullsUpdateRequest("facilis", 809365L, "perspiciatis") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateBranchRequest req = new PullsUpdateBranchRequest("ullam", 600193L, "necessitatibus") {{
                requestBody = new PullsUpdateBranchRequestBody() {{
                    expectedHeadSha = "animi";
                }};;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateReviewRequest req = new PullsUpdateReviewRequest(                new PullsUpdateReviewRequestBody("impedit");, "ipsam", 357425L, "est", 621666L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateReviewCommentRequest req = new PullsUpdateReviewCommentRequest(                new PullsUpdateReviewCommentRequestBody("esse");, 288570L, "veritatis", "vero");            
