...
class ListServiceListServiceResponse:
    ...
    services: Optional[list[shared_proxy_v1_service.ProxyV1Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('services'), 'exclude': lambda f: f is None }})  
