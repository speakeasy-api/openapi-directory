...
public class Sentences {
     ...
     */
    public org.openapis.openapi.models.operations.GetSentencesResponse getSentences(org.openapis.openapi.models.operations.GetSentencesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/sentences");
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.operations.GetSentences200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetSentences200ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.GetSentencesFromBookResponse getSentencesFromBook(org.openapis.openapi.models.operations.GetSentencesFromBookRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetSentencesFromBook200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetSentencesFromBook200ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.GetSpecificSentenceResponse getSpecificSentence(org.openapis.openapi.models.operations.GetSpecificSentenceRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetSpecificSentence200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetSpecificSentence200ApplicationJSON.class);
