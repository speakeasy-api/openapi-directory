...
from ..shared import security as shared_security
from ..shared import retrievetransferparametersresponse as shared_retrievetransferparametersresponse
...
class DomainsProjectsLocationsRegistrationsRetrieveTransferParametersRequest:
    path_params: DomainsProjectsLocationsRegistrationsRetrieveTransferParametersPathParams = dataclasses.field()
    query_params: DomainsProjectsLocationsRegistrationsRetrieveTransferParametersQueryParams = dataclasses.field()
    security: DomainsProjectsLocationsRegistrationsRetrieveTransferParametersSecurity = dataclasses.field()
...
class DomainsProjectsLocationsRegistrationsRetrieveTransferParametersResponse:
    ...
    retrieve_transfer_parameters_response: Optional[shared_retrievetransferparametersresponse.RetrieveTransferParametersResponse] = dataclasses.field(default=None)
