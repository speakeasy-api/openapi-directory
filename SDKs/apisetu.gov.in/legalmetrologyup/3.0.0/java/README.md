...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DelcsRequestBody req = new DelcsRequestBody(DelcsRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new DelcsRequestBodyCertificateParameters("181527xxxxxxx7", "53453xxxxxx11");;
            ...
            DelcsResponse res = sdk.apIs.delcs(req, new DelcsSecurity("molestiae", "minus") {{
...
* [delcs](docs/apis/README.md#delcs) - Dealer License
* [malcs](docs/apis/README.md#malcs) - Manufacturer License
* [palcs](docs/apis/README.md#palcs) - Packers License
* [relcs](docs/apis/README.md#relcs) - Repairer License
