...
exports.ThirdPartyVpnPeers = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ThirdPartyVpnPeers = /** @class */ (function () {
    function ThirdPartyVpnPeers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ThirdPartyVpnPeers.prototype.getOrganizationApplianceVpnThirdPartyVpnPeers = function (req, config) {
    ...
    **/
    ThirdPartyVpnPeers.prototype.updateOrganizationApplianceVpnThirdPartyVpnPeers = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.ThirdPartyVpnPeers = ThirdPartyVpnPeers;
