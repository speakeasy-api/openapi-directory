...
export class PostServersIdActionsAddToPlacementGroupActionResponseAction extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => PostServersIdActionsAddToPlacementGroupActionResponseActionError)
  ...
  @SpeakeasyMetadata({
    elemType:
      PostServersIdActionsAddToPlacementGroupActionResponseActionResources,
  })
...
export class PostServersIdActionsAddToPlacementGroupActionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "action" })
  @Type(() => PostServersIdActionsAddToPlacementGroupActionResponseAction)
