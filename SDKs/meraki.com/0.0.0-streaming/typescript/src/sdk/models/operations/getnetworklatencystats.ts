 ...
 */
export enum GetNetworkLatencyStatsBandEnum {
  Two4 = "2.4",
  Five = "5",
}

export class GetNetworkLatencyStatsRequest extends SpeakeasyBase {
  /**
...
export class GetNetworkLatencyStatsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
