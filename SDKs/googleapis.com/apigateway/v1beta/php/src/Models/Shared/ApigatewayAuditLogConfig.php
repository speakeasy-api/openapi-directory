...
class ApigatewayAuditLogConfig
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ApigatewayAuditLogConfigLogTypeEnum $logType
     */
	#[\JMS\Serializer\Annotation\SerializedName('logType')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ApigatewayAuditLogConfigLogTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ApigatewayAuditLogConfigLogTypeEnum $logType = null;
