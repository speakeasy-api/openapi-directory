...
public class GetItemListsRequest {
    ...
    public GetItemListsRequest withAfter(OffsetDateTime after) {
        this.after = after;
        return this;
    }
    ...
    public GetItemListsRequest withAfterId(String afterId) {
    ...
    public GetItemListsRequest withBefore(String before) {
        this.before = before;
        return this;
    }
    ...
    public GetItemListsRequest withBeforeId(String beforeId) {
    ...
    public GetItemListsRequest withFrom(String from) {
        this.from = from;
        return this;
    }
    ...
    public GetItemListsRequest withFromId(String fromId) {
        this.fromId = fromId;
        return this;
    }
    ...
    public GetItemListsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetItemListsRequest withIdOnly(Boolean idOnly) {
        this.idOnly = idOnly;
        return this;
    }
    ...
    public GetItemListsRequest withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public GetItemListsRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetItemListsRequest withMetadata(String metadata) {
    ...
    public GetItemListsRequest withPopulate(String populate) {
    ...
    public GetItemListsRequest withResultsOnly(Boolean resultsOnly) {
    ...
    public GetItemListsRequest withSelect(String select) {
        this.select = select;
        return this;
    }
    ...
    public GetItemListsRequest withSha1(String sha1) {
        this.sha1 = sha1;
        return this;
    }
    ...
    public GetItemListsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetItemListsRequest withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public GetItemListsRequest withTimeCreated(String timeCreated) {
    ...
    public GetItemListsRequest withTimeUpdated(String timeUpdated) {
    ...
    public GetItemListsRequest withTimeoutS(Double timeoutS) {
    ...
    public GetItemListsRequest withTotal(Long total) {
        this.total = total;
        return this;
    }
    ...
    public GetItemListsRequest withUntil(String until) {
        this.until = until;
        return this;
    }
    ...
    public GetItemListsRequest withUntilId(String untilId) {
        this.untilId = untilId;
        return this;
    }
    
    public GetItemListsRequest(){}
}
