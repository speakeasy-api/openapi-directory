...
from ..shared import createconsumerresponse as shared_createconsumerresponse
...
class ConsumersAddSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class ConsumersAddRequest:
    
    consumer_input: shared_consumer.ConsumerInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    x_apideck_app_id: str = dataclasses.field(metadata={'header': { 'field_name': 'x-apideck-app-id', 'style': 'simple', 'explode': False }})
    r"""The ID of your Unify application"""  
    

@dataclasses.dataclass
class ConsumersAddResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    create_consumer_response: Optional[shared_createconsumerresponse.CreateConsumerResponse] = dataclasses.field(default=None)
    r"""Consumer created"""  
