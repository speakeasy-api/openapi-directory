...
class GetNetworkClientConnectionStatsBandEnum(str, Enum):
...
class GetNetworkClientConnectionStatsRequest:
    ...
    band: Optional[GetNetworkClientConnectionStatsBandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'band', 'style': 'form', 'explode': True }})
    r"""Filter results by band (either '2.4' or '5'). Note that data prior to February 2020 will not have band information."""  
...
class GetNetworkClientConnectionStatsResponse:
    ...
    get_network_client_connection_stats_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
