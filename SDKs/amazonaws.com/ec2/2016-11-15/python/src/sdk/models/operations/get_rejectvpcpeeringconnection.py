...
class GetRejectVpcPeeringConnectionQueryParams:
    action: GetRejectVpcPeeringConnectionActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetRejectVpcPeeringConnectionVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRejectVpcPeeringConnectionRequest:
    headers: GetRejectVpcPeeringConnectionHeaders = dataclasses.field()
    query_params: GetRejectVpcPeeringConnectionQueryParams = dataclasses.field()
