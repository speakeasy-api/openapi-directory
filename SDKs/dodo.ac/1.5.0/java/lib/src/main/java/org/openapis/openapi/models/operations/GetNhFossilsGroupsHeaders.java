...
public class GetNhFossilsGroupsHeaders {
    /**
    ...
    public GetNhFossilsGroupsHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhFossilsGroupsHeaders withXApiKey(String xApiKey) {
