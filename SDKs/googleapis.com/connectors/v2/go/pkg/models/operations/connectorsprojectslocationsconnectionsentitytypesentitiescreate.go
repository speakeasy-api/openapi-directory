...
type ConnectorsProjectsLocationsConnectionsEntityTypesEntitiesCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ConnectorsProjectsLocationsConnectionsEntityTypesEntitiesCreatePathParams struct {
...
type ConnectorsProjectsLocationsConnectionsEntityTypesEntitiesCreateQueryParams struct {
	// V1 error format.
...
type ConnectorsProjectsLocationsConnectionsEntityTypesEntitiesCreateResponse struct {
	ContentType string
	// Successful response
