...
class ApplicationListQueryParams:
...
class ApplicationListRequest:
    headers: ApplicationListHeaders = dataclasses.field()
    query_params: ApplicationListQueryParams = dataclasses.field()
...
class ApplicationListResponse:
    ...
    application_list_result: Optional[Any] = dataclasses.field(default=None)
