...
class DfareportingOrderDocumentsListRequest:
    ...
    r"""Select only order documents that have been approved by at least one user."""  
    ...
    r"""Select only order documents with these IDs."""  
    ...
    r"""Select only order documents for specified orders."""  
    ...
    r"""Allows searching for order documents by name or ID. Wildcards (*) are allowed. For example, \\"orderdocument*2015\\" will return order documents with names like \\"orderdocument June 2015\\", \\"orderdocument April 2015\\", or simply \\"orderdocument 2015\\". Most of the searches also add wildcards implicitly at the start and the end of the search string. For example, a search string of \\"orderdocument\\" will match order documents with name \\"my orderdocument\\", \\"orderdocument 2015\\", or simply \\"orderdocument\\"."""  
    site_id: Optional[list[str]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'siteId', 'style': 'form', 'explode': True }})
    r"""Select only order documents that are associated with these sites."""  
