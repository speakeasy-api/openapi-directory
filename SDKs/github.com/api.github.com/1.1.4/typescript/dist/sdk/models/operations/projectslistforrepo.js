...
exports.ProjectsListForRepoResponse = exports.ProjectsListForRepoRequest = exports.ProjectsListForRepoStateEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Indicates the state of the projects to return.
 */
var ProjectsListForRepoStateEnum;
...
})(ProjectsListForRepoStateEnum = exports.ProjectsListForRepoStateEnum || (exports.ProjectsListForRepoStateEnum = {}));
var ProjectsListForRepoRequest = /** @class */ (function (_super) {
    ...
    ], ProjectsListForRepoRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], ProjectsListForRepoRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], ProjectsListForRepoRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], ProjectsListForRepoRequest.prototype, "repo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=state" }),
        __metadata("design:type", String)
    ], ProjectsListForRepoRequest.prototype, "state", void 0);
    return ProjectsListForRepoRequest;
}(utils_1.SpeakeasyBase));
exports.ProjectsListForRepoRequest = ProjectsListForRepoRequest;
var ProjectsListForRepoResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ProjectsListForRepoResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.ProjectsListForRepoResponse = ProjectsListForRepoResponse;
