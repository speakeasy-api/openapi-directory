...
public class AvatarsGetInitialsSecurity {
    ...
    public AvatarsGetInitialsSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public AvatarsGetInitialsSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public AvatarsGetInitialsSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public AvatarsGetInitialsSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
