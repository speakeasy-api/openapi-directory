...
class SearchPlaceIndexForTextRequest:
    headers: SearchPlaceIndexForTextHeaders = dataclasses.field()
    path_params: SearchPlaceIndexForTextPathParams = dataclasses.field()
    request: SearchPlaceIndexForTextRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
