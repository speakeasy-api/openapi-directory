...
class Grant:
    ...
    app_level_permissions: Optional[list[GrantAppLevelPermissionsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('appLevelPermissions') }})
