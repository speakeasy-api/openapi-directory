...
from ..shared import social_friends_bungiefriendrequestlistresponse as shared_social_friends_bungiefriendrequestlistresponse
...
class SocialGetFriendRequestList200Wildcard:
    ...
    response: Optional[shared_social_friends_bungiefriendrequestlistresponse.SocialFriendsBungieFriendRequestListResponse] = dataclasses.field(default=None)  
