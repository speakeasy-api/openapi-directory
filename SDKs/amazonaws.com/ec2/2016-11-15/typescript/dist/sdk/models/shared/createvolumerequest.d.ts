 ...
 */
export declare enum CreateVolumeRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateVolumeRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateVolumeRequestTagSpecifications extends SpeakeasyBase {
