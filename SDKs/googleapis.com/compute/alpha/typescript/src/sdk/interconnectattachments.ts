...
export class InterconnectAttachments {
  ...
  computeInterconnectAttachmentsGetIamPolicy(
    req: operations.ComputeInterconnectAttachmentsGetIamPolicyRequest,
    security: operations.ComputeInterconnectAttachmentsGetIamPolicySecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeInterconnectAttachmentsGetIamPolicyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ComputeInterconnectAttachmentsGetIamPolicyRequest(
        req
      );
    }
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/projects/{project}/regions/{region}/interconnectAttachments/{resource}/getIamPolicy",
      req
    );
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ComputeInterconnectAttachmentsGetIamPolicySecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeInterconnectAttachmentsGetIamPolicyResponse =
        new operations.ComputeInterconnectAttachmentsGetIamPolicyResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  computeInterconnectAttachmentsSetIamPolicy(
    req: operations.ComputeInterconnectAttachmentsSetIamPolicyRequest,
    security: operations.ComputeInterconnectAttachmentsSetIamPolicySecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeInterconnectAttachmentsSetIamPolicyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ComputeInterconnectAttachmentsSetIamPolicyRequest(
        req
      );
    }
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/projects/{project}/regions/{region}/interconnectAttachments/{resource}/setIamPolicy",
      req
    );
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ComputeInterconnectAttachmentsSetIamPolicySecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeInterconnectAttachmentsSetIamPolicyResponse =
        new operations.ComputeInterconnectAttachmentsSetIamPolicyResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
