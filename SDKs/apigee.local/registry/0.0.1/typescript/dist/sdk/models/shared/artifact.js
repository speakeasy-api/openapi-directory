...
exports.ArtifactOutput = exports.ArtifactInput = void 0;
 ...
 * Artifacts of resources. Artifacts are unique (single-value) per resource and are used to store metadata that is too large or numerous to be stored directly on the resource. Since artifacts are stored separately from parent resources, they should generally be used for metadata that is needed infrequently, i.e. not for display in primary views of the resource but perhaps displayed or downloaded upon request. The ListArtifacts method allows artifacts to be quickly enumerated and checked for presence without downloading their (potentially-large) contents.
 */
var ArtifactOutput = /** @class */ (function (_super) {
    __extends(ArtifactOutput, _super);
    ...
    ], ArtifactOutput.prototype, "createTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "hash" }),
        __metadata("design:type", String)
    ], ArtifactOutput.prototype, "hash", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "mimeType" }),
        __metadata("design:type", String)
    ], ArtifactOutput.prototype, "mimeType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "name" }),
        __metadata("design:type", String)
    ], ArtifactOutput.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "sizeBytes" }),
        __metadata("design:type", Number)
    ], ArtifactOutput.prototype, "sizeBytes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", Date)
    ], ArtifactOutput.prototype, "updateTime", void 0);
    return ArtifactOutput;
}(utils_1.SpeakeasyBase));
exports.ArtifactOutput = ArtifactOutput;
