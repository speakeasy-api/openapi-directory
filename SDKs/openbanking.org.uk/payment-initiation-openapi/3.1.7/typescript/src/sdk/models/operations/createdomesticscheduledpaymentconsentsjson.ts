...
export class CreateDomesticScheduledPaymentConsentsJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateDomesticScheduledPaymentConsentsJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateDomesticScheduledPaymentConsentsJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
