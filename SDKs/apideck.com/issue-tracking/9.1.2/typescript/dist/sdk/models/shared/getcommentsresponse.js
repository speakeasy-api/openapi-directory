...
var collectionticketcomment_1 = require("./collectionticketcomment");
...
var GetCommentsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: collectionticketcomment_1.CollectionTicketComment }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return collectionticketcomment_1.CollectionTicketComment; }),
        __metadata("design:type", Array)
    ], GetCommentsResponse.prototype, "data", void 0);
    __decorate([
    ...
    ], GetCommentsResponse.prototype, "links", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    ], GetCommentsResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "operation" }),
        __metadata("design:type", String)
    ], GetCommentsResponse.prototype, "operation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "resource" }),
        __metadata("design:type", String)
    ], GetCommentsResponse.prototype, "resource", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "service" }),
        __metadata("design:type", String)
    ], GetCommentsResponse.prototype, "service", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "status" }),
        __metadata("design:type", String)
    ], GetCommentsResponse.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
