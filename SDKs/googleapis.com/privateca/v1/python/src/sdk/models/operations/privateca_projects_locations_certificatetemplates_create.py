...
class PrivatecaProjectsLocationsCertificateTemplatesCreateQueryParams:
    ...
    certificate_template_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'certificateTemplateId', 'style': 'form', 'explode': True }})
...
class PrivatecaProjectsLocationsCertificateTemplatesCreateRequest:
    path_params: PrivatecaProjectsLocationsCertificateTemplatesCreatePathParams = dataclasses.field()
    query_params: PrivatecaProjectsLocationsCertificateTemplatesCreateQueryParams = dataclasses.field()
    security: PrivatecaProjectsLocationsCertificateTemplatesCreateSecurity = dataclasses.field()
    request: Optional[shared_certificatetemplate.CertificateTemplateInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
