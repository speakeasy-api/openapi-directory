...
const (
	ListTagsForResourceXAmzTargetEnumStarlingDoveServiceListTagsForResource ListTagsForResourceXAmzTargetEnum = "StarlingDoveService.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "StarlingDoveService.ListTagsForResource":
