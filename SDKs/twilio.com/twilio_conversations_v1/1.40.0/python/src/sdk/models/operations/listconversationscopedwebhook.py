...
class ListConversationScopedWebhookListConversationScopedWebhookResponse:
    ...
    meta: Optional[ListConversationScopedWebhookListConversationScopedWebhookResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    webhooks: Optional[list[shared_conversations_v1_conversation_conversation_scoped_webhook.ConversationsV1ConversationConversationScopedWebhook]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('webhooks'), 'exclude': lambda f: f is None }})  
