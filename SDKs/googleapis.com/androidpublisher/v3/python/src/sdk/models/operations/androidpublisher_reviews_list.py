...
from ..shared import security as shared_security
from ..shared import reviewslistresponse as shared_reviewslistresponse
...
class AndroidpublisherReviewsListResponse:
    ...
    reviews_list_response: Optional[shared_reviewslistresponse.ReviewsListResponse] = dataclasses.field(default=None)
