 ...
 */
export enum NodeTemplateAggregatedListWarningCodeEnum {
...
export class NodeTemplateAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NodeTemplateAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NodeTemplateAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class NodeTemplateAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: NodeTemplatesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, NodeTemplatesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], NodeTemplatesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
