...
public class ActionsListWorkflowRunsForRepoRequest {
    ...
    public ActionsListWorkflowRunsForRepoRequest withCheckSuiteId(Long checkSuiteId) {
        this.checkSuiteId = checkSuiteId;
        return this;
    }
    
    /**
     * Returns workflow runs created within the given date-time range. For more information on the syntax, see "[Understanding the search syntax](https://docs.github.com/enterprise-server@3.7/search-github/getting-started-with-searching-on-github/understanding-the-search-syntax#query-for-dates)."
     */
    ...
    /**
     * Returns workflow run triggered by the event you specify. For example, `push`, `pull_request` or `issue`. For more information, see "[Events that trigger workflows](https://docs.github.com/enterprise-server@3.7/actions/automating-your-workflow-with-github-actions/events-that-trigger-workflows)."
     */
    ...
    public ActionsListWorkflowRunsForRepoRequest withHeadSha(String headSha) {
