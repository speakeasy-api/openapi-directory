...
var SyncV1Service = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reachability_debouncing_enabled" }),
        __metadata("design:type", Boolean)
    ], SyncV1Service.prototype, "reachabilityDebouncingEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reachability_debouncing_window" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=webhooks_from_rest_enabled" }),
        __metadata("design:type", Boolean)
