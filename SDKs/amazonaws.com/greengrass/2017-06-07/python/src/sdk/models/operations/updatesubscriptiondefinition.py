...
class UpdateSubscriptionDefinitionRequest:
    headers: UpdateSubscriptionDefinitionHeaders = dataclasses.field()
    path_params: UpdateSubscriptionDefinitionPathParams = dataclasses.field()
    request: UpdateSubscriptionDefinitionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateSubscriptionDefinitionResponse:
    ...
    update_subscription_definition_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
