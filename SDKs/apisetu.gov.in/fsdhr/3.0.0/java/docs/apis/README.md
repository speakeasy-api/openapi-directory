    ...
    public static void main(String[] args) {
        try {
            ...
            RatcrRequestBody req = new RatcrRequestBody(RatcrRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new RatcrRequestBodyCertificateParameters("Sunil Kumar", "06xxxxxxxxxx5");;
            ...
            RatcrResponse res = sdk.apIs.ratcr(req, new RatcrSecurity("maiores", "molestiae") {{
