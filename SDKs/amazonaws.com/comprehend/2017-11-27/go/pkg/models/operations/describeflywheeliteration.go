...
type DescribeFlywheelIterationHeaders struct {
...
type DescribeFlywheelIterationRequest struct {
	Headers DescribeFlywheelIterationHeaders
	Request shared.DescribeFlywheelIterationRequest `request:"mediaType=application/json"`
}
