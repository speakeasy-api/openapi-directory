...
**/
export class CalculateRatesResponseBodyInternationalShipmentOptions extends SpeakeasyBase {
...
**/
export class CalculateRatesResponseBodyWeight extends SpeakeasyBase {
 ...
 * 
**/
export class CalculateRatesResponseBody extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=rate_response" })
