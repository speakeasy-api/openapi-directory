...
exports.UpdatePaymentMethodStrongResponse = exports.UpdatePaymentMethodStrongRequest = exports.UpdatePaymentMethodStrongSecurity = void 0;
...
exports.UpdatePaymentMethodStrongSecurity = UpdatePaymentMethodStrongSecurity;
var UpdatePaymentMethodStrongRequest = /** @class */ (function (_super) {
    ...
    ], UpdatePaymentMethodStrongRequest.prototype, "itvUpdatePaymentStrongRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=lang" }),
        __metadata("design:type", String)
    ], UpdatePaymentMethodStrongRequest.prototype, "lang", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=platform",
        }),
        __metadata("design:type", String)
    ], UpdatePaymentMethodStrongRequest.prototype, "platform", void 0);
    return UpdatePaymentMethodStrongRequest;
}(utils_1.SpeakeasyBase));
exports.UpdatePaymentMethodStrongRequest = UpdatePaymentMethodStrongRequest;
var UpdatePaymentMethodStrongResponse = /** @class */ (function (_super) {
    ...
    ], UpdatePaymentMethodStrongResponse.prototype, "rawResponse", void 0);
    return UpdatePaymentMethodStrongResponse;
}(utils_1.SpeakeasyBase));
exports.UpdatePaymentMethodStrongResponse = UpdatePaymentMethodStrongResponse;
