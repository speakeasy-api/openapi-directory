 ...
 * @access public
 */
class UpdateShipmentResponseBody
{
    /**
     * The address validation
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\AddressValidationResult $addressValidation
     */
	#[\JMS\Serializer\Annotation\SerializedName('address_validation')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\AddressValidationResult')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyDeliveryConfirmationEnum $confirmation
     */
	#[\JMS\Serializer\Annotation\SerializedName('confirmation')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyDeliveryConfirmationEnum>')]
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyInternationalShipmentOptions $customs
     */
	#[\JMS\Serializer\Annotation\SerializedName('customs')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyInternationalShipmentOptions')]
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyInsuranceProviderEnum $insuranceProvider
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_provider')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyInsuranceProviderEnum>')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyOriginTypeEnum $originType
     */
	#[\JMS\Serializer\Annotation\SerializedName('origin_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyOriginTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateShipmentResponseBodyOriginTypeEnum $originType = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyShipmentStatusEnum $shipmentStatus
     */
	#[\JMS\Serializer\Annotation\SerializedName('shipment_status')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyShipmentStatusEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyWeight $totalWeight
     */
	#[\JMS\Serializer\Annotation\SerializedName('total_weight')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyWeight')]
	...
	{
		$this->addressValidation = new \OpenAPI\OpenAPI\Models\Shared\AddressValidationResult();
		$this->advancedOptions = new \OpenAPI\OpenAPI\Models\Shared\AdvancedShipmentOptions();
		$this->carrierId = "";
		$this->confirmation = \OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyDeliveryConfirmationEnum::NONE;
		$this->createdAt = new \DateTime();
		$this->customs = new \OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyInternationalShipmentOptions();
		$this->errors = [];
		$this->externalOrderId = null;
		$this->externalShipmentId = null;
		$this->insuranceProvider = \OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyInsuranceProviderEnum::NONE;
		$this->items = null;
		...
		$this->shipmentStatus = \OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyShipmentStatusEnum::PENDING;
		$this->tags = [];
		$this->taxIdentifiers = null;
		$this->totalWeight = new \OpenAPI\OpenAPI\Models\Shared\UpdateShipmentResponseBodyWeight();
