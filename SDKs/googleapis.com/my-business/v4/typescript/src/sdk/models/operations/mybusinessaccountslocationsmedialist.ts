...
export class MybusinessAccountsLocationsMediaListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinessAccountsLocationsMediaListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
