...
export declare class CreateDomesticPaymentsJsonSecurity extends SpeakeasyBase {
    psuoAuth2Security: string;
}
export declare class CreateDomesticPaymentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateDomesticPaymentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
