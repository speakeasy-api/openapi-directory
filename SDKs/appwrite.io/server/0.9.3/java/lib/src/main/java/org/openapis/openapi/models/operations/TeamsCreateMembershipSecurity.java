...
public class TeamsCreateMembershipSecurity {
    ...
    public TeamsCreateMembershipSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public TeamsCreateMembershipSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
