...
class IpamVrfsUpdateRequest:
    ...
    r"""A unique integer value identifying this VRF."""  
    writable_vrf_input: shared_writablevrf.WritableVRFInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
