...
exports.JobListPreparationAndReleaseTaskStatusResponse = exports.JobListPreparationAndReleaseTaskStatusRequest = void 0;
...
var JobListPreparationAndReleaseTaskStatusRequest = /** @class */ (function (_super) {
    ...
    ], JobListPreparationAndReleaseTaskStatusRequest.prototype, "dollarFilter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=$select",
        }),
        __metadata("design:type", String)
    ], JobListPreparationAndReleaseTaskStatusRequest.prototype, "dollarSelect", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=api-version",
        }),
        __metadata("design:type", String)
    ], JobListPreparationAndReleaseTaskStatusRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], JobListPreparationAndReleaseTaskStatusRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=jobId",
        }),
        __metadata("design:type", String)
    ], JobListPreparationAndReleaseTaskStatusRequest.prototype, "jobId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=maxresults",
        }),
        __metadata("design:type", Number)
    ], JobListPreparationAndReleaseTaskStatusRequest.prototype, "maxresults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], JobListPreparationAndReleaseTaskStatusRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], JobListPreparationAndReleaseTaskStatusRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], JobListPreparationAndReleaseTaskStatusRequest.prototype, "timeout", void 0);
...
var JobListPreparationAndReleaseTaskStatusResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.CloudJobListPreparationAndReleaseTaskStatusResult)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], JobListPreparationAndReleaseTaskStatusResponse.prototype, "rawResponse", void 0);
