...
class MembershipFeatureSpec:
    ...
    cloudbuild: Optional[shared_cloudbuildmembershipspec.CloudBuildMembershipSpec] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cloudbuild'), 'exclude': lambda f: f is None }})
    ...
    workloadcertificate: Optional[shared_membershipspec.MembershipSpec] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('workloadcertificate'), 'exclude': lambda f: f is None }})
