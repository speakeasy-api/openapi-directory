...
exports.ChildWorkflowExecutionFailedEventAttributes = void 0;
...
**/
var ChildWorkflowExecutionFailedEventAttributes = /** @class */ (function (_super) {
    __extends(ChildWorkflowExecutionFailedEventAttributes, _super);
    ...
    ], ChildWorkflowExecutionFailedEventAttributes.prototype, "details", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=initiatedEventId" }),
        __metadata("design:type", Number)
    ], ChildWorkflowExecutionFailedEventAttributes.prototype, "initiatedEventId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reason" }),
        __metadata("design:type", String)
    ], ChildWorkflowExecutionFailedEventAttributes.prototype, "reason", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startedEventId" }),
        __metadata("design:type", Number)
    ], ChildWorkflowExecutionFailedEventAttributes.prototype, "startedEventId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=workflowExecution" }),
        __metadata("design:type", workflowexecution_1.WorkflowExecution)
    ], ChildWorkflowExecutionFailedEventAttributes.prototype, "workflowExecution", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=workflowType" }),
        __metadata("design:type", workflowtype_1.WorkflowType)
    ], ChildWorkflowExecutionFailedEventAttributes.prototype, "workflowType", void 0);
