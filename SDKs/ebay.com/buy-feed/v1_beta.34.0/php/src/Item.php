...
class Item 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetItemFeedRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\GetItemFeedSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\GetItemFeedResponse
     */
	public function getItemFeed(
        \OpenAPI\OpenAPI\Models\Operations\GetItemFeedRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\GetItemFeedSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\GetItemFeedResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/item');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\GetItemFeedRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetItemFeedResponse();
        ...
        if ($httpResponse->getStatusCode() === 200 or $httpResponse->getStatusCode() === 206) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->itemResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ItemResponse', 'json');
            }
