...
public class AndroidpublisherEditsApklistingsGetPathParams {
    /**
    ...
    public AndroidpublisherEditsApklistingsGetPathParams withApkVersionCode(Long apkVersionCode) {
    ...
    public AndroidpublisherEditsApklistingsGetPathParams withEditId(String editId) {
        this.editId = editId;
        return this;
    }
    ...
    public AndroidpublisherEditsApklistingsGetPathParams withLanguage(String language) {
    ...
    public AndroidpublisherEditsApklistingsGetPathParams withPackageName(String packageName) {
