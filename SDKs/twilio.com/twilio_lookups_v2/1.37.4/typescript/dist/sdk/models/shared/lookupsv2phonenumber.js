...
var LookupsV2PhoneNumber = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=call_forwarding" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=calling_country_code" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=identity_match" }),
        __metadata("design:type", Object)
    ], LookupsV2PhoneNumber.prototype, "identityMatch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=line_type_intelligence" }),
        __metadata("design:type", Object)
    ], LookupsV2PhoneNumber.prototype, "lineTypeIntelligence", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=live_activity" }),
        __metadata("design:type", Object)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sim_swap" }),
        __metadata("design:type", Object)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=validation_errors" }),
