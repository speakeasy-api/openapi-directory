...
public class GetItemFeedQueryParams {
    /**
    ...
    public GetItemFeedQueryParams withCategoryId(String categoryId) {
    ...
    public String date;
    public GetItemFeedQueryParams withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public GetItemFeedQueryParams withFeedScope(String feedScope) {
