 ...
 */
export enum MetalsSpotRatioHistoryGETFormatEnum {
  Json = "json",
  Xml = "xml",
}

export class MetalsSpotRatioHistoryGETRequest extends SpeakeasyBase {
  /**
...
export class MetalsSpotRatioHistoryGETResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
