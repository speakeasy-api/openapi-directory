...
exports.ListMemberResponse = exports.ListMemberListMemberResponse = exports.ListMemberListMemberResponseMeta = exports.ListMemberRequest = exports.ListMemberSecurity = exports.ListMemberServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListMemberServerList = ["https://chat.twilio.com"];
var ListMemberSecurity = /** @class */ (function (_super) {
    ...
    ], ListMemberSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListMemberSecurity.prototype, "username", void 0);
...
var ListMemberRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListMemberRequest.prototype, "channelSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Identity",
        }),
        __metadata("design:type", Array)
    ], ListMemberRequest.prototype, "identity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListMemberRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListMemberRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListMemberRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListMemberRequest.prototype, "serviceSid", void 0);
...
var ListMemberListMemberResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ChatV1ServiceChannelMember }),
        (0, class_transformer_1.Expose)({ name: "members" }),
        (0, class_transformer_1.Type)(function () { return shared.ChatV1ServiceChannelMember; }),
        __metadata("design:type", Array)
    ], ListMemberListMemberResponse.prototype, "members", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListMemberListMemberResponseMeta; }),
...
var ListMemberResponse = /** @class */ (function (_super) {
    ...
    ], ListMemberResponse.prototype, "rawResponse", void 0);
