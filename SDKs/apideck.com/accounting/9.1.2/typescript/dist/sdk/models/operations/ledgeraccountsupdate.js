...
exports.LedgerAccountsUpdateResponse = exports.LedgerAccountsUpdateRequest = exports.LedgerAccountsUpdateSecurity = void 0;
...
exports.LedgerAccountsUpdateSecurity = LedgerAccountsUpdateSecurity;
var LedgerAccountsUpdateRequest = /** @class */ (function (_super) {
    ...
    ], LedgerAccountsUpdateRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], LedgerAccountsUpdateRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], LedgerAccountsUpdateRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], LedgerAccountsUpdateRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], LedgerAccountsUpdateRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], LedgerAccountsUpdateRequest.prototype, "xApideckServiceId", void 0);
    return LedgerAccountsUpdateRequest;
}(utils_1.SpeakeasyBase));
exports.LedgerAccountsUpdateRequest = LedgerAccountsUpdateRequest;
var LedgerAccountsUpdateResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], LedgerAccountsUpdateResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.LedgerAccountsUpdateResponse = LedgerAccountsUpdateResponse;
