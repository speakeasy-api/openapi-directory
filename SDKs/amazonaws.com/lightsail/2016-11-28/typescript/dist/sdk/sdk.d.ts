...
export declare class SDK {
     ...
     */
    createGUISessionAccessDetails(req: operations.CreateGUISessionAccessDetailsRequest, config?: AxiosRequestConfig): Promise<operations.CreateGUISessionAccessDetailsResponse>;
    /**
     ...
     */
    getCostEstimate(req: operations.GetCostEstimateRequest, config?: AxiosRequestConfig): Promise<operations.GetCostEstimateResponse>;
    /**
     ...
     */
    getLoadBalancerTlsPolicies(req: operations.GetLoadBalancerTlsPoliciesRequest, config?: AxiosRequestConfig): Promise<operations.GetLoadBalancerTlsPoliciesResponse>;
    /**
     ...
     */
    startGUISession(req: operations.StartGUISessionRequest, config?: AxiosRequestConfig): Promise<operations.StartGUISessionResponse>;
    /**
     ...
     */
    stopGUISession(req: operations.StopGUISessionRequest, config?: AxiosRequestConfig): Promise<operations.StopGUISessionResponse>;
    /**
     ...
     */
    updateInstanceMetadataOptions(req: operations.UpdateInstanceMetadataOptionsRequest, config?: AxiosRequestConfig): Promise<operations.UpdateInstanceMetadataOptionsResponse>;
    /**
