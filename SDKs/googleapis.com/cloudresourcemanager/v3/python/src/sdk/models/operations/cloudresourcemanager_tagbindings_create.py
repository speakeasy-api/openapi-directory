...
class CloudresourcemanagerTagBindingsCreateRequest:
    query_params: CloudresourcemanagerTagBindingsCreateQueryParams = dataclasses.field()
    security: CloudresourcemanagerTagBindingsCreateSecurity = dataclasses.field()
    request: Optional[shared_tagbinding.TagBindingInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
