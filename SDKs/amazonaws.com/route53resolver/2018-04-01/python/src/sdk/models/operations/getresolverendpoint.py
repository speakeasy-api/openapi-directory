...
class GetResolverEndpointRequest:
    ...
    get_resolver_endpoint_request: shared_getresolverendpointrequest.GetResolverEndpointRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
