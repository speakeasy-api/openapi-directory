...
exports.GetSampleDataResponse = exports.GetSampleDataRequest = exports.GetSampleDataRequestBody = exports.GetSampleDataRequestBodyS3SourceConfig = void 0;
...
var GetSampleDataRequestBodyS3SourceConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "FileFormatDescriptor" }),
        (0, class_transformer_1.Type)(function () { return shared.FileFormatDescriptor; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "HistoricalDataPathList" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TemplatedPathList" }),
        __metadata("design:type", Array)
...
exports.GetSampleDataRequestBodyS3SourceConfig = GetSampleDataRequestBodyS3SourceConfig;
var GetSampleDataRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return GetSampleDataRequestBodyS3SourceConfig; }),
...
exports.GetSampleDataRequestBody = GetSampleDataRequestBody;
var GetSampleDataRequest = /** @class */ (function (_super) {
    ...
    ], GetSampleDataRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], GetSampleDataRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], GetSampleDataRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], GetSampleDataRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], GetSampleDataRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], GetSampleDataRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], GetSampleDataRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], GetSampleDataRequest.prototype, "xAmzSignedHeaders", void 0);
    return GetSampleDataRequest;
}(utils_1.SpeakeasyBase));
exports.GetSampleDataRequest = GetSampleDataRequest;
var GetSampleDataResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetSampleDataResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.GetSampleDataResponse = GetSampleDataResponse;
