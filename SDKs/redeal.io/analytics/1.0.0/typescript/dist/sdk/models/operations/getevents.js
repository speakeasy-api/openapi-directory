...
exports.GetEventsResponse = exports.GetEventsRequest = exports.GetEventsTypeEnum = void 0;
...
var GetEventsRequest = /** @class */ (function (_super) {
    ...
    ], GetEventsRequest.prototype, "company", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=deal" }),
        __metadata("design:type", String)
    ], GetEventsRequest.prototype, "deal", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=nexttoken",
        }),
        __metadata("design:type", String)
    ], GetEventsRequest.prototype, "nexttoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=queryexecutionid",
        }),
        __metadata("design:type", String)
    ], GetEventsRequest.prototype, "queryexecutionid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=site" }),
        __metadata("design:type", String)
    ], GetEventsRequest.prototype, "site", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=type" }),
        __metadata("design:type", String)
    ], GetEventsRequest.prototype, "type", void 0);
