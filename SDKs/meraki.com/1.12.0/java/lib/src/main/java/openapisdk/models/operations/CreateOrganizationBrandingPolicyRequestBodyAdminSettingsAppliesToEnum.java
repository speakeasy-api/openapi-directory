...
public enum CreateOrganizationBrandingPolicyRequestBodyAdminSettingsAppliesToEnum {
    ...
    private CreateOrganizationBrandingPolicyRequestBodyAdminSettingsAppliesToEnum(String value) {
        this.value = value;
    }
}
