...
type GETGETVpnConnectionDeviceTypesQueryParams struct {
...
type GETGETVpnConnectionDeviceTypesHeaders struct {
...
type GETGETVpnConnectionDeviceTypesRequest struct {
	QueryParams GETGETVpnConnectionDeviceTypesQueryParams
	Headers     GETGETVpnConnectionDeviceTypesHeaders
}
