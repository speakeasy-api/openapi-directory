...
export class GetCallBroadcastCallsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetCallBroadcastCallsRequest extends SpeakeasyBase {
  /**
...
export class GetCallBroadcastCallsResponse extends SpeakeasyBase {
  /**
