...
public class Buckets {
    ...
    **/
    public openapisdk.models.operations.StorageBucketsGetIamPolicyResponse storageBucketsGetIamPolicy(openapisdk.models.operations.StorageBucketsGetIamPolicyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/b/{bucket}/iam", request.pathParams);
        ...
        openapisdk.models.operations.StorageBucketsGetIamPolicyResponse res = new openapisdk.models.operations.StorageBucketsGetIamPolicyResponse() {{
            policy = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.StorageBucketsLockRetentionPolicyResponse storageBucketsLockRetentionPolicy(openapisdk.models.operations.StorageBucketsLockRetentionPolicyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/b/{bucket}/lockRetentionPolicy", request.pathParams);
        ...
        openapisdk.models.operations.StorageBucketsLockRetentionPolicyResponse res = new openapisdk.models.operations.StorageBucketsLockRetentionPolicyResponse() {{
            bucket = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.StorageBucketsSetIamPolicyResponse storageBucketsSetIamPolicy(openapisdk.models.operations.StorageBucketsSetIamPolicyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/b/{bucket}/iam", request.pathParams);
        ...
        openapisdk.models.operations.StorageBucketsSetIamPolicyResponse res = new openapisdk.models.operations.StorageBucketsSetIamPolicyResponse() {{
            policy = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.StorageBucketsTestIamPermissionsResponse storageBucketsTestIamPermissions(openapisdk.models.operations.StorageBucketsTestIamPermissionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/b/{bucket}/iam/testPermissions", request.pathParams);
        ...
        openapisdk.models.operations.StorageBucketsTestIamPermissionsResponse res = new openapisdk.models.operations.StorageBucketsTestIamPermissionsResponse() {{
