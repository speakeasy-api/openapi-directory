 ...
 */
export const ServerList = ["https://ip-messaging.twilio.com"] as const;
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV2ServiceChannel = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV2ServiceChannel
            );
          }
          break;
      }
  ...
  createChannelWebhook(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV2ServiceChannelChannelWebhook = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV2ServiceChannelChannelWebhook
            );
          }
          break;
      }
  ...
  createCredential(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV2Credential = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV2Credential
            );
          }
          break;
      }
  ...
  createInvite(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV2ServiceChannelInvite = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV2ServiceChannelInvite
            );
          }
          break;
      }
  ...
  createMember(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV2ServiceChannelMember = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV2ServiceChannelMember
            );
          }
          break;
      }
  ...
  createMessage(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV2ServiceChannelMessage = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV2ServiceChannelMessage
            );
          }
          break;
      }
  ...
  createRole(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV2ServiceRole = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV2ServiceRole
            );
          }
          break;
      }
  ...
  createService(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV2Service = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV2Service
            );
          }
          break;
      }
  ...
  createUser(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV2ServiceUser = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV2ServiceUser
            );
          }
          break;
      }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV2ServiceBinding = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV2ServiceBinding
            );
          }
          break;
      }
  ...
  fetchUserBinding(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV2ServiceUserUserBinding = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV2ServiceUserUserBinding
            );
          }
          break;
      }
  ...
  fetchUserChannel(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV2ServiceUserUserChannel = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV2ServiceUserUserChannel
            );
          }
          break;
      }
