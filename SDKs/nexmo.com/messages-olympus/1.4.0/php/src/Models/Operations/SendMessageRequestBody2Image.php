...
class SendMessageRequestBody2Image
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2ImageChannelEnum $channel
     */
	#[\JMS\Serializer\Annotation\SerializedName('channel')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2ImageChannelEnum>')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2ImageImage')]
    public SendMessageRequestBody2ImageImage $image;
    
    /**
     * The type of message to send. You must provide `image` in this field
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2ImageMessageTypeEnum $messageType
     */
	#[\JMS\Serializer\Annotation\SerializedName('message_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2ImageMessageTypeEnum>')]
	...
	{
		$this->channel = \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2ImageChannelEnum::MMS;
		$this->clientRef = null;
		$this->from = "";
		$this->image = new \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2ImageImage();
		$this->messageType = \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2ImageMessageTypeEnum::IMAGE;
		$this->to = "";
	}
}
