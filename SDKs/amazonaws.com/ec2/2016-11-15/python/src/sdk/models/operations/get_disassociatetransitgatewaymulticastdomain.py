...
class GETDisassociateTransitGatewayMulticastDomainRequest:
    ...
    action: GETDisassociateTransitGatewayMulticastDomainActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    ...
    version: GETDisassociateTransitGatewayMulticastDomainVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
