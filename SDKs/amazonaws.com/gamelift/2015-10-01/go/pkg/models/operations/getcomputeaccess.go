...
func (e *GetComputeAccessXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "GameLift.GetComputeAccess":
		*e = GetComputeAccessXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetComputeAccessXAmzTargetEnum: %s", s)
	}
}

type GetComputeAccessHeaders struct {
...
type GetComputeAccessRequest struct {
	Headers GetComputeAccessHeaders
	Request shared.GetComputeAccessInput `request:"mediaType=application/json"`
}
