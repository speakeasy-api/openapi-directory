 ...
 */
export class PreprintsReadPreprintAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class PreprintsReadPreprintLinks extends SpeakeasyBase {
  /**
 ...
 */
export class PreprintsReadPreprintRelationships extends SpeakeasyBase {
  /**
 ...
 * OK
 */
export class PreprintsReadPreprint extends SpeakeasyBase {
  /**
   * The properties of the preprint entity.
   */
  @SpeakeasyMetadata()
