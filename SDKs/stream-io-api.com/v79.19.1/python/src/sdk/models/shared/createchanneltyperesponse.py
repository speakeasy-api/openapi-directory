...
class CreateChannelTypeResponseAutomodEnum(str, Enum):
    DISABLED = 'disabled'
    SIMPLE = 'simple'
    AI = 'AI'

class CreateChannelTypeResponseAutomodBehaviorEnum(str, Enum):
    FLAG = 'flag'
    BLOCK = 'block'

class CreateChannelTypeResponseBlocklistBehaviorEnum(str, Enum):
    FLAG = 'flag'
    BLOCK = 'block'
...
class CreateChannelTypeResponse:
    ...
    automod: CreateChannelTypeResponseAutomodEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('automod') }})  
    automod_behavior: CreateChannelTypeResponseAutomodBehaviorEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('automod_behavior') }})  
    ...
    blocklist_behavior: Optional[CreateChannelTypeResponseBlocklistBehaviorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('blocklist_behavior'), 'exclude': lambda f: f is None }})  
