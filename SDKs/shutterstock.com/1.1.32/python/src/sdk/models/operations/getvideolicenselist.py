...
class GetVideoLicenseListDownloadAvailabilityEnum(str, Enum):
...
class GetVideoLicenseListRequest:
    ...
    download_availability: Optional[GetVideoLicenseListDownloadAvailabilityEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'download_availability', 'style': 'form', 'explode': True }})
    r"""Filter licenses by download availability"""  
    ...
    r"""Show videos that are available with the specified license, such as `standard` or `enhanced`; prepending a `-` sign excludes results from that license"""  
    ...
    r"""Show licenses for the specified video ID"""  
