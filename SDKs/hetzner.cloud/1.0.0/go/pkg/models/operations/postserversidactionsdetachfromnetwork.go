...
func (e PostServersIDActionsDetachFromNetworkActionResponseActionStatusEnum) ToPointer() *PostServersIDActionsDetachFromNetworkActionResponseActionStatusEnum {
	return &e
}

func (e *PostServersIDActionsDetachFromNetworkActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsDetachFromNetworkActionResponseActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsDetachFromNetworkActionResponseActionStatusEnum: %v", v)
	}
}
