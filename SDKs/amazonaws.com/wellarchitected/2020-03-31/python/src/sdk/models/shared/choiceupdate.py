...
class ChoiceUpdate:
    r"""A list of choices to be updated."""
    
    status: shared_choicestatus_enum.ChoiceStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Status') }})  
