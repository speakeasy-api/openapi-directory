...
from ..shared import consents as shared_consents
...
from ..shared import consentsresponse_201 as shared_consentsresponse_201
...
class CreateConsentRequest:
    headers: CreateConsentHeaders = dataclasses.field()
    security: CreateConsentSecurity = dataclasses.field()
    request: Optional[shared_consents.Consents] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class CreateConsentResponse:
    ...
    consents_response_201: Optional[shared_consentsresponse_201.ConsentsResponse201] = dataclasses.field(default=None)
