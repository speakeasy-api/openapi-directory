...
export class DeleteStreamingDistribution20181105Request extends SpeakeasyBase {
  /**
   * The distribution ID.
   */
...
export class DeleteStreamingDistribution20181105Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
