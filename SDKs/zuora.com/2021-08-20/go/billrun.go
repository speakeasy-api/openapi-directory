...
func NewBillRun(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *BillRun {
	return &BillRun{
...
func (s *BillRun) ObjectDeleteBillRun(ctx context.Context, request operations.ObjectDeleteBillRunRequest) (*operations.ObjectDeleteBillRunResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/object/bill-run/{id}", request.PathParams)
	...
	res := &operations.ObjectDeleteBillRunResponse{
...
func (s *BillRun) ObjectGetBillRun(ctx context.Context, request operations.ObjectGetBillRunRequest) (*operations.ObjectGetBillRunResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/object/bill-run/{id}", request.PathParams)
	...
	res := &operations.ObjectGetBillRunResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json; charset=utf-8`):
			var out *shared.ProxyGetBillRun
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *BillRun) ObjectPostBillRun(ctx context.Context, request operations.ObjectPostBillRunRequest) (*operations.ObjectPostBillRunResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v1/object/bill-run"
	...
	res := &operations.ObjectPostBillRunResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *BillRun) ObjectPutBillRun(ctx context.Context, request operations.ObjectPutBillRunRequest) (*operations.ObjectPutBillRunResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/object/bill-run/{id}", request.PathParams)
	...
	res := &operations.ObjectPutBillRunResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *BillRun) PostEmailBillingDocumentsfromBillRun(ctx context.Context, request operations.PostEmailBillingDocumentsfromBillRunRequest) (*operations.PostEmailBillingDocumentsfromBillRunResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/bill-runs/{billRunId}/emails", request.PathParams)
	...
	res := &operations.PostEmailBillingDocumentsfromBillRunResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
