...
func (e RestoreServiceRequestRestoreTypeEnum) ToPointer() *RestoreServiceRequestRestoreTypeEnum {
	return &e
}
...
func (e *RestoreServiceRequestRestoreTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "FULL":
		fallthrough
	case "METADATA_ONLY":
		*e = RestoreServiceRequestRestoreTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RestoreServiceRequestRestoreTypeEnum: %v", v)
	}
}
