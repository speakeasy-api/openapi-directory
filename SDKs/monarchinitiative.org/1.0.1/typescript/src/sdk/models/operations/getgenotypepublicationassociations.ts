...
export class GetGenotypePublicationAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGenotypePublicationAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGenotypePublicationAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGenotypePublicationAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
