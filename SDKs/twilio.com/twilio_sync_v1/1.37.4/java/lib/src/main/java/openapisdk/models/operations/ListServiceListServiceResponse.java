...
public class ListServiceListServiceResponse {
    ...
    public openapisdk.models.shared.SyncV1Service[] services;
    public ListServiceListServiceResponse withServices(openapisdk.models.shared.SyncV1Service[] services) {
