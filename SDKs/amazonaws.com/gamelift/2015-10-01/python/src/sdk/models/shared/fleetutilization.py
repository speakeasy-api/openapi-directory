...
class FleetUtilization:
    ...
    active_game_session_count: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ActiveGameSessionCount') }})
    active_server_process_count: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ActiveServerProcessCount') }})
