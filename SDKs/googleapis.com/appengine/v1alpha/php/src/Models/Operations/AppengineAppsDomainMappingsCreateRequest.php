...
class AppengineAppsDomainMappingsCreateRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\AppengineAppsDomainMappingsCreateOverrideStrategyEnum $overrideStrategy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=overrideStrategy')]
    public ?AppengineAppsDomainMappingsCreateOverrideStrategyEnum $overrideStrategy = null;
