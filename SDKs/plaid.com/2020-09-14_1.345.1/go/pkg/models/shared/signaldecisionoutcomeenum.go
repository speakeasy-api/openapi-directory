...
func (e SignalDecisionOutcomeEnum) ToPointer() *SignalDecisionOutcomeEnum {
	return &e
}
...
func (e *SignalDecisionOutcomeEnum) UnmarshalJSON(data []byte) error {
	...
	case "TAKE_OTHER_RISK_MEASURES":
		fallthrough
	case "NOT_EVALUATED":
		*e = SignalDecisionOutcomeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SignalDecisionOutcomeEnum: %v", v)
	}
}
