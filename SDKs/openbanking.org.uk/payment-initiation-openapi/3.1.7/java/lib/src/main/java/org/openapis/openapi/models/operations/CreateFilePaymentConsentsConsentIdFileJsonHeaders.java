...
public class CreateFilePaymentConsentsConsentIdFileJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateFilePaymentConsentsConsentIdFileJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateFilePaymentConsentsConsentIdFileJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateFilePaymentConsentsConsentIdFileJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateFilePaymentConsentsConsentIdFileJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateFilePaymentConsentsConsentIdFileJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateFilePaymentConsentsConsentIdFileJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateFilePaymentConsentsConsentIdFileJsonHeaders withXJwsSignature(String xJwsSignature) {
