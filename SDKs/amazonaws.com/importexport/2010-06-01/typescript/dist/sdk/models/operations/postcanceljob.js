...
exports.POSTCancelJobResponse = exports.POSTCancelJobRequest = exports.POSTCancelJobVersionEnum = exports.POSTCancelJobOperationEnum = exports.POSTCancelJobActionEnum = void 0;
...
var POSTCancelJobRequest = /** @class */ (function (_super) {
    ...
    ], POSTCancelJobRequest.prototype, "awsAccessKeyId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Action",
        }),
        __metadata("design:type", String)
    ], POSTCancelJobRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Operation",
        }),
        __metadata("design:type", String)
    ], POSTCancelJobRequest.prototype, "operation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=text/xml" }),
        __metadata("design:type", Uint8Array)
    ], POSTCancelJobRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Signature",
        }),
        __metadata("design:type", String)
    ], POSTCancelJobRequest.prototype, "signature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SignatureMethod",
        }),
        __metadata("design:type", String)
    ], POSTCancelJobRequest.prototype, "signatureMethod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SignatureVersion",
        }),
        __metadata("design:type", String)
    ], POSTCancelJobRequest.prototype, "signatureVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Timestamp",
        }),
        __metadata("design:type", String)
    ], POSTCancelJobRequest.prototype, "timestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], POSTCancelJobRequest.prototype, "version", void 0);
...
var POSTCancelJobResponse = /** @class */ (function (_super) {
    ...
    ], POSTCancelJobResponse.prototype, "rawResponse", void 0);
