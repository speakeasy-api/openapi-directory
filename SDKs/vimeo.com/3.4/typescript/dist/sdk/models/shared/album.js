...
var AlbumPicture = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sizes", elemType: AlbumPictureSizes }),
...
var AlbumMetadataInteractions = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=add_custom_thumbnails" }),
...
var Album = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=allow_continuous_play" }),
        __metadata("design:type", Boolean)
    ], Album.prototype, "allowContinuousPlay", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=allow_downloads" }),
        __metadata("design:type", Boolean)
    ], Album.prototype, "allowDownloads", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=allow_share" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=custom_logo" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=embed_brand_color" }),
        __metadata("design:type", Boolean)
    ], Album.prototype, "embedBrandColor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=embed_custom_logo" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=hide_vimeo_logo" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=web_brand_color" }),
        __metadata("design:type", Boolean)
    ], Album.prototype, "webBrandColor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=web_custom_logo" }),
        __metadata("design:type", Boolean)
