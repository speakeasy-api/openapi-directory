...
class ScriptProjectsDeploymentsCreateRequest:
    ...
    r"""JSONP"""  
    deployment_config: Optional[shared_deploymentconfig.DeploymentConfig] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class ScriptProjectsDeploymentsCreateResponse:
