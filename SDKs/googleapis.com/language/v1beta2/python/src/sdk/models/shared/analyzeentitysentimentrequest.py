...
class AnalyzeEntitySentimentRequest:
    ...
    encoding_type: Optional[AnalyzeEntitySentimentRequestEncodingTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('encodingType'), 'exclude': lambda f: f is None }})
    r"""The encoding type used by the API to calculate offsets."""  
