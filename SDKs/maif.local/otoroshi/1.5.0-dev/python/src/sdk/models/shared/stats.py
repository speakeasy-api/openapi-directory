...
class Stats:
    ...
    concurrent_handled_requests: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('concurrentHandledRequests') }})
    data_in: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('dataIn') }})
    data_in_rate: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('dataInRate') }})
    data_out: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('dataOut') }})
    data_out_rate: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('dataOutRate') }})
    duration: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('duration') }})
    overhead: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('overhead') }})
