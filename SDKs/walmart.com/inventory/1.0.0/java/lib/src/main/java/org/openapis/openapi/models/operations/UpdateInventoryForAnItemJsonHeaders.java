...
public class UpdateInventoryForAnItemJsonHeaders {
    /**
    ...
    public UpdateInventoryForAnItemJsonHeaders withWmConsumerChannelType(String wmConsumerChannelType) {
    ...
    public UpdateInventoryForAnItemJsonHeaders withWmQosCorrelationId(String wmQosCorrelationId) {
    ...
    public UpdateInventoryForAnItemJsonHeaders withWmSecAccessToken(String wmSecAccessToken) {
    ...
    public UpdateInventoryForAnItemJsonHeaders withWmSvcName(String wmSvcName) {
