...
public class SandboxItemSetVerificationStatusRequest {
    ...
    public SandboxItemSetVerificationStatusRequest(@JsonProperty("access_token") String accessToken, @JsonProperty("account_id") String accountId, @JsonProperty("verification_status") SandboxItemSetVerificationStatusRequestVerificationStatusEnum verificationStatus) {
        this.accessToken = accessToken;
        this.accountId = accountId;
        this.verificationStatus = verificationStatus;
  }
