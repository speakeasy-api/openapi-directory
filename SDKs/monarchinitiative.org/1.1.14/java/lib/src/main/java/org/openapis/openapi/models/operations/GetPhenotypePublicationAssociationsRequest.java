...
public class GetPhenotypePublicationAssociationsRequest {
    ...
    public GetPhenotypePublicationAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPhenotypePublicationAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPhenotypePublicationAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPhenotypePublicationAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPhenotypePublicationAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPhenotypePublicationAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsRequest withRelation(String relation) {
    ...
    public GetPhenotypePublicationAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPhenotypePublicationAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPhenotypePublicationAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
