...
class AnalyticsManagementClientIDHashClientIDRequest:
    ...
    hash_client_id_request: Optional[shared_hashclientidrequest.HashClientIDRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
