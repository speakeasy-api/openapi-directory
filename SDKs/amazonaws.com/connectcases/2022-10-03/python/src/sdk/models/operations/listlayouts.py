...
from ..shared import listlayoutsresponse as shared_listlayoutsresponse
...
class ListLayoutsResponse:
    ...
    list_layouts_response: Optional[shared_listlayoutsresponse.ListLayoutsResponse] = dataclasses.field(default=None)
    r"""Success"""  
