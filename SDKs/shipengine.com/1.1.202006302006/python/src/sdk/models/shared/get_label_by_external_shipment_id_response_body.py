...
class GetLabelByExternalShipmentIDResponseBodyOptionalLink:
    r"""GetLabelByExternalShipmentIDResponseBodyOptionalLink
...
@dataclass_json
@dataclasses.dataclass
class GetLabelByExternalShipmentIDResponseBodyMonetaryValue:
    r"""GetLabelByExternalShipmentIDResponseBodyMonetaryValue
...
@dataclass_json
@dataclasses.dataclass
class GetLabelByExternalShipmentIDResponseBodyLabelDownload:
    r"""GetLabelByExternalShipmentIDResponseBodyLabelDownload
...
class GetLabelByExternalShipmentIDResponseBodyOutput:
    r"""GetLabelByExternalShipmentIDResponseBodyOutput
    ...
    form_download: Optional[GetLabelByExternalShipmentIDResponseBodyOptionalLink] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('form_download') }})
    insurance_claim: Optional[GetLabelByExternalShipmentIDResponseBodyOptionalLink] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('insurance_claim') }})
    insurance_cost: Optional[GetLabelByExternalShipmentIDResponseBodyMonetaryValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('insurance_cost') }})
    ...
    label_download: Optional[GetLabelByExternalShipmentIDResponseBodyLabelDownload] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('label_download') }})
    ...
    shipment_cost: Optional[GetLabelByExternalShipmentIDResponseBodyMonetaryValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('shipment_cost') }})
