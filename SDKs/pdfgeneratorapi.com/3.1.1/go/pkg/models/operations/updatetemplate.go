...
func (e *UpdateTemplate422ApplicationJSONErrorEnum) UnmarshalJSON(data []byte) error {
	...
	case "Required parameter missing: template not defined":
		*e = UpdateTemplate422ApplicationJSONErrorEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateTemplate422ApplicationJSONErrorEnum: %s", s)
	}
}
...
func (e *UpdateTemplate404ApplicationJSONErrorEnum) UnmarshalJSON(data []byte) error {
	...
	case "None of the templates is available for the workspace.":
		*e = UpdateTemplate404ApplicationJSONErrorEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateTemplate404ApplicationJSONErrorEnum: %s", s)
	}
}
...
func (e *UpdateTemplate403ApplicationJSONErrorEnum) UnmarshalJSON(data []byte) error {
	...
	case "Your account has exceeded the monthly document generation limit.":
		*e = UpdateTemplate403ApplicationJSONErrorEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateTemplate403ApplicationJSONErrorEnum: %s", s)
	}
}
...
func (e *UpdateTemplate401ApplicationJSONErrorEnum) UnmarshalJSON(data []byte) error {
	...
	case "Authentication failed":
		*e = UpdateTemplate401ApplicationJSONErrorEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateTemplate401ApplicationJSONErrorEnum: %s", s)
	}
}
