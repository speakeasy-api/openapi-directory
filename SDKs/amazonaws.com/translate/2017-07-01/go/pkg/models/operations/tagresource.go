...
const (
	TagResourceXAmzTargetEnumAwsShineFrontendService20170701TagResource TagResourceXAmzTargetEnum = "AWSShineFrontendService_20170701.TagResource"
)
...
func (e *TagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AWSShineFrontendService_20170701.TagResource":
