...
public class GETDescribeReservedNodeExchangeStatusQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=Action")
    public GETDescribeReservedNodeExchangeStatusActionEnum action;
    public GETDescribeReservedNodeExchangeStatusQueryParams withAction(GETDescribeReservedNodeExchangeStatusActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETDescribeReservedNodeExchangeStatusQueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public GETDescribeReservedNodeExchangeStatusQueryParams withMaxRecords(Long maxRecords) {
    ...
    public GETDescribeReservedNodeExchangeStatusQueryParams withReservedNodeExchangeRequestId(String reservedNodeExchangeRequestId) {
    ...
    public GETDescribeReservedNodeExchangeStatusQueryParams withReservedNodeId(String reservedNodeId) {
    ...
    public GETDescribeReservedNodeExchangeStatusQueryParams withVersion(GETDescribeReservedNodeExchangeStatusVersionEnum version) {
