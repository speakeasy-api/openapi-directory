...
export class CodespacesSetSelectedReposForOrgSecretRequestBody extends SpeakeasyBase {
  /**
...
export class CodespacesSetSelectedReposForOrgSecretRequest extends SpeakeasyBase {
...
export class CodespacesSetSelectedReposForOrgSecretResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
