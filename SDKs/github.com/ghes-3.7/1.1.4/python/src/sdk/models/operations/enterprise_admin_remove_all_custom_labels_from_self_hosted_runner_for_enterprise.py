...
@dataclasses.dataclass
class EnterpriseAdminRemoveAllCustomLabelsFromSelfHostedRunnerForEnterprise200ApplicationJSON:
    r"""Response"""
...
class EnterpriseAdminRemoveAllCustomLabelsFromSelfHostedRunnerForEnterpriseResponse:
    ...
    enterprise_admin_remove_all_custom_labels_from_self_hosted_runner_for_enterprise_200_application_json_object: Optional[EnterpriseAdminRemoveAllCustomLabelsFromSelfHostedRunnerForEnterprise200ApplicationJSON] = dataclasses.field(default=None)
    r"""Response"""  
