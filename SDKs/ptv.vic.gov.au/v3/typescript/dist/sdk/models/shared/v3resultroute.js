...
var V3ResultRoute = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "route_gtfs_id" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "route_name" }),
        __metadata("design:type", String)
    ], V3ResultRoute.prototype, "routeName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "route_number" }),
        __metadata("design:type", String)
    ], V3ResultRoute.prototype, "routeNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "route_service_status" }),
        (0, class_transformer_1.Type)(function () { return v3routeservicestatus_1.V3RouteServiceStatus; }),
