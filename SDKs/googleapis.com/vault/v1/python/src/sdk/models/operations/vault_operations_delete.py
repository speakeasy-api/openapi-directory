...
@dataclasses.dataclass
class VaultOperationsDeleteQueryParams:
...
class VaultOperationsDeleteRequest:
    path_params: VaultOperationsDeletePathParams = dataclasses.field()
    query_params: VaultOperationsDeleteQueryParams = dataclasses.field()
