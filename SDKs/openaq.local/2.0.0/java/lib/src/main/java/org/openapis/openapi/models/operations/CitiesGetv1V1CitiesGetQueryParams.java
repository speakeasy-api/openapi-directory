...
public class CitiesGetv1V1CitiesGetQueryParams {
    ...
    public CitiesGetv1V1CitiesGetQueryParams withOrderBy(CitiesGetv1V1CitiesGetOrderByCitiesOrderEnum orderBy) {
    ...
    public CitiesGetv1V1CitiesGetQueryParams withSort(CitiesGetv1V1CitiesGetSortSortEnum sort) {
        this.sort = sort;
        return this;
    }
