...
type VaultMattersUndeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type VaultMattersUndeletePathParams struct {
	// The matter ID.
	MatterID string `pathParam:"style=simple,explode=false,name=matterId"`
}

type VaultMattersUndeleteQueryParams struct {
	// V1 error format.
...
type VaultMattersUndeleteRequest struct {
...
type VaultMattersUndeleteResponse struct {
	ContentType string
	// Successful response
