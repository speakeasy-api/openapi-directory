...
export class GetDiseaseSubstanceAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetDiseaseSubstanceAssociationsQueryParams extends SpeakeasyBase {
...
export class GetDiseaseSubstanceAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetDiseaseSubstanceAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
