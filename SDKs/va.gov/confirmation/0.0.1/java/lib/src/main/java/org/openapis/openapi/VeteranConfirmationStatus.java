...
public class VeteranConfirmationStatus {
     ...
     */
    public org.openapis.openapi.models.operations.GetVeteranStatusResponse getVeteranStatus(org.openapis.openapi.models.operations.GetVeteranStatusRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.VeteranStatusConfirmation out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.VeteranStatusConfirmation.class);
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.AuthorizationError out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.AuthorizationError.class);
