...
class PostPortfolioOptimizationMinimumVarianceDiversifiedRequestBodyConstraints:
    ...
    r"""The relative tolerance over the minimum variance portfolio return, if applicable"""  
    ...
    r"""The relative tolerance over the minimum variance portfolio volatility"""  
...
class PostPortfolioOptimizationMinimumVarianceDiversifiedRequestBody:
    ...
    constraints: Optional[PostPortfolioOptimizationMinimumVarianceDiversifiedRequestBodyConstraints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('constraints'), 'exclude': lambda f: f is None }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostPortfolioOptimizationMinimumVarianceDiversified200ApplicationJSON:
    r"""OK"""
...
class PostPortfolioOptimizationMinimumVarianceDiversifiedResponse:
    ...
    post_portfolio_optimization_minimum_variance_diversified_200_application_json_object: Optional[PostPortfolioOptimizationMinimumVarianceDiversified200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""  
