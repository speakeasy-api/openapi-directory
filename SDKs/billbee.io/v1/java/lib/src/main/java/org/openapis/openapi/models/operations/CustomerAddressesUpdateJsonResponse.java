...
public class CustomerAddressesUpdateJsonResponse {
    
    public byte[] body;

    public CustomerAddressesUpdateJsonResponse withBody(byte[] body) {
        this.body = body;
        return this;
    }
    ...
    public CustomerAddressesUpdateJsonResponse withContentType(String contentType) {
    ...
    public CustomerAddressesUpdateJsonResponse withStatusCode(Integer statusCode) {
    ...
    public CustomerAddressesUpdateJsonResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
        this.rawResponse = rawResponse;
        return this;
    }
    
    public CustomerAddressesUpdateJsonResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
