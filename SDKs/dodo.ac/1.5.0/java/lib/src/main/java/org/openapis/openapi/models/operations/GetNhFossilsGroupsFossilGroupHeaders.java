...
public class GetNhFossilsGroupsFossilGroupHeaders {
    /**
    ...
    public GetNhFossilsGroupsFossilGroupHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhFossilsGroupsFossilGroupHeaders withXApiKey(String xApiKey) {
