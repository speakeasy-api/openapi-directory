...
class ListRetirableGrantsRequest:
    ...
    list_retirable_grants_request: shared_listretirablegrantsrequest.ListRetirableGrantsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
