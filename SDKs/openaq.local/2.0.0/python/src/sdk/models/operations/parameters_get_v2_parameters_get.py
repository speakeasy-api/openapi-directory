...
class ParametersGetV2ParametersGetSortSortEnum(str, Enum):
    r"""An enumeration."""
    ASC = 'asc'
    DESC = 'desc'
...
class ParametersGetV2ParametersGetRequest:
    ...
    sort: Optional[ParametersGetV2ParametersGetSortSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""Define sort order."""  
