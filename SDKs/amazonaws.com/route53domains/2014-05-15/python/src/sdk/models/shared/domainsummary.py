...
class DomainSummary:
    r"""Summary information about one domain."""
    ...
    transfer_lock: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TransferLock'), 'exclude': lambda f: f is None }})  
