...
export class WorkflowsProjectsLocationsWorkflowsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class WorkflowsProjectsLocationsWorkflowsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class WorkflowsProjectsLocationsWorkflowsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
