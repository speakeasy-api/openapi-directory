...
class Error404NgPiis:
    ...
    tpp_messages: Optional[list[shared_tppmessage404_piis.TppMessage404Piis]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tppMessages') }})
