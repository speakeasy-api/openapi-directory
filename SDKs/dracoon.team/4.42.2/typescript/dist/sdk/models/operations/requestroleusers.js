...
exports.RequestRoleUsersResponse = exports.RequestRoleUsersRequest = void 0;
...
var RequestRoleUsersRequest = /** @class */ (function (_super) {
    ...
    ], RequestRoleUsersRequest.prototype, "xSdsAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], RequestRoleUsersRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], RequestRoleUsersRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], RequestRoleUsersRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=role_id",
        }),
        __metadata("design:type", Number)
    ], RequestRoleUsersRequest.prototype, "roleId", void 0);
    return RequestRoleUsersRequest;
}(utils_1.SpeakeasyBase));
exports.RequestRoleUsersRequest = RequestRoleUsersRequest;
var RequestRoleUsersResponse = /** @class */ (function (_super) {
    ...
    ], RequestRoleUsersResponse.prototype, "rawResponse", void 0);
    return RequestRoleUsersResponse;
}(utils_1.SpeakeasyBase));
exports.RequestRoleUsersResponse = RequestRoleUsersResponse;
