 ...
 */
export declare enum GetNetworkLatencyStatsBandEnum {
    Two4 = "2.4",
    Five = "5"
}
export declare class GetNetworkLatencyStatsRequest extends SpeakeasyBase {
    /**
     ...
     * Filter results by band (either '2.4' or '5'). Note that data prior to February 2020 will not have band information.
     */
    band?: GetNetworkLatencyStatsBandEnum;
    /**
...
export declare class GetNetworkLatencyStatsResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
     ...
     */
    getNetworkLatencyStats200ApplicationJSONObject?: Record<string, any>;
}
