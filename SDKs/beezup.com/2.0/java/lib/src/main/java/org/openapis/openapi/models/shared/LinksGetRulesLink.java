...
public class LinksGetRulesLink {
    ...
    public LinksGetRulesLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksGetRulesLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksGetRulesLink withDescription(String description) {
    ...
    public LinksGetRulesLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksGetRulesLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksGetRulesLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksGetRulesLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksGetRulesLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksGetRulesLink withOperationId(String operationId) {
    ...
    public LinksGetRulesLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksGetRulesLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksGetRulesLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
