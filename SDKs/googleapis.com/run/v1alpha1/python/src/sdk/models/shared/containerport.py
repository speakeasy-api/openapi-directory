...
class ContainerPort:
    ...
    r"""(Optional) Port number the container listens on. This must be a valid port number, 0 < x < 65536."""  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})
    r"""(Optional) If specified, used to specify which protocol to use. Allowed values are \\"http1\\" and \\"h2c\\"."""  
    ...
    r"""(Optional) Protocol for port. Must be \\"TCP\\". Defaults to \\"TCP\\"."""  
