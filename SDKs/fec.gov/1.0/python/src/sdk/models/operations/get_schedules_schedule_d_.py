...
class GetSchedulesScheduleDDefaultApplicationJSON:
    ...
    results: Optional[list[GetSchedulesScheduleDDefaultApplicationJSONResults]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    

@dataclasses.dataclass
class GetSchedulesScheduleDRequest:
    query_params: GetSchedulesScheduleDQueryParams = dataclasses.field()
