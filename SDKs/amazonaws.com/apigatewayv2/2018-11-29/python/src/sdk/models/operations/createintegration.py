...
from ..shared import createintegrationresult as shared_createintegrationresult
...
class CreateIntegrationRequestBody:
    integration_type: CreateIntegrationRequestBodyIntegrationTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('integrationType') }})
    ...
    connection_type: Optional[CreateIntegrationRequestBodyConnectionTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('connectionType') }})
    content_handling_strategy: Optional[CreateIntegrationRequestBodyContentHandlingStrategyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contentHandlingStrategy') }})
    ...
    passthrough_behavior: Optional[CreateIntegrationRequestBodyPassthroughBehaviorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('passthroughBehavior') }})
    ...
    tls_config: Optional[CreateIntegrationRequestBodyTLSConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tlsConfig') }})
    

@dataclasses.dataclass
class CreateIntegrationRequest:
    headers: CreateIntegrationHeaders = dataclasses.field()
    path_params: CreateIntegrationPathParams = dataclasses.field()
    request: CreateIntegrationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateIntegrationResponse:
    ...
    create_integration_result: Optional[shared_createintegrationresult.CreateIntegrationResult] = dataclasses.field(default=None)
