...
public class StoreReleasesGetPublishErrorRequest {
    ...
    public StoreReleasesGetPublishErrorRequest(@JsonProperty("app_name") String appName, @JsonProperty("owner_name") String ownerName, @JsonProperty("release_id") Double releaseId, @JsonProperty("store_name") String storeName) {
        this.appName = appName;
        this.ownerName = ownerName;
        this.releaseId = releaseId;
        this.storeName = storeName;
