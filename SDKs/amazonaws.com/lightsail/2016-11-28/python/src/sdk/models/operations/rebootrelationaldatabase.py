...
class RebootRelationalDatabaseRequest:
    ...
    reboot_relational_database_request: shared_rebootrelationaldatabaserequest.RebootRelationalDatabaseRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
