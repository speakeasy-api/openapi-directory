...
class GetDiscoveryV2VenuesIdRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetDiscoveryV2VenuesIdIncludeLicensedContentEnum $includeLicensedContent
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=includeLicensedContent')]
    public ?GetDiscoveryV2VenuesIdIncludeLicensedContentEnum $includeLicensedContent = null;
