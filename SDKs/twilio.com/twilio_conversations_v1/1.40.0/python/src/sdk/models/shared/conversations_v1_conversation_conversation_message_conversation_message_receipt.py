...
from ..shared import conversation_message_receipt_enum_delivery_status_enum as shared_conversation_message_receipt_enum_delivery_status_enum
...
class ConversationsV1ConversationConversationMessageConversationMessageReceipt:
    ...
    status: Optional[shared_conversation_message_receipt_enum_delivery_status_enum.ConversationMessageReceiptEnumDeliveryStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
