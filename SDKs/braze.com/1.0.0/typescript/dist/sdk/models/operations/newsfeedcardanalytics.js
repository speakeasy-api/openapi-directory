...
exports.NewsFeedCardAnalyticsResponse = exports.NewsFeedCardAnalyticsRequest = void 0;
...
var NewsFeedCardAnalyticsRequest = /** @class */ (function (_super) {
    ...
    ], NewsFeedCardAnalyticsRequest.prototype, "cardId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ending_at",
        }),
        __metadata("design:type", String)
    ], NewsFeedCardAnalyticsRequest.prototype, "endingAt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=length",
        }),
        __metadata("design:type", String)
    ], NewsFeedCardAnalyticsRequest.prototype, "length", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=unit" }),
        __metadata("design:type", String)
    ], NewsFeedCardAnalyticsRequest.prototype, "unit", void 0);
...
var NewsFeedCardAnalyticsResponse = /** @class */ (function (_super) {
    ...
    ], NewsFeedCardAnalyticsResponse.prototype, "rawResponse", void 0);
