...
class GenerateDataKeyWithoutPlaintextRequest:
    ...
    generate_data_key_without_plaintext_request: shared_generatedatakeywithoutplaintextrequest.GenerateDataKeyWithoutPlaintextRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
