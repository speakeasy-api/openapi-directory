...
class DfareportingDirectorySitesListRequest:
    ...
    r"""Select only directory sites that accept publisher paid placements. This field can be left blank."""  
    ...
    r"""Select only active directory sites. Leave blank to retrieve both active and inactive directory sites."""  
    ...
    r"""Select only directory sites with this Ad Manager network code."""  
    ...
    r"""Select only directory sites with these IDs."""  
    ...
    r"""Allows searching for objects by name, ID or URL. Wildcards (*) are allowed. For example, \\"directory site*2015\\" will return objects with names like \\"directory site June 2015\\", \\"directory site April 2015\\", or simply \\"directory site 2015\\". Most of the searches also add wildcards implicitly at the start and the end of the search string. For example, a search string of \\"directory site\\" will match objects with name \\"my directory site\\", \\"directory site 2015\\" or simply, \\"directory site\\"."""  
