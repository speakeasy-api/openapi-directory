...
class CreateMerchantWebhookRequestCommunicationFormatEnum(str, Enum):
...
class CreateMerchantWebhookRequestNetworkTypeEnum(str, Enum):
...
class CreateMerchantWebhookRequestSslVersionEnum(str, Enum):
...
class CreateMerchantWebhookRequest:
    ...
    communication_format: CreateMerchantWebhookRequestCommunicationFormatEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('communicationFormat') }})
    r"""Format or protocol for receiving webhooks. Possible values:
    * **soap**
    * **http**
    * **json**
    ...
    network_type: Optional[CreateMerchantWebhookRequestNetworkTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('networkType'), 'exclude': lambda f: f is None }})
    r"""Network type for Terminal API notification webhooks. Possible values:
    * **public**
    * **local**
    ...
    """  
    ssl_version: Optional[CreateMerchantWebhookRequestSslVersionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sslVersion'), 'exclude': lambda f: f is None }})
    r"""SSL version to access the public webhook URL specified in the `url` field. Possible values:
    * **TLSv1.3**
    * **TLSv1.2**
    * **HTTP** - Only allowed on Test environment.
