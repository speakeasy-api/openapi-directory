...
var GridRange = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=endColumnIndex" }),
        __metadata("design:type", Number)
    ], GridRange.prototype, "endColumnIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=endRowIndex" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startColumnIndex" }),
        __metadata("design:type", Number)
    ], GridRange.prototype, "startColumnIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startRowIndex" }),
        __metadata("design:type", Number)
