...
public class RetailProjectsLocationsCatalogsBranchesProductsAddLocalInventoriesPathParams {
    /**
    ...
    public RetailProjectsLocationsCatalogsBranchesProductsAddLocalInventoriesPathParams withProduct(String product) {
