...
from ..shared import putresourcepolicyoutput as shared_putresourcepolicyoutput
...
class PutResourcePolicyRequest:
    ...
    request: PutResourcePolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class PutResourcePolicyResponse:
    ...
    put_resource_policy_output: Optional[shared_putresourcepolicyoutput.PutResourcePolicyOutput] = dataclasses.field(default=None)
