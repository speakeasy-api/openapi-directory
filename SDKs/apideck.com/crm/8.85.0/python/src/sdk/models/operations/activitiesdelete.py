...
class ActivitiesDeleteRequest:
    headers: ActivitiesDeleteHeaders = dataclasses.field()
    path_params: ActivitiesDeletePathParams = dataclasses.field()
    query_params: ActivitiesDeleteQueryParams = dataclasses.field()
    security: ActivitiesDeleteSecurity = dataclasses.field()
