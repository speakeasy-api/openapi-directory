...
public class GetEarlyDayMotionsListQueryParams {
    /**
    ...
    public GetEarlyDayMotionsListQueryParams withParametersCurrentStatusDateEnd(OffsetDateTime parametersCurrentStatusDateEnd) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersCurrentStatusDateStart(OffsetDateTime parametersCurrentStatusDateStart) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersEdmIds(Integer[] parametersEdmIds) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersIncludeSponsoredByMember(Boolean parametersIncludeSponsoredByMember) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersIsPrayer(Boolean parametersIsPrayer) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersMemberId(Integer parametersMemberId) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersOrderBy(GetEarlyDayMotionsListParametersOrderByEnum parametersOrderBy) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersSearchTerm(String parametersSearchTerm) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersSkip(Integer parametersSkip) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersStatuses(GetEarlyDayMotionsListParametersStatusesEnum[] parametersStatuses) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersTabledEndDate(OffsetDateTime parametersTabledEndDate) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersTabledStartDate(OffsetDateTime parametersTabledStartDate) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersTake(Integer parametersTake) {
    ...
    public GetEarlyDayMotionsListQueryParams withParametersUINWithAmendmentSuffix(String parametersUINWithAmendmentSuffix) {
