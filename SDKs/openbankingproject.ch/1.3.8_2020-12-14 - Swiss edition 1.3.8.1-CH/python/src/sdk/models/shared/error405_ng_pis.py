...
from ..shared import tppmessage405_pis as shared_tppmessage405_pis
...
class Error405NgPis:
    ...
    tpp_messages: Optional[list[shared_tppmessage405_pis.TppMessage405Pis]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tppMessages') }})
