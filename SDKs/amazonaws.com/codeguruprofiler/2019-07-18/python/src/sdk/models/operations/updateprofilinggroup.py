...
class UpdateProfilingGroupRequestBody:
    agent_orchestration_config: UpdateProfilingGroupRequestBodyAgentOrchestrationConfig = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('agentOrchestrationConfig') }})
    

@dataclasses.dataclass
class UpdateProfilingGroupRequest:
    headers: UpdateProfilingGroupHeaders = dataclasses.field()
    path_params: UpdateProfilingGroupPathParams = dataclasses.field()
    request: UpdateProfilingGroupRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
