...
public class GetDiseaseVariantAssociationsRequest {
    ...
    public GetDiseaseVariantAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetDiseaseVariantAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetDiseaseVariantAssociationsRequest withEvidence(String evidence) {
    ...
    public GetDiseaseVariantAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetDiseaseVariantAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetDiseaseVariantAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetDiseaseVariantAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetDiseaseVariantAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetDiseaseVariantAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetDiseaseVariantAssociationsRequest withRelation(String relation) {
    ...
    public GetDiseaseVariantAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetDiseaseVariantAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetDiseaseVariantAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetDiseaseVariantAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetDiseaseVariantAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetDiseaseVariantAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetDiseaseVariantAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetDiseaseVariantAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
