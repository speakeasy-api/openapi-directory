...
public class GetMeBadgesQueryParams {
    /**
    ...
    public GetMeBadgesQueryParams withCallback(String callback) {
    ...
    public GetMeBadgesQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeBadgesQueryParams withFromdate(Long fromdate) {
    ...
    public String max;
    public GetMeBadgesQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetMeBadgesQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetMeBadgesOrderEnum order;
    public GetMeBadgesQueryParams withOrder(GetMeBadgesOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetMeBadgesQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeBadgesQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetMeBadgesQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetMeBadgesSortEnum sort;
    public GetMeBadgesQueryParams withSort(GetMeBadgesSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetMeBadgesQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
