...
export declare const ProductSearchWhoSawAlsoBoughtServerList: readonly ["http://example.com/.{environment}.com.br"];
export declare class ProductSearchWhoSawAlsoBoughtRequest extends SpeakeasyBase {
    /**
...
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsImages extends SpeakeasyBase {
    /**
     * Image ID.
     */
    imageId: string;
...
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsKitItems extends SpeakeasyBase {
    /**
...
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsReferenceId extends SpeakeasyBase {
    /**
     * Reference Code.
     */
    key: string;
...
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySlaSamples extends SpeakeasyBase {
    /**
 ...
 * Delivery SLA ID.
 */
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySlaSamplesPerRegion0 extends SpeakeasyBase {
    /**
     * Delivery SLA per types.
     */
    deliverySlaPerTypes: any[];
 ...
 */
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySlaSamplesPerRegion extends SpeakeasyBase {
    /**
     * Delivery SLA ID.
     */
    zero?: ProductSearchWhoSawAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySlaSamplesPerRegion0;
}
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsSellersCommertialOfferInstallments extends SpeakeasyBase {
    /**
...
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallmentsSellerMerchantInstallments extends SpeakeasyBase {
    /**
     * Count.
     */
    count: number;
...
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallments extends SpeakeasyBase {
    /**
     * Count.
     */
    count: number;
...
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptions extends SpeakeasyBase {
    /**
     * Bin.
     */
    bin: string;
...
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsPaymentSystems extends SpeakeasyBase {
    /**
     * Available payments.
     */
 ...
 * Payment options.
 */
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptions extends SpeakeasyBase {
    /**
     * Available accounts.
     */
 ...
 */
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsSellersCommertialOffer extends SpeakeasyBase {
    /**
...
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItemsSellers extends SpeakeasyBase {
    /**
...
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSONItems extends SpeakeasyBase {
    /**
     * Videos.
     */
    videos: any[];
...
export declare class ProductSearchWhoSawAlsoBought200ApplicationJSON extends SpeakeasyBase {
    /**
...
export declare class ProductSearchWhoSawAlsoBoughtResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * OK
     */
