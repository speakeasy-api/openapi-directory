...
class GiftCardObject:
    ...
    balance: Optional[shared_money.Money] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('balance'), 'exclude': lambda f: f is None }})  
    balance_update_time: Optional[shared_datetime_.DateTime] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('balanceUpdateTime'), 'exclude': lambda f: f is None }})  
    ...
    class_reference: Optional[shared_giftcardclass.GiftCardClass] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('classReference'), 'exclude': lambda f: f is None }})  
    ...
    event_number: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('eventNumber'), 'exclude': lambda f: f is None }})
    r"""The card's event number, an optional field used by some gift cards."""  
    ...
    r"""Identifies what kind of resource this is. Value: the fixed string `\\"walletobjects#giftCardObject\\"`."""  
    ...
    state: Optional[GiftCardObjectStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
    r"""Required. The state of the object. This field is used to determine how an object is displayed in the app. For example, an `inactive` object is moved to the \\"Expired passes\\" section."""  
