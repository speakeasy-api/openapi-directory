...
import org.openapis.openapi.models.operations.TrcerRequestBody;
import org.openapis.openapi.models.operations.TrcerRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.TrcerRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.TrcerResponse;
import org.openapis.openapi.models.operations.TrcerSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            TrcerRequestBody req = new TrcerRequestBody(TrcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new TrcerRequestBodyCertificateParameters("12345", "Sunil Kumar");;
            ...
            TrcerResponse res = sdk.apIs.trcer(req, new TrcerSecurity("molestiae", "minus") {{
...
* [trcer](docs/apis/README.md#trcer) - Transfer Certificate
