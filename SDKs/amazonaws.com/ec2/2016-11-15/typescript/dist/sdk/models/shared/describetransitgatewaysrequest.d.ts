 ...
 */
export declare class DescribeTransitGatewaysRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTransitGatewaysRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeTransitGatewaysRequestFilters[];
    maxResults?: number;
    nextToken?: string;
