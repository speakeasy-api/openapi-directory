...
class StoryRequestInput:
    ...
    sticker_name: Optional[StoryRequestStickerNameEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sticker_name'), 'exclude': lambda f: f is None }})
    r"""The name of the sticker in this story. `null` if there is no sticker."""  
