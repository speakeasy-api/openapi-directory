...
import org.openapis.openapi.models.operations.PvcerRequestBody;
import org.openapis.openapi.models.operations.PvcerRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.PvcerRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.PvcerResponse;
import org.openapis.openapi.models.operations.PvcerSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PvcerRequestBody req = new PvcerRequestBody(PvcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new PvcerRequestBodyCertificateParameters("12xxxxx8", "Sunil Kumar", "2018");;
            ...
            PvcerResponse res = sdk.apIs.pvcer(req, new PvcerSecurity("molestiae", "minus") {{
