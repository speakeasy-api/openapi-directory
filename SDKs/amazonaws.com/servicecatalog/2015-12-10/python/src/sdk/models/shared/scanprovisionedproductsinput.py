...
class ScanProvisionedProductsInput:
    ...
    access_level_filter: Optional[shared_accesslevelfilter.AccessLevelFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AccessLevelFilter'), 'exclude': lambda f: f is None }})  
