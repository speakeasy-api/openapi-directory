...
func (e *IdpProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = IdpProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for IdpProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum: %s", s)
	}
}
