...
class CreateAnomalySubscriptionRequest:
    ...
    anomaly_subscription: shared_anomalysubscription.AnomalySubscription = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AnomalySubscription') }})  
