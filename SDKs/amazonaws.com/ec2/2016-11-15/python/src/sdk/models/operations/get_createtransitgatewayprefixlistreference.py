...
class GetCreateTransitGatewayPrefixListReferenceRequest:
    headers: GetCreateTransitGatewayPrefixListReferenceHeaders = dataclasses.field()
    query_params: GetCreateTransitGatewayPrefixListReferenceQueryParams = dataclasses.field()
