...
class BillingDocumentQueryResponseElementType:
    ...
    documents: Optional[list[shared_getbillingdocumentsresponsetype.GETBillingDocumentsResponseType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('documents'), 'exclude': lambda f: f is None }})
    r"""Container for billing documents."""  
