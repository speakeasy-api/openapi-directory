...
from ..shared import googlecloudvisionv1p1beta1position as shared_googlecloudvisionv1p1beta1position
...
class GoogleCloudVisionV1p1beta1FaceAnnotationLandmark:
    r"""GoogleCloudVisionV1p1beta1FaceAnnotationLandmark
    A face-specific landmark (for example, a face feature).
    """
    
    position: Optional[shared_googlecloudvisionv1p1beta1position.GoogleCloudVisionV1p1beta1Position] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('position') }})
    type: Optional[GoogleCloudVisionV1p1beta1FaceAnnotationLandmarkTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
