...
class Sdfdownloadtasks 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DisplayvideoSdfdownloadtasksCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/sdfdownloadtasks');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/{name}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoSdfdownloadtasksOperationsGetRequest::class, $request);
