 ...
 */
public class GoogleCloudIdentitytoolkitAdminV2RecaptchaConfigInput {
    /**
    ...
    public GoogleCloudIdentitytoolkitAdminV2RecaptchaConfigInput withEmailPasswordEnforcementState(GoogleCloudIdentitytoolkitAdminV2RecaptchaConfigEmailPasswordEnforcementStateEnum emailPasswordEnforcementState) {
    ...
    public GoogleCloudIdentitytoolkitAdminV2RecaptchaConfigInput withManagedRules(GoogleCloudIdentitytoolkitAdminV2RecaptchaManagedRule[] managedRules) {
    ...
    public GoogleCloudIdentitytoolkitAdminV2RecaptchaConfigInput withUseAccountDefender(Boolean useAccountDefender) {
        this.useAccountDefender = useAccountDefender;
        return this;
    }
    
    public GoogleCloudIdentitytoolkitAdminV2RecaptchaConfigInput(){}
}
