...
exports.LedgerAccountsAddResponse = exports.LedgerAccountsAddRequest = exports.LedgerAccountsAddSecurity = void 0;
...
exports.LedgerAccountsAddSecurity = LedgerAccountsAddSecurity;
var LedgerAccountsAddRequest = /** @class */ (function (_super) {
    ...
    ], LedgerAccountsAddRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], LedgerAccountsAddRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], LedgerAccountsAddRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], LedgerAccountsAddRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], LedgerAccountsAddRequest.prototype, "xApideckServiceId", void 0);
    return LedgerAccountsAddRequest;
}(utils_1.SpeakeasyBase));
exports.LedgerAccountsAddRequest = LedgerAccountsAddRequest;
var LedgerAccountsAddResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], LedgerAccountsAddResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.LedgerAccountsAddResponse = LedgerAccountsAddResponse;
