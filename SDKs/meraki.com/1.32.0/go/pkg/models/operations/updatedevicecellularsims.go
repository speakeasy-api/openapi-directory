...
func (e UpdateDeviceCellularSimsRequestBodySimsApnsAuthenticationTypeEnum) ToPointer() *UpdateDeviceCellularSimsRequestBodySimsApnsAuthenticationTypeEnum {
	return &e
}
...
func (e *UpdateDeviceCellularSimsRequestBodySimsApnsAuthenticationTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "none":
		fallthrough
	case "pap":
		*e = UpdateDeviceCellularSimsRequestBodySimsApnsAuthenticationTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDeviceCellularSimsRequestBodySimsApnsAuthenticationTypeEnum: %v", v)
	}
}
...
func (e UpdateDeviceCellularSimsRequestBodySimsSlotEnum) ToPointer() *UpdateDeviceCellularSimsRequestBodySimsSlotEnum {
	return &e
}
...
func (e *UpdateDeviceCellularSimsRequestBodySimsSlotEnum) UnmarshalJSON(data []byte) error {
	...
	case "sim1":
		fallthrough
	case "sim2":
		*e = UpdateDeviceCellularSimsRequestBodySimsSlotEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDeviceCellularSimsRequestBodySimsSlotEnum: %v", v)
	}
}
