...
public class SuggestBidsRequest {
    ...
    public SuggestBidsRequest(@JsonProperty("TargetedBidRequest") org.openapis.openapi.models.shared.TargetedBidRequest targetedBidRequest, @JsonProperty("ad_group_id") String adGroupId, @JsonProperty("campaign_id") String campaignId) {
        this.targetedBidRequest = targetedBidRequest;
        this.adGroupId = adGroupId;
        this.campaignId = campaignId;
  }
