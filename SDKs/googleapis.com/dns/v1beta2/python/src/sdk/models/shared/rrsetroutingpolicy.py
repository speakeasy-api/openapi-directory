...
class RRSetRoutingPolicy:
    ...
    geo_policy: Optional[shared_rrsetroutingpolicygeopolicy.RRSetRoutingPolicyGeoPolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('geoPolicy'), 'exclude': lambda f: f is None }})
    r"""Configures a RRSetRoutingPolicy that routes based on the geo location of the querying user."""  
    ...
    wrr_policy: Optional[shared_rrsetroutingpolicywrrpolicy.RRSetRoutingPolicyWrrPolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('wrrPolicy'), 'exclude': lambda f: f is None }})
    r"""Configures a RRSetRoutingPolicy that routes in a weighted round robin fashion."""  
