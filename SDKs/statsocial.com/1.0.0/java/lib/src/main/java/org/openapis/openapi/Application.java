...
public class Application {
     ...
     */
    public org.openapis.openapi.models.operations.GetApplicationsStatusResponse getApplicationsStatus(org.openapis.openapi.models.operations.GetApplicationsStatusRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/applications/status/");
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetApplicationsStatusRequest.class, request, null);
        if (queryParams != null) {
        ...
        org.openapis.openapi.models.operations.GetApplicationsStatusResponse res = new org.openapis.openapi.models.operations.GetApplicationsStatusResponse(contentType, httpRes.statusCode()) {{
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.ApplicationStatus out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.ApplicationStatus.class);
