...
func (e CreateUnreferencedMergeCommitXAmzTargetEnum) ToPointer() *CreateUnreferencedMergeCommitXAmzTargetEnum {
	return &e
}
...
func (e *CreateUnreferencedMergeCommitXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "CodeCommit_20150413.CreateUnreferencedMergeCommit":
		*e = CreateUnreferencedMergeCommitXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateUnreferencedMergeCommitXAmzTargetEnum: %v", v)
	}
}

type CreateUnreferencedMergeCommitRequest struct {
	CreateUnreferencedMergeCommitInput shared.CreateUnreferencedMergeCommitInput   `request:"mediaType=application/json"`
