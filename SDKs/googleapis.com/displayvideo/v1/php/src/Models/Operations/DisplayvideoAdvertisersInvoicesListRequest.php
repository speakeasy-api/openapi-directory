...
class DisplayvideoAdvertisersInvoicesListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DisplayvideoAdvertisersInvoicesListLoiSapinInvoiceTypeEnum $loiSapinInvoiceType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=loiSapinInvoiceType')]
    public ?DisplayvideoAdvertisersInvoicesListLoiSapinInvoiceTypeEnum $loiSapinInvoiceType = null;
