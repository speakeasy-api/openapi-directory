 ...
 */
public enum Webinar200ApplicationXMLSettingsFollowUpAbsenteesEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private Webinar200ApplicationXMLSettingsFollowUpAbsenteesEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
