...
import { EcsEnvironmentFileTypeEnum } from "./ecsenvironmentfiletypeenum";
/**
 ...
 */
export declare class EcsEnvironmentFile extends SpeakeasyBase {
    type: EcsEnvironmentFileTypeEnum;
    value: string;
}
