 ...
 */
export declare enum GetNetworkClientConnectionStatsBandEnum {
    Two4 = "2.4",
    Five = "5"
}
export declare class GetNetworkClientConnectionStatsRequest extends SpeakeasyBase {
    /**
...
export declare class GetNetworkClientConnectionStatsResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
