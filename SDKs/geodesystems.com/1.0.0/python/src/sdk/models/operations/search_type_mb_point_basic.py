...
class SearchTypeMbPointBasicQueryParams:
...
@dataclasses.dataclass
class SearchTypeMbPointBasicRequest:
    query_params: SearchTypeMbPointBasicQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeMbPointBasicResponse:
