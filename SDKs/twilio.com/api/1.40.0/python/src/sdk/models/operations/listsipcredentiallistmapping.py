...
class ListSipCredentialListMappingRequest:
    ...
    r"""A 34 character string that uniquely identifies the SIP Domain that includes the resource to read."""  
...
class ListSipCredentialListMappingListSipCredentialListMappingResponse:
    ...
    credential_list_mappings: Optional[list[shared_api_v2010_account_sip_sip_domain_sip_credential_list_mapping.APIV2010AccountSipSipDomainSipCredentialListMapping]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credential_list_mappings'), 'exclude': lambda f: f is None }})  
