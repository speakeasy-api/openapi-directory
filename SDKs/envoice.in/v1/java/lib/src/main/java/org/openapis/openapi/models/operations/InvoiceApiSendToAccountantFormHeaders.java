...
public class InvoiceApiSendToAccountantFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiSendToAccountantFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiSendToAccountantFormHeaders withXAuthSecret(String xAuthSecret) {
