...
from ..shared import listappcomponentcompliancesresponse as shared_listappcomponentcompliancesresponse
...
class ListAppComponentCompliancesRequestBody:
...
class ListAppComponentCompliancesRequest:
    ...
    request_body: ListAppComponentCompliancesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListAppComponentCompliancesResponse:
    ...
    list_app_component_compliances_response: Optional[shared_listappcomponentcompliancesresponse.ListAppComponentCompliancesResponse] = dataclasses.field(default=None)
    r"""Success"""  
