...
class GETModifyEndpointAccessRequest:
    ...
    action: GETModifyEndpointAccessActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    endpoint_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'EndpointName', 'style': 'form', 'explode': True }})
    r"""The endpoint to be modified."""  
    version: GETModifyEndpointAccessVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
    ...
    r"""The complete list of VPC security groups associated with the endpoint after the endpoint is modified."""  
