...
class PostDescribeReservedNodesQueryParams:
    action: PostDescribeReservedNodesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeReservedNodesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeReservedNodesRequest:
    headers: PostDescribeReservedNodesHeaders = dataclasses.field()
    query_params: PostDescribeReservedNodesQueryParams = dataclasses.field()
