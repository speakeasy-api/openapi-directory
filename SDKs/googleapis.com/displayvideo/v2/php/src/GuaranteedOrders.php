...
class GuaranteedOrders 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DisplayvideoGuaranteedOrdersCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/guaranteedOrders');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/guaranteedOrders/{guaranteedOrderId}:editGuaranteedOrderReadAccessors', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoGuaranteedOrdersEditGuaranteedOrderReadAccessorsRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/guaranteedOrders/{guaranteedOrderId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoGuaranteedOrdersGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/guaranteedOrders/{guaranteedOrderId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoGuaranteedOrdersPatchRequest::class, $request);
