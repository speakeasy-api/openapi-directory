...
class CountOpenWorkflowExecutionsInput:
    ...
    start_time_filter: shared_executiontimefilter.ExecutionTimeFilter = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('startTimeFilter') }})  
