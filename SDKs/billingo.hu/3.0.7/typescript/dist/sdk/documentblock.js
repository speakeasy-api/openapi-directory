...
var DocumentBlock = /** @class */ (function () {
    ...
    DocumentBlock.prototype.listDocumentBlock = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.ListDocumentBlockResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.documentBlockList = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.DocumentBlockList);
                    }
                    break;
