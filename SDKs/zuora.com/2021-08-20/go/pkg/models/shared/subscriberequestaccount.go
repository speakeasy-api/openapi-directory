...
type SubscribeRequestAccountCustomerTypeNSEnum string

const (
	SubscribeRequestAccountCustomerTypeNSEnumCompany    SubscribeRequestAccountCustomerTypeNSEnum = "Company"
	SubscribeRequestAccountCustomerTypeNSEnumIndividual SubscribeRequestAccountCustomerTypeNSEnum = "Individual"
)

func (e *SubscribeRequestAccountCustomerTypeNSEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Company":
		fallthrough
	case "Individual":
		*e = SubscribeRequestAccountCustomerTypeNSEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for SubscribeRequestAccountCustomerTypeNSEnum: %s", s)
	}
}
...
type SubscribeRequestAccountSynctoNetSuiteNSEnum string

const (
	SubscribeRequestAccountSynctoNetSuiteNSEnumYes SubscribeRequestAccountSynctoNetSuiteNSEnum = "Yes"
	SubscribeRequestAccountSynctoNetSuiteNSEnumNo  SubscribeRequestAccountSynctoNetSuiteNSEnum = "No"
)

func (e *SubscribeRequestAccountSynctoNetSuiteNSEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Yes":
		fallthrough
	case "No":
		*e = SubscribeRequestAccountSynctoNetSuiteNSEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for SubscribeRequestAccountSynctoNetSuiteNSEnum: %s", s)
	}
}
...
type SubscribeRequestAccount struct {
	...
	//
	CustomerTypeNS *SubscribeRequestAccountCustomerTypeNSEnum `json:"CustomerType__NS,omitempty"`
	...
	//
	SynctoNetSuiteNS *SubscribeRequestAccountSynctoNetSuiteNSEnum `json:"SynctoNetSuite__NS,omitempty"`
