...
from ..shared import createopportunityresponse as shared_createopportunityresponse
...
class OpportunitiesAddResponse:
    ...
    r"""Bad Request"""  
    create_opportunity_response: Optional[shared_createopportunityresponse.CreateOpportunityResponse] = dataclasses.field(default=None)
