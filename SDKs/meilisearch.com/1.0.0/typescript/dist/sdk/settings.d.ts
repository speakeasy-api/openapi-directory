...
export declare class Settings {
     ...
     * Reset all settings
     */
    resetAllSettings(config?: AxiosRequestConfig): Promise<operations.ResetAllSettingsResponse>;
    /**
     ...
     * Update settings
     */
    updateSettings(req: operations.UpdateSettingsRequestBody, config?: AxiosRequestConfig): Promise<operations.UpdateSettingsResponse>;
    /**
