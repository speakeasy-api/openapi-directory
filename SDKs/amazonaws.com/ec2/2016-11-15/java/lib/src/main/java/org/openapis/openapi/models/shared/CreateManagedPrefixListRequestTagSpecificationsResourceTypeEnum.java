 ...
 */
public enum CreateManagedPrefixListRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateManagedPrefixListRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
