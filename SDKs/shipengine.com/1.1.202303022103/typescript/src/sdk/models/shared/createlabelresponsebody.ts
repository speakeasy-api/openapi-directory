 ...
 */
export enum CreateLabelResponseBodyDisplaySchemeEnum {
  Label = "label",
  QrCode = "qr_code",
 ...
 *
 */
export enum CreateLabelResponseBodyLabelFormatEnum {
  Pdf = "pdf",
  Png = "png",
  Zpl = "zpl",
}
 ...
 *
 */
export enum CreateLabelResponseBodyLabelLayoutEnum {
  Fourx6 = "4x6",
  Letter = "letter",
}
 ...
 *
 */
export enum CreateLabelResponseBodyLabelStatusEnum {
 ...
 */
export enum CreateLabelResponseBodyTrackingStatusEnum {
  Unknown = "unknown",
...
export class CreateLabelResponseBodyOutput extends SpeakeasyBase {
  ...
  displayScheme: CreateLabelResponseBodyDisplaySchemeEnum;
  ...
  @Type(() => CreateLabelResponseBodyOptionalLink)
  ...
  @Type(() => CreateLabelResponseBodyMonetaryValue)
  ...
  @Type(() => CreateLabelResponseBodyLabelDownload)
  ...
  labelFormat: CreateLabelResponseBodyLabelFormatEnum;
  ...
  labelLayout: CreateLabelResponseBodyLabelLayoutEnum;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "status" })
  status: CreateLabelResponseBodyLabelStatusEnum;
  ...
  trackingStatus: CreateLabelResponseBodyTrackingStatusEnum;
