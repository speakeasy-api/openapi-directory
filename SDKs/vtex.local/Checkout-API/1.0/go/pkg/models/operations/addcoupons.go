...
type AddCoupons200ApplicationJSONClientPreferencesData struct {
...
type AddCoupons200ApplicationJSONClientProfileData struct {
...
type AddCoupons200ApplicationJSONItemMetadataItems struct {
	// Detail URL.
...
type AddCoupons200ApplicationJSONItemMetadata struct {
	// List of objects containing metadata on each item in the order.
	Items []AddCoupons200ApplicationJSONItemMetadataItems `json:"items,omitempty"`
}

// AddCoupons200ApplicationJSONItemsAdditionalInfo - Additional information.
type AddCoupons200ApplicationJSONItemsAdditionalInfo struct {
	// Brand ID.
...
type AddCoupons200ApplicationJSONItemsBundleItems struct {
	// Service identifier.
...
type AddCoupons200ApplicationJSONItemsPriceDefinitionSellingPrices struct {
...
type AddCoupons200ApplicationJSONItemsPriceDefinition struct {
	...
	SellingPrices []AddCoupons200ApplicationJSONItemsPriceDefinitionSellingPrices `json:"sellingPrices,omitempty"`
	// Total value for all units of the item in cents.
	Total *int64 `json:"total,omitempty"`
}

type AddCoupons200ApplicationJSONItemsPriceTags struct {
...
type AddCoupons200ApplicationJSONItemsProductCategories struct {
	// Product category corresponding to the ID in the field key.
	ID *string `json:"{ID},omitempty"`
}

type AddCoupons200ApplicationJSONItems struct {
	// Additional information.
	AdditionalInfo *AddCoupons200ApplicationJSONItemsAdditionalInfo `json:"additionalInfo,omitempty"`
	...
	BundleItems []AddCoupons200ApplicationJSONItemsBundleItems `json:"bundleItems,omitempty"`
	// Detail URL.
	DetailURL *string `json:"detailUrl,omitempty"`
	// European Article Number.
	Ean *string `json:"ean,omitempty"`
	...
	PriceDefinition *AddCoupons200ApplicationJSONItemsPriceDefinition `json:"priceDefinition,omitempty"`
	...
	PriceTags []AddCoupons200ApplicationJSONItemsPriceTags `json:"priceTags,omitempty"`
	...
	ProductCategories *AddCoupons200ApplicationJSONItemsProductCategories `json:"productCategories,omitempty"`
...
type AddCoupons200ApplicationJSONItemsOrdination struct {
...
type AddCoupons200ApplicationJSONMarketingData struct {
	// Sending an existing coupon code in this field will return the corresponding discount in the purchase. Use the [cart simulation](https://developers.vtex.com/vtex-rest-api/reference/orderform#orderformsimulation) request to check which coupons might apply before placing the order.
...
type AddCoupons200ApplicationJSONPaymentDataGiftCards struct {
...
type AddCoupons200ApplicationJSONPaymentDataTransactionsPayments struct {
	// Account ID.
...
type AddCoupons200ApplicationJSONPaymentDataTransactions struct {
	// Indicates whether transaction is active.
	IsActive *bool `json:"isActive,omitempty"`
	// Merchant name.
	MerchantName *string `json:"merchantName,omitempty"`
	// Information on each payment.
	Payments []AddCoupons200ApplicationJSONPaymentDataTransactionsPayments `json:"payments,omitempty"`
...
type AddCoupons200ApplicationJSONPaymentData struct {
	// Gift card information, if it applies to the order.
	GiftCards []AddCoupons200ApplicationJSONPaymentDataGiftCards `json:"giftCards,omitempty"`
	// Information on each transaction pertinent to the order.
	Transactions []AddCoupons200ApplicationJSONPaymentDataTransactions `json:"transactions,omitempty"`
}

// AddCoupons200ApplicationJSONRatesAndBenefitsData - Information on rates and benefits that apply to the order.
type AddCoupons200ApplicationJSONRatesAndBenefitsData struct {
...
type AddCoupons200ApplicationJSONSellers struct {
	// Seller ID.
	ID *string `json:"id,omitempty"`
	// Seller logo.
...
type AddCoupons200ApplicationJSONShippingDataAddress struct {
	// Address ID.
	AddressID *string `json:"addressId,omitempty"`
...
type AddCoupons200ApplicationJSONShippingDataAvailableAddresses struct {
	// Address ID.
	AddressID *string `json:"addressId,omitempty"`
	// Type of address. For example, `Residential` or `Pickup`.
	AddressType *string `json:"addressType,omitempty"`
...
type AddCoupons200ApplicationJSONShippingDataLogisticsInfoDeliveryChannels struct {
	// Delivery channel ID.
	ID *string `json:"id,omitempty"`
}

type AddCoupons200ApplicationJSONShippingDataLogisticsInfoSlasDeliveryIds struct {
	// Courier ID.
...
type AddCoupons200ApplicationJSONShippingDataLogisticsInfoSlasPickupStoreInfoAddress struct {
	// Type of address. For example, `Residential` or `Pickup`.
	AddressType *string `json:"addressType,omitempty"`
	// City of the shipping address.
	City *string `json:"city,omitempty"`
...
type AddCoupons200ApplicationJSONShippingDataLogisticsInfoSlasPickupStoreInfo struct {
	// Additional information.
	AdditionalInfo *string `json:"additionalInfo,omitempty"`
	// Address information.
	Address *AddCoupons200ApplicationJSONShippingDataLogisticsInfoSlasPickupStoreInfoAddress `json:"address,omitempty"`
...
type AddCoupons200ApplicationJSONShippingDataLogisticsInfoSlas struct {
	// Delivery channel.
	DeliveryChannel *string `json:"deliveryChannel,omitempty"`
	// Information on each delivery ID.
	DeliveryIds []AddCoupons200ApplicationJSONShippingDataLogisticsInfoSlasDeliveryIds `json:"deliveryIds,omitempty"`
	// SLA ID.
	ID *string `json:"id,omitempty"`
	// List price in cents.
	ListPrice *int64 `json:"listPrice,omitempty"`
	...
	PickupStoreInfo *AddCoupons200ApplicationJSONShippingDataLogisticsInfoSlasPickupStoreInfo `json:"pickupStoreInfo,omitempty"`
	// Polygon name.
...
type AddCoupons200ApplicationJSONShippingDataLogisticsInfo struct {
	// Address ID.
	AddressID *string `json:"addressId,omitempty"`
	// List of available delivery channels.
	DeliveryChannels []AddCoupons200ApplicationJSONShippingDataLogisticsInfoDeliveryChannels `json:"deliveryChannels,omitempty"`
	// Item ID.
	...
	Slas []AddCoupons200ApplicationJSONShippingDataLogisticsInfoSlas `json:"slas,omitempty"`
}

type AddCoupons200ApplicationJSONShippingDataSelectedAddresses struct {
	// Address ID.
	AddressID *string `json:"addressId,omitempty"`
	// Type of address. For example, `Residential` or `Pickup`.
	AddressType *string `json:"addressType,omitempty"`
...
type AddCoupons200ApplicationJSONShippingData struct {
	// Address information.
	Address *AddCoupons200ApplicationJSONShippingDataAddress `json:"address,omitempty"`
	// Array with information on the available addresses for the order.
	AvailableAddresses []AddCoupons200ApplicationJSONShippingDataAvailableAddresses `json:"availableAddresses,omitempty"`
	...
	LogisticsInfo []AddCoupons200ApplicationJSONShippingDataLogisticsInfo `json:"logisticsInfo,omitempty"`
	// Array with information on the selected addresses for the order.
	SelectedAddresses []AddCoupons200ApplicationJSONShippingDataSelectedAddresses `json:"selectedAddresses,omitempty"`
}

// AddCoupons200ApplicationJSON - OK
type AddCoupons200ApplicationJSON struct {
	...
	AvailableAddresses []AddCoupons200ApplicationJSONAvailableAddresses `json:"availableAddresses,omitempty"`
	// Data can be edited.
	CanEditData *bool `json:"canEditData,omitempty"`
	// Object containing preferences from the client who placed the order.
	ClientPreferencesData *AddCoupons200ApplicationJSONClientPreferencesData `json:"clientPreferencesData,omitempty"`
	// Customer's profile information.
	ClientProfileData *AddCoupons200ApplicationJSONClientProfileData `json:"clientProfileData,omitempty"`
	...
	// Item metadata.
	ItemMetadata *AddCoupons200ApplicationJSONItemMetadata `json:"itemMetadata,omitempty"`
	// Information on each item in the order.
	Items []AddCoupons200ApplicationJSONItems `json:"items,omitempty"`
	// Object containing information about the ordering of items within the orderForm.
	ItemsOrdination *AddCoupons200ApplicationJSONItemsOrdination `json:"itemsOrdination,omitempty"`
	...
	MarketingData *AddCoupons200ApplicationJSONMarketingData `json:"marketingData,omitempty"`
	...
	PaymentData *AddCoupons200ApplicationJSONPaymentData `json:"paymentData,omitempty"`
	// Profile provider.
	ProfileProvider *string `json:"profileProvider,omitempty"`
	// Information on rates and benefits that apply to the order.
	RatesAndBenefitsData *AddCoupons200ApplicationJSONRatesAndBenefitsData `json:"ratesAndBenefitsData,omitempty"`
	...
	Sellers []AddCoupons200ApplicationJSONSellers `json:"sellers,omitempty"`
	// Shipping information pertinent to the order.
	ShippingData *AddCoupons200ApplicationJSONShippingData `json:"shippingData,omitempty"`
	// ID of the store.
