...
exports.UsersEssentials = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var UsersEssentials = /** @class */ (function () {
    function UsersEssentials(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    UsersEssentials.prototype.editUser = function (req, config) {
        var _a;
    ...
    **/
    UsersEssentials.prototype.editUserAlt1 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * getUser - Get a user
    **/
    UsersEssentials.prototype.getUser = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    UsersEssentials.prototype.getUserAlt1 = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/me";
        var client = this._securityClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
...
exports.UsersEssentials = UsersEssentials;
