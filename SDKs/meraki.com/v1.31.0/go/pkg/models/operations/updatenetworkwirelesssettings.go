...
func (e *UpdateNetworkWirelessSettings200ApplicationJSONUpgradeStrategyEnum) UnmarshalJSON(data []byte) error {
	...
	case "minimizeClientDowntime":
		fallthrough
	case "minimizeUpgradeTime":
		*e = UpdateNetworkWirelessSettings200ApplicationJSONUpgradeStrategyEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSettings200ApplicationJSONUpgradeStrategyEnum: %s", s)
	}
}
