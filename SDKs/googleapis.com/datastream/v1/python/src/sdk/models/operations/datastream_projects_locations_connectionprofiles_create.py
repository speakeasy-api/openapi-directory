...
class DatastreamProjectsLocationsConnectionProfilesCreateRequest:
    ...
    r"""Required. The parent that owns the collection of ConnectionProfiles."""  
    ...
    r"""Optional. Create the connection profile without validating it."""  
    ...
    r"""Optional. Only validate the connection profile, but don't create any resources. The default is false."""  
