...
class InlineScopedRouteConfigs:
    ...
    scoped_route_configs: Optional[list[dict[str, Any]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('scopedRouteConfigs') }})
