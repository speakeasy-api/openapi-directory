...
type ContentOrderreturnsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentOrderreturnsGetPathParams struct {
...
type ContentOrderreturnsGetQueryParams struct {
	// V1 error format.
...
type ContentOrderreturnsGetRequest struct {
...
type ContentOrderreturnsGetResponse struct {
	ContentType string
	// Successful response
