...
from ..shared import projectsortby_enum as shared_projectsortby_enum
from ..shared import projectsortorder_enum as shared_projectsortorder_enum
...
class ListProjectsInput:
    ...
    sort_by: Optional[shared_projectsortby_enum.ProjectSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
    sort_order: Optional[shared_projectsortorder_enum.ProjectSortOrderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortOrder'), 'exclude': lambda f: f is None }})  
