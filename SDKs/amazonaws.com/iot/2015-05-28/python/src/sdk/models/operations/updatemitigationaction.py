...
class UpdateMitigationActionRequestBody:
    action_params: Optional[UpdateMitigationActionRequestBodyActionParams] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('actionParams') }})
    role_arn: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('roleArn') }})
    

@dataclasses.dataclass
class UpdateMitigationActionRequest:
    headers: UpdateMitigationActionHeaders = dataclasses.field()
    path_params: UpdateMitigationActionPathParams = dataclasses.field()
    request: UpdateMitigationActionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
