...
public class GetManifestByIdResponseBody {
    ...
    public GetManifestByIdResponseBody(@JsonProperty("carrier_id") String carrierId, @JsonProperty("created_at") OffsetDateTime createdAt, @JsonProperty("form_id") String formId, @JsonProperty("label_ids") String[] labelIds, @JsonProperty("manifest_download") GetManifestByIdResponseBodyManifestDownload manifestDownload, @JsonProperty("manifest_id") String manifestId, @JsonProperty("ship_date") OffsetDateTime shipDate, @JsonProperty("shipments") Integer shipments, @JsonProperty("submission_id") String submissionId, @JsonProperty("warehouse_id") String warehouseId) {
        this.carrierId = carrierId;
        this.createdAt = createdAt;
        this.formId = formId;
        this.labelIds = labelIds;
