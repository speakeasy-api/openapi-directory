 ...
 */
public enum CreateEgressOnlyInternetGatewayRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateEgressOnlyInternetGatewayRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
