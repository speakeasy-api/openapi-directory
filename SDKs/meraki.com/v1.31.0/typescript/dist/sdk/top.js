...
var Top = /** @class */ (function () {
    function Top(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return the top 10 appliances sorted by utilization over given time range.
     */
    Top.prototype.getOrganizationSummaryTopAppliancesByUtilization = function (req, config) {
     ...
     * Return metrics for organization's top 10 clients by data usage (in mb) over given time range.
     */
    Top.prototype.getOrganizationSummaryTopClientsByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Return metrics for organization's top clients by data usage (in mb) over given time range, grouped by manufacturer.
     */
    Top.prototype.getOrganizationSummaryTopClientsManufacturersByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
     ...
     */
    Top.prototype.getOrganizationSummaryTopDevicesByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    Top.prototype.getOrganizationSummaryTopDevicesModelsByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    Top.prototype.getOrganizationSummaryTopSsidsByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    Top.prototype.getOrganizationSummaryTopSwitchesByEnergyUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
