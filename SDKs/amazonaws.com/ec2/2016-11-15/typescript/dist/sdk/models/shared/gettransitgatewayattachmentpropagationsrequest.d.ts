 ...
 */
export declare class GetTransitGatewayAttachmentPropagationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetTransitGatewayAttachmentPropagationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
