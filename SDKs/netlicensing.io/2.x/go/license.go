...
func (s *license) CreateLicense(ctx context.Context, request operations.CreateLicenseRequestBody, security operations.CreateLicenseSecurity) (*operations.CreateLicenseResponse, error) {
	baseURL := s.serverURL
