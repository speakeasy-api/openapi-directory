...
public class EmployeePayrollsOneRequest {
    ...
    public EmployeePayrollsOneRequest(@JsonProperty("employee_id") String employeeId, @JsonProperty("payroll_id") String payrollId, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.employeeId = employeeId;
        this.payrollId = payrollId;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
