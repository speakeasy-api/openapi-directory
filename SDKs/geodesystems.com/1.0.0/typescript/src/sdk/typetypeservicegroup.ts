...
export class TypeTypeServiceGroup {
  ...
  searchTypeServiceGroup(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_service_group";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeServiceGroupResponse =
        new operations.SearchTypeServiceGroupResponse({
