...
public class GETMassUpdaterRequest {
    ...
    public GETMassUpdaterRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETMassUpdaterRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETMassUpdaterRequest withBulkKey(String bulkKey) {
