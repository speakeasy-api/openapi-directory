...
class VideoVersionsUserPreferencesVideosPrivacy
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserPreferencesVideosPrivacyCommentsEnum $comments
     */
	#[\JMS\Serializer\Annotation\SerializedName('comments')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserPreferencesVideosPrivacyCommentsEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?VideoVersionsUserPreferencesVideosPrivacyCommentsEnum $comments = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserPreferencesVideosPrivacyEmbedEnum $embed
     */
	#[\JMS\Serializer\Annotation\SerializedName('embed')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserPreferencesVideosPrivacyEmbedEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?VideoVersionsUserPreferencesVideosPrivacyEmbedEnum $embed = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserPreferencesVideosPrivacyViewEnum $view
     */
	#[\JMS\Serializer\Annotation\SerializedName('view')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserPreferencesVideosPrivacyViewEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?VideoVersionsUserPreferencesVideosPrivacyViewEnum $view = null;
