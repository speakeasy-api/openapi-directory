...
class ListPostsRequest:
    ...
    r"""Load posts with an id lower than this value. Useful for pagination."""  
...
class ListPosts200ApplicationJSONLatestPosts:
    ...
    actions_summary: Optional[list[ListPosts200ApplicationJSONLatestPostsActionsSummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('actions_summary'), 'exclude': lambda f: f is None }})  
    ...
    topic_html_title: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('topic_html_title'), 'exclude': lambda f: f is None }})  
    ...
    topic_title: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('topic_title'), 'exclude': lambda f: f is None }})  
...
class ListPosts200ApplicationJSON:
    ...
    latest_posts: Optional[list[ListPosts200ApplicationJSONLatestPosts]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('latest_posts'), 'exclude': lambda f: f is None }})  
...
class ListPostsResponse:
    ...
    list_posts_200_application_json_object: Optional[ListPosts200ApplicationJSON] = dataclasses.field(default=None)
    r"""latest posts"""  
