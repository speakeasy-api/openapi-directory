...
class ListReceivedGrantsRequest:
    ...
    grant_arns: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('GrantArns'), 'exclude': lambda f: f is None }})  
