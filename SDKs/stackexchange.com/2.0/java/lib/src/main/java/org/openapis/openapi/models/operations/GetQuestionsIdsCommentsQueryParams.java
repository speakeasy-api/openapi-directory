...
public class GetQuestionsIdsCommentsQueryParams {
    /**
    ...
    public GetQuestionsIdsCommentsQueryParams withCallback(String callback) {
    ...
    public GetQuestionsIdsCommentsQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetQuestionsIdsCommentsQueryParams withFromdate(Long fromdate) {
    ...
    public String max;
    public GetQuestionsIdsCommentsQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetQuestionsIdsCommentsQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetQuestionsIdsCommentsOrderEnum order;
    public GetQuestionsIdsCommentsQueryParams withOrder(GetQuestionsIdsCommentsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetQuestionsIdsCommentsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetQuestionsIdsCommentsQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetQuestionsIdsCommentsQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetQuestionsIdsCommentsSortEnum sort;
    public GetQuestionsIdsCommentsQueryParams withSort(GetQuestionsIdsCommentsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetQuestionsIdsCommentsQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
