...
class GetQualificationTypeRequest:
    ...
    get_qualification_type_request: shared_getqualificationtyperequest.GetQualificationTypeRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
