...
class GetModifyIdentityIDFormatQueryParams:
    action: GetModifyIdentityIDFormatActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetModifyIdentityIDFormatVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetModifyIdentityIDFormatRequest:
    headers: GetModifyIdentityIDFormatHeaders = dataclasses.field()
    query_params: GetModifyIdentityIDFormatQueryParams = dataclasses.field()
