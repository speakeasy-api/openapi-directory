...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsAddCollaboratorRequest req = new ProjectsAddCollaboratorRequest(253625L, "numquam") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsCreateColumnRequest req = new ProjectsCreateColumnRequest(                new ProjectsCreateColumnRequestBody("Remaining tasks");, 637856L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsCreateForOrgRequest req = new ProjectsCreateForOrgRequest(                new ProjectsCreateForOrgRequestBody("dignissimos") {{
                                body = "optio";
                            }};, "necessitatibus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsCreateForRepoRequest req = new ProjectsCreateForRepoRequest(                new ProjectsCreateForRepoRequestBody("corporis") {{
                                body = "qui";
                            }};, "expedita", "voluptatum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsDeleteRequest req = new ProjectsDeleteRequest(587375L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsDeleteCardRequest req = new ProjectsDeleteCardRequest(326269L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsDeleteColumnRequest req = new ProjectsDeleteColumnRequest(809594L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsGetRequest req = new ProjectsGetRequest(316542L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsGetCardRequest req = new ProjectsGetCardRequest(204072L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsGetColumnRequest req = new ProjectsGetColumnRequest(446877L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsGetPermissionForUserRequest req = new ProjectsGetPermissionForUserRequest(796397L, "eum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListCardsRequest req = new ProjectsListCardsRequest(266408L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListCollaboratorsRequest req = new ProjectsListCollaboratorsRequest(978173L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListColumnsRequest req = new ProjectsListColumnsRequest(189753L) {{
                page = 289913L;
                perPage = 520875L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListForOrgRequest req = new ProjectsListForOrgRequest("occaecati") {{
                page = 375994L;
                perPage = 779180L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListForRepoRequest req = new ProjectsListForRepoRequest("minus", "fuga") {{
                page = 344530L;
                perPage = 669237L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListForUserRequest req = new ProjectsListForUserRequest("delectus") {{
                page = 735894L;
                perPage = 878601L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsMoveColumnRequest req = new ProjectsMoveColumnRequest(                new ProjectsMoveColumnRequestBody("last");, 865946L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsRemoveCollaboratorRequest req = new ProjectsRemoveCollaboratorRequest(362888L, "reprehenderit");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsUpdateRequest req = new ProjectsUpdateRequest(45234L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsUpdateCardRequest req = new ProjectsUpdateCardRequest(325297L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsUpdateColumnRequest req = new ProjectsUpdateColumnRequest(                new ProjectsUpdateColumnRequestBody("Remaining tasks");, 448369L);            
