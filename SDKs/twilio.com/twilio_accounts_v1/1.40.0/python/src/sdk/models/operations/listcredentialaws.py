...
class ListCredentialAwsListCredentialAwsResponse:
    ...
    credentials: Optional[list[shared_accounts_v1_credential_credential_aws.AccountsV1CredentialCredentialAws]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListCredentialAwsListCredentialAwsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
