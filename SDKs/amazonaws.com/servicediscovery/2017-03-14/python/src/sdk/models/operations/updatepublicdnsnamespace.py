...
class UpdatePublicDNSNamespaceRequest:
    ...
    update_public_dns_namespace_request: shared_updatepublicdnsnamespacerequest.UpdatePublicDNSNamespaceRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
