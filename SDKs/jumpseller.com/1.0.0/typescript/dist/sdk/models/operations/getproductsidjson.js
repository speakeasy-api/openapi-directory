...
exports.GetProductsIdJsonResponse = exports.GetProductsIdJsonRequest = void 0;
...
var GetProductsIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetProductsIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetProductsIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locale",
        }),
        __metadata("design:type", String)
    ], GetProductsIdJsonRequest.prototype, "locale", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetProductsIdJsonRequest.prototype, "login", void 0);
    return GetProductsIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetProductsIdJsonRequest = GetProductsIdJsonRequest;
var GetProductsIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], GetProductsIdJsonResponse.prototype, "rawResponse", void 0);
    return GetProductsIdJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetProductsIdJsonResponse = GetProductsIdJsonResponse;
