 ...
 */
public enum DescribeFleetsResultFleetsLaunchTemplateConfigsOverridesInstanceRequirementsLocalStorageEnum {
    INCLUDED("included"),
    REQUIRED("required"),
    EXCLUDED("excluded");
    ...
    private DescribeFleetsResultFleetsLaunchTemplateConfigsOverridesInstanceRequirementsLocalStorageEnum(String value) {
        this.value = value;
    }
}
