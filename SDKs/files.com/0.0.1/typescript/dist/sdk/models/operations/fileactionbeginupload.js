...
exports.FileActionBeginUploadResponse = exports.FileActionBeginUploadRequest = exports.FileActionBeginUploadRequestBody = exports.FileActionBeginUploadPathParams = void 0;
...
exports.FileActionBeginUploadPathParams = FileActionBeginUploadPathParams;
var FileActionBeginUploadRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=mkdir_parents" }),
        __metadata("design:type", Boolean)
    ], FileActionBeginUploadRequestBody.prototype, "mkdirParents", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=part" }),
        __metadata("design:type", Number)
    ], FileActionBeginUploadRequestBody.prototype, "part", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=parts" }),
        __metadata("design:type", Number)
    ], FileActionBeginUploadRequestBody.prototype, "parts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=ref" }),
        __metadata("design:type", String)
    ], FileActionBeginUploadRequestBody.prototype, "ref", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=restart" }),
        __metadata("design:type", Number)
    ], FileActionBeginUploadRequestBody.prototype, "restart", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=with_rename" }),
        __metadata("design:type", Boolean)
    ], FileActionBeginUploadRequestBody.prototype, "withRename", void 0);
    return FileActionBeginUploadRequestBody;
}(utils_1.SpeakeasyBase));
exports.FileActionBeginUploadRequestBody = FileActionBeginUploadRequestBody;
...
exports.FileActionBeginUploadRequest = FileActionBeginUploadRequest;
var FileActionBeginUploadResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.FileUploadPartEntity }),
...
exports.FileActionBeginUploadResponse = FileActionBeginUploadResponse;
