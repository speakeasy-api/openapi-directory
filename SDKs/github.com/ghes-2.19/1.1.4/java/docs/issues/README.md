...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesAddAssigneesRequest req = new IssuesAddAssigneesRequest(878870L, "tenetur", "dignissimos") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesAddLabelsRequest req = new IssuesAddLabelsRequest(708548L, "vero", "ducimus") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesCheckUserCanBeAssignedRequest req = new IssuesCheckUserCanBeAssignedRequest("aut", "voluptatibus", "exercitationem");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesCreateRequest req = new IssuesCreateRequest(                new IssuesCreateRequestBody(148141L) {{
                                assignee = "porro";
                                assignees = new String[]{{
                                    add("doloribus"),
                                    add("iusto"),
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesCreateCommentRequest req = new IssuesCreateCommentRequest(                new IssuesCreateCommentRequestBody("dicta");, 224317L, "maiores", "quasi");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesCreateLabelRequest req = new IssuesCreateLabelRequest(                new IssuesCreateLabelRequestBody("ex") {{
                                color = "nulla";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesCreateMilestoneRequest req = new IssuesCreateMilestoneRequest(                new IssuesCreateMilestoneRequestBody("sapiente") {{
                                description = "quisquam";
                                dueOn = OffsetDateTime.parse("2021-10-07T13:07:57.949Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesDeleteCommentRequest req = new IssuesDeleteCommentRequest(399499L, "inventore", "magnam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesDeleteLabelRequest req = new IssuesDeleteLabelRequest("ea", "quo", "consectetur");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesDeleteMilestoneRequest req = new IssuesDeleteMilestoneRequest(926213L, "aspernatur", "minima");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesGetRequest req = new IssuesGetRequest(53427L, "a", "libero");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesGetCommentRequest req = new IssuesGetCommentRequest(13948L, "aut", "deleniti");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesGetEventRequest req = new IssuesGetEventRequest(770581L, "aliquam", "fugit");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesGetLabelRequest req = new IssuesGetLabelRequest("accusamus", "inventore", "non");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesGetMilestoneRequest req = new IssuesGetMilestoneRequest(89603L, "dolorum", "laborum");            
    ...
    public static void main(String[] args) {
        try {
            ...
            IssuesListRequest req = new IssuesListRequest() {{
                ...
                perPage = 752135L;
                pulls = false;
                since = OffsetDateTime.parse("2021-05-05T09:22:07.208Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesListAssigneesRequest req = new IssuesListAssigneesRequest("libero", "quasi") {{
                page = 270328L;
                perPage = 256139L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesListCommentsRequest req = new IssuesListCommentsRequest(131482L, "provident", "ipsa") {{
                page = 476477L;
                perPage = 301598L;
                since = OffsetDateTime.parse("2022-09-27T07:50:41.350Z");
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesListCommentsForRepoRequest req = new IssuesListCommentsForRepoRequest("esse", "esse") {{
                direction = IssuesListCommentsForRepoDirectionEnum.DESC;
                page = 683282L;
                perPage = 442015L;
                since = OffsetDateTime.parse("2021-04-18T13:50:09.955Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesListEventsRequest req = new IssuesListEventsRequest(433439L, "suscipit", "assumenda") {{
                page = 181151L;
                perPage = 509342L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesListEventsForRepoRequest req = new IssuesListEventsForRepoRequest("quisquam", "veritatis") {{
                page = 56848L;
                perPage = 660040L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesListEventsForTimelineRequest req = new IssuesListEventsForTimelineRequest(696997L, "neque", "quo") {{
                page = 847276L;
                perPage = 777408L;
            }};            
    ...
    public static void main(String[] args) {
        try {
            ...
            IssuesListForAuthenticatedUserRequest req = new IssuesListForAuthenticatedUserRequest() {{
                direction = DirectionEnum.DESC;
                filter = IssuesListForAuthenticatedUserFilterEnum.CREATED;
                labels = "eos";
                page = 373813L;
                perPage = 69859L;
                since = OffsetDateTime.parse("2022-12-24T22:15:46.522Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesListForOrgRequest req = new IssuesListForOrgRequest("ipsam") {{
                direction = DirectionEnum.ASC;
                filter = IssuesListForOrgFilterEnum.CREATED;
                labels = "quo";
                page = 459856L;
                perPage = 925164L;
                since = OffsetDateTime.parse("2022-04-14T23:02:02.692Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesListForRepoRequest req = new IssuesListForRepoRequest("inventore", "nihil") {{
                assignee = "totam";
                creator = "accusamus";
                direction = DirectionEnum.ASC;
                labels = "odio";
                ...
                page = 959434L;
                perPage = 174112L;
                since = OffsetDateTime.parse("2022-01-19T00:55:43.636Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesListLabelsForMilestoneRequest req = new IssuesListLabelsForMilestoneRequest(430402L, "quas", "praesentium") {{
                page = 159867L;
                perPage = 536178L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesListLabelsForRepoRequest req = new IssuesListLabelsForRepoRequest("fugit", "fuga") {{
                page = 649463L;
                perPage = 277596L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesListLabelsOnIssueRequest req = new IssuesListLabelsOnIssueRequest(539224L, "explicabo", "minima") {{
                page = 392676L;
                perPage = 147014L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesListMilestonesRequest req = new IssuesListMilestonesRequest("sapiente", "consequuntur") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesLockRequest req = new IssuesLockRequest(92260L, "esse", "eveniet") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesRemoveAllLabelsRequest req = new IssuesRemoveAllLabelsRequest(82971L, "esse", "quod");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesRemoveAssigneesRequest req = new IssuesRemoveAssigneesRequest(724168L, "vero", "aliquid") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesRemoveLabelRequest req = new IssuesRemoveLabelRequest(426306L, "harum", "molestiae", "rerum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesSetLabelsRequest req = new IssuesSetLabelsRequest(580197L, "minima", "distinctio") {{
                requestBody = new org.openapis.openapi.models.operations.IssuesSetLabelsRequestBody4[]{{
                    add(new IssuesSetLabelsRequestBody4("consequatur") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesUnlockRequest req = new IssuesUnlockRequest(796392L, "quaerat", "sapiente");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesUpdateRequest req = new IssuesUpdateRequest(232865L, "esse", "blanditiis") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesUpdateCommentRequest req = new IssuesUpdateCommentRequest(                new IssuesUpdateCommentRequestBody("ex");, 536275L, "itaque", "dolorum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesUpdateLabelRequest req = new IssuesUpdateLabelRequest("architecto", "omnis", "tenetur") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesUpdateMilestoneRequest req = new IssuesUpdateMilestoneRequest(454162L, "ipsa", "minima") {{
                requestBody = new IssuesUpdateMilestoneRequestBody() {{
                    description = "veritatis";
                    dueOn = OffsetDateTime.parse("2022-10-06T10:21:42.350Z");
