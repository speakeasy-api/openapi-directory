...
class GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesAvailToSellQty:
    ...
    r"""Inventory Count"""  
    unit: GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesAvailToSellQtyUnitEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('unit') }})
    r"""The unit of measurement. Example: 'EACH'"""  
...
class GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesErrors:
    ...
    category: Optional[GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesErrorsCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category'), 'exclude': lambda f: f is None }})  
    causes: Optional[list[GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesErrorsCauses]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('causes'), 'exclude': lambda f: f is None }})  
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('description'), 'exclude': lambda f: f is None }})  
    ...
    severity: Optional[GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesErrorsSeverityEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('severity'), 'exclude': lambda f: f is None }})  
...
class GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesInputQty:
    ...
    amount: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('amount') }})
    r"""Inventory Count"""  
    unit: GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesInputQtyUnitEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('unit') }})
    r"""The unit of measurement. Example: 'EACH'"""  
    
class GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesReservedQtyUnitEnum(str, Enum):
    r"""The unit of measurement. Example: 'EACH'"""
    EACH = 'EACH'
...
class GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesReservedQty:
    ...
    amount: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('amount') }})
    r"""Inventory Count"""  
    unit: GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesReservedQtyUnitEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('unit') }})
    r"""The unit of measurement. Example: 'EACH'"""  
...
class GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodes:
    ...
    avail_to_sell_qty: Optional[GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesAvailToSellQty] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('availToSellQty'), 'exclude': lambda f: f is None }})
    r"""Quantity of an item that is available to be allocated to orders"""  
    errors: Optional[list[GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errors'), 'exclude': lambda f: f is None }})  
    input_qty: Optional[GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesInputQty] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('inputQty'), 'exclude': lambda f: f is None }})
    r"""Quantity of an item that is input by the seller"""  
    reserved_qty: Optional[GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodesReservedQty] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reservedQty'), 'exclude': lambda f: f is None }})
    r"""Quantity that has been ordered by the customers but not yet shipped"""  
...
class GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSON:
    ...
    nodes: Optional[list[GetMultiNodeInventoryForSkuAndAllShipnodes200ApplicationJSONNodes]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('nodes'), 'exclude': lambda f: f is None }})  
