...
class GetPortfolioVideosRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetPortfolioVideosFilterEnum $filter
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=filter')]
    public ?GetPortfolioVideosFilterEnum $filter = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetPortfolioVideosSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?GetPortfolioVideosSortEnum $sort = null;
