...
func (e ConnectionConfigurationDefaultsTargetEnum) ToPointer() *ConnectionConfigurationDefaultsTargetEnum {
	return &e
}
...
func (e *ConnectionConfigurationDefaultsTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "custom_fields":
		fallthrough
	case "resource":
		*e = ConnectionConfigurationDefaultsTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ConnectionConfigurationDefaultsTargetEnum: %v", v)
	}
}
