...
public class SDK {
     ...
     */
    public org.openapis.openapi.models.operations.ListRealtimeContactAnalysisSegmentsResponse listRealtimeContactAnalysisSegments(org.openapis.openapi.models.operations.ListRealtimeContactAnalysisSegmentsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/realtime-contact-analysis/analysis-segments");
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ListRealtimeContactAnalysisSegmentsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.ListRealtimeContactAnalysisSegmentsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.ListRealtimeContactAnalysisSegmentsResponse.class);
