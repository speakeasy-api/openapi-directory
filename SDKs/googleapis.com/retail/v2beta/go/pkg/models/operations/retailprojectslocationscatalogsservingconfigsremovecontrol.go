...
type RetailProjectsLocationsCatalogsServingConfigsRemoveControlSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RetailProjectsLocationsCatalogsServingConfigsRemoveControlPathParams struct {
...
type RetailProjectsLocationsCatalogsServingConfigsRemoveControlQueryParams struct {
	// V1 error format.
...
type RetailProjectsLocationsCatalogsServingConfigsRemoveControlRequest struct {
	...
	Request     *shared.GoogleCloudRetailV2betaRemoveControlRequest `request:"mediaType=application/json"`
	Security    RetailProjectsLocationsCatalogsServingConfigsRemoveControlSecurity
}

type RetailProjectsLocationsCatalogsServingConfigsRemoveControlResponse struct {
	ContentType string
	// Successful response
