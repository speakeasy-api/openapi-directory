...
type GETValidateTemplateQueryParams struct {
...
type GETValidateTemplateHeaders struct {
...
type GETValidateTemplateRequest struct {
	QueryParams GETValidateTemplateQueryParams
	Headers     GETValidateTemplateHeaders
}
