...
public class ListRecordingAddOnResultPayloadRequest {
    ...
    public ListRecordingAddOnResultPayloadRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("AddOnResultSid") String addOnResultSid, @JsonProperty("ReferenceSid") String referenceSid) {
        this.accountSid = accountSid;
        this.addOnResultSid = addOnResultSid;
        this.referenceSid = referenceSid;
  }
