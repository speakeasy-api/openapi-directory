...
func (e ListBatchInferenceJobsXAmzTargetEnum) ToPointer() *ListBatchInferenceJobsXAmzTargetEnum {
	return &e
}
...
func (e *ListBatchInferenceJobsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonPersonalize.ListBatchInferenceJobs":
		*e = ListBatchInferenceJobsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListBatchInferenceJobsXAmzTargetEnum: %v", v)
	}
}

type ListBatchInferenceJobsRequest struct {
	ListBatchInferenceJobsRequest shared.ListBatchInferenceJobsRequest `request:"mediaType=application/json"`
