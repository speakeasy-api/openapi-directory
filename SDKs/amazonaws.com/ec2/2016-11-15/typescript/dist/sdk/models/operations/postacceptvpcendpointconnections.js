...
exports.POSTAcceptVpcEndpointConnectionsResponse = exports.POSTAcceptVpcEndpointConnectionsRequest = exports.POSTAcceptVpcEndpointConnectionsVersionEnum = exports.POSTAcceptVpcEndpointConnectionsActionEnum = void 0;
...
var POSTAcceptVpcEndpointConnectionsRequest = /** @class */ (function (_super) {
    ...
    ], POSTAcceptVpcEndpointConnectionsRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=text/xml" }),
        __metadata("design:type", Uint8Array)
    ], POSTAcceptVpcEndpointConnectionsRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], POSTAcceptVpcEndpointConnectionsRequest.prototype, "version", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], POSTAcceptVpcEndpointConnectionsRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], POSTAcceptVpcEndpointConnectionsRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], POSTAcceptVpcEndpointConnectionsRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], POSTAcceptVpcEndpointConnectionsRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], POSTAcceptVpcEndpointConnectionsRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], POSTAcceptVpcEndpointConnectionsRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], POSTAcceptVpcEndpointConnectionsRequest.prototype, "xAmzSignedHeaders", void 0);
...
var POSTAcceptVpcEndpointConnectionsResponse = /** @class */ (function (_super) {
    ...
    ], POSTAcceptVpcEndpointConnectionsResponse.prototype, "rawResponse", void 0);
