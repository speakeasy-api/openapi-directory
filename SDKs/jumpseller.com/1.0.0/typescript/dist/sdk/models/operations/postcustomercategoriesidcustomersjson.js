...
exports.PostCustomerCategoriesIdCustomersJsonResponse = exports.PostCustomerCategoriesIdCustomersJsonRequest = void 0;
...
var PostCustomerCategoriesIdCustomersJsonRequest = /** @class */ (function (_super) {
    ...
    ], PostCustomerCategoriesIdCustomersJsonRequest.prototype, "customersToCustomerCategory", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PostCustomerCategoriesIdCustomersJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PostCustomerCategoriesIdCustomersJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PostCustomerCategoriesIdCustomersJsonRequest.prototype, "login", void 0);
    return PostCustomerCategoriesIdCustomersJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PostCustomerCategoriesIdCustomersJsonRequest = PostCustomerCategoriesIdCustomersJsonRequest;
var PostCustomerCategoriesIdCustomersJsonResponse = /** @class */ (function (_super) {
    ...
    ], PostCustomerCategoriesIdCustomersJsonResponse.prototype, "rawResponse", void 0);
    return PostCustomerCategoriesIdCustomersJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PostCustomerCategoriesIdCustomersJsonResponse = PostCustomerCategoriesIdCustomersJsonResponse;
