...
class GetWorkspaceSlugMembersRequest
{
    ...
    public ?string $activitiesCountMax = null;
    
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=activities_count_min')]
    public ?string $activitiesCountMin = null;
    
    /**
     * Comma separated list of activity types
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetWorkspaceSlugMembersActivityTypeEnum $activityType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=activity_type')]
    public ?GetWorkspaceSlugMembersActivityTypeEnum $activityType = null;
    
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=affiliation')]
    public ?GetWorkspaceSlugMembersAffiliationEnum $affiliation = null;
    ...
    public ?GetWorkspaceSlugMembersDirectionEnum $direction = null;
    ...
    public ?GetWorkspaceSlugMembersIdentityEnum $identity = null;
    
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=items')]
    public ?GetWorkspaceSlugMembersItemsEnum $items = null;
    ...
    public ?GetWorkspaceSlugMembersSortEnum $sort = null;
	...
	{
		$this->activitiesCountMax = null;
		$this->activitiesCountMin = null;
