...
class GetarchivedbycouponcodeRequest:
...
class GetarchivedbycouponcodeResponse:
    ...
    getarchivedbycouponcode_200_application_json_object: Optional[Getarchivedbycouponcode200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""  
