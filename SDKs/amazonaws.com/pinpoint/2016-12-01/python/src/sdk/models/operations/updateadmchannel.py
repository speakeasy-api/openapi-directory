...
from ..shared import updateadmchannelresponse as shared_updateadmchannelresponse
...
class UpdateAdmChannelRequestBody:
    adm_channel_request: UpdateAdmChannelRequestBodyAdmChannelRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ADMChannelRequest') }})
    

@dataclasses.dataclass
class UpdateAdmChannelRequest:
    headers: UpdateAdmChannelHeaders = dataclasses.field()
    path_params: UpdateAdmChannelPathParams = dataclasses.field()
    request: UpdateAdmChannelRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateAdmChannelResponse:
    ...
    update_adm_channel_response: Optional[shared_updateadmchannelresponse.UpdateAdmChannelResponse] = dataclasses.field(default=None)
