...
class AutoScalingGroupRecommendationOption:
    r"""Describes a recommendation option for an Auto Scaling group."""
    
    configuration: Optional[shared_autoscalinggroupconfiguration.AutoScalingGroupConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('configuration'), 'exclude': lambda f: f is None }})  
