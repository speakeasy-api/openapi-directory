...
public class CreateInfrastructureConfigurationRequestBody {
    ...
    public CreateInfrastructureConfigurationRequestBody(@JsonProperty("clientToken") String clientToken, @JsonProperty("instanceProfileName") String instanceProfileName, @JsonProperty("name") String name) {
        this.clientToken = clientToken;
        this.instanceProfileName = instanceProfileName;
        this.name = name;
  }
