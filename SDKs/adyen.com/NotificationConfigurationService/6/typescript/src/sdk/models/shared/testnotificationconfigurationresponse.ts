...
export enum TestNotificationConfigurationResponseEventTypesEnum {
 ...
 */
export class TestNotificationConfigurationResponse extends SpeakeasyBase {
  /**
  ...
  eventTypes?: TestNotificationConfigurationResponseEventTypesEnum[];

  /**
   * The notification message and related response messages.
   */
  @SpeakeasyMetadata({ elemType: ExchangeMessage })
  @Expose({ name: "exchangeMessages" })
