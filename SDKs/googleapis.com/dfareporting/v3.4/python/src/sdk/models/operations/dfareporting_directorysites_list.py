...
from ..shared import security as shared_security
from ..shared import directorysiteslistresponse as shared_directorysiteslistresponse
...
class DfareportingDirectorySitesListQueryParams:
    ...
    dfp_network_code: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'dfpNetworkCode', 'style': 'form', 'explode': True }})
    ...
    sort_field: Optional[DfareportingDirectorySitesListSortFieldEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sortField', 'style': 'form', 'explode': True }})
    sort_order: Optional[DfareportingDirectorySitesListSortOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sortOrder', 'style': 'form', 'explode': True }})
...
class DfareportingDirectorySitesListRequest:
    path_params: DfareportingDirectorySitesListPathParams = dataclasses.field()
    query_params: DfareportingDirectorySitesListQueryParams = dataclasses.field()
    security: DfareportingDirectorySitesListSecurity = dataclasses.field()
...
class DfareportingDirectorySitesListResponse:
    ...
    directory_sites_list_response: Optional[shared_directorysiteslistresponse.DirectorySitesListResponse] = dataclasses.field(default=None)
