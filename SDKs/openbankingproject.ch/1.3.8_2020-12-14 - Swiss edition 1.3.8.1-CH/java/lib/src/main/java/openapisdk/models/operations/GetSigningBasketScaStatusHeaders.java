...
public class GetSigningBasketScaStatusHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Digest")
    public String digest;
    public GetSigningBasketScaStatusHeaders withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-Accept")
    public String psuAccept;
    public GetSigningBasketScaStatusHeaders withPsuAccept(String psuAccept) {
    ...
    public GetSigningBasketScaStatusHeaders withPsuAcceptCharset(String psuAcceptCharset) {
    ...
    public GetSigningBasketScaStatusHeaders withPsuAcceptEncoding(String psuAcceptEncoding) {
    ...
    public GetSigningBasketScaStatusHeaders withPsuAcceptLanguage(String psuAcceptLanguage) {
    ...
    public GetSigningBasketScaStatusHeaders withPsuDeviceId(String psuDeviceID) {
    ...
    public GetSigningBasketScaStatusHeaders withPsuGeoLocation(String psuGeoLocation) {
    ...
    public GetSigningBasketScaStatusHeaders withPsuHttpMethod(openapisdk.models.shared.PsuHttpMethodEnum psuHttpMethod) {
    ...
    public GetSigningBasketScaStatusHeaders withPsuIpAddress(String psuIPAddress) {
        this.psuIPAddress = psuIPAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-IP-Port")
    public String psuIPPort;
    public GetSigningBasketScaStatusHeaders withPsuIpPort(String psuIPPort) {
    ...
    public GetSigningBasketScaStatusHeaders withPsuUserAgent(String psuUserAgent) {
        this.psuUserAgent = psuUserAgent;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Signature")
    public String signature;
    public GetSigningBasketScaStatusHeaders withSignature(String signature) {
    ...
    public GetSigningBasketScaStatusHeaders withTppSignatureCertificate(String tppSignatureCertificate) {
    ...
    public GetSigningBasketScaStatusHeaders withXRequestId(String xRequestID) {
