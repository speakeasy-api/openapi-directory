...
class GetMergeCommitOutput:
    ...
    merged_commit_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mergedCommitId'), 'exclude': lambda f: f is None }})  
