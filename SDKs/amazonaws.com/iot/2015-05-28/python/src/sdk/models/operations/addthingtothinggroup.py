...
class AddThingToThingGroupHeaders:
...
class AddThingToThingGroupRequest:
    headers: AddThingToThingGroupHeaders = dataclasses.field()
    request: AddThingToThingGroupRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
