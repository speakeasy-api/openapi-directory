...
exports.GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedResponse = exports.GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedRequest = void 0;
...
var GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedRequest = /** @class */ (function (_super) {
    ...
    ], GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=realm",
        }),
        __metadata("design:type", String)
    ], GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedRequest.prototype, "realm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=roleContainerId",
        }),
        __metadata("design:type", String)
    ], GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedRequest.prototype, "roleContainerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=scope" }),
        __metadata("design:type", String)
    ], GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedRequest.prototype, "scope", void 0);
    return GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedRequest;
}(utils_1.SpeakeasyBase));
exports.GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedRequest = GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedRequest;
var GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedResponse = /** @class */ (function (_super) {
    ...
    ], GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedResponse.prototype, "rawResponse", void 0);
    return GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedResponse;
}(utils_1.SpeakeasyBase));
exports.GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedResponse = GetRealmClientsIdEvaluateScopesScopeMappingsRoleContainerIdGrantedResponse;
