...
exports.CertificateDeleteResponse = exports.CertificateDeleteRequest = void 0;
...
var CertificateDeleteRequest = /** @class */ (function (_super) {
    ...
    ], CertificateDeleteRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], CertificateDeleteRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], CertificateDeleteRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], CertificateDeleteRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=thumbprint",
        }),
        __metadata("design:type", String)
    ], CertificateDeleteRequest.prototype, "thumbprint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=thumbprintAlgorithm",
        }),
        __metadata("design:type", String)
    ], CertificateDeleteRequest.prototype, "thumbprintAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], CertificateDeleteRequest.prototype, "timeout", void 0);
...
var CertificateDeleteResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CertificateDeleteResponse.prototype, "rawResponse", void 0);
