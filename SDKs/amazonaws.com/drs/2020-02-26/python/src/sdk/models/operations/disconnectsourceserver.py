...
class DisconnectSourceServerRequestBody:
    
    source_server_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceServerID') }})
    r"""The ID of the Source Server to disconnect."""  
    

@dataclasses.dataclass
class DisconnectSourceServerRequest:
    
    request_body: DisconnectSourceServerRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
