...
public class GetItemFeedHeaders {
    /**
    ...
    public GetItemFeedHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public String range;
    public GetItemFeedHeaders withRange(String range) {
        this.range = range;
        return this;
    }
    ...
    public GetItemFeedHeaders withXEbayCMarketplaceId(String xEbayCMarketplaceId) {
