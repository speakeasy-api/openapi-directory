...
class PUTSuspendSubscriptionRequest:
    ...
    put_subscription_suspend_type: shared_putsubscriptionsuspendtype.PUTSubscriptionSuspendType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
