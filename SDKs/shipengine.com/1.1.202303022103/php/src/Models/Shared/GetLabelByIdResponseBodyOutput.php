...
class GetLabelByIdResponseBodyOutput
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyDisplaySchemeEnum $displayScheme
     */
	#[\JMS\Serializer\Annotation\SerializedName('display_scheme')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyDisplaySchemeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetLabelByIdResponseBodyDisplaySchemeEnum $displayScheme = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyOptionalLink $formDownload
     */
	#[\JMS\Serializer\Annotation\SerializedName('form_download')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyOptionalLink')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetLabelByIdResponseBodyOptionalLink $formDownload = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyOptionalLink $insuranceClaim
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_claim')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyOptionalLink')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetLabelByIdResponseBodyOptionalLink $insuranceClaim = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyMonetaryValue $insuranceCost
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_cost')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyMonetaryValue')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetLabelByIdResponseBodyMonetaryValue $insuranceCost = null;
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyLabelDownload')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetLabelByIdResponseBodyLabelDownload $labelDownload = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyLabelFormatEnum $labelFormat
     */
	#[\JMS\Serializer\Annotation\SerializedName('label_format')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyLabelFormatEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetLabelByIdResponseBodyLabelFormatEnum $labelFormat = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyLabelLayoutEnum $labelLayout
     */
	#[\JMS\Serializer\Annotation\SerializedName('label_layout')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyLabelLayoutEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetLabelByIdResponseBodyLabelLayoutEnum $labelLayout = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyMonetaryValue $shipmentCost
     */
	#[\JMS\Serializer\Annotation\SerializedName('shipment_cost')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyMonetaryValue')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetLabelByIdResponseBodyMonetaryValue $shipmentCost = null;
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyLabelStatusEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetLabelByIdResponseBodyLabelStatusEnum $status = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyTrackingStatusEnum $trackingStatus
     */
	#[\JMS\Serializer\Annotation\SerializedName('tracking_status')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetLabelByIdResponseBodyTrackingStatusEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetLabelByIdResponseBodyTrackingStatusEnum $trackingStatus = null;
