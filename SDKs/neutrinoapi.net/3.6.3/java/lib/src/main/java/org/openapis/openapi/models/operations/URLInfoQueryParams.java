...
public class URLInfoQueryParams {
    /**
    ...
    public URLInfoQueryParams withFetchContent(Boolean fetchContent) {
    ...
    public URLInfoQueryParams withIgnoreCertificateErrors(Boolean ignoreCertificateErrors) {
    ...
    public URLInfoQueryParams withRetry(Integer retry) {
        this.retry = retry;
        return this;
    }
    ...
    public URLInfoQueryParams withTimeout(Integer timeout) {
    ...
    public String url;
    public URLInfoQueryParams withUrl(String url) {
        this.url = url;
        return this;
    }
