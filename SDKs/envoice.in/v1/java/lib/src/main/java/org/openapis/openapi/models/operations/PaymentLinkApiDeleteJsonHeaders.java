...
public class PaymentLinkApiDeleteJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PaymentLinkApiDeleteJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public PaymentLinkApiDeleteJsonHeaders withXAuthSecret(String xAuthSecret) {
