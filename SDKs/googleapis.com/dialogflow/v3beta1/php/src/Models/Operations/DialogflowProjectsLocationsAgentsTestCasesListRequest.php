...
class DialogflowProjectsLocationsAgentsTestCasesListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DialogflowProjectsLocationsAgentsTestCasesListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?DialogflowProjectsLocationsAgentsTestCasesListViewEnum $view = null;
