...
exports.PoolEvaluateAutoScaleResponse = exports.PoolEvaluateAutoScaleRequest = void 0;
...
var PoolEvaluateAutoScaleRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", shared.PoolEvaluateAutoScaleParameter)
    ], PoolEvaluateAutoScaleRequest.prototype, "poolEvaluateAutoScaleParameter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=api-version",
        }),
        __metadata("design:type", String)
    ], PoolEvaluateAutoScaleRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], PoolEvaluateAutoScaleRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], PoolEvaluateAutoScaleRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=poolId",
        }),
        __metadata("design:type", String)
    ], PoolEvaluateAutoScaleRequest.prototype, "poolId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], PoolEvaluateAutoScaleRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], PoolEvaluateAutoScaleRequest.prototype, "timeout", void 0);
    return PoolEvaluateAutoScaleRequest;
}(utils_1.SpeakeasyBase));
exports.PoolEvaluateAutoScaleRequest = PoolEvaluateAutoScaleRequest;
var PoolEvaluateAutoScaleResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.AutoScaleRun)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], PoolEvaluateAutoScaleResponse.prototype, "rawResponse", void 0);
    return PoolEvaluateAutoScaleResponse;
}(utils_1.SpeakeasyBase));
exports.PoolEvaluateAutoScaleResponse = PoolEvaluateAutoScaleResponse;
