 ...
 */
public enum CreateCapacityReservationFleetRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateCapacityReservationFleetRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
