...
var Files = /** @class */ (function () {
    ...
    **/
    Files.prototype.driveFilesInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Files.prototype.driveFilesPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Files.prototype.driveFilesTouch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DriveFilesTouchRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/files/{fileId}/touch", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
    ...
    **/
    Files.prototype.driveFilesTrash = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DriveFilesTrashRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/files/{fileId}/trash", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "post" }, requestConfig));
    ...
    **/
    Files.prototype.driveFilesUntrash = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DriveFilesUntrashRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/files/{fileId}/untrash", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "post" }, requestConfig));
