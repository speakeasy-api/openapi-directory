...
var LeaveLine = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "AnnualNumberOfUnits" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "EntitlementFinalPayPayoutType" }),
        __metadata("design:type", String)
    ], LeaveLine.prototype, "entitlementFinalPayPayoutType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "FullTimeNumberOfUnitsPerPeriod" }),
        __metadata("design:type", Number)
    ], LeaveLine.prototype, "fullTimeNumberOfUnitsPerPeriod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "IncludeSuperannuationGuaranteeContribution" }),
