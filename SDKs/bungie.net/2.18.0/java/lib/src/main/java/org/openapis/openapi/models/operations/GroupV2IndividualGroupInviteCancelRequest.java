...
public class GroupV2IndividualGroupInviteCancelRequest {
    ...
    public GroupV2IndividualGroupInviteCancelRequest(@JsonProperty("groupId") Long groupId, @JsonProperty("membershipId") Long membershipId, @JsonProperty("membershipType") Integer membershipType) {
        this.groupId = groupId;
        this.membershipId = membershipId;
        this.membershipType = membershipType;
  }
