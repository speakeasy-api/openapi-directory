...
var OrgChartSpec = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "nodeColor" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "nodeColorStyle" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "selectedNodeColor" }),
        (0, class_transformer_1.Type)(function () { return color_1.Color; }),
        __metadata("design:type", color_1.Color)
    ], OrgChartSpec.prototype, "selectedNodeColor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "selectedNodeColorStyle" }),
        (0, class_transformer_1.Type)(function () { return colorstyle_1.ColorStyle; }),
        __metadata("design:type", colorstyle_1.ColorStyle)
    ], OrgChartSpec.prototype, "selectedNodeColorStyle", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "tooltips" }),
        (0, class_transformer_1.Type)(function () { return chartdata_1.ChartData; }),
        __metadata("design:type", chartdata_1.ChartData)
