...
exports.CreateSubscriptionDefinitionResponse = void 0;
...
var CreateSubscriptionDefinitionResponse = /** @class */ (function (_super) {
    ...
    ], CreateSubscriptionDefinitionResponse.prototype, "arn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CreationTimestamp" }),
        __metadata("design:type", String)
    ], CreateSubscriptionDefinitionResponse.prototype, "creationTimestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Id" }),
        __metadata("design:type", String)
    ], CreateSubscriptionDefinitionResponse.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=LastUpdatedTimestamp" }),
        __metadata("design:type", String)
    ], CreateSubscriptionDefinitionResponse.prototype, "lastUpdatedTimestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=LatestVersion" }),
        __metadata("design:type", String)
    ], CreateSubscriptionDefinitionResponse.prototype, "latestVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=LatestVersionArn" }),
        __metadata("design:type", String)
    ], CreateSubscriptionDefinitionResponse.prototype, "latestVersionArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], CreateSubscriptionDefinitionResponse.prototype, "name", void 0);
