...
class ModifyWorkspacePropertiesRequest:
    ...
    modify_workspace_properties_request: shared_modifyworkspacepropertiesrequest.ModifyWorkspacePropertiesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ModifyWorkspacePropertiesResponse:
    ...
    r"""UnsupportedWorkspaceConfigurationException"""  
