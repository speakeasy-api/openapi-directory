...
var Wireless = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=agent_name" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=essid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_agent_id" }),
        __metadata("design:type", String)
    ], Wireless.prototype, "lastAgentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_seen" }),
        __metadata("design:type", Number)
    ], Wireless.prototype, "lastSeen", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_task_id" }),
        __metadata("design:type", String)
    ], Wireless.prototype, "lastTaskId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=org_name" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=signal" }),
        __metadata("design:type", Number)
