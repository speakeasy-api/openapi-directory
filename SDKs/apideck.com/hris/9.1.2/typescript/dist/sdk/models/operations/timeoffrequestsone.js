...
exports.TimeOffRequestsOneResponse = exports.TimeOffRequestsOneRequest = exports.TimeOffRequestsOneSecurity = void 0;
...
exports.TimeOffRequestsOneSecurity = TimeOffRequestsOneSecurity;
var TimeOffRequestsOneRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], TimeOffRequestsOneRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], TimeOffRequestsOneRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], TimeOffRequestsOneRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], TimeOffRequestsOneRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], TimeOffRequestsOneRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], TimeOffRequestsOneRequest.prototype, "xApideckServiceId", void 0);
    return TimeOffRequestsOneRequest;
}(utils_1.SpeakeasyBase));
exports.TimeOffRequestsOneRequest = TimeOffRequestsOneRequest;
var TimeOffRequestsOneResponse = /** @class */ (function (_super) {
    ...
    ], TimeOffRequestsOneResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.TimeOffRequestsOneResponse = TimeOffRequestsOneResponse;
