...
public class Scroll {
    ...
    public org.openapis.openapi.models.operations.ScrolldocumentsResponse scrolldocuments(org.openapis.openapi.models.operations.ScrolldocumentsRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ScrolldocumentsRequest.class, baseUrl, "/api/dataentities/{dataEntityName}/scroll", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ScrolldocumentsRequest.class, request, null);
        if (queryParams != null) {
