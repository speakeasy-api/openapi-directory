...
class Projects 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\WorkflowsProjectsLocationsListResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{name}/locations', \OpenAPI\OpenAPI\Models\Operations\WorkflowsProjectsLocationsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{name}/operations', \OpenAPI\OpenAPI\Models\Operations\WorkflowsProjectsLocationsOperationsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{parent}/workflows', \OpenAPI\OpenAPI\Models\Operations\WorkflowsProjectsLocationsWorkflowsCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{name}', \OpenAPI\OpenAPI\Models\Operations\WorkflowsProjectsLocationsWorkflowsDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{name}', \OpenAPI\OpenAPI\Models\Operations\WorkflowsProjectsLocationsWorkflowsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{parent}/workflows', \OpenAPI\OpenAPI\Models\Operations\WorkflowsProjectsLocationsWorkflowsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{name}', \OpenAPI\OpenAPI\Models\Operations\WorkflowsProjectsLocationsWorkflowsPatchRequest::class, $request);
