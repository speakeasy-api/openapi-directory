...
class UpdateGoalRequestBodyInput:
    r"""The updated fields for the goal."""
    
    data: Optional[shared_goalrequest.GoalRequestInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
...
class UpdateGoalRequest:
    ...
    request_body: UpdateGoalRequestBodyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The updated fields for the goal."""  
...
class UpdateGoal200ApplicationJSON:
    r"""Successfully updated the goal."""
