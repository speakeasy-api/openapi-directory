...
var ServiceCredentialTypesCollection = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: servicecredentialtype_1.ServiceCredentialType }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return servicecredentialtype_1.ServiceCredentialType; }),
