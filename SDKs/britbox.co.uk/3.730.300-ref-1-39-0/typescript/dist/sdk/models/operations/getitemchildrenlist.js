...
exports.GetItemChildrenListResponse = exports.GetItemChildrenListRequest = void 0;
...
var GetItemChildrenListRequest = /** @class */ (function (_super) {
    ...
    ], GetItemChildrenListRequest.prototype, "device", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=false;name=ff" }),
        __metadata("design:type", Array)
    ], GetItemChildrenListRequest.prototype, "ff", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], GetItemChildrenListRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=lang" }),
        __metadata("design:type", String)
    ], GetItemChildrenListRequest.prototype, "lang", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=max_rating",
        }),
        __metadata("design:type", String)
    ], GetItemChildrenListRequest.prototype, "maxRating", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=order" }),
        __metadata("design:type", String)
    ], GetItemChildrenListRequest.prototype, "order", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetItemChildrenListRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], GetItemChildrenListRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=segments",
        }),
        __metadata("design:type", Array)
    ], GetItemChildrenListRequest.prototype, "segments", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sub" }),
        __metadata("design:type", String)
    ], GetItemChildrenListRequest.prototype, "sub", void 0);
    return GetItemChildrenListRequest;
}(utils_1.SpeakeasyBase));
exports.GetItemChildrenListRequest = GetItemChildrenListRequest;
var GetItemChildrenListResponse = /** @class */ (function (_super) {
    ...
    ], GetItemChildrenListResponse.prototype, "rawResponse", void 0);
    return GetItemChildrenListResponse;
}(utils_1.SpeakeasyBase));
exports.GetItemChildrenListResponse = GetItemChildrenListResponse;
