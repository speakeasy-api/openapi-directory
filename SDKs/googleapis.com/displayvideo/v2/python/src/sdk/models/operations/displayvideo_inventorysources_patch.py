...
class DisplayvideoInventorySourcesPatchSecurity:
...
@dataclasses.dataclass
class DisplayvideoInventorySourcesPatchRequest:
    ...
    r"""The ID of the advertiser that the request is being made within."""  
    ...
    inventory_source_input: Optional[shared_inventorysource.InventorySourceInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    ...
    r"""The ID of the partner that the request is being made within."""  
    ...
    r"""Required. The mask to control which fields to update."""  
...
@dataclasses.dataclass
class DisplayvideoInventorySourcesPatchResponse:
