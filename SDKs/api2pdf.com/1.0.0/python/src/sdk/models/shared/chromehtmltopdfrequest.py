...
class ChromeHTMLToPdfRequest:
    ...
    options: Optional[shared_chromeadvancedoptions.ChromeAdvancedOptions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('options'), 'exclude': lambda f: f is None }})  
