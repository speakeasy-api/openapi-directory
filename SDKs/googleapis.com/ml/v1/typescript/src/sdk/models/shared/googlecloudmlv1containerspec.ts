...
export class GoogleCloudMlV1ContainerSpec extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudMlV1EnvVar })
  @Expose({ name: "env" })
  @Type(() => GoogleCloudMlV1EnvVar)
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudMlV1ContainerPort })
  @Expose({ name: "ports" })
  @Type(() => GoogleCloudMlV1ContainerPort)
