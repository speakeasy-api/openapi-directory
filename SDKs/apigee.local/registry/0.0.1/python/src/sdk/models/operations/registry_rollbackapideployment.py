...
from ..shared import rollbackapideploymentrequest as shared_rollbackapideploymentrequest
...
class RegistryRollbackAPIDeploymentRequest:
    ...
    r"""The project id."""  
    rollback_api_deployment_request: shared_rollbackapideploymentrequest.RollbackAPIDeploymentRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
