...
class GetSigningBasketScaStatusRequest:
    headers: GetSigningBasketScaStatusHeaders = dataclasses.field()
    path_params: GetSigningBasketScaStatusPathParams = dataclasses.field()
    security: GetSigningBasketScaStatusSecurity = dataclasses.field()
