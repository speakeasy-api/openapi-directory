...
exports.PutPayInstructionTagResponse = exports.PutPayInstructionTagRequest = void 0;
...
var PutPayInstructionTagRequest = /** @class */ (function (_super) {
    ...
    ], PutPayInstructionTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], PutPayInstructionTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], PutPayInstructionTagRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], PutPayInstructionTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayInstructionId",
        }),
        __metadata("design:type", String)
    ], PutPayInstructionTagRequest.prototype, "payInstructionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], PutPayInstructionTagRequest.prototype, "tagId", void 0);
...
var PutPayInstructionTagResponse = /** @class */ (function (_super) {
    ...
    ], PutPayInstructionTagResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
