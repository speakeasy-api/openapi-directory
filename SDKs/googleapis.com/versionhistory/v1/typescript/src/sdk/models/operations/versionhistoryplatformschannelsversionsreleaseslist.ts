...
export class VersionhistoryPlatformsChannelsVersionsReleasesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class VersionhistoryPlatformsChannelsVersionsReleasesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
