...
export class ListFieldLevelEncryptionConfigs20200531Request extends SpeakeasyBase {
  /**
...
export class ListFieldLevelEncryptionConfigs20200531Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
