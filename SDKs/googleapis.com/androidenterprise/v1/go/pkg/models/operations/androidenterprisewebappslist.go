...
type AndroidenterpriseWebappsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseWebappsListPathParams struct {
	// The ID of the enterprise.
	EnterpriseID string `pathParam:"style=simple,explode=false,name=enterpriseId"`
}

type AndroidenterpriseWebappsListQueryParams struct {
	// V1 error format.
...
type AndroidenterpriseWebappsListRequest struct {
...
type AndroidenterpriseWebappsListResponse struct {
	ContentType string
	StatusCode  int
