...
export class ServicePrincipalPasswordCredentials {
  ...
  servicePrincipalsListPasswordCredentials(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ServicePrincipalsListPasswordCredentialsResponse =
        new operations.ServicePrincipalsListPasswordCredentialsResponse({
  ...
  servicePrincipalsUpdatePasswordCredentials(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ServicePrincipalsUpdatePasswordCredentialsRequest(
        req
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ServicePrincipalsUpdatePasswordCredentialsResponse =
        new operations.ServicePrincipalsUpdatePasswordCredentialsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
