...
public class PutVCustomPricesRulesPriceAssociationIdPathParams {
    /**
    ...
    public PutVCustomPricesRulesPriceAssociationIdPathParams withPriceAssociationId(Long priceAssociationId) {
