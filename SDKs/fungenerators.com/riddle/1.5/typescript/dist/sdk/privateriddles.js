...
exports.PrivateRiddles = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var PrivateRiddles = /** @class */ (function () {
    function PrivateRiddles(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    PrivateRiddles.prototype.deleteRiddle = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteRiddleRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/riddle";
    ...
    **/
    PrivateRiddles.prototype.getRiddle = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PrivateRiddles.prototype.postRiddle = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PrivateRiddles.prototype.putRiddle = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.PrivateRiddles = PrivateRiddles;
