...
class PatientsQrda1PathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PatientsQrda1QueryParams:
...
class PatientsQrda1Request:
    path_params: PatientsQrda1PathParams = dataclasses.field()
    query_params: PatientsQrda1QueryParams = dataclasses.field()
    security: PatientsQrda1Security = dataclasses.field()
