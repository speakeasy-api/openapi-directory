...
class RemoveTagsRequest:
    headers: RemoveTagsHeaders = dataclasses.field()
    request: shared_removetagsrequest.RemoveTagsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
