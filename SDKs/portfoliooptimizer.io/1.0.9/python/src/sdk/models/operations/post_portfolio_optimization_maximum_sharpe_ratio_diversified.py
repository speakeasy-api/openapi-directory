...
class PostPortfolioOptimizationMaximumSharpeRatioDiversifiedRequestBodyConstraints:
    ...
    r"""The relative tolerance over the maximum Sharpe ratio portfolio return"""  
    ...
    r"""The relative tolerance over the maximum Sharpe ratio portfolio volatility"""  
...
class PostPortfolioOptimizationMaximumSharpeRatioDiversifiedRequestBody:
    ...
    constraints: Optional[PostPortfolioOptimizationMaximumSharpeRatioDiversifiedRequestBodyConstraints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('constraints'), 'exclude': lambda f: f is None }})  
...
class PostPortfolioOptimizationMaximumSharpeRatioDiversifiedResponse:
    ...
    post_portfolio_optimization_maximum_sharpe_ratio_diversified_200_application_json_object: Optional[PostPortfolioOptimizationMaximumSharpeRatioDiversified200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""  
