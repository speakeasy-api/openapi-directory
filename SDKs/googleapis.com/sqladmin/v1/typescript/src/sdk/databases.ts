...
export class Databases {
  ...
  **/
  sqlDatabasesDelete(
    ...
    const url: string = utils.generateURL(baseURL, "/v1/projects/{project}/instances/{instance}/databases/{database}", req.pathParams);
  ...
  **/
  sqlDatabasesInsert(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/projects/{project}/instances/{instance}/databases", req.pathParams);
