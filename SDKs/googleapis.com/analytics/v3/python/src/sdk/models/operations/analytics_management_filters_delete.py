...
class AnalyticsManagementFiltersDeleteRequest:
    path_params: AnalyticsManagementFiltersDeletePathParams = dataclasses.field()
    query_params: AnalyticsManagementFiltersDeleteQueryParams = dataclasses.field()
    security: AnalyticsManagementFiltersDeleteSecurity = dataclasses.field()
