...
class ListingExtraAttributes:
    ...
    seller_cmts: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('seller_cmts'), 'exclude': lambda f: f is None }})
    r"""Seller comment for the car"""  
