...
class DescribeGameServerResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\DescribeGameServerOutput $describeGameServerOutput
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\DescribeGameServerOutput $describeGameServerOutput = null;
	...
	{
		$this->contentType = "";
		$this->describeGameServerOutput = null;
