...
class TestOrderCustomerMarketingRightsInfo:
    explicit_marketing_preference: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('explicitMarketingPreference') }})
