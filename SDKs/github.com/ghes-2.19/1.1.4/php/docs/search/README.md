...
try {
    ...
    $request->order = OrderEnum::ASC;
    $request->page = 964925;
    $request->perPage = 251212;
    $request->q = 'distinctio';
    $request->repositoryId = 450224;
