...
@dataclasses.dataclass
class PaymentsresellersubscriptionPartnersSubscriptionsGetQueryParams:
...
class PaymentsresellersubscriptionPartnersSubscriptionsGetRequest:
    path_params: PaymentsresellersubscriptionPartnersSubscriptionsGetPathParams = dataclasses.field()
    query_params: PaymentsresellersubscriptionPartnersSubscriptionsGetQueryParams = dataclasses.field()
