...
export class TypeTypePointSnotel {
  ...
  searchTypePointSnotel(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_point_snotel";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypePointSnotelResponse =
        new operations.SearchTypePointSnotelResponse({
