...
exports.PutCisInstructionTagResponse = exports.PutCisInstructionTagRequest = void 0;
...
var PutCisInstructionTagRequest = /** @class */ (function (_super) {
    ...
    ], PutCisInstructionTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], PutCisInstructionTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=CisInstructionId",
        }),
        __metadata("design:type", String)
    ], PutCisInstructionTagRequest.prototype, "cisInstructionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], PutCisInstructionTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], PutCisInstructionTagRequest.prototype, "subContractorId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], PutCisInstructionTagRequest.prototype, "tagId", void 0);
...
var PutCisInstructionTagResponse = /** @class */ (function (_super) {
    ...
    ], PutCisInstructionTagResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
