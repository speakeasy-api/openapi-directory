...
public class LinksHarvestOrderLink {
    ...
    public LinksHarvestOrderLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksHarvestOrderLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksHarvestOrderLink withDescription(String description) {
    ...
    public LinksHarvestOrderLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksHarvestOrderLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksHarvestOrderLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksHarvestOrderLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksHarvestOrderLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksHarvestOrderLink withOperationId(String operationId) {
    ...
    public LinksHarvestOrderLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksHarvestOrderLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksHarvestOrderLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
