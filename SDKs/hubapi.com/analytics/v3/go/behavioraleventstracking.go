...
type BehavioralEventsTracking struct {
...
func NewBehavioralEventsTracking(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *BehavioralEventsTracking {
	return &BehavioralEventsTracking{
...
func (s *BehavioralEventsTracking) PostEventsV3Send(ctx context.Context, request operations.PostEventsV3SendRequest) (*operations.PostEventsV3SendResponse, error) {
	...
	res := &operations.PostEventsV3SendResponse{
