...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.. req = "dignissimos"            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCheckFollowingForUserRequest req = new UsersCheckFollowingForUserRequest("minus", "distinctio");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCheckPersonIsFollowedByAuthenticatedRequest req = new UsersCheckPersonIsFollowedByAuthenticatedRequest("possimus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCreateGpgKeyForAuthenticatedUserRequestBody req = new UsersCreateGpgKeyForAuthenticatedUserRequestBody("cum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCreatePublicSshKeyForAuthenticatedUserRequestBody req = new UsersCreatePublicSshKeyForAuthenticatedUserRequestBody("suscipit") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.. req = "earum"            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersDeleteGpgKeyForAuthenticatedUserRequest req = new UsersDeleteGpgKeyForAuthenticatedUserRequest(799866L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersDeletePublicSshKeyForAuthenticatedUserRequest req = new UsersDeletePublicSshKeyForAuthenticatedUserRequest(469588L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersFollowRequest req = new UsersFollowRequest("quaerat");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetByUsernameRequest req = new UsersGetByUsernameRequest("ipsum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetContextForUserRequest req = new UsersGetContextForUserRequest("ducimus") {{
                subjectId = "laudantium";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetGpgKeyForAuthenticatedUserRequest req = new UsersGetGpgKeyForAuthenticatedUserRequest(643997L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetPublicSshKeyForAuthenticatedUserRequest req = new UsersGetPublicSshKeyForAuthenticatedUserRequest(138436L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListFollowersForUserRequest req = new UsersListFollowersForUserRequest("impedit") {{
                page = 586277L;
                perPage = 72422L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListFollowingForUserRequest req = new UsersListFollowingForUserRequest("exercitationem") {{
                page = 670430L;
                perPage = 848833L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListGpgKeysForUserRequest req = new UsersListGpgKeysForUserRequest("dolorum") {{
                page = 998355L;
                perPage = 341983L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListPublicKeysForUserRequest req = new UsersListPublicKeysForUserRequest("commodi") {{
                page = 456371L;
                perPage = 127499L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersUnfollowRequest req = new UsersUnfollowRequest("optio");            
