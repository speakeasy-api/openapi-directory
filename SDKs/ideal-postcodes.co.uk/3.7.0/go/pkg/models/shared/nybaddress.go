...
type NybAddressCountryEnum string

const (
	NybAddressCountryEnumEngland         NybAddressCountryEnum = "England"
	NybAddressCountryEnumScotland        NybAddressCountryEnum = "Scotland"
	NybAddressCountryEnumWales           NybAddressCountryEnum = "Wales"
	NybAddressCountryEnumNorthernIreland NybAddressCountryEnum = "Northern Ireland"
	NybAddressCountryEnumJersey          NybAddressCountryEnum = "Jersey"
	NybAddressCountryEnumGuernsey        NybAddressCountryEnum = "Guernsey"
	NybAddressCountryEnumIsleOfMan       NybAddressCountryEnum = "Isle of Man"
)

func (e *NybAddressCountryEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Guernsey":
		fallthrough
	case "Isle of Man":
		*e = NybAddressCountryEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for NybAddressCountryEnum: %s", s)
	}
}

type NybAddressCountryIsoEnum string

const (
	NybAddressCountryIsoEnumGbr NybAddressCountryIsoEnum = "GBR"
	NybAddressCountryIsoEnumImn NybAddressCountryIsoEnum = "IMN"
	NybAddressCountryIsoEnumJey NybAddressCountryIsoEnum = "JEY"
	NybAddressCountryIsoEnumGgy NybAddressCountryIsoEnum = "GGY"
)

func (e *NybAddressCountryIsoEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "JEY":
		fallthrough
	case "GGY":
		*e = NybAddressCountryIsoEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for NybAddressCountryIsoEnum: %s", s)
	}
}

type NybAddressCountryIso2Enum string

const (
	NybAddressCountryIso2EnumGb NybAddressCountryIso2Enum = "GB"
	NybAddressCountryIso2EnumIm NybAddressCountryIso2Enum = "IM"
	NybAddressCountryIso2EnumJe NybAddressCountryIso2Enum = "JE"
	NybAddressCountryIso2EnumGg NybAddressCountryIso2Enum = "GG"
)

func (e *NybAddressCountryIso2Enum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "JE":
		fallthrough
	case "GG":
		*e = NybAddressCountryIso2Enum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for NybAddressCountryIso2Enum: %s", s)
	}
}

type NybAddressDatasetEnum string

const (
	NybAddressDatasetEnumNyb NybAddressDatasetEnum = "nyb"
)

func (e *NybAddressDatasetEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	switch s {
	case "nyb":
		*e = NybAddressDatasetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for NybAddressDatasetEnum: %s", s)
	}
}

type NybAddressLanguageEnum string

const (
	NybAddressLanguageEnumEn NybAddressLanguageEnum = "en"
)

func (e *NybAddressLanguageEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	switch s {
	case "en":
		*e = NybAddressLanguageEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for NybAddressLanguageEnum: %s", s)
	}
}

// NybAddress - A UK premise under construction and currently not occupied.
//
// This dataset is updated by Royal Mail on a monthly cadence.
type NybAddress struct {
	...
	Country        NybAddressCountryEnum     `json:"country"`
	CountryIso     NybAddressCountryIsoEnum  `json:"country_iso"`
	CountryIso2    NybAddressCountryIso2Enum `json:"country_iso_2"`
	...
	Dataset    NybAddressDatasetEnum `json:"dataset"`
	...
	ID       string                 `json:"id"`
	Language NybAddressLanguageEnum `json:"language"`
