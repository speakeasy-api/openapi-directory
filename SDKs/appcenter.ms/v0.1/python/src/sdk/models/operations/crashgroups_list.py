...
class CrashGroupsListSecurity:
    
    api_token: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'X-API-Token' }})  
    
class CrashGroupsListDollarOrderbyEnum(str, Enum):
    r"""the OData-like $orderby argument"""
...
class CrashGroupsListGroupStatusEnum(str, Enum):
    OPEN = 'open'
    CLOSED = 'closed'
    IGNORED = 'ignored'

class CrashGroupsListGroupTypeEnum(str, Enum):
...
class CrashGroupsListRequest:
    ...
    dollar_orderby: Optional[CrashGroupsListDollarOrderbyEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': '$orderby', 'style': 'form', 'explode': True }})
    r"""the OData-like $orderby argument"""  
    ...
    r"""Cassandra request continuation token. The token is used for pagination."""  
    group_status: Optional[CrashGroupsListGroupStatusEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'group_status', 'style': 'form', 'explode': True }})  
    group_text_search: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'group_text_search', 'style': 'form', 'explode': True }})
    r"""A freetext search that matches in crash, crash types, crash stack_traces and crash user"""  
    group_type: Optional[CrashGroupsListGroupTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'group_type', 'style': 'form', 'explode': True }})  
    last_occurrence_from: Optional[datetime] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'last_occurrence_from', 'style': 'form', 'explode': True }})
    r"""Earliest date when the last time a crash occured in a crash group"""  
    last_occurrence_to: Optional[datetime] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'last_occurrence_to', 'style': 'form', 'explode': True }})
    r"""Latest date when the last time a crash occured in a crash group"""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CrashGroupsListDefaultApplicationJSON:
    r"""Error"""
    
    message: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message') }})  
    
class CrashGroupsList200ApplicationJSONCrashGroupsReasonFrameLanguageEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CrashGroupsList200ApplicationJSONCrashGroupsReasonFrame:
    ...
    language: Optional[CrashGroupsList200ApplicationJSONCrashGroupsReasonFrameLanguageEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('language'), 'exclude': lambda f: f is None }})
    r"""programming language of the frame"""  
...
class CrashGroupsList200ApplicationJSONCrashGroupsStatusEnum(str, Enum):
    OPEN = 'open'
    CLOSED = 'closed'
    IGNORED = 'ignored'
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CrashGroupsList200ApplicationJSONCrashGroups:
    ...
    status: CrashGroupsList200ApplicationJSONCrashGroupsStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
    ...
    reason_frame: Optional[CrashGroupsList200ApplicationJSONCrashGroupsReasonFrame] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason_frame'), 'exclude': lambda f: f is None }})
    r"""frame belonging to the reason of the crash"""  
...
class CrashGroupsList200ApplicationJSON:
    ...
    crash_groups: list[CrashGroupsList200ApplicationJSONCrashGroups] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('crash_groups') }})  
    limited_result_set: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('limited_result_set') }})  
    continuation_token: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('continuation_token'), 'exclude': lambda f: f is None }})
    r"""Cassandra request continuation token. The token is used for pagination."""  
...
class CrashGroupsListResponse:
    ...
    crash_groups_list_200_application_json_object: Optional[CrashGroupsList200ApplicationJSON] = dataclasses.field(default=None)
    r"""Success"""  
    crash_groups_list_default_application_json_object: Optional[CrashGroupsListDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error"""  
