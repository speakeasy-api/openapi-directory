...
class Conversations:
    ...
    product: shared_product_conversations_enum.ProductConversationsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('product') }})
