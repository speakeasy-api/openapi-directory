...
* [cvcer](#cvcer) - Caste Validity Certificate
...
import org.openapis.openapi.models.operations.CvcerRequestBody;
import org.openapis.openapi.models.operations.CvcerRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.CvcerRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.CvcerResponse;
import org.openapis.openapi.models.operations.CvcerSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CvcerRequestBody req = new CvcerRequestBody(CvcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new CvcerRequestBodyCertificateParameters("31-12-1980", "XXXX-XXXXXXXXX");;
            ...
            CvcerResponse res = sdk.apIs.cvcer(req, new CvcerSecurity("maiores", "molestiae") {{
