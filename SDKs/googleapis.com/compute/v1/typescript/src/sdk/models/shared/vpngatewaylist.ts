 ...
 */
export enum VpnGatewayListWarningCodeEnum {
...
export class VpnGatewayListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class VpnGatewayListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: VpnGatewayListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class VpnGatewayList extends SpeakeasyBase {
  /**
