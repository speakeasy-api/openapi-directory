...
class GetEnrollmentStatusesForOrganizationRequest:
    ...
    get_enrollment_statuses_for_organization_request: shared_getenrollmentstatusesfororganizationrequest.GetEnrollmentStatusesForOrganizationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
