...
export class ContactcenteraiplatformProjectsLocationsContactCentersPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContactcenteraiplatformProjectsLocationsContactCentersPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContactcenteraiplatformProjectsLocationsContactCentersPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
