...
public class ListBundleQueryParams {
    ...
    public Long page;
    public ListBundleQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListBundleQueryParams withPageToken(String pageToken) {
    ...
    public ListBundleQueryParams withSortBy(org.openapis.openapi.models.shared.BundleEnumSortByEnum sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public ListBundleQueryParams withSortDirection(org.openapis.openapi.models.shared.BundleEnumSortDirectionEnum sortDirection) {
    ...
    public ListBundleQueryParams withStatus(org.openapis.openapi.models.shared.BundleEnumStatusEnum status) {
        this.status = status;
        return this;
    }
