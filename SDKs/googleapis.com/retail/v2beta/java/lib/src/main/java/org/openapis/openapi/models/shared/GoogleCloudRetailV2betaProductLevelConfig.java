 ...
 */
public class GoogleCloudRetailV2betaProductLevelConfig {
    /**
    ...
    public GoogleCloudRetailV2betaProductLevelConfig withIngestionProductType(String ingestionProductType) {
    ...
    public GoogleCloudRetailV2betaProductLevelConfig withMerchantCenterProductIdField(String merchantCenterProductIdField) {
        this.merchantCenterProductIdField = merchantCenterProductIdField;
        return this;
    }
    
    public GoogleCloudRetailV2betaProductLevelConfig(){}
}
