...
class DescribeFleetCapacityRequest:
    ...
    describe_fleet_capacity_input: shared_describefleetcapacityinput.DescribeFleetCapacityInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
