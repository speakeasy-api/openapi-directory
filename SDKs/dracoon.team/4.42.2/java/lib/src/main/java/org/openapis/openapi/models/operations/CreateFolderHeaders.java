...
public class CreateFolderHeaders {
    ...
    public CreateFolderHeaders withXSdsAuthToken(String xSdsAuthToken) {
    ...
    public CreateFolderHeaders withXSdsDateFormat(CreateFolderXSdsDateFormatEnum xSdsDateFormat) {
