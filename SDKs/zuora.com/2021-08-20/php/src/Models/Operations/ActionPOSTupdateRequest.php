...
class ActionPOSTupdateRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\ProxyActionupdateRequest $proxyActionupdateRequest;
	...
	{
		$this->proxyActionupdateRequest = new \OpenAPI\OpenAPI\Models\Shared\ProxyActionupdateRequest();
