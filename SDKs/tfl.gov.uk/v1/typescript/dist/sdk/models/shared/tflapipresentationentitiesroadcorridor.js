...
exports.TflApiPresentationEntitiesRoadCorridor = void 0;
...
var TflApiPresentationEntitiesRoadCorridor = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "statusAggregationEndDate" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "statusAggregationStartDate" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
...
exports.TflApiPresentationEntitiesRoadCorridor = TflApiPresentationEntitiesRoadCorridor;
