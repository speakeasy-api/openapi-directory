...
class GetVariantPhenotypeAssociationsRequest:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""CURIE identifier of variant, e.g. ZFIN:ZDB-ALT-010427-8, ClinVarVariant:39783"""  
...
@dataclasses.dataclass
class GetVariantPhenotypeAssociationsResponse:
