...
class PostAdminRequestsRemoveRequestBody:
    basic_auth_credentials: Optional[PostAdminRequestsRemoveRequestBodyBasicAuthCredentials] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('basicAuthCredentials') }})
...
class PostAdminRequestsRemoveRequest:
    request: PostAdminRequestsRemoveRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
