...
class MonitoringProjectsGroupsMembersListRequest:
    path_params: MonitoringProjectsGroupsMembersListPathParams = dataclasses.field()
    query_params: MonitoringProjectsGroupsMembersListQueryParams = dataclasses.field()
    security: MonitoringProjectsGroupsMembersListSecurity = dataclasses.field()
