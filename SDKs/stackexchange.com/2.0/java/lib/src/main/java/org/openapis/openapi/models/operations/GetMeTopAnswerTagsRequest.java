...
public class GetMeTopAnswerTagsRequest {
    ...
    public GetMeTopAnswerTagsRequest withCallback(String callback) {
    ...
    public GetMeTopAnswerTagsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeTopAnswerTagsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeTopAnswerTagsRequest withPagesize(Long pagesize) {
    ...
    public GetMeTopAnswerTagsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    public GetMeTopAnswerTagsRequest(@JsonProperty("site") String site) {
        this.site = site;
  }
}
