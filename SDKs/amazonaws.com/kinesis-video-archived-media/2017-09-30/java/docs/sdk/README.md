    ...
    public static void main(String[] args) {
        try {
            ...
            GetClipRequest req = new GetClipRequest(                new GetClipRequestBody(                new GetClipRequestBodyClipFragmentSelector() {{
                                                ...
                                                timestampRange = new ClipTimestampRange(OffsetDateTime.parse("2022-08-14T01:03:07.567Z"), OffsetDateTime.parse("2022-03-18T00:29:19.137Z"));;
                                            }};) {{
                                streamARN = "placeat";
            ...
            GetClipResponse res = sdk.sdk.getClip(req);
...
import java.time.OffsetDateTime;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.GetDASHStreamingSessionURLRequest;
import org.openapis.openapi.models.operations.GetDASHStreamingSessionURLRequestBody;
import org.openapis.openapi.models.operations.GetDASHStreamingSessionURLRequestBodyDASHFragmentSelector;
import org.openapis.openapi.models.operations.GetDASHStreamingSessionURLRequestBodyDisplayFragmentNumberEnum;
import org.openapis.openapi.models.operations.GetDASHStreamingSessionURLRequestBodyDisplayFragmentTimestampEnum;
import org.openapis.openapi.models.operations.GetDASHStreamingSessionURLRequestBodyPlaybackModeEnum;
import org.openapis.openapi.models.operations.GetDASHStreamingSessionURLResponse;
import org.openapis.openapi.models.shared.DASHFragmentSelectorTypeEnum;
import org.openapis.openapi.models.shared.DASHTimestampRange;
import org.openapis.openapi.models.shared.Security;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetDASHStreamingSessionURLRequest req = new GetDASHStreamingSessionURLRequest(                new GetDASHStreamingSessionURLRequestBody() {{
                                dashFragmentSelector = new GetDASHStreamingSessionURLRequestBodyDASHFragmentSelector() {{
                                    fragmentSelectorType = DASHFragmentSelectorTypeEnum.SERVER_TIMESTAMP;
                                    timestampRange = new DASHTimestampRange() {{
                                        endTimestamp = OffsetDateTime.parse("2022-08-19T14:12:14.246Z");
                                        startTimestamp = OffsetDateTime.parse("2020-02-17T21:57:45.117Z");
                                    }};;
                                }};;
                                displayFragmentNumber = GetDASHStreamingSessionURLRequestBodyDisplayFragmentNumberEnum.NEVER;
                                displayFragmentTimestamp = GetDASHStreamingSessionURLRequestBodyDisplayFragmentTimestampEnum.ALWAYS;
                                expires = 870013L;
                                maxManifestFragmentResults = 870088L;
                                playbackMode = GetDASHStreamingSessionURLRequestBodyPlaybackModeEnum.ON_DEMAND;
                                streamARN = "molestiae";
                                streamName = "quod";
                            }};) {{
                xAmzAlgorithm = "quod";
            ...
            GetDASHStreamingSessionURLResponse res = sdk.sdk.getDASHStreamingSessionURL(req);

            if (res.getDASHStreamingSessionURLOutput != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import java.time.OffsetDateTime;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.GetHLSStreamingSessionURLRequest;
import org.openapis.openapi.models.operations.GetHLSStreamingSessionURLRequestBody;
import org.openapis.openapi.models.operations.GetHLSStreamingSessionURLRequestBodyContainerFormatEnum;
import org.openapis.openapi.models.operations.GetHLSStreamingSessionURLRequestBodyDiscontinuityModeEnum;
import org.openapis.openapi.models.operations.GetHLSStreamingSessionURLRequestBodyDisplayFragmentTimestampEnum;
import org.openapis.openapi.models.operations.GetHLSStreamingSessionURLRequestBodyHLSFragmentSelector;
import org.openapis.openapi.models.operations.GetHLSStreamingSessionURLRequestBodyPlaybackModeEnum;
import org.openapis.openapi.models.operations.GetHLSStreamingSessionURLResponse;
import org.openapis.openapi.models.shared.HLSFragmentSelectorTypeEnum;
import org.openapis.openapi.models.shared.HLSTimestampRange;
import org.openapis.openapi.models.shared.Security;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetHLSStreamingSessionURLRequest req = new GetHLSStreamingSessionURLRequest(                new GetHLSStreamingSessionURLRequestBody() {{
                                containerFormat = GetHLSStreamingSessionURLRequestBodyContainerFormatEnum.MPEG_TS;
                                discontinuityMode = GetHLSStreamingSessionURLRequestBodyDiscontinuityModeEnum.ALWAYS;
                                displayFragmentTimestamp = GetHLSStreamingSessionURLRequestBodyDisplayFragmentTimestampEnum.NEVER;
                                expires = 944669L;
                                hlsFragmentSelector = new GetHLSStreamingSessionURLRequestBodyHLSFragmentSelector() {{
                                    fragmentSelectorType = HLSFragmentSelectorTypeEnum.SERVER_TIMESTAMP;
                                    timestampRange = new HLSTimestampRange() {{
                                        endTimestamp = OffsetDateTime.parse("2022-10-15T16:29:54.554Z");
                                        startTimestamp = OffsetDateTime.parse("2022-07-12T03:15:36.542Z");
                                    }};;
                                }};;
                                maxMediaPlaylistFragmentResults = 264555L;
                                playbackMode = GetHLSStreamingSessionURLRequestBodyPlaybackModeEnum.LIVE;
                                streamARN = "impedit";
                                streamName = "cum";
                            }};) {{
                xAmzAlgorithm = "esse";
            ...
            GetHLSStreamingSessionURLResponse res = sdk.sdk.getHLSStreamingSessionURL(req);

            if (res.getHLSStreamingSessionURLOutput != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import org.openapis.openapi.models.operations.GetImagesRequestBody;
import org.openapis.openapi.models.operations.GetImagesRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.GetImagesRequestBodyImageSelectorTypeEnum;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetImagesRequest req = new GetImagesRequest(                new GetImagesRequestBody(OffsetDateTime.parse("2022-07-22T16:55:44.795Z"), GetImagesRequestBodyFormatEnum.PNG, GetImagesRequestBodyImageSelectorTypeEnum.PRODUCER_TIMESTAMP, 943749L, OffsetDateTime.parse("2020-12-15T09:45:44.943Z")) {{
                                formatConfig = new java.util.HashMap<String, String>() {{
                                    put("corporis", "iste");
                                    put("iure", "saepe");
                                }};
                                heightPixels = 697631L;
                                maxResults = 99280L;
                                nextToken = "ipsa";
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.GetMediaForFragmentListRequest;
import org.openapis.openapi.models.operations.GetMediaForFragmentListRequestBody;
import org.openapis.openapi.models.operations.GetMediaForFragmentListResponse;
import org.openapis.openapi.models.shared.Security;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetMediaForFragmentListRequest req = new GetMediaForFragmentListRequest(                new GetMediaForFragmentListRequestBody(                new String[]{{
                                                add("accusantium"),
                                                add("iure"),
                                                add("culpa"),
                                            }}) {{
            ...
            GetMediaForFragmentListResponse res = sdk.sdk.getMediaForFragmentList(req);

            if (res.getMediaForFragmentListOutput != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import java.time.OffsetDateTime;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.ListFragmentsRequest;
import org.openapis.openapi.models.operations.ListFragmentsRequestBody;
import org.openapis.openapi.models.operations.ListFragmentsRequestBodyFragmentSelector;
import org.openapis.openapi.models.operations.ListFragmentsResponse;
import org.openapis.openapi.models.shared.FragmentSelectorTypeEnum;
import org.openapis.openapi.models.shared.Security;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ListFragmentsRequest req = new ListFragmentsRequest(                new ListFragmentsRequestBody() {{
                                fragmentSelector = new ListFragmentsRequestBodyFragmentSelector() {{
                                    fragmentSelectorType = FragmentSelectorTypeEnum.PRODUCER_TIMESTAMP;
                                    timestampRange = new TimestampRange(OffsetDateTime.parse("2022-07-14T19:07:02.935Z"), OffsetDateTime.parse("2022-10-03T18:49:53.900Z"));;
                                }};;
                                maxResults = 623510L;
                                nextToken = "quia";
                                streamARN = "quis";
            ...
            ListFragmentsResponse res = sdk.sdk.listFragments(req);

            if (res.listFragmentsOutput != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
