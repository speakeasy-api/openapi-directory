...
from ..shared import getpospaymentresponse as shared_getpospaymentresponse
...
class PaymentsOneRequest:
    headers: PaymentsOneHeaders = dataclasses.field()
    path_params: PaymentsOnePathParams = dataclasses.field()
    query_params: PaymentsOneQueryParams = dataclasses.field()
    security: PaymentsOneSecurity = dataclasses.field()
...
class PaymentsOneResponse:
    ...
    get_pos_payment_response: Optional[shared_getpospaymentresponse.GetPosPaymentResponse] = dataclasses.field(default=None)
