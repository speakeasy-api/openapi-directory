...
func (e PostServersIDActionsPoweronActionResponseActionStatusEnum) ToPointer() *PostServersIDActionsPoweronActionResponseActionStatusEnum {
	return &e
}

func (e *PostServersIDActionsPoweronActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsPoweronActionResponseActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsPoweronActionResponseActionStatusEnum: %v", v)
	}
}
