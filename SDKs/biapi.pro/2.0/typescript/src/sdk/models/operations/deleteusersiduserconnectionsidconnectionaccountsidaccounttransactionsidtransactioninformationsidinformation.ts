...
export class DeleteUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsIdTransactionInformationsIdInformationRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DeleteUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsIdTransactionInformationsIdInformationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
