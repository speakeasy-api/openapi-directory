...
from ..shared import accountdevices as shared_accountdevices
...
class GetDevicesResponse:
    ...
    account_devices: Optional[shared_accountdevices.AccountDevices] = dataclasses.field(default=None)
    r"""OK"""  
