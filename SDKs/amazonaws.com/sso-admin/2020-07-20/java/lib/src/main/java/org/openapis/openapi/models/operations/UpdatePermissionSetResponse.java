...
public class UpdatePermissionSetResponse {
    ...
    public UpdatePermissionSetResponse withStatusCode(Integer statusCode) {
    ...
    public UpdatePermissionSetResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public UpdatePermissionSetResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
