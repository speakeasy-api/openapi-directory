...
type TransactionSettlementDetailsPathParams struct {
	TransactionID string `pathParam:"style=simple,explode=false,name=transactionId"`
}

type TransactionSettlementDetailsHeaders struct {
...
type TransactionSettlementDetailsRequest struct {
	PathParams TransactionSettlementDetailsPathParams
	Headers    TransactionSettlementDetailsHeaders
}

type TransactionSettlementDetailsResponse struct {
	ContentType                  string
