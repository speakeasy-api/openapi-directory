...
class UpdateShipmentResponseBodyInternationalShipmentOptions:
    r"""UpdateShipmentResponseBodyInternationalShipmentOptions
...
@dataclass_json
@dataclasses.dataclass
class UpdateShipmentResponseBodyWeight:
    r"""UpdateShipmentResponseBodyWeight
...
class UpdateShipmentResponseBody:
    r"""UpdateShipmentResponseBody
    The information necessary to ship a package, such as the origin, the destination, the carrier service, and the package dimensions and weight.
    
    """
    
    address_validation: shared_address_validation_result.AddressValidationResult = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('address_validation') }})
    ...
    customs: UpdateShipmentResponseBodyInternationalShipmentOptions = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('customs') }})
    errors: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('errors') }})
    ...
    total_weight: UpdateShipmentResponseBodyWeight = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('total_weight') }})
