 ...
 */
export declare class RegistrationSchemasListRegistrationSchemaAttributes extends SpeakeasyBase {
    /**
 ...
 */
export declare class RegistrationSchemasListRegistrationSchemaLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class RegistrationSchemasListRegistrationSchemaRelationships extends SpeakeasyBase {
    /**
 ...
 * OK
 */
export declare class RegistrationSchemasListRegistrationSchema extends SpeakeasyBase {
    /**
     * The attributes of the Registration Schema.
     */
...
export declare class RegistrationSchemasListResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
