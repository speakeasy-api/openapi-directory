...
func (e *GetOrganizationSwitchPortsBySwitch200ApplicationJSONPortsAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Sticky MAC allow list":
		*e = GetOrganizationSwitchPortsBySwitch200ApplicationJSONPortsAccessPolicyTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationSwitchPortsBySwitch200ApplicationJSONPortsAccessPolicyTypeEnum: %s", s)
	}
}
...
func (e *GetOrganizationSwitchPortsBySwitch200ApplicationJSONPortsStpGuardEnum) UnmarshalJSON(data []byte) error {
	...
	case "loop guard":
		fallthrough
	case "root guard":
		*e = GetOrganizationSwitchPortsBySwitch200ApplicationJSONPortsStpGuardEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationSwitchPortsBySwitch200ApplicationJSONPortsStpGuardEnum: %s", s)
	}
}
...
func (e *GetOrganizationSwitchPortsBySwitch200ApplicationJSONPortsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "access":
		fallthrough
	case "trunk":
		*e = GetOrganizationSwitchPortsBySwitch200ApplicationJSONPortsTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationSwitchPortsBySwitch200ApplicationJSONPortsTypeEnum: %s", s)
	}
}
