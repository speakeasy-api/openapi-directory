...
public class InvoiceApiSendToAccountantRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiSendToAccountantRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiSendToAccountantRawHeaders withXAuthSecret(String xAuthSecret) {
