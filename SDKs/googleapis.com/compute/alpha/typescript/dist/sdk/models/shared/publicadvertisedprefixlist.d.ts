 ...
 */
export declare enum PublicAdvertisedPrefixListWarningCodeEnum {
...
export declare class PublicAdvertisedPrefixListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class PublicAdvertisedPrefixListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: PublicAdvertisedPrefixListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: PublicAdvertisedPrefixListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class PublicAdvertisedPrefixList extends SpeakeasyBase {
    /**
