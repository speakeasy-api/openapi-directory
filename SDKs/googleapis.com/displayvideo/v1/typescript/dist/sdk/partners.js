...
var Partners = /** @class */ (function () {
     ...
     */
    Partners.prototype.displayvideoPartnersBulkEditPartnerAssignedTargetingOptions = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
                new operations.DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/partners/{partnerId}:bulkEditPartnerAssignedTargetingOptions", req);
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security =
                new operations.DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsResponse({
    ...
    Partners.prototype.displayvideoPartnersChannelsCreate = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/partners/{partnerId}/channels", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Partners.prototype.displayvideoPartnersChannelsPatch = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/partners/{partnerId}/channels/{channelId}", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "channelInput", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    Partners.prototype.displayvideoPartnersChannelsSitesBulkEdit = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/partners/{partnerId}/channels/{channelId}/sites:bulkEdit", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Partners.prototype.displayvideoPartnersChannelsSitesDelete = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/partners/{partnerId}/channels/{channelId}/sites/{urlOrAppId}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Partners.prototype.displayvideoPartnersChannelsSitesList = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/partners/{partnerId}/channels/{channelId}/sites", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Partners.prototype.displayvideoPartnersChannelsSitesReplace = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/partners/{partnerId}/channels/{channelId}/sites:replace", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Partners.prototype.displayvideoPartnersGet = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/partners/{partnerId}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Partners.prototype.displayvideoPartnersList = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/partners";
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Partners.prototype.displayvideoPartnersTargetingTypesAssignedTargetingOptionsCreate = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Partners.prototype.displayvideoPartnersTargetingTypesAssignedTargetingOptionsDelete = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security =
