...
var FilterCriteria = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "hiddenValues" }),
        __metadata("design:type", Array)
    ], FilterCriteria.prototype, "hiddenValues", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "visibleBackgroundColor" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "visibleBackgroundColorStyle" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "visibleForegroundColor" }),
        (0, class_transformer_1.Type)(function () { return color_1.Color; }),
        __metadata("design:type", color_1.Color)
    ], FilterCriteria.prototype, "visibleForegroundColor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "visibleForegroundColorStyle" }),
        (0, class_transformer_1.Type)(function () { return colorstyle_1.ColorStyle; }),
        __metadata("design:type", colorstyle_1.ColorStyle)
