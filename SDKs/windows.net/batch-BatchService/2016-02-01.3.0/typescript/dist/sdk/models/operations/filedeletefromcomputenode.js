...
exports.FileDeleteFromComputeNodeResponse = exports.FileDeleteFromComputeNodeRequest = void 0;
...
var FileDeleteFromComputeNodeRequest = /** @class */ (function (_super) {
    ...
    ], FileDeleteFromComputeNodeRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], FileDeleteFromComputeNodeRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=fileName",
        }),
        __metadata("design:type", String)
    ], FileDeleteFromComputeNodeRequest.prototype, "fileName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=nodeId",
        }),
        __metadata("design:type", String)
    ], FileDeleteFromComputeNodeRequest.prototype, "nodeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], FileDeleteFromComputeNodeRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=poolId",
        }),
        __metadata("design:type", String)
    ], FileDeleteFromComputeNodeRequest.prototype, "poolId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=recursive",
        }),
        __metadata("design:type", Boolean)
    ], FileDeleteFromComputeNodeRequest.prototype, "recursive", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], FileDeleteFromComputeNodeRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], FileDeleteFromComputeNodeRequest.prototype, "timeout", void 0);
    return FileDeleteFromComputeNodeRequest;
}(utils_1.SpeakeasyBase));
exports.FileDeleteFromComputeNodeRequest = FileDeleteFromComputeNodeRequest;
var FileDeleteFromComputeNodeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], FileDeleteFromComputeNodeResponse.prototype, "rawResponse", void 0);
    return FileDeleteFromComputeNodeResponse;
}(utils_1.SpeakeasyBase));
exports.FileDeleteFromComputeNodeResponse = FileDeleteFromComputeNodeResponse;
