...
public class CreateLoadBalancerTlsCertificateRequest {
    ...
    public CreateLoadBalancerTlsCertificateRequest(@JsonProperty("CreateLoadBalancerTlsCertificateRequest") org.openapis.openapi.models.shared.CreateLoadBalancerTlsCertificateRequest createLoadBalancerTlsCertificateRequest, @JsonProperty("X-Amz-Target") CreateLoadBalancerTlsCertificateXAmzTargetEnum xAmzTarget) {
        this.createLoadBalancerTlsCertificateRequest = createLoadBalancerTlsCertificateRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
