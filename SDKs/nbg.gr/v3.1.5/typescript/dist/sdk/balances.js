...
var Balances = /** @class */ (function () {
     ...
     */
    Balances.prototype.getAccountsAccountIdBalances = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAccountsAccountIdBalancesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/accounts/{accountId}/balances", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetAccountsAccountIdBalancesResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.obReadBalance1 = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.OBReadBalance1);
                    }
