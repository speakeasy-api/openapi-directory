...
var Card = /** @class */ (function () {
    function Card(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * getApiCard - Get Card
    **/
    Card.prototype.getApiCard = function (req, config) {
    ...
    **/
    Card.prototype.getApiCardTypes = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
