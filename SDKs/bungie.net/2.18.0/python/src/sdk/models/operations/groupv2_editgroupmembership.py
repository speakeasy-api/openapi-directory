...
class GroupV2EditGroupMembershipRequest:
    ...
    r"""ID of the group to which the member belongs."""  
    membership_id: int = dataclasses.field(metadata={'path_param': { 'field_name': 'membershipId', 'style': 'simple', 'explode': False }})
    r"""Membership ID to modify."""  
    membership_type: int = dataclasses.field(metadata={'path_param': { 'field_name': 'membershipType', 'style': 'simple', 'explode': False }})
    r"""Membership type of the provide membership ID."""  
    member_type: int = dataclasses.field(metadata={'path_param': { 'field_name': 'memberType', 'style': 'simple', 'explode': False }})
    r"""New membertype for the specified member."""  
    

@dataclasses.dataclass
class GroupV2EditGroupMembership200Wildcard:
