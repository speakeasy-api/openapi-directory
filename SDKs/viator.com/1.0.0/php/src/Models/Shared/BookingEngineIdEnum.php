 ...
 * 
 */
enum BookingEngineIdEnum: string
{
    case FREESALE_BE = 'FreesaleBE';
    case UNCONDITIONAL_BE = 'UnconditionalBE';
    case DEFERRED_CRMBE = 'DeferredCRMBE';
    case FREESALE_ON_REQUEST_BE = 'FreesaleOnRequestBE';
}
