 ...
 */
export declare enum RegionInstanceGroupManagerListWarningCodeEnum {
...
export declare class RegionInstanceGroupManagerListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class RegionInstanceGroupManagerListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class RegionInstanceGroupManagerList extends SpeakeasyBase {
    /**
