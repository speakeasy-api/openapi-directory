...
import dataclasses
from ..shared import messageflag as shared_messageflag
...
class QueryMessageFlagsResponse:
    ...
    flags: list[shared_messageflag.MessageFlag] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flags') }})  
