...
class GetRoutingVersionNumberCalculateRouteLocationsContentTypeRequest:
    path_params: GetRoutingVersionNumberCalculateRouteLocationsContentTypePathParams = dataclasses.field()
    query_params: GetRoutingVersionNumberCalculateRouteLocationsContentTypeQueryParams = dataclasses.field()
