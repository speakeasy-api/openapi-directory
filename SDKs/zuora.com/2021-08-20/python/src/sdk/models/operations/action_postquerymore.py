...
class ActionPOSTqueryMoreRequest:
    ...
    proxy_actionquery_more_request: shared_proxyactionquerymorerequest.ProxyActionqueryMoreRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
