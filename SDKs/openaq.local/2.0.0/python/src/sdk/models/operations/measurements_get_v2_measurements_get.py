...
class MeasurementsGetV2MeasurementsGetOrderByMeasOrderEnum(str, Enum):
    r"""An enumeration."""
    CITY = 'city'
    COUNTRY = 'country'
    LOCATION = 'location'
...
class MeasurementsGetV2MeasurementsGetSortSortEnum(str, Enum):
    r"""An enumeration."""
    ASC = 'asc'
    DESC = 'desc'
...
class MeasurementsGetV2MeasurementsGetRequest:
    ...
    order_by: Optional[MeasurementsGetV2MeasurementsGetOrderByMeasOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order_by', 'style': 'form', 'explode': True }})
    r"""An enumeration."""  
    ...
    r"""An enumeration."""  
    sort: Optional[MeasurementsGetV2MeasurementsGetSortSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""An enumeration."""  
