...
class APIV2010AccountNotificationInstance:
    ...
    request_method: Optional[APIV2010AccountNotificationInstanceRequestMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('request_method') }})
