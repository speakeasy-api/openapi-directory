...
class CreateLabelFromRateRequest:
    ...
    create_label_from_rate_request_body: shared_create_label_from_rate_request_body.CreateLabelFromRateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    rate_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'rate_id', 'style': 'simple', 'explode': False }})
    r"""Rate ID"""  
    

@dataclasses.dataclass
class CreateLabelFromRateResponse:
