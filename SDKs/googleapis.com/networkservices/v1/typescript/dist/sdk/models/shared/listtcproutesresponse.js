 ...
 */
var ListTcpRoutesResponse = /** @class */ (function (_super) {
    __extends(ListTcpRoutesResponse, _super);
    function ListTcpRoutesResponse() {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: tcproute_1.TcpRoute }),
        (0, class_transformer_1.Expose)({ name: "tcpRoutes" }),
        (0, class_transformer_1.Type)(function () { return tcproute_1.TcpRoute; }),
