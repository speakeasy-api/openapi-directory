...
class PutRepositoryCatalogDataRequest:
    ...
    catalog_data: shared_repositorycatalogdatainput.RepositoryCatalogDataInput = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('catalogData') }})  
