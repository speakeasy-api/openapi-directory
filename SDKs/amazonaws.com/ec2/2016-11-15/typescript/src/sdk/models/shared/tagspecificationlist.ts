 ...
 */
export enum TagSpecificationListResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class TagSpecificationListTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class TagSpecificationList extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: TagSpecificationListResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: TagSpecificationListTags })
