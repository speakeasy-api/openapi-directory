...
var Imports = /** @class */ (function () {
     ...
     * Commits the import operation to complete the onboarding of a device into Dashboard for monitoring.
     */
    Imports.prototype.createOrganizationInventoryOnboardingCloudMonitoringImport = function (req, config) {
        var _a;
     ...
     * Check the status of a committed Import operation
     */
    Imports.prototype.getOrganizationInventoryOnboardingCloudMonitoringImports = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
