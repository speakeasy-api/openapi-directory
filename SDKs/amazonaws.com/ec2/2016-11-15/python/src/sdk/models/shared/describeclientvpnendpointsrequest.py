...
class DescribeClientVpnEndpointsRequestFilters:
...
class DescribeClientVpnEndpointsRequest:
    ...
    client_vpn_endpoint_ids: Optional[list[str]] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeClientVpnEndpointsRequestFilters]] = dataclasses.field(default=None)  
