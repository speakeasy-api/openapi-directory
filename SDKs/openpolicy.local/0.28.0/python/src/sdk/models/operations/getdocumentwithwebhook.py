...
class GetDocumentWithWebHook200ApplicationJSONExplanationLocals:
    ...
    key: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationLocalsKey] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('key'), 'exclude': lambda f: f is None }})  
    value: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationLocalsValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value'), 'exclude': lambda f: f is None }})  
...
class GetDocumentWithWebHook200ApplicationJSONExplanationNode:
    ...
    r"""Node number"""  
    terms: Optional[list[GetDocumentWithWebHook200ApplicationJSONExplanationNodeTerms]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('terms'), 'exclude': lambda f: f is None }})  
...
class GetDocumentWithWebHook200ApplicationJSONExplanation:
    ...
    locals: Optional[list[GetDocumentWithWebHook200ApplicationJSONExplanationLocals]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('locals'), 'exclude': lambda f: f is None }})
    r"""The query's term bindings at the point when the trace event was emitted."""  
    node: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationNode] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('node'), 'exclude': lambda f: f is None }})
    r"""The AST element associated with the evaluation step.
    https://godoc.org/github.com/open-policy-agent/opa/ast - AST
    """  
    op: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationOpEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('op'), 'exclude': lambda f: f is None }})
    r"""The kind of *trace event*
    ...
    type: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of the **node** field"""  
...
class GetDocumentWithWebHook200ApplicationJSONResultAstPackagePathTypeEnum(str, Enum):
...
class GetDocumentWithWebHook200ApplicationJSONResultAstPackagePath:
    ...
    type: Optional[GetDocumentWithWebHook200ApplicationJSONResultAstPackagePathTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of the path operation"""  
    value: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value'), 'exclude': lambda f: f is None }})
    r"""The path variable"""  
...
class GetDocumentWithWebHook200ApplicationJSONResultAstPackage:
    ...
    path: Optional[list[GetDocumentWithWebHook200ApplicationJSONResultAstPackagePath]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('path'), 'exclude': lambda f: f is None }})
...
class GetDocumentWithWebHook200ApplicationJSONResultAstRulesBodyTerms:
    ...
    value: Optional[list[GetDocumentWithWebHook200ApplicationJSONResultAstRulesBodyTermsValue]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value'), 'exclude': lambda f: f is None }})
...
class GetDocumentWithWebHook200ApplicationJSONResultAstRulesBody:
    ...
    terms: Optional[list[GetDocumentWithWebHook200ApplicationJSONResultAstRulesBodyTerms]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('terms'), 'exclude': lambda f: f is None }})
...
class GetDocumentWithWebHook200ApplicationJSONResultAstRulesHead:
    ...
    key: Optional[GetDocumentWithWebHook200ApplicationJSONResultAstRulesHeadKey] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('key'), 'exclude': lambda f: f is None }})
    r"""The type/value pairing for this rule's head"""  
...
class GetDocumentWithWebHook200ApplicationJSONResultAstRules:
    ...
    body: Optional[list[GetDocumentWithWebHook200ApplicationJSONResultAstRulesBody]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('body'), 'exclude': lambda f: f is None }})
    r"""A list of the terms in this rule"""  
    head: Optional[GetDocumentWithWebHook200ApplicationJSONResultAstRulesHead] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('head'), 'exclude': lambda f: f is None }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetDocumentWithWebHook200ApplicationJSONResultAst:
    ...
    package: Optional[GetDocumentWithWebHook200ApplicationJSONResultAstPackage] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('package'), 'exclude': lambda f: f is None }})  
    rules: Optional[list[GetDocumentWithWebHook200ApplicationJSONResultAstRules]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rules'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetDocumentWithWebHook200ApplicationJSONResult:
    
    ast: Optional[GetDocumentWithWebHook200ApplicationJSONResultAst] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ast'), 'exclude': lambda f: f is None }})
    r"""The types for declarations and runtime objects passed to your implementation. This consists of an abstract syntax tree (AST) of policy modules, package and import declarations, rules, expressions, and terms.
    https://godoc.org/github.com/open-policy-agent/opa/ast - AST
    """  
...
class GetDocumentWithWebHook200ApplicationJSON:
    ...
    explanation: Optional[list[GetDocumentWithWebHook200ApplicationJSONExplanation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('explanation'), 'exclude': lambda f: f is None }})  
    metrics: Optional[GetDocumentWithWebHook200ApplicationJSONMetrics] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metrics'), 'exclude': lambda f: f is None }})  
    provenance: Optional[GetDocumentWithWebHook200ApplicationJSONProvenance] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('provenance'), 'exclude': lambda f: f is None }})  
    result: Optional[list[GetDocumentWithWebHook200ApplicationJSONResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})  
