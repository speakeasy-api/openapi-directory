...
public class GetBadgesIdsQueryParams {
    /**
    ...
    public GetBadgesIdsQueryParams withCallback(String callback) {
    ...
    public GetBadgesIdsQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetBadgesIdsQueryParams withFromdate(Long fromdate) {
    ...
    public String max;
    public GetBadgesIdsQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetBadgesIdsQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetBadgesIdsOrderEnum order;
    public GetBadgesIdsQueryParams withOrder(GetBadgesIdsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetBadgesIdsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetBadgesIdsQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetBadgesIdsQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetBadgesIdsSortEnum sort;
    public GetBadgesIdsQueryParams withSort(GetBadgesIdsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetBadgesIdsQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
