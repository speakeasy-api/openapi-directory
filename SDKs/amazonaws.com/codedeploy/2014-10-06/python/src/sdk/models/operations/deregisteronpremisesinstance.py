...
class DeregisterOnPremisesInstanceRequest:
    ...
    deregister_on_premises_instance_input: shared_deregisteronpremisesinstanceinput.DeregisterOnPremisesInstanceInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
