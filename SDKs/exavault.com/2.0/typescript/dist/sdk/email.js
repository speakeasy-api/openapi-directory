...
var Email = /** @class */ (function () {
    ...
    **/
    Email.prototype.sendReferralEmail = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SendReferralEmailRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/email/referral";
    ...
    **/
    Email.prototype.sendWelcomeEmail = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SendWelcomeEmailRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/email/welcome/{username}", req.pathParams);
        var client = this._defaultClient;
