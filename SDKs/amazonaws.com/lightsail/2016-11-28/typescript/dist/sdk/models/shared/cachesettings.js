...
var CacheSettings = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "allowedHTTPMethods" }),
        __metadata("design:type", String)
    ], CacheSettings.prototype, "allowedHTTPMethods", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cachedHTTPMethods" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "forwardedCookies" }),
        (0, class_transformer_1.Type)(function () { return cookieobject_1.CookieObject; }),
        __metadata("design:type", cookieobject_1.CookieObject)
    ], CacheSettings.prototype, "forwardedCookies", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "forwardedHeaders" }),
        (0, class_transformer_1.Type)(function () { return headerobject_1.HeaderObject; }),
        __metadata("design:type", headerobject_1.HeaderObject)
    ], CacheSettings.prototype, "forwardedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "forwardedQueryStrings" }),
        (0, class_transformer_1.Type)(function () { return querystringobject_1.QueryStringObject; }),
        __metadata("design:type", querystringobject_1.QueryStringObject)
    ], CacheSettings.prototype, "forwardedQueryStrings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maximumTTL" }),
        __metadata("design:type", Number)
    ], CacheSettings.prototype, "maximumTTL", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "minimumTTL" }),
        __metadata("design:type", Number)
