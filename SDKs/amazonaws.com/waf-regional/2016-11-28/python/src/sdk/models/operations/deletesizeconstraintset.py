...
class DeleteSizeConstraintSetRequest:
    ...
    delete_size_constraint_set_request: shared_deletesizeconstraintsetrequest.DeleteSizeConstraintSetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
