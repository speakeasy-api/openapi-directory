...
type CloudresourcemanagerFoldersCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudresourcemanagerFoldersCreateQueryParams struct {
	// V1 error format.
...
type CloudresourcemanagerFoldersCreateResponse struct {
	ContentType string
	// Successful response
