...
class EmployeePayroll:
    ...
    payroll: Optional[shared_payroll.Payroll] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payroll'), 'exclude': lambda f: f is None }})  
