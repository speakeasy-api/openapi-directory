...
class StartKeyPhrasesDetectionJobRequest:
    ...
    start_key_phrases_detection_job_request: shared_startkeyphrasesdetectionjobrequest.StartKeyPhrasesDetectionJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
