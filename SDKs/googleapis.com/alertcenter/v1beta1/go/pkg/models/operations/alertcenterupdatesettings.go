...
type AlertcenterUpdateSettingsSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AlertcenterUpdateSettingsQueryParams struct {
	// V1 error format.
...
type AlertcenterUpdateSettingsRequest struct {
...
type AlertcenterUpdateSettingsResponse struct {
	ContentType string
	// Successful response
