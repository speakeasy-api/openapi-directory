...
public class UpdateNetworkWirelessRfProfileRequestBody {
    ...
    public UpdateNetworkWirelessRfProfileRequestBodyPerSsidSettings perSsidSettings;
    public UpdateNetworkWirelessRfProfileRequestBody withPerSsidSettings(UpdateNetworkWirelessRfProfileRequestBodyPerSsidSettings perSsidSettings) {
    ...
    public UpdateNetworkWirelessRfProfileRequestBodyTransmission transmission;
    public UpdateNetworkWirelessRfProfileRequestBody withTransmission(UpdateNetworkWirelessRfProfileRequestBodyTransmission transmission) {
