...
export declare class SasportalNodesNodesDevicesCreateSignedSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesNodesDevicesCreateSignedSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesNodesDevicesCreateSignedSecurity extends SpeakeasyBase {
    option1?: SasportalNodesNodesDevicesCreateSignedSecurityOption1;
    option2?: SasportalNodesNodesDevicesCreateSignedSecurityOption2;
}
