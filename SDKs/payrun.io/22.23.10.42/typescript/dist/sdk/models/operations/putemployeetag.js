...
exports.PutEmployeeTagResponse = exports.PutEmployeeTagRequest = void 0;
...
var PutEmployeeTagRequest = /** @class */ (function (_super) {
    ...
    ], PutEmployeeTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], PutEmployeeTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], PutEmployeeTagRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], PutEmployeeTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], PutEmployeeTagRequest.prototype, "tagId", void 0);
    return PutEmployeeTagRequest;
}(utils_1.SpeakeasyBase));
exports.PutEmployeeTagRequest = PutEmployeeTagRequest;
var PutEmployeeTagResponse = /** @class */ (function (_super) {
    ...
    ], PutEmployeeTagResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.PutEmployeeTagResponse = PutEmployeeTagResponse;
