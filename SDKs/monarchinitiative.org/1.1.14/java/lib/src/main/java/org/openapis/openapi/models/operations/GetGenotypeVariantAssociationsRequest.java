...
public class GetGenotypeVariantAssociationsRequest {
    ...
    public GetGenotypeVariantAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGenotypeVariantAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGenotypeVariantAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGenotypeVariantAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGenotypeVariantAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGenotypeVariantAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGenotypeVariantAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGenotypeVariantAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGenotypeVariantAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGenotypeVariantAssociationsRequest withRelation(String relation) {
    ...
    public GetGenotypeVariantAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGenotypeVariantAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGenotypeVariantAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetGenotypeVariantAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGenotypeVariantAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGenotypeVariantAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGenotypeVariantAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGenotypeVariantAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
