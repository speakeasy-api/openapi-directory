...
from ..shared import timecardlistvo as shared_timecardlistvo
...
class GetMyTimeCardListResponse:
    ...
    time_card_list_vo: Optional[shared_timecardlistvo.TimeCardListVO] = dataclasses.field(default=None)
