...
export class AnalyticsadminPropertiesAccessBindingsBatchGetSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesAccessBindingsBatchGetSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class AnalyticsadminPropertiesAccessBindingsBatchGetSecurity extends SpeakeasyBase {
...
export class AnalyticsadminPropertiesAccessBindingsBatchGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesAccessBindingsBatchGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
