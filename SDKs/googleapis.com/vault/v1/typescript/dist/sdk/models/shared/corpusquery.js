...
var CorpusQuery = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "driveQuery" }),
        (0, class_transformer_1.Type)(function () { return helddrivequery_1.HeldDriveQuery; }),
        __metadata("design:type", helddrivequery_1.HeldDriveQuery)
    ], CorpusQuery.prototype, "driveQuery", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "groupsQuery" }),
        (0, class_transformer_1.Type)(function () { return heldgroupsquery_1.HeldGroupsQuery; }),
        __metadata("design:type", heldgroupsquery_1.HeldGroupsQuery)
    ], CorpusQuery.prototype, "groupsQuery", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "hangoutsChatQuery" }),
        (0, class_transformer_1.Type)(function () { return heldhangoutschatquery_1.HeldHangoutsChatQuery; }),
        __metadata("design:type", heldhangoutschatquery_1.HeldHangoutsChatQuery)
    ], CorpusQuery.prototype, "hangoutsChatQuery", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "mailQuery" }),
        (0, class_transformer_1.Type)(function () { return heldmailquery_1.HeldMailQuery; }),
        __metadata("design:type", heldmailquery_1.HeldMailQuery)
    ], CorpusQuery.prototype, "mailQuery", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "voiceQuery" }),
        (0, class_transformer_1.Type)(function () { return heldvoicequery_1.HeldVoiceQuery; }),
