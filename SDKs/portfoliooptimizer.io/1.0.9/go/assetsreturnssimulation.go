...
func (s *assetsReturnsSimulation) PostAssetsReturnsSimulationBootstrap(ctx context.Context, request operations.PostAssetsReturnsSimulationBootstrapRequest) (*operations.PostAssetsReturnsSimulationBootstrapResponse, error) {
	baseURL := s.serverURL
