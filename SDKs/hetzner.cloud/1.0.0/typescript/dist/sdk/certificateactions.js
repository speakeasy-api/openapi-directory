...
var CertificateActions = /** @class */ (function () {
    ...
    CertificateActions.prototype.getCertificatesIdActions = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/certificates/{id}/actions", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetCertificatesIdActionsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.actionsResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetCertificatesIdActionsActionsResponse);
                    }
                    break;
            }
            return res;
    ...
    CertificateActions.prototype.getCertificatesIdActionsActionId = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/certificates/{id}/actions/{action_id}", req);
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetCertificatesIdActionsActionIdResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.actionResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetCertificatesIdActionsActionIdActionResponse);
                    }
                    break;
            }
            return res;
    ...
    CertificateActions.prototype.postCertificatesIdActionsRetry = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/certificates/{id}/actions/retry", req);
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostCertificatesIdActionsRetryResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.actionResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.PostCertificatesIdActionsRetryActionResponse);
                    }
                    break;
            }
            return res;
