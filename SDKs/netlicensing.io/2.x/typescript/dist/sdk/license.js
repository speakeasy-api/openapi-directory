...
var License = /** @class */ (function () {
    ...
    **/
    License.prototype.createLicense = function (req, config) {
        var _a;
    ...
    **/
    License.prototype.deleteLicense = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    License.prototype.getLicense = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    License.prototype.listLicenses = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    License.prototype.updateLicense = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
