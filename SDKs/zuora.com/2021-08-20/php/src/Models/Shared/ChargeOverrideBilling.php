...
class ChargeOverrideBilling
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ChargeOverrideBillingBillCycleTypeEnum $billCycleType
     */
	#[\JMS\Serializer\Annotation\SerializedName('billCycleType')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ChargeOverrideBillingBillCycleTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ChargeOverrideBillingBillCycleTypeEnum $billCycleType = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ChargeOverrideBillingBillingPeriodEnum $billingPeriod
     */
	#[\JMS\Serializer\Annotation\SerializedName('billingPeriod')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ChargeOverrideBillingBillingPeriodEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ChargeOverrideBillingBillingPeriodEnum $billingPeriod = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ChargeOverrideBillingBillingPeriodAlignmentEnum $billingPeriodAlignment
     */
	#[\JMS\Serializer\Annotation\SerializedName('billingPeriodAlignment')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ChargeOverrideBillingBillingPeriodAlignmentEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ChargeOverrideBillingBillingPeriodAlignmentEnum $billingPeriodAlignment = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ChargeOverrideBillingBillingTimingEnum $billingTiming
     */
	#[\JMS\Serializer\Annotation\SerializedName('billingTiming')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ChargeOverrideBillingBillingTimingEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ChargeOverrideBillingBillingTimingEnum $billingTiming = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ChargeOverrideBillingWeeklyBillCycleDayEnum $weeklyBillCycleDay
     */
	#[\JMS\Serializer\Annotation\SerializedName('weeklyBillCycleDay')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ChargeOverrideBillingWeeklyBillCycleDayEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ChargeOverrideBillingWeeklyBillCycleDayEnum $weeklyBillCycleDay = null;
