...
var queryexecutionstateenum_1 = require("./queryexecutionstateenum");
...
var QueryExecutionStatus = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CompletionDateTime" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=StateChangeReason" }),
        __metadata("design:type", String)
