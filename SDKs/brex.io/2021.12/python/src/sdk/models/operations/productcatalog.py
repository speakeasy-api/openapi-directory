...
class ProductCatalogRequest:
    ...
    r"""two letter country code in upper case"""  
...
class ProductCatalog200ApplicationJSON:
    r"""Product with details like URI to purchase it"""
...
class ProductCatalogResponse:
    ...
    product_catalog_200_application_json_object: Optional[ProductCatalog200ApplicationJSON] = dataclasses.field(default=None)
    r"""Product with details like URI to purchase it"""  
    product_catalog_default_application_json_object: Optional[ProductCatalogDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Detailed information about the error"""  
