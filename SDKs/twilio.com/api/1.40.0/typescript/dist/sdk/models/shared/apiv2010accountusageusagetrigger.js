...
exports.ApiV2010AccountUsageUsageTrigger = exports.ApiV2010AccountUsageUsageTriggerCallbackMethodEnum = void 0;
var utils_1 = require("../../../internal/utils");
var usagetriggerenumrecurringenum_1 = require("./usagetriggerenumrecurringenum");
var usagetriggerenumtriggerfieldenum_1 = require("./usagetriggerenumtriggerfieldenum");
var usagetriggerenumusagecategoryenum_1 = require("./usagetriggerenumusagecategoryenum");
var class_transformer_1 = require("class-transformer");
/**
 * The HTTP method we use to call `callback_url`. Can be: `GET` or `POST`.
 */
var ApiV2010AccountUsageUsageTriggerCallbackMethodEnum;
...
})(ApiV2010AccountUsageUsageTriggerCallbackMethodEnum = exports.ApiV2010AccountUsageUsageTriggerCallbackMethodEnum || (exports.ApiV2010AccountUsageUsageTriggerCallbackMethodEnum = {}));
/**
 * Created
 */
var ApiV2010AccountUsageUsageTrigger = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "callback_method" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "date_fired" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "trigger_by" }),
        __metadata("design:type", String)
    ], ApiV2010AccountUsageUsageTrigger.prototype, "triggerBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "trigger_value" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "usage_category" }),
        __metadata("design:type", String)
    ], ApiV2010AccountUsageUsageTrigger.prototype, "usageCategory", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "usage_record_uri" }),
        __metadata("design:type", String)
    ], ApiV2010AccountUsageUsageTrigger.prototype, "usageRecordUri", void 0);
    return ApiV2010AccountUsageUsageTrigger;
}(utils_1.SpeakeasyBase));
exports.ApiV2010AccountUsageUsageTrigger = ApiV2010AccountUsageUsageTrigger;
