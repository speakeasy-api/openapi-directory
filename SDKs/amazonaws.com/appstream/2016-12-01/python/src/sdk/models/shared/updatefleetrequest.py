...
class UpdateFleetRequest:
    ...
    attributes_to_delete: Optional[list[shared_fleetattribute_enum.FleetAttributeEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AttributesToDelete'), 'exclude': lambda f: f is None }})  
    ...
    delete_vpc_config: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DeleteVpcConfig'), 'exclude': lambda f: f is None }})  
