...
class DriveDrivesDeleteQueryParams:
    allow_item_deletion: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'allowItemDeletion', 'style': 'form', 'explode': True }})
...
class DriveDrivesDeleteRequest:
    path_params: DriveDrivesDeletePathParams = dataclasses.field()
    query_params: DriveDrivesDeleteQueryParams = dataclasses.field()
    security: DriveDrivesDeleteSecurity = dataclasses.field()
