...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/jharsewa/3.0.0/python
```
...
req = operations.BtcerRequestBody(
    certificate_parameters=operations.BtcerRequestBodyCertificateParameters(
        ref_no="Ex. JHRC/2018/236543",
        token_no="Ex. 2924637nNv839 or date of issue in dd/mm/yyyy. if tokan number is less than 8 chars",
    ),
