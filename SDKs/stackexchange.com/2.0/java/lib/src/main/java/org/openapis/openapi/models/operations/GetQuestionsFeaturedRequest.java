...
public class GetQuestionsFeaturedRequest {
    /**
    ...
    public GetQuestionsFeaturedRequest withCallback(String callback) {
    ...
    public GetQuestionsFeaturedRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetQuestionsFeaturedRequest withFromdate(Long fromdate) {
    ...
    public GetQuestionsFeaturedRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetQuestionsFeaturedRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetQuestionsFeaturedRequest withOrder(GetQuestionsFeaturedOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetQuestionsFeaturedRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetQuestionsFeaturedRequest withPagesize(Long pagesize) {
    ...
    public GetQuestionsFeaturedRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetQuestionsFeaturedRequest withSort(GetQuestionsFeaturedSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetQuestionsFeaturedRequest withTagged(String tagged) {
        this.tagged = tagged;
        return this;
    }
    ...
    public GetQuestionsFeaturedRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetQuestionsFeaturedRequest(@JsonProperty("site") String site) {
        this.site = site;
  }
}
