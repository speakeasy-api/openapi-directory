 ...
 */
export declare enum NodeTypesScopedListWarningCodeEnum {
...
export declare class NodeTypesScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodeTypesScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class NodeTypesScopedList extends SpeakeasyBase {
    /**
