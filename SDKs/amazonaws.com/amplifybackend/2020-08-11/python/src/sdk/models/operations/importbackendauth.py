...
class ImportBackendAuthRequestBody:
    ...
    native_client_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('nativeClientId') }})
    r"""The ID of the Amazon Cognito native client."""  
    user_pool_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('userPoolId') }})
    r"""The ID of the Amazon Cognito user pool."""  
    web_client_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('webClientId') }})
    r"""The ID of the Amazon Cognito web client."""  
    ...
    r"""The ID of the Amazon Cognito identity pool."""  
...
class ImportBackendAuthRequest:
    ...
    request_body: ImportBackendAuthRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
