...
public class PostPayCodeRequest {
    ...
    public PostPayCodeRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("EmployerId") String employerId, @JsonProperty("PayCode") org.openapis.openapi.models.shared.PayCode payCode) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.employerId = employerId;
        this.payCode = payCode;
