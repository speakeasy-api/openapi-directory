...
func (e *DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "TARGETING_TYPE_SESSION_POSITION":
		*e = DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum: %s", s)
	}
}
