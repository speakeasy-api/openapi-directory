 ...
 */
public class AccountSettings200ApplicationXML3 {
    /**
     * Only account administrators can change a user's username and picture.
     */
    
    public Boolean adminChangeNamePic;
    public AccountSettings200ApplicationXML3 withAdminChangeNamePic(Boolean adminChangeNamePic) {
    ...
    public AccountSettings200ApplicationXML3 withHideBillingInfo(Boolean hideBillingInfo) {
    ...
    public AccountSettings200ApplicationXML3 withImportPhotosFromDevices(Boolean importPhotosFromDevices) {
    ...
    public AccountSettings200ApplicationXML3PasswordRequirement passwordRequirement;
    public AccountSettings200ApplicationXML3 withPasswordRequirement(AccountSettings200ApplicationXML3PasswordRequirement passwordRequirement) {
    ...
    public AccountSettings200ApplicationXML3 withSignAgainPeriodForInactivityOnClient(Long signAgainPeriodForInactivityOnClient) {
    ...
    public AccountSettings200ApplicationXML3 withSignAgainPeriodForInactivityOnWeb(Long signAgainPeriodForInactivityOnWeb) {
    ...
    public AccountSettings200ApplicationXML3SignInWithTwoFactorAuthEnum signInWithTwoFactorAuth;
    public AccountSettings200ApplicationXML3 withSignInWithTwoFactorAuth(AccountSettings200ApplicationXML3SignInWithTwoFactorAuthEnum signInWithTwoFactorAuth) {
    ...
    public AccountSettings200ApplicationXML3 withSignInWithTwoFactorAuthGroups(String[] signInWithTwoFactorAuthGroups) {
    ...
    public AccountSettings200ApplicationXML3 withSignInWithTwoFactorAuthRoles(String[] signInWithTwoFactorAuthRoles) {
