 ...
 */
export declare class GetTransitGatewayMulticastDomainAssociationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetTransitGatewayMulticastDomainAssociationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
