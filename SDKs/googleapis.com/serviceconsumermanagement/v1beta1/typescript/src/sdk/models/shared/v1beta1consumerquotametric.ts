 ...
 */
export class V1Beta1ConsumerQuotaMetric extends SpeakeasyBase {
  /**
   * The consumer quota for each quota limit defined on the metric.
   */
  @SpeakeasyMetadata({ elemType: V1Beta1ConsumerQuotaLimit })
  @Expose({ name: "consumerQuotaLimits" })
  @Type(() => V1Beta1ConsumerQuotaLimit)
  consumerQuotaLimits?: V1Beta1ConsumerQuotaLimit[];
  ...
  @Type(() => V1Beta1ConsumerQuotaLimit)
  descendantConsumerQuotaLimits?: V1Beta1ConsumerQuotaLimit[];
