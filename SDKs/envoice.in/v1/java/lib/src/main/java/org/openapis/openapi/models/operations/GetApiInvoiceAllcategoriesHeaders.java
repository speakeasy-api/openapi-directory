...
public class GetApiInvoiceAllcategoriesHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public GetApiInvoiceAllcategoriesHeaders withXAuthKey(String xAuthKey) {
    ...
    public GetApiInvoiceAllcategoriesHeaders withXAuthSecret(String xAuthSecret) {
