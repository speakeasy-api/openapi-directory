...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EgcerResponse res = sdk.apIs.egcer(req, new EgcerSecurity("molestiae", "minus") {{
...
* [egcer](docs/apis/README.md#egcer) - Economically Backward In General Caste Certificate
