...
class GetChatHeadUsingPOST200ApplicationJSONData:
    ...
    chat_head: Optional[GetChatHeadUsingPOST200ApplicationJSONDataChatHead] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('chatHead'), 'exclude': lambda f: f is None }})  
...
class GetChatHeadUsingPOST200ApplicationJSON:
    ...
    code: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})  
    data: Optional[GetChatHeadUsingPOST200ApplicationJSONData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
    message: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message'), 'exclude': lambda f: f is None }})  
