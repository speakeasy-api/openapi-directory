...
export class AnalysisCategories {
  ...
  analysisCategoriesGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AnalysisCategoriesGetResponse =
        new operations.AnalysisCategoriesGetResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.pageResultAnalysisCategoryDto = utils.objectToClass(
              httpRes?.data,
              shared.PageResultAnalysisCategoryDto
            );
          }
          break;
      }
