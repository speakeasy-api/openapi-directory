...
public class GETDescribePrincipalIdFormatRequest {
    ...
    public GETDescribePrincipalIdFormatRequest(@JsonProperty("Action") GETDescribePrincipalIdFormatActionEnum action, @JsonProperty("Version") GETDescribePrincipalIdFormatVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
