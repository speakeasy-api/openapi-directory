...
class TimeCardReceivedDetailVO:
    r"""Java type: com.noosh.nooshapi.vo.TimeCardReceivedDetailVO"""
    ...
    r"""Java type: java.math.BigDecimal"""  
    owner: Optional[shared_personvo.PersonVO] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('owner'), 'exclude': lambda f: f is None }})
