...
exports.GetPlayerSeasonStatsResponse = exports.GetPlayerSeasonStatsRequest = exports.GetPlayerSeasonStatsQueryParams = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var GetPlayerSeasonStatsQueryParams = /** @class */ (function (_super) {
    __extends(GetPlayerSeasonStatsQueryParams, _super);
    function GetPlayerSeasonStatsQueryParams() {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=endWeek" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=startWeek" }),
        __metadata("design:type", Number)
...
exports.GetPlayerSeasonStatsQueryParams = GetPlayerSeasonStatsQueryParams;
var GetPlayerSeasonStatsRequest = /** @class */ (function (_super) {
    __extends(GetPlayerSeasonStatsRequest, _super);
    function GetPlayerSeasonStatsRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
exports.GetPlayerSeasonStatsRequest = GetPlayerSeasonStatsRequest;
var GetPlayerSeasonStatsResponse = /** @class */ (function (_super) {
    __extends(GetPlayerSeasonStatsResponse, _super);
    function GetPlayerSeasonStatsResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.PlayerSeasonStat }),
...
exports.GetPlayerSeasonStatsResponse = GetPlayerSeasonStatsResponse;
