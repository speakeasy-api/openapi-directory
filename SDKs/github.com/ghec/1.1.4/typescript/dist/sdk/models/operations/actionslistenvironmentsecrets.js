...
exports.ActionsListEnvironmentSecretsResponse = exports.ActionsListEnvironmentSecrets200ApplicationJSON = exports.ActionsListEnvironmentSecretsRequest = void 0;
...
var ActionsListEnvironmentSecretsRequest = /** @class */ (function (_super) {
    ...
    ], ActionsListEnvironmentSecretsRequest.prototype, "environmentName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], ActionsListEnvironmentSecretsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], ActionsListEnvironmentSecretsRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repository_id",
        }),
        __metadata("design:type", Number)
    ], ActionsListEnvironmentSecretsRequest.prototype, "repositoryId", void 0);
    return ActionsListEnvironmentSecretsRequest;
}(utils_1.SpeakeasyBase));
exports.ActionsListEnvironmentSecretsRequest = ActionsListEnvironmentSecretsRequest;
/**
 * Response
 */
var ActionsListEnvironmentSecrets200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ActionsSecret }),
        (0, class_transformer_1.Expose)({ name: "secrets" }),
        (0, class_transformer_1.Type)(function () { return shared.ActionsSecret; }),
...
exports.ActionsListEnvironmentSecrets200ApplicationJSON = ActionsListEnvironmentSecrets200ApplicationJSON;
var ActionsListEnvironmentSecretsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ActionsListEnvironmentSecretsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.ActionsListEnvironmentSecretsResponse = ActionsListEnvironmentSecretsResponse;
