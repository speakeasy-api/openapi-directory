...
class SearchBioOntologySeriesQueryParams:
...
@dataclasses.dataclass
class SearchBioOntologySeriesRequest:
    query_params: SearchBioOntologySeriesQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchBioOntologySeriesResponse:
