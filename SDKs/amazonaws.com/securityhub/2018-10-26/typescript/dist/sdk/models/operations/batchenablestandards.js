...
exports.BatchEnableStandardsResponse = exports.BatchEnableStandardsRequest = exports.BatchEnableStandardsRequestBody = void 0;
...
var BatchEnableStandardsRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.StandardsSubscriptionRequest }),
        (0, class_transformer_1.Expose)({ name: "StandardsSubscriptionRequests" }),
        (0, class_transformer_1.Type)(function () { return shared.StandardsSubscriptionRequest; }),
...
exports.BatchEnableStandardsRequestBody = BatchEnableStandardsRequestBody;
var BatchEnableStandardsRequest = /** @class */ (function (_super) {
    ...
    ], BatchEnableStandardsRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], BatchEnableStandardsRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], BatchEnableStandardsRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], BatchEnableStandardsRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], BatchEnableStandardsRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], BatchEnableStandardsRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], BatchEnableStandardsRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], BatchEnableStandardsRequest.prototype, "xAmzSignedHeaders", void 0);
...
var BatchEnableStandardsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], BatchEnableStandardsResponse.prototype, "rawResponse", void 0);
