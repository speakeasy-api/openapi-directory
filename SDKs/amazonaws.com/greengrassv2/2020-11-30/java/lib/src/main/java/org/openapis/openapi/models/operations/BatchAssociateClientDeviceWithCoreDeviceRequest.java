...
public class BatchAssociateClientDeviceWithCoreDeviceRequest {
    ...
    public BatchAssociateClientDeviceWithCoreDeviceRequest(@JsonProperty("RequestBody") BatchAssociateClientDeviceWithCoreDeviceRequestBody requestBody, @JsonProperty("coreDeviceThingName") String coreDeviceThingName) {
        this.requestBody = requestBody;
        this.coreDeviceThingName = coreDeviceThingName;
  }
}
