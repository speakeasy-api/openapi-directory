...
exports.AssetChanges = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var AssetChanges = /** @class */ (function () {
    function AssetChanges(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    AssetChanges.prototype.deleteV3AssetChangesChangeSetsChangeSetId = function (req, config) {
     ...
     *
    **/
    AssetChanges.prototype.getV3AssetChangesChannels = function (config) {
        var baseURL = this._serverURL;
     ...
     *
    **/
    AssetChanges.prototype.putV3AssetChangesChangeSets = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.AssetChanges = AssetChanges;
