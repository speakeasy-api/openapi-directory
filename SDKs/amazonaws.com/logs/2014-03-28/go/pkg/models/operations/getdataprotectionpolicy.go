...
type GetDataProtectionPolicyHeaders struct {
...
type GetDataProtectionPolicyRequest struct {
	Headers GetDataProtectionPolicyHeaders
	Request shared.GetDataProtectionPolicyRequest `request:"mediaType=application/json"`
}
