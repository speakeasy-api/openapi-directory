...
public class ForwardingRules {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeForwardingRulesTestIamPermissionsResponse computeForwardingRulesTestIamPermissions(org.openapis.openapi.models.operations.ComputeForwardingRulesTestIamPermissionsRequest request, org.openapis.openapi.models.operations.ComputeForwardingRulesTestIamPermissionsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeForwardingRulesTestIamPermissionsRequest.class, baseUrl, "/projects/{project}/regions/{region}/forwardingRules/{resource}/testIamPermissions", request, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeForwardingRulesTestIamPermissionsRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
