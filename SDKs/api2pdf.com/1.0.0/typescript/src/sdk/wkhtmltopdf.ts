...
export class Wkhtmltopdf {
  ...
  wkhtmltopdfFromHtmlPost(
    req: shared.WkHtmlToPdfHtmlToPdfRequest,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.WkhtmltopdfFromHtmlPostResponse =
        new operations.WkhtmltopdfFromHtmlPostResponse({
  ...
  wkhtmltopdfFromUrlGET(
    ...
    security: operations.WkhtmltopdfFromUrlGETSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.WkhtmltopdfFromUrlGETResponse =
        new operations.WkhtmltopdfFromUrlGETResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  wkhtmltopdfFromUrlPost(
    req: shared.WkHtmlToPdfUrlToPdfRequest,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.WkhtmltopdfFromUrlPostResponse =
        new operations.WkhtmltopdfFromUrlPostResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
