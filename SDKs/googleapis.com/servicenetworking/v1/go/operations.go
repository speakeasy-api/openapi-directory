...
func (s *Operations) ServicenetworkingOperationsCancel(ctx context.Context, request operations.ServicenetworkingOperationsCancelRequest) (*operations.ServicenetworkingOperationsCancelResponse, error) {
	...
	res := &operations.ServicenetworkingOperationsCancelResponse{
