...
public class ListingRecommendation {
	...
	public ListingRecommendation(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    **/
    public openapisdk.models.operations.FindListingRecommendationsResponse findListingRecommendations(openapisdk.models.operations.FindListingRecommendationsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/find");
        ...
        openapisdk.models.operations.FindListingRecommendationsResponse res = new openapisdk.models.operations.FindListingRecommendationsResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json;charset=UTF-8")) {
                ...
                openapisdk.models.shared.PagedListingRecommendationCollection out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.PagedListingRecommendationCollection.class);
