...
class ListProblemsResponse:
    ...
    problem_list: Optional[list[shared_problem.Problem]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ProblemList'), 'exclude': lambda f: f is None }})  
