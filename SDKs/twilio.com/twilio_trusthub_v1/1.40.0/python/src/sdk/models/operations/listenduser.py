...
class ListEndUserListEndUserResponse:
    ...
    results: Optional[list[shared_trusthub_v1_end_user.TrusthubV1EndUser]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
