...
class SetVaultAccessPolicyRequestBody:
    policy: Optional[SetVaultAccessPolicyRequestBodyPolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('policy') }})
    

@dataclasses.dataclass
class SetVaultAccessPolicyRequest:
    headers: SetVaultAccessPolicyHeaders = dataclasses.field()
    path_params: SetVaultAccessPolicyPathParams = dataclasses.field()
    request: SetVaultAccessPolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
