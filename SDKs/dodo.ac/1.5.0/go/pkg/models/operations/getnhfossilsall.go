...
type GetNhFossilsAllQueryParams struct {
...
type GetNhFossilsAllHeaders struct {
...
type GetNhFossilsAllRequest struct {
	QueryParams GetNhFossilsAllQueryParams
	Headers     GetNhFossilsAllHeaders
}

type GetNhFossilsAllResponse struct {
	ContentType string
