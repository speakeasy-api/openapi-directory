...
from ..shared import salesforcestandardobjectname_enum as shared_salesforcestandardobjectname_enum
...
class SalesforceStandardObjectConfiguration:
    r"""Provides the configuration information for indexing a single standard object."""
    ...
    name: shared_salesforcestandardobjectname_enum.SalesforceStandardObjectNameEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Name') }})  
