...
class JobScheduleDeleteRequest:
    headers: JobScheduleDeleteHeaders = dataclasses.field()
    path_params: JobScheduleDeletePathParams = dataclasses.field()
    query_params: JobScheduleDeleteQueryParams = dataclasses.field()
