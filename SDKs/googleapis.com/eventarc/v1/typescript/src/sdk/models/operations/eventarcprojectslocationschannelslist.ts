...
export class EventarcProjectsLocationsChannelsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class EventarcProjectsLocationsChannelsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class EventarcProjectsLocationsChannelsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
