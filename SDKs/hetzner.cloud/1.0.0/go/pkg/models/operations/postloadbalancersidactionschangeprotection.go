...
func (e PostLoadBalancersIDActionsChangeProtectionActionResponseActionStatusEnum) ToPointer() *PostLoadBalancersIDActionsChangeProtectionActionResponseActionStatusEnum {
	return &e
}
...
func (e *PostLoadBalancersIDActionsChangeProtectionActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostLoadBalancersIDActionsChangeProtectionActionResponseActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostLoadBalancersIDActionsChangeProtectionActionResponseActionStatusEnum: %v", v)
	}
}
