...
class Networks 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpAddressesRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpAddressesSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpAddressesResponse
     */
	public function computeNetworksListIpAddresses(
        \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpAddressesRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpAddressesSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpAddressesResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/networks/{network}/listIpAddresses', \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpAddressesRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpAddressesRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpAddressesResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->ipAddressesList = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\IpAddressesList', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpOwnersRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpOwnersSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpOwnersResponse
     */
	public function computeNetworksListIpOwners(
        \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpOwnersRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpOwnersSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpOwnersResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/networks/{network}/listIpOwners', \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpOwnersRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpOwnersRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksListIpOwnersResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->ipOwnerList = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\IpOwnerList', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksTestIamPermissionsResponse
     */
	public function computeNetworksTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/networks/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeNetworksTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeNetworksTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
