...
public class V1Tax {
    ...
    public org.openapis.openapi.models.operations.TaxRatesByCountryCodeResponse taxRatesByCountryCode(org.openapis.openapi.models.operations.TaxRatesByCountryCodeRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.TaxRatesByCountryCodeQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.TaxRatesByIpAddressResponse taxRatesByIpAddress(org.openapis.openapi.models.operations.TaxRatesByIpAddressRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.TaxRatesByIpAddressQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
