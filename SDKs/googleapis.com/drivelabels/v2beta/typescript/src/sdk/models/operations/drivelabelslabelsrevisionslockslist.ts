...
export class DrivelabelsLabelsRevisionsLocksListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DrivelabelsLabelsRevisionsLocksListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
