...
class GetNhToolsRequest:
    ...
    r"""When set to `true`, only tool names are returned. Instead of an array of objects with all details, the return will be an array of strings."""  
    

@dataclasses.dataclass
class GetNhToolsResponse:
    ...
    nh_tools: Optional[list[shared_nhtool.NHTool]] = dataclasses.field(default=None)
    r"""A JSON array of interior items."""  
