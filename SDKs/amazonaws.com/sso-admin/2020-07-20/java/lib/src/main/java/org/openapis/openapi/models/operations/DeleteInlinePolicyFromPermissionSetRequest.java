...
public class DeleteInlinePolicyFromPermissionSetRequest {
    ...
    public DeleteInlinePolicyFromPermissionSetRequest(@JsonProperty("DeleteInlinePolicyFromPermissionSetRequest") org.openapis.openapi.models.shared.DeleteInlinePolicyFromPermissionSetRequest deleteInlinePolicyFromPermissionSetRequest, @JsonProperty("X-Amz-Target") DeleteInlinePolicyFromPermissionSetXAmzTargetEnum xAmzTarget) {
        this.deleteInlinePolicyFromPermissionSetRequest = deleteInlinePolicyFromPermissionSetRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
