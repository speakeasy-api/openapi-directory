...
class GetAddRoleToDbInstanceQueryParams:
    action: GetAddRoleToDbInstanceActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetAddRoleToDbInstanceVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAddRoleToDbInstanceRequest:
    headers: GetAddRoleToDbInstanceHeaders = dataclasses.field()
    query_params: GetAddRoleToDbInstanceQueryParams = dataclasses.field()
