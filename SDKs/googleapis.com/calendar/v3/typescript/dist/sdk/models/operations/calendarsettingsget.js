...
exports.CalendarSettingsGetResponse = exports.CalendarSettingsGetRequest = exports.CalendarSettingsGetSecurity = exports.CalendarSettingsGetSecurityOption3 = exports.CalendarSettingsGetSecurityOption2 = exports.CalendarSettingsGetSecurityOption1 = void 0;
...
var CalendarSettingsGetRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CalendarSettingsGetRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], CalendarSettingsGetRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], CalendarSettingsGetRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], CalendarSettingsGetRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], CalendarSettingsGetRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], CalendarSettingsGetRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=setting",
        }),
        __metadata("design:type", String)
    ], CalendarSettingsGetRequest.prototype, "setting", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], CalendarSettingsGetRequest.prototype, "userIp", void 0);
...
var CalendarSettingsGetResponse = /** @class */ (function (_super) {
    ...
    ], CalendarSettingsGetResponse.prototype, "rawResponse", void 0);
