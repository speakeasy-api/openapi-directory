...
exports.TaskrouterV1WorkspaceTaskQueueTaskQueueRealTimeStatistics = void 0;
...
var TaskrouterV1WorkspaceTaskQueueTaskQueueRealTimeStatistics = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=longest_relative_task_age_in_queue" }),
        __metadata("design:type", Number)
    ], TaskrouterV1WorkspaceTaskQueueTaskQueueRealTimeStatistics.prototype, "longestRelativeTaskAgeInQueue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=longest_relative_task_sid_in_queue" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=total_available_workers" }),
        __metadata("design:type", Number)
    ], TaskrouterV1WorkspaceTaskQueueTaskQueueRealTimeStatistics.prototype, "totalAvailableWorkers", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=total_eligible_workers" }),
        __metadata("design:type", Number)
...
exports.TaskrouterV1WorkspaceTaskQueueTaskQueueRealTimeStatistics = TaskrouterV1WorkspaceTaskQueueTaskQueueRealTimeStatistics;
