...
class GetListSSHPublicKeysQueryParams:
    action: GetListSSHPublicKeysActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetListSSHPublicKeysVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListSSHPublicKeysRequest:
    headers: GetListSSHPublicKeysHeaders = dataclasses.field()
    query_params: GetListSSHPublicKeysQueryParams = dataclasses.field()
