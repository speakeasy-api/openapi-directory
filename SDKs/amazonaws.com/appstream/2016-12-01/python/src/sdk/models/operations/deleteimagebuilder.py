...
class DeleteImageBuilderRequest:
    ...
    delete_image_builder_request: shared_deleteimagebuilderrequest.DeleteImageBuilderRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
