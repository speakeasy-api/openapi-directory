...
public class SetListeNoire {
    ...
    **/
    public openapisdk.models.operations.SetListeNoireResponse setListeNoire(openapisdk.models.operations.SetListeNoireRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/setlistenoire");
        ...
        openapisdk.models.operations.SetListeNoireResponse res = new openapisdk.models.operations.SetListeNoireResponse() {{
