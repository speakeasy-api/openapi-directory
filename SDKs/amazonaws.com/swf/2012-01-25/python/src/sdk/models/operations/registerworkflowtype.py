...
from ..shared import registerworkflowtypeinput as shared_registerworkflowtypeinput
...
class RegisterWorkflowTypeHeaders:
    x_amz_target: RegisterWorkflowTypeXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RegisterWorkflowTypeRequest:
    headers: RegisterWorkflowTypeHeaders = dataclasses.field()
    request: shared_registerworkflowtypeinput.RegisterWorkflowTypeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
