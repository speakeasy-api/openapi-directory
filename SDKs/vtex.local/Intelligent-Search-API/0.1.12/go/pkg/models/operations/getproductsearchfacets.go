...
type GetProductSearchFacetsPathParams struct {
	// # Format
	//
...
type GetProductSearchFacetsQueryParams struct {
...
type GetProductSearchFacetsRequest struct {
	PathParams  GetProductSearchFacetsPathParams
	QueryParams GetProductSearchFacetsQueryParams
}
