...
from ..shared import createdomainassociationresult as shared_createdomainassociationresult


@dataclasses.dataclass
class CreateDomainAssociationPathParams:
    app_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'appId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class CreateDomainAssociationHeaders:
...
class CreateDomainAssociationRequest:
    headers: CreateDomainAssociationHeaders = dataclasses.field()
    path_params: CreateDomainAssociationPathParams = dataclasses.field()
    request: CreateDomainAssociationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateDomainAssociationResponse:
    ...
    create_domain_association_result: Optional[shared_createdomainassociationresult.CreateDomainAssociationResult] = dataclasses.field(default=None)
