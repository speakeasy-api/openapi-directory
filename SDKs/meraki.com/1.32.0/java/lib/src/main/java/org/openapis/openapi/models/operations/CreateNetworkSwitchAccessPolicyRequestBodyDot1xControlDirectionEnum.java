 ...
 */
public enum CreateNetworkSwitchAccessPolicyRequestBodyDot1xControlDirectionEnum {
    BOTH("both"),
    INBOUND("inbound");
    ...
    private CreateNetworkSwitchAccessPolicyRequestBodyDot1xControlDirectionEnum(String value) {
        this.value = value;
    }
}
