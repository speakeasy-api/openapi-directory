...
var secretscanning_1 = require("./secretscanning");
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.secretScanning = new secretscanning_1.SecretScanning(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
