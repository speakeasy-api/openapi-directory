...
export class GetUserExternalId200ApplicationJSONUserCustomFields extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "first_name" })
  firstName?: string;
}

export class GetUserExternalId200ApplicationJSONUserGroupUsers extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetUserExternalId200ApplicationJSONUserGroups extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetUserExternalId200ApplicationJSONUserUserAuthTokens extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "browser" })
  browser: string;
...
export class GetUserExternalId200ApplicationJSONUserUserFields extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "1" })
  one: string;
...
export class GetUserExternalId200ApplicationJSONUserUserNotificationSchedule extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetUserExternalId200ApplicationJSONUserUserOption extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetUserExternalId200ApplicationJSONUser extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "admin" })
  admin: boolean;
  ...
  @Type(() => GetUserExternalId200ApplicationJSONUserCustomFields)
  ...
  @Type(() => GetUserExternalId200ApplicationJSONUserGroupUsers)
  ...
  @Expose({ name: "groups" })
  @Type(() => GetUserExternalId200ApplicationJSONUserGroups)
 ...
 * user response
 */
export class GetUserExternalId200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "user" })
  @Type(() => GetUserExternalId200ApplicationJSONUser)
