...
func (e ListAssetModelPropertiesFilterEnum) ToPointer() *ListAssetModelPropertiesFilterEnum {
	return &e
}
...
func (e *ListAssetModelPropertiesFilterEnum) UnmarshalJSON(data []byte) error {
	...
	case "ALL":
		fallthrough
	case "BASE":
		*e = ListAssetModelPropertiesFilterEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListAssetModelPropertiesFilterEnum: %v", v)
	}
}
