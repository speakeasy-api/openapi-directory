...
// List As2 Keys
func (s *Users) GetUsersUserIDAs2Keys(ctx context.Context, request operations.GetUsersUserIDAs2KeysRequest) (*operations.GetUsersUserIDAs2KeysResponse, error) {
	baseURL := s._serverURL
...
// Create As2 Key
func (s *Users) PostUsersUserIDAs2Keys(ctx context.Context, request operations.PostUsersUserIDAs2KeysRequest) (*operations.PostUsersUserIDAs2KeysResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/users/{user_id}/as2_keys", request.PathParams)
