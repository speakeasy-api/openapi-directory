...
const (
	UntagResourceXAmzTargetEnumAwsShineFrontendService20170701UntagResource UntagResourceXAmzTargetEnum = "AWSShineFrontendService_20170701.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "AWSShineFrontendService_20170701.UntagResource":
