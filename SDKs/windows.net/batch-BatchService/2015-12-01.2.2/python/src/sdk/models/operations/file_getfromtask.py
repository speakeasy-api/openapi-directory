...
class FileGetFromTaskRequest:
    ...
    r"""Specifies the byte range to be retrieved. The default is to retrieve the entire file.  The format is startRange-endRange."""  
