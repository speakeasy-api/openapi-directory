...
class AssociateResolverEndpointIPAddressRequest:
    ...
    associate_resolver_endpoint_ip_address_request: shared_associateresolverendpointipaddressrequest.AssociateResolverEndpointIPAddressRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
