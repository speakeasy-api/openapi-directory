...
export class ListSupportingDocumentTypeListSupportingDocumentTypeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListSupportingDocumentTypeListSupportingDocumentTypeResponseMeta)
  meta?: ListSupportingDocumentTypeListSupportingDocumentTypeResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.TrusthubV1SupportingDocumentType })
  @Expose({ name: "supporting_document_types" })
  @Type(() => shared.TrusthubV1SupportingDocumentType)
