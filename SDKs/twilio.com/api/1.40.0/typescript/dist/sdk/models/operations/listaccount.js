...
exports.ListAccountResponse = exports.ListAccountListAccountResponse = exports.ListAccountRequest = exports.ListAccountSecurity = exports.ListAccountServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListAccountServerList = ["https://api.twilio.com"];
var ListAccountSecurity = /** @class */ (function (_super) {
    ...
    ], ListAccountSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListAccountSecurity.prototype, "username", void 0);
...
var ListAccountRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListAccountRequest.prototype, "friendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListAccountRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListAccountRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListAccountRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListAccountRequest.prototype, "status", void 0);
...
var ListAccountListAccountResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ApiV2010Account }),
        (0, class_transformer_1.Expose)({ name: "accounts" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010Account; }),
...
var ListAccountResponse = /** @class */ (function (_super) {
    ...
    ], ListAccountResponse.prototype, "rawResponse", void 0);
