...
use \OpenAPI\OpenAPI\Models\Operations\CancelOrder2Request;
use \OpenAPI\OpenAPI\Models\Operations\CancelOrder2RequestBody;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CancelOrder2Request();
    $request->accept = 'application/json';
    $request->contentType = 'application/json';
    $request->requestBody = new CancelOrder2RequestBody();
    $request->requestBody->reason = 'Unexpected stock shortage';
    $request->orderId = '70caf3941s6df1';

    $response = $sdk->orders->cancelOrder2($request);

    if ($response->cancelOrder2200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetOrder2Request;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetOrder2Request();
    $request->accept = 'application/json';
    $request->contentType = 'application/json';
    $request->orderId = '70caf3941s6df1';
    $request->reason = 'data-validation';

    $response = $sdk->orders->getOrder2($request);

    if ($response->getOrder2200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListOrders2Request;
use \OpenAPI\OpenAPI\Models\Operations\ListOrders2RequestBody;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListOrders2Request();
    $request->accept = 'application/json';
    $request->contentType = 'application/json';
    $request->requestBody = new ListOrders2RequestBody();
    $request->requestBody->fCreationDate = 'creationDate:[2021-11-01T00:00:00.000Z TO 2022-11-10T02:00:00.000Z]';
    $request->requestBody->page = 1;
    $request->requestBody->perPage = 15;
    $request->requestBody->q = 'Postman Test';
    $request->fHasInputInvoice = false;

    $response = $sdk->orders->listOrders2($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StartHandling2Request;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StartHandling2Request();
    $request->accept = 'application/json';
    $request->contentType = 'application/json';
    $request->orderId = '70caf3941s6df1';

    $response = $sdk->orders->startHandling2($request);
