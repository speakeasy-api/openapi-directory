...
public class DcimPowerConnectionsListQueryParams {
    ...
    public DcimPowerConnectionsListQueryParams withConnectionStatusN(String connectionStatusN) {
    ...
    public DcimPowerConnectionsListQueryParams withDeviceId(String deviceId) {
    ...
    public DcimPowerConnectionsListQueryParams withNameIc(String nameIc) {
        this.nameIc = nameIc;
        return this;
    }
    ...
    public DcimPowerConnectionsListQueryParams withNameIe(String nameIe) {
        this.nameIe = nameIe;
        return this;
    }
    ...
    public DcimPowerConnectionsListQueryParams withNameIew(String nameIew) {
    ...
    public DcimPowerConnectionsListQueryParams withNameIsw(String nameIsw) {
    ...
    public String nameN;
    public DcimPowerConnectionsListQueryParams withNameN(String nameN) {
        this.nameN = nameN;
        return this;
    }
    ...
    public DcimPowerConnectionsListQueryParams withNameNic(String nameNic) {
    ...
    public DcimPowerConnectionsListQueryParams withNameNie(String nameNie) {
    ...
    public DcimPowerConnectionsListQueryParams withNameNiew(String nameNiew) {
    ...
    public DcimPowerConnectionsListQueryParams withNameNisw(String nameNisw) {
