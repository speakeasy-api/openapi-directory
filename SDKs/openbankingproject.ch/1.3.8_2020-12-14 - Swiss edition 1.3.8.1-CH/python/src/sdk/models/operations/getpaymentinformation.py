...
from ..shared import paymentinitiationwithstatusresponse as shared_paymentinitiationwithstatusresponse
from ..shared import periodicpaymentinitiationwithstatusresponse as shared_periodicpaymentinitiationwithstatusresponse
from ..shared import bulkpaymentinitiationwithstatusresponse as shared_bulkpaymentinitiationwithstatusresponse


@dataclasses.dataclass
class GetPaymentInformationPathParams:
...
@dataclasses.dataclass
class GetPaymentInformationHeaders:
...
@dataclasses.dataclass
class GetPaymentInformationRequest:
    headers: GetPaymentInformationHeaders = dataclasses.field()
    path_params: GetPaymentInformationPathParams = dataclasses.field()
    security: GetPaymentInformationSecurity = dataclasses.field()
...
class GetPaymentInformationResponse:
    ...
    get_payment_information_200_application_json_one_of: Optional[Any] = dataclasses.field(default=None)
