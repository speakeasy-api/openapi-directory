...
class DescribeActivityRequest:
    ...
    describe_activity_input: shared_describeactivityinput.DescribeActivityInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
