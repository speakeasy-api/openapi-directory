...
from ..shared import listfieldsresponse as shared_listfieldsresponse
...
class ListFieldsResponse:
    ...
    list_fields_response: Optional[shared_listfieldsresponse.ListFieldsResponse] = dataclasses.field(default=None)
    r"""Success"""  
