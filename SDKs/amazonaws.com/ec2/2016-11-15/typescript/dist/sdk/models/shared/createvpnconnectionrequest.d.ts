...
import { VpnTunnelOptionsSpecification } from "./vpntunneloptionsspecification";
/**
 * The options for the VPN connection.
 */
export declare class CreateVpnConnectionRequestOptions extends SpeakeasyBase {
 ...
 */
export declare enum CreateVpnConnectionRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateVpnConnectionRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateVpnConnectionRequestTagSpecifications extends SpeakeasyBase {
 ...
 */
export declare class CreateVpnConnectionRequest extends SpeakeasyBase {
