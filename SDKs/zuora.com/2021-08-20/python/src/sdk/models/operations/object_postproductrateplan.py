...
class ObjectPostProductRatePlanQueryParams:
...
@dataclasses.dataclass
class ObjectPostProductRatePlanHeaders:
    zuora_entity_ids: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Entity-Ids', 'style': 'simple', 'explode': False }})
    zuora_track_id: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Track-Id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectPostProductRatePlanRequest:
    headers: ObjectPostProductRatePlanHeaders = dataclasses.field()
    query_params: ObjectPostProductRatePlanQueryParams = dataclasses.field()
