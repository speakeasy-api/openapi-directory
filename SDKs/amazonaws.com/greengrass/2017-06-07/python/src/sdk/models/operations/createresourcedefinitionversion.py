...
class CreateResourceDefinitionVersionRequest:
    headers: CreateResourceDefinitionVersionHeaders = dataclasses.field()
    path_params: CreateResourceDefinitionVersionPathParams = dataclasses.field()
    request: CreateResourceDefinitionVersionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
