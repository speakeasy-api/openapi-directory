...
class RemarketingAudiences:
    r"""A remarketing audience collection lists Analytics remarketing audiences to which the user has access. Each resource in the collection corresponds to a single Analytics remarketing audience."""
    
    items: Optional[list[shared_remarketingaudience.RemarketingAudience]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
    r"""A list of remarketing audiences."""  
    ...
    r"""Link to next page for this remarketing audience collection."""  
