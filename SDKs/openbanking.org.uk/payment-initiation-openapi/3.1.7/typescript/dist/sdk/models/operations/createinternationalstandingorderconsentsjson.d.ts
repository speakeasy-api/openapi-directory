...
export declare class CreateInternationalStandingOrderConsentsJsonSecurity extends SpeakeasyBase {
    tppoAuth2Security: string;
}
export declare class CreateInternationalStandingOrderConsentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateInternationalStandingOrderConsentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
