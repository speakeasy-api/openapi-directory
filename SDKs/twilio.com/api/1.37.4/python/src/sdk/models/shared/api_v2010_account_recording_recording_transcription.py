...
class APIV2010AccountRecordingRecordingTranscription:
    ...
    status: Optional[shared_recording_transcription_enum_status_enum.RecordingTranscriptionEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
