...
class GetDirectDebitsForMandateUUIDRequest:
    ...
    r"""The mandate UUID to retrieve"""  
    
class GetDirectDebitsForMandateUUIDDirectDebitsDirectDebitCurrencyCodeEnum(str, Enum):
...
class GetDirectDebitsForMandateUUIDDirectDebitsDirectDebitCurrency:
    ...
    code: Optional[GetDirectDebitsForMandateUUIDDirectDebitsDirectDebitCurrencyCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})
    r"""The three letter code for the currency - either `EUR` or `GBP`."""  
...
class GetDirectDebitsForMandateUUIDDirectDebitsDirectDebit:
    ...
    currency: Optional[GetDirectDebitsForMandateUUIDDirectDebitsDirectDebitCurrency] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('currency'), 'exclude': lambda f: f is None }})
    r"""The currency."""  
    ...
    scheme_reject_reason_code: Optional[GetDirectDebitsForMandateUUIDDirectDebitsDirectDebitSchemeRejectReasonCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('schemeRejectReasonCode'), 'exclude': lambda f: f is None }})
    r"""The reject code returned by the bank indicating an issue with the direct debit. Each ARRUD code represents a rejection reason."""  
    status: Optional[GetDirectDebitsForMandateUUIDDirectDebitsDirectDebitStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The statuses of the direct debit payments associated with the mandate.
    * 'RECIEVED' - Direct Debit has been recieved
    * 'REJECT_REQUESTED' - The direct debit has a rejected request associated with it
    * 'REJECT_READY_FOR_PROCESSING' 
    ...
    * 'REFUND_FILE_SENT'
    ...
    type: Optional[GetDirectDebitsForMandateUUIDDirectDebitsDirectDebitTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of the direct debit."""  
...
class GetDirectDebitsForMandateUUIDDirectDebits:
    r"""Retrieve all direct debit payments associated with a direct debit mandate."""
    
    directdebits: Optional[list[GetDirectDebitsForMandateUUIDDirectDebitsDirectDebit]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('directdebits'), 'exclude': lambda f: f is None }})  
