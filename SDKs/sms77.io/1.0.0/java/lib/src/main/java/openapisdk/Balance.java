...
public class Balance {
    ...
    public openapisdk.models.operations.BalanceResponse balance() throws Exception {
        ...
        openapisdk.models.operations.BalanceResponse res = new openapisdk.models.operations.BalanceResponse() {{
