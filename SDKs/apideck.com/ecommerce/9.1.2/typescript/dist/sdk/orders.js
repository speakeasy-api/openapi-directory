...
var Orders = /** @class */ (function () {
    ...
    Orders.prototype.ordersAll = function (req, security, config) {
        ...
        var url = baseURL.replace(/\/$/, "") + "/ecommerce/orders";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getEcommerceOrdersResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetEcommerceOrdersResponse);
                    }
                    break;
    ...
    Orders.prototype.ordersOne = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ecommerce/orders/{id}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getEcommerceOrderResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetEcommerceOrderResponse);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    if (utils.matchContentType(contentType, "application/json")) {
