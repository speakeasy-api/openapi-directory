 ...
 */
export enum AddressListWarningCodeEnum {
...
export class AddressListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class AddressListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: AddressListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class AddressList extends SpeakeasyBase {
  /**
