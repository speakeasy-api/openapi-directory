...
class PutConfigurationSetSendingOptionsRequest:
    headers: PutConfigurationSetSendingOptionsHeaders = dataclasses.field()
    path_params: PutConfigurationSetSendingOptionsPathParams = dataclasses.field()
    request: PutConfigurationSetSendingOptionsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
