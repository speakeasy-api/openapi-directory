...
class GetUsers200ApplicationJSON:
    r"""A JSON object containing a list of users"""
    ...
    results: Optional[list[shared_user.UserOutput]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
