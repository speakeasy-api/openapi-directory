 ...
 *
 * @see {@link https://docs.aws.amazon.com/firehose/} - Amazon Web Services documentation
 */
export class SDK {
  ...
  createDeliveryStream(
  ...
  ): Promise<operations.CreateDeliveryStreamResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.CreateDeliveryStreamRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CreateDeliveryStreamResponse =
        new operations.CreateDeliveryStreamResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.createDeliveryStreamOutput = utils.objectToClass(
              httpRes?.data,
              shared.CreateDeliveryStreamOutput
            );
          }
          break;
        ...
        case httpRes?.status == 483:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.invalidKMSResourceException = httpRes?.data;
          }
          break;
      }
  ...
  deleteDeliveryStream(
    req: operations.DeleteDeliveryStreamRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.DeleteDeliveryStreamResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.DeleteDeliveryStreamRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DeleteDeliveryStreamResponse =
        new operations.DeleteDeliveryStreamResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.deleteDeliveryStreamOutput = utils.objectToClass(httpRes?.data);
          }
          break;
        case httpRes?.status == 480:
          if (utils.matchContentType(contentType, `application/json`)) {
  ...
  describeDeliveryStream(
    req: operations.DescribeDeliveryStreamRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.DescribeDeliveryStreamResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.DescribeDeliveryStreamRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DescribeDeliveryStreamResponse =
        new operations.DescribeDeliveryStreamResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.describeDeliveryStreamOutput = utils.objectToClass(
              httpRes?.data,
              shared.DescribeDeliveryStreamOutput
            );
          }
          break;
        case httpRes?.status == 480:
   ...
   */
  listDeliveryStreams(
    req: operations.ListDeliveryStreamsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ListDeliveryStreamsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ListDeliveryStreamsRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListDeliveryStreamsResponse =
        new operations.ListDeliveryStreamsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listDeliveryStreamsOutput = utils.objectToClass(
              httpRes?.data,
              shared.ListDeliveryStreamsOutput
            );
          }
          break;
      }
  ...
  listTagsForDeliveryStream(
    req: operations.ListTagsForDeliveryStreamRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ListTagsForDeliveryStreamResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ListTagsForDeliveryStreamRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListTagsForDeliveryStreamResponse =
        new operations.ListTagsForDeliveryStreamResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listTagsForDeliveryStreamOutput = utils.objectToClass(
              httpRes?.data,
              shared.ListTagsForDeliveryStreamOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  putRecord(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=Firehose_20150804.PutRecord";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.putRecordOutput = utils.objectToClass(
              httpRes?.data,
              shared.PutRecordOutput
            );
          }
          break;
        case httpRes?.status == 480:
   ...
   */
  putRecordBatch(
    req: operations.PutRecordBatchRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PutRecordBatchResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PutRecordBatchRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PutRecordBatchResponse =
        new operations.PutRecordBatchResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.putRecordBatchOutput = utils.objectToClass(
              httpRes?.data,
              shared.PutRecordBatchOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  startDeliveryStreamEncryption(
    req: operations.StartDeliveryStreamEncryptionRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.StartDeliveryStreamEncryptionResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.StartDeliveryStreamEncryptionRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.StartDeliveryStreamEncryptionResponse =
        new operations.StartDeliveryStreamEncryptionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.startDeliveryStreamEncryptionOutput = utils.objectToClass(
              httpRes?.data
            );
          }
          break;
  ...
  stopDeliveryStreamEncryption(
    req: operations.StopDeliveryStreamEncryptionRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.StopDeliveryStreamEncryptionResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.StopDeliveryStreamEncryptionRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.StopDeliveryStreamEncryptionResponse =
        new operations.StopDeliveryStreamEncryptionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.stopDeliveryStreamEncryptionOutput = utils.objectToClass(
              httpRes?.data
            );
          }
          break;
   ...
   */
  tagDeliveryStream(
    req: operations.TagDeliveryStreamRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.TagDeliveryStreamResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.TagDeliveryStreamRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.TagDeliveryStreamResponse =
        new operations.TagDeliveryStreamResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.tagDeliveryStreamOutput = utils.objectToClass(httpRes?.data);
          }
          break;
        case httpRes?.status == 480:
          if (utils.matchContentType(contentType, `application/json`)) {
   ...
   */
  untagDeliveryStream(
    req: operations.UntagDeliveryStreamRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UntagDeliveryStreamResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UntagDeliveryStreamRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UntagDeliveryStreamResponse =
        new operations.UntagDeliveryStreamResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.untagDeliveryStreamOutput = utils.objectToClass(httpRes?.data);
          }
          break;
        case httpRes?.status == 480:
          if (utils.matchContentType(contentType, `application/json`)) {
  ...
  updateDestination(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.updateDestinationOutput = utils.objectToClass(httpRes?.data);
          }
          break;
        case httpRes?.status == 480:
          if (utils.matchContentType(contentType, `application/json`)) {
