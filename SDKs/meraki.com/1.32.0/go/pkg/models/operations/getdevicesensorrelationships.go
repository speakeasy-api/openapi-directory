...
func (e GetDeviceSensorRelationships200ApplicationJSONLivestreamRelatedDevicesProductTypeEnum) ToPointer() *GetDeviceSensorRelationships200ApplicationJSONLivestreamRelatedDevicesProductTypeEnum {
	return &e
}
...
func (e *GetDeviceSensorRelationships200ApplicationJSONLivestreamRelatedDevicesProductTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "camera":
		fallthrough
	case "sensor":
		*e = GetDeviceSensorRelationships200ApplicationJSONLivestreamRelatedDevicesProductTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDeviceSensorRelationships200ApplicationJSONLivestreamRelatedDevicesProductTypeEnum: %v", v)
	}
}
