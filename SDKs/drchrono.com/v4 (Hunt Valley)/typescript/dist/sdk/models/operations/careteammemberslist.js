...
exports.CareTeamMembersListResponse = exports.CareTeamMembersList200ApplicationJSON = exports.CareTeamMembersListRequest = exports.CareTeamMembersListSecurity = void 0;
...
var CareTeamMembersListRequest = /** @class */ (function (_super) {
    ...
    ], CareTeamMembersListRequest.prototype, "appointment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=cursor",
        }),
        __metadata("design:type", String)
    ], CareTeamMembersListRequest.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=doctor",
        }),
        __metadata("design:type", Number)
    ], CareTeamMembersListRequest.prototype, "doctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], CareTeamMembersListRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=patient",
        }),
        __metadata("design:type", Number)
    ], CareTeamMembersListRequest.prototype, "patient", void 0);
...
var CareTeamMembersList200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.CareTeamMember }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return shared.CareTeamMember; }),
...
var CareTeamMembersListResponse = /** @class */ (function (_super) {
    ...
    ], CareTeamMembersListResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
