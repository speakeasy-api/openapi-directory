...
public class HolidaysQueryParams {
    /**
    ...
    public HolidaysQueryParams withFederal(HolidaysFederalEnum federal) {
    ...
    public HolidaysQueryParams withOptional(HolidaysOptionalEnum optional) {
    ...
    public Long year;
    public HolidaysQueryParams withYear(Long year) {
        this.year = year;
        return this;
    }
