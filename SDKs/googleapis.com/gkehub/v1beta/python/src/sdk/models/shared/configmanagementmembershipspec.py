...
class ConfigManagementMembershipSpec:
    ...
    binauthz: Optional[shared_configmanagementbinauthzconfig.ConfigManagementBinauthzConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('binauthz'), 'exclude': lambda f: f is None }})
