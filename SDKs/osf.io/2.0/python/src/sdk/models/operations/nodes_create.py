...
class NodesCreateNodeAttributesInput:
    ...
    category: NodesCreateNodeAttributesCategoryEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category') }})
    r"""The category of the node, as selected by project contributors."""  
...
class NodesCreateNodeInput:
    ...
    attributes: NodesCreateNodeAttributesInput = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attributes') }})
    r"""The properties of the node entity."""  
