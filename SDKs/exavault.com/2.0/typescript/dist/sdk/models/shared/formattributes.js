...
var FormAttributes = /** @class */ (function (_super) {
    ...
    ], FormAttributes.prototype, "cssStyles", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=elements", elemType: formfield_1.FormField }),
        __metadata("design:type", Array)
    ], FormAttributes.prototype, "elements", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=formDescription" }),
        __metadata("design:type", String)
    ], FormAttributes.prototype, "formDescription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=submitButtonText" }),
        __metadata("design:type", String)
    ], FormAttributes.prototype, "submitButtonText", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=successMessage" }),
        __metadata("design:type", String)
    ], FormAttributes.prototype, "successMessage", void 0);
