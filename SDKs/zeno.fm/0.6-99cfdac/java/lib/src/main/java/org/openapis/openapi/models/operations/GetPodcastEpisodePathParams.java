...
public class GetPodcastEpisodePathParams {
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=episodeKey")
    public String episodeKey;
    public GetPodcastEpisodePathParams withEpisodeKey(String episodeKey) {
    ...
    public GetPodcastEpisodePathParams withPodcastKey(String podcastKey) {
