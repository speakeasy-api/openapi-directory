...
class GetCommitteeCommitteeIDFilingsQueryParams:
    ...
    amendment_indicator: Optional[list[GetCommitteeCommitteeIDFilingsAmendmentIndicatorEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'amendment_indicator', 'style': 'form', 'explode': True }})
    ...
    filer_type: Optional[GetCommitteeCommitteeIDFilingsFilerTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filer_type', 'style': 'form', 'explode': True }})
    ...
    office: Optional[list[GetCommitteeCommitteeIDFilingsOfficeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'office', 'style': 'form', 'explode': True }})
...
class GetCommitteeCommitteeIDFilingsRequest:
    path_params: GetCommitteeCommitteeIDFilingsPathParams = dataclasses.field()
    query_params: GetCommitteeCommitteeIDFilingsQueryParams = dataclasses.field()
