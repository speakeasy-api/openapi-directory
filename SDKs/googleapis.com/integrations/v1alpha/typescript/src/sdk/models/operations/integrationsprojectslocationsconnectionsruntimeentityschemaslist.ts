...
export class IntegrationsProjectsLocationsConnectionsRuntimeEntitySchemasListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsConnectionsRuntimeEntitySchemasListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsConnectionsRuntimeEntitySchemasListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
