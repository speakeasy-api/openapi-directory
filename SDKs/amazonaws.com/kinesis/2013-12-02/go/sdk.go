...
func (s *SDK) AddTagsToStream(ctx context.Context, request operations.AddTagsToStreamRequest) (*operations.AddTagsToStreamResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "AddTagsToStreamInput", "json")
	if err != nil {
...
func (s *SDK) CreateStream(ctx context.Context, request operations.CreateStreamRequest) (*operations.CreateStreamResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "CreateStreamInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) DecreaseStreamRetentionPeriod(ctx context.Context, request operations.DecreaseStreamRetentionPeriodRequest) (*operations.DecreaseStreamRetentionPeriodResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DecreaseStreamRetentionPeriodInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
// DeleteStream - <p>Deletes a Kinesis data stream and all its shards and data. You must shut down any applications that are operating on the stream before you delete the stream. If an application attempts to operate on a deleted stream, it receives the exception <code>ResourceNotFoundException</code>.</p> <note> <p>When invoking this API, it is recommended you use the <code>StreamARN</code> input parameter rather than the <code>StreamName</code> input parameter.</p> </note> <p>If the stream is in the <code>ACTIVE</code> state, you can delete it. After a <code>DeleteStream</code> request, the specified stream is in the <code>DELETING</code> state until Kinesis Data Streams completes the deletion.</p> <p> <b>Note:</b> Kinesis Data Streams might continue to accept data read and write operations, such as <a>PutRecord</a>, <a>PutRecords</a>, and <a>GetRecords</a>, on a stream in the <code>DELETING</code> state until the stream deletion is complete.</p> <p>When you delete a stream, any shards in that stream are also deleted, and any tags are dissociated from the stream.</p> <p>You can use the <a>DescribeStreamSummary</a> operation to check the state of the stream, which is returned in <code>StreamStatus</code>.</p> <p> <a>DeleteStream</a> has a limit of five transactions per second per account.</p>
func (s *SDK) DeleteStream(ctx context.Context, request operations.DeleteStreamRequest) (*operations.DeleteStreamResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DeleteStreamInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) DeregisterStreamConsumer(ctx context.Context, request operations.DeregisterStreamConsumerRequest) (*operations.DeregisterStreamConsumerResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DeregisterStreamConsumerInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) DescribeStream(ctx context.Context, request operations.DescribeStreamRequest) (*operations.DescribeStreamResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DescribeStreamInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) DescribeStreamConsumer(ctx context.Context, request operations.DescribeStreamConsumerRequest) (*operations.DescribeStreamConsumerResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DescribeStreamConsumerInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
// DescribeStreamSummary - <p>Provides a summarized description of the specified Kinesis data stream without the shard list.</p> <note> <p>When invoking this API, it is recommended you use the <code>StreamARN</code> input parameter rather than the <code>StreamName</code> input parameter.</p> </note> <p>The information returned includes the stream name, Amazon Resource Name (ARN), status, record retention period, approximate creation time, monitoring, encryption details, and open shard count. </p> <p> <a>DescribeStreamSummary</a> has a limit of 20 transactions per second per account.</p>
func (s *SDK) DescribeStreamSummary(ctx context.Context, request operations.DescribeStreamSummaryRequest) (*operations.DescribeStreamSummaryResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DescribeStreamSummaryInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
// DisableEnhancedMonitoring - <p>Disables enhanced monitoring.</p> <note> <p>When invoking this API, it is recommended you use the <code>StreamARN</code> input parameter rather than the <code>StreamName</code> input parameter.</p> </note>
func (s *SDK) DisableEnhancedMonitoring(ctx context.Context, request operations.DisableEnhancedMonitoringRequest) (*operations.DisableEnhancedMonitoringResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DisableEnhancedMonitoringInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
// EnableEnhancedMonitoring - <p>Enables enhanced Kinesis data stream monitoring for shard-level metrics.</p> <note> <p>When invoking this API, it is recommended you use the <code>StreamARN</code> input parameter rather than the <code>StreamName</code> input parameter.</p> </note>
func (s *SDK) EnableEnhancedMonitoring(ctx context.Context, request operations.EnableEnhancedMonitoringRequest) (*operations.EnableEnhancedMonitoringResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "EnableEnhancedMonitoringInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) GetRecords(ctx context.Context, request operations.GetRecordsRequest) (*operations.GetRecordsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetRecordsInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) GetShardIterator(ctx context.Context, request operations.GetShardIteratorRequest) (*operations.GetShardIteratorResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetShardIteratorInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) IncreaseStreamRetentionPeriod(ctx context.Context, request operations.IncreaseStreamRetentionPeriodRequest) (*operations.IncreaseStreamRetentionPeriodResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "IncreaseStreamRetentionPeriodInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) ListShards(ctx context.Context, request operations.ListShardsRequest) (*operations.ListShardsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListShardsInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) ListStreamConsumers(ctx context.Context, request operations.ListStreamConsumersRequest) (*operations.ListStreamConsumersResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListStreamConsumersInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) ListStreams(ctx context.Context, request operations.ListStreamsRequest) (*operations.ListStreamsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListStreamsInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) ListTagsForStream(ctx context.Context, request operations.ListTagsForStreamRequest) (*operations.ListTagsForStreamResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListTagsForStreamInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) MergeShards(ctx context.Context, request operations.MergeShardsRequest) (*operations.MergeShardsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "MergeShardsInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) PutRecords(ctx context.Context, request operations.PutRecordsRequest) (*operations.PutRecordsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "PutRecordsInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) RegisterStreamConsumer(ctx context.Context, request operations.RegisterStreamConsumerRequest) (*operations.RegisterStreamConsumerResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "RegisterStreamConsumerInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
// RemoveTagsFromStream - <p>Removes tags from the specified Kinesis data stream. Removed tags are deleted and cannot be recovered after this operation successfully completes.</p> <note> <p>When invoking this API, it is recommended you use the <code>StreamARN</code> input parameter rather than the <code>StreamName</code> input parameter.</p> </note> <p>If you specify a tag that does not exist, it is ignored.</p> <p> <a>RemoveTagsFromStream</a> has a limit of five transactions per second per account.</p>
func (s *SDK) RemoveTagsFromStream(ctx context.Context, request operations.RemoveTagsFromStreamRequest) (*operations.RemoveTagsFromStreamResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "RemoveTagsFromStreamInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) SplitShard(ctx context.Context, request operations.SplitShardRequest) (*operations.SplitShardResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "SplitShardInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) StartStreamEncryption(ctx context.Context, request operations.StartStreamEncryptionRequest) (*operations.StartStreamEncryptionResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "StartStreamEncryptionInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) StopStreamEncryption(ctx context.Context, request operations.StopStreamEncryptionRequest) (*operations.StopStreamEncryptionResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "StopStreamEncryptionInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) UpdateShardCount(ctx context.Context, request operations.UpdateShardCountRequest) (*operations.UpdateShardCountResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "UpdateShardCountInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) UpdateStreamMode(ctx context.Context, request operations.UpdateStreamModeRequest) (*operations.UpdateStreamModeResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=Kinesis_20131202.UpdateStreamMode"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "UpdateStreamModeInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.UpdateStreamModeResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
