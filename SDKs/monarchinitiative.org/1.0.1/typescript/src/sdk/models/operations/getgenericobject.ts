...
export class GetGenericObjectPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGenericObjectQueryParams extends SpeakeasyBase {
...
export class GetGenericObjectRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGenericObjectResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
