...
class ListDatasetImportJobsRequest:
    ...
    list_dataset_import_jobs_request: shared_listdatasetimportjobsrequest.ListDatasetImportJobsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
