...
type CloudassetSavedQueriesDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudassetSavedQueriesDeletePathParams struct {
...
type CloudassetSavedQueriesDeleteQueryParams struct {
	// V1 error format.
...
type CloudassetSavedQueriesDeleteRequest struct {
...
type CloudassetSavedQueriesDeleteResponse struct {
	ContentType string
	// Successful response
