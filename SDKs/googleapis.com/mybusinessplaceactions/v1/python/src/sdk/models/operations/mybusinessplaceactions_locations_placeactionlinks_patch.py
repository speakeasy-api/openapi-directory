...
@dataclasses.dataclass
class MybusinessplaceactionsLocationsPlaceActionLinksPatchQueryParams:
...
class MybusinessplaceactionsLocationsPlaceActionLinksPatchRequest:
    path_params: MybusinessplaceactionsLocationsPlaceActionLinksPatchPathParams = dataclasses.field()
    query_params: MybusinessplaceactionsLocationsPlaceActionLinksPatchQueryParams = dataclasses.field()
