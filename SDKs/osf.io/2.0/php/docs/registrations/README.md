...
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsChildrenListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsChildrenListRequest();
    $request->registrationId = 'cumque';

    $response = $sdk->registrations->registrationsChildrenList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsCitationReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsCitationReadRequest();
    $request->citationId = 'corporis';
    $request->registrationId = 'hic';

    $response = $sdk->registrations->registrationsCitationRead($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsCitationsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsCitationsListRequest();
    $request->registrationId = 'libero';

    $response = $sdk->registrations->registrationsCitationsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsCommentsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsCommentsListRequest();
    $request->registrationId = 'nobis';

    $response = $sdk->registrations->registrationsCommentsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsContributorsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsContributorsListRequest();
    $request->registrationId = 'dolores';

    $response = $sdk->registrations->registrationsContributorsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsContributorsReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsContributorsReadRequest();
    $request->registrationId = 'quis';
    $request->userId = 'totam';

    $response = $sdk->registrations->registrationsContributorsRead($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsFilesListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsFilesListRequest();
    $request->provider = 'dignissimos';
    $request->registrationId = 'eaque';

    $response = $sdk->registrations->registrationsFilesList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsFilesReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsFilesReadRequest();
    $request->path = 'quis';
    $request->provider = 'nesciunt';
    $request->registrationId = 'eos';

    $response = $sdk->registrations->registrationsFilesRead($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsForksCreateRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsForksCreateRequest();
    $request->registrationId = 'perferendis';

    $response = $sdk->registrations->registrationsForksCreate($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsForksListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsForksListRequest();
    $request->registrationId = 'dolores';

    $response = $sdk->registrations->registrationsForksList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsIdentifiersListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsIdentifiersListRequest();
    $request->registrationId = 'minus';

    $response = $sdk->registrations->registrationsIdentifiersList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsInstitutionsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsInstitutionsListRequest();
    $request->registrationId = 'quam';

    $response = $sdk->registrations->registrationsInstitutionsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsLinkedNodesListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsLinkedNodesListRequest();
    $request->registrationId = 'dolor';

    $response = $sdk->registrations->registrationsLinkedNodesList($request);
...
try {
    $response = $sdk->registrations->registrationsList();
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsLogsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsLogsListRequest();
    $request->registrationId = 'vero';

    $response = $sdk->registrations->registrationsLogsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsPartialUpdateRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsPartialUpdateRequest();
    $request->registrationId = 'nostrum';

    $response = $sdk->registrations->registrationsPartialUpdate($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsProvidersListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsProvidersListRequest();
    $request->registrationId = 'hic';

    $response = $sdk->registrations->registrationsProvidersList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsReadRequest();
    $request->registrationId = 'recusandae';

    $response = $sdk->registrations->registrationsRead($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsViewOnlyLinksListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsViewOnlyLinksListRequest();
    $request->registrationId = 'omnis';

    $response = $sdk->registrations->registrationsViewOnlyLinksList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsViewOnlyLinksReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsViewOnlyLinksReadRequest();
    $request->linkId = 'facilis';
    $request->registrationId = 'perspiciatis';

    $response = $sdk->registrations->registrationsViewOnlyLinksRead($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RegistrationsWikisListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RegistrationsWikisListRequest();
    $request->registrationId = 'voluptatem';

    $response = $sdk->registrations->registrationsWikisList($request);
