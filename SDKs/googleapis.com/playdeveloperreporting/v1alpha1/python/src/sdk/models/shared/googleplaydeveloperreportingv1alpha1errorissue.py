...
class GooglePlayDeveloperReportingV1alpha1ErrorIssue:
    ...
    type: Optional[GooglePlayDeveloperReportingV1alpha1ErrorIssueTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
