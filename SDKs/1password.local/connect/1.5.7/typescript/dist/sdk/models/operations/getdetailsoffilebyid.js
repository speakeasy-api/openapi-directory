...
exports.GetDetailsOfFileByIdResponse = exports.GetDetailsOfFileByIdRequest = exports.GetDetailsOfFileByIdSecurity = void 0;
...
exports.GetDetailsOfFileByIdSecurity = GetDetailsOfFileByIdSecurity;
var GetDetailsOfFileByIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetDetailsOfFileByIdRequest.prototype, "fileUuid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=inline_files",
        }),
        __metadata("design:type", Boolean)
    ], GetDetailsOfFileByIdRequest.prototype, "inlineFiles", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=itemUuid",
        }),
        __metadata("design:type", String)
    ], GetDetailsOfFileByIdRequest.prototype, "itemUuid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=vaultUuid",
        }),
        __metadata("design:type", String)
    ], GetDetailsOfFileByIdRequest.prototype, "vaultUuid", void 0);
    return GetDetailsOfFileByIdRequest;
}(utils_1.SpeakeasyBase));
exports.GetDetailsOfFileByIdRequest = GetDetailsOfFileByIdRequest;
var GetDetailsOfFileByIdResponse = /** @class */ (function (_super) {
    ...
    ], GetDetailsOfFileByIdResponse.prototype, "rawResponse", void 0);
    return GetDetailsOfFileByIdResponse;
}(utils_1.SpeakeasyBase));
exports.GetDetailsOfFileByIdResponse = GetDetailsOfFileByIdResponse;
