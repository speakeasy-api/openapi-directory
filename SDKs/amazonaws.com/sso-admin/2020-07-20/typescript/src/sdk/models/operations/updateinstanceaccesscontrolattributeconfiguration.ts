...
export enum UpdateInstanceAccessControlAttributeConfigurationXAmzTargetEnum {
...
export class UpdateInstanceAccessControlAttributeConfigurationResponse extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata()
  updateInstanceAccessControlAttributeConfigurationResponse?: Record<
    string,
    any
  >;
