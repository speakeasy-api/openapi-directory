...
public class EmployeePayrolls {
    ...
    **/
    public openapisdk.models.operations.EmployeePayrollsAllResponse employeePayrollsAll(openapisdk.models.operations.EmployeePayrollsAllRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/hris/payrolls/employees/{employee_id}", request.pathParams);
        ...
        openapisdk.models.operations.EmployeePayrollsAllResponse res = new openapisdk.models.operations.EmployeePayrollsAllResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GetEmployeePayrollsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetEmployeePayrollsResponse.class);
    ...
    **/
    public openapisdk.models.operations.EmployeePayrollsOneResponse employeePayrollsOne(openapisdk.models.operations.EmployeePayrollsOneRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/hris/payrolls/employees/{employee_id}/payrolls/{payroll_id}", request.pathParams);
        ...
        openapisdk.models.operations.EmployeePayrollsOneResponse res = new openapisdk.models.operations.EmployeePayrollsOneResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GetEmployeePayrollResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetEmployeePayrollResponse.class);
