...
func (s *schedule) CreateSchedule(ctx context.Context, request shared.CreateUserScheduleRequest, security operations.CreateScheduleSecurity) (*operations.CreateScheduleResponse, error) {
	baseURL := s.serverURL
...
func (s *schedule) DeleteSchedule(ctx context.Context, request operations.DeleteScheduleRequest, security operations.DeleteScheduleSecurity) (*operations.DeleteScheduleResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/schedule/{schedule_id}", request, nil)
	if err != nil {
...
func (s *schedule) GetLatestResultFile(ctx context.Context, request operations.GetLatestResultFileRequest, security operations.GetLatestResultFileSecurity) (*operations.GetLatestResultFileResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/schedule/{schedule_id}/download_result_file", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *schedule) GetSchedule(ctx context.Context, request operations.GetScheduleRequest, security operations.GetScheduleSecurity) (*operations.GetScheduleResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/schedule/{schedule_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *schedule) GetScheduleTemplate(ctx context.Context, request operations.GetScheduleTemplateRequest, security operations.GetScheduleTemplateSecurity) (*operations.GetScheduleTemplateResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/schedule_template/{schedule_template_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *schedule) GetScheduleTemplates(ctx context.Context, request operations.GetScheduleTemplatesRequest, security operations.GetScheduleTemplatesSecurity) (*operations.GetScheduleTemplatesResponse, error) {
	baseURL := s.serverURL
...
func (s *schedule) GetSchedules(ctx context.Context, request operations.GetSchedulesRequest, security operations.GetSchedulesSecurity) (*operations.GetSchedulesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/schedule"
...
func (s *schedule) UpdateSchedule(ctx context.Context, request operations.UpdateScheduleRequest, security operations.UpdateScheduleSecurity) (*operations.UpdateScheduleResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/schedule/{schedule_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "UpdateUserScheduleRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
