...
var CreateRuleRequest = /** @class */ (function (_super) {
    ...
    ], CreateRuleRequest.prototype, "endUtcDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=optimisationActionName" }),
        __metadata("design:type", String)
    ], CreateRuleRequest.prototype, "optimisationActionName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reportFilterId" }),
        __metadata("design:type", String)
    ], CreateRuleRequest.prototype, "reportFilterId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ruleName" }),
        __metadata("design:type", String)
    ], CreateRuleRequest.prototype, "ruleName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startUtcDate" }),
        __metadata("design:type", Date)
    ], CreateRuleRequest.prototype, "startUtcDate", void 0);
