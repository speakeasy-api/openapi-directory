...
class ConversionsBatchInsertResponse:
    ...
    r"""Indicates that some or all conversions failed to insert."""  
    kind: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('kind'), 'exclude': lambda f: f is None }})
    r"""Identifies what kind of resource this is. Value: the fixed string \\"dfareporting#conversionsBatchInsertResponse\\"."""  
    ...
    r"""The insert status of each conversion. Statuses are returned in the same order that conversions are inserted."""  
