...
class DocumentaiProjectsLocationsProcessorsProcessorVersionsUndeploySecurity:
...
@dataclasses.dataclass
class DocumentaiProjectsLocationsProcessorsProcessorVersionsUndeployRequest:
    
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'name', 'style': 'simple', 'explode': False }})
    r"""Required. The processor version resource name to be undeployed."""  
...
@dataclasses.dataclass
class DocumentaiProjectsLocationsProcessorsProcessorVersionsUndeployResponse:
