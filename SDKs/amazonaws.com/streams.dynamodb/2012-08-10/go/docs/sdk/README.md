...
func main() {
    ...
    res, err := s.SDK.DescribeStream(ctx, operations.DescribeStreamRequest{
        DescribeStreamInput: shared.DescribeStreamInput{
            ExclusiveStartShardID: sdk.String("deserunt"),
...
func main() {
    ...
    res, err := s.SDK.GetRecords(ctx, operations.GetRecordsRequest{
        ...
        XAmzTarget: operations.GetRecordsXAmzTargetEnumDynamoDbStreams20120810GetRecords,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.GetShardIterator(ctx, operations.GetShardIteratorRequest{
        GetShardIteratorInput: shared.GetShardIteratorInput{
            SequenceNumber: sdk.String("quis"),
            ShardID: "veritatis",
            ShardIteratorType: shared.ShardIteratorTypeEnumAtSequenceNumber,
        ...
        XAmzTarget: operations.GetShardIteratorXAmzTargetEnumDynamoDbStreams20120810GetShardIterator,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.ListStreams(ctx, operations.ListStreamsRequest{
        ListStreamsInput: shared.ListStreamsInput{
            ExclusiveStartStreamArn: sdk.String("maiores"),
            Limit: sdk.Int64(473608),
            TableName: sdk.String("quod"),
        },
        ...
        XAmzTarget: operations.ListStreamsXAmzTargetEnumDynamoDbStreams20120810ListStreams,
    })
    if err != nil {
        log.Fatal(err)
    }
