...
type GetNetworkWirelessUsageHistoryPathParams struct {
...
func (e *GetNetworkWirelessUsageHistoryBandEnum) UnmarshalJSON(data []byte) error {
	...
	case "5":
		fallthrough
	case "6":
		*e = GetNetworkWirelessUsageHistoryBandEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessUsageHistoryBandEnum: %s", s)
	}
}
