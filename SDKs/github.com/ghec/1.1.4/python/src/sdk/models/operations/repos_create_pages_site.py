...
class ReposCreatePagesSiteRequestBody2BuildTypeEnum(str, Enum):
    r"""The process in which the Page will be built. Possible values are `\\"legacy\\"` and `\\"workflow\\"`."""
    LEGACY = 'legacy'
    WORKFLOW = 'workflow'

class ReposCreatePagesSiteRequestBody2SourcePathEnum(str, Enum):
...
class ReposCreatePagesSiteRequestBody2Source:
    ...
    path: Optional[ReposCreatePagesSiteRequestBody2SourcePathEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('path'), 'exclude': lambda f: f is None }})
    r"""The repository directory that includes the source files for the Pages site. Allowed paths are `/` or `/docs`. Default: `/`"""  
...
class ReposCreatePagesSiteRequestBody2:
    ...
    build_type: ReposCreatePagesSiteRequestBody2BuildTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('build_type') }})
    r"""The process in which the Page will be built. Possible values are `\\"legacy\\"` and `\\"workflow\\"`."""  
    source: Optional[ReposCreatePagesSiteRequestBody2Source] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('source'), 'exclude': lambda f: f is None }})
    r"""The source branch and directory used to publish your Pages site."""  
    
class ReposCreatePagesSiteRequestBody1BuildTypeEnum(str, Enum):
    r"""The process in which the Page will be built. Possible values are `\\"legacy\\"` and `\\"workflow\\"`."""
    LEGACY = 'legacy'
    WORKFLOW = 'workflow'
...
class ReposCreatePagesSiteRequestBody1:
    ...
    r"""The source branch and directory used to publish your Pages site."""  
    build_type: Optional[ReposCreatePagesSiteRequestBody1BuildTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('build_type'), 'exclude': lambda f: f is None }})
    r"""The process in which the Page will be built. Possible values are `\\"legacy\\"` and `\\"workflow\\"`."""  
