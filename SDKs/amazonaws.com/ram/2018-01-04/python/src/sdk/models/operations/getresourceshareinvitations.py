...
class GetResourceShareInvitationsRequestBody:
    ...
    r"""Specifies that you want details about invitations only for the resource shares described by this list of <a href=\\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\\">Amazon Resource Names (ARNs)</a>"""  
    resource_share_invitation_arns: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resourceShareInvitationArns'), 'exclude': lambda f: f is None }})
    r"""Specifies the <a href=\\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\\">Amazon Resource Names (ARNs)</a> of the resource share invitations you want information about."""  
    

@dataclasses.dataclass
class GetResourceShareInvitationsRequest:
    
    request_body: GetResourceShareInvitationsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
