 ...
 */
export enum NetworkAttachmentsScopedListWarningCodeEnum {
...
export class NetworkAttachmentsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NetworkAttachmentsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: NetworkAttachmentsScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: NetworkAttachmentsScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => NetworkAttachmentsScopedListWarningData)
  data?: NetworkAttachmentsScopedListWarningData[];
...
export class NetworkAttachmentsScopedList extends SpeakeasyBase {
  /**
   * A list of NetworkAttachments contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: NetworkAttachment })
  @Expose({ name: "networkAttachments" })
