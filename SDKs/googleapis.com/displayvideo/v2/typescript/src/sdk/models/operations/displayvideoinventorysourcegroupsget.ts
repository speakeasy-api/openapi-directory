...
export class DisplayvideoInventorySourceGroupsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoInventorySourceGroupsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoInventorySourceGroupsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
