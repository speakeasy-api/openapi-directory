...
public class RegionBackendServices {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeRegionBackendServicesSetSecurityPolicyResponse computeRegionBackendServicesSetSecurityPolicy(org.openapis.openapi.models.operations.ComputeRegionBackendServicesSetSecurityPolicyRequest request, org.openapis.openapi.models.operations.ComputeRegionBackendServicesSetSecurityPolicySecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeRegionBackendServicesSetSecurityPolicyRequest.class, baseUrl, "/projects/{project}/regions/{region}/backendServices/{backendService}/setSecurityPolicy", request, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeRegionBackendServicesSetSecurityPolicyRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
