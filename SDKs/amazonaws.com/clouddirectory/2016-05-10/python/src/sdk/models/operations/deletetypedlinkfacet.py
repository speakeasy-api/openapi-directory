...
class DeleteTypedLinkFacetRequest:
    headers: DeleteTypedLinkFacetHeaders = dataclasses.field()
    request: DeleteTypedLinkFacetRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
