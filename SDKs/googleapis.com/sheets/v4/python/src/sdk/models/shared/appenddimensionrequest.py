...
class AppendDimensionRequest:
    ...
    dimension: Optional[AppendDimensionRequestDimensionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dimension') }})
