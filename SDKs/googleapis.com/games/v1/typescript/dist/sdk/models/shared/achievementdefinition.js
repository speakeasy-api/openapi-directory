...
var AchievementDefinition = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=formattedTotalSteps" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=isRevealedIconUrlDefault" }),
        __metadata("design:type", Boolean)
    ], AchievementDefinition.prototype, "isRevealedIconUrlDefault", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=isUnlockedIconUrlDefault" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=revealedIconUrl" }),
        __metadata("design:type", String)
    ], AchievementDefinition.prototype, "revealedIconUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=totalSteps" }),
        __metadata("design:type", Number)
    ], AchievementDefinition.prototype, "totalSteps", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=unlockedIconUrl" }),
        __metadata("design:type", String)
