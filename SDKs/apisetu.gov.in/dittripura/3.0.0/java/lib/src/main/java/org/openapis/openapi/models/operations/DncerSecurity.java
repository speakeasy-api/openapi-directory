...
public class DncerSecurity {
    ...
    public DncerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public DncerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public DncerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
