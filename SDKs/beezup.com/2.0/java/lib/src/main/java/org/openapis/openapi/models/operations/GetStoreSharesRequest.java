...
public class GetStoreSharesRequest {
    ...
    public GetStoreSharesRequest withIfNoneMatch(String ifNoneMatch) {
    ...
    public GetStoreSharesRequest withStoreId(String storeId) {
        this.storeId = storeId;
        return this;
    }
    
    public GetStoreSharesRequest(@JsonProperty("storeId") String storeId) {
        this.storeId = storeId;
  }
}
