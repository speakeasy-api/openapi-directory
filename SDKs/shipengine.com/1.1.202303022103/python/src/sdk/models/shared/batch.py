...
class BatchLabelFormatEnum(str, Enum):
...
class BatchLabelLayoutEnum(str, Enum):
...
class BatchBatchStatusEnum(str, Enum):
...
class Batch:
    ...
    batch_errors_url: BatchOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('batch_errors_url') }})
    ...
    form_download: BatchOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('form_download') }})
    ...
    label_download: BatchLabelDownload = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_download') }})
    r"""The label download for the batch"""  
    label_format: BatchLabelFormatEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_format') }})  
    label_layout: BatchLabelLayoutEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_layout') }})
    r"""label layout"""  
    ...
    status: BatchBatchStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
