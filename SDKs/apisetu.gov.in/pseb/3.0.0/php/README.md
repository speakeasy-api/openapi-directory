...
use \OpenAPI\OpenAPI\Models\Operations\CemstRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\CemstRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\CemstRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\CemstSecurity;
...
try {
    ...
    $request->certificateParameters = new CemstRequestBodyCertificateParameters();
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->uid = '123412341234';
    $request->certificateParameters->rollno = '102012xxxx';
    ...
    $request->format = CemstRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new CemstSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->cemst($request, $requestSecurity);
