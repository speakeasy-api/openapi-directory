...
export class CommunicationProfiles {
  ...
  objectGETCommunicationProfile(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ObjectGETCommunicationProfileResponse =
        new operations.ObjectGETCommunicationProfileResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.proxyGetCommunicationProfile = utils.objectToClass(
              httpRes?.data,
              shared.ProxyGetCommunicationProfile
            );
          }
          break;
