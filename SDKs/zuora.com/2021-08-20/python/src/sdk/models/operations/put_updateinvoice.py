...
from ..shared import putinvoiceresponsetype as shared_putinvoiceresponsetype
from ..shared import putinvoicetype as shared_putinvoicetype
...
class PUTUpdateInvoiceRequest:
    ...
    r"""The ID of the invoice. For example,
    2c92c8955bd63cc1015bd7c151af02ab.
    """  
    put_invoice_type: shared_putinvoicetype.PutInvoiceType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class PUTUpdateInvoiceResponse:
    ...
    put_invoice_response_type: Optional[shared_putinvoiceresponsetype.PutInvoiceResponseType] = dataclasses.field(default=None)  
