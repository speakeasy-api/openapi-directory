...
public class ListResolverQueryLogConfigAssociationsRequest {
    ...
    public ListResolverQueryLogConfigAssociationsRequest(@JsonProperty("ListResolverQueryLogConfigAssociationsRequest") org.openapis.openapi.models.shared.ListResolverQueryLogConfigAssociationsRequest listResolverQueryLogConfigAssociationsRequest, @JsonProperty("X-Amz-Target") ListResolverQueryLogConfigAssociationsXAmzTargetEnum xAmzTarget) {
        this.listResolverQueryLogConfigAssociationsRequest = listResolverQueryLogConfigAssociationsRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
