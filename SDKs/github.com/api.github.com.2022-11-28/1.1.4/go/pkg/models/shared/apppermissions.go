...
func (e AppPermissionsOrganizationAnnouncementBannersEnum) ToPointer() *AppPermissionsOrganizationAnnouncementBannersEnum {
	return &e
}
...
func (e *AppPermissionsOrganizationAnnouncementBannersEnum) UnmarshalJSON(data []byte) error {
	...
	case "read":
		fallthrough
	case "write":
		*e = AppPermissionsOrganizationAnnouncementBannersEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AppPermissionsOrganizationAnnouncementBannersEnum: %v", v)
	}
}
...
func (e AppPermissionsOrganizationCustomRolesEnum) ToPointer() *AppPermissionsOrganizationCustomRolesEnum {
	return &e
}
...
func (e *AppPermissionsOrganizationCustomRolesEnum) UnmarshalJSON(data []byte) error {
	...
	case "read":
		fallthrough
	case "write":
		*e = AppPermissionsOrganizationCustomRolesEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AppPermissionsOrganizationCustomRolesEnum: %v", v)
	}
}
...
func (e AppPermissionsRepositoryAnnouncementBannersEnum) ToPointer() *AppPermissionsRepositoryAnnouncementBannersEnum {
	return &e
}
...
func (e *AppPermissionsRepositoryAnnouncementBannersEnum) UnmarshalJSON(data []byte) error {
	...
	case "read":
		fallthrough
	case "write":
		*e = AppPermissionsRepositoryAnnouncementBannersEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AppPermissionsRepositoryAnnouncementBannersEnum: %v", v)
	}
}
