...
class ScriptProjectsDeploymentsListSecurity:
    ...
    option1: Optional[ScriptProjectsDeploymentsListSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[ScriptProjectsDeploymentsListSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class ScriptProjectsDeploymentsListRequest:
    ...
    r"""The maximum number of deployments on each returned page. Defaults to 50."""  
