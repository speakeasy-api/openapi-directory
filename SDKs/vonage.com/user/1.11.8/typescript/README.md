...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/vonage.com/user/1.11.8/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/vonage.com/user/1.11.8/typescript
```
