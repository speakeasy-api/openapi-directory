...
export class ContentOrdersCancelSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentOrdersCancelRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentOrdersCancelResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
