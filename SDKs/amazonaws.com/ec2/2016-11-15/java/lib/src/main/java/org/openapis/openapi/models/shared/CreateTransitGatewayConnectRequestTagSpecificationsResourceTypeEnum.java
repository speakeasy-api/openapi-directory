 ...
 */
public enum CreateTransitGatewayConnectRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateTransitGatewayConnectRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
