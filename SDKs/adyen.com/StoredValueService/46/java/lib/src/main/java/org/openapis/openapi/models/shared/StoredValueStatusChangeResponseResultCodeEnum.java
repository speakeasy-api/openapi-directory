...
/**
 * StoredValueStatusChangeResponseResultCodeEnum - The result of the payment. Possible values:
 * 
 ...
 * 
 */
public enum StoredValueStatusChangeResponseResultCodeEnum {
    SUCCESS("Success"),
    REFUSED("Refused"),
    ERROR("Error"),
    ...
    private StoredValueStatusChangeResponseResultCodeEnum(String value) {
        this.value = value;
    }
}
