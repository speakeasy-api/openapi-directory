...
public class PromotePermissionCreatedFromPolicyRequestBody {
    /**
    ...
    public PromotePermissionCreatedFromPolicyRequestBody withClientToken(String clientToken) {
    ...
    public PromotePermissionCreatedFromPolicyRequestBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public PromotePermissionCreatedFromPolicyRequestBody withPermissionArn(String permissionArn) {
        this.permissionArn = permissionArn;
        return this;
    }
    
    public PromotePermissionCreatedFromPolicyRequestBody(@JsonProperty("name") String name, @JsonProperty("permissionArn") String permissionArn) {
        this.name = name;
        this.permissionArn = permissionArn;
  }
}
