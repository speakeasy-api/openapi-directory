...
class ListResourcesRequestBody:
    resource_owner: ListResourcesRequestBodyResourceOwnerEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceOwner') }})
...
class ListResourcesRequest:
    ...
    request: ListResourcesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
