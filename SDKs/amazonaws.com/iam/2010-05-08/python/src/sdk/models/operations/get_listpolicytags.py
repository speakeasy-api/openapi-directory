...
class GetListPolicyTagsQueryParams:
    action: GetListPolicyTagsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    policy_arn: str = dataclasses.field(metadata={'query_param': { 'field_name': 'PolicyArn', 'style': 'form', 'explode': True }})
    version: GetListPolicyTagsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListPolicyTagsRequest:
    headers: GetListPolicyTagsHeaders = dataclasses.field()
    query_params: GetListPolicyTagsQueryParams = dataclasses.field()
