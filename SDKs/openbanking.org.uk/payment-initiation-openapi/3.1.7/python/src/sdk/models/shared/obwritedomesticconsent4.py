...
class ObWriteDomesticConsent4DataAuthorisation:
    ...
    authorisation_type: ObWriteDomesticConsent4DataAuthorisationAuthorisationTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('AuthorisationType') }})
...
class ObWriteDomesticConsent4DataInitiation:
    ...
    creditor_account: ObWriteDomesticConsent4DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('CreditorAccount') }})
    ...
    instructed_amount: ObWriteDomesticConsent4DataInitiationInstructedAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('InstructedAmount') }})
    ...
    debtor_account: Optional[ObWriteDomesticConsent4DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DebtorAccount') }})
    ...
    remittance_information: Optional[ObWriteDomesticConsent4DataInitiationRemittanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RemittanceInformation') }})
...
class ObWriteDomesticConsent4Data:
    initiation: ObWriteDomesticConsent4DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Initiation') }})
    authorisation: Optional[ObWriteDomesticConsent4DataAuthorisation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Authorisation') }})
    read_refund_account: Optional[ObWriteDomesticConsent4DataReadRefundAccountEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ReadRefundAccount') }})
...
class ObWriteDomesticConsent4:
    data: ObWriteDomesticConsent4Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Data') }})
