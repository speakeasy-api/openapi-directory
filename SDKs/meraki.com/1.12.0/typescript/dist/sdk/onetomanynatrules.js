...
exports.OneToManyNatRules = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var OneToManyNatRules = /** @class */ (function () {
    function OneToManyNatRules(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    OneToManyNatRules.prototype.getNetworkApplianceFirewallOneToManyNatRules = function (req, config) {
    ...
    **/
    OneToManyNatRules.prototype.updateNetworkApplianceFirewallOneToManyNatRules = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.OneToManyNatRules = OneToManyNatRules;
