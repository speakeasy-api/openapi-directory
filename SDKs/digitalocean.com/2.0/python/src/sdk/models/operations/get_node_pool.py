...
class GetNodePoolRequest:
    path_params: GetNodePoolPathParams = dataclasses.field()
...
class GetNodePoolResponse:
    ...
    get_node_pool_200_application_json_any: Optional[Any] = dataclasses.field(default=None)
    get_node_pool_401_application_json_object: Optional[GetNodePool401ApplicationJSON] = dataclasses.field(default=None)
