...
class YoutubeLiveBroadcastsInsertCuepointRequest:
    ...
    r"""JSONP"""  
    cuepoint: Optional[shared_cuepoint.Cuepoint] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    fields_: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': True }})
    r"""Selector specifying which fields to include in a partial response."""  
    id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'id', 'style': 'form', 'explode': True }})
    r"""Broadcast to insert ads to, or equivalently `external_video_id` for internal use."""  
