...
from ..shared import itvassignbttokenrequest as shared_itvassignbttokenrequest
...
class AssignTokenRequest:
    ...
    itv_assign_bt_token_request: shared_itvassignbttokenrequest.ItvAssignBtTokenRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
