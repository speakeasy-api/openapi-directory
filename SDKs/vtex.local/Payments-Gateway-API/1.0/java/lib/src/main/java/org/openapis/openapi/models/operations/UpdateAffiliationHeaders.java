...
public class UpdateAffiliationHeaders {
    /**
    ...
    public UpdateAffiliationHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public UpdateAffiliationHeaders withContentType(String contentType) {
    ...
    public UpdateAffiliationHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public UpdateAffiliationHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
