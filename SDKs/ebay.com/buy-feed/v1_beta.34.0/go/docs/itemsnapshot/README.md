...
func main() {
    ...
    res, err := s.ItemSnapshot.GetItemSnapshotFeed(ctx, operations.GetItemSnapshotFeedRequest{
        Accept: "iusto",
        Range: "excepturi",
        XEbayCMarketplaceID: "nisi",
        CategoryID: "recusandae",
        SnapshotDate: "temporibus",
    }, operations.GetItemSnapshotFeedSecurity{
    ...
    if res.ItemSnapshotResponse != nil {
        // handle response
    }
}
```
