...
class BatchDeletePartitionRequest:
    ...
    partitions_to_delete: list[shared_partitionvaluelist.PartitionValueList] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PartitionsToDelete') }})  
