...
class GETRefundItemPartCollectionType:
    ...
    item_parts: Optional[list[shared_getrefunditemparttypewithsuccess.GETRefundItemPartTypewithSuccess]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('itemParts'), 'exclude': lambda f: f is None }})
    r"""Container for refund part items."""  
