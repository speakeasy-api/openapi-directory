...
type DialogflowProjectsLocationsConversationsMessagesBatchCreateRequest struct {
	...
	GoogleCloudDialogflowV2beta1BatchCreateMessagesRequestInput *shared.GoogleCloudDialogflowV2beta1BatchCreateMessagesRequestInput `request:"mediaType=application/json"`
	// OAuth access token.
