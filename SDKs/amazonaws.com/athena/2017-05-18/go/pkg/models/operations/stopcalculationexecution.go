...
type StopCalculationExecutionHeaders struct {
...
type StopCalculationExecutionRequest struct {
	Headers StopCalculationExecutionHeaders
	Request shared.StopCalculationExecutionRequest `request:"mediaType=application/json"`
}
