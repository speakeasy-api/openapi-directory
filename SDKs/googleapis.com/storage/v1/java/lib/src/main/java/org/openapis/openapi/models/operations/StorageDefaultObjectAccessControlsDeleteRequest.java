...
public class StorageDefaultObjectAccessControlsDeleteRequest {
    ...
    public StorageDefaultObjectAccessControlsDeleteRequest withUploadType(String uploadType) {
    ...
    public StorageDefaultObjectAccessControlsDeleteRequest withUserProject(String userProject) {
