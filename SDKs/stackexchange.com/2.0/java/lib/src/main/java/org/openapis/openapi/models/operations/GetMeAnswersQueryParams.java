...
public class GetMeAnswersQueryParams {
    /**
    ...
    public GetMeAnswersQueryParams withCallback(String callback) {
    ...
    public GetMeAnswersQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeAnswersQueryParams withFromdate(Long fromdate) {
    ...
    public String max;
    public GetMeAnswersQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetMeAnswersQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetMeAnswersOrderEnum order;
    public GetMeAnswersQueryParams withOrder(GetMeAnswersOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetMeAnswersQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeAnswersQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetMeAnswersQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetMeAnswersSortEnum sort;
    public GetMeAnswersQueryParams withSort(GetMeAnswersSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetMeAnswersQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
