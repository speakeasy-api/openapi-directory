...
class GoogleCloudBillingBudgetsV1beta1ThresholdRule:
    ...
    spend_basis: Optional[GoogleCloudBillingBudgetsV1beta1ThresholdRuleSpendBasisEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('spendBasis') }})
