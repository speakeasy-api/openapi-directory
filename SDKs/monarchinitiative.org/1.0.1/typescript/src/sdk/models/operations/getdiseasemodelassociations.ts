...
export class GetDiseaseModelAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetDiseaseModelAssociationsQueryParams extends SpeakeasyBase {
...
export class GetDiseaseModelAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetDiseaseModelAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
