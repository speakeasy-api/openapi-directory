...
type SearchTypeEsriMapserverQueryParams struct {
...
type SearchTypeEsriMapserverRequest struct {
	QueryParams SearchTypeEsriMapserverQueryParams
}

type SearchTypeEsriMapserverResponse struct {
	ContentType string
	StatusCode  int
