...
class GetTaskCountsForProject200ApplicationJSON:
    r"""Successfully retrieved the requested project's task counts."""
    
    data: Optional[shared_taskcountresponse.TaskCountResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
