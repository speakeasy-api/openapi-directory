 ...
 */
export declare class DescribeEgressOnlyInternetGatewaysRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeEgressOnlyInternetGatewaysRequest extends SpeakeasyBase {
    dryRun?: boolean;
    egressOnlyInternetGatewayIds?: string[];
    filters?: DescribeEgressOnlyInternetGatewaysRequestFilters[];
    maxResults?: number;
    nextToken?: string;
}
