...
import { ExchangedPeeringRoute } from "./exchangedpeeringroute";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum ExchangedPeeringRoutesListWarningCodeEnum {
...
export declare class ExchangedPeeringRoutesListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ExchangedPeeringRoutesListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: ExchangedPeeringRoutesListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: ExchangedPeeringRoutesListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class ExchangedPeeringRoutesList extends SpeakeasyBase {
    /**
