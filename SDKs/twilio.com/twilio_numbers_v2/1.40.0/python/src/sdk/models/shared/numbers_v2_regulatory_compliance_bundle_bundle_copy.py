...
class NumbersV2RegulatoryComplianceBundleBundleCopy:
    ...
    status: Optional[shared_bundle_copy_enum_status_enum.BundleCopyEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
