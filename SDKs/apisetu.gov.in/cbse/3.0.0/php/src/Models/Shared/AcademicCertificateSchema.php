...
class AcademicCertificateSchema
{
	...
	{
		$this->certificateData = new \OpenAPI\OpenAPI\Models\Shared\AcademicCertificateSchemaCertificateData();
		$this->issuedBy = new \OpenAPI\OpenAPI\Models\Shared\AcademicCertificateSchemaIssuedBy();
		$this->issuedTo = new \OpenAPI\OpenAPI\Models\Shared\AcademicCertificateSchemaIssuedTo();
		$this->issueDate = "";
		$this->issuedAt = "";
		$this->language = "";
		$this->name = "";
