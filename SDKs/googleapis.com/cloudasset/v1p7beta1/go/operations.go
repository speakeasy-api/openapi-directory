...
func (s *Operations) CloudassetOperationsGet(ctx context.Context, request operations.CloudassetOperationsGetRequest) (*operations.CloudassetOperationsGetResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1p7beta1/{name}", request.PathParams)
	...
	res := &operations.CloudassetOperationsGetResponse{
