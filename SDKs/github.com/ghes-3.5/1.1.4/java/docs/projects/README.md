...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsAddCollaboratorRequest req = new ProjectsAddCollaboratorRequest(479385L, "ipsa") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsCreateColumnRequest req = new ProjectsCreateColumnRequest(                new ProjectsCreateColumnRequestBody("Remaining tasks");, 49348L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsCreateForRepoRequest req = new ProjectsCreateForRepoRequest(                new ProjectsCreateForRepoRequestBody("distinctio") {{
                                body = "voluptatem";
                            }};, "autem", "esse");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsDeleteRequest req = new ProjectsDeleteRequest(172951L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsDeleteCardRequest req = new ProjectsDeleteCardRequest(824798L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsDeleteColumnRequest req = new ProjectsDeleteColumnRequest(107210L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsGetRequest req = new ProjectsGetRequest(668606L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsGetCardRequest req = new ProjectsGetCardRequest(817339L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsGetColumnRequest req = new ProjectsGetColumnRequest(545918L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsGetPermissionForUserRequest req = new ProjectsGetPermissionForUserRequest(473143L, "provident");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListCardsRequest req = new ProjectsListCardsRequest(882284L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListCollaboratorsRequest req = new ProjectsListCollaboratorsRequest(409726L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListColumnsRequest req = new ProjectsListColumnsRequest(515638L) {{
                page = 357207L;
                perPage = 889060L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListForOrgRequest req = new ProjectsListForOrgRequest("voluptatibus") {{
                page = 737279L;
                perPage = 872303L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListForRepoRequest req = new ProjectsListForRepoRequest("quia", "quidem") {{
                page = 684126L;
                perPage = 919508L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListForUserRequest req = new ProjectsListForUserRequest("expedita") {{
                page = 885208L;
                perPage = 177005L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsMoveColumnRequest req = new ProjectsMoveColumnRequest(                new ProjectsMoveColumnRequestBody("last");, 510128L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsRemoveCollaboratorRequest req = new ProjectsRemoveCollaboratorRequest(140316L, "explicabo");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsUpdateRequest req = new ProjectsUpdateRequest(358995L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsUpdateCardRequest req = new ProjectsUpdateCardRequest(937117L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsUpdateColumnRequest req = new ProjectsUpdateColumnRequest(                new ProjectsUpdateColumnRequestBody("Remaining tasks");, 239337L);            
