...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DeleteImagesRequest req = new DeleteImagesRequest("voluptates", "b9434645-d030-484f-bba5-cceff5cb01fe") {{
                allImages = false;
                allIterations = false;
                imageIds = new String[]{{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetImagesByIdsRequest req = new GetImagesByIdsRequest("incidunt", "848bd6a6-f044-41d2-83b8-08094373e060") {{
                imageIds = new String[]{{
                    add("59bebbad-02f2-4586-bcf1-52558daa95be"),
                    add("6cd02756-c354-4aa4-b2b4-7e1763c5208c"),
                }};
                iterationId = "23e9802d-82f0-4d45-ab4a-8b674ee5cfc1";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetTaggedImageCountRequest req = new GetTaggedImageCountRequest("rem", "edc7f787-e32e-404b-bd3e-d0c5670ef42b") {{
                iterationId = "d3c9f1cc-503f-46c3-9bcd-0a6290f957f3";
                tagIds = new String[]{{
                    add("5189ad7e-f807-4aae-83f3-3ca79fb9de40"),
                    add("32ba26fd-368b-4a92-96bc-b415835c7364"),
                    add("1723133e-dc04-46bc-9163-bbca49227c42"),
                }};
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetTaggedImagesRequest req = new GetTaggedImagesRequest("maxime", "22c55350-495c-45db-b3c5-7c1e4981e8aa") {{
                iterationId = "257ddc19-12eb-4de6-8bfc-c5469d4015df";
                orderBy = GetTaggedImagesOrderByEnum.OLDEST;
                skip = 458220;
                tagIds = new String[]{{
                    add("6206bef2-b0a3-4e42-81aa-010e9aac2e91"),
                    add("35586d18-f9f9-47a4-bfad-2bf7d67ca84a"),
                    add("d99b41d6-1243-4531-870c-f68b03ad421b"),
                }};
                take = 830304;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetUntaggedImageCountRequest req = new GetUntaggedImageCountRequest("ut", "3d1f0cb0-a000-43eb-a2d9-b3a70d94faa7") {{
                iterationId = "41c57d1f-edc2-4050-938d-c3ce185472f9";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetUntaggedImagesRequest req = new GetUntaggedImagesRequest("necessitatibus", "e69166a8-be34-444e-ac8b-3a2875c6c1fe") {{
                iterationId = "606d07d2-a9c8-47ae-90c1-6661a1d9136a";
    ...
    public static void main(String[] args) {
        try {
            ...
            QuerySuggestedImageCountFormRequest req = new QuerySuggestedImageCountFormRequest(                new TagFilter() {{
                                tagIds = new String[]{{
                                    add("53213f3f-6587-452d-b764-c59f0a56cebc"),
                                    add("ada29ca7-9181-4c95-a716-63c530b56651"),
                                    add("63a36385-12ab-4252-9b9f-2e072467b8a4"),
                                    add("0bc05fab-0d65-40ed-b22a-94d20ec90ea4"),
                                }};
                                threshold = 957.08;
                            }};, "repellendus", "1f465e85-156f-4ff7-bfdf-54fdd5ea9543", "398dafb4-2a8d-4633-88e4-d8039ea5f9b1");            
    ...
    public static void main(String[] args) {
        try {
            ...
            QuerySuggestedImageCountJsonRequest req = new QuerySuggestedImageCountJsonRequest(                new TagFilter() {{
                                tagIds = new String[]{{
                                    add("a244fd61-9039-4dac-938e-d0dc671dc7f1"),
                                    add("e3af1592-0c90-4d1b-8901-f2bd89c8a326"),
                                    add("39da5b7b-6902-4b88-9a94-f643664a8f0a"),
                                }};
                                threshold = 9939.42;
                            }};, "rem", "c691d732-d9fb-4af9-876a-2ae8dcc50c8a", "3512c737-8489-4307-90a0-0e966ec736d4");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            QuerySuggestedImageCountRawRequest req = new QuerySuggestedImageCountRawRequest("neque".getBytes(), "inventore", "94398c78-3c92-4398-ad3d-3ab7ca3c5ca8", "649a70cf-d5d6-4989-b720-6451077d19ea");            
    ...
    public static void main(String[] args) {
        try {
            ...
            QuerySuggestedImagesFormRequest req = new QuerySuggestedImagesFormRequest(                new SuggestedTagAndRegionQueryToken() {{
                                continuation = "voluptatum";
                                maxCount = 188008;
                                session = "facere";
                                sortBy = SuggestedTagAndRegionQueryTokenSortByEnum.UNCERTAINTY_ASCENDING;
                                tagIds = new String[]{{
                                    add("2ed14b8a-2c19-4545-85e9-55dcc185ea49"),
                                    add("01c7c43a-d2da-4a78-8aba-3d230edf7381"),
                                    add("1a115382-bd7e-4d56-9076-21c58f4d7396"),
                                }};
                                threshold = 3441.48;
                            }};, "eum", "4c20a071-1a96-41d2-8a7d-bb8f532d892c", "f7812cb5-12c8-4782-80bf-548f88f8f1bf");            
    ...
    public static void main(String[] args) {
        try {
            ...
            QuerySuggestedImagesJsonRequest req = new QuerySuggestedImagesJsonRequest(                new SuggestedTagAndRegionQueryToken() {{
                                ...
                                tagIds = new String[]{{
                                    add("1f206d5d-831d-4008-9090-f6706673f3a6"),
                                    add("81c5768d-ce74-4240-9a21-5e08601489a5"),
                                    add("f63e3af3-dd9d-4da3-bdcd-63483e4a7a98"),
                                    add("e4df37e4-5b89-455d-813e-13a482310907"),
                                }};
                                threshold = 7384.96;
                            }};, "facere", "354c092b-d734-4f02-849d-86f4bb20fe5d", "911cbfe7-49ca-4f45-a27f-69e2c9e6d10e");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            QuerySuggestedImagesRawRequest req = new QuerySuggestedImagesRawRequest("omnis".getBytes(), "temporibus", "b3ad4c6b-0310-48d9-8337-473082b94f2a", "b1fd5671-e9c3-4263-90a4-67143789ce0e");            
