...
exports.GetCountriesCountryCodeJsonResponse = exports.GetCountriesCountryCodeJsonRequest = void 0;
...
var GetCountriesCountryCodeJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetCountriesCountryCodeJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=country_code",
        }),
        __metadata("design:type", String)
    ], GetCountriesCountryCodeJsonRequest.prototype, "countryCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetCountriesCountryCodeJsonRequest.prototype, "login", void 0);
    return GetCountriesCountryCodeJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetCountriesCountryCodeJsonRequest = GetCountriesCountryCodeJsonRequest;
var GetCountriesCountryCodeJsonResponse = /** @class */ (function (_super) {
    ...
    ], GetCountriesCountryCodeJsonResponse.prototype, "rawResponse", void 0);
    return GetCountriesCountryCodeJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetCountriesCountryCodeJsonResponse = GetCountriesCountryCodeJsonResponse;
