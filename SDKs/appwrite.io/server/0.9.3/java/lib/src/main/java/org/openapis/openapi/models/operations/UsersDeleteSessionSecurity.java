...
public class UsersDeleteSessionSecurity {
    ...
    public UsersDeleteSessionSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public UsersDeleteSessionSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public UsersDeleteSessionSecurity(@JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.key = key;
        this.project = project;
  }
}
