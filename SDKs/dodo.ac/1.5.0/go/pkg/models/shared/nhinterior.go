...
func (e *NHInteriorCategoryEnum) UnmarshalJSON(data []byte) error {
	...
	case "Wallpaper":
		fallthrough
	case "Rugs":
		*e = NHInteriorCategoryEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for NHInteriorCategoryEnum: %s", s)
	}
}
...
func (e *NHInteriorColorsEnum) UnmarshalJSON(data []byte) error {
	...
	case "White":
		fallthrough
	case "Yellow":
		*e = NHInteriorColorsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for NHInteriorColorsEnum: %s", s)
	}
}
