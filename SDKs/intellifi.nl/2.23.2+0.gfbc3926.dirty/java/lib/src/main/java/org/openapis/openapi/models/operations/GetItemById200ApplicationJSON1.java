...
public class GetItemById200ApplicationJSON1 {
    /**
    ...
    public GetItemById200ApplicationJSON1 withCodeHex(String codeHex) {
    ...
    public GetItemById200ApplicationJSON1 withConfigRequest(java.util.Map<String, Object> configRequest) {
    ...
    public GetItemById200ApplicationJSON1 withCustom(Object custom) {
        this.custom = custom;
        return this;
    }
    ...
    public GetItemById200ApplicationJSON1 withGeoCoords(org.openapis.openapi.models.shared.GeoCoordsReadOnly geoCoords) {
    ...
    @JsonProperty("id")
    public String id;
    public GetItemById200ApplicationJSON1 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetItemById200ApplicationJSON1 withIsPresent(Boolean isPresent) {
    ...
    @JsonProperty("label")
    public String label;
    public GetItemById200ApplicationJSON1 withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public GetItemById200ApplicationJSON1 withLocation(org.openapis.openapi.models.shared.Location location) {
    ...
    public GetItemById200ApplicationJSON1 withLocationRequest(String locationRequest) {
    ...
    public GetItemById200ApplicationJSON1 withMetadata(java.util.Map<String, Object> metadata) {
    ...
    public GetItemById200ApplicationJSON1 withMoveCount(Long moveCount) {
    ...
    public GetItemById200ApplicationJSON1 withProtocol(org.openapis.openapi.models.shared.ItemProtocolEnum protocol) {
    ...
    @JsonProperty("sets")
    public String[] sets;
    public GetItemById200ApplicationJSON1 withSets(String[] sets) {
        this.sets = sets;
        return this;
    }
    ...
    public GetItemById200ApplicationJSON1 withTechnology(org.openapis.openapi.models.shared.TechnologyEnum technology) {
    ...
    public GetItemById200ApplicationJSON1 withTimeCreated(String timeCreated) {
    ...
    public GetItemById200ApplicationJSON1 withTimeLastPresent(String timeLastPresent) {
    ...
    public GetItemById200ApplicationJSON1 withTimeMoved(String timeMoved) {
    ...
    public GetItemById200ApplicationJSON1 withTimeUpdated(String timeUpdated) {
    ...
    public GetItemById200ApplicationJSON1 withType(org.openapis.openapi.models.shared.ItemTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    @JsonProperty("url")
    public String url;
    public GetItemById200ApplicationJSON1 withUrl(String url) {
        this.url = url;
        return this;
    }
