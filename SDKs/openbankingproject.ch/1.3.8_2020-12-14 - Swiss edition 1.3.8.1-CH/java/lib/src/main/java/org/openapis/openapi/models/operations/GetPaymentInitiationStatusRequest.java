...
public class GetPaymentInitiationStatusRequest {
    ...
    public GetPaymentInitiationStatusRequest withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public GetPaymentInitiationStatusRequest withPSUAccept(String psuAccept) {
    ...
    public GetPaymentInitiationStatusRequest withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public GetPaymentInitiationStatusRequest withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public GetPaymentInitiationStatusRequest withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public GetPaymentInitiationStatusRequest withPSUDeviceID(String psuDeviceID) {
    ...
    public GetPaymentInitiationStatusRequest withPSUGeoLocation(String psuGeoLocation) {
    ...
    public GetPaymentInitiationStatusRequest withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public GetPaymentInitiationStatusRequest withPSUIPAddress(String psuIPAddress) {
    ...
    public GetPaymentInitiationStatusRequest withPSUIPPort(String psuIPPort) {
    ...
    public GetPaymentInitiationStatusRequest withPSUUserAgent(String psuUserAgent) {
    ...
    public GetPaymentInitiationStatusRequest withSignature(String signature) {
    ...
    public GetPaymentInitiationStatusRequest withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public GetPaymentInitiationStatusRequest withXRequestID(String xRequestID) {
    ...
    public GetPaymentInitiationStatusRequest withPaymentProduct(org.openapis.openapi.models.shared.PaymentProductEnum paymentProduct) {
    ...
    public GetPaymentInitiationStatusRequest withPaymentService(org.openapis.openapi.models.shared.PaymentServiceEnum paymentService) {
