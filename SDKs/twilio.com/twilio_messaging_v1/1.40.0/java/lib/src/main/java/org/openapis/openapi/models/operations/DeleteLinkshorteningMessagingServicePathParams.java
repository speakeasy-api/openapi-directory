...
public class DeleteLinkshorteningMessagingServicePathParams {
    /**
    ...
    public DeleteLinkshorteningMessagingServicePathParams withDomainSid(String domainSid) {
    ...
    public DeleteLinkshorteningMessagingServicePathParams withMessagingServiceSid(String messagingServiceSid) {
