 ...
 */
export declare class CreateInsightRequestBodyFilters extends SpeakeasyBase {
...
export declare class CreateInsightRequestBody extends SpeakeasyBase {
    /**
     * <p>A collection of attributes that are applied to all active Security Hub-aggregated findings and that result in a subset of findings that are included in this insight.</p> <p>You can filter by up to 10 finding attributes. For each attribute, you can provide up to 20 filter values.</p>
     */
...
export declare class CreateInsightRequest extends SpeakeasyBase {
    requestBody: CreateInsightRequestBody;
...
export declare class CreateInsightResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Success
     */
