 ...
 */
export class DescribeCustomerGatewaysRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
 ...
 */
export class DescribeCustomerGatewaysRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: DescribeCustomerGatewaysRequestFilters })
