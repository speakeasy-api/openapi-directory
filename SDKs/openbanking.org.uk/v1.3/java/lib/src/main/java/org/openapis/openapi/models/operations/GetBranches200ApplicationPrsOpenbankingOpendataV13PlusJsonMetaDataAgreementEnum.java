...
public enum GetBranches200ApplicationPrsOpenbankingOpendataV13PlusJsonMetaDataAgreementEnum {
    ...
    private GetBranches200ApplicationPrsOpenbankingOpendataV13PlusJsonMetaDataAgreementEnum(String value) {
        this.value = value;
    }
}
