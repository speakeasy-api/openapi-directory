...
class PUTOrderTriggerDatesRequest:
    ...
    r"""Order number of a pending order in which you are to update an order action's triggering dates."""  
    put_order_action_trigger_dates_request_type: shared_putorderactiontriggerdatesrequesttype.PUTOrderActionTriggerDatesRequestType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
