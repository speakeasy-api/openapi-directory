...
func (e *UpdateNetworkWirelessSsidBonjourForwardingRequestBodyRulesServicesEnum) UnmarshalJSON(data []byte) error {
	...
	case "iChat":
		fallthrough
	case "iTunes":
		*e = UpdateNetworkWirelessSsidBonjourForwardingRequestBodyRulesServicesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSsidBonjourForwardingRequestBodyRulesServicesEnum: %s", s)
	}
}
