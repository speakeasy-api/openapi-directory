...
class GetDomesticPaymentsDomesticPaymentIDRequest:
    headers: GetDomesticPaymentsDomesticPaymentIDHeaders = dataclasses.field()
    path_params: GetDomesticPaymentsDomesticPaymentIDPathParams = dataclasses.field()
    security: GetDomesticPaymentsDomesticPaymentIDSecurity = dataclasses.field()
