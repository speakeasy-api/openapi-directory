...
class RequestUploadStatusFilesRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestUploadStatusFilesXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestUploadStatusFilesXSdsDateFormatEnum $xSdsDateFormat = null;
