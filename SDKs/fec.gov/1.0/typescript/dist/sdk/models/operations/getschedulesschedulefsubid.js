...
exports.GetSchedulesScheduleFSubIdResponse = exports.GetSchedulesScheduleFSubIdRequest = exports.GetSchedulesScheduleFSubIdDefaultApplicationJson = exports.GetSchedulesScheduleFSubIdDefaultApplicationJsonResults = exports.GetSchedulesScheduleFSubIdQueryParams = exports.GetSchedulesScheduleFSubIdPathParams = void 0;
...
exports.GetSchedulesScheduleFSubIdPathParams = GetSchedulesScheduleFSubIdPathParams;
...
exports.GetSchedulesScheduleFSubIdQueryParams = GetSchedulesScheduleFSubIdQueryParams;
var GetSchedulesScheduleFSubIdDefaultApplicationJsonResults = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=aggregate_general_election_expenditure" }),
        __metadata("design:type", String)
    ], GetSchedulesScheduleFSubIdDefaultApplicationJsonResults.prototype, "aggregateGeneralElectionExpenditure", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=back_reference_schedule_name" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=catolog_code" }),
        __metadata("design:type", String)
    ], GetSchedulesScheduleFSubIdDefaultApplicationJsonResults.prototype, "catologCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=catolog_code_full" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=committee_designated_coordinated_expenditure_indicator" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=designated_committee_id" }),
        __metadata("design:type", String)
    ], GetSchedulesScheduleFSubIdDefaultApplicationJsonResults.prototype, "designatedCommitteeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=designated_committee_name" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=subordinate_committee" }),
        __metadata("design:type", shared.CommitteeHistory)
    ], GetSchedulesScheduleFSubIdDefaultApplicationJsonResults.prototype, "subordinateCommittee", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=subordinate_committee_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=unlimited_spending_flag" }),
        __metadata("design:type", String)
    ], GetSchedulesScheduleFSubIdDefaultApplicationJsonResults.prototype, "unlimitedSpendingFlag", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=unlimited_spending_flag_full" }),
        __metadata("design:type", String)
...
var GetSchedulesScheduleFSubIdDefaultApplicationJson = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=results", elemType: GetSchedulesScheduleFSubIdDefaultApplicationJsonResults }),
