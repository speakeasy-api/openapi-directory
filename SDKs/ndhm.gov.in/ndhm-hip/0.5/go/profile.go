...
func (s *Profile) PostV05PatientsProfileShare(ctx context.Context, request operations.PostV05PatientsProfileShareRequest) (*operations.PostV05PatientsProfileShareResponse, error) {
	baseURL := operations.PostV05PatientsProfileShareServerList[0]
	...
	res := &operations.PostV05PatientsProfileShareResponse{
