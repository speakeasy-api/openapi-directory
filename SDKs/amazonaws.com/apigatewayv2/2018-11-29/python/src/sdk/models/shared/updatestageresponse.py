...
class UpdateStageResponseAccessLogSettings:
    r"""UpdateStageResponseAccessLogSettings
...
class UpdateStageResponseDefaultRouteSettings:
    r"""UpdateStageResponseDefaultRouteSettings
...
class UpdateStageResponse:
    access_log_settings: Optional[UpdateStageResponseAccessLogSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('AccessLogSettings') }})
    ...
    default_route_settings: Optional[UpdateStageResponseDefaultRouteSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DefaultRouteSettings') }})
