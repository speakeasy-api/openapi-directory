...
class GetExportClientVpnClientConfigurationQueryParams:
    action: GetExportClientVpnClientConfigurationActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    client_vpn_endpoint_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'ClientVpnEndpointId', 'style': 'form', 'explode': True }})
    version: GetExportClientVpnClientConfigurationVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetExportClientVpnClientConfigurationRequest:
    headers: GetExportClientVpnClientConfigurationHeaders = dataclasses.field()
    query_params: GetExportClientVpnClientConfigurationQueryParams = dataclasses.field()
