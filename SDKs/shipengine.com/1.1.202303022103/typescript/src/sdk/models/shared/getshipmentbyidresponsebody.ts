 ...
 */
export enum GetShipmentByIdResponseBodyDeliveryConfirmationEnum {
  None = "none",
  Delivery = "delivery",
  Signature = "signature",
 ...
 */
export enum GetShipmentByIdResponseBodyInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export enum GetShipmentByIdResponseBodyInternationalShipmentOptionsNonDeliveryEnum {
 ...
 */
export enum GetShipmentByIdResponseBodyInsuranceProviderEnum {
  None = "none",
 ...
 */
export enum GetShipmentByIdResponseBodyOriginTypeEnum {
  Pickup = "pickup",
  DropOff = "drop_off",
}
 ...
 */
export enum GetShipmentByIdResponseBodyShipmentStatusEnum {
  Pending = "pending",
...
export class GetShipmentByIdResponseBody extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "customs" })
  @Type(() => GetShipmentByIdResponseBodyInternationalShipmentOptions)
  ...
  @Type(() => GetShipmentByIdResponseBodyWeight)
