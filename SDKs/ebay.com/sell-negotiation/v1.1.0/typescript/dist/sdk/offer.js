...
var Offer = /** @class */ (function () {
     ...
     */
    Offer.prototype.findEligibleItems = function (req, security, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.FindEligibleItemsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.pagedEligibleItemCollection = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.PagedEligibleItemCollection);
                    }
                    break;
     ...
     */
    Offer.prototype.sendOfferToInterestedBuyers = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        try {
            _a = utils.serializeRequestBody(req, "createOffersRequest", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.SendOfferToInterestedBuyersResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.sendOfferToInterestedBuyersCollectionResponse =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.SendOfferToInterestedBuyersCollectionResponse);
                    }
                    break;
