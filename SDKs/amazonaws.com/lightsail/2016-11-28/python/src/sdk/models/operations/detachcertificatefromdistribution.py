...
class DetachCertificateFromDistributionRequest:
    ...
    detach_certificate_from_distribution_request: shared_detachcertificatefromdistributionrequest.DetachCertificateFromDistributionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
