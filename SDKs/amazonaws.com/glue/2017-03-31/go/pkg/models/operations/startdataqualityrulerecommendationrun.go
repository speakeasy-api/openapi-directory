...
func (e *StartDataQualityRuleRecommendationRunXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSGlue.StartDataQualityRuleRecommendationRun":
		*e = StartDataQualityRuleRecommendationRunXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for StartDataQualityRuleRecommendationRunXAmzTargetEnum: %s", s)
	}
}

type StartDataQualityRuleRecommendationRunHeaders struct {
...
type StartDataQualityRuleRecommendationRunRequest struct {
	Headers StartDataQualityRuleRecommendationRunHeaders
	Request shared.StartDataQualityRuleRecommendationRunRequest `request:"mediaType=application/json"`
}
