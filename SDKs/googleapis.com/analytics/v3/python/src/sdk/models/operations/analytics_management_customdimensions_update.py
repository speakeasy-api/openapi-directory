...
class AnalyticsManagementCustomDimensionsUpdateRequest:
    ...
    r"""Account ID for the custom dimension to update."""  
    custom_dimension_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'customDimensionId', 'style': 'simple', 'explode': False }})
    r"""Custom dimension ID for the custom dimension to update."""  
    web_property_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'webPropertyId', 'style': 'simple', 'explode': False }})
    r"""Web property ID for the custom dimension to update."""  
    alt: Optional[shared_alt_enum.AltEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'alt', 'style': 'form', 'explode': True }})
    r"""Data format for the response."""  
    custom_dimension_input: Optional[shared_customdimension.CustomDimensionInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    ...
    r"""Force the update and ignore any warnings related to the custom dimension being linked to a custom data source / data set."""  
