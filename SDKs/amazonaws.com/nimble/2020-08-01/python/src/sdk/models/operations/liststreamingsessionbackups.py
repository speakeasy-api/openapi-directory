...
from ..shared import liststreamingsessionbackupsresponse as shared_liststreamingsessionbackupsresponse
...
class ListStreamingSessionBackupsRequest:
    ...
    r"""The user ID of the user that owns the streaming session."""  
...
class ListStreamingSessionBackupsResponse:
    ...
    list_streaming_session_backups_response: Optional[shared_liststreamingsessionbackupsresponse.ListStreamingSessionBackupsResponse] = dataclasses.field(default=None)
    r"""Success"""  
