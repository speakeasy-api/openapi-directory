...
class DeleteSessionRequest:
    ...
    r"""The alias identifier in use for the bot that contains the session data."""  
    bot_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'botId', 'style': 'simple', 'explode': False }})
    r"""The identifier of the bot that contains the session data."""  
    ...
    r"""The identifier of the session to delete."""  
