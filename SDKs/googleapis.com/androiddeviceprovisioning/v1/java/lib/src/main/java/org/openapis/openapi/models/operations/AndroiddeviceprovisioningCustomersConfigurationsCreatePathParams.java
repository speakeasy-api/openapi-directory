...
public class AndroiddeviceprovisioningCustomersConfigurationsCreatePathParams {
    /**
    ...
    public AndroiddeviceprovisioningCustomersConfigurationsCreatePathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
