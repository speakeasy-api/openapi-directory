 ...
 */
export declare enum AllocateAddressRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class AllocateAddressRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class AllocateAddressRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: AllocateAddressRequestTagSpecificationsResourceTypeEnum;
    tags?: AllocateAddressRequestTagSpecificationsTags[];
}
export declare class AllocateAddressRequest extends SpeakeasyBase {
    address?: string;
