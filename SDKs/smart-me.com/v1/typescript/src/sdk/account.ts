...
export class Account {
  ...
  accountLogin(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AccountLoginResponse =
        new operations.AccountLoginResponse({
  ...
  postApiAccountLogin(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostApiAccountLoginResponse =
        new operations.PostApiAccountLoginResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
