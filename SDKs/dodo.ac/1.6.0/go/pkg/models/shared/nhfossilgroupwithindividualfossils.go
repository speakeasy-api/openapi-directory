...
func (e NHFossilGroupWithIndividualFossilsFossilsColorsEnum) ToPointer() *NHFossilGroupWithIndividualFossilsFossilsColorsEnum {
	return &e
}
...
func (e *NHFossilGroupWithIndividualFossilsFossilsColorsEnum) UnmarshalJSON(data []byte) error {
	...
	case "White":
		fallthrough
	case "Yellow":
		*e = NHFossilGroupWithIndividualFossilsFossilsColorsEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NHFossilGroupWithIndividualFossilsFossilsColorsEnum: %v", v)
	}
}
