...
public class Challenge {
    ...
    **/
    public openapisdk.models.operations.VerifiedaccessChallengeCreateResponse verifiedaccessChallengeCreate(openapisdk.models.operations.VerifiedaccessChallengeCreateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/challenge");
        ...
        openapisdk.models.operations.VerifiedaccessChallengeCreateResponse res = new openapisdk.models.operations.VerifiedaccessChallengeCreateResponse() {{
            challenge = null;
        }};
    ...
    **/
    public openapisdk.models.operations.VerifiedaccessChallengeVerifyResponse verifiedaccessChallengeVerify(openapisdk.models.operations.VerifiedaccessChallengeVerifyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/challenge:verify");
