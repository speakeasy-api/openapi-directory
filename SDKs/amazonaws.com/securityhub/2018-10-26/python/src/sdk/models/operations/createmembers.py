...
class CreateMembersRequestBody:
    ...
    account_details: list[shared_accountdetails.AccountDetails] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AccountDetails') }})
    r"""The list of accounts to associate with the Security Hub administrator account. For each account, the list includes the account ID and optionally the email address."""  
