...
const (
	DeleteNamespaceXAmzTargetEnumRedshiftServerlessDeleteNamespace DeleteNamespaceXAmzTargetEnum = "RedshiftServerless.DeleteNamespace"
)
...
func (e *DeleteNamespaceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "RedshiftServerless.DeleteNamespace":
...
type DeleteNamespaceRequest struct {
	DeleteNamespaceRequest shared.DeleteNamespaceRequest `request:"mediaType=application/json"`
