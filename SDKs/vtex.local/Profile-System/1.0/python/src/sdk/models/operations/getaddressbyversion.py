...
class GetAddressByVersionRequest:
    ...
    address_version_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'addressVersionId', 'style': 'simple', 'explode': False }})
    r"""ID of the version of a given client's address as returned by endpoints that create or update address information in the `version` field."""  
...
class GetAddressByVersionResponse:
    ...
    get_address_by_version_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""OK"""  
