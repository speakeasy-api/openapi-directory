...
public class UpdateSipIpAddressRequest {
    ...
    public UpdateSipIpAddressRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("IpAccessControlListSid") String ipAccessControlListSid, @JsonProperty("Sid") String sid) {
        this.accountSid = accountSid;
        this.ipAccessControlListSid = ipAccessControlListSid;
        this.sid = sid;
  }
