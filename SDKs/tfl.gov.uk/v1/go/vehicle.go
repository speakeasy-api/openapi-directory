...
func (s *vehicle) VehicleGetEmissionsSurchargeCompliance(ctx context.Context, request operations.VehicleGetEmissionsSurchargeComplianceRequest) (*operations.VehicleGetEmissionsSurchargeComplianceResponse, error) {
	baseURL := s.serverURL
...
func (s *vehicle) VehicleGetUlezCompliance(ctx context.Context, request operations.VehicleGetUlezComplianceRequest) (*operations.VehicleGetUlezComplianceResponse, error) {
	baseURL := s.serverURL
