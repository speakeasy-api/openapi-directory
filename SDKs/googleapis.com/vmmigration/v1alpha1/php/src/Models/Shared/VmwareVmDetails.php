...
class VmwareVmDetails
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\VmwareVmDetailsBootOptionEnum $bootOption
     */
	#[\JMS\Serializer\Annotation\SerializedName('bootOption')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VmwareVmDetailsBootOptionEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?VmwareVmDetailsBootOptionEnum $bootOption = null;
    
    /**
     * The total size of the storage allocated to the VM in MB.
     * 
     * @var ?string $committedStorage
     */
	#[\JMS\Serializer\Annotation\SerializedName('committedStorage')]
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $committedStorage = null;
