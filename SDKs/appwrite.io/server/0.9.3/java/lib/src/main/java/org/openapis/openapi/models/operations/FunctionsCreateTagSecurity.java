...
public class FunctionsCreateTagSecurity {
    ...
    public FunctionsCreateTagSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public FunctionsCreateTagSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public FunctionsCreateTagSecurity(@JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.key = key;
        this.project = project;
  }
}
