...
from ..shared import unsuspendaccountholderresponse as shared_unsuspendaccountholderresponse
...
class PostUnSuspendAccountHolderResponse:
    ...
    un_suspend_account_holder_response: Optional[shared_unsuspendaccountholderresponse.UnSuspendAccountHolderResponse] = dataclasses.field(default=None)
