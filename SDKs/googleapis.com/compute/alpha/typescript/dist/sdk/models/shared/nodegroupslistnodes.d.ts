 ...
 */
export declare enum NodeGroupsListNodesWarningCodeEnum {
...
export declare class NodeGroupsListNodesWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodeGroupsListNodesWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class NodeGroupsListNodes extends SpeakeasyBase {
    /**
