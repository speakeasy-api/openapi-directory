...
class TeamsCreateDiscussionRequest:
    path_params: TeamsCreateDiscussionPathParams = dataclasses.field()
    request: Optional[TeamsCreateDiscussionRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
