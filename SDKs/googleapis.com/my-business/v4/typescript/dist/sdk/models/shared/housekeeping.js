...
var Housekeeping = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "dailyHousekeeping" }),
        __metadata("design:type", Boolean)
    ], Housekeeping.prototype, "dailyHousekeeping", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "dailyHousekeepingException" }),
        __metadata("design:type", String)
    ], Housekeeping.prototype, "dailyHousekeepingException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "housekeepingAvailable" }),
        __metadata("design:type", Boolean)
    ], Housekeeping.prototype, "housekeepingAvailable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "housekeepingAvailableException" }),
        __metadata("design:type", String)
    ], Housekeeping.prototype, "housekeepingAvailableException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "turndownService" }),
        __metadata("design:type", Boolean)
    ], Housekeeping.prototype, "turndownService", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "turndownServiceException" }),
        __metadata("design:type", String)
