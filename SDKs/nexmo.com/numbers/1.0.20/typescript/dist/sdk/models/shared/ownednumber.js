...
var Ownednumber = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "messagesCallbackType" }),
        __metadata("design:type", String)
    ], Ownednumber.prototype, "messagesCallbackType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "messagesCallbackValue" }),
        __metadata("design:type", String)
    ], Ownednumber.prototype, "messagesCallbackValue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "moHttpUrl" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "voiceCallbackType" }),
        __metadata("design:type", String)
    ], Ownednumber.prototype, "voiceCallbackType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "voiceCallbackValue" }),
        __metadata("design:type", String)
