...
exports.IdentitytoolkitRelyingpartyCreateAuthUriResponse = exports.IdentitytoolkitRelyingpartyCreateAuthUriRequest = exports.IdentitytoolkitRelyingpartyCreateAuthUriSecurity = void 0;
...
exports.IdentitytoolkitRelyingpartyCreateAuthUriSecurity = IdentitytoolkitRelyingpartyCreateAuthUriSecurity;
var IdentitytoolkitRelyingpartyCreateAuthUriRequest = /** @class */ (function (_super) {
    ...
    ], IdentitytoolkitRelyingpartyCreateAuthUriRequest.prototype, "identitytoolkitRelyingpartyCreateAuthUriRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyCreateAuthUriRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyCreateAuthUriRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyCreateAuthUriRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyCreateAuthUriRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], IdentitytoolkitRelyingpartyCreateAuthUriRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyCreateAuthUriRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyCreateAuthUriRequest.prototype, "userIp", void 0);
...
var IdentitytoolkitRelyingpartyCreateAuthUriResponse = /** @class */ (function (_super) {
    ...
    ], IdentitytoolkitRelyingpartyCreateAuthUriResponse.prototype, "rawResponse", void 0);
    return IdentitytoolkitRelyingpartyCreateAuthUriResponse;
}(utils_1.SpeakeasyBase));
exports.IdentitytoolkitRelyingpartyCreateAuthUriResponse = IdentitytoolkitRelyingpartyCreateAuthUriResponse;
