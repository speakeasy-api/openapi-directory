...
func (e StartQueryExecutionXAmzTargetEnum) ToPointer() *StartQueryExecutionXAmzTargetEnum {
	return &e
}

func (e *StartQueryExecutionXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "AmazonAthena.StartQueryExecution":
		*e = StartQueryExecutionXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for StartQueryExecutionXAmzTargetEnum: %v", v)
	}
}

type StartQueryExecutionRequest struct {
	StartQueryExecutionInput shared.StartQueryExecutionInput   `request:"mediaType=application/json"`
