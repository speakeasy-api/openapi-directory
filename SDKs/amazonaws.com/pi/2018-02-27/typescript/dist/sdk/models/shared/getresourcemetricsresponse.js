...
var GetResourceMetricsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: metrickeydatapoints_1.MetricKeyDataPoints }),
        (0, class_transformer_1.Expose)({ name: "MetricList" }),
        (0, class_transformer_1.Type)(function () { return metrickeydatapoints_1.MetricKeyDataPoints; }),
