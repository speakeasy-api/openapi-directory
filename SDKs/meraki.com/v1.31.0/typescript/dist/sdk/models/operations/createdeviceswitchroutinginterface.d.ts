 ...
 */
export declare class CreateDeviceSwitchRoutingInterfaceRequestBodyIpv6 extends SpeakeasyBase {
    /**
 ...
 */
export declare class CreateDeviceSwitchRoutingInterfaceRequestBodyOspfV3 extends SpeakeasyBase {
    /**
 ...
 * IPv6 addressing
 */
export declare class CreateDeviceSwitchRoutingInterface201ApplicationJSONIpv6 extends SpeakeasyBase {
    /**
     * IPv6 address
     */
    address?: string;
 ...
 * IPv4 OSPF Settings
 */
export declare class CreateDeviceSwitchRoutingInterface201ApplicationJSONOspfSettings extends SpeakeasyBase {
    /**
     * Area id
     */
    area?: string;
 ...
 * IPv6 OSPF Settings
 */
export declare class CreateDeviceSwitchRoutingInterface201ApplicationJSONOspfV3 extends SpeakeasyBase {
    /**
     * Area id
     */
    area?: string;
 ...
 */
export declare class CreateDeviceSwitchRoutingInterface201ApplicationJSON extends SpeakeasyBase {
    /**
