...
exports.ExtendedKeyUsageOptions = void 0;
...
var ExtendedKeyUsageOptions = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=clientAuth" }),
        __metadata("design:type", Boolean)
    ], ExtendedKeyUsageOptions.prototype, "clientAuth", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=codeSigning" }),
        __metadata("design:type", Boolean)
    ], ExtendedKeyUsageOptions.prototype, "codeSigning", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=emailProtection" }),
        __metadata("design:type", Boolean)
    ], ExtendedKeyUsageOptions.prototype, "emailProtection", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ocspSigning" }),
        __metadata("design:type", Boolean)
    ], ExtendedKeyUsageOptions.prototype, "ocspSigning", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=serverAuth" }),
        __metadata("design:type", Boolean)
    ], ExtendedKeyUsageOptions.prototype, "serverAuth", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timeStamping" }),
        __metadata("design:type", Boolean)
    ], ExtendedKeyUsageOptions.prototype, "timeStamping", void 0);
    return ExtendedKeyUsageOptions;
}(utils_1.SpeakeasyBase));
exports.ExtendedKeyUsageOptions = ExtendedKeyUsageOptions;
