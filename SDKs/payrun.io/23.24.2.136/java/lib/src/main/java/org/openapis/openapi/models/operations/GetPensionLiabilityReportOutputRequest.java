...
public class GetPensionLiabilityReportOutputRequest {
    ...
    public GetPensionLiabilityReportOutputRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("EmployerKey") String employerKey, @JsonProperty("PensionKey") String pensionKey, @JsonProperty("TaxYear") String taxYear) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.employerKey = employerKey;
        this.pensionKey = pensionKey;
