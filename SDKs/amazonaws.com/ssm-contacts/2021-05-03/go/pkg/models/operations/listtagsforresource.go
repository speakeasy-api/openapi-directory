...
const (
	ListTagsForResourceXAmzTargetEnumSsmContactsListTagsForResource ListTagsForResourceXAmzTargetEnum = "SSMContacts.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "SSMContacts.ListTagsForResource":
