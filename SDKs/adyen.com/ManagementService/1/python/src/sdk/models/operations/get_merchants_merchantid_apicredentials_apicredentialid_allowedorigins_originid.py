...
class GetMerchantsMerchantIDAPICredentialsAPICredentialIDAllowedOriginsOriginIDSecurity:
...
@dataclasses.dataclass
class GetMerchantsMerchantIDAPICredentialsAPICredentialIDAllowedOriginsOriginIDResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    allowed_origin: Optional[shared_allowedorigin.AllowedOrigin] = dataclasses.field(default=None)
