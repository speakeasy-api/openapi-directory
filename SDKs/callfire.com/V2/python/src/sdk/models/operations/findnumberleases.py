...
from ..shared import numberleasepage as shared_numberleasepage
...
class FindNumberLeasesRequest:
    ...
    toll_free: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'tollFree', 'style': 'form', 'explode': True }})
    r"""~"""  
...
class FindNumberLeasesResponse:
    ...
    r"""Bad request"""  
    number_lease_page: Optional[shared_numberleasepage.NumberLeasePage] = dataclasses.field(default=None)
