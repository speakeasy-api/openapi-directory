...
exports.EmployeesDeleteResponse = exports.EmployeesDeleteRequest = exports.EmployeesDeleteSecurity = void 0;
...
exports.EmployeesDeleteSecurity = EmployeesDeleteSecurity;
var EmployeesDeleteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], EmployeesDeleteRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], EmployeesDeleteRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], EmployeesDeleteRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], EmployeesDeleteRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], EmployeesDeleteRequest.prototype, "xApideckServiceId", void 0);
    return EmployeesDeleteRequest;
}(utils_1.SpeakeasyBase));
exports.EmployeesDeleteRequest = EmployeesDeleteRequest;
var EmployeesDeleteResponse = /** @class */ (function (_super) {
    ...
    ], EmployeesDeleteResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.EmployeesDeleteResponse = EmployeesDeleteResponse;
