...
class CreateSubnetRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateSubnetRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
class CreateSubnetRequestTagSpecifications:
    ...
    resource_type: Optional[CreateSubnetRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateSubnetRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateSubnetRequest:
    ...
    tag_specifications: Optional[list[CreateSubnetRequestTagSpecifications]] = dataclasses.field(default=None)  
