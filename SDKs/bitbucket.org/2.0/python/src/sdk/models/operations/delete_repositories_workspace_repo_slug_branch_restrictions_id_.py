...
class DeleteRepositoriesWorkspaceRepoSlugBranchRestrictionsIDRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugBranchRestrictionsIDPathParams = dataclasses.field()
    security: DeleteRepositoriesWorkspaceRepoSlugBranchRestrictionsIDSecurity = dataclasses.field()
