...
class Error405NGPIIS:
    ...
    tpp_messages: Optional[list[shared_tppmessage405_piis.TppMessage405PIIS]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tppMessages'), 'exclude': lambda f: f is None }})  
