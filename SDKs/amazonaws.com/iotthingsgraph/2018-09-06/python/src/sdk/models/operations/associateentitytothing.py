...
class AssociateEntityToThingRequest:
    ...
    associate_entity_to_thing_request: shared_associateentitytothingrequest.AssociateEntityToThingRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
