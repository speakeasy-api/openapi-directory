...
public class DeleteSKUsellerassociationPathParams {
    /**
    ...
    public DeleteSKUsellerassociationPathParams withSellerId(String sellerId) {
    ...
    public DeleteSKUsellerassociationPathParams withSellerSkuId(String sellerSkuId) {
