...
export enum POSTDescribeClusterSecurityGroupsActionEnum {
  DescribeClusterSecurityGroups = "DescribeClusterSecurityGroups",
}

export enum POSTDescribeClusterSecurityGroupsVersionEnum {
  TwoThousandAndTwelve1201 = "2012-12-01",
}

export class POSTDescribeClusterSecurityGroupsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class POSTDescribeClusterSecurityGroupsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
