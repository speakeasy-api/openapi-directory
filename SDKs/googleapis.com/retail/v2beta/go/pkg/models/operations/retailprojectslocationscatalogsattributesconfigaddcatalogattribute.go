...
type RetailProjectsLocationsCatalogsAttributesConfigAddCatalogAttributeRequest struct {
	...
	GoogleCloudRetailV2betaAddCatalogAttributeRequestInput *shared.GoogleCloudRetailV2betaAddCatalogAttributeRequestInput `request:"mediaType=application/json"`
	// OAuth access token.
