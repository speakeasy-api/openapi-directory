...
export class MybusinesslodgingLocationsLodgingGetGoogleUpdatedRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinesslodgingLocationsLodgingGetGoogleUpdatedResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
