...
class FilesDeleteRequest:
    headers: FilesDeleteHeaders = dataclasses.field()
    path_params: FilesDeletePathParams = dataclasses.field()
    query_params: FilesDeleteQueryParams = dataclasses.field()
    security: FilesDeleteSecurity = dataclasses.field()
