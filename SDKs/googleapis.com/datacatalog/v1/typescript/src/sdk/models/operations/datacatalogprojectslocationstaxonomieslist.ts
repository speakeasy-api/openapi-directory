...
export class DatacatalogProjectsLocationsTaxonomiesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatacatalogProjectsLocationsTaxonomiesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatacatalogProjectsLocationsTaxonomiesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
