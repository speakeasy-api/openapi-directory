...
class OfferingMetadataResponse:
    ...
    enrollment_limit: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('enrollmentLimit') }})
    ...
    metadata: Optional[shared_offeringmetadata.OfferingMetadata] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('metadata') }})
