...
var NewAttendancePeriodRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: NewAttendancePeriodRequestAttendances }),
        (0, class_transformer_1.Expose)({ name: "attendances" }),
        (0, class_transformer_1.Type)(function () { return NewAttendancePeriodRequestAttendances; }),
