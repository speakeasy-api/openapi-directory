...
export class GetCaseModelAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetCaseModelAssociationsQueryParams extends SpeakeasyBase {
...
export class GetCaseModelAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetCaseModelAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
