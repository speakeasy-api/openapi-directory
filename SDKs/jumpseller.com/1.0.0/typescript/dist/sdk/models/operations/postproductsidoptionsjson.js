...
exports.PostProductsIdOptionsJsonResponse = exports.PostProductsIdOptionsJsonRequest = void 0;
...
var PostProductsIdOptionsJsonRequest = /** @class */ (function (_super) {
    ...
    ], PostProductsIdOptionsJsonRequest.prototype, "productOptionEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PostProductsIdOptionsJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PostProductsIdOptionsJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PostProductsIdOptionsJsonRequest.prototype, "login", void 0);
    return PostProductsIdOptionsJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PostProductsIdOptionsJsonRequest = PostProductsIdOptionsJsonRequest;
var PostProductsIdOptionsJsonResponse = /** @class */ (function (_super) {
    ...
    ], PostProductsIdOptionsJsonResponse.prototype, "rawResponse", void 0);
    return PostProductsIdOptionsJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PostProductsIdOptionsJsonResponse = PostProductsIdOptionsJsonResponse;
