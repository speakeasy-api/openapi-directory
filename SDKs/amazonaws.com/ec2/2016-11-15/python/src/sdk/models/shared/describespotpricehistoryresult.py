...
class DescribeSpotPriceHistoryResultSpotPriceHistoryInstanceTypeEnum(str, Enum):
    r"""The instance type."""
    A1_MEDIUM = 'a1.medium'
    A1_LARGE = 'a1.large'
    A1_XLARGE = 'a1.xlarge'
...
class DescribeSpotPriceHistoryResultSpotPriceHistoryProductDescriptionEnum(str, Enum):
    r"""A general description of the AMI."""
...
class DescribeSpotPriceHistoryResultSpotPriceHistory:
    r"""<p>The maximum price per unit hour that you are willing to pay for a Spot Instance. We do not recommend using this parameter because it can lead to increased interruptions. If you do not specify this parameter, you will pay the current Spot price.</p> <important> <p>If you specify a maximum price, your instances will be interrupted more frequently than if you do not specify this parameter.</p> </important>"""
    
    availability_zone: Optional[str] = dataclasses.field(default=None)  
    instance_type: Optional[DescribeSpotPriceHistoryResultSpotPriceHistoryInstanceTypeEnum] = dataclasses.field(default=None)  
    product_description: Optional[DescribeSpotPriceHistoryResultSpotPriceHistoryProductDescriptionEnum] = dataclasses.field(default=None)  
...
class DescribeSpotPriceHistoryResult:
    r"""Contains the output of DescribeSpotPriceHistory."""
    
    next_token: Optional[str] = dataclasses.field(default=None)  
    spot_price_history: Optional[list[DescribeSpotPriceHistoryResultSpotPriceHistory]] = dataclasses.field(default=None)  
