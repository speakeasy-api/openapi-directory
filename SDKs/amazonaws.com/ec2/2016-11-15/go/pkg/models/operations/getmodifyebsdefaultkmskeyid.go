...
func (e GETModifyEbsDefaultKmsKeyIDActionEnum) ToPointer() *GETModifyEbsDefaultKmsKeyIDActionEnum {
	return &e
}
...
func (e *GETModifyEbsDefaultKmsKeyIDActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "ModifyEbsDefaultKmsKeyId":
		*e = GETModifyEbsDefaultKmsKeyIDActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETModifyEbsDefaultKmsKeyIDActionEnum: %v", v)
	}
}
...
func (e GETModifyEbsDefaultKmsKeyIDVersionEnum) ToPointer() *GETModifyEbsDefaultKmsKeyIDVersionEnum {
	return &e
}
...
func (e *GETModifyEbsDefaultKmsKeyIDVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2016-11-15":
		*e = GETModifyEbsDefaultKmsKeyIDVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETModifyEbsDefaultKmsKeyIDVersionEnum: %v", v)
	}
}
