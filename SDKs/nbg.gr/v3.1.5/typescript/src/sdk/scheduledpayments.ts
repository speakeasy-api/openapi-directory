...
export class ScheduledPayments {
  ...
  getAccountsAccountIdScheduledPayments(
    ...
    security: operations.GetAccountsAccountIdScheduledPaymentsSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.GetAccountsAccountIdScheduledPaymentsSecurity(
        security
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetAccountsAccountIdScheduledPaymentsResponse =
        new operations.GetAccountsAccountIdScheduledPaymentsResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.obReadScheduledPayment3 = utils.objectToClass(
              httpRes?.data,
              shared.OBReadScheduledPayment3
            );
          }
          if (
