...
export declare class Users {
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#add-an-email-address-for-the-authenticated-user} - API method documentation
     */
    usersAddEmailForAuthenticated(req: any, config?: AxiosRequestConfig): Promise<operations.UsersAddEmailForAuthenticatedResponse>;
    /**
     * Check if a user follows another user
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#check-if-a-user-follows-another-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#check-if-a-person-is-followed-by-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#create-a-gpg-key-for-the-authenticated-user} - API method documentation
     */
    usersCreateGpgKeyForAuthenticated(req: operations.UsersCreateGpgKeyForAuthenticatedRequestBody, config?: AxiosRequestConfig): Promise<operations.UsersCreateGpgKeyForAuthenticatedResponse>;
    /**
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#create-a-public-ssh-key-for-the-authenticated-user} - API method documentation
     */
    usersCreatePublicSshKeyForAuthenticated(req: operations.UsersCreatePublicSshKeyForAuthenticatedRequestBody, config?: AxiosRequestConfig): Promise<operations.UsersCreatePublicSshKeyForAuthenticatedResponse>;
    /**
     ...
     * This endpoint is accessible with the `user` scope.
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#delete-an-email-address-for-the-authenticated-user} - API method documentation
     */
    usersDeleteEmailForAuthenticated(req: any, config?: AxiosRequestConfig): Promise<operations.UsersDeleteEmailForAuthenticatedResponse>;
    /**
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#delete-a-gpg-key-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#delete-a-public-ssh-key-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#follow-a-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#get-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#get-a-user} - API method documentation
     */
     ...
     * ```
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#get-contextual-information-for-a-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#get-a-gpg-key-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#get-a-public-ssh-key-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#list-users} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#list-email-addresses-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#list-the-people-the-authenticated-user-follows} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#list-followers-of-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#list-followers-of-a-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#list-the-people-a-user-follows} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#list-gpg-keys-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#list-gpg-keys-for-a-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#list-public-email-addresses-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#list-public-keys-for-a-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#list-public-ssh-keys-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users#unfollow-a-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/users/#update-the-authenticated-user} - API method documentation
     */
