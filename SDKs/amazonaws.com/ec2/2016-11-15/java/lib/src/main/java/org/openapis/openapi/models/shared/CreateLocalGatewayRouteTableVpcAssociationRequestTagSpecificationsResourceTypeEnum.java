 ...
 */
public enum CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
