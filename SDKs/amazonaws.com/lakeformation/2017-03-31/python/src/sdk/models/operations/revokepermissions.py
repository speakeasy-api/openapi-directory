...
class RevokePermissionsRequestBody:
    ...
    r"""The permissions revoked to the principal on the resource. For information about permissions, see <a href=\\"https://docs.aws.amazon.com/lake-formation/latest/dg/security-data-access.html\\">Security and Access Control to Metadata and Data</a>."""  
    principal: RevokePermissionsRequestBodyPrincipal = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Principal') }})
    r"""The Lake Formation principal. Supported principals are IAM users or IAM roles."""  
    resource: RevokePermissionsRequestBodyResource = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Resource') }})
    r"""A structure for the resource."""  
    ...
    r"""Indicates a list of permissions for which to revoke the grant option allowing the principal to pass permissions to other principals."""  
    

@dataclasses.dataclass
class RevokePermissionsRequest:
    
    request_body: RevokePermissionsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
