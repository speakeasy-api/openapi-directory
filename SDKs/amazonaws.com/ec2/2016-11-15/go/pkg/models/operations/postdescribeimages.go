...
func (e *POSTDescribeImagesActionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "DescribeImages":
		*e = POSTDescribeImagesActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTDescribeImagesActionEnum: %s", s)
	}
}
...
func (e *POSTDescribeImagesVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2016-11-15":
		*e = POSTDescribeImagesVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTDescribeImagesVersionEnum: %s", s)
	}
}
