...
class GetEnableLoggingQueryParams:
    ...
    bucket_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'BucketName', 'style': 'form', 'explode': True }})
...
class GetEnableLoggingRequest:
    headers: GetEnableLoggingHeaders = dataclasses.field()
    query_params: GetEnableLoggingQueryParams = dataclasses.field()
