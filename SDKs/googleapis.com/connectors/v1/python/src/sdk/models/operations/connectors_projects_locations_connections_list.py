...
class ConnectorsProjectsLocationsConnectionsListViewEnum(str, Enum):
    r"""Specifies which fields of the Connection are returned in the response. Defaults to `BASIC` view."""
...
class ConnectorsProjectsLocationsConnectionsListRequest:
    ...
    r"""Required. Parent resource of the Connection, of the form: `projects/*/locations/*`"""  
