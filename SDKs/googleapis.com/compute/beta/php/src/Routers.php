...
class Routers 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRoutersTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRoutersTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeRoutersTestIamPermissionsResponse
     */
	public function computeRoutersTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeRoutersTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeRoutersTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeRoutersTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/regions/{region}/routers/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeRoutersTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeRoutersTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeRoutersTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
