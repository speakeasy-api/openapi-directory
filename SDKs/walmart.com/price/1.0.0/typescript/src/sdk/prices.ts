...
export class Prices {
  ...
  optCapProgramInPrice(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.OptCapProgramInPriceResponse =
        new operations.OptCapProgramInPriceResponse({
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.optCapProgramInPrice200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.OptCapProgramInPrice200ApplicationJSON
              );
          }
          break;
      }
  ...
  priceBulkUploads(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PriceBulkUploadsResponse =
        new operations.PriceBulkUploadsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.priceBulkUploads200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.PriceBulkUploads200ApplicationJSON
            );
          }
  ...
  updatePrice(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UpdatePriceResponse =
        new operations.UpdatePriceResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
