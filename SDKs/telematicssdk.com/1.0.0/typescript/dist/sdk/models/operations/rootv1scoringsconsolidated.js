...
exports.RootV1ScoringsConsolidatedResponse = exports.RootV1ScoringsConsolidatedRequest = void 0;
...
var RootV1ScoringsConsolidatedRequest = /** @class */ (function (_super) {
    ...
    ], RootV1ScoringsConsolidatedRequest.prototype, "appId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=CompanyId",
        }),
        __metadata("design:type", String)
    ], RootV1ScoringsConsolidatedRequest.prototype, "companyId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DeviceToken",
        }),
        __metadata("design:type", String)
    ], RootV1ScoringsConsolidatedRequest.prototype, "deviceToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EndDate",
        }),
        __metadata("design:type", String)
    ], RootV1ScoringsConsolidatedRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=InstanceId",
        }),
        __metadata("design:type", String)
    ], RootV1ScoringsConsolidatedRequest.prototype, "instanceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate",
        }),
        __metadata("design:type", String)
    ], RootV1ScoringsConsolidatedRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Tag" }),
        __metadata("design:type", String)
    ], RootV1ScoringsConsolidatedRequest.prototype, "tag", void 0);
...
var RootV1ScoringsConsolidatedResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], RootV1ScoringsConsolidatedResponse.prototype, "rawResponse", void 0);
