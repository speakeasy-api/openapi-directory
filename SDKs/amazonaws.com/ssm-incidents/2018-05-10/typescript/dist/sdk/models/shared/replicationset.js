...
var regioninfo_1 = require("./regioninfo");
var replicationsetstatusenum_1 = require("./replicationsetstatusenum");
...
var ReplicationSet = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: regioninfo_1.RegionInfo }),
        (0, class_transformer_1.Expose)({ name: "regionMap" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], regioninfo_1.RegionInfo);
            }
            return obj;
        }, { toClassOnly: true }),
