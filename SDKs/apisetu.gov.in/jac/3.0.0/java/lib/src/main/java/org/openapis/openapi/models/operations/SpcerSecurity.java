...
public class SpcerSecurity {
    ...
    public SpcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public SpcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public SpcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
