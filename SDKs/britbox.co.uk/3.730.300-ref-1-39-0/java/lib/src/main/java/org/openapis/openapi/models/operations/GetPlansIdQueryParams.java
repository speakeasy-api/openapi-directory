...
public class GetPlansIdQueryParams {
    /**
     * The type of device the content is targeting.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=device")
    public String device;
    public GetPlansIdQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetPlansIdQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public String lang;
    public GetPlansIdQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetPlansIdQueryParams withSegments(String[] segments) {
    ...
    public String sub;
    public GetPlansIdQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
