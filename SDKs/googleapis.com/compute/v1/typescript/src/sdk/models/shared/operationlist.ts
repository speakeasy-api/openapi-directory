 ...
 */
export enum OperationListWarningCodeEnum {
...
export class OperationListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class OperationListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: OperationListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: OperationListWarningData })
  @Expose({ name: "data" })
  @Type(() => OperationListWarningData)
  data?: OperationListWarningData[];
 ...
 */
export class OperationList extends SpeakeasyBase {
  /**
