...
/**
 * SendMessageRequestBody1Text - The text of message to send.
 * 
...
class SendMessageRequestBody1Text
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody1TextChannelEnum $channel
     */
	#[\JMS\Serializer\Annotation\SerializedName('channel')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody1TextChannelEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody1TextMessageTypeEnum $messageType
     */
	#[\JMS\Serializer\Annotation\SerializedName('message_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody1TextMessageTypeEnum>')]
	...
	{
		$this->channel = \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody1TextChannelEnum::SMS;
		$this->clientRef = null;
		$this->from = "";
		$this->messageType = \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody1TextMessageTypeEnum::TEXT;
		$this->text = "";
		$this->to = "";
	}
}
