...
class ClassroomUserProfilesGuardiansDeleteRequest:
    path_params: ClassroomUserProfilesGuardiansDeletePathParams = dataclasses.field()
    query_params: ClassroomUserProfilesGuardiansDeleteQueryParams = dataclasses.field()
    security: ClassroomUserProfilesGuardiansDeleteSecurity = dataclasses.field()
