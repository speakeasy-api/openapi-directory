...
public class GetCallQoS200ApplicationXMLCalleeQosReceivingQos {
    /**
    ...
    public GetCallQoS200ApplicationXMLCalleeQosReceivingQos withAvgLoss(String avgLoss) {
    ...
    public GetCallQoS200ApplicationXMLCalleeQosReceivingQos withBitrate(String bitrate) {
    ...
    public GetCallQoS200ApplicationXMLCalleeQosReceivingQos withJitter(String jitter) {
        this.jitter = jitter;
        return this;
    }
    ...
    public GetCallQoS200ApplicationXMLCalleeQosReceivingQos withMaxLoss(String maxLoss) {
    ...
    public String mos;
    public GetCallQoS200ApplicationXMLCalleeQosReceivingQos withMos(String mos) {
        this.mos = mos;
        return this;
    }
    ...
    public GetCallQoS200ApplicationXMLCalleeQosReceivingQos withNetworkDelay(String networkDelay) {
