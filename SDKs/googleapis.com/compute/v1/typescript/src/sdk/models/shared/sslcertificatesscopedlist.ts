 ...
 */
export enum SslCertificatesScopedListWarningCodeEnum {
...
export class SslCertificatesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SslCertificatesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: SslCertificatesScopedListWarningData })
  @Expose({ name: "data" })
...
export class SslCertificatesScopedList extends SpeakeasyBase {
  /**
