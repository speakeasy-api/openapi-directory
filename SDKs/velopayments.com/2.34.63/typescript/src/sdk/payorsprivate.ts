...
export class PayorsPrivate {
   ...
   */
  createPayorLinks(
    req: shared.CreatePayorLinkRequest,
    security: operations.CreatePayorLinksSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.CreatePayorLinksResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new shared.CreatePayorLinkRequest(req);
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.CreatePayorLinksSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CreatePayorLinksResponse =
        new operations.CreatePayorLinksResponse({
