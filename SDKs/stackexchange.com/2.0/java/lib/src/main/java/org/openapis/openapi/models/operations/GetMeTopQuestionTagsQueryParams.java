...
public class GetMeTopQuestionTagsQueryParams {
    /**
    ...
    public GetMeTopQuestionTagsQueryParams withCallback(String callback) {
    ...
    public GetMeTopQuestionTagsQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public Long page;
    public GetMeTopQuestionTagsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeTopQuestionTagsQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetMeTopQuestionTagsQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
