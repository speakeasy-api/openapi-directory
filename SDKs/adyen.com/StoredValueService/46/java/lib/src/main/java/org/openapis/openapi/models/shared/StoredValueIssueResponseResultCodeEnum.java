...
/**
 * StoredValueIssueResponseResultCodeEnum - The result of the payment. Possible values:
 * 
 ...
 * 
 */
public enum StoredValueIssueResponseResultCodeEnum {
    SUCCESS("Success"),
    REFUSED("Refused"),
    ERROR("Error"),
    ...
    private StoredValueIssueResponseResultCodeEnum(String value) {
        this.value = value;
    }
}
