...
class CreateGatewayRouteRequestBody:
    ...
    spec: CreateGatewayRouteRequestBodySpec = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('spec') }})
...
class CreateGatewayRouteRequest:
    headers: CreateGatewayRouteHeaders = dataclasses.field()
    path_params: CreateGatewayRoutePathParams = dataclasses.field()
    query_params: CreateGatewayRouteQueryParams = dataclasses.field()
    request: CreateGatewayRouteRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
