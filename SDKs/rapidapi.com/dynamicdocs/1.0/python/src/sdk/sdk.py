...
from . import utils
from .pdf_generation import PDFGeneration
...
class SDK:
    r"""ADVICEment's [DynamicDocs API automates your document generation](https://advicement.io/dynamic-documents-api) and creates dynamic, optimized, interactive PDFs. Write your templates in LaTeX and call the API with JSON data to get your PDFs in seconds.
    ...
    def _init_sdks(self):
        self.pdf_generation = PDFGeneration(
            self._client,
