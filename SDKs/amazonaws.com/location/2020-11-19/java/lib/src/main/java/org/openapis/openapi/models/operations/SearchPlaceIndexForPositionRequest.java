...
public class SearchPlaceIndexForPositionRequest {
    ...
    public SearchPlaceIndexForPositionRequest(@JsonProperty("IndexName") String indexName, @JsonProperty("RequestBody") SearchPlaceIndexForPositionRequestBody requestBody) {
        this.indexName = indexName;
        this.requestBody = requestBody;
  }
}
