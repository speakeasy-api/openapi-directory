...
var EmployeeSchedules = /** @class */ (function () {
     ...
     */
    EmployeeSchedules.prototype.employeeSchedulesAll = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.EmployeeSchedulesAllRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/hris/schedules/employees/{employee_id}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.EmployeeSchedulesAllSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.EmployeeSchedulesAllResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getEmployeeSchedulesResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetEmployeeSchedulesResponse);
                    }
                    break;
