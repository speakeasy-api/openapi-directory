...
export class AddItemRequestBody3Input extends SpeakeasyBase {
  /**
...
export class AddItemRequestBody2Input extends SpeakeasyBase {
  /**
   * String representation of the unique code that this item transmits. By default this is a hexadecimal representation. This number could be so long (> 40 bytes!) that a decimal representation would be useless to generate.
   */
  @SpeakeasyMetadata()
...
export class AddItemRequestBody1Input extends SpeakeasyBase {
  /**
   * String representation of the unique code that this item transmits. By default this is a hexadecimal representation. This number could be so long (> 40 bytes!) that a decimal representation would be useless to generate.
   */
  @SpeakeasyMetadata()
