...
public class Locations {
    ...
    public org.openapis.openapi.models.operations.GETVersionLocationsFormatResponse getVersionLocationsFormat(org.openapis.openapi.models.operations.GETVersionLocationsFormatRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GETVersionLocationsFormatRequest.class, request, null);
        if (queryParams != null) {
        ...
        org.openapis.openapi.models.operations.GETVersionLocationsFormatResponse res = new org.openapis.openapi.models.operations.GETVersionLocationsFormatResponse(contentType, httpRes.statusCode()) {{
        }};
    ...
    public org.openapis.openapi.models.operations.GETVersionLocationsMarkersFormatResponse getVersionLocationsMarkersFormat(org.openapis.openapi.models.operations.GETVersionLocationsMarkersFormatRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GETVersionLocationsMarkersFormatRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.GETVersionLocationsMarkersFormatResponse res = new org.openapis.openapi.models.operations.GETVersionLocationsMarkersFormatResponse(contentType, httpRes.statusCode()) {{
        }};
        res.rawResponse = httpRes;
