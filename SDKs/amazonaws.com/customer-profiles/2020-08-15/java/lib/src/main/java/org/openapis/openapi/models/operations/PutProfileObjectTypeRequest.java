...
public class PutProfileObjectTypeRequest {
    ...
    public PutProfileObjectTypeRequest(@JsonProperty("DomainName") String domainName, @JsonProperty("ObjectTypeName") String objectTypeName, @JsonProperty("RequestBody") PutProfileObjectTypeRequestBody requestBody) {
        this.domainName = domainName;
        this.objectTypeName = objectTypeName;
        this.requestBody = requestBody;
  }
