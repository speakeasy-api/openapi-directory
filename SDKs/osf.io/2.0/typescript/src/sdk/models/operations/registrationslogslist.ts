 ...
 */
export class RegistrationsLogsListLogAttributesLogParams extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsLogsListLogAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsLogsListLogLinks extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsLogsListLogRelationships extends SpeakeasyBase {
  /**
...
export class RegistrationsLogsListLog extends SpeakeasyBase {
  /**
   * The properties of the log.
   */
  @SpeakeasyMetadata()
