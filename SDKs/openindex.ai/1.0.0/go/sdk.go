...
func (s *SDK) QueryQueryPost(ctx context.Context, request shared.QueryRequest, security operations.QueryQueryPostSecurity) (*operations.QueryQueryPostResponse, error) {
	...
	res := &operations.QueryQueryPostResponse{
