...
class ProxyV1ServiceSessionParticipant:
    ...
    proxy_identifier: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('proxy_identifier') }})
    proxy_identifier_sid: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('proxy_identifier_sid') }})
