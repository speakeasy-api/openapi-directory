...
type HomegraphDevicesSyncSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type HomegraphDevicesSyncQueryParams struct {
	// V1 error format.
...
type HomegraphDevicesSyncRequest struct {
...
type HomegraphDevicesSyncResponse struct {
	ContentType string
	StatusCode  int
