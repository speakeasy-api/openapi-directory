 ...
 */
public enum RegionInstanceGroupManagersApplyUpdatesRequestMostDisruptiveAllowedActionEnum {
    NONE("NONE"),
    REFRESH("REFRESH"),
    REPLACE("REPLACE"),
    RESTART("RESTART");
    ...
    private RegionInstanceGroupManagersApplyUpdatesRequestMostDisruptiveAllowedActionEnum(String value) {
        this.value = value;
    }
}
