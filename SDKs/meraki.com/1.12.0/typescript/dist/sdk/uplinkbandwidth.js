...
exports.UplinkBandwidth = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var UplinkBandwidth = /** @class */ (function () {
    function UplinkBandwidth(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    UplinkBandwidth.prototype.getNetworkApplianceTrafficShapingUplinkBandwidth = function (req, config) {
    ...
    **/
    UplinkBandwidth.prototype.updateNetworkApplianceTrafficShapingUplinkBandwidth = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.UplinkBandwidth = UplinkBandwidth;
