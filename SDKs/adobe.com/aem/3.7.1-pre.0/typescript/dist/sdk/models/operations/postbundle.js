...
exports.PostBundleResponse = exports.PostBundleRequest = void 0;
...
var PostBundleRequest = /** @class */ (function (_super) {
    ...
    ], PostBundleRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=name",
        }),
        __metadata("design:type", String)
    ], PostBundleRequest.prototype, "name", void 0);
...
var PostBundleResponse = /** @class */ (function (_super) {
    ...
    ], PostBundleResponse.prototype, "rawResponse", void 0);
