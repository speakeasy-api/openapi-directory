...
public class GetUsersIdTopQuestionTagsRequest {
    ...
    public GetUsersIdTopQuestionTagsRequest withCallback(String callback) {
    ...
    public GetUsersIdTopQuestionTagsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdTopQuestionTagsRequest withId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public GetUsersIdTopQuestionTagsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdTopQuestionTagsRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdTopQuestionTagsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    public GetUsersIdTopQuestionTagsRequest(@JsonProperty("id") Long id, @JsonProperty("site") String site) {
        this.id = id;
        this.site = site;
  }
}
