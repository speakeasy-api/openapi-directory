...
func (e POSTDescribeAlarmHistoryActionEnum) ToPointer() *POSTDescribeAlarmHistoryActionEnum {
	return &e
}
...
func (e *POSTDescribeAlarmHistoryActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DescribeAlarmHistory":
		*e = POSTDescribeAlarmHistoryActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTDescribeAlarmHistoryActionEnum: %v", v)
	}
}
...
func (e POSTDescribeAlarmHistoryVersionEnum) ToPointer() *POSTDescribeAlarmHistoryVersionEnum {
	return &e
}
...
func (e *POSTDescribeAlarmHistoryVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2010-08-01":
		*e = POSTDescribeAlarmHistoryVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTDescribeAlarmHistoryVersionEnum: %v", v)
	}
}
