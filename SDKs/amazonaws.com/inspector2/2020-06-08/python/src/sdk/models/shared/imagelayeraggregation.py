...
import dataclasses
from ..shared import imagelayersortby_enum as shared_imagelayersortby_enum
...
class ImageLayerAggregation:
    r"""The details that define an aggregation based on container image layers."""
    
    layer_hashes: Optional[list[shared_stringfilter.StringFilter]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('layerHashes'), 'exclude': lambda f: f is None }})  
    ...
    sort_by: Optional[shared_imagelayersortby_enum.ImageLayerSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sortBy'), 'exclude': lambda f: f is None }})  
