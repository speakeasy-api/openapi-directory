...
class ListDeployedDevicesDeviceRequest:
    ...
    r"""Filters the resulting list of Devices by a unique string identifier of the Deployment they are associated with."""  
...
class ListDeployedDevicesDeviceListDeployedDevicesDeviceResponse:
    ...
    devices: Optional[list[shared_preview_deployed_devices_fleet_device.PreviewDeployedDevicesFleetDevice]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('devices'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListDeployedDevicesDeviceListDeployedDevicesDeviceResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
