...
class GETDMTaxItemTypeFinanceInformation:
...
class GETDMTaxItemTypeTaxRateTypeEnum(str, Enum):
    r"""The type of the tax rate."""
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GETDMTaxItemType:
    r"""Container for custom fields of a Debit Taxation Item object."""
    ...
    r"""The applied amount of the taxation item."""  
    credit_amount: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('creditAmount'), 'exclude': lambda f: f is None }})
    r"""The amount of credit memos applied to the debit memo."""  
    ...
    finance_information: Optional[GETDMTaxItemTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the taxation item."""  
    ...
    r"""The amount of payments applied to the debit memo."""  
    ...
    r"""The amount of the refund on the taxation item."""  
    ...
    tax_rate_type: Optional[GETDMTaxItemTypeTaxRateTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxRateType'), 'exclude': lambda f: f is None }})
    r"""The type of the tax rate."""  
    ...
    r"""The unapplied amount of the taxation item."""  
