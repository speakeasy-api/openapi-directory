...
class GroupOwners:
    ...
    def groups_list_owners(self, request: operations.GroupsListOwnersRequest) -> operations.GroupsListOwnersResponse:
        ...
        url = utils.generate_url(operations.GroupsListOwnersRequest, base_url, '/{tenantID}/groups/{objectId}/owners', request)
        
        query_params = utils.get_query_params(operations.GroupsListOwnersRequest, request)
        ...
        res = operations.GroupsListOwnersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
