...
class UpdateEnvironmentAccountConnectionRequest:
    ...
    update_environment_account_connection_input: shared_updateenvironmentaccountconnectioninput.UpdateEnvironmentAccountConnectionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
