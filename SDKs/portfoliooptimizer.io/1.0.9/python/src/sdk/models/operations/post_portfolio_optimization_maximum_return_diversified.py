...
class PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints:
    ...
    r"""The relative tolerance over the maximum return portfolio return"""  
    ...
    r"""The relative tolerance over the maximum return portfolio volatility, if applicable"""  
...
class PostPortfolioOptimizationMaximumReturnDiversifiedRequestBody:
    ...
    constraints: Optional[PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('constraints'), 'exclude': lambda f: f is None }})  
...
class PostPortfolioOptimizationMaximumReturnDiversifiedResponse:
    ...
    post_portfolio_optimization_maximum_return_diversified_200_application_json_object: Optional[PostPortfolioOptimizationMaximumReturnDiversified200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""  
