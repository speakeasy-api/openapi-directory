...
class UpdateTemplateActiveVersionRequestBody:
    template_active_version_request: UpdateTemplateActiveVersionRequestBodyTemplateActiveVersionRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('TemplateActiveVersionRequest') }})
    

@dataclasses.dataclass
class UpdateTemplateActiveVersionRequest:
    headers: UpdateTemplateActiveVersionHeaders = dataclasses.field()
    path_params: UpdateTemplateActiveVersionPathParams = dataclasses.field()
    request: UpdateTemplateActiveVersionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
