...
import { ContainerServiceECRImagePullerRoleRequest } from "./containerserviceecrimagepullerrolerequest";
 ...
 */
export class PrivateRegistryAccessRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
