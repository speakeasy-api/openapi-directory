...
class DriveFilesInsertVisibilityEnum(str, Enum):
    r"""The visibility of the new file. This parameter is only relevant when convert=false."""
    DEFAULT = 'DEFAULT'
    PRIVATE = 'PRIVATE'
...
class DriveFilesInsertRequest:
    ...
    r"""Deprecated. Creating files in multiple folders is no longer supported."""  
    ...
    r"""Whether to pin the head revision of the uploaded file. A file can have a maximum of 200 pinned revisions."""  
