...
public class InstanceProperties {
    ...
    public InstanceProperties withSecureTags(String[] secureTags) {
    ...
    public InstanceProperties withServiceIntegrationSpecs(java.util.Map<String, ServiceIntegrationSpec> serviceIntegrationSpecs) {
