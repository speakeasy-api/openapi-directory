 ...
 */
export declare class CreateIpamResourceDiscoveryResultIpamResourceDiscoveryOperatingRegions extends SpeakeasyBase {
    regionName?: string;
}
/**
 ...
 */
export declare enum CreateIpamResourceDiscoveryResultIpamResourceDiscoveryStateEnum {
 ...
 * Describes a tag.
 */
export declare class CreateIpamResourceDiscoveryResultIpamResourceDiscoveryTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateIpamResourceDiscoveryResultIpamResourceDiscovery extends SpeakeasyBase {
    description?: string;
 ...
 * Success
 */
export declare class CreateIpamResourceDiscoveryResult extends SpeakeasyBase {
