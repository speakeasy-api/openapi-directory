...
from ..shared import transactionruleresponse as shared_transactionruleresponse
...
class GetTransactionRulesTransactionRuleIDResponse:
    ...
    transaction_rule_response: Optional[shared_transactionruleresponse.TransactionRuleResponse] = dataclasses.field(default=None)
