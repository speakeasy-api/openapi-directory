...
export class DeleteStreamingDistribution20170325Request extends SpeakeasyBase {
  /**
   * The distribution ID.
   */
...
export class DeleteStreamingDistribution20170325Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
