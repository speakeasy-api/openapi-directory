...
from ..shared import putscalingpolicyrequest as shared_putscalingpolicyrequest
from ..shared import putscalingpolicyresponse as shared_putscalingpolicyresponse
...
class PutScalingPolicyRequest:
    ...
    request: shared_putscalingpolicyrequest.PutScalingPolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class PutScalingPolicyResponse:
    ...
    put_scaling_policy_response: Optional[shared_putscalingpolicyresponse.PutScalingPolicyResponse] = dataclasses.field(default=None)
