 ...
 */
export enum BackendBucketListWarningCodeEnum {
...
export class BackendBucketListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class BackendBucketListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: BackendBucketListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class BackendBucketList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: BackendBucket })
  @Expose({ name: "items" })
  @Type(() => BackendBucket)
  items?: BackendBucket[];
