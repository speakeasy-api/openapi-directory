...
public class UpdateLocationRuleRequest {
    ...
    public UpdateLocationRuleRequest(@JsonProperty("LocationRuleUpdate") org.openapis.openapi.models.shared.LocationRuleUpdate locationRuleUpdate, @JsonProperty("id") String id) {
        this.locationRuleUpdate = locationRuleUpdate;
        this.id = id;
  }
}
