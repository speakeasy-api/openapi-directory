...
class PatientLinkReferenceResultLink:
    ...
    authentication_type: PatientLinkReferenceResultLinkAuthenticationTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authenticationType') }})  
...
class PatientLinkReferenceResult:
    ...
    link: Optional[PatientLinkReferenceResultLink] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('link'), 'exclude': lambda f: f is None }})  
