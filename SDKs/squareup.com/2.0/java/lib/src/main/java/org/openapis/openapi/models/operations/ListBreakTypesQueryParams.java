...
public class ListBreakTypesQueryParams {
    /**
     * A pointer to the next page of `BreakType` results to fetch.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=cursor")
    public String cursor;
    public ListBreakTypesQueryParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public Long limit;
    public ListBreakTypesQueryParams withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListBreakTypesQueryParams withLocationId(String locationId) {
