...
public class GetAccountsAccountIdTransactionsHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=sandbox-id")
    public String sandboxId;
    public GetAccountsAccountIdTransactionsHeaders withSandboxId(String sandboxId) {
        this.sandboxId = sandboxId;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-customer-user-agent")
    public String xCustomerUserAgent;
    public GetAccountsAccountIdTransactionsHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public GetAccountsAccountIdTransactionsHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public GetAccountsAccountIdTransactionsHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
        this.xFapiCustomerIpAddress = xFapiCustomerIpAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-fapi-interaction-id")
    public String xFapiInteractionId;
    public GetAccountsAccountIdTransactionsHeaders withXFapiInteractionId(String xFapiInteractionId) {
