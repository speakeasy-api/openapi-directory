...
var Search = /** @class */ (function () {
     ...
     *
    **/
    Search.prototype.getUsersSelectedUserSearchCode = function (req, config) {
     ...
     *
    **/
    Search.prototype.getWorkspacesWorkspaceSearchCode = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Search.prototype.searchAccount = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
