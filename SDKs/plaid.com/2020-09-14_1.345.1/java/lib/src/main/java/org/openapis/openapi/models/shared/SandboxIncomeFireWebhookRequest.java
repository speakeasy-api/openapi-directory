...
public class SandboxIncomeFireWebhookRequest {
    ...
    public SandboxIncomeFireWebhookRequest(@JsonProperty("item_id") String itemId, @JsonProperty("verification_status") SandboxIncomeFireWebhookRequestVerificationStatusEnum verificationStatus, @JsonProperty("webhook") String webhook) {
        this.itemId = itemId;
        this.verificationStatus = verificationStatus;
        this.webhook = webhook;
  }
