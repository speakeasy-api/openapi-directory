 ...
 */
export declare class DescribeFastLaunchImagesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeFastLaunchImagesRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeFastLaunchImagesRequestFilters[];
    imageIds?: string[];
    maxResults?: number;
    nextToken?: string;
}
