...
class DcimPowerFeedsList200ApplicationJSON:
    ...
    results: list[shared_powerfeed.PowerFeed] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class DcimPowerFeedsListRequest:
    query_params: DcimPowerFeedsListQueryParams = dataclasses.field()
