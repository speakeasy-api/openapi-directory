...
class DescribeDocumentClassificationJobRequest:
    ...
    describe_document_classification_job_request: shared_describedocumentclassificationjobrequest.DescribeDocumentClassificationJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
