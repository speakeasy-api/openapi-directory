...
from ..shared import predictivescalingpredefinedloadmetric as shared_predictivescalingpredefinedloadmetric
from ..shared import predictivescalingpredefinedmetricpair as shared_predictivescalingpredefinedmetricpair
from ..shared import predictivescalingpredefinedscalingmetric as shared_predictivescalingpredefinedscalingmetric
...
class PredictiveScalingMetricSpecification:
    ...
    predefined_load_metric_specification: Optional[shared_predictivescalingpredefinedloadmetric.PredictiveScalingPredefinedLoadMetric] = dataclasses.field(default=None)
    predefined_metric_pair_specification: Optional[shared_predictivescalingpredefinedmetricpair.PredictiveScalingPredefinedMetricPair] = dataclasses.field(default=None)
    predefined_scaling_metric_specification: Optional[shared_predictivescalingpredefinedscalingmetric.PredictiveScalingPredefinedScalingMetric] = dataclasses.field(default=None)
