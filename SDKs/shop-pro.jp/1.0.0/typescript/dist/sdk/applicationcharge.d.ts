...
export declare class ApplicationCharge {
     ...
     *
     */
    createUsageCharge(req: operations.CreateUsageChargeRequest, security: operations.CreateUsageChargeSecurity, config?: AxiosRequestConfig): Promise<operations.CreateUsageChargeResponse>;
    /**
     * アプリ内課金データの作成
     *
     * @remarks
     ...
     *
     */
    postApplicationCharge(req: operations.PostApplicationChargeRequestBody, security: operations.PostApplicationChargeSecurity, config?: AxiosRequestConfig): Promise<operations.PostApplicationChargeResponse>;
}
