...
func (e CreateRecommenderXAmzTargetEnum) ToPointer() *CreateRecommenderXAmzTargetEnum {
	return &e
}
...
func (e *CreateRecommenderXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonPersonalize.CreateRecommender":
		*e = CreateRecommenderXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateRecommenderXAmzTargetEnum: %v", v)
	}
}

type CreateRecommenderRequest struct {
	CreateRecommenderRequest shared.CreateRecommenderRequest `request:"mediaType=application/json"`
