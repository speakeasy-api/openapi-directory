...
class DescribeEndpointSettingsResponse:
    ...
    endpoint_settings: Optional[list[shared_endpointsetting.EndpointSetting]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EndpointSettings'), 'exclude': lambda f: f is None }})  
