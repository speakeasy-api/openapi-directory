...
class BillbeeInterfacesBillbeeAPIModelCreateCustomerAPIModelInput:
    ...
    address: Optional[shared_billbee_interfaces_billbeeapi_model_customeraddressapimodel.BillbeeInterfacesBillbeeAPIModelCustomerAddressAPIModel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Address'), 'exclude': lambda f: f is None }, 'form': { 'field_name': 'Address', 'json': True }})
