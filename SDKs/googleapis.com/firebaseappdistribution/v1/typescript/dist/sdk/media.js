...
var Media = /** @class */ (function () {
     ...
     */
    Media.prototype.firebaseappdistributionMediaUpload = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FirebaseappdistributionMediaUploadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{app}/releases:upload", req);
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.FirebaseappdistributionMediaUploadSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.FirebaseappdistributionMediaUploadResponse({
