...
class CreateGraphqlAPIRequestBodyAuthenticationTypeEnum(str, Enum):
    r"""The authentication type: API key, Identity and Access Management (IAM), OpenID Connect (OIDC), Amazon Cognito user pools, or Lambda."""
    API_KEY = 'API_KEY'
    AWS_IAM = 'AWS_IAM'
...
class CreateGraphqlAPIRequestBody:
    ...
    authentication_type: CreateGraphqlAPIRequestBodyAuthenticationTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authenticationType') }})
    r"""The authentication type: API key, Identity and Access Management (IAM), OpenID Connect (OIDC), Amazon Cognito user pools, or Lambda."""  
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})
    r"""A user-supplied name for the <code>GraphqlApi</code>."""  
    ...
    lambda_authorizer_config: Optional[CreateGraphqlAPIRequestBodyLambdaAuthorizerConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lambdaAuthorizerConfig'), 'exclude': lambda f: f is None }})
    r"""A <code>LambdaAuthorizerConfig</code> specifies how to authorize AppSync API access when using the <code>AWS_LAMBDA</code> authorizer mode. Be aware that an AppSync API can have only one Lambda authorizer configured at a time."""  
    log_config: Optional[CreateGraphqlAPIRequestBodyLogConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logConfig'), 'exclude': lambda f: f is None }})
    r"""The Amazon CloudWatch Logs configuration."""  
    open_id_connect_config: Optional[CreateGraphqlAPIRequestBodyOpenIDConnectConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('openIDConnectConfig'), 'exclude': lambda f: f is None }})
    r"""Describes an OpenID Connect (OIDC) configuration."""  
    tags: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tags'), 'exclude': lambda f: f is None }})
    r"""A map with keys of <code>TagKey</code> objects and values of <code>TagValue</code> objects."""  
    user_pool_config: Optional[CreateGraphqlAPIRequestBodyUserPoolConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('userPoolConfig'), 'exclude': lambda f: f is None }})
    r"""Describes an Amazon Cognito user pool configuration."""  
...
class CreateGraphqlAPIRequest:
    ...
    request_body: CreateGraphqlAPIRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
