 ...
 */
export enum CreateSubnetRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateSubnetRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateSubnetRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateSubnetRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateSubnetRequestTagSpecificationsTags })
  tags?: CreateSubnetRequestTagSpecificationsTags[];
}

export class CreateSubnetRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: CreateSubnetRequestTagSpecifications })
