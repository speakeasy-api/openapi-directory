...
exports.DeleteEmployeeSecretResponse = exports.DeleteEmployeeSecretRequest = void 0;
...
var DeleteEmployeeSecretRequest = /** @class */ (function (_super) {
    ...
    ], DeleteEmployeeSecretRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeleteEmployeeSecretRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], DeleteEmployeeSecretRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeleteEmployeeSecretRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SecretId",
        }),
        __metadata("design:type", String)
    ], DeleteEmployeeSecretRequest.prototype, "secretId", void 0);
    return DeleteEmployeeSecretRequest;
}(utils_1.SpeakeasyBase));
exports.DeleteEmployeeSecretRequest = DeleteEmployeeSecretRequest;
var DeleteEmployeeSecretResponse = /** @class */ (function (_super) {
    ...
    ], DeleteEmployeeSecretResponse.prototype, "rawResponse", void 0);
    return DeleteEmployeeSecretResponse;
}(utils_1.SpeakeasyBase));
exports.DeleteEmployeeSecretResponse = DeleteEmployeeSecretResponse;
