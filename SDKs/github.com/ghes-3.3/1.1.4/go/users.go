...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#add-an-email-address-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#check-if-a-user-follows-another-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#check-if-a-person-is-followed-by-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#create-a-gpg-key-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#create-a-public-ssh-key-for-the-authenticated-user - API method documentation
...
// This endpoint is accessible with the `user` scope.
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#delete-an-email-address-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#delete-a-gpg-key-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#delete-a-public-ssh-key-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#follow-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#get-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#get-a-user - API method documentation
...
//
// ```
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#get-contextual-information-for-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#get-a-gpg-key-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#get-a-public-ssh-key-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#list-users - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#list-email-addresses-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#list-the-people-the-authenticated-user-follows - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#list-followers-of-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#list-followers-of-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#list-the-people-a-user-follows - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#list-gpg-keys-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#list-gpg-keys-for-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#list-public-email-addresses-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#list-public-keys-for-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#list-public-ssh-keys-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users#unfollow-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.3/rest/reference/users/#update-the-authenticated-user - API method documentation
