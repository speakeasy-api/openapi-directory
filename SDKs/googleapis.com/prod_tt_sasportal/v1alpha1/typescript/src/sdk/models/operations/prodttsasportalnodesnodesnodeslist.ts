...
export class ProdTtSasportalNodesNodesNodesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ProdTtSasportalNodesNodesNodesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ProdTtSasportalNodesNodesNodesListSecurity extends SpeakeasyBase {
...
export class ProdTtSasportalNodesNodesNodesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ProdTtSasportalNodesNodesNodesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
