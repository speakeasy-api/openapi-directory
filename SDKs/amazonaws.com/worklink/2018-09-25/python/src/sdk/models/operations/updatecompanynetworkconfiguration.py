...
class UpdateCompanyNetworkConfigurationHeaders:
...
class UpdateCompanyNetworkConfigurationRequest:
    headers: UpdateCompanyNetworkConfigurationHeaders = dataclasses.field()
    request: UpdateCompanyNetworkConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
