...
public class GetDeviceSwitchPortStatusesPacketsQueryParams {
    /**
     * The beginning of the timespan for the data. The maximum lookback period is 1 day from today.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=t0")
    public String t0;
    public GetDeviceSwitchPortStatusesPacketsQueryParams withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public GetDeviceSwitchPortStatusesPacketsQueryParams withTimespan(Float timespan) {
