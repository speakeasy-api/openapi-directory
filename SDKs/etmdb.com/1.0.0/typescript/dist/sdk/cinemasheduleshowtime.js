...
exports.CinemaSheduleShowtime = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var CinemaSheduleShowtime = /** @class */ (function () {
    function CinemaSheduleShowtime(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CinemaSheduleShowtime.prototype.cinemaSheduleShowtimeSearchRead = function (req, config) {
     ...
     * [ref]: https://etmdb.com/en/movie-list/-updated_date
    **/
    CinemaSheduleShowtime.prototype.cinemaSheduleShowtimeSearchallRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.CinemaSheduleShowtime = CinemaSheduleShowtime;
