...
public class FetchAvailablePhoneNumberCountrySecurity {
    ...
    public FetchAvailablePhoneNumberCountrySecurity withPassword(String password) {
    ...
    public FetchAvailablePhoneNumberCountrySecurity withUsername(String username) {
