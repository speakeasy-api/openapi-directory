...
class MembershipFeatureState:
    ...
    metering: Optional[shared_meteringmembershipstate.MeteringMembershipState] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metering'), 'exclude': lambda f: f is None }})
    r"""**Metering**: Per-Membership Feature State."""  
    policycontroller: Optional[shared_policycontrollermembershipstate.PolicyControllerMembershipState] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('policycontroller'), 'exclude': lambda f: f is None }})
