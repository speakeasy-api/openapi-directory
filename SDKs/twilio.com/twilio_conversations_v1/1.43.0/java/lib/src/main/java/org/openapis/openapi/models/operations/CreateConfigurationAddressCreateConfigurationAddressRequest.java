...
public class CreateConfigurationAddressCreateConfigurationAddressRequest {
    ...
    public CreateConfigurationAddressCreateConfigurationAddressRequest withAutoCreationType(org.openapis.openapi.models.shared.ConfigurationAddressEnumAutoCreationTypeEnum autoCreationType) {
    ...
    public CreateConfigurationAddressCreateConfigurationAddressRequest withAutoCreationWebhookMethod(org.openapis.openapi.models.shared.ConfigurationAddressEnumMethodEnum autoCreationWebhookMethod) {
    ...
    public org.openapis.openapi.models.shared.ConfigurationAddressEnumTypeEnum type;

    public CreateConfigurationAddressCreateConfigurationAddressRequest withType(org.openapis.openapi.models.shared.ConfigurationAddressEnumTypeEnum type) {
        this.type = type;
        return this;
    }
    
    public CreateConfigurationAddressCreateConfigurationAddressRequest(@JsonProperty("Address") String address, @JsonProperty("Type") org.openapis.openapi.models.shared.ConfigurationAddressEnumTypeEnum type) {
        this.address = address;
        this.type = type;
  }
}
