...
class GoogleCloudVideointelligenceV1p3beta1VideoContext:
    ...
    explicit_content_detection_config: Optional[shared_googlecloudvideointelligencev1p3beta1_explicitcontentdetectionconfig.GoogleCloudVideointelligenceV1p3beta1ExplicitContentDetectionConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('explicitContentDetectionConfig'), 'exclude': lambda f: f is None }})
    r"""Config for EXPLICIT_CONTENT_DETECTION."""  
    face_detection_config: Optional[shared_googlecloudvideointelligencev1p3beta1_facedetectionconfig.GoogleCloudVideointelligenceV1p3beta1FaceDetectionConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('faceDetectionConfig'), 'exclude': lambda f: f is None }})
    r"""Config for FACE_DETECTION."""  
    label_detection_config: Optional[shared_googlecloudvideointelligencev1p3beta1_labeldetectionconfig.GoogleCloudVideointelligenceV1p3beta1LabelDetectionConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('labelDetectionConfig'), 'exclude': lambda f: f is None }})
    r"""Config for LABEL_DETECTION."""  
    object_tracking_config: Optional[shared_googlecloudvideointelligencev1p3beta1_objecttrackingconfig.GoogleCloudVideointelligenceV1p3beta1ObjectTrackingConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('objectTrackingConfig'), 'exclude': lambda f: f is None }})
    r"""Config for OBJECT_TRACKING."""  
    person_detection_config: Optional[shared_googlecloudvideointelligencev1p3beta1_persondetectionconfig.GoogleCloudVideointelligenceV1p3beta1PersonDetectionConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('personDetectionConfig'), 'exclude': lambda f: f is None }})
    r"""Config for PERSON_DETECTION."""  
    segments: Optional[list[shared_googlecloudvideointelligencev1p3beta1_videosegment.GoogleCloudVideointelligenceV1p3beta1VideoSegment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('segments'), 'exclude': lambda f: f is None }})
    ...
    shot_change_detection_config: Optional[shared_googlecloudvideointelligencev1p3beta1_shotchangedetectionconfig.GoogleCloudVideointelligenceV1p3beta1ShotChangeDetectionConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shotChangeDetectionConfig'), 'exclude': lambda f: f is None }})
    r"""Config for SHOT_CHANGE_DETECTION."""  
    speech_transcription_config: Optional[shared_googlecloudvideointelligencev1p3beta1_speechtranscriptionconfig.GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('speechTranscriptionConfig'), 'exclude': lambda f: f is None }})
    r"""Config for SPEECH_TRANSCRIPTION."""  
    text_detection_config: Optional[shared_googlecloudvideointelligencev1p3beta1_textdetectionconfig.GoogleCloudVideointelligenceV1p3beta1TextDetectionConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('textDetectionConfig'), 'exclude': lambda f: f is None }})
