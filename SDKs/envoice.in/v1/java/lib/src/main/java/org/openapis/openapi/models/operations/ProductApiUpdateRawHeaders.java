...
public class ProductApiUpdateRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ProductApiUpdateRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public ProductApiUpdateRawHeaders withXAuthSecret(String xAuthSecret) {
