...
class GetWebhookSubscriptionsRequest
{
    /**
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetWebhookSubscriptionsSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?GetWebhookSubscriptionsSortEnum $sort = null;
