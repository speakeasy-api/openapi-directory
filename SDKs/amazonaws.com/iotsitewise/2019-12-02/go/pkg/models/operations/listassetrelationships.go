...
func (e ListAssetRelationshipsTraversalTypeEnum) ToPointer() *ListAssetRelationshipsTraversalTypeEnum {
	return &e
}
...
func (e *ListAssetRelationshipsTraversalTypeEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "PATH_TO_ROOT":
		*e = ListAssetRelationshipsTraversalTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListAssetRelationshipsTraversalTypeEnum: %v", v)
	}
}
