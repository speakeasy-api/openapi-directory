...
from ..shared import externalterminalaction as shared_externalterminalaction
...
class GetCompaniesCompanyIDTerminalActionsActionIDSecurity:
...
class GetCompaniesCompanyIDTerminalActionsActionIDRequest:
    ...
    r"""The unique identifier of the terminal action."""  
    company_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'companyId', 'style': 'simple', 'explode': False }})
    r"""The unique identifier of the company account."""  
    

@dataclasses.dataclass
class GetCompaniesCompanyIDTerminalActionsActionIDResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    external_terminal_action: Optional[shared_externalterminalaction.ExternalTerminalAction] = dataclasses.field(default=None)
