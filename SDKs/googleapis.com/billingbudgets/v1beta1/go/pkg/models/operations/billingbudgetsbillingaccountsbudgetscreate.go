...
type BillingbudgetsBillingAccountsBudgetsCreateRequest struct {
	...
	GoogleCloudBillingBudgetsV1beta1CreateBudgetRequestInput *shared.GoogleCloudBillingBudgetsV1beta1CreateBudgetRequestInput `request:"mediaType=application/json"`
	// OAuth access token.
