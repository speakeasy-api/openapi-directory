...
type CloudtasksProjectsLocationsQueuesTasksCreateSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type CloudtasksProjectsLocationsQueuesTasksCreateRequest struct {
	// V1 error format.
...
type CloudtasksProjectsLocationsQueuesTasksCreateResponse struct {
	ContentType string
	StatusCode  int
