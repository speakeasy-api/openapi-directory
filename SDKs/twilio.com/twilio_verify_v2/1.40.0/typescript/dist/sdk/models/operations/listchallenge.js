...
exports.ListChallengeResponse = exports.ListChallengeListChallengeResponse = exports.ListChallengeListChallengeResponseMeta = exports.ListChallengeRequest = exports.ListChallengeSecurity = exports.ListChallengeServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListChallengeServerList = ["https://verify.twilio.com"];
var ListChallengeSecurity = /** @class */ (function (_super) {
    ...
    ], ListChallengeSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListChallengeSecurity.prototype, "username", void 0);
...
var ListChallengeRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListChallengeRequest.prototype, "factorSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=Identity",
        }),
        __metadata("design:type", String)
    ], ListChallengeRequest.prototype, "identity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Order" }),
        __metadata("design:type", String)
    ], ListChallengeRequest.prototype, "order", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListChallengeRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListChallengeRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListChallengeRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListChallengeRequest.prototype, "serviceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListChallengeRequest.prototype, "status", void 0);
...
var ListChallengeListChallengeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.VerifyV2ServiceEntityChallenge }),
        (0, class_transformer_1.Expose)({ name: "challenges" }),
        (0, class_transformer_1.Type)(function () { return shared.VerifyV2ServiceEntityChallenge; }),
        __metadata("design:type", Array)
    ], ListChallengeListChallengeResponse.prototype, "challenges", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListChallengeListChallengeResponseMeta; }),
...
var ListChallengeResponse = /** @class */ (function (_super) {
    ...
    ], ListChallengeResponse.prototype, "rawResponse", void 0);
