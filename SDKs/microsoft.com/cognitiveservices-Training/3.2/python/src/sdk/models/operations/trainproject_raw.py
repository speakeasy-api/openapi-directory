...
class TrainProjectRawTrainingTypeEnum(str, Enum):
...
class TrainProjectRawRequest:
    ...
    training_type: Optional[TrainProjectRawTrainingTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'trainingType', 'style': 'form', 'explode': True }})
    r"""The type of training to use to train the project (default: Regular)."""  
    

@dataclasses.dataclass
class TrainProjectRawResponse:
