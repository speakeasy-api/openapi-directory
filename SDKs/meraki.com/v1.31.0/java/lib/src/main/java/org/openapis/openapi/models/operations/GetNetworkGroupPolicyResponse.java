...
public class GetNetworkGroupPolicyResponse {
    ...
    public GetNetworkGroupPolicyResponse withStatusCode(Integer statusCode) {
    ...
    public GetNetworkGroupPolicyResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
