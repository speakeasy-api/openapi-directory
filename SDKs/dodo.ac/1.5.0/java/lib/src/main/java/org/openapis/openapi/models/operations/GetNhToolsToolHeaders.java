...
public class GetNhToolsToolHeaders {
    /**
    ...
    public GetNhToolsToolHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhToolsToolHeaders withXApiKey(String xApiKey) {
