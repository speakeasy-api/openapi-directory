...
class NHBugSouth
{
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Shared\NHBugSouthAvailabilityArray> $availabilityArray
     */
	#[\JMS\Serializer\Annotation\SerializedName('availability_array')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Shared\NHBugSouthAvailabilityArray>')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\NHBugSouthTimesByMonth $timesByMonth
     */
	#[\JMS\Serializer\Annotation\SerializedName('times_by_month')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\NHBugSouthTimesByMonth')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?NHBugSouthTimesByMonth $timesByMonth = null;
