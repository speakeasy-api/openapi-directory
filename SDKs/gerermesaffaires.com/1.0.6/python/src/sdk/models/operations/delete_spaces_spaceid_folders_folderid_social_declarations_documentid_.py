...
class DeleteSpacesSpaceIDFoldersFolderIDSocialDeclarationsDocumentIDRequest:
...
@dataclasses.dataclass
class DeleteSpacesSpaceIDFoldersFolderIDSocialDeclarationsDocumentIDResponse:
