...
exports.BucketCountByEncryptionType = void 0;
...
var BucketCountByEncryptionType = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=kmsManaged" }),
        __metadata("design:type", Number)
    ], BucketCountByEncryptionType.prototype, "kmsManaged", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=s3Managed" }),
        __metadata("design:type", Number)
    ], BucketCountByEncryptionType.prototype, "s3Managed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=unencrypted" }),
        __metadata("design:type", Number)
