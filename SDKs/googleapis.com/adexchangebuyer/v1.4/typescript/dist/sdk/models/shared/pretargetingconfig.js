...
exports.PretargetingConfig = exports.PretargetingConfigVideoPlayerSizes = exports.PretargetingConfigPlacements = exports.PretargetingConfigExcludedPlacements = exports.PretargetingConfigDimensions = void 0;
...
var PretargetingConfigVideoPlayerSizes = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=minHeight" }),
        __metadata("design:type", String)
    ], PretargetingConfigVideoPlayerSizes.prototype, "minHeight", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=minWidth" }),
        __metadata("design:type", String)
    ], PretargetingConfigVideoPlayerSizes.prototype, "minWidth", void 0);
    return PretargetingConfigVideoPlayerSizes;
}(utils_1.SpeakeasyBase));
exports.PretargetingConfigVideoPlayerSizes = PretargetingConfigVideoPlayerSizes;
var PretargetingConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=userIdentifierDataRequired" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=videoPlayerSizes", elemType: PretargetingConfigVideoPlayerSizes }),
        __metadata("design:type", Array)
