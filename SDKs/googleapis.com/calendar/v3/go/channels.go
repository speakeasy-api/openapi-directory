...
func (s *channels) CalendarChannelsStop(ctx context.Context, request operations.CalendarChannelsStopRequest, security operations.CalendarChannelsStopSecurity) (*operations.CalendarChannelsStopResponse, error) {
	baseURL := s.serverURL
