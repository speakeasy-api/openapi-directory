...
exports.NestingLevelSuggestionState = void 0;
...
var NestingLevelSuggestionState = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "bulletAlignmentSuggested" }),
        __metadata("design:type", Boolean)
    ], NestingLevelSuggestionState.prototype, "bulletAlignmentSuggested", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "glyphFormatSuggested" }),
        __metadata("design:type", Boolean)
    ], NestingLevelSuggestionState.prototype, "glyphFormatSuggested", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "glyphSymbolSuggested" }),
        __metadata("design:type", Boolean)
    ], NestingLevelSuggestionState.prototype, "glyphSymbolSuggested", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "glyphTypeSuggested" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "startNumberSuggested" }),
        __metadata("design:type", Boolean)
...
exports.NestingLevelSuggestionState = NestingLevelSuggestionState;
