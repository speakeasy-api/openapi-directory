...
export class ViberServiceMessage {
  ...
  getVSMAccount(
    ...
    security: operations.GetVSMAccountSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.GetVSMAccountSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetVSMAccountResponse =
        new operations.GetVSMAccountResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.vsmAccountResponse = utils.objectToClass(
              httpRes?.data,
              shared.VSMAccountResponse
            );
          }
          break;
