...
class CustomMetrics:
    r"""A custom metric collection lists Analytics custom metrics to which the user has access. Each resource in the collection corresponds to a single Analytics custom metric."""
    
    items: Optional[list[shared_custommetric.CustomMetric]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
    r"""Collection of custom metrics."""  
    ...
    r"""Link to next page for this custom metric collection."""  
    ...
    r"""Link to previous page for this custom metric collection."""  
