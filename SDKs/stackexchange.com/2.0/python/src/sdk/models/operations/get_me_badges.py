...
class GetMeBadgesOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetMeBadgesSortEnum(str, Enum):
    RANK = "rank"
    NAME = "name"
    TYPE = "type"
...
class GetMeBadgesQueryParams:
    ...
    order: Optional[GetMeBadgesOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeBadgesSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetMeBadgesRequest:
    query_params: GetMeBadgesQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetMeBadgesResponse:
