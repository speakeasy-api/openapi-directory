...
var FormFieldDefinition = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=AlternateAnchor" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=BottomAnchor" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=HorizontalAlignmentType" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=LeftAnchor" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TargetDigitCount" }),
        __metadata("design:type", Number)
    ], FormFieldDefinition.prototype, "targetDigitCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TargetFieldHeight_Relative" }),
        __metadata("design:type", Number)
    ], FormFieldDefinition.prototype, "targetFieldHeightRelative", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TargetFieldHorizontalAdjustment" }),
        __metadata("design:type", Number)
    ], FormFieldDefinition.prototype, "targetFieldHorizontalAdjustment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TargetFieldVerticalAdjustment" }),
        __metadata("design:type", Number)
    ], FormFieldDefinition.prototype, "targetFieldVerticalAdjustment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TargetFieldWidth_Relative" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=VerticalAlignmentType" }),
        __metadata("design:type", String)
