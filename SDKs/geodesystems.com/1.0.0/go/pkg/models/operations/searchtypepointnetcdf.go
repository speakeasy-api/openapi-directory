...
type SearchTypePointNetcdfQueryParams struct {
...
type SearchTypePointNetcdfRequest struct {
	QueryParams SearchTypePointNetcdfQueryParams
}

type SearchTypePointNetcdfResponse struct {
	ContentType string
	StatusCode  int
