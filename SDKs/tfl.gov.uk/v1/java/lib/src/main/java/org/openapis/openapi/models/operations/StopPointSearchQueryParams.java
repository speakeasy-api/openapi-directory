...
public class StopPointSearchQueryParams {
    /**
    ...
    public StopPointSearchQueryParams withFaresOnly(Boolean faresOnly) {
    ...
    public StopPointSearchQueryParams withIncludeHubs(Boolean includeHubs) {
    ...
    public String[] lines;
    public StopPointSearchQueryParams withLines(String[] lines) {
        this.lines = lines;
        return this;
    }
    ...
    public StopPointSearchQueryParams withMaxResults(Integer maxResults) {
    ...
    public String[] modes;
    public StopPointSearchQueryParams withModes(String[] modes) {
        this.modes = modes;
        return this;
    }
    ...
    public StopPointSearchQueryParams withTflOperatedNationalRailStationsOnly(Boolean tflOperatedNationalRailStationsOnly) {
