 ...
 */
export declare class DescribeInternetGatewaysRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeInternetGatewaysRequest extends SpeakeasyBase {
    dryRun?: boolean;
