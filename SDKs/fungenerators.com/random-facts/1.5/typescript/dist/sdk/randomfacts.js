...
var RandomFacts = /** @class */ (function () {
    ...
    **/
    RandomFacts.prototype.getFact = function (req, config) {
    ...
    **/
    RandomFacts.prototype.getFactCategories = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    RandomFacts.prototype.getFactRandom = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    RandomFacts.prototype.getFactSearch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
