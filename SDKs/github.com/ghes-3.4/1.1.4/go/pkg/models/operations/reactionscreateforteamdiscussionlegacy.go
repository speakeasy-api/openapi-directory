...
func (e ReactionsCreateForTeamDiscussionLegacyRequestBodyContentEnum) ToPointer() *ReactionsCreateForTeamDiscussionLegacyRequestBodyContentEnum {
	return &e
}
...
func (e *ReactionsCreateForTeamDiscussionLegacyRequestBodyContentEnum) UnmarshalJSON(data []byte) error {
	...
	case "rocket":
		fallthrough
	case "eyes":
		*e = ReactionsCreateForTeamDiscussionLegacyRequestBodyContentEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ReactionsCreateForTeamDiscussionLegacyRequestBodyContentEnum: %v", v)
	}
}
