...
from ..shared import nhfossilgroup as shared_nhfossilgroup
from typing import Optional


@dataclasses.dataclass
class GetNhFossilsGroupsFossilGroupRequest:
    ...
    fossil_group: str = dataclasses.field(metadata={'path_param': { 'field_name': 'fossil_group', 'style': 'simple', 'explode': False }})
    r"""The name of the fossil group you wish to retrieve information about."""  
...
@dataclasses.dataclass
class GetNhFossilsGroupsFossilGroupResponse:
    ...
    nh_fossil_group: Optional[shared_nhfossilgroup.NHFossilGroup] = dataclasses.field(default=None)
