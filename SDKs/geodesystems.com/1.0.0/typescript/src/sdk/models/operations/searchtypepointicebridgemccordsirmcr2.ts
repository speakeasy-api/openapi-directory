...
export class SearchTypePointIcebridgeMccordsIrmcr2Request extends SpeakeasyBase {
  /**
...
export class SearchTypePointIcebridgeMccordsIrmcr2Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
