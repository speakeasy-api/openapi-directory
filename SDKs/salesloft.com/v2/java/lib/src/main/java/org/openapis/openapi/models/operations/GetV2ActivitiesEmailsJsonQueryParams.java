...
public class GetV2ActivitiesEmailsJsonQueryParams {
    /**
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withActionId(Long[] actionId) {
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withBounced(Boolean bounced) {
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withCadenceId(Long[] cadenceId) {
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withCrmActivityId(Long[] crmActivityId) {
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withEmailAddresses(String[] emailAddresses) {
    ...
    public Long[] ids;
    public GetV2ActivitiesEmailsJsonQueryParams withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withOneOff(Boolean oneOff) {
        this.oneOff = oneOff;
        return this;
    }
    ...
    public Long page;
    public GetV2ActivitiesEmailsJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2ActivitiesEmailsJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withPersonId(Long[] personId) {
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withPersonalization(String[] personalization) {
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withScopedFields(String[] scopedFields) {
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withSentAt(String[] sentAt) {
        this.sentAt = sentAt;
        return this;
    }
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withStatus(String[] status) {
        this.status = status;
        return this;
    }
    ...
    public Long[] stepId;
    public GetV2ActivitiesEmailsJsonQueryParams withStepId(Long[] stepId) {
        this.stepId = stepId;
        return this;
    }
    ...
    public GetV2ActivitiesEmailsJsonQueryParams withUpdatedAt(String[] updatedAt) {
    ...
    public Long[] userId;
    public GetV2ActivitiesEmailsJsonQueryParams withUserId(Long[] userId) {
        this.userId = userId;
        return this;
    }
