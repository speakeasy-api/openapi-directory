 ...
 */
export enum InstanceGroupAggregatedListWarningCodeEnum {
...
export class InstanceGroupAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceGroupAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceGroupAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class InstanceGroupAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceGroupsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, InstanceGroupsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], InstanceGroupsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
