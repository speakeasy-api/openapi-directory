...
class GetGeneHomologAssociationsHomologyTypeEnum(str, Enum):
    r"""P (paralog), O (Ortholog) or LDO (least-diverged ortholog)"""
    P = 'P'
    O = 'O'
    LDO = 'LDO'
...
class GetGeneHomologAssociationsRequest:
    ...
    r"""id, e.g. NCBIGene:3630. Equivalent IDs can be used with same results"""  
    ...
    r"""Taxon CURIE of homolog, e.g. NCBITaxon:9606 (Can be an ancestral node in the ontology; includes inferred associations by default)"""  
