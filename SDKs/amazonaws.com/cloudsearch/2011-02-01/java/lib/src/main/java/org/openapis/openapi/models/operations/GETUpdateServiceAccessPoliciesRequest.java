...
public class GETUpdateServiceAccessPoliciesRequest {
    ...
    public GETUpdateServiceAccessPoliciesRequest(@JsonProperty("AccessPolicies") String accessPolicies, @JsonProperty("Action") GETUpdateServiceAccessPoliciesActionEnum action, @JsonProperty("DomainName") String domainName, @JsonProperty("Version") GETUpdateServiceAccessPoliciesVersionEnum version) {
        this.accessPolicies = accessPolicies;
        this.action = action;
        this.domainName = domainName;
        this.version = version;
