...
class Reactions:
    ...
    def reactions_create_for_commit_comment(self, request: operations.ReactionsCreateForCommitCommentRequest) -> operations.ReactionsCreateForCommitCommentResponse:
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#create-reaction-for-a-commit-comment - API method documentation
        """
    ...
    def reactions_create_for_issue(self, request: operations.ReactionsCreateForIssueRequest) -> operations.ReactionsCreateForIssueResponse:
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#create-reaction-for-an-issue - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_create_for_issue_comment(self, request: operations.ReactionsCreateForIssueCommentRequest) -> operations.ReactionsCreateForIssueCommentResponse:
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#create-reaction-for-an-issue-comment - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_create_for_pull_request_review_comment(self, request: operations.ReactionsCreateForPullRequestReviewCommentRequest) -> operations.ReactionsCreateForPullRequestReviewCommentResponse:
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#create-reaction-for-a-pull-request-review-comment - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_create_for_release(self, request: operations.ReactionsCreateForReleaseRequest) -> operations.ReactionsCreateForReleaseResponse:
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions/#create-reaction-for-a-release - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_create_for_team_discussion_comment_in_org(self, request: operations.ReactionsCreateForTeamDiscussionCommentInOrgRequest) -> operations.ReactionsCreateForTeamDiscussionCommentInOrgResponse:
        ...
        **Note:** You can also specify a team by `org_id` and `team_id` using the route `POST /organizations/:org_id/team/:team_id/discussions/:discussion_number/comments/:comment_number/reactions`.
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#create-reaction-for-a-team-discussion-comment - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_create_for_team_discussion_comment_legacy(self, request: operations.ReactionsCreateForTeamDiscussionCommentLegacyRequest) -> operations.ReactionsCreateForTeamDiscussionCommentLegacyResponse:
        ...
        **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new \"[Create reaction for a team discussion comment](https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#create-reaction-for-a-team-discussion-comment)\" endpoint.
        ...
        Create a reaction to a [team discussion comment](https://docs.github.com/enterprise-server@3.7/rest/reference/teams#discussion-comments). OAuth access tokens require the `write:discussion` [scope](https://docs.github.com/enterprise-server@3.7/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/). A response with an HTTP `200` status means that you already added the reaction type to this team discussion comment.
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions/#create-reaction-for-a-team-discussion-comment-legacy - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_create_for_team_discussion_in_org(self, request: operations.ReactionsCreateForTeamDiscussionInOrgRequest) -> operations.ReactionsCreateForTeamDiscussionInOrgResponse:
        ...
        **Note:** You can also specify a team by `org_id` and `team_id` using the route `POST /organizations/:org_id/team/:team_id/discussions/:discussion_number/reactions`.
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#create-reaction-for-a-team-discussion - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_create_for_team_discussion_legacy(self, request: operations.ReactionsCreateForTeamDiscussionLegacyRequest) -> operations.ReactionsCreateForTeamDiscussionLegacyResponse:
        ...
        **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Create reaction for a team discussion`](https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#create-reaction-for-a-team-discussion) endpoint.
        ...
        Create a reaction to a [team discussion](https://docs.github.com/enterprise-server@3.7/rest/reference/teams#discussions). OAuth access tokens require the `write:discussion` [scope](https://docs.github.com/enterprise-server@3.7/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/). A response with an HTTP `200` status means that you already added the reaction type to this team discussion.
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions/#create-reaction-for-a-team-discussion-legacy - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_delete_for_commit_comment(self, request: operations.ReactionsDeleteForCommitCommentRequest) -> operations.ReactionsDeleteForCommitCommentResponse:
        ...
        **Note:** You can also specify a repository by `repository_id` using the route `DELETE /repositories/:repository_id/comments/:comment_id/reactions/:reaction_id`.
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#delete-a-commit-comment-reaction - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_delete_for_issue(self, request: operations.ReactionsDeleteForIssueRequest) -> operations.ReactionsDeleteForIssueResponse:
        ...
        **Note:** You can also specify a repository by `repository_id` using the route `DELETE /repositories/:repository_id/issues/:issue_number/reactions/:reaction_id`.
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#delete-an-issue-reaction - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_delete_for_issue_comment(self, request: operations.ReactionsDeleteForIssueCommentRequest) -> operations.ReactionsDeleteForIssueCommentResponse:
        ...
        **Note:** You can also specify a repository by `repository_id` using the route `DELETE delete /repositories/:repository_id/issues/comments/:comment_id/reactions/:reaction_id`.
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#delete-an-issue-comment-reaction - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_delete_for_pull_request_comment(self, request: operations.ReactionsDeleteForPullRequestCommentRequest) -> operations.ReactionsDeleteForPullRequestCommentResponse:
        ...
        **Note:** You can also specify a repository by `repository_id` using the route `DELETE /repositories/:repository_id/pulls/comments/:comment_id/reactions/:reaction_id.`
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#delete-a-pull-request-comment-reaction - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_delete_for_release(self, request: operations.ReactionsDeleteForReleaseRequest) -> operations.ReactionsDeleteForReleaseResponse:
        ...
        **Note:** You can also specify a repository by `repository_id` using the route `DELETE delete /repositories/:repository_id/releases/:release_id/reactions/:reaction_id`.
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions/#delete-a-release-reaction - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_delete_for_team_discussion(self, request: operations.ReactionsDeleteForTeamDiscussionRequest) -> operations.ReactionsDeleteForTeamDiscussionResponse:
        ...
        **Note:** You can also specify a team or organization with `team_id` and `org_id` using the route `DELETE /organizations/:org_id/team/:team_id/discussions/:discussion_number/reactions/:reaction_id`.
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#delete-team-discussion-reaction - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_delete_for_team_discussion_comment(self, request: operations.ReactionsDeleteForTeamDiscussionCommentRequest) -> operations.ReactionsDeleteForTeamDiscussionCommentResponse:
        ...
        **Note:** You can also specify a team or organization with `team_id` and `org_id` using the route `DELETE /organizations/:org_id/team/:team_id/discussions/:discussion_number/comments/:comment_number/reactions/:reaction_id`.
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#delete-team-discussion-comment-reaction - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_list_for_commit_comment(self, request: operations.ReactionsListForCommitCommentRequest) -> operations.ReactionsListForCommitCommentResponse:
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#list-reactions-for-a-commit-comment - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_list_for_issue(self, request: operations.ReactionsListForIssueRequest) -> operations.ReactionsListForIssueResponse:
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#list-reactions-for-an-issue - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_list_for_issue_comment(self, request: operations.ReactionsListForIssueCommentRequest) -> operations.ReactionsListForIssueCommentResponse:
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#list-reactions-for-an-issue-comment - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_list_for_pull_request_review_comment(self, request: operations.ReactionsListForPullRequestReviewCommentRequest) -> operations.ReactionsListForPullRequestReviewCommentResponse:
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#list-reactions-for-a-pull-request-review-comment - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_list_for_release(self, request: operations.ReactionsListForReleaseRequest) -> operations.ReactionsListForReleaseResponse:
        ...
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions/#list-reactions-for-a-release - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_list_for_team_discussion_comment_in_org(self, request: operations.ReactionsListForTeamDiscussionCommentInOrgRequest) -> operations.ReactionsListForTeamDiscussionCommentInOrgResponse:
        ...
        **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/:org_id/team/:team_id/discussions/:discussion_number/comments/:comment_number/reactions`.
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#list-reactions-for-a-team-discussion-comment - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_list_for_team_discussion_comment_legacy(self, request: operations.ReactionsListForTeamDiscussionCommentLegacyRequest) -> operations.ReactionsListForTeamDiscussionCommentLegacyResponse:
        ...
        **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List reactions for a team discussion comment`](https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#list-reactions-for-a-team-discussion-comment) endpoint.
        ...
        List the reactions to a [team discussion comment](https://docs.github.com/enterprise-server@3.7/rest/reference/teams#discussion-comments). OAuth access tokens require the `read:discussion` [scope](https://docs.github.com/enterprise-server@3.7/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions/#list-reactions-for-a-team-discussion-comment-legacy - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_list_for_team_discussion_in_org(self, request: operations.ReactionsListForTeamDiscussionInOrgRequest) -> operations.ReactionsListForTeamDiscussionInOrgResponse:
        ...
        **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/:org_id/team/:team_id/discussions/:discussion_number/reactions`.
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#list-reactions-for-a-team-discussion - API method documentation
        """
        base_url = self._server_url
    ...
    def reactions_list_for_team_discussion_legacy(self, request: operations.ReactionsListForTeamDiscussionLegacyRequest) -> operations.ReactionsListForTeamDiscussionLegacyResponse:
        ...
        **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List reactions for a team discussion`](https://docs.github.com/enterprise-server@3.7/rest/reference/reactions#list-reactions-for-a-team-discussion) endpoint.
        ...
        List the reactions to a [team discussion](https://docs.github.com/enterprise-server@3.7/rest/reference/teams#discussions). OAuth access tokens require the `read:discussion` [scope](https://docs.github.com/enterprise-server@3.7/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
        https://docs.github.com/enterprise-server@3.7/rest/reference/reactions/#list-reactions-for-a-team-discussion-legacy - API method documentation
        """
        base_url = self._server_url
