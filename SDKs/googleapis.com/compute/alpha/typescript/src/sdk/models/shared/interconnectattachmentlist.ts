 ...
 */
export enum InterconnectAttachmentListWarningCodeEnum {
...
export class InterconnectAttachmentListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InterconnectAttachmentListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InterconnectAttachmentListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class InterconnectAttachmentList extends SpeakeasyBase {
  /**
