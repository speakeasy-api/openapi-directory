...
public class PostV3PayeesPayeeIdRemoteIdUpdateRequest {
    ...
    public PostV3PayeesPayeeIdRemoteIdUpdateRequest(@JsonProperty("UpdateRemoteIdRequestV3") org.openapis.openapi.models.shared.UpdateRemoteIdRequestV3 updateRemoteIdRequestV3, @JsonProperty("payeeId") String payeeId) {
        this.updateRemoteIdRequestV3 = updateRemoteIdRequestV3;
        this.payeeId = payeeId;
  }
}
