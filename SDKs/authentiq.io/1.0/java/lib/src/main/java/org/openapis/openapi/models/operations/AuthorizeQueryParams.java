...
public class AuthorizeQueryParams {
    ...
    public AuthorizeQueryParams withDisplay(String display) {
    ...
    public Long maxAge;
    public AuthorizeQueryParams withMaxAge(Long maxAge) {
        this.maxAge = maxAge;
        return this;
    }
    ...
    public String nonce;
    public AuthorizeQueryParams withNonce(String nonce) {
        this.nonce = nonce;
        return this;
    }
    ...
    public AuthorizeQueryParams withPrompt(String prompt) {
        this.prompt = prompt;
        return this;
    }
    ...
    public AuthorizeQueryParams withResponseMode(String responseMode) {
    ...
    public AuthorizeQueryParams withResponseType(String responseType) {
    ...
    public AuthorizeQueryParams withUiLocales(String uiLocales) {
