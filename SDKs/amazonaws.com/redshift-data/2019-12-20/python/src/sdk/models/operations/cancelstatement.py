...
class CancelStatementRequest:
    headers: CancelStatementHeaders = dataclasses.field()
    request: shared_cancelstatementrequest.CancelStatementRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
