...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            StorageCreateFileRequestBody req = new StorageCreateFileRequestBody("dolores") {{
                read = new String[]{{
                    add("quam"),
                    add("dolor"),
                    add("vero"),
            ...
            StorageCreateFileResponse res = sdk.storage.storageCreateFile(req, new StorageCreateFileSecurity("voluptatem", "porro", "consequuntur") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            StorageDeleteFileRequest req = new StorageDeleteFileRequest("blanditiis");            

            StorageDeleteFileResponse res = sdk.storage.storageDeleteFile(req, new StorageDeleteFileSecurity("error", "eaque", "occaecati") {{
                jwt = "YOUR_API_KEY_HERE";
                key = "YOUR_API_KEY_HERE";
                project = "YOUR_API_KEY_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            StorageGetFileRequest req = new StorageGetFileRequest("rerum");            

            StorageGetFileResponse res = sdk.storage.storageGetFile(req, new StorageGetFileSecurity("adipisci", "asperiores", "earum") {{
                jwt = "YOUR_API_KEY_HERE";
                key = "YOUR_API_KEY_HERE";
                project = "YOUR_API_KEY_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            StorageGetFileDownloadRequest req = new StorageGetFileDownloadRequest("modi");            

            StorageGetFileDownloadResponse res = sdk.storage.storageGetFileDownload(req, new StorageGetFileDownloadSecurity("iste", "dolorum", "deleniti") {{
                jwt = "YOUR_API_KEY_HERE";
                key = "YOUR_API_KEY_HERE";
                project = "YOUR_API_KEY_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            StorageGetFilePreviewRequest req = new StorageGetFilePreviewRequest("pariatur") {{
                background = "provident";
                borderColor = "nobis";
                borderRadius = 730122;
                borderWidth = 964490;
                gravity = "quaerat";
            ...
            StorageGetFilePreviewResponse res = sdk.storage.storageGetFilePreview(req, new StorageGetFilePreviewSecurity("ipsum", "hic", "excepturi") {{
                jwt = "YOUR_API_KEY_HERE";
                key = "YOUR_API_KEY_HERE";
                project = "YOUR_API_KEY_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            StorageGetFileViewRequest req = new StorageGetFileViewRequest("cum");            

            StorageGetFileViewResponse res = sdk.storage.storageGetFileView(req, new StorageGetFileViewSecurity("voluptate", "dignissimos", "reiciendis") {{
                jwt = "YOUR_API_KEY_HERE";
                key = "YOUR_API_KEY_HERE";
                project = "YOUR_API_KEY_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            StorageListFilesResponse res = sdk.storage.storageListFiles(req, new StorageListFilesSecurity("ipsa", "ipsa", "iure") {{
                jwt = "YOUR_API_KEY_HERE";
                key = "YOUR_API_KEY_HERE";
                project = "YOUR_API_KEY_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            StorageUpdateFileRequest req = new StorageUpdateFileRequest("odio") {{
            ...
            StorageUpdateFileResponse res = sdk.storage.storageUpdateFile(req, new StorageUpdateFileSecurity("sit", "fugiat", "ab") {{
                jwt = "YOUR_API_KEY_HERE";
                key = "YOUR_API_KEY_HERE";
                project = "YOUR_API_KEY_HERE";
            }});
