...
SERVERS = [
    ...
    r"""The Amazon CloudSearch Domain multi-region endpoint"""
    "https://cloudsearchdomain.{region}.amazonaws.com",
    r"""The Amazon CloudSearch Domain multi-region endpoint"""
    "http://cloudsearchdomain.{region}.amazonaws.com.cn",
    r"""The Amazon CloudSearch Domain endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    r"""<p>You use the AmazonCloudSearch2013 API to upload documents to a search domain and search those documents. </p> <p>The endpoints for submitting <code>UploadDocuments</code>, <code>Search</code>, and <code>Suggest</code> requests are domain-specific. To get the endpoints for your domain, use the Amazon CloudSearch configuration service <code>DescribeDomains</code> action. The domain endpoints are also displayed on the domain dashboard in the Amazon CloudSearch console. You submit suggest requests to the search endpoint. </p> <p>For more information, see the <a href=\\"http://docs.aws.amazon.com/cloudsearch/latest/developerguide\\">Amazon CloudSearch Developer Guide</a>.</p>
    ...
    def search(self, request: operations.SearchRequest) -> operations.SearchResponse:
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SearchException])
    ...
    def suggest(self, request: operations.SuggestRequest) -> operations.SuggestResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.SuggestRequest, request)
        ...
        res = operations.SuggestResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def upload_documents(self, request: operations.UploadDocumentsRequest) -> operations.UploadDocumentsResponse:
        ...
        query_params = utils.get_query_params(operations.UploadDocumentsRequest, request)
        ...
        res = operations.UploadDocumentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UploadDocumentsResponse])
                res.upload_documents_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DocumentServiceException])
