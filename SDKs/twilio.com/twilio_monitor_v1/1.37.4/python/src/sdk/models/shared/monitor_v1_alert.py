...
class MonitorV1Alert:
    ...
    request_method: Optional[MonitorV1AlertRequestMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('request_method') }})
