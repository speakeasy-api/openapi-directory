...
public class ListBrandVettingQueryParams {
    ...
    public Long page;
    public ListBrandVettingQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListBrandVettingQueryParams withPageToken(String pageToken) {
    ...
    public ListBrandVettingQueryParams withVettingProvider(org.openapis.openapi.models.shared.BrandVettingEnumVettingProviderEnum vettingProvider) {
