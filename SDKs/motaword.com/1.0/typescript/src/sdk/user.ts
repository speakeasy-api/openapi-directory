...
export class User {
  ...
  approveVendorApplication(
    ...
    const url: string = utils.generateURL(baseURL, "/{userId}/approve", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.ApproveVendorApplicationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  deleteUserAccount(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/delete-account", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DeleteUserAccountResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  downgradeProofreader(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DowngradeProofreaderResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  downgradeUserProofreader(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/downgrade-proofreader", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DowngradeUserProofreaderResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  **/
  freezeAccount(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.FreezeAccountResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  **/
  freezeUserAccount(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/freeze-account", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.FreezeUserAccountResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  **/
  getEarnings(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetEarningsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  getPaymentInfo(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetPaymentInfoResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.paymentInfo = httpRes?.data;
            }
            break;
          case httpRes?.status == 404:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  getResponsivity(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetResponsivityResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.responsivityList = httpRes?.data;
            }
            break;
          case httpRes?.status == 400:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  getThisUserGroups(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/user-groups", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetThisUserGroupsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  getUser(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}", req.pathParams);
  ...
  **/
  getUserEarnings(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/earnings", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetUserEarningsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.earnings = httpRes?.data;
  ...
  **/
  getUserPaymentInfo(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/payment", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetUserPaymentInfoResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.paymentInfo = httpRes?.data;
  ...
  **/
  getUserPermissions(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/permissions", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetUserPermissionsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.permissionList = httpRes?.data;
  ...
  **/
  getUserPopularPairs(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/stats/popular-pairs", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetUserPopularPairsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.popularLanguagePairs = httpRes?.data;
            }
            break;
          case httpRes?.status == 404:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  getUserProjectStats(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/stats/projects", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetUserProjectStatsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.clientProjectStats = httpRes?.data;
            }
            break;
          case httpRes?.status == 404:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  getUserResponsivity(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/responsivity", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetUserResponsivityResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.responsivityList = httpRes?.data;
  ...
  **/
  getUserStats(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/stats", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetUserStatsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.stats = httpRes?.data;
  ...
  **/
  logLocation(
    req: operations.LogLocationRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.LogLocationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.LogLocationRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.LogLocationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  makeProofreader(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.MakeProofreaderResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  makeUserProofreader(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/make-proofreader", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.MakeUserProofreaderResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  rejectVendorApplication(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/reject", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.RejectVendorApplicationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  **/
  sendEmailConfirmation(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/resend-email-confirmation";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.SendEmailConfirmationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.sendEmailConfirmation200ApplicationJSONObject = httpRes?.data;
            }
            break;
        }
  ...
  **/
  sendPasswordReminder(
    req: operations.SendPasswordReminderRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.SendPasswordReminderResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.SendPasswordReminderRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/users/send-password-reminder";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.SendPasswordReminderResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  **/
  sendUserEmailConfirmation(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/resend-email-confirmation", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.SendUserEmailConfirmationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.sendUserEmailConfirmation200ApplicationJSONObject = httpRes?.data;
            }
            break;
          case httpRes?.status == 202:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.sendUserEmailConfirmation202ApplicationJSONObject = httpRes?.data;
            }
            break;
          case httpRes?.status == 400:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  subscribeNotification(
    req: operations.SubscribeNotificationRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.SubscribeNotificationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.SubscribeNotificationRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.SubscribeNotificationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  subscribeUserNotification(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/notifications/subscribe", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.SubscribeUserNotificationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  suspendUser(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/suspend", req.pathParams);
  ...
  **/
  unfreezeAccount(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UnfreezeAccountResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  **/
  unfreezeUserAccount(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/unfreeze-account", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UnfreezeUserAccountResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  unsubscribeNotification(
    req: operations.UnsubscribeNotificationRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UnsubscribeNotificationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UnsubscribeNotificationRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/notifications/unsubscribe";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UnsubscribeNotificationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  unsubscribeUserNotification(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/notifications/unsubscribe", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UnsubscribeUserNotificationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  **/
  updateMe(
    req: operations.UpdateMeRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UpdateMeResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UpdateMeRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UpdateMeResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.user = httpRes?.data;
  ...
  **/
  updatePassword(
    req: operations.UpdatePasswordRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UpdatePasswordResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UpdatePasswordRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UpdatePasswordResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  **/
  updatePaymentInfo(
    req: operations.UpdatePaymentInfoRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UpdatePaymentInfoResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UpdatePaymentInfoRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UpdatePaymentInfoResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.paymentInfo = httpRes?.data;
  ...
  **/
  updateUserPaymentInfo(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UpdateUserPaymentInfoResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  uploadProfilePicture(
    req: operations.UploadProfilePictureRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UploadProfilePictureResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UploadProfilePictureRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UploadProfilePictureResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
  ...
  uploadUserProfilePicture(
    req: operations.UploadUserProfilePictureRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UploadUserProfilePictureResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UploadUserProfilePictureRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{userId}/profile-picture", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UploadUserProfilePictureResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operationStatus = httpRes?.data;
