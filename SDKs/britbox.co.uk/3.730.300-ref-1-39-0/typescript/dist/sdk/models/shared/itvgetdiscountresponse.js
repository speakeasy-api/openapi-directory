...
exports.ItvGetDiscountResponse = void 0;
...
var ItvGetDiscountResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "initialCost" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "offerdurationperiod" }),
        __metadata("design:type", String)
...
exports.ItvGetDiscountResponse = ItvGetDiscountResponse;
