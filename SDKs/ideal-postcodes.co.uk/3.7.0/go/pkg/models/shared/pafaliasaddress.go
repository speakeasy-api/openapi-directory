...
type PafAliasAddressCountryEnum string

const (
	PafAliasAddressCountryEnumEngland         PafAliasAddressCountryEnum = "England"
	PafAliasAddressCountryEnumScotland        PafAliasAddressCountryEnum = "Scotland"
	PafAliasAddressCountryEnumWales           PafAliasAddressCountryEnum = "Wales"
	PafAliasAddressCountryEnumNorthernIreland PafAliasAddressCountryEnum = "Northern Ireland"
	PafAliasAddressCountryEnumJersey          PafAliasAddressCountryEnum = "Jersey"
	PafAliasAddressCountryEnumGuernsey        PafAliasAddressCountryEnum = "Guernsey"
	PafAliasAddressCountryEnumIsleOfMan       PafAliasAddressCountryEnum = "Isle of Man"
)

func (e *PafAliasAddressCountryEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Guernsey":
		fallthrough
	case "Isle of Man":
		*e = PafAliasAddressCountryEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PafAliasAddressCountryEnum: %s", s)
	}
}

type PafAliasAddressCountryIsoEnum string

const (
	PafAliasAddressCountryIsoEnumGbr PafAliasAddressCountryIsoEnum = "GBR"
	PafAliasAddressCountryIsoEnumImn PafAliasAddressCountryIsoEnum = "IMN"
	PafAliasAddressCountryIsoEnumJey PafAliasAddressCountryIsoEnum = "JEY"
	PafAliasAddressCountryIsoEnumGgy PafAliasAddressCountryIsoEnum = "GGY"
)

func (e *PafAliasAddressCountryIsoEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "JEY":
		fallthrough
	case "GGY":
		*e = PafAliasAddressCountryIsoEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PafAliasAddressCountryIsoEnum: %s", s)
	}
}

type PafAliasAddressCountryIso2Enum string

const (
	PafAliasAddressCountryIso2EnumGb PafAliasAddressCountryIso2Enum = "GB"
	PafAliasAddressCountryIso2EnumIm PafAliasAddressCountryIso2Enum = "IM"
	PafAliasAddressCountryIso2EnumJe PafAliasAddressCountryIso2Enum = "JE"
	PafAliasAddressCountryIso2EnumGg PafAliasAddressCountryIso2Enum = "GG"
)

func (e *PafAliasAddressCountryIso2Enum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "JE":
		fallthrough
	case "GG":
		*e = PafAliasAddressCountryIso2Enum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PafAliasAddressCountryIso2Enum: %s", s)
	}
}

type PafAliasAddressDatasetEnum string

const (
	PafAliasAddressDatasetEnumPafa PafAliasAddressDatasetEnum = "pafa"
)

func (e *PafAliasAddressDatasetEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	switch s {
	case "pafa":
		*e = PafAliasAddressDatasetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PafAliasAddressDatasetEnum: %s", s)
	}
}

type PafAliasAddressLanguageEnum string

const (
	PafAliasAddressLanguageEnumEn PafAliasAddressLanguageEnum = "en"
)

func (e *PafAliasAddressLanguageEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	switch s {
	case "en":
		*e = PafAliasAddressLanguageEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PafAliasAddressLanguageEnum: %s", s)
	}
}
...
type PafAliasAddress struct {
	...
	Country        PafAliasAddressCountryEnum     `json:"country"`
	CountryIso     PafAliasAddressCountryIsoEnum  `json:"country_iso"`
	CountryIso2    PafAliasAddressCountryIso2Enum `json:"country_iso_2"`
	...
	Dataset    PafAliasAddressDatasetEnum `json:"dataset"`
	...
	ID       string                      `json:"id"`
	Language PafAliasAddressLanguageEnum `json:"language"`
