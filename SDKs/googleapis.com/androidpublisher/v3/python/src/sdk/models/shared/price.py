...
class Price:
    ...
    r"""3 letter Currency code, as defined by ISO 4217. See java/com/google/common/money/CurrencyCode.java"""  
    ...
    r"""Price in 1/million of the currency base unit, represented as a string."""  
