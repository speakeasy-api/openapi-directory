...
class GETDeleteVpcEndpointServiceConfigurationsRequest:
    ...
    action: GETDeleteVpcEndpointServiceConfigurationsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    service_id: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'ServiceId', 'style': 'form', 'explode': True }})
    r"""The IDs of the services."""  
    version: GETDeleteVpcEndpointServiceConfigurationsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
