...
class RuntimeconfigProjectsConfigsWaitersCreatePathParams:
    parent: str = dataclasses.field(metadata={'path_param': { 'field_name': 'parent', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class RuntimeconfigProjectsConfigsWaitersCreateQueryParams:
...
class RuntimeconfigProjectsConfigsWaitersCreateRequest:
    path_params: RuntimeconfigProjectsConfigsWaitersCreatePathParams = dataclasses.field()
    query_params: RuntimeconfigProjectsConfigsWaitersCreateQueryParams = dataclasses.field()
    security: RuntimeconfigProjectsConfigsWaitersCreateSecurity = dataclasses.field()
    request: Optional[shared_waiter.Waiter] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
