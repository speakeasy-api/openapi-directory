...
exports.CategoriesEssentials = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var CategoriesEssentials = /** @class */ (function () {
    function CategoriesEssentials(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CategoriesEssentials.prototype.getCategories = function (req, config) {
    ...
    **/
    CategoriesEssentials.prototype.getCategory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.CategoriesEssentials = CategoriesEssentials;
