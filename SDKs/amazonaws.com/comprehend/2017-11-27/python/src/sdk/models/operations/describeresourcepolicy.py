...
class DescribeResourcePolicyXAmzTargetEnum(str, Enum):
    COMPREHEND_20171127_DESCRIBE_RESOURCE_POLICY = 'Comprehend_20171127.DescribeResourcePolicy'


@dataclasses.dataclass
class DescribeResourcePolicyRequest:
    
    describe_resource_policy_request: shared_describeresourcepolicyrequest.DescribeResourcePolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
