...
public class ClientApiNewRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ClientApiNewRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public ClientApiNewRawHeaders withXAuthSecret(String xAuthSecret) {
