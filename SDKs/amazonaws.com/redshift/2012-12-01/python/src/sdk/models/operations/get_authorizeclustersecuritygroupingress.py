...
class GetAuthorizeClusterSecurityGroupIngressRequest:
    headers: GetAuthorizeClusterSecurityGroupIngressHeaders = dataclasses.field()
    query_params: GetAuthorizeClusterSecurityGroupIngressQueryParams = dataclasses.field()
