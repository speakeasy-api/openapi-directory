...
public class ListHostsRequest {
    ...
    public ListHostsRequest withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public ListHostsRequest withEndTime(Double endTime) {
    ...
    public ListHostsRequest withSize(Double size) {
        this.size = size;
        return this;
    }
    ...
    public ListHostsRequest withStartTime(Double startTime) {
        this.startTime = startTime;
        return this;
    }
    
    public ListHostsRequest(){}
}
