...
export class DriveGroupsAllSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DriveGroupsAllRequest extends SpeakeasyBase {
  /**
...
export class DriveGroupsAllResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
