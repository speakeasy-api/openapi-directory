...
@dataclasses.dataclass
class OrdersUpdateSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class OrdersUpdateRequest:
    headers: OrdersUpdateHeaders = dataclasses.field()
    path_params: OrdersUpdatePathParams = dataclasses.field()
    query_params: OrdersUpdateQueryParams = dataclasses.field()
    request: shared_order.OrderInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: OrdersUpdateSecurity = dataclasses.field()
