...
export declare class DataplexProjectsLocationsDataTaxonomiesAttributesListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class DataplexProjectsLocationsDataTaxonomiesAttributesListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class DataplexProjectsLocationsDataTaxonomiesAttributesListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
