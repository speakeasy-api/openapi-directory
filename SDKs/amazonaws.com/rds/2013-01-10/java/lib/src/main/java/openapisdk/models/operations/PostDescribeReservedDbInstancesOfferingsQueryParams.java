...
public class PostDescribeReservedDbInstancesOfferingsQueryParams {
    ...
    public PostDescribeReservedDbInstancesOfferingsQueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=MaxRecords")
    public String maxRecords;
    public PostDescribeReservedDbInstancesOfferingsQueryParams withMaxRecords(String maxRecords) {
