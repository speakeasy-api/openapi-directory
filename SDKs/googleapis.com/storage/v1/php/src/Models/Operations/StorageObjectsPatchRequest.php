...
class StorageObjectsPatchRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\StorageObjectsPatchPredefinedACLEnum $predefinedAcl
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=predefinedAcl')]
    public ?StorageObjectsPatchPredefinedACLEnum $predefinedAcl = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\StorageObjectsPatchProjectionEnum $projection
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=projection')]
    public ?StorageObjectsPatchProjectionEnum $projection = null;
