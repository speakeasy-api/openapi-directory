...
export class RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsCollectSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsCollectRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsCollectResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
