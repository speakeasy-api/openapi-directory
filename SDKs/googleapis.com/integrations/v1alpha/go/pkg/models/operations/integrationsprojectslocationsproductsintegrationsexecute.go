...
type IntegrationsProjectsLocationsProductsIntegrationsExecuteRequest struct {
	...
	GoogleCloudIntegrationsV1alphaExecuteIntegrationsRequest *shared.GoogleCloudIntegrationsV1alphaExecuteIntegrationsRequest `request:"mediaType=application/json"`
	// OAuth access token.
