...
class UpdateActiveDirectoryConfigRequest
{
    ...
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $ldapUsersDomain = null;
    ...
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $serverAdminName = null;
    ...
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $serverAdminPassword = null;
	...
	public function __construct()
	{
		...
		$this->ldapUsersDomain = null;
		$this->sdsImportGroup = null;
		$this->serverAdminName = null;
		$this->serverAdminPassword = null;
		$this->serverIp = null;
