...
} from "./devicetypeassignedtargetingoptiondetails";
...
export class AssignedTargetingOption extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "assignedTargetingOptionIdAlias" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "sessionPositionDetails" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "youtubeChannelDetails" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "youtubeVideoDetails" })
...
export class AssignedTargetingOptionInput extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "deviceTypeDetails" })
  @Type(() => DeviceTypeAssignedTargetingOptionDetailsInput)
