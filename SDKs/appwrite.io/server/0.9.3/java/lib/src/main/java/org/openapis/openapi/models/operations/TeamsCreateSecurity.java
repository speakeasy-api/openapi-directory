...
public class TeamsCreateSecurity {
    ...
    public TeamsCreateSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public TeamsCreateSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public TeamsCreateSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public TeamsCreateSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
