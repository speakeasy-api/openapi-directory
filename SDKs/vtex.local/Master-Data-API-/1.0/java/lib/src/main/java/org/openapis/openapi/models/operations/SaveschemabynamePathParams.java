...
public class SaveschemabynamePathParams {
    /**
    ...
    public SaveschemabynamePathParams withDataEntityName(String dataEntityName) {
    ...
    public SaveschemabynamePathParams withSchemaName(String schemaName) {
