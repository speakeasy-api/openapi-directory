...
class APIV2010AccountCallCallNotificationRequestMethodEnum(str, Enum):
    HEAD = "HEAD"
    GET = "GET"
    POST = "POST"
    PATCH = "PATCH"
...
class APIV2010AccountCallCallNotification:
    ...
    request_method: Optional[APIV2010AccountCallCallNotificationRequestMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('request_method') }})
