...
export class PostAuthorizableKeystoreRequest extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=currentPassword",
  })
  ...
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=keyPassword",
  })
  keyPassword?: string;

  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=keyStorePass",
  })
  keyStorePass?: string;

  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=newAlias",
  })
  newAlias?: string;
