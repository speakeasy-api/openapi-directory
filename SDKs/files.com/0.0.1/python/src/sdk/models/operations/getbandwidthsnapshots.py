...
from ..shared import bandwidthsnapshotentity as shared_bandwidthsnapshotentity


@dataclasses.dataclass
class GetBandwidthSnapshotsQueryParams:
...
class GetBandwidthSnapshotsRequest:
    query_params: GetBandwidthSnapshotsQueryParams = dataclasses.field()
...
class GetBandwidthSnapshotsResponse:
    ...
    bandwidth_snapshot_entities: Optional[list[shared_bandwidthsnapshotentity.BandwidthSnapshotEntity]] = dataclasses.field(default=None)
