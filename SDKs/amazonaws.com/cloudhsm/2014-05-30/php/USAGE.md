...
try {
    ...
    $request->addTagsToResourceRequest->resourceArn = 'corrupti';
    $request->addTagsToResourceRequest->tagList = [
        new Tag(),
        new Tag(),
        new Tag(),
    ];
    ...
    $request->xAmzTarget = AddTagsToResourceXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_ADD_TAGS_TO_RESOURCE;
