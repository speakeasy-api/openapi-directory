...
class PostStartVpcEndpointServicePrivateDNSVerificationQueryParams:
    action: PostStartVpcEndpointServicePrivateDNSVerificationActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostStartVpcEndpointServicePrivateDNSVerificationVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostStartVpcEndpointServicePrivateDNSVerificationRequest:
    headers: PostStartVpcEndpointServicePrivateDNSVerificationHeaders = dataclasses.field()
    query_params: PostStartVpcEndpointServicePrivateDNSVerificationQueryParams = dataclasses.field()
