...
public class DeleteDatabaseRequest {
    ...
    public DeleteDatabaseRequest(@JsonProperty("databaseNamePathParameter") String databaseNamePathParameter, @JsonProperty("database_nameQueryParameter") String databaseNameQueryParameter) {
        this.databaseNamePathParameter = databaseNamePathParameter;
        this.databaseNameQueryParameter = databaseNameQueryParameter;
  }
}
