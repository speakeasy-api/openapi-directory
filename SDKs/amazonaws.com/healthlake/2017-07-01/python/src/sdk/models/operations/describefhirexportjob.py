...
class DescribeFHIRExportJobRequest:
    ...
    describe_fhir_export_job_request: shared_describefhirexportjobrequest.DescribeFHIRExportJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
