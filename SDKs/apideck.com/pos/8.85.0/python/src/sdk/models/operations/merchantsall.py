...
from ..shared import getmerchantsresponse as shared_getmerchantsresponse
...
@dataclasses.dataclass
class MerchantsAllSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class MerchantsAllRequest:
    headers: MerchantsAllHeaders = dataclasses.field()
    query_params: MerchantsAllQueryParams = dataclasses.field()
    security: MerchantsAllSecurity = dataclasses.field()
    

@dataclasses.dataclass
class MerchantsAllResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    get_merchants_response: Optional[shared_getmerchantsresponse.GetMerchantsResponse] = dataclasses.field(default=None)
