...
from ..shared import itemdownloadablelist as shared_itemdownloadablelist
...
class GetItemDownloadablesResponse:
    ...
    item_downloadable_list: Optional[shared_itemdownloadablelist.ItemDownloadableList] = dataclasses.field(default=None)
