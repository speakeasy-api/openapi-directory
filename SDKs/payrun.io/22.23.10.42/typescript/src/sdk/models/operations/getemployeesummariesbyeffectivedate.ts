...
export class GetEmployeeSummariesByEffectiveDateRequest extends SpeakeasyBase {
  /**
...
export class GetEmployeeSummariesByEffectiveDateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
