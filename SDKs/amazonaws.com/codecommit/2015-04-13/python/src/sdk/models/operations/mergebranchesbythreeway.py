...
class MergeBranchesByThreeWayRequest:
    ...
    merge_branches_by_three_way_input: shared_mergebranchesbythreewayinput.MergeBranchesByThreeWayInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
