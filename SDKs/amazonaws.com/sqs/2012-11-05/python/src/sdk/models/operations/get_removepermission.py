...
class GetRemovePermissionQueryParams:
    action: GetRemovePermissionActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    label: str = dataclasses.field(metadata={'query_param': { 'field_name': 'Label', 'style': 'form', 'explode': True }})
    version: GetRemovePermissionVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRemovePermissionRequest:
    headers: GetRemovePermissionHeaders = dataclasses.field()
    path_params: GetRemovePermissionPathParams = dataclasses.field()
    query_params: GetRemovePermissionQueryParams = dataclasses.field()
