...
class DeleteAssessmentRunRequest:
    headers: DeleteAssessmentRunHeaders = dataclasses.field()
    request: shared_deleteassessmentrunrequest.DeleteAssessmentRunRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
