...
exports.DistrictAdmins = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var DistrictAdmins = /** @class */ (function () {
    function DistrictAdmins(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    DistrictAdmins.prototype.getDistrictAdmin = function (req, config) {
    ...
    **/
    DistrictAdmins.prototype.getDistrictAdmins = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.DistrictAdmins = DistrictAdmins;
