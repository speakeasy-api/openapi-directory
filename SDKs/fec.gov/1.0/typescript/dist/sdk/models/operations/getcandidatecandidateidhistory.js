...
exports.GetCandidateCandidateIdHistoryResponse = exports.GetCandidateCandidateIdHistoryRequest = void 0;
...
var GetCandidateCandidateIdHistoryRequest = /** @class */ (function (_super) {
    ...
    ], GetCandidateCandidateIdHistoryRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=candidate_id",
        }),
        __metadata("design:type", String)
    ], GetCandidateCandidateIdHistoryRequest.prototype, "candidateId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=election_full",
        }),
        __metadata("design:type", Boolean)
    ], GetCandidateCandidateIdHistoryRequest.prototype, "electionFull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetCandidateCandidateIdHistoryRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetCandidateCandidateIdHistoryRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetCandidateCandidateIdHistoryRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_hide_null",
        }),
        __metadata("design:type", Boolean)
    ], GetCandidateCandidateIdHistoryRequest.prototype, "sortHideNull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_null_only",
        }),
        __metadata("design:type", Boolean)
    ], GetCandidateCandidateIdHistoryRequest.prototype, "sortNullOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_nulls_last",
        }),
        __metadata("design:type", Boolean)
    ], GetCandidateCandidateIdHistoryRequest.prototype, "sortNullsLast", void 0);
...
var GetCandidateCandidateIdHistoryResponse = /** @class */ (function (_super) {
    ...
    ], GetCandidateCandidateIdHistoryResponse.prototype, "rawResponse", void 0);
