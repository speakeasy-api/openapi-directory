...
class CreateVpcEndpointServiceConfigurationRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateVpcEndpointServiceConfigurationRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateVpcEndpointServiceConfigurationRequestTagSpecifications:
    ...
    resource_type: Optional[CreateVpcEndpointServiceConfigurationRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateVpcEndpointServiceConfigurationRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateVpcEndpointServiceConfigurationRequest:
    ...
    supported_ip_address_types: Optional[list[str]] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateVpcEndpointServiceConfigurationRequestTagSpecifications]] = dataclasses.field(default=None)  
