...
exports.GETSelectResponse = exports.GETSelectRequest = exports.GETSelectVersionEnum = exports.GETSelectActionEnum = void 0;
...
var GETSelectRequest = /** @class */ (function (_super) {
    ...
    ], GETSelectRequest.prototype, "awsAccessKeyId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Action",
        }),
        __metadata("design:type", String)
    ], GETSelectRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ConsistentRead",
        }),
        __metadata("design:type", Boolean)
    ], GETSelectRequest.prototype, "consistentRead", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=NextToken",
        }),
        __metadata("design:type", String)
    ], GETSelectRequest.prototype, "nextToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SelectExpression",
        }),
        __metadata("design:type", String)
    ], GETSelectRequest.prototype, "selectExpression", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Signature",
        }),
        __metadata("design:type", String)
    ], GETSelectRequest.prototype, "signature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SignatureMethod",
        }),
        __metadata("design:type", String)
    ], GETSelectRequest.prototype, "signatureMethod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SignatureVersion",
        }),
        __metadata("design:type", String)
    ], GETSelectRequest.prototype, "signatureVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Timestamp",
        }),
        __metadata("design:type", String)
    ], GETSelectRequest.prototype, "timestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], GETSelectRequest.prototype, "version", void 0);
...
var GETSelectResponse = /** @class */ (function (_super) {
    ...
    ], GETSelectResponse.prototype, "rawResponse", void 0);
