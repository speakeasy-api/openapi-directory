...
export class GkehubProjectsLocationsNamespacesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkehubProjectsLocationsNamespacesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GkehubProjectsLocationsNamespacesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
