...
class RemoveLayerVersionPermissionRequest:
    headers: RemoveLayerVersionPermissionHeaders = dataclasses.field()
    path_params: RemoveLayerVersionPermissionPathParams = dataclasses.field()
    query_params: RemoveLayerVersionPermissionQueryParams = dataclasses.field()
