...
class DeleteAutoSnapshotRequest:
    ...
    delete_auto_snapshot_request: shared_deleteautosnapshotrequest.DeleteAutoSnapshotRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
