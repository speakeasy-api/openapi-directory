...
class EventsDetectionJobProperties:
    r"""Provides information about an events detection job."""
    ...
    target_event_types: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TargetEventTypes'), 'exclude': lambda f: f is None }})  
