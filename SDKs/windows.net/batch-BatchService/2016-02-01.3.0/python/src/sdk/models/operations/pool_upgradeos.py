...
from ..shared import poolupgradeosparameter as shared_poolupgradeosparameter
...
class PoolUpgradeOSRequest:
    ...
    r"""The id of the pool to upgrade."""  
    pool_upgrade_os_parameter: shared_poolupgradeosparameter.PoolUpgradeOSParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
