...
func (s *inventory) CreateOrganizationInventoryOnboardingCloudMonitoringPrepare(ctx context.Context, request operations.CreateOrganizationInventoryOnboardingCloudMonitoringPrepareRequest) (*operations.CreateOrganizationInventoryOnboardingCloudMonitoringPrepareResponse, error) {
	baseURL := s.serverURL
