...
exports.EmployeeSchedules = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var EmployeeSchedules = /** @class */ (function () {
    function EmployeeSchedules(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    EmployeeSchedules.prototype.employeeSchedulesAll = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.EmployeeSchedulesAllRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/hris/schedules/employees/{employee_id}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getEmployeeSchedulesResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
...
exports.EmployeeSchedules = EmployeeSchedules;
