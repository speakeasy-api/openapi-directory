...
func (e StoryRequestStickerNameEnum) ToPointer() *StoryRequestStickerNameEnum {
	return &e
}
...
func (e *StoryRequestStickerNameEnum) UnmarshalJSON(data []byte) error {
	...
	case "phoenix_spreading_love":
		*e = StoryRequestStickerNameEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for StoryRequestStickerNameEnum: %v", v)
	}
}
