...
class HipHealthInformationRequestAcknowledgementHiRequest:
    session_status: HipHealthInformationRequestAcknowledgementHiRequestSessionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('sessionStatus') }})
...
class HipHealthInformationRequestAcknowledgement:
    ...
    hi_request: Optional[HipHealthInformationRequestAcknowledgementHiRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('hiRequest') }})
