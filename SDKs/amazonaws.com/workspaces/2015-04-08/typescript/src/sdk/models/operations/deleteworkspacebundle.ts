...
export enum DeleteWorkspaceBundleXAmzTargetEnum {
    WorkspacesServiceDeleteWorkspaceBundle = "WorkspacesService.DeleteWorkspaceBundle"
}


export class DeleteWorkspaceBundleHeaders extends SpeakeasyBase {
...
export class DeleteWorkspaceBundleResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
