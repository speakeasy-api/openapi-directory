...
var ArtifactRules = /** @class */ (function () {
    ...
    **/
    ArtifactRules.prototype.createArtifactRule = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/rules", req.pathParams);
    ...
    **/
    ArtifactRules.prototype.deleteArtifactRule = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/rules/{rule}", req.pathParams);
        var client = this._defaultClient;
    ...
    **/
    ArtifactRules.prototype.testUpdateArtifact = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/test", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
