...
var OauthAuthorizations = /** @class */ (function () {
    ...
    OauthAuthorizations.prototype.oauthAuthorizationsCheckAuthorization = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.OauthAuthorizationsCheckAuthorizationResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.authorizationWithUser = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.AuthorizationWithUser);
                    }
                    break;
            }
            return res;
    ...
    OauthAuthorizations.prototype.oauthAuthorizationsResetAuthorization = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.OauthAuthorizationsResetAuthorizationResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    OauthAuthorizations.prototype.oauthAuthorizationsRevokeAuthorizationForApplication = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
                new operations.OauthAuthorizationsRevokeAuthorizationForApplicationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/applications/{client_id}/tokens/{access_token}", req);
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.OauthAuthorizationsRevokeAuthorizationForApplicationResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    OauthAuthorizations.prototype.oauthAuthorizationsRevokeGrantForApplication = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.OauthAuthorizationsRevokeGrantForApplicationResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
