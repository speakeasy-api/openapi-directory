...
export class Projects {
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#add-project-collaborator} - API method documentation
   */
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#create-a-project-card} - API method documentation
   */
  projectsCreateCard(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#create-a-project-column} - API method documentation
   */
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#create-a-user-project} - API method documentation
   */
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#create-an-organization-project} - API method documentation
   */
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#create-a-repository-project} - API method documentation
   */
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#delete-a-project} - API method documentation
   */
  projectsDelete(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#delete-a-project-card} - API method documentation
   */
  projectsDeleteCard(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#delete-a-project-column} - API method documentation
   */
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#get-a-project} - API method documentation
   */
  projectsGet(
   ...
   * Get a project card
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#get-a-project-card} - API method documentation
   */
  projectsGetCard(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#get-a-project-column} - API method documentation
   */
  projectsGetColumn(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#get-project-permission-for-a-user} - API method documentation
   */
   ...
   * List project cards
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#list-project-cards} - API method documentation
   */
  projectsListCards(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#list-project-collaborators} - API method documentation
   */
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#list-project-columns} - API method documentation
   */
  projectsListColumns(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#list-organization-projects} - API method documentation
   */
  projectsListForOrg(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#list-repository-projects} - API method documentation
   */
  projectsListForRepo(
   ...
   * List user projects
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#list-user-projects} - API method documentation
   */
  projectsListForUser(
   ...
   * Move a project card
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#move-a-project-card} - API method documentation
   */
  projectsMoveCard(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#move-a-project-column} - API method documentation
   */
  projectsMoveColumn(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#remove-project-collaborator} - API method documentation
   */
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#update-a-project} - API method documentation
   */
  projectsUpdate(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#update-a-project-card} - API method documentation
   */
  projectsUpdateCard(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/projects#update-a-project-column} - API method documentation
   */
