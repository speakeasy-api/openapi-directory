...
class AddressAddressResidentialIndicatorEnum(str, Enum):
...
class Address:
    ...
    address_residential_indicator: AddressAddressResidentialIndicatorEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address_residential_indicator') }})
