...
var WeatherForecast = /** @class */ (function () {
    function WeatherForecast(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    WeatherForecast.prototype.getVisualCrossingWebServicesRestServicesWeatherdataForecast = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetVisualCrossingWebServicesRestServicesWeatherdataForecastRequest(req);
        }
        var baseURL = operations.GetVisualCrossingWebServicesRestServicesWeatherdataForecastServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = baseURL.replace(/\/$/, "") + "/VisualCrossingWebServices/rest/services/weatherdata/forecast";
