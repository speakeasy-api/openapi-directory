...
class RequestNodesXSdsDateFormatEnum(str, Enum):
...
class RequestNodesRequest:
    ...
    * `n` (any positive number) - include `n` levels starting from the current node
    ...
    """  
    room_manager: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'room_manager', 'style': 'form', 'explode': True }})
    r"""Show all rooms for management perspective.
    ...
    x_sds_date_format: Optional[RequestNodesXSdsDateFormatEnum] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'X-Sds-Date-Format', 'style': 'simple', 'explode': False }})
    r"""Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) & [leettime.de](http://leettime.de/))"""  
