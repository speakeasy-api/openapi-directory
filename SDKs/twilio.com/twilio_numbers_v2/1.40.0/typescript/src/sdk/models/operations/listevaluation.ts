...
export const ListEvaluationServerList = ["https://numbers.twilio.com"] as const;
...
export class ListEvaluationListEvaluationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListEvaluationListEvaluationResponseMeta)
  ...
  @Expose({ name: "results" })
  @Type(() => shared.NumbersV2RegulatoryComplianceBundleEvaluation)
