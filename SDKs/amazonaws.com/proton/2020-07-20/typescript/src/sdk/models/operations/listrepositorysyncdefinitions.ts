...
export enum ListRepositorySyncDefinitionsXAmzTargetEnum {
  AwsProton20200720ListRepositorySyncDefinitions = "AwsProton20200720.ListRepositorySyncDefinitions",
}

export class ListRepositorySyncDefinitionsRequest extends SpeakeasyBase {
...
export class ListRepositorySyncDefinitionsResponse extends SpeakeasyBase {
  /**
