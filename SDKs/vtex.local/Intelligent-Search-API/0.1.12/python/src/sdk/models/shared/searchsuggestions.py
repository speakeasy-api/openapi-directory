...
class SearchSuggestionsSearches:
...
class SearchSuggestions:
    ...
    searches: Optional[list[SearchSuggestionsSearches]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('searches'), 'exclude': lambda f: f is None }})
    r"""List of suggested terms."""  
