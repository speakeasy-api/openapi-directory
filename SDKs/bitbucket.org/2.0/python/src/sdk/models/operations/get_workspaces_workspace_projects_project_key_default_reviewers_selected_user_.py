...
class GetWorkspacesWorkspaceProjectsProjectKeyDefaultReviewersSelectedUserSecurity:
...
class GetWorkspacesWorkspaceProjectsProjectKeyDefaultReviewersSelectedUserRequest:
    ...
    r"""The project in question. This can either be the actual `key` assigned
    ...
    r"""This can either be the username or the UUID of the default reviewer,
...
@dataclasses.dataclass
class GetWorkspacesWorkspaceProjectsProjectKeyDefaultReviewersSelectedUserResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    error: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""If the specified user is not a default reviewer for the project"""  
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None)  
    user: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""The specified user that is a default reviewer"""  
