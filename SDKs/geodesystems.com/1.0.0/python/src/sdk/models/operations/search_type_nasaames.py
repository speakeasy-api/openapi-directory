...
class SearchTypeNasaamesQueryParams:
...
@dataclasses.dataclass
class SearchTypeNasaamesRequest:
    query_params: SearchTypeNasaamesQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeNasaamesResponse:
