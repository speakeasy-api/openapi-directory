...
public class MarketplacesOrdersList {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.GetOrderListLightResponse getOrderListLight(org.openapis.openapi.models.operations.GetOrderListLightRequest request) throws Exception {
        String baseUrl = this._serverUrl;
