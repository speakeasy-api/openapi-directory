...
export declare class EventItem {
     ...
     */
    getEventItems(req: operations.GetEventItemsRequest, security: operations.GetEventItemsSecurity, config?: AxiosRequestConfig): Promise<operations.GetEventItemsResponse>;
}
