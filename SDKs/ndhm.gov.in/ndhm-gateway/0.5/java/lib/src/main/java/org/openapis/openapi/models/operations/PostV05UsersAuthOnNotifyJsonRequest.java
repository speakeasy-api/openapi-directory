...
public class PostV05UsersAuthOnNotifyJsonRequest {
    ...
    public PostV05UsersAuthOnNotifyJsonRequest withXCmId(String xCmId) {
        this.xCmId = xCmId;
        return this;
    }
    
    public PostV05UsersAuthOnNotifyJsonRequest(@JsonProperty("Authorization") String authorization, @JsonProperty("PatientAuthNotificationAcknowledgement") org.openapis.openapi.models.shared.PatientAuthNotificationAcknowledgement patientAuthNotificationAcknowledgement, @JsonProperty("X-CM-ID") String xCmId) {
        this.authorization = authorization;
        this.patientAuthNotificationAcknowledgement = patientAuthNotificationAcknowledgement;
        this.xCmId = xCmId;
  }
