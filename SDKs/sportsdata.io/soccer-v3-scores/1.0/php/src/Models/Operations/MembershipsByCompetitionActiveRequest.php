...
class MembershipsByCompetitionActiveRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\MembershipsByCompetitionActiveFormatEnum $format
     */
	...
	{
		$this->competition = "";
		$this->format = \OpenAPI\OpenAPI\Models\Operations\MembershipsByCompetitionActiveFormatEnum::XML;
	}
}
