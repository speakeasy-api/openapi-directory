...
class ComputeNodeAddUserPathParams:
...
@dataclasses.dataclass
class ComputeNodeAddUserQueryParams:
...
@dataclasses.dataclass
class ComputeNodeAddUserHeaders:
...
@dataclasses.dataclass
class ComputeNodeAddUserRequest:
    headers: ComputeNodeAddUserHeaders = dataclasses.field()
    path_params: ComputeNodeAddUserPathParams = dataclasses.field()
    query_params: ComputeNodeAddUserQueryParams = dataclasses.field()
    request: Any = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class ComputeNodeAddUserResponse:
