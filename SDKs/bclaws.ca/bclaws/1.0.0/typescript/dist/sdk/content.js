...
var Content = /** @class */ (function () {
    ...
    Content.prototype.getContentAspectId = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/content/{aspectId}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetContentAspectIdResponse({
    ...
    Content.prototype.getContentAspectIdCivixDocumentId = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/content/{aspectId}/{civixDocumentId}", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetContentAspectIdCivixDocumentIdResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
