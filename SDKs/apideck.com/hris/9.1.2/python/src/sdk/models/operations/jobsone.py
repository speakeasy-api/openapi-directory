...
from ..shared import gethrisjobresponse as shared_gethrisjobresponse
...
class JobsOneRequest:
    ...
    r"""ID of the job you are acting upon."""  
...
class JobsOneResponse:
    ...
    r"""Bad Request"""  
    get_hris_job_response: Optional[shared_gethrisjobresponse.GetHrisJobResponse] = dataclasses.field(default=None)
    r"""Job"""  
