 ...
 */
export enum ZoneListWarningCodeEnum {
...
export class ZoneListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ZoneListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: ZoneListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class ZoneList extends SpeakeasyBase {
  /**
