 ...
 */
export class SearchTransitGatewayRoutesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class SearchTransitGatewayRoutesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: SearchTransitGatewayRoutesRequestFilters })
