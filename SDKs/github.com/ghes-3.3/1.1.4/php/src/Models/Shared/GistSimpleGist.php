...
class GistSimpleGist
{
     ...
     * $files
     * 
     * @var array<string, \OpenAPI\OpenAPI\Models\Shared\GistSimpleGistFiles> $files
     */
	#[\JMS\Serializer\Annotation\SerializedName('files')]
    #[\JMS\Serializer\Annotation\Type('array<string, OpenAPI\OpenAPI\Models\Shared\GistSimpleGistFiles>')]
    public array $files;
