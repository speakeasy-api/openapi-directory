...
exports.EmployeesAllResponse = exports.EmployeesAllRequest = exports.EmployeesAllSecurity = void 0;
...
exports.EmployeesAllSecurity = EmployeesAllSecurity;
var EmployeesAllRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], EmployeesAllRequest.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], EmployeesAllRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=deepObject;explode=true;name=filter",
        }),
        __metadata("design:type", shared.EmployeesFilter)
    ], EmployeesAllRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], EmployeesAllRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], EmployeesAllRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=deepObject;explode=true;name=sort",
        }),
        __metadata("design:type", shared.EmployeesSort)
    ], EmployeesAllRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], EmployeesAllRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], EmployeesAllRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], EmployeesAllRequest.prototype, "xApideckServiceId", void 0);
    return EmployeesAllRequest;
}(utils_1.SpeakeasyBase));
exports.EmployeesAllRequest = EmployeesAllRequest;
var EmployeesAllResponse = /** @class */ (function (_super) {
    ...
    ], EmployeesAllResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.EmployeesAllResponse = EmployeesAllResponse;
