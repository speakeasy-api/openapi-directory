...
var GoogleCloudContactcenterinsightsV1PhraseMatcher = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=activationUpdateTime" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=phraseMatchRuleGroups", elemType: googlecloudcontactcenterinsightsv1phrasematchrulegroup_1.GoogleCloudContactcenterinsightsV1PhraseMatchRuleGroup }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=roleMatch" }),
        __metadata("design:type", String)
