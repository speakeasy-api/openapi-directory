...
public class GetUsersIdReputationHistoryFullRequest {
    ...
    public GetUsersIdReputationHistoryFullRequest withCallback(String callback) {
    ...
    public GetUsersIdReputationHistoryFullRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdReputationHistoryFullRequest withId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public GetUsersIdReputationHistoryFullRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdReputationHistoryFullRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdReputationHistoryFullRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    public GetUsersIdReputationHistoryFullRequest(@JsonProperty("id") Long id, @JsonProperty("site") String site) {
        this.id = id;
        this.site = site;
  }
}
