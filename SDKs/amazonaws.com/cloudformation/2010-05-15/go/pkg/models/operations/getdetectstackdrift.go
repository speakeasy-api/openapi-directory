...
type GETDetectStackDriftQueryParams struct {
...
type GETDetectStackDriftHeaders struct {
...
type GETDetectStackDriftRequest struct {
	QueryParams GETDetectStackDriftQueryParams
	Headers     GETDetectStackDriftHeaders
}
