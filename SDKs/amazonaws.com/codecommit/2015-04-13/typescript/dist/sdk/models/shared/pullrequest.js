...
var PullRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=approvalRules", elemType: approvalrule_1.ApprovalRule }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=pullRequestTargets", elemType: pullrequesttarget_1.PullRequestTarget }),
        __metadata("design:type", Array)
