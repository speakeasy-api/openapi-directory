...
export declare class GetUpdatedEditorialImageSecurity extends SpeakeasyBase {
 ...
 * Sort by
 */
export declare enum GetUpdatedEditorialImageSortEnum {
    Newest = "newest",
    Oldest = "oldest"
}
/**
 ...
 */
export declare enum GetUpdatedEditorialImageTypeEnum {
    Edit = "edit",
    Addition = "addition"
}
export declare class GetUpdatedEditorialImageRequest extends SpeakeasyBase {
    /**
...
export declare class GetUpdatedEditorialImageResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * OK
     */
