...
public class ArcmwSecurity {
    ...
    public ArcmwSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public ArcmwSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public ArcmwSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
