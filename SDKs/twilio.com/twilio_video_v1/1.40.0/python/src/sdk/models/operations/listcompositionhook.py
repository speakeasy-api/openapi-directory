...
class ListCompositionHookRequest:
    ...
    r"""Read only CompositionHook resources created on or after this [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) datetime with time zone."""  
    ...
    r"""Read only CompositionHook resources created before this [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) datetime with time zone."""  
    enabled: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'Enabled', 'style': 'form', 'explode': True }})
    r"""Read only CompositionHook resources with an `enabled` value that matches this parameter."""  
    ...
    r"""Read only CompositionHook resources with friendly names that match this string. The match is not case sensitive and can include asterisk `*` characters as wildcard match."""  
...
class ListCompositionHookListCompositionHookResponse:
    ...
    composition_hooks: Optional[list[shared_video_v1_composition_hook.VideoV1CompositionHook]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('composition_hooks'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListCompositionHookListCompositionHookResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
