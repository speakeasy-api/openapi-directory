...
func (e AndroidpublisherEditsExpansionfilesPatchExpansionFileTypeEnum) ToPointer() *AndroidpublisherEditsExpansionfilesPatchExpansionFileTypeEnum {
	return &e
}
...
func (e *AndroidpublisherEditsExpansionfilesPatchExpansionFileTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "main":
		fallthrough
	case "patch":
		*e = AndroidpublisherEditsExpansionfilesPatchExpansionFileTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AndroidpublisherEditsExpansionfilesPatchExpansionFileTypeEnum: %v", v)
	}
}
