...
class DisassociateProductFromPortfolioRequest:
    ...
    disassociate_product_from_portfolio_input: shared_disassociateproductfromportfolioinput.DisassociateProductFromPortfolioInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
