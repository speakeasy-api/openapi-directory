...
class SupportedLanguage:
    ...
    r"""Supported language code, generally consisting of its ISO 639-1 identifier, for example, 'en', 'ja'. In certain cases, ISO-639 codes including language and region identifiers are returned (for example, 'zh-TW' and 'zh-CN')."""  
    ...
    r"""Can be used as a source language."""  
    ...
    r"""Can be used as a target language."""  
