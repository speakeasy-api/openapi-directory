      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV1ServiceChannel = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV1ServiceChannel
            );
          }
          break;
      }
  ...
  createCredential(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV1Credential = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV1Credential
            );
          }
          break;
      }
  ...
  createInvite(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV1ServiceChannelInvite = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV1ServiceChannelInvite
            );
          }
          break;
      }
  ...
  createMember(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV1ServiceChannelMember = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV1ServiceChannelMember
            );
          }
          break;
      }
  ...
  createMessage(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV1ServiceChannelMessage = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV1ServiceChannelMessage
            );
          }
          break;
      }
  ...
  createRole(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV1ServiceRole = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV1ServiceRole
            );
          }
          break;
      }
  ...
  createService(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV1Service = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV1Service
            );
          }
          break;
      }
  ...
  createUser(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ipMessagingV1ServiceUser = utils.objectToClass(
              httpRes?.data,
              shared.IpMessagingV1ServiceUser
            );
          }
          break;
      }
