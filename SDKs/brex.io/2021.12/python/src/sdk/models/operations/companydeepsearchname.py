...
class CompanyDeepsearchNameResponse:
    ...
    company_deepsearch_name_200_application_json_objects: Optional[list[CompanyDeepsearchName200ApplicationJSON]] = dataclasses.field(default=None)
    r"""List of companies"""  
    company_deepsearch_name_default_application_json_object: Optional[CompanyDeepsearchNameDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Detailed information about the error"""  
