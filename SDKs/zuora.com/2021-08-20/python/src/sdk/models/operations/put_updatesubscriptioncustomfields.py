...
class PUTUpdateSubscriptionCustomFieldsRequest:
    ...
    put_subscription_patch_request_type: shared_putsubscriptionpatchrequesttype.PUTSubscriptionPatchRequestType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    subscription_number: str = dataclasses.field(metadata={'path_param': { 'field_name': 'subscriptionNumber', 'style': 'simple', 'explode': False }})
    r"""The subscription number to be updated."""  
