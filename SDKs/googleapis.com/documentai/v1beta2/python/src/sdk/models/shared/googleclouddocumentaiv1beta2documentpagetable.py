...
from ..shared import googleclouddocumentaiv1beta2documentpagetabletablerow as shared_googleclouddocumentaiv1beta2documentpagetabletablerow
...
class GoogleCloudDocumentaiV1beta2DocumentPageTable:
    ...
    body_rows: Optional[list[shared_googleclouddocumentaiv1beta2documentpagetabletablerow.GoogleCloudDocumentaiV1beta2DocumentPageTableTableRow]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bodyRows'), 'exclude': lambda f: f is None }})
    ...
    header_rows: Optional[list[shared_googleclouddocumentaiv1beta2documentpagetabletablerow.GoogleCloudDocumentaiV1beta2DocumentPageTableTableRow]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('headerRows'), 'exclude': lambda f: f is None }})
