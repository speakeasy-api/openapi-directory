...
class AdsenseReportsSavedGenerateSecurity:
    ...
    option1: Optional[AdsenseReportsSavedGenerateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[AdsenseReportsSavedGenerateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
