...
* [ReposCreatePagesDeployment](#reposcreatepagesdeployment) - Create a GitHub Pages deployment
...
<https://docs.github.com/enterprise-server@3.7/rest/collaborators/invitations#accept-a-repository-invitation>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#add-app-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/collaborators/collaborators#add-a-repository-collaborator>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#add-status-check-contexts>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#add-team-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#add-user-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/collaborators/collaborators#check-if-a-user-is-a-repository-collaborator>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-codeowners-errors>
...
Compares two commits against one another. You can compare branches in the same repository, or you can compare branches that exist in different repositories within the same repository network, including fork branches. For more information about how to view a repository's network, see "[Understanding connections between repositories](https://docs.github.com/enterprise-server@3.7/repositories/viewing-activity-and-data-for-your-repository/understanding-connections-between-repositories)."
...
For more information on working with pagination, see "[Using pagination in the REST API](https://docs.github.com/enterprise-server@3.7/rest/guides/using-pagination-in-the-rest-api)."
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/commits#compare-two-commits>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/repos/autolinks#create-an-autolink-reference-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/comments#create-a-commit-comment>
...
func main() {
    ...
    res, err := s.Repos.ReposCreateCommitComment(ctx, operations.ReposCreateCommitCommentRequest{
        RequestBody: operations.ReposCreateCommitCommentRequestBody{
            Body: "similique",
            Line: sdk.Int64(783274),
            Path: sdk.String("blanditiis"),
            Position: sdk.Int64(60892),
        },
        CommitSha: "magni",
        Owner: "officiis",
        Repo: "sed",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#create-commit-signature-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/statuses#create-a-commit-status>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deploy-keys#create-a-deploy-key>
...
By default, [commit statuses](https://docs.github.com/enterprise-server@3.7/rest/commits/statuses) for every submitted context must be in a `success`
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/deployments#create-a-deployment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/branch-policies#create-deployment-branch-policy>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/statuses#create-a-deployment-status>
...
func main() {
    ...
    res, err := s.Repos.ReposCreateDeploymentStatus(ctx, operations.ReposCreateDeploymentStatusRequest{
        RequestBody: operations.ReposCreateDeploymentStatusRequestBody{
            ...
            EnvironmentURL: sdk.String("incidunt"),
            LogURL: sdk.String("dicta"),
            State: operations.ReposCreateDeploymentStatusRequestBodyStateEnumError,
            TargetURL: sdk.String("corporis"),
        },
        DeploymentID: 701441,
        Owner: "alias",
        Repo: "error",
...
This endpoint requires write access to the repository by providing either:
  ...
  - Personal access tokens with `repo` scope. For more information, see "[Creating a personal access token for the command line](https://docs.github.com/enterprise-server@3.7/articles/creating-a-personal-access-token-for-the-command-line)" in the GitHub Help documentation.
  - GitHub Apps with both `metadata:read` and `contents:read&write` permissions.

This input example shows how you can use the `client_payload` as a test to debug your workflow.

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#create-a-repository-dispatch-event>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#create-a-repository-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Repos.ReposCreateForAuthenticatedUser(ctx, operations.ReposCreateForAuthenticatedUserRequestBody{
        ...
        Homepage: sdk.String("similique"),
        IsTemplate: sdk.Bool(true),
        LicenseTemplate: sdk.String("mit"),
        MergeCommitMessage: operations.ReposCreateForAuthenticatedUserRequestBodyMergeCommitMessageEnumPrBody.ToPointer(),
        MergeCommitTitle: operations.ReposCreateForAuthenticatedUserRequestBodyMergeCommitTitleEnumPrTitle.ToPointer(),
        Name: "Team Environment",
        Private: sdk.Bool(false),
        SquashMergeCommitMessage: operations.ReposCreateForAuthenticatedUserRequestBodySquashMergeCommitMessageEnumPrBody.ToPointer(),
        SquashMergeCommitTitle: operations.ReposCreateForAuthenticatedUserRequestBodySquashMergeCommitTitleEnumCommitOrPrTitle.ToPointer(),
        TeamID: sdk.Int64(965095),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#create-a-fork>
...
func main() {
    ...
    res, err := s.Repos.ReposCreateFork(ctx, operations.ReposCreateForkRequest{
        RequestBody: &operations.ReposCreateForkRequestBody{
            DefaultBranchOnly: sdk.Bool(false),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#create-an-organization-repository>
...
func main() {
    ...
    res, err := s.Repos.ReposCreateInOrg(ctx, operations.ReposCreateInOrgRequest{
        RequestBody: operations.ReposCreateInOrgRequestBody{
            ...
            GitignoreTemplate: sdk.String("laudantium"),
            HasDownloads: sdk.Bool(true),
            HasIssues: sdk.Bool(false),
            HasProjects: sdk.Bool(false),
            HasWiki: sdk.Bool(false),
            Homepage: sdk.String("velit"),
            IsTemplate: sdk.Bool(false),
            LicenseTemplate: sdk.String("reiciendis"),
            MergeCommitMessage: operations.ReposCreateInOrgRequestBodyMergeCommitMessageEnumPrBody.ToPointer(),
            MergeCommitTitle: operations.ReposCreateInOrgRequestBodyMergeCommitTitleEnumPrTitle.ToPointer(),
            Name: "Adrienne White",
            Private: sdk.Bool(false),
            SquashMergeCommitMessage: operations.ReposCreateInOrgRequestBodySquashMergeCommitMessageEnumCommitMessages.ToPointer(),
            SquashMergeCommitTitle: operations.ReposCreateInOrgRequestBodySquashMergeCommitTitleEnumCommitOrPrTitle.ToPointer(),
            TeamID: sdk.Int64(955466),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/environments#create-or-update-an-environment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#create-or-update-file-contents>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/pages#create-a-github-pages-deployment>
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposCreatePagesDeployment(ctx, operations.ReposCreatePagesDeploymentRequest{
        RequestBody: operations.ReposCreatePagesDeploymentRequestBody{
            ArtifactURL: "accusantium",
            Environment: sdk.String("officia"),
            OidcToken: "impedit",
            PagesBuildVersion: "quasi",
        },
        Owner: "blanditiis",
        Repo: "eius",
    })
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/pages#create-a-github-pages-site>
...
func main() {
    ...
    res, err := s.Repos.ReposCreatePagesSite(ctx, operations.ReposCreatePagesSiteRequest{
        RequestBody: operations.ReposCreatePagesSiteRequestBody2{
            BuildType: operations.ReposCreatePagesSiteRequestBody2BuildTypeEnumLegacy,
            Source: &operations.ReposCreatePagesSiteRequestBody2Source{
                Branch: "nobis",
                Path: operations.ReposCreatePagesSiteRequestBody2SourcePathEnumRootDocs.ToPointer(),
            },
        },
        Owner: "minus",
        Repo: "quia",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/releases/releases#create-a-release>
...
func main() {
    ...
    res, err := s.Repos.ReposCreateRelease(ctx, operations.ReposCreateReleaseRequest{
        RequestBody: operations.ReposCreateReleaseRequestBody{
            Body: sdk.String("magnam"),
            Draft: sdk.Bool(false),
            GenerateReleaseNotes: sdk.Bool(false),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#create-tag-protection-state-for-a-repository>
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposCreateTagProtection(ctx, operations.ReposCreateTagProtectionRequest{
        RequestBody: operations.ReposCreateTagProtectionRequestBody{
            Pattern: "perferendis",
        },
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#create-a-repository-using-a-template>
...
func main() {
    ...
    res, err := s.Repos.ReposCreateUsingTemplate(ctx, operations.ReposCreateUsingTemplateRequest{
        RequestBody: operations.ReposCreateUsingTemplateRequestBody{
            ...
            Name: "Ashley Wunsch",
            Owner: sdk.String("earum"),
            Private: sdk.Bool(false),
        },
        TemplateOwner: "veniam",
        TemplateRepo: "ipsam",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/webhooks/repos#create-a-repository-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/collaborators/invitations#decline-a-repository-invitation>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#delete-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#delete-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#delete-admin-branch-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/environments#delete-an-environment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/repos/autolinks#delete-an-autolink-reference-from-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#delete-branch-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/comments#delete-a-commit-comment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#delete-commit-signature-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deploy-keys#delete-a-deploy-key>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/deployments#delete-a-deployment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/branch-policies#delete-deployment-branch-policy>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#delete-a-file>
    ...
    res, err := s.Repos.ReposDeleteFile(ctx, operations.ReposDeleteFileRequest{
        RequestBody: operations.ReposDeleteFileRequestBody{
            Author: &operations.ReposDeleteFileRequestBodyAuthor{
                Email: sdk.String("Merritt64@gmail.com"),
                Name: sdk.String("Velma Cummings"),
            },
            Branch: sdk.String("dolor"),
            Committer: &operations.ReposDeleteFileRequestBodyCommitter{
                Email: sdk.String("Candida_Tillman79@hotmail.com"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/collaborators/invitations#delete-a-repository-invitation>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/pages#delete-a-github-pages-site>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#delete-pull-request-review-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#delete-a-release>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#delete-a-release-asset>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#delete-tag-protection-state-for-a-repository>
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposDeleteTagProtection(ctx, operations.ReposDeleteTagProtectionRequest{
        Owner: "aliquam",
        Repo: "quisquam",
        TagProtectionID: 557987,
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/webhooks/repos#delete-a-repository-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#disable-git-lfs-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#download-a-repository-archive>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#enable-git-lfs-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#generate-release-notes>
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposGenerateReleaseNotes(ctx, operations.ReposGenerateReleaseNotesRequest{
        RequestBody: operations.ReposGenerateReleaseNotesRequestBody{
            ConfigurationFilePath: sdk.String("adipisci"),
            PreviousTagName: sdk.String("recusandae"),
            TagName: "tempora",
            TargetCommitish: sdk.String("blanditiis"),
        },
        Owner: "numquam",
        Repo: "sequi",
    })
    ...
    if res.ReleaseNotesContent != nil {
        // handle response
    }
}
```
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#get-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#get-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#get-admin-branch-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/environments#list-environments>
...
func main() {
    ...
    res, err := s.Repos.ReposGetAllEnvironments(ctx, operations.ReposGetAllEnvironmentsRequest{
        Owner: "porro",
        Page: sdk.Int64(646491),
        PerPage: sdk.Int64(168926),
        Repo: "nihil",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#get-all-status-check-contexts>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#get-all-repository-topics>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#list-apps-with-access-to-the-protected-branch>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/repos/autolinks#get-an-autolink-reference-of-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branches#get-a-branch>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#get-branch-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/metrics/statistics#get-the-weekly-commit-activity>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/collaborators/collaborators#get-repository-permissions-for-a-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/statuses#get-the-combined-status-for-a-specific-reference>
...
You can pass the appropriate [media type](https://docs.github.com/enterprise-server@3.7/rest/overview/media-types/#commits-commit-comparison-and-pull-requests) to  fetch `diff` and `patch` formats. Diffs with binary data will have no `patch` property.
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/commits#get-a-commit>
...
func main() {
    ...
    res, err := s.Repos.ReposGetCommit(ctx, operations.ReposGetCommitRequest{
        Owner: "rem",
        Page: sdk.Int64(543353),
        PerPage: sdk.Int64(886118),
        Ref: "cum",
        Repo: "pariatur",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/metrics/statistics#get-the-last-year-of-commit-activity>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/comments#get-a-commit-comment>
...
When authenticated with admin or owner permissions to the repository, you can use this endpoint to check whether a branch requires signed commits. An enabled status of `true` indicates you must sign commits on this branch. For more information, see [Signing commits with GPG](https://docs.github.com/enterprise-server@3.7/articles/signing-commits-with-gpg) in GitHub Help.

**Note**: You must enable branch protection to require signed commits.

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#get-commit-signature-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#get-repository-content>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/metrics/statistics#get-all-contributor-commit-activity>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deploy-keys#get-a-deploy-key>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/deployments#get-a-deployment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/branch-policies#get-deployment-branch-policy>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/statuses#get-a-deployment-status>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/environments#get-an-environment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/pages#get-latest-pages-build>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#get-the-latest-release>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/pages#get-a-github-pages-site>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/pages#get-github-pages-build>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/metrics/statistics#get-the-weekly-commit-count>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#get-pull-request-review-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/metrics/statistics#get-the-hourly-commit-count-for-each-day>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#get-a-repository-readme>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#get-a-repository-directory-readme>
...
**Note:** This returns an `upload_url` key corresponding to the endpoint for uploading release assets. This key is a [hypermedia resource](https://docs.github.com/enterprise-server@3.7/rest/overview/resources-in-the-rest-api#hypermedia).

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#get-a-release>
...
To download the asset's binary content, set the `Accept` header of the request to [`application/octet-stream`](https://docs.github.com/enterprise-server@3.7/rest/overview/media-types). The API will either redirect the client to the location, or stream it directly if possible. API clients should handle both a `200` or `302` response.

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#get-a-release-asset>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#get-a-release-by-tag-name>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#get-status-checks-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#list-teams-with-access-to-the-protected-branch>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#list-users-with-access-to-the-protected-branch>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/webhooks/repos#get-a-repository-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/webhooks/repo-config#get-a-webhook-configuration-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/webhooks/repo-deliveries#get-a-delivery-for-a-repository-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/repos/autolinks#list-all-autolinks-of-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branches#list-branches>
...
func main() {
    ...
    res, err := s.Repos.ReposListBranches(ctx, operations.ReposListBranchesRequest{
        Owner: "sed",
        Page: sdk.Int64(537170),
        PerPage: sdk.Int64(122744),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/commits#list-branches-for-head-commit>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-repository-cache-replication-status>
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposListCacheInfo(ctx, operations.ReposListCacheInfoRequest{
        Owner: "deserunt",
        Page: sdk.Int64(266680),
        PerPage: sdk.Int64(122085),
        Repo: "impedit",
    })
    if err != nil {
        log.Fatal(err)
    ...
    if res.ReposListCacheInfo200ApplicationJSONObjects != nil {
        // handle response
    }
}
```
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/collaborators/collaborators#list-repository-collaborators>
...
func main() {
    ...
    res, err := s.Repos.ReposListCollaborators(ctx, operations.ReposListCollaboratorsRequest{
        ...
        Owner: "voluptatum",
        Page: sdk.Int64(60078),
        PerPage: sdk.Int64(872991),
        Repo: "dolorem",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/comments#list-commit-comments>
...
func main() {
    ...
    res, err := s.Repos.ReposListCommentsForCommit(ctx, operations.ReposListCommentsForCommitRequest{
        CommitSha: "repellat",
        Owner: "aspernatur",
        Page: sdk.Int64(80284),
        PerPage: sdk.Int64(193236),
        Repo: "fugit",
    })
    if err != nil {
        log.Fatal(err)
...
Commit Comments use [these custom media types](https://docs.github.com/enterprise-server@3.7/rest/reference/repos#custom-media-types). You can read more about the use of media types in the API [here](https://docs.github.com/enterprise-server@3.7/rest/overview/media-types/).

Comments are ordered by ascending ID.

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/comments#list-commit-comments-for-a-repository>
...
func main() {
    ...
    res, err := s.Repos.ReposListCommitCommentsForRepo(ctx, operations.ReposListCommitCommentsForRepoRequest{
        Owner: "fuga",
        Page: sdk.Int64(943103),
        PerPage: sdk.Int64(49499),
        Repo: "dolorem",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/statuses#list-commit-statuses-for-a-reference>
...
func main() {
    ...
    res, err := s.Repos.ReposListCommitStatusesForRef(ctx, operations.ReposListCommitStatusesForRefRequest{
        Owner: "architecto",
        Page: sdk.Int64(44929),
        PerPage: sdk.Int64(134173),
        Ref: "nulla",
        Repo: "enim",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/commits#list-commits>
...
func main() {
    ...
    res, err := s.Repos.ReposListCommits(ctx, operations.ReposListCommitsRequest{
        Author: sdk.String("illo"),
        Owner: "magnam",
        Page: sdk.Int64(961842),
        Path: sdk.String("numquam"),
        PerPage: sdk.Int64(760279),
        Repo: "nobis",
        Sha: sdk.String("ex"),
        Since: types.MustTimeFromString("2022-10-21T16:41:09.733Z"),
        Until: types.MustTimeFromString("2021-07-30T12:30:50.377Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-repository-contributors>
...
func main() {
    ...
    res, err := s.Repos.ReposListContributors(ctx, operations.ReposListContributorsRequest{
        Anon: sdk.String("hic"),
        Owner: "excepturi",
        Page: sdk.Int64(396610),
        PerPage: sdk.Int64(151385),
        Repo: "beatae",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deploy-keys#list-deploy-keys>
...
func main() {
    ...
    res, err := s.Repos.ReposListDeployKeys(ctx, operations.ReposListDeployKeysRequest{
        Owner: "similique",
        Page: sdk.Int64(408774),
        PerPage: sdk.Int64(657301),
        Repo: "dolore",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/branch-policies#list-deployment-branch-policies>
...
func main() {
    ...
    res, err := s.Repos.ReposListDeploymentBranchPolicies(ctx, operations.ReposListDeploymentBranchPoliciesRequest{
        EnvironmentName: "tenetur",
        Owner: "dignissimos",
        Page: sdk.Int64(457835),
        PerPage: sdk.Int64(657044),
        Repo: "laudantium",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/statuses#list-deployment-statuses>
...
func main() {
    ...
    res, err := s.Repos.ReposListDeploymentStatuses(ctx, operations.ReposListDeploymentStatusesRequest{
        DeploymentID: 461050,
        Owner: "eveniet",
        Page: sdk.Int64(935161),
        PerPage: sdk.Int64(246402),
        Repo: "officiis",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/deployments#list-deployments>
...
func main() {
    ...
    res, err := s.Repos.ReposListDeployments(ctx, operations.ReposListDeploymentsRequest{
        Environment: sdk.String("eius"),
        Owner: "rerum",
        Page: sdk.Int64(930111),
        PerPage: sdk.Int64(489685),
        Ref: sdk.String("ipsam"),
        Repo: "explicabo",
        Sha: sdk.String("impedit"),
        Task: sdk.String("aliquid"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-repositories-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Repos.ReposListForAuthenticatedUser(ctx, operations.ReposListForAuthenticatedUserRequest{
        Affiliation: sdk.String("quis"),
        Before: types.MustTimeFromString("2022-07-25T18:23:48.906Z"),
        ...
        Since: types.MustTimeFromString("2021-03-09T05:37:08.074Z"),
        Sort: operations.ReposListForAuthenticatedUserSortEnumCreated.ToPointer(),
        Type: operations.ReposListForAuthenticatedUserTypeEnumPrivate.ToPointer(),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-organization-repositories>
...
func main() {
    ...
    res, err := s.Repos.ReposListForOrg(ctx, operations.ReposListForOrgRequest{
        ...
        Org: "illo",
        Page: sdk.Int64(792499),
        PerPage: sdk.Int64(553315),
        Sort: operations.ReposListForOrgSortEnumFullName.ToPointer(),
        Type: operations.ReposListForOrgTypeEnumSources.ToPointer(),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-repositories-for-a-user>
...
func main() {
    ...
    res, err := s.Repos.ReposListForUser(ctx, operations.ReposListForUserRequest{
        ...
        Page: sdk.Int64(315671),
        PerPage: sdk.Int64(881189),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-forks>
...
func main() {
    ...
    res, err := s.Repos.ReposListForks(ctx, operations.ReposListForksRequest{
        Owner: "illum",
        Page: sdk.Int64(526584),
        PerPage: sdk.Int64(949370),
        Repo: "deleniti",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/collaborators/invitations#list-repository-invitations>
...
func main() {
    ...
    res, err := s.Repos.ReposListInvitations(ctx, operations.ReposListInvitationsRequest{
        Owner: "earum",
        Page: sdk.Int64(101374),
        PerPage: sdk.Int64(305189),
        Repo: "labore",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/collaborators/invitations#list-repository-invitations-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Repos.ReposListInvitationsForAuthenticatedUser(ctx, operations.ReposListInvitationsForAuthenticatedUserRequest{
        Page: sdk.Int64(983434),
        PerPage: sdk.Int64(196646),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-repository-languages>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/pages#list-github-pages-builds>
...
func main() {
    ...
    res, err := s.Repos.ReposListPagesBuilds(ctx, operations.ReposListPagesBuildsRequest{
        Owner: "esse",
        Page: sdk.Int64(891302),
        PerPage: sdk.Int64(817454),
        Repo: "quisquam",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-public-repositories>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/commits#list-pull-requests-associated-with-a-commit>
...
func main() {
    ...
    res, err := s.Repos.ReposListPullRequestsAssociatedWithCommit(ctx, operations.ReposListPullRequestsAssociatedWithCommitRequest{
        CommitSha: "aliquam",
        Owner: "dolorum",
        Page: sdk.Int64(644827),
        PerPage: sdk.Int64(319834),
        Repo: "reiciendis",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-release-assets>
...
func main() {
    ...
    res, err := s.Repos.ReposListReleaseAssets(ctx, operations.ReposListReleaseAssetsRequest{
        Owner: "sequi",
        Page: sdk.Int64(785555),
        PerPage: sdk.Int64(671528),
        ReleaseID: 748973,
        Repo: "quibusdam",
    })
    if err != nil {
...
This returns a list of releases, which does not include regular Git tags that have not been associated with a release. To get a list of Git tags, use the [Repository Tags API](https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-repository-tags).

Information about published releases are available to everyone. Only users with push access will receive listings for draft releases.

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-releases>
...
func main() {
    ...
    res, err := s.Repos.ReposListReleases(ctx, operations.ReposListReleasesRequest{
        Owner: "omnis",
        Page: sdk.Int64(16252),
        PerPage: sdk.Int64(369941),
        Repo: "officia",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-tag-protection-state-of-a-repository>
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposListTagProtection(ctx, operations.ReposListTagProtectionRequest{
        Owner: "cupiditate",
        Repo: "reprehenderit",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-repository-tags>
...
func main() {
    ...
    res, err := s.Repos.ReposListTags(ctx, operations.ReposListTagsRequest{
        Owner: "quia",
        Page: sdk.Int64(898088),
        PerPage: sdk.Int64(37764),
        Repo: "ad",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-repository-teams>
...
func main() {
    ...
    res, err := s.Repos.ReposListTeams(ctx, operations.ReposListTeamsRequest{
        Owner: "nisi",
        Page: sdk.Int64(474185),
        PerPage: sdk.Int64(154130),
        Repo: "laudantium",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/webhooks/repo-deliveries#list-deliveries-for-a-repository-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/webhooks/repos#list-repository-webhooks>
...
func main() {
    ...
    res, err := s.Repos.ReposListWebhooks(ctx, operations.ReposListWebhooksRequest{
        Owner: "repellendus",
        Page: sdk.Int64(199879),
        PerPage: sdk.Int64(57909),
        Repo: "sint",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branches#merge-a-branch>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branches#sync-a-fork-branch-with-the-upstream-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/webhooks/repos#ping-a-repository-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/webhooks/repo-deliveries#redeliver-a-delivery-for-a-repository-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#remove-app-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/collaborators/collaborators#remove-a-repository-collaborator>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#remove-status-check-contexts>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#remove-status-check-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#remove-team-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#remove-user-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branches#rename-a-branch>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#replace-all-repository-topics>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/pages#request-a-github-pages-build>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#set-admin-branch-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#set-app-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#set-status-check-contexts>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#set-team-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#set-user-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/webhooks/repos#test-the-push-repository-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#transfer-a-repository>
...
**Note**: To edit a repository's topics, use the [Replace all repository topics](https://docs.github.com/enterprise-server@3.7/rest/reference/repos#replace-all-repository-topics) endpoint.

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/repos/repos#update-a-repository>
...
func main() {
    ...
    res, err := s.Repos.ReposUpdate(ctx, operations.ReposUpdateRequest{
        RequestBody: &operations.ReposUpdateRequestBody{
            ...
            DefaultBranch: sdk.String("enim"),
            DeleteBranchOnMerge: sdk.Bool(false),
            Description: sdk.String("nulla"),
            HasIssues: sdk.Bool(false),
            HasProjects: sdk.Bool(false),
            HasWiki: sdk.Bool(false),
            Homepage: sdk.String("maiores"),
            IsTemplate: sdk.Bool(false),
            MergeCommitMessage: operations.ReposUpdateRequestBodyMergeCommitMessageEnumBlank.ToPointer(),
            MergeCommitTitle: operations.ReposUpdateRequestBodyMergeCommitTitleEnumMergeMessage.ToPointer(),
            Name: sdk.String("Tomas Bosco"),
            Private: sdk.Bool(false),
            SquashMergeCommitMessage: operations.ReposUpdateRequestBodySquashMergeCommitMessageEnumBlank.ToPointer(),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#update-branch-protection>
    ...
    res, err := s.Repos.ReposUpdateBranchProtection(ctx, operations.ReposUpdateBranchProtectionRequest{
        RequestBody: operations.ReposUpdateBranchProtectionRequestBody{
            ...
            RequiredPullRequestReviews: operations.ReposUpdateBranchProtectionRequestBodyRequiredPullRequestReviews{
                ...
                RequiredApprovingReviewCount: sdk.Int64(799866),
            },
            RequiredStatusChecks: operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecks{
                Checks: []ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                    operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                        AppID: sdk.Int64(310930),
                        Context: "ipsum",
                    },
                    operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                        AppID: sdk.Int64(498435),
                        Context: "laudantium",
                    },
                },
                Contexts: []string{
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/commits/comments#update-a-commit-comment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/deployments/branch-policies#update-deployment-branch-policy>
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateDeploymentBranchPolicy(ctx, operations.ReposUpdateDeploymentBranchPolicyRequest{
        BranchPolicyID: 681115,
        DeploymentBranchPolicyNamePattern: shared.DeploymentBranchPolicyNamePattern{
            Name: "release/*",
        },
        EnvironmentName: "repellat",
        Owner: "nostrum",
        Repo: "illum",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/pages#update-information-about-a-github-pages-site>
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateInformationAboutPagesSite(ctx, operations.ReposUpdateInformationAboutPagesSiteRequest{
        RequestBody: operations.ReposUpdateInformationAboutPagesSiteRequestBody5{
            BuildType: operations.ReposUpdateInformationAboutPagesSiteRequestBody5BuildTypeEnumLegacy.ToPointer(),
            Cname: sdk.String("esse"),
            HTTPSEnforced: false,
            Source: operations.ReposUpdateInformationAboutPagesSiteRequestBody5Source1EnumGhPages.ToPointer(),
        },
        Owner: "temporibus",
        Repo: "optio",
    })
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/collaborators/invitations#update-a-repository-invitation>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#update-pull-request-review-protection>
...
func main() {
    ...
    res, err := s.Repos.ReposUpdatePullRequestReviewProtection(ctx, operations.ReposUpdatePullRequestReviewProtectionRequest{
        RequestBody: &operations.ReposUpdatePullRequestReviewProtectionRequestBody{
            ...
            RequireCodeOwnerReviews: sdk.Bool(false),
            RequiredApprovingReviewCount: sdk.Int64(357984),
        },
        Branch: "est",
        Owner: "iure",
        Repo: "quisquam",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#update-a-release>
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateRelease(ctx, operations.ReposUpdateReleaseRequest{
        RequestBody: &operations.ReposUpdateReleaseRequestBody{
            ...
            Draft: sdk.Bool(false),
            Name: sdk.String("Archie Hilll"),
            Prerelease: sdk.Bool(false),
            TagName: sdk.String("minima"),
            TargetCommitish: sdk.String("tempora"),
        },
        Owner: "perferendis",
        ReleaseID: 546963,
        Repo: "doloremque",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#update-a-release-asset>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/branches/branch-protection#update-status-check-protection>
        ...
        RequestBody: &operations.ReposUpdateStatusCheckProtectionRequestBody{
            Checks: []ReposUpdateStatusCheckProtectionRequestBodyChecks{
                operations.ReposUpdateStatusCheckProtectionRequestBodyChecks{
                    AppID: sdk.Int64(743795),
                    Context: "fugiat",
                },
                operations.ReposUpdateStatusCheckProtectionRequestBodyChecks{
                    AppID: sdk.Int64(389287),
                    Context: "nam",
                },
                operations.ReposUpdateStatusCheckProtectionRequestBodyChecks{
                    AppID: sdk.Int64(315387),
                    Context: "maiores",
                },
                operations.ReposUpdateStatusCheckProtectionRequestBodyChecks{
                    AppID: sdk.Int64(235482),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/webhooks/repos#update-a-repository-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/webhooks/repo-config#update-a-webhook-configuration-for-a-repository>
...
This endpoint makes use of [a Hypermedia relation](https://docs.github.com/enterprise-server@3.7/rest/overview/resources-in-the-rest-api#hypermedia) to determine which URL to access. The endpoint you call to upload release assets is specific to your release. Use the `upload_url` returned in
the response of the [Create a release endpoint](https://docs.github.com/enterprise-server@3.7/rest/releases/releases#create-a-release) to upload a release asset.
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/repos#upload-a-release-asset>
