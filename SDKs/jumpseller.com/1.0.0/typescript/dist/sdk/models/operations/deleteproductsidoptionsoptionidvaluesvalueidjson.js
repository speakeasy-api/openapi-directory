...
exports.DeleteProductsIdOptionsOptionIdValuesValueIdJsonResponse = exports.DeleteProductsIdOptionsOptionIdValuesValueIdJsonRequest = void 0;
...
var DeleteProductsIdOptionsOptionIdValuesValueIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], DeleteProductsIdOptionsOptionIdValuesValueIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], DeleteProductsIdOptionsOptionIdValuesValueIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], DeleteProductsIdOptionsOptionIdValuesValueIdJsonRequest.prototype, "login", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=option_id",
        }),
        __metadata("design:type", Number)
    ], DeleteProductsIdOptionsOptionIdValuesValueIdJsonRequest.prototype, "optionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=value_id",
        }),
        __metadata("design:type", Number)
    ], DeleteProductsIdOptionsOptionIdValuesValueIdJsonRequest.prototype, "valueId", void 0);
    return DeleteProductsIdOptionsOptionIdValuesValueIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.DeleteProductsIdOptionsOptionIdValuesValueIdJsonRequest = DeleteProductsIdOptionsOptionIdValuesValueIdJsonRequest;
var DeleteProductsIdOptionsOptionIdValuesValueIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], DeleteProductsIdOptionsOptionIdValuesValueIdJsonResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", String)
...
exports.DeleteProductsIdOptionsOptionIdValuesValueIdJsonResponse = DeleteProductsIdOptionsOptionIdValuesValueIdJsonResponse;
