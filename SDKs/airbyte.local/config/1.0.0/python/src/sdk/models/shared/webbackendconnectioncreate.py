...
class WebBackendConnectionCreate:
    ...
    operations: Optional[list[shared_operationcreate.OperationCreate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('operations') }})
