...
class InsertEnumOptionForCustomFieldRequestBody:
    r"""The enum option object to create."""
    
    data: Optional[shared_enumoptioninsertrequest.EnumOptionInsertRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
...
class InsertEnumOptionForCustomFieldRequest:
    ...
    """  
    request_body: Optional[InsertEnumOptionForCustomFieldRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    r"""The enum option object to create."""  
...
class InsertEnumOptionForCustomField200ApplicationJSON:
    r"""Custom field enum option successfully reordered."""
