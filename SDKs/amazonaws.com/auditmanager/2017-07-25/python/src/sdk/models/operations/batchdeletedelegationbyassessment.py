...
class BatchDeleteDelegationByAssessmentRequestBody:
    ...
    delegation_ids: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('delegationIds') }})
    r"""The identifiers for the delegations."""  
...
class BatchDeleteDelegationByAssessmentRequest:
    ...
    request_body: BatchDeleteDelegationByAssessmentRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
