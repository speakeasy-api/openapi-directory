...
public class GetGeneInteractionsRequest {
    ...
    public GetGeneInteractionsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGeneInteractionsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGeneInteractionsRequest withEvidence(String evidence) {
    ...
    public GetGeneInteractionsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGeneInteractionsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGeneInteractionsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGeneInteractionsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGeneInteractionsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGeneInteractionsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGeneInteractionsRequest withRelation(String relation) {
    ...
    public GetGeneInteractionsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGeneInteractionsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGeneInteractionsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetGeneInteractionsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGeneInteractionsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGeneInteractionsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGeneInteractionsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGeneInteractionsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
