...
class AuthorizeSecurityGroupIngressRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class AuthorizeSecurityGroupIngressRequestTagSpecifications:
    ...
    resource_type: Optional[AuthorizeSecurityGroupIngressRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[AuthorizeSecurityGroupIngressRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class AuthorizeSecurityGroupIngressRequest:
    ...
    tag_specifications: Optional[list[AuthorizeSecurityGroupIngressRequestTagSpecifications]] = dataclasses.field(default=None)  
