...
class GetNamesChangesEmbedEnum(str, Enum):
...
class GetNamesChangesOutputSrsEnum(str, Enum):
...
class GetNamesChangesRequest:
    ...
    r"""Defines the earliest date (YYYY-MM-DD format) of the change time window for the search"""  
    ...
    r"""Defines the latest date (YYYY-MM-DD format) of the change time window for the search"""  
    embed: Optional[GetNamesChangesEmbedEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'embed', 'style': 'form', 'explode': True }})
    r"""A flag to indicate whether to embed the corresponding 'feature' into each matching name"""  
    ...
    output_srs: Optional[GetNamesChangesOutputSrsEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outputSRS', 'style': 'form', 'explode': True }})
    r"""The EPSG code of the spatial reference system (SRS) to use for output geometries."""  
