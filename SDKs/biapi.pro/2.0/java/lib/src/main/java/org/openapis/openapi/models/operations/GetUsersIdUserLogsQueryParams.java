...
public class GetUsersIdUserLogsQueryParams {
    /**
     * UUID of a connector
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=connector_uuid")
    public String connectorUuid;
    public GetUsersIdUserLogsQueryParams withConnectorUuid(String connectorUuid) {
    ...
    public String error;
    public GetUsersIdUserLogsQueryParams withError(String error) {
        this.error = error;
        return this;
    }
    ...
    public GetUsersIdUserLogsQueryParams withExpand(String expand) {
        this.expand = expand;
        return this;
    }
    ...
    public GetUsersIdUserLogsQueryParams withIdConnection(Long idConnection) {
    ...
    public GetUsersIdUserLogsQueryParams withIdConnector(Long idConnector) {
    ...
    public Long idMax;
    public GetUsersIdUserLogsQueryParams withIdMax(Long idMax) {
        this.idMax = idMax;
        return this;
    }
    ...
    public GetUsersIdUserLogsQueryParams withIdSource(Long idSource) {
    ...
    public Long idUser;
    public GetUsersIdUserLogsQueryParams withIdUser(Long idUser) {
        this.idUser = idUser;
        return this;
    }
    ...
    public Long limit;
    public GetUsersIdUserLogsQueryParams withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetUsersIdUserLogsQueryParams withMaxDate(LocalDate maxDate) {
    ...
    public GetUsersIdUserLogsQueryParams withMinDate(LocalDate minDate) {
    ...
    public Long offset;
    public GetUsersIdUserLogsQueryParams withOffset(Long offset) {
        this.offset = offset;
        return this;
    }
    ...
    public GetUsersIdUserLogsQueryParams withPeriod(String period) {
        this.period = period;
        return this;
    }
