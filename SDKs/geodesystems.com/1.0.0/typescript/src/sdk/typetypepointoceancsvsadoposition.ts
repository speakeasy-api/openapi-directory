...
export class TypeTypePointOceanCsvSadoPosition {
  ...
  **/
  searchTypePointOceanCsvSadoPosition(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.SearchTypePointOceanCsvSadoPositionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
