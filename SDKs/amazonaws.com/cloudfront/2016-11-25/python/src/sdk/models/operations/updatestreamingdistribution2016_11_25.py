...
class UpdateStreamingDistribution20161125RequestBodyStreamingDistributionConfig:
...
class UpdateStreamingDistribution20161125RequestBody:
    ...
    streaming_distribution_config: UpdateStreamingDistribution20161125RequestBodyStreamingDistributionConfig = dataclasses.field()
    r"""The RTMP distribution's configuration information."""  
...
class UpdateStreamingDistribution20161125Request:
    ...
    r"""The streaming distribution's id."""  
    ...
    r"""The value of the <code>ETag</code> header that you received when retrieving the streaming distribution's configuration. For example: <code>E2QWRUHAPOMQZL</code>."""  
