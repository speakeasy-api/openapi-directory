...
class GetEventsForSubscriptionByIDRequest:
    ...
    id_path_parameter: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""Unique identifier"""  
    ...
    id_query_parameter: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'id', 'style': 'form', 'explode': True }})
    r"""Unique identifier"""  
...
class GetEventsForSubscriptionByID200ApplicationJSON:
    r"""A JSON object containing the events for a specific subscription"""
