...
export const ListShortCodeServerList = ["https://proxy.twilio.com"] as const;
...
export class ListShortCodeListShortCodeResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.ProxyV1ServiceShortCode })
  @Expose({ name: "short_codes" })
  @Type(() => shared.ProxyV1ServiceShortCode)
