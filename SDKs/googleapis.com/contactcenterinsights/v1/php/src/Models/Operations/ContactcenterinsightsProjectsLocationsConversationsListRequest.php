...
class ContactcenterinsightsProjectsLocationsConversationsListRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ContactcenterinsightsProjectsLocationsConversationsListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?ContactcenterinsightsProjectsLocationsConversationsListViewEnum $view = null;
