...
class DeleteThingGroupRequest:
    headers: DeleteThingGroupHeaders = dataclasses.field()
    path_params: DeleteThingGroupPathParams = dataclasses.field()
    query_params: DeleteThingGroupQueryParams = dataclasses.field()
...
class DeleteThingGroupResponse:
    ...
    delete_thing_group_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
