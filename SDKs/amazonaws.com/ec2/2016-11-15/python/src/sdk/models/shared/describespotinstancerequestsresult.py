...
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsFault:
    r"""The fault codes for the Spot Instance request, if any."""
    
    code: Optional[str] = dataclasses.field(default=None)  
    message: Optional[str] = dataclasses.field(default=None)  
    
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsInstanceInterruptionBehaviorEnum(str, Enum):
    r"""The behavior when a Spot Instance is interrupted."""
    HIBERNATE = 'hibernate'
    STOP = 'stop'
    TERMINATE = 'terminate'

class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappingsEbsVolumeTypeEnum(str, Enum):
...
@dataclasses.dataclass
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappingsEbs:
    ...
    volume_type: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappingsEbsVolumeTypeEnum] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappings:
    ...
    ebs: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappingsEbs] = dataclasses.field(default=None)  
    no_device: Optional[str] = dataclasses.field(default=None)  
    virtual_name: Optional[str] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationIamInstanceProfile:
    r"""The IAM instance profile."""
    
    arn: Optional[str] = dataclasses.field(default=None)  
    name: Optional[str] = dataclasses.field(default=None)  
    
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationInstanceTypeEnum(str, Enum):
    r"""The instance type. Only one instance type can be specified."""
    A1_MEDIUM = 'a1.medium'
    A1_LARGE = 'a1.large'
    A1_XLARGE = 'a1.xlarge'
...
@dataclasses.dataclass
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv4Prefixes:
...
@dataclasses.dataclass
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv6Addresses:
...
@dataclasses.dataclass
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesPrivateIPAddresses:
...
@dataclasses.dataclass
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationNetworkInterfaces:
    ...
    ipv4_prefixes: Optional[list[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv4Prefixes]] = dataclasses.field(default=None)  
    ipv6_address_count: Optional[int] = dataclasses.field(default=None)  
    ipv6_addresses: Optional[list[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv6Addresses]] = dataclasses.field(default=None)  
    ipv6_prefix_count: Optional[int] = dataclasses.field(default=None)  
    ipv6_prefixes: Optional[list[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv6Prefixes]] = dataclasses.field(default=None)  
    ...
    private_ip_address: Optional[str] = dataclasses.field(default=None)  
    private_ip_addresses: Optional[list[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesPrivateIPAddresses]] = dataclasses.field(default=None)  
...
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationPlacementTenancyEnum(str, Enum):
...
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationPlacement:
    r"""The placement information for the instance."""
    
    availability_zone: Optional[str] = dataclasses.field(default=None)  
    group_name: Optional[str] = dataclasses.field(default=None)  
    tenancy: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationPlacementTenancyEnum] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationSecurityGroups:
...
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecification:
    r"""Additional information for launching instances."""
    
    addressing_type: Optional[str] = dataclasses.field(default=None)  
    block_device_mappings: Optional[list[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappings]] = dataclasses.field(default=None)  
    ebs_optimized: Optional[bool] = dataclasses.field(default=None)  
    iam_instance_profile: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationIamInstanceProfile] = dataclasses.field(default=None)  
    image_id: Optional[str] = dataclasses.field(default=None)  
    instance_type: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationInstanceTypeEnum] = dataclasses.field(default=None)  
    kernel_id: Optional[str] = dataclasses.field(default=None)  
    key_name: Optional[str] = dataclasses.field(default=None)  
    monitoring: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationMonitoring] = dataclasses.field(default=None)  
    network_interfaces: Optional[list[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationNetworkInterfaces]] = dataclasses.field(default=None)  
    placement: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationPlacement] = dataclasses.field(default=None)  
    ramdisk_id: Optional[str] = dataclasses.field(default=None)  
    security_groups: Optional[list[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecificationSecurityGroups]] = dataclasses.field(default=None)  
    subnet_id: Optional[str] = dataclasses.field(default=None)  
    user_data: Optional[str] = dataclasses.field(default=None)  
    
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsProductDescriptionEnum(str, Enum):
    r"""The product description associated with the Spot Instance."""
    LINUX_UNIX = 'Linux/UNIX'
    LINUX_UNIX_AMAZON_VPC_ = 'Linux/UNIX (Amazon VPC)'
    WINDOWS = 'Windows'
    WINDOWS_AMAZON_VPC_ = 'Windows (Amazon VPC)'

class DescribeSpotInstanceRequestsResultSpotInstanceRequestsStateEnum(str, Enum):
    r"""The state of the Spot Instance request. Spot request status information helps track your Spot Instance requests. For more information, see <a href=\\"https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-request-status.html\\">Spot request status</a> in the <i>Amazon EC2 User Guide for Linux Instances</i>."""
    OPEN = 'open'
    ACTIVE = 'active'
    CLOSED = 'closed'
    CANCELLED = 'cancelled'
...
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsStatus:
    r"""The status code and status message describing the Spot Instance request."""
...
@dataclasses.dataclass
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsTags:
    r"""Describes a tag."""
    
    key: Optional[str] = dataclasses.field(default=None)  
    value: Optional[str] = dataclasses.field(default=None)  
    
class DescribeSpotInstanceRequestsResultSpotInstanceRequestsTypeEnum(str, Enum):
...
class DescribeSpotInstanceRequestsResultSpotInstanceRequests:
    r"""Describes a Spot Instance request."""
    
    actual_block_hourly_price: Optional[str] = dataclasses.field(default=None)  
    ...
    fault: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsFault] = dataclasses.field(default=None)  
    instance_id: Optional[str] = dataclasses.field(default=None)  
    instance_interruption_behavior: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsInstanceInterruptionBehaviorEnum] = dataclasses.field(default=None)  
    launched_availability_zone: Optional[str] = dataclasses.field(default=None)  
    launch_group: Optional[str] = dataclasses.field(default=None)  
    launch_specification: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsLaunchSpecification] = dataclasses.field(default=None)  
    product_description: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsProductDescriptionEnum] = dataclasses.field(default=None)  
    ...
    state: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsStateEnum] = dataclasses.field(default=None)  
    status: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsStatus] = dataclasses.field(default=None)  
    tags: Optional[list[DescribeSpotInstanceRequestsResultSpotInstanceRequestsTags]] = dataclasses.field(default=None)  
    type: Optional[DescribeSpotInstanceRequestsResultSpotInstanceRequestsTypeEnum] = dataclasses.field(default=None)  
...
class DescribeSpotInstanceRequestsResult:
    r"""Contains the output of DescribeSpotInstanceRequests."""
    
    next_token: Optional[str] = dataclasses.field(default=None)  
    spot_instance_requests: Optional[list[DescribeSpotInstanceRequestsResultSpotInstanceRequests]] = dataclasses.field(default=None)  
