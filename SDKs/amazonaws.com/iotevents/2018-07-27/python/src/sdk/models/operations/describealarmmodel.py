...
from ..shared import describealarmmodelresponse as shared_describealarmmodelresponse
...
class DescribeAlarmModelRequest:
    headers: DescribeAlarmModelHeaders = dataclasses.field()
    path_params: DescribeAlarmModelPathParams = dataclasses.field()
    query_params: DescribeAlarmModelQueryParams = dataclasses.field()
...
class DescribeAlarmModelResponse:
    ...
    describe_alarm_model_response: Optional[shared_describealarmmodelresponse.DescribeAlarmModelResponse] = dataclasses.field(default=None)
