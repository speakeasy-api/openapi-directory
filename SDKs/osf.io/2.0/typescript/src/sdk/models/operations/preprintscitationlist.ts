 ...
 */
export class PreprintsCitationListCitationDetailAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class PreprintsCitationListCitationDetailLinks extends SpeakeasyBase {
  /**
...
export class PreprintsCitationListCitationDetail extends SpeakeasyBase {
  /**
   * The properties of the citation entity.
   */
  @SpeakeasyMetadata()
