...
public class GetSigningBasketAuthorisationHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Digest")
    public String digest;
    public GetSigningBasketAuthorisationHeaders withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-Accept")
    public String psuAccept;
    public GetSigningBasketAuthorisationHeaders withPsuAccept(String psuAccept) {
    ...
    public GetSigningBasketAuthorisationHeaders withPsuAcceptCharset(String psuAcceptCharset) {
    ...
    public GetSigningBasketAuthorisationHeaders withPsuAcceptEncoding(String psuAcceptEncoding) {
    ...
    public GetSigningBasketAuthorisationHeaders withPsuAcceptLanguage(String psuAcceptLanguage) {
    ...
    public GetSigningBasketAuthorisationHeaders withPsuDeviceId(String psuDeviceID) {
    ...
    public GetSigningBasketAuthorisationHeaders withPsuGeoLocation(String psuGeoLocation) {
    ...
    public GetSigningBasketAuthorisationHeaders withPsuHttpMethod(openapisdk.models.shared.PsuHttpMethodEnum psuHttpMethod) {
    ...
    public GetSigningBasketAuthorisationHeaders withPsuIpAddress(String psuIPAddress) {
        this.psuIPAddress = psuIPAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-IP-Port")
    public String psuIPPort;
    public GetSigningBasketAuthorisationHeaders withPsuIpPort(String psuIPPort) {
    ...
    public GetSigningBasketAuthorisationHeaders withPsuUserAgent(String psuUserAgent) {
        this.psuUserAgent = psuUserAgent;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Signature")
    public String signature;
    public GetSigningBasketAuthorisationHeaders withSignature(String signature) {
    ...
    public GetSigningBasketAuthorisationHeaders withTppSignatureCertificate(String tppSignatureCertificate) {
    ...
    public GetSigningBasketAuthorisationHeaders withXRequestId(String xRequestID) {
