...
class EditCommentRequest:
    path_params: EditCommentPathParams = dataclasses.field()
    request: EditCommentRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/vnd.vimeo.comment+json' }})
    security: EditCommentSecurity = dataclasses.field()
