...
class DeleteSlackWorkspaceConfigurationRequest:
    ...
    request_body: DeleteSlackWorkspaceConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DeleteSlackWorkspaceConfigurationResponse:
    ...
    r"""ConflictException"""  
    delete_slack_workspace_configuration_result: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
