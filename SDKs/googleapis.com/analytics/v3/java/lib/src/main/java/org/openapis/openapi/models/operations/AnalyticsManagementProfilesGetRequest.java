...
public class AnalyticsManagementProfilesGetRequest {
    ...
    public AnalyticsManagementProfilesGetRequest(@JsonProperty("accountId") String accountId, @JsonProperty("profileId") String profileId, @JsonProperty("webPropertyId") String webPropertyId) {
        this.accountId = accountId;
        this.profileId = profileId;
        this.webPropertyId = webPropertyId;
  }
