...
public class DropletActions {
	...
	public DropletActions(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
     ...
     * 
    **/
    public openapisdk.models.operations.GetDropletActionResponse getDropletAction(openapisdk.models.operations.GetDropletActionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v2/droplets/{droplet_id}/actions/{action_id}", request.pathParams);
        ...
        openapisdk.models.operations.GetDropletActionResponse res = new openapisdk.models.operations.GetDropletActionResponse() {{
            getDropletAction200ApplicationJSONAny = null;
            getDropletAction401ApplicationJSONObject = null;
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.GetDropletAction401ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetDropletAction401ApplicationJson.class);
     ...
     * 
    **/
    public openapisdk.models.operations.ListDropletActionsResponse listDropletActions(openapisdk.models.operations.ListDropletActionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v2/droplets/{droplet_id}/actions", request.pathParams);
        ...
        openapisdk.models.operations.ListDropletActionsResponse res = new openapisdk.models.operations.ListDropletActionsResponse() {{
            listDropletActions200ApplicationJSONObject = null;
            listDropletActions401ApplicationJSONObject = null;
            onev211ClicksGetResponses401ContentApplication1jsonSchema = null;
            onev211ClicksGetResponses401ContentApplication1jsonSchema = null;
            onev211ClicksGetResponses401ContentApplication1jsonSchema = null;
            onev211ClicksGetResponses401ContentApplication1jsonSchema = null;
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.ListDropletActions200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.ListDropletActions200ApplicationJson.class);
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.ListDropletActions401ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.ListDropletActions401ApplicationJson.class);
     ...
     * 
    **/
    public openapisdk.models.operations.PostDropletActionResponse postDropletAction(openapisdk.models.operations.PostDropletActionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v2/droplets/{droplet_id}/actions", request.pathParams);
        ...
        openapisdk.models.operations.PostDropletActionResponse res = new openapisdk.models.operations.PostDropletActionResponse() {{
            postDropletAction201ApplicationJSONAny = null;
            postDropletAction401ApplicationJSONObject = null;
            onev211ClicksGetResponses401ContentApplication1jsonSchema = null;
            onev211ClicksGetResponses401ContentApplication1jsonSchema = null;
            onev211ClicksGetResponses401ContentApplication1jsonSchema = null;
            onev211ClicksGetResponses401ContentApplication1jsonSchema = null;
        ...
        if (httpRes.statusCode() == 201) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.PostDropletAction401ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.PostDropletAction401ApplicationJson.class);
     ...
     * 
    **/
    public openapisdk.models.operations.PostDropletActionByTagResponse postDropletActionByTag(openapisdk.models.operations.PostDropletActionByTagRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v2/droplets/actions");
        ...
        openapisdk.models.operations.PostDropletActionByTagResponse res = new openapisdk.models.operations.PostDropletActionByTagResponse() {{
            postDropletActionByTag201ApplicationJSONAny = null;
            postDropletActionByTag401ApplicationJSONObject = null;
            onev211ClicksGetResponses401ContentApplication1jsonSchema = null;
            onev211ClicksGetResponses401ContentApplication1jsonSchema = null;
            onev211ClicksGetResponses401ContentApplication1jsonSchema = null;
        }};
        ...
        if (httpRes.statusCode() == 201) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.PostDropletActionByTag401ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.PostDropletActionByTag401ApplicationJson.class);
