...
exports.PostProductsIdOptionsOptionIdValuesJsonResponse = exports.PostProductsIdOptionsOptionIdValuesJsonRequest = void 0;
...
var PostProductsIdOptionsOptionIdValuesJsonRequest = /** @class */ (function (_super) {
    ...
    ], PostProductsIdOptionsOptionIdValuesJsonRequest.prototype, "productOptionValueEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PostProductsIdOptionsOptionIdValuesJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PostProductsIdOptionsOptionIdValuesJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PostProductsIdOptionsOptionIdValuesJsonRequest.prototype, "login", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=option_id",
        }),
        __metadata("design:type", Number)
    ], PostProductsIdOptionsOptionIdValuesJsonRequest.prototype, "optionId", void 0);
    return PostProductsIdOptionsOptionIdValuesJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PostProductsIdOptionsOptionIdValuesJsonRequest = PostProductsIdOptionsOptionIdValuesJsonRequest;
var PostProductsIdOptionsOptionIdValuesJsonResponse = /** @class */ (function (_super) {
    ...
    ], PostProductsIdOptionsOptionIdValuesJsonResponse.prototype, "rawResponse", void 0);
    return PostProductsIdOptionsOptionIdValuesJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PostProductsIdOptionsOptionIdValuesJsonResponse = PostProductsIdOptionsOptionIdValuesJsonResponse;
