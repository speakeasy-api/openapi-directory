...
class ToolresultsProjectsHistoriesExecutionsStepsPerfMetricsSummaryCreateRequest:
    ...
    perf_metrics_summary: Optional[shared_perfmetricssummary.PerfMetricsSummary] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
