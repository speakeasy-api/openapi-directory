 ...
 */
export enum SslCertificateListWarningCodeEnum {
...
export class SslCertificateListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SslCertificateListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: SslCertificateListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: SslCertificateListWarningData })
  @Expose({ name: "data" })
  @Type(() => SslCertificateListWarningData)
  data?: SslCertificateListWarningData[];
 ...
 */
export class SslCertificateList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: SslCertificate })
  @Expose({ name: "items" })
  @Type(() => SslCertificate)
