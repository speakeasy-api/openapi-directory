...
const (
	UntagResourceXAmzTargetEnumOpsWorks20130218UntagResource UntagResourceXAmzTargetEnum = "OpsWorks_20130218.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "OpsWorks_20130218.UntagResource":
