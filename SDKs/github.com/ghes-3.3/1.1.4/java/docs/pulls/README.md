...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCheckIfMergedRequest req = new PullsCheckIfMergedRequest("sequi", 493958L, "neque");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateRequest req = new PullsCreateRequest(                new PullsCreateRequestBody("quo", "deleniti") {{
                                body = "quibusdam";
                                draft = false;
                                issue = 1L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReplyForReviewCommentRequest req = new PullsCreateReplyForReviewCommentRequest(                new PullsCreateReplyForReviewCommentRequestBody("vel");, 300824L, "quibusdam", 78969L, "facere");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReviewRequest req = new PullsCreateReviewRequest("libero", 102413L, "voluptatibus") {{
                requestBody = new PullsCreateReviewRequestBody() {{
                    ...
                    comments = new org.openapis.openapi.models.operations.PullsCreateReviewRequestBodyComments[]{{
                        add(new PullsCreateReviewRequestBodyComments("accusantium", "vel") {{
                            body = "aliquam";
                            line = 28L;
                            path = "velit";
                            position = 75359L;
                        ...
                        add(new PullsCreateReviewRequestBodyComments("excepturi", "eum") {{
                            body = "ea";
                            line = 28L;
                            path = "beatae";
                            position = 877751L;
                        ...
                        add(new PullsCreateReviewRequestBodyComments("earum", "dicta") {{
                            body = "velit";
                            line = 28L;
                            path = "ut";
                            position = 596433L;
                        ...
                        add(new PullsCreateReviewRequestBodyComments("itaque", "alias") {{
                            body = "impedit";
                            line = 28L;
                            path = "voluptatibus";
                            position = 610987L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReviewCommentRequest req = new PullsCreateReviewCommentRequest(                new PullsCreateReviewCommentRequestBody("velit", "laborum", 250398L, "dolor") {{
                                inReplyTo = 2L;
                                position = 483394L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDeletePendingReviewRequest req = new PullsDeletePendingReviewRequest("quidem", 377406L, "facilis", 809365L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDeleteReviewCommentRequest req = new PullsDeleteReviewCommentRequest(596065L, "expedita", "deleniti");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDismissReviewRequest req = new PullsDismissReviewRequest(                new PullsDismissReviewRequestBody("a") {{
                                event = PullsDismissReviewRequestBodyEventEnum.DISMISS;
                            }};, "voluptate", 351936L, "unde", 897543L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetRequest req = new PullsGetRequest("animi", 769967L, "ipsam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetReviewRequest req = new PullsGetReviewRequest("corporis", 668234L, "error", 456885L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetReviewCommentRequest req = new PullsGetReviewCommentRequest(288570L, "veritatis", "vero");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListRequest req = new PullsListRequest("consectetur", "vitae") {{
                base = "inventore";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListCommentsForReviewRequest req = new PullsListCommentsForReviewRequest("soluta", 726227L, "rem", 678060L) {{
                page = 487676L;
                perPage = 144691L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListCommitsRequest req = new PullsListCommitsRequest("alias", 168042L, "vel") {{
                page = 64435L;
                perPage = 63553L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListFilesRequest req = new PullsListFilesRequest("modi", 208253L, "exercitationem") {{
                page = 932394L;
                perPage = 88248L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListRequestedReviewersRequest req = new PullsListRequestedReviewersRequest("ipsum", 602229L, "nulla");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewCommentsRequest req = new PullsListReviewCommentsRequest("distinctio", 802894L, "quia") {{
                direction = PullsListReviewCommentsDirectionEnum.ASC;
                page = 342137L;
                perPage = 605712L;
                since = OffsetDateTime.parse("2022-10-08T13:36:13.725Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewCommentsForRepoRequest req = new PullsListReviewCommentsForRepoRequest("libero", "fugiat") {{
                direction = PullsListReviewCommentsForRepoDirectionEnum.DESC;
                page = 554603L;
                perPage = 811939L;
                since = OffsetDateTime.parse("2022-07-10T00:35:28.130Z");
                sort = PullsListReviewCommentsForRepoSortEnum.CREATED;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewsRequest req = new PullsListReviewsRequest("voluptates", 80061L, "aperiam") {{
                page = 517137L;
                perPage = 292888L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsMergeRequest req = new PullsMergeRequest("eligendi", 715053L, "voluptatem") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsRequestReviewersRequest req = new PullsRequestReviewersRequest("ea", 421819L, "ipsam") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsSubmitReviewRequest req = new PullsSubmitReviewRequest(                new PullsSubmitReviewRequestBody(PullsSubmitReviewRequestBodyEventEnum.COMMENT) {{
                                body = "fuga";
                            }};, "repudiandae", 34070L, "expedita", 885208L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateRequest req = new PullsUpdateRequest("eos", 844854L, "odio") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateBranchRequest req = new PullsUpdateBranchRequest("error", 937117L, "adipisci") {{
                requestBody = new PullsUpdateBranchRequestBody() {{
                    expectedHeadSha = "recusandae";
                }};;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateReviewRequest req = new PullsUpdateReviewRequest(                new PullsUpdateReviewRequestBody("similique");, "ut", 693746L, "quis", 106255L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateReviewCommentRequest req = new PullsUpdateReviewCommentRequest(                new PullsUpdateReviewCommentRequestBody("unde");, 476946L, "delectus", "cupiditate");            
