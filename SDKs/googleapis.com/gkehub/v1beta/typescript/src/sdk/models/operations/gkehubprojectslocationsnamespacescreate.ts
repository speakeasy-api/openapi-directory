...
export class GkehubProjectsLocationsNamespacesCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkehubProjectsLocationsNamespacesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GkehubProjectsLocationsNamespacesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
