 ...
 */
export enum AccountSupportingEntityCapabilityAllowedLevelEnum {
  High = "high",
  Low = "low",
  Medium = "medium",
 ...
 * Possible values: **notApplicable**, **low**, **medium**, **high**.
 */
export enum AccountSupportingEntityCapabilityRequestedLevelEnum {
  High = "high",
  Low = "low",
  Medium = "medium",
  NotApplicable = "notApplicable",
 ...
 *
 */
export enum AccountSupportingEntityCapabilityVerificationStatusEnum {
  Invalid = "invalid",
  Pending = "pending",
  Rejected = "rejected",
  Valid = "valid",
...
export class AccountSupportingEntityCapability extends SpeakeasyBase {
  /**
...
export class AccountSupportingEntityCapabilityInput extends SpeakeasyBase {
  /**
   * Indicates whether the capability is enabled. If **false**, the capability is temporarily disabled for the account holder.
   */
  @SpeakeasyMetadata()
