 ...
 */
export declare enum SecurityPolicyListWarningCodeEnum {
...
export declare class SecurityPolicyListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class SecurityPolicyListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: SecurityPolicyListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: SecurityPolicyListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class SecurityPolicyList extends SpeakeasyBase {
    etag?: string;
    /**
