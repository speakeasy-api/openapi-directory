...
public class ChromemanagementCustomersReportsCountPrintJobsByPrinterPathParams {
    /**
    ...
    public ChromemanagementCustomersReportsCountPrintJobsByPrinterPathParams withCustomer(String customer) {
