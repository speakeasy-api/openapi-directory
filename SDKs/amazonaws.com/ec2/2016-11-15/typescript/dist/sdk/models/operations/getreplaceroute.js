...
exports.GetReplaceRouteResponse = exports.GetReplaceRouteRequest = exports.GetReplaceRouteHeaders = exports.GetReplaceRouteQueryParams = exports.GetReplaceRouteVersionEnum = exports.GetReplaceRouteActionEnum = void 0;
...
var GetReplaceRouteQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=DestinationIpv6CidrBlock" }),
        __metadata("design:type", String)
    ], GetReplaceRouteQueryParams.prototype, "destinationIpv6CidrBlock", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=DestinationPrefixListId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=EgressOnlyInternetGatewayId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=LocalGatewayId" }),
        __metadata("design:type", String)
    ], GetReplaceRouteQueryParams.prototype, "localGatewayId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=LocalTarget" }),
        __metadata("design:type", Boolean)
    ], GetReplaceRouteQueryParams.prototype, "localTarget", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=NatGatewayId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=VpcEndpointId" }),
        __metadata("design:type", String)
...
exports.GetReplaceRouteQueryParams = GetReplaceRouteQueryParams;
...
exports.GetReplaceRouteHeaders = GetReplaceRouteHeaders;
