...
exports.ListAppResponse = exports.ListAppListAppResponse = exports.ListAppListAppResponseMeta = exports.ListAppRequest = exports.ListAppSecurity = exports.ListAppServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListAppServerList = ["https://microvisor.twilio.com"];
var ListAppSecurity = /** @class */ (function (_super) {
    ...
    ], ListAppSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListAppSecurity.prototype, "username", void 0);
...
var ListAppRequest = /** @class */ (function (_super) {
    ...
    ], ListAppRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListAppRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListAppRequest.prototype, "pageToken", void 0);
...
var ListAppListAppResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.MicrovisorV1App }),
        (0, class_transformer_1.Expose)({ name: "apps" }),
        (0, class_transformer_1.Type)(function () { return shared.MicrovisorV1App; }),
        __metadata("design:type", Array)
    ], ListAppListAppResponse.prototype, "apps", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListAppListAppResponseMeta; }),
...
var ListAppResponse = /** @class */ (function (_super) {
    ...
    ], ListAppResponse.prototype, "rawResponse", void 0);
