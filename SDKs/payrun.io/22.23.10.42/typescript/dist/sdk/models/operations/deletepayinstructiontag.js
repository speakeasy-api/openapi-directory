...
exports.DeletePayInstructionTagResponse = exports.DeletePayInstructionTagRequest = void 0;
...
var DeletePayInstructionTagRequest = /** @class */ (function (_super) {
    ...
    ], DeletePayInstructionTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeletePayInstructionTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], DeletePayInstructionTagRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeletePayInstructionTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayInstructionId",
        }),
        __metadata("design:type", String)
    ], DeletePayInstructionTagRequest.prototype, "payInstructionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], DeletePayInstructionTagRequest.prototype, "tagId", void 0);
...
var DeletePayInstructionTagResponse = /** @class */ (function (_super) {
    ...
    ], DeletePayInstructionTagResponse.prototype, "rawResponse", void 0);
