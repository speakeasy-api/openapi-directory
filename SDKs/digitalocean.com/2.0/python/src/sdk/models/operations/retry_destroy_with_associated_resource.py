...
class RetryDestroyWithAssociatedResourceRequest:
    path_params: RetryDestroyWithAssociatedResourcePathParams = dataclasses.field()
...
class RetryDestroyWithAssociatedResourceResponse:
    ...
    retry_destroy_with_associated_resource_401_application_json_object: Optional[RetryDestroyWithAssociatedResource401ApplicationJSON] = dataclasses.field(default=None)
