...
from ..shared import accounttokenrequest as shared_accounttokenrequest
...
class GetAccountTokenRequest:
    ...
    account_token_request: shared_accounttokenrequest.AccountTokenRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetAccountTokenResponse:
    ...
    access_tokens: Optional[list[shared_accesstoken.AccessToken]] = dataclasses.field(default=None)
    r"""OK"""  
