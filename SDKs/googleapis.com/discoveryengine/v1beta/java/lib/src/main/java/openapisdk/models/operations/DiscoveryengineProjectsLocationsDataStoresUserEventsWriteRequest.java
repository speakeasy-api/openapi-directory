...
public class DiscoveryengineProjectsLocationsDataStoresUserEventsWriteRequest {
    ...
    public openapisdk.models.shared.GoogleCloudDiscoveryengineV1betaUserEvent request;
    public DiscoveryengineProjectsLocationsDataStoresUserEventsWriteRequest withRequest(openapisdk.models.shared.GoogleCloudDiscoveryengineV1betaUserEvent request) {
