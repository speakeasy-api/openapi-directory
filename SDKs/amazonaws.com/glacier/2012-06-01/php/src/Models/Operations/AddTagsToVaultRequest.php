...
class AddTagsToVaultRequest
{
	...
	{
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\AddTagsToVaultRequestBody();
		...
		$this->accountId = "";
		$this->operation = \OpenAPI\OpenAPI\Models\Operations\AddTagsToVaultOperationEnum::ADD;
		$this->vaultName = "";
	}
}
