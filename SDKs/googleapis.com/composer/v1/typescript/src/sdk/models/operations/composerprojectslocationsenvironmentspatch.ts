...
export class ComposerProjectsLocationsEnvironmentsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ComposerProjectsLocationsEnvironmentsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ComposerProjectsLocationsEnvironmentsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
