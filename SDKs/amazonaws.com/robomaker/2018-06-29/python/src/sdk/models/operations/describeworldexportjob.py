...
class DescribeWorldExportJobRequestBody:
    ...
    r"""The Amazon Resource Name (arn) of the world export job to describe."""  
    

@dataclasses.dataclass
class DescribeWorldExportJobRequest:
    
    request_body: DescribeWorldExportJobRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
