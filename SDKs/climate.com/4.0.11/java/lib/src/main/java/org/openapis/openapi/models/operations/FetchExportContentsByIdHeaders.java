...
public class FetchExportContentsByIdHeaders {
    /**
     * Must be either \* /* or application/octet-stream,application/json
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Accept")
    public String accept;
    public FetchExportContentsByIdHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public String range;
    public FetchExportContentsByIdHeaders withRange(String range) {
        this.range = range;
        return this;
    }
