...
class ListTaskQueueListTaskQueueResponse:
    meta: Optional[ListTaskQueueListTaskQueueResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    task_queues: Optional[list[shared_taskrouter_v1_workspace_task_queue.TaskrouterV1WorkspaceTaskQueue]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('task_queues') }})
    

@dataclasses.dataclass
class ListTaskQueueRequest:
    path_params: ListTaskQueuePathParams = dataclasses.field()
    query_params: ListTaskQueueQueryParams = dataclasses.field()
    security: ListTaskQueueSecurity = dataclasses.field()
