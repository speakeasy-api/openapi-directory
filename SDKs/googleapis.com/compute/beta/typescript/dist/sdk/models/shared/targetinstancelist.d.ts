 ...
 */
export declare enum TargetInstanceListWarningCodeEnum {
...
export declare class TargetInstanceListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetInstanceListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class TargetInstanceList extends SpeakeasyBase {
    /**
