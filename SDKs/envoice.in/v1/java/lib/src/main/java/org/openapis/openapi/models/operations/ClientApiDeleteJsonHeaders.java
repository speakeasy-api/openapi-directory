...
public class ClientApiDeleteJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ClientApiDeleteJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public ClientApiDeleteJsonHeaders withXAuthSecret(String xAuthSecret) {
