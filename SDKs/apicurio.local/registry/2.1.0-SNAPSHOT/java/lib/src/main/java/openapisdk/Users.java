...
public class Users {
    ...
    **/
    public openapisdk.models.operations.GetCurrentUserInfoResponse getCurrentUserInfo() throws Exception {
        ...
        openapisdk.models.operations.GetCurrentUserInfoResponse res = new openapisdk.models.operations.GetCurrentUserInfoResponse() {{
            userInfo = null;
            error = null;
        }};
