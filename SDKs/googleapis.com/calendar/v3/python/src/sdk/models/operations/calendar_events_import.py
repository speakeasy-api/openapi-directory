...
class CalendarEventsImportSecurity:
    option1: Optional[CalendarEventsImportSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CalendarEventsImportSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class CalendarEventsImportRequest:
    path_params: CalendarEventsImportPathParams = dataclasses.field()
    query_params: CalendarEventsImportQueryParams = dataclasses.field()
    security: CalendarEventsImportSecurity = dataclasses.field()
