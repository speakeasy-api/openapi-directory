...
public class GETListTypeVersionsRequest {
    ...
    public GETListTypeVersionsRequest(@JsonProperty("Action") GETListTypeVersionsActionEnum action, @JsonProperty("Version") GETListTypeVersionsVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
