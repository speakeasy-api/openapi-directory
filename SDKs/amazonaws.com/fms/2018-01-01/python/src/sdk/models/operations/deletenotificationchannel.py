...
class DeleteNotificationChannelHeaders:
    x_amz_target: DeleteNotificationChannelXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteNotificationChannelRequest:
    headers: DeleteNotificationChannelHeaders = dataclasses.field()
