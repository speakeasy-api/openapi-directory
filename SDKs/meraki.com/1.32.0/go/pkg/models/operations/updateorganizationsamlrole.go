...
const (
	...
	UpdateOrganizationSamlRoleRequestBodyNetworksAccessEnumSsidAdmin       UpdateOrganizationSamlRoleRequestBodyNetworksAccessEnum = "ssid-admin"
)

func (e UpdateOrganizationSamlRoleRequestBodyNetworksAccessEnum) ToPointer() *UpdateOrganizationSamlRoleRequestBodyNetworksAccessEnum {
	return &e
}
...
func (e *UpdateOrganizationSamlRoleRequestBodyNetworksAccessEnum) UnmarshalJSON(data []byte) error {
	...
	case "read-only":
		fallthrough
	case "ssid-admin":
		*e = UpdateOrganizationSamlRoleRequestBodyNetworksAccessEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationSamlRoleRequestBodyNetworksAccessEnum: %v", v)
	}
}
...
func (e UpdateOrganizationSamlRoleRequestBodyOrgAccessEnum) ToPointer() *UpdateOrganizationSamlRoleRequestBodyOrgAccessEnum {
	return &e
}
...
func (e *UpdateOrganizationSamlRoleRequestBodyOrgAccessEnum) UnmarshalJSON(data []byte) error {
	...
	case "none":
		fallthrough
	case "read-only":
		*e = UpdateOrganizationSamlRoleRequestBodyOrgAccessEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationSamlRoleRequestBodyOrgAccessEnum: %v", v)
	}
}
...
func (e UpdateOrganizationSamlRoleRequestBodyTagsAccessEnum) ToPointer() *UpdateOrganizationSamlRoleRequestBodyTagsAccessEnum {
	return &e
}
...
func (e *UpdateOrganizationSamlRoleRequestBodyTagsAccessEnum) UnmarshalJSON(data []byte) error {
	...
	case "monitor-only":
		fallthrough
	case "read-only":
		*e = UpdateOrganizationSamlRoleRequestBodyTagsAccessEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationSamlRoleRequestBodyTagsAccessEnum: %v", v)
	}
}
