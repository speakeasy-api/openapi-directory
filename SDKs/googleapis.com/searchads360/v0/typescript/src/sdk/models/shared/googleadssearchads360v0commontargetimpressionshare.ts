 ...
 */
export enum GoogleAdsSearchads360V0CommonTargetImpressionShareLocationEnum {
 ...
 */
export class GoogleAdsSearchads360V0CommonTargetImpressionShare extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "locationFractionMicros" })
