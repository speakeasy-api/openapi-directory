...
export class PostServersIdActionsShutdownActionResponseAction extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => PostServersIdActionsShutdownActionResponseActionError)
  ...
  @Type(() => PostServersIdActionsShutdownActionResponseActionResources)
...
export class PostServersIdActionsShutdownActionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "action" })
  @Type(() => PostServersIdActionsShutdownActionResponseAction)
