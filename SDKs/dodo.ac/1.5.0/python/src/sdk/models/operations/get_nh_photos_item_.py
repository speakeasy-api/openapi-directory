...
class GetNhPhotosItemRequest:
    ...
    r"""The name of the photo or poster you wish to retrieve information about."""  
...
class GetNhPhotosItemResponse:
    ...
    nh_photo: Optional[shared_nhphoto.NHPhoto] = dataclasses.field(default=None)
