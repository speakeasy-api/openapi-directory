...
func main() {
    ...
    res, err := s.Apps.AppsListInstallations(ctx, operations.AppsListInstallationsRequest{
        Outdated: sdk.String("odio"),
        Page: sdk.Int64(311796),
        PerPage: sdk.Int64(881005),
        Since: types.MustTimeFromString("2021-01-18T05:23:42.271Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
