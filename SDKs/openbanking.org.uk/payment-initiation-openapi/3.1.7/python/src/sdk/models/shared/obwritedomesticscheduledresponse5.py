...
class ObWriteDomesticScheduledResponse5DataInitiation:
    ...
    creditor_account: ObWriteDomesticScheduledResponse5DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('CreditorAccount') }})
    instructed_amount: ObWriteDomesticScheduledResponse5DataInitiationInstructedAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('InstructedAmount') }})
    ...
    debtor_account: Optional[ObWriteDomesticScheduledResponse5DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DebtorAccount') }})
    ...
    remittance_information: Optional[ObWriteDomesticScheduledResponse5DataInitiationRemittanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RemittanceInformation') }})
...
class ObWriteDomesticScheduledResponse5DataMultiAuthorisation:
    ...
    status: ObWriteDomesticScheduledResponse5DataMultiAuthorisationStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Status') }})
...
class ObWriteDomesticScheduledResponse5DataRefund:
    ...
    account: ObWriteDomesticScheduledResponse5DataRefundAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Account') }})
...
class ObWriteDomesticScheduledResponse5Data:
    ...
    domestic_scheduled_payment_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('DomesticScheduledPaymentId') }})
    initiation: ObWriteDomesticScheduledResponse5DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Initiation') }})
    status: ObWriteDomesticScheduledResponse5DataStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Status') }})
    ...
    charges: Optional[list[ObWriteDomesticScheduledResponse5DataCharges]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Charges') }})
    ...
    multi_authorisation: Optional[ObWriteDomesticScheduledResponse5DataMultiAuthorisation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('MultiAuthorisation') }})
    refund: Optional[ObWriteDomesticScheduledResponse5DataRefund] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Refund') }})
    

@dataclass_json
@dataclasses.dataclass
class ObWriteDomesticScheduledResponse5:
    data: ObWriteDomesticScheduledResponse5Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Data') }})
