...
type DetectTargetedSentimentHeaders struct {
...
type DetectTargetedSentimentRequest struct {
	Headers DetectTargetedSentimentHeaders
	Request shared.DetectTargetedSentimentRequest `request:"mediaType=application/json"`
}
