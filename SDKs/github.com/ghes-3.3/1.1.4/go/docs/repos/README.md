...
func main() {
    ...
    res, err := s.Repos.ReposCreateCommitComment(ctx, operations.ReposCreateCommitCommentRequest{
        RequestBody: operations.ReposCreateCommitCommentRequestBody{
            Body: "enim",
            Line: sdk.Int64(965090),
            Path: sdk.String("iusto"),
            Position: sdk.Int64(491201),
        },
        CommitSha: "libero",
        Owner: "illo",
        Repo: "ab",
...
func main() {
    ...
    res, err := s.Repos.ReposCreateCommitStatus(ctx, operations.ReposCreateCommitStatusRequest{
        RequestBody: operations.ReposCreateCommitStatusRequestBody{
            ...
            State: operations.ReposCreateCommitStatusRequestBodyStateEnumError,
            TargetURL: sdk.String("reiciendis"),
        },
        Owner: "earum",
        Repo: "reprehenderit",
        Sha: "praesentium",
...
func main() {
    ...
    res, err := s.Repos.ReposCreateDeployment(ctx, operations.ReposCreateDeploymentRequest{
        RequestBody: operations.ReposCreateDeploymentRequestBody{
            ...
            Environment: sdk.String("deleniti"),
...
func main() {
    ...
    res, err := s.Repos.ReposCreateDeploymentStatus(ctx, operations.ReposCreateDeploymentStatusRequest{
        RequestBody: operations.ReposCreateDeploymentStatusRequestBody{
            ...
            EnvironmentURL: sdk.String("expedita"),
            LogURL: sdk.String("quas"),
            State: operations.ReposCreateDeploymentStatusRequestBodyStateEnumQueued,
            TargetURL: sdk.String("repudiandae"),
        },
        DeploymentID: 700045,
        Owner: "dignissimos",
        Repo: "corporis",
...
func main() {
    ...
    res, err := s.Repos.ReposCreateForAuthenticatedUser(ctx, operations.ReposCreateForAuthenticatedUserRequestBody{
        ...
        Homepage: sdk.String("illum"),
        IsTemplate: sdk.Bool(true),
        LicenseTemplate: sdk.String("mit"),
        MergeCommitMessage: operations.ReposCreateForAuthenticatedUserRequestBodyMergeCommitMessageEnumPrTitle.ToPointer(),
        ...
        SquashMergeCommitMessage: operations.ReposCreateForAuthenticatedUserRequestBodySquashMergeCommitMessageEnumBlank.ToPointer(),
        SquashMergeCommitTitle: operations.ReposCreateForAuthenticatedUserRequestBodySquashMergeCommitTitleEnumPrTitle.ToPointer(),
        TeamID: sdk.Int64(97676),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Repos.ReposCreateRelease(ctx, operations.ReposCreateReleaseRequest{
        RequestBody: operations.ReposCreateReleaseRequestBody{
            ...
            TagName: "consectetur",
            TargetCommitish: sdk.String("repellat"),
        },
        Owner: "explicabo",
        Repo: "explicabo",
    })
...
func main() {
    ...
    res, err := s.Repos.ReposCreateUsingTemplate(ctx, operations.ReposCreateUsingTemplateRequest{
        RequestBody: operations.ReposCreateUsingTemplateRequestBody{
            ...
            Owner: sdk.String("delectus"),
            Private: sdk.Bool(false),
        },
        TemplateOwner: "non",
        TemplateRepo: "distinctio",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Repos.ReposCreateWebhook(ctx, operations.ReposCreateWebhookRequest{
        RequestBody: &operations.ReposCreateWebhookRequestBody{
            ...
            Name: sdk.String("Casey Gleason PhD"),
        },
        Owner: "rem",
        Repo: "aperiam",
    })
...
func main() {
    ...
    res, err := s.Repos.ReposDeleteDeploymentBranchPolicy(ctx, operations.ReposDeleteDeploymentBranchPolicyRequest{
        BranchPolicyID: 232772,
        EnvironmentName: "nesciunt",
        Owner: "quaerat",
        Repo: "itaque",
    })
    if err != nil {
    ...
    res, err := s.Repos.ReposDeleteFile(ctx, operations.ReposDeleteFileRequest{
        RequestBody: operations.ReposDeleteFileRequestBody{
            Author: &operations.ReposDeleteFileRequestBodyAuthor{
                Email: sdk.String("Boris_Rau@hotmail.com"),
                Name: sdk.String("Flora Fay"),
            },
            Branch: sdk.String("alias"),
            Committer: &operations.ReposDeleteFileRequestBodyCommitter{
                Email: sdk.String("Aditya_Lubowitz@yahoo.com"),
...
func main() {
    ...
    res, err := s.Repos.ReposGenerateReleaseNotes(ctx, operations.ReposGenerateReleaseNotesRequest{
        RequestBody: operations.ReposGenerateReleaseNotesRequestBody{
            ConfigurationFilePath: sdk.String("repellat"),
            PreviousTagName: sdk.String("nulla"),
            TagName: "laborum",
            TargetCommitish: sdk.String("natus"),
        },
        Owner: "accusamus",
        Repo: "doloremque",
    })
...
func main() {
    ...
    res, err := s.Repos.ReposGetCollaboratorPermissionLevel(ctx, operations.ReposGetCollaboratorPermissionLevelRequest{
        Owner: "assumenda",
        Repo: "vero",
        Username: "Winnifred_Rutherford51",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Repos.ReposListCommitCommentsForRepo(ctx, operations.ReposListCommitCommentsForRepoRequest{
        Owner: "perspiciatis",
        Page: sdk.Int64(892708),
        PerPage: sdk.Int64(354821),
        Repo: "architecto",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListCommitStatusesForRef(ctx, operations.ReposListCommitStatusesForRefRequest{
        Owner: "accusantium",
        Page: sdk.Int64(18096),
        PerPage: sdk.Int64(82876),
        Ref: "provident",
        Repo: "cumque",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Repos.ReposListCommits(ctx, operations.ReposListCommitsRequest{
        Author: sdk.String("iure"),
        Owner: "quibusdam",
        Page: sdk.Int64(798690),
        Path: sdk.String("nemo"),
        PerPage: sdk.Int64(923456),
        Repo: "velit",
        Sha: sdk.String("magnam"),
        Since: types.MustTimeFromString("2022-08-12T05:34:46.987Z"),
        Until: types.MustTimeFromString("2022-07-07T12:15:23.014Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Repos.ReposListContributors(ctx, operations.ReposListContributorsRequest{
        Anon: sdk.String("natus"),
        Owner: "provident",
        Page: sdk.Int64(739508),
        PerPage: sdk.Int64(983854),
        Repo: "facilis",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListDeployments(ctx, operations.ReposListDeploymentsRequest{
        ...
        Owner: "saepe",
        Page: sdk.Int64(423054),
        PerPage: sdk.Int64(779409),
        Ref: sdk.String("nesciunt"),
        Repo: "illum",
        Sha: sdk.String("nemo"),
        Task: sdk.String("illum"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Repos.ReposListForAuthenticatedUser(ctx, operations.ReposListForAuthenticatedUserRequest{
        ...
        Before: types.MustTimeFromString("2022-05-08T22:04:48.396Z"),
        ...
        Since: types.MustTimeFromString("2022-01-11T21:57:18.174Z"),
...
func main() {
    ...
    res, err := s.Repos.ReposListForOrg(ctx, operations.ReposListForOrgRequest{
        ...
        Org: "incidunt",
        Page: sdk.Int64(802356),
        PerPage: sdk.Int64(369523),
        Sort: operations.ReposListForOrgSortEnumCreated.ToPointer(),
...
func main() {
    ...
    res, err := s.Repos.ReposListForUser(ctx, operations.ReposListForUserRequest{
        ...
        Page: sdk.Int64(560451),
        PerPage: sdk.Int64(672889),
...
func main() {
    ...
    res, err := s.Repos.ReposListForks(ctx, operations.ReposListForksRequest{
        Owner: "aliquid",
        Page: sdk.Int64(301309),
        PerPage: sdk.Int64(308528),
        Repo: "eligendi",
...
func main() {
    ...
    res, err := s.Repos.ReposListInvitations(ctx, operations.ReposListInvitationsRequest{
        Owner: "nostrum",
        Page: sdk.Int64(888265),
        PerPage: sdk.Int64(603650),
        Repo: "nulla",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListPagesBuilds(ctx, operations.ReposListPagesBuildsRequest{
        Owner: "esse",
        Page: sdk.Int64(548849),
        PerPage: sdk.Int64(684799),
        Repo: "facere",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListPullRequestsAssociatedWithCommit(ctx, operations.ReposListPullRequestsAssociatedWithCommitRequest{
        CommitSha: "quasi",
        Owner: "deserunt",
        Page: sdk.Int64(801075),
        PerPage: sdk.Int64(385739),
        Repo: "doloremque",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListReleaseAssets(ctx, operations.ReposListReleaseAssetsRequest{
        Owner: "voluptatem",
        Page: sdk.Int64(816421),
        PerPage: sdk.Int64(901008),
        ReleaseID: 807564,
        Repo: "consequatur",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Repos.ReposListReleases(ctx, operations.ReposListReleasesRequest{
        Owner: "eaque",
        Page: sdk.Int64(102390),
        PerPage: sdk.Int64(627161),
        Repo: "porro",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListTeams(ctx, operations.ReposListTeamsRequest{
        Owner: "sed",
        Page: sdk.Int64(898111),
        PerPage: sdk.Int64(773259),
        Repo: "ipsa",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListWebhooks(ctx, operations.ReposListWebhooksRequest{
        Owner: "alias",
        Page: sdk.Int64(992667),
        PerPage: sdk.Int64(523365),
        Repo: "dicta",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposUpdate(ctx, operations.ReposUpdateRequest{
        RequestBody: &operations.ReposUpdateRequestBody{
            ...
            DefaultBranch: sdk.String("modi"),
            DeleteBranchOnMerge: sdk.Bool(false),
            Description: sdk.String("voluptates"),
            HasIssues: sdk.Bool(false),
            HasProjects: sdk.Bool(false),
            HasWiki: sdk.Bool(false),
            Homepage: sdk.String("fugit"),
            IsTemplate: sdk.Bool(false),
            MergeCommitMessage: operations.ReposUpdateRequestBodyMergeCommitMessageEnumPrBody.ToPointer(),
            MergeCommitTitle: operations.ReposUpdateRequestBodyMergeCommitTitleEnumPrTitle.ToPointer(),
            Name: sdk.String("Marlon Koelpin"),
            Private: sdk.Bool(false),
    ...
    res, err := s.Repos.ReposUpdateBranchProtection(ctx, operations.ReposUpdateBranchProtectionRequest{
        RequestBody: operations.ReposUpdateBranchProtectionRequestBody{
            ...
            RequiredPullRequestReviews: operations.ReposUpdateBranchProtectionRequestBodyRequiredPullRequestReviews{
                ...
                RequiredApprovingReviewCount: sdk.Int64(260911),
            },
            RequiredStatusChecks: operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecks{
                Checks: []ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                    operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                        AppID: sdk.Int64(177929),
                        Context: "nobis",
                    },
                    operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                        AppID: sdk.Int64(620054),
                        Context: "minus",
                    },
                    operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                        AppID: sdk.Int64(154389),
                        Context: "magnam",
                    },
                    operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                        AppID: sdk.Int64(440847),
                        Context: "quod",
                    },
                },
                Contexts: []string{
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateDeploymentBranchPolicy(ctx, operations.ReposUpdateDeploymentBranchPolicyRequest{
        BranchPolicyID: 373106,
        DeploymentBranchPolicyNamePattern: shared.DeploymentBranchPolicyNamePattern{
            Name: "release/*",
        },
        EnvironmentName: "eaque",
        Owner: "exercitationem",
        Repo: "veniam",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateInformationAboutPagesSite(ctx, operations.ReposUpdateInformationAboutPagesSiteRequest{
        RequestBody: operations.ReposUpdateInformationAboutPagesSiteRequestBody3{
            BuildType: operations.ReposUpdateInformationAboutPagesSiteRequestBody3BuildTypeEnumLegacy.ToPointer(),
            Cname: "nisi",
            HTTPSEnforced: sdk.Bool(false),
            Source: &operations.ReposUpdateInformationAboutPagesSiteRequestBody3Source2{
                Branch: "quis",
                Path: operations.ReposUpdateInformationAboutPagesSiteRequestBody3Source2PathEnumRootDocs,
            },
        },
        Owner: "nemo",
        Repo: "suscipit",
...
func main() {
    ...
    res, err := s.Repos.ReposUpdatePullRequestReviewProtection(ctx, operations.ReposUpdatePullRequestReviewProtectionRequest{
        RequestBody: &operations.ReposUpdatePullRequestReviewProtectionRequestBody{
            ...
            RequireCodeOwnerReviews: sdk.Bool(false),
            RequiredApprovingReviewCount: sdk.Int64(867115),
        },
        Branch: "harum",
        Owner: "dolore",
        Repo: "voluptatibus",
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateRelease(ctx, operations.ReposUpdateReleaseRequest{
        RequestBody: &operations.ReposUpdateReleaseRequestBody{
            ...
            Prerelease: sdk.Bool(false),
            TagName: sdk.String("earum"),
            TargetCommitish: sdk.String("praesentium"),
        },
        Owner: "error",
        ReleaseID: 252473,
        Repo: "quasi",
