...
var ReportRequestReportScope = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=keywordId" }),
        __metadata("design:type", String)
...
var ReportRequestTimeRange = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=changedAttributesSinceTimestamp" }),
        __metadata("design:type", String)
    ], ReportRequestTimeRange.prototype, "changedAttributesSinceTimestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=changedMetricsSinceTimestamp" }),
        __metadata("design:type", String)
...
var ReportRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=columns", elemType: reportapicolumnspec_1.ReportApiColumnSpec }),
        __metadata("design:type", Array)
    ], ReportRequest.prototype, "columns", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=downloadFormat" }),
        __metadata("design:type", String)
    ], ReportRequest.prototype, "downloadFormat", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=filters", elemType: ReportRequestFilters }),
        __metadata("design:type", Array)
    ], ReportRequest.prototype, "filters", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=includeDeletedEntities" }),
        __metadata("design:type", Boolean)
    ], ReportRequest.prototype, "includeDeletedEntities", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=includeRemovedEntities" }),
        __metadata("design:type", Boolean)
    ], ReportRequest.prototype, "includeRemovedEntities", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=maxRowsPerFile" }),
        __metadata("design:type", Number)
    ], ReportRequest.prototype, "maxRowsPerFile", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=orderBy", elemType: ReportRequestOrderBy }),
        __metadata("design:type", Array)
    ], ReportRequest.prototype, "orderBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reportScope" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=statisticsCurrency" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=verifySingleTimeZone" }),
        __metadata("design:type", Boolean)
