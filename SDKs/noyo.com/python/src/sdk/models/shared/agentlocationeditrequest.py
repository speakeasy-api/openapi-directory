...
class AgentLocationEditRequestAddress:
    r"""AgentLocationEditRequestAddress
    Address of the agent location
    """
    
    city: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('city') }})
    state: AgentLocationEditRequestAddressStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
...
class AgentLocationEditRequest:
    address: Optional[AgentLocationEditRequestAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('address') }})
    ...
    primary_location: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('primary_location') }})
