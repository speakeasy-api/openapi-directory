...
public class GetPathwayDiseaseAssociationsRequest {
    ...
    public GetPathwayDiseaseAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPathwayDiseaseAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPathwayDiseaseAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPathwayDiseaseAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPathwayDiseaseAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPathwayDiseaseAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsRequest withRelation(String relation) {
    ...
    public GetPathwayDiseaseAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPathwayDiseaseAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPathwayDiseaseAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
