...
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsDeleteRequest:
    path_params: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsDeletePathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsDeleteQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsDeleteSecurity = dataclasses.field()
