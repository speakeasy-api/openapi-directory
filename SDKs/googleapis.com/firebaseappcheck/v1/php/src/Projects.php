...
class Projects 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsAppAttestConfigBatchGetResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/apps/-/appAttestConfig:batchGet', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsAppAttestConfigBatchGetRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->googleFirebaseAppcheckV1BatchGetAppAttestConfigsResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1BatchGetAppAttestConfigsResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/debugTokens', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsDebugTokensCreateRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirebaseAppcheckV1DebugToken", "json");
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1DebugToken = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1DebugToken', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsDebugTokensDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/debugTokens', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsDebugTokensListRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1ListDebugTokensResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1ListDebugTokensResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/apps/-/deviceCheckConfig:batchGet', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsDeviceCheckConfigBatchGetRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1BatchGetDeviceCheckConfigsResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1BatchGetDeviceCheckConfigsResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{app}:exchangeAppAttestAssertion', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsExchangeAppAttestAssertionRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirebaseAppcheckV1ExchangeAppAttestAssertionRequest", "json");
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1AppCheckToken = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1AppCheckToken', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{app}:exchangeAppAttestAttestation', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsExchangeAppAttestAttestationRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirebaseAppcheckV1ExchangeAppAttestAttestationRequest", "json");
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1ExchangeAppAttestAttestationResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{app}:exchangeCustomToken', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsExchangeCustomTokenRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirebaseAppcheckV1ExchangeCustomTokenRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{app}:exchangeDebugToken', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsExchangeDebugTokenRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirebaseAppcheckV1ExchangeDebugTokenRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{app}:exchangeDeviceCheckToken', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsExchangeDeviceCheckTokenRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirebaseAppcheckV1ExchangeDeviceCheckTokenRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{app}:exchangePlayIntegrityToken', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsExchangePlayIntegrityTokenRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{app}:exchangeRecaptchaEnterpriseToken', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirebaseAppcheckV1ExchangeRecaptchaEnterpriseTokenRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{app}:exchangeRecaptchaV3Token', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsExchangeRecaptchaV3TokenRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirebaseAppcheckV1ExchangeRecaptchaV3TokenRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{app}:exchangeSafetyNetToken', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsExchangeSafetyNetTokenRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirebaseAppcheckV1ExchangeSafetyNetTokenRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{app}:generateAppAttestChallenge', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsGenerateAppAttestChallengeRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1GenerateAppAttestChallengeResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1GenerateAppAttestChallengeResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{app}:generatePlayIntegrityChallenge', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsGeneratePlayIntegrityChallengeRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1GeneratePlayIntegrityChallengeResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1GeneratePlayIntegrityChallengeResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/apps/-/playIntegrityConfig:batchGet', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsPlayIntegrityConfigBatchGetRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1BatchGetPlayIntegrityConfigsResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1BatchGetPlayIntegrityConfigsResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/apps/-/recaptchaEnterpriseConfig:batchGet', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsRecaptchaEnterpriseConfigBatchGetRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1BatchGetRecaptchaEnterpriseConfigsResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1BatchGetRecaptchaEnterpriseConfigsResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/apps/-/recaptchaV3Config:batchGet', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsRecaptchaV3ConfigBatchGetRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1BatchGetRecaptchaV3ConfigsResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1BatchGetRecaptchaV3ConfigsResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/apps/-/safetyNetConfig:batchGet', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsAppsSafetyNetConfigBatchGetRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1BatchGetSafetyNetConfigsResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1BatchGetSafetyNetConfigsResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/services:batchUpdate', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsServicesBatchUpdateRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirebaseAppcheckV1BatchUpdateServicesRequest", "json");
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1BatchUpdateServicesResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1BatchUpdateServicesResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsServicesGetRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1Service = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1Service', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/services', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsServicesListRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleFirebaseAppcheckV1ListServicesResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleFirebaseAppcheckV1ListServicesResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\FirebaseappcheckProjectsServicesPatchRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleFirebaseAppcheckV1Service", "json");
        $options = array_merge_recursive($options, $body);
