...
public class ConversationsV1User {
    ...
    public ConversationsV1User withAccountSid(String accountSid) {
    ...
    public ConversationsV1User withAttributes(String attributes) {
    ...
    public ConversationsV1User withChatServiceSid(String chatServiceSid) {
    ...
    public ConversationsV1User withDateCreated(OffsetDateTime dateCreated) {
    ...
    public ConversationsV1User withDateUpdated(OffsetDateTime dateUpdated) {
    ...
    public ConversationsV1User withFriendlyName(String friendlyName) {
    ...
    public ConversationsV1User withIdentity(String identity) {
    ...
    public ConversationsV1User withIsNotifiable(Boolean isNotifiable) {
    ...
    public ConversationsV1User withIsOnline(Boolean isOnline) {
    ...
    public ConversationsV1User withLinks(java.util.Map<String, Object> links) {
        this.links = links;
        return this;
    }
    ...
    public ConversationsV1User withRoleSid(String roleSid) {
    ...
    @JsonProperty("sid")
    public String sid;
    public ConversationsV1User withSid(String sid) {
        this.sid = sid;
        return this;
    }
    ...
    @JsonProperty("url")
    public String url;
    public ConversationsV1User withUrl(String url) {
        this.url = url;
        return this;
    }
