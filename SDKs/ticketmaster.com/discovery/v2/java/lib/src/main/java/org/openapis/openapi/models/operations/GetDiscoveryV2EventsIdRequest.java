...
public class GetDiscoveryV2EventsIdRequest {
    ...
    public GetDiscoveryV2EventsIdRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetDiscoveryV2EventsIdRequest withIncludeLicensedContent(GetDiscoveryV2EventsIdIncludeLicensedContentEnum includeLicensedContent) {
    ...
    public GetDiscoveryV2EventsIdRequest withLocale(String locale) {
        this.locale = locale;
        return this;
    }
    
    public GetDiscoveryV2EventsIdRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
