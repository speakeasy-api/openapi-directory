...
func (e *GoogleCloudDiscoveryengineV1alphaImportDocumentsRequestReconciliationModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "INCREMENTAL":
		fallthrough
	case "FULL":
		*e = GoogleCloudDiscoveryengineV1alphaImportDocumentsRequestReconciliationModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudDiscoveryengineV1alphaImportDocumentsRequestReconciliationModeEnum: %s", s)
	}
}
