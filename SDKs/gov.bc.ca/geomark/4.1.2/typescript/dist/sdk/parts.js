...
var Parts = /** @class */ (function () {
    function Parts(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Parts.prototype.getGeomarksGeomarkIdPartsFileFormatExtension = function (req, config) {
