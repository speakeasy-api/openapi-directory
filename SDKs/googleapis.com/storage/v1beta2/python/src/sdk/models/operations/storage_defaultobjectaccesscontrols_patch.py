...
class StorageDefaultObjectAccessControlsPatchRequest:
    path_params: StorageDefaultObjectAccessControlsPatchPathParams = dataclasses.field()
    query_params: StorageDefaultObjectAccessControlsPatchQueryParams = dataclasses.field()
    security: StorageDefaultObjectAccessControlsPatchSecurity = dataclasses.field()
