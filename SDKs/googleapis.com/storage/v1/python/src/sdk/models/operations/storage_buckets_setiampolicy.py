...
class StorageBucketsSetIamPolicySecurity:
    option1: Optional[StorageBucketsSetIamPolicySecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageBucketsSetIamPolicySecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class StorageBucketsSetIamPolicyRequest:
    path_params: StorageBucketsSetIamPolicyPathParams = dataclasses.field()
    query_params: StorageBucketsSetIamPolicyQueryParams = dataclasses.field()
    security: StorageBucketsSetIamPolicySecurity = dataclasses.field()
