...
@dataclasses.dataclass
class GetDescribeReservedNodesHeaders:
...
class GetDescribeReservedNodesRequest:
    headers: GetDescribeReservedNodesHeaders = dataclasses.field()
    query_params: GetDescribeReservedNodesQueryParams = dataclasses.field()
