...
func (e PerformanceGoalPerformanceGoalTypeEnum) ToPointer() *PerformanceGoalPerformanceGoalTypeEnum {
	return &e
}
...
func (e *PerformanceGoalPerformanceGoalTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "PERFORMANCE_GOAL_TYPE_OTHER":
		*e = PerformanceGoalPerformanceGoalTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PerformanceGoalPerformanceGoalTypeEnum: %v", v)
	}
}
