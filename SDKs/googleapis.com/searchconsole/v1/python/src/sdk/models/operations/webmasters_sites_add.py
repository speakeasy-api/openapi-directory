...
class WebmastersSitesAddRequest:
    path_params: WebmastersSitesAddPathParams = dataclasses.field()
    query_params: WebmastersSitesAddQueryParams = dataclasses.field()
    security: WebmastersSitesAddSecurity = dataclasses.field()
