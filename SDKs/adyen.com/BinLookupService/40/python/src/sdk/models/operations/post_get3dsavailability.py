...
from ..shared import threedsavailabilityresponse as shared_threedsavailabilityresponse
...
class PostGet3dsAvailabilityResponse:
    ...
    three_ds_availability_response: Optional[shared_threedsavailabilityresponse.ThreeDSAvailabilityResponse] = dataclasses.field(default=None)
