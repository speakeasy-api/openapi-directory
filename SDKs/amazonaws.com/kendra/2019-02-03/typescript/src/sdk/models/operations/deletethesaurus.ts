...
export enum DeleteThesaurusXAmzTargetEnum {
  AWSKendraFrontendServiceDeleteThesaurus = "AWSKendraFrontendService.DeleteThesaurus",
}

export class DeleteThesaurusRequest extends SpeakeasyBase {
...
export class DeleteThesaurusResponse extends SpeakeasyBase {
  /**
