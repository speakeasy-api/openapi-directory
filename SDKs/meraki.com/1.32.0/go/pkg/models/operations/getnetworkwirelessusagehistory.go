...
type GetNetworkWirelessUsageHistoryBandEnum string

const (
	GetNetworkWirelessUsageHistoryBandEnumTwo4 GetNetworkWirelessUsageHistoryBandEnum = "2.4"
	GetNetworkWirelessUsageHistoryBandEnumFive GetNetworkWirelessUsageHistoryBandEnum = "5"
	GetNetworkWirelessUsageHistoryBandEnumSix  GetNetworkWirelessUsageHistoryBandEnum = "6"
)

func (e GetNetworkWirelessUsageHistoryBandEnum) ToPointer() *GetNetworkWirelessUsageHistoryBandEnum {
	return &e
}

func (e *GetNetworkWirelessUsageHistoryBandEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "5":
		fallthrough
	case "6":
		*e = GetNetworkWirelessUsageHistoryBandEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessUsageHistoryBandEnum: %v", v)
	}
}

type GetNetworkWirelessUsageHistoryRequest struct {
	...
	Band *GetNetworkWirelessUsageHistoryBandEnum `queryParam:"style=form,explode=true,name=band"`
...
type GetNetworkWirelessUsageHistory200ApplicationJSON struct {
...
type GetNetworkWirelessUsageHistoryResponse struct {
	ContentType string
	StatusCode  int
