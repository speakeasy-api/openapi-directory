...
class GetDisassociateSubnetCidrBlockQueryParams:
    action: GetDisassociateSubnetCidrBlockActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    association_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'AssociationId', 'style': 'form', 'explode': True }})
    version: GetDisassociateSubnetCidrBlockVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDisassociateSubnetCidrBlockRequest:
    headers: GetDisassociateSubnetCidrBlockHeaders = dataclasses.field()
    query_params: GetDisassociateSubnetCidrBlockQueryParams = dataclasses.field()
