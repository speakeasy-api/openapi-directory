...
exports.InventoryDeletionStatusItem = void 0;
var utils_1 = require("../../../internal/utils");
var inventorydeletionstatusenum_1 = require("./inventorydeletionstatusenum");
var inventorydeletionsummary_1 = require("./inventorydeletionsummary");
...
var InventoryDeletionStatusItem = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "DeletionId" }),
        __metadata("design:type", String)
    ], InventoryDeletionStatusItem.prototype, "deletionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "DeletionStartTime" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "DeletionSummary" }),
        (0, class_transformer_1.Type)(function () { return inventorydeletionsummary_1.InventoryDeletionSummary; }),
        __metadata("design:type", inventorydeletionsummary_1.InventoryDeletionSummary)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "LastStatusMessage" }),
        __metadata("design:type", String)
    ], InventoryDeletionStatusItem.prototype, "lastStatusMessage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "LastStatusUpdateTime" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
