 ...
 */
export enum GetNetworkFailedConnectionsBandEnum {
  Two4 = "2.4",
  Five = "5",
}

export class GetNetworkFailedConnectionsRequest extends SpeakeasyBase {
  /**
  ...
  band?: GetNetworkFailedConnectionsBandEnum;
...
export class GetNetworkFailedConnectionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getNetworkFailedConnections200ApplicationJSONObjects?: Record<string, any>[];
}
