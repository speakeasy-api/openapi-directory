...
class ExchangeConfigEnabledExchange:
    r"""An enabled exchange in the partner."""
    
    exchange: Optional[ExchangeConfigEnabledExchangeExchangeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('exchange'), 'exclude': lambda f: f is None }})
    r"""The enabled exchange."""  
    google_ad_manager_agency_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('googleAdManagerAgencyId'), 'exclude': lambda f: f is None }})
    r"""Output only. Agency ID of Google Ad Manager. The field is only relevant when Google Ad Manager is the enabled exchange."""  
    google_ad_manager_buyer_network_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('googleAdManagerBuyerNetworkId'), 'exclude': lambda f: f is None }})
    r"""Output only. Network ID of Google Ad Manager. The field is only relevant when Google Ad Manager is the enabled exchange."""  
    seat_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('seatId'), 'exclude': lambda f: f is None }})
    r"""Output only. Seat ID of the enabled exchange."""  
