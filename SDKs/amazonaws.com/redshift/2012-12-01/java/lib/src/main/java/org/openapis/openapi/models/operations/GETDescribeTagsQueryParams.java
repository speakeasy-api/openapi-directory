...
public class GETDescribeTagsQueryParams {
    ...
    public GETDescribeTagsQueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public GETDescribeTagsQueryParams withMaxRecords(Long maxRecords) {
    ...
    public GETDescribeTagsQueryParams withResourceName(String resourceName) {
    ...
    public GETDescribeTagsQueryParams withResourceType(String resourceType) {
    ...
    public GETDescribeTagsQueryParams withTagKeys(String[] tagKeys) {
    ...
    public GETDescribeTagsQueryParams withTagValues(String[] tagValues) {
