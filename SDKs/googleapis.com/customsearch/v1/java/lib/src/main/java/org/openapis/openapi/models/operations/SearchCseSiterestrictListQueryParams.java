...
public class SearchCseSiterestrictListQueryParams {
    /**
     * V1 error format.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=$.xgafv")
    public org.openapis.openapi.models.shared.XgafvEnum dollarXgafv;
    public SearchCseSiterestrictListQueryParams withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public SearchCseSiterestrictListQueryParams withAccessToken(String accessToken) {
    ...
    public SearchCseSiterestrictListQueryParams withAlt(org.openapis.openapi.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
    ...
    public SearchCseSiterestrictListQueryParams withC2coff(String c2coff) {
        this.c2coff = c2coff;
        return this;
    }
    ...
    public SearchCseSiterestrictListQueryParams withCallback(String callback) {
    ...
    public String cr;
    public SearchCseSiterestrictListQueryParams withCr(String cr) {
        this.cr = cr;
        return this;
    }
    ...
    public String cx;
    public SearchCseSiterestrictListQueryParams withCx(String cx) {
        this.cx = cx;
        return this;
    }
    ...
    public SearchCseSiterestrictListQueryParams withDateRestrict(String dateRestrict) {
    ...
    public SearchCseSiterestrictListQueryParams withExactTerms(String exactTerms) {
    ...
    public SearchCseSiterestrictListQueryParams withExcludeTerms(String excludeTerms) {
    ...
    public SearchCseSiterestrictListQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public SearchCseSiterestrictListQueryParams withFileType(String fileType) {
    ...
    public SearchCseSiterestrictListQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public String gl;
    public SearchCseSiterestrictListQueryParams withGl(String gl) {
        this.gl = gl;
        return this;
    }
    ...
    public SearchCseSiterestrictListQueryParams withGooglehost(String googlehost) {
    ...
    public SearchCseSiterestrictListQueryParams withHighRange(String highRange) {
    ...
    public String hl;
    public SearchCseSiterestrictListQueryParams withHl(String hl) {
        this.hl = hl;
        return this;
    }
    ...
    public String hq;
    public SearchCseSiterestrictListQueryParams withHq(String hq) {
        this.hq = hq;
        return this;
    }
    ...
    public SearchCseSiterestrictListQueryParams withImgColorType(SearchCseSiterestrictListImgColorTypeEnum imgColorType) {
    ...
    public SearchCseSiterestrictListQueryParams withImgDominantColor(SearchCseSiterestrictListImgDominantColorEnum imgDominantColor) {
    ...
    public SearchCseSiterestrictListQueryParams withImgSize(SearchCseSiterestrictListImgSizeEnum imgSize) {
    ...
    public SearchCseSiterestrictListQueryParams withImgType(SearchCseSiterestrictListImgTypeEnum imgType) {
    ...
    public String key;
    public SearchCseSiterestrictListQueryParams withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public SearchCseSiterestrictListQueryParams withLinkSite(String linkSite) {
    ...
    public SearchCseSiterestrictListQueryParams withLowRange(String lowRange) {
    ...
    public String lr;
    public SearchCseSiterestrictListQueryParams withLr(String lr) {
        this.lr = lr;
        return this;
    }
    ...
    public Long num;
    public SearchCseSiterestrictListQueryParams withNum(Long num) {
        this.num = num;
        return this;
    }
    ...
    public SearchCseSiterestrictListQueryParams withOauthToken(String oauthToken) {
    ...
    public SearchCseSiterestrictListQueryParams withOrTerms(String orTerms) {
    ...
    public SearchCseSiterestrictListQueryParams withPrettyPrint(Boolean prettyPrint) {
    ...
    public String q;
    public SearchCseSiterestrictListQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public SearchCseSiterestrictListQueryParams withQuotaUser(String quotaUser) {
    ...
    public SearchCseSiterestrictListQueryParams withRelatedSite(String relatedSite) {
    ...
    public SearchCseSiterestrictListQueryParams withRights(String rights) {
        this.rights = rights;
        return this;
    }
    ...
    public SearchCseSiterestrictListQueryParams withSafe(SearchCseSiterestrictListSafeEnum safe) {
        this.safe = safe;
        return this;
    }
    ...
    public SearchCseSiterestrictListQueryParams withSearchType(SearchCseSiterestrictListSearchTypeEnum searchType) {
    ...
    public SearchCseSiterestrictListQueryParams withSiteSearch(String siteSearch) {
    ...
    public SearchCseSiterestrictListQueryParams withSiteSearchFilter(SearchCseSiterestrictListSiteSearchFilterEnum siteSearchFilter) {
    ...
    public String sort;
    public SearchCseSiterestrictListQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public SearchCseSiterestrictListQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public SearchCseSiterestrictListQueryParams withUploadType(String uploadType) {
    ...
    public SearchCseSiterestrictListQueryParams withUploadProtocol(String uploadProtocol) {
