...
var ApiUsage = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: plandata_1.PlanData }),
        (0, class_transformer_1.Expose)({ name: "planData" }),
        (0, class_transformer_1.Type)(function () { return plandata_1.PlanData; }),
        __metadata("design:type", Array)
    ], ApiUsage.prototype, "planData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "predictionsMax" }),
        __metadata("design:type", Number)
    ], ApiUsage.prototype, "predictionsMax", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "predictionsUsed" }),
        __metadata("design:type", Number)
