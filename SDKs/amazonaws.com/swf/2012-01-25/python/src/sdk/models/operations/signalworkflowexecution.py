...
class SignalWorkflowExecutionRequest:
    ...
    signal_workflow_execution_input: shared_signalworkflowexecutioninput.SignalWorkflowExecutionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
