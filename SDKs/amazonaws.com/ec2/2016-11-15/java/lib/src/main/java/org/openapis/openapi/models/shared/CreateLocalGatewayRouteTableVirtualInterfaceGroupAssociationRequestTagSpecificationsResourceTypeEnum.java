 ...
 */
public enum CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
