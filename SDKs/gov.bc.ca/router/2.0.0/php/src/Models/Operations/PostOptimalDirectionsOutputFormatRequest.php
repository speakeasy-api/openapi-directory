...
class PostOptimalDirectionsOutputFormatRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostOptimalDirectionsOutputFormatCriteriaEnum $criteria
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=criteria')]
    public ?PostOptimalDirectionsOutputFormatCriteriaEnum $criteria = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostOptimalDirectionsOutputFormatDistanceUnitEnum $distanceUnit
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=distanceUnit')]
    public ?PostOptimalDirectionsOutputFormatDistanceUnitEnum $distanceUnit = null;
    
    /**
     * Format of representation
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\PostOptimalDirectionsOutputFormatOutputFormatEnum $outputFormat
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostOptimalDirectionsOutputFormatOutputSrsEnum $outputSRS
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=outputSRS')]
    public ?PostOptimalDirectionsOutputFormatOutputSrsEnum $outputSRS = null;
	...
	public function __construct()
	{
		...
		$this->outputFormat = \OpenAPI\OpenAPI\Models\Operations\PostOptimalDirectionsOutputFormatOutputFormatEnum::JSON;
		$this->outputSRS = null;
		$this->points = "";
		$this->roundTrip = null;
