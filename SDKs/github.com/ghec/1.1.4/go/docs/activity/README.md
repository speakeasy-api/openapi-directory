...
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#check-if-a-repository-is-starred-by-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#delete-a-repository-subscription>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#delete-a-thread-subscription>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#get-feeds>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#get-a-repository-subscription>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#get-a-thread>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#get-a-thread-subscription-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-events-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-notifications-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Activity.ActivityListNotificationsForAuthenticatedUser(ctx, operations.ActivityListNotificationsForAuthenticatedUserRequest{
        All: sdk.Bool(false),
        Before: types.MustTimeFromString("2022-03-05T04:36:55.913Z"),
        Page: sdk.Int64(181151),
        Participating: sdk.Bool(false),
        PerPage: sdk.Int64(509342),
        Since: types.MustTimeFromString("2022-09-28T10:00:45.702Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-organization-events-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-public-events>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-public-events-for-a-network-of-repositories>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-public-events-for-a-user>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-public-organization-events>
...
func main() {
    ...
    res, err := s.Activity.ActivityListPublicOrgEvents(ctx, operations.ActivityListPublicOrgEventsRequest{
        Org: "esse",
        Page: sdk.Int64(925164),
        PerPage: sdk.Int64(44612),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-events-received-by-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Activity.ActivityListReceivedEventsForUser(ctx, operations.ActivityListReceivedEventsForUserRequest{
        Page: sdk.Int64(715179),
        PerPage: sdk.Int64(799796),
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-public-events-received-by-a-user>
...
func main() {
    ...
    res, err := s.Activity.ActivityListReceivedPublicEventsForUser(ctx, operations.ActivityListReceivedPublicEventsForUserRequest{
        ...
        PerPage: sdk.Int64(306810),
        Username: "Jeffery_Mayert",
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-repository-events>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-repository-notifications-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Activity.ActivityListRepoNotificationsForAuthenticatedUser(ctx, operations.ActivityListRepoNotificationsForAuthenticatedUserRequest{
        All: sdk.Bool(false),
        Before: types.MustTimeFromString("2021-09-16T17:01:25.429Z"),
        Owner: "quas",
        Page: sdk.Int64(510017),
        Participating: sdk.Bool(false),
        PerPage: sdk.Int64(159867),
        Repo: "deleniti",
        Since: types.MustTimeFromString("2022-04-27T07:00:05.421Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-repositories-starred-by-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-repositories-starred-by-a-user>
...
func main() {
    ...
    res, err := s.Activity.ActivityListReposStarredByUser(ctx, operations.ActivityListReposStarredByUserRequest{
        ...
        Page: sdk.Int64(392676),
        PerPage: sdk.Int64(147014),
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-repositories-watched-by-a-user>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-stargazers>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-repositories-watched-by-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#list-watchers>
...
func main() {
    ...
    res, err := s.Activity.ActivityListWatchersForRepo(ctx, operations.ActivityListWatchersForRepoRequest{
        Owner: "saepe",
        Page: sdk.Int64(426306),
        PerPage: sdk.Int64(690025),
        Repo: "molestiae",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#mark-notifications-as-read>
...
func main() {
    ...
    res, err := s.Activity.ActivityMarkNotificationsAsRead(ctx, operations.ActivityMarkNotificationsAsReadRequestBody{
        LastReadAt: types.MustTimeFromString("2021-11-03T10:56:47.600Z"),
        Read: sdk.Bool(false),
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#mark-repository-notifications-as-read>
...
func main() {
    ...
    res, err := s.Activity.ActivityMarkRepoNotificationsAsRead(ctx, operations.ActivityMarkRepoNotificationsAsReadRequest{
        RequestBody: &operations.ActivityMarkRepoNotificationsAsReadRequestBody{
            LastReadAt: types.MustTimeFromString("2022-04-14T13:42:03.513Z"),
        },
        Owner: "eligendi",
        Repo: "sit",
    })
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#mark-a-thread-as-read>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#set-a-repository-subscription>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#set-a-thread-subscription>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#star-a-repository-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/activity#unstar-a-repository-for-the-authenticated-user>
