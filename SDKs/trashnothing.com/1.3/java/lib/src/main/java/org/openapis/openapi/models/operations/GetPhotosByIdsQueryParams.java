...
public class GetPhotosByIdsQueryParams {
    /**
    ...
    public GetPhotosByIdsQueryParams withDevicePixelRatio(Double devicePixelRatio) {
    ...
    public GetPhotosByIdsQueryParams withPhotoIds(String photoIds) {
