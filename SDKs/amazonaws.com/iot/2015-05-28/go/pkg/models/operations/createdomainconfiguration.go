...
func (e CreateDomainConfigurationRequestBodyServiceTypeEnum) ToPointer() *CreateDomainConfigurationRequestBodyServiceTypeEnum {
	return &e
}
...
func (e *CreateDomainConfigurationRequestBodyServiceTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "CREDENTIAL_PROVIDER":
		fallthrough
	case "JOBS":
		*e = CreateDomainConfigurationRequestBodyServiceTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDomainConfigurationRequestBodyServiceTypeEnum: %v", v)
	}
}
