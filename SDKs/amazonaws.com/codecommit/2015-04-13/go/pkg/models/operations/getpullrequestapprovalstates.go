...
func (e GetPullRequestApprovalStatesXAmzTargetEnum) ToPointer() *GetPullRequestApprovalStatesXAmzTargetEnum {
	return &e
}
...
func (e *GetPullRequestApprovalStatesXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "CodeCommit_20150413.GetPullRequestApprovalStates":
		*e = GetPullRequestApprovalStatesXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPullRequestApprovalStatesXAmzTargetEnum: %v", v)
	}
}

type GetPullRequestApprovalStatesRequest struct {
	GetPullRequestApprovalStatesInput shared.GetPullRequestApprovalStatesInput   `request:"mediaType=application/json"`
