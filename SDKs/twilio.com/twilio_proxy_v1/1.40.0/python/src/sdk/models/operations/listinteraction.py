...
class ListInteractionListInteractionResponse:
    ...
    interactions: Optional[list[shared_proxy_v1_service_session_interaction.ProxyV1ServiceSessionInteraction]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('interactions'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListInteractionListInteractionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
