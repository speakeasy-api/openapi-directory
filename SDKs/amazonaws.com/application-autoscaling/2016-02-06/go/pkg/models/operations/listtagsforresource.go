...
const (
	ListTagsForResourceXAmzTargetEnumAnyScaleFrontendServiceListTagsForResource ListTagsForResourceXAmzTargetEnum = "AnyScaleFrontendService.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AnyScaleFrontendService.ListTagsForResource":
