...
public class People {
    ...
    **/
    public openapisdk.models.operations.PeopleGeoPeopleGeoGetResponse peopleGeoPeopleGeoGet(openapisdk.models.operations.PeopleGeoPeopleGeoGetRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/people.geo");
        ...
        openapisdk.models.operations.PeopleGeoPeopleGeoGetResponse res = new openapisdk.models.operations.PeopleGeoPeopleGeoGetResponse() {{
            personList = null;
    ...
    **/
    public openapisdk.models.operations.PeopleSearchPeopleGetResponse peopleSearchPeopleGet(openapisdk.models.operations.PeopleSearchPeopleGetRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        openapisdk.models.operations.PeopleSearchPeopleGetResponse res = new openapisdk.models.operations.PeopleSearchPeopleGetResponse() {{
            personList = null;
            httpValidationError = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
