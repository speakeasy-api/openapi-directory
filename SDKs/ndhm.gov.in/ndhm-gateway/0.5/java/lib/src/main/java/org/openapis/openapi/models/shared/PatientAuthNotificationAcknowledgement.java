...
public class PatientAuthNotificationAcknowledgement {
    ...
    public PatientAuthNotificationAcknowledgement(@JsonProperty("requestId") String requestId, @JsonProperty("resp") RequestReference resp, @JsonProperty("timestamp") OffsetDateTime timestamp) {
        this.requestId = requestId;
        this.resp = resp;
        this.timestamp = timestamp;
  }
