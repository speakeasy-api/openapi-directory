...
public class CreateRecommenderConfigurationResponse {
    ...
    public CreateRecommenderConfigurationResponse(@JsonProperty("RecommenderConfigurationResponse") RecommenderConfigurationResponse recommenderConfigurationResponse) {
        this.recommenderConfigurationResponse = recommenderConfigurationResponse;
  }
}
