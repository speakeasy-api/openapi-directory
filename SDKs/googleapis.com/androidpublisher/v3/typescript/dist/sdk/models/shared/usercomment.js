...
var UserComment = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=androidOsVersion" }),
        __metadata("design:type", Number)
    ], UserComment.prototype, "androidOsVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=appVersionCode" }),
        __metadata("design:type", Number)
    ], UserComment.prototype, "appVersionCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=appVersionName" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reviewerLanguage" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=thumbsDownCount" }),
        __metadata("design:type", Number)
    ], UserComment.prototype, "thumbsDownCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=thumbsUpCount" }),
        __metadata("design:type", Number)
