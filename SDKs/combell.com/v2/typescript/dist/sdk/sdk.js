...
var linuxhostings_1 = require("./linuxhostings");
var mailboxes_1 = require("./mailboxes");
var mailzones_1 = require("./mailzones");
var mysqldatabases_1 = require("./mysqldatabases");
var provisioningjobs_1 = require("./provisioningjobs");
var servicepacks_1 = require("./servicepacks");
var ssh_1 = require("./ssh");
var sslcertificaterequests_1 = require("./sslcertificaterequests");
var sslcertificates_1 = require("./sslcertificates");
var windowshostings_1 = require("./windowshostings");
var axios_1 = __importDefault(require("axios"));
/**
 * Contains the list of servers available to the SDK
 */
exports.ServerList = ["/v2"];
/**
 * # Introduction
 *
 * @remarks
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.linuxHostings = new linuxhostings_1.LinuxHostings(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.mailZones = new mailzones_1.MailZones(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.mailboxes = new mailboxes_1.Mailboxes(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.mySqlDatabases = new mysqldatabases_1.MySqlDatabases(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.provisioningJobs = new provisioningjobs_1.ProvisioningJobs(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.sslCertificateRequests = new sslcertificaterequests_1.SSLCertificateRequests(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.servicepacks = new servicepacks_1.Servicepacks(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.windowsHostings = new windowshostings_1.WindowsHostings(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
