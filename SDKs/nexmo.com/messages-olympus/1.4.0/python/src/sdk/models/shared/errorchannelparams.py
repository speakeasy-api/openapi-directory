...
class ErrorChannelParams:
    ...
    invalid_parameters: Optional[list[ErrorChannelParamsInvalidParameters]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('invalid_parameters'), 'exclude': lambda f: f is None }})  
