...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesAddAssigneesRequest req = new IssuesAddAssigneesRequest(715561L, "quod", "odio") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesAddLabelsRequest req = new IssuesAddLabelsRequest(293020L, "quibusdam", "illum") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesCheckUserCanBeAssignedRequest req = new IssuesCheckUserCanBeAssignedRequest("exercitationem", "nulla", "fugit");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IssuesCreateRequest req = new IssuesCreateRequest(                new IssuesCreateRequestBody(981830L) {{
                                assignee = "doloribus";
                                assignees = new String[]{{
                                    add("eligendi"),
                                    add("ducimus"),
