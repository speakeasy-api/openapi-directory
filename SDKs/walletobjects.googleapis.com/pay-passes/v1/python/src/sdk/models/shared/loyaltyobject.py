...
class LoyaltyObject:
    ...
    r"""The loyalty account identifier. Recommended maximum length is 20 characters."""  
    ...
    r"""The loyalty account holder name, such as \\"John Smith.\\" Recommended maximum length is 20 characters to ensure full string is displayed on smaller screens."""  
    ...
    class_reference: Optional[shared_loyaltyclass.LoyaltyClass] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('classReference'), 'exclude': lambda f: f is None }})  
    ...
    r"""Identifies what kind of resource this is. Value: the fixed string `\\"walletobjects#loyaltyObject\\"`."""  
    ...
    r"""A list of offer objects linked to this loyalty card. The offer objects must already exist. Offer object IDs should follow the format issuer ID. identifier where the former is issued by Google and latter is chosen by you."""  
    ...
    secondary_loyalty_points: Optional[shared_loyaltypoints.LoyaltyPoints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('secondaryLoyaltyPoints'), 'exclude': lambda f: f is None }})  
