...
class GetTeamsForUserRequest:
    path_params: GetTeamsForUserPathParams = dataclasses.field()
    query_params: GetTeamsForUserQueryParams = dataclasses.field()
...
class GetTeamsForUserResponse:
    ...
    get_teams_for_user_200_application_json_object: Optional[GetTeamsForUser200ApplicationJSON] = dataclasses.field(default=None)
