...
from ..shared import fantasyplayer as shared_fantasyplayer
...
class IdpFantasyPlayersWithAdpResponse:
    ...
    fantasy_players: Optional[list[shared_fantasyplayer.FantasyPlayer]] = dataclasses.field(default=None)  
