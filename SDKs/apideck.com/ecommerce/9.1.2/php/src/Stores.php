...
class Stores 
{
     ...
     * Get Store
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StoresOneRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\StoresOneSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\StoresOneResponse
     */
	public function storesOne(
        \OpenAPI\OpenAPI\Models\Operations\StoresOneRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\StoresOneSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\StoresOneResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ecommerce/store');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\StoresOneRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StoresOneResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->getStoreResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetStoreResponse', 'json');
            }
        }
