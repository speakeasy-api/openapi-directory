...
type MybusinessaccountmanagementLocationsAdminsListPathParams struct {
	// Required. The name of the location to list admins of. `locations/{location_id}/admins`.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type MybusinessaccountmanagementLocationsAdminsListQueryParams struct {
	// V1 error format.
...
type MybusinessaccountmanagementLocationsAdminsListRequest struct {
...
type MybusinessaccountmanagementLocationsAdminsListResponse struct {
	ContentType string
	// Successful response
