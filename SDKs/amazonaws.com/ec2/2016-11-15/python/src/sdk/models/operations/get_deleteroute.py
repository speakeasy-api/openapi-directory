...
class GETDeleteRouteRequest:
    ...
    r"""The IPv4 CIDR range for the route. The value you specify must match the CIDR for the route exactly."""  
    ...
    r"""The IPv6 CIDR range for the route. The value you specify must match the CIDR for the route exactly."""  
