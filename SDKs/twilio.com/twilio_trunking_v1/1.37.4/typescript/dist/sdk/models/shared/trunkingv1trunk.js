...
var TrunkingV1Trunk = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=auth_type_set" }),
        __metadata("design:type", Array)
    ], TrunkingV1Trunk.prototype, "authTypeSet", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cnam_lookup_enabled" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=disaster_recovery_method" }),
        __metadata("design:type", String)
    ], TrunkingV1Trunk.prototype, "disasterRecoveryMethod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=disaster_recovery_url" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=transfer_caller_id" }),
        __metadata("design:type", String)
    ], TrunkingV1Trunk.prototype, "transferCallerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=transfer_mode" }),
        __metadata("design:type", String)
