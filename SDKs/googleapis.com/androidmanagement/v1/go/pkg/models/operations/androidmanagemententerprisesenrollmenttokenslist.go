...
type AndroidmanagementEnterprisesEnrollmentTokensListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidmanagementEnterprisesEnrollmentTokensListPathParams struct {
	// Required. The name of the enterprise in the form enterprises/{enterpriseId}.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type AndroidmanagementEnterprisesEnrollmentTokensListQueryParams struct {
	// V1 error format.
...
type AndroidmanagementEnterprisesEnrollmentTokensListRequest struct {
...
type AndroidmanagementEnterprisesEnrollmentTokensListResponse struct {
	ContentType string
	// Successful response
