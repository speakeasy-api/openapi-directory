...
class CreateEnvironmentAccountConnectionRequest:
    ...
    create_environment_account_connection_input: shared_createenvironmentaccountconnectioninput.CreateEnvironmentAccountConnectionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
