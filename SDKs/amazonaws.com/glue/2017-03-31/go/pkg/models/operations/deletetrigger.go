...
func (e DeleteTriggerXAmzTargetEnum) ToPointer() *DeleteTriggerXAmzTargetEnum {
	return &e
}
...
func (e *DeleteTriggerXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSGlue.DeleteTrigger":
		*e = DeleteTriggerXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DeleteTriggerXAmzTargetEnum: %v", v)
	}
}
