...
class NetworkservicesProjectsLocationsTlsRoutesPatchRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\TlsRouteInput $tlsRouteInput = null;
