...
const (
	TagResourceXAmzTargetEnumAwsInsightsIndexServiceTagResource TagResourceXAmzTargetEnum = "AWSInsightsIndexService.TagResource"
)
...
func (e *TagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AWSInsightsIndexService.TagResource":
