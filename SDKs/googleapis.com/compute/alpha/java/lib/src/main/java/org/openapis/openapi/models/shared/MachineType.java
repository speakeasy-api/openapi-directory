...
public class MachineType {
    ...
    public MachineTypeArchitectureEnum architecture;

    public MachineType withArchitecture(MachineTypeArchitectureEnum architecture) {
    ...
    public MachineType withSelfLinkWithId(String selfLinkWithId) {
