...
var VideoV1Room = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=audio_only" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=empty_room_timeout" }),
        __metadata("design:type", Number)
    ], VideoV1Room.prototype, "emptyRoomTimeout", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=enable_turn" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=large_room" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=max_concurrent_published_tracks" }),
        __metadata("design:type", Number)
    ], VideoV1Room.prototype, "maxConcurrentPublishedTracks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=max_participant_duration" }),
        __metadata("design:type", Number)
    ], VideoV1Room.prototype, "maxParticipantDuration", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=max_participants" }),
        __metadata("design:type", Number)
    ], VideoV1Room.prototype, "maxParticipants", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=media_region" }),
        __metadata("design:type", String)
    ], VideoV1Room.prototype, "mediaRegion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=record_participants_on_connect" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=unused_room_timeout" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=video_codecs" }),
