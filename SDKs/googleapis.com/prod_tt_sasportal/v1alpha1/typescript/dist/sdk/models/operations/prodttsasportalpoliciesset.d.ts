...
export declare class ProdTtSasportalPoliciesSetSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalPoliciesSetSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
