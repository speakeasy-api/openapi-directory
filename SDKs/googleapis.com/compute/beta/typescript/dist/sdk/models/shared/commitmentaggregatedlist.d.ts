...
import { CommitmentsScopedList } from "./commitmentsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum CommitmentAggregatedListWarningCodeEnum {
...
export declare class CommitmentAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class CommitmentAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: CommitmentAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: CommitmentAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class CommitmentAggregatedList extends SpeakeasyBase {
    /**
