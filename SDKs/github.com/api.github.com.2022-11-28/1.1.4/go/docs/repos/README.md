...
* [ReposCheckVulnerabilityAlerts](#reposcheckvulnerabilityalerts) - Check if vulnerability alerts are enabled for a repository
...
* [ReposDeletePagesSite](#reposdeletepagessite) - Delete a GitHub Pages site
...
* [ReposDisableAutomatedSecurityFixes](#reposdisableautomatedsecurityfixes) - Disable automated security fixes
* [ReposDisableLfsForRepo](#reposdisablelfsforrepo) - Disable Git LFS for a repository
* [ReposDisableVulnerabilityAlerts](#reposdisablevulnerabilityalerts) - Disable vulnerability alerts
...
* [ReposEnableAutomatedSecurityFixes](#reposenableautomatedsecurityfixes) - Enable automated security fixes
* [ReposEnableLfsForRepo](#reposenablelfsforrepo) - Enable Git LFS for a repository
* [ReposEnableVulnerabilityAlerts](#reposenablevulnerabilityalerts) - Enable vulnerability alerts
...
* [ReposGetClones](#reposgetclones) - Get repository clones
...
* [ReposGetCommunityProfileMetrics](#reposgetcommunityprofilemetrics) - Get community profile metrics
...
* [ReposGetPages](#reposgetpages) - Get a GitHub Pages site
* [ReposGetPagesBuild](#reposgetpagesbuild) - Get GitHub Pages build
* [ReposGetPagesHealthCheck](#reposgetpageshealthcheck) - Get a DNS health check for GitHub Pages
...
* [ReposGetTopPaths](#reposgettoppaths) - Get top referral paths
* [ReposGetTopReferrers](#reposgettopreferrers) - Get top referral sources
...
* [ReposGetViews](#reposgetviews) - Get page views
...
* [ReposListPagesBuilds](#reposlistpagesbuilds) - List GitHub Pages builds
...
* [ReposRequestPagesBuild](#reposrequestpagesbuild) - Request a GitHub Pages build
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposCheckVulnerabilityAlerts(ctx, operations.ReposCheckVulnerabilityAlertsRequest{
        Owner: "a",
        Repo: "nobis",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Repos.ReposCompareCommits(ctx, operations.ReposCompareCommitsRequest{
        Basehead: "minus",
        Owner: "commodi",
        Page: sdk.Int64(908734),
        PerPage: sdk.Int64(781582),
        Repo: "tempore",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposCreateCommitComment(ctx, operations.ReposCreateCommitCommentRequest{
        RequestBody: operations.ReposCreateCommitCommentRequestBody{
            Body: "eius",
            Line: sdk.Int64(194058),
            Path: sdk.String("eligendi"),
            Position: sdk.Int64(992887),
        },
        CommitSha: "esse",
        Owner: "blanditiis",
        Repo: "sint",
...
API method documentation
<https://docs.github.com/rest/deploy-keys#create-a-deploy-key>
...
func main() {
    ...
    res, err := s.Repos.ReposCreateDeploymentStatus(ctx, operations.ReposCreateDeploymentStatusRequest{
        RequestBody: operations.ReposCreateDeploymentStatusRequestBody{
            ...
            EnvironmentURL: sdk.String("quos"),
            LogURL: sdk.String("corrupti"),
            State: operations.ReposCreateDeploymentStatusRequestBodyStateEnumFailure,
            TargetURL: sdk.String("molestiae"),
        },
        DeploymentID: 227156,
        Owner: "laborum",
        Repo: "modi",
    ...
    res, err := s.Repos.ReposCreateOrUpdateFileContents(ctx, operations.ReposCreateOrUpdateFileContentsRequest{
        RequestBody: operations.ReposCreateOrUpdateFileContentsRequestBody{
            Author: &operations.ReposCreateOrUpdateFileContentsRequestBodyAuthor{
                ...
                Email: "Pete.Rogahn93@gmail.com",
                Name: "Miss Jeremiah Fritsch",
            },
            Branch: sdk.String("harum"),
            Committer: &operations.ReposCreateOrUpdateFileContentsRequestBodyCommitter{
                Date: sdk.String(""2013-01-05T13:13:22+05:00""),
                Email: "Ally.Rath@hotmail.com",
                Name: "Gilbert Marks",
            },
            Content: "possimus",
            Message: "dolor",
            Sha: sdk.String("rerum"),
        },
        Owner: "sed",
        Path: "accusamus",
        Repo: "optio",
...
func main() {
    ...
    res, err := s.Repos.ReposCreatePagesDeployment(ctx, operations.ReposCreatePagesDeploymentRequest{
        RequestBody: operations.ReposCreatePagesDeploymentRequestBody{
            ArtifactURL: "delectus",
            Environment: sdk.String("minus"),
            OidcToken: "quo",
            PagesBuildVersion: "quos",
        },
        Owner: "asperiores",
        Repo: "voluptatum",
    })
...
func main() {
    ...
    res, err := s.Repos.ReposCreateRelease(ctx, operations.ReposCreateReleaseRequest{
        RequestBody: operations.ReposCreateReleaseRequestBody{
            Body: sdk.String("nostrum"),
            DiscussionCategoryName: sdk.String("at"),
            Draft: sdk.Bool(false),
            GenerateReleaseNotes: sdk.Bool(false),
            MakeLatest: operations.ReposCreateReleaseRequestBodyMakeLatestEnumLegacy.ToPointer(),
            Name: sdk.String("Meredith Kassulke"),
            Prerelease: sdk.Bool(false),
            TagName: "quae",
            TargetCommitish: sdk.String("quos"),
        },
        Owner: "aperiam",
        Repo: "non",
    })
...
func main() {
    ...
    res, err := s.Repos.ReposCreateUsingTemplate(ctx, operations.ReposCreateUsingTemplateRequest{
        RequestBody: operations.ReposCreateUsingTemplateRequestBody{
            ...
            Owner: sdk.String("est"),
            Private: sdk.Bool(false),
        },
        TemplateOwner: "dolor",
        TemplateRepo: "aliquid",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Repos.ReposCreateWebhook(ctx, operations.ReposCreateWebhookRequest{
        RequestBody: &operations.ReposCreateWebhookRequestBody{
            ...
            Name: sdk.String("Wallace Kuphal"),
        },
        Owner: "tempora",
        Repo: "blanditiis",
    })
...
API method documentation
<https://docs.github.com/rest/deploy-keys#delete-a-deploy-key>
    ...
    res, err := s.Repos.ReposDeleteFile(ctx, operations.ReposDeleteFileRequest{
        RequestBody: operations.ReposDeleteFileRequestBody{
            Author: &operations.ReposDeleteFileRequestBodyAuthor{
                Email: sdk.String("Axel68@yahoo.com"),
                Name: sdk.String("Johnathan Braun"),
            },
            Branch: sdk.String("labore"),
            Committer: &operations.ReposDeleteFileRequestBodyCommitter{
                Email: sdk.String("Katelyn_Ledner@hotmail.com"),
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposDisableAutomatedSecurityFixes(ctx, operations.ReposDisableAutomatedSecurityFixesRequest{
        Owner: "rerum",
        Repo: "doloremque",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposDisableVulnerabilityAlerts(ctx, operations.ReposDisableVulnerabilityAlertsRequest{
        Owner: "at",
        Repo: "eum",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposEnableAutomatedSecurityFixes(ctx, operations.ReposEnableAutomatedSecurityFixesRequest{
        Owner: "deserunt",
        Repo: "atque",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposEnableVulnerabilityAlerts(ctx, operations.ReposEnableVulnerabilityAlertsRequest{
        Owner: "architecto",
        Repo: "est",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Repos.ReposGenerateReleaseNotes(ctx, operations.ReposGenerateReleaseNotesRequest{
        RequestBody: operations.ReposGenerateReleaseNotesRequestBody{
            ConfigurationFilePath: sdk.String("enim"),
            PreviousTagName: sdk.String("rem"),
            TagName: "magni",
            TargetCommitish: sdk.String("quae"),
        },
        Owner: "quas",
        Repo: "placeat",
    })
...
func main() {
    ...
    res, err := s.Repos.ReposGetAllEnvironments(ctx, operations.ReposGetAllEnvironmentsRequest{
        Owner: "natus",
        Page: sdk.Int64(312511),
        PerPage: sdk.Int64(985379),
        Repo: "quia",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposGetAllTopics(ctx, operations.ReposGetAllTopicsRequest{
        Owner: "quis",
        Page: sdk.Int64(313590),
        PerPage: sdk.Int64(430235),
        Repo: "nemo",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/rest/branches/branch-protection#list-apps-with-access-to-the-protected-branch>
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposGetClones(ctx, operations.ReposGetClonesRequest{
        Owner: "aliquid",
        Per: shared.PerEnumWeek.ToPointer(),
        Repo: "sed",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposGetCombinedStatusForRef(ctx, operations.ReposGetCombinedStatusForRefRequest{
        Owner: "sunt",
        Page: sdk.Int64(771092),
        PerPage: sdk.Int64(259600),
        Ref: "voluptatum",
        Repo: "ipsa",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Repos.ReposGetCommit(ctx, operations.ReposGetCommitRequest{
        Owner: "at",
        Page: sdk.Int64(209860),
        PerPage: sdk.Int64(999854),
        Ref: "aspernatur",
        Repo: "inventore",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposGetCommunityProfileMetrics(ctx, operations.ReposGetCommunityProfileMetricsRequest{
        Owner: "aspernatur",
        Repo: "nulla",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/rest/deploy-keys#get-a-deploy-key>
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposGetPagesHealthCheck(ctx, operations.ReposGetPagesHealthCheckRequest{
        Owner: "rerum",
        Repo: "itaque",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/rest/branches/branch-protection#list-teams-with-access-to-the-protected-branch>
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposGetTopPaths(ctx, operations.ReposGetTopPathsRequest{
        Owner: "quae",
        Repo: "omnis",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposGetTopReferrers(ctx, operations.ReposGetTopReferrersRequest{
        Owner: "illum",
        Repo: "rem",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/rest/branches/branch-protection#list-users-with-access-to-the-protected-branch>
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Repos.ReposGetViews(ctx, operations.ReposGetViewsRequest{
        Owner: "earum",
        Per: shared.PerEnumDay.ToPointer(),
        Repo: "aliquam",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListBranches(ctx, operations.ReposListBranchesRequest{
        Owner: "ad",
        Page: sdk.Int64(970411),
        PerPage: sdk.Int64(196451),
...
func main() {
    ...
    res, err := s.Repos.ReposListCollaborators(ctx, operations.ReposListCollaboratorsRequest{
        ...
        Owner: "aut",
        Page: sdk.Int64(369941),
        PerPage: sdk.Int64(642804),
        Permission: operations.ReposListCollaboratorsPermissionEnumPush.ToPointer(),
        Repo: "reprehenderit",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListCommentsForCommit(ctx, operations.ReposListCommentsForCommitRequest{
        ...
        Page: sdk.Int64(37764),
        PerPage: sdk.Int64(321473),
        Repo: "nisi",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListCommitCommentsForRepo(ctx, operations.ReposListCommitCommentsForRepoRequest{
        Owner: "molestiae",
        Page: sdk.Int64(154130),
        PerPage: sdk.Int64(514767),
        Repo: "sed",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListCommits(ctx, operations.ReposListCommitsRequest{
        Author: sdk.String("nesciunt"),
        Owner: "ipsa",
        Page: sdk.Int64(575139),
        Path: sdk.String("dolore"),
        PerPage: sdk.Int64(457063),
        Repo: "accusantium",
        Sha: sdk.String("distinctio"),
        Since: types.MustTimeFromString("2021-08-11T23:02:40.424Z"),
        Until: types.MustTimeFromString("2022-05-21T15:59:19.662Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Repos.ReposListContributors(ctx, operations.ReposListContributorsRequest{
        Anon: sdk.String("delectus"),
        Owner: "culpa",
        Page: sdk.Int64(531494),
        PerPage: sdk.Int64(482628),
        Repo: "quod",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/rest/deploy-keys#list-deploy-keys>
...
func main() {
    ...
    res, err := s.Repos.ReposListDeployKeys(ctx, operations.ReposListDeployKeysRequest{
        Owner: "voluptatibus",
        Page: sdk.Int64(374414),
        PerPage: sdk.Int64(247767),
        Repo: "ullam",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListDeploymentBranchPolicies(ctx, operations.ReposListDeploymentBranchPoliciesRequest{
        ...
        Owner: "voluptas",
        Page: sdk.Int64(987371),
        PerPage: sdk.Int64(657862),
        Repo: "recusandae",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListDeploymentStatuses(ctx, operations.ReposListDeploymentStatusesRequest{
        DeploymentID: 359453,
        Owner: "non",
        Page: sdk.Int64(900368),
        PerPage: sdk.Int64(719469),
        Repo: "maiores",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListDeployments(ctx, operations.ReposListDeploymentsRequest{
        Environment: sdk.String("laboriosam"),
        Owner: "voluptatem",
        Page: sdk.Int64(759490),
        PerPage: sdk.Int64(193623),
        Ref: sdk.String("sunt"),
        Repo: "vitae",
        Sha: sdk.String("voluptatibus"),
        Task: sdk.String("doloremque"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Repos.ReposListForAuthenticatedUser(ctx, operations.ReposListForAuthenticatedUserRequest{
        Affiliation: sdk.String("sed"),
        Before: types.MustTimeFromString("2022-04-20T16:03:55.086Z"),
        Direction: operations.ReposListForAuthenticatedUserDirectionEnumAsc.ToPointer(),
        Page: sdk.Int64(345514),
        PerPage: sdk.Int64(836991),
        Since: types.MustTimeFromString("2022-10-12T00:49:16.585Z"),
...
func main() {
    ...
    res, err := s.Repos.ReposListForOrg(ctx, operations.ReposListForOrgRequest{
        ...
        Org: "vitae",
        Page: sdk.Int64(667215),
        PerPage: sdk.Int64(33093),
...
func main() {
    ...
    res, err := s.Repos.ReposListForks(ctx, operations.ReposListForksRequest{
        Owner: "provident",
        Page: sdk.Int64(404774),
        PerPage: sdk.Int64(832944),
        Repo: "unde",
...
func main() {
    ...
    res, err := s.Repos.ReposListInvitations(ctx, operations.ReposListInvitationsRequest{
        Owner: "impedit",
        Page: sdk.Int64(196700),
        PerPage: sdk.Int64(413086),
        Repo: "labore",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListInvitationsForAuthenticatedUser(ctx, operations.ReposListInvitationsForAuthenticatedUserRequest{
        Page: sdk.Int64(710059),
        PerPage: sdk.Int64(446737),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Repos.ReposListPagesBuilds(ctx, operations.ReposListPagesBuildsRequest{
        Owner: "enim",
        Page: sdk.Int64(859725),
        PerPage: sdk.Int64(979271),
        Repo: "distinctio",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListPullRequestsAssociatedWithCommit(ctx, operations.ReposListPullRequestsAssociatedWithCommitRequest{
        CommitSha: "impedit",
        Owner: "accusamus",
        Page: sdk.Int64(91120),
        PerPage: sdk.Int64(555938),
        Repo: "blanditiis",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListReleaseAssets(ctx, operations.ReposListReleaseAssetsRequest{
        Owner: "cum",
        Page: sdk.Int64(119725),
        PerPage: sdk.Int64(770544),
        ReleaseID: 274040,
        Repo: "eveniet",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Repos.ReposListReleases(ctx, operations.ReposListReleasesRequest{
        Owner: "repudiandae",
        Page: sdk.Int64(150349),
        PerPage: sdk.Int64(772628),
        Repo: "quas",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListTags(ctx, operations.ReposListTagsRequest{
        Owner: "eligendi",
        Page: sdk.Int64(923159),
        PerPage: sdk.Int64(404643),
        Repo: "beatae",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListTeams(ctx, operations.ReposListTeamsRequest{
        Owner: "veritatis",
        Page: sdk.Int64(982574),
        PerPage: sdk.Int64(930877),
        Repo: "vero",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposMerge(ctx, operations.ReposMergeRequest{
        RequestBody: operations.ReposMergeRequestBody{
            Base: "saepe",
            CommitMessage: sdk.String("earum"),
            Head: "quod",
        },
        Owner: "nihil",
        Repo: "quaerat",
...
func main() {
    ...
    res, err := s.Repos.ReposUpdate(ctx, operations.ReposUpdateRequest{
        RequestBody: &operations.ReposUpdateRequestBody{
            ...
            DefaultBranch: sdk.String("tempora"),
            DeleteBranchOnMerge: sdk.Bool(false),
            Description: sdk.String("perferendis"),
            HasIssues: sdk.Bool(false),
            HasProjects: sdk.Bool(false),
            HasWiki: sdk.Bool(false),
            Homepage: sdk.String("corrupti"),
            IsTemplate: sdk.Bool(false),
            MergeCommitMessage: operations.ReposUpdateRequestBodyMergeCommitMessageEnumPrBody.ToPointer(),
            MergeCommitTitle: operations.ReposUpdateRequestBodyMergeCommitTitleEnumMergeMessage.ToPointer(),
            Name: sdk.String("Sharon Robel"),
            Private: sdk.Bool(false),
            SecurityAndAnalysis: &operations.ReposUpdateRequestBodySecurityAndAnalysis{
                AdvancedSecurity: &operations.ReposUpdateRequestBodySecurityAndAnalysisAdvancedSecurity{
                    Status: sdk.String("porro"),
                },
                SecretScanning: &operations.ReposUpdateRequestBodySecurityAndAnalysisSecretScanning{
                    Status: sdk.String("impedit"),
                },
                SecretScanningPushProtection: &operations.ReposUpdateRequestBodySecurityAndAnalysisSecretScanningPushProtection{
            ...
            SquashMergeCommitTitle: operations.ReposUpdateRequestBodySquashMergeCommitTitleEnumCommitOrPrTitle.ToPointer(),
            UseSquashPrTitleAsDefault: sdk.Bool(false),
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateBranchProtection(ctx, operations.ReposUpdateBranchProtectionRequest{
        RequestBody: operations.ReposUpdateBranchProtectionRequestBody{
            ...
            AllowForkSyncing: sdk.Bool(false),
            BlockCreations: sdk.Bool(false),
            EnforceAdmins: false,
            LockBranch: sdk.Bool(false),
            ...
            RequiredPullRequestReviews: operations.ReposUpdateBranchProtectionRequestBodyRequiredPullRequestReviews{
                ...
                RequireLastPushApproval: sdk.Bool(false),
                RequiredApprovingReviewCount: sdk.Int64(373054),
            },
            RequiredStatusChecks: operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecks{
                Checks: []ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                    operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                        AppID: sdk.Int64(196852),
                        Context: "voluptatum",
                    },
                    operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                        AppID: sdk.Int64(98759),
                        Context: "error",
                    },
                },
                Contexts: []string{
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateInformationAboutPagesSite(ctx, operations.ReposUpdateInformationAboutPagesSiteRequest{
        RequestBody: operations.ReposUpdateInformationAboutPagesSiteRequestBody4{
            BuildType: operations.ReposUpdateInformationAboutPagesSiteRequestBody4BuildTypeEnumWorkflow.ToPointer(),
            Cname: sdk.String("assumenda"),
            HTTPSEnforced: sdk.Bool(false),
            Source: &operations.ReposUpdateInformationAboutPagesSiteRequestBody4Source2{
                Branch: "fuga",
                Path: operations.ReposUpdateInformationAboutPagesSiteRequestBody4Source2PathEnumRootDocs,
            },
        },
        Owner: "commodi",
        Repo: "fugit",
...
func main() {
    ...
    res, err := s.Repos.ReposUpdatePullRequestReviewProtection(ctx, operations.ReposUpdatePullRequestReviewProtectionRequest{
        RequestBody: &operations.ReposUpdatePullRequestReviewProtectionRequestBody{
            ...
            RequireCodeOwnerReviews: sdk.Bool(false),
            RequireLastPushApproval: sdk.Bool(false),
            RequiredApprovingReviewCount: sdk.Int64(989089),
        },
        Branch: "temporibus",
        Owner: "id",
        Repo: "atque",
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateRelease(ctx, operations.ReposUpdateReleaseRequest{
        RequestBody: &operations.ReposUpdateReleaseRequestBody{
            ...
            DiscussionCategoryName: sdk.String("sit"),
            Draft: sdk.Bool(false),
            MakeLatest: operations.ReposUpdateReleaseRequestBodyMakeLatestEnumLegacy.ToPointer(),
            Name: sdk.String("Michele McLaughlin"),
            Prerelease: sdk.Bool(false),
            TagName: sdk.String("doloremque"),
            TargetCommitish: sdk.String("ipsum"),
        },
        Owner: "alias",
        ReleaseID: 43715,
        Repo: "tempora",
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateReleaseAsset(ctx, operations.ReposUpdateReleaseAssetRequest{
        RequestBody: &operations.ReposUpdateReleaseAssetRequestBody{
            ...
            Name: sdk.String("Penny Nienow DVM"),
        ...
        RequestBody: &operations.ReposUpdateStatusCheckProtectionRequestBody{
            Checks: []ReposUpdateStatusCheckProtectionRequestBodyChecks{
                operations.ReposUpdateStatusCheckProtectionRequestBodyChecks{
                    AppID: sdk.Int64(185313),
                    Context: "accusantium",
                },
                operations.ReposUpdateStatusCheckProtectionRequestBodyChecks{
                    AppID: sdk.Int64(415125),
                    Context: "atque",
                },
                operations.ReposUpdateStatusCheckProtectionRequestBodyChecks{
                    AppID: sdk.Int64(519985),
                    Context: "tenetur",
                },
                operations.ReposUpdateStatusCheckProtectionRequestBodyChecks{
                    AppID: sdk.Int64(451807),
                    Context: "quam",
                },
            },
            Contexts: []string{
