...
class TitleAggregationResponse:
    r"""A response that contains details on the results of a finding aggregation by title."""
    ...
    vulnerability_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('vulnerabilityId'), 'exclude': lambda f: f is None }})  
