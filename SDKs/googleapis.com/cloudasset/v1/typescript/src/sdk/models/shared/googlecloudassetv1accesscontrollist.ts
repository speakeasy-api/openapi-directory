...
export class GoogleCloudAssetV1AccessControlList extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudAssetV1Access })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "conditionEvaluation" })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudAssetV1Resource })
