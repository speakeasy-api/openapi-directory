...
class UpdateWorldTemplateRequestBody:
    ...
    template_location: Optional[UpdateWorldTemplateRequestBodyTemplateLocation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('templateLocation') }})
    

@dataclasses.dataclass
class UpdateWorldTemplateRequest:
    headers: UpdateWorldTemplateHeaders = dataclasses.field()
    request: UpdateWorldTemplateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
