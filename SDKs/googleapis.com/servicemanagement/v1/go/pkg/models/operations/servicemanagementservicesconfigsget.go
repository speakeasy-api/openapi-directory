...
func (e ServicemanagementServicesConfigsGetViewEnum) ToPointer() *ServicemanagementServicesConfigsGetViewEnum {
	return &e
}
...
func (e *ServicemanagementServicesConfigsGetViewEnum) UnmarshalJSON(data []byte) error {
	...
	case "BASIC":
		fallthrough
	case "FULL":
		*e = ServicemanagementServicesConfigsGetViewEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ServicemanagementServicesConfigsGetViewEnum: %v", v)
	}
}
