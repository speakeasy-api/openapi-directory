...
exports.DeleteJournalLineTagResponse = exports.DeleteJournalLineTagRequest = void 0;
...
var DeleteJournalLineTagRequest = /** @class */ (function (_super) {
    ...
    ], DeleteJournalLineTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeleteJournalLineTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeleteJournalLineTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=JournalLineId",
        }),
        __metadata("design:type", String)
    ], DeleteJournalLineTagRequest.prototype, "journalLineId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], DeleteJournalLineTagRequest.prototype, "tagId", void 0);
...
var DeleteJournalLineTagResponse = /** @class */ (function (_super) {
    ...
    ], DeleteJournalLineTagResponse.prototype, "rawResponse", void 0);
