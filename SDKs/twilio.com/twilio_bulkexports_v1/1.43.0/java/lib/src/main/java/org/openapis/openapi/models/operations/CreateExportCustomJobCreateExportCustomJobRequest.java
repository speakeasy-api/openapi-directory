...
public class CreateExportCustomJobCreateExportCustomJobRequest {
    ...
    public CreateExportCustomJobCreateExportCustomJobRequest(@JsonProperty("EndDay") String endDay, @JsonProperty("FriendlyName") String friendlyName, @JsonProperty("StartDay") String startDay) {
        this.endDay = endDay;
        this.friendlyName = friendlyName;
        this.startDay = startDay;
  }
