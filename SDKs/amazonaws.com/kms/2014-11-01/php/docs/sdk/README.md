...
try {
    ...
    $request->cancelKeyDeletionRequest->keyId = 'vel';
    ...
    $response = $sdk->sdk->cancelKeyDeletion($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ConnectCustomKeyStoreRequest;
use \OpenAPI\OpenAPI\Models\Shared\ConnectCustomKeyStoreRequest;
use \OpenAPI\OpenAPI\Models\Operations\ConnectCustomKeyStoreXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ConnectCustomKeyStoreRequest();
    $request->connectCustomKeyStoreRequest = new ConnectCustomKeyStoreRequest();
    $request->connectCustomKeyStoreRequest->customKeyStoreId = 'delectus';
    ...
    $request->xAmzTarget = ConnectCustomKeyStoreXAmzTargetEnum::TRENT_SERVICE_CONNECT_CUSTOM_KEY_STORE;

    $response = $sdk->sdk->connectCustomKeyStore($request);

    if ($response->connectCustomKeyStoreResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->createAliasRequest->aliasName = 'excepturi';
    $request->createAliasRequest->targetKeyId = 'nisi';
    ...
    $request->xAmzTarget = CreateAliasXAmzTargetEnum::TRENT_SERVICE_CREATE_ALIAS;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\CreateCustomKeyStoreRequest;
use \OpenAPI\OpenAPI\Models\Shared\CreateCustomKeyStoreRequest;
use \OpenAPI\OpenAPI\Models\Shared\CustomKeyStoreTypeEnum;
use \OpenAPI\OpenAPI\Models\Shared\XksProxyAuthenticationCredentialType;
use \OpenAPI\OpenAPI\Models\Shared\XksProxyConnectivityTypeEnum;
use \OpenAPI\OpenAPI\Models\Operations\CreateCustomKeyStoreXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CreateCustomKeyStoreRequest();
    $request->createCustomKeyStoreRequest = new CreateCustomKeyStoreRequest();
    $request->createCustomKeyStoreRequest->cloudHsmClusterId = 'ipsam';
    $request->createCustomKeyStoreRequest->customKeyStoreName = 'repellendus';
    $request->createCustomKeyStoreRequest->customKeyStoreType = CustomKeyStoreTypeEnum::EXTERNAL_KEY_STORE;
    $request->createCustomKeyStoreRequest->keyStorePassword = 'quo';
    $request->createCustomKeyStoreRequest->trustAnchorCertificate = 'odit';
    $request->createCustomKeyStoreRequest->xksProxyAuthenticationCredential = new XksProxyAuthenticationCredentialType();
    $request->createCustomKeyStoreRequest->xksProxyAuthenticationCredential->accessKeyId = 'at';
    $request->createCustomKeyStoreRequest->xksProxyAuthenticationCredential->rawSecretAccessKey = 'at';
    $request->createCustomKeyStoreRequest->xksProxyConnectivity = XksProxyConnectivityTypeEnum::VPC_ENDPOINT_SERVICE;
    $request->createCustomKeyStoreRequest->xksProxyUriEndpoint = 'molestiae';
    $request->createCustomKeyStoreRequest->xksProxyUriPath = 'quod';
    $request->createCustomKeyStoreRequest->xksProxyVpcEndpointServiceName = 'quod';
    ...
    $request->xAmzTarget = CreateCustomKeyStoreXAmzTargetEnum::TRENT_SERVICE_CREATE_CUSTOM_KEY_STORE;

    $response = $sdk->sdk->createCustomKeyStore($request);

    if ($response->createCustomKeyStoreResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\Models\Shared\GrantConstraints;
use \OpenAPI\OpenAPI\Models\Shared\GrantOperationEnum;
...
try {
    ...
    $request->createGrantRequest->constraints = new GrantConstraints();
    $request->createGrantRequest->constraints->encryptionContextEquals = [
        'fugit' => 'deleniti',
        'hic' => 'optio',
        'totam' => 'beatae',
    ];
    $request->createGrantRequest->constraints->encryptionContextSubset = [
        'molestiae' => 'modi',
        'qui' => 'impedit',
    ];
    $request->createGrantRequest->grantTokens = [
        'esse',
        'ipsum',
        'excepturi',
    ];
    $request->createGrantRequest->granteePrincipal = 'aspernatur';
    $request->createGrantRequest->keyId = 'perferendis';
    $request->createGrantRequest->name = 'Faye Cormier';
    $request->createGrantRequest->operations = [
        GrantOperationEnum::SIGN,
        GrantOperationEnum::VERIFY_MAC,
        GrantOperationEnum::GENERATE_MAC,
    ];
    $request->createGrantRequest->retiringPrincipal = 'fuga';
    ...
    $request->xAmzTarget = CreateGrantXAmzTargetEnum::TRENT_SERVICE_CREATE_GRANT;
...
use \OpenAPI\OpenAPI\Models\Shared\CreateKeyRequest;
use \OpenAPI\OpenAPI\Models\Shared\CreateKeyRequestCustomerMasterKeySpecEnum;
use \OpenAPI\OpenAPI\Models\Shared\KeySpecEnum;
use \OpenAPI\OpenAPI\Models\Shared\KeyUsageTypeEnum;
use \OpenAPI\OpenAPI\Models\Shared\OriginTypeEnum;
use \OpenAPI\OpenAPI\Models\Shared\Tag;
use \OpenAPI\OpenAPI\Models\Operations\CreateKeyXAmzTargetEnum;
...
try {
    ...
    $request->createKeyRequest = new CreateKeyRequest();
    $request->createKeyRequest->bypassPolicyLockoutSafetyCheck = false;
    $request->createKeyRequest->customKeyStoreId = 'ipsa';
    $request->createKeyRequest->customerMasterKeySpec = CreateKeyRequestCustomerMasterKeySpecEnum::SM2;
    $request->createKeyRequest->description = 'est';
    $request->createKeyRequest->keySpec = KeySpecEnum::HMAC224;
    $request->createKeyRequest->keyUsage = KeyUsageTypeEnum::GENERATE_VERIFY_MAC;
    $request->createKeyRequest->multiRegion = false;
    $request->createKeyRequest->origin = OriginTypeEnum::AWS_KMS;
    $request->createKeyRequest->policy = 'dolorem';
    $request->createKeyRequest->tags = [
        new Tag(),
        new Tag(),
    ];
    $request->createKeyRequest->xksKeyId = 'explicabo';
    ...
    $request->xAmzTarget = CreateKeyXAmzTargetEnum::TRENT_SERVICE_CREATE_KEY;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DecryptRequest;
use \OpenAPI\OpenAPI\Models\Shared\DecryptRequest;
use \OpenAPI\OpenAPI\Models\Shared\EncryptionAlgorithmSpecEnum;
use \OpenAPI\OpenAPI\Models\Operations\DecryptXAmzTargetEnum;
...
try {
    ...
    $request->decryptRequest->ciphertextBlob = 'iure';
    $request->decryptRequest->encryptionAlgorithm = EncryptionAlgorithmSpecEnum::RSAES_OAEP_SHA256;
    $request->decryptRequest->encryptionContext = [
        'sapiente' => 'architecto',
        'mollitia' => 'dolorem',
        'culpa' => 'consequuntur',
        'repellat' => 'mollitia',
    ];
    $request->decryptRequest->grantTokens = [
        'numquam',
        'commodi',
        'quam',
    ];
    $request->decryptRequest->keyId = 'molestiae';
    ...
    $request->xAmzTarget = DecryptXAmzTargetEnum::TRENT_SERVICE_DECRYPT;

    $response = $sdk->sdk->decrypt($request);
...
try {
    ...
    $request->deleteAliasRequest->aliasName = 'enim';
    ...
    $request->xAmzTarget = DeleteAliasXAmzTargetEnum::TRENT_SERVICE_DELETE_ALIAS;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DeleteCustomKeyStoreRequest;
use \OpenAPI\OpenAPI\Models\Shared\DeleteCustomKeyStoreRequest;
use \OpenAPI\OpenAPI\Models\Operations\DeleteCustomKeyStoreXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DeleteCustomKeyStoreRequest();
    $request->deleteCustomKeyStoreRequest = new DeleteCustomKeyStoreRequest();
    $request->deleteCustomKeyStoreRequest->customKeyStoreId = 'aut';
    ...
    $request->xAmzTarget = DeleteCustomKeyStoreXAmzTargetEnum::TRENT_SERVICE_DELETE_CUSTOM_KEY_STORE;

    $response = $sdk->sdk->deleteCustomKeyStore($request);

    if ($response->deleteCustomKeyStoreResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DeleteImportedKeyMaterialRequest;
use \OpenAPI\OpenAPI\Models\Shared\DeleteImportedKeyMaterialRequest;
use \OpenAPI\OpenAPI\Models\Operations\DeleteImportedKeyMaterialXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DeleteImportedKeyMaterialRequest();
    $request->deleteImportedKeyMaterialRequest = new DeleteImportedKeyMaterialRequest();
    $request->deleteImportedKeyMaterialRequest->keyId = 'vero';
    ...
    $request->xAmzTarget = DeleteImportedKeyMaterialXAmzTargetEnum::TRENT_SERVICE_DELETE_IMPORTED_KEY_MATERIAL;

    $response = $sdk->sdk->deleteImportedKeyMaterial($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DescribeCustomKeyStoresRequest;
use \OpenAPI\OpenAPI\Models\Shared\DescribeCustomKeyStoresRequest;
use \OpenAPI\OpenAPI\Models\Operations\DescribeCustomKeyStoresXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DescribeCustomKeyStoresRequest();
    $request->describeCustomKeyStoresRequest = new DescribeCustomKeyStoresRequest();
    $request->describeCustomKeyStoresRequest->customKeyStoreId = 'perferendis';
    $request->describeCustomKeyStoresRequest->customKeyStoreName = 'doloremque';
    $request->describeCustomKeyStoresRequest->limit = 441711;
    $request->describeCustomKeyStoresRequest->marker = 'ut';
    ...
    $request->xAmzTarget = DescribeCustomKeyStoresXAmzTargetEnum::TRENT_SERVICE_DESCRIBE_CUSTOM_KEY_STORES;

    $response = $sdk->sdk->describeCustomKeyStores($request);

    if ($response->describeCustomKeyStoresResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\Models\Shared\DescribeKeyRequest;
use \OpenAPI\OpenAPI\Models\Operations\DescribeKeyXAmzTargetEnum;
...
try {
    ...
    $request->describeKeyRequest = new DescribeKeyRequest();
    $request->describeKeyRequest->grantTokens = [
        'repudiandae',
        'quae',
    ];
    $request->describeKeyRequest->keyId = 'ipsum';
    ...
    $request->xAmzTarget = DescribeKeyXAmzTargetEnum::TRENT_SERVICE_DESCRIBE_KEY;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DisableKeyRequest;
use \OpenAPI\OpenAPI\Models\Shared\DisableKeyRequest;
use \OpenAPI\OpenAPI\Models\Operations\DisableKeyXAmzTargetEnum;
...
try {
    ...
    $request->disableKeyRequest = new DisableKeyRequest();
    $request->disableKeyRequest->keyId = 'voluptates';
    $request->xAmzAlgorithm = 'quasi';
    ...
    $request->xAmzTarget = DisableKeyXAmzTargetEnum::TRENT_SERVICE_DISABLE_KEY;

    $response = $sdk->sdk->disableKey($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DisableKeyRotationRequest;
use \OpenAPI\OpenAPI\Models\Shared\DisableKeyRotationRequest;
use \OpenAPI\OpenAPI\Models\Operations\DisableKeyRotationXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DisableKeyRotationRequest();
    $request->disableKeyRotationRequest = new DisableKeyRotationRequest();
    $request->disableKeyRotationRequest->keyId = 'consequatur';
    ...
    $request->xAmzTarget = DisableKeyRotationXAmzTargetEnum::TRENT_SERVICE_DISABLE_KEY_ROTATION;

    $response = $sdk->sdk->disableKeyRotation($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DisconnectCustomKeyStoreRequest;
use \OpenAPI\OpenAPI\Models\Shared\DisconnectCustomKeyStoreRequest;
use \OpenAPI\OpenAPI\Models\Operations\DisconnectCustomKeyStoreXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DisconnectCustomKeyStoreRequest();
    $request->disconnectCustomKeyStoreRequest = new DisconnectCustomKeyStoreRequest();
    $request->disconnectCustomKeyStoreRequest->customKeyStoreId = 'modi';
    ...
    $request->xAmzTarget = DisconnectCustomKeyStoreXAmzTargetEnum::TRENT_SERVICE_DISCONNECT_CUSTOM_KEY_STORE;

    $response = $sdk->sdk->disconnectCustomKeyStore($request);

    if ($response->disconnectCustomKeyStoreResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\EnableKeyRequest;
use \OpenAPI\OpenAPI\Models\Shared\EnableKeyRequest;
use \OpenAPI\OpenAPI\Models\Operations\EnableKeyXAmzTargetEnum;
...
try {
    ...
    $request->enableKeyRequest = new EnableKeyRequest();
    $request->enableKeyRequest->keyId = 'ipsam';
    ...
    $request->xAmzTarget = EnableKeyXAmzTargetEnum::TRENT_SERVICE_ENABLE_KEY;

    $response = $sdk->sdk->enableKey($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\EnableKeyRotationRequest;
use \OpenAPI\OpenAPI\Models\Shared\EnableKeyRotationRequest;
use \OpenAPI\OpenAPI\Models\Operations\EnableKeyRotationXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new EnableKeyRotationRequest();
    $request->enableKeyRotationRequest = new EnableKeyRotationRequest();
    $request->enableKeyRotationRequest->keyId = 'labore';
    ...
    $request->xAmzTarget = EnableKeyRotationXAmzTargetEnum::TRENT_SERVICE_ENABLE_KEY_ROTATION;

    $response = $sdk->sdk->enableKeyRotation($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\EncryptRequest;
use \OpenAPI\OpenAPI\Models\Shared\EncryptRequest;
use \OpenAPI\OpenAPI\Models\Shared\EncryptionAlgorithmSpecEnum;
use \OpenAPI\OpenAPI\Models\Operations\EncryptXAmzTargetEnum;
...
try {
    ...
    $request->encryptRequest->encryptionAlgorithm = EncryptionAlgorithmSpecEnum::SM2_PKE;
    $request->encryptRequest->encryptionContext = [
        'officia' => 'dolor',
        'debitis' => 'a',
        'dolorum' => 'in',
    ];
    $request->encryptRequest->grantTokens = [
        'illum',
        'maiores',
    ];
    $request->encryptRequest->keyId = 'rerum';
    $request->encryptRequest->plaintext = 'dicta';
    ...
    $request->xAmzSignature = 'laborum';
    $request->xAmzSignedHeaders = 'accusamus';
    $request->xAmzTarget = EncryptXAmzTargetEnum::TRENT_SERVICE_ENCRYPT;

    $response = $sdk->sdk->encrypt($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyRequest;
use \OpenAPI\OpenAPI\Models\Shared\GenerateDataKeyRequest;
use \OpenAPI\OpenAPI\Models\Shared\DataKeySpecEnum;
use \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyXAmzTargetEnum;
...
try {
    ...
    $request->generateDataKeyRequest = new GenerateDataKeyRequest();
    $request->generateDataKeyRequest->encryptionContext = [
        'occaecati' => 'enim',
    ];
    $request->generateDataKeyRequest->grantTokens = [
        'delectus',
        'quidem',
        'provident',
        'nam',
    ];
    $request->generateDataKeyRequest->keyId = 'id';
    $request->generateDataKeyRequest->keySpec = DataKeySpecEnum::AES128;
    $request->generateDataKeyRequest->numberOfBytes = 533206;
    ...
    $request->xAmzTarget = GenerateDataKeyXAmzTargetEnum::TRENT_SERVICE_GENERATE_DATA_KEY;

    $response = $sdk->sdk->generateDataKey($request);

    if ($response->generateDataKeyResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairRequest;
use \OpenAPI\OpenAPI\Models\Shared\GenerateDataKeyPairRequest;
use \OpenAPI\OpenAPI\Models\Shared\DataKeyPairSpecEnum;
use \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairXAmzTargetEnum;
...
try {
    ...
    $request->generateDataKeyPairRequest = new GenerateDataKeyPairRequest();
    $request->generateDataKeyPairRequest->encryptionContext = [
        'perferendis' => 'nihil',
        'magnam' => 'distinctio',
    ];
    $request->generateDataKeyPairRequest->grantTokens = [
        'labore',
        'labore',
        'suscipit',
    ];
    $request->generateDataKeyPairRequest->keyId = 'natus';
    $request->generateDataKeyPairRequest->keyPairSpec = DataKeyPairSpecEnum::ECC_NIST_P521;
    ...
    $request->xAmzTarget = GenerateDataKeyPairXAmzTargetEnum::TRENT_SERVICE_GENERATE_DATA_KEY_PAIR;

    $response = $sdk->sdk->generateDataKeyPair($request);

    if ($response->generateDataKeyPairResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairWithoutPlaintextRequest;
use \OpenAPI\OpenAPI\Models\Shared\GenerateDataKeyPairWithoutPlaintextRequest;
use \OpenAPI\OpenAPI\Models\Shared\DataKeyPairSpecEnum;
use \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairWithoutPlaintextXAmzTargetEnum;
...
try {
    ...
    $request->generateDataKeyPairWithoutPlaintextRequest = new GenerateDataKeyPairWithoutPlaintextRequest();
    $request->generateDataKeyPairWithoutPlaintextRequest->encryptionContext = [
        'provident' => 'quos',
        'sint' => 'accusantium',
    ];
    $request->generateDataKeyPairWithoutPlaintextRequest->grantTokens = [
        'reiciendis',
        'mollitia',
        'ad',
    ];
    $request->generateDataKeyPairWithoutPlaintextRequest->keyId = 'eum';
    $request->generateDataKeyPairWithoutPlaintextRequest->keyPairSpec = DataKeyPairSpecEnum::RSA3072;
    ...
    $request->xAmzTarget = GenerateDataKeyPairWithoutPlaintextXAmzTargetEnum::TRENT_SERVICE_GENERATE_DATA_KEY_PAIR_WITHOUT_PLAINTEXT;

    $response = $sdk->sdk->generateDataKeyPairWithoutPlaintext($request);

    if ($response->generateDataKeyPairWithoutPlaintextResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyWithoutPlaintextRequest;
use \OpenAPI\OpenAPI\Models\Shared\GenerateDataKeyWithoutPlaintextRequest;
use \OpenAPI\OpenAPI\Models\Shared\DataKeySpecEnum;
use \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyWithoutPlaintextXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GenerateDataKeyWithoutPlaintextRequest();
    $request->generateDataKeyWithoutPlaintextRequest = new GenerateDataKeyWithoutPlaintextRequest();
    $request->generateDataKeyWithoutPlaintextRequest->encryptionContext = [
        'maxime' => 'deleniti',
        'facilis' => 'in',
    ];
    $request->generateDataKeyWithoutPlaintextRequest->grantTokens = [
        'architecto',
    ];
    $request->generateDataKeyWithoutPlaintextRequest->keyId = 'repudiandae';
    $request->generateDataKeyWithoutPlaintextRequest->keySpec = DataKeySpecEnum::AES256;
    $request->generateDataKeyWithoutPlaintextRequest->numberOfBytes = 714242;
    $request->xAmzAlgorithm = 'nihil';
    ...
    $request->xAmzSignedHeaders = 'accusantium';
    $request->xAmzTarget = GenerateDataKeyWithoutPlaintextXAmzTargetEnum::TRENT_SERVICE_GENERATE_DATA_KEY_WITHOUT_PLAINTEXT;

    $response = $sdk->sdk->generateDataKeyWithoutPlaintext($request);

    if ($response->generateDataKeyWithoutPlaintextResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GenerateMacRequest;
use \OpenAPI\OpenAPI\Models\Shared\GenerateMacRequest;
use \OpenAPI\OpenAPI\Models\Shared\MacAlgorithmSpecEnum;
use \OpenAPI\OpenAPI\Models\Operations\GenerateMacXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GenerateMacRequest();
    $request->generateMacRequest = new GenerateMacRequest();
    $request->generateMacRequest->grantTokens = [
        'praesentium',
    ];
    $request->generateMacRequest->keyId = 'natus';
    $request->generateMacRequest->macAlgorithm = MacAlgorithmSpecEnum::HMAC_SHA224;
    $request->generateMacRequest->message = 'sunt';
    ...
    $request->xAmzTarget = GenerateMacXAmzTargetEnum::TRENT_SERVICE_GENERATE_MAC;

    $response = $sdk->sdk->generateMac($request);

    if ($response->generateMacResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GenerateRandomRequest;
use \OpenAPI\OpenAPI\Models\Shared\GenerateRandomRequest;
use \OpenAPI\OpenAPI\Models\Operations\GenerateRandomXAmzTargetEnum;
...
try {
    ...
    $request->generateRandomRequest = new GenerateRandomRequest();
    $request->generateRandomRequest->customKeyStoreId = 'ea';
    $request->generateRandomRequest->numberOfBytes = 33222;
    ...
    $request->xAmzTarget = GenerateRandomXAmzTargetEnum::TRENT_SERVICE_GENERATE_RANDOM;

    $response = $sdk->sdk->generateRandom($request);

    if ($response->generateRandomResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetKeyPolicyRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetKeyPolicyRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetKeyPolicyXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetKeyPolicyRequest();
    $request->getKeyPolicyRequest = new GetKeyPolicyRequest();
    $request->getKeyPolicyRequest->keyId = 'eaque';
    $request->getKeyPolicyRequest->policyName = 'pariatur';
    ...
    $request->xAmzTarget = GetKeyPolicyXAmzTargetEnum::TRENT_SERVICE_GET_KEY_POLICY;

    $response = $sdk->sdk->getKeyPolicy($request);

    if ($response->getKeyPolicyResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetKeyRotationStatusRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetKeyRotationStatusRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetKeyRotationStatusXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetKeyRotationStatusRequest();
    $request->getKeyRotationStatusRequest = new GetKeyRotationStatusRequest();
    $request->getKeyRotationStatusRequest->keyId = 'corporis';
    ...
    $request->xAmzTarget = GetKeyRotationStatusXAmzTargetEnum::TRENT_SERVICE_GET_KEY_ROTATION_STATUS;

    $response = $sdk->sdk->getKeyRotationStatus($request);

    if ($response->getKeyRotationStatusResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetParametersForImportRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetParametersForImportRequest;
use \OpenAPI\OpenAPI\Models\Shared\AlgorithmSpecEnum;
use \OpenAPI\OpenAPI\Models\Shared\WrappingKeySpecEnum;
use \OpenAPI\OpenAPI\Models\Operations\GetParametersForImportXAmzTargetEnum;
...
try {
    ...
    $request->getParametersForImportRequest = new GetParametersForImportRequest();
    $request->getParametersForImportRequest->keyId = 'eaque';
    $request->getParametersForImportRequest->wrappingAlgorithm = AlgorithmSpecEnum::RSAES_OAEP_SHA1;
    $request->getParametersForImportRequest->wrappingKeySpec = WrappingKeySpecEnum::RSA2048;
    ...
    $request->xAmzTarget = GetParametersForImportXAmzTargetEnum::TRENT_SERVICE_GET_PARAMETERS_FOR_IMPORT;

    $response = $sdk->sdk->getParametersForImport($request);

    if ($response->getParametersForImportResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetPublicKeyRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetPublicKeyRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetPublicKeyXAmzTargetEnum;
...
try {
    ...
    $request->getPublicKeyRequest = new GetPublicKeyRequest();
    $request->getPublicKeyRequest->grantTokens = [
        'nostrum',
        'hic',
        'recusandae',
        'omnis',
    ];
    $request->getPublicKeyRequest->keyId = 'facilis';
    ...
    $request->xAmzTarget = GetPublicKeyXAmzTargetEnum::TRENT_SERVICE_GET_PUBLIC_KEY;

    $response = $sdk->sdk->getPublicKey($request);

    if ($response->getPublicKeyResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ImportKeyMaterialRequest;
use \OpenAPI\OpenAPI\Models\Shared\ImportKeyMaterialRequest;
use \OpenAPI\OpenAPI\Models\Shared\ExpirationModelTypeEnum;
use \OpenAPI\OpenAPI\Models\Operations\ImportKeyMaterialXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ImportKeyMaterialRequest();
    $request->importKeyMaterialRequest = new ImportKeyMaterialRequest();
    $request->importKeyMaterialRequest->encryptedKeyMaterial = 'occaecati';
    $request->importKeyMaterialRequest->expirationModel = ExpirationModelTypeEnum::KEY_MATERIAL_DOES_NOT_EXPIRE;
    $request->importKeyMaterialRequest->importToken = 'adipisci';
    $request->importKeyMaterialRequest->keyId = 'asperiores';
    $request->importKeyMaterialRequest->validTo = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-03-14T08:20:25.450Z');
    ...
    $request->xAmzTarget = ImportKeyMaterialXAmzTargetEnum::TRENT_SERVICE_IMPORT_KEY_MATERIAL;

    $response = $sdk->sdk->importKeyMaterial($request);

    if ($response->importKeyMaterialResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->listAliasesRequest->keyId = 'quaerat';
    $request->listAliasesRequest->limit = 554242;
    $request->listAliasesRequest->marker = 'aliquid';
    ...
    $request->xAmzSignature = 'excepturi';
    $request->xAmzSignedHeaders = 'cum';
    $request->xAmzTarget = ListAliasesXAmzTargetEnum::TRENT_SERVICE_LIST_ALIASES;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListGrantsRequest;
use \OpenAPI\OpenAPI\Models\Shared\ListGrantsRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListGrantsXAmzTargetEnum;
...
try {
    ...
    $request->limit = 'voluptate';
    $request->listGrantsRequest = new ListGrantsRequest();
    $request->listGrantsRequest->grantId = 'dignissimos';
    $request->listGrantsRequest->granteePrincipal = 'reiciendis';
    $request->listGrantsRequest->keyId = 'amet';
    $request->listGrantsRequest->limit = 680545;
    $request->listGrantsRequest->marker = 'numquam';
    ...
    $request->xAmzTarget = ListGrantsXAmzTargetEnum::TRENT_SERVICE_LIST_GRANTS;

    $response = $sdk->sdk->listGrants($request);

    if ($response->listGrantsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListKeyPoliciesRequest;
use \OpenAPI\OpenAPI\Models\Shared\ListKeyPoliciesRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListKeyPoliciesXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListKeyPoliciesRequest();
    $request->limit = 'voluptatibus';
    $request->listKeyPoliciesRequest = new ListKeyPoliciesRequest();
    $request->listKeyPoliciesRequest->keyId = 'voluptas';
    $request->listKeyPoliciesRequest->limit = 617658;
    $request->listKeyPoliciesRequest->marker = 'eos';
    ...
    $request->xAmzTarget = ListKeyPoliciesXAmzTargetEnum::TRENT_SERVICE_LIST_KEY_POLICIES;

    $response = $sdk->sdk->listKeyPolicies($request);

    if ($response->listKeyPoliciesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\Models\Shared\ListKeysRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListKeysXAmzTargetEnum;
...
try {
    ...
    $request->listKeysRequest = new ListKeysRequest();
    $request->listKeysRequest->limit = 536579;
    $request->listKeysRequest->marker = 'omnis';
    ...
    $request->xAmzTarget = ListKeysXAmzTargetEnum::TRENT_SERVICE_LIST_KEYS;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListResourceTagsRequest;
use \OpenAPI\OpenAPI\Models\Shared\ListResourceTagsRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListResourceTagsXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListResourceTagsRequest();
    $request->limit = 'eius';
    $request->listResourceTagsRequest = new ListResourceTagsRequest();
    $request->listResourceTagsRequest->keyId = 'aspernatur';
    $request->listResourceTagsRequest->limit = 20651;
    $request->listResourceTagsRequest->marker = 'amet';
    ...
    $request->xAmzTarget = ListResourceTagsXAmzTargetEnum::TRENT_SERVICE_LIST_RESOURCE_TAGS;

    $response = $sdk->sdk->listResourceTags($request);

    if ($response->listResourceTagsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListRetirableGrantsRequest;
use \OpenAPI\OpenAPI\Models\Shared\ListRetirableGrantsRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListRetirableGrantsXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListRetirableGrantsRequest();
    $request->limit = 'repellendus';
    $request->listRetirableGrantsRequest = new ListRetirableGrantsRequest();
    $request->listRetirableGrantsRequest->limit = 519711;
    $request->listRetirableGrantsRequest->marker = 'similique';
    $request->listRetirableGrantsRequest->retiringPrincipal = 'alias';
    $request->marker = 'at';
    ...
    $request->xAmzTarget = ListRetirableGrantsXAmzTargetEnum::TRENT_SERVICE_LIST_RETIRABLE_GRANTS;

    $response = $sdk->sdk->listRetirableGrants($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\PutKeyPolicyRequest;
use \OpenAPI\OpenAPI\Models\Shared\PutKeyPolicyRequest;
use \OpenAPI\OpenAPI\Models\Operations\PutKeyPolicyXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new PutKeyPolicyRequest();
    $request->putKeyPolicyRequest = new PutKeyPolicyRequest();
    $request->putKeyPolicyRequest->bypassPolicyLockoutSafetyCheck = false;
    $request->putKeyPolicyRequest->keyId = 'a';
    $request->putKeyPolicyRequest->policy = 'esse';
    $request->putKeyPolicyRequest->policyName = 'harum';
    ...
    $request->xAmzSignedHeaders = 'accusamus';
    $request->xAmzTarget = PutKeyPolicyXAmzTargetEnum::TRENT_SERVICE_PUT_KEY_POLICY;

    $response = $sdk->sdk->putKeyPolicy($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ReEncryptRequest;
use \OpenAPI\OpenAPI\Models\Shared\ReEncryptRequest;
use \OpenAPI\OpenAPI\Models\Shared\EncryptionAlgorithmSpecEnum;
use \OpenAPI\OpenAPI\Models\Operations\ReEncryptXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ReEncryptRequest();
    $request->reEncryptRequest = new ReEncryptRequest();
    $request->reEncryptRequest->ciphertextBlob = 'numquam';
    $request->reEncryptRequest->destinationEncryptionAlgorithm = EncryptionAlgorithmSpecEnum::RSAES_OAEP_SHA1;
    $request->reEncryptRequest->destinationEncryptionContext = [
        'sapiente' => 'totam',
    ];
    $request->reEncryptRequest->destinationKeyId = 'nihil';
    $request->reEncryptRequest->grantTokens = [
        'expedita',
    ];
    $request->reEncryptRequest->sourceEncryptionAlgorithm = EncryptionAlgorithmSpecEnum::SYMMETRIC_DEFAULT;
    $request->reEncryptRequest->sourceEncryptionContext = [
        'vel' => 'libero',
    ];
    $request->reEncryptRequest->sourceKeyId = 'voluptas';
    ...
    $request->xAmzTarget = ReEncryptXAmzTargetEnum::TRENT_SERVICE_RE_ENCRYPT;

    $response = $sdk->sdk->reEncrypt($request);

    if ($response->reEncryptResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ReplicateKeyRequest;
use \OpenAPI\OpenAPI\Models\Shared\ReplicateKeyRequest;
use \OpenAPI\OpenAPI\Models\Shared\Tag;
use \OpenAPI\OpenAPI\Models\Operations\ReplicateKeyXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ReplicateKeyRequest();
    $request->replicateKeyRequest = new ReplicateKeyRequest();
    $request->replicateKeyRequest->bypassPolicyLockoutSafetyCheck = false;
    $request->replicateKeyRequest->description = 'pariatur';
    $request->replicateKeyRequest->keyId = 'soluta';
    $request->replicateKeyRequest->policy = 'dicta';
    $request->replicateKeyRequest->replicaRegion = 'laborum';
    $request->replicateKeyRequest->tags = [
        new Tag(),
        new Tag(),
        new Tag(),
    ];
    ...
    $request->xAmzTarget = ReplicateKeyXAmzTargetEnum::TRENT_SERVICE_REPLICATE_KEY;

    $response = $sdk->sdk->replicateKey($request);

    if ($response->replicateKeyResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\RetireGrantRequest;
use \OpenAPI\OpenAPI\Models\Shared\RetireGrantRequest;
use \OpenAPI\OpenAPI\Models\Operations\RetireGrantXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RetireGrantRequest();
    $request->retireGrantRequest = new RetireGrantRequest();
    $request->retireGrantRequest->grantId = 'molestias';
    $request->retireGrantRequest->grantToken = 'temporibus';
    $request->retireGrantRequest->keyId = 'qui';
    ...
    $request->xAmzSignedHeaders = 'nam';
    $request->xAmzTarget = RetireGrantXAmzTargetEnum::TRENT_SERVICE_RETIRE_GRANT;

    $response = $sdk->sdk->retireGrant($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\RevokeGrantRequest;
use \OpenAPI\OpenAPI\Models\Shared\RevokeGrantRequest;
use \OpenAPI\OpenAPI\Models\Operations\RevokeGrantXAmzTargetEnum;
...
try {
    ...
    $request->revokeGrantRequest = new RevokeGrantRequest();
    $request->revokeGrantRequest->grantId = 'hic';
    $request->revokeGrantRequest->keyId = 'voluptatem';
    ...
    $request->xAmzTarget = RevokeGrantXAmzTargetEnum::TRENT_SERVICE_REVOKE_GRANT;

    $response = $sdk->sdk->revokeGrant($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ScheduleKeyDeletionRequest;
use \OpenAPI\OpenAPI\Models\Shared\ScheduleKeyDeletionRequest;
use \OpenAPI\OpenAPI\Models\Operations\ScheduleKeyDeletionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ScheduleKeyDeletionRequest();
    $request->scheduleKeyDeletionRequest = new ScheduleKeyDeletionRequest();
    $request->scheduleKeyDeletionRequest->keyId = 'nobis';
    $request->scheduleKeyDeletionRequest->pendingWindowInDays = 552193;
    ...
    $request->xAmzSignedHeaders = 'labore';
    $request->xAmzTarget = ScheduleKeyDeletionXAmzTargetEnum::TRENT_SERVICE_SCHEDULE_KEY_DELETION;

    $response = $sdk->sdk->scheduleKeyDeletion($request);

    if ($response->scheduleKeyDeletionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\SignRequest;
use \OpenAPI\OpenAPI\Models\Shared\SignRequest;
use \OpenAPI\OpenAPI\Models\Shared\MessageTypeEnum;
use \OpenAPI\OpenAPI\Models\Shared\SigningAlgorithmSpecEnum;
use \OpenAPI\OpenAPI\Models\Operations\SignXAmzTargetEnum;
...
try {
    ...
    $request->signRequest = new SignRequest();
    $request->signRequest->grantTokens = [
        'dolorum',
    ];
    $request->signRequest->keyId = 'architecto';
    $request->signRequest->message = 'quae';
    $request->signRequest->messageType = MessageTypeEnum::RAW;
    $request->signRequest->signingAlgorithm = SigningAlgorithmSpecEnum::RSASSA_PKCS1_V15_SHA512;
    ...
    $request->xAmzTarget = SignXAmzTargetEnum::TRENT_SERVICE_SIGN;

    $response = $sdk->sdk->sign($request);
...
try {
    ...
    $request->tagResourceRequest->keyId = 'facilis';
    ...
    $request->xAmzTarget = TagResourceXAmzTargetEnum::TRENT_SERVICE_TAG_RESOURCE;
...
try {
    ...
    $request->untagResourceRequest->keyId = 'vero';
    ...
    $request->xAmzTarget = UntagResourceXAmzTargetEnum::TRENT_SERVICE_UNTAG_RESOURCE;
...
try {
    ...
    $request->updateAliasRequest->aliasName = 'quod';
    $request->updateAliasRequest->targetKeyId = 'odio';
    ...
    $request->xAmzTarget = UpdateAliasXAmzTargetEnum::TRENT_SERVICE_UPDATE_ALIAS;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\UpdateCustomKeyStoreRequest;
use \OpenAPI\OpenAPI\Models\Shared\UpdateCustomKeyStoreRequest;
use \OpenAPI\OpenAPI\Models\Shared\XksProxyAuthenticationCredentialType;
use \OpenAPI\OpenAPI\Models\Shared\XksProxyConnectivityTypeEnum;
use \OpenAPI\OpenAPI\Models\Operations\UpdateCustomKeyStoreXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new UpdateCustomKeyStoreRequest();
    $request->updateCustomKeyStoreRequest = new UpdateCustomKeyStoreRequest();
    $request->updateCustomKeyStoreRequest->cloudHsmClusterId = 'sequi';
    $request->updateCustomKeyStoreRequest->customKeyStoreId = 'natus';
    $request->updateCustomKeyStoreRequest->keyStorePassword = 'impedit';
    $request->updateCustomKeyStoreRequest->newCustomKeyStoreName = 'aut';
    $request->updateCustomKeyStoreRequest->xksProxyAuthenticationCredential = new XksProxyAuthenticationCredentialType();
    $request->updateCustomKeyStoreRequest->xksProxyAuthenticationCredential->accessKeyId = 'voluptatibus';
    $request->updateCustomKeyStoreRequest->xksProxyAuthenticationCredential->rawSecretAccessKey = 'exercitationem';
    $request->updateCustomKeyStoreRequest->xksProxyConnectivity = XksProxyConnectivityTypeEnum::VPC_ENDPOINT_SERVICE;
    $request->updateCustomKeyStoreRequest->xksProxyUriEndpoint = 'fugit';
    $request->updateCustomKeyStoreRequest->xksProxyUriPath = 'porro';
    $request->updateCustomKeyStoreRequest->xksProxyVpcEndpointServiceName = 'maiores';
    ...
    $request->xAmzTarget = UpdateCustomKeyStoreXAmzTargetEnum::TRENT_SERVICE_UPDATE_CUSTOM_KEY_STORE;

    $response = $sdk->sdk->updateCustomKeyStore($request);

    if ($response->updateCustomKeyStoreResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\UpdateKeyDescriptionRequest;
use \OpenAPI\OpenAPI\Models\Shared\UpdateKeyDescriptionRequest;
use \OpenAPI\OpenAPI\Models\Operations\UpdateKeyDescriptionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new UpdateKeyDescriptionRequest();
    $request->updateKeyDescriptionRequest = new UpdateKeyDescriptionRequest();
    $request->updateKeyDescriptionRequest->description = 'ipsam';
    $request->updateKeyDescriptionRequest->keyId = 'ea';
    ...
    $request->xAmzTarget = UpdateKeyDescriptionXAmzTargetEnum::TRENT_SERVICE_UPDATE_KEY_DESCRIPTION;

    $response = $sdk->sdk->updateKeyDescription($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\UpdatePrimaryRegionRequest;
use \OpenAPI\OpenAPI\Models\Shared\UpdatePrimaryRegionRequest;
use \OpenAPI\OpenAPI\Models\Operations\UpdatePrimaryRegionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new UpdatePrimaryRegionRequest();
    $request->updatePrimaryRegionRequest = new UpdatePrimaryRegionRequest();
    $request->updatePrimaryRegionRequest->keyId = 'dicta';
    $request->updatePrimaryRegionRequest->primaryRegion = 'dolor';
    ...
    $request->xAmzTarget = UpdatePrimaryRegionXAmzTargetEnum::TRENT_SERVICE_UPDATE_PRIMARY_REGION;

    $response = $sdk->sdk->updatePrimaryRegion($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\VerifyRequest;
use \OpenAPI\OpenAPI\Models\Shared\VerifyRequest;
use \OpenAPI\OpenAPI\Models\Shared\MessageTypeEnum;
use \OpenAPI\OpenAPI\Models\Shared\SigningAlgorithmSpecEnum;
use \OpenAPI\OpenAPI\Models\Operations\VerifyXAmzTargetEnum;
...
try {
    ...
    $request->verifyRequest->grantTokens = [
        'quisquam',
        'saepe',
        'ea',
        'impedit',
    ];
    $request->verifyRequest->keyId = 'corporis';
    $request->verifyRequest->message = 'veniam';
    $request->verifyRequest->messageType = MessageTypeEnum::RAW;
    $request->verifyRequest->signature = 'inventore';
    $request->verifyRequest->signingAlgorithm = SigningAlgorithmSpecEnum::RSASSA_PKCS1_V15_SHA256;
    ...
    $request->xAmzSignedHeaders = 'eaque';
    $request->xAmzTarget = VerifyXAmzTargetEnum::TRENT_SERVICE_VERIFY;

    $response = $sdk->sdk->verify($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\VerifyMacRequest;
use \OpenAPI\OpenAPI\Models\Shared\VerifyMacRequest;
use \OpenAPI\OpenAPI\Models\Shared\MacAlgorithmSpecEnum;
use \OpenAPI\OpenAPI\Models\Operations\VerifyMacXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new VerifyMacRequest();
    $request->verifyMacRequest = new VerifyMacRequest();
    $request->verifyMacRequest->grantTokens = [
        'libero',
        'aut',
        'aut',
        'deleniti',
    ];
    $request->verifyMacRequest->keyId = 'impedit';
    $request->verifyMacRequest->mac = 'aliquam';
    $request->verifyMacRequest->macAlgorithm = MacAlgorithmSpecEnum::HMAC_SHA224;
    $request->verifyMacRequest->message = 'accusamus';
    ...
    $request->xAmzTarget = VerifyMacXAmzTargetEnum::TRENT_SERVICE_VERIFY_MAC;

    $response = $sdk->sdk->verifyMac($request);

    if ($response->verifyMacResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
