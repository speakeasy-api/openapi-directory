...
exports.ActivityListNotificationsForAuthenticatedUserResponse = exports.ActivityListNotificationsForAuthenticatedUserRequest = void 0;
...
var ActivityListNotificationsForAuthenticatedUserRequest = /** @class */ (function (_super) {
    ...
    ], ActivityListNotificationsForAuthenticatedUserRequest.prototype, "all", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=before;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ActivityListNotificationsForAuthenticatedUserRequest.prototype, "before", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], ActivityListNotificationsForAuthenticatedUserRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=participating",
        }),
        __metadata("design:type", Boolean)
    ], ActivityListNotificationsForAuthenticatedUserRequest.prototype, "participating", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], ActivityListNotificationsForAuthenticatedUserRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=since;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ActivityListNotificationsForAuthenticatedUserRequest.prototype, "since", void 0);
...
var ActivityListNotificationsForAuthenticatedUserResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ActivityListNotificationsForAuthenticatedUserResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
