...
/**
 * AccountSettingsUpdateApplicationJSON2AccountSettingsAuthenticationUpdateAuthenticationOptionTypeEnum -  Authentication type. Specify one of the following authentication types for the authentication profile:&lt;br&gt;
 ...
 */
public enum AccountSettingsUpdateApplicationJSON2AccountSettingsAuthenticationUpdateAuthenticationOptionTypeEnum {
    ...
    private AccountSettingsUpdateApplicationJSON2AccountSettingsAuthenticationUpdateAuthenticationOptionTypeEnum(String value) {
        this.value = value;
    }
}
