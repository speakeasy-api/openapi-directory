...
class AdsensehostCustomchannelsPatchQueryParams:
    custom_channel_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'customChannelId', 'style': 'form', 'explode': True }})
...
class AdsensehostCustomchannelsPatchRequest:
    path_params: AdsensehostCustomchannelsPatchPathParams = dataclasses.field()
    query_params: AdsensehostCustomchannelsPatchQueryParams = dataclasses.field()
    security: AdsensehostCustomchannelsPatchSecurity = dataclasses.field()
