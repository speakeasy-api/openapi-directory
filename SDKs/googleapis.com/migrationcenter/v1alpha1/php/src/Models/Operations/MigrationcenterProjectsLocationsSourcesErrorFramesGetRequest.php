...
class MigrationcenterProjectsLocationsSourcesErrorFramesGetRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MigrationcenterProjectsLocationsSourcesErrorFramesGetViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?MigrationcenterProjectsLocationsSourcesErrorFramesGetViewEnum $view = null;
