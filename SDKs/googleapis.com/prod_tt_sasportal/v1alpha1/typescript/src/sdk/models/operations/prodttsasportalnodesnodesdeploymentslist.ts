...
export class ProdTtSasportalNodesNodesDeploymentsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ProdTtSasportalNodesNodesDeploymentsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
