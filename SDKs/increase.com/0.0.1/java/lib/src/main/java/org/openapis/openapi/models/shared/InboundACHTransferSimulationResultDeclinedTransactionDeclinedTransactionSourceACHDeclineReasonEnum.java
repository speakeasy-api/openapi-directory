 ...
 */
public enum InboundACHTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceACHDeclineReasonEnum {
    ...
    private InboundACHTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceACHDeclineReasonEnum(String value) {
        this.value = value;
    }
}
