...
public class EstimationApiAllHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public EstimationApiAllHeaders withXAuthKey(String xAuthKey) {
    ...
    public EstimationApiAllHeaders withXAuthSecret(String xAuthSecret) {
