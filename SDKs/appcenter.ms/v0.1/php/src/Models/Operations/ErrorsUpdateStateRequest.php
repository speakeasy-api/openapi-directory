...
class ErrorsUpdateStateRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\ErrorsUpdateStateRequestBody $requestBody
     */
	...
	{
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\ErrorsUpdateStateRequestBody();
		$this->appName = "";
		$this->errorGroupId = "";
		$this->ownerName = "";
	}
