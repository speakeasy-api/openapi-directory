...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.GetTimestagsResponse getTimestags(org.openapis.openapi.models.operations.GetTimestagsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/timestags");
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetTimestagsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
