...
export declare class GetItemFeedSecurity extends SpeakeasyBase {
    clientCredentials: string;
}
export declare class GetItemFeedRequest extends SpeakeasyBase {
    /**
...
export declare class GetItemFeedResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
