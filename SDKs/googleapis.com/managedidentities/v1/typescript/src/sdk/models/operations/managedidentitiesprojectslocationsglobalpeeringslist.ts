...
export class ManagedidentitiesProjectsLocationsGlobalPeeringsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ManagedidentitiesProjectsLocationsGlobalPeeringsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ManagedidentitiesProjectsLocationsGlobalPeeringsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
