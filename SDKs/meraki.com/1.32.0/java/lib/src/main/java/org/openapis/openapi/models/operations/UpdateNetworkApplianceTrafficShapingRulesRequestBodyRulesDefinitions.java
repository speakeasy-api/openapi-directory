...
public class UpdateNetworkApplianceTrafficShapingRulesRequestBodyRulesDefinitions {
    ...
    public UpdateNetworkApplianceTrafficShapingRulesRequestBodyRulesDefinitions(@JsonProperty("type") UpdateNetworkApplianceTrafficShapingRulesRequestBodyRulesDefinitionsTypeEnum type, @JsonProperty("value") String value) {
        this.type = type;
        this.value = value;
  }
}
