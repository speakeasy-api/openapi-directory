...
class APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobileCapabilities:
    r"""APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobileCapabilities
...
class APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile:
    ...
    capabilities: Optional[APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobileCapabilities] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('capabilities') }})
