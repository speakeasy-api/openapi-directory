...
var PaginatedGroupApplicationResult = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return PaginatedGroupApplicationResultMeta; }),
        __metadata("design:type", PaginatedGroupApplicationResultMeta)
    ], PaginatedGroupApplicationResult.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: groupapplicationresult_1.GroupApplicationResult }),
        (0, class_transformer_1.Expose)({ name: "response" }),
        (0, class_transformer_1.Type)(function () { return groupapplicationresult_1.GroupApplicationResult; }),
