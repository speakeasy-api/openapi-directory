...
export enum ListRotationsXAmzTargetEnum {
  SSMContactsListRotations = "SSMContacts.ListRotations",
}

export class ListRotationsRequest extends SpeakeasyBase {
...
export class ListRotationsResponse extends SpeakeasyBase {
  /**
