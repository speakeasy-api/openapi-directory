...
class Game:
    ...
    alternate_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AlternateID'), 'exclude': lambda f: f is None }})  
    ...
    crew_chief_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CrewChiefID'), 'exclude': lambda f: f is None }})  
    ...
    umpire_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('UmpireID'), 'exclude': lambda f: f is None }})  
