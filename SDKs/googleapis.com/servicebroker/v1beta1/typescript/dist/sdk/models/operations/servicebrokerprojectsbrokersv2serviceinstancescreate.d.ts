...
export declare class ServicebrokerProjectsBrokersV2ServiceInstancesCreateSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ServicebrokerProjectsBrokersV2ServiceInstancesCreateRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class ServicebrokerProjectsBrokersV2ServiceInstancesCreateResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
