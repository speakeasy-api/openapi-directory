...
exports.ListIncomingPhoneNumberTollFreeResponse = exports.ListIncomingPhoneNumberTollFreeListIncomingPhoneNumberTollFreeResponse = exports.ListIncomingPhoneNumberTollFreeRequest = exports.ListIncomingPhoneNumberTollFreeSecurity = exports.ListIncomingPhoneNumberTollFreeServerList = void 0;
...
var ListIncomingPhoneNumberTollFreeSecurity = /** @class */ (function (_super) {
    ...
    ], ListIncomingPhoneNumberTollFreeSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListIncomingPhoneNumberTollFreeSecurity.prototype, "username", void 0);
...
var ListIncomingPhoneNumberTollFreeRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListIncomingPhoneNumberTollFreeRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Beta" }),
        __metadata("design:type", Boolean)
    ], ListIncomingPhoneNumberTollFreeRequest.prototype, "beta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=FriendlyName",
        }),
        __metadata("design:type", String)
    ], ListIncomingPhoneNumberTollFreeRequest.prototype, "friendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Origin",
        }),
        __metadata("design:type", String)
    ], ListIncomingPhoneNumberTollFreeRequest.prototype, "origin", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListIncomingPhoneNumberTollFreeRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListIncomingPhoneNumberTollFreeRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListIncomingPhoneNumberTollFreeRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PhoneNumber",
        }),
        __metadata("design:type", String)
    ], ListIncomingPhoneNumberTollFreeRequest.prototype, "phoneNumber", void 0);
...
var ListIncomingPhoneNumberTollFreeListIncomingPhoneNumberTollFreeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree,
        }),
        (0, class_transformer_1.Expose)({ name: "incoming_phone_numbers" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree; }),
...
var ListIncomingPhoneNumberTollFreeResponse = /** @class */ (function (_super) {
    ...
    ], ListIncomingPhoneNumberTollFreeResponse.prototype, "rawResponse", void 0);
