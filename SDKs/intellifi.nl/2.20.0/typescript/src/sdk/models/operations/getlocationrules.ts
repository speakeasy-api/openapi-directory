...
export class GetLocationRulesQueryParams extends SpeakeasyBase {
...
export class GetLocationRules200ApplicationJson extends SpeakeasyBase {
...
export class GetLocationRulesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: GetLocationRulesQueryParams;
}


export class GetLocationRulesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
