...
export class DataplexProjectsLocationsDataTaxonomiesAttributesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsDataTaxonomiesAttributesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsDataTaxonomiesAttributesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
