...
class GETDeleteVpcEndpointsRequest:
    ...
    action: GETDeleteVpcEndpointsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    version: GETDeleteVpcEndpointsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
    vpc_endpoint_id: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'VpcEndpointId', 'style': 'form', 'explode': True }})
    r"""The IDs of the VPC endpoints."""  
