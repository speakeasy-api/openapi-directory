...
public class POSTDescribeDBInstancesResponse {
    ...
    public POSTDescribeDBInstancesResponse withStatusCode(Integer statusCode) {
    ...
    public POSTDescribeDBInstancesResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
