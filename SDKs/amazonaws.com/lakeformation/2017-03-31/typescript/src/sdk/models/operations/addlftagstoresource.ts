 ...
 */
export class AddLFTagsToResourceRequestBodyResource extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "Catalog" })
...
export class AddLFTagsToResourceRequestBody extends SpeakeasyBase {
  /**
  ...
  @Type(() => AddLFTagsToResourceRequestBodyResource)
