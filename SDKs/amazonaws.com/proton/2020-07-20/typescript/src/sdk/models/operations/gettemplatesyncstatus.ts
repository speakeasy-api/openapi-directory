...
export enum GetTemplateSyncStatusXAmzTargetEnum {
  AwsProton20200720GetTemplateSyncStatus = "AwsProton20200720.GetTemplateSyncStatus",
}

export class GetTemplateSyncStatusRequest extends SpeakeasyBase {
...
export class GetTemplateSyncStatusResponse extends SpeakeasyBase {
  /**
