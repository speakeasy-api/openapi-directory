 ...
 */
public class UpdateNetworkApplianceVlan200ApplicationJSONMandatoryDhcp {
    /**
    ...
    public UpdateNetworkApplianceVlan200ApplicationJSONMandatoryDhcp withEnabled(Boolean enabled) {
        this.enabled = enabled;
        return this;
    }
    
    public UpdateNetworkApplianceVlan200ApplicationJSONMandatoryDhcp(){}
}
