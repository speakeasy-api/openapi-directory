...
export enum DeregisterMailDomainXAmzTargetEnum {
  WorkMailServiceDeregisterMailDomain = "WorkMailService.DeregisterMailDomain",
}

export class DeregisterMailDomainRequest extends SpeakeasyBase {
...
export class DeregisterMailDomainResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
