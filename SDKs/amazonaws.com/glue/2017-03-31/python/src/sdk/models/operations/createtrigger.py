...
class CreateTriggerRequest:
    headers: CreateTriggerHeaders = dataclasses.field()
    request: shared_createtriggerrequest.CreateTriggerRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
