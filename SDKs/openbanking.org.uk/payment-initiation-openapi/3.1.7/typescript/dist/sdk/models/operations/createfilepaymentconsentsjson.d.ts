...
export declare class CreateFilePaymentConsentsJsonSecurity extends SpeakeasyBase {
    tppoAuth2Security: string;
}
export declare class CreateFilePaymentConsentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateFilePaymentConsentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
