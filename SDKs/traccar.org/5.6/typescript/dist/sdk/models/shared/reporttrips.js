...
var ReportTrips = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "averageSpeed" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "driverName" }),
        __metadata("design:type", String)
    ], ReportTrips.prototype, "driverName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "driverUniqueId" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "endAddress" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maxSpeed" }),
        __metadata("design:type", Number)
