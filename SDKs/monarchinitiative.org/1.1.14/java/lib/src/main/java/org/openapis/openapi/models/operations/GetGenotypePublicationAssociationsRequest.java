...
public class GetGenotypePublicationAssociationsRequest {
    ...
    public GetGenotypePublicationAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGenotypePublicationAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGenotypePublicationAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGenotypePublicationAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGenotypePublicationAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGenotypePublicationAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGenotypePublicationAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGenotypePublicationAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGenotypePublicationAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGenotypePublicationAssociationsRequest withRelation(String relation) {
    ...
    public GetGenotypePublicationAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGenotypePublicationAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGenotypePublicationAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetGenotypePublicationAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGenotypePublicationAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGenotypePublicationAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGenotypePublicationAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGenotypePublicationAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
