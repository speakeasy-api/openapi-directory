...
export class RegionHealthChecks {
  ...
  computeRegionHealthChecksTestIamPermissions(
    req: operations.ComputeRegionHealthChecksTestIamPermissionsRequest,
    security: operations.ComputeRegionHealthChecksTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeRegionHealthChecksTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ComputeRegionHealthChecksTestIamPermissionsRequest(
        req
      );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ComputeRegionHealthChecksTestIamPermissionsSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeRegionHealthChecksTestIamPermissionsResponse =
        new operations.ComputeRegionHealthChecksTestIamPermissionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
