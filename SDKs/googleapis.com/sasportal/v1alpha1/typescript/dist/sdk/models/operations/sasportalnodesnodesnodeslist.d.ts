...
export declare class SasportalNodesNodesNodesListSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesNodesNodesListSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesNodesNodesListSecurity extends SpeakeasyBase {
    option1?: SasportalNodesNodesNodesListSecurityOption1;
    option2?: SasportalNodesNodesNodesListSecurityOption2;
}
