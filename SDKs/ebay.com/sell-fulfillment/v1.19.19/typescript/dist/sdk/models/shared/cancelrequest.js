...
var CancelRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "cancelCompletedDate" }),
        __metadata("design:type", String)
    ], CancelRequest.prototype, "cancelCompletedDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cancelInitiator" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cancelRequestId" }),
        __metadata("design:type", String)
    ], CancelRequest.prototype, "cancelRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cancelRequestState" }),
        __metadata("design:type", String)
    ], CancelRequest.prototype, "cancelRequestState", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cancelRequestedDate" }),
        __metadata("design:type", String)
