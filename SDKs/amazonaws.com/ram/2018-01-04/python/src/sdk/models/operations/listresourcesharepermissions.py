...
from ..shared import listresourcesharepermissionsresponse as shared_listresourcesharepermissionsresponse
...
class ListResourceSharePermissionsRequest:
    headers: ListResourceSharePermissionsHeaders = dataclasses.field()
    query_params: ListResourceSharePermissionsQueryParams = dataclasses.field()
    request: ListResourceSharePermissionsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class ListResourceSharePermissionsResponse:
    ...
    list_resource_share_permissions_response: Optional[shared_listresourcesharepermissionsresponse.ListResourceSharePermissionsResponse] = dataclasses.field(default=None)
