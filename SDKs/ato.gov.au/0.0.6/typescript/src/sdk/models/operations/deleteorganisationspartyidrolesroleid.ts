...
export class DeleteOrganisationsPartyIdRolesRoleIdRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class DeleteOrganisationsPartyIdRolesRoleIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
