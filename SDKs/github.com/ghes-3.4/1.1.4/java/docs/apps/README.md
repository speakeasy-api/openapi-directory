...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsAddRepoToInstallationForAuthenticatedUserRequest req = new AppsAddRepoToInstallationForAuthenticatedUserRequest(137220L, 20651L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsCheckTokenRequest req = new AppsCheckTokenRequest(                new AppsCheckTokenRequestBody("amet");, "optio");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsCreateFromManifestRequest req = new AppsCreateFromManifestRequest("accusamus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsCreateInstallationAccessTokenRequest req = new AppsCreateInstallationAccessTokenRequest(320017L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsDeleteAuthorizationRequest req = new AppsDeleteAuthorizationRequest(                new AppsDeleteAuthorizationRequestBody("totam");, "nihil");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsDeleteInstallationRequest req = new AppsDeleteInstallationRequest(25662L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsDeleteTokenRequest req = new AppsDeleteTokenRequest(                new AppsDeleteTokenRequestBody("expedita");, "neque");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsGetBySlugRequest req = new AppsGetBySlugRequest("sed");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsGetInstallationRequest req = new AppsGetInstallationRequest(424685L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsGetOrgInstallationRequest req = new AppsGetOrgInstallationRequest("libero");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsGetRepoInstallationRequest req = new AppsGetRepoInstallationRequest("voluptas", "deserunt");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsGetUserInstallationRequest req = new AppsGetUserInstallationRequest("quam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsGetWebhookDeliveryRequest req = new AppsGetWebhookDeliveryRequest(214880L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsListInstallationReposForAuthenticatedUserRequest req = new AppsListInstallationReposForAuthenticatedUserRequest(277628L) {{
                page = 186458L;
                perPage = 586784L;
            }};            
    ...
    public static void main(String[] args) {
        try {
            ...
            AppsListInstallationsRequest req = new AppsListInstallationsRequest() {{
                ...
                page = 863856L;
                perPage = 747080L;
                since = OffsetDateTime.parse("2022-04-29T16:20:13.800Z");
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsRedeliverWebhookDeliveryRequest req = new AppsRedeliverWebhookDeliveryRequest(396060L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsRemoveRepoFromInstallationForAuthenticatedUserRequest req = new AppsRemoveRepoFromInstallationForAuthenticatedUserRequest(463150L, 565421L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsResetTokenRequest req = new AppsResetTokenRequest(                new AppsResetTokenRequestBody("temporibus");, "qui");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsSuspendInstallationRequest req = new AppsSuspendInstallationRequest(9240L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsUnsuspendInstallationRequest req = new AppsUnsuspendInstallationRequest(669917L);            
