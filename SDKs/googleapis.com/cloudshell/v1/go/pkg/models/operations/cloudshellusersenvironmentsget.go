...
type CloudshellUsersEnvironmentsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudshellUsersEnvironmentsGetPathParams struct {
...
type CloudshellUsersEnvironmentsGetQueryParams struct {
	// V1 error format.
...
type CloudshellUsersEnvironmentsGetRequest struct {
...
type CloudshellUsersEnvironmentsGetResponse struct {
	ContentType string
	// Successful response
