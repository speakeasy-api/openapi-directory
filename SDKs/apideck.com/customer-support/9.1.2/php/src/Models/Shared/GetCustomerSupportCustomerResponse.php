...
class GetCustomerSupportCustomerResponse
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CustomerSupportCustomer')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\CustomerSupportCustomer();
		$this->operation = "";
		$this->resource = "";
		$this->service = "";
		$this->status = "";
