...
class GetDeviceLiveToolsPingDeviceRequest:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetDeviceLiveToolsPingDevice200ApplicationJSONResults:
    r"""Results of the ping request."""
    
    latencies: Optional[GetDeviceLiveToolsPingDevice200ApplicationJSONResultsLatencies] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('latencies'), 'exclude': lambda f: f is None }})
    r"""Packet latency stats"""  
    loss: Optional[GetDeviceLiveToolsPingDevice200ApplicationJSONResultsLoss] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('loss'), 'exclude': lambda f: f is None }})
    r"""Lost packets"""  
    ...
    replies: Optional[list[GetDeviceLiveToolsPingDevice200ApplicationJSONResultsReplies]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('replies'), 'exclude': lambda f: f is None }})
    r"""Received packets"""  
...
class GetDeviceLiveToolsPingDevice200ApplicationJSON:
    ...
    request: Optional[GetDeviceLiveToolsPingDevice200ApplicationJSONRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('request'), 'exclude': lambda f: f is None }})
    r"""Ping request parameters"""  
    results: Optional[GetDeviceLiveToolsPingDevice200ApplicationJSONResults] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})
    r"""Results of the ping request."""  
...
class GetDeviceLiveToolsPingDeviceResponse:
    ...
    get_device_live_tools_ping_device_200_application_json_object: Optional[GetDeviceLiveToolsPingDevice200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
