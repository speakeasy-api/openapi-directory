...
class FilesDetailRequest:
    ...
    r"""The unique identifier of the file you wish to retrieve."""  
    

@dataclasses.dataclass
class FilesDetailFileAttributes:
...
class FilesDetailFile:
    ...
    attributes: Optional[FilesDetailFileAttributes] = dataclasses.field(default=None)
    r"""The properties of the file entity."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The identifier of the file entity."""  
    links: Optional[FilesDetailFileLinks] = dataclasses.field(default=None)
    r"""Links to alternative representations of the file entity."""  
    relationships: Optional[FilesDetailFileRelationships] = dataclasses.field(default=None)
    r"""Links to other entities or entity collections that have a relationship to the file entity."""  
