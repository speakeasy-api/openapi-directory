...
<https://docs.github.com/github-ae@latest/rest/reference/search#search-code>
...
func main() {
    ...
    res, err := s.Search.SearchCode(ctx, operations.SearchCodeRequest{
        ...
        Page: sdk.Int64(627161),
        PerPage: sdk.Int64(783274),
        Q: "blanditiis",
...
Find commits via various criteria on the default branch (usually `main`). This method returns up to 100 results [per page](https://docs.github.com/github-ae@latest/rest/overview/resources-in-the-rest-api#pagination).
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/search#search-commits>
...
func main() {
    ...
    res, err := s.Search.SearchCommits(ctx, operations.SearchCommitsRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(169819),
        PerPage: sdk.Int64(885797),
        Q: "sed",
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/search#search-issues-and-pull-requests>
...
func main() {
    ...
    res, err := s.Search.SearchIssuesAndPullRequests(ctx, operations.SearchIssuesAndPullRequestsRequest{
        ...
        Page: sdk.Int64(55981),
        PerPage: sdk.Int64(567693),
        Q: "a",
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/search#search-labels>
...
func main() {
    ...
    res, err := s.Search.SearchLabels(ctx, operations.SearchLabelsRequest{
        Order: shared.OrderEnumAsc.ToPointer(),
        Page: sdk.Int64(982248),
        PerPage: sdk.Int64(691),
        Q: "asperiores",
        RepositoryID: 523365,
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/search#search-repositories>
...
func main() {
    ...
    res, err := s.Search.SearchRepos(ctx, operations.SearchReposRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(938257),
        PerPage: sdk.Int64(985360),
        Q: "velit",
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/search#search-topics>
...
func main() {
    ...
    res, err := s.Search.SearchTopics(ctx, operations.SearchTopicsRequest{
        Page: sdk.Int64(458212),
        PerPage: sdk.Int64(446547),
        Q: "eligendi",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/search#search-users>
...
func main() {
    ...
    res, err := s.Search.SearchUsers(ctx, operations.SearchUsersRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(203621),
        PerPage: sdk.Int64(876649),
        Q: "excepturi",
