...
public class EstimationApiUpdateJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public EstimationApiUpdateJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public EstimationApiUpdateJsonHeaders withXAuthSecret(String xAuthSecret) {
