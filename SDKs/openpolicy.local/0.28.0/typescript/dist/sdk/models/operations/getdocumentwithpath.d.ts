 ...
 */
export declare enum GetDocumentWithPath200ApplicationJSONResultAstPackagePathTypeEnum {
    Import = "import",
    Package = "package"
}
export declare class GetDocumentWithPath200ApplicationJSONResultAstPackagePath extends SpeakeasyBase {
    /**
     * The type of the path operation
     */
...
export declare class GetDocumentWithPath200ApplicationJSONResultAstPackage extends SpeakeasyBase {
    /**
     * The path to the package
     */
    path?: GetDocumentWithPath200ApplicationJSONResultAstPackagePath[];
}
export declare class GetDocumentWithPath200ApplicationJSONResultAstRulesBodyTermsValue extends SpeakeasyBase {
    type?: string;
    value?: string;
}
export declare class GetDocumentWithPath200ApplicationJSONResultAstRulesBodyTerms extends SpeakeasyBase {
    /**
...
export declare class GetDocumentWithPath200ApplicationJSONResultAstRulesBody extends SpeakeasyBase {
    /**
 ...
 */
export declare class GetDocumentWithPath200ApplicationJSONResultAstRulesHeadKey extends SpeakeasyBase {
    /**
...
export declare class GetDocumentWithPath200ApplicationJSONResultAstRulesHead extends SpeakeasyBase {
    /**
     * The type/value pairing for this rule's head
     */
...
export declare class GetDocumentWithPath200ApplicationJSONResultAstRules extends SpeakeasyBase {
    /**
 ...
 * @see {@link https://godoc.org/github.com/open-policy-agent/opa/ast} - AST
 */
export declare class GetDocumentWithPath200ApplicationJSONResultAst extends SpeakeasyBase {
...
export declare class GetDocumentWithPath200ApplicationJSONResult extends SpeakeasyBase {
    /**
     * The types for declarations and runtime objects passed to your implementation. This consists of an abstract syntax tree (AST) of policy modules, package and import declarations, rules, expressions, and terms.
     */
