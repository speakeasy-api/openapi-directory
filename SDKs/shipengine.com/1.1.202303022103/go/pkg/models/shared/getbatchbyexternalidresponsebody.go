...
func (e *GetBatchByExternalIDResponseBodyLabelFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "png":
		fallthrough
	case "zpl":
		*e = GetBatchByExternalIDResponseBodyLabelFormatEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetBatchByExternalIDResponseBodyLabelFormatEnum: %s", s)
	}
}
...
func (e *GetBatchByExternalIDResponseBodyLabelLayoutEnum) UnmarshalJSON(data []byte) error {
	...
	case "4x6":
		fallthrough
	case "letter":
		*e = GetBatchByExternalIDResponseBodyLabelLayoutEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetBatchByExternalIDResponseBodyLabelLayoutEnum: %s", s)
	}
}
...
func (e *GetBatchByExternalIDResponseBodyBatchStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "notifying":
		fallthrough
	case "invalid":
		*e = GetBatchByExternalIDResponseBodyBatchStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetBatchByExternalIDResponseBodyBatchStatusEnum: %s", s)
	}
}
