...
class BatchDeleteCustomVocabularyItemRequest
{
    ...
    public BatchDeleteCustomVocabularyItemRequestBody $requestBody;
	...
	{
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\BatchDeleteCustomVocabularyItemRequestBody();
