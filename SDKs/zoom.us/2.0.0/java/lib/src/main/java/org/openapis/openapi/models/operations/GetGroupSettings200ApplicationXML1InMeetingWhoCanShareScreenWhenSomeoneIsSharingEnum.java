 ...
 * 
 */
public enum GetGroupSettings200ApplicationXML1InMeetingWhoCanShareScreenWhenSomeoneIsSharingEnum {
    HOST("host"),
    ALL("all");
    ...
    private GetGroupSettings200ApplicationXML1InMeetingWhoCanShareScreenWhenSomeoneIsSharingEnum(String value) {
        this.value = value;
    }
}
