...
class GetQuestionsUnansweredQueryParams:
    ...
    order: Optional[GetQuestionsUnansweredOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetQuestionsUnansweredSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetQuestionsUnansweredRequest:
    query_params: GetQuestionsUnansweredQueryParams = dataclasses.field()
