...
func (e RemovePermissionActionGroupEnum) ToPointer() *RemovePermissionActionGroupEnum {
	return &e
}
...
func (e *RemovePermissionActionGroupEnum) UnmarshalJSON(data []byte) error {
	...
	case "agentPermissions":
		*e = RemovePermissionActionGroupEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RemovePermissionActionGroupEnum: %v", v)
	}
}
