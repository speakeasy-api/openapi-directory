 ...
 */
export class DescribeSecurityGroupsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeSecurityGroupsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeSecurityGroupsRequestFilters })
  filters?: DescribeSecurityGroupsRequestFilters[];
