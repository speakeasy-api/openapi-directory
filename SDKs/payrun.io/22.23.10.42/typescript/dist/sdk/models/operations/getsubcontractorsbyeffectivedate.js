...
exports.GetSubContractorsByEffectiveDateResponse = exports.GetSubContractorsByEffectiveDateRequest = void 0;
...
var GetSubContractorsByEffectiveDateRequest = /** @class */ (function (_super) {
    ...
    ], GetSubContractorsByEffectiveDateRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetSubContractorsByEffectiveDateRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EffectiveDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetSubContractorsByEffectiveDateRequest.prototype, "effectiveDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetSubContractorsByEffectiveDateRequest.prototype, "employerId", void 0);
    return GetSubContractorsByEffectiveDateRequest;
}(utils_1.SpeakeasyBase));
exports.GetSubContractorsByEffectiveDateRequest = GetSubContractorsByEffectiveDateRequest;
var GetSubContractorsByEffectiveDateResponse = /** @class */ (function (_super) {
    ...
    ], GetSubContractorsByEffectiveDateResponse.prototype, "rawResponse", void 0);
    return GetSubContractorsByEffectiveDateResponse;
}(utils_1.SpeakeasyBase));
exports.GetSubContractorsByEffectiveDateResponse = GetSubContractorsByEffectiveDateResponse;
