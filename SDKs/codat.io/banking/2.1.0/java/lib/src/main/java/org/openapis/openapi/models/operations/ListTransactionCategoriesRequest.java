...
public class ListTransactionCategoriesRequest {
    ...
    public ListTransactionCategoriesRequest withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public ListTransactionCategoriesRequest withPageSize(Integer pageSize) {
    ...
    public ListTransactionCategoriesRequest(@JsonProperty("companyId") String companyId, @JsonProperty("connectionId") String connectionId, @JsonProperty("page") Integer page) {
        this.companyId = companyId;
        this.connectionId = connectionId;
        this.page = page;
  }
