...
func (e GetNetworkWirelessClientConnectionStatsBandEnum) ToPointer() *GetNetworkWirelessClientConnectionStatsBandEnum {
	return &e
}
...
func (e *GetNetworkWirelessClientConnectionStatsBandEnum) UnmarshalJSON(data []byte) error {
	...
	case "5":
		fallthrough
	case "6":
		*e = GetNetworkWirelessClientConnectionStatsBandEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessClientConnectionStatsBandEnum: %v", v)
	}
}
