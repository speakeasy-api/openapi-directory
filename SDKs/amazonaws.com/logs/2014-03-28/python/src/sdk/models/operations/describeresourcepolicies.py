...
class DescribeResourcePoliciesRequest:
    ...
    describe_resource_policies_request: shared_describeresourcepoliciesrequest.DescribeResourcePoliciesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
