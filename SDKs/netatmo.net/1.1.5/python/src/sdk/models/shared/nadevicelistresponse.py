...
import dataclasses
from ..shared import nadevicelistbody as shared_nadevicelistbody
...
class NADeviceListResponse:
    ...
    body: Optional[shared_nadevicelistbody.NADeviceListBody] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('body'), 'exclude': lambda f: f is None }})  
