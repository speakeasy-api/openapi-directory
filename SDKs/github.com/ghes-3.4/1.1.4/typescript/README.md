...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/github.com/ghes-3.4/1.1.4/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/github.com/ghes-3.4/1.1.4/typescript
```
