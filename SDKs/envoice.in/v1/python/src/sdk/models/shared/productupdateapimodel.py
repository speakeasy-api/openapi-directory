...
class ProductUpdateAPIModel:
    ...
    status: Optional[ProductUpdateAPIModelStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Status'), 'exclude': lambda f: f is None }, 'form': { 'field_name': 'Status' }})
    r"""Product availability status"""  
