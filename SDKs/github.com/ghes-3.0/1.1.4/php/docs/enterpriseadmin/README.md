...
try {
    ...
    $request->runnerGroupId = 775220;
    $request->runnerId = 232234;
...
try {
    ...
    $request->license = 'recusandae';
    $request->password = 'aspernatur';
    $request->settings = 'minima';
...
try {
    ...
    $request->requestBody->config->contentType = 'eaque';
    $request->requestBody->config->insecureSsl = 'a';
    $request->requestBody->config->secret = 'libero';
    $request->requestBody->config->url = 'aut';
    $request->requestBody->events = [
        'deleniti',
    ];
    $request->requestBody->name = 'Jim Corkery I';
    $request->accept = 'et';
...
try {
    ...
    $request->email = 'Gabe77@hotmail.com';
    $request->login = 'esse';
...
try {
    ...
    $request->username = 'Micheal.Schmidt';
...
try {
    ...
    $request->preReceiveEnvironmentId = 518835;
...
try {
    ...
    $request->preReceiveHookId = 882710;
...
try {
    ...
    $request->enterprise = 'odio';
    $request->runnerId = 577543;
...
try {
    ...
    $request->username = 'Chaim.Oberbrunner';
...
try {
    ...
    $request->username = 'Ottilie_Keeling';
...
try {
    ...
    $request->preReceiveEnvironmentId = 539224;
...
try {
    ...
    $request->accept = 'minima';
    $request->hookId = 392676;
...
try {
    ...
    $request->preReceiveEnvironmentId = 147014;
...
try {
    ...
    $request->preReceiveHookId = 956406;
...
try {
    ...
    $request->preReceiveHookId = 187131;
...
try {
    ...
    $request->preReceiveHookId = 903984;
...
try {
    ...
    $request->enterprise = 'atque';
    $request->runnerId = 92260;
...
try {
    ...
    $request->page = 724168;
    $request->perPage = 877131;
    $request->runnerGroupId = 399025;
...
try {
    ...
    $request->enterprise = 'possimus';
    $request->page = 157632;
    $request->perPage = 908844;
...
try {
    ...
    $request->enterprise = 'asperiores';
    $request->page = 815524;
    $request->perPage = 85001;
    $request->runnerGroupId = 159414;
...
try {
    ...
    $request->username = 'Lorena.Jacobi93';
...
try {
    ...
    $request->orgId = 258684;
    $request->runnerGroupId = 727697;
...
try {
    ...
    $request->org = 'illum';
    $request->preReceiveHookId = 742238;
...
try {
    ...
    $request->preReceiveHookId = 306986;
    $request->repo = 'sapiente';
...
try {
    ...
    $request->runnerGroupId = 355369;
    $request->runnerId = 443879;
...
try {
    ...
    $request->requestBody->enabledOrganizations = EnabledOrganizationsEnum::SELECTED;
...
try {
    ...
    $request->enterprise = 'omnis';
    $request->runnerGroupId = 945302;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#start-a-configuration-process>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#start-a-pre-receive-environment-download>
...
try {
    ...
    $request->preReceiveEnvironmentId = 614465;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#suspend-a-user>
...
try {
    ...
    $request->requestBody->reason = 'temporibus';
    $request->username = 'Alexanne51';
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#sync-ldap-mapping-for-a-team>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#sync-ldap-mapping-for-a-user>
...
try {
    ...
    $request->username = 'Mabel.Bernhard';
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#unsuspend-a-user>
...
try {
    ...
    $request->requestBody->reason = 'voluptatem';
    $request->username = 'Dallas77';
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#update-a-global-webhook>
...
try {
    ...
    $request->requestBody->config->contentType = 'explicabo';
    $request->requestBody->config->insecureSsl = 'voluptas';
    $request->requestBody->config->secret = 'aut';
    $request->requestBody->config->url = 'dignissimos';
    $request->requestBody->events = [
        'maiores',
    ];
    $request->accept = 'natus';
    $request->hookId = 244651;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#update-ldap-mapping-for-a-team>
...
try {
    ...
    $request->requestBody->ldapDn = 'voluptatibus';
    $request->teamId = 374323;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#update-ldap-mapping-for-a-user>
...
try {
    ...
    $request->requestBody->ldapDn = 'asperiores';
    $request->username = 'Alvina16';
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#update-an-organization-name>
...
try {
    ...
    $request->requestBody->login = 'repellendus';
    $request->org = 'officia';
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#update-a-pre-receive-environment>
...
try {
    ...
    $request->requestBody->imageUrl = 'maxime';
    $request->requestBody->name = 'Blanche Yundt II';
    $request->preReceiveEnvironmentId = 783235;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#update-a-pre-receive-hook>
...
try {
    ...
    $request->requestBody->enforcement = 'quod';
    $request->requestBody->environment = [
        'ab' => 'adipisci',
        'fuga' => 'id',
    ];
    $request->requestBody->name = 'Sheila Nader';
    $request->requestBody->script = 'totam';
    ...
    $request->preReceiveHookId = 414857;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#update-pre-receive-hook-enforcement-for-an-organization>
...
try {
    ...
    $request->requestBody->allowDownstreamConfiguration = false;
    $request->requestBody->enforcement = 'in';
    $request->org = 'corporis';
    $request->preReceiveHookId = 968904;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#update-pre-receive-hook-enforcement-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/actions#update-a-self-hosted-runner-group-for-an-enterprise>
...
try {
    ...
    $request->requestBody->allowsPublicRepositories = false;
    $request->requestBody->name = 'Karla Feest';
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#update-the-username-for-a-user>
...
try {
    ...
    $request->requestBody->login = 'doloribus';
    $request->username = 'Georgianna_Wisozk89';
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#upgrade-a-license>
