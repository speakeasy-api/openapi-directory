...
func (e GetMergeConflictsXAmzTargetEnum) ToPointer() *GetMergeConflictsXAmzTargetEnum {
	return &e
}
...
func (e *GetMergeConflictsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "CodeCommit_20150413.GetMergeConflicts":
		*e = GetMergeConflictsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetMergeConflictsXAmzTargetEnum: %v", v)
	}
}
