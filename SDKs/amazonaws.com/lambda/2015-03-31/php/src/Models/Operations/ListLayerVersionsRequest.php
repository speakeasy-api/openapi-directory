...
class ListLayerVersionsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ListLayerVersionsCompatibleArchitectureEnum $compatibleArchitecture
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=CompatibleArchitecture')]
    public ?ListLayerVersionsCompatibleArchitectureEnum $compatibleArchitecture = null;
    
    /**
     * A runtime identifier. For example, <code>go1.x</code>.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ListLayerVersionsCompatibleRuntimeEnum $compatibleRuntime
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=CompatibleRuntime')]
    public ?ListLayerVersionsCompatibleRuntimeEnum $compatibleRuntime = null;
