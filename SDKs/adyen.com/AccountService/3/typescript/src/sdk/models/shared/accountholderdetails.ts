...
export class AccountHolderDetails extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "address" })
  @Type(() => ViasAddress)
  address?: ViasAddress;
   ...
   */
  @SpeakeasyMetadata({ elemType: BankAccountDetail })
  @Expose({ name: "bankAccountDetails" })
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "principalBusinessAddress" })
  @Type(() => ViasAddress)
