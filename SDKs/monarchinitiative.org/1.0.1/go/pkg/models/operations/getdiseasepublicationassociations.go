...
type GetDiseasePublicationAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetDiseasePublicationAssociationsQueryParams struct {
