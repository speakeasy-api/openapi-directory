 ...
 */
export declare class GetTransitGatewayPolicyTableAssociationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetTransitGatewayPolicyTableAssociationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
