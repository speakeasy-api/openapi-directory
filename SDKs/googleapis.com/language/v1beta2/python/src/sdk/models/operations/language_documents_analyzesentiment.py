...
class LanguageDocumentsAnalyzeSentimentRequest:
    ...
    analyze_sentiment_request: Optional[shared_analyzesentimentrequest.AnalyzeSentimentRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
