...
func (e UnclaimDeviceRequestSectionTypeEnum) ToPointer() *UnclaimDeviceRequestSectionTypeEnum {
	return &e
}
...
func (e *UnclaimDeviceRequestSectionTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "SECTION_TYPE_ZERO_TOUCH":
		*e = UnclaimDeviceRequestSectionTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UnclaimDeviceRequestSectionTypeEnum: %v", v)
	}
}
