...
exports.SessionControllerCreateLandlordLoginResponse = exports.SessionControllerCreateLandlordLoginRequest = void 0;
...
var SessionControllerCreateLandlordLoginRequest = /** @class */ (function (_super) {
    ...
    ], SessionControllerCreateLandlordLoginRequest.prototype, "branchID", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=contactDetails",
        }),
        __metadata("design:type", String)
    ], SessionControllerCreateLandlordLoginRequest.prototype, "contactDetails", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=email" }),
        __metadata("design:type", String)
    ], SessionControllerCreateLandlordLoginRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=forename",
        }),
        __metadata("design:type", String)
    ], SessionControllerCreateLandlordLoginRequest.prototype, "forename", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=propertyAddress",
        }),
        __metadata("design:type", String)
    ], SessionControllerCreateLandlordLoginRequest.prototype, "propertyAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=shortName",
        }),
        __metadata("design:type", String)
    ], SessionControllerCreateLandlordLoginRequest.prototype, "shortName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=surname",
        }),
        __metadata("design:type", String)
    ], SessionControllerCreateLandlordLoginRequest.prototype, "surname", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=title" }),
        __metadata("design:type", String)
    ], SessionControllerCreateLandlordLoginRequest.prototype, "title", void 0);
...
var SessionControllerCreateLandlordLoginResponse = /** @class */ (function (_super) {
    ...
    ], SessionControllerCreateLandlordLoginResponse.prototype, "rawResponse", void 0);
