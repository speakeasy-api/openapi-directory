...
export class PaymentsProgram {
  ...
  getPaymentsProgram(
    ...
    security: operations.GetPaymentsProgramSecurity,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetPaymentsProgramResponse =
        new operations.GetPaymentsProgramResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.paymentsProgramResponse = utils.objectToClass(
              httpRes?.data,
              shared.PaymentsProgramResponse
            );
          }
          break;
