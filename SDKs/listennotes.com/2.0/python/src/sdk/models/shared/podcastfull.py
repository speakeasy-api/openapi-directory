...
class PodcastFull:
    ...
    episodes: Optional[list[shared_episodeminimum.EpisodeMinimum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('episodes'), 'exclude': lambda f: f is None }})  
    ...
    next_episode_pub_date: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('next_episode_pub_date'), 'exclude': lambda f: f is None }})
    r"""Passed to the **next_episode_pub_date** parameter of `GET /podcasts/{id}` to paginate through episodes of that podcast."""  
