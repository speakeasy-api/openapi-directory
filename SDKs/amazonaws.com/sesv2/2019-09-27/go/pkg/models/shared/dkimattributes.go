...
type DkimAttributes struct {
	CurrentSigningKeyLength    *DkimSigningKeyLengthEnum        `json:"CurrentSigningKeyLength,omitempty"`
	LastKeyGenerationTimestamp *time.Time                       `json:"LastKeyGenerationTimestamp,omitempty"`
	NextSigningKeyLength       *DkimSigningKeyLengthEnum        `json:"NextSigningKeyLength,omitempty"`
