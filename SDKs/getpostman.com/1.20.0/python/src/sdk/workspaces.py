...
class Workspaces:
    ...
    def all_workspaces(self) -> operations.AllWorkspacesResponse:
        ...
        res = operations.AllWorkspacesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.AllWorkspaces200ApplicationJSON])
                res.all_workspaces_200_application_json_object = out

        return res

    def create_workspace(self, request: operations.CreateWorkspaceRequestBody) -> operations.CreateWorkspaceResponse:
        r"""Create Workspace
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.CreateWorkspace200ApplicationJSON])
                res.create_workspace_200_application_json_object = out
        elif http_res.status_code == 400:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.CreateWorkspace400ApplicationJSON])
    ...
    def delete_workspace(self, request: operations.DeleteWorkspaceRequest) -> operations.DeleteWorkspaceResponse:
        ...
        url = utils.generate_url(operations.DeleteWorkspaceRequest, base_url, '/workspaces/{workspace_id}', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.DeleteWorkspace200ApplicationJSON])
    ...
    def single_workspace(self, request: operations.SingleWorkspaceRequest) -> operations.SingleWorkspaceResponse:
        ...
        url = utils.generate_url(operations.SingleWorkspaceRequest, base_url, '/workspaces/{workspace_id}', request)
        ...
        res = operations.SingleWorkspaceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.SingleWorkspace200ApplicationJSON])
                res.single_workspace_200_application_json_object = out
        elif http_res.status_code == 404:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.SingleWorkspace404ApplicationJSON])
    ...
    def update_workspace(self, request: operations.UpdateWorkspaceRequest) -> operations.UpdateWorkspaceResponse:
        ...
        **Note** : The endpoint expects you to send the desired state of the workspace in terms of the associated entities so be careful when trying to update these entities.
        ...
        url = utils.generate_url(operations.UpdateWorkspaceRequest, base_url, '/workspaces/{workspace_id}', request)
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.UpdateWorkspace403ApplicationJSON])
                res.update_workspace_403_application_json_object = out
        elif http_res.status_code == 404:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.UpdateWorkspace404ApplicationJSON])
