...
class CloneStackRequest:
    ...
    source_stack_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SourceStackId') }})  
    ...
    clone_app_ids: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CloneAppIds'), 'exclude': lambda f: f is None }})  
    clone_permissions: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ClonePermissions'), 'exclude': lambda f: f is None }})  
