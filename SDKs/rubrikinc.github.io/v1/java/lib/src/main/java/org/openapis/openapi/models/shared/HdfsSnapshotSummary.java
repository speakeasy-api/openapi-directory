...
public class HdfsSnapshotSummary {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("archivalLocationIds")
    public String[] archivalLocationIds;

    public HdfsSnapshotSummary withArchivalLocationIds(String[] archivalLocationIds) {
    ...
    public HdfsSnapshotSummary withCloudState(Long cloudState) {
    ...
    public HdfsSnapshotSummary withCloudStorageTier(SnapshotCloudStorageTierEnum cloudStorageTier) {
    ...
    public HdfsSnapshotSummary withConsistencyLevel(String consistencyLevel) {
    ...
    public HdfsSnapshotSummary withDate(OffsetDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public HdfsSnapshotSummary withExpirationDate(OffsetDateTime expirationDate) {
    ...
    public HdfsSnapshotSummary withFileCount(Long fileCount) {
        this.fileCount = fileCount;
        return this;
    }
    
    @JsonProperty("hdfsName")
    public String hdfsName;

    public HdfsSnapshotSummary withHdfsName(String hdfsName) {
    ...
    public HdfsSnapshotSummary withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public HdfsSnapshotSummary withIndexState(Long indexState) {
    ...
    public HdfsSnapshotSummary withIsCustomRetentionApplied(Boolean isCustomRetentionApplied) {
    ...
    public HdfsSnapshotSummary withIsOnDemandSnapshot(Boolean isOnDemandSnapshot) {
    ...
    public HdfsSnapshotSummary withIsPlacedOnLegalHold(Boolean isPlacedOnLegalHold) {
    ...
    public HdfsSnapshotSummary withIsRetainedByRetentionLockSla(Boolean isRetainedByRetentionLockSla) {
    ...
    public HdfsSnapshotSummary withParentSnapshotId(String parentSnapshotId) {
    ...
    public HdfsSnapshotSummary withReplicationLocationIds(String[] replicationLocationIds) {
    ...
    public HdfsSnapshotSummary withSlaId(String slaId) {
        this.slaId = slaId;
        return this;
    }
    ...
    public HdfsSnapshotSummary withSlaName(String slaName) {
    ...
    public HdfsSnapshotSummary withSnapshotRetentionInfo(SnapshotRetentionInfo snapshotRetentionInfo) {
    ...
    public HdfsSnapshotSummary withSourceObjectType(String sourceObjectType) {
        this.sourceObjectType = sourceObjectType;
        return this;
    }
    
    public HdfsSnapshotSummary(@JsonProperty("date") OffsetDateTime date, @JsonProperty("hdfsName") String hdfsName, @JsonProperty("id") String id, @JsonProperty("isCustomRetentionApplied") Boolean isCustomRetentionApplied, @JsonProperty("isOnDemandSnapshot") Boolean isOnDemandSnapshot, @JsonProperty("replicationLocationIds") String[] replicationLocationIds, @JsonProperty("slaId") String slaId, @JsonProperty("slaName") String slaName) {
        this.date = date;
        this.hdfsName = hdfsName;
        this.id = id;
        this.isCustomRetentionApplied = isCustomRetentionApplied;
