 ...
 */
public enum DescribeFleetsResultFleetsInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsLocalStorageEnum {
    INCLUDED("included"),
    REQUIRED("required"),
    EXCLUDED("excluded");
    ...
    private DescribeFleetsResultFleetsInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsLocalStorageEnum(String value) {
        this.value = value;
    }
}
