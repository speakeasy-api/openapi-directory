...
public class RemoveWarehouseRequest {
    ...
    public RemoveWarehouseRequest(@JsonProperty("Accept") String accept, @JsonProperty("Content-Type") String contentType, @JsonProperty("warehouseId") String warehouseId) {
        this.accept = accept;
        this.contentType = contentType;
        this.warehouseId = warehouseId;
  }
