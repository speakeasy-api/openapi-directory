...
var IosTest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "iosAppInfo" }),
        (0, class_transformer_1.Type)(function () { return iosappinfo_1.IosAppInfo; }),
        __metadata("design:type", iosappinfo_1.IosAppInfo)
    ], IosTest.prototype, "iosAppInfo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "iosRoboTest" }),
