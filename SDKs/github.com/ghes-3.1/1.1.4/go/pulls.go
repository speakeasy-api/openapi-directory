...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#check-if-a-pull-request-has-been-merged - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#create-a-pull-request - API method documentation
...
//
// This endpoint triggers [notifications](https://docs.github.com/en/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in abuse rate limiting. See "[Abuse rate limits](https://docs.github.com/enterprise-server@3.1/rest/overview/resources-in-the-rest-api#abuse-rate-limits)" and "[Dealing with abuse rate limits](https://docs.github.com/enterprise-server@3.1/rest/guides/best-practices-for-integrators#dealing-with-rate-limits)" for details.
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#create-a-reply-for-a-review-comment - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#create-a-review-for-a-pull-request - API method documentation
...
//
// This endpoint triggers [notifications](https://docs.github.com/en/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in abuse rate limiting. See "[Abuse rate limits](https://docs.github.com/enterprise-server@3.1/rest/overview/resources-in-the-rest-api#abuse-rate-limits)" and "[Dealing with abuse rate limits](https://docs.github.com/enterprise-server@3.1/rest/guides/best-practices-for-integrators#dealing-with-rate-limits)" for details.
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#create-a-review-comment-for-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#delete-a-pending-review-for-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#delete-a-review-comment-for-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#dismiss-a-review-for-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#get-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#get-a-review-for-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#get-a-review-comment-for-a-pull-request - API method documentation
...
// Draft pull requests are available in public repositories with GitHub Free and GitHub Free for organizations, GitHub Pro, and legacy per-repository billing plans, and in public and private repositories with GitHub Team and GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#list-pull-requests - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#list-comments-for-a-pull-request-review - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#list-commits-on-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#list-pull-requests-files - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#list-requested-reviewers-for-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#list-review-comments-on-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#list-review-comments-in-a-repository - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#list-reviews-for-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#merge-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#remove-requested-reviewers-from-a-pull-request - API method documentation
...
// This endpoint triggers [notifications](https://docs.github.com/enterprise-server@3.1/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in abuse rate limiting. See "[Abuse rate limits](https://docs.github.com/enterprise-server@3.1/rest/overview/resources-in-the-rest-api#abuse-rate-limits)" and "[Dealing with abuse rate limits](https://docs.github.com/enterprise-server@3.1/rest/guides/best-practices-for-integrators#dealing-with-abuse-rate-limits)" for details.
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#request-reviewers-for-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#submit-a-review-for-a-pull-request - API method documentation
...
//
// To open or update a pull request in a public repository, you must have write access to the head or the source branch. For organization-owned repositories, you must be a member of the organization that owns the repository to open or update a pull request.
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls/#update-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#update-a-pull-request-branch - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#update-a-review-for-a-pull-request - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/pulls#update-a-review-comment-for-a-pull-request - API method documentation
