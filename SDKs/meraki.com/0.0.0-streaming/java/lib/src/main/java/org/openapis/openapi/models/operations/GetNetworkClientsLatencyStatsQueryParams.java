...
public class GetNetworkClientsLatencyStatsQueryParams {
    /**
     * Filter results by AP Tag
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=apTag")
    public String apTag;
    public GetNetworkClientsLatencyStatsQueryParams withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkClientsLatencyStatsQueryParams withBand(GetNetworkClientsLatencyStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public GetNetworkClientsLatencyStatsQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public Long ssid;
    public GetNetworkClientsLatencyStatsQueryParams withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetNetworkClientsLatencyStatsQueryParams withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetNetworkClientsLatencyStatsQueryParams withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkClientsLatencyStatsQueryParams withTimespan(Float timespan) {
    ...
    public Long vlan;
    public GetNetworkClientsLatencyStatsQueryParams withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
