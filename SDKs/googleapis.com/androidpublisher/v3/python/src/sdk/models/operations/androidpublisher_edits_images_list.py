...
class AndroidpublisherEditsImagesListImageTypeEnum(str, Enum):
    r"""Type of the Image. Providing an image type that refers to no images will return an empty response."""
...
class AndroidpublisherEditsImagesListRequest:
    ...
    r"""Language localization code (a BCP-47 language tag; for example, \\"de-AT\\" for Austrian German). There must be a store listing for the specified language."""  
