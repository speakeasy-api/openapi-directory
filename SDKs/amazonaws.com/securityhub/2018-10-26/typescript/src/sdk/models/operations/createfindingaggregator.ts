...
export class CreateFindingAggregatorRequestBody extends SpeakeasyBase {
  /**
...
export class CreateFindingAggregatorRequest extends SpeakeasyBase {
...
export class CreateFindingAggregatorResponse extends SpeakeasyBase {
  /**
