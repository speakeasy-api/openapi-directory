...
const (
	ListTagsForResourceXAmzTargetEnumAwsInsightsIndexServiceListTagsForResource ListTagsForResourceXAmzTargetEnum = "AWSInsightsIndexService.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "AWSInsightsIndexService.ListTagsForResource":
