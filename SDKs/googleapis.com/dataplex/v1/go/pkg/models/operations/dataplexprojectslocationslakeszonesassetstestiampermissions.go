...
type DataplexProjectsLocationsLakesZonesAssetsTestIamPermissionsSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DataplexProjectsLocationsLakesZonesAssetsTestIamPermissionsPathParams struct {
	// REQUIRED: The resource for which the policy detail is being requested. See Resource names (https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
	Resource string `pathParam:"style=simple,explode=false,name=resource"`
}

type DataplexProjectsLocationsLakesZonesAssetsTestIamPermissionsQueryParams struct {
	// V1 error format.
...
type DataplexProjectsLocationsLakesZonesAssetsTestIamPermissionsRequest struct {
...
type DataplexProjectsLocationsLakesZonesAssetsTestIamPermissionsResponse struct {
	ContentType string
	// Successful response
