...
public class GoogleCloudRetailV2RemoveFulfillmentPlacesRequest {
    ...
    public GoogleCloudRetailV2RemoveFulfillmentPlacesRequest withAllowMissing(Boolean allowMissing) {
    ...
    public GoogleCloudRetailV2RemoveFulfillmentPlacesRequest withPlaceIds(String[] placeIds) {
    ...
    public GoogleCloudRetailV2RemoveFulfillmentPlacesRequest withRemoveTime(String removeTime) {
    ...
    public GoogleCloudRetailV2RemoveFulfillmentPlacesRequest withType(String type) {
        this.type = type;
        return this;
    }
