...
export class GetSchedulesScheduleETotalsByCandidateRequest extends SpeakeasyBase {
  /**
   *
   * @remarks
...
export class GetSchedulesScheduleETotalsByCandidateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
