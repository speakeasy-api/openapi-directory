...
var Tags = /** @class */ (function () {
     ...
     * List Tags
     */
    Tags.prototype.collectionTagsAll = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CollectionTagsAllRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/issue-tracking/collections/{collection_id}/tags", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.CollectionTagsAllSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.CollectionTagsAllResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getCollectionTagsResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetCollectionTagsResponse);
                    }
                    break;
