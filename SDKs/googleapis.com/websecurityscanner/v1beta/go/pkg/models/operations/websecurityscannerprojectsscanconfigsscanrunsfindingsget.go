...
type WebsecurityscannerProjectsScanConfigsScanRunsFindingsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type WebsecurityscannerProjectsScanConfigsScanRunsFindingsGetPathParams struct {
...
type WebsecurityscannerProjectsScanConfigsScanRunsFindingsGetQueryParams struct {
	// V1 error format.
...
type WebsecurityscannerProjectsScanConfigsScanRunsFindingsGetRequest struct {
...
type WebsecurityscannerProjectsScanConfigsScanRunsFindingsGetResponse struct {
	ContentType string
	// Successful response
