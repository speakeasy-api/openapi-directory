...
class DescribeVerifiedAccessGroupsRequest:
    ...
    filters: Optional[list[DescribeVerifiedAccessGroupsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    verified_access_group_ids: Optional[list[str]] = dataclasses.field(default=None)  
