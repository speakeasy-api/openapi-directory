...
__doc__ = """ SDK Documentation: https://docs.aws.amazon.com/elasticache/ - Amazon Web Services documentation"""
import requests
...
class SDK:
    r"""SDK Documentation: https://docs.aws.amazon.com/elasticache/ - Amazon Web Services documentation"""
    ...
    def get_delete_user(self, request: operations.GetDeleteUserRequest) -> operations.GetDeleteUserResponse:
        r"""For Redis engine version 6.x onwards: Deletes a user. The user will be removed from all user groups and in turn removed from all replication groups. For more information, see <a href=\"http://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/Clusters.RBAC.html\">Using Role Based Access Control (RBAC)</a>. 
        """
    ...
    def get_failover_global_replication_group(self, request: operations.GetFailoverGlobalReplicationGroupRequest) -> operations.GetFailoverGlobalReplicationGroupResponse:
        r"""Used to failover the primary region to a selected secondary region. The selected secondary region will become primary, and all other clusters will become secondary.
        """
    ...
    def post_create_user(self, request: operations.PostCreateUserRequest) -> operations.PostCreateUserResponse:
        r"""For Redis engine version 6.x onwards: Creates a Redis user. For more information, see <a href=\"http://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/Clusters.RBAC.html\">Using Role Based Access Control (RBAC)</a>.
        """
    ...
    def post_create_user_group(self, request: operations.PostCreateUserGroupRequest) -> operations.PostCreateUserGroupResponse:
        r"""For Redis engine version 6.x onwards: Creates a Redis user group. For more information, see <a href=\"http://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/Clusters.RBAC.html\">Using Role Based Access Control (RBAC)</a> 
        """
