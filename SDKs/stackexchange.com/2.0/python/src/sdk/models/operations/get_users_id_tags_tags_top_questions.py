...
class GetUsersIDTagsTagsTopQuestionsPathParams:
    id: int = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    tags: str = dataclasses.field(metadata={'path_param': { 'field_name': 'tags', 'style': 'simple', 'explode': False }})
    
class GetUsersIDTagsTagsTopQuestionsOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetUsersIDTagsTagsTopQuestionsSortEnum(str, Enum):
    ACTIVITY = "activity"
    CREATION = "creation"
    VOTES = "votes"
...
@dataclasses.dataclass
class GetUsersIDTagsTagsTopQuestionsQueryParams:
    ...
    order: Optional[GetUsersIDTagsTagsTopQuestionsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetUsersIDTagsTagsTopQuestionsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetUsersIDTagsTagsTopQuestionsRequest:
    path_params: GetUsersIDTagsTagsTopQuestionsPathParams = dataclasses.field()
    query_params: GetUsersIDTagsTagsTopQuestionsQueryParams = dataclasses.field()
