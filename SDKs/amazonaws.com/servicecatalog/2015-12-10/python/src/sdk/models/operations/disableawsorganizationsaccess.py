...
class DisableAwsOrganizationsAccessHeaders:
    x_amz_target: DisableAwsOrganizationsAccessXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisableAwsOrganizationsAccessRequest:
    headers: DisableAwsOrganizationsAccessHeaders = dataclasses.field()
...
class DisableAwsOrganizationsAccessResponse:
    ...
    disable_aws_organizations_access_output: Optional[dict[str, Any]] = dataclasses.field(default=None)
