...
type ContentOrdertrackingsignalsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentOrdertrackingsignalsCreatePathParams struct {
	// The ID of the merchant for which the order signal is created.
	MerchantID string `pathParam:"style=simple,explode=false,name=merchantId"`
}

type ContentOrdertrackingsignalsCreateQueryParams struct {
	// V1 error format.
...
type ContentOrdertrackingsignalsCreateResponse struct {
	ContentType string
	// Successful response
