 ...
 */
export declare enum ProvisionByoipCidrRequestPoolTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class ProvisionByoipCidrRequestPoolTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class ProvisionByoipCidrRequestPoolTagSpecifications extends SpeakeasyBase {
