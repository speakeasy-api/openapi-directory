...
class InvoiceAPIDeleteRawRequest:
...
class InvoiceAPIDeleteRawResponse:
    ...
    invoice_api_delete_raw_200_application_json_int32_integer: Optional[int] = dataclasses.field(default=None)
    r"""OK"""  
    invoice_api_delete_raw_200_text_json_int32_integer: Optional[int] = dataclasses.field(default=None)
    r"""OK"""  
