...
var DeviceProfiles = /** @class */ (function () {
    function DeviceProfiles(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Get the installed profiles associated with a device
     */
    DeviceProfiles.prototype.getNetworkSmDeviceDeviceProfiles = function (req, config) {
     ...
     * Get the profiles associated with a user
     */
    DeviceProfiles.prototype.getNetworkSmUserDeviceProfiles = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
