...
class CloudtasksAPIQueueUpdateRequest:
    query_params: CloudtasksAPIQueueUpdateQueryParams = dataclasses.field()
    security: CloudtasksAPIQueueUpdateSecurity = dataclasses.field()
    request: Optional[shared_httpbody.HTTPBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
