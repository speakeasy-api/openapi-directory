...
var InsightsV1CallSummaries = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=answered_by" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=call_sid" }),
        __metadata("design:type", String)
    ], InsightsV1CallSummaries.prototype, "callSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=call_state" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=carrier_edge" }),
        __metadata("design:type", Object)
    ], InsightsV1CallSummaries.prototype, "carrierEdge", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=client_edge" }),
        __metadata("design:type", Object)
    ], InsightsV1CallSummaries.prototype, "clientEdge", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=connect_duration" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=processing_state" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sdk_edge" }),
        __metadata("design:type", Object)
    ], InsightsV1CallSummaries.prototype, "sdkEdge", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sip_edge" }),
        __metadata("design:type", Object)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=trust" }),
        __metadata("design:type", Object)
