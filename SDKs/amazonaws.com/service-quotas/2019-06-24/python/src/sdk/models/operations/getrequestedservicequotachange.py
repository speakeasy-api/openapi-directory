...
class GetRequestedServiceQuotaChangeRequest:
    ...
    get_requested_service_quota_change_request: shared_getrequestedservicequotachangerequest.GetRequestedServiceQuotaChangeRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
