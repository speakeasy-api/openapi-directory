...
class GoogleCloudAssetV1p7beta1PartitionSpec:
    ...
    partition_key: Optional[GoogleCloudAssetV1p7beta1PartitionSpecPartitionKeyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('partitionKey'), 'exclude': lambda f: f is None }})
    r"""The partition key for BigQuery partitioned table."""  
