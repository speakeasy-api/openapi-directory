...
class HiuConsentRequestStatusConsentRequest:
    consent_artefacts: list[shared_consentartefactreference.ConsentArtefactReference] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('consentArtefacts') }})
