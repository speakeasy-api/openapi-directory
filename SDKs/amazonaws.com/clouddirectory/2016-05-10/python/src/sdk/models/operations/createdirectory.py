...
from ..shared import directoryalreadyexistsexception as shared_directoryalreadyexistsexception
...
class CreateDirectoryResponse:
    ...
    directory_already_exists_exception: Optional[shared_directoryalreadyexistsexception.DirectoryAlreadyExistsException] = dataclasses.field(default=None)
