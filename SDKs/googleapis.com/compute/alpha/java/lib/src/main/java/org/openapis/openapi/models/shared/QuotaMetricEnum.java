...
public enum QuotaMetricEnum {
    ...
    COMMITTED_NVIDIA_L4_GPUS("COMMITTED_NVIDIA_L4_GPUS"),
    ...
    IN_USE_MAINTENANCE_WINDOWS("IN_USE_MAINTENANCE_WINDOWS"),
    ...
    NET_LB_SECURITY_POLICY_RULE_ATTRIBUTES_PER_REGION("NET_LB_SECURITY_POLICY_RULE_ATTRIBUTES_PER_REGION"),
    ...
    PREEMPTIBLE_TPU_LITE_DEVICE_V4("PREEMPTIBLE_TPU_LITE_DEVICE_V4"),
    PREEMPTIBLE_TPU_PODSLICE_V4("PREEMPTIBLE_TPU_PODSLICE_V4"),
    PRIVATE_V6_ACCESS_SUBNETWORKS("PRIVATE_V6_ACCESS_SUBNETWORKS"),
    ...
    SECURITY_POLICY_ADVANCED_RULES_PER_REGION("SECURITY_POLICY_ADVANCED_RULES_PER_REGION"),
    ...
    TPU_LITE_DEVICE_V4("TPU_LITE_DEVICE_V4"),
    TPU_PODSLICE_V4("TPU_PODSLICE_V4"),
    URL_MAPS("URL_MAPS"),
