...
class ListBackendJobsRequestBody:
    ...
    r"""The maximum number of results that you want in the response."""  
...
class ListBackendJobsRequest:
    ...
    request_body: ListBackendJobsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
