...
exports.RequestUserGroupsResponse = exports.RequestUserGroupsRequest = void 0;
...
var RequestUserGroupsRequest = /** @class */ (function (_super) {
    ...
    ], RequestUserGroupsRequest.prototype, "xSdsAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], RequestUserGroupsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], RequestUserGroupsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], RequestUserGroupsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=user_id",
        }),
        __metadata("design:type", Number)
    ], RequestUserGroupsRequest.prototype, "userId", void 0);
    return RequestUserGroupsRequest;
}(utils_1.SpeakeasyBase));
exports.RequestUserGroupsRequest = RequestUserGroupsRequest;
var RequestUserGroupsResponse = /** @class */ (function (_super) {
    ...
    ], RequestUserGroupsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.RequestUserGroupsResponse = RequestUserGroupsResponse;
