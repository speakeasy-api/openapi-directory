...
class TagmanagerAccountsContainersWorkspacesTriggersListSecurity:
    ...
    option1: Optional[TagmanagerAccountsContainersWorkspacesTriggersListSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[TagmanagerAccountsContainersWorkspacesTriggersListSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
