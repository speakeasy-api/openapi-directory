...
class ListJourneysRequest:
    headers: ListJourneysHeaders = dataclasses.field()
    path_params: ListJourneysPathParams = dataclasses.field()
    query_params: ListJourneysQueryParams = dataclasses.field()
