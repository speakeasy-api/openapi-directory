...
class DeleteFieldLevelEncryptionProfile20180618Request:
    headers: DeleteFieldLevelEncryptionProfile20180618Headers = dataclasses.field()
    path_params: DeleteFieldLevelEncryptionProfile20180618PathParams = dataclasses.field()
