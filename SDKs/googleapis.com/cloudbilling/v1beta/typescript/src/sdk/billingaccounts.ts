...
export class BillingAccounts {
  ...
  cloudbillingBillingAccountsEstimateCostScenario(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.CloudbillingBillingAccountsEstimateCostScenarioRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.CloudbillingBillingAccountsEstimateCostScenarioSecurity(
          security
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CloudbillingBillingAccountsEstimateCostScenarioResponse =
        new operations.CloudbillingBillingAccountsEstimateCostScenarioResponse({
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.estimateCostScenarioForBillingAccountResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.EstimateCostScenarioForBillingAccountResponse
              );
          }
          break;
      }
