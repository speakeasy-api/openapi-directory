...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Ewcer(ctx, operations.EwcerRequestBody{
        CertificateParameters: &operations.EwcerRequestBodyCertificateParameters{
            UID: "123412341234",
            Refno: "2126201712RES001044",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
        ...
        Format: operations.EwcerRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.EwcerSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Ror1b(ctx, operations.Ror1bRequestBody{
        CertificateParameters: &operations.Ror1bRequestBodyCertificateParameters{
            UID: "123412341234",
            Refno: "2126201712RES001044",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
        ...
        Format: operations.Ror1bRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.Ror1bSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
