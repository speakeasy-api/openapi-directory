...
class Disapproval:
    ...
    reason: Optional[DisapprovalReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is None }})
    r"""The categorized reason for disapproval."""  
