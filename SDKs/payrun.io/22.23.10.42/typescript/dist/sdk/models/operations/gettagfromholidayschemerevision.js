...
exports.GetTagFromHolidaySchemeRevisionResponse = exports.GetTagFromHolidaySchemeRevisionRequest = void 0;
...
var GetTagFromHolidaySchemeRevisionRequest = /** @class */ (function (_super) {
    ...
    ], GetTagFromHolidaySchemeRevisionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagFromHolidaySchemeRevisionRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EffectiveDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetTagFromHolidaySchemeRevisionRequest.prototype, "effectiveDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagFromHolidaySchemeRevisionRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=HolidaySchemeId",
        }),
        __metadata("design:type", String)
    ], GetTagFromHolidaySchemeRevisionRequest.prototype, "holidaySchemeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetTagFromHolidaySchemeRevisionRequest.prototype, "tagId", void 0);
...
var GetTagFromHolidaySchemeRevisionResponse = /** @class */ (function (_super) {
    ...
    ], GetTagFromHolidaySchemeRevisionResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
