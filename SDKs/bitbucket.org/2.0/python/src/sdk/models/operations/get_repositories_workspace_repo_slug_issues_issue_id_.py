...
class GetRepositoriesWorkspaceRepoSlugIssuesIssueIDRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugIssuesIssueIDPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugIssuesIssueIDSecurity = dataclasses.field()
