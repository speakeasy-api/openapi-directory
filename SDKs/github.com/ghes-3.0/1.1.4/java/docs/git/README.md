...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateBlobRequest req = new GitCreateBlobRequest(                new GitCreateBlobRequestBody("facere") {{
                                encoding = "numquam";
                            }};, "doloribus", "suscipit");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateCommitRequest req = new GitCreateCommitRequest(                new GitCreateCommitRequestBody("reiciendis", "quidem") {{
                                author = new GitCreateCommitRequestBodyAuthor("saepe", "necessitatibus") {{
                                    date = OffsetDateTime.parse("2022-11-17T19:30:54.837Z");
                                }};;
                                committer = new GitCreateCommitRequestBodyCommitter() {{
                                    date = OffsetDateTime.parse("2022-04-11T12:10:44.801Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateRefRequest req = new GitCreateRefRequest(                new GitCreateRefRequestBody("similique", "tempora") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateTagRequest req = new GitCreateTagRequest(                new GitCreateTagRequestBody("voluptas", "voluptas", "minima", GitCreateTagRequestBodyTypeEnum.BLOB) {{
                                tagger = new GitCreateTagRequestBodyTagger("dolorum", "adipisci") {{
                                    date = OffsetDateTime.parse("2022-06-26T19:42:01.136Z");
                                }};;
                            }};, "blanditiis", "in");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitDeleteRefRequest req = new GitDeleteRefRequest("totam", "hic", "exercitationem");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetBlobRequest req = new GitGetBlobRequest("nobis", "sit", "rerum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetCommitRequest req = new GitGetCommitRequest("sed", "reiciendis", "explicabo");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetRefRequest req = new GitGetRefRequest("asperiores", "facilis", "voluptate");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetTagRequest req = new GitGetTagRequest("expedita", "ab", "iste");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetTreeRequest req = new GitGetTreeRequest("dolore", "laborum", "sed") {{
                recursive = "in";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitListMatchingRefsRequest req = new GitListMatchingRefsRequest("commodi", "quidem", "explicabo") {{
                page = 378326L;
                perPage = 604118L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitUpdateRefRequest req = new GitUpdateRefRequest(                new GitUpdateRefRequestBody("architecto") {{
                                force = false;
                            }};, "suscipit", "sapiente", "debitis");            
