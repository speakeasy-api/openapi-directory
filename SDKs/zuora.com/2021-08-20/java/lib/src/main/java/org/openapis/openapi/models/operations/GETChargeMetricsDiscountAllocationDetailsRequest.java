...
public class GETChargeMetricsDiscountAllocationDetailsRequest {
    ...
    public GETChargeMetricsDiscountAllocationDetailsRequest withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public GETChargeMetricsDiscountAllocationDetailsRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETChargeMetricsDiscountAllocationDetailsRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETChargeMetricsDiscountAllocationDetailsRequest withFromTimestamp(OffsetDateTime fromTimestamp) {
    ...
    public GETChargeMetricsDiscountAllocationDetailsRequest withToTimestamp(OffsetDateTime toTimestamp) {
