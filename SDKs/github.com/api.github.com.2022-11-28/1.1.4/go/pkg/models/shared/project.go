...
func (e ProjectOrganizationPermissionEnum) ToPointer() *ProjectOrganizationPermissionEnum {
	return &e
}
...
func (e *ProjectOrganizationPermissionEnum) UnmarshalJSON(data []byte) error {
	...
	case "admin":
		fallthrough
	case "none":
		*e = ProjectOrganizationPermissionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ProjectOrganizationPermissionEnum: %v", v)
	}
}
