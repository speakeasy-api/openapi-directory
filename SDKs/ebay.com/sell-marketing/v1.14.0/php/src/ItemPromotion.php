...
class ItemPromotion 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Shared\ItemPromotion $request
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateItemPromotionSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\CreateItemPromotionResponse
     */
	public function createItemPromotion(
        \OpenAPI\OpenAPI\Models\Shared\ItemPromotion $request,
        \OpenAPI\OpenAPI\Models\Operations\CreateItemPromotionSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateItemPromotionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/item_promotion');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreateItemPromotionResponse();
        ...
        if ($httpResponse->getStatusCode() === 201) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->baseResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\BaseResponse', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteItemPromotionRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteItemPromotionSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\DeleteItemPromotionResponse
     */
	public function deleteItemPromotion(
        \OpenAPI\OpenAPI\Models\Operations\DeleteItemPromotionRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\DeleteItemPromotionSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteItemPromotionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/item_promotion/{promotion_id}', \OpenAPI\OpenAPI\Models\Operations\DeleteItemPromotionRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeleteItemPromotionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetItemPromotionRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\GetItemPromotionSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\GetItemPromotionResponse
     */
	public function getItemPromotion(
        \OpenAPI\OpenAPI\Models\Operations\GetItemPromotionRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\GetItemPromotionSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\GetItemPromotionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/item_promotion/{promotion_id}', \OpenAPI\OpenAPI\Models\Operations\GetItemPromotionRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetItemPromotionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->itemPromotionResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ItemPromotionResponse', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateItemPromotionRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateItemPromotionSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateItemPromotionResponse
     */
	public function updateItemPromotion(
        \OpenAPI\OpenAPI\Models\Operations\UpdateItemPromotionRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\UpdateItemPromotionSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateItemPromotionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/item_promotion/{promotion_id}', \OpenAPI\OpenAPI\Models\Operations\UpdateItemPromotionRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "itemPromotion", "json");
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateItemPromotionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
