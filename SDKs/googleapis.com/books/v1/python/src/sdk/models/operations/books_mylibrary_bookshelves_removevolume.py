...
class BooksMylibraryBookshelvesRemoveVolumeQueryParams:
    ...
    reason: Optional[BooksMylibraryBookshelvesRemoveVolumeReasonEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'reason', 'style': 'form', 'explode': True }})
...
class BooksMylibraryBookshelvesRemoveVolumeRequest:
    path_params: BooksMylibraryBookshelvesRemoveVolumePathParams = dataclasses.field()
    query_params: BooksMylibraryBookshelvesRemoveVolumeQueryParams = dataclasses.field()
    security: BooksMylibraryBookshelvesRemoveVolumeSecurity = dataclasses.field()
