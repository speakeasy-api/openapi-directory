...
export class GoogleCloudDatacatalogV1SearchCatalogRequestScope extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "includeGcpPublicDatasets" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "includePublicTagTemplates" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "restrictedLocations" })
