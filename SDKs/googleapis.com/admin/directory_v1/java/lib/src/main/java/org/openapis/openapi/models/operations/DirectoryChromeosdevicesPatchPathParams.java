...
public class DirectoryChromeosdevicesPatchPathParams {
    /**
    ...
    public DirectoryChromeosdevicesPatchPathParams withCustomerId(String customerId) {
    ...
    public DirectoryChromeosdevicesPatchPathParams withDeviceId(String deviceId) {
