...
from ..shared import listdelegatedadminaccountsresponse as shared_listdelegatedadminaccountsresponse
...
class ListDelegatedAdminAccountsRequestBody:
...
class ListDelegatedAdminAccountsRequest:
    ...
    request_body: ListDelegatedAdminAccountsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListDelegatedAdminAccountsResponse:
    ...
    list_delegated_admin_accounts_response: Optional[shared_listdelegatedadminaccountsresponse.ListDelegatedAdminAccountsResponse] = dataclasses.field(default=None)
    r"""Success"""  
