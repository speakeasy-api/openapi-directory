...
func (e CancelCommandXAmzTargetEnum) ToPointer() *CancelCommandXAmzTargetEnum {
	return &e
}
...
func (e *CancelCommandXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonSSM.CancelCommand":
		*e = CancelCommandXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CancelCommandXAmzTargetEnum: %v", v)
	}
}
