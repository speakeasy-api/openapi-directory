...
var Fulfillment = /** @class */ (function () {
    function Fulfillment(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    Fulfillment.prototype.getAddressByPostalCode = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAddressByPostalCodeRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/checkout/pub/postal-code/{countryCode}/{postalCode}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetAddressByPostalCodeResponse({
  ...
  The pickup points returned are not necessarily all active ones. Make sure to validate the information consumed by integrations.
     */
    Fulfillment.prototype.listPickupPpointsByLocation = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListPickupPpointsByLocationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/checkout/pub/pickup-points";
        var client = this._securityClient || this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req)), config === null || config === void 0 ? void 0 : config.headers);
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ListPickupPpointsByLocationResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
