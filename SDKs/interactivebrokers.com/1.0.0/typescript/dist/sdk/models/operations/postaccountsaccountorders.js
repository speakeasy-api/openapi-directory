...
exports.PostAccountsAccountOrdersResponse = exports.PostAccountsAccountOrdersRequest = exports.PostAccountsAccountOrdersRequestBody = exports.PostAccountsAccountOrdersPathParams = void 0;
...
exports.PostAccountsAccountOrdersPathParams = PostAccountsAccountOrdersPathParams;
var PostAccountsAccountOrdersRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=GermanHftAlgo" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Mifid2Algo" }),
        __metadata("design:type", String)
    ], PostAccountsAccountOrdersRequestBody.prototype, "mifid2Algo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Mifid2DecisionMaker" }),
        __metadata("design:type", String)
    ], PostAccountsAccountOrdersRequestBody.prototype, "mifid2DecisionMaker", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Mifid2ExecutionAlgo" }),
        __metadata("design:type", String)
    ], PostAccountsAccountOrdersRequestBody.prototype, "mifid2ExecutionAlgo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Mifid2ExecutionTrader" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=OrderRestrictions" }),
        __metadata("design:type", Number)
    ], PostAccountsAccountOrdersRequestBody.prototype, "orderRestrictions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Outside RTH" }),
        __metadata("design:type", Number)
...
exports.PostAccountsAccountOrdersRequestBody = PostAccountsAccountOrdersRequestBody;
...
exports.PostAccountsAccountOrdersRequest = PostAccountsAccountOrdersRequest;
var PostAccountsAccountOrdersResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.OrderState }),
        __metadata("design:type", Array)
    ], PostAccountsAccountOrdersResponse.prototype, "orderStates", void 0);
    return PostAccountsAccountOrdersResponse;
}(utils_1.SpeakeasyBase));
exports.PostAccountsAccountOrdersResponse = PostAccountsAccountOrdersResponse;
