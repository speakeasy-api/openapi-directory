...
type DestinyResponsesDestinyProfileResponseCharacterCraftables struct {
	Data map[string]DestinyComponentsCraftablesDestinyCraftablesComponent
	// If true, this component is disabled.
	Disabled *bool
	Privacy  *int
}
...
type DestinyResponsesDestinyProfileResponseCharacterLoadouts struct {
	Data map[string]DestinyComponentsLoadoutsDestinyLoadoutsComponent
	// If true, this component is disabled.
	Disabled *bool
	Privacy  *int
}
...
type DestinyResponsesDestinyProfileResponseProfileCommendations struct {
...
type DestinyResponsesDestinyProfileResponse struct {
	...
	ResponseMintedTimestamp *time.Time
	...
	SecondaryComponentsMintedTimestamp *time.Time
