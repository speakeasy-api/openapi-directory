 ...
 */
public enum AddInternalNumbersApplicationJSONInternalNumbersLanguagesEnum {
    EN_GB("en-GB"),
    EN_US("en-US"),
    DEDE("de-DE");
    ...
    private AddInternalNumbersApplicationJSONInternalNumbersLanguagesEnum(String value) {
        this.value = value;
    }
}
