...
const (
	ListTagsForResourceXAmzTargetEnumPinpointSmsVoiceV2ListTagsForResource ListTagsForResourceXAmzTargetEnum = "PinpointSMSVoiceV2.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "PinpointSMSVoiceV2.ListTagsForResource":
