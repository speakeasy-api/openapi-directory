...
class GetImagesRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetImagesIncludeLicensedContentEnum $includeLicensedContent
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=includeLicensedContent')]
    public ?GetImagesIncludeLicensedContentEnum $includeLicensedContent = null;
