...
class GetCollectionTagsResponse:
    r"""List Tags"""
    
    data: list[shared_collectiontag.CollectionTag] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
