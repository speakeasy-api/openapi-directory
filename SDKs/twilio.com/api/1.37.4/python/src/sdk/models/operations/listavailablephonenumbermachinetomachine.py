...
class ListAvailablePhoneNumberMachineToMachinePathParams:
...
@dataclasses.dataclass
class ListAvailablePhoneNumberMachineToMachineQueryParams:
...
class ListAvailablePhoneNumberMachineToMachineListAvailablePhoneNumberMachineToMachineResponse:
    available_phone_numbers: Optional[list[shared_api_v2010_account_available_phone_number_country_available_phone_number_machine_to_machine.APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('available_phone_numbers') }})
...
class ListAvailablePhoneNumberMachineToMachineRequest:
    path_params: ListAvailablePhoneNumberMachineToMachinePathParams = dataclasses.field()
    query_params: ListAvailablePhoneNumberMachineToMachineQueryParams = dataclasses.field()
    security: ListAvailablePhoneNumberMachineToMachineSecurity = dataclasses.field()
