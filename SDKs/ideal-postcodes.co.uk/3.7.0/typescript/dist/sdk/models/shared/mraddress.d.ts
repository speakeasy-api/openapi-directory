...
export declare enum MrAddressCountryEnum {
    England = "England",
    Scotland = "Scotland",
    Wales = "Wales",
...
export declare enum MrAddressCountryIsoEnum {
    Gbr = "GBR",
    Imn = "IMN",
    Jey = "JEY",
    Ggy = "GGY"
}
export declare enum MrAddressCountryIso2Enum {
    Gb = "GB",
    Im = "IM",
    Je = "JE",
    Gg = "GG"
}
export declare enum MrAddressDatasetEnum {
    Mr = "mr"
}
export declare enum MrAddressLanguageEnum {
    En = "en"
}
/**
 ...
 *
 */
export declare class MrAddress extends SpeakeasyBase {
    /**
    ...
    country: MrAddressCountryEnum;
    countryIso: MrAddressCountryIsoEnum;
    countryIso2: MrAddressCountryIso2Enum;
    /**
     ...
     */
    id: string;
    language: MrAddressLanguageEnum;
    /**
