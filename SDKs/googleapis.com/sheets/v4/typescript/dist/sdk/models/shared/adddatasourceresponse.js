...
exports.AddDataSourceResponse = void 0;
...
**/
var AddDataSourceResponse = /** @class */ (function (_super) {
    __extends(AddDataSourceResponse, _super);
    function AddDataSourceResponse() {
    ...
    ], AddDataSourceResponse.prototype, "dataExecutionStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dataSource" }),
        __metadata("design:type", datasource_1.DataSource)
    ], AddDataSourceResponse.prototype, "dataSource", void 0);
