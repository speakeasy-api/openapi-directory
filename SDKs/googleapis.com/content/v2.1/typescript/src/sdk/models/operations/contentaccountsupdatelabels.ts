...
export class ContentAccountsUpdatelabelsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentAccountsUpdatelabelsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentAccountsUpdatelabelsResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
