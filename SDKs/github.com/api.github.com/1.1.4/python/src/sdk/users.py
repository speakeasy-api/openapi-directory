...
class Users:
    ...
    def users_block(self, request: operations.UsersBlockRequest) -> operations.UsersBlockResponse:
        ...
        url = utils.generate_url(base_url, "/user/blocks/{username}", request.path_params)
        ...
        res = operations.UsersBlockResponse(status_code=r.status_code, content_type=content_type)
    ...
    def users_check_blocked(self, request: operations.UsersCheckBlockedRequest) -> operations.UsersCheckBlockedResponse:
        ...
        res = operations.UsersCheckBlockedResponse(status_code=r.status_code, content_type=content_type)
    ...
    def users_list_blocked_by_authenticated(self) -> operations.UsersListBlockedByAuthenticatedResponse:
        ...
        res = operations.UsersListBlockedByAuthenticatedResponse(status_code=r.status_code, content_type=content_type)
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.UsersListBlockedByAuthenticated415ApplicationJSON])
                res.users_list_blocked_by_authenticated_415_application_json_object = out
    ...
    def users_set_primary_email_visibility_for_authenticated(self, request: operations.UsersSetPrimaryEmailVisibilityForAuthenticatedRequest) -> operations.UsersSetPrimaryEmailVisibilityForAuthenticatedResponse:
        ...
        res = operations.UsersSetPrimaryEmailVisibilityForAuthenticatedResponse(status_code=r.status_code, content_type=content_type)
    ...
    def users_unblock(self, request: operations.UsersUnblockRequest) -> operations.UsersUnblockResponse:
        ...
        res = operations.UsersUnblockResponse(status_code=r.status_code, content_type=content_type)
