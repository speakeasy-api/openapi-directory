...
class AppengineAppsFirewallIngressRulesPatchRequest:
    ...
    r"""Part of `name`. Name of the Firewall resource to update. Example: apps/myapp/firewall/ingressRules/100."""  
    ...
    firewall_rule: Optional[shared_firewallrule.FirewallRule] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
