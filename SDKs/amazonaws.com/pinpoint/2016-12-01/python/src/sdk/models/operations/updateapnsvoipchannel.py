...
class UpdateAPNSVoipChannelRequestBodyAPNSVoipChannelRequest:
    r"""Specifies the status and settings of the APNs (Apple Push Notification service) VoIP channel for an application."""
...
class UpdateApnsVoipChannelRequestBody:
    ...
    apns_voip_channel_request: UpdateAPNSVoipChannelRequestBodyAPNSVoipChannelRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('APNSVoipChannelRequest') }})
    r"""Specifies the status and settings of the APNs (Apple Push Notification service) VoIP channel for an application."""  
...
class UpdateApnsVoipChannelRequest:
    ...
    request_body: UpdateApnsVoipChannelRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
