...
public class ThreeSendAdditionalDataRequest {
    ...
    public ThreeSendAdditionalDataRequest(@JsonProperty("Accept") String accept, @JsonProperty("Content-Type") String contentType, @JsonProperty("RequestBody") Object[][] requestBody, @JsonProperty("X-PROVIDER-API-AppKey") String xPROVIDERAPIAppKey, @JsonProperty("X-PROVIDER-API-AppToken") String xPROVIDERAPIAppToken, @JsonProperty("transactionId") String transactionId) {
        this.accept = accept;
        this.contentType = contentType;
        this.requestBody = requestBody;
        this.xPROVIDERAPIAppKey = xPROVIDERAPIAppKey;
