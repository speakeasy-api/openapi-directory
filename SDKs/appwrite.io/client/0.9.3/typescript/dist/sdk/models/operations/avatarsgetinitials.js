...
exports.AvatarsGetInitialsResponse = exports.AvatarsGetInitialsRequest = exports.AvatarsGetInitialsSecurity = void 0;
...
var AvatarsGetInitialsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AvatarsGetInitialsRequest.prototype, "background", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=color" }),
        __metadata("design:type", String)
    ], AvatarsGetInitialsRequest.prototype, "color", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=height",
        }),
        __metadata("design:type", Number)
    ], AvatarsGetInitialsRequest.prototype, "height", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], AvatarsGetInitialsRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=width" }),
        __metadata("design:type", Number)
    ], AvatarsGetInitialsRequest.prototype, "width", void 0);
...
var AvatarsGetInitialsResponse = /** @class */ (function (_super) {
    ...
    ], AvatarsGetInitialsResponse.prototype, "rawResponse", void 0);
