...
from ..shared import scopescontext_enum as shared_scopescontext_enum
...
class ItemApplicationScopesUpdateRequest:
    ...
    context: shared_scopescontext_enum.ScopesContextEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('context') }})
