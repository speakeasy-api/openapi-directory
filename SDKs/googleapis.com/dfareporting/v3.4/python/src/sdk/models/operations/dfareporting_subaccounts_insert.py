...
class DfareportingSubaccountsInsertSecurity:
...
@dataclasses.dataclass
class DfareportingSubaccountsInsertRequest:
    ...
    subaccount: Optional[shared_subaccount.Subaccount] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class DfareportingSubaccountsInsertResponse:
