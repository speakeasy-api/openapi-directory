...
from ..shared import security as shared_security
from ..shared import googleadshomeserviceslocalservicesv1searchaccountreportsresponse as shared_googleadshomeserviceslocalservicesv1searchaccountreportsresponse
...
class LocalservicesAccountReportsSearchRequest:
    query_params: LocalservicesAccountReportsSearchQueryParams = dataclasses.field()
    security: LocalservicesAccountReportsSearchSecurity = dataclasses.field()
...
class LocalservicesAccountReportsSearchResponse:
    ...
    google_ads_homeservices_localservices_v1_search_account_reports_response: Optional[shared_googleadshomeserviceslocalservicesv1searchaccountreportsresponse.GoogleAdsHomeservicesLocalservicesV1SearchAccountReportsResponse] = dataclasses.field(default=None)
