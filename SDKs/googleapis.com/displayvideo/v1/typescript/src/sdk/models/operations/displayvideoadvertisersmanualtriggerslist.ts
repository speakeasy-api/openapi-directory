...
export class DisplayvideoAdvertisersManualTriggersListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersManualTriggersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersManualTriggersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
