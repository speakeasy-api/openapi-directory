...
export class LocationsGetV2LocationsLocationIdGetPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=location_id" })
  locationId: number;
}


export class LocationsGetV2LocationsLocationIdGetQueryParams extends SpeakeasyBase {
...
export class LocationsGetV2LocationsLocationIdGetRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class LocationsGetV2LocationsLocationIdGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
