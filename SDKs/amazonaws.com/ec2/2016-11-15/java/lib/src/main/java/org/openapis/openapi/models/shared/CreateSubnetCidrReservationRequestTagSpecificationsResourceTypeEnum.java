 ...
 */
public enum CreateSubnetCidrReservationRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateSubnetCidrReservationRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
