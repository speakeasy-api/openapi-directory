...
class PaymentMethodSnapshots:
    ...
    def object_get_payment_method_snapshot(self, request: operations.ObjectGETPaymentMethodSnapshotRequest) -> operations.ObjectGETPaymentMethodSnapshotResponse:
        ...
        * `UpdatedDate`
        ...
        url = utils.generate_url(operations.ObjectGETPaymentMethodSnapshotRequest, base_url, '/v1/object/payment-method-snapshot/{id}', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.ObjectGETPaymentMethodSnapshotRequest, request)
        ...
        res = operations.ObjectGETPaymentMethodSnapshotResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/json; charset=utf-8'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ProxyGetPaymentMethodSnapshot])
