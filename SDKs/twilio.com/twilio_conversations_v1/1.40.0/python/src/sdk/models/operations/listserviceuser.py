...
class ListServiceUserRequest:
    ...
    r"""The SID of the [Conversation Service](https://www.twilio.com/docs/conversations/api/service-resource) to read the User resources from."""  
...
class ListServiceUserListServiceUserResponse:
    ...
    meta: Optional[ListServiceUserListServiceUserResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    users: Optional[list[shared_conversations_v1_service_service_user.ConversationsV1ServiceServiceUser]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('users'), 'exclude': lambda f: f is None }})  
