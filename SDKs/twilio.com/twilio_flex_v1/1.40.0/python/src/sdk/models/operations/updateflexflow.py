...
class UpdateFlexFlowRequest:
    ...
    r"""The SID of the Flex Flow resource to update."""  
    request_body: Optional[UpdateFlexFlowUpdateFlexFlowRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
