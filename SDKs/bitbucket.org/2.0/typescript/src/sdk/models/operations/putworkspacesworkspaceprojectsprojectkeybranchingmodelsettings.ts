...
export class PutWorkspacesWorkspaceProjectsProjectKeyBranchingModelSettingsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PutWorkspacesWorkspaceProjectsProjectKeyBranchingModelSettingsRequest extends SpeakeasyBase {
  /**
...
export class PutWorkspacesWorkspaceProjectsProjectKeyBranchingModelSettingsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
