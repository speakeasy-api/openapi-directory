...
public class GetUsersIdTopAnswerTagsRequest {
    ...
    public GetUsersIdTopAnswerTagsRequest withCallback(String callback) {
    ...
    public GetUsersIdTopAnswerTagsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdTopAnswerTagsRequest withId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public GetUsersIdTopAnswerTagsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdTopAnswerTagsRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdTopAnswerTagsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    public GetUsersIdTopAnswerTagsRequest(@JsonProperty("id") Long id, @JsonProperty("site") String site) {
        this.id = id;
        this.site = site;
  }
}
