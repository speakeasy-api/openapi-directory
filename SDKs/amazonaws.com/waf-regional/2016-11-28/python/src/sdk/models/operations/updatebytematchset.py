...
class UpdateByteMatchSetRequest:
    ...
    update_byte_match_set_request: shared_updatebytematchsetrequest.UpdateByteMatchSetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
