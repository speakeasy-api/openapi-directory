...
public class BulkUpdateAdsBidByInventoryReferenceRequest {
    ...
    public BulkUpdateAdsBidByInventoryReferenceRequest(@JsonProperty("BulkCreateAdsByInventoryReferenceRequest") org.openapis.openapi.models.shared.BulkCreateAdsByInventoryReferenceRequest bulkCreateAdsByInventoryReferenceRequest, @JsonProperty("campaign_id") String campaignId) {
        this.bulkCreateAdsByInventoryReferenceRequest = bulkCreateAdsByInventoryReferenceRequest;
        this.campaignId = campaignId;
  }
}
