...
class UpdateNetworkSmTargetGroupRequest:
    path_params: UpdateNetworkSmTargetGroupPathParams = dataclasses.field()
    request: Optional[UpdateNetworkSmTargetGroupRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
