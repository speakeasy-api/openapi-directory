...
export class TimeMachineTimeMachineGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 * An enumeration.
 */
export enum TimeMachineTimeMachineGetUnitsUnitsEnum {
  Auto = "auto",
  Metric = "metric",
  Us = "us",
  Uk = "uk",
...
export class TimeMachineTimeMachineGetRequest extends SpeakeasyBase {
  /**
...
export class TimeMachineTimeMachineGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
