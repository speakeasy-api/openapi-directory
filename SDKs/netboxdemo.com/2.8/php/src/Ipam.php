...
class Ipam 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\IpamPrefixesAvailableIpsCreateResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 201) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->availableIPS = $serializer->deserialize((string)$httpResponse->getBody(), 'array<OpenAPI\OpenAPI\Models\Shared\AvailableIP>', 'json');
            }
        }
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\IpamPrefixesAvailablePrefixesCreateResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 201) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->availablePrefixes = $serializer->deserialize((string)$httpResponse->getBody(), 'array<OpenAPI\OpenAPI\Models\Shared\AvailablePrefix>', 'json');
            }
        }
