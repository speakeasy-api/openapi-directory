...
type ProxyCreateOrModifyProductRatePlanChargeChargeModelConfiguration struct {
	// An array of Charge Model Configuration Key-Value pairs.
	//
	ConfigurationItem []ProxyCreateOrModifyProductRatePlanChargeChargeModelConfigurationItem `json:"ConfigurationItem,omitempty"`
}
