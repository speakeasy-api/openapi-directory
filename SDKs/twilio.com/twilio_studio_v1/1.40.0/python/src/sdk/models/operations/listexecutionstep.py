...
class ListExecutionStepListExecutionStepResponse:
    ...
    steps: Optional[list[shared_studio_v1_flow_execution_execution_step.StudioV1FlowExecutionExecutionStep]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('steps'), 'exclude': lambda f: f is None }})  
