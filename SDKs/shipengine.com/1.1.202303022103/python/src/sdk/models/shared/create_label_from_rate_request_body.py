...
class CreateLabelFromRateRequestBodyDisplaySchemeEnum(str, Enum):
    r"""The display format that the label should be shown in."""
    LABEL = 'label'
    QR_CODE = 'qr_code'
    LABEL_AND_QR_CODE = 'label_and_qr_code'

class CreateLabelFromRateRequestBodyLabelFormatEnum(str, Enum):
...
class CreateLabelFromRateRequestBodyLabelLayoutEnum(str, Enum):
...
class CreateLabelFromRateRequestBody:
    r"""A purchase label without shipment resource"""
    
    display_scheme: Optional[CreateLabelFromRateRequestBodyDisplaySchemeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('display_scheme'), 'exclude': lambda f: f is None }})
    r"""The display format that the label should be shown in."""  
    ...
    label_format: Optional[CreateLabelFromRateRequestBodyLabelFormatEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_format'), 'exclude': lambda f: f is None }})  
    label_layout: Optional[CreateLabelFromRateRequestBodyLabelLayoutEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_layout'), 'exclude': lambda f: f is None }})  
