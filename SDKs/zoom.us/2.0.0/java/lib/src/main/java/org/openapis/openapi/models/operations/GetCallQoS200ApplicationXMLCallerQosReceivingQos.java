...
public class GetCallQoS200ApplicationXMLCallerQosReceivingQos {
    /**
    ...
    public GetCallQoS200ApplicationXMLCallerQosReceivingQos withAvgLoss(String avgLoss) {
    ...
    public GetCallQoS200ApplicationXMLCallerQosReceivingQos withBitrate(String bitrate) {
    ...
    public GetCallQoS200ApplicationXMLCallerQosReceivingQos withJitter(String jitter) {
        this.jitter = jitter;
        return this;
    }
    ...
    public GetCallQoS200ApplicationXMLCallerQosReceivingQos withMaxLoss(String maxLoss) {
    ...
    public String mos;
    public GetCallQoS200ApplicationXMLCallerQosReceivingQos withMos(String mos) {
        this.mos = mos;
        return this;
    }
    ...
    public GetCallQoS200ApplicationXMLCallerQosReceivingQos withNetworkDelay(String networkDelay) {
