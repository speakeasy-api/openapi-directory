...
public class GetUsersIdsSuggestedEditsRequest {
    /**
    ...
    public GetUsersIdsSuggestedEditsRequest withCallback(String callback) {
    ...
    public GetUsersIdsSuggestedEditsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdsSuggestedEditsRequest withFromdate(Long fromdate) {
    ...
    public GetUsersIdsSuggestedEditsRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetUsersIdsSuggestedEditsRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetUsersIdsSuggestedEditsRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetUsersIdsSuggestedEditsRequest withOrder(GetUsersIdsSuggestedEditsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetUsersIdsSuggestedEditsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdsSuggestedEditsRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdsSuggestedEditsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetUsersIdsSuggestedEditsRequest withSort(GetUsersIdsSuggestedEditsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetUsersIdsSuggestedEditsRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetUsersIdsSuggestedEditsRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
