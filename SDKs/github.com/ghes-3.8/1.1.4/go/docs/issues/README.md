...
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#add-assignees-to-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#add-labels-to-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#check-if-a-user-can-be-assigned>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#check-if-a-user-can-be-assigned-to-a-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#create-an-issue>
...
func main() {
    ...
    res, err := s.Issues.IssuesCreate(ctx, operations.IssuesCreateRequest{
        RequestBody: operations.IssuesCreateRequestBody{
            Assignee: sdk.String("aperiam"),
            Assignees: []string{
                "minima",
                "in",
            },
            Body: sdk.String("ducimus"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#create-an-issue-comment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#create-a-label>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#create-a-milestone>
...
func main() {
    ...
    res, err := s.Issues.IssuesCreateMilestone(ctx, operations.IssuesCreateMilestoneRequest{
        RequestBody: operations.IssuesCreateMilestoneRequestBody{
            ...
            DueOn: types.MustTimeFromString("2022-10-15T19:39:20.819Z"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#delete-an-issue-comment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#delete-a-label>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#delete-a-milestone>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#get-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#get-an-issue-comment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#get-an-issue-event>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#get-a-label>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#get-a-milestone>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-issues-assigned-to-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-assignees>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-issue-comments>
...
func main() {
    ...
    res, err := s.Issues.IssuesListComments(ctx, operations.IssuesListCommentsRequest{
        IssueNumber: 38557,
        Owner: "delectus",
        Page: sdk.Int64(773110),
        PerPage: sdk.Int64(741238),
        Repo: "ipsum",
        Since: types.MustTimeFromString("2022-02-05T08:24:32.703Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-issue-comments-for-a-repository>
...
func main() {
    ...
    res, err := s.Issues.IssuesListCommentsForRepo(ctx, operations.IssuesListCommentsForRepoRequest{
        ...
        Owner: "doloremque",
        Page: sdk.Int64(339756),
        PerPage: sdk.Int64(333072),
        Repo: "libero",
        Since: types.MustTimeFromString("2022-06-01T14:58:08.177Z"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-issue-events>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-issue-events-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-timeline-events-for-an-issue>
...
func main() {
    ...
    res, err := s.Issues.IssuesListEventsForTimeline(ctx, operations.IssuesListEventsForTimelineRequest{
        IssueNumber: 813880,
        Owner: "laudantium",
        Page: sdk.Int64(140384),
        PerPage: sdk.Int64(863477),
        Repo: "amet",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-user-account-issues-assigned-to-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Issues.IssuesListForAuthenticatedUser(ctx, operations.IssuesListForAuthenticatedUserRequest{
        ...
        Labels: sdk.String("velit"),
        Page: sdk.Int64(705710),
        PerPage: sdk.Int64(731065),
        Since: types.MustTimeFromString("2022-01-09T04:56:37.970Z"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-organization-issues-assigned-to-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Issues.IssuesListForOrg(ctx, operations.IssuesListForOrgRequest{
        ...
        Labels: sdk.String("quis"),
        Org: "nisi",
        Page: sdk.Int64(727771),
        PerPage: sdk.Int64(794507),
        Since: types.MustTimeFromString("2020-11-18T20:43:00.067Z"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-repository-issues>
...
func main() {
    ...
    res, err := s.Issues.IssuesListForRepo(ctx, operations.IssuesListForRepoRequest{
        Assignee: sdk.String("voluptatibus"),
        Creator: sdk.String("voluptatibus"),
        Direction: shared.DirectionEnumAsc.ToPointer(),
        Labels: sdk.String("debitis"),
        Mentioned: sdk.String("labore"),
        Milestone: sdk.String("rerum"),
        Owner: "eos",
        Page: sdk.Int64(440777),
        PerPage: sdk.Int64(345506),
        Repo: "neque",
        Since: types.MustTimeFromString("2022-05-03T06:54:32.911Z"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-labels-for-issues-in-a-milestone>
...
func main() {
    ...
    res, err := s.Issues.IssuesListLabelsForMilestone(ctx, operations.IssuesListLabelsForMilestoneRequest{
        MilestoneNumber: 853606,
        Owner: "unde",
        Page: sdk.Int64(889448),
        PerPage: sdk.Int64(495617),
        Repo: "dolor",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-labels-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-labels-for-an-issue>
...
func main() {
    ...
    res, err := s.Issues.IssuesListLabelsOnIssue(ctx, operations.IssuesListLabelsOnIssueRequest{
        IssueNumber: 491591,
        Owner: "esse",
        Page: sdk.Int64(854115),
        PerPage: sdk.Int64(322333),
        Repo: "aspernatur",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-milestones>
...
func main() {
    ...
    res, err := s.Issues.IssuesListMilestones(ctx, operations.IssuesListMilestonesRequest{
        ...
        Owner: "delectus",
        Page: sdk.Int64(482584),
        PerPage: sdk.Int64(491201),
        Repo: "libero",
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#lock-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#remove-all-labels-from-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#remove-assignees-from-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#remove-a-label-from-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#set-labels-for-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#unlock-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#update-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#update-an-issue-comment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#update-a-label>
...
func main() {
    ...
    res, err := s.Issues.IssuesUpdateLabel(ctx, operations.IssuesUpdateLabelRequest{
        RequestBody: &operations.IssuesUpdateLabelRequestBody{
            Color: sdk.String("voluptatem"),
            Description: sdk.String("ad"),
            NewName: sdk.String("quae"),
        },
        Name: "Desiree Lakin",
        Owner: "amet",
        Repo: "quasi",
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/issues#update-a-milestone>
...
func main() {
    ...
    res, err := s.Issues.IssuesUpdateMilestone(ctx, operations.IssuesUpdateMilestoneRequest{
        RequestBody: &operations.IssuesUpdateMilestoneRequestBody{
            ...
            DueOn: types.MustTimeFromString("2022-12-02T06:45:21.747Z"),
            State: operations.IssuesUpdateMilestoneRequestBodyStateEnumClosed.ToPointer(),
            Title: sdk.String("Ms."),
        },
        MilestoneNumber: 228646,
        Owner: "provident",
        Repo: "dolorum",
    })
    if err != nil {
