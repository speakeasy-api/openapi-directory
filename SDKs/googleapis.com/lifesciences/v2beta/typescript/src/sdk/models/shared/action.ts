...
export class Action extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "blockExternalNetwork" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "disableImagePrefetch" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "disableStandardErrorCapture" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "publishExposedPorts" })
