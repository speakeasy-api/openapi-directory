...
class DisassociateSubnetCidrBlockResultIpv6CidrBlockAssociationIpv6CidrBlockStateStateEnum(str, Enum):
...
class DisassociateSubnetCidrBlockResultIpv6CidrBlockAssociationIpv6CidrBlockState:
    ...
    state: Optional[DisassociateSubnetCidrBlockResultIpv6CidrBlockAssociationIpv6CidrBlockStateStateEnum] = dataclasses.field(default=None)  
