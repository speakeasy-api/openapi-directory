...
public class GetBranches429ErrorObject {
    ...
    public GetBranches429ErrorObject(@JsonProperty("description") GetBranches429ErrorObjectDescriptionEnum description, @JsonProperty("status") GetBranches429ErrorObjectStatusEnum status, @JsonProperty("title") GetBranches429ErrorObjectTitleEnum title) {
        this.description = description;
        this.status = status;
        this.title = title;
  }
