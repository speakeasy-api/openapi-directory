...
from ..shared import ecommercecustomersfilter as shared_ecommercecustomersfilter
from ..shared import getecommercecustomersresponse as shared_getecommercecustomersresponse
...
class CustomersAllRequest:
    ...
    filter: Optional[shared_ecommercecustomersfilter.EcommerceCustomersFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    r"""Apply filters"""  
...
class CustomersAllResponse:
    ...
    r"""Bad Request"""  
    get_ecommerce_customers_response: Optional[shared_getecommercecustomersresponse.GetEcommerceCustomersResponse] = dataclasses.field(default=None)
    r"""Customers"""  
