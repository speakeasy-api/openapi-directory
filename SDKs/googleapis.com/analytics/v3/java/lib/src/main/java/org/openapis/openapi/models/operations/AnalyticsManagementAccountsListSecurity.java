...
public class AnalyticsManagementAccountsListSecurity {
    ...
    @SpeakeasyMetadata("security:option=true")
    public AnalyticsManagementAccountsListSecurityOption3 option3;

    public AnalyticsManagementAccountsListSecurity withOption3(AnalyticsManagementAccountsListSecurityOption3 option3) {
        this.option3 = option3;
        return this;
    }
    
    public AnalyticsManagementAccountsListSecurity(){}
}
