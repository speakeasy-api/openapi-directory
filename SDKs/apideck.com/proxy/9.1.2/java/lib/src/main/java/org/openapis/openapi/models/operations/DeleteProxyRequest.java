...
public class DeleteProxyRequest {
    ...
    public DeleteProxyRequest withXApideckAppId(String xApideckAppId) {
    ...
    public DeleteProxyRequest withXApideckConsumerId(String xApideckConsumerId) {
    ...
    public DeleteProxyRequest withXApideckDownstreamAuthorization(String xApideckDownstreamAuthorization) {
    ...
    public DeleteProxyRequest withXApideckDownstreamUrl(String xApideckDownstreamUrl) {
    ...
    public DeleteProxyRequest withXApideckServiceId(String xApideckServiceId) {
