...
var Prefixes = /** @class */ (function () {
    function Prefixes(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Add a static delegated prefix from a network
     */
    Prefixes.prototype.createNetworkAppliancePrefixesDelegatedStatic = function (req, config) {
        var _a;
     ...
     * Delete a static delegated prefix from a network
     */
    Prefixes.prototype.deleteNetworkAppliancePrefixesDelegatedStatic = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Return current delegated IPv6 prefixes on an appliance.
     */
    Prefixes.prototype.getDeviceAppliancePrefixesDelegated = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Return prefixes assigned to all IPv6 enabled VLANs on an appliance.
     */
    Prefixes.prototype.getDeviceAppliancePrefixesDelegatedVlanAssignments = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
     ...
     * Return a static delegated prefix from a network
     */
    Prefixes.prototype.getNetworkAppliancePrefixesDelegatedStatic = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * List static delegated prefixes for a network
     */
    Prefixes.prototype.getNetworkAppliancePrefixesDelegatedStatics = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update a static delegated prefix from a network
     */
    Prefixes.prototype.updateNetworkAppliancePrefixesDelegatedStatic = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
