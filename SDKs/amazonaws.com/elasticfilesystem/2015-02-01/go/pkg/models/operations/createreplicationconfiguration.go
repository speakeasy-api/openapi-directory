...
type CreateReplicationConfigurationPathParams struct {
...
type CreateReplicationConfigurationHeaders struct {
...
type CreateReplicationConfigurationRequest struct {
	PathParams CreateReplicationConfigurationPathParams
	Headers    CreateReplicationConfigurationHeaders
	Request    CreateReplicationConfigurationRequestBody `request:"mediaType=application/json"`
}
