...
class PromotionFields:
    ...
    r"""Minimum order amount to validate the promotion"""  
    ...
    r"""Minimum quantity of ordered itens to validate the promotion"""  
    ...
    r"""Fixed discount amount of the promotion"""  
    ...
    r"""Percentual discount amount of the promotion"""  
    ...
    r"""If the promotion is currently enabled"""  
    ...
    r"""Status of the promotion ('active', 'expired')"""  
    times_used: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('times_used'), 'exclude': lambda f: f is None }})
    r"""Amount of times the promotion was used"""  
