...
type GetUnmaskedAddressByVersionPathParams struct {
...
type GetUnmaskedAddressByVersionQueryParams struct {
...
type GetUnmaskedAddressByVersionHeaders struct {
...
type GetUnmaskedAddressByVersionRequest struct {
	PathParams  GetUnmaskedAddressByVersionPathParams
	QueryParams GetUnmaskedAddressByVersionQueryParams
	Headers     GetUnmaskedAddressByVersionHeaders
}

type GetUnmaskedAddressByVersionResponse struct {
	ContentType string
	// OK
	GetUnmaskedAddressByVersion200ApplicationJSONObject map[string]interface{}
	StatusCode                                          int
