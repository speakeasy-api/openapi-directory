...
public class ListDistributionsByKeyGroup20200531QueryParams {
    /**
    ...
    public ListDistributionsByKeyGroup20200531QueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListDistributionsByKeyGroup20200531QueryParams withMaxItems(String maxItems) {
