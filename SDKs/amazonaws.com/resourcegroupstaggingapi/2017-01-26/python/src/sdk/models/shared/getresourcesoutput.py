...
class GetResourcesOutput:
    ...
    resource_tag_mapping_list: Optional[list[shared_resourcetagmapping.ResourceTagMapping]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ResourceTagMappingList'), 'exclude': lambda f: f is None }})  
