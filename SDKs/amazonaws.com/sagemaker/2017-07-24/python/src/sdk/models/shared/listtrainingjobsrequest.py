...
class ListTrainingJobsRequest:
    ...
    warm_pool_status_equals: Optional[shared_warmpoolresourcestatus_enum.WarmPoolResourceStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('WarmPoolStatusEquals'), 'exclude': lambda f: f is None }})  
