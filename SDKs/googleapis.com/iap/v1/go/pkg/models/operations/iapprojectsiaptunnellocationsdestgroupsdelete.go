...
type IapProjectsIapTunnelLocationsDestGroupsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type IapProjectsIapTunnelLocationsDestGroupsDeletePathParams struct {
...
type IapProjectsIapTunnelLocationsDestGroupsDeleteQueryParams struct {
	// V1 error format.
...
type IapProjectsIapTunnelLocationsDestGroupsDeleteRequest struct {
...
type IapProjectsIapTunnelLocationsDestGroupsDeleteResponse struct {
	ContentType string
	// Successful response
