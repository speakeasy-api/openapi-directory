...
from ..shared import enablessorequest as shared_enablessorequest
...
class EnableSsoHeaders:
    x_amz_target: EnableSsoXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class EnableSsoRequest:
    headers: EnableSsoHeaders = dataclasses.field()
    request: shared_enablessorequest.EnableSsoRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class EnableSsoResponse:
    ...
    enable_sso_result: Optional[dict[str, Any]] = dataclasses.field(default=None)
