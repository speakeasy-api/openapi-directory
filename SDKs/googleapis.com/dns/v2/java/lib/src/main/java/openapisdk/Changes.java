...
public class Changes {
    ...
    **/
    public openapisdk.models.operations.DnsChangesCreateResponse dnsChangesCreate(openapisdk.models.operations.DnsChangesCreateRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/changes", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.DnsChangesGetResponse dnsChangesGet(openapisdk.models.operations.DnsChangesGetRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/changes/{changeId}", request.pathParams);
