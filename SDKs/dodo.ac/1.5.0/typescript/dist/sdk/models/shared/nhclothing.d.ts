...
export declare class NHClothingAvailability extends SpeakeasyBase {
    from?: string;
    note?: string;
}
export declare class NHClothingBuy extends SpeakeasyBase {
    currency?: string;
    price?: number;
}
/**
 ...
 */
export declare enum NHClothingCategoryEnum {
    Tops = "Tops",
    Bottoms = "Bottoms",
    DressUp = "Dress-up",
    Headwear = "Headwear",
...
export declare enum NHClothingLabelThemesEnum {
    Comfy = "Comfy",
    Everyday = "Everyday",
...
export declare enum NHClothingStylesEnum {
    Active = "Active",
    Cool = "Cool",
    Cute = "Cute",
    Elegant = "Elegant",
 ...
 */
export declare enum NHClothingVariationTotalEnum {
    Zero = "0",
    One = "1",
    Two = "2",
    Three = "3",
...
export declare enum NHClothingVariationsColorsEnum {
    Aqua = "Aqua",
    Beige = "Beige",
    Black = "Black",
    Blue = "Blue",
...
export declare class NHClothingVariations extends SpeakeasyBase {
 ...
 */
export declare class NHClothing extends SpeakeasyBase {
    /**
