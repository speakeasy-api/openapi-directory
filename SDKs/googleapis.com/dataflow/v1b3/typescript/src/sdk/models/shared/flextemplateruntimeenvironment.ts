...
export class FlexTemplateRuntimeEnvironment extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "autoscalingAlgorithm" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "enableLauncherVmSerialPortLogging" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "launcherMachineType" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "saveHeapDumpsToGcsPath" })
