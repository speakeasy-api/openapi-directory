...
class DfareportingBillingProfilesListRequest:
    ...
    r"""Select only billing profile with currency."""  
    ...
    r"""Select only billing profile with these IDs."""  
    ...
    r"""Select only billing profile which is suggested for the currency_code & subaccount_id using the Billing Suggestion API."""  
    ...
    r"""Select only billing profile with the specified status."""  
    ...
    r"""Select only billing profile with the specified subaccount.When only_suggestion is true, only a single subaccount_id is supported."""  
