...
export class Item extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "inferredLocalizedAspects" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "lengthUnitOfMeasure" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "weightUnitOfMeasure" })
