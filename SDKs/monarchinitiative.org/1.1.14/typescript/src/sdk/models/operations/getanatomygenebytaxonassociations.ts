...
export class GetAnatomyGeneByTaxonAssociationsRequest extends SpeakeasyBase {
  /**
...
export class GetAnatomyGeneByTaxonAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
