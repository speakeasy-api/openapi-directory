...
func (e GetNetworkWirelessDevicesLatencyStatsBandEnum) ToPointer() *GetNetworkWirelessDevicesLatencyStatsBandEnum {
	return &e
}
...
func (e *GetNetworkWirelessDevicesLatencyStatsBandEnum) UnmarshalJSON(data []byte) error {
	...
	case "5":
		fallthrough
	case "6":
		*e = GetNetworkWirelessDevicesLatencyStatsBandEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessDevicesLatencyStatsBandEnum: %v", v)
	}
}
