...
from ..shared import worktype as shared_worktype
...
class PaymentLinkItem:
    ...
    tax: Optional[shared_tax.Tax] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Tax'), 'exclude': lambda f: f is None }})  
    ...
    work_type: Optional[shared_worktype.WorkType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('WorkType'), 'exclude': lambda f: f is None }})  
