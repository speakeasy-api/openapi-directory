...
class UpdateRuntimeConfigurationRequest:
    ...
    update_runtime_configuration_input: shared_updateruntimeconfigurationinput.UpdateRuntimeConfigurationInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
