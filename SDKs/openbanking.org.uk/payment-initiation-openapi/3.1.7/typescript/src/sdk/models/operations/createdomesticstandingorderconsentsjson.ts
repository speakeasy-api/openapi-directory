...
export class CreateDomesticStandingOrderConsentsJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateDomesticStandingOrderConsentsJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateDomesticStandingOrderConsentsJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
