...
class APIV2010AccountUsageUsageRecordUsageRecordYesterday:
    ...
    category: Optional[shared_usage_record_yesterday_enum_category_enum.UsageRecordYesterdayEnumCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('category') }})
