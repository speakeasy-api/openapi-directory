...
exports.ExportApiResponse = exports.ExportApiRequest = exports.ExportApiHeaders = exports.ExportApiQueryParams = exports.ExportApiPathParams = void 0;
...
var ExportApiPathParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=specification" }),
        __metadata("design:type", String)
    ], ExportApiPathParams.prototype, "specification", void 0);
    return ExportApiPathParams;
}(utils_1.SpeakeasyBase));
exports.ExportApiPathParams = ExportApiPathParams;
var ExportApiQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=exportVersion" }),
        __metadata("design:type", String)
    ], ExportApiQueryParams.prototype, "exportVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=includeExtensions" }),
        __metadata("design:type", Boolean)
    ], ExportApiQueryParams.prototype, "includeExtensions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=outputType" }),
        __metadata("design:type", String)
    ], ExportApiQueryParams.prototype, "outputType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=stageName" }),
        __metadata("design:type", String)
    ], ExportApiQueryParams.prototype, "stageName", void 0);
    return ExportApiQueryParams;
}(utils_1.SpeakeasyBase));
exports.ExportApiQueryParams = ExportApiQueryParams;
...
exports.ExportApiHeaders = ExportApiHeaders;
