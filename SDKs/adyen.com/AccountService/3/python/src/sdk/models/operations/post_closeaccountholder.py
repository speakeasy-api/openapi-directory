...
from ..shared import closeaccountholderresponse as shared_closeaccountholderresponse
...
class PostCloseAccountHolderResponse:
    ...
    close_account_holder_response: Optional[shared_closeaccountholderresponse.CloseAccountHolderResponse] = dataclasses.field(default=None)
