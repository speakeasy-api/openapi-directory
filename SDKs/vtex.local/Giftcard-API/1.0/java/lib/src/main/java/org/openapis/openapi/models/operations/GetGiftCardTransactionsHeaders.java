...
public class GetGiftCardTransactionsHeaders {
    /**
    ...
    public GetGiftCardTransactionsHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public GetGiftCardTransactionsHeaders withContentType(String contentType) {
