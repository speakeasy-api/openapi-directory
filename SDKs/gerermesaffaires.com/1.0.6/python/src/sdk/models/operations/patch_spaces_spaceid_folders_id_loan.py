...
class PatchSpacesSpaceIDFoldersIDLoanRequestBodyCategoryEnum(str, Enum):
...
class PatchSpacesSpaceIDFoldersIDLoanRequestBodyLevelEnum(str, Enum):
...
class PatchSpacesSpaceIDFoldersIDLoanRequestBody:
    r"""Loan to modify (except name, class and archivaldate)"""
    ...
    category: Optional[PatchSpacesSpaceIDFoldersIDLoanRequestBodyCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Category'), 'exclude': lambda f: f is None }})  
    ...
    level: Optional[PatchSpacesSpaceIDFoldersIDLoanRequestBodyLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Level'), 'exclude': lambda f: f is None }})  
...
class PatchSpacesSpaceIDFoldersIDLoanRequest:
    ...
    r"""Id of the folder"""  
    request_body: PatchSpacesSpaceIDFoldersIDLoanRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Loan to modify (except name, class and archivaldate)"""  
