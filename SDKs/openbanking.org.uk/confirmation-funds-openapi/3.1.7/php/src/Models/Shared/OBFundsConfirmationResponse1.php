...
class OBFundsConfirmationResponse1
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBFundsConfirmationResponse1Data')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\OBFundsConfirmationResponse1Data();
		$this->links = null;
		$this->meta = null;
	}
}
