 ...
 * 
 */
public enum GETRefundCreditMemoTypeFinanceInformationTransferredToAccountingEnum {
    ...
    private GETRefundCreditMemoTypeFinanceInformationTransferredToAccountingEnum(String value) {
        this.value = value;
    }
}
