...
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#add-an-email-address-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.. req = "ad"            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#check-if-a-user-follows-another-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCheckFollowingForUserRequest req = new UsersCheckFollowingForUserRequest("aliquam", "quisquam");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#check-if-a-person-is-followed-by-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCheckPersonIsFollowedByAuthenticatedRequest req = new UsersCheckPersonIsFollowedByAuthenticatedRequest("quas");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#create-a-gpg-key-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCreateGpgKeyForAuthenticatedUserRequestBody req = new UsersCreateGpgKeyForAuthenticatedUserRequestBody("consequuntur");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#create-a-public-ssh-key-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCreatePublicSshKeyForAuthenticatedUserRequestBody req = new UsersCreatePublicSshKeyForAuthenticatedUserRequestBody("maiores") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#delete-an-email-address-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.. req = new UsersDeleteEmailForAuthenticatedUserRequestBody1(                new String[]{{
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#delete-a-gpg-key-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersDeleteGpgKeyForAuthenticatedUserRequest req = new UsersDeleteGpgKeyForAuthenticatedUserRequest(665872L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#delete-a-public-ssh-key-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersDeletePublicSshKeyForAuthenticatedUserRequest req = new UsersDeletePublicSshKeyForAuthenticatedUserRequest(221329L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#follow-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersFollowRequest req = new UsersFollowRequest("aliquid");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#get-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#get-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetByUsernameRequest req = new UsersGetByUsernameRequest("consectetur");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#get-contextual-information-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetContextForUserRequest req = new UsersGetContextForUserRequest("cumque") {{
                subjectId = "rem";
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#get-a-gpg-key-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetGpgKeyForAuthenticatedUserRequest req = new UsersGetGpgKeyForAuthenticatedUserRequest(498534L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#get-a-public-ssh-key-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetPublicSshKeyForAuthenticatedUserRequest req = new UsersGetPublicSshKeyForAuthenticatedUserRequest(237523L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#list-users>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#list-email-addresses-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#list-the-people-the-authenticated-user-follows>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#list-followers-of-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#list-followers-of-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListFollowersForUserRequest req = new UsersListFollowersForUserRequest("veritatis") {{
                page = 949280L;
                perPage = 419858L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#list-the-people-a-user-follows>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListFollowingForUserRequest req = new UsersListFollowingForUserRequest("quidem") {{
                page = 517121L;
                perPage = 781193L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#list-gpg-keys-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#list-gpg-keys-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListGpgKeysForUserRequest req = new UsersListGpgKeysForUserRequest("nihil") {{
                page = 374062L;
                perPage = 658199L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#list-public-email-addresses-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#list-public-keys-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListPublicKeysForUserRequest req = new UsersListPublicKeysForUserRequest("fuga") {{
                page = 14780L;
                perPage = 295892L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#list-public-ssh-keys-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users#unfollow-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersUnfollowRequest req = new UsersUnfollowRequest("iste");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/users/#update-the-authenticated-user>
