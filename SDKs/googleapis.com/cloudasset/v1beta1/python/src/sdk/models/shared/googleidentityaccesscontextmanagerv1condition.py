...
class GoogleIdentityAccesscontextmanagerV1Condition:
    ...
    device_policy: Optional[shared_googleidentityaccesscontextmanagerv1devicepolicy.GoogleIdentityAccesscontextmanagerV1DevicePolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('devicePolicy') }})
