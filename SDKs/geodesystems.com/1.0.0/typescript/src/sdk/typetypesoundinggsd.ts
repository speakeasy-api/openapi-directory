...
export class TypeTypeSoundingGsd {
  ...
  searchTypeSoundingGsd(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_sounding_gsd";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeSoundingGsdResponse =
        new operations.SearchTypeSoundingGsdResponse({
