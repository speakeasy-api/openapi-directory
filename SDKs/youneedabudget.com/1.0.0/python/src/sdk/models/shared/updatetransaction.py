...
class UpdateTransaction:
    ...
    cleared: Optional[UpdateTransactionClearedEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cleared') }})
    flag_color: Optional[UpdateTransactionFlagColorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('flag_color') }})
