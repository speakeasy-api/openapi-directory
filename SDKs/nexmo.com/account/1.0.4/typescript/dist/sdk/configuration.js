...
var Configuration = /** @class */ (function () {
    ...
    **/
    Configuration.prototype.changeAccountSettings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ChangeAccountSettingsRequest(req);
        }
        var baseURL = operations.ChangeAccountSettingsServerList[0];
        if (req.serverURL) {
    ...
    **/
    Configuration.prototype.registerSender = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegisterSenderRequest(req);
        }
        var baseURL = operations.RegisterSenderServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = baseURL.replace(/\/$/, "") + "/account/register-sender";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.registerEmailResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
