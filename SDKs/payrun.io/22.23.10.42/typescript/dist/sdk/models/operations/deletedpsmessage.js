...
exports.DeleteDpsMessageResponse = exports.DeleteDpsMessageRequest = void 0;
...
var DeleteDpsMessageRequest = /** @class */ (function (_super) {
    ...
    ], DeleteDpsMessageRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeleteDpsMessageRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=DpsMessageId",
        }),
        __metadata("design:type", String)
    ], DeleteDpsMessageRequest.prototype, "dpsMessageId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeleteDpsMessageRequest.prototype, "employerId", void 0);
    return DeleteDpsMessageRequest;
}(utils_1.SpeakeasyBase));
exports.DeleteDpsMessageRequest = DeleteDpsMessageRequest;
var DeleteDpsMessageResponse = /** @class */ (function (_super) {
    ...
    ], DeleteDpsMessageResponse.prototype, "rawResponse", void 0);
    return DeleteDpsMessageResponse;
}(utils_1.SpeakeasyBase));
exports.DeleteDpsMessageResponse = DeleteDpsMessageResponse;
