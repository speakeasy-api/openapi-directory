...
func (s *V1) ChangePassword(ctx context.Context, request operations.ChangePasswordRequest) (*operations.ChangePasswordResponse, error) {
	...
	url := utils.GenerateURL(ctx, baseURL, "/v1/shoppers/{shopperId}/factors/password", request.PathParams)
...
func (s *V1) CreateSubaccount(ctx context.Context, request operations.CreateSubaccountRequest) (*operations.CreateSubaccountResponse, error) {
	baseURL := s._serverURL
...
func (s *V1) Delete(ctx context.Context, request operations.DeleteRequest) (*operations.DeleteResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/shoppers/{shopperId}", request.PathParams)
...
func (s *V1) GetStatus(ctx context.Context, request operations.GetStatusRequest) (*operations.GetStatusResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/shoppers/{shopperId}/status", request.PathParams)
