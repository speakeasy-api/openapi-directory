...
from ..shared import noderemoveparameter as shared_noderemoveparameter
from typing import Optional


@dataclasses.dataclass
class PoolRemoveNodesRequest:
    
    api_version: str = dataclasses.field(metadata={'query_param': { 'field_name': 'api-version', 'style': 'form', 'explode': True }})
    r"""Client API Version."""  
    node_remove_parameter: shared_noderemoveparameter.NodeRemoveParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    ...
    r"""The id of the pool from which you want to remove nodes."""  
