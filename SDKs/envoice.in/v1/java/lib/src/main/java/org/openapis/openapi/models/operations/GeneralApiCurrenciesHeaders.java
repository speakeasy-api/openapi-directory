...
public class GeneralApiCurrenciesHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public GeneralApiCurrenciesHeaders withXAuthKey(String xAuthKey) {
    ...
    public GeneralApiCurrenciesHeaders withXAuthSecret(String xAuthSecret) {
