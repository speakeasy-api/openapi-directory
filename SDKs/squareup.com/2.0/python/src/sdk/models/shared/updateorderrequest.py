...
class UpdateOrderRequest:
    ...
    r"""The [dot notation paths](https://developer.squareup.com/docs/orders-api/manage-orders#on-dot-notation)
    ...
    r"""A value you specify that uniquely identifies this update request.
