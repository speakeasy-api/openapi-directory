...
class GetCandidatesQueryParams:
    ...
    candidate_status: Optional[list[GetCandidatesCandidateStatusEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'candidate_status', 'style': 'form', 'explode': True }})
    ...
    incumbent_challenge: Optional[list[GetCandidatesIncumbentChallengeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'incumbent_challenge', 'style': 'form', 'explode': True }})
    ...
    office: Optional[list[GetCandidatesOfficeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'office', 'style': 'form', 'explode': True }})
...
class GetCandidatesRequest:
    query_params: GetCandidatesQueryParams = dataclasses.field()
