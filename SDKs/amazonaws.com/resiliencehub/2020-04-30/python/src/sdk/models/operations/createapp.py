...
class CreateAppRequestBodyAssessmentScheduleEnum(str, Enum):
...
class CreateAppRequestBody:
    ...
    r"""The name for the application."""  
    assessment_schedule: Optional[CreateAppRequestBodyAssessmentScheduleEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assessmentSchedule'), 'exclude': lambda f: f is None }})
    r"""Assessment execution schedule with 'Daily' or 'Disabled' values."""  
