...
export enum GetLoadBalancerTlsPoliciesXAmzTargetEnum {
  Lightsail20161128GetLoadBalancerTlsPolicies = "Lightsail_20161128.GetLoadBalancerTlsPolicies",
}

export class GetLoadBalancerTlsPoliciesRequest extends SpeakeasyBase {
...
export class GetLoadBalancerTlsPoliciesResponse extends SpeakeasyBase {
  /**
