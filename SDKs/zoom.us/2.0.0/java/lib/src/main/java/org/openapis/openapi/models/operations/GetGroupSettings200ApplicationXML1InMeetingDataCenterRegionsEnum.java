 ...
 * 
 */
public enum GetGroupSettings200ApplicationXML1InMeetingDataCenterRegionsEnum {
    EU("EU"),
    HK("HK"),
    AU("AU"),
    IN("IN"),
    ...
    private GetGroupSettings200ApplicationXML1InMeetingDataCenterRegionsEnum(String value) {
        this.value = value;
    }
}
