...
class GetSearchCarFsboActiveQueryParams:
...
@dataclasses.dataclass
class GetSearchCarFsboActiveRequest:
    query_params: GetSearchCarFsboActiveQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetSearchCarFsboActiveResponse:
