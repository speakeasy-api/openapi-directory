...
class StartLifecyclePolicyPreviewRequest:
    ...
    start_lifecycle_policy_preview_request: shared_startlifecyclepolicypreviewrequest.StartLifecyclePolicyPreviewRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class StartLifecyclePolicyPreviewResponse:
    ...
    r"""LifecyclePolicyPreviewInProgressException"""  
