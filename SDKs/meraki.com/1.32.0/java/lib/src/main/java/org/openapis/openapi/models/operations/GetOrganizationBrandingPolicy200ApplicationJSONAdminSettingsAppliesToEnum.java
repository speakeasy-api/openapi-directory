 ...
 */
public enum GetOrganizationBrandingPolicy200ApplicationJSONAdminSettingsAppliesToEnum {
    ...
    private GetOrganizationBrandingPolicy200ApplicationJSONAdminSettingsAppliesToEnum(String value) {
        this.value = value;
    }
}
