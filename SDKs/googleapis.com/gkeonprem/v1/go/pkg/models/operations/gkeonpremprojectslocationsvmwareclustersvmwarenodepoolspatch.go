...
type GkeonpremProjectsLocationsVmwareClustersVmwareNodePoolsPatchSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type GkeonpremProjectsLocationsVmwareClustersVmwareNodePoolsPatchRequest struct {
	// V1 error format.
	DollarXgafv         *shared.XgafvEnum           `queryParam:"style=form,explode=true,name=$.xgafv"`
	VmwareNodePoolInput *shared.VmwareNodePoolInput `request:"mediaType=application/json"`
	// OAuth access token.
...
type GkeonpremProjectsLocationsVmwareClustersVmwareNodePoolsPatchResponse struct {
	ContentType string
	// Successful response
