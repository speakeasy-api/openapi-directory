...
class GetIndexDocumentsQueryParams:
    action: GetIndexDocumentsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    domain_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'DomainName', 'style': 'form', 'explode': True }})
    version: GetIndexDocumentsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetIndexDocumentsRequest:
    headers: GetIndexDocumentsHeaders = dataclasses.field()
    query_params: GetIndexDocumentsQueryParams = dataclasses.field()
