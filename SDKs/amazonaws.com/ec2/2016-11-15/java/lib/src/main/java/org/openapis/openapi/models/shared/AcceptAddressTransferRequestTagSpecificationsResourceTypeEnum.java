 ...
 */
public enum AcceptAddressTransferRequestTagSpecificationsResourceTypeEnum {
    ...
    private AcceptAddressTransferRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
