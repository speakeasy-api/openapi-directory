...
export declare class Projects {
     ...
     */
    tpuProjectsLocationsNodesReimage(req: operations.TpuProjectsLocationsNodesReimageRequest, security: operations.TpuProjectsLocationsNodesReimageSecurity, config?: AxiosRequestConfig): Promise<operations.TpuProjectsLocationsNodesReimageResponse>;
    /**
     * Starts a node.
     */
     ...
     */
    tpuProjectsLocationsTensorflowVersionsGet(req: operations.TpuProjectsLocationsTensorflowVersionsGetRequest, security: operations.TpuProjectsLocationsTensorflowVersionsGetSecurity, config?: AxiosRequestConfig): Promise<operations.TpuProjectsLocationsTensorflowVersionsGetResponse>;
    /**
     * List TensorFlow versions supported by this API.
     */
    tpuProjectsLocationsTensorflowVersionsList(req: operations.TpuProjectsLocationsTensorflowVersionsListRequest, security: operations.TpuProjectsLocationsTensorflowVersionsListSecurity, config?: AxiosRequestConfig): Promise<operations.TpuProjectsLocationsTensorflowVersionsListResponse>;
}
