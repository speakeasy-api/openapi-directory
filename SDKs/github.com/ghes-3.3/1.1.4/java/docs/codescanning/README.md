...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningDeleteAnalysisRequest req = new CodeScanningDeleteAnalysisRequest(269479L, "ipsam", "ea") {{
                confirmDelete = "aspernatur";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetAlertRequest req = new CodeScanningGetAlertRequest(428224L, "possimus", "magnam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetAnalysisRequest req = new CodeScanningGetAnalysisRequest(189848L, "ex", "laudantium");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetSarifRequest req = new CodeScanningGetSarifRequest("dicta", "dolor", "maiores");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListAlertInstancesRequest req = new CodeScanningListAlertInstancesRequest(97844L, "ex", "nulla") {{
                page = 569211L;
                perPage = 972920L;
                ref = "nostrum";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListAlertsForRepoRequest req = new CodeScanningListAlertsForRepoRequest("sapiente", "quisquam") {{
                page = 906556L;
                perPage = 411372L;
                ref = "impedit";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListRecentAnalysesRequest req = new CodeScanningListRecentAnalysesRequest("inventore", "magnam") {{
                page = 407241L;
                perPage = 775220L;
                ref = "consectetur";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningUploadSarifRequest req = new CodeScanningUploadSarifRequest(                new CodeScanningUploadSarifRequestBody("aut", "deleniti", "impedit") {{
                                checkoutUri = "file:///github/workspace/";
                                startedAt = OffsetDateTime.parse("2022-11-08T08:44:49.857Z");
                                toolName = "accusamus";
                            }};, "inventore", "non");            
