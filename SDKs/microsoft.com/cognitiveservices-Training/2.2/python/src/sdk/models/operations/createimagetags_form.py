...
class CreateImageTagsFormRequest:
    
    image_tag_create_batch: shared_imagetagcreatebatch.ImageTagCreateBatch = dataclasses.field(metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
...
@dataclasses.dataclass
class CreateImageTagsFormResponse:
