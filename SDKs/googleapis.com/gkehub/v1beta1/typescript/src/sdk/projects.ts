...
export class Projects {
  ...
  gkehubProjectsLocationsMembershipsGenerateExclusivityManifest(
    ...
    security: operations.GkehubProjectsLocationsMembershipsGenerateExclusivityManifestSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.GkehubProjectsLocationsMembershipsGenerateExclusivityManifestResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GkehubProjectsLocationsMembershipsGenerateExclusivityManifestRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GkehubProjectsLocationsMembershipsGenerateExclusivityManifestSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GkehubProjectsLocationsMembershipsGenerateExclusivityManifestResponse =
        new operations.GkehubProjectsLocationsMembershipsGenerateExclusivityManifestResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.generateExclusivityManifestResponse = utils.objectToClass(
              httpRes?.data,
              shared.GenerateExclusivityManifestResponse
            );
          }
          break;
      }
  ...
  gkehubProjectsLocationsMembershipsValidateExclusivity(
    ...
    security: operations.GkehubProjectsLocationsMembershipsValidateExclusivitySecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.GkehubProjectsLocationsMembershipsValidateExclusivityResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GkehubProjectsLocationsMembershipsValidateExclusivityRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GkehubProjectsLocationsMembershipsValidateExclusivitySecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GkehubProjectsLocationsMembershipsValidateExclusivityResponse =
        new operations.GkehubProjectsLocationsMembershipsValidateExclusivityResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.validateExclusivityResponse = utils.objectToClass(
              httpRes?.data,
              shared.ValidateExclusivityResponse
            );
          }
          break;
      }
