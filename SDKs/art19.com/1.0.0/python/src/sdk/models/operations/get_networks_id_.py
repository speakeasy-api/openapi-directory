...
class GetNetworksIDRequest:
    ...
    r"""The ID of the network resource to load."""  
...
class GetNetworksID200ApplicationVndAPIPlusJSON:
    ...
    data: Optional[shared_network.Network] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
