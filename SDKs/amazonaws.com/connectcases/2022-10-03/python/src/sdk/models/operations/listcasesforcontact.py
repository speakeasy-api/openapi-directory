...
from ..shared import listcasesforcontactresponse as shared_listcasesforcontactresponse
...
class ListCasesForContactRequestBody:
    ...
    r"""A unique identifier of a contact in Amazon Connect."""  
...
class ListCasesForContactRequest:
    ...
    request_body: ListCasesForContactRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListCasesForContactResponse:
    ...
    list_cases_for_contact_response: Optional[shared_listcasesforcontactresponse.ListCasesForContactResponse] = dataclasses.field(default=None)
    r"""Success"""  
