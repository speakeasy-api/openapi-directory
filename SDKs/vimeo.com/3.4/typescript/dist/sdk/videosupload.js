...
var VideosUpload = /** @class */ (function () {
    ...
    **/
    VideosUpload.prototype.completeStreamingUpload = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CompleteStreamingUploadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{user_id}/uploads/{upload}", req.pathParams);
    ...
    **/
    VideosUpload.prototype.getUploadAttempt = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/vnd.vimeo.uploadattempt+json")) {
                        res.uploadAttempt = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
