...
var Media = /** @class */ (function () {
     ...
     */
    Media.prototype.cloudsupportMediaDownload = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudsupportMediaDownloadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta/{name}:download", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.CloudsupportMediaDownloadResponse({
     ...
     */
    Media.prototype.cloudsupportMediaUpload = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.CloudsupportMediaUploadResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
