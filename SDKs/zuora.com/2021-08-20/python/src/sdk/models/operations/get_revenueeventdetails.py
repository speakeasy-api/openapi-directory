...
from ..shared import getrevenueeventdetailtype as shared_getrevenueeventdetailtype
...
class GETRevenueEventDetailsResponse:
    ...
    get_revenue_event_detail_type: Optional[shared_getrevenueeventdetailtype.GETRevenueEventDetailType] = dataclasses.field(default=None)  
