...
export class MigrationcenterProjectsLocationsImportJobsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum MigrationcenterProjectsLocationsImportJobsListViewEnum {
...
export class MigrationcenterProjectsLocationsImportJobsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MigrationcenterProjectsLocationsImportJobsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
