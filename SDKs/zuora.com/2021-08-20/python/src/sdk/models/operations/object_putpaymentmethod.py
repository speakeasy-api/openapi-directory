...
from ..shared import proxymodifypaymentmethod as shared_proxymodifypaymentmethod
...
class ObjectPUTPaymentMethodRequest:
    ...
    r"""Object id"""  
    proxy_modify_payment_method: shared_proxymodifypaymentmethod.ProxyModifyPaymentMethod = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
