...
class ListMarketplaceInstalledAddOnExtensionRequest:
    ...
    r"""The SID of the InstalledAddOn resource with the extensions to read."""  
...
class ListMarketplaceInstalledAddOnExtensionListMarketplaceInstalledAddOnExtensionResponse:
    ...
    extensions: Optional[list[shared_preview_marketplace_installed_add_on_installed_add_on_extension.PreviewMarketplaceInstalledAddOnInstalledAddOnExtension]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('extensions'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListMarketplaceInstalledAddOnExtensionListMarketplaceInstalledAddOnExtensionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
