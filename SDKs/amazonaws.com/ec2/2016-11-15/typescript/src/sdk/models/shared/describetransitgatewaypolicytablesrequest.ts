 ...
 */
export class DescribeTransitGatewayPolicyTablesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeTransitGatewayPolicyTablesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
