...
from ..shared import createapprequest as shared_createapprequest
...
class CreateAppHeaders:
    x_amz_target: CreateAppXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAppRequest:
    ...
    request: shared_createapprequest.CreateAppRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
