...
class DescribeVpnConnectionsRequest:
    r"""Contains the parameters for DescribeVpnConnections."""
    
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeVpnConnectionsRequestFilters]] = dataclasses.field(default=None)  
    vpn_connection_ids: Optional[list[str]] = dataclasses.field(default=None)  
