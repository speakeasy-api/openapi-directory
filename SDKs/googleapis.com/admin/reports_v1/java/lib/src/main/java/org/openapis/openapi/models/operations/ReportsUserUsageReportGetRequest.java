...
public class ReportsUserUsageReportGetRequest {
    ...
    public ReportsUserUsageReportGetRequest withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public ReportsUserUsageReportGetRequest withAccessToken(String accessToken) {
    ...
    public ReportsUserUsageReportGetRequest withAlt(org.openapis.openapi.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
    ...
    public ReportsUserUsageReportGetRequest withCallback(String callback) {
    ...
    public ReportsUserUsageReportGetRequest withCustomerId(String customerId) {
    ...
    public ReportsUserUsageReportGetRequest withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public ReportsUserUsageReportGetRequest withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public ReportsUserUsageReportGetRequest withFilters(String filters) {
    ...
    public ReportsUserUsageReportGetRequest withGroupIdFilter(String groupIdFilter) {
    ...
    public ReportsUserUsageReportGetRequest withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public ReportsUserUsageReportGetRequest withMaxResults(Long maxResults) {
    ...
    public ReportsUserUsageReportGetRequest withOauthToken(String oauthToken) {
    ...
    public ReportsUserUsageReportGetRequest withOrgUnitID(String orgUnitID) {
    ...
    public ReportsUserUsageReportGetRequest withPageToken(String pageToken) {
    ...
    public ReportsUserUsageReportGetRequest withParameters(String parameters) {
    ...
    public ReportsUserUsageReportGetRequest withPrettyPrint(Boolean prettyPrint) {
    ...
    public ReportsUserUsageReportGetRequest withQuotaUser(String quotaUser) {
    ...
    public ReportsUserUsageReportGetRequest withUploadType(String uploadType) {
    ...
    public ReportsUserUsageReportGetRequest withUploadProtocol(String uploadProtocol) {
    ...
    public ReportsUserUsageReportGetRequest withUserKey(String userKey) {
        this.userKey = userKey;
        return this;
    }
    
    public ReportsUserUsageReportGetRequest(@JsonProperty("date") String date, @JsonProperty("userKey") String userKey) {
        this.date = date;
        this.userKey = userKey;
  }
}
