...
export class DataplexProjectsLocationsLakesTasksRunSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsLakesTasksRunRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsLakesTasksRunResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
