...
<https://docs.github.com/enterprise-server@2.21/rest/reference/search#search-code>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCodeRequest req = new SearchCodeRequest("provident") {{
                order = OrderEnum.ASC;
                page = 921719L;
                perPage = 9683L;
...
API method documentation
<https://docs.github.com/enterprise-server@2.21/rest/reference/search#search-commits>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCommitsRequest req = new SearchCommitsRequest("maxime") {{
...
API method documentation
<https://docs.github.com/enterprise-server@2.21/rest/reference/search#search-issues-and-pull-requests>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchIssuesAndPullRequestsRequest req = new SearchIssuesAndPullRequestsRequest("provident") {{
                order = OrderEnum.ASC;
                page = 700045L;
                perPage = 492361L;
...
API method documentation
<https://docs.github.com/enterprise-server@2.21/rest/reference/search#search-labels>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchLabelsRequest req = new SearchLabelsRequest("vero", 629377L) {{
                order = OrderEnum.ASC;
                page = 434827L;
                perPage = 213835L;
...
API method documentation
<https://docs.github.com/enterprise-server@2.21/rest/reference/search#search-repositories>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchReposRequest req = new SearchReposRequest("impedit") {{
                order = OrderEnum.DESC;
                page = 12171L;
                perPage = 32055L;
                sort = SearchReposSortEnum.FORKS;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@2.21/rest/reference/search#search-topics>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchTopicsRequest req = new SearchTopicsRequest("quae") {{
                page = 229567L;
                perPage = 849320L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@2.21/rest/reference/search#search-users>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchUsersRequest req = new SearchUsersRequest("praesentium") {{
                order = OrderEnum.ASC;
                page = 736853L;
                perPage = 230411L;
