...
public class ServiceusageServicesConsumerQuotaMetricsLimitsAdminOverridesListPathParams {
    /**
    ...
    public ServiceusageServicesConsumerQuotaMetricsLimitsAdminOverridesListPathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
