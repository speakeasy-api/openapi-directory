 ...
 */
export enum CreateIntegrationResultConnectionTypeEnum {
  Internet = "INTERNET",
  VpcLink = "VPC_LINK",
}
 ...
 */
export enum CreateIntegrationResultContentHandlingStrategyEnum {
 ...
 */
export enum CreateIntegrationResultIntegrationTypeEnum {
  Aws = "AWS",
  Http = "HTTP",
  Mock = "MOCK",
 ...
 */
export enum CreateIntegrationResultPassthroughBehaviorEnum {
...
export class CreateIntegrationResult extends SpeakeasyBase {
  ...
  @Type(() => CreateIntegrationResultTlsConfig)
