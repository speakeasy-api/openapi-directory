...
class DeleteFirewallDomainListRequest:
    ...
    delete_firewall_domain_list_request: shared_deletefirewalldomainlistrequest.DeleteFirewallDomainListRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
