...
class GoogleFirebaseAppcheckV1UpdateServiceRequest:
    ...
    service: Optional[shared_googlefirebaseappcheckv1service.GoogleFirebaseAppcheckV1Service] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('service') }})
