...
public class CreateFilePaymentConsentsConsentIdFileRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateFilePaymentConsentsConsentIdFileRawHeaders withAuthorization(String authorization) {
    ...
    public CreateFilePaymentConsentsConsentIdFileRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateFilePaymentConsentsConsentIdFileRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateFilePaymentConsentsConsentIdFileRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateFilePaymentConsentsConsentIdFileRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateFilePaymentConsentsConsentIdFileRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateFilePaymentConsentsConsentIdFileRawHeaders withXJwsSignature(String xJwsSignature) {
