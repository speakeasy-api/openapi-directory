...
exports.AssetsCovarianceMatrix = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var AssetsCovarianceMatrix = /** @class */ (function () {
    function AssetsCovarianceMatrix(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    AssetsCovarianceMatrix.prototype.postAssetsCovarianceMatrix = function (req, config) {
        var _a;
     ...
     *
    **/
    AssetsCovarianceMatrix.prototype.postAssetsCovarianceMatrixSample = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    AssetsCovarianceMatrix.prototype.postAssetsCovarianceMatrixValidation = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.AssetsCovarianceMatrix = AssetsCovarianceMatrix;
