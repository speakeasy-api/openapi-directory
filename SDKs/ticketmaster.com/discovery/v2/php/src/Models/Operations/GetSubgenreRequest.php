...
class GetSubgenreRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetSubgenreIncludeLicensedContentEnum $includeLicensedContent
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=includeLicensedContent')]
    public ?GetSubgenreIncludeLicensedContentEnum $includeLicensedContent = null;
