...
public class GetSKUoffersQueryParams {
    /**
    ...
    public GetSKUoffersQueryParams withAccountName(String accountName) {
    ...
    public GetSKUoffersQueryParams withEnvironment(String environment) {
