...
class DeletePlacementPathParams:
...
class DeletePlacementRequest:
    headers: DeletePlacementHeaders = dataclasses.field()
    path_params: DeletePlacementPathParams = dataclasses.field()
