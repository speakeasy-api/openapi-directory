...
var ReplicationTaskAssessmentRun = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "AssessmentProgress" }),
        (0, class_transformer_1.Type)(function () { return replicationtaskassessmentrunprogress_1.ReplicationTaskAssessmentRunProgress; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ReplicationTaskAssessmentRunArn" }),
        __metadata("design:type", String)
    ], ReplicationTaskAssessmentRun.prototype, "replicationTaskAssessmentRunArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ReplicationTaskAssessmentRunCreationDate" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ResultEncryptionMode" }),
        __metadata("design:type", String)
    ], ReplicationTaskAssessmentRun.prototype, "resultEncryptionMode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ResultKmsKeyArn" }),
        __metadata("design:type", String)
    ], ReplicationTaskAssessmentRun.prototype, "resultKmsKeyArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ResultLocationBucket" }),
        __metadata("design:type", String)
    ], ReplicationTaskAssessmentRun.prototype, "resultLocationBucket", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ResultLocationFolder" }),
        __metadata("design:type", String)
