...
class ProjectsGetV2ProjectsProjectIDGetOrderByProjectsOrderEnum(str, Enum):
    r"""An enumeration."""
    ID = 'id'
    NAME = 'name'
    SUBTITLE = 'subtitle'
...
class ProjectsGetV2ProjectsProjectIDGetSortSortEnum(str, Enum):
    r"""An enumeration."""
    ASC = 'asc'
    DESC = 'desc'
...
class ProjectsGetV2ProjectsProjectIDGetRequest:
    ...
    order_by: Optional[ProjectsGetV2ProjectsProjectIDGetOrderByProjectsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order_by', 'style': 'form', 'explode': True }})
    r"""An enumeration."""  
    ...
    sort: Optional[ProjectsGetV2ProjectsProjectIDGetSortSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""Define sort order."""  
