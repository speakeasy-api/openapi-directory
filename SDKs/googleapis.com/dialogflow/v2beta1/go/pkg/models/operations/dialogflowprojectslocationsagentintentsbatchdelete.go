...
type DialogflowProjectsLocationsAgentIntentsBatchDeleteRequest struct {
	...
	GoogleCloudDialogflowV2beta1BatchDeleteIntentsRequestInput *shared.GoogleCloudDialogflowV2beta1BatchDeleteIntentsRequestInput `request:"mediaType=application/json"`
	// OAuth access token.
