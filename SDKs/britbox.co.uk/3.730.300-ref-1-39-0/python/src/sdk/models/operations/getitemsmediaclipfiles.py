...
from ..shared import itemclipfileslist as shared_itemclipfileslist
from ..shared import itemdownloadablerequest as shared_itemdownloadablerequest
...
class GetItemsMediaClipFilesRequest:
    ...
    item_downloadable_request: shared_itemdownloadablerequest.ItemDownloadableRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetItemsMediaClipFilesResponse:
    ...
    item_clip_files_list: Optional[shared_itemclipfileslist.ItemClipFilesList] = dataclasses.field(default=None)
    r"""The item id with clip files"""  
