...
func (e GoogleCloudVisionV1p1beta1BlockBlockTypeEnum) ToPointer() *GoogleCloudVisionV1p1beta1BlockBlockTypeEnum {
	return &e
}
...
func (e *GoogleCloudVisionV1p1beta1BlockBlockTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "RULER":
		fallthrough
	case "BARCODE":
		*e = GoogleCloudVisionV1p1beta1BlockBlockTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudVisionV1p1beta1BlockBlockTypeEnum: %v", v)
	}
}
