 ...
 */
export declare class DescribeVpcsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeVpcsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeVpcsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
    vpcIds?: string[];
}
