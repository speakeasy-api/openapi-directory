...
class StoredValueBalanceMergeResponseResultCodeEnum(str, Enum):
...
class StoredValueBalanceMergeResponse:
    ...
    * When the payment is not authorised, this field is empty.
    ...
    """  
    result_code: Optional[StoredValueBalanceMergeResponseResultCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resultCode'), 'exclude': lambda f: f is None }})
    r"""The result of the payment. Possible values:
