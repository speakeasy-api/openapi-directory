...
public class DataPointsGetQueryParams {
    /**
    ...
    public DataPointsGetQueryParams withCreatedAfter(String createdAfter) {
    ...
    public DataPointsGetQueryParams withCreatedBefore(String createdBefore) {
    ...
    public DataPointsGetQueryParams withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public DataPointsGetQueryParams withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public DataPointsGetQueryParams withOnlyFavorites(Boolean onlyFavorites) {
    ...
    public DataPointsGetQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public DataPointsGetQueryParams withSortDirection(DataPointsGetSortDirectionEnum sortDirection) {
    ...
    public DataPointsGetQueryParams withStatus(DataPointsGetStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public String tags;
    public DataPointsGetQueryParams withTags(String tags) {
        this.tags = tags;
        return this;
    }
    ...
    public DataPointsGetQueryParams withTextSearch(String textSearch) {
    ...
    public DataPointsGetQueryParams withType(DataPointsGetTypeEnum type) {
        this.type = type;
        return this;
    }
