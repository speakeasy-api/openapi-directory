...
public class PostV05ConsentRequestsInitJsonRequest {
    ...
    public PostV05ConsentRequestsInitJsonRequest(@JsonProperty("Authorization") String authorization, @JsonProperty("ConsentRequest") org.openapis.openapi.models.shared.ConsentRequest consentRequest) {
        this.authorization = authorization;
        this.consentRequest = consentRequest;
  }
}
