...
exports.GetSetupV1ResourcesResponse = exports.GetSetupV1ResourcesRequest = void 0;
...
var GetSetupV1ResourcesRequest = /** @class */ (function (_super) {
    ...
    ], GetSetupV1ResourcesRequest.prototype, "deleted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=email" }),
        __metadata("design:type", String)
    ], GetSetupV1ResourcesRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=googleAuthReturnUrl",
        }),
        __metadata("design:type", String)
    ], GetSetupV1ResourcesRequest.prototype, "googleAuthReturnUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetSetupV1ResourcesRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locationId",
        }),
        __metadata("design:type", String)
    ], GetSetupV1ResourcesRequest.prototype, "locationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], GetSetupV1ResourcesRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], GetSetupV1ResourcesRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=outlookAuthReturnUrl",
        }),
        __metadata("design:type", String)
    ], GetSetupV1ResourcesRequest.prototype, "outlookAuthReturnUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=resourceGroupId",
        }),
        __metadata("design:type", String)
    ], GetSetupV1ResourcesRequest.prototype, "resourceGroupId", void 0);
...
var GetSetupV1ResourcesResponse = /** @class */ (function (_super) {
    ...
    ], GetSetupV1ResourcesResponse.prototype, "rawResponse", void 0);
