...
class CreateOrderTriggerParams:
    ...
    trigger_event: Optional[CreateOrderTriggerParamsTriggerEventEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('triggerEvent') }})
