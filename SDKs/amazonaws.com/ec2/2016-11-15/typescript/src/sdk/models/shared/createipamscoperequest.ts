 ...
 */
export enum CreateIpamScopeRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateIpamScopeRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateIpamScopeRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateIpamScopeRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateIpamScopeRequestTagSpecificationsTags })
  tags?: CreateIpamScopeRequestTagSpecificationsTags[];
}

export class CreateIpamScopeRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken?: string;
  ...
  @SpeakeasyMetadata({ elemType: CreateIpamScopeRequestTagSpecifications })
