...
exports.GetImagePerformancesResponse = exports.GetImagePerformancesRequest = exports.GetImagePerformancesOrderByEnum = void 0;
...
var GetImagePerformancesRequest = /** @class */ (function (_super) {
    ...
    ], GetImagePerformancesRequest.prototype, "trainingKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=iterationId",
        }),
        __metadata("design:type", String)
    ], GetImagePerformancesRequest.prototype, "iterationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=orderBy",
        }),
        __metadata("design:type", String)
    ], GetImagePerformancesRequest.prototype, "orderBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=projectId",
        }),
        __metadata("design:type", String)
    ], GetImagePerformancesRequest.prototype, "projectId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=skip" }),
        __metadata("design:type", Number)
    ], GetImagePerformancesRequest.prototype, "skip", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=tagIds",
        }),
        __metadata("design:type", Array)
    ], GetImagePerformancesRequest.prototype, "tagIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=take" }),
        __metadata("design:type", Number)
    ], GetImagePerformancesRequest.prototype, "take", void 0);
...
var GetImagePerformancesResponse = /** @class */ (function (_super) {
    ...
    ], GetImagePerformancesResponse.prototype, "rawResponse", void 0);
