...
func (e AdvancedShipmentOptionsBillToPartyEnum) ToPointer() *AdvancedShipmentOptionsBillToPartyEnum {
	return &e
}
...
func (e *AdvancedShipmentOptionsBillToPartyEnum) UnmarshalJSON(data []byte) error {
	...
	case "recipient":
		fallthrough
	case "third_party":
		*e = AdvancedShipmentOptionsBillToPartyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AdvancedShipmentOptionsBillToPartyEnum: %v", v)
	}
}
...
func (e AdvancedShipmentOptionsOriginTypeEnum) ToPointer() *AdvancedShipmentOptionsOriginTypeEnum {
	return &e
}
...
func (e *AdvancedShipmentOptionsOriginTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "pickup":
		fallthrough
	case "drop_off":
		*e = AdvancedShipmentOptionsOriginTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AdvancedShipmentOptionsOriginTypeEnum: %v", v)
	}
}
