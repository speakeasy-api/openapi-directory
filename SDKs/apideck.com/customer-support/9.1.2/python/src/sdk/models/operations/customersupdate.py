...
from ..shared import updatecustomersupportcustomerresponse as shared_updatecustomersupportcustomerresponse
...
class CustomersUpdateRequest:
    ...
    customer_support_customer_input: shared_customersupportcustomer.CustomerSupportCustomerInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class CustomersUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_customer_support_customer_response: Optional[shared_updatecustomersupportcustomerresponse.UpdateCustomerSupportCustomerResponse] = dataclasses.field(default=None)
