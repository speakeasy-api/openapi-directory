...
type GetSchedulesScheduleCQueryParams struct {
	...
	MaxIncurredDate  *time.Time `queryParam:"style=form,explode=true,name=max_incurred_date"`
	MaxPaymentToDate *int32     `queryParam:"style=form,explode=true,name=max_payment_to_date"`
	...
	MinIncurredDate  *time.Time `queryParam:"style=form,explode=true,name=min_incurred_date"`
	MinPaymentToDate *int32     `queryParam:"style=form,explode=true,name=min_payment_to_date"`
