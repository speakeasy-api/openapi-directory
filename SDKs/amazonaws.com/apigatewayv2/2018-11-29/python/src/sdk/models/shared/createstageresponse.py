...
class CreateStageResponseAccessLogSettings:
    r"""CreateStageResponseAccessLogSettings
...
class CreateStageResponseDefaultRouteSettings:
    r"""CreateStageResponseDefaultRouteSettings
...
class CreateStageResponse:
    access_log_settings: Optional[CreateStageResponseAccessLogSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('AccessLogSettings') }})
    ...
    default_route_settings: Optional[CreateStageResponseDefaultRouteSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DefaultRouteSettings') }})
