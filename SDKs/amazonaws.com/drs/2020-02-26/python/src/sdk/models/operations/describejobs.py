...
class DescribeJobsRequestBodyFilters:
    r"""A set of filters by which to return Jobs."""
    ...
    job_i_ds: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('jobIDs'), 'exclude': lambda f: f is None }})  
...
class DescribeJobsRequestBody:
    ...
    filters: Optional[DescribeJobsRequestBodyFilters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filters'), 'exclude': lambda f: f is None }})
    r"""A set of filters by which to return Jobs."""  
    max_results: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxResults'), 'exclude': lambda f: f is None }})
    r"""Maximum number of Jobs to retrieve."""  
    next_token: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('nextToken'), 'exclude': lambda f: f is None }})
    r"""The token of the next Job to retrieve."""  
    

@dataclasses.dataclass
class DescribeJobsRequest:
    
    request_body: DescribeJobsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
