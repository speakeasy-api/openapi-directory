...
var Uris = /** @class */ (function () {
    function Uris(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Uris.prototype.webriskUrisSearch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.WebriskUrisSearchRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/uris:search";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.googleCloudWebriskV1SearchUrisResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
