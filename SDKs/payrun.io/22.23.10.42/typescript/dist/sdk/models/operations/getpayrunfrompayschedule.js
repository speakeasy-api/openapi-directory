...
exports.GetPayRunFromPayScheduleResponse = exports.GetPayRunFromPayScheduleRequest = void 0;
...
var GetPayRunFromPayScheduleRequest = /** @class */ (function (_super) {
    ...
    ], GetPayRunFromPayScheduleRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetPayRunFromPayScheduleRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetPayRunFromPayScheduleRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayRunId",
        }),
        __metadata("design:type", String)
    ], GetPayRunFromPayScheduleRequest.prototype, "payRunId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayScheduleId",
        }),
        __metadata("design:type", String)
    ], GetPayRunFromPayScheduleRequest.prototype, "payScheduleId", void 0);
...
var GetPayRunFromPayScheduleResponse = /** @class */ (function (_super) {
    ...
    ], GetPayRunFromPayScheduleResponse.prototype, "rawResponse", void 0);
