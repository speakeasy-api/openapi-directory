...
class CloudbuildProjectsLocationsWorkerPoolsCreateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\WorkerPoolInput $workerPoolInput = null;
