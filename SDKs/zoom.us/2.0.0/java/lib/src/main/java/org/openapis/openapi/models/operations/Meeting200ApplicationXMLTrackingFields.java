...
public class Meeting200ApplicationXMLTrackingFields {
    /**
     * Label of the tracking field.
     */
    
    public String field;
    public Meeting200ApplicationXMLTrackingFields withField(String field) {
        this.field = field;
        return this;
    }
    ...
    public String value;
    public Meeting200ApplicationXMLTrackingFields withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public Meeting200ApplicationXMLTrackingFields withVisible(Boolean visible) {
