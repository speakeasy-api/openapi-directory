...
public class SecretScanning {
    ...
    public org.openapis.openapi.models.operations.SecretScanningListAlertsForEnterpriseResponse secretScanningListAlertsForEnterprise(org.openapis.openapi.models.operations.SecretScanningListAlertsForEnterpriseRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.SecretScanningListAlertsForEnterpriseResponse res = new org.openapis.openapi.models.operations.SecretScanningListAlertsForEnterpriseResponse(contentType, httpRes.statusCode()) {{
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.SecretScanningListAlertsForOrgResponse secretScanningListAlertsForOrg(org.openapis.openapi.models.operations.SecretScanningListAlertsForOrgRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.SecretScanningListAlertsForOrgRequest.class, baseUrl, "/orgs/{org}/secret-scanning/alerts", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.SecretScanningListAlertsForOrgRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.SecretScanningListAlertsForOrg503ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.SecretScanningListAlertsForOrg503ApplicationJSON.class);
