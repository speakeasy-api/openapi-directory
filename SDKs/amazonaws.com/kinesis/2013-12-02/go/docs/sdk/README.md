...
func main() {
    ...
    res, err := s.SDK.AddTagsToStream(ctx, operations.AddTagsToStreamRequest{
        AddTagsToStreamInput: shared.AddTagsToStreamInput{
            StreamARN: sdk.String("delectus"),
            StreamName: sdk.String("tempora"),
...
func main() {
    ...
    res, err := s.SDK.CreateStream(ctx, operations.CreateStreamRequest{
        CreateStreamInput: shared.CreateStreamInput{
            ShardCount: sdk.Int64(87129),
            StreamModeDetails: &shared.StreamModeDetails{
                StreamMode: shared.StreamModeEnumOnDemand,
            },
            StreamName: "perferendis",
        },
        ...
        XAmzTarget: operations.CreateStreamXAmzTargetEnumKinesis20131202CreateStream,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DecreaseStreamRetentionPeriod(ctx, operations.DecreaseStreamRetentionPeriodRequest{
        DecreaseStreamRetentionPeriodInput: shared.DecreaseStreamRetentionPeriodInput{
            RetentionPeriodHours: 978619,
            StreamARN: sdk.String("molestiae"),
            StreamName: sdk.String("quod"),
        },
        ...
        XAmzTarget: operations.DecreaseStreamRetentionPeriodXAmzTargetEnumKinesis20131202DecreaseStreamRetentionPeriod,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.DeleteStream(ctx, operations.DeleteStreamRequest{
        DeleteStreamInput: shared.DeleteStreamInput{
            EnforceConsumerDeletion: sdk.Bool(false),
            StreamARN: sdk.String("officia"),
            StreamName: sdk.String("occaecati"),
        },
        ...
        XAmzTarget: operations.DeleteStreamXAmzTargetEnumKinesis20131202DeleteStream,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DeregisterStreamConsumer(ctx, operations.DeregisterStreamConsumerRequest{
        DeregisterStreamConsumerInput: shared.DeregisterStreamConsumerInput{
            ConsumerARN: sdk.String("molestiae"),
            ConsumerName: sdk.String("modi"),
            StreamARN: sdk.String("qui"),
        },
        ...
        XAmzTarget: operations.DeregisterStreamConsumerXAmzTargetEnumKinesis20131202DeregisterStreamConsumer,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.DescribeLimits(ctx, operations.DescribeLimitsRequest{
        ...
        XAmzTarget: operations.DescribeLimitsXAmzTargetEnumKinesis20131202DescribeLimits,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.DescribeStream(ctx, operations.DescribeStreamRequest{
        DescribeStreamInput: shared.DescribeStreamInput{
            ExclusiveStartShardID: sdk.String("iste"),
            Limit: sdk.Int64(437032),
            StreamARN: sdk.String("saepe"),
            StreamName: sdk.String("quidem"),
        },
        ExclusiveStartShardID: sdk.String("architecto"),
        Limit: sdk.String("ipsa"),
        ...
        XAmzSignedHeaders: sdk.String("corporis"),
        XAmzTarget: operations.DescribeStreamXAmzTargetEnumKinesis20131202DescribeStream,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DescribeStreamConsumer(ctx, operations.DescribeStreamConsumerRequest{
        DescribeStreamConsumerInput: shared.DescribeStreamConsumerInput{
            ConsumerARN: sdk.String("explicabo"),
            ConsumerName: sdk.String("nobis"),
            StreamARN: sdk.String("enim"),
        },
        ...
        XAmzTarget: operations.DescribeStreamConsumerXAmzTargetEnumKinesis20131202DescribeStreamConsumer,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DescribeStreamConsumerOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DescribeStreamSummary(ctx, operations.DescribeStreamSummaryRequest{
        DescribeStreamSummaryInput: shared.DescribeStreamSummaryInput{
            StreamARN: sdk.String("doloribus"),
            StreamName: sdk.String("sapiente"),
        },
        ...
        XAmzTarget: operations.DescribeStreamSummaryXAmzTargetEnumKinesis20131202DescribeStreamSummary,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DescribeStreamSummaryOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DisableEnhancedMonitoring(ctx, operations.DisableEnhancedMonitoringRequest{
        DisableEnhancedMonitoringInput: shared.DisableEnhancedMonitoringInput{
            ShardLevelMetrics: []shared.MetricsNameEnum{
                shared.MetricsNameEnumOutgoingBytes,
                shared.MetricsNameEnumOutgoingRecords,
                shared.MetricsNameEnumOutgoingRecords,
            },
            StreamARN: sdk.String("molestiae"),
            StreamName: sdk.String("velit"),
        },
        ...
        XAmzTarget: operations.DisableEnhancedMonitoringXAmzTargetEnumKinesis20131202DisableEnhancedMonitoring,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.EnhancedMonitoringOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.EnableEnhancedMonitoring(ctx, operations.EnableEnhancedMonitoringRequest{
        EnableEnhancedMonitoringInput: shared.EnableEnhancedMonitoringInput{
            ShardLevelMetrics: []shared.MetricsNameEnum{
                shared.MetricsNameEnumIteratorAgeMilliseconds,
            },
            StreamARN: sdk.String("sequi"),
            StreamName: sdk.String("tenetur"),
        },
        XAmzAlgorithm: sdk.String("ipsam"),
        ...
        XAmzTarget: operations.EnableEnhancedMonitoringXAmzTargetEnumKinesis20131202EnableEnhancedMonitoring,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.GetRecords(ctx, operations.GetRecordsRequest{
        GetRecordsInput: shared.GetRecordsInput{
            Limit: sdk.Int64(673660),
            ShardIterator: "quasi",
        ...
        XAmzTarget: operations.GetRecordsXAmzTargetEnumKinesis20131202GetRecords,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.GetRecordsOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.GetShardIterator(ctx, operations.GetShardIteratorRequest{
        GetShardIteratorInput: shared.GetShardIteratorInput{
            ShardID: "voluptate",
            ShardIteratorType: shared.ShardIteratorTypeEnumLatest,
            StartingSequenceNumber: sdk.String("perferendis"),
            StreamARN: sdk.String("doloremque"),
            StreamName: sdk.String("reprehenderit"),
            Timestamp: types.MustTimeFromString("2022-01-08T10:49:12.847Z"),
        },
        ...
        XAmzSignedHeaders: sdk.String("enim"),
        XAmzTarget: operations.GetShardIteratorXAmzTargetEnumKinesis20131202GetShardIterator,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.GetShardIteratorOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.IncreaseStreamRetentionPeriod(ctx, operations.IncreaseStreamRetentionPeriodRequest{
        IncreaseStreamRetentionPeriodInput: shared.IncreaseStreamRetentionPeriodInput{
            RetentionPeriodHours: 880476,
            StreamARN: sdk.String("commodi"),
            StreamName: sdk.String("repudiandae"),
        },
        ...
        XAmzTarget: operations.IncreaseStreamRetentionPeriodXAmzTargetEnumKinesis20131202IncreaseStreamRetentionPeriod,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.ListShards(ctx, operations.ListShardsRequest{
        ListShardsInput: shared.ListShardsInput{
            ExclusiveStartShardID: sdk.String("praesentium"),
            MaxResults: sdk.Int64(523248),
            NextToken: sdk.String("voluptates"),
            ShardFilter: &shared.ShardFilter{
                ShardID: sdk.String("quasi"),
                Timestamp: types.MustTimeFromString("2021-04-10T08:07:33.561Z"),
                Type: shared.ShardFilterTypeEnumAfterShardID,
            },
            StreamARN: sdk.String("itaque"),
            StreamCreationTimestamp: types.MustTimeFromString("2022-09-06T17:20:08.756Z"),
            StreamName: sdk.String("consequatur"),
        },
        ...
        XAmzTarget: operations.ListShardsXAmzTargetEnumKinesis20131202ListShards,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.ListShardsOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.ListStreamConsumers(ctx, operations.ListStreamConsumersRequest{
        ListStreamConsumersInput: shared.ListStreamConsumersInput{
            MaxResults: sdk.Int64(264730),
            NextToken: sdk.String("qui"),
            StreamARN: "aliquid",
            StreamCreationTimestamp: types.MustTimeFromString("2021-11-23T10:34:02.904Z"),
        },
        ...
        XAmzTarget: operations.ListStreamConsumersXAmzTargetEnumKinesis20131202ListStreamConsumers,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.ListStreamConsumersOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.SDK.ListStreams(ctx, operations.ListStreamsRequest{
        ...
        ListStreamsInput: shared.ListStreamsInput{
            ExclusiveStartStreamName: sdk.String("tempore"),
            Limit: sdk.Int64(288476),
        ...
        XAmzTarget: operations.ListStreamsXAmzTargetEnumKinesis20131202ListStreams,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.ListTagsForStream(ctx, operations.ListTagsForStreamRequest{
        ListTagsForStreamInput: shared.ListTagsForStreamInput{
            ExclusiveStartTagKey: sdk.String("officia"),
            Limit: sdk.Int64(223081),
            StreamARN: sdk.String("debitis"),
            StreamName: sdk.String("a"),
        },
        ...
        XAmzTarget: operations.ListTagsForStreamXAmzTargetEnumKinesis20131202ListTagsForStream,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.MergeShards(ctx, operations.MergeShardsRequest{
        MergeShardsInput: shared.MergeShardsInput{
            AdjacentShardToMerge: "magnam",
            ShardToMerge: "cumque",
            StreamARN: sdk.String("facere"),
            StreamName: sdk.String("ea"),
        },
        ...
        XAmzTarget: operations.MergeShardsXAmzTargetEnumKinesis20131202MergeShards,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.PutRecord(ctx, operations.PutRecordRequest{
        PutRecordInput: shared.PutRecordInput{
            Data: "delectus",
            ExplicitHashKey: sdk.String("quidem"),
            PartitionKey: "provident",
            SequenceNumberForOrdering: sdk.String("nam"),
            StreamARN: sdk.String("id"),
            StreamName: sdk.String("blanditiis"),
        },
        ...
        XAmzTarget: operations.PutRecordXAmzTargetEnumKinesis20131202PutRecord,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.PutRecords(ctx, operations.PutRecordsRequest{
        PutRecordsInput: shared.PutRecordsInput{
            Records: []shared.PutRecordsRequestEntry{
                shared.PutRecordsRequestEntry{
                    Data: "molestiae",
                    ExplicitHashKey: sdk.String("perferendis"),
                    PartitionKey: "nihil",
                },
                shared.PutRecordsRequestEntry{
                    Data: "magnam",
                    ExplicitHashKey: sdk.String("distinctio"),
                    PartitionKey: "id",
                },
                shared.PutRecordsRequestEntry{
                    Data: "labore",
                    ExplicitHashKey: sdk.String("labore"),
                    PartitionKey: "suscipit",
                },
            },
            StreamARN: sdk.String("natus"),
            StreamName: sdk.String("nobis"),
        },
        ...
        XAmzTarget: operations.PutRecordsXAmzTargetEnumKinesis20131202PutRecords,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.PutRecordsOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.RegisterStreamConsumer(ctx, operations.RegisterStreamConsumerRequest{
        ...
        XAmzTarget: operations.RegisterStreamConsumerXAmzTargetEnumKinesis20131202RegisterStreamConsumer,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.RegisterStreamConsumerOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.RemoveTagsFromStream(ctx, operations.RemoveTagsFromStreamRequest{
        RemoveTagsFromStreamInput: shared.RemoveTagsFromStreamInput{
            StreamARN: sdk.String("eum"),
            StreamName: sdk.String("dolor"),
            TagKeys: []string{
                "odit",
                "nemo",
                "quasi",
        ...
        XAmzTarget: operations.RemoveTagsFromStreamXAmzTargetEnumKinesis20131202RemoveTagsFromStream,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.SplitShard(ctx, operations.SplitShardRequest{
        SplitShardInput: shared.SplitShardInput{
            NewStartingHashKey: "architecto",
            ShardToSplit: "architecto",
            StreamARN: sdk.String("repudiandae"),
            StreamName: sdk.String("ullam"),
        },
        ...
        XAmzTarget: operations.SplitShardXAmzTargetEnumKinesis20131202SplitShard,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.StartStreamEncryption(ctx, operations.StartStreamEncryptionRequest{
        StartStreamEncryptionInput: shared.StartStreamEncryptionInput{
            EncryptionType: shared.EncryptionTypeEnumNone,
            KeyID: "consequuntur",
            StreamARN: sdk.String("praesentium"),
            StreamName: sdk.String("natus"),
        },
        ...
        XAmzTarget: operations.StartStreamEncryptionXAmzTargetEnumKinesis20131202StartStreamEncryption,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.StopStreamEncryption(ctx, operations.StopStreamEncryptionRequest{
        StopStreamEncryptionInput: shared.StopStreamEncryptionInput{
            EncryptionType: shared.EncryptionTypeEnumKms,
            KeyID: "odit",
            StreamARN: sdk.String("ea"),
            StreamName: sdk.String("accusantium"),
        },
        ...
        XAmzSignedHeaders: sdk.String("nam"),
        XAmzTarget: operations.StopStreamEncryptionXAmzTargetEnumKinesis20131202StopStreamEncryption,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.UpdateShardCount(ctx, operations.UpdateShardCountRequest{
        UpdateShardCountInput: shared.UpdateShardCountInput{
            ScalingType: shared.ScalingTypeEnumUniformScaling,
            StreamARN: sdk.String("eaque"),
            StreamName: sdk.String("pariatur"),
            TargetShardCount: 365496,
        },
        XAmzAlgorithm: sdk.String("voluptatibus"),
        ...
        XAmzSignedHeaders: sdk.String("corporis"),
        XAmzTarget: operations.UpdateShardCountXAmzTargetEnumKinesis20131202UpdateShardCount,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.UpdateShardCountOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.UpdateStreamMode(ctx, operations.UpdateStreamModeRequest{
        ...
        XAmzSignedHeaders: sdk.String("quis"),
        XAmzTarget: operations.UpdateStreamModeXAmzTargetEnumKinesis20131202UpdateStreamMode,
    })
    if err != nil {
        log.Fatal(err)
    }
