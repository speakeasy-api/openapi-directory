...
public class GetKeywordPathParams {
    /**
    ...
    public GetKeywordPathParams withCampaignId(String campaignId) {
    ...
    public GetKeywordPathParams withKeywordId(String keywordId) {
