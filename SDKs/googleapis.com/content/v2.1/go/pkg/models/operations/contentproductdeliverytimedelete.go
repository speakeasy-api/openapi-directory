...
type ContentProductdeliverytimeDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentProductdeliverytimeDeletePathParams struct {
...
type ContentProductdeliverytimeDeleteQueryParams struct {
	// V1 error format.
...
type ContentProductdeliverytimeDeleteRequest struct {
...
type ContentProductdeliverytimeDeleteResponse struct {
	ContentType string
	StatusCode  int
