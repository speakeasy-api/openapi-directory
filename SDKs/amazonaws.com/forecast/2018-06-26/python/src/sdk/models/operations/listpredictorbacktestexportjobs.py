...
class ListPredictorBacktestExportJobsRequest:
    ...
    list_predictor_backtest_export_jobs_request: shared_listpredictorbacktestexportjobsrequest.ListPredictorBacktestExportJobsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
