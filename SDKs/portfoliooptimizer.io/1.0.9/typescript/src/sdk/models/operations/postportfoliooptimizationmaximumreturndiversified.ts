...
export class PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class PostPortfolioOptimizationMaximumReturnDiversifiedRequestBody extends SpeakeasyBase {
  /**
  ...
  @Type(
    () =>
      PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints
  )
 ...
 * OK
 */
export class PostPortfolioOptimizationMaximumReturnDiversified200ApplicationJSON extends SpeakeasyBase {
  /**
...
export class PostPortfolioOptimizationMaximumReturnDiversifiedResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
