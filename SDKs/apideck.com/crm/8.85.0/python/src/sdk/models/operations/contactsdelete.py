...
class ContactsDeleteRequest:
    headers: ContactsDeleteHeaders = dataclasses.field()
    path_params: ContactsDeletePathParams = dataclasses.field()
    query_params: ContactsDeleteQueryParams = dataclasses.field()
    security: ContactsDeleteSecurity = dataclasses.field()
