...
export class VmmigrationProjectsLocationsSourcesDatacenterConnectorsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsSourcesDatacenterConnectorsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsSourcesDatacenterConnectorsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
