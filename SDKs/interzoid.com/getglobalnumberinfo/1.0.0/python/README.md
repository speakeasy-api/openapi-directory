...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/interzoid.com/getglobalnumberinfo/1.0.0/python
```
...
### global_phone_number_information
