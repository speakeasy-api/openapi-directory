...
class AdsensehostReportsGenerateQueryParams:
...
class AdsensehostReportsGenerateRequest:
    query_params: AdsensehostReportsGenerateQueryParams = dataclasses.field()
    security: AdsensehostReportsGenerateSecurity = dataclasses.field()
