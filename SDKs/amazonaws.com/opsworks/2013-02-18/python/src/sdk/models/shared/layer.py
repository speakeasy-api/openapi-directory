...
class Layer:
    ...
    default_recipes: Optional[shared_recipes.Recipes] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DefaultRecipes') }})
    default_security_group_names: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DefaultSecurityGroupNames') }})
    ...
    type: Optional[shared_layertype_enum.LayerTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Type') }})
