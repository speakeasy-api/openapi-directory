...
class VaultMattersExportsDeleteRequest:
    path_params: VaultMattersExportsDeletePathParams = dataclasses.field()
    query_params: VaultMattersExportsDeleteQueryParams = dataclasses.field()
    security: VaultMattersExportsDeleteSecurity = dataclasses.field()
