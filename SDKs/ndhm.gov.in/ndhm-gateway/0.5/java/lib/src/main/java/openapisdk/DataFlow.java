...
public class DataFlow {
     ...
     * 
    **/
    public openapisdk.models.operations.PostV05HealthInformationCmOnRequestResponse postV05HealthInformationCmOnRequest(openapisdk.models.operations.PostV05HealthInformationCmOnRequestRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v0.5/health-information/cm/on-request");
        ...
        openapisdk.models.operations.PostV05HealthInformationCmOnRequestResponse res = new openapisdk.models.operations.PostV05HealthInformationCmOnRequestResponse() {{
            errorResponse = null;
            body = null;
            errorResponse = null;
            body = null;
