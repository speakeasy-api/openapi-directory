...
@dataclasses.dataclass
class IdsProjectsLocationsOperationsDeleteQueryParams:
...
class IdsProjectsLocationsOperationsDeleteRequest:
    path_params: IdsProjectsLocationsOperationsDeletePathParams = dataclasses.field()
    query_params: IdsProjectsLocationsOperationsDeleteQueryParams = dataclasses.field()
    security: IdsProjectsLocationsOperationsDeleteSecurity = dataclasses.field()
