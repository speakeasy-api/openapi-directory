...
class StorageDefaultObjectAccessControlsUpdateSecurity:
    option1: Optional[StorageDefaultObjectAccessControlsUpdateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageDefaultObjectAccessControlsUpdateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class StorageDefaultObjectAccessControlsUpdateRequest:
    path_params: StorageDefaultObjectAccessControlsUpdatePathParams = dataclasses.field()
    query_params: StorageDefaultObjectAccessControlsUpdateQueryParams = dataclasses.field()
    security: StorageDefaultObjectAccessControlsUpdateSecurity = dataclasses.field()
