...
class FinalizeDeviceClaimRequest:
    headers: FinalizeDeviceClaimHeaders = dataclasses.field()
    path_params: FinalizeDeviceClaimPathParams = dataclasses.field()
    request: FinalizeDeviceClaimRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
