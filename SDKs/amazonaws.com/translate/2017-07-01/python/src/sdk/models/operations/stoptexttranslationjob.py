...
class StopTextTranslationJobRequest:
    ...
    stop_text_translation_job_request: shared_stoptexttranslationjobrequest.StopTextTranslationJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
