...
class UserCipherUses:
    ...
    def get_user_cipher_uses(self, request: operations.GetUserCipherUsesRequest) -> operations.GetUserCipherUsesResponse:
        ...
        query_params = utils.get_query_params(operations.GetUserCipherUsesRequest, request)
        ...
        res = operations.GetUserCipherUsesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
