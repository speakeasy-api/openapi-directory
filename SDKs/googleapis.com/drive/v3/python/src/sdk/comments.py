...
class Comments:
    ...
    def drive_comments_create(self, request: operations.DriveCommentsCreateRequest) -> operations.DriveCommentsCreateResponse:
        r"""Creates a new comment on a file.
        """
        ...
        res = operations.DriveCommentsCreateResponse(status_code=r.status_code, content_type=content_type)
