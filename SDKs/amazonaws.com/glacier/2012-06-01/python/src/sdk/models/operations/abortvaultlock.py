...
class AbortVaultLockRequest:
    headers: AbortVaultLockHeaders = dataclasses.field()
    path_params: AbortVaultLockPathParams = dataclasses.field()
