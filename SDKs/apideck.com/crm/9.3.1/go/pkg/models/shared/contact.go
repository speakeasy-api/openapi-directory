...
func (e ContactGenderEnum) ToPointer() *ContactGenderEnum {
	return &e
}

func (e *ContactGenderEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "female":
		fallthrough
	case "unisex":
		*e = ContactGenderEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ContactGenderEnum: %v", v)
	}
}
