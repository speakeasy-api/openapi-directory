...
export class Projects {
  ...
  **/
  websecurityscannerProjectsScanConfigsCreate(
    ...
    const url: string = utils.generateURL(baseURL, "/v1alpha/{parent}/scanConfigs", req.pathParams);
  ...
  **/
  websecurityscannerProjectsScanConfigsScanRunsCrawledUrlsList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1alpha/{parent}/crawledUrls", req.pathParams);
  ...
  **/
  websecurityscannerProjectsScanConfigsScanRunsFindingTypeStatsList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1alpha/{parent}/findingTypeStats", req.pathParams);
  ...
  **/
  websecurityscannerProjectsScanConfigsScanRunsFindingsList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1alpha/{parent}/findings", req.pathParams);
  ...
  **/
  websecurityscannerProjectsScanConfigsScanRunsList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1alpha/{parent}/scanRuns", req.pathParams);
  ...
  **/
  websecurityscannerProjectsScanConfigsScanRunsStop(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1alpha/{name}:stop", req.pathParams);
  ...
  **/
  websecurityscannerProjectsScanConfigsStart(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1alpha/{name}:start", req.pathParams);
