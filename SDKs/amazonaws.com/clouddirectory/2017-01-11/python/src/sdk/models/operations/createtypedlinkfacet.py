...
class CreateTypedLinkFacetRequestBodyFacet:
    r"""Defines the typed links structure and its attributes. To create a typed link facet, use the <a>CreateTypedLinkFacet</a> API."""
    ...
    identity_attribute_order: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('IdentityAttributeOrder'), 'exclude': lambda f: f is None }})  
...
class CreateTypedLinkFacetRequestBody:
    ...
    facet: CreateTypedLinkFacetRequestBodyFacet = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Facet') }})
    r"""Defines the typed links structure and its attributes. To create a typed link facet, use the <a>CreateTypedLinkFacet</a> API."""  
...
class CreateTypedLinkFacetRequest:
    ...
    request_body: CreateTypedLinkFacetRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
