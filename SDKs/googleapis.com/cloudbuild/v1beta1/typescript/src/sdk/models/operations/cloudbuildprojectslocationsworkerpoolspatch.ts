...
export class CloudbuildProjectsLocationsWorkerPoolsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudbuildProjectsLocationsWorkerPoolsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudbuildProjectsLocationsWorkerPoolsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
