 ...
 */
export enum CreateSnapshotsRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateSnapshotsRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateSnapshotsRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateSnapshotsRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateSnapshotsRequestTagSpecificationsTags })
  tags?: CreateSnapshotsRequestTagSpecificationsTags[];
}

export class CreateSnapshotsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: CreateSnapshotsRequestTagSpecifications })
