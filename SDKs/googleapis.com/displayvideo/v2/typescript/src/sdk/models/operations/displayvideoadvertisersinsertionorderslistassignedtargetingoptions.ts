...
export class DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
