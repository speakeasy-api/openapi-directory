...
public class GetAssessmentFrameworkResponse {
    ...
    public org.openapis.openapi.models.shared.GetAssessmentFrameworkResponse getAssessmentFrameworkResponse;

    public GetAssessmentFrameworkResponse withGetAssessmentFrameworkResponse(org.openapis.openapi.models.shared.GetAssessmentFrameworkResponse getAssessmentFrameworkResponse) {
    ...
    public GetAssessmentFrameworkResponse withStatusCode(Integer statusCode) {
    ...
    public GetAssessmentFrameworkResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public GetAssessmentFrameworkResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
