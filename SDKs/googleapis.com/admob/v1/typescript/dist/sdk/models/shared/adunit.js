...
var AdUnit = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=adFormat" }),
        __metadata("design:type", String)
    ], AdUnit.prototype, "adFormat", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=adTypes" }),
        __metadata("design:type", Array)
    ], AdUnit.prototype, "adTypes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=adUnitId" }),
        __metadata("design:type", String)
