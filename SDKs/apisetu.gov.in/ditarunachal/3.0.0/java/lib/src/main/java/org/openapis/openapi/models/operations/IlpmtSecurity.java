...
public class IlpmtSecurity {
    ...
    public IlpmtSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public IlpmtSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public IlpmtSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
