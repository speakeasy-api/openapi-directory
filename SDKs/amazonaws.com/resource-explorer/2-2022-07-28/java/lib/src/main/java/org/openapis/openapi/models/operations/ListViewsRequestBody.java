...
public class ListViewsRequestBody {
    /**
    ...
    public ListViewsRequestBody withMaxResults(Long maxResults) {
    ...
    public ListViewsRequestBody withNextToken(String nextToken) {
        this.nextToken = nextToken;
        return this;
    }
    
    public ListViewsRequestBody(){}
}
