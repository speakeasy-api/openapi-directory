...
public class OndemandscanningProjectsLocationsScansAnalyzePackagesRequest {
    ...
    public openapisdk.models.shared.AnalyzePackagesRequest request;
    public OndemandscanningProjectsLocationsScansAnalyzePackagesRequest withRequest(openapisdk.models.shared.AnalyzePackagesRequest request) {
