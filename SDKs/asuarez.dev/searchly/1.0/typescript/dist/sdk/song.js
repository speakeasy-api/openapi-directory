...
var Song = /** @class */ (function () {
    ...
    Song.prototype.srcSearchlyApiV1ControllersSongSearch = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.SrcSearchlyApiV1ControllersSongSearchResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.apiResponseSong = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.APIResponseSong);
                    }
                    break;
                default:
