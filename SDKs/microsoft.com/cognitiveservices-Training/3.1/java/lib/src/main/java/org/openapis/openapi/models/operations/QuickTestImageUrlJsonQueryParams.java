...
public class QuickTestImageUrlJsonQueryParams {
    /**
    ...
    public QuickTestImageUrlJsonQueryParams withIterationId(String iterationId) {
    ...
    public QuickTestImageUrlJsonQueryParams withStore(Boolean store) {
        this.store = store;
        return this;
    }
