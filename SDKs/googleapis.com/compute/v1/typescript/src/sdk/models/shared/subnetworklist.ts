 ...
 */
export enum SubnetworkListWarningCodeEnum {
...
export class SubnetworkListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SubnetworkListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: SubnetworkListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class SubnetworkList extends SpeakeasyBase {
  /**
