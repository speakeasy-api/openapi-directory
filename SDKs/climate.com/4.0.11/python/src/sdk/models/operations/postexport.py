...
from ..shared import createdexport as shared_createdexport
from ..shared import error as shared_error
from typing import Optional


@dataclasses.dataclass
class PostExportSecurity:
...
class PostExportResponse:
    ...
    created_export: Optional[shared_createdexport.CreatedExport] = dataclasses.field(default=None)
    r"""OK"""  
