...
class GetUsersIdsPathParams:
    ids: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ids', 'style': 'simple', 'explode': False }})
    
class GetUsersIdsOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetUsersIdsSortEnum(str, Enum):
...
class GetUsersIdsQueryParams:
    ...
    order: Optional[GetUsersIdsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetUsersIdsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetUsersIdsRequest:
    path_params: GetUsersIdsPathParams = dataclasses.field()
    query_params: GetUsersIdsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetUsersIdsResponse:
