 ...
 */
export enum AcceleratorTypeListWarningCodeEnum {
...
export class AcceleratorTypeListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class AcceleratorTypeListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: AcceleratorTypeListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: AcceleratorTypeListWarningData })
  @Expose({ name: "data" })
  @Type(() => AcceleratorTypeListWarningData)
  data?: AcceleratorTypeListWarningData[];
 ...
 */
export class AcceleratorTypeList extends SpeakeasyBase {
  /**
