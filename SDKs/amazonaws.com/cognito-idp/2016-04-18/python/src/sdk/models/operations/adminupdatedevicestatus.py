...
class AdminUpdateDeviceStatusRequest:
    ...
    admin_update_device_status_request: shared_adminupdatedevicestatusrequest.AdminUpdateDeviceStatusRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
