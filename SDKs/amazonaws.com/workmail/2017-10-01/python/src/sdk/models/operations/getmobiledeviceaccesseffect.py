...
class GetMobileDeviceAccessEffectRequest:
    ...
    get_mobile_device_access_effect_request: shared_getmobiledeviceaccesseffectrequest.GetMobileDeviceAccessEffectRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
