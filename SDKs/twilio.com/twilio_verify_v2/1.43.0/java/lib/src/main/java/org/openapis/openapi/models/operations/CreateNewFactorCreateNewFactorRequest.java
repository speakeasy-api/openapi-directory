...
public class CreateNewFactorCreateNewFactorRequest {
    ...
    public CreateNewFactorCreateNewFactorRequest(@JsonProperty("FactorType") org.openapis.openapi.models.shared.NewFactorEnumFactorTypesEnum factorType, @JsonProperty("FriendlyName") String friendlyName) {
        this.factorType = factorType;
        this.friendlyName = friendlyName;
  }
}
