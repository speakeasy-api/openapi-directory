...
public class AwsKinesisRuleResponse {
    ...
    public AwsKinesisRuleResponse withRequestMode(String requestMode) {
    ...
    public AwsKinesisRuleResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public AwsKinesisRuleResponse(@JsonProperty("requestMode") String requestMode, @JsonProperty("ruleType") AwsKinesisRuleResponseRuleTypeEnum ruleType, @JsonProperty("source") RuleSource source, @JsonProperty("target") AwsKinesisRuleResponseTarget target) {
        this.requestMode = requestMode;
        this.ruleType = ruleType;
        this.source = source;
        this.target = target;
