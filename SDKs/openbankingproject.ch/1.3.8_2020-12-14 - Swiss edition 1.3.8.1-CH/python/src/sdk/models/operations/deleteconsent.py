...
@dataclasses.dataclass
class DeleteConsentRequest:
    headers: DeleteConsentHeaders = dataclasses.field()
    path_params: DeleteConsentPathParams = dataclasses.field()
    security: DeleteConsentSecurity = dataclasses.field()
    

@dataclasses.dataclass
class DeleteConsentResponse:
