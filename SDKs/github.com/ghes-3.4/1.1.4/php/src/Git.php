...
class Git 
{
     ...
     * Create a blob
     * 
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-blob - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-blob
     */
     ...
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-commit - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-commit
     */
     ...
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-reference - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-reference
     */
     ...
     * | `invalid` | The signature could not be cryptographically verified using the key whose key-id was found in the signature. |
     * | `valid` | None of the above errors applied, so the signature is considered to be verified. |
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-tag-object - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-tag-object
     */
     ...
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-tree - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-tree
     */
     ...
     * Delete a reference
     * 
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#delete-a-reference - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#delete-a-reference
     */
     ...
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-blob - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-blob
     */
     ...
     * | `invalid` | The signature could not be cryptographically verified using the key whose key-id was found in the signature. |
     * | `valid` | None of the above errors applied, so the signature is considered to be verified. |
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-commit - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-commit
     */
     ...
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-reference - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-reference
     */
     ...
     * | `invalid` | The signature could not be cryptographically verified using the key whose key-id was found in the signature. |
     * | `valid` | None of the above errors applied, so the signature is considered to be verified. |
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-tag - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-tag
     */
     ...
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-tree - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-tree
     */
     ...
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#list-matching-references - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#list-matching-references
     */
     ...
     * Update a reference
     * 
     * https://docs.github.com/enterprise-server@3.4/rest/reference/git#update-a-reference - API method documentation
     * 
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/git#update-a-reference
     */
