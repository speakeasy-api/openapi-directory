...
export class CommitteeHistoryJfcCommittee extends SpeakeasyBase {
  /**
   *
   * @remarks
...
export class CommitteeHistory extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: CommitteeHistoryJfcCommittee })
  @Expose({ name: "jfc_committee" })
  @Type(() => CommitteeHistoryJfcCommittee)
