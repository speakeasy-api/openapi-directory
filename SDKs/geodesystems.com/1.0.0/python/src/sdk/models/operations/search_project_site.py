...
class SearchProjectSiteQueryParams:
    ...
    search_project_site_country: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_site.country', 'style': 'form', 'explode': True }})
    search_project_site_county: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_site.county', 'style': 'form', 'explode': True }})
    search_project_site_network: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_site.network', 'style': 'form', 'explode': True }})
    search_project_site_short_name: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_site.short_name', 'style': 'form', 'explode': True }})
    search_project_site_site_type: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_site.site_type', 'style': 'form', 'explode': True }})
    search_project_site_state: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_site.state', 'style': 'form', 'explode': True }})
    search_project_site_status: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_site.status', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchProjectSiteRequest:
    query_params: SearchProjectSiteQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectSiteResponse:
