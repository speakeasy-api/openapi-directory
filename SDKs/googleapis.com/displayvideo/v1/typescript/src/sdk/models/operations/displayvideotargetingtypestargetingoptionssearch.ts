...
export class DisplayvideoTargetingTypesTargetingOptionsSearchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum DisplayvideoTargetingTypesTargetingOptionsSearchTargetingTypeEnum {
...
export class DisplayvideoTargetingTypesTargetingOptionsSearchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
  ...
  targetingType: DisplayvideoTargetingTypesTargetingOptionsSearchTargetingTypeEnum;
...
export class DisplayvideoTargetingTypesTargetingOptionsSearchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
