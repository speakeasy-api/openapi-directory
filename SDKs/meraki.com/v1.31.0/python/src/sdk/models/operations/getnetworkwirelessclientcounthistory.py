...
class GetNetworkWirelessClientCountHistoryRequest:
    ...
    r"""Filter results by network client to return per-device client counts over time inner joined by the queried client's connection history."""  
...
class GetNetworkWirelessClientCountHistoryResponse:
    ...
    get_network_wireless_client_count_history_200_application_json_objects: Optional[list[GetNetworkWirelessClientCountHistory200ApplicationJSON]] = dataclasses.field(default=None)
