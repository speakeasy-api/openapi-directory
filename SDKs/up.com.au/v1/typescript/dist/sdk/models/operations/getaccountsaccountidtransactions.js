...
exports.GetAccountsAccountIdTransactionsResponse = exports.GetAccountsAccountIdTransactionsRequest = exports.GetAccountsAccountIdTransactionsQueryParams = exports.GetAccountsAccountIdTransactionsPathParams = void 0;
...
exports.GetAccountsAccountIdTransactionsPathParams = GetAccountsAccountIdTransactionsPathParams;
var GetAccountsAccountIdTransactionsQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=filter[category]" }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdTransactionsQueryParams.prototype, "filterCategory", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=filter[since]" }),
        __metadata("design:type", Date)
    ], GetAccountsAccountIdTransactionsQueryParams.prototype, "filterSince", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=filter[status]" }),
        __metadata("design:type", Object)
    ], GetAccountsAccountIdTransactionsQueryParams.prototype, "filterStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=filter[tag]" }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdTransactionsQueryParams.prototype, "filterTag", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=filter[until]" }),
        __metadata("design:type", Date)
...
exports.GetAccountsAccountIdTransactionsQueryParams = GetAccountsAccountIdTransactionsQueryParams;
...
exports.GetAccountsAccountIdTransactionsRequest = GetAccountsAccountIdTransactionsRequest;
...
exports.GetAccountsAccountIdTransactionsResponse = GetAccountsAccountIdTransactionsResponse;
