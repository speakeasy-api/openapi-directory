...
class CreateLoadBalancerTLSCertificateRequest:
    ...
    create_load_balancer_tls_certificate_request: shared_createloadbalancertlscertificaterequest.CreateLoadBalancerTLSCertificateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
