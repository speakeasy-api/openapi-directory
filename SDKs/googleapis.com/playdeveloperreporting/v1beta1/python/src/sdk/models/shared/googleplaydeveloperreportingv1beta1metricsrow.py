...
class GooglePlayDeveloperReportingV1beta1MetricsRow:
    ...
    aggregation_period: Optional[GooglePlayDeveloperReportingV1beta1MetricsRowAggregationPeriodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('aggregationPeriod'), 'exclude': lambda f: f is None }})
    r"""Granularity of the aggregation period of the row."""  
    ...
    metrics: Optional[list[shared_googleplaydeveloperreportingv1beta1metricvalue.GooglePlayDeveloperReportingV1beta1MetricValue]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metrics'), 'exclude': lambda f: f is None }})
