...
class GetComplianceDetailRequest:
    ...
    get_compliance_detail_request: shared_getcompliancedetailrequest.GetComplianceDetailRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
