...
from ..shared import getreadsetexportjobresponse as shared_getreadsetexportjobresponse
...
class GetReadSetExportJobResponse:
    ...
    get_read_set_export_job_response: Optional[shared_getreadsetexportjobresponse.GetReadSetExportJobResponse] = dataclasses.field(default=None)
    r"""Success"""  
