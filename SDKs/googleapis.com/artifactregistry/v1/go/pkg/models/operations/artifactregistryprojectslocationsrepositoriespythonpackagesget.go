...
func (e *ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetViewEnum) UnmarshalJSON(data []byte) error {
	...
	case "BASIC":
		fallthrough
	case "FULL":
		*e = ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetViewEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetViewEnum: %s", s)
	}
}
