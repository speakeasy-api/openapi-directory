...
class AndroiddeviceprovisioningCustomersConfigurationsPatchRequest:
    path_params: AndroiddeviceprovisioningCustomersConfigurationsPatchPathParams = dataclasses.field()
    query_params: AndroiddeviceprovisioningCustomersConfigurationsPatchQueryParams = dataclasses.field()
