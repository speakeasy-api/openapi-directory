...
class UpsertAccount401ApplicationJSON
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\UpsertAccount401ApplicationJSONMeta')]
    public UpsertAccount401ApplicationJSONMeta $meta;
    
	public function __construct()
	{
		$this->message = "";
		$this->meta = new \OpenAPI\OpenAPI\Models\Operations\UpsertAccount401ApplicationJSONMeta();
	}
}
