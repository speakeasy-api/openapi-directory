...
public class AnalyticsadminPropertiesAccessBindingsBatchDeletePathParams {
    /**
    ...
    public AnalyticsadminPropertiesAccessBindingsBatchDeletePathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
