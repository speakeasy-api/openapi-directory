...
class DeleteSipAuthCallsIPAccessControlListMappingRequest:
    path_params: DeleteSipAuthCallsIPAccessControlListMappingPathParams = dataclasses.field()
    security: DeleteSipAuthCallsIPAccessControlListMappingSecurity = dataclasses.field()
