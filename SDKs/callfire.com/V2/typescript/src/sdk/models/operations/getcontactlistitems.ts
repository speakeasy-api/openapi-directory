...
export class GetContactListItemsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetContactListItemsRequest extends SpeakeasyBase {
  /**
...
export class GetContactListItemsResponse extends SpeakeasyBase {
  /**
