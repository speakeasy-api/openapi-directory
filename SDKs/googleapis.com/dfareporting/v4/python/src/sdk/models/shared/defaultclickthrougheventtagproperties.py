...
class DefaultClickThroughEventTagProperties:
    ...
    override_inherited_event_tag: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('overrideInheritedEventTag') }})
