...
var organizationinfo_2 = require("./organizationinfo");
...
var Account = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=primaryOwner" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=verificationState" }),
        __metadata("design:type", String)
    ], Account.prototype, "verificationState", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=vettedState" }),
        __metadata("design:type", String)
...
var AccountInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=organizationInfo" }),
        __metadata("design:type", organizationinfo_2.OrganizationInfoInput)
