...
class CreateTransitVirtualInterfaceRequest:
    ...
    create_transit_virtual_interface_request: shared_createtransitvirtualinterfacerequest.CreateTransitVirtualInterfaceRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
