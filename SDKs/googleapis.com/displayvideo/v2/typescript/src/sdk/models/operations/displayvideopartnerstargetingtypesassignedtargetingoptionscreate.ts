...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateTargetingTypeEnum {
...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
  ...
  targetingType: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateTargetingTypeEnum;
...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
