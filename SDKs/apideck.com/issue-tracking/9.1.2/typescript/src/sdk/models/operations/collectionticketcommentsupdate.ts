...
export class CollectionTicketCommentsUpdateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CollectionTicketCommentsUpdateRequest extends SpeakeasyBase {
...
export class CollectionTicketCommentsUpdateResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
