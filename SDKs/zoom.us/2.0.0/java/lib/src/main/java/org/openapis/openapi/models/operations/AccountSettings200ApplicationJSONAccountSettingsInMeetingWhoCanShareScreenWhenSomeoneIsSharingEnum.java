 ...
 * 
 */
public enum AccountSettings200ApplicationJSONAccountSettingsInMeetingWhoCanShareScreenWhenSomeoneIsSharingEnum {
    HOST("host"),
    ALL("all");
    ...
    private AccountSettings200ApplicationJSONAccountSettingsInMeetingWhoCanShareScreenWhenSomeoneIsSharingEnum(String value) {
        this.value = value;
    }
}
