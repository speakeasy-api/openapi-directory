...
public class WorkTypeApiDetailsHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public WorkTypeApiDetailsHeaders withXAuthKey(String xAuthKey) {
    ...
    public WorkTypeApiDetailsHeaders withXAuthSecret(String xAuthSecret) {
