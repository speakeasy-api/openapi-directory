 ...
 */
public enum CreatePlacementGroupRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreatePlacementGroupRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
