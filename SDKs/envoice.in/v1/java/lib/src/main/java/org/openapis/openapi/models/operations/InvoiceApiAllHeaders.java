...
public class InvoiceApiAllHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiAllHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiAllHeaders withXAuthSecret(String xAuthSecret) {
