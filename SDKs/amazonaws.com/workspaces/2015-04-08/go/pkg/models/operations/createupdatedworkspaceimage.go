...
type CreateUpdatedWorkspaceImageHeaders struct {
...
type CreateUpdatedWorkspaceImageRequest struct {
	Headers CreateUpdatedWorkspaceImageHeaders
	Request shared.CreateUpdatedWorkspaceImageRequest `request:"mediaType=application/json"`
}
