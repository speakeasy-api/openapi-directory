...
export enum DeleteNotebookInstanceLifecycleConfigXAmzTargetEnum {
  SageMakerDeleteNotebookInstanceLifecycleConfig = "SageMaker.DeleteNotebookInstanceLifecycleConfig",
}

export class DeleteNotebookInstanceLifecycleConfigRequest extends SpeakeasyBase {
...
export class DeleteNotebookInstanceLifecycleConfigResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
