...
public class GetVolumesFsJsonHeaders {
    /**
    ...
    public GetVolumesFsJsonHeaders withXAuthProjectId(String xAuthProjectId) {
    ...
    public GetVolumesFsJsonHeaders withXAuthToken(String xAuthToken) {
