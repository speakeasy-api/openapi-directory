...
type BatchDetectTargetedSentimentHeaders struct {
...
type BatchDetectTargetedSentimentRequest struct {
	Headers BatchDetectTargetedSentimentHeaders
	Request shared.BatchDetectTargetedSentimentRequest `request:"mediaType=application/json"`
}
