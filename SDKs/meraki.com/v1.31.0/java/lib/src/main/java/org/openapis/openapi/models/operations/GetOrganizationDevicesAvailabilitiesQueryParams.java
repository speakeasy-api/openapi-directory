...
public class GetOrganizationDevicesAvailabilitiesQueryParams {
    /**
     * A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=endingBefore")
    public String endingBefore;
    public GetOrganizationDevicesAvailabilitiesQueryParams withEndingBefore(String endingBefore) {
    ...
    public GetOrganizationDevicesAvailabilitiesQueryParams withNetworkIds(String[] networkIds) {
    ...
    public Long perPage;
    public GetOrganizationDevicesAvailabilitiesQueryParams withPerPage(Long perPage) {
    ...
    public GetOrganizationDevicesAvailabilitiesQueryParams withProductTypes(String[] productTypes) {
    ...
    public GetOrganizationDevicesAvailabilitiesQueryParams withSerials(String[] serials) {
    ...
    public GetOrganizationDevicesAvailabilitiesQueryParams withStartingAfter(String startingAfter) {
    ...
    public String[] tags;
    public GetOrganizationDevicesAvailabilitiesQueryParams withTags(String[] tags) {
        this.tags = tags;
        return this;
    }
    ...
    public GetOrganizationDevicesAvailabilitiesQueryParams withTagsFilterType(GetOrganizationDevicesAvailabilitiesTagsFilterTypeEnum tagsFilterType) {
