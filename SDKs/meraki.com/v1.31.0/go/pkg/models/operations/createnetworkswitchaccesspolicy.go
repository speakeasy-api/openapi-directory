...
func (e *CreateNetworkSwitchAccessPolicyRequestBodyAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "MAC authentication bypass":
		*e = CreateNetworkSwitchAccessPolicyRequestBodyAccessPolicyTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkSwitchAccessPolicyRequestBodyAccessPolicyTypeEnum: %s", s)
	}
}
...
func (e *CreateNetworkSwitchAccessPolicyRequestBodyDot1xControlDirectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "both":
		fallthrough
	case "inbound":
		*e = CreateNetworkSwitchAccessPolicyRequestBodyDot1xControlDirectionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkSwitchAccessPolicyRequestBodyDot1xControlDirectionEnum: %s", s)
	}
}
...
func (e *CreateNetworkSwitchAccessPolicyRequestBodyHostModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Multi-Host":
		fallthrough
	case "Single-Host":
		*e = CreateNetworkSwitchAccessPolicyRequestBodyHostModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkSwitchAccessPolicyRequestBodyHostModeEnum: %s", s)
	}
}
...
func (e *CreateNetworkSwitchAccessPolicy201ApplicationJSONAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Hybrid authentication":
		fallthrough
	case "MAC authentication bypass":
		*e = CreateNetworkSwitchAccessPolicy201ApplicationJSONAccessPolicyTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkSwitchAccessPolicy201ApplicationJSONAccessPolicyTypeEnum: %s", s)
	}
}
...
func (e *CreateNetworkSwitchAccessPolicy201ApplicationJSONDot1xControlDirectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "both":
		fallthrough
	case "inbound":
		*e = CreateNetworkSwitchAccessPolicy201ApplicationJSONDot1xControlDirectionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkSwitchAccessPolicy201ApplicationJSONDot1xControlDirectionEnum: %s", s)
	}
}
...
func (e *CreateNetworkSwitchAccessPolicy201ApplicationJSONHostModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Multi-Host":
		fallthrough
	case "Single-Host":
		*e = CreateNetworkSwitchAccessPolicy201ApplicationJSONHostModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkSwitchAccessPolicy201ApplicationJSONHostModeEnum: %s", s)
	}
}
