...
export class EffectiveTags {
  ...
  cloudresourcemanagerEffectiveTagsList(
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.CloudresourcemanagerEffectiveTagsListSecurity(
        security
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CloudresourcemanagerEffectiveTagsListResponse =
        new operations.CloudresourcemanagerEffectiveTagsListResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listEffectiveTagsResponse = utils.objectToClass(
              httpRes?.data,
              shared.ListEffectiveTagsResponse
            );
          }
          break;
      }
