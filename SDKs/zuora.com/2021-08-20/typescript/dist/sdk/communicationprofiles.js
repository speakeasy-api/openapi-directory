...
var CommunicationProfiles = /** @class */ (function () {
    ...
    CommunicationProfiles.prototype.objectGETCommunicationProfile = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/object/communication-profile/{id}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.ObjectGETCommunicationProfileResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.proxyGetCommunicationProfile = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ProxyGetCommunicationProfile);
                    }
                    break;
