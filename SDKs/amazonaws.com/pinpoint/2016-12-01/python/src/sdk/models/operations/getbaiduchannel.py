...
from ..shared import getbaiduchannelresponse as shared_getbaiduchannelresponse
...
class GetBaiduChannelRequest:
    headers: GetBaiduChannelHeaders = dataclasses.field()
    path_params: GetBaiduChannelPathParams = dataclasses.field()
...
class GetBaiduChannelResponse:
    ...
    get_baidu_channel_response: Optional[shared_getbaiduchannelresponse.GetBaiduChannelResponse] = dataclasses.field(default=None)
