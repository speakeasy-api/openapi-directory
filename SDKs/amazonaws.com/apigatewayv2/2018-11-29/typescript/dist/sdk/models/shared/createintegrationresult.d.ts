 ...
 */
export declare enum CreateIntegrationResultConnectionTypeEnum {
    Internet = "INTERNET",
    VpcLink = "VPC_LINK"
}
/**
 ...
 */
export declare enum CreateIntegrationResultContentHandlingStrategyEnum {
 ...
 */
export declare enum CreateIntegrationResultIntegrationTypeEnum {
    Aws = "AWS",
    Http = "HTTP",
    Mock = "MOCK",
 ...
 */
export declare enum CreateIntegrationResultPassthroughBehaviorEnum {
 ...
 */
export declare class CreateIntegrationResultTlsConfig extends SpeakeasyBase {
...
export declare class CreateIntegrationResult extends SpeakeasyBase {
    ...
    connectionId?: string;
    connectionType?: CreateIntegrationResultConnectionTypeEnum;
    contentHandlingStrategy?: CreateIntegrationResultContentHandlingStrategyEnum;
    ...
    integrationType?: CreateIntegrationResultIntegrationTypeEnum;
    integrationUri?: string;
    passthroughBehavior?: CreateIntegrationResultPassthroughBehaviorEnum;
