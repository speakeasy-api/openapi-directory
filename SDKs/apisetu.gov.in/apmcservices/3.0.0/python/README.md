...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/apmcservices/3.0.0/python
```
...
req = operations.ApmclRequestBody(
...
res = s.ap_is.apmcl(req, operations.ApmclSecurity(
