...
class ListDeviceListDeviceResponse:
    ...
    devices: Optional[list[shared_microvisor_v1_device.MicrovisorV1Device]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('devices'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListDeviceListDeviceResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
