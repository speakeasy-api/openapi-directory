...
export class Devices {
   ...
   */
  deviceCreate(
    req: operations.DeviceCreateTheH323SIPDeviceObject,
    security: operations.DeviceCreateSecurity,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DeviceCreateResponse =
        new operations.DeviceCreateResponse({
      ...
      switch (true) {
        ...
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.theH323SIPDeviceObject = utils.objectToClass(
              httpRes?.data,
              operations.DeviceCreateTheH323SIPDeviceObject1
            );
          }
  ...
  deviceDelete(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DeviceDeleteResponse =
        new operations.DeviceDeleteResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.h323SIPDeviceList = utils.objectToClass(
              httpRes?.data,
              operations.DeviceListH323SIPDeviceList
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  deviceUpdate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DeviceUpdateResponse =
        new operations.DeviceUpdateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
