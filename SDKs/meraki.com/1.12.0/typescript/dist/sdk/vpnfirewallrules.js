...
exports.VpnFirewallRules = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var VpnFirewallRules = /** @class */ (function () {
    function VpnFirewallRules(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    VpnFirewallRules.prototype.getOrganizationApplianceVpnVpnFirewallRules = function (req, config) {
    ...
    **/
    VpnFirewallRules.prototype.updateOrganizationApplianceVpnVpnFirewallRules = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.VpnFirewallRules = VpnFirewallRules;
