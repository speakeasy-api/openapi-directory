...
class DatasetSchema:
    r"""Describes the schema for a dataset. For more information on schemas, see <a href=\\"https://docs.aws.amazon.com/personalize/latest/dg/API_CreateSchema.html\\">CreateSchema</a>."""
