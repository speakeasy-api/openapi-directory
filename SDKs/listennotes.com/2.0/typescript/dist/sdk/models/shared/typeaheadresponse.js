...
var TypeaheadResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: podcasttypeaheadresult_1.PodcastTypeaheadResult }),
        (0, class_transformer_1.Expose)({ name: "podcasts" }),
        (0, class_transformer_1.Type)(function () { return podcasttypeaheadresult_1.PodcastTypeaheadResult; }),
        __metadata("design:type", Array)
