...
var Transfer = /** @class */ (function () {
     ...
     */
    Transfer.prototype.getTransfer = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetTransferRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/transfer/{transfer_Id}", req);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.transfer = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.Transfer);
                    }
                    break;
