...
type ContentRecommendationsGenerateSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type ContentRecommendationsGenerateRequest struct {
	// V1 error format.
	...
	AllowedTag []string `queryParam:"style=form,explode=true,name=allowedTag"`
...
type ContentRecommendationsGenerateResponse struct {
	ContentType string
	// Successful response
	GenerateRecommendationsResponse *shared.GenerateRecommendationsResponse
	StatusCode                      int
