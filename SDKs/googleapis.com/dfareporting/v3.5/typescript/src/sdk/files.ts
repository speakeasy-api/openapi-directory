...
export class Files {
  ...
  dfareportingFilesGet(
    ...
    security: operations.DfareportingFilesGetSecurity,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DfareportingFilesGetResponse =
        new operations.DfareportingFilesGetResponse({
  ...
  dfareportingFilesList(
    ...
    security: operations.DfareportingFilesListSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DfareportingFilesListResponse =
        new operations.DfareportingFilesListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
