...
class SearchProjectExperimentQueryParams:
...
@dataclasses.dataclass
class SearchProjectExperimentRequest:
    query_params: SearchProjectExperimentQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectExperimentResponse:
