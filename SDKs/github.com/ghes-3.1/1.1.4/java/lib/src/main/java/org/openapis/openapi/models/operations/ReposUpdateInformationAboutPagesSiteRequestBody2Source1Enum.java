 ...
 */
public enum ReposUpdateInformationAboutPagesSiteRequestBody2Source1Enum {
    GH_PAGES("gh-pages"),
    MASTER("master"),
    ...
    private ReposUpdateInformationAboutPagesSiteRequestBody2Source1Enum(String value) {
        this.value = value;
    }
}
