 ...
 */
export class DescribeClientVpnTargetNetworksRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeClientVpnTargetNetworksRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
