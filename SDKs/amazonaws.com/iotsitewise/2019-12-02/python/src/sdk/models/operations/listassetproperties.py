...
class ListAssetPropertiesRequest:
    ...
    filter: Optional[ListAssetPropertiesFilterEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'form', 'explode': True }})
    r"""<p> Filters the requested list of asset properties. You can choose one of the following options:</p> <ul> <li> <p> <code>ALL</code> – The list includes all asset properties for a given asset model ID. </p> </li> <li> <p> <code>BASE</code> – The list includes only base asset properties for a given asset model ID. </p> </li> </ul> <p>Default: <code>BASE</code> </p>"""  
...
class ListAssetPropertiesResponse:
    ...
    list_asset_properties_response: Optional[shared_listassetpropertiesresponse.ListAssetPropertiesResponse] = dataclasses.field(default=None)
    r"""Success"""  
