...
var System = /** @class */ (function () {
     ...
     */
    System.prototype.getResourceLimits = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/system/limits";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetResourceLimitsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.limits = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.Limits);
                    }
                    break;
    ...
    System.prototype.getSystemInfo = function (config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetSystemInfoResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
