...
var CisInstructionCisInstruction = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CisLineTag" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TaxYearEnd" }),
        __metadata("design:type", Number)
    ], CisInstructionCisInstruction.prototype, "taxYearEnd", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TaxYearStart" }),
        __metadata("design:type", Number)
...
var CisInstruction = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CisInstruction" }),
