...
@dataclasses.dataclass
class GetPushDeviceDetailsHeaders:
...
@dataclasses.dataclass
class GetPushDeviceDetailsRequest:
    headers: GetPushDeviceDetailsHeaders = dataclasses.field()
    path_params: GetPushDeviceDetailsPathParams = dataclasses.field()
    query_params: GetPushDeviceDetailsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetPushDeviceDetailsResponseOutput:
