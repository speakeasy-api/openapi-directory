...
class RecommendationengineProjectsLocationsCatalogsEventStoresPlacementsPredictRequest:
    ...
    google_cloud_recommendationengine_v1beta1_predict_request: Optional[shared_googlecloudrecommendationenginev1beta1predictrequest.GoogleCloudRecommendationengineV1beta1PredictRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
