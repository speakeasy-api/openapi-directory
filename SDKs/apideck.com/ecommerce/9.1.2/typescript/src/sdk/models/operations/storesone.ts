...
export class StoresOneSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class StoresOneRequest extends SpeakeasyBase {
  /**
...
export class StoresOneResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
