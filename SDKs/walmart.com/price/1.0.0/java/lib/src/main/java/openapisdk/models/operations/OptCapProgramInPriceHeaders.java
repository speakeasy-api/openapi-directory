...
public class OptCapProgramInPriceHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public OptCapProgramInPriceHeaders withAuthorization(String authorization) {
    ...
    public OptCapProgramInPriceHeaders withWmConsumerChannelType(String wmCONSUMERCHANNELTYPE) {
    ...
    public OptCapProgramInPriceHeaders withWmQosCorrelationId(String wmQOSCORRELATIONID) {
    ...
    public OptCapProgramInPriceHeaders withWmSecAccessToken(String wmSECACCESSTOKEN) {
    ...
    public OptCapProgramInPriceHeaders withWmSvcName(String wmSVCNAME) {
