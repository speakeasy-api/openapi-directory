...
class PostTransactionRulesSecurity:
...
@dataclasses.dataclass
class PostTransactionRulesRequest:
    security: PostTransactionRulesSecurity = dataclasses.field()
    request: Optional[Any] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class PostTransactionRulesResponse:
