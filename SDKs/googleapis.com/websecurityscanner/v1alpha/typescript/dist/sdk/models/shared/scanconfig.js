...
exports.ScanConfig = exports.ScanConfigUserAgentEnum = exports.ScanConfigTargetPlatformsEnum = void 0;
var utils_1 = require("../../../internal/utils");
var authentication_1 = require("./authentication");
var scanrun_1 = require("./scanrun");
var schedule_1 = require("./schedule");
var ScanConfigTargetPlatformsEnum;
...
})(ScanConfigTargetPlatformsEnum = exports.ScanConfigTargetPlatformsEnum || (exports.ScanConfigTargetPlatformsEnum = {}));
...
var ScanConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=blacklistPatterns" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=latestRun" }),
        __metadata("design:type", scanrun_1.ScanRun)
    ], ScanConfig.prototype, "latestRun", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=maxQps" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startingUrls" }),
        __metadata("design:type", Array)
    ], ScanConfig.prototype, "startingUrls", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=targetPlatforms" }),
        __metadata("design:type", Array)
