...
class DeleteIdentityProviderRequest:
    ...
    delete_identity_provider_request: shared_deleteidentityproviderrequest.DeleteIdentityProviderRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DeleteIdentityProviderResponse:
    ...
    r"""UnsupportedIdentityProviderException"""  
