...
public class VirtualizationInterfacesList200ApplicationJson {
    ...
    public openapisdk.models.shared.VirtualMachineInterface[] results;
    public VirtualizationInterfacesList200ApplicationJson withResults(openapisdk.models.shared.VirtualMachineInterface[] results) {
