...
export class FullNameMatchSimilarityKey {
  ...
  getfullnamematch(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetfullnamematchResponse =
        new operations.GetfullnamematchResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getfullnamematch200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Getfullnamematch200ApplicationJSON
            );
          }
          break;
