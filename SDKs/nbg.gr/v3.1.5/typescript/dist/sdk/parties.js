...
var Parties = /** @class */ (function () {
     ...
     */
    Parties.prototype.getAccountsAccountIdParties = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAccountsAccountIdPartiesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/accounts/{accountId}/parties", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetAccountsAccountIdPartiesResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.obReadParty3 = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.OBReadParty3);
                    }
     ...
     */
    Parties.prototype.getAccountsAccountIdParty = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAccountsAccountIdPartyRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/accounts/{accountId}/party", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetAccountsAccountIdPartyResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.obReadParty2 = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.OBReadParty2);
                    }
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.obReadParty2 = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.OBReadParty2);
                    }
     ...
     * Get Party
     */
    Parties.prototype.getParty = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetPartyResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
