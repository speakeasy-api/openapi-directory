...
exports.ListParticipantResponse = exports.ListParticipantListParticipantResponse = exports.ListParticipantListParticipantResponseMeta = exports.ListParticipantRequest = exports.ListParticipantSecurity = exports.ListParticipantServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListParticipantServerList = ["https://proxy.twilio.com"];
var ListParticipantSecurity = /** @class */ (function (_super) {
    ...
    ], ListParticipantSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListParticipantSecurity.prototype, "username", void 0);
...
var ListParticipantRequest = /** @class */ (function (_super) {
    ...
    ], ListParticipantRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListParticipantRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListParticipantRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListParticipantRequest.prototype, "serviceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SessionSid",
        }),
        __metadata("design:type", String)
    ], ListParticipantRequest.prototype, "sessionSid", void 0);
...
var ListParticipantListParticipantResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListParticipantListParticipantResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ProxyV1ServiceSessionParticipant }),
        (0, class_transformer_1.Expose)({ name: "participants" }),
        (0, class_transformer_1.Type)(function () { return shared.ProxyV1ServiceSessionParticipant; }),
...
var ListParticipantResponse = /** @class */ (function (_super) {
    ...
    ], ListParticipantResponse.prototype, "rawResponse", void 0);
