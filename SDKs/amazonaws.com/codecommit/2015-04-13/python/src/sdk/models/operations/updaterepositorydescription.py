...
class UpdateRepositoryDescriptionHeaders:
...
class UpdateRepositoryDescriptionRequest:
    headers: UpdateRepositoryDescriptionHeaders = dataclasses.field()
    request: shared_updaterepositorydescriptioninput.UpdateRepositoryDescriptionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
