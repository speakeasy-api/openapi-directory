...
var GetRecommendationsRequest = /** @class */ (function (_super) {
    ...
    ], GetRecommendationsRequest.prototype, "endTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locale",
        }),
        __metadata("design:type", String)
    ], GetRecommendationsRequest.prototype, "locale", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=profilingGroupName",
        }),
        __metadata("design:type", String)
    ], GetRecommendationsRequest.prototype, "profilingGroupName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=startTime;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], GetRecommendationsRequest.prototype, "startTime", void 0);
