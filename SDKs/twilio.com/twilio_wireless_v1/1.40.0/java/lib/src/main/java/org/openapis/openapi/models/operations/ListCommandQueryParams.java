...
public class ListCommandQueryParams {
    ...
    public ListCommandQueryParams withDirection(org.openapis.openapi.models.shared.CommandEnumDirectionEnum direction) {
    ...
    public Long page;
    public ListCommandQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListCommandQueryParams withPageToken(String pageToken) {
    ...
    public ListCommandQueryParams withStatus(org.openapis.openapi.models.shared.CommandEnumStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ListCommandQueryParams withTransport(org.openapis.openapi.models.shared.CommandEnumTransportEnum transport) {
