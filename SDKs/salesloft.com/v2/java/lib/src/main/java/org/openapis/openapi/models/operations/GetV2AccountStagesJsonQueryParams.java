...
public class GetV2AccountStagesJsonQueryParams {
    /**
    ...
    public Long[] ids;
    public GetV2AccountStagesJsonQueryParams withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2AccountStagesJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2AccountStagesJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public Long page;
    public GetV2AccountStagesJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2AccountStagesJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2AccountStagesJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2AccountStagesJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public GetV2AccountStagesJsonQueryParams withUpdatedAt(String[] updatedAt) {
