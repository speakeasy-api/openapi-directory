...
exports.MysqlSourceConfig = void 0;
...
**/
var MysqlSourceConfig = /** @class */ (function (_super) {
    __extends(MysqlSourceConfig, _super);
    ...
    ], MysqlSourceConfig.prototype, "excludeObjects", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=includeObjects" }),
        __metadata("design:type", mysqlrdbms_1.MysqlRdbms)
    ], MysqlSourceConfig.prototype, "includeObjects", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=maxConcurrentCdcTasks" }),
        __metadata("design:type", Number)
    ], MysqlSourceConfig.prototype, "maxConcurrentCdcTasks", void 0);
    return MysqlSourceConfig;
}(utils_1.SpeakeasyBase));
exports.MysqlSourceConfig = MysqlSourceConfig;
