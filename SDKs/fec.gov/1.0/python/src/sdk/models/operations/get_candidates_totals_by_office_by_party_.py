...
from ..shared import totalbyofficebypartypage as shared_totalbyofficebypartypage
...
class GetCandidatesTotalsByOfficeByPartyQueryParams:
    ...
    office: Optional[GetCandidatesTotalsByOfficeByPartyOfficeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'office', 'style': 'form', 'explode': True }})
...
class GetCandidatesTotalsByOfficeByPartyRequest:
    query_params: GetCandidatesTotalsByOfficeByPartyQueryParams = dataclasses.field()
...
class GetCandidatesTotalsByOfficeByPartyResponse:
    ...
    total_by_office_by_party_page: Optional[shared_totalbyofficebypartypage.TotalByOfficeByPartyPage] = dataclasses.field(default=None)
