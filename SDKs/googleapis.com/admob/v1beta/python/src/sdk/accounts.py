...
class Accounts:
    ...
    def admob_accounts_ad_sources_list(self, request: operations.AdmobAccountsAdSourcesListRequest) -> operations.AdmobAccountsAdSourcesListResponse:
        ...
        url = utils.generate_url(operations.AdmobAccountsAdSourcesListRequest, base_url, '/v1beta/{parent}/adSources', request)
        
        query_params = utils.get_query_params(operations.AdmobAccountsAdSourcesListRequest, request)
        ...
        res = operations.AdmobAccountsAdSourcesListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListAdSourcesResponse])
    ...
    def admob_accounts_ad_units_list(self, request: operations.AdmobAccountsAdUnitsListRequest, security: operations.AdmobAccountsAdUnitsListSecurity) -> operations.AdmobAccountsAdUnitsListResponse:
        ...
        url = utils.generate_url(operations.AdmobAccountsAdUnitsListRequest, base_url, '/v1beta/{parent}/adUnits', request)
    ...
    def admob_accounts_apps_list(self, request: operations.AdmobAccountsAppsListRequest, security: operations.AdmobAccountsAppsListSecurity) -> operations.AdmobAccountsAppsListResponse:
        ...
        url = utils.generate_url(operations.AdmobAccountsAppsListRequest, base_url, '/v1beta/{parent}/apps', request)
    ...
    def admob_accounts_get(self, request: operations.AdmobAccountsGetRequest, security: operations.AdmobAccountsGetSecurity) -> operations.AdmobAccountsGetResponse:
        ...
        url = utils.generate_url(operations.AdmobAccountsGetRequest, base_url, '/v1beta/{name}', request)
    ...
    def admob_accounts_mediation_report_generate(self, request: operations.AdmobAccountsMediationReportGenerateRequest, security: operations.AdmobAccountsMediationReportGenerateSecurity) -> operations.AdmobAccountsMediationReportGenerateResponse:
        ...
        url = utils.generate_url(operations.AdmobAccountsMediationReportGenerateRequest, base_url, '/v1beta/{parent}/mediationReport:generate', request)
    ...
    def admob_accounts_network_report_generate(self, request: operations.AdmobAccountsNetworkReportGenerateRequest, security: operations.AdmobAccountsNetworkReportGenerateSecurity) -> operations.AdmobAccountsNetworkReportGenerateResponse:
        ...
        url = utils.generate_url(operations.AdmobAccountsNetworkReportGenerateRequest, base_url, '/v1beta/{parent}/networkReport:generate', request)
