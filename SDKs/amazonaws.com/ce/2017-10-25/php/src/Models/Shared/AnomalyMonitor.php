...
/**
 * AnomalyMonitor - This object continuously inspects your account's cost data for anomalies. It's based on <code>MonitorType</code> and <code>MonitorSpecification</code>. The content consists of detailed metadata and the current status of the monitor object. 
 * 
...
class AnomalyMonitor
{
	...
	#[\JMS\Serializer\Annotation\SerializedName('DimensionalValueCount')]
    #[\JMS\Serializer\Annotation\Type('int')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?int $dimensionalValueCount = null;
    
	#[\JMS\Serializer\Annotation\SerializedName('LastEvaluatedDate')]
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $lastEvaluatedDate = null;
	...
	#[\JMS\Serializer\Annotation\SerializedName('MonitorDimension')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\MonitorDimensionEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MonitorDimensionEnum $monitorDimension = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\Expression $monitorSpecification
     */
	#[\JMS\Serializer\Annotation\SerializedName('MonitorSpecification')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\Expression')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?Expression $monitorSpecification = null;
    
	#[\JMS\Serializer\Annotation\SerializedName('MonitorType')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\MonitorTypeEnum>')]
    public MonitorTypeEnum $monitorType;
    
	public function __construct()
	{
		$this->creationDate = null;
		$this->dimensionalValueCount = null;
		$this->lastEvaluatedDate = null;
		$this->lastUpdatedDate = null;
		$this->monitorArn = null;
		$this->monitorDimension = null;
		$this->monitorName = "";
		$this->monitorSpecification = null;
		$this->monitorType = \OpenAPI\OpenAPI\Models\Shared\MonitorTypeEnum::DIMENSIONAL;
	}
}
