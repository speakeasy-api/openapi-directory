...
class TagResourceRequestBody:
    ...
    r"""Tags that you add to a resource. You can add a maximum of 50 tags in Internet Monitor."""  
...
class TagResourceRequest:
    ...
    r"""The Amazon Resource Name (ARN) for a tag that you add to a resource. Tags are supported only for monitors in Amazon CloudWatch Internet Monitor."""  
