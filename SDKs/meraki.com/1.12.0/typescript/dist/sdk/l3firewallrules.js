...
exports.L3FirewallRules = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var L3FirewallRules = /** @class */ (function () {
    function L3FirewallRules(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    L3FirewallRules.prototype.getNetworkApplianceFirewallL3FirewallRules = function (req, config) {
    ...
    **/
    L3FirewallRules.prototype.getNetworkWirelessSsidFirewallL3FirewallRules = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    L3FirewallRules.prototype.updateNetworkApplianceFirewallL3FirewallRules = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    L3FirewallRules.prototype.updateNetworkWirelessSsidFirewallL3FirewallRules = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.L3FirewallRules = L3FirewallRules;
