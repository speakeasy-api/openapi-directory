...
var Aquifer = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=aquifer_id" }),
        __metadata("design:type", Number)
    ], Aquifer.prototype, "aquiferId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=aquifer_name" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=demand" }),
        __metadata("design:type", String)
    ], Aquifer.prototype, "demand", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=demand_description" }),
        __metadata("design:type", String)
    ], Aquifer.prototype, "demandDescription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=known_water_use" }),
        __metadata("design:type", String)
    ], Aquifer.prototype, "knownWaterUse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=known_water_use_description" }),
        __metadata("design:type", String)
    ], Aquifer.prototype, "knownWaterUseDescription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=litho_stratographic_unit" }),
        __metadata("design:type", String)
    ], Aquifer.prototype, "lithoStratographicUnit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=location_description" }),
        __metadata("design:type", String)
    ], Aquifer.prototype, "locationDescription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mapping_year" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=material_description" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=productivity" }),
        __metadata("design:type", String)
    ], Aquifer.prototype, "productivity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=productivity_description" }),
        __metadata("design:type", String)
    ], Aquifer.prototype, "productivityDescription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=quality_concern" }),
        __metadata("design:type", String)
    ], Aquifer.prototype, "qualityConcern", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=quality_concern_description" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=subtype_description" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=vulnerability_description" }),
        __metadata("design:type", String)
    ], Aquifer.prototype, "vulnerabilityDescription", void 0);
    return Aquifer;
}(utils_1.SpeakeasyBase));
exports.Aquifer = Aquifer;
