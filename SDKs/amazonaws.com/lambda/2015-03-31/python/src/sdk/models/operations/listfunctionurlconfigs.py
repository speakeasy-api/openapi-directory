...
from ..shared import listfunctionurlconfigsresponse as shared_listfunctionurlconfigsresponse
...
class ListFunctionURLConfigsRequest:
    ...
    r"""The maximum number of function URLs to return in the response. Note that <code>ListFunctionUrlConfigs</code> returns a maximum of 50 items in each response, even if you set the number higher."""  
...
class ListFunctionURLConfigsResponse:
    ...
    list_function_url_configs_response: Optional[shared_listfunctionurlconfigsresponse.ListFunctionURLConfigsResponse] = dataclasses.field(default=None)
    r"""Success"""  
