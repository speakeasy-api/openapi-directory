...
class DeploymentGroupInfo:
    r"""Information about a deployment group."""
    ...
    deployment_group_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deploymentGroupId'), 'exclude': lambda f: f is None }})  
    ...
    last_attempted_deployment: Optional[shared_lastdeploymentinfo.LastDeploymentInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lastAttemptedDeployment'), 'exclude': lambda f: f is None }})  
    last_successful_deployment: Optional[shared_lastdeploymentinfo.LastDeploymentInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lastSuccessfulDeployment'), 'exclude': lambda f: f is None }})  
    ...
    target_revision: Optional[shared_revisionlocation.RevisionLocation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('targetRevision'), 'exclude': lambda f: f is None }})  
