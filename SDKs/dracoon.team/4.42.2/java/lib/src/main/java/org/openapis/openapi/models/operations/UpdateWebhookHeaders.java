...
public class UpdateWebhookHeaders {
    ...
    public UpdateWebhookHeaders withXSdsAuthToken(String xSdsAuthToken) {
    ...
    public UpdateWebhookHeaders withXSdsDateFormat(UpdateWebhookXSdsDateFormatEnum xSdsDateFormat) {
