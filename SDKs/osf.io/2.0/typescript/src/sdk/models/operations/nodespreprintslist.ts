 ...
 */
export class NodesPreprintsListPreprintAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class NodesPreprintsListPreprintLinks extends SpeakeasyBase {
  /**
 ...
 */
export class NodesPreprintsListPreprintRelationships extends SpeakeasyBase {
  /**
...
export class NodesPreprintsListPreprint extends SpeakeasyBase {
  /**
   * The properties of the preprint entity.
   */
  @SpeakeasyMetadata()
  attributes?: NodesPreprintsListPreprintAttributes;
   ...
   */
  @SpeakeasyMetadata()
  links?: NodesPreprintsListPreprintLinks;

  /**
   * URLs to other entities or entity collections that have a relationship to the preprint entity.
   */
  @SpeakeasyMetadata()
  relationships: NodesPreprintsListPreprintRelationships;
