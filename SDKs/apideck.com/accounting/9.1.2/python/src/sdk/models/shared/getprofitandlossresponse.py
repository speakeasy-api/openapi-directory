...
import dataclasses
from ..shared import profitandloss as shared_profitandloss
...
class GetProfitAndLossResponse:
    ...
    data: shared_profitandloss.ProfitAndLoss = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
