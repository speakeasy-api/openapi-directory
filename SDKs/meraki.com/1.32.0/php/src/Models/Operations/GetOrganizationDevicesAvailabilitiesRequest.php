...
class GetOrganizationDevicesAvailabilitiesRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetOrganizationDevicesAvailabilitiesTagsFilterTypeEnum $tagsFilterType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=tagsFilterType')]
    public ?GetOrganizationDevicesAvailabilitiesTagsFilterTypeEnum $tagsFilterType = null;
