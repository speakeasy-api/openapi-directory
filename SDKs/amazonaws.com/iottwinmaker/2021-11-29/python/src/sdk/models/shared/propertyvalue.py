...
class PropertyValue:
    r"""An object that contains information about a value for a time series property."""
    
    value: shared_datavalue.DataValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value') }})  
