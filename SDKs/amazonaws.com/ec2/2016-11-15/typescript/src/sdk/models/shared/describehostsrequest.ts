 ...
 */
export class DescribeHostsRequestFilter extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeHostsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: DescribeHostsRequestFilter })
  filter?: DescribeHostsRequestFilter[];
