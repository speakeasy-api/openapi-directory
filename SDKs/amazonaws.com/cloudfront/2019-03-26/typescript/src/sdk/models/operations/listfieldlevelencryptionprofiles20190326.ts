...
export class ListFieldLevelEncryptionProfiles20190326Request extends SpeakeasyBase {
  /**
...
export class ListFieldLevelEncryptionProfiles20190326Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
