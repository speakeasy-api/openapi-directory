...
exports.GetCisInstructionFromSubContractorResponse = exports.GetCisInstructionFromSubContractorRequest = void 0;
...
var GetCisInstructionFromSubContractorRequest = /** @class */ (function (_super) {
    ...
    ], GetCisInstructionFromSubContractorRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetCisInstructionFromSubContractorRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=CisInstructionId",
        }),
        __metadata("design:type", String)
    ], GetCisInstructionFromSubContractorRequest.prototype, "cisInstructionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetCisInstructionFromSubContractorRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], GetCisInstructionFromSubContractorRequest.prototype, "subContractorId", void 0);
...
var GetCisInstructionFromSubContractorResponse = /** @class */ (function (_super) {
    ...
    ], GetCisInstructionFromSubContractorResponse.prototype, "rawResponse", void 0);
