...
class ListMemberListMemberResponse:
    members: Optional[list[shared_ip_messaging_v1_service_channel_member.IPMessagingV1ServiceChannelMember]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('members') }})
