...
class ResourceCreationLimitPolicy:
    ...
    new_game_sessions_per_creator: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('NewGameSessionsPerCreator') }})
    policy_period_in_minutes: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('PolicyPeriodInMinutes') }})
