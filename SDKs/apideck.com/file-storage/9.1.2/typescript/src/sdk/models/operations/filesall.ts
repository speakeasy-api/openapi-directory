...
export class FilesAllSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FilesAllRequest extends SpeakeasyBase {
  /**
...
export class FilesAllResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
