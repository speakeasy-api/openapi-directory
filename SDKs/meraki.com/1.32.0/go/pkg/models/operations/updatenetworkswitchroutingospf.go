...
func (e UpdateNetworkSwitchRoutingOspfRequestBodyAreasAreaTypeEnum) ToPointer() *UpdateNetworkSwitchRoutingOspfRequestBodyAreasAreaTypeEnum {
	return &e
}
...
func (e *UpdateNetworkSwitchRoutingOspfRequestBodyAreasAreaTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "nssa":
		fallthrough
	case "stub":
		*e = UpdateNetworkSwitchRoutingOspfRequestBodyAreasAreaTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchRoutingOspfRequestBodyAreasAreaTypeEnum: %v", v)
	}
}
...
func (e UpdateNetworkSwitchRoutingOspfRequestBodyV3AreasAreaTypeEnum) ToPointer() *UpdateNetworkSwitchRoutingOspfRequestBodyV3AreasAreaTypeEnum {
	return &e
}
...
func (e *UpdateNetworkSwitchRoutingOspfRequestBodyV3AreasAreaTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "nssa":
		fallthrough
	case "stub":
		*e = UpdateNetworkSwitchRoutingOspfRequestBodyV3AreasAreaTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchRoutingOspfRequestBodyV3AreasAreaTypeEnum: %v", v)
	}
}
