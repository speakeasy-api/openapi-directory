...
from ..shared import createcatchallrequest as shared_createcatchallrequest
...
class CreateCatchAllRequest:
    ...
    create_catch_all_request: Optional[shared_createcatchallrequest.CreateCatchAllRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
