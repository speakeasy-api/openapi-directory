 ...
 */
public enum WebinarCreate201ApplicationJSONSettingsRegistrationTypeEnum {
    ONE("1"),
    TWO("2"),
    THREE("3");
    ...
    private WebinarCreate201ApplicationJSONSettingsRegistrationTypeEnum(String value) {
        this.value = value;
    }
}
