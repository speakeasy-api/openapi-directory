...
class UserStatisticeDailyValueV1StatisticsIndividualDaily200ApplicationJSON:
    ...
    result: Optional[list[UserStatisticeDailyValueV1StatisticsIndividualDaily200ApplicationJSONResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Result'), 'exclude': lambda f: f is None }})  
