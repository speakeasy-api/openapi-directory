...
class RealtimebiddingBiddersPretargetingConfigsRemoveTargetedSitesRequest:
    ...
    remove_targeted_sites_request: Optional[shared_removetargetedsitesrequest.RemoveTargetedSitesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
