 ...
 */
export class DescribeExportImageTasksRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeExportImageTasksRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
  ...
  @SpeakeasyMetadata({ elemType: DescribeExportImageTasksRequestFilters })
  filters?: DescribeExportImageTasksRequestFilters[];
