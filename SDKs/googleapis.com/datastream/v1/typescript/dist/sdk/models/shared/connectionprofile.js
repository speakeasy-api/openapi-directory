...
var postgresqlprofile_1 = require("./postgresqlprofile");
...
var ConnectionProfile = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=bigqueryProfile" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=postgresqlProfile" }),
        __metadata("design:type", postgresqlprofile_1.PostgresqlProfile)
