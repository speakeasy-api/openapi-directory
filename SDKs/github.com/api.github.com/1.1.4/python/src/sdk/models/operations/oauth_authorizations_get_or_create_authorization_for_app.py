...
class OauthAuthorizationsGetOrCreateAuthorizationForAppRequest:
    path_params: OauthAuthorizationsGetOrCreateAuthorizationForAppPathParams = dataclasses.field()
    request: Optional[OauthAuthorizationsGetOrCreateAuthorizationForAppRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
