...
public class UpdateReceivable3Request {
    ...
    public UpdateReceivable3Request(@JsonProperty("ReceivableDTO") org.openapis.openapi.models.shared.ReceivableDTO receivableDTO, @JsonProperty("quoteId") String quoteId, @JsonProperty("receivableId") Long receivableId) {
        this.receivableDTO = receivableDTO;
        this.quoteId = quoteId;
        this.receivableId = receivableId;
  }
