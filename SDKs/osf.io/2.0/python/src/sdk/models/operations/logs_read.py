...
class LogsReadRequest:
    ...
    r"""The unique identifier of the log you wish to retrieve."""  
...
class LogsReadLogAttributes:
    ...
    params: Optional[LogsReadLogAttributesLogParams] = dataclasses.field(default=None)
    r"""The type of action performed on the OSF. See description for full list of possible actions."""  
...
class LogsReadLog:
    ...
    attributes: LogsReadLogAttributes = dataclasses.field()
    r"""The properties of the log."""  
    id: str = dataclasses.field()
    r"""The identifier of the log."""  
    links: LogsReadLogLinks = dataclasses.field()
    r"""URLs to alternative representations of the log entity."""  
    relationships: LogsReadLogRelationships = dataclasses.field()
    r"""URLs to other entities or entity collections that have a relationship to the log."""  
