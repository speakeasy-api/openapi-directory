...
class AndroidenterpriseEnterprisesGetServiceAccountRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\AndroidenterpriseEnterprisesGetServiceAccountKeyTypeEnum $keyType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=keyType')]
    public ?AndroidenterpriseEnterprisesGetServiceAccountKeyTypeEnum $keyType = null;
