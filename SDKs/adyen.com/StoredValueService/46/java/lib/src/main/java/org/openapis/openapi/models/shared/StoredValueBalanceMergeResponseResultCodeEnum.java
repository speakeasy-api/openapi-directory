...
/**
 * StoredValueBalanceMergeResponseResultCodeEnum - The result of the payment. Possible values:
 * 
 ...
 * 
 */
public enum StoredValueBalanceMergeResponseResultCodeEnum {
    SUCCESS("Success"),
    REFUSED("Refused"),
    ERROR("Error"),
    ...
    private StoredValueBalanceMergeResponseResultCodeEnum(String value) {
        this.value = value;
    }
}
