...
export declare class PostIndividualsPartyIdBusinessNamesRequest extends SpeakeasyBase {
    /**
     * The API key.
     */
    apiKey: string;
...
export declare class PostIndividualsPartyIdBusinessNamesResponse extends SpeakeasyBase {
    contentType: string;
