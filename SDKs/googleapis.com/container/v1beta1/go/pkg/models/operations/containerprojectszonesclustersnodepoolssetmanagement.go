...
type ContainerProjectsZonesClustersNodePoolsSetManagementSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContainerProjectsZonesClustersNodePoolsSetManagementPathParams struct {
...
type ContainerProjectsZonesClustersNodePoolsSetManagementQueryParams struct {
	// V1 error format.
...
type ContainerProjectsZonesClustersNodePoolsSetManagementRequest struct {
...
type ContainerProjectsZonesClustersNodePoolsSetManagementResponse struct {
	ContentType string
	// Successful response
