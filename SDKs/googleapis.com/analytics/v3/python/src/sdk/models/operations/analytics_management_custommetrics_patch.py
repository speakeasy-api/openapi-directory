...
@dataclasses.dataclass
class AnalyticsManagementCustomMetricsPatchQueryParams:
...
class AnalyticsManagementCustomMetricsPatchRequest:
    path_params: AnalyticsManagementCustomMetricsPatchPathParams = dataclasses.field()
    query_params: AnalyticsManagementCustomMetricsPatchQueryParams = dataclasses.field()
    security: AnalyticsManagementCustomMetricsPatchSecurity = dataclasses.field()
