...
func (e NamedStyleNamedStyleTypeEnum) ToPointer() *NamedStyleNamedStyleTypeEnum {
	return &e
}
...
func (e *NamedStyleNamedStyleTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "HEADING_5":
		fallthrough
	case "HEADING_6":
		*e = NamedStyleNamedStyleTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NamedStyleNamedStyleTypeEnum: %v", v)
	}
}
