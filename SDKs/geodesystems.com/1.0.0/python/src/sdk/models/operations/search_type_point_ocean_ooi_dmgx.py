...
class SearchTypePointOceanOoiDmgxQueryParams:
...
@dataclasses.dataclass
class SearchTypePointOceanOoiDmgxRequest:
    query_params: SearchTypePointOceanOoiDmgxQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypePointOceanOoiDmgxResponse:
