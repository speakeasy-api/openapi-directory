...
exports.GetAccountAccessConsentsConsentIdResponse = exports.GetAccountAccessConsentsConsentIdRequest = exports.GetAccountAccessConsentsConsentIdSecurity = void 0;
...
var GetAccountAccessConsentsConsentIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetAccountAccessConsentsConsentIdRequest.prototype, "consentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=sandbox-id",
        }),
        __metadata("design:type", String)
    ], GetAccountAccessConsentsConsentIdRequest.prototype, "sandboxId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetAccountAccessConsentsConsentIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetAccountAccessConsentsConsentIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetAccountAccessConsentsConsentIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetAccountAccessConsentsConsentIdRequest.prototype, "xFapiInteractionId", void 0);
...
var GetAccountAccessConsentsConsentIdResponse = /** @class */ (function (_super) {
    ...
    ], GetAccountAccessConsentsConsentIdResponse.prototype, "rawResponse", void 0);
