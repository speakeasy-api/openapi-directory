 ...
 */
export enum InstancesScopedListWarningCodeEnum {
...
export class InstancesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstancesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstancesScopedListWarningData })
  @Expose({ name: "data" })
...
export class InstancesScopedList extends SpeakeasyBase {
  /**
