...
func (s *webhooks) PutWebhooksFirehose(ctx context.Context, request operations.PutWebhooksFirehoseRequestBody, security operations.PutWebhooksFirehoseSecurity) (*operations.PutWebhooksFirehoseResponse, error) {
	baseURL := s.serverURL
