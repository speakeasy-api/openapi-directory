...
func (e *PostServersIDActionsChangeDNSPtrActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsChangeDNSPtrActionResponseActionStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsChangeDNSPtrActionResponseActionStatusEnum: %s", s)
	}
}
