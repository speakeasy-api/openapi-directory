...
class PostModifyReplicationGroupShardConfigurationQueryParams:
    action: PostModifyReplicationGroupShardConfigurationActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostModifyReplicationGroupShardConfigurationVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostModifyReplicationGroupShardConfigurationRequest:
    headers: PostModifyReplicationGroupShardConfigurationHeaders = dataclasses.field()
    query_params: PostModifyReplicationGroupShardConfigurationQueryParams = dataclasses.field()
