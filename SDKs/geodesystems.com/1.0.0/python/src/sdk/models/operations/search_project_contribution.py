...
class SearchProjectContributionQueryParams:
...
@dataclasses.dataclass
class SearchProjectContributionRequest:
    query_params: SearchProjectContributionQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectContributionResponse:
