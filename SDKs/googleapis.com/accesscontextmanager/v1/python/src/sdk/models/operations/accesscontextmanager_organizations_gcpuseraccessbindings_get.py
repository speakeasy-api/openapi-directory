...
class AccesscontextmanagerOrganizationsGcpUserAccessBindingsGetQueryParams:
    ...
    filter: Optional[AccesscontextmanagerOrganizationsGcpUserAccessBindingsGetFilterEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'form', 'explode': True }})
...
class AccesscontextmanagerOrganizationsGcpUserAccessBindingsGetRequest:
    path_params: AccesscontextmanagerOrganizationsGcpUserAccessBindingsGetPathParams = dataclasses.field()
    query_params: AccesscontextmanagerOrganizationsGcpUserAccessBindingsGetQueryParams = dataclasses.field()
    security: AccesscontextmanagerOrganizationsGcpUserAccessBindingsGetSecurity = dataclasses.field()
...
class AccesscontextmanagerOrganizationsGcpUserAccessBindingsGetResponse:
    ...
    gcp_user_access_binding: Optional[shared_gcpuseraccessbinding.GcpUserAccessBinding] = dataclasses.field(default=None)
