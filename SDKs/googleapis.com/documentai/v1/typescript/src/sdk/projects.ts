...
export class Projects {
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleCloudDocumentaiV1FetchProcessorTypesResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleCloudDocumentaiV1FetchProcessorTypesResponse
              );
          }
          break;
      }
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleCloudDocumentaiV1ListProcessorTypesResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleCloudDocumentaiV1ListProcessorTypesResponse
              );
          }
          break;
      }
  ...
  documentaiProjectsLocationsProcessorsCreate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleCloudDocumentaiV1Processor = utils.objectToClass(
              httpRes?.data,
              shared.GoogleCloudDocumentaiV1Processor
            );
          }
          break;
      }
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleCloudDocumentaiV1ListProcessorsResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleCloudDocumentaiV1ListProcessorsResponse
              );
          }
          break;
      }
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleCloudDocumentaiV1ListEvaluationsResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleCloudDocumentaiV1ListEvaluationsResponse
              );
          }
          break;
      }
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleCloudDocumentaiV1ListProcessorVersionsResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleCloudDocumentaiV1ListProcessorVersionsResponse
              );
          }
          break;
      }
  ...
  documentaiProjectsLocationsProcessorsProcessorVersionsProcess(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{name}:process", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleCloudDocumentaiV1ProcessResponse = utils.objectToClass(
              httpRes?.data,
              shared.GoogleCloudDocumentaiV1ProcessResponse
            );
          }
          break;
      }
  ...
  documentaiProjectsOperationsGet(
    ...
    security: operations.DocumentaiProjectsOperationsGetSecurity,
    config?: AxiosRequestConfig
    ...
    const url: string = utils.generateURL(baseURL, "/v1/{name}", req);
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DocumentaiProjectsOperationsGetSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DocumentaiProjectsOperationsGetResponse =
        new operations.DocumentaiProjectsOperationsGetResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
