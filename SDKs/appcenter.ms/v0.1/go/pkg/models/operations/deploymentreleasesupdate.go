...
func (e DeploymentReleasesUpdate200ApplicationJSONReleaseMethodEnum) ToPointer() *DeploymentReleasesUpdate200ApplicationJSONReleaseMethodEnum {
	return &e
}
...
func (e *DeploymentReleasesUpdate200ApplicationJSONReleaseMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "Promote":
		fallthrough
	case "Rollback":
		*e = DeploymentReleasesUpdate200ApplicationJSONReleaseMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DeploymentReleasesUpdate200ApplicationJSONReleaseMethodEnum: %v", v)
	}
}
