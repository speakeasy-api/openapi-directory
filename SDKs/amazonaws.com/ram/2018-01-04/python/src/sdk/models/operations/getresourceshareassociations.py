...
class GetResourceShareAssociationsRequestBody:
    association_type: GetResourceShareAssociationsRequestBodyAssociationTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('associationType') }})
    association_status: Optional[GetResourceShareAssociationsRequestBodyAssociationStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('associationStatus') }})
...
class GetResourceShareAssociationsRequest:
    headers: GetResourceShareAssociationsHeaders = dataclasses.field()
    query_params: GetResourceShareAssociationsQueryParams = dataclasses.field()
    request: GetResourceShareAssociationsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
