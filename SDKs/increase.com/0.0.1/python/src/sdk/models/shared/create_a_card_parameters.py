...
class CreateACardParameters:
    ...
    r"""The Account the card should belong to."""  
    billing_address: Optional[CreateACardParametersBillingAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('billing_address'), 'exclude': lambda f: f is None }})
    r"""The card's billing address."""  
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('description'), 'exclude': lambda f: f is None }})
    r"""The description you choose to give the card."""  
    digital_wallet: Optional[CreateACardParametersDigitalWallet] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('digital_wallet'), 'exclude': lambda f: f is None }})
    r"""The contact information used in the two-factor steps for digital wallet card creation. At least one field must be present to complete the digital wallet steps."""  
