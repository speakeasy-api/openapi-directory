 ...
 */
public enum CreateCustomerGatewayRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateCustomerGatewayRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
