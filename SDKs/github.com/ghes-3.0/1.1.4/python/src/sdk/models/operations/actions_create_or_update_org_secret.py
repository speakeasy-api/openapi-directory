...
class ActionsCreateOrUpdateOrgSecretRequestBody:
    visibility: ActionsCreateOrUpdateOrgSecretRequestBodyVisibilityEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('visibility') }})
