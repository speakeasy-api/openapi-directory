...
export const ListRoleServerList = ["https://ip-messaging.twilio.com"] as const;
...
export class ListRoleListRoleResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.IpMessagingV1ServiceRole })
  @Expose({ name: "roles" })
  @Type(() => shared.IpMessagingV1ServiceRole)
