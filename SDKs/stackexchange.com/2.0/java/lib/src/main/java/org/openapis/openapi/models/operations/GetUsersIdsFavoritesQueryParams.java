...
public class GetUsersIdsFavoritesQueryParams {
    /**
    ...
    public GetUsersIdsFavoritesQueryParams withCallback(String callback) {
    ...
    public GetUsersIdsFavoritesQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdsFavoritesQueryParams withFromdate(Long fromdate) {
    ...
    public String max;
    public GetUsersIdsFavoritesQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetUsersIdsFavoritesQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetUsersIdsFavoritesQueryParams withOrder(GetUsersIdsFavoritesOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetUsersIdsFavoritesQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdsFavoritesQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetUsersIdsFavoritesQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetUsersIdsFavoritesQueryParams withSort(GetUsersIdsFavoritesSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetUsersIdsFavoritesQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
