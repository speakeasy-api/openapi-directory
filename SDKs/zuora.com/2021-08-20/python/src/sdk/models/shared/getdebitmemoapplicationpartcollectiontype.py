...
class GetDebitMemoApplicationPartCollectionType:
    ...
    application_parts: Optional[list[shared_getdebitmemoapplicationparttype.GetDebitMemoApplicationPartType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('applicationParts'), 'exclude': lambda f: f is None }})
