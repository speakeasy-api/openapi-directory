...
exports.ListShortCodeResponse = exports.ListShortCodeListShortCodeResponse = exports.ListShortCodeListShortCodeResponseMeta = exports.ListShortCodeRequest = exports.ListShortCodeSecurity = exports.ListShortCodeServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListShortCodeServerList = ["https://proxy.twilio.com"];
var ListShortCodeSecurity = /** @class */ (function (_super) {
    ...
    ], ListShortCodeSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListShortCodeSecurity.prototype, "username", void 0);
...
var ListShortCodeRequest = /** @class */ (function (_super) {
    ...
    ], ListShortCodeRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListShortCodeRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListShortCodeRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListShortCodeRequest.prototype, "serviceSid", void 0);
...
var ListShortCodeListShortCodeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListShortCodeListShortCodeResponseMeta; }),
        __metadata("design:type", ListShortCodeListShortCodeResponseMeta)
    ], ListShortCodeListShortCodeResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ProxyV1ServiceShortCode }),
        (0, class_transformer_1.Expose)({ name: "short_codes" }),
        (0, class_transformer_1.Type)(function () { return shared.ProxyV1ServiceShortCode; }),
...
var ListShortCodeResponse = /** @class */ (function (_super) {
    ...
    ], ListShortCodeResponse.prototype, "rawResponse", void 0);
