...
class ObjectPutAccountPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectPutAccountQueryParams:
...
class ObjectPutAccountRequest:
    headers: ObjectPutAccountHeaders = dataclasses.field()
    path_params: ObjectPutAccountPathParams = dataclasses.field()
    query_params: ObjectPutAccountQueryParams = dataclasses.field()
