...
exports.GetVideosResponse = exports.GetVideosRequest = exports.GetVideosSortEnum = exports.GetVideosFilterEnum = exports.GetVideosDirectionEnum = void 0;
...
var GetVideosRequest = /** @class */ (function (_super) {
    ...
    ], GetVideosRequest.prototype, "containingUri", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=direction",
        }),
        __metadata("design:type", String)
    ], GetVideosRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetVideosRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter_embeddable",
        }),
        __metadata("design:type", Boolean)
    ], GetVideosRequest.prototype, "filterEmbeddable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter_playable",
        }),
        __metadata("design:type", Boolean)
    ], GetVideosRequest.prototype, "filterPlayable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetVideosRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetVideosRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=query" }),
        __metadata("design:type", String)
    ], GetVideosRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetVideosRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=user_id",
        }),
        __metadata("design:type", Number)
    ], GetVideosRequest.prototype, "userId", void 0);
...
var GetVideosResponse = /** @class */ (function (_super) {
    ...
    ], GetVideosResponse.prototype, "rawResponse", void 0);
    __decorate([
