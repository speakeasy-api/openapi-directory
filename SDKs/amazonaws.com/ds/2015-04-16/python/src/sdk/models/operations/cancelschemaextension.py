...
class CancelSchemaExtensionRequest:
    ...
    cancel_schema_extension_request: shared_cancelschemaextensionrequest.CancelSchemaExtensionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
