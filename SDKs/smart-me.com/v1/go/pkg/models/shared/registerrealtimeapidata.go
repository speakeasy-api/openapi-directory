...
func (e RegisterRealtimeAPIDataRegistrationTypeEnum) ToPointer() *RegisterRealtimeAPIDataRegistrationTypeEnum {
	return &e
}
...
func (e *RegisterRealtimeAPIDataRegistrationTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "UserRegistration":
		*e = RegisterRealtimeAPIDataRegistrationTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RegisterRealtimeAPIDataRegistrationTypeEnum: %v", v)
	}
}
