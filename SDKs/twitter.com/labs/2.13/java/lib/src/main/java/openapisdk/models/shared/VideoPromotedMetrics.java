...
public class VideoPromotedMetrics {
    ...
    public VideoPromotedMetrics withPlayback0Count(Integer playback0Count) {
    ...
    public VideoPromotedMetrics withPlayback100Count(Integer playback100Count) {
    ...
    public VideoPromotedMetrics withPlayback25Count(Integer playback25Count) {
    ...
    public VideoPromotedMetrics withPlayback50Count(Integer playback50Count) {
    ...
    public VideoPromotedMetrics withPlayback75Count(Integer playback75Count) {
    ...
    public VideoPromotedMetrics withViewCount(Integer viewCount) {
