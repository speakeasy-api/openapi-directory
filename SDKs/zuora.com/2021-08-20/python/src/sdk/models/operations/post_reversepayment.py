...
class POSTReversePaymentRequest:
    ...
    post_reverse_payment_request: shared_postreversepaymentrequest.POSTReversePaymentRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
