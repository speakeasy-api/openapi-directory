...
export class Debts {
  ...
  getSchedulesScheduleD(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetSchedulesScheduleDResponse =
        new operations.GetSchedulesScheduleDResponse({
        ...
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getSchedulesScheduleDDefaultApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetSchedulesScheduleDDefaultApplicationJSON
              );
          }
          break;
      }
  ...
  getSchedulesScheduleDSubId(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleDSubIdResponse =
        new operations.GetSchedulesScheduleDSubIdResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getSchedulesScheduleDSubIdDefaultApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetSchedulesScheduleDSubIdDefaultApplicationJSON
              );
          }
          break;
      }
