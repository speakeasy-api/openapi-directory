...
import { InstanceTemplatesScopedList } from "./instancetemplatesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum InstanceTemplateAggregatedListWarningCodeEnum {
...
export declare class InstanceTemplateAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InstanceTemplateAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InstanceTemplateAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InstanceTemplateAggregatedListWarningData[];
    /**
 ...
 */
export declare class InstanceTemplateAggregatedList extends SpeakeasyBase {
    /**
     ...
     */
    items?: Record<string, InstanceTemplatesScopedList>;
    /**
     * Type of resource.
     */
    kind?: string;
