...
public class GetOrganizationDevicesStatusesQueryParams {
    ...
    public GetOrganizationDevicesStatusesQueryParams withModels(String[] models) {
        this.models = models;
        return this;
    }
    ...
    public GetOrganizationDevicesStatusesQueryParams withNetworkIds(String[] networkIds) {
    ...
    public GetOrganizationDevicesStatusesQueryParams withProductTypes(GetOrganizationDevicesStatusesProductTypesEnum[] productTypes) {
    ...
    public GetOrganizationDevicesStatusesQueryParams withSerials(String[] serials) {
    ...
    public GetOrganizationDevicesStatusesQueryParams withStatuses(GetOrganizationDevicesStatusesStatusesEnum[] statuses) {
    ...
    public String[] tags;
    public GetOrganizationDevicesStatusesQueryParams withTags(String[] tags) {
        this.tags = tags;
        return this;
    }
    ...
    public GetOrganizationDevicesStatusesQueryParams withTagsFilterType(GetOrganizationDevicesStatusesTagsFilterTypeEnum tagsFilterType) {
