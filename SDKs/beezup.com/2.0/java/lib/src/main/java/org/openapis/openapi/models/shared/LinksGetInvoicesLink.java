...
public class LinksGetInvoicesLink {
    /**
    ...
    public LinksGetInvoicesLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksGetInvoicesLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksGetInvoicesLink withDescription(String description) {
    ...
    public LinksGetInvoicesLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksGetInvoicesLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksGetInvoicesLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksGetInvoicesLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksGetInvoicesLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksGetInvoicesLink withOperationId(String operationId) {
    ...
    public LinksGetInvoicesLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksGetInvoicesLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksGetInvoicesLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
