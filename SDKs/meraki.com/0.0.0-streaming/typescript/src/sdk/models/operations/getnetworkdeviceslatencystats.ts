 ...
 */
export enum GetNetworkDevicesLatencyStatsBandEnum {
  Two4 = "2.4",
  Five = "5",
}

export class GetNetworkDevicesLatencyStatsRequest extends SpeakeasyBase {
  /**
...
export class GetNetworkDevicesLatencyStatsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getNetworkDevicesLatencyStats200ApplicationJSONObjects?: Record<
    string,
    any
  >[];
}
