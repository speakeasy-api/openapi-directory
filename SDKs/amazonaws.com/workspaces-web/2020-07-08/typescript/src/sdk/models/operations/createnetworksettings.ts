...
export class CreateNetworkSettingsRequestBody extends SpeakeasyBase {
  /**
...
export class CreateNetworkSettingsRequest extends SpeakeasyBase {
...
export class CreateNetworkSettingsResponse extends SpeakeasyBase {
  /**
