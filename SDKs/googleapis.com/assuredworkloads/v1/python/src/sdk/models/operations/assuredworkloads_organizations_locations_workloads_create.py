...
class AssuredworkloadsOrganizationsLocationsWorkloadsCreateRequest:
    path_params: AssuredworkloadsOrganizationsLocationsWorkloadsCreatePathParams = dataclasses.field()
    query_params: AssuredworkloadsOrganizationsLocationsWorkloadsCreateQueryParams = dataclasses.field()
    security: AssuredworkloadsOrganizationsLocationsWorkloadsCreateSecurity = dataclasses.field()
