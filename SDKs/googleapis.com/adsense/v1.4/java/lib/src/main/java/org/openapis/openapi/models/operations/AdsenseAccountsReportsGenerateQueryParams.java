...
public class AdsenseAccountsReportsGenerateQueryParams {
    ...
    public AdsenseAccountsReportsGenerateQueryParams withCurrency(String currency) {
    ...
    public AdsenseAccountsReportsGenerateQueryParams withDimension(String[] dimension) {
    ...
    public AdsenseAccountsReportsGenerateQueryParams withEndDate(String endDate) {
    ...
    public AdsenseAccountsReportsGenerateQueryParams withFilter(String[] filter) {
        this.filter = filter;
        return this;
    }
    ...
    public AdsenseAccountsReportsGenerateQueryParams withLocale(String locale) {
        this.locale = locale;
        return this;
    }
    ...
    public AdsenseAccountsReportsGenerateQueryParams withMaxResults(Long maxResults) {
    ...
    public AdsenseAccountsReportsGenerateQueryParams withMetric(String[] metric) {
        this.metric = metric;
        return this;
    }
    ...
    public String[] sort;
    public AdsenseAccountsReportsGenerateQueryParams withSort(String[] sort) {
        this.sort = sort;
        return this;
    }
    ...
    public AdsenseAccountsReportsGenerateQueryParams withStartDate(String startDate) {
    ...
    public AdsenseAccountsReportsGenerateQueryParams withStartIndex(Long startIndex) {
    ...
    public AdsenseAccountsReportsGenerateQueryParams withUseTimezoneReporting(Boolean useTimezoneReporting) {
    ...
    public AdsenseAccountsReportsGenerateQueryParams withUserIp(String userIp) {
        this.userIp = userIp;
        return this;
    }
