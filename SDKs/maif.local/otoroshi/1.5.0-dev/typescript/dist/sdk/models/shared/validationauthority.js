...
var ValidationAuthority = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "alwaysValid" }),
        __metadata("design:type", Boolean)
    ], ValidationAuthority.prototype, "alwaysValid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "badTtl" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "goodTtl" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "noCache" }),
        __metadata("design:type", Boolean)
