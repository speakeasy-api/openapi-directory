 ...
 */
export declare class DescribeVpnGatewaysRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
/**
 ...
 */
export declare class DescribeVpnGatewaysRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeVpnGatewaysRequestFilters[];
