...
exports.HiuFacing = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var HiuFacing = /** @class */ (function () {
    function HiuFacing(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    HiuFacing.prototype.postV05SubscriptionsHiuOnNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05SubscriptionsHiuOnNotifyRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v0.5/subscriptions/hiu/on-notify";
     ...
     *
    **/
    HiuFacing.prototype.postV05UsersAuthOnNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
