...
public class UpdateParticipantRequest {
    ...
    public UpdateParticipantRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("CallSid") String callSid, @JsonProperty("ConferenceSid") String conferenceSid) {
        this.accountSid = accountSid;
        this.callSid = callSid;
        this.conferenceSid = conferenceSid;
  }
