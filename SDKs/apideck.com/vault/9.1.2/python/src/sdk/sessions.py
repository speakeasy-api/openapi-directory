...
class Sessions:
    ...
    def sessions_create(self, request: operations.SessionsCreateRequest, security: operations.SessionsCreateSecurity) -> operations.SessionsCreateResponse:
        r"""Create Session
        ...
        res = operations.SessionsCreateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
