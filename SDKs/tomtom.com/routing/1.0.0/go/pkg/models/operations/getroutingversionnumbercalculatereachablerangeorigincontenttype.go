...
func (e GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeVehicleEngineTypeEnum) ToPointer() *GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeVehicleEngineTypeEnum {
	return &e
}

func (e *GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeVehicleEngineTypeEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "combustion":
		fallthrough
	case "electric":
		*e = GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeVehicleEngineTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeVehicleEngineTypeEnum: %v", v)
	}
}
