...
class NotebooksProjectsLocationsSchedulesDeleteRequest:
    path_params: NotebooksProjectsLocationsSchedulesDeletePathParams = dataclasses.field()
    query_params: NotebooksProjectsLocationsSchedulesDeleteQueryParams = dataclasses.field()
    security: NotebooksProjectsLocationsSchedulesDeleteSecurity = dataclasses.field()
