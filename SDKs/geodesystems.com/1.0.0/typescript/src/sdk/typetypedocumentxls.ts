...
export class TypeTypeDocumentXls {
  ...
  searchTypeDocumentXls(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_document_xls";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeDocumentXlsResponse =
        new operations.SearchTypeDocumentXlsResponse({
