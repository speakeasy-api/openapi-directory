 ...
 */
export enum RegionInstanceGroupListWarningCodeEnum {
...
export class RegionInstanceGroupListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class RegionInstanceGroupListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: RegionInstanceGroupListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class RegionInstanceGroupList extends SpeakeasyBase {
  /**
