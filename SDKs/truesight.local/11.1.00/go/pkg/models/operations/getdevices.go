...
func (e GetDevicesDirectionEnum) ToPointer() *GetDevicesDirectionEnum {
	return &e
}
...
func (e *GetDevicesDirectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "asc":
		fallthrough
	case "desc":
		*e = GetDevicesDirectionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDevicesDirectionEnum: %v", v)
	}
}
