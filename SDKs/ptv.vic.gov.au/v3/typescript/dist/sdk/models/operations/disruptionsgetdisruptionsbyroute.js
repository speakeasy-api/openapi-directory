...
exports.DisruptionsGetDisruptionsByRouteResponse = exports.DisruptionsGetDisruptionsByRouteRequest = exports.DisruptionsGetDisruptionsByRouteDisruptionStatusEnum = void 0;
...
var DisruptionsGetDisruptionsByRouteRequest = /** @class */ (function (_super) {
    ...
    ], DisruptionsGetDisruptionsByRouteRequest.prototype, "devid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=disruption_status",
        }),
        __metadata("design:type", String)
    ], DisruptionsGetDisruptionsByRouteRequest.prototype, "disruptionStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=route_id",
        }),
        __metadata("design:type", Number)
    ], DisruptionsGetDisruptionsByRouteRequest.prototype, "routeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=signature",
        }),
        __metadata("design:type", String)
    ], DisruptionsGetDisruptionsByRouteRequest.prototype, "signature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=token" }),
        __metadata("design:type", String)
    ], DisruptionsGetDisruptionsByRouteRequest.prototype, "token", void 0);
...
var DisruptionsGetDisruptionsByRouteResponse = /** @class */ (function (_super) {
    ...
    ], DisruptionsGetDisruptionsByRouteResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
