...
/**
 * DescribeVerifiedAccessTrustProvidersRequestFilters - &lt;p&gt;A filter name and value pair that is used to return a more specific list of results from a describe operation. Filters can be used to match a set of resources by specific criteria, such as tags, attributes, or IDs.&lt;/p&gt; &lt;p&gt;If you specify multiple filters, the filters are joined with an &lt;code&gt;AND&lt;/code&gt;, and the request returns only results that match all of the specified filters.&lt;/p&gt;
 */
