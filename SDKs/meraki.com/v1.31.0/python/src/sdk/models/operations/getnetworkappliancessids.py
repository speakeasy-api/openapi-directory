...
class GetNetworkApplianceSsidsRequest:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetNetworkApplianceSsids200ApplicationJSON:
    ...
    radius_servers: Optional[list[GetNetworkApplianceSsids200ApplicationJSONRadiusServers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radiusServers'), 'exclude': lambda f: f is None }})
...
class GetNetworkApplianceSsidsResponse:
    ...
    get_network_appliance_ssids_200_application_json_objects: Optional[list[GetNetworkApplianceSsids200ApplicationJSON]] = dataclasses.field(default=None)
