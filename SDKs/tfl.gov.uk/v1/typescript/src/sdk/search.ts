...
export class Search {
  ...
  searchBusSchedules(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchBusSchedulesResponse =
        new operations.SearchBusSchedulesResponse({
  ...
  searchMetaCategories(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SearchMetaCategoriesResponse =
        new operations.SearchMetaCategoriesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          ...
          if (utils.matchContentType(contentType, `text/json`)) {
            res.searchMetaCategories200TextJSONStrings = utils.objectToClass(
              httpRes?.data
            );
          }
          break;
  ...
  searchMetaSearchProviders(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/Search/Meta/SearchProviders";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SearchMetaSearchProvidersResponse =
        new operations.SearchMetaSearchProvidersResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  searchMetaSorts(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SearchMetaSortsResponse =
        new operations.SearchMetaSortsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchMetaSorts200ApplicationJSONStrings = utils.objectToClass(
              httpRes?.data
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
          ...
          if (utils.matchContentType(contentType, `text/json`)) {
            res.searchMetaSorts200TextJSONStrings = utils.objectToClass(
              httpRes?.data
            );
          }
          break;
