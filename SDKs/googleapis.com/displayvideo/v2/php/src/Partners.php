...
class Partners 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersChannelsCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}/channels', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersChannelsCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}/channels', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersChannelsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}/channels/{channelId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersChannelsPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}/channels/{channelId}/sites:bulkEdit', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersChannelsSitesBulkEditRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}/channels/{channelId}/sites/{urlOrAppId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersChannelsSitesDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}/channels/{channelId}/sites', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersChannelsSitesListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}/channels/{channelId}/sites:replace', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersChannelsSitesReplaceRequest::class, $request);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersEditAssignedTargetingOptionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersEditAssignedTargetingOptionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersEditAssignedTargetingOptionsResponse
     */
	public function displayvideoPartnersEditAssignedTargetingOptions(
        \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersEditAssignedTargetingOptionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersEditAssignedTargetingOptionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersEditAssignedTargetingOptionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}:editAssignedTargetingOptions', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersEditAssignedTargetingOptionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "bulkEditPartnerAssignedTargetingOptionsRequestInput", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersEditAssignedTargetingOptionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersEditAssignedTargetingOptionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListRequest::class, $request);
