...
class TimeSlicedTcbNetMetricsGeneratedReasonEnum(str, Enum):
...
class TimeSlicedTcbNetMetricsTypeEnum(str, Enum):
    REGULAR = "Regular"
    DISCOUNT = "Discount"
...
class TimeSlicedTcbNetMetrics:
    ...
    generated_reason: Optional[TimeSlicedTcbNetMetricsGeneratedReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('generatedReason') }})
    ...
    type: Optional[TimeSlicedTcbNetMetricsTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
