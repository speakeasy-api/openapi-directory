...
class PostCreditMemoFromPrpcHeaders:
...
@dataclasses.dataclass
class PostCreditMemoFromPrpcRequest:
    headers: PostCreditMemoFromPrpcHeaders = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class PostCreditMemoFromPrpcResponse:
