...
export declare class FindKeywordLeasesSecurity extends SpeakeasyBase {
    password: string;
    username: string;
}
export declare class FindKeywordLeasesRequest extends SpeakeasyBase {
    /**
...
export declare class FindKeywordLeasesResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Bad request
     */
