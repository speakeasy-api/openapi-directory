...
from ..shared import security as shared_security
from ..shared import booksvolumesrecommendedrateresponse as shared_booksvolumesrecommendedrateresponse
...
class BooksVolumesRecommendedRateQueryParams:
    rating: BooksVolumesRecommendedRateRatingEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'rating', 'style': 'form', 'explode': True }})
...
class BooksVolumesRecommendedRateRequest:
    query_params: BooksVolumesRecommendedRateQueryParams = dataclasses.field()
    security: BooksVolumesRecommendedRateSecurity = dataclasses.field()
...
class BooksVolumesRecommendedRateResponse:
    ...
    books_volumes_recommended_rate_response: Optional[shared_booksvolumesrecommendedrateresponse.BooksVolumesRecommendedRateResponse] = dataclasses.field(default=None)
