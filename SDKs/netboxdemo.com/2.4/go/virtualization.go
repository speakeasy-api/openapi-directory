...
func (s *Virtualization) VirtualizationChoicesList(ctx context.Context) (*operations.VirtualizationChoicesListResponse, error) {
	...
	res := &operations.VirtualizationChoicesListResponse{
...
func (s *Virtualization) VirtualizationChoicesRead(ctx context.Context, request operations.VirtualizationChoicesReadRequest) (*operations.VirtualizationChoicesReadResponse, error) {
	...
	res := &operations.VirtualizationChoicesReadResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
