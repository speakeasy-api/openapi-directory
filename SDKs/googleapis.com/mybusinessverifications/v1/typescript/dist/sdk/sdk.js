...
var verificationtokens_1 = require("./verificationtokens");
exports.ServerList = [
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.verificationTokens = new verificationtokens_1.VerificationTokens(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
