...
public class GetKeyPairResponse {
    ...
    public org.openapis.openapi.models.shared.GetKeyPairResult getKeyPairResult;

    public GetKeyPairResponse withGetKeyPairResult(org.openapis.openapi.models.shared.GetKeyPairResult getKeyPairResult) {
    ...
    public GetKeyPairResponse withStatusCode(Integer statusCode) {
    ...
    public GetKeyPairResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public GetKeyPairResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
