...
public class RecommenderProjectsLocationsRecommendersRecommendationsMarkSucceededRequest {
    ...
    public openapisdk.models.shared.GoogleCloudRecommenderV1beta1MarkRecommendationSucceededRequest request;
    public RecommenderProjectsLocationsRecommendersRecommendationsMarkSucceededRequest withRequest(openapisdk.models.shared.GoogleCloudRecommenderV1beta1MarkRecommendationSucceededRequest request) {
