...
type AndroiddeviceprovisioningCustomersDpcsListPathParams struct {
...
type AndroiddeviceprovisioningCustomersDpcsListQueryParams struct {
	// V1 error format.
...
type AndroiddeviceprovisioningCustomersDpcsListRequest struct {
...
type AndroiddeviceprovisioningCustomersDpcsListResponse struct {
	ContentType string
	// Successful response
