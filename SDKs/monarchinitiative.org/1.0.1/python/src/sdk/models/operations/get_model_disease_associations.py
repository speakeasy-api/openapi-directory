...
class GetModelDiseaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetModelDiseaseAssociationsQueryParams:
...
class GetModelDiseaseAssociationsRequest:
    path_params: GetModelDiseaseAssociationsPathParams = dataclasses.field()
    query_params: GetModelDiseaseAssociationsQueryParams = dataclasses.field()
