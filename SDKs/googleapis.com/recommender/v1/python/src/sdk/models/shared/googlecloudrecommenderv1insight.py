...
class GoogleCloudRecommenderV1Insight:
    ...
    associated_recommendations: Optional[list[shared_googlecloudrecommenderv1insightrecommendationreference.GoogleCloudRecommenderV1InsightRecommendationReference]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('associatedRecommendations'), 'exclude': lambda f: f is None }})
    r"""Recommendations derived from this insight."""  
    category: Optional[GoogleCloudRecommenderV1InsightCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category'), 'exclude': lambda f: f is None }})
    r"""Category being targeted by the insight."""  
    ...
    severity: Optional[GoogleCloudRecommenderV1InsightSeverityEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('severity'), 'exclude': lambda f: f is None }})
    r"""Insight's severity."""  
    state_info: Optional[shared_googlecloudrecommenderv1insightstateinfo.GoogleCloudRecommenderV1InsightStateInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('stateInfo'), 'exclude': lambda f: f is None }})
