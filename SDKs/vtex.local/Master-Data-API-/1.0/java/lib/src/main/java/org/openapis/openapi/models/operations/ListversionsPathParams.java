...
public class ListversionsPathParams {
    /**
    ...
    public ListversionsPathParams withDataEntityName(String dataEntityName) {
    ...
    public String id;
    public ListversionsPathParams withId(String id) {
        this.id = id;
        return this;
    }
