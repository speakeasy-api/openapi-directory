...
from ..shared import cannotlistparentofrootexception as shared_cannotlistparentofrootexception
...
class ListObjectParentsResponse:
    ...
    cannot_list_parent_of_root_exception: Optional[shared_cannotlistparentofrootexception.CannotListParentOfRootException] = dataclasses.field(default=None)
