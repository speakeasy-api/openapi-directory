...
class GooglePrivacyDlpV2Dictionary:
    ...
    cloud_storage_path: Optional[shared_googleprivacydlpv2cloudstoragepath.GooglePrivacyDlpV2CloudStoragePath] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cloudStoragePath') }})
