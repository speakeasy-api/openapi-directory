...
class UpdateHTTPNamespaceRequest:
    ...
    update_http_namespace_request: shared_updatehttpnamespacerequest.UpdateHTTPNamespaceRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
