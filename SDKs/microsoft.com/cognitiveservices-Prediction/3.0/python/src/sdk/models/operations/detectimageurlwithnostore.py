...
class DetectImageURLWithNoStorePathParams:
...
@dataclasses.dataclass
class DetectImageURLWithNoStoreQueryParams:
...
@dataclasses.dataclass
class DetectImageURLWithNoStoreRequests:
...
@dataclasses.dataclass
class DetectImageURLWithNoStoreRequest:
    path_params: DetectImageURLWithNoStorePathParams = dataclasses.field()
    query_params: DetectImageURLWithNoStoreQueryParams = dataclasses.field()
    request: DetectImageURLWithNoStoreRequests = dataclasses.field()
    

@dataclasses.dataclass
class DetectImageURLWithNoStoreResponse:
