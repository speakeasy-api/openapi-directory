...
class GetLocationRulesQueryParams:
...
class GetLocationRules200ApplicationJSON:
    ...
    results: Optional[list[shared_locationrule.LocationRule]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    

@dataclasses.dataclass
class GetLocationRulesRequest:
    query_params: GetLocationRulesQueryParams = dataclasses.field()
