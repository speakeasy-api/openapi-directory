...
class ListSipIPAccessControlListMappingListSipIPAccessControlListMappingResponse:
    ...
    ip_access_control_list_mappings: Optional[list[shared_api_v2010_account_sip_sip_domain_sip_ip_access_control_list_mapping.APIV2010AccountSipSipDomainSipIPAccessControlListMapping]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ip_access_control_list_mappings'), 'exclude': lambda f: f is None }})  
