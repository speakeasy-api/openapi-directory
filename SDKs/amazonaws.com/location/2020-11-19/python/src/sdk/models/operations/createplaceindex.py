...
class CreatePlaceIndexRequestBody:
    ...
    pricing_plan: CreatePlaceIndexRequestBodyPricingPlanEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('PricingPlan') }})
    data_source_configuration: Optional[CreatePlaceIndexRequestBodyDataSourceConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DataSourceConfiguration') }})
...
class CreatePlaceIndexRequest:
    headers: CreatePlaceIndexHeaders = dataclasses.field()
    request: CreatePlaceIndexRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
