...
export declare class SasportalPoliciesTestSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalPoliciesTestSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalPoliciesTestSecurity extends SpeakeasyBase {
    option1?: SasportalPoliciesTestSecurityOption1;
    option2?: SasportalPoliciesTestSecurityOption2;
}
