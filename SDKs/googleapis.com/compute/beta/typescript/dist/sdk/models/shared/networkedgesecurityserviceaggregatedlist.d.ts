 ...
 */
export declare enum NetworkEdgeSecurityServiceAggregatedListWarningCodeEnum {
...
export declare class NetworkEdgeSecurityServiceAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NetworkEdgeSecurityServiceAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class NetworkEdgeSecurityServiceAggregatedList extends SpeakeasyBase {
    etag?: string;
    /**
