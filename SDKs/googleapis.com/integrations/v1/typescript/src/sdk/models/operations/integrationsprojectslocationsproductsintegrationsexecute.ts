...
export class IntegrationsProjectsLocationsProductsIntegrationsExecuteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsProductsIntegrationsExecuteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsProductsIntegrationsExecuteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
