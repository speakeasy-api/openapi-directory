 ...
 */
export declare enum CreateNatGatewayRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateNatGatewayRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateNatGatewayRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: CreateNatGatewayRequestTagSpecificationsResourceTypeEnum;
    tags?: CreateNatGatewayRequestTagSpecificationsTags[];
}
export declare class CreateNatGatewayRequest extends SpeakeasyBase {
    allocationId?: string;
    clientToken?: string;
