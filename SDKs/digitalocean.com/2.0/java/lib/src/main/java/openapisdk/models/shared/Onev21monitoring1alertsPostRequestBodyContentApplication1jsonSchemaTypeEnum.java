...
public enum Onev21monitoring1alertsPostRequestBodyContentApplication1jsonSchemaTypeEnum {
    ...
    private Onev21monitoring1alertsPostRequestBodyContentApplication1jsonSchemaTypeEnum(String value) {
        this.value = value;
    }
}
