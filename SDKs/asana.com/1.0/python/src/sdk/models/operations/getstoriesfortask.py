...
class GetStoriesForTask200ApplicationJSON:
    r"""Successfully retrieved the specified task's stories."""
    
    data: Optional[list[shared_storycompact.StoryCompact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
