...
var Jobs = /** @class */ (function () {
    ...
    **/
    Jobs.prototype.getJob = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetJobRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/jobs/{job_gid}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getJob200ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
