...
public class DistributionGroupsAddUsersForOrgRequest {
    ...
    public DistributionGroupsAddUsersForOrgRequest(@JsonProperty("RequestBody") DistributionGroupsAddUsersForOrgRequestBody requestBody, @JsonProperty("distribution_group_name") String distributionGroupName, @JsonProperty("org_name") String orgName) {
        this.requestBody = requestBody;
        this.distributionGroupName = distributionGroupName;
        this.orgName = orgName;
  }
