...
<https://docs.github.com/enterprise-server@3.1/rest/reference/oauth-authorizations#create-a-new-authorization>
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/oauth-authorizations#delete-an-authorization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsDeleteAuthorizationRequest req = new OauthAuthorizationsDeleteAuthorizationRequest(62636L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/oauth-authorizations#delete-a-grant>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsDeleteGrantRequest req = new OauthAuthorizationsDeleteGrantRequest(21688L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/oauth-authorizations#get-a-single-authorization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetAuthorizationRequest req = new OauthAuthorizationsGetAuthorizationRequest(241901L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/oauth-authorizations#get-a-single-grant>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetGrantRequest req = new OauthAuthorizationsGetGrantRequest(137251L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/oauth-authorizations#get-or-create-an-authorization-for-a-specific-app>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetOrCreateAuthorizationForAppRequest req = new OauthAuthorizationsGetOrCreateAuthorizationForAppRequest(                new OauthAuthorizationsGetOrCreateAuthorizationForAppRequestBody("eum") {{
                                fingerprint = "eius";
                                note = "Update all gems";
                                noteUrl = "rem";
                                scopes = new String[]{{
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/oauth-authorizations#get-or-create-an-authorization-for-a-specific-app-and-fingerprint>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequest req = new OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequest(                new OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequestBody("minima") {{
                                note = "Update all gems";
                                noteUrl = "beatae";
                                scopes = new String[]{{
                                    add("provident"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/oauth-authorizations#list-your-authorizations>
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/oauth-authorizations#list-your-grants>
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/oauth-authorizations#update-an-existing-authorization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsUpdateAuthorizationRequest req = new OauthAuthorizationsUpdateAuthorizationRequest(780931L) {{
