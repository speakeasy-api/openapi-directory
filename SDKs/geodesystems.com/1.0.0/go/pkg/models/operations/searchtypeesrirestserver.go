...
type SearchTypeEsriRestserverQueryParams struct {
...
type SearchTypeEsriRestserverRequest struct {
	QueryParams SearchTypeEsriRestserverQueryParams
}

type SearchTypeEsriRestserverResponse struct {
	ContentType string
	StatusCode  int
