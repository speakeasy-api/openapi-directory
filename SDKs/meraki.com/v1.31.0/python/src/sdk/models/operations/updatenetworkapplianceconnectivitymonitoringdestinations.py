...
class UpdateNetworkApplianceConnectivityMonitoringDestinationsRequestBodyDestinations:
    ...
    r"""Description of the testing destination. Optional, defaults to null"""  
...
class UpdateNetworkApplianceConnectivityMonitoringDestinationsRequestBody:
    ...
    destinations: Optional[list[UpdateNetworkApplianceConnectivityMonitoringDestinationsRequestBodyDestinations]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destinations'), 'exclude': lambda f: f is None }})
...
class UpdateNetworkApplianceConnectivityMonitoringDestinationsRequest:
    ...
    request_body: Optional[UpdateNetworkApplianceConnectivityMonitoringDestinationsRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
