...
export class GkehubProjectsLocationsFeaturesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkehubProjectsLocationsFeaturesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GkehubProjectsLocationsFeaturesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
