...
public class DeleteDeviceSecretPathParams {
    /**
    ...
    public DeleteDeviceSecretPathParams withDeviceSid(String deviceSid) {
    ...
    public String key;
    public DeleteDeviceSecretPathParams withKey(String key) {
        this.key = key;
        return this;
    }
