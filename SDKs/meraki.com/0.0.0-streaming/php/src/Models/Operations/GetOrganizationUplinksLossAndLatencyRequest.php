...
class GetOrganizationUplinksLossAndLatencyRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetOrganizationUplinksLossAndLatencyUplinkEnum $uplink
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=uplink')]
    public ?GetOrganizationUplinksLossAndLatencyUplinkEnum $uplink = null;
