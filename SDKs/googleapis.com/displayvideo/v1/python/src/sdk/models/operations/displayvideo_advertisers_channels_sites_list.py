...
class DisplayvideoAdvertisersChannelsSitesListRequest:
    path_params: DisplayvideoAdvertisersChannelsSitesListPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersChannelsSitesListQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersChannelsSitesListSecurity = dataclasses.field()
