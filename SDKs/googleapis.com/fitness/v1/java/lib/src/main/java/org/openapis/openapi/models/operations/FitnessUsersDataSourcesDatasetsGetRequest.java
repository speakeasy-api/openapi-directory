...
public class FitnessUsersDataSourcesDatasetsGetRequest {
    ...
    public FitnessUsersDataSourcesDatasetsGetRequest(@JsonProperty("dataSourceId") String dataSourceId, @JsonProperty("datasetId") String datasetId, @JsonProperty("userId") String userId) {
        this.dataSourceId = dataSourceId;
        this.datasetId = datasetId;
        this.userId = userId;
  }
