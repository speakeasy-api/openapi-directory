...
* [fcmdataProjectsAndroidAppsDeliveryDataList](docs/projects/README.md#fcmdataprojectsandroidappsdeliverydatalist) - List aggregate delivery data for the given Android application.
