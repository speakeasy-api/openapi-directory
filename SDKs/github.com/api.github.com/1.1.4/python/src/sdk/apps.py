...
class Apps:
    ...
    def apps_create_content_attachment(self, request: operations.AppsCreateContentAttachmentRequest) -> operations.AppsCreateContentAttachmentResponse:
        ...
        url = utils.generate_url(base_url, "/content_references/{content_reference_id}/attachments", request.path_params)
    ...
    def apps_get_subscription_plan_for_account(self, request: operations.AppsGetSubscriptionPlanForAccountRequest) -> operations.AppsGetSubscriptionPlanForAccountResponse:
        ...
        url = utils.generate_url(base_url, "/marketplace_listing/accounts/{account_id}", request.path_params)
        ...
        res = operations.AppsGetSubscriptionPlanForAccountResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MarketplacePurchase])
    ...
    def apps_get_subscription_plan_for_account_stubbed(self, request: operations.AppsGetSubscriptionPlanForAccountStubbedRequest) -> operations.AppsGetSubscriptionPlanForAccountStubbedResponse:
        ...
        url = utils.generate_url(base_url, "/marketplace_listing/stubbed/accounts/{account_id}", request.path_params)
        ...
        res = operations.AppsGetSubscriptionPlanForAccountStubbedResponse(status_code=r.status_code, content_type=content_type)
    ...
    def apps_list_accounts_for_plan(self, request: operations.AppsListAccountsForPlanRequest) -> operations.AppsListAccountsForPlanResponse:
        ...
        url = utils.generate_url(base_url, "/marketplace_listing/plans/{plan_id}/accounts", request.path_params)
        ...
        res = operations.AppsListAccountsForPlanResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.MarketplacePurchase]])
    ...
    def apps_list_accounts_for_plan_stubbed(self, request: operations.AppsListAccountsForPlanStubbedRequest) -> operations.AppsListAccountsForPlanStubbedResponse:
        ...
        url = utils.generate_url(base_url, "/marketplace_listing/stubbed/plans/{plan_id}/accounts", request.path_params)
        ...
        res = operations.AppsListAccountsForPlanStubbedResponse(status_code=r.status_code, content_type=content_type)
    ...
    def apps_list_plans(self, request: operations.AppsListPlansRequest) -> operations.AppsListPlansResponse:
        ...
        res = operations.AppsListPlansResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.MarketplaceListingPlan]])
    ...
    def apps_list_plans_stubbed(self, request: operations.AppsListPlansStubbedRequest) -> operations.AppsListPlansStubbedResponse:
        ...
        res = operations.AppsListPlansStubbedResponse(status_code=r.status_code, content_type=content_type)
    ...
    def apps_list_subscriptions_for_authenticated_user(self, request: operations.AppsListSubscriptionsForAuthenticatedUserRequest) -> operations.AppsListSubscriptionsForAuthenticatedUserResponse:
        ...
        res = operations.AppsListSubscriptionsForAuthenticatedUserResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.UserMarketplacePurchase]])
    ...
    def apps_list_subscriptions_for_authenticated_user_stubbed(self, request: operations.AppsListSubscriptionsForAuthenticatedUserStubbedRequest) -> operations.AppsListSubscriptionsForAuthenticatedUserStubbedResponse:
        ...
        res = operations.AppsListSubscriptionsForAuthenticatedUserStubbedResponse(status_code=r.status_code, content_type=content_type)
