 ...
 */
export enum RegistrationsListRegistrationAttributesCategoryEnum {
  Analysis = "analysis",
 ...
 */
export class RegistrationsListRegistrationAttributes extends SpeakeasyBase {
  /**
   * The category of the registered node.
   */
  @SpeakeasyMetadata()
 ...
 */
export class RegistrationsListRegistrationLinks extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsListRegistrationRelationships extends SpeakeasyBase {
  /**
...
export class RegistrationsListRegistration extends SpeakeasyBase {
  /**
   * The properties of the registration entity.
   */
  @SpeakeasyMetadata()
