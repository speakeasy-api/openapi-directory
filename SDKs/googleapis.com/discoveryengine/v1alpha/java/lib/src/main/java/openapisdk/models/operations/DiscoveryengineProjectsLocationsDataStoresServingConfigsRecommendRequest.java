...
public class DiscoveryengineProjectsLocationsDataStoresServingConfigsRecommendRequest {
    ...
    public openapisdk.models.shared.GoogleCloudDiscoveryengineV1alphaRecommendRequest request;
    public DiscoveryengineProjectsLocationsDataStoresServingConfigsRecommendRequest withRequest(openapisdk.models.shared.GoogleCloudDiscoveryengineV1alphaRecommendRequest request) {
