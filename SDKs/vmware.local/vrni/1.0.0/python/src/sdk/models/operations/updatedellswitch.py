...
class UpdateDellSwitchRequest:
    ...
    r"""entity id"""  
    dell_switch_data_source: Optional[shared_dellswitchdatasource.DellSwitchDataSource] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
