...
public class GETOrdersByInvoiceOwnerRequest {
    ...
    public GETOrdersByInvoiceOwnerRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETOrdersByInvoiceOwnerRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETOrdersByInvoiceOwnerRequest withAccountNumber(String accountNumber) {
    ...
    public GETOrdersByInvoiceOwnerRequest withDateFilterOption(String dateFilterOption) {
    ...
    public GETOrdersByInvoiceOwnerRequest withEndDate(LocalDate endDate) {
    ...
    public Long page;
    public GETOrdersByInvoiceOwnerRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GETOrdersByInvoiceOwnerRequest withPageSize(Long pageSize) {
    ...
    public GETOrdersByInvoiceOwnerRequest withStartDate(LocalDate startDate) {
