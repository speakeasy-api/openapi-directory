...
class PartialFindResultUserMessageContract:
    items: Optional[list[shared_usermessagecontract.UserMessageContract]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
