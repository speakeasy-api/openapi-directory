...
export declare class ProdTtSasportalNodesNodesMoveSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalNodesNodesMoveSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalNodesNodesMoveSecurity extends SpeakeasyBase {
    option1?: ProdTtSasportalNodesNodesMoveSecurityOption1;
    option2?: ProdTtSasportalNodesNodesMoveSecurityOption2;
}
