...
export class CloudkmsProjectsLocationsKeyRingsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudkmsProjectsLocationsKeyRingsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudkmsProjectsLocationsKeyRingsListSecurity extends SpeakeasyBase {
...
export class CloudkmsProjectsLocationsKeyRingsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudkmsProjectsLocationsKeyRingsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
