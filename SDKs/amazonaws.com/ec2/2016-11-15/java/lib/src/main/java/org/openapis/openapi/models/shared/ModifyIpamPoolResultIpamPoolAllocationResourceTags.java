 ...
 */
public class ModifyIpamPoolResultIpamPoolAllocationResourceTags {
    
    public String key;

    public ModifyIpamPoolResultIpamPoolAllocationResourceTags withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public ModifyIpamPoolResultIpamPoolAllocationResourceTags withValue(String value) {
        this.value = value;
        return this;
    }
    
    public ModifyIpamPoolResultIpamPoolAllocationResourceTags(){}
}
