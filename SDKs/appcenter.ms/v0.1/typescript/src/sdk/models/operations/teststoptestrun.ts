...
export class TestStopTestRunSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class TestStopTestRunRequest extends SpeakeasyBase {
  /**
 ...
 */
export class TestStopTestRunTestRunTestRunStatistics extends SpeakeasyBase {
  /**
 ...
 * Summary single test run on Xamarin Test Cloud
 */
export class TestStopTestRunTestRun extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "stats" })
  @Type(() => TestStopTestRunTestRunTestRunStatistics)
  stats?: TestStopTestRunTestRunTestRunStatistics;
...
export class TestStopTestRunResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
