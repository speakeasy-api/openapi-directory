 ...
 */
public enum CreateNetworkFirmwareUpgradesRollback200ApplicationJSONReasonsCategoryEnum {
    ...
    private CreateNetworkFirmwareUpgradesRollback200ApplicationJSONReasonsCategoryEnum(String value) {
        this.value = value;
    }
}
