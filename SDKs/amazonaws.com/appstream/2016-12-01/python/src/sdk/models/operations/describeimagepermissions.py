...
class DescribeImagePermissionsRequest:
    ...
    describe_image_permissions_request: shared_describeimagepermissionsrequest.DescribeImagePermissionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
