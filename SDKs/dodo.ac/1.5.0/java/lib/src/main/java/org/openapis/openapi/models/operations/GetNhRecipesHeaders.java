...
public class GetNhRecipesHeaders {
    /**
    ...
    public GetNhRecipesHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhRecipesHeaders withXApiKey(String xApiKey) {
