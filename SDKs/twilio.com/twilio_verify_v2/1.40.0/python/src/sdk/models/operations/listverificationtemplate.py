...
class ListVerificationTemplateRequest:
    ...
    r"""String filter used to query templates with a given friendly name"""  
...
class ListVerificationTemplateListVerificationTemplateResponse:
    ...
    meta: Optional[ListVerificationTemplateListVerificationTemplateResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    templates: Optional[list[shared_verify_v2_verification_template.VerifyV2VerificationTemplate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('templates'), 'exclude': lambda f: f is None }})  
