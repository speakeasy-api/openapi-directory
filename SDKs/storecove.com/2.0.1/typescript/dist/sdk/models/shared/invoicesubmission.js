...
exports.InvoiceSubmission = exports.InvoiceSubmissionModeEnum = void 0;
var utils_1 = require("../../../internal/utils");
var attachment_1 = require("./attachment");
var invoice_1 = require("./invoice");
var invoicedata_1 = require("./invoicedata");
var invoicerecipient_1 = require("./invoicerecipient");
var routing_1 = require("./routing");
var InvoiceSubmissionModeEnum;
(function (InvoiceSubmissionModeEnum) {
    InvoiceSubmissionModeEnum["Direct"] = "direct";
})(InvoiceSubmissionModeEnum = exports.InvoiceSubmissionModeEnum || (exports.InvoiceSubmissionModeEnum = {}));
// InvoiceSubmission
/**
...
var InvoiceSubmission = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=documentUrl" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=invoiceData" }),
        __metadata("design:type", invoicedata_1.InvoiceData)
    ], InvoiceSubmission.prototype, "invoiceData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=invoiceRecipient" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=legalSupplierId" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=supplierId" }),
        __metadata("design:type", Number)
    ], InvoiceSubmission.prototype, "supplierId", void 0);
    return InvoiceSubmission;
}(utils_1.SpeakeasyBase));
exports.InvoiceSubmission = InvoiceSubmission;
