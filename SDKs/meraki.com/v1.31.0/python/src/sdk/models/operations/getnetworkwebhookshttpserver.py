...
@dataclasses.dataclass
class GetNetworkWebhooksHTTPServer200ApplicationJSONPayloadTemplate:
...
class GetNetworkWebhooksHTTPServer200ApplicationJSON:
    ...
    payload_template: Optional[GetNetworkWebhooksHTTPServer200ApplicationJSONPayloadTemplate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payloadTemplate'), 'exclude': lambda f: f is None }})
    r"""The payload template to use when posting data to the HTTP server."""  
...
class GetNetworkWebhooksHTTPServerResponse:
    ...
    get_network_webhooks_http_server_200_application_json_object: Optional[GetNetworkWebhooksHTTPServer200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
