...
exports.PutProductsIdOptionsOptionIdValuesValueIdJsonResponse = exports.PutProductsIdOptionsOptionIdValuesValueIdJsonRequest = void 0;
...
var PutProductsIdOptionsOptionIdValuesValueIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], PutProductsIdOptionsOptionIdValuesValueIdJsonRequest.prototype, "productOptionValueEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PutProductsIdOptionsOptionIdValuesValueIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PutProductsIdOptionsOptionIdValuesValueIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PutProductsIdOptionsOptionIdValuesValueIdJsonRequest.prototype, "login", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=option_id",
        }),
        __metadata("design:type", Number)
    ], PutProductsIdOptionsOptionIdValuesValueIdJsonRequest.prototype, "optionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=value_id",
        }),
        __metadata("design:type", Number)
    ], PutProductsIdOptionsOptionIdValuesValueIdJsonRequest.prototype, "valueId", void 0);
    return PutProductsIdOptionsOptionIdValuesValueIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PutProductsIdOptionsOptionIdValuesValueIdJsonRequest = PutProductsIdOptionsOptionIdValuesValueIdJsonRequest;
var PutProductsIdOptionsOptionIdValuesValueIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], PutProductsIdOptionsOptionIdValuesValueIdJsonResponse.prototype, "rawResponse", void 0);
    return PutProductsIdOptionsOptionIdValuesValueIdJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PutProductsIdOptionsOptionIdValuesValueIdJsonResponse = PutProductsIdOptionsOptionIdValuesValueIdJsonResponse;
