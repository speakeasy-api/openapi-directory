...
class AddFollowersForTaskRequestBody:
    r"""The followers to add to the task."""
...
class AddFollowersForTaskRequest:
    ...
    request_body: AddFollowersForTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The followers to add to the task."""  
...
class AddFollowersForTask200ApplicationJSON:
    r"""Successfully added the specified followers to the task."""
