...
class CodePushDeploymentReleaseRollback201ApplicationJSON
{
     ...
     * $diffPackageMap
     * 
     * @var ?array<string, \OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentReleaseRollback201ApplicationJSONDiffPackageMap> $diffPackageMap
     */
	#[\JMS\Serializer\Annotation\SerializedName('diff_package_map')]
    #[\JMS\Serializer\Annotation\Type('array<string, OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentReleaseRollback201ApplicationJSONDiffPackageMap>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentReleaseRollback201ApplicationJSONReleaseMethodEnum $releaseMethod
     */
	#[\JMS\Serializer\Annotation\SerializedName('release_method')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentReleaseRollback201ApplicationJSONReleaseMethodEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CodePushDeploymentReleaseRollback201ApplicationJSONReleaseMethodEnum $releaseMethod = null;
