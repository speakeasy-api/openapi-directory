...
class Me:
    r"""The `Me` endpoint returns metadata about the authenticated User."""
    ...
    def disconnect_vendor(self, request: operations.DisconnectVendorRequest, security: operations.DisconnectVendorSecurity) -> operations.DisconnectVendorResponse:
        r"""Disconnect Vendor
        ...
        url = utils.generate_url(operations.DisconnectVendorRequest, base_url, '/me/vendors/{vendor}', request)
        ...
        res = operations.DisconnectVendorResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_me(self) -> operations.GetMeResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetMe200ApplicationJSON])
