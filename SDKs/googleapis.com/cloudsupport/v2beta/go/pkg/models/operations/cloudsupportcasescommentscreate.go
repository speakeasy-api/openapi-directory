...
type CloudsupportCasesCommentsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudsupportCasesCommentsCreatePathParams struct {
	// Required. The resource name of Case to which this comment should be added.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type CloudsupportCasesCommentsCreateQueryParams struct {
	// V1 error format.
...
type CloudsupportCasesCommentsCreateResponse struct {
	// Successful response
