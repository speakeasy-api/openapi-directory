...
export enum GETDeregisterTypeActionEnum {
 ...
 */
export enum GETDeregisterTypeTypeEnum {
  Resource = "RESOURCE",
  Module = "MODULE",
  Hook = "HOOK",
}

export enum GETDeregisterTypeVersionEnum {
  TwoThousandAndTen0515 = "2010-05-15",
}

export class GETDeregisterTypeRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETDeregisterTypeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
