...
class UpdateShipmentResponseBodyDeliveryConfirmationEnum(str, Enum):
...
class UpdateShipmentResponseBodyInternationalShipmentOptionsPackageContentsEnum(str, Enum):
...
class UpdateShipmentResponseBodyInternationalShipmentOptionsNonDeliveryEnum(str, Enum):
...
class UpdateShipmentResponseBodyInternationalShipmentOptions:
    ...
    contents: UpdateShipmentResponseBodyInternationalShipmentOptionsPackageContentsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contents') }})
    r"""The type of contents in this shipment.  This may impact import duties or customs treatment."""  
    non_delivery: UpdateShipmentResponseBodyInternationalShipmentOptionsNonDeliveryEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('non_delivery') }})
...
class UpdateShipmentResponseBodyInsuranceProviderEnum(str, Enum):
...
class UpdateShipmentResponseBodyOriginTypeEnum(str, Enum):
    r"""Indicates if the package will be picked up or dropped off by the carrier"""
    PICKUP = 'pickup'
    DROP_OFF = 'drop_off'

class UpdateShipmentResponseBodyShipmentStatusEnum(str, Enum):
...
class UpdateShipmentResponseBody:
    ...
    address_validation: shared_address_validation_result.AddressValidationResult = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address_validation') }})
    ...
    confirmation: UpdateShipmentResponseBodyDeliveryConfirmationEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('confirmation') }})
    ...
    customs: UpdateShipmentResponseBodyInternationalShipmentOptions = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('customs') }})
    ...
    insurance_provider: UpdateShipmentResponseBodyInsuranceProviderEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('insurance_provider') }})
    ...
    shipment_status: UpdateShipmentResponseBodyShipmentStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shipment_status') }})
    ...
    total_weight: UpdateShipmentResponseBodyWeight = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('total_weight') }})
    ...
    origin_type: Optional[UpdateShipmentResponseBodyOriginTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin_type'), 'exclude': lambda f: f is None }})
    r"""Indicates if the package will be picked up or dropped off by the carrier"""  
