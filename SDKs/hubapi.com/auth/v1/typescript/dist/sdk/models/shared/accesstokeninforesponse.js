...
var AccessTokenInfoResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "scope_to_scope_group_pks" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "trial_scope_to_scope_group_pks" }),
        __metadata("design:type", Array)
    ], AccessTokenInfoResponse.prototype, "trialScopeToScopeGroupPks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "trial_scopes" }),
        __metadata("design:type", Array)
