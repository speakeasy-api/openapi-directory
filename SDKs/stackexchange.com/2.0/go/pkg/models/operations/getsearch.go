...
func (e GetSearchOrderEnum) ToPointer() *GetSearchOrderEnum {
	return &e
}

func (e *GetSearchOrderEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "desc":
		fallthrough
	case "asc":
		*e = GetSearchOrderEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSearchOrderEnum: %v", v)
	}
}
...
func (e GetSearchSortEnum) ToPointer() *GetSearchSortEnum {
	return &e
}

func (e *GetSearchSortEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "votes":
		fallthrough
	case "relevance":
		*e = GetSearchSortEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSearchSortEnum: %v", v)
	}
}
