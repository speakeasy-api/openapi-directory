...
public class DELETERSRequest {
    ...
    public DELETERSRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public DELETERSRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public DELETERSRequest withRsNumber(String rsNumber) {
