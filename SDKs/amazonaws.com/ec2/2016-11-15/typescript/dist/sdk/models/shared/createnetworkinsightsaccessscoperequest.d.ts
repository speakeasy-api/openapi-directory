...
import { PathStatementRequest } from "./pathstatementrequest";
import { ResourceStatementRequest } from "./resourcestatementrequest";
/**
 * Describes a through resource statement.
 */
export declare class CreateNetworkInsightsAccessScopeRequestExcludePathsThroughResources extends SpeakeasyBase {
    resourceStatement?: ResourceStatementRequest;
}
/**
 * Describes a path.
 */
export declare class CreateNetworkInsightsAccessScopeRequestExcludePaths extends SpeakeasyBase {
 ...
 * Describes a through resource statement.
 */
export declare class CreateNetworkInsightsAccessScopeRequestMatchPathsThroughResources extends SpeakeasyBase {
    resourceStatement?: ResourceStatementRequest;
}
/**
 * Describes a path.
 */
export declare class CreateNetworkInsightsAccessScopeRequestMatchPaths extends SpeakeasyBase {
    destination?: PathStatementRequest;
    source?: PathStatementRequest;
 ...
 */
export declare enum CreateNetworkInsightsAccessScopeRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateNetworkInsightsAccessScopeRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateNetworkInsightsAccessScopeRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateNetworkInsightsAccessScopeRequest extends SpeakeasyBase {
    clientToken: string;
    dryRun?: boolean;
