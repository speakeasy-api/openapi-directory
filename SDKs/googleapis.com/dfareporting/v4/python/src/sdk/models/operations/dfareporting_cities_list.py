...
class DfareportingCitiesListRequest:
    ...
    r"""Select only cities from these countries."""  
    ...
    r"""Select only cities with these DART IDs."""  
    ...
    r"""Select only cities with names starting with this prefix."""  
    ...
    r"""Select only cities from these regions."""  
