...
var EventRankingRankings = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=extra_stats" }),
...
var EventRanking = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=extra_stats_info", elemType: EventRankingExtraStatsInfo }),
        __metadata("design:type", Array)
    ], EventRanking.prototype, "extraStatsInfo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rankings", elemType: EventRankingRankings }),
        __metadata("design:type", Array)
    ], EventRanking.prototype, "rankings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sort_order_info", elemType: EventRankingSortOrderInfo }),
        __metadata("design:type", Array)
