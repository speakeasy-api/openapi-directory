...
class UpdateFlowRequestBody:
    ...
    source_flow_config: UpdateFlowRequestBodySourceFlowConfig = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('sourceFlowConfig') }})
    tasks: list[shared_task.Task] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('tasks') }})
    trigger_config: UpdateFlowRequestBodyTriggerConfig = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('triggerConfig') }})
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('description') }})
    

@dataclasses.dataclass
class UpdateFlowRequest:
    headers: UpdateFlowHeaders = dataclasses.field()
    request: UpdateFlowRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
