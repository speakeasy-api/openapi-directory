...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/listennotes.com/2.0/python
```
...
* `get_podcast_audience` - Fetch audience demographics for a podcast
...
* `get_related_searches` - Fetch related search terms
* `get_trending_searches` - Fetch trending search terms
