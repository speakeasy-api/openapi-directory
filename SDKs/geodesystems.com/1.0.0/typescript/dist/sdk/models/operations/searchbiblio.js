...
exports.SearchBiblioResponse = exports.SearchBiblioRequest = exports.SearchBiblioQueryParams = void 0;
...
var SearchBiblioQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.biblio.institution" }),
        __metadata("design:type", String)
    ], SearchBiblioQueryParams.prototype, "searchBiblioInstitution", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.biblio.other_authors" }),
        __metadata("design:type", String)
    ], SearchBiblioQueryParams.prototype, "searchBiblioOtherAuthors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.biblio.primary_author" }),
        __metadata("design:type", String)
    ], SearchBiblioQueryParams.prototype, "searchBiblioPrimaryAuthor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.biblio.publication" }),
        __metadata("design:type", String)
    ], SearchBiblioQueryParams.prototype, "searchBiblioPublication", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.biblio.type" }),
        __metadata("design:type", String)
...
exports.SearchBiblioQueryParams = SearchBiblioQueryParams;
