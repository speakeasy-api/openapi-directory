...
class DeviceWithConfigContextFace:
    ...
    label: DeviceWithConfigContextFaceLabelEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label') }})  
    value: DeviceWithConfigContextFaceValueEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value') }})  
...
class DeviceWithConfigContextStatus:
    ...
    label: DeviceWithConfigContextStatusLabelEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label') }})  
    value: DeviceWithConfigContextStatusValueEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value') }})  
...
class DeviceWithConfigContext:
    ...
    face: Optional[DeviceWithConfigContextFace] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('face'), 'exclude': lambda f: f is None }})  
    ...
    status: Optional[DeviceWithConfigContextStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
