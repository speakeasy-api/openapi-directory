...
export class ListFieldLevelEncryptionProfiles20181105Request extends SpeakeasyBase {
  /**
...
export class ListFieldLevelEncryptionProfiles20181105Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
