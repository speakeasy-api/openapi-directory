 ...
 */
export declare class DescribeVpcEndpointConnectionNotificationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeVpcEndpointConnectionNotificationsRequest extends SpeakeasyBase {
