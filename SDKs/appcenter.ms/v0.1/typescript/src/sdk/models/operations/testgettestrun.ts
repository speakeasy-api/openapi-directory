...
export class TestGetTestRunSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class TestGetTestRunRequest extends SpeakeasyBase {
  /**
 ...
 */
export class TestGetTestRunTestRunTestRunStatistics extends SpeakeasyBase {
  /**
 ...
 * Summary single test run on Xamarin Test Cloud
 */
export class TestGetTestRunTestRun extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "stats" })
  @Type(() => TestGetTestRunTestRunTestRunStatistics)
...
export class TestGetTestRunResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
