...
class PatchFormFieldSets:
    ...
    form_fields: Optional[list[PatchFormFieldSetsFormFields]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('form_fields'), 'exclude': lambda f: f is None }, 'form': { 'field_name': 'form_fields', 'json': True }, 'multipart_form': { 'field_name': 'form_fields', 'json': True }})  
