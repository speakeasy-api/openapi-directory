...
func (s *transfer) GetTransfer(ctx context.Context, request operations.GetTransferRequest, security operations.GetTransferSecurity) (*operations.GetTransferResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/transfer/{transfer_Id}", request, nil)
	if err != nil {
