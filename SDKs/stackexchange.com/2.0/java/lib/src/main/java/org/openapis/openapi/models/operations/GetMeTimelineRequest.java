...
public class GetMeTimelineRequest {
    ...
    public GetMeTimelineRequest withCallback(String callback) {
    ...
    public GetMeTimelineRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeTimelineRequest withFromdate(Long fromdate) {
    ...
    public GetMeTimelineRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeTimelineRequest withPagesize(Long pagesize) {
    ...
    public GetMeTimelineRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetMeTimelineRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetMeTimelineRequest(@JsonProperty("site") String site) {
        this.site = site;
  }
}
