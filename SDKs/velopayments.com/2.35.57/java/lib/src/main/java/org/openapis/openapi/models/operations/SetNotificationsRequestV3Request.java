...
public class SetNotificationsRequestV3Request {
    ...
    public SetNotificationsRequestV3Request(@JsonProperty("SetNotificationsRequest_2") org.openapis.openapi.models.shared.SetNotificationsRequest2 setNotificationsRequest2, @JsonProperty("sourceAccountId") String sourceAccountId) {
        this.setNotificationsRequest2 = setNotificationsRequest2;
        this.sourceAccountId = sourceAccountId;
  }
}
