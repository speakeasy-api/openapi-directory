...
var AllowedKeyType = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "ellipticCurve" }),
        (0, class_transformer_1.Type)(function () { return eckeytype_1.EcKeyType; }),
        __metadata("design:type", eckeytype_1.EcKeyType)
    ], AllowedKeyType.prototype, "ellipticCurve", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "rsa" }),
        (0, class_transformer_1.Type)(function () { return rsakeytype_1.RsaKeyType; }),
