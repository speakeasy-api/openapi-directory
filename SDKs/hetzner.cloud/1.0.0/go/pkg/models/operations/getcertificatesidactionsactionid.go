...
func (e GetCertificatesIDActionsActionIDActionResponseActionStatusEnum) ToPointer() *GetCertificatesIDActionsActionIDActionResponseActionStatusEnum {
	return &e
}
...
func (e *GetCertificatesIDActionsActionIDActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = GetCertificatesIDActionsActionIDActionResponseActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCertificatesIDActionsActionIDActionResponseActionStatusEnum: %v", v)
	}
}
