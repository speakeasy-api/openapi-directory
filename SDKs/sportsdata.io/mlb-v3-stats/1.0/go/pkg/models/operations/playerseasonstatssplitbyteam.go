...
func (e PlayerSeasonStatsSplitByTeamFormatEnum) ToPointer() *PlayerSeasonStatsSplitByTeamFormatEnum {
	return &e
}
...
func (e *PlayerSeasonStatsSplitByTeamFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = PlayerSeasonStatsSplitByTeamFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PlayerSeasonStatsSplitByTeamFormatEnum: %v", v)
	}
}
