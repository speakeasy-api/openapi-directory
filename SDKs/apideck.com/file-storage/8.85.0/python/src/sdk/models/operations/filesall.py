...
from ..shared import filesfilter as shared_filesfilter
from ..shared import filessort as shared_filessort
...
class FilesAllQueryParams:
    cursor: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'cursor', 'style': 'form', 'explode': True }})
    filter: Optional[shared_filesfilter.FilesFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    ...
    sort: Optional[shared_filessort.FilesSort] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'deepObject', 'explode': True }})
    

@dataclasses.dataclass
class FilesAllHeaders:
...
@dataclasses.dataclass
class FilesAllSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class FilesAllRequest:
    headers: FilesAllHeaders = dataclasses.field()
    query_params: FilesAllQueryParams = dataclasses.field()
    security: FilesAllSecurity = dataclasses.field()
    

@dataclasses.dataclass
class FilesAllResponse:
