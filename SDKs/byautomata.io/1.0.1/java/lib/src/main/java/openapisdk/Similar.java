...
public class Similar {
	...
	public Similar(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    **/
    public openapisdk.models.operations.GetSimilarResponse getSimilar(openapisdk.models.operations.GetSimilarRequest request) throws Exception {
        ...
        openapisdk.models.operations.GetSimilarResponse res = new openapisdk.models.operations.GetSimilarResponse() {{
            getSimilar200ApplicationJSONObject = null;
        }};
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.operations.GetSimilar200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetSimilar200ApplicationJson.class);
