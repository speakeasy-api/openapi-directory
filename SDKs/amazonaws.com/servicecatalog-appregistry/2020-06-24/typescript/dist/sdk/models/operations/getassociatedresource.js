...
exports.GetAssociatedResourceResponse = exports.GetAssociatedResourceRequest = exports.GetAssociatedResourceResourceTypeEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * The type of resource associated with the application.
 */
var GetAssociatedResourceResourceTypeEnum;
(function (GetAssociatedResourceResourceTypeEnum) {
    GetAssociatedResourceResourceTypeEnum["CfnStack"] = "CFN_STACK";
    GetAssociatedResourceResourceTypeEnum["ResourceTagValue"] = "RESOURCE_TAG_VALUE";
})(GetAssociatedResourceResourceTypeEnum = exports.GetAssociatedResourceResourceTypeEnum || (exports.GetAssociatedResourceResourceTypeEnum = {}));
var GetAssociatedResourceRequest = /** @class */ (function (_super) {
    ...
    ], GetAssociatedResourceRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], GetAssociatedResourceRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], GetAssociatedResourceRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], GetAssociatedResourceRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], GetAssociatedResourceRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], GetAssociatedResourceRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], GetAssociatedResourceRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=application",
        }),
        __metadata("design:type", String)
    ], GetAssociatedResourceRequest.prototype, "application", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=resource",
        }),
        __metadata("design:type", String)
    ], GetAssociatedResourceRequest.prototype, "resource", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=resourceType",
        }),
        __metadata("design:type", String)
    ], GetAssociatedResourceRequest.prototype, "resourceType", void 0);
...
var GetAssociatedResourceResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetAssociatedResourceResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
