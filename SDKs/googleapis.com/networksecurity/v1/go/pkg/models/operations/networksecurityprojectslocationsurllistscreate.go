...
type NetworksecurityProjectsLocationsURLListsCreateSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type NetworksecurityProjectsLocationsURLListsCreateRequest struct {
	// V1 error format.
	...
	URLListID *string `queryParam:"style=form,explode=true,name=urlListId"`
}

type NetworksecurityProjectsLocationsURLListsCreateResponse struct {
	ContentType string
	// Successful response
