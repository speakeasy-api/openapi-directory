...
class FirebaseappcheckProjectsAppsExchangeRecaptchaTokenRequest:
    ...
    google_firebase_appcheck_v1beta_exchange_recaptcha_token_request: Optional[shared_googlefirebaseappcheckv1betaexchangerecaptchatokenrequest.GoogleFirebaseAppcheckV1betaExchangeRecaptchaTokenRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
