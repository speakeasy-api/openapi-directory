...
from ..shared import listimagepipelineimagesresponse as shared_listimagepipelineimagesresponse


@dataclasses.dataclass
class ListImagePipelineImagesQueryParams:
    max_results: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'maxResults', 'style': 'form', 'explode': True }})
    next_token: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'nextToken', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class ListImagePipelineImagesHeaders:
...
class ListImagePipelineImagesRequest:
    headers: ListImagePipelineImagesHeaders = dataclasses.field()
    query_params: ListImagePipelineImagesQueryParams = dataclasses.field()
    request: ListImagePipelineImagesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class ListImagePipelineImagesResponse:
    ...
    list_image_pipeline_images_response: Optional[shared_listimagepipelineimagesresponse.ListImagePipelineImagesResponse] = dataclasses.field(default=None)
