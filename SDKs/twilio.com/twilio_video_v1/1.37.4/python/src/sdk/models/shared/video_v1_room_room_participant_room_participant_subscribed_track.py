...
class VideoV1RoomRoomParticipantRoomParticipantSubscribedTrack:
    ...
    kind: Optional[shared_room_participant_subscribed_track_enum_kind_enum.RoomParticipantSubscribedTrackEnumKindEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('kind') }})
    ...
    publisher_sid: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('publisher_sid') }})
