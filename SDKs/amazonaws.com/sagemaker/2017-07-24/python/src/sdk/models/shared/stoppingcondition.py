...
class StoppingCondition:
    ...
    max_wait_time_in_seconds: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MaxWaitTimeInSeconds'), 'exclude': lambda f: f is None }})  
