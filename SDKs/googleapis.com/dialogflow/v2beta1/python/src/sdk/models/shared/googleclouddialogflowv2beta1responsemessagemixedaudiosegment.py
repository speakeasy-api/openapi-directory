...
class GoogleCloudDialogflowV2beta1ResponseMessageMixedAudioSegment:
    ...
    r"""Whether the playback of this segment can be interrupted by the end user's speech and the client should then start the next Dialogflow request."""  
    ...
    r"""Client-specific URI that points to an audio clip accessible to the client."""  
