...
public class CollectionTicketCommentsAllRequest {
    ...
    public CollectionTicketCommentsAllRequest(@JsonProperty("collection_id") String collectionId, @JsonProperty("ticket_id") String ticketId, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.collectionId = collectionId;
        this.ticketId = ticketId;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
