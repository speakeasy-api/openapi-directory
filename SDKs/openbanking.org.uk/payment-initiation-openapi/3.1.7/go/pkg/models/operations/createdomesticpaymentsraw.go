...
type CreateDomesticPaymentsRawSecurity struct {
	PSUOAuth2Security shared.SchemePsuoAuth2Security `security:"scheme,type=oauth2"`
}

type CreateDomesticPaymentsRawHeaders struct {
...
type CreateDomesticPaymentsRawRequest struct {
	Headers CreateDomesticPaymentsRawHeaders
	// Default
	Request  []byte `request:"mediaType=application/jose+jwe"`
	Security CreateDomesticPaymentsRawSecurity
}

type CreateDomesticPaymentsRawResponse struct {
	Body        []byte
	ContentType string
