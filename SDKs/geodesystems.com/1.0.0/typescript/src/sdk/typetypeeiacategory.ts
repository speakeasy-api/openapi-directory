...
export class TypeTypeEiaCategory {
  ...
  searchTypeEiaCategory(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_eia_category";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeEiaCategoryResponse =
        new operations.SearchTypeEiaCategoryResponse({
