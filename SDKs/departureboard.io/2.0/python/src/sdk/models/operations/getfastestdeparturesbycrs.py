...
class GetFastestDeparturesByCRSRequest:
    ...
    r"""The CRS (Computer Reservation System) for the station you wish to get departure information for, e.g. KGX for London Kings Cross."""  
    filter_list: str = dataclasses.field(metadata={'query_param': { 'field_name': 'filterList', 'style': 'form', 'explode': True }})
    r"""The CRS (Computer Reservation System) codes to show the fastest departing services to. Up to 20 destination stations can be specified. These should be split by a comma, for example HAY,EAL,PAD."""  
    ...
    r"""The time window in minutes to offset the departure information by. For example, a value of 20 will show the fastest services departing after 20 minutes."""  
    ...
    r"""The time window to show train services for in minutes. For example, a value of 60 will show the fastest services departing the station in the next 60 minutes."""  
