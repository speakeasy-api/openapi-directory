...
from ..shared import exportableecsservicefield_enum as shared_exportableecsservicefield_enum
...
class ExportECSServiceRecommendationsRequest:
    ...
    fields_to_export: Optional[list[shared_exportableecsservicefield_enum.ExportableECSServiceFieldEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fieldsToExport'), 'exclude': lambda f: f is None }})  
