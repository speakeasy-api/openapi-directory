...
from ..shared import querybatchresponsev3 as shared_querybatchresponsev3
...
class QueryBatchStatusV3Response:
    ...
    query_batch_response_v3: Optional[shared_querybatchresponsev3.QueryBatchResponseV3] = dataclasses.field(default=None)
    r"""Get Batch Status"""  
