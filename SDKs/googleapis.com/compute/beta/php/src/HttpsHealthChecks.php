...
class HttpsHealthChecks 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeHttpsHealthChecksTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeHttpsHealthChecksTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeHttpsHealthChecksTestIamPermissionsResponse
     */
	public function computeHttpsHealthChecksTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeHttpsHealthChecksTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeHttpsHealthChecksTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeHttpsHealthChecksTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/httpsHealthChecks/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeHttpsHealthChecksTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeHttpsHealthChecksTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeHttpsHealthChecksTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
