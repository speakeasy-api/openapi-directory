...
from ..shared import fetchhealthprofileanswersresponse as shared_fetchhealthprofileanswersresponse
from enum import Enum
from typing import Optional

class FetchHealthProfileAnswersIncludeEnum(str, Enum):
    r"""List of related resources to include in the response"""
    PATIENT = 'patient'


@dataclasses.dataclass
class FetchHealthProfileAnswersRequest:
    ...
    r"""Patient id to fetch healt profile answers. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`."""  
    include: Optional[FetchHealthProfileAnswersIncludeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'include', 'style': 'form', 'explode': True }})
    r"""List of related resources to include in the response"""  
...
class FetchHealthProfileAnswersResponse:
    ...
    r"""Unauthorized"""  
    fetch_health_profile_answers_response: Optional[shared_fetchhealthprofileanswersresponse.FetchHealthProfileAnswersResponse] = dataclasses.field(default=None)
    r"""OK"""  
