...
export class CloudchannelAccountsCustomersEntitlementsChangeOfferSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersEntitlementsChangeOfferRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersEntitlementsChangeOfferResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
