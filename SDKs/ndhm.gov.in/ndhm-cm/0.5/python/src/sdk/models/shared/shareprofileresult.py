...
class ShareProfileResult:
    ...
    acknowledgement: shared_shareprofileacknowledgement.ShareProfileAcknowledgement = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('acknowledgement') }})  
