...
export class Reports {
  ...
  doubleclickbidmanagerReportsListreports(
    ...
    security: operations.DoubleclickbidmanagerReportsListreportsSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DoubleclickbidmanagerReportsListreportsSecurity(
        security
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DoubleclickbidmanagerReportsListreportsResponse =
        new operations.DoubleclickbidmanagerReportsListreportsResponse({
