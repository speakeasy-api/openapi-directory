...
exports.ConnectionSettingsUpdateResponse = exports.ConnectionSettingsUpdateRequest = exports.ConnectionSettingsUpdateSecurity = void 0;
...
var ConnectionSettingsUpdateRequest = /** @class */ (function (_super) {
    ...
    ], ConnectionSettingsUpdateRequest.prototype, "connectionInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=resource",
        }),
        __metadata("design:type", String)
    ], ConnectionSettingsUpdateRequest.prototype, "resource", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=service_id",
        }),
        __metadata("design:type", String)
    ], ConnectionSettingsUpdateRequest.prototype, "serviceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=unified_api",
        }),
        __metadata("design:type", String)
    ], ConnectionSettingsUpdateRequest.prototype, "unifiedApi", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], ConnectionSettingsUpdateRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], ConnectionSettingsUpdateRequest.prototype, "xApideckConsumerId", void 0);
...
var ConnectionSettingsUpdateResponse = /** @class */ (function (_super) {
    ...
    ], ConnectionSettingsUpdateResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
