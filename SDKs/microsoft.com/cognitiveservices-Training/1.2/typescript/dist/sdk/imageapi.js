...
var ImageApi = /** @class */ (function () {
    ...
    **/
    ImageApi.prototype.createImagesFromData = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/projects/{projectId}/images", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.imageCreateSummary = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    ImageApi.prototype.deleteImageTags = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/projects/{projectId}/images/tags", req.pathParams);
        var client = this._defaultClient;
    ...
    **/
    ImageApi.prototype.getTaggedImages = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/projects/{projectId}/images/tagged", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.images = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.matchContentType(contentType, "text/json")) {
                        res.images = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    ImageApi.prototype.getUntaggedImages = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/projects/{projectId}/images/untagged", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
