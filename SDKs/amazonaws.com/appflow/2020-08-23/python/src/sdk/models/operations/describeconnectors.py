...
class DescribeConnectorsRequestBody:
    ...
    connector_types: Optional[list[shared_connectortype_enum.ConnectorTypeEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connectorTypes'), 'exclude': lambda f: f is None }})
    r"""The type of connector, such as Salesforce, Amplitude, and so on."""  
    max_results: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxResults'), 'exclude': lambda f: f is None }})
    r"""The maximum number of items that should be returned in the result set. The default is 20."""  
...
class DescribeConnectorsRequest:
    ...
    request_body: DescribeConnectorsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
