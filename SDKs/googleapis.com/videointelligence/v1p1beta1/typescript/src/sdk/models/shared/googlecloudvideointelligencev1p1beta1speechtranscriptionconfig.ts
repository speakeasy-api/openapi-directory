 ...
 */
export class GoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({
    elemType: GoogleCloudVideointelligenceV1p1beta1SpeechContext,
  })
