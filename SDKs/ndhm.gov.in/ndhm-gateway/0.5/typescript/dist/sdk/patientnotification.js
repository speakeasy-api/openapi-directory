...
var PatientNotification = /** @class */ (function () {
    function PatientNotification(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    PatientNotification.prototype.postV05PatientsSmsNotify = function (req, config) {
        var _a;
     ...
     *
    **/
    PatientNotification.prototype.postV05PatientsSmsOnNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
