...
public class AvatarsGetQRSecurity {
    ...
    public AvatarsGetQRSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public AvatarsGetQRSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public AvatarsGetQRSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public AvatarsGetQRSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
