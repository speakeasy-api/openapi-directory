...
class GoogleAppsDriveLabelsV2betaLifecycle:
    ...
    state: Optional[GoogleAppsDriveLabelsV2betaLifecycleStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
