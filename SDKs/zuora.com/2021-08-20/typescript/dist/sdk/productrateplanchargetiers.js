...
var ProductRatePlanChargeTiers = /** @class */ (function () {
    ...
    **/
    ProductRatePlanChargeTiers.prototype.objectGetProductRatePlanChargeTier = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/object/product-rate-plan-charge-tier/{id}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.proxyGetProductRatePlanChargeTier = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
