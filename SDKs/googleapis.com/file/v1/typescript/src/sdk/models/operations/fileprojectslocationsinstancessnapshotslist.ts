...
export class FileProjectsLocationsInstancesSnapshotsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FileProjectsLocationsInstancesSnapshotsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FileProjectsLocationsInstancesSnapshotsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
