...
class PatchRemoteServersIDRequestBodyFilesAgentPermissionSetEnum(str, Enum):
...
class PatchRemoteServersIDRequestBody:
    ...
    files_agent_permission_set: Optional[PatchRemoteServersIDRequestBodyFilesAgentPermissionSetEnum] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'files_agent_permission_set' }})
    r"""Local permissions for files agent. read_only, write_only, or read_write"""  
...
class PatchRemoteServersIDRequest:
    ...
    r"""Remote Server ID."""  
    request_body: Optional[PatchRemoteServersIDRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})  
