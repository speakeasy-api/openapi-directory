...
from ..shared import proxycreateunitofmeasure as shared_proxycreateunitofmeasure
...
class ObjectPostUnitOfMeasureQueryParams:
...
@dataclasses.dataclass
class ObjectPostUnitOfMeasureHeaders:
    zuora_entity_ids: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Entity-Ids', 'style': 'simple', 'explode': False }})
    zuora_track_id: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Track-Id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectPostUnitOfMeasureRequest:
    headers: ObjectPostUnitOfMeasureHeaders = dataclasses.field()
    query_params: ObjectPostUnitOfMeasureQueryParams = dataclasses.field()
    request: shared_proxycreateunitofmeasure.ProxyCreateUnitOfMeasure = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class ObjectPostUnitOfMeasureResponse:
