...
/**
 * VcdVappSnapshotDetail - Details for a vApp snapshot.
 */
public class VcdVappSnapshotDetail {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("archivalLocationIds")
    public String[] archivalLocationIds;

    public VcdVappSnapshotDetail withArchivalLocationIds(String[] archivalLocationIds) {
    ...
    public VcdVappSnapshotDetail withCloudState(Long cloudState) {
    ...
    public VcdVappSnapshotDetail withCloudStorageTier(SnapshotCloudStorageTierEnum cloudStorageTier) {
    ...
    public VcdVappSnapshotDetail withConsistencyLevel(String consistencyLevel) {
    ...
    public VcdVappSnapshotDetail withDate(OffsetDateTime date) {
        this.date = date;
        return this;
    }
    
    /**
     * Array that lists the Virtual Machines of the vApp that where excluded from the snapshot.
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("excludedVcdVmMoids")
    public String[] excludedVcdVmMoids;

    public VcdVappSnapshotDetail withExcludedVcdVmMoids(String[] excludedVcdVmMoids) {
        this.excludedVcdVmMoids = excludedVcdVmMoids;
        return this;
    }
    ...
    public VcdVappSnapshotDetail withExpirationDate(OffsetDateTime expirationDate) {
    ...
    public VcdVappSnapshotDetail withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public VcdVappSnapshotDetail withIndexState(Long indexState) {
    ...
    public VcdVappSnapshotDetail withIsCustomRetentionApplied(Boolean isCustomRetentionApplied) {
    ...
    public VcdVappSnapshotDetail withIsOnDemandSnapshot(Boolean isOnDemandSnapshot) {
    ...
    public VcdVappSnapshotDetail withIsPlacedOnLegalHold(Boolean isPlacedOnLegalHold) {
    ...
    public VcdVappSnapshotDetail withIsRetainedByRetentionLockSla(Boolean isRetainedByRetentionLockSla) {
    ...
    public VcdVappSnapshotDetail withIsSynchronized(Boolean isSynchronized) {
        this.isSynchronized = isSynchronized;
        return this;
    }
    
    /**
     * Array that lists the vApp networks in the vApp at the time of the snapshot.
     */
    @JsonProperty("networks")
    public VappNetworkSummary[] networks;

    public VcdVappSnapshotDetail withNetworks(VappNetworkSummary[] networks) {
    ...
    public VcdVappSnapshotDetail withParentSnapshotId(String parentSnapshotId) {
    ...
    public VcdVappSnapshotDetail withReplicationLocationIds(String[] replicationLocationIds) {
    ...
    public VcdVappSnapshotDetail withSlaId(String slaId) {
        this.slaId = slaId;
        return this;
    }
    ...
    public VcdVappSnapshotDetail withSlaName(String slaName) {
    ...
    public VcdVappSnapshotDetail withSnapshotRetentionInfo(SnapshotRetentionInfo snapshotRetentionInfo) {
    ...
    public VcdVappSnapshotDetail withSourceObjectType(String sourceObjectType) {
    ...
    public VcdVappSnapshotDetail withVappName(String vappName) {
        this.vappName = vappName;
        return this;
    }
    
    @JsonProperty("vmSnapshots")
    public VcdVmSnapshotDetail[] vmSnapshots;

    public VcdVappSnapshotDetail withVmSnapshots(VcdVmSnapshotDetail[] vmSnapshots) {
        this.vmSnapshots = vmSnapshots;
        return this;
    }
    
    public VcdVappSnapshotDetail(@JsonProperty("date") OffsetDateTime date, @JsonProperty("id") String id, @JsonProperty("isCustomRetentionApplied") Boolean isCustomRetentionApplied, @JsonProperty("isOnDemandSnapshot") Boolean isOnDemandSnapshot, @JsonProperty("networks") VappNetworkSummary[] networks, @JsonProperty("replicationLocationIds") String[] replicationLocationIds, @JsonProperty("slaId") String slaId, @JsonProperty("slaName") String slaName, @JsonProperty("vappName") String vappName, @JsonProperty("vmSnapshots") VcdVmSnapshotDetail[] vmSnapshots) {
        this.date = date;
        this.id = id;
        this.isCustomRetentionApplied = isCustomRetentionApplied;
        this.isOnDemandSnapshot = isOnDemandSnapshot;
