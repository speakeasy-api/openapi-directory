...
exports.GerUserLikesResponse = exports.GerUserLikesRequest = exports.GerUserLikesSecurity = void 0;
...
var GerUserLikesRequest = /** @class */ (function (_super) {
    ...
    ], GerUserLikesRequest.prototype, "ids", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=user",
        }),
        __metadata("design:type", String)
    ], GerUserLikesRequest.prototype, "user", void 0);
...
var GerUserLikesResponse = /** @class */ (function (_super) {
    ...
    ], GerUserLikesResponse.prototype, "rawResponse", void 0);
