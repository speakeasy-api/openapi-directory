...
class DescribeCustomDomainsRequest:
    headers: DescribeCustomDomainsHeaders = dataclasses.field()
    query_params: DescribeCustomDomainsQueryParams = dataclasses.field()
    request: shared_describecustomdomainsrequest.DescribeCustomDomainsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
