...
export class ListDialingPermissionsHrsPrefixesListDialingPermissionsHrsPrefixesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({
    elemType:
      shared.VoiceV1DialingPermissionsDialingPermissionsCountryDialingPermissionsHrsPrefixes,
  })
  @Expose({ name: "content" })
  @Type(
    () =>
  ...
  @Type(
    () =>
      ListDialingPermissionsHrsPrefixesListDialingPermissionsHrsPrefixesResponseMeta
  )
