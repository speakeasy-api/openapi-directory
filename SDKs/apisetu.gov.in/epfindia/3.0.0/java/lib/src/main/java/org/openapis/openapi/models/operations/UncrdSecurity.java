...
public class UncrdSecurity {
    ...
    public UncrdSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public UncrdSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public UncrdSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
