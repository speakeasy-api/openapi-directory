...
type WelshPafAddressCountryEnum string

const (
	WelshPafAddressCountryEnumWales WelshPafAddressCountryEnum = "Wales"
)

func (e *WelshPafAddressCountryEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	switch s {
	case "Wales":
		*e = WelshPafAddressCountryEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WelshPafAddressCountryEnum: %s", s)
	}
}

type WelshPafAddressCountryIsoEnum string

const (
	WelshPafAddressCountryIsoEnumGbr WelshPafAddressCountryIsoEnum = "GBR"
)

func (e *WelshPafAddressCountryIsoEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	switch s {
	case "GBR":
		*e = WelshPafAddressCountryIsoEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WelshPafAddressCountryIsoEnum: %s", s)
	}
}

type WelshPafAddressCountryIso2Enum string

const (
	WelshPafAddressCountryIso2EnumGb WelshPafAddressCountryIso2Enum = "GB"
)

func (e *WelshPafAddressCountryIso2Enum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	switch s {
	case "GB":
		*e = WelshPafAddressCountryIso2Enum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WelshPafAddressCountryIso2Enum: %s", s)
	}
}

type WelshPafAddressDatasetEnum string

const (
	WelshPafAddressDatasetEnumPafw WelshPafAddressDatasetEnum = "pafw"
)

func (e *WelshPafAddressDatasetEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	switch s {
	case "pafw":
		*e = WelshPafAddressDatasetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WelshPafAddressDatasetEnum: %s", s)
	}
}

type WelshPafAddressLanguageEnum string

const (
	WelshPafAddressLanguageEnumCy WelshPafAddressLanguageEnum = "cy"
)

func (e *WelshPafAddressLanguageEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	switch s {
	case "cy":
		*e = WelshPafAddressLanguageEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WelshPafAddressLanguageEnum: %s", s)
	}
}

// WelshPafAddress - Welsh language alternative for a PAF Address
type WelshPafAddress struct {
	...
	Country        WelshPafAddressCountryEnum     `json:"country"`
	CountryIso     WelshPafAddressCountryIsoEnum  `json:"country_iso"`
	CountryIso2    WelshPafAddressCountryIso2Enum `json:"country_iso_2"`
	...
	Dataset    WelshPafAddressDatasetEnum `json:"dataset"`
	...
	ID       string                      `json:"id"`
	Language WelshPafAddressLanguageEnum `json:"language"`
