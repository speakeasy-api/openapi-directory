...
class IndividualAddressAddressTypeEnum(str, Enum):
    r"""The address type."""
    MAILING = 'Mailing'
...
class IndividualAddressInput:
    ...
    address_type: Optional[IndividualAddressAddressTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('addressType'), 'exclude': lambda f: f is None }})
    r"""The address type."""  
