...
exports.AssetsVolatility = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var AssetsVolatility = /** @class */ (function () {
    function AssetsVolatility(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    AssetsVolatility.prototype.postAssetsVolatility = function (req, config) {
        var _a;
     ...
     *
    **/
    AssetsVolatility.prototype.postAssetsVolatilitySample = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.AssetsVolatility = AssetsVolatility;
