...
from ..shared import invoiceactivityapimodel as shared_invoiceactivityapimodel
from ..shared import invoiceattachmentapimodel as shared_invoiceattachmentapimodel
from ..shared import invoicegatewayapimodel as shared_invoicegatewayapimodel
from ..shared import invoiceitemapimodel as shared_invoiceitemapimodel
from ..shared import invoicepaymentapimodel as shared_invoicepaymentapimodel
...
class InvoiceFullDetailsAPIModel:
    ...
    activities: Optional[list[shared_invoiceactivityapimodel.InvoiceActivityAPIModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Activities'), 'exclude': lambda f: f is None }})
    r"""List of invoice activities. Invoice audit log"""  
    attachments: Optional[list[shared_invoiceattachmentapimodel.InvoiceAttachmentAPIModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Attachments'), 'exclude': lambda f: f is None }})
    ...
    items: Optional[list[shared_invoiceitemapimodel.InvoiceItemAPIModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Items'), 'exclude': lambda f: f is None }})
    ...
    payment_gateways: Optional[list[shared_invoicegatewayapimodel.InvoiceGatewayAPIModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PaymentGateways'), 'exclude': lambda f: f is None }})
    r"""List of enabled payment gateways for this invoice"""  
    payments: Optional[list[shared_invoicepaymentapimodel.InvoicePaymentAPIModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Payments'), 'exclude': lambda f: f is None }})
    r"""List of invoice payments"""  
    ...
    status: Optional[InvoiceFullDetailsAPIModelStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Status'), 'exclude': lambda f: f is None }})
    r"""Indicate the status of the invoice (paid/unpaid/overdue)"""  
