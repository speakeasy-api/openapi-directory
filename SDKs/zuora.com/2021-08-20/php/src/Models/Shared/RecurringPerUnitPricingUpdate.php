...
class RecurringPerUnitPricingUpdate
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RecurringPerUnitPricingUpdatePriceChangeOptionEnum $priceChangeOption
     */
	#[\JMS\Serializer\Annotation\SerializedName('priceChangeOption')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\RecurringPerUnitPricingUpdatePriceChangeOptionEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?RecurringPerUnitPricingUpdatePriceChangeOptionEnum $priceChangeOption = null;
