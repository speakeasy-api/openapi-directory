...
class VirtualizationClusterTypesPartialUpdateRequest:
    ...
    cluster_type_input: shared_clustertype.ClusterTypeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    id: int = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""A unique integer value identifying this cluster type."""  
