...
from ..shared import certificaterefresh as shared_certificaterefresh
...
class PutTlskeyRefreshResponse:
    ...
    certificate_refresh: Optional[shared_certificaterefresh.CertificateRefresh] = dataclasses.field(default=None)
