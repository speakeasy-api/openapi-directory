...
class ServiceBlockUpdateModel:
    ...
    repeat: Optional[shared_repeatupdatemodel.RepeatUpdateModel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('repeat'), 'exclude': lambda f: f is None }})  
