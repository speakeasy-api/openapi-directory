...
public class Apps {
    ...
    **/
     ...
     * You must use a [JWT](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/apps#get-the-authenticated-app - API method documentation
    **/
    ...
    public openapisdk.models.operations.AppsGetInstallationResponse appsGetInstallation(openapisdk.models.operations.AppsGetInstallationRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.Installation out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.Installation.class);
    ...
    **/
     ...
     * You must use a [JWT](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/apps#get-a-webhook-configuration-for-an-app - API method documentation
    **/
    public openapisdk.models.operations.AppsGetWebhookConfigForAppResponse appsGetWebhookConfigForApp() throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/app/hook/config");
        ...
        openapisdk.models.operations.AppsGetWebhookConfigForAppResponse res = new openapisdk.models.operations.AppsGetWebhookConfigForAppResponse() {{
            webhookConfig = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/apps#list-installations-for-the-authenticated-app - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/apps#list-app-installations-accessible-to-the-user-access-token - API method documentation
    **/
     ...
     * You must use an [installation access token](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-an-installation) to access this endpoint.
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/apps#list-repositories-accessible-to-the-app-installation - API method documentation
    **/
    ...
    **/
     ...
     * You must use an [installation access token](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-an-installation) to access this endpoint.
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/apps#revoke-an-installation-access-token - API method documentation
    **/
    ...
    **/
    public openapisdk.models.operations.AppsScopeTokenResponse appsScopeToken(openapisdk.models.operations.AppsScopeTokenRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/applications/{client_id}/token/scoped", request.pathParams);
        ...
        openapisdk.models.operations.AppsScopeTokenResponse res = new openapisdk.models.operations.AppsScopeTokenResponse() {{
            authorization = null;
            basicError = null;
            basicError = null;
            basicError = null;
    ...
    **/
    public openapisdk.models.operations.AppsUpdateWebhookConfigForAppResponse appsUpdateWebhookConfigForApp(openapisdk.models.operations.AppsUpdateWebhookConfigForAppRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/app/hook/config");
        ...
        openapisdk.models.operations.AppsUpdateWebhookConfigForAppResponse res = new openapisdk.models.operations.AppsUpdateWebhookConfigForAppResponse() {{
            webhookConfig = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
