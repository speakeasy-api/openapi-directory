...
import org.openapis.openapi.models.operations.DipcrRequestBody;
import org.openapis.openapi.models.operations.DipcrRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.DipcrRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.DipcrResponse;
import org.openapis.openapi.models.operations.DipcrSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DipcrRequestBody req = new DipcrRequestBody(DipcrRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new DipcrRequestBodyCertificateParameters("Sunil Kumar", "99999999");;
            ...
            DipcrResponse res = sdk.apIs.dipcr(req, new DipcrSecurity("molestiae", "minus") {{
