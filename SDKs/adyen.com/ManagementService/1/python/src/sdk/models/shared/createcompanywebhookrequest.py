...
class CreateCompanyWebhookRequestCommunicationFormatEnum(str, Enum):
...
class CreateCompanyWebhookRequestFilterMerchantAccountTypeEnum(str, Enum):
...
class CreateCompanyWebhookRequestNetworkTypeEnum(str, Enum):
...
class CreateCompanyWebhookRequestSslVersionEnum(str, Enum):
...
class CreateCompanyWebhookRequest:
    ...
    communication_format: CreateCompanyWebhookRequestCommunicationFormatEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('communicationFormat') }})
    r"""Format or protocol for receiving webhooks. Possible values:
    * **soap**
    * **http**
    * **json**
    """  
    filter_merchant_accounts: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filterMerchantAccounts') }})
    ...
    * **excludeAccounts**
    ...
    """  
    filter_merchant_account_type: CreateCompanyWebhookRequestFilterMerchantAccountTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filterMerchantAccountType') }})
    r"""Shows how merchant accounts are filtered when configuring the webhook. Possible values:
    * **includeAccounts**: The webhook is configured for the merchant accounts listed in `filterMerchantAccounts`.
    * **excludeAccounts**: The webhook is not configured for the merchant accounts listed in `filterMerchantAccounts`.
    * **allAccounts**: Includes all merchant accounts, and does not require specifying `filterMerchantAccounts`.
    ...
    r"""The type of webhook that is being created. Possible values are:
    ...
    network_type: Optional[CreateCompanyWebhookRequestNetworkTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('networkType'), 'exclude': lambda f: f is None }})
    r"""Network type for Terminal API notification webhooks. Possible values:
    * **public**
    * **local**
    ...
    """  
    ssl_version: Optional[CreateCompanyWebhookRequestSslVersionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sslVersion'), 'exclude': lambda f: f is None }})
    r"""SSL version to access the public webhook URL specified in the `url` field. Possible values:
    * **TLSv1.3**
    * **TLSv1.2**
    * **HTTP** - Only allowed on Test environment.
