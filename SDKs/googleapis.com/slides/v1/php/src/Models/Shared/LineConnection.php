...
class LineConnection
{
     ...
     * 
     * @var ?string $connectedObjectId
     */
	#[\JMS\Serializer\Annotation\SerializedName('connectedObjectId')]
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $connectedObjectId = null;
     ...
     * 
     * @var ?int $connectionSiteIndex
     */
	#[\JMS\Serializer\Annotation\SerializedName('connectionSiteIndex')]
    #[\JMS\Serializer\Annotation\Type('int')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?int $connectionSiteIndex = null;
    
	public function __construct()
	{
		$this->connectedObjectId = null;
		$this->connectionSiteIndex = null;
	}
}
