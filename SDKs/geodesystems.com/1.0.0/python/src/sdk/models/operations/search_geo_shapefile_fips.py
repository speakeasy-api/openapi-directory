...
class SearchGeoShapefileFipsQueryParams:
...
@dataclasses.dataclass
class SearchGeoShapefileFipsRequest:
    query_params: SearchGeoShapefileFipsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchGeoShapefileFipsResponse:
