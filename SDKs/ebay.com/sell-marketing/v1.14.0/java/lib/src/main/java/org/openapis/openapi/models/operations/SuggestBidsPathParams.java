...
public class SuggestBidsPathParams {
    /**
    ...
    public SuggestBidsPathParams withAdGroupId(String adGroupId) {
    ...
    public SuggestBidsPathParams withCampaignId(String campaignId) {
