...
import dataclasses
from ..shared import collectionuser as shared_collectionuser
...
class GetCollectionUsersResponse:
    r"""Users"""
    
    data: list[shared_collectionuser.CollectionUser] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
