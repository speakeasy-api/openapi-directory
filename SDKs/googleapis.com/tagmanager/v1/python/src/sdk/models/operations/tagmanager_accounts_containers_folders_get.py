...
class TagmanagerAccountsContainersFoldersGetSecurity:
    ...
    option1: Optional[TagmanagerAccountsContainersFoldersGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[TagmanagerAccountsContainersFoldersGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
