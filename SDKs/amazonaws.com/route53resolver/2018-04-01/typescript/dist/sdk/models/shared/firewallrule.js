...
var blockoverridednstypeenum_1 = require("./blockoverridednstypeenum");
var blockresponseenum_1 = require("./blockresponseenum");
...
var FirewallRule = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "BlockOverrideDnsType" }),
        __metadata("design:type", String)
    ], FirewallRule.prototype, "blockOverrideDnsType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "BlockOverrideDomain" }),
        __metadata("design:type", String)
    ], FirewallRule.prototype, "blockOverrideDomain", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "BlockOverrideTtl" }),
        __metadata("design:type", Number)
    ], FirewallRule.prototype, "blockOverrideTtl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "BlockResponse" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "FirewallDomainListId" }),
        __metadata("design:type", String)
