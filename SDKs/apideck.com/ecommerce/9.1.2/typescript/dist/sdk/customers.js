...
var Customers = /** @class */ (function () {
    ...
    Customers.prototype.customersAll = function (req, security, config) {
        ...
        var url = baseURL.replace(/\/$/, "") + "/ecommerce/customers";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getEcommerceCustomersResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetEcommerceCustomersResponse);
                    }
                    break;
    ...
    Customers.prototype.customersOne = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ecommerce/customers/{id}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getEcommerceCustomerResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetEcommerceCustomerResponse);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    if (utils.matchContentType(contentType, "application/json")) {
