...
@dataclasses.dataclass
class ApigeeregistryProjectsLocationsApisVersionsSpecsPatchQueryParams:
...
class ApigeeregistryProjectsLocationsApisVersionsSpecsPatchRequest:
    path_params: ApigeeregistryProjectsLocationsApisVersionsSpecsPatchPathParams = dataclasses.field()
    query_params: ApigeeregistryProjectsLocationsApisVersionsSpecsPatchQueryParams = dataclasses.field()
    security: ApigeeregistryProjectsLocationsApisVersionsSpecsPatchSecurity = dataclasses.field()
