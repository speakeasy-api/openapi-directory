...
export class MinimalRepositoryRepositoryPermissions extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=admin" })
  admin: boolean;
...
export class MinimalRepositoryRepositoryTemplateRepositoryOwner extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=avatar_url" })
  avatarUrl?: string;
...
export class MinimalRepositoryRepositoryTemplateRepositoryPermissions extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=admin" })
  admin?: boolean;
...
export class MinimalRepositoryRepositoryTemplateRepository extends SpeakeasyBase {
