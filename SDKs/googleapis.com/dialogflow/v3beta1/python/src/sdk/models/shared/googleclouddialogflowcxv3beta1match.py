...
class GoogleCloudDialogflowCxV3beta1Match:
    ...
    match_type: Optional[GoogleCloudDialogflowCxV3beta1MatchMatchTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('matchType'), 'exclude': lambda f: f is None }})
    r"""Type of this Match."""  
