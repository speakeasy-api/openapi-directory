...
public class IMChat {
    ...
    public org.openapis.openapi.models.operations.ImChatMessagesResponse imChatMessages(org.openapis.openapi.models.operations.ImChatMessagesRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ImChatMessagesRequest.class, baseUrl, "/im/chat/sessions/{sessionId}", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ImChatMessagesRequest.class, request, null);
        if (queryParams != null) {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ImChatSessionsResponse imChatSessions(org.openapis.openapi.models.operations.ImChatSessionsRequest request, org.openapis.openapi.models.operations.ImChatSessionsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ImChatSessionsRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ListimmessagesResponse listimmessages(org.openapis.openapi.models.operations.ListimmessagesRequest request, org.openapis.openapi.models.operations.ListimmessagesSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ListimmessagesRequest.class, baseUrl, "/im/users/{userId}/chat/messages", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ListimmessagesRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.SendimmessagesResponse sendimmessages(org.openapis.openapi.models.operations.SendimmessagesRequest request, org.openapis.openapi.models.operations.SendimmessagesSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.SendimmessagesRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
