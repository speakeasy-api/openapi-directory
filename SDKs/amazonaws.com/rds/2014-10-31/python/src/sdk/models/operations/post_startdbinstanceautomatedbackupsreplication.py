...
class PostStartDbInstanceAutomatedBackupsReplicationQueryParams:
    action: PostStartDbInstanceAutomatedBackupsReplicationActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostStartDbInstanceAutomatedBackupsReplicationVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostStartDbInstanceAutomatedBackupsReplicationRequest:
    headers: PostStartDbInstanceAutomatedBackupsReplicationHeaders = dataclasses.field()
    query_params: PostStartDbInstanceAutomatedBackupsReplicationQueryParams = dataclasses.field()
