...
func (e GetNetworkSwitchAccessPolicies200ApplicationJSONAccessPolicyTypeEnum) ToPointer() *GetNetworkSwitchAccessPolicies200ApplicationJSONAccessPolicyTypeEnum {
	return &e
}
...
func (e *GetNetworkSwitchAccessPolicies200ApplicationJSONAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "MAC authentication bypass":
		*e = GetNetworkSwitchAccessPolicies200ApplicationJSONAccessPolicyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkSwitchAccessPolicies200ApplicationJSONAccessPolicyTypeEnum: %v", v)
	}
}
...
func (e GetNetworkSwitchAccessPolicies200ApplicationJSONDot1xControlDirectionEnum) ToPointer() *GetNetworkSwitchAccessPolicies200ApplicationJSONDot1xControlDirectionEnum {
	return &e
}
...
func (e *GetNetworkSwitchAccessPolicies200ApplicationJSONDot1xControlDirectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "both":
		fallthrough
	case "inbound":
		*e = GetNetworkSwitchAccessPolicies200ApplicationJSONDot1xControlDirectionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkSwitchAccessPolicies200ApplicationJSONDot1xControlDirectionEnum: %v", v)
	}
}
...
func (e GetNetworkSwitchAccessPolicies200ApplicationJSONHostModeEnum) ToPointer() *GetNetworkSwitchAccessPolicies200ApplicationJSONHostModeEnum {
	return &e
}
...
func (e *GetNetworkSwitchAccessPolicies200ApplicationJSONHostModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Multi-Host":
		fallthrough
	case "Single-Host":
		*e = GetNetworkSwitchAccessPolicies200ApplicationJSONHostModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkSwitchAccessPolicies200ApplicationJSONHostModeEnum: %v", v)
	}
}
