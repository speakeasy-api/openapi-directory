...
class GetListServerCertificateTagsQueryParams:
    action: GetListServerCertificateTagsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetListServerCertificateTagsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListServerCertificateTagsRequest:
    headers: GetListServerCertificateTagsHeaders = dataclasses.field()
    query_params: GetListServerCertificateTagsQueryParams = dataclasses.field()
