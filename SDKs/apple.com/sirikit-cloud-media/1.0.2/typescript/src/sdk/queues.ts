...
export class Queues {
  ...
  playMediaOnQueue(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.PlayMediaOnQueueResponse =
        new operations.PlayMediaOnQueueResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          ...
          break;
        case [204, 401, 410].includes(httpRes?.status):
          break;
      }
  ...
  updateActivityOnQueue(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UpdateActivityOnQueueResponse =
        new operations.UpdateActivityOnQueueResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          ...
          break;
        case [204, 401, 404, 410].includes(httpRes?.status):
          break;
      }
