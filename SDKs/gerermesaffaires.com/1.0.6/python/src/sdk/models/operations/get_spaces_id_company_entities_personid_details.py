...
class GetSpacesIDCompanyEntitiesPersonIDDetailsRequest:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""Id of the space"""  
    person_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'personId', 'style': 'simple', 'explode': False }})
    r"""Id of the company entity to get"""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetSpacesIDCompanyEntitiesPersonIDDetails200ApplicationJSONAddress:
...
class GetSpacesIDCompanyEntitiesPersonIDDetails200ApplicationJSON:
    ...
    address: Optional[GetSpacesIDCompanyEntitiesPersonIDDetails200ApplicationJSONAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Address'), 'exclude': lambda f: f is None }})  
...
class GetSpacesIDCompanyEntitiesPersonIDDetailsResponse:
    ...
    get_spaces_id_company_entities_person_id_details_200_application_json_all_ofs: Optional[list[GetSpacesIDCompanyEntitiesPersonIDDetails200ApplicationJSON]] = dataclasses.field(default=None)
