...
exports.MonitoredMediaServers = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var MonitoredMediaServers = /** @class */ (function () {
    function MonitoredMediaServers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    MonitoredMediaServers.prototype.createOrganizationInsightMonitoredMediaServer = function (req, config) {
        var _a;
    ...
    **/
    MonitoredMediaServers.prototype.deleteOrganizationInsightMonitoredMediaServer = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    MonitoredMediaServers.prototype.getOrganizationInsightMonitoredMediaServer = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    MonitoredMediaServers.prototype.getOrganizationInsightMonitoredMediaServers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    MonitoredMediaServers.prototype.updateOrganizationInsightMonitoredMediaServer = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.MonitoredMediaServers = MonitoredMediaServers;
