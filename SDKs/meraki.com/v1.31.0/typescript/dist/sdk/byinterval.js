...
exports.ByInterval = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var ByInterval = /** @class */ (function () {
    function ByInterval(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Tracks organizations' API requests by response code across a given time period
     */
    ByInterval.prototype.getOrganizationApiRequestsOverviewResponseCodesByInterval = function (req, config) {
