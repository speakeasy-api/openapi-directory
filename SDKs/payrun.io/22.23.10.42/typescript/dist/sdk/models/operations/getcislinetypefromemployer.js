...
exports.GetCisLineTypeFromEmployerResponse = exports.GetCisLineTypeFromEmployerRequest = void 0;
...
var GetCisLineTypeFromEmployerRequest = /** @class */ (function (_super) {
    ...
    ], GetCisLineTypeFromEmployerRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetCisLineTypeFromEmployerRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=CisLineTypeId",
        }),
        __metadata("design:type", String)
    ], GetCisLineTypeFromEmployerRequest.prototype, "cisLineTypeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetCisLineTypeFromEmployerRequest.prototype, "employerId", void 0);
    return GetCisLineTypeFromEmployerRequest;
}(utils_1.SpeakeasyBase));
exports.GetCisLineTypeFromEmployerRequest = GetCisLineTypeFromEmployerRequest;
var GetCisLineTypeFromEmployerResponse = /** @class */ (function (_super) {
    ...
    ], GetCisLineTypeFromEmployerResponse.prototype, "rawResponse", void 0);
    return GetCisLineTypeFromEmployerResponse;
}(utils_1.SpeakeasyBase));
exports.GetCisLineTypeFromEmployerResponse = GetCisLineTypeFromEmployerResponse;
