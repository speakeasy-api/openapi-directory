...
class FirebasehostingSitesVersionsPopulateFilesRequest:
    ...
    r"""Required. The version to which to add files, in the format: sites/SITE_ID /versions/VERSION_ID"""  
    ...
    populate_version_files_request: Optional[shared_populateversionfilesrequest.PopulateVersionFilesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
