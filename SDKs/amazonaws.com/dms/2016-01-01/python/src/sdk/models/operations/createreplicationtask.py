...
class CreateReplicationTaskRequest:
    headers: CreateReplicationTaskHeaders = dataclasses.field()
    request: shared_createreplicationtaskmessage.CreateReplicationTaskMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
