...
export class GetProjectBriefRequest extends SpeakeasyBase {
  /**
 ...
 */
export class GetProjectBrief200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "data" })
...
export class GetProjectBriefResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getProjectBrief200ApplicationJSONObject?: GetProjectBrief200ApplicationJSON;
}
