...
class ReadAccountDetails200ApplicationJSON:
    account: shared_accountdetails.AccountDetails = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('account') }})
    

@dataclasses.dataclass
class ReadAccountDetailsRequest:
    headers: ReadAccountDetailsHeaders = dataclasses.field()
    path_params: ReadAccountDetailsPathParams = dataclasses.field()
    query_params: ReadAccountDetailsQueryParams = dataclasses.field()
    security: ReadAccountDetailsSecurity = dataclasses.field()
...
class ReadAccountDetailsResponse:
    ...
    read_account_details_200_application_json_object: Optional[ReadAccountDetails200ApplicationJSON] = dataclasses.field(default=None)
