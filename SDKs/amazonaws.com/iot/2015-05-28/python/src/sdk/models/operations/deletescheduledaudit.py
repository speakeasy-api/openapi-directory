...
class DeleteScheduledAuditRequest:
    headers: DeleteScheduledAuditHeaders = dataclasses.field()
    path_params: DeleteScheduledAuditPathParams = dataclasses.field()
...
class DeleteScheduledAuditResponse:
    ...
    delete_scheduled_audit_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
