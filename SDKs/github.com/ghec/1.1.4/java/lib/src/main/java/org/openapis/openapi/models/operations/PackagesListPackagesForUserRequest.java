...
public class PackagesListPackagesForUserRequest {
    ...
    public PackagesListPackagesForUserRequest withPackageType(PackagesListPackagesForUserPackageTypeEnum packageType) {
    ...
    public PackagesListPackagesForUserRequest withUsername(String username) {
    ...
    public PackagesListPackagesForUserRequest withVisibility(org.openapis.openapi.models.shared.PackageVisibilityEnum visibility) {
