...
var InvoicePayments = /** @class */ (function () {
    function InvoicePayments(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    InvoicePayments.prototype.objectGetInvoicePayment = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ObjectGetInvoicePaymentRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/object/invoice-payment/{id}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.proxyGetInvoicePayment = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    InvoicePayments.prototype.objectPostInvoicePayment = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ObjectPostInvoicePaymentRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/object/invoice-payment";
    ...
    **/
    InvoicePayments.prototype.objectPutInvoicePayment = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.InvoicePayments = InvoicePayments;
