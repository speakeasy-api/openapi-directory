...
import dataclasses
from ..shared import googlecloudretailv2completiondatainputconfig as shared_googlecloudretailv2completiondatainputconfig
...
class GoogleCloudRetailV2ImportCompletionDataRequest:
    ...
    input_config: Optional[shared_googlecloudretailv2completiondatainputconfig.GoogleCloudRetailV2CompletionDataInputConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('inputConfig'), 'exclude': lambda f: f is None }})
