...
class PUTAttachmentsRequest:
    ...
    r"""Id of the attachment to be updated."""  
    put_attachment_type: Optional[shared_putattachmenttype.PUTAttachmentType] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
