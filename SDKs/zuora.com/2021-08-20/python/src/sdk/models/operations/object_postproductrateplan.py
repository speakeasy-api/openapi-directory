...
from ..shared import proxycreateproductrateplan as shared_proxycreateproductrateplan
...
class ObjectPOSTProductRatePlanRequest:
    ...
    proxy_create_product_rate_plan: shared_proxycreateproductrateplan.ProxyCreateProductRatePlan = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
