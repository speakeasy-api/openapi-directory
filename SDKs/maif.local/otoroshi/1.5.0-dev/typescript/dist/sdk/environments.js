...
var Environments = /** @class */ (function () {
    ...
    **/
    Environments.prototype.allLines = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.environment = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
    ...
    **/
    Environments.prototype.servicesForALine = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ServicesForALineRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/lines/{line}/services", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
