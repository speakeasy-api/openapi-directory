...
export enum GETListStackSetOperationsActionEnum {
 ...
 */
export enum GETListStackSetOperationsCallAsEnum {
  Self = "SELF",
  DelegatedAdmin = "DELEGATED_ADMIN",
}

export enum GETListStackSetOperationsVersionEnum {
  TwoThousandAndTen0515 = "2010-05-15",
}

export class GETListStackSetOperationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETListStackSetOperationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
