...
func main() {
    ...
    res, err := s.Repos.ReposCreateCommitComment(ctx, operations.ReposCreateCommitCommentRequest{
        RequestBody: operations.ReposCreateCommitCommentRequestBody{
            Body: "itaque",
            Line: sdk.Int64(791228),
            Path: sdk.String("sunt"),
            Position: sdk.Int64(715143),
        },
        CommitSha: "iusto",
        Owner: "quas",
        Repo: "et",
...
func main() {
    ...
    res, err := s.Repos.ReposCreateDeployment(ctx, operations.ReposCreateDeploymentRequest{
        RequestBody: operations.ReposCreateDeploymentRequestBody{
            ...
            Environment: sdk.String("mollitia"),
...
func main() {
    ...
    res, err := s.Repos.ReposCreateDeploymentStatus(ctx, operations.ReposCreateDeploymentStatusRequest{
        RequestBody: operations.ReposCreateDeploymentStatusRequestBody{
            ...
            EnvironmentURL: sdk.String("explicabo"),
            LogURL: sdk.String("beatae"),
...
func main() {
    ...
    res, err := s.Repos.ReposCreateInOrg(ctx, operations.ReposCreateInOrgRequest{
        RequestBody: operations.ReposCreateInOrgRequestBody{
            ...
            GitignoreTemplate: sdk.String("non"),
            HasDownloads: sdk.Bool(true),
            HasIssues: sdk.Bool(false),
            HasProjects: sdk.Bool(false),
            HasWiki: sdk.Bool(false),
            Homepage: sdk.String("rem"),
            IsTemplate: sdk.Bool(false),
            LicenseTemplate: sdk.String("quia"),
            MergeCommitMessage: operations.ReposCreateInOrgRequestBodyMergeCommitMessageEnumPrTitle.ToPointer(),
...
func main() {
    ...
    res, err := s.Repos.ReposCreatePagesSite(ctx, operations.ReposCreatePagesSiteRequest{
        RequestBody: operations.ReposCreatePagesSiteRequestBody1{
            BuildType: operations.ReposCreatePagesSiteRequestBody1BuildTypeEnumLegacy.ToPointer(),
            Source: operations.ReposCreatePagesSiteRequestBody1Source{
                Branch: "officia",
                Path: operations.ReposCreatePagesSiteRequestBody1SourcePathEnumRoot.ToPointer(),
            },
        },
        Owner: "distinctio",
        Repo: "eius",
...
func main() {
    ...
    res, err := s.Repos.ReposCreateRelease(ctx, operations.ReposCreateReleaseRequest{
        RequestBody: operations.ReposCreateReleaseRequestBody{
            ...
            TagName: "neque",
            TargetCommitish: sdk.String("facere"),
        },
        Owner: "aliquam",
        Repo: "quos",
    })
...
func main() {
    ...
    res, err := s.Repos.ReposCreateUsingTemplate(ctx, operations.ReposCreateUsingTemplateRequest{
        RequestBody: operations.ReposCreateUsingTemplateRequestBody{
            ...
            Name: "Ernesto Windler I",
            Owner: sdk.String("similique"),
            Private: sdk.Bool(false),
        },
        TemplateOwner: "illo",
        TemplateRepo: "repellat",
    })
    if err != nil {
        log.Fatal(err)
    }
    ...
    res, err := s.Repos.ReposDeleteFile(ctx, operations.ReposDeleteFileRequest{
        RequestBody: operations.ReposDeleteFileRequestBody{
            Author: &operations.ReposDeleteFileRequestBodyAuthor{
                Email: sdk.String("Faye_Quitzon2@gmail.com"),
                Name: sdk.String("Molly Cronin"),
            },
            Branch: sdk.String("modi"),
            Committer: &operations.ReposDeleteFileRequestBodyCommitter{
                Email: sdk.String("Porter_Waters31@gmail.com"),
...
func main() {
    ...
    res, err := s.Repos.ReposGenerateReleaseNotes(ctx, operations.ReposGenerateReleaseNotesRequest{
        RequestBody: operations.ReposGenerateReleaseNotesRequestBody{
            ConfigurationFilePath: sdk.String("itaque"),
            PreviousTagName: sdk.String("laboriosam"),
            TagName: "unde",
            TargetCommitish: sdk.String("modi"),
        },
        Owner: "perspiciatis",
        Repo: "hic",
    })
...
func main() {
    ...
    res, err := s.Repos.ReposGetAllTopics(ctx, operations.ReposGetAllTopicsRequest{
        Owner: "facilis",
        Page: sdk.Int64(247618),
        PerPage: sdk.Int64(649534),
        Repo: "assumenda",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposGetCombinedStatusForRef(ctx, operations.ReposGetCombinedStatusForRefRequest{
        Owner: "perferendis",
        Page: sdk.Int64(143528),
        PerPage: sdk.Int64(399222),
        Ref: "magnam",
        Repo: "quaerat",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Repos.ReposGetCommit(ctx, operations.ReposGetCommitRequest{
        Owner: "eligendi",
        Page: sdk.Int64(942185),
        PerPage: sdk.Int64(342921),
        Ref: "officiis",
        Repo: "unde",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Repos.ReposListBranches(ctx, operations.ReposListBranchesRequest{
        Owner: "aliquam",
        Page: sdk.Int64(569287),
        PerPage: sdk.Int64(980410),
...
func main() {
    ...
    res, err := s.Repos.ReposListCollaborators(ctx, operations.ReposListCollaboratorsRequest{
        ...
        Owner: "molestiae",
        Page: sdk.Int64(395634),
        PerPage: sdk.Int64(989033),
        Repo: "a",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListCommentsForCommit(ctx, operations.ReposListCommentsForCommitRequest{
        CommitSha: "nobis",
        Owner: "perspiciatis",
        Page: sdk.Int64(34245),
        PerPage: sdk.Int64(118917),
        Repo: "minus",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListCommitStatusesForRef(ctx, operations.ReposListCommitStatusesForRefRequest{
        Owner: "quidem",
        Page: sdk.Int64(265930),
        PerPage: sdk.Int64(916341),
        Ref: "fugit",
        Repo: "eius",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Repos.ReposListCommits(ctx, operations.ReposListCommitsRequest{
        Author: sdk.String("sequi"),
        Owner: "eligendi",
        Page: sdk.Int64(992887),
        Path: sdk.String("esse"),
        PerPage: sdk.Int64(500021),
        Repo: "sint",
        Sha: sdk.String("repellat"),
        Since: types.MustTimeFromString("2021-01-09T19:53:05.818Z"),
        Until: types.MustTimeFromString("2020-03-18T04:20:31.433Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Repos.ReposListContributors(ctx, operations.ReposListContributorsRequest{
        Anon: sdk.String("nulla"),
        Owner: "deserunt",
        Page: sdk.Int64(359097),
        PerPage: sdk.Int64(246577),
        Repo: "officiis",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListDeployKeys(ctx, operations.ReposListDeployKeysRequest{
        Owner: "enim",
        Page: sdk.Int64(638609),
        PerPage: sdk.Int64(902979),
        Repo: "eum",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListDeploymentBranchPolicies(ctx, operations.ReposListDeploymentBranchPoliciesRequest{
        ...
        Owner: "accusantium",
        Page: sdk.Int64(637840),
        PerPage: sdk.Int64(770128),
        Repo: "quasi",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListDeploymentStatuses(ctx, operations.ReposListDeploymentStatusesRequest{
        DeploymentID: 502106,
        Owner: "eius",
        Page: sdk.Int64(786189),
        PerPage: sdk.Int64(177929),
        Repo: "nobis",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListDeployments(ctx, operations.ReposListDeploymentsRequest{
        Environment: sdk.String("natus"),
        Owner: "minus",
        Page: sdk.Int64(154389),
        PerPage: sdk.Int64(300651),
        Ref: sdk.String("reprehenderit"),
        Repo: "quod",
        Sha: sdk.String("quos"),
        Task: sdk.String("corrupti"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Repos.ReposListForAuthenticatedUser(ctx, operations.ReposListForAuthenticatedUserRequest{
        Affiliation: sdk.String("amet"),
        Before: types.MustTimeFromString("2022-10-10T02:06:29.028Z"),
        Direction: operations.ReposListForAuthenticatedUserDirectionEnumDesc.ToPointer(),
        Page: sdk.Int64(266946),
        PerPage: sdk.Int64(21358),
        Since: types.MustTimeFromString("2022-09-10T23:06:49.765Z"),
...
func main() {
    ...
    res, err := s.Repos.ReposListForOrg(ctx, operations.ReposListForOrgRequest{
        ...
        Org: "neque",
        Page: sdk.Int64(139745),
        PerPage: sdk.Int64(936845),
...
func main() {
    ...
    res, err := s.Repos.ReposListForks(ctx, operations.ReposListForksRequest{
        Owner: "nemo",
        Page: sdk.Int64(382764),
        PerPage: sdk.Int64(866459),
        Repo: "sit",
...
func main() {
    ...
    res, err := s.Repos.ReposListInvitations(ctx, operations.ReposListInvitationsRequest{
        Owner: "repellendus",
        Page: sdk.Int64(17768),
        PerPage: sdk.Int64(660536),
        Repo: "sapiente",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListInvitationsForAuthenticatedUser(ctx, operations.ReposListInvitationsForAuthenticatedUserRequest{
        Page: sdk.Int64(152364),
        PerPage: sdk.Int64(823572),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Repos.ReposListPagesBuilds(ctx, operations.ReposListPagesBuildsRequest{
        Owner: "architecto",
        Page: sdk.Int64(240696),
        PerPage: sdk.Int64(867115),
        Repo: "harum",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListPullRequestsAssociatedWithCommit(ctx, operations.ReposListPullRequestsAssociatedWithCommitRequest{
        ...
        Owner: "iure",
        Page: sdk.Int64(127087),
        PerPage: sdk.Int64(795457),
        Repo: "soluta",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListReleaseAssets(ctx, operations.ReposListReleaseAssetsRequest{
        Owner: "dolorum",
        Page: sdk.Int64(242531),
        PerPage: sdk.Int64(937865),
        ReleaseID: 510020,
        Repo: "error",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Repos.ReposListReleases(ctx, operations.ReposListReleasesRequest{
        Owner: "non",
        Page: sdk.Int64(97810),
        PerPage: sdk.Int64(649032),
        Repo: "accusamus",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListTags(ctx, operations.ReposListTagsRequest{
        Owner: "harum",
        Page: sdk.Int64(769156),
        PerPage: sdk.Int64(42615),
        Repo: "expedita",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListTeams(ctx, operations.ReposListTeamsRequest{
        Owner: "corrupti",
        Page: sdk.Int64(53733),
        PerPage: sdk.Int64(643199),
        Repo: "aliquid",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposListWebhooks(ctx, operations.ReposListWebhooksRequest{
        Owner: "rerum",
        Page: sdk.Int64(153582),
        PerPage: sdk.Int64(883078),
        Repo: "optio",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Repos.ReposMerge(ctx, operations.ReposMergeRequest{
        RequestBody: operations.ReposMergeRequestBody{
            Base: "delectus",
            CommitMessage: sdk.String("minus"),
            Head: "quo",
        },
        Owner: "quos",
        Repo: "asperiores",
...
func main() {
    ...
    res, err := s.Repos.ReposUpdate(ctx, operations.ReposUpdateRequest{
        RequestBody: &operations.ReposUpdateRequestBody{
            ...
            DefaultBranch: sdk.String("occaecati"),
            DeleteBranchOnMerge: sdk.Bool(false),
            Description: sdk.String("unde"),
            HasIssues: sdk.Bool(false),
            HasProjects: sdk.Bool(false),
            HasWiki: sdk.Bool(false),
            Homepage: sdk.String("illo"),
            IsTemplate: sdk.Bool(false),
            ...
            Name: sdk.String("Roberto Boyle MD"),
            Private: sdk.Bool(false),
    ...
    res, err := s.Repos.ReposUpdateBranchProtection(ctx, operations.ReposUpdateBranchProtectionRequest{
        RequestBody: operations.ReposUpdateBranchProtectionRequestBody{
            ...
            RequiredPullRequestReviews: operations.ReposUpdateBranchProtectionRequestBodyRequiredPullRequestReviews{
                ...
                RequiredApprovingReviewCount: sdk.Int64(756287),
            },
            RequiredStatusChecks: operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecks{
                Checks: []ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                    operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                        AppID: sdk.Int64(83791),
                        Context: "aut",
                    },
                    operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                        AppID: sdk.Int64(516124),
                        Context: "iusto",
                    },
                    operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                        AppID: sdk.Int64(219860),
                        Context: "voluptates",
                    },
                    operations.ReposUpdateBranchProtectionRequestBodyRequiredStatusChecksChecks{
                        AppID: sdk.Int64(274295),
                        Context: "magni",
                    },
                },
                Contexts: []string{
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateDeploymentBranchPolicy(ctx, operations.ReposUpdateDeploymentBranchPolicyRequest{
        BranchPolicyID: 811259,
        DeploymentBranchPolicyNamePattern: shared.DeploymentBranchPolicyNamePattern{
            Name: "release/*",
        },
        EnvironmentName: "enim",
        Owner: "labore",
        Repo: "sapiente",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateInformationAboutPagesSite(ctx, operations.ReposUpdateInformationAboutPagesSiteRequest{
        RequestBody: operations.ReposUpdateInformationAboutPagesSiteRequestBody5{
            BuildType: operations.ReposUpdateInformationAboutPagesSiteRequestBody5BuildTypeEnumWorkflow.ToPointer(),
            Cname: sdk.String("officia"),
            HTTPSEnforced: false,
            Source: &operations.ReposUpdateInformationAboutPagesSiteRequestBody5Source2{
                Branch: "cumque",
                Path: operations.ReposUpdateInformationAboutPagesSiteRequestBody5Source2PathEnumRootDocs,
            },
        },
        Owner: "quaerat",
        Repo: "doloribus",
...
func main() {
    ...
    res, err := s.Repos.ReposUpdatePullRequestReviewProtection(ctx, operations.ReposUpdatePullRequestReviewProtectionRequest{
        RequestBody: &operations.ReposUpdatePullRequestReviewProtectionRequestBody{
            ...
            RequireCodeOwnerReviews: sdk.Bool(false),
            RequiredApprovingReviewCount: sdk.Int64(898638),
        },
        Branch: "sed",
        Owner: "deleniti",
        Repo: "sunt",
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateRelease(ctx, operations.ReposUpdateReleaseRequest{
        RequestBody: &operations.ReposUpdateReleaseRequestBody{
            Body: sdk.String("nesciunt"),
            Draft: sdk.Bool(false),
            Name: sdk.String("Neal Gutmann"),
            Prerelease: sdk.Bool(false),
            TagName: sdk.String("sunt"),
            TargetCommitish: sdk.String("impedit"),
        },
        Owner: "eius",
        ReleaseID: 528320,
        Repo: "ipsa",
...
func main() {
    ...
    res, err := s.Repos.ReposUpdateReleaseAsset(ctx, operations.ReposUpdateReleaseAssetRequest{
        RequestBody: &operations.ReposUpdateReleaseAssetRequestBody{
            Label: sdk.String("at"),
            Name: sdk.String("Mr. Kristie Cole"),
