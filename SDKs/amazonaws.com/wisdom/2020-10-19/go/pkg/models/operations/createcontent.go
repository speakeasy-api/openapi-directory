...
type CreateContentRequest struct {
	PathParams CreateContentPathParams
	Headers    CreateContentHeaders
	Request    CreateContentRequestBody `request:"mediaType=application/json"`
}
