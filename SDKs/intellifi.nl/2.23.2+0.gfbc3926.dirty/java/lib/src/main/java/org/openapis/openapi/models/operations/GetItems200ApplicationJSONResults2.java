...
public class GetItems200ApplicationJSONResults2 {
    /**
    ...
    public GetItems200ApplicationJSONResults2 withCodeHex(String codeHex) {
    ...
    public GetItems200ApplicationJSONResults2 withConfigRequest(java.util.Map<String, Object> configRequest) {
    ...
    public GetItems200ApplicationJSONResults2 withCustom(Object custom) {
        this.custom = custom;
        return this;
    }
    ...
    public GetItems200ApplicationJSONResults2 withGeoCoords(org.openapis.openapi.models.shared.GeoCoordsReadOnly geoCoords) {
    ...
    @JsonProperty("id")
    public String id;
    public GetItems200ApplicationJSONResults2 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetItems200ApplicationJSONResults2 withIsPresent(Boolean isPresent) {
    ...
    @JsonProperty("label")
    public String label;
    public GetItems200ApplicationJSONResults2 withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public GetItems200ApplicationJSONResults2 withLocationId(String locationId) {
    ...
    public GetItems200ApplicationJSONResults2 withLocationRequest(String locationRequest) {
    ...
    public GetItems200ApplicationJSONResults2 withMetadata(java.util.Map<String, Object> metadata) {
    ...
    public GetItems200ApplicationJSONResults2 withMoveCount(Long moveCount) {
    ...
    public GetItems200ApplicationJSONResults2 withProtocol(org.openapis.openapi.models.shared.ItemProtocolEnum protocol) {
    ...
    @JsonProperty("sets")
    public String[] sets;
    public GetItems200ApplicationJSONResults2 withSets(String[] sets) {
        this.sets = sets;
        return this;
    }
    ...
    public GetItems200ApplicationJSONResults2 withTechnology(org.openapis.openapi.models.shared.TechnologyEnum technology) {
    ...
    public GetItems200ApplicationJSONResults2 withTimeCreated(String timeCreated) {
    ...
    public GetItems200ApplicationJSONResults2 withTimeLastPresent(String timeLastPresent) {
    ...
    public GetItems200ApplicationJSONResults2 withTimeMoved(String timeMoved) {
    ...
    public GetItems200ApplicationJSONResults2 withTimeUpdated(String timeUpdated) {
    ...
    public GetItems200ApplicationJSONResults2 withType(org.openapis.openapi.models.shared.ItemTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    @JsonProperty("url")
    public String url;
    public GetItems200ApplicationJSONResults2 withUrl(String url) {
        this.url = url;
        return this;
    }
