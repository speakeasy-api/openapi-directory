...
class GetIdentityProviderByIdentifierRequest:
    ...
    get_identity_provider_by_identifier_request: shared_getidentityproviderbyidentifierrequest.GetIdentityProviderByIdentifierRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
