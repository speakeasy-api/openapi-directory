...
public class Public {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.GetpublicdataResponse getpublicdata(org.openapis.openapi.models.operations.GetpublicdataRequest request, org.openapis.openapi.models.operations.GetpublicdataSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetpublicdataRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.GetpublicdataResponse res = new org.openapis.openapi.models.operations.GetpublicdataResponse(contentType, httpRes.statusCode()) {{
