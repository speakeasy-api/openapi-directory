...
class GetPresences200ApplicationJSON:
    ...
    results: Optional[list[shared_presence.Presence]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    

@dataclasses.dataclass
class GetPresencesRequest:
    query_params: GetPresencesQueryParams = dataclasses.field()
