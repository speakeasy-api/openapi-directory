...
func (e FinalizedDealDealServingStatusEnum) ToPointer() *FinalizedDealDealServingStatusEnum {
	return &e
}
...
func (e *FinalizedDealDealServingStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "PAUSED_BY_SELLER":
		*e = FinalizedDealDealServingStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for FinalizedDealDealServingStatusEnum: %v", v)
	}
}
