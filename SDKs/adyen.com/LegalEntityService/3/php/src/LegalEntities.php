...
class LegalEntities 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\PostLegalEntitiesIdCheckVerificationErrorsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\PostLegalEntitiesIdCheckVerificationErrorsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\PostLegalEntitiesIdCheckVerificationErrorsResponse
     */
	public function postLegalEntitiesIdCheckVerificationErrors(
        \OpenAPI\OpenAPI\Models\Operations\PostLegalEntitiesIdCheckVerificationErrorsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\PostLegalEntitiesIdCheckVerificationErrorsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\PostLegalEntitiesIdCheckVerificationErrorsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/legalEntities/{id}/checkVerificationErrors', \OpenAPI\OpenAPI\Models\Operations\PostLegalEntitiesIdCheckVerificationErrorsRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PostLegalEntitiesIdCheckVerificationErrorsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->verificationErrors = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\VerificationErrors', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 400 or $httpResponse->getStatusCode() === 401 or $httpResponse->getStatusCode() === 403 or $httpResponse->getStatusCode() === 422 or $httpResponse->getStatusCode() === 500) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
