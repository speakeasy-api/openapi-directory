...
func (e PlayerGameRedZoneStatsInsideTenFormatEnum) ToPointer() *PlayerGameRedZoneStatsInsideTenFormatEnum {
	return &e
}
...
func (e *PlayerGameRedZoneStatsInsideTenFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = PlayerGameRedZoneStatsInsideTenFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PlayerGameRedZoneStatsInsideTenFormatEnum: %v", v)
	}
}
