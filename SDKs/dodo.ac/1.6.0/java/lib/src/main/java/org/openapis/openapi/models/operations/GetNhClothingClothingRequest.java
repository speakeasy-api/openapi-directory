...
public class GetNhClothingClothingRequest {
    ...
    public GetNhClothingClothingRequest withAcceptVersion(String acceptVersion) {
    ...
    public GetNhClothingClothingRequest withXApiKey(String xApiKey) {
    ...
    public GetNhClothingClothingRequest withClothing(String clothing) {
    ...
    public GetNhClothingClothingRequest withThumbsize(Long thumbsize) {
        this.thumbsize = thumbsize;
        return this;
    }
    
    public GetNhClothingClothingRequest(@JsonProperty("Accept-Version") String acceptVersion, @JsonProperty("X-API-KEY") String xApiKey, @JsonProperty("clothing") String clothing) {
        this.acceptVersion = acceptVersion;
        this.xApiKey = xApiKey;
        this.clothing = clothing;
  }
