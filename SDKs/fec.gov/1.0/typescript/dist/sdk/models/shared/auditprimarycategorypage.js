...
var AuditPrimaryCategoryPage = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: auditprimarycategory_1.AuditPrimaryCategory }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return auditprimarycategory_1.AuditPrimaryCategory; }),
