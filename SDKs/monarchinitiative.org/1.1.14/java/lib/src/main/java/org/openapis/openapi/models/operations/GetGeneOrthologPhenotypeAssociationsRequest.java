...
public class GetGeneOrthologPhenotypeAssociationsRequest {
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withRelation(String relation) {
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGeneOrthologPhenotypeAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGeneOrthologPhenotypeAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
