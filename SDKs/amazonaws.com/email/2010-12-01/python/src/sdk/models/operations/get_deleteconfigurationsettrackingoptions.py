...
class GetDeleteConfigurationSetTrackingOptionsRequest:
    headers: GetDeleteConfigurationSetTrackingOptionsHeaders = dataclasses.field()
    query_params: GetDeleteConfigurationSetTrackingOptionsQueryParams = dataclasses.field()
