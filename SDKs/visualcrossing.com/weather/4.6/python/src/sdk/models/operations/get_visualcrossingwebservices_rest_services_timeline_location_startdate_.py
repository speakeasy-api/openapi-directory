...
GET_VISUAL_CROSSING_WEB_SERVICES_REST_SERVICES_TIMELINE_LOCATION_STARTDATE_SERVERS = [
	"https://weather.visualcrossing.com",
]


@dataclasses.dataclass
class GetVisualCrossingWebServicesRestServicesTimelineLocationStartdateRequest:
