...
@dataclass_json
@dataclasses.dataclass
class ReposSetTeamAccessRestrictionsRequestBody:
...
class ReposSetTeamAccessRestrictionsRequest:
    path_params: ReposSetTeamAccessRestrictionsPathParams = dataclasses.field()
    request: Optional[ReposSetTeamAccessRestrictionsRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
