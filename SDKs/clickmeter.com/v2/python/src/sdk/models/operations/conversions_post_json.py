...
class ConversionsPostJSONRequest:
    ...
    api_core_dto_conversions_conversion: shared_api_core_dto_conversions_conversion.APICoreDtoConversionsConversion = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
