...
exports.PackageSystemsResponse = exports.PackageSystemsRequest = exports.PackageSystemsSecurity = void 0;
...
var PackageSystemsRequest = /** @class */ (function (_super) {
    ...
    ], PackageSystemsRequest.prototype, "filterSystemProfileSapSidsIn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[system_profile][sap_system]",
        }),
        __metadata("design:type", String)
    ], PackageSystemsRequest.prototype, "filterSystemProfileSapSystem", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], PackageSystemsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], PackageSystemsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=package_name",
        }),
        __metadata("design:type", String)
    ], PackageSystemsRequest.prototype, "packageName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=tags" }),
        __metadata("design:type", Array)
    ], PackageSystemsRequest.prototype, "tags", void 0);
...
var PackageSystemsResponse = /** @class */ (function (_super) {
    ...
    ], PackageSystemsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
