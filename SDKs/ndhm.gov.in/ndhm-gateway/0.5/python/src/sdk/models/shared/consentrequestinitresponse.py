...
class ConsentRequestInitResponse:
    ...
    consent_request: Optional[ConsentRequestInitResponseConsentRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('consentRequest') }})
