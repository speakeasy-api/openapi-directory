...
public class GetMeQuestionsUnansweredQueryParams {
    /**
    ...
    public GetMeQuestionsUnansweredQueryParams withCallback(String callback) {
    ...
    public GetMeQuestionsUnansweredQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeQuestionsUnansweredQueryParams withFromdate(Long fromdate) {
    ...
    public String max;
    public GetMeQuestionsUnansweredQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetMeQuestionsUnansweredQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetMeQuestionsUnansweredQueryParams withOrder(GetMeQuestionsUnansweredOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetMeQuestionsUnansweredQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeQuestionsUnansweredQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetMeQuestionsUnansweredQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetMeQuestionsUnansweredQueryParams withSort(GetMeQuestionsUnansweredSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetMeQuestionsUnansweredQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
