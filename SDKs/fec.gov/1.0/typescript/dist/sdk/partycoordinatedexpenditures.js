...
var PartyCoordinatedExpenditures = /** @class */ (function () {
    ...
    PartyCoordinatedExpenditures.prototype.getSchedulesScheduleF = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetSchedulesScheduleFResponse({
                ...
                default:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getSchedulesScheduleFDefaultApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetSchedulesScheduleFDefaultApplicationJSON);
                    }
                    break;
            }
            return res;
    ...
    PartyCoordinatedExpenditures.prototype.getSchedulesScheduleFSubId = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/schedules/schedule_f/{sub_id}/", req);
        var client = this._securityClient || this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetSchedulesScheduleFSubIdResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
                ...
                default:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getSchedulesScheduleFSubIdDefaultApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetSchedulesScheduleFSubIdDefaultApplicationJSON);
                    }
                    break;
            }
            return res;
