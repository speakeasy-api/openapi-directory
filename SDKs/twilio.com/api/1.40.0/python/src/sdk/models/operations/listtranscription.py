...
class ListTranscriptionListTranscriptionResponse:
    ...
    transcriptions: Optional[list[shared_api_v2010_account_transcription.APIV2010AccountTranscription]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transcriptions'), 'exclude': lambda f: f is None }})  
