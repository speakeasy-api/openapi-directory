...
import { HealthCheckServicesScopedList } from "./healthcheckservicesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum HealthCheckServiceAggregatedListWarningCodeEnum {
...
export declare class HealthCheckServiceAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class HealthCheckServiceAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: HealthCheckServiceAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: HealthCheckServiceAggregatedListWarningData[];
    /**
 ...
 */
export declare class HealthCheckServiceAggregatedList extends SpeakeasyBase {
    /**
     ...
     */
    items?: Record<string, HealthCheckServicesScopedList>;
    /**
     * Type of resource.
     */
    kind?: string;
     ...
     * [Output Only] Informational warning message.
     */
    warning?: HealthCheckServiceAggregatedListWarning;
}
