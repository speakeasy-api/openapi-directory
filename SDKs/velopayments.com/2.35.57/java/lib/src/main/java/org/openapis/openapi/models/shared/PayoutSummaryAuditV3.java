...
public class PayoutSummaryAuditV3 {
    ...
    public PayoutSummaryAuditV3(@JsonProperty("payoutId") String payoutId, @JsonProperty("status") String status, @JsonProperty("submittedDateTime") String submittedDateTime) {
        this.payoutId = payoutId;
        this.status = status;
        this.submittedDateTime = submittedDateTime;
  }
