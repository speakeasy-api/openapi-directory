...
from ..shared import getuploadsessionresponse as shared_getuploadsessionresponse
...
@dataclasses.dataclass
class UploadSessionsOneSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class UploadSessionsOneRequest:
    headers: UploadSessionsOneHeaders = dataclasses.field()
    path_params: UploadSessionsOnePathParams = dataclasses.field()
    query_params: UploadSessionsOneQueryParams = dataclasses.field()
    security: UploadSessionsOneSecurity = dataclasses.field()
...
class UploadSessionsOneResponse:
    ...
    get_upload_session_response: Optional[shared_getuploadsessionresponse.GetUploadSessionResponse] = dataclasses.field(default=None)
