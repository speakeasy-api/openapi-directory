...
func (e CreateUserXSdsDateFormatEnum) ToPointer() *CreateUserXSdsDateFormatEnum {
	return &e
}
...
func (e *CreateUserXSdsDateFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "EPOCH":
		fallthrough
	case "LEET":
		*e = CreateUserXSdsDateFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateUserXSdsDateFormatEnum: %v", v)
	}
}
