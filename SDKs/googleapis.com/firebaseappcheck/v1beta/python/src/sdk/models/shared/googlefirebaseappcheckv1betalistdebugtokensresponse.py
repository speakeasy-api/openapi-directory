...
class GoogleFirebaseAppcheckV1betaListDebugTokensResponse:
    ...
    debug_tokens: Optional[list[shared_googlefirebaseappcheckv1betadebugtoken.GoogleFirebaseAppcheckV1betaDebugToken]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('debugTokens'), 'exclude': lambda f: f is None }})
