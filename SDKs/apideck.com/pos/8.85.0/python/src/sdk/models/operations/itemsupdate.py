...
class ItemsUpdateRequest:
    headers: ItemsUpdateHeaders = dataclasses.field()
    path_params: ItemsUpdatePathParams = dataclasses.field()
    query_params: ItemsUpdateQueryParams = dataclasses.field()
    request: shared_item.ItemInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: ItemsUpdateSecurity = dataclasses.field()
