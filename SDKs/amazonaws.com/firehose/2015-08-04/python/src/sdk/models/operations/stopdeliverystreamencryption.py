...
class StopDeliveryStreamEncryptionRequest:
    ...
    stop_delivery_stream_encryption_input: shared_stopdeliverystreamencryptioninput.StopDeliveryStreamEncryptionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
