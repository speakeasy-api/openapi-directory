...
class GoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceDisplayHints:
    ...
    badge_colors: Optional[shared_googleappsdrivelabelsv2betabadgecolors.GoogleAppsDriveLabelsV2betaBadgeColors] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('badgeColors'), 'exclude': lambda f: f is None }})
    ...
    dark_badge_colors: Optional[shared_googleappsdrivelabelsv2betabadgecolors.GoogleAppsDriveLabelsV2betaBadgeColors] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('darkBadgeColors'), 'exclude': lambda f: f is None }})
    r"""The color derived from BadgeConfig and changed to the closest recommended supported color."""  
