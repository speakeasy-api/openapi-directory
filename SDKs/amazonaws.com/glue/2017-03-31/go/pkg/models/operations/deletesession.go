...
type DeleteSessionXAmzTargetEnum string
...
type DeleteSessionRequest struct {
	DeleteSessionRequest shared.DeleteSessionRequest `request:"mediaType=application/json"`
	...
	XAmzTarget           DeleteSessionXAmzTargetEnum `header:"style=simple,explode=false,name=X-Amz-Target"`
}
