...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/ucobank/3.0.0/python
```
...
req = operations.TdcerRequestBody(
    certificate_parameters=operations.TdcerRequestBodyCertificateParameters(
        cust_id="Enter 14 Digit A/c No - TDS Information will be generated for all A/cs associated with Customer ID.",
        dob="31-12-1980",
        fin_yr="2018-2019",
    ),
...
res = s.ap_is.tdcer(req, operations.TdcerSecurity(
