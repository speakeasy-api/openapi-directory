...
public class GetApiV2BroadcastservicesQueryParams {
    /**
    ...
    public GetApiV2BroadcastservicesQueryParams withOrderById(GetApiV2BroadcastservicesOrderByIDEnum orderById) {
    ...
    public GetApiV2BroadcastservicesQueryParams withPageSize(Integer pageSize) {
    ...
    public GetApiV2BroadcastservicesQueryParams withPageStart(Integer pageStart) {
