...
type MinimalRepositoryRepositoryPermissions struct {
...
type MinimalRepositoryRepositoryTemplateRepositoryOwner struct {
...
type MinimalRepositoryRepositoryTemplateRepositoryPermissions struct {
	Admin *bool `json:"admin,omitempty"`
	Pull  *bool `json:"pull,omitempty"`
	Push  *bool `json:"push,omitempty"`
}

type MinimalRepositoryRepositoryTemplateRepository struct {
	...
	Owner                  *MinimalRepositoryRepositoryTemplateRepositoryOwner       `json:"owner,omitempty"`
	Permissions            *MinimalRepositoryRepositoryTemplateRepositoryPermissions `json:"permissions,omitempty"`
...
type MinimalRepositoryRepository struct {
	...
	License                MinimalRepositoryRepositoryLicenseSimple       `json:"license"`
	...
	Organization           *MinimalRepositoryRepositorySimpleUser         `json:"organization,omitempty"`
	Owner                  MinimalRepositoryRepositorySimpleUser          `json:"owner"`
	Permissions            *MinimalRepositoryRepositoryPermissions        `json:"permissions,omitempty"`
	...
	TemplateRepository     *MinimalRepositoryRepositoryTemplateRepository `json:"template_repository,omitempty"`
	Topics                 []string                                       `json:"topics,omitempty"`
...
type MinimalRepository struct {
	...
	OpenIssuesCount        *int64                        `json:"open_issues_count,omitempty"`
	Owner                  MinimalRepositorySimpleUser   `json:"owner"`
	...
	TagsURL                string                        `json:"tags_url"`
	TeamsURL               string                        `json:"teams_url"`
	TemplateRepository     *MinimalRepositoryRepository  `json:"template_repository,omitempty"`
	Topics                 []string                      `json:"topics,omitempty"`
	TreesURL               string                        `json:"trees_url"`
