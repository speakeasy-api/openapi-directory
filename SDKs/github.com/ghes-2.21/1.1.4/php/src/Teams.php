...
class Teams 
{
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#add-or-update-team-membership-for-a-user
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#add-or-update-team-project-permissions
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\TeamsAddOrUpdateProjectPermissionsLegacyResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 204) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->teamsAddOrUpdateProjectPermissionsLegacy415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\TeamsAddOrUpdateProjectPermissionsLegacy415ApplicationJSON', 'json');
            }
        }
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams/#add-or-update-team-repository-permissions
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#check-team-permissions-for-a-project
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\TeamsCheckPermissionsForProjectLegacyResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->teamsCheckPermissionsForProjectLegacy415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\TeamsCheckPermissionsForProjectLegacy415ApplicationJSON', 'json');
            }
        }
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams/#check-team-permissions-for-a-repository
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#create-a-team
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#create-a-discussion-comment
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#create-a-discussion
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#delete-a-discussion-comment
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#delete-a-discussion
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#delete-a-team
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#get-a-team-by-name
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#get-a-discussion-comment
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#get-a-discussion
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#get-team-membership-for-a-user
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#list-teams
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#list-child-teams
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#list-discussion-comments
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#list-discussions
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#list-teams-for-the-authenticated-user
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#list-team-members
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#list-team-projects
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\TeamsListProjectsLegacyResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->teamsListProjectsLegacy415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\TeamsListProjectsLegacy415ApplicationJSON', 'json');
            }
        }
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#list-team-repositories
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#remove-team-membership-for-a-user
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#remove-a-project-from-a-team
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\TeamsRemoveProjectLegacyResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 204) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->teamsRemoveProjectLegacy415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\TeamsRemoveProjectLegacy415ApplicationJSON', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 422) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams/#remove-a-repository-from-a-team
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#update-a-discussion-comment
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#update-a-discussion
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.21/rest/reference/teams#update-a-team
     */
