...
class GetContainerServiceMetricDataRequest:
    ...
    get_container_service_metric_data_request: shared_getcontainerservicemetricdatarequest.GetContainerServiceMetricDataRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
