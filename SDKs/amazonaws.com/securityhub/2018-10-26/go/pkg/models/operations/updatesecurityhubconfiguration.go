...
func (e UpdateSecurityHubConfigurationRequestBodyControlFindingGeneratorEnum) ToPointer() *UpdateSecurityHubConfigurationRequestBodyControlFindingGeneratorEnum {
	return &e
}
...
func (e *UpdateSecurityHubConfigurationRequestBodyControlFindingGeneratorEnum) UnmarshalJSON(data []byte) error {
	...
	case "SECURITY_CONTROL":
		*e = UpdateSecurityHubConfigurationRequestBodyControlFindingGeneratorEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateSecurityHubConfigurationRequestBodyControlFindingGeneratorEnum: %v", v)
	}
}
