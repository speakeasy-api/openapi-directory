...
func (s *tags) GetV2TagsJSON(ctx context.Context, request operations.GetV2TagsJSONRequest) (*operations.GetV2TagsJSONResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/tags.json"
	...
	res := &operations.GetV2TagsJSONResponse{
