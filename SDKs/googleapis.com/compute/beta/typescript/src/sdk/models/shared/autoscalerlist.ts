 ...
 */
export enum AutoscalerListWarningCodeEnum {
...
export class AutoscalerListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class AutoscalerListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: AutoscalerListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: AutoscalerListWarningData })
  @Expose({ name: "data" })
  @Type(() => AutoscalerListWarningData)
  data?: AutoscalerListWarningData[];
 ...
 */
export class AutoscalerList extends SpeakeasyBase {
  /**
