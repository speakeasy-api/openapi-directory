...
exports.CategorySearch = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var CategorySearch = /** @class */ (function () {
    function CategorySearch(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CategorySearch.prototype.endpointSearch = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.searchResponseObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                default:
                    if (utils.matchContentType(contentType, "application/json")) {
