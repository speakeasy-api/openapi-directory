...
from ..shared import generateapikeyresponse as shared_generateapikeyresponse
...
class PostMerchantsMerchantIDAPICredentialsAPICredentialIDGenerateAPIKeySecurity:
...
@dataclasses.dataclass
class PostMerchantsMerchantIDAPICredentialsAPICredentialIDGenerateAPIKeyRequest:
...
@dataclasses.dataclass
class PostMerchantsMerchantIDAPICredentialsAPICredentialIDGenerateAPIKeyResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    generate_api_key_response: Optional[shared_generateapikeyresponse.GenerateAPIKeyResponse] = dataclasses.field(default=None)
