 ...
 */
public enum MonitoringProjectsTimeSeriesListAggregationPerSeriesAlignerEnum {
    ...
    private MonitoringProjectsTimeSeriesListAggregationPerSeriesAlignerEnum(String value) {
        this.value = value;
    }
}
