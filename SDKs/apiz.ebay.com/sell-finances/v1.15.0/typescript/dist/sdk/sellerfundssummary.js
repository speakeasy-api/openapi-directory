...
var SellerFundsSummary = /** @class */ (function () {
     ...
     */
    SellerFundsSummary.prototype.getSellerFundsSummary = function (req, security, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetSellerFundsSummaryResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.sellerFundsSummaryResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.SellerFundsSummaryResponse);
                    }
                    break;
