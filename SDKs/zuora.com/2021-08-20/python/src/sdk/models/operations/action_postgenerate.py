...
class ActionPOSTgenerateRequest:
    ...
    proxy_actiongenerate_request: shared_proxyactiongeneraterequest.ProxyActiongenerateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
