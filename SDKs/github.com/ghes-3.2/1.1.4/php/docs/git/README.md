...
try {
    ...
    $request->requestBody->content = 'veniam';
    $request->requestBody->encoding = 'minima';
...
try {
    ...
    $request->requestBody->author->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-06-30T09:48:42.630Z');
    $request->requestBody->author->email = 'Stephany44@gmail.com';
    $request->requestBody->author->name = 'Jack Langworth';
    $request->requestBody->committer = new GitCreateCommitRequestBodyCommitter();
    $request->requestBody->committer->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-03-24T14:47:17.315Z');
    $request->requestBody->committer->email = 'Justice_Mueller89@hotmail.com';
    $request->requestBody->committer->name = 'Sonya Heaney';
    $request->requestBody->message = 'corrupti';
    ...
    $request->requestBody->signature = 'fugiat';
    $request->requestBody->tree = 'voluptatem';
    $request->owner = 'culpa';
...
try {
    ...
    $request->requestBody->ref = 'magnam';
    $request->requestBody->sha = 'consequatur';
    $request->owner = 'esse';
    $request->repo = 'ipsam';
...
try {
    ...
    $request->requestBody->message = 'sit';
    $request->requestBody->object = 'voluptatum';
    $request->requestBody->tag = 'quas';
    $request->requestBody->tagger = new GitCreateTagRequestBodyTagger();
    $request->requestBody->tagger->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-12-01T12:56:16.650Z');
    $request->requestBody->tagger->email = 'Jo2@gmail.com';
    $request->requestBody->tagger->name = 'Bernice Ullrich II';
...
try {
    ...
    $request->requestBody->baseTree = 'dicta';
...
try {
    ...
    $request->recursive = 'perferendis';
    $request->repo = 'est';
    $request->treeSha = 'quidem';
...
try {
    ...
    $request->requestBody->sha = 'praesentium';
