...
class UpdateBackendAPIRequestBodyResourceConfigConflictResolutionResolutionStrategyEnum(str, Enum):
...
class UpdateBackendAPIRequestBodyResourceConfigConflictResolution:
    ...
    resolution_strategy: Optional[UpdateBackendAPIRequestBodyResourceConfigConflictResolutionResolutionStrategyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ResolutionStrategy'), 'exclude': lambda f: f is None }})  
    
class UpdateBackendAPIRequestBodyResourceConfigDefaultAuthTypeModeEnum(str, Enum):
...
class UpdateBackendAPIRequestBodyResourceConfigDefaultAuthType:
    ...
    mode: Optional[UpdateBackendAPIRequestBodyResourceConfigDefaultAuthTypeModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Mode'), 'exclude': lambda f: f is None }})  
    settings: Optional[UpdateBackendAPIRequestBodyResourceConfigDefaultAuthTypeSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Settings'), 'exclude': lambda f: f is None }})  
...
class UpdateBackendAPIRequestBodyResourceConfig:
    ...
    conflict_resolution: Optional[UpdateBackendAPIRequestBodyResourceConfigConflictResolution] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ConflictResolution'), 'exclude': lambda f: f is None }})  
    default_auth_type: Optional[UpdateBackendAPIRequestBodyResourceConfigDefaultAuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DefaultAuthType'), 'exclude': lambda f: f is None }})  
...
class UpdateBackendAPIRequestBody:
    ...
    resource_config: Optional[UpdateBackendAPIRequestBodyResourceConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resourceConfig'), 'exclude': lambda f: f is None }})
    r"""The resource config for the data model, configured as a part of the Amplify project."""  
...
class UpdateBackendAPIRequest:
    ...
    request_body: UpdateBackendAPIRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
