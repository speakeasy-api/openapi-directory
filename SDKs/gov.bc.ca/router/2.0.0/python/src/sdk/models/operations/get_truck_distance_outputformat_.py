...
class GetTruckDistanceOutputFormatOutputSrsEnum(str, Enum):
...
class GetTruckDistanceOutputFormatRequest:
    ...
    r"""distance unit of measure (e.g., km, mi). Default is km."""  
    output_srs: Optional[GetTruckDistanceOutputFormatOutputSrsEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outputSRS', 'style': 'form', 'explode': True }})
    r"""The EPSG code of the spatial reference system (SRS) to use for output geometries. See <a href=https://github.com/bcgov/ols-router/blob/gh-pages/glossary.md#outputSRS target=\\"_blank\\">outputSRS</a>"""  
