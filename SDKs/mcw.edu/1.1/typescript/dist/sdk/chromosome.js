...
var Chromosome = /** @class */ (function () {
    function Chromosome(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Chromosome.prototype.getChromosomeByAssemblyUsingGet = function (req, config) {
    ...
    **/
    Chromosome.prototype.getChromosomesByAssemblyUsingGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
