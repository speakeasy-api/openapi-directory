...
class ListTrunkingCountryListTrunkingCountryResponse:
    ...
    countries: Optional[list[shared_pricing_v2_trunking_country.PricingV2TrunkingCountry]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('countries'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListTrunkingCountryListTrunkingCountryResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
