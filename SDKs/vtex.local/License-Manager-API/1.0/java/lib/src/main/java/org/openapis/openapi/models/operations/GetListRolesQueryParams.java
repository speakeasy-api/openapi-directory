...
public class GetListRolesQueryParams {
    ...
    public GetListRolesQueryParams withNumItems(Long numItems) {
    ...
    public GetListRolesQueryParams withPageNumber(Long pageNumber) {
    ...
    public String sort;
    public GetListRolesQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetListRolesQueryParams withSortType(String sortType) {
