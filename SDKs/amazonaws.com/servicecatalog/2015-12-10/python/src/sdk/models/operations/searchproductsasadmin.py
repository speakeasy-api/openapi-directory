...
class SearchProductsAsAdminRequest:
    ...
    search_products_as_admin_input: shared_searchproductsasadmininput.SearchProductsAsAdminInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
