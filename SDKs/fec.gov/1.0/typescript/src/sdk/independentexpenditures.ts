...
export class IndependentExpenditures {
  ...
  getSchedulesScheduleE(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetSchedulesScheduleEResponse =
        new operations.GetSchedulesScheduleEResponse({
      ...
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleEPage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleEPage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleEByCandidate(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/schedules/schedule_e/by_candidate/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleEByCandidateResponse =
        new operations.GetSchedulesScheduleEByCandidateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleEByCandidatePage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleEByCandidatePage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleEEfile(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/schedules/schedule_e/efile/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleEEfileResponse =
        new operations.GetSchedulesScheduleEEfileResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleEEfilePage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleEEfilePage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleETotalsByCandidate(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/schedules/schedule_e/totals/by_candidate/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleETotalsByCandidateResponse =
        new operations.GetSchedulesScheduleETotalsByCandidateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ieTotalsByCandidatePage = utils.objectToClass(
              httpRes?.data,
              shared.IETotalsByCandidatePage
            );
          }
          break;
      }
