...
export enum GETDetachVerifiedAccessTrustProviderActionEnum {
  DetachVerifiedAccessTrustProvider = "DetachVerifiedAccessTrustProvider",
}

export enum GETDetachVerifiedAccessTrustProviderVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETDetachVerifiedAccessTrustProviderRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETDetachVerifiedAccessTrustProviderResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
