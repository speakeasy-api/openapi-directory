 ...
 */
export declare enum DiskTypeListWarningCodeEnum {
...
export declare class DiskTypeListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class DiskTypeListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class DiskTypeList extends SpeakeasyBase {
    /**
