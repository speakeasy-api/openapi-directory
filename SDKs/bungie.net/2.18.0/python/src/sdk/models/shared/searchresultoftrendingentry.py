...
from ..shared import trending_trendingentry as shared_trending_trendingentry
...
class SearchResultOfTrendingEntry:
    ...
    results: Optional[list[shared_trending_trendingentry.TrendingTrendingEntry]] = dataclasses.field(default=None)  
