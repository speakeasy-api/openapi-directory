 ...
 */
export enum PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJsonVehicleEngineTypeEnum {
  Combustion = "combustion",
  Electric = "electric",
}

export class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJsonRequest extends SpeakeasyBase {
  /**
...
export class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
