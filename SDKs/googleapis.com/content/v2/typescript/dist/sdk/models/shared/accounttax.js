...
var AccountTax = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: accounttaxtaxrule_1.AccountTaxTaxRule }),
        (0, class_transformer_1.Expose)({ name: "rules" }),
        (0, class_transformer_1.Type)(function () { return accounttaxtaxrule_1.AccountTaxTaxRule; }),
