...
class CreatePayeesCsvRequest2AddressCountryEnum(str, Enum):
    AF = "AF"
    AX = "AX"
    AL = "AL"
    DZ = "DZ"
...
class CreatePayeesCsvRequest2PaymentChannelCountryCodeEnum(str, Enum):
    AF = "AF"
    AX = "AX"
    AL = "AL"
    DZ = "DZ"
...
class CreatePayeesCsvRequest2PaymentChannelCurrencyEnum(str, Enum):
    USD = "USD"
    GBP = "GBP"
    EUR = "EUR"
...
class CreatePayeesCsvRequest2:
    ...
    address_country: CreatePayeesCsvRequest2AddressCountryEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('addressCountry') }})
    ...
    payment_channel_country_code: Optional[CreatePayeesCsvRequest2PaymentChannelCountryCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('paymentChannelCountryCode') }})
    payment_channel_currency: Optional[CreatePayeesCsvRequest2PaymentChannelCurrencyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('paymentChannelCurrency') }})
