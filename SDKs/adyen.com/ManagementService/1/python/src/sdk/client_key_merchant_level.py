...
class ClientKeyMerchantLevel:
    ...
    def post_merchants_merchant_id_api_credentials_api_credential_id_generate_client_key(self, request: operations.PostMerchantsMerchantIDAPICredentialsAPICredentialIDGenerateClientKeyRequest, security: operations.PostMerchantsMerchantIDAPICredentialsAPICredentialIDGenerateClientKeySecurity) -> operations.PostMerchantsMerchantIDAPICredentialsAPICredentialIDGenerateClientKeyResponse:
        ...
        * Management API—API credentials read and write
        ...
        url = utils.generate_url(operations.PostMerchantsMerchantIDAPICredentialsAPICredentialIDGenerateClientKeyRequest, base_url, '/merchants/{merchantId}/apiCredentials/{apiCredentialId}/generateClientKey', request)
        ...
        res = operations.PostMerchantsMerchantIDAPICredentialsAPICredentialIDGenerateClientKeyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
