...
public class ActionPOSTqueryMoreRequest {
    ...
    public org.openapis.openapi.models.shared.ProxyActionqueryMoreRequest proxyActionqueryMoreRequest;
    public ActionPOSTqueryMoreRequest withProxyActionqueryMoreRequest(org.openapis.openapi.models.shared.ProxyActionqueryMoreRequest proxyActionqueryMoreRequest) {
        this.proxyActionqueryMoreRequest = proxyActionqueryMoreRequest;
        return this;
    }
    ...
    public ActionPOSTqueryMoreRequest withXZuoraWSDLVersion(String xZuoraWSDLVersion) {
    ...
    public ActionPOSTqueryMoreRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public ActionPOSTqueryMoreRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public ActionPOSTqueryMoreRequest withRejectUnknownFields(Boolean rejectUnknownFields) {
