...
from ..shared import proxymodifyinvoice as shared_proxymodifyinvoice
...
class ObjectPUTInvoiceRequest:
    ...
    r"""Object id"""  
    proxy_modify_invoice: shared_proxymodifyinvoice.ProxyModifyInvoice = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
