...
exports.SocialNumber = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var SocialNumber = /** @class */ (function () {
    function SocialNumber(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    SocialNumber.prototype.getApiSocialNumber = function (req, config) {
    ...
    **/
    SocialNumber.prototype.postApiSocialNumber = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.SocialNumber = SocialNumber;
