...
class GETListStackSetsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GETListStackSetsCallAsEnum $callAs
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=CallAs')]
    public ?GETListStackSetsCallAsEnum $callAs = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GETListStackSetsStatusEnum $status
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=Status')]
    public ?GETListStackSetsStatusEnum $status = null;
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETListStackSetsActionEnum::LIST_STACK_SETS;
		$this->callAs = null;
		$this->maxResults = null;
		$this->nextToken = null;
		$this->status = null;
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETListStackSetsVersionEnum::TWO_THOUSAND_AND_TEN0515;
