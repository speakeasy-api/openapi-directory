...
class GetConnectionsIDConnectionLogsRequest:
    
    id_connection_path_parameter: int = dataclasses.field(metadata={'path_param': { 'field_name': 'id_connection', 'style': 'simple', 'explode': False }})  
    ...
    id_connection_query_parameter: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'id_connection', 'style': 'form', 'explode': True }})
...
class GetConnectionsIDConnectionLogsResponse:
    ...
    get_connections_id_connection_logs_200_application_json_object: Optional[GetConnectionsIDConnectionLogs200ApplicationJSON] = dataclasses.field(default=None)
    r"""connectionlogs"""  
