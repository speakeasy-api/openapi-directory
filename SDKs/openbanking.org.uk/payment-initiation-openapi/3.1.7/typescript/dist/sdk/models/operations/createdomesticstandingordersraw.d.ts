...
export declare class CreateDomesticStandingOrdersRawSecurity extends SpeakeasyBase {
    psuoAuth2Security: string;
}
export declare class CreateDomesticStandingOrdersRawRequest extends SpeakeasyBase {
    /**
...
export declare class CreateDomesticStandingOrdersRawResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
