...
public class GetV2NotesJsonQueryParams {
    /**
    ...
    public GetV2NotesJsonQueryParams withAssociatedWithId(Long associatedWithId) {
    ...
    public GetV2NotesJsonQueryParams withAssociatedWithType(String associatedWithType) {
    ...
    public Long[] ids;
    public GetV2NotesJsonQueryParams withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2NotesJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2NotesJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public Long page;
    public GetV2NotesJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2NotesJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2NotesJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2NotesJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public GetV2NotesJsonQueryParams withUpdatedAt(String[] updatedAt) {
