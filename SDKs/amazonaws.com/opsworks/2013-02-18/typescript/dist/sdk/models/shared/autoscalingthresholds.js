...
exports.AutoScalingThresholds = void 0;
...
var AutoScalingThresholds = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CpuThreshold" }),
        __metadata("design:type", Number)
    ], AutoScalingThresholds.prototype, "cpuThreshold", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=IgnoreMetricsTime" }),
        __metadata("design:type", Number)
    ], AutoScalingThresholds.prototype, "ignoreMetricsTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=InstanceCount" }),
        __metadata("design:type", Number)
    ], AutoScalingThresholds.prototype, "instanceCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=LoadThreshold" }),
        __metadata("design:type", Number)
    ], AutoScalingThresholds.prototype, "loadThreshold", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MemoryThreshold" }),
        __metadata("design:type", Number)
    ], AutoScalingThresholds.prototype, "memoryThreshold", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ThresholdsWaitTime" }),
        __metadata("design:type", Number)
