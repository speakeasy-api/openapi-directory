...
export declare class RecaptchaenterpriseProjectsRelatedaccountgroupsListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class RecaptchaenterpriseProjectsRelatedaccountgroupsListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class RecaptchaenterpriseProjectsRelatedaccountgroupsListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
