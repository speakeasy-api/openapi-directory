 ...
 */
public class InboundRealTimePaymentsTransferSimulationResultTransactionTransactionSourceCardDisputeAcceptance {
    /**
    ...
    public InboundRealTimePaymentsTransferSimulationResultTransactionTransactionSourceCardDisputeAcceptance withAcceptedAt(OffsetDateTime acceptedAt) {
    ...
    public InboundRealTimePaymentsTransferSimulationResultTransactionTransactionSourceCardDisputeAcceptance withCardDisputeId(String cardDisputeId) {
    ...
    public InboundRealTimePaymentsTransferSimulationResultTransactionTransactionSourceCardDisputeAcceptance withTransactionId(String transactionId) {
