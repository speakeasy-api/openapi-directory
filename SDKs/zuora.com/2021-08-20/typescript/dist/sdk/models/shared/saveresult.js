...
var SaveResult = /** @class */ (function (_super) {
    __extends(SaveResult, _super);
    function SaveResult() {
    ...
    ], SaveResult.prototype, "errors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Id" }),
        __metadata("design:type", String)
    ], SaveResult.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Success" }),
        __metadata("design:type", Boolean)
    ], SaveResult.prototype, "success", void 0);
    return SaveResult;
