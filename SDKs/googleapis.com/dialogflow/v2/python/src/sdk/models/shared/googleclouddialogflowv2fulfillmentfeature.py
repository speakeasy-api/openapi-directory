...
class GoogleCloudDialogflowV2FulfillmentFeature:
    ...
    type: Optional[GoogleCloudDialogflowV2FulfillmentFeatureTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of the feature that enabled for fulfillment."""  
