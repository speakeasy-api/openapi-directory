...
export class AssignOrganizationLicensesSeats200ApplicationJSONResultingLicensesPermanentlyQueuedLicenses extends SpeakeasyBase {
  /**
 ...
 */
export enum AssignOrganizationLicensesSeats200ApplicationJSONResultingLicensesStateEnum {
  Active = "active",
  Expired = "expired",
  Expiring = "expiring",
...
export class AssignOrganizationLicensesSeats200ApplicationJSONResultingLicenses extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata({
    elemType:
      AssignOrganizationLicensesSeats200ApplicationJSONResultingLicensesPermanentlyQueuedLicenses,
  })
 ...
 */
export class AssignOrganizationLicensesSeats200ApplicationJSON extends SpeakeasyBase {
  /**
   * Resulting licenses from the move
   */
  @SpeakeasyMetadata({
    elemType:
      AssignOrganizationLicensesSeats200ApplicationJSONResultingLicenses,
  })
