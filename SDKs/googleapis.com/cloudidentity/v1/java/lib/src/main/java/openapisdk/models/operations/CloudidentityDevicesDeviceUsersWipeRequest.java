...
public class CloudidentityDevicesDeviceUsersWipeRequest {
    ...
    public openapisdk.models.shared.GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest request;
    public CloudidentityDevicesDeviceUsersWipeRequest withRequest(openapisdk.models.shared.GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest request) {
