...
class PrivatecaProjectsLocationsReusableConfigsTestIamPermissionsRequest:
    path_params: PrivatecaProjectsLocationsReusableConfigsTestIamPermissionsPathParams = dataclasses.field()
    query_params: PrivatecaProjectsLocationsReusableConfigsTestIamPermissionsQueryParams = dataclasses.field()
    security: PrivatecaProjectsLocationsReusableConfigsTestIamPermissionsSecurity = dataclasses.field()
