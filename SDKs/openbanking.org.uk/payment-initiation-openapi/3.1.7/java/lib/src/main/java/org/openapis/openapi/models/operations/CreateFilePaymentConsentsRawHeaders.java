...
public class CreateFilePaymentConsentsRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateFilePaymentConsentsRawHeaders withAuthorization(String authorization) {
    ...
    public CreateFilePaymentConsentsRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateFilePaymentConsentsRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateFilePaymentConsentsRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateFilePaymentConsentsRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateFilePaymentConsentsRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateFilePaymentConsentsRawHeaders withXJwsSignature(String xJwsSignature) {
