...
public class ListQuerySuggestionsBlockListsRequest {
    ...
    public ListQuerySuggestionsBlockListsRequest(@JsonProperty("ListQuerySuggestionsBlockListsRequest") org.openapis.openapi.models.shared.ListQuerySuggestionsBlockListsRequest listQuerySuggestionsBlockListsRequest, @JsonProperty("X-Amz-Target") ListQuerySuggestionsBlockListsXAmzTargetEnum xAmzTarget) {
        this.listQuerySuggestionsBlockListsRequest = listQuerySuggestionsBlockListsRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
