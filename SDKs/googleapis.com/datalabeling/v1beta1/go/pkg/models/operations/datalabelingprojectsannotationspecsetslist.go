...
type DatalabelingProjectsAnnotationSpecSetsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DatalabelingProjectsAnnotationSpecSetsListPathParams struct {
	// Required. Parent of AnnotationSpecSet resource, format: projects/{project_id}
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type DatalabelingProjectsAnnotationSpecSetsListQueryParams struct {
	// V1 error format.
...
type DatalabelingProjectsAnnotationSpecSetsListRequest struct {
...
type DatalabelingProjectsAnnotationSpecSetsListResponse struct {
	ContentType string
	// Successful response
