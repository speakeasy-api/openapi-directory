...
class DescribeAssessmentTemplatesRequest:
    ...
    describe_assessment_templates_request: shared_describeassessmenttemplatesrequest.DescribeAssessmentTemplatesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
