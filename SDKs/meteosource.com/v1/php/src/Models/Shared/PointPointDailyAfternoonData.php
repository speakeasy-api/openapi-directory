...
class PointPointDailyAfternoonData
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PointPointDailyAfternoonCloudCoverData')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PointPointDailyAfternoonPrecipitationData')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PointPointDailyAfternoonProbData')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PointPointDailyAfternoonWindData')]
	...
	{
		$this->cloudCover = new \OpenAPI\OpenAPI\Models\Shared\PointPointDailyAfternoonCloudCoverData();
		$this->dewPoint = null;
		$this->feelsLike = null;
		$this->humidity = null;
		$this->icon = null;
		$this->ozone = null;
		$this->precipitation = new \OpenAPI\OpenAPI\Models\Shared\PointPointDailyAfternoonPrecipitationData();
		$this->pressure = null;
		$this->probability = new \OpenAPI\OpenAPI\Models\Shared\PointPointDailyAfternoonProbData();
		$this->snowDepth = null;
		...
		$this->weather = null;
		$this->wind = new \OpenAPI\OpenAPI\Models\Shared\PointPointDailyAfternoonWindData();
		$this->windChill = null;
	}
}
