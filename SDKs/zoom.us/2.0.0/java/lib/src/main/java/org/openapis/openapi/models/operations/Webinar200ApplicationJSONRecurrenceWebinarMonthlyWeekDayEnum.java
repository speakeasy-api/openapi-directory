 ...
 */
public enum Webinar200ApplicationJSONRecurrenceWebinarMonthlyWeekDayEnum {
    ONE("1"),
    TWO("2"),
    THREE("3"),
    FOUR("4"),
    ...
    private Webinar200ApplicationJSONRecurrenceWebinarMonthlyWeekDayEnum(String value) {
        this.value = value;
    }
}
