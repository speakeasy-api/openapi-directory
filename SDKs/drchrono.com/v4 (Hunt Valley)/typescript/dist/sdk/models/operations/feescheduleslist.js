...
exports.FeeSchedulesListResponse = exports.FeeSchedulesList200ApplicationJSON = exports.FeeSchedulesListRequest = exports.FeeSchedulesListSecurity = void 0;
...
var FeeSchedulesListRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], FeeSchedulesListRequest.prototype, "code", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=code_type",
        }),
        __metadata("design:type", String)
    ], FeeSchedulesListRequest.prototype, "codeType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=cursor",
        }),
        __metadata("design:type", String)
    ], FeeSchedulesListRequest.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=doctor",
        }),
        __metadata("design:type", Number)
    ], FeeSchedulesListRequest.prototype, "doctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], FeeSchedulesListRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=payer_id",
        }),
        __metadata("design:type", String)
    ], FeeSchedulesListRequest.prototype, "payerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=since" }),
        __metadata("design:type", String)
    ], FeeSchedulesListRequest.prototype, "since", void 0);
...
var FeeSchedulesList200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.DoctorFeeSchedule }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return shared.DoctorFeeSchedule; }),
...
var FeeSchedulesListResponse = /** @class */ (function (_super) {
    ...
    ], FeeSchedulesListResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
