 ...
 */
export enum NetworkEdgeSecurityServicesScopedListWarningCodeEnum {
...
export class NetworkEdgeSecurityServicesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NetworkEdgeSecurityServicesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
...
export class NetworkEdgeSecurityServicesScopedList extends SpeakeasyBase {
  /**
   * A list of NetworkEdgeSecurityServices contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: NetworkEdgeSecurityService })
  @Expose({ name: "networkEdgeSecurityServices" })
