...
class DeleteDebitMemoRequest:
    headers: DeleteDebitMemoHeaders = dataclasses.field()
    path_params: DeleteDebitMemoPathParams = dataclasses.field()
