...
export class VmmigrationProjectsLocationsSourcesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsSourcesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsSourcesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
