...
class GetNetworkWirelessConnectionStatsRequest:
    path_params: GetNetworkWirelessConnectionStatsPathParams = dataclasses.field()
    query_params: GetNetworkWirelessConnectionStatsQueryParams = dataclasses.field()
...
class GetNetworkWirelessConnectionStatsResponse:
    ...
    get_network_wireless_connection_stats_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
