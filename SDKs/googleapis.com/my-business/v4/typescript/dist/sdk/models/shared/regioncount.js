...
**/
var RegionCount = /** @class */ (function (_super) {
    __extends(RegionCount, _super);
    ...
    ], RegionCount.prototype, "count", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=label" }),
        __metadata("design:type", String)
    ], RegionCount.prototype, "label", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=latlng" }),
        __metadata("design:type", latlng_1.LatLng)
    ], RegionCount.prototype, "latlng", void 0);
    return RegionCount;
