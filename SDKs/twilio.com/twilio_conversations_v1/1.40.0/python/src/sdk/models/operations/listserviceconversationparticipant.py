...
class ListServiceConversationParticipantListServiceConversationParticipantResponse:
    ...
    meta: Optional[ListServiceConversationParticipantListServiceConversationParticipantResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    participants: Optional[list[shared_conversations_v1_service_service_conversation_service_conversation_participant.ConversationsV1ServiceServiceConversationServiceConversationParticipant]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('participants'), 'exclude': lambda f: f is None }})  
