...
class DeprecatedServices 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\MerchantCancellationResponse
    {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\MerchantCancellationResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->merchantCancellation200ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\MerchantCancellation200ApplicationJSON', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 400) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->merchantCancellation400ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\MerchantCancellation400ApplicationJSON', 'json');
            }
        }
