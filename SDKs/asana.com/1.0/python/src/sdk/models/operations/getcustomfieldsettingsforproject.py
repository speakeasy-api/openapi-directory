...
class GetCustomFieldSettingsForProject200ApplicationJSON:
    r"""Successfully retrieved custom field settings objects for a project."""
    
    data: Optional[list[shared_customfieldsettingresponse.CustomFieldSettingResponse]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
