...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Prfnd(ctx, operations.PrfndRequestBody{
        CertificateParameters: &operations.PrfndRequestBodyCertificateParameters{
            AcNo: "T/AIS/XX or 123456789",
            Dob: "31-12-1980",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
        ...
        Format: operations.PrfndRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.PrfndSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
