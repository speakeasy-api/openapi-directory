...
SERVERS = [
    ...
    r"""The CodeDeploy multi-region endpoint"""
    "https://codedeploy.{region}.amazonaws.com",
    r"""The CodeDeploy multi-region endpoint"""
    "http://codedeploy.{region}.amazonaws.com.cn",
    r"""The CodeDeploy endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    ...
    def add_tags_to_on_premises_instances(self, request: operations.AddTagsToOnPremisesInstancesRequest) -> operations.AddTagsToOnPremisesInstancesResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "add_tags_to_on_premises_instances_input", 'json')
        ...
        res = operations.AddTagsToOnPremisesInstancesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def batch_get_application_revisions(self, request: operations.BatchGetApplicationRevisionsRequest) -> operations.BatchGetApplicationRevisionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "batch_get_application_revisions_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.BatchGetApplicationRevisionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.BatchGetApplicationRevisionsOutput])
    ...
    def batch_get_applications(self, request: operations.BatchGetApplicationsRequest) -> operations.BatchGetApplicationsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "batch_get_applications_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.BatchGetApplicationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.BatchGetApplicationsOutput])
    ...
    def batch_get_deployment_groups(self, request: operations.BatchGetDeploymentGroupsRequest) -> operations.BatchGetDeploymentGroupsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "batch_get_deployment_groups_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.BatchGetDeploymentGroupsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.BatchGetDeploymentGroupsOutput])
    ...
    def batch_get_deployment_instances(self, request: operations.BatchGetDeploymentInstancesRequest) -> operations.BatchGetDeploymentInstancesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "batch_get_deployment_instances_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.BatchGetDeploymentInstancesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.BatchGetDeploymentInstancesOutput])
    ...
    def batch_get_deployment_targets(self, request: operations.BatchGetDeploymentTargetsRequest) -> operations.BatchGetDeploymentTargetsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "batch_get_deployment_targets_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.BatchGetDeploymentTargetsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.BatchGetDeploymentTargetsOutput])
    ...
    def batch_get_deployments(self, request: operations.BatchGetDeploymentsRequest) -> operations.BatchGetDeploymentsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "batch_get_deployments_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.BatchGetDeploymentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.BatchGetDeploymentsOutput])
    ...
    def batch_get_on_premises_instances(self, request: operations.BatchGetOnPremisesInstancesRequest) -> operations.BatchGetOnPremisesInstancesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "batch_get_on_premises_instances_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.BatchGetOnPremisesInstancesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.BatchGetOnPremisesInstancesOutput])
    ...
    def continue_deployment(self, request: operations.ContinueDeploymentRequest) -> operations.ContinueDeploymentResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "continue_deployment_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ContinueDeploymentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def create_application(self, request: operations.CreateApplicationRequest) -> operations.CreateApplicationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_application_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateApplicationOutput])
    ...
    def create_deployment(self, request: operations.CreateDeploymentRequest) -> operations.CreateDeploymentResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_deployment_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateDeploymentOutput])
    ...
    def create_deployment_config(self, request: operations.CreateDeploymentConfigRequest) -> operations.CreateDeploymentConfigResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_deployment_config_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateDeploymentConfigResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateDeploymentConfigOutput])
    ...
    def create_deployment_group(self, request: operations.CreateDeploymentGroupRequest) -> operations.CreateDeploymentGroupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_deployment_group_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateDeploymentGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateDeploymentGroupOutput])
    ...
    def delete_application(self, request: operations.DeleteApplicationRequest) -> operations.DeleteApplicationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_application_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def delete_deployment_config(self, request: operations.DeleteDeploymentConfigRequest) -> operations.DeleteDeploymentConfigResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_deployment_config_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteDeploymentConfigResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_deployment_group(self, request: operations.DeleteDeploymentGroupRequest) -> operations.DeleteDeploymentGroupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_deployment_group_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteDeploymentGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteDeploymentGroupOutput])
    ...
    def delete_git_hub_account_token(self, request: operations.DeleteGitHubAccountTokenRequest) -> operations.DeleteGitHubAccountTokenResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_git_hub_account_token_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteGitHubAccountTokenResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteGitHubAccountTokenOutput])
    ...
    def delete_resources_by_external_id(self, request: operations.DeleteResourcesByExternalIDRequest) -> operations.DeleteResourcesByExternalIDResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_resources_by_external_id_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteResourcesByExternalIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def deregister_on_premises_instance(self, request: operations.DeregisterOnPremisesInstanceRequest) -> operations.DeregisterOnPremisesInstanceResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "deregister_on_premises_instance_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeregisterOnPremisesInstanceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_application(self, request: operations.GetApplicationRequest) -> operations.GetApplicationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_application_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def get_application_revision(self, request: operations.GetApplicationRevisionRequest) -> operations.GetApplicationRevisionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_application_revision_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetApplicationRevisionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetApplicationRevisionOutput])
    ...
    def get_deployment(self, request: operations.GetDeploymentRequest) -> operations.GetDeploymentResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_deployment_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetDeploymentOutput])
    ...
    def get_deployment_config(self, request: operations.GetDeploymentConfigRequest) -> operations.GetDeploymentConfigResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_deployment_config_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetDeploymentConfigResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetDeploymentConfigOutput])
    ...
    def get_deployment_group(self, request: operations.GetDeploymentGroupRequest) -> operations.GetDeploymentGroupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_deployment_group_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetDeploymentGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetDeploymentGroupOutput])
    ...
    def get_deployment_instance(self, request: operations.GetDeploymentInstanceRequest) -> operations.GetDeploymentInstanceResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_deployment_instance_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetDeploymentInstanceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetDeploymentInstanceOutput])
    ...
    def get_deployment_target(self, request: operations.GetDeploymentTargetRequest) -> operations.GetDeploymentTargetResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_deployment_target_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetDeploymentTargetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetDeploymentTargetOutput])
    ...
    def get_on_premises_instance(self, request: operations.GetOnPremisesInstanceRequest) -> operations.GetOnPremisesInstanceResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_on_premises_instance_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetOnPremisesInstanceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetOnPremisesInstanceOutput])
    ...
    def list_application_revisions(self, request: operations.ListApplicationRevisionsRequest) -> operations.ListApplicationRevisionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_application_revisions_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListApplicationRevisionsRequest, request)
        ...
        res = operations.ListApplicationRevisionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListApplicationRevisionsOutput])
    ...
    def list_applications(self, request: operations.ListApplicationsRequest) -> operations.ListApplicationsResponse:
        r"""Lists the applications registered with the IAM user or Amazon Web Services account."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=CodeDeploy_20141006.ListApplications'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_applications_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def list_deployment_configs(self, request: operations.ListDeploymentConfigsRequest) -> operations.ListDeploymentConfigsResponse:
        r"""Lists the deployment configurations with the IAM user or Amazon Web Services account."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentConfigs'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_deployment_configs_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListDeploymentConfigsRequest, request)
        ...
        res = operations.ListDeploymentConfigsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListDeploymentConfigsOutput])
    ...
    def list_deployment_groups(self, request: operations.ListDeploymentGroupsRequest) -> operations.ListDeploymentGroupsResponse:
        r"""Lists the deployment groups for an application registered with the IAM user or Amazon Web Services account."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentGroups'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_deployment_groups_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListDeploymentGroupsRequest, request)
        ...
        res = operations.ListDeploymentGroupsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListDeploymentGroupsOutput])
    ...
    def list_deployment_instances(self, request: operations.ListDeploymentInstancesRequest) -> operations.ListDeploymentInstancesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_deployment_instances_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListDeploymentInstancesRequest, request)
        ...
        res = operations.ListDeploymentInstancesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListDeploymentInstancesOutput])
    ...
    def list_deployment_targets(self, request: operations.ListDeploymentTargetsRequest) -> operations.ListDeploymentTargetsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_deployment_targets_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ListDeploymentTargetsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListDeploymentTargetsOutput])
    ...
    def list_deployments(self, request: operations.ListDeploymentsRequest) -> operations.ListDeploymentsResponse:
        r"""Lists the deployments in a deployment group for an application registered with the IAM user or Amazon Web Services account."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=CodeDeploy_20141006.ListDeployments'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_deployments_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListDeploymentsOutput])
    ...
    def list_git_hub_account_token_names(self, request: operations.ListGitHubAccountTokenNamesRequest) -> operations.ListGitHubAccountTokenNamesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_git_hub_account_token_names_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ListGitHubAccountTokenNamesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListGitHubAccountTokenNamesOutput])
    ...
    def list_on_premises_instances(self, request: operations.ListOnPremisesInstancesRequest) -> operations.ListOnPremisesInstancesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_on_premises_instances_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ListOnPremisesInstancesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListOnPremisesInstancesOutput])
    ...
    def put_lifecycle_event_hook_execution_status(self, request: operations.PutLifecycleEventHookExecutionStatusRequest) -> operations.PutLifecycleEventHookExecutionStatusResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "put_lifecycle_event_hook_execution_status_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.PutLifecycleEventHookExecutionStatusResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PutLifecycleEventHookExecutionStatusOutput])
    ...
    def register_application_revision(self, request: operations.RegisterApplicationRevisionRequest) -> operations.RegisterApplicationRevisionResponse:
        r"""Registers with CodeDeploy a revision for the specified application."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=CodeDeploy_20141006.RegisterApplicationRevision'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "register_application_revision_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RegisterApplicationRevisionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def register_on_premises_instance(self, request: operations.RegisterOnPremisesInstanceRequest) -> operations.RegisterOnPremisesInstanceResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "register_on_premises_instance_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RegisterOnPremisesInstanceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_tags_from_on_premises_instances(self, request: operations.RemoveTagsFromOnPremisesInstancesRequest) -> operations.RemoveTagsFromOnPremisesInstancesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "remove_tags_from_on_premises_instances_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RemoveTagsFromOnPremisesInstancesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def skip_wait_time_for_instance_termination(self, request: operations.SkipWaitTimeForInstanceTerminationRequest) -> operations.SkipWaitTimeForInstanceTerminationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "skip_wait_time_for_instance_termination_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SkipWaitTimeForInstanceTerminationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def stop_deployment(self, request: operations.StopDeploymentRequest) -> operations.StopDeploymentResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "stop_deployment_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StopDeploymentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StopDeploymentOutput])
    ...
    def update_application(self, request: operations.UpdateApplicationRequest) -> operations.UpdateApplicationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_application_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def update_deployment_group(self, request: operations.UpdateDeploymentGroupRequest) -> operations.UpdateDeploymentGroupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_deployment_group_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateDeploymentGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateDeploymentGroupOutput])
