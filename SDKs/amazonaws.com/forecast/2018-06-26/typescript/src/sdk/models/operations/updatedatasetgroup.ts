...
export enum UpdateDatasetGroupXAmzTargetEnum {
    AmazonForecastUpdateDatasetGroup = "AmazonForecast.UpdateDatasetGroup"
}


export class UpdateDatasetGroupHeaders extends SpeakeasyBase {
...
export class UpdateDatasetGroupResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
