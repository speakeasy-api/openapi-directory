...
class GetJournalRunTransactionTypeTypeEnum(str, Enum):
...
class GetJournalRunTransactionType:
    type: Optional[GetJournalRunTransactionTypeTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
