...
public class BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput {
    ...
    public BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput(@JsonProperty("disassociatedRepositoryNames") String[] disassociatedRepositoryNames, @JsonProperty("errors") BatchDisassociateApprovalRuleTemplateFromRepositoriesError[] errors) {
        this.disassociatedRepositoryNames = disassociatedRepositoryNames;
        this.errors = errors;
  }
}
