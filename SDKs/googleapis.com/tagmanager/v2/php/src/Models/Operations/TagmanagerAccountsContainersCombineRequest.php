...
class TagmanagerAccountsContainersCombineRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\TagmanagerAccountsContainersCombineSettingSourceEnum $settingSource
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=settingSource')]
    public ?TagmanagerAccountsContainersCombineSettingSourceEnum $settingSource = null;
