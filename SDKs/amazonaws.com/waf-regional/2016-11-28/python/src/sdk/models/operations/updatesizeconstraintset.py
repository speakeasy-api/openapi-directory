...
class UpdateSizeConstraintSetRequest:
    ...
    update_size_constraint_set_request: shared_updatesizeconstraintsetrequest.UpdateSizeConstraintSetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
