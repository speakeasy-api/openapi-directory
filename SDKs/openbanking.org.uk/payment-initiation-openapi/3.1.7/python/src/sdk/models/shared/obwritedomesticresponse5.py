...
class ObWriteDomesticResponse5DataInitiation:
    ...
    creditor_account: ObWriteDomesticResponse5DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('CreditorAccount') }})
    ...
    instructed_amount: ObWriteDomesticResponse5DataInitiationInstructedAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('InstructedAmount') }})
    ...
    debtor_account: Optional[ObWriteDomesticResponse5DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DebtorAccount') }})
    ...
    remittance_information: Optional[ObWriteDomesticResponse5DataInitiationRemittanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RemittanceInformation') }})
...
class ObWriteDomesticResponse5DataMultiAuthorisation:
    ...
    status: ObWriteDomesticResponse5DataMultiAuthorisationStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Status') }})
...
class ObWriteDomesticResponse5DataRefund:
    ...
    account: ObWriteDomesticResponse5DataRefundAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Account') }})
...
class ObWriteDomesticResponse5Data:
    ...
    domestic_payment_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('DomesticPaymentId') }})
    initiation: ObWriteDomesticResponse5DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Initiation') }})
    status: ObWriteDomesticResponse5DataStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Status') }})
    ...
    charges: Optional[list[ObWriteDomesticResponse5DataCharges]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Charges') }})
    ...
    multi_authorisation: Optional[ObWriteDomesticResponse5DataMultiAuthorisation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('MultiAuthorisation') }})
    refund: Optional[ObWriteDomesticResponse5DataRefund] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Refund') }})
    

@dataclass_json
@dataclasses.dataclass
class ObWriteDomesticResponse5:
    data: ObWriteDomesticResponse5Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Data') }})
