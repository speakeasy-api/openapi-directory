...
export class AndroiddeviceprovisioningCustomersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AndroiddeviceprovisioningCustomersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
