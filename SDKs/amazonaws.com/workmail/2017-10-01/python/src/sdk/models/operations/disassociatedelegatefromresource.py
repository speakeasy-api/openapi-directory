...
class DisassociateDelegateFromResourceRequest:
    ...
    disassociate_delegate_from_resource_request: shared_disassociatedelegatefromresourcerequest.DisassociateDelegateFromResourceRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
