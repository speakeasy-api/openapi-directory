 ...
 * 
 */
public enum PUTSubscriptionResumeTypeRunBillingEnum {
    TRUE("true"),
    FALSE("false");
    ...
    private PUTSubscriptionResumeTypeRunBillingEnum(String value) {
        this.value = value;
    }
}
