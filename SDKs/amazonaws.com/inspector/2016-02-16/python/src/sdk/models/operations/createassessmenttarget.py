...
class CreateAssessmentTargetRequest:
    ...
    create_assessment_target_request: shared_createassessmenttargetrequest.CreateAssessmentTargetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
