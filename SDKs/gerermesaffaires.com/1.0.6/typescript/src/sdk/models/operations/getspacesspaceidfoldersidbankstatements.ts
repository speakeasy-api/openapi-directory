...
export class GetSpacesSpaceIdFoldersIdBankStatementsRequest extends SpeakeasyBase {
  /**
...
export class GetSpacesSpaceIdFoldersIdBankStatementsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
