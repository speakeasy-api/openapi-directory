...
export class GetPhenotypeAnatomyAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetPhenotypeAnatomyAssociationsQueryParams extends SpeakeasyBase {
...
export class GetPhenotypeAnatomyAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetPhenotypeAnatomyAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;

  @SpeakeasyMetadata({ elemType: shared.NamedObject })
