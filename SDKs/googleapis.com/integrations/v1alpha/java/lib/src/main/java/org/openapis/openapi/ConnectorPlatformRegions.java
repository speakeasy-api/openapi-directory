...
public class ConnectorPlatformRegions {
	...
	public ConnectorPlatformRegions(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.IntegrationsConnectorPlatformRegionsEnumerateResponse integrationsConnectorPlatformRegionsEnumerate(org.openapis.openapi.models.operations.IntegrationsConnectorPlatformRegionsEnumerateRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.GoogleCloudIntegrationsV1alphaEnumerateConnectorPlatformRegionsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.GoogleCloudIntegrationsV1alphaEnumerateConnectorPlatformRegionsResponse.class);
