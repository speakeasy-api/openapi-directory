...
var GetAutoSnapshotsResult = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: autosnapshotdetails_1.AutoSnapshotDetails }),
        (0, class_transformer_1.Expose)({ name: "autoSnapshots" }),
        (0, class_transformer_1.Type)(function () { return autosnapshotdetails_1.AutoSnapshotDetails; }),
