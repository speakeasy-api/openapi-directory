 ...
 */
export declare const ServerList: readonly ["http://snowball.{region}.amazonaws.com", "https://snowball.{region}.amazonaws.com", "http://snowball.{region}.amazonaws.com.cn", "https://snowball.{region}.amazonaws.com.cn"];
/**
...
export declare class SDK {
     ...
     */
    cancelCluster(req: operations.CancelClusterRequest, config?: AxiosRequestConfig): Promise<operations.CancelClusterResponse>;
    /**
     ...
     */
    createLongTermPricing(req: operations.CreateLongTermPricingRequest, config?: AxiosRequestConfig): Promise<operations.CreateLongTermPricingResponse>;
    /**
     * Creates a shipping label that will be used to return the Snow device to Amazon Web Services.
     */
    createReturnShippingLabel(req: operations.CreateReturnShippingLabelRequest, config?: AxiosRequestConfig): Promise<operations.CreateReturnShippingLabelResponse>;
    /**
     * Takes an <code>AddressId</code> and returns specific details about that address in the form of an <code>Address</code> object.
     */
    describeAddress(req: operations.DescribeAddressRequest, config?: AxiosRequestConfig): Promise<operations.DescribeAddressResponse>;
    /**
     ...
     */
    describeAddresses(req: operations.DescribeAddressesRequest, config?: AxiosRequestConfig): Promise<operations.DescribeAddressesResponse>;
    /**
     ...
     */
    describeReturnShippingLabel(req: operations.DescribeReturnShippingLabelRequest, config?: AxiosRequestConfig): Promise<operations.DescribeReturnShippingLabelResponse>;
    /**
     ...
     */
    getJobManifest(req: operations.GetJobManifestRequest, config?: AxiosRequestConfig): Promise<operations.GetJobManifestResponse>;
    /**
     ...
     */
    getJobUnlockCode(req: operations.GetJobUnlockCodeRequest, config?: AxiosRequestConfig): Promise<operations.GetJobUnlockCodeResponse>;
    /**
     ...
     */
    getSnowballUsage(req: operations.GetSnowballUsageRequest, config?: AxiosRequestConfig): Promise<operations.GetSnowballUsageResponse>;
    /**
     * Returns an Amazon S3 presigned URL for an update file associated with a specified <code>JobId</code>.
     */
    getSoftwareUpdates(req: operations.GetSoftwareUpdatesRequest, config?: AxiosRequestConfig): Promise<operations.GetSoftwareUpdatesResponse>;
    /**
     ...
     */
    listClusterJobs(req: operations.ListClusterJobsRequest, config?: AxiosRequestConfig): Promise<operations.ListClusterJobsResponse>;
    /**
     ...
     */
    listCompatibleImages(req: operations.ListCompatibleImagesRequest, config?: AxiosRequestConfig): Promise<operations.ListCompatibleImagesResponse>;
    /**
     ...
     */
    listLongTermPricing(req: operations.ListLongTermPricingRequest, config?: AxiosRequestConfig): Promise<operations.ListLongTermPricingResponse>;
    /**
     ...
     */
    listServiceVersions(req: operations.ListServiceVersionsRequest, config?: AxiosRequestConfig): Promise<operations.ListServiceVersionsResponse>;
    /**
     ...
     */
    updateJobShipmentState(req: operations.UpdateJobShipmentStateRequest, config?: AxiosRequestConfig): Promise<operations.UpdateJobShipmentStateResponse>;
    /**
     * Updates the long-term pricing type.
     */
    updateLongTermPricing(req: operations.UpdateLongTermPricingRequest, config?: AxiosRequestConfig): Promise<operations.UpdateLongTermPricingResponse>;
}
