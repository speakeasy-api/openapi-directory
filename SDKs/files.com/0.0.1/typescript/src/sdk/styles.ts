  ...
  **/
  deleteStylesPath(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.DeleteStylesPathResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  getStylesPath(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetStylesPathResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  patchStylesPath(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PatchStylesPathResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.styleEntity = httpRes?.data;
