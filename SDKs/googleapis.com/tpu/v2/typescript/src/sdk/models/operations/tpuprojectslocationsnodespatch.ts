...
export class TpuProjectsLocationsNodesPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class TpuProjectsLocationsNodesPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class TpuProjectsLocationsNodesPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
