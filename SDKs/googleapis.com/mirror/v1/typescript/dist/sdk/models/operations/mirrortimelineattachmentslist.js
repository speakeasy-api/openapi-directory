...
exports.MirrorTimelineAttachmentsListResponse = exports.MirrorTimelineAttachmentsListRequest = exports.MirrorTimelineAttachmentsListSecurity = void 0;
...
var MirrorTimelineAttachmentsListRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsListRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsListRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=itemId",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsListRequest.prototype, "itemId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsListRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsListRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], MirrorTimelineAttachmentsListRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsListRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsListRequest.prototype, "userIp", void 0);
...
var MirrorTimelineAttachmentsListResponse = /** @class */ (function (_super) {
    ...
    ], MirrorTimelineAttachmentsListResponse.prototype, "rawResponse", void 0);
