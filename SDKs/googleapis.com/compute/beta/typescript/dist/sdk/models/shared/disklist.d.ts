 ...
 */
export declare enum DiskListWarningCodeEnum {
...
export declare class DiskListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class DiskListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class DiskList extends SpeakeasyBase {
    /**
