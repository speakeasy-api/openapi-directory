...
class AddFollowersRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\AddFollowersRequestBody $requestBody
     */
	...
	{
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\AddFollowersRequestBody();
		$this->goalGid = "";
		$this->optFields = null;
		$this->optPretty = null;
	}
