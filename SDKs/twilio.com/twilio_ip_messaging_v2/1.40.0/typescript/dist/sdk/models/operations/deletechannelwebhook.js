...
exports.DeleteChannelWebhookResponse = exports.DeleteChannelWebhookRequest = exports.DeleteChannelWebhookSecurity = exports.DeleteChannelWebhookServerList = void 0;
var utils_1 = require("../../../internal/utils");
exports.DeleteChannelWebhookServerList = [
...
var DeleteChannelWebhookSecurity = /** @class */ (function (_super) {
    ...
    ], DeleteChannelWebhookSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], DeleteChannelWebhookSecurity.prototype, "username", void 0);
    return DeleteChannelWebhookSecurity;
}(utils_1.SpeakeasyBase));
exports.DeleteChannelWebhookSecurity = DeleteChannelWebhookSecurity;
var DeleteChannelWebhookRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DeleteChannelWebhookRequest.prototype, "channelSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], DeleteChannelWebhookRequest.prototype, "serviceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=Sid" }),
        __metadata("design:type", String)
    ], DeleteChannelWebhookRequest.prototype, "sid", void 0);
    return DeleteChannelWebhookRequest;
}(utils_1.SpeakeasyBase));
exports.DeleteChannelWebhookRequest = DeleteChannelWebhookRequest;
var DeleteChannelWebhookResponse = /** @class */ (function (_super) {
    ...
    ], DeleteChannelWebhookResponse.prototype, "rawResponse", void 0);
    return DeleteChannelWebhookResponse;
}(utils_1.SpeakeasyBase));
exports.DeleteChannelWebhookResponse = DeleteChannelWebhookResponse;
