...
class GoogleAnalyticsAdminV1betaListMeasurementProtocolSecretsResponse:
    ...
    measurement_protocol_secrets: Optional[list[shared_googleanalyticsadminv1betameasurementprotocolsecret.GoogleAnalyticsAdminV1betaMeasurementProtocolSecret]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('measurementProtocolSecrets'), 'exclude': lambda f: f is None }})
