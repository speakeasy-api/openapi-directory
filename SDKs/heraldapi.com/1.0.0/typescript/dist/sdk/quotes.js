...
var Quotes = /** @class */ (function () {
    function Quotes(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    Quotes.prototype.getQuotesQuoteId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetQuotesQuoteIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/quotes/{quote_id}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetQuotesQuoteIdResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getQuotesQuoteId200ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetQuotesQuoteId200ApplicationJSON);
                    }
                    break;
            }
            return res;
