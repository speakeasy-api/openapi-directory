...
import dataclasses
from ..shared import googleiamv1_auditlogconfig as shared_googleiamv1_auditlogconfig
...
class GoogleIamV1AuditConfig:
    ...
    audit_log_configs: Optional[list[shared_googleiamv1_auditlogconfig.GoogleIamV1AuditLogConfig]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auditLogConfigs'), 'exclude': lambda f: f is None }})
