...
exports.PhotoControllerGetPhotoDownloadResponse = exports.PhotoControllerGetPhotoDownloadRequest = void 0;
...
var PhotoControllerGetPhotoDownloadRequest = /** @class */ (function (_super) {
    ...
    ], PhotoControllerGetPhotoDownloadRequest.prototype, "height", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=photoID",
        }),
        __metadata("design:type", String)
    ], PhotoControllerGetPhotoDownloadRequest.prototype, "photoID", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=shortName",
        }),
        __metadata("design:type", String)
    ], PhotoControllerGetPhotoDownloadRequest.prototype, "shortName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=token" }),
        __metadata("design:type", String)
    ], PhotoControllerGetPhotoDownloadRequest.prototype, "token", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=width" }),
        __metadata("design:type", Number)
    ], PhotoControllerGetPhotoDownloadRequest.prototype, "width", void 0);
...
var PhotoControllerGetPhotoDownloadResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], PhotoControllerGetPhotoDownloadResponse.prototype, "rawResponse", void 0);
