...
var Oauth = /** @class */ (function () {
     ...
     *
    **/
    Oauth.prototype.getConnect = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetConnectRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/connect";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 302:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.getConnect302ApplicationJSONString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
    ...
    **/
    Oauth.prototype.postOauth2Token = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.postOauth2Token400ApplicationJSONOneOf = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
