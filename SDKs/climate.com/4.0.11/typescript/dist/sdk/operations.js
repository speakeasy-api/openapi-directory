...
var Operations = /** @class */ (function () {
     ...
     */
    Operations.prototype.fetchOperations = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FetchOperationsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v4/operations/all";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.FetchOperationsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.operations = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.Operations);
                    }
                    break;
