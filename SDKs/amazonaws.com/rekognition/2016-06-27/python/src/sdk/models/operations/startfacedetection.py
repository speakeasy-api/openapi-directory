...
class StartFaceDetectionRequest:
    ...
    start_face_detection_request: shared_startfacedetectionrequest.StartFaceDetectionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
