 ...
 */
export enum TargetVpnGatewayAggregatedListWarningCodeEnum {
...
export class TargetVpnGatewayAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetVpnGatewayAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetVpnGatewayAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class TargetVpnGatewayAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetVpnGatewaysScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, TargetVpnGatewaysScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], TargetVpnGatewaysScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
