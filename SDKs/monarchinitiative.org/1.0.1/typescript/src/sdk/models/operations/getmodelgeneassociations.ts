...
export class GetModelGeneAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetModelGeneAssociationsQueryParams extends SpeakeasyBase {
...
export class GetModelGeneAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetModelGeneAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
