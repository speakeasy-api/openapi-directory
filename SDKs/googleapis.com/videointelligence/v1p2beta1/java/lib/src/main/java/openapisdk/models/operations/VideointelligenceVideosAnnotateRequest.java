...
public class VideointelligenceVideosAnnotateRequest {
    ...
    public openapisdk.models.shared.GoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest request;
    public VideointelligenceVideosAnnotateRequest withRequest(openapisdk.models.shared.GoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest request) {
