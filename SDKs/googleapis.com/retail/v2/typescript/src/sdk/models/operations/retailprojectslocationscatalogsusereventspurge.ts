...
export class RetailProjectsLocationsCatalogsUserEventsPurgeSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsUserEventsPurgeRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsUserEventsPurgeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
