...
from ..shared import room_participant_published_track_enum_kind_enum as shared_room_participant_published_track_enum_kind_enum
...
class VideoV1RoomRoomParticipantRoomParticipantPublishedTrack:
    ...
    kind: Optional[shared_room_participant_published_track_enum_kind_enum.RoomParticipantPublishedTrackEnumKindEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('kind'), 'exclude': lambda f: f is None }})  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})
    r"""The track name. Must be no more than 128 characters, and be unique among the participant's published tracks."""  
    ...
    r"""The SID of the Participant resource with the published track."""  
    ...
    r"""The SID of the Room resource where the track is published."""  
    sid: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sid'), 'exclude': lambda f: f is None }})
    r"""The unique string that we created to identify the RoomParticipantPublishedTrack resource."""  
