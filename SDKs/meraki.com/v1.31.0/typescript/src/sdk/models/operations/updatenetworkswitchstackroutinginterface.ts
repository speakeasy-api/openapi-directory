 ...
 */
export class UpdateNetworkSwitchStackRoutingInterfaceRequestBodyIpv6 extends SpeakeasyBase {
  /**
...
export class UpdateNetworkSwitchStackRoutingInterfaceRequestBody extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "ipv6" })
  @Type(() => UpdateNetworkSwitchStackRoutingInterfaceRequestBodyIpv6)
  ...
  @Type(() => UpdateNetworkSwitchStackRoutingInterfaceRequestBodyOspfSettings)
...
export class UpdateNetworkSwitchStackRoutingInterfaceResponse extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  updateNetworkSwitchStackRoutingInterface200ApplicationJSONObject?: Record<
    string,
    any
  >;
}
