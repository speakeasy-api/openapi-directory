...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.listRealtimeContactAnalysisSegments = function (req, config) {
        ...
        var url = baseURL.replace(/\/$/, "") + "/realtime-contact-analysis/analysis-segments";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.listRealtimeContactAnalysisSegmentsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
