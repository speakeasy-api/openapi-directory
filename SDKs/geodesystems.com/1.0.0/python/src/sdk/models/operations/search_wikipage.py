...
class SearchWikipageQueryParams:
    ...
    search_wikipage_category: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.wikipage.category', 'style': 'form', 'explode': True }})
    search_wikipage_wikitext: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.wikipage.wikitext', 'style': 'form', 'explode': True }})
...
class SearchWikipageRequest:
    query_params: SearchWikipageQueryParams = dataclasses.field()
