...
from ..shared import vehhistorydata as shared_vehhistorydata


@dataclass_json
@dataclasses.dataclass
class HistoryResp:
    data: shared_vehhistorydata.VehHistoryData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
