...
func (e GETCreateEndpointAccessActionEnum) ToPointer() *GETCreateEndpointAccessActionEnum {
	return &e
}
...
func (e *GETCreateEndpointAccessActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "CreateEndpointAccess":
		*e = GETCreateEndpointAccessActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETCreateEndpointAccessActionEnum: %v", v)
	}
}
...
func (e GETCreateEndpointAccessVersionEnum) ToPointer() *GETCreateEndpointAccessVersionEnum {
	return &e
}
...
func (e *GETCreateEndpointAccessVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2012-12-01":
		*e = GETCreateEndpointAccessVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETCreateEndpointAccessVersionEnum: %v", v)
	}
}
