...
from ..shared import createfindingsreportresponse as shared_createfindingsreportresponse
...
class CreateFindingsReportRequestBodyReportFormatEnum(str, Enum):
    r"""The format to generate the report in."""
    CSV = 'CSV'
    JSON = 'JSON'
...
class CreateFindingsReportRequestBody:
    ...
    report_format: CreateFindingsReportRequestBodyReportFormatEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reportFormat') }})
    r"""The format to generate the report in."""  
    s3_destination: CreateFindingsReportRequestBodyS3Destination = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('s3Destination') }})
    r"""Contains details of the Amazon S3 bucket and KMS key used to export findings."""  
    filter_criteria: Optional[CreateFindingsReportRequestBodyFilterCriteria] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filterCriteria'), 'exclude': lambda f: f is None }})
    r"""Details on the criteria used to define the filter."""  
...
class CreateFindingsReportRequest:
    ...
    request_body: CreateFindingsReportRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class CreateFindingsReportResponse:
    ...
    create_findings_report_response: Optional[shared_createfindingsreportresponse.CreateFindingsReportResponse] = dataclasses.field(default=None)
    r"""Success"""  
