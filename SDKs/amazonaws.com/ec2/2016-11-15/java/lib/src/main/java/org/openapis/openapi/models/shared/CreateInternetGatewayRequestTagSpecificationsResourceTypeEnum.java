 ...
 */
public enum CreateInternetGatewayRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateInternetGatewayRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
