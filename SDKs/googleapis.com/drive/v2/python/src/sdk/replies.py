...
class Replies:
    ...
    def drive_replies_get(self, request: operations.DriveRepliesGetRequest, security: operations.DriveRepliesGetSecurity) -> operations.DriveRepliesGetResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CommentReply])
                res.comment_reply = out

        return res

    def drive_replies_insert(self, request: operations.DriveRepliesInsertRequest, security: operations.DriveRepliesInsertSecurity) -> operations.DriveRepliesInsertResponse:
        r"""Creates a new reply to the given comment."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.DriveRepliesInsertRequest, base_url, '/files/{fileId}/comments/{commentId}/replies', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "comment_reply", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.DriveRepliesInsertRequest, request)
        ...
        res = operations.DriveRepliesInsertResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def drive_replies_list(self, request: operations.DriveRepliesListRequest, security: operations.DriveRepliesListSecurity) -> operations.DriveRepliesListResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CommentReplyList])
                res.comment_reply_list = out

        return res

    def drive_replies_patch(self, request: operations.DriveRepliesPatchRequest, security: operations.DriveRepliesPatchSecurity) -> operations.DriveRepliesPatchResponse:
        r"""Updates an existing reply."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.DriveRepliesPatchRequest, base_url, '/files/{fileId}/comments/{commentId}/replies/{replyId}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "comment_reply", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.DriveRepliesPatchRequest, request)
        ...
        res = operations.DriveRepliesPatchResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
