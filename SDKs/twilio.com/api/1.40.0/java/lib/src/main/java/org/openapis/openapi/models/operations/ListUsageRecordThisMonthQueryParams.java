...
public class ListUsageRecordThisMonthQueryParams {
    ...
    public ListUsageRecordThisMonthQueryParams withCategory(org.openapis.openapi.models.shared.UsageRecordThisMonthEnumCategoryEnum category) {
    ...
    public Long page;
    public ListUsageRecordThisMonthQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListUsageRecordThisMonthQueryParams withPageToken(String pageToken) {
