...
class PostRepositoriesWorkspaceRepoSlugIssuesImportRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugIssuesImportPathParams = dataclasses.field()
    security: PostRepositoriesWorkspaceRepoSlugIssuesImportSecurity = dataclasses.field()
