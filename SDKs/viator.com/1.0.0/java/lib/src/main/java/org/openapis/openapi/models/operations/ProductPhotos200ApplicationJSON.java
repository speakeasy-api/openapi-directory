...
public class ProductPhotos200ApplicationJSON {
    ...
    @JsonProperty("data")
    public org.openapis.openapi.models.shared.PhotoObject[] data;

    public ProductPhotos200ApplicationJSON withData(org.openapis.openapi.models.shared.PhotoObject[] data) {
        this.data = data;
        return this;
    }
    ...
    public ProductPhotos200ApplicationJSON(){}
}
