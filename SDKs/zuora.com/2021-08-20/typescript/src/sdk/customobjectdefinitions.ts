...
export class CustomObjectDefinitions {
  ...
  deleteCustomObjectDefinitionByType(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DeleteCustomObjectDefinitionByTypeResponse =
        new operations.DeleteCustomObjectDefinitionByTypeResponse({
  ...
  getAllCustomObjectDefinitionsInNamespace(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/objects/definitions/default";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETAllCustomObjectDefinitionsInNamespaceResponse =
        new operations.GETAllCustomObjectDefinitionsInNamespaceResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
        ...
        case httpRes?.status == 200:
          if (
            ...
            res.getAllCustomObjectDefinitionsInNamespaceResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GETAllCustomObjectDefinitionsInNamespaceResponse
              );
          }
          break;
      }
  ...
  getCustomObjectDefinitionByType(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETCustomObjectDefinitionByTypeResponse =
        new operations.GETCustomObjectDefinitionByTypeResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.customObjectDefinition = utils.objectToClass(
              httpRes?.data,
              shared.CustomObjectDefinition
            );
          }
          break;
  ...
  postCustomObjectDefinitions(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTCustomObjectDefinitionsResponse =
        new operations.POSTCustomObjectDefinitionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  postUpdateCustomObjectDefinition(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTUpdateCustomObjectDefinitionResponse =
        new operations.POSTUpdateCustomObjectDefinitionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
        ...
        case httpRes?.status == 200:
          if (
            ...
            res.migrationUpdateCustomObjectDefinitionsResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.MigrationUpdateCustomObjectDefinitionsResponse
              );
          }
          break;
      }
