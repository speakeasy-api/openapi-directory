...
type SearchGadgetsCountdownQueryParams struct {
...
type SearchGadgetsCountdownRequest struct {
	QueryParams SearchGadgetsCountdownQueryParams
}

type SearchGadgetsCountdownResponse struct {
	ContentType string
	StatusCode  int
