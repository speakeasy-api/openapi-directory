...
public class GetPublicationVariantAssociationsRequest {
    ...
    public GetPublicationVariantAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPublicationVariantAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPublicationVariantAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPublicationVariantAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPublicationVariantAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPublicationVariantAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPublicationVariantAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPublicationVariantAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPublicationVariantAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPublicationVariantAssociationsRequest withRelation(String relation) {
    ...
    public GetPublicationVariantAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPublicationVariantAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPublicationVariantAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPublicationVariantAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPublicationVariantAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPublicationVariantAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPublicationVariantAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPublicationVariantAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
