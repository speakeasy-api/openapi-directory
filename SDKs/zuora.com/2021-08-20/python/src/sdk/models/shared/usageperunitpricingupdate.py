...
class UsagePerUnitPricingUpdate:
    ...
    price_change_option: Optional[UsagePerUnitPricingUpdatePriceChangeOptionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('priceChangeOption'), 'exclude': lambda f: f is None }})
    r"""Specifies how Zuora changes the price of the charge each time the subscription renews.
