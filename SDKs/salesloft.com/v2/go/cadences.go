...
func newCadences(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *cadences {
	return &cadences{
...
func (s *cadences) GetV2CadencesJSON(ctx context.Context, request operations.GetV2CadencesJSONRequest) (*operations.GetV2CadencesJSONResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/cadences.json"
	...
	res := &operations.GetV2CadencesJSONResponse{
...
func (s *cadences) GetV2CadencesIDJSON(ctx context.Context, request operations.GetV2CadencesIDJSONRequest) (*operations.GetV2CadencesIDJSONResponse, error) {
	...
	res := &operations.GetV2CadencesIDJSONResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
