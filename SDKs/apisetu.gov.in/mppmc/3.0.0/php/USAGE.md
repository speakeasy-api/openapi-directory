...
use \OpenAPI\OpenAPI\Models\Operations\SocerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\SocerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\SocerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\SocerSecurity;
...
try {
    ...
    $request->certificateParameters = new SocerRequestBodyCertificateParameters();
    $request->certificateParameters->appno = 'REG1307241';
    $request->certificateParameters->dateOfBirth = '11-11-1990';
    $request->certificateParameters->enrolno = '41C172C17OCT1203';
    $request->certificateParameters->typOfCert = 'Registration Certificate&#x28;PREGC&#x29;,Duplicate Registration Certificate&#x28;PDURC&#x29;,Good S';
    ...
    $request->format = SocerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new SocerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->socer($request, $requestSecurity);
