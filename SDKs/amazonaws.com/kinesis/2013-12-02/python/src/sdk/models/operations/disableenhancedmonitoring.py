...
class DisableEnhancedMonitoringRequest:
    headers: DisableEnhancedMonitoringHeaders = dataclasses.field()
    request: shared_disableenhancedmonitoringinput.DisableEnhancedMonitoringInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
