...
class CreateQuantumTaskRequestBody:
    ...
    output_s3_key_prefix: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('outputS3KeyPrefix') }})
    shots: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('shots') }})
    device_parameters: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('deviceParameters') }})
    tags: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tags') }})
    

@dataclasses.dataclass
class CreateQuantumTaskRequest:
    headers: CreateQuantumTaskHeaders = dataclasses.field()
    request: CreateQuantumTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
