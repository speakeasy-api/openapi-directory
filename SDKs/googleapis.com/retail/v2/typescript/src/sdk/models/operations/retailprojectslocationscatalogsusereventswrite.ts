...
export class RetailProjectsLocationsCatalogsUserEventsWriteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsUserEventsWriteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=writeAsync",
  })
  writeAsync?: boolean;
}

export class RetailProjectsLocationsCatalogsUserEventsWriteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  googleCloudRetailV2UserEvent?: shared.GoogleCloudRetailV2UserEvent;
