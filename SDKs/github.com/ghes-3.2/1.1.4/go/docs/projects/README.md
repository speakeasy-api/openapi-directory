...
func main() {
    ...
    res, err := s.Projects.ProjectsListCollaborators(ctx, operations.ProjectsListCollaboratorsRequest{
        ...
        Page: sdk.Int64(975425),
        PerPage: sdk.Int64(156383),
        ProjectID: 782090,
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Projects.ProjectsListColumns(ctx, operations.ProjectsListColumnsRequest{
        Page: sdk.Int64(304198),
        PerPage: sdk.Int64(247045),
        ProjectID: 75359,
    })
    if err != nil {
        log.Fatal(err)
