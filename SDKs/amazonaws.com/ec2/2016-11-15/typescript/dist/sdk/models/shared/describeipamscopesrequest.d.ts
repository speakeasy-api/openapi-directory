 ...
 */
export declare class DescribeIpamScopesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeIpamScopesRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeIpamScopesRequestFilters[];
    ipamScopeIds?: string[];
    maxResults?: number;
    nextToken?: string;
}
