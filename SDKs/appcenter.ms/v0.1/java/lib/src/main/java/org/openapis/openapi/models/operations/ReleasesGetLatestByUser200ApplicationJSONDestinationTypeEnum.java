 ...
 * 
 */
public enum ReleasesGetLatestByUser200ApplicationJSONDestinationTypeEnum {
    GROUP("group"),
    STORE("store"),
    TESTER("tester");
    ...
    private ReleasesGetLatestByUser200ApplicationJSONDestinationTypeEnum(String value) {
        this.value = value;
    }
}
