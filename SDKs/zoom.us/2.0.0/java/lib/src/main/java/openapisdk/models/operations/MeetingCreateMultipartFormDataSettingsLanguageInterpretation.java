...
**/
public class MeetingCreateMultipartFormDataSettingsLanguageInterpretation {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("enable")
    public Boolean enable;
    public MeetingCreateMultipartFormDataSettingsLanguageInterpretation withEnable(Boolean enable) {
        this.enable = enable;
        return this;
    }
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("interpreters")
    public MeetingCreateMultipartFormDataSettingsLanguageInterpretationInterpreters[] interpreters;
    public MeetingCreateMultipartFormDataSettingsLanguageInterpretation withInterpreters(MeetingCreateMultipartFormDataSettingsLanguageInterpretationInterpreters[] interpreters) {
