...
func (e AuthenticationTokenRepositorySelectionEnum) ToPointer() *AuthenticationTokenRepositorySelectionEnum {
	return &e
}
...
func (e *AuthenticationTokenRepositorySelectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "all":
		fallthrough
	case "selected":
		*e = AuthenticationTokenRepositorySelectionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AuthenticationTokenRepositorySelectionEnum: %v", v)
	}
}
