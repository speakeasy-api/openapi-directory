...
public class StartSigningBasketAuthorisationRequest {
    ...
    public StartSigningBasketAuthorisationRequest withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public StartSigningBasketAuthorisationRequest withPSUAccept(String psuAccept) {
    ...
    public StartSigningBasketAuthorisationRequest withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public StartSigningBasketAuthorisationRequest withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public StartSigningBasketAuthorisationRequest withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public StartSigningBasketAuthorisationRequest withPSUCorporateID(String psuCorporateID) {
    ...
    public StartSigningBasketAuthorisationRequest withPSUCorporateIDType(String psuCorporateIDType) {
    ...
    public StartSigningBasketAuthorisationRequest withPSUDeviceID(String psuDeviceID) {
    ...
    public StartSigningBasketAuthorisationRequest withPSUGeoLocation(String psuGeoLocation) {
    ...
    public StartSigningBasketAuthorisationRequest withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public StartSigningBasketAuthorisationRequest withPsuId(String psuId) {
        this.psuId = psuId;
        return this;
    }
    ...
    public StartSigningBasketAuthorisationRequest withPSUIDType(String psuIDType) {
    ...
    public StartSigningBasketAuthorisationRequest withPSUIPAddress(String psuIPAddress) {
    ...
    public StartSigningBasketAuthorisationRequest withPSUIPPort(String psuIPPort) {
    ...
    public StartSigningBasketAuthorisationRequest withPSUUserAgent(String psuUserAgent) {
    ...
    public StartSigningBasketAuthorisationRequest withRequestBody(Object requestBody) {
    ...
    public StartSigningBasketAuthorisationRequest withSignature(String signature) {
    ...
    public StartSigningBasketAuthorisationRequest withTPPNokRedirectURI(String tppNokRedirectURI) {
    ...
    public StartSigningBasketAuthorisationRequest withTPPNotificationContentPreferred(String tppNotificationContentPreferred) {
    ...
    public StartSigningBasketAuthorisationRequest withTPPNotificationURI(String tppNotificationURI) {
    ...
    public StartSigningBasketAuthorisationRequest withTPPRedirectPreferred(Boolean tppRedirectPreferred) {
    ...
    public StartSigningBasketAuthorisationRequest withTPPRedirectURI(String tppRedirectURI) {
    ...
    public StartSigningBasketAuthorisationRequest withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public StartSigningBasketAuthorisationRequest withXRequestID(String xRequestID) {
    ...
    public StartSigningBasketAuthorisationRequest withBasketId(String basketId) {
        this.basketId = basketId;
        return this;
    }
    
    public StartSigningBasketAuthorisationRequest(@JsonProperty("X-Request-ID") String xRequestID, @JsonProperty("basketId") String basketId) {
        this.xRequestID = xRequestID;
        this.basketId = basketId;
  }
}
