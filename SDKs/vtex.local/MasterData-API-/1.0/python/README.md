...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/vtex.local/MasterData-API-/1.0/python
```
...
* `validate_documentby_clusters` - Validate Document by Clusters
