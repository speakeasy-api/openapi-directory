...
export class TypeTypePointIcebridgeAtmIcessn {
  ...
  **/
  searchTypePointIcebridgeAtmIcessn(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.SearchTypePointIcebridgeAtmIcessnResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
