 ...
 */
public class WorkflowInvocationInput {
    /**
    ...
    public WorkflowInvocationInput withCompilationResult(String compilationResult) {
    ...
    public WorkflowInvocationInput withInvocationConfig(InvocationConfig invocationConfig) {
    ...
    public WorkflowInvocationInput withInvocationTiming(Interval invocationTiming) {
    ...
    public WorkflowInvocationInput withWorkflowConfig(String workflowConfig) {
        this.workflowConfig = workflowConfig;
        return this;
    }
    
    public WorkflowInvocationInput(){}
}
