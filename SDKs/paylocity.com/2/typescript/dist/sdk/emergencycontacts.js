...
var EmergencyContacts = /** @class */ (function () {
    function EmergencyContacts(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    EmergencyContacts.prototype.addOrUpdateEmergencyContacts = function (req, config) {
        var _a;
