...
export class TagmanagerAccountsContainersDestinationsLinkSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class TagmanagerAccountsContainersDestinationsLinkRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class TagmanagerAccountsContainersDestinationsLinkResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
