...
type SearchJobsQueryParams struct {
	// Pagination limit
...
type SearchJobsRequest struct {
	QueryParams SearchJobsQueryParams
	Headers     SearchJobsHeaders
	Request     SearchJobsRequestBody `request:"mediaType=application/json"`
}
