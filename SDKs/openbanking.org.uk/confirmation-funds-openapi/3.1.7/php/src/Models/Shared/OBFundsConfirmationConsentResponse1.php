...
class OBFundsConfirmationConsentResponse1
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBFundsConfirmationConsentResponse1Data')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\OBFundsConfirmationConsentResponse1Data();
		$this->links = null;
		$this->meta = null;
	}
}
