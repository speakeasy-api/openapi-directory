...
type GetRequestedServiceQuotaChangeResponseRequestedQuota struct {
...
type GetRequestedServiceQuotaChangeResponse struct {
	RequestedQuota *GetRequestedServiceQuotaChangeResponseRequestedQuota `json:"RequestedQuota,omitempty"`
}
