...
public class GetNhFossilsAllFossilHeaders {
    /**
    ...
    public GetNhFossilsAllFossilHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhFossilsAllFossilHeaders withXApiKey(String xApiKey) {
