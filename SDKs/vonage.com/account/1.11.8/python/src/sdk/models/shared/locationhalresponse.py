...
from ..shared import locationembeddedobject as shared_locationembeddedobject
...
class LocationHalResponse:
    embedded: Optional[shared_locationembeddedobject.LocationEmbeddedObject] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_embedded') }})
