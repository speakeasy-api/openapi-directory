...
export class CreditNotesOneSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreditNotesOneRequest extends SpeakeasyBase {
  /**
...
export class CreditNotesOneResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
