...
type GETRollbackInstanceRefreshQueryParams struct {
...
type GETRollbackInstanceRefreshHeaders struct {
...
type GETRollbackInstanceRefreshRequest struct {
	QueryParams GETRollbackInstanceRefreshQueryParams
	Headers     GETRollbackInstanceRefreshHeaders
}
