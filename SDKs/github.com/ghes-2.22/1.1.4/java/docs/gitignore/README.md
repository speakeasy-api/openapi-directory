...
<https://docs.github.com/enterprise-server@2.22/rest/reference/gitignore#get-all-gitignore-templates>
...
API method documentation
<https://docs.github.com/enterprise-server@2.22/rest/reference/gitignore#get-a-gitignore-template>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitignoreGetTemplateRequest req = new GitignoreGetTemplateRequest("aperiam");            
