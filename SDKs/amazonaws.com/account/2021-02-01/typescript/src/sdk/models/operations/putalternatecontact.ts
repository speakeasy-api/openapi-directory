 ...
 */
export enum PutAlternateContactRequestBodyAlternateContactTypeEnum {
  Billing = "BILLING",
  Operations = "OPERATIONS",
  Security = "SECURITY",
}

export class PutAlternateContactRequestBody extends SpeakeasyBase {
  /**
...
export class PutAlternateContactRequest extends SpeakeasyBase {
...
export class PutAlternateContactResponse extends SpeakeasyBase {
  /**
