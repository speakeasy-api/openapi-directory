...
func (s *DataFlow) PostV05HealthInformationNotify(ctx context.Context, request operations.PostV05HealthInformationNotifyRequest) (*operations.PostV05HealthInformationNotifyResponse, error) {
	...
	res := &operations.PostV05HealthInformationNotifyResponse{
...
func (s *DataFlow) PostV05HealthInformationOnRequest(ctx context.Context, request operations.PostV05HealthInformationOnRequestRequest) (*operations.PostV05HealthInformationOnRequestResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05HealthInformationOnRequestResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *DataFlow) PostV05HealthInformationRequest(ctx context.Context, request operations.PostV05HealthInformationRequestRequest) (*operations.PostV05HealthInformationRequestResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05HealthInformationRequestResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
