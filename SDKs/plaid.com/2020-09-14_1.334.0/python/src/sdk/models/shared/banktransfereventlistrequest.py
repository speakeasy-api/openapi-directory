...
from ..shared import banktransfereventlistbanktransfertype_enum as shared_banktransfereventlistbanktransfertype_enum
from ..shared import banktransfereventlistdirection_enum as shared_banktransfereventlistdirection_enum
...
class BankTransferEventListRequest:
    ...
    bank_transfer_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bank_transfer_id'), 'exclude': lambda f: f is None }})
    r"""Plaid’s unique identifier for a bank transfer."""  
    bank_transfer_type: Optional[shared_banktransfereventlistbanktransfertype_enum.BankTransferEventListBankTransferTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bank_transfer_type'), 'exclude': lambda f: f is None }})
    ...
    direction: Optional[shared_banktransfereventlistdirection_enum.BankTransferEventListDirectionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('direction'), 'exclude': lambda f: f is None }})
    ...
    event_types: Optional[list[shared_banktransfereventtype_enum.BankTransferEventTypeEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('event_types'), 'exclude': lambda f: f is None }})
