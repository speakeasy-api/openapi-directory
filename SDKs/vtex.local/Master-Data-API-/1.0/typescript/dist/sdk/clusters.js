...
var Clusters = /** @class */ (function () {
    function Clusters(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    Clusters.prototype.validatedocumentbyclusters = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ValidatedocumentbyclustersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/dataentities/{dataEntityName}/documents/{id}/clusters", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.ValidatedocumentbyclustersResponse({
