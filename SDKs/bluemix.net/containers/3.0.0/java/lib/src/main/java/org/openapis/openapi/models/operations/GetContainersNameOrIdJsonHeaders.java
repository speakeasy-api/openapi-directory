...
public class GetContainersNameOrIdJsonHeaders {
    /**
    ...
    public GetContainersNameOrIdJsonHeaders withXAuthProjectId(String xAuthProjectId) {
    ...
    public GetContainersNameOrIdJsonHeaders withXAuthToken(String xAuthToken) {
