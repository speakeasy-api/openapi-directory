...
exports.ContactsFetchAllResponse = exports.ContactsFetchAllRequest = exports.ContactsFetchAllSecurity = void 0;
...
var ContactsFetchAllRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ContactsFetchAllRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=email" }),
        __metadata("design:type", String)
    ], ContactsFetchAllRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=firstName",
        }),
        __metadata("design:type", String)
    ], ContactsFetchAllRequest.prototype, "firstName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=lastName",
        }),
        __metadata("design:type", String)
    ], ContactsFetchAllRequest.prototype, "lastName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], ContactsFetchAllRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=mobile",
        }),
        __metadata("design:type", String)
    ], ContactsFetchAllRequest.prototype, "mobile", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], ContactsFetchAllRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=tags" }),
        __metadata("design:type", String)
    ], ContactsFetchAllRequest.prototype, "tags", void 0);
...
var ContactsFetchAllResponse = /** @class */ (function (_super) {
    ...
    ], ContactsFetchAllResponse.prototype, "rawResponse", void 0);
