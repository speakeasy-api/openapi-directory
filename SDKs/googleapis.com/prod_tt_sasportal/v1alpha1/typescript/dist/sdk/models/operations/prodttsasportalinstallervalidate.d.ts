...
export declare class ProdTtSasportalInstallerValidateSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalInstallerValidateSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalInstallerValidateSecurity extends SpeakeasyBase {
    option1?: ProdTtSasportalInstallerValidateSecurityOption1;
    option2?: ProdTtSasportalInstallerValidateSecurityOption2;
}
