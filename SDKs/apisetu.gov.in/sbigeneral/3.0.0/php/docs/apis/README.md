...
use \OpenAPI\OpenAPI\Models\Operations\CripcRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\CripcRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\CripcRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\CripcSecurity;
...
try {
    ...
    $request->certificateParameters = new CripcRequestBodyCertificateParameters();
    $request->certificateParameters->udf1 = '0000001234567890-001';
    $request->certificateParameters->udf2 = 'For Motor- Enter Last 5 Digits of Engine/Chasis No. Or Full RegNo - For Others- Enter Mobile No.';
    ...
    $request->format = CripcRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new CripcSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->cripc($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\CvipcRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\CvipcRequestBodyCertificateParameters;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchema;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsent;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentData;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentDataConsumer;
...
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentUser;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaSignature;
use \OpenAPI\OpenAPI\Models\Operations\CvipcRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\CvipcSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CvipcRequestBody();
    $request->certificateParameters = new CvipcRequestBodyCertificateParameters();
    $request->certificateParameters->udf1 = '0000001234567890-001';
    $request->certificateParameters->udf2 = 'For Motor- Enter Last 5 Digits of Engine/Chasis No. Or Full RegNo - For Others- Enter Mobile No.';
    $request->consentArtifact = new ConsentArtifactSchema();
    $request->consentArtifact->consent = new ConsentArtifactSchemaConsent();
    ...
    $request->format = CvipcRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new CvipcSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->cvipc($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\HlipcRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\HlipcRequestBodyCertificateParameters;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchema;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsent;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentData;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentDataConsumer;
...
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentUser;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaSignature;
use \OpenAPI\OpenAPI\Models\Operations\HlipcRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\HlipcSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new HlipcRequestBody();
    $request->certificateParameters = new HlipcRequestBodyCertificateParameters();
    $request->certificateParameters->udf1 = '0000001234567890-001';
    $request->certificateParameters->udf2 = 'For Motor- Enter Last 5 Digits of Engine/Chasis No. Or Full RegNo - For Others- Enter Mobile No.';
    $request->consentArtifact = new ConsentArtifactSchema();
    $request->consentArtifact->consent = new ConsentArtifactSchemaConsent();
    ...
    $request->format = HlipcRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new HlipcSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->hlipc($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\TripcRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\TripcRequestBodyCertificateParameters;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchema;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsent;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentData;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentDataConsumer;
...
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentUser;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaSignature;
use \OpenAPI\OpenAPI\Models\Operations\TripcRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\TripcSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new TripcRequestBody();
    $request->certificateParameters = new TripcRequestBodyCertificateParameters();
    $request->certificateParameters->udf1 = '0000001234567890-001';
    $request->certificateParameters->udf2 = 'For Motor- Enter Last 5 Digits of Engine/Chasis No. Or Full RegNo - For Others- Enter Mobile No.';
    $request->consentArtifact = new ConsentArtifactSchema();
    $request->consentArtifact->consent = new ConsentArtifactSchemaConsent();
    ...
    $request->format = TripcRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new TripcSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->tripc($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\TwipcRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\TwipcRequestBodyCertificateParameters;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchema;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsent;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentData;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentDataConsumer;
...
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentUser;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaSignature;
use \OpenAPI\OpenAPI\Models\Operations\TwipcRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\TwipcSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new TwipcRequestBody();
    $request->certificateParameters = new TwipcRequestBodyCertificateParameters();
    $request->certificateParameters->udf1 = '0000001234567890-001';
    $request->certificateParameters->udf2 = 'For Motor- Enter Last 5 Digits of Engine/Chasis No. Or Full RegNo - For Others- Enter Mobile No.';
    $request->consentArtifact = new ConsentArtifactSchema();
    $request->consentArtifact->consent = new ConsentArtifactSchemaConsent();
    ...
    $request->format = TwipcRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new TwipcSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->twipc($request, $requestSecurity);
