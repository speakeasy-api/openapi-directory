...
class Verification 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Shared\PerformVerificationRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\PostCheckAccountHolderSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\PostCheckAccountHolderResponse
     */
	public function postCheckAccountHolder(
        \OpenAPI\OpenAPI\Models\Shared\PerformVerificationRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\PostCheckAccountHolderSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\PostCheckAccountHolderResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/checkAccountHolder');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PostCheckAccountHolderResponse();
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Shared\DeletePayoutMethodRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\PostDeletePayoutMethodsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\PostDeletePayoutMethodsResponse
     */
	public function postDeletePayoutMethods(
        \OpenAPI\OpenAPI\Models\Shared\DeletePayoutMethodRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\PostDeletePayoutMethodsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\PostDeletePayoutMethodsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/deletePayoutMethods');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PostDeletePayoutMethodsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
