...
class ConnectivityTestInput:
    ...
    probing_details: Optional[shared_probingdetails.ProbingDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('probingDetails') }})
