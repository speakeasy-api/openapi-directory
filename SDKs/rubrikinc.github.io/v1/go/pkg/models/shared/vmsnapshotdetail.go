...
type VMSnapshotDetail struct {
	...
	SnapshotDiskDetails []VMSnapshotDiskDetail `json:"snapshotDiskDetails"`
	// This field is deprecated, use snapshotDiskDetails instead.
	SnapshotDiskIds       []string                `json:"snapshotDiskIds,omitempty"`
	...
	VNicsInfo             []VmwareVNicBindingInfo `json:"vNicsInfo,omitempty"`
	VirtualMachine        *VirtualMachineSummary  `json:"virtualMachine,omitempty"`
	VMName                string                  `json:"vmName"`
	// List of vSphere tags assigned to the virtual machine.
	VmwareTagList  []string `json:"vmwareTagList,omitempty"`
	VmxFileContent *string  `json:"vmxFileContent,omitempty"`
}
