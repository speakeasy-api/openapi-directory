...
func (e *GetNetworkSensorAlertsCurrentOverviewByMetric200ApplicationJSONSupportedMetricsEnum) UnmarshalJSON(data []byte) error {
	...
	case "tvoc":
		fallthrough
	case "water":
		*e = GetNetworkSensorAlertsCurrentOverviewByMetric200ApplicationJSONSupportedMetricsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkSensorAlertsCurrentOverviewByMetric200ApplicationJSONSupportedMetricsEnum: %s", s)
	}
}
