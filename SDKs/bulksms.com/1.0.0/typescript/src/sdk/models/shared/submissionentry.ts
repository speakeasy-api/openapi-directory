...
export class SubmissionEntry extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "longMessageMaxParts" })
   ...
   *
   */
  @SpeakeasyMetadata({ elemType: SubmissionEntryTo })
  @Expose({ name: "to" })
  @Type(() => SubmissionEntryTo)
