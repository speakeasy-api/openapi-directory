...
class UploadVideoRequestBodyEmbedLogos:
    ...
    custom: Optional[UploadVideoRequestBodyEmbedLogosCustom] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('custom'), 'exclude': lambda f: f is None }})  
...
class UploadVideoRequestBodyEmbedTitle:
    ...
    name: Optional[UploadVideoRequestBodyEmbedTitleNameEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})
    r"""Show or hide the video title, or enable the user to determine whether the video title appears."""  
    owner: Optional[UploadVideoRequestBodyEmbedTitleOwnerEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('owner'), 'exclude': lambda f: f is None }})
    r"""Show or hide the owner information, or enable the user to determine whether the owner information appears."""  
    portrait: Optional[UploadVideoRequestBodyEmbedTitlePortraitEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('portrait'), 'exclude': lambda f: f is None }})
    r"""Show or hide the owner portrait, or enable the user to determine whether the owner portrait appears."""  
...
class UploadVideoRequestBodyEmbed:
    ...
    buttons: Optional[UploadVideoRequestBodyEmbedButtons] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('buttons'), 'exclude': lambda f: f is None }})  
    ...
    logos: Optional[UploadVideoRequestBodyEmbedLogos] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logos'), 'exclude': lambda f: f is None }})  
    ...
    title: Optional[UploadVideoRequestBodyEmbedTitle] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('title'), 'exclude': lambda f: f is None }})  
...
class UploadVideoRequestBodyPrivacy:
    ...
    comments: Optional[UploadVideoRequestBodyPrivacyCommentsEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('comments'), 'exclude': lambda f: f is None }})
    r"""The privacy level required to comment on the video."""  
    ...
    embed: Optional[UploadVideoRequestBodyPrivacyEmbedEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('embed'), 'exclude': lambda f: f is None }})
    r"""The video's embed settings. The `whitelist` value enables you to define all valid embed domains. See our [documentation](https://developer.vimeo.com/api/endpoints/videos#/{video_id}/privacy/domains) for details on adding and removing domains."""  
    view: Optional[UploadVideoRequestBodyPrivacyViewEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('view'), 'exclude': lambda f: f is None }})
    r"""The video's privacy setting. When privacy is `users`, `application/json` is the only valid content type. Basic users can't set privacy to `unlisted`."""  
...
class UploadVideoRequestBodyRatingsMpaa:
    ...
    reason: Optional[UploadVideoRequestBodyRatingsMpaaReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is None }})
    r"""The reason for the video's MPAA rating.
...
class UploadVideoRequestBodyRatingsTv:
    ...
    reason: Optional[UploadVideoRequestBodyRatingsTvReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is None }})
    r"""The reason for the video's TV rating.
...
class UploadVideoRequestBodyRatings:
    ...
    mpaa: Optional[UploadVideoRequestBodyRatingsMpaa] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mpaa'), 'exclude': lambda f: f is None }})  
    tv: Optional[UploadVideoRequestBodyRatingsTv] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tv'), 'exclude': lambda f: f is None }})  
...
class UploadVideoRequestBodySpatial:
    ...
    director_timeline: Optional[list[UploadVideoRequestBodySpatialDirectorTimeline]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('director_timeline'), 'exclude': lambda f: f is None }})
    ...
    projection: Optional[UploadVideoRequestBodySpatialProjectionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('projection'), 'exclude': lambda f: f is None }})
    r"""The 360 spatial projection."""  
    stereo_format: Optional[UploadVideoRequestBodySpatialStereoFormatEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('stereo_format'), 'exclude': lambda f: f is None }})
    r"""The 360 spatial stereo format."""  
...
class UploadVideoRequestBodyUpload:
    ...
    approach: UploadVideoRequestBodyUploadApproachEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('approach') }})
    r"""The upload approach."""  
    link: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('link'), 'exclude': lambda f: f is None }})
...
class UploadVideoRequestBody:
    ...
    upload: UploadVideoRequestBodyUpload = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('upload') }})  
    ...
    embed: Optional[UploadVideoRequestBodyEmbed] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('embed'), 'exclude': lambda f: f is None }})  
    license: Optional[UploadVideoRequestBodyLicenseEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('license'), 'exclude': lambda f: f is None }})
    r"""The Creative Commons license."""  
    ...
    privacy: Optional[UploadVideoRequestBodyPrivacy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('privacy'), 'exclude': lambda f: f is None }})  
    ratings: Optional[UploadVideoRequestBodyRatings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ratings'), 'exclude': lambda f: f is None }})  
    review_page: Optional[UploadVideoRequestBodyReviewPage] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('review_page'), 'exclude': lambda f: f is None }})  
    spatial: Optional[UploadVideoRequestBodySpatial] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('spatial'), 'exclude': lambda f: f is None }})  
    

@dataclasses.dataclass
class UploadVideoRequest:
    
    request_body: UploadVideoRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/vnd.vimeo.video+json' }})  
