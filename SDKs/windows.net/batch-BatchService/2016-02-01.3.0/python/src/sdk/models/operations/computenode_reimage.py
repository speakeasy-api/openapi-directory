...
class ComputeNodeReimageRequest:
    headers: ComputeNodeReimageHeaders = dataclasses.field()
    path_params: ComputeNodeReimagePathParams = dataclasses.field()
    query_params: ComputeNodeReimageQueryParams = dataclasses.field()
