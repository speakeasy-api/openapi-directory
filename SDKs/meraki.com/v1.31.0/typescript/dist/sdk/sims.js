...
var Sims = /** @class */ (function () {
    function Sims(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return the SIM and APN configurations for a cellular device.
     */
    Sims.prototype.getDeviceCellularSims = function (req, config) {
     ...
     * Updates the SIM and APN configurations for a cellular device.
     */
    Sims.prototype.updateDeviceCellularSims = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
