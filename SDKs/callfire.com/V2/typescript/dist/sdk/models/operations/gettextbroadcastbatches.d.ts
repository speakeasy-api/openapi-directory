...
export declare class GetTextBroadcastBatchesSecurity extends SpeakeasyBase {
    password: string;
    username: string;
}
export declare class GetTextBroadcastBatchesRequest extends SpeakeasyBase {
    /**
...
export declare class GetTextBroadcastBatchesResponse extends SpeakeasyBase {
    /**
