...
export declare class RadioDNS {
     ...
     *
     */
    getRadiodnsSpi31GIXml(config?: AxiosRequestConfig): Promise<operations.GetRadiodnsSpi31GIXmlResponse>;
    /**
     ...
     *
     */
    getRadiodnsSpi31SIXml(serverURL?: string, config?: AxiosRequestConfig): Promise<operations.GetRadiodnsSpi31SIXmlResponse>;
    /**
     ...
     *
     */
    getRadiodnsSpi31IdFqdnSidDatePIXml(req: operations.GetRadiodnsSpi31IdFqdnSidDatePIXmlRequest, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.GetRadiodnsSpi31IdFqdnSidDatePIXmlResponse>;
}
