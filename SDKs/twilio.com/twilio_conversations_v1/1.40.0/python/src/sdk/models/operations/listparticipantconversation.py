...
class ListParticipantConversationListParticipantConversationResponse:
    ...
    conversations: Optional[list[shared_conversations_v1_participant_conversation.ConversationsV1ParticipantConversation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conversations'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListParticipantConversationListParticipantConversationResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
