...
class GETDocumentProperiesDocumentTypeEnum(str, Enum):
...
class GETDocumentProperiesRequest:
    ...
    r"""The unique ID of document properties to be retrieved. For example, 402892c74c9193cd014c96bbe7c101f9."""  
    document_type: GETDocumentProperiesDocumentTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'documentType', 'style': 'simple', 'explode': False }})
    r"""The type of the billing document."""  
