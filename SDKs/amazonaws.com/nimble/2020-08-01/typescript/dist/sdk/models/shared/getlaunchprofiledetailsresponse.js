...
var GetLaunchProfileDetailsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "launchProfile" }),
        (0, class_transformer_1.Type)(function () { return launchprofile_1.LaunchProfile; }),
        __metadata("design:type", launchprofile_1.LaunchProfile)
    ], GetLaunchProfileDetailsResponse.prototype, "launchProfile", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: streamingimage_1.StreamingImage }),
        (0, class_transformer_1.Expose)({ name: "streamingImages" }),
        (0, class_transformer_1.Type)(function () { return streamingimage_1.StreamingImage; }),
        __metadata("design:type", Array)
    ], GetLaunchProfileDetailsResponse.prototype, "streamingImages", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: studiocomponentsummary_1.StudioComponentSummary }),
        (0, class_transformer_1.Expose)({ name: "studioComponentSummaries" }),
        (0, class_transformer_1.Type)(function () { return studiocomponentsummary_1.StudioComponentSummary; }),
        __metadata("design:type", Array)
