...
class GooglePlayDeveloperReportingV1alpha1Anomaly:
    ...
    metric: Optional[shared_googleplaydeveloperreportingv1alpha1metricvalue.GooglePlayDeveloperReportingV1alpha1MetricValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metric'), 'exclude': lambda f: f is None }})
    ...
    timeline_spec: Optional[shared_googleplaydeveloperreportingv1alpha1timelinespec.GooglePlayDeveloperReportingV1alpha1TimelineSpec] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('timelineSpec'), 'exclude': lambda f: f is None }})
