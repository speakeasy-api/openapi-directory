...
public class GroupsGetDatapointsQueryParams {
    /**
    ...
    public GroupsGetDatapointsQueryParams withCreatedAfter(String createdAfter) {
    ...
    public GroupsGetDatapointsQueryParams withCreatedBefore(String createdBefore) {
    ...
    public GroupsGetDatapointsQueryParams withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GroupsGetDatapointsQueryParams withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public GroupsGetDatapointsQueryParams withOnlyFavorites(Boolean onlyFavorites) {
    ...
    public GroupsGetDatapointsQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GroupsGetDatapointsQueryParams withSortDirection(GroupsGetDatapointsSortDirectionEnum sortDirection) {
    ...
    public GroupsGetDatapointsQueryParams withStatus(GroupsGetDatapointsStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public String tags;
    public GroupsGetDatapointsQueryParams withTags(String tags) {
        this.tags = tags;
        return this;
    }
    ...
    public GroupsGetDatapointsQueryParams withTextSearch(String textSearch) {
    ...
    public GroupsGetDatapointsQueryParams withType(GroupsGetDatapointsTypeEnum type) {
        this.type = type;
        return this;
    }
