...
class FileProjectsLocationsInstancesSnapshotsPatchSecurity:
...
@dataclasses.dataclass
class FileProjectsLocationsInstancesSnapshotsPatchRequest:
    ...
    snapshot_input: Optional[shared_snapshot.SnapshotInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class FileProjectsLocationsInstancesSnapshotsPatchResponse:
