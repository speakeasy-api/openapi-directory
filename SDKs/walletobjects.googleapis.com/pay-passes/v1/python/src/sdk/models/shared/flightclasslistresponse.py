...
class FlightClassListResponse:
    ...
    resources: Optional[list[shared_flightclass.FlightClass]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('resources') }})
