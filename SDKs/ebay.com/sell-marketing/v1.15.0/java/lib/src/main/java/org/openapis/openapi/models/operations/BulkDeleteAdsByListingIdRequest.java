...
public class BulkDeleteAdsByListingIdRequest {
    ...
    public BulkDeleteAdsByListingIdRequest(@JsonProperty("BulkDeleteAdRequest") org.openapis.openapi.models.shared.BulkDeleteAdRequest bulkDeleteAdRequest, @JsonProperty("campaign_id") String campaignId) {
        this.bulkDeleteAdRequest = bulkDeleteAdRequest;
        this.campaignId = campaignId;
  }
}
