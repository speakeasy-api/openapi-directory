...
public class CreateInternationalStandingOrderConsentsRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateInternationalStandingOrderConsentsRawHeaders withAuthorization(String authorization) {
    ...
    public CreateInternationalStandingOrderConsentsRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateInternationalStandingOrderConsentsRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateInternationalStandingOrderConsentsRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateInternationalStandingOrderConsentsRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateInternationalStandingOrderConsentsRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateInternationalStandingOrderConsentsRawHeaders withXJwsSignature(String xJwsSignature) {
