...
class GetDiseaseGeneAssociationsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetDiseaseGeneAssociationsAssociationTypeEnum $associationType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=association_type')]
    public ?GetDiseaseGeneAssociationsAssociationTypeEnum $associationType = null;
