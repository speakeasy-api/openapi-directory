...
exports.GetEventsResponse = exports.GetEventsRequest = exports.GetEvents200ApplicationJson = exports.GetEventsQueryParams = void 0;
...
var GetEventsQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=time_event" }),
        __metadata("design:type", String)
    ], GetEventsQueryParams.prototype, "timeEvent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=time_expire" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=topic.action" }),
        __metadata("design:type", String)
    ], GetEventsQueryParams.prototype, "topicAction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=topic.resource" }),
        __metadata("design:type", String)
    ], GetEventsQueryParams.prototype, "topicResource", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=topic.resource_type" }),
        __metadata("design:type", String)
