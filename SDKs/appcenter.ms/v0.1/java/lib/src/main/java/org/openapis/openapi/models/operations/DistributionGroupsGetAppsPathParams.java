...
public class DistributionGroupsGetAppsPathParams {
    /**
    ...
    public DistributionGroupsGetAppsPathParams withDistributionGroupName(String distributionGroupName) {
    ...
    public DistributionGroupsGetAppsPathParams withOrgName(String orgName) {
