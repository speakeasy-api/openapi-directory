...
class DriveRepliesDeleteRequest:
    path_params: DriveRepliesDeletePathParams = dataclasses.field()
    query_params: DriveRepliesDeleteQueryParams = dataclasses.field()
    security: DriveRepliesDeleteSecurity = dataclasses.field()
