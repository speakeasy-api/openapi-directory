...
type SecuritycenterOrganizationsSourcesFindingsGroupSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type SecuritycenterOrganizationsSourcesFindingsGroupPathParams struct {
...
type SecuritycenterOrganizationsSourcesFindingsGroupQueryParams struct {
	// V1 error format.
...
type SecuritycenterOrganizationsSourcesFindingsGroupRequest struct {
	...
	Request     *shared.GroupFindingsRequest `request:"mediaType=application/json"`
	Security    SecuritycenterOrganizationsSourcesFindingsGroupSecurity
}

type SecuritycenterOrganizationsSourcesFindingsGroupResponse struct {
	ContentType string
	// Successful response
