...
var RadAnalyst = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "analyst_id" }),
        __metadata("design:type", Number)
    ], RadAnalyst.prototype, "analystId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "analyst_short_id" }),
        __metadata("design:type", Number)
    ], RadAnalyst.prototype, "analystShortId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "assignment_update_date" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "rad_branch" }),
        __metadata("design:type", String)
    ], RadAnalyst.prototype, "radBranch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "telephone_ext" }),
        __metadata("design:type", Number)
