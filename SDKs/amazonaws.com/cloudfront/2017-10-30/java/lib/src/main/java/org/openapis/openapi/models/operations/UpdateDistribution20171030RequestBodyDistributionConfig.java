 ...
 */
public class UpdateDistribution20171030RequestBodyDistributionConfig {
    
    public org.openapis.openapi.models.shared.Aliases aliases;
    public UpdateDistribution20171030RequestBodyDistributionConfig withAliases(org.openapis.openapi.models.shared.Aliases aliases) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withCacheBehaviors(org.openapis.openapi.models.shared.CacheBehaviors cacheBehaviors) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withCallerReference(String callerReference) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withComment(String comment) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withCustomErrorResponses(org.openapis.openapi.models.shared.CustomErrorResponses customErrorResponses) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withDefaultCacheBehavior(org.openapis.openapi.models.shared.DefaultCacheBehavior defaultCacheBehavior) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withDefaultRootObject(String defaultRootObject) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withEnabled(Boolean enabled) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withHttpVersion(org.openapis.openapi.models.shared.HttpVersionEnum httpVersion) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withIsIpv6Enabled(Boolean isIpv6Enabled) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withLogging(org.openapis.openapi.models.shared.LoggingConfig logging) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withOrigins(org.openapis.openapi.models.shared.Origins origins) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withPriceClass(org.openapis.openapi.models.shared.PriceClassEnum priceClass) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withRestrictions(org.openapis.openapi.models.shared.Restrictions restrictions) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withViewerCertificate(org.openapis.openapi.models.shared.ViewerCertificate viewerCertificate) {
    ...
    public UpdateDistribution20171030RequestBodyDistributionConfig withWebACLId(String webACLId) {
