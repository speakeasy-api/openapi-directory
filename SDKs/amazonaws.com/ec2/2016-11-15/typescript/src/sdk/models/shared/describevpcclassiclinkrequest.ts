 ...
 */
export class DescribeVpcClassicLinkRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeVpcClassicLinkRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeVpcClassicLinkRequestFilters })
  filters?: DescribeVpcClassicLinkRequestFilters[];
