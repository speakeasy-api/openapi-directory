...
func (e UpdatePullRequestStatusXAmzTargetEnum) ToPointer() *UpdatePullRequestStatusXAmzTargetEnum {
	return &e
}
...
func (e *UpdatePullRequestStatusXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "CodeCommit_20150413.UpdatePullRequestStatus":
		*e = UpdatePullRequestStatusXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdatePullRequestStatusXAmzTargetEnum: %v", v)
	}
}
