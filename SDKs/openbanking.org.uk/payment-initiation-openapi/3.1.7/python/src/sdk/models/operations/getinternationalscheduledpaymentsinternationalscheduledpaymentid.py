...
class GetInternationalScheduledPaymentsInternationalScheduledPaymentIDRequest:
    headers: GetInternationalScheduledPaymentsInternationalScheduledPaymentIDHeaders = dataclasses.field()
    path_params: GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPathParams = dataclasses.field()
    security: GetInternationalScheduledPaymentsInternationalScheduledPaymentIDSecurity = dataclasses.field()
