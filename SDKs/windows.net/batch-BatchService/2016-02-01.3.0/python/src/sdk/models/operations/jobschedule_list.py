...
from ..shared import cloudjobschedulelistresult as shared_cloudjobschedulelistresult
...
class JobScheduleListResponse:
    ...
    cloud_job_schedule_list_result: Optional[shared_cloudjobschedulelistresult.CloudJobScheduleListResult] = dataclasses.field(default=None)  
