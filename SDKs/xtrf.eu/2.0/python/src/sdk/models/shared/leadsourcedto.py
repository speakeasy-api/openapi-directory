...
class LeadSourceDTO:
    r"""origin of a customer (ie. recomendation from another customer)"""
    
    active: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('active'), 'exclude': lambda f: f is None }})
    r"""should this value be available on the XTRF selection lists"""  
    available_for_customer: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('availableForCustomer'), 'exclude': lambda f: f is None }})
    r"""should be available for customer"""  
    available_for_provider: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('availableForProvider'), 'exclude': lambda f: f is None }})
    r"""should be available for provider"""  
