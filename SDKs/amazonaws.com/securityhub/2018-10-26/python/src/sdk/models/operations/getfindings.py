...
class GetFindingsRequestBody:
    filters: Optional[GetFindingsRequestBodyFilters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Filters') }})
...
class GetFindingsRequest:
    ...
    query_params: GetFindingsQueryParams = dataclasses.field()
