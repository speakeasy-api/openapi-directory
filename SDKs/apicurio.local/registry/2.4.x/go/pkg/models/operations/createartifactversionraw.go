...
type CreateArtifactVersionRawPathParams struct {
...
type CreateArtifactVersionRawHeaders struct {
...
type CreateArtifactVersionRawRequest struct {
	PathParams CreateArtifactVersionRawPathParams
	Headers    CreateArtifactVersionRawHeaders
...
type CreateArtifactVersionRawResponse struct {
	ContentType string
