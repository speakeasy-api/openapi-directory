...
class ReposListPublicVisibilityEnum(str, Enum):
    r"""Specifies the types of repositories to return. This endpoint will only list repositories available to all users on the enterprise."""
    ALL = 'all'
    PUBLIC = 'public'
...
class ReposListPublicRequest:
    ...
    visibility: Optional[ReposListPublicVisibilityEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'visibility', 'style': 'form', 'explode': True }})
    r"""Specifies the types of repositories to return. This endpoint will only list repositories available to all users on the enterprise."""  
