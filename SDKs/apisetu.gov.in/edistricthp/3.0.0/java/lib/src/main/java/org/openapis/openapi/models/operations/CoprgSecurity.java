...
public class CoprgSecurity {
    ...
    public CoprgSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public CoprgSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public CoprgSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
