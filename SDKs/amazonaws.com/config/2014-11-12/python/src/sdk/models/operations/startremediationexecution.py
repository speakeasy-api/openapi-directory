...
class StartRemediationExecutionRequest:
    ...
    start_remediation_execution_request: shared_startremediationexecutionrequest.StartRemediationExecutionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
