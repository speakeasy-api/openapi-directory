...
class BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsSecurity:
    option1: Optional[BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsRequest:
    path_params: BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsPathParams = dataclasses.field()
    query_params: BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsQueryParams = dataclasses.field()
    security: BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsSecurity = dataclasses.field()
