...
from ..shared import deletecreditnoteresponse as shared_deletecreditnoteresponse
...
class CreditNotesDeleteResponse:
    ...
    r"""Bad Request"""  
    delete_credit_note_response: Optional[shared_deletecreditnoteresponse.DeleteCreditNoteResponse] = dataclasses.field(default=None)
