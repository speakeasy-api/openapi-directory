...
public class BankTransferMigrateAccountRequest {
    ...
    public BankTransferMigrateAccountRequest withWireRoutingNumber(String wireRoutingNumber) {
        this.wireRoutingNumber = wireRoutingNumber;
        return this;
    }
    
    public BankTransferMigrateAccountRequest(@JsonProperty("account_number") String accountNumber, @JsonProperty("account_type") String accountType, @JsonProperty("routing_number") String routingNumber) {
        this.accountNumber = accountNumber;
        this.accountType = accountType;
        this.routingNumber = routingNumber;
  }
