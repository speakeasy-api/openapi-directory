...
func (e GetSystemInstanceXAmzTargetEnum) ToPointer() *GetSystemInstanceXAmzTargetEnum {
	return &e
}
...
func (e *GetSystemInstanceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "IotThingsGraphFrontEndService.GetSystemInstance":
		*e = GetSystemInstanceXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSystemInstanceXAmzTargetEnum: %v", v)
	}
}
