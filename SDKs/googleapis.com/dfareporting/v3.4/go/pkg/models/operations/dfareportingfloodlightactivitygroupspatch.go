...
type DfareportingFloodlightActivityGroupsPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DfareportingFloodlightActivityGroupsPatchPathParams struct {
	// User profile ID associated with this request.
	ProfileID string `pathParam:"style=simple,explode=false,name=profileId"`
}

type DfareportingFloodlightActivityGroupsPatchQueryParams struct {
	// V1 error format.
...
type DfareportingFloodlightActivityGroupsPatchRequest struct {
...
type DfareportingFloodlightActivityGroupsPatchResponse struct {
	ContentType string
	// Successful response
