...
class SecurityHubConfiguration:
    ...
    publish_classification_findings: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('publishClassificationFindings') }})
    publish_policy_findings: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('publishPolicyFindings') }})
