...
public class CodeScanning {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.CodeScanningGetCodeqlDatabaseResponse codeScanningGetCodeqlDatabase(org.openapis.openapi.models.operations.CodeScanningGetCodeqlDatabaseRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.CodeScanningGetCodeqlDatabasePathParams.class, baseUrl, "/repos/{owner}/{repo}/code-scanning/codeql/databases/{language}", request.pathParams, null);
        ...
        org.openapis.openapi.models.operations.CodeScanningGetCodeqlDatabaseResponse res = new org.openapis.openapi.models.operations.CodeScanningGetCodeqlDatabaseResponse() {{
            codeScanningCodeqlDatabase = null;
            basicError = null;
            codeScanningGetCodeqlDatabase503ApplicationJSONObject = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
        res.rawResponse = httpRes;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.CodeScanningCodeqlDatabase out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.CodeScanningCodeqlDatabase.class);
                res.codeScanningCodeqlDatabase = out;
            }
        }
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.CodeScanningGetCodeqlDatabase503ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.CodeScanningGetCodeqlDatabase503ApplicationJSON.class);
                res.codeScanningGetCodeqlDatabase503ApplicationJSONObject = out;
            }
        }
    ...
    public org.openapis.openapi.models.operations.CodeScanningListAlertsForEnterpriseResponse codeScanningListAlertsForEnterprise(org.openapis.openapi.models.operations.CodeScanningListAlertsForEnterpriseRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.CodeScanningListAlertsForEnterpriseResponse res = new org.openapis.openapi.models.operations.CodeScanningListAlertsForEnterpriseResponse() {{
            codeScanningOrganizationAlertItems = null;
            basicError = null;
            codeScanningListAlertsForEnterprise503ApplicationJSONObject = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
        res.rawResponse = httpRes;
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.CodeScanningOrganizationAlertItems[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.CodeScanningOrganizationAlertItems[].class);
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.CodeScanningListAlertsForEnterprise503ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.CodeScanningListAlertsForEnterprise503ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.CodeScanningListAlertsForOrgResponse codeScanningListAlertsForOrg(org.openapis.openapi.models.operations.CodeScanningListAlertsForOrgRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.CodeScanningListAlertsForOrg503ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.CodeScanningListAlertsForOrg503ApplicationJSON.class);
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.CodeScanningListCodeqlDatabasesResponse codeScanningListCodeqlDatabases(org.openapis.openapi.models.operations.CodeScanningListCodeqlDatabasesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.CodeScanningListCodeqlDatabasesPathParams.class, baseUrl, "/repos/{owner}/{repo}/code-scanning/codeql/databases", request.pathParams, null);
        ...
        org.openapis.openapi.models.operations.CodeScanningListCodeqlDatabasesResponse res = new org.openapis.openapi.models.operations.CodeScanningListCodeqlDatabasesResponse() {{
            codeScanningCodeqlDatabases = null;
            basicError = null;
            codeScanningListCodeqlDatabases503ApplicationJSONObject = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
        res.rawResponse = httpRes;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.CodeScanningCodeqlDatabase[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.CodeScanningCodeqlDatabase[].class);
                res.codeScanningCodeqlDatabases = out;
            }
        }
        else if (httpRes.statusCode() == 403 || httpRes.statusCode() == 404) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.CodeScanningListCodeqlDatabases503ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.CodeScanningListCodeqlDatabases503ApplicationJSON.class);
                res.codeScanningListCodeqlDatabases503ApplicationJSONObject = out;
            }
        }
