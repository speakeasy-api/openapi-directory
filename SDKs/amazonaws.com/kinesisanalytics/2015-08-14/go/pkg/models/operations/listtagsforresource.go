...
const (
	ListTagsForResourceXAmzTargetEnumKinesisAnalytics20150814ListTagsForResource ListTagsForResourceXAmzTargetEnum = "KinesisAnalytics_20150814.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "KinesisAnalytics_20150814.ListTagsForResource":
