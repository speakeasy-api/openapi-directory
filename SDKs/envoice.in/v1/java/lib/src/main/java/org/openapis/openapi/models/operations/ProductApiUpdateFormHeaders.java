...
public class ProductApiUpdateFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ProductApiUpdateFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public ProductApiUpdateFormHeaders withXAuthSecret(String xAuthSecret) {
