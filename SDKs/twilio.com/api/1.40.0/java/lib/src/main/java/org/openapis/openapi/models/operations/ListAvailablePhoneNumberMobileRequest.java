...
public class ListAvailablePhoneNumberMobileRequest {
    ...
    public ListAvailablePhoneNumberMobileRequest withAccountSid(String accountSid) {
    ...
    public ListAvailablePhoneNumberMobileRequest withAreaCode(Long areaCode) {
    ...
    public Boolean beta;
    public ListAvailablePhoneNumberMobileRequest withBeta(Boolean beta) {
        this.beta = beta;
        return this;
    }
    ...
    public ListAvailablePhoneNumberMobileRequest withContains(String contains) {
    ...
    public ListAvailablePhoneNumberMobileRequest withCountryCode(String countryCode) {
    ...
    public ListAvailablePhoneNumberMobileRequest withDistance(Long distance) {
    ...
    public ListAvailablePhoneNumberMobileRequest withExcludeAllAddressRequired(Boolean excludeAllAddressRequired) {
    ...
    public ListAvailablePhoneNumberMobileRequest withExcludeForeignAddressRequired(Boolean excludeForeignAddressRequired) {
    ...
    public ListAvailablePhoneNumberMobileRequest withExcludeLocalAddressRequired(Boolean excludeLocalAddressRequired) {
    ...
    public ListAvailablePhoneNumberMobileRequest withFaxEnabled(Boolean faxEnabled) {
    ...
    public ListAvailablePhoneNumberMobileRequest withInLata(String inLata) {
        this.inLata = inLata;
        return this;
    }
    ...
    public ListAvailablePhoneNumberMobileRequest withInLocality(String inLocality) {
    ...
    public ListAvailablePhoneNumberMobileRequest withInPostalCode(String inPostalCode) {
    ...
    public ListAvailablePhoneNumberMobileRequest withInRateCenter(String inRateCenter) {
    ...
    public ListAvailablePhoneNumberMobileRequest withInRegion(String inRegion) {
    ...
    public ListAvailablePhoneNumberMobileRequest withMmsEnabled(Boolean mmsEnabled) {
    ...
    public ListAvailablePhoneNumberMobileRequest withNearLatLong(String nearLatLong) {
    ...
    public ListAvailablePhoneNumberMobileRequest withNearNumber(String nearNumber) {
    ...
    public Long page;
    public ListAvailablePhoneNumberMobileRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListAvailablePhoneNumberMobileRequest withPageSize(Long pageSize) {
    ...
    public ListAvailablePhoneNumberMobileRequest withPageToken(String pageToken) {
    ...
    public ListAvailablePhoneNumberMobileRequest withSmsEnabled(Boolean smsEnabled) {
    ...
    public ListAvailablePhoneNumberMobileRequest withVoiceEnabled(Boolean voiceEnabled) {
