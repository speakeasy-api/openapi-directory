...
var StartDeviceAuthorizationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "deviceCode" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "userCode" }),
        __metadata("design:type", String)
    ], StartDeviceAuthorizationResponse.prototype, "userCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "verificationUri" }),
        __metadata("design:type", String)
    ], StartDeviceAuthorizationResponse.prototype, "verificationUri", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "verificationUriComplete" }),
        __metadata("design:type", String)
