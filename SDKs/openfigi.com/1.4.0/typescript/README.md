...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/openfigi.com/1.4.0/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/openfigi.com/1.4.0/typescript
```
