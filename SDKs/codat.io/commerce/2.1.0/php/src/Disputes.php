...
class Disputes 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\ListDisputesResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/companies/{companyId}/connections/{connectionId}/data/commerce-disputes', \OpenAPI\OpenAPI\Models\Operations\ListDisputesRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->disputes = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\Disputes', 'json');
            }
        }
