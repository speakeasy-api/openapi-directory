 ...
 */
export enum SnapshotListWarningCodeEnum {
...
export class SnapshotListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SnapshotListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: SnapshotListWarningData })
  @Expose({ name: "data" })
