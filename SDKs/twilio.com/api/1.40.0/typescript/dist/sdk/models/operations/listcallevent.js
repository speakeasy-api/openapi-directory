...
exports.ListCallEventResponse = exports.ListCallEventListCallEventResponse = exports.ListCallEventRequest = exports.ListCallEventSecurity = exports.ListCallEventServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListCallEventServerList = ["https://api.twilio.com"];
var ListCallEventSecurity = /** @class */ (function (_super) {
    ...
    ], ListCallEventSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListCallEventSecurity.prototype, "username", void 0);
    return ListCallEventSecurity;
}(utils_1.SpeakeasyBase));
exports.ListCallEventSecurity = ListCallEventSecurity;
var ListCallEventRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListCallEventRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=CallSid",
        }),
        __metadata("design:type", String)
    ], ListCallEventRequest.prototype, "callSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListCallEventRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListCallEventRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListCallEventRequest.prototype, "pageToken", void 0);
    return ListCallEventRequest;
}(utils_1.SpeakeasyBase));
exports.ListCallEventRequest = ListCallEventRequest;
/**
 * OK
 */
var ListCallEventListCallEventResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ApiV2010AccountCallCallEvent }),
        (0, class_transformer_1.Expose)({ name: "events" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountCallCallEvent; }),
...
exports.ListCallEventListCallEventResponse = ListCallEventListCallEventResponse;
var ListCallEventResponse = /** @class */ (function (_super) {
    ...
    ], ListCallEventResponse.prototype, "rawResponse", void 0);
    return ListCallEventResponse;
}(utils_1.SpeakeasyBase));
exports.ListCallEventResponse = ListCallEventResponse;
