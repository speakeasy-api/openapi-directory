...
class DeleteLaunchProfileMemberRequest:
    headers: DeleteLaunchProfileMemberHeaders = dataclasses.field()
    path_params: DeleteLaunchProfileMemberPathParams = dataclasses.field()
...
class DeleteLaunchProfileMemberResponse:
    ...
    delete_launch_profile_member_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
