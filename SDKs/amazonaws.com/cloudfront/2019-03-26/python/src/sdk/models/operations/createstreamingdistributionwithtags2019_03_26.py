...
class CreateStreamingDistributionWithTags20190326Request:
    headers: CreateStreamingDistributionWithTags20190326Headers = dataclasses.field()
    query_params: CreateStreamingDistributionWithTags20190326QueryParams = dataclasses.field()
