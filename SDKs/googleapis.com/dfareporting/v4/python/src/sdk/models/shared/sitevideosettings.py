...
class SiteVideoSettings:
    ...
    publisher_specification_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('publisherSpecificationId') }})
