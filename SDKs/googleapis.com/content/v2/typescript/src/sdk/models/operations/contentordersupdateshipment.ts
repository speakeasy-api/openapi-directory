...
export class ContentOrdersUpdateshipmentSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentOrdersUpdateshipmentRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentOrdersUpdateshipmentResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
