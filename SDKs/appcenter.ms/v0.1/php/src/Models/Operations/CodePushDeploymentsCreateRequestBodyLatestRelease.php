...
class CodePushDeploymentsCreateRequestBodyLatestRelease
{
     ...
     * $diffPackageMap
     * 
     * @var ?array<string, \OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentsCreateRequestBodyLatestReleaseDiffPackageMap> $diffPackageMap
     */
	#[\JMS\Serializer\Annotation\SerializedName('diff_package_map')]
    #[\JMS\Serializer\Annotation\Type('array<string, OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentsCreateRequestBodyLatestReleaseDiffPackageMap>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentsCreateRequestBodyLatestReleaseReleaseMethodEnum $releaseMethod
     */
	#[\JMS\Serializer\Annotation\SerializedName('release_method')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentsCreateRequestBodyLatestReleaseReleaseMethodEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CodePushDeploymentsCreateRequestBodyLatestReleaseReleaseMethodEnum $releaseMethod = null;
