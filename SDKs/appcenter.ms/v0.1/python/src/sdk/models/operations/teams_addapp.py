...
class TeamsAddAppRequestBody:
    r"""The name of the app to be added to the team. The app has to be owned by the organization."""
...
class TeamsAddAppRequest:
    ...
    request_body: TeamsAddAppRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The name of the app to be added to the team. The app has to be owned by the organization."""  
    team_name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'team_name', 'style': 'simple', 'explode': False }})
    r"""The team's name"""  
    
class TeamsAddAppDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
class TeamsAddAppDefaultApplicationJSONError:
    ...
    code: TeamsAddAppDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
...
class TeamsAddAppDefaultApplicationJSON:
    ...
    error: TeamsAddAppDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TeamsAddApp201ApplicationJSONAzureSubscription:
...
class TeamsAddApp201ApplicationJSONMemberPermissionsEnum(str, Enum):
    MANAGER = 'manager'
    DEVELOPER = 'developer'
    VIEWER = 'viewer'
    TESTER = 'tester'

class TeamsAddApp201ApplicationJSONOriginEnum(str, Enum):
    r"""The creation origin of this app"""
    APPCENTER = 'appcenter'
    HOCKEYAPP = 'hockeyapp'
    CODEPUSH = 'codepush'

class TeamsAddApp201ApplicationJSONOsEnum(str, Enum):
...
class TeamsAddApp201ApplicationJSONOwnerTypeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TeamsAddApp201ApplicationJSONOwner:
    ...
    type: TeamsAddApp201ApplicationJSONOwnerTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The owner type. Can either be 'org' or 'user'"""  
...
class TeamsAddApp201ApplicationJSONPlatformEnum(str, Enum):
...
class TeamsAddApp201ApplicationJSONTeamPermissionsEnum(str, Enum):
    MANAGER = 'manager'
    DEVELOPER = 'developer'
    VIEWER = 'viewer'
...
class TeamsAddApp201ApplicationJSON:
    ...
    origin: TeamsAddApp201ApplicationJSONOriginEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin') }})
    r"""The creation origin of this app"""  
    os: TeamsAddApp201ApplicationJSONOsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('os') }})
    r"""The OS the app will be running on"""  
    owner: TeamsAddApp201ApplicationJSONOwner = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('owner') }})
    r"""The information about the app's owner"""  
    platform: TeamsAddApp201ApplicationJSONPlatformEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('platform') }})
    r"""The platform of the app"""  
    azure_subscription: Optional[TeamsAddApp201ApplicationJSONAzureSubscription] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('azure_subscription'), 'exclude': lambda f: f is None }})  
    ...
    member_permissions: Optional[list[TeamsAddApp201ApplicationJSONMemberPermissionsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('member_permissions'), 'exclude': lambda f: f is None }})
    ...
    team_permissions: Optional[list[TeamsAddApp201ApplicationJSONTeamPermissionsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('team_permissions'), 'exclude': lambda f: f is None }})
...
class TeamsAddAppResponse:
    ...
    teams_add_app_201_application_json_object: Optional[TeamsAddApp201ApplicationJSON] = dataclasses.field(default=None)
    r"""Success"""  
    teams_add_app_default_application_json_object: Optional[TeamsAddAppDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error"""  
