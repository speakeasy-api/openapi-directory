...
func (e TrunkingV1TrunkPhoneNumberSmsFallbackMethodEnum) ToPointer() *TrunkingV1TrunkPhoneNumberSmsFallbackMethodEnum {
	return &e
}
...
func (e *TrunkingV1TrunkPhoneNumberSmsFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = TrunkingV1TrunkPhoneNumberSmsFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TrunkingV1TrunkPhoneNumberSmsFallbackMethodEnum: %v", v)
	}
}
...
func (e TrunkingV1TrunkPhoneNumberSmsMethodEnum) ToPointer() *TrunkingV1TrunkPhoneNumberSmsMethodEnum {
	return &e
}
...
func (e *TrunkingV1TrunkPhoneNumberSmsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = TrunkingV1TrunkPhoneNumberSmsMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TrunkingV1TrunkPhoneNumberSmsMethodEnum: %v", v)
	}
}
...
func (e TrunkingV1TrunkPhoneNumberStatusCallbackMethodEnum) ToPointer() *TrunkingV1TrunkPhoneNumberStatusCallbackMethodEnum {
	return &e
}
...
func (e *TrunkingV1TrunkPhoneNumberStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = TrunkingV1TrunkPhoneNumberStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TrunkingV1TrunkPhoneNumberStatusCallbackMethodEnum: %v", v)
	}
}
...
func (e TrunkingV1TrunkPhoneNumberVoiceFallbackMethodEnum) ToPointer() *TrunkingV1TrunkPhoneNumberVoiceFallbackMethodEnum {
	return &e
}
...
func (e *TrunkingV1TrunkPhoneNumberVoiceFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = TrunkingV1TrunkPhoneNumberVoiceFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TrunkingV1TrunkPhoneNumberVoiceFallbackMethodEnum: %v", v)
	}
}
...
func (e TrunkingV1TrunkPhoneNumberVoiceMethodEnum) ToPointer() *TrunkingV1TrunkPhoneNumberVoiceMethodEnum {
	return &e
}
...
func (e *TrunkingV1TrunkPhoneNumberVoiceMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = TrunkingV1TrunkPhoneNumberVoiceMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TrunkingV1TrunkPhoneNumberVoiceMethodEnum: %v", v)
	}
}
