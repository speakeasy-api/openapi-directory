...
public class Monatsbelege {
    ...
    public org.openapis.openapi.models.operations.GetMonatsbelegeResponse getMonatsbelege(org.openapis.openapi.models.operations.GetMonatsbelegeRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.GetMonatsbelegeResponse res = new org.openapis.openapi.models.operations.GetMonatsbelegeResponse(contentType, httpRes.statusCode()) {{
            monatsbelegs = null;
        }};
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.Monatsbeleg[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.Monatsbeleg[].class);
