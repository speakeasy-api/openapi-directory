...
class RegisterStreamConsumerRequest:
    ...
    register_stream_consumer_input: shared_registerstreamconsumerinput.RegisterStreamConsumerInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
