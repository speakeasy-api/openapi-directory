 ...
 */
export enum CreateRouteTableRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateRouteTableRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateRouteTableRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateRouteTableRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateRouteTableRequestTagSpecificationsTags })
  tags?: CreateRouteTableRequestTagSpecificationsTags[];
}

export class CreateRouteTableRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: CreateRouteTableRequestTagSpecifications })
