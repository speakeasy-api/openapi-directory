...
```bash
go get github.com/speakeasy-api/openapi-directory/SDKs/apisetu.gov.in/saralharyana/3.0.0/go
```
...
func main() {
    ...
    res, err := s.APIs.Nbcer(ctx, operations.NbcerRequestBody{
        ...
        Format: operations.NbcerRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.NbcerSecurity{
