...
class GetAPIVVersionMetalsSpotRatioHistoryRequest:
    path_params: GetAPIVVersionMetalsSpotRatioHistoryPathParams = dataclasses.field()
    query_params: GetAPIVVersionMetalsSpotRatioHistoryQueryParams = dataclasses.field()
