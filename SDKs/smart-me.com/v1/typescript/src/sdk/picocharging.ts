...
export class PicoCharging {
  ...
  picoChargingGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.PicoChargingGetResponse =
        new operations.PicoChargingGetResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.picoChargingData = utils.objectToClass(
              httpRes?.data,
              shared.PicoChargingData
            );
          }
