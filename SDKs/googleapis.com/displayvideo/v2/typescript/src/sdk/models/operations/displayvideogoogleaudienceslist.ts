...
export class DisplayvideoGoogleAudiencesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoGoogleAudiencesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoGoogleAudiencesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
