...
class GetRemoveRoleFromDbClusterQueryParams:
    action: GetRemoveRoleFromDbClusterActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetRemoveRoleFromDbClusterVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRemoveRoleFromDbClusterRequest:
    headers: GetRemoveRoleFromDbClusterHeaders = dataclasses.field()
    query_params: GetRemoveRoleFromDbClusterQueryParams = dataclasses.field()
