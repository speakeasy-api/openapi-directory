...
func (e *ErrorsErrorStackTraceDefaultApplicationJSONErrorCodeEnum) UnmarshalJSON(data []byte) error {
	...
	case "TooManyRequests":
		*e = ErrorsErrorStackTraceDefaultApplicationJSONErrorCodeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ErrorsErrorStackTraceDefaultApplicationJSONErrorCodeEnum: %s", s)
	}
}
