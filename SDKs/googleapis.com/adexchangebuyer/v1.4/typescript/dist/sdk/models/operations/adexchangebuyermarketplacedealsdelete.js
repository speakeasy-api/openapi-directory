...
exports.AdexchangebuyerMarketplacedealsDeleteResponse = exports.AdexchangebuyerMarketplacedealsDeleteRequest = exports.AdexchangebuyerMarketplacedealsDeleteSecurity = void 0;
...
var AdexchangebuyerMarketplacedealsDeleteRequest = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerMarketplacedealsDeleteRequest.prototype, "deleteOrderDealsRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsDeleteRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsDeleteRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsDeleteRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsDeleteRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdexchangebuyerMarketplacedealsDeleteRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=proposalId",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsDeleteRequest.prototype, "proposalId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsDeleteRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsDeleteRequest.prototype, "userIp", void 0);
...
var AdexchangebuyerMarketplacedealsDeleteResponse = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerMarketplacedealsDeleteResponse.prototype, "rawResponse", void 0);
