...
class BatchTranslateDocumentRequest:
    ...
    r"""Required. The ISO-639 language code of the input document if known, for example, \\"en-US\\" or \\"sr-Latn\\". Supported language codes are listed in [Language Support](https://cloud.google.com/translate/docs/languages)."""  
    ...
    r"""Required. The ISO-639 language code to use for translation of the input document. Specify up to 10 language codes here."""  
