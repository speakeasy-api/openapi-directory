...
class GoogleCloudDocumentaiV1beta2DocumentPageTokenDetectedBreak:
    ...
    type: Optional[GoogleCloudDocumentaiV1beta2DocumentPageTokenDetectedBreakTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Detected break type."""  
