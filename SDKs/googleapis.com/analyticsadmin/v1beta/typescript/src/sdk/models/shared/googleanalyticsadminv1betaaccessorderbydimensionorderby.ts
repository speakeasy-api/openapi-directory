 ...
 */
export enum GoogleAnalyticsAdminV1betaAccessOrderByDimensionOrderByOrderTypeEnum {
 ...
 */
export class GoogleAnalyticsAdminV1betaAccessOrderByDimensionOrderBy extends SpeakeasyBase {
  /**
