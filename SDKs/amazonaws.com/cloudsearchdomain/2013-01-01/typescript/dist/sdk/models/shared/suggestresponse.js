...
var SuggestResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return suggeststatus_1.SuggestStatus; }),
        __metadata("design:type", suggeststatus_1.SuggestStatus)
    ], SuggestResponse.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "suggest" }),
        (0, class_transformer_1.Type)(function () { return suggestmodel_1.SuggestModel; }),
