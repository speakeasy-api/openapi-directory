...
public class BatchInvoiceType {
    ...
    public BatchInvoiceType withIntegrationIdNS(String integrationIdNS) {
    ...
    public BatchInvoiceType withIntegrationStatusNS(String integrationStatusNS) {
    ...
    public BatchInvoiceType withSyncDateNS(String syncDateNS) {
    ...
    public BatchInvoiceType withAutoPay(Boolean autoPay) {
    ...
    public BatchInvoiceType withComments(String comments) {
    ...
    public BatchInvoiceType withDueDate(LocalDate dueDate) {
    ...
    @JsonProperty("id")
    public String id;
    public BatchInvoiceType withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public BatchInvoiceType withInvoiceDate(LocalDate invoiceDate) {
    ...
    public BatchInvoiceType withInvoiceItems(PutInvoiceItemType[] invoiceItems) {
    ...
    public BatchInvoiceTypeTransferredToAccountingEnum transferredToAccounting;
    public BatchInvoiceType withTransferredToAccounting(BatchInvoiceTypeTransferredToAccountingEnum transferredToAccounting) {
