...
class LatestGetV2LatestLocationIdGetRequest
{
     ...
     * Order by a field
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\LatestGetV2LatestLocationIdGetOrderByLocationsOrderEnum $orderBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=order_by')]
    public ?LatestGetV2LatestLocationIdGetOrderByLocationsOrderEnum $orderBy = null;
     ...
     * Sort Direction
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\LatestGetV2LatestLocationIdGetSortSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?LatestGetV2LatestLocationIdGetSortSortEnum $sort = null;
