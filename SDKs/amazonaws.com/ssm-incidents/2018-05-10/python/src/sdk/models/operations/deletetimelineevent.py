...
class DeleteTimelineEventRequest:
    headers: DeleteTimelineEventHeaders = dataclasses.field()
    request: DeleteTimelineEventRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteTimelineEventResponse:
    ...
    delete_timeline_event_output: Optional[dict[str, Any]] = dataclasses.field(default=None)
