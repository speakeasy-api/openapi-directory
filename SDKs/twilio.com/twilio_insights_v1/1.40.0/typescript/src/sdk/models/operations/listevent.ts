...
export const ListEventServerList = ["https://insights.twilio.com"] as const;
...
export class ListEventListEventResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.InsightsV1CallEvent })
  @Expose({ name: "events" })
  @Type(() => shared.InsightsV1CallEvent)
