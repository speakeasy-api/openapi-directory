...
export class ServicePrincipalKeyCredentials {
  ...
  servicePrincipalsListKeyCredentials(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ServicePrincipalsListKeyCredentialsResponse =
        new operations.ServicePrincipalsListKeyCredentialsResponse({
  ...
  servicePrincipalsUpdateKeyCredentials(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ServicePrincipalsUpdateKeyCredentialsResponse =
        new operations.ServicePrincipalsUpdateKeyCredentialsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
