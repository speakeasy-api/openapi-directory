...
export enum DescribeOptOutListsXAmzTargetEnum {
  PinpointSMSVoiceV2DescribeOptOutLists = "PinpointSMSVoiceV2.DescribeOptOutLists",
}

export class DescribeOptOutListsRequest extends SpeakeasyBase {
...
export class DescribeOptOutListsResponse extends SpeakeasyBase {
  /**
