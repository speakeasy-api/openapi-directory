...
class GetDiseaseCaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetDiseaseCaseAssociationsQueryParams:
...
class GetDiseaseCaseAssociationsRequest:
    path_params: GetDiseaseCaseAssociationsPathParams = dataclasses.field()
    query_params: GetDiseaseCaseAssociationsQueryParams = dataclasses.field()
