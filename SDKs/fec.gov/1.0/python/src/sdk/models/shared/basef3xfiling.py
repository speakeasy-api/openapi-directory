...
class BaseF3XFiling:
    ...
    amend_address: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('amend_address'), 'exclude': lambda f: f is None }})  
    ...
    qualified_multicandidate_committee: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('qualified_multicandidate_committee'), 'exclude': lambda f: f is None }})  
