...
class UpdateDomainNameResponse:
    ...
    mutual_tls_authentication: Optional[UpdateDomainNameResponseMutualTLSAuthentication] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MutualTlsAuthentication'), 'exclude': lambda f: f is None }})  
