...
public class UpdateIntegrationResponseResponse {
    ...
    public UpdateIntegrationResponseResponse withContentHandlingStrategy(java.util.Map<String, Object> contentHandlingStrategy) {
    ...
    public UpdateIntegrationResponseResponse withIntegrationResponseId(java.util.Map<String, Object> integrationResponseId) {
    ...
    public UpdateIntegrationResponseResponse withIntegrationResponseKey(java.util.Map<String, Object> integrationResponseKey) {
    ...
    public UpdateIntegrationResponseResponse withTemplateSelectionExpression(java.util.Map<String, Object> templateSelectionExpression) {
