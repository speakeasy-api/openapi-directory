...
class OpenBanking:
    ...
    def get_list_of_aspsps(self, request: operations.GetListOfAspspsRequest) -> operations.GetListOfAspspsResponse:
        ...
        ***This endpoint is only required if you intend to host the “Select ASPSP / bank” page yourself.***
        ...
        url = base_url.removesuffix('/') + '/v1/aspsps'
        
        query_params = utils.get_query_params(operations.GetListOfAspspsRequest, request)
        ...
        res = operations.GetListOfAspspsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetListOfAspspsAspsps])
                res.aspsps = out
    ...
    def get_payment_details(self, request: operations.GetPaymentDetailsRequest) -> operations.GetPaymentDetailsResponse:
        ...
        * `PAID` - Funds were received into your fire.com GBP or EUR account from your customer’s ASPSP / bank.
        ...
        url = utils.generate_url(operations.GetPaymentDetailsRequest, base_url, '/v1/payments/{paymentUuid}', request)
        ...
        res = operations.GetPaymentDetailsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetPaymentDetailsPaymentRequest])
                res.payment_request = out

        return res

    def new_payment_request(self, request: operations.NewPaymentRequestNewPaymentRequest) -> operations.NewPaymentRequestResponse:
        ...
        url = base_url.removesuffix('/') + '/v1/paymentrequests'
        ...
        res = operations.NewPaymentRequestResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.NewPaymentRequestNewPaymentRequestResponse])
