...
class GetInternationalPaymentConsentsConsentIDPathParams:
    consent_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ConsentId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetInternationalPaymentConsentsConsentIDHeaders:
...
@dataclasses.dataclass
class GetInternationalPaymentConsentsConsentIDSecurity:
...
class GetInternationalPaymentConsentsConsentIDRequest:
    headers: GetInternationalPaymentConsentsConsentIDHeaders = dataclasses.field()
    path_params: GetInternationalPaymentConsentsConsentIDPathParams = dataclasses.field()
    security: GetInternationalPaymentConsentsConsentIDSecurity = dataclasses.field()
