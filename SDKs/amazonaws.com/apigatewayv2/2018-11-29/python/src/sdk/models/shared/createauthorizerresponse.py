...
class CreateAuthorizerResponseJwtConfiguration:
    r"""CreateAuthorizerResponseJwtConfiguration
...
class CreateAuthorizerResponse:
    ...
    jwt_configuration: Optional[CreateAuthorizerResponseJwtConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('JwtConfiguration') }})
