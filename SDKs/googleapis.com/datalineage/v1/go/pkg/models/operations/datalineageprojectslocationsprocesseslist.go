...
type DatalineageProjectsLocationsProcessesListPathParams struct {
	// Required. The name of the project and its location that owns this collection of processes.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type DatalineageProjectsLocationsProcessesListQueryParams struct {
	// V1 error format.
...
type DatalineageProjectsLocationsProcessesListRequest struct {
	PathParams  DatalineageProjectsLocationsProcessesListPathParams
	QueryParams DatalineageProjectsLocationsProcessesListQueryParams
	Security    DatalineageProjectsLocationsProcessesListSecurity
}
