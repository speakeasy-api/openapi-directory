...
exports.GetFundsConfirmationConsentsConsentIdResponse = exports.GetFundsConfirmationConsentsConsentIdRequest = exports.GetFundsConfirmationConsentsConsentIdSecurity = void 0;
...
exports.GetFundsConfirmationConsentsConsentIdSecurity = GetFundsConfirmationConsentsConsentIdSecurity;
var GetFundsConfirmationConsentsConsentIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetFundsConfirmationConsentsConsentIdRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConsentId",
        }),
        __metadata("design:type", String)
    ], GetFundsConfirmationConsentsConsentIdRequest.prototype, "consentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetFundsConfirmationConsentsConsentIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetFundsConfirmationConsentsConsentIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetFundsConfirmationConsentsConsentIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetFundsConfirmationConsentsConsentIdRequest.prototype, "xFapiInteractionId", void 0);
    return GetFundsConfirmationConsentsConsentIdRequest;
}(utils_1.SpeakeasyBase));
exports.GetFundsConfirmationConsentsConsentIdRequest = GetFundsConfirmationConsentsConsentIdRequest;
var GetFundsConfirmationConsentsConsentIdResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetFundsConfirmationConsentsConsentIdResponse.prototype, "rawResponse", void 0);
    return GetFundsConfirmationConsentsConsentIdResponse;
}(utils_1.SpeakeasyBase));
exports.GetFundsConfirmationConsentsConsentIdResponse = GetFundsConfirmationConsentsConsentIdResponse;
