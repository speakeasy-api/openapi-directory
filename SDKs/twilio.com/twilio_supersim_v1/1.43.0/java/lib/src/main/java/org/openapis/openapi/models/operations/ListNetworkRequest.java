...
public class ListNetworkRequest {
    ...
    public ListNetworkRequest withIsoCountry(String isoCountry) {
    ...
    public ListNetworkRequest withMcc(String mcc) {
        this.mcc = mcc;
        return this;
    }
    ...
    public ListNetworkRequest withMnc(String mnc) {
        this.mnc = mnc;
        return this;
    }
    ...
    public ListNetworkRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListNetworkRequest withPageSize(Long pageSize) {
    ...
    public ListNetworkRequest withPageToken(String pageToken) {
