 ...
 */
public class UpdateDeviceSensorRelationships200ApplicationJSONLivestream {
    /**
     * An array of the related devices for the role
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("relatedDevices")
    public UpdateDeviceSensorRelationships200ApplicationJSONLivestreamRelatedDevices[] relatedDevices;
    public UpdateDeviceSensorRelationships200ApplicationJSONLivestream withRelatedDevices(UpdateDeviceSensorRelationships200ApplicationJSONLivestreamRelatedDevices[] relatedDevices) {
