...
@dataclasses.dataclass
class ClouddeployProjectsLocationsTargetsGetQueryParams:
...
class ClouddeployProjectsLocationsTargetsGetRequest:
    path_params: ClouddeployProjectsLocationsTargetsGetPathParams = dataclasses.field()
    query_params: ClouddeployProjectsLocationsTargetsGetQueryParams = dataclasses.field()
    security: ClouddeployProjectsLocationsTargetsGetSecurity = dataclasses.field()
