...
class SendMessageRequestBody3Video
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3VideoChannelEnum $channel
     */
	#[\JMS\Serializer\Annotation\SerializedName('channel')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3VideoChannelEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3VideoMessageTypeEnum $messageType
     */
	#[\JMS\Serializer\Annotation\SerializedName('message_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3VideoMessageTypeEnum>')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3VideoVideo')]
    public SendMessageRequestBody3VideoVideo $video;
    
	public function __construct()
	{
		$this->channel = \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3VideoChannelEnum::WHATSAPP;
		$this->clientRef = null;
		$this->from = "";
		$this->messageType = \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3VideoMessageTypeEnum::VIDEO;
		$this->to = "";
		$this->video = new \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3VideoVideo();
	}
}
