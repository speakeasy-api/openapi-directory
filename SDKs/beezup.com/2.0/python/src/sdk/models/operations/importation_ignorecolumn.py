...
class ImportationIgnoreColumnPathParams:
...
@dataclasses.dataclass
class ImportationIgnoreColumnRequest:
    path_params: ImportationIgnoreColumnPathParams = dataclasses.field()
    

@dataclasses.dataclass
class ImportationIgnoreColumnResponse:
