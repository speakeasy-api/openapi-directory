...
class GetInsightSummariesResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetInsightSummariesResult $getInsightSummariesResult
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetInsightSummariesResult $getInsightSummariesResult = null;
	...
	{
		$this->contentType = "";
		$this->getInsightSummariesResult = null;
