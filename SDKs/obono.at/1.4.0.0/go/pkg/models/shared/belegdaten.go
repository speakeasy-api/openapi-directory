...
func (e BelegdatenUnternehmenIDTypEnum) ToPointer() *BelegdatenUnternehmenIDTypEnum {
	return &e
}
...
func (e *BelegdatenUnternehmenIDTypEnum) UnmarshalJSON(data []byte) error {
	...
	case "uid":
		fallthrough
	case "gln":
		*e = BelegdatenUnternehmenIDTypEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for BelegdatenUnternehmenIDTypEnum: %v", v)
	}
}
