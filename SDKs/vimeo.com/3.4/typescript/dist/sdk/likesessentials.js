...
var LikesEssentials = /** @class */ (function () {
    ...
    **/
    LikesEssentials.prototype.checkIfUserLikedVideo = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/users/{user_id}/likes/{video_id}", req.pathParams);
    ...
    **/
    LikesEssentials.prototype.checkIfUserLikedVideoAlt1 = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/me/likes/{video_id}", req.pathParams);
        var client = this._securityClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    LikesEssentials.prototype.getLikes = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{user_id}/likes", req.pathParams);
        var client = this._securityClient;
    ...
    **/
    LikesEssentials.prototype.getVideoLikes = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/videos/{video_id}/likes", req.pathParams);
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    **/
    LikesEssentials.prototype.getVideoLikesAlt1 = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/channels/{channel_id}/videos/{video_id}/likes", req.pathParams);
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    **/
    LikesEssentials.prototype.getVodLikes = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ondemand/pages/{ondemand_id}/likes", req.pathParams);
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    **/
    LikesEssentials.prototype.likeVideo = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    LikesEssentials.prototype.likeVideoAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    LikesEssentials.prototype.unlikeVideo = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    LikesEssentials.prototype.unlikeVideoAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
