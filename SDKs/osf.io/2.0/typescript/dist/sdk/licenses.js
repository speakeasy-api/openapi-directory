...
var Licenses = /** @class */ (function () {
    ...
    **/
    Licenses.prototype.licenseList = function (config) {
    ...
    **/
    Licenses.prototype.licensesRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.LicensesReadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/license/{license_id}/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
