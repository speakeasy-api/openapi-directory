...
class GetApplicationRevisionOutput:
    r"""Represents the output of a <code>GetApplicationRevision</code> operation."""
    ...
    revision_info: Optional[shared_genericrevisioninfo.GenericRevisionInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('revisionInfo'), 'exclude': lambda f: f is None }})  
