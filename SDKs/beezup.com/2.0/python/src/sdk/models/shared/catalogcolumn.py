...
from ..shared import catalogcolumnlinks as shared_catalogcolumnlinks
...
class CatalogColumn:
    ...
    links: shared_catalogcolumnlinks.CatalogColumnLinks = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('links') }})
