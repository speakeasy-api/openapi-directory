...
class CreateCustomerGatewayRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateCustomerGatewayRequestTagSpecifications:
    ...
    resource_type: Optional[CreateCustomerGatewayRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateCustomerGatewayRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateCustomerGatewayRequest:
    r"""Contains the parameters for CreateCustomerGateway."""
    
    type: shared_gatewaytype_enum.GatewayTypeEnum = dataclasses.field()  
    bgp_asn: Optional[int] = dataclasses.field(default=None)  
    ...
    tag_specifications: Optional[list[CreateCustomerGatewayRequestTagSpecifications]] = dataclasses.field(default=None)  
