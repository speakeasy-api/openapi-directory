...
exports.SearchGroupsResponse = exports.SearchGroups200ApplicationJSON = exports.SearchGroupsRequest = exports.SearchGroupsSecurity = void 0;
...
exports.SearchGroupsSecurity = SearchGroupsSecurity;
var SearchGroupsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], SearchGroupsRequest.prototype, "country", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=distance",
        }),
        __metadata("design:type", Number)
    ], SearchGroupsRequest.prototype, "distance", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=latitude",
        }),
        __metadata("design:type", Number)
    ], SearchGroupsRequest.prototype, "latitude", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=longitude",
        }),
        __metadata("design:type", Number)
    ], SearchGroupsRequest.prototype, "longitude", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], SearchGroupsRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], SearchGroupsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], SearchGroupsRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=postal_code",
        }),
        __metadata("design:type", String)
    ], SearchGroupsRequest.prototype, "postalCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=region",
        }),
        __metadata("design:type", String)
    ], SearchGroupsRequest.prototype, "region", void 0);
    return SearchGroupsRequest;
}(utils_1.SpeakeasyBase));
exports.SearchGroupsRequest = SearchGroupsRequest;
/**
...
var SearchGroups200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "num_groups" }),
        __metadata("design:type", Number)
...
exports.SearchGroups200ApplicationJSON = SearchGroups200ApplicationJSON;
var SearchGroupsResponse = /** @class */ (function (_super) {
    ...
    ], SearchGroupsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
