...
class Nodes:
    ...
    def add_favorite(self, request: operations.AddFavoriteRequest) -> operations.AddFavoriteResponse:
        r"""Mark a node (room, folder or file) as favorite
        ### Description:  
        ...
        url = utils.generate_url(operations.AddFavoriteRequest, base_url, '/v4/nodes/{node_id}/favorite', request)
        ...
        res = operations.AddFavoriteResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def add_room_guest_users(self, request: operations.AddRoomGuestUsersRequest) -> operations.AddRoomGuestUsersResponse:
        r"""Add guest users to a room
        ### Description:
        ...
        url = utils.generate_url(operations.AddRoomGuestUsersRequest, base_url, '/v4/nodes/rooms/{room_id}/guest_users', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "room_guest_user_add_request", 'json')
        ...
        res = operations.AddRoomGuestUsersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def cancel_file_upload(self, request: operations.CancelFileUploadRequest) -> operations.CancelFileUploadResponse:
        ...
        url = utils.generate_url(operations.CancelFileUploadRequest, base_url, '/v4/nodes/files/uploads/{upload_id}', request)
        ...
        res = operations.CancelFileUploadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 204:
            pass
        elif http_res.status_code in [400, 401, 403, 404, 406, 412, 504]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def change_pending_assignments(self, request: operations.ChangePendingAssignmentsRequest) -> operations.ChangePendingAssignmentsResponse:
        r"""Handle user-room assignments per group
        ### Description:  
        ...
        **WAITING** or **DENIED** assignments can be **ACCEPTED**.
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/rooms/pending'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "pending_assignments_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ChangePendingAssignmentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def complete_file_upload(self, request: operations.CompleteFileUploadRequest) -> operations.CompleteFileUploadResponse:
        ...
        * Illegal characters in names:  
        ...
        url = utils.generate_url(operations.CompleteFileUploadRequest, base_url, '/v4/nodes/files/uploads/{upload_id}', request)
        ...
        res = operations.CompleteFileUploadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code in [201, 202]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.Node])
                res.node = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 409, 412, 507]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def complete_s3_file_upload(self, request: operations.CompleteS3FileUploadRequest) -> operations.CompleteS3FileUploadResponse:
        ...
        url = utils.generate_url(operations.CompleteS3FileUploadRequest, base_url, '/v4/nodes/files/uploads/{upload_id}/s3', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "complete_s3_file_upload_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CompleteS3FileUploadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 202:
            pass
        elif http_res.status_code in [400, 401, 403, 404, 406, 409, 412, 504]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def configure_room(self, request: operations.ConfigureRoomRequest) -> operations.ConfigureRoomResponse:
        r"""Configure room
        ### Description:
        Configure a room.
        ...
        * `PUT /nodes/rooms/{room_id}/users `  
        ...
        url = utils.generate_url(operations.ConfigureRoomRequest, base_url, '/v4/nodes/rooms/{room_id}/config', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "config_room_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ConfigureRoomResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def copy_nodes(self, request: operations.CopyNodesRequest) -> operations.CopyNodesResponse:
        r"""Copy node(s)
        ### Description:
        ...
        * Illegal characters in names:  
        ...
        url = utils.generate_url(operations.CopyNodesRequest, base_url, '/v4/nodes/{node_id}/copy_to', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "copy_nodes_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CopyNodesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        ...
        if http_res.status_code == 201:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                res.copy_nodes_204_application_json_string = http_res.content
        elif http_res.status_code in [400, 401, 403, 404, 406, 409, 412, 507]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def create_and_preserve_room_rescue_key_pair(self, request: operations.CreateAndPreserveRoomRescueKeyPairRequest) -> operations.CreateAndPreserveRoomRescueKeyPairResponse:
        ...
        url = utils.generate_url(operations.CreateAndPreserveRoomRescueKeyPairRequest, base_url, '/v4/nodes/rooms/{room_id}/keypairs', request)
        ...
        res = operations.CreateAndPreserveRoomRescueKeyPairResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def create_file_upload_channel(self, request: operations.CreateFileUploadChannelRequest) -> operations.CreateFileUploadChannelResponse:
        ...
        * Illegal characters in names:  
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/files/uploads'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_file_upload_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateFileUploadChannelResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateFileUploadResponse])
                res.create_file_upload_response = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412, 504, 507]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def create_folder(self, request: operations.CreateFolderRequest) -> operations.CreateFolderResponse:
        ...
        * Illegal characters in names:  
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/folders'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_folder_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def create_node_comment(self, request: operations.CreateNodeCommentRequest) -> operations.CreateNodeCommentResponse:
        r"""Create node comment
        ...
        url = utils.generate_url(operations.CreateNodeCommentRequest, base_url, '/v4/nodes/{node_id}/comments', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_node_comment_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateNodeCommentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def create_room(self, request: operations.CreateRoomRequest) -> operations.CreateRoomResponse:
        ...
        * Illegal characters in names:  
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/rooms'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_room_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def download_zip_archive(self, request: operations.DownloadZipArchiveRequest) -> operations.DownloadZipArchiveResponse:
        r"""Download files / folders as ZIP archive
        ### Description:  
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/zip/download'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "zip_download_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DownloadZipArchiveResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def empty_deleted_nodes(self, request: operations.EmptyDeletedNodesRequest) -> operations.EmptyDeletedNodesResponse:
        r"""Empty recycle bin
        ### Description:  
        Empty a recycle bin.
        ...
        **This action is irreversible.**
        ...
        url = utils.generate_url(operations.EmptyDeletedNodesRequest, base_url, '/v4/nodes/{node_id}/deleted_nodes', request)
        ...
        res = operations.EmptyDeletedNodesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def encrypt_room(self, request: operations.EncryptRoomRequest) -> operations.EncryptRoomResponse:
        r"""Encrypt room
        ### Description:  
        ...
        url = utils.generate_url(operations.EncryptRoomRequest, base_url, '/v4/nodes/rooms/{room_id}/encrypt', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "encrypt_room_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.EncryptRoomResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def generate_download_url(self, request: operations.GenerateDownloadURLRequest) -> operations.GenerateDownloadURLResponse:
        ...
        url = utils.generate_url(operations.GenerateDownloadURLRequest, base_url, '/v4/nodes/files/{file_id}/downloads', request)
        ...
        res = operations.GenerateDownloadURLResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DownloadTokenGenerateResponse])
                res.download_token_generate_response = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def generate_download_url_for_zip_archive(self, request: operations.GenerateDownloadURLForZipArchiveRequest) -> operations.GenerateDownloadURLForZipArchiveResponse:
        r"""Generate download URL for ZIP download
        ### Description:  
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/zip'
        ...
        res = operations.GenerateDownloadURLForZipArchiveResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def generate_presigned_urls_files(self, request: operations.GeneratePresignedUrlsFilesRequest) -> operations.GeneratePresignedUrlsFilesResponse:
        ...
        url = utils.generate_url(operations.GeneratePresignedUrlsFilesRequest, base_url, '/v4/nodes/files/uploads/{upload_id}/s3_urls', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "generate_presigned_urls_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GeneratePresignedUrlsFilesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PresignedURLList])
    ...
    def handle_room_webhook_assignments(self, request: operations.HandleRoomWebhookAssignmentsRequest) -> operations.HandleRoomWebhookAssignmentsResponse:
        r"""Assign or unassign webhooks to room
        ...
        url = utils.generate_url(operations.HandleRoomWebhookAssignmentsRequest, base_url, '/v4/nodes/rooms/{room_id}/webhooks', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_room_webhook_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.HandleRoomWebhookAssignmentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.RoomWebhookList])
                res.room_webhook_list = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def move_nodes(self, request: operations.MoveNodesRequest) -> operations.MoveNodesResponse:
        r"""Move node(s)
        ### Description:  
        ...
        * Illegal characters in names:  
        ...
        url = utils.generate_url(operations.MoveNodesRequest, base_url, '/v4/nodes/{node_id}/move_to', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "move_nodes_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.MoveNodesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                res.move_nodes_204_application_json_string = http_res.content
        elif http_res.status_code in [400, 401, 403, 404, 406, 409, 412, 507]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def remove_deleted_nodes(self, request: operations.RemoveDeletedNodesRequest) -> operations.RemoveDeletedNodesResponse:
        r"""Remove nodes from recycle bin
        ### Description:
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/deleted_nodes'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_deleted_nodes_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RemoveDeletedNodesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_favorite(self, request: operations.RemoveFavoriteRequest) -> operations.RemoveFavoriteResponse:
        r"""Unmark a node (room, folder or file) as favorite
        ### Description:
        ...
        url = utils.generate_url(operations.RemoveFavoriteRequest, base_url, '/v4/nodes/{node_id}/favorite', request)
        ...
        res = operations.RemoveFavoriteResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_node(self, request: operations.RemoveNodeRequest) -> operations.RemoveNodeResponse:
        r"""Remove node
        ### Description:
        ...
        url = utils.generate_url(operations.RemoveNodeRequest, base_url, '/v4/nodes/{node_id}', request)
        ...
        res = operations.RemoveNodeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_node_comment(self, request: operations.RemoveNodeCommentRequest) -> operations.RemoveNodeCommentResponse:
        r"""Remove node comment
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128640; Since v4.10.0</h3>
        ...
        url = utils.generate_url(operations.RemoveNodeCommentRequest, base_url, '/v4/nodes/comments/{comment_id}', request)
        ...
        res = operations.RemoveNodeCommentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_nodes(self, request: operations.RemoveNodesRequest) -> operations.RemoveNodesResponse:
        r"""Remove nodes
        ### Description:
        ...
        url = base_url.removesuffix('/') + '/v4/nodes'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_nodes_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RemoveNodesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_room_rescue_key_pair(self, request: operations.RemoveRoomRescueKeyPairRequest) -> operations.RemoveRoomRescueKeyPairResponse:
        r"""Remove rooms's rescue key pair
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128640; Since v4.24.0</h3>
        ...
        url = utils.generate_url(operations.RemoveRoomRescueKeyPairRequest, base_url, '/v4/nodes/rooms/{room_id}/keypair', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RemoveRoomRescueKeyPairRequest, request)
        ...
        res = operations.RemoveRoomRescueKeyPairResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_deleted_node(self, request: operations.RequestDeletedNodeRequest) -> operations.RequestDeletedNodeResponse:
        r"""Request deleted node
        ### Description:  
        ...
        url = utils.generate_url(operations.RequestDeletedNodeRequest, base_url, '/v4/nodes/deleted_nodes/{deleted_node_id}', request)
        ...
        res = operations.RequestDeletedNodeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeletedNode])
                res.deleted_node = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def request_deleted_node_versions(self, request: operations.RequestDeletedNodeVersionsRequest) -> operations.RequestDeletedNodeVersionsResponse:
        r"""Request deleted versions of nodes
        ### Description:  
        ...
        * type (file, folder).
        ...
        url = utils.generate_url(operations.RequestDeletedNodeVersionsRequest, base_url, '/v4/nodes/{node_id}/deleted_nodes/versions', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestDeletedNodeVersionsRequest, request)
        ...
        res = operations.RequestDeletedNodeVersionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeletedNodeVersionsList])
                res.deleted_node_versions_list = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def request_deleted_nodes_summary(self, request: operations.RequestDeletedNodesSummaryRequest) -> operations.RequestDeletedNodesSummaryResponse:
        r"""Request list of deleted nodes
        ### Description:  
        ...
        url = utils.generate_url(operations.RequestDeletedNodesSummaryRequest, base_url, '/v4/nodes/{node_id}/deleted_nodes', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestDeletedNodesSummaryRequest, request)
        ...
        res = operations.RequestDeletedNodesSummaryResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeletedNodeSummaryList])
                res.deleted_node_summary_list = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def request_file_version_list(self, request: operations.RequestFileVersionListRequest) -> operations.RequestFileVersionListResponse:
        r"""Request list of file versions
        ...
        url = utils.generate_url(operations.RequestFileVersionListRequest, base_url, '/v4/nodes/files/versions/{reference_id}', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestFileVersionListRequest, request)
        ...
        res = operations.RequestFileVersionListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.FileVersionList])
                res.file_version_list = out
        elif http_res.status_code in [401, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def request_list_of_webhooks_for_room(self, request: operations.RequestListOfWebhooksForRoomRequest) -> operations.RequestListOfWebhooksForRoomResponse:
        r"""Request list of webhooks that are assigned or can be assigned to this room
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128640; Since v4.19.0</h3>
        ...
        url = utils.generate_url(operations.RequestListOfWebhooksForRoomRequest, base_url, '/v4/nodes/rooms/{room_id}/webhooks', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestListOfWebhooksForRoomRequest, request)
        ...
        res = operations.RequestListOfWebhooksForRoomResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_missing_file_keys(self, request: operations.RequestMissingFileKeysRequest) -> operations.RequestMissingFileKeysResponse:
        r"""Request files without user's file key
        ### Description:  
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/missingFileKeys'
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestMissingFileKeysRequest, request)
        ...
        res = operations.RequestMissingFileKeysResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.MissingKeysResponse])
                res.missing_keys_response = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def request_node(self, request: operations.RequestNodeRequest) -> operations.RequestNodeResponse:
        r"""Request node
        ### Description:  
        ...
        url = utils.generate_url(operations.RequestNodeRequest, base_url, '/v4/nodes/{node_id}', request)
        ...
        res = operations.RequestNodeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_node_comments(self, request: operations.RequestNodeCommentsRequest) -> operations.RequestNodeCommentsResponse:
        r"""Request list of node comments
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128640; Since v4.10.0</h3>
        ...
        url = utils.generate_url(operations.RequestNodeCommentsRequest, base_url, '/v4/nodes/{node_id}/comments', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestNodeCommentsRequest, request)
        ...
        res = operations.RequestNodeCommentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_node_parents(self, request: operations.RequestNodeParentsRequest) -> operations.RequestNodeParentsResponse:
        r"""Request list of parent nodes
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128640; Since v4.10.0</h3>
        ...
        url = utils.generate_url(operations.RequestNodeParentsRequest, base_url, '/v4/nodes/{node_id}/parents', request)
        ...
        res = operations.RequestNodeParentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.NodeParentList])
                res.node_parent_list = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def request_nodes(self, request: operations.RequestNodesRequest) -> operations.RequestNodesResponse:
        r"""Request list of nodes
        ### Description:  
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestNodesRequest, request)
        ...
        res = operations.RequestNodesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.NodeList])
                res.node_list = out
    ...
    def request_pending_assignments(self, request: operations.RequestPendingAssignmentsRequest) -> operations.RequestPendingAssignmentsResponse:
        r"""Request user-room assignments per group
        ### Description:  
        ...
        **ACCEPTED** assignments are already removed from the list.
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestPendingAssignmentsRequest, request)
        ...
        res = operations.RequestPendingAssignmentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PendingAssignmentList])
                res.pending_assignment_list = out
    ...
    def request_room_activities_log_as_json(self, request: operations.RequestRoomActivitiesLogAsJSONRequest) -> operations.RequestRoomActivitiesLogAsJSONResponse:
        r"""Request events of a room
        ...
        url = utils.generate_url(operations.RequestRoomActivitiesLogAsJSONRequest, base_url, '/v4/nodes/rooms/{room_id}/events', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestRoomActivitiesLogAsJSONRequest, request)
        ...
        res = operations.RequestRoomActivitiesLogAsJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.LogEventList])
    ...
    def request_room_groups(self, request: operations.RequestRoomGroupsRequest) -> operations.RequestRoomGroupsResponse:
        r"""Request room granted group(s) or / and group(s) that can be granted
        ### Description:  
        ...
        url = utils.generate_url(operations.RequestRoomGroupsRequest, base_url, '/v4/nodes/rooms/{room_id}/groups', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestRoomGroupsRequest, request)
        ...
        res = operations.RequestRoomGroupsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.RoomGroupList])
                res.room_group_list = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def request_room_policies(self, request: operations.RequestRoomPoliciesRequest) -> operations.RequestRoomPoliciesResponse:
        r"""Request Room Policies
        ...
        * `defaultExpirationPeriod`
        ...
        url = utils.generate_url(operations.RequestRoomPoliciesRequest, base_url, '/v4/nodes/rooms/{room_id}/policies', request)
        ...
        res = operations.RequestRoomPoliciesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.RoomPolicies])
                res.room_policies = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def request_room_rescue_key(self, request: operations.RequestRoomRescueKeyRequest) -> operations.RequestRoomRescueKeyResponse:
        r"""Request room rescue key
        ...
        url = utils.generate_url(operations.RequestRoomRescueKeyRequest, base_url, '/v4/nodes/files/{file_id}/data_room_file_key', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestRoomRescueKeyRequest, request)
        ...
        res = operations.RequestRoomRescueKeyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.FileKey])
                res.file_key = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
    ...
    def request_room_rescue_key_pair(self, request: operations.RequestRoomRescueKeyPairRequest) -> operations.RequestRoomRescueKeyPairResponse:
        r"""Request room rescue key
        ### Description:  
        ...
        url = utils.generate_url(operations.RequestRoomRescueKeyPairRequest, base_url, '/v4/nodes/rooms/{room_id}/keypair', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestRoomRescueKeyPairRequest, request)
        ...
        res = operations.RequestRoomRescueKeyPairResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_room_rescue_key_pairs(self, request: operations.RequestRoomRescueKeyPairsRequest) -> operations.RequestRoomRescueKeyPairsResponse:
        r"""Request all room rescue key pairs
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128640; Since v4.24.0</h3>
        ...
        url = utils.generate_url(operations.RequestRoomRescueKeyPairsRequest, base_url, '/v4/nodes/rooms/{room_id}/keypairs', request)
        ...
        res = operations.RequestRoomRescueKeyPairsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_room_s3_tags(self, request: operations.RequestRoomS3TagsRequest) -> operations.RequestRoomS3TagsResponse:
        r"""Request list of all assigned S3 tags to the room
        ...
        url = utils.generate_url(operations.RequestRoomS3TagsRequest, base_url, '/v4/nodes/rooms/{room_id}/s3_tags', request)
        ...
        res = operations.RequestRoomS3TagsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_room_users(self, request: operations.RequestRoomUsersRequest) -> operations.RequestRoomUsersResponse:
        r"""Request room granted user(s) or / and user(s) that can be granted
        ### Description:  
        ...
        url = utils.generate_url(operations.RequestRoomUsersRequest, base_url, '/v4/nodes/rooms/{room_id}/users', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestRoomUsersRequest, request)
        ...
        res = operations.RequestRoomUsersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.RoomUserList])
                res.room_user_list = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def request_system_rescue_key(self, request: operations.RequestSystemRescueKeyRequest) -> operations.RequestSystemRescueKeyResponse:
        r"""Request system rescue key
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128679; Deprecated since v4.24.0</h3>
        ...
        url = utils.generate_url(operations.RequestSystemRescueKeyRequest, base_url, '/v4/nodes/files/{file_id}/data_space_file_key', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestSystemRescueKeyRequest, request)
        ...
        res = operations.RequestSystemRescueKeyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_upload_status_files(self, request: operations.RequestUploadStatusFilesRequest) -> operations.RequestUploadStatusFilesResponse:
        ...
        url = utils.generate_url(operations.RequestUploadStatusFilesRequest, base_url, '/v4/nodes/files/uploads/{upload_id}', request)
        ...
        res = operations.RequestUploadStatusFilesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.S3FileUploadStatus])
                res.s3_file_upload_status = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def request_user_file_key(self, request: operations.RequestUserFileKeyRequest) -> operations.RequestUserFileKeyResponse:
        r"""Request user's file key
        ### Description:  
        ...
        url = utils.generate_url(operations.RequestUserFileKeyRequest, base_url, '/v4/nodes/files/{file_id}/user_file_key', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestUserFileKeyRequest, request)
        ...
        res = operations.RequestUserFileKeyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def restore_nodes(self, request: operations.RestoreNodesRequest) -> operations.RestoreNodesResponse:
        r"""Restore deleted nodes
        ### Description:  
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/deleted_nodes/actions/restore'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "restore_deleted_nodes_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RestoreNodesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def revoke_room_groups(self, request: operations.RevokeRoomGroupsRequest) -> operations.RevokeRoomGroupsResponse:
        r"""Revoke granted group(s) from room
        ### Description:  
        ...
        url = utils.generate_url(operations.RevokeRoomGroupsRequest, base_url, '/v4/nodes/rooms/{room_id}/groups', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "room_groups_delete_batch_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RevokeRoomGroupsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def revoke_room_users(self, request: operations.RevokeRoomUsersRequest) -> operations.RevokeRoomUsersResponse:
        r"""Revoke granted user(s) from room
        ### Description:  
        ...
        url = utils.generate_url(operations.RevokeRoomUsersRequest, base_url, '/v4/nodes/rooms/{room_id}/users', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "room_users_delete_batch_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RevokeRoomUsersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def search_nodes(self, request: operations.SearchNodesRequest) -> operations.SearchNodesResponse:
        r"""Search nodes
        ### Description:  
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/search'
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.SearchNodesRequest, request)
        ...
        res = operations.SearchNodesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def set_room_policies(self, request: operations.SetRoomPoliciesRequest) -> operations.SetRoomPoliciesResponse:
        r"""Set room policies
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128640; Since v4.32.0</h3>
        ...
        * `defaultExpirationPeriod`
        ...
        url = utils.generate_url(operations.SetRoomPoliciesRequest, base_url, '/v4/nodes/rooms/{room_id}/policies', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "room_policies_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SetRoomPoliciesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def set_room_rescue_key_pair(self, request: operations.SetRoomRescueKeyPairRequest) -> operations.SetRoomRescueKeyPairResponse:
        r"""Set room's rescue key pair
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128640; Since v4.24.0</h3>
        ...
        url = utils.generate_url(operations.SetRoomRescueKeyPairRequest, base_url, '/v4/nodes/rooms/{room_id}/keypair', request)
        ...
        res = operations.SetRoomRescueKeyPairResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def set_room_s3_tags(self, request: operations.SetRoomS3TagsRequest) -> operations.SetRoomS3TagsResponse:
        r"""Set S3 tags for a room
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128640; Since v4.9.0</h3>
        ...
        url = utils.generate_url(operations.SetRoomS3TagsRequest, base_url, '/v4/nodes/rooms/{room_id}/s3_tags', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "s3_tag_ids", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SetRoomS3TagsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def set_user_file_keys(self, request: operations.SetUserFileKeysRequest) -> operations.SetUserFileKeysResponse:
        r"""Set file keys for a list of users and files
        ### Description:  
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/files/keys'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "user_file_key_set_batch_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SetUserFileKeysResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_favorites(self, request: operations.UpdateFavoritesRequest) -> operations.UpdateFavoritesResponse:
        r"""Mark or unmark a list of nodes (room, folder or file) as favorite
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/favorites'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_favorites_bulk_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateFavoritesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_file(self, request: operations.UpdateFileRequest) -> operations.UpdateFileResponse:
        ...
        url = utils.generate_url(operations.UpdateFileRequest, base_url, '/v4/nodes/files/{file_id}', request)
    ...
    def update_files(self, request: operations.UpdateFilesRequest) -> operations.UpdateFilesResponse:
        r"""Updates a list of  file’s metadata
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128640; Since v4.25.0</h3>
        ...
        url = base_url.removesuffix('/') + '/v4/nodes/files'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_files_bulk_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateFilesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_folder(self, request: operations.UpdateFolderRequest) -> operations.UpdateFolderResponse:
        ...
        * Illegal characters in names:  
        ...
        url = utils.generate_url(operations.UpdateFolderRequest, base_url, '/v4/nodes/folders/{folder_id}', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_folder_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def update_node_comment(self, request: operations.UpdateNodeCommentRequest) -> operations.UpdateNodeCommentResponse:
        r"""Edit node comment
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128640; Since v4.10.0</h3>
        ...
        url = utils.generate_url(operations.UpdateNodeCommentRequest, base_url, '/v4/nodes/comments/{comment_id}', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "change_node_comment_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateNodeCommentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_room(self, request: operations.UpdateRoomRequest) -> operations.UpdateRoomResponse:
        ...
        * Illegal characters in names:  
        ...
        url = utils.generate_url(operations.UpdateRoomRequest, base_url, '/v4/nodes/rooms/{room_id}', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_room_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def update_room_groups(self, request: operations.UpdateRoomGroupsRequest) -> operations.UpdateRoomGroupsResponse:
        r"""Add or change room granted group(s)
        ### Description:
        ...
        url = utils.generate_url(operations.UpdateRoomGroupsRequest, base_url, '/v4/nodes/rooms/{room_id}/groups', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "room_groups_add_batch_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateRoomGroupsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_room_users(self, request: operations.UpdateRoomUsersRequest) -> operations.UpdateRoomUsersResponse:
        r"""Add or change room granted user(s)
        ### Description:
        ...
        url = utils.generate_url(operations.UpdateRoomUsersRequest, base_url, '/v4/nodes/rooms/{room_id}/users', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "room_users_add_batch_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateRoomUsersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def upload_file_as_multipart(self, request: operations.UploadFileAsMultipartRequest) -> operations.UploadFileAsMultipartResponse:
        r"""Upload file
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128679; Deprecated since v4.9.0</h3>
        ...
        * any other `Content-Type`  
        ...
        url = utils.generate_url(operations.UploadFileAsMultipartRequest, base_url, '/v4/nodes/files/uploads/{upload_id}', request)
        ...
        res = operations.UploadFileAsMultipartResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ChunkUploadResponse])
                res.chunk_upload_response = out
        elif http_res.status_code in [400, 401, 403, 404, 406, 412, 507]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
