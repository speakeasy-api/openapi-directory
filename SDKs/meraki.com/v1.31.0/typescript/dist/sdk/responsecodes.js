...
var ResponseCodes = /** @class */ (function () {
    function ResponseCodes(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Tracks organizations' API requests by response code across a given time period
     */
    ResponseCodes.prototype.getOrganizationApiRequestsOverviewResponseCodesByInterval = function (req, config) {
