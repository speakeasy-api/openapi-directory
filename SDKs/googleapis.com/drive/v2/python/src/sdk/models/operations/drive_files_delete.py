...
class DriveFilesDeleteRequest:
    path_params: DriveFilesDeletePathParams = dataclasses.field()
    query_params: DriveFilesDeleteQueryParams = dataclasses.field()
    security: DriveFilesDeleteSecurity = dataclasses.field()
