...
class OBWriteInternationalStandingOrderConsentResponse7DataInitiation
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderConsentResponse7DataInitiationCreditor $creditor
     */
	#[\JMS\Serializer\Annotation\SerializedName('Creditor')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderConsentResponse7DataInitiationCreditor')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteInternationalStandingOrderConsentResponse7DataInitiationCreditor $creditor = null;
    
    /**
     * Provides the details to identify the beneficiary account.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderConsentResponse7DataInitiationCreditorAccount $creditorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('CreditorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderConsentResponse7DataInitiationCreditorAccount')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderConsentResponse7DataInitiationCreditorAgent $creditorAgent
     */
	#[\JMS\Serializer\Annotation\SerializedName('CreditorAgent')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderConsentResponse7DataInitiationCreditorAgent')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteInternationalStandingOrderConsentResponse7DataInitiationCreditorAgent $creditorAgent = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderConsentResponse7DataInitiationDebtorAccount $debtorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('DebtorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderConsentResponse7DataInitiationDebtorAccount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteInternationalStandingOrderConsentResponse7DataInitiationDebtorAccount $debtorAccount = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderConsentResponse7DataInitiationInstructedAmount $instructedAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('InstructedAmount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderConsentResponse7DataInitiationInstructedAmount')]
	...
	public function __construct()
	{
		...
		$this->creditor = null;
		$this->creditorAccount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderConsentResponse7DataInitiationCreditorAccount();
		...
		$this->frequency = "";
		$this->instructedAmount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderConsentResponse7DataInitiationInstructedAmount();
