...
func (e ListStudioSessionMappingsXAmzTargetEnum) ToPointer() *ListStudioSessionMappingsXAmzTargetEnum {
	return &e
}
...
func (e *ListStudioSessionMappingsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "ElasticMapReduce.ListStudioSessionMappings":
		*e = ListStudioSessionMappingsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListStudioSessionMappingsXAmzTargetEnum: %v", v)
	}
}
