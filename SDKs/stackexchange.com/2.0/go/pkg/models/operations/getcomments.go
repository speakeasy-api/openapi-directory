...
func (e GetCommentsOrderEnum) ToPointer() *GetCommentsOrderEnum {
	return &e
}

func (e *GetCommentsOrderEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "desc":
		fallthrough
	case "asc":
		*e = GetCommentsOrderEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCommentsOrderEnum: %v", v)
	}
}
...
func (e GetCommentsSortEnum) ToPointer() *GetCommentsSortEnum {
	return &e
}

func (e *GetCommentsSortEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "creation":
		fallthrough
	case "votes":
		*e = GetCommentsSortEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCommentsSortEnum: %v", v)
	}
}
