...
from ..shared import createfleetrequest as shared_createfleetrequest
from ..shared import createfleetresult as shared_createfleetresult
...
class CreateFleetRequest:
    ...
    request: shared_createfleetrequest.CreateFleetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateFleetResponse:
    ...
    create_fleet_result: Optional[shared_createfleetresult.CreateFleetResult] = dataclasses.field(default=None)
