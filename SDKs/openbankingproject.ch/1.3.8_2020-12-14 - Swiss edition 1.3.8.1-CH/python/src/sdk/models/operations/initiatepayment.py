...
from ..shared import paymentinitiation_json as shared_paymentinitiation_json
from ..shared import periodicpaymentinitiation_json as shared_periodicpaymentinitiation_json
from ..shared import bulkpaymentinitiation_json as shared_bulkpaymentinitiation_json
from ..shared import periodicpaymentinitiationmultipartbody as shared_periodicpaymentinitiationmultipartbody
...
class InitiatePaymentRequests:
    ...
    periodic_payment_initiation_multipart_body: Optional[shared_periodicpaymentinitiationmultipartbody.PeriodicPaymentInitiationMultipartBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})
...
class InitiatePaymentRequest:
    headers: InitiatePaymentHeaders = dataclasses.field()
    path_params: InitiatePaymentPathParams = dataclasses.field()
    request: InitiatePaymentRequests = dataclasses.field()
    security: InitiatePaymentSecurity = dataclasses.field()
