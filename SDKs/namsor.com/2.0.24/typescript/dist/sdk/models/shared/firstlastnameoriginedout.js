 ...
 */
var FirstLastNameOriginedOut = /** @class */ (function (_super) {
    __extends(FirstLastNameOriginedOut, _super);
    function FirstLastNameOriginedOut() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "countriesOriginTop" }),
        __metadata("design:type", Array)
    ], FirstLastNameOriginedOut.prototype, "countriesOriginTop", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "countryOrigin" }),
        __metadata("design:type", String)
    ], FirstLastNameOriginedOut.prototype, "countryOrigin", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "countryOriginAlt" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "regionOrigin" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subRegionOrigin" }),
        __metadata("design:type", String)
    ], FirstLastNameOriginedOut.prototype, "subRegionOrigin", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "topRegionOrigin" }),
        __metadata("design:type", String)
