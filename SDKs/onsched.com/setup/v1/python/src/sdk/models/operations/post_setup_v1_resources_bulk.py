...
from ..shared import resourcesinputmodel as shared_resourcesinputmodel
...
class PostSetupV1ResourcesBulkRequest:
    ...
    resources_input_model: Optional[shared_resourcesinputmodel.ResourcesInputModel] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
