...
exports.PlaceSingleBetResponse = exports.PlaceSingleBetRequest = void 0;
...
var PlaceSingleBetRequest = /** @class */ (function (_super) {
    ...
    ], PlaceSingleBetRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=apiSecret",
        }),
        __metadata("design:type", String)
    ], PlaceSingleBetRequest.prototype, "apiSecret", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=apiTicket",
        }),
        __metadata("design:type", String)
    ], PlaceSingleBetRequest.prototype, "apiTicket", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=exclude",
        }),
        __metadata("design:type", Array)
    ], PlaceSingleBetRequest.prototype, "exclude", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=fields",
        }),
        __metadata("design:type", Array)
    ], PlaceSingleBetRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=include",
        }),
        __metadata("design:type", Array)
    ], PlaceSingleBetRequest.prototype, "include", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=application/json" }),
        __metadata("design:type", shared.SingleBetRequestBody)
    ], PlaceSingleBetRequest.prototype, "singleBetRequestBody", void 0);
...
var PlaceSingleBetResponse = /** @class */ (function (_super) {
    ...
    ], PlaceSingleBetResponse.prototype, "rawResponse", void 0);
    __decorate([
