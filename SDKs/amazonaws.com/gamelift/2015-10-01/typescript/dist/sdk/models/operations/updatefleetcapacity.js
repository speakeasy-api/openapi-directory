...
exports.UpdateFleetCapacityResponse = exports.UpdateFleetCapacityRequest = exports.UpdateFleetCapacityXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var UpdateFleetCapacityXAmzTargetEnum;
...
})(UpdateFleetCapacityXAmzTargetEnum = exports.UpdateFleetCapacityXAmzTargetEnum || (exports.UpdateFleetCapacityXAmzTargetEnum = {}));
var UpdateFleetCapacityRequest = /** @class */ (function (_super) {
    ...
    ], UpdateFleetCapacityRequest.prototype, "updateFleetCapacityInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], UpdateFleetCapacityRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], UpdateFleetCapacityRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], UpdateFleetCapacityRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], UpdateFleetCapacityRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], UpdateFleetCapacityRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], UpdateFleetCapacityRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], UpdateFleetCapacityRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], UpdateFleetCapacityRequest.prototype, "xAmzTarget", void 0);
    return UpdateFleetCapacityRequest;
}(utils_1.SpeakeasyBase));
exports.UpdateFleetCapacityRequest = UpdateFleetCapacityRequest;
var UpdateFleetCapacityResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], UpdateFleetCapacityResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], UpdateFleetCapacityResponse.prototype, "unsupportedRegionException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.UpdateFleetCapacityResponse = UpdateFleetCapacityResponse;
