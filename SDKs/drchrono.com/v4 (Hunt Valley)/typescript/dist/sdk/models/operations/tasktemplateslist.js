...
exports.TaskTemplatesListResponse = exports.TaskTemplatesList200ApplicationJSON = exports.TaskTemplatesListRequest = exports.TaskTemplatesListSecurity = void 0;
...
var TaskTemplatesListRequest = /** @class */ (function (_super) {
    ...
    ], TaskTemplatesListRequest.prototype, "assigneeGroup", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=assignee_user",
        }),
        __metadata("design:type", Number)
    ], TaskTemplatesListRequest.prototype, "assigneeUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=category",
        }),
        __metadata("design:type", Number)
    ], TaskTemplatesListRequest.prototype, "category", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=cursor",
        }),
        __metadata("design:type", String)
    ], TaskTemplatesListRequest.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], TaskTemplatesListRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=since" }),
        __metadata("design:type", String)
    ], TaskTemplatesListRequest.prototype, "since", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", Number)
    ], TaskTemplatesListRequest.prototype, "status", void 0);
...
var TaskTemplatesList200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.TaskTemplate }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return shared.TaskTemplate; }),
...
var TaskTemplatesListResponse = /** @class */ (function (_super) {
    ...
    ], TaskTemplatesListResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
