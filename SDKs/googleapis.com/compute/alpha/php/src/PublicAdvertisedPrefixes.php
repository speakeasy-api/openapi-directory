...
class PublicAdvertisedPrefixes 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesAnnounceRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesAnnounceSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesAnnounceResponse
     */
	public function computePublicAdvertisedPrefixesAnnounce(
        \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesAnnounceRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesAnnounceSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesAnnounceResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/publicAdvertisedPrefixes/{publicAdvertisedPrefix}/announce', \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesAnnounceRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesAnnounceRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesAnnounceResponse();
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesWithdrawRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesWithdrawSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesWithdrawResponse
     */
	public function computePublicAdvertisedPrefixesWithdraw(
        \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesWithdrawRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesWithdrawSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesWithdrawResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/publicAdvertisedPrefixes/{publicAdvertisedPrefix}/withdraw', \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesWithdrawRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesWithdrawRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputePublicAdvertisedPrefixesWithdrawResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
