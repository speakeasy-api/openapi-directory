...
from ..shared import listrefundsresponse as shared_listrefundsresponse
...
class GetV2LocationsLocationIDRefundsResponse:
    ...
    list_refunds_response: Optional[shared_listrefundsresponse.ListRefundsResponse] = dataclasses.field(default=None)
    r"""Success"""  
