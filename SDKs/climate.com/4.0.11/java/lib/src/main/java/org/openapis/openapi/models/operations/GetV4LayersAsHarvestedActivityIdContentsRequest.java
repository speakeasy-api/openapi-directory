...
public class GetV4LayersAsHarvestedActivityIdContentsRequest {
    ...
    public GetV4LayersAsHarvestedActivityIdContentsRequest(@JsonProperty("Accept") String accept, @JsonProperty("Range") String range, @JsonProperty("activityId") String activityId) {
        this.accept = accept;
        this.range = range;
        this.activityId = activityId;
  }
