...
from ..shared import security as shared_security
from ..shared import listlineitemassignedtargetingoptionsresponse as shared_listlineitemassignedtargetingoptionsresponse

class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum(str, Enum):
...
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListPathParams:
    ...
    targeting_type: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListQueryParams:
...
@dataclasses.dataclass
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListSecurity:
...
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListRequest:
    path_params: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListSecurity = dataclasses.field()
    

@dataclasses.dataclass
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    list_line_item_assigned_targeting_options_response: Optional[shared_listlineitemassignedtargetingoptionsresponse.ListLineItemAssignedTargetingOptionsResponse] = dataclasses.field(default=None)
