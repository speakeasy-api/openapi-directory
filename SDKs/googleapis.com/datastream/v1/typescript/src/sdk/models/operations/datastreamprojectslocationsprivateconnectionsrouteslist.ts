...
export class DatastreamProjectsLocationsPrivateConnectionsRoutesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatastreamProjectsLocationsPrivateConnectionsRoutesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatastreamProjectsLocationsPrivateConnectionsRoutesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
