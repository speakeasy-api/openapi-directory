...
class DescribeAuditSuppressionRequestBody:
    ...
    resource_identifier: DescribeAuditSuppressionRequestBodyResourceIdentifier = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resourceIdentifier') }})
    r"""Information that identifies the noncompliant resource."""  
...
class DescribeAuditSuppressionRequest:
    ...
    request_body: DescribeAuditSuppressionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
