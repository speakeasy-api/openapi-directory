...
class CreateRestoreImageTaskRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateRestoreImageTaskRequestTagSpecifications:
    ...
    resource_type: Optional[CreateRestoreImageTaskRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateRestoreImageTaskRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateRestoreImageTaskRequest:
    ...
    object_key: str = dataclasses.field()  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    name: Optional[str] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateRestoreImageTaskRequestTagSpecifications]] = dataclasses.field(default=None)  
