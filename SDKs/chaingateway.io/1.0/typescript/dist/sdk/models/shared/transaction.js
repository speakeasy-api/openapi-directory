...
var Transaction = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=block_number" }),
        __metadata("design:type", String)
    ], Transaction.prototype, "blockNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=contract_address" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=gas" }),
        __metadata("design:type", String)
    ], Transaction.prototype, "gas", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=gas_price" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=token_decimals" }),
        __metadata("design:type", String)
    ], Transaction.prototype, "tokenDecimals", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=token_name" }),
        __metadata("design:type", String)
    ], Transaction.prototype, "tokenName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=token_supply" }),
        __metadata("design:type", String)
    ], Transaction.prototype, "tokenSupply", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=token_symbol" }),
        __metadata("design:type", String)
