...
class UpdateStackRequest:
    ...
    attributes_to_delete: Optional[list[shared_stackattribute_enum.StackAttributeEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AttributesToDelete'), 'exclude': lambda f: f is None }})  
    delete_storage_connectors: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DeleteStorageConnectors'), 'exclude': lambda f: f is None }})  
