...
var FirewallActions = /** @class */ (function () {
    ...
    **/
    FirewallActions.prototype.getFirewallsIdActions = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/firewalls/{id}/actions", req.pathParams);
    ...
    **/
    FirewallActions.prototype.getFirewallsIdActionsActionId = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/firewalls/{id}/actions/{action_id}", req.pathParams);
        var client = this._defaultClient;
    ...
    **/
    FirewallActions.prototype.postFirewallsIdActionsApplyToResources = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/firewalls/{id}/actions/apply_to_resources", req.pathParams);
    ...
    **/
    FirewallActions.prototype.postFirewallsIdActionsRemoveFromResources = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/firewalls/{id}/actions/remove_from_resources", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    FirewallActions.prototype.postFirewallsIdActionsSetRules = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/firewalls/{id}/actions/set_rules", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
