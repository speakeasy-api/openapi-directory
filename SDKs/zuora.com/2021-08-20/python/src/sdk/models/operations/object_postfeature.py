...
class ObjectPostFeatureQueryParams:
...
@dataclasses.dataclass
class ObjectPostFeatureHeaders:
...
class ObjectPostFeatureRequest:
    headers: ObjectPostFeatureHeaders = dataclasses.field()
    query_params: ObjectPostFeatureQueryParams = dataclasses.field()
