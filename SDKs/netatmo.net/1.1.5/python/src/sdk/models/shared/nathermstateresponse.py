...
import dataclasses
from ..shared import nathermstatebody as shared_nathermstatebody
...
class NAThermStateResponse:
    ...
    body: Optional[shared_nathermstatebody.NAThermStateBody] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('body'), 'exclude': lambda f: f is None }})  
