...
class GoogleCloudRetailV2SearchRequestBoostSpec:
    ...
    condition_boost_specs: Optional[list[shared_googlecloudretailv2searchrequestboostspecconditionboostspec.GoogleCloudRetailV2SearchRequestBoostSpecConditionBoostSpec]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conditionBoostSpecs'), 'exclude': lambda f: f is None }})
