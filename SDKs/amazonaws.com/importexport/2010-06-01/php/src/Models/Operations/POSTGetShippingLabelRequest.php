...
class POSTGetShippingLabelRequest
{
	...
	{
		$this->awsAccessKeyId = "";
		$this->action = \OpenAPI\OpenAPI\Models\Operations\POSTGetShippingLabelActionEnum::GET_SHIPPING_LABEL;
		$this->operation = \OpenAPI\OpenAPI\Models\Operations\POSTGetShippingLabelOperationEnum::GET_SHIPPING_LABEL;
		$this->requestBody = null;
		$this->signature = "";
		$this->signatureMethod = "";
		$this->signatureVersion = "";
		$this->timestamp = "";
		$this->version = \OpenAPI\OpenAPI\Models\Operations\POSTGetShippingLabelVersionEnum::TWO_THOUSAND_AND_TEN0601;
	}
}
