...
* [nbcer](#nbcer) - NAC/Birth/Death Certificate
...
use \OpenAPI\OpenAPI\Models\Operations\NbcerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\NbcerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\NbcerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\NbcerSecurity;
...
try {
    ...
    $request->certificateParameters = new NbcerRequestBodyCertificateParameters();
    $request->certificateParameters->refNo = 'SRHR/2017/231234';
    $request->certificateParameters->tokenNo = '2912337nNn123 or date of issue in dd/mm/yyyy format if token number is less than 8 chars';
    ...
    $request->format = NbcerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new NbcerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->nbcer($request, $requestSecurity);
