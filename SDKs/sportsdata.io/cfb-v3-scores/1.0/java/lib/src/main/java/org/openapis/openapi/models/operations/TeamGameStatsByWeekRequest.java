...
public class TeamGameStatsByWeekRequest {
    ...
    public TeamGameStatsByWeekRequest(@JsonProperty("format") TeamGameStatsByWeekFormatEnum format, @JsonProperty("season") String season, @JsonProperty("week") String week) {
        this.format = format;
        this.season = season;
        this.week = week;
  }
