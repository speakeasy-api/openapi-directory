...
exports.ByDevice = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var ByDevice = /** @class */ (function () {
    function ByDevice(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return the devices that have a Dynamic ARP Inspection warning and their warnings
     */
    ByDevice.prototype.getNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDevice = function (req, config) {
     ...
     */
    ByDevice.prototype.getOrganizationDevicesPowerModulesStatusesByDevice = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
     ...
     * List the current uplink addresses for devices in an organization.
     */
    ByDevice.prototype.getOrganizationDevicesUplinksAddressesByDevice = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
     ...
     * Get firmware upgrade status for the filtered devices
     */
    ByDevice.prototype.getOrganizationFirmwareUpgradesByDevice = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
