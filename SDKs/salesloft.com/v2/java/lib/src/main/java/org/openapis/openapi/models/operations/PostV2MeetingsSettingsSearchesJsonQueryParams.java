...
public class PostV2MeetingsSettingsSearchesJsonQueryParams {
    /**
     * Filters meeting settings by calendar type
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=calendar_type")
    public String calendarType;
    public PostV2MeetingsSettingsSearchesJsonQueryParams withCalendarType(String calendarType) {
    ...
    public PostV2MeetingsSettingsSearchesJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public PostV2MeetingsSettingsSearchesJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public Long page;
    public PostV2MeetingsSettingsSearchesJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public PostV2MeetingsSettingsSearchesJsonQueryParams withPerPage(Long perPage) {
    ...
    public PostV2MeetingsSettingsSearchesJsonQueryParams withUpdatedAt(String[] updatedAt) {
    ...
    public PostV2MeetingsSettingsSearchesJsonQueryParams withUserGuids(String[] userGuids) {
