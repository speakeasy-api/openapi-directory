...
class StopBulkDeploymentRequest:
    headers: StopBulkDeploymentHeaders = dataclasses.field()
    path_params: StopBulkDeploymentPathParams = dataclasses.field()
...
class StopBulkDeploymentResponse:
    ...
    stop_bulk_deployment_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
