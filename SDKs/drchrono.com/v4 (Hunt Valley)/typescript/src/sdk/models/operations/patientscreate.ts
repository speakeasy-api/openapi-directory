...
export class PatientsCreateQueryParams extends SpeakeasyBase {
...
export class PatientsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" })
  drchronoOauth2: shared.SchemeDrchronoOauth2;
}


export class PatientsCreateRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class PatientsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
