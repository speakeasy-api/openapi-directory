...
var Incidents = /** @class */ (function () {
    ...
    Incidents.prototype.getVersionIncidentsFormat = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GETVersionIncidentsFormatResponse({
    ...
    Incidents.prototype.getVersionIncidentsIdFormat = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2/incidents/{id}", req);
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GETVersionIncidentsIdFormatResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
