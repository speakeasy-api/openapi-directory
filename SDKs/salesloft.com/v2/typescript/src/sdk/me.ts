...
export class Me {
  ...
  getV2MeJson(
  ...
  ): Promise<operations.GetV2MeJsonResponse> {
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v2/me.json";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetV2MeJsonResponse =
        new operations.GetV2MeJsonResponse({
