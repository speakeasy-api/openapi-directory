...
func main() {
    ...
    res, err := s.SDK.GetLatestConfiguration(ctx, operations.GetLatestConfigurationRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.StartConfigurationSession(ctx, operations.StartConfigurationSessionRequest{
        RequestBody: operations.StartConfigurationSessionRequestBody{
            ApplicationIdentifier: "delectus",
            ConfigurationProfileIdentifier: "tempora",
            EnvironmentIdentifier: "suscipit",
            RequiredMinimumPollIntervalInSeconds: sdk.Int64(477665),
        },
    ...
    if res.StartConfigurationSessionResponse != nil {
        // handle response
    }
}
```
