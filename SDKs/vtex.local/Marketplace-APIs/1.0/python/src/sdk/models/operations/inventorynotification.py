...
class InventoryNotificationRequest:
    ...
    r"""A string that identifies the SKU in the seller, that suffered the change. This is the ID that the marketplace will use for all  references to this SKU, such as price and inventory notifications."""  
    

@dataclasses.dataclass
class InventoryNotificationResponse:
