 ...
 */
public class CreateNetworkWirelessRfProfileRequestBodyTransmission {
    /**
    ...
    public CreateNetworkWirelessRfProfileRequestBodyTransmission withEnabled(Boolean enabled) {
