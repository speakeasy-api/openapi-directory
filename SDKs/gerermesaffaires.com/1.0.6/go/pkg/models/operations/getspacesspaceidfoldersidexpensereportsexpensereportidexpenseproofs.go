...
func (e GetSpacesSpaceIDFoldersIDExpenseReportsExpenseReportIDExpenseProofsStatusEnum) ToPointer() *GetSpacesSpaceIDFoldersIDExpenseReportsExpenseReportIDExpenseProofsStatusEnum {
	return &e
}
...
func (e *GetSpacesSpaceIDFoldersIDExpenseReportsExpenseReportIDExpenseProofsStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "W":
		fallthrough
	case "V":
		*e = GetSpacesSpaceIDFoldersIDExpenseReportsExpenseReportIDExpenseProofsStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSpacesSpaceIDFoldersIDExpenseReportsExpenseReportIDExpenseProofsStatusEnum: %v", v)
	}
}
