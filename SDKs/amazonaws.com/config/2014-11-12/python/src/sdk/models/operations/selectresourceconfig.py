...
class SelectResourceConfigRequest:
    ...
    select_resource_config_request: shared_selectresourceconfigrequest.SelectResourceConfigRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
