...
class DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDVoteRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDVotePathParams = dataclasses.field()
    security: DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDVoteSecurity = dataclasses.field()
