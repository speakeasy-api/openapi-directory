...
public class GETCreditMemoItemPartsRequest {
    ...
    public GETCreditMemoItemPartsRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETCreditMemoItemPartsRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETCreditMemoItemPartsRequest withCreditMemoId(String creditMemoId) {
    ...
    public GETCreditMemoItemPartsRequest withPageSize(Long pageSize) {
    ...
    public GETCreditMemoItemPartsRequest withPartid(String partid) {
        this.partid = partid;
        return this;
    }
