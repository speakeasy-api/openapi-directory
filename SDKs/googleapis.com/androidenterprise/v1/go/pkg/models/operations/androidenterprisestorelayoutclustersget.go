...
type AndroidenterpriseStorelayoutclustersGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseStorelayoutclustersGetPathParams struct {
...
type AndroidenterpriseStorelayoutclustersGetQueryParams struct {
	// V1 error format.
...
type AndroidenterpriseStorelayoutclustersGetRequest struct {
...
type AndroidenterpriseStorelayoutclustersGetResponse struct {
	ContentType string
	StatusCode  int
