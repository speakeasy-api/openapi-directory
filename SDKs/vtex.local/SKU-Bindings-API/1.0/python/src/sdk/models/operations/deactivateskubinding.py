...
class DeactivateSKUBindingRequest:
    ...
    sku_seller_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'skuSellerId', 'style': 'simple', 'explode': False }})
    r"""SKU ID in the seller's store."""  
    

@dataclasses.dataclass
class DeactivateSKUBindingResponse:
