 ...
 */
export declare enum InstanceGroupManagerResizeRequestsListResponseWarningCodeEnum {
...
export declare class InstanceGroupManagerResizeRequestsListResponseWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InstanceGroupManagerResizeRequestsListResponseWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class InstanceGroupManagerResizeRequestsListResponse extends SpeakeasyBase {
    /**
