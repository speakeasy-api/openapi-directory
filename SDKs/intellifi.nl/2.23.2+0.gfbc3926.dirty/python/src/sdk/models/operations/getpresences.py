...
class GetPresencesRequest:
    ...
    item: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'item', 'style': 'form', 'explode': True }})
    r"""Filter based on the item"""  
    ...
    proximity: Optional[shared_proximity_enum.ProximityEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'proximity', 'style': 'form', 'explode': True }})
    r"""Filter based on the proximity."""  
...
class GetPresences200ApplicationJSON:
    r"""A JSON object containing a list of presences"""
    ...
    results: Optional[list[shared_presence.Presence]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
...
class GetPresencesResponse:
    ...
    get_presences_200_application_json_object: Optional[GetPresences200ApplicationJSON] = dataclasses.field(default=None)
    r"""A JSON object containing a list of presences"""  
