...
class PostSubscriptionCancellationType:
    cancellation_policy: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('cancellationPolicy') }})
    invoice_collect: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('invoiceCollect') }})
