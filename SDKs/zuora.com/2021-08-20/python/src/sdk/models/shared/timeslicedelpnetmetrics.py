...
class TimeSlicedElpNetMetrics:
    ...
    generated_reason: Optional[TimeSlicedElpNetMetricsGeneratedReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('generatedReason') }})
    ...
    type: Optional[TimeSlicedElpNetMetricsTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
