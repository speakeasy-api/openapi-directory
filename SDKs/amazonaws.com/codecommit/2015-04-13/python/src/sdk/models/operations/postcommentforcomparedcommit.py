...
class PostCommentForComparedCommitRequest:
    headers: PostCommentForComparedCommitHeaders = dataclasses.field()
    request: shared_postcommentforcomparedcommitinput.PostCommentForComparedCommitInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
