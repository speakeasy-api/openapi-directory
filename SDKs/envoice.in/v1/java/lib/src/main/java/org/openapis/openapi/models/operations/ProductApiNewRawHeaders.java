...
public class ProductApiNewRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ProductApiNewRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public ProductApiNewRawHeaders withXAuthSecret(String xAuthSecret) {
