...
class SearchTypeUsgsGaugeQueryParams:
...
@dataclasses.dataclass
class SearchTypeUsgsGaugeRequest:
    query_params: SearchTypeUsgsGaugeQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeUsgsGaugeResponse:
