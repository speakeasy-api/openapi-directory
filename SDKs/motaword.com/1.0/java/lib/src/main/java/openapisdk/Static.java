...
public class Static {
     ...
     * 
    **/
    public openapisdk.models.operations.GetEndpointsResponse getEndpoints() throws Exception {
        ...
        openapisdk.models.operations.GetEndpointsResponse res = new openapisdk.models.operations.GetEndpointsResponse() {{
     ...
     * 
    **/
    public openapisdk.models.operations.GetFormatsResponse getFormats() throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/formats");
        ...
        openapisdk.models.operations.GetFormatsResponse res = new openapisdk.models.operations.GetFormatsResponse() {{
    ...
    **/
    public openapisdk.models.operations.GetLanguagesResponse getLanguages() throws Exception {
        String baseUrl = this._serverUrl;
     ...
     * Get Swagger JSON
    **/
    public openapisdk.models.operations.GetSwaggerJsonResponse getSwaggerJson() throws Exception {
        String baseUrl = this._serverUrl;
        ...
        openapisdk.models.operations.GetSwaggerJsonResponse res = new openapisdk.models.operations.GetSwaggerJsonResponse() {{
            getSwaggerJSON200ApplicationJSONObject = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
