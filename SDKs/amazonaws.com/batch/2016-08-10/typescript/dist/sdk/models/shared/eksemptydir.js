 ...
 */
var EksEmptyDir = /** @class */ (function (_super) {
    __extends(EksEmptyDir, _super);
    function EksEmptyDir() {
    ...
    ], EksEmptyDir.prototype, "medium", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "sizeLimit" }),
        __metadata("design:type", String)
    ], EksEmptyDir.prototype, "sizeLimit", void 0);
    return EksEmptyDir;
