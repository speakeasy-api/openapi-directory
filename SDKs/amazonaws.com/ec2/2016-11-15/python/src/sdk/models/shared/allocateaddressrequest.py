...
class AllocateAddressRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class AllocateAddressRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class AllocateAddressRequestTagSpecifications:
    ...
    resource_type: Optional[AllocateAddressRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[AllocateAddressRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class AllocateAddressRequest:
    ...
    domain: Optional[shared_domaintype_enum.DomainTypeEnum] = dataclasses.field(default=None)  
    ...
    tag_specifications: Optional[list[AllocateAddressRequestTagSpecifications]] = dataclasses.field(default=None)  
