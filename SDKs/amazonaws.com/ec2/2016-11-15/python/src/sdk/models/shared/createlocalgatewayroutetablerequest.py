...
import dataclasses
from ..shared import localgatewayroutetablemode_enum as shared_localgatewayroutetablemode_enum
from enum import Enum
from typing import Optional

class CreateLocalGatewayRouteTableRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateLocalGatewayRouteTableRequestTagSpecifications:
    ...
    resource_type: Optional[CreateLocalGatewayRouteTableRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateLocalGatewayRouteTableRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateLocalGatewayRouteTableRequest:
    
    local_gateway_id: str = dataclasses.field()  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    mode: Optional[shared_localgatewayroutetablemode_enum.LocalGatewayRouteTableModeEnum] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateLocalGatewayRouteTableRequestTagSpecifications]] = dataclasses.field(default=None)  
