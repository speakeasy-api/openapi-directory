...
class ContactcenterinsightsProjectsLocationsViewsDeleteRequest:
    path_params: ContactcenterinsightsProjectsLocationsViewsDeletePathParams = dataclasses.field()
    query_params: ContactcenterinsightsProjectsLocationsViewsDeleteQueryParams = dataclasses.field()
    security: ContactcenterinsightsProjectsLocationsViewsDeleteSecurity = dataclasses.field()
