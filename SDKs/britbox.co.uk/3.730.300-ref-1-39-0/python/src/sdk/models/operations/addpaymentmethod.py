...
from ..shared import addpaymentmethodrequest as shared_addpaymentmethodrequest
...
class AddPaymentMethodRequest:
    ...
    add_payment_method_request: shared_addpaymentmethodrequest.AddPaymentMethodRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
