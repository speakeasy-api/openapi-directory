...
public class ConnectorDocs {
	...
	public ConnectorDocs(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.ConnectorDocsOneResponse connectorDocsOne(org.openapis.openapi.models.operations.ConnectorDocsOneRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.ConnectorDocsOneResponse res = new org.openapis.openapi.models.operations.ConnectorDocsOneResponse() {{
            connectorDocsOne200TextMarkdownMarkdownString = null;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "text/markdown")) {
