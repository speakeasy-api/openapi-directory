...
type RecommenderProjectsLocationsRecommendersRecommendationsMarkSucceededRequest struct {
	...
	GoogleCloudRecommenderV1beta1MarkRecommendationSucceededRequest *shared.GoogleCloudRecommenderV1beta1MarkRecommendationSucceededRequest `request:"mediaType=application/json"`
	// OAuth access token.
