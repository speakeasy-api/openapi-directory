...
exports.LinksCatalogIndexLink = void 0;
...
var LinksCatalogIndexLink = /** @class */ (function (_super) {
    __extends(LinksCatalogIndexLink, _super);
    function LinksCatalogIndexLink() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=allOptionalParamsProvided" }),
        __metadata("design:type", Boolean)
    ], LinksCatalogIndexLink.prototype, "allOptionalParamsProvided", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=allRequiredParamsProvided" }),
        __metadata("design:type", Boolean)
    ], LinksCatalogIndexLink.prototype, "allRequiredParamsProvided", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=description" }),
        __metadata("design:type", String)
    ], LinksCatalogIndexLink.prototype, "description", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=docUrl" }),
        __metadata("design:type", String)
    ], LinksCatalogIndexLink.prototype, "docUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=href" }),
        __metadata("design:type", String)
    ], LinksCatalogIndexLink.prototype, "href", void 0);
    __decorate([
    ...
    ], LinksCatalogIndexLink.prototype, "info", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=label" }),
        __metadata("design:type", String)
    ], LinksCatalogIndexLink.prototype, "label", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=method" }),
        __metadata("design:type", String)
    ], LinksCatalogIndexLink.prototype, "method", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=operationId" }),
        __metadata("design:type", String)
    ], LinksCatalogIndexLink.prototype, "operationId", void 0);
    __decorate([
    ...
    ], LinksCatalogIndexLink.prototype, "parameters", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=urlTemplated" }),
        __metadata("design:type", Boolean)
    ], LinksCatalogIndexLink.prototype, "urlTemplated", void 0);
    return LinksCatalogIndexLink;
}(utils_1.SpeakeasyBase));
exports.LinksCatalogIndexLink = LinksCatalogIndexLink;
