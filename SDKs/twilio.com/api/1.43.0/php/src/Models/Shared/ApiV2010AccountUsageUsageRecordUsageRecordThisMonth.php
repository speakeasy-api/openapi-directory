...
class ApiV2010AccountUsageUsageRecordUsageRecordThisMonth
{
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UsageRecordThisMonthEnumCategoryEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UsageRecordThisMonthEnumCategoryEnum $category = null;
