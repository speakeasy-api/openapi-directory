...
class GetIntegrationResponseResponseContentHandlingStrategyEnum(str, Enum):
...
class GetIntegrationResponseResponse:
    ...
    content_handling_strategy: Optional[GetIntegrationResponseResponseContentHandlingStrategyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ContentHandlingStrategy'), 'exclude': lambda f: f is None }})  
