...
try {
    ...
    $request->requestBody->startSelector->afterFragmentNumber = 'debitis';
    $request->requestBody->startSelector->continuationToken = 'ipsa';
    $request->requestBody->startSelector->startSelectorType = StartSelectorTypeEnum::CONTINUATION_TOKEN;
    $request->requestBody->startSelector->startTimestamp = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-08-14T01:03:07.567Z');
    ...
    $response = $sdk->sdk->getMedia($request);
