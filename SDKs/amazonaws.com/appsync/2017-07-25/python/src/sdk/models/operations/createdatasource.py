...
class CreateDataSourceRequestBodyTypeEnum(str, Enum):
    r"""The type of the <code>DataSource</code>."""
...
class CreateDataSourceRequestBody:
    ...
    r"""A user-supplied name for the <code>DataSource</code>."""  
    type: CreateDataSourceRequestBodyTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type of the <code>DataSource</code>."""  
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('description'), 'exclude': lambda f: f is None }})
    r"""A description of the <code>DataSource</code>."""  
    dynamodb_config: Optional[CreateDataSourceRequestBodyDynamodbConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dynamodbConfig'), 'exclude': lambda f: f is None }})
    r"""Describes an Amazon DynamoDB data source configuration."""  
    elasticsearch_config: Optional[CreateDataSourceRequestBodyElasticsearchConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('elasticsearchConfig'), 'exclude': lambda f: f is None }})
    r"""<p>Describes an OpenSearch data source configuration.</p> <p>As of September 2021, Amazon Elasticsearch service is Amazon OpenSearch Service. This configuration is deprecated. For new data sources, use <a>OpenSearchServiceDataSourceConfig</a> to specify an OpenSearch data source.</p>"""  
    event_bridge_config: Optional[CreateDataSourceRequestBodyEventBridgeConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('eventBridgeConfig'), 'exclude': lambda f: f is None }})
    r"""Describes an Amazon EventBridge bus data source configuration."""  
    http_config: Optional[CreateDataSourceRequestBodyHTTPConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('httpConfig'), 'exclude': lambda f: f is None }})
    r"""Describes an HTTP data source configuration."""  
    lambda_config: Optional[CreateDataSourceRequestBodyLambdaConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lambdaConfig'), 'exclude': lambda f: f is None }})
    r"""Describes an Lambda data source configuration."""  
    open_search_service_config: Optional[CreateDataSourceRequestBodyOpenSearchServiceConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('openSearchServiceConfig'), 'exclude': lambda f: f is None }})
    r"""Describes an OpenSearch data source configuration."""  
    relational_database_config: Optional[CreateDataSourceRequestBodyRelationalDatabaseConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('relationalDatabaseConfig'), 'exclude': lambda f: f is None }})
    r"""Describes a relational database data source configuration."""  
    ...
    r"""The Identity and Access Management (IAM) service role Amazon Resource Name (ARN) for the data source. The system assumes this role when accessing the data source."""  
...
class CreateDataSourceRequest:
    ...
    r"""The API ID for the GraphQL API for the <code>DataSource</code>."""  
    request_body: CreateDataSourceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
