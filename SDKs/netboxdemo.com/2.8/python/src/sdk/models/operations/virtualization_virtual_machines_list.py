...
class VirtualizationVirtualMachinesList200ApplicationJSON:
    ...
    results: list[shared_virtualmachinewithconfigcontext.VirtualMachineWithConfigContext] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results') }})  
