...
class ArtifactregistryProjectsLocationsRepositoriesPackagesTagsCreateRequest:
    ...
    r"""The name of the parent resource where the tag will be created."""  
    ...
    tag: Optional[shared_tag.Tag] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    tag_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'tagId', 'style': 'form', 'explode': True }})
    r"""The tag id to use for this repository."""  
