...
exports.TagsGetDatapointsCountResponse = exports.TagsGetDatapointsCountRequest = exports.TagsGetDatapointsCountTypeEnum = exports.TagsGetDatapointsCountStatusEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Status of the datapoint
 */
var TagsGetDatapointsCountStatusEnum;
...
})(TagsGetDatapointsCountStatusEnum = exports.TagsGetDatapointsCountStatusEnum || (exports.TagsGetDatapointsCountStatusEnum = {}));
/**
 * Type of the datapoint ("tp"/"tl")
 */
var TagsGetDatapointsCountTypeEnum;
(function (TagsGetDatapointsCountTypeEnum) {
    TagsGetDatapointsCountTypeEnum["Tp"] = "tp";
    TagsGetDatapointsCountTypeEnum["Tl"] = "tl";
})(TagsGetDatapointsCountTypeEnum = exports.TagsGetDatapointsCountTypeEnum || (exports.TagsGetDatapointsCountTypeEnum = {}));
var TagsGetDatapointsCountRequest = /** @class */ (function (_super) {
    ...
    ], TagsGetDatapointsCountRequest.prototype, "createdAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=createdBefore",
        }),
        __metadata("design:type", String)
    ], TagsGetDatapointsCountRequest.prototype, "createdBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], TagsGetDatapointsCountRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=tagId",
        }),
        __metadata("design:type", Number)
    ], TagsGetDatapointsCountRequest.prototype, "tagId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=textSearch",
        }),
        __metadata("design:type", String)
    ], TagsGetDatapointsCountRequest.prototype, "textSearch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=type" }),
        __metadata("design:type", String)
    ], TagsGetDatapointsCountRequest.prototype, "type", void 0);
    return TagsGetDatapointsCountRequest;
}(utils_1.SpeakeasyBase));
exports.TagsGetDatapointsCountRequest = TagsGetDatapointsCountRequest;
var TagsGetDatapointsCountResponse = /** @class */ (function (_super) {
    ...
    ], TagsGetDatapointsCountResponse.prototype, "rawResponse", void 0);
    return TagsGetDatapointsCountResponse;
}(utils_1.SpeakeasyBase));
exports.TagsGetDatapointsCountResponse = TagsGetDatapointsCountResponse;
