...
class CreateArtifactRawRequest
{
    /**
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CreateArtifactRawXRegistryHashAlgorithmEnum $xRegistryHashAlgorithm
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Registry-Hash-Algorithm')]
    public ?CreateArtifactRawXRegistryHashAlgorithmEnum $xRegistryHashAlgorithm = null;
