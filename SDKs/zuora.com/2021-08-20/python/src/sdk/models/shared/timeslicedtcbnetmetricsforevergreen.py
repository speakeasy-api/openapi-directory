...
class TimeSlicedTcbNetMetricsForEvergreen:
    ...
    type: Optional[TimeSlicedTcbNetMetricsForEvergreenTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Indicates whether this metrics is for a regular charge or a discount. charge."""  
