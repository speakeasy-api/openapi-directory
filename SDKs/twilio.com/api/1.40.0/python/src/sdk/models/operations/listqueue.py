...
class ListQueueRequest:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Queue resources to read."""  
...
class ListQueueListQueueResponse:
    ...
    queues: Optional[list[shared_api_v2010_account_queue.APIV2010AccountQueue]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('queues'), 'exclude': lambda f: f is None }})  
