...
export class OrderTypesAllSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class OrderTypesAllRequest extends SpeakeasyBase {
  /**
...
export class OrderTypesAllResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
