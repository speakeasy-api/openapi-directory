...
class CiscoSwitchDataSource:
    ...
    switch_type: Optional[shared_ciscoswitchtype_enum.CiscoSwitchTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('switch_type'), 'exclude': lambda f: f is None }})  
