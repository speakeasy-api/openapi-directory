...
exports.FileDeleteFromTaskResponse = exports.FileDeleteFromTaskRequest = void 0;
...
var FileDeleteFromTaskRequest = /** @class */ (function (_super) {
    ...
    ], FileDeleteFromTaskRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], FileDeleteFromTaskRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=fileName",
        }),
        __metadata("design:type", String)
    ], FileDeleteFromTaskRequest.prototype, "fileName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=jobId",
        }),
        __metadata("design:type", String)
    ], FileDeleteFromTaskRequest.prototype, "jobId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], FileDeleteFromTaskRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=recursive",
        }),
        __metadata("design:type", Boolean)
    ], FileDeleteFromTaskRequest.prototype, "recursive", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], FileDeleteFromTaskRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=taskId",
        }),
        __metadata("design:type", String)
    ], FileDeleteFromTaskRequest.prototype, "taskId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], FileDeleteFromTaskRequest.prototype, "timeout", void 0);
...
var FileDeleteFromTaskResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], FileDeleteFromTaskResponse.prototype, "rawResponse", void 0);
