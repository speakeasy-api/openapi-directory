...
class CloudJobSchedulePreviousStateEnum(str, Enum):
    r"""The previous state of the job schedule."""
    ACTIVE = 'active'
    COMPLETED = 'completed'
    DISABLED = 'disabled'
...
class CloudJobScheduleStateEnum(str, Enum):
    r"""The current state of the job schedule."""
    ACTIVE = 'active'
    COMPLETED = 'completed'
    DISABLED = 'disabled'
    TERMINATING = 'terminating'
...
class CloudJobSchedule:
    ...
    r"""The creation time of the job schedule."""  
    ...
    r"""The ETag of the job schedule."""  
    ...
    r"""The last modified time of the job schedule."""  
    ...
    r"""The time at which the job schedule entered its previous state."""  
    ...
    r"""The time at which the job schedule entered the current state."""  
