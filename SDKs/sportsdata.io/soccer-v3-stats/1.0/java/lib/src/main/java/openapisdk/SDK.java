...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.BoxScoresByDateByCompetitionResponse boxScoresByDateByCompetition(openapisdk.models.operations.BoxScoresByDateByCompetitionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/{format}/BoxScoresByCompetition/{competition}/{date}", request.pathParams);
        ...
        openapisdk.models.operations.BoxScoresByDateByCompetitionResponse res = new openapisdk.models.operations.BoxScoresByDateByCompetitionResponse() {{
            boxScores = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.BoxScoresDeltaByDateByCompetitionResponse boxScoresDeltaByDateByCompetition(openapisdk.models.operations.BoxScoresDeltaByDateByCompetitionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/{format}/BoxScoresDeltaByCompetition/{competition}/{date}/{minutes}", request.pathParams);
        ...
        openapisdk.models.operations.BoxScoresDeltaByDateByCompetitionResponse res = new openapisdk.models.operations.BoxScoresDeltaByDateByCompetitionResponse() {{
            boxScores = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.PlayerSeasonStatsResponse playerSeasonStats(openapisdk.models.operations.PlayerSeasonStatsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/{format}/PlayerSeasonStats/{roundid}", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.PlayerSeasonStatsByPlayerResponse playerSeasonStatsByPlayer(openapisdk.models.operations.PlayerSeasonStatsByPlayerRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/{format}/PlayerSeasonStatsByPlayer/{roundid}/{playerid}", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.PlayerSeasonStatsByTeamResponse playerSeasonStatsByTeam(openapisdk.models.operations.PlayerSeasonStatsByTeamRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/{format}/PlayerSeasonStatsByTeam/{roundid}/{team}", request.pathParams);
