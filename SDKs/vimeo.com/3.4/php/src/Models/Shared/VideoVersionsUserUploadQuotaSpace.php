...
class VideoVersionsUserUploadQuotaSpace
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserUploadQuotaSpaceShowingEnum $showing
     */
	#[\JMS\Serializer\Annotation\SerializedName('showing')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserUploadQuotaSpaceShowingEnum>')]
	...
	public function __construct()
	{
		$this->free = 0;
		$this->max = 0;
		$this->showing = \OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserUploadQuotaSpaceShowingEnum::LIFETIME;
		$this->used = 0;
	}
}
