...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Campaign.CampaignDetails(ctx, operations.CampaignDetailsRequest{
        CampaignID: sdk.String("{{campaign_identifier}}"),
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Campaign.CampaignList(ctx, operations.CampaignListRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Campaign.SendAnalytics(ctx, operations.SendAnalyticsRequest{
        CampaignID: sdk.String("{{campaign_identifier}}"),
