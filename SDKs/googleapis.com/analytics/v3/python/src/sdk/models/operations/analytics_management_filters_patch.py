...
class AnalyticsManagementFiltersPatchRequest:
    path_params: AnalyticsManagementFiltersPatchPathParams = dataclasses.field()
    query_params: AnalyticsManagementFiltersPatchQueryParams = dataclasses.field()
    security: AnalyticsManagementFiltersPatchSecurity = dataclasses.field()
