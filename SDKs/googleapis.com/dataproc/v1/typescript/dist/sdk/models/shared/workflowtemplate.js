...
exports.WorkflowTemplateInput = exports.WorkflowTemplate = void 0;
var utils_1 = require("../../../internal/utils");
var orderedjob_1 = require("./orderedjob");
var templateparameter_1 = require("./templateparameter");
var workflowtemplateplacement_1 = require("./workflowtemplateplacement");
var workflowtemplateplacement_2 = require("./workflowtemplateplacement");
// WorkflowTemplate
/**
...
var WorkflowTemplate = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dagTimeout" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=jobs", elemType: orderedjob_1.OrderedJob }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=parameters", elemType: templateparameter_1.TemplateParameter }),
        __metadata("design:type", Array)
    ], WorkflowTemplate.prototype, "parameters", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=placement" }),
        __metadata("design:type", workflowtemplateplacement_1.WorkflowTemplatePlacement)
...
var WorkflowTemplateInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=placement" }),
        __metadata("design:type", workflowtemplateplacement_2.WorkflowTemplatePlacementInput)
...
exports.WorkflowTemplateInput = WorkflowTemplateInput;
