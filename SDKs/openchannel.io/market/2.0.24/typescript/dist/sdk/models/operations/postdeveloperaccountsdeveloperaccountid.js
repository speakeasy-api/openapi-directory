...
exports.PostDeveloperAccountsDeveloperAccountIdResponse = exports.PostDeveloperAccountsDeveloperAccountIdRequest = void 0;
...
var PostDeveloperAccountsDeveloperAccountIdRequest = /** @class */ (function (_super) {
    ...
    ], PostDeveloperAccountsDeveloperAccountIdRequest.prototype, "customData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=developerAccountId",
        }),
        __metadata("design:type", String)
    ], PostDeveloperAccountsDeveloperAccountIdRequest.prototype, "developerAccountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=developerId",
        }),
        __metadata("design:type", String)
    ], PostDeveloperAccountsDeveloperAccountIdRequest.prototype, "developerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=email" }),
        __metadata("design:type", String)
    ], PostDeveloperAccountsDeveloperAccountIdRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], PostDeveloperAccountsDeveloperAccountIdRequest.prototype, "name", void 0);
...
var PostDeveloperAccountsDeveloperAccountIdResponse = /** @class */ (function (_super) {
    ...
    ], PostDeveloperAccountsDeveloperAccountIdResponse.prototype, "rawResponse", void 0);
