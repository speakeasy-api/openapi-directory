...
class CreateSubscriberRequest:
    headers: CreateSubscriberHeaders = dataclasses.field()
    request: shared_createsubscriberrequest.CreateSubscriberRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
