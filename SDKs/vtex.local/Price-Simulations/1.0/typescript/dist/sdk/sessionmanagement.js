...
var SessionManagement = /** @class */ (function () {
    function SessionManagement(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    SessionManagement.prototype.postSessions = function (req, config) {
        var _a;
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostSessionsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.postSessions200ApplicationJSONAny = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
