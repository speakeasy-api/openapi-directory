...
class PostSetIdentityHeadersInNotificationsEnabledQueryParams:
    action: PostSetIdentityHeadersInNotificationsEnabledActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostSetIdentityHeadersInNotificationsEnabledVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostSetIdentityHeadersInNotificationsEnabledRequest:
    headers: PostSetIdentityHeadersInNotificationsEnabledHeaders = dataclasses.field()
    query_params: PostSetIdentityHeadersInNotificationsEnabledQueryParams = dataclasses.field()
