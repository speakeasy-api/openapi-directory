...
exports.ConnectionsImportResponse = exports.ConnectionsImportRequest = exports.ConnectionsImportSecurity = void 0;
...
var ConnectionsImportRequest = /** @class */ (function (_super) {
    ...
    ], ConnectionsImportRequest.prototype, "connectionImportData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=service_id",
        }),
        __metadata("design:type", String)
    ], ConnectionsImportRequest.prototype, "serviceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=unified_api",
        }),
        __metadata("design:type", String)
    ], ConnectionsImportRequest.prototype, "unifiedApi", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], ConnectionsImportRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], ConnectionsImportRequest.prototype, "xApideckConsumerId", void 0);
...
var ConnectionsImportResponse = /** @class */ (function (_super) {
    ...
    ], ConnectionsImportResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
