...
class GameServerGroupAutoScalingPolicy:
    ...
    target_tracking_configuration: shared_targettrackingconfiguration.TargetTrackingConfiguration = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('TargetTrackingConfiguration') }})
