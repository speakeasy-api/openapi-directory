...
export declare class GetOrganisationsPartyIdBusinessNamesRequest extends SpeakeasyBase {
    /**
     * The API key.
     */
    apiKey: string;
...
export declare class GetOrganisationsPartyIdBusinessNamesResponse extends SpeakeasyBase {
    contentType: string;
