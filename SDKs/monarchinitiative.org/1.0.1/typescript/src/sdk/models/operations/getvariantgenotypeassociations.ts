...
export class GetVariantGenotypeAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetVariantGenotypeAssociationsQueryParams extends SpeakeasyBase {
...
export class GetVariantGenotypeAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetVariantGenotypeAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
