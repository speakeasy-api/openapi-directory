...
class DescribeIpamResourceDiscoveriesRequestFilters:
...
class DescribeIpamResourceDiscoveriesRequest:
    ...
    filters: Optional[list[DescribeIpamResourceDiscoveriesRequestFilters]] = dataclasses.field(default=None)  
    ipam_resource_discovery_ids: Optional[list[str]] = dataclasses.field(default=None)  
