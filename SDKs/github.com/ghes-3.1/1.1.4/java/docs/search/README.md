...
<https://docs.github.com/enterprise-server@3.1/rest/reference/search#search-code>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCodeRequest req = new SearchCodeRequest("ipsa") {{
                order = OrderEnum.ASC;
                page = 950956L;
                perPage = 983000L;
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/search#search-commits>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCommitsRequest req = new SearchCommitsRequest("laudantium") {{
                order = OrderEnum.ASC;
                page = 691L;
                perPage = 992667L;
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/search#search-issues-and-pull-requests>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchIssuesAndPullRequestsRequest req = new SearchIssuesAndPullRequestsRequest("dicta") {{
                order = OrderEnum.DESC;
                page = 938257L;
                perPage = 985360L;
                sort = SearchIssuesAndPullRequestsSortEnum.REACTIONS_PLUS1;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/search#search-labels>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchLabelsRequest req = new SearchLabelsRequest("eius", 458212L) {{
                order = OrderEnum.DESC;
                page = 757407L;
                perPage = 94697L;
                sort = SearchLabelsSortEnum.CREATED;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/search#search-repositories>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchReposRequest req = new SearchReposRequest("vero") {{
                order = OrderEnum.ASC;
                page = 37534L;
                perPage = 185816L;
                sort = SearchReposSortEnum.UPDATED;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/search#search-topics>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchTopicsRequest req = new SearchTopicsRequest("beatae") {{
                page = 278329L;
                perPage = 116558L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/search#search-users>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchUsersRequest req = new SearchUsersRequest("odit") {{
                order = OrderEnum.DESC;
                page = 701441L;
                perPage = 4654L;
                sort = SearchUsersSortEnum.REPOSITORIES;
            }};            
