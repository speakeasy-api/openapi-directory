...
var Device = /** @class */ (function () {
    function Device(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Device.prototype.detectDeviceDetectPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DetectDeviceDetectPostRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/device/detect";
