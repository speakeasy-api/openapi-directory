...
public class Assets {
    ...
    **/
    public openapisdk.models.operations.CloudassetAssetsListResponse cloudassetAssetsList(openapisdk.models.operations.CloudassetAssetsListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1p5beta1/{parent}/assets", request.pathParams);
        ...
        openapisdk.models.operations.CloudassetAssetsListResponse res = new openapisdk.models.operations.CloudassetAssetsListResponse() {{
