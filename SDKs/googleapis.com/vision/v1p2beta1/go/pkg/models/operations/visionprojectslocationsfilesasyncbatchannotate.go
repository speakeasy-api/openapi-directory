...
type VisionProjectsLocationsFilesAsyncBatchAnnotateRequest struct {
	...
	GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest *shared.GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest `request:"mediaType=application/json"`
	// OAuth access token.
