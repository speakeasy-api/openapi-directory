...
func (e ListRecommendersXAmzTargetEnum) ToPointer() *ListRecommendersXAmzTargetEnum {
	return &e
}
...
func (e *ListRecommendersXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonPersonalize.ListRecommenders":
		*e = ListRecommendersXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListRecommendersXAmzTargetEnum: %v", v)
	}
}
