...
func (e UpdateConnectAppUpdateConnectAppRequestDeauthorizeCallbackMethodEnum) ToPointer() *UpdateConnectAppUpdateConnectAppRequestDeauthorizeCallbackMethodEnum {
	return &e
}
...
func (e *UpdateConnectAppUpdateConnectAppRequestDeauthorizeCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateConnectAppUpdateConnectAppRequestDeauthorizeCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateConnectAppUpdateConnectAppRequestDeauthorizeCallbackMethodEnum: %v", v)
	}
}
