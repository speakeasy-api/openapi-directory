...
exports.PoolGetAllPoolsLifetimeStatisticsResponse = exports.PoolGetAllPoolsLifetimeStatisticsRequest = void 0;
...
var PoolGetAllPoolsLifetimeStatisticsRequest = /** @class */ (function (_super) {
    ...
    ], PoolGetAllPoolsLifetimeStatisticsRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], PoolGetAllPoolsLifetimeStatisticsRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], PoolGetAllPoolsLifetimeStatisticsRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], PoolGetAllPoolsLifetimeStatisticsRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], PoolGetAllPoolsLifetimeStatisticsRequest.prototype, "timeout", void 0);
...
var PoolGetAllPoolsLifetimeStatisticsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.PoolStatistics)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], PoolGetAllPoolsLifetimeStatisticsResponse.prototype, "rawResponse", void 0);
