...
try {
    ...
    $request->certificateParameters->refNo = 'eService Certificate No like ARSTC/2018/005241';
    $request->certificateParameters->tokenNo = 'Printed on the bottom of the certificate like 8624';
