...
var CurrencyRates = /** @class */ (function () {
    function CurrencyRates(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CurrencyRates.prototype.getcurrencyrate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetcurrencyrateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/getcurrencyrate";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getcurrencyrate200ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
