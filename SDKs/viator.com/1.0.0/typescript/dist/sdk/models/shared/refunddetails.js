 ...
 *
**/
var RefundDetails = /** @class */ (function (_super) {
    __extends(RefundDetails, _super);
    ...
    ], RefundDetails.prototype, "currencyCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=itemPrice" }),
        __metadata("design:type", Number)
    ], RefundDetails.prototype, "itemPrice", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=refundAmount" }),
        __metadata("design:type", Number)
    ], RefundDetails.prototype, "refundAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=refundPercentage" }),
        __metadata("design:type", Number)
    ], RefundDetails.prototype, "refundPercentage", void 0);
