...
public class FirebaseappcheckProjectsAppsExchangePlayIntegrityTokenRequest {
    ...
    public openapisdk.models.shared.GoogleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest request;
    public FirebaseappcheckProjectsAppsExchangePlayIntegrityTokenRequest withRequest(openapisdk.models.shared.GoogleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest request) {
