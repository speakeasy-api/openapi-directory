...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.TeamScheduleResponse teamSchedule(org.openapis.openapi.models.operations.TeamScheduleRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.TeamSchedulePathParams.class, baseUrl, "/{format}/TeamSchedule/{season}/{team}", request.pathParams, null);
        ...
        org.openapis.openapi.models.operations.TeamScheduleResponse res = new org.openapis.openapi.models.operations.TeamScheduleResponse() {{
            games = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
