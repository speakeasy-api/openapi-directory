...
var BatchResponseMarketingEventPublicDefaultResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: marketingeventpublicdefaultresponse_1.MarketingEventPublicDefaultResponse }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return marketingeventpublicdefaultresponse_1.MarketingEventPublicDefaultResponse; }),
        __metadata("design:type", Array)
