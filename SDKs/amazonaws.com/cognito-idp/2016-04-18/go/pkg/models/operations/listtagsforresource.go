...
const (
	ListTagsForResourceXAmzTargetEnumAwsCognitoIdentityProviderServiceListTagsForResource ListTagsForResourceXAmzTargetEnum = "AWSCognitoIdentityProviderService.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AWSCognitoIdentityProviderService.ListTagsForResource":
