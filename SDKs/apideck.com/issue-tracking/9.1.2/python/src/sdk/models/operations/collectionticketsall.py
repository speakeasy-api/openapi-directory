...
from ..shared import getticketsresponse as shared_getticketsresponse
from ..shared import issuesfilter as shared_issuesfilter
...
from ..shared import ticketssort as shared_ticketssort
...
class CollectionTicketsAllSecurity:
...
class CollectionTicketsAllRequest:
    ...
    filter: Optional[shared_issuesfilter.IssuesFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    r"""Apply filters"""  
    ...
    sort: Optional[shared_ticketssort.TicketsSort] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'deepObject', 'explode': True }})
    r"""Apply sorting"""  
...
class CollectionTicketsAllResponse:
    ...
    r"""Bad Request"""  
    get_tickets_response: Optional[shared_getticketsresponse.GetTicketsResponse] = dataclasses.field(default=None)
    r"""List Tickets"""  
