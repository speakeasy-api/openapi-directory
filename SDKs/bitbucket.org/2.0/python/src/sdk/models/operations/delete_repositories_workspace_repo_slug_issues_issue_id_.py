...
class DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDPathParams = dataclasses.field()
    security: DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDSecurity = dataclasses.field()
