...
public class StopPointReachableFromQueryParams {
    /**
    ...
    public StopPointReachableFromQueryParams withServiceTypes(StopPointReachableFromServiceTypesEnum[] serviceTypes) {
