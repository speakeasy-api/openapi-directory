...
export class AdminCustomersChromePrintServersCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdminCustomersChromePrintServersCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdminCustomersChromePrintServersCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
