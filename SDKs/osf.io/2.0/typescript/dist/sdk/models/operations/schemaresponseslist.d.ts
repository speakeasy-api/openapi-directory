 ...
 */
export declare enum SchemaResponsesListSchemaResponsesAttributesReviewsStateEnum {
    Initial = "initial",
 ...
 */
export declare class SchemaResponsesListSchemaResponsesAttributes extends SpeakeasyBase {
    /**
 ...
 */
export declare class SchemaResponsesListSchemaResponsesLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class SchemaResponsesListSchemaResponsesRelationships extends SpeakeasyBase {
    /**
 ...
 * OK
 */
export declare class SchemaResponsesListSchemaResponses extends SpeakeasyBase {
    /**
     * The properties of the Schema Response.
     */
...
export declare class SchemaResponsesListResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
