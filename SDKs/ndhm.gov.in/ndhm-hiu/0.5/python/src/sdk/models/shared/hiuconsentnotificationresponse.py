...
from ..shared import consentacknowledgement as shared_consentacknowledgement
...
class HiuConsentNotificationResponse:
    ...
    acknowledgement: Optional[list[shared_consentacknowledgement.ConsentAcknowledgement]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('acknowledgement') }})
