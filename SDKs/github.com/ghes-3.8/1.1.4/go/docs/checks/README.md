...
<https://docs.github.com/enterprise-server@3.8/rest/reference/checks#create-a-check-run>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/checks#create-a-check-suite>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/checks#get-a-check-run>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/checks#get-a-check-suite>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/checks#list-check-run-annotations>
...
func main() {
    ...
    res, err := s.Checks.ChecksListAnnotations(ctx, operations.ChecksListAnnotationsRequest{
        CheckRunID: 924967,
        Owner: "aliquid",
        Page: sdk.Int64(46007),
        PerPage: sdk.Int64(738683),
        Repo: "consectetur",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/checks#list-check-runs-for-a-git-reference>
...
func main() {
    ...
    res, err := s.Checks.ChecksListForRef(ctx, operations.ChecksListForRefRequest{
        AppID: sdk.Int64(449083),
        CheckName: sdk.String("exercitationem"),
        Filter: operations.ChecksListForRefFilterEnumAll.ToPointer(),
        Owner: "facere",
        Page: sdk.Int64(257233),
        PerPage: sdk.Int64(985492),
        Ref: "suscipit",
        Repo: "reiciendis",
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/checks#list-check-runs-in-a-check-suite>
...
func main() {
    ...
    res, err := s.Checks.ChecksListForSuite(ctx, operations.ChecksListForSuiteRequest{
        CheckName: sdk.String("saepe"),
        CheckSuiteID: 897071,
        Filter: operations.ChecksListForSuiteFilterEnumLatest.ToPointer(),
        Owner: "sunt",
        Page: sdk.Int64(992012),
        PerPage: sdk.Int64(241545),
        Repo: "non",
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/checks#list-check-suites-for-a-git-reference>
...
func main() {
    ...
    res, err := s.Checks.ChecksListSuitesForRef(ctx, operations.ChecksListSuitesForRefRequest{
        AppID: sdk.Int64(105906),
        CheckName: sdk.String("dignissimos"),
        Owner: "a",
        Page: sdk.Int64(891523),
        PerPage: sdk.Int64(233420),
        Ref: "corporis",
        Repo: "harum",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/checks#rerequest-a-check-run>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/checks#rerequest-a-check-suite>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/checks#update-repository-preferences-for-check-suites>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/checks#update-a-check-run>
