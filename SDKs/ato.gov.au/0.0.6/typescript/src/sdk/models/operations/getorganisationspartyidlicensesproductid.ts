...
export class GetOrganisationsPartyIdLicensesProductIdRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class GetOrganisationsPartyIdLicensesProductIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
