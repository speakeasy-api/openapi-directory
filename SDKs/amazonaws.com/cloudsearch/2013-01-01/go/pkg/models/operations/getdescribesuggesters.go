...
func (e GETDescribeSuggestersActionEnum) ToPointer() *GETDescribeSuggestersActionEnum {
	return &e
}
...
func (e *GETDescribeSuggestersActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DescribeSuggesters":
		*e = GETDescribeSuggestersActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeSuggestersActionEnum: %v", v)
	}
}
...
func (e GETDescribeSuggestersVersionEnum) ToPointer() *GETDescribeSuggestersVersionEnum {
	return &e
}
...
func (e *GETDescribeSuggestersVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2013-01-01":
		*e = GETDescribeSuggestersVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeSuggestersVersionEnum: %v", v)
	}
}
