...
class DescribeTrafficMirrorSessionsRequestFilters:
...
class DescribeTrafficMirrorSessionsRequest:
    ...
    filters: Optional[list[DescribeTrafficMirrorSessionsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    traffic_mirror_session_ids: Optional[list[str]] = dataclasses.field(default=None)  
