...
class GetDimensionKeyDetailsRequest:
    ...
    group_identifier: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('GroupIdentifier') }})  
    ...
    requested_dimensions: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RequestedDimensions'), 'exclude': lambda f: f is None }})  
