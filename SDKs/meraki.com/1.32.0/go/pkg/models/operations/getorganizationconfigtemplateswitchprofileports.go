...
func (e GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONAccessPolicyTypeEnum) ToPointer() *GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONAccessPolicyTypeEnum {
	return &e
}
...
func (e *GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Sticky MAC allow list":
		*e = GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONAccessPolicyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONAccessPolicyTypeEnum: %v", v)
	}
}
...
func (e GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONStpGuardEnum) ToPointer() *GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONStpGuardEnum {
	return &e
}
...
func (e *GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONStpGuardEnum) UnmarshalJSON(data []byte) error {
	...
	case "loop guard":
		fallthrough
	case "root guard":
		*e = GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONStpGuardEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONStpGuardEnum: %v", v)
	}
}
...
func (e GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONTypeEnum) ToPointer() *GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONTypeEnum {
	return &e
}
...
func (e *GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "access":
		fallthrough
	case "trunk":
		*e = GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONTypeEnum: %v", v)
	}
}
...
func (e GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONUdldEnum) ToPointer() *GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONUdldEnum {
	return &e
}
...
func (e *GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONUdldEnum) UnmarshalJSON(data []byte) error {
	...
	case "Alert only":
		fallthrough
	case "Enforce":
		*e = GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONUdldEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationConfigTemplateSwitchProfilePorts200ApplicationJSONUdldEnum: %v", v)
	}
}
