...
exports.BrandingPolicies = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var BrandingPolicies = /** @class */ (function () {
    function BrandingPolicies(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Add a new branding policy to an organization
     */
    BrandingPolicies.prototype.createOrganizationBrandingPolicy = function (req, config) {
        var _a;
     ...
     * Delete a branding policy
     */
    BrandingPolicies.prototype.deleteOrganizationBrandingPolicy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * List the branding policies of an organization
     */
    BrandingPolicies.prototype.getOrganizationBrandingPolicies = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    BrandingPolicies.prototype.getOrganizationBrandingPoliciesPriorities = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Return a branding policy
     */
    BrandingPolicies.prototype.getOrganizationBrandingPolicy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update the priority ordering of an organization's branding policies.
     */
    BrandingPolicies.prototype.updateOrganizationBrandingPoliciesPriorities = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update a branding policy
     */
    BrandingPolicies.prototype.updateOrganizationBrandingPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.BrandingPolicies = BrandingPolicies;
