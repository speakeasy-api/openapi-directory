...
class Batch
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\BatchOptionalLink $batchErrorsUrl
     */
	#[\JMS\Serializer\Annotation\SerializedName('batch_errors_url')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\BatchOptionalLink')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\BatchOptionalLink $formDownload
     */
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\BatchLabelDownload $labelDownload
     */
	#[\JMS\Serializer\Annotation\SerializedName('label_download')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\BatchLabelDownload')]
    public BatchLabelDownload $labelDownload;
    
	#[\JMS\Serializer\Annotation\SerializedName('label_format')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\BatchLabelFormatEnum>')]
    public BatchLabelFormatEnum $labelFormat;
    
    /**
     * label layout
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\BatchLabelLayoutEnum $labelLayout
     */
	#[\JMS\Serializer\Annotation\SerializedName('label_layout')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\BatchLabelLayoutEnum>')]
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\BatchBatchStatusEnum>')]
	...
	{
		$this->batchErrorsUrl = new \OpenAPI\OpenAPI\Models\Shared\BatchOptionalLink();
		$this->batchId = "";
		...
		$this->formDownload = new \OpenAPI\OpenAPI\Models\Shared\BatchOptionalLink();
		$this->forms = 0;
		$this->labelDownload = new \OpenAPI\OpenAPI\Models\Shared\BatchLabelDownload();
		$this->labelFormat = \OpenAPI\OpenAPI\Models\Shared\BatchLabelFormatEnum::PDF;
		$this->labelLayout = \OpenAPI\OpenAPI\Models\Shared\BatchLabelLayoutEnum::FOURX6;
		$this->processedAt = new \DateTime();
		$this->status = \OpenAPI\OpenAPI\Models\Shared\BatchBatchStatusEnum::OPEN;
		$this->warnings = 0;
	}
}
