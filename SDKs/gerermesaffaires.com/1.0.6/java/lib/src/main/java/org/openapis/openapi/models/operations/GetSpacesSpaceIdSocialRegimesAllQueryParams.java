...
public class GetSpacesSpaceIdSocialRegimesAllQueryParams {
    /**
    ...
    public GetSpacesSpaceIdSocialRegimesAllQueryParams withWithContractingPartner(String withContractingPartner) {
