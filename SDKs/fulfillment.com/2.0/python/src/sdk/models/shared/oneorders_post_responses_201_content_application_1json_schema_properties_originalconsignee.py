...
class OneordersPostResponses201ContentApplication1jsonSchemaPropertiesOriginalConsignee:
    ...
    iso: Optional[OneordersPostResponses201ContentApplication1jsonSchemaPropertiesOriginalConsigneeIsoCountryV2] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('iso'), 'exclude': lambda f: f is None }})  
