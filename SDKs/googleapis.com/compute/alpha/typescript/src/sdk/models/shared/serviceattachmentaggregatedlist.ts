 ...
 */
export enum ServiceAttachmentAggregatedListWarningCodeEnum {
...
export class ServiceAttachmentAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ServiceAttachmentAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: ServiceAttachmentAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class ServiceAttachmentAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: ServiceAttachmentsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, ServiceAttachmentsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], ServiceAttachmentsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
