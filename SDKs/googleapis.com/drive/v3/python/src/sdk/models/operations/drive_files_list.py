...
class DriveFilesListCorpusEnum(str, Enum):
    r"""The source of files to list. Deprecated: use 'corpora' instead."""
    DOMAIN = 'domain'
    USER = 'user'
...
class DriveFilesListRequest:
    ...
    r"""A comma-separated list of sort keys. Valid keys are 'createdTime', 'folder', 'modifiedByMeTime', 'modifiedTime', 'name', 'name_natural', 'quotaBytesUsed', 'recency', 'sharedWithMeTime', 'starred', and 'viewedByMeTime'. Each key sorts ascending by default, but may be reversed with the 'desc' modifier. Example usage: ?orderBy=folder,modifiedTime desc,name. Please note that there is a current limitation for users with approximately one million files in which the requested sort order is ignored."""  
    ...
    r"""A query for filtering the file results. See the \\"Search for Files\\" guide for supported syntax."""  
