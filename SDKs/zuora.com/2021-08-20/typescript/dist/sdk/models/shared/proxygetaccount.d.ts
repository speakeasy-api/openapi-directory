 ...
 *
 */
export declare enum ProxyGetAccountCustomerTypeNSEnum {
    Company = "Company",
 ...
 *
 */
export declare enum ProxyGetAccountStatusEnum {
    Draft = "Draft",
    Active = "Active",
    Canceled = "Canceled"
}
 ...
 *
 */
export declare enum ProxyGetAccountSynctoNetSuiteNSEnum {
    Yes = "Yes",
    No = "No"
}
/**
 ...
 *
 */
export declare class ProxyGetAccount extends SpeakeasyBase {
    /**
