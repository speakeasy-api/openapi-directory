...
var CustomerServiceMetricTask = /** @class */ (function () {
    ...
    **/
    CustomerServiceMetricTask.prototype.createCustomerServiceMetricTask = function (req, config) {
        var _a;
    ...
    **/
    CustomerServiceMetricTask.prototype.getCustomerServiceMetricTask = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCustomerServiceMetricTaskRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/customer_service_metric_task/{task_id}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.serviceMetricsTask = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
    ...
    **/
    CustomerServiceMetricTask.prototype.getCustomerServiceMetricTasks = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.customerServiceMetricTaskCollection = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
