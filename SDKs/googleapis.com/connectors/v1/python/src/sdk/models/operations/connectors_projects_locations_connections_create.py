...
class ConnectorsProjectsLocationsConnectionsCreateRequest:
    ...
    r"""Required. Identifier to assign to the Connection. Must be unique within scope of the parent resource."""  
    connection_input: Optional[shared_connection.ConnectionInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
