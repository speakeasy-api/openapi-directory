    ...
    public static void main(String[] args) {
        try {
            ...
            HsmgrRequestBody req = new HsmgrRequestBody(HsmgrRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HsmgrRequestBodyCertificateParameters("Sunil Kumar", "0010003015", "2013");;
    ...
    public static void main(String[] args) {
        try {
            ...
            HvcerRequestBody req = new HvcerRequestBody(HvcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HvcerRequestBodyCertificateParameters("Sunil Kumar", "0010003015", "2013");;
            ...
            HvcerResponse res = sdk.apIs.hvcer(req, new HvcerSecurity("iure", "saepe") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            SscerRequestBody req = new SscerRequestBody(SscerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SscerRequestBodyCertificateParameters("Sunil Kumar", "0010003015", "2013");;
            ...
            SscerResponse res = sdk.apIs.sscer(req, new SscerSecurity("culpa", "doloribus") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            SsmgrRequestBody req = new SsmgrRequestBody(SsmgrRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SsmgrRequestBodyCertificateParameters("Sunil Kumar", "0010003015", "2013");;
            ...
            SsmgrResponse res = sdk.apIs.ssmgr(req, new SsmgrSecurity("animi", "enim") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
...
import java.time.OffsetDateTime;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.SvcerRequestBody;
import org.openapis.openapi.models.operations.SvcerRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.SvcerRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.SvcerResponse;
import org.openapis.openapi.models.operations.SvcerSecurity;
import org.openapis.openapi.models.shared.ConsentArtifactSchema;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsent;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentData;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentDataConsumer;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SvcerRequestBody req = new SvcerRequestBody(SvcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SvcerRequestBodyCertificateParameters("Sunil Kumar", "0010003015", "2013");;
            ...
            SvcerResponse res = sdk.apIs.svcer(req, new SvcerSecurity("ipsa", "omnis") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
