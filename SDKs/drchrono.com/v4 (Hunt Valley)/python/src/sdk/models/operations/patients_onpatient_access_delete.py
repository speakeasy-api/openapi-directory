...
class PatientsOnpatientAccessDeletePathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PatientsOnpatientAccessDeleteQueryParams:
...
@dataclasses.dataclass
class PatientsOnpatientAccessDeleteSecurity:
    drchrono_oauth2: shared_security.SchemeDrchronoOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class PatientsOnpatientAccessDeleteRequest:
    path_params: PatientsOnpatientAccessDeletePathParams = dataclasses.field()
    query_params: PatientsOnpatientAccessDeleteQueryParams = dataclasses.field()
    security: PatientsOnpatientAccessDeleteSecurity = dataclasses.field()
