...
exports.GetGetPathwayAsResponse = exports.GetGetPathwayAsRequest = exports.GetGetPathwayAsFormatEnum = void 0;
...
var GetGetPathwayAsRequest = /** @class */ (function (_super) {
    ...
    ], GetGetPathwayAsRequest.prototype, "fileType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=format",
        }),
        __metadata("design:type", String)
    ], GetGetPathwayAsRequest.prototype, "format", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=pwId" }),
        __metadata("design:type", String)
    ], GetGetPathwayAsRequest.prototype, "pwId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=revision",
        }),
        __metadata("design:type", Number)
    ], GetGetPathwayAsRequest.prototype, "revision", void 0);
...
var GetGetPathwayAsResponse = /** @class */ (function (_super) {
    ...
    ], GetGetPathwayAsResponse.prototype, "rawResponse", void 0);
