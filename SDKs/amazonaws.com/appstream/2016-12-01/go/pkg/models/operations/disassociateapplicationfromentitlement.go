...
type DisassociateApplicationFromEntitlementHeaders struct {
...
type DisassociateApplicationFromEntitlementRequest struct {
	Headers DisassociateApplicationFromEntitlementHeaders
	Request shared.DisassociateApplicationFromEntitlementRequest `request:"mediaType=application/json"`
}
