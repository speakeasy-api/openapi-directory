...
export class ModifierGroupsAllSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ModifierGroupsAllRequest extends SpeakeasyBase {
  /**
...
export class ModifierGroupsAllResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
