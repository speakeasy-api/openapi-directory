...
class Meta:
    ...
    def meta_get(self) -> operations.MetaGetResponse:
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/meta#get-github-meta-information - API method documentation
        """
    ...
    def meta_get_octocat(self, request: operations.MetaGetOctocatRequest) -> operations.MetaGetOctocatResponse:
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/meta#get-octocat - API method documentation
        """
        base_url = self._server_url
    ...
    def meta_root(self) -> operations.MetaRootResponse:
        ...
        https://docs.github.com/enterprise-server@3.2/rest/overview/resources-in-the-rest-api#root-endpoint - API method documentation
        """
        base_url = self._server_url
