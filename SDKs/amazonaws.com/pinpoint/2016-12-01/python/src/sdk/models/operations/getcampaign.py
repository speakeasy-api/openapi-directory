...
from ..shared import getcampaignresponse as shared_getcampaignresponse
...
class GetCampaignRequest:
    headers: GetCampaignHeaders = dataclasses.field()
...
class GetCampaignResponse:
    ...
    get_campaign_response: Optional[shared_getcampaignresponse.GetCampaignResponse] = dataclasses.field(default=None)
