 ...
 */
public enum WebinarCreate201ApplicationXMLRecurrenceWebinarMonthlyWeekEnum {
    MINUS1("-1"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private WebinarCreate201ApplicationXMLRecurrenceWebinarMonthlyWeekEnum(String value) {
        this.value = value;
    }
}
