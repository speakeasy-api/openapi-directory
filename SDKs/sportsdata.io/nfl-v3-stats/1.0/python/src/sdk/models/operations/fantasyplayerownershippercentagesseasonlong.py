...
from ..shared import playerownership as shared_playerownership
...
class FantasyPlayerOwnershipPercentagesSeasonLongResponse:
    ...
    player_ownerships: Optional[list[shared_playerownership.PlayerOwnership]] = dataclasses.field(default=None)  
