...
public class SDK {
	...
	private SDK(HTTPClient client, String serverUrl, java.util.Map<String, String> params) throws Exception {
		...
		this.advertiserInvoices = new AdvertiserInvoices(
			this._defaultClient,
			this._securityClient,
			this._serverUrl,
			this._language,
		...
		this.billingAssignments = new BillingAssignments(
			this._defaultClient,
			this._securityClient,
			this._serverUrl,
			this._language,
		...
		this.billingProfiles = new BillingProfiles(
			this._defaultClient,
			this._securityClient,
			this._serverUrl,
			this._language,
		...
		this.billingRates = new BillingRates(
			this._defaultClient,
			this._securityClient,
			this._serverUrl,
			this._language,
