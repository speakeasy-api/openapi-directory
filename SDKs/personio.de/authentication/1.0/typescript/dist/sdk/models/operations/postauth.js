...
exports.PostAuthResponse = exports.PostAuthRequest = void 0;
...
var PostAuthRequest = /** @class */ (function (_super) {
    ...
    ], PostAuthRequest.prototype, "clientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=client_secret",
        }),
        __metadata("design:type", String)
    ], PostAuthRequest.prototype, "clientSecret", void 0);
...
var PostAuthResponse = /** @class */ (function (_super) {
    ...
    ], PostAuthResponse.prototype, "rawResponse", void 0);
