...
class AssociateFirewallRuleGroupRequest:
    ...
    associate_firewall_rule_group_request: shared_associatefirewallrulegrouprequest.AssociateFirewallRuleGroupRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
