...
var SupersimV1Fleet = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ip_commands_method" }),
        __metadata("design:type", String)
    ], SupersimV1Fleet.prototype, "ipCommandsMethod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ip_commands_url" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sms_commands_enabled" }),
        __metadata("design:type", Boolean)
    ], SupersimV1Fleet.prototype, "smsCommandsEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sms_commands_method" }),
        __metadata("design:type", String)
    ], SupersimV1Fleet.prototype, "smsCommandsMethod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sms_commands_url" }),
        __metadata("design:type", String)
