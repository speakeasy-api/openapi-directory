...
public class Customers {
    ...
    public org.openapis.openapi.models.operations.ListCustomersResponse listCustomers(org.openapis.openapi.models.operations.ListCustomersRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ListCustomersRequest.class, baseUrl, "/companies/{companyId}/connections/{connectionId}/data/commerce-customers", request, null);
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.Customers out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.Customers.class);
                res.customers = out;
            }
        }
