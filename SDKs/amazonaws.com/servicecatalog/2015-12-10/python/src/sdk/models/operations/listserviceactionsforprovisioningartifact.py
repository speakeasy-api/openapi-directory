...
class ListServiceActionsForProvisioningArtifactRequest:
    ...
    list_service_actions_for_provisioning_artifact_input: shared_listserviceactionsforprovisioningartifactinput.ListServiceActionsForProvisioningArtifactInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
