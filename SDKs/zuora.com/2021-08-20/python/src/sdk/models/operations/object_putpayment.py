...
from ..shared import proxymodifypayment as shared_proxymodifypayment
...
class ObjectPUTPaymentRequest:
    ...
    proxy_modify_payment: shared_proxymodifypayment.ProxyModifyPayment = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
