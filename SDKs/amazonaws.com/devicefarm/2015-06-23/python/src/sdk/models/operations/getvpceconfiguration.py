...
class GetVPCEConfigurationRequest:
    ...
    get_vpce_configuration_request: shared_getvpceconfigurationrequest.GetVPCEConfigurationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
