...
from ..shared import uploadedboundaryid as shared_uploadedboundaryid
...
class UploadBoundaryResponse:
    ...
    uploaded_boundary_id: Optional[shared_uploadedboundaryid.UploadedBoundaryID] = dataclasses.field(default=None)
    r"""OK"""  
