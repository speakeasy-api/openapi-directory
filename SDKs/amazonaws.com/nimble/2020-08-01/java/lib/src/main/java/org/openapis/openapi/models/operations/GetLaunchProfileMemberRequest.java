...
public class GetLaunchProfileMemberRequest {
    ...
    public GetLaunchProfileMemberRequest(@JsonProperty("launchProfileId") String launchProfileId, @JsonProperty("principalId") String principalId, @JsonProperty("studioId") String studioId) {
        this.launchProfileId = launchProfileId;
        this.principalId = principalId;
        this.studioId = studioId;
  }
