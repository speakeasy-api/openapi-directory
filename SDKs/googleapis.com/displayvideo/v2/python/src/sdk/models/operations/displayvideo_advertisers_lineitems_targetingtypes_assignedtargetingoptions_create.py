...
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsCreateRequest:
    path_params: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsCreatePathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsCreateQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsCreateSecurity = dataclasses.field()
