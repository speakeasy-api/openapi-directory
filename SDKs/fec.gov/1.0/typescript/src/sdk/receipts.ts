...
export class Receipts {
  ...
  getSchedulesScheduleA(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetSchedulesScheduleAResponse =
        new operations.GetSchedulesScheduleAResponse({
      ...
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleAPage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleAPage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleAByEmployer(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/schedules/schedule_a/by_employer/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleAByEmployerResponse =
        new operations.GetSchedulesScheduleAByEmployerResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleAByEmployerPage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleAByEmployerPage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleAByOccupation(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/schedules/schedule_a/by_occupation/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleAByOccupationResponse =
        new operations.GetSchedulesScheduleAByOccupationResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleAByOccupationPage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleAByOccupationPage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleABySize(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/schedules/schedule_a/by_size/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleABySizeResponse =
        new operations.GetSchedulesScheduleABySizeResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleABySizePage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleABySizePage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleABySizeByCandidate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleABySizeByCandidateResponse =
        new operations.GetSchedulesScheduleABySizeByCandidateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleABySizeCandidatePage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleABySizeCandidatePage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleAByState(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/schedules/schedule_a/by_state/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleAByStateResponse =
        new operations.GetSchedulesScheduleAByStateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleAByStatePage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleAByStatePage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleAByStateByCandidate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleAByStateByCandidateResponse =
        new operations.GetSchedulesScheduleAByStateByCandidateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleAByStateCandidatePage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleAByStateCandidatePage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleAByStateByCandidateTotals(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetSchedulesScheduleAByStateByCandidateTotalsRequest(
        req
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleAByStateByCandidateTotalsResponse =
        new operations.GetSchedulesScheduleAByStateByCandidateTotalsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getSchedulesScheduleAByStateTotals(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/schedules/schedule_a/by_state/totals/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleAByStateTotalsResponse =
        new operations.GetSchedulesScheduleAByStateTotalsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleAByStateRecipientTotalsPage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleAByStateRecipientTotalsPage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleAByZip(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/schedules/schedule_a/by_zip/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleAByZipResponse =
        new operations.GetSchedulesScheduleAByZipResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleAByZipPage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleAByZipPage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleAEfile(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/schedules/schedule_a/efile/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleAEfileResponse =
        new operations.GetSchedulesScheduleAEfileResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scheduleAEfilePage = utils.objectToClass(
              httpRes?.data,
              shared.ScheduleAEfilePage
            );
          }
          break;
      }
  ...
  getSchedulesScheduleASubId(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSchedulesScheduleASubIdResponse =
        new operations.GetSchedulesScheduleASubIdResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
