...
public class GETCreateClientVpnRouteRequest {
    ...
    public GETCreateClientVpnRouteRequest(@JsonProperty("Action") GETCreateClientVpnRouteActionEnum action, @JsonProperty("ClientVpnEndpointId") String clientVpnEndpointId, @JsonProperty("DestinationCidrBlock") String destinationCidrBlock, @JsonProperty("TargetVpcSubnetId") String targetVpcSubnetId, @JsonProperty("Version") GETCreateClientVpnRouteVersionEnum version) {
        this.action = action;
        this.clientVpnEndpointId = clientVpnEndpointId;
        this.destinationCidrBlock = destinationCidrBlock;
        this.targetVpcSubnetId = targetVpcSubnetId;
