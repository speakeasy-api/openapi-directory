...
class PlacementActiveStatusEnum(str, Enum):
    r"""Whether this placement is active, inactive, archived or permanently archived."""
...
class Placement:
    ...
    active_status: Optional[PlacementActiveStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('activeStatus'), 'exclude': lambda f: f is None }})
    r"""Whether this placement is active, inactive, archived or permanently archived."""  
