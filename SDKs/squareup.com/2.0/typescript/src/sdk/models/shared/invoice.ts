...
export class Invoice extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "accepted_payment_methods" })
   ...
   * Max: 2 custom fields
   */
  @SpeakeasyMetadata({ elemType: InvoiceCustomField })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "next_payment_amount_money" })
  @Type(() => Money)
   ...
   * [Invoices Plus subscription](https://developer.squareup.com/docs/invoices-api/overview#invoices-plus-subscription).
   */
  @SpeakeasyMetadata({ elemType: InvoicePaymentRequest })
  @Expose({ name: "payment_requests" })
