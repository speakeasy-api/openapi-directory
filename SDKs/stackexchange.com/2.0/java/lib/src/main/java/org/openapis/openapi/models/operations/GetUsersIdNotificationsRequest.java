...
public class GetUsersIdNotificationsRequest {
    ...
    public GetUsersIdNotificationsRequest withCallback(String callback) {
    ...
    public GetUsersIdNotificationsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdNotificationsRequest withId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public GetUsersIdNotificationsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdNotificationsRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdNotificationsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    public GetUsersIdNotificationsRequest(@JsonProperty("id") Long id, @JsonProperty("site") String site) {
        this.id = id;
        this.site = site;
  }
}
