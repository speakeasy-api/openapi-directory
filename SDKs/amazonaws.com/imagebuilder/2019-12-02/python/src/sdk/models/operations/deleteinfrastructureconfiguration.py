...
from ..shared import deleteinfrastructureconfigurationresponse as shared_deleteinfrastructureconfigurationresponse
...
class DeleteInfrastructureConfigurationRequest:
    headers: DeleteInfrastructureConfigurationHeaders = dataclasses.field()
    query_params: DeleteInfrastructureConfigurationQueryParams = dataclasses.field()
...
class DeleteInfrastructureConfigurationResponse:
    ...
    delete_infrastructure_configuration_response: Optional[shared_deleteinfrastructureconfigurationresponse.DeleteInfrastructureConfigurationResponse] = dataclasses.field(default=None)
