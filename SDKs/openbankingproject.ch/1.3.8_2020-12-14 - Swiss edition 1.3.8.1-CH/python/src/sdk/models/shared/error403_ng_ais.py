...
class Error403NGAIS:
    ...
    tpp_messages: Optional[list[shared_tppmessage403_ais.TppMessage403AIS]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tppMessages'), 'exclude': lambda f: f is None }})  
