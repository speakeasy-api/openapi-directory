...
type AndroidenterpriseStorelayoutclustersInsertSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseStorelayoutclustersInsertPathParams struct {
...
type AndroidenterpriseStorelayoutclustersInsertQueryParams struct {
	// V1 error format.
...
type AndroidenterpriseStorelayoutclustersInsertRequest struct {
...
type AndroidenterpriseStorelayoutclustersInsertResponse struct {
	ContentType string
	StatusCode  int
