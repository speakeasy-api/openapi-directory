...
from ..shared import getjournalentrydetailtype as shared_getjournalentrydetailtype
...
class GETSummaryJournalEntryResponse:
    ...
    get_journal_entry_detail_type: Optional[shared_getjournalentrydetailtype.GETJournalEntryDetailType] = dataclasses.field(default=None)  
