 ...
 */
export enum LicensesListResponseWarningCodeEnum {
...
export class LicensesListResponseWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class LicensesListResponseWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: LicensesListResponseWarningData })
  @Expose({ name: "data" })
