...
public class General {
    ...
    **/
    public openapisdk.models.operations.PostTransfersResponse postTransfers(openapisdk.models.operations.PostTransfersRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/transfers");
        ...
        openapisdk.models.operations.PostTransfersResponse res = new openapisdk.models.operations.PostTransfersResponse() {{
            transfer = null;
