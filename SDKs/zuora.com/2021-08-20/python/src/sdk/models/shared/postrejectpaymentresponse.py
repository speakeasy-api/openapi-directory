...
class PostRejectPaymentResponseFinanceInformation:
    r"""PostRejectPaymentResponseFinanceInformation
    ...
    transferred_to_accounting: Optional[PostRejectPaymentResponseFinanceInformationTransferredToAccountingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('transferredToAccounting') }})
...
class PostRejectPaymentResponse:
    ...
    finance_information: Optional[PostRejectPaymentResponseFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('financeInformation') }})
    ...
    gateway_state: Optional[PostRejectPaymentResponseGatewayStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('gatewayState') }})
    ...
    method_type: Optional[PostRejectPaymentResponseMethodTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('methodType') }})
    ...
    type: Optional[PostRejectPaymentResponseTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
