...
var OperationsLog = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=candidate_committee_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=status_num" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=summary_data_complete_date" }),
        __metadata("design:type", Date)
    ], OperationsLog.prototype, "summaryDataCompleteDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=summary_data_verification_date" }),
        __metadata("design:type", Date)
    ], OperationsLog.prototype, "summaryDataVerificationDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=transaction_data_complete_date" }),
        __metadata("design:type", Date)
