...
from ..shared import policiesupdateresponse as shared_policiesupdateresponse
...
class DNSPoliciesUpdateSecurity:
    option1: Optional[DNSPoliciesUpdateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSPoliciesUpdateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DNSPoliciesUpdateRequest:
    path_params: DNSPoliciesUpdatePathParams = dataclasses.field()
    query_params: DNSPoliciesUpdateQueryParams = dataclasses.field()
    security: DNSPoliciesUpdateSecurity = dataclasses.field()
...
class DNSPoliciesUpdateResponse:
    ...
    policies_update_response: Optional[shared_policiesupdateresponse.PoliciesUpdateResponse] = dataclasses.field(default=None)
