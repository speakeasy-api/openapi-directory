...
from ..shared import gettaxformresponse as shared_gettaxformresponse
...
class PostGetTaxFormResponse:
    ...
    get_tax_form_response: Optional[shared_gettaxformresponse.GetTaxFormResponse] = dataclasses.field(default=None)
