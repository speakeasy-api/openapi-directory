...
exports.IpamVlansListResponse = exports.IpamVlansListRequest = exports.IpamVlansList200ApplicationJson = exports.IpamVlansListQueryParams = void 0;
...
var IpamVlansListQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=vid__gt" }),
        __metadata("design:type", String)
    ], IpamVlansListQueryParams.prototype, "vidGt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=vid__gte" }),
        __metadata("design:type", String)
    ], IpamVlansListQueryParams.prototype, "vidGte", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=vid__lt" }),
        __metadata("design:type", String)
    ], IpamVlansListQueryParams.prototype, "vidLt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=vid__lte" }),
        __metadata("design:type", String)
    ], IpamVlansListQueryParams.prototype, "vidLte", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=vid__n" }),
        __metadata("design:type", String)
    ], IpamVlansListQueryParams.prototype, "vidN", void 0);
    return IpamVlansListQueryParams;
}(utils_1.SpeakeasyBase));
exports.IpamVlansListQueryParams = IpamVlansListQueryParams;
var IpamVlansList200ApplicationJson = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=results", elemType: shared.Vlan }),
