...
class ListRatePlanListRatePlanResponse:
    ...
    meta: Optional[ListRatePlanListRatePlanResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    rate_plans: Optional[list[shared_wireless_v1_rate_plan.WirelessV1RatePlan]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rate_plans'), 'exclude': lambda f: f is None }})  
