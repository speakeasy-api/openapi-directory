...
class GoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfig:
    ...
    speech_contexts: Optional[list[shared_googlecloudvideointelligencev1p2beta1_speechcontext.GoogleCloudVideointelligenceV1p2beta1SpeechContext]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('speechContexts') }})
