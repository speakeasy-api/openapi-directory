...
class ReplicapoolPoolsDeleteRequest:
    ...
    pools_delete_request: Optional[shared_poolsdeleterequest.PoolsDeleteRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
