 ...
 */
public enum UpdateSlackChannelConfigurationRequestBodyNotifyOnCaseSeverityEnum {
    NONE("none"),
    ALL("all"),
    HIGH("high");
    ...
    private UpdateSlackChannelConfigurationRequestBodyNotifyOnCaseSeverityEnum(String value) {
        this.value = value;
    }
}
