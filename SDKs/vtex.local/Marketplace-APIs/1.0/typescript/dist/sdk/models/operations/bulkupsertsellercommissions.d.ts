...
export declare class BulkUpsertSellerCommissionsRequest extends SpeakeasyBase {
    /**
...
export declare class BulkUpsertSellerCommissionsResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
