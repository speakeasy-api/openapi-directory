...
export class GetMerchantsMerchantIdApiCredentialsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetMerchantsMerchantIdApiCredentialsRequest extends SpeakeasyBase {
  /**
...
export class GetMerchantsMerchantIdApiCredentialsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
