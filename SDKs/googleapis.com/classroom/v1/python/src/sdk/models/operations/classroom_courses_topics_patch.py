...
class ClassroomCoursesTopicsPatchRequest:
    path_params: ClassroomCoursesTopicsPatchPathParams = dataclasses.field()
    query_params: ClassroomCoursesTopicsPatchQueryParams = dataclasses.field()
    security: ClassroomCoursesTopicsPatchSecurity = dataclasses.field()
