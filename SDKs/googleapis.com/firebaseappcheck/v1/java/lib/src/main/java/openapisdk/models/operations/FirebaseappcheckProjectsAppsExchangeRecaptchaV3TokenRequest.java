...
public class FirebaseappcheckProjectsAppsExchangeRecaptchaV3TokenRequest {
    ...
    public openapisdk.models.shared.GoogleFirebaseAppcheckV1ExchangeRecaptchaV3TokenRequest request;
    public FirebaseappcheckProjectsAppsExchangeRecaptchaV3TokenRequest withRequest(openapisdk.models.shared.GoogleFirebaseAppcheckV1ExchangeRecaptchaV3TokenRequest request) {
