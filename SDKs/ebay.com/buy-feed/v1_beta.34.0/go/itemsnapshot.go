...
func (s *itemSnapshot) GetItemSnapshotFeed(ctx context.Context, request operations.GetItemSnapshotFeedRequest) (*operations.GetItemSnapshotFeedResponse, error) {
	baseURL := s.serverURL
