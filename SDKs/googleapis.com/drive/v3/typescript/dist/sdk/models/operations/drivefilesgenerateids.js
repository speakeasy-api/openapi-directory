...
exports.DriveFilesGenerateIdsResponse = exports.DriveFilesGenerateIdsRequest = exports.DriveFilesGenerateIdsSecurity = exports.DriveFilesGenerateIdsSecurityOption3 = exports.DriveFilesGenerateIdsSecurityOption2 = exports.DriveFilesGenerateIdsSecurityOption1 = void 0;
...
var DriveFilesGenerateIdsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DriveFilesGenerateIdsRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=count" }),
        __metadata("design:type", Number)
    ], DriveFilesGenerateIdsRequest.prototype, "count", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], DriveFilesGenerateIdsRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], DriveFilesGenerateIdsRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], DriveFilesGenerateIdsRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], DriveFilesGenerateIdsRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], DriveFilesGenerateIdsRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=space" }),
        __metadata("design:type", String)
    ], DriveFilesGenerateIdsRequest.prototype, "space", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=type" }),
        __metadata("design:type", String)
    ], DriveFilesGenerateIdsRequest.prototype, "type", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], DriveFilesGenerateIdsRequest.prototype, "userIp", void 0);
...
var DriveFilesGenerateIdsResponse = /** @class */ (function (_super) {
    ...
    ], DriveFilesGenerateIdsResponse.prototype, "rawResponse", void 0);
