...
class ListUsersRequest:
    path_params: ListUsersPathParams = dataclasses.field()
...
class ListUsersResponse:
    ...
    list_users_200_application_json_any: Optional[Any] = dataclasses.field(default=None)
