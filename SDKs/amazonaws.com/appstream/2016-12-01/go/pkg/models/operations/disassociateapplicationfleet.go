...
type DisassociateApplicationFleetHeaders struct {
...
type DisassociateApplicationFleetRequest struct {
	Headers DisassociateApplicationFleetHeaders
	Request shared.DisassociateApplicationFleetRequest `request:"mediaType=application/json"`
}
