...
export class FilesOneSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FilesOneRequest extends SpeakeasyBase {
  /**
...
export class FilesOneResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
