...
public class CreateChannelCreateChannelRequest {
    ...
    public CreateChannelCreateChannelRequest(@JsonProperty("ChatFriendlyName") String chatFriendlyName, @JsonProperty("ChatUserFriendlyName") String chatUserFriendlyName, @JsonProperty("FlexFlowSid") String flexFlowSid, @JsonProperty("Identity") String identity) {
        this.chatFriendlyName = chatFriendlyName;
        this.chatUserFriendlyName = chatUserFriendlyName;
        this.flexFlowSid = flexFlowSid;
        this.identity = identity;
