...
class Error:
    ...
    point_count: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pointCount'), 'exclude': lambda f: f is None }})
    r"""The number of points that couldn't be written because of status."""  
