...
from ..shared import updatecompanyresponse as shared_updatecompanyresponse
...
class CompaniesUpdateRequest:
    ...
    company_input: shared_company.CompanyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class CompaniesUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_company_response: Optional[shared_updatecompanyresponse.UpdateCompanyResponse] = dataclasses.field(default=None)
    r"""Company updated"""  
