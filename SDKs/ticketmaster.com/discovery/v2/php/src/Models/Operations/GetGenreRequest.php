...
class GetGenreRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetGenreIncludeLicensedContentEnum $includeLicensedContent
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=includeLicensedContent')]
    public ?GetGenreIncludeLicensedContentEnum $includeLicensedContent = null;
