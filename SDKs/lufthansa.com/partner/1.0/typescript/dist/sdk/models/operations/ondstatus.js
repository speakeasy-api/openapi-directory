...
exports.ONDStatusResponse = exports.ONDStatusRequest = exports.ONDStatusSecurity = void 0;
...
var ONDStatusRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ONDStatusRequest.prototype, "accept", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=catalogues",
        }),
        __metadata("design:type", String)
    ], ONDStatusRequest.prototype, "catalogues", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=new-routes",
        }),
        __metadata("design:type", String)
    ], ONDStatusRequest.prototype, "newRoutes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=old-routes",
        }),
        __metadata("design:type", String)
    ], ONDStatusRequest.prototype, "oldRoutes", void 0);
...
var ONDStatusResponse = /** @class */ (function (_super) {
    ...
    ], ONDStatusResponse.prototype, "rawResponse", void 0);
