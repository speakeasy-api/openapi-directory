...
class GetResourcePermissionResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetResourcePermissionOutput $getResourcePermissionOutput
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetResourcePermissionOutput $getResourcePermissionOutput = null;
	...
	{
		$this->contentType = "";
		$this->getResourcePermissionOutput = null;
