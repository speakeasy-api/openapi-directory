...
**/
export declare class GetLabelByExternalShipmentIdResponseBodyOptionalLink extends SpeakeasyBase {
    href: string;
    type?: string;
}
/**
 ...
 *
**/
export declare class GetLabelByExternalShipmentIdResponseBodyMonetaryValue extends SpeakeasyBase {
    amount: number;
 ...
 *
**/
export declare class GetLabelByExternalShipmentIdResponseBodyLabelDownload extends SpeakeasyBase {
    href?: string;
    pdf?: string;
    png?: string;
    zpl?: string;
 ...
 *
**/
export declare class GetLabelByExternalShipmentIdResponseBodyOutput extends SpeakeasyBase {
    ...
    formDownload?: GetLabelByExternalShipmentIdResponseBodyOptionalLink;
    insuranceClaim?: GetLabelByExternalShipmentIdResponseBodyOptionalLink;
    insuranceCost?: GetLabelByExternalShipmentIdResponseBodyMonetaryValue;
    isInternational?: boolean;
    isReturnLabel?: boolean;
    labelDownload?: GetLabelByExternalShipmentIdResponseBodyLabelDownload;
    ...
    shipmentCost?: GetLabelByExternalShipmentIdResponseBodyMonetaryValue;
