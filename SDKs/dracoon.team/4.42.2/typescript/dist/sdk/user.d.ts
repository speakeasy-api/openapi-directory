...
export declare class User {
     ...
     * None.
     */
    confirmTotpSetup(req: operations.ConfirmTotpSetupRequest, config?: AxiosRequestConfig): Promise<operations.ConfirmTotpSetupResponse>;
    /**
     ...
     * None.
     */
    deleteMfaTotpSetup(req: operations.DeleteMfaTotpSetupRequest, config?: AxiosRequestConfig): Promise<operations.DeleteMfaTotpSetupResponse>;
    /**
     ...
     * None.
     */
    getMfaStatusForUser(req: operations.GetMfaStatusForUserRequest, config?: AxiosRequestConfig): Promise<operations.GetMfaStatusForUserResponse>;
    /**
     ...
     * None.
     */
    getTotpSetupInformation(req: operations.GetTotpSetupInformationRequest, config?: AxiosRequestConfig): Promise<operations.GetTotpSetupInformationResponse>;
    /**
     ...
     */
    requestCustomerKeyPair(req: operations.RequestCustomerKeyPairRequest, config?: AxiosRequestConfig): Promise<operations.RequestCustomerKeyPairResponse>;
    /**
     ...
     * The private key is password-based encrypted with `AES256` / `PBKDF2`.
     */
    requestUserKeyPair(req: operations.RequestUserKeyPairRequest, config?: AxiosRequestConfig): Promise<operations.RequestUserKeyPairResponse>;
    /**
     ...
     * None.
     */
    requestUserKeyPairs(req: operations.RequestUserKeyPairsRequest, config?: AxiosRequestConfig): Promise<operations.RequestUserKeyPairsResponse>;
    /**
     * Reset avatar
     *
     * @remarks
     ...
     *
     */
    useEmergencyCode(req: operations.UseEmergencyCodeRequest, config?: AxiosRequestConfig): Promise<operations.UseEmergencyCodeResponse>;
}
