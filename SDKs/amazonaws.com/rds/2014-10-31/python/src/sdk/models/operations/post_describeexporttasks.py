...
class PostDescribeExportTasksQueryParams:
    action: PostDescribeExportTasksActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeExportTasksVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeExportTasksRequest:
    headers: PostDescribeExportTasksHeaders = dataclasses.field()
    query_params: PostDescribeExportTasksQueryParams = dataclasses.field()
