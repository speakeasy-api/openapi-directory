...
public class GetReportsEntityTypeQueryParams {
    ...
    public GetReportsEntityTypeQueryParams withCommitteeType(String[] committeeType) {
    ...
    public GetReportsEntityTypeQueryParams withQFiler(String[] qFiler) {
        this.qFiler = qFiler;
        return this;
    }
    ...
    public GetReportsEntityTypeQueryParams withQSpender(String[] qSpender) {
