...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/api.gov.uk/vehicle-enquiry/1.1.0/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/api.gov.uk/vehicle-enquiry/1.1.0/typescript
```
