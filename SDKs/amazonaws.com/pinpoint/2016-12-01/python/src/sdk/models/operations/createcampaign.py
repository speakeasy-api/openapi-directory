...
class CreateCampaignRequestBodyWriteCampaignRequest:
    r"""CreateCampaignRequestBodyWriteCampaignRequest
...
class CreateCampaignRequestBody:
    write_campaign_request: CreateCampaignRequestBodyWriteCampaignRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('WriteCampaignRequest') }})
    

@dataclasses.dataclass
class CreateCampaignRequest:
    headers: CreateCampaignHeaders = dataclasses.field()
    path_params: CreateCampaignPathParams = dataclasses.field()
    request: CreateCampaignRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
