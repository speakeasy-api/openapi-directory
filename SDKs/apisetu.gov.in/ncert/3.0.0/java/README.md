    ...
    public static void main(String[] args) {
        try {
            ...
            MrcerRequestBody req = new MrcerRequestBody(MrcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new MrcerRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "22018207", "2018");;
            ...
            MrcerResponse res = sdk.apIs.mrcer(req, new MrcerSecurity("molestiae", "minus") {{
