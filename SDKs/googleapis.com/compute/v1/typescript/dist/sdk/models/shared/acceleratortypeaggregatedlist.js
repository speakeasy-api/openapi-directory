...
exports.AcceleratorTypeAggregatedList = exports.AcceleratorTypeAggregatedListWarning = exports.AcceleratorTypeAggregatedListWarningData = exports.AcceleratorTypeAggregatedListWarningCodeEnum = void 0;
var utils_1 = require("../../../internal/utils");
var acceleratortypesscopedlist_1 = require("./acceleratortypesscopedlist");
var class_transformer_1 = require("class-transformer");
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
var AcceleratorTypeAggregatedListWarningCodeEnum;
(function (AcceleratorTypeAggregatedListWarningCodeEnum) {
...
})(AcceleratorTypeAggregatedListWarningCodeEnum = exports.AcceleratorTypeAggregatedListWarningCodeEnum || (exports.AcceleratorTypeAggregatedListWarningCodeEnum = {}));
var AcceleratorTypeAggregatedListWarningData = /** @class */ (function (_super) {
    __extends(AcceleratorTypeAggregatedListWarningData, _super);
    function AcceleratorTypeAggregatedListWarningData() {
    ...
    ], AcceleratorTypeAggregatedListWarningData.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "value" }),
        __metadata("design:type", String)
    ], AcceleratorTypeAggregatedListWarningData.prototype, "value", void 0);
    return AcceleratorTypeAggregatedListWarningData;
}(utils_1.SpeakeasyBase));
exports.AcceleratorTypeAggregatedListWarningData = AcceleratorTypeAggregatedListWarningData;
/**
 * [Output Only] Informational warning message.
 */
var AcceleratorTypeAggregatedListWarning = /** @class */ (function (_super) {
    __extends(AcceleratorTypeAggregatedListWarning, _super);
    function AcceleratorTypeAggregatedListWarning() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", String)
    ], AcceleratorTypeAggregatedListWarning.prototype, "code", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: AcceleratorTypeAggregatedListWarningData }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return AcceleratorTypeAggregatedListWarningData; }),
        __metadata("design:type", Array)
    ], AcceleratorTypeAggregatedListWarning.prototype, "data", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "message" }),
        __metadata("design:type", String)
    ], AcceleratorTypeAggregatedListWarning.prototype, "message", void 0);
    return AcceleratorTypeAggregatedListWarning;
}(utils_1.SpeakeasyBase));
exports.AcceleratorTypeAggregatedListWarning = AcceleratorTypeAggregatedListWarning;
/**
 * Successful response
 */
var AcceleratorTypeAggregatedList = /** @class */ (function (_super) {
    __extends(AcceleratorTypeAggregatedList, _super);
    function AcceleratorTypeAggregatedList() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", String)
    ], AcceleratorTypeAggregatedList.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: acceleratortypesscopedlist_1.AcceleratorTypesScopedList }),
        (0, class_transformer_1.Expose)({ name: "items" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], acceleratortypesscopedlist_1.AcceleratorTypesScopedList);
            }
            return obj;
        }, { toClassOnly: true }),
        __metadata("design:type", Object)
    ], AcceleratorTypeAggregatedList.prototype, "items", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kind" }),
        __metadata("design:type", String)
    ], AcceleratorTypeAggregatedList.prototype, "kind", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "nextPageToken" }),
        __metadata("design:type", String)
    ], AcceleratorTypeAggregatedList.prototype, "nextPageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "selfLink" }),
        __metadata("design:type", String)
    ], AcceleratorTypeAggregatedList.prototype, "selfLink", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "unreachables" }),
        __metadata("design:type", Array)
    ], AcceleratorTypeAggregatedList.prototype, "unreachables", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "warning" }),
        (0, class_transformer_1.Type)(function () { return AcceleratorTypeAggregatedListWarning; }),
        __metadata("design:type", AcceleratorTypeAggregatedListWarning)
    ], AcceleratorTypeAggregatedList.prototype, "warning", void 0);
    return AcceleratorTypeAggregatedList;
}(utils_1.SpeakeasyBase));
exports.AcceleratorTypeAggregatedList = AcceleratorTypeAggregatedList;
