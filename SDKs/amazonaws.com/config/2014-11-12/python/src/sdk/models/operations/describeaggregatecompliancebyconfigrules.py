...
class DescribeAggregateComplianceByConfigRulesRequest:
    ...
    describe_aggregate_compliance_by_config_rules_request: shared_describeaggregatecompliancebyconfigrulesrequest.DescribeAggregateComplianceByConfigRulesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
