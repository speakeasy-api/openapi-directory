...
class ListActivityRequest:
    ...
    r"""The SID of the Workspace with the Activity resources to read."""  
    available: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'Available', 'style': 'form', 'explode': True }})
    r"""Whether return only Activity resources that are available or unavailable. A value of `true` returns only available activities. Values of '1' or `yes` also indicate `true`. All other values represent `false` and return activities that are unavailable."""  
    ...
    r"""The `friendly_name` of the Activity resources to read."""  
...
class ListActivityListActivityResponse:
    ...
    activities: Optional[list[shared_taskrouter_v1_workspace_activity.TaskrouterV1WorkspaceActivity]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('activities'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListActivityListActivityResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
