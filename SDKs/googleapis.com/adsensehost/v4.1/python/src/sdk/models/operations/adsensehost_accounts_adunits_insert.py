...
class AdsensehostAccountsAdunitsInsertRequest:
    path_params: AdsensehostAccountsAdunitsInsertPathParams = dataclasses.field()
    query_params: AdsensehostAccountsAdunitsInsertQueryParams = dataclasses.field()
    security: AdsensehostAccountsAdunitsInsertSecurity = dataclasses.field()
