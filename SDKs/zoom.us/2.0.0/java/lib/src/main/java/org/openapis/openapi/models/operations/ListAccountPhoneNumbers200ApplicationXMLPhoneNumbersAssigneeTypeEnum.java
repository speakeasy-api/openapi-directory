 ...
 */
public enum ListAccountPhoneNumbers200ApplicationXMLPhoneNumbersAssigneeTypeEnum {
    USER("user"),
    ...
    private ListAccountPhoneNumbers200ApplicationXMLPhoneNumbersAssigneeTypeEnum(String value) {
        this.value = value;
    }
}
