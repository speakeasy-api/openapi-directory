...
class ListConnectAppRequest:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the ConnectApp resources to read."""  
...
class ListConnectAppListConnectAppResponse:
    ...
    connect_apps: Optional[list[shared_api_v2010_account_connect_app.APIV2010AccountConnectApp]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connect_apps'), 'exclude': lambda f: f is None }})  
