...
from ..shared import androidappsresponse as shared_androidappsresponse
...
@dataclasses.dataclass
class GetCompaniesCompanyIDAndroidAppsRequest:
...
class GetCompaniesCompanyIDAndroidAppsResponse:
    ...
    android_apps_response: Optional[shared_androidappsresponse.AndroidAppsResponse] = dataclasses.field(default=None)
