...
var Manage = /** @class */ (function () {
    ...
    **/
    Manage.prototype.addClutter = function (req, config) {
        var _a;
    ...
    **/
    Manage.prototype.delete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Warning! you could lose data. This function will delete the entry from the database and the file from the disk. Accidental deletion can be reversed by contacting support with biscuits who maintain an offsite backup.
    **/
    Manage.prototype.deleteNetwork = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Manage.prototype.export = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Manage.prototype.list = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
