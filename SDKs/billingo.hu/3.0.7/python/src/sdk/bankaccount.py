...
class BankAccount:
    ...
    def create_bank_account(self, request: operations.CreateBankAccountRequest) -> operations.CreateBankAccountResponse:
        ...
        if r.status_code == 201:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BankAccount])
    ...
    def delete_bank_account(self, request: operations.DeleteBankAccountRequest) -> operations.DeleteBankAccountResponse:
        ...
        url = utils.generate_url(base_url, "/bank-accounts/{id}", request.path_params)
    ...
    def list_bank_account(self, request: operations.ListBankAccountRequest) -> operations.ListBankAccountResponse:
        ...
        res = operations.ListBankAccountResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BankAccountList])
    ...
    def update_bank_account(self, request: operations.UpdateBankAccountRequest) -> operations.UpdateBankAccountResponse:
        ...
        res = operations.UpdateBankAccountResponse(status_code=r.status_code, content_type=content_type)
