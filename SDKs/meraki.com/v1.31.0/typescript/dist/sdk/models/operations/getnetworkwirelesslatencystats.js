...
exports.GetNetworkWirelessLatencyStatsResponse = exports.GetNetworkWirelessLatencyStatsRequest = exports.GetNetworkWirelessLatencyStatsBandEnum = void 0;
...
(function (GetNetworkWirelessLatencyStatsBandEnum) {
    ...
    GetNetworkWirelessLatencyStatsBandEnum["Six"] = "6";
...
var GetNetworkWirelessLatencyStatsRequest = /** @class */ (function (_super) {
    ...
    ], GetNetworkWirelessLatencyStatsRequest.prototype, "apTag", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=band" }),
        __metadata("design:type", String)
    ], GetNetworkWirelessLatencyStatsRequest.prototype, "band", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], GetNetworkWirelessLatencyStatsRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=networkId",
        }),
        __metadata("design:type", String)
    ], GetNetworkWirelessLatencyStatsRequest.prototype, "networkId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ssid" }),
        __metadata("design:type", Number)
    ], GetNetworkWirelessLatencyStatsRequest.prototype, "ssid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t0" }),
        __metadata("design:type", String)
    ], GetNetworkWirelessLatencyStatsRequest.prototype, "t0", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t1" }),
        __metadata("design:type", String)
    ], GetNetworkWirelessLatencyStatsRequest.prototype, "t1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timespan",
        }),
        __metadata("design:type", Number)
    ], GetNetworkWirelessLatencyStatsRequest.prototype, "timespan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=vlan" }),
        __metadata("design:type", Number)
    ], GetNetworkWirelessLatencyStatsRequest.prototype, "vlan", void 0);
...
var GetNetworkWirelessLatencyStatsResponse = /** @class */ (function (_super) {
    ...
    ], GetNetworkWirelessLatencyStatsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
