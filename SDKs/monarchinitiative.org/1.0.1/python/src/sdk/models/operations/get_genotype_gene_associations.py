...
class GetGenotypeGeneAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGenotypeGeneAssociationsQueryParams:
...
class GetGenotypeGeneAssociationsRequest:
    path_params: GetGenotypeGeneAssociationsPathParams = dataclasses.field()
    query_params: GetGenotypeGeneAssociationsQueryParams = dataclasses.field()
