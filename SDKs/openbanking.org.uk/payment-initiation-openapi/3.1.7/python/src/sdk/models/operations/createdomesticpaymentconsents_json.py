...
class CreateDomesticPaymentConsentsJSONRequest:
    ...
    ob_write_domestic_consent4: shared_obwritedomesticconsent4.OBWriteDomesticConsent4 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Default"""  
...
@dataclasses.dataclass
class CreateDomesticPaymentConsentsJSONResponse:
