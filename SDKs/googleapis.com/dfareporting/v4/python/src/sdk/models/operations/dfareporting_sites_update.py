...
class DfareportingSitesUpdateRequest:
    path_params: DfareportingSitesUpdatePathParams = dataclasses.field()
    query_params: DfareportingSitesUpdateQueryParams = dataclasses.field()
    security: DfareportingSitesUpdateSecurity = dataclasses.field()
