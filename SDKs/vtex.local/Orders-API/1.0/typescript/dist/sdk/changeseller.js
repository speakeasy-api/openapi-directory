...
exports.ChangeSeller = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var ChangeSeller = /** @class */ (function () {
    function ChangeSeller(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
  ...
  The default period for this window is of 2 days, but it can be configured by the request Update window to change seller.
     */
    ChangeSeller.prototype.getWindowToChangeSeller = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "text/plain")) {
                        res.getWindowToChangeSeller200TextPlainInteger = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
            }
            return res;
  ...
  It is possible to check the current window using the request Get window to change seller.
     */
    ChangeSeller.prototype.updateWindowToChangeSeller = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.ChangeSeller = ChangeSeller;
