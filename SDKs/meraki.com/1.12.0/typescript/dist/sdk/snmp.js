...
var Snmp = /** @class */ (function () {
    function Snmp(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Snmp.prototype.getNetworkSnmp = function (req, config) {
    ...
    **/
    Snmp.prototype.getOrganizationSnmp = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Snmp.prototype.updateNetworkSnmp = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Snmp.prototype.updateOrganizationSnmp = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
