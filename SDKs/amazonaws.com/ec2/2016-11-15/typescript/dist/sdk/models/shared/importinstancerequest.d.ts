 ...
 */
export declare enum ImportInstanceRequestLaunchSpecificationArchitectureEnum {
    I386 = "i386",
    X8664 = "x86_64",
    Arm64 = "arm64",
    X8664Mac = "x86_64_mac",
 ...
 */
export declare enum ImportInstanceRequestLaunchSpecificationInstanceInitiatedShutdownBehaviorEnum {
    Stop = "stop",
    Terminate = "terminate"
}
/**
 ...
 */
export declare enum ImportInstanceRequestLaunchSpecificationInstanceTypeEnum {
    A1Medium = "a1.medium",
    A1Large = "a1.large",
    A1Xlarge = "a1.xlarge",
 ...
 */
export declare enum ImportInstanceRequestLaunchSpecificationPlacementTenancyEnum {
    Default = "default",
    Dedicated = "dedicated",
    Host = "host"
}
 ...
 */
export declare class ImportInstanceRequestLaunchSpecificationPlacement extends SpeakeasyBase {
    affinity?: string;
 ...
 */
export declare class ImportInstanceRequestLaunchSpecificationUserData extends SpeakeasyBase {
    data?: string;
}
/**
 * The launch specification.
 */
export declare class ImportInstanceRequestLaunchSpecification extends SpeakeasyBase {
 ...
 */
export declare enum ImportInstanceRequestPlatformEnum {
    Windows = "Windows"
}
export declare class ImportInstanceRequest extends SpeakeasyBase {
    description?: string;
