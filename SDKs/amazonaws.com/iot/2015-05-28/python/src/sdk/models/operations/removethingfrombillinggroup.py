...
class RemoveThingFromBillingGroupRequestBody:
    ...
    r"""The ARN of the thing to be removed from the billing group."""  
    ...
    r"""The name of the thing to be removed from the billing group."""  
    

@dataclasses.dataclass
class RemoveThingFromBillingGroupRequest:
    
    request_body: RemoveThingFromBillingGroupRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
