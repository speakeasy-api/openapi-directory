...
from ..shared import nodedisableschedulingparameter as shared_nodedisableschedulingparameter
...
class ComputeNodeDisableSchedulingRequest:
    ...
    r"""The id of the compute node that you want to disable task scheduling."""  
    ...
    node_disable_scheduling_parameter: Optional[shared_nodedisableschedulingparameter.NodeDisableSchedulingParameter] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
