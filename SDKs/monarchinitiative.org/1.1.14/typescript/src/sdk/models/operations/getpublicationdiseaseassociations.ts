...
export class GetPublicationDiseaseAssociationsRequest extends SpeakeasyBase {
  /**
...
export class GetPublicationDiseaseAssociationsResponse extends SpeakeasyBase {
  /**
   * Success
   */
  @SpeakeasyMetadata()
