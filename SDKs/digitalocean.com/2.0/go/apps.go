...
func (s *Apps) CreateApp(ctx context.Context, request operations.CreateAppRequest) (*operations.CreateAppResponse, error) {
...
func (s *Apps) CreateDeployment(ctx context.Context, request operations.CreateDeploymentRequest) (*operations.CreateDeploymentResponse, error) {
	baseURL := s._serverURL
...
func (s *Apps) DeleteApp(ctx context.Context, request operations.DeleteAppRequest) (*operations.DeleteAppResponse, error) {
	baseURL := s._serverURL
...
func (s *Apps) GetApp(ctx context.Context, request operations.GetAppRequest) (*operations.GetAppResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/apps/{id}", request.PathParams)
...
func (s *Apps) GetDeployment(ctx context.Context, request operations.GetDeploymentRequest) (*operations.GetDeploymentResponse, error) {
	baseURL := s._serverURL
...
func (s *Apps) GetInstanceSize(ctx context.Context, request operations.GetInstanceSizeRequest) (*operations.GetInstanceSizeResponse, error) {
	baseURL := s._serverURL
...
func (s *Apps) GetLogs(ctx context.Context, request operations.GetLogsRequest) (*operations.GetLogsResponse, error) {
	baseURL := s._serverURL
...
// Retrieve the logs of a past, in-progress, or active deployment. If a component name is specified, the logs will be limited to only that component. The response will include links to either real-time logs of an in-progress or active deployment or archived logs of a past deployment.
func (s *Apps) GetLogsAggregate(ctx context.Context, request operations.GetLogsAggregateRequest) (*operations.GetLogsAggregateResponse, error) {
	baseURL := s._serverURL
...
func (s *Apps) GetTier(ctx context.Context, request operations.GetTierRequest) (*operations.GetTierResponse, error) {
	baseURL := s._serverURL
...
func (s *Apps) ListApps(ctx context.Context, request operations.ListAppsRequest) (*operations.ListAppsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/apps"
...
func (s *Apps) ListDeployments(ctx context.Context, request operations.ListDeploymentsRequest) (*operations.ListDeploymentsResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/apps/{app_id}/deployments", request.PathParams)
...
func (s *Apps) ListInstanceSizes(ctx context.Context) (*operations.ListInstanceSizesResponse, error) {
	baseURL := s._serverURL
...
func (s *Apps) ListRegions(ctx context.Context) (*operations.ListRegionsResponse, error) {
	baseURL := s._serverURL
...
// List all app tiers.
func (s *Apps) ListTiers(ctx context.Context) (*operations.ListTiersResponse, error) {
	baseURL := s._serverURL
...
func (s *Apps) PostCancelDeployment(ctx context.Context, request operations.PostCancelDeploymentRequest) (*operations.PostCancelDeploymentResponse, error) {
	baseURL := s._serverURL
...
func (s *Apps) UpdateApp(ctx context.Context, request operations.UpdateAppRequest) (*operations.UpdateAppResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/apps/{id}", request.PathParams)
...
func (s *Apps) ValidateAppSpec(ctx context.Context, request operations.ValidateAppSpecRequest) (*operations.ValidateAppSpecResponse, error) {
	baseURL := s._serverURL
