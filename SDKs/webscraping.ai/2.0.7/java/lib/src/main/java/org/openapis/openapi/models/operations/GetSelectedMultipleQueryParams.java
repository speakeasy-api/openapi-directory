...
public class GetSelectedMultipleQueryParams {
    ...
    public GetSelectedMultipleQueryParams withCountry(org.openapis.openapi.models.shared.CountryEnum country) {
    ...
    public GetSelectedMultipleQueryParams withDevice(org.openapis.openapi.models.shared.DeviceEnum device) {
        this.device = device;
        return this;
    }
    ...
    public GetSelectedMultipleQueryParams withErrorOn404(Boolean errorOn404) {
    ...
    public GetSelectedMultipleQueryParams withErrorOnRedirect(Boolean errorOnRedirect) {
    ...
    public GetSelectedMultipleQueryParams withJsTimeout(Long jsTimeout) {
    ...
    public GetSelectedMultipleQueryParams withProxy(org.openapis.openapi.models.shared.ProxyEnum proxy) {
        this.proxy = proxy;
        return this;
    }
