...
func (e POSTGetReservedNodeExchangeConfigurationOptionsActionEnum) ToPointer() *POSTGetReservedNodeExchangeConfigurationOptionsActionEnum {
	return &e
}
...
func (e *POSTGetReservedNodeExchangeConfigurationOptionsActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "GetReservedNodeExchangeConfigurationOptions":
		*e = POSTGetReservedNodeExchangeConfigurationOptionsActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTGetReservedNodeExchangeConfigurationOptionsActionEnum: %v", v)
	}
}
...
func (e POSTGetReservedNodeExchangeConfigurationOptionsVersionEnum) ToPointer() *POSTGetReservedNodeExchangeConfigurationOptionsVersionEnum {
	return &e
}
...
func (e *POSTGetReservedNodeExchangeConfigurationOptionsVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2012-12-01":
		*e = POSTGetReservedNodeExchangeConfigurationOptionsVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTGetReservedNodeExchangeConfigurationOptionsVersionEnum: %v", v)
	}
}
