...
class ActionsListArtifactsForRepoRequest:
    path_params: ActionsListArtifactsForRepoPathParams = dataclasses.field()
    query_params: ActionsListArtifactsForRepoQueryParams = dataclasses.field()
...
class ActionsListArtifactsForRepoResponse:
    ...
    actions_list_artifacts_for_repo_200_application_json_object: Optional[ActionsListArtifactsForRepo200ApplicationJSON] = dataclasses.field(default=None)
