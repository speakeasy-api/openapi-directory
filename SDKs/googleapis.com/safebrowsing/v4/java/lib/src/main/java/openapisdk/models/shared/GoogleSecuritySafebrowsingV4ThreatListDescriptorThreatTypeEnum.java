...
public enum GoogleSecuritySafebrowsingV4ThreatListDescriptorThreatTypeEnum {
    ...
    private GoogleSecuritySafebrowsingV4ThreatListDescriptorThreatTypeEnum(String value) {
        this.value = value;
    }
}
