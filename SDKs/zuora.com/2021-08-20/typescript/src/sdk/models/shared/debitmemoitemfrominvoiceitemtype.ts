 ...
 *
 */
export class DebitMemoItemFromInvoiceItemTypeFinanceInformation extends SpeakeasyBase {
  /**
 ...
 *
 */
export enum DebitMemoItemFromInvoiceItemTypeTaxModeEnum {
 ...
 *
 */
export class DebitMemoItemFromInvoiceItemType extends SpeakeasyBase {
  /**
   ...
   *
   */
  @SpeakeasyMetadata({ elemType: DebitMemoTaxItemFromInvoiceTaxItemType })
