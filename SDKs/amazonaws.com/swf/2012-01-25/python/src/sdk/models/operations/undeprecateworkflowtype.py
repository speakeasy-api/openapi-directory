...
class UndeprecateWorkflowTypeRequest:
    ...
    undeprecate_workflow_type_input: shared_undeprecateworkflowtypeinput.UndeprecateWorkflowTypeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
