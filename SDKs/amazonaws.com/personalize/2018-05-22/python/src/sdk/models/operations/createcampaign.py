...
class CreateCampaignXAmzTargetEnum(str, Enum):
    AMAZON_PERSONALIZE_CREATE_CAMPAIGN = "AmazonPersonalize.CreateCampaign"


@dataclasses.dataclass
class CreateCampaignHeaders:
    x_amz_target: CreateCampaignXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
