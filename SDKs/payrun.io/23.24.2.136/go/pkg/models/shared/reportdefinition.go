...
func (e ReportDefinitionReportDefinitionReportQueryGroupGroupOutputAtOutputEnum) ToPointer() *ReportDefinitionReportDefinitionReportQueryGroupGroupOutputAtOutputEnum {
	return &e
}
...
func (e *ReportDefinitionReportDefinitionReportQueryGroupGroupOutputAtOutputEnum) UnmarshalJSON(data []byte) error {
	...
	case "ElementDatePart":
		fallthrough
	case "InnerText":
		*e = ReportDefinitionReportDefinitionReportQueryGroupGroupOutputAtOutputEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ReportDefinitionReportDefinitionReportQueryGroupGroupOutputAtOutputEnum: %v", v)
	}
}
