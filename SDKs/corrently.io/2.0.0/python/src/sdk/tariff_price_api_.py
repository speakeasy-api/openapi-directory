...
class TariffPriceAPI:
    ...
    def tariff_slph0(self, request: operations.TariffSlph0Request) -> operations.TariffSlph0Response:
        ...
        query_params = utils.get_query_params(operations.TariffSlph0Request, request)
        ...
        res = operations.TariffSlph0Response(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.Tariffh0]])
                res.tariffh0s = out

        return res

    def tariffcomponents(self, request: operations.TariffcomponentsRequest) -> operations.TariffcomponentsResponse:
        r"""Energy Tariff price components
        ...
        query_params = utils.get_query_params(operations.TariffcomponentsRequest, request)
        ...
        res = operations.TariffcomponentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.Componentsh0])
