...
class AssessmentReportMetadata:
    ...
    status: Optional[shared_assessmentreportstatus_enum.AssessmentReportStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
