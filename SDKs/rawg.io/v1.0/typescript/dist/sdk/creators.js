...
var Creators = /** @class */ (function () {
    function Creators(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Creators.prototype.creatorsList = function (req, config) {
    ...
    **/
    Creators.prototype.creatorsRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
