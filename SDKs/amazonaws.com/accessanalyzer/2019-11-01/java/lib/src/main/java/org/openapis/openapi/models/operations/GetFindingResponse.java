...
public class GetFindingResponse {
    ...
    public org.openapis.openapi.models.shared.GetFindingResponse getFindingResponse;

    public GetFindingResponse withGetFindingResponse(org.openapis.openapi.models.shared.GetFindingResponse getFindingResponse) {
    ...
    public GetFindingResponse withStatusCode(Integer statusCode) {
    ...
    public GetFindingResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public GetFindingResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
