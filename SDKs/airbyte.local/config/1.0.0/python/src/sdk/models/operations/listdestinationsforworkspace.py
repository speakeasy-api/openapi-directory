...
from ..shared import destinationreadlist as shared_destinationreadlist
...
class ListDestinationsForWorkspaceResponse:
    ...
    destination_read_list: Optional[shared_destinationreadlist.DestinationReadList] = dataclasses.field(default=None)
