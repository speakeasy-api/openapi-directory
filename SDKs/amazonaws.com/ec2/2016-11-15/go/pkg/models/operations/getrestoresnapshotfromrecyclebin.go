...
type GETRestoreSnapshotFromRecycleBinQueryParams struct {
...
type GETRestoreSnapshotFromRecycleBinHeaders struct {
...
type GETRestoreSnapshotFromRecycleBinRequest struct {
	QueryParams GETRestoreSnapshotFromRecycleBinQueryParams
	Headers     GETRestoreSnapshotFromRecycleBinHeaders
}
