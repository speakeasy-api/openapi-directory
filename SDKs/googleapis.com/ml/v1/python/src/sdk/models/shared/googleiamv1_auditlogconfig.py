...
class GoogleIamV1AuditLogConfig:
    ...
    log_type: Optional[GoogleIamV1AuditLogConfigLogTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logType'), 'exclude': lambda f: f is None }})
    r"""The log type that this config enables."""  
