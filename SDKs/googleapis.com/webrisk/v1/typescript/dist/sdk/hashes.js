...
var Hashes = /** @class */ (function () {
    function Hashes(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Hashes.prototype.webriskHashesSearch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.WebriskHashesSearchRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/hashes:search";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.googleCloudWebriskV1SearchHashesResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
