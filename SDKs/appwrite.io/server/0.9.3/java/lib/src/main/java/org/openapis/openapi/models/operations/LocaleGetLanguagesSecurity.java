...
public class LocaleGetLanguagesSecurity {
    ...
    public LocaleGetLanguagesSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public LocaleGetLanguagesSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public LocaleGetLanguagesSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public LocaleGetLanguagesSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
