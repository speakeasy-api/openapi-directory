...
class ListUsAppToPersonListUsAppToPersonResponse:
    ...
    compliance: Optional[list[shared_messaging_v1_service_us_app_to_person.MessagingV1ServiceUsAppToPerson]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('compliance'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListUsAppToPersonListUsAppToPersonResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
