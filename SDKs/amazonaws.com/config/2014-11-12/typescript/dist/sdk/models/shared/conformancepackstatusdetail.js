...
var ConformancePackStatusDetail = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ConformancePackState" }),
        __metadata("design:type", String)
    ], ConformancePackStatusDetail.prototype, "conformancePackState", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ConformancePackStatusReason" }),
        __metadata("design:type", String)
    ], ConformancePackStatusDetail.prototype, "conformancePackStatusReason", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "LastUpdateCompletedTime" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "StackArn" }),
        __metadata("design:type", String)
