...
var Operations = /** @class */ (function () {
     ...
     */
    Operations.prototype.cloudresourcemanagerOperationsGet = function (req, security, config) {
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.CloudresourcemanagerOperationsGetSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.CloudresourcemanagerOperationsGetResponse({
