...
public class ProductResponse {
    ...
    public ProductResponse(@JsonProperty("created") OffsetDateTime created, @JsonProperty("etag") String etag, @JsonProperty("name") String name, @JsonProperty("updated") OffsetDateTime updated, @JsonProperty("uuid") String uuid, @JsonProperty("variants") VariantDTO[] variants) {
        this.created = created;
        this.etag = etag;
        this.name = name;
        this.updated = updated;
