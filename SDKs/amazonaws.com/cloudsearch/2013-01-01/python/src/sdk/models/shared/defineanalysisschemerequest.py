...
class DefineAnalysisSchemeRequest:
    r"""Container for the parameters to the <code><a>DefineAnalysisScheme</a></code> operation. Specifies the name of the domain you want to update and the analysis scheme configuration."""
    
    analysis_scheme: shared_analysisscheme.AnalysisScheme = dataclasses.field()
