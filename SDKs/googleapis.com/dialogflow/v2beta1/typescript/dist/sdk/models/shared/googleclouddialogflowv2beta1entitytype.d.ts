 ...
 */
export declare enum GoogleCloudDialogflowV2beta1EntityTypeAutoExpansionModeEnum {
 ...
 */
export declare enum GoogleCloudDialogflowV2beta1EntityTypeKindEnum {
 ...
 */
export declare class GoogleCloudDialogflowV2beta1EntityType extends SpeakeasyBase {
    /**
     * Optional. Indicates whether the entity type can be automatically expanded.
     */
