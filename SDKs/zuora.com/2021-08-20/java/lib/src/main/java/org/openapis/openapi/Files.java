...
public class Files {
    ...
    public org.openapis.openapi.models.operations.GETFilesResponse getFiles(org.openapis.openapi.models.operations.GETFilesRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GETFilesPathParams.class, baseUrl, "/v1/files/{file-id}", request.pathParams, null);
