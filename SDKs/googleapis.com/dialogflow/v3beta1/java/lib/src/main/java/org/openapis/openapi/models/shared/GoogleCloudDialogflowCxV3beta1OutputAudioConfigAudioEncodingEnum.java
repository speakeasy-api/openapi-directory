 ...
 */
public enum GoogleCloudDialogflowCxV3beta1OutputAudioConfigAudioEncodingEnum {
    ...
    private GoogleCloudDialogflowCxV3beta1OutputAudioConfigAudioEncodingEnum(String value) {
        this.value = value;
    }
}
