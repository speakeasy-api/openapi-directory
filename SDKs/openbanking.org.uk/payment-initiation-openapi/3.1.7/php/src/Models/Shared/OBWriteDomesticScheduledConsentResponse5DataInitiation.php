...
class OBWriteDomesticScheduledConsentResponse5DataInitiation
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsentResponse5DataInitiationCreditorAccount $creditorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('CreditorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsentResponse5DataInitiationCreditorAccount')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsentResponse5DataInitiationDebtorAccount $debtorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('DebtorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsentResponse5DataInitiationDebtorAccount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteDomesticScheduledConsentResponse5DataInitiationDebtorAccount $debtorAccount = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsentResponse5DataInitiationInstructedAmount $instructedAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('InstructedAmount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsentResponse5DataInitiationInstructedAmount')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsentResponse5DataInitiationRemittanceInformation $remittanceInformation
     */
	#[\JMS\Serializer\Annotation\SerializedName('RemittanceInformation')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsentResponse5DataInitiationRemittanceInformation')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteDomesticScheduledConsentResponse5DataInitiationRemittanceInformation $remittanceInformation = null;
	...
	{
		$this->creditorAccount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsentResponse5DataInitiationCreditorAccount();
		$this->creditorPostalAddress = null;
		$this->debtorAccount = null;
		$this->endToEndIdentification = null;
		$this->instructedAmount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsentResponse5DataInitiationInstructedAmount();
