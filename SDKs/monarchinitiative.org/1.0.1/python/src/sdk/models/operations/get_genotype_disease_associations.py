...
class GetGenotypeDiseaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGenotypeDiseaseAssociationsQueryParams:
...
@dataclasses.dataclass
class GetGenotypeDiseaseAssociationsRequest:
    path_params: GetGenotypeDiseaseAssociationsPathParams = dataclasses.field()
    query_params: GetGenotypeDiseaseAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetGenotypeDiseaseAssociationsResponse:
