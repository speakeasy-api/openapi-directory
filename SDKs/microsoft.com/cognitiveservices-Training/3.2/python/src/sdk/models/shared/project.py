...
class Project:
    ...
    status: Optional[ProjectStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class ProjectInput:
    ...
    settings: shared_projectsettings.ProjectSettingsInput = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('settings') }, 'form': { 'field_name': 'settings' }})
    status: Optional[ProjectStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }, 'form': { 'field_name': 'status' }})
