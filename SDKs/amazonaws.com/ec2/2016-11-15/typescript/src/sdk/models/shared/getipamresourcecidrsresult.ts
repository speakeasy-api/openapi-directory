 ...
 */
export enum GetIpamResourceCidrsResultIpamResourceCidrsComplianceStatusEnum {
  Compliant = "compliant",
 ...
 */
export enum GetIpamResourceCidrsResultIpamResourceCidrsManagementStateEnum {
  Managed = "managed",
  Unmanaged = "unmanaged",
  Ignored = "ignored",
}
 ...
 */
export enum GetIpamResourceCidrsResultIpamResourceCidrsOverlapStatusEnum {
 ...
 */
export class GetIpamResourceCidrsResultIpamResourceCidrsResourceTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export enum GetIpamResourceCidrsResultIpamResourceCidrsResourceTypeEnum {
  Vpc = "vpc",
  Subnet = "subnet",
  Eip = "eip",
 ...
 */
export class GetIpamResourceCidrsResultIpamResourceCidrs extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 * Success
 */
export class GetIpamResourceCidrsResult extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: GetIpamResourceCidrsResultIpamResourceCidrs })
