...
func (e *GoogleCloudRetailV2alphaAttributesConfigAttributeConfigLevelEnum) UnmarshalJSON(data []byte) error {
	...
	case "CATALOG_LEVEL_ATTRIBUTE_CONFIG":
		*e = GoogleCloudRetailV2alphaAttributesConfigAttributeConfigLevelEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudRetailV2alphaAttributesConfigAttributeConfigLevelEnum: %s", s)
	}
}
