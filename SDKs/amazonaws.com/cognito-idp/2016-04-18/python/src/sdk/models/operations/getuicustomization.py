...
class GetUICustomizationRequest:
    ...
    get_ui_customization_request: shared_getuicustomizationrequest.GetUICustomizationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
