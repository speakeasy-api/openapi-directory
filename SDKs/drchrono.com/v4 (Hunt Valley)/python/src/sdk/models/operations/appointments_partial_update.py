...
class AppointmentsPartialUpdatePathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class AppointmentsPartialUpdateQueryParams:
...
class AppointmentsPartialUpdateRequest:
    path_params: AppointmentsPartialUpdatePathParams = dataclasses.field()
    query_params: AppointmentsPartialUpdateQueryParams = dataclasses.field()
    security: AppointmentsPartialUpdateSecurity = dataclasses.field()
    

@dataclasses.dataclass
class AppointmentsPartialUpdateResponse:
