...
class GetLifecyclePolicyPreviewRequest:
    ...
    filter: Optional[shared_lifecyclepolicypreviewfilter.LifecyclePolicyPreviewFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filter'), 'exclude': lambda f: f is None }})  
