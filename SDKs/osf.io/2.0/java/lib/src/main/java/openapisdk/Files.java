...
public class Files {
    ...
    **/
    public openapisdk.models.operations.FilesDetailResponse filesDetail(openapisdk.models.operations.FilesDetailRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/files/{file_id}/", request.pathParams);
        ...
        openapisdk.models.operations.FilesDetailResponse res = new openapisdk.models.operations.FilesDetailResponse() {{
            body = null;
        }};
    ...
    **/
    public openapisdk.models.operations.FilesPatchResponse filesPatch(openapisdk.models.operations.FilesPatchRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/files/{file_id}/", request.pathParams);
        ...
        openapisdk.models.operations.FilesPatchResponse res = new openapisdk.models.operations.FilesPatchResponse() {{
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
     ...
     * If the request is unsuccessful, an `errors` key containing information about the failure will be returned. Refer to the [list of error codes](#tag/Errors-and-Error-Codes) to understand why this request may have failed.
    **/
    public openapisdk.models.operations.FilesVersionDetailResponse filesVersionDetail(openapisdk.models.operations.FilesVersionDetailRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/files/{file_id}/versions/{version_id}/", request.pathParams);
        ...
        openapisdk.models.operations.FilesVersionDetailResponse res = new openapisdk.models.operations.FilesVersionDetailResponse() {{
            body = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
     ...
     * If the request is unsuccessful, an `errors` key containing information about the failure will be returned. Refer to the [list of error codes](#tag/Errors-and-Error-Codes) to understand why this request may have failed.
    **/
    public openapisdk.models.operations.FilesVersionsResponse filesVersions(openapisdk.models.operations.FilesVersionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/files/{file_id}/versions/", request.pathParams);
        ...
        openapisdk.models.operations.FilesVersionsResponse res = new openapisdk.models.operations.FilesVersionsResponse() {{
            body = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
