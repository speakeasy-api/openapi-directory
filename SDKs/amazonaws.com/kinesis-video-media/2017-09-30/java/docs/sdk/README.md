    ...
    public static void main(String[] args) {
        try {
            ...
            GetMediaRequest req = new GetMediaRequest(                new GetMediaRequestBody(                new GetMediaRequestBodyStartSelector() {{
                                                afterFragmentNumber = "delectus";
                                                continuationToken = "tempora";
                                                startSelectorType = StartSelectorTypeEnum.PRODUCER_TIMESTAMP;
                                                startTimestamp = OffsetDateTime.parse("2022-03-18T00:29:19.137Z");
                                            }};) {{
                                streamARN = "placeat";
                                streamName = "voluptatum";
                            }};) {{
                xAmzAlgorithm = "iusto";
            ...
            GetMediaResponse res = sdk.sdk.getMedia(req);
