...
class EventTrackerSummary:
    ...
    event_tracker_arn: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('eventTrackerArn') }})
