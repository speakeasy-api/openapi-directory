 ...
 */
public enum CreateReplaceRootVolumeTaskResultReplaceRootVolumeTaskTaskStateEnum {
    PENDING("pending"),
    ...
    private CreateReplaceRootVolumeTaskResultReplaceRootVolumeTaskTaskStateEnum(String value) {
        this.value = value;
    }
}
