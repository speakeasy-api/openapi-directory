...
import { UrlMapsScopedList } from "./urlmapsscopedlist";
import { Expose, Transform, Type } from "class-transformer";

/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export enum UrlMapsAggregatedListWarningCodeEnum {
...
export class UrlMapsAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class UrlMapsAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: UrlMapsAggregatedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: UrlMapsAggregatedListWarningData })
  @Expose({ name: "data" })
  @Type(() => UrlMapsAggregatedListWarningData)
  data?: UrlMapsAggregatedListWarningData[];
 ...
 * Successful response
 */
export class UrlMapsAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: UrlMapsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, UrlMapsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], UrlMapsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
