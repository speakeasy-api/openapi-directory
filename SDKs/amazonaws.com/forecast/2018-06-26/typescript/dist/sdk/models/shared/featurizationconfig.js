...
var FeaturizationConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: featurization_1.Featurization }),
        (0, class_transformer_1.Expose)({ name: "Featurizations" }),
        (0, class_transformer_1.Type)(function () { return featurization_1.Featurization; }),
