...
public class GetApiV2ProgramsSearchQueryParams {
    /**
    ...
    public GetApiV2ProgramsSearchQueryParams withKeywords(String keywords) {
    ...
    public GetApiV2ProgramsSearchQueryParams withPageSize(Integer pageSize) {
    ...
    public GetApiV2ProgramsSearchQueryParams withPageStart(Integer pageStart) {
