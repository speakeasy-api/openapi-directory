...
exports.GetCopyDbSnapshotResponse = exports.GetCopyDbSnapshotRequest = exports.GetCopyDbSnapshotHeaders = exports.GetCopyDbSnapshotQueryParams = exports.GetCopyDbSnapshotVersionEnum = exports.GetCopyDbSnapshotActionEnum = void 0;
var utils_1 = require("../../../internal/utils");
var GetCopyDbSnapshotActionEnum;
(function (GetCopyDbSnapshotActionEnum) {
    GetCopyDbSnapshotActionEnum["CopyDbSnapshot"] = "CopyDBSnapshot";
})(GetCopyDbSnapshotActionEnum = exports.GetCopyDbSnapshotActionEnum || (exports.GetCopyDbSnapshotActionEnum = {}));
var GetCopyDbSnapshotVersionEnum;
(function (GetCopyDbSnapshotVersionEnum) {
    GetCopyDbSnapshotVersionEnum["TwoThousandAndThirteen0212"] = "2013-02-12";
})(GetCopyDbSnapshotVersionEnum = exports.GetCopyDbSnapshotVersionEnum || (exports.GetCopyDbSnapshotVersionEnum = {}));
var GetCopyDbSnapshotQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=SourceDBSnapshotIdentifier" }),
        __metadata("design:type", String)
    ], GetCopyDbSnapshotQueryParams.prototype, "sourceDBSnapshotIdentifier", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=TargetDBSnapshotIdentifier" }),
        __metadata("design:type", String)
...
exports.GetCopyDbSnapshotQueryParams = GetCopyDbSnapshotQueryParams;
...
exports.GetCopyDbSnapshotHeaders = GetCopyDbSnapshotHeaders;
...
exports.GetCopyDbSnapshotRequest = GetCopyDbSnapshotRequest;
...
exports.GetCopyDbSnapshotResponse = GetCopyDbSnapshotResponse;
