...
export enum StartGUISessionXAmzTargetEnum {
  Lightsail20161128StartGUISession = "Lightsail_20161128.StartGUISession",
}

export class StartGUISessionRequest extends SpeakeasyBase {
...
export class StartGUISessionResponse extends SpeakeasyBase {
  /**
