...
exports.GetPortfolioVideosResponse = exports.GetPortfolioVideosRequest = exports.GetPortfolioVideosSortEnum = exports.GetPortfolioVideosFilterEnum = void 0;
...
var GetPortfolioVideosRequest = /** @class */ (function (_super) {
    ...
    ], GetPortfolioVideosRequest.prototype, "containingUri", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetPortfolioVideosRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter_embeddable",
        }),
        __metadata("design:type", Boolean)
    ], GetPortfolioVideosRequest.prototype, "filterEmbeddable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetPortfolioVideosRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetPortfolioVideosRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=portfolio_id",
        }),
        __metadata("design:type", Number)
    ], GetPortfolioVideosRequest.prototype, "portfolioId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetPortfolioVideosRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=user_id",
        }),
        __metadata("design:type", Number)
    ], GetPortfolioVideosRequest.prototype, "userId", void 0);
...
var GetPortfolioVideosResponse = /** @class */ (function (_super) {
    ...
    ], GetPortfolioVideosResponse.prototype, "rawResponse", void 0);
    __decorate([
