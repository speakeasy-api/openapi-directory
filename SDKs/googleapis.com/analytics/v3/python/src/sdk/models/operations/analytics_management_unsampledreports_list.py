...
from ..shared import security as shared_security
from ..shared import unsampledreports as shared_unsampledreports
...
class AnalyticsManagementUnsampledReportsListSecurity:
    option1: Optional[AnalyticsManagementUnsampledReportsListSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementUnsampledReportsListSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[AnalyticsManagementUnsampledReportsListSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class AnalyticsManagementUnsampledReportsListRequest:
    path_params: AnalyticsManagementUnsampledReportsListPathParams = dataclasses.field()
    query_params: AnalyticsManagementUnsampledReportsListQueryParams = dataclasses.field()
    security: AnalyticsManagementUnsampledReportsListSecurity = dataclasses.field()
...
class AnalyticsManagementUnsampledReportsListResponse:
    ...
    unsampled_reports: Optional[shared_unsampledreports.UnsampledReports] = dataclasses.field(default=None)
