...
type ListEnvironmentOutputsQueryParams struct {
	// Pagination token
...
func (e *ListEnvironmentOutputsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AwsProton20200720.ListEnvironmentOutputs":
		*e = ListEnvironmentOutputsXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListEnvironmentOutputsXAmzTargetEnum: %s", s)
	}
}

type ListEnvironmentOutputsHeaders struct {
...
type ListEnvironmentOutputsRequest struct {
	QueryParams ListEnvironmentOutputsQueryParams
	Headers     ListEnvironmentOutputsHeaders
	Request     shared.ListEnvironmentOutputsInput `request:"mediaType=application/json"`
}
