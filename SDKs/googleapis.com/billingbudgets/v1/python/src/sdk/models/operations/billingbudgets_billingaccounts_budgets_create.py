...
class BillingbudgetsBillingAccountsBudgetsCreateRequest:
    ...
    google_cloud_billing_budgets_v1_budget_input: Optional[shared_googlecloudbillingbudgetsv1budget.GoogleCloudBillingBudgetsV1BudgetInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
