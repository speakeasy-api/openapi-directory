 ...
 */
public enum ReposUpdateInformationAboutPagesSiteRequestBody5Source1Enum {
    GH_PAGES("gh-pages"),
    MASTER("master"),
    ...
    private ReposUpdateInformationAboutPagesSiteRequestBody5Source1Enum(String value) {
        this.value = value;
    }
}
