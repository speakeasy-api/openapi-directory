...
SERVERS = [
    ...
    r"""The ACM-PCA multi-region endpoint"""
    "https://acm-pca.{region}.amazonaws.com",
    r"""The ACM-PCA multi-region endpoint"""
    "http://acm-pca.{region}.amazonaws.com.cn",
    r"""The ACM-PCA endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    ...
    def create_certificate_authority(self, request: operations.CreateCertificateAuthorityRequest) -> operations.CreateCertificateAuthorityResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "create_certificate_authority_request", 'json')
        ...
        res = operations.CreateCertificateAuthorityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateCertificateAuthorityResponse])
    ...
    def create_certificate_authority_audit_report(self, request: operations.CreateCertificateAuthorityAuditReportRequest) -> operations.CreateCertificateAuthorityAuditReportResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_certificate_authority_audit_report_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateCertificateAuthorityAuditReportResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateCertificateAuthorityAuditReportResponse])
    ...
    def create_permission(self, request: operations.CreatePermissionRequest) -> operations.CreatePermissionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_permission_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreatePermissionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_certificate_authority(self, request: operations.DeleteCertificateAuthorityRequest) -> operations.DeleteCertificateAuthorityResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_certificate_authority_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteCertificateAuthorityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_permission(self, request: operations.DeletePermissionRequest) -> operations.DeletePermissionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_permission_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def describe_certificate_authority(self, request: operations.DescribeCertificateAuthorityRequest) -> operations.DescribeCertificateAuthorityResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_certificate_authority_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeCertificateAuthorityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeCertificateAuthorityResponse])
    ...
    def describe_certificate_authority_audit_report(self, request: operations.DescribeCertificateAuthorityAuditReportRequest) -> operations.DescribeCertificateAuthorityAuditReportResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_certificate_authority_audit_report_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeCertificateAuthorityAuditReportResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeCertificateAuthorityAuditReportResponse])
    ...
    def get_certificate_authority_certificate(self, request: operations.GetCertificateAuthorityCertificateRequest) -> operations.GetCertificateAuthorityCertificateResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_certificate_authority_certificate_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetCertificateAuthorityCertificateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetCertificateAuthorityCertificateResponse])
    ...
    def get_certificate_authority_csr(self, request: operations.GetCertificateAuthorityCsrRequest) -> operations.GetCertificateAuthorityCsrResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_certificate_authority_csr_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetCertificateAuthorityCsrResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetCertificateAuthorityCsrResponse])
    ...
    def import_certificate_authority_certificate(self, request: operations.ImportCertificateAuthorityCertificateRequest) -> operations.ImportCertificateAuthorityCertificateResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "import_certificate_authority_certificate_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ImportCertificateAuthorityCertificateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def issue_certificate(self, request: operations.IssueCertificateRequest) -> operations.IssueCertificateResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "issue_certificate_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.IssueCertificateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.IssueCertificateResponse])
    ...
    def list_certificate_authorities(self, request: operations.ListCertificateAuthoritiesRequest) -> operations.ListCertificateAuthoritiesResponse:
        r"""Lists the private certificate authorities that you created by using the <a href=\\"https://docs.aws.amazon.com/privateca/latest/APIReference/API_CreateCertificateAuthority.html\\">CreateCertificateAuthority</a> action."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=ACMPrivateCA.ListCertificateAuthorities'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_certificate_authorities_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListCertificateAuthoritiesRequest, request)
        ...
        res = operations.ListCertificateAuthoritiesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def list_permissions(self, request: operations.ListPermissionsRequest) -> operations.ListPermissionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_permissions_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def restore_certificate_authority(self, request: operations.RestoreCertificateAuthorityRequest) -> operations.RestoreCertificateAuthorityResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "restore_certificate_authority_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RestoreCertificateAuthorityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def revoke_certificate(self, request: operations.RevokeCertificateRequest) -> operations.RevokeCertificateResponse:
        ...
        res = operations.RevokeCertificateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def tag_certificate_authority(self, request: operations.TagCertificateAuthorityRequest) -> operations.TagCertificateAuthorityResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "tag_certificate_authority_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.TagCertificateAuthorityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def untag_certificate_authority(self, request: operations.UntagCertificateAuthorityRequest) -> operations.UntagCertificateAuthorityResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "untag_certificate_authority_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UntagCertificateAuthorityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_certificate_authority(self, request: operations.UpdateCertificateAuthorityRequest) -> operations.UpdateCertificateAuthorityResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_certificate_authority_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateCertificateAuthorityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
