...
class ActionsCreateOrUpdateOrgSecretRequestBodyVisibilityEnum(str, Enum):
    r"""Configures the access that repositories have to the organization secret. Can be one of:
...
class ActionsCreateOrUpdateOrgSecretRequestBody:
    ...
    r"""Value for your secret, encrypted with [LibSodium](https://libsodium.gitbook.io/doc/bindings_for_other_languages) using the public key retrieved from the [Get an organization public key](https://docs.github.com/enterprise-server@2.22/rest/reference/actions#get-an-organization-public-key) endpoint."""  
