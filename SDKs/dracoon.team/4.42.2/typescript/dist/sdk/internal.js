...
var Internal = /** @class */ (function () {
     ...
     *
     */
    Internal.prototype.internalRequestSubscriptionPlan = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.InternalRequestSubscriptionPlanRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v4/internal/tenant/subscription_plan";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.InternalRequestSubscriptionPlanResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.subscriptionPlanResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.SubscriptionPlanResponse);
                    }
                    break;
     ...
     *
     */
    Internal.prototype.internalSetSubscriptionPlan = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        try {
            _a = utils.serializeRequestBody(req, "subscriptionPlanRequest", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.InternalSetSubscriptionPlanResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
