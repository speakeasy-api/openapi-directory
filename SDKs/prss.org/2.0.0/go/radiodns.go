...
func newRadioDNS(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *radioDNS {
	return &radioDNS{
...
func (s *radioDNS) GetRadiodnsSpi31GIXML(ctx context.Context) (*operations.GetRadiodnsSpi31GIXMLResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/radiodns/spi/3.1/GI.xml"
	...
	res := &operations.GetRadiodnsSpi31GIXMLResponse{
...
func (s *radioDNS) GetRadiodnsSpi31SIXML(ctx context.Context, opts ...operations.Option) (*operations.GetRadiodnsSpi31SIXMLResponse, error) {
	...
	res := &operations.GetRadiodnsSpi31SIXMLResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
func (s *radioDNS) GetRadiodnsSpi31IDFqdnSidDatePIXML(ctx context.Context, request operations.GetRadiodnsSpi31IDFqdnSidDatePIXMLRequest, opts ...operations.Option) (*operations.GetRadiodnsSpi31IDFqdnSidDatePIXMLResponse, error) {
	...
	res := &operations.GetRadiodnsSpi31IDFqdnSidDatePIXMLResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
