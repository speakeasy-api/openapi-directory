...
from ..shared import createlagrequest as shared_createlagrequest
...
class CreateLagHeaders:
    x_amz_target: CreateLagXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateLagRequest:
    headers: CreateLagHeaders = dataclasses.field()
    request: shared_createlagrequest.CreateLagRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
