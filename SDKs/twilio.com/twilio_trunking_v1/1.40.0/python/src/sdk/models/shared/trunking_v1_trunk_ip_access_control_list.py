...
class TrunkingV1TrunkIPAccessControlList:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the IpAccessControlList resource."""  
    ...
    r"""The unique string that we created to identify the IpAccessControlList resource."""  
    ...
    r"""The SID of the Trunk the resource is associated with."""  
