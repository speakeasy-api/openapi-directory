...
class CloudresourcemanagerTagValuesPatchRequest:
    ...
    tag_value_input: Optional[shared_tagvalue.TagValueInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    ...
    r"""Optional. Fields to be updated."""  
    ...
    r"""Optional. True to perform validations necessary for updating the resource, but not actually perform the action."""  
