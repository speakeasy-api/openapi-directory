...
class ResellerSubscriptionsChangeSeatsRequest:
    path_params: ResellerSubscriptionsChangeSeatsPathParams = dataclasses.field()
    query_params: ResellerSubscriptionsChangeSeatsQueryParams = dataclasses.field()
    security: ResellerSubscriptionsChangeSeatsSecurity = dataclasses.field()
    request: Optional[shared_seats.Seats] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
