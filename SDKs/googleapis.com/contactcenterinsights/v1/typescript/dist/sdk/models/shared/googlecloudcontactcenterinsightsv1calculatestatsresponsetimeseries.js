...
var GoogleCloudContactcenterinsightsV1CalculateStatsResponseTimeSeries = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "intervalDuration" }),
        __metadata("design:type", String)
    ], GoogleCloudContactcenterinsightsV1CalculateStatsResponseTimeSeries.prototype, "intervalDuration", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: googlecloudcontactcenterinsightsv1calculatestatsresponsetimeseriesinterval_1.GoogleCloudContactcenterinsightsV1CalculateStatsResponseTimeSeriesInterval,
        }),
        (0, class_transformer_1.Expose)({ name: "points" }),
        (0, class_transformer_1.Type)(function () {
            return googlecloudcontactcenterinsightsv1calculatestatsresponsetimeseriesinterval_1.GoogleCloudContactcenterinsightsV1CalculateStatsResponseTimeSeriesInterval;
        }),
