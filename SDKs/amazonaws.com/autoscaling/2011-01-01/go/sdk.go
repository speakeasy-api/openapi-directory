...
func (s *SDK) GetDescribeAutoScalingGroups(ctx context.Context, request operations.GetDescribeAutoScalingGroupsRequest) (*operations.GetDescribeAutoScalingGroupsResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.GetDescribeAutoScalingGroupsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
