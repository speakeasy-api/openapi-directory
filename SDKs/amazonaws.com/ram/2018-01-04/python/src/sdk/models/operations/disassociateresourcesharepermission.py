...
class DisassociateResourceSharePermissionHeaders:
...
class DisassociateResourceSharePermissionRequest:
    headers: DisassociateResourceSharePermissionHeaders = dataclasses.field()
    request: DisassociateResourceSharePermissionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
