...
public class HostReputationQueryParams {
    /**
    ...
    public String host;
    public HostReputationQueryParams withHost(String host) {
        this.host = host;
        return this;
    }
    ...
    public HostReputationQueryParams withListRating(Integer listRating) {
    ...
    public String zones;
    public HostReputationQueryParams withZones(String zones) {
        this.zones = zones;
        return this;
    }
