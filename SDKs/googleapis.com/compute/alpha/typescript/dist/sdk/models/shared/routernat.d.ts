 ...
 */
export declare enum RouterNatAutoNetworkTierEnum {
...
export declare enum RouterNatEndpointTypesEnum {
 ...
 */
export declare enum RouterNatNatIpAllocateOptionEnum {
    AutoOnly = "AUTO_ONLY",
 ...
 */
export declare enum RouterNatSourceSubnetworkIpRangesToNatEnum {
 ...
 */
export declare enum RouterNatTypeEnum {
    Private = "PRIVATE",
    Public = "PUBLIC"
}
/**
 ...
 */
export declare class RouterNat extends SpeakeasyBase {
    /**
     * The network tier to use when automatically reserving IP addresses. Must be one of: PREMIUM, STANDARD. If not specified, PREMIUM tier will be used.
     */
