...
from ..shared import getreadsetmetadataresponse as shared_getreadsetmetadataresponse
...
class GetReadSetMetadataResponse:
    ...
    get_read_set_metadata_response: Optional[shared_getreadsetmetadataresponse.GetReadSetMetadataResponse] = dataclasses.field(default=None)
    r"""Success"""  
