...
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#add-project-collaborator>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#create-a-project-card>
...
try {
    ...
    $request->requestBody = new ProjectsCreateCardRequestBody1();
    $request->requestBody->note = 'Update all gems';
    $request->columnId = 571844;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#create-a-project-column>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#create-a-user-project>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#create-an-organization-project>
...
try {
    ...
    $request->requestBody->name = 'Alonzo Zemlak';
    $request->org = 'debitis';
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#create-a-repository-project>
...
try {
    ...
    $request->requestBody->body = 'delectus';
    $request->requestBody->name = 'Alexandra Pfannerstill';
    $request->owner = 'velit';
    $request->repo = 'atque';
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#delete-a-project>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#delete-a-project-card>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#delete-a-project-column>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#get-a-project>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#get-a-project-card>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#get-a-project-column>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#get-project-permission-for-a-user>
...
try {
    ...
    $request->projectId = 294076;
    $request->username = 'Jayme49';
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#list-project-cards>
...
try {
    ...
    $request->archivedState = ProjectsListCardsArchivedStateEnum::ALL;
    $request->columnId = 778172;
    $request->page = 535468;
    $request->perPage = 844235;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#list-project-collaborators>
...
try {
    ...
    $request->page = 139072;
    $request->perPage = 974990;
    $request->projectId = 426904;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#list-project-columns>
...
try {
    ...
    $request->page = 300824;
    $request->perPage = 842855;
    $request->projectId = 78969;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#list-organization-projects>
...
try {
    ...
    $request->org = 'facere';
    $request->page = 726878;
    $request->perPage = 102413;
    $request->state = ProjectsListForOrgStateEnum::ALL;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#list-repository-projects>
...
try {
    ...
    $request->owner = 'quia';
    $request->page = 782090;
    $request->perPage = 304198;
    $request->repo = 'velit';
    $request->state = ProjectsListForRepoStateEnum::OPEN;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#list-user-projects>
...
try {
    ...
    $request->state = ProjectsListForUserStateEnum::CLOSED;
    $request->username = 'Berenice.Thiel';
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#move-a-project-card>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#move-a-project-column>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#remove-project-collaborator>
...
try {
    ...
    $request->projectId = 596433;
    $request->username = 'Travon_Carroll61';
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#update-a-project>
...
try {
    ...
    $request->requestBody->organizationPermission = ProjectsUpdateRequestBodyOrganizationPermissionEnum::NONE;
    $request->requestBody->private = false;
    $request->requestBody->state = 'open';
    $request->projectId = 2677;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#update-a-project-card>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/projects#update-a-project-column>
