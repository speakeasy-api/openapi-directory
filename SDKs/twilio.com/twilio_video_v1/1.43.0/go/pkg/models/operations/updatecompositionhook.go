...
func (e UpdateCompositionHookUpdateCompositionHookRequestStatusCallbackMethodEnum) ToPointer() *UpdateCompositionHookUpdateCompositionHookRequestStatusCallbackMethodEnum {
	return &e
}
...
func (e *UpdateCompositionHookUpdateCompositionHookRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateCompositionHookUpdateCompositionHookRequestStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateCompositionHookUpdateCompositionHookRequestStatusCallbackMethodEnum: %v", v)
	}
}
