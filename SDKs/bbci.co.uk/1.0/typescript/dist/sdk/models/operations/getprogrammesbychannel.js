...
exports.GetProgrammesByChannelResponse = exports.GetProgrammesByChannelRequest = void 0;
...
var GetProgrammesByChannelRequest = /** @class */ (function (_super) {
    ...
    ], GetProgrammesByChannelRequest.prototype, "availability", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=channel",
        }),
        __metadata("design:type", String)
    ], GetProgrammesByChannelRequest.prototype, "channel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=lang" }),
        __metadata("design:type", String)
    ], GetProgrammesByChannelRequest.prototype, "lang", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetProgrammesByChannelRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetProgrammesByChannelRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=rights",
        }),
        __metadata("design:type", String)
    ], GetProgrammesByChannelRequest.prototype, "rights", void 0);
    return GetProgrammesByChannelRequest;
}(utils_1.SpeakeasyBase));
exports.GetProgrammesByChannelRequest = GetProgrammesByChannelRequest;
var GetProgrammesByChannelResponse = /** @class */ (function (_super) {
    ...
    ], GetProgrammesByChannelResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.GetProgrammesByChannelResponse = GetProgrammesByChannelResponse;
