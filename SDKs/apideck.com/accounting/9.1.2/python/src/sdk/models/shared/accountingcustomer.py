...
from ..shared import linkedparentcustomer as shared_linkedparentcustomer
...
class AccountingCustomerInput:
    ...
    parent: Optional[shared_linkedparentcustomer.LinkedParentCustomer] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('parent'), 'exclude': lambda f: f is None }})
    ...
    status: Optional[AccountingCustomerStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""Customer status"""  
