...
class UpdateBookingRequestPaymentTypeEnum(str, Enum):
...
class UpdateBookingRequest:
    ...
    rooms: list[UpdateBookingRequestRooms] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rooms') }})
    ...
    payment_type: Optional[UpdateBookingRequestPaymentTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('paymentType'), 'exclude': lambda f: f is None }})
    r"""How will the guest make payment for this booking?"""  
