...
var Budget = /** @class */ (function () {
    function Budget(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Budget.prototype.adexchangebuyerBudgetGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AdexchangebuyerBudgetGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/billinginfo/{accountId}/{billingId}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.budget = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Budget.prototype.adexchangebuyerBudgetPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Budget.prototype.adexchangebuyerBudgetUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
