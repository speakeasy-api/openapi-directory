...
class VirtualMachineWithConfigContext:
    ...
    config_context: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('config_context'), 'exclude': lambda f: f is None }})  
