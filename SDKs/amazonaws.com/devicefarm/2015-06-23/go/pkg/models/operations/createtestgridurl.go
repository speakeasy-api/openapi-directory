...
func (e CreateTestGridURLXAmzTargetEnum) ToPointer() *CreateTestGridURLXAmzTargetEnum {
	return &e
}
...
func (e *CreateTestGridURLXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "DeviceFarm_20150623.CreateTestGridUrl":
		*e = CreateTestGridURLXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateTestGridURLXAmzTargetEnum: %v", v)
	}
}
