...
var Members = /** @class */ (function () {
    ...
    **/
    Members.prototype.deleteWorkspaceIdMembersId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteWorkspaceIdMembersIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{workspace_id}/members/{id}", req.pathParams);
    ...
    **/
    Members.prototype.deleteWorkspaceIdMembersMemberIdIdentities = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteWorkspaceIdMembersMemberIdIdentitiesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{workspace_id}/members/{member_id}/identities", req.pathParams);
    ...
    **/
    Members.prototype.getWorkspaceIdMembers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetWorkspaceIdMembersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{workspace_id}/members", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
    ...
    **/
    Members.prototype.getWorkspaceIdMembersFind = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetWorkspaceIdMembersFindRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{workspace_id}/members/find", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    **/
    Members.prototype.getWorkspaceIdMembersId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Members.prototype.postWorkspaceIdMembers = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Members.prototype.postWorkspaceIdMembersMemberIdIdentities = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Members.prototype.putWorkspaceIdMembersId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
