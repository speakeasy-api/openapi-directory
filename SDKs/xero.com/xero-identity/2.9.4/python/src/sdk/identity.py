...
class Identity:
    ...
    def delete_connection(self, request: operations.DeleteConnectionRequest, security: operations.DeleteConnectionSecurity) -> operations.DeleteConnectionResponse:
        r"""Deletes a connection for this user (i.e. disconnect a tenant)
        Override the base server url that include version
        """
        base_url = self._server_url
        
        url = utils.generate_url(operations.DeleteConnectionRequest, base_url, '/Connections/{id}', request)
    ...
    def get_connections(self, request: operations.GetConnectionsRequest, security: operations.GetConnectionsSecurity) -> operations.GetConnectionsResponse:
