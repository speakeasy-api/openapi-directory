...
var OpenAQProjectsResult = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return OpenAQProjectsResultMeta; }),
        __metadata("design:type", OpenAQProjectsResultMeta)
    ], OpenAQProjectsResult.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: projectsrow_1.ProjectsRow }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return projectsrow_1.ProjectsRow; }),
