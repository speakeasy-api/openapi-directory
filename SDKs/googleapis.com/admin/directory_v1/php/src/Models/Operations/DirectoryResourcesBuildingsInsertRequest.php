...
class DirectoryResourcesBuildingsInsertRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DirectoryResourcesBuildingsInsertCoordinatesSourceEnum $coordinatesSource
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=coordinatesSource')]
    public ?DirectoryResourcesBuildingsInsertCoordinatesSourceEnum $coordinatesSource = null;
