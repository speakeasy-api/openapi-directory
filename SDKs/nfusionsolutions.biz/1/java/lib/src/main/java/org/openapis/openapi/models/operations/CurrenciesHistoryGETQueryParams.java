...
public class CurrenciesHistoryGETQueryParams {
    /**
     * end date of time period. format is &lt;i&gt;yyyy-mm-dd&lt;/i&gt;. Default is current date.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=end")
    public OffsetDateTime end;
    public CurrenciesHistoryGETQueryParams withEnd(OffsetDateTime end) {
        this.end = end;
        return this;
    }
    ...
    public CurrenciesHistoryGETQueryParams withFormat(CurrenciesHistoryGETFormatEnum format) {
        this.format = format;
        return this;
    }
    ...
    public CurrenciesHistoryGETQueryParams withInterval(String interval) {
    ...
    public String pairs;
    public CurrenciesHistoryGETQueryParams withPairs(String pairs) {
        this.pairs = pairs;
        return this;
    }
    ...
    public CurrenciesHistoryGETQueryParams withStart(OffsetDateTime start) {
        this.start = start;
        return this;
    }
