    ...
    public static void main(String[] args) {
        try {
            ...
            LeadsAddRequest req = new LeadsAddRequest(                new LeadInput("Spacex", "Elon Musk") {{
                ...
                raw = false;
                xApideckServiceId = "sapiente";
            }};            

            LeadsAddResponse res = sdk.leads.leadsAdd(req, new LeadsAddSecurity("quo") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            LeadsAllRequest req = new LeadsAllRequest("odit", "at") {{
                cursor = "at";
                fields = "maiores";
                ...
                xApideckServiceId = "quod";
            }};            

            LeadsAllResponse res = sdk.leads.leadsAll(req, new LeadsAllSecurity("esse") {{
                apiKey = "YOUR_API_KEY_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            LeadsDeleteRequest req = new LeadsDeleteRequest("totam", "porro", "dolorum") {{
                raw = false;
                xApideckServiceId = "dicta";
            }};            

            LeadsDeleteResponse res = sdk.leads.leadsDelete(req, new LeadsDeleteSecurity("nam") {{
                apiKey = "YOUR_API_KEY_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            LeadsOneRequest req = new LeadsOneRequest("officia", "occaecati", "fugit") {{
                fields = "deleniti";
                raw = false;
                xApideckServiceId = "hic";
            }};            

            LeadsOneResponse res = sdk.leads.leadsOne(req, new LeadsOneSecurity("optio") {{
                apiKey = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            LeadsUpdateRequest req = new LeadsUpdateRequest(                new LeadInput("Spacex", "Elon Musk") {{
                            ...
                            }};, "perferendis", "ad", "natus") {{
                raw = false;
                xApideckServiceId = "sed";
            }};            

            LeadsUpdateResponse res = sdk.leads.leadsUpdate(req, new LeadsUpdateSecurity("iste") {{
                apiKey = "YOUR_API_KEY_HERE";
            }});
