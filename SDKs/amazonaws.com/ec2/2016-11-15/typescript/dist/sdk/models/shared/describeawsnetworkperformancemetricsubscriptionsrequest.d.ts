 ...
 */
export declare class DescribeAwsNetworkPerformanceMetricSubscriptionsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeAwsNetworkPerformanceMetricSubscriptionsRequest extends SpeakeasyBase {
    dryRun?: boolean;
