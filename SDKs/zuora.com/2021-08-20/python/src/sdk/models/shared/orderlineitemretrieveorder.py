...
from ..shared import ordercontactretrieveorder as shared_ordercontactretrieveorder

class OrderLineItemRetrieveOrderItemStateEnum(str, Enum):
    EXECUTING = "Executing"
    SENT_TO_BILLING = "SentToBilling"
    COMPLETE = "Complete"
    CANCELLED = "Cancelled"

class OrderLineItemRetrieveOrderItemTypeEnum(str, Enum):
    PRODUCT = "Product"
    FEE = "Fee"
    SERVICES = "Services"

class OrderLineItemRetrieveOrderTaxModeEnum(str, Enum):
...
class OrderLineItemRetrieveOrder:
    ...
    item_state: Optional[OrderLineItemRetrieveOrderItemStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itemState') }})
    item_type: Optional[OrderLineItemRetrieveOrderItemTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itemType') }})
    ...
    sold_to_data: Optional[shared_ordercontactretrieveorder.OrderContactRetrieveOrder] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('soldToData') }})
    tax_code: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('taxCode') }})
    tax_mode: Optional[OrderLineItemRetrieveOrderTaxModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('taxMode') }})
