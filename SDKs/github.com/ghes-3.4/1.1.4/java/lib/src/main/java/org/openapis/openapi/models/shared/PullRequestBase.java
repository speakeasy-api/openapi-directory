...
public class PullRequestBase {
    ...
    public PullRequestBase(@JsonProperty("label") String label, @JsonProperty("ref") String ref, @JsonProperty("repo") PullRequestBaseRepo repo, @JsonProperty("sha") String sha, @JsonProperty("user") PullRequestBaseUser user) {
        this.label = label;
        this.ref = ref;
        this.repo = repo;
        this.sha = sha;
