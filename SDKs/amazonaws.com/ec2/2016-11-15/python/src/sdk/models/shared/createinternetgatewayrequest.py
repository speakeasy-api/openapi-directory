...
class CreateInternetGatewayRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateInternetGatewayRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateInternetGatewayRequestTagSpecifications:
    ...
    resource_type: Optional[CreateInternetGatewayRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateInternetGatewayRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateInternetGatewayRequest:
    ...
    tag_specifications: Optional[list[CreateInternetGatewayRequestTagSpecifications]] = dataclasses.field(default=None)  
