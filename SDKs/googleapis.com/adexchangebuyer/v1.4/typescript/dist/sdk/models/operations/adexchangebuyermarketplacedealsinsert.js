...
exports.AdexchangebuyerMarketplacedealsInsertResponse = exports.AdexchangebuyerMarketplacedealsInsertRequest = exports.AdexchangebuyerMarketplacedealsInsertSecurity = void 0;
...
var AdexchangebuyerMarketplacedealsInsertRequest = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerMarketplacedealsInsertRequest.prototype, "addOrderDealsRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsInsertRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsInsertRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsInsertRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsInsertRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdexchangebuyerMarketplacedealsInsertRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=proposalId",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsInsertRequest.prototype, "proposalId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsInsertRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacedealsInsertRequest.prototype, "userIp", void 0);
...
var AdexchangebuyerMarketplacedealsInsertResponse = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerMarketplacedealsInsertResponse.prototype, "rawResponse", void 0);
