...
public class ObjectPUTUsageRequest {
    ...
    public org.openapis.openapi.models.shared.ProxyModifyUsage proxyModifyUsage;
    public ObjectPUTUsageRequest withProxyModifyUsage(org.openapis.openapi.models.shared.ProxyModifyUsage proxyModifyUsage) {
    ...
    public ObjectPUTUsageRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public ObjectPUTUsageRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public String id;
    public ObjectPUTUsageRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ObjectPUTUsageRequest withRejectUnknownFields(Boolean rejectUnknownFields) {
