...
from ..shared import createactivityresponse as shared_createactivityresponse
...
class ActivitiesAddRequest:
    headers: ActivitiesAddHeaders = dataclasses.field()
    query_params: ActivitiesAddQueryParams = dataclasses.field()
    request: shared_activity.ActivityInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: ActivitiesAddSecurity = dataclasses.field()
...
class ActivitiesAddResponse:
    ...
    create_activity_response: Optional[shared_createactivityresponse.CreateActivityResponse] = dataclasses.field(default=None)
