...
public class POSTDescribeDataSharesForConsumerQueryParams {
    ...
    public POSTDescribeDataSharesForConsumerQueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public POSTDescribeDataSharesForConsumerQueryParams withMaxRecords(String maxRecords) {
