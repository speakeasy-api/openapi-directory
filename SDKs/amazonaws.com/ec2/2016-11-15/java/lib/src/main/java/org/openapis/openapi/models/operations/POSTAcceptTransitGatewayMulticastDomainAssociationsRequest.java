...
public class POSTAcceptTransitGatewayMulticastDomainAssociationsRequest {
    ...
    public POSTAcceptTransitGatewayMulticastDomainAssociationsRequest(@JsonProperty("Action") POSTAcceptTransitGatewayMulticastDomainAssociationsActionEnum action, @JsonProperty("Version") POSTAcceptTransitGatewayMulticastDomainAssociationsVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
