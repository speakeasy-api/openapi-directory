...
class GetPathwayPhenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPathwayPhenotypeAssociationsQueryParams:
...
@dataclasses.dataclass
class GetPathwayPhenotypeAssociationsRequest:
    path_params: GetPathwayPhenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetPathwayPhenotypeAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetPathwayPhenotypeAssociationsResponse:
