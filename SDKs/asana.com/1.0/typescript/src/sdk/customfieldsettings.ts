  ...
  **/
  getCustomFieldSettingsForPortfolio(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetCustomFieldSettingsForPortfolioResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  getCustomFieldSettingsForProject(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetCustomFieldSettingsForProjectResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
