 ...
 */
export enum NullableRepositoryMergeCommitMessageEnum {
  PrBody = "PR_BODY",
  PrTitle = "PR_TITLE",
  Blank = "BLANK",
}
 ...
 */
export enum NullableRepositoryMergeCommitTitleEnum {
  PrTitle = "PR_TITLE",
 ...
 * - `BLANK` - default to a blank commit message.
 */
export enum NullableRepositorySquashMergeCommitMessageEnum {
  PrBody = "PR_BODY",
 ...
 */
export enum NullableRepositorySquashMergeCommitTitleEnum {
  PrTitle = "PR_TITLE",
 ...
 * - `BLANK` - default to a blank commit message.
 */
export enum NullableRepositoryTemplateRepositoryMergeCommitMessageEnum {
  PrBody = "PR_BODY",
  PrTitle = "PR_TITLE",
  Blank = "BLANK",
}
 ...
 * - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
 */
export enum NullableRepositoryTemplateRepositoryMergeCommitTitleEnum {
  PrTitle = "PR_TITLE",
  MergeMessage = "MERGE_MESSAGE",
}
 ...
 * - `BLANK` - default to a blank commit message.
 */
export enum NullableRepositoryTemplateRepositorySquashMergeCommitMessageEnum {
  PrBody = "PR_BODY",
  CommitMessages = "COMMIT_MESSAGES",
  Blank = "BLANK",
}
 ...
 * - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
 */
export enum NullableRepositoryTemplateRepositorySquashMergeCommitTitleEnum {
  PrTitle = "PR_TITLE",
  CommitOrPrTitle = "COMMIT_OR_PR_TITLE",
}
