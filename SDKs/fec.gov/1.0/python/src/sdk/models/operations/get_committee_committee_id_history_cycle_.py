...
class GetCommitteeCommitteeIDHistoryCycleQueryParams:
    ...
    designation: Optional[list[GetCommitteeCommitteeIDHistoryCycleDesignationEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'designation', 'style': 'form', 'explode': True }})
...
class GetCommitteeCommitteeIDHistoryCycleRequest:
    path_params: GetCommitteeCommitteeIDHistoryCyclePathParams = dataclasses.field()
    query_params: GetCommitteeCommitteeIDHistoryCycleQueryParams = dataclasses.field()
