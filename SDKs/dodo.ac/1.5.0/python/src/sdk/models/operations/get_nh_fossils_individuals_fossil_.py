...
class GetNhFossilsIndividualsFossilRequest:
    ...
    r"""The name of the individual fossil you wish to retrieve fossil information about."""  
...
class GetNhFossilsIndividualsFossilResponse:
    ...
    nh_individual_fossil: Optional[shared_nhindividualfossil.NHIndividualFossil] = dataclasses.field(default=None)
