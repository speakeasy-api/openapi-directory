...
from ..shared import stopjobrequest as shared_stopjobrequest
...
class StopJobHeaders:
    x_amz_target: StopJobXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopJobRequest:
    headers: StopJobHeaders = dataclasses.field()
    request: shared_stopjobrequest.StopJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
