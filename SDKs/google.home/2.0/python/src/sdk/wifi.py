...
class Wifi:
    ...
    def connectto_wi_fi_network(self, request: shared.ConnecttoWiFiNetworkRequest) -> operations.ConnecttoWiFiNetworkResponse:
        ...
        **Note:** Not sure how the password is encrypted. Might be using the public certificate from /setup/eureka_info. So this cannot be used as of now. If someone figures it out, please [create a new issue here](https://github.com/rithvikvibhu/GHLocalApi/issues/new).
        ...
        res = operations.ConnecttoWiFiNetworkResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        

        return res

    def forget_wi_fi_network(self, request: shared.ForgetWiFiNetworkRequest) -> operations.ForgetWiFiNetworkResponse:
        ...
        res = operations.ForgetWiFiNetworkResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'text/plain'):
                res.forget_wi_fi_network_200_text_plain_object = http_res.content
    ...
    def get_saved_networks(self) -> operations.GetSavedNetworksResponse:
        ...
        res = operations.GetSavedNetworksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.Example113]])
                res.example113s = out
    ...
    def get_wi_fi_scan_results(self) -> operations.GetWiFiScanResultsResponse:
        ...
        res = operations.GetWiFiScanResultsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.Example114]])
                res.example114s = out
    ...
    def scanfor_networks(self) -> operations.ScanforNetworksResponse:
        ...
        res = operations.ScanforNetworksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'text/plain'):
                res.scanfor_networks_200_text_plain_object = http_res.content
