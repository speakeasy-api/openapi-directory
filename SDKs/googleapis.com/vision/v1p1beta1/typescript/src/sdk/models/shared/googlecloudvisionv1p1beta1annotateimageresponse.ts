...
export class GoogleCloudVisionV1p1beta1AnnotateImageResponse extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudVisionV1p1beta1FaceAnnotation })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudVisionV1p1beta1EntityAnnotation })
   ...
   */
  @SpeakeasyMetadata({
    elemType: GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation,
  })
