...
type HomegraphDevicesQuerySecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type HomegraphDevicesQueryQueryParams struct {
	// V1 error format.
...
type HomegraphDevicesQueryRequest struct {
...
type HomegraphDevicesQueryResponse struct {
	ContentType string
	// Successful response
