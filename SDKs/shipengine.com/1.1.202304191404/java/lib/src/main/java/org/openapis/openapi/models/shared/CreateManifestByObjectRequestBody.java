...
public class CreateManifestByObjectRequestBody {
    ...
    public CreateManifestByObjectRequestBody(@JsonProperty("carrier_id") String carrierId, @JsonProperty("ship_date") OffsetDateTime shipDate, @JsonProperty("warehouse_id") String warehouseId) {
        this.carrierId = carrierId;
        this.shipDate = shipDate;
        this.warehouseId = warehouseId;
  }
