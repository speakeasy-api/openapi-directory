...
class TflAPIPresentationEntitiesRoadDisruptionImpactArea:
    ...
    polygon: Optional[shared_system_data_spatial_dbgeography.SystemDataSpatialDbGeography] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('polygon'), 'exclude': lambda f: f is None }})  
