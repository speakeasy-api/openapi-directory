...
public class GETSubscriptionsByKeyAndVersionRequest {
    ...
    public GETSubscriptionsByKeyAndVersionRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETSubscriptionsByKeyAndVersionRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETSubscriptionsByKeyAndVersionRequest withChargeDetail(String chargeDetail) {
    ...
    public GETSubscriptionsByKeyAndVersionRequest withSubscriptionKey(String subscriptionKey) {
    ...
    public GETSubscriptionsByKeyAndVersionRequest withVersion(String version) {
