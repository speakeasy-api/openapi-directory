...
var Thumbnails = /** @class */ (function () {
    function Thumbnails(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Thumbnails.prototype.youtubeThumbnailsSet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.YoutubeThumbnailsSetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/youtube/v3/thumbnails/set";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.thumbnailSetResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
