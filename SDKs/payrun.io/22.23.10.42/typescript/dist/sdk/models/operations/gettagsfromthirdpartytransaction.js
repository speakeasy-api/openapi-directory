...
exports.GetTagsFromThirdPartyTransactionResponse = exports.GetTagsFromThirdPartyTransactionRequest = void 0;
...
var GetTagsFromThirdPartyTransactionRequest = /** @class */ (function (_super) {
    ...
    ], GetTagsFromThirdPartyTransactionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagsFromThirdPartyTransactionRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagsFromThirdPartyTransactionRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ThirdPartyTransactionId",
        }),
        __metadata("design:type", String)
    ], GetTagsFromThirdPartyTransactionRequest.prototype, "thirdPartyTransactionId", void 0);
...
var GetTagsFromThirdPartyTransactionResponse = /** @class */ (function (_super) {
    ...
    ], GetTagsFromThirdPartyTransactionResponse.prototype, "rawResponse", void 0);
