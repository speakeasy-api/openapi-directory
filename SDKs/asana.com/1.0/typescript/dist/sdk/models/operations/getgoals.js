...
exports.GetGoalsResponse = exports.GetGoalsRequest = exports.GetGoals200ApplicationJson = exports.GetGoalsQueryParams = void 0;
...
var GetGoalsQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=is_workspace_level" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=time_periods" }),
        __metadata("design:type", Array)
...
exports.GetGoalsQueryParams = GetGoalsQueryParams;
...
exports.GetGoals200ApplicationJson = GetGoals200ApplicationJson;
...
exports.GetGoalsRequest = GetGoalsRequest;
...
exports.GetGoalsResponse = GetGoalsResponse;
