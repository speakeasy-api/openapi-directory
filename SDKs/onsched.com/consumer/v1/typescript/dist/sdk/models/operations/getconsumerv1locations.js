...
exports.GetConsumerV1LocationsResponse = exports.GetConsumerV1LocationsRequest = exports.GetConsumerV1LocationsQueryParams = void 0;
...
var GetConsumerV1LocationsQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ignorePrimary" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=nearestTo" }),
        __metadata("design:type", String)
...
exports.GetConsumerV1LocationsQueryParams = GetConsumerV1LocationsQueryParams;
...
exports.GetConsumerV1LocationsRequest = GetConsumerV1LocationsRequest;
...
exports.GetConsumerV1LocationsResponse = GetConsumerV1LocationsResponse;
