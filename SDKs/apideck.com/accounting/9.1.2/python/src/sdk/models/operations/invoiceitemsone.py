...
from ..shared import getinvoiceitemresponse as shared_getinvoiceitemresponse
...
class InvoiceItemsOneSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class InvoiceItemsOneRequest:
...
@dataclasses.dataclass
class InvoiceItemsOneResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    get_invoice_item_response: Optional[shared_getinvoiceitemresponse.GetInvoiceItemResponse] = dataclasses.field(default=None)
    r"""InvoiceItems"""  
