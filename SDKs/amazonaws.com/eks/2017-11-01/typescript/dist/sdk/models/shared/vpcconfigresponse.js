...
**/
var VpcConfigResponse = /** @class */ (function (_super) {
    __extends(VpcConfigResponse, _super);
    function VpcConfigResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=clusterSecurityGroupId" }),
        __metadata("design:type", String)
    ], VpcConfigResponse.prototype, "clusterSecurityGroupId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=endpointPrivateAccess" }),
        __metadata("design:type", Boolean)
    ], VpcConfigResponse.prototype, "endpointPrivateAccess", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=endpointPublicAccess" }),
        __metadata("design:type", Boolean)
    ], VpcConfigResponse.prototype, "endpointPublicAccess", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=publicAccessCidrs" }),
        __metadata("design:type", Array)
    ], VpcConfigResponse.prototype, "publicAccessCidrs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=securityGroupIds" }),
        __metadata("design:type", Array)
    ], VpcConfigResponse.prototype, "securityGroupIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=subnetIds" }),
        __metadata("design:type", Array)
    ], VpcConfigResponse.prototype, "subnetIds", void 0);
    __decorate([
