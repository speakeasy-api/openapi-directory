...
public class QueryMssqlDbSnapshotRequest {
    /**
    ...
    public QueryMssqlDbSnapshotRequest withAfterTime(OffsetDateTime afterTime) {
    ...
    public QueryMssqlDbSnapshotRequest withBeforeTime(OffsetDateTime beforeTime) {
    ...
    public QueryMssqlDbSnapshotRequest withId(String id) {
        this.id = id;
        return this;
    }
    
    public QueryMssqlDbSnapshotRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
