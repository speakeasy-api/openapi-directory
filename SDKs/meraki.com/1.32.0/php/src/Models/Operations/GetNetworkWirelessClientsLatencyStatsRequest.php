...
class GetNetworkWirelessClientsLatencyStatsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNetworkWirelessClientsLatencyStatsBandEnum $band
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=band')]
    public ?GetNetworkWirelessClientsLatencyStatsBandEnum $band = null;
