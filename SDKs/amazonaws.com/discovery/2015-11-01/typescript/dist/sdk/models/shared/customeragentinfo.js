...
var CustomerAgentInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "activeAgents" }),
        __metadata("design:type", Number)
    ], CustomerAgentInfo.prototype, "activeAgents", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "blackListedAgents" }),
        __metadata("design:type", Number)
    ], CustomerAgentInfo.prototype, "blackListedAgents", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "healthyAgents" }),
        __metadata("design:type", Number)
    ], CustomerAgentInfo.prototype, "healthyAgents", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "shutdownAgents" }),
        __metadata("design:type", Number)
    ], CustomerAgentInfo.prototype, "shutdownAgents", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "totalAgents" }),
        __metadata("design:type", Number)
    ], CustomerAgentInfo.prototype, "totalAgents", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "unhealthyAgents" }),
        __metadata("design:type", Number)
    ], CustomerAgentInfo.prototype, "unhealthyAgents", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "unknownAgents" }),
        __metadata("design:type", Number)
