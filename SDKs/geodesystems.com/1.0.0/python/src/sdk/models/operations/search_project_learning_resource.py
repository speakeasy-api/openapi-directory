...
class SearchProjectLearningResourceQueryParams:
    ...
    search_project_learning_resource_grade_level: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_learning_resource.grade_level', 'style': 'form', 'explode': True }})
    search_project_learning_resource_topic: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_learning_resource.topic', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchProjectLearningResourceRequest:
    query_params: SearchProjectLearningResourceQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectLearningResourceResponse:
