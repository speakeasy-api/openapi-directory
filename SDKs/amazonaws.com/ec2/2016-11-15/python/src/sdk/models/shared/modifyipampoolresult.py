...
class ModifyIpamPoolResultIpamPoolAddressFamilyEnum(str, Enum):
...
class ModifyIpamPoolResultIpamPoolAllocationResourceTags:
...
class ModifyIpamPoolResultIpamPoolAwsServiceEnum(str, Enum):
...
class ModifyIpamPoolResultIpamPoolIpamScopeTypeEnum(str, Enum):
...
class ModifyIpamPoolResultIpamPoolPublicIPSourceEnum(str, Enum):
...
class ModifyIpamPoolResultIpamPoolStateEnum(str, Enum):
...
class ModifyIpamPoolResultIpamPool:
    ...
    address_family: Optional[ModifyIpamPoolResultIpamPoolAddressFamilyEnum] = dataclasses.field(default=None)  
    ...
    allocation_resource_tags: Optional[list[ModifyIpamPoolResultIpamPoolAllocationResourceTags]] = dataclasses.field(default=None)  
    auto_import: Optional[bool] = dataclasses.field(default=None)  
    aws_service: Optional[ModifyIpamPoolResultIpamPoolAwsServiceEnum] = dataclasses.field(default=None)  
    ...
    ipam_scope_type: Optional[ModifyIpamPoolResultIpamPoolIpamScopeTypeEnum] = dataclasses.field(default=None)  
    ...
    public_ip_source: Optional[ModifyIpamPoolResultIpamPoolPublicIPSourceEnum] = dataclasses.field(default=None)  
    ...
    state: Optional[ModifyIpamPoolResultIpamPoolStateEnum] = dataclasses.field(default=None)  
    state_message: Optional[str] = dataclasses.field(default=None)  
    tags: Optional[list[ModifyIpamPoolResultIpamPoolTags]] = dataclasses.field(default=None)  
...
class ModifyIpamPoolResult:
    ...
    ipam_pool: Optional[ModifyIpamPoolResultIpamPool] = dataclasses.field(default=None)  
