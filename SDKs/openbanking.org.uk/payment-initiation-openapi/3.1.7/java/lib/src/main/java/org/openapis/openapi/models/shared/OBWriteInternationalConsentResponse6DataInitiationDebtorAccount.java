...
public class OBWriteInternationalConsentResponse6DataInitiationDebtorAccount {
    ...
    public OBWriteInternationalConsentResponse6DataInitiationDebtorAccount(@JsonProperty("Identification") String identification, @JsonProperty("SchemeName") String schemeName) {
        this.identification = identification;
        this.schemeName = schemeName;
  }
}
