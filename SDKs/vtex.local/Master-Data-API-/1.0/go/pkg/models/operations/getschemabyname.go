...
type GetschemabynamePathParams struct {
...
type GetschemabynameHeaders struct {
	// Type of the content being sent.
	ContentType string `header:"style=simple,explode=false,name=Content-Type"`
}

type GetschemabynameRequest struct {
	PathParams GetschemabynamePathParams
	Headers    GetschemabynameHeaders
}
