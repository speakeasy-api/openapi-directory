...
class ActionsSetActionsCacheUsagePolicyForEnterpriseRequest:
    
    actions_cache_usage_policy_enterprise: shared_actions_cache_usage_policy_enterprise.ActionsCacheUsagePolicyEnterprise = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class ActionsSetActionsCacheUsagePolicyForEnterpriseResponse:
