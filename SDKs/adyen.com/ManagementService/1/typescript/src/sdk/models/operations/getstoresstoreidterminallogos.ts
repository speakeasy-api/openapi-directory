...
export class GetStoresStoreIdTerminalLogosSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetStoresStoreIdTerminalLogosRequest extends SpeakeasyBase {
  /**
...
export class GetStoresStoreIdTerminalLogosResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
