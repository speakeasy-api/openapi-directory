...
exports.FetchWorkspaceCumulativeStatisticsResponse = exports.FetchWorkspaceCumulativeStatisticsRequest = exports.FetchWorkspaceCumulativeStatisticsSecurity = exports.FetchWorkspaceCumulativeStatisticsServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.FetchWorkspaceCumulativeStatisticsServerList = [
...
var FetchWorkspaceCumulativeStatisticsSecurity = /** @class */ (function (_super) {
    ...
    ], FetchWorkspaceCumulativeStatisticsSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], FetchWorkspaceCumulativeStatisticsSecurity.prototype, "username", void 0);
    return FetchWorkspaceCumulativeStatisticsSecurity;
}(utils_1.SpeakeasyBase));
exports.FetchWorkspaceCumulativeStatisticsSecurity = FetchWorkspaceCumulativeStatisticsSecurity;
var FetchWorkspaceCumulativeStatisticsRequest = /** @class */ (function (_super) {
    ...
    ], FetchWorkspaceCumulativeStatisticsRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Minutes",
        }),
        __metadata("design:type", Number)
    ], FetchWorkspaceCumulativeStatisticsRequest.prototype, "minutes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SplitByWaitTime",
        }),
        __metadata("design:type", String)
    ], FetchWorkspaceCumulativeStatisticsRequest.prototype, "splitByWaitTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], FetchWorkspaceCumulativeStatisticsRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskChannel",
        }),
        __metadata("design:type", String)
    ], FetchWorkspaceCumulativeStatisticsRequest.prototype, "taskChannel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], FetchWorkspaceCumulativeStatisticsRequest.prototype, "workspaceSid", void 0);
    return FetchWorkspaceCumulativeStatisticsRequest;
}(utils_1.SpeakeasyBase));
exports.FetchWorkspaceCumulativeStatisticsRequest = FetchWorkspaceCumulativeStatisticsRequest;
var FetchWorkspaceCumulativeStatisticsResponse = /** @class */ (function (_super) {
    ...
    ], FetchWorkspaceCumulativeStatisticsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.FetchWorkspaceCumulativeStatisticsResponse = FetchWorkspaceCumulativeStatisticsResponse;
