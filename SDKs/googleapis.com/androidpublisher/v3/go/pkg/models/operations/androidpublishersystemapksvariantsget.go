...
type AndroidpublisherSystemapksVariantsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidpublisherSystemapksVariantsGetPathParams struct {
...
type AndroidpublisherSystemapksVariantsGetQueryParams struct {
	// V1 error format.
...
type AndroidpublisherSystemapksVariantsGetRequest struct {
...
type AndroidpublisherSystemapksVariantsGetResponse struct {
	ContentType string
	StatusCode  int
