...
class GetSubstanceTreatsAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetSubstanceTreatsAssociationsQueryParams:
...
@dataclasses.dataclass
class GetSubstanceTreatsAssociationsRequest:
    path_params: GetSubstanceTreatsAssociationsPathParams = dataclasses.field()
    query_params: GetSubstanceTreatsAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetSubstanceTreatsAssociationsResponse:
