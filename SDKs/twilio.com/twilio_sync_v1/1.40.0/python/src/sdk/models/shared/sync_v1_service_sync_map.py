...
class SyncV1ServiceSyncMap:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Sync Map resource."""  
    ...
    r"""The identity of the Sync Map's creator. If the Sync Map is created from the client SDK, the value matches the Access Token's `identity` field. If the Sync Map was created from the REST API, the value is `system`."""  
    ...
    r"""The date and time in GMT when the Sync Map expires and will be deleted, specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. If the Sync Map does not expire, this value is `null`. The Sync Map might not be deleted immediately after it expires."""  
    ...
    r"""The URLs of the Sync Map's nested resources."""  
    ...
    r"""The current revision of the Sync Map, represented as a string."""  
    ...
    r"""The unique string that we created to identify the Sync Map resource."""  
    ...
    r"""The absolute URL of the Sync Map resource."""  
