...
class CreateOrderCreateSubscriptionTerms
{
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CreateOrderCreateSubscriptionTermsInitialTerm $initialTerm
     */
	#[\JMS\Serializer\Annotation\SerializedName('initialTerm')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateOrderCreateSubscriptionTermsInitialTerm')]
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateOrderCreateSubscriptionTermsRenewalSettingEnum $renewalSetting
     */
	#[\JMS\Serializer\Annotation\SerializedName('renewalSetting')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateOrderCreateSubscriptionTermsRenewalSettingEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateOrderCreateSubscriptionTermsRenewalSettingEnum $renewalSetting = null;
	...
	{
		$this->autoRenew = null;
		$this->initialTerm = new \OpenAPI\OpenAPI\Models\Shared\CreateOrderCreateSubscriptionTermsInitialTerm();
