...
from ..shared import content_models_contenttypedescription as shared_content_models_contenttypedescription
...
@dataclasses.dataclass
class ContentGetContentType200Wildcard:
    ...
    response: Optional[shared_content_models_contenttypedescription.ContentModelsContentTypeDescription] = dataclasses.field(default=None)  
