...
from ..shared import deletecustomersupportcustomerresponse as shared_deletecustomersupportcustomerresponse
...
class CustomersDeleteRequest:
    headers: CustomersDeleteHeaders = dataclasses.field()
    path_params: CustomersDeletePathParams = dataclasses.field()
    query_params: CustomersDeleteQueryParams = dataclasses.field()
    security: CustomersDeleteSecurity = dataclasses.field()
...
class CustomersDeleteResponse:
    ...
    delete_customer_support_customer_response: Optional[shared_deletecustomersupportcustomerresponse.DeleteCustomerSupportCustomerResponse] = dataclasses.field(default=None)
