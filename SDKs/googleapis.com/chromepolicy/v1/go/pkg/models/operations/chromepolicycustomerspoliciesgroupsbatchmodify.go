...
type ChromepolicyCustomersPoliciesGroupsBatchModifyRequest struct {
	...
	GoogleChromePolicyVersionsV1BatchModifyGroupPoliciesRequest *shared.GoogleChromePolicyVersionsV1BatchModifyGroupPoliciesRequest `request:"mediaType=application/json"`
	// OAuth access token.
