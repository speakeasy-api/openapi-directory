...
exports.GETCustomExchangeRatesResponse = exports.GETCustomExchangeRatesRequest = void 0;
...
var GETCustomExchangeRatesRequest = /** @class */ (function (_super) {
    ...
    ], GETCustomExchangeRatesRequest.prototype, "zuoraEntityIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Zuora-Track-Id",
        }),
        __metadata("design:type", String)
    ], GETCustomExchangeRatesRequest.prototype, "zuoraTrackId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=currency",
        }),
        __metadata("design:type", String)
    ], GETCustomExchangeRatesRequest.prototype, "currency", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=endDate",
        }),
        __metadata("design:type", String)
    ], GETCustomExchangeRatesRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=startDate",
        }),
        __metadata("design:type", String)
    ], GETCustomExchangeRatesRequest.prototype, "startDate", void 0);
...
var GETCustomExchangeRatesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GETCustomExchangeRatesResponse.prototype, "rawResponse", void 0);
