...
from ..shared import getdrivegroupresponse as shared_getdrivegroupresponse
...
@dataclasses.dataclass
class DriveGroupsOneSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class DriveGroupsOneRequest:
    headers: DriveGroupsOneHeaders = dataclasses.field()
    path_params: DriveGroupsOnePathParams = dataclasses.field()
    query_params: DriveGroupsOneQueryParams = dataclasses.field()
    security: DriveGroupsOneSecurity = dataclasses.field()
    

@dataclasses.dataclass
class DriveGroupsOneResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    get_drive_group_response: Optional[shared_getdrivegroupresponse.GetDriveGroupResponse] = dataclasses.field(default=None)
