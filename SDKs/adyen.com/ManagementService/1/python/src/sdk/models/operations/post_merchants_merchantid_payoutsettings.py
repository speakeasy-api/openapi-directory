...
from ..shared import payoutsettings as shared_payoutsettings
from ..shared import payoutsettingsrequest as shared_payoutsettingsrequest
...
class PostMerchantsMerchantIDPayoutSettingsSecurity:
...
@dataclasses.dataclass
class PostMerchantsMerchantIDPayoutSettingsRequest:
    ...
    payout_settings_request: Optional[shared_payoutsettingsrequest.PayoutSettingsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    

@dataclasses.dataclass
class PostMerchantsMerchantIDPayoutSettingsResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    payout_settings: Optional[shared_payoutsettings.PayoutSettings] = dataclasses.field(default=None)
