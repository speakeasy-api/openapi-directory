...
export class RetailProjectsLocationsCatalogsControlsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsControlsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsControlsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
