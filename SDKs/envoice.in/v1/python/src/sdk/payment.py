...
class Payment:
    ...
    def payment_api_supported(self, request: operations.PaymentAPISupportedRequest) -> operations.PaymentAPISupportedResponse:
        ...
        res = operations.PaymentAPISupportedResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.PaymentGatewayDetailsAPIModel]])
