...
public class ListServiceListServiceResponse {
    ...
    public openapisdk.models.shared.IpMessagingV2Service[] services;
    public ListServiceListServiceResponse withServices(openapisdk.models.shared.IpMessagingV2Service[] services) {
