...
exports.SmsChannelResponse = void 0;
...
var SmsChannelResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=PromotionalMessagesPerSecond" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TransactionalMessagesPerSecond" }),
        __metadata("design:type", Number)
...
exports.SmsChannelResponse = SmsChannelResponse;
