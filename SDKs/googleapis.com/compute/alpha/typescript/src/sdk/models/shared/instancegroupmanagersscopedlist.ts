 ...
 */
export enum InstanceGroupManagersScopedListWarningCodeEnum {
...
export class InstanceGroupManagersScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceGroupManagersScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceGroupManagersScopedListWarningData })
  @Expose({ name: "data" })
...
export class InstanceGroupManagersScopedList extends SpeakeasyBase {
  /**
   * [Output Only] The list of managed instance groups that are contained in the specified project and zone.
   */
  @SpeakeasyMetadata({ elemType: InstanceGroupManager })
  @Expose({ name: "instanceGroupManagers" })
