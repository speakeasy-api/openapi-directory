...
from ..shared import getmerchantresponse as shared_getmerchantresponse
...
class MerchantsOneSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class MerchantsOneRequest:
...
@dataclasses.dataclass
class MerchantsOneResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    get_merchant_response: Optional[shared_getmerchantresponse.GetMerchantResponse] = dataclasses.field(default=None)
    r"""Merchants"""  
