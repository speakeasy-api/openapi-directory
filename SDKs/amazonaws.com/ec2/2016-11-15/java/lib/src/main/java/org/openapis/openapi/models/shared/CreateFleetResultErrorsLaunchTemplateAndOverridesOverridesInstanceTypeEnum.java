 ...
 */
public enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceTypeEnum {
    A1_MEDIUM("a1.medium"),
    A1_LARGE("a1.large"),
    A1_XLARGE("a1.xlarge"),
    ...
    private CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceTypeEnum(String value) {
        this.value = value;
    }
}
