...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.appApiWMMEndpointsWMMMagneticField = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.AppApiWMMEndpointsWMMMagneticFieldResponse({
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.appApiWMMEndpointsWMMMagneticField200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.AppApiWMMEndpointsWMMMagneticField200ApplicationJSON);
                    }
                    break;
            }
            return res;
