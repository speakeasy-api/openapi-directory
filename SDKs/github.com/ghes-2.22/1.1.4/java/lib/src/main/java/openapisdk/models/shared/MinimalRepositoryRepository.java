...
public class MinimalRepositoryRepository {
    ...
    public MinimalRepositoryRepositorySimpleUser organization;
    public MinimalRepositoryRepository withOrganization(MinimalRepositoryRepositorySimpleUser organization) {
