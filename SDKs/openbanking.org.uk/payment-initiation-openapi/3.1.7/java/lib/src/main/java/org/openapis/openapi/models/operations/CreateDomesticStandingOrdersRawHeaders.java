...
public class CreateDomesticStandingOrdersRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticStandingOrdersRawHeaders withAuthorization(String authorization) {
    ...
    public CreateDomesticStandingOrdersRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticStandingOrdersRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticStandingOrdersRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateDomesticStandingOrdersRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateDomesticStandingOrdersRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticStandingOrdersRawHeaders withXJwsSignature(String xJwsSignature) {
