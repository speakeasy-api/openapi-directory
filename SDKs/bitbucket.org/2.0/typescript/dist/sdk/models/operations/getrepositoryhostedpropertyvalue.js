...
exports.GetRepositoryHostedPropertyValueResponse = exports.GetRepositoryHostedPropertyValueRequest = void 0;
...
var GetRepositoryHostedPropertyValueRequest = /** @class */ (function (_super) {
    ...
    ], GetRepositoryHostedPropertyValueRequest.prototype, "appKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=property_name",
        }),
        __metadata("design:type", String)
    ], GetRepositoryHostedPropertyValueRequest.prototype, "propertyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], GetRepositoryHostedPropertyValueRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], GetRepositoryHostedPropertyValueRequest.prototype, "workspace", void 0);
...
var GetRepositoryHostedPropertyValueResponse = /** @class */ (function (_super) {
    ...
    ], GetRepositoryHostedPropertyValueResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetRepositoryHostedPropertyValueResponse.prototype, "applicationProperty", void 0);
