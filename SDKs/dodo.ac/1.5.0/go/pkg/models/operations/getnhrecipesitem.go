...
type GetNhRecipesItemPathParams struct {
...
type GetNhRecipesItemQueryParams struct {
...
type GetNhRecipesItemHeaders struct {
...
type GetNhRecipesItemRequest struct {
	PathParams  GetNhRecipesItemPathParams
	QueryParams GetNhRecipesItemQueryParams
	Headers     GetNhRecipesItemHeaders
}

type GetNhRecipesItemResponse struct {
	ContentType string
