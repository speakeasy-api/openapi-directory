...
class PUTCustomObjectRecordRequest:
    ...
    r"""The expected ETag of the resource. You can use this header to perform a conditional request. Zuora responds with 412 Precondition Failed if the ETag of the resource does not match the value of this header."""  
...
class PUTCustomObjectRecordResponse:
    ...
    r"""Object record does not exist"""  
    custom_object_record_with_all_fields: Optional[shared_customobjectrecordwithallfields.CustomObjectRecordWithAllFields] = dataclasses.field(default=None)
    r"""OK"""  
