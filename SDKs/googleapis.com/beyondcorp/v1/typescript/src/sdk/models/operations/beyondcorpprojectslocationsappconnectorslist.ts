...
export class BeyondcorpProjectsLocationsAppConnectorsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BeyondcorpProjectsLocationsAppConnectorsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BeyondcorpProjectsLocationsAppConnectorsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
