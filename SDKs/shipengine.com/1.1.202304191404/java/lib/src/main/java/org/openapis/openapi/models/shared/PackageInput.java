...
public class PackageInput {
    ...
    public PackageInput withContentDescription(String contentDescription) {
    ...
    public PackageInput withPackageId(String packageId) {
    ...
    public PackageInput(@JsonProperty("weight") Weight weight) {
        this.weight = weight;
  }
}
