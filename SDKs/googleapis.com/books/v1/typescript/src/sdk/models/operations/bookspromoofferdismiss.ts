...
export class BooksPromoofferDismissQueryParams extends SpeakeasyBase {
...
export class BooksPromoofferDismissSecurity extends SpeakeasyBase {
...
export class BooksPromoofferDismissRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class BooksPromoofferDismissResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
