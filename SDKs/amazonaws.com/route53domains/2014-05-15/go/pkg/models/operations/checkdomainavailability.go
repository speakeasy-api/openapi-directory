...
func (e CheckDomainAvailabilityXAmzTargetEnum) ToPointer() *CheckDomainAvailabilityXAmzTargetEnum {
	return &e
}
...
func (e *CheckDomainAvailabilityXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "Route53Domains_v20140515.CheckDomainAvailability":
		*e = CheckDomainAvailabilityXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CheckDomainAvailabilityXAmzTargetEnum: %v", v)
	}
}
