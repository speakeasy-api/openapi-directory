...
var GoogleCloudContactcenterinsightsV1CalculateStatsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "averageDuration" }),
        __metadata("design:type", String)
    ], GoogleCloudContactcenterinsightsV1CalculateStatsResponse.prototype, "averageDuration", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "averageTurnCount" }),
        __metadata("design:type", Number)
    ], GoogleCloudContactcenterinsightsV1CalculateStatsResponse.prototype, "averageTurnCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "conversationCount" }),
        __metadata("design:type", Number)
    ], GoogleCloudContactcenterinsightsV1CalculateStatsResponse.prototype, "conversationCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "conversationCountTimeSeries" }),
        (0, class_transformer_1.Type)(function () { return googlecloudcontactcenterinsightsv1calculatestatsresponsetimeseries_1.GoogleCloudContactcenterinsightsV1CalculateStatsResponseTimeSeries; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "customHighlighterMatches" }),
        __metadata("design:type", Object)
    ], GoogleCloudContactcenterinsightsV1CalculateStatsResponse.prototype, "customHighlighterMatches", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "issueMatches" }),
        __metadata("design:type", Object)
    ], GoogleCloudContactcenterinsightsV1CalculateStatsResponse.prototype, "issueMatches", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: googlecloudcontactcenterinsightsv1issuemodellabelstatsissuestats_1.GoogleCloudContactcenterinsightsV1IssueModelLabelStatsIssueStats,
        }),
        (0, class_transformer_1.Expose)({ name: "issueMatchesStats" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], googlecloudcontactcenterinsightsv1issuemodellabelstatsissuestats_1.GoogleCloudContactcenterinsightsV1IssueModelLabelStatsIssueStats);
            }
            return obj;
        }, { toClassOnly: true }),
        __metadata("design:type", Object)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "smartHighlighterMatches" }),
        __metadata("design:type", Object)
