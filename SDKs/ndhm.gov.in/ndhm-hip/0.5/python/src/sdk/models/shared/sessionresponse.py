...
class SessionResponse:
    ...
    r"""In Minutes"""  
    refresh_expires_in: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('refreshExpiresIn'), 'exclude': lambda f: f is None }})
    r"""In Minutes"""  
