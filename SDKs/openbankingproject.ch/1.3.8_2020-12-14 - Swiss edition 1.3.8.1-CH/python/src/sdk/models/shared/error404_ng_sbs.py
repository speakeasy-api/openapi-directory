...
from ..shared import tppmessage404_sbs as shared_tppmessage404_sbs
...
class Error404NgSbs:
    ...
    tpp_messages: Optional[list[shared_tppmessage404_sbs.TppMessage404Sbs]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tppMessages') }})
