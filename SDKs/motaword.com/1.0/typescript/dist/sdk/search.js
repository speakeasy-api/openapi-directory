...
var Search = /** @class */ (function () {
    ...
    **/
    Search.prototype.checkDocumentsReindex = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CheckDocumentsReindexRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/search/documents/reindex/status";
    ...
    **/
    Search.prototype.reindexDocuments = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/search/documents/reindex";
        var client = this._securityClient;
    ...
    **/
    Search.prototype.searchEverywhere = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.searchEverywhereResult = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
