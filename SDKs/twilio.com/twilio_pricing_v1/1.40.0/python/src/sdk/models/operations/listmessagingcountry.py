...
class ListMessagingCountryListMessagingCountryResponse:
    ...
    countries: Optional[list[shared_pricing_v1_messaging_messaging_country.PricingV1MessagingMessagingCountry]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('countries'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListMessagingCountryListMessagingCountryResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
