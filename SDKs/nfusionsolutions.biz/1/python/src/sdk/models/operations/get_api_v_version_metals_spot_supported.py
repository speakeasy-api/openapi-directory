...
class GetAPIVVersionMetalsSpotSupportedRequest:
    path_params: GetAPIVVersionMetalsSpotSupportedPathParams = dataclasses.field()
    query_params: GetAPIVVersionMetalsSpotSupportedQueryParams = dataclasses.field()
...
class GetAPIVVersionMetalsSpotSupportedResponse:
    ...
    get_api_v_version_metals_spot_supported_200_application_json_strings: Optional[list[str]] = dataclasses.field(default=None)
