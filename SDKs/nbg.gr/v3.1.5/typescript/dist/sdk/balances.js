...
var Balances = /** @class */ (function () {
    function Balances(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Balances.prototype.getAccountsAccountIdBalances = function (req, config) {
