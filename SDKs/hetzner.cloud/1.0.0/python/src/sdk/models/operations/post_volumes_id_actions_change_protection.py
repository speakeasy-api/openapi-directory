...
class PostVolumesIDActionsChangeProtectionRequestBody:
    ...
    r"""If true, prevents the Volume from being deleted"""  
...
class PostVolumesIDActionsChangeProtectionRequest:
    ...
    r"""ID of the Volume"""  
    request_body: Optional[PostVolumesIDActionsChangeProtectionRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class PostVolumesIDActionsChangeProtectionActionResponseAction:
    ...
    error: PostVolumesIDActionsChangeProtectionActionResponseActionError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    r"""Error message for the Action if error occurred, otherwise null"""  
    ...
    resources: list[PostVolumesIDActionsChangeProtectionActionResponseActionResources] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources') }})
    ...
    status: PostVolumesIDActionsChangeProtectionActionResponseActionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Status of the Action"""  
...
class PostVolumesIDActionsChangeProtectionActionResponse:
    ...
    action: PostVolumesIDActionsChangeProtectionActionResponseAction = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action') }})  
