...
public class Offer {
    ...
    **/
    public openapisdk.models.operations.FindEligibleItemsResponse findEligibleItems(openapisdk.models.operations.FindEligibleItemsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/find_eligible_items");
        ...
        openapisdk.models.operations.FindEligibleItemsResponse res = new openapisdk.models.operations.FindEligibleItemsResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.PagedEligibleItemCollection out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.PagedEligibleItemCollection.class);
    ...
    **/
    public openapisdk.models.operations.SendOfferToInterestedBuyersResponse sendOfferToInterestedBuyers(openapisdk.models.operations.SendOfferToInterestedBuyersRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/send_offer_to_interested_buyers");
        ...
        openapisdk.models.operations.SendOfferToInterestedBuyersResponse res = new openapisdk.models.operations.SendOfferToInterestedBuyersResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.SendOfferToInterestedBuyersCollectionResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.SendOfferToInterestedBuyersCollectionResponse.class);
