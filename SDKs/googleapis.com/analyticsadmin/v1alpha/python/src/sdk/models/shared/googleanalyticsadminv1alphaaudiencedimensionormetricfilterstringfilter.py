...
class GoogleAnalyticsAdminV1alphaAudienceDimensionOrMetricFilterStringFilter:
    ...
    match_type: Optional[GoogleAnalyticsAdminV1alphaAudienceDimensionOrMetricFilterStringFilterMatchTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('matchType'), 'exclude': lambda f: f is None }})
    r"""Required. The match type for the string filter."""  
