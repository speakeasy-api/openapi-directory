...
exports.CreditNotesDeleteResponse = exports.CreditNotesDeleteRequest = exports.CreditNotesDeleteSecurity = void 0;
...
exports.CreditNotesDeleteSecurity = CreditNotesDeleteSecurity;
var CreditNotesDeleteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CreditNotesDeleteRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], CreditNotesDeleteRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], CreditNotesDeleteRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], CreditNotesDeleteRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], CreditNotesDeleteRequest.prototype, "xApideckServiceId", void 0);
    return CreditNotesDeleteRequest;
}(utils_1.SpeakeasyBase));
exports.CreditNotesDeleteRequest = CreditNotesDeleteRequest;
var CreditNotesDeleteResponse = /** @class */ (function (_super) {
    ...
    ], CreditNotesDeleteResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.CreditNotesDeleteResponse = CreditNotesDeleteResponse;
