...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsList = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2beta2/{name}/locations", req.pathParams);
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesCreate = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{parent}/queues", req.pathParams);
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesGetIamPolicy = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{resource}:getIamPolicy", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesPatch = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{name}", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesPause = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{name}:pause", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesPurge = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{name}:purge", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesResume = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{name}:resume", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesSetIamPolicy = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{resource}:setIamPolicy", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesTasksAcknowledge = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudtasksProjectsLocationsQueuesTasksAcknowledgeRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{name}:acknowledge", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesTasksBuffer = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudtasksProjectsLocationsQueuesTasksBufferRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{queue}/tasks/{taskId}:buffer", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.bufferTaskResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesTasksCancelLease = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudtasksProjectsLocationsQueuesTasksCancelLeaseRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{name}:cancelLease", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesTasksCreate = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{parent}/tasks", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesTasksLease = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudtasksProjectsLocationsQueuesTasksLeaseRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{parent}/tasks:lease", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.leaseTasksResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesTasksRenewLease = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudtasksProjectsLocationsQueuesTasksRenewLeaseRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{name}:renewLease", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesTasksRun = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{name}:run", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.cloudtasksProjectsLocationsQueuesTestIamPermissions = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2beta2/{resource}:testIamPermissions", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
