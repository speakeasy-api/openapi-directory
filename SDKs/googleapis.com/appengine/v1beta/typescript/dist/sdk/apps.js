...
var Apps = /** @class */ (function () {
    ...
    Apps.prototype.appengineAppsAuthorizedCertificatesCreate = function (req, security, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/authorizedCertificates", req);
    ...
    Apps.prototype.appengineAppsAuthorizedCertificatesDelete = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/authorizedCertificates/{authorizedCertificatesId}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security =
    ...
    Apps.prototype.appengineAppsAuthorizedDomainsList = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/authorizedDomains", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Apps.prototype.appengineAppsCreate = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1beta/apps";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Apps.prototype.appengineAppsDomainMappingsCreate = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/domainMappings", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Apps.prototype.appengineAppsDomainMappingsDelete = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/domainMappings/{domainMappingsId}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Apps.prototype.appengineAppsFirewallIngressRulesBatchUpdate = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/firewall/ingressRules:batchUpdate", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Apps.prototype.appengineAppsFirewallIngressRulesCreate = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/firewall/ingressRules", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Apps.prototype.appengineAppsFirewallIngressRulesDelete = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/firewall/ingressRules/{ingressRulesId}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Apps.prototype.appengineAppsGet = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Apps.prototype.appengineAppsLocationsGet = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/locations/{locationsId}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Apps.prototype.appengineAppsLocationsList = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/locations", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Apps.prototype.appengineAppsOperationsGet = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/operations/{operationsId}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Apps.prototype.appengineAppsOperationsList = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/operations", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Apps.prototype.appengineAppsRepair = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}:repair", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Apps.prototype.appengineAppsServicesDelete = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/services/{servicesId}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Apps.prototype.appengineAppsServicesList = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/services", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Apps.prototype.appengineAppsServicesVersionsCreate = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/services/{servicesId}/versions", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Apps.prototype.appengineAppsServicesVersionsDelete = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/services/{servicesId}/versions/{versionsId}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    Apps.prototype.appengineAppsServicesVersionsInstancesDebug = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}:debug", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
    ...
    Apps.prototype.appengineAppsServicesVersionsInstancesDelete = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security =
    ...
    Apps.prototype.appengineAppsServicesVersionsInstancesList = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1beta/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security =
