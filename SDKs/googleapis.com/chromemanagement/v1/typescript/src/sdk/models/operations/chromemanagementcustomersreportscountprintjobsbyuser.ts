...
export class ChromemanagementCustomersReportsCountPrintJobsByUserSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ChromemanagementCustomersReportsCountPrintJobsByUserRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ChromemanagementCustomersReportsCountPrintJobsByUserResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
