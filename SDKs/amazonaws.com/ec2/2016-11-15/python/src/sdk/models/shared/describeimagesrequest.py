...
class DescribeImagesRequest:
    ...
    executable_users: Optional[list[str]] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeImagesRequestFilters]] = dataclasses.field(default=None)  
    image_ids: Optional[list[str]] = dataclasses.field(default=None)  
    include_deprecated: Optional[bool] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    owners: Optional[list[str]] = dataclasses.field(default=None)  
