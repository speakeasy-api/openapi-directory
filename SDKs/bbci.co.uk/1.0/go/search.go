...
// Search-suggest
func (s *Search) SearchSuggest(ctx context.Context, request operations.SearchSuggestRequest) (*operations.SearchSuggestResponse, error) {
	...
	res := &operations.SearchSuggestResponse{
