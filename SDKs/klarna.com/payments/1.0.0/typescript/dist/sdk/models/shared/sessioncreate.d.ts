 ...
 */
export declare enum SessionCreateAcquiringChannelEnum {
    Ecommerce = "ECOMMERCE",
    InStore = "IN_STORE",
    Telesales = "TELESALES"
}
 ...
 */
export declare enum SessionCreateIntentEnum {
    Buy = "buy",
    Tokenize = "tokenize",
 ...
 * session_request
 */
export declare class SessionCreateInput extends SpeakeasyBase {
    /**
     * The acquiring channel in which the session takes place. Ecommerce is default unless specified. Any other values should be defined in the agreement.
     */
