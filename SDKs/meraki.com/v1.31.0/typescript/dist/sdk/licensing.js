...
var Licensing = /** @class */ (function () {
    function Licensing(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * List the licenses in a coterm organization
     */
    Licensing.prototype.getOrganizationLicensingCotermLicenses = function (req, config) {
     ...
     * Moves a license to a different organization (coterm only)
     */
    Licensing.prototype.moveOrganizationLicensingCotermLicenses = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
