...
public class FunctionsListQueryParams {
    ...
    public FunctionsListQueryParams withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public FunctionsListQueryParams withOrderType(String orderType) {
    ...
    public FunctionsListQueryParams withSearch(String search) {
        this.search = search;
        return this;
    }
