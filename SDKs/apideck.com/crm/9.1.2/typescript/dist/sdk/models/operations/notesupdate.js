...
exports.NotesUpdateResponse = exports.NotesUpdateRequest = exports.NotesUpdateSecurity = void 0;
...
exports.NotesUpdateSecurity = NotesUpdateSecurity;
var NotesUpdateRequest = /** @class */ (function (_super) {
    ...
    ], NotesUpdateRequest.prototype, "noteInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], NotesUpdateRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], NotesUpdateRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], NotesUpdateRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], NotesUpdateRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], NotesUpdateRequest.prototype, "xApideckServiceId", void 0);
    return NotesUpdateRequest;
}(utils_1.SpeakeasyBase));
exports.NotesUpdateRequest = NotesUpdateRequest;
var NotesUpdateResponse = /** @class */ (function (_super) {
    ...
    ], NotesUpdateResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.NotesUpdateResponse = NotesUpdateResponse;
