...
from ..shared import messagecode403_ais_enum as shared_messagecode403_ais_enum
...
class TppMessage403Ais:
    ...
    code: shared_messagecode403_ais_enum.MessageCode403AisEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('code') }})
