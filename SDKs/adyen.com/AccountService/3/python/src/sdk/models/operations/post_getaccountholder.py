...
from ..shared import getaccountholderresponse as shared_getaccountholderresponse
...
class PostGetAccountHolderResponse:
    ...
    get_account_holder_response: Optional[shared_getaccountholderresponse.GetAccountHolderResponse] = dataclasses.field(default=None)
