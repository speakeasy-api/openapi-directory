...
type ComputeClusterSummary struct {
	...
	DrsStatus *bool `json:"drsStatus,omitempty"`
	...
	HostVersions []string `json:"hostVersions"`
	// The ID of the Rubrik object.
	ID string `json:"id"`
	// Status of Rubrik Io Filter on Cluster.
	IoFilterStatus IoFilterStatusEnum `json:"ioFilterStatus"`
	...
	LastUsedFqdn                        *string `json:"lastUsedFqdn,omitempty"`
