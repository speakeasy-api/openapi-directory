...
exports.ExportTableToPointInTimeResponse = exports.ExportTableToPointInTimeRequest = exports.ExportTableToPointInTimeXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var ExportTableToPointInTimeXAmzTargetEnum;
...
})(ExportTableToPointInTimeXAmzTargetEnum = exports.ExportTableToPointInTimeXAmzTargetEnum || (exports.ExportTableToPointInTimeXAmzTargetEnum = {}));
var ExportTableToPointInTimeRequest = /** @class */ (function (_super) {
    ...
    ], ExportTableToPointInTimeRequest.prototype, "exportTableToPointInTimeInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], ExportTableToPointInTimeRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], ExportTableToPointInTimeRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], ExportTableToPointInTimeRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], ExportTableToPointInTimeRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], ExportTableToPointInTimeRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], ExportTableToPointInTimeRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], ExportTableToPointInTimeRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], ExportTableToPointInTimeRequest.prototype, "xAmzTarget", void 0);
    return ExportTableToPointInTimeRequest;
}(utils_1.SpeakeasyBase));
exports.ExportTableToPointInTimeRequest = ExportTableToPointInTimeRequest;
var ExportTableToPointInTimeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ExportTableToPointInTimeResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.ExportTableToPointInTimeResponse = ExportTableToPointInTimeResponse;
