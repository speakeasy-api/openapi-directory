...
exports.AccountsResponse = exports.AccountsAccountList = exports.AccountsAccountListAccounts = exports.AccountsRequest = void 0;
...
var AccountsRequest = /** @class */ (function (_super) {
    ...
    ], AccountsRequest.prototype, "nextPageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_number",
        }),
        __metadata("design:type", Number)
    ], AccountsRequest.prototype, "pageNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], AccountsRequest.prototype, "pageSize", void 0);
...
var AccountsAccountListAccounts = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subscription_end_time" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subscription_start_time" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
...
var AccountsAccountList = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: AccountsAccountListAccounts }),
        (0, class_transformer_1.Expose)({ name: "accounts" }),
        (0, class_transformer_1.Type)(function () { return AccountsAccountListAccounts; }),
...
var AccountsResponse = /** @class */ (function (_super) {
    ...
    ], AccountsResponse.prototype, "rawResponse", void 0);
