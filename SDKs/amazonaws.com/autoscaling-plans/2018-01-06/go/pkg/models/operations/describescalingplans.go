...
func (e DescribeScalingPlansXAmzTargetEnum) ToPointer() *DescribeScalingPlansXAmzTargetEnum {
	return &e
}
...
func (e *DescribeScalingPlansXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AnyScaleScalingPlannerFrontendService.DescribeScalingPlans":
		*e = DescribeScalingPlansXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeScalingPlansXAmzTargetEnum: %v", v)
	}
}
