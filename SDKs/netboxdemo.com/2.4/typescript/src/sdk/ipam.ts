...
export class Ipam {
  ...
  ipamChoicesList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.IpamChoicesListResponse =
        new operations.IpamChoicesListResponse({
  ...
  ipamChoicesRead(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/ipam/_choices/{id}/", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.IpamChoicesReadResponse =
        new operations.IpamChoicesReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
