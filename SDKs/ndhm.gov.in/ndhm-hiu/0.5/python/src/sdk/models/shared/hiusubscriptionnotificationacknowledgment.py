...
class HIUSubscriptionNotificationAcknowledgmentAcknowledgement:
    ...
    status: HIUSubscriptionNotificationAcknowledgmentAcknowledgementStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
...
class HIUSubscriptionNotificationAcknowledgment:
    ...
    acknowledgement: Optional[HIUSubscriptionNotificationAcknowledgmentAcknowledgement] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('acknowledgement'), 'exclude': lambda f: f is None }})  
