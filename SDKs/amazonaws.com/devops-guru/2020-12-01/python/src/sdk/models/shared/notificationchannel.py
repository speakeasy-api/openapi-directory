...
class NotificationChannel:
    ...
    config: Optional[shared_notificationchannelconfig.NotificationChannelConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Config') }})
