...
exports.ListEndUserTypeResponse = exports.ListEndUserTypeListEndUserTypeResponse = exports.ListEndUserTypeListEndUserTypeResponseMeta = exports.ListEndUserTypeRequest = exports.ListEndUserTypeSecurity = exports.ListEndUserTypeServerList = void 0;
...
var ListEndUserTypeSecurity = /** @class */ (function (_super) {
    ...
    ], ListEndUserTypeSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListEndUserTypeSecurity.prototype, "username", void 0);
...
var ListEndUserTypeRequest = /** @class */ (function (_super) {
    ...
    ], ListEndUserTypeRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListEndUserTypeRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListEndUserTypeRequest.prototype, "pageToken", void 0);
...
var ListEndUserTypeListEndUserTypeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.TrusthubV1EndUserType }),
        (0, class_transformer_1.Expose)({ name: "end_user_types" }),
        (0, class_transformer_1.Type)(function () { return shared.TrusthubV1EndUserType; }),
        __metadata("design:type", Array)
    ], ListEndUserTypeListEndUserTypeResponse.prototype, "endUserTypes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListEndUserTypeListEndUserTypeResponseMeta; }),
...
var ListEndUserTypeResponse = /** @class */ (function (_super) {
    ...
    ], ListEndUserTypeResponse.prototype, "rawResponse", void 0);
