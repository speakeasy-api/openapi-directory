...
func (e GETListServiceSpecificCredentialsActionEnum) ToPointer() *GETListServiceSpecificCredentialsActionEnum {
	return &e
}
...
func (e *GETListServiceSpecificCredentialsActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "ListServiceSpecificCredentials":
		*e = GETListServiceSpecificCredentialsActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETListServiceSpecificCredentialsActionEnum: %v", v)
	}
}
...
func (e GETListServiceSpecificCredentialsVersionEnum) ToPointer() *GETListServiceSpecificCredentialsVersionEnum {
	return &e
}
...
func (e *GETListServiceSpecificCredentialsVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2010-05-08":
		*e = GETListServiceSpecificCredentialsVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETListServiceSpecificCredentialsVersionEnum: %v", v)
	}
}
