 ...
 */
export declare class DescribeClientVpnTargetNetworksRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeClientVpnTargetNetworksRequest extends SpeakeasyBase {
