...
class GetDetachInstancesQueryParams:
    action: GetDetachInstancesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDetachInstancesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDetachInstancesRequest:
    headers: GetDetachInstancesHeaders = dataclasses.field()
    query_params: GetDetachInstancesQueryParams = dataclasses.field()
