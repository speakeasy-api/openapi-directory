...
exports.VCenterDataSource = void 0;
var utils_1 = require("../../../internal/utils");
var passwordcredentials_1 = require("./passwordcredentials");
var datasourcetypeenum_1 = require("./datasourcetypeenum");
var VCenterDataSource = /** @class */ (function (_super) {
    __extends(VCenterDataSource, _super);
    function VCenterDataSource() {
    ...
    ], VCenterDataSource.prototype, "credentials", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=enabled" }),
        __metadata("design:type", Boolean)
    ], VCenterDataSource.prototype, "enabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=entity_id" }),
        __metadata("design:type", String)
    ], VCenterDataSource.prototype, "entityId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=entity_type" }),
        __metadata("design:type", String)
    ], VCenterDataSource.prototype, "entityType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=fqdn" }),
        __metadata("design:type", String)
    ], VCenterDataSource.prototype, "fqdn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ip" }),
        __metadata("design:type", String)
    ], VCenterDataSource.prototype, "ip", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=nickname" }),
        __metadata("design:type", String)
    ], VCenterDataSource.prototype, "nickname", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=notes" }),
        __metadata("design:type", String)
    ], VCenterDataSource.prototype, "notes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=proxy_id" }),
        __metadata("design:type", String)
    ], VCenterDataSource.prototype, "proxyId", void 0);
    return VCenterDataSource;
}(utils_1.SpeakeasyBase));
exports.VCenterDataSource = VCenterDataSource;
