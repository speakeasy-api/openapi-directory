...
class RunNamespacesTasksListPathParams:
    parent: str = dataclasses.field(metadata={'path_param': { 'field_name': 'parent', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class RunNamespacesTasksListQueryParams:
...
@dataclasses.dataclass
class RunNamespacesTasksListRequest:
    path_params: RunNamespacesTasksListPathParams = dataclasses.field()
    query_params: RunNamespacesTasksListQueryParams = dataclasses.field()
    security: RunNamespacesTasksListSecurity = dataclasses.field()
    

@dataclasses.dataclass
class RunNamespacesTasksListResponse:
