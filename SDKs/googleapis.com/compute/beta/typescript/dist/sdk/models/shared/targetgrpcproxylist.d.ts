 ...
 */
export declare enum TargetGrpcProxyListWarningCodeEnum {
...
export declare class TargetGrpcProxyListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetGrpcProxyListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: TargetGrpcProxyListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: TargetGrpcProxyListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class TargetGrpcProxyList extends SpeakeasyBase {
    /**
