...
type LibraryagentShelvesBooksBorrowSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type LibraryagentShelvesBooksBorrowPathParams struct {
	// Required. The name of the book to borrow.
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type LibraryagentShelvesBooksBorrowQueryParams struct {
	// V1 error format.
...
type LibraryagentShelvesBooksBorrowRequest struct {
...
type LibraryagentShelvesBooksBorrowResponse struct {
	ContentType string
	// Successful response
