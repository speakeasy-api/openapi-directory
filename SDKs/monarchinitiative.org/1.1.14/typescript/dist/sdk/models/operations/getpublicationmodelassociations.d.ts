...
export declare class GetPublicationModelAssociationsRequest extends SpeakeasyBase {
    /**
...
export declare class GetPublicationModelAssociationsResponse extends SpeakeasyBase {
    /**
     * Success
     */
