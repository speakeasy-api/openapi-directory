...
from ..shared import proxymodifyamendment as shared_proxymodifyamendment
...
class ObjectPUTAmendmentRequest:
    ...
    r"""Object id"""  
    proxy_modify_amendment: shared_proxymodifyamendment.ProxyModifyAmendment = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
