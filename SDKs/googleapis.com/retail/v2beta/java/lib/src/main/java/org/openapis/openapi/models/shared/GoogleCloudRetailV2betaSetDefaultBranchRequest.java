...
public class GoogleCloudRetailV2betaSetDefaultBranchRequest {
    ...
    public GoogleCloudRetailV2betaSetDefaultBranchRequest withBranchId(String branchId) {
    ...
    public GoogleCloudRetailV2betaSetDefaultBranchRequest withForce(Boolean force) {
        this.force = force;
        return this;
    }
    ...
    public GoogleCloudRetailV2betaSetDefaultBranchRequest withNote(String note) {
        this.note = note;
        return this;
    }
