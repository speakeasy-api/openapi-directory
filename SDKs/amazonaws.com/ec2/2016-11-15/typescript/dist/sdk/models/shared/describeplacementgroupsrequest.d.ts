 ...
 */
export declare class DescribePlacementGroupsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribePlacementGroupsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribePlacementGroupsRequestFilters[];
    groupIds?: string[];
    groupNames?: string[];
}
