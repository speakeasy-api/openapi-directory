...
export class GetAs2OutgoingMessagesRequest extends SpeakeasyBase {
  /**
...
export class GetAs2OutgoingMessagesResponse extends SpeakeasyBase {
  /**
   * A list of As2OutgoingMessages objects.
   */
  @SpeakeasyMetadata({ elemType: shared.As2OutgoingMessageEntity })
