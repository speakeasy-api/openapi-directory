...
<https://docs.github.com/enterprise-server@3.4/rest/migrations/orgs#delete-an-organization-migration-archive>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            MigrationsDeleteArchiveForOrgRequest req = new MigrationsDeleteArchiveForOrgRequest(895692L, "quasi");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/migrations/orgs#download-an-organization-migration-archive>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            MigrationsDownloadArchiveForOrgRequest req = new MigrationsDownloadArchiveForOrgRequest(392569L, "at");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/migrations/users#download-a-user-migration-archive>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            MigrationsGetArchiveForAuthenticatedUserRequest req = new MigrationsGetArchiveForAuthenticatedUserRequest(878373L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/migrations/orgs#get-an-organization-migration-status>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            MigrationsGetStatusForOrgRequest req = new MigrationsGetStatusForOrgRequest(667593L, "harum") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/migrations/users#list-user-migrations>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/migrations/orgs#list-organization-migrations>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            MigrationsListForOrgRequest req = new MigrationsListForOrgRequest("optio") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/migrations/users#list-repositories-for-a-user-migration>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            MigrationsListReposForAuthenticatedUserRequest req = new MigrationsListReposForAuthenticatedUserRequest(501063L) {{
                page = 642352L;
                perPage = 376389L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/migrations/orgs#list-repositories-in-an-organization-migration>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            MigrationsListReposForOrgRequest req = new MigrationsListReposForOrgRequest(254025L, "nemo") {{
                page = 551079L;
                perPage = 260904L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/migrations/users#start-a-user-migration>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/migrations/orgs#start-an-organization-migration>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/migrations/orgs#unlock-an-organization-repository>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            MigrationsUnlockRepoForOrgRequest req = new MigrationsUnlockRepoForOrgRequest(97493L, "rem", "fugiat");            
