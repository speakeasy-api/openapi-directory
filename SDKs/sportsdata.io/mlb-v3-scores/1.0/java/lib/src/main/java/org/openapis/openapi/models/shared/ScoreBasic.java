...
public class ScoreBasic {
    ...
    public ScoreBasic withAttendance(Long attendance) {
    ...
    public ScoreBasic withAwayTeamErrors(Long awayTeamErrors) {
    ...
    public ScoreBasic withAwayTeamHits(Long awayTeamHits) {
    ...
    public ScoreBasic withAwayTeamRuns(Long awayTeamRuns) {
    ...
    public ScoreBasic withHomeTeamErrors(Long homeTeamErrors) {
    ...
    public ScoreBasic withHomeTeamHits(Long homeTeamHits) {
    ...
    public ScoreBasic withHomeTeamRuns(Long homeTeamRuns) {
    ...
    public ScoreBasic withInning(Long inning) {
        this.inning = inning;
        return this;
    }
    ...
    public ScoreBasic withInningHalf(String inningHalf) {
    ...
    public ScoreBasic withRescheduledFromGameID(Long rescheduledFromGameID) {
    ...
    public ScoreBasic withRescheduledGameID(Long rescheduledGameID) {
