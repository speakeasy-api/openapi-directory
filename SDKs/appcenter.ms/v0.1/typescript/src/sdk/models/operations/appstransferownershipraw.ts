...
export class AppsTransferOwnershipRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AppsTransferOwnershipRawRequest extends SpeakeasyBase {
  /**
...
export enum AppsTransferOwnershipRawDefaultApplicationJSONErrorCodeEnum {
...
export class AppsTransferOwnershipRawDefaultApplicationJSONError extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
 ...
 * Error
 */
export class AppsTransferOwnershipRawDefaultApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => AppsTransferOwnershipRawDefaultApplicationJSONError)
  error: AppsTransferOwnershipRawDefaultApplicationJSONError;
}

export class AppsTransferOwnershipRaw200ApplicationJSONAzureSubscription extends SpeakeasyBase {
  /**
...
export enum AppsTransferOwnershipRaw200ApplicationJSONMemberPermissionsEnum {
  Manager = "manager",
  Developer = "developer",
  Viewer = "viewer",
  Tester = "tester",
 ...
 */
export enum AppsTransferOwnershipRaw200ApplicationJSONOriginEnum {
  Appcenter = "appcenter",
  Hockeyapp = "hockeyapp",
  Codepush = "codepush",
}
 ...
 */
export enum AppsTransferOwnershipRaw200ApplicationJSONOsEnum {
  Android = "Android",
  IOS = "iOS",
  MacOS = "macOS",
  Tizen = "Tizen",
 ...
 */
export enum AppsTransferOwnershipRaw200ApplicationJSONOwnerTypeEnum {
  Org = "org",
  User = "user",
}
 ...
 */
export class AppsTransferOwnershipRaw200ApplicationJSONOwner extends SpeakeasyBase {
  /**
 ...
 */
export enum AppsTransferOwnershipRaw200ApplicationJSONPlatformEnum {
  Java = "Java",
 ...
 * Success
 */
export class AppsTransferOwnershipRaw200ApplicationJSON extends SpeakeasyBase {
  /**
  ...
  @Type(() => AppsTransferOwnershipRaw200ApplicationJSONAzureSubscription)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "owner" })
  @Type(() => AppsTransferOwnershipRaw200ApplicationJSONOwner)
...
export class AppsTransferOwnershipRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
