...
export class DatalabelingProjectsEvaluationJobsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatalabelingProjectsEvaluationJobsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatalabelingProjectsEvaluationJobsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
