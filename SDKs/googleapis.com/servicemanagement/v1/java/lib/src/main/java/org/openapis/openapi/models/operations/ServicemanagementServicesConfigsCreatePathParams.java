...
public class ServicemanagementServicesConfigsCreatePathParams {
    /**
    ...
    public ServicemanagementServicesConfigsCreatePathParams withServiceName(String serviceName) {
