...
exports.GetQuestionsResponse = exports.GetQuestionsRequest = void 0;
...
var GetQuestionsRequest = /** @class */ (function (_super) {
    ...
    ], GetQuestionsRequest.prototype, "xAppToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=app_token",
        }),
        __metadata("design:type", String)
    ], GetQuestionsRequest.prototype, "appToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetQuestionsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], GetQuestionsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=query" }),
        __metadata("design:type", String)
    ], GetQuestionsRequest.prototype, "query", void 0);
