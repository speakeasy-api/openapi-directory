 ...
 */
public enum InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCategoryEnum {
    ...
    private InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCategoryEnum(String value) {
        this.value = value;
    }
}
