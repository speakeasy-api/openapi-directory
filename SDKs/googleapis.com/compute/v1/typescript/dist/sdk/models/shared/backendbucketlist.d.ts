 ...
 */
export declare enum BackendBucketListWarningCodeEnum {
...
export declare class BackendBucketListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class BackendBucketListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: BackendBucketListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: BackendBucketListWarningData[];
    /**
 ...
 */
export declare class BackendBucketList extends SpeakeasyBase {
    /**
