...
export class AndroidpublisherEditsApklistingsDeleteallSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AndroidpublisherEditsApklistingsDeleteallRequest extends SpeakeasyBase {
  /**
...
export class AndroidpublisherEditsApklistingsDeleteallResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
