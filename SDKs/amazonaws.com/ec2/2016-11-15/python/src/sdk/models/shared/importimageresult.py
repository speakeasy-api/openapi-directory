...
class ImportImageResultLicenseSpecifications:
...
@dataclasses.dataclass
class ImportImageResultSnapshotDetails:
    ...
    user_bucket: Optional[ImportImageResultSnapshotDetailsUserBucket] = dataclasses.field(default=None)  
...
class ImportImageResult:
    ...
    license_specifications: Optional[list[ImportImageResultLicenseSpecifications]] = dataclasses.field(default=None)  
    license_type: Optional[str] = dataclasses.field(default=None)  
    platform: Optional[str] = dataclasses.field(default=None)  
    progress: Optional[str] = dataclasses.field(default=None)  
    snapshot_details: Optional[list[ImportImageResultSnapshotDetails]] = dataclasses.field(default=None)  
    status: Optional[str] = dataclasses.field(default=None)  
    status_message: Optional[str] = dataclasses.field(default=None)  
    tags: Optional[list[ImportImageResultTags]] = dataclasses.field(default=None)  
