...
public class Pulls {
    ...
    **/
    public openapisdk.models.operations.PullsCreateReviewCommentAlternativeResponse pullsCreateReviewCommentAlternative(openapisdk.models.operations.PullsCreateReviewCommentAlternativeRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        openapisdk.models.operations.PullsCreateReviewCommentAlternativeResponse res = new openapisdk.models.operations.PullsCreateReviewCommentAlternativeResponse() {{
            legacyReviewComment = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 201) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.LegacyReviewComment out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.LegacyReviewComment.class);
                res.legacyReviewComment = out;
            }
        }
