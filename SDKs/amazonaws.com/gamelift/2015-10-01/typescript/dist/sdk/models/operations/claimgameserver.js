...
exports.ClaimGameServerResponse = exports.ClaimGameServerRequest = exports.ClaimGameServerXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var ClaimGameServerXAmzTargetEnum;
(function (ClaimGameServerXAmzTargetEnum) {
    ClaimGameServerXAmzTargetEnum["GameLiftClaimGameServer"] = "GameLift.ClaimGameServer";
})(ClaimGameServerXAmzTargetEnum = exports.ClaimGameServerXAmzTargetEnum || (exports.ClaimGameServerXAmzTargetEnum = {}));
var ClaimGameServerRequest = /** @class */ (function (_super) {
    ...
    ], ClaimGameServerRequest.prototype, "claimGameServerInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], ClaimGameServerRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], ClaimGameServerRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], ClaimGameServerRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], ClaimGameServerRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], ClaimGameServerRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], ClaimGameServerRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], ClaimGameServerRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], ClaimGameServerRequest.prototype, "xAmzTarget", void 0);
    return ClaimGameServerRequest;
}(utils_1.SpeakeasyBase));
exports.ClaimGameServerRequest = ClaimGameServerRequest;
var ClaimGameServerResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ClaimGameServerResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.ClaimGameServerResponse = ClaimGameServerResponse;
