...
class GetV2StepsJSONRequest:
    ...
    r"""Filter by cadence ID"""  
    has_due_actions: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'has_due_actions', 'style': 'form', 'explode': True }})
    r"""Filter by whether a step has due actions"""  
    ids: Optional[list[int]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'ids', 'style': 'form', 'explode': False }})
    r"""IDs of steps to fetch."""  
