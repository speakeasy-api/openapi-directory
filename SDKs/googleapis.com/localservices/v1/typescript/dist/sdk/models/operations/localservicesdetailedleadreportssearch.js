...
exports.LocalservicesDetailedLeadReportsSearchResponse = exports.LocalservicesDetailedLeadReportsSearchRequest = exports.LocalservicesDetailedLeadReportsSearchSecurity = exports.LocalservicesDetailedLeadReportsSearchQueryParams = void 0;
...
var LocalservicesDetailedLeadReportsSearchQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=endDate.day" }),
        __metadata("design:type", Number)
    ], LocalservicesDetailedLeadReportsSearchQueryParams.prototype, "endDateDay", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=endDate.month" }),
        __metadata("design:type", Number)
    ], LocalservicesDetailedLeadReportsSearchQueryParams.prototype, "endDateMonth", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=endDate.year" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=startDate.day" }),
        __metadata("design:type", Number)
    ], LocalservicesDetailedLeadReportsSearchQueryParams.prototype, "startDateDay", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=startDate.month" }),
        __metadata("design:type", Number)
    ], LocalservicesDetailedLeadReportsSearchQueryParams.prototype, "startDateMonth", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=startDate.year" }),
        __metadata("design:type", Number)
...
exports.LocalservicesDetailedLeadReportsSearchQueryParams = LocalservicesDetailedLeadReportsSearchQueryParams;
...
exports.LocalservicesDetailedLeadReportsSearchSecurity = LocalservicesDetailedLeadReportsSearchSecurity;
...
exports.LocalservicesDetailedLeadReportsSearchRequest = LocalservicesDetailedLeadReportsSearchRequest;
...
exports.LocalservicesDetailedLeadReportsSearchResponse = LocalservicesDetailedLeadReportsSearchResponse;
