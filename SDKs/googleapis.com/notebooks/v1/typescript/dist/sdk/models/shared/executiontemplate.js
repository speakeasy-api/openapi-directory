...
var ExecutionTemplate = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return scheduleracceleratorconfig_1.SchedulerAcceleratorConfig; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "containerImageUri" }),
        __metadata("design:type", String)
    ], ExecutionTemplate.prototype, "containerImageUri", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "dataprocParameters" }),
        (0, class_transformer_1.Type)(function () { return dataprocparameters_1.DataprocParameters; }),
        __metadata("design:type", dataprocparameters_1.DataprocParameters)
    ], ExecutionTemplate.prototype, "dataprocParameters", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "inputNotebookFile" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kernelSpec" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "outputNotebookFolder" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "paramsYamlFile" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "tensorboard" }),
        __metadata("design:type", String)
    ], ExecutionTemplate.prototype, "tensorboard", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "vertexAiParameters" }),
        (0, class_transformer_1.Type)(function () { return vertexaiparameters_1.VertexAIParameters; }),
