...
class DatafusionProjectsLocationsInstancesNamespacesListRequest:
    path_params: DatafusionProjectsLocationsInstancesNamespacesListPathParams = dataclasses.field()
    query_params: DatafusionProjectsLocationsInstancesNamespacesListQueryParams = dataclasses.field()
    security: DatafusionProjectsLocationsInstancesNamespacesListSecurity = dataclasses.field()
