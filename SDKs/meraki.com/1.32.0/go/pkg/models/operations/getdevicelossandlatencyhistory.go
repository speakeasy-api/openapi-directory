...
func (e GetDeviceLossAndLatencyHistoryUplinkEnum) ToPointer() *GetDeviceLossAndLatencyHistoryUplinkEnum {
	return &e
}
...
func (e *GetDeviceLossAndLatencyHistoryUplinkEnum) UnmarshalJSON(data []byte) error {
	...
	case "wan1":
		fallthrough
	case "wan2":
		*e = GetDeviceLossAndLatencyHistoryUplinkEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDeviceLossAndLatencyHistoryUplinkEnum: %v", v)
	}
}
