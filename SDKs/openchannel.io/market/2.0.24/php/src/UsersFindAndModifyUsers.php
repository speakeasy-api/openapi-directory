...
class UsersFindAndModifyUsers 
{
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/users/{userId}', \OpenAPI\OpenAPI\Models\Operations\GetUsersUserIdRequest::class, $request);
     ...
     * Updates user fields
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\PatchUsersUserIdRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\PatchUsersUserIdResponse
     */
	public function patchUsersUserId(
        \OpenAPI\OpenAPI\Models\Operations\PatchUsersUserIdRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\PatchUsersUserIdResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/users/{userId}', \OpenAPI\OpenAPI\Models\Operations\PatchUsersUserIdRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\PatchUsersUserIdRequest::class, $request, null));
        
        $httpResponse = $this->_securityClient->request('PATCH', $url, $options);
        
        $contentType = $httpResponse->getHeader('Content-Type')[0] ?? '';

        $response = new \OpenAPI\OpenAPI\Models\Operations\PatchUsersUserIdResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\PostUsersUserIdRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\PostUsersUserIdResponse
     */
	public function postUsersUserId(
        \OpenAPI\OpenAPI\Models\Operations\PostUsersUserIdRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\PostUsersUserIdResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/users/{userId}', \OpenAPI\OpenAPI\Models\Operations\PostUsersUserIdRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\PostUsersUserIdRequest::class, $request, null));
        
        $httpResponse = $this->_securityClient->request('POST', $url, $options);
        
        $contentType = $httpResponse->getHeader('Content-Type')[0] ?? '';

        $response = new \OpenAPI\OpenAPI\Models\Operations\PostUsersUserIdResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
