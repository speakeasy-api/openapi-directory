...
from ..shared import updatedepartmentresponse as shared_updatedepartmentresponse
...
class DepartmentsUpdateRequest:
    headers: DepartmentsUpdateHeaders = dataclasses.field()
    path_params: DepartmentsUpdatePathParams = dataclasses.field()
    query_params: DepartmentsUpdateQueryParams = dataclasses.field()
    request: shared_department.DepartmentInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: DepartmentsUpdateSecurity = dataclasses.field()
...
class DepartmentsUpdateResponse:
    ...
    update_department_response: Optional[shared_updatedepartmentresponse.UpdateDepartmentResponse] = dataclasses.field(default=None)
