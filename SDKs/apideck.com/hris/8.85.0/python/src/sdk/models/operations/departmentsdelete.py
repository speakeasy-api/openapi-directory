...
from ..shared import deletedepartmentresponse as shared_deletedepartmentresponse
...
class DepartmentsDeleteRequest:
    headers: DepartmentsDeleteHeaders = dataclasses.field()
    path_params: DepartmentsDeletePathParams = dataclasses.field()
    query_params: DepartmentsDeleteQueryParams = dataclasses.field()
    security: DepartmentsDeleteSecurity = dataclasses.field()
...
class DepartmentsDeleteResponse:
    ...
    delete_department_response: Optional[shared_deletedepartmentresponse.DeleteDepartmentResponse] = dataclasses.field(default=None)
