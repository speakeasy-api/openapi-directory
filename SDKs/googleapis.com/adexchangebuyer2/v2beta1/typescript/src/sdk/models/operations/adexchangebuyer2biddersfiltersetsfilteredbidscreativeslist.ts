...
export class Adexchangebuyer2BiddersFilterSetsFilteredBidsCreativesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class Adexchangebuyer2BiddersFilterSetsFilteredBidsCreativesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "pathParam, style=simple;explode=false;name=creativeStatusId",
  })
...
export class Adexchangebuyer2BiddersFilterSetsFilteredBidsCreativesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
