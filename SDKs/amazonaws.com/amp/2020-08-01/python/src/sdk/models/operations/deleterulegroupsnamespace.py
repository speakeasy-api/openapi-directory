...
class DeleteRuleGroupsNamespaceRequest:
    ...
    r"""The ID of the workspace to delete rule group definition."""  
    ...
    r"""Optional, unique, case-sensitive, user-provided identifier to ensure the idempotency of the request."""  
