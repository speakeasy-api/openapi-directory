...
var Configs = /** @class */ (function () {
    ...
    **/
    Configs.prototype.createSubscriptionNotificationEvent = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateSubscriptionNotificationEventRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/configs/notifications/events/{eventName}", req.pathParams);
    ...
    **/
    Configs.prototype.deleteSubscribedNotificationEvent = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Configs.prototype.getPublicEncryptionKey = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/configs/publicKey";
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json;charset=UTF-8")) {
                        res.configsPublicKeyResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    break;
    ...
    **/
    Configs.prototype.getSubscribedNotificationEvents = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetSubscribedNotificationEventsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/configs/notifications/events";
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json;charset=UTF-8")) {
                        res.configsNotificationResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    break;
    ...
    **/
    Configs.prototype.updateSubscribedNotificationEvent = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
