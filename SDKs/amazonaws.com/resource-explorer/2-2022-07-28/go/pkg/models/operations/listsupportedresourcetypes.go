...
type ListSupportedResourceTypesQueryParams struct {
	// Pagination limit
...
type ListSupportedResourceTypesHeaders struct {
...
type ListSupportedResourceTypesRequestBody struct {
...
type ListSupportedResourceTypesRequest struct {
	QueryParams ListSupportedResourceTypesQueryParams
	Headers     ListSupportedResourceTypesHeaders
	Request     ListSupportedResourceTypesRequestBody `request:"mediaType=application/json"`
}
