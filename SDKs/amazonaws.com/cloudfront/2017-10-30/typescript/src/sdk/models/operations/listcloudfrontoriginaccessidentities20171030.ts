...
export class ListCloudFrontOriginAccessIdentities20171030Request extends SpeakeasyBase {
  /**
...
export class ListCloudFrontOriginAccessIdentities20171030Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
