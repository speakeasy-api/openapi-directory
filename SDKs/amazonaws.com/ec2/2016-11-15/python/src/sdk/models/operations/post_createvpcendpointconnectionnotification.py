...
class PostCreateVpcEndpointConnectionNotificationQueryParams:
    action: PostCreateVpcEndpointConnectionNotificationActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCreateVpcEndpointConnectionNotificationVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCreateVpcEndpointConnectionNotificationRequest:
    headers: PostCreateVpcEndpointConnectionNotificationHeaders = dataclasses.field()
    query_params: PostCreateVpcEndpointConnectionNotificationQueryParams = dataclasses.field()
