...
var ListTaskQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=EvaluateTaskAttributes" }),
        __metadata("design:type", String)
    ], ListTaskQueryParams.prototype, "evaluateTaskAttributes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=HasAddons" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=WorkflowName" }),
        __metadata("design:type", String)
...
var ListTaskListTaskResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=tasks", elemType: shared.TaskrouterV1WorkspaceTask }),
        __metadata("design:type", Array)
