...
from ..shared import updatefunctionurlconfigresponse as shared_updatefunctionurlconfigresponse
from dataclasses_json import Undefined, dataclass_json
from enum import Enum
from sdk import utils
from typing import Any, Optional

class UpdateFunctionURLConfigRequestBodyAuthTypeEnum(str, Enum):
...
class UpdateFunctionURLConfigRequestBody:
    ...
    auth_type: Optional[UpdateFunctionURLConfigRequestBodyAuthTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AuthType'), 'exclude': lambda f: f is None }})
    r"""The type of authentication that your function URL uses. Set to <code>AWS_IAM</code> if you want to restrict access to authenticated users only. Set to <code>NONE</code> if you want to bypass IAM authentication to create a public endpoint. For more information, see <a href=\\"https://docs.aws.amazon.com/lambda/latest/dg/urls-auth.html\\">Security and auth model for Lambda function URLs</a>."""  
    cors: Optional[UpdateFunctionURLConfigRequestBodyCors] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Cors'), 'exclude': lambda f: f is None }})
    r"""The <a href=\\"https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS\\">cross-origin resource sharing (CORS)</a> settings for your Lambda function URL. Use CORS to grant access to your function URL from any origin. You can also use CORS to control access for specific HTTP headers and methods in requests to your function URL."""  
...
class UpdateFunctionURLConfigRequest:
    ...
    request_body: UpdateFunctionURLConfigRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdateFunctionURLConfigResponse:
    ...
    update_function_url_config_response: Optional[shared_updatefunctionurlconfigresponse.UpdateFunctionURLConfigResponse] = dataclasses.field(default=None)
    r"""Success"""  
