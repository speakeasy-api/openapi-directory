...
from ..shared import importimagelicensespecificationlistrequest as shared_importimagelicensespecificationlistrequest
...
class ImportImageRequestDiskContainers:
    r"""Describes the disk container object for an import image task."""
...
class ImportImageRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class ImportImageRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class ImportImageRequestTagSpecifications:
    ...
    resource_type: Optional[ImportImageRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[ImportImageRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class ImportImageRequest:
    ...
    client_data: Optional[shared_clientdata.ClientData] = dataclasses.field(default=None)  
    client_token: Optional[str] = dataclasses.field(default=None)  
    description: Optional[str] = dataclasses.field(default=None)  
    disk_containers: Optional[list[ImportImageRequestDiskContainers]] = dataclasses.field(default=None)  
    ...
    license_specifications: Optional[list[shared_importimagelicensespecificationlistrequest.ImportImageLicenseSpecificationListRequest]] = dataclasses.field(default=None)  
    ...
    tag_specifications: Optional[list[ImportImageRequestTagSpecifications]] = dataclasses.field(default=None)  
