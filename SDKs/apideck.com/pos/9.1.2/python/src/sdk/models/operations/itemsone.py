...
from ..shared import getitemresponse as shared_getitemresponse
...
class ItemsOneSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class ItemsOneRequest:
...
class ItemsOneResponse:
    ...
    r"""Bad Request"""  
    get_item_response: Optional[shared_getitemresponse.GetItemResponse] = dataclasses.field(default=None)
    r"""Items"""  
