...
public class GetPublicationGenotypeAssociationsRequest {
    ...
    public GetPublicationGenotypeAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPublicationGenotypeAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPublicationGenotypeAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPublicationGenotypeAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPublicationGenotypeAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPublicationGenotypeAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPublicationGenotypeAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPublicationGenotypeAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPublicationGenotypeAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPublicationGenotypeAssociationsRequest withRelation(String relation) {
    ...
    public GetPublicationGenotypeAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPublicationGenotypeAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPublicationGenotypeAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPublicationGenotypeAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPublicationGenotypeAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPublicationGenotypeAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPublicationGenotypeAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPublicationGenotypeAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
