...
type DescribeVpcConnectorHeaders struct {
...
type DescribeVpcConnectorRequest struct {
	Headers DescribeVpcConnectorHeaders
	Request shared.DescribeVpcConnectorRequest `request:"mediaType=application/json"`
}
