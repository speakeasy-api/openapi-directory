...
class RemoveAttributesRequestBodyUpdateAttributesRequest:
    ...
    blacklist: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Blacklist') }})
    

@dataclass_json
@dataclasses.dataclass
class RemoveAttributesRequestBody:
    update_attributes_request: RemoveAttributesRequestBodyUpdateAttributesRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('UpdateAttributesRequest') }})
    

@dataclasses.dataclass
class RemoveAttributesRequest:
    headers: RemoveAttributesHeaders = dataclasses.field()
    path_params: RemoveAttributesPathParams = dataclasses.field()
    request: RemoveAttributesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
