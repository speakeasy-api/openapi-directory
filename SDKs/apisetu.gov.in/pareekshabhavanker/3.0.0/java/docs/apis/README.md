...
import org.openapis.openapi.models.operations.SslcrRequestBody;
import org.openapis.openapi.models.operations.SslcrRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.SslcrRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.SslcrResponse;
import org.openapis.openapi.models.operations.SslcrSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SslcrRequestBody req = new SslcrRequestBody(SslcrRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SslcrRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "123412341234", "123456", "2018,2019,2020");;
            ...
            SslcrResponse res = sdk.apIs.sslcr(req, new SslcrSecurity("maiores", "molestiae") {{
