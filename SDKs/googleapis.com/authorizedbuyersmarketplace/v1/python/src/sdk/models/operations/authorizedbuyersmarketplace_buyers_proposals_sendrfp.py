...
class AuthorizedbuyersmarketplaceBuyersProposalsSendRfpRequest:
    ...
    r"""Required. The current buyer who is sending the RFP in the format: `buyers/{accountId}`."""  
    ...
    send_rfp_request: Optional[shared_sendrfprequest.SendRfpRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
