...
class PlacementGroupActiveStatusEnum(str, Enum):
    r"""Whether this placement group is active, inactive, archived or permanently archived."""
...
class PlacementGroup:
    ...
    active_status: Optional[PlacementGroupActiveStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('activeStatus'), 'exclude': lambda f: f is None }})
    r"""Whether this placement group is active, inactive, archived or permanently archived."""  
