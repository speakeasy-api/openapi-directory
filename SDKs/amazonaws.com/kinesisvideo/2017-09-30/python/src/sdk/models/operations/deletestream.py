...
class DeleteStreamRequest:
    headers: DeleteStreamHeaders = dataclasses.field()
    request: DeleteStreamRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
