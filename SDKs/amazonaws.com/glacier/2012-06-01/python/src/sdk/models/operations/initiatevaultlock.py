...
class InitiateVaultLockRequestBodyPolicy:
    r"""Contains the vault lock policy."""
...
class InitiateVaultLockRequestBody:
    ...
    policy: Optional[InitiateVaultLockRequestBodyPolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('policy'), 'exclude': lambda f: f is None }})
    r"""Contains the vault lock policy."""  
...
class InitiateVaultLockRequest:
    ...
    request_body: InitiateVaultLockRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
