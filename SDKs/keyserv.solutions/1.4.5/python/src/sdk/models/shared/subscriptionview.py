...
class SubscriptionView:
    ...
    keys: Optional[list[shared_keyview.KeyView]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('keys'), 'exclude': lambda f: f is None }})  
