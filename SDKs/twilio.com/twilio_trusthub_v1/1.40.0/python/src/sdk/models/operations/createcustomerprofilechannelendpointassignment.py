...
class CreateCustomerProfileChannelEndpointAssignmentRequest:
    ...
    request_body: Optional[CreateCustomerProfileChannelEndpointAssignmentCreateCustomerProfileChannelEndpointAssignmentRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
