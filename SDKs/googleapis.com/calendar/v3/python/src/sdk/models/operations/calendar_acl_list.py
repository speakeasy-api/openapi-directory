...
class CalendarACLListRequest:
    ...
    r"""Whether to include deleted ACLs in the result. Deleted ACLs are represented by role equal to \\"none\\". Deleted ACLs will always be included if syncToken is provided. Optional. The default is False."""  
