 ...
 */
public enum GetNetworkSensorAlertsProfiles200ApplicationJSONConditionsDurationEnum {
    ZERO("0"),
    SIXTY("60"),
    ...
    private GetNetworkSensorAlertsProfiles200ApplicationJSONConditionsDurationEnum(String value) {
        this.value = value;
    }
}
