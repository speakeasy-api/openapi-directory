...
func (e *CloneOrganization201ApplicationJSONLicensingModelEnum) UnmarshalJSON(data []byte) error {
	...
	case "per-device":
		fallthrough
	case "subscription":
		*e = CloneOrganization201ApplicationJSONLicensingModelEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CloneOrganization201ApplicationJSONLicensingModelEnum: %s", s)
	}
}
