...
export class CloudsupportProjectsCasesAttachmentsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudsupportProjectsCasesAttachmentsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudsupportProjectsCasesAttachmentsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
