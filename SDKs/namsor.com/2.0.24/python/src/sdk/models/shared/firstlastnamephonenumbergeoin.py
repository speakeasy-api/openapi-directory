...
class FirstLastNamePhoneNumberGeoIn:
    ...
    country_iso2_alt: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('countryIso2Alt'), 'exclude': lambda f: f is None }})  
