...
type ChatSpacesMessagesPatchSecurityOption1 struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ChatSpacesMessagesPatchSecurityOption2 struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ChatSpacesMessagesPatchSecurity struct {
	Option1 *ChatSpacesMessagesPatchSecurityOption1 `security:"option"`
	Option2 *ChatSpacesMessagesPatchSecurityOption2 `security:"option"`
}
