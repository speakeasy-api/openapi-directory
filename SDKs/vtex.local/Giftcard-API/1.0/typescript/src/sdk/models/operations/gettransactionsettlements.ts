...
export class GetTransactionSettlementsRequest extends SpeakeasyBase {
  /**
...
export class GetTransactionSettlementsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
  ...
  @SpeakeasyMetadata({ elemType: shared.Response6 })
