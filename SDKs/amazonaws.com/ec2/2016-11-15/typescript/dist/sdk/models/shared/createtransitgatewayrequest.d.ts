 ...
 */
export declare enum CreateTransitGatewayRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateTransitGatewayRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateTransitGatewayRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateTransitGatewayRequest extends SpeakeasyBase {
    description?: string;
    dryRun?: boolean;
