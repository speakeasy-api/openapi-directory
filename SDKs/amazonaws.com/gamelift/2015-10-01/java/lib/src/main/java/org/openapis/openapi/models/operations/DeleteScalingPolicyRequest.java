...
public class DeleteScalingPolicyRequest {
    ...
    public org.openapis.openapi.models.shared.DeleteScalingPolicyInput deleteScalingPolicyInput;

    public DeleteScalingPolicyRequest withDeleteScalingPolicyInput(org.openapis.openapi.models.shared.DeleteScalingPolicyInput deleteScalingPolicyInput) {
        this.deleteScalingPolicyInput = deleteScalingPolicyInput;
        return this;
    }
    ...
    public DeleteScalingPolicyRequest(@JsonProperty("DeleteScalingPolicyInput") org.openapis.openapi.models.shared.DeleteScalingPolicyInput deleteScalingPolicyInput, @JsonProperty("X-Amz-Target") DeleteScalingPolicyXAmzTargetEnum xAmzTarget) {
        this.deleteScalingPolicyInput = deleteScalingPolicyInput;
        this.xAmzTarget = xAmzTarget;
  }
}
