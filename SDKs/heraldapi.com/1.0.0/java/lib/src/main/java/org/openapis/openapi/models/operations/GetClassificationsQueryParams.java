...
public class GetClassificationsQueryParams {
    ...
    public Double limit;
    public GetClassificationsQueryParams withLimit(Double limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetClassificationsQueryParams withNaics2017(String naics2017) {
    ...
    public Double page;
    public GetClassificationsQueryParams withPage(Double page) {
        this.page = page;
        return this;
    }
    ...
    public GetClassificationsQueryParams withSearch(String search) {
        this.search = search;
        return this;
    }
