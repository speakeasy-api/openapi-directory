...
class ListMessageListMessageResponse:
    messages: Optional[list[shared_chat_v2_service_channel_message.ChatV2ServiceChannelMessage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('messages') }})
