...
public class ServicenetworkingServicesDisableVpcServiceControlsPathParams {
    /**
    ...
    public ServicenetworkingServicesDisableVpcServiceControlsPathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
