...
class DcimInterfacesListQueryParams:
    ...
    lag_id_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'lag_id__n', 'style': 'form', 'explode': True }})
    ...
    mode_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'mode__n', 'style': 'form', 'explode': True }})
...
class DcimInterfacesList200ApplicationJSON:
    ...
    results: list[shared_deviceinterface.DeviceInterface] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
