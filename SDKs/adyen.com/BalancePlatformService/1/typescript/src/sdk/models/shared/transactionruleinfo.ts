...
export enum TransactionRuleInfoEntryModesEnum {
  Barcode = "barcode",
  Chip = "chip",
  Cof = "cof",
...
export enum TransactionRuleInfoProcessingTypesEnum {
 ...
 */
export enum TransactionRuleInfoStatusEnum {
  Active = "active",
  Inactive = "inactive",
}
 ...
 *
 */
export enum TransactionRuleInfoTypeEnum {
  AllowList = "allowList",
  BlockList = "blockList",
  MaxUsage = "maxUsage",
  Velocity = "velocity",
...
export class TransactionRuleInfo extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "amount" })
  @Type(() => Amount)
  amount?: Amount;
  ...
  entryModes?: TransactionRuleInfoEntryModesEnum[];
  ...
  processingTypes?: TransactionRuleInfoProcessingTypesEnum[];
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "status" })
  status?: TransactionRuleInfoStatusEnum;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "type" })
  type: TransactionRuleInfoTypeEnum;
}
