...
from ..shared import creativevideosearchitem as shared_creativevideosearchitem
...
class CreativeVideoSearchResults:
    ...
    videos: Optional[list[shared_creativevideosearchitem.CreativeVideoSearchItem]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('videos') }})
