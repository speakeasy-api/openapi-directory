...
class PostNetworks201ApplicationJSONNetwork
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\PostNetworks201ApplicationJSONNetworkProtection $protection
     */
	#[\JMS\Serializer\Annotation\SerializedName('protection')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\PostNetworks201ApplicationJSONNetworkProtection')]
    public PostNetworks201ApplicationJSONNetworkProtection $protection;
    
    /**
     * Array of routes set in this Network
     * 
     * @var array<\OpenAPI\OpenAPI\Models\Operations\PostNetworks201ApplicationJSONNetworkRoutes> $routes
     */
	#[\JMS\Serializer\Annotation\SerializedName('routes')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Operations\PostNetworks201ApplicationJSONNetworkRoutes>')]
    public array $routes;
     ...
     * 
     * @var array<\OpenAPI\OpenAPI\Models\Operations\PostNetworks201ApplicationJSONNetworkSubnets> $subnets
     */
	#[\JMS\Serializer\Annotation\SerializedName('subnets')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Operations\PostNetworks201ApplicationJSONNetworkSubnets>')]
	...
	public function __construct()
	{
		...
		$this->name = "";
		$this->protection = new \OpenAPI\OpenAPI\Models\Operations\PostNetworks201ApplicationJSONNetworkProtection();
		$this->routes = [];
		$this->servers = [];
		$this->subnets = [];
	}
