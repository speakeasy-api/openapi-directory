...
class StartingLineups:
    ...
    away_lineup: Optional[list[shared_lineup.Lineup]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AwayLineup'), 'exclude': lambda f: f is None }})  
    ...
    home_lineup: Optional[list[shared_lineup.Lineup]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('HomeLineup'), 'exclude': lambda f: f is None }})  
