 ...
 */
export enum RegionInstanceGroupManagersListInstanceConfigsRespWarningCodeEnum {
...
export class RegionInstanceGroupManagersListInstanceConfigsRespWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class RegionInstanceGroupManagersListInstanceConfigsRespWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
 ...
 * Successful response
 */
export class RegionInstanceGroupManagersListInstanceConfigsResp extends SpeakeasyBase {
  /**
