...
class PostTruckDistanceBetweenPairsOutputFormatRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostTruckDistanceBetweenPairsOutputFormatCriteriaEnum $criteria
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=criteria')]
    public ?PostTruckDistanceBetweenPairsOutputFormatCriteriaEnum $criteria = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostTruckDistanceBetweenPairsOutputFormatDistanceUnitEnum $distanceUnit
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=distanceUnit')]
    public ?PostTruckDistanceBetweenPairsOutputFormatDistanceUnitEnum $distanceUnit = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\PostTruckDistanceBetweenPairsOutputFormatOutputFormatEnum $outputFormat
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostTruckDistanceBetweenPairsOutputFormatOutputSrsEnum $outputSRS
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=outputSRS')]
    public ?PostTruckDistanceBetweenPairsOutputFormatOutputSrsEnum $outputSRS = null;
	...
	public function __construct()
	{
		...
		$this->fromPoints = "";
		$this->maxPairs = null;
		$this->outputFormat = \OpenAPI\OpenAPI\Models\Operations\PostTruckDistanceBetweenPairsOutputFormatOutputFormatEnum::JSON;
		$this->outputSRS = null;
