...
public class FetchWorkflowCumulativeStatisticsSecurity {
    ...
    public FetchWorkflowCumulativeStatisticsSecurity withPassword(String password) {
    ...
    public FetchWorkflowCumulativeStatisticsSecurity withUsername(String username) {
