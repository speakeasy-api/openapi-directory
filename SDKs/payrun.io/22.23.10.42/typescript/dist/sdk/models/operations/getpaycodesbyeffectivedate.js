...
exports.GetPayCodesByEffectiveDateResponse = exports.GetPayCodesByEffectiveDateRequest = void 0;
...
var GetPayCodesByEffectiveDateRequest = /** @class */ (function (_super) {
    ...
    ], GetPayCodesByEffectiveDateRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetPayCodesByEffectiveDateRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EffectiveDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetPayCodesByEffectiveDateRequest.prototype, "effectiveDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetPayCodesByEffectiveDateRequest.prototype, "employerId", void 0);
    return GetPayCodesByEffectiveDateRequest;
}(utils_1.SpeakeasyBase));
exports.GetPayCodesByEffectiveDateRequest = GetPayCodesByEffectiveDateRequest;
var GetPayCodesByEffectiveDateResponse = /** @class */ (function (_super) {
    ...
    ], GetPayCodesByEffectiveDateResponse.prototype, "rawResponse", void 0);
    return GetPayCodesByEffectiveDateResponse;
}(utils_1.SpeakeasyBase));
exports.GetPayCodesByEffectiveDateResponse = GetPayCodesByEffectiveDateResponse;
