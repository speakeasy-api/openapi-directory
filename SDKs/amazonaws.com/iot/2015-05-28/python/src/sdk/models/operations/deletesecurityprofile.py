...
class DeleteSecurityProfileRequest:
    headers: DeleteSecurityProfileHeaders = dataclasses.field()
    path_params: DeleteSecurityProfilePathParams = dataclasses.field()
    query_params: DeleteSecurityProfileQueryParams = dataclasses.field()
