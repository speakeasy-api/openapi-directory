...
export class DeleteConsentPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=consentId" })
  consentId: string;
}


export class DeleteConsentHeaders extends SpeakeasyBase {
...
export class DeleteConsentSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=http;subtype=bearer" })
  bearerAuthOAuth?: shared.SchemeBearerAuthOAuth;
}


export class DeleteConsentRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class DeleteConsentResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
