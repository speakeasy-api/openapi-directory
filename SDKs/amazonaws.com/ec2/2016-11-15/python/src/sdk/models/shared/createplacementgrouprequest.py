...
import dataclasses
from ..shared import spreadlevel_enum as shared_spreadlevel_enum
from enum import Enum
from typing import Optional

class CreatePlacementGroupRequestStrategyEnum(str, Enum):
    r"""The placement strategy."""
    CLUSTER = 'cluster'
    SPREAD = 'spread'
    PARTITION = 'partition'

class CreatePlacementGroupRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreatePlacementGroupRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
class CreatePlacementGroupRequestTagSpecifications:
    ...
    resource_type: Optional[CreatePlacementGroupRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreatePlacementGroupRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreatePlacementGroupRequest:
    ...
    spread_level: Optional[shared_spreadlevel_enum.SpreadLevelEnum] = dataclasses.field(default=None)  
    strategy: Optional[CreatePlacementGroupRequestStrategyEnum] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreatePlacementGroupRequestTagSpecifications]] = dataclasses.field(default=None)  
