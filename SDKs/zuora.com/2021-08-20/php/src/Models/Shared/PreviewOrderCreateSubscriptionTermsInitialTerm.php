...
class PreviewOrderCreateSubscriptionTermsInitialTerm
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionTermsInitialTermPeriodTypeEnum $periodType
     */
	#[\JMS\Serializer\Annotation\SerializedName('periodType')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionTermsInitialTermPeriodTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?PreviewOrderCreateSubscriptionTermsInitialTermPeriodTypeEnum $periodType = null;
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionTermsInitialTermTermTypeEnum $termType
     */
	#[\JMS\Serializer\Annotation\SerializedName('termType')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionTermsInitialTermTermTypeEnum>')]
	...
	public function __construct()
	{
		...
		$this->startDate = null;
		$this->termType = \OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionTermsInitialTermTermTypeEnum::TERMED;
	}
}
