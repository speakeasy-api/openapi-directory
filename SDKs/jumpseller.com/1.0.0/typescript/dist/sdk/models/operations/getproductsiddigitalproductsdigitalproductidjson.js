...
exports.GetProductsIdDigitalProductsDigitalProductIdJsonResponse = exports.GetProductsIdDigitalProductsDigitalProductIdJsonRequest = void 0;
...
var GetProductsIdDigitalProductsDigitalProductIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetProductsIdDigitalProductsDigitalProductIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=digital_product_id",
        }),
        __metadata("design:type", Number)
    ], GetProductsIdDigitalProductsDigitalProductIdJsonRequest.prototype, "digitalProductId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetProductsIdDigitalProductsDigitalProductIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetProductsIdDigitalProductsDigitalProductIdJsonRequest.prototype, "login", void 0);
    return GetProductsIdDigitalProductsDigitalProductIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetProductsIdDigitalProductsDigitalProductIdJsonRequest = GetProductsIdDigitalProductsDigitalProductIdJsonRequest;
var GetProductsIdDigitalProductsDigitalProductIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], GetProductsIdDigitalProductsDigitalProductIdJsonResponse.prototype, "rawResponse", void 0);
    return GetProductsIdDigitalProductsDigitalProductIdJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetProductsIdDigitalProductsDigitalProductIdJsonResponse = GetProductsIdDigitalProductsDigitalProductIdJsonResponse;
