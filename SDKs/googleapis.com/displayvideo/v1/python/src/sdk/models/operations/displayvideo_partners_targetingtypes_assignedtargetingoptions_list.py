...
from ..shared import security as shared_security
from ..shared import listpartnerassignedtargetingoptionsresponse as shared_listpartnerassignedtargetingoptionsresponse

class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum(str, Enum):
...
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListPathParams:
    partner_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'partnerId', 'style': 'simple', 'explode': False }})
    targeting_type: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListQueryParams:
...
@dataclasses.dataclass
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListRequest:
    path_params: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListPathParams = dataclasses.field()
    query_params: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListQueryParams = dataclasses.field()
    security: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListSecurity = dataclasses.field()
    

@dataclasses.dataclass
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    list_partner_assigned_targeting_options_response: Optional[shared_listpartnerassignedtargetingoptionsresponse.ListPartnerAssignedTargetingOptionsResponse] = dataclasses.field(default=None)
