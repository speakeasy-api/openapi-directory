...
exports.GetLinksTopDomainsResponse = exports.GetLinksTopDomains200ApplicationJSON = exports.GetLinksTopDomainsRequest = void 0;
...
var GetLinksTopDomainsRequest = /** @class */ (function (_super) {
    ...
    ], GetLinksTopDomainsRequest.prototype, "analysisSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetLinksTopDomainsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=project_slug",
        }),
        __metadata("design:type", String)
    ], GetLinksTopDomainsRequest.prototype, "projectSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=size" }),
        __metadata("design:type", Number)
    ], GetLinksTopDomainsRequest.prototype, "size", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=username",
        }),
        __metadata("design:type", String)
    ], GetLinksTopDomainsRequest.prototype, "username", void 0);
...
var GetLinksTopDomains200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.LinksTopDomains }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return shared.LinksTopDomains; }),
...
var GetLinksTopDomainsResponse = /** @class */ (function (_super) {
    ...
    ], GetLinksTopDomainsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
