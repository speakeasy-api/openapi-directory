...
class TagResourceRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the notification rule to tag."""  
    tags: dict[str, str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Tags') }})
    r"""The list of tags to associate with the resource. Tag key names cannot start with \\"<code>aws</code>\\"."""  
