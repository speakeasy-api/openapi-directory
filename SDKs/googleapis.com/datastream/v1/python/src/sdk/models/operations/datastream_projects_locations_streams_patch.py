...
class DatastreamProjectsLocationsStreamsPatchRequest:
    path_params: DatastreamProjectsLocationsStreamsPatchPathParams = dataclasses.field()
    query_params: DatastreamProjectsLocationsStreamsPatchQueryParams = dataclasses.field()
    security: DatastreamProjectsLocationsStreamsPatchSecurity = dataclasses.field()
