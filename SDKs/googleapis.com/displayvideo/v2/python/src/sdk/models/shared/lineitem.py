...
class LineItemInput:
    ...
    youtube_and_partners_settings: Optional[shared_youtubeandpartnerssettings.YoutubeAndPartnersSettingsInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('youtubeAndPartnersSettings'), 'exclude': lambda f: f is None }})
...
class LineItem:
    ...
    youtube_and_partners_settings: Optional[shared_youtubeandpartnerssettings.YoutubeAndPartnersSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('youtubeAndPartnersSettings'), 'exclude': lambda f: f is None }})
    r"""Settings for YouTube and Partners line items."""  
