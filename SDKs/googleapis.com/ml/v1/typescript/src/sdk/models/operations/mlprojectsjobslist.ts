...
export class MlProjectsJobsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MlProjectsJobsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class MlProjectsJobsListSecurity extends SpeakeasyBase {
...
export class MlProjectsJobsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MlProjectsJobsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
