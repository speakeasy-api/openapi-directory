...
class ListIncomingPhoneNumberRequest:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the IncomingPhoneNumber resources to read."""  
    ...
    r"""A string that identifies the IncomingPhoneNumber resources to read."""  
...
class ListIncomingPhoneNumberListIncomingPhoneNumberResponse:
    ...
    incoming_phone_numbers: Optional[list[shared_api_v2010_account_incoming_phone_number.APIV2010AccountIncomingPhoneNumber]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('incoming_phone_numbers'), 'exclude': lambda f: f is None }})  
