...
class SavingsPlanOfferingFilterElement:
    ...
    name: Optional[shared_savingsplanofferingfilterattribute_enum.SavingsPlanOfferingFilterAttributeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})  
