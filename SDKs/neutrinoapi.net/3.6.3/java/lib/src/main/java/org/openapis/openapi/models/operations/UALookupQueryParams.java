...
public class UALookupQueryParams {
    /**
    ...
    public UALookupQueryParams withDeviceBrand(String deviceBrand) {
    ...
    public UALookupQueryParams withDeviceModel(String deviceModel) {
    ...
    public String ua;
    public UALookupQueryParams withUa(String ua) {
        this.ua = ua;
        return this;
    }
    ...
    public UALookupQueryParams withUaMobile(String uaMobile) {
    ...
    public UALookupQueryParams withUaPlatform(String uaPlatform) {
    ...
    public UALookupQueryParams withUaPlatformVersion(String uaPlatformVersion) {
    ...
    public UALookupQueryParams withUaVersion(String uaVersion) {
