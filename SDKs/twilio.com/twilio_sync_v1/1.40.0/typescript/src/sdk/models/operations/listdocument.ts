...
export const ListDocumentServerList = ["https://sync.twilio.com"] as const;
...
export class ListDocumentListDocumentResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.SyncV1ServiceDocument })
  @Expose({ name: "documents" })
  @Type(() => shared.SyncV1ServiceDocument)
  documents?: shared.SyncV1ServiceDocument[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListDocumentListDocumentResponseMeta)
