...
public class AggregatedGetStatisticsListQueryParams {
    /**
     * If using a "custom" timeFrame you can specify the starting day (YYYYMMDD)
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=fromDay")
    public String fromDay;
    public AggregatedGetStatisticsListQueryParams withFromDay(String fromDay) {
    ...
    public AggregatedGetStatisticsListQueryParams withGroupBy(AggregatedGetStatisticsListGroupByEnum groupBy) {
    ...
    public AggregatedGetStatisticsListQueryParams withTimeFrame(AggregatedGetStatisticsListTimeFrameEnum timeFrame) {
    ...
    public String toDay;
    public AggregatedGetStatisticsListQueryParams withToDay(String toDay) {
        this.toDay = toDay;
        return this;
    }
