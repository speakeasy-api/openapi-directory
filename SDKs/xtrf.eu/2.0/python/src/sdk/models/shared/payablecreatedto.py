...
class PayableCreateDTORateOriginEnum(str, Enum):
    PRICE_PROFILE = 'PRICE_PROFILE'
    PRICE_LIST = 'PRICE_LIST'
    FILLED_MANUALLY = 'FILLED_MANUALLY'
    AUTOCALCULATED = 'AUTOCALCULATED'

class PayableCreateDTOTypeEnum(str, Enum):
    SIMPLE = 'SIMPLE'
    CAT = 'CAT'
...
class PayableCreateDTO:
    ...
    cat_log_file: Optional[shared_filedto.FileDTO] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('catLogFile'), 'exclude': lambda f: f is None }})  
    ...
    rate_origin: Optional[PayableCreateDTORateOriginEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rateOrigin'), 'exclude': lambda f: f is None }})  
    ...
    type: Optional[PayableCreateDTOTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
