...
class Service
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GkeNamespace $gkeNamespace
     */
	#[\JMS\Serializer\Annotation\SerializedName('gkeNamespace')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GkeNamespace')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GkeNamespace $gkeNamespace = null;
    
    /**
     * GKE Service. The "service" here represents a Kubernetes service object (https://kubernetes.io/docs/concepts/services-networking/service). The field names correspond to the resource labels on k8s_service monitored resources (https://cloud.google.com/monitoring/api/resources#tag_k8s_service).
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GkeService $gkeService
     */
	#[\JMS\Serializer\Annotation\SerializedName('gkeService')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GkeService')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GkeService $gkeService = null;
    
    /**
     * A GKE Workload (Deployment, StatefulSet, etc). The field names correspond to the metadata labels on monitored resources that fall under a workload (for example, k8s_container or k8s_pod).
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GkeWorkload $gkeWorkload
     */
	#[\JMS\Serializer\Annotation\SerializedName('gkeWorkload')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GkeWorkload')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GkeWorkload $gkeWorkload = null;
