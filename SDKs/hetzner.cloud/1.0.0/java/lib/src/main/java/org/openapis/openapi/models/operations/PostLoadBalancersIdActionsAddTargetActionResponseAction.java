...
public class PostLoadBalancersIdActionsAddTargetActionResponseAction {
    ...
    public PostLoadBalancersIdActionsAddTargetActionResponseAction(@JsonProperty("command") String command, @JsonProperty("error") PostLoadBalancersIdActionsAddTargetActionResponseActionError error, @JsonProperty("finished") String finished, @JsonProperty("id") Long id, @JsonProperty("progress") Double progress, @JsonProperty("resources") PostLoadBalancersIdActionsAddTargetActionResponseActionResources[] resources, @JsonProperty("started") String started, @JsonProperty("status") PostLoadBalancersIdActionsAddTargetActionResponseActionStatusEnum status) {
        this.command = command;
        this.error = error;
        this.finished = finished;
        this.id = id;
