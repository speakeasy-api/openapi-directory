...
class CreateAndValidateShipmentDeliveryConfirmationEnum(str, Enum):
...
class CreateAndValidateShipmentInternationalShipmentOptionsPackageContentsEnum(str, Enum):
...
class CreateAndValidateShipmentInternationalShipmentOptionsNonDeliveryEnum(str, Enum):
...
class CreateAndValidateShipmentInternationalShipmentOptions:
    ...
    contents: CreateAndValidateShipmentInternationalShipmentOptionsPackageContentsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contents') }})
    r"""The type of contents in this shipment.  This may impact import duties or customs treatment."""  
    non_delivery: CreateAndValidateShipmentInternationalShipmentOptionsNonDeliveryEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('non_delivery') }})
...
class CreateAndValidateShipmentInsuranceProviderEnum(str, Enum):
...
class CreateAndValidateShipmentOriginTypeEnum(str, Enum):
    r"""Indicates if the package will be picked up or dropped off by the carrier"""
    PICKUP = 'pickup'
    DROP_OFF = 'drop_off'

class CreateAndValidateShipmentShipmentStatusEnum(str, Enum):
...
class CreateAndValidateShipment:
    ...
    address_validation: Optional[shared_address_validation_result.AddressValidationResult] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address_validation'), 'exclude': lambda f: f is None }})
    r"""The address validation"""  
    ...
    confirmation: Optional[CreateAndValidateShipmentDeliveryConfirmationEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('confirmation'), 'exclude': lambda f: f is None }})
    ...
    customs: Optional[CreateAndValidateShipmentInternationalShipmentOptions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('customs'), 'exclude': lambda f: f is None }})
    ...
    r"""An array of errors that occurred while creating shipment."""  
    ...
    """  
    insurance_provider: Optional[CreateAndValidateShipmentInsuranceProviderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('insurance_provider'), 'exclude': lambda f: f is None }})
    ...
    origin_type: Optional[CreateAndValidateShipmentOriginTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin_type'), 'exclude': lambda f: f is None }})
    r"""Indicates if the package will be picked up or dropped off by the carrier"""  
    ...
    """  
    shipment_status: Optional[CreateAndValidateShipmentShipmentStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shipment_status'), 'exclude': lambda f: f is None }})
    ...
    total_weight: Optional[CreateAndValidateShipmentWeight] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('total_weight'), 'exclude': lambda f: f is None }})
