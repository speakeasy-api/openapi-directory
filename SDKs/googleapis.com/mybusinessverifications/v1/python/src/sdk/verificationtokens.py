...
class VerificationTokens:
    ...
    def mybusinessverifications_verification_tokens_generate(self, request: operations.MybusinessverificationsVerificationTokensGenerateRequest) -> operations.MybusinessverificationsVerificationTokensGenerateResponse:
        r"""Generates a token for the provided location data as a vetted [partner](https://support.google.com/business/answer/7674102). Throws PERMISSION_DENIED if the caller is not a vetted partner account. Throws FAILED_PRECONDITION if the caller's VettedStatus is INVALID.
        """
