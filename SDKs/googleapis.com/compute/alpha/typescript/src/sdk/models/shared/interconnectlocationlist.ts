 ...
 */
export enum InterconnectLocationListWarningCodeEnum {
...
export class InterconnectLocationListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InterconnectLocationListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InterconnectLocationListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class InterconnectLocationList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: InterconnectLocation })
  @Expose({ name: "items" })
