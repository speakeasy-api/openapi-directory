...
class NullableCollaboratorPermissions:
...
class NullableCollaborator:
    ...
    permissions: Optional[NullableCollaboratorPermissions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('permissions'), 'exclude': lambda f: f is None }})  
