...
class SearchTypeGtfsAgencyQueryParams:
...
@dataclasses.dataclass
class SearchTypeGtfsAgencyRequest:
    query_params: SearchTypeGtfsAgencyQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeGtfsAgencyResponse:
