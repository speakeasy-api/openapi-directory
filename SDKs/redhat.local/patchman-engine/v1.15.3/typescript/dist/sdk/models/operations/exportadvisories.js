...
exports.ExportAdvisoriesResponse = exports.ExportAdvisoriesRequest = exports.ExportAdvisoriesSecurity = void 0;
...
var ExportAdvisoriesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ExportAdvisoriesRequest.prototype, "filterAdvisoryType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[applicable_systems]",
        }),
        __metadata("design:type", String)
    ], ExportAdvisoriesRequest.prototype, "filterApplicableSystems", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[description]",
        }),
        __metadata("design:type", String)
    ], ExportAdvisoriesRequest.prototype, "filterDescription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[id]",
        }),
        __metadata("design:type", String)
    ], ExportAdvisoriesRequest.prototype, "filterId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[public_date]",
        }),
        __metadata("design:type", String)
    ], ExportAdvisoriesRequest.prototype, "filterPublicDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[severity]",
        }),
        __metadata("design:type", String)
    ], ExportAdvisoriesRequest.prototype, "filterSeverity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[synopsis]",
        }),
        __metadata("design:type", String)
    ], ExportAdvisoriesRequest.prototype, "filterSynopsis", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=search",
        }),
        __metadata("design:type", String)
    ], ExportAdvisoriesRequest.prototype, "search", void 0);
...
var ExportAdvisoriesResponse = /** @class */ (function (_super) {
    ...
    ], ExportAdvisoriesResponse.prototype, "rawResponse", void 0);
    __decorate([
