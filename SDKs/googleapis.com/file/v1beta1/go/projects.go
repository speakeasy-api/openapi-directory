...
func (s *projects) FileProjectsLocationsInstancesRevert(ctx context.Context, request operations.FileProjectsLocationsInstancesRevertRequest, security operations.FileProjectsLocationsInstancesRevertSecurity) (*operations.FileProjectsLocationsInstancesRevertResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v1beta1/{name}:revert", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *projects) FileProjectsLocationsInstancesSharesCreate(ctx context.Context, request operations.FileProjectsLocationsInstancesSharesCreateRequest, security operations.FileProjectsLocationsInstancesSharesCreateSecurity) (*operations.FileProjectsLocationsInstancesSharesCreateResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v1beta1/{parent}/shares", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *projects) FileProjectsLocationsInstancesSnapshotsCreate(ctx context.Context, request operations.FileProjectsLocationsInstancesSnapshotsCreateRequest, security operations.FileProjectsLocationsInstancesSnapshotsCreateSecurity) (*operations.FileProjectsLocationsInstancesSnapshotsCreateResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v1beta1/{parent}/snapshots", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
