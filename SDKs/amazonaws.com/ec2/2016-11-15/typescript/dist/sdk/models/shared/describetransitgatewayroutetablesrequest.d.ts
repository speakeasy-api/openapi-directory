 ...
 */
export declare class DescribeTransitGatewayRouteTablesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTransitGatewayRouteTablesRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeTransitGatewayRouteTablesRequestFilters[];
    maxResults?: number;
    nextToken?: string;
