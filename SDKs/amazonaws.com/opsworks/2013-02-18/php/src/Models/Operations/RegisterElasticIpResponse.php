...
class RegisterElasticIpResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RegisterElasticIpResult $registerElasticIpResult
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\RegisterElasticIpResult $registerElasticIpResult = null;
	...
	{
		$this->contentType = "";
		$this->registerElasticIpResult = null;
