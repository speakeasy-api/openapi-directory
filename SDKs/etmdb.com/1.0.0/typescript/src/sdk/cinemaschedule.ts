...
export class CinemaSchedule {
  ...
  cinemaScheduleSearchRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CinemaScheduleSearchReadResponse =
        new operations.CinemaScheduleSearchReadResponse({
  ...
  cinemaScheduleSearchallRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CinemaScheduleSearchallReadResponse =
        new operations.CinemaScheduleSearchallReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
