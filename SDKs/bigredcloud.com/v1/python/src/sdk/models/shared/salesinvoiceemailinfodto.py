...
class SalesInvoiceEmailInfoDto:
    ...
    sales_invoice_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('salesInvoiceId'), 'exclude': lambda f: f is None }})  
