 ...
 */
export declare class DescribeVpcEndpointConnectionsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeVpcEndpointConnectionsRequest extends SpeakeasyBase {
    dryRun?: boolean;
