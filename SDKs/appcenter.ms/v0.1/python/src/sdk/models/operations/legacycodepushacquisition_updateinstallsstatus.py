...
class LegacyCodePushAcquisitionUpdateInstallsStatusSecurity:
...
class LegacyCodePushAcquisitionUpdateInstallsStatusResponse:
    ...
    legacy_code_push_acquisition_update_installs_status_default_application_json_object: Optional[LegacyCodePushAcquisitionUpdateInstallsStatusDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error"""  
