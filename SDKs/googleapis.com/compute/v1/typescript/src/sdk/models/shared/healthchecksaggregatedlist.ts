 ...
 */
export enum HealthChecksAggregatedListWarningCodeEnum {
...
export class HealthChecksAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class HealthChecksAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: HealthChecksAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class HealthChecksAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: HealthChecksScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, HealthChecksScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], HealthChecksScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
