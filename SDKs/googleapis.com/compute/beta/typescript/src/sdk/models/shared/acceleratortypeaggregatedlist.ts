...
import { AcceleratorTypesScopedList } from "./acceleratortypesscopedlist";
import { Expose, Transform, Type } from "class-transformer";

/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export enum AcceleratorTypeAggregatedListWarningCodeEnum {
...
export class AcceleratorTypeAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class AcceleratorTypeAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: AcceleratorTypeAggregatedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: AcceleratorTypeAggregatedListWarningData })
  @Expose({ name: "data" })
  @Type(() => AcceleratorTypeAggregatedListWarningData)
  data?: AcceleratorTypeAggregatedListWarningData[];
 ...
 * Successful response
 */
export class AcceleratorTypeAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: AcceleratorTypesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, AcceleratorTypesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], AcceleratorTypesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
