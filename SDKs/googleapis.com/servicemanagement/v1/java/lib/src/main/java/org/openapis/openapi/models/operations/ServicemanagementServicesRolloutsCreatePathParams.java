...
public class ServicemanagementServicesRolloutsCreatePathParams {
    /**
    ...
    public ServicemanagementServicesRolloutsCreatePathParams withServiceName(String serviceName) {
