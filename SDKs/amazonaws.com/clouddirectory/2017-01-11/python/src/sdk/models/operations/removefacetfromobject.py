...
class RemoveFacetFromObjectRequestBody:
    object_reference: RemoveFacetFromObjectRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ObjectReference') }})
    schema_facet: RemoveFacetFromObjectRequestBodySchemaFacet = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SchemaFacet') }})
    

@dataclasses.dataclass
class RemoveFacetFromObjectRequest:
    headers: RemoveFacetFromObjectHeaders = dataclasses.field()
    request: RemoveFacetFromObjectRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
