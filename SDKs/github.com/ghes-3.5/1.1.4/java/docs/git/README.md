...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateBlobRequest req = new GitCreateBlobRequest(                new GitCreateBlobRequestBody("minima") {{
                                encoding = "aspernatur";
                            }};, "ex", "maiores");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateCommitRequest req = new GitCreateCommitRequest(                new GitCreateCommitRequestBody("corrupti", "at") {{
                                author = new GitCreateCommitRequestBodyAuthor("error", "blanditiis") {{
                                    date = OffsetDateTime.parse("2022-01-29T08:13:54.022Z");
                                }};;
                                committer = new GitCreateCommitRequestBodyCommitter() {{
                                    date = OffsetDateTime.parse("2021-12-01T19:00:30.130Z");
                                    email = "Theresia.Parisian96@gmail.com";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateRefRequest req = new GitCreateRefRequest(                new GitCreateRefRequestBody("saepe", "consequuntur") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateTagRequest req = new GitCreateTagRequest(                new GitCreateTagRequestBody("perspiciatis", "in", "adipisci", GitCreateTagRequestBodyTypeEnum.BLOB) {{
                                tagger = new GitCreateTagRequestBodyTagger("occaecati", "consequuntur") {{
                                    date = OffsetDateTime.parse("2022-05-04T16:36:37.699Z");
                                }};;
                            }};, "quis", "reprehenderit");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitDeleteRefRequest req = new GitDeleteRefRequest("laborum", "distinctio", "voluptatum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetBlobRequest req = new GitGetBlobRequest("rem", "aliquam", "ad");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetCommitRequest req = new GitGetCommitRequest("repellat", "alias", "corporis");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetRefRequest req = new GitGetRefRequest("perspiciatis", "nihil", "mollitia");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetTagRequest req = new GitGetTagRequest("voluptas", "alias", "maiores");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetTreeRequest req = new GitGetTreeRequest("reiciendis", "dolores", "id") {{
                recursive = "minima";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitListMatchingRefsRequest req = new GitListMatchingRefsRequest("dolore", "dolorum", "nesciunt");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitUpdateRefRequest req = new GitUpdateRefRequest(                new GitUpdateRefRequestBody("quae") {{
                                force = false;
                            }};, "recusandae", "omnis", "quaerat");            
