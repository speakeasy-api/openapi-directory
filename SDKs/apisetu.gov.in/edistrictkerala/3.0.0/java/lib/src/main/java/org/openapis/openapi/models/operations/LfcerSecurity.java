...
public class LfcerSecurity {
    ...
    public LfcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public LfcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public LfcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
