...
type SearchProjectDataformatQueryParams struct {
	...
	// Data Type
	SearchProjectDataformatDataType *string `queryParam:"style=form,explode=true,name=search.project_dataformat.data_type"`
	// Field
	SearchProjectDataformatField *string `queryParam:"style=form,explode=true,name=search.project_dataformat.field"`
	// Number to skip
...
type SearchProjectDataformatRequest struct {
	QueryParams SearchProjectDataformatQueryParams
}

type SearchProjectDataformatResponse struct {
	ContentType string
	StatusCode  int
