...
class DescribeAvailabilityZonesRequest:
    ...
    all_availability_zones: Optional[bool] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeAvailabilityZonesRequestFilters]] = dataclasses.field(default=None)  
    zone_ids: Optional[list[str]] = dataclasses.field(default=None)  
    zone_names: Optional[list[str]] = dataclasses.field(default=None)  
