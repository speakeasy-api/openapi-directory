...
export class ContainerProjectsLocationsClustersListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContainerProjectsLocationsClustersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsLocationsClustersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
