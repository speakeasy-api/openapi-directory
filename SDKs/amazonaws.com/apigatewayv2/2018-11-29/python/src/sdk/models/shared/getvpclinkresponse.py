...
class GetVpcLinkResponseVpcLinkStatusEnum(str, Enum):
...
class GetVpcLinkResponseVpcLinkVersionEnum(str, Enum):
...
class GetVpcLinkResponse:
    ...
    vpc_link_status: Optional[GetVpcLinkResponseVpcLinkStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VpcLinkStatus'), 'exclude': lambda f: f is None }})  
    ...
    vpc_link_version: Optional[GetVpcLinkResponseVpcLinkVersionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VpcLinkVersion'), 'exclude': lambda f: f is None }})  
