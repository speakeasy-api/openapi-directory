...
func (s *operationsT) CloudresourcemanagerOperationsGet(ctx context.Context, request operations.CloudresourcemanagerOperationsGetRequest) (*operations.CloudresourcemanagerOperationsGetResponse, error) {
	baseURL := s.serverURL
