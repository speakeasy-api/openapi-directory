...
exports.ClientApiCanDeleteResponse = exports.ClientApiCanDeleteRequest = void 0;
...
var ClientApiCanDeleteRequest = /** @class */ (function (_super) {
    ...
    ], ClientApiCanDeleteRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-key",
        }),
        __metadata("design:type", String)
    ], ClientApiCanDeleteRequest.prototype, "xAuthKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-secret",
        }),
        __metadata("design:type", String)
    ], ClientApiCanDeleteRequest.prototype, "xAuthSecret", void 0);
    return ClientApiCanDeleteRequest;
}(utils_1.SpeakeasyBase));
exports.ClientApiCanDeleteRequest = ClientApiCanDeleteRequest;
var ClientApiCanDeleteResponse = /** @class */ (function (_super) {
    ...
    ], ClientApiCanDeleteResponse.prototype, "rawResponse", void 0);
    return ClientApiCanDeleteResponse;
}(utils_1.SpeakeasyBase));
exports.ClientApiCanDeleteResponse = ClientApiCanDeleteResponse;
