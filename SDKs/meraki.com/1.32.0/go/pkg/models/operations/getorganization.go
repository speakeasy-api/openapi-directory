...
func (e GetOrganization200ApplicationJSONLicensingModelEnum) ToPointer() *GetOrganization200ApplicationJSONLicensingModelEnum {
	return &e
}
...
func (e *GetOrganization200ApplicationJSONLicensingModelEnum) UnmarshalJSON(data []byte) error {
	...
	case "per-device":
		fallthrough
	case "subscription":
		*e = GetOrganization200ApplicationJSONLicensingModelEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganization200ApplicationJSONLicensingModelEnum: %v", v)
	}
}
