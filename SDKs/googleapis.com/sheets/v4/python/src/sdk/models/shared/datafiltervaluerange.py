...
class DataFilterValueRange:
    ...
    major_dimension: Optional[DataFilterValueRangeMajorDimensionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('majorDimension') }})
