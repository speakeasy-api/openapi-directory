...
class RecommenderProjectsLocationsRecommendersRecommendationsMarkClaimedRequest:
    ...
    google_cloud_recommender_v1_mark_recommendation_claimed_request: Optional[shared_googlecloudrecommenderv1markrecommendationclaimedrequest.GoogleCloudRecommenderV1MarkRecommendationClaimedRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
