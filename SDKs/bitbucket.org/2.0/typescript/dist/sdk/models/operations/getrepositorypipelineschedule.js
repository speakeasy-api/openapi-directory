...
exports.GetRepositoryPipelineScheduleResponse = exports.GetRepositoryPipelineScheduleRequest = void 0;
...
var GetRepositoryPipelineScheduleRequest = /** @class */ (function (_super) {
    ...
    ], GetRepositoryPipelineScheduleRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=schedule_uuid",
        }),
        __metadata("design:type", String)
    ], GetRepositoryPipelineScheduleRequest.prototype, "scheduleUuid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], GetRepositoryPipelineScheduleRequest.prototype, "workspace", void 0);
...
var GetRepositoryPipelineScheduleResponse = /** @class */ (function (_super) {
    ...
    ], GetRepositoryPipelineScheduleResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
