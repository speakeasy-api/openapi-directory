...
from ..shared import lendingresult as shared_lendingresult
...
class GetLendingAnalysisResponse:
    ...
    results: Optional[list[shared_lendingresult.LendingResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Results'), 'exclude': lambda f: f is None }})  
