...
exports.TaxRatesOneResponse = exports.TaxRatesOneRequest = exports.TaxRatesOneSecurity = void 0;
...
exports.TaxRatesOneSecurity = TaxRatesOneSecurity;
var TaxRatesOneRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], TaxRatesOneRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], TaxRatesOneRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], TaxRatesOneRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], TaxRatesOneRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], TaxRatesOneRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], TaxRatesOneRequest.prototype, "xApideckServiceId", void 0);
    return TaxRatesOneRequest;
}(utils_1.SpeakeasyBase));
exports.TaxRatesOneRequest = TaxRatesOneRequest;
var TaxRatesOneResponse = /** @class */ (function (_super) {
    ...
    ], TaxRatesOneResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.TaxRatesOneResponse = TaxRatesOneResponse;
