...
class AdexchangebuyerProposalsUpdateRequest:
    path_params: AdexchangebuyerProposalsUpdatePathParams = dataclasses.field()
    query_params: AdexchangebuyerProposalsUpdateQueryParams = dataclasses.field()
    security: AdexchangebuyerProposalsUpdateSecurity = dataclasses.field()
