...
export class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsJobRunsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsJobRunsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsJobRunsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
