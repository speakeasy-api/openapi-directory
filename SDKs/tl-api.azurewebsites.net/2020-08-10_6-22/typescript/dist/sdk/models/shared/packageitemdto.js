...
var PackageItemDTO = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "articleName" }),
        __metadata("design:type", String)
    ], PackageItemDTO.prototype, "articleName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "articleNumber" }),
        __metadata("design:type", Number)
    ], PackageItemDTO.prototype, "articleNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "articlePrice" }),
        __metadata("design:type", Number)
    ], PackageItemDTO.prototype, "articlePrice", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "endOrder" }),
        __metadata("design:type", Number)
    ], PackageItemDTO.prototype, "endOrder", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "isIncludeServiceInCharge" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "numberOfItems" }),
        __metadata("design:type", Number)
    ], PackageItemDTO.prototype, "numberOfItems", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "startOrder" }),
        __metadata("design:type", Number)
