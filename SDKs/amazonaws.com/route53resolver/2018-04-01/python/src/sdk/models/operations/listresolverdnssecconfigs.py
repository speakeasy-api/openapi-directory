...
class ListResolverDnssecConfigsRequest:
    ...
    list_resolver_dnssec_configs_request: shared_listresolverdnssecconfigsrequest.ListResolverDnssecConfigsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
