...
exports.ListFieldTypeResponse = exports.ListFieldTypeListFieldTypeResponse = exports.ListFieldTypeListFieldTypeResponseMeta = exports.ListFieldTypeRequest = exports.ListFieldTypeSecurity = exports.ListFieldTypeServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListFieldTypeServerList = [
...
var ListFieldTypeSecurity = /** @class */ (function (_super) {
    ...
    ], ListFieldTypeSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListFieldTypeSecurity.prototype, "username", void 0);
    return ListFieldTypeSecurity;
}(utils_1.SpeakeasyBase));
exports.ListFieldTypeSecurity = ListFieldTypeSecurity;
var ListFieldTypeRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListFieldTypeRequest.prototype, "assistantSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListFieldTypeRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListFieldTypeRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListFieldTypeRequest.prototype, "pageToken", void 0);
    return ListFieldTypeRequest;
}(utils_1.SpeakeasyBase));
exports.ListFieldTypeRequest = ListFieldTypeRequest;
...
exports.ListFieldTypeListFieldTypeResponseMeta = ListFieldTypeListFieldTypeResponseMeta;
/**
 * OK
 */
var ListFieldTypeListFieldTypeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.AutopilotV1AssistantFieldType }),
        (0, class_transformer_1.Expose)({ name: "field_types" }),
        (0, class_transformer_1.Type)(function () { return shared.AutopilotV1AssistantFieldType; }),
        __metadata("design:type", Array)
    ], ListFieldTypeListFieldTypeResponse.prototype, "fieldTypes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListFieldTypeListFieldTypeResponseMeta; }),
...
exports.ListFieldTypeListFieldTypeResponse = ListFieldTypeListFieldTypeResponse;
var ListFieldTypeResponse = /** @class */ (function (_super) {
    ...
    ], ListFieldTypeResponse.prototype, "rawResponse", void 0);
    return ListFieldTypeResponse;
}(utils_1.SpeakeasyBase));
exports.ListFieldTypeResponse = ListFieldTypeResponse;
