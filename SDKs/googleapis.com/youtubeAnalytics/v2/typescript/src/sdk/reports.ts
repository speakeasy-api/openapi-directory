...
export class Reports {
  ...
  youtubeAnalyticsReportsQuery(
    ...
    security: operations.YoutubeAnalyticsReportsQuerySecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.YoutubeAnalyticsReportsQuerySecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.YoutubeAnalyticsReportsQueryResponse =
        new operations.YoutubeAnalyticsReportsQueryResponse({
