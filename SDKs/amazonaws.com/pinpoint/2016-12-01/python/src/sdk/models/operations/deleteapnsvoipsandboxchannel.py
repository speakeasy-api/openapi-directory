...
from ..shared import deleteapnsvoipsandboxchannelresponse as shared_deleteapnsvoipsandboxchannelresponse
...
class DeleteApnsVoipSandboxChannelRequest:
    headers: DeleteApnsVoipSandboxChannelHeaders = dataclasses.field()
    path_params: DeleteApnsVoipSandboxChannelPathParams = dataclasses.field()
...
class DeleteApnsVoipSandboxChannelResponse:
    ...
    delete_apns_voip_sandbox_channel_response: Optional[shared_deleteapnsvoipsandboxchannelresponse.DeleteApnsVoipSandboxChannelResponse] = dataclasses.field(default=None)
