...
func (e CreateEnvironmentRequestBodyEngineTypeEnum) ToPointer() *CreateEnvironmentRequestBodyEngineTypeEnum {
	return &e
}
...
func (e *CreateEnvironmentRequestBodyEngineTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "microfocus":
		fallthrough
	case "bluage":
		*e = CreateEnvironmentRequestBodyEngineTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateEnvironmentRequestBodyEngineTypeEnum: %v", v)
	}
}
