...
class DeleteMountTargetRequest:
    headers: DeleteMountTargetHeaders = dataclasses.field()
    path_params: DeleteMountTargetPathParams = dataclasses.field()
...
class DeleteMountTargetResponse:
    ...
    dependency_timeout: Optional[Any] = dataclasses.field(default=None)
