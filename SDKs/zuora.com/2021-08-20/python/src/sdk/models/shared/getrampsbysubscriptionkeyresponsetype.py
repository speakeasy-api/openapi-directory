...
class GETRampsBySubscriptionKeyResponseType:
    ...
    ramps: Optional[list[shared_rampresponse.RampResponse]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ramps'), 'exclude': lambda f: f is None }})  
    reasons: Optional[list[GETRampsBySubscriptionKeyResponseTypeReasons]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reasons'), 'exclude': lambda f: f is None }})  
