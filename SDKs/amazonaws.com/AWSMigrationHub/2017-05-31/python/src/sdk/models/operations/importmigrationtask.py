...
class ImportMigrationTaskRequest:
    ...
    import_migration_task_request: shared_importmigrationtaskrequest.ImportMigrationTaskRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
