...
public class GetDevEnvironmentPathParams {
    /**
    ...
    public String id;
    public GetDevEnvironmentPathParams withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetDevEnvironmentPathParams withProjectName(String projectName) {
    ...
    public GetDevEnvironmentPathParams withSpaceName(String spaceName) {
