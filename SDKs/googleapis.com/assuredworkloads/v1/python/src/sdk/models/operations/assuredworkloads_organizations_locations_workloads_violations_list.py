...
from ..shared import security as shared_security
from ..shared import googlecloudassuredworkloadsv1listviolationsresponse as shared_googlecloudassuredworkloadsv1listviolationsresponse
...
class AssuredworkloadsOrganizationsLocationsWorkloadsViolationsListRequest:
    path_params: AssuredworkloadsOrganizationsLocationsWorkloadsViolationsListPathParams = dataclasses.field()
    query_params: AssuredworkloadsOrganizationsLocationsWorkloadsViolationsListQueryParams = dataclasses.field()
    security: AssuredworkloadsOrganizationsLocationsWorkloadsViolationsListSecurity = dataclasses.field()
...
class AssuredworkloadsOrganizationsLocationsWorkloadsViolationsListResponse:
    ...
    google_cloud_assuredworkloads_v1_list_violations_response: Optional[shared_googlecloudassuredworkloadsv1listviolationsresponse.GoogleCloudAssuredworkloadsV1ListViolationsResponse] = dataclasses.field(default=None)
