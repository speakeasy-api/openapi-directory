...
from ..shared import snapshotdiskcontainer as shared_snapshotdiskcontainer
from enum import Enum
from typing import Optional

class ImportSnapshotRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class ImportSnapshotRequestTagSpecifications:
    ...
    resource_type: Optional[ImportSnapshotRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[ImportSnapshotRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class ImportSnapshotRequest:
    ...
    disk_container: Optional[shared_snapshotdiskcontainer.SnapshotDiskContainer] = dataclasses.field(default=None)  
    ...
    tag_specifications: Optional[list[ImportSnapshotRequestTagSpecifications]] = dataclasses.field(default=None)  
