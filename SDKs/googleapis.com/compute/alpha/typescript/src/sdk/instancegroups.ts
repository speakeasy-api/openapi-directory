...
export class InstanceGroups {
  ...
  computeInstanceGroupsTestIamPermissions(
    req: operations.ComputeInstanceGroupsTestIamPermissionsRequest,
    security: operations.ComputeInstanceGroupsTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeInstanceGroupsTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ComputeInstanceGroupsTestIamPermissionsRequest(req);
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.ComputeInstanceGroupsTestIamPermissionsSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeInstanceGroupsTestIamPermissionsResponse =
        new operations.ComputeInstanceGroupsTestIamPermissionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
