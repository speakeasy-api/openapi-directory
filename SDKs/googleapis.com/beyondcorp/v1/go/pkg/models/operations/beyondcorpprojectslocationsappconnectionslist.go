...
type BeyondcorpProjectsLocationsAppConnectionsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type BeyondcorpProjectsLocationsAppConnectionsListPathParams struct {
...
type BeyondcorpProjectsLocationsAppConnectionsListQueryParams struct {
	// V1 error format.
...
type BeyondcorpProjectsLocationsAppConnectionsListRequest struct {
...
type BeyondcorpProjectsLocationsAppConnectionsListResponse struct {
	ContentType string
	// Successful response
