...
class SearchBioDicomTestQueryParams:
    ...
    search_bio_dicom_test_patient_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.bio_dicom_test.PatientID', 'style': 'form', 'explode': True }})
    search_bio_dicom_test_patient_name: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.bio_dicom_test.PatientName', 'style': 'form', 'explode': True }})
...
class SearchBioDicomTestRequest:
    query_params: SearchBioDicomTestQueryParams = dataclasses.field()
