...
class GetNetworkBluetoothClientsRequest:
    ...
    r"""The number of entries per page returned. Acceptable range is 5 - 1000. Default is 10."""  
    ...
    r"""The timespan for which the information will be fetched. If specifying timespan, do not specify parameter t0. The value must be in seconds and be less than or equal to 7 days. The default is 1 day."""  
...
class GetNetworkBluetoothClientsResponse:
    ...
    get_network_bluetooth_clients_200_application_json_objects: Optional[list[dict[str, Any]]] = dataclasses.field(default=None)
