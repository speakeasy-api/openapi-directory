...
export class SearchTypeHydroColoradoRequest extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=search.type_hydro_colorado.site_id",
  })
...
export class SearchTypeHydroColoradoResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
