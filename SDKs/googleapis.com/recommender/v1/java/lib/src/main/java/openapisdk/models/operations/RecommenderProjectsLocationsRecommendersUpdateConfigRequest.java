...
public class RecommenderProjectsLocationsRecommendersUpdateConfigRequest {
    ...
    public openapisdk.models.shared.GoogleCloudRecommenderV1RecommenderConfigInput request;
    public RecommenderProjectsLocationsRecommendersUpdateConfigRequest withRequest(openapisdk.models.shared.GoogleCloudRecommenderV1RecommenderConfigInput request) {
