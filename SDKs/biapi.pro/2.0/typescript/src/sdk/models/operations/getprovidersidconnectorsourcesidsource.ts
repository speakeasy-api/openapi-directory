...
export class GetProvidersIdConnectorSourcesIdSourceRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetProvidersIdConnectorSourcesIdSourceResponse extends SpeakeasyBase {
  /**
