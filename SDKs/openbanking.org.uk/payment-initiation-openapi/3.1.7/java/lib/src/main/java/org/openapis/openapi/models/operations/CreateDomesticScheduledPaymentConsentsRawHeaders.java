...
public class CreateDomesticScheduledPaymentConsentsRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticScheduledPaymentConsentsRawHeaders withAuthorization(String authorization) {
    ...
    public CreateDomesticScheduledPaymentConsentsRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticScheduledPaymentConsentsRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticScheduledPaymentConsentsRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateDomesticScheduledPaymentConsentsRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateDomesticScheduledPaymentConsentsRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticScheduledPaymentConsentsRawHeaders withXJwsSignature(String xJwsSignature) {
