...
exports.GetUsersResponse = exports.GetUsersRequest = exports.GetUsersQueryParams = void 0;
...
var GetUsersQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q[admin]" }),
        __metadata("design:type", String)
    ], GetUsersQueryParams.prototype, "qAdmin", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q[allowed_ips]" }),
        __metadata("design:type", String)
    ], GetUsersQueryParams.prototype, "qAllowedIps", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q[email]" }),
        __metadata("design:type", String)
    ], GetUsersQueryParams.prototype, "qEmail", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q[notes]" }),
        __metadata("design:type", String)
    ], GetUsersQueryParams.prototype, "qNotes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q[password_validity_days]" }),
        __metadata("design:type", String)
    ], GetUsersQueryParams.prototype, "qPasswordValidityDays", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q[ssl_required]" }),
        __metadata("design:type", String)
    ], GetUsersQueryParams.prototype, "qSslRequired", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q[username]" }),
        __metadata("design:type", String)
...
var GetUsersResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.UserEntity }),
