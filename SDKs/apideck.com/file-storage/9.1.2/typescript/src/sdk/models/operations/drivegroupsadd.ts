...
export class DriveGroupsAddSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DriveGroupsAddRequest extends SpeakeasyBase {
...
export class DriveGroupsAddResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
