...
export declare class CreateFilePaymentsJsonSecurity extends SpeakeasyBase {
    psuoAuth2Security: string;
}
export declare class CreateFilePaymentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateFilePaymentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
