...
class TrustTrustDirectionEnum(str, Enum):
    r"""The trust direction, which decides if the current domain is trusted, trusting, or both."""
...
class TrustInput:
    ...
    r"""The trust authentication type, which decides whether the trusted side has forest/domain wide access or selective access to an approved set of resources."""  
    ...
    r"""The target DNS server IP addresses which can resolve the remote domain involved in the trust."""  
    ...
    r"""The fully qualified target domain name which will be in trust with the current domain."""  
    ...
    r"""Input only. The trust secret used for the handshake with the target domain. It will not be stored."""  
