 ...
 */
export enum AddressValidatingShipmentDeliveryConfirmationEnum {
  None = "none",
  Delivery = "delivery",
  Signature = "signature",
 ...
 */
export enum AddressValidatingShipmentInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export enum AddressValidatingShipmentInternationalShipmentOptionsNonDeliveryEnum {
...
export class AddressValidatingShipmentInternationalShipmentOptionsInput extends SpeakeasyBase {
  ...
  contents: AddressValidatingShipmentInternationalShipmentOptionsPackageContentsEnum;
  ...
  nonDelivery: AddressValidatingShipmentInternationalShipmentOptionsNonDeliveryEnum;
}

/**
 * The possible insurance provider values
 */
export enum AddressValidatingShipmentInsuranceProviderEnum {
  None = "none",
 ...
 */
export enum AddressValidatingShipmentOriginTypeEnum {
  Pickup = "pickup",
  DropOff = "drop_off",
}
 ...
 */
export enum AddressValidatingShipmentValidateAddressEnum {
...
export class AddressValidatingShipmentInput extends SpeakeasyBase {
  ...
  confirmation?: AddressValidatingShipmentDeliveryConfirmationEnum;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "customs" })
  @Type(() => AddressValidatingShipmentInternationalShipmentOptionsInput)
  ...
  insuranceProvider?: AddressValidatingShipmentInsuranceProviderEnum;
  ...
  originType?: AddressValidatingShipmentOriginTypeEnum;
  ...
  validateAddress?: AddressValidatingShipmentValidateAddressEnum;
