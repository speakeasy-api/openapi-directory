...
class MessageStatusWhatsApp
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\MessageStatusWhatsAppChannelEnum $channel
     */
	#[\JMS\Serializer\Annotation\SerializedName('channel')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\MessageStatusWhatsAppChannelEnum>')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\MessageStatusWhatsAppError $error
     */
	#[\JMS\Serializer\Annotation\SerializedName('error')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\MessageStatusWhatsAppError')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MessageStatusWhatsAppError $error = null;
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\MessageStatusWhatsAppStatusEnum>')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\MessageStatusWhatsAppUsage')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MessageStatusWhatsAppUsage $usage = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\MessageStatusWhatsAppWhatsapp $whatsapp
     */
	#[\JMS\Serializer\Annotation\SerializedName('whatsapp')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\MessageStatusWhatsAppWhatsapp')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MessageStatusWhatsAppWhatsapp $whatsapp = null;
    
	public function __construct()
	{
		$this->channel = \OpenAPI\OpenAPI\Models\Shared\MessageStatusWhatsAppChannelEnum::WHATSAPP;
		$this->clientRef = null;
		$this->error = null;
		$this->from = "";
		$this->messageUuid = "";
		$this->status = \OpenAPI\OpenAPI\Models\Shared\MessageStatusWhatsAppStatusEnum::SUBMITTED;
		$this->timestamp = "";
		$this->to = "";
		$this->usage = null;
		$this->whatsapp = null;
