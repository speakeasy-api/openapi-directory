...
exports.VisionTraining = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var VisionTraining = /** @class */ (function () {
    function VisionTraining(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    VisionTraining.prototype.getTrainStatusAndProgress1 = function (req, config) {
    ...
    **/
    VisionTraining.prototype.retrain1 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    VisionTraining.prototype.train1 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.VisionTraining = VisionTraining;
