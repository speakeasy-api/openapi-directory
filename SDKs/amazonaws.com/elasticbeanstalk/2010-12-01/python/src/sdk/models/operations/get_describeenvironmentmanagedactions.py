...
class GetDescribeEnvironmentManagedActionsQueryParams:
    action: GetDescribeEnvironmentManagedActionsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDescribeEnvironmentManagedActionsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    ...
    status: Optional[GetDescribeEnvironmentManagedActionsStatusEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'Status', 'style': 'form', 'explode': True }})
...
class GetDescribeEnvironmentManagedActionsRequest:
    headers: GetDescribeEnvironmentManagedActionsHeaders = dataclasses.field()
    query_params: GetDescribeEnvironmentManagedActionsQueryParams = dataclasses.field()
