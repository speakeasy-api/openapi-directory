...
func (e RegisterTargetWithMaintenanceWindowXAmzTargetEnum) ToPointer() *RegisterTargetWithMaintenanceWindowXAmzTargetEnum {
	return &e
}
...
func (e *RegisterTargetWithMaintenanceWindowXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonSSM.RegisterTargetWithMaintenanceWindow":
		*e = RegisterTargetWithMaintenanceWindowXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RegisterTargetWithMaintenanceWindowXAmzTargetEnum: %v", v)
	}
}

type RegisterTargetWithMaintenanceWindowRequest struct {
	RegisterTargetWithMaintenanceWindowRequest shared.RegisterTargetWithMaintenanceWindowRequest `request:"mediaType=application/json"`
