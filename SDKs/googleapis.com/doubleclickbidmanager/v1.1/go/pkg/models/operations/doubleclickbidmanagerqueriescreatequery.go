...
type DoubleclickbidmanagerQueriesCreatequerySecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DoubleclickbidmanagerQueriesCreatequeryQueryParams struct {
	// V1 error format.
...
type DoubleclickbidmanagerQueriesCreatequeryRequest struct {
...
type DoubleclickbidmanagerQueriesCreatequeryResponse struct {
	ContentType string
	// Successful response
	Query       *shared.Query
	StatusCode  int
