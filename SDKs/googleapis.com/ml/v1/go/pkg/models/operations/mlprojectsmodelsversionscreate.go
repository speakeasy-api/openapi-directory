...
type MlProjectsModelsVersionsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type MlProjectsModelsVersionsCreatePathParams struct {
	// Required. The name of the model.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type MlProjectsModelsVersionsCreateQueryParams struct {
	// V1 error format.
...
type MlProjectsModelsVersionsCreateResponse struct {
	ContentType string
	// Successful response
