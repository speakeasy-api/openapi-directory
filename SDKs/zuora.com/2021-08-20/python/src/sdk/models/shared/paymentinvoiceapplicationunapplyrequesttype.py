...
class PaymentInvoiceApplicationUnapplyRequestType:
    ...
    r"""The amount of the payment that is unapplied from the invoice."""  
    ...
    r"""The unique ID of the invoice that the payment is unapplied from."""  
    items: Optional[list[shared_paymentinvoiceapplicationitemunapplyrequesttype.PaymentInvoiceApplicationItemUnapplyRequestType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
