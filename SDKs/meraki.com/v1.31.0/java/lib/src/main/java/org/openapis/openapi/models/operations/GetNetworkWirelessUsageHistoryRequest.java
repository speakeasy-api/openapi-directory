...
public class GetNetworkWirelessUsageHistoryRequest {
    ...
    public String apTag;
    public GetNetworkWirelessUsageHistoryRequest withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkWirelessUsageHistoryRequest withAutoResolution(Boolean autoResolution) {
    ...
    public GetNetworkWirelessUsageHistoryRequest withBand(GetNetworkWirelessUsageHistoryBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public GetNetworkWirelessUsageHistoryRequest withClientId(String clientId) {
    ...
    public GetNetworkWirelessUsageHistoryRequest withDeviceSerial(String deviceSerial) {
    ...
    public GetNetworkWirelessUsageHistoryRequest withNetworkId(String networkId) {
    ...
    public GetNetworkWirelessUsageHistoryRequest withResolution(Long resolution) {
    ...
    public Long ssid;
    public GetNetworkWirelessUsageHistoryRequest withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetNetworkWirelessUsageHistoryRequest withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetNetworkWirelessUsageHistoryRequest withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkWirelessUsageHistoryRequest withTimespan(Float timespan) {
