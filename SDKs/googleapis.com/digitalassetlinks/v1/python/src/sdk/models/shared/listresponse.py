...
class ListResponse:
    r"""Response message for the List call."""
    ...
    error_code: Optional[list[ListResponseErrorCodeEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errorCode'), 'exclude': lambda f: f is None }})
    r"""Error codes that describe the result of the List operation."""  
    ...
    r"""A list of all the matching statements that have been found."""  
