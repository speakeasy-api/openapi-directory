...
export class UpdateTextBroadcastSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class UpdateTextBroadcastRequest extends SpeakeasyBase {
  /**
...
export class UpdateTextBroadcastResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
