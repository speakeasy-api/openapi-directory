...
export class GetVariantDiseaseAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetVariantDiseaseAssociationsQueryParams extends SpeakeasyBase {
...
export class GetVariantDiseaseAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetVariantDiseaseAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
