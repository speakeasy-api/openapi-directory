...
exports.GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathResponse = exports.GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathRequest = exports.GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathSecurity = void 0;
...
var GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathRequest.prototype, "commit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=path",
        }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathRequest.prototype, "path", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q" }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathRequest.prototype, "q", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=renames",
        }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathRequest.prototype, "renames", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathRequest.prototype, "workspace", void 0);
...
var GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathResponse = /** @class */ (function (_super) {
    ...
    ], GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
