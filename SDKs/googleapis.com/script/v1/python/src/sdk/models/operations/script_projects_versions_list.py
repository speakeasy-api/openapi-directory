...
class ScriptProjectsVersionsListSecurity:
    ...
    option1: Optional[ScriptProjectsVersionsListSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[ScriptProjectsVersionsListSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class ScriptProjectsVersionsListRequest:
    ...
    r"""The maximum number of versions on each returned page. Defaults to 50."""  
