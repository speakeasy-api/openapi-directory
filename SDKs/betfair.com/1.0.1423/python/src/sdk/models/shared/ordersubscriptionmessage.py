...
import dataclasses
from ..shared import orderfilter as shared_orderfilter
...
class OrderSubscriptionMessage:
    ...
    order_filter: Optional[shared_orderfilter.OrderFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('orderFilter'), 'exclude': lambda f: f is None }})  
