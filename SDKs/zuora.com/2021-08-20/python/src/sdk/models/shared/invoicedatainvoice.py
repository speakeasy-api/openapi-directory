...
class InvoiceDataInvoice:
    ...
    **Character limit**: 29
    ...
    r"""Specifies whether the invoice includes one-time charges. You can use this field only with the `generate
    ...
    **Values**: automatically generated from one of the following: `True` (default), `False`
    ...
    r"""Specifies whether the invoice includes recurring charges. You can use this field only with the `generate
    `call for the Invoice object.
    ...
    **Values**: automatically generated from one of the following: `True` (default), `False`
    ...
    r"""Specifies whether the invoice includes usage charges. You can use this field only with the `generate
    `call for the Invoice object.
    ...
    **Values**: automatically generated
    ...
    r"""Regenerates a PDF of an invoice that was already generated. Add this field to an `update
