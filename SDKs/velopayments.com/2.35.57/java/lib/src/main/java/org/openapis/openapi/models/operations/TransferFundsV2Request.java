...
public class TransferFundsV2Request {
    ...
    public TransferFundsV2Request(@JsonProperty("TransferRequestV2") org.openapis.openapi.models.shared.TransferRequestV2 transferRequestV2, @JsonProperty("sourceAccountId") String sourceAccountId) {
        this.transferRequestV2 = transferRequestV2;
        this.sourceAccountId = sourceAccountId;
  }
}
