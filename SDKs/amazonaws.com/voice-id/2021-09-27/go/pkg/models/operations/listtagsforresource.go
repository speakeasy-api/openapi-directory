...
const (
	ListTagsForResourceXAmzTargetEnumVoiceIDListTagsForResource ListTagsForResourceXAmzTargetEnum = "VoiceID.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "VoiceID.ListTagsForResource":
