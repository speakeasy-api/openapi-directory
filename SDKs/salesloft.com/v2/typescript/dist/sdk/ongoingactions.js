...
exports.OngoingActions = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
/**
 * Ongoing Actions
 */
var OngoingActions = /** @class */ (function () {
    function OngoingActions(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
     */
    OngoingActions.prototype.postV2OngoingActionsJson = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV2OngoingActionsJsonRequestBody(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v2/ongoing_actions.json";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostV2OngoingActionsJsonResponse({
...
exports.OngoingActions = OngoingActions;
