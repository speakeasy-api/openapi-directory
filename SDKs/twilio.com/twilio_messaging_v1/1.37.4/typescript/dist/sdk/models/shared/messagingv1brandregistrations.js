...
var MessagingV1BrandRegistrations = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=a2p_profile_bundle_sid" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=brand_feedback" }),
        __metadata("design:type", Array)
    ], MessagingV1BrandRegistrations.prototype, "brandFeedback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=brand_score" }),
        __metadata("design:type", Number)
    ], MessagingV1BrandRegistrations.prototype, "brandScore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=brand_type" }),
        __metadata("design:type", String)
    ], MessagingV1BrandRegistrations.prototype, "brandType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=customer_profile_bundle_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=government_entity" }),
        __metadata("design:type", Boolean)
    ], MessagingV1BrandRegistrations.prototype, "governmentEntity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=identity_status" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=russell_3000" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=skip_automatic_sec_vet" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=tax_exempt_status" }),
        __metadata("design:type", String)
    ], MessagingV1BrandRegistrations.prototype, "taxExemptStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=tcr_id" }),
        __metadata("design:type", String)
