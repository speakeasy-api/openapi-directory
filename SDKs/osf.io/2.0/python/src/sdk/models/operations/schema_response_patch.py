...
class SchemaResponsePatchSchemaResponsesAttributesReviewsStateEnum(str, Enum):
...
class SchemaResponsePatchSchemaResponsesAttributesInput:
    ...
    reviews_state: Optional[SchemaResponsePatchSchemaResponsesAttributesReviewsStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reviews_state'), 'exclude': lambda f: f is None }})
    r"""A string that represents Schema Response state. `initial` is the state of a Schema Response on a newly registered Registration, to edit a Schema Response you must create a Schema Response Action that triggers a new submission."""  
...
class SchemaResponsePatchSchemaResponsesInput:
    ...
    attributes: SchemaResponsePatchSchemaResponsesAttributesInput = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attributes') }})
    r"""The properties of the Schema Response."""  
    type: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type identifier of the Schema Response (`schema-response`)."""  
    links: Optional[SchemaResponsePatchSchemaResponsesLinks] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('links'), 'exclude': lambda f: f is None }})
    r"""URLs to alternative representations of the Schema Response entity."""  
    relationships: Optional[SchemaResponsePatchSchemaResponsesRelationships] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('relationships'), 'exclude': lambda f: f is None }})
    r"""Links to other entities or entity collections that have a relationship to the file entity."""  
    

@dataclasses.dataclass
class SchemaResponsePatchRequest:
    
    request_body: SchemaResponsePatchSchemaResponsesInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class SchemaResponsePatchSchemaResponsesAttributes:
    ...
    r"""A bool that represents whether the Schema Response needs the current user to approve the state transition."""  
    reviews_state: Optional[SchemaResponsePatchSchemaResponsesAttributesReviewsStateEnum] = dataclasses.field(default=None)
    r"""A string that represents Schema Response state. `initial` is the state of a Schema Response on a newly registered Registration, to edit a Schema Response you must create a Schema Response Action that triggers a new submission."""  
...
class SchemaResponsePatchSchemaResponses:
    ...
    attributes: SchemaResponsePatchSchemaResponsesAttributes = dataclasses.field()
    r"""The properties of the Schema Response."""  
    type: str = dataclasses.field()
    r"""The type identifier of the Schema Response (`schema-response`)."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The unique identifier of the Schema Response."""  
    links: Optional[SchemaResponsePatchSchemaResponsesLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the Schema Response entity."""  
    relationships: Optional[SchemaResponsePatchSchemaResponsesRelationships] = dataclasses.field(default=None)
    r"""Links to other entities or entity collections that have a relationship to the file entity."""  
    

@dataclasses.dataclass
class SchemaResponsePatchResponse:
