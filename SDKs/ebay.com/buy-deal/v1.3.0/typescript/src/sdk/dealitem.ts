...
export class DealItem {
  ...
  getDealItems(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetDealItemsResponse =
        new operations.GetDealItemsResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dealItemSearchResponse = utils.objectToClass(
              httpRes?.data,
              shared.DealItemSearchResponse
            );
          }
          break;
