 ...
 */
export declare class DescribeLaunchTemplateVersionsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeLaunchTemplateVersionsRequest extends SpeakeasyBase {
    dryRun?: boolean;
