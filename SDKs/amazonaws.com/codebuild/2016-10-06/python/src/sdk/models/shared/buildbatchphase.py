...
from ..shared import buildbatchphasetype_enum as shared_buildbatchphasetype_enum
...
class BuildBatchPhase:
    ...
    phase_type: Optional[shared_buildbatchphasetype_enum.BuildBatchPhaseTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('phaseType') }})
