...
try {
    ...
    $request->addTagsToResourceRequest->resourceArn = 'error';
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\CreateHapgRequest;
use \OpenAPI\OpenAPI\Models\Shared\CreateHapgRequest;
use \OpenAPI\OpenAPI\Models\Operations\CreateHapgXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CreateHapgRequest();
    $request->createHapgRequest = new CreateHapgRequest();
    $request->createHapgRequest->label = 'suscipit';
    ...
    $request->xAmzTarget = CreateHapgXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_CREATE_HAPG;

    $response = $sdk->sdk->createHapg($request);

    if ($response->createHapgResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->createHsmRequest->clientToken = 'recusandae';
    $request->createHsmRequest->eniIp = 'temporibus';
    $request->createHsmRequest->externalId = 'ab';
    $request->createHsmRequest->iamRoleArn = 'quis';
    $request->createHsmRequest->sshKey = 'veritatis';
    $request->createHsmRequest->subnetId = 'deserunt';
    $request->createHsmRequest->subscriptionType = SubscriptionTypeEnum::PRODUCTION;
    $request->createHsmRequest->syslogIp = 'perferendis';
    ...
    $request->xAmzTarget = CreateHsmXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_CREATE_HSM;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\CreateLunaClientRequest;
use \OpenAPI\OpenAPI\Models\Shared\CreateLunaClientRequest;
use \OpenAPI\OpenAPI\Models\Operations\CreateLunaClientXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CreateLunaClientRequest();
    $request->createLunaClientRequest = new CreateLunaClientRequest();
    $request->createLunaClientRequest->certificate = 'maiores';
    $request->createLunaClientRequest->label = 'molestiae';
    ...
    $request->xAmzTarget = CreateLunaClientXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_CREATE_LUNA_CLIENT;

    $response = $sdk->sdk->createLunaClient($request);

    if ($response->createLunaClientResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DeleteHapgRequest;
use \OpenAPI\OpenAPI\Models\Shared\DeleteHapgRequest;
use \OpenAPI\OpenAPI\Models\Operations\DeleteHapgXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DeleteHapgRequest();
    $request->deleteHapgRequest = new DeleteHapgRequest();
    $request->deleteHapgRequest->hapgArn = 'nam';
    ...
    $request->xAmzTarget = DeleteHapgXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_DELETE_HAPG;

    $response = $sdk->sdk->deleteHapg($request);

    if ($response->deleteHapgResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->deleteHsmRequest->hsmArn = 'beatae';
    ...
    $request->xAmzTarget = DeleteHsmXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_DELETE_HSM;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DeleteLunaClientRequest;
use \OpenAPI\OpenAPI\Models\Shared\DeleteLunaClientRequest;
use \OpenAPI\OpenAPI\Models\Operations\DeleteLunaClientXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DeleteLunaClientRequest();
    $request->deleteLunaClientRequest = new DeleteLunaClientRequest();
    $request->deleteLunaClientRequest->clientArn = 'ipsum';
    ...
    $request->xAmzTarget = DeleteLunaClientXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_DELETE_LUNA_CLIENT;

    $response = $sdk->sdk->deleteLunaClient($request);

    if ($response->deleteLunaClientResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DescribeHapgRequest;
use \OpenAPI\OpenAPI\Models\Shared\DescribeHapgRequest;
use \OpenAPI\OpenAPI\Models\Operations\DescribeHapgXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DescribeHapgRequest();
    $request->describeHapgRequest = new DescribeHapgRequest();
    $request->describeHapgRequest->hapgArn = 'dolor';
    ...
    $request->xAmzTarget = DescribeHapgXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_DESCRIBE_HAPG;

    $response = $sdk->sdk->describeHapg($request);

    if ($response->describeHapgResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DescribeHsmRequest;
use \OpenAPI\OpenAPI\Models\Shared\DescribeHsmRequest;
use \OpenAPI\OpenAPI\Models\Operations\DescribeHsmXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DescribeHsmRequest();
    $request->describeHsmRequest = new DescribeHsmRequest();
    $request->describeHsmRequest->hsmArn = 'iste';
    $request->describeHsmRequest->hsmSerialNumber = 'iure';
    ...
    $request->xAmzTarget = DescribeHsmXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_DESCRIBE_HSM;

    $response = $sdk->sdk->describeHsm($request);

    if ($response->describeHsmResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DescribeLunaClientRequest;
use \OpenAPI\OpenAPI\Models\Shared\DescribeLunaClientRequest;
use \OpenAPI\OpenAPI\Models\Operations\DescribeLunaClientXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DescribeLunaClientRequest();
    $request->describeLunaClientRequest = new DescribeLunaClientRequest();
    $request->describeLunaClientRequest->certificateFingerprint = 'laborum';
    $request->describeLunaClientRequest->clientArn = 'dolores';
    ...
    $request->xAmzTarget = DescribeLunaClientXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_DESCRIBE_LUNA_CLIENT;

    $response = $sdk->sdk->describeLunaClient($request);

    if ($response->describeLunaClientResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\Models\Shared\GetConfigRequest;
use \OpenAPI\OpenAPI\Models\Shared\ClientVersionEnum;
use \OpenAPI\OpenAPI\Models\Operations\GetConfigXAmzTargetEnum;
...
try {
    ...
    $request->getConfigRequest = new GetConfigRequest();
    $request->getConfigRequest->clientArn = 'minima';
    $request->getConfigRequest->clientVersion = ClientVersionEnum::FIVE3;
    $request->getConfigRequest->hapgList = [
        'iure',
    ];
    ...
    $request->xAmzTarget = GetConfigXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_GET_CONFIG;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListAvailableZonesRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListAvailableZonesXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListAvailableZonesRequest();
    $request->requestBody = [
        'repellat' => 'mollitia',
    ];
    ...
    $request->xAmzTarget = ListAvailableZonesXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_LIST_AVAILABLE_ZONES;

    $response = $sdk->sdk->listAvailableZones($request);

    if ($response->listAvailableZonesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListHapgsRequest;
use \OpenAPI\OpenAPI\Models\Shared\ListHapgsRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListHapgsXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListHapgsRequest();
    $request->listHapgsRequest = new ListHapgsRequest();
    $request->listHapgsRequest->nextToken = 'quia';
    ...
    $request->xAmzTarget = ListHapgsXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_LIST_HAPGS;

    $response = $sdk->sdk->listHapgs($request);

    if ($response->listHapgsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListHsmsRequest;
use \OpenAPI\OpenAPI\Models\Shared\ListHsmsRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListHsmsXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListHsmsRequest();
    $request->listHsmsRequest = new ListHsmsRequest();
    $request->listHsmsRequest->nextToken = 'sequi';
    ...
    $request->xAmzSignedHeaders = 'error';
    $request->xAmzTarget = ListHsmsXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_LIST_HSMS;

    $response = $sdk->sdk->listHsms($request);

    if ($response->listHsmsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListLunaClientsRequest;
use \OpenAPI\OpenAPI\Models\Shared\ListLunaClientsRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListLunaClientsXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListLunaClientsRequest();
    $request->listLunaClientsRequest = new ListLunaClientsRequest();
    $request->listLunaClientsRequest->nextToken = 'temporibus';
    ...
    $request->xAmzTarget = ListLunaClientsXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_LIST_LUNA_CLIENTS;

    $response = $sdk->sdk->listLunaClients($request);

    if ($response->listLunaClientsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->listTagsForResourceRequest->resourceArn = 'voluptatibus';
    ...
    $request->xAmzTarget = ListTagsForResourceXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_LIST_TAGS_FOR_RESOURCE;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ModifyHapgRequest;
use \OpenAPI\OpenAPI\Models\Shared\ModifyHapgRequest;
use \OpenAPI\OpenAPI\Models\Operations\ModifyHapgXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ModifyHapgRequest();
    $request->modifyHapgRequest = new ModifyHapgRequest();
    $request->modifyHapgRequest->hapgArn = 'ut';
    $request->modifyHapgRequest->label = 'maiores';
    $request->modifyHapgRequest->partitionSerialList = [
        'corporis',
    ];
    ...
    $request->xAmzTarget = ModifyHapgXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_MODIFY_HAPG;

    $response = $sdk->sdk->modifyHapg($request);

    if ($response->modifyHapgResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ModifyHsmRequest;
use \OpenAPI\OpenAPI\Models\Shared\ModifyHsmRequest;
use \OpenAPI\OpenAPI\Models\Operations\ModifyHsmXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ModifyHsmRequest();
    $request->modifyHsmRequest = new ModifyHsmRequest();
    $request->modifyHsmRequest->eniIp = 'repudiandae';
    $request->modifyHsmRequest->externalId = 'quae';
    $request->modifyHsmRequest->hsmArn = 'ipsum';
    $request->modifyHsmRequest->iamRoleArn = 'quidem';
    $request->modifyHsmRequest->subnetId = 'molestias';
    $request->modifyHsmRequest->syslogIp = 'excepturi';
    ...
    $request->xAmzTarget = ModifyHsmXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_MODIFY_HSM;

    $response = $sdk->sdk->modifyHsm($request);

    if ($response->modifyHsmResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ModifyLunaClientRequest;
use \OpenAPI\OpenAPI\Models\Shared\ModifyLunaClientRequest;
use \OpenAPI\OpenAPI\Models\Operations\ModifyLunaClientXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ModifyLunaClientRequest();
    $request->modifyLunaClientRequest = new ModifyLunaClientRequest();
    $request->modifyLunaClientRequest->certificate = 'sint';
    $request->modifyLunaClientRequest->clientArn = 'veritatis';
    ...
    $request->xAmzTarget = ModifyLunaClientXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_MODIFY_LUNA_CLIENT;

    $response = $sdk->sdk->modifyLunaClient($request);

    if ($response->modifyLunaClientResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->removeTagsFromResourceRequest->resourceArn = 'deserunt';
    $request->removeTagsFromResourceRequest->tagKeyList = [
        'quibusdam',
        'labore',
        'modi',
    ];
    ...
    $request->xAmzTarget = RemoveTagsFromResourceXAmzTargetEnum::CLOUD_HSM_FRONTEND_SERVICE_REMOVE_TAGS_FROM_RESOURCE;
