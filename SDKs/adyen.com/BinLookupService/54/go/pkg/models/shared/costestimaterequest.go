...
// CostEstimateRequestShopperInteractionEnum - Specifies the sales channel, through which the shopper gives their card details, and whether the shopper is a returning customer.
...
type CostEstimateRequestShopperInteractionEnum string

const (
	CostEstimateRequestShopperInteractionEnumEcommerce CostEstimateRequestShopperInteractionEnum = "Ecommerce"
	CostEstimateRequestShopperInteractionEnumContAuth  CostEstimateRequestShopperInteractionEnum = "ContAuth"
	CostEstimateRequestShopperInteractionEnumMoto      CostEstimateRequestShopperInteractionEnum = "Moto"
...
type CostEstimateRequest struct {
	...
	// * `Moto` - Mail-order and telephone-order transactions where the shopper is in contact with the merchant via email or telephone.
	// * `POS` - Point-of-sale transactions where the shopper is physically present to make a payment using a secure payment terminal.
	ShopperInteraction *CostEstimateRequestShopperInteractionEnum `json:"shopperInteraction,omitempty"`
