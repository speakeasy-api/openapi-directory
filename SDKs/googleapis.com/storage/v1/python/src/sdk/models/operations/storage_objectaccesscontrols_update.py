...
class StorageObjectAccessControlsUpdateSecurity:
    option1: Optional[StorageObjectAccessControlsUpdateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageObjectAccessControlsUpdateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
