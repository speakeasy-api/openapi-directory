...
exports.ListCollectionsResponse = exports.ListCollectionsRequest = exports.ListCollectionsSortEnum = exports.ListCollectionsDirectionEnum = exports.ListCollectionsSecurity = void 0;
...
var ListCollectionsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListCollectionsRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], ListCollectionsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=next" }),
        __metadata("design:type", String)
    ], ListCollectionsRequest.prototype, "next", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=parent",
        }),
        __metadata("design:type", String)
    ], ListCollectionsRequest.prototype, "parent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=previous",
        }),
        __metadata("design:type", String)
    ], ListCollectionsRequest.prototype, "previous", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], ListCollectionsRequest.prototype, "sort", void 0);
