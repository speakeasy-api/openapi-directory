...
class CalendarACLInsertRequest:
    path_params: CalendarACLInsertPathParams = dataclasses.field()
    query_params: CalendarACLInsertQueryParams = dataclasses.field()
    security: CalendarACLInsertSecurity = dataclasses.field()
