...
class SharedLinksDeleteRequest:
    headers: SharedLinksDeleteHeaders = dataclasses.field()
    path_params: SharedLinksDeletePathParams = dataclasses.field()
    query_params: SharedLinksDeleteQueryParams = dataclasses.field()
    security: SharedLinksDeleteSecurity = dataclasses.field()
