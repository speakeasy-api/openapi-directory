 ...
 */
public enum UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum {
    ...
    private UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum(String value) {
        this.value = value;
    }
}
