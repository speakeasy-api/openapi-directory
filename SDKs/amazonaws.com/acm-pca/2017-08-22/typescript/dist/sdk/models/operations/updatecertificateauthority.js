...
exports.UpdateCertificateAuthorityResponse = exports.UpdateCertificateAuthorityRequest = exports.UpdateCertificateAuthorityXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var UpdateCertificateAuthorityXAmzTargetEnum;
...
})(UpdateCertificateAuthorityXAmzTargetEnum = exports.UpdateCertificateAuthorityXAmzTargetEnum || (exports.UpdateCertificateAuthorityXAmzTargetEnum = {}));
var UpdateCertificateAuthorityRequest = /** @class */ (function (_super) {
    ...
    ], UpdateCertificateAuthorityRequest.prototype, "updateCertificateAuthorityRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], UpdateCertificateAuthorityRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], UpdateCertificateAuthorityRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], UpdateCertificateAuthorityRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], UpdateCertificateAuthorityRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], UpdateCertificateAuthorityRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], UpdateCertificateAuthorityRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], UpdateCertificateAuthorityRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], UpdateCertificateAuthorityRequest.prototype, "xAmzTarget", void 0);
...
var UpdateCertificateAuthorityResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], UpdateCertificateAuthorityResponse.prototype, "rawResponse", void 0);
    return UpdateCertificateAuthorityResponse;
}(utils_1.SpeakeasyBase));
exports.UpdateCertificateAuthorityResponse = UpdateCertificateAuthorityResponse;
