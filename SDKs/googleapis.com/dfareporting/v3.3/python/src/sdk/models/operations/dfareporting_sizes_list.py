...
from ..shared import security as shared_security
from ..shared import sizeslistresponse as shared_sizeslistresponse
...
class DfareportingSizesListQueryParams:
    ...
    iab_standard: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'iabStandard', 'style': 'form', 'explode': True }})
...
class DfareportingSizesListRequest:
    path_params: DfareportingSizesListPathParams = dataclasses.field()
    query_params: DfareportingSizesListQueryParams = dataclasses.field()
    security: DfareportingSizesListSecurity = dataclasses.field()
...
class DfareportingSizesListResponse:
    ...
    sizes_list_response: Optional[shared_sizeslistresponse.SizesListResponse] = dataclasses.field(default=None)
