...
type RegistrationsForksListRegistrationAttributesCategoryEnum string

const (
	RegistrationsForksListRegistrationAttributesCategoryEnumAnalysis           RegistrationsForksListRegistrationAttributesCategoryEnum = "analysis"
	RegistrationsForksListRegistrationAttributesCategoryEnumCommunication      RegistrationsForksListRegistrationAttributesCategoryEnum = "communication"
	RegistrationsForksListRegistrationAttributesCategoryEnumData               RegistrationsForksListRegistrationAttributesCategoryEnum = "data"
	RegistrationsForksListRegistrationAttributesCategoryEnumHypothesis         RegistrationsForksListRegistrationAttributesCategoryEnum = "hypothesis"
	RegistrationsForksListRegistrationAttributesCategoryEnumInstrumentation    RegistrationsForksListRegistrationAttributesCategoryEnum = "instrumentation"
	RegistrationsForksListRegistrationAttributesCategoryEnumMethodsAndMeasures RegistrationsForksListRegistrationAttributesCategoryEnum = "methods and measures"
	RegistrationsForksListRegistrationAttributesCategoryEnumProcedure          RegistrationsForksListRegistrationAttributesCategoryEnum = "procedure"
	RegistrationsForksListRegistrationAttributesCategoryEnumProject            RegistrationsForksListRegistrationAttributesCategoryEnum = "project"
	RegistrationsForksListRegistrationAttributesCategoryEnumSoftware           RegistrationsForksListRegistrationAttributesCategoryEnum = "software"
	RegistrationsForksListRegistrationAttributesCategoryEnumOther              RegistrationsForksListRegistrationAttributesCategoryEnum = "other"
)

func (e RegistrationsForksListRegistrationAttributesCategoryEnum) ToPointer() *RegistrationsForksListRegistrationAttributesCategoryEnum {
	return &e
}

func (e *RegistrationsForksListRegistrationAttributesCategoryEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "software":
		fallthrough
	case "other":
		*e = RegistrationsForksListRegistrationAttributesCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RegistrationsForksListRegistrationAttributesCategoryEnum: %v", v)
	}
}

// RegistrationsForksListRegistrationAttributes - The properties of the registration entity.
type RegistrationsForksListRegistrationAttributes struct {
...
type RegistrationsForksListRegistrationLinks struct {
...
type RegistrationsForksListRegistrationRelationships struct {
...
type RegistrationsForksListRegistration struct {
