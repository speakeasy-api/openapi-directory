...
class ModifyEndpointMessage:
    ...
    exact_settings: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ExactSettings'), 'exclude': lambda f: f is None }})  
