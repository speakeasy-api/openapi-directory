...
class SearchTypeEsriMapserverQueryParams:
...
@dataclasses.dataclass
class SearchTypeEsriMapserverRequest:
    query_params: SearchTypeEsriMapserverQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeEsriMapserverResponse:
