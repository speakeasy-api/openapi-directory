...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityCheckRepoIsStarredByAuthenticatedUserRequest req = new ActivityCheckRepoIsStarredByAuthenticatedUserRequest("nihil", "repellat");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityDeleteRepoSubscriptionRequest req = new ActivityDeleteRepoSubscriptionRequest("quibusdam", "sed");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityDeleteThreadSubscriptionRequest req = new ActivityDeleteThreadSubscriptionRequest(904648L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityGetRepoSubscriptionRequest req = new ActivityGetRepoSubscriptionRequest("pariatur", "accusantium");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityGetThreadRequest req = new ActivityGetThreadRequest(162493L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityGetThreadSubscriptionForAuthenticatedUserRequest req = new ActivityGetThreadSubscriptionForAuthenticatedUserRequest(508315L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListEventsForAuthenticatedUserRequest req = new ActivityListEventsForAuthenticatedUserRequest("natus") {{
                page = 166847L;
                perPage = 123820L;
            }};            
    ...
    public static void main(String[] args) {
        try {
            ...
            ActivityListNotificationsForAuthenticatedUserRequest req = new ActivityListNotificationsForAuthenticatedUserRequest() {{
                all = false;
                before = OffsetDateTime.parse("2020-06-16T10:20:37.479Z");
                page = 864934L;
                participating = false;
                perPage = 807319L;
                since = OffsetDateTime.parse("2022-06-07T06:40:38.496Z");
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListOrgEventsForAuthenticatedUserRequest req = new ActivityListOrgEventsForAuthenticatedUserRequest("odit", "ea") {{
                page = 33222L;
                perPage = 69167L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListPublicEventsForRepoNetworkRequest req = new ActivityListPublicEventsForRepoNetworkRequest("ipsam", "voluptate") {{
                page = 420075L;
                perPage = 722056L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListPublicEventsForUserRequest req = new ActivityListPublicEventsForUserRequest("eaque") {{
                page = 866383L;
                perPage = 365496L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListPublicOrgEventsRequest req = new ActivityListPublicOrgEventsRequest("voluptatibus") {{
                page = 16627L;
                perPage = 855804L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListReceivedEventsForUserRequest req = new ActivityListReceivedEventsForUserRequest("amet") {{
                page = 11714L;
                perPage = 764912L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListReceivedPublicEventsForUserRequest req = new ActivityListReceivedPublicEventsForUserRequest("corporis") {{
                page = 944124L;
                perPage = 729991L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListRepoEventsRequest req = new ActivityListRepoEventsRequest("nobis", "dolores") {{
                page = 339404L;
                perPage = 521037L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListRepoNotificationsForAuthenticatedUserRequest req = new ActivityListRepoNotificationsForAuthenticatedUserRequest("dignissimos", "eaque") {{
                all = false;
                before = OffsetDateTime.parse("2022-10-20T00:01:48.775Z");
                page = 179490L;
                participating = false;
                perPage = 18521L;
                since = OffsetDateTime.parse("2022-03-17T07:12:29.048Z");
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListReposStarredByUserRequest req = new ActivityListReposStarredByUserRequest("hic") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListReposWatchedByUserRequest req = new ActivityListReposWatchedByUserRequest("voluptatem") {{
                page = 783645L;
                perPage = 164694L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListStargazersForRepoRequest req = new ActivityListStargazersForRepoRequest("blanditiis", "error") {{
                page = 50370L;
                perPage = 577229L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListWatchersForRepoRequest req = new ActivityListWatchersForRepoRequest("asperiores", "earum") {{
                page = 267262L;
                perPage = 613966L;
            }};            
    ...
    public static void main(String[] args) {
        try {
            ...
            ActivityMarkNotificationsAsReadRequestBody req = new ActivityMarkNotificationsAsReadRequestBody() {{
                lastReadAt = OffsetDateTime.parse("2021-12-05T23:42:47.745Z");
                read = false;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityMarkRepoNotificationsAsReadRequest req = new ActivityMarkRepoNotificationsAsReadRequest("pariatur", "provident") {{
                requestBody = new ActivityMarkRepoNotificationsAsReadRequestBody() {{
                    lastReadAt = OffsetDateTime.parse("2020-10-23T12:23:35.067Z");
                }};;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityMarkThreadAsReadRequest req = new ActivityMarkThreadAsReadRequest(964490L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivitySetRepoSubscriptionRequest req = new ActivitySetRepoSubscriptionRequest("quaerat", "quos") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivitySetThreadSubscriptionRequest req = new ActivitySetThreadSubscriptionRequest(398221L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityStarRepoForAuthenticatedUserRequest req = new ActivityStarRepoForAuthenticatedUserRequest("dolorem", "dolorem");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityUnstarRepoForAuthenticatedUserRequest req = new ActivityUnstarRepoForAuthenticatedUserRequest("dolor", "qui");            
