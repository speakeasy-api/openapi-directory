...
from ..shared import oauthconsentread as shared_oauthconsentread
...
class GetSourceOAuthConsentResponse:
    ...
    o_auth_consent_read: Optional[shared_oauthconsentread.OAuthConsentRead] = dataclasses.field(default=None)
