...
class GetSpacesSpaceIDFoldersAllRequest:
...
class GetSpacesSpaceIDFoldersAllResponse:
    ...
    get_spaces_space_id_folders_all_200_application_json_all_ofs: Optional[list[shared_folder.Folder]] = dataclasses.field(default=None)
    r"""A list of folders"""  
