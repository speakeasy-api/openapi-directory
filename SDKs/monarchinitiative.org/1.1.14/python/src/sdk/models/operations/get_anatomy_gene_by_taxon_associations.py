...
class GetAnatomyGeneByTaxonAssociationsRequest:
    ...
    r"""CURIE identifier of anatomical entity, e.g. GO:0005634 (nucleus), UBERON:0002037 (cerebellum), CL:0000540 (neuron). Equivalent IDs can be used with same results"""  
    taxid: str = dataclasses.field(metadata={'path_param': { 'field_name': 'taxid', 'style': 'simple', 'explode': False }})
    r"""Species or high level taxon grouping, e.g  NCBITaxon:10090 (Mus musculus)"""  
