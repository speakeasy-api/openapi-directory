...
export class EnableRegionRequestBody extends SpeakeasyBase {
  /**
...
export class EnableRegionRequest extends SpeakeasyBase {
...
export class EnableRegionResponse extends SpeakeasyBase {
  /**
