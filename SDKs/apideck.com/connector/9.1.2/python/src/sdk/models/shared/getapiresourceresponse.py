...
import dataclasses
from ..shared import apiresource as shared_apiresource
...
class GetAPIResourceResponse:
    ...
    data: shared_apiresource.APIResource = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
