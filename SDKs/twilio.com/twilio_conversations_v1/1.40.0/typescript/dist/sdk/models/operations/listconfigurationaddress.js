...
exports.ListConfigurationAddressResponse = exports.ListConfigurationAddressListConfigurationAddressResponse = exports.ListConfigurationAddressListConfigurationAddressResponseMeta = exports.ListConfigurationAddressRequest = exports.ListConfigurationAddressSecurity = exports.ListConfigurationAddressServerList = void 0;
...
var ListConfigurationAddressSecurity = /** @class */ (function (_super) {
    ...
    ], ListConfigurationAddressSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListConfigurationAddressSecurity.prototype, "username", void 0);
...
var ListConfigurationAddressRequest = /** @class */ (function (_super) {
    ...
    ], ListConfigurationAddressRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListConfigurationAddressRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListConfigurationAddressRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Type" }),
        __metadata("design:type", String)
    ], ListConfigurationAddressRequest.prototype, "type", void 0);
...
var ListConfigurationAddressListConfigurationAddressResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ConversationsV1ConfigurationAddress }),
        (0, class_transformer_1.Expose)({ name: "address_configurations" }),
        (0, class_transformer_1.Type)(function () { return shared.ConversationsV1ConfigurationAddress; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListConfigurationAddressListConfigurationAddressResponseMeta; }),
...
var ListConfigurationAddressResponse = /** @class */ (function (_super) {
    ...
    ], ListConfigurationAddressResponse.prototype, "rawResponse", void 0);
