...
class CreateServiceConversationParticipantRequest:
    headers: CreateServiceConversationParticipantHeaders = dataclasses.field()
    path_params: CreateServiceConversationParticipantPathParams = dataclasses.field()
    security: CreateServiceConversationParticipantSecurity = dataclasses.field()
    request: Optional[CreateServiceConversationParticipantCreateServiceConversationParticipantRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
