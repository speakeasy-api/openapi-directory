...
class StartConnectionResponse:
    ...
    underlay_ip_address: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('UnderlayIpAddress'), 'exclude': lambda f: f is None }})  
