...
class CloudkmsProjectsLocationsEkmConnectionsCreateRequest:
    ...
    r"""Required. The resource name of the location associated with the EkmConnection, in the format `projects/*/locations/*`."""  
    ...
    ekm_connection_input: Optional[shared_ekmconnection.EkmConnectionInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
