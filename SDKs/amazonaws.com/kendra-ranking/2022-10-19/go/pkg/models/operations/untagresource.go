...
const (
	UntagResourceXAmzTargetEnumAwsKendraRerankingFrontendServiceUntagResource UntagResourceXAmzTargetEnum = "AWSKendraRerankingFrontendService.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AWSKendraRerankingFrontendService.UntagResource":
