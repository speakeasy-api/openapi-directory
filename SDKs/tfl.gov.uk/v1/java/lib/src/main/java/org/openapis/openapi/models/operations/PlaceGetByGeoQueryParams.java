...
public class PlaceGetByGeoQueryParams {
    /**
    ...
    public PlaceGetByGeoQueryParams withActiveOnly(Boolean activeOnly) {
    ...
    public PlaceGetByGeoQueryParams withCategories(String[] categories) {
    ...
    public PlaceGetByGeoQueryParams withIncludeChildren(Boolean includeChildren) {
    ...
    public PlaceGetByGeoQueryParams withNumberOfPlacesToReturn(Integer numberOfPlacesToReturn) {
    ...
    public PlaceGetByGeoQueryParams withPlaceGeoLat(Double placeGeoLat) {
    ...
    public PlaceGetByGeoQueryParams withPlaceGeoLon(Double placeGeoLon) {
    ...
    public PlaceGetByGeoQueryParams withPlaceGeoNeLat(Double placeGeoNeLat) {
    ...
    public PlaceGetByGeoQueryParams withPlaceGeoNeLon(Double placeGeoNeLon) {
    ...
    public PlaceGetByGeoQueryParams withPlaceGeoSwLat(Double placeGeoSwLat) {
    ...
    public PlaceGetByGeoQueryParams withPlaceGeoSwLon(Double placeGeoSwLon) {
    ...
    public PlaceGetByGeoQueryParams withRadius(Double radius) {
        this.radius = radius;
        return this;
    }
    ...
    public String[] type;
    public PlaceGetByGeoQueryParams withType(String[] type) {
        this.type = type;
        return this;
    }
