...
class InstallToRemoteAccessSessionRequest:
    ...
    install_to_remote_access_session_request: shared_installtoremoteaccesssessionrequest.InstallToRemoteAccessSessionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
