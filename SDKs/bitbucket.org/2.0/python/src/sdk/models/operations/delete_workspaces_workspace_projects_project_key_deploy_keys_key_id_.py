...
class DeleteWorkspacesWorkspaceProjectsProjectKeyDeployKeysKeyIDSecurity:
...
@dataclasses.dataclass
class DeleteWorkspacesWorkspaceProjectsProjectKeyDeployKeysKeyIDResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    error: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""If the current user does not have permission to delete a key for the specified project"""  
