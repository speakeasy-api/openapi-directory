...
class ReactionsCreateForIssueRequestBody:
    content: ReactionsCreateForIssueRequestBodyContentEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('content') }})
...
class ReactionsCreateForIssueRequest:
    path_params: ReactionsCreateForIssuePathParams = dataclasses.field()
    request: Optional[ReactionsCreateForIssueRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
