...
public class GetAddressByVersionRequest {
    ...
    public GetAddressByVersionRequest(@JsonProperty("Accept") String accept, @JsonProperty("Content-Type") String contentType, @JsonProperty("addressId") String addressId, @JsonProperty("addressVersionId") String addressVersionId, @JsonProperty("profileId") String profileId, @JsonProperty("reason") String reason) {
        this.accept = accept;
        this.contentType = contentType;
        this.addressId = addressId;
        this.addressVersionId = addressVersionId;
