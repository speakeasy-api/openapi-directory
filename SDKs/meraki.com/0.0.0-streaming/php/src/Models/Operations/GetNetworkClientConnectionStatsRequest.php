...
class GetNetworkClientConnectionStatsRequest
{
    /**
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNetworkClientConnectionStatsBandEnum $band
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=band')]
    public ?GetNetworkClientConnectionStatsBandEnum $band = null;
