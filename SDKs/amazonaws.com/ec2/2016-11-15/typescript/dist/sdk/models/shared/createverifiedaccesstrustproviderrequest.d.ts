...
import { CreateVerifiedAccessTrustProviderDeviceOptions } from "./createverifiedaccesstrustproviderdeviceoptions";
import { CreateVerifiedAccessTrustProviderOidcOptions } from "./createverifiedaccesstrustprovideroidcoptions";
import { DeviceTrustProviderTypeEnum } from "./devicetrustprovidertypeenum";
import { TrustProviderTypeEnum } from "./trustprovidertypeenum";
import { UserTrustProviderTypeEnum } from "./usertrustprovidertypeenum";
/**
 * The type of resource to tag on creation.
 */
export declare enum CreateVerifiedAccessTrustProviderRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateVerifiedAccessTrustProviderRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateVerifiedAccessTrustProviderRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateVerifiedAccessTrustProviderRequest extends SpeakeasyBase {
    clientToken?: string;
    description?: string;
