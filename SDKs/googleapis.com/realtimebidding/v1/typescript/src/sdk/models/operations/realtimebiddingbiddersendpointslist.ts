...
export class RealtimebiddingBiddersEndpointsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RealtimebiddingBiddersEndpointsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RealtimebiddingBiddersEndpointsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
