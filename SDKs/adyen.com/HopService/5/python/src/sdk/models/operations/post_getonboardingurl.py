...
from ..shared import getonboardingurlresponse as shared_getonboardingurlresponse
...
class PostGetOnboardingURLResponse:
    ...
    get_onboarding_url_response: Optional[shared_getonboardingurlresponse.GetOnboardingURLResponse] = dataclasses.field(default=None)
