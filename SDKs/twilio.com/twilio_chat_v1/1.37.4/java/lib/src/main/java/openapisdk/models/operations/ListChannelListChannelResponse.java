...
public class ListChannelListChannelResponse {
    ...
    public openapisdk.models.shared.ChatV1ServiceChannel[] channels;
    public ListChannelListChannelResponse withChannels(openapisdk.models.shared.ChatV1ServiceChannel[] channels) {
