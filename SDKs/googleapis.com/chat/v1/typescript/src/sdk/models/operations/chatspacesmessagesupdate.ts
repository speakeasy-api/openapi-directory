...
export class ChatSpacesMessagesUpdateSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ChatSpacesMessagesUpdateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ChatSpacesMessagesUpdateSecurity extends SpeakeasyBase {
...
export class ChatSpacesMessagesUpdateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ChatSpacesMessagesUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
