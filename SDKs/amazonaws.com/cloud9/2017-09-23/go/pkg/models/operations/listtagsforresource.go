...
const (
	ListTagsForResourceXAmzTargetEnumAwsCloud9WorkspaceManagementServiceListTagsForResource ListTagsForResourceXAmzTargetEnum = "AWSCloud9WorkspaceManagementService.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AWSCloud9WorkspaceManagementService.ListTagsForResource":
