...
import dataclasses
from ..shared import estimatedetailsvo as shared_estimatedetailsvo
...
class EstimateExpandVO:
    r"""Java type: com.noosh.nooshapi.vo.EstimateExpandVO"""
    
    result: Optional[shared_estimatedetailsvo.EstimateDetailsVO] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})
