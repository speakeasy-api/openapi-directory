...
class GetPhenotypePathwayAssociationsRequest:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""Pheno class CURIE identifier, e.g  MP:0001569 (abnormal circulating bilirubin level)"""  
...
@dataclasses.dataclass
class GetPhenotypePathwayAssociationsResponse:
