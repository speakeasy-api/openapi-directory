 ...
 */
export declare class DescribeTransitGatewayRouteTableAnnouncementsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTransitGatewayRouteTableAnnouncementsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeTransitGatewayRouteTableAnnouncementsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
