...
public class GetQuestionsNoAnswersRequest {
    ...
    public GetQuestionsNoAnswersRequest withCallback(String callback) {
    ...
    public GetQuestionsNoAnswersRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetQuestionsNoAnswersRequest withFromdate(Long fromdate) {
    ...
    public GetQuestionsNoAnswersRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetQuestionsNoAnswersRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetQuestionsNoAnswersRequest withOrder(GetQuestionsNoAnswersOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetQuestionsNoAnswersRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetQuestionsNoAnswersRequest withPagesize(Long pagesize) {
    ...
    public GetQuestionsNoAnswersRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetQuestionsNoAnswersRequest withSort(GetQuestionsNoAnswersSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetQuestionsNoAnswersRequest withTagged(String tagged) {
        this.tagged = tagged;
        return this;
    }
    ...
    public GetQuestionsNoAnswersRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetQuestionsNoAnswersRequest(@JsonProperty("site") String site) {
        this.site = site;
  }
}
