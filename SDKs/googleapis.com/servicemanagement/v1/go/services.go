...
func (s *services) ServicemanagementServicesCreate(ctx context.Context, request operations.ServicemanagementServicesCreateRequest, security operations.ServicemanagementServicesCreateSecurity) (*operations.ServicemanagementServicesCreateResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v1/services"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ManagedService", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
...
func (s *services) ServicemanagementServicesGenerateConfigReport(ctx context.Context, request operations.ServicemanagementServicesGenerateConfigReportRequest, security operations.ServicemanagementServicesGenerateConfigReportSecurity) (*operations.ServicemanagementServicesGenerateConfigReportResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v1/services:generateConfigReport"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GenerateConfigReportRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
...
func (s *services) ServicemanagementServicesList(ctx context.Context, request operations.ServicemanagementServicesListRequest, security operations.ServicemanagementServicesListSecurity) (*operations.ServicemanagementServicesListResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v1/services"
