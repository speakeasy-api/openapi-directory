...
exports.GetCandidateCandidateIdTotalsResponse = exports.GetCandidateCandidateIdTotalsRequest = void 0;
...
var GetCandidateCandidateIdTotalsRequest = /** @class */ (function (_super) {
    ...
    ], GetCandidateCandidateIdTotalsRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=candidate_id",
        }),
        __metadata("design:type", String)
    ], GetCandidateCandidateIdTotalsRequest.prototype, "candidateId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=cycle" }),
        __metadata("design:type", Array)
    ], GetCandidateCandidateIdTotalsRequest.prototype, "cycle", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=election_full",
        }),
        __metadata("design:type", Boolean)
    ], GetCandidateCandidateIdTotalsRequest.prototype, "electionFull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetCandidateCandidateIdTotalsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetCandidateCandidateIdTotalsRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetCandidateCandidateIdTotalsRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_hide_null",
        }),
        __metadata("design:type", Boolean)
    ], GetCandidateCandidateIdTotalsRequest.prototype, "sortHideNull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_null_only",
        }),
        __metadata("design:type", Boolean)
    ], GetCandidateCandidateIdTotalsRequest.prototype, "sortNullOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_nulls_last",
        }),
        __metadata("design:type", Boolean)
    ], GetCandidateCandidateIdTotalsRequest.prototype, "sortNullsLast", void 0);
...
var GetCandidateCandidateIdTotalsResponse = /** @class */ (function (_super) {
    ...
    ], GetCandidateCandidateIdTotalsResponse.prototype, "rawResponse", void 0);
