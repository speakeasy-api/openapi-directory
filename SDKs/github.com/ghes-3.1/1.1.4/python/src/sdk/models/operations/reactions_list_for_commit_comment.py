...
class ReactionsListForCommitCommentPathParams:
...
@dataclasses.dataclass
class ReactionsListForCommitCommentQueryParams:
...
class ReactionsListForCommitCommentRequest:
    path_params: ReactionsListForCommitCommentPathParams = dataclasses.field()
    query_params: ReactionsListForCommitCommentQueryParams = dataclasses.field()
