...
public class WebinarUpdateApplicationJSONSettingsFollowUpAbsenteesEmailNotification {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    public WebinarUpdateApplicationJSONSettingsFollowUpAbsenteesEmailNotificationTypeEnum type;
    public WebinarUpdateApplicationJSONSettingsFollowUpAbsenteesEmailNotification withType(WebinarUpdateApplicationJSONSettingsFollowUpAbsenteesEmailNotificationTypeEnum type) {
        this.type = type;
        return this;
    }
