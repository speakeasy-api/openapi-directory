...
class DriveDrivesGetSecurity:
    option1: Optional[DriveDrivesGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DriveDrivesGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DriveDrivesGetRequest:
    path_params: DriveDrivesGetPathParams = dataclasses.field()
    query_params: DriveDrivesGetQueryParams = dataclasses.field()
    security: DriveDrivesGetSecurity = dataclasses.field()
