...
func (e PostBusinessGroupsIDSpacesSpaceIDLegalEntitiesPersonIDCustomersFolderIDSpacesRequestBodyTypeEnum) ToPointer() *PostBusinessGroupsIDSpacesSpaceIDLegalEntitiesPersonIDCustomersFolderIDSpacesRequestBodyTypeEnum {
	return &e
}
...
func (e *PostBusinessGroupsIDSpacesSpaceIDLegalEntitiesPersonIDCustomersFolderIDSpacesRequestBodyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "company":
		fallthrough
	case "association":
		*e = PostBusinessGroupsIDSpacesSpaceIDLegalEntitiesPersonIDCustomersFolderIDSpacesRequestBodyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostBusinessGroupsIDSpacesSpaceIDLegalEntitiesPersonIDCustomersFolderIDSpacesRequestBodyTypeEnum: %v", v)
	}
}
