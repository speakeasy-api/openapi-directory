...
var Teams = /** @class */ (function () {
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#add-team-member-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#add-or-update-team-membership-for-a-user} - API method documentation
     */
     ...
     * If the user is already a member of the team, this endpoint will update the role of the team member's role. To update the membership of a team member, the authenticated user must be an organization owner or a team maintainer.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#add-or-update-team-membership-for-a-user-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#add-or-update-team-project-permissions} - API method documentation
     */
     ...
     * Adds an organization project to a team. To add a project to a team or update the team's permission on a project, the authenticated user must have `admin` permissions for the project. The project and team must be part of the same organization.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#add-or-update-team-project-permissions-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#add-or-update-team-repository-permissions} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#add-or-update-team-repository-permissions-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#check-team-permissions-for-a-project} - API method documentation
     */
     ...
     * Checks whether a team has `read`, `write`, or `admin` permissions for an organization project. The response includes projects inherited from a parent team.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#check-team-permissions-for-a-project-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#check-team-permissions-for-a-repository} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#check-team-permissions-for-a-repository-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#create-a-team} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#create-a-discussion-comment} - API method documentation
     */
     ...
     * This endpoint triggers [notifications](https://docs.github.com/enterprise-cloud@latest//github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. See "[Secondary rate limits](https://docs.github.com/enterprise-cloud@latest//rest/overview/resources-in-the-rest-api#secondary-rate-limits)" and "[Dealing with secondary rate limits](https://docs.github.com/enterprise-cloud@latest//rest/guides/best-practices-for-integrators#dealing-with-secondary-rate-limits)" for details.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#create-a-discussion-comment-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#create-a-discussion} - API method documentation
     */
     ...
     * This endpoint triggers [notifications](https://docs.github.com/enterprise-cloud@latest//github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. See "[Secondary rate limits](https://docs.github.com/enterprise-cloud@latest//rest/overview/resources-in-the-rest-api#secondary-rate-limits)" and "[Dealing with secondary rate limits](https://docs.github.com/enterprise-cloud@latest//rest/guides/best-practices-for-integrators#dealing-with-secondary-rate-limits)" for details.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#create-a-discussion-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#create-or-update-idp-group-connections} - API method documentation
     */
    Teams.prototype.teamsCreateOrUpdateIdpGroupConnectionsInOrg = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TeamsCreateOrUpdateIdpGroupConnectionsInOrgRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/orgs/{org}/teams/{team_slug}/team-sync/group-mappings", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "requestBody", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TeamsCreateOrUpdateIdpGroupConnectionsInOrgResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.groupMapping = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GroupMapping);
                    }
                    break;
            }
            return res;
     ...
     * Creates, updates, or removes a connection between a team and an IdP group. When adding groups to a team, you must include all new and existing groups to avoid replacing existing groups with the new ones. Specifying an empty `groups` array will remove all connections for a team.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#create-or-update-idp-group-connections-legacy} - API method documentation
     */
    Teams.prototype.teamsCreateOrUpdateIdpGroupConnectionsLegacy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TeamsCreateOrUpdateIdpGroupConnectionsLegacyRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/teams/{team_id}/team-sync/group-mappings", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "requestBody", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TeamsCreateOrUpdateIdpGroupConnectionsLegacyResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#delete-a-discussion-comment} - API method documentation
     */
     ...
     * Deletes a comment on a team discussion. OAuth access tokens require the `write:discussion` [scope](https://docs.github.com/enterprise-cloud@latest//apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#delete-a-discussion-comment-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#delete-a-discussion} - API method documentation
     */
     ...
     * Delete a discussion from a team's page. OAuth access tokens require the `write:discussion` [scope](https://docs.github.com/enterprise-cloud@latest//apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#delete-a-discussion-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#delete-a-team} - API method documentation
     */
     ...
     * If you are an organization owner, deleting a parent team will delete all of its child teams as well.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#delete-a-team-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#external-idp-group-info-for-an-organization} - API method documentation
     */
    Teams.prototype.teamsExternalIdpGroupInfoForOrg = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TeamsExternalIdpGroupInfoForOrgRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/orgs/{org}/external-group/{group_id}", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TeamsExternalIdpGroupInfoForOrgResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.externalGroup = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ExternalGroup);
                    }
                    break;
            }
            return res;
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#get-a-team-by-name} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#get-a-discussion-comment} - API method documentation
     */
     ...
     * Get a specific comment on a team discussion. OAuth access tokens require the `read:discussion` [scope](https://docs.github.com/enterprise-cloud@latest//apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#get-a-discussion-comment-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#get-a-discussion} - API method documentation
     */
     ...
     * Get a specific discussion on a team's page. OAuth access tokens require the `read:discussion` [scope](https://docs.github.com/enterprise-cloud@latest//apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#get-a-discussion-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#get-a-team-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#get-team-member-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#get-team-membership-for-a-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#get-team-membership-for-a-user-legacy} - API method documentation
     */
     ...
     * You can manage team membership with your identity provider using Enterprise Managed Users for GitHub Enterprise Cloud. For more information, see "[GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products)" in the GitHub Help documentation.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#link-external-idp-group-team-connection} - API method documentation
     */
    Teams.prototype.teamsLinkExternalIdpGroupToTeamForOrg = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TeamsLinkExternalIdpGroupToTeamForOrgRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/orgs/{org}/teams/{team_slug}/external-groups", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "requestBody", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TeamsLinkExternalIdpGroupToTeamForOrgResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-teams} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-child-teams} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#list-child-teams-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-discussion-comments} - API method documentation
     */
     ...
     * List all comments on a team discussion. OAuth access tokens require the `read:discussion` [scope](https://docs.github.com/enterprise-cloud@latest//apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-discussion-comments-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-discussions} - API method documentation
     */
     ...
     * List all discussions on a team's page. OAuth access tokens require the `read:discussion` [scope](https://docs.github.com/enterprise-cloud@latest//apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-discussions-legacy} - API method documentation
     */
     ...
     * You can manage team membership with your identity provider using Enterprise Managed Users for GitHub Enterprise Cloud. For more information, see "[GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products)" in the GitHub Help documentation.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-external-idp-groups-for-an-organization} - API method documentation
     */
    Teams.prototype.teamsListExternalIdpGroupsForOrg = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TeamsListExternalIdpGroupsForOrgRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/orgs/{org}/external-groups", req);
        var client = this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TeamsListExternalIdpGroupsForOrgResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
                headers: utils.getHeadersFromResponse(httpRes.headers),
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.externalGroups = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ExternalGroups);
                    }
                    break;
            }
            return res;
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-teams-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-idp-groups-for-a-team-legacy} - API method documentation
     */
    Teams.prototype.teamsListIdpGroupsForLegacy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TeamsListIdpGroupsForLegacyResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-idp-groups-for-an-organization} - API method documentation
     */
    Teams.prototype.teamsListIdpGroupsForOrg = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TeamsListIdpGroupsForOrgRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/orgs/{org}/team-sync/groups", req);
        var client = this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TeamsListIdpGroupsForOrgResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
                headers: utils.getHeadersFromResponse(httpRes.headers),
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-idp-groups-for-a-team} - API method documentation
     */
    Teams.prototype.teamsListIdpGroupsInOrg = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TeamsListIdpGroupsInOrgResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     * You can manage team membership with your identity provider using Enterprise Managed Users for GitHub Enterprise Cloud. For more information, see "[GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products)" in the GitHub Help documentation.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-external-idp-group-team-connection} - API method documentation
     */
    Teams.prototype.teamsListLinkedExternalIdpGroupsToTeamForOrg = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TeamsListLinkedExternalIdpGroupsToTeamForOrgRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/orgs/{org}/teams/{team_slug}/external-groups", req);
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TeamsListLinkedExternalIdpGroupsToTeamForOrgResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     * To list members in a team, the team must be visible to the authenticated user.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-team-members} - API method documentation
     */
     ...
     * Team members will include the members of child teams.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-team-members-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-pending-team-invitations} - API method documentation
     */
    Teams.prototype.teamsListPendingInvitationsInOrg = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TeamsListPendingInvitationsInOrgRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/orgs/{org}/teams/{team_slug}/invitations", req);
        var client = this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TeamsListPendingInvitationsInOrgResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
                headers: utils.getHeadersFromResponse(httpRes.headers),
     ...
     * The return hash contains a `role` field which refers to the Organization Invitation role and will be one of the following values: `direct_member`, `admin`, `billing_manager`, `hiring_manager`, or `reinstate`. If the invitee is not a GitHub Enterprise Cloud member, the `login` field in the return hash will be `null`.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-pending-team-invitations-legacy} - API method documentation
     */
    Teams.prototype.teamsListPendingInvitationsLegacy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TeamsListPendingInvitationsLegacyRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/teams/{team_id}/invitations", req);
        var client = this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TeamsListPendingInvitationsLegacyResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
                headers: utils.getHeadersFromResponse(httpRes.headers),
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-team-projects} - API method documentation
     */
     ...
     * Lists the organization projects for a team.
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#list-team-projects-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#list-team-repositories} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#list-team-repositories-legacy} - API method documentation
     */
     ...
     * **Note:** When you have team synchronization set up for a team with your organization's identity provider (IdP), you will see an error if you attempt to use the API for making changes to the team's membership. If you have access to manage group membership in your IdP, you can manage GitHub Enterprise Cloud team membership through your identity provider, which automatically adds and removes team members in an organization. For more information, see "[Synchronizing teams between your identity provider and GitHub Enterprise Cloud](https://docs.github.com/enterprise-cloud@latest//articles/synchronizing-teams-between-your-identity-provider-and-github/)."
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#remove-team-member-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#remove-team-membership-for-a-user} - API method documentation
     */
     ...
     * **Note:** When you have team synchronization set up for a team with your organization's identity provider (IdP), you will see an error if you attempt to use the API for making changes to the team's membership. If you have access to manage group membership in your IdP, you can manage GitHub Enterprise Cloud team membership through your identity provider, which automatically adds and removes team members in an organization. For more information, see "[Synchronizing teams between your identity provider and GitHub Enterprise Cloud](https://docs.github.com/enterprise-cloud@latest//articles/synchronizing-teams-between-your-identity-provider-and-github/)."
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#remove-team-membership-for-a-user-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#remove-a-project-from-a-team} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#remove-a-project-from-a-team-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#remove-a-repository-from-a-team} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#remove-a-repository-from-a-team-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#unlink-external-idp-group-team-connection} - API method documentation
     */
    Teams.prototype.teamsUnlinkExternalIdpGroupFromTeamForOrg = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TeamsUnlinkExternalIdpGroupFromTeamForOrgRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/orgs/{org}/teams/{team_slug}/external-groups", req);
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TeamsUnlinkExternalIdpGroupFromTeamForOrgResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#update-a-discussion-comment} - API method documentation
     */
     ...
     * Edits the body text of a discussion comment. OAuth access tokens require the `write:discussion` [scope](https://docs.github.com/enterprise-cloud@latest//apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#update-a-discussion-comment-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#update-a-discussion} - API method documentation
     */
     ...
     * Edits the title and body text of a discussion post. Only the parameters you provide are updated. OAuth access tokens require the `write:discussion` [scope](https://docs.github.com/enterprise-cloud@latest//apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#update-a-discussion-legacy} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams#update-a-team} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-cloud@latest//rest/reference/teams/#update-a-team-legacy} - API method documentation
     */
