...
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#create-a-blob>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#create-a-commit>
    ...
    res, err := s.Git.GitCreateCommit(ctx, operations.GitCreateCommitRequest{
        RequestBody: operations.GitCreateCommitRequestBody{
            Author: &operations.GitCreateCommitRequestBodyAuthor{
                Date: types.MustTimeFromString("2022-09-01T18:00:27.481Z"),
                Email: "Meta_Kemmer@gmail.com",
                Name: "Annette Bernier",
            },
            Committer: &operations.GitCreateCommitRequestBodyCommitter{
                Date: types.MustTimeFromString("2021-11-01T18:57:38.460Z"),
                Email: sdk.String("Carolanne_Barrows@hotmail.com"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#create-a-reference>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#create-a-tag-object>
    ...
    res, err := s.Git.GitCreateTag(ctx, operations.GitCreateTagRequest{
        RequestBody: operations.GitCreateTagRequestBody{
            ...
            Tagger: &operations.GitCreateTagRequestBodyTagger{
                Date: types.MustTimeFromString("2022-11-13T20:31:38.306Z"),
                Email: "Cole.Parker@yahoo.com",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#create-a-tree>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#delete-a-reference>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#get-a-blob>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#get-a-commit>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#get-a-reference>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#get-a-tag>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#get-a-tree>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#list-matching-references>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/git#update-a-reference>
