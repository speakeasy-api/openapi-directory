...
export class SNMPSettings {
  ...
  getNetworkSnmpSettings(
    req: operations.GetNetworkSnmpSettingsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetNetworkSnmpSettingsResponse> {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetNetworkSnmpSettingsResponse =
        new operations.GetNetworkSnmpSettingsResponse({
