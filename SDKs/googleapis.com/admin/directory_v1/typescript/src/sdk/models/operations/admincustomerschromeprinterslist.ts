...
export class AdminCustomersChromePrintersListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdminCustomersChromePrintersListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class AdminCustomersChromePrintersListSecurity extends SpeakeasyBase {
...
export class AdminCustomersChromePrintersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdminCustomersChromePrintersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
