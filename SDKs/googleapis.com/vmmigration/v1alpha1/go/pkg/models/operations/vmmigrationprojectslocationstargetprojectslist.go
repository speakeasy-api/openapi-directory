...
type VmmigrationProjectsLocationsTargetProjectsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type VmmigrationProjectsLocationsTargetProjectsListPathParams struct {
	// Required. The parent, which owns this collection of targets.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type VmmigrationProjectsLocationsTargetProjectsListQueryParams struct {
	// V1 error format.
...
type VmmigrationProjectsLocationsTargetProjectsListRequest struct {
...
type VmmigrationProjectsLocationsTargetProjectsListResponse struct {
	ContentType string
	// Successful response
