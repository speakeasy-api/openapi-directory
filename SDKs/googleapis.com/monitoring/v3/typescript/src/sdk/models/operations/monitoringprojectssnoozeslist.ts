...
export class MonitoringProjectsSnoozesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MonitoringProjectsSnoozesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class MonitoringProjectsSnoozesListSecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class MonitoringProjectsSnoozesListSecurity extends SpeakeasyBase {
...
export class MonitoringProjectsSnoozesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MonitoringProjectsSnoozesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
