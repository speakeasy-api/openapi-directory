...
class ListMarketplaceInstalledAddOnListMarketplaceInstalledAddOnResponse:
    ...
    installed_add_ons: Optional[list[shared_preview_marketplace_installed_add_on.PreviewMarketplaceInstalledAddOn]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('installed_add_ons'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListMarketplaceInstalledAddOnListMarketplaceInstalledAddOnResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
