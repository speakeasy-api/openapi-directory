...
class BaremetalsolutionProjectsLocationsProvisioningConfigsSubmitRequest:
    ...
    r"""Required. The parent project and location containing the ProvisioningConfig."""  
    ...
    submit_provisioning_config_request_input: Optional[shared_submitprovisioningconfigrequest.SubmitProvisioningConfigRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
