...
func (s *SDK) PutItems(ctx context.Context, request operations.PutItemsRequest) (*operations.PutItemsResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PutItemsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) PutUsers(ctx context.Context, request operations.PutUsersRequest) (*operations.PutUsersResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PutUsersResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
