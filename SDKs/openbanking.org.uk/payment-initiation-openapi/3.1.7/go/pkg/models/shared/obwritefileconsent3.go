...
func (e OBWriteFileConsent3DataAuthorisationAuthorisationTypeEnum) ToPointer() *OBWriteFileConsent3DataAuthorisationAuthorisationTypeEnum {
	return &e
}
...
func (e *OBWriteFileConsent3DataAuthorisationAuthorisationTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Any":
		fallthrough
	case "Single":
		*e = OBWriteFileConsent3DataAuthorisationAuthorisationTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for OBWriteFileConsent3DataAuthorisationAuthorisationTypeEnum: %v", v)
	}
}
