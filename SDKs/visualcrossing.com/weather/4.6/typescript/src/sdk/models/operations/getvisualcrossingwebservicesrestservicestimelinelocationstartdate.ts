...
export const GetVisualCrossingWebServicesRestServicesTimelineLocationStartdateServerList =
  ["https://weather.visualcrossing.com"] as const;

export class GetVisualCrossingWebServicesRestServicesTimelineLocationStartdateRequest extends SpeakeasyBase {
  /**
...
export class GetVisualCrossingWebServicesRestServicesTimelineLocationStartdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
