...
var WorkflowRunStatistics = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=FailedActions" }),
        __metadata("design:type", Number)
    ], WorkflowRunStatistics.prototype, "failedActions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=RunningActions" }),
        __metadata("design:type", Number)
    ], WorkflowRunStatistics.prototype, "runningActions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=StoppedActions" }),
        __metadata("design:type", Number)
    ], WorkflowRunStatistics.prototype, "stoppedActions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SucceededActions" }),
        __metadata("design:type", Number)
    ], WorkflowRunStatistics.prototype, "succeededActions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TimeoutActions" }),
        __metadata("design:type", Number)
    ], WorkflowRunStatistics.prototype, "timeoutActions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TotalActions" }),
        __metadata("design:type", Number)
