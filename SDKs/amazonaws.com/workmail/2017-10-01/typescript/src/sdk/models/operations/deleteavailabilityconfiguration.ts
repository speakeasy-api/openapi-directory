...
export enum DeleteAvailabilityConfigurationXAmzTargetEnum {
  WorkMailServiceDeleteAvailabilityConfiguration = "WorkMailService.DeleteAvailabilityConfiguration",
}

export class DeleteAvailabilityConfigurationRequest extends SpeakeasyBase {
...
export class DeleteAvailabilityConfigurationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
