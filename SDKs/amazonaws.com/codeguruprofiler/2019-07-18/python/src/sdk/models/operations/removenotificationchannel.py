...
from ..shared import removenotificationchannelresponse as shared_removenotificationchannelresponse
...
class RemoveNotificationChannelResponse:
    ...
    remove_notification_channel_response: Optional[shared_removenotificationchannelresponse.RemoveNotificationChannelResponse] = dataclasses.field(default=None)
