...
class FeatureIdProto
{
     ...
     * @var ?string $cellId
     */
	#[\JMS\Serializer\Annotation\SerializedName('cellId')]
     ...
     * @var ?string $fprint
     */
	#[\JMS\Serializer\Annotation\SerializedName('fprint')]
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $fprint = null;
    
    /**
     * This is proto2's version of MessageSet.
     * 
     * @var ?array<string, mixed> $temporaryData
     */
	#[\JMS\Serializer\Annotation\SerializedName('temporaryData')]
    #[\JMS\Serializer\Annotation\Type('array<string, mixed>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?array $temporaryData = null;
