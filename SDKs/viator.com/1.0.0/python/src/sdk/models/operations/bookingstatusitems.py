...
class BookingStatusItemsRequestBody:
    ...
    r"""**earliest date** for when the booking(s) in question were made (must be in the future)"""  
    ...
    r"""**latest date** for when the booking(s) in question were made (must be in the future)"""  
    ...
    r"""**array** of booking-reference numbers to check
...
class BookingStatusItemsRequest:
    ...
    request_body: Optional[BookingStatusItemsRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class BookingStatusItems200ApplicationJSON:
    ...
    data: Optional[list[BookingStatusItems200ApplicationJSONData]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""**array** containing item ids and their associated booking status object"""  
