...
class GETDescribeConversionTasksRequest:
    ...
    action: GETDescribeConversionTasksActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    version: GETDescribeConversionTasksVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
    conversion_task_id: Optional[list[str]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'ConversionTaskId', 'style': 'form', 'explode': True }})
    r"""The conversion task IDs."""  
