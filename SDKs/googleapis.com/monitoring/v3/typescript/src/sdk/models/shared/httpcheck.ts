...
export class HttpCheck extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: ResponseStatusCode })
  @Expose({ name: "acceptedResponseStatusCodes" })
