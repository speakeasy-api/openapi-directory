...
export class GetDiseaseModelTaxonAssociationsPathParams extends SpeakeasyBase {
...
export class GetDiseaseModelTaxonAssociationsQueryParams extends SpeakeasyBase {
...
export class GetDiseaseModelTaxonAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetDiseaseModelTaxonAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
