...
export class PaymentTransactionLogs {
  ...
  objectGETPaymentTransactionLog(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ObjectGETPaymentTransactionLogResponse =
        new operations.ObjectGETPaymentTransactionLogResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.proxyGetPaymentTransactionLog = utils.objectToClass(
              httpRes?.data,
              shared.ProxyGetPaymentTransactionLog
            );
          }
          break;
