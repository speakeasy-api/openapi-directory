...
exports.ScheduleMesages = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ScheduleMesages = /** @class */ (function () {
    function ScheduleMesages(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * ```
    **/
    ScheduleMesages.prototype.getUpcomingScheduledCampaignsAndCanvases = function (req, config) {
    ...
    **/
    ScheduleMesages.prototype.scheduleApiTriggeredCanvases = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.ScheduleMesages = ScheduleMesages;
