...
import dataclasses
from ..shared import diskimage as shared_diskimage
from enum import Enum
from typing import Optional

class ImportInstanceRequestLaunchSpecificationArchitectureEnum(str, Enum):
    r"""The architecture of the instance."""
    I386 = 'i386'
    X86_64 = 'x86_64'
    ARM64 = 'arm64'
...
class ImportInstanceRequestLaunchSpecificationInstanceInitiatedShutdownBehaviorEnum(str, Enum):
...
class ImportInstanceRequestLaunchSpecificationInstanceTypeEnum(str, Enum):
    r"""The instance type. For more information about the instance types that you can import, see <a href=\\"https://docs.aws.amazon.com/vm-import/latest/userguide/vmie_prereqs.html#vmimport-instance-types\\">Instance Types</a> in the VM Import/Export User Guide."""
    A1_MEDIUM = 'a1.medium'
    A1_LARGE = 'a1.large'
    A1_XLARGE = 'a1.xlarge'
...
class ImportInstanceRequestLaunchSpecificationPlacementTenancyEnum(str, Enum):
...
class ImportInstanceRequestLaunchSpecificationPlacement:
    ...
    tenancy: Optional[ImportInstanceRequestLaunchSpecificationPlacementTenancyEnum] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class ImportInstanceRequestLaunchSpecificationUserData:
    r"""The Base64-encoded user data to make available to the instance."""
...
class ImportInstanceRequestLaunchSpecification:
    r"""The launch specification."""
    
    additional_info: Optional[str] = dataclasses.field(default=None)  
    architecture: Optional[ImportInstanceRequestLaunchSpecificationArchitectureEnum] = dataclasses.field(default=None)  
    group_ids: Optional[list[str]] = dataclasses.field(default=None)  
    group_names: Optional[list[str]] = dataclasses.field(default=None)  
    instance_initiated_shutdown_behavior: Optional[ImportInstanceRequestLaunchSpecificationInstanceInitiatedShutdownBehaviorEnum] = dataclasses.field(default=None)  
    instance_type: Optional[ImportInstanceRequestLaunchSpecificationInstanceTypeEnum] = dataclasses.field(default=None)  
    monitoring: Optional[bool] = dataclasses.field(default=None)  
    placement: Optional[ImportInstanceRequestLaunchSpecificationPlacement] = dataclasses.field(default=None)  
    private_ip_address: Optional[str] = dataclasses.field(default=None)  
    subnet_id: Optional[str] = dataclasses.field(default=None)  
    user_data: Optional[ImportInstanceRequestLaunchSpecificationUserData] = dataclasses.field(default=None)  
    
class ImportInstanceRequestPlatformEnum(str, Enum):
...
class ImportInstanceRequest:
    ...
    platform: ImportInstanceRequestPlatformEnum = dataclasses.field()  
    description: Optional[str] = dataclasses.field(default=None)  
    disk_images: Optional[list[shared_diskimage.DiskImage]] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    launch_specification: Optional[ImportInstanceRequestLaunchSpecification] = dataclasses.field(default=None)  
