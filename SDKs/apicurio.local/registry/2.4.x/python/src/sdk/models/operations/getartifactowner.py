...
from ..shared import artifactowner as shared_artifactowner
from ..shared import error as shared_error
from typing import Optional


@dataclasses.dataclass
class GetArtifactOwnerRequest:
...
@dataclasses.dataclass
class GetArtifactOwnerResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    artifact_owner: Optional[shared_artifactowner.ArtifactOwner] = dataclasses.field(default=None)
    r"""The artifact's owner."""  
