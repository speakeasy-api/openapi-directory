...
func (e InvoiceUpdateAPIModelStatusEnum) ToPointer() *InvoiceUpdateAPIModelStatusEnum {
	return &e
}

func (e *InvoiceUpdateAPIModelStatusEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "Overdue":
		fallthrough
	case "Void":
		*e = InvoiceUpdateAPIModelStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for InvoiceUpdateAPIModelStatusEnum: %v", v)
	}
}

type InvoiceUpdateAPIModel struct {
	// List of invoice attachments
	Attachments []InvoiceUpdateAttachmentAPIModel `json:"Attachments,omitempty" form:"name=Attachments,json"`
	...
	Items []InvoiceUpdateItemAPIModel `json:"Items,omitempty" form:"name=Items,json"`
	...
	Status *InvoiceUpdateAPIModelStatusEnum `json:"Status,omitempty" form:"name=Status"`
	// Terms of agreement
