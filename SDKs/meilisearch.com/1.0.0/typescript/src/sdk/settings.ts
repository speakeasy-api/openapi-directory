...
export class Settings {
  ...
  getAllSettings(
    ...
    const url: string = baseURL.replace(/\/$/, "") + "/indexes/books/settings";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetAllSettingsResponse =
        new operations.GetAllSettingsResponse({
  ...
  resetAllSettings(
    config?: AxiosRequestConfig
  ): Promise<operations.ResetAllSettingsResponse> {
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/indexes/books/settings";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ResetAllSettingsResponse =
        new operations.ResetAllSettingsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
   ...
   */
  updateSettings(
    req: operations.UpdateSettingsRequestBody,
    config?: AxiosRequestConfig
