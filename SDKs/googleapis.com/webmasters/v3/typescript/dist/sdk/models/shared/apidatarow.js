...
var ApiDataRow = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ctr" }),
        __metadata("design:type", Number)
    ], ApiDataRow.prototype, "ctr", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=impressions" }),
        __metadata("design:type", Number)
