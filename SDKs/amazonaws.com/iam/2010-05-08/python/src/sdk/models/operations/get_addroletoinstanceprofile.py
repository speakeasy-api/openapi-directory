...
class GetAddRoleToInstanceProfileQueryParams:
    action: GetAddRoleToInstanceProfileActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetAddRoleToInstanceProfileVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAddRoleToInstanceProfileRequest:
    headers: GetAddRoleToInstanceProfileHeaders = dataclasses.field()
    query_params: GetAddRoleToInstanceProfileQueryParams = dataclasses.field()
