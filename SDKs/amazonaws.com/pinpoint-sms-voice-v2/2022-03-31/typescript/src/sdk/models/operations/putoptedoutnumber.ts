...
export enum PutOptedOutNumberXAmzTargetEnum {
  PinpointSMSVoiceV2PutOptedOutNumber = "PinpointSMSVoiceV2.PutOptedOutNumber",
}

export class PutOptedOutNumberRequest extends SpeakeasyBase {
...
export class PutOptedOutNumberResponse extends SpeakeasyBase {
  /**
