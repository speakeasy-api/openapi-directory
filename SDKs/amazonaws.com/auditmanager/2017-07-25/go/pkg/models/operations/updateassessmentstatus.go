...
func (e UpdateAssessmentStatusRequestBodyStatusEnum) ToPointer() *UpdateAssessmentStatusRequestBodyStatusEnum {
	return &e
}
...
func (e *UpdateAssessmentStatusRequestBodyStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "ACTIVE":
		fallthrough
	case "INACTIVE":
		*e = UpdateAssessmentStatusRequestBodyStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateAssessmentStatusRequestBodyStatusEnum: %v", v)
	}
}
