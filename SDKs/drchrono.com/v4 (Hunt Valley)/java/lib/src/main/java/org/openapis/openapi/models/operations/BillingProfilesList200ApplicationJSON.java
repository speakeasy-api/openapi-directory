...
public class BillingProfilesList200ApplicationJSON {
    ...
    @JsonProperty("data")
    public org.openapis.openapi.models.shared.BillingProfile[] data;

    public BillingProfilesList200ApplicationJSON withData(org.openapis.openapi.models.shared.BillingProfile[] data) {
        this.data = data;
        return this;
    }
    ...
    public BillingProfilesList200ApplicationJSON(){}
}
