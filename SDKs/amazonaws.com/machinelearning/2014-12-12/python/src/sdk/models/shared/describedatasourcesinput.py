...
class DescribeDataSourcesInput:
    ...
    filter_variable: Optional[shared_datasourcefiltervariable_enum.DataSourceFilterVariableEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FilterVariable'), 'exclude': lambda f: f is None }})  
