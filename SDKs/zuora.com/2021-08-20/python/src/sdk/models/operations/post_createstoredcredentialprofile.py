...
class POSTCreateStoredCredentialProfileRequest:
    ...
    create_stored_credential_profile_request: shared_createstoredcredentialprofilerequest.CreateStoredCredentialProfileRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
