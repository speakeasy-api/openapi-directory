...
exports.InstallationGhes2 = exports.InstallationGhes2SimpleUser = exports.InstallationGhes2RepositorySelectionEnum = exports.InstallationGhes2Permissions = void 0;
...
var InstallationGhes2Permissions = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=checks" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=deployments" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=organization_administration" }),
        __metadata("design:type", String)
...
exports.InstallationGhes2SimpleUser = InstallationGhes2SimpleUser;
// InstallationGhes2
/**
 * Installation
**/
var InstallationGhes2 = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=access_tokens_url" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=app_slug" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=suspended_at" }),
        __metadata("design:type", Date)
    ], InstallationGhes2.prototype, "suspendedAt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=suspended_by" }),
