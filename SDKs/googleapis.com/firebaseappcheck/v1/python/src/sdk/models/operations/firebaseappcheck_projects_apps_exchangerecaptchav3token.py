...
class FirebaseappcheckProjectsAppsExchangeRecaptchaV3TokenRequest:
    ...
    google_firebase_appcheck_v1_exchange_recaptcha_v3_token_request: Optional[shared_googlefirebaseappcheckv1exchangerecaptchav3tokenrequest.GoogleFirebaseAppcheckV1ExchangeRecaptchaV3TokenRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
