...
export class AerodromesByPolyUsV1AerodromesPolygonQueryPostRequest extends SpeakeasyBase {
...
export class AerodromesByPolyUsV1AerodromesPolygonQueryPostResponse extends SpeakeasyBase {
  /**
