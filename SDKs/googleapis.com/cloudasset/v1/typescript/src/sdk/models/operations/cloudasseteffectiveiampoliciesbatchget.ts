...
export class CloudassetEffectiveIamPoliciesBatchGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudassetEffectiveIamPoliciesBatchGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudassetEffectiveIamPoliciesBatchGetResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
