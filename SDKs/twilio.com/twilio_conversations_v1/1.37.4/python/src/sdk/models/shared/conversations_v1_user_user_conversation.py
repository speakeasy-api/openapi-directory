...
from ..shared import user_conversation_enum_state_enum as shared_user_conversation_enum_state_enum
...
class ConversationsV1UserUserConversation:
    ...
    conversation_state: Optional[shared_user_conversation_enum_state_enum.UserConversationEnumStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('conversation_state') }})
    ...
    notification_level: Optional[shared_user_conversation_enum_notification_level_enum.UserConversationEnumNotificationLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('notification_level') }})
