...
class DeleteFirewallRuleRequest:
    ...
    delete_firewall_rule_request: shared_deletefirewallrulerequest.DeleteFirewallRuleRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
