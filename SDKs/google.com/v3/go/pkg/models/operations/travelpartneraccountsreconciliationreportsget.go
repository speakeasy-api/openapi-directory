...
type TravelpartnerAccountsReconciliationReportsGetQueryParams struct {
	...
	IncludeMatchedPrices *bool `queryParam:"style=form,explode=true,name=includeMatchedPrices"`
	// Set to true if non-account impacting rows are to be added into the report.
	IncludeNonScoring *bool `queryParam:"style=form,explode=true,name=includeNonScoring"`
