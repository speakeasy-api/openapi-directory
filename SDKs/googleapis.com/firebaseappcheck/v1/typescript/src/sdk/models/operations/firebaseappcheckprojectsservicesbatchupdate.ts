...
export class FirebaseappcheckProjectsServicesBatchUpdateSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseappcheckProjectsServicesBatchUpdateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class FirebaseappcheckProjectsServicesBatchUpdateSecurity extends SpeakeasyBase {
...
export class FirebaseappcheckProjectsServicesBatchUpdateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseappcheckProjectsServicesBatchUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
