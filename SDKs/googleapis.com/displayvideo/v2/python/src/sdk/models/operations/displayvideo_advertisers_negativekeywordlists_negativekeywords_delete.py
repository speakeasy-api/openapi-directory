...
class DisplayvideoAdvertisersNegativeKeywordListsNegativeKeywordsDeleteRequest:
    ...
    r"""Required. The keyword value of the negative keyword to delete."""  
    ...
    r"""Required. The ID of the parent negative keyword list to which the negative keyword belongs."""  
