...
var OwnershipFindOwnership = /** @class */ (function () {
    ...
    **/
    OwnershipFindOwnership.prototype.getOwnershipOwnershipId = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ownership/{ownershipId}", req.pathParams);
        var client = this._securityClient;
    ...
    **/
    OwnershipFindOwnership.prototype.postOwnershipUninstallOwnershipId = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ownership/uninstall/{ownershipId}", req.pathParams);
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "post" }, requestConfig));
