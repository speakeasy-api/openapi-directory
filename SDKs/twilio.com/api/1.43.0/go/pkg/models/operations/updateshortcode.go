...
func (e UpdateShortCodeUpdateShortCodeRequestSmsFallbackMethodEnum) ToPointer() *UpdateShortCodeUpdateShortCodeRequestSmsFallbackMethodEnum {
	return &e
}
...
func (e *UpdateShortCodeUpdateShortCodeRequestSmsFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateShortCodeUpdateShortCodeRequestSmsFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateShortCodeUpdateShortCodeRequestSmsFallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateShortCodeUpdateShortCodeRequestSmsMethodEnum) ToPointer() *UpdateShortCodeUpdateShortCodeRequestSmsMethodEnum {
	return &e
}
...
func (e *UpdateShortCodeUpdateShortCodeRequestSmsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateShortCodeUpdateShortCodeRequestSmsMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateShortCodeUpdateShortCodeRequestSmsMethodEnum: %v", v)
	}
}
