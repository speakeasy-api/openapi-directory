...
class GetDiseaseGeneAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    
class GetDiseaseGeneAssociationsAssociationTypeEnum(str, Enum):
    CAUSAL = "causal"
...
@dataclasses.dataclass
class GetDiseaseGeneAssociationsQueryParams:
    association_type: Optional[GetDiseaseGeneAssociationsAssociationTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'association_type', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class GetDiseaseGeneAssociationsRequest:
    path_params: GetDiseaseGeneAssociationsPathParams = dataclasses.field()
    query_params: GetDiseaseGeneAssociationsQueryParams = dataclasses.field()
