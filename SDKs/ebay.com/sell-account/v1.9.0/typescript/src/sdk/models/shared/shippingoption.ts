...
export class ShippingOption extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "packageHandlingCost" })
  @Type(() => Amount)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "shippingDiscountProfileId" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "shippingPromotionOffered" })
