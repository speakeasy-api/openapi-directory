...
const (
	ListTagsForResourceXAmzTargetEnumHealthLakeListTagsForResource ListTagsForResourceXAmzTargetEnum = "HealthLake.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "HealthLake.ListTagsForResource":
