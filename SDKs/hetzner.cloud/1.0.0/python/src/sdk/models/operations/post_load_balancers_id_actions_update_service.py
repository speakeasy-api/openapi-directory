...
class PostLoadBalancersIDActionsUpdateServiceLoadBalancerServiceLoadBalancerServiceHealthCheck:
    ...
    protocol: PostLoadBalancersIDActionsUpdateServiceLoadBalancerServiceLoadBalancerServiceHealthCheckProtocolEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol') }})
    r"""Type of the health check"""  
    ...
    http: Optional[PostLoadBalancersIDActionsUpdateServiceLoadBalancerServiceLoadBalancerServiceHealthCheckHTTP] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('http'), 'exclude': lambda f: f is None }})
    r"""Additional configuration for protocol http"""  
...
class PostLoadBalancersIDActionsUpdateServiceLoadBalancerService:
    ...
    health_check: PostLoadBalancersIDActionsUpdateServiceLoadBalancerServiceLoadBalancerServiceHealthCheck = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('health_check') }})
    r"""Service health check"""  
    ...
    protocol: PostLoadBalancersIDActionsUpdateServiceLoadBalancerServiceProtocolEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol') }})
    r"""Protocol of the Load Balancer"""  
    ...
    http: Optional[PostLoadBalancersIDActionsUpdateServiceLoadBalancerServiceLoadBalancerServiceHTTP] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('http'), 'exclude': lambda f: f is None }})
    r"""Configuration option for protocols http and https"""  
...
class PostLoadBalancersIDActionsUpdateServiceRequest:
    ...
    request_body: Optional[PostLoadBalancersIDActionsUpdateServiceLoadBalancerService] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class PostLoadBalancersIDActionsUpdateServiceActionResponseAction:
    ...
    error: PostLoadBalancersIDActionsUpdateServiceActionResponseActionError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    r"""Error message for the Action if error occurred, otherwise null"""  
    ...
    resources: list[PostLoadBalancersIDActionsUpdateServiceActionResponseActionResources] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources') }})
    ...
    status: PostLoadBalancersIDActionsUpdateServiceActionResponseActionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Status of the Action"""  
...
class PostLoadBalancersIDActionsUpdateServiceActionResponse:
    r"""The `action` key contains the `update_service` Action"""
    
    action: PostLoadBalancersIDActionsUpdateServiceActionResponseAction = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action') }})  
