...
from ..shared import createledgeraccountresponse as shared_createledgeraccountresponse
...
class LedgerAccountsAddResponse:
    ...
    r"""Bad Request"""  
    create_ledger_account_response: Optional[shared_createledgeraccountresponse.CreateLedgerAccountResponse] = dataclasses.field(default=None)
