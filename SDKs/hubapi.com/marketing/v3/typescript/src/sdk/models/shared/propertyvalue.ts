...
export class PropertyValue extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "persistenceTimestamp" })
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "selectedByUser" })
  selectedByUser: boolean;

  @SpeakeasyMetadata()
  @Expose({ name: "selectedByUserTimestamp" })
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "useTimestampAsPersistenceTimestamp" })
