...
export class GetReviewbyReviewIdRequest extends SpeakeasyBase {
  /**
 ...
 * OK
 */
export class GetReviewbyReviewId200ApplicationJSON extends SpeakeasyBase {
  /**
...
export class GetReviewbyReviewIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
