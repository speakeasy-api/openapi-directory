...
class CustomersAddRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\CustomerSupportCustomerInput $customerSupportCustomerInput;
	...
	{
		$this->customerSupportCustomerInput = new \OpenAPI\OpenAPI\Models\Shared\CustomerSupportCustomerInput();
		$this->raw = null;
		$this->xApideckAppId = "";
