...
public class ActivityListRepoNotificationsForAuthenticatedUserQueryParams {
    ...
    public ActivityListRepoNotificationsForAuthenticatedUserQueryParams withBefore(OffsetDateTime before) {
        this.before = before;
        return this;
    }
    ...
    public ActivityListRepoNotificationsForAuthenticatedUserQueryParams withSince(OffsetDateTime since) {
        this.since = since;
        return this;
    }
