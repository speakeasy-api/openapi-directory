 ...
 */
export class DocumentAttributeTarget extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "TargetDocumentAttributeKey" })
  targetDocumentAttributeKey?: string;

  @SpeakeasyMetadata()
  @Expose({ name: "TargetDocumentAttributeValue" })
  @Type(() => DocumentAttributeValue)
  targetDocumentAttributeValue?: DocumentAttributeValue;

  @SpeakeasyMetadata()
  @Expose({ name: "TargetDocumentAttributeValueDeletion" })
