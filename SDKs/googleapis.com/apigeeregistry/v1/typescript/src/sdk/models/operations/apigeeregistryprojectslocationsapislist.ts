...
export class ApigeeregistryProjectsLocationsApisListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ApigeeregistryProjectsLocationsApisListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ApigeeregistryProjectsLocationsApisListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
