...
type IntegrationsProjectsLocationsProductsIntegrationtemplatesVersionsCreateRequest struct {
	...
	GoogleCloudIntegrationsV1alphaIntegrationTemplateVersionInput *shared.GoogleCloudIntegrationsV1alphaIntegrationTemplateVersionInput `request:"mediaType=application/json"`
	// OAuth access token.
