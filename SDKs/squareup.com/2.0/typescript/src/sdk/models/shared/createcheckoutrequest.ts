...
export class CreateCheckoutRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: ChargeRequestAdditionalRecipient })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "ask_for_shipping_address" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "merchant_support_email" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "pre_populate_buyer_email" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "pre_populate_shipping_address" })
  @Type(() => Address)
