...
@dataclasses.dataclass
class CloudprivatecatalogproducerCatalogsTestIamPermissionsQueryParams:
...
class CloudprivatecatalogproducerCatalogsTestIamPermissionsRequest:
    path_params: CloudprivatecatalogproducerCatalogsTestIamPermissionsPathParams = dataclasses.field()
    query_params: CloudprivatecatalogproducerCatalogsTestIamPermissionsQueryParams = dataclasses.field()
    security: CloudprivatecatalogproducerCatalogsTestIamPermissionsSecurity = dataclasses.field()
