 ...
 */
export enum NotificationEndpointAggregatedListWarningCodeEnum {
...
export class NotificationEndpointAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NotificationEndpointAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
 ...
 */
export class NotificationEndpointAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: NotificationEndpointsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, NotificationEndpointsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], NotificationEndpointsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
