...
export class V1 {
  ...
  **/
  changePassword(
    ...
    const url: string = utils.generateURL(baseURL, "/v1/shoppers/{shopperId}/factors/password", req.pathParams);
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.shopperId = httpRes?.data;
            }
            break;
          case httpRes?.status == 400:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.passwordError = httpRes?.data;
            }
            break;
  ...
  **/
  delete(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/shoppers/{shopperId}", req.pathParams);
  ...
  **/
  getStatus(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/shoppers/{shopperId}/status", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            ...
            if (utils.matchContentType(contentType, `application/json`)) {
                res.shopperStatus = httpRes?.data;
            }
            break;
          case httpRes?.status == 400:
            if (utils.matchContentType(contentType, `application/javascript`)) {
