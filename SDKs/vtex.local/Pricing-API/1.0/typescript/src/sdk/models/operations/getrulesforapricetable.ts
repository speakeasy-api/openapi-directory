...
export const GetrulesforapricetableServerList = [
  "https://api.vtex.com/{account}/pricing",
] as const;

export class GetrulesforapricetableRequest extends SpeakeasyBase {
  /**
 ...
 */
export class Getrulesforapricetable200ApplicationJSONRulesContextDateRange extends SpeakeasyBase {
  /**
 ...
 */
export class Getrulesforapricetable200ApplicationJSONRulesContextMarkupRange extends SpeakeasyBase {
  /**
 ...
 */
export class Getrulesforapricetable200ApplicationJSONRulesContext extends SpeakeasyBase {
  /**
  ...
  @Type(() => Getrulesforapricetable200ApplicationJSONRulesContextDateRange)
  ...
  @Type(() => Getrulesforapricetable200ApplicationJSONRulesContextMarkupRange)
 ...
 */
export class Getrulesforapricetable200ApplicationJSONRules extends SpeakeasyBase {
  /**
   * Rule Context is a group of filters to be checked at an item level when applying the rule. If all those filters check out, the rule will be applied for that item, unless there is a fixed price for that item.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "context" })
  @Type(() => Getrulesforapricetable200ApplicationJSONRulesContext)
 ...
 * OK
 */
export class Getrulesforapricetable200ApplicationJSON extends SpeakeasyBase {
  /**
   * Percentual modifier.
   */
  @SpeakeasyMetadata()
  ...
  @Expose({ name: "rules" })
  @Type(() => Getrulesforapricetable200ApplicationJSONRules)
...
export class GetrulesforapricetableResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
