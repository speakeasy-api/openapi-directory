...
from ..shared import getcampaignversionresponse as shared_getcampaignversionresponse
...
class GetCampaignVersionRequest:
    headers: GetCampaignVersionHeaders = dataclasses.field()
    path_params: GetCampaignVersionPathParams = dataclasses.field()
...
class GetCampaignVersionResponse:
    ...
    get_campaign_version_response: Optional[shared_getcampaignversionresponse.GetCampaignVersionResponse] = dataclasses.field(default=None)
