...
export declare enum DoubleVerifyBrandSafetyCategoriesAvoidedHighSeverityCategoriesEnum {
...
export declare enum DoubleVerifyBrandSafetyCategoriesAvoidedMediumSeverityCategoriesEnum {
 ...
 */
export declare class DoubleVerifyBrandSafetyCategories extends SpeakeasyBase {
    /**
