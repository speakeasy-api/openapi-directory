...
exports.AdexchangebuyerCreativesListDealsResponse = exports.AdexchangebuyerCreativesListDealsRequest = exports.AdexchangebuyerCreativesListDealsSecurity = void 0;
...
var AdexchangebuyerCreativesListDealsRequest = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerCreativesListDealsRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdexchangebuyerCreativesListDealsRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=buyerCreativeId",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerCreativesListDealsRequest.prototype, "buyerCreativeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerCreativesListDealsRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdexchangebuyerCreativesListDealsRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerCreativesListDealsRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdexchangebuyerCreativesListDealsRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerCreativesListDealsRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerCreativesListDealsRequest.prototype, "userIp", void 0);
...
var AdexchangebuyerCreativesListDealsResponse = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerCreativesListDealsResponse.prototype, "rawResponse", void 0);
