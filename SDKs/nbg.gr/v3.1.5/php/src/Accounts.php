...
class Accounts 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetAccountsResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->obReadAccount5 = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\OBReadAccount5', 'json');
            }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetAccountsAccountIdRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\GetAccountsAccountIdSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\GetAccountsAccountIdResponse
     */
	public function getAccountsAccountId(
        \OpenAPI\OpenAPI\Models\Operations\GetAccountsAccountIdRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\GetAccountsAccountIdSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\GetAccountsAccountIdResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/accounts/{accountId}', \OpenAPI\OpenAPI\Models\Operations\GetAccountsAccountIdRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetAccountsAccountIdResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
