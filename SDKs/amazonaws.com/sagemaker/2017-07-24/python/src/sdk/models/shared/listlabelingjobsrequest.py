...
class ListLabelingJobsRequest:
    ...
    status_equals: Optional[shared_labelingjobstatus_enum.LabelingJobStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StatusEquals'), 'exclude': lambda f: f is None }})  
