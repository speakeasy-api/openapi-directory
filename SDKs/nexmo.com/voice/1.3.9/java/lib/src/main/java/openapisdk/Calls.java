...
public class Calls {
    ...
    public openapisdk.models.operations.CreateCallResponse createCall(openapisdk.models.operations.CreateCallRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 201) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.CreateCallResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateCallResponse.class);
    ...
    **/
    public openapisdk.models.operations.GetCallResponse getCall(openapisdk.models.operations.GetCallRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/{uuid}", request.pathParams);
        ...
        openapisdk.models.operations.GetCallResponse res = new openapisdk.models.operations.GetCallResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GetCallResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetCallResponse.class);
    ...
    public openapisdk.models.operations.GetCallsResponse getCalls(openapisdk.models.operations.GetCallsRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GetCallsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetCallsResponse.class);
