...
var ProvisioningQuota = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "availableCount" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "networkBandwidth" }),
        __metadata("design:type", String)
    ], ProvisioningQuota.prototype, "networkBandwidth", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "serverCount" }),
        __metadata("design:type", String)
    ], ProvisioningQuota.prototype, "serverCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "storageGib" }),
        __metadata("design:type", String)
