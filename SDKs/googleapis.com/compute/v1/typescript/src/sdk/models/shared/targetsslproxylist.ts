 ...
 */
export enum TargetSslProxyListWarningCodeEnum {
...
export class TargetSslProxyListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetSslProxyListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetSslProxyListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class TargetSslProxyList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetSslProxy })
  @Expose({ name: "items" })
  @Type(() => TargetSslProxy)
