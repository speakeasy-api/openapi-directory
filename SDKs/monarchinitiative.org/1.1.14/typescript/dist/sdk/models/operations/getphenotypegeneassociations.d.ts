...
export declare class GetPhenotypeGeneAssociationsRequest extends SpeakeasyBase {
    /**
...
export declare class GetPhenotypeGeneAssociationsResponse extends SpeakeasyBase {
    /**
     * Success
     */
