...
/**
 * DestinyComponentsKiosksDestinyKioskItemFlavorObjective - Returns data about a character's status with a given Objective. Combine with DestinyObjectiveDefinition static data for display purposes.
 */
public class DestinyComponentsKiosksDestinyKioskItemFlavorObjective {
    /**
