...
class ActionsListWorkflowRunsRequest:
    ...
    r"""Returns workflow runs created within the given date-time range. For more information on the syntax, see \\"[Understanding the search syntax](https://docs.github.com/enterprise-server@3.8/search-github/getting-started-with-searching-on-github/understanding-the-search-syntax#query-for-dates).\\" """  
    event: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'event', 'style': 'form', 'explode': True }})
    r"""Returns workflow run triggered by the event you specify. For example, `push`, `pull_request` or `issue`. For more information, see \\"[Events that trigger workflows](https://docs.github.com/enterprise-server@3.8/actions/automating-your-workflow-with-github-actions/events-that-trigger-workflows).\\" """  
