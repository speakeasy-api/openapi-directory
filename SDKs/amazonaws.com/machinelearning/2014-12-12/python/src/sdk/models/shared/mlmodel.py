...
class MlModel:
    ...
    algorithm: Optional[shared_algorithm_enum.AlgorithmEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Algorithm') }})
