...
type ChromemanagementCustomersReportsCountPrintJobsByUserPathParams struct {
...
type ChromemanagementCustomersReportsCountPrintJobsByUserQueryParams struct {
	// V1 error format.
...
type ChromemanagementCustomersReportsCountPrintJobsByUserRequest struct {
	PathParams  ChromemanagementCustomersReportsCountPrintJobsByUserPathParams
	QueryParams ChromemanagementCustomersReportsCountPrintJobsByUserQueryParams
	Security    ChromemanagementCustomersReportsCountPrintJobsByUserSecurity
}
