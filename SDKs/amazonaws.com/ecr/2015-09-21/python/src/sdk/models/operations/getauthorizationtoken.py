...
class GetAuthorizationTokenRequest:
    ...
    get_authorization_token_request: shared_getauthorizationtokenrequest.GetAuthorizationTokenRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
