...
public class ListConversationParticipantResponse {
    ...
    public ListConversationParticipantResponse withStatusCode(Integer statusCode) {
    ...
    public ListConversationParticipantResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
        this.rawResponse = rawResponse;
        return this;
    }
    
    public ListConversationParticipantResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
