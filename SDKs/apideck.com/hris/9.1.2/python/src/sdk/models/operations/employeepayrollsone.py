...
from ..shared import getemployeepayrollresponse as shared_getemployeepayrollresponse
...
class EmployeePayrollsOneRequest:
    ...
    payroll_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'payroll_id', 'style': 'simple', 'explode': False }})
    r"""ID of the payroll you are acting upon."""  
...
class EmployeePayrollsOneResponse:
    ...
    r"""Bad Request"""  
    get_employee_payroll_response: Optional[shared_getemployeepayrollresponse.GetEmployeePayrollResponse] = dataclasses.field(default=None)
    r"""Payrolls"""  
