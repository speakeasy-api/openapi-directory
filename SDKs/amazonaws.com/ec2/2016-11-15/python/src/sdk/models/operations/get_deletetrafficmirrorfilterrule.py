...
class GetDeleteTrafficMirrorFilterRuleQueryParams:
    action: GetDeleteTrafficMirrorFilterRuleActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteTrafficMirrorFilterRuleVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteTrafficMirrorFilterRuleRequest:
    headers: GetDeleteTrafficMirrorFilterRuleHeaders = dataclasses.field()
    query_params: GetDeleteTrafficMirrorFilterRuleQueryParams = dataclasses.field()
