...
public class GetNhFossilsIndividualsFossilHeaders {
    /**
    ...
    public GetNhFossilsIndividualsFossilHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhFossilsIndividualsFossilHeaders withXApiKey(String xApiKey) {
