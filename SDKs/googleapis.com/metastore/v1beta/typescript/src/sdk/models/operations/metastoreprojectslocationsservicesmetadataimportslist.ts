...
export class MetastoreProjectsLocationsServicesMetadataImportsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsServicesMetadataImportsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsServicesMetadataImportsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
