...
class CreateServiceConversationRequest:
    ...
    request_body: Optional[CreateServiceConversationCreateServiceConversationRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
