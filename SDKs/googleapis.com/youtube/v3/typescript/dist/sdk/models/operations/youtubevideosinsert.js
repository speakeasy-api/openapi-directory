...
exports.YoutubeVideosInsertResponse = exports.YoutubeVideosInsertRequest = exports.YoutubeVideosInsertSecurity = exports.YoutubeVideosInsertSecurityOption4 = exports.YoutubeVideosInsertSecurityOption3 = exports.YoutubeVideosInsertSecurityOption2 = exports.YoutubeVideosInsertSecurityOption1 = exports.YoutubeVideosInsertRequests = exports.YoutubeVideosInsertQueryParams = void 0;
...
var YoutubeVideosInsertQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=autoLevels" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=notifySubscribers" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=stabilize" }),
        __metadata("design:type", Boolean)
...
exports.YoutubeVideosInsertQueryParams = YoutubeVideosInsertQueryParams;
var YoutubeVideosInsertRequests = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=video/av1" }),
        __metadata("design:type", Uint8Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=video/ffv1" }),
        __metadata("design:type", Uint8Array)
    ], YoutubeVideosInsertRequests.prototype, "videoFfv1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=video/flexfec" }),
        __metadata("design:type", Uint8Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=video/jxsv" }),
        __metadata("design:type", Uint8Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=video/scip" }),
        __metadata("design:type", Uint8Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=video/vnd.youtube.yt" }),
        __metadata("design:type", Uint8Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=video/vp9" }),
        __metadata("design:type", Uint8Array)
...
exports.YoutubeVideosInsertRequests = YoutubeVideosInsertRequests;
