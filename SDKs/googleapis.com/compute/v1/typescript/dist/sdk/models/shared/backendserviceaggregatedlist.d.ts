...
import { BackendServicesScopedList } from "./backendservicesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum BackendServiceAggregatedListWarningCodeEnum {
...
export declare class BackendServiceAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class BackendServiceAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: BackendServiceAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: BackendServiceAggregatedListWarningData[];
    /**
 ...
 */
export declare class BackendServiceAggregatedList extends SpeakeasyBase {
    /**
