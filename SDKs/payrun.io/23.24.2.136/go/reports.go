...
func (s *reports) DeleteReportDefinition(ctx context.Context, request operations.DeleteReportDefinitionRequest) (*operations.DeleteReportDefinitionResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/Report/{ReportDefinitionId}", request, nil)
	if err != nil {
...
func (s *reports) DeleteTransformDefinition(ctx context.Context, request operations.DeleteTransformDefinitionRequest) (*operations.DeleteTransformDefinitionResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/Transform/{TransformDefinitionId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *reports) GetReportOutput(ctx context.Context, request operations.GetReportOutputRequest) (*operations.GetReportOutputResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/Report/{ReportDefinitionId}/run", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *reports) PostReportDefinition(ctx context.Context, request operations.PostReportDefinitionRequest) (*operations.PostReportDefinitionResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ReportDefinition", "json")
	if err != nil {
...
func (s *reports) PostTransformDefinition(ctx context.Context, request operations.PostTransformDefinitionRequest) (*operations.PostTransformDefinitionResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "TransformDefinition", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
