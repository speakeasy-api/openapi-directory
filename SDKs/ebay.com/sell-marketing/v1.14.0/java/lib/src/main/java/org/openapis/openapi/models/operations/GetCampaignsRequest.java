...
public class GetCampaignsRequest {
    ...
    public GetCampaignsRequest withCampaignName(String campaignName) {
    ...
    public GetCampaignsRequest withCampaignStatus(String campaignStatus) {
    ...
    public GetCampaignsRequest withEndDateRange(String endDateRange) {
    ...
    public GetCampaignsRequest withFundingStrategy(String fundingStrategy) {
    ...
    public String limit;
    public GetCampaignsRequest withLimit(String limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetCampaignsRequest withOffset(String offset) {
        this.offset = offset;
        return this;
    }
    ...
    public GetCampaignsRequest withStartDateRange(String startDateRange) {
