...
public class PUTCustomObjectRecordRequest {
    ...
    public PUTCustomObjectRecordRequest withAuthorization(String authorization) {
    ...
    public PUTCustomObjectRecordRequest withIfMatch(String ifMatch) {
    ...
    public PUTCustomObjectRecordRequest withRequestBody(java.util.Map<String, Object> requestBody) {
    ...
    public PUTCustomObjectRecordRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public PUTCustomObjectRecordRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public PUTCustomObjectRecordRequest withZuoraVersion(LocalDate zuoraVersion) {
    ...
    public String id;
    public PUTCustomObjectRecordRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public PUTCustomObjectRecordRequest withObject(String object) {
        this.object = object;
        return this;
    }
