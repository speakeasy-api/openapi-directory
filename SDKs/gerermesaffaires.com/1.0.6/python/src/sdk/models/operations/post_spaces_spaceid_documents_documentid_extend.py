...
class PostSpacesSpaceIDDocumentsDocumentIDExtendResponse:
    ...
    post_spaces_space_id_documents_document_id_extend_201_application_json_object: Optional[PostSpacesSpaceIDDocumentsDocumentIDExtend201ApplicationJSON] = dataclasses.field(default=None)
    r"""Id of document created"""  
