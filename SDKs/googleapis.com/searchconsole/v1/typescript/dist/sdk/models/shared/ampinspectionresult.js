...
var AmpInspectionResult = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "ampIndexStatusVerdict" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: ampissue_1.AmpIssue }),
        (0, class_transformer_1.Expose)({ name: "issues" }),
        (0, class_transformer_1.Type)(function () { return ampissue_1.AmpIssue; }),
