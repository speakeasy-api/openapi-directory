 ...
 */
export class CodespaceWithFullRepositoryGitStatus extends SpeakeasyBase {
  /**
 ...
 */
export enum CodespaceWithFullRepositoryLocationEnum {
  EastUs = "EastUs",
...
export class CodespaceWithFullRepositoryRuntimeConstraints extends SpeakeasyBase {
  /**
 ...
 */
export enum CodespaceWithFullRepositoryStateEnum {
  Unknown = "Unknown",
  Created = "Created",
  Queued = "Queued",
 ...
 * A codespace.
 */
export class CodespaceWithFullRepository extends SpeakeasyBase {
  /**
   * A GitHub user.
   */
  @SpeakeasyMetadata()
  ...
  @Type(() => CodespaceWithFullRepositoryGitStatus)
  ...
  @Type(() => CodespaceWithFullRepositoryRuntimeConstraints)
