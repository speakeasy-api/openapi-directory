...
var CreateUserScheduleRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "preferredTriggerDayOfMonth" }),
        __metadata("design:type", Number)
    ], CreateUserScheduleRequest.prototype, "preferredTriggerDayOfMonth", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "preferredTriggerDayOfWeek" }),
        __metadata("design:type", String)
    ], CreateUserScheduleRequest.prototype, "preferredTriggerDayOfWeek", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "preferredTriggerHour" }),
        __metadata("design:type", String)
    ], CreateUserScheduleRequest.prototype, "preferredTriggerHour", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "scheduleEndDate" }),
        __metadata("design:type", String)
    ], CreateUserScheduleRequest.prototype, "scheduleEndDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "scheduleName" }),
        __metadata("design:type", String)
    ], CreateUserScheduleRequest.prototype, "scheduleName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "scheduleStartDate" }),
        __metadata("design:type", String)
