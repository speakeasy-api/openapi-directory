...
class DrivelabelsLabelsCreateQueryParams:
...
class DrivelabelsLabelsCreateRequest:
    query_params: DrivelabelsLabelsCreateQueryParams = dataclasses.field()
    request: Optional[shared_googleappsdrivelabelsv2betalabel.GoogleAppsDriveLabelsV2betaLabelInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
