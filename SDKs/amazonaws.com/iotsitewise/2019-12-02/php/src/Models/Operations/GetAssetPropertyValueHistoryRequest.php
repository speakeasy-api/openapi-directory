...
class GetAssetPropertyValueHistoryRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetAssetPropertyValueHistoryTimeOrderingEnum $timeOrdering
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=timeOrdering')]
    public ?GetAssetPropertyValueHistoryTimeOrderingEnum $timeOrdering = null;
