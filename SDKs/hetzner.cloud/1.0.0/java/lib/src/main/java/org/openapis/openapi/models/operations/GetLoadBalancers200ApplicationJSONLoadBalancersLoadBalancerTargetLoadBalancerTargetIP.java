 ...
 */
public class GetLoadBalancers200ApplicationJSONLoadBalancersLoadBalancerTargetLoadBalancerTargetIP {
    /**
    ...
    public GetLoadBalancers200ApplicationJSONLoadBalancersLoadBalancerTargetLoadBalancerTargetIP withIp(String ip) {
        this.ip = ip;
        return this;
    }
    
    public GetLoadBalancers200ApplicationJSONLoadBalancersLoadBalancerTargetLoadBalancerTargetIP(@JsonProperty("ip") String ip) {
        this.ip = ip;
  }
}
