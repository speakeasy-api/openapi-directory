 ...
 */
export enum BusinessChainTargetingOptionDetailsGeoRegionTypeEnum {
 ...
 */
export class BusinessChainTargetingOptionDetails extends SpeakeasyBase {
  /**
   * Output only. The display name of the business chain, e.g. "KFC", "Chase Bank".
   */
  @SpeakeasyMetadata()
  @Expose({ name: "businessChain" })
