...
exports.CreateOrderRatePlanOverride = void 0;
var utils_1 = require("../../../internal/utils");
var createorderchargeoverride_1 = require("./createorderchargeoverride");
 ...
 *
**/
var CreateOrderRatePlanOverride = /** @class */ (function (_super) {
    __extends(CreateOrderRatePlanOverride, _super);
    function CreateOrderRatePlanOverride() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=chargeOverrides", elemType: createorderchargeoverride_1.CreateOrderChargeOverride }),
        __metadata("design:type", Array)
    ], CreateOrderRatePlanOverride.prototype, "chargeOverrides", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=customFields" }),
        __metadata("design:type", Object)
    ], CreateOrderRatePlanOverride.prototype, "customFields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=productRatePlanId" }),
        __metadata("design:type", String)
    ], CreateOrderRatePlanOverride.prototype, "productRatePlanId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=uniqueToken" }),
        __metadata("design:type", String)
    ], CreateOrderRatePlanOverride.prototype, "uniqueToken", void 0);
    return CreateOrderRatePlanOverride;
}(utils_1.SpeakeasyBase));
exports.CreateOrderRatePlanOverride = CreateOrderRatePlanOverride;
