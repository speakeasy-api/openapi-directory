...
var CreateCommitInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: putfileentry_1.PutFileEntry }),
        (0, class_transformer_1.Expose)({ name: "putFiles" }),
        (0, class_transformer_1.Type)(function () { return putfileentry_1.PutFileEntry; }),
        __metadata("design:type", Array)
