...
public class RegionHealthChecks {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeRegionHealthChecksTestIamPermissionsResponse computeRegionHealthChecksTestIamPermissions(org.openapis.openapi.models.operations.ComputeRegionHealthChecksTestIamPermissionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeRegionHealthChecksTestIamPermissionsPathParams.class, baseUrl, "/projects/{project}/regions/{region}/healthChecks/{resource}/testIamPermissions", request.pathParams, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeRegionHealthChecksTestIamPermissionsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
