...
func (e DirectoryChromeosdevicesUpdateProjectionEnum) ToPointer() *DirectoryChromeosdevicesUpdateProjectionEnum {
	return &e
}

func (e *DirectoryChromeosdevicesUpdateProjectionEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "BASIC":
		fallthrough
	case "FULL":
		*e = DirectoryChromeosdevicesUpdateProjectionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DirectoryChromeosdevicesUpdateProjectionEnum: %v", v)
	}
}
