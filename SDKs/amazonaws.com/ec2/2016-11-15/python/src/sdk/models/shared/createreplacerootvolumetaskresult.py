...
class CreateReplaceRootVolumeTaskResultReplaceRootVolumeTaskTags:
    r"""Describes a tag."""
    
    key: Optional[str] = dataclasses.field(default=None)  
    value: Optional[str] = dataclasses.field(default=None)  
    
class CreateReplaceRootVolumeTaskResultReplaceRootVolumeTaskTaskStateEnum(str, Enum):
...
class CreateReplaceRootVolumeTaskResultReplaceRootVolumeTask:
    r"""Information about the root volume replacement task."""
    ...
    tags: Optional[list[CreateReplaceRootVolumeTaskResultReplaceRootVolumeTaskTags]] = dataclasses.field(default=None)  
    task_state: Optional[CreateReplaceRootVolumeTaskResultReplaceRootVolumeTaskTaskStateEnum] = dataclasses.field(default=None)  
