...
func (e GETDescribeOrderableClusterOptionsActionEnum) ToPointer() *GETDescribeOrderableClusterOptionsActionEnum {
	return &e
}
...
func (e *GETDescribeOrderableClusterOptionsActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DescribeOrderableClusterOptions":
		*e = GETDescribeOrderableClusterOptionsActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeOrderableClusterOptionsActionEnum: %v", v)
	}
}
...
func (e GETDescribeOrderableClusterOptionsVersionEnum) ToPointer() *GETDescribeOrderableClusterOptionsVersionEnum {
	return &e
}
...
func (e *GETDescribeOrderableClusterOptionsVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2012-12-01":
		*e = GETDescribeOrderableClusterOptionsVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeOrderableClusterOptionsVersionEnum: %v", v)
	}
}
