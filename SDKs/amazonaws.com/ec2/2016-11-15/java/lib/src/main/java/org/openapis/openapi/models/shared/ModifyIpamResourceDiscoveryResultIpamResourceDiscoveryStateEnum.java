 ...
 */
public enum ModifyIpamResourceDiscoveryResultIpamResourceDiscoveryStateEnum {
    ...
    private ModifyIpamResourceDiscoveryResultIpamResourceDiscoveryStateEnum(String value) {
        this.value = value;
    }
}
