...
export class RunProjectsLocationsServicesRevisionsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunProjectsLocationsServicesRevisionsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunProjectsLocationsServicesRevisionsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
