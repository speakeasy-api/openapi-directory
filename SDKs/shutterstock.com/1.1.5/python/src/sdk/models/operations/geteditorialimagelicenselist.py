...
class GetEditorialImageLicenseListQueryParams:
...
class GetEditorialImageLicenseListRequest:
    query_params: GetEditorialImageLicenseListQueryParams = dataclasses.field()
    security: GetEditorialImageLicenseListSecurity = dataclasses.field()
