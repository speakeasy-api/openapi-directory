...
class UpdateGatewayRequest:
    headers: UpdateGatewayHeaders = dataclasses.field()
    path_params: UpdateGatewayPathParams = dataclasses.field()
    request: UpdateGatewayRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
