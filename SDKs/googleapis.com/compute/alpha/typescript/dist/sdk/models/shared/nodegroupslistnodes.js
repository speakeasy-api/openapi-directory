...
exports.NodeGroupsListNodes = exports.NodeGroupsListNodesWarning = exports.NodeGroupsListNodesWarningData = exports.NodeGroupsListNodesWarningCodeEnum = void 0;
var utils_1 = require("../../../internal/utils");
var nodegroupnode_1 = require("./nodegroupnode");
var class_transformer_1 = require("class-transformer");
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
var NodeGroupsListNodesWarningCodeEnum;
(function (NodeGroupsListNodesWarningCodeEnum) {
...
})(NodeGroupsListNodesWarningCodeEnum = exports.NodeGroupsListNodesWarningCodeEnum || (exports.NodeGroupsListNodesWarningCodeEnum = {}));
var NodeGroupsListNodesWarningData = /** @class */ (function (_super) {
    __extends(NodeGroupsListNodesWarningData, _super);
    function NodeGroupsListNodesWarningData() {
    ...
    ], NodeGroupsListNodesWarningData.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "value" }),
        __metadata("design:type", String)
    ], NodeGroupsListNodesWarningData.prototype, "value", void 0);
    return NodeGroupsListNodesWarningData;
}(utils_1.SpeakeasyBase));
exports.NodeGroupsListNodesWarningData = NodeGroupsListNodesWarningData;
/**
 * [Output Only] Informational warning message.
 */
var NodeGroupsListNodesWarning = /** @class */ (function (_super) {
    __extends(NodeGroupsListNodesWarning, _super);
    function NodeGroupsListNodesWarning() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", String)
    ], NodeGroupsListNodesWarning.prototype, "code", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: NodeGroupsListNodesWarningData }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return NodeGroupsListNodesWarningData; }),
        __metadata("design:type", Array)
    ], NodeGroupsListNodesWarning.prototype, "data", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "message" }),
        __metadata("design:type", String)
    ], NodeGroupsListNodesWarning.prototype, "message", void 0);
    return NodeGroupsListNodesWarning;
}(utils_1.SpeakeasyBase));
exports.NodeGroupsListNodesWarning = NodeGroupsListNodesWarning;
/**
 * Successful response
 */
var NodeGroupsListNodes = /** @class */ (function (_super) {
    __extends(NodeGroupsListNodes, _super);
    function NodeGroupsListNodes() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", String)
    ], NodeGroupsListNodes.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: nodegroupnode_1.NodeGroupNode }),
        (0, class_transformer_1.Expose)({ name: "items" }),
        (0, class_transformer_1.Type)(function () { return nodegroupnode_1.NodeGroupNode; }),
        __metadata("design:type", Array)
    ], NodeGroupsListNodes.prototype, "items", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kind" }),
        __metadata("design:type", String)
    ], NodeGroupsListNodes.prototype, "kind", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "nextPageToken" }),
        __metadata("design:type", String)
    ], NodeGroupsListNodes.prototype, "nextPageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "selfLink" }),
        __metadata("design:type", String)
    ], NodeGroupsListNodes.prototype, "selfLink", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "warning" }),
        (0, class_transformer_1.Type)(function () { return NodeGroupsListNodesWarning; }),
        __metadata("design:type", NodeGroupsListNodesWarning)
    ], NodeGroupsListNodes.prototype, "warning", void 0);
    return NodeGroupsListNodes;
}(utils_1.SpeakeasyBase));
exports.NodeGroupsListNodes = NodeGroupsListNodes;
