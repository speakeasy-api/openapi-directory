...
class GetRemoveRoleFromDbInstanceQueryParams:
    action: GetRemoveRoleFromDbInstanceActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    feature_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'FeatureName', 'style': 'form', 'explode': True }})
    role_arn: str = dataclasses.field(metadata={'query_param': { 'field_name': 'RoleArn', 'style': 'form', 'explode': True }})
    version: GetRemoveRoleFromDbInstanceVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRemoveRoleFromDbInstanceRequest:
    headers: GetRemoveRoleFromDbInstanceHeaders = dataclasses.field()
    query_params: GetRemoveRoleFromDbInstanceQueryParams = dataclasses.field()
