...
public class GETQueryNotificationDefinitions200ApplicationJSON {
    ...
    @JsonProperty("data")
    public org.openapis.openapi.models.shared.GETPublicNotificationDefinitionResponse[] data;
    public GETQueryNotificationDefinitions200ApplicationJSON withData(org.openapis.openapi.models.shared.GETPublicNotificationDefinitionResponse[] data) {
        this.data = data;
        return this;
    }
