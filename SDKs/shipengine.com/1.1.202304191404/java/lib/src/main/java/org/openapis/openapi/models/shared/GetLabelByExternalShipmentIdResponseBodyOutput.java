...
public class GetLabelByExternalShipmentIdResponseBodyOutput {
    ...
    public GetLabelByExternalShipmentIdResponseBodyOutput withAlternativeIdentifiers(AlternativeIdentifier[] alternativeIdentifiers) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyOutput withBatchId(String batchId) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyOutput withCarrierCode(String carrierCode) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyOutput withCarrierId(String carrierId) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyOutput withCreatedAt(OffsetDateTime createdAt) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyDisplaySchemeEnum displayScheme;

    public GetLabelByExternalShipmentIdResponseBodyOutput withDisplayScheme(GetLabelByExternalShipmentIdResponseBodyDisplaySchemeEnum displayScheme) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyLabelFormatEnum labelFormat;

    public GetLabelByExternalShipmentIdResponseBodyOutput withLabelFormat(GetLabelByExternalShipmentIdResponseBodyLabelFormatEnum labelFormat) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyOutput withLabelId(String labelId) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyOutput withLabelImageId(String labelImageId) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyLabelLayoutEnum labelLayout;

    public GetLabelByExternalShipmentIdResponseBodyOutput withLabelLayout(GetLabelByExternalShipmentIdResponseBodyLabelLayoutEnum labelLayout) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyOutput withPackageCode(String packageCode) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyOutput withServiceCode(String serviceCode) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyOutput withShipDate(OffsetDateTime shipDate) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyOutput withShipmentId(String shipmentId) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("status")
    public GetLabelByExternalShipmentIdResponseBodyLabelStatusEnum status;

    public GetLabelByExternalShipmentIdResponseBodyOutput withStatus(GetLabelByExternalShipmentIdResponseBodyLabelStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public GetLabelByExternalShipmentIdResponseBodyTrackingStatusEnum trackingStatus;

    public GetLabelByExternalShipmentIdResponseBodyOutput withTrackingStatus(GetLabelByExternalShipmentIdResponseBodyTrackingStatusEnum trackingStatus) {
    ...
    public GetLabelByExternalShipmentIdResponseBodyOutput withVoidedAt(OffsetDateTime voidedAt) {
        this.voidedAt = voidedAt;
        return this;
    }
    
    public GetLabelByExternalShipmentIdResponseBodyOutput(){}
}
