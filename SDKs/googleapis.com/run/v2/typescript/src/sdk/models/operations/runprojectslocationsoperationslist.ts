...
export class RunProjectsLocationsOperationsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunProjectsLocationsOperationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunProjectsLocationsOperationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
