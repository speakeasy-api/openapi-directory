...
public class ActionPOSTgenerateRequest {
    ...
    public org.openapis.openapi.models.shared.ProxyActiongenerateRequest proxyActiongenerateRequest;
    public ActionPOSTgenerateRequest withProxyActiongenerateRequest(org.openapis.openapi.models.shared.ProxyActiongenerateRequest proxyActiongenerateRequest) {
        this.proxyActiongenerateRequest = proxyActiongenerateRequest;
        return this;
    }
    ...
    public ActionPOSTgenerateRequest withXZuoraWSDLVersion(String xZuoraWSDLVersion) {
    ...
    public ActionPOSTgenerateRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public ActionPOSTgenerateRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public ActionPOSTgenerateRequest withRejectUnknownFields(Boolean rejectUnknownFields) {
