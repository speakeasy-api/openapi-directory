...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.IpGeolocationWithConfidenceAreaAndHazardReportApiResponse ipGeolocationWithConfidenceAreaAndHazardReportApi(org.openapis.openapi.models.operations.IpGeolocationWithConfidenceAreaAndHazardReportApiRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.IpGeolocationWithConfidenceAreaAndHazardReportApiQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.IpGeolocationWithConfidenceAreaApiResponse ipGeolocationWithConfidenceAreaApi(org.openapis.openapi.models.operations.IpGeolocationWithConfidenceAreaApiRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.IpGeolocationWithConfidenceAreaApiQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
