...
from ..shared import fundingresponse as shared_fundingresponse
...
class GetFundingByIDV1Request:
    
    funding_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'fundingId', 'style': 'simple', 'explode': False }})  
    

@dataclasses.dataclass
class GetFundingByIDV1Response:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    funding_response: Optional[shared_fundingresponse.FundingResponse] = dataclasses.field(default=None)
    r"""Funding response"""  
