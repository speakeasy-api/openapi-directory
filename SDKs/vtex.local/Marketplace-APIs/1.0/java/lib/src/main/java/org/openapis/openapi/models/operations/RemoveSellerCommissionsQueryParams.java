...
public class RemoveSellerCommissionsQueryParams {
    /**
    ...
    public RemoveSellerCommissionsQueryParams withAccountName(String accountName) {
    ...
    public RemoveSellerCommissionsQueryParams withEnvironment(String environment) {
