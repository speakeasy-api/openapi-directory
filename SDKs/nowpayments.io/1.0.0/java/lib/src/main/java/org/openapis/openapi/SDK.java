...
public class SDK {
     ...
     */
    public BillingSubPartnerAPI billingSubPartnerAPI;
    public PaymentsAPI paymentsAPI;
    public PayoutsAPI payoutsAPI;
    /**
     ...
     */
    public RecurringPaymentsAPIEmailSubscriptionsFeature recurringPaymentsAPIEmailSubscriptionsFeature;	
	...
	private SDK(HTTPClient client, String serverUrl, java.util.Map<String, String> params) throws Exception {
		...
		this.billingSubPartnerAPI = new BillingSubPartnerAPI(
			this._defaultClient,
		...
		this.payoutsAPI = new PayoutsAPI(
			this._defaultClient,
			this._securityClient,
			this._serverUrl,
			this._language,
		...
		this.recurringPaymentsAPIEmailSubscriptionsFeature = new RecurringPaymentsAPIEmailSubscriptionsFeature(
			this._defaultClient,
			this._securityClient,
			this._serverUrl,
			this._language,
