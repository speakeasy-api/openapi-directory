...
class GetTransitGatewayMulticastDomainAssociationsRequestFilters:
...
class GetTransitGatewayMulticastDomainAssociationsRequest:
    ...
    filters: Optional[list[GetTransitGatewayMulticastDomainAssociationsRequestFilters]] = dataclasses.field(default=None)  
