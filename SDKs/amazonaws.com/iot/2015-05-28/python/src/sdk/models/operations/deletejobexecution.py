...
class DeleteJobExecutionRequest:
    headers: DeleteJobExecutionHeaders = dataclasses.field()
    path_params: DeleteJobExecutionPathParams = dataclasses.field()
    query_params: DeleteJobExecutionQueryParams = dataclasses.field()
