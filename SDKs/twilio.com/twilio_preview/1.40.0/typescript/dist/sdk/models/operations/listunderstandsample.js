...
exports.ListUnderstandSampleResponse = exports.ListUnderstandSampleListUnderstandSampleResponse = exports.ListUnderstandSampleListUnderstandSampleResponseMeta = exports.ListUnderstandSampleRequest = exports.ListUnderstandSampleSecurity = exports.ListUnderstandSampleServerList = void 0;
...
var ListUnderstandSampleSecurity = /** @class */ (function (_super) {
    ...
    ], ListUnderstandSampleSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListUnderstandSampleSecurity.prototype, "username", void 0);
...
var ListUnderstandSampleRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListUnderstandSampleRequest.prototype, "assistantSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Language",
        }),
        __metadata("design:type", String)
    ], ListUnderstandSampleRequest.prototype, "language", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListUnderstandSampleRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListUnderstandSampleRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListUnderstandSampleRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TaskSid",
        }),
        __metadata("design:type", String)
    ], ListUnderstandSampleRequest.prototype, "taskSid", void 0);
...
var ListUnderstandSampleListUnderstandSampleResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListUnderstandSampleListUnderstandSampleResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.PreviewUnderstandAssistantTaskSample }),
        (0, class_transformer_1.Expose)({ name: "samples" }),
        (0, class_transformer_1.Type)(function () { return shared.PreviewUnderstandAssistantTaskSample; }),
...
var ListUnderstandSampleResponse = /** @class */ (function (_super) {
    ...
    ], ListUnderstandSampleResponse.prototype, "rawResponse", void 0);
