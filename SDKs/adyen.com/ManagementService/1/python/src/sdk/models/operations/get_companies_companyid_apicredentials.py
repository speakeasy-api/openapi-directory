...
from ..shared import listcompanyapicredentialsresponse as shared_listcompanyapicredentialsresponse
...
@dataclasses.dataclass
class GetCompaniesCompanyIDAPICredentialsRequest:
...
class GetCompaniesCompanyIDAPICredentialsResponse:
    ...
    list_company_api_credentials_response: Optional[shared_listcompanyapicredentialsresponse.ListCompanyAPICredentialsResponse] = dataclasses.field(default=None)
