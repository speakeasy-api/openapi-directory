...
exports.GetHealthResponse = exports.GetHealthRequest = void 0;
...
var GetHealthRequest = /** @class */ (function (_super) {
    ...
    ], GetHealthRequest.prototype, "bundles", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=plugins",
        }),
        __metadata("design:type", Boolean)
    ], GetHealthRequest.prototype, "plugins", void 0);
...
var GetHealthResponse = /** @class */ (function (_super) {
    ...
    ], GetHealthResponse.prototype, "rawResponse", void 0);
