...
type TravelpartnerAccountsParticipationReportViewsQueryPathParams struct {
	// The resource name of the account being queried. The format is `accounts/{account_id}`.
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type TravelpartnerAccountsParticipationReportViewsQueryQueryParams struct {
	// V1 error format.
...
type TravelpartnerAccountsParticipationReportViewsQueryRequest struct {
	PathParams  TravelpartnerAccountsParticipationReportViewsQueryPathParams
	QueryParams TravelpartnerAccountsParticipationReportViewsQueryQueryParams
}
