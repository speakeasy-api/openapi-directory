...
export class Orders {
  ...
  getAllOrders(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETAllOrdersResponse =
        new operations.GETAllOrdersResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.getAllOrdersResponseType = utils.objectToClass(
              httpRes?.data,
              shared.GetAllOrdersResponseType
            );
          }
          break;
      }
  ...
  getJobStatusAndResponse(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETJobStatusAndResponseResponse =
        new operations.GETJobStatusAndResponseResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
        ...
        case httpRes?.status == 200:
          if (
            ...
            res.getJobStatusAndResponse200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GETJobStatusAndResponse200ApplicationJSON
              );
          }
          break;
      }
  ...
  getOrderMetricsforEvergreenSubscription(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETOrderMetricsforEvergreenSubscriptionResponse =
        new operations.GETOrderMetricsforEvergreenSubscriptionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.getOrderResponseForEvergreen = utils.objectToClass(
              httpRes?.data,
              shared.GetOrderResponseForEvergreen
            );
          }
          break;
      }
  ...
  getOrdersByInvoiceOwner(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETOrdersByInvoiceOwnerResponse =
        new operations.GETOrdersByInvoiceOwnerResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  getOrdersBySubscriptionNumber(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETOrdersBySubscriptionNumberResponse =
        new operations.GETOrdersBySubscriptionNumberResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  getOrdersBySubscriptionOwner(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETOrdersBySubscriptionOwnerResponse =
        new operations.GETOrdersBySubscriptionOwnerResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  getSubscriptionTermInfo(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETSubscriptionTermInfoResponse =
        new operations.GETSubscriptionTermInfoResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.getSubscriptionTermInfoResponseType = utils.objectToClass(
              httpRes?.data,
              shared.GetSubscriptionTermInfoResponseType
            );
          }
          break;
      }
  ...
  postCreateOrderAsynchronously(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTCreateOrderAsynchronouslyResponse =
        new operations.POSTCreateOrderAsynchronouslyResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
        ...
        case httpRes?.status == 202:
          if (
            ...
            res.postCreateOrderAsynchronously202ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.POSTCreateOrderAsynchronously202ApplicationJSON
              );
          }
          break;
      }
  ...
  postOrder(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTOrderResponse =
        new operations.POSTOrderResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.postOrderResponseType = utils.objectToClass(
              httpRes?.data,
              shared.PostOrderResponseType
            );
          }
          break;
      }
  ...
  postPreviewOrder(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTPreviewOrderResponse =
        new operations.POSTPreviewOrderResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.postOrderPreviewResponseType = utils.objectToClass(
              httpRes?.data,
              shared.PostOrderPreviewResponseType
            );
          }
          break;
      }
  ...
  postPreviewOrderAsynchronously(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTPreviewOrderAsynchronouslyResponse =
        new operations.POSTPreviewOrderAsynchronouslyResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
        ...
        case httpRes?.status == 202:
          if (
            ...
            res.postPreviewOrderAsynchronously202ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.POSTPreviewOrderAsynchronously202ApplicationJSON
              );
          }
          break;
      }
  ...
  putOrderTriggerDates(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PUTOrderTriggerDatesResponse =
        new operations.PUTOrderTriggerDatesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.putOrderTriggerDatesResponseType = utils.objectToClass(
              httpRes?.data,
              shared.PUTOrderTriggerDatesResponseType
            );
          }
          break;
      }
  ...
  putUpdateOrderCustomFields(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PUTUpdateOrderCustomFieldsResponse =
        new operations.PUTUpdateOrderCustomFieldsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  putUpdateSubscriptionCustomFields(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PUTUpdateSubscriptionCustomFieldsResponse =
        new operations.PUTUpdateSubscriptionCustomFieldsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
