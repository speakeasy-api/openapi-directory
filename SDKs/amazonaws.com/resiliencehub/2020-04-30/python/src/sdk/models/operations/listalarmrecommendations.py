...
from ..shared import listalarmrecommendationsresponse as shared_listalarmrecommendationsresponse
...
class ListAlarmRecommendationsRequest:
    ...
    request_body: ListAlarmRecommendationsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListAlarmRecommendationsResponse:
    ...
    list_alarm_recommendations_response: Optional[shared_listalarmrecommendationsresponse.ListAlarmRecommendationsResponse] = dataclasses.field(default=None)
    r"""Success"""  
