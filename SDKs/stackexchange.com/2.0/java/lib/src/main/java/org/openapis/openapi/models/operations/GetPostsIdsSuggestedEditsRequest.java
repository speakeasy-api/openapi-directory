...
public class GetPostsIdsSuggestedEditsRequest {
    ...
    public GetPostsIdsSuggestedEditsRequest withCallback(String callback) {
    ...
    public GetPostsIdsSuggestedEditsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetPostsIdsSuggestedEditsRequest withFromdate(Long fromdate) {
    ...
    public GetPostsIdsSuggestedEditsRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetPostsIdsSuggestedEditsRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetPostsIdsSuggestedEditsRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetPostsIdsSuggestedEditsRequest withOrder(GetPostsIdsSuggestedEditsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetPostsIdsSuggestedEditsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetPostsIdsSuggestedEditsRequest withPagesize(Long pagesize) {
    ...
    public GetPostsIdsSuggestedEditsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetPostsIdsSuggestedEditsRequest withSort(GetPostsIdsSuggestedEditsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPostsIdsSuggestedEditsRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetPostsIdsSuggestedEditsRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
