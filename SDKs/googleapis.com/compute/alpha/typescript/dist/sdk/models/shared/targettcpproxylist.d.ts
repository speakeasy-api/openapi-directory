 ...
 */
export declare enum TargetTcpProxyListWarningCodeEnum {
...
export declare class TargetTcpProxyListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetTcpProxyListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: TargetTcpProxyListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: TargetTcpProxyListWarningData[];
    /**
 ...
 */
export declare class TargetTcpProxyList extends SpeakeasyBase {
    /**
