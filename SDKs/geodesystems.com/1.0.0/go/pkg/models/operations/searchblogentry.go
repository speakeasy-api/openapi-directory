...
type SearchBlogentryQueryParams struct {
	...
	// Extra Text
	SearchBlogentryBlogtext *string `queryParam:"style=form,explode=true,name=search.blogentry.blogtext"`
	// Number to skip
...
type SearchBlogentryRequest struct {
	QueryParams SearchBlogentryQueryParams
}

type SearchBlogentryResponse struct {
	ContentType string
	StatusCode  int
