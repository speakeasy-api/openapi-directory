...
use \OpenAPI\OpenAPI\Models\Operations\EtcerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\EtcerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\EtcerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\EtcerSecurity;
...
try {
    ...
    $request->certificateParameters = new EtcerRequestBodyCertificateParameters();
    $request->certificateParameters->uniqueCode = '7L017C';
    ...
    $request->format = EtcerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new EtcerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->etcer($request, $requestSecurity);
