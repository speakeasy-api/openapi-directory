...
func main() {
    ...
    res, err := s.Apps.AppsListInstallationReposForAuthenticatedUser(ctx, operations.AppsListInstallationReposForAuthenticatedUserRequest{
        InstallationID: 730442,
        Page: sdk.Int64(374170),
        PerPage: sdk.Int64(646265),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Apps.AppsListInstallations(ctx, operations.AppsListInstallationsRequest{
        Outdated: sdk.String("quam"),
        Page: sdk.Int64(214880),
        PerPage: sdk.Int64(277628),
        Since: types.MustTimeFromString("2022-05-31T19:46:08.472Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
