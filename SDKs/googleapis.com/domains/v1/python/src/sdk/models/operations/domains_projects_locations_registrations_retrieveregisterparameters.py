...
from ..shared import security as shared_security
from ..shared import retrieveregisterparametersresponse as shared_retrieveregisterparametersresponse
...
class DomainsProjectsLocationsRegistrationsRetrieveRegisterParametersRequest:
    path_params: DomainsProjectsLocationsRegistrationsRetrieveRegisterParametersPathParams = dataclasses.field()
    query_params: DomainsProjectsLocationsRegistrationsRetrieveRegisterParametersQueryParams = dataclasses.field()
    security: DomainsProjectsLocationsRegistrationsRetrieveRegisterParametersSecurity = dataclasses.field()
...
class DomainsProjectsLocationsRegistrationsRetrieveRegisterParametersResponse:
    ...
    retrieve_register_parameters_response: Optional[shared_retrieveregisterparametersresponse.RetrieveRegisterParametersResponse] = dataclasses.field(default=None)
