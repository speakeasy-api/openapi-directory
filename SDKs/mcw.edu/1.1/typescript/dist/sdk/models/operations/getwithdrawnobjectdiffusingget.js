...
exports.GETWithdrawnObjectDiffUsingGETResponse = exports.GETWithdrawnObjectDiffUsingGETRequest = void 0;
...
var GETWithdrawnObjectDiffUsingGETRequest = /** @class */ (function (_super) {
    ...
    ], GETWithdrawnObjectDiffUsingGETRequest.prototype, "dateFromYYYYMMDD", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=dateToYYYYMMDD",
        }),
        __metadata("design:type", String)
    ], GETWithdrawnObjectDiffUsingGETRequest.prototype, "dateToYYYYMMDD", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=speciesTypeKey",
        }),
        __metadata("design:type", Number)
    ], GETWithdrawnObjectDiffUsingGETRequest.prototype, "speciesTypeKey", void 0);
...
var GETWithdrawnObjectDiffUsingGETResponse = /** @class */ (function (_super) {
    ...
    ], GETWithdrawnObjectDiffUsingGETResponse.prototype, "rawResponse", void 0);
