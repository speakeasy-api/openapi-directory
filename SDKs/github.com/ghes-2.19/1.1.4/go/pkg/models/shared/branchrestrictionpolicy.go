...
type BranchRestrictionPolicyRestrictionsAppsOwner struct {
	AvatarURL        *string  `json:"avatar_url,omitempty"`
	Description      *string  `json:"description,omitempty"`
	EventsURL        *string  `json:"events_url,omitempty"`
	HooksURL         *string  `json:"hooks_url,omitempty"`
...
type BranchRestrictionPolicyRestrictionsAppsPermissions struct {
	Contents   *string `json:"contents,omitempty"`
	Issues     *string `json:"issues,omitempty"`
	Metadata   *string `json:"metadata,omitempty"`
	SingleFile *string `json:"single_file,omitempty"`
...
type BranchRestrictionPolicyRestrictionsApps struct {
	CreatedAt   *string                                             `json:"created_at,omitempty"`
	Description *string                                             `json:"description,omitempty"`
	Events      []string                                            `json:"events,omitempty"`
	ExternalURL *string                                             `json:"external_url,omitempty"`
	...
	Name        *string                                             `json:"name,omitempty"`
	NodeID      *string                                             `json:"node_id,omitempty"`
	Owner       *BranchRestrictionPolicyRestrictionsAppsOwner       `json:"owner,omitempty"`
	Permissions *BranchRestrictionPolicyRestrictionsAppsPermissions `json:"permissions,omitempty"`
	Slug        *string                                             `json:"slug,omitempty"`
	UpdatedAt   *string                                             `json:"updated_at,omitempty"`
}
...
type BranchRestrictionPolicyRestrictions struct {
	Apps     []BranchRestrictionPolicyRestrictionsApps  `json:"apps,omitempty"`
