...
class ControllersAdvisoryItemAttributes:
    ...
    applicable_systems: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('applicable_systems'), 'exclude': lambda f: f is None }})  
