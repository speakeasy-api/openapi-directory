...
class GetRepositoriesWorkspaceRepoSlugRefsTagsNameRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugRefsTagsNamePathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugRefsTagsNameSecurity = dataclasses.field()
