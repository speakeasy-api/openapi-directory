 ...
 */
public class GetZRLocationSettings200ApplicationXML2Notification {
    /**
     * Send an alert when the audio echo test result meets usability threshold.
     */
    
    public Boolean audioMeetUsabilityThreshold;
    public GetZRLocationSettings200ApplicationXML2Notification withAudioMeetUsabilityThreshold(Boolean audioMeetUsabilityThreshold) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withAudioNotMeetUsabilityThreshold(Boolean audioNotMeetUsabilityThreshold) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withBatteryIsCharging(Boolean batteryIsCharging) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withBatteryLowAndNotCharging(Boolean batteryLowAndNotCharging) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withBatteryPercentage(String batteryPercentage) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withControllerSchedulingDisconnected(Boolean controllerSchedulingDisconnected) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withControllerSchedulingReconnected(Boolean controllerSchedulingReconnected) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withCpuUsageHighDetected(Boolean cpuUsageHighDetected) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withMicSpeakerCameraDisconnected(Boolean micSpeakerCameraDisconnected) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withMicSpeakerCameraReconnected(Boolean micSpeakerCameraReconnected) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withNetworkUnstableDetected(Boolean networkUnstableDetected) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withSipRegistrationFailed(Boolean sipRegistrationFailed) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withSipRegistrationReEnabled(Boolean sipRegistrationReEnabled) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withZoomRoomComeBackOnline(Boolean zoomRoomComeBackOnline) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withZoomRoomDisplayDisconnected(Boolean zoomRoomDisplayDisconnected) {
    ...
    public GetZRLocationSettings200ApplicationXML2Notification withZoomRoomOffline(Boolean zoomRoomOffline) {
