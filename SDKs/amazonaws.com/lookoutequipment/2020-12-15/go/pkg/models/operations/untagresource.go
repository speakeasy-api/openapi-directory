...
const (
	UntagResourceXAmzTargetEnumAwsLookoutEquipmentFrontendServiceUntagResource UntagResourceXAmzTargetEnum = "AWSLookoutEquipmentFrontendService.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AWSLookoutEquipmentFrontendService.UntagResource":
