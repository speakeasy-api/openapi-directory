...
public class AccountGetSessionsSecurity {
    ...
    public AccountGetSessionsSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public AccountGetSessionsSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public AccountGetSessionsSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.project = project;
  }
}
