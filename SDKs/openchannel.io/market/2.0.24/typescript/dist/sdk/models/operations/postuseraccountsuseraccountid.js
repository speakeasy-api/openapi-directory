...
exports.PostUserAccountsUserAccountIdResponse = exports.PostUserAccountsUserAccountIdRequest = void 0;
...
var PostUserAccountsUserAccountIdRequest = /** @class */ (function (_super) {
    ...
    ], PostUserAccountsUserAccountIdRequest.prototype, "customData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=email" }),
        __metadata("design:type", String)
    ], PostUserAccountsUserAccountIdRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], PostUserAccountsUserAccountIdRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=userAccountId",
        }),
        __metadata("design:type", String)
    ], PostUserAccountsUserAccountIdRequest.prototype, "userAccountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userId",
        }),
        __metadata("design:type", String)
    ], PostUserAccountsUserAccountIdRequest.prototype, "userId", void 0);
...
var PostUserAccountsUserAccountIdResponse = /** @class */ (function (_super) {
    ...
    ], PostUserAccountsUserAccountIdResponse.prototype, "rawResponse", void 0);
