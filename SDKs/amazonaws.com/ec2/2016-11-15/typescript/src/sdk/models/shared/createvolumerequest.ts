 ...
 */
export enum CreateVolumeRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateVolumeRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateVolumeRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateVolumeRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateVolumeRequestTagSpecificationsTags })
...
export class CreateVolumeRequest extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: CreateVolumeRequestTagSpecifications })
