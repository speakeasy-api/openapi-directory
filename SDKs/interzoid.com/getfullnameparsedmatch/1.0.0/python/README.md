...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/interzoid.com/getfullnameparsedmatch/1.0.0/python
```
...
### full_name_parsed_similarity_key
