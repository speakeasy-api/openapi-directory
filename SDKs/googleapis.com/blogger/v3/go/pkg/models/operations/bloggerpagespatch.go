...
type BloggerPagesPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type BloggerPagesPatchPathParams struct {
...
type BloggerPagesPatchQueryParams struct {
	// V1 error format.
...
type BloggerPagesPatchRequest struct {
...
type BloggerPagesPatchResponse struct {
	ContentType string
	// Successful response
	Page        *shared.Page
	StatusCode  int
