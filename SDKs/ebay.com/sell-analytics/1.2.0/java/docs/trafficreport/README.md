...
import org.openapis.openapi.models.operations.GetTrafficReportRequest;
import org.openapis.openapi.models.operations.GetTrafficReportResponse;
import org.openapis.openapi.models.operations.GetTrafficReportSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetTrafficReportRequest req = new GetTrafficReportRequest() {{
                dimension = "iure";
                filter = "magnam";
                metric = "debitis";
                sort = "ipsa";
            ...
            GetTrafficReportResponse res = sdk.trafficReport.getTrafficReport(req, new GetTrafficReportSecurity("delectus") {{
