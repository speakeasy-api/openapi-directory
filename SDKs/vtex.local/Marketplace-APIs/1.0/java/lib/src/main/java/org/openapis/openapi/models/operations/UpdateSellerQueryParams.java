...
public class UpdateSellerQueryParams {
    /**
    ...
    public UpdateSellerQueryParams withAccountName(String accountName) {
    ...
    public UpdateSellerQueryParams withEnvironment(String environment) {
