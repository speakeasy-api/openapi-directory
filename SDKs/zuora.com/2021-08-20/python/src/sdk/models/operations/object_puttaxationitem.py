...
from ..shared import proxymodifytaxationitem as shared_proxymodifytaxationitem
...
class ObjectPUTTaxationItemRequest:
    ...
    r"""Object id"""  
    proxy_modify_taxation_item: shared_proxymodifytaxationitem.ProxyModifyTaxationItem = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
