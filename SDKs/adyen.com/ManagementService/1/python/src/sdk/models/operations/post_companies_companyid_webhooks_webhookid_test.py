...
from ..shared import testcompanywebhookrequest as shared_testcompanywebhookrequest
...
@dataclasses.dataclass
class PostCompaniesCompanyIDWebhooksWebhookIDTestRequest:
    ...
    test_company_webhook_request: Optional[shared_testcompanywebhookrequest.TestCompanyWebhookRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
