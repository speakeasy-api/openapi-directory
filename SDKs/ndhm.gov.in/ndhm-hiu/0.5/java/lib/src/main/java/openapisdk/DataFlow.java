...
public class DataFlow {
     ...
     * 
    **/
    public openapisdk.models.operations.PostV05HealthInformationHiuOnRequestResponse postV05HealthInformationHiuOnRequest(openapisdk.models.operations.PostV05HealthInformationHiuOnRequestRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.PostV05HealthInformationHiuOnRequestRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v0.5/health-information/hiu/on-request");
        ...
        openapisdk.models.operations.PostV05HealthInformationHiuOnRequestResponse res = new openapisdk.models.operations.PostV05HealthInformationHiuOnRequestResponse() {{
            errorResponse = null;
            body = null;
            errorResponse = null;
            body = null;
