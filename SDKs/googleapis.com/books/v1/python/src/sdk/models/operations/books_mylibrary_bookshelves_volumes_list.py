...
class BooksMylibraryBookshelvesVolumesListRequest:
    path_params: BooksMylibraryBookshelvesVolumesListPathParams = dataclasses.field()
    query_params: BooksMylibraryBookshelvesVolumesListQueryParams = dataclasses.field()
    security: BooksMylibraryBookshelvesVolumesListSecurity = dataclasses.field()
