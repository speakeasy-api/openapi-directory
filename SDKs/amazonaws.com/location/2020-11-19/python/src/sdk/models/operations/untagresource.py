...
class UntagResourceRequest:
    ...
    r"""<p>The Amazon Resource Name (ARN) of the resource from which you want to remove tags.</p> <ul> <li> <p>Format example: <code>arn:aws:geo:region:account-id:resourcetype/ExampleResource</code> </p> </li> </ul>"""  
    tag_keys: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'tagKeys', 'style': 'form', 'explode': True }})
    r"""The list of tag keys to remove from the specified resource."""  
