...
class WellListAlternativeSpecsSubmittedIfRequiredEnum(str, Enum):
    FALSE = 'false'
    TRUE = 'true'

class WellListHydroFracturingPerformedEnum(str, Enum):
    FALSE = 'false'
    TRUE = 'true'

class WellListWellDisinfectedEnum(str, Enum):
    FALSE = 'false'
    TRUE = 'true'

class WellListOrientationOfWellEnum(str, Enum):
    TRUE = 'true'
    FALSE = 'false'
...
class WellList:
    ...
    alternative_specs_submitted: Optional[WellListAlternativeSpecsSubmittedIfRequiredEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('alternative_specs_submitted'), 'exclude': lambda f: f is None }})  
    ...
    hydro_fracturing_performed: Optional[WellListHydroFracturingPerformedEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('hydro_fracturing_performed'), 'exclude': lambda f: f is None }})  
    ...
    well_disinfected: Optional[WellListWellDisinfectedEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('well_disinfected'), 'exclude': lambda f: f is None }})  
    ...
    well_orientation: Optional[WellListOrientationOfWellEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('well_orientation'), 'exclude': lambda f: f is None }})  
