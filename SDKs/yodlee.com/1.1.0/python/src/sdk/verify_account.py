...
class VerifyAccount:
    ...
    def initiate_account_verification(self, request: operations.InitiateAccountVerificationRequest) -> operations.InitiateAccountVerificationResponse:
        r"""Verify Accounts Using Transactions
        ...
        url = utils.generate_url(base_url, "/verifyAccount/{providerAccountId}", request.path_params)
        ...
        res = operations.InitiateAccountVerificationResponse(status_code=r.status_code, content_type=content_type)
