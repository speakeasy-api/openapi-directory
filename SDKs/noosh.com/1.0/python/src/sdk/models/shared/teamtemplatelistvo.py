...
class TeamTemplateListVO:
    r"""Java type: com.noosh.nooshapi.vo.TeamTemplateListVO"""
    
    results: Optional[list[shared_teamtemplatesimplevo.TeamTemplateSimpleVO]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
