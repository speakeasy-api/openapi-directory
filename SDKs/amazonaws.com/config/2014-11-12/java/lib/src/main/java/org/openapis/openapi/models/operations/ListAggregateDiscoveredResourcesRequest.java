...
public class ListAggregateDiscoveredResourcesRequest {
    ...
    public ListAggregateDiscoveredResourcesRequest(@JsonProperty("ListAggregateDiscoveredResourcesRequest") org.openapis.openapi.models.shared.ListAggregateDiscoveredResourcesRequest listAggregateDiscoveredResourcesRequest, @JsonProperty("X-Amz-Target") ListAggregateDiscoveredResourcesXAmzTargetEnum xAmzTarget) {
        this.listAggregateDiscoveredResourcesRequest = listAggregateDiscoveredResourcesRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
