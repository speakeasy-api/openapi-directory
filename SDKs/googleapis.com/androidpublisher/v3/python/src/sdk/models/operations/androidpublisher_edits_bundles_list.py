...
from ..shared import security as shared_security
from ..shared import bundleslistresponse as shared_bundleslistresponse
...
class AndroidpublisherEditsBundlesListRequest:
    path_params: AndroidpublisherEditsBundlesListPathParams = dataclasses.field()
    query_params: AndroidpublisherEditsBundlesListQueryParams = dataclasses.field()
    security: AndroidpublisherEditsBundlesListSecurity = dataclasses.field()
...
class AndroidpublisherEditsBundlesListResponse:
    ...
    bundles_list_response: Optional[shared_bundleslistresponse.BundlesListResponse] = dataclasses.field(default=None)
