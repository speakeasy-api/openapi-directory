 ...
 */
export enum InstanceGroupListWarningCodeEnum {
...
export class InstanceGroupListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceGroupListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceGroupListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class InstanceGroupList extends SpeakeasyBase {
  /**
