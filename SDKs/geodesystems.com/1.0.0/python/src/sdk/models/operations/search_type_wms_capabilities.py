...
class SearchTypeWmsCapabilitiesQueryParams:
...
@dataclasses.dataclass
class SearchTypeWmsCapabilitiesRequest:
    query_params: SearchTypeWmsCapabilitiesQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeWmsCapabilitiesResponse:
