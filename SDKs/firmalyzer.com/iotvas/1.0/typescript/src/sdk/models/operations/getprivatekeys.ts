...
export class GetPrivateKeysSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetPrivateKeysRequest extends SpeakeasyBase {
  /**
...
export class GetPrivateKeysResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
