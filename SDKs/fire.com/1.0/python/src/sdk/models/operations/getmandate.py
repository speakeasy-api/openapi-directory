...
class GetMandateMandateCurrencyCodeEnum(str, Enum):
...
@dataclasses.dataclass
class GetMandateMandateCurrency:
    r"""The currency."""
    
    code: Optional[GetMandateMandateCurrencyCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})
    r"""The three letter code for the currency - either `EUR` or `GBP`."""  
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('description'), 'exclude': lambda f: f is None }})
    r"""The name of the currency"""  
    
class GetMandateMandateFireRejectionReasonEnum(str, Enum):
...
class GetMandateMandateStatusEnum(str, Enum):
...
class GetMandateMandate:
    r"""Retrieve all details for a direct debit mandate."""
    ...
    currency: Optional[GetMandateMandateCurrency] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('currency'), 'exclude': lambda f: f is None }})
    r"""The currency."""  
    ...
    fire_rejection_reason: Optional[GetMandateMandateFireRejectionReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fireRejectionReason'), 'exclude': lambda f: f is None }})
    r"""Rejection reason if transaction is rejected"""  
    ...
    status: Optional[GetMandateMandateStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The status of the mandate.
    * 'CREATED'
    * 'LIVE'
    * 'REJECT_REQUESTED'
...
class GetMandateResponse:
    ...
    mandate: Optional[GetMandateMandate] = dataclasses.field(default=None)
    r"""Retrieve all details for a direct debit mandate."""  
