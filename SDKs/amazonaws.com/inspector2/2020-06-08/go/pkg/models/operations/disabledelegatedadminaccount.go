...
type DisableDelegatedAdminAccountHeaders struct {
...
type DisableDelegatedAdminAccountRequest struct {
	Headers DisableDelegatedAdminAccountHeaders
	Request DisableDelegatedAdminAccountRequestBody `request:"mediaType=application/json"`
}
