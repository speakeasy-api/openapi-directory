...
class SetVaultNotificationsRequestBody:
    ...
    vault_notification_config: Optional[SetVaultNotificationsRequestBodyVaultNotificationConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('vaultNotificationConfig'), 'exclude': lambda f: f is None }})
    r"""Represents a vault's notification configuration."""  
...
class SetVaultNotificationsRequest:
    ...
    request_body: SetVaultNotificationsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
