...
type TagmanagerAccountsContainersVersionsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type TagmanagerAccountsContainersVersionsCreatePathParams struct {
	// The GTM Account ID.
...
type TagmanagerAccountsContainersVersionsCreateQueryParams struct {
	// V1 error format.
...
type TagmanagerAccountsContainersVersionsCreateRequest struct {
...
type TagmanagerAccountsContainersVersionsCreateResponse struct {
	ContentType string
	// Successful response
