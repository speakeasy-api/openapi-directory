...
class JobScheduleGetRequest:
    headers: JobScheduleGetHeaders = dataclasses.field()
    path_params: JobScheduleGetPathParams = dataclasses.field()
    query_params: JobScheduleGetQueryParams = dataclasses.field()
...
class JobScheduleGetResponse:
    ...
    cloud_job_schedule: Optional[Any] = dataclasses.field(default=None)
