...
class SearchTypeDbTableQueryParams:
...
@dataclasses.dataclass
class SearchTypeDbTableRequest:
    query_params: SearchTypeDbTableQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeDbTableResponse:
