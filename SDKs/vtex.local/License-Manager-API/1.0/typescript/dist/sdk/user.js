...
var User = /** @class */ (function () {
    ...
    User.prototype.createUser = function (req, config) {
        ...
        var url = baseURL.replace(/\/$/, "") + "/api/license-manager/users";
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.createUser400ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.CreateUser400ApplicationJSON);
                    }
                    break;
            }
            return res;
     ...
     */
    User.prototype.getListUsers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    User.prototype.getUser = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/license-manager/users/{userId}", req);
        var client = this._securityClient || this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req)), config === null || config === void 0 ? void 0 : config.headers);
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getUser400ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetUser400ApplicationJSON);
                    }
                    break;
