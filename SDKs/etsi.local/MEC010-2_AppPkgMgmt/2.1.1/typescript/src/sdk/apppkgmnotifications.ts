...
export class AppPkgmNotifications {
  ...
  appPkgNotificationPOST(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/user_defined_notification";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AppPkgNotificationPOSTResponse =
        new operations.AppPkgNotificationPOSTResponse({
