...
class GetLaunchConfigurationRequestBody:
    ...
    r"""Request to get Launch Configuration information by Source Server ID."""  
    

@dataclasses.dataclass
class GetLaunchConfigurationRequest:
    
    request_body: GetLaunchConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
