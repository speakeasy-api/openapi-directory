...
class SearchTypeExtremesQueryParams:
    ...
    search_type_extremes_region: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_extremes.region', 'style': 'form', 'explode': True }})
    search_type_extremes_variable: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_extremes.variable', 'style': 'form', 'explode': True }})
...
class SearchTypeExtremesRequest:
    query_params: SearchTypeExtremesQueryParams = dataclasses.field()
