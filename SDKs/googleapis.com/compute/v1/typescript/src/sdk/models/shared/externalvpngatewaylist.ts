 ...
 */
export enum ExternalVpnGatewayListWarningCodeEnum {
...
export class ExternalVpnGatewayListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ExternalVpnGatewayListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: ExternalVpnGatewayListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: ExternalVpnGatewayListWarningData })
  @Expose({ name: "data" })
  @Type(() => ExternalVpnGatewayListWarningData)
  data?: ExternalVpnGatewayListWarningData[];
 ...
 */
export class ExternalVpnGatewayList extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "etag" })
  etag?: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: ExternalVpnGateway })
  @Expose({ name: "items" })
