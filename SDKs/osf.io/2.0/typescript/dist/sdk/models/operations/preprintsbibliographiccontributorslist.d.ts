...
export declare class PreprintsBibliographicContributorsListRequest extends SpeakeasyBase {
    /**
 ...
 */
export declare enum PreprintsBibliographicContributorsListContributorAttributesPermissionEnum {
    Read = "read",
    Write = "write",
    Admin = "admin"
}
 ...
 */
export declare class PreprintsBibliographicContributorsListContributorAttributes extends SpeakeasyBase {
    /**
 ...
 */
export declare class PreprintsBibliographicContributorsListContributorLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class PreprintsBibliographicContributorsListContributorRelationships extends SpeakeasyBase {
    /**
...
export declare class PreprintsBibliographicContributorsListContributor extends SpeakeasyBase {
    /**
     * The properties of the contributor entity.
     */
...
export declare class PreprintsBibliographicContributorsListResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
