...
export class GetResponseHeadersPolicyConfig20200531Request extends SpeakeasyBase {
  /**
...
export class GetResponseHeadersPolicyConfig20200531Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
