...
try {
    ...
    $request->projectId = 844235;
    $request->username = 'Hyman.Conn30';
...
try {
    ...
    $request->requestBody->name = 'Camille Crist';
    $request->org = 'velit';
...
try {
    ...
    $request->requestBody->name = 'Dr. Gina Jaskolski';
    $request->owner = 'eum';
    $request->repo = 'velit';
...
try {
    ...
    $request->projectId = 610987;
    $request->username = 'Torey_Abernathy';
...
try {
    ...
    $request->columnId = 673838;
    $request->page = 250398;
    $request->perPage = 224467;
...
try {
    ...
    $request->page = 639705;
    $request->perPage = 927403;
    $request->projectId = 408303;
...
try {
    ...
    $request->page = 351936;
    $request->perPage = 600193;
    $request->state = ProjectsListForUserStateEnum::ALL;
    $request->username = 'Madeline.Russel';
...
try {
    ...
    $request->projectId = 456885;
    $request->username = 'Edwin.Bogan11';
