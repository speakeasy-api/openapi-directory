 ...
 */
export declare enum CreateVerifiedAccessGroupRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateVerifiedAccessGroupRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateVerifiedAccessGroupRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateVerifiedAccessGroupRequest extends SpeakeasyBase {
    clientToken?: string;
    description?: string;
    dryRun?: boolean;
