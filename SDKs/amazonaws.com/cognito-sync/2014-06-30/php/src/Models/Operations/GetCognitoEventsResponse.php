...
class GetCognitoEventsResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetCognitoEventsResponse $getCognitoEventsResponse
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetCognitoEventsResponse $getCognitoEventsResponse = null;
	...
	{
		$this->contentType = "";
		$this->getCognitoEventsResponse = null;
