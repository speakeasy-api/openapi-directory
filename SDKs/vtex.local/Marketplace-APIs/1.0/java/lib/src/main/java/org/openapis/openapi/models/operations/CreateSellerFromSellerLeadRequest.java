...
public class CreateSellerFromSellerLeadRequest {
    ...
    public CreateSellerFromSellerLeadRequest(@JsonProperty("Accept") String accept, @JsonProperty("Content-Type") String contentType, @JsonProperty("accountName") String accountName, @JsonProperty("environment") String environment, @JsonProperty("isActive") Boolean isActive, @JsonProperty("sellerLeadId") String sellerLeadId) {
        this.accept = accept;
        this.contentType = contentType;
        this.accountName = accountName;
        this.environment = environment;
