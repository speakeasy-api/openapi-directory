...
func (e GetNetworkEventsProductTypeEnum) ToPointer() *GetNetworkEventsProductTypeEnum {
	return &e
}
...
func (e *GetNetworkEventsProductTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "systemsManager":
		fallthrough
	case "wireless":
		*e = GetNetworkEventsProductTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkEventsProductTypeEnum: %v", v)
	}
}
