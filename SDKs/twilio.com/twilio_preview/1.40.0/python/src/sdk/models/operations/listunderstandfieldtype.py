...
class ListUnderstandFieldTypeListUnderstandFieldTypeResponse:
    ...
    field_types: Optional[list[shared_preview_understand_assistant_field_type.PreviewUnderstandAssistantFieldType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('field_types'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListUnderstandFieldTypeListUnderstandFieldTypeResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
