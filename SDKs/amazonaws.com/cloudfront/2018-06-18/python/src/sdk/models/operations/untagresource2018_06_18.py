...
class UntagResource20180618QueryParams:
    operation: UntagResource20180618OperationEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
...
class UntagResource20180618Request:
    headers: UntagResource20180618Headers = dataclasses.field()
    query_params: UntagResource20180618QueryParams = dataclasses.field()
