...
import dataclasses
from ..shared import tasksimplevo as shared_tasksimplevo
...
class TaskListVO:
    r"""Java type: com.noosh.nooshapi.vo.TaskListVO"""
    
    results: Optional[list[shared_tasksimplevo.TaskSimpleVO]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
