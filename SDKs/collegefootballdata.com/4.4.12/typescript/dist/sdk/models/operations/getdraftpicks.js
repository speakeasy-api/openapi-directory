...
exports.GetDraftPicksResponse = exports.GetDraftPicksRequest = void 0;
...
var GetDraftPicksRequest = /** @class */ (function (_super) {
    ...
    ], GetDraftPicksRequest.prototype, "college", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=conference",
        }),
        __metadata("design:type", String)
    ], GetDraftPicksRequest.prototype, "conference", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=nflTeam",
        }),
        __metadata("design:type", String)
    ], GetDraftPicksRequest.prototype, "nflTeam", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=position",
        }),
        __metadata("design:type", String)
    ], GetDraftPicksRequest.prototype, "position", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=year" }),
        __metadata("design:type", Number)
    ], GetDraftPicksRequest.prototype, "year", void 0);
    return GetDraftPicksRequest;
}(utils_1.SpeakeasyBase));
exports.GetDraftPicksRequest = GetDraftPicksRequest;
var GetDraftPicksResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.DraftPick }),
    ...
    ], GetDraftPicksResponse.prototype, "rawResponse", void 0);
    return GetDraftPicksResponse;
}(utils_1.SpeakeasyBase));
exports.GetDraftPicksResponse = GetDraftPicksResponse;
