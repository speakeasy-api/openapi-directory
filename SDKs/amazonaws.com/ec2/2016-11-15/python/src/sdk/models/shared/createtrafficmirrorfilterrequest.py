...
class CreateTrafficMirrorFilterRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateTrafficMirrorFilterRequestTagSpecifications:
    ...
    resource_type: Optional[CreateTrafficMirrorFilterRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateTrafficMirrorFilterRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateTrafficMirrorFilterRequest:
    ...
    tag_specifications: Optional[list[CreateTrafficMirrorFilterRequestTagSpecifications]] = dataclasses.field(default=None)  
