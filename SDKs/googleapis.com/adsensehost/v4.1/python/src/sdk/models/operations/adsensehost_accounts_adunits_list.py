...
class AdsensehostAccountsAdunitsListRequest:
    path_params: AdsensehostAccountsAdunitsListPathParams = dataclasses.field()
    query_params: AdsensehostAccountsAdunitsListQueryParams = dataclasses.field()
    security: AdsensehostAccountsAdunitsListSecurity = dataclasses.field()
