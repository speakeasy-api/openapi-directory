...
func (s *Operations) VaultOperationsCancel(ctx context.Context, request operations.VaultOperationsCancelRequest) (*operations.VaultOperationsCancelResponse, error) {
	...
	res := &operations.VaultOperationsCancelResponse{
...
func (s *Operations) VaultOperationsDelete(ctx context.Context, request operations.VaultOperationsDeleteRequest) (*operations.VaultOperationsDeleteResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.VaultOperationsDeleteResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Operations) VaultOperationsList(ctx context.Context, request operations.VaultOperationsListRequest) (*operations.VaultOperationsListResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{name}", request.PathParams)
	...
	res := &operations.VaultOperationsListResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
