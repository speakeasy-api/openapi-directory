...
class SearchRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\SearchQParserEnum $qParser
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=q.parser')]
    public ?SearchQParserEnum $qParser = null;
	...
	public function __construct()
	{
		...
		$this->expr = null;
		$this->facet = null;
		$this->format = \OpenAPI\OpenAPI\Models\Operations\SearchFormatEnum::SDK;
		$this->fq = null;
		$this->highlight = null;
		$this->partial = null;
		$this->pretty = \OpenAPI\OpenAPI\Models\Operations\SearchPrettyEnum::TRUE;
		$this->q = "";
		$this->qOptions = null;
		$this->qParser = null;
		$this->return = null;
