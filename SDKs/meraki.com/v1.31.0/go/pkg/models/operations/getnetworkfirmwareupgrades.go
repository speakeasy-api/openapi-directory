...
func (e *GetNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowDayOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "wed":
		fallthrough
	case "wednesday":
		*e = GetNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowDayOfWeekEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowDayOfWeekEnum: %s", s)
	}
}
...
func (e *GetNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowHourOfDayEnum) UnmarshalJSON(data []byte) error {
	...
	case "8:00":
		fallthrough
	case "9:00":
		*e = GetNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowHourOfDayEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkFirmwareUpgrades200ApplicationJSONUpgradeWindowHourOfDayEnum: %s", s)
	}
}
