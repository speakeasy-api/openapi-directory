...
class ListAssessmentTargetsRequest:
    ...
    list_assessment_targets_request: shared_listassessmenttargetsrequest.ListAssessmentTargetsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
