...
public class DeleteConsentRequest {
    ...
    public DeleteConsentRequest withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public DeleteConsentRequest withPSUAccept(String psuAccept) {
    ...
    public DeleteConsentRequest withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public DeleteConsentRequest withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public DeleteConsentRequest withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public DeleteConsentRequest withPSUDeviceID(String psuDeviceID) {
    ...
    public DeleteConsentRequest withPSUGeoLocation(String psuGeoLocation) {
    ...
    public DeleteConsentRequest withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public DeleteConsentRequest withPSUIPAddress(String psuIPAddress) {
    ...
    public DeleteConsentRequest withPSUIPPort(String psuIPPort) {
    ...
    public DeleteConsentRequest withPSUUserAgent(String psuUserAgent) {
    ...
    public DeleteConsentRequest withSignature(String signature) {
    ...
    public DeleteConsentRequest withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public DeleteConsentRequest withXRequestID(String xRequestID) {
    ...
    public DeleteConsentRequest withConsentId(String consentId) {
        this.consentId = consentId;
        return this;
    }
    
    public DeleteConsentRequest(@JsonProperty("X-Request-ID") String xRequestID, @JsonProperty("consentId") String consentId) {
        this.xRequestID = xRequestID;
        this.consentId = consentId;
  }
}
