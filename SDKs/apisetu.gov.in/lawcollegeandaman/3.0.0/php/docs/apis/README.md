...
use \OpenAPI\OpenAPI\Models\Operations\TrcerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\TrcerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\TrcerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\TrcerSecurity;
...
try {
    ...
    $request->certificateParameters = new TrcerRequestBodyCertificateParameters();
    $request->certificateParameters->admnNo = '12345';
    ...
    $request->format = TrcerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new TrcerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->trcer($request, $requestSecurity);
