...
public class Hosted {
     ...
     */
    public org.openapis.openapi.models.operations.GetHostedResponse getHosted() throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/hosted");
