...
export declare enum PafAddressCountryEnum {
    England = "England",
    Scotland = "Scotland",
    Wales = "Wales",
...
export declare enum PafAddressCountryIsoEnum {
    Gbr = "GBR",
    Imn = "IMN",
    Jey = "JEY",
    Ggy = "GGY"
}
export declare enum PafAddressCountryIso2Enum {
    Gb = "GB",
    Im = "IM",
    Je = "JE",
    Gg = "GG"
}
export declare enum PafAddressDatasetEnum {
    Paf = "paf"
}
export declare enum PafAddressLanguageEnum {
    En = "en"
}
/**
 ...
 */
export declare class PafAddress extends SpeakeasyBase {
    /**
    ...
    country: PafAddressCountryEnum;
    countryIso: PafAddressCountryIsoEnum;
    countryIso2: PafAddressCountryIso2Enum;
    /**
     ...
     */
    id: string;
    language: PafAddressLanguageEnum;
    /**
