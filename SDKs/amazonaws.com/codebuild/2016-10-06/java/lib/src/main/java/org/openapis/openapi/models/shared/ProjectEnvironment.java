...
public class ProjectEnvironment {
    ...
    public ProjectEnvironment(@JsonProperty("computeType") ComputeTypeEnum computeType, @JsonProperty("image") String image, @JsonProperty("type") EnvironmentTypeEnum type) {
        this.computeType = computeType;
        this.image = image;
        this.type = type;
  }
