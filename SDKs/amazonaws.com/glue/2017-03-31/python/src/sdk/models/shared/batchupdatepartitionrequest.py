...
class BatchUpdatePartitionRequest:
    ...
    entries: list[shared_batchupdatepartitionrequestentry.BatchUpdatePartitionRequestEntry] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Entries') }})  
