 ...
 */
export enum DependabotAlertDependencyScopeEnum {
 ...
 */
export class DependabotAlertDependency extends SpeakeasyBase {
  /**
 ...
 */
export enum DependabotAlertDismissedReasonEnum {
 ...
 */
export enum DependabotAlertStateEnum {
  Dismissed = "dismissed",
  Fixed = "fixed",
  Open = "open",
}
 ...
 * A Dependabot alert.
 */
export class DependabotAlert extends SpeakeasyBase {
  /**
  ...
  @Type(() => DependabotAlertDependency)
