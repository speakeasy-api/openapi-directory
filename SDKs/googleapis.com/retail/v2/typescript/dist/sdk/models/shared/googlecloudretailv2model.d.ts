 ...
 */
export declare enum GoogleCloudRetailV2ModelDataStateEnum {
 ...
 */
export declare enum GoogleCloudRetailV2ModelFilteringOptionEnum {
 ...
 */
export declare enum GoogleCloudRetailV2ModelPeriodicTuningStateEnum {
 ...
 */
export declare enum GoogleCloudRetailV2ModelServingStateEnum {
 ...
 */
export declare enum GoogleCloudRetailV2ModelTrainingStateEnum {
 ...
 */
export declare class GoogleCloudRetailV2Model extends SpeakeasyBase {
    /**
 ...
 * Metadata that describes the training and serving parameters of a Model. A Model can be associated with a ServingConfig and then queried through the Predict API.
 */
export declare class GoogleCloudRetailV2ModelInput extends SpeakeasyBase {
    /**
     * Required. The display name of the model. Should be human readable, used to display Recommendation Models in the Retail Cloud Console Dashboard. UTF-8 encoded string with limit of 1024 characters.
     */
    displayName?: string;
