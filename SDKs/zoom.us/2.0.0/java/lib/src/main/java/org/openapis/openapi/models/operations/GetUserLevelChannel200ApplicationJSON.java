...
public class GetUserLevelChannel200ApplicationJSON {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    public GetUserLevelChannel200ApplicationJSONTypeEnum type;
    public GetUserLevelChannel200ApplicationJSON withType(GetUserLevelChannel200ApplicationJSONTypeEnum type) {
        this.type = type;
        return this;
    }
