...
from ..shared import userrolepermissiongroupslistresponse as shared_userrolepermissiongroupslistresponse
...
class DfareportingUserRolePermissionGroupsListResponse:
    ...
    user_role_permission_groups_list_response: Optional[shared_userrolepermissiongroupslistresponse.UserRolePermissionGroupsListResponse] = dataclasses.field(default=None)
