...
class AttributeInput:
    ...
    r"""Required. The resource name for this attribute."""  
    ...
    uri_values: Optional[list[shared_uriattributevalue.URIAttributeValue]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('uriValues'), 'exclude': lambda f: f is None }})
    ...
    r"""The values for this attribute. The type of the values supplied must match that expected for that attribute. This is a repeated field where multiple attribute values may be provided. Attribute types only support one value."""  
