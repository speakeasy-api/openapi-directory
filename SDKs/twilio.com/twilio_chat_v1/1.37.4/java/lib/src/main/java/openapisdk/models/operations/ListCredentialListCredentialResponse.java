...
public class ListCredentialListCredentialResponse {
    ...
    public openapisdk.models.shared.ChatV1Credential[] credentials;
    public ListCredentialListCredentialResponse withCredentials(openapisdk.models.shared.ChatV1Credential[] credentials) {
