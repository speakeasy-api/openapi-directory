...
class DescribeLogPatternRequest:
    ...
    describe_log_pattern_request: shared_describelogpatternrequest.DescribeLogPatternRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
