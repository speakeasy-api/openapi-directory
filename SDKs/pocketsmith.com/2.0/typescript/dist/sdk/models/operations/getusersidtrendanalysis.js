...
exports.GetUsersIdTrendAnalysisResponse = exports.GetUsersIdTrendAnalysisRequest = exports.GetUsersIdTrendAnalysisPeriodEnum = void 0;
 ...
 */
var GetUsersIdTrendAnalysisPeriodEnum;
...
})(GetUsersIdTrendAnalysisPeriodEnum = exports.GetUsersIdTrendAnalysisPeriodEnum || (exports.GetUsersIdTrendAnalysisPeriodEnum = {}));
var GetUsersIdTrendAnalysisRequest = /** @class */ (function (_super) {
    ...
    ], GetUsersIdTrendAnalysisRequest.prototype, "categories", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=end_date",
        }),
        __metadata("design:type", String)
    ], GetUsersIdTrendAnalysisRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetUsersIdTrendAnalysisRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=interval",
        }),
        __metadata("design:type", Number)
    ], GetUsersIdTrendAnalysisRequest.prototype, "interval", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=period",
        }),
        __metadata("design:type", String)
    ], GetUsersIdTrendAnalysisRequest.prototype, "period", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=scenarios",
        }),
        __metadata("design:type", String)
    ], GetUsersIdTrendAnalysisRequest.prototype, "scenarios", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=start_date",
        }),
        __metadata("design:type", String)
    ], GetUsersIdTrendAnalysisRequest.prototype, "startDate", void 0);
    return GetUsersIdTrendAnalysisRequest;
}(utils_1.SpeakeasyBase));
exports.GetUsersIdTrendAnalysisRequest = GetUsersIdTrendAnalysisRequest;
var GetUsersIdTrendAnalysisResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.BudgetAnalysisPackage }),
    ...
    ], GetUsersIdTrendAnalysisResponse.prototype, "error", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Number)
    ...
    ], GetUsersIdTrendAnalysisResponse.prototype, "rawResponse", void 0);
    return GetUsersIdTrendAnalysisResponse;
}(utils_1.SpeakeasyBase));
exports.GetUsersIdTrendAnalysisResponse = GetUsersIdTrendAnalysisResponse;
