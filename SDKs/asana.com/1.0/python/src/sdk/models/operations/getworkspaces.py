...
class GetWorkspaces200ApplicationJSON:
    r"""Return all workspaces visible to the authorized user."""
    
    data: Optional[list[shared_workspacecompact.WorkspaceCompact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
