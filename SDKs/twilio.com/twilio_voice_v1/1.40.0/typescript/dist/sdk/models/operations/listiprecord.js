...
exports.ListIpRecordResponse = exports.ListIpRecordListIpRecordResponse = exports.ListIpRecordListIpRecordResponseMeta = exports.ListIpRecordRequest = exports.ListIpRecordSecurity = exports.ListIpRecordServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListIpRecordServerList = ["https://voice.twilio.com"];
var ListIpRecordSecurity = /** @class */ (function (_super) {
    ...
    ], ListIpRecordSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListIpRecordSecurity.prototype, "username", void 0);
    return ListIpRecordSecurity;
}(utils_1.SpeakeasyBase));
exports.ListIpRecordSecurity = ListIpRecordSecurity;
var ListIpRecordRequest = /** @class */ (function (_super) {
    ...
    ], ListIpRecordRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListIpRecordRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListIpRecordRequest.prototype, "pageToken", void 0);
    return ListIpRecordRequest;
}(utils_1.SpeakeasyBase));
exports.ListIpRecordRequest = ListIpRecordRequest;
...
exports.ListIpRecordListIpRecordResponseMeta = ListIpRecordListIpRecordResponseMeta;
/**
 * OK
 */
var ListIpRecordListIpRecordResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.VoiceV1IpRecord }),
        (0, class_transformer_1.Expose)({ name: "ip_records" }),
        (0, class_transformer_1.Type)(function () { return shared.VoiceV1IpRecord; }),
        __metadata("design:type", Array)
    ], ListIpRecordListIpRecordResponse.prototype, "ipRecords", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListIpRecordListIpRecordResponseMeta; }),
...
exports.ListIpRecordListIpRecordResponse = ListIpRecordListIpRecordResponse;
var ListIpRecordResponse = /** @class */ (function (_super) {
    ...
    ], ListIpRecordResponse.prototype, "rawResponse", void 0);
    return ListIpRecordResponse;
}(utils_1.SpeakeasyBase));
exports.ListIpRecordResponse = ListIpRecordResponse;
