...
type DrivelabelsLabelsRevisionsPermissionsBatchUpdateRequest struct {
	...
	GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsRequest *shared.GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsRequest `request:"mediaType=application/json"`
	// OAuth access token.
...
type DrivelabelsLabelsRevisionsPermissionsBatchUpdateResponse struct {
	ContentType string
	// Successful response
	GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsResponse *shared.GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsResponse
	StatusCode                                                 int
