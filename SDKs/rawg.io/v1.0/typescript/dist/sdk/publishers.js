...
var Publishers = /** @class */ (function () {
    function Publishers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Publishers.prototype.publishersList = function (req, config) {
    ...
    **/
    Publishers.prototype.publishersRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
