 ...
 * 
 */
public class GetAccountLockSettings200ApplicationJSON1RecordingIpAddressAccessControl {
    /**
    ...
    public GetAccountLockSettings200ApplicationJSON1RecordingIpAddressAccessControl withEnable(Boolean enable) {
        this.enable = enable;
        return this;
    }
    ...
    public GetAccountLockSettings200ApplicationJSON1RecordingIpAddressAccessControl withIpAddressesOrRanges(String ipAddressesOrRanges) {
