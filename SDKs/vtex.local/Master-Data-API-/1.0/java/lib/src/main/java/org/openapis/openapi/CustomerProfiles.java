...
public class CustomerProfiles {
	...
	public CustomerProfiles(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
     ...
     */
    public org.openapis.openapi.models.operations.CreateNewCustomerProfilev2Response createNewCustomerProfilev2(org.openapis.openapi.models.operations.CreateNewCustomerProfilev2Request request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/api/dataentities/Client/documents");
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "createUpdateProfileRequests", "json");
        if (serializedRequestBody == null) {
            throw new Exception("Request body is required");
        }
        req.setBody(serializedRequestBody);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.CreateNewCustomerProfilev2Request.class, request, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.DeleteCustomerProfileResponse deleteCustomerProfile(org.openapis.openapi.models.operations.DeleteCustomerProfileRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.DeleteCustomerProfileRequest.class, baseUrl, "/api/dataentities/Client/documents/{id}", request, null);
    ...
    public org.openapis.openapi.models.operations.UpdateCustomerProfileResponse updateCustomerProfile(org.openapis.openapi.models.operations.UpdateCustomerProfileRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.UpdateCustomerProfileRequest.class, baseUrl, "/api/dataentities/Client/documents/{id}", request, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.UpdateCustomerProfileRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
