...
func main() {
    ...
    res, err := s.APIs.Licer(ctx, operations.LicerRequestBody{
        ...
        Format: operations.LicerRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.LicerSecurity{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Prcpt(ctx, operations.PrcptRequestBody{
        CertificateParameters: &operations.PrcptRequestBodyCertificateParameters{
            FullName: "Sunil Kumar",
            PiDob: "28-01-2016",
            PiFinYear: "Previous Year, Current Year",
            PiPolicynbr: "C000000217",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
            Consent: shared.ConsentArtifactSchemaConsent{
                ConsentID: "ea9c43aa-7f5a-4bf3-a0be-e1caa24737ba",
        ...
        Format: operations.PrcptRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.PrcptSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
