...
class GoogleCloudDialogflowV2NotificationConfig:
    ...
    message_format: Optional[GoogleCloudDialogflowV2NotificationConfigMessageFormatEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('messageFormat'), 'exclude': lambda f: f is None }})
    r"""Format of message."""  
