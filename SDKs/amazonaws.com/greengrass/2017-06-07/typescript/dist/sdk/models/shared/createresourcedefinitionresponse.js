...
exports.CreateResourceDefinitionResponse = void 0;
...
var CreateResourceDefinitionResponse = /** @class */ (function (_super) {
    ...
    ], CreateResourceDefinitionResponse.prototype, "arn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CreationTimestamp" }),
        __metadata("design:type", String)
    ], CreateResourceDefinitionResponse.prototype, "creationTimestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Id" }),
        __metadata("design:type", String)
    ], CreateResourceDefinitionResponse.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=LastUpdatedTimestamp" }),
        __metadata("design:type", String)
    ], CreateResourceDefinitionResponse.prototype, "lastUpdatedTimestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=LatestVersion" }),
        __metadata("design:type", String)
    ], CreateResourceDefinitionResponse.prototype, "latestVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=LatestVersionArn" }),
        __metadata("design:type", String)
    ], CreateResourceDefinitionResponse.prototype, "latestVersionArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], CreateResourceDefinitionResponse.prototype, "name", void 0);
