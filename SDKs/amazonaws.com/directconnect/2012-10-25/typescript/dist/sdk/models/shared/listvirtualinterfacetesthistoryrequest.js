...
exports.ListVirtualInterfaceTestHistoryRequest = void 0;
...
var ListVirtualInterfaceTestHistoryRequest = /** @class */ (function (_super) {
    ...
    ], ListVirtualInterfaceTestHistoryRequest.prototype, "bgpPeers", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=maxResults" }),
        __metadata("design:type", Number)
    ], ListVirtualInterfaceTestHistoryRequest.prototype, "maxResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=nextToken" }),
        __metadata("design:type", String)
    ], ListVirtualInterfaceTestHistoryRequest.prototype, "nextToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=status" }),
        __metadata("design:type", String)
    ], ListVirtualInterfaceTestHistoryRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=testId" }),
        __metadata("design:type", String)
    ], ListVirtualInterfaceTestHistoryRequest.prototype, "testId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=virtualInterfaceId" }),
        __metadata("design:type", String)
    ], ListVirtualInterfaceTestHistoryRequest.prototype, "virtualInterfaceId", void 0);
