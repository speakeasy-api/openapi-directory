...
from ..shared import user_usermembershipdata as shared_user_usermembershipdata
from typing import Optional


@dataclasses.dataclass
class UserGetMembershipDataForCurrentUser200Wildcard:
    ...
    response: Optional[shared_user_usermembershipdata.UserUserMembershipData] = dataclasses.field(default=None)  
