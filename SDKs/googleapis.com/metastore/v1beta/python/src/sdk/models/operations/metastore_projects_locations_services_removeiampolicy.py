...
class MetastoreProjectsLocationsServicesRemoveIamPolicyRequest:
    path_params: MetastoreProjectsLocationsServicesRemoveIamPolicyPathParams = dataclasses.field()
    query_params: MetastoreProjectsLocationsServicesRemoveIamPolicyQueryParams = dataclasses.field()
    security: MetastoreProjectsLocationsServicesRemoveIamPolicySecurity = dataclasses.field()
