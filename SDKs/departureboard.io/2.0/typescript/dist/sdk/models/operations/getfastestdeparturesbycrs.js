...
exports.GetFastestDeparturesByCRSResponse = exports.GetFastestDeparturesByCRSRequest = void 0;
...
var GetFastestDeparturesByCRSRequest = /** @class */ (function (_super) {
    ...
    ], GetFastestDeparturesByCRSRequest.prototype, "crs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=apiKey",
        }),
        __metadata("design:type", String)
    ], GetFastestDeparturesByCRSRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filterList",
        }),
        __metadata("design:type", String)
    ], GetFastestDeparturesByCRSRequest.prototype, "filterList", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=serviceDetails",
        }),
        __metadata("design:type", Boolean)
    ], GetFastestDeparturesByCRSRequest.prototype, "serviceDetails", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeOffset",
        }),
        __metadata("design:type", Number)
    ], GetFastestDeparturesByCRSRequest.prototype, "timeOffset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeWindow",
        }),
        __metadata("design:type", Number)
    ], GetFastestDeparturesByCRSRequest.prototype, "timeWindow", void 0);
...
var GetFastestDeparturesByCRSResponse = /** @class */ (function (_super) {
    ...
    ], GetFastestDeparturesByCRSResponse.prototype, "rawResponse", void 0);
