...
public class OtcerSecurity {
    ...
    public OtcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public OtcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public OtcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
