...
public class SecretmanagerProjectsSecretsVersionsDisableRequest {
    ...
    public openapisdk.models.shared.DisableSecretVersionRequest request;
    public SecretmanagerProjectsSecretsVersionsDisableRequest withRequest(openapisdk.models.shared.DisableSecretVersionRequest request) {
