...
export enum MrAddressCountryEnum {
  England = "England",
  Scotland = "Scotland",
  Wales = "Wales",
...
export enum MrAddressCountryIsoEnum {
  Gbr = "GBR",
  Imn = "IMN",
  Jey = "JEY",
  Ggy = "GGY",
...
export enum MrAddressCountryIso2Enum {
  Gb = "GB",
  Im = "IM",
  Je = "JE",
  Gg = "GG",
...
export enum MrAddressDatasetEnum {
  Mr = "mr",
}

export enum MrAddressLanguageEnum {
  En = "en",
}
 ...
 *
 */
export class MrAddress extends SpeakeasyBase {
  /**
