...
class Projects 
{
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/customClasses', \OpenAPI\OpenAPI\Models\Operations\SpeechProjectsLocationsCustomClassesListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\SpeechProjectsLocationsPhraseSetsDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\SpeechProjectsLocationsPhraseSetsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/phraseSets', \OpenAPI\OpenAPI\Models\Operations\SpeechProjectsLocationsPhraseSetsListRequest::class, $request);
