...
exports.GetDomesticScheduledPaymentsDomesticScheduledPaymentIdResponse = exports.GetDomesticScheduledPaymentsDomesticScheduledPaymentIdRequest = exports.GetDomesticScheduledPaymentsDomesticScheduledPaymentIdSecurity = void 0;
...
exports.GetDomesticScheduledPaymentsDomesticScheduledPaymentIdSecurity = GetDomesticScheduledPaymentsDomesticScheduledPaymentIdSecurity;
var GetDomesticScheduledPaymentsDomesticScheduledPaymentIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=DomesticScheduledPaymentId",
        }),
        __metadata("design:type", String)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdRequest.prototype, "domesticScheduledPaymentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdRequest.prototype, "xFapiInteractionId", void 0);
    return GetDomesticScheduledPaymentsDomesticScheduledPaymentIdRequest;
}(utils_1.SpeakeasyBase));
exports.GetDomesticScheduledPaymentsDomesticScheduledPaymentIdRequest = GetDomesticScheduledPaymentsDomesticScheduledPaymentIdRequest;
var GetDomesticScheduledPaymentsDomesticScheduledPaymentIdResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdResponse.prototype, "rawResponse", void 0);
    return GetDomesticScheduledPaymentsDomesticScheduledPaymentIdResponse;
}(utils_1.SpeakeasyBase));
exports.GetDomesticScheduledPaymentsDomesticScheduledPaymentIdResponse = GetDomesticScheduledPaymentsDomesticScheduledPaymentIdResponse;
