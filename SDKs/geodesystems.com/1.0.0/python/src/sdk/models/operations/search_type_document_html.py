...
class SearchTypeDocumentHTMLQueryParams:
...
@dataclasses.dataclass
class SearchTypeDocumentHTMLRequest:
    query_params: SearchTypeDocumentHTMLQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeDocumentHTMLResponse:
