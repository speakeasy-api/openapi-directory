...
public class FfcerSecurity {
    ...
    public FfcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public FfcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public FfcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
