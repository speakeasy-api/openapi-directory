...
class TerrainTile:
    r"""A tile containing information about the terrain located in the region it covers."""
    
    coordinates: Optional[shared_tilecoordinates.TileCoordinates] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('coordinates'), 'exclude': lambda f: f is None }})
    ...
    first_derivative: Optional[shared_firstderivativeelevationgrid.FirstDerivativeElevationGrid] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('firstDerivative'), 'exclude': lambda f: f is None }})
    ...
    r"""Resource name of the tile. The tile resource name is prefixed by its collection ID `terrain/` followed by the resource ID, which encodes the tile's global x and y coordinates and zoom level as `@,,z`. For example, `terrain/@1,2,3z`."""  
    second_derivative: Optional[shared_secondderivativeelevationgrid.SecondDerivativeElevationGrid] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('secondDerivative'), 'exclude': lambda f: f is None }})
