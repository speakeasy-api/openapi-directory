...
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeletePathParams:
...
@dataclasses.dataclass
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteQueryParams:
...
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteRequest:
    path_params: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeletePathParams = dataclasses.field()
    query_params: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteQueryParams = dataclasses.field()
    security: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteSecurity = dataclasses.field()
