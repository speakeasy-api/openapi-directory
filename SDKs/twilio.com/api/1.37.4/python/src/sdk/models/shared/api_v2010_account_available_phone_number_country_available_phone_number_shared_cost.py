...
class APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCostCapabilities:
    r"""APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCostCapabilities
...
class APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost:
    ...
    capabilities: Optional[APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCostCapabilities] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('capabilities') }})
