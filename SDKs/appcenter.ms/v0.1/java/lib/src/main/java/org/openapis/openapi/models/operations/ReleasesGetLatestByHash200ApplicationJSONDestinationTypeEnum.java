 ...
 * 
 */
public enum ReleasesGetLatestByHash200ApplicationJSONDestinationTypeEnum {
    GROUP("group"),
    STORE("store"),
    TESTER("tester");
    ...
    private ReleasesGetLatestByHash200ApplicationJSONDestinationTypeEnum(String value) {
        this.value = value;
    }
}
