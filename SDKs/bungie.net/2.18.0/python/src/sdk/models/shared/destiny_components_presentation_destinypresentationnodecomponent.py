...
class DestinyComponentsPresentationDestinyPresentationNodeComponent:
    ...
    completion_value: Optional[int] = dataclasses.field(default=None)
    r"""The value at which the presentation node is considered to be completed."""  
    objective: Optional[DestinyComponentsPresentationDestinyPresentationNodeComponentObjective] = dataclasses.field(default=None)
    r"""An optional property: presentation nodes MAY have objectives, which can be used to infer more human readable data about the progress. However, progressValue and completionValue ought to be considered the canonical values for progress on Progression Nodes."""  
    progress_value: Optional[int] = dataclasses.field(default=None)
    r"""How much of the presentation node is considered to be completed so far by the given character/profile."""  
    record_category_score: Optional[int] = dataclasses.field(default=None)
    r"""If available, this is the current score for the record category that this node represents."""  
