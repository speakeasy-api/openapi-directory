...
from ..shared import itvcurrentsubscription as shared_itvcurrentsubscription
...
class GetCurrentSubscriptionResponse:
    ...
    itv_current_subscription: Optional[shared_itvcurrentsubscription.ItvCurrentSubscription] = dataclasses.field(default=None)
