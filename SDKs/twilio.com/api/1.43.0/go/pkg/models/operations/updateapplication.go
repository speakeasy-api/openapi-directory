...
func (e UpdateApplicationUpdateApplicationRequestSmsFallbackMethodEnum) ToPointer() *UpdateApplicationUpdateApplicationRequestSmsFallbackMethodEnum {
	return &e
}
...
func (e *UpdateApplicationUpdateApplicationRequestSmsFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateApplicationUpdateApplicationRequestSmsFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateApplicationUpdateApplicationRequestSmsFallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateApplicationUpdateApplicationRequestSmsMethodEnum) ToPointer() *UpdateApplicationUpdateApplicationRequestSmsMethodEnum {
	return &e
}
...
func (e *UpdateApplicationUpdateApplicationRequestSmsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateApplicationUpdateApplicationRequestSmsMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateApplicationUpdateApplicationRequestSmsMethodEnum: %v", v)
	}
}
...
func (e UpdateApplicationUpdateApplicationRequestStatusCallbackMethodEnum) ToPointer() *UpdateApplicationUpdateApplicationRequestStatusCallbackMethodEnum {
	return &e
}
...
func (e *UpdateApplicationUpdateApplicationRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateApplicationUpdateApplicationRequestStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateApplicationUpdateApplicationRequestStatusCallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateApplicationUpdateApplicationRequestVoiceFallbackMethodEnum) ToPointer() *UpdateApplicationUpdateApplicationRequestVoiceFallbackMethodEnum {
	return &e
}
...
func (e *UpdateApplicationUpdateApplicationRequestVoiceFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateApplicationUpdateApplicationRequestVoiceFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateApplicationUpdateApplicationRequestVoiceFallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateApplicationUpdateApplicationRequestVoiceMethodEnum) ToPointer() *UpdateApplicationUpdateApplicationRequestVoiceMethodEnum {
	return &e
}
...
func (e *UpdateApplicationUpdateApplicationRequestVoiceMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateApplicationUpdateApplicationRequestVoiceMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateApplicationUpdateApplicationRequestVoiceMethodEnum: %v", v)
	}
}
