...
class GetNetworkWirelessLatencyHistoryQueryParams:
    access_category: Optional[GetNetworkWirelessLatencyHistoryAccessCategoryEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'accessCategory', 'style': 'form', 'explode': True }})
    ...
    band: Optional[GetNetworkWirelessLatencyHistoryBandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'band', 'style': 'form', 'explode': True }})
...
class GetNetworkWirelessLatencyHistoryRequest:
    path_params: GetNetworkWirelessLatencyHistoryPathParams = dataclasses.field()
    query_params: GetNetworkWirelessLatencyHistoryQueryParams = dataclasses.field()
...
class GetNetworkWirelessLatencyHistoryResponse:
    ...
    get_network_wireless_latency_history_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
