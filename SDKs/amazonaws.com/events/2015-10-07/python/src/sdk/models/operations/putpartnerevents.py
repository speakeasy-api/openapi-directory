...
class PutPartnerEventsRequest:
    headers: PutPartnerEventsHeaders = dataclasses.field()
    request: shared_putpartnereventsrequest.PutPartnerEventsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
