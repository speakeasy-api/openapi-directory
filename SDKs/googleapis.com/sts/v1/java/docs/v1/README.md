...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.StsOauthtokenRequest;
import org.openapis.openapi.models.operations.StsOauthtokenResponse;
import org.openapis.openapi.models.shared.AltEnum;
import org.openapis.openapi.models.shared.GoogleIdentityStsV1ExchangeOauthTokenRequest;
import org.openapis.openapi.models.shared.XgafvEnum;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            StsOauthtokenRequest req = new StsOauthtokenRequest() {{
                dollarXgafv = XgafvEnum.TWO;
                googleIdentityStsV1ExchangeOauthTokenRequest = new GoogleIdentityStsV1ExchangeOauthTokenRequest() {{
                    clientId = "nisi";
                    code = "recusandae";
            ...
            StsOauthtokenResponse res = sdk.v1.stsOauthtoken(req);

            if (res.googleIdentityStsV1ExchangeOauthTokenResponse != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import org.openapis.openapi.models.shared.AltEnum;
import org.openapis.openapi.models.shared.GoogleIdentityStsV1ExchangeTokenRequest;
import org.openapis.openapi.models.shared.XgafvEnum;
    ...
    public static void main(String[] args) {
        try {
            ...
            StsTokenRequest req = new StsTokenRequest() {{
                dollarXgafv = XgafvEnum.ONE;
                googleIdentityStsV1ExchangeTokenRequest = new GoogleIdentityStsV1ExchangeTokenRequest() {{
                    audience = "quod";
                    grantType = "quod";
                    options = "esse";
                    requestedTokenType = "totam";
                    scope = "porro";
                    subjectToken = "dolorum";
                    subjectTokenType = "dicta";
                }};;
                accessToken = "nam";
                alt = AltEnum.MEDIA;
                callback = "occaecati";
            ...
            StsTokenResponse res = sdk.v1.stsToken(req);

            if (res.googleIdentityStsV1ExchangeTokenResponse != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
