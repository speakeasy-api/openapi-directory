...
public class SDK {
    ...
    public openapisdk.models.operations.CreateWorkspaceResponse createWorkspace(openapisdk.models.operations.CreateWorkspaceRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 202) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.CreateWorkspaceResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateWorkspaceResponse.class);
    ...
    **/
    public openapisdk.models.operations.DeleteWorkspaceResponse deleteWorkspace(openapisdk.models.operations.DeleteWorkspaceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/workspaces/{workspaceId}", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.DescribeWorkspaceResponse describeWorkspace(openapisdk.models.operations.DescribeWorkspaceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/workspaces/{workspaceId}", request.pathParams);
        ...
        openapisdk.models.operations.DescribeWorkspaceResponse res = new openapisdk.models.operations.DescribeWorkspaceResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DescribeWorkspaceResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DescribeWorkspaceResponse.class);
    ...
    **/
    public openapisdk.models.operations.ListWorkspacesResponse listWorkspaces(openapisdk.models.operations.ListWorkspacesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/workspaces");
        ...
        openapisdk.models.operations.ListWorkspacesResponse res = new openapisdk.models.operations.ListWorkspacesResponse() {{
    ...
    **/
    public openapisdk.models.operations.UpdateWorkspaceAliasResponse updateWorkspaceAlias(openapisdk.models.operations.UpdateWorkspaceAliasRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/workspaces/{workspaceId}/alias", request.pathParams);
        ...
        openapisdk.models.operations.UpdateWorkspaceAliasResponse res = new openapisdk.models.operations.UpdateWorkspaceAliasResponse() {{
            throttlingException = null;
            conflictException = null;
            validationException = null;
            resourceNotFoundException = null;
