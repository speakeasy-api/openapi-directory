...
class SageMakerPipelineParameters:
    r"""The templated target type for the Amazon SageMaker <a href=\\"https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_StartPipelineExecution.html\\"> <code>StartPipelineExecution</code> </a> API operation."""
