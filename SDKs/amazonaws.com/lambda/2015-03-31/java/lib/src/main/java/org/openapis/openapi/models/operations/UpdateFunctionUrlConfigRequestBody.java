...
public class UpdateFunctionUrlConfigRequestBody {
    /**
    ...
    public UpdateFunctionUrlConfigRequestBodyAuthTypeEnum authType;

    public UpdateFunctionUrlConfigRequestBody withAuthType(UpdateFunctionUrlConfigRequestBodyAuthTypeEnum authType) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("Cors")
    public UpdateFunctionUrlConfigRequestBodyCors cors;

    public UpdateFunctionUrlConfigRequestBody withCors(UpdateFunctionUrlConfigRequestBodyCors cors) {
        this.cors = cors;
        return this;
    }
    ...
    public UpdateFunctionUrlConfigRequestBodyInvokeModeEnum invokeMode;

    public UpdateFunctionUrlConfigRequestBody withInvokeMode(UpdateFunctionUrlConfigRequestBodyInvokeModeEnum invokeMode) {
        this.invokeMode = invokeMode;
        return this;
    }
    
    public UpdateFunctionUrlConfigRequestBody(){}
}
