...
public class General {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.PostDisablePermitResponse postDisablePermit(org.openapis.openapi.models.operations.PostDisablePermitRequest request) throws Exception {
        String baseUrl = this._serverUrl;
