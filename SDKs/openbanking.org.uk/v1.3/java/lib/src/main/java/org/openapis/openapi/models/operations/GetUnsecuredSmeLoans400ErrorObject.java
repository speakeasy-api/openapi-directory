...
public class GetUnsecuredSmeLoans400ErrorObject {
    ...
    public GetUnsecuredSmeLoans400ErrorObject(@JsonProperty("description") GetUnsecuredSmeLoans400ErrorObjectDescriptionEnum description, @JsonProperty("status") GetUnsecuredSmeLoans400ErrorObjectStatusEnum status, @JsonProperty("title") GetUnsecuredSmeLoans400ErrorObjectTitleEnum title) {
        this.description = description;
        this.status = status;
        this.title = title;
  }
