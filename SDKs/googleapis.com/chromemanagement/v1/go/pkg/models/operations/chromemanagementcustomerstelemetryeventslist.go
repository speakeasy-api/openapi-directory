...
type ChromemanagementCustomersTelemetryEventsListPathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ChromemanagementCustomersTelemetryEventsListQueryParams struct {
...
type ChromemanagementCustomersTelemetryEventsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ChromemanagementCustomersTelemetryEventsListRequest struct {
...
type ChromemanagementCustomersTelemetryEventsListResponse struct {
	ContentType                                         string
