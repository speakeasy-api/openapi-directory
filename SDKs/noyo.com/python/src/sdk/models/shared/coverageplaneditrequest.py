...
class CoveragePlanEditRequestCobraRules:
    r"""CoveragePlanEditRequestCobraRules
...
class CoveragePlanEditRequest:
    ...
    cobra_rules: Optional[CoveragePlanEditRequestCobraRules] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cobra_rules') }})
