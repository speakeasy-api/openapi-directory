...
class GETAccountingPeriodType:
    ...
    file_ids: Optional[GETAccountingPeriodTypeFileIds] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fileIds'), 'exclude': lambda f: f is None }})
    r"""File IDs of the reports available for the accounting period. You can retrieve the reports by specifying the file ID in a [Get Files](https://www.zuora.com/developer/api-reference/#operation/GET_Files) REST API call."""  
    ...
    * `Closed`
    ...
    r"""ID of the user who last updated the accounting period."""  
