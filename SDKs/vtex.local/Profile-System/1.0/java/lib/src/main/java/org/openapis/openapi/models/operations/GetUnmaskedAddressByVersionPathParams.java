...
public class GetUnmaskedAddressByVersionPathParams {
    /**
    ...
    public GetUnmaskedAddressByVersionPathParams withAddressId(String addressId) {
    ...
    public GetUnmaskedAddressByVersionPathParams withAddressVersionId(String addressVersionId) {
    ...
    public GetUnmaskedAddressByVersionPathParams withProfileId(String profileId) {
