...
var ViewOnlyLinks = /** @class */ (function () {
    ...
    ViewOnlyLinks.prototype.viewOnlyLinksNodeList = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/view_only_links/{link_id}/nodes/", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.ViewOnlyLinksNodeListResponse({
    ...
    ViewOnlyLinks.prototype.viewOnlyLinksRead = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/view_only_links/{link_id}/", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ViewOnlyLinksReadResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
