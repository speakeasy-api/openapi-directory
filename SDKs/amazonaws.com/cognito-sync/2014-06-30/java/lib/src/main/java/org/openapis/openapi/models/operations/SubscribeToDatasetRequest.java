...
public class SubscribeToDatasetRequest {
    ...
    public SubscribeToDatasetRequest(@JsonProperty("DatasetName") String datasetName, @JsonProperty("DeviceId") String deviceId, @JsonProperty("IdentityId") String identityId, @JsonProperty("IdentityPoolId") String identityPoolId) {
        this.datasetName = datasetName;
        this.deviceId = deviceId;
        this.identityId = identityId;
        this.identityPoolId = identityPoolId;
