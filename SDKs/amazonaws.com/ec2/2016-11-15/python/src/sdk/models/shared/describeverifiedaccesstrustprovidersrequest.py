...
class DescribeVerifiedAccessTrustProvidersRequest:
    ...
    filters: Optional[list[DescribeVerifiedAccessTrustProvidersRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    verified_access_trust_provider_ids: Optional[list[str]] = dataclasses.field(default=None)  
