...
class NotesAllRequest:
    headers: NotesAllHeaders = dataclasses.field()
    query_params: NotesAllQueryParams = dataclasses.field()
    security: NotesAllSecurity = dataclasses.field()
