...
func (e EmployeeCompensationsFlsaStatusEnum) ToPointer() *EmployeeCompensationsFlsaStatusEnum {
	return &e
}
...
func (e *EmployeeCompensationsFlsaStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "nonexempt":
		fallthrough
	case "owner":
		*e = EmployeeCompensationsFlsaStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EmployeeCompensationsFlsaStatusEnum: %v", v)
	}
}
...
func (e EmployeeEmploymentRoleEmploymentSubTypeEnum) ToPointer() *EmployeeEmploymentRoleEmploymentSubTypeEnum {
	return &e
}
...
func (e *EmployeeEmploymentRoleEmploymentSubTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "part_time":
		fallthrough
	case "hourly":
		*e = EmployeeEmploymentRoleEmploymentSubTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EmployeeEmploymentRoleEmploymentSubTypeEnum: %v", v)
	}
}
...
func (e EmployeeEmploymentRoleEmploymentTypeEnum) ToPointer() *EmployeeEmploymentRoleEmploymentTypeEnum {
	return &e
}
...
func (e *EmployeeEmploymentRoleEmploymentTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "internship":
		fallthrough
	case "other":
		*e = EmployeeEmploymentRoleEmploymentTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EmployeeEmploymentRoleEmploymentTypeEnum: %v", v)
	}
}
...
func (e EmployeeLeavingReasonEnum) ToPointer() *EmployeeLeavingReasonEnum {
	return &e
}
...
func (e *EmployeeLeavingReasonEnum) UnmarshalJSON(data []byte) error {
	...
	case "redundancy":
		fallthrough
	case "other":
		*e = EmployeeLeavingReasonEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EmployeeLeavingReasonEnum: %v", v)
	}
}
