...
class AnalyticsManagementUnsampledReportsInsertSecurity:
    option1: Optional[AnalyticsManagementUnsampledReportsInsertSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementUnsampledReportsInsertSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class AnalyticsManagementUnsampledReportsInsertRequest:
    path_params: AnalyticsManagementUnsampledReportsInsertPathParams = dataclasses.field()
    query_params: AnalyticsManagementUnsampledReportsInsertQueryParams = dataclasses.field()
    security: AnalyticsManagementUnsampledReportsInsertSecurity = dataclasses.field()
    request: Optional[shared_unsampledreport.UnsampledReportInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
