...
/**
 * POSTPaymentMethodRequest - Container for custom fields of a payment method object.
 * 
 */
public class POSTPaymentMethodRequest {
    /**
    ...
    @JsonProperty("BAID")
    public String baid;
    public POSTPaymentMethodRequest withBaid(String baid) {
        this.baid = baid;
        return this;
    }
    ...
    @JsonProperty("IBAN")
    public String iban;
    public POSTPaymentMethodRequest withIban(String iban) {
        this.iban = iban;
        return this;
    }
    ...
    public POSTPaymentMethodRequestAccountHolderInfo accountHolderInfo;
    public POSTPaymentMethodRequest withAccountHolderInfo(POSTPaymentMethodRequestAccountHolderInfo accountHolderInfo) {
    ...
    public POSTPaymentMethodRequest withAccountKey(String accountKey) {
    ...
    public POSTPaymentMethodRequest withAccountNumber(String accountNumber) {
    ...
    public POSTPaymentMethodRequest withAddressLine1(String addressLine1) {
    ...
    public POSTPaymentMethodRequest withAddressLine2(String addressLine2) {
    ...
    public POSTPaymentMethodRequest withAuthGateway(String authGateway) {
    ...
    public POSTPaymentMethodRequest withBankABACode(String bankABACode) {
    ...
    public POSTPaymentMethodRequest withBankAccountName(String bankAccountName) {
    ...
    public POSTPaymentMethodRequest withBankAccountNumber(String bankAccountNumber) {
    ...
    public POSTPaymentMethodRequestBankAccountTypeEnum bankAccountType;
    public POSTPaymentMethodRequest withBankAccountType(POSTPaymentMethodRequestBankAccountTypeEnum bankAccountType) {
    ...
    public POSTPaymentMethodRequest withBankCode(String bankCode) {
    ...
    public POSTPaymentMethodRequest withBankName(String bankName) {
    ...
    public POSTPaymentMethodRequest withBranchCode(String branchCode) {
    ...
    public POSTPaymentMethodRequest withBusinessIdentificationCode(String businessIdentificationCode) {
    ...
    public POSTPaymentMethodRequest withCardHolderInfo(CreatePaymentMethodCardholderInfo cardHolderInfo) {
    ...
    public POSTPaymentMethodRequest withCardNumber(String cardNumber) {
    ...
    public POSTPaymentMethodRequest withCardType(String cardType) {
    ...
    public POSTPaymentMethodRequest withCheckDuplicated(Boolean checkDuplicated) {
    ...
    @JsonProperty("city")
    public String city;
    public POSTPaymentMethodRequest withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public POSTPaymentMethodRequest withCountry(String country) {
    ...
    public POSTPaymentMethodRequest withCurrencyCode(String currencyCode) {
    ...
    @JsonProperty("email")
    public String email;
    public POSTPaymentMethodRequest withEmail(String email) {
        this.email = email;
        return this;
    }
    ...
    public POSTPaymentMethodRequest withExpirationMonth(Long expirationMonth) {
    ...
    public POSTPaymentMethodRequest withExpirationYear(Long expirationYear) {
    ...
    public POSTPaymentMethodRequest withIdentityNumber(String identityNumber) {
    ...
    public POSTPaymentMethodRequest withMakeDefault(Boolean makeDefault) {
    ...
    public POSTPaymentMethodRequest withMitConsentAgreementRef(String mitConsentAgreementRef) {
    ...
    public POSTPaymentMethodRequestMitConsentAgreementSrcEnum mitConsentAgreementSrc;
    public POSTPaymentMethodRequest withMitConsentAgreementSrc(POSTPaymentMethodRequestMitConsentAgreementSrcEnum mitConsentAgreementSrc) {
    ...
    public POSTPaymentMethodRequest withMitNetworkTransactionId(String mitNetworkTransactionId) {
    ...
    public POSTPaymentMethodRequestMitProfileActionEnum mitProfileAction;
    public POSTPaymentMethodRequest withMitProfileAction(POSTPaymentMethodRequestMitProfileActionEnum mitProfileAction) {
    ...
    public POSTPaymentMethodRequest withMitProfileAgreedOn(LocalDate mitProfileAgreedOn) {
    ...
    public POSTPaymentMethodRequestMitProfileTypeEnum mitProfileType;
    public POSTPaymentMethodRequest withMitProfileType(POSTPaymentMethodRequestMitProfileTypeEnum mitProfileType) {
    ...
    @JsonProperty("phone")
    public String phone;
    public POSTPaymentMethodRequest withPhone(String phone) {
        this.phone = phone;
        return this;
    }
    ...
    public POSTPaymentMethodRequest withPreapprovalKey(String preapprovalKey) {
    ...
    public POSTPaymentMethodRequest withSecurityCode(String securityCode) {
    ...
    @JsonProperty("state")
    public String state;
    public POSTPaymentMethodRequest withState(String state) {
        this.state = state;
        return this;
    }
    ...
    @JsonProperty("type")
    public String type;
    public POSTPaymentMethodRequest withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public POSTPaymentMethodRequest withZipCode(String zipCode) {
