 ...
 */
export enum ServiceAttachmentsScopedListWarningCodeEnum {
...
export class ServiceAttachmentsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ServiceAttachmentsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: ServiceAttachmentsScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: ServiceAttachmentsScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => ServiceAttachmentsScopedListWarningData)
  data?: ServiceAttachmentsScopedListWarningData[];
...
export class ServiceAttachmentsScopedList extends SpeakeasyBase {
  /**
   * A list of ServiceAttachments contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: ServiceAttachment })
  @Expose({ name: "serviceAttachments" })
