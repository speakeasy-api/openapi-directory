...
exports.DataPointsGetStatisticsListResponse = exports.DataPointsGetStatisticsListRequest = exports.DataPointsGetStatisticsListTimeFrameEnum = exports.DataPointsGetStatisticsListGroupByEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * The temporal entity you want to group by ("week"/"month"). If unspecified is "day".
 */
var DataPointsGetStatisticsListGroupByEnum;
...
})(DataPointsGetStatisticsListGroupByEnum = exports.DataPointsGetStatisticsListGroupByEnum || (exports.DataPointsGetStatisticsListGroupByEnum = {}));
/**
 * Timeframe of the request. See list at $timeframeList
 */
var DataPointsGetStatisticsListTimeFrameEnum;
...
})(DataPointsGetStatisticsListTimeFrameEnum = exports.DataPointsGetStatisticsListTimeFrameEnum || (exports.DataPointsGetStatisticsListTimeFrameEnum = {}));
var DataPointsGetStatisticsListRequest = /** @class */ (function (_super) {
    ...
    ], DataPointsGetStatisticsListRequest.prototype, "fromDay", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=groupBy",
        }),
        __metadata("design:type", String)
    ], DataPointsGetStatisticsListRequest.prototype, "groupBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], DataPointsGetStatisticsListRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeFrame",
        }),
        __metadata("design:type", String)
    ], DataPointsGetStatisticsListRequest.prototype, "timeFrame", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=toDay" }),
        __metadata("design:type", String)
    ], DataPointsGetStatisticsListRequest.prototype, "toDay", void 0);
    return DataPointsGetStatisticsListRequest;
}(utils_1.SpeakeasyBase));
exports.DataPointsGetStatisticsListRequest = DataPointsGetStatisticsListRequest;
var DataPointsGetStatisticsListResponse = /** @class */ (function (_super) {
    ...
    ], DataPointsGetStatisticsListResponse.prototype, "rawResponse", void 0);
    return DataPointsGetStatisticsListResponse;
}(utils_1.SpeakeasyBase));
exports.DataPointsGetStatisticsListResponse = DataPointsGetStatisticsListResponse;
