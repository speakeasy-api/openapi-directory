...
func (s *media) CloudsearchMediaUpload(ctx context.Context, request operations.CloudsearchMediaUploadRequest, security operations.CloudsearchMediaUploadSecurity) (*operations.CloudsearchMediaUploadResponse, error) {
	baseURL := s.serverURL
