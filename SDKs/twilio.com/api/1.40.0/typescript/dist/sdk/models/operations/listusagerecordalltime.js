...
exports.ListUsageRecordAllTimeResponse = exports.ListUsageRecordAllTimeListUsageRecordAllTimeResponse = exports.ListUsageRecordAllTimeRequest = exports.ListUsageRecordAllTimeSecurity = exports.ListUsageRecordAllTimeServerList = void 0;
...
var ListUsageRecordAllTimeSecurity = /** @class */ (function (_super) {
    ...
    ], ListUsageRecordAllTimeSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordAllTimeSecurity.prototype, "username", void 0);
...
var ListUsageRecordAllTimeRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListUsageRecordAllTimeRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Category",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordAllTimeRequest.prototype, "category", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EndDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListUsageRecordAllTimeRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=IncludeSubaccounts",
        }),
        __metadata("design:type", Boolean)
    ], ListUsageRecordAllTimeRequest.prototype, "includeSubaccounts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListUsageRecordAllTimeRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListUsageRecordAllTimeRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordAllTimeRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListUsageRecordAllTimeRequest.prototype, "startDate", void 0);
...
var ListUsageRecordAllTimeListUsageRecordAllTimeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountUsageUsageRecordUsageRecordAllTime; }),
...
var ListUsageRecordAllTimeResponse = /** @class */ (function (_super) {
    ...
    ], ListUsageRecordAllTimeResponse.prototype, "rawResponse", void 0);
