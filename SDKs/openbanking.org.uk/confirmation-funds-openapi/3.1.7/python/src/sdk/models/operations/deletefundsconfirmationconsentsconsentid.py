...
class DeleteFundsConfirmationConsentsConsentIDRequest:
    headers: DeleteFundsConfirmationConsentsConsentIDHeaders = dataclasses.field()
    path_params: DeleteFundsConfirmationConsentsConsentIDPathParams = dataclasses.field()
    security: DeleteFundsConfirmationConsentsConsentIDSecurity = dataclasses.field()
