...
export class Mocks {
  ...
  allMocks(config?: AxiosRequestConfig): Promise<operations.AllMocksResponse> {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AllMocksResponse = new operations.AllMocksResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.allMocks200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.AllMocks200ApplicationJSON
            );
          }
          break;
      }
   ...
   */
  createMock(
    req: operations.CreateMockRequestBody,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CreateMockResponse =
        new operations.CreateMockResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.createMock200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.CreateMock200ApplicationJSON
            );
          }
          break;
      }
  ...
  deleteMock(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/mocks/{mock_uid}", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DeleteMockResponse =
        new operations.DeleteMockResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.deleteMock200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.DeleteMock200ApplicationJSON
            );
          }
          break;
      }
  ...
  publishMock(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PublishMockResponse =
        new operations.PublishMockResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.publishMock200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.PublishMock200ApplicationJSON
            );
          }
          break;
      }
  ...
  singleMock(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SingleMockResponse =
        new operations.SingleMockResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.singleMock200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SingleMock200ApplicationJSON
            );
          }
          break;
      }
  ...
  unpublishMock(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UnpublishMockResponse =
        new operations.UnpublishMockResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.unpublishMock200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.UnpublishMock200ApplicationJSON
            );
          }
          break;
      }
  ...
  updateMock(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UpdateMockResponse =
        new operations.UpdateMockResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.updateMock200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.UpdateMock200ApplicationJSON
            );
          }
          break;
      }
