...
public class VcenterDetail {
    ...
    public VcenterDetail withCaCerts(String caCerts) {
    ...
    public VcenterDetail withComputeVisibilityFilter(ClusterVisibilityInfo[] computeVisibilityFilter) {
    ...
    public VcenterDetail withConfiguredSlaDomainId(String configuredSlaDomainId) {
    ...
    public VcenterDetail withConfiguredSlaDomainName(String configuredSlaDomainName) {
    ...
    public VcenterDetail withConfiguredSlaDomainPolarisManagedId(String configuredSlaDomainPolarisManagedId) {
    ...
    public VcenterDetail withConfiguredSlaDomainType(ConfiguredSlaTypeEnum configuredSlaDomainType) {
    ...
    public VcenterDetailConflictResolutionAuthzEnum conflictResolutionAuthz;

    public VcenterDetail withConflictResolutionAuthz(VcenterDetailConflictResolutionAuthzEnum conflictResolutionAuthz) {
    ...
    public VcenterDetail withConnectionStatus(RefreshableObjectConnectionStatus connectionStatus) {
    ...
    public VcenterDetail withHostname(String hostname) {
    ...
    public VcenterDetail withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public VcenterDetail withIsConfiguredSlaDomainRetentionLocked(Boolean isConfiguredSlaDomainRetentionLocked) {
    ...
    public VcenterDetail withIsIoFilterInstalled(Boolean isIoFilterInstalled) {
    ...
    public VcenterDetail withIsVmc(Boolean isVmc) {
        this.isVmc = isVmc;
        return this;
    }
    ...
    public VcenterDetail withLastRefreshTime(OffsetDateTime lastRefreshTime) {
    ...
    public VcenterDetail withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public VcenterDetail withPrimaryClusterId(String primaryClusterId) {
    ...
    public VcenterDetail withSlaLastUpdateTime(OffsetDateTime slaLastUpdateTime) {
    ...
    public VcenterDetail withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public VcenterDetail withUsername(String username) {
    ...
    public VcenterDetail withVersion(String version) {
        this.version = version;
        return this;
    }
    
    public VcenterDetail(@JsonProperty("computeVisibilityFilter") ClusterVisibilityInfo[] computeVisibilityFilter, @JsonProperty("configuredSlaDomainId") String configuredSlaDomainId, @JsonProperty("configuredSlaDomainName") String configuredSlaDomainName, @JsonProperty("connectionStatus") RefreshableObjectConnectionStatus connectionStatus, @JsonProperty("hostname") String hostname, @JsonProperty("id") String id, @JsonProperty("name") String name, @JsonProperty("primaryClusterId") String primaryClusterId, @JsonProperty("status") String status, @JsonProperty("username") String username, @JsonProperty("version") String version) {
        this.computeVisibilityFilter = computeVisibilityFilter;
        this.configuredSlaDomainId = configuredSlaDomainId;
        this.configuredSlaDomainName = configuredSlaDomainName;
        this.connectionStatus = connectionStatus;
