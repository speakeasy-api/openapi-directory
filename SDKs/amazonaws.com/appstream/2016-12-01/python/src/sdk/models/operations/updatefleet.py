...
class UpdateFleetRequest:
    headers: UpdateFleetHeaders = dataclasses.field()
    request: shared_updatefleetrequest.UpdateFleetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
