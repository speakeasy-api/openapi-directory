...
var MessagingV1BrandRegistrationsBrandVetting = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=brand_sid" }),
        __metadata("design:type", String)
    ], MessagingV1BrandRegistrationsBrandVetting.prototype, "brandSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=brand_vetting_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=vetting_class" }),
        __metadata("design:type", String)
    ], MessagingV1BrandRegistrationsBrandVetting.prototype, "vettingClass", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=vetting_id" }),
        __metadata("design:type", String)
    ], MessagingV1BrandRegistrationsBrandVetting.prototype, "vettingId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=vetting_provider" }),
        __metadata("design:type", String)
    ], MessagingV1BrandRegistrationsBrandVetting.prototype, "vettingProvider", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=vetting_status" }),
        __metadata("design:type", String)
