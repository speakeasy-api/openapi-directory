...
class ReimportAPIResponseProtocolTypeEnum(str, Enum):
    r"""The API protocol."""
    WEBSOCKET = 'WEBSOCKET'
    HTTP = 'HTTP'
...
class ReimportAPIResponse:
    ...
    cors_configuration: Optional[ReimportAPIResponseCorsConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CorsConfiguration'), 'exclude': lambda f: f is None }})  
    ...
    protocol_type: Optional[ReimportAPIResponseProtocolTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ProtocolType'), 'exclude': lambda f: f is None }})  
