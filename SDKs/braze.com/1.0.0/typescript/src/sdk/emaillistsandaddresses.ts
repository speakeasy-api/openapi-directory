...
export class EmailListsAndAddresses {
  ...
  queryHardBouncedEmails(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.QueryHardBouncedEmailsResponse =
        new operations.QueryHardBouncedEmailsResponse({
  ...
  queryListOfUnsubscribedEmailAddresses(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.QueryListOfUnsubscribedEmailAddressesResponse =
        new operations.QueryListOfUnsubscribedEmailAddressesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
