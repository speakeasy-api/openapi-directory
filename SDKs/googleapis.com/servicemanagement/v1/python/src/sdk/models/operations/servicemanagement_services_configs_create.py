...
class ServicemanagementServicesConfigsCreateSecurity:
    ...
    option1: Optional[ServicemanagementServicesConfigsCreateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[ServicemanagementServicesConfigsCreateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
