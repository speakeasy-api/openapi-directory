...
class GetUpdateOpenIDConnectProviderThumbprintQueryParams:
    action: GetUpdateOpenIDConnectProviderThumbprintActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    thumbprint_list: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'ThumbprintList', 'style': 'form', 'explode': True }})
    version: GetUpdateOpenIDConnectProviderThumbprintVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetUpdateOpenIDConnectProviderThumbprintRequest:
    headers: GetUpdateOpenIDConnectProviderThumbprintHeaders = dataclasses.field()
    query_params: GetUpdateOpenIDConnectProviderThumbprintQueryParams = dataclasses.field()
