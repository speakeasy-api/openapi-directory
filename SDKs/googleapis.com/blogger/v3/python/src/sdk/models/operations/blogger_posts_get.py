...
class BloggerPostsGetQueryParams:
    ...
    view: Optional[BloggerPostsGetViewEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
...
class BloggerPostsGetSecurity:
    option1: Optional[BloggerPostsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[BloggerPostsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class BloggerPostsGetRequest:
    path_params: BloggerPostsGetPathParams = dataclasses.field()
    query_params: BloggerPostsGetQueryParams = dataclasses.field()
    security: BloggerPostsGetSecurity = dataclasses.field()
