...
public class PostContainersNameOrIdStartRequest {
    ...
    public PostContainersNameOrIdStartRequest(@JsonProperty("X-Auth-Project-Id") String xAuthProjectId, @JsonProperty("X-Auth-Token") String xAuthToken, @JsonProperty("name_or_id") String nameOrId) {
        this.xAuthProjectId = xAuthProjectId;
        this.xAuthToken = xAuthToken;
        this.nameOrId = nameOrId;
  }
