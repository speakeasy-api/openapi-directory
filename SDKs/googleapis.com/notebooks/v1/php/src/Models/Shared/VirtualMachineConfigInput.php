...
class VirtualMachineConfigInput
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\LocalDiskInput $dataDisk
     */
	#[\JMS\Serializer\Annotation\SerializedName('dataDisk')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\LocalDiskInput')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?LocalDiskInput $dataDisk = null;
