...
from ..shared import deletepipelineresponse as shared_deletepipelineresponse
...
@dataclasses.dataclass
class PipelinesDeleteSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class PipelinesDeleteRequest:
    headers: PipelinesDeleteHeaders = dataclasses.field()
    path_params: PipelinesDeletePathParams = dataclasses.field()
    query_params: PipelinesDeleteQueryParams = dataclasses.field()
    security: PipelinesDeleteSecurity = dataclasses.field()
    

@dataclasses.dataclass
class PipelinesDeleteResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    delete_pipeline_response: Optional[shared_deletepipelineresponse.DeletePipelineResponse] = dataclasses.field(default=None)
