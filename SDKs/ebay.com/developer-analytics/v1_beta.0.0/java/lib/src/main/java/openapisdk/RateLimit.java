...
public class RateLimit {
    ...
    **/
    public openapisdk.models.operations.GetRateLimitsResponse getRateLimits(openapisdk.models.operations.GetRateLimitsRequest request) throws Exception {
        ...
        openapisdk.models.operations.GetRateLimitsResponse res = new openapisdk.models.operations.GetRateLimitsResponse() {{
            rateLimitsResponse = null;
            getRateLimits500ApplicationJSONObject = null;
        }};
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.GetRateLimits500ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetRateLimits500ApplicationJson.class);
