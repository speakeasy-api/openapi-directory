...
class DescribeRepositoriesRequest:
    ...
    repository_names: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('repositoryNames'), 'exclude': lambda f: f is None }})  
