...
class ListEventTypeRequest:
    ...
    r"""A string parameter filtering the results to return only the Event Types using a given schema."""  
...
class ListEventTypeListEventTypeResponse:
    ...
    meta: Optional[ListEventTypeListEventTypeResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    types: Optional[list[shared_events_v1_event_type.EventsV1EventType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('types'), 'exclude': lambda f: f is None }})  
