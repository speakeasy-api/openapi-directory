...
type DirectorySchemasUpdateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DirectorySchemasUpdatePathParams struct {
...
type DirectorySchemasUpdateQueryParams struct {
	// V1 error format.
...
type DirectorySchemasUpdateRequest struct {
...
type DirectorySchemasUpdateResponse struct {
	ContentType string
	// Successful response
