...
class SearchBookmarksQueryParams:
    ...
    search_db_bookmarks_category: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_bookmarks.category', 'style': 'form', 'explode': True }})
    search_db_bookmarks_date: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_bookmarks.date', 'style': 'form', 'explode': True }})
    search_db_bookmarks_title: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_bookmarks.title', 'style': 'form', 'explode': True }})
    search_db_bookmarks_url: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_bookmarks.url', 'style': 'form', 'explode': True }})
...
class SearchBookmarksRequest:
    query_params: SearchBookmarksQueryParams = dataclasses.field()
