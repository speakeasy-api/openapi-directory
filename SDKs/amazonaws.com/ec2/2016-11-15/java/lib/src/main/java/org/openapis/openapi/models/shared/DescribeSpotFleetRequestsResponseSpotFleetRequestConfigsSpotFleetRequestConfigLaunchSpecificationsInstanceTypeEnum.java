 ...
 */
public enum DescribeSpotFleetRequestsResponseSpotFleetRequestConfigsSpotFleetRequestConfigLaunchSpecificationsInstanceTypeEnum {
    A1_MEDIUM("a1.medium"),
    A1_LARGE("a1.large"),
    A1_XLARGE("a1.xlarge"),
    ...
    private DescribeSpotFleetRequestsResponseSpotFleetRequestConfigsSpotFleetRequestConfigLaunchSpecificationsInstanceTypeEnum(String value) {
        this.value = value;
    }
}
