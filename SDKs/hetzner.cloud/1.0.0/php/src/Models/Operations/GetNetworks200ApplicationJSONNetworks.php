...
class GetNetworks200ApplicationJSONNetworks
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\GetNetworks200ApplicationJSONNetworksProtection $protection
     */
	#[\JMS\Serializer\Annotation\SerializedName('protection')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\GetNetworks200ApplicationJSONNetworksProtection')]
    public GetNetworks200ApplicationJSONNetworksProtection $protection;
    
    /**
     * Array of routes set in this Network
     * 
     * @var array<\OpenAPI\OpenAPI\Models\Operations\GetNetworks200ApplicationJSONNetworksRoutes> $routes
     */
	#[\JMS\Serializer\Annotation\SerializedName('routes')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Operations\GetNetworks200ApplicationJSONNetworksRoutes>')]
    public array $routes;
     ...
     * 
     * @var array<\OpenAPI\OpenAPI\Models\Operations\GetNetworks200ApplicationJSONNetworksSubnets> $subnets
     */
	#[\JMS\Serializer\Annotation\SerializedName('subnets')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Operations\GetNetworks200ApplicationJSONNetworksSubnets>')]
	...
	public function __construct()
	{
		...
		$this->name = "";
		$this->protection = new \OpenAPI\OpenAPI\Models\Operations\GetNetworks200ApplicationJSONNetworksProtection();
		$this->routes = [];
		$this->servers = [];
		$this->subnets = [];
	}
