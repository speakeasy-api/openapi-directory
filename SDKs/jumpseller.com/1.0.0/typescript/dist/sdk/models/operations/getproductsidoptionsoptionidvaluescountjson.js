...
exports.GetProductsIdOptionsOptionIdValuesCountJsonResponse = exports.GetProductsIdOptionsOptionIdValuesCountJsonRequest = void 0;
...
var GetProductsIdOptionsOptionIdValuesCountJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetProductsIdOptionsOptionIdValuesCountJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetProductsIdOptionsOptionIdValuesCountJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetProductsIdOptionsOptionIdValuesCountJsonRequest.prototype, "login", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=option_id",
        }),
        __metadata("design:type", Number)
    ], GetProductsIdOptionsOptionIdValuesCountJsonRequest.prototype, "optionId", void 0);
    return GetProductsIdOptionsOptionIdValuesCountJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetProductsIdOptionsOptionIdValuesCountJsonRequest = GetProductsIdOptionsOptionIdValuesCountJsonRequest;
var GetProductsIdOptionsOptionIdValuesCountJsonResponse = /** @class */ (function (_super) {
    ...
    ], GetProductsIdOptionsOptionIdValuesCountJsonResponse.prototype, "rawResponse", void 0);
    return GetProductsIdOptionsOptionIdValuesCountJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetProductsIdOptionsOptionIdValuesCountJsonResponse = GetProductsIdOptionsOptionIdValuesCountJsonResponse;
