 ...
 */
export enum QueuedResourcesAggregatedListWarningCodeEnum {
...
export class QueuedResourcesAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class QueuedResourcesAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: QueuedResourcesAggregatedListWarningData })
  @Expose({ name: "data" })
  @Type(() => QueuedResourcesAggregatedListWarningData)
 ...
 * Successful response
 */
export class QueuedResourcesAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: QueuedResourcesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, QueuedResourcesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], QueuedResourcesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "warning" })
  @Type(() => QueuedResourcesAggregatedListWarning)
