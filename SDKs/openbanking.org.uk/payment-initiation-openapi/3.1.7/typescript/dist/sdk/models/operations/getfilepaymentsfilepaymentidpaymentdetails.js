...
exports.GetFilePaymentsFilePaymentIdPaymentDetailsResponse = exports.GetFilePaymentsFilePaymentIdPaymentDetailsRequest = exports.GetFilePaymentsFilePaymentIdPaymentDetailsSecurity = void 0;
...
exports.GetFilePaymentsFilePaymentIdPaymentDetailsSecurity = GetFilePaymentsFilePaymentIdPaymentDetailsSecurity;
var GetFilePaymentsFilePaymentIdPaymentDetailsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetFilePaymentsFilePaymentIdPaymentDetailsRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=FilePaymentId",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentsFilePaymentIdPaymentDetailsRequest.prototype, "filePaymentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentsFilePaymentIdPaymentDetailsRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentsFilePaymentIdPaymentDetailsRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentsFilePaymentIdPaymentDetailsRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentsFilePaymentIdPaymentDetailsRequest.prototype, "xFapiInteractionId", void 0);
    return GetFilePaymentsFilePaymentIdPaymentDetailsRequest;
}(utils_1.SpeakeasyBase));
exports.GetFilePaymentsFilePaymentIdPaymentDetailsRequest = GetFilePaymentsFilePaymentIdPaymentDetailsRequest;
var GetFilePaymentsFilePaymentIdPaymentDetailsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetFilePaymentsFilePaymentIdPaymentDetailsResponse.prototype, "rawResponse", void 0);
    return GetFilePaymentsFilePaymentIdPaymentDetailsResponse;
}(utils_1.SpeakeasyBase));
exports.GetFilePaymentsFilePaymentIdPaymentDetailsResponse = GetFilePaymentsFilePaymentIdPaymentDetailsResponse;
