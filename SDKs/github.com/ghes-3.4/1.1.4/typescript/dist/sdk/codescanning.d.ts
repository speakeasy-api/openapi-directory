...
export declare class CodeScanning {
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#delete-a-code-scanning-analysis-from-a-repository} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#get-a-code-scanning-alert} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#get-a-code-scanning-analysis-for-a-repository} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#list-recent-code-scanning-analyses-for-a-repository} - API method documentation
     */
     ...
     * GitHub Apps must have the `security_events` read permission to use this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#list-instances-of-a-code-scanning-alert} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#list-code-scanning-alerts-for-a-repository} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#list-code-scanning-analyses-for-a-repository} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#update-a-code-scanning-alert} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#upload-a-sarif-file} - API method documentation
     */
