...
public class CreateArtifactJsonQueryParams {
    /**
    ...
    public CreateArtifactJsonQueryParams withCanonical(Boolean canonical) {
    ...
    public CreateArtifactJsonQueryParams withIfExists(org.openapis.openapi.models.shared.IfExistsEnum ifExists) {
