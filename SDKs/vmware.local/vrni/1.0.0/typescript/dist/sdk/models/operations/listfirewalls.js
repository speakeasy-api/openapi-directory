...
exports.ListFirewallsResponse = exports.ListFirewallsRequest = exports.ListFirewallsSecurity = exports.ListFirewallsQueryParams = void 0;
...
var ListFirewallsQueryParams = /** @class */ (function (_super) {
    ...
    ], ListFirewallsQueryParams.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=end_time" }),
        __metadata("design:type", Number)
    ], ListFirewallsQueryParams.prototype, "endTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=size" }),
        __metadata("design:type", Number)
    ], ListFirewallsQueryParams.prototype, "size", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=start_time" }),
        __metadata("design:type", Number)
    ], ListFirewallsQueryParams.prototype, "startTime", void 0);
    return ListFirewallsQueryParams;
}(utils_1.SpeakeasyBase));
exports.ListFirewallsQueryParams = ListFirewallsQueryParams;
var ListFirewallsSecurity = /** @class */ (function (_super) {
    __extends(ListFirewallsSecurity, _super);
    function ListFirewallsSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "security, scheme=true;type=apiKey;subtype=header" }),
        __metadata("design:type", shared.SchemeApiKeyAuth)
    ], ListFirewallsSecurity.prototype, "apiKeyAuth", void 0);
    return ListFirewallsSecurity;
}(utils_1.SpeakeasyBase));
exports.ListFirewallsSecurity = ListFirewallsSecurity;
var ListFirewallsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", ListFirewallsSecurity)
    ], ListFirewallsRequest.prototype, "security", void 0);
...
var ListFirewallsResponse = /** @class */ (function (_super) {
    ...
    ], ListFirewallsResponse.prototype, "apiError", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", String)
    ...
    ], ListFirewallsResponse.prototype, "pagedListResponseWithTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Number)
