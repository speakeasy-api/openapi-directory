...
class IbmDb2Settings:
    ...
    current_lsn: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CurrentLsn') }})
    ...
    max_k_bytes_per_read: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('MaxKBytesPerRead') }})
    ...
    set_data_capture_changes: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('SetDataCaptureChanges') }})
