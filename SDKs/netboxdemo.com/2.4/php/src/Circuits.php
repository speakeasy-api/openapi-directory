...
class Circuits 
{
     ...
     * circuitsChoicesList
     * 
     * @return \OpenAPI\OpenAPI\Models\Operations\CircuitsChoicesListResponse
     */
	public function circuitsChoicesList(
    ): \OpenAPI\OpenAPI\Models\Operations\CircuitsChoicesListResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/circuits/_choices/');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CircuitsChoicesListResponse();
     ...
     * circuitsChoicesRead
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CircuitsChoicesReadRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CircuitsChoicesReadResponse
     */
	public function circuitsChoicesRead(
        \OpenAPI\OpenAPI\Models\Operations\CircuitsChoicesReadRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CircuitsChoicesReadResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/circuits/_choices/{id}/', \OpenAPI\OpenAPI\Models\Operations\CircuitsChoicesReadRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CircuitsChoicesReadResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
