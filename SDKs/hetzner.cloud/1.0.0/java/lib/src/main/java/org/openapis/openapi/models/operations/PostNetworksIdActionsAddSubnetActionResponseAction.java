...
public class PostNetworksIdActionsAddSubnetActionResponseAction {
    ...
    public PostNetworksIdActionsAddSubnetActionResponseAction(@JsonProperty("command") String command, @JsonProperty("error") PostNetworksIdActionsAddSubnetActionResponseActionError error, @JsonProperty("finished") String finished, @JsonProperty("id") Long id, @JsonProperty("progress") Double progress, @JsonProperty("resources") PostNetworksIdActionsAddSubnetActionResponseActionResources[] resources, @JsonProperty("started") String started, @JsonProperty("status") PostNetworksIdActionsAddSubnetActionResponseActionStatusEnum status) {
        this.command = command;
        this.error = error;
        this.finished = finished;
        this.id = id;
