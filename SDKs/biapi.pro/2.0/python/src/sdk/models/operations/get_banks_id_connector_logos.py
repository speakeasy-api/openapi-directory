...
class GetBanksIDConnectorLogosRequest:
...
class GetBanksIDConnectorLogosResponse:
    ...
    get_banks_id_connector_logos_200_application_json_object: Optional[GetBanksIDConnectorLogos200ApplicationJSON] = dataclasses.field(default=None)
    r"""connectorlogos"""  
