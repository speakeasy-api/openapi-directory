...
type DomainsProjectsLocationsRegistrationsResetAuthorizationCodePathParams struct {
...
type DomainsProjectsLocationsRegistrationsResetAuthorizationCodeQueryParams struct {
	// V1 error format.
