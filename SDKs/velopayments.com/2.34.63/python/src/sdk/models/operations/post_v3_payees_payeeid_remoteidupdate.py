...
from ..shared import updateremoteidrequestv3 as shared_updateremoteidrequestv3
...
class PostV3PayeesPayeeIDRemoteIDUpdateRequest:
    ...
    update_remote_id_request_v3: shared_updateremoteidrequestv3.UpdateRemoteIDRequestV3 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Request to update payee remote id v3"""  
