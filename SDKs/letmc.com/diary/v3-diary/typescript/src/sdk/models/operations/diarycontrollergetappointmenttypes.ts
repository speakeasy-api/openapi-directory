...
export class DiaryControllerGetAppointmentTypesRequest extends SpeakeasyBase {
  /**
...
export class DiaryControllerGetAppointmentTypesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
