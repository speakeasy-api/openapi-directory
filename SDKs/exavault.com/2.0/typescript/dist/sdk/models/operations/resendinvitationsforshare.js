...
exports.ResendInvitationsForShareResponse = exports.ResendInvitationsForShareRequest = exports.ResendInvitationsForShareResendInvitationsRequestBody = void 0;
...
var ResendInvitationsForShareResendInvitationsRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "recipientId" }),
...
var ResendInvitationsForShareRequest = /** @class */ (function (_super) {
    ...
    ], ResendInvitationsForShareRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ev-access-token",
        }),
        __metadata("design:type", String)
    ], ResendInvitationsForShareRequest.prototype, "evAccessToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ev-api-key",
        }),
        __metadata("design:type", String)
    ], ResendInvitationsForShareRequest.prototype, "evApiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=shareId",
        }),
        __metadata("design:type", Number)
    ], ResendInvitationsForShareRequest.prototype, "shareId", void 0);
...
var ResendInvitationsForShareResponse = /** @class */ (function (_super) {
    ...
    ], ResendInvitationsForShareResponse.prototype, "rawResponse", void 0);
