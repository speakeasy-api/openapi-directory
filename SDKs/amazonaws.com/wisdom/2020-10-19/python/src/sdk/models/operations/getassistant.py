...
from ..shared import getassistantresponse as shared_getassistantresponse
...
class GetAssistantResponse:
    ...
    get_assistant_response: Optional[shared_getassistantresponse.GetAssistantResponse] = dataclasses.field(default=None)
    r"""Success"""  
