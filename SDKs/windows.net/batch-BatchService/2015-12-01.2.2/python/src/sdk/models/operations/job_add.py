...
from ..shared import jobaddparameter as shared_jobaddparameter
...
class JobAddRequest:
    ...
    job_add_parameter: shared_jobaddparameter.JobAddParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Specifies the job to be added."""  
