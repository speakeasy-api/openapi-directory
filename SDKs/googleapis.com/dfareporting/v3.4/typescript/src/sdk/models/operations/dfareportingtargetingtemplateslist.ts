...
export class DfareportingTargetingTemplatesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum DfareportingTargetingTemplatesListSortFieldEnum {
  Id = "ID",
  Name = "NAME",
}
 ...
 */
export enum DfareportingTargetingTemplatesListSortOrderEnum {
  Ascending = "ASCENDING",
  Descending = "DESCENDING",
}

export class DfareportingTargetingTemplatesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DfareportingTargetingTemplatesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
