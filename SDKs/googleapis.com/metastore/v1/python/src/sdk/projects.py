...
class Projects:
    ...
    def metastore_projects_locations_federations_create(self, request: operations.MetastoreProjectsLocationsFederationsCreateRequest) -> operations.MetastoreProjectsLocationsFederationsCreateResponse:
        ...
        url = utils.generate_url(base_url, "/v1/{parent}/federations", request.path_params)
    ...
    def metastore_projects_locations_services_backups_get_iam_policy(self, request: operations.MetastoreProjectsLocationsServicesBackupsGetIamPolicyRequest) -> operations.MetastoreProjectsLocationsServicesBackupsGetIamPolicyResponse:
        ...
        res = operations.MetastoreProjectsLocationsServicesBackupsGetIamPolicyResponse(status_code=r.status_code, content_type=content_type)
    ...
    def metastore_projects_locations_services_backups_set_iam_policy(self, request: operations.MetastoreProjectsLocationsServicesBackupsSetIamPolicyRequest) -> operations.MetastoreProjectsLocationsServicesBackupsSetIamPolicyResponse:
        ...
        res = operations.MetastoreProjectsLocationsServicesBackupsSetIamPolicyResponse(status_code=r.status_code, content_type=content_type)
    ...
    def metastore_projects_locations_services_export_metadata(self, request: operations.MetastoreProjectsLocationsServicesExportMetadataRequest) -> operations.MetastoreProjectsLocationsServicesExportMetadataResponse:
        ...
        url = utils.generate_url(base_url, "/v1/{service}:exportMetadata", request.path_params)
    ...
    def metastore_projects_locations_services_metadata_imports_create(self, request: operations.MetastoreProjectsLocationsServicesMetadataImportsCreateRequest) -> operations.MetastoreProjectsLocationsServicesMetadataImportsCreateResponse:
        ...
        url = utils.generate_url(base_url, "/v1/{parent}/metadataImports", request.path_params)
    ...
    def metastore_projects_locations_services_restore(self, request: operations.MetastoreProjectsLocationsServicesRestoreRequest) -> operations.MetastoreProjectsLocationsServicesRestoreResponse:
        ...
        url = utils.generate_url(base_url, "/v1/{service}:restore", request.path_params)
    ...
    def metastore_projects_locations_services_test_iam_permissions(self, request: operations.MetastoreProjectsLocationsServicesTestIamPermissionsRequest) -> operations.MetastoreProjectsLocationsServicesTestIamPermissionsResponse:
        ...
        res = operations.MetastoreProjectsLocationsServicesTestIamPermissionsResponse(status_code=r.status_code, content_type=content_type)
