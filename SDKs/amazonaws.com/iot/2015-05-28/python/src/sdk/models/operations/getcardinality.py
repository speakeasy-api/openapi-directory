...
class GetCardinalityRequest:
    headers: GetCardinalityHeaders = dataclasses.field()
    request: GetCardinalityRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
