...
class Comments:
    ...
    def drive_comments_insert(self, request: operations.DriveCommentsInsertRequest, security: operations.DriveCommentsInsertSecurity) -> operations.DriveCommentsInsertResponse:
        r"""Creates a new comment on the given file."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.DriveCommentsInsertRequest, base_url, '/files/{fileId}/comments', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "comment", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.DriveCommentsInsertRequest, request)
        ...
        res = operations.DriveCommentsInsertResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def drive_comments_patch(self, request: operations.DriveCommentsPatchRequest, security: operations.DriveCommentsPatchSecurity) -> operations.DriveCommentsPatchResponse:
        r"""Updates an existing comment."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.DriveCommentsPatchRequest, base_url, '/files/{fileId}/comments/{commentId}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "comment", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.DriveCommentsPatchRequest, request)
        ...
        res = operations.DriveCommentsPatchResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
