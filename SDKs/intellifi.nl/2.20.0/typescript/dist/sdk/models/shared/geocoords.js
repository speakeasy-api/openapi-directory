...
**/
var GeoCoords = /** @class */ (function (_super) {
    __extends(GeoCoords, _super);
    function GeoCoords() {
 ...
 * Last known geolocation estimate of this object. Not guaranteed to be included in response.
**/
var GeoCoordsInput = /** @class */ (function (_super) {
    __extends(GeoCoordsInput, _super);
    function GeoCoordsInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=lat" }),
