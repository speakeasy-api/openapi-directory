  ...
  **/
  deletePermissionsId(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.DeletePermissionsIdResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  postPermissions(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostPermissionsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
