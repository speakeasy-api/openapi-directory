...
func (e GetNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum) ToPointer() *GetNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum {
	return &e
}
...
func (e *GetNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "useNetworkSetting":
		*e = GetNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum: %v", v)
	}
}
