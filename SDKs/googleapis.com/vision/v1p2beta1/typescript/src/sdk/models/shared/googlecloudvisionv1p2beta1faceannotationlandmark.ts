 ...
 * Face landmark type.
 */
export enum GoogleCloudVisionV1p2beta1FaceAnnotationLandmarkTypeEnum {
 ...
 */
export class GoogleCloudVisionV1p2beta1FaceAnnotationLandmark extends SpeakeasyBase {
  /**
