...
export class ClassroomCoursesPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ClassroomCoursesPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ClassroomCoursesPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
