...
class UpdateDirectConnectGatewayAssociationRequest:
    ...
    update_direct_connect_gateway_association_request: shared_updatedirectconnectgatewayassociationrequest.UpdateDirectConnectGatewayAssociationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
