...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetAssociationByIdRequest req = new GetAssociationByIdRequest("accusantium");            

            GetAssociationByIdResponse res = sdk.retrieve.getAssociationById(req);
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetEvidenceByIdResponse res = sdk.retrieve.getEvidenceById(req);
...
"            
            ...
            PostEvidenceByIdResponse res = sdk.retrieve.postEvidenceById(req);
