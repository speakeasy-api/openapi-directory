...
exports.GetOfferingsOfferingIdUsersResponse = exports.GetOfferingsOfferingIdUsersRequest = exports.GetOfferingsOfferingIdUsersMarkersEnum = exports.GetOfferingsOfferingIdUsersLearnersEnum = exports.GetOfferingsOfferingIdUsersFacilitatorsEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * If true, facilitators are included in the results.
 */
var GetOfferingsOfferingIdUsersFacilitatorsEnum;
...
})(GetOfferingsOfferingIdUsersFacilitatorsEnum = exports.GetOfferingsOfferingIdUsersFacilitatorsEnum || (exports.GetOfferingsOfferingIdUsersFacilitatorsEnum = {}));
/**
 * If true, learners are included in the results.
 */
var GetOfferingsOfferingIdUsersLearnersEnum;
...
})(GetOfferingsOfferingIdUsersLearnersEnum = exports.GetOfferingsOfferingIdUsersLearnersEnum || (exports.GetOfferingsOfferingIdUsersLearnersEnum = {}));
/**
 * If true, markers are included in the results.
 */
var GetOfferingsOfferingIdUsersMarkersEnum;
...
})(GetOfferingsOfferingIdUsersMarkersEnum = exports.GetOfferingsOfferingIdUsersMarkersEnum || (exports.GetOfferingsOfferingIdUsersMarkersEnum = {}));
var GetOfferingsOfferingIdUsersRequest = /** @class */ (function (_super) {
    ...
    ], GetOfferingsOfferingIdUsersRequest.prototype, "facilitators", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=learners",
        }),
        __metadata("design:type", String)
    ], GetOfferingsOfferingIdUsersRequest.prototype, "learners", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=markers",
        }),
        __metadata("design:type", String)
    ], GetOfferingsOfferingIdUsersRequest.prototype, "markers", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=offeringId",
        }),
        __metadata("design:type", String)
    ], GetOfferingsOfferingIdUsersRequest.prototype, "offeringId", void 0);
...
var GetOfferingsOfferingIdUsersResponse = /** @class */ (function (_super) {
    ...
    ], GetOfferingsOfferingIdUsersResponse.prototype, "rawResponse", void 0);
