...
var Ospf = /** @class */ (function () {
    function Ospf(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Ospf.prototype.getNetworkSwitchRoutingOspf = function (req, config) {
    ...
    **/
    Ospf.prototype.updateNetworkSwitchRoutingOspf = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
