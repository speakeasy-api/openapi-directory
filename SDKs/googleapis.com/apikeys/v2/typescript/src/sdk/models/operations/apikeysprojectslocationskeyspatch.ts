...
export class ApikeysProjectsLocationsKeysPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ApikeysProjectsLocationsKeysPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ApikeysProjectsLocationsKeysPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
