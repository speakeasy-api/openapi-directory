...
type DataplexProjectsLocationsLakesZonesAssetsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DataplexProjectsLocationsLakesZonesAssetsListPathParams struct {
...
type DataplexProjectsLocationsLakesZonesAssetsListQueryParams struct {
	// V1 error format.
...
type DataplexProjectsLocationsLakesZonesAssetsListRequest struct {
...
type DataplexProjectsLocationsLakesZonesAssetsListResponse struct {
	ContentType string
	// Successful response
