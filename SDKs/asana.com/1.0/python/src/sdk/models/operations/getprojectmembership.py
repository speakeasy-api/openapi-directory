...
class GetProjectMembership200ApplicationJSON:
    r"""Successfully retrieved the requested project membership."""
    
    data: Optional[shared_projectmembershipresponse.ProjectMembershipResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
