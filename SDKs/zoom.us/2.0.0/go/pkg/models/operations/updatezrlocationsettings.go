...
type UpdateZRLocationSettingsApplicationJSON2ClientAlert struct {
...
type UpdateZRLocationSettingsApplicationJSON2DigitalSignageBanner struct {
...
type UpdateZRLocationSettingsApplicationJSON2DigitalSignageDisplayPeriod struct {
...
// UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListActionEnum - Specify an action for the content list. The value can be one of the following:<br>
// `add`: Add another content list.<br>
// `update`: Update existing content list.<br>
// `delete`: Delete content list.
type UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListActionEnum string

const (
	UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListActionEnumAdd    UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListActionEnum = "add"
	UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListActionEnumUpdate UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListActionEnum = "update"
	UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListActionEnumDelete UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListActionEnum = "delete"
)

func (e *UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListActionEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "update":
		fallthrough
	case "delete":
		*e = UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListActionEnum: %s", s)
	}
}

// UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListContents - Content list.
type UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListContents struct {
...
type UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayList struct {
	// Specify an action for the content list. The value can be one of the following:<br>
	// `add`: Add another content list.<br>
	// `update`: Update existing content list.<br>
	// `delete`: Delete content list.
	//
	Action   *UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListActionEnum `json:"action,omitempty"`
	Contents []UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayListContents  `json:"contents,omitempty"`
...
type UpdateZRLocationSettingsApplicationJSON2DigitalSignage struct {
	Banner *UpdateZRLocationSettingsApplicationJSON2DigitalSignageBanner `json:"banner,omitempty"`
	...
	DisplayPeriod *UpdateZRLocationSettingsApplicationJSON2DigitalSignageDisplayPeriod `json:"display_period,omitempty"`
	...
	// Content list.
	PlayList []UpdateZRLocationSettingsApplicationJSON2DigitalSignagePlayList `json:"play_list,omitempty"`
}
...
type UpdateZRLocationSettingsApplicationJSON2Notification struct {
...
type UpdateZRLocationSettingsApplicationJSON2 struct {
	...
	ClientAlert    *UpdateZRLocationSettingsApplicationJSON2ClientAlert    `json:"client_alert,omitempty"`
	DigitalSignage *UpdateZRLocationSettingsApplicationJSON2DigitalSignage `json:"digital_signage,omitempty"`
	// [Notifications Settings](https://support.zoom.us/hc/en-us/articles/205394099-Zoom-Room-Alerts#h_b430b5f2-5150-4522-9c96-c77f22ab70bc) includes the circumstances in which the room sends an email alert to the support team to notify them of a potentially urgent issue. These issues can affect the operation of the room, but do not display on the TV screen. The email alert is sent to the email address specified in the Notification Email Recipients section.
	Notification *UpdateZRLocationSettingsApplicationJSON2Notification `json:"notification,omitempty"`
}

// UpdateZRLocationSettingsApplicationJSON1MeetingSecurityEncryptionTypeEnum - Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
// `enhanced_encryption`: Enhanced encryption. Encryption is stored in the cloud if you enable this option. <br>
//
// `e2ee`: [End-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871). The encryption key is stored in your local device and can not be obtained by anyone else. Enabling this setting also **disables** the following features: join before host, cloud recording, streaming, live transcription, breakout rooms, polling, 1:1 private chat, and meeting reactions.
type UpdateZRLocationSettingsApplicationJSON1MeetingSecurityEncryptionTypeEnum string

const (
	UpdateZRLocationSettingsApplicationJSON1MeetingSecurityEncryptionTypeEnumEnhancedEncryption UpdateZRLocationSettingsApplicationJSON1MeetingSecurityEncryptionTypeEnum = "enhanced_encryption"
	UpdateZRLocationSettingsApplicationJSON1MeetingSecurityEncryptionTypeEnumE2ee               UpdateZRLocationSettingsApplicationJSON1MeetingSecurityEncryptionTypeEnum = "e2ee"
)

func (e *UpdateZRLocationSettingsApplicationJSON1MeetingSecurityEncryptionTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "enhanced_encryption":
		fallthrough
	case "e2ee":
		*e = UpdateZRLocationSettingsApplicationJSON1MeetingSecurityEncryptionTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateZRLocationSettingsApplicationJSON1MeetingSecurityEncryptionTypeEnum: %s", s)
	}
}

type UpdateZRLocationSettingsApplicationJSON1MeetingSecurity struct {
	// Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
	// `enhanced_encryption`: Enhanced encryption. Encryption is stored in the cloud if you enable this option. <br>
	//
	// `e2ee`: [End-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871). The encryption key is stored in your local device and can not be obtained by anyone else. Enabling this setting also **disables** the following features: join before host, cloud recording, streaming, live transcription, breakout rooms, polling, 1:1 private chat, and meeting reactions.
	EncryptionType *UpdateZRLocationSettingsApplicationJSON1MeetingSecurityEncryptionTypeEnum `json:"encryption_type,omitempty"`
...
type UpdateZRLocationSettingsApplicationJSON1ZoomRooms struct {
...
type UpdateZRLocationSettingsApplicationJSON1 struct {
	MeetingSecurity *UpdateZRLocationSettingsApplicationJSON1MeetingSecurity `json:"meeting_security,omitempty"`
	ZoomRooms       *UpdateZRLocationSettingsApplicationJSON1ZoomRooms       `json:"zoom_rooms,omitempty"`
}

type UpdateZRLocationSettingsApplicationJSONType string

const (
	UpdateZRLocationSettingsApplicationJSONTypeUpdateZRLocationSettingsApplicationJSON1 UpdateZRLocationSettingsApplicationJSONType = "updateZRLocationSettings_ApplicationJSON_1"
	UpdateZRLocationSettingsApplicationJSONTypeUpdateZRLocationSettingsApplicationJSON2 UpdateZRLocationSettingsApplicationJSONType = "updateZRLocationSettings_ApplicationJSON_2"
)

type UpdateZRLocationSettingsApplicationJSON struct {
	UpdateZRLocationSettingsApplicationJSON1 *UpdateZRLocationSettingsApplicationJSON1
	UpdateZRLocationSettingsApplicationJSON2 *UpdateZRLocationSettingsApplicationJSON2

	Type UpdateZRLocationSettingsApplicationJSONType
}

func CreateUpdateZRLocationSettingsApplicationJSONUpdateZRLocationSettingsApplicationJSON1(updateZRLocationSettingsApplicationJSON1 UpdateZRLocationSettingsApplicationJSON1) UpdateZRLocationSettingsApplicationJSON {
	typ := UpdateZRLocationSettingsApplicationJSONTypeUpdateZRLocationSettingsApplicationJSON1

	return UpdateZRLocationSettingsApplicationJSON{
		UpdateZRLocationSettingsApplicationJSON1: &updateZRLocationSettingsApplicationJSON1,
		Type:                                     typ,
	}
}

func CreateUpdateZRLocationSettingsApplicationJSONUpdateZRLocationSettingsApplicationJSON2(updateZRLocationSettingsApplicationJSON2 UpdateZRLocationSettingsApplicationJSON2) UpdateZRLocationSettingsApplicationJSON {
	typ := UpdateZRLocationSettingsApplicationJSONTypeUpdateZRLocationSettingsApplicationJSON2
...
func (u *UpdateZRLocationSettingsApplicationJSON) UnmarshalJSON(data []byte) error {
	var d *json.Decoder

	updateZRLocationSettingsApplicationJSON1 := new(UpdateZRLocationSettingsApplicationJSON1)
	d = json.NewDecoder(bytes.NewReader(data))
	d.DisallowUnknownFields()
	if err := d.Decode(&updateZRLocationSettingsApplicationJSON1); err == nil {
		u.UpdateZRLocationSettingsApplicationJSON1 = updateZRLocationSettingsApplicationJSON1
		u.Type = UpdateZRLocationSettingsApplicationJSONTypeUpdateZRLocationSettingsApplicationJSON1
		return nil
	}

	updateZRLocationSettingsApplicationJSON2 := new(UpdateZRLocationSettingsApplicationJSON2)
	d = json.NewDecoder(bytes.NewReader(data))
	d.DisallowUnknownFields()
	if err := d.Decode(&updateZRLocationSettingsApplicationJSON2); err == nil {
		u.UpdateZRLocationSettingsApplicationJSON2 = updateZRLocationSettingsApplicationJSON2
		u.Type = UpdateZRLocationSettingsApplicationJSONTypeUpdateZRLocationSettingsApplicationJSON2
		return nil
	}
...
func (u UpdateZRLocationSettingsApplicationJSON) MarshalJSON() ([]byte, error) {
	if u.UpdateZRLocationSettingsApplicationJSON1 != nil {
		return json.Marshal(u.UpdateZRLocationSettingsApplicationJSON1)
	}

	if u.UpdateZRLocationSettingsApplicationJSON2 != nil {
		return json.Marshal(u.UpdateZRLocationSettingsApplicationJSON2)
	}
