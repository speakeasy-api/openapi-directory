...
class GetBadgesIdsQueryParams:
    ...
    order: Optional[GetBadgesIdsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetBadgesIdsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetBadgesIdsRequest:
    path_params: GetBadgesIdsPathParams = dataclasses.field()
    query_params: GetBadgesIdsQueryParams = dataclasses.field()
