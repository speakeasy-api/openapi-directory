...
export class ProductDigitalProducts {
  ...
  deleteProductsIdDigitalProductsDigitalProductIdJson(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.DeleteProductsIdDigitalProductsDigitalProductIdJsonRequest(
          req
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DeleteProductsIdDigitalProductsDigitalProductIdJsonResponse =
        new operations.DeleteProductsIdDigitalProductsDigitalProductIdJsonResponse(
          {
  ...
  getProductsIdDigitalProductsJson(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetProductsIdDigitalProductsJsonResponse =
        new operations.GetProductsIdDigitalProductsJsonResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            ...
            res.digitalProducts = utils.objectToClass(
              httpRes?.data,
              shared.DigitalProduct,
              resFieldDepth
            );
          }
          break;
  ...
  getProductsIdDigitalProductsCountJson(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetProductsIdDigitalProductsCountJsonResponse =
        new operations.GetProductsIdDigitalProductsCountJsonResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getProductsIdDigitalProductsDigitalProductIdJson(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetProductsIdDigitalProductsDigitalProductIdJsonRequest(
          req
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetProductsIdDigitalProductsDigitalProductIdJsonResponse =
        new operations.GetProductsIdDigitalProductsDigitalProductIdJsonResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.digitalProduct = utils.objectToClass(
              httpRes?.data,
              shared.DigitalProduct
            );
          }
  ...
  postProductsIdDigitalProductsJson(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostProductsIdDigitalProductsJsonResponse =
        new operations.PostProductsIdDigitalProductsJsonResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
