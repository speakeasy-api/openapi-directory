...
class DescribeUserImportJobRequest:
    ...
    describe_user_import_job_request: shared_describeuserimportjobrequest.DescribeUserImportJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
