...
// APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCostCapabilities - The set of Boolean properties that indicate whether a phone number can receive calls or messages.  Capabilities are: `Voice`, `SMS`, and `MMS` and each capability can be: `true` or `false`.
type APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCostCapabilities struct {
...
type APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost struct {
	...
	Capabilities *APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCostCapabilities `json:"capabilities,omitempty"`
