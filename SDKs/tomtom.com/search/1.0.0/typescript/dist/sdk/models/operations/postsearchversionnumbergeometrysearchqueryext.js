...
exports.PostSearchVersionNumberGeometrySearchQueryExtResponse = exports.PostSearchVersionNumberGeometrySearchQueryExtRequest = exports.PostSearchVersionNumberGeometrySearchQueryExtRequestBody = exports.PostSearchVersionNumberGeometrySearchQueryExtRequestBodyGeometryList = void 0;
...
var PostSearchVersionNumberGeometrySearchQueryExtRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: PostSearchVersionNumberGeometrySearchQueryExtRequestBodyGeometryList,
        }),
        (0, class_transformer_1.Expose)({ name: "geometryList" }),
        (0, class_transformer_1.Type)(function () { return PostSearchVersionNumberGeometrySearchQueryExtRequestBodyGeometryList; }),
        __metadata("design:type", Array)
...
var PostSearchVersionNumberGeometrySearchQueryExtRequest = /** @class */ (function (_super) {
    ...
    ], PostSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=ext" }),
        __metadata("design:type", String)
    ], PostSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "ext", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=extendedPostalCodesFor",
        }),
        __metadata("design:type", String)
    ], PostSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "extendedPostalCodesFor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=idxSet",
        }),
        __metadata("design:type", String)
    ], PostSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "idxSet", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=language",
        }),
        __metadata("design:type", String)
    ], PostSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "language", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], PostSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=query",
        }),
        __metadata("design:type", String)
    ], PostSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=versionNumber",
        }),
        __metadata("design:type", String)
    ], PostSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "versionNumber", void 0);
...
var PostSearchVersionNumberGeometrySearchQueryExtResponse = /** @class */ (function (_super) {
    ...
    ], PostSearchVersionNumberGeometrySearchQueryExtResponse.prototype, "rawResponse", void 0);
