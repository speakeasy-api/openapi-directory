...
exports.DriveRepliesDeleteResponse = exports.DriveRepliesDeleteRequest = exports.DriveRepliesDeleteSecurity = exports.DriveRepliesDeleteSecurityOption2 = exports.DriveRepliesDeleteSecurityOption1 = void 0;
...
var DriveRepliesDeleteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DriveRepliesDeleteRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=commentId",
        }),
        __metadata("design:type", String)
    ], DriveRepliesDeleteRequest.prototype, "commentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], DriveRepliesDeleteRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=fileId",
        }),
        __metadata("design:type", String)
    ], DriveRepliesDeleteRequest.prototype, "fileId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], DriveRepliesDeleteRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], DriveRepliesDeleteRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], DriveRepliesDeleteRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], DriveRepliesDeleteRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=replyId",
        }),
        __metadata("design:type", String)
    ], DriveRepliesDeleteRequest.prototype, "replyId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], DriveRepliesDeleteRequest.prototype, "userIp", void 0);
...
var DriveRepliesDeleteResponse = /** @class */ (function (_super) {
    ...
    ], DriveRepliesDeleteResponse.prototype, "rawResponse", void 0);
