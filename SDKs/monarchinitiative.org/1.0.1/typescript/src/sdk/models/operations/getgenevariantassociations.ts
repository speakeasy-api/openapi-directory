...
export class GetGeneVariantAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGeneVariantAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGeneVariantAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGeneVariantAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
