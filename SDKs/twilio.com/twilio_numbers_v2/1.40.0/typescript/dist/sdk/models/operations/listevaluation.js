...
exports.ListEvaluationResponse = exports.ListEvaluationListEvaluationResponse = exports.ListEvaluationListEvaluationResponseMeta = exports.ListEvaluationRequest = exports.ListEvaluationSecurity = exports.ListEvaluationServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListEvaluationServerList = ["https://numbers.twilio.com"];
var ListEvaluationSecurity = /** @class */ (function (_super) {
    ...
    ], ListEvaluationSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListEvaluationSecurity.prototype, "username", void 0);
...
var ListEvaluationRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListEvaluationRequest.prototype, "bundleSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListEvaluationRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListEvaluationRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListEvaluationRequest.prototype, "pageToken", void 0);
...
var ListEvaluationListEvaluationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListEvaluationListEvaluationResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.NumbersV2RegulatoryComplianceBundleEvaluation,
        }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return shared.NumbersV2RegulatoryComplianceBundleEvaluation; }),
...
var ListEvaluationResponse = /** @class */ (function (_super) {
    ...
    ], ListEvaluationResponse.prototype, "rawResponse", void 0);
