...
class GetTrackingSnippet404ApplicationJSON
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\GetTrackingSnippet404ApplicationJSONMeta')]
    public GetTrackingSnippet404ApplicationJSONMeta $meta;
    
	public function __construct()
	{
		$this->message = "";
		$this->meta = new \OpenAPI\OpenAPI\Models\Operations\GetTrackingSnippet404ApplicationJSONMeta();
	}
}
