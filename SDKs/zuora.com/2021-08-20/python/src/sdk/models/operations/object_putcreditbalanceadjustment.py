...
class ObjectPutCreditBalanceAdjustmentPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectPutCreditBalanceAdjustmentQueryParams:
...
@dataclasses.dataclass
class ObjectPutCreditBalanceAdjustmentHeaders:
    zuora_entity_ids: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Entity-Ids', 'style': 'simple', 'explode': False }})
    zuora_track_id: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Track-Id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectPutCreditBalanceAdjustmentRequest:
    headers: ObjectPutCreditBalanceAdjustmentHeaders = dataclasses.field()
    path_params: ObjectPutCreditBalanceAdjustmentPathParams = dataclasses.field()
    query_params: ObjectPutCreditBalanceAdjustmentQueryParams = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class ObjectPutCreditBalanceAdjustmentResponse:
