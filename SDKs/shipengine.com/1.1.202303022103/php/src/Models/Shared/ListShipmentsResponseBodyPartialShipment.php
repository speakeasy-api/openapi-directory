...
class ListShipmentsResponseBodyPartialShipment
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentDeliveryConfirmationEnum $confirmation
     */
	#[\JMS\Serializer\Annotation\SerializedName('confirmation')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentDeliveryConfirmationEnum>')]
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentInternationalShipmentOptions $customs
     */
	#[\JMS\Serializer\Annotation\SerializedName('customs')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentInternationalShipmentOptions')]
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentInsuranceProviderEnum $insuranceProvider
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_provider')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentInsuranceProviderEnum>')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentOriginTypeEnum $originType
     */
	#[\JMS\Serializer\Annotation\SerializedName('origin_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentOriginTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ListShipmentsResponseBodyPartialShipmentOriginTypeEnum $originType = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentShipmentStatusEnum $shipmentStatus
     */
	#[\JMS\Serializer\Annotation\SerializedName('shipment_status')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentShipmentStatusEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentWeight $totalWeight
     */
	#[\JMS\Serializer\Annotation\SerializedName('total_weight')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentWeight')]
	...
	public function __construct()
	{
		...
		$this->carrierId = "";
		$this->confirmation = \OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentDeliveryConfirmationEnum::NONE;
		$this->createdAt = new \DateTime();
		$this->customs = new \OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentInternationalShipmentOptions();
		$this->externalOrderId = null;
		$this->externalShipmentId = null;
		$this->insuranceProvider = \OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentInsuranceProviderEnum::NONE;
		$this->items = null;
		...
		$this->shipmentStatus = \OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentShipmentStatusEnum::PENDING;
		$this->tags = [];
		$this->taxIdentifiers = null;
		$this->totalWeight = new \OpenAPI\OpenAPI\Models\Shared\ListShipmentsResponseBodyPartialShipmentWeight();
		$this->warehouseId = "";
	}
}
