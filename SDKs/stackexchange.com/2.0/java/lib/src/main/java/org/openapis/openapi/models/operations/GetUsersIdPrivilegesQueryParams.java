...
public class GetUsersIdPrivilegesQueryParams {
    /**
    ...
    public GetUsersIdPrivilegesQueryParams withCallback(String callback) {
    ...
    public GetUsersIdPrivilegesQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public Long page;
    public GetUsersIdPrivilegesQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdPrivilegesQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetUsersIdPrivilegesQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
