...
class CreateParameterGroupRequest:
    ...
    create_parameter_group_request: shared_createparametergrouprequest.CreateParameterGroupRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
