...
class DfareportingPlacementsInsertRequest:
    path_params: DfareportingPlacementsInsertPathParams = dataclasses.field()
    query_params: DfareportingPlacementsInsertQueryParams = dataclasses.field()
    security: DfareportingPlacementsInsertSecurity = dataclasses.field()
