...
var Action = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=disableImagePrefetch" }),
        __metadata("design:type", Boolean)
    ], Action.prototype, "disableImagePrefetch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=disableStandardErrorCapture" }),
        __metadata("design:type", Boolean)
    ], Action.prototype, "disableStandardErrorCapture", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=enableFuse" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mounts", elemType: mount_1.Mount }),
        __metadata("design:type", Array)
    ], Action.prototype, "mounts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=pidNamespace" }),
        __metadata("design:type", String)
    ], Action.prototype, "pidNamespace", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=portMappings" }),
        __metadata("design:type", Object)
    ], Action.prototype, "portMappings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=publishExposedPorts" }),
        __metadata("design:type", Boolean)
    ], Action.prototype, "publishExposedPorts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=runInBackground" }),
        __metadata("design:type", Boolean)
