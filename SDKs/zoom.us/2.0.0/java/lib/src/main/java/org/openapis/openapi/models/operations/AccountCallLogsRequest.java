...
public class AccountCallLogsRequest {
    ...
    public String from;
    public AccountCallLogsRequest withFrom(String from) {
        this.from = from;
        return this;
    }
    ...
    public AccountCallLogsRequest withNextPageToken(String nextPageToken) {
    ...
    public AccountCallLogsRequest withPageSize(Long pageSize) {
    ...
    public String path;
    public AccountCallLogsRequest withPath(String path) {
        this.path = path;
        return this;
    }
    ...
    public AccountCallLogsRequest withSiteId(String siteId) {
        this.siteId = siteId;
        return this;
    }
    ...
    public AccountCallLogsRequest withTimeType(AccountCallLogsTimeTypeEnum timeType) {
    ...
    public String to;
    public AccountCallLogsRequest withTo(String to) {
        this.to = to;
        return this;
    }
    ...
    public String type;
    public AccountCallLogsRequest withType(String type) {
        this.type = type;
        return this;
    }
