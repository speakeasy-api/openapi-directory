...
class GoogleCloudBillingBudgetsV1ThresholdRuleSpendBasisEnum(str, Enum):
    r"""Optional. The type of basis used to determine if spend has passed the threshold. Behavior defaults to CURRENT_SPEND if not set."""
...
class GoogleCloudBillingBudgetsV1ThresholdRule:
    ...
    r"""Required. Send an alert when this threshold is exceeded. This is a 1.0-based percentage, so 0.5 = 50%. Validation: non-negative number."""  
