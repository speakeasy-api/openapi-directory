...
exports.ListSyncListItemResponse = exports.ListSyncListItemListSyncListItemResponse = exports.ListSyncListItemListSyncListItemResponseMeta = exports.ListSyncListItemRequest = exports.ListSyncListItemSecurity = exports.ListSyncListItemServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListSyncListItemServerList = ["https://sync.twilio.com"];
var ListSyncListItemSecurity = /** @class */ (function (_super) {
    ...
    ], ListSyncListItemSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSyncListItemSecurity.prototype, "username", void 0);
    return ListSyncListItemSecurity;
}(utils_1.SpeakeasyBase));
exports.ListSyncListItemSecurity = ListSyncListItemSecurity;
var ListSyncListItemRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListSyncListItemRequest.prototype, "bounds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=From" }),
        __metadata("design:type", String)
    ], ListSyncListItemRequest.prototype, "from", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ListSid",
        }),
        __metadata("design:type", String)
    ], ListSyncListItemRequest.prototype, "listSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Order" }),
        __metadata("design:type", String)
    ], ListSyncListItemRequest.prototype, "order", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListSyncListItemRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSyncListItemRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSyncListItemRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListSyncListItemRequest.prototype, "serviceSid", void 0);
    return ListSyncListItemRequest;
}(utils_1.SpeakeasyBase));
exports.ListSyncListItemRequest = ListSyncListItemRequest;
...
exports.ListSyncListItemListSyncListItemResponseMeta = ListSyncListItemListSyncListItemResponseMeta;
/**
 * OK
 */
var ListSyncListItemListSyncListItemResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.SyncV1ServiceSyncListSyncListItem }),
        (0, class_transformer_1.Expose)({ name: "items" }),
        (0, class_transformer_1.Type)(function () { return shared.SyncV1ServiceSyncListSyncListItem; }),
        __metadata("design:type", Array)
    ], ListSyncListItemListSyncListItemResponse.prototype, "items", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListSyncListItemListSyncListItemResponseMeta; }),
...
exports.ListSyncListItemListSyncListItemResponse = ListSyncListItemListSyncListItemResponse;
var ListSyncListItemResponse = /** @class */ (function (_super) {
    ...
    ], ListSyncListItemResponse.prototype, "rawResponse", void 0);
    return ListSyncListItemResponse;
}(utils_1.SpeakeasyBase));
exports.ListSyncListItemResponse = ListSyncListItemResponse;
