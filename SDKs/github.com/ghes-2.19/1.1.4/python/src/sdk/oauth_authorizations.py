...
class OauthAuthorizations:
    ...
    def oauth_authorizations_check_authorization(self, request: operations.OauthAuthorizationsCheckAuthorizationRequest) -> operations.OauthAuthorizationsCheckAuthorizationResponse:
        ...
        res = operations.OauthAuthorizationsCheckAuthorizationResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AuthorizationWithUser])
    ...
    def oauth_authorizations_reset_authorization(self, request: operations.OauthAuthorizationsResetAuthorizationRequest) -> operations.OauthAuthorizationsResetAuthorizationResponse:
        ...
        res = operations.OauthAuthorizationsResetAuthorizationResponse(status_code=r.status_code, content_type=content_type)
    ...
    def oauth_authorizations_revoke_authorization_for_application(self, request: operations.OauthAuthorizationsRevokeAuthorizationForApplicationRequest) -> operations.OauthAuthorizationsRevokeAuthorizationForApplicationResponse:
        ...
        res = operations.OauthAuthorizationsRevokeAuthorizationForApplicationResponse(status_code=r.status_code, content_type=content_type)
    ...
    def oauth_authorizations_revoke_grant_for_application(self, request: operations.OauthAuthorizationsRevokeGrantForApplicationRequest) -> operations.OauthAuthorizationsRevokeGrantForApplicationResponse:
        ...
        res = operations.OauthAuthorizationsRevokeGrantForApplicationResponse(status_code=r.status_code, content_type=content_type)
