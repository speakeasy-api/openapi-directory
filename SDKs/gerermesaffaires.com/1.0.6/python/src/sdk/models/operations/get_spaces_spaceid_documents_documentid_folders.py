...
class GetSpacesSpaceIDDocumentsDocumentIDFolders200ApplicationJSON:
    ...
    folders: Optional[list[GetSpacesSpaceIDDocumentsDocumentIDFolders200ApplicationJSONFolders]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Folders'), 'exclude': lambda f: f is None }})  
    id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Id'), 'exclude': lambda f: f is None }})  
...
class GetSpacesSpaceIDDocumentsDocumentIDFoldersResponse:
    ...
    get_spaces_space_id_documents_document_id_folders_200_application_json_object: Optional[GetSpacesSpaceIDDocumentsDocumentIDFolders200ApplicationJSON] = dataclasses.field(default=None)
    r"""document with folders"""  
