...
public class ListEndUserTypeListEndUserTypeResponse {
    ...
    public openapisdk.models.shared.TrusthubV1EndUserType[] endUserTypes;
    public ListEndUserTypeListEndUserTypeResponse withEndUserTypes(openapisdk.models.shared.TrusthubV1EndUserType[] endUserTypes) {
