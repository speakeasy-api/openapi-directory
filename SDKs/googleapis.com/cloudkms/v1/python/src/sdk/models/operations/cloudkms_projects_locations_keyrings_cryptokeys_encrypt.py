...
class CloudkmsProjectsLocationsKeyRingsCryptoKeysEncryptRequest:
    ...
    r"""Required. The resource name of the CryptoKey or CryptoKeyVersion to use for encryption. If a CryptoKey is specified, the server will use its primary version."""  
    ...
    r"""JSONP"""  
    encrypt_request: Optional[shared_encryptrequest.EncryptRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
