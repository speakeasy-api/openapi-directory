...
class ListInteractionChannelListInteractionChannelResponse:
    ...
    channels: Optional[list[shared_flex_v1_interaction_interaction_channel.FlexV1InteractionInteractionChannel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('channels'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListInteractionChannelListInteractionChannelResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
