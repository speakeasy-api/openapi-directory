 ...
 */
export enum HttpHealthCheckListWarningCodeEnum {
...
export class HttpHealthCheckListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class HttpHealthCheckListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: HttpHealthCheckListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class HttpHealthCheckList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: HttpHealthCheck1 })
  @Expose({ name: "items" })
  @Type(() => HttpHealthCheck1)
