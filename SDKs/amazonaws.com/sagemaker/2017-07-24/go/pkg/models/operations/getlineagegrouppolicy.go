...
type GetLineageGroupPolicyHeaders struct {
...
type GetLineageGroupPolicyRequest struct {
	Headers GetLineageGroupPolicyHeaders
	Request shared.GetLineageGroupPolicyRequest `request:"mediaType=application/json"`
}
