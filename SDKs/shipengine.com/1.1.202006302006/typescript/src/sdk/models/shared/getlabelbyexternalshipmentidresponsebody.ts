...
**/
export class GetLabelByExternalShipmentIdResponseBodyOptionalLink extends SpeakeasyBase {
 ...
 * 
**/
export class GetLabelByExternalShipmentIdResponseBodyMonetaryValue extends SpeakeasyBase {
 ...
 * 
**/
export class GetLabelByExternalShipmentIdResponseBodyLabelDownload extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=href" })
  href?: string;
 ...
 * 
**/
export class GetLabelByExternalShipmentIdResponseBodyOutput extends SpeakeasyBase {
