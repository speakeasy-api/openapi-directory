...
func (e UpdateWorkloadShareRequestBodyPermissionTypeEnum) ToPointer() *UpdateWorkloadShareRequestBodyPermissionTypeEnum {
	return &e
}
...
func (e *UpdateWorkloadShareRequestBodyPermissionTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "READONLY":
		fallthrough
	case "CONTRIBUTOR":
		*e = UpdateWorkloadShareRequestBodyPermissionTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateWorkloadShareRequestBodyPermissionTypeEnum: %v", v)
	}
}
...
type UpdateWorkloadShareRequest struct {
	RequestBody       UpdateWorkloadShareRequestBody `request:"mediaType=application/json"`
