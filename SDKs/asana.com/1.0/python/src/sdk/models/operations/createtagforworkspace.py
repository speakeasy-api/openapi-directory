...
class CreateTagForWorkspaceRequestBodyInput:
    ...
    data: Optional[shared_tagresponse.TagResponseInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
    

@dataclasses.dataclass
class CreateTagForWorkspaceRequest:
    
    request_body: CreateTagForWorkspaceRequestBodyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The tag to create."""  
