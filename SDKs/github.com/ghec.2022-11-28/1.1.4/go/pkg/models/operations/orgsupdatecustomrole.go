...
type OrgsUpdateCustomRolePathParams struct {
...
type OrgsUpdateCustomRoleRequest struct {
	PathParams OrgsUpdateCustomRolePathParams
	Request    OrgsUpdateCustomRoleRequestBody `request:"mediaType=application/json"`
}
