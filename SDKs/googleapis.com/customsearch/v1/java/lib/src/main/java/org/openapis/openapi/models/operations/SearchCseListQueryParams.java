...
public class SearchCseListQueryParams {
    /**
     * V1 error format.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=$.xgafv")
    public org.openapis.openapi.models.shared.XgafvEnum dollarXgafv;
    public SearchCseListQueryParams withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public SearchCseListQueryParams withAccessToken(String accessToken) {
    ...
    public SearchCseListQueryParams withAlt(org.openapis.openapi.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
    ...
    public SearchCseListQueryParams withC2coff(String c2coff) {
        this.c2coff = c2coff;
        return this;
    }
    ...
    public SearchCseListQueryParams withCallback(String callback) {
    ...
    public String cr;
    public SearchCseListQueryParams withCr(String cr) {
        this.cr = cr;
        return this;
    }
    ...
    public String cx;
    public SearchCseListQueryParams withCx(String cx) {
        this.cx = cx;
        return this;
    }
    ...
    public SearchCseListQueryParams withDateRestrict(String dateRestrict) {
    ...
    public SearchCseListQueryParams withExactTerms(String exactTerms) {
    ...
    public SearchCseListQueryParams withExcludeTerms(String excludeTerms) {
    ...
    public SearchCseListQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public SearchCseListQueryParams withFileType(String fileType) {
    ...
    public SearchCseListQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public String gl;
    public SearchCseListQueryParams withGl(String gl) {
        this.gl = gl;
        return this;
    }
    ...
    public SearchCseListQueryParams withGooglehost(String googlehost) {
    ...
    public SearchCseListQueryParams withHighRange(String highRange) {
    ...
    public String hl;
    public SearchCseListQueryParams withHl(String hl) {
        this.hl = hl;
        return this;
    }
    ...
    public String hq;
    public SearchCseListQueryParams withHq(String hq) {
        this.hq = hq;
        return this;
    }
    ...
    public SearchCseListImgColorTypeEnum imgColorType;
    public SearchCseListQueryParams withImgColorType(SearchCseListImgColorTypeEnum imgColorType) {
    ...
    public SearchCseListImgDominantColorEnum imgDominantColor;
    public SearchCseListQueryParams withImgDominantColor(SearchCseListImgDominantColorEnum imgDominantColor) {
    ...
    public SearchCseListImgSizeEnum imgSize;
    public SearchCseListQueryParams withImgSize(SearchCseListImgSizeEnum imgSize) {
    ...
    public SearchCseListImgTypeEnum imgType;
    public SearchCseListQueryParams withImgType(SearchCseListImgTypeEnum imgType) {
    ...
    public String key;
    public SearchCseListQueryParams withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public SearchCseListQueryParams withLinkSite(String linkSite) {
    ...
    public SearchCseListQueryParams withLowRange(String lowRange) {
    ...
    public String lr;
    public SearchCseListQueryParams withLr(String lr) {
        this.lr = lr;
        return this;
    }
    ...
    public Long num;
    public SearchCseListQueryParams withNum(Long num) {
        this.num = num;
        return this;
    }
    ...
    public SearchCseListQueryParams withOauthToken(String oauthToken) {
    ...
    public SearchCseListQueryParams withOrTerms(String orTerms) {
    ...
    public SearchCseListQueryParams withPrettyPrint(Boolean prettyPrint) {
    ...
    public String q;
    public SearchCseListQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public SearchCseListQueryParams withQuotaUser(String quotaUser) {
    ...
    public SearchCseListQueryParams withRelatedSite(String relatedSite) {
    ...
    public SearchCseListQueryParams withRights(String rights) {
        this.rights = rights;
        return this;
    }
    ...
    public SearchCseListSafeEnum safe;
    public SearchCseListQueryParams withSafe(SearchCseListSafeEnum safe) {
        this.safe = safe;
        return this;
    }
    ...
    public SearchCseListSearchTypeEnum searchType;
    public SearchCseListQueryParams withSearchType(SearchCseListSearchTypeEnum searchType) {
    ...
    public SearchCseListQueryParams withSiteSearch(String siteSearch) {
    ...
    public SearchCseListSiteSearchFilterEnum siteSearchFilter;
    public SearchCseListQueryParams withSiteSearchFilter(SearchCseListSiteSearchFilterEnum siteSearchFilter) {
    ...
    public String sort;
    public SearchCseListQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public SearchCseListQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public SearchCseListQueryParams withUploadType(String uploadType) {
    ...
    public SearchCseListQueryParams withUploadProtocol(String uploadProtocol) {
