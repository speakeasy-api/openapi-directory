...
class TextBroadcastPage:
    ...
    items: Optional[list[shared_textbroadcast.TextBroadcast]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})  
