...
exports.ListConversationMessageReceiptResponse = exports.ListConversationMessageReceiptListConversationMessageReceiptResponse = exports.ListConversationMessageReceiptListConversationMessageReceiptResponseMeta = exports.ListConversationMessageReceiptRequest = exports.ListConversationMessageReceiptSecurity = exports.ListConversationMessageReceiptServerList = void 0;
...
var ListConversationMessageReceiptSecurity = /** @class */ (function (_super) {
    ...
    ], ListConversationMessageReceiptSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListConversationMessageReceiptSecurity.prototype, "username", void 0);
...
var ListConversationMessageReceiptRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListConversationMessageReceiptRequest.prototype, "conversationSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=MessageSid",
        }),
        __metadata("design:type", String)
    ], ListConversationMessageReceiptRequest.prototype, "messageSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListConversationMessageReceiptRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListConversationMessageReceiptRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListConversationMessageReceiptRequest.prototype, "pageToken", void 0);
...
var ListConversationMessageReceiptListConversationMessageReceiptResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.ConversationsV1ConversationConversationMessageConversationMessageReceipt,
        }),
        (0, class_transformer_1.Expose)({ name: "delivery_receipts" }),
        (0, class_transformer_1.Type)(function () {
            return shared.ConversationsV1ConversationConversationMessageConversationMessageReceipt;
        }),
...
var ListConversationMessageReceiptResponse = /** @class */ (function (_super) {
    ...
    ], ListConversationMessageReceiptResponse.prototype, "rawResponse", void 0);
