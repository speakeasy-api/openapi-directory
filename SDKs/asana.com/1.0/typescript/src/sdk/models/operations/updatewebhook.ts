...
export class UpdateWebhookRequestBody extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "data" })
  @Type(() => shared.WebhookUpdateRequest)
 ...
 */
export class UpdateWebhook200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "data" })
  @Type(() => shared.WebhookResponse)
...
export class UpdateWebhookResponse extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  updateWebhook200ApplicationJSONObject?: UpdateWebhook200ApplicationJSON;
}
