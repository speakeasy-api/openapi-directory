...
from ..shared import getusersresponse as shared_getusersresponse
...
class UsersAllRequest:
    headers: UsersAllHeaders = dataclasses.field()
    query_params: UsersAllQueryParams = dataclasses.field()
    security: UsersAllSecurity = dataclasses.field()
    

@dataclasses.dataclass
class UsersAllResponseOutput:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    get_users_response: Optional[shared_getusersresponse.GetUsersResponseOutput] = dataclasses.field(default=None)
