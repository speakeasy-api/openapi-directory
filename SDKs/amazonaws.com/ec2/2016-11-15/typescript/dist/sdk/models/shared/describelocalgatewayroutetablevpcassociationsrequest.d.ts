 ...
 */
export declare class DescribeLocalGatewayRouteTableVpcAssociationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeLocalGatewayRouteTableVpcAssociationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
