...
**/
var ExistingDisk = /** @class */ (function (_super) {
    __extends(ExistingDisk, _super);
    function ExistingDisk() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=attachment" }),
        __metadata("design:type", diskattachment_1.DiskAttachment)
    ], ExistingDisk.prototype, "attachment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=source" }),
        __metadata("design:type", String)
    ], ExistingDisk.prototype, "source", void 0);
    return ExistingDisk;
}(utils_1.SpeakeasyBase));
exports.ExistingDisk = ExistingDisk;
