...
export class GoogleCloudRunV2Container extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRunV2EnvVar })
  @Expose({ name: "env" })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRunV2ContainerPort })
  @Expose({ name: "ports" })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRunV2VolumeMount })
