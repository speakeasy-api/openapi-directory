...
class GetGeneCaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGeneCaseAssociationsQueryParams:
...
class GetGeneCaseAssociationsRequest:
    path_params: GetGeneCaseAssociationsPathParams = dataclasses.field()
    query_params: GetGeneCaseAssociationsQueryParams = dataclasses.field()
