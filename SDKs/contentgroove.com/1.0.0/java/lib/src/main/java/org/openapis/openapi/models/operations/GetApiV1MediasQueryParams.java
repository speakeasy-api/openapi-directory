...
public class GetApiV1MediasQueryParams {
    /**
    ...
    public GetApiV1MediasQueryParams withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetApiV1MediasQueryParams withPage(java.util.Map<String, Object> page) {
        this.page = page;
        return this;
    }
    ...
    public GetApiV1MediasSortEnum sort;
    public GetApiV1MediasQueryParams withSort(GetApiV1MediasSortEnum sort) {
        this.sort = sort;
        return this;
    }
