...
exports.GetglobaltimeResponse = exports.GetglobaltimeRequest = exports.Getglobaltime200ApplicationJson = exports.GetglobaltimeQueryParams = void 0;
...
exports.GetglobaltimeQueryParams = GetglobaltimeQueryParams;
var Getglobaltime200ApplicationJson = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ClockTime" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CurrentDate" }),
        __metadata("design:type", String)
    ], Getglobaltime200ApplicationJson.prototype, "currentDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CurrentTime" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MonthNumber" }),
        __metadata("design:type", String)
    ], Getglobaltime200ApplicationJson.prototype, "monthNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Second" }),
        __metadata("design:type", String)
