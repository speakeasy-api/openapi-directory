...
class GetNhFishFishRequest:
    ...
    fish: str = dataclasses.field(metadata={'path_param': { 'field_name': 'fish', 'style': 'simple', 'explode': False }})
    r"""The name of the fish you wish to retrieve information about."""  
...
class GetNhFishFishResponse:
    ...
    r"""Could not find the specified fish."""  
    ...
    nh_fish: Optional[shared_nhfish.NHFish] = dataclasses.field(default=None)
