...
func (e SupersimV1FleetIPCommandsMethodEnum) ToPointer() *SupersimV1FleetIPCommandsMethodEnum {
	return &e
}
...
func (e *SupersimV1FleetIPCommandsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = SupersimV1FleetIPCommandsMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SupersimV1FleetIPCommandsMethodEnum: %v", v)
	}
}
...
func (e SupersimV1FleetSmsCommandsMethodEnum) ToPointer() *SupersimV1FleetSmsCommandsMethodEnum {
	return &e
}
...
func (e *SupersimV1FleetSmsCommandsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = SupersimV1FleetSmsCommandsMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SupersimV1FleetSmsCommandsMethodEnum: %v", v)
	}
}
