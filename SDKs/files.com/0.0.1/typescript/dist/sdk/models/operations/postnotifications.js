...
exports.PostNotificationsResponse = exports.PostNotificationsRequestBody = void 0;
...
var PostNotificationsRequestBody = /** @class */ (function (_super) {
    ...
    ], PostNotificationsRequestBody.prototype, "message", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", Boolean)
    ], PostNotificationsRequestBody.prototype, "notifyOnDelete", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=notify_on_download" }),
        __metadata("design:type", Boolean)
    ], PostNotificationsRequestBody.prototype, "notifyOnDownload", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=notify_on_move" }),
        __metadata("design:type", Boolean)
    ], PostNotificationsRequestBody.prototype, "notifyOnMove", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=notify_on_upload" }),
        __metadata("design:type", Boolean)
    ], PostNotificationsRequestBody.prototype, "notifyOnUpload", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", Boolean)
    ], PostNotificationsRequestBody.prototype, "triggerByShareRecipients", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=triggering_filenames" }),
        __metadata("design:type", Array)
    ], PostNotificationsRequestBody.prototype, "triggeringFilenames", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=triggering_group_ids" }),
        __metadata("design:type", Array)
    ], PostNotificationsRequestBody.prototype, "triggeringGroupIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=triggering_user_ids" }),
        __metadata("design:type", Array)
    ], PostNotificationsRequestBody.prototype, "triggeringUserIds", void 0);
    __decorate([
...
var PostNotificationsResponse = /** @class */ (function (_super) {
    ...
    ], PostNotificationsResponse.prototype, "rawResponse", void 0);
