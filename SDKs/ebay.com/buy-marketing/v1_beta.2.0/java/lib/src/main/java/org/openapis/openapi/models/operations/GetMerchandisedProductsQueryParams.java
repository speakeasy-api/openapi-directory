...
public class GetMerchandisedProductsQueryParams {
    /**
    ...
    public GetMerchandisedProductsQueryParams withAspectFilter(String aspectFilter) {
    ...
    public GetMerchandisedProductsQueryParams withCategoryId(String categoryId) {
    ...
    public String limit;
    public GetMerchandisedProductsQueryParams withLimit(String limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetMerchandisedProductsQueryParams withMetricName(String metricName) {
