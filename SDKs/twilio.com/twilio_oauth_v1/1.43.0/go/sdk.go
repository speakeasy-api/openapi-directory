...
func (s *SDK) FetchCerts(ctx context.Context, security operations.FetchCertsSecurity, opts ...operations.Option) (*operations.FetchCertsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionServerURL,
	}
...
func (s *SDK) FetchOpenidDiscovery(ctx context.Context, security operations.FetchOpenidDiscoverySecurity, opts ...operations.Option) (*operations.FetchOpenidDiscoveryResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionServerURL,
	}
...
func (s *SDK) FetchUserInfo(ctx context.Context, security operations.FetchUserInfoSecurity, opts ...operations.Option) (*operations.FetchUserInfoResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionServerURL,
	}
