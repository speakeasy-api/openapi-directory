...
exports.BluetoothClients = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var BluetoothClients = /** @class */ (function () {
    function BluetoothClients(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    BluetoothClients.prototype.getNetworkBluetoothClient = function (req, config) {
    ...
    **/
    BluetoothClients.prototype.getNetworkBluetoothClients = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.BluetoothClients = BluetoothClients;
