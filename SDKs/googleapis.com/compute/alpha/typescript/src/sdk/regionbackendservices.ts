...
export class RegionBackendServices {
  ...
  computeRegionBackendServicesSetSecurityPolicy(
    req: operations.ComputeRegionBackendServicesSetSecurityPolicyRequest,
    security: operations.ComputeRegionBackendServicesSetSecurityPolicySecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeRegionBackendServicesSetSecurityPolicyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ComputeRegionBackendServicesSetSecurityPolicyRequest(
        req
      );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ComputeRegionBackendServicesSetSecurityPolicySecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeRegionBackendServicesSetSecurityPolicyResponse =
        new operations.ComputeRegionBackendServicesSetSecurityPolicyResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
