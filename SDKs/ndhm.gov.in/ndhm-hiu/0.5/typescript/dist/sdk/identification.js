...
var Identification = /** @class */ (function () {
     ...
     *
     */
    Identification.prototype.postV05PatientsOnFindJson = function (req, serverURL, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05PatientsOnFindJsonRequest(req);
        }
        var baseURL = operations.PostV05PatientsOnFindJsonServerList[0];
        if (serverURL) {
            baseURL = serverURL;
        }
     ...
     *
     */
    Identification.prototype.postV05PatientsOnFindRaw = function (req, serverURL, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05PatientsOnFindRawRequest(req);
        }
        var baseURL = operations.PostV05PatientsOnFindRawServerList[0];
        if (serverURL) {
            baseURL = serverURL;
        }
        var url = baseURL.replace(/\/$/, "") + "/v0.5/patients/on-find";
