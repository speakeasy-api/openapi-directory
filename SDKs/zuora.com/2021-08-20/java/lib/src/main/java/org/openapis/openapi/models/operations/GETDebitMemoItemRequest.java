...
public class GETDebitMemoItemRequest {
    ...
    public GETDebitMemoItemRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETDebitMemoItemRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETDebitMemoItemRequest withDebitMemoId(String debitMemoId) {
    ...
    public GETDebitMemoItemRequest withDmitemid(String dmitemid) {
    ...
    public GETDebitMemoItemRequest withZuoraVersion(String zuoraVersion) {
