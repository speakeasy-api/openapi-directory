...
from ..shared import config_grouptheme as shared_config_grouptheme
from typing import Optional


@dataclasses.dataclass
class GroupV2GetAvailableThemes200Wildcard:
    ...
    response: Optional[list[shared_config_grouptheme.ConfigGroupTheme]] = dataclasses.field(default=None)  
