...
class AuditCaseCategoryRelation:
    ...
    sub_category_list: Optional[list[shared_auditcasesubcategory.AuditCaseSubCategory]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sub_category_list') }})
