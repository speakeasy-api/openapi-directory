...
export class VotedEpisodes {
  ...
  deleteUserVotesEpisodesEpisodeId(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DeleteUserVotesEpisodesEpisodeIdResponse =
        new operations.DeleteUserVotesEpisodesEpisodeIdResponse({
  ...
  getUserVotesEpisodes(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetUserVotesEpisodesResponse =
        new operations.GetUserVotesEpisodesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            ...
            res.episodeVotes = utils.objectToClass(
              httpRes?.data,
              shared.EpisodeVote,
              resFieldDepth
            );
  ...
  getUserVotesEpisodesEpisodeId(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetUserVotesEpisodesEpisodeIdResponse =
        new operations.GetUserVotesEpisodesEpisodeIdResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.episodeVote = utils.objectToClass(
              httpRes?.data,
              shared.EpisodeVote
            );
          }
  ...
  putUserVotesEpisodesEpisodeId(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PutUserVotesEpisodesEpisodeIdResponse =
        new operations.PutUserVotesEpisodesEpisodeIdResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
