...
class GlobalPhoneNumberInformation:
    ...
    def getglobalnumberinfo(self, request: operations.GetglobalnumberinfoRequest) -> operations.GetglobalnumberinfoResponse:
        ...
        query_params = utils.get_query_params(operations.GetglobalnumberinfoRequest, request)
        ...
        res = operations.GetglobalnumberinfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.Getglobalnumberinfo200ApplicationJSON])
