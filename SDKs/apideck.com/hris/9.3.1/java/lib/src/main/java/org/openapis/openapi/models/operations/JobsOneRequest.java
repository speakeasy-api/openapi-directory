...
public class JobsOneRequest {
    ...
    public JobsOneRequest(@JsonProperty("employee_id") String employeeId, @JsonProperty("job_id") String jobId, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.employeeId = employeeId;
        this.jobId = jobId;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
