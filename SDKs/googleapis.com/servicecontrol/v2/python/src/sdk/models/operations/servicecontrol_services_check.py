...
class ServicecontrolServicesCheckSecurity:
    option1: Optional[ServicecontrolServicesCheckSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ServicecontrolServicesCheckSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class ServicecontrolServicesCheckRequest:
    path_params: ServicecontrolServicesCheckPathParams = dataclasses.field()
    query_params: ServicecontrolServicesCheckQueryParams = dataclasses.field()
    security: ServicecontrolServicesCheckSecurity = dataclasses.field()
    request: Optional[shared_checkrequest.CheckRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
