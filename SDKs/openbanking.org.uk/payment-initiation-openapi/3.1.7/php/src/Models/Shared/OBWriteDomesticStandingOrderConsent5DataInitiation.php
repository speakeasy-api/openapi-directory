...
class OBWriteDomesticStandingOrderConsent5DataInitiation
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsent5DataInitiationCreditorAccount $creditorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('CreditorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsent5DataInitiationCreditorAccount')]
    public OBWriteDomesticStandingOrderConsent5DataInitiationCreditorAccount $creditorAccount;
    
    /**
     * Provides the details to identify the debtor account.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsent5DataInitiationDebtorAccount $debtorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('DebtorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsent5DataInitiationDebtorAccount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteDomesticStandingOrderConsent5DataInitiationDebtorAccount $debtorAccount = null;
    
    /**
     * The amount of the final Standing Order
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsent5DataInitiationFinalPaymentAmount $finalPaymentAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('FinalPaymentAmount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsent5DataInitiationFinalPaymentAmount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteDomesticStandingOrderConsent5DataInitiationFinalPaymentAmount $finalPaymentAmount = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsent5DataInitiationFirstPaymentAmount $firstPaymentAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('FirstPaymentAmount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsent5DataInitiationFirstPaymentAmount')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsent5DataInitiationRecurringPaymentAmount $recurringPaymentAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('RecurringPaymentAmount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsent5DataInitiationRecurringPaymentAmount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteDomesticStandingOrderConsent5DataInitiationRecurringPaymentAmount $recurringPaymentAmount = null;
	...
	{
		$this->creditorAccount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsent5DataInitiationCreditorAccount();
		$this->debtorAccount = null;
		$this->finalPaymentAmount = null;
		$this->finalPaymentDateTime = null;
		$this->firstPaymentAmount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsent5DataInitiationFirstPaymentAmount();
