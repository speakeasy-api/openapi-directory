...
public class CreateMitigationActionRequestBodyActionParams {
    ...
    public CreateMitigationActionRequestBodyActionParams withAddThingsToThingGroupParams(openapisdk.models.shared.AddThingsToThingGroupParams addThingsToThingGroupParams) {
    ...
    public CreateMitigationActionRequestBodyActionParams withEnableIoTLoggingParams(openapisdk.models.shared.EnableIoTLoggingParams enableIoTLoggingParams) {
    ...
    public CreateMitigationActionRequestBodyActionParams withPublishFindingToSnsParams(openapisdk.models.shared.PublishFindingToSnsParams publishFindingToSnsParams) {
    ...
    public CreateMitigationActionRequestBodyActionParams withReplaceDefaultPolicyVersionParams(openapisdk.models.shared.ReplaceDefaultPolicyVersionParams replaceDefaultPolicyVersionParams) {
    ...
    public CreateMitigationActionRequestBodyActionParams withUpdateCaCertificateParams(openapisdk.models.shared.UpdateCaCertificateParams updateCACertificateParams) {
    ...
    public CreateMitigationActionRequestBodyActionParams withUpdateDeviceCertificateParams(openapisdk.models.shared.UpdateDeviceCertificateParams updateDeviceCertificateParams) {
