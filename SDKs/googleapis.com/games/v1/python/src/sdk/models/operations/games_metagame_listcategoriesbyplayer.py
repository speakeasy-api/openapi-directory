...
from ..shared import security as shared_security
from ..shared import categorylistresponse as shared_categorylistresponse
...
class GamesMetagameListCategoriesByPlayerPathParams:
    collection: GamesMetagameListCategoriesByPlayerCollectionEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'collection', 'style': 'simple', 'explode': False }})
...
class GamesMetagameListCategoriesByPlayerRequest:
    path_params: GamesMetagameListCategoriesByPlayerPathParams = dataclasses.field()
    query_params: GamesMetagameListCategoriesByPlayerQueryParams = dataclasses.field()
    security: GamesMetagameListCategoriesByPlayerSecurity = dataclasses.field()
...
class GamesMetagameListCategoriesByPlayerResponse:
    ...
    category_list_response: Optional[shared_categorylistresponse.CategoryListResponse] = dataclasses.field(default=None)
