...
class RatePlanDataRatePlan:
    ...
    r"""The ID of the associated product rate plan.
    ...
    **Values**: a valid amendment ID
    """  
    amendment_subscription_rate_plan_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AmendmentSubscriptionRatePlanId'), 'exclude': lambda f: f is None }})
    r"""The ID of the subscription rate plan modified by the amendment. This field only applies to amendment rate plans.
    ...
    **Values**: inherited from `Amendment.Type`
    ...
    r"""The ID of the Zuora user who created the RatePlan object.
    ...
    **Values**: automatically generated
    ...
    r"""The date when the `RatePlan` object was last updated.
    ...
    **Values**: automatically generated
    ...
    r"""The name of the rate plan. Leave this null in a subscribe
    ...
    **Values**: a string of 100 characters or fewer or inherited from ProductRatePlan.Name
    ...
    r"""The ID of the subscription that the rate plan belongs to.
