...
export class EmployeeSchedules {
  ...
  employeeSchedulesAll(
    ...
    security: operations.EmployeeSchedulesAllSecurity,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.EmployeeSchedulesAllResponse =
        new operations.EmployeeSchedulesAllResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getEmployeeSchedulesResponse = utils.objectToClass(
              httpRes?.data,
              shared.GetEmployeeSchedulesResponse
            );
          }
          break;
