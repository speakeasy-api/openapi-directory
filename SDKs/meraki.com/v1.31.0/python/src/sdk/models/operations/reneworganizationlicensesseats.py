...
class RenewOrganizationLicensesSeats200ApplicationJSONResultingLicensesStateEnum(str, Enum):
...
class RenewOrganizationLicensesSeats200ApplicationJSONResultingLicenses:
    ...
    order_number: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('orderNumber'), 'exclude': lambda f: f is None }})
    r"""Order number"""  
    permanently_queued_licenses: Optional[list[RenewOrganizationLicensesSeats200ApplicationJSONResultingLicensesPermanentlyQueuedLicenses]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('permanentlyQueuedLicenses'), 'exclude': lambda f: f is None }})
    ...
    state: Optional[RenewOrganizationLicensesSeats200ApplicationJSONResultingLicensesStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
    r"""The state of the license. All queued licenses have a status of `recentlyQueued`."""  
...
class RenewOrganizationLicensesSeats200ApplicationJSON:
    ...
    resulting_licenses: Optional[list[RenewOrganizationLicensesSeats200ApplicationJSONResultingLicenses]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resultingLicenses'), 'exclude': lambda f: f is None }})
...
class RenewOrganizationLicensesSeatsResponse:
    ...
    renew_organization_licenses_seats_200_application_json_object: Optional[RenewOrganizationLicensesSeats200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
