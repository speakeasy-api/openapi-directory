...
type CreateBatchSegmentJobHeaders struct {
...
type CreateBatchSegmentJobRequest struct {
	Headers CreateBatchSegmentJobHeaders
	Request shared.CreateBatchSegmentJobRequest `request:"mediaType=application/json"`
}
