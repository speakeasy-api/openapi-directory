...
class ListInstalledComponentsRequest
{
     ...
     * 
     * @var string $coreDeviceThingName
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ListInstalledComponentsTopologyFilterEnum $topologyFilter
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=topologyFilter')]
    public ?ListInstalledComponentsTopologyFilterEnum $topologyFilter = null;
