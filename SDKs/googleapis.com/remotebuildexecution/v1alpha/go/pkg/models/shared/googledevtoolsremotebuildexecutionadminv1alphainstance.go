...
func (e GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstanceStateEnum) ToPointer() *GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstanceStateEnum {
	return &e
}
...
func (e *GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstanceStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "RUNNING":
		fallthrough
	case "INACTIVE":
		*e = GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstanceStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstanceStateEnum: %v", v)
	}
}
