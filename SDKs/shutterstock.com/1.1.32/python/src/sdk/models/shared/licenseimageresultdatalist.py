...
from ..shared import licenseimageresult as shared_licenseimageresult
...
class LicenseImageResultDataList:
    r"""List of information about licensed images"""
    
    data: Optional[list[shared_licenseimageresult.LicenseImageResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""License results"""  
