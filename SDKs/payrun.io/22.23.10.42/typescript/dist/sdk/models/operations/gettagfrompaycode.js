...
exports.GetTagFromPayCodeResponse = exports.GetTagFromPayCodeRequest = void 0;
...
var GetTagFromPayCodeRequest = /** @class */ (function (_super) {
    ...
    ], GetTagFromPayCodeRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayCodeRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayCodeRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayCodeId",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayCodeRequest.prototype, "payCodeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayCodeRequest.prototype, "tagId", void 0);
...
var GetTagFromPayCodeResponse = /** @class */ (function (_super) {
    ...
    ], GetTagFromPayCodeResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
