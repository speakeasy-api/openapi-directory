...
class WirelessV1RatePlan:
    ...
    international_roaming_data_limit: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('international_roaming_data_limit') }})
    ...
    national_roaming_data_limit: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('national_roaming_data_limit') }})
