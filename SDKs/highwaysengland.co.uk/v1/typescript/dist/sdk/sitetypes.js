...
exports.SiteTypes = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var SiteTypes = /** @class */ (function () {
    function SiteTypes(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    SiteTypes.prototype.siteTypesGetSitesForPublicFacingApi = function (req, config) {
    ...
    **/
    SiteTypes.prototype.siteTypesIndex = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
