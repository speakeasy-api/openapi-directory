...
class CreateInstanceAccessControlAttributeConfigurationRequest:
    ...
    create_instance_access_control_attribute_configuration_request: shared_createinstanceaccesscontrolattributeconfigurationrequest.CreateInstanceAccessControlAttributeConfigurationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
