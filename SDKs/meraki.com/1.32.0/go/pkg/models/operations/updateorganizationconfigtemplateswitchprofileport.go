...
func (e UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyAccessPolicyTypeEnum) ToPointer() *UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyAccessPolicyTypeEnum {
	return &e
}
...
func (e *UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Sticky MAC allow list":
		*e = UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyAccessPolicyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyAccessPolicyTypeEnum: %v", v)
	}
}
...
func (e UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyStpGuardEnum) ToPointer() *UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyStpGuardEnum {
	return &e
}
...
func (e *UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyStpGuardEnum) UnmarshalJSON(data []byte) error {
	...
	case "loop guard":
		fallthrough
	case "root guard":
		*e = UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyStpGuardEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyStpGuardEnum: %v", v)
	}
}
...
func (e UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyTypeEnum) ToPointer() *UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyTypeEnum {
	return &e
}
...
func (e *UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "access":
		fallthrough
	case "trunk":
		*e = UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyTypeEnum: %v", v)
	}
}
...
func (e UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyUdldEnum) ToPointer() *UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyUdldEnum {
	return &e
}
...
func (e *UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyUdldEnum) UnmarshalJSON(data []byte) error {
	...
	case "Alert only":
		fallthrough
	case "Enforce":
		*e = UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyUdldEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationConfigTemplateSwitchProfilePortRequestBodyUdldEnum: %v", v)
	}
}
...
func (e UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONAccessPolicyTypeEnum) ToPointer() *UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONAccessPolicyTypeEnum {
	return &e
}
...
func (e *UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Open":
		fallthrough
	case "Sticky MAC allow list":
		*e = UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONAccessPolicyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONAccessPolicyTypeEnum: %v", v)
	}
}
...
func (e UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONStpGuardEnum) ToPointer() *UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONStpGuardEnum {
	return &e
}
...
func (e *UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONStpGuardEnum) UnmarshalJSON(data []byte) error {
	...
	case "loop guard":
		fallthrough
	case "root guard":
		*e = UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONStpGuardEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONStpGuardEnum: %v", v)
	}
}
...
func (e UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONTypeEnum) ToPointer() *UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONTypeEnum {
	return &e
}
...
func (e *UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "access":
		fallthrough
	case "trunk":
		*e = UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONTypeEnum: %v", v)
	}
}
...
func (e UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum) ToPointer() *UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum {
	return &e
}
...
func (e *UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum) UnmarshalJSON(data []byte) error {
	...
	case "Alert only":
		fallthrough
	case "Enforce":
		*e = UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum: %v", v)
	}
}
