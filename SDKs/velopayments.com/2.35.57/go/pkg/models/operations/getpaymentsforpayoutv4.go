...
func (e GetPaymentsForPayoutV4StatusEnum) ToPointer() *GetPaymentsForPayoutV4StatusEnum {
	return &e
}
...
func (e *GetPaymentsForPayoutV4StatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "RETURNED":
		fallthrough
	case "WITHDRAWN":
		*e = GetPaymentsForPayoutV4StatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPaymentsForPayoutV4StatusEnum: %v", v)
	}
}
...
func (e GetPaymentsForPayoutV4TransmissionTypeEnum) ToPointer() *GetPaymentsForPayoutV4TransmissionTypeEnum {
	return &e
}
...
func (e *GetPaymentsForPayoutV4TransmissionTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "LOCAL":
		fallthrough
	case "GACHO":
		*e = GetPaymentsForPayoutV4TransmissionTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPaymentsForPayoutV4TransmissionTypeEnum: %v", v)
	}
}
