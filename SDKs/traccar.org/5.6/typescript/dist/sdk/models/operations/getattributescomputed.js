...
exports.GetAttributesComputedResponse = exports.GetAttributesComputedRequest = void 0;
...
var GetAttributesComputedRequest = /** @class */ (function (_super) {
    ...
    ], GetAttributesComputedRequest.prototype, "all", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=deviceId",
        }),
        __metadata("design:type", Number)
    ], GetAttributesComputedRequest.prototype, "deviceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=groupId",
        }),
        __metadata("design:type", Number)
    ], GetAttributesComputedRequest.prototype, "groupId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=refresh",
        }),
        __metadata("design:type", Boolean)
    ], GetAttributesComputedRequest.prototype, "refresh", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userId",
        }),
        __metadata("design:type", Number)
    ], GetAttributesComputedRequest.prototype, "userId", void 0);
    return GetAttributesComputedRequest;
}(utils_1.SpeakeasyBase));
exports.GetAttributesComputedRequest = GetAttributesComputedRequest;
var GetAttributesComputedResponse = /** @class */ (function (_super) {
    ...
    ], GetAttributesComputedResponse.prototype, "rawResponse", void 0);
    return GetAttributesComputedResponse;
}(utils_1.SpeakeasyBase));
exports.GetAttributesComputedResponse = GetAttributesComputedResponse;
