...
exports.GetSshKeysResponse = exports.GetSshKeysRequest = void 0;
...
var GetSshKeysRequest = /** @class */ (function (_super) {
    ...
    ], GetSshKeysRequest.prototype, "domainNamePathParameter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=domain_name",
        }),
        __metadata("design:type", String)
    ], GetSshKeysRequest.prototype, "domainNameQueryParameter", void 0);
