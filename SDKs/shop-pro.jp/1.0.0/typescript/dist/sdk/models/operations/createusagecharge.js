...
exports.CreateUsageChargeResponse = exports.CreateUsageCharge201ApplicationJSON = exports.CreateUsageCharge201ApplicationJSONUsageCharge = exports.CreateUsageChargeRequest = exports.CreateUsageChargeRequestBody = exports.CreateUsageChargeRequestBodyUsageCharge = exports.CreateUsageChargeSecurity = void 0;
...
var CreateUsageChargeRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return CreateUsageChargeRequestBodyUsageCharge; }),
...
var CreateUsageChargeRequest = /** @class */ (function (_super) {
    ...
    ], CreateUsageChargeRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Appstore-Usage-Charge-Token",
        }),
        __metadata("design:type", String)
    ], CreateUsageChargeRequest.prototype, "xAppstoreUsageChargeToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=recurringApplicationChargeId",
        }),
        __metadata("design:type", String)
    ], CreateUsageChargeRequest.prototype, "recurringApplicationChargeId", void 0);
...
var CreateUsageCharge201ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "usage_charge" }),
        (0, class_transformer_1.Type)(function () { return CreateUsageCharge201ApplicationJSONUsageCharge; }),
...
var CreateUsageChargeResponse = /** @class */ (function (_super) {
    ...
    ], CreateUsageChargeResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
