...
type ListTopTopics200ApplicationJSONTopicListTopics struct {
	...
	Posters            []ListTopTopics200ApplicationJSONTopicListTopicsPosters `json:"posters,omitempty"`
...
type ListTopTopics200ApplicationJSONTopicList struct {
	...
	Topics         []ListTopTopics200ApplicationJSONTopicListTopics `json:"topics,omitempty"`
}

type ListTopTopics200ApplicationJSONUsers struct {
...
type ListTopTopics200ApplicationJSON struct {
	PrimaryGroups []interface{}                             `json:"primary_groups,omitempty"`
	TopicList     *ListTopTopics200ApplicationJSONTopicList `json:"topic_list,omitempty"`
	Users         []ListTopTopics200ApplicationJSONUsers    `json:"users,omitempty"`
}

type ListTopTopicsResponse struct {
	ContentType string
	StatusCode  int
