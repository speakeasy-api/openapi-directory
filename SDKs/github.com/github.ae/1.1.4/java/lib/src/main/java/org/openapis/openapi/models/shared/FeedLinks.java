...
public class FeedLinks {
    ...
    public FeedLinks withRepositoryDiscussions(LinkWithType repositoryDiscussions) {
    ...
    public FeedLinks withRepositoryDiscussionsCategory(LinkWithType repositoryDiscussionsCategory) {
