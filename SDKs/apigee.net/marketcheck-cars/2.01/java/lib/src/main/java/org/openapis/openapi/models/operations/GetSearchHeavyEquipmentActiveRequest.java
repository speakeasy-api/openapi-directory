...
public class GetSearchHeavyEquipmentActiveRequest {
    ...
    public GetSearchHeavyEquipmentActiveRequest withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public GetSearchHeavyEquipmentActiveRequest withBodyType(String bodyType) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withCategory(String category) {
    ...
    public String city;
    public GetSearchHeavyEquipmentActiveRequest withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public GetSearchHeavyEquipmentActiveRequest withDealerId(String dealerId) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withDealerName(String dealerName) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withDrivetrain(String drivetrain) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withEngine(String engine) {
        this.engine = engine;
        return this;
    }
    ...
    public GetSearchHeavyEquipmentActiveRequest withExteriorColor(String exteriorColor) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withFacetSort(org.openapis.openapi.models.shared.FacetSortEnum facetSort) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withFacets(String facets) {
        this.facets = facets;
        return this;
    }
    ...
    public GetSearchHeavyEquipmentActiveRequest withFirstSeenDays(String firstSeenDays) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withFirstSeenRange(String firstSeenRange) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withFuelType(String fuelType) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withHoursUsedRange(String hoursUsedRange) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withInteriorColor(String interiorColor) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withInventoryType(org.openapis.openapi.models.shared.InventoryTypeEnum inventoryType) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withLastSeenDays(String lastSeenDays) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withLastSeenRange(String lastSeenRange) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withLatitude(Double latitude) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withLongitude(Double longitude) {
    ...
    public String make;
    public GetSearchHeavyEquipmentActiveRequest withMake(String make) {
        this.make = make;
        return this;
    }
    ...
    public GetSearchHeavyEquipmentActiveRequest withMilesRange(String milesRange) {
    ...
    public String model;
    public GetSearchHeavyEquipmentActiveRequest withModel(String model) {
        this.model = model;
        return this;
    }
    ...
    public GetSearchHeavyEquipmentActiveRequest withMsaCode(String msaCode) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withMsrpRange(String msrpRange) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withPriceRange(String priceRange) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withRadius(Integer radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetSearchHeavyEquipmentActiveRequest withRangeFacets(String rangeFacets) {
    ...
    public Integer rows;
    public GetSearchHeavyEquipmentActiveRequest withRows(Integer rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetSearchHeavyEquipmentActiveRequest withSearchText(String searchText) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetSearchHeavyEquipmentActiveRequest withSortOrder(org.openapis.openapi.models.shared.SortOrderEnum sortOrder) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public GetSearchHeavyEquipmentActiveRequest withStart(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public String state;
    public GetSearchHeavyEquipmentActiveRequest withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public String stats;
    public GetSearchHeavyEquipmentActiveRequest withStats(String stats) {
        this.stats = stats;
        return this;
    }
    ...
    public GetSearchHeavyEquipmentActiveRequest withStockNo(String stockNo) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withSubCategory(String subCategory) {
    ...
    public GetSearchHeavyEquipmentActiveRequest withTransmission(String transmission) {
    ...
    public String trim;
    public GetSearchHeavyEquipmentActiveRequest withTrim(String trim) {
        this.trim = trim;
        return this;
    }
    ...
    public String vin;
    public GetSearchHeavyEquipmentActiveRequest withVin(String vin) {
        this.vin = vin;
        return this;
    }
    ...
    public String year;
    public GetSearchHeavyEquipmentActiveRequest withYear(String year) {
        this.year = year;
        return this;
    }
    ...
    public String zip;
    public GetSearchHeavyEquipmentActiveRequest withZip(String zip) {
        this.zip = zip;
        return this;
    }
