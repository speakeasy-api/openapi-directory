...
export enum GetResourcesSummaryXAmzTargetEnum {
  AwsProton20200720GetResourcesSummary = "AwsProton20200720.GetResourcesSummary",
}

export class GetResourcesSummaryRequest extends SpeakeasyBase {
...
export class GetResourcesSummaryResponse extends SpeakeasyBase {
  /**
