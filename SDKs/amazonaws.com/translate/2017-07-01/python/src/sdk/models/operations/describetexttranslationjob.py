...
class DescribeTextTranslationJobRequest:
    ...
    describe_text_translation_job_request: shared_describetexttranslationjobrequest.DescribeTextTranslationJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
