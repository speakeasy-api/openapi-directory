...
public class CreateAdGroupRequest {
    ...
    public CreateAdGroupRequest(@JsonProperty("CreateAdGroupRequest") org.openapis.openapi.models.shared.CreateAdGroupRequest createAdGroupRequest, @JsonProperty("campaign_id") String campaignId) {
        this.createAdGroupRequest = createAdGroupRequest;
        this.campaignId = campaignId;
  }
}
