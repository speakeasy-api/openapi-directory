...
export class PostOrganisationsPartyIdBusinessNamesRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class PostOrganisationsPartyIdBusinessNamesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
