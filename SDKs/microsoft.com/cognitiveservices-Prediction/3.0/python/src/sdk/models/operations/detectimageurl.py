...
class DetectImageURLPathParams:
...
@dataclasses.dataclass
class DetectImageURLQueryParams:
...
@dataclasses.dataclass
class DetectImageURLRequest:
    path_params: DetectImageURLPathParams = dataclasses.field()
    query_params: DetectImageURLQueryParams = dataclasses.field()
    request: DetectImageURLRequests = dataclasses.field()
    

@dataclasses.dataclass
class DetectImageURLResponse:
