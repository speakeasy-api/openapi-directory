...
export declare class GetRemoteBandwidthSnapshotsRequest extends SpeakeasyBase {
    /**
...
export declare class GetRemoteBandwidthSnapshotsResponse extends SpeakeasyBase {
    contentType: string;
    /**
