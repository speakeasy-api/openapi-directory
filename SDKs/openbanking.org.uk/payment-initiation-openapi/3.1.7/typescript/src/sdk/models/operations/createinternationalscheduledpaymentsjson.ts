...
export class CreateInternationalScheduledPaymentsJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateInternationalScheduledPaymentsJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateInternationalScheduledPaymentsJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
