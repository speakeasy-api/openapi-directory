...
type AnalyticsadminPropertiesAcknowledgeUserDataCollectionRequest struct {
	...
	GoogleAnalyticsAdminV1betaAcknowledgeUserDataCollectionRequest *shared.GoogleAnalyticsAdminV1betaAcknowledgeUserDataCollectionRequest `request:"mediaType=application/json"`
	// OAuth access token.
