...
class OngoingActions:
    ...
    def post_v2_ongoing_actions_json(self, request: operations.PostV2OngoingActionsJSONRequestBody) -> operations.PostV2OngoingActionsJSONResponse:
        r"""Create an ongoing action
        ...
        url = base_url.removesuffix('/') + '/v2/ongoing_actions.json'
        ...
        res = operations.PostV2OngoingActionsJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
