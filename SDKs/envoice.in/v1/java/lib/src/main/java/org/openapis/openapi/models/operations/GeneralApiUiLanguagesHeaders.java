...
public class GeneralApiUiLanguagesHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public GeneralApiUiLanguagesHeaders withXAuthKey(String xAuthKey) {
    ...
    public GeneralApiUiLanguagesHeaders withXAuthSecret(String xAuthSecret) {
