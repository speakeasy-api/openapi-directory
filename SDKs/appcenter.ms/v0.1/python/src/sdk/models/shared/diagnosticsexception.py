...
class DiagnosticsExceptionFramesLanguageEnum(str, Enum):
...
class DiagnosticsExceptionFrames:
    ...
    language: Optional[DiagnosticsExceptionFramesLanguageEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('language'), 'exclude': lambda f: f is None }})
    r"""programming language of the frame"""  
...
class DiagnosticsExceptionPlatformEnum(str, Enum):
...
class DiagnosticsException:
    ...
    frames: list[DiagnosticsExceptionFrames] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('frames') }})
    r"""frames of the excetpion"""  
    inner_exceptions: Optional[list[DiagnosticsException]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('inner_exceptions'), 'exclude': lambda f: f is None }})  
    platform: Optional[DiagnosticsExceptionPlatformEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('platform'), 'exclude': lambda f: f is None }})
    r"""SDK/Platform this thread is beeing generated from"""  
