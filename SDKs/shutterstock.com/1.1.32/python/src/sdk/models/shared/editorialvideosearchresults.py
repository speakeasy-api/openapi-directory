...
class EditorialVideoSearchResults:
    r"""Editorial search results"""
    
    data: list[shared_editorialvideocontent.EditorialVideoContent] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
    r"""Editorial items"""  
