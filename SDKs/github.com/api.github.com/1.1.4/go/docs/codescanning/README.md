...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningDeleteAnalysis(ctx, operations.CodeScanningDeleteAnalysisRequest{
        AnalysisID: 968972,
        ConfirmDelete: sdk.String("quidem"),
        Owner: "saepe",
        Repo: "necessitatibus",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/rest/reference/code-scanning#get-codeql-database>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListAlertInstances(ctx, operations.CodeScanningListAlertInstancesRequest{
        ...
        PerPage: sdk.Int64(916727),
        Ref: sdk.String("libero"),
        Repo: "vitae",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListAlertsForOrg(ctx, operations.CodeScanningListAlertsForOrgRequest{
        After: sdk.String("accusamus"),
        Before: sdk.String("similique"),
        Direction: shared.DirectionEnumAsc.ToPointer(),
        Org: "aspernatur",
        Page: sdk.Int64(379057),
        PerPage: sdk.Int64(374244),
        Severity: shared.CodeScanningAlertSeverityEnumMedium.ToPointer(),
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListAlertsForRepo(ctx, operations.CodeScanningListAlertsForRepoRequest{
        ...
        ToolGUID: sdk.String("adipisci"),
        ToolName: sdk.String("cum"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/rest/reference/code-scanning#list-codeql-databases>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningUpdateAlert(ctx, operations.CodeScanningUpdateAlertRequest{
        RequestBody: operations.CodeScanningUpdateAlertRequestBody{
            DismissedComment: sdk.String("nobis"),
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningUploadSarif(ctx, operations.CodeScanningUploadSarifRequest{
        RequestBody: operations.CodeScanningUploadSarifRequestBody{
            ...
            CommitSha: "asperiores",
            Ref: "facilis",
            Sarif: "voluptate",
            StartedAt: types.MustTimeFromString("2022-11-10T06:21:40.327Z"),
            ToolName: sdk.String("iste"),
