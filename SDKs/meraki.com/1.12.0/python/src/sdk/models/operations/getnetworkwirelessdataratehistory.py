...
class GetNetworkWirelessDataRateHistoryRequest:
    path_params: GetNetworkWirelessDataRateHistoryPathParams = dataclasses.field()
    query_params: GetNetworkWirelessDataRateHistoryQueryParams = dataclasses.field()
...
class GetNetworkWirelessDataRateHistoryResponse:
    ...
    get_network_wireless_data_rate_history_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
