...
export enum GetPostsIdsSuggestedEditsOrderEnum {
  Desc = "desc",
  Asc = "asc",
}

export enum GetPostsIdsSuggestedEditsSortEnum {
  Creation = "creation",
  Approval = "approval",
  Rejection = "rejection",
}

export class GetPostsIdsSuggestedEditsRequest extends SpeakeasyBase {
  /**
...
export class GetPostsIdsSuggestedEditsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
