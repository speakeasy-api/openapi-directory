...
class CloudidentityOrgUnitsMembershipsMoveRequest:
    ...
    move_org_membership_request: Optional[shared_moveorgmembershiprequest.MoveOrgMembershipRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
