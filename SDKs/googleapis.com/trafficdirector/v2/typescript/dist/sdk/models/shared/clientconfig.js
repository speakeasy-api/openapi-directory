...
var ClientConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: perxdsconfig_1.PerXdsConfig }),
        (0, class_transformer_1.Expose)({ name: "xdsConfig" }),
        (0, class_transformer_1.Type)(function () { return perxdsconfig_1.PerXdsConfig; }),
