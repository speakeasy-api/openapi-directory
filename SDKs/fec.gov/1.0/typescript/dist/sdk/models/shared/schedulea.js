...
var ScheduleA = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=contributor_street_1" }),
        __metadata("design:type", String)
    ], ScheduleA.prototype, "contributorStreet1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=contributor_street_2" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=donor_committee_name" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=increased_limit" }),
        __metadata("design:type", String)
    ], ScheduleA.prototype, "increasedLimit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=is_individual" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=receipt_type" }),
        __metadata("design:type", String)
    ], ScheduleA.prototype, "receiptType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=receipt_type_desc" }),
        __metadata("design:type", String)
    ], ScheduleA.prototype, "receiptTypeDesc", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=receipt_type_full" }),
        __metadata("design:type", String)
    ], ScheduleA.prototype, "receiptTypeFull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=recipient_committee_designation" }),
        __metadata("design:type", String)
    ], ScheduleA.prototype, "recipientCommitteeDesignation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=recipient_committee_org_type" }),
        __metadata("design:type", String)
    ], ScheduleA.prototype, "recipientCommitteeOrgType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=recipient_committee_type" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=unused_contbr_id" }),
        __metadata("design:type", String)
    ], ScheduleA.prototype, "unusedContbrId", void 0);
    return ScheduleA;
}(utils_1.SpeakeasyBase));
exports.ScheduleA = ScheduleA;
