...
class PutEventsRequestBody:
    ...
    r"""An array of Event JSON objects"""  
...
class PutEventsRequest:
    ...
    r"""The client context including the client ID, app title, app version and package name."""  
    ...
    r"""The encoding used for the client context."""  
