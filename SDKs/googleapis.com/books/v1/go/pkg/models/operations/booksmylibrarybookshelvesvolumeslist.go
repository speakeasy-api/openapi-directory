...
func (e BooksMylibraryBookshelvesVolumesListProjectionEnum) ToPointer() *BooksMylibraryBookshelvesVolumesListProjectionEnum {
	return &e
}
...
func (e *BooksMylibraryBookshelvesVolumesListProjectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "FULL":
		fallthrough
	case "LITE":
		*e = BooksMylibraryBookshelvesVolumesListProjectionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for BooksMylibraryBookshelvesVolumesListProjectionEnum: %v", v)
	}
}
