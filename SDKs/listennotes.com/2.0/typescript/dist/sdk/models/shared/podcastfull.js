...
var PodcastFull = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=episodes", elemType: episodeminimum_1.EpisodeMinimum }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=is_claimed" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=looking_for" }),
        __metadata("design:type", podcastlookingforfield_1.PodcastLookingForField)
    ], PodcastFull.prototype, "lookingFor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=next_episode_pub_date" }),
        __metadata("design:type", Number)
