...
class GetContributionsRequest
{
     ...
     * 
     * @var ?\DateTime $createdDay
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=createdDay,dateTimeFormat=Y-m-d')]
    public ?\DateTime $createdDay = null;
    
    /**
     * Limit results to contributions created during this month.
     * 
     * @var ?string $createdMonth
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=createdMonth')]
    public ?string $createdMonth = null;
