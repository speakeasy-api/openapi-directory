...
class AdsenseMetadataDimensionsListSecurity:
    ...
    option1: Optional[AdsenseMetadataDimensionsListSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[AdsenseMetadataDimensionsListSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
