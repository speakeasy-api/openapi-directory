...
import dataclasses
from ..shared import invoiceitemdetailvo as shared_invoiceitemdetailvo
...
class InvoiceDetailVO:
    ...
    items: Optional[list[shared_invoiceitemdetailvo.InvoiceItemDetailVO]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})  
