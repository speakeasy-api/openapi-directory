...
public class CreateManifestResponseBody {
    ...
    public CreateManifestResponseBody(@JsonProperty("carrier_id") String carrierId, @JsonProperty("created_at") OffsetDateTime createdAt, @JsonProperty("errors") Error[] errors, @JsonProperty("form_id") String formId, @JsonProperty("manifest_download") CreateManifestResponseBodyManifestDownload manifestDownload, @JsonProperty("manifest_id") String manifestId, @JsonProperty("request_id") String requestId, @JsonProperty("ship_date") OffsetDateTime shipDate, @JsonProperty("shipments") Integer shipments, @JsonProperty("submission_id") String submissionId, @JsonProperty("warehouse_id") String warehouseId) {
        this.carrierId = carrierId;
        this.createdAt = createdAt;
        this.errors = errors;
        this.formId = formId;
