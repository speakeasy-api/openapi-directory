 ...
 */
public class CreateNetworkSwitchAccessPolicy201ApplicationJSONRadiusCriticalAuth {
    /**
    ...
    public CreateNetworkSwitchAccessPolicy201ApplicationJSONRadiusCriticalAuth withDataVlanId(Long dataVlanId) {
    ...
    public CreateNetworkSwitchAccessPolicy201ApplicationJSONRadiusCriticalAuth withSuspendPortBounce(Boolean suspendPortBounce) {
    ...
    public CreateNetworkSwitchAccessPolicy201ApplicationJSONRadiusCriticalAuth withVoiceVlanId(Long voiceVlanId) {
