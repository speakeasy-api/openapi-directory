...
class Application 
{
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetApplicationsStatusRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetApplicationsStatusResponse
     */
	public function getApplicationsStatus(
        \OpenAPI\OpenAPI\Models\Operations\GetApplicationsStatusRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetApplicationsStatusResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/applications/status/');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\GetApplicationsStatusRequest::class, $request, null));
        
        $httpResponse = $this->_securityClient->request('GET', $url, $options);
        
        $contentType = $httpResponse->getHeader('Content-Type')[0] ?? '';

        $response = new \OpenAPI\OpenAPI\Models\Operations\GetApplicationsStatusResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->applicationStatus = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ApplicationStatus', 'json');
            }
        }
