...
public class ReleasesGetLatestByHash200ApplicationJSON {
    ...
    public ReleasesGetLatestByHash200ApplicationJSON(@JsonProperty("app_display_name") String appDisplayName, @JsonProperty("app_icon_url") String appIconUrl, @JsonProperty("app_name") String appName, @JsonProperty("enabled") Boolean enabled, @JsonProperty("id") Long id, @JsonProperty("short_version") String shortVersion, @JsonProperty("uploaded_at") String uploadedAt, @JsonProperty("version") String version) {
        this.appDisplayName = appDisplayName;
        this.appIconUrl = appIconUrl;
        this.appName = appName;
        this.enabled = enabled;
