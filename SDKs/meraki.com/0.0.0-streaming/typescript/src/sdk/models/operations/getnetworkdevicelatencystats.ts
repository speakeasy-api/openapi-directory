 ...
 */
export enum GetNetworkDeviceLatencyStatsBandEnum {
  Two4 = "2.4",
  Five = "5",
}

export class GetNetworkDeviceLatencyStatsRequest extends SpeakeasyBase {
  /**
  ...
  band?: GetNetworkDeviceLatencyStatsBandEnum;
...
export class GetNetworkDeviceLatencyStatsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getNetworkDeviceLatencyStats200ApplicationJSONObject?: Record<string, any>;
}
