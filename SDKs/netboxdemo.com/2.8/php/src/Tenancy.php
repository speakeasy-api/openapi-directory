...
class Tenancy 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Shared\WritableTenantGroupInput $request
     * @return \OpenAPI\OpenAPI\Models\Operations\TenancyTenantGroupsCreateResponse
     */
	public function tenancyTenantGroupsCreate(
        \OpenAPI\OpenAPI\Models\Shared\WritableTenantGroupInput $request,
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\TenancyTenantGroupsPartialUpdateResponse
    {
        ...
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "writableTenantGroupInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
