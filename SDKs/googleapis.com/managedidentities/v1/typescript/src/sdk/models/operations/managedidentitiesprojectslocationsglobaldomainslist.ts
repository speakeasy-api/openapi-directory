...
export class ManagedidentitiesProjectsLocationsGlobalDomainsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ManagedidentitiesProjectsLocationsGlobalDomainsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ManagedidentitiesProjectsLocationsGlobalDomainsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
