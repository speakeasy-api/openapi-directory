...
class ListTLSRoutesResponse:
    ...
    tls_routes: Optional[list[shared_tlsroute.TLSRoute]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tlsRoutes'), 'exclude': lambda f: f is None }})
    r"""List of TlsRoute resources."""  
