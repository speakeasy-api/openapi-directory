...
class DescribeEgressOnlyInternetGatewaysRequestFilters:
...
class DescribeEgressOnlyInternetGatewaysRequest:
    ...
    egress_only_internet_gateway_ids: Optional[list[str]] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeEgressOnlyInternetGatewaysRequestFilters]] = dataclasses.field(default=None)  
