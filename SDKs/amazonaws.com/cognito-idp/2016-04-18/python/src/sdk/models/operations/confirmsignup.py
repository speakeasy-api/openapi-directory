...
class ConfirmSignUpRequest:
    headers: ConfirmSignUpHeaders = dataclasses.field()
    request: shared_confirmsignuprequest.ConfirmSignUpRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
