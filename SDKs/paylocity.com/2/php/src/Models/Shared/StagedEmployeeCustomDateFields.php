...
class StagedEmployeeCustomDateFields
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\StagedEmployeeCustomDateFieldsCategoryEnum $category
     */
	#[\JMS\Serializer\Annotation\SerializedName('category')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\StagedEmployeeCustomDateFieldsCategoryEnum>')]
	...
	{
		$this->category = \OpenAPI\OpenAPI\Models\Shared\StagedEmployeeCustomDateFieldsCategoryEnum::PAYROLL_AND_HR;
		$this->label = "";
		$this->value = "";
	}
}
