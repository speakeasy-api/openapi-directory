...
public class InsightsAPI {
	...
	public InsightsAPI(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
     ...
     */
    public org.openapis.openapi.models.operations.GetPodcastAudienceResponse getPodcastAudience(org.openapis.openapi.models.operations.GetPodcastAudienceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetPodcastAudiencePathParams.class, baseUrl, "/podcasts/{id}/audience", request.pathParams, null);
