...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Operations.BaremetalsolutionOperationsDelete(ctx, operations.BaremetalsolutionOperationsDeleteRequest{
        DollarXgafv: shared.XgafvEnumTwo.ToPointer(),
    ...
    }, operations.BaremetalsolutionOperationsDeleteSecurity{
        Oauth2: "Bearer YOUR_ACCESS_TOKEN_HERE",
        Oauth2c: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Operations.BaremetalsolutionOperationsList(ctx, operations.BaremetalsolutionOperationsListRequest{
    ...
    }, operations.BaremetalsolutionOperationsListSecurity{
        Oauth2: "Bearer YOUR_ACCESS_TOKEN_HERE",
        Oauth2c: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
