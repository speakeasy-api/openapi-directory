...
public class GETCancelReservedInstancesListingRequest {
    ...
    public GETCancelReservedInstancesListingRequest(@JsonProperty("Action") GETCancelReservedInstancesListingActionEnum action, @JsonProperty("ReservedInstancesListingId") String reservedInstancesListingId, @JsonProperty("Version") GETCancelReservedInstancesListingVersionEnum version) {
        this.action = action;
        this.reservedInstancesListingId = reservedInstancesListingId;
        this.version = version;
  }
