    ...
    public static void main(String[] args) {
        try {
            ...
            HscerRequestBody req = new HscerRequestBody(HscerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HscerRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "MAR2018", "123456", "123412341234");;
            ...
            HscerResponse res = sdk.apIs.hscer(req, new HscerSecurity("molestiae", "minus") {{
