 ...
 */
export declare class DescribeSpotInstanceRequestsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
/**
 ...
 */
export declare class DescribeSpotInstanceRequestsRequest extends SpeakeasyBase {
    dryRun?: boolean;
