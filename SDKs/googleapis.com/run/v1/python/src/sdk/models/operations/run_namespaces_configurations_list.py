...
class RunNamespacesConfigurationsListRequest:
    ...
    r"""The namespace from which the configurations should be listed. For Cloud Run, replace {namespace_id} with the project ID or number."""  
    ...
    r"""Optional. The maximum number of the records that should be returned."""  
