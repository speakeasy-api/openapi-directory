...
class GetAccessControlEffectRequest:
    ...
    get_access_control_effect_request: shared_getaccesscontroleffectrequest.GetAccessControlEffectRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
