...
class PostTruckOptimalRouteOutputFormatRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostTruckOptimalRouteOutputFormatCriteriaEnum $criteria
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=criteria')]
    public ?PostTruckOptimalRouteOutputFormatCriteriaEnum $criteria = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostTruckOptimalRouteOutputFormatDistanceUnitEnum $distanceUnit
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=distanceUnit')]
    public ?PostTruckOptimalRouteOutputFormatDistanceUnitEnum $distanceUnit = null;
    
    /**
     * Format of representation
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\PostTruckOptimalRouteOutputFormatOutputFormatEnum $outputFormat
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostTruckOptimalRouteOutputFormatOutputSrsEnum $outputSRS
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=outputSRS')]
    public ?PostTruckOptimalRouteOutputFormatOutputSrsEnum $outputSRS = null;
	...
	public function __construct()
	{
		...
		$this->outputFormat = \OpenAPI\OpenAPI\Models\Operations\PostTruckOptimalRouteOutputFormatOutputFormatEnum::JSON;
		$this->outputSRS = null;
		$this->partition = null;
		$this->points = "";
		$this->roundTrip = null;
