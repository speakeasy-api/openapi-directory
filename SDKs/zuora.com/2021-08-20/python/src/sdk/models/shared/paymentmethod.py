...
class PaymentMethodBankAccountTypeEnum(str, Enum):
...
class PaymentMethodMitConsentAgreementSrcEnum(str, Enum):
    r"""Required if you set the `mitProfileAction` field."""
    EXTERNAL = 'External'

class PaymentMethodMitProfileActionEnum(str, Enum):
...
class PaymentMethodMitProfileTypeEnum(str, Enum):
...
class PaymentMethod:
    ...
    r"""Type of payment method. The following types of the payment method are supported:
    ...
    * You can also specify a custom payment method type. This type is only available if the Universal Payment Connector and Open Payment Method services are enabled. See [Set up custom payment gateways and payment methods](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/MB_Set_up_custom_payment_gateways_and_payment_methods) for details.
    """  
    account_holder_info: Optional[PaymentMethodAccountHolderInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('accountHolderInfo'), 'exclude': lambda f: f is None }})  
    ...
    * The default payment gateway of your Zuora tenant, if the `accountKey` field is not set.
    ...
    bank_account_type: Optional[PaymentMethodBankAccountTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bankAccountType'), 'exclude': lambda f: f is None }})
    r"""The type of bank account associated with the ACH payment. This field is only required if the `type` field is set to `ACH`."""  
    ...
    mit_consent_agreement_src: Optional[PaymentMethodMitConsentAgreementSrcEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mitConsentAgreementSrc'), 'exclude': lambda f: f is None }})
    r"""Required if you set the `mitProfileAction` field."""  
    ...
    mit_profile_action: Optional[PaymentMethodMitProfileActionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mitProfileAction'), 'exclude': lambda f: f is None }})
    r"""If you set this field, Zuora creates a stored credential profile within the payment method.
    ...
    * `Persist` - Use this value if the stored credential profile represents a stored credential profile in an external system. The status of the payment method's stored credential profile will be `Active`.
    ...
    mit_profile_type: Optional[PaymentMethodMitProfileTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mitProfileType'), 'exclude': lambda f: f is None }})
    r"""Required if you set the `mitProfileAction` field. Indicates the type of the stored credential profile to process recurring or unsecheduled transactions."""  
    phone: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('phone'), 'exclude': lambda f: f is None }})
