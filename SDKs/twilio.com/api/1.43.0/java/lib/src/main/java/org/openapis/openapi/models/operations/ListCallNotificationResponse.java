...
public class ListCallNotificationResponse {
    ...
    public ListCallNotificationResponse withStatusCode(Integer statusCode) {
    ...
    public ListCallNotificationResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
        this.rawResponse = rawResponse;
        return this;
    }
    
    public ListCallNotificationResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
