...
from ..shared import listpartsoutput as shared_listpartsoutput
...
class ListPartsRequest:
    headers: ListPartsHeaders = dataclasses.field()
    path_params: ListPartsPathParams = dataclasses.field()
    query_params: ListPartsQueryParams = dataclasses.field()
...
class ListPartsResponse:
    ...
    list_parts_output: Optional[shared_listpartsoutput.ListPartsOutput] = dataclasses.field(default=None)
