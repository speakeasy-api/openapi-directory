...
public class PutRawMessageContentRequestBodyContent {
    ...
    public openapisdk.models.shared.S3Reference s3Reference;
    public PutRawMessageContentRequestBodyContent withS3Reference(openapisdk.models.shared.S3Reference s3Reference) {
