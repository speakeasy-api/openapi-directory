...
public class GetNetworkWirelessSignalQualityHistoryRequest {
    ...
    public GetNetworkWirelessSignalQualityHistoryRequest withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkWirelessSignalQualityHistoryRequest withAutoResolution(Boolean autoResolution) {
    ...
    public GetNetworkWirelessSignalQualityHistoryRequest withBand(GetNetworkWirelessSignalQualityHistoryBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public GetNetworkWirelessSignalQualityHistoryRequest withClientId(String clientId) {
    ...
    public GetNetworkWirelessSignalQualityHistoryRequest withDeviceSerial(String deviceSerial) {
    ...
    public GetNetworkWirelessSignalQualityHistoryRequest withNetworkId(String networkId) {
    ...
    public GetNetworkWirelessSignalQualityHistoryRequest withResolution(Long resolution) {
    ...
    public GetNetworkWirelessSignalQualityHistoryRequest withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public GetNetworkWirelessSignalQualityHistoryRequest withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public GetNetworkWirelessSignalQualityHistoryRequest withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkWirelessSignalQualityHistoryRequest withTimespan(Float timespan) {
        this.timespan = timespan;
        return this;
    }
    
    public GetNetworkWirelessSignalQualityHistoryRequest(@JsonProperty("networkId") String networkId) {
        this.networkId = networkId;
  }
}
