...
class GoogleCloudRecaptchaenterpriseV1ListRelatedAccountGroupsResponse:
    ...
    related_account_groups: Optional[list[shared_googlecloudrecaptchaenterprisev1relatedaccountgroup.GoogleCloudRecaptchaenterpriseV1RelatedAccountGroup]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('relatedAccountGroups'), 'exclude': lambda f: f is None }})
    r"""The groups of related accounts listed by the query."""  
