...
public class GetNhBugsBugHeaders {
    /**
    ...
    public GetNhBugsBugHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhBugsBugHeaders withXApiKey(String xApiKey) {
