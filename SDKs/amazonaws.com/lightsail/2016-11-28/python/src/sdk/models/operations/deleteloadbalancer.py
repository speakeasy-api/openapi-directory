...
class DeleteLoadBalancerHeaders:
...
class DeleteLoadBalancerRequest:
    headers: DeleteLoadBalancerHeaders = dataclasses.field()
    request: shared_deleteloadbalancerrequest.DeleteLoadBalancerRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
