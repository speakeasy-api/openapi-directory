...
class GetNotificationChannelResponse:
    ...
    sns_role_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SnsRoleName'), 'exclude': lambda f: f is None }})  
