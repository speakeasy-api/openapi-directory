 ...
 */
export class CoverageNormalizedUnits extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "CoverageNormalizedUnitsPercentage" })
  coverageNormalizedUnitsPercentage?: string;

  @SpeakeasyMetadata()
  @Expose({ name: "OnDemandNormalizedUnits" })
  onDemandNormalizedUnits?: string;

  @SpeakeasyMetadata()
  @Expose({ name: "ReservedNormalizedUnits" })
  reservedNormalizedUnits?: string;

  @SpeakeasyMetadata()
  @Expose({ name: "TotalRunningNormalizedUnits" })
