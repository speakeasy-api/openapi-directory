...
type UpdateFolderRequestClassificationEnum string
...
func (e *UpdateFolderRequestClassificationEnum) UnmarshalJSON(data []byte) error {
	...
	case "3":
		fallthrough
	case "4":
		*e = UpdateFolderRequestClassificationEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateFolderRequestClassificationEnum: %s", s)
	}
}
