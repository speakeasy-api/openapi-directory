...
import dataclasses
from ..shared import failedsubmissionv3 as shared_failedsubmissionv3
...
class QueryBatchResponseV3:
    ...
    failures: Optional[list[shared_failedsubmissionv3.FailedSubmissionV3]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failures'), 'exclude': lambda f: f is None }})  
