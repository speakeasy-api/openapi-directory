...
class ComputeNodeGetRequest:
    ...
    r"""The id of the compute node that you want to get information about."""  
...
class ComputeNodeGetResponse:
    ...
    compute_node: Optional[shared_computenode.ComputeNode] = dataclasses.field(default=None)  
