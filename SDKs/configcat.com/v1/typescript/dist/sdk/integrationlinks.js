...
exports.IntegrationLinks = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var IntegrationLinks = /** @class */ (function () {
    function IntegrationLinks(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    IntegrationLinks.prototype.addOrUpdateIntegrationLink = function (req, config) {
        var _a;
    ...
    **/
    IntegrationLinks.prototype.deleteIntegrationLink = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    IntegrationLinks.prototype.getIntegrationLinkDetails = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.IntegrationLinks = IntegrationLinks;
