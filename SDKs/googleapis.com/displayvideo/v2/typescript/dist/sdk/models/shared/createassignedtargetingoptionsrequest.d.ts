 ...
 */
export declare enum CreateAssignedTargetingOptionsRequestTargetingTypeEnum {
 ...
 */
export declare class CreateAssignedTargetingOptionsRequestInput extends SpeakeasyBase {
    /**
     * Required. The assigned targeting options to create and add.
     */
    assignedTargetingOptions?: AssignedTargetingOptionInput[];
    /**
     * Required. Identifies the type of this assigned targeting option.
     */
