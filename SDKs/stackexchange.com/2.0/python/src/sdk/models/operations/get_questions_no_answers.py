...
class GetQuestionsNoAnswersQueryParams:
    ...
    order: Optional[GetQuestionsNoAnswersOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetQuestionsNoAnswersSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetQuestionsNoAnswersRequest:
    query_params: GetQuestionsNoAnswersQueryParams = dataclasses.field()
