...
exports.TaskrouterV1WorkspaceEvent = void 0;
...
var TaskrouterV1WorkspaceEvent = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "actor_sid" }),
        __metadata("design:type", String)
    ], TaskrouterV1WorkspaceEvent.prototype, "actorSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "actor_type" }),
        __metadata("design:type", String)
    ], TaskrouterV1WorkspaceEvent.prototype, "actorType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "actor_url" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "event_data" }),
        __metadata("design:type", Object)
    ], TaskrouterV1WorkspaceEvent.prototype, "eventData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "event_date" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "event_date_ms" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "resource_url" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "source_ip_address" }),
        __metadata("design:type", String)
...
exports.TaskrouterV1WorkspaceEvent = TaskrouterV1WorkspaceEvent;
