 ...
 * @access public
 */
class CreateTransitGatewayConnectRequestTagSpecifications
{
	
    public ?CreateTransitGatewayConnectRequestTagSpecificationsResourceTypeEnum $resourceType = null;
    
    /**
     * $tags
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Shared\CreateTransitGatewayConnectRequestTagSpecificationsTags> $tags
     */
