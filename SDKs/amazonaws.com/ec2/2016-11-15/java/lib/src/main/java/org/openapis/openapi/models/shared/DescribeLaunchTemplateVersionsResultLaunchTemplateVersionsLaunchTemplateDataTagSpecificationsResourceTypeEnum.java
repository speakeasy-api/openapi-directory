 ...
 */
public enum DescribeLaunchTemplateVersionsResultLaunchTemplateVersionsLaunchTemplateDataTagSpecificationsResourceTypeEnum {
    ...
    private DescribeLaunchTemplateVersionsResultLaunchTemplateVersionsLaunchTemplateDataTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
