...
export class V1 {
  ...
  **/
  cancel(
    ...
    const url: string = utils.generateURL(baseURL, "/v1/subscriptions/{subscriptionId}", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.CancelResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            ...
            if (utils.matchContentType(contentType, `application/json`)) {
                res.subscriptionList = httpRes?.data;
            }
            break;
          case httpRes?.status == 400:
            if (utils.matchContentType(contentType, `application/javascript`)) {
  ...
  **/
  productGroups(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/subscriptions/productGroups";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ProductGroupsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/javascript`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
            ...
            if (utils.matchContentType(contentType, `application/json`)) {
                res.productGroups = httpRes?.data;
            }
            break;
          case httpRes?.status == 400:
            if (utils.matchContentType(contentType, `application/javascript`)) {
