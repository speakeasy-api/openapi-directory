...
class PutRepositoriesWorkspaceRepoSlugDefaultReviewersTargetUsernameResponse:
    ...
    r"""The specified user was successfully added to the default reviewers"""  
    error: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""If the authenticated user tried to add a team, bot user, or user without access to the repository to the default reviewers"""  
