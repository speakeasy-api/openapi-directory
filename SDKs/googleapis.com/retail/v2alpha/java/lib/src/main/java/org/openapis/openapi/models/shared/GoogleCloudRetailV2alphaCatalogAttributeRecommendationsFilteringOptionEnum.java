 ...
 */
public enum GoogleCloudRetailV2alphaCatalogAttributeRecommendationsFilteringOptionEnum {
    ...
    private GoogleCloudRetailV2alphaCatalogAttributeRecommendationsFilteringOptionEnum(String value) {
        this.value = value;
    }
}
