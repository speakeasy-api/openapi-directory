 ...
 */
export enum RegionDiskTypeListWarningCodeEnum {
...
export class RegionDiskTypeListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class RegionDiskTypeListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: RegionDiskTypeListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: RegionDiskTypeListWarningData })
  @Expose({ name: "data" })
  @Type(() => RegionDiskTypeListWarningData)
  data?: RegionDiskTypeListWarningData[];
 ...
 * Successful response
 */
export class RegionDiskTypeList extends SpeakeasyBase {
  /**
