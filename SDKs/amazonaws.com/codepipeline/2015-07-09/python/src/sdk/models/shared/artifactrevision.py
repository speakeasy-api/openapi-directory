...
class ArtifactRevision:
    ...
    revision_change_identifier: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('revisionChangeIdentifier') }})
