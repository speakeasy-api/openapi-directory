...
export class GetNetworkMerakiAuthUser200ApplicationJSONAuthorizations extends SpeakeasyBase {
  /**
 ...
 */
export class GetNetworkMerakiAuthUser200ApplicationJSON extends SpeakeasyBase {
  /**
  ...
  @Type(() => GetNetworkMerakiAuthUser200ApplicationJSONAuthorizations)
