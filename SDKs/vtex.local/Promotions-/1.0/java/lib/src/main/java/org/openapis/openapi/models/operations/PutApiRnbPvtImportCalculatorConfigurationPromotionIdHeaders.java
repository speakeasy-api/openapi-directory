...
public class PutApiRnbPvtImportCalculatorConfigurationPromotionIdHeaders {
    /**
     * HTTP Client Negotiation Accept Header. Indicates the types of responses the client can understand.
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Accept")
    public String accept;
    public PutApiRnbPvtImportCalculatorConfigurationPromotionIdHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public PutApiRnbPvtImportCalculatorConfigurationPromotionIdHeaders withContentType(String contentType) {
    ...
    public PutApiRnbPvtImportCalculatorConfigurationPromotionIdHeaders withXVTEXAccumulateWithManualPrices(Boolean xVTEXAccumulateWithManualPrices) {
    ...
    public PutApiRnbPvtImportCalculatorConfigurationPromotionIdHeaders withXVTEXCalculatorName(String xVTEXCalculatorName) {
    ...
    public PutApiRnbPvtImportCalculatorConfigurationPromotionIdHeaders withXVTEXClusterExpression(String xVTEXClusterExpression) {
    ...
    public PutApiRnbPvtImportCalculatorConfigurationPromotionIdHeaders withXVTEXClusterOperator(String xVTEXClusterOperator) {
    ...
    public PutApiRnbPvtImportCalculatorConfigurationPromotionIdHeaders withXVTEXCumulative(Boolean xVTEXCumulative) {
    ...
    public PutApiRnbPvtImportCalculatorConfigurationPromotionIdHeaders withXVTEXEndDate(String xVTEXEndDate) {
    ...
    public PutApiRnbPvtImportCalculatorConfigurationPromotionIdHeaders withXVTEXStartDate(String xVTEXStartDate) {
