...
import { NetworkInterfaceCreationTypeEnum } from "./networkinterfacecreationtypeenum";

/**
 * Describes the IPv4 prefix option for a network interface.
 */
export class CreateNetworkInterfaceRequestIpv4Prefixes extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipv4Prefix?: string;
}
 ...
 */
export class CreateNetworkInterfaceRequestIpv6Addresses extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipv6Address?: string;
}
 ...
 * Describes the IPv4 prefix option for a network interface.
 */
export class CreateNetworkInterfaceRequestIpv6Prefixes extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipv6Prefix?: string;
}
 ...
 */
export class CreateNetworkInterfaceRequestPrivateIpAddresses extends SpeakeasyBase {
  @SpeakeasyMetadata()
  primary?: boolean;
 ...
 */
export enum CreateNetworkInterfaceRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateNetworkInterfaceRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateNetworkInterfaceRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateNetworkInterfaceRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken?: string;
  ...
  @SpeakeasyMetadata({ elemType: CreateNetworkInterfaceRequestIpv4Prefixes })
  ipv4Prefixes?: CreateNetworkInterfaceRequestIpv4Prefixes[];

  @SpeakeasyMetadata()
  ipv6AddressCount?: number;

  @SpeakeasyMetadata({ elemType: CreateNetworkInterfaceRequestIpv6Addresses })
  ipv6Addresses?: CreateNetworkInterfaceRequestIpv6Addresses[];

  @SpeakeasyMetadata()
  ipv6PrefixCount?: number;

  @SpeakeasyMetadata({ elemType: CreateNetworkInterfaceRequestIpv6Prefixes })
