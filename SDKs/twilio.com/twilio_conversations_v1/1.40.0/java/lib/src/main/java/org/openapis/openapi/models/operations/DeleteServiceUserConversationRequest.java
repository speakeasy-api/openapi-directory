...
public class DeleteServiceUserConversationRequest {
    ...
    public DeleteServiceUserConversationRequest withChatServiceSid(String chatServiceSid) {
    ...
    public DeleteServiceUserConversationRequest withConversationSid(String conversationSid) {
    ...
    public DeleteServiceUserConversationRequest withUserSid(String userSid) {
