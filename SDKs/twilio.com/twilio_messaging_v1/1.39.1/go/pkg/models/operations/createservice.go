...
func (e *CreateServiceCreateServiceRequestFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateServiceCreateServiceRequestFallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateServiceCreateServiceRequestFallbackMethodEnum: %s", s)
	}
}
...
func (e *CreateServiceCreateServiceRequestInboundMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateServiceCreateServiceRequestInboundMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateServiceCreateServiceRequestInboundMethodEnum: %s", s)
	}
}
