...
var machinelearning_1 = require("./machinelearning");
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.machineLearning = new machinelearning_1.MachineLearning(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    ...
    SDK.prototype.deleteCache = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/cache/{key}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.DeleteCacheResponse({
