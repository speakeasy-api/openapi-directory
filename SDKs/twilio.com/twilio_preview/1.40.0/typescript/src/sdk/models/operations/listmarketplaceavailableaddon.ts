...
export class ListMarketplaceAvailableAddOnListMarketplaceAvailableAddOnResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.PreviewMarketplaceAvailableAddOn })
  @Expose({ name: "available_add_ons" })
  @Type(() => shared.PreviewMarketplaceAvailableAddOn)
  availableAddOns?: shared.PreviewMarketplaceAvailableAddOn[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(
    () => ListMarketplaceAvailableAddOnListMarketplaceAvailableAddOnResponseMeta
  )
