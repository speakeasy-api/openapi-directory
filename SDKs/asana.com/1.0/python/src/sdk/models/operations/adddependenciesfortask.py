...
class AddDependenciesForTaskRequestBody:
    r"""The list of tasks to set as dependencies."""
    
    data: Optional[shared_modifydependenciesrequest.ModifyDependenciesRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
    

@dataclasses.dataclass
class AddDependenciesForTaskRequest:
    
    request_body: AddDependenciesForTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The list of tasks to set as dependencies."""  
...
class AddDependenciesForTask200ApplicationJSON:
    r"""Successfully set the specified dependencies on the task."""
