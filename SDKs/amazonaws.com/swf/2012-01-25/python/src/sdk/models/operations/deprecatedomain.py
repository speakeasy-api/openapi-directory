...
class DeprecateDomainRequest:
    ...
    deprecate_domain_input: shared_deprecatedomaininput.DeprecateDomainInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
