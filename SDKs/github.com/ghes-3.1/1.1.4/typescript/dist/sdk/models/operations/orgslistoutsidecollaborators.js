...
exports.OrgsListOutsideCollaboratorsResponse = exports.OrgsListOutsideCollaboratorsRequest = exports.OrgsListOutsideCollaboratorsFilterEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Filter the list of outside collaborators. `2fa_disabled` means that only outside collaborators without [two-factor authentication](https://github.com/blog/1614-two-factor-authentication) enabled will be returned.
 */
var OrgsListOutsideCollaboratorsFilterEnum;
...
})(OrgsListOutsideCollaboratorsFilterEnum = exports.OrgsListOutsideCollaboratorsFilterEnum || (exports.OrgsListOutsideCollaboratorsFilterEnum = {}));
var OrgsListOutsideCollaboratorsRequest = /** @class */ (function (_super) {
    ...
    ], OrgsListOutsideCollaboratorsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=org" }),
        __metadata("design:type", String)
    ], OrgsListOutsideCollaboratorsRequest.prototype, "org", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], OrgsListOutsideCollaboratorsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], OrgsListOutsideCollaboratorsRequest.prototype, "perPage", void 0);
    return OrgsListOutsideCollaboratorsRequest;
}(utils_1.SpeakeasyBase));
exports.OrgsListOutsideCollaboratorsRequest = OrgsListOutsideCollaboratorsRequest;
var OrgsListOutsideCollaboratorsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], OrgsListOutsideCollaboratorsResponse.prototype, "rawResponse", void 0);
    __decorate([
...
exports.OrgsListOutsideCollaboratorsResponse = OrgsListOutsideCollaboratorsResponse;
