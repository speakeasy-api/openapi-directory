...
class BooksNotificationGetQueryParams:
    notification_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'notification_id', 'style': 'form', 'explode': True }})
...
class BooksNotificationGetRequest:
    query_params: BooksNotificationGetQueryParams = dataclasses.field()
    security: BooksNotificationGetSecurity = dataclasses.field()
