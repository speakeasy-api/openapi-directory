...
class DisplayvideoInventorySourceGroupsAssignedInventorySourcesBulkEditRequest:
    ...
    r"""Required. The ID of the inventory source group to which the assignments are assigned."""  
    ...
    bulk_edit_assigned_inventory_sources_request_input: Optional[shared_bulkeditassignedinventorysourcesrequest.BulkEditAssignedInventorySourcesRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
