...
class GetSfxLicenseListDownloadAvailabilityEnum(str, Enum):
    r"""Filter licenses by download availability"""
    ALL = 'all'
    DOWNLOADABLE = 'downloadable'
    NON_DOWNLOADABLE = 'non_downloadable'

class GetSfxLicenseListSortEnum(str, Enum):
    r"""Sort order"""
    NEWEST = 'newest'
    OLDEST = 'oldest'
...
class GetSfxLicenseListRequest:
    ...
    download_availability: Optional[GetSfxLicenseListDownloadAvailabilityEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'download_availability', 'style': 'form', 'explode': True }})
    r"""Filter licenses by download availability"""  
    ...
    r"""Show sound effects that are available with the specified license, such as `standard` or `enhanced`; prepending a `-` sign excludes results from that license"""  
    license_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'license_id', 'style': 'form', 'explode': True }})
    r"""Filter by the license ID"""  
    page: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'page', 'style': 'form', 'explode': True }})
    r"""Page number"""  
    per_page: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'per_page', 'style': 'form', 'explode': True }})
    r"""Number of results per page"""  
    sfx_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sfx_id', 'style': 'form', 'explode': True }})
    r"""Show licenses for the specified sound effects ID"""  
    sort: Optional[GetSfxLicenseListSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""Sort order"""  
