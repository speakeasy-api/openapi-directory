...
class DeleteSlackChannelConfigurationRequest:
    ...
    request_body: DeleteSlackChannelConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DeleteSlackChannelConfigurationResponse:
    ...
    r"""ConflictException"""  
    delete_slack_channel_configuration_result: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
