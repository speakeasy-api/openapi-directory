...
class ListRoleListRoleResponse:
    ...
    roles: Optional[list[shared_ip_messaging_v2_service_role.IPMessagingV2ServiceRole]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('roles'), 'exclude': lambda f: f is None }})  
