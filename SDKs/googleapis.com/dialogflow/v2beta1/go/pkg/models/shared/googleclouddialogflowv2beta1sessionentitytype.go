...
func (e GoogleCloudDialogflowV2beta1SessionEntityTypeEntityOverrideModeEnum) ToPointer() *GoogleCloudDialogflowV2beta1SessionEntityTypeEntityOverrideModeEnum {
	return &e
}
...
func (e *GoogleCloudDialogflowV2beta1SessionEntityTypeEntityOverrideModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "ENTITY_OVERRIDE_MODE_SUPPLEMENT":
		*e = GoogleCloudDialogflowV2beta1SessionEntityTypeEntityOverrideModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudDialogflowV2beta1SessionEntityTypeEntityOverrideModeEnum: %v", v)
	}
}
