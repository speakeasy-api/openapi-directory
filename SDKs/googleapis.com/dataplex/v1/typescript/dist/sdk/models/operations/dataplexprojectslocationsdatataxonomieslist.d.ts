...
export declare class DataplexProjectsLocationsDataTaxonomiesListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class DataplexProjectsLocationsDataTaxonomiesListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class DataplexProjectsLocationsDataTaxonomiesListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
