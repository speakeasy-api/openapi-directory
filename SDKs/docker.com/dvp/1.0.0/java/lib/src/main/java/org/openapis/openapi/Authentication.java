...
public class Authentication {
    ...
    /**
	 * POST_USERS2_FA_LOGIN_SERVERS contains the list of server urls available to the SDK.
	 */
    public static final String[] POST_USERS2_FA_LOGIN_SERVERS = {
        "https://hub.docker.com",
    };
	
    /**
	 * POST_USERS_LOGIN_SERVERS contains the list of server urls available to the SDK.
	 */
    public static final String[] POST_USERS_LOGIN_SERVERS = {
        "https://hub.docker.com",
    };
