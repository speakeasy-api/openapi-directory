 ...
 */
public class SubmitPost200ApplicationJSON {
    /**
    ...
    public SubmitPost200ApplicationJSON withIdentifier(String identifier) {
    ...
    public SubmitPost200ApplicationJSON withMessage(String message) {
    ...
    public SubmitPost200ApplicationJSON withPreferenceKey(String preferenceKey) {
    ...
    public SubmitPost200ApplicationJSON withResult(String result) {
        this.result = result;
        return this;
    }
    ...
    public SubmitPost200ApplicationJSON withSession(java.util.Map<String, String> session) {
