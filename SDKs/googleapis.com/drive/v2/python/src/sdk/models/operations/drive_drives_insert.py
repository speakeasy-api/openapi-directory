...
class DriveDrivesInsertQueryParams:
...
@dataclasses.dataclass
class DriveDrivesInsertSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class DriveDrivesInsertRequest:
    query_params: DriveDrivesInsertQueryParams = dataclasses.field()
    security: DriveDrivesInsertSecurity = dataclasses.field()
