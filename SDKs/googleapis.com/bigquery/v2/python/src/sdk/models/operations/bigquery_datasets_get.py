...
class BigqueryDatasetsGetSecurity:
    ...
    option1: Optional[BigqueryDatasetsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[BigqueryDatasetsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option3: Optional[BigqueryDatasetsGetSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class BigqueryDatasetsGetRequest:
    ...
    r"""Dataset ID of the requested dataset"""  
    project_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'projectId', 'style': 'simple', 'explode': False }})
    r"""Project ID of the requested dataset"""  
