...
exports.GetAlbumsResponse = exports.GetAlbumsRequest = exports.GetAlbumsSortEnum = exports.GetAlbumsDirectionEnum = void 0;
...
var GetAlbumsRequest = /** @class */ (function (_super) {
    ...
    ], GetAlbumsRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetAlbumsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetAlbumsRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=query" }),
        __metadata("design:type", String)
    ], GetAlbumsRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetAlbumsRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=user_id",
        }),
        __metadata("design:type", Number)
    ], GetAlbumsRequest.prototype, "userId", void 0);
...
var GetAlbumsResponse = /** @class */ (function (_super) {
    ...
    ], GetAlbumsResponse.prototype, "rawResponse", void 0);
    __decorate([
