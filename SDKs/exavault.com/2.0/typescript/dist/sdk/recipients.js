...
var Recipients = /** @class */ (function () {
    function Recipients(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Recipients.prototype.resendInvitationsForShare = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ResendInvitationsForShareRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/recipients/shares/invites/{shareId}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.shareRecipientsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
