 ...
 */
export declare class DescribeVpcEndpointServicePermissionsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeVpcEndpointServicePermissionsRequest extends SpeakeasyBase {
    dryRun?: boolean;
