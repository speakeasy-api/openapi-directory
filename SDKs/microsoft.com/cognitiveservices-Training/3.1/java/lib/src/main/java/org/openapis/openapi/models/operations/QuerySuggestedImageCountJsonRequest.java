...
public class QuerySuggestedImageCountJsonRequest {
    ...
    public QuerySuggestedImageCountJsonRequest(@JsonProperty("TagFilter") org.openapis.openapi.models.shared.TagFilter tagFilter, @JsonProperty("Training-Key") String trainingKey, @JsonProperty("iterationId") String iterationId, @JsonProperty("projectId") String projectId) {
        this.tagFilter = tagFilter;
        this.trainingKey = trainingKey;
        this.iterationId = iterationId;
        this.projectId = projectId;
