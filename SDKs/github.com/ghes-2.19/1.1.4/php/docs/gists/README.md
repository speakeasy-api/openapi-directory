...
try {
    ...
    $request->files = [
        'tempore' => new GistsCreateRequestBodyFiles(),
    ];
...
try {
    ...
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-05-10T02:43:24.423Z');
...
try {
    ...
    $request->page = 863856;
    $request->perPage = 747080;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-04-29T16:20:13.800Z');
    $request->username = 'Joseph17';
...
try {
    ...
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-06-14T07:24:20.121Z');
...
try {
    ...
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-07-06T20:37:36.497Z');
...
try {
    ...
    $request->requestBody->files = [
        'voluptatem' => new GistsUpdateRequestBody2Files3(),
        'soluta' => new GistsUpdateRequestBody2Files3(),
        'et' => new GistsUpdateRequestBody2Files3(),
        'ipsum' => new GistsUpdateRequestBody2Files1(),
    ];
    $request->gistId = 'nobis';
...
try {
    ...
    $request->requestBody->body = 'Body of the attachment';
    $request->commentId = 552193;
    $request->gistId = 'tempore';
