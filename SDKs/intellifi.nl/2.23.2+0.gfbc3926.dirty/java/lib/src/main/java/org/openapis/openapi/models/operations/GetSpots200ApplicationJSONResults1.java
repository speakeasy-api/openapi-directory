...
public class GetSpots200ApplicationJSONResults1 {
    /**
    ...
    public GetSpots200ApplicationJSONResults1AntennaReportLocations[] antennaReportLocations;
    public GetSpots200ApplicationJSONResults1 withAntennaReportLocations(GetSpots200ApplicationJSONResults1AntennaReportLocations[] antennaReportLocations) {
    ...
    public GetSpots200ApplicationJSONResults1 withConfig(java.util.Map<String, Object> config) {
        this.config = config;
        return this;
    }
    ...
    public GetSpots200ApplicationJSONResults1 withConfigRequest(java.util.Map<String, Object> configRequest) {
    ...
    public GetSpots200ApplicationJSONResults1 withGeoCoords(org.openapis.openapi.models.shared.GeoCoords geoCoords) {
    ...
    @JsonProperty("id")
    public String id;
    public GetSpots200ApplicationJSONResults1 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetSpots200ApplicationJSONResults1 withIsOnline(Boolean isOnline) {
    ...
    public GetSpots200ApplicationJSONResults1 withReportLocation(org.openapis.openapi.models.shared.Location reportLocation) {
    ...
    public GetSpots200ApplicationJSONResults1 withRequestCounter(Long requestCounter) {
    ...
    public GetSpots200ApplicationJSONResults1 withSenses(java.util.Map<String, Object> senses) {
        this.senses = senses;
        return this;
    }
    ...
    public GetSpots200ApplicationJSONResults1 withSensesRequest(java.util.Map<String, Object> sensesRequest) {
    ...
    public GetSpots200ApplicationJSONResults1 withSerialNumber(Long serialNumber) {
    ...
    public GetSpots200ApplicationJSONResults1 withStatus(Object status) {
        this.status = status;
        return this;
    }
    ...
    public GetSpots200ApplicationJSONResults1 withTimeCreated(String timeCreated) {
    ...
    public GetSpots200ApplicationJSONResults1 withTimeUpdated(String timeUpdated) {
    ...
    @JsonProperty("url")
    public String url;
    public GetSpots200ApplicationJSONResults1 withUrl(String url) {
        this.url = url;
        return this;
    }
