...
from ..shared import unlockruleresponse as shared_unlockruleresponse
...
class UnlockRuleResponse:
    ...
    unlock_rule_response: Optional[shared_unlockruleresponse.UnlockRuleResponse] = dataclasses.field(default=None)
    r"""Success"""  
