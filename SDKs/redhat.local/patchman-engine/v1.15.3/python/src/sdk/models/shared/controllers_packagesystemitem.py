...
class ControllersPackageSystemItem:
    available_evra: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('available_evra') }})
    ...
    installed_evra: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('installed_evra') }})
