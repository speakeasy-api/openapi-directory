...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningDeleteAnalysisRequest req = new CodeScanningDeleteAnalysisRequest(44612L, "distinctio", "quod") {{
                confirmDelete = "dignissimos";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetAlertRequest req = new CodeScanningGetAlertRequest(76956L, "nihil", "totam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetAnalysisRequest req = new CodeScanningGetAnalysisRequest(882710L, "aliquam", "odio");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetSarifRequest req = new CodeScanningGetSarifRequest("occaecati", "commodi", "sapiente");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListAlertInstancesRequest req = new CodeScanningListAlertInstancesRequest(174112L, "deserunt", "molestiae") {{
                page = 35362L;
                perPage = 783648L;
                ref = "eum";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListAlertsForOrgRequest req = new CodeScanningListAlertsForOrgRequest("quas") {{
                after = "praesentium";
                before = "consequuntur";
                direction = DirectionEnum.DESC;
                page = 143829L;
                perPage = 681393L;
                sort = CodeScanningListAlertsForOrgSortEnum.UPDATED;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListAlertsForRepoRequest req = new CodeScanningListAlertsForRepoRequest("minima", "nisi") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListRecentAnalysesRequest req = new CodeScanningListRecentAnalysesRequest("et", "esse") {{
                page = 910545L;
                perPage = 882042L;
                ref = "veritatis";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningUploadSarifRequest req = new CodeScanningUploadSarifRequest(                new CodeScanningUploadSarifRequestBody("vel", "harum", "molestiae") {{
                                checkoutUri = "file:///github/workspace/";
                                startedAt = OffsetDateTime.parse("2021-11-03T10:56:47.600Z");
                                toolName = "minima";
                            }};, "distinctio", "eligendi");            
