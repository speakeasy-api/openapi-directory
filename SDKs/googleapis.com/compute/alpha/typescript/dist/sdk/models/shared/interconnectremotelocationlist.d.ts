 ...
 */
export declare enum InterconnectRemoteLocationListWarningCodeEnum {
...
export declare class InterconnectRemoteLocationListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InterconnectRemoteLocationListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class InterconnectRemoteLocationList extends SpeakeasyBase {
    /**
