...
from ..shared import getapplicantresponse as shared_getapplicantresponse
...
class ApplicantsOneRequest:
    headers: ApplicantsOneHeaders = dataclasses.field()
    path_params: ApplicantsOnePathParams = dataclasses.field()
    query_params: ApplicantsOneQueryParams = dataclasses.field()
    security: ApplicantsOneSecurity = dataclasses.field()
...
class ApplicantsOneResponse:
    ...
    get_applicant_response: Optional[shared_getapplicantresponse.GetApplicantResponse] = dataclasses.field(default=None)
