...
export class CloudchannelAccountsCustomersCustomerRepricingConfigsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersCustomerRepricingConfigsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersCustomerRepricingConfigsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
