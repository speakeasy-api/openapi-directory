 ...
 */
export declare class GetIpamPoolCidrsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetIpamPoolCidrsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: GetIpamPoolCidrsRequestFilters[];
    ipamPoolId: string;
    maxResults?: number;
    nextToken?: string;
}
