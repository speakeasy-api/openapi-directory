...
public class ListExecutionStepListExecutionStepResponse {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("steps")
    public openapisdk.models.shared.StudioV1FlowExecutionExecutionStep[] steps;
    public ListExecutionStepListExecutionStepResponse withSteps(openapisdk.models.shared.StudioV1FlowExecutionExecutionStep[] steps) {
        this.steps = steps;
        return this;
    }
}