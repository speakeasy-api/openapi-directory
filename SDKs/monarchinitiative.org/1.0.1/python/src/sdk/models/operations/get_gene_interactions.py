...
class GetGeneInteractionsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGeneInteractionsQueryParams:
...
class GetGeneInteractionsRequest:
    path_params: GetGeneInteractionsPathParams = dataclasses.field()
    query_params: GetGeneInteractionsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetGeneInteractionsResponse:
