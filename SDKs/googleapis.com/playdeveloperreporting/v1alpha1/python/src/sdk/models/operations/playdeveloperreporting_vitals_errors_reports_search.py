...
from ..shared import googleplaydeveloperreportingv1alpha1searcherrorreportsresponse as shared_googleplaydeveloperreportingv1alpha1searcherrorreportsresponse
...
class PlaydeveloperreportingVitalsErrorsReportsSearchRequest:
    path_params: PlaydeveloperreportingVitalsErrorsReportsSearchPathParams = dataclasses.field()
    query_params: PlaydeveloperreportingVitalsErrorsReportsSearchQueryParams = dataclasses.field()
...
class PlaydeveloperreportingVitalsErrorsReportsSearchResponse:
    ...
    google_play_developer_reporting_v1alpha1_search_error_reports_response: Optional[shared_googleplaydeveloperreportingv1alpha1searcherrorreportsresponse.GooglePlayDeveloperReportingV1alpha1SearchErrorReportsResponse] = dataclasses.field(default=None)
