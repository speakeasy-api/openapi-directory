...
import dataclasses
from ..shared import overrideinlinesource as shared_overrideinlinesource
...
class ImportConsumerOverridesRequest:
    ...
    force_only: Optional[list[ImportConsumerOverridesRequestForceOnlyEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('forceOnly'), 'exclude': lambda f: f is None }})
    ...
    inline_source: Optional[shared_overrideinlinesource.OverrideInlineSource] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('inlineSource'), 'exclude': lambda f: f is None }})
