...
export class ListOriginationUrlListOriginationUrlResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListOriginationUrlListOriginationUrlResponseMeta)
  meta?: ListOriginationUrlListOriginationUrlResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.TrunkingV1TrunkOriginationUrl })
  @Expose({ name: "origination_urls" })
  @Type(() => shared.TrunkingV1TrunkOriginationUrl)
