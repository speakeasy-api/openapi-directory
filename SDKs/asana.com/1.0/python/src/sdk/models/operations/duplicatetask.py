...
class DuplicateTaskRequestBody:
    r"""Describes the duplicate's name and the fields that will be duplicated."""
    
    data: Optional[shared_taskduplicaterequest.TaskDuplicateRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
    

@dataclasses.dataclass
class DuplicateTaskRequest:
    
    request_body: DuplicateTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Describes the duplicate's name and the fields that will be duplicated."""  
...
class DuplicateTask201ApplicationJSON:
    r"""Successfully created the job to handle duplication."""
