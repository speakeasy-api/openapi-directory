...
class CloudsearchIndexingDatasourcesItemsIndexRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\IndexItemRequest $indexItemRequest = null;
