...
class OsloginUsersSSHPublicKeysGetSecurity:
    option1: Optional[OsloginUsersSSHPublicKeysGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[OsloginUsersSSHPublicKeysGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class OsloginUsersSSHPublicKeysGetRequest:
    path_params: OsloginUsersSSHPublicKeysGetPathParams = dataclasses.field()
    query_params: OsloginUsersSSHPublicKeysGetQueryParams = dataclasses.field()
    security: OsloginUsersSSHPublicKeysGetSecurity = dataclasses.field()
