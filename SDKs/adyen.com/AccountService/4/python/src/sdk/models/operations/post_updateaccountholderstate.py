...
from ..shared import getaccountholderstatusresponse as shared_getaccountholderstatusresponse
...
class PostUpdateAccountHolderStateResponse:
    ...
    get_account_holder_status_response: Optional[shared_getaccountholderstatusresponse.GetAccountHolderStatusResponse] = dataclasses.field(default=None)
