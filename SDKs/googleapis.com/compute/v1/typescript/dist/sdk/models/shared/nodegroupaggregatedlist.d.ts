...
import { NodeGroupsScopedList } from "./nodegroupsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum NodeGroupAggregatedListWarningCodeEnum {
...
export declare class NodeGroupAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodeGroupAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: NodeGroupAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: NodeGroupAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class NodeGroupAggregatedList extends SpeakeasyBase {
    /**
