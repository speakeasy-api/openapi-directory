...
@dataclasses.dataclass
class StorageObjectAccessControlsPatchSecurityOption1:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class StorageObjectAccessControlsPatchSecurityOption2:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
...
class StorageObjectAccessControlsPatchSecurity:
    option1: Optional[StorageObjectAccessControlsPatchSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageObjectAccessControlsPatchSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class StorageObjectAccessControlsPatchRequest:
    path_params: StorageObjectAccessControlsPatchPathParams = dataclasses.field()
    query_params: StorageObjectAccessControlsPatchQueryParams = dataclasses.field()
    security: StorageObjectAccessControlsPatchSecurity = dataclasses.field()
