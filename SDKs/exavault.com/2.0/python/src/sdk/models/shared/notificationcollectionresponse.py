...
class NotificationCollectionResponse:
    r"""NotificationCollectionResponse
    Response object for notifications collection.
    """
    
    data: Optional[list[shared_notification.Notification]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
