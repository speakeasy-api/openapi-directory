...
exports.ProactiveInsightSummary = void 0;
...
**/
var ProactiveInsightSummary = /** @class */ (function (_super) {
    __extends(ProactiveInsightSummary, _super);
    ...
    ], ProactiveInsightSummary.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=InsightTimeRange" }),
        __metadata("design:type", insighttimerange_1.InsightTimeRange)
    ], ProactiveInsightSummary.prototype, "insightTimeRange", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], ProactiveInsightSummary.prototype, "name", void 0);
    __decorate([
    ...
    ], ProactiveInsightSummary.prototype, "predictionTimeRange", void 0);
    __decorate([
    ...
    ], ProactiveInsightSummary.prototype, "resourceCollection", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ServiceCollection" }),
        __metadata("design:type", servicecollection_1.ServiceCollection)
    ], ProactiveInsightSummary.prototype, "serviceCollection", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Severity" }),
        __metadata("design:type", String)
    ], ProactiveInsightSummary.prototype, "severity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Status" }),
        __metadata("design:type", String)
    ], ProactiveInsightSummary.prototype, "status", void 0);
