...
class DriveCommentsInsertSecurity:
    option1: Optional[DriveCommentsInsertSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DriveCommentsInsertSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DriveCommentsInsertRequest:
    path_params: DriveCommentsInsertPathParams = dataclasses.field()
    query_params: DriveCommentsInsertQueryParams = dataclasses.field()
    security: DriveCommentsInsertSecurity = dataclasses.field()
