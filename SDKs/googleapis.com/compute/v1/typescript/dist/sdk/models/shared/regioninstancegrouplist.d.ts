 ...
 */
export declare enum RegionInstanceGroupListWarningCodeEnum {
...
export declare class RegionInstanceGroupListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class RegionInstanceGroupListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: RegionInstanceGroupListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: RegionInstanceGroupListWarningData[];
    /**
 ...
 */
export declare class RegionInstanceGroupList extends SpeakeasyBase {
    /**
