...
var UserResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "businessAccount" }),
        (0, class_transformer_1.Type)(function () { return businessaccount_1.BusinessAccount; }),
        __metadata("design:type", businessaccount_1.BusinessAccount)
    ], UserResponse.prototype, "businessAccount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "individualAccount" }),
        (0, class_transformer_1.Type)(function () { return individualaccount_1.IndividualAccount; }),
        __metadata("design:type", individualaccount_1.IndividualAccount)
    ], UserResponse.prototype, "individualAccount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "registrationMarketplaceId" }),
        __metadata("design:type", String)
