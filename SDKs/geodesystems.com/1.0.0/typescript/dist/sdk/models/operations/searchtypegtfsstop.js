...
exports.SearchTypeGtfsStopResponse = exports.SearchTypeGtfsStopRequest = exports.SearchTypeGtfsStopQueryParams = void 0;
...
var SearchTypeGtfsStopQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_gtfs_stop.location_type" }),
        __metadata("design:type", String)
    ], SearchTypeGtfsStopQueryParams.prototype, "searchTypeGtfsStopLocationType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_gtfs_stop.stop_code" }),
        __metadata("design:type", String)
    ], SearchTypeGtfsStopQueryParams.prototype, "searchTypeGtfsStopStopCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_gtfs_stop.stop_id" }),
        __metadata("design:type", String)
    ], SearchTypeGtfsStopQueryParams.prototype, "searchTypeGtfsStopStopId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_gtfs_stop.wheelchair_boarding" }),
        __metadata("design:type", String)
    ], SearchTypeGtfsStopQueryParams.prototype, "searchTypeGtfsStopWheelchairBoarding", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_gtfs_stop.zone_id" }),
        __metadata("design:type", String)
...
exports.SearchTypeGtfsStopQueryParams = SearchTypeGtfsStopQueryParams;
