...
class DescribeVaultRequest:
    headers: DescribeVaultHeaders = dataclasses.field()
    path_params: DescribeVaultPathParams = dataclasses.field()
...
class DescribeVaultResponse:
    ...
    describe_vault_output: Optional[shared_describevaultoutput.DescribeVaultOutput] = dataclasses.field(default=None)
