...
func NewCdnEndpoints(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *CdnEndpoints {
	return &CdnEndpoints{
...
func (s *CdnEndpoints) CreateCdnEndpoint(ctx context.Context, request operations.CreateCdnEndpointRequest) (*operations.CreateCdnEndpointResponse, error) {
...
func (s *CdnEndpoints) DeleteCdnEndpoint(ctx context.Context, request operations.DeleteCdnEndpointRequest) (*operations.DeleteCdnEndpointResponse, error) {
	baseURL := s._serverURL
...
func (s *CdnEndpoints) GetCdnEndpoint(ctx context.Context, request operations.GetCdnEndpointRequest) (*operations.GetCdnEndpointResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/cdn/endpoints/{cdn_id}", request.PathParams)
...
func (s *CdnEndpoints) ListCdnEndpoints(ctx context.Context, request operations.ListCdnEndpointsRequest) (*operations.ListCdnEndpointsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/cdn/endpoints"
...
func (s *CdnEndpoints) PurgeCdnCache(ctx context.Context, request operations.PurgeCdnCacheRequest) (*operations.PurgeCdnCacheResponse, error) {
	baseURL := s._serverURL
...
// `/v2/cdn/endpoints/$ENDPOINT_ID`.
func (s *CdnEndpoints) UpdateCdnEndpoint(ctx context.Context, request operations.UpdateCdnEndpointRequest) (*operations.UpdateCdnEndpointResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/cdn/endpoints/{cdn_id}", request.PathParams)
