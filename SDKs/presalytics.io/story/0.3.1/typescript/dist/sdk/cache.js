...
var Cache = /** @class */ (function () {
    function Cache(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Cache.prototype.cacheNonceGet = function (req, config) {
    ...
    **/
    Cache.prototype.cachePost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
