 ...
 */
export declare enum PartialShipmentDeliveryConfirmationEnum {
    None = "none",
    Delivery = "delivery",
    Signature = "signature",
 ...
 */
export declare enum PartialShipmentInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export declare enum PartialShipmentInternationalShipmentOptionsNonDeliveryEnum {
 ...
 */
export declare enum PartialShipmentInsuranceProviderEnum {
    None = "none",
 ...
 */
export declare enum PartialShipmentOriginTypeEnum {
    Pickup = "pickup",
    DropOff = "drop_off"
}
/**
 ...
 */
export declare enum PartialShipmentShipmentStatusEnum {
    Pending = "pending",
