...
class DescribeExportImageTasksRequestFilters:
...
class DescribeExportImageTasksRequest:
    ...
    export_image_task_ids: Optional[list[str]] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeExportImageTasksRequestFilters]] = dataclasses.field(default=None)  
