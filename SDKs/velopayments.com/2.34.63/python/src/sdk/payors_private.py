...
class PayorsPrivate:
    ...
    def create_payor_links(self, request: shared.CreatePayorLinkRequest, security: operations.CreatePayorLinksSecurity) -> operations.CreatePayorLinksResponse:
        ...
        res = operations.CreatePayorLinksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
