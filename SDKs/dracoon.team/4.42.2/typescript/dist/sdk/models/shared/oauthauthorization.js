...
exports.OAuthAuthorization = exports.OAuthAuthorizationUserAgentCategoryEnum = void 0;
 ...
 * User agent category.
 */
var OAuthAuthorizationUserAgentCategoryEnum;
...
})(OAuthAuthorizationUserAgentCategoryEnum = exports.OAuthAuthorizationUserAgentCategoryEnum || (exports.OAuthAuthorizationUserAgentCategoryEnum = {}));
/**
 * OAuth authorization
 */
var OAuthAuthorization = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "isCurrentAuthorization" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "usedAt" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "userAgentCategory" }),
        __metadata("design:type", String)
    ], OAuthAuthorization.prototype, "userAgentCategory", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "userAgentInfo" }),
        __metadata("design:type", String)
    ], OAuthAuthorization.prototype, "userAgentInfo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "userAgentOs" }),
        __metadata("design:type", String)
    ], OAuthAuthorization.prototype, "userAgentOs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "userAgentType" }),
        __metadata("design:type", String)
