...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.ConnectionsResponse connections(java.util.Map<String, Object> request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.operations.Connections200ApplicationJSON[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.Connections200ApplicationJSON[].class);
    ...
    public org.openapis.openapi.models.operations.StatusResponse status(org.openapis.openapi.models.operations.StatusRequestBody request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.Status200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.Status200ApplicationJSON.class);
