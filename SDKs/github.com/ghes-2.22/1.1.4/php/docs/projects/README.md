...
try {
    ...
    $request->projectId = 24944;
    $request->username = 'Dillon51';
...
try {
    ...
    $request->requestBody->name = 'Cynthia Macejkovic';
...
try {
    ...
    $request->requestBody->name = 'Aaron Hartmann';
    $request->owner = 'eum';
    $request->repo = 'vel';
...
try {
    ...
    $request->projectId = 751022;
    $request->username = 'Gilberto2';
...
try {
    ...
    $request->columnId = 895692;
    $request->page = 95619;
    $request->perPage = 392569;
...
try {
    ...
    $request->affiliation = ProjectsListCollaboratorsAffiliationEnum::ALL;
    $request->page = 878373;
    $request->perPage = 667593;
    $request->projectId = 690785;
...
try {
    ...
    $request->page = 551079;
    $request->perPage = 260904;
    $request->state = ProjectsListForUserStateEnum::OPEN;
    $request->username = 'Jerrell_Dooley27';
...
try {
    ...
    $request->projectId = 851854;
    $request->username = 'Bianka23';
