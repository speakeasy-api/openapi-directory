...
class ListManagedSchemaArnsRequestBody:
    ...
    r"""The response for ListManagedSchemaArns. When this parameter is used, all minor version ARNs for a major version are listed."""  
    

@dataclasses.dataclass
class ListManagedSchemaArnsRequest:
    
    request_body: ListManagedSchemaArnsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
