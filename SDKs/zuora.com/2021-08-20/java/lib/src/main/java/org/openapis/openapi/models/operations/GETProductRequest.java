...
public class GETProductRequest {
    ...
    public GETProductRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETProductRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETProductRequest withProductId(String productId) {
    ...
    public GETProductRequest withZuoraVersion(String zuoraVersion) {
