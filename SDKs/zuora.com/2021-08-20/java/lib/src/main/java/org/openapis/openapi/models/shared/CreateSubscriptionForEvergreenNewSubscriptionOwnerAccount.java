...
public class CreateSubscriptionForEvergreenNewSubscriptionOwnerAccount {
    ...
    public CreateSubscriptionForEvergreenNewSubscriptionOwnerAccount withBillToContact(BillToContact billToContact) {
    ...
    public CreateSubscriptionForEvergreenNewSubscriptionOwnerAccount withPaymentMethod(PaymentMethod paymentMethod) {
    ...
    public CreateSubscriptionForEvergreenNewSubscriptionOwnerAccount withSoldToContact(SoldToContact soldToContact) {
