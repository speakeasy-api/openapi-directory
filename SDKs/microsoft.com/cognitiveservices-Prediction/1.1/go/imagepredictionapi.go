...
func (s *ImagePredictionAPI) PredictImageURL(ctx context.Context, request operations.PredictImageURLRequest) (*operations.PredictImageURLResponse, error) {
	baseURL := s._serverURL
...
func (s *ImagePredictionAPI) PredictImageURLWithNoStore(ctx context.Context, request operations.PredictImageURLWithNoStoreRequest) (*operations.PredictImageURLWithNoStoreResponse, error) {
	baseURL := s._serverURL
