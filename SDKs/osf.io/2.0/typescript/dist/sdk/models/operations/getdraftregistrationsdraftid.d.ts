...
export declare class GetDraftRegistrationsDraftIdRequest extends SpeakeasyBase {
    /**
     * The unique identifier of the draft registration.
     */
    draftId: string;
}
export declare class GetDraftRegistrationsDraftIdDraftRegistrationAttributesNodeLicense extends SpeakeasyBase {
    /**
 ...
 */
export declare class GetDraftRegistrationsDraftIdDraftRegistrationAttributes extends SpeakeasyBase {
    /**
 ...
 */
export declare class GetDraftRegistrationsDraftIdDraftRegistrationLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class GetDraftRegistrationsDraftIdDraftRegistrationRelationships extends SpeakeasyBase {
    /**
 ...
 * OK
 */
export declare class GetDraftRegistrationsDraftIdDraftRegistration extends SpeakeasyBase {
    /**
     * The properties of the Draft Registration entity.
     */
...
export declare class GetDraftRegistrationsDraftIdResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
