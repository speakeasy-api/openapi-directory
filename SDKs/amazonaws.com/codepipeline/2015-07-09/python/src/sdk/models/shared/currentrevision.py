...
class CurrentRevision:
    r"""Represents information about a current revision."""
    
    change_identifier: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('changeIdentifier') }})  
