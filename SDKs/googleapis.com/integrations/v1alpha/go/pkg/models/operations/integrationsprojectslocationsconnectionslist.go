...
type IntegrationsProjectsLocationsConnectionsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type IntegrationsProjectsLocationsConnectionsListPathParams struct {
	// Required. Parent resource of the Connection, of the form: `projects/*/locations/*`
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type IntegrationsProjectsLocationsConnectionsListQueryParams struct {
	// V1 error format.
...
type IntegrationsProjectsLocationsConnectionsListRequest struct {
...
type IntegrationsProjectsLocationsConnectionsListResponse struct {
	ContentType string
	// Successful response
