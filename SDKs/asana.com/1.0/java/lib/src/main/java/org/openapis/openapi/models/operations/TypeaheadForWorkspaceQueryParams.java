...
public class TypeaheadForWorkspaceQueryParams {
    ...
    public TypeaheadForWorkspaceQueryParams withResourceType(TypeaheadForWorkspaceResourceTypeEnum resourceType) {
    ...
    public TypeaheadForWorkspaceQueryParams withType(TypeaheadForWorkspaceTypeEnum type) {
        this.type = type;
        return this;
    }
