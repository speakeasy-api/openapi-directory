...
class PeopleContactGroupsMembersModifyRequest:
    ...
    r"""Required. The resource name of the contact group to modify."""  
    ...
    modify_contact_group_members_request: Optional[shared_modifycontactgroupmembersrequest.ModifyContactGroupMembersRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
