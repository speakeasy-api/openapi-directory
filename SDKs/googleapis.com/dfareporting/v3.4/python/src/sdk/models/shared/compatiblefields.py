...
class CompatibleFields:
    ...
    path_attribution_report_compatible_fields: Optional[shared_pathreportcompatiblefields.PathReportCompatibleFields] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pathAttributionReportCompatibleFields') }})
    path_report_compatible_fields: Optional[shared_pathreportcompatiblefields.PathReportCompatibleFields] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pathReportCompatibleFields') }})
