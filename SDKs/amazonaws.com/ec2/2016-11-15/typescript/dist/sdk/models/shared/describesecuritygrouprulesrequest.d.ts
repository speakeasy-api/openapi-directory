 ...
 */
export declare class DescribeSecurityGroupRulesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeSecurityGroupRulesRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeSecurityGroupRulesRequestFilters[];
    maxResults?: number;
    nextToken?: string;
