...
import dataclasses
from ..shared import googlecloudretailv2alphapriceinfopricerange as shared_googlecloudretailv2alphapriceinfopricerange
...
class GoogleCloudRetailV2alphaPriceInfo:
    ...
    price_range: Optional[shared_googlecloudretailv2alphapriceinfopricerange.GoogleCloudRetailV2alphaPriceInfoPriceRange] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('priceRange'), 'exclude': lambda f: f is None }})
