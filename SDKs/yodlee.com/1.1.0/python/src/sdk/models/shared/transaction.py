...
class TransactionContainerEnum(str, Enum):
    BANK = "bank"
...
class TransactionBaseTypeEnum(str, Enum):
    CREDIT = "CREDIT"
    DEBIT = "DEBIT"

class TransactionCategorySourceEnum(str, Enum):
    SYSTEM = "SYSTEM"
    USER = "USER"

class TransactionCategoryTypeEnum(str, Enum):
    TRANSFER = "TRANSFER"
...
class Transaction:
    container: Optional[TransactionContainerEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CONTAINER') }})
    ...
    base_type: Optional[TransactionBaseTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('baseType') }})
    ...
    category_source: Optional[TransactionCategorySourceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('categorySource') }})
    category_type: Optional[TransactionCategoryTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('categoryType') }})
    ...
    source_type: Optional[TransactionSourceTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sourceType') }})
    status: Optional[TransactionStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
    sub_type: Optional[TransactionSubTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('subType') }})
