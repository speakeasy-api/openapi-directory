 ...
 */
export enum HealthCheckServicesListWarningCodeEnum {
...
export class HealthCheckServicesListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class HealthCheckServicesListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: HealthCheckServicesListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class HealthCheckServicesList extends SpeakeasyBase {
  /**
