...
public class ComputeNodeGetRemoteDesktopHeaders {
    ...
    public ComputeNodeGetRemoteDesktopHeaders withOcpDate(String ocpDate) {
    ...
    public ComputeNodeGetRemoteDesktopHeaders withReturnClientRequestId(Boolean returnClientRequestId) {
