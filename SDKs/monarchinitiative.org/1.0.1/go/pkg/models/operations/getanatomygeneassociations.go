...
type GetAnatomyGeneAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetAnatomyGeneAssociationsQueryParams struct {
