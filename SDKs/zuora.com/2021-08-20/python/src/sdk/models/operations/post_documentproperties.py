...
class POSTDocumentPropertiesRequest:
    ...
    post_document_properties_type: shared_postdocumentpropertiestype.POSTDocumentPropertiesType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
