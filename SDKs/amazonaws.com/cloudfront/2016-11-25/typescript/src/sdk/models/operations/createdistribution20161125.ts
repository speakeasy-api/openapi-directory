 ...
 */
export class CreateDistribution20161125RequestBodyDistributionConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateDistribution20161125RequestBody extends SpeakeasyBase {
  /**
   * A distribution configuration.
   */
  @SpeakeasyMetadata()
...
export class CreateDistribution20161125Request extends SpeakeasyBase {
...
export class CreateDistribution20161125Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
