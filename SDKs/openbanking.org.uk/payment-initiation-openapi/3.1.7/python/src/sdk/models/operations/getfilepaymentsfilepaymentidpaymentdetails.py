...
class GetFilePaymentsFilePaymentIDPaymentDetailsPathParams:
    file_payment_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'FilePaymentId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetFilePaymentsFilePaymentIDPaymentDetailsHeaders:
...
@dataclasses.dataclass
class GetFilePaymentsFilePaymentIDPaymentDetailsSecurity:
    tppo_auth2_security: shared_security.SchemeTppoAuth2Security = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class GetFilePaymentsFilePaymentIDPaymentDetailsRequest:
    headers: GetFilePaymentsFilePaymentIDPaymentDetailsHeaders = dataclasses.field()
    path_params: GetFilePaymentsFilePaymentIDPaymentDetailsPathParams = dataclasses.field()
    security: GetFilePaymentsFilePaymentIDPaymentDetailsSecurity = dataclasses.field()
    

@dataclasses.dataclass
class GetFilePaymentsFilePaymentIDPaymentDetailsResponse:
