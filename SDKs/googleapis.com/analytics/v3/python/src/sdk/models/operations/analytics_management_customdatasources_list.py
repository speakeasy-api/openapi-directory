...
class AnalyticsManagementCustomDataSourcesListPathParams:
...
@dataclasses.dataclass
class AnalyticsManagementCustomDataSourcesListQueryParams:
...
class AnalyticsManagementCustomDataSourcesListRequest:
    path_params: AnalyticsManagementCustomDataSourcesListPathParams = dataclasses.field()
    query_params: AnalyticsManagementCustomDataSourcesListQueryParams = dataclasses.field()
    security: AnalyticsManagementCustomDataSourcesListSecurity = dataclasses.field()
