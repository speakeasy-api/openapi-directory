...
// set.
func (s *V1beta1) ServicebrokerGetIamPolicy(ctx context.Context, request operations.ServicebrokerGetIamPolicyRequest) (*operations.ServicebrokerGetIamPolicyResponse, error) {
...
func (s *V1beta1) ServicebrokerSetIamPolicy(ctx context.Context, request operations.ServicebrokerSetIamPolicyRequest) (*operations.ServicebrokerSetIamPolicyResponse, error) {
	baseURL := s._serverURL
...
func (s *V1beta1) ServicebrokerTestIamPermissions(ctx context.Context, request operations.ServicebrokerTestIamPermissionsRequest) (*operations.ServicebrokerTestIamPermissionsResponse, error) {
	baseURL := s._serverURL
