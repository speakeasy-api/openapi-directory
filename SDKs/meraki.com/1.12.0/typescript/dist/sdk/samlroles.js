...
exports.SamlRoles = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var SamlRoles = /** @class */ (function () {
    function SamlRoles(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Create a SAML role
    **/
    SamlRoles.prototype.createOrganizationSamlRole = function (req, config) {
        var _a;
     ...
     * Remove a SAML role
    **/
    SamlRoles.prototype.deleteOrganizationSamlRole = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Return a SAML role
    **/
    SamlRoles.prototype.getOrganizationSamlRole = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SamlRoles.prototype.getOrganizationSamlRoles = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update a SAML role
    **/
    SamlRoles.prototype.updateOrganizationSamlRole = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
