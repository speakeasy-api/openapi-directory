...
func (e GetNetworkWirelessSettings200ApplicationJSONUpgradeStrategyEnum) ToPointer() *GetNetworkWirelessSettings200ApplicationJSONUpgradeStrategyEnum {
	return &e
}
...
func (e *GetNetworkWirelessSettings200ApplicationJSONUpgradeStrategyEnum) UnmarshalJSON(data []byte) error {
	...
	case "minimizeUpgradeTime":
		*e = GetNetworkWirelessSettings200ApplicationJSONUpgradeStrategyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessSettings200ApplicationJSONUpgradeStrategyEnum: %v", v)
	}
}
