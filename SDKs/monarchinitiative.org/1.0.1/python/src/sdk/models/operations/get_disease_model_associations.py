...
class GetDiseaseModelAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetDiseaseModelAssociationsQueryParams:
...
class GetDiseaseModelAssociationsRequest:
    path_params: GetDiseaseModelAssociationsPathParams = dataclasses.field()
    query_params: GetDiseaseModelAssociationsQueryParams = dataclasses.field()
