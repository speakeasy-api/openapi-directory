...
from ..shared import ticket as shared_ticket
...
from ..shared import updateticketresponse as shared_updateticketresponse
from typing import Optional


@dataclasses.dataclass
class CollectionTicketsUpdateSecurity:
...
class CollectionTicketsUpdateRequest:
    ...
    ticket_input: shared_ticket.TicketInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class CollectionTicketsUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_ticket_response: Optional[shared_updateticketresponse.UpdateTicketResponse] = dataclasses.field(default=None)
    r"""Update a Ticket"""  
