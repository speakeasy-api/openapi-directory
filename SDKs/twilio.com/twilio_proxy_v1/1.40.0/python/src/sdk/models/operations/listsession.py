...
class ListSessionRequest:
    ...
    r"""The SID of the parent [Service](https://www.twilio.com/docs/proxy/api/service) of the resource to read."""  
...
class ListSessionListSessionResponse:
    ...
    meta: Optional[ListSessionListSessionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    sessions: Optional[list[shared_proxy_v1_service_session.ProxyV1ServiceSession]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sessions'), 'exclude': lambda f: f is None }})  
