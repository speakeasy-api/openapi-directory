 ...
 */
export enum GetDirectDebitsForMandateUuidDirectDebitsDirectDebitCurrencyCodeEnum {
  Eur = "EUR",
  Gbp = "GBP",
}
 ...
 * The currency.
 */
export class GetDirectDebitsForMandateUuidDirectDebitsDirectDebitCurrency extends SpeakeasyBase {
  /**
   * The three letter code for the currency - either `EUR` or `GBP`.
   */
  @SpeakeasyMetadata()
...
export class GetDirectDebitsForMandateUuidDirectDebitsDirectDebit extends SpeakeasyBase {
  ...
  @Type(() => GetDirectDebitsForMandateUuidDirectDebitsDirectDebitCurrency)
...
export class GetDirectDebitsForMandateUuidDirectDebits extends SpeakeasyBase {
  ...
  @Expose({ name: "directdebits" })
  @Type(() => GetDirectDebitsForMandateUuidDirectDebitsDirectDebit)
