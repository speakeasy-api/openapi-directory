...
class GETDescribeAddressesAttributeRequest:
    ...
    action: GETDescribeAddressesAttributeActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    version: GETDescribeAddressesAttributeVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
    ...
    r"""[EC2-VPC] The allocation IDs."""  
    attribute: Optional[GETDescribeAddressesAttributeAttributeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'Attribute', 'style': 'form', 'explode': True }})
    r"""The attribute of the IP address."""  
