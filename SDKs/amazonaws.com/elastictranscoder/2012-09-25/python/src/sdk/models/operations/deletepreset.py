...
class DeletePresetRequest:
    headers: DeletePresetHeaders = dataclasses.field()
    path_params: DeletePresetPathParams = dataclasses.field()
...
class DeletePresetResponse:
    ...
    delete_preset_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
