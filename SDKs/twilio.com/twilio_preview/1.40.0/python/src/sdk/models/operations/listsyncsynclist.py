...
class ListSyncSyncListListSyncSyncListResponse:
    ...
    lists: Optional[list[shared_preview_sync_service_sync_list.PreviewSyncServiceSyncList]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lists'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListSyncSyncListListSyncSyncListResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
