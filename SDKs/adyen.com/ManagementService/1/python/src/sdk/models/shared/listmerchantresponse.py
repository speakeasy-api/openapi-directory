...
class ListMerchantResponse:
    ...
    data: Optional[list[shared_merchant.Merchant]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""The list of merchant accounts."""  
