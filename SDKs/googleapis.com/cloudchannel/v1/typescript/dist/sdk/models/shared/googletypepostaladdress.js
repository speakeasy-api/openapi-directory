...
exports.GoogleTypePostalAddress = void 0;
...
var GoogleTypePostalAddress = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=addressLines" }),
        __metadata("design:type", Array)
    ], GoogleTypePostalAddress.prototype, "addressLines", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=administrativeArea" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sortingCode" }),
        __metadata("design:type", String)
    ], GoogleTypePostalAddress.prototype, "sortingCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sublocality" }),
        __metadata("design:type", String)
    ], GoogleTypePostalAddress.prototype, "sublocality", void 0);
    return GoogleTypePostalAddress;
}(utils_1.SpeakeasyBase));
exports.GoogleTypePostalAddress = GoogleTypePostalAddress;
