 ...
 */
public enum SchemaResponsePatchSchemaResponsesAttributesReviewsStateEnum {
    INITIAL("initial"),
    ...
    private SchemaResponsePatchSchemaResponsesAttributesReviewsStateEnum(String value) {
        this.value = value;
    }
}
