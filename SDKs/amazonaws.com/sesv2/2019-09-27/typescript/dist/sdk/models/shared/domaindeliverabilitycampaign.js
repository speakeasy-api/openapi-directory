...
var DomainDeliverabilityCampaign = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "DeleteRate" }),
        __metadata("design:type", Number)
    ], DomainDeliverabilityCampaign.prototype, "deleteRate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "Esps" }),
        __metadata("design:type", Array)
    ], DomainDeliverabilityCampaign.prototype, "esps", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "FirstSeenDateTime" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "InboxCount" }),
        __metadata("design:type", Number)
