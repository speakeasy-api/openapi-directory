...
class RemoveTagsFromCertificateRequest:
    ...
    remove_tags_from_certificate_request: shared_removetagsfromcertificaterequest.RemoveTagsFromCertificateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
