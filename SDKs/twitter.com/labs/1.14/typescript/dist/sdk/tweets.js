...
var Tweets = /** @class */ (function () {
    function Tweets(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Tweets.prototype.addOrDeleteRules = function (req, config) {
        var _a;
    ...
    **/
    Tweets.prototype.findPrivateTweetMetricsById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Tweets.prototype.getRules = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Tweets.prototype.streamFilter = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Tweets.prototype.streamSample = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
