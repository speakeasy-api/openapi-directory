...
var Authentication = /** @class */ (function () {
    ...
    **/
    Authentication.prototype.requestAccessToken = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RequestAccessTokenRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/keys/{keyName}/requestToken", req.pathParams);
            ...
            switch (true) {
                case ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) >= 200 && (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) < 300):
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.tokenDetails = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
