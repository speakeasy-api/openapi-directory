...
class GetLoggerDefinitionVersionResponse:
    ...
    definition: Optional[shared_loggerdefinitionversion.LoggerDefinitionVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Definition'), 'exclude': lambda f: f is None }})  
