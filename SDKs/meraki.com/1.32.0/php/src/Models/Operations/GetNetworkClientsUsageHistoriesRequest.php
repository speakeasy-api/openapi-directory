...
class GetNetworkClientsUsageHistoriesRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNetworkClientsUsageHistoriesSsidNumberEnum $ssidNumber
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=ssidNumber')]
    public ?GetNetworkClientsUsageHistoriesSsidNumberEnum $ssidNumber = null;
