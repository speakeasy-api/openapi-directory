...
class TargetVpnGateways 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeTargetVpnGatewaysTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeTargetVpnGatewaysTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeTargetVpnGatewaysTestIamPermissionsResponse
     */
	public function computeTargetVpnGatewaysTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeTargetVpnGatewaysTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeTargetVpnGatewaysTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeTargetVpnGatewaysTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/regions/{region}/targetVpnGateways/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeTargetVpnGatewaysTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeTargetVpnGatewaysTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeTargetVpnGatewaysTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
