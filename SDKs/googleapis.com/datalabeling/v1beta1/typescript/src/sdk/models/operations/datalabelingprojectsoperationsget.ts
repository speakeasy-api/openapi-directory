...
export class DatalabelingProjectsOperationsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatalabelingProjectsOperationsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatalabelingProjectsOperationsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
