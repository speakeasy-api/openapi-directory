...
class WritablePowerPortConnectionStatusEnum(str, Enum):
    FALSE = 'false'
    TRUE = 'true'
...
class WritablePowerPortInput:
    ...
    connection_status: Optional[WritablePowerPortConnectionStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connection_status'), 'exclude': lambda f: f is None }})  
    ...
    type: Optional[WritablePowerPortTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Physical port type"""  
