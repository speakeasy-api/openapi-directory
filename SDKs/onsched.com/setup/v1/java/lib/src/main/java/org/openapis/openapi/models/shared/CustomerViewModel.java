...
public class CustomerViewModel {
    ...
    public CustomerViewModel withAddress(AddressViewModel address) {
    ...
    public CustomerViewModel withContact(ContactViewModel contact) {
    ...
    public CustomerViewModel withCustomFields(java.util.Map<String, CustomFieldViewModel> customFields) {
    ...
    public CustomerViewModel withObject(String object) {
        this.object = object;
        return this;
    }
