...
class DcimRacksListQueryParams:
    ...
    facility_id_ic: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'facility_id__ic', 'style': 'form', 'explode': True }})
    facility_id_ie: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'facility_id__ie', 'style': 'form', 'explode': True }})
    facility_id_iew: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'facility_id__iew', 'style': 'form', 'explode': True }})
    facility_id_isw: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'facility_id__isw', 'style': 'form', 'explode': True }})
    facility_id_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'facility_id__n', 'style': 'form', 'explode': True }})
    facility_id_nic: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'facility_id__nic', 'style': 'form', 'explode': True }})
    facility_id_nie: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'facility_id__nie', 'style': 'form', 'explode': True }})
    facility_id_niew: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'facility_id__niew', 'style': 'form', 'explode': True }})
    facility_id_nisw: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'facility_id__nisw', 'style': 'form', 'explode': True }})
    ...
    outer_depth: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_depth', 'style': 'form', 'explode': True }})
    outer_depth_gt: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_depth__gt', 'style': 'form', 'explode': True }})
    outer_depth_gte: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_depth__gte', 'style': 'form', 'explode': True }})
    outer_depth_lt: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_depth__lt', 'style': 'form', 'explode': True }})
    outer_depth_lte: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_depth__lte', 'style': 'form', 'explode': True }})
    outer_depth_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_depth__n', 'style': 'form', 'explode': True }})
    outer_unit: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_unit', 'style': 'form', 'explode': True }})
    outer_unit_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_unit__n', 'style': 'form', 'explode': True }})
    outer_width: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_width', 'style': 'form', 'explode': True }})
    outer_width_gt: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_width__gt', 'style': 'form', 'explode': True }})
    outer_width_gte: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_width__gte', 'style': 'form', 'explode': True }})
    outer_width_lt: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_width__lt', 'style': 'form', 'explode': True }})
    outer_width_lte: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_width__lte', 'style': 'form', 'explode': True }})
    outer_width_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outer_width__n', 'style': 'form', 'explode': True }})
    ...
    width_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'width__n', 'style': 'form', 'explode': True }})
