...
export class GetGeneOrthologDiseaseAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGeneOrthologDiseaseAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGeneOrthologDiseaseAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGeneOrthologDiseaseAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
