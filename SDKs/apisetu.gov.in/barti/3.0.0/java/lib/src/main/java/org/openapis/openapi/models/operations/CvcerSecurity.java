...
public class CvcerSecurity {
    ...
    public CvcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public CvcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public CvcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
