...
export class ConnectorsProjectsLocationsConnectionsRuntimeEntitySchemasListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ConnectorsProjectsLocationsConnectionsRuntimeEntitySchemasListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ConnectorsProjectsLocationsConnectionsRuntimeEntitySchemasListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
