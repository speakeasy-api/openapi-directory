...
@dataclasses.dataclass
class DNSManagedZonesUpdateQueryParams:
...
@dataclasses.dataclass
class DNSManagedZonesUpdateSecurity:
    option1: Optional[DNSManagedZonesUpdateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSManagedZonesUpdateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DNSManagedZonesUpdateRequest:
    path_params: DNSManagedZonesUpdatePathParams = dataclasses.field()
    query_params: DNSManagedZonesUpdateQueryParams = dataclasses.field()
    security: DNSManagedZonesUpdateSecurity = dataclasses.field()
