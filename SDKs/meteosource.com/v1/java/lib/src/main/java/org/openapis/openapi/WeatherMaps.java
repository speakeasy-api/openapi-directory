...
public class WeatherMaps {
     ...
     */
    public org.openapis.openapi.models.operations.MapMapGetResponse mapMapGet(org.openapis.openapi.models.operations.MapMapGetRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.MapMapGetQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
