...
exports.PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsResponse = exports.PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsRequest = exports.PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsSecurity = void 0;
...
var PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsRequest = /** @class */ (function (_super) {
    ...
    ], PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=commit",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsRequest.prototype, "commit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsRequest.prototype, "workspace", void 0);
...
var PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsResponse.prototype, "rawResponse", void 0);
