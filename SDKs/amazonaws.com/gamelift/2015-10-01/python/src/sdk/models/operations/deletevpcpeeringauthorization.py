...
class DeleteVpcPeeringAuthorizationRequest:
    ...
    delete_vpc_peering_authorization_input: shared_deletevpcpeeringauthorizationinput.DeleteVpcPeeringAuthorizationInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
