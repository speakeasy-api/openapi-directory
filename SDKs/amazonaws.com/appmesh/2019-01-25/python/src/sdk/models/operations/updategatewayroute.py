...
from ..shared import updategatewayrouteoutput as shared_updategatewayrouteoutput
...
class UpdateGatewayRouteRequestBody:
    spec: UpdateGatewayRouteRequestBodySpec = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('spec') }})
    client_token: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('clientToken') }})
    

@dataclasses.dataclass
class UpdateGatewayRouteRequest:
    headers: UpdateGatewayRouteHeaders = dataclasses.field()
    path_params: UpdateGatewayRoutePathParams = dataclasses.field()
    query_params: UpdateGatewayRouteQueryParams = dataclasses.field()
    request: UpdateGatewayRouteRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateGatewayRouteResponse:
    ...
    update_gateway_route_output: Optional[shared_updategatewayrouteoutput.UpdateGatewayRouteOutput] = dataclasses.field(default=None)
