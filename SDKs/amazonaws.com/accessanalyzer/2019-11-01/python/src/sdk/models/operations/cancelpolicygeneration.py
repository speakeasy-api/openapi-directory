...
class CancelPolicyGenerationRequest:
    headers: CancelPolicyGenerationHeaders = dataclasses.field()
    path_params: CancelPolicyGenerationPathParams = dataclasses.field()
...
class CancelPolicyGenerationResponse:
    ...
    cancel_policy_generation_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
