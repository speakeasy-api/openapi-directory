 ...
 * An enumeration.
 */
export enum LatestV1GetV1LatestLocationIdGetOrderByLocationsOrderEnum {
  City = "city",
  Country = "country",
  Location = "location",
 ...
 * An enumeration.
 */
export enum LatestV1GetV1LatestLocationIdGetSortSortEnum {
  Asc = "asc",
  Desc = "desc",
}
...
export class LatestV1GetV1LatestLocationIdGetRequest extends SpeakeasyBase {
  ...
  orderBy?: LatestV1GetV1LatestLocationIdGetOrderByLocationsOrderEnum;
  ...
  sort?: LatestV1GetV1LatestLocationIdGetSortSortEnum;
