...
var ChannelCatalog = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "categoryMappingSettings" }),
        (0, class_transformer_1.Type)(function () { return channelcatalogcategorymappingsettings_1.ChannelCatalogCategoryMappingSettings; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "channelCatalogId" }),
        __metadata("design:type", String)
    ], ChannelCatalog.prototype, "channelCatalogId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "channelCategorySettings" }),
        (0, class_transformer_1.Type)(function () { return channelcategorysettings_1.ChannelCategorySettings; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "channelCostSettings" }),
        (0, class_transformer_1.Type)(function () { return channelcostsettings_1.ChannelCostSettings; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: channelcatalogcolumnmappingwithname_1.ChannelCatalogColumnMappingWithName }),
        (0, class_transformer_1.Expose)({ name: "columnMappings" }),
        (0, class_transformer_1.Type)(function () { return channelcatalogcolumnmappingwithname_1.ChannelCatalogColumnMappingWithName; }),
        __metadata("design:type", Array)
    ], ChannelCatalog.prototype, "columnMappings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "costSettings" }),
        (0, class_transformer_1.Type)(function () { return costsettings_1.CostSettings; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: exclusionfilter_1.ExclusionFilter }),
        (0, class_transformer_1.Expose)({ name: "exclusionFilters" }),
        (0, class_transformer_1.Type)(function () { return exclusionfilter_1.ExclusionFilter; }),
        __metadata("design:type", Array)
    ], ChannelCatalog.prototype, "exclusionFilters", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "exportUrl" }),
        __metadata("design:type", String)
    ], ChannelCatalog.prototype, "exportUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "generalSettings" }),
        (0, class_transformer_1.Type)(function () { return generalsettings_1.GeneralSettings; }),
        __metadata("design:type", generalsettings_1.GeneralSettings)
    ], ChannelCatalog.prototype, "generalSettings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "isMarketplace" }),
        __metadata("design:type", Boolean)
    ], ChannelCatalog.prototype, "isMarketplace", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "links" }),
        (0, class_transformer_1.Type)(function () { return channelcataloglinks_1.ChannelCatalogLinks; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return channelcatalogstate_1.ChannelCatalogState; }),
