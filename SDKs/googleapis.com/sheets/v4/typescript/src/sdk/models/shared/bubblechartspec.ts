...
export class BubbleChartSpec extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "bubbleBorderColorStyle" })
  @Type(() => ColorStyle)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "bubbleMaxRadiusSize" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "bubbleMinRadiusSize" })
