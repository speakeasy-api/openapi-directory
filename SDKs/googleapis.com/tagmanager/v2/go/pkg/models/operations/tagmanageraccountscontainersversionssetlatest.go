...
type TagmanagerAccountsContainersVersionsSetLatestSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type TagmanagerAccountsContainersVersionsSetLatestPathParams struct {
...
type TagmanagerAccountsContainersVersionsSetLatestQueryParams struct {
	// V1 error format.
...
type TagmanagerAccountsContainersVersionsSetLatestRequest struct {
...
type TagmanagerAccountsContainersVersionsSetLatestResponse struct {
	// Successful response
