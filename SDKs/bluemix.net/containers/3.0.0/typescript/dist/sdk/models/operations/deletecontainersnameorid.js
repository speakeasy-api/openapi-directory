...
exports.DeleteContainersNameOrIdResponse = exports.DeleteContainersNameOrIdRequest = void 0;
...
var DeleteContainersNameOrIdRequest = /** @class */ (function (_super) {
    ...
    ], DeleteContainersNameOrIdRequest.prototype, "xAuthProjectId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Auth-Token",
        }),
        __metadata("design:type", String)
    ], DeleteContainersNameOrIdRequest.prototype, "xAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=force" }),
        __metadata("design:type", Boolean)
    ], DeleteContainersNameOrIdRequest.prototype, "force", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=name_or_id",
        }),
        __metadata("design:type", String)
    ], DeleteContainersNameOrIdRequest.prototype, "nameOrId", void 0);
...
var DeleteContainersNameOrIdResponse = /** @class */ (function (_super) {
    ...
    ], DeleteContainersNameOrIdResponse.prototype, "rawResponse", void 0);
