...
func (e UpdateAnomalyMonitorXAmzTargetEnum) ToPointer() *UpdateAnomalyMonitorXAmzTargetEnum {
	return &e
}
...
func (e *UpdateAnomalyMonitorXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSInsightsIndexService.UpdateAnomalyMonitor":
		*e = UpdateAnomalyMonitorXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateAnomalyMonitorXAmzTargetEnum: %v", v)
	}
}
