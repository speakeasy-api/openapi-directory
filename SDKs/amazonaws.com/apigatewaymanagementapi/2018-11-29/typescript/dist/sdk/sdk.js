...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.deleteConnection = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/@connections/{connectionId}", req.pathParams);
            ...
            switch (true) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 480:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.goneException = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    SDK.prototype.postToConnection = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
