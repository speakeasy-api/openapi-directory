...
from ..shared import globalrequestresult as shared_globalrequestresult
...
class GetRealmClientsIDTestNodesAvailableResponse:
    ...
    global_request_result: Optional[shared_globalrequestresult.GlobalRequestResult] = dataclasses.field(default=None)
    r"""success"""  
