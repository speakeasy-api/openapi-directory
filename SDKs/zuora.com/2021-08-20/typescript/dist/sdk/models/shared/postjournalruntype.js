...
var POSTJournalRunType = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: postjournalruntransactiontype_1.POSTJournalRunTransactionType }),
        (0, class_transformer_1.Expose)({ name: "transactionTypes" }),
        (0, class_transformer_1.Type)(function () { return postjournalruntransactiontype_1.POSTJournalRunTransactionType; }),
