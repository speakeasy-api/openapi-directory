...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/hpbose/3.0.0/python
```
...
res = s.ap_is.hvcer(req, operations.HvcerSecurity(
