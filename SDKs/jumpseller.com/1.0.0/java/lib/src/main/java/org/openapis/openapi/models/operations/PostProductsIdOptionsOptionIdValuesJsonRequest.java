...
public class PostProductsIdOptionsOptionIdValuesJsonRequest {
    ...
    public PostProductsIdOptionsOptionIdValuesJsonRequest(@JsonProperty("ProductOptionValueEdit") org.openapis.openapi.models.shared.ProductOptionValueEdit productOptionValueEdit, @JsonProperty("authtoken") String authtoken, @JsonProperty("id") Integer id, @JsonProperty("login") String login, @JsonProperty("option_id") Integer optionId) {
        this.productOptionValueEdit = productOptionValueEdit;
        this.authtoken = authtoken;
        this.id = id;
        this.login = login;
