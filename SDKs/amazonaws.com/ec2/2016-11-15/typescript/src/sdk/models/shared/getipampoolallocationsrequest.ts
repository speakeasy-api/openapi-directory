 ...
 */
export class GetIpamPoolAllocationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class GetIpamPoolAllocationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: GetIpamPoolAllocationsRequestFilters })
