...
public class ServicenetworkingServicesDnsRecordSetsUpdatePathParams {
    /**
    ...
    public ServicenetworkingServicesDnsRecordSetsUpdatePathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
