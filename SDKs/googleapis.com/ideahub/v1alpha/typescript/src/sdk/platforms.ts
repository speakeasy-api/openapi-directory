      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleSearchIdeahubV1alphaIdeaActivity = utils.objectToClass(
              httpRes?.data,
              shared.GoogleSearchIdeahubV1alphaIdeaActivity
            );
          }
          break;
      }
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleSearchIdeahubV1alphaListAvailableLocalesResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleSearchIdeahubV1alphaListAvailableLocalesResponse
              );
          }
          break;
      }
  ...
  ideahubPlatformsPropertiesTopicStatesPatch(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleSearchIdeahubV1alphaTopicState = utils.objectToClass(
              httpRes?.data,
              shared.GoogleSearchIdeahubV1alphaTopicState
            );
          }
          break;
      }
