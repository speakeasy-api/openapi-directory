...
type DialogflowProjectsLocationsAgentEntityTypesEntitiesBatchDeleteRequest struct {
	...
	GoogleCloudDialogflowV2beta1BatchDeleteEntitiesRequest *shared.GoogleCloudDialogflowV2beta1BatchDeleteEntitiesRequest `request:"mediaType=application/json"`
	// OAuth access token.
