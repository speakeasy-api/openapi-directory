...
class GetUsersIdsQuestionsUnansweredQueryParams:
    ...
    order: Optional[GetUsersIdsQuestionsUnansweredOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetUsersIdsQuestionsUnansweredSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetUsersIdsQuestionsUnansweredRequest:
    path_params: GetUsersIdsQuestionsUnansweredPathParams = dataclasses.field()
    query_params: GetUsersIdsQuestionsUnansweredQueryParams = dataclasses.field()
