...
class BooksLayersAnnotationDataListRequest:
    path_params: BooksLayersAnnotationDataListPathParams = dataclasses.field()
    query_params: BooksLayersAnnotationDataListQueryParams = dataclasses.field()
    security: BooksLayersAnnotationDataListSecurity = dataclasses.field()
