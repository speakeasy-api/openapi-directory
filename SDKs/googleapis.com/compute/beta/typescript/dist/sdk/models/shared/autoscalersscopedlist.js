...
exports.AutoscalersScopedList = exports.AutoscalersScopedListWarning = exports.AutoscalersScopedListWarningData = exports.AutoscalersScopedListWarningCodeEnum = void 0;
 ...
 */
var AutoscalersScopedListWarningCodeEnum;
(function (AutoscalersScopedListWarningCodeEnum) {
...
})(AutoscalersScopedListWarningCodeEnum = exports.AutoscalersScopedListWarningCodeEnum || (exports.AutoscalersScopedListWarningCodeEnum = {}));
var AutoscalersScopedListWarningData = /** @class */ (function (_super) {
    __extends(AutoscalersScopedListWarningData, _super);
    function AutoscalersScopedListWarningData() {
    ...
    ], AutoscalersScopedListWarningData.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "value" }),
        __metadata("design:type", String)
    ], AutoscalersScopedListWarningData.prototype, "value", void 0);
    return AutoscalersScopedListWarningData;
}(utils_1.SpeakeasyBase));
exports.AutoscalersScopedListWarningData = AutoscalersScopedListWarningData;
/**
 * [Output Only] Informational warning which replaces the list of autoscalers when the list is empty.
 */
var AutoscalersScopedListWarning = /** @class */ (function (_super) {
    __extends(AutoscalersScopedListWarning, _super);
    function AutoscalersScopedListWarning() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", String)
    ], AutoscalersScopedListWarning.prototype, "code", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: AutoscalersScopedListWarningData }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return AutoscalersScopedListWarningData; }),
        __metadata("design:type", Array)
    ], AutoscalersScopedListWarning.prototype, "data", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "message" }),
        __metadata("design:type", String)
    ], AutoscalersScopedListWarning.prototype, "message", void 0);
    return AutoscalersScopedListWarning;
}(utils_1.SpeakeasyBase));
exports.AutoscalersScopedListWarning = AutoscalersScopedListWarning;
var AutoscalersScopedList = /** @class */ (function (_super) {
    __extends(AutoscalersScopedList, _super);
    function AutoscalersScopedList() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: autoscaler_1.Autoscaler }),
        (0, class_transformer_1.Expose)({ name: "autoscalers" }),
        (0, class_transformer_1.Type)(function () { return autoscaler_1.Autoscaler; }),
        __metadata("design:type", Array)
    ], AutoscalersScopedList.prototype, "autoscalers", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "warning" }),
        (0, class_transformer_1.Type)(function () { return AutoscalersScopedListWarning; }),
        __metadata("design:type", AutoscalersScopedListWarning)
    ], AutoscalersScopedList.prototype, "warning", void 0);
    return AutoscalersScopedList;
}(utils_1.SpeakeasyBase));
exports.AutoscalersScopedList = AutoscalersScopedList;
