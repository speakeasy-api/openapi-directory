...
public class BusinessLines {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.PatchBusinessLinesIdResponse patchBusinessLinesId(org.openapis.openapi.models.operations.PatchBusinessLinesIdRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.PatchBusinessLinesIdPathParams.class, baseUrl, "/businessLines/{id}", request.pathParams, null);
