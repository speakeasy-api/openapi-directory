 ...
 */
export declare enum CreateManagedPrefixListRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateManagedPrefixListRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateManagedPrefixListRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateManagedPrefixListRequest extends SpeakeasyBase {
