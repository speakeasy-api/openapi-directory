...
type ContentPosSaleSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentPosSalePathParams struct {
...
type ContentPosSaleQueryParams struct {
	// V1 error format.
...
type ContentPosSaleRequest struct {
	PathParams  ContentPosSalePathParams
	QueryParams ContentPosSaleQueryParams
	Request     *shared.PosSaleRequest `request:"mediaType=application/json"`
	Security    ContentPosSaleSecurity
}

type ContentPosSaleResponse struct {
	ContentType string
	// Successful response
