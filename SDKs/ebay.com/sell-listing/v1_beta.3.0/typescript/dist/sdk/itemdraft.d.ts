...
export declare class ItemDraft {
     ...
     */
    createItemDraft(req: operations.CreateItemDraftRequest, security: operations.CreateItemDraftSecurity, config?: AxiosRequestConfig): Promise<operations.CreateItemDraftResponse>;
}
