...
export class MerchantsAllSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MerchantsAllRequest extends SpeakeasyBase {
  /**
...
export class MerchantsAllResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
