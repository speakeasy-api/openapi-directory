...
var ClientProfileNpsAverage = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "completed_surveys_count" }),
...
var ClientProfileNps = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ClientProfileNpsAverage; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ClientProfileNpsLast; }),
...
var ClientProfile = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "account_creation_date" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "client_project_count" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "corporate_user_count" }),
        __metadata("design:type", Number)
    ], ClientProfile.prototype, "corporateUserCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "frequent_file_extension" }),
        __metadata("design:type", String)
    ], ClientProfile.prototype, "frequentFileExtension", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "frequent_language_pairs" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "growth" }),
        __metadata("design:type", Boolean)
    ], ClientProfile.prototype, "growth", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "is_complex" }),
        __metadata("design:type", Boolean)
    ], ClientProfile.prototype, "isComplex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "last_12_months_spending" }),
        __metadata("design:type", Number)
    ], ClientProfile.prototype, "last12MonthsSpending", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "last_project" }),
        __metadata("design:type", Number)
    ], ClientProfile.prototype, "lastProject", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "last_project_time" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: proofreaderwithlanguage_1.ProofreaderWithLanguage }),
        (0, class_transformer_1.Expose)({ name: "last_proofreaders" }),
        (0, class_transformer_1.Type)(function () { return proofreaderwithlanguage_1.ProofreaderWithLanguage; }),
        __metadata("design:type", Array)
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ClientProfileNps; }),
        __metadata("design:type", ClientProfileNps)
    ], ClientProfile.prototype, "nps", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "user_rank_in_project_count" }),
        __metadata("design:type", Number)
    ], ClientProfile.prototype, "userRankInProjectCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "user_rank_in_spending" }),
        __metadata("design:type", Number)
