...
type SearchTypePointOceanCsvSadoTTSQueryParams struct {
...
type SearchTypePointOceanCsvSadoTTSRequest struct {
	QueryParams SearchTypePointOceanCsvSadoTTSQueryParams
}

type SearchTypePointOceanCsvSadoTTSResponse struct {
	ContentType string
	StatusCode  int
