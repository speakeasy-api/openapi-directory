...
class PostExportRequest:
    ...
    combined: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'combined', 'style': 'form', 'explode': True }})
    r"""Included a combined file with all contribution text."""  
    ...
    r"""Media format to export; none, fullsize, tagged or original."""  
    ...
    individual: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'individual', 'style': 'form', 'explode': True }})
    r"""Include individual text files for each contribution."""  
    json: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'json', 'style': 'form', 'explode': True }})
    r"""Include raw JSON for each contribution."""  
    ...
    tagged: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'tagged', 'style': 'form', 'explode': True }})
    r"""Should exported media files be tagged with metadata. Deprecated; use format instead."""  
