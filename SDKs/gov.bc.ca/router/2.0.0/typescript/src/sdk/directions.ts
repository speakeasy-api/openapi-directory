...
export class Directions {
  ...
  getDirectionsOutputFormat(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetDirectionsOutputFormatResponse =
        new operations.GetDirectionsOutputFormatResponse({
  ...
  getOptimalDirectionsOutputFormat(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetOptimalDirectionsOutputFormatResponse =
        new operations.GetOptimalDirectionsOutputFormatResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getTruckDirectionsOutputFormat(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetTruckDirectionsOutputFormatResponse =
        new operations.GetTruckDirectionsOutputFormatResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getTruckOptimalDirectionsOutputFormat(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetTruckOptimalDirectionsOutputFormatResponse =
        new operations.GetTruckOptimalDirectionsOutputFormatResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postDirectionsOutputFormat(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostDirectionsOutputFormatResponse =
        new operations.PostDirectionsOutputFormatResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postOptimalDirectionsOutputFormat(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostOptimalDirectionsOutputFormatResponse =
        new operations.PostOptimalDirectionsOutputFormatResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postTruckDirectionsOutputFormat(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostTruckDirectionsOutputFormatResponse =
        new operations.PostTruckDirectionsOutputFormatResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postTruckOptimalDirectionsOutputFormat(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostTruckOptimalDirectionsOutputFormatResponse =
        new operations.PostTruckOptimalDirectionsOutputFormatResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
