...
var ListAssessmentRunAgentsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: assessmentrunagent_1.AssessmentRunAgent }),
        (0, class_transformer_1.Expose)({ name: "assessmentRunAgents" }),
        (0, class_transformer_1.Type)(function () { return assessmentrunagent_1.AssessmentRunAgent; }),
