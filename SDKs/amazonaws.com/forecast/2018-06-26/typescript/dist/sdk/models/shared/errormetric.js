...
var ErrorMetric = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "ForecastType" }),
        __metadata("design:type", String)
    ], ErrorMetric.prototype, "forecastType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "MAPE" }),
        __metadata("design:type", Number)
    ], ErrorMetric.prototype, "mape", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "MASE" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "WAPE" }),
        __metadata("design:type", Number)
