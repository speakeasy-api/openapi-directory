...
exports.DeleteRtiTransactionTagResponse = exports.DeleteRtiTransactionTagRequest = void 0;
...
var DeleteRtiTransactionTagRequest = /** @class */ (function (_super) {
    ...
    ], DeleteRtiTransactionTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeleteRtiTransactionTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeleteRtiTransactionTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RtiTransactionId",
        }),
        __metadata("design:type", String)
    ], DeleteRtiTransactionTagRequest.prototype, "rtiTransactionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], DeleteRtiTransactionTagRequest.prototype, "tagId", void 0);
...
var DeleteRtiTransactionTagResponse = /** @class */ (function (_super) {
    ...
    ], DeleteRtiTransactionTagResponse.prototype, "rawResponse", void 0);
