...
class ListAvailablePhoneNumberCountryRequest:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) requesting the available phone number Country resources."""  
...
class ListAvailablePhoneNumberCountryListAvailablePhoneNumberCountryResponse:
    ...
    countries: Optional[list[shared_api_v2010_account_available_phone_number_country.APIV2010AccountAvailablePhoneNumberCountry]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('countries'), 'exclude': lambda f: f is None }})  
