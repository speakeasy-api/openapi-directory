...
const (
	UntagResourceXAmzTargetEnumNetworkFirewall20201112UntagResource UntagResourceXAmzTargetEnum = "NetworkFirewall_20201112.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "NetworkFirewall_20201112.UntagResource":
