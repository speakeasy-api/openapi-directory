...
from ..shared import sortpipelinesby_enum as shared_sortpipelinesby_enum
...
class ListPipelinesRequest:
    ...
    pipeline_name_prefix: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PipelineNamePrefix'), 'exclude': lambda f: f is None }})  
    sort_by: Optional[shared_sortpipelinesby_enum.SortPipelinesByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
