 ...
 */
public enum MonitoringProjectsTimeSeriesListSecondaryAggregationCrossSeriesReducerEnum {
    ...
    private MonitoringProjectsTimeSeriesListSecondaryAggregationCrossSeriesReducerEnum(String value) {
        this.value = value;
    }
}
