...
/**
 * Key/value pairs to provide settings for this webhook. [These are defined below](https://docs.github.com/enterprise-server@3.8/rest/reference/repos#create-hook-config-params).
 */
...
export declare class ReposUpdateWebhookRequestBody extends SpeakeasyBase {
    ...
    /**
     * Determines what [events](https://docs.github.com/enterprise-server@3.8/webhooks/event-payloads) the hook is triggered for. This replaces the entire array of events.
     */
    events?: string[];
    /**
