...
class InterpolationPointTypeEnum(str, Enum):
    r"""How the value should be interpreted."""
...
class InterpolationPoint:
    ...
    r"""A color value."""  
    type: Optional[InterpolationPointTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""How the value should be interpreted."""  
    value: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value'), 'exclude': lambda f: f is None }})
    r"""The value this interpolation point uses. May be a formula. Unused if type is MIN or MAX."""  
