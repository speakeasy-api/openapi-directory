...
public class ListUsageRecordLastMonthQueryParams {
    ...
    public ListUsageRecordLastMonthQueryParams withCategory(org.openapis.openapi.models.shared.UsageRecordLastMonthEnumCategoryEnum category) {
    ...
    public Long page;
    public ListUsageRecordLastMonthQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListUsageRecordLastMonthQueryParams withPageToken(String pageToken) {
