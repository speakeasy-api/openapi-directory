...
class Namespace:
    ...
    r"""Output only. The timestamp when the namespace was created."""  
    ...
    r"""Output only. A globally unique identifier (in UUID4 format) for this namespace."""  
    update_time: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('updateTime'), 'exclude': lambda f: f is None }})
    r"""Output only. The timestamp when the namespace was last updated."""  
