...
var Files = /** @class */ (function () {
    ...
    **/
    Files.prototype.fileDeleteFromComputeNode = function (req, config) {
    ...
    **/
    Files.prototype.fileDeleteFromTask = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Files.prototype.fileGetFromComputeNode = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Files.prototype.fileGetFromTask = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Files.prototype.fileGetNodeFilePropertiesFromComputeNode = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "head", headers: headers }, requestConfig));
        return r.then(function (httpRes) {
            var _a, _b;
            var contentType = (_b = (_a = httpRes === null || httpRes === void 0 ? void 0 : httpRes.headers) === null || _a === void 0 ? void 0 : _a["content-type"]) !== null && _b !== void 0 ? _b : "";
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
    ...
    **/
    Files.prototype.fileGetNodeFilePropertiesFromTask = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Files.prototype.fileListFromComputeNode = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Files.prototype.fileListFromTask = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
