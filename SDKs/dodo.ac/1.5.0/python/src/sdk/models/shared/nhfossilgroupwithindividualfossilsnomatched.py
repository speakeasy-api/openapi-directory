...
class NHFossilGroupWithIndividualFossilsNoMatchedFossilsColorsEnum(str, Enum):
    AQUA = 'Aqua'
    BEIGE = 'Beige'
    BLACK = 'Black'
    BLUE = 'Blue'
...
class NHFossilGroupWithIndividualFossilsNoMatchedFossils:
    ...
    colors: Optional[list[NHFossilGroupWithIndividualFossilsNoMatchedFossilsColorsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('colors'), 'exclude': lambda f: f is None }})  
...
class NHFossilGroupWithIndividualFossilsNoMatched:
    ...
    fossils: Optional[list[NHFossilGroupWithIndividualFossilsNoMatchedFossils]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fossils'), 'exclude': lambda f: f is None }})
