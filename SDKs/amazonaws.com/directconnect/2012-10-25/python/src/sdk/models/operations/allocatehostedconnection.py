...
class AllocateHostedConnectionRequest:
    headers: AllocateHostedConnectionHeaders = dataclasses.field()
    request: shared_allocatehostedconnectionrequest.AllocateHostedConnectionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
