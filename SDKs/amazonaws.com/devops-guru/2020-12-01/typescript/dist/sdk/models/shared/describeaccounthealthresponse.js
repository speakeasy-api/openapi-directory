...
exports.DescribeAccountHealthResponse = void 0;
...
var DescribeAccountHealthResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MetricsAnalyzed" }),
        __metadata("design:type", Number)
    ], DescribeAccountHealthResponse.prototype, "metricsAnalyzed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=OpenProactiveInsights" }),
        __metadata("design:type", Number)
    ], DescribeAccountHealthResponse.prototype, "openProactiveInsights", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=OpenReactiveInsights" }),
        __metadata("design:type", Number)
    ], DescribeAccountHealthResponse.prototype, "openReactiveInsights", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ResourceHours" }),
        __metadata("design:type", Number)
