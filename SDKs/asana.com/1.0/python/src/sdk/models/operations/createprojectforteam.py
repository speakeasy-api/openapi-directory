...
class CreateProjectForTeamRequest:
    ...
    request_body: CreateProjectForTeamRequestBodyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The new project to create."""  
...
class CreateProjectForTeam201ApplicationJSON:
    r"""Successfully created the specified project."""
