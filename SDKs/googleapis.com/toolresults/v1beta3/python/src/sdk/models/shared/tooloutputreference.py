...
class ToolOutputReference:
    ...
    output: Optional[shared_filereference.FileReference] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('output'), 'exclude': lambda f: f is None }})
    r"""A reference to a file."""  
    test_case: Optional[shared_testcasereference.TestCaseReference] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('testCase'), 'exclude': lambda f: f is None }})
