...
export declare class PostIndividualsPartyIdRolesRequest extends SpeakeasyBase {
    /**
     * The API key.
     */
    apiKey: string;
...
export declare class PostIndividualsPartyIdRolesResponse extends SpeakeasyBase {
    contentType: string;
