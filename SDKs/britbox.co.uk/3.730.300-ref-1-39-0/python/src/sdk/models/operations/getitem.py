...
class GetItemExpandEnum(str, Enum):
    r"""If no value is specified no dependencies are expanded.
...
class GetItemSelectSeasonEnum(str, Enum):
    r"""Given a provided show id, it can be useful to get the details of a child season. This option
...
class GetItemRequest:
    ...
    r"""The identifier of the item to load.
    ...
    expand: Optional[GetItemExpandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'expand', 'style': 'form', 'explode': True }})
    r"""If no value is specified no dependencies are expanded.
    ...
    select_season: Optional[GetItemSelectSeasonEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'select_season', 'style': 'form', 'explode': True }})
    r"""Given a provided show id, it can be useful to get the details of a child season. This option
    provides a means to return the `first` or `latest` season of a show given the show id.
    ...
    use_custom_id: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'use_custom_id', 'style': 'form', 'explode': True }})
    r"""Set to true when passing a custom Id as the `id` path parameter."""  
...
class GetItemResponse:
    ...
    item_detail: Optional[shared_itemdetail.ItemDetail] = dataclasses.field(default=None)
    r"""The item requested"""  
