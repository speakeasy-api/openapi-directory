...
class PatientDiscoveryResult:
    ...
    patient: Optional[shared_patientrepresentation.PatientRepresentation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('patient'), 'exclude': lambda f: f is None }})  
