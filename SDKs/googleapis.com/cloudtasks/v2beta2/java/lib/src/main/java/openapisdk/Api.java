...
public class Api {
    ...
    **/
    public openapisdk.models.operations.CloudtasksApiQueueUpdateResponse cloudtasksApiQueueUpdate(openapisdk.models.operations.CloudtasksApiQueueUpdateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/api/queue/update");
        ...
        openapisdk.models.operations.CloudtasksApiQueueUpdateResponse res = new openapisdk.models.operations.CloudtasksApiQueueUpdateResponse() {{
            empty = null;
        }};
