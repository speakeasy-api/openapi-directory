...
exports.RouteRequest = exports.RouteRequestCurbsidesEnum = exports.RouteRequestAlgorithmEnum = void 0;
...
var RouteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=alternative_route.max_paths" }),
        __metadata("design:type", Number)
    ], RouteRequest.prototype, "alternativeRouteMaxPaths", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=alternative_route.max_share_factor" }),
        __metadata("design:type", Number)
    ], RouteRequest.prototype, "alternativeRouteMaxShareFactor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=alternative_route.max_weight_factor" }),
        __metadata("design:type", Number)
    ], RouteRequest.prototype, "alternativeRouteMaxWeightFactor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=avoid" }),
        __metadata("design:type", String)
    ], RouteRequest.prototype, "avoid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=block_area" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ch.disable" }),
        __metadata("design:type", Boolean)
    ], RouteRequest.prototype, "chDisable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=curbsides" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=elevation" }),
        __metadata("design:type", Boolean)
    ], RouteRequest.prototype, "elevation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=heading_penalty" }),
        __metadata("design:type", Number)
    ], RouteRequest.prototype, "headingPenalty", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=headings" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=optimize" }),
        __metadata("design:type", String)
    ], RouteRequest.prototype, "optimize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=pass_through" }),
        __metadata("design:type", Boolean)
    ], RouteRequest.prototype, "passThrough", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=point_hints" }),
        __metadata("design:type", Array)
    ], RouteRequest.prototype, "pointHints", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=points" }),
        __metadata("design:type", Array)
    ], RouteRequest.prototype, "points", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=points_encoded" }),
        __metadata("design:type", Boolean)
    ], RouteRequest.prototype, "pointsEncoded", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=round_trip.distance" }),
        __metadata("design:type", Number)
    ], RouteRequest.prototype, "roundTripDistance", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=round_trip.seed" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=weighting" }),
        __metadata("design:type", String)
