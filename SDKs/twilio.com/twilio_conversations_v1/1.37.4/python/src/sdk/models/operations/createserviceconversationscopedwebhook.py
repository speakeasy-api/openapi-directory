...
from ..shared import service_conversation_scoped_webhook_enum_target_enum as shared_service_conversation_scoped_webhook_enum_target_enum
...
class CreateServiceConversationScopedWebhookCreateServiceConversationScopedWebhookRequest:
    target: shared_service_conversation_scoped_webhook_enum_target_enum.ServiceConversationScopedWebhookEnumTargetEnum = dataclasses.field(metadata={'form': { 'field_name': 'Target' }})
...
class CreateServiceConversationScopedWebhookRequest:
    path_params: CreateServiceConversationScopedWebhookPathParams = dataclasses.field()
    security: CreateServiceConversationScopedWebhookSecurity = dataclasses.field()
    request: Optional[CreateServiceConversationScopedWebhookCreateServiceConversationScopedWebhookRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
