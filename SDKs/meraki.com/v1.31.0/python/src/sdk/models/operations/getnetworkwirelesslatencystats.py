...
class GetNetworkWirelessLatencyStatsRequest:
    ...
    band: Optional[GetNetworkWirelessLatencyStatsBandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'band', 'style': 'form', 'explode': True }})
    r"""Filter results by band (either '2.4', '5' or '6'). Note that data prior to February 2020 will not have band information."""  
...
class GetNetworkWirelessLatencyStatsResponse:
    ...
    get_network_wireless_latency_stats_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
