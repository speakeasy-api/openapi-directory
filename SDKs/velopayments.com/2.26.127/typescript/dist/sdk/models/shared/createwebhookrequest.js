...
var CreateWebhookRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=authorizationHeader" }),
        __metadata("design:type", String)
    ], CreateWebhookRequest.prototype, "authorizationHeader", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=categories" }),
        __metadata("design:type", Array)
    ], CreateWebhookRequest.prototype, "categories", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=enabled" }),
        __metadata("design:type", Boolean)
    ], CreateWebhookRequest.prototype, "enabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=payorId" }),
        __metadata("design:type", String)
    ], CreateWebhookRequest.prototype, "payorId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=webhookUrl" }),
        __metadata("design:type", String)
    ], CreateWebhookRequest.prototype, "webhookUrl", void 0);
