...
public class GetSearchRvUkActiveQueryParams {
    /**
     * The API Authentication Key. Mandatory with all API calls.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=api_key")
    public String apiKey;
    public GetSearchRvUkActiveQueryParams withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withAvailabilityStatus(String availabilityStatus) {
    ...
    public GetSearchRvUkActiveQueryParams withBaseExteriorColor(String baseExteriorColor) {
    ...
    public GetSearchRvUkActiveQueryParams withBaseInteriorColor(String baseInteriorColor) {
    ...
    public GetSearchRvUkActiveQueryParams withBerths(String berths) {
        this.berths = berths;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withCategory(String category) {
    ...
    public GetSearchRvUkActiveQueryParams withChassis(String chassis) {
    ...
    public String city;
    public GetSearchRvUkActiveQueryParams withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withCounty(String county) {
        this.county = county;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withCylinders(String cylinders) {
    ...
    public GetSearchRvUkActiveQueryParams withDealerId(String dealerId) {
    ...
    public GetSearchRvUkActiveQueryParams withDealerName(String dealerName) {
    ...
    public String doors;
    public GetSearchRvUkActiveQueryParams withDoors(String doors) {
        this.doors = doors;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withDriveType(String driveType) {
    ...
    public GetSearchRvUkActiveQueryParams withEngineSize(String engineSize) {
    ...
    public GetSearchRvUkActiveQueryParams withExteriorColor(String exteriorColor) {
    ...
    public GetSearchRvUkActiveQueryParams withExteriorLengthRange(String exteriorLengthRange) {
    ...
    public GetSearchRvUkActiveQueryParams withFacetSort(org.openapis.openapi.models.shared.FacetSortEnum facetSort) {
    ...
    public GetSearchRvUkActiveQueryParams withFacets(String facets) {
        this.facets = facets;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withFirstSeenDays(String firstSeenDays) {
    ...
    public GetSearchRvUkActiveQueryParams withFirstSeenRange(String firstSeenRange) {
    ...
    public GetSearchRvUkActiveQueryParams withFuelType(String fuelType) {
    ...
    public GetSearchRvUkActiveQueryParams withInteriorColor(String interiorColor) {
    ...
    public GetSearchRvUkActiveQueryParams withInteriorLengthRange(String interiorLengthRange) {
    ...
    public GetSearchRvUkActiveQueryParams withInventoryType(org.openapis.openapi.models.shared.InventoryTypeEnum inventoryType) {
    ...
    public GetSearchRvUkActiveQueryParams withLastSeenDays(String lastSeenDays) {
    ...
    public GetSearchRvUkActiveQueryParams withLastSeenRange(String lastSeenRange) {
    ...
    public GetSearchRvUkActiveQueryParams withLatitude(Double latitude) {
    ...
    public GetSearchRvUkActiveQueryParams withLongitude(Double longitude) {
    ...
    public String make;
    public GetSearchRvUkActiveQueryParams withMake(String make) {
        this.make = make;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withMilesRange(String milesRange) {
    ...
    public String model;
    public GetSearchRvUkActiveQueryParams withModel(String model) {
        this.model = model;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withMsrpRange(String msrpRange) {
    ...
    public String mtplm;
    public GetSearchRvUkActiveQueryParams withMtplm(String mtplm) {
        this.mtplm = mtplm;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withPostalCode(String postalCode) {
    ...
    public GetSearchRvUkActiveQueryParams withPriceRange(String priceRange) {
    ...
    public GetSearchRvUkActiveQueryParams withRadius(Integer radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withRangeFacets(String rangeFacets) {
    ...
    public Integer rows;
    public GetSearchRvUkActiveQueryParams withRows(Integer rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withSearchText(String searchText) {
    ...
    public GetSearchRvUkActiveQueryParams withSeatingCapacity(String seatingCapacity) {
    ...
    public GetSearchRvUkActiveQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withSortOrder(org.openapis.openapi.models.shared.SortOrderEnum sortOrder) {
    ...
    public GetSearchRvUkActiveQueryParams withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withStart(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public String state;
    public GetSearchRvUkActiveQueryParams withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public String stats;
    public GetSearchRvUkActiveQueryParams withStats(String stats) {
        this.stats = stats;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withSteering(String steering) {
    ...
    public GetSearchRvUkActiveQueryParams withSubCategory(String subCategory) {
    ...
    public GetSearchRvUkActiveQueryParams withTransmission(String transmission) {
    ...
    public String vin;
    public GetSearchRvUkActiveQueryParams withVin(String vin) {
        this.vin = vin;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withWidthRange(String widthRange) {
    ...
    public String year;
    public GetSearchRvUkActiveQueryParams withYear(String year) {
        this.year = year;
        return this;
    }
    ...
    public GetSearchRvUkActiveQueryParams withYearRange(String yearRange) {
    ...
    public String zip;
    public GetSearchRvUkActiveQueryParams withZip(String zip) {
        this.zip = zip;
        return this;
    }
