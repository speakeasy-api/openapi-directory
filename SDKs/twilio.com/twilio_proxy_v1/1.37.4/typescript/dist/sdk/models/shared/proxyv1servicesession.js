...
exports.ProxyV1ServiceSession = void 0;
var utils_1 = require("../../../internal/utils");
var sessionenummodeenum_1 = require("./sessionenummodeenum");
var sessionenumstatusenum_1 = require("./sessionenumstatusenum");
var ProxyV1ServiceSession = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=closed_reason" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=date_ended" }),
        __metadata("design:type", Date)
    ], ProxyV1ServiceSession.prototype, "dateEnded", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=date_expiry" }),
        __metadata("design:type", Date)
    ], ProxyV1ServiceSession.prototype, "dateExpiry", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=date_last_interaction" }),
        __metadata("design:type", Date)
    ], ProxyV1ServiceSession.prototype, "dateLastInteraction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=date_started" }),
        __metadata("design:type", Date)
...
exports.ProxyV1ServiceSession = ProxyV1ServiceSession;
