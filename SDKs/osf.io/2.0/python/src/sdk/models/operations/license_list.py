...
class LicenseListLicenseAttributes:
...
class LicenseListLicense:
    ...
    attributes: Optional[LicenseListLicenseAttributes] = dataclasses.field(default=None)
    r"""The properties of the license."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The identifier of the license."""  
    links: Optional[LicenseListLicenseLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the license."""  
