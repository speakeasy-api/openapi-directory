...
class ListGrpcRoutesResponse:
    ...
    grpc_routes: Optional[list[shared_grpcroute.GrpcRoute]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('grpcRoutes'), 'exclude': lambda f: f is None }})
    r"""List of GrpcRoute resources."""  
