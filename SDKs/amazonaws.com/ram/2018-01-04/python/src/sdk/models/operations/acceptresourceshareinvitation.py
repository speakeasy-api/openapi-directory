...
class AcceptResourceShareInvitationRequestBody:
    ...
    r"""The <a href=\\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\\">Amazon Resoure Name (ARN)</a> of the invitation that you want to accept."""  
...
class AcceptResourceShareInvitationRequest:
    ...
    request_body: AcceptResourceShareInvitationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
