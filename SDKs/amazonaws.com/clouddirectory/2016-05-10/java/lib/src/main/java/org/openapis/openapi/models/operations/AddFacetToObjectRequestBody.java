...
public class AddFacetToObjectRequestBody {
    ...
    public AddFacetToObjectRequestBody(@JsonProperty("ObjectReference") AddFacetToObjectRequestBodyObjectReference objectReference, @JsonProperty("SchemaFacet") AddFacetToObjectRequestBodySchemaFacet schemaFacet) {
        this.objectReference = objectReference;
        this.schemaFacet = schemaFacet;
  }
}
