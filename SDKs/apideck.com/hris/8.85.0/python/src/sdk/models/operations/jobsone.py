...
class JobsOneRequest:
    headers: JobsOneHeaders = dataclasses.field()
    path_params: JobsOnePathParams = dataclasses.field()
    query_params: JobsOneQueryParams = dataclasses.field()
    security: JobsOneSecurity = dataclasses.field()
