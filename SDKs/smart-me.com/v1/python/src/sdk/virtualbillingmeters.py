...
class VirtualBillingMeters:
    ...
    def virtual_billing_meters_get(self) -> operations.VirtualBillingMetersGetResponse:
        ...
        res = operations.VirtualBillingMetersGetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
