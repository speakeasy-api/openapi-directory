...
exports.ZxingZebraCrossingBarCodes = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ZxingZebraCrossingBarCodes = /** @class */ (function () {
    function ZxingZebraCrossingBarCodes(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ZxingZebraCrossingBarCodes.prototype.zebraGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ZebraGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/zebra";
...
exports.ZxingZebraCrossingBarCodes = ZxingZebraCrossingBarCodes;
