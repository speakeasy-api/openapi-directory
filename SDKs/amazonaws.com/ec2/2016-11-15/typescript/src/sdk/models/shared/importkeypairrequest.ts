 ...
 */
export enum ImportKeyPairRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class ImportKeyPairRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class ImportKeyPairRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: ImportKeyPairRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: ImportKeyPairRequestTagSpecificationsTags })
...
export class ImportKeyPairRequest extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: ImportKeyPairRequestTagSpecifications })
