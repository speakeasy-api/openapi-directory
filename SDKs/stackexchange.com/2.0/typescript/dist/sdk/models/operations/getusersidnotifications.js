...
exports.GetUsersIdNotificationsResponse = exports.GetUsersIdNotificationsRequest = void 0;
...
var GetUsersIdNotificationsRequest = /** @class */ (function (_super) {
    ...
    ], GetUsersIdNotificationsRequest.prototype, "callback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetUsersIdNotificationsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetUsersIdNotificationsRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetUsersIdNotificationsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pagesize",
        }),
        __metadata("design:type", Number)
    ], GetUsersIdNotificationsRequest.prototype, "pagesize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=site" }),
        __metadata("design:type", String)
    ], GetUsersIdNotificationsRequest.prototype, "site", void 0);
...
var GetUsersIdNotificationsResponse = /** @class */ (function (_super) {
    ...
    ], GetUsersIdNotificationsResponse.prototype, "rawResponse", void 0);
