...
export declare class CreateInternationalScheduledPaymentConsentsJsonSecurity extends SpeakeasyBase {
    tppoAuth2Security: string;
}
export declare class CreateInternationalScheduledPaymentConsentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateInternationalScheduledPaymentConsentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
