...
class Group:
    ...
    r"""Output only. The [resource name](https://cloud.google.com/apis/design/resource_names) of the `Group`. Shall be of the form `groups/{group_id}`."""  
    ...
    posix_groups: Optional[list[shared_posixgroup.PosixGroup]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('posixGroups'), 'exclude': lambda f: f is None }})
    r"""Optional. The POSIX groups associated with the `Group`."""  
