...
class FootnoteReference:
    ...
    r"""The ID of the footnote that contains the content of this footnote reference."""  
    footnote_number: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('footnoteNumber'), 'exclude': lambda f: f is None }})
    r"""The rendered number of this footnote."""  
    ...
    r"""The suggested insertion IDs. A FootnoteReference may have multiple insertion IDs if it's a nested suggested change. If empty, then this is not a suggested insertion."""  
    ...
    r"""The suggested text style changes to this FootnoteReference, keyed by suggestion ID."""  
