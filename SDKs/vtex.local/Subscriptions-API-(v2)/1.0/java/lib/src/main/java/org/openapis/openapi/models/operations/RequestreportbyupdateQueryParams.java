...
public class RequestreportbyupdateQueryParams {
    /**
    ...
    public RequestreportbyupdateQueryParams withBeginDate(Integer beginDate) {
    ...
    public RequestreportbyupdateQueryParams withEndDate(Integer endDate) {
    ...
    public RequestreportbyupdateQueryParams withRequesterEmail(String requesterEmail) {
