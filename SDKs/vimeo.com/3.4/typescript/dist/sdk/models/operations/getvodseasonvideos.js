...
exports.GetVodSeasonVideosResponse = exports.GetVodSeasonVideosRequest = exports.GetVodSeasonVideosSortEnum = exports.GetVodSeasonVideosFilterEnum = void 0;
...
var GetVodSeasonVideosRequest = /** @class */ (function (_super) {
    ...
    ], GetVodSeasonVideosRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ondemand_id",
        }),
        __metadata("design:type", Number)
    ], GetVodSeasonVideosRequest.prototype, "ondemandId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetVodSeasonVideosRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetVodSeasonVideosRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=season_id",
        }),
        __metadata("design:type", Number)
    ], GetVodSeasonVideosRequest.prototype, "seasonId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetVodSeasonVideosRequest.prototype, "sort", void 0);
...
var GetVodSeasonVideosResponse = /** @class */ (function (_super) {
    ...
    ], GetVodSeasonVideosResponse.prototype, "rawResponse", void 0);
    __decorate([
