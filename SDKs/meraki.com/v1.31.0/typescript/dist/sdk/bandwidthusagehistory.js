...
exports.BandwidthUsageHistory = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var BandwidthUsageHistory = /** @class */ (function () {
    function BandwidthUsageHistory(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Returns a timeseries of total traffic consumption rates for all clients on a network within a given timespan, in megabits per second.
     */
    BandwidthUsageHistory.prototype.getNetworkClientsBandwidthUsageHistory = function (req, config) {
     ...
     * Return data usage (in megabits per second) over time for all clients in the given organization within a given time range.
     */
    BandwidthUsageHistory.prototype.getOrganizationClientsBandwidthUsageHistory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.BandwidthUsageHistory = BandwidthUsageHistory;
