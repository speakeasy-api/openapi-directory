...
public class GetWindowsHostingsQueryParams {
    /**
     * The number of items to skip in the resultset.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=skip")
    public Integer skip;
    public GetWindowsHostingsQueryParams withSkip(Integer skip) {
        this.skip = skip;
        return this;
    }
    ...
    public Integer take;
    public GetWindowsHostingsQueryParams withTake(Integer take) {
        this.take = take;
        return this;
    }
