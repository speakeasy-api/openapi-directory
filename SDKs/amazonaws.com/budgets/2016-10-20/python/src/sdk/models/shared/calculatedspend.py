...
class CalculatedSpend:
    ...
    actual_spend: shared_spend.Spend = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ActualSpend') }})
    forecasted_spend: Optional[shared_spend.Spend] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ForecastedSpend') }})
