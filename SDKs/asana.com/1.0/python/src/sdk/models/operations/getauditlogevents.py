...
from ..shared import audit_log_actor_type_enum as shared_audit_log_actor_type_enum
...
class GetAuditLogEventsRequest:
    ...
    actor_type: Optional[shared_audit_log_actor_type_enum.AuditLogActorTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'actor_type', 'style': 'form', 'explode': True }})
