...
var Versions = /** @class */ (function () {
    ...
    **/
    Versions.prototype.getVersionsVersionsGet = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/versions";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "text/csv; header=present")) {
                        res.getVersionsVersionsGet200TextCsvString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
            }
            return res;
