...
type DisplayvideoAdvertisersCampaignsBulkListCampaignAssignedTargetingOptionsSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DisplayvideoAdvertisersCampaignsBulkListCampaignAssignedTargetingOptionsPathParams struct {
...
type DisplayvideoAdvertisersCampaignsBulkListCampaignAssignedTargetingOptionsQueryParams struct {
	// V1 error format.
...
type DisplayvideoAdvertisersCampaignsBulkListCampaignAssignedTargetingOptionsRequest struct {
...
type DisplayvideoAdvertisersCampaignsBulkListCampaignAssignedTargetingOptionsResponse struct {
	// Successful response
