 ...
 */
export enum CreateNetworkInsightsPathRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateNetworkInsightsPathRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateNetworkInsightsPathRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateNetworkInsightsPathRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken: string;
