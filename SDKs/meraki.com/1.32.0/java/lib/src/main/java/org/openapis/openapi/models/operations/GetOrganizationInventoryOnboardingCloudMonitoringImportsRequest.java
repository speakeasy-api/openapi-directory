...
public class GetOrganizationInventoryOnboardingCloudMonitoringImportsRequest {
    ...
    public GetOrganizationInventoryOnboardingCloudMonitoringImportsRequest(@JsonProperty("importIds") String[] importIds, @JsonProperty("organizationId") String organizationId) {
        this.importIds = importIds;
        this.organizationId = organizationId;
  }
}
