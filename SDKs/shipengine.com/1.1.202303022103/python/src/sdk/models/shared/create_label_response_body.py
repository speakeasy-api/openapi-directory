...
class CreateLabelResponseBodyDisplaySchemeEnum(str, Enum):
...
class CreateLabelResponseBodyLabelFormatEnum(str, Enum):
...
class CreateLabelResponseBodyLabelLayoutEnum(str, Enum):
...
class CreateLabelResponseBodyLabelStatusEnum(str, Enum):
...
class CreateLabelResponseBodyTrackingStatusEnum(str, Enum):
...
class CreateLabelResponseBodyOutput:
    ...
    charge_event: shared_label_charge_event_enum.LabelChargeEventEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('charge_event') }})
    ...
    display_scheme: CreateLabelResponseBodyDisplaySchemeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('display_scheme') }})
    r"""The display format that the label should be shown in."""  
    form_download: CreateLabelResponseBodyOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('form_download') }})
    ...
    insurance_claim: CreateLabelResponseBodyOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('insurance_claim') }})
    ...
    insurance_cost: CreateLabelResponseBodyMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('insurance_cost') }})
    r"""The insurance cost for this package.  Add this to the `shipment_cost` field to get the total cost."""  
    is_international: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('is_international') }})
    ...
    is_return_label: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('is_return_label') }})
    r"""Indicates whether this is a return label.  You may also want to set the `rma_number` so you know what is being returned."""  
    label_download: CreateLabelResponseBodyLabelDownload = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_download') }})  
    label_format: CreateLabelResponseBodyLabelFormatEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_format') }})
    ...
    label_image_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_image_id') }})
    r"""The label image resource that was used to create a custom label image."""  
    label_layout: CreateLabelResponseBodyLabelLayoutEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_layout') }})
    ...
    """  
    rma_number: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rma_number') }})
    ...
    shipment_cost: CreateLabelResponseBodyMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shipment_cost') }})
    ...
    status: CreateLabelResponseBodyLabelStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
    ...
    tracking_status: CreateLabelResponseBodyTrackingStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tracking_status') }})
    r"""The current status of the package, such as `in_transit` or `delivered`"""  
    voided: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('voided') }})
