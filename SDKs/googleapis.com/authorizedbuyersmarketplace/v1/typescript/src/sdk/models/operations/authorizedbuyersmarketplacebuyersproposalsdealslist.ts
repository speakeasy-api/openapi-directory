...
export class AuthorizedbuyersmarketplaceBuyersProposalsDealsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AuthorizedbuyersmarketplaceBuyersProposalsDealsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AuthorizedbuyersmarketplaceBuyersProposalsDealsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
