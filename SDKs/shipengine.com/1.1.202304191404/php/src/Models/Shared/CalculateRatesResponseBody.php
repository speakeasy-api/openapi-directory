...
class CalculateRatesResponseBody
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyDeliveryConfirmationEnum $confirmation
     */
	#[\JMS\Serializer\Annotation\SerializedName('confirmation')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyDeliveryConfirmationEnum>')]
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyInternationalShipmentOptions $customs
     */
	#[\JMS\Serializer\Annotation\SerializedName('customs')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyInternationalShipmentOptions')]
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyInsuranceProviderEnum $insuranceProvider
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_provider')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyInsuranceProviderEnum>')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyOriginTypeEnum $originType
     */
	#[\JMS\Serializer\Annotation\SerializedName('origin_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyOriginTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CalculateRatesResponseBodyOriginTypeEnum $originType = null;
     ...
     * The rates response
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\RatesInformation $rateResponse
     */
	#[\JMS\Serializer\Annotation\SerializedName('rate_response')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\RatesInformation')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyShipmentStatusEnum $shipmentStatus
     */
	#[\JMS\Serializer\Annotation\SerializedName('shipment_status')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyShipmentStatusEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyWeight $totalWeight
     */
	#[\JMS\Serializer\Annotation\SerializedName('total_weight')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyWeight')]
	...
	public function __construct()
	{
		...
		$this->carrierId = null;
		$this->confirmation = \OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyDeliveryConfirmationEnum::NONE;
		$this->createdAt = new \DateTime();
		$this->customs = new \OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyInternationalShipmentOptions();
		$this->externalOrderId = null;
		$this->externalShipmentId = null;
		$this->insuranceProvider = \OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyInsuranceProviderEnum::NONE;
		$this->isReturn = null;
		$this->items = null;
		...
		$this->packages = [];
		$this->rateResponse = new \OpenAPI\OpenAPI\Models\Shared\RatesInformation();
		...
		$this->shipmentStatus = \OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyShipmentStatusEnum::PENDING;
		$this->tags = [];
		$this->taxIdentifiers = null;
		$this->totalWeight = new \OpenAPI\OpenAPI\Models\Shared\CalculateRatesResponseBodyWeight();
