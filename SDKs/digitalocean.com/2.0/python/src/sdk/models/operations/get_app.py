...
@dataclasses.dataclass
class GetAppRequest:
    path_params: GetAppPathParams = dataclasses.field()
    query_params: GetAppQueryParams = dataclasses.field()
...
class GetAppResponse:
    ...
    get_app_401_application_json_object: Optional[GetApp401ApplicationJSON] = dataclasses.field(default=None)
