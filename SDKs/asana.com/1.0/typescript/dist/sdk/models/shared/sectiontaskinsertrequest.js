...
var SectionTaskInsertRequest = /** @class */ (function (_super) {
    __extends(SectionTaskInsertRequest, _super);
    function SectionTaskInsertRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=insert_after" }),
        __metadata("design:type", String)
    ], SectionTaskInsertRequest.prototype, "insertAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=insert_before" }),
        __metadata("design:type", String)
    ], SectionTaskInsertRequest.prototype, "insertBefore", void 0);
    __decorate([
