 ...
 */
export declare enum CreateRestoreImageTaskRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateRestoreImageTaskRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateRestoreImageTaskRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateRestoreImageTaskRequest extends SpeakeasyBase {
    bucket: string;
    dryRun?: boolean;
    name?: string;
    objectKey: string;
