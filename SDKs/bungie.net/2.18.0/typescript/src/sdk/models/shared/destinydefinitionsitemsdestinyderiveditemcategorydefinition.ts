 ...
 */
export class DestinyDefinitionsItemsDestinyDerivedItemCategoryDefinition extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({
    elemType: DestinyDefinitionsItemsDestinyDerivedItemDefinition,
  })
