...
class User
{
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\UserAccountEnum $account
     */
	#[\JMS\Serializer\Annotation\SerializedName('account')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UserAccountEnum>')]
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UserContentFilterEnum $contentFilter
     */
	#[\JMS\Serializer\Annotation\SerializedName('content_filter')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UserContentFilterEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UserContentFilterEnum $contentFilter = null;
     ...
     * The user's metadata.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\UserMetadata $metadata
     */
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\UserPreferences')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\UserUploadQuota $uploadQuota
     */
	#[\JMS\Serializer\Annotation\SerializedName('upload_quota')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\UserUploadQuota')]
     ...
     * The user's websites.
     * 
     * @var array<\OpenAPI\OpenAPI\Models\Shared\UserWebsites> $websites
     */
	#[\JMS\Serializer\Annotation\SerializedName('websites')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Shared\UserWebsites>')]
    public array $websites;
    
	public function __construct()
	{
		$this->account = \OpenAPI\OpenAPI\Models\Shared\UserAccountEnum::BASIC;
		$this->bio = "";
		...
		$this->link = "";
		$this->location = "";
		$this->metadata = new \OpenAPI\OpenAPI\Models\Shared\UserMetadata();
		$this->name = "";
		$this->pictures = new \OpenAPI\OpenAPI\Models\Shared\Picture();
		$this->preferences = null;
		$this->resourceKey = "";
		$this->uploadQuota = new \OpenAPI\OpenAPI\Models\Shared\UserUploadQuota();
		$this->uri = "";
		$this->websites = [];
	}
}
