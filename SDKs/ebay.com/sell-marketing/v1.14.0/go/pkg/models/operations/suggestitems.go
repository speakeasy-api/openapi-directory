...
type SuggestItemsPathParams struct {
...
type SuggestItemsQueryParams struct {
...
type SuggestItemsRequest struct {
	PathParams  SuggestItemsPathParams
	QueryParams SuggestItemsQueryParams
	Security    SuggestItemsSecurity
}
