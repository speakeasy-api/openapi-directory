...
func (e EcommerceProductProductStatusEnum) ToPointer() *EcommerceProductProductStatusEnum {
	return &e
}
...
func (e *EcommerceProductProductStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "active":
		fallthrough
	case "archived":
		*e = EcommerceProductProductStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EcommerceProductProductStatusEnum: %v", v)
	}
}
