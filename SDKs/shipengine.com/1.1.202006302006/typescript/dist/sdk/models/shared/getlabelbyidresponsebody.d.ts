...
**/
export declare class GetLabelByIdResponseBodyOptionalLink extends SpeakeasyBase {
    href: string;
    type?: string;
}
/**
 ...
 *
**/
export declare class GetLabelByIdResponseBodyMonetaryValue extends SpeakeasyBase {
    amount: number;
 ...
 *
**/
export declare class GetLabelByIdResponseBodyLabelDownload extends SpeakeasyBase {
    href?: string;
    pdf?: string;
    png?: string;
    zpl?: string;
 ...
 *
**/
export declare class GetLabelByIdResponseBodyOutput extends SpeakeasyBase {
