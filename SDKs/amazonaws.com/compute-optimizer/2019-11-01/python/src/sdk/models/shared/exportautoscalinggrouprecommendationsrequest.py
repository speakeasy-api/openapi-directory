...
from ..shared import exportableautoscalinggroupfield_enum as shared_exportableautoscalinggroupfield_enum
...
class ExportAutoScalingGroupRecommendationsRequest:
    ...
    fields_to_export: Optional[list[shared_exportableautoscalinggroupfield_enum.ExportableAutoScalingGroupFieldEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fieldsToExport') }})
