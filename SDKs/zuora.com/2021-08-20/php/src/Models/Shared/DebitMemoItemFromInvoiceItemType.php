 ...
 * @access public
 */
class DebitMemoItemFromInvoiceItemType
{
    /**
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\DebitMemoItemFromInvoiceItemTypeFinanceInformation $financeInformation
     */
	#[\JMS\Serializer\Annotation\SerializedName('financeInformation')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\DebitMemoItemFromInvoiceItemTypeFinanceInformation')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?DebitMemoItemFromInvoiceItemTypeFinanceInformation $financeInformation = null;
     ...
     * 
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Shared\DebitMemoTaxItemFromInvoiceTaxItemType> $taxItems
     */
	#[\JMS\Serializer\Annotation\SerializedName('taxItems')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Shared\DebitMemoTaxItemFromInvoiceTaxItemType>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\DebitMemoItemFromInvoiceItemTypeTaxModeEnum $taxMode
     */
	#[\JMS\Serializer\Annotation\SerializedName('taxMode')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\DebitMemoItemFromInvoiceItemTypeTaxModeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?DebitMemoItemFromInvoiceItemTypeTaxModeEnum $taxMode = null;
