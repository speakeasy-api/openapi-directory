...
class OnScreenPositionTargetingOptionDetails:
    ...
    on_screen_position: Optional[OnScreenPositionTargetingOptionDetailsOnScreenPositionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('onScreenPosition') }})
