...
export class EssentialcontactsProjectsContactsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class EssentialcontactsProjectsContactsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class EssentialcontactsProjectsContactsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
