...
class PurchaseDto:
    r"""Information of Purchase to create."""
    ...
    is_discrepancy_accepted: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('isDiscrepancyAccepted'), 'exclude': lambda f: f is None }})  
