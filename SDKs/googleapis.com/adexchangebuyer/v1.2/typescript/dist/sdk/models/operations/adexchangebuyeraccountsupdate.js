...
exports.AdexchangebuyerAccountsUpdateResponse = exports.AdexchangebuyerAccountsUpdateRequest = exports.AdexchangebuyerAccountsUpdateSecurity = void 0;
...
var AdexchangebuyerAccountsUpdateRequest = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerAccountsUpdateRequest.prototype, "account", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdexchangebuyerAccountsUpdateRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerAccountsUpdateRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], AdexchangebuyerAccountsUpdateRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdexchangebuyerAccountsUpdateRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerAccountsUpdateRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdexchangebuyerAccountsUpdateRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerAccountsUpdateRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerAccountsUpdateRequest.prototype, "userIp", void 0);
...
var AdexchangebuyerAccountsUpdateResponse = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerAccountsUpdateResponse.prototype, "rawResponse", void 0);
