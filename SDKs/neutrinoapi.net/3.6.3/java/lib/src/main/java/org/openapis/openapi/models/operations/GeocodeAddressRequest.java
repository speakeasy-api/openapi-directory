...
public class GeocodeAddressRequest {
    ...
    public GeocodeAddressRequest withAddress(String address) {
    ...
    public String city;
    public GeocodeAddressRequest withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public GeocodeAddressRequest withCountryCode(String countryCode) {
    ...
    public GeocodeAddressRequest withCounty(String county) {
        this.county = county;
        return this;
    }
    ...
    public GeocodeAddressRequest withFuzzySearch(Boolean fuzzySearch) {
    ...
    public GeocodeAddressRequest withHouseNumber(String houseNumber) {
    ...
    public GeocodeAddressRequest withLanguageCode(String languageCode) {
    ...
    public GeocodeAddressRequest withPostalCode(String postalCode) {
    ...
    public String state;
    public GeocodeAddressRequest withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public GeocodeAddressRequest withStreet(String street) {
        this.street = street;
        return this;
    }
