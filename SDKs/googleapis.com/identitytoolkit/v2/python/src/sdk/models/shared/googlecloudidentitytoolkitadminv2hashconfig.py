...
class GoogleCloudIdentitytoolkitAdminV2HashConfig:
    ...
    algorithm: Optional[GoogleCloudIdentitytoolkitAdminV2HashConfigAlgorithmEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('algorithm') }})
