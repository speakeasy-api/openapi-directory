...
class ImagePredictionResult:
    ...
    predictions: Optional[list[shared_imagetagprediction.ImageTagPrediction]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Predictions'), 'exclude': lambda f: f is None }})  
