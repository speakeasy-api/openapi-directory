...
class AutopilotV1Assistant:
    ...
    development_stage: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('development_stage') }})
    ...
    needs_model_build: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('needs_model_build') }})
