...
public class DcimInterfaceConnectionsListRequest {
    ...
    public DcimInterfaceConnectionsListRequest withConnectionStatusN(String connectionStatusN) {
    ...
    public DcimInterfaceConnectionsListRequest withDeviceId(String deviceId) {
