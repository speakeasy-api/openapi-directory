...
from ..shared import getconnectionrequest as shared_getconnectionrequest
...
class GetConnectionHeaders:
    x_amz_target: GetConnectionXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetConnectionRequest:
    ...
    request: shared_getconnectionrequest.GetConnectionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
