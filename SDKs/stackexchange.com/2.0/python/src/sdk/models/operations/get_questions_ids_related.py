...
class GetQuestionsIdsRelatedQueryParams:
    ...
    order: Optional[GetQuestionsIdsRelatedOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetQuestionsIdsRelatedSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetQuestionsIdsRelatedRequest:
    path_params: GetQuestionsIdsRelatedPathParams = dataclasses.field()
    query_params: GetQuestionsIdsRelatedQueryParams = dataclasses.field()
