...
class GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIkeVersionEnum(str, Enum):
    r"""[optional] The IKE version to be used for the IPsec VPN peer configuration. Defaults to '1' when omitted."""
    ONE = '1'
    TWO = '2'

class GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesChildAuthAlgoEnum(str, Enum):
    MD5 = 'md5'
    SHA1 = 'sha1'
    SHA256 = 'sha256'

class GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesChildCipherAlgoEnum(str, Enum):
    AES128 = 'aes128'
    AES192 = 'aes192'
    AES256 = 'aes256'
    DES = 'des'
...
class GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkeAuthAlgoEnum(str, Enum):
    MD5 = 'md5'
    SHA1 = 'sha1'
    SHA256 = 'sha256'

class GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkeCipherAlgoEnum(str, Enum):
    AES128 = 'aes128'
    AES192 = 'aes192'
    AES256 = 'aes256'
    DES = 'des'
...
class GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkePrfAlgoEnum(str, Enum):
    DEFAULT = 'default'
    PRFMD5 = 'prfmd5'
    PRFSHA1 = 'prfsha1'
    PRFSHA256 = 'prfsha256'
...
@dataclasses.dataclass
class GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPolicies:
    ...
    child_auth_algo: Optional[list[GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesChildAuthAlgoEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('childAuthAlgo'), 'exclude': lambda f: f is None }})
    ...
    child_cipher_algo: Optional[list[GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesChildCipherAlgoEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('childCipherAlgo'), 'exclude': lambda f: f is None }})
    ...
    ike_auth_algo: Optional[list[GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkeAuthAlgoEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ikeAuthAlgo'), 'exclude': lambda f: f is None }})
    ...
    ike_cipher_algo: Optional[list[GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkeCipherAlgoEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ikeCipherAlgo'), 'exclude': lambda f: f is None }})
    ...
    ike_prf_algo: Optional[list[GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkePrfAlgoEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ikePrfAlgo'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeers:
    
    ike_version: Optional[GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIkeVersionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ikeVersion'), 'exclude': lambda f: f is None }})
    r"""[optional] The IKE version to be used for the IPsec VPN peer configuration. Defaults to '1' when omitted."""  
    ipsec_policies: Optional[GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPolicies] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ipsecPolicies'), 'exclude': lambda f: f is None }})
    r"""Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used."""  
...
class GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSON:
    ...
    peers: Optional[list[GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('peers'), 'exclude': lambda f: f is None }})
...
class GetOrganizationApplianceVPNThirdPartyVPNPeersResponse:
    ...
    get_organization_appliance_vpn_third_party_vpn_peers_200_application_json_object: Optional[GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
