 ...
 */
export enum ResourcePolicyAggregatedListWarningCodeEnum {
...
export class ResourcePolicyAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ResourcePolicyAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: ResourcePolicyAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class ResourcePolicyAggregatedList extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "etag" })
  etag?: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: ResourcePoliciesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, ResourcePoliciesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], ResourcePoliciesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
