...
class NextContractInfo:
    r"""Get the conditions of your next contract"""
    
    links: shared_nextcontractinfolinks.NextContractInfoLinks = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('links') }})  
