...
class AdexchangebuyerBillingInfoGetRequest:
    path_params: AdexchangebuyerBillingInfoGetPathParams = dataclasses.field()
    query_params: AdexchangebuyerBillingInfoGetQueryParams = dataclasses.field()
    security: AdexchangebuyerBillingInfoGetSecurity = dataclasses.field()
