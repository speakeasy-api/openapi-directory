...
public class UpdateNetworkApplianceVpnBgpRequestBodyNeighbors {
    ...
    public UpdateNetworkApplianceVpnBgpRequestBodyNeighbors(@JsonProperty("ebgpHoldTimer") Long ebgpHoldTimer, @JsonProperty("ebgpMultihop") Long ebgpMultihop, @JsonProperty("remoteAsNumber") Long remoteAsNumber) {
        this.ebgpHoldTimer = ebgpHoldTimer;
        this.ebgpMultihop = ebgpMultihop;
        this.remoteAsNumber = remoteAsNumber;
  }
