...
class CreateTaskRequest:
    ...
    request_body: CreateTaskRequestBodyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The task to create."""  
...
class CreateTask201ApplicationJSON:
    r"""Successfully created a new task."""
