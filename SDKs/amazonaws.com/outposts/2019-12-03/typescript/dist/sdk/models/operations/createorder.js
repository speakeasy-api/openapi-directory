...
exports.CreateOrderResponse = exports.CreateOrderRequest = exports.CreateOrderRequestBody = exports.CreateOrderRequestBodyPaymentTermEnum = exports.CreateOrderRequestBodyPaymentOptionEnum = void 0;
 ...
 * The payment option.
 */
var CreateOrderRequestBodyPaymentOptionEnum;
...
})(CreateOrderRequestBodyPaymentOptionEnum = exports.CreateOrderRequestBodyPaymentOptionEnum || (exports.CreateOrderRequestBodyPaymentOptionEnum = {}));
/**
 * The payment terms.
 */
var CreateOrderRequestBodyPaymentTermEnum;
(function (CreateOrderRequestBodyPaymentTermEnum) {
    CreateOrderRequestBodyPaymentTermEnum["ThreeYears"] = "THREE_YEARS";
    CreateOrderRequestBodyPaymentTermEnum["OneYear"] = "ONE_YEAR";
})(CreateOrderRequestBodyPaymentTermEnum = exports.CreateOrderRequestBodyPaymentTermEnum || (exports.CreateOrderRequestBodyPaymentTermEnum = {}));
var CreateOrderRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.LineItemRequest }),
        (0, class_transformer_1.Expose)({ name: "LineItems" }),
        (0, class_transformer_1.Type)(function () { return shared.LineItemRequest; }),
        __metadata("design:type", Array)
    ], CreateOrderRequestBody.prototype, "lineItems", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "OutpostIdentifier" }),
...
exports.CreateOrderRequestBody = CreateOrderRequestBody;
var CreateOrderRequest = /** @class */ (function (_super) {
    ...
    ], CreateOrderRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], CreateOrderRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreateOrderRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreateOrderRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreateOrderRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreateOrderRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreateOrderRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreateOrderRequest.prototype, "xAmzSignedHeaders", void 0);
