...
func (e InsightsV1VideoRoomSummaryStatusCallbackMethodEnum) ToPointer() *InsightsV1VideoRoomSummaryStatusCallbackMethodEnum {
	return &e
}
...
func (e *InsightsV1VideoRoomSummaryStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = InsightsV1VideoRoomSummaryStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for InsightsV1VideoRoomSummaryStatusCallbackMethodEnum: %v", v)
	}
}
