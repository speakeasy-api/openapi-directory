...
class DisplayvideoAdvertisersChannelsSitesDeleteSecurity:
...
@dataclasses.dataclass
class DisplayvideoAdvertisersChannelsSitesDeleteRequest:
    ...
    r"""Required. The ID of the parent channel to which the site belongs."""  
    url_or_app_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'urlOrAppId', 'style': 'simple', 'explode': False }})
    r"""Required. The URL or app ID of the site to delete."""  
...
@dataclasses.dataclass
class DisplayvideoAdvertisersChannelsSitesDeleteResponse:
