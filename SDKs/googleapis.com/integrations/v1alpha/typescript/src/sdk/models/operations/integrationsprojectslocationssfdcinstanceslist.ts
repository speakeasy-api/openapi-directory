...
export class IntegrationsProjectsLocationsSfdcInstancesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsSfdcInstancesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsSfdcInstancesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
