...
class ReportSuccess:
    ...
    data: Optional[shared_report_response.ReportResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
