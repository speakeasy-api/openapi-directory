...
from ..shared import updateaccountholderresponse as shared_updateaccountholderresponse
...
class PostUpdateAccountHolderResponse:
    ...
    update_account_holder_response: Optional[shared_updateaccountholderresponse.UpdateAccountHolderResponse] = dataclasses.field(default=None)
