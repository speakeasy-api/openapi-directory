...
export class DialogflowProjectsLocationsAgentsTestCasesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsAgentsTestCasesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class DialogflowProjectsLocationsAgentsTestCasesListSecurity extends SpeakeasyBase {
 ...
 */
export enum DialogflowProjectsLocationsAgentsTestCasesListViewEnum {
  TestCaseViewUnspecified = "TEST_CASE_VIEW_UNSPECIFIED",
  Basic = "BASIC",
  Full = "FULL",
}

export class DialogflowProjectsLocationsAgentsTestCasesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsAgentsTestCasesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
