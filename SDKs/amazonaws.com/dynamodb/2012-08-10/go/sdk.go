...
func (s *SDK) BatchExecuteStatement(ctx context.Context, request operations.BatchExecuteStatementRequest) (*operations.BatchExecuteStatementResponse, error) {
	...
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.BatchExecuteStatement"
...
func (s *SDK) BatchGetItem(ctx context.Context, request operations.BatchGetItemRequest) (*operations.BatchGetItemResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.BatchGetItem"
	...
	res := &operations.BatchGetItemResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.BatchGetItemOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) BatchWriteItem(ctx context.Context, request operations.BatchWriteItemRequest) (*operations.BatchWriteItemResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.BatchWriteItem"
	...
	res := &operations.BatchWriteItemResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.BatchWriteItemOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) CreateBackup(ctx context.Context, request operations.CreateBackupRequest) (*operations.CreateBackupResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.CreateBackup"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.CreateBackupOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) CreateGlobalTable(ctx context.Context, request operations.CreateGlobalTableRequest) (*operations.CreateGlobalTableResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.CreateGlobalTable"
	...
	res := &operations.CreateGlobalTableResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.CreateGlobalTableOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) CreateTable(ctx context.Context, request operations.CreateTableRequest) (*operations.CreateTableResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.CreateTable"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.CreateTableOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DeleteBackup(ctx context.Context, request operations.DeleteBackupRequest) (*operations.DeleteBackupResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DeleteBackup"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DeleteBackupOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DeleteItem(ctx context.Context, request operations.DeleteItemRequest) (*operations.DeleteItemResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DeleteItem"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DeleteItemOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DeleteTable(ctx context.Context, request operations.DeleteTableRequest) (*operations.DeleteTableResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DeleteTable"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DeleteTableOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DescribeBackup(ctx context.Context, request operations.DescribeBackupRequest) (*operations.DescribeBackupResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DescribeBackup"
	...
	res := &operations.DescribeBackupResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeBackupOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DescribeContinuousBackups(ctx context.Context, request operations.DescribeContinuousBackupsRequest) (*operations.DescribeContinuousBackupsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DescribeContinuousBackups"
	...
	res := &operations.DescribeContinuousBackupsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeContinuousBackupsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DescribeContributorInsights(ctx context.Context, request operations.DescribeContributorInsightsRequest) (*operations.DescribeContributorInsightsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DescribeContributorInsights"
	...
	res := &operations.DescribeContributorInsightsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeContributorInsightsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DescribeEndpoints(ctx context.Context, request operations.DescribeEndpointsRequest) (*operations.DescribeEndpointsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DescribeEndpoints"
...
func (s *SDK) DescribeExport(ctx context.Context, request operations.DescribeExportRequest) (*operations.DescribeExportResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DescribeExport"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeExportOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DescribeGlobalTable(ctx context.Context, request operations.DescribeGlobalTableRequest) (*operations.DescribeGlobalTableResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DescribeGlobalTable"
	...
	res := &operations.DescribeGlobalTableResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeGlobalTableOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DescribeGlobalTableSettings(ctx context.Context, request operations.DescribeGlobalTableSettingsRequest) (*operations.DescribeGlobalTableSettingsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DescribeGlobalTableSettings"
	...
	res := &operations.DescribeGlobalTableSettingsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeGlobalTableSettingsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DescribeKinesisStreamingDestination(ctx context.Context, request operations.DescribeKinesisStreamingDestinationRequest) (*operations.DescribeKinesisStreamingDestinationResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DescribeKinesisStreamingDestination"
	...
	res := &operations.DescribeKinesisStreamingDestinationResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeKinesisStreamingDestinationOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DescribeLimits(ctx context.Context, request operations.DescribeLimitsRequest) (*operations.DescribeLimitsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DescribeLimits"
	...
	res := &operations.DescribeLimitsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeLimitsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DescribeTable(ctx context.Context, request operations.DescribeTableRequest) (*operations.DescribeTableResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DescribeTable"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeTableOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DescribeTableReplicaAutoScaling(ctx context.Context, request operations.DescribeTableReplicaAutoScalingRequest) (*operations.DescribeTableReplicaAutoScalingResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DescribeTableReplicaAutoScaling"
	...
	res := &operations.DescribeTableReplicaAutoScalingResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeTableReplicaAutoScalingOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DescribeTimeToLive(ctx context.Context, request operations.DescribeTimeToLiveRequest) (*operations.DescribeTimeToLiveResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DescribeTimeToLive"
	...
	res := &operations.DescribeTimeToLiveResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeTimeToLiveOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DisableKinesisStreamingDestination(ctx context.Context, request operations.DisableKinesisStreamingDestinationRequest) (*operations.DisableKinesisStreamingDestinationResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.DisableKinesisStreamingDestination"
	...
	res := &operations.DisableKinesisStreamingDestinationResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.KinesisStreamingDestinationOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) EnableKinesisStreamingDestination(ctx context.Context, request operations.EnableKinesisStreamingDestinationRequest) (*operations.EnableKinesisStreamingDestinationResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.EnableKinesisStreamingDestination"
	...
	res := &operations.EnableKinesisStreamingDestinationResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) ExecuteStatement(ctx context.Context, request operations.ExecuteStatementRequest) (*operations.ExecuteStatementResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.ExecuteStatement"
...
func (s *SDK) ExecuteTransaction(ctx context.Context, request operations.ExecuteTransactionRequest) (*operations.ExecuteTransactionResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.ExecuteTransaction"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ExecuteTransactionOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ExportTableToPointInTime(ctx context.Context, request operations.ExportTableToPointInTimeRequest) (*operations.ExportTableToPointInTimeResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.ExportTableToPointInTime"
	...
	res := &operations.ExportTableToPointInTimeResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ExportTableToPointInTimeOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetItem(ctx context.Context, request operations.GetItemRequest) (*operations.GetItemResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.GetItem"
...
func (s *SDK) ListBackups(ctx context.Context, request operations.ListBackupsRequest) (*operations.ListBackupsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.ListBackups"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListBackupsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListContributorInsights(ctx context.Context, request operations.ListContributorInsightsRequest) (*operations.ListContributorInsightsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.ListContributorInsights"
	...
	res := &operations.ListContributorInsightsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListContributorInsightsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListExports(ctx context.Context, request operations.ListExportsRequest) (*operations.ListExportsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.ListExports"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListExportsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListGlobalTables(ctx context.Context, request operations.ListGlobalTablesRequest) (*operations.ListGlobalTablesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.ListGlobalTables"
	...
	res := &operations.ListGlobalTablesResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListGlobalTablesOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListTables(ctx context.Context, request operations.ListTablesRequest) (*operations.ListTablesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.ListTables"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListTablesOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListTagsOfResource(ctx context.Context, request operations.ListTagsOfResourceRequest) (*operations.ListTagsOfResourceResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.ListTagsOfResource"
	...
	res := &operations.ListTagsOfResourceResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListTagsOfResourceOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) PutItem(ctx context.Context, request operations.PutItemRequest) (*operations.PutItemResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.PutItem"
	...
	res := &operations.PutItemResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) Query(ctx context.Context, request operations.QueryRequest) (*operations.QueryResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.Query"
...
func (s *SDK) RestoreTableFromBackup(ctx context.Context, request operations.RestoreTableFromBackupRequest) (*operations.RestoreTableFromBackupResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.RestoreTableFromBackup"
	...
	res := &operations.RestoreTableFromBackupResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.RestoreTableFromBackupOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) RestoreTableToPointInTime(ctx context.Context, request operations.RestoreTableToPointInTimeRequest) (*operations.RestoreTableToPointInTimeResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.RestoreTableToPointInTime"
	...
	res := &operations.RestoreTableToPointInTimeResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.RestoreTableToPointInTimeOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) Scan(ctx context.Context, request operations.ScanRequest) (*operations.ScanResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.Scan"
...
func (s *SDK) TagResource(ctx context.Context, request operations.TagResourceRequest) (*operations.TagResourceResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.TagResource"
...
func (s *SDK) TransactGetItems(ctx context.Context, request operations.TransactGetItemsRequest) (*operations.TransactGetItemsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.TransactGetItems"
	...
	res := &operations.TransactGetItemsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.TransactGetItemsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) TransactWriteItems(ctx context.Context, request operations.TransactWriteItemsRequest) (*operations.TransactWriteItemsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.TransactWriteItems"
	...
	res := &operations.TransactWriteItemsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.TransactWriteItemsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) UntagResource(ctx context.Context, request operations.UntagResourceRequest) (*operations.UntagResourceResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.UntagResource"
...
func (s *SDK) UpdateContinuousBackups(ctx context.Context, request operations.UpdateContinuousBackupsRequest) (*operations.UpdateContinuousBackupsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.UpdateContinuousBackups"
	...
	res := &operations.UpdateContinuousBackupsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.UpdateContinuousBackupsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) UpdateContributorInsights(ctx context.Context, request operations.UpdateContributorInsightsRequest) (*operations.UpdateContributorInsightsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.UpdateContributorInsights"
	...
	res := &operations.UpdateContributorInsightsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.UpdateContributorInsightsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) UpdateGlobalTable(ctx context.Context, request operations.UpdateGlobalTableRequest) (*operations.UpdateGlobalTableResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.UpdateGlobalTable"
	...
	res := &operations.UpdateGlobalTableResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.UpdateGlobalTableOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) UpdateGlobalTableSettings(ctx context.Context, request operations.UpdateGlobalTableSettingsRequest) (*operations.UpdateGlobalTableSettingsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.UpdateGlobalTableSettings"
	...
	res := &operations.UpdateGlobalTableSettingsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.UpdateGlobalTableSettingsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) UpdateItem(ctx context.Context, request operations.UpdateItemRequest) (*operations.UpdateItemResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.UpdateItem"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.UpdateItemOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) UpdateTable(ctx context.Context, request operations.UpdateTableRequest) (*operations.UpdateTableResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.UpdateTable"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.UpdateTableOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) UpdateTableReplicaAutoScaling(ctx context.Context, request operations.UpdateTableReplicaAutoScalingRequest) (*operations.UpdateTableReplicaAutoScalingResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.UpdateTableReplicaAutoScaling"
	...
	res := &operations.UpdateTableReplicaAutoScalingResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.UpdateTableReplicaAutoScalingOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) UpdateTimeToLive(ctx context.Context, request operations.UpdateTimeToLiveRequest) (*operations.UpdateTimeToLiveResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=DynamoDB_20120810.UpdateTimeToLive"
	...
	res := &operations.UpdateTimeToLiveResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.UpdateTimeToLiveOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
