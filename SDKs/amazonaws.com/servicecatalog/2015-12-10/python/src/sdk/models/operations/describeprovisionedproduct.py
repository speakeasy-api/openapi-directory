...
class DescribeProvisionedProductRequest:
    ...
    describe_provisioned_product_input: shared_describeprovisionedproductinput.DescribeProvisionedProductInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
