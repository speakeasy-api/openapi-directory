...
public class DescribeResourceCollectionHealthRequest {
    ...
    public DescribeResourceCollectionHealthRequest(@JsonProperty("ResourceCollectionType") DescribeResourceCollectionHealthResourceCollectionTypeEnum resourceCollectionType) {
        this.resourceCollectionType = resourceCollectionType;
  }
}
