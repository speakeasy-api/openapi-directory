...
class DetectorSummary:
    ...
    state: Optional[shared_detectorstatesummary.DetectorStateSummary] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})  
