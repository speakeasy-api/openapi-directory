...
var OrdersShipLineItemsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: ordershipmentlineitemshipment_1.OrderShipmentLineItemShipment }),
        (0, class_transformer_1.Expose)({ name: "lineItems" }),
        (0, class_transformer_1.Type)(function () { return ordershipmentlineitemshipment_1.OrderShipmentLineItemShipment; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "shipmentGroupId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: orderscustombatchrequestentryshiplineitemsshipmentinfo_1.OrdersCustomBatchRequestEntryShipLineItemsShipmentInfo,
        }),
        (0, class_transformer_1.Expose)({ name: "shipmentInfos" }),
        (0, class_transformer_1.Type)(function () { return orderscustombatchrequestentryshiplineitemsshipmentinfo_1.OrdersCustomBatchRequestEntryShipLineItemsShipmentInfo; }),
        __metadata("design:type", Array)
