...
class CreateFilePaymentConsentsRequests:
    ...
    ob_write_file_consent3: Optional[shared_obwritefileconsent3.ObWriteFileConsent3] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    ob_write_file_consent4: Optional[shared_obwritefileconsent3.ObWriteFileConsent3] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class CreateFilePaymentConsentsRequest:
    headers: CreateFilePaymentConsentsHeaders = dataclasses.field()
    request: CreateFilePaymentConsentsRequests = dataclasses.field()
    security: CreateFilePaymentConsentsSecurity = dataclasses.field()
