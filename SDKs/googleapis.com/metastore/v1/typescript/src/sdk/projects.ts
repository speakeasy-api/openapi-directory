...
export class Projects {
  ...
  **/
  metastoreProjectsLocationsFederationsCreate(
    ...
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/federations", req.pathParams);
  ...
  **/
  metastoreProjectsLocationsServicesBackupsGetIamPolicy(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.MetastoreProjectsLocationsServicesBackupsGetIamPolicyRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.MetastoreProjectsLocationsServicesBackupsGetIamPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  metastoreProjectsLocationsServicesBackupsSetIamPolicy(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.MetastoreProjectsLocationsServicesBackupsSetIamPolicyRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.MetastoreProjectsLocationsServicesBackupsSetIamPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.policy = httpRes?.data;
  ...
  **/
  metastoreProjectsLocationsServicesExportMetadata(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{service}:exportMetadata", req.pathParams);
  ...
  **/
  metastoreProjectsLocationsServicesMetadataImportsCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/metadataImports", req.pathParams);
  ...
  **/
  metastoreProjectsLocationsServicesRestore(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{service}:restore", req.pathParams);
  ...
  **/
  metastoreProjectsLocationsServicesTestIamPermissions(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.MetastoreProjectsLocationsServicesTestIamPermissionsRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.MetastoreProjectsLocationsServicesTestIamPermissionsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
