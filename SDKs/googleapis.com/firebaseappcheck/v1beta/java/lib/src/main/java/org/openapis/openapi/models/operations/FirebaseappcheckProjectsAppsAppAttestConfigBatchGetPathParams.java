...
public class FirebaseappcheckProjectsAppsAppAttestConfigBatchGetPathParams {
    /**
    ...
    public FirebaseappcheckProjectsAppsAppAttestConfigBatchGetPathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
