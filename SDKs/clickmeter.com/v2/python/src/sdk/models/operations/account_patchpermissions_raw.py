...
class AccountPatchPermissionsRawTypeEnum(str, Enum):
...
class AccountPatchPermissionsRawRequest:
    ...
    type: AccountPatchPermissionsRawTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'type', 'style': 'simple', 'explode': False }})
    r"""Can be \\"datapoint\\" or \\"group\\" """  
    

@dataclasses.dataclass
class AccountPatchPermissionsRawResponse:
