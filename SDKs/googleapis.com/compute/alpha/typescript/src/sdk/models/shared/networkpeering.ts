 ...
 */
export enum NetworkPeeringStackTypeEnum {
  Ipv4Ipv6 = "IPV4_IPV6",
  Ipv4Only = "IPV4_ONLY",
}
 ...
 */
export enum NetworkPeeringStateEnum {
  Active = "ACTIVE",
  Inactive = "INACTIVE",
}
...
export class NetworkPeering extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "exchangeSubnetRoutes" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "exportSubnetRoutesWithPublicIp" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "importSubnetRoutesWithPublicIp" })
