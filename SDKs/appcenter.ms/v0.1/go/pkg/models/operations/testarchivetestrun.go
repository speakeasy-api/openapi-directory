...
type TestArchiveTestRunSecurity struct {
	APIToken shared.SchemeAPIToken `security:"scheme,type=apiKey,subtype=header"`
}

type TestArchiveTestRunPathParams struct {
...
type TestArchiveTestRunRequest struct {
	PathParams TestArchiveTestRunPathParams
	Security   TestArchiveTestRunSecurity
}

// TestArchiveTestRunTestRunTestRunStatistics - Summary single test run on Xamarin Test Cloud
type TestArchiveTestRunTestRunTestRunStatistics struct {
...
type TestArchiveTestRunTestRun struct {
	...
	Stats *TestArchiveTestRunTestRunTestRunStatistics `json:"stats,omitempty"`
...
type TestArchiveTestRunResponse struct {
	ContentType string
	StatusCode  int
