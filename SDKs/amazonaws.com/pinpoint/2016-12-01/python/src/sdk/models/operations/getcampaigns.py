...
from ..shared import getcampaignsresponse as shared_getcampaignsresponse


@dataclasses.dataclass
class GetCampaignsPathParams:
...
class GetCampaignsRequest:
    headers: GetCampaignsHeaders = dataclasses.field()
    path_params: GetCampaignsPathParams = dataclasses.field()
...
class GetCampaignsResponse:
    ...
    get_campaigns_response: Optional[shared_getcampaignsresponse.GetCampaignsResponse] = dataclasses.field(default=None)
