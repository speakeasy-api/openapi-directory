...
class GetSubscriptionDefinitionVersionRequest:
    headers: GetSubscriptionDefinitionVersionHeaders = dataclasses.field()
    path_params: GetSubscriptionDefinitionVersionPathParams = dataclasses.field()
    query_params: GetSubscriptionDefinitionVersionQueryParams = dataclasses.field()
