...
func (e MonitorV1AlertInstanceRequestMethodEnum) ToPointer() *MonitorV1AlertInstanceRequestMethodEnum {
	return &e
}
...
func (e *MonitorV1AlertInstanceRequestMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = MonitorV1AlertInstanceRequestMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for MonitorV1AlertInstanceRequestMethodEnum: %v", v)
	}
}
