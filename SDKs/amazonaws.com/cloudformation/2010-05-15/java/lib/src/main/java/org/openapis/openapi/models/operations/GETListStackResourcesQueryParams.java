...
public class GETListStackResourcesQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=Action")
    public GETListStackResourcesActionEnum action;
    public GETListStackResourcesQueryParams withAction(GETListStackResourcesActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETListStackResourcesQueryParams withNextToken(String nextToken) {
    ...
    public GETListStackResourcesQueryParams withStackName(String stackName) {
    ...
    public GETListStackResourcesQueryParams withVersion(GETListStackResourcesVersionEnum version) {
