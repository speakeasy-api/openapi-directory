...
class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsApproveRequest:
    ...
    r"""Required. Name of the Rollout. Format is projects/{project}/locations/{location}/deliveryPipelines/{deliveryPipeline}/ releases/{release}/rollouts/{rollout}."""  
    ...
    approve_rollout_request: Optional[shared_approverolloutrequest.ApproveRolloutRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
