...
func (e *GETDeletePlacementGroupActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DeletePlacementGroup":
		*e = GETDeletePlacementGroupActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDeletePlacementGroupActionEnum: %s", s)
	}
}
...
func (e *GETDeletePlacementGroupVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2016-11-15":
		*e = GETDeletePlacementGroupVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDeletePlacementGroupVersionEnum: %s", s)
	}
}
