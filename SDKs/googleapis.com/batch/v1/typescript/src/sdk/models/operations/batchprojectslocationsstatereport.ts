...
export class BatchProjectsLocationsStateReportSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BatchProjectsLocationsStateReportRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BatchProjectsLocationsStateReportResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
