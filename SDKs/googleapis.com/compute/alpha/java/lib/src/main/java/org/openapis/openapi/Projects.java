...
public class Projects {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeProjectsSetDefaultServiceAccountResponse computeProjectsSetDefaultServiceAccount(org.openapis.openapi.models.operations.ComputeProjectsSetDefaultServiceAccountRequest request, org.openapis.openapi.models.operations.ComputeProjectsSetDefaultServiceAccountSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeProjectsSetDefaultServiceAccountRequest.class, baseUrl, "/projects/{project}/setDefaultServiceAccount", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "projectsSetDefaultServiceAccountRequest", "json");
        req.setBody(serializedRequestBody);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeProjectsSetDefaultServiceAccountRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.ComputeProjectsSetDefaultServiceAccountResponse res = new org.openapis.openapi.models.operations.ComputeProjectsSetDefaultServiceAccountResponse(contentType, httpRes.statusCode()) {{
            operation = null;
        }};
        res.rawResponse = httpRes;
