 ...
 */
export class ListKeysRequestBodyFilter extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "KeyStatus" })
  keyStatus?: shared.StatusEnum;
}

export class ListKeysRequestBody extends SpeakeasyBase {
  /**
   * Options for filtering API keys.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "Filter" })
  @Type(() => ListKeysRequestBodyFilter)
