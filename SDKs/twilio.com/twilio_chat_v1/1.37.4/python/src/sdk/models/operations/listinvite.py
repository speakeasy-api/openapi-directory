...
class ListInviteListInviteResponse:
    invites: Optional[list[shared_chat_v1_service_channel_invite.ChatV1ServiceChannelInvite]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('invites') }})
