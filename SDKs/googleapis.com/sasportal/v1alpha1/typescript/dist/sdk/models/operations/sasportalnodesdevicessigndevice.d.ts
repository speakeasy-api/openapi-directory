...
export declare class SasportalNodesDevicesSignDeviceSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesDevicesSignDeviceSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
