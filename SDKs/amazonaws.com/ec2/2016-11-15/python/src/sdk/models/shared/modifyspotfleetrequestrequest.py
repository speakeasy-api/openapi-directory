...
class ModifySpotFleetRequestRequestExcessCapacityTerminationPolicyEnum(str, Enum):
    r"""<p>Indicates whether running instances should be terminated if the target capacity of the Spot Fleet request is decreased below the current size of the Spot Fleet.</p> <p>Supported only for fleets of type <code>maintain</code>.</p>"""
    NO_TERMINATION = 'noTermination'
    DEFAULT = 'default'


@dataclasses.dataclass
class ModifySpotFleetRequestRequestLaunchTemplateConfigsLaunchTemplateSpecification:
...
@dataclasses.dataclass
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorCount:
...
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorManufacturersEnum(str, Enum):
    NVIDIA = 'nvidia'
    AMD = 'amd'
    AMAZON_WEB_SERVICES = 'amazon-web-services'
    XILINX = 'xilinx'

class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorNamesEnum(str, Enum):
    A100 = 'a100'
    V100 = 'v100'
    K80 = 'k80'
    T4 = 't4'
...
@dataclasses.dataclass
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorTotalMemoryMiB:
    r"""<p>The minimum and maximum amount of total accelerator memory, in MiB.</p> <p>Default: No minimum or maximum limits</p>"""
    
    max: Optional[int] = dataclasses.field(default=None)  
    min: Optional[int] = dataclasses.field(default=None)  
    
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorTypesEnum(str, Enum):
    GPU = 'gpu'
    FPGA = 'fpga'
    INFERENCE = 'inference'

class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsBareMetalEnum(str, Enum):
...
@dataclasses.dataclass
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsBaselineEbsBandwidthMbps:
...
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsBurstablePerformanceEnum(str, Enum):
...
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsCPUManufacturersEnum(str, Enum):
    INTEL = 'intel'
    AMD = 'amd'
    AMAZON_WEB_SERVICES = 'amazon-web-services'

class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsInstanceGenerationsEnum(str, Enum):
    CURRENT = 'current'
    PREVIOUS = 'previous'

class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsLocalStorageEnum(str, Enum):
...
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsLocalStorageTypesEnum(str, Enum):
    HDD = 'hdd'
    SSD = 'ssd'


@dataclasses.dataclass
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsMemoryGiBPerVCPU:
...
@dataclasses.dataclass
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsMemoryMiB:
...
@dataclasses.dataclass
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsNetworkBandwidthGbps:
...
@dataclasses.dataclass
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsNetworkInterfaceCount:
...
@dataclasses.dataclass
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsTotalLocalStorageGB:
...
@dataclasses.dataclass
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsVCPUCount:
...
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirements:
    ...
    accelerator_count: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorCount] = dataclasses.field(default=None)  
    accelerator_manufacturers: Optional[list[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorManufacturersEnum]] = dataclasses.field(default=None)  
    accelerator_names: Optional[list[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorNamesEnum]] = dataclasses.field(default=None)  
    accelerator_total_memory_mi_b: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorTotalMemoryMiB] = dataclasses.field(default=None)  
    accelerator_types: Optional[list[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorTypesEnum]] = dataclasses.field(default=None)  
    allowed_instance_types: Optional[list[str]] = dataclasses.field(default=None)  
    bare_metal: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsBareMetalEnum] = dataclasses.field(default=None)  
    baseline_ebs_bandwidth_mbps: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsBaselineEbsBandwidthMbps] = dataclasses.field(default=None)  
    burstable_performance: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsBurstablePerformanceEnum] = dataclasses.field(default=None)  
    cpu_manufacturers: Optional[list[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsCPUManufacturersEnum]] = dataclasses.field(default=None)  
    excluded_instance_types: Optional[list[str]] = dataclasses.field(default=None)  
    instance_generations: Optional[list[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsInstanceGenerationsEnum]] = dataclasses.field(default=None)  
    local_storage: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsLocalStorageEnum] = dataclasses.field(default=None)  
    local_storage_types: Optional[list[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsLocalStorageTypesEnum]] = dataclasses.field(default=None)  
    memory_gi_b_per_v_cpu: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsMemoryGiBPerVCPU] = dataclasses.field(default=None)  
    memory_mi_b: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsMemoryMiB] = dataclasses.field(default=None)  
    network_bandwidth_gbps: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsNetworkBandwidthGbps] = dataclasses.field(default=None)  
    network_interface_count: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsNetworkInterfaceCount] = dataclasses.field(default=None)  
    ...
    total_local_storage_gb: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsTotalLocalStorageGB] = dataclasses.field(default=None)  
    v_cpu_count: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirementsVCPUCount] = dataclasses.field(default=None)  
    
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceTypeEnum(str, Enum):
    r"""The instance type."""
    A1_MEDIUM = 'a1.medium'
    A1_LARGE = 'a1.large'
    A1_XLARGE = 'a1.xlarge'
...
class ModifySpotFleetRequestRequestLaunchTemplateConfigsOverrides:
    ...
    instance_requirements: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceRequirements] = dataclasses.field(default=None)  
    instance_type: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverridesInstanceTypeEnum] = dataclasses.field(default=None)  
...
class ModifySpotFleetRequestRequestLaunchTemplateConfigs:
    ...
    launch_template_specification: Optional[ModifySpotFleetRequestRequestLaunchTemplateConfigsLaunchTemplateSpecification] = dataclasses.field(default=None)  
    overrides: Optional[list[ModifySpotFleetRequestRequestLaunchTemplateConfigsOverrides]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class ModifySpotFleetRequestRequest:
    r"""Contains the parameters for ModifySpotFleetRequest."""
    
    spot_fleet_request_id: str = dataclasses.field()  
    context: Optional[str] = dataclasses.field(default=None)  
    excess_capacity_termination_policy: Optional[ModifySpotFleetRequestRequestExcessCapacityTerminationPolicyEnum] = dataclasses.field(default=None)  
    launch_template_configs: Optional[list[ModifySpotFleetRequestRequestLaunchTemplateConfigs]] = dataclasses.field(default=None)  
    on_demand_target_capacity: Optional[int] = dataclasses.field(default=None)  
    target_capacity: Optional[int] = dataclasses.field(default=None)  
