...
public class HealthGetDBSecurity {
    ...
    public HealthGetDBSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public HealthGetDBSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public HealthGetDBSecurity(@JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.key = key;
        this.project = project;
  }
}
