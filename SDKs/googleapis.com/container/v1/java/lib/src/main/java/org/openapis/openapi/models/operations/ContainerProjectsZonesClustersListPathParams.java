...
public class ContainerProjectsZonesClustersListPathParams {
    /**
     * Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the parent field.
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=projectId")
    public String projectId;
    public ContainerProjectsZonesClustersListPathParams withProjectId(String projectId) {
    ...
    public String zone;
    public ContainerProjectsZonesClustersListPathParams withZone(String zone) {
        this.zone = zone;
        return this;
    }
