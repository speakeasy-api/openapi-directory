...
class GoogleAppsDriveLabelsV2LabelAppliedLabelPolicy:
    ...
    copy_mode: Optional[GoogleAppsDriveLabelsV2LabelAppliedLabelPolicyCopyModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('copyMode') }})
