...
class GoogleCloudVisionV1p2beta1OutputConfig:
    ...
    gcs_destination: Optional[shared_googlecloudvisionv1p2beta1gcsdestination.GoogleCloudVisionV1p2beta1GcsDestination] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('gcsDestination'), 'exclude': lambda f: f is None }})
