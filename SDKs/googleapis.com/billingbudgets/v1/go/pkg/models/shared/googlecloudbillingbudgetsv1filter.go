...
func (e GoogleCloudBillingBudgetsV1FilterCalendarPeriodEnum) ToPointer() *GoogleCloudBillingBudgetsV1FilterCalendarPeriodEnum {
	return &e
}

func (e *GoogleCloudBillingBudgetsV1FilterCalendarPeriodEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "QUARTER":
		fallthrough
	case "YEAR":
		*e = GoogleCloudBillingBudgetsV1FilterCalendarPeriodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudBillingBudgetsV1FilterCalendarPeriodEnum: %v", v)
	}
}
...
func (e GoogleCloudBillingBudgetsV1FilterCreditTypesTreatmentEnum) ToPointer() *GoogleCloudBillingBudgetsV1FilterCreditTypesTreatmentEnum {
	return &e
}

func (e *GoogleCloudBillingBudgetsV1FilterCreditTypesTreatmentEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "INCLUDE_SPECIFIED_CREDITS":
		*e = GoogleCloudBillingBudgetsV1FilterCreditTypesTreatmentEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudBillingBudgetsV1FilterCreditTypesTreatmentEnum: %v", v)
	}
}
