...
class AdexchangebuyerMarketplacedealsInsertRequest:
    ...
    r"""proposalId for which deals need to be added."""  
    add_order_deals_request: Optional[shared_addorderdealsrequest.AddOrderDealsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
