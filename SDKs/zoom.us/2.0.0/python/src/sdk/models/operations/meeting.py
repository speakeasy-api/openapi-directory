...
class MeetingRequest:
    ...
    r"""Meeting Occurrence ID. Provide this field to view meeting details of a particular occurrence of the [recurring meeting](https://support.zoom.us/hc/en-us/articles/214973206-Scheduling-Recurring-Meetings)."""  
    ...
    r"""Set the value of this field to `true` if you would like to view meeting details of all previous occurrences of a [recurring meeting](https://support.zoom.us/hc/en-us/articles/214973206-Scheduling-Recurring-Meetings)."""  
    

@dataclasses.dataclass
class Meeting200ApplicationXMLOccurrences:
...
class Meeting200ApplicationXMLRecurrenceMonthlyWeekEnum(str, Enum):
...
class Meeting200ApplicationXMLRecurrenceMonthlyWeekDayEnum(str, Enum):
...
class Meeting200ApplicationXMLRecurrenceTypeEnum(str, Enum):
    r"""Recurrence meeting types:<br>`1` - Daily.<br>`2` - Weekly.<br>`3` - Monthly."""
    ONE = '1'
    TWO = '2'
    THREE = '3'

class Meeting200ApplicationXMLRecurrenceWeeklyDaysEnum(str, Enum):
...
class Meeting200ApplicationXMLRecurrence:
    ...
    """  
    monthly_week: Optional[Meeting200ApplicationXMLRecurrenceMonthlyWeekEnum] = dataclasses.field(default=None)
    r"""Use this field **only if you're scheduling a recurring meeting of type** `3` to state the week of the month when the meeting should recur. If you use this field, **you must also use the `monthly_week_day` field to state the day of the week when the meeting should recur.** <br>`-1` - Last week of the month.<br>`1` - First week of the month.<br>`2` - Second week of the month.<br>`3` - Third week of the month.<br>`4` - Fourth week of the month."""  
    monthly_week_day: Optional[Meeting200ApplicationXMLRecurrenceMonthlyWeekDayEnum] = dataclasses.field(default=None)
    r"""Use this field **only if you're scheduling a recurring meeting of type** `3` to state a specific day in a week when the monthly meeting should recur. To use this field, you must also use the `monthly_week` field.
    ...
    """  
    weekly_days: Optional[Meeting200ApplicationXMLRecurrenceWeeklyDaysEnum] = dataclasses.field(default=None)
    r"""This field is required **if you're scheduling a recurring meeting of type** `2` to state which day(s) of the week the meeting should repeat. <br> <br> The value for this field could be a number between `1` to `7` in string format. For instance, if the meeting should recur on Sunday, provide `\\"1\\"` as the value of this field.<br><br> **Note:** If you would like the meeting to occur on multiple days of a week, you should provide comma separated values for this field. For instance, if the meeting should recur on Sundays and Tuesdays provide `\\"1,3\\"` as the value of this field.
    
     <br>`1`  - Sunday. <br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` -  Thursday.<br>`6` - Friday.<br>`7` - Saturday.
    """  
    
class Meeting200ApplicationXMLSettingsApprovalTypeEnum(str, Enum):
...
class Meeting200ApplicationXMLSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum(str, Enum):
...
@dataclasses.dataclass
class Meeting200ApplicationXMLSettingsApprovedOrDeniedCountriesOrRegions:
    ...
    """  
    method: Optional[Meeting200ApplicationXMLSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum] = dataclasses.field(default=None)
    r"""Specify whether to allow users from specific regions to join this meeting; or block users from specific regions from joining this meeting. <br><br>
    `approve`: Allow users from specific regions/countries to join this meeting. If this setting is selected, the approved regions/countries must be included in the `approved_list`.<br><br>
    `deny`: Block users from specific regions/countries from joining this meeting. If this setting is selected, the approved regions/countries must be included in the `denied_list`
    """  
    
class Meeting200ApplicationXMLSettingsAudioEnum(str, Enum):
...
class Meeting200ApplicationXMLSettingsAutoRecordingEnum(str, Enum):
...
@dataclasses.dataclass
class Meeting200ApplicationXMLSettingsBreakoutRoomRooms:
...
class Meeting200ApplicationXMLSettingsBreakoutRoom:
    ...
    rooms: Optional[list[Meeting200ApplicationXMLSettingsBreakoutRoomRooms]] = dataclasses.field(default=None)
    r"""Create room(s)."""  
...
class Meeting200ApplicationXMLSettingsEncryptionTypeEnum(str, Enum):
...
class Meeting200ApplicationXMLSettingsGlobalDialInNumbersTypeEnum(str, Enum):
    r"""Type of number."""
    TOLL = 'toll'
    TOLLFREE = 'tollfree'
...
@dataclasses.dataclass
class Meeting200ApplicationXMLSettingsGlobalDialInNumbers:
    ...
    type: Optional[Meeting200ApplicationXMLSettingsGlobalDialInNumbersTypeEnum] = dataclasses.field(default=None)
    r"""Type of number."""  
    
class Meeting200ApplicationXMLSettingsJbhTimeEnum(str, Enum):
...
@dataclasses.dataclass
class Meeting200ApplicationXMLSettingsLanguageInterpretationInterpreters:
...
class Meeting200ApplicationXMLSettingsLanguageInterpretation:
    ...
    enable: Optional[bool] = dataclasses.field(default=None)  
    interpreters: Optional[list[Meeting200ApplicationXMLSettingsLanguageInterpretationInterpreters]] = dataclasses.field(default=None)
    r"""Information associated with the interpreter."""  
    
class Meeting200ApplicationXMLSettingsRegistrationTypeEnum(str, Enum):
...
@dataclasses.dataclass
class Meeting200ApplicationXMLSettings:
    r"""Meeting settings."""
    ...
    approval_type: Optional[Meeting200ApplicationXMLSettingsApprovalTypeEnum] = dataclasses.field(default=None)
    r"""Enable registration and set approval for the registration. Note that this feature requires the host to be of **Licensed** user type. **Registration cannot be enabled for a basic user.** <br><br>
    
    `0` - Automatically approve.<br>`1` - Manually approve.<br>`2` - No registration required.
    """  
    approved_or_denied_countries_or_regions: Optional[Meeting200ApplicationXMLSettingsApprovedOrDeniedCountriesOrRegions] = dataclasses.field(default=None)
    r"""Approve or block users from specific regions/countries from joining this meeting."""  
    audio: Optional[Meeting200ApplicationXMLSettingsAudioEnum] = dataclasses.field(default=None)
    r"""Determine how participants can join the audio portion of the meeting.<br>`both` - Both Telephony and VoIP.<br>`telephony` - Telephony only.<br>`voip` - VoIP only."""  
    ...
    authentication_exception: Optional[list[Meeting200ApplicationXMLSettingsAuthenticationException]] = dataclasses.field(default=None)
    ...
    auto_recording: Optional[Meeting200ApplicationXMLSettingsAutoRecordingEnum] = dataclasses.field(default=None)
    r"""Automatic recording:<br>`local` - Record on local.<br>`cloud` -  Record on cloud.<br>`none` - Disabled."""  
    breakout_room: Optional[Meeting200ApplicationXMLSettingsBreakoutRoom] = dataclasses.field(default=None)
    r"""Setting to [pre-assign breakout rooms](https://support.zoom.us/hc/en-us/articles/360032752671-Pre-assigning-participants-to-breakout-rooms#h_36f71353-4190-48a2-b999-ca129861c1f4)."""  
    ...
    custom_keys: Optional[list[Meeting200ApplicationXMLSettingsCustomKeys]] = dataclasses.field(default=None)
    r"""Custom keys and values assigned to the meeting."""  
    encryption_type: Optional[Meeting200ApplicationXMLSettingsEncryptionTypeEnum] = dataclasses.field(default=None)
    r"""Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
    `enhanced_encryption`: Enhanced encryption. Encryption is stored in the cloud if you enable this option. <br>
    ...
    **This field is deprecated and will not be supported in the future.**  <br><br>As an alternative, use the \"meeting_authentication\", \"authentication_option\" and \"authentication_domains\" fields to understand the [authentication configurations](https://support.zoom.us/hc/en-us/articles/360037117472-Authentication-Profiles-for-Meetings-and-Webinars) set for the meeting.
    ...
    global_dial_in_numbers: Optional[list[Meeting200ApplicationXMLSettingsGlobalDialInNumbers]] = dataclasses.field(default=None)
    ...
    jbh_time: Optional[Meeting200ApplicationXMLSettingsJbhTimeEnum] = dataclasses.field(default=None)
    r"""If the value of \\"join_before_host\\" field is set to true, this field can be used to indicate time limits within which a participant may join a meeting before a host. The value of this field can be one of the following:
    ...
    *  `5`: Allow participant to join 5 minutes before meeting start time.
    ...
    language_interpretation: Optional[Meeting200ApplicationXMLSettingsLanguageInterpretation] = dataclasses.field(default=None)  
    ...
    registration_type: Optional[Meeting200ApplicationXMLSettingsRegistrationTypeEnum] = dataclasses.field(default=None)
    r"""Registration type. Used for recurring meeting with fixed time only. <br>`1` Attendees register once and can attend any of the occurrences.<br>`2` Attendees need to register for each occurrence to attend.<br>`3` Attendees register once and can choose one or more occurrences to attend."""  
...
class Meeting200ApplicationXMLStatusEnum(str, Enum):
    r"""Meeting status"""
    WAITING = 'waiting'
    STARTED = 'started'
...
@dataclasses.dataclass
class Meeting200ApplicationXMLTrackingFields:
...
class Meeting200ApplicationXMLTypeEnum(str, Enum):
    r"""Meeting Types:<br>`1` - Instant meeting.<br>`2` - Scheduled meeting.<br>`3` - Recurring meeting with no fixed time.<br>`4` - PMI Meeting<br>
...
class Meeting200ApplicationXML:
    ...
    duration: Optional[int] = dataclasses.field(default=None)
    r"""Meeting duration."""  
    encrypted_password: Optional[str] = dataclasses.field(default=None)
    r"""Encrypted passcode for third party endpoints (H323/SIP)."""  
    h323_password: Optional[str] = dataclasses.field(default=None)
    r"""H.323/SIP room system passcode."""  
    ...
    r"""ID of the user who is set as host of meeting."""  
    ...
    occurrences: Optional[list[Meeting200ApplicationXMLOccurrences]] = dataclasses.field(default=None)
    ...
    recurrence: Optional[Meeting200ApplicationXMLRecurrence] = dataclasses.field(default=None)
    r"""Recurrence object. Use this object only for a meeting with type `8` i.e., a recurring meeting with fixed time."""  
    settings: Optional[Meeting200ApplicationXMLSettings] = dataclasses.field(default=None)
    r"""Meeting settings."""  
    start_time: Optional[datetime] = dataclasses.field(default=None)
    r"""Meeting start time in GMT/UTC. Start time will not be returned if the meeting is an **instant** meeting."""  
    start_url: Optional[str] = dataclasses.field(default=None)
    r"""<br><aside>The <code>start_url</code> of a Meeting is a URL using which a host or an alternative host can start the Meeting.
    ...
    """  
    status: Optional[Meeting200ApplicationXMLStatusEnum] = dataclasses.field(default=None)
    r"""Meeting status"""  
    timezone: Optional[str] = dataclasses.field(default=None)
    r"""Timezone to format the meeting start time on the ."""  
    topic: Optional[str] = dataclasses.field(default=None)
    r"""Meeting topic."""  
    tracking_fields: Optional[list[Meeting200ApplicationXMLTrackingFields]] = dataclasses.field(default=None)
    r"""Tracking fields"""  
    type: Optional[Meeting200ApplicationXMLTypeEnum] = dataclasses.field(default=None)
    r"""Meeting Types:<br>`1` - Instant meeting.<br>`2` - Scheduled meeting.<br>`3` - Recurring meeting with no fixed time.<br>`4` - PMI Meeting<br>
    `8` - Recurring meeting with a fixed time.
    """  
    uuid: Optional[str] = dataclasses.field(default=None)
    r"""Unique meeting ID. Each meeting instance will generate its own Meeting UUID (i.e., after a meeting ends, a new UUID will be generated for the next instance of the meeting). You can retrieve a list of UUIDs from past meeting instances using [this API](https://marketplace.zoom.us/docs/api-reference/zoom-api/meetings/pastmeetings) . Please double encode your UUID when using it for API calls if the UUID begins with a '/'or contains '//' in it."""  
...
class Meeting200ApplicationJSONRecurrenceMonthlyWeekEnum(str, Enum):
    r"""Use this field **only if you're scheduling a recurring meeting of type** `3` to state the week of the month when the meeting should recur. If you use this field, **you must also use the `monthly_week_day` field to state the day of the week when the meeting should recur.** <br>`-1` - Last week of the month.<br>`1` - First week of the month.<br>`2` - Second week of the month.<br>`3` - Third week of the month.<br>`4` - Fourth week of the month."""
    MINUS_1 = '-1'
    ONE = '1'
    TWO = '2'
...
class Meeting200ApplicationJSONRecurrenceMonthlyWeekDayEnum(str, Enum):
    r"""Use this field **only if you're scheduling a recurring meeting of type** `3` to state a specific day in a week when the monthly meeting should recur. To use this field, you must also use the `monthly_week` field.
...
class Meeting200ApplicationJSONRecurrenceTypeEnum(str, Enum):
    r"""Recurrence meeting types:<br>`1` - Daily.<br>`2` - Weekly.<br>`3` - Monthly."""
    ONE = '1'
    TWO = '2'
    THREE = '3'
...
class Meeting200ApplicationJSONRecurrence:
    ...
    type: Meeting200ApplicationJSONRecurrenceTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Recurrence meeting types:<br>`1` - Daily.<br>`2` - Weekly.<br>`3` - Monthly."""  
    ...
    For instance, if you would like the meeting to recur on 23rd of each month, provide `23` as the value of this field and `1` as the value of the `repeat_interval` field. Instead, if you would like the meeting to recur every three months, on 23rd of the month, change the value of the `repeat_interval` field to `3`.
    """  
    monthly_week: Optional[Meeting200ApplicationJSONRecurrenceMonthlyWeekEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('monthly_week'), 'exclude': lambda f: f is None }})
    r"""Use this field **only if you're scheduling a recurring meeting of type** `3` to state the week of the month when the meeting should recur. If you use this field, **you must also use the `monthly_week_day` field to state the day of the week when the meeting should recur.** <br>`-1` - Last week of the month.<br>`1` - First week of the month.<br>`2` - Second week of the month.<br>`3` - Third week of the month.<br>`4` - Fourth week of the month."""  
    monthly_week_day: Optional[Meeting200ApplicationJSONRecurrenceMonthlyWeekDayEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('monthly_week_day'), 'exclude': lambda f: f is None }})
    r"""Use this field **only if you're scheduling a recurring meeting of type** `3` to state a specific day in a week when the monthly meeting should recur. To use this field, you must also use the `monthly_week` field.
    ...
    For a daily meeting, the maximum interval you can set is `90` days. For a weekly meeting the maximum interval that you can set is  of `12` weeks. For a monthly meeting, there is a maximum of `3` months.
    """  
    weekly_days: Optional[Meeting200ApplicationJSONRecurrenceWeeklyDaysEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('weekly_days'), 'exclude': lambda f: f is None }})
    r"""This field is required **if you're scheduling a recurring meeting of type** `2` to state which day(s) of the week the meeting should repeat. <br> <br> The value for this field could be a number between `1` to `7` in string format. For instance, if the meeting should recur on Sunday, provide `\\"1\\"` as the value of this field.<br><br> **Note:** If you would like the meeting to occur on multiple days of a week, you should provide comma separated values for this field. For instance, if the meeting should recur on Sundays and Tuesdays provide `\\"1,3\\"` as the value of this field.
    
     <br>`1`  - Sunday. <br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` -  Thursday.<br>`6` - Friday.<br>`7` - Saturday.
    """  
    
class Meeting200ApplicationJSONSettingsApprovalTypeEnum(str, Enum):
    r"""Enable registration and set approval for the registration. Note that this feature requires the host to be of **Licensed** user type. **Registration cannot be enabled for a basic user.** <br><br>
...
class Meeting200ApplicationJSONSettingsApprovedOrDeniedCountriesOrRegions:
    ...
    `false`: Setting disabled.
    """  
    method: Optional[Meeting200ApplicationJSONSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('method'), 'exclude': lambda f: f is None }})
    r"""Specify whether to allow users from specific regions to join this meeting; or block users from specific regions from joining this meeting. <br><br>
    `approve`: Allow users from specific regions/countries to join this meeting. If this setting is selected, the approved regions/countries must be included in the `approved_list`.<br><br>
    `deny`: Block users from specific regions/countries from joining this meeting. If this setting is selected, the approved regions/countries must be included in the `denied_list`
    """  
...
class Meeting200ApplicationJSONSettingsBreakoutRoom:
    ...
    enable: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('enable'), 'exclude': lambda f: f is None }})
    r"""Set the value of this field to `true` if you would like to enable the [breakout room pre-assign](https://support.zoom.us/hc/en-us/articles/360032752671-Pre-assigning-participants-to-breakout-rooms#h_36f71353-4190-48a2-b999-ca129861c1f4) option."""  
    rooms: Optional[list[Meeting200ApplicationJSONSettingsBreakoutRoomRooms]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rooms'), 'exclude': lambda f: f is None }})
    r"""Create room(s)."""  
...
class Meeting200ApplicationJSONSettingsGlobalDialInNumbers:
    ...
    r"""Phone number. For example, +1 2332357613."""  
    type: Optional[Meeting200ApplicationJSONSettingsGlobalDialInNumbersTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Type of number."""  
    
class Meeting200ApplicationJSONSettingsJbhTimeEnum(str, Enum):
    r"""If the value of \\"join_before_host\\" field is set to true, this field can be used to indicate time limits within which a participant may join a meeting before a host. The value of this field can be one of the following:
...
class Meeting200ApplicationJSONSettingsLanguageInterpretation:
    ...
    enable: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('enable'), 'exclude': lambda f: f is None }})  
    interpreters: Optional[list[Meeting200ApplicationJSONSettingsLanguageInterpretationInterpreters]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('interpreters'), 'exclude': lambda f: f is None }})
    r"""Information associated with the interpreter."""  
    
class Meeting200ApplicationJSONSettingsRegistrationTypeEnum(str, Enum):
    r"""Registration type. Used for recurring meeting with fixed time only. <br>`1` Attendees register once and can attend any of the occurrences.<br>`2` Attendees need to register for each occurrence to attend.<br>`3` Attendees register once and can choose one or more occurrences to attend."""
    ONE = '1'
    TWO = '2'
    THREE = '3'
...
class Meeting200ApplicationJSONSettings:
    ...
    r"""Flag to determine whether to send email notifications to alternative hosts, default value is true."""  
    approval_type: Optional[Meeting200ApplicationJSONSettingsApprovalTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('approval_type'), 'exclude': lambda f: f is None }})
    r"""Enable registration and set approval for the registration. Note that this feature requires the host to be of **Licensed** user type. **Registration cannot be enabled for a basic user.** <br><br>
    
    `0` - Automatically approve.<br>`1` - Manually approve.<br>`2` - No registration required.
    """  
    approved_or_denied_countries_or_regions: Optional[Meeting200ApplicationJSONSettingsApprovedOrDeniedCountriesOrRegions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('approved_or_denied_countries_or_regions'), 'exclude': lambda f: f is None }})
    r"""Approve or block users from specific regions/countries from joining this meeting."""  
    audio: Optional[Meeting200ApplicationJSONSettingsAudioEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('audio'), 'exclude': lambda f: f is None }})
    r"""Determine how participants can join the audio portion of the meeting.<br>`both` - Both Telephony and VoIP.<br>`telephony` - Telephony only.<br>`voip` - VoIP only."""  
    ...
    r"""If user has configured [\\"Sign Into Zoom with Specified Domains\\"](https://support.zoom.us/hc/en-us/articles/360037117472-Authentication-Profiles-for-Meetings-and-Webinars#h_5c0df2e1-cfd2-469f-bb4a-c77d7c0cca6f) option, this will list the domains that are authenticated."""  
    authentication_exception: Optional[list[Meeting200ApplicationJSONSettingsAuthenticationException]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authentication_exception'), 'exclude': lambda f: f is None }})
    r"""The participants added here will receive unique meeting invite links and bypass authentication."""  
    ...
    r"""Meeting authentication option id."""  
    auto_recording: Optional[Meeting200ApplicationJSONSettingsAutoRecordingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auto_recording'), 'exclude': lambda f: f is None }})
    r"""Automatic recording:<br>`local` - Record on local.<br>`cloud` -  Record on cloud.<br>`none` - Disabled."""  
    breakout_room: Optional[Meeting200ApplicationJSONSettingsBreakoutRoom] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('breakout_room'), 'exclude': lambda f: f is None }})
    r"""Setting to [pre-assign breakout rooms](https://support.zoom.us/hc/en-us/articles/360032752671-Pre-assigning-participants-to-breakout-rooms#h_36f71353-4190-48a2-b999-ca129861c1f4)."""  
    ...
    r"""Contact name for registration"""  
    custom_keys: Optional[list[Meeting200ApplicationJSONSettingsCustomKeys]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('custom_keys'), 'exclude': lambda f: f is None }})
    r"""Custom keys and values assigned to the meeting."""  
    encryption_type: Optional[Meeting200ApplicationJSONSettingsEncryptionTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('encryption_type'), 'exclude': lambda f: f is None }})
    r"""Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
    `enhanced_encryption`: Enhanced encryption. Encryption is stored in the cloud if you enable this option. <br>
    ...
    **This field is deprecated and will not be supported in the future.**  <br><br>As an alternative, use the \"meeting_authentication\", \"authentication_option\" and \"authentication_domains\" fields to understand the [authentication configurations](https://support.zoom.us/hc/en-us/articles/360037117472-Authentication-Profiles-for-Meetings-and-Webinars) set for the meeting.
    ...
    r"""List of global dial-in countries"""  
    global_dial_in_numbers: Optional[list[Meeting200ApplicationJSONSettingsGlobalDialInNumbers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('global_dial_in_numbers'), 'exclude': lambda f: f is None }})
    r"""Global Dial-in Countries/Regions"""  
    ...
    r"""Host meeting in India."""  
    jbh_time: Optional[Meeting200ApplicationJSONSettingsJbhTimeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('jbh_time'), 'exclude': lambda f: f is None }})
    r"""If the value of \\"join_before_host\\" field is set to true, this field can be used to indicate time limits within which a participant may join a meeting before a host. The value of this field can be one of the following:
    ...
    *  `5`: Allow participant to join 5 minutes before meeting start time.
    ...
    r"""Allow participants to join the meeting before the host starts the meeting. Only used for scheduled or recurring meetings."""  
    language_interpretation: Optional[Meeting200ApplicationJSONSettingsLanguageInterpretation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('language_interpretation'), 'exclude': lambda f: f is None }})  
    ...
    r"""Send email notifications to registrants about approval, cancellation, denial of the registration. The value of this field must be set to true in order to use the `registrants_confirmation_email` field."""  
    registration_type: Optional[Meeting200ApplicationJSONSettingsRegistrationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('registration_type'), 'exclude': lambda f: f is None }})
    r"""Registration type. Used for recurring meeting with fixed time only. <br>`1` Attendees register once and can attend any of the occurrences.<br>`2` Attendees need to register for each occurrence to attend.<br>`3` Attendees register once and can choose one or more occurrences to attend."""  
...
class Meeting200ApplicationJSONTypeEnum(str, Enum):
    r"""Meeting Types:<br>`1` - Instant meeting.<br>`2` - Scheduled meeting.<br>`3` - Recurring meeting with no fixed time.<br>`4` - PMI Meeting<br>
    `8` - Recurring meeting with a fixed time.
    """
    ONE = '1'
...
class Meeting200ApplicationJSON:
    ...
    duration: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('duration'), 'exclude': lambda f: f is None }})
    r"""Meeting duration."""  
    encrypted_password: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('encrypted_password'), 'exclude': lambda f: f is None }})
    r"""Encrypted passcode for third party endpoints (H323/SIP)."""  
    ...
    r"""URL for participants to join the meeting. This URL should only be shared with users that you would like to invite for the meeting."""  
    occurrences: Optional[list[Meeting200ApplicationJSONOccurrences]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('occurrences'), 'exclude': lambda f: f is None }})
    r"""Array of occurrence objects."""  
    ...
    r"""Personal Meeting Id. Only used for scheduled meetings and recurring meetings with no fixed time."""  
    recurrence: Optional[Meeting200ApplicationJSONRecurrence] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('recurrence'), 'exclude': lambda f: f is None }})
    r"""Recurrence object. Use this object only for a meeting with type `8` i.e., a recurring meeting with fixed time."""  
    settings: Optional[Meeting200ApplicationJSONSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('settings'), 'exclude': lambda f: f is None }})
    r"""Meeting settings."""  
    start_time: Optional[datetime] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('start_time'), 'encoder': utils.datetimeisoformat(True), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso'), 'exclude': lambda f: f is None }})
    r"""Meeting start time in GMT/UTC. Start time will not be returned if the meeting is an **instant** meeting."""  
    ...
    For security reasons, to retrieve the updated value for the <code>start_url</code> field programmatically (after the expiry time), you must call the [Retrieve a Meeting API](https://marketplace.zoom.us/docs/api-reference/zoom-api/meetings/meeting) and refer to the value of the <code>start_url</code> field in the response.</aside><br>This URL should only be used by the host of the meeting and **should not be shared with anyone other than the host** of the meeting as anyone with this URL will be able to login to the Zoom Client as the host of the meeting.
    """  
    status: Optional[Meeting200ApplicationJSONStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""Meeting status"""  
    ...
    r"""Meeting topic."""  
    tracking_fields: Optional[list[Meeting200ApplicationJSONTrackingFields]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tracking_fields'), 'exclude': lambda f: f is None }})
    r"""Tracking fields"""  
    type: Optional[Meeting200ApplicationJSONTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Meeting Types:<br>`1` - Instant meeting.<br>`2` - Scheduled meeting.<br>`3` - Recurring meeting with no fixed time.<br>`4` - PMI Meeting<br>
    `8` - Recurring meeting with a fixed time.
    """  
