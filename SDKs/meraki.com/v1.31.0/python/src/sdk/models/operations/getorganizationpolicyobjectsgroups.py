...
class GetOrganizationPolicyObjectsGroupsRequest:
    ...
    r"""The number of entries per page returned. Acceptable range is 10 - 1000. Default is 1000."""  
...
class GetOrganizationPolicyObjectsGroupsResponse:
    ...
    get_organization_policy_objects_groups_200_application_json_objects: Optional[list[dict[str, Any]]] = dataclasses.field(default=None)
