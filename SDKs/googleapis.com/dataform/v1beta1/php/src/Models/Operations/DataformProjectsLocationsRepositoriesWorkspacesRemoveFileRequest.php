...
class DataformProjectsLocationsRepositoriesWorkspacesRemoveFileRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\RemoveFileRequest $removeFileRequest = null;
