...
class UserUploadQuotaSpace
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\UserUploadQuotaSpaceShowingEnum $showing
     */
	#[\JMS\Serializer\Annotation\SerializedName('showing')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UserUploadQuotaSpaceShowingEnum>')]
	...
	public function __construct()
	{
		$this->free = 0;
		$this->max = 0;
		$this->showing = \OpenAPI\OpenAPI\Models\Shared\UserUploadQuotaSpaceShowingEnum::LIFETIME;
		$this->used = 0;
	}
}
