...
public class UpdateShipmentRequestBodyInput {
    ...
    public UpdateShipmentRequestBodyDeliveryConfirmationEnum confirmation;
    public UpdateShipmentRequestBodyInput withConfirmation(UpdateShipmentRequestBodyDeliveryConfirmationEnum confirmation) {
    ...
    public UpdateShipmentRequestBodyInsuranceProviderEnum insuranceProvider;
    public UpdateShipmentRequestBodyInput withInsuranceProvider(UpdateShipmentRequestBodyInsuranceProviderEnum insuranceProvider) {
    ...
    public UpdateShipmentRequestBodyOriginTypeEnum originType;
    public UpdateShipmentRequestBodyInput withOriginType(UpdateShipmentRequestBodyOriginTypeEnum originType) {
    ...
    public UpdateShipmentRequestBodyInput withReturnTo(ShippingAddress returnTo) {
    ...
    public UpdateShipmentRequestBodyInput withShipFrom(ShippingAddress shipFrom) {
    ...
    public UpdateShipmentRequestBodyInput withShipTo(ShippingAddress shipTo) {
        this.shipTo = shipTo;
        return this;
    }
    ...
    public UpdateShipmentRequestBodyInput withShipmentNumber(String shipmentNumber) {
    ...
    public UpdateShipmentRequestBodyInput withTaxIdentifiers(TaxIdentifier[] taxIdentifiers) {
    ...
    public UpdateShipmentRequestBodyValidateAddressEnum validateAddress;
    public UpdateShipmentRequestBodyInput withValidateAddress(UpdateShipmentRequestBodyValidateAddressEnum validateAddress) {
    ...
    public UpdateShipmentRequestBodyInput withWarehouseId(String warehouseId) {
