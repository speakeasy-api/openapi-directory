...
var ObservationController = /** @class */ (function () {
    ...
    ObservationController.prototype.getObservationsByCode = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/user/{userId}/observations/{code}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetObservationsByCodeResponse({
    ...
    ObservationController.prototype.getObservationsByCodes = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/user/{userId}/observations", req);
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetObservationsByCodesResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    ObservationController.prototype.getPatientEnteredObservationsByCode = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/user/{userId}/observations/{code}/patiententered", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetPatientEnteredObservationsByCodeResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
