...
class DisplayvideoInventorySourceGroupsAssignedInventorySourcesDeleteRequest:
    ...
    r"""Required. The ID of the assigned inventory source to delete."""  
    ...
    r"""Required. The ID of the inventory source group to which this assignment is assigned."""  
    ...
    r"""The ID of the advertiser that owns the parent inventory source group. The parent partner does not have access to this assigned inventory source."""  
    ...
    r"""The ID of the partner that owns the parent inventory source group. Only this partner has write access to this assigned inventory source."""  
