...
from ..shared import googledatastoreadminv1importentitiesrequest as shared_googledatastoreadminv1importentitiesrequest
...
class DatastoreProjectsImportRequest:
    ...
    r"""Required. Project ID against which to make the request."""  
    ...
    google_datastore_admin_v1_import_entities_request: Optional[shared_googledatastoreadminv1importentitiesrequest.GoogleDatastoreAdminV1ImportEntitiesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
