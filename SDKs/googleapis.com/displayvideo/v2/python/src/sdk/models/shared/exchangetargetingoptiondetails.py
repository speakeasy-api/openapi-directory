...
class ExchangeTargetingOptionDetails:
    ...
    exchange: Optional[ExchangeTargetingOptionDetailsExchangeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('exchange') }})
