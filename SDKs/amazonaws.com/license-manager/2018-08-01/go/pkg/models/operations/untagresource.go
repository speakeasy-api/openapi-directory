...
const (
	UntagResourceXAmzTargetEnumAwsLicenseManagerUntagResource UntagResourceXAmzTargetEnum = "AWSLicenseManager.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AWSLicenseManager.UntagResource":
