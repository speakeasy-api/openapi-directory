...
exports.RepricingRuleEligibleOfferMatcher = exports.RepricingRuleEligibleOfferMatcherMatcherOptionEnum = void 0;
var utils_1 = require("../../../internal/utils");
var repricingruleeligibleoffermatcherstringmatcher_1 = require("./repricingruleeligibleoffermatcherstringmatcher");
 ...
 */
var RepricingRuleEligibleOfferMatcherMatcherOptionEnum;
...
})(RepricingRuleEligibleOfferMatcherMatcherOptionEnum = exports.RepricingRuleEligibleOfferMatcherMatcherOptionEnum || (exports.RepricingRuleEligibleOfferMatcherMatcherOptionEnum = {}));
/**
...
var RepricingRuleEligibleOfferMatcher = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "brandMatcher" }),
        (0, class_transformer_1.Type)(function () { return repricingruleeligibleoffermatcherstringmatcher_1.RepricingRuleEligibleOfferMatcherStringMatcher; }),
        __metadata("design:type", repricingruleeligibleoffermatcherstringmatcher_1.RepricingRuleEligibleOfferMatcherStringMatcher)
    ], RepricingRuleEligibleOfferMatcher.prototype, "brandMatcher", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "itemGroupIdMatcher" }),
        (0, class_transformer_1.Type)(function () { return repricingruleeligibleoffermatcherstringmatcher_1.RepricingRuleEligibleOfferMatcherStringMatcher; }),
        __metadata("design:type", repricingruleeligibleoffermatcherstringmatcher_1.RepricingRuleEligibleOfferMatcherStringMatcher)
    ], RepricingRuleEligibleOfferMatcher.prototype, "itemGroupIdMatcher", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "matcherOption" }),
        __metadata("design:type", String)
    ], RepricingRuleEligibleOfferMatcher.prototype, "matcherOption", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "offerIdMatcher" }),
        (0, class_transformer_1.Type)(function () { return repricingruleeligibleoffermatcherstringmatcher_1.RepricingRuleEligibleOfferMatcherStringMatcher; }),
        __metadata("design:type", repricingruleeligibleoffermatcherstringmatcher_1.RepricingRuleEligibleOfferMatcherStringMatcher)
    ], RepricingRuleEligibleOfferMatcher.prototype, "offerIdMatcher", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "skipWhenOnPromotion" }),
        __metadata("design:type", Boolean)
    ], RepricingRuleEligibleOfferMatcher.prototype, "skipWhenOnPromotion", void 0);
    return RepricingRuleEligibleOfferMatcher;
}(utils_1.SpeakeasyBase));
exports.RepricingRuleEligibleOfferMatcher = RepricingRuleEligibleOfferMatcher;
