...
class InboundSamlSsoProfiles 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\CloudidentityInboundSamlSsoProfilesCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/inboundSamlSsoProfiles');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/idpCredentials:add', \OpenAPI\OpenAPI\Models\Operations\CloudidentityInboundSamlSsoProfilesIdpCredentialsAddRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/idpCredentials', \OpenAPI\OpenAPI\Models\Operations\CloudidentityInboundSamlSsoProfilesIdpCredentialsListRequest::class, $request);
