 ...
 */
export enum CloudStorageEgressWorkloadDestinationContinentEnum {
 ...
 */
export enum CloudStorageEgressWorkloadSourceContinentEnum {
 ...
 */
export class CloudStorageEgressWorkload extends SpeakeasyBase {
  /**
   * Where the data is sent to.
   */
  @SpeakeasyMetadata()
