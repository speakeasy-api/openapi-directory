...
var ImprovementProgram = /** @class */ (function () {
     ...
     *
     */
    ImprovementProgram.prototype.postImproveForm = function (req, config) {
        var _a;
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostImproveFormResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case [200, 400, 403, 429].includes(httpRes === null || httpRes === void 0 ? void 0 : httpRes.status):
     ...
     *
     */
    ImprovementProgram.prototype.postImproveJson = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new shared.ImprovementProgramJson(req);
        }
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostImproveJsonResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     */
    ImprovementProgram.prototype.postImproveMultipart = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostImproveMultipartResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
