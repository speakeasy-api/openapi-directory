...
public class PrcptSecurity {
    ...
    public PrcptSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public PrcptSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public PrcptSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
