...
class GetDisableImageDeprecationQueryParams:
    action: GetDisableImageDeprecationActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    image_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'ImageId', 'style': 'form', 'explode': True }})
    version: GetDisableImageDeprecationVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDisableImageDeprecationRequest:
    headers: GetDisableImageDeprecationHeaders = dataclasses.field()
    query_params: GetDisableImageDeprecationQueryParams = dataclasses.field()
