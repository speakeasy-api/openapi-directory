...
exports.GetEmployerRevisionByNumberResponse = exports.GetEmployerRevisionByNumberRequest = void 0;
...
var GetEmployerRevisionByNumberRequest = /** @class */ (function (_super) {
    ...
    ], GetEmployerRevisionByNumberRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetEmployerRevisionByNumberRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetEmployerRevisionByNumberRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RevisionNumber",
        }),
        __metadata("design:type", String)
    ], GetEmployerRevisionByNumberRequest.prototype, "revisionNumber", void 0);
...
var GetEmployerRevisionByNumberResponse = /** @class */ (function (_super) {
    ...
    ], GetEmployerRevisionByNumberResponse.prototype, "rawResponse", void 0);
