...
type BaremetalsolutionProjectsLocationsNfsSharesCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type BaremetalsolutionProjectsLocationsNfsSharesCreatePathParams struct {
	// Required. The parent project and location.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type BaremetalsolutionProjectsLocationsNfsSharesCreateQueryParams struct {
	// V1 error format.
...
type BaremetalsolutionProjectsLocationsNfsSharesCreateResponse struct {
	ContentType string
	// Successful response
