...
public class MapMapGetQueryParams {
    /**
    ...
    public MapMapGetQueryParams withDatetime(String datetime) {
    ...
    public String key;
    public MapMapGetQueryParams withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public MapMapGetQueryParams withMaxLat(String maxLat) {
        this.maxLat = maxLat;
        return this;
    }
    ...
    public MapMapGetQueryParams withMaxLon(String maxLon) {
        this.maxLon = maxLon;
        return this;
    }
    ...
    public MapMapGetQueryParams withMinLat(String minLat) {
        this.minLat = minLat;
        return this;
    }
    ...
    public MapMapGetQueryParams withMinLon(String minLon) {
        this.minLon = minLon;
        return this;
    }
    ...
    public Long tileX;
    public MapMapGetQueryParams withTileX(Long tileX) {
        this.tileX = tileX;
        return this;
    }
    ...
    public Long tileY;
    public MapMapGetQueryParams withTileY(Long tileY) {
        this.tileY = tileY;
        return this;
    }
    ...
    public MapMapGetQueryParams withTileZoom(Long tileZoom) {
    ...
    public MapMapGetQueryParams withVariable(String variable) {
