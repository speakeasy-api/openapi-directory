...
class PresetsUserPreferencesVideosPrivacy
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\PresetsUserPreferencesVideosPrivacyCommentsEnum $comments
     */
	#[\JMS\Serializer\Annotation\SerializedName('comments')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\PresetsUserPreferencesVideosPrivacyCommentsEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?PresetsUserPreferencesVideosPrivacyCommentsEnum $comments = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\PresetsUserPreferencesVideosPrivacyEmbedEnum $embed
     */
	#[\JMS\Serializer\Annotation\SerializedName('embed')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\PresetsUserPreferencesVideosPrivacyEmbedEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?PresetsUserPreferencesVideosPrivacyEmbedEnum $embed = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\PresetsUserPreferencesVideosPrivacyViewEnum $view
     */
	#[\JMS\Serializer\Annotation\SerializedName('view')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\PresetsUserPreferencesVideosPrivacyViewEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?PresetsUserPreferencesVideosPrivacyViewEnum $view = null;
