...
var ListUsersRequest = /** @class */ (function (_super) {
    ...
    ], ListUsersRequest.prototype, "filters", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=IdentityStoreId" }),
        __metadata("design:type", String)
    ], ListUsersRequest.prototype, "identityStoreId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MaxResults" }),
        __metadata("design:type", Number)
    ], ListUsersRequest.prototype, "maxResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], ListUsersRequest.prototype, "nextToken", void 0);
