...
exports.StartSyncExecutionResponse = exports.StartSyncExecutionRequest = exports.StartSyncExecutionXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var StartSyncExecutionXAmzTargetEnum;
...
})(StartSyncExecutionXAmzTargetEnum = exports.StartSyncExecutionXAmzTargetEnum || (exports.StartSyncExecutionXAmzTargetEnum = {}));
var StartSyncExecutionRequest = /** @class */ (function (_super) {
    ...
    ], StartSyncExecutionRequest.prototype, "startSyncExecutionInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], StartSyncExecutionRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], StartSyncExecutionRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], StartSyncExecutionRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], StartSyncExecutionRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], StartSyncExecutionRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], StartSyncExecutionRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], StartSyncExecutionRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], StartSyncExecutionRequest.prototype, "xAmzTarget", void 0);
    return StartSyncExecutionRequest;
}(utils_1.SpeakeasyBase));
exports.StartSyncExecutionRequest = StartSyncExecutionRequest;
var StartSyncExecutionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], StartSyncExecutionResponse.prototype, "rawResponse", void 0);
    return StartSyncExecutionResponse;
}(utils_1.SpeakeasyBase));
exports.StartSyncExecutionResponse = StartSyncExecutionResponse;
