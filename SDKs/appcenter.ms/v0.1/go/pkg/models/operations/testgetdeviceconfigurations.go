...
type TestGetDeviceConfigurationsPathParams struct {
...
type TestGetDeviceConfigurationsQueryParams struct {
...
type TestGetDeviceConfigurationsRequest struct {
	PathParams  TestGetDeviceConfigurationsPathParams
	QueryParams TestGetDeviceConfigurationsQueryParams
	Security    TestGetDeviceConfigurationsSecurity
}
