...
class RetryStageExecutionRequest:
    ...
    retry_stage_execution_input: shared_retrystageexecutioninput.RetryStageExecutionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class RetryStageExecutionResponse:
    ...
    r"""NotLatestPipelineExecutionException"""  
