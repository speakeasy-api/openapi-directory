...
export class ServiceusageServicesBatchGetSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ServiceusageServicesBatchGetSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ServiceusageServicesBatchGetSecurity extends SpeakeasyBase {
...
export class ServiceusageServicesBatchGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ServiceusageServicesBatchGetResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
