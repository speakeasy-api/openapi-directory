...
class SearchTypePointNetcdfQueryParams:
...
@dataclasses.dataclass
class SearchTypePointNetcdfRequest:
    query_params: SearchTypePointNetcdfQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypePointNetcdfResponse:
