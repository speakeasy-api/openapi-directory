...
func (s *verification) PostCheckAccountHolder(ctx context.Context, request shared.PerformVerificationRequest, security operations.PostCheckAccountHolderSecurity) (*operations.PostCheckAccountHolderResponse, error) {
	baseURL := s.serverURL
...
func (s *verification) PostDeletePayoutMethods(ctx context.Context, request shared.DeletePayoutMethodRequest, security operations.PostDeletePayoutMethodsSecurity) (*operations.PostDeletePayoutMethodsResponse, error) {
	baseURL := s.serverURL
