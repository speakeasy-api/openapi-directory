...
export class CloudresourcemanagerTagBindingsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudresourcemanagerTagBindingsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudresourcemanagerTagBindingsListSecurity extends SpeakeasyBase {
...
export class CloudresourcemanagerTagBindingsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudresourcemanagerTagBindingsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
