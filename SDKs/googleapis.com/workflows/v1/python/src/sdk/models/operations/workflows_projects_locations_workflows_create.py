...
class WorkflowsProjectsLocationsWorkflowsCreateRequest:
    path_params: WorkflowsProjectsLocationsWorkflowsCreatePathParams = dataclasses.field()
    query_params: WorkflowsProjectsLocationsWorkflowsCreateQueryParams = dataclasses.field()
    security: WorkflowsProjectsLocationsWorkflowsCreateSecurity = dataclasses.field()
    request: Optional[shared_workflow.WorkflowInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
