...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsAddRepoToInstallationForAuthenticatedUserRequest req = new AppsAddRepoToInstallationForAuthenticatedUserRequest(747080L, 117531L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsCheckTokenRequest req = new AppsCheckTokenRequest(                new AppsCheckTokenRequestBody("laborum");, "totam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsCreateFromManifestRequest req = new AppsCreateFromManifestRequest("incidunt");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsCreateInstallationAccessTokenRequest req = new AppsCreateInstallationAccessTokenRequest(132068L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsDeleteAuthorizationRequest req = new AppsDeleteAuthorizationRequest(                new AppsDeleteAuthorizationRequestBody("dolorum");, "architecto");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsDeleteInstallationRequest req = new AppsDeleteInstallationRequest(63038L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsDeleteTokenRequest req = new AppsDeleteTokenRequest(                new AppsDeleteTokenRequestBody("aut");, "quas");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsGetBySlugRequest req = new AppsGetBySlugRequest("itaque");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsGetInstallationRequest req = new AppsGetInstallationRequest(9240L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsGetOrgInstallationRequest req = new AppsGetOrgInstallationRequest("est");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsGetRepoInstallationRequest req = new AppsGetRepoInstallationRequest("repellendus", "porro");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsGetUserInstallationRequest req = new AppsGetUserInstallationRequest("doloribus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsGetWebhookDeliveryRequest req = new AppsGetWebhookDeliveryRequest(281730L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsListInstallationReposForAuthenticatedUserRequest req = new AppsListInstallationReposForAuthenticatedUserRequest(703495L) {{
                page = 586410L;
                perPage = 181631L;
            }};            
    ...
    public static void main(String[] args) {
        try {
            ...
            AppsListInstallationsRequest req = new AppsListInstallationsRequest() {{
                ...
                page = 512393L;
                perPage = 485628L;
                since = OffsetDateTime.parse("2021-01-17T10:17:06.805Z");
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsRedeliverWebhookDeliveryRequest req = new AppsRedeliverWebhookDeliveryRequest(455169L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsRemoveRepoFromInstallationForAuthenticatedUserRequest req = new AppsRemoveRepoFromInstallationForAuthenticatedUserRequest(231701L, 878870L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsResetTokenRequest req = new AppsResetTokenRequest(                new AppsResetTokenRequestBody("tenetur");, "dignissimos");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsSuspendInstallationRequest req = new AppsSuspendInstallationRequest(297842L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AppsUnsuspendInstallationRequest req = new AppsUnsuspendInstallationRequest(189848L);            
