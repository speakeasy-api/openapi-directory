...
var ScheduleABySizeCandidatePage = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: scheduleabysizecandidate_1.ScheduleABySizeCandidate }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return scheduleabysizecandidate_1.ScheduleABySizeCandidate; }),
