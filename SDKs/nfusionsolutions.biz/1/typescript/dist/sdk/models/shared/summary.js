...
var Summary = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ask" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=fiftyTwoWeekHigh" }),
        __metadata("design:type", Number)
    ], Summary.prototype, "fiftyTwoWeekHigh", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=fiftyTwoWeekLow" }),
        __metadata("design:type", Number)
    ], Summary.prototype, "fiftyTwoWeekLow", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=fiftyTwoWeekPercentChange" }),
        __metadata("design:type", Number)
    ], Summary.prototype, "fiftyTwoWeekPercentChange", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=fourWeekPercentChange" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=oneDayChange" }),
        __metadata("design:type", Number)
    ], Summary.prototype, "oneDayChange", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=oneDayPercentChange" }),
        __metadata("design:type", Number)
    ], Summary.prototype, "oneDayPercentChange", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=oneDayValue" }),
        __metadata("design:type", Number)
    ], Summary.prototype, "oneDayValue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=open" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=twelveWeekPercentChange" }),
        __metadata("design:type", Number)
    ], Summary.prototype, "twelveWeekPercentChange", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=yearToDatePercentChange" }),
        __metadata("design:type", Number)
