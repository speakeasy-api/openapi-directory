...
class GetAssociateEnclaveCertificateIamRoleQueryParams:
    action: GetAssociateEnclaveCertificateIamRoleActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetAssociateEnclaveCertificateIamRoleVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAssociateEnclaveCertificateIamRoleRequest:
    headers: GetAssociateEnclaveCertificateIamRoleHeaders = dataclasses.field()
    query_params: GetAssociateEnclaveCertificateIamRoleQueryParams = dataclasses.field()
