...
public class GetItemGroupFeedHeaders {
    /**
    ...
    public GetItemGroupFeedHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public String range;
    public GetItemGroupFeedHeaders withRange(String range) {
        this.range = range;
        return this;
    }
    ...
    public GetItemGroupFeedHeaders withXEbayCMarketplaceId(String xEbayCMarketplaceId) {
