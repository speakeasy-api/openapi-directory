...
from ..shared import api_core_requests_patchbodybatch as shared_api_core_requests_patchbodybatch
...
class PutConversionsConversionIDDatapointsBatchPatchRequest:
    ...
    api_core_requests_patch_body_batch: shared_api_core_requests_patchbodybatch.APICoreRequestsPatchBodyBatch = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Patch requests"""  
...
@dataclasses.dataclass
class PutConversionsConversionIDDatapointsBatchPatchResponse:
