...
type RecommenderProjectsLocationsInsightTypesInsightsMarkAcceptedRequest struct {
	...
	GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest *shared.GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest `request:"mediaType=application/json"`
	// OAuth access token.
