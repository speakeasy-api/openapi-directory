...
class DriveTeamdrivesDeleteRequest:
    path_params: DriveTeamdrivesDeletePathParams = dataclasses.field()
    query_params: DriveTeamdrivesDeleteQueryParams = dataclasses.field()
    security: DriveTeamdrivesDeleteSecurity = dataclasses.field()
