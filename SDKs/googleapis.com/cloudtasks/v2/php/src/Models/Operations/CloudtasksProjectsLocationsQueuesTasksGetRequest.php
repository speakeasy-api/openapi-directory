...
class CloudtasksProjectsLocationsQueuesTasksGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CloudtasksProjectsLocationsQueuesTasksGetResponseViewEnum $responseView
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=responseView')]
    public ?CloudtasksProjectsLocationsQueuesTasksGetResponseViewEnum $responseView = null;
