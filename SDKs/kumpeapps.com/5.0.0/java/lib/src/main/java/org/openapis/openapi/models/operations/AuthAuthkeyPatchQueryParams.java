...
public class AuthAuthkeyPatchQueryParams {
    /**
     * auth key to mark as compromised
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=auth_key")
    public String authKey;
    public AuthAuthkeyPatchQueryParams withAuthKey(String authKey) {
    ...
    public AuthAuthkeyPatchQueryParams withComments(String comments) {
