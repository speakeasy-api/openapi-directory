...
from ..shared import listappversionsresponse as shared_listappversionsresponse
...
class ListAppVersionsRequest:
    ...
    request_body: ListAppVersionsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListAppVersionsResponse:
    ...
    list_app_versions_response: Optional[shared_listappversionsresponse.ListAppVersionsResponse] = dataclasses.field(default=None)
    r"""Success"""  
