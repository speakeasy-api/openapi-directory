 ...
 */
export enum PublicDelegatedPrefixesScopedListWarningCodeEnum {
...
export class PublicDelegatedPrefixesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class PublicDelegatedPrefixesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: PublicDelegatedPrefixesScopedListWarningData })
  @Expose({ name: "data" })
...
export class PublicDelegatedPrefixesScopedList extends SpeakeasyBase {
  /**
   * [Output Only] A list of PublicDelegatedPrefixes contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: PublicDelegatedPrefix })
  @Expose({ name: "publicDelegatedPrefixes" })
