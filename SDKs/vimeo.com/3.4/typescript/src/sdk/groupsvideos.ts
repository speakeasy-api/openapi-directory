...
export class GroupsVideos {
  ...
  addVideoToGroup(
    ...
    security: operations.AddVideoToGroupSecurity,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AddVideoToGroupResponse =
        new operations.AddVideoToGroupResponse({
  ...
  deleteVideoFromGroup(
    ...
    security: operations.DeleteVideoFromGroupSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DeleteVideoFromGroupResponse =
        new operations.DeleteVideoFromGroupResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getGroupVideo(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetGroupVideoResponse =
        new operations.GetGroupVideoResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getGroupVideos(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetGroupVideosResponse =
        new operations.GetGroupVideosResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
