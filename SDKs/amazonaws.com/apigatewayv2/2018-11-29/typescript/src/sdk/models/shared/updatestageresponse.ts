 ...
 */
export enum UpdateStageResponseDefaultRouteSettingsLoggingLevelEnum {
  Error = "ERROR",
  Info = "INFO",
  Off = "OFF",
}
...
export class UpdateStageResponse extends SpeakeasyBase {
  ...
  @Type(() => UpdateStageResponseAccessLogSettings)
  ...
  @Type(() => UpdateStageResponseDefaultRouteSettings)
