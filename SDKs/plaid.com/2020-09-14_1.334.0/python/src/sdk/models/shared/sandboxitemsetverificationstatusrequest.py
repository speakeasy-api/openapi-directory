...
class SandboxItemSetVerificationStatusRequest:
    ...
    verification_status: SandboxItemSetVerificationStatusRequestVerificationStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('verification_status') }})
    r"""The verification status to set the account to."""  
