 ...
 */
export enum VpnGatewaysScopedListWarningCodeEnum {
...
export class VpnGatewaysScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class VpnGatewaysScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: VpnGatewaysScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: VpnGatewaysScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => VpnGatewaysScopedListWarningData)
  data?: VpnGatewaysScopedListWarningData[];
...
export class VpnGatewaysScopedList extends SpeakeasyBase {
  /**
   * [Output Only] A list of VPN gateways contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: VpnGateway })
  @Expose({ name: "vpnGateways" })
  @Type(() => VpnGateway)
