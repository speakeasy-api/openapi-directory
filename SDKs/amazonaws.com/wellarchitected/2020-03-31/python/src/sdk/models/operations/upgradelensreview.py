...
class UpgradeLensReviewPathParams:
...
@dataclasses.dataclass
class UpgradeLensReviewHeaders:
...
class UpgradeLensReviewRequest:
    headers: UpgradeLensReviewHeaders = dataclasses.field()
    path_params: UpgradeLensReviewPathParams = dataclasses.field()
    request: UpgradeLensReviewRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
