...
class ListTrackersResponseEntryPricingPlanEnum(str, Enum):
...
class ListTrackersResponseEntry:
    ...
    pricing_plan: Optional[ListTrackersResponseEntryPricingPlanEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PricingPlan'), 'exclude': lambda f: f is None }})  
