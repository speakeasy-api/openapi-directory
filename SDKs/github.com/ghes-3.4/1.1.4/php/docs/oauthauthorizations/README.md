...
try {
    ...
    $request->clientSecret = 'esse';
    $request->fingerprint = 'nemo';
    $request->note = 'Update all gems';
    $request->noteUrl = 'reprehenderit';
    $request->scopes = [
        'quis',
        'sint',
        'accusamus',
...
try {
    ...
    $request->authorizationId = 774684;
...
try {
    ...
    $request->authorizationId = 900103;
...
try {
    ...
    $request->requestBody->clientSecret = 'ex';
    $request->requestBody->fingerprint = 'voluptas';
...
try {
    ...
    $request->requestBody->clientSecret = 'velit';
    $request->requestBody->note = 'Update all gems';
    $request->requestBody->noteUrl = 'atque';
    $request->requestBody->scopes = [
        'impedit',
    ];
    $request->clientId = 'magni';
    $request->fingerprint = 'soluta';
...
try {
    ...
    $request->requestBody->fingerprint = 'deleniti';
    $request->requestBody->note = 'Update all gems';
    $request->requestBody->noteUrl = 'quibusdam';
