...
class DescribeDetectorRequest:
    ...
    r"""The name of the detector model whose detectors (instances) you want information about."""  
    key_value: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'keyValue', 'style': 'form', 'explode': True }})
    r"""A filter used to limit results to detectors (instances) created because of the given key ID."""  
