 ...
 */
public class AccountSettings200ApplicationXML3PasswordRequirement {
    /**
    ...
    public AccountSettings200ApplicationXML3PasswordRequirement withConsecutiveCharactersLength(Long consecutiveCharactersLength) {
    ...
    public AccountSettings200ApplicationXML3PasswordRequirement withHaveSpecialCharacter(Boolean haveSpecialCharacter) {
    ...
    public AccountSettings200ApplicationXML3PasswordRequirement withMinimumPasswordLength(Long minimumPasswordLength) {
    ...
    public AccountSettings200ApplicationXML3PasswordRequirement withWeakEnhanceDetection(Boolean weakEnhanceDetection) {
