 ...
 */
export enum MachineImageListWarningCodeEnum {
...
export class MachineImageListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class MachineImageListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: MachineImageListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: MachineImageListWarningData })
  @Expose({ name: "data" })
  @Type(() => MachineImageListWarningData)
  data?: MachineImageListWarningData[];
 ...
 */
export class MachineImageList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: MachineImage })
  @Expose({ name: "items" })
  @Type(() => MachineImage)
  items?: MachineImage[];
