...
class DevicePolicy:
    ...
    allowed_device_management_levels: Optional[list[DevicePolicyAllowedDeviceManagementLevelsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('allowedDeviceManagementLevels'), 'exclude': lambda f: f is None }})
    r"""Allowed device management levels, an empty list allows all management levels."""  
    allowed_encryption_statuses: Optional[list[DevicePolicyAllowedEncryptionStatusesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('allowedEncryptionStatuses'), 'exclude': lambda f: f is None }})
    r"""Allowed encryptions statuses, an empty list allows all statuses."""  
    os_constraints: Optional[list[shared_osconstraint.OsConstraint]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('osConstraints'), 'exclude': lambda f: f is None }})
