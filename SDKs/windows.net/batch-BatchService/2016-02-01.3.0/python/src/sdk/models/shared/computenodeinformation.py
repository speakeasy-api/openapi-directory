...
class ComputeNodeInformation:
    ...
    r"""An identifier for the compute node on which the task ran, which can be passed when adding a task to request that the task be scheduled close to this compute node."""  
    ...
    r"""The id of the node on which the task ran."""  
    ...
    r"""The URL of the node on which the task ran."""  
    ...
    r"""The id of the pool on which the task ran."""  
    ...
    r"""The root directory of the task on the compute node."""  
    ...
    r"""The URL to the root directory of the task on the compute node."""  
