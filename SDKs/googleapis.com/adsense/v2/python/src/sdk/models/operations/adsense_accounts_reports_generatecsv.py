...
class AdsenseAccountsReportsGenerateCsvRequest:
    path_params: AdsenseAccountsReportsGenerateCsvPathParams = dataclasses.field()
    query_params: AdsenseAccountsReportsGenerateCsvQueryParams = dataclasses.field()
    security: AdsenseAccountsReportsGenerateCsvSecurity = dataclasses.field()
