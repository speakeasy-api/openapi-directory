...
export declare class ProdTtSasportalInstallerGenerateSecretSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalInstallerGenerateSecretSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalInstallerGenerateSecretSecurity extends SpeakeasyBase {
    option1?: ProdTtSasportalInstallerGenerateSecretSecurityOption1;
    option2?: ProdTtSasportalInstallerGenerateSecretSecurityOption2;
}
