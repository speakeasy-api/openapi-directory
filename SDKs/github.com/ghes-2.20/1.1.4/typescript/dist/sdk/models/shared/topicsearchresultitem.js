...
var TopicSearchResultItemAliasesTopicRelation = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=relation_type" }),
        __metadata("design:type", String)
    ], TopicSearchResultItemAliasesTopicRelation.prototype, "relationType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=topic_id" }),
        __metadata("design:type", Number)
...
var TopicSearchResultItemAliases = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=topic_relation" }),
...
var TopicSearchResultItem = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=aliases", elemType: TopicSearchResultItemAliases }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=curated" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=related", elemType: TopicSearchResultItemRelated }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=repository_count" }),
        __metadata("design:type", Number)
