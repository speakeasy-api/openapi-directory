...
public class WebmastersSitemapsListRequest {
    ...
    public WebmastersSitemapsListRequest withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public WebmastersSitemapsListRequest withAccessToken(String accessToken) {
    ...
    public WebmastersSitemapsListRequest withCallback(String callback) {
    ...
    public WebmastersSitemapsListRequest withUploadType(String uploadType) {
    ...
    public WebmastersSitemapsListRequest withUploadProtocol(String uploadProtocol) {
