...
class AggregatedGetDatapointsSummaryRequest:
    ...
    time_frame: AggregatedGetDatapointsSummaryTimeFrameEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'timeFrame', 'style': 'form', 'explode': True }})
    r"""Timeframe of the request. See list at $timeframeList"""  
    type: AggregatedGetDatapointsSummaryTypeEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
    r"""Type of datapoint (\\"tl\\"/\\"tp\\")"""  
    ...
    r"""Field to sort by"""  
    sort_direction: Optional[AggregatedGetDatapointsSummarySortDirectionEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sortDirection', 'style': 'form', 'explode': True }})
    r"""Direction of sort \\"asc\\" or \\"desc\\" """  
    status: Optional[AggregatedGetDatapointsSummaryStatusEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'status', 'style': 'form', 'explode': True }})
    r"""Status of datapoint (\\"deleted\\"/\\"active\\"/\\"paused\\"/\\"spam\\")"""  
