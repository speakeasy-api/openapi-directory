...
class CarrierAccounts:
    ...
    def connect_carrier(self, request: operations.ConnectCarrierRequest) -> operations.ConnectCarrierResponse:
        ...
        url = utils.generate_url(base_url, "/v1/connections/carriers/{carrier_name}", request.path_params)
        ...
        res = operations.ConnectCarrierResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ConnectCarrierResponseBody])
    ...
    def disconnect_carrier(self, request: operations.DisconnectCarrierRequest) -> operations.DisconnectCarrierResponse:
        ...
        url = utils.generate_url(base_url, "/v1/connections/carriers/{carrier_name}/{carrier_id}", request.path_params)
        ...
        res = operations.DisconnectCarrierResponse(status_code=r.status_code, content_type=content_type)
    ...
    def get_carrier_settings(self, request: operations.GetCarrierSettingsRequest) -> operations.GetCarrierSettingsResponse:
        ...
        url = utils.generate_url(base_url, "/v1/connections/carriers/{carrier_name}/{carrier_id}/settings", request.path_params)
        ...
        res = operations.GetCarrierSettingsResponse(status_code=r.status_code, content_type=content_type)
    ...
    def update_carrier_settings(self, request: operations.UpdateCarrierSettingsRequest) -> operations.UpdateCarrierSettingsResponse:
        ...
        res = operations.UpdateCarrierSettingsResponse(status_code=r.status_code, content_type=content_type)
