...
public class MetastoreProjectsLocationsServicesMetadataImportsCreatePathParams {
    /**
    ...
    public MetastoreProjectsLocationsServicesMetadataImportsCreatePathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
