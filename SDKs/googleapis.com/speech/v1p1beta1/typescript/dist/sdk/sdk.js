 ...
 */
exports.ServerList = ["https://speech.googleapis.com/"];
/**
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.speech = new speech_1.Speech(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
