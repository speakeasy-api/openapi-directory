...
from ..shared import nodefilelistresult as shared_nodefilelistresult
...
class FileListFromTaskRequest:
    ...
    r"""The id of the task whose files you want to list."""  
    ...
    r"""Sets whether to list children of a directory."""  
...
class FileListFromTaskResponse:
    ...
    node_file_list_result: Optional[shared_nodefilelistresult.NodeFileListResult] = dataclasses.field(default=None)  
