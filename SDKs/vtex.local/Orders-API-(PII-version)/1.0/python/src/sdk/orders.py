...
class Orders:
    ...
    def cancel_order2(self, request: operations.CancelOrder2Request) -> operations.CancelOrder2Response:
        r"""Cancel order
        ...
        url = utils.generate_url(operations.CancelOrder2Request, base_url, '/api/orders/pvt/document/{orderId}/cancel', request)
        ...
        res = operations.CancelOrder2Response(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.CancelOrder2200ApplicationJSON])
                res.cancel_order2_200_application_json_object = out
        elif http_res.status_code in [403, 404, 429]:
            pass

        return res

    def get_order2(self, request: operations.GetOrder2Request) -> operations.GetOrder2Response:
        r"""Get order
        ...
        url = utils.generate_url(operations.GetOrder2Request, base_url, '/api/orders/pvt/document/{orderId}', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.GetOrder2Request, request)
        ...
        res = operations.GetOrder2Response(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetOrder2200ApplicationJSON])
                res.get_order2_200_application_json_object = out

        return res

    def list_orders2(self, request: operations.ListOrders2Request) -> operations.ListOrders2Response:
        r"""List orders
        ...
        **Response object has the following properties:**
        ...
        url = base_url.removesuffix('/') + '/api/orders/extendsearch/orders'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "request_body", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.ListOrders2Request, request)
        ...
        res = operations.ListOrders2Response(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def start_handling2(self, request: operations.StartHandling2Request) -> operations.StartHandling2Response:
        ...
        url = utils.generate_url(operations.StartHandling2Request, base_url, '/api/orders/pvt/document/{orderId}/actions/start-handling', request)
        ...
        res = operations.StartHandling2Response(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
