...
export class CloudidentityInboundSsoAssignmentsDeleteSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudidentityInboundSsoAssignmentsDeleteSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudidentityInboundSsoAssignmentsDeleteSecurity extends SpeakeasyBase {
...
export class CloudidentityInboundSsoAssignmentsDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudidentityInboundSsoAssignmentsDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
