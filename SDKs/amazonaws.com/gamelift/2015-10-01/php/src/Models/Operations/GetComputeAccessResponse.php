...
class GetComputeAccessResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetComputeAccessOutput $getComputeAccessOutput
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetComputeAccessOutput $getComputeAccessOutput = null;
	...
	{
		$this->contentType = "";
		$this->getComputeAccessOutput = null;
