...
class Assembly:
    ...
    group_probabilities: list[float] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('group_probabilities') }})
    sites_in_groups: list[list[int]] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('sites_in_groups') }})
