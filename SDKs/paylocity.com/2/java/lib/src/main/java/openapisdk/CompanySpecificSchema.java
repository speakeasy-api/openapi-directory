...
public class CompanySpecificSchema {
    ...
    **/
    public openapisdk.models.operations.GetCompanySpecificOpenApiDocumentationResponse getCompanySpecificOpenApiDocumentation(openapisdk.models.operations.GetCompanySpecificOpenApiDocumentationRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v2/companies/{companyId}/openapi", request.pathParams);
        ...
        openapisdk.models.operations.GetCompanySpecificOpenApiDocumentationResponse res = new openapisdk.models.operations.GetCompanySpecificOpenApiDocumentationResponse() {{
            errors = null;
            errors = null;
        }};
