 ...
 */
public enum Webinar200ApplicationXMLSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private Webinar200ApplicationXMLSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
