...
export class ProductsOnline {
  ...
  createProductSlug(
    ...
    security: operations.CreateProductSlugSecurity,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CreateProductSlugResponse =
        new operations.CreateProductSlugResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.slugResponse = utils.objectToClass(
              httpRes?.data,
              shared.SlugResponse
            );
          }
