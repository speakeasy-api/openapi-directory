...
class ListGeofenceCollectionsResponseEntryPricingPlanEnum(str, Enum):
...
class ListGeofenceCollectionsResponseEntry:
    r"""Contains the geofence collection details."""
    ...
    pricing_plan: Optional[ListGeofenceCollectionsResponseEntryPricingPlanEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PricingPlan'), 'exclude': lambda f: f is None }})  
