...
public class GetMeFavoritesQueryParams {
    /**
    ...
    public GetMeFavoritesQueryParams withCallback(String callback) {
    ...
    public GetMeFavoritesQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeFavoritesQueryParams withFromdate(Long fromdate) {
    ...
    public String max;
    public GetMeFavoritesQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetMeFavoritesQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetMeFavoritesOrderEnum order;
    public GetMeFavoritesQueryParams withOrder(GetMeFavoritesOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetMeFavoritesQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeFavoritesQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetMeFavoritesQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetMeFavoritesSortEnum sort;
    public GetMeFavoritesQueryParams withSort(GetMeFavoritesSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetMeFavoritesQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
