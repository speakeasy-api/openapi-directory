...
export enum DescribeComputeXAmzTargetEnum {
  GameLiftDescribeCompute = "GameLift.DescribeCompute",
}

export class DescribeComputeRequest extends SpeakeasyBase {
...
export class DescribeComputeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
