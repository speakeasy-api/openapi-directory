...
type PeoplePeopleDeleteContactSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type PeoplePeopleDeleteContactPathParams struct {
...
type PeoplePeopleDeleteContactQueryParams struct {
	// V1 error format.
...
type PeoplePeopleDeleteContactRequest struct {
...
type PeoplePeopleDeleteContactResponse struct {
	ContentType string
	// Successful response
