...
class GoogleCloudRetailV2alphaSearchRequestBoostSpecConditionBoostSpec:
    ...
    r"""An expression which specifies a boost condition. The syntax and supported fields are the same as a filter expression. See SearchRequest.filter for detail syntax and limitations. Examples: * To boost products with product ID \\"product_1\\" or \\"product_2\\", and color \\"Red\\" or \\"Blue\\": * (id: ANY(\\"product_1\\", \\"product_2\\")) AND (colorFamilies: ANY(\\"Red\\",\\"Blue\\"))"""  
