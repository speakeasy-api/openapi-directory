...
class AdexchangebuyerCreativesListDealsStatusFilterEnum(str, Enum):
    r"""When specified, only creatives having the given deals status are returned."""
    APPROVED = 'approved'
...
class AdexchangebuyerCreativesListOpenAuctionStatusFilterEnum(str, Enum):
    r"""When specified, only creatives having the given open auction status are returned."""
    APPROVED = 'approved'
    CONDITIONALLY_APPROVED = 'conditionally_approved'
    DISAPPROVED = 'disapproved'
    NOT_CHECKED = 'not_checked'
