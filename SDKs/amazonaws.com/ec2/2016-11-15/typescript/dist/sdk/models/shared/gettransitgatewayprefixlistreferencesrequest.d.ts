 ...
 */
export declare class GetTransitGatewayPrefixListReferencesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetTransitGatewayPrefixListReferencesRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: GetTransitGatewayPrefixListReferencesRequestFilters[];
    maxResults?: number;
    nextToken?: string;
