...
class GetCreateReceiptRuleSetQueryParams:
    action: GetCreateReceiptRuleSetActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    rule_set_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'RuleSetName', 'style': 'form', 'explode': True }})
    version: GetCreateReceiptRuleSetVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetCreateReceiptRuleSetRequest:
    headers: GetCreateReceiptRuleSetHeaders = dataclasses.field()
    query_params: GetCreateReceiptRuleSetQueryParams = dataclasses.field()
