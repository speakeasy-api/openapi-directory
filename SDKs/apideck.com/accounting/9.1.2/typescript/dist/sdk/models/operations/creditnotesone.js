...
exports.CreditNotesOneResponse = exports.CreditNotesOneRequest = exports.CreditNotesOneSecurity = void 0;
...
exports.CreditNotesOneSecurity = CreditNotesOneSecurity;
var CreditNotesOneRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CreditNotesOneRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], CreditNotesOneRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], CreditNotesOneRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], CreditNotesOneRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], CreditNotesOneRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], CreditNotesOneRequest.prototype, "xApideckServiceId", void 0);
    return CreditNotesOneRequest;
}(utils_1.SpeakeasyBase));
exports.CreditNotesOneRequest = CreditNotesOneRequest;
var CreditNotesOneResponse = /** @class */ (function (_super) {
    ...
    ], CreditNotesOneResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.CreditNotesOneResponse = CreditNotesOneResponse;
