...
public class ScoreBasic {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("AwayTeamScore2")
    public Long awayTeamScore2;

    public ScoreBasic withAwayTeamScore2(Long awayTeamScore2) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("HomeTeamScore2")
    public Long homeTeamScore2;

    public ScoreBasic withHomeTeamScore2(Long homeTeamScore2) {
    ...
    public ScoreBasic withSeriesInfo(Series seriesInfo) {
