 ...
 */
export enum CommitmentListWarningCodeEnum {
...
export class CommitmentListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class CommitmentListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: CommitmentListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: CommitmentListWarningData })
  @Expose({ name: "data" })
  @Type(() => CommitmentListWarningData)
  data?: CommitmentListWarningData[];
 ...
 */
export class CommitmentList extends SpeakeasyBase {
  /**
