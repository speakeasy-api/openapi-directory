...
class Feedback 
{
     ...
     * @return \OpenAPI\OpenAPI\Models\Operations\PostSuggestResponse
     */
	public function postSuggest(
        string $request,
    ): \OpenAPI\OpenAPI\Models\Operations\PostSuggestResponse
    {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PostSuggestResponse();
