...
export class ServiceusageServicesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ServiceusageServicesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ServiceusageServicesListSecurity extends SpeakeasyBase {
...
export class ServiceusageServicesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ServiceusageServicesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
