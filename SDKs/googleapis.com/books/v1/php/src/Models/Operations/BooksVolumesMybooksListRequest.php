...
class BooksVolumesMybooksListRequest
{
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\BooksVolumesMybooksListAcquireMethodEnum> $acquireMethod
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=acquireMethod')]
    public ?array $acquireMethod = null;
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\BooksVolumesMybooksListProcessingStateEnum> $processingState
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=processingState')]
    public ?array $processingState = null;
