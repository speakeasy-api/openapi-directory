 ...
 */
public enum AssociateIpamResourceDiscoveryRequestTagSpecificationsResourceTypeEnum {
    ...
    private AssociateIpamResourceDiscoveryRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
