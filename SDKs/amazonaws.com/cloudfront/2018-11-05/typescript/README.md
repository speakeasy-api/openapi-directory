...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/amazonaws.com/cloudfront/2018-11-05/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/amazonaws.com/cloudfront/2018-11-05/typescript
```
...
import {
  ...
  CreateCloudFrontOriginAccessIdentity20181105Response
