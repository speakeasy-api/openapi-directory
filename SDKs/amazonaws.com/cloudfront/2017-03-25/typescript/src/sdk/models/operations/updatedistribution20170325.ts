 ...
 */
export class UpdateDistribution20170325RequestBodyDistributionConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateDistribution20170325RequestBody extends SpeakeasyBase {
  /**
   * A distribution configuration.
   */
  @SpeakeasyMetadata()
  distributionConfig: UpdateDistribution20170325RequestBodyDistributionConfig;
}

export class UpdateDistribution20170325Request extends SpeakeasyBase {
  /**
...
export class UpdateDistribution20170325Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
