...
exports.GetConsumerV1AvailabilityServiceIdStartDateEndDateDaysResponse = exports.GetConsumerV1AvailabilityServiceIdStartDateEndDateDaysRequest = void 0;
...
var GetConsumerV1AvailabilityServiceIdStartDateEndDateDaysRequest = /** @class */ (function (_super) {
    ...
    ], GetConsumerV1AvailabilityServiceIdStartDateEndDateDaysRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locationId",
        }),
        __metadata("design:type", String)
    ], GetConsumerV1AvailabilityServiceIdStartDateEndDateDaysRequest.prototype, "locationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=resourceId",
        }),
        __metadata("design:type", String)
    ], GetConsumerV1AvailabilityServiceIdStartDateEndDateDaysRequest.prototype, "resourceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=serviceId",
        }),
        __metadata("design:type", String)
    ], GetConsumerV1AvailabilityServiceIdStartDateEndDateDaysRequest.prototype, "serviceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=startDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], GetConsumerV1AvailabilityServiceIdStartDateEndDateDaysRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=tzOffset",
        }),
        __metadata("design:type", Number)
    ], GetConsumerV1AvailabilityServiceIdStartDateEndDateDaysRequest.prototype, "tzOffset", void 0);
...
var GetConsumerV1AvailabilityServiceIdStartDateEndDateDaysResponse = /** @class */ (function (_super) {
    ...
    ], GetConsumerV1AvailabilityServiceIdStartDateEndDateDaysResponse.prototype, "rawResponse", void 0);
