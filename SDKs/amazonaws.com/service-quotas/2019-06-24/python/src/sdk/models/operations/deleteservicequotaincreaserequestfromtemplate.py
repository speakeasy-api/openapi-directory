...
from ..shared import deleteservicequotaincreaserequestfromtemplaterequest as shared_deleteservicequotaincreaserequestfromtemplaterequest
...
class DeleteServiceQuotaIncreaseRequestFromTemplateHeaders:
    x_amz_target: DeleteServiceQuotaIncreaseRequestFromTemplateXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteServiceQuotaIncreaseRequestFromTemplateRequest:
    headers: DeleteServiceQuotaIncreaseRequestFromTemplateHeaders = dataclasses.field()
    request: shared_deleteservicequotaincreaserequestfromtemplaterequest.DeleteServiceQuotaIncreaseRequestFromTemplateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteServiceQuotaIncreaseRequestFromTemplateResponse:
    ...
    delete_service_quota_increase_request_from_template_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
