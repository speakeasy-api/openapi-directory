...
public class CreateSipAuthRegistrationsCredentialListMappingCreateSipAuthRegistrationsCredentialListMappingRequest {
    ...
    public CreateSipAuthRegistrationsCredentialListMappingCreateSipAuthRegistrationsCredentialListMappingRequest(@JsonProperty("CredentialListSid") String credentialListSid) {
        this.credentialListSid = credentialListSid;
  }
}
