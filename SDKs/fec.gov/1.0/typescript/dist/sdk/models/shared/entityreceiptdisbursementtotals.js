...
exports.EntityReceiptDisbursementTotals = void 0;
...
var EntityReceiptDisbursementTotals = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cumulative_candidate_disbursements" }),
        __metadata("design:type", Number)
    ], EntityReceiptDisbursementTotals.prototype, "cumulativeCandidateDisbursements", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cumulative_candidate_receipts" }),
        __metadata("design:type", Number)
    ], EntityReceiptDisbursementTotals.prototype, "cumulativeCandidateReceipts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cumulative_pac_disbursements" }),
        __metadata("design:type", Number)
    ], EntityReceiptDisbursementTotals.prototype, "cumulativePacDisbursements", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cumulative_pac_receipts" }),
        __metadata("design:type", Number)
    ], EntityReceiptDisbursementTotals.prototype, "cumulativePacReceipts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cumulative_party_disbursements" }),
        __metadata("design:type", Number)
    ], EntityReceiptDisbursementTotals.prototype, "cumulativePartyDisbursements", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cumulative_party_receipts" }),
        __metadata("design:type", Number)
...
exports.EntityReceiptDisbursementTotals = EntityReceiptDisbursementTotals;
