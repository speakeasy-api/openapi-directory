...
func main() {
    ...
    res, err := s.SDK.DeleteThingShadow(ctx, operations.DeleteThingShadowRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.GetRetainedMessage(ctx, operations.GetRetainedMessageRequest{
    ...
    if res.GetRetainedMessageResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.GetThingShadow(ctx, operations.GetThingShadowRequest{
    ...
    if res.GetThingShadowResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.ListNamedShadowsForThing(ctx, operations.ListNamedShadowsForThingRequest{
    ...
    if res.ListNamedShadowsForThingResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.ListRetainedMessages(ctx, operations.ListRetainedMessagesRequest{
    ...
    if res.ListRetainedMessagesResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.Publish(ctx, operations.PublishRequest{
        RequestBody: operations.PublishRequestBody{
            Payload: sdk.String("excepturi"),
        },
        ...
        MessageExpiry: sdk.Int64(386489),
        Qos: sdk.Int64(943749),
        ResponseTopic: sdk.String("saepe"),
        Retain: sdk.Bool(false),
        Topic: "fuga",
        XAmzMqtt5CorrelationData: sdk.String("in"),
        XAmzMqtt5PayloadFormatIndicator: operations.PublishXAmzMqtt5PayloadFormatIndicatorEnumUnspecifiedBytes.ToPointer(),
        XAmzMqtt5UserProperties: sdk.String("iste"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.UpdateThingShadow(ctx, operations.UpdateThingShadowRequest{
        RequestBody: operations.UpdateThingShadowRequestBody{
            Payload: "iure",
        },
    ...
    if res.UpdateThingShadowResponse != nil {
        // handle response
    }
}
```
