 ...
 * @access public
 * @see https://docs.aws.amazon.com/firehose/
 */
class SDK
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateDeliveryStreamRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CreateDeliveryStreamResponse
     */
	public function createDeliveryStream(
        \OpenAPI\OpenAPI\Models\Operations\CreateDeliveryStreamRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateDeliveryStreamResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Firehose_20150804.CreateDeliveryStream');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createDeliveryStreamInput", "json");
        if ($body === null) {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreateDeliveryStreamResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->createDeliveryStreamOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateDeliveryStreamOutput', 'json');
            }
        }
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->invalidKMSResourceException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteDeliveryStreamRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeleteDeliveryStreamResponse
     */
	public function deleteDeliveryStream(
        \OpenAPI\OpenAPI\Models\Operations\DeleteDeliveryStreamRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteDeliveryStreamResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Firehose_20150804.DeleteDeliveryStream');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteDeliveryStreamInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeleteDeliveryStreamResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->deleteDeliveryStreamOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeDeliveryStreamRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeDeliveryStreamResponse
     */
	public function describeDeliveryStream(
        \OpenAPI\OpenAPI\Models\Operations\DescribeDeliveryStreamRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeDeliveryStreamResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Firehose_20150804.DescribeDeliveryStream');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeDeliveryStreamInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeDeliveryStreamResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeDeliveryStreamOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeDeliveryStreamOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListDeliveryStreamsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListDeliveryStreamsResponse
     */
	public function listDeliveryStreams(
        \OpenAPI\OpenAPI\Models\Operations\ListDeliveryStreamsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListDeliveryStreamsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Firehose_20150804.ListDeliveryStreams');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listDeliveryStreamsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListDeliveryStreamsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listDeliveryStreamsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListDeliveryStreamsOutput', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListTagsForDeliveryStreamRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListTagsForDeliveryStreamResponse
     */
	public function listTagsForDeliveryStream(
        \OpenAPI\OpenAPI\Models\Operations\ListTagsForDeliveryStreamRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListTagsForDeliveryStreamResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Firehose_20150804.ListTagsForDeliveryStream');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listTagsForDeliveryStreamInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListTagsForDeliveryStreamResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listTagsForDeliveryStreamOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListTagsForDeliveryStreamOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Firehose_20150804.PutRecord');
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\PutRecordBatchRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\PutRecordBatchResponse
     */
	public function putRecordBatch(
        \OpenAPI\OpenAPI\Models\Operations\PutRecordBatchRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\PutRecordBatchResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Firehose_20150804.PutRecordBatch');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "putRecordBatchInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PutRecordBatchResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->putRecordBatchOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\PutRecordBatchOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StartDeliveryStreamEncryptionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\StartDeliveryStreamEncryptionResponse
     */
	public function startDeliveryStreamEncryption(
        \OpenAPI\OpenAPI\Models\Operations\StartDeliveryStreamEncryptionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\StartDeliveryStreamEncryptionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Firehose_20150804.StartDeliveryStreamEncryption');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "startDeliveryStreamEncryptionInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StartDeliveryStreamEncryptionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->startDeliveryStreamEncryptionOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StopDeliveryStreamEncryptionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\StopDeliveryStreamEncryptionResponse
     */
	public function stopDeliveryStreamEncryption(
        \OpenAPI\OpenAPI\Models\Operations\StopDeliveryStreamEncryptionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\StopDeliveryStreamEncryptionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Firehose_20150804.StopDeliveryStreamEncryption');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "stopDeliveryStreamEncryptionInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StopDeliveryStreamEncryptionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->stopDeliveryStreamEncryptionOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\TagDeliveryStreamRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\TagDeliveryStreamResponse
     */
	public function tagDeliveryStream(
        \OpenAPI\OpenAPI\Models\Operations\TagDeliveryStreamRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\TagDeliveryStreamResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Firehose_20150804.TagDeliveryStream');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "tagDeliveryStreamInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\TagDeliveryStreamResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->tagDeliveryStreamOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UntagDeliveryStreamRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UntagDeliveryStreamResponse
     */
	public function untagDeliveryStream(
        \OpenAPI\OpenAPI\Models\Operations\UntagDeliveryStreamRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UntagDeliveryStreamResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Firehose_20150804.UntagDeliveryStream');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "untagDeliveryStreamInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UntagDeliveryStreamResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->untagDeliveryStreamOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Firehose_20150804.UpdateDestination');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateDestinationInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateDestinationOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
