...
export declare enum GETModifyCapacityReservationFleetActionEnum {
    ModifyCapacityReservationFleet = "ModifyCapacityReservationFleet"
}
export declare enum GETModifyCapacityReservationFleetVersionEnum {
    TwoThousandAndSixteen1115 = "2016-11-15"
}
export declare class GETModifyCapacityReservationFleetRequest extends SpeakeasyBase {
...
export declare class GETModifyCapacityReservationFleetResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
