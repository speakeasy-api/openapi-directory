...
type DatastreamProjectsLocationsPrivateConnectionsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DatastreamProjectsLocationsPrivateConnectionsListPathParams struct {
	// Required. The parent that owns the collection of private connectivity configurations.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type DatastreamProjectsLocationsPrivateConnectionsListQueryParams struct {
	// V1 error format.
...
type DatastreamProjectsLocationsPrivateConnectionsListRequest struct {
...
type DatastreamProjectsLocationsPrivateConnectionsListResponse struct {
	ContentType string
	// Successful response
