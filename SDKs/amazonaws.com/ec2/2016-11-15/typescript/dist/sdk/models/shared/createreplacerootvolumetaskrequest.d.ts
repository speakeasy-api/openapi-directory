 ...
 */
export declare enum CreateReplaceRootVolumeTaskRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateReplaceRootVolumeTaskRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateReplaceRootVolumeTaskRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateReplaceRootVolumeTaskRequest extends SpeakeasyBase {
    clientToken?: string;
