...
public class GETContinueUpdateRollbackQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=Action")
    public GETContinueUpdateRollbackActionEnum action;
    public GETContinueUpdateRollbackQueryParams withAction(GETContinueUpdateRollbackActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETContinueUpdateRollbackQueryParams withClientRequestToken(String clientRequestToken) {
    ...
    public GETContinueUpdateRollbackQueryParams withResourcesToSkip(String[] resourcesToSkip) {
    ...
    public GETContinueUpdateRollbackQueryParams withRoleARN(String roleARN) {
    ...
    public GETContinueUpdateRollbackQueryParams withStackName(String stackName) {
    ...
    public GETContinueUpdateRollbackQueryParams withVersion(GETContinueUpdateRollbackVersionEnum version) {
