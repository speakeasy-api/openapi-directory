...
class SearchTypeHazarddataQueryParams:
    ...
    search_type_hazarddata_source: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_hazarddata.source', 'style': 'form', 'explode': True }})
...
class SearchTypeHazarddataRequest:
    query_params: SearchTypeHazarddataQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeHazarddataResponse:
