...
exports.AssetsReturns = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var AssetsReturns = /** @class */ (function () {
    function AssetsReturns(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    AssetsReturns.prototype.postAssetsReturns = function (req, config) {
        var _a;
     ...
     *
    **/
    AssetsReturns.prototype.postAssetsReturnsAverage = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.AssetsReturns = AssetsReturns;
