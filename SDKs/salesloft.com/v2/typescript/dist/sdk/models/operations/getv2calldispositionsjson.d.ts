...
export declare class GetV2CallDispositionsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class GetV2CallDispositionsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
