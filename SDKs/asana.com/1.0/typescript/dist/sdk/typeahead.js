...
var Typeahead = /** @class */ (function () {
    ...
    Typeahead.prototype.typeaheadForWorkspace = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/workspaces/{workspace_gid}/typeahead", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.TypeaheadForWorkspaceResponse({
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.typeaheadForWorkspace200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.TypeaheadForWorkspace200ApplicationJSON);
                    }
                    break;
