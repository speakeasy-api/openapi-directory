...
func (e *SandboxItemSetVerificationStatusRequestVerificationStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "verification_expired":
		*e = SandboxItemSetVerificationStatusRequestVerificationStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for SandboxItemSetVerificationStatusRequestVerificationStatusEnum: %s", s)
	}
}
