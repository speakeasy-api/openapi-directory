...
class MarketingEventUpdateRequestParams:
    ...
    event_organizer: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('eventOrganizer'), 'exclude': lambda f: f is None }})
