...
public class Groups {
    ...
    **/
    public openapisdk.models.operations.GetGroupsResponse getGroups(openapisdk.models.operations.GetGroupsRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/hardware/groups");
    ...
    **/
    public openapisdk.models.operations.GetOneGroupResponse getOneGroup(openapisdk.models.operations.GetOneGroupRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/hardware/groups/{groupId}", request.pathParams);
        ...
        openapisdk.models.operations.GetOneGroupResponse res = new openapisdk.models.operations.GetOneGroupResponse() {{
            body = null;
            body = null;
            body = null;
        }};
    ...
    **/
    public openapisdk.models.operations.UpdateEnergyCostResponse updateEnergyCost(openapisdk.models.operations.UpdateEnergyCostRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/hardware/groups/{groupId}", request.pathParams);
        ...
        openapisdk.models.operations.UpdateEnergyCostResponse res = new openapisdk.models.operations.UpdateEnergyCostResponse() {{
            body = null;
            body = null;
            body = null;
        }};
