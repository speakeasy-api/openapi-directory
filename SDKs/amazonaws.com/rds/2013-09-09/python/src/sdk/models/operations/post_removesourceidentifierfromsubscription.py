...
class PostRemoveSourceIdentifierFromSubscriptionQueryParams:
    action: PostRemoveSourceIdentifierFromSubscriptionActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostRemoveSourceIdentifierFromSubscriptionVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostRemoveSourceIdentifierFromSubscriptionRequest:
    headers: PostRemoveSourceIdentifierFromSubscriptionHeaders = dataclasses.field()
    query_params: PostRemoveSourceIdentifierFromSubscriptionQueryParams = dataclasses.field()
