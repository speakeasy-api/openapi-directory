 ...
 *
 */
export class POSTTaxationItemForCMTypeFinanceInformation extends SpeakeasyBase {
  /**
 ...
 *
 */
export enum POSTTaxationItemForCMTypeTaxRateTypeEnum {
 ...
 *
 */
export class POSTTaxationItemForCMType extends SpeakeasyBase {
  /**
