...
var ApIs = /** @class */ (function () {
    ...
    **/
    ApIs.prototype.ctcer = function (req, config) {
        var _a;
    ...
    **/
    ApIs.prototype.ewcer = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ApIs.prototype.incer = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ApIs.prototype.rscer = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
