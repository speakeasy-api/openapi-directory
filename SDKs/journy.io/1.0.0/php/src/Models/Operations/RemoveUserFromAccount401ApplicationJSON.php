...
class RemoveUserFromAccount401ApplicationJSON
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\RemoveUserFromAccount401ApplicationJSONMeta')]
    public RemoveUserFromAccount401ApplicationJSONMeta $meta;
    
	public function __construct()
	{
		$this->message = "";
		$this->meta = new \OpenAPI\OpenAPI\Models\Operations\RemoveUserFromAccount401ApplicationJSONMeta();
	}
}
