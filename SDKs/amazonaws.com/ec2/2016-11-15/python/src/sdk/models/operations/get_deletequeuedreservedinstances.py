...
class GETDeleteQueuedReservedInstancesRequest:
    ...
    action: GETDeleteQueuedReservedInstancesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    reserved_instances_id: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'ReservedInstancesId', 'style': 'form', 'explode': True }})
    r"""The IDs of the Reserved Instances."""  
    version: GETDeleteQueuedReservedInstancesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
