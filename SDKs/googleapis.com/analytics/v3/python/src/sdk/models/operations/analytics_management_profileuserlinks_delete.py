...
class AnalyticsManagementProfileUserLinksDeleteRequest:
    path_params: AnalyticsManagementProfileUserLinksDeletePathParams = dataclasses.field()
    query_params: AnalyticsManagementProfileUserLinksDeleteQueryParams = dataclasses.field()
    security: AnalyticsManagementProfileUserLinksDeleteSecurity = dataclasses.field()
