...
class SellerStandardsProfile:
    ...
    def find_seller_standards_profiles(self) -> operations.FindSellerStandardsProfilesResponse:
        ...
        res = operations.FindSellerStandardsProfilesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.FindSellerStandardsProfilesResponse])
    ...
    def get_seller_standards_profile(self, request: operations.GetSellerStandardsProfileRequest, security: operations.GetSellerStandardsProfileSecurity) -> operations.GetSellerStandardsProfileResponse:
        ...
        url = utils.generate_url(operations.GetSellerStandardsProfileRequest, base_url, '/seller_standards_profile/{program}/{cycle}', request)
        ...
        res = operations.GetSellerStandardsProfileResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StandardsProfile])
