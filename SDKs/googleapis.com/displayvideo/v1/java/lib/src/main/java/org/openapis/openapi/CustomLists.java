...
public class CustomLists {
    ...
    public org.openapis.openapi.models.operations.DisplayvideoCustomListsGetResponse displayvideoCustomListsGet(org.openapis.openapi.models.operations.DisplayvideoCustomListsGetRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.DisplayvideoCustomListsGetPathParams.class, baseUrl, "/v1/customLists/{customListId}", request.pathParams, null);
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.CustomList out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.CustomList.class);
                res.customList = out;
            }
        }
    ...
    public org.openapis.openapi.models.operations.DisplayvideoCustomListsListResponse displayvideoCustomListsList(org.openapis.openapi.models.operations.DisplayvideoCustomListsListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/v1/customLists");
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.ListCustomListsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.ListCustomListsResponse.class);
