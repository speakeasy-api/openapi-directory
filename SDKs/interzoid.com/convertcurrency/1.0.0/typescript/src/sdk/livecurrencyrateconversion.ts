...
export class LiveCurrencyRateConversion {
  ...
  convertcurrency(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ConvertcurrencyResponse =
        new operations.ConvertcurrencyResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.convertcurrency200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Convertcurrency200ApplicationJSON
            );
          }
          break;
