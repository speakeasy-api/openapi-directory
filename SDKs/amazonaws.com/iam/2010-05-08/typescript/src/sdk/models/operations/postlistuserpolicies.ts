...
export enum POSTListUserPoliciesActionEnum {
  ListUserPolicies = "ListUserPolicies",
}

export enum POSTListUserPoliciesVersionEnum {
  TwoThousandAndTen0508 = "2010-05-08",
}

export class POSTListUserPoliciesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class POSTListUserPoliciesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
