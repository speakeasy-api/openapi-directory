...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.createChannel = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels", req);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.ipMessagingV2ServiceChannel = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IpMessagingV2ServiceChannel);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createChannelWebhook = function (req, security, serverURL, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "requestBody", "form"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.CreateChannelWebhookResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.ipMessagingV2ServiceChannelChannelWebhook = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IpMessagingV2ServiceChannelChannelWebhook);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createCredential = function (req, security, serverURL, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.ipMessagingV2Credential = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IpMessagingV2Credential);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createInvite = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Invites", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "requestBody", "form"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.ipMessagingV2ServiceChannelInvite = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IpMessagingV2ServiceChannelInvite);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createMember = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Members", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "requestBody", "form"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.ipMessagingV2ServiceChannelMember = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IpMessagingV2ServiceChannelMember);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createMessage = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Messages", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "requestBody", "form"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.ipMessagingV2ServiceChannelMessage = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IpMessagingV2ServiceChannelMessage);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createRole = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Roles", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "requestBody", "form"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.ipMessagingV2ServiceRole = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IpMessagingV2ServiceRole);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createService = function (req, security, serverURL, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.ipMessagingV2Service = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IpMessagingV2Service);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createUser = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "requestBody", "form"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.ipMessagingV2ServiceUser = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IpMessagingV2ServiceUser);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.deleteBinding = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Bindings/{Sid}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.deleteChannel = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{Sid}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.deleteChannelWebhook = function (req, security, serverURL, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks/{Sid}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.DeleteChannelWebhookResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    SDK.prototype.deleteCredential = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Credentials/{Sid}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.deleteInvite = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Invites/{Sid}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.deleteMember = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Members/{Sid}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.deleteMessage = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Messages/{Sid}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.deleteRole = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Roles/{Sid}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.deleteUser = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{Sid}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.deleteUserBinding = function (req, security, serverURL, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Bindings/{Sid}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.DeleteUserBindingResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    SDK.prototype.deleteUserChannel = function (req, security, serverURL, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels/{ChannelSid}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.DeleteUserChannelResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.ipMessagingV2ServiceBinding = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IpMessagingV2ServiceBinding);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.fetchChannelWebhook = function (req, security, serverURL, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.FetchChannelWebhookResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    SDK.prototype.fetchUserBinding = function (req, security, serverURL, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.FetchUserBindingResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.ipMessagingV2ServiceUserUserBinding = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IpMessagingV2ServiceUserUserBinding);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.fetchUserChannel = function (req, security, serverURL, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.FetchUserChannelResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.ipMessagingV2ServiceUserUserChannel = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IpMessagingV2ServiceUserUserChannel);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.listBinding = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Bindings", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.listChannelWebhook = function (req, security, serverURL, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ListChannelWebhookResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.listChannelWebhookResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.ListChannelWebhookListChannelWebhookResponse);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.listUserBinding = function (req, security, serverURL, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Bindings", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ListUserBindingResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.listUserBindingResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.ListUserBindingListUserBindingResponse);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.listUserChannel = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.updateChannelWebhook = function (req, security, serverURL, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.UpdateChannelWebhookResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    SDK.prototype.updateUserChannel = function (req, security, serverURL, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.UpdateUserChannelResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
