...
class ListProtectionGroupsRequest:
    ...
    list_protection_groups_request: shared_listprotectiongroupsrequest.ListProtectionGroupsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
