...
class BuildBatchPhase:
    r"""Contains information about a stage for a batch build."""
    ...
    phase_type: Optional[shared_buildbatchphasetype_enum.BuildBatchPhaseTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('phaseType'), 'exclude': lambda f: f is None }})  
