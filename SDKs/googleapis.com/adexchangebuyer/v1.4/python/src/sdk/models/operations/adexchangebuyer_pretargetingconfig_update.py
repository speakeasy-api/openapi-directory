...
class AdexchangebuyerPretargetingConfigUpdateRequest:
    path_params: AdexchangebuyerPretargetingConfigUpdatePathParams = dataclasses.field()
    query_params: AdexchangebuyerPretargetingConfigUpdateQueryParams = dataclasses.field()
    security: AdexchangebuyerPretargetingConfigUpdateSecurity = dataclasses.field()
    request: Optional[shared_pretargetingconfig.PretargetingConfig] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
