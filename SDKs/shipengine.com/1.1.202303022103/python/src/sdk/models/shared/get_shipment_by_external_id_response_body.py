...
class GetShipmentByExternalIDResponseBodyDeliveryConfirmationEnum(str, Enum):
...
class GetShipmentByExternalIDResponseBodyInternationalShipmentOptionsPackageContentsEnum(str, Enum):
...
class GetShipmentByExternalIDResponseBodyInternationalShipmentOptionsNonDeliveryEnum(str, Enum):
...
class GetShipmentByExternalIDResponseBodyInternationalShipmentOptions:
    ...
    contents: GetShipmentByExternalIDResponseBodyInternationalShipmentOptionsPackageContentsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contents') }})
    r"""The type of contents in this shipment.  This may impact import duties or customs treatment."""  
    non_delivery: GetShipmentByExternalIDResponseBodyInternationalShipmentOptionsNonDeliveryEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('non_delivery') }})
...
class GetShipmentByExternalIDResponseBodyInsuranceProviderEnum(str, Enum):
...
class GetShipmentByExternalIDResponseBodyOriginTypeEnum(str, Enum):
    r"""Indicates if the package will be picked up or dropped off by the carrier"""
    PICKUP = 'pickup'
    DROP_OFF = 'drop_off'

class GetShipmentByExternalIDResponseBodyShipmentStatusEnum(str, Enum):
...
class GetShipmentByExternalIDResponseBody:
    ...
    confirmation: GetShipmentByExternalIDResponseBodyDeliveryConfirmationEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('confirmation') }})
    ...
    customs: GetShipmentByExternalIDResponseBodyInternationalShipmentOptions = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('customs') }})
    r"""Customs information.  This is usually only needed for international shipments."""  
    insurance_provider: GetShipmentByExternalIDResponseBodyInsuranceProviderEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('insurance_provider') }})
    ...
    shipment_status: GetShipmentByExternalIDResponseBodyShipmentStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shipment_status') }})
    ...
    total_weight: GetShipmentByExternalIDResponseBodyWeight = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('total_weight') }})
    ...
    origin_type: Optional[GetShipmentByExternalIDResponseBodyOriginTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin_type'), 'exclude': lambda f: f is None }})
    r"""Indicates if the package will be picked up or dropped off by the carrier"""  
