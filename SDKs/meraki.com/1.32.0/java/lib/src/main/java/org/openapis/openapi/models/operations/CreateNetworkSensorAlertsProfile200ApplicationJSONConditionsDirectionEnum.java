 ...
 */
public enum CreateNetworkSensorAlertsProfile200ApplicationJSONConditionsDirectionEnum {
    ABOVE("above"),
    BELOW("below");
    ...
    private CreateNetworkSensorAlertsProfile200ApplicationJSONConditionsDirectionEnum(String value) {
        this.value = value;
    }
}
