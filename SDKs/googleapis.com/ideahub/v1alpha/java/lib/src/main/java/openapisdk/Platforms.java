...
public class Platforms {
    ...
    **/
    public openapisdk.models.operations.IdeahubPlatformsPropertiesIdeaActivitiesCreateResponse ideahubPlatformsPropertiesIdeaActivitiesCreate(openapisdk.models.operations.IdeahubPlatformsPropertiesIdeaActivitiesCreateRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1alpha/{parent}/ideaActivities", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GoogleSearchIdeahubV1alphaIdeaActivity out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GoogleSearchIdeahubV1alphaIdeaActivity.class);
    ...
    **/
    public openapisdk.models.operations.IdeahubPlatformsPropertiesIdeasListResponse ideahubPlatformsPropertiesIdeasList(openapisdk.models.operations.IdeahubPlatformsPropertiesIdeasListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1alpha/{parent}/ideas", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GoogleSearchIdeahubV1alphaListIdeasResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GoogleSearchIdeahubV1alphaListIdeasResponse.class);
    ...
    **/
    public openapisdk.models.operations.IdeahubPlatformsPropertiesLocalesListResponse ideahubPlatformsPropertiesLocalesList(openapisdk.models.operations.IdeahubPlatformsPropertiesLocalesListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1alpha/{parent}/locales", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GoogleSearchIdeahubV1alphaListAvailableLocalesResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GoogleSearchIdeahubV1alphaListAvailableLocalesResponse.class);
    ...
    public openapisdk.models.operations.IdeahubPlatformsPropertiesTopicStatesPatchResponse ideahubPlatformsPropertiesTopicStatesPatch(openapisdk.models.operations.IdeahubPlatformsPropertiesTopicStatesPatchRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GoogleSearchIdeahubV1alphaTopicState out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GoogleSearchIdeahubV1alphaTopicState.class);
