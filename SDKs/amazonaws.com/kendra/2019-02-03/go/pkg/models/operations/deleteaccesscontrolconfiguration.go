...
type DeleteAccessControlConfigurationHeaders struct {
...
type DeleteAccessControlConfigurationRequest struct {
	Headers DeleteAccessControlConfigurationHeaders
	Request shared.DeleteAccessControlConfigurationRequest `request:"mediaType=application/json"`
}
