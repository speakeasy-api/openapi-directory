...
var CreateSubscriptionRequest = /** @class */ (function (_super) {
    ...
    ], CreateSubscriptionRequest.prototype, "canceledDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "card_id" }),
        __metadata("design:type", String)
    ], CreateSubscriptionRequest.prototype, "cardId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "customer_id" }),
        __metadata("design:type", String)
    ], CreateSubscriptionRequest.prototype, "customerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "idempotency_key" }),
        __metadata("design:type", String)
    ], CreateSubscriptionRequest.prototype, "idempotencyKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "location_id" }),
        __metadata("design:type", String)
    ], CreateSubscriptionRequest.prototype, "locationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "plan_id" }),
        __metadata("design:type", String)
    ], CreateSubscriptionRequest.prototype, "planId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    ], CreateSubscriptionRequest.prototype, "priceOverrideMoney", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "start_date" }),
        __metadata("design:type", String)
    ], CreateSubscriptionRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "tax_percentage" }),
        __metadata("design:type", String)
    ], CreateSubscriptionRequest.prototype, "taxPercentage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
