...
public class GetOrder200ApplicationJSONOrderResponseV2ConsigneeV2 {
    ...
    public GetOrder200ApplicationJSONOrderResponseV2ConsigneeV2 withUpdatedBy(org.openapis.openapi.models.shared.OnereturnsGetResponses200ContentApplication1jsonSchemaPropertiesDataItemsPropertiesUpdatedBy updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    
    public GetOrder200ApplicationJSONOrderResponseV2ConsigneeV2(@JsonProperty("address1") String address1, @JsonProperty("addressLocality") String addressLocality, @JsonProperty("addressRegion") String addressRegion, @JsonProperty("country") String country, @JsonProperty("firstName") String firstName, @JsonProperty("id") Long id, @JsonProperty("lastName") String lastName, @JsonProperty("postalCode") String postalCode) {
        this.address1 = address1;
        this.addressLocality = addressLocality;
        this.addressRegion = addressRegion;
        this.country = country;
