...
API method documentation
<https://docs.github.com/rest/reference/codespaces#add-selected-repository-to-an-organization-secret>
...
API method documentation
<https://docs.github.com/rest/reference/codespaces#create-or-update-an-organization-secret>
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesCreateOrUpdateOrgSecret(ctx, operations.CodespacesCreateOrUpdateOrgSecretRequest{
        RequestBody: operations.CodespacesCreateOrUpdateOrgSecretRequestBody{
            EncryptedValue: sdk.String("architecto"),
            KeyID: sdk.String("suscipit"),
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesCreateOrUpdateRepoSecret(ctx, operations.CodespacesCreateOrUpdateRepoSecretRequest{
        RequestBody: operations.CodespacesCreateOrUpdateRepoSecretRequestBody{
            EncryptedValue: sdk.String("sed"),
            KeyID: sdk.String("provident"),
        },
        Owner: "eius",
        Repo: "necessitatibus",
        SecretName: "ipsum",
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesCreateWithPrForAuthenticatedUser(ctx, operations.CodespacesCreateWithPrForAuthenticatedUserRequest{
        RequestBody: operations.CodespacesCreateWithPrForAuthenticatedUserRequestBody{
            ClientIP: sdk.String("non"),
            DevcontainerPath: sdk.String("officiis"),
            DisplayName: sdk.String("praesentium"),
            IdleTimeoutMinutes: sdk.Int64(708609),
            Location: sdk.String("quaerat"),
            Machine: sdk.String("incidunt"),
            MultiRepoPermissionsOptOut: sdk.Bool(false),
            RetentionPeriodMinutes: sdk.Int64(373035),
            WorkingDirectory: sdk.String("debitis"),
        },
        Owner: "rem",
        PullNumber: 26522,
        Repo: "nobis",
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesCreateWithRepoForAuthenticatedUser(ctx, operations.CodespacesCreateWithRepoForAuthenticatedUserRequest{
        RequestBody: operations.CodespacesCreateWithRepoForAuthenticatedUserRequestBody{
            ClientIP: sdk.String("error"),
            DevcontainerPath: sdk.String("veniam"),
            DisplayName: sdk.String("minima"),
            IdleTimeoutMinutes: sdk.Int64(924159),
            Location: sdk.String("reiciendis"),
            Machine: sdk.String("nulla"),
            MultiRepoPermissionsOptOut: sdk.Bool(false),
            Ref: sdk.String("magni"),
            RetentionPeriodMinutes: sdk.Int64(48690),
            WorkingDirectory: sdk.String("saepe"),
        },
        Owner: "numquam",
        Repo: "veniam",
    })
...
API method documentation
<https://docs.github.com/rest/reference/codespaces#delete-codespaces-billing-users>
...
API method documentation
<https://docs.github.com/rest/reference/codespaces#delete-an-organization-secret>
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesGetCodespacesForUserInOrg(ctx, operations.CodespacesGetCodespacesForUserInOrgRequest{
        Org: "dolorum",
        Page: sdk.Int64(548361),
        PerPage: sdk.Int64(879235),
        Username: "Donny28",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/rest/reference/codespaces#get-an-organization-public-key>
...
API method documentation
<https://docs.github.com/rest/reference/codespaces#get-an-organization-secret>
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesListForAuthenticatedUser(ctx, operations.CodespacesListForAuthenticatedUserRequest{
        ...
        PerPage: sdk.Int64(24313),
        RepositoryID: sdk.Int64(425508),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesListInOrganization(ctx, operations.CodespacesListInOrganizationRequest{
        Org: "nostrum",
        Page: sdk.Int64(906172),
        PerPage: sdk.Int64(622231),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesListInRepositoryForAuthenticatedUser(ctx, operations.CodespacesListInRepositoryForAuthenticatedUserRequest{
        Owner: "consequatur",
        Page: sdk.Int64(279068),
        PerPage: sdk.Int64(968865),
        Repo: "dolorem",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesListOrgSecrets(ctx, operations.CodespacesListOrgSecretsRequest{
        Org: "harum",
        Page: sdk.Int64(115703),
        PerPage: sdk.Int64(99416),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesListSecretsForAuthenticatedUser(ctx, operations.CodespacesListSecretsForAuthenticatedUserRequest{
        Page: sdk.Int64(724148),
        PerPage: sdk.Int64(948861),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/rest/reference/codespaces#list-selected-repositories-for-an-organization-secret>
...
API method documentation
<https://docs.github.com/rest/reference/codespaces/codespaces#create-a-repository-from-an-unpublished-codespace>
...
API method documentation
<https://docs.github.com/rest/reference/codespaces#remove-selected-repository-from-an-organization-secret>
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesRepoMachinesForAuthenticatedUser(ctx, operations.CodespacesRepoMachinesForAuthenticatedUserRequest{
        ClientIP: sdk.String("praesentium"),
...
API method documentation
<https://docs.github.com/rest/reference/codespaces#set-codespaces-billing>
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesSetCodespacesBilling(ctx, operations.CodespacesSetCodespacesBillingRequest{
        RequestBody: operations.CodespacesSetCodespacesBillingRequestBody{
            ...
            Visibility: operations.CodespacesSetCodespacesBillingRequestBodyVisibilityEnumAllMembersAndOutsideCollaborators,
        },
        Org: "quasi",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/rest/reference/codespaces#set-codespaces-billing-users>
...
API method documentation
<https://docs.github.com/rest/reference/codespaces#set-selected-repositories-for-an-organization-secret>
...
func main() {
    ...
    res, err := s.Codespaces.CodespacesUpdateForAuthenticatedUser(ctx, operations.CodespacesUpdateForAuthenticatedUserRequest{
        RequestBody: &operations.CodespacesUpdateForAuthenticatedUserRequestBody{
            ...
            Machine: sdk.String("repudiandae"),
