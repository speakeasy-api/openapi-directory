...
class TrusthubV1CustomerProfile:
    ...
    status: Optional[shared_customer_profile_enum_status_enum.CustomerProfileEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
