...
class VirtualTariffConsumption:
    ...
    def virtual_tariff_consumption_get(self, request: operations.VirtualTariffConsumptionGetRequest) -> operations.VirtualTariffConsumptionGetResponse:
        ...
        query_params = utils.get_query_params(operations.VirtualTariffConsumptionGetRequest, request)
        ...
        res = operations.VirtualTariffConsumptionGetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.VirtualTariffConsumptionData]])
