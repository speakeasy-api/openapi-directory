 ...
 */
export enum PacketMirroringAggregatedListWarningCodeEnum {
...
export class PacketMirroringAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class PacketMirroringAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: PacketMirroringAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class PacketMirroringAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: PacketMirroringsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, PacketMirroringsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], PacketMirroringsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
