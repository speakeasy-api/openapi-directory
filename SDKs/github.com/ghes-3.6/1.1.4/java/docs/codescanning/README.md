...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningDeleteAnalysisRequest req = new CodeScanningDeleteAnalysisRequest(56848L, "id", "quidem") {{
                confirmDelete = "neque";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetAlertRequest req = new CodeScanningGetAlertRequest(778696L, "illum", "quo");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetAnalysisRequest req = new CodeScanningGetAnalysisRequest(681359L, "eius", "eos");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetSarifRequest req = new CodeScanningGetSarifRequest("voluptas", "ab", "cupiditate");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListAlertInstancesRequest req = new CodeScanningListAlertInstancesRequest(9688L, "tempora", "debitis") {{
                page = 370853L;
                perPage = 133465L;
                ref = "sequi";
            }};            
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.CodeScanningListAlertsForOrgRequest;
import org.openapis.openapi.models.operations.CodeScanningListAlertsForOrgResponse;
import org.openapis.openapi.models.operations.CodeScanningListAlertsForOrgSortEnum;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListAlertsForOrgRequest req = new CodeScanningListAlertsForOrgRequest("quo") {{
                after = "esse";
                before = "recusandae";
                direction = DirectionEnum.ASC;
                page = 715179L;
                perPage = 799796L;
                sort = CodeScanningListAlertsForOrgSortEnum.CREATED;
                state = CodeScanningAlertStateEnum.OPEN;
                toolGuid = "nihil";
                toolName = "totam";
            }};            

            CodeScanningListAlertsForOrgResponse res = sdk.codeScanning.codeScanningListAlertsForOrg(req);

            if (res.codeScanningOrganizationAlertItems != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListAlertsForRepoRequest req = new CodeScanningListAlertsForRepoRequest("accusamus", "aliquam") {{
                direction = DirectionEnum.ASC;
                page = 577543L;
                perPage = 414567L;
                ref = "sapiente";
                sort = CodeScanningListAlertsForRepoSortEnum.CREATED;
                state = CodeScanningAlertStateEnum.DISMISSED;
                toolGuid = "molestiae";
                toolName = "accusantium";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListRecentAnalysesRequest req = new CodeScanningListRecentAnalysesRequest("porro", "eum") {{
                page = 556429L;
                perPage = 510017L;
                ref = "consequuntur";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningUploadSarifRequest req = new CodeScanningUploadSarifRequest(                new CodeScanningUploadSarifRequestBody("nisi", "fugit", "sapiente") {{
                                checkoutUri = "file:///github/workspace/";
                                startedAt = OffsetDateTime.parse("2022-10-24T16:43:59.350Z");
                                toolName = "explicabo";
                            }};, "saepe", "occaecati");            
