...
public class GetMeCommentsToIdRequest {
    ...
    public GetMeCommentsToIdRequest withCallback(String callback) {
    ...
    public GetMeCommentsToIdRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeCommentsToIdRequest withFromdate(Long fromdate) {
    ...
    public GetMeCommentsToIdRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetMeCommentsToIdRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetMeCommentsToIdRequest withOrder(GetMeCommentsToIdOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetMeCommentsToIdRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeCommentsToIdRequest withPagesize(Long pagesize) {
    ...
    public GetMeCommentsToIdRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetMeCommentsToIdRequest withSort(GetMeCommentsToIdSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetMeCommentsToIdRequest withToId(Long toId) {
        this.toId = toId;
        return this;
    }
    ...
    public GetMeCommentsToIdRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetMeCommentsToIdRequest(@JsonProperty("site") String site, @JsonProperty("toId") Long toId) {
        this.site = site;
        this.toId = toId;
  }
}
