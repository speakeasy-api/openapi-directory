...
public class CreditNotesAddRequest {
    ...
    public CreditNotesAddRequest(@JsonProperty("CreditNoteInput") org.openapis.openapi.models.shared.CreditNoteInput creditNoteInput, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.creditNoteInput = creditNoteInput;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
  }
