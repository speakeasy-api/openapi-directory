...
func (e CloudidentityGroupsListViewEnum) ToPointer() *CloudidentityGroupsListViewEnum {
	return &e
}
...
func (e *CloudidentityGroupsListViewEnum) UnmarshalJSON(data []byte) error {
	...
	case "BASIC":
		fallthrough
	case "FULL":
		*e = CloudidentityGroupsListViewEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CloudidentityGroupsListViewEnum: %v", v)
	}
}
