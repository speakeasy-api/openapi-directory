...
from ..shared import fetchactionresponse as shared_fetchactionresponse
...
class FetchActionResponse:
    ...
    fetch_action_response: Optional[shared_fetchactionresponse.FetchActionResponse] = dataclasses.field(default=None)
    r"""OK"""  
