...
class ImportationReattendColumnPathParams:
...
@dataclasses.dataclass
class ImportationReattendColumnRequest:
    path_params: ImportationReattendColumnPathParams = dataclasses.field()
    

@dataclasses.dataclass
class ImportationReattendColumnResponse:
