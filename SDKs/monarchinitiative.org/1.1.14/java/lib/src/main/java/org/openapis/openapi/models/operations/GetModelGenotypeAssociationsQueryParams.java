...
public class GetModelGenotypeAssociationsQueryParams {
    /**
    ...
    public GetModelGenotypeAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetModelGenotypeAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetModelGenotypeAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetModelGenotypeAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetModelGenotypeAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetModelGenotypeAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetModelGenotypeAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public String q;
    public GetModelGenotypeAssociationsQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetModelGenotypeAssociationsQueryParams withRelation(String relation) {
    ...
    public Long rows;
    public GetModelGenotypeAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetModelGenotypeAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public String sort;
    public GetModelGenotypeAssociationsQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetModelGenotypeAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetModelGenotypeAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetModelGenotypeAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetModelGenotypeAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
