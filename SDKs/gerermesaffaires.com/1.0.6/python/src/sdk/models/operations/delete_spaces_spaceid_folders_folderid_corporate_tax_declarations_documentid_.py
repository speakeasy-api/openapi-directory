...
class DeleteSpacesSpaceIDFoldersFolderIDCorporateTaxDeclarationsDocumentIDRequest:
...
@dataclasses.dataclass
class DeleteSpacesSpaceIDFoldersFolderIDCorporateTaxDeclarationsDocumentIDResponse:
