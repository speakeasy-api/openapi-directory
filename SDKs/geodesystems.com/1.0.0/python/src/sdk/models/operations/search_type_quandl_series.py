...
class SearchTypeQuandlSeriesQueryParams:
...
@dataclasses.dataclass
class SearchTypeQuandlSeriesRequest:
    query_params: SearchTypeQuandlSeriesQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeQuandlSeriesResponse:
