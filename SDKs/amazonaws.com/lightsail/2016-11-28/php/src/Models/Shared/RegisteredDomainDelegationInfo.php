...
{
	#[\JMS\Serializer\Annotation\SerializedName('nameServersUpdateState')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\NameServersUpdateState')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?NameServersUpdateState $nameServersUpdateState = null;
    
	#[\JMS\Serializer\Annotation\SerializedName('r53HostedZoneDeletionState')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\R53HostedZoneDeletionState')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?R53HostedZoneDeletionState $r53HostedZoneDeletionState = null;
    
	public function __construct()
	{
		$this->nameServersUpdateState = null;
		$this->r53HostedZoneDeletionState = null;
	}
}
