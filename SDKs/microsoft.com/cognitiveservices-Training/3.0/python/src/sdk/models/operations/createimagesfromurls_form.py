...
class CreateImagesFromUrlsFormRequest:
    
    image_url_create_batch: shared_imageurlcreatebatch.ImageURLCreateBatch = dataclasses.field(metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
...
@dataclasses.dataclass
class CreateImagesFromUrlsFormResponse:
