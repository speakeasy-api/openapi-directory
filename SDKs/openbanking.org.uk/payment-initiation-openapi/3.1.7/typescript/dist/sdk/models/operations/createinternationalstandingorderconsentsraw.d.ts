...
export declare class CreateInternationalStandingOrderConsentsRawSecurity extends SpeakeasyBase {
    tppoAuth2Security: string;
}
export declare class CreateInternationalStandingOrderConsentsRawRequest extends SpeakeasyBase {
    /**
...
export declare class CreateInternationalStandingOrderConsentsRawResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
