...
exports.GetCandidateCandidateIdHistoryCycleResponse = exports.GetCandidateCandidateIdHistoryCycleRequest = void 0;
...
var GetCandidateCandidateIdHistoryCycleRequest = /** @class */ (function (_super) {
    ...
    ], GetCandidateCandidateIdHistoryCycleRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=candidate_id",
        }),
        __metadata("design:type", String)
    ], GetCandidateCandidateIdHistoryCycleRequest.prototype, "candidateId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=cycle",
        }),
        __metadata("design:type", Number)
    ], GetCandidateCandidateIdHistoryCycleRequest.prototype, "cycle", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=election_full",
        }),
        __metadata("design:type", Boolean)
    ], GetCandidateCandidateIdHistoryCycleRequest.prototype, "electionFull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetCandidateCandidateIdHistoryCycleRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetCandidateCandidateIdHistoryCycleRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetCandidateCandidateIdHistoryCycleRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_hide_null",
        }),
        __metadata("design:type", Boolean)
    ], GetCandidateCandidateIdHistoryCycleRequest.prototype, "sortHideNull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_null_only",
        }),
        __metadata("design:type", Boolean)
    ], GetCandidateCandidateIdHistoryCycleRequest.prototype, "sortNullOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_nulls_last",
        }),
        __metadata("design:type", Boolean)
    ], GetCandidateCandidateIdHistoryCycleRequest.prototype, "sortNullsLast", void 0);
...
var GetCandidateCandidateIdHistoryCycleResponse = /** @class */ (function (_super) {
    ...
    ], GetCandidateCandidateIdHistoryCycleResponse.prototype, "rawResponse", void 0);
