...
class CreateAccountResponsePayoutSpeedEnum(str, Enum):
...
class CreateAccountResponse:
    ...
    r"""A list of fields that caused the `/createAccount` request to fail."""  
    ...
    payout_speed: Optional[CreateAccountResponsePayoutSpeedEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payoutSpeed'), 'exclude': lambda f: f is None }})
    r"""Speed with which payouts for this account are processed. Permitted values: `STANDARD`, `SAME_DAY`."""  
