...
class DisconnectParticipantRequest:
    headers: DisconnectParticipantHeaders = dataclasses.field()
    request: DisconnectParticipantRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
