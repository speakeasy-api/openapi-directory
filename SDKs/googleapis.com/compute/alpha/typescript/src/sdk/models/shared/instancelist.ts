 ...
 */
export enum InstanceListWarningCodeEnum {
...
export class InstanceListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class InstanceList extends SpeakeasyBase {
  /**
