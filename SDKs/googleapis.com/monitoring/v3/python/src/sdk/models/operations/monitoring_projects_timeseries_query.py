...
class MonitoringProjectsTimeSeriesQueryRequest:
    ...
    query_time_series_request: Optional[shared_querytimeseriesrequest.QueryTimeSeriesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
