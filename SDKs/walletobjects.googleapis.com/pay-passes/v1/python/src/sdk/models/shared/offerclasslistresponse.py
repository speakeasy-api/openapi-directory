...
class OfferClassListResponse:
    ...
    resources: Optional[list[shared_offerclass.OfferClass]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources'), 'exclude': lambda f: f is None }})
