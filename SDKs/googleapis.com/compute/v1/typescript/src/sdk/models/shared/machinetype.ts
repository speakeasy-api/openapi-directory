...
export class MachineTypeScratchDisks extends SpeakeasyBase {
  /**
...
export class MachineType extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: MachineTypeScratchDisks })
  @Expose({ name: "scratchDisks" })
