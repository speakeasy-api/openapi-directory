...
export class AutomlProjectsLocationsModelsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AutomlProjectsLocationsModelsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AutomlProjectsLocationsModelsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
