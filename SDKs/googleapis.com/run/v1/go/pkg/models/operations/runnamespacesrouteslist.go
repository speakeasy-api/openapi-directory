...
type RunNamespacesRoutesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RunNamespacesRoutesListPathParams struct {
...
type RunNamespacesRoutesListQueryParams struct {
	// V1 error format.
...
type RunNamespacesRoutesListRequest struct {
...
type RunNamespacesRoutesListResponse struct {
	ContentType string
	// Successful response
