...
exports.SetDefaultAuthorizerResponse = exports.SetDefaultAuthorizerRequest = exports.SetDefaultAuthorizerRequestBody = void 0;
...
exports.SetDefaultAuthorizerRequestBody = SetDefaultAuthorizerRequestBody;
var SetDefaultAuthorizerRequest = /** @class */ (function (_super) {
    ...
    ], SetDefaultAuthorizerRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], SetDefaultAuthorizerRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], SetDefaultAuthorizerRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], SetDefaultAuthorizerRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], SetDefaultAuthorizerRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], SetDefaultAuthorizerRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], SetDefaultAuthorizerRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], SetDefaultAuthorizerRequest.prototype, "xAmzSignedHeaders", void 0);
    return SetDefaultAuthorizerRequest;
}(utils_1.SpeakeasyBase));
exports.SetDefaultAuthorizerRequest = SetDefaultAuthorizerRequest;
var SetDefaultAuthorizerResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], SetDefaultAuthorizerResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.SetDefaultAuthorizerResponse = SetDefaultAuthorizerResponse;
