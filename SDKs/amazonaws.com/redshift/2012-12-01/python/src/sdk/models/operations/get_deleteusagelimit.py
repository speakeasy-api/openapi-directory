...
class GetDeleteUsageLimitQueryParams:
    action: GetDeleteUsageLimitActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    usage_limit_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'UsageLimitId', 'style': 'form', 'explode': True }})
    version: GetDeleteUsageLimitVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteUsageLimitRequest:
    headers: GetDeleteUsageLimitHeaders = dataclasses.field()
    query_params: GetDeleteUsageLimitQueryParams = dataclasses.field()
