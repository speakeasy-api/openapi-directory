...
export enum PutAdminMappingsStubMappingIdRequestBodyResponseDelayDistributionUniformTypeEnum {
  Uniform = "uniform",
}
 ...
 */
export class PutAdminMappingsStubMappingIdRequestBodyResponseDelayDistributionUniform extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "lower" })
  lower?: number;
...
export enum PutAdminMappingsStubMappingIdRequestBodyResponseDelayDistributionLogNormalTypeEnum {
  Lognormal = "lognormal",
}
 ...
 */
export class PutAdminMappingsStubMappingIdRequestBodyResponseDelayDistributionLogNormal extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "median" })
  median?: number;
...
export class PutAdminMappingsStubMappingIdRequestBody extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "request" })
  @Type(() => PutAdminMappingsStubMappingIdRequestBodyRequest)
  ...
  @Type(() => PutAdminMappingsStubMappingIdRequestBodyResponse)
...
export enum PutAdminMappingsStubMappingId200ApplicationJSONResponseDelayDistributionUniformTypeEnum {
  Uniform = "uniform",
}
 ...
 * Uniformly distributed random response delay.
 */
export class PutAdminMappingsStubMappingId200ApplicationJSONResponseDelayDistributionUniform extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "lower" })
  lower?: number;
...
export enum PutAdminMappingsStubMappingId200ApplicationJSONResponseDelayDistributionLogNormalTypeEnum {
  Lognormal = "lognormal",
}
 ...
 * Log normal randomly distributed response delay.
 */
export class PutAdminMappingsStubMappingId200ApplicationJSONResponseDelayDistributionLogNormal extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "median" })
  median?: number;
...
export class PutAdminMappingsStubMappingId200ApplicationJSON extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "request" })
  @Type(() => PutAdminMappingsStubMappingId200ApplicationJSONRequest)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "response" })
  @Type(() => PutAdminMappingsStubMappingId200ApplicationJSONResponse)
