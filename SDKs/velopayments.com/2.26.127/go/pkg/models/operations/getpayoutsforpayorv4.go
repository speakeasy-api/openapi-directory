...
func (e *GetPayoutsForPayorV4StatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "CONFIRMED":
		fallthrough
	case "WITHDRAWN":
		*e = GetPayoutsForPayorV4StatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPayoutsForPayorV4StatusEnum: %s", s)
	}
}
...
type GetPayoutsForPayorV4QueryParams struct {
	...
	// The supported sort fields are: submittedDateTime, instructedDateTime, status, totalPayments, payoutId
	//
