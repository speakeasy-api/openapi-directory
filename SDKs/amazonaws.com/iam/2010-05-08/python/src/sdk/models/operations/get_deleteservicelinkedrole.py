...
class GetDeleteServiceLinkedRoleQueryParams:
    action: GetDeleteServiceLinkedRoleActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    role_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'RoleName', 'style': 'form', 'explode': True }})
    version: GetDeleteServiceLinkedRoleVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteServiceLinkedRoleRequest:
    headers: GetDeleteServiceLinkedRoleHeaders = dataclasses.field()
    query_params: GetDeleteServiceLinkedRoleQueryParams = dataclasses.field()
