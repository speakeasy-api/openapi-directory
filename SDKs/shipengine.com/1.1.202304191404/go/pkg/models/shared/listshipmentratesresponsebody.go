...
func (e ListShipmentRatesResponseBodyRateRateTypeEnum) ToPointer() *ListShipmentRatesResponseBodyRateRateTypeEnum {
	return &e
}
...
func (e *ListShipmentRatesResponseBodyRateRateTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "check":
		fallthrough
	case "shipment":
		*e = ListShipmentRatesResponseBodyRateRateTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListShipmentRatesResponseBodyRateRateTypeEnum: %v", v)
	}
}
...
func (e ListShipmentRatesResponseBodyRateValidationStatusEnum) ToPointer() *ListShipmentRatesResponseBodyRateValidationStatusEnum {
	return &e
}
...
func (e *ListShipmentRatesResponseBodyRateValidationStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "has_warnings":
		fallthrough
	case "unknown":
		*e = ListShipmentRatesResponseBodyRateValidationStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListShipmentRatesResponseBodyRateValidationStatusEnum: %v", v)
	}
}
...
func (e ListShipmentRatesResponseBodyRateResponseStatusEnum) ToPointer() *ListShipmentRatesResponseBodyRateResponseStatusEnum {
	return &e
}
...
func (e *ListShipmentRatesResponseBodyRateResponseStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "partial":
		fallthrough
	case "error":
		*e = ListShipmentRatesResponseBodyRateResponseStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListShipmentRatesResponseBodyRateResponseStatusEnum: %v", v)
	}
}
