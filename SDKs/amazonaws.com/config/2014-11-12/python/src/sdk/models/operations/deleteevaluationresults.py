...
class DeleteEvaluationResultsRequest:
    ...
    delete_evaluation_results_request: shared_deleteevaluationresultsrequest.DeleteEvaluationResultsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
