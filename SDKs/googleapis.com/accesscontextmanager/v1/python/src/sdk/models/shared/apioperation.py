...
class APIOperation:
    ...
    method_selectors: Optional[list[shared_methodselector.MethodSelector]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('methodSelectors'), 'exclude': lambda f: f is None }})
