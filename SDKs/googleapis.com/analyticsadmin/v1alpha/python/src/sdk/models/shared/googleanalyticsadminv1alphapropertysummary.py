...
class GoogleAnalyticsAdminV1alphaPropertySummary:
    ...
    property_type: Optional[GoogleAnalyticsAdminV1alphaPropertySummaryPropertyTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('propertyType'), 'exclude': lambda f: f is None }})
    r"""The property's property type."""  
