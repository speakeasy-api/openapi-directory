...
public class BulkUpsertSellerCommissionsQueryParams {
    /**
    ...
    public BulkUpsertSellerCommissionsQueryParams withAccountName(String accountName) {
    ...
    public BulkUpsertSellerCommissionsQueryParams withEnvironment(String environment) {
