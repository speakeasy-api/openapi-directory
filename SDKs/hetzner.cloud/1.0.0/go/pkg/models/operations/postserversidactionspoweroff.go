...
func (e *PostServersIDActionsPoweroffActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsPoweroffActionResponseActionStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsPoweroffActionResponseActionStatusEnum: %s", s)
	}
}
