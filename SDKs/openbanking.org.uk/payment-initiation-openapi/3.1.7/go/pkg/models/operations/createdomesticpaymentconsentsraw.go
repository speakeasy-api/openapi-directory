...
type CreateDomesticPaymentConsentsRawSecurity struct {
	TPPOAuth2Security shared.SchemeTppoAuth2Security `security:"scheme,type=oauth2"`
}

type CreateDomesticPaymentConsentsRawHeaders struct {
...
type CreateDomesticPaymentConsentsRawRequest struct {
	Headers CreateDomesticPaymentConsentsRawHeaders
	// Default
	Request  []byte `request:"mediaType=application/jose+jwe"`
	Security CreateDomesticPaymentConsentsRawSecurity
}

type CreateDomesticPaymentConsentsRawResponse struct {
	Body        []byte
	ContentType string
