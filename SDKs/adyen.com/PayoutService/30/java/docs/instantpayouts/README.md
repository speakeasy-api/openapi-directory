    ...
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.shared.PayoutRequest req = new PayoutRequest(                new Amount("praesentium", 523248L);, "voluptates", "quasi") {{
                ...
                selectedRecurringDetailReference = "sint";
                shopperEmail = "officia";
                shopperInteraction = PayoutRequestShopperInteractionEnum.ECOMMERCE;
                shopperName = new Name("debitis", "a");;
