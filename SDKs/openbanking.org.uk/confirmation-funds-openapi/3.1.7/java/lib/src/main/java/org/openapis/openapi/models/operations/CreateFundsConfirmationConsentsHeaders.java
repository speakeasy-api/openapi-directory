...
public class CreateFundsConfirmationConsentsHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateFundsConfirmationConsentsHeaders withAuthorization(String authorization) {
    ...
    public CreateFundsConfirmationConsentsHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateFundsConfirmationConsentsHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateFundsConfirmationConsentsHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateFundsConfirmationConsentsHeaders withXFapiInteractionId(String xFapiInteractionId) {
