...
import org.openapis.openapi.models.operations.PodocRequest;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PodocRequest req = new PodocRequest() {{
                security = new PodocSecurity() {{
            ...
            PodocResponse res = sdk.apIs.podoc(req);
