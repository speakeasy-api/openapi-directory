...
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetRequest:
    path_params: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetPathParams = dataclasses.field()
    query_params: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetQueryParams = dataclasses.field()
    security: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetSecurity = dataclasses.field()
