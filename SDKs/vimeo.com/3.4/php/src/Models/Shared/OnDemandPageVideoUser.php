...
class OnDemandPageVideoUser
{
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserAccountEnum $account
     */
	#[\JMS\Serializer\Annotation\SerializedName('account')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserAccountEnum>')]
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserContentFilterEnum $contentFilter
     */
	#[\JMS\Serializer\Annotation\SerializedName('content_filter')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserContentFilterEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OnDemandPageVideoUserContentFilterEnum $contentFilter = null;
     ...
     * The user's metadata.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserMetadata $metadata
     */
	#[\JMS\Serializer\Annotation\SerializedName('metadata')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserMetadata')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserPreferences')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OnDemandPageVideoUserPreferences $preferences = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserUploadQuota $uploadQuota
     */
	#[\JMS\Serializer\Annotation\SerializedName('upload_quota')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserUploadQuota')]
     ...
     * The user's websites.
     * 
     * @var array<\OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserWebsites> $websites
     */
	#[\JMS\Serializer\Annotation\SerializedName('websites')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserWebsites>')]
    public array $websites;
    
	public function __construct()
	{
		$this->account = \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserAccountEnum::BASIC;
		$this->bio = "";
		...
		$this->link = "";
		$this->location = "";
		$this->metadata = new \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserMetadata();
		$this->name = "";
		$this->pictures = new \OpenAPI\OpenAPI\Models\Shared\Picture();
		$this->preferences = null;
		$this->resourceKey = "";
		$this->uploadQuota = new \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserUploadQuota();
		$this->uri = "";
		$this->websites = [];
	}
}
