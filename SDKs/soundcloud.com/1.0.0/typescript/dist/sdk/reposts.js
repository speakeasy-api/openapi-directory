...
var Reposts = /** @class */ (function () {
    function Reposts(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Reposts.prototype.deleteRepostsPlaylistsPlaylistId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteRepostsPlaylistsPlaylistIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/reposts/playlists/{playlist_id}", req.pathParams);
    ...
    **/
    Reposts.prototype.deleteRepostsTracksTrackId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteRepostsTracksTrackIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/reposts/tracks/{track_id}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var r = client.request(__assign({ url: url, method: "delete" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Reposts.prototype.postRepostsPlaylistsPlaylistId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Reposts.prototype.postRepostsTracksTrackId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
