...
class SDK
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\PlayerDetailsByFreeAgentRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\PlayerDetailsByFreeAgentResponse
     */
	public function playerDetailsByFreeAgent(
        \OpenAPI\OpenAPI\Models\Operations\PlayerDetailsByFreeAgentRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\PlayerDetailsByFreeAgentResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/{format}/FreeAgents', \OpenAPI\OpenAPI\Models\Operations\PlayerDetailsByFreeAgentRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PlayerDetailsByFreeAgentResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
