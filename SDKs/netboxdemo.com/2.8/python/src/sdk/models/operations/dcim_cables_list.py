...
class DcimCablesList200ApplicationJSON:
    ...
    results: list[shared_cable.Cable] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class DcimCablesListRequest:
    query_params: DcimCablesListQueryParams = dataclasses.field()
