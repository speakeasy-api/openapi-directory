 ...
 */
export declare enum RegionListWarningCodeEnum {
...
export declare class RegionListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class RegionListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class RegionList extends SpeakeasyBase {
    /**
