...
exports.GetCommitteesResponse = exports.GetCommitteesRequest = exports.GetCommitteesQueryParams = exports.GetCommitteesOrganizationTypeEnum = exports.GetCommitteesFilingFrequencyEnum = exports.GetCommitteesDesignationEnum = exports.GetCommitteesCommitteeTypeEnum = void 0;
...
var GetCommitteesQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=max_last_f1_date" }),
        __metadata("design:type", Date)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=min_last_f1_date" }),
        __metadata("design:type", Date)
...
exports.GetCommitteesQueryParams = GetCommitteesQueryParams;
