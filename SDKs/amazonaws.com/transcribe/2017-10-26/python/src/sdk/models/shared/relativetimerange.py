...
class RelativeTimeRange:
    ...
    start_percentage: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StartPercentage'), 'exclude': lambda f: f is None }})  
