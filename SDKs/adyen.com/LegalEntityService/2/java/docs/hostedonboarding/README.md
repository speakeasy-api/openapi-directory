...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetThemesIdRequest req = new GetThemesIdRequest("reiciendis");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PostLegalEntitiesIdOnboardingLinksRequest req = new PostLegalEntitiesIdOnboardingLinksRequest("est") {{
