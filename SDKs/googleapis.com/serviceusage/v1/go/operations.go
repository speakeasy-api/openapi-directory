...
func (s *Operations) ServiceusageOperationsCancel(ctx context.Context, request operations.ServiceusageOperationsCancelRequest) (*operations.ServiceusageOperationsCancelResponse, error) {
	...
	res := &operations.ServiceusageOperationsCancelResponse{
...
func (s *Operations) ServiceusageOperationsDelete(ctx context.Context, request operations.ServiceusageOperationsDeleteRequest) (*operations.ServiceusageOperationsDeleteResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.ServiceusageOperationsDeleteResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Operations) ServiceusageOperationsList(ctx context.Context, request operations.ServiceusageOperationsListRequest) (*operations.ServiceusageOperationsListResponse, error) {
	baseURL := s._serverURL
