...
class DescribeCustomRoutingAcceleratorAttributesRequest:
    ...
    describe_custom_routing_accelerator_attributes_request: shared_describecustomroutingacceleratorattributesrequest.DescribeCustomRoutingAcceleratorAttributesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
