...
func (e *CreateNetworkSwitchStackRoutingInterfaceRequestBodyMulticastRoutingEnum) UnmarshalJSON(data []byte) error {
	...
	case "disabled":
		fallthrough
	case "enabled":
		*e = CreateNetworkSwitchStackRoutingInterfaceRequestBodyMulticastRoutingEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkSwitchStackRoutingInterfaceRequestBodyMulticastRoutingEnum: %s", s)
	}
}
