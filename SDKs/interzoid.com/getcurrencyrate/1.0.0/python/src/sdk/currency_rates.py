...
class CurrencyRates:
    ...
    def getcurrencyrate(self, request: operations.GetcurrencyrateRequest) -> operations.GetcurrencyrateResponse:
        ...
        query_params = utils.get_query_params(operations.GetcurrencyrateRequest, request)
        ...
        res = operations.GetcurrencyrateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.Getcurrencyrate200ApplicationJSON])
