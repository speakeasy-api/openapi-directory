...
class ObjectPUTProductRatePlanChargeTierRequest:
    ...
    r"""The unique ID of the product rate plan charge tier to be updated. For example, 2c92c0f86c85891e016c88d55a6e543b."""  
    proxy_modify_product_rate_plan_charge_tier: shared_proxymodifyproductrateplanchargetier.ProxyModifyProductRatePlanChargeTier = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
