...
class GetReplicationConfigurationRequestBody:
    ...
    r"""The ID of the Source Serve for this Replication Configuration.r"""  
    

@dataclasses.dataclass
class GetReplicationConfigurationRequest:
    
    request_body: GetReplicationConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
