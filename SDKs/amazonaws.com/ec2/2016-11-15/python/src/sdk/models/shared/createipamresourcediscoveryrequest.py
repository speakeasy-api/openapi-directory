...
class CreateIpamResourceDiscoveryRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateIpamResourceDiscoveryRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateIpamResourceDiscoveryRequestTagSpecifications:
    ...
    resource_type: Optional[CreateIpamResourceDiscoveryRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateIpamResourceDiscoveryRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateIpamResourceDiscoveryRequest:
    ...
    operating_regions: Optional[list[shared_addipamoperatingregion.AddIpamOperatingRegion]] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateIpamResourceDiscoveryRequestTagSpecifications]] = dataclasses.field(default=None)  
