...
export declare class Git {
     ...
     * Create a blob
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#create-a-blob} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#create-a-commit} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#create-a-reference} - API method documentation
     */
     ...
     * | `valid` | None of the above errors applied, so the signature is considered to be verified. |
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#create-a-tag-object} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#create-a-tree} - API method documentation
     */
    gitCreateTree(req: operations.GitCreateTreeRequest, config?: AxiosRequestConfig): Promise<operations.GitCreateTreeResponse>;
    /**
     * Delete a reference
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#delete-a-reference} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#get-a-blob} - API method documentation
     */
     ...
     * | `valid` | None of the above errors applied, so the signature is considered to be verified. |
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#get-a-commit} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#get-a-reference} - API method documentation
     */
     ...
     * | `valid` | None of the above errors applied, so the signature is considered to be verified. |
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#get-a-tag} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#get-a-tree} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#list-matching-references} - API method documentation
     */
     ...
     * Update a reference
     *
     * @see {@link https://docs.github.com/github-ae@latest/rest/reference/git#update-a-reference} - API method documentation
     */
