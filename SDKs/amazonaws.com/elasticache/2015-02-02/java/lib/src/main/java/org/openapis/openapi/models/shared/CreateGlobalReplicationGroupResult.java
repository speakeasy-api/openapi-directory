...
/**
 * CreateGlobalReplicationGroupResult - Success
 */
public class CreateGlobalReplicationGroupResult {
    ...
    public CreateGlobalReplicationGroupResult withGlobalReplicationGroup(GlobalReplicationGroup globalReplicationGroup) {
