...
class YoutubeAnalyticsGroupsInsertSecurity:
    option1: Optional[YoutubeAnalyticsGroupsInsertSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubeAnalyticsGroupsInsertSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[YoutubeAnalyticsGroupsInsertSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[YoutubeAnalyticsGroupsInsertSecurityOption4] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option5: Optional[YoutubeAnalyticsGroupsInsertSecurityOption5] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class YoutubeAnalyticsGroupsInsertRequest:
    query_params: YoutubeAnalyticsGroupsInsertQueryParams = dataclasses.field()
    security: YoutubeAnalyticsGroupsInsertSecurity = dataclasses.field()
