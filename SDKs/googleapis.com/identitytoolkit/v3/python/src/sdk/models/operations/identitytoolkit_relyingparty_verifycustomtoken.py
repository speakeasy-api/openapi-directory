...
class IdentitytoolkitRelyingpartyVerifyCustomTokenRequest:
    ...
    identitytoolkit_relyingparty_verify_custom_token_request: Optional[shared_identitytoolkitrelyingpartyverifycustomtokenrequest.IdentitytoolkitRelyingpartyVerifyCustomTokenRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
