...
public class ListLicenseesRequest {
    ...
    public String key;
    public ListLicenseesRequest withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public ListLicenseesRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public String query;
    public ListLicenseesRequest withQuery(String query) {
        this.query = query;
        return this;
    }
    ...
    public ListLicenseesRequest withStartingAfter(Integer startingAfter) {
    ...
    public ListLicenseesRequest withUserToken(String userToken) {
