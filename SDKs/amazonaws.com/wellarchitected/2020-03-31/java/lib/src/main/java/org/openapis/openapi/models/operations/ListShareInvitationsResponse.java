...
public class ListShareInvitationsResponse {
    ...
    public org.openapis.openapi.models.shared.ListShareInvitationsOutput listShareInvitationsOutput;

    public ListShareInvitationsResponse withListShareInvitationsOutput(org.openapis.openapi.models.shared.ListShareInvitationsOutput listShareInvitationsOutput) {
    ...
    public ListShareInvitationsResponse withStatusCode(Integer statusCode) {
    ...
    public ListShareInvitationsResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public ListShareInvitationsResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
