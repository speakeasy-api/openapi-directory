...
class SelectPsuAuthenticationMethodResponse:
    r"""Body of the JSON response for a successful select PSU authentication method request."""
    ...
    r"""A list of hyperlinks to be recognised by the TPP. The actual hyperlinks used in
