...
func (s *DataTransfer) PostV05HealthInformationTransfer(ctx context.Context, request operations.PostV05HealthInformationTransferRequest) (*operations.PostV05HealthInformationTransferResponse, error) {
