...
func (e CreateCompositionHookCreateCompositionHookRequestStatusCallbackMethodEnum) ToPointer() *CreateCompositionHookCreateCompositionHookRequestStatusCallbackMethodEnum {
	return &e
}
...
func (e *CreateCompositionHookCreateCompositionHookRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateCompositionHookCreateCompositionHookRequestStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCompositionHookCreateCompositionHookRequestStatusCallbackMethodEnum: %v", v)
	}
}
