...
exports.V2VisionTrainParams = void 0;
...
var V2VisionTrainParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=trainSplitRatio" }),
        __metadata("design:type", Number)
    ], V2VisionTrainParams.prototype, "trainSplitRatio", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=withFeedback" }),
        __metadata("design:type", Boolean)
    ], V2VisionTrainParams.prototype, "withFeedback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=withGlobalDatasetId" }),
        __metadata("design:type", Number)
    ], V2VisionTrainParams.prototype, "withGlobalDatasetId", void 0);
    return V2VisionTrainParams;
}(utils_1.SpeakeasyBase));
exports.V2VisionTrainParams = V2VisionTrainParams;
