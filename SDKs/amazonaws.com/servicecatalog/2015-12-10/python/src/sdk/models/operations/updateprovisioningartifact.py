...
class UpdateProvisioningArtifactRequest:
    ...
    update_provisioning_artifact_input: shared_updateprovisioningartifactinput.UpdateProvisioningArtifactInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
