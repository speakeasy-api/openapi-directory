...
public class ResourcePolicy {
    ...
    public ResourcePolicy withSelfLinkWithId(String selfLinkWithId) {
    ...
    public ResourcePolicyVmMaintenancePolicy vmMaintenancePolicy;

    public ResourcePolicy withVmMaintenancePolicy(ResourcePolicyVmMaintenancePolicy vmMaintenancePolicy) {
