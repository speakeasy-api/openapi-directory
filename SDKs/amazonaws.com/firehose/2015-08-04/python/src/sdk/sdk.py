...
SERVERS = [
    ...
    r"""The Firehose multi-region endpoint"""
    "https://firehose.{region}.amazonaws.com",
    r"""The Firehose multi-region endpoint"""
    "http://firehose.{region}.amazonaws.com.cn",
    r"""The Firehose endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    ...
    def create_delivery_stream(self, request: operations.CreateDeliveryStreamRequest) -> operations.CreateDeliveryStreamResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "create_delivery_stream_input", 'json')
        ...
        res = operations.CreateDeliveryStreamResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateDeliveryStreamOutput])
    ...
    def delete_delivery_stream(self, request: operations.DeleteDeliveryStreamRequest) -> operations.DeleteDeliveryStreamResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_delivery_stream_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteDeliveryStreamResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def describe_delivery_stream(self, request: operations.DescribeDeliveryStreamRequest) -> operations.DescribeDeliveryStreamResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_delivery_stream_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeDeliveryStreamResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeDeliveryStreamOutput])
    ...
    def list_delivery_streams(self, request: operations.ListDeliveryStreamsRequest) -> operations.ListDeliveryStreamsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_delivery_streams_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ListDeliveryStreamsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListDeliveryStreamsOutput])
    ...
    def list_tags_for_delivery_stream(self, request: operations.ListTagsForDeliveryStreamRequest) -> operations.ListTagsForDeliveryStreamResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_tags_for_delivery_stream_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ListTagsForDeliveryStreamResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListTagsForDeliveryStreamOutput])
    ...
    def put_record_batch(self, request: operations.PutRecordBatchRequest) -> operations.PutRecordBatchResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "put_record_batch_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.PutRecordBatchResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PutRecordBatchOutput])
    ...
    def start_delivery_stream_encryption(self, request: operations.StartDeliveryStreamEncryptionRequest) -> operations.StartDeliveryStreamEncryptionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "start_delivery_stream_encryption_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StartDeliveryStreamEncryptionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def stop_delivery_stream_encryption(self, request: operations.StopDeliveryStreamEncryptionRequest) -> operations.StopDeliveryStreamEncryptionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "stop_delivery_stream_encryption_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StopDeliveryStreamEncryptionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def tag_delivery_stream(self, request: operations.TagDeliveryStreamRequest) -> operations.TagDeliveryStreamResponse:
        ...
        res = operations.TagDeliveryStreamResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def untag_delivery_stream(self, request: operations.UntagDeliveryStreamRequest) -> operations.UntagDeliveryStreamResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "untag_delivery_stream_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UntagDeliveryStreamResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_destination(self, request: operations.UpdateDestinationRequest) -> operations.UpdateDestinationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_destination_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
