...
class GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeyRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeyPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeySecurity = dataclasses.field()
