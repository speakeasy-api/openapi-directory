...
class CreateChannelRequestBody:
    ...
    latency_mode: Optional[CreateChannelRequestBodyLatencyModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('latencyMode') }})
    ...
    type: Optional[CreateChannelRequestBodyTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
