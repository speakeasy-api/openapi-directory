...
exports.BackupLifecycleEnum = void 0;
/**
 ...
 */
var BackupLifecycleEnum;
(function (BackupLifecycleEnum) {
    BackupLifecycleEnum["Available"] = "AVAILABLE";
    BackupLifecycleEnum["Creating"] = "CREATING";
    BackupLifecycleEnum["Transferring"] = "TRANSFERRING";
    BackupLifecycleEnum["Deleted"] = "DELETED";
    BackupLifecycleEnum["Failed"] = "FAILED";
    BackupLifecycleEnum["Pending"] = "PENDING";
    BackupLifecycleEnum["Copying"] = "COPYING";
})(BackupLifecycleEnum = exports.BackupLifecycleEnum || (exports.BackupLifecycleEnum = {}));
