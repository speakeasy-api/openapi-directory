 ...
 */
export enum OperationsScopedListWarningCodeEnum {
...
export class OperationsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class OperationsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: OperationsScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: OperationsScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => OperationsScopedListWarningData)
  data?: OperationsScopedListWarningData[];
...
export class OperationsScopedList extends SpeakeasyBase {
  /**
