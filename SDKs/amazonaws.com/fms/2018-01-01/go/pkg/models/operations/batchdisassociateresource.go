...
type BatchDisassociateResourceHeaders struct {
...
type BatchDisassociateResourceRequest struct {
	Headers BatchDisassociateResourceHeaders
	Request shared.BatchDisassociateResourceRequest `request:"mediaType=application/json"`
}
