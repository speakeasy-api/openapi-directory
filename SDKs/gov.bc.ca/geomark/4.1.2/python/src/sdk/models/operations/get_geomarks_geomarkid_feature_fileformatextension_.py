...
class GetGeomarksGeomarkIDFeatureFileFormatExtensionSridEnum(str, Enum):
...
class GetGeomarksGeomarkIDFeatureFileFormatExtensionRequest:
    ...
    srid: Optional[GetGeomarksGeomarkIDFeatureFileFormatExtensionSridEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'srid', 'style': 'form', 'explode': True }})
    r"""The srid of the coordinate system the geometry should be converted to."""  
