...
from ..shared import listdataintegrationsresponse as shared_listdataintegrationsresponse
...
class ListDataIntegrationsResponse:
    ...
    list_data_integrations_response: Optional[shared_listdataintegrationsresponse.ListDataIntegrationsResponse] = dataclasses.field(default=None)
    r"""Success"""  
