...
public class CustomerAddCustomerAddressFormRequest {
    ...
    public CustomerAddCustomerAddressFormRequest(@JsonProperty("Billbee.Interfaces.BillbeeAPI.Model.CustomerAddressApiModel") org.openapis.openapi.models.shared.BillbeeInterfacesBillbeeAPIModelCustomerAddressAPIModel billbeeInterfacesBillbeeAPIModelCustomerAddressAPIModel, @JsonProperty("id") Long id) {
        this.billbeeInterfacesBillbeeAPIModelCustomerAddressAPIModel = billbeeInterfacesBillbeeAPIModelCustomerAddressAPIModel;
        this.id = id;
  }
}
