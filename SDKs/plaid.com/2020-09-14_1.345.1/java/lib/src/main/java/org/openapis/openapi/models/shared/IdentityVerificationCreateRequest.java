...
public class IdentityVerificationCreateRequest {
    ...
    public IdentityVerificationCreateRequest withUser(java.util.Map<String, Object> user) {
        this.user = user;
        return this;
    }
    
    public IdentityVerificationCreateRequest(@JsonProperty("gave_consent") Boolean gaveConsent, @JsonProperty("is_shareable") Boolean isShareable, @JsonProperty("template_id") String templateId, @JsonProperty("user") java.util.Map<String, Object> user) {
        this.gaveConsent = gaveConsent;
        this.isShareable = isShareable;
        this.templateId = templateId;
        this.user = user;
