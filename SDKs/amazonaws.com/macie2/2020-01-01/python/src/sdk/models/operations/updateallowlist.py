...
from ..shared import updateallowlistresponse as shared_updateallowlistresponse
...
class UpdateAllowListRequestBody:
    ...
    criteria: UpdateAllowListRequestBodyCriteria = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('criteria') }})
    r"""Specifies the criteria for an allow list. The criteria must specify a regular expression (regex) or an S3 object (s3WordsList). It can't specify both."""  
...
class UpdateAllowListRequest:
    ...
    request_body: UpdateAllowListRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdateAllowListResponse:
    ...
    update_allow_list_response: Optional[shared_updateallowlistresponse.UpdateAllowListResponse] = dataclasses.field(default=None)
    r"""Success"""  
