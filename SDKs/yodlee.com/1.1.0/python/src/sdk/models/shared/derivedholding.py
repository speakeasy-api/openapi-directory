...
class DerivedHoldingHoldingTypeEnum(str, Enum):
    STOCK = "stock"
...
class DerivedHoldingOptionTypeEnum(str, Enum):
    PUT = "put"
    CALL = "call"
    UNKNOWN = "unknown"
    OTHER = "other"
...
class DerivedHolding:
    ...
    asset_classification: Optional[shared_assetclassification.AssetClassification] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('assetClassification') }})
    ...
    holding_type: Optional[DerivedHoldingHoldingTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('holdingType') }})
    ...
    option_type: Optional[DerivedHoldingOptionTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('optionType') }})
