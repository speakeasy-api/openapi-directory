...
class DeleteApplicationCloudWatchLoggingOptionRequest:
    ...
    delete_application_cloud_watch_logging_option_request: shared_deleteapplicationcloudwatchloggingoptionrequest.DeleteApplicationCloudWatchLoggingOptionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
