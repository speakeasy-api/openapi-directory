...
class AcceptAddressTransferRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class AcceptAddressTransferRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class AcceptAddressTransferRequestTagSpecifications:
    ...
    resource_type: Optional[AcceptAddressTransferRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[AcceptAddressTransferRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class AcceptAddressTransferRequest:
    ...
    tag_specifications: Optional[list[AcceptAddressTransferRequestTagSpecifications]] = dataclasses.field(default=None)  
