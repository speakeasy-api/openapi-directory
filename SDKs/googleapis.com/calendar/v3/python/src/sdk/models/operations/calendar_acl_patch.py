...
class CalendarACLPatchRequest:
    path_params: CalendarACLPatchPathParams = dataclasses.field()
    query_params: CalendarACLPatchQueryParams = dataclasses.field()
    security: CalendarACLPatchSecurity = dataclasses.field()
    request: Optional[shared_aclrule.ACLRule] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
