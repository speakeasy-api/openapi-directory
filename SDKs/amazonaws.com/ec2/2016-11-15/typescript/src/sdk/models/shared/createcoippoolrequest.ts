 ...
 */
export enum CreateCoipPoolRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateCoipPoolRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateCoipPoolRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateCoipPoolRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateCoipPoolRequestTagSpecificationsTags })
  tags?: CreateCoipPoolRequestTagSpecificationsTags[];
}

export class CreateCoipPoolRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
  ...
  @SpeakeasyMetadata({ elemType: CreateCoipPoolRequestTagSpecifications })
