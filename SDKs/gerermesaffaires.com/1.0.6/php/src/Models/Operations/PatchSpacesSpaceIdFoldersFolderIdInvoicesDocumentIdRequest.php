...
class PatchSpacesSpaceIdFoldersFolderIdInvoicesDocumentIdRequest
{
     ...
     * A invoice to modify
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PatchSpacesSpaceIdFoldersFolderIdInvoicesDocumentIdRequestBody $requestBody
     */
	#[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?PatchSpacesSpaceIdFoldersFolderIdInvoicesDocumentIdRequestBody $requestBody = null;
