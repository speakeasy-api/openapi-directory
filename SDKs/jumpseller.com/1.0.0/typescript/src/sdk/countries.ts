...
export class Countries {
  ...
  getCountriesJson(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetCountriesJsonResponse =
        new operations.GetCountriesJsonResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            ...
            res.countries = utils.objectToClass(
              httpRes?.data,
              shared.Country,
              resFieldDepth
            );
  ...
  getCountriesCountryCodeJson(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetCountriesCountryCodeJsonResponse =
        new operations.GetCountriesCountryCodeJsonResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
