...
export class RemotebuildexecutionProjectsInstancesWorkerpoolsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RemotebuildexecutionProjectsInstancesWorkerpoolsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RemotebuildexecutionProjectsInstancesWorkerpoolsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
