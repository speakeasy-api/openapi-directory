...
class Standing:
    ...
    conference_ties: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ConferenceTies'), 'exclude': lambda f: f is None }})  
    ...
    division_ties: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DivisionTies'), 'exclude': lambda f: f is None }})  
    ...
    net_points: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('NetPoints'), 'exclude': lambda f: f is None }})  
