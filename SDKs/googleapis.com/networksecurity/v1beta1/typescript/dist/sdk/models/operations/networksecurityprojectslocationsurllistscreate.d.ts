...
export declare class NetworksecurityProjectsLocationsUrlListsCreateSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class NetworksecurityProjectsLocationsUrlListsCreateRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class NetworksecurityProjectsLocationsUrlListsCreateResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
