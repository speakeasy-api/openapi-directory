...
export declare class SDK {
     ...
     */
    getListManagedInsightRules(req: operations.GETListManagedInsightRulesRequest, config?: AxiosRequestConfig): Promise<operations.GETListManagedInsightRulesResponse>;
    /**
     ...
     *  Returns a list that contains the number of managed Contributor Insights rules in your account.
     */
    postListManagedInsightRules(req: operations.POSTListManagedInsightRulesRequest, config?: AxiosRequestConfig): Promise<operations.POSTListManagedInsightRulesResponse>;
    /**
     * Returns a list of metric streams in this account.
     */
     ...
     */
    postPutManagedInsightRules(req: operations.POSTPutManagedInsightRulesRequest, config?: AxiosRequestConfig): Promise<operations.POSTPutManagedInsightRulesResponse>;
    /**
