...
public class CreateDomainEntryResponse {
    ...
    public org.openapis.openapi.models.shared.CreateDomainEntryResult createDomainEntryResult;

    public CreateDomainEntryResponse withCreateDomainEntryResult(org.openapis.openapi.models.shared.CreateDomainEntryResult createDomainEntryResult) {
    ...
    public CreateDomainEntryResponse withStatusCode(Integer statusCode) {
    ...
    public CreateDomainEntryResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public CreateDomainEntryResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
