...
@dataclasses.dataclass
class DoubleclickbidmanagerQueriesReportsGetQueryParams:
...
class DoubleclickbidmanagerQueriesReportsGetRequest:
    path_params: DoubleclickbidmanagerQueriesReportsGetPathParams = dataclasses.field()
    query_params: DoubleclickbidmanagerQueriesReportsGetQueryParams = dataclasses.field()
    security: DoubleclickbidmanagerQueriesReportsGetSecurity = dataclasses.field()
