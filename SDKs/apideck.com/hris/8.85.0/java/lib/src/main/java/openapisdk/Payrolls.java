...
public class Payrolls {
     ...
     * List Payroll
    **/
    public openapisdk.models.operations.PayrollsAllResponse payrollsAll(openapisdk.models.operations.PayrollsAllRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/hris/payrolls");
        ...
        openapisdk.models.operations.PayrollsAllResponse res = new openapisdk.models.operations.PayrollsAllResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GetPayrollsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetPayrollsResponse.class);
     ...
     * Get Payroll
    **/
    public openapisdk.models.operations.PayrollsOneResponse payrollsOne(openapisdk.models.operations.PayrollsOneRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/hris/payrolls/{payroll_id}", request.pathParams);
        ...
        openapisdk.models.operations.PayrollsOneResponse res = new openapisdk.models.operations.PayrollsOneResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GetPayrollResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetPayrollResponse.class);
