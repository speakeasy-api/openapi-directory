...
public class LoggingConfigurationSummary {
    ...
    public LoggingConfigurationSummary withCreateTime(OffsetDateTime createTime) {
    ...
    public LoggingConfigurationSummary withState(LoggingConfigurationStateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public LoggingConfigurationSummary withUpdateTime(OffsetDateTime updateTime) {
