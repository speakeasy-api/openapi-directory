...
export enum POSTDescribeGlobalReplicationGroupsActionEnum {
  DescribeGlobalReplicationGroups = "DescribeGlobalReplicationGroups",
}

export enum POSTDescribeGlobalReplicationGroupsVersionEnum {
  TwoThousandAndFifteen0202 = "2015-02-02",
}

export class POSTDescribeGlobalReplicationGroupsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class POSTDescribeGlobalReplicationGroupsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
