...
exports.ActionsDeleteEnvironmentSecretResponse = exports.ActionsDeleteEnvironmentSecretRequest = void 0;
...
var ActionsDeleteEnvironmentSecretRequest = /** @class */ (function (_super) {
    ...
    ], ActionsDeleteEnvironmentSecretRequest.prototype, "environmentName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repository_id",
        }),
        __metadata("design:type", Number)
    ], ActionsDeleteEnvironmentSecretRequest.prototype, "repositoryId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=secret_name",
        }),
        __metadata("design:type", String)
    ], ActionsDeleteEnvironmentSecretRequest.prototype, "secretName", void 0);
...
var ActionsDeleteEnvironmentSecretResponse = /** @class */ (function (_super) {
    ...
    ], ActionsDeleteEnvironmentSecretResponse.prototype, "rawResponse", void 0);
