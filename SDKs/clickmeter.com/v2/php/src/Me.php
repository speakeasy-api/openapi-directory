...
class Me 
{
     ...
     * 
     * @return \OpenAPI\OpenAPI\Models\Operations\MeGetMeResponse
     */
	public function meGetMe(
    ): \OpenAPI\OpenAPI\Models\Operations\MeGetMeResponse
    {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\MeGetMeResponse();
     ...
     * 
     * @return \OpenAPI\OpenAPI\Models\Operations\MeGetMePlanResponse
     */
	public function meGetMePlan(
    ): \OpenAPI\OpenAPI\Models\Operations\MeGetMePlanResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/me/plan');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\MeGetMePlanResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
