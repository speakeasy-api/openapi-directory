 ...
 */
export enum FirewallPolicyRuleDirectionEnum {
  Egress = "EGRESS",
  Ingress = "INGRESS",
}
 ...
 */
export class FirewallPolicyRule extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "securityProfileGroup" })
