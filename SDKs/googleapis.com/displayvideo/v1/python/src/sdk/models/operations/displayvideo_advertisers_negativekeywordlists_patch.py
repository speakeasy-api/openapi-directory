...
class DisplayvideoAdvertisersNegativeKeywordListsPatchRequest:
    path_params: DisplayvideoAdvertisersNegativeKeywordListsPatchPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersNegativeKeywordListsPatchQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersNegativeKeywordListsPatchSecurity = dataclasses.field()
