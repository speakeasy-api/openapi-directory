...
class ToolresultsProjectsHistoriesExecutionsStepsPerfMetricsSummaryCreateRequest:
    path_params: ToolresultsProjectsHistoriesExecutionsStepsPerfMetricsSummaryCreatePathParams = dataclasses.field()
    query_params: ToolresultsProjectsHistoriesExecutionsStepsPerfMetricsSummaryCreateQueryParams = dataclasses.field()
    security: ToolresultsProjectsHistoriesExecutionsStepsPerfMetricsSummaryCreateSecurity = dataclasses.field()
    request: Optional[shared_perfmetricssummary.PerfMetricsSummary] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
