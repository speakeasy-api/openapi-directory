...
export class CloudchannelAccountsCustomersEntitlementsListEntitlementChangesSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersEntitlementsListEntitlementChangesRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersEntitlementsListEntitlementChangesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
