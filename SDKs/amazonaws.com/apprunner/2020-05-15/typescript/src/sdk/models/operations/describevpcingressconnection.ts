...
export enum DescribeVpcIngressConnectionXAmzTargetEnum {
  AppRunnerDescribeVpcIngressConnection = "AppRunner.DescribeVpcIngressConnection",
}

export class DescribeVpcIngressConnectionRequest extends SpeakeasyBase {
...
export class DescribeVpcIngressConnectionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
