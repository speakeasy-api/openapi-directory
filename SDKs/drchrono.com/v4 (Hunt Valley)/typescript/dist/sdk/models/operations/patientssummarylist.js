...
exports.PatientsSummaryListResponse = exports.PatientsSummaryList200ApplicationJSON = exports.PatientsSummaryListRequest = exports.PatientsSummaryListSecurity = void 0;
...
var PatientsSummaryListRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], PatientsSummaryListRequest.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=date_of_birth",
        }),
        __metadata("design:type", String)
    ], PatientsSummaryListRequest.prototype, "dateOfBirth", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=doctor",
        }),
        __metadata("design:type", Number)
    ], PatientsSummaryListRequest.prototype, "doctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=first_name",
        }),
        __metadata("design:type", String)
    ], PatientsSummaryListRequest.prototype, "firstName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=gender",
        }),
        __metadata("design:type", String)
    ], PatientsSummaryListRequest.prototype, "gender", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=last_name",
        }),
        __metadata("design:type", String)
    ], PatientsSummaryListRequest.prototype, "lastName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], PatientsSummaryListRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=since" }),
        __metadata("design:type", String)
    ], PatientsSummaryListRequest.prototype, "since", void 0);
...
var PatientsSummaryListResponse = /** @class */ (function (_super) {
    ...
    ], PatientsSummaryListResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
