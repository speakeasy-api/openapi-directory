...
from . import utils
from .veteran_confirmation_status import VeteranConfirmationStatus
...
class SDK:
    r"""The Veteran Confirmation API allows you to confirm Veteran status for a given person. This can be useful for offering Veterans discounts or other benefits.
    ...
    * Gender
    ...
    """
    veteran_confirmation_status: VeteranConfirmationStatus
    r"""Veteran Confirmation - Veteran Status"""
    ...
    def _init_sdks(self):
        self.veteran_confirmation_status = VeteranConfirmationStatus(
            self._client,
