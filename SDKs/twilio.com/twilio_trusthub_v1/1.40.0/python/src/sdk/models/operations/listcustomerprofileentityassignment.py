...
class ListCustomerProfileEntityAssignmentListCustomerProfileEntityAssignmentResponse:
    ...
    meta: Optional[ListCustomerProfileEntityAssignmentListCustomerProfileEntityAssignmentResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    results: Optional[list[shared_trusthub_v1_customer_profile_customer_profile_entity_assignment.TrusthubV1CustomerProfileCustomerProfileEntityAssignment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
