...
class CreateDomesticScheduledPaymentsJSONRequest:
    ...
    ob_write_domestic_scheduled2: shared_obwritedomesticscheduled2.OBWriteDomesticScheduled2 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Default"""  
