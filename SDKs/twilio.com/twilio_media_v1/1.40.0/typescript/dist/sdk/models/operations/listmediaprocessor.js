...
exports.ListMediaProcessorResponse = exports.ListMediaProcessorListMediaProcessorResponse = exports.ListMediaProcessorListMediaProcessorResponseMeta = exports.ListMediaProcessorRequest = exports.ListMediaProcessorSecurity = exports.ListMediaProcessorServerList = void 0;
...
var ListMediaProcessorSecurity = /** @class */ (function (_super) {
    ...
    ], ListMediaProcessorSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListMediaProcessorSecurity.prototype, "username", void 0);
...
var ListMediaProcessorRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListMediaProcessorRequest.prototype, "order", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListMediaProcessorRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListMediaProcessorRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListMediaProcessorRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListMediaProcessorRequest.prototype, "status", void 0);
...
var ListMediaProcessorListMediaProcessorResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.MediaV1MediaProcessor }),
        (0, class_transformer_1.Expose)({ name: "media_processors" }),
        (0, class_transformer_1.Type)(function () { return shared.MediaV1MediaProcessor; }),
        __metadata("design:type", Array)
    ], ListMediaProcessorListMediaProcessorResponse.prototype, "mediaProcessors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListMediaProcessorListMediaProcessorResponseMeta; }),
...
var ListMediaProcessorResponse = /** @class */ (function (_super) {
    ...
    ], ListMediaProcessorResponse.prototype, "rawResponse", void 0);
