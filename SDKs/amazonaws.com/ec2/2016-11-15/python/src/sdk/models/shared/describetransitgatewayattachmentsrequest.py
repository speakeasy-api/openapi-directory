...
class DescribeTransitGatewayAttachmentsRequestFilters:
...
class DescribeTransitGatewayAttachmentsRequest:
    ...
    filters: Optional[list[DescribeTransitGatewayAttachmentsRequestFilters]] = dataclasses.field(default=None)  
