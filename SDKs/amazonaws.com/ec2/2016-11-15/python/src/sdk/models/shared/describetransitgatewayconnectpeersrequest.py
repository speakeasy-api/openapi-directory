...
class DescribeTransitGatewayConnectPeersRequestFilters:
...
class DescribeTransitGatewayConnectPeersRequest:
    ...
    filters: Optional[list[DescribeTransitGatewayConnectPeersRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    transit_gateway_connect_peer_ids: Optional[list[str]] = dataclasses.field(default=None)  
