...
type ToolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ToolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesGetPathParams struct {
...
type ToolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesGetQueryParams struct {
	// V1 error format.
...
type ToolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesGetRequest struct {
...
type ToolresultsProjectsHistoriesExecutionsStepsPerfSampleSeriesGetResponse struct {
	ContentType string
	// Successful response
