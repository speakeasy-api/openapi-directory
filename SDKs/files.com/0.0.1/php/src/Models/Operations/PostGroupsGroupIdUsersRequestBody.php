...
class PostGroupsGroupIdUsersRequestBody
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostGroupsGroupIdUsersRequestBodyAuthenticationMethodEnum $authenticationMethod
     */
	#[SpeakeasyMetadata('multipartForm:name=authentication_method')]
    public ?PostGroupsGroupIdUsersRequestBodyAuthenticationMethodEnum $authenticationMethod = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostGroupsGroupIdUsersRequestBodyAvatarFile $avatarFile
     */
	#[SpeakeasyMetadata('multipartForm:file=true')]
    public ?PostGroupsGroupIdUsersRequestBodyAvatarFile $avatarFile = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostGroupsGroupIdUsersRequestBodyRequire2faEnum $require2fa
     */
	#[SpeakeasyMetadata('multipartForm:name=require_2fa')]
    public ?PostGroupsGroupIdUsersRequestBodyRequire2faEnum $require2fa = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostGroupsGroupIdUsersRequestBodySslRequiredEnum $sslRequired
     */
	#[SpeakeasyMetadata('multipartForm:name=ssl_required')]
    public ?PostGroupsGroupIdUsersRequestBodySslRequiredEnum $sslRequired = null;
