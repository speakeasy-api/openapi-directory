...
class AgentEditRequest:
    ...
    agent_details: Optional[AgentEditRequestAgentDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('agent_details'), 'exclude': lambda f: f is None }})
    r"""Details about the agent"""  
