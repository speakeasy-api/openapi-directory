...
type UpdateCategoryRequestBody struct {
	...
	SearchPriority            *int64                 `json:"search_priority,omitempty"`
...
type UpdateCategory200ApplicationJSONCategoryRequiredTagGroups struct {
	MinCount int64  `json:"min_count"`
	Name     string `json:"name"`
}

type UpdateCategory200ApplicationJSONCategory struct {
	...
	FormTemplateIds                     []interface{}                                               `json:"form_template_ids"`
	GroupPermissions                    []UpdateCategory200ApplicationJSONCategoryGroupPermissions  `json:"group_permissions"`
	...
	RequiredTagGroups                   []UpdateCategory200ApplicationJSONCategoryRequiredTagGroups `json:"required_tag_groups"`
...
type UpdateCategory200ApplicationJSON struct {
	Category UpdateCategory200ApplicationJSONCategory `json:"category"`
