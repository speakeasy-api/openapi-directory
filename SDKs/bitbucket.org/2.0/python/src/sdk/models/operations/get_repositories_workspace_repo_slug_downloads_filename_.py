...
class GetRepositoriesWorkspaceRepoSlugDownloadsFilenameRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugDownloadsFilenamePathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugDownloadsFilenameSecurity = dataclasses.field()
