...
exports.ListTaskServerList = ["https://taskrouter.twilio.com"];
...
var ListTaskRequest = /** @class */ (function (_super) {
    ...
    ], ListTaskRequest.prototype, "assignmentStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EvaluateTaskAttributes",
        }),
        __metadata("design:type", String)
    ], ListTaskRequest.prototype, "evaluateTaskAttributes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=HasAddons",
        }),
        __metadata("design:type", Boolean)
    ], ListTaskRequest.prototype, "hasAddons", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Ordering",
        }),
        __metadata("design:type", String)
    ], ListTaskRequest.prototype, "ordering", void 0);
    __decorate([
...
var ListTaskListTaskResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.TaskrouterV1WorkspaceTask }),
        (0, class_transformer_1.Expose)({ name: "tasks" }),
        (0, class_transformer_1.Type)(function () { return shared.TaskrouterV1WorkspaceTask; }),
        __metadata("design:type", Array)
