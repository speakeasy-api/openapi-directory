...
public class GoogleCloudRetailV2alphaSearchRequest {
    ...
    public GoogleCloudRetailV2alphaSearchRequestBoostSpec boostSpec;

    public GoogleCloudRetailV2alphaSearchRequest withBoostSpec(GoogleCloudRetailV2alphaSearchRequestBoostSpec boostSpec) {
    ...
    public GoogleCloudRetailV2alphaSearchRequest withBranch(String branch) {
        this.branch = branch;
        return this;
    }
    ...
    public GoogleCloudRetailV2alphaSearchRequest withCanonicalFilter(String canonicalFilter) {
    ...
    public GoogleCloudRetailV2alphaSearchRequest withDynamicFacetSpec(GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec dynamicFacetSpec) {
    ...
    public GoogleCloudRetailV2alphaSearchRequest withEntity(String entity) {
        this.entity = entity;
        return this;
    }
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpec[] facetSpecs;

    public GoogleCloudRetailV2alphaSearchRequest withFacetSpecs(GoogleCloudRetailV2alphaSearchRequestFacetSpec[] facetSpecs) {
    ...
    public GoogleCloudRetailV2alphaSearchRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GoogleCloudRetailV2alphaSearchRequest withLabels(java.util.Map<String, String> labels) {
        this.labels = labels;
        return this;
    }
    ...
    public GoogleCloudRetailV2alphaSearchRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public GoogleCloudRetailV2alphaSearchRequest withOrderBy(String orderBy) {
    ...
    public GoogleCloudRetailV2alphaSearchRequest withPageCategories(String[] pageCategories) {
    ...
    public GoogleCloudRetailV2alphaSearchRequest withPageSize(Integer pageSize) {
    ...
    public GoogleCloudRetailV2alphaSearchRequest withPageToken(String pageToken) {
    ...
    public GoogleCloudRetailV2alphaSearchRequest withPersonalizationSpec(GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec personalizationSpec) {
    ...
    public GoogleCloudRetailV2alphaSearchRequest withQuery(String query) {
        this.query = query;
        return this;
    }
    ...
    public GoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec queryExpansionSpec;

    public GoogleCloudRetailV2alphaSearchRequest withQueryExpansionSpec(GoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec queryExpansionSpec) {
    ...
    public GoogleCloudRetailV2alphaSearchRequestRelevanceThresholdEnum relevanceThreshold;

    public GoogleCloudRetailV2alphaSearchRequest withRelevanceThreshold(GoogleCloudRetailV2alphaSearchRequestRelevanceThresholdEnum relevanceThreshold) {
    ...
    public GoogleCloudRetailV2alphaSearchRequestSearchModeEnum searchMode;

    public GoogleCloudRetailV2alphaSearchRequest withSearchMode(GoogleCloudRetailV2alphaSearchRequestSearchModeEnum searchMode) {
    ...
    public GoogleCloudRetailV2alphaSearchRequestSpellCorrectionSpec spellCorrectionSpec;

    public GoogleCloudRetailV2alphaSearchRequest withSpellCorrectionSpec(GoogleCloudRetailV2alphaSearchRequestSpellCorrectionSpec spellCorrectionSpec) {
    ...
    public GoogleCloudRetailV2alphaSearchRequest withUserInfo(GoogleCloudRetailV2alphaUserInfo userInfo) {
    ...
    public GoogleCloudRetailV2alphaSearchRequest withVariantRollupKeys(String[] variantRollupKeys) {
    ...
    public GoogleCloudRetailV2alphaSearchRequest withVisitorId(String visitorId) {
