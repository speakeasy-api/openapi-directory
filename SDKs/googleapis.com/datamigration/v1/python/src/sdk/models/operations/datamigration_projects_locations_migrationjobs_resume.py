...
class DatamigrationProjectsLocationsMigrationJobsResumeSecurity:
...
@dataclasses.dataclass
class DatamigrationProjectsLocationsMigrationJobsResumeRequest:
    
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'name', 'style': 'simple', 'explode': False }})
    r"""Name of the migration job resource to resume."""  
...
@dataclasses.dataclass
class DatamigrationProjectsLocationsMigrationJobsResumeResponse:
