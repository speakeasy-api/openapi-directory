...
func (s *Order) OrderAPIChangeShippingDetails(ctx context.Context, request operations.OrderAPIChangeShippingDetailsRequest) (*operations.OrderAPIChangeShippingDetailsResponse, error) {
	baseURL := s._serverURL
...
func (s *Order) OrderAPIChangeStatus(ctx context.Context, request operations.OrderAPIChangeStatusRequest) (*operations.OrderAPIChangeStatusResponse, error) {
	baseURL := s._serverURL
...
func (s *Order) OrderAPIDelete(ctx context.Context, request operations.OrderAPIDeleteRequest) (*operations.OrderAPIDeleteResponse, error) {
	baseURL := s._serverURL
