...
type FileProjectsLocationsOperationsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type FileProjectsLocationsOperationsDeletePathParams struct {
	// The name of the operation resource to be deleted.
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type FileProjectsLocationsOperationsDeleteQueryParams struct {
	// V1 error format.
...
type FileProjectsLocationsOperationsDeleteRequest struct {
...
type FileProjectsLocationsOperationsDeleteResponse struct {
	ContentType string
	// Successful response
