...
class ListRegexPatternSetsRequest:
    ...
    list_regex_pattern_sets_request: shared_listregexpatternsetsrequest.ListRegexPatternSetsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
