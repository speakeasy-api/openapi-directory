...
type ContentRepricingrulesPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentRepricingrulesPatchPathParams struct {
...
type ContentRepricingrulesPatchQueryParams struct {
	// V1 error format.
...
type ContentRepricingrulesPatchResponse struct {
	ContentType string
	// Successful response
