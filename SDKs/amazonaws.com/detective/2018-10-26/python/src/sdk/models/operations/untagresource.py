...
class UntagResourceRequest:
    ...
    r"""The ARN of the behavior graph to remove the tags from."""  
    tag_keys: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'tagKeys', 'style': 'form', 'explode': True }})
    r"""The tag keys of the tags to remove from the behavior graph. You can remove up to 50 tags at a time."""  
