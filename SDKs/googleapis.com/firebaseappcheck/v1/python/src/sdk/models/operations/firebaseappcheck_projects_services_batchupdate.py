...
class FirebaseappcheckProjectsServicesBatchUpdateRequest:
    ...
    r"""Required. The parent project name shared by all Service configurations being updated, in the format ``` projects/{project_number} ``` The parent collection in the `name` field of any resource being updated must match this field, or the entire batch fails."""  
    ...
    google_firebase_appcheck_v1_batch_update_services_request: Optional[shared_googlefirebaseappcheckv1batchupdateservicesrequest.GoogleFirebaseAppcheckV1BatchUpdateServicesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
