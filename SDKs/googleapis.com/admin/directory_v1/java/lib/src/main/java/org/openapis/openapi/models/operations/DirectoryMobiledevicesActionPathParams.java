...
public class DirectoryMobiledevicesActionPathParams {
    /**
    ...
    public DirectoryMobiledevicesActionPathParams withCustomerId(String customerId) {
    ...
    public DirectoryMobiledevicesActionPathParams withResourceId(String resourceId) {
