...
class GetRateByIdResponseBody
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyMonetaryValue $confirmationAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('confirmation_amount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyMonetaryValue')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyMonetaryValue $insuranceAmount
     */
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyMonetaryValue $otherAmount
     */
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyRateTypeEnum>')]
     ...
     * The shipping amount
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyMonetaryValue $shippingAmount
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyMonetaryValue $taxAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('tax_amount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyMonetaryValue')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetRateByIdResponseBodyMonetaryValue $taxAmount = null;
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyValidationStatusEnum>')]
	...
	public function __construct()
	{
		...
		$this->confirmationAmount = new \OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyMonetaryValue();
		$this->deliveryDays = null;
		$this->errorMessages = [];
		$this->estimatedDeliveryDate = null;
		$this->guaranteedService = false;
		$this->insuranceAmount = new \OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyMonetaryValue();
		$this->negotiatedRate = false;
		$this->otherAmount = new \OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyMonetaryValue();
		$this->packageType = "";
		$this->rateId = "";
		$this->rateType = \OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyRateTypeEnum::CHECK;
		$this->serviceCode = "";
		$this->serviceType = "";
		$this->shipDate = null;
		$this->shippingAmount = new \OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyMonetaryValue();
		$this->taxAmount = null;
		$this->trackable = false;
		$this->validationStatus = \OpenAPI\OpenAPI\Models\Shared\GetRateByIdResponseBodyValidationStatusEnum::VALID;
