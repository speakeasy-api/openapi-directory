...
export class RegionTargetHttpProxies {
  ...
  computeRegionTargetHttpProxiesTestIamPermissions(
    req: operations.ComputeRegionTargetHttpProxiesTestIamPermissionsRequest,
    security: operations.ComputeRegionTargetHttpProxiesTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeRegionTargetHttpProxiesTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.ComputeRegionTargetHttpProxiesTestIamPermissionsRequest(
          req
        );
    }
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/projects/{project}/regions/{region}/targetHttpProxies/{resource}/testIamPermissions",
      req
    );
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ComputeRegionTargetHttpProxiesTestIamPermissionsSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeRegionTargetHttpProxiesTestIamPermissionsResponse =
        new operations.ComputeRegionTargetHttpProxiesTestIamPermissionsResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
