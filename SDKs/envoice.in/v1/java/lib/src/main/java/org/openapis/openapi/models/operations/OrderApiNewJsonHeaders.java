...
public class OrderApiNewJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public OrderApiNewJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public OrderApiNewJsonHeaders withXAuthSecret(String xAuthSecret) {
