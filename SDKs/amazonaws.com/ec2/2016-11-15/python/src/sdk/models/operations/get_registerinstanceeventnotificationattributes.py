...
class GETRegisterInstanceEventNotificationAttributesRequest:
    ...
    action: GETRegisterInstanceEventNotificationAttributesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    version: GETRegisterInstanceEventNotificationAttributesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
    ...
    instance_tag_attribute: Optional[GETRegisterInstanceEventNotificationAttributesInstanceTagAttribute] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'InstanceTagAttribute', 'style': 'form', 'explode': True }})
    r"""Information about the tag keys to register."""  
