...
exports.BlockedNumbers = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var BlockedNumbers = /** @class */ (function () {
    function BlockedNumbers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    BlockedNumbers.prototype.getBlockedNumbers = function (req, config) {
     ...
     *
    **/
    BlockedNumbers.prototype.postBlockedNumbers = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
