 ...
 */
public class SchemaResponsePpostSchemaResponsesAttributes {
    /**
    ...
    public SchemaResponsePpostSchemaResponsesAttributes withDateCreated(Long dateCreated) {
    ...
    public SchemaResponsePpostSchemaResponsesAttributes withDateModified(Long dateModified) {
    ...
    public SchemaResponsePpostSchemaResponsesAttributes withDateSubmitted(Long dateSubmitted) {
    ...
    public SchemaResponsePpostSchemaResponsesAttributes withIsOriginalResponse(Boolean isOriginalResponse) {
    ...
    public SchemaResponsePpostSchemaResponsesAttributes withIsPendingCurrentUserApproval(Boolean isPendingCurrentUserApproval) {
    ...
    public SchemaResponsePpostSchemaResponsesAttributes withReviewsState(SchemaResponsePpostSchemaResponsesAttributesReviewsStateEnum reviewsState) {
    ...
    public SchemaResponsePpostSchemaResponsesAttributes withRevisionJustification(String revisionJustification) {
    ...
    public SchemaResponsePpostSchemaResponsesAttributes withRevisionResponses(java.util.Map<String, Object> revisionResponses) {
    ...
    public SchemaResponsePpostSchemaResponsesAttributes withUpdatedResponseKeys(Object[] updatedResponseKeys) {
        this.updatedResponseKeys = updatedResponseKeys;
        return this;
    }
    
    public SchemaResponsePpostSchemaResponsesAttributes(){}
}
