...
class CatalogChangeCustomColumnUserNamePathParams:
...
class CatalogChangeCustomColumnUserNameRequest:
    path_params: CatalogChangeCustomColumnUserNamePathParams = dataclasses.field()
...
@dataclasses.dataclass
class CatalogChangeCustomColumnUserNameResponse:
