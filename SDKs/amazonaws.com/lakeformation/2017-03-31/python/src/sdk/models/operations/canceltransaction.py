...
class CancelTransactionRequestBody:
    ...
    r"""The transaction to cancel."""  
    

@dataclasses.dataclass
class CancelTransactionRequest:
    
    request_body: CancelTransactionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class CancelTransactionResponse:
    ...
    cancel_transaction_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
