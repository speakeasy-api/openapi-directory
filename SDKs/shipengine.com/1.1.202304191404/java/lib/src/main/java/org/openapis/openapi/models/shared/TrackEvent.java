...
public class TrackEvent {
    ...
    public TrackEvent(@JsonProperty("carrier_detail_code") String carrierDetailCode, @JsonProperty("carrier_status_code") String carrierStatusCode, @JsonProperty("carrier_status_description") String carrierStatusDescription, @JsonProperty("city_locality") String cityLocality, @JsonProperty("occurred_at") OffsetDateTime occurredAt, @JsonProperty("postal_code") String postalCode, @JsonProperty("state_province") String stateProvince, @JsonProperty("status_code") StatusCodeEnum statusCode, @JsonProperty("status_description") String statusDescription) {
        this.carrierDetailCode = carrierDetailCode;
        this.carrierStatusCode = carrierStatusCode;
        this.carrierStatusDescription = carrierStatusDescription;
        this.cityLocality = cityLocality;
