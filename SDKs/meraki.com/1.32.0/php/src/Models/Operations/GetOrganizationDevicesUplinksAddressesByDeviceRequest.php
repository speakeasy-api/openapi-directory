...
class GetOrganizationDevicesUplinksAddressesByDeviceRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetOrganizationDevicesUplinksAddressesByDeviceTagsFilterTypeEnum $tagsFilterType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=tagsFilterType')]
    public ?GetOrganizationDevicesUplinksAddressesByDeviceTagsFilterTypeEnum $tagsFilterType = null;
