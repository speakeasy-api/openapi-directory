...
class PostPortfolioOptimizationMeanVarianceEfficientDiversifiedRequestBodyConstraints:
    ...
    delta_return: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deltaReturn'), 'exclude': lambda f: f is None }})
    r"""The relative tolerance over the mean-variance efficient portfolio return"""  
    delta_volatility: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deltaVolatility'), 'exclude': lambda f: f is None }})
    r"""The relative tolerance over the mean-variance efficient portfolio volatility"""  
    ...
    portfolio_return: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('portfolioReturn'), 'exclude': lambda f: f is None }})
    r"""The portfolio return; exclusive with portfolioVolatility and riskTolerance"""  
    portfolio_volatility: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('portfolioVolatility'), 'exclude': lambda f: f is None }})
    r"""The portfolio volatility; exclusive with portfolioReturn and riskTolerance"""  
    risk_tolerance: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('riskTolerance'), 'exclude': lambda f: f is None }})
    r"""The portfolio risk tolerance; exclusive with portfolioReturn and portfolioVolatility"""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostPortfolioOptimizationMeanVarianceEfficientDiversifiedRequestBody:
    ...
    constraints: PostPortfolioOptimizationMeanVarianceEfficientDiversifiedRequestBodyConstraints = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('constraints') }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostPortfolioOptimizationMeanVarianceEfficientDiversified200ApplicationJSON:
    r"""OK"""
...
class PostPortfolioOptimizationMeanVarianceEfficientDiversifiedResponse:
    ...
    post_portfolio_optimization_mean_variance_efficient_diversified_200_application_json_object: Optional[PostPortfolioOptimizationMeanVarianceEfficientDiversified200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""  
