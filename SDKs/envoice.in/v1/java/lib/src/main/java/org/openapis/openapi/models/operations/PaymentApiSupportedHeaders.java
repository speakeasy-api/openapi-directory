...
public class PaymentApiSupportedHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PaymentApiSupportedHeaders withXAuthKey(String xAuthKey) {
    ...
    public PaymentApiSupportedHeaders withXAuthSecret(String xAuthSecret) {
