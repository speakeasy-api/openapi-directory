...
public class Jobs {
    ...
    public org.openapis.openapi.models.operations.GetJobResponse getJob(org.openapis.openapi.models.operations.GetJobRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetJobRequest.class, baseUrl, "/jobs/{job_gid}", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetJobRequest.class, request, null);
        if (queryParams != null) {
