...
var Alias = /** @class */ (function () {
     ...
     */
    Alias.prototype.createAlias = function (req, security, config) {
        var _a;
        ...
        try {
            _a = utils.serializeRequestBody(req, "createAliasModel", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.createAliasResponseModel = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.CreateAliasResponseModel);
                    }
                    break;
            }
            return res;
     ...
     */
    Alias.prototype.deleteAlias = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    Alias.prototype.getAlias = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.aliasModel = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.AliasModel);
                    }
                    break;
            }
            return res;
     ...
     */
    Alias.prototype.getAliases = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetAliasesResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getAliasesModel = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetAliasesModel);
                    }
                    break;
            }
            return res;
     ...
     */
    Alias.prototype.updateAlias = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
