...
public class RepoSubmitPullReviewJsonRequest {
    ...
    public RepoSubmitPullReviewJsonRequest(@JsonProperty("SubmitPullReviewOptions") org.openapis.openapi.models.shared.SubmitPullReviewOptions submitPullReviewOptions, @JsonProperty("id") Long id, @JsonProperty("index") Long index, @JsonProperty("owner") String owner, @JsonProperty("repo") String repo) {
        this.submitPullReviewOptions = submitPullReviewOptions;
        this.id = id;
        this.index = index;
        this.owner = owner;
