...
exports.UploadSessionsUploadResponse = exports.UploadSessionsUploadRequest = exports.UploadSessionsUploadSecurity = exports.UploadSessionsUploadServerList = void 0;
...
var UploadSessionsUploadRequest = /** @class */ (function (_super) {
    ...
    ], UploadSessionsUploadRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "header, style=simple;explode=false;name=digest" }),
        __metadata("design:type", String)
    ], UploadSessionsUploadRequest.prototype, "digest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], UploadSessionsUploadRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=part_number",
        }),
        __metadata("design:type", Number)
    ], UploadSessionsUploadRequest.prototype, "partNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], UploadSessionsUploadRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], UploadSessionsUploadRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], UploadSessionsUploadRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], UploadSessionsUploadRequest.prototype, "xApideckServiceId", void 0);
...
var UploadSessionsUploadResponse = /** @class */ (function (_super) {
    ...
    ], UploadSessionsUploadResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
