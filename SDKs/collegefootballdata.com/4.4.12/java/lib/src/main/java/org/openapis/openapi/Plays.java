...
public class Plays {
    ...
    public org.openapis.openapi.models.operations.GetLivePlaysResponse getLivePlays(org.openapis.openapi.models.operations.GetLivePlaysRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetLivePlaysRequest.class, request, null);
        if (queryParams != null) {
        ...
        org.openapis.openapi.models.operations.GetLivePlaysResponse res = new org.openapis.openapi.models.operations.GetLivePlaysResponse(contentType, httpRes.statusCode()) {{
            livePlayByPlay = null;
        }};
    ...
    public org.openapis.openapi.models.operations.GetPlayStatTypesResponse getPlayStatTypes() throws Exception {
        ...
        org.openapis.openapi.models.operations.GetPlayStatTypesResponse res = new org.openapis.openapi.models.operations.GetPlayStatTypesResponse(contentType, httpRes.statusCode()) {{
            playStatTypes = null;
        }};
        res.rawResponse = httpRes;
    ...
    public org.openapis.openapi.models.operations.GetPlayStatsResponse getPlayStats(org.openapis.openapi.models.operations.GetPlayStatsRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetPlayStatsRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.GetPlayStatsResponse res = new org.openapis.openapi.models.operations.GetPlayStatsResponse(contentType, httpRes.statusCode()) {{
            playStats = null;
        }};
        res.rawResponse = httpRes;
    ...
    public org.openapis.openapi.models.operations.GetPlayTypesResponse getPlayTypes() throws Exception {
        ...
        org.openapis.openapi.models.operations.GetPlayTypesResponse res = new org.openapis.openapi.models.operations.GetPlayTypesResponse(contentType, httpRes.statusCode()) {{
            playTypes = null;
        }};
        res.rawResponse = httpRes;
    ...
    public org.openapis.openapi.models.operations.GetPlaysResponse getPlays(org.openapis.openapi.models.operations.GetPlaysRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetPlaysRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.GetPlaysResponse res = new org.openapis.openapi.models.operations.GetPlaysResponse(contentType, httpRes.statusCode()) {{
            plays = null;
        }};
        res.rawResponse = httpRes;
