...
export class GetNetworkClientLatencyHistoryRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetNetworkClientLatencyHistoryResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getNetworkClientLatencyHistory200ApplicationJSONObjects?: Record<
    string,
    any
  >[];
}
