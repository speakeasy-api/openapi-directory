...
class ReviewDismissedIssueEvent
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\ReviewDismissedIssueEventDismissedReview')]
	...
	public function __construct()
	{
		...
		$this->commitUrl = "";
		$this->createdAt = "";
		$this->dismissedReview = new \OpenAPI\OpenAPI\Models\Shared\ReviewDismissedIssueEventDismissedReview();
		$this->event = "";
		$this->id = 0;
		$this->nodeId = "";
