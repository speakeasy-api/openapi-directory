...
func (e ErrorsErrorAttachmentTextDefaultApplicationJSONErrorCodeEnum) ToPointer() *ErrorsErrorAttachmentTextDefaultApplicationJSONErrorCodeEnum {
	return &e
}
...
func (e *ErrorsErrorAttachmentTextDefaultApplicationJSONErrorCodeEnum) UnmarshalJSON(data []byte) error {
	...
	case "TooManyRequests":
		*e = ErrorsErrorAttachmentTextDefaultApplicationJSONErrorCodeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ErrorsErrorAttachmentTextDefaultApplicationJSONErrorCodeEnum: %v", v)
	}
}
