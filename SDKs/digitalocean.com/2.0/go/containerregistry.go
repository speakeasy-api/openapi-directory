...
func NewContainerRegistry(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *ContainerRegistry {
...
func (s *ContainerRegistry) CreateRegistry(ctx context.Context, request operations.CreateRegistryRequest) (*operations.CreateRegistryResponse, error) {
...
func (s *ContainerRegistry) DeleteRegistry(ctx context.Context) (*operations.DeleteRegistryResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/registry"
...
func (s *ContainerRegistry) DeleteRepositoryManifest(ctx context.Context, request operations.DeleteRepositoryManifestRequest) (*operations.DeleteRepositoryManifestResponse, error) {
	baseURL := s._serverURL
...
// A successful request will receive a 204 status code with no body in response.
// This indicates that the request was processed successfully.
func (s *ContainerRegistry) DeleteRepositoryTag(ctx context.Context, request operations.DeleteRepositoryTagRequest) (*operations.DeleteRepositoryTagResponse, error) {
	baseURL := s._serverURL
...
func (s *ContainerRegistry) GetDockerCredentials(ctx context.Context, request operations.GetDockerCredentialsRequest) (*operations.GetDockerCredentialsResponse, error) {
	baseURL := s._serverURL
...
func (s *ContainerRegistry) GetGarbageCollection(ctx context.Context, request operations.GetGarbageCollectionRequest) (*operations.GetGarbageCollectionResponse, error) {
	baseURL := s._serverURL
...
func (s *ContainerRegistry) GetRegistry(ctx context.Context) (*operations.GetRegistryResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/registry"
...
func (s *ContainerRegistry) GetRegistryOptions(ctx context.Context) (*operations.GetRegistryOptionsResponse, error) {
	baseURL := s._serverURL
...
func (s *ContainerRegistry) GetRegistrySubscription(ctx context.Context) (*operations.GetRegistrySubscriptionResponse, error) {
	baseURL := s._serverURL
...
func (s *ContainerRegistry) ListGarbageCollections(ctx context.Context, request operations.ListGarbageCollectionsRequest) (*operations.ListGarbageCollectionsResponse, error) {
	baseURL := s._serverURL
...
func (s *ContainerRegistry) ListRegistryRepositories(ctx context.Context, request operations.ListRegistryRepositoriesRequest) (*operations.ListRegistryRepositoriesResponse, error) {
	baseURL := s._serverURL
...
func (s *ContainerRegistry) ListRepositoryTags(ctx context.Context, request operations.ListRepositoryTagsRequest) (*operations.ListRepositoryTagsResponse, error) {
	baseURL := s._serverURL
...
func (s *ContainerRegistry) PostRegistrySubscription(ctx context.Context, request operations.PostRegistrySubscriptionRequest) (*operations.PostRegistrySubscriptionResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/registry/subscription"
...
func (s *ContainerRegistry) RunGarbageCollection(ctx context.Context, request operations.RunGarbageCollectionRequest) (*operations.RunGarbageCollectionResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/registry/{registry_name}/garbage-collection", request.PathParams)
...
func (s *ContainerRegistry) UpdateGarbageCollection(ctx context.Context, request operations.UpdateGarbageCollectionRequest) (*operations.UpdateGarbageCollectionResponse, error) {
	baseURL := s._serverURL
...
// be a 409 Conflict.
func (s *ContainerRegistry) ValidateRegistryName(ctx context.Context, request operations.ValidateRegistryNameRequest) (*operations.ValidateRegistryNameResponse, error) {
	baseURL := s._serverURL
