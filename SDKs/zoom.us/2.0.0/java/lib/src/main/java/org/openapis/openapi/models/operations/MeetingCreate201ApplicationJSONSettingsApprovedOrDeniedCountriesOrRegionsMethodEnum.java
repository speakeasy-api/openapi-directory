 ...
 */
public enum MeetingCreate201ApplicationJSONSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum {
    APPROVE("approve"),
    DENY("deny");
    ...
    private MeetingCreate201ApplicationJSONSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum(String value) {
        this.value = value;
    }
}
