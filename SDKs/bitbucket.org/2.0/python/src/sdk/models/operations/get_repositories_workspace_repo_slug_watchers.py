...
class GetRepositoriesWorkspaceRepoSlugWatchersRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugWatchersPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugWatchersSecurity = dataclasses.field()
