 ...
 */
export class GetSubnetCidrReservationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class GetSubnetCidrReservationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: GetSubnetCidrReservationsRequestFilters })
  filters?: GetSubnetCidrReservationsRequestFilters[];
