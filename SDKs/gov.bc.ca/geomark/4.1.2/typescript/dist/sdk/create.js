...
var Create = /** @class */ (function () {
    ...
    Create.prototype.postGeomarksCopy = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostGeomarksCopyResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case [200, 302, 400, 500].includes(httpRes === null || httpRes === void 0 ? void 0 : httpRes.status):
                    break;
            }
            return res;
        });
    ...
    Create.prototype.postGeomarksNew = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostGeomarksNewResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
