...
class GetRepositoriesWorkspaceRepoSlugVersionsVersionIDRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugVersionsVersionIDPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugVersionsVersionIDSecurity = dataclasses.field()
