...
from ..shared import deletenetworksiteresponse as shared_deletenetworksiteresponse
...
class DeleteNetworkSiteResponse:
    ...
    delete_network_site_response: Optional[shared_deletenetworksiteresponse.DeleteNetworkSiteResponse] = dataclasses.field(default=None)
    r"""Success"""  
