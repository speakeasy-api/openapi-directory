...
public class GetUsersIdsQuestionsFeaturedRequest {
    ...
    public GetUsersIdsQuestionsFeaturedRequest withCallback(String callback) {
    ...
    public GetUsersIdsQuestionsFeaturedRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdsQuestionsFeaturedRequest withFromdate(Long fromdate) {
    ...
    public GetUsersIdsQuestionsFeaturedRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetUsersIdsQuestionsFeaturedRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetUsersIdsQuestionsFeaturedRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetUsersIdsQuestionsFeaturedRequest withOrder(GetUsersIdsQuestionsFeaturedOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetUsersIdsQuestionsFeaturedRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdsQuestionsFeaturedRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdsQuestionsFeaturedRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetUsersIdsQuestionsFeaturedRequest withSort(GetUsersIdsQuestionsFeaturedSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetUsersIdsQuestionsFeaturedRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetUsersIdsQuestionsFeaturedRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
