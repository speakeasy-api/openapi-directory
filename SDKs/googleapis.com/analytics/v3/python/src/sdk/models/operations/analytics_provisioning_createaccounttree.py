...
class AnalyticsProvisioningCreateAccountTreeRequest:
    ...
    account_tree_request: Optional[shared_accounttreerequest.AccountTreeRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
