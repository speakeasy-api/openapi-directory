...
class DisassociateApprovalRuleTemplateFromRepositoryRequest:
    ...
    disassociate_approval_rule_template_from_repository_input: shared_disassociateapprovalruletemplatefromrepositoryinput.DisassociateApprovalRuleTemplateFromRepositoryInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
