...
export class FirebaseappdistributionProjectsGroupsBatchLeaveSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseappdistributionProjectsGroupsBatchLeaveRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseappdistributionProjectsGroupsBatchLeaveResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
