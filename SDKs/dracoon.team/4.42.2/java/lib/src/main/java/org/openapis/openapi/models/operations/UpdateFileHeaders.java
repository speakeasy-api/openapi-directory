...
public class UpdateFileHeaders {
    ...
    public UpdateFileHeaders withXSdsAuthToken(String xSdsAuthToken) {
    ...
    public UpdateFileHeaders withXSdsDateFormat(UpdateFileXSdsDateFormatEnum xSdsDateFormat) {
