...
import dataclasses
from ..shared import nathermostatdatabody as shared_nathermostatdatabody
...
class NAThermostatDataResponse:
    ...
    body: Optional[shared_nathermostatdatabody.NAThermostatDataBody] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('body'), 'exclude': lambda f: f is None }})  
