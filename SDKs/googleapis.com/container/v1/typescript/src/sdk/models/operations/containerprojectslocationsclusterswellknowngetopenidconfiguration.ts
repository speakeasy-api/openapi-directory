...
export class ContainerProjectsLocationsClustersWellKnownGetOpenidConfigurationRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsLocationsClustersWellKnownGetOpenidConfigurationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
