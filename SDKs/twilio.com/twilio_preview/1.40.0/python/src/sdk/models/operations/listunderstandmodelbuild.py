...
class ListUnderstandModelBuildListUnderstandModelBuildResponse:
    ...
    meta: Optional[ListUnderstandModelBuildListUnderstandModelBuildResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    model_builds: Optional[list[shared_preview_understand_assistant_model_build.PreviewUnderstandAssistantModelBuild]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_builds'), 'exclude': lambda f: f is None }})  
