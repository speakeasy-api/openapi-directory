...
export class MirrorTimelineUpdatePathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class MirrorTimelineUpdateQueryParams extends SpeakeasyBase {
...
export class MirrorTimelineUpdateRequests extends SpeakeasyBase {
...
export class MirrorTimelineUpdateSecurityOption1 extends SpeakeasyBase {
...
export class MirrorTimelineUpdateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" })
  oauth2: shared.SchemeOauth2;
...
export class MirrorTimelineUpdateSecurity extends SpeakeasyBase {
...
export class MirrorTimelineUpdateRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class MirrorTimelineUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
