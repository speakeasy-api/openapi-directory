...
from ..shared import associateapprovalruletemplatewithrepositoryinput as shared_associateapprovalruletemplatewithrepositoryinput
...
class AssociateApprovalRuleTemplateWithRepositoryHeaders:
    x_amz_target: AssociateApprovalRuleTemplateWithRepositoryXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateApprovalRuleTemplateWithRepositoryRequest:
    headers: AssociateApprovalRuleTemplateWithRepositoryHeaders = dataclasses.field()
    request: shared_associateapprovalruletemplatewithrepositoryinput.AssociateApprovalRuleTemplateWithRepositoryInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class AssociateApprovalRuleTemplateWithRepositoryResponse:
    ...
    maximum_rule_templates_associated_with_repository_exception: Optional[Any] = dataclasses.field(default=None)
