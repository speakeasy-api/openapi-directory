...
class V3PatternDeparture:
    ...
    skipped_stops: Optional[list[shared_v3_stopmodel.V3StopModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('skipped_stops') }})
