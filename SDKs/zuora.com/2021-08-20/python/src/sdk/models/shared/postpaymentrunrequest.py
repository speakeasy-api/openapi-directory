...
from ..shared import postpaymentrundataelementrequest as shared_postpaymentrundataelementrequest
...
class PostPaymentRunRequest:
    ...
    data: Optional[list[shared_postpaymentrundataelementrequest.PostPaymentRunDataElementRequest]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
