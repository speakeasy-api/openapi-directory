...
class UpdateKeywordByKeywordIDRequest:
    r"""A type that contains the fields for the <b>UpdateKeywordByKeywordId</b> request."""
    ...
    r"""This field is used to identify the keyword to be updated. The <a href=\"/api-docs/sell/marketing/resources/keyword/methods/getKeyword\">getKeyword</a> method can be used to retrieve keywordId values."""  
