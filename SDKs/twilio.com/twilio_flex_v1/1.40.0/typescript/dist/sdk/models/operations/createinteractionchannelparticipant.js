...
exports.CreateInteractionChannelParticipantResponse = exports.CreateInteractionChannelParticipantRequest = exports.CreateInteractionChannelParticipantCreateInteractionChannelParticipantRequest = exports.CreateInteractionChannelParticipantSecurity = exports.CreateInteractionChannelParticipantServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.CreateInteractionChannelParticipantServerList = [
...
var CreateInteractionChannelParticipantSecurity = /** @class */ (function (_super) {
    ...
    ], CreateInteractionChannelParticipantSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], CreateInteractionChannelParticipantSecurity.prototype, "username", void 0);
    return CreateInteractionChannelParticipantSecurity;
}(utils_1.SpeakeasyBase));
exports.CreateInteractionChannelParticipantSecurity = CreateInteractionChannelParticipantSecurity;
var CreateInteractionChannelParticipantCreateInteractionChannelParticipantRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=MediaProperties" }),
...
exports.CreateInteractionChannelParticipantCreateInteractionChannelParticipantRequest = CreateInteractionChannelParticipantCreateInteractionChannelParticipantRequest;
var CreateInteractionChannelParticipantRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CreateInteractionChannelParticipantRequest.prototype, "channelSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=InteractionSid",
        }),
        __metadata("design:type", String)
    ], CreateInteractionChannelParticipantRequest.prototype, "interactionSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "request, media_type=application/x-www-form-urlencoded",
        }),
        __metadata("design:type", CreateInteractionChannelParticipantCreateInteractionChannelParticipantRequest)
    ], CreateInteractionChannelParticipantRequest.prototype, "requestBody", void 0);
    return CreateInteractionChannelParticipantRequest;
}(utils_1.SpeakeasyBase));
exports.CreateInteractionChannelParticipantRequest = CreateInteractionChannelParticipantRequest;
var CreateInteractionChannelParticipantResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreateInteractionChannelParticipantResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.CreateInteractionChannelParticipantResponse = CreateInteractionChannelParticipantResponse;
