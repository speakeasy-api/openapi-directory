...
from ..shared import orderworkgrouplevellistvo as shared_orderworkgrouplevellistvo
...
class GetBuyOrderListOfWorkgroupResponse:
    ...
    order_workgroup_level_list_vo: Optional[shared_orderworkgrouplevellistvo.OrderWorkgroupLevelListVO] = dataclasses.field(default=None)
