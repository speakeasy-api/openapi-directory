...
req = operations.AlimwRequestBody(
    certificate_parameters=operations.AlimwRequestBodyCertificateParameters(
        ref_no="BRRC/2018/236543",
        token_no="Ex. 2924637nNv839 or date of issue in dd/mm/yyyy. if token number is less than 8 chars",
    ),
...
res = s.ap_is.alimw(req, operations.AlimwSecurity(
