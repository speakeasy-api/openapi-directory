...
public class GetNhInteriorHeaders {
    /**
    ...
    public GetNhInteriorHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhInteriorHeaders withXApiKey(String xApiKey) {
