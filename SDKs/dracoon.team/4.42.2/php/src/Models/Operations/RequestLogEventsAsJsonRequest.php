...
class RequestLogEventsAsJsonRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestLogEventsAsJsonXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestLogEventsAsJsonXSdsDateFormatEnum $xSdsDateFormat = null;
     ...
     * * `2` - Error
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestLogEventsAsJsonStatusEnum $status
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=status')]
    public ?RequestLogEventsAsJsonStatusEnum $status = null;
