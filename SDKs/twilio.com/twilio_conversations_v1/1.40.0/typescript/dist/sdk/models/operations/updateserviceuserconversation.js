...
exports.UpdateServiceUserConversationResponse = exports.UpdateServiceUserConversationRequest = exports.UpdateServiceUserConversationUpdateServiceUserConversationRequest = exports.UpdateServiceUserConversationSecurity = exports.UpdateServiceUserConversationServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.UpdateServiceUserConversationServerList = [
...
var UpdateServiceUserConversationSecurity = /** @class */ (function (_super) {
    ...
    ], UpdateServiceUserConversationSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], UpdateServiceUserConversationSecurity.prototype, "username", void 0);
    return UpdateServiceUserConversationSecurity;
}(utils_1.SpeakeasyBase));
exports.UpdateServiceUserConversationSecurity = UpdateServiceUserConversationSecurity;
...
exports.UpdateServiceUserConversationUpdateServiceUserConversationRequest = UpdateServiceUserConversationUpdateServiceUserConversationRequest;
var UpdateServiceUserConversationRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], UpdateServiceUserConversationRequest.prototype, "chatServiceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConversationSid",
        }),
        __metadata("design:type", String)
    ], UpdateServiceUserConversationRequest.prototype, "conversationSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "request, media_type=application/x-www-form-urlencoded",
        }),
        __metadata("design:type", UpdateServiceUserConversationUpdateServiceUserConversationRequest)
    ], UpdateServiceUserConversationRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=UserSid",
        }),
        __metadata("design:type", String)
    ], UpdateServiceUserConversationRequest.prototype, "userSid", void 0);
    return UpdateServiceUserConversationRequest;
}(utils_1.SpeakeasyBase));
exports.UpdateServiceUserConversationRequest = UpdateServiceUserConversationRequest;
var UpdateServiceUserConversationResponse = /** @class */ (function (_super) {
    ...
    ], UpdateServiceUserConversationResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.UpdateServiceUserConversationResponse = UpdateServiceUserConversationResponse;
