...
from ..shared import groupsv2_groupsearchresponse as shared_groupsv2_groupsearchresponse
from typing import Optional


@dataclasses.dataclass
class GroupV2GroupSearch200Wildcard:
    ...
    response: Optional[shared_groupsv2_groupsearchresponse.GroupsV2GroupSearchResponse] = dataclasses.field(default=None)  
