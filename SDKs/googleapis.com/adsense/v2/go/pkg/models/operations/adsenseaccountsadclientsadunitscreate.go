...
type AdsenseAccountsAdclientsAdunitsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AdsenseAccountsAdclientsAdunitsCreatePathParams struct {
	// Required. Ad client to create an ad unit under. Format: accounts/{account}/adclients/{adclient}
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type AdsenseAccountsAdclientsAdunitsCreateQueryParams struct {
	// V1 error format.
...
type AdsenseAccountsAdclientsAdunitsCreateResponse struct {
	// Successful response
