 ...
 * * **json**
 */
export enum UpdateCompanyWebhookRequestCommunicationFormatEnum {
  Http = "http",
  Json = "json",
  Soap = "soap",
}
 ...
 */
export enum UpdateCompanyWebhookRequestFilterMerchantAccountTypeEnum {
 ...
 */
export enum UpdateCompanyWebhookRequestNetworkTypeEnum {
  Local = "LOCAL",
  Public = "PUBLIC",
}
 ...
 */
export enum UpdateCompanyWebhookRequestSslVersionEnum {
  Http = "HTTP",
  Ssl = "SSL",
  SSLv3 = "SSLv3",
  Tls = "TLS",
...
export class UpdateCompanyWebhookRequest extends SpeakeasyBase {
  /**
