...
export class ContentRepricingrulesPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentRepricingrulesPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentRepricingrulesPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
