...
class OsPolicyResourceGroup:
    ...
    os_filter: Optional[shared_ospolicyosfilter.OsPolicyOsFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('osFilter') }})
