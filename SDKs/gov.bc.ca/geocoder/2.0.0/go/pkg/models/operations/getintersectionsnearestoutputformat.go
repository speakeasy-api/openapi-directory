...
func (e GetIntersectionsNearestOutputFormatOutputFormatEnum) ToPointer() *GetIntersectionsNearestOutputFormatOutputFormatEnum {
	return &e
}
...
func (e *GetIntersectionsNearestOutputFormatOutputFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "csv":
		fallthrough
	case "shpz":
		*e = GetIntersectionsNearestOutputFormatOutputFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetIntersectionsNearestOutputFormatOutputFormatEnum: %v", v)
	}
}
...
type GetIntersectionsNearestOutputFormatOutputSrsEnum int64
...
func (e GetIntersectionsNearestOutputFormatOutputSrsEnum) ToPointer() *GetIntersectionsNearestOutputFormatOutputSrsEnum {
	return &e
}
...
func (e *GetIntersectionsNearestOutputFormatOutputSrsEnum) UnmarshalJSON(data []byte) error {
	...
	case 26910:
		fallthrough
	case 26911:
		*e = GetIntersectionsNearestOutputFormatOutputSrsEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetIntersectionsNearestOutputFormatOutputSrsEnum: %v", v)
	}
}
