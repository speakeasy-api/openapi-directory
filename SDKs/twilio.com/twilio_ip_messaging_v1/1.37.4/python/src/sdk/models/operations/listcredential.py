...
class ListCredentialListCredentialResponse:
    credentials: Optional[list[shared_ip_messaging_v1_credential.IPMessagingV1Credential]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('credentials') }})
