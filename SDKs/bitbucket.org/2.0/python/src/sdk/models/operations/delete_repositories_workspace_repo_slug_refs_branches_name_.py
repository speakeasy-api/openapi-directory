...
class DeleteRepositoriesWorkspaceRepoSlugRefsBranchesNameRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugRefsBranchesNamePathParams = dataclasses.field()
    security: DeleteRepositoriesWorkspaceRepoSlugRefsBranchesNameSecurity = dataclasses.field()
