...
class AdminLinkProviderForUserRequest:
    ...
    admin_link_provider_for_user_request: shared_adminlinkproviderforuserrequest.AdminLinkProviderForUserRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
