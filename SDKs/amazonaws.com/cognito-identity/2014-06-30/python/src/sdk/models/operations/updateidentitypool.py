...
class UpdateIdentityPoolHeaders:
    x_amz_target: UpdateIdentityPoolXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateIdentityPoolRequest:
    headers: UpdateIdentityPoolHeaders = dataclasses.field()
    request: shared_identitypool.IdentityPool = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
