...
var V3StopAccessibilityWheelchair = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "accessible_ramp" }),
        __metadata("design:type", Boolean)
    ], V3StopAccessibilityWheelchair.prototype, "accessibleRamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "low_ticket_counter" }),
        __metadata("design:type", Boolean)
    ], V3StopAccessibilityWheelchair.prototype, "lowTicketCounter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "manouvering" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "raised_platform" }),
        __metadata("design:type", Boolean)
    ], V3StopAccessibilityWheelchair.prototype, "raisedPlatform", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "raised_platform_shelther" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "secondary_path" }),
        __metadata("design:type", Boolean)
    ], V3StopAccessibilityWheelchair.prototype, "secondaryPath", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "steep_ramp" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "toilet" }),
        __metadata("design:type", Boolean)
