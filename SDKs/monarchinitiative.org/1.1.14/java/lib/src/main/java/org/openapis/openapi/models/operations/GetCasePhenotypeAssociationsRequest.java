...
public class GetCasePhenotypeAssociationsRequest {
    ...
    public GetCasePhenotypeAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetCasePhenotypeAssociationsRequest withEvidence(String evidence) {
    ...
    public GetCasePhenotypeAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetCasePhenotypeAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetCasePhenotypeAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetCasePhenotypeAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetCasePhenotypeAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetCasePhenotypeAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetCasePhenotypeAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetCasePhenotypeAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetCasePhenotypeAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetCasePhenotypeAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetCasePhenotypeAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
