...
class ChargeUpdate:
    ...
    pricing: Optional[shared_pricingupdate.PricingUpdate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pricing'), 'exclude': lambda f: f is None }})  
