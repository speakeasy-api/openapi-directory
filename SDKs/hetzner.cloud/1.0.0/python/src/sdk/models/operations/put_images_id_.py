...
class PutImagesIDUpdateImageRequestTypeEnum(str, Enum):
    r"""Destination Image type to convert to"""
    SNAPSHOT = 'snapshot'
...
class PutImagesIDUpdateImageRequest:
    ...
    type: Optional[PutImagesIDUpdateImageRequestTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Destination Image type to convert to"""  
...
class PutImagesIDRequest:
    ...
    r"""ID of the Image"""  
    request_body: Optional[PutImagesIDUpdateImageRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class PutImagesID200ApplicationJSONImage:
    ...
    created_from: PutImagesID200ApplicationJSONImageCreatedFrom = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('created_from') }})
    r"""Information about the Server the Image was created from"""  
    ...
    os_flavor: PutImagesID200ApplicationJSONImageOsFlavorEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('os_flavor') }})
    r"""Flavor of operating system contained in the Image"""  
    ...
    protection: PutImagesID200ApplicationJSONImageProtection = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protection') }})
    r"""Protection configuration for the Resource"""  
    status: PutImagesID200ApplicationJSONImageStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Whether the Image can be used or if it's still being created or unavailable"""  
    type: PutImagesID200ApplicationJSONImageTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Type of the Image"""  
...
class PutImagesID200ApplicationJSON:
    r"""The image key in the reply contains the modified Image object"""
    
    image: Optional[PutImagesID200ApplicationJSONImage] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('image'), 'exclude': lambda f: f is None }})  
