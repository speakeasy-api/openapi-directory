...
type GetLicenseConversionTaskHeaders struct {
...
type GetLicenseConversionTaskRequest struct {
	Headers GetLicenseConversionTaskHeaders
	Request shared.GetLicenseConversionTaskRequest `request:"mediaType=application/json"`
}
