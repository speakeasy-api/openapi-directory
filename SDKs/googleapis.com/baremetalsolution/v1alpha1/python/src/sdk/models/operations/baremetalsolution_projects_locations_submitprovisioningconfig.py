...
class BaremetalsolutionProjectsLocationsSubmitProvisioningConfigRequest:
    ...
    r"""Required. The target location of the provisioning request."""  
    project: str = dataclasses.field(metadata={'path_param': { 'field_name': 'project', 'style': 'simple', 'explode': False }})
    r"""Required. The target project of the provisioning request."""  
    ...
    submit_provisioning_config_request: Optional[shared_submitprovisioningconfigrequest.SubmitProvisioningConfigRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
