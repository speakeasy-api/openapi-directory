...
func main() {
    ...
    res, err := s.Orgs.OrgsGetAuditLog(ctx, operations.OrgsGetAuditLogRequest{
        After: sdk.String("praesentium"),
        Before: sdk.String("odit"),
        Include: shared.AuditLogIncludeEnumWeb.ToPointer(),
        Order: shared.AuditLogOrderEnumDesc.ToPointer(),
        Org: "error",
        Page: sdk.Int64(937117),
        PerPage: sdk.Int64(239337),
        Phrase: sdk.String("recusandae"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Orgs.OrgsListAppInstallations(ctx, operations.OrgsListAppInstallationsRequest{
        Org: "dignissimos",
        Page: sdk.Int64(760744),
        PerPage: sdk.Int64(898961),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Orgs.OrgsListForUser(ctx, operations.OrgsListForUserRequest{
        Page: sdk.Int64(532669),
        PerPage: sdk.Int64(587375),
        Username: "Erich20",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Orgs.OrgsUpdate(ctx, operations.OrgsUpdateRequest{
        RequestBody: &operations.OrgsUpdateRequestBody{
            BillingEmail: sdk.String("sequi"),
            Blog: sdk.String(""http://github.blog""),
            Company: sdk.String("Robel, Carter and Wehner"),
            ...
            Email: sdk.String("Mohamed89@gmail.com"),
            ...
            TwitterUsername: sdk.String("libero"),
