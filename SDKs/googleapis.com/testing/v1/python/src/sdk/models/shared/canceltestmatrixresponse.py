...
class CancelTestMatrixResponse:
    ...
    test_state: Optional[CancelTestMatrixResponseTestStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('testState') }})
