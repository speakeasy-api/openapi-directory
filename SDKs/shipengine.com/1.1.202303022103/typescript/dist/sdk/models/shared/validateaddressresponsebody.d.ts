 ...
 */
export declare enum ValidateAddressResponseBodyPartialAddressAddressResidentialIndicatorEnum {
    Unknown = "unknown",
    Yes = "yes",
    No = "no"
}
 ...
 */
export declare class ValidateAddressResponseBodyPartialAddress extends SpeakeasyBase {
    /**
 ...
 */
export declare class ValidateAddressResponseBody extends SpeakeasyBase {
    /**
