...
class GetTruckOptimalDirectionsOutputFormatPathParams:
    output_format: GetTruckOptimalDirectionsOutputFormatOutputFormatEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class GetTruckOptimalDirectionsOutputFormatQueryParams:
    ...
    criteria: Optional[GetTruckOptimalDirectionsOutputFormatCriteriaEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'criteria', 'style': 'form', 'explode': True }})
    ...
    distance_unit: Optional[GetTruckOptimalDirectionsOutputFormatDistanceUnitEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'distanceUnit', 'style': 'form', 'explode': True }})
...
class GetTruckOptimalDirectionsOutputFormatRequest:
    path_params: GetTruckOptimalDirectionsOutputFormatPathParams = dataclasses.field()
    query_params: GetTruckOptimalDirectionsOutputFormatQueryParams = dataclasses.field()
