...
export class DatalineageProjectsLocationsProcessesCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatalineageProjectsLocationsProcessesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatalineageProjectsLocationsProcessesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
