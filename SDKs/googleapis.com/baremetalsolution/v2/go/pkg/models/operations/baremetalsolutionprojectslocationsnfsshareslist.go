...
type BaremetalsolutionProjectsLocationsNfsSharesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type BaremetalsolutionProjectsLocationsNfsSharesListPathParams struct {
	// Required. Parent value for ListNfsSharesRequest.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type BaremetalsolutionProjectsLocationsNfsSharesListQueryParams struct {
	// V1 error format.
...
type BaremetalsolutionProjectsLocationsNfsSharesListRequest struct {
...
type BaremetalsolutionProjectsLocationsNfsSharesListResponse struct {
	ContentType string
	// Successful response
