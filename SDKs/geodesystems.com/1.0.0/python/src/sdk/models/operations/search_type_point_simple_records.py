...
class SearchTypePointSimpleRecordsQueryParams:
...
@dataclasses.dataclass
class SearchTypePointSimpleRecordsRequest:
    query_params: SearchTypePointSimpleRecordsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypePointSimpleRecordsResponse:
