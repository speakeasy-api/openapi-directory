...
class ErrorsGroupDetailsSecurity:
...
class ErrorsGroupDetailsDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
class ErrorsGroupDetailsDefaultApplicationJSONError:
    ...
    code: ErrorsGroupDetailsDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
...
class ErrorsGroupDetailsDefaultApplicationJSON:
    ...
    error: ErrorsGroupDetailsDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
    
class ErrorsGroupDetails200ApplicationJSONReasonFramesLanguageEnum(str, Enum):
...
class ErrorsGroupDetails200ApplicationJSONReasonFrames:
    ...
    language: Optional[ErrorsGroupDetails200ApplicationJSONReasonFramesLanguageEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('language'), 'exclude': lambda f: f is None }})
    r"""programming language of the frame"""  
...
class ErrorsGroupDetails200ApplicationJSONStateEnum(str, Enum):
    OPEN = 'open'
    CLOSED = 'closed'
    IGNORED = 'ignored'
...
class ErrorsGroupDetails200ApplicationJSON:
    ...
    state: ErrorsGroupDetails200ApplicationJSONStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})  
    ...
    reason_frames: Optional[list[ErrorsGroupDetails200ApplicationJSONReasonFrames]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reasonFrames'), 'exclude': lambda f: f is None }})  
...
class ErrorsGroupDetailsResponse:
    ...
    errors_group_details_200_application_json_object: Optional[ErrorsGroupDetails200ApplicationJSON] = dataclasses.field(default=None)
    r"""Error group details"""  
    errors_group_details_default_application_json_object: Optional[ErrorsGroupDetailsDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error code with reason"""  
