...
import dataclasses
from ..shared import proposedbid as shared_proposedbid
...
class SuggestedBids:
    r"""The suggested bid rate for the item."""
    ...
    proposed_bid: Optional[shared_proposedbid.ProposedBid] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('proposedBid'), 'exclude': lambda f: f is None }})
