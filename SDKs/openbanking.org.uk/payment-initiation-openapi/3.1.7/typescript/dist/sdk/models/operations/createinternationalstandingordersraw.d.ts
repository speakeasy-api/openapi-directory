...
export declare class CreateInternationalStandingOrdersRawSecurity extends SpeakeasyBase {
    psuoAuth2Security: string;
}
export declare class CreateInternationalStandingOrdersRawRequest extends SpeakeasyBase {
    /**
...
export declare class CreateInternationalStandingOrdersRawResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
