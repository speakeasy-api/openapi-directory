...
var GkeNodeConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: gkenodepoolacceleratorconfig_1.GkeNodePoolAcceleratorConfig }),
        (0, class_transformer_1.Expose)({ name: "accelerators" }),
        (0, class_transformer_1.Type)(function () { return gkenodepoolacceleratorconfig_1.GkeNodePoolAcceleratorConfig; }),
