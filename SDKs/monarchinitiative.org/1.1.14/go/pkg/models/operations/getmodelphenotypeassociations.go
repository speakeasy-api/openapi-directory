...
type GetModelPhenotypeAssociationsPathParams struct {
	// id
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetModelPhenotypeAssociationsQueryParams struct {
