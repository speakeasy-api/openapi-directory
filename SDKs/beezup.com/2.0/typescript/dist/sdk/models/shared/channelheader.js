...
var channelheaderlinks_1 = require("./channelheaderlinks");
// ChannelHeader
/**
...
var ChannelHeader = /** @class */ (function (_super) {
    ...
    ], ChannelHeader.prototype, "channelId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=channelLogoUrl" }),
        __metadata("design:type", String)
    ], ChannelHeader.prototype, "channelLogoUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=channelName" }),
        __metadata("design:type", String)
    ], ChannelHeader.prototype, "channelName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=links" }),
        __metadata("design:type", channelheaderlinks_1.ChannelHeaderLinks)
    ], ChannelHeader.prototype, "links", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=types" }),
        __metadata("design:type", Array)
    ], ChannelHeader.prototype, "types", void 0);
