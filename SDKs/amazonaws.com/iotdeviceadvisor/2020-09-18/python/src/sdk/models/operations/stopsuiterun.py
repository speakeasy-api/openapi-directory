...
class StopSuiteRunRequest:
    headers: StopSuiteRunHeaders = dataclasses.field()
    path_params: StopSuiteRunPathParams = dataclasses.field()
...
class StopSuiteRunResponse:
    ...
    stop_suite_run_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
