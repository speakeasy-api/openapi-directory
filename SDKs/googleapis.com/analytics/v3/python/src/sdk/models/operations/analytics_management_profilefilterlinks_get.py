...
class AnalyticsManagementProfileFilterLinksGetSecurity:
    option1: Optional[AnalyticsManagementProfileFilterLinksGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementProfileFilterLinksGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class AnalyticsManagementProfileFilterLinksGetRequest:
    path_params: AnalyticsManagementProfileFilterLinksGetPathParams = dataclasses.field()
    query_params: AnalyticsManagementProfileFilterLinksGetQueryParams = dataclasses.field()
    security: AnalyticsManagementProfileFilterLinksGetSecurity = dataclasses.field()
