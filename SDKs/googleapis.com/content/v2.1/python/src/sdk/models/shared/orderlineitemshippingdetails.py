...
class OrderLineItemShippingDetails:
    ...
    pickup_promise_in_minutes: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pickupPromiseInMinutes'), 'exclude': lambda f: f is None }})
    r"""The promised time in minutes in which the order will be ready for pickup. This only applies to buy-online-pickup-in-store same-day order."""  
