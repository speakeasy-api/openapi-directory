...
class DiagnosticsThreadFramesLanguageEnum(str, Enum):
...
class DiagnosticsThreadFrames:
    ...
    language: Optional[DiagnosticsThreadFramesLanguageEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('language'), 'exclude': lambda f: f is None }})
    r"""programming language of the frame"""  
...
class DiagnosticsThreadPlatformEnum(str, Enum):
...
class DiagnosticsThread:
    ...
    frames: list[DiagnosticsThreadFrames] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('frames') }})
    ...
    r"""a exception"""  
    platform: Optional[DiagnosticsThreadPlatformEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('platform'), 'exclude': lambda f: f is None }})
    r"""SDK/Platform this thread is beeing generated from"""  
    relevant: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('relevant'), 'exclude': lambda f: f is None }})
