...
class GetDeleteTargetGroupQueryParams:
    action: GetDeleteTargetGroupActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    target_group_arn: str = dataclasses.field(metadata={'query_param': { 'field_name': 'TargetGroupArn', 'style': 'form', 'explode': True }})
    version: GetDeleteTargetGroupVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteTargetGroupRequest:
    headers: GetDeleteTargetGroupHeaders = dataclasses.field()
    query_params: GetDeleteTargetGroupQueryParams = dataclasses.field()
