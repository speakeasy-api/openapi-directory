...
public class TargetSslProxies {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeTargetSslProxiesTestIamPermissionsResponse computeTargetSslProxiesTestIamPermissions(org.openapis.openapi.models.operations.ComputeTargetSslProxiesTestIamPermissionsRequest request, org.openapis.openapi.models.operations.ComputeTargetSslProxiesTestIamPermissionsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeTargetSslProxiesTestIamPermissionsRequest.class, baseUrl, "/projects/{project}/global/targetSslProxies/{resource}/testIamPermissions", request, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeTargetSslProxiesTestIamPermissionsRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
