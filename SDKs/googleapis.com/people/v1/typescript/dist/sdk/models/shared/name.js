...
exports.NameInput = exports.Name = void 0;
...
var Name = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=displayNameLastFirst" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=phoneticFamilyName" }),
        __metadata("design:type", String)
    ], Name.prototype, "phoneticFamilyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=phoneticFullName" }),
        __metadata("design:type", String)
    ], Name.prototype, "phoneticFullName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=phoneticGivenName" }),
        __metadata("design:type", String)
    ], Name.prototype, "phoneticGivenName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=phoneticHonorificPrefix" }),
        __metadata("design:type", String)
    ], Name.prototype, "phoneticHonorificPrefix", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=phoneticHonorificSuffix" }),
        __metadata("design:type", String)
    ], Name.prototype, "phoneticHonorificSuffix", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=phoneticMiddleName" }),
        __metadata("design:type", String)
    ], Name.prototype, "phoneticMiddleName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=unstructuredName" }),
        __metadata("design:type", String)
