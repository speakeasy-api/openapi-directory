...
from ..shared import updatetenderresponse as shared_updatetenderresponse
...
class TendersUpdateRequest:
    ...
    tender_input: shared_tender.TenderInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class TendersUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_tender_response: Optional[shared_updatetenderresponse.UpdateTenderResponse] = dataclasses.field(default=None)
    r"""Tenders"""  
