...
class CinemaSheduleShowtime:
    ...
    def cinema_shedule_showtime_search_read(self, request: operations.CinemaSheduleShowtimeSearchReadRequest) -> operations.CinemaSheduleShowtimeSearchReadResponse:
        ...
        * You can use both Amharic or English charset/font to search
        ...
        url = utils.generate_url(operations.CinemaSheduleShowtimeSearchReadRequest, base_url, '/api/v1/cinema-shedule-showtime/search/{movie_title}', request)
        ...
        res = operations.CinemaSheduleShowtimeSearchReadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def cinema_shedule_showtime_searchall_read(self, request: operations.CinemaSheduleShowtimeSearchallReadRequest) -> operations.CinemaSheduleShowtimeSearchallReadResponse:
        ...
        * cinema technology
        ...
        url = utils.generate_url(operations.CinemaSheduleShowtimeSearchallReadRequest, base_url, '/api/v1/cinema-shedule-showtime/searchall/{param}', request)
        ...
        res = operations.CinemaSheduleShowtimeSearchallReadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
