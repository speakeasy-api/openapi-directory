...
public class TaxApiDeleteFormRequest {
    ...
    public TaxApiDeleteFormRequest(@JsonProperty("TaxDeleteApiModel") org.openapis.openapi.models.shared.TaxDeleteApiModel taxDeleteApiModel, @JsonProperty("x-auth-key") String xAuthKey, @JsonProperty("x-auth-secret") String xAuthSecret) {
        this.taxDeleteApiModel = taxDeleteApiModel;
        this.xAuthKey = xAuthKey;
        this.xAuthSecret = xAuthSecret;
  }
