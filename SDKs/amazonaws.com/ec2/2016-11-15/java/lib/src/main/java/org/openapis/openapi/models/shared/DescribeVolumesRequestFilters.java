 ...
 */
public class DescribeVolumesRequestFilters {
    
    public String name;

    public DescribeVolumesRequestFilters withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DescribeVolumesRequestFilters withValues(String[] values) {
        this.values = values;
        return this;
    }
    
    public DescribeVolumesRequestFilters(){}
}
