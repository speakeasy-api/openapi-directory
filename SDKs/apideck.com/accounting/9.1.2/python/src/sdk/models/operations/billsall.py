...
from ..shared import billssort as shared_billssort
from ..shared import getbillsresponse as shared_getbillsresponse
...
class BillsAllRequest:
    ...
    sort: Optional[shared_billssort.BillsSort] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'deepObject', 'explode': True }})
    r"""Apply sorting"""  
...
class BillsAllResponse:
    ...
    r"""Bad Request"""  
    get_bills_response: Optional[shared_getbillsresponse.GetBillsResponse] = dataclasses.field(default=None)
    r"""Bills"""  
