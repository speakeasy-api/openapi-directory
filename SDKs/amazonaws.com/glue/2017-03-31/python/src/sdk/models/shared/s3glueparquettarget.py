...
class S3GlueParquetTarget:
    ...
    compression: Optional[shared_parquetcompressiontype_enum.ParquetCompressionTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Compression'), 'exclude': lambda f: f is None }})  
