...
exports.POSTEnableFastSnapshotRestoresResponse = exports.POSTEnableFastSnapshotRestoresRequest = exports.POSTEnableFastSnapshotRestoresVersionEnum = exports.POSTEnableFastSnapshotRestoresActionEnum = void 0;
...
var POSTEnableFastSnapshotRestoresRequest = /** @class */ (function (_super) {
    ...
    ], POSTEnableFastSnapshotRestoresRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=text/xml" }),
        __metadata("design:type", Uint8Array)
    ], POSTEnableFastSnapshotRestoresRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], POSTEnableFastSnapshotRestoresRequest.prototype, "version", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], POSTEnableFastSnapshotRestoresRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], POSTEnableFastSnapshotRestoresRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], POSTEnableFastSnapshotRestoresRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], POSTEnableFastSnapshotRestoresRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], POSTEnableFastSnapshotRestoresRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], POSTEnableFastSnapshotRestoresRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], POSTEnableFastSnapshotRestoresRequest.prototype, "xAmzSignedHeaders", void 0);
...
var POSTEnableFastSnapshotRestoresResponse = /** @class */ (function (_super) {
    ...
    ], POSTEnableFastSnapshotRestoresResponse.prototype, "rawResponse", void 0);
