...
class AddMembersForPortfolioRequestBody:
    r"""Information about the members being added."""
    
    data: Optional[shared_addmembersrequest.AddMembersRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
...
class AddMembersForPortfolioRequest:
    ...
    request_body: AddMembersForPortfolioRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Information about the members being added."""  
...
class AddMembersForPortfolio200ApplicationJSON:
    r"""Successfully added members to the portfolio."""
