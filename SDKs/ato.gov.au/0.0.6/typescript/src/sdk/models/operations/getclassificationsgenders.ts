...
export class GetClassificationsGendersRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class GetClassificationsGendersResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: shared.Gender })
