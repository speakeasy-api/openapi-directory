...
class ToolresultsProjectsHistoriesExecutionsStepsTestCasesGetPathParams:
    ...
    test_case_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'testCaseId', 'style': 'simple', 'explode': False }})
...
class ToolresultsProjectsHistoriesExecutionsStepsTestCasesGetRequest:
    path_params: ToolresultsProjectsHistoriesExecutionsStepsTestCasesGetPathParams = dataclasses.field()
    query_params: ToolresultsProjectsHistoriesExecutionsStepsTestCasesGetQueryParams = dataclasses.field()
    security: ToolresultsProjectsHistoriesExecutionsStepsTestCasesGetSecurity = dataclasses.field()
...
class ToolresultsProjectsHistoriesExecutionsStepsTestCasesGetResponse:
    ...
    test_case: Optional[shared_testcase.TestCase] = dataclasses.field(default=None)
