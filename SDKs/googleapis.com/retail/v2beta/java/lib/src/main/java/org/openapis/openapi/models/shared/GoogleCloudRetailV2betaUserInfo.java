...
public class GoogleCloudRetailV2betaUserInfo {
    ...
    public GoogleCloudRetailV2betaUserInfo withDirectUserRequest(Boolean directUserRequest) {
    ...
    public GoogleCloudRetailV2betaUserInfo withIpAddress(String ipAddress) {
    ...
    public GoogleCloudRetailV2betaUserInfo withUserAgent(String userAgent) {
    ...
    public GoogleCloudRetailV2betaUserInfo withUserId(String userId) {
        this.userId = userId;
        return this;
    }
