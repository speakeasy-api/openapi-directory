...
func (s *Operations) CloudresourcemanagerOperationsGet(ctx context.Context, request operations.CloudresourcemanagerOperationsGetRequest) (*operations.CloudresourcemanagerOperationsGetResponse, error) {
	...
	res := &operations.CloudresourcemanagerOperationsGetResponse{
