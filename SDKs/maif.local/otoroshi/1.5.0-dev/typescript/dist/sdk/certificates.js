...
var Certificates = /** @class */ (function () {
    ...
    **/
    Certificates.prototype.allCerts = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AllCertsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/certificates";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.certificates = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    Certificates.prototype.createCert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Certificates.prototype.deleteCert = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteCertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/certificates/{id}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
    ...
    **/
    Certificates.prototype.oneCert = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Certificates.prototype.patchCert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update one certificate by id
    **/
    Certificates.prototype.putCert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
