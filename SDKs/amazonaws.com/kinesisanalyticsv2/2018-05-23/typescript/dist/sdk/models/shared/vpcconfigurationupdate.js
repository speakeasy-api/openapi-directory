...
exports.VpcConfigurationUpdate = void 0;
var utils_1 = require("../../../internal/utils");
var class_transformer_1 = require("class-transformer");
/**
 * Describes updates to the VPC configuration used by the application.
 */
var VpcConfigurationUpdate = /** @class */ (function (_super) {
    __extends(VpcConfigurationUpdate, _super);
    function VpcConfigurationUpdate() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "SecurityGroupIdUpdates" }),
        __metadata("design:type", Array)
    ], VpcConfigurationUpdate.prototype, "securityGroupIdUpdates", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "SubnetIdUpdates" }),
        __metadata("design:type", Array)
    ], VpcConfigurationUpdate.prototype, "subnetIdUpdates", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "VpcConfigurationId" }),
