...
from ..shared import requestspotlaunchspecification as shared_requestspotlaunchspecification
from datetime import datetime
from enum import Enum
from typing import Optional

class RequestSpotInstancesRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class RequestSpotInstancesRequestTagSpecifications:
    ...
    resource_type: Optional[RequestSpotInstancesRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[RequestSpotInstancesRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    
class RequestSpotInstancesRequestTypeEnum(str, Enum):
    r"""<p>The Spot Instance request type.</p> <p>Default: <code>one-time</code> </p>"""
    ONE_TIME = 'one-time'
...
class RequestSpotInstancesRequest:
    r"""Contains the parameters for RequestSpotInstances."""
    ...
    launch_specification: Optional[shared_requestspotlaunchspecification.RequestSpotLaunchSpecification] = dataclasses.field(default=None)  
    spot_price: Optional[str] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[RequestSpotInstancesRequestTagSpecifications]] = dataclasses.field(default=None)  
    type: Optional[RequestSpotInstancesRequestTypeEnum] = dataclasses.field(default=None)  
