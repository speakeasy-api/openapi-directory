...
class GetSubstanceRoleAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetSubstanceRoleAssociationsQueryParams:
...
class GetSubstanceRoleAssociationsRequest:
    path_params: GetSubstanceRoleAssociationsPathParams = dataclasses.field()
    query_params: GetSubstanceRoleAssociationsQueryParams = dataclasses.field()
