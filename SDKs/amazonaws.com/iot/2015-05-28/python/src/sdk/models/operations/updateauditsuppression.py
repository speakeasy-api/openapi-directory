...
class UpdateAuditSuppressionRequestBody:
    ...
    resource_identifier: UpdateAuditSuppressionRequestBodyResourceIdentifier = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resourceIdentifier') }})
    r"""Information that identifies the noncompliant resource."""  
    ...
    r"""The expiration date (epoch timestamp in seconds) that you want the suppression to adhere to."""  
...
class UpdateAuditSuppressionRequest:
    ...
    request_body: UpdateAuditSuppressionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
