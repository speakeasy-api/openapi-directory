...
public class QuickTestImageUrlFormRequest {
    ...
    public QuickTestImageUrlFormRequest(@JsonProperty("ImageUrl") org.openapis.openapi.models.shared.ImageUrl imageUrl, @JsonProperty("Training-Key") String trainingKey, @JsonProperty("projectId") String projectId) {
        this.imageUrl = imageUrl;
        this.trainingKey = trainingKey;
        this.projectId = projectId;
  }
