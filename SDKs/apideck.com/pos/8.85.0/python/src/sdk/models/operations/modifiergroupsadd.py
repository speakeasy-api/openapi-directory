...
from ..shared import createmodifiergroupresponse as shared_createmodifiergroupresponse
...
class ModifierGroupsAddRequest:
    headers: ModifierGroupsAddHeaders = dataclasses.field()
    query_params: ModifierGroupsAddQueryParams = dataclasses.field()
    request: shared_modifiergroup.ModifierGroupInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: ModifierGroupsAddSecurity = dataclasses.field()
...
class ModifierGroupsAddResponse:
    ...
    create_modifier_group_response: Optional[shared_createmodifiergroupresponse.CreateModifierGroupResponse] = dataclasses.field(default=None)
