...
@dataclasses.dataclass
class JobListFromJobScheduleHeaders:
...
@dataclasses.dataclass
class JobListFromJobScheduleRequest:
    headers: JobListFromJobScheduleHeaders = dataclasses.field()
    path_params: JobListFromJobSchedulePathParams = dataclasses.field()
    query_params: JobListFromJobScheduleQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class JobListFromJobScheduleResponse:
    content_type: str = dataclasses.field()
    headers: dict[str, list[str]] = dataclasses.field()
    status_code: int = dataclasses.field()
    batch_error: Optional[Any] = dataclasses.field(default=None)
    cloud_job_list_result: Optional[Any] = dataclasses.field(default=None)
