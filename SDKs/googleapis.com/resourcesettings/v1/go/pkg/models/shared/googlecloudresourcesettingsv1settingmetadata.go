...
func (e *GoogleCloudResourcesettingsV1SettingMetadataDataTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "DURATION_VALUE":
		fallthrough
	case "STRING_MAP":
		*e = GoogleCloudResourcesettingsV1SettingMetadataDataTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudResourcesettingsV1SettingMetadataDataTypeEnum: %s", s)
	}
}
