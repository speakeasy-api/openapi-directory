...
class LocalDiskInitializeParams:
    ...
    disk_type: Optional[LocalDiskInitializeParamsDiskTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('diskType') }})
