...
class ActionPOSTqueryRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\ProxyActionqueryRequest $proxyActionqueryRequest;
	...
	{
		$this->proxyActionqueryRequest = new \OpenAPI\OpenAPI\Models\Shared\ProxyActionqueryRequest();
