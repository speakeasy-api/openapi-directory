    ...
    public static void main(String[] args) {
        try {
            ...
            CripcRequestBody req = new CripcRequestBody(CripcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new CripcRequestBodyCertificateParameters("31-12-1980", "01234567890/12345678901234567/AA11AA1111", "Sunil Kumar", "M", "D0123456789", "Mobile Number,Chassis Number,Vehicle Registration Number");;
