...
func (s *operationsT) ServiceusageOperationsCancel(ctx context.Context, request operations.ServiceusageOperationsCancelRequest) (*operations.ServiceusageOperationsCancelResponse, error) {
	baseURL := s.serverURL
...
func (s *operationsT) ServiceusageOperationsDelete(ctx context.Context, request operations.ServiceusageOperationsDeleteRequest) (*operations.ServiceusageOperationsDeleteResponse, error) {
	baseURL := s.serverURL
