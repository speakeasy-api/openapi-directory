...
class CreateBatchResponseBodyLabelFormatEnum(str, Enum):
...
class CreateBatchResponseBodyLabelLayoutEnum(str, Enum):
...
class CreateBatchResponseBodyBatchStatusEnum(str, Enum):
...
class CreateBatchResponseBody:
    ...
    batch_errors_url: CreateBatchResponseBodyOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('batch_errors_url') }})
    ...
    form_download: CreateBatchResponseBodyOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('form_download') }})
    ...
    label_download: CreateBatchResponseBodyLabelDownload = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_download') }})
    r"""The label download for the batch"""  
    label_format: CreateBatchResponseBodyLabelFormatEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_format') }})  
    label_layout: CreateBatchResponseBodyLabelLayoutEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_layout') }})
    r"""label layout"""  
    ...
    status: CreateBatchResponseBodyBatchStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
