...
class DriveFilesTouchSecurity:
    option1: Optional[DriveFilesTouchSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DriveFilesTouchSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[DriveFilesTouchSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[DriveFilesTouchSecurityOption4] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option5: Optional[DriveFilesTouchSecurityOption5] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DriveFilesTouchRequest:
    path_params: DriveFilesTouchPathParams = dataclasses.field()
    query_params: DriveFilesTouchQueryParams = dataclasses.field()
    security: DriveFilesTouchSecurity = dataclasses.field()
