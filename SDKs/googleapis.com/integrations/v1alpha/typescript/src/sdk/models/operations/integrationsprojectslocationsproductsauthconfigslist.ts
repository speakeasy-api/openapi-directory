...
export class IntegrationsProjectsLocationsProductsAuthConfigsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsProductsAuthConfigsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsProductsAuthConfigsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
