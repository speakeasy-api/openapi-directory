...
func (e CallFeedbackEnumIssuesEnum) ToPointer() *CallFeedbackEnumIssuesEnum {
	return &e
}
...
func (e *CallFeedbackEnumIssuesEnum) UnmarshalJSON(data []byte) error {
	...
	case "unsolicited-call":
		*e = CallFeedbackEnumIssuesEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CallFeedbackEnumIssuesEnum: %v", v)
	}
}
