...
class SendMessageRequestBody3Custom
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3CustomChannelEnum $channel
     */
	#[\JMS\Serializer\Annotation\SerializedName('channel')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3CustomChannelEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3CustomMessageTypeEnum $messageType
     */
	#[\JMS\Serializer\Annotation\SerializedName('message_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3CustomMessageTypeEnum>')]
	...
	{
		$this->channel = \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3CustomChannelEnum::WHATSAPP;
		$this->clientRef = null;
		$this->custom = null;
		$this->from = "";
		$this->messageType = \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody3CustomMessageTypeEnum::CUSTOM;
		$this->to = "";
	}
}
