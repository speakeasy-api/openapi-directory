...
class StartAppReplicationRequest:
    ...
    start_app_replication_request: shared_startappreplicationrequest.StartAppReplicationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
