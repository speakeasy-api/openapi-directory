...
class Metric:
    ...
    window: shared_metricwindow.MetricWindow = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('window') }})
    processing_config: Optional[shared_metricprocessingconfig.MetricProcessingConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('processingConfig') }})
