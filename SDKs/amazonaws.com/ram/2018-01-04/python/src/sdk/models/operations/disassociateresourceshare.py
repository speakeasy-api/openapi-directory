...
class DisassociateResourceShareRequest:
    headers: DisassociateResourceShareHeaders = dataclasses.field()
    request: DisassociateResourceShareRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
