...
export declare class PutOrganisationsPartyIdBusinessNamesProductIdRequest extends SpeakeasyBase {
    /**
     * The API key.
     */
    apiKey: string;
...
export declare class PutOrganisationsPartyIdBusinessNamesProductIdResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
