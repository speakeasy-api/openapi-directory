...
public class ListServiceListServiceResponse {
    ...
    public openapisdk.models.shared.VerifyV2Service[] services;
    public ListServiceListServiceResponse withServices(openapisdk.models.shared.VerifyV2Service[] services) {
