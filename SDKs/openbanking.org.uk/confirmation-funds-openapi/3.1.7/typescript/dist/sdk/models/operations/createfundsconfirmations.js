...
exports.CreateFundsConfirmationsResponse = exports.CreateFundsConfirmationsRequest = exports.CreateFundsConfirmationsSecurity = void 0;
...
exports.CreateFundsConfirmationsSecurity = CreateFundsConfirmationsSecurity;
var CreateFundsConfirmationsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CreateFundsConfirmationsRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=application/json" }),
        __metadata("design:type", shared.OBFundsConfirmation1)
    ], CreateFundsConfirmationsRequest.prototype, "obFundsConfirmation1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], CreateFundsConfirmationsRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], CreateFundsConfirmationsRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], CreateFundsConfirmationsRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], CreateFundsConfirmationsRequest.prototype, "xFapiInteractionId", void 0);
    return CreateFundsConfirmationsRequest;
}(utils_1.SpeakeasyBase));
exports.CreateFundsConfirmationsRequest = CreateFundsConfirmationsRequest;
var CreateFundsConfirmationsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreateFundsConfirmationsResponse.prototype, "rawResponse", void 0);
    return CreateFundsConfirmationsResponse;
}(utils_1.SpeakeasyBase));
exports.CreateFundsConfirmationsResponse = CreateFundsConfirmationsResponse;
