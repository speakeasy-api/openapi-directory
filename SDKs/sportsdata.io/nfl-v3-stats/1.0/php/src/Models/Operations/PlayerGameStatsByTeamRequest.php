...
class PlayerGameStatsByTeamRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\PlayerGameStatsByTeamFormatEnum $format
     */
	...
	{
		$this->format = \OpenAPI\OpenAPI\Models\Operations\PlayerGameStatsByTeamFormatEnum::XML;
		$this->season = "";
		$this->team = "";
		$this->week = "";
	}
