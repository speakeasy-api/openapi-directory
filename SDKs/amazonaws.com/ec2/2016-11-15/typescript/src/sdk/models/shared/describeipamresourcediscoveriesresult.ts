 ...
 */
export class DescribeIpamResourceDiscoveriesResultIpamResourceDiscoveriesOperatingRegions extends SpeakeasyBase {
  @SpeakeasyMetadata()
  regionName?: string;
}
 ...
 */
export enum DescribeIpamResourceDiscoveriesResultIpamResourceDiscoveriesStateEnum {
 ...
 * Describes a tag.
 */
export class DescribeIpamResourceDiscoveriesResultIpamResourceDiscoveriesTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class DescribeIpamResourceDiscoveriesResultIpamResourceDiscoveries extends SpeakeasyBase {
  @SpeakeasyMetadata()
  description?: string;
  ...
  @SpeakeasyMetadata({
    elemType: DescribeIpamResourceDiscoveriesResultIpamResourceDiscoveriesTags,
  })
 ...
 * Success
 */
export class DescribeIpamResourceDiscoveriesResult extends SpeakeasyBase {
  @SpeakeasyMetadata({
    elemType: DescribeIpamResourceDiscoveriesResultIpamResourceDiscoveries,
  })
