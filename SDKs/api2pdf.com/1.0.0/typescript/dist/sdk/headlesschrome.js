...
exports.HeadlessChrome = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var HeadlessChrome = /** @class */ (function () {
    function HeadlessChrome(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    HeadlessChrome.prototype.chromeFromHtmlPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ChromeFromHtmlPostRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/chrome/html";
    ...
    **/
    HeadlessChrome.prototype.chromeFromUrlGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ChromeFromUrlGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/chrome/url";
        var client = this._securityClient;
     ...
     * **Authorization: YOUR-API-KEY**
    **/
    HeadlessChrome.prototype.chromeFromUrlPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.HeadlessChrome = HeadlessChrome;
