...
var Uninstallation = /** @class */ (function () {
     ...
     *
     */
    Uninstallation.prototype.deleteInstallation = function (config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.DeleteInstallationResponse({
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.deleteInstallation200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.DeleteInstallation200ApplicationJSON);
                    }
                    break;
            }
            return res;
