...
func (e UpdateLaunchProfileMemberRequestBodyPersonaEnum) ToPointer() *UpdateLaunchProfileMemberRequestBodyPersonaEnum {
	return &e
}
...
func (e *UpdateLaunchProfileMemberRequestBodyPersonaEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "USER":
		*e = UpdateLaunchProfileMemberRequestBodyPersonaEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateLaunchProfileMemberRequestBodyPersonaEnum: %v", v)
	}
}
...
type UpdateLaunchProfileMemberRequest struct {
	RequestBody   UpdateLaunchProfileMemberRequestBody `request:"mediaType=application/json"`
