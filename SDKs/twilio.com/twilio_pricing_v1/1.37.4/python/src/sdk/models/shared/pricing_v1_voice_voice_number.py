...
class PricingV1VoiceVoiceNumber:
    ...
    inbound_call_price: Optional[PricingV1VoiceVoiceNumberInboundCallPrice] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('inbound_call_price') }})
    ...
    outbound_call_price: Optional[PricingV1VoiceVoiceNumberOutboundCallPrice] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('outbound_call_price') }})
