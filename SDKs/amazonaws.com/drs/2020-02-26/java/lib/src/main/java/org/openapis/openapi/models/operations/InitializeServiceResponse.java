...
public class InitializeServiceResponse {
    ...
    public InitializeServiceResponse withInternalServerException(Object internalServerException) {
    ...
    public InitializeServiceResponse withThrottlingException(Object throttlingException) {
