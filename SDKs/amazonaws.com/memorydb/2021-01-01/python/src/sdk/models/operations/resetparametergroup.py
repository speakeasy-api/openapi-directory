...
class ResetParameterGroupRequest:
    ...
    reset_parameter_group_request: shared_resetparametergrouprequest.ResetParameterGroupRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
