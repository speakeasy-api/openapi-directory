...
exports.RequestRoleGroupsResponse = exports.RequestRoleGroupsRequest = void 0;
...
var RequestRoleGroupsRequest = /** @class */ (function (_super) {
    ...
    ], RequestRoleGroupsRequest.prototype, "xSdsAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], RequestRoleGroupsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], RequestRoleGroupsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], RequestRoleGroupsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=role_id",
        }),
        __metadata("design:type", Number)
    ], RequestRoleGroupsRequest.prototype, "roleId", void 0);
    return RequestRoleGroupsRequest;
}(utils_1.SpeakeasyBase));
exports.RequestRoleGroupsRequest = RequestRoleGroupsRequest;
var RequestRoleGroupsResponse = /** @class */ (function (_super) {
    ...
    ], RequestRoleGroupsResponse.prototype, "rawResponse", void 0);
    return RequestRoleGroupsResponse;
}(utils_1.SpeakeasyBase));
exports.RequestRoleGroupsResponse = RequestRoleGroupsResponse;
