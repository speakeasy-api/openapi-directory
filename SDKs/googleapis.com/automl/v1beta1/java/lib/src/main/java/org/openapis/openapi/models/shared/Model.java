...
public class Model {
    ...
    public Model withDatasetId(String datasetId) {
    ...
    public Model withDeploymentState(ModelDeploymentStateEnum deploymentState) {
    ...
    public Model withImageClassificationModelMetadata(ImageClassificationModelMetadata imageClassificationModelMetadata) {
    ...
    public Model withImageObjectDetectionModelMetadata(ImageObjectDetectionModelMetadata imageObjectDetectionModelMetadata) {
    ...
    public Model withTablesModelMetadata(TablesModelMetadata tablesModelMetadata) {
    ...
    public Model withTextClassificationModelMetadata(TextClassificationModelMetadata textClassificationModelMetadata) {
    ...
    public Model withTextExtractionModelMetadata(TextExtractionModelMetadata textExtractionModelMetadata) {
    ...
    public Model withTextSentimentModelMetadata(java.util.Map<String, Object> textSentimentModelMetadata) {
    ...
    public Model withTranslationModelMetadata(TranslationModelMetadata translationModelMetadata) {
    ...
    public Model withVideoClassificationModelMetadata(java.util.Map<String, Object> videoClassificationModelMetadata) {
    ...
    public Model withVideoObjectTrackingModelMetadata(java.util.Map<String, Object> videoObjectTrackingModelMetadata) {
