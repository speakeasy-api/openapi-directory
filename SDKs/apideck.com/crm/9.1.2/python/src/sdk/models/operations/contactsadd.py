...
from ..shared import createcontactresponse as shared_createcontactresponse
...
class ContactsAddRequest:
    ...
    contact_input: shared_contact.ContactInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class ContactsAddResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    create_contact_response: Optional[shared_createcontactresponse.CreateContactResponse] = dataclasses.field(default=None)
    r"""Contact created"""  
