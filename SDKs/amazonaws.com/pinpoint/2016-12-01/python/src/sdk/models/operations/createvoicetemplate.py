...
class CreateVoiceTemplateRequestBody:
    ...
    voice_template_request: CreateVoiceTemplateRequestBodyVoiceTemplateRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VoiceTemplateRequest') }})
    r"""Specifies the content and settings for a message template that can be used in messages that are sent through the voice channel."""  
...
class CreateVoiceTemplateRequest:
    ...
    request_body: CreateVoiceTemplateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
