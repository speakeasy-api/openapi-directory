...
class ProjectInSearch:
    ...
    price: Optional[ProjectInSearchPrice] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price'), 'exclude': lambda f: f is None }})  
    price_without_discount: Optional[ProjectInSearchPriceWithoutDiscount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_without_discount'), 'exclude': lambda f: f is None }})  
    ...
    search_result_reason: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('search_result_reason'), 'exclude': lambda f: f is None }})  
    ...
    word_count_analysis: Optional[ProjectInSearchWordCountAnalysis] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('word_count_analysis'), 'exclude': lambda f: f is None }})  
