...
export const ListDayServerList = ["https://bulkexports.twilio.com"] as const;
...
export class ListDayListDayResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.BulkexportsV1ExportDay })
  @Expose({ name: "days" })
  @Type(() => shared.BulkexportsV1ExportDay)
  days?: shared.BulkexportsV1ExportDay[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListDayListDayResponseMeta)
