...
func (e *GoogleCloudBillingBudgetsV1FilterCalendarPeriodEnum) UnmarshalJSON(data []byte) error {
	...
	case "QUARTER":
		fallthrough
	case "YEAR":
		*e = GoogleCloudBillingBudgetsV1FilterCalendarPeriodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudBillingBudgetsV1FilterCalendarPeriodEnum: %s", s)
	}
}
...
func (e *GoogleCloudBillingBudgetsV1FilterCreditTypesTreatmentEnum) UnmarshalJSON(data []byte) error {
	...
	case "INCLUDE_SPECIFIED_CREDITS":
		*e = GoogleCloudBillingBudgetsV1FilterCreditTypesTreatmentEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudBillingBudgetsV1FilterCreditTypesTreatmentEnum: %s", s)
	}
}
