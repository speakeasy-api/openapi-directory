...
type CreateFleetAdvisorCollectorHeaders struct {
...
type CreateFleetAdvisorCollectorRequest struct {
	Headers CreateFleetAdvisorCollectorHeaders
	Request shared.CreateFleetAdvisorCollectorRequest `request:"mediaType=application/json"`
}
