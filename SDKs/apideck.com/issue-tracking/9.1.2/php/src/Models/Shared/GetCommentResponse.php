...
class GetCommentResponse
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CollectionTicketComment')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\CollectionTicketComment();
		$this->operation = "";
		$this->resource = "";
		$this->service = "";
		$this->status = "";
