...
class DescribeReservedInstancesModificationsRequest:
    r"""Contains the parameters for DescribeReservedInstancesModifications."""
    
    filters: Optional[list[DescribeReservedInstancesModificationsRequestFilters]] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    reserved_instances_modification_ids: Optional[list[str]] = dataclasses.field(default=None)  
