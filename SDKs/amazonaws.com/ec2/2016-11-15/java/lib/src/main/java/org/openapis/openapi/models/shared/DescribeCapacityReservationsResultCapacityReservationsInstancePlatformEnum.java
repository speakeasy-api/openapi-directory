 ...
 */
public enum DescribeCapacityReservationsResultCapacityReservationsInstancePlatformEnum {
    ...
    private DescribeCapacityReservationsResultCapacityReservationsInstancePlatformEnum(String value) {
        this.value = value;
    }
}
