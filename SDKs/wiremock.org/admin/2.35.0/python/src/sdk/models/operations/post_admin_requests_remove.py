...
class PostAdminRequestsRemoveRequestBody:
    ...
    basic_auth_credentials: Optional[PostAdminRequestsRemoveRequestBodyBasicAuthCredentials] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('basicAuthCredentials'), 'exclude': lambda f: f is None }})
    r"""Pre-emptive basic auth credentials to match against"""  
