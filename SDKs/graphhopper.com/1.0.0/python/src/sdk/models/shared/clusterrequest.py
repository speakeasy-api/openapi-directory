...
class ClusterRequest:
    r"""Request object that contains the problem to be solved"""
    ...
    customers: Optional[list[shared_clustercustomer.ClusterCustomer]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('customers'), 'exclude': lambda f: f is None }})  
