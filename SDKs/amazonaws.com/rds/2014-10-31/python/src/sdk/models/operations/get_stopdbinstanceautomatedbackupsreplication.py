...
class GetStopDbInstanceAutomatedBackupsReplicationRequest:
    headers: GetStopDbInstanceAutomatedBackupsReplicationHeaders = dataclasses.field()
    query_params: GetStopDbInstanceAutomatedBackupsReplicationQueryParams = dataclasses.field()
