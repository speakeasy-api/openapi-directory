...
class EditEmbedPresetRequestBody:
    ...
    outro: Optional[EditEmbedPresetRequestBodyOutroEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('outro'), 'exclude': lambda f: f is None }})
    r"""Disable the outro."""  
...
class EditEmbedPresetRequest:
    ...
    request_body: Optional[EditEmbedPresetRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/vnd.vimeo.preset+json' }})  
