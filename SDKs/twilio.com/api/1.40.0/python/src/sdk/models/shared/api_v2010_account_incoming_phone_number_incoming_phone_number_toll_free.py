...
class APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree:
    ...
    address_requirements: Optional[shared_incoming_phone_number_toll_free_enum_address_requirement_enum.IncomingPhoneNumberTollFreeEnumAddressRequirementEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address_requirements'), 'exclude': lambda f: f is None }})  
    ...
    capabilities: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFreeCapabilities] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('capabilities'), 'exclude': lambda f: f is None }})
    r"""The set of Boolean properties that indicate whether a phone number can receive calls or messages.  Capabilities are  `Voice`, `SMS`, and `MMS` and each capability can be: `true` or `false`."""  
    ...
    emergency_address_status: Optional[shared_incoming_phone_number_toll_free_enum_emergency_address_status_enum.IncomingPhoneNumberTollFreeEnumEmergencyAddressStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('emergency_address_status'), 'exclude': lambda f: f is None }})  
    emergency_status: Optional[shared_incoming_phone_number_toll_free_enum_emergency_status_enum.IncomingPhoneNumberTollFreeEnumEmergencyStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('emergency_status'), 'exclude': lambda f: f is None }})  
    ...
    sms_fallback_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFreeSmsFallbackMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sms_fallback_method'), 'exclude': lambda f: f is None }})
    r"""The HTTP method we use to call `sms_fallback_url`. Can be: `GET` or `POST`."""  
    ...
    sms_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFreeSmsMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sms_method'), 'exclude': lambda f: f is None }})
    r"""The HTTP method we use to call `sms_url`. Can be: `GET` or `POST`."""  
    ...
    status_callback_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFreeStatusCallbackMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status_callback_method'), 'exclude': lambda f: f is None }})
    r"""The HTTP method we use to call `status_callback`. Can be: `GET` or `POST`."""  
    ...
    voice_fallback_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFreeVoiceFallbackMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('voice_fallback_method'), 'exclude': lambda f: f is None }})
    r"""The HTTP method we use to call `voice_fallback_url`. Can be: `GET` or `POST`."""  
    ...
    voice_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFreeVoiceMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('voice_method'), 'exclude': lambda f: f is None }})
    r"""The HTTP method we use to call `voice_url`. Can be: `GET` or `POST`."""  
    voice_receive_mode: Optional[shared_incoming_phone_number_toll_free_enum_voice_receive_mode_enum.IncomingPhoneNumberTollFreeEnumVoiceReceiveModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('voice_receive_mode'), 'exclude': lambda f: f is None }})  
