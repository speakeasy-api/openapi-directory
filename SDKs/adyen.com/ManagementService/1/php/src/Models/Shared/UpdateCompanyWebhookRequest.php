...
class UpdateCompanyWebhookRequest
{
     ...
     * * **json** 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UpdateCompanyWebhookRequestCommunicationFormatEnum $communicationFormat
     */
	#[\JMS\Serializer\Annotation\SerializedName('communicationFormat')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateCompanyWebhookRequestCommunicationFormatEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateCompanyWebhookRequestCommunicationFormatEnum $communicationFormat = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UpdateCompanyWebhookRequestFilterMerchantAccountTypeEnum $filterMerchantAccountType
     */
	#[\JMS\Serializer\Annotation\SerializedName('filterMerchantAccountType')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateCompanyWebhookRequestFilterMerchantAccountTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateCompanyWebhookRequestFilterMerchantAccountTypeEnum $filterMerchantAccountType = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UpdateCompanyWebhookRequestNetworkTypeEnum $networkType
     */
	#[\JMS\Serializer\Annotation\SerializedName('networkType')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateCompanyWebhookRequestNetworkTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateCompanyWebhookRequestNetworkTypeEnum $networkType = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UpdateCompanyWebhookRequestSslVersionEnum $sslVersion
     */
	#[\JMS\Serializer\Annotation\SerializedName('sslVersion')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateCompanyWebhookRequestSslVersionEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateCompanyWebhookRequestSslVersionEnum $sslVersion = null;
