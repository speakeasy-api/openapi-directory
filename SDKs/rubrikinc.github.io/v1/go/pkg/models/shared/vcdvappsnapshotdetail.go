...
type VcdVappSnapshotDetail struct {
	...
	ExcludedVcdVMMoids []string   `json:"excludedVcdVmMoids,omitempty"`
	...
	Networks []VappNetworkSummary `json:"networks"`
	...
	VMSnapshots []VcdVMSnapshotDetail `json:"vmSnapshots"`
}
