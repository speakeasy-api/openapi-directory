...
type InitiatePaymentJSONHeaders struct {
...
type InitiatePaymentApplicationJSONType string

const (
	InitiatePaymentApplicationJSONTypePaymentInitiationJSON         InitiatePaymentApplicationJSONType = "paymentInitiation_json"
	InitiatePaymentApplicationJSONTypePeriodicPaymentInitiationJSON InitiatePaymentApplicationJSONType = "periodicPaymentInitiation_json"
	InitiatePaymentApplicationJSONTypeBulkPaymentInitiationJSON     InitiatePaymentApplicationJSONType = "bulkPaymentInitiation_json"
)

type InitiatePaymentApplicationJSON struct {
	PaymentInitiationJSON         *shared.PaymentInitiationJSON
	PeriodicPaymentInitiationJSON *shared.PeriodicPaymentInitiationJSON
	BulkPaymentInitiationJSON     *shared.BulkPaymentInitiationJSON

	Type InitiatePaymentApplicationJSONType
}

func CreateInitiatePaymentApplicationJSONPaymentInitiationJSON(paymentInitiationJSON shared.PaymentInitiationJSON) InitiatePaymentApplicationJSON {
	typ := InitiatePaymentApplicationJSONTypePaymentInitiationJSON

	return InitiatePaymentApplicationJSON{
		PaymentInitiationJSON: &paymentInitiationJSON,
		Type:                  typ,
	}
}

func CreateInitiatePaymentApplicationJSONPeriodicPaymentInitiationJSON(periodicPaymentInitiationJSON shared.PeriodicPaymentInitiationJSON) InitiatePaymentApplicationJSON {
	typ := InitiatePaymentApplicationJSONTypePeriodicPaymentInitiationJSON
...
func CreateInitiatePaymentApplicationJSONBulkPaymentInitiationJSON(bulkPaymentInitiationJSON shared.BulkPaymentInitiationJSON) InitiatePaymentApplicationJSON {
	typ := InitiatePaymentApplicationJSONTypeBulkPaymentInitiationJSON
...
func (u *InitiatePaymentApplicationJSON) UnmarshalJSON(data []byte) error {
	var d *json.Decoder

	paymentInitiationJSON := new(shared.PaymentInitiationJSON)
	d = json.NewDecoder(bytes.NewReader(data))
	d.DisallowUnknownFields()
	if err := d.Decode(&paymentInitiationJSON); err == nil {
		u.PaymentInitiationJSON = paymentInitiationJSON
		u.Type = InitiatePaymentApplicationJSONTypePaymentInitiationJSON
		return nil
	}

	periodicPaymentInitiationJSON := new(shared.PeriodicPaymentInitiationJSON)
	d = json.NewDecoder(bytes.NewReader(data))
	d.DisallowUnknownFields()
	if err := d.Decode(&periodicPaymentInitiationJSON); err == nil {
		u.PeriodicPaymentInitiationJSON = periodicPaymentInitiationJSON
		u.Type = InitiatePaymentApplicationJSONTypePeriodicPaymentInitiationJSON
		return nil
	}

	bulkPaymentInitiationJSON := new(shared.BulkPaymentInitiationJSON)
	d = json.NewDecoder(bytes.NewReader(data))
	d.DisallowUnknownFields()
	if err := d.Decode(&bulkPaymentInitiationJSON); err == nil {
		u.BulkPaymentInitiationJSON = bulkPaymentInitiationJSON
		u.Type = InitiatePaymentApplicationJSONTypeBulkPaymentInitiationJSON
		return nil
	}
...
func (u InitiatePaymentApplicationJSON) MarshalJSON() ([]byte, error) {
	if u.PaymentInitiationJSON != nil {
		return json.Marshal(u.PaymentInitiationJSON)
	}

	if u.PeriodicPaymentInitiationJSON != nil {
		return json.Marshal(u.PeriodicPaymentInitiationJSON)
	}

	if u.BulkPaymentInitiationJSON != nil {
		return json.Marshal(u.BulkPaymentInitiationJSON)
	}

	return nil, nil
}

type InitiatePaymentJSONRequest struct {
	PathParams InitiatePaymentJSONPathParams
	Headers    InitiatePaymentJSONHeaders
	...
	//
	Request  InitiatePaymentApplicationJSON `request:"mediaType=application/json"`
	Security InitiatePaymentJSONSecurity
}

type InitiatePaymentJSONResponse struct {
	ContentType string
	// Bad Request
