...
import { UserGroupResolutionModeEnum } from "./usergroupresolutionmodeenum";
 ...
 */
export class UserGroupResolutionConfiguration extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "UserGroupResolutionMode" })
  userGroupResolutionMode: UserGroupResolutionModeEnum;
}
