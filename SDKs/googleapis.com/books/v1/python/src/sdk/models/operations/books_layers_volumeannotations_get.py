...
class BooksLayersVolumeAnnotationsGetRequest:
    path_params: BooksLayersVolumeAnnotationsGetPathParams = dataclasses.field()
    query_params: BooksLayersVolumeAnnotationsGetQueryParams = dataclasses.field()
    security: BooksLayersVolumeAnnotationsGetSecurity = dataclasses.field()
...
class BooksLayersVolumeAnnotationsGetResponse:
    ...
    volumeannotation: Optional[shared_volumeannotation.Volumeannotation] = dataclasses.field(default=None)
