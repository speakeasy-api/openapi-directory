...
class DeleteReplicationJobRequest:
    ...
    delete_replication_job_request: shared_deletereplicationjobrequest.DeleteReplicationJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
