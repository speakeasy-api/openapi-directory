...
export class ReleasesGetLatestPrivateReleaseSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ReleasesGetLatestPrivateReleaseRequest extends SpeakeasyBase {
  /**
...
export enum ReleasesGetLatestPrivateRelease404ApplicationJSONCodeEnum {
 ...
 *
 */
export class ReleasesGetLatestPrivateRelease404ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
 ...
 */
export class ReleasesGetLatestPrivateRelease200ApplicationJSONBuild extends SpeakeasyBase {
  /**
 ...
 *
 */
export enum ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationTypeEnum {
  Group = "group",
  Store = "store",
  Tester = "tester",
}
 ...
 */
export enum ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationsDestinationTypeEnum {
  Group = "group",
  Store = "store",
  Tester = "tester",
}
 ...
 */
export enum ReleasesGetLatestPrivateRelease200ApplicationJSONDestinationsTypeEnum {
  Intune = "intune",
 ...
 */
export class ReleasesGetLatestPrivateRelease200ApplicationJSONDestinations extends SpeakeasyBase {
  /**
   * Destination can be either store or group.
   */
  @SpeakeasyMetadata()
...
export class ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionGroups extends SpeakeasyBase {
  /**
 ...
 * type of the distribution store currently stores type can be intune, googleplay or windows.
 */
export enum ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionStoresTypeEnum {
  Intune = "intune",
  Googleplay = "googleplay",
  Apple = "apple",
  None = "none",
...
export class ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionStores extends SpeakeasyBase {
  /**
   * ID identifying a unique distribution store.
   */
  @SpeakeasyMetadata()
 ...
 */
export enum ReleasesGetLatestPrivateRelease200ApplicationJSONOriginEnum {
  Hockeyapp = "hockeyapp",
  Appcenter = "appcenter",
}
 ...
 */
export enum ReleasesGetLatestPrivateRelease200ApplicationJSONProvisioningProfileTypeEnum {
  Adhoc = "adhoc",
 ...
 */
export class ReleasesGetLatestPrivateRelease200ApplicationJSON extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "build" })
  @Type(() => ReleasesGetLatestPrivateRelease200ApplicationJSONBuild)
  ...
  @Type(() => ReleasesGetLatestPrivateRelease200ApplicationJSONDestinations)
  ...
  @SpeakeasyMetadata({
    elemType:
      ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionGroups,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      ReleasesGetLatestPrivateRelease200ApplicationJSONDistributionStores,
  })
...
export class ReleasesGetLatestPrivateReleaseResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
