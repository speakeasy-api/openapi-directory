...
class AndroidpublisherReviewsListQueryParams:
    ...
    translation_language: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'translationLanguage', 'style': 'form', 'explode': True }})
...
class AndroidpublisherReviewsListRequest:
    path_params: AndroidpublisherReviewsListPathParams = dataclasses.field()
    query_params: AndroidpublisherReviewsListQueryParams = dataclasses.field()
    security: AndroidpublisherReviewsListSecurity = dataclasses.field()
