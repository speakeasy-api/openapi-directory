...
public class LinksDisableRuleLink {
    ...
    public LinksDisableRuleLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksDisableRuleLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksDisableRuleLink withDescription(String description) {
    ...
    public LinksDisableRuleLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksDisableRuleLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksDisableRuleLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksDisableRuleLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksDisableRuleLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksDisableRuleLink withOperationId(String operationId) {
    ...
    public LinksDisableRuleLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksDisableRuleLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksDisableRuleLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
