...
class PutConfigurationSetTrackingOptionsRequestBody:
    ...
    r"""The domain that you want to use for tracking open and click events."""  
...
class PutConfigurationSetTrackingOptionsRequest:
    ...
    r"""The name of the configuration set that you want to add a custom tracking domain to."""  
