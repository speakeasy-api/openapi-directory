 ...
 */
export enum CalculateRatesResponseBodyDeliveryConfirmationEnum {
  None = "none",
  Delivery = "delivery",
  Signature = "signature",
 ...
 */
export enum CalculateRatesResponseBodyInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export enum CalculateRatesResponseBodyInternationalShipmentOptionsNonDeliveryEnum {
 ...
 */
export enum CalculateRatesResponseBodyInsuranceProviderEnum {
  None = "none",
 ...
 */
export enum CalculateRatesResponseBodyOriginTypeEnum {
  Pickup = "pickup",
  DropOff = "drop_off",
}
 ...
 */
export enum CalculateRatesResponseBodyShipmentStatusEnum {
  Pending = "pending",
...
export class CalculateRatesResponseBody extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "customs" })
  @Type(() => CalculateRatesResponseBodyInternationalShipmentOptions)
  ...
  @Type(() => CalculateRatesResponseBodyWeight)
