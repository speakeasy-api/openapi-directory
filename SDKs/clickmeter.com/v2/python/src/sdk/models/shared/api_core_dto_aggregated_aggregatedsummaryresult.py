...
class APICoreDtoAggregatedAggregatedSummaryResult:
    ...
    result: Optional[list[shared_api_core_dto_aggregated_aggregatedresult.APICoreDtoAggregatedAggregatedResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})  
