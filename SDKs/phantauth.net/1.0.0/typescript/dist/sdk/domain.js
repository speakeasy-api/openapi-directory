...
var Domain = /** @class */ (function () {
    ...
    Domain.prototype.getDomainDomainname = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/domain/{domainname}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetDomainDomainnameResponse({
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getDomainDomainname200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetDomainDomainname200ApplicationJSON);
                    }
                    break;
            }
            return res;
