...
public class ListUserChannelListUserChannelResponse {
    ...
    public openapisdk.models.shared.IpMessagingV1ServiceUserUserChannel[] channels;
    public ListUserChannelListUserChannelResponse withChannels(openapisdk.models.shared.IpMessagingV1ServiceUserUserChannel[] channels) {
