...
from ..shared import accountupdaterequest as shared_accountupdaterequest
...
class UpdateAccountRequest:
    ...
    account_update_request: shared_accountupdaterequest.AccountUpdateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
