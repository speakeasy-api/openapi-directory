...
exports.GetObservationsByCodesResponse = exports.GetObservationsByCodesRequest = void 0;
...
var GetObservationsByCodesRequest = /** @class */ (function (_super) {
    ...
    ], GetObservationsByCodesRequest.prototype, "code", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetObservationsByCodesRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], GetObservationsByCodesRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=orderDirection",
        }),
        __metadata("design:type", String)
    ], GetObservationsByCodesRequest.prototype, "orderDirection", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=userId",
        }),
        __metadata("design:type", Number)
    ], GetObservationsByCodesRequest.prototype, "userId", void 0);
    return GetObservationsByCodesRequest;
}(utils_1.SpeakeasyBase));
exports.GetObservationsByCodesRequest = GetObservationsByCodesRequest;
var GetObservationsByCodesResponse = /** @class */ (function (_super) {
    ...
    ], GetObservationsByCodesResponse.prototype, "rawResponse", void 0);
    return GetObservationsByCodesResponse;
}(utils_1.SpeakeasyBase));
exports.GetObservationsByCodesResponse = GetObservationsByCodesResponse;
