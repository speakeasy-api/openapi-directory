...
from ..shared import snsactionencoding_enum as shared_snsactionencoding_enum
...
class SnsAction:
    ...
    encoding: Optional[shared_snsactionencoding_enum.SnsActionEncodingEnum] = dataclasses.field(default=None)
