...
public class GetMeTagsTagsTopQuestionsQueryParams {
    /**
    ...
    public GetMeTagsTagsTopQuestionsQueryParams withCallback(String callback) {
    ...
    public GetMeTagsTagsTopQuestionsQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeTagsTagsTopQuestionsQueryParams withFromdate(Long fromdate) {
    ...
    public String max;
    public GetMeTagsTagsTopQuestionsQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetMeTagsTagsTopQuestionsQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetMeTagsTagsTopQuestionsOrderEnum order;
    public GetMeTagsTagsTopQuestionsQueryParams withOrder(GetMeTagsTagsTopQuestionsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetMeTagsTagsTopQuestionsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeTagsTagsTopQuestionsQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetMeTagsTagsTopQuestionsQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetMeTagsTagsTopQuestionsSortEnum sort;
    public GetMeTagsTagsTopQuestionsQueryParams withSort(GetMeTagsTagsTopQuestionsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetMeTagsTagsTopQuestionsQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
