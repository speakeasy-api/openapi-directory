...
type RestoreEventDataStoreHeaders struct {
...
type RestoreEventDataStoreRequest struct {
	Headers RestoreEventDataStoreHeaders
	Request shared.RestoreEventDataStoreRequest `request:"mediaType=application/json"`
}
