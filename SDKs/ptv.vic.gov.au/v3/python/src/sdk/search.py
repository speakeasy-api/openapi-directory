...
class Search:
    ...
    def search_search(self, request: operations.SearchSearchRequest) -> operations.SearchSearchResponse:
        ...
        url = utils.generate_url(operations.SearchSearchRequest, base_url, '/v3/search/{search_term}', request)
        
        query_params = utils.get_query_params(operations.SearchSearchRequest, request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.V3SearchResult])
