...
export class AdminCustomersChromePrintersListPrinterModelsSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdminCustomersChromePrintersListPrinterModelsSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class AdminCustomersChromePrintersListPrinterModelsSecurity extends SpeakeasyBase {
...
export class AdminCustomersChromePrintersListPrinterModelsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdminCustomersChromePrintersListPrinterModelsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
