...
func (e PostSpacesIDPersonsPersonIDPortfoliosRequestBodyLevelEnum) ToPointer() *PostSpacesIDPersonsPersonIDPortfoliosRequestBodyLevelEnum {
	return &e
}
...
func (e *PostSpacesIDPersonsPersonIDPortfoliosRequestBodyLevelEnum) UnmarshalJSON(data []byte) error {
	...
	case "regular":
		fallthrough
	case "public":
		*e = PostSpacesIDPersonsPersonIDPortfoliosRequestBodyLevelEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostSpacesIDPersonsPersonIDPortfoliosRequestBodyLevelEnum: %v", v)
	}
}
