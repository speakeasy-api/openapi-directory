...
var CreatePrivateVirtualInterfaceRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "newPrivateVirtualInterface" }),
        (0, class_transformer_1.Type)(function () { return newprivatevirtualinterface_1.NewPrivateVirtualInterface; }),
