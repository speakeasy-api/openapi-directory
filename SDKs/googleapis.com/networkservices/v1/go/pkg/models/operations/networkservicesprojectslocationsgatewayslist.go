...
type NetworkservicesProjectsLocationsGatewaysListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type NetworkservicesProjectsLocationsGatewaysListPathParams struct {
...
type NetworkservicesProjectsLocationsGatewaysListQueryParams struct {
	// V1 error format.
...
type NetworkservicesProjectsLocationsGatewaysListRequest struct {
...
type NetworkservicesProjectsLocationsGatewaysListResponse struct {
	ContentType string
	// Successful response
