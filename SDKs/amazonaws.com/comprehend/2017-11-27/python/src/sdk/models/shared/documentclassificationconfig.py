...
class DocumentClassificationConfig:
    r"""Configuration required for a custom classification model."""
    
    mode: shared_documentclassifiermode_enum.DocumentClassifierModeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Mode') }})  
