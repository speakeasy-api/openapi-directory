...
class StatusUpdateRequestStatusTypeEnum(str, Enum):
...
class StatusUpdateRequestInput:
    ...
    status_type: StatusUpdateRequestStatusTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status_type') }})
    r"""The type associated with the status update. This represents the current state of the object this object is on."""  
