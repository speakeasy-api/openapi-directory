...
exports.AuthenticationExecutionInfoRepresentation = void 0;
...
var AuthenticationExecutionInfoRepresentation = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "authenticationFlow" }),
        __metadata("design:type", Boolean)
    ], AuthenticationExecutionInfoRepresentation.prototype, "authenticationFlow", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "configurable" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "flowId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "requirement" }),
        __metadata("design:type", String)
    ], AuthenticationExecutionInfoRepresentation.prototype, "requirement", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "requirementChoices" }),
...
exports.AuthenticationExecutionInfoRepresentation = AuthenticationExecutionInfoRepresentation;
