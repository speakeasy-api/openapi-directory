...
type DrivelabelsLabelsDeltaRequest struct {
	...
	GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequestInput *shared.GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequestInput `request:"mediaType=application/json"`
	// OAuth access token.
