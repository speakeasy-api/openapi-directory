...
export class CloudidentityGroupsMembershipsGetMembershipGraphSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudidentityGroupsMembershipsGetMembershipGraphSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudidentityGroupsMembershipsGetMembershipGraphSecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudidentityGroupsMembershipsGetMembershipGraphSecurity extends SpeakeasyBase {
...
export class CloudidentityGroupsMembershipsGetMembershipGraphRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudidentityGroupsMembershipsGetMembershipGraphResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
