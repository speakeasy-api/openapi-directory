...
public class CreateNetworkWirelessRfProfileRequestBody {
    ...
    public CreateNetworkWirelessRfProfileRequestBody(@JsonProperty("bandSelectionType") CreateNetworkWirelessRfProfileRequestBodyBandSelectionTypeEnum bandSelectionType, @JsonProperty("name") String name) {
        this.bandSelectionType = bandSelectionType;
        this.name = name;
  }
}
