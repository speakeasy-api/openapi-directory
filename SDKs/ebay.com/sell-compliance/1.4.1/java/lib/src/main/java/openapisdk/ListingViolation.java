...
public class ListingViolation {
    ...
    **/
    public openapisdk.models.operations.GetListingViolationsResponse getListingViolations(openapisdk.models.operations.GetListingViolationsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/listing_violation");
        ...
        openapisdk.models.operations.GetListingViolationsResponse res = new openapisdk.models.operations.GetListingViolationsResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json;charset=UTF-8")) {
                ...
                openapisdk.models.shared.PagedComplianceViolationCollection out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.PagedComplianceViolationCollection.class);
    ...
    **/
    public openapisdk.models.operations.SuppressViolationResponse suppressViolation(openapisdk.models.operations.SuppressViolationRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/suppress_listing_violation");
        ...
        openapisdk.models.operations.SuppressViolationResponse res = new openapisdk.models.operations.SuppressViolationResponse() {{
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
