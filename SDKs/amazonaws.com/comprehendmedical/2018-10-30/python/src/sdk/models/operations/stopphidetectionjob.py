...
class StopPHIDetectionJobRequest:
    ...
    stop_phi_detection_job_request: shared_stopphidetectionjobrequest.StopPHIDetectionJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
