...
from ..shared import deletetimeoffrequestresponse as shared_deletetimeoffrequestresponse
...
@dataclasses.dataclass
class TimeOffRequestsDeleteSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class TimeOffRequestsDeleteRequest:
    headers: TimeOffRequestsDeleteHeaders = dataclasses.field()
    path_params: TimeOffRequestsDeletePathParams = dataclasses.field()
    query_params: TimeOffRequestsDeleteQueryParams = dataclasses.field()
    security: TimeOffRequestsDeleteSecurity = dataclasses.field()
    

@dataclasses.dataclass
class TimeOffRequestsDeleteResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    delete_time_off_request_response: Optional[shared_deletetimeoffrequestresponse.DeleteTimeOffRequestResponse] = dataclasses.field(default=None)
