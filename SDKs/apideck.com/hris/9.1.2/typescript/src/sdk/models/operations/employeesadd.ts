...
export class EmployeesAddSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class EmployeesAddRequest extends SpeakeasyBase {
...
export class EmployeesAddResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
