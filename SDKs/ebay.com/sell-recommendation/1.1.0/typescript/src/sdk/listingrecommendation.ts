...
export class ListingRecommendation {
  ...
  findListingRecommendations(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.FindListingRecommendationsResponse =
        new operations.FindListingRecommendationsResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.pagedListingRecommendationCollection = utils.objectToClass(
              httpRes?.data,
              shared.PagedListingRecommendationCollection
            );
          }
          break;
