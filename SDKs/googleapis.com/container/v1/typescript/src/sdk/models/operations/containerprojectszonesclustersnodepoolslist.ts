...
export class ContainerProjectsZonesClustersNodePoolsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContainerProjectsZonesClustersNodePoolsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsZonesClustersNodePoolsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
