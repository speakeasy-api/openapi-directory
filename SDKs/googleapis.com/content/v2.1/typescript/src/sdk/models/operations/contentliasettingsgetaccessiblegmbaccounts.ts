...
export class ContentLiasettingsGetaccessiblegmbaccountsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentLiasettingsGetaccessiblegmbaccountsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentLiasettingsGetaccessiblegmbaccountsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
