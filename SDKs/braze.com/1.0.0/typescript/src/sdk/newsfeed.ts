...
export class NewsFeed {
  ...
  newsFeedCardAnalytics(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.NewsFeedCardAnalyticsResponse =
        new operations.NewsFeedCardAnalyticsResponse({
  ...
  newsFeedCardsDetails(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.NewsFeedCardsDetailsResponse =
        new operations.NewsFeedCardsDetailsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  newsFeedCardsList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.NewsFeedCardsListResponse =
        new operations.NewsFeedCardsListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
