...
class GetOrganizationConfigurationChangesRequest:
    ...
    r"""The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 365 days. The default is 365 days."""  
...
class GetOrganizationConfigurationChangesResponse:
    ...
    get_organization_configuration_changes_200_application_json_objects: Optional[list[dict[str, Any]]] = dataclasses.field(default=None)
