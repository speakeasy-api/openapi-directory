...
import { ForwardingRulesScopedList } from "./forwardingrulesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum ForwardingRuleAggregatedListWarningCodeEnum {
...
export declare class ForwardingRuleAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ForwardingRuleAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: ForwardingRuleAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: ForwardingRuleAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class ForwardingRuleAggregatedList extends SpeakeasyBase {
    /**
