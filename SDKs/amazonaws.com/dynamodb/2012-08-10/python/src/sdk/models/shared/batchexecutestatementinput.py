...
import dataclasses
from ..shared import batchstatementrequest as shared_batchstatementrequest
...
class BatchExecuteStatementInput:
    ...
    statements: list[shared_batchstatementrequest.BatchStatementRequest] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Statements') }})  
