...
class BooksMylibraryBookshelvesRemoveVolumeRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\BooksMylibraryBookshelvesRemoveVolumeReasonEnum $reason
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=reason')]
    public ?BooksMylibraryBookshelvesRemoveVolumeReasonEnum $reason = null;
