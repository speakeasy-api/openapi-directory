...
func (e DeleteModelPackageGroupXAmzTargetEnum) ToPointer() *DeleteModelPackageGroupXAmzTargetEnum {
	return &e
}
...
func (e *DeleteModelPackageGroupXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "SageMaker.DeleteModelPackageGroup":
		*e = DeleteModelPackageGroupXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DeleteModelPackageGroupXAmzTargetEnum: %v", v)
	}
}
