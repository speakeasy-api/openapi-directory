...
public class UpdateTenantWebhookHeaders {
    /**
    ...
    public UpdateTenantWebhookHeaders withXSdsDateFormat(UpdateTenantWebhookXSdsDateFormatEnum xSdsDateFormat) {
    ...
    public UpdateTenantWebhookHeaders withXSdsServiceToken(String xSdsServiceToken) {
