...
from ..shared import updatetaxrateresponse as shared_updatetaxrateresponse
...
class TaxRatesUpdateRequest:
    ...
    tax_rate_input: shared_taxrate.TaxRateInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class TaxRatesUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_tax_rate_response: Optional[shared_updatetaxrateresponse.UpdateTaxRateResponse] = dataclasses.field(default=None)
    r"""TaxRate updated"""  
