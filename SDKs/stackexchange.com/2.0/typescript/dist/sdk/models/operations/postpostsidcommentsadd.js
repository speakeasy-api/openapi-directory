...
exports.PostPostsIdCommentsAddResponse = exports.PostPostsIdCommentsAddRequest = void 0;
...
var PostPostsIdCommentsAddRequest = /** @class */ (function (_super) {
    ...
    ], PostPostsIdCommentsAddRequest.prototype, "body", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=callback",
        }),
        __metadata("design:type", String)
    ], PostPostsIdCommentsAddRequest.prototype, "callback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], PostPostsIdCommentsAddRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PostPostsIdCommentsAddRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=preview",
        }),
        __metadata("design:type", Boolean)
    ], PostPostsIdCommentsAddRequest.prototype, "preview", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=site" }),
        __metadata("design:type", String)
    ], PostPostsIdCommentsAddRequest.prototype, "site", void 0);
...
var PostPostsIdCommentsAddResponse = /** @class */ (function (_super) {
    ...
    ], PostPostsIdCommentsAddResponse.prototype, "rawResponse", void 0);
