...
export class BaremetalsolutionProjectsLocationsVolumesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BaremetalsolutionProjectsLocationsVolumesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BaremetalsolutionProjectsLocationsVolumesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
