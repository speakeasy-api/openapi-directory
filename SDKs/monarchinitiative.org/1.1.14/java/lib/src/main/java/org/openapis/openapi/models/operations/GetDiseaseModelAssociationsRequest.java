...
public class GetDiseaseModelAssociationsRequest {
    ...
    public GetDiseaseModelAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetDiseaseModelAssociationsRequest withEvidence(String evidence) {
    ...
    public GetDiseaseModelAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetDiseaseModelAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetDiseaseModelAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetDiseaseModelAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsRequest withRelation(String relation) {
    ...
    public GetDiseaseModelAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetDiseaseModelAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetDiseaseModelAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
