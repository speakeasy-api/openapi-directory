...
class Service:
    ...
    pipeline: Optional[shared_servicepipeline.ServicePipeline] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pipeline') }})
