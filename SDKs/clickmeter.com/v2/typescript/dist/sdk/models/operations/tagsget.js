...
exports.TagsGetResponse = exports.TagsGetRequest = exports.TagsGetTypeEnum = void 0;
...
})(TagsGetTypeEnum = exports.TagsGetTypeEnum || (exports.TagsGetTypeEnum = {}));
var TagsGetRequest = /** @class */ (function (_super) {
    ...
    ], TagsGetRequest.prototype, "datapoints", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=groups",
        }),
        __metadata("design:type", String)
    ], TagsGetRequest.prototype, "groups", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], TagsGetRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], TagsGetRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], TagsGetRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=type" }),
        __metadata("design:type", String)
    ], TagsGetRequest.prototype, "type", void 0);
    return TagsGetRequest;
}(utils_1.SpeakeasyBase));
exports.TagsGetRequest = TagsGetRequest;
var TagsGetResponse = /** @class */ (function (_super) {
    ...
    ], TagsGetResponse.prototype, "rawResponse", void 0);
    return TagsGetResponse;
}(utils_1.SpeakeasyBase));
exports.TagsGetResponse = TagsGetResponse;
