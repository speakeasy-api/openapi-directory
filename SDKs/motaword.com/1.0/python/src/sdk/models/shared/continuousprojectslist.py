...
class ContinuousProjectsList:
    ...
    projects: Optional[list[shared_continuousproject.ContinuousProject]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('projects') }})
