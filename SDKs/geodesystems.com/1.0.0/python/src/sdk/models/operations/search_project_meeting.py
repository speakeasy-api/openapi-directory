...
class SearchProjectMeetingQueryParams:
    ...
    search_project_meeting_location: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_meeting.location', 'style': 'form', 'explode': True }})
    search_project_meeting_participants: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_meeting.participants', 'style': 'form', 'explode': True }})
    search_project_meeting_topic: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_meeting.topic', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchProjectMeetingRequest:
    query_params: SearchProjectMeetingQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectMeetingResponse:
