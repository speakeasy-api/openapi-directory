...
class DeleteTransitGatewayPrefixListReferenceResultTransitGatewayPrefixListReferenceStateEnum(str, Enum):
...
class DeleteTransitGatewayPrefixListReferenceResultTransitGatewayPrefixListReferenceTransitGatewayAttachmentResourceTypeEnum(str, Enum):
...
class DeleteTransitGatewayPrefixListReferenceResultTransitGatewayPrefixListReferenceTransitGatewayAttachment:
    ...
    resource_type: Optional[DeleteTransitGatewayPrefixListReferenceResultTransitGatewayPrefixListReferenceTransitGatewayAttachmentResourceTypeEnum] = dataclasses.field(default=None)  
...
class DeleteTransitGatewayPrefixListReferenceResultTransitGatewayPrefixListReference:
    r"""Information about the deleted prefix list reference."""
    ...
    state: Optional[DeleteTransitGatewayPrefixListReferenceResultTransitGatewayPrefixListReferenceStateEnum] = dataclasses.field(default=None)  
