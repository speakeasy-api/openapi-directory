...
public class LinksGetOrderLink {
    ...
    public LinksGetOrderLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksGetOrderLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksGetOrderLink withDescription(String description) {
    ...
    public LinksGetOrderLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksGetOrderLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksGetOrderLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksGetOrderLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksGetOrderLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksGetOrderLink withOperationId(String operationId) {
    ...
    public LinksGetOrderLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksGetOrderLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksGetOrderLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
