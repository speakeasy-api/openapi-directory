...
public class DataFlow {
    ...
    /**
	 * POST_V05_HEALTH_INFORMATION_HIU_ON_REQUEST_JSON_SERVERS contains the list of server urls available to the SDK.
	 */
    public static final String[] POST_V05_HEALTH_INFORMATION_HIU_ON_REQUEST_JSON_SERVERS = {
        "https://dev.ndhm.gov.in/hiu",
    };
	
    /**
	 * POST_V05_HEALTH_INFORMATION_HIU_ON_REQUEST_RAW_SERVERS contains the list of server urls available to the SDK.
	 */
    public static final String[] POST_V05_HEALTH_INFORMATION_HIU_ON_REQUEST_RAW_SERVERS = {
        "https://dev.ndhm.gov.in/hiu",
    };
     ...
     */
    public org.openapis.openapi.models.operations.PostV05HealthInformationHiuOnRequestJsonResponse postV05HealthInformationHiuOnRequestJson(org.openapis.openapi.models.operations.PostV05HealthInformationHiuOnRequestJsonRequest request) throws Exception {
        return this.postV05HealthInformationHiuOnRequestJson(request, null);
    }
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.PostV05HealthInformationHiuOnRequestJsonResponse postV05HealthInformationHiuOnRequestJson(org.openapis.openapi.models.operations.PostV05HealthInformationHiuOnRequestJsonRequest request, String serverURL) throws Exception {
        String baseUrl = POST_V05_HEALTH_INFORMATION_HIU_ON_REQUEST_JSON_SERVERS[0];
        if (serverURL != null && !serverURL.isBlank()) {
            baseUrl = serverURL;
        }
        
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/v0.5/health-information/hiu/on-request");
        ...
        org.openapis.openapi.models.operations.PostV05HealthInformationHiuOnRequestJsonResponse res = new org.openapis.openapi.models.operations.PostV05HealthInformationHiuOnRequestJsonResponse(contentType, httpRes.statusCode()) {{
            errorResponse = null;
            body = null;
        }};
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.PostV05HealthInformationHiuOnRequestRawResponse postV05HealthInformationHiuOnRequestRaw(org.openapis.openapi.models.operations.PostV05HealthInformationHiuOnRequestRawRequest request) throws Exception {
        return this.postV05HealthInformationHiuOnRequestRaw(request, null);
    }
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.PostV05HealthInformationHiuOnRequestRawResponse postV05HealthInformationHiuOnRequestRaw(org.openapis.openapi.models.operations.PostV05HealthInformationHiuOnRequestRawRequest request, String serverURL) throws Exception {
        String baseUrl = POST_V05_HEALTH_INFORMATION_HIU_ON_REQUEST_RAW_SERVERS[0];
        if (serverURL != null && !serverURL.isBlank()) {
            baseUrl = serverURL;
        }
        ...
        org.openapis.openapi.models.operations.PostV05HealthInformationHiuOnRequestRawResponse res = new org.openapis.openapi.models.operations.PostV05HealthInformationHiuOnRequestRawResponse(contentType, httpRes.statusCode()) {{
            errorResponse = null;
            body = null;
        }};
        res.rawResponse = httpRes;
