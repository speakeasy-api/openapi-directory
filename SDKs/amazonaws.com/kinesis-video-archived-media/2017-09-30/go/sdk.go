...
func (s *SDK) GetClip(ctx context.Context, request operations.GetClipRequest) (*operations.GetClipResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/getClip"
	...
	res := &operations.GetClipResponse{
...
func (s *SDK) GetDashStreamingSessionURL(ctx context.Context, request operations.GetDashStreamingSessionURLRequest) (*operations.GetDashStreamingSessionURLResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/getDASHStreamingSessionURL"
	...
	res := &operations.GetDashStreamingSessionURLResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetDashStreamingSessionURLOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetHlsStreamingSessionURL(ctx context.Context, request operations.GetHlsStreamingSessionURLRequest) (*operations.GetHlsStreamingSessionURLResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/getHLSStreamingSessionURL"
	...
	res := &operations.GetHlsStreamingSessionURLResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetHlsStreamingSessionURLOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetMediaForFragmentList(ctx context.Context, request operations.GetMediaForFragmentListRequest) (*operations.GetMediaForFragmentListResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/getMediaForFragmentList"
	...
	res := &operations.GetMediaForFragmentListResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetMediaForFragmentListOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListFragments(ctx context.Context, request operations.ListFragmentsRequest) (*operations.ListFragmentsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/listFragments"
	...
	res := &operations.ListFragmentsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListFragmentsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
