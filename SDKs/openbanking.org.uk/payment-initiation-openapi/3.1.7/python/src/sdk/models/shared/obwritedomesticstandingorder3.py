...
class OBWriteDomesticStandingOrder3DataInitiation:
    ...
    creditor_account: OBWriteDomesticStandingOrder3DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreditorAccount') }})
    r"""Identification assigned by an institution to identify an account. This identification is known by the account owner."""  
    first_payment_amount: OBWriteDomesticStandingOrder3DataInitiationFirstPaymentAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FirstPaymentAmount') }})
    r"""The amount of the first Standing Order"""  
    ...
    """  
    debtor_account: Optional[OBWriteDomesticStandingOrder3DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DebtorAccount'), 'exclude': lambda f: f is None }})
    r"""Provides the details to identify the debtor account."""  
    final_payment_amount: Optional[OBWriteDomesticStandingOrder3DataInitiationFinalPaymentAmount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FinalPaymentAmount'), 'exclude': lambda f: f is None }})
    r"""The amount of the final Standing Order"""  
    ...
    recurring_payment_amount: Optional[OBWriteDomesticStandingOrder3DataInitiationRecurringPaymentAmount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RecurringPaymentAmount'), 'exclude': lambda f: f is None }})
    r"""The amount of the recurring Standing Order"""  
...
class OBWriteDomesticStandingOrder3Data:
    ...
    initiation: OBWriteDomesticStandingOrder3DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Initiation') }})
    r"""The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds from the debtor account to a creditor for a domestic standing order."""  
...
class OBWriteDomesticStandingOrder3:
    ...
    data: OBWriteDomesticStandingOrder3Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Data') }})  
