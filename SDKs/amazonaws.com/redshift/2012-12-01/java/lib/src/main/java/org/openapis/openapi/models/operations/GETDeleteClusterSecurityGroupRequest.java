...
public class GETDeleteClusterSecurityGroupRequest {
    ...
    public GETDeleteClusterSecurityGroupRequest(@JsonProperty("Action") GETDeleteClusterSecurityGroupActionEnum action, @JsonProperty("ClusterSecurityGroupName") String clusterSecurityGroupName, @JsonProperty("Version") GETDeleteClusterSecurityGroupVersionEnum version) {
        this.action = action;
        this.clusterSecurityGroupName = clusterSecurityGroupName;
        this.version = version;
  }
