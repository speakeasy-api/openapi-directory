...
class PostEnableAvailabilityZonesForLoadBalancerQueryParams:
    action: PostEnableAvailabilityZonesForLoadBalancerActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostEnableAvailabilityZonesForLoadBalancerVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostEnableAvailabilityZonesForLoadBalancerRequest:
    headers: PostEnableAvailabilityZonesForLoadBalancerHeaders = dataclasses.field()
    query_params: PostEnableAvailabilityZonesForLoadBalancerQueryParams = dataclasses.field()
