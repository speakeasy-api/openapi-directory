...
from ..shared import deletewebhookresult as shared_deletewebhookresult
...
class DeleteWebhookResponse:
    ...
    delete_webhook_result: Optional[shared_deletewebhookresult.DeleteWebhookResult] = dataclasses.field(default=None)
