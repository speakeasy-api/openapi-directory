...
class DeploymentmanagerDeploymentsDeleteRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DeploymentmanagerDeploymentsDeleteDeletePolicyEnum $deletePolicy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=deletePolicy')]
    public ?DeploymentmanagerDeploymentsDeleteDeletePolicyEnum $deletePolicy = null;
