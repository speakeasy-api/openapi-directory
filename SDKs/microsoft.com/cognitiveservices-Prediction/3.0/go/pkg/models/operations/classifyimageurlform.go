...
type ClassifyImageURLFormPathParams struct {
	// The project id.
...
type ClassifyImageURLFormQueryParams struct {
	// Optional. Specifies the name of application using the endpoint.
	Application *string `queryParam:"style=form,explode=true,name=application"`
}

type ClassifyImageURLFormRequest struct {
	PathParams  ClassifyImageURLFormPathParams
	QueryParams ClassifyImageURLFormQueryParams
...
type ClassifyImageURLFormResponse struct {
	Body        []byte
	ContentType string
	// Error response
