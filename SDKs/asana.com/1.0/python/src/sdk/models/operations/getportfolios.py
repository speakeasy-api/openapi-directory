...
class GetPortfoliosRequest:
    ...
    r"""The user who owns the portfolio. Currently, API users can only get a list of portfolios that they themselves own."""  
    workspace: str = dataclasses.field(metadata={'query_param': { 'field_name': 'workspace', 'style': 'form', 'explode': True }})
    r"""The workspace or organization to filter portfolios on."""  
...
class GetPortfolios200ApplicationJSON:
    r"""Successfully retrieved portfolios."""
    
    data: Optional[list[shared_portfoliocompact.PortfolioCompact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
