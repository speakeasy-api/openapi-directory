 ...
 */
export enum PublicAdvertisedPrefixListWarningCodeEnum {
...
export class PublicAdvertisedPrefixListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class PublicAdvertisedPrefixListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: PublicAdvertisedPrefixListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class PublicAdvertisedPrefixList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: PublicAdvertisedPrefix })
  @Expose({ name: "items" })
