...
class VerifyV2ServiceEntityNewFactor:
    ...
    binding: Optional[Any] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('binding') }})
    ...
    factor_type: Optional[shared_new_factor_enum_factor_types_enum.NewFactorEnumFactorTypesEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('factor_type') }})
    ...
    status: Optional[shared_new_factor_enum_factor_statuses_enum.NewFactorEnumFactorStatusesEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
