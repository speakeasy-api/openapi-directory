...
class AccounttaxCustomBatchResponseEntry:
    r"""A batch entry encoding a single non-batch accounttax response."""
    ...
    r"""Identifies what kind of resource this is. Value: the fixed string \\"`content#accounttaxCustomBatchResponseEntry`\\" """  
