...
**/
var SignalExternalWorkflowExecutionDecisionAttributes = /** @class */ (function (_super) {
    __extends(SignalExternalWorkflowExecutionDecisionAttributes, _super);
    ...
    ], SignalExternalWorkflowExecutionDecisionAttributes.prototype, "control", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=input" }),
        __metadata("design:type", String)
    ], SignalExternalWorkflowExecutionDecisionAttributes.prototype, "input", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=runId" }),
        __metadata("design:type", String)
    ], SignalExternalWorkflowExecutionDecisionAttributes.prototype, "runId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=signalName" }),
        __metadata("design:type", String)
    ], SignalExternalWorkflowExecutionDecisionAttributes.prototype, "signalName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=workflowId" }),
        __metadata("design:type", String)
    ], SignalExternalWorkflowExecutionDecisionAttributes.prototype, "workflowId", void 0);
