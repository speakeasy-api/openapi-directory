...
public class CloudbuildProjectsWorkerPoolsCreateRequest {
    ...
    public openapisdk.models.shared.WorkerPool request;
    public CloudbuildProjectsWorkerPoolsCreateRequest withRequest(openapisdk.models.shared.WorkerPool request) {
