...
class AnalysisCategories:
    ...
    def analysis_categories_get(self) -> operations.AnalysisCategoriesGetResponse:
        ...
        res = operations.AnalysisCategoriesGetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PageResultAnalysisCategoryDto])
                res.page_result_analysis_category_dto = out
