...
@dataclasses.dataclass
class DataprocProjectsRegionsClustersDeleteQueryParams:
...
class DataprocProjectsRegionsClustersDeleteRequest:
    path_params: DataprocProjectsRegionsClustersDeletePathParams = dataclasses.field()
    query_params: DataprocProjectsRegionsClustersDeleteQueryParams = dataclasses.field()
    security: DataprocProjectsRegionsClustersDeleteSecurity = dataclasses.field()
