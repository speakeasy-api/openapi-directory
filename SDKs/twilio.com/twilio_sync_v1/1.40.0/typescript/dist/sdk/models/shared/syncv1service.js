...
var SyncV1Service = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "acl_enabled" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "reachability_debouncing_enabled" }),
        __metadata("design:type", Boolean)
    ], SyncV1Service.prototype, "reachabilityDebouncingEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "reachability_debouncing_window" }),
        __metadata("design:type", Number)
    ], SyncV1Service.prototype, "reachabilityDebouncingWindow", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "reachability_webhooks_enabled" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "webhooks_from_rest_enabled" }),
        __metadata("design:type", Boolean)
    ], SyncV1Service.prototype, "webhooksFromRestEnabled", void 0);
    return SyncV1Service;
}(utils_1.SpeakeasyBase));
exports.SyncV1Service = SyncV1Service;
