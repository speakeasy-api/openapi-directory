...
class GETVersionLocationsMarkersFormatRequest
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GETVersionLocationsMarkersFormatIncidentTypeEnum $incidentType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=incident_type')]
    public ?GETVersionLocationsMarkersFormatIncidentTypeEnum $incidentType = null;
