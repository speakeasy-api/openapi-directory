...
@dataclasses.dataclass
class DoubleclickbidmanagerReportsListreportsQueryParams:
...
class DoubleclickbidmanagerReportsListreportsRequest:
    path_params: DoubleclickbidmanagerReportsListreportsPathParams = dataclasses.field()
    query_params: DoubleclickbidmanagerReportsListreportsQueryParams = dataclasses.field()
    security: DoubleclickbidmanagerReportsListreportsSecurity = dataclasses.field()
