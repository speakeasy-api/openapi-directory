...
type GetNhSeaQueryParams struct {
...
type GetNhSeaRequest struct {
	QueryParams GetNhSeaQueryParams
	Headers     GetNhSeaHeaders
}

type GetNhSeaResponse struct {
	ContentType string
