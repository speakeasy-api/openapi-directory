...
type DescribeInferenceExperimentHeaders struct {
...
type DescribeInferenceExperimentRequest struct {
	Headers DescribeInferenceExperimentHeaders
	Request shared.DescribeInferenceExperimentRequest `request:"mediaType=application/json"`
}
