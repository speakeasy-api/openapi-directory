...
exports.GetNetworkWirelessClientConnectionStatsResponse = exports.GetNetworkWirelessClientConnectionStatsRequest = exports.GetNetworkWirelessClientConnectionStatsBandEnum = void 0;
...
(function (GetNetworkWirelessClientConnectionStatsBandEnum) {
    ...
    GetNetworkWirelessClientConnectionStatsBandEnum["Six"] = "6";
...
var GetNetworkWirelessClientConnectionStatsRequest = /** @class */ (function (_super) {
    ...
    ], GetNetworkWirelessClientConnectionStatsRequest.prototype, "apTag", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=band" }),
        __metadata("design:type", String)
    ], GetNetworkWirelessClientConnectionStatsRequest.prototype, "band", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=clientId",
        }),
        __metadata("design:type", String)
    ], GetNetworkWirelessClientConnectionStatsRequest.prototype, "clientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=networkId",
        }),
        __metadata("design:type", String)
    ], GetNetworkWirelessClientConnectionStatsRequest.prototype, "networkId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ssid" }),
        __metadata("design:type", Number)
    ], GetNetworkWirelessClientConnectionStatsRequest.prototype, "ssid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t0" }),
        __metadata("design:type", String)
    ], GetNetworkWirelessClientConnectionStatsRequest.prototype, "t0", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t1" }),
        __metadata("design:type", String)
    ], GetNetworkWirelessClientConnectionStatsRequest.prototype, "t1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timespan",
        }),
        __metadata("design:type", Number)
    ], GetNetworkWirelessClientConnectionStatsRequest.prototype, "timespan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=vlan" }),
        __metadata("design:type", Number)
    ], GetNetworkWirelessClientConnectionStatsRequest.prototype, "vlan", void 0);
...
var GetNetworkWirelessClientConnectionStatsResponse = /** @class */ (function (_super) {
    ...
    ], GetNetworkWirelessClientConnectionStatsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
