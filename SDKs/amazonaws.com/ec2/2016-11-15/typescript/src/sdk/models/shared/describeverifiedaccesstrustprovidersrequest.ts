 ...
 */
export class DescribeVerifiedAccessTrustProvidersRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeVerifiedAccessTrustProvidersRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({
    elemType: DescribeVerifiedAccessTrustProvidersRequestFilters,
  })
  filters?: DescribeVerifiedAccessTrustProvidersRequestFilters[];
