...
__doc__ = """ SDK Documentation: https://docs.aws.amazon.com/finspace/ - Amazon Web Services documentation"""
import requests
...
class SDK:
    r"""SDK Documentation: https://docs.aws.amazon.com/finspace/ - Amazon Web Services documentation"""
    ...
    def create_environment(self, request: operations.CreateEnvironmentRequest) -> operations.CreateEnvironmentResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateEnvironmentResponse])
    ...
    def delete_environment(self, request: operations.DeleteEnvironmentRequest) -> operations.DeleteEnvironmentResponse:
        ...
        url = utils.generate_url(base_url, "/environment/{environmentId}", request.path_params)
    ...
    def get_environment(self, request: operations.GetEnvironmentRequest) -> operations.GetEnvironmentResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetEnvironmentResponse])
    ...
    def list_environments(self, request: operations.ListEnvironmentsRequest) -> operations.ListEnvironmentsResponse:
        ...
        res = operations.ListEnvironmentsResponse(status_code=r.status_code, content_type=content_type)
    ...
    def update_environment(self, request: operations.UpdateEnvironmentRequest) -> operations.UpdateEnvironmentResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateEnvironmentResponse])
