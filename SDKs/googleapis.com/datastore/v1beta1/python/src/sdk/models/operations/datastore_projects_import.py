...
class DatastoreProjectsImportRequest:
    ...
    google_datastore_admin_v1beta1_import_entities_request: Optional[shared_googledatastoreadminv1beta1importentitiesrequest.GoogleDatastoreAdminV1beta1ImportEntitiesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
