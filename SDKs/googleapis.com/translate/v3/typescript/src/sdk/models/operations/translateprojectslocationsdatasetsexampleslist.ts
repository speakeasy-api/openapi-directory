...
export class TranslateProjectsLocationsDatasetsExamplesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class TranslateProjectsLocationsDatasetsExamplesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class TranslateProjectsLocationsDatasetsExamplesListSecurity extends SpeakeasyBase {
...
export class TranslateProjectsLocationsDatasetsExamplesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class TranslateProjectsLocationsDatasetsExamplesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
