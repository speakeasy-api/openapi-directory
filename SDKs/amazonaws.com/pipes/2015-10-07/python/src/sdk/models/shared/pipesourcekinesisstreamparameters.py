...
from ..shared import kinesisstreamstartposition_enum as shared_kinesisstreamstartposition_enum
...
class PipeSourceKinesisStreamParameters:
    ...
    starting_position: shared_kinesisstreamstartposition_enum.KinesisStreamStartPositionEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StartingPosition') }})  
