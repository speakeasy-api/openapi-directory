 ...
 */
public class GoogleCloudRetailV2SearchRequestFacetSpecFacetKey {
    /**
    ...
    public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey withCaseInsensitive(Boolean caseInsensitive) {
    ...
    public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey withContains(String[] contains) {
    ...
    public GoogleCloudRetailV2Interval[] intervals;

    public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey withIntervals(GoogleCloudRetailV2Interval[] intervals) {
    ...
    public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey withOrderBy(String orderBy) {
    ...
    public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey withPrefixes(String[] prefixes) {
    ...
    public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey withQuery(String query) {
        this.query = query;
        return this;
    }
    ...
    public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey withRestrictedValues(String[] restrictedValues) {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("returnMinMax")
    public Boolean returnMinMax;

    public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey withReturnMinMax(Boolean returnMinMax) {
        this.returnMinMax = returnMinMax;
        return this;
    }
    
    public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey(){}
}
