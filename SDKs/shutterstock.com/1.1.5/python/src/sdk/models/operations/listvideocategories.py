...
class ListVideoCategoriesQueryParams:
...
class ListVideoCategoriesRequest:
    query_params: ListVideoCategoriesQueryParams = dataclasses.field()
    security: ListVideoCategoriesSecurity = dataclasses.field()
