...
func (e DisassociateTransitGatewayRouteTableResultAssociationResourceTypeEnum) ToPointer() *DisassociateTransitGatewayRouteTableResultAssociationResourceTypeEnum {
	return &e
}
...
func (e *DisassociateTransitGatewayRouteTableResultAssociationResourceTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "peering":
		fallthrough
	case "tgw-peering":
		*e = DisassociateTransitGatewayRouteTableResultAssociationResourceTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DisassociateTransitGatewayRouteTableResultAssociationResourceTypeEnum: %v", v)
	}
}
...
func (e DisassociateTransitGatewayRouteTableResultAssociationStateEnum) ToPointer() *DisassociateTransitGatewayRouteTableResultAssociationStateEnum {
	return &e
}
...
func (e *DisassociateTransitGatewayRouteTableResultAssociationStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "disassociating":
		fallthrough
	case "disassociated":
		*e = DisassociateTransitGatewayRouteTableResultAssociationStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DisassociateTransitGatewayRouteTableResultAssociationStateEnum: %v", v)
	}
}
