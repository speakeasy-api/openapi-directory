...
exports.TerminalSettingsCompanyLevel = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var shared = __importStar(require("./models/shared"));
var TerminalSettingsCompanyLevel = /** @class */ (function () {
    function TerminalSettingsCompanyLevel(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    TerminalSettingsCompanyLevel.prototype.getCompaniesCompanyIdTerminalLogos = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCompaniesCompanyIdTerminalLogosRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/companies/{companyId}/terminalLogos", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.GetCompaniesCompanyIdTerminalLogosSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetCompaniesCompanyIdTerminalLogosResponse({
     ...
     */
    TerminalSettingsCompanyLevel.prototype.getCompaniesCompanyIdTerminalSettings = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCompaniesCompanyIdTerminalSettingsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/companies/{companyId}/terminalSettings", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.GetCompaniesCompanyIdTerminalSettingsSecurity(security);
        }
        var client = utils.createSecurityClient(this._defaultClient, security);
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetCompaniesCompanyIdTerminalSettingsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     * * Management API—Terminal settings read and write
     */
    TerminalSettingsCompanyLevel.prototype.patchCompaniesCompanyIdTerminalLogos = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.PatchCompaniesCompanyIdTerminalLogosSecurity(security);
        }
        var client = utils.createSecurityClient(this._defaultClient, security);
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PatchCompaniesCompanyIdTerminalLogosResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     * * Management API—Terminal settings read and write
     */
    TerminalSettingsCompanyLevel.prototype.patchCompaniesCompanyIdTerminalSettings = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.PatchCompaniesCompanyIdTerminalSettingsSecurity(security);
        }
        var client = utils.createSecurityClient(this._defaultClient, security);
        var headers = __assign(__assign({}, reqBodyHeaders), config === null || config === void 0 ? void 0 : config.headers);
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PatchCompaniesCompanyIdTerminalSettingsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
...
exports.TerminalSettingsCompanyLevel = TerminalSettingsCompanyLevel;
