...
class SendMessageRequestBody5TextViberService
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody5TextViberServiceAction $action
     */
	#[\JMS\Serializer\Annotation\SerializedName('action')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody5TextViberServiceAction')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?SendMessageRequestBody5TextViberServiceAction $action = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody5TextViberServiceCategoryEnum $category
     */
	#[\JMS\Serializer\Annotation\SerializedName('category')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody5TextViberServiceCategoryEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?SendMessageRequestBody5TextViberServiceCategoryEnum $category = null;
