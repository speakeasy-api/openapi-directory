...
func (e CreateNetworkSwitchQosRuleRequestBodyProtocolEnum) ToPointer() *CreateNetworkSwitchQosRuleRequestBodyProtocolEnum {
	return &e
}
...
func (e *CreateNetworkSwitchQosRuleRequestBodyProtocolEnum) UnmarshalJSON(data []byte) error {
	...
	case "TCP":
		fallthrough
	case "UDP":
		*e = CreateNetworkSwitchQosRuleRequestBodyProtocolEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkSwitchQosRuleRequestBodyProtocolEnum: %v", v)
	}
}
