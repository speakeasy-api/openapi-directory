...
export class SDK {
  ...
  addEventSource(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/2014-11-13/event-source-mappings/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AddEventSourceResponse =
        new operations.AddEventSourceResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.eventSourceConfiguration = utils.objectToClass(
              httpRes?.data,
              shared.EventSourceConfiguration
            );
          }
          break;
        case httpRes?.status == 400:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.invalidParameterValueException = utils.objectToClass(
              httpRes?.data,
              shared.InvalidParameterValueException
            );
          }
          break;
        case httpRes?.status == 500:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.serviceException = utils.objectToClass(
              httpRes?.data,
              shared.ServiceException
            );
          }
          break;
      }
  ...
  getEventSource(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetEventSourceResponse =
        new operations.GetEventSourceResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  invokeAsync(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        ...
        case httpRes?.status == 400:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.invalidRequestContentException = utils.objectToClass(
              httpRes?.data,
              shared.InvalidRequestContentException
            );
          }
          break;
        case httpRes?.status == 404:
  ...
  removeEventSource(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RemoveEventSourceResponse =
        new operations.RemoveEventSourceResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  uploadFunction(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UploadFunctionResponse =
        new operations.UploadFunctionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
