 ...
 */
export class ProtectiveEquipmentSummary extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "PersonsIndeterminate" })
  personsIndeterminate?: number[];

  @SpeakeasyMetadata()
  @Expose({ name: "PersonsWithRequiredEquipment" })
  personsWithRequiredEquipment?: number[];

  @SpeakeasyMetadata()
  @Expose({ name: "PersonsWithoutRequiredEquipment" })
