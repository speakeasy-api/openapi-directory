...
from ..shared import api_key_enum6 as shared_api_key_enum6
...
class GetSearchRvAutoCompleteQueryParams:
    field: shared_api_key_enum6.APIKeyEnum6 = dataclasses.field(metadata={'query_param': { 'field_name': 'field', 'style': 'form', 'explode': True }})
...
class GetSearchRvAutoCompleteRequest:
    query_params: GetSearchRvAutoCompleteQueryParams = dataclasses.field()
