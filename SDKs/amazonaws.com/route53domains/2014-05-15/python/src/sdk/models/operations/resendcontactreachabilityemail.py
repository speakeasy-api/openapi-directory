...
class ResendContactReachabilityEmailRequest:
    ...
    resend_contact_reachability_email_request: shared_resendcontactreachabilityemailrequest.ResendContactReachabilityEmailRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
