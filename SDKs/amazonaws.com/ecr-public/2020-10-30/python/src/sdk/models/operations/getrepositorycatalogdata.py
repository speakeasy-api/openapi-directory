...
class GetRepositoryCatalogDataRequest:
    ...
    get_repository_catalog_data_request: shared_getrepositorycatalogdatarequest.GetRepositoryCatalogDataRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class GetRepositoryCatalogDataResponse:
    ...
    repository_catalog_data_not_found_exception: Optional[Any] = dataclasses.field(default=None)
