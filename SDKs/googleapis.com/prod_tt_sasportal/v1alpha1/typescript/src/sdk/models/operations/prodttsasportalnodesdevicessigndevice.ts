...
export class ProdTtSasportalNodesDevicesSignDeviceSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ProdTtSasportalNodesDevicesSignDeviceSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ProdTtSasportalNodesDevicesSignDeviceSecurity extends SpeakeasyBase {
  ...
  option1?: ProdTtSasportalNodesDevicesSignDeviceSecurityOption1;

  @SpeakeasyMetadata({ data: "security, option=true" })
  option2?: ProdTtSasportalNodesDevicesSignDeviceSecurityOption2;
}
