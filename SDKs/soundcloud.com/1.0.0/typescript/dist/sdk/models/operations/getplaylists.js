...
exports.GetPlaylistsResponse = exports.GetPlaylistsRequest = exports.GetPlaylistsSecurity = exports.GetPlaylistsQueryParams = void 0;
...
var GetPlaylistsQueryParams = /** @class */ (function (_super) {
    ...
    ], GetPlaylistsQueryParams.prototype, "access", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetPlaylistsQueryParams.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=linked_partitioning" }),
        __metadata("design:type", Boolean)
    ], GetPlaylistsQueryParams.prototype, "linkedPartitioning", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=offset" }),
        __metadata("design:type", Number)
    ], GetPlaylistsQueryParams.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q" }),
        __metadata("design:type", String)
    ], GetPlaylistsQueryParams.prototype, "q", void 0);
    return GetPlaylistsQueryParams;
}(utils_1.SpeakeasyBase));
exports.GetPlaylistsQueryParams = GetPlaylistsQueryParams;
var GetPlaylistsSecurity = /** @class */ (function (_super) {
    __extends(GetPlaylistsSecurity, _super);
    function GetPlaylistsSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "security, scheme=true;type=apiKey;subtype=header" }),
        __metadata("design:type", shared.SchemeAuthHeader)
    ], GetPlaylistsSecurity.prototype, "authHeader", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "security, scheme=true;type=apiKey;subtype=query" }),
        __metadata("design:type", shared.SchemeClientId)
    ], GetPlaylistsSecurity.prototype, "clientId", void 0);
    return GetPlaylistsSecurity;
}(utils_1.SpeakeasyBase));
exports.GetPlaylistsSecurity = GetPlaylistsSecurity;
var GetPlaylistsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", GetPlaylistsSecurity)
    ], GetPlaylistsRequest.prototype, "security", void 0);
...
var GetPlaylistsResponse = /** @class */ (function (_super) {
    ...
    ], GetPlaylistsResponse.prototype, "error", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Number)
    ...
    ], GetPlaylistsResponse.prototype, "getPlaylists200ApplicationJSONOneOf", void 0);
