...
exports.GetDeparturesByCRSResponse = exports.GetDeparturesByCRSRequest = void 0;
...
var GetDeparturesByCRSRequest = /** @class */ (function (_super) {
    ...
    ], GetDeparturesByCRSRequest.prototype, "crs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=apiKey",
        }),
        __metadata("design:type", String)
    ], GetDeparturesByCRSRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filterStation",
        }),
        __metadata("design:type", String)
    ], GetDeparturesByCRSRequest.prototype, "filterStation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=numServices",
        }),
        __metadata("design:type", Number)
    ], GetDeparturesByCRSRequest.prototype, "numServices", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=serviceDetails",
        }),
        __metadata("design:type", Boolean)
    ], GetDeparturesByCRSRequest.prototype, "serviceDetails", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeOffset",
        }),
        __metadata("design:type", Number)
    ], GetDeparturesByCRSRequest.prototype, "timeOffset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeWindow",
        }),
        __metadata("design:type", Number)
    ], GetDeparturesByCRSRequest.prototype, "timeWindow", void 0);
...
var GetDeparturesByCRSResponse = /** @class */ (function (_super) {
    ...
    ], GetDeparturesByCRSResponse.prototype, "rawResponse", void 0);
