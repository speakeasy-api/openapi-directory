...
public class HealthGetQueueLogsSecurity {
    ...
    public HealthGetQueueLogsSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public HealthGetQueueLogsSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public HealthGetQueueLogsSecurity(@JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.key = key;
        this.project = project;
  }
}
