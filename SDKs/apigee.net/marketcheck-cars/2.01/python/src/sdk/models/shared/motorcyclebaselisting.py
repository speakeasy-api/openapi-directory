...
from ..shared import motorcyclebuild as shared_motorcyclebuild
...
class MotorcycleBaseListing:
    r"""MotorcycleBaseListing
    Base motorcycle listing
    """
    
    build: Optional[shared_motorcyclebuild.MotorcycleBuild] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('build') }})
