...
type RealtimebiddingBiddersPretargetingConfigsAddTargetedSitesSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RealtimebiddingBiddersPretargetingConfigsAddTargetedSitesPathParams struct {
...
type RealtimebiddingBiddersPretargetingConfigsAddTargetedSitesQueryParams struct {
	// V1 error format.
...
type RealtimebiddingBiddersPretargetingConfigsAddTargetedSitesRequest struct {
	...
	Request     *shared.AddTargetedSitesRequest `request:"mediaType=application/json"`
	Security    RealtimebiddingBiddersPretargetingConfigsAddTargetedSitesSecurity
}

type RealtimebiddingBiddersPretargetingConfigsAddTargetedSitesResponse struct {
	ContentType string
	// Successful response
