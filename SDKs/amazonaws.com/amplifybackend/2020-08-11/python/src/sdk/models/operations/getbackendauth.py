...
from ..shared import getbackendauthresponse as shared_getbackendauthresponse
...
class GetBackendAuthRequest:
    headers: GetBackendAuthHeaders = dataclasses.field()
    path_params: GetBackendAuthPathParams = dataclasses.field()
    request: GetBackendAuthRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetBackendAuthResponse:
    ...
    get_backend_auth_response: Optional[shared_getbackendauthresponse.GetBackendAuthResponse] = dataclasses.field(default=None)
