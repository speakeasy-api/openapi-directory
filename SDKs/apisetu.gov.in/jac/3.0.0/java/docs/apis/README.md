    ...
    public static void main(String[] args) {
        try {
            ...
            HpcerRequestBody req = new HpcerRequestBody(HpcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HpcerRequestBodyCertificateParameters("Sunil Kumar", "11001", "X00X", "2009,2010,2011,2012,2013,2014,2015,2016,2017");;
    ...
    public static void main(String[] args) {
        try {
            ...
            HscerRequestBody req = new HscerRequestBody(HscerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HscerRequestBodyCertificateParameters("Sunil Kumar", "11001", "X00X", "2009,2010,2011,2012,2013,2014,2015,2016,2017");;
            ...
            HscerResponse res = sdk.apIs.hscer(req, new HscerSecurity("qui", "impedit") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            SpcerRequestBody req = new SpcerRequestBody(SpcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SpcerRequestBodyCertificateParameters("Sunil Kumar", "11001", "X00X", "2009,2010,2011,2012,2013,2014,2015,2016,2017");;
            ...
            SpcerResponse res = sdk.apIs.spcer(req, new SpcerSecurity("iure", "saepe") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            SscerRequestBody req = new SscerRequestBody(SscerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SscerRequestBodyCertificateParameters("Sunil Kumar", "11001", "X00X", "2009,2010,2011,2012,2013,2014,2015,2016,2017");;
