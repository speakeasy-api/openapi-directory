...
```bash
go get github.com/speakeasy-api/openapi-directory/SDKs/apisetu.gov.in/niesbud/3.0.0/go
```
...
func main() {
    ...
    res, err := s.APIs.Skcer(ctx, operations.SkcerRequestBody{
        CertificateParameters: &operations.SkcerRequestBodyCertificateParameters{
            CourseNo: "2019/65404/1",
            FullName: "Sunil Kumar",
            CertificateType: "NIESBUD,PMYUVA",
        },
        ...
        Format: operations.SkcerRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.SkcerSecurity{
