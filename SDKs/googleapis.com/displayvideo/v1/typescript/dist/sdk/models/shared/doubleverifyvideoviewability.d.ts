 ...
 */
export declare enum DoubleVerifyVideoViewabilityPlayerImpressionRateEnum {
 ...
 */
export declare enum DoubleVerifyVideoViewabilityVideoIabEnum {
 ...
 */
export declare enum DoubleVerifyVideoViewabilityVideoViewableRateEnum {
 ...
 */
export declare class DoubleVerifyVideoViewability extends SpeakeasyBase {
    /**
     * Target inventory to maximize impressions with 400x300 or greater player size.
     */
