...
class StoredValueIssueResponseResultCodeEnum(str, Enum):
...
class StoredValueIssueResponse:
    ...
    * When the payment is not authorised, this field is empty.
    ...
    payment_method: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('paymentMethod'), 'exclude': lambda f: f is None }})
    ...
    """  
    result_code: Optional[StoredValueIssueResponseResultCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resultCode'), 'exclude': lambda f: f is None }})
    r"""The result of the payment. Possible values:
