...
class InventoryperdockandwarehouseRequest:
...
class InventoryperdockandwarehouseResponse:
    ...
    inventoryperdockandwarehouse_200_application_json_objects: Optional[list[Inventoryperdockandwarehouse200ApplicationJSON]] = dataclasses.field(default=None)
    r"""OK"""  
