...
class TagsPatchDataPointJSONRequest:
    ...
    api_core_requests_patch_body: shared_api_core_requests_patchbody.APICoreRequestsPatchBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The body patch"""  
...
@dataclasses.dataclass
class TagsPatchDataPointJSONResponse:
