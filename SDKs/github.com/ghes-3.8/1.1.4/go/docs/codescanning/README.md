...
<https://docs.github.com/enterprise-server@3.8/rest/reference/code-scanning#delete-a-code-scanning-analysis-from-a-repository>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningDeleteAnalysis(ctx, operations.CodeScanningDeleteAnalysisRequest{
        AnalysisID: 839189,
        ConfirmDelete: sdk.String("ullam"),
        Owner: "adipisci",
        Repo: "cum",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/code-scanning#get-a-code-scanning-alert>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/code-scanning#get-a-code-scanning-analysis-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/code-scanning#list-recent-code-scanning-analyses-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/code-scanning#list-instances-of-a-code-scanning-alert>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListAlertInstances(ctx, operations.CodeScanningListAlertInstancesRequest{
        AlertNumber: 348783,
        Owner: "nobis",
        Page: sdk.Int64(24619),
        PerPage: sdk.Int64(699575),
        Ref: sdk.String("sed"),
        Repo: "reiciendis",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/code-scanning#list-code-scanning-alerts-for-an-enterprise>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListAlertsForEnterprise(ctx, operations.CodeScanningListAlertsForEnterpriseRequest{
        After: sdk.String("explicabo"),
        Before: sdk.String("asperiores"),
        ...
        ToolGUID: sdk.String("laborum"),
        ToolName: sdk.String("sed"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/code-scanning#list-code-scanning-alerts-by-organization>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListAlertsForOrg(ctx, operations.CodeScanningListAlertsForOrgRequest{
        After: sdk.String("in"),
        Before: sdk.String("commodi"),
        Direction: shared.DirectionEnumDesc.ToPointer(),
        Org: "explicabo",
        Page: sdk.Int64(378326),
        PerPage: sdk.Int64(604118),
        Severity: shared.CodeScanningAlertSeverityEnumCritical.ToPointer(),
        ...
        ToolGUID: sdk.String("debitis"),
        ToolName: sdk.String("illo"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/code-scanning#list-code-scanning-alerts-for-a-repository>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListAlertsForRepo(ctx, operations.CodeScanningListAlertsForRepoRequest{
        Direction: shared.DirectionEnumDesc.ToPointer(),
        Owner: "perferendis",
        Page: sdk.Int64(546885),
        PerPage: sdk.Int64(979574),
        Ref: sdk.String("incidunt"),
        Repo: "sed",
        Severity: shared.CodeScanningAlertSeverityEnumWarning.ToPointer(),
        Sort: operations.CodeScanningListAlertsForRepoSortEnumCreated.ToPointer(),
        State: shared.CodeScanningAlertStateEnumFixed.ToPointer(),
        ToolGUID: sdk.String("ipsum"),
        ToolName: sdk.String("ea"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/code-scanning#list-code-scanning-analyses-for-a-repository>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListRecentAnalyses(ctx, operations.CodeScanningListRecentAnalysesRequest{
        ...
        ToolGUID: sdk.String("reiciendis"),
        ToolName: sdk.String("ex"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/code-scanning#update-a-code-scanning-alert>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningUpdateAlert(ctx, operations.CodeScanningUpdateAlertRequest{
        RequestBody: operations.CodeScanningUpdateAlertRequestBody{
            DismissedComment: sdk.String("sit"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/code-scanning#upload-a-sarif-file>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningUploadSarif(ctx, operations.CodeScanningUploadSarifRequest{
        RequestBody: operations.CodeScanningUploadSarifRequestBody{
            ...
            Ref: "ipsam",
            Sarif: "debitis",
            StartedAt: types.MustTimeFromString("2022-12-12T15:19:28.678Z"),
            ToolName: sdk.String("nobis"),
        },
        Owner: "error",
        Repo: "veniam",
    })
