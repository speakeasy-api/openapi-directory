...
from ..shared import roomtreedatalist as shared_roomtreedatalist
from enum import Enum
from typing import Optional

class RequestUsersRoomsXSdsDateFormatEnum(str, Enum):
...
class RequestUsersRoomsRequest:
    ...
    x_sds_date_format: Optional[RequestUsersRoomsXSdsDateFormatEnum] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'X-Sds-Date-Format', 'style': 'simple', 'explode': False }})
    r"""Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) & [leettime.de](http://leettime.de/))"""  
...
class RequestUsersRoomsResponse:
    ...
    room_tree_data_list: Optional[shared_roomtreedatalist.RoomTreeDataList] = dataclasses.field(default=None)
    r"""OK"""  
