...
class ListFirewallDomainListsRequest:
    ...
    list_firewall_domain_lists_request: shared_listfirewalldomainlistsrequest.ListFirewallDomainListsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
