...
public class CreateImagesFromUrlsRawRequest {
    ...
    public CreateImagesFromUrlsRawRequest(@JsonProperty("RequestBody") byte[] requestBody, @JsonProperty("Training-Key") String trainingKey, @JsonProperty("projectId") String projectId) {
        this.requestBody = requestBody;
        this.trainingKey = trainingKey;
        this.projectId = projectId;
  }
