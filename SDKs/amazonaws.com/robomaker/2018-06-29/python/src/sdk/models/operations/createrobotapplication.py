...
class CreateRobotApplicationRequestBody:
    ...
    robot_software_suite: CreateRobotApplicationRequestBodyRobotSoftwareSuite = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('robotSoftwareSuite') }})
    environment: Optional[CreateRobotApplicationRequestBodyEnvironment] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('environment') }})
...
class CreateRobotApplicationRequest:
    headers: CreateRobotApplicationHeaders = dataclasses.field()
    request: CreateRobotApplicationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
