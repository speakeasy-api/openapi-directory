...
public class Operations {
     ...
     * 
    **/
    public openapisdk.models.operations.PostBillingPreviewResponse postBillingPreview(openapisdk.models.operations.PostBillingPreviewRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/operations/billing-preview");
        ...
        openapisdk.models.operations.PostBillingPreviewResponse res = new openapisdk.models.operations.PostBillingPreviewResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                ...
                openapisdk.models.shared.BillingPreviewResult out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.BillingPreviewResult.class);
     ...
     * 
    **/
    public openapisdk.models.operations.PostTransactionInvoicePaymentResponse postTransactionInvoicePayment(openapisdk.models.operations.PostTransactionInvoicePaymentRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/operations/invoice-collect");
        ...
        openapisdk.models.operations.PostTransactionInvoicePaymentResponse res = new openapisdk.models.operations.PostTransactionInvoicePaymentResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.PostInvoiceCollectResponseType out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.PostInvoiceCollectResponseType.class);
