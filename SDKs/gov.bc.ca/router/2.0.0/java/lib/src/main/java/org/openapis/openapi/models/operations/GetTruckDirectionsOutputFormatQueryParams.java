...
public class GetTruckDirectionsOutputFormatQueryParams {
    ...
    public GetTruckDirectionsOutputFormatQueryParams withOutputSRS(GetTruckDirectionsOutputFormatOutputSrsEnum outputSRS) {
    ...
    public GetTruckDirectionsOutputFormatQueryParams withPartition(String partition) {
    ...
    public GetTruckDirectionsOutputFormatQueryParams withTruckRouteMultiplier(Long truckRouteMultiplier) {
