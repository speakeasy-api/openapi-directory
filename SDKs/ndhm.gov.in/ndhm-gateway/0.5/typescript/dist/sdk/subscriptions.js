...
var Subscriptions = /** @class */ (function () {
    ...
    **/
    Subscriptions.prototype.postV05SubscriptionRequestsCmInit = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05SubscriptionRequestsCmInitRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v0.5/subscription-requests/cm/init";
     ...
     *
    **/
    Subscriptions.prototype.postV05SubscriptionRequestsCmOnInit = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Subscriptions.prototype.postV05SubscriptionRequestsHiuNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Subscriptions.prototype.postV05SubscriptionRequestsHiuOnNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05SubscriptionRequestsHiuOnNotifyRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v0.5/subscription-requests/hiu/on-notify";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
     ...
     *
    **/
    Subscriptions.prototype.postV05SubscriptionsHiuNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Subscriptions.prototype.postV05SubscriptionsHiuOnNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
