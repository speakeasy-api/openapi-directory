...
class RouteMatrixEntryError
{
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\RouteMatrixErrorCodeEnum>')]
	...
	{
		$this->code = \OpenAPI\OpenAPI\Models\Shared\RouteMatrixErrorCodeEnum::ROUTE_NOT_FOUND;
		$this->message = null;
	}
}
