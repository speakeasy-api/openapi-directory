...
public class CocerSecurity {
    ...
    public CocerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public CocerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public CocerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
