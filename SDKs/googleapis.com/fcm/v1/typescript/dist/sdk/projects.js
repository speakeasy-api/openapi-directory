...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.fcmProjectsMessagesSend = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FcmProjectsMessagesSendRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/messages:send", req.pathParams);
