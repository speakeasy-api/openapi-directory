...
class BooksMylibraryBookshelvesVolumesListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\BooksMylibraryBookshelvesVolumesListProjectionEnum $projection
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=projection')]
    public ?BooksMylibraryBookshelvesVolumesListProjectionEnum $projection = null;
