...
class OpenAQCountriesResult:
    ...
    results: list[shared_countriesrow.CountriesRow] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results') }})  
    meta: Optional[OpenAQCountriesResultMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
