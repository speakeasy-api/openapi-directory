...
class MonitoringProjectsNotificationChannelsGetVerificationCodeRequest:
    ...
    r"""Required. The notification channel for which a verification code is to be generated and retrieved. This must name a channel that is already verified; if the specified channel is not verified, the request will fail."""  
    ...
    get_notification_channel_verification_code_request: Optional[shared_getnotificationchannelverificationcoderequest.GetNotificationChannelVerificationCodeRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
