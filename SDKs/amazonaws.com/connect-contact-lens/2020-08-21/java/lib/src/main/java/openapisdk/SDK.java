...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.ListRealtimeContactAnalysisSegmentsResponse listRealtimeContactAnalysisSegments(openapisdk.models.operations.ListRealtimeContactAnalysisSegmentsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/realtime-contact-analysis/analysis-segments");
        ...
        openapisdk.models.operations.ListRealtimeContactAnalysisSegmentsResponse res = new openapisdk.models.operations.ListRealtimeContactAnalysisSegmentsResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.ListRealtimeContactAnalysisSegmentsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ListRealtimeContactAnalysisSegmentsResponse.class);
