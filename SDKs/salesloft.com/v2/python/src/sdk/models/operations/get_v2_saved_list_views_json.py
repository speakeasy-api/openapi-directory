...
class GetV2SavedListViewsJSONRequest:
    ...
    r"""IDs of saved list views to fetch. If a record can't be found, that record won't be returned and your request will be successful"""  
    ...
    r"""Key to sort on, must be one of: name. Defaults to name"""  
    ...
    r"""Type of saved list views to fetch."""  
    

@dataclasses.dataclass
class GetV2SavedListViewsJSONResponse:
