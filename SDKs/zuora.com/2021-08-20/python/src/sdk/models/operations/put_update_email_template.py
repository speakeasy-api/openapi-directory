...
class PUTUpdateEmailTemplateRequest:
    ...
    r"""The ID of the email template to be updated."""  
    put_public_email_template_request: shared_putpublicemailtemplaterequest.PUTPublicEmailTemplateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
