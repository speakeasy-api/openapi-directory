 ...
 */
export enum CreateNetworkSwitchAccessPolicyRequestBodyDot1xControlDirectionEnum {
  Both = "both",
  Inbound = "inbound",
}
 ...
 * 802.1x Settings
 */
export class CreateNetworkSwitchAccessPolicyRequestBodyDot1x extends SpeakeasyBase {
  /**
   * Supports either 'both' or 'inbound'. Set to 'inbound' to allow unauthorized egress on the switchport. Set to 'both' to control both traffic directions with authorization. Defaults to 'both'
   */
  @SpeakeasyMetadata()
...
export class CreateNetworkSwitchAccessPolicyRequestBodyRadius extends SpeakeasyBase {
  ...
  @Type(() => CreateNetworkSwitchAccessPolicyRequestBodyRadiusCriticalAuth)
...
export class CreateNetworkSwitchAccessPolicyRequestBody extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "dot1x" })
  @Type(() => CreateNetworkSwitchAccessPolicyRequestBodyDot1x)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "radius" })
  @Type(() => CreateNetworkSwitchAccessPolicyRequestBodyRadius)
  ...
  @Type(() => CreateNetworkSwitchAccessPolicyRequestBodyRadiusAccountingServers)
  ...
  @Type(() => CreateNetworkSwitchAccessPolicyRequestBodyRadiusServers)
 ...
 * Access Type of the policy. Automatically 'Hybrid authentication' when hostMode is 'Multi-Domain'.
 */
export enum CreateNetworkSwitchAccessPolicy201ApplicationJSONAccessPolicyTypeEnum {
  EightHundredAndTwo1x = "802.1x",
  HybridAuthentication = "Hybrid authentication",
  MACAuthenticationBypass = "MAC authentication bypass",
}
 ...
 * Supports either 'both' or 'inbound'. Set to 'inbound' to allow unauthorized egress on the switchport. Set to 'both' to control both traffic directions with authorization. Defaults to 'both'
 */
export enum CreateNetworkSwitchAccessPolicy201ApplicationJSONDot1xControlDirectionEnum {
  Both = "both",
  Inbound = "inbound",
}
 ...
 * 802.1x Settings
 */
export class CreateNetworkSwitchAccessPolicy201ApplicationJSONDot1x extends SpeakeasyBase {
  /**
   * Supports either 'both' or 'inbound'. Set to 'inbound' to allow unauthorized egress on the switchport. Set to 'both' to control both traffic directions with authorization. Defaults to 'both'
   */
  @SpeakeasyMetadata()
 ...
 * Choose the Host Mode for the access policy.
 */
export enum CreateNetworkSwitchAccessPolicy201ApplicationJSONHostModeEnum {
  MultiAuth = "Multi-Auth",
  MultiDomain = "Multi-Domain",
  MultiHost = "Multi-Host",
  SingleHost = "Single-Host",
 ...
 * Critical auth settings for when authentication is rejected by the RADIUS server
 */
export class CreateNetworkSwitchAccessPolicy201ApplicationJSONRadiusCriticalAuth extends SpeakeasyBase {
  /**
   * VLAN that clients who use data will be placed on when RADIUS authentication fails. Will be null if hostMode is Multi-Auth
   */
  @SpeakeasyMetadata()
 ...
 * Object for RADIUS Settings
 */
export class CreateNetworkSwitchAccessPolicy201ApplicationJSONRadius extends SpeakeasyBase {
  /**
   * Critical auth settings for when authentication is rejected by the RADIUS server
   */
  @SpeakeasyMetadata()
  @Expose({ name: "criticalAuth" })
  @Type(
    () => CreateNetworkSwitchAccessPolicy201ApplicationJSONRadiusCriticalAuth
  )
...
export class CreateNetworkSwitchAccessPolicy201ApplicationJSONRadiusAccountingServers extends SpeakeasyBase {
  /**
   * Public IP address of the RADIUS accounting server
   */
  @SpeakeasyMetadata()
...
export class CreateNetworkSwitchAccessPolicy201ApplicationJSONRadiusServers extends SpeakeasyBase {
  /**
   * Public IP address of the RADIUS server
   */
  @SpeakeasyMetadata()
 ...
 */
export class CreateNetworkSwitchAccessPolicy201ApplicationJSON extends SpeakeasyBase {
  /**
   * Access Type of the policy. Automatically 'Hybrid authentication' when hostMode is 'Multi-Domain'.
   */
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "dot1x" })
  @Type(() => CreateNetworkSwitchAccessPolicy201ApplicationJSONDot1x)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "radius" })
  @Type(() => CreateNetworkSwitchAccessPolicy201ApplicationJSONRadius)
  ...
  @SpeakeasyMetadata({
    elemType:
      CreateNetworkSwitchAccessPolicy201ApplicationJSONRadiusAccountingServers,
  })
  @Expose({ name: "radiusAccountingServers" })
  @Type(
    () =>
  ...
  @Expose({ name: "radiusServers" })
  @Type(() => CreateNetworkSwitchAccessPolicy201ApplicationJSONRadiusServers)
