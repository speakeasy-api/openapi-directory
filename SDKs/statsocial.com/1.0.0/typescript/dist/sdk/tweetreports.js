...
var TweetReports = /** @class */ (function () {
    ...
    TweetReports.prototype.getReportsTweetCreate = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetReportsTweetCreateResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.createTweet = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.CreateTweet);
                    }
                    break;
    ...
    TweetReports.prototype.postReportsTweetCreate = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostReportsTweetCreateResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
