...
public class GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction {
    /**
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withAmountAfterCharges(Long amountAfterCharges) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withAmountBeforeCharges(Long amountBeforeCharges) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withBalance(Long balance) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1TransactionBatchItemDetails batchItemDetails;

    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withBatchItemDetails(GetTransactionsByAccountIdFilteredCardTransactionsv1TransactionBatchItemDetails batchItemDetails) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("card")
    public GetTransactionsByAccountIdFilteredCardTransactionsv1TransactionRelatedCard card;

    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withCard(GetTransactionsByAccountIdFilteredCardTransactionsv1TransactionRelatedCard card) {
        this.card = card;
        return this;
    }
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1TransactionCurrency currency;

    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withCurrency(GetTransactionsByAccountIdFilteredCardTransactionsv1TransactionCurrency currency) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withDate(OffsetDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withDateAcknowledged(OffsetDateTime dateAcknowledged) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1TransactionDirectDebitDetails directDebitDetails;

    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withDirectDebitDetails(GetTransactionsByAccountIdFilteredCardTransactionsv1TransactionDirectDebitDetails directDebitDetails) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withEventUuid(String eventUuid) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withFeeAmount(Long feeAmount) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1TransactionFxTrade fxTradeDetails;

    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withFxTradeDetails(GetTransactionsByAccountIdFilteredCardTransactionsv1TransactionFxTrade fxTradeDetails) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withIcan(Long ican) {
        this.ican = ican;
        return this;
    }
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withMyRef(String myRef) {
        this.myRef = myRef;
        return this;
    }
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withPaymentRequestPublicCode(String paymentRequestPublicCode) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1TransactionProprietarySchemeDetails[] proprietarySchemeDetails;

    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withProprietarySchemeDetails(GetTransactionsByAccountIdFilteredCardTransactionsv1TransactionProprietarySchemeDetails[] proprietarySchemeDetails) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withRefId(Long refId) {
        this.refId = refId;
        return this;
    }
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withRelatedParty(Object relatedParty) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withTaxAmount(Long taxAmount) {
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withTxnId(Long txnId) {
        this.txnId = txnId;
        return this;
    }
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction withYourRef(String yourRef) {
        this.yourRef = yourRef;
        return this;
    }
    
    public GetTransactionsByAccountIdFilteredCardTransactionsv1Transaction(){}
}
