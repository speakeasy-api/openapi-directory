...
export class TypeBioOntologyAssay {
  ...
  searchBioOntologyAssay(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/bio_ontology_assay";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchBioOntologyAssayResponse =
        new operations.SearchBioOntologyAssayResponse({
