...
var TaskCountResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "num_completed_milestones" }),
        __metadata("design:type", Number)
    ], TaskCountResponse.prototype, "numCompletedMilestones", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "num_completed_tasks" }),
        __metadata("design:type", Number)
    ], TaskCountResponse.prototype, "numCompletedTasks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "num_incomplete_milestones" }),
        __metadata("design:type", Number)
    ], TaskCountResponse.prototype, "numIncompleteMilestones", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "num_incomplete_tasks" }),
        __metadata("design:type", Number)
    ], TaskCountResponse.prototype, "numIncompleteTasks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "num_milestones" }),
        __metadata("design:type", Number)
    ], TaskCountResponse.prototype, "numMilestones", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "num_tasks" }),
        __metadata("design:type", Number)
