...
class GetDisableLoggingQueryParams:
    action: GetDisableLoggingActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    cluster_identifier: str = dataclasses.field(metadata={'query_param': { 'field_name': 'ClusterIdentifier', 'style': 'form', 'explode': True }})
    version: GetDisableLoggingVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDisableLoggingRequest:
    headers: GetDisableLoggingHeaders = dataclasses.field()
    query_params: GetDisableLoggingQueryParams = dataclasses.field()
