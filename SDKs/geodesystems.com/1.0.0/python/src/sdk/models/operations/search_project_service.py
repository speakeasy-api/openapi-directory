...
class SearchProjectServiceQueryParams:
    ...
    search_project_service_provider: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_service.provider', 'style': 'form', 'explode': True }})
    search_project_service_service_type: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_service.service_type', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchProjectServiceRequest:
    query_params: SearchProjectServiceQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectServiceResponse:
