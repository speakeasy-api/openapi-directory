...
class EssentialcontactsProjectsContactsComputeRequest
{
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\EssentialcontactsProjectsContactsComputeNotificationCategoriesEnum> $notificationCategories
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=notificationCategories')]
    public ?array $notificationCategories = null;
