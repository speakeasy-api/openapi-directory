...
class Settings:
    ...
    def create_and_preserve_key_pair(self, request: operations.CreateAndPreserveKeyPairRequest) -> operations.CreateAndPreserveKeyPairResponse:
        ...
        * Existence of own key pair
        ...
        res = operations.CreateAndPreserveKeyPairResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_system_rescue_key_pair(self, request: operations.RemoveSystemRescueKeyPairRequest) -> operations.RemoveSystemRescueKeyPairResponse:
        ...
        * Existence of own key pair
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RemoveSystemRescueKeyPairRequest, request)
        ...
        res = operations.RemoveSystemRescueKeyPairResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_webhook(self, request: operations.RemoveWebhookRequest) -> operations.RemoveWebhookResponse:
        ...
        url = utils.generate_url(operations.RemoveWebhookRequest, base_url, '/v4/settings/webhooks/{webhook_id}', request)
        ...
        res = operations.RemoveWebhookResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_all_system_rescue_key_pairs(self, request: operations.RequestAllSystemRescueKeyPairsRequest) -> operations.RequestAllSystemRescueKeyPairsResponse:
        ...
        * Existence of own key pair
        ...
        res = operations.RequestAllSystemRescueKeyPairsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_list_of_event_types_for_config_manager(self, request: operations.RequestListOfEventTypesForConfigManagerRequest) -> operations.RequestListOfEventTypesForConfigManagerResponse:
        ...
        res = operations.RequestListOfEventTypesForConfigManagerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.EventTypeList])
    ...
    def request_list_of_webhooks(self, request: operations.RequestListOfWebhooksRequest) -> operations.RequestListOfWebhooksResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestListOfWebhooksRequest, request)
        ...
        res = operations.RequestListOfWebhooksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.WebhookList])
    ...
    def request_notification_channels(self, request: operations.RequestNotificationChannelsRequest) -> operations.RequestNotificationChannelsResponse:
        ...
        res = operations.RequestNotificationChannelsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.NotificationChannelList])
    ...
    def request_settings(self, request: operations.RequestSettingsRequest) -> operations.RequestSettingsResponse:
        ...
        res = operations.RequestSettingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CustomerSettingsResponse])
    ...
    def request_system_rescue_key_pair(self, request: operations.RequestSystemRescueKeyPairRequest) -> operations.RequestSystemRescueKeyPairResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestSystemRescueKeyPairRequest, request)
        ...
        res = operations.RequestSystemRescueKeyPairResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_webhook(self, request: operations.RequestWebhookRequest) -> operations.RequestWebhookResponse:
        ...
        url = utils.generate_url(operations.RequestWebhookRequest, base_url, '/v4/settings/webhooks/{webhook_id}', request)
        ...
        res = operations.RequestWebhookResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def reset_webhook_lifetime(self, request: operations.ResetWebhookLifetimeRequest) -> operations.ResetWebhookLifetimeResponse:
        ...
        url = utils.generate_url(operations.ResetWebhookLifetimeRequest, base_url, '/v4/settings/webhooks/{webhook_id}/reset_lifetime', request)
        ...
        res = operations.ResetWebhookLifetimeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def set_settings(self, request: operations.SetSettingsRequest) -> operations.SetSettingsResponse:
        ...
        * Illegal characters in names:  
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "customer_settings_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SetSettingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def set_system_rescue_key_pair(self, request: operations.SetSystemRescueKeyPairRequest) -> operations.SetSystemRescueKeyPairResponse:
        ...
        * Existence of own key pair
        ...
        res = operations.SetSystemRescueKeyPairResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def toggle_notification_channels(self, request: operations.ToggleNotificationChannelsRequest) -> operations.ToggleNotificationChannelsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "notification_channel_activation_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ToggleNotificationChannelsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_webhook(self, request: operations.UpdateWebhookRequest) -> operations.UpdateWebhookResponse:
        ...
        url = utils.generate_url(operations.UpdateWebhookRequest, base_url, '/v4/settings/webhooks/{webhook_id}', request)
