...
type StartPaymentInitiationCancellationAuthorisationPathParams struct {
...
type StartPaymentInitiationCancellationAuthorisationHeaders struct {
...
type StartPaymentInitiationCancellationAuthorisationSecurity struct {
	BearerAuthOAuth *shared.SchemeBearerAuthOAuth `security:"scheme,type=http,subtype=bearer"`
}

type StartPaymentInitiationCancellationAuthorisationRequest struct {
...
type StartPaymentInitiationCancellationAuthorisationResponse struct {
	ContentType             string
