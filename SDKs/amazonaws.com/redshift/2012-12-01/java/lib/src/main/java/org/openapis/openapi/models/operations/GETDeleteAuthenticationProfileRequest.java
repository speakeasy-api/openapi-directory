...
public class GETDeleteAuthenticationProfileRequest {
    ...
    public GETDeleteAuthenticationProfileRequest(@JsonProperty("Action") GETDeleteAuthenticationProfileActionEnum action, @JsonProperty("AuthenticationProfileName") String authenticationProfileName, @JsonProperty("Version") GETDeleteAuthenticationProfileVersionEnum version) {
        this.action = action;
        this.authenticationProfileName = authenticationProfileName;
        this.version = version;
  }
