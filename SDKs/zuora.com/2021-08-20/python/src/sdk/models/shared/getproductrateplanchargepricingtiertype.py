...
class GETProductRatePlanChargePricingTierType:
    ...
    ending_unit: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('endingUnit'), 'exclude': lambda f: f is None }})
    ...
    - per unit
    """  
    starting_unit: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('startingUnit'), 'exclude': lambda f: f is None }})
