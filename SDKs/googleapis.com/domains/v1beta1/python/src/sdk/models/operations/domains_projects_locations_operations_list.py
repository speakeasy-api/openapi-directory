...
class DomainsProjectsLocationsOperationsListRequest:
    path_params: DomainsProjectsLocationsOperationsListPathParams = dataclasses.field()
    query_params: DomainsProjectsLocationsOperationsListQueryParams = dataclasses.field()
    security: DomainsProjectsLocationsOperationsListSecurity = dataclasses.field()
