...
type MybusinessverificationsLocationsFetchVerificationOptionsPathParams struct {
	// Required. The location to verify.
	Location string `pathParam:"style=simple,explode=false,name=location"`
}

type MybusinessverificationsLocationsFetchVerificationOptionsQueryParams struct {
	// V1 error format.
...
type MybusinessverificationsLocationsFetchVerificationOptionsRequest struct {
...
type MybusinessverificationsLocationsFetchVerificationOptionsResponse struct {
	ContentType string
	// Successful response
