...
const (
	TagResourceXAmzTargetEnumCodeCommit20150413TagResource TagResourceXAmzTargetEnum = "CodeCommit_20150413.TagResource"
)
...
func (e *TagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "CodeCommit_20150413.TagResource":
...
type TagResourceResponse struct {
	...
	TagsMapRequiredException interface{}
