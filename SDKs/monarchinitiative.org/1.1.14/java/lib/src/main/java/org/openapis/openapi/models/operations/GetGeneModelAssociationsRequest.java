...
public class GetGeneModelAssociationsRequest {
    ...
    public GetGeneModelAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGeneModelAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGeneModelAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGeneModelAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGeneModelAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGeneModelAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGeneModelAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGeneModelAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGeneModelAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGeneModelAssociationsRequest withRelation(String relation) {
    ...
    public GetGeneModelAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGeneModelAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGeneModelAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetGeneModelAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGeneModelAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGeneModelAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGeneModelAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGeneModelAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
