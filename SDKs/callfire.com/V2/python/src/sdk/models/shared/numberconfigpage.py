...
class NumberConfigPage:
    ...
    items: Optional[list[shared_numberconfig.NumberConfig]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})  
