...
var Authentication = /** @class */ (function () {
    ...
    Authentication.prototype.requestAccessToken = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/keys/{keyName}/requestToken", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.RequestAccessTokenResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) >= 200 && (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) < 300:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.tokenDetails = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.TokenDetails);
                    }
