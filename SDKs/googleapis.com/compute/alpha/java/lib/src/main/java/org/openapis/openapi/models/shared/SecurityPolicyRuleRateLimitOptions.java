...
public class SecurityPolicyRuleRateLimitOptions {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("exceedActionRpcStatus")
    public SecurityPolicyRuleRateLimitOptionsRpcStatus exceedActionRpcStatus;

    public SecurityPolicyRuleRateLimitOptions withExceedActionRpcStatus(SecurityPolicyRuleRateLimitOptionsRpcStatus exceedActionRpcStatus) {
