...
type CreateDistribution20170325Headers struct {
...
type CreateDistribution20170325RequestBodyDistributionConfig struct {
...
type CreateDistribution20170325RequestBody struct {
	// A distribution configuration.
	DistributionConfig CreateDistribution20170325RequestBodyDistributionConfig
}

type CreateDistribution20170325Request struct {
	Headers CreateDistribution20170325Headers
	Request []byte `request:"mediaType=text/xml"`
}

type CreateDistribution20170325Response struct {
	Body        []byte
	ContentType string
	StatusCode  int
