...
class ListUsageRecordAllTimeListUsageRecordAllTimeResponse:
    ...
    usage_records: Optional[list[shared_api_v2010_account_usage_usage_record_usage_record_all_time.APIV2010AccountUsageUsageRecordUsageRecordAllTime]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('usage_records'), 'exclude': lambda f: f is None }})  
