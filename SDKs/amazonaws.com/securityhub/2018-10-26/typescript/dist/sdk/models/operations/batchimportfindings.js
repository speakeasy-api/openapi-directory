...
exports.BatchImportFindingsResponse = exports.BatchImportFindingsRequest = exports.BatchImportFindingsRequestBody = void 0;
...
var BatchImportFindingsRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.AwsSecurityFinding }),
        (0, class_transformer_1.Expose)({ name: "Findings" }),
        (0, class_transformer_1.Type)(function () { return shared.AwsSecurityFinding; }),
        __metadata("design:type", Array)
    ], BatchImportFindingsRequestBody.prototype, "findings", void 0);
    return BatchImportFindingsRequestBody;
}(utils_1.SpeakeasyBase));
exports.BatchImportFindingsRequestBody = BatchImportFindingsRequestBody;
var BatchImportFindingsRequest = /** @class */ (function (_super) {
    ...
    ], BatchImportFindingsRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], BatchImportFindingsRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], BatchImportFindingsRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], BatchImportFindingsRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], BatchImportFindingsRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], BatchImportFindingsRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], BatchImportFindingsRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], BatchImportFindingsRequest.prototype, "xAmzSignedHeaders", void 0);
...
var BatchImportFindingsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], BatchImportFindingsResponse.prototype, "rawResponse", void 0);
