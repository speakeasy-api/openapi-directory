...
public class SDK {
    ...
    public openapisdk.models.operations.FetchPhoneNumberResponse fetchPhoneNumber(openapisdk.models.operations.FetchPhoneNumberRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/PhoneNumbers/{PhoneNumber}", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.LookupsV1PhoneNumber out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.LookupsV1PhoneNumber.class);
