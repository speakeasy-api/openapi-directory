...
export class GoogleCloudRetailV2ProductInput extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2FulfillmentInfo })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2Image })
  @Expose({ name: "images" })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2Promotion })
