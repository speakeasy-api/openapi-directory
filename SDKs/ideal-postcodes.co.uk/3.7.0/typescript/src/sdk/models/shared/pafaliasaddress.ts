...
export enum PafAliasAddressCountryEnum {
  England = "England",
  Scotland = "Scotland",
  Wales = "Wales",
...
export enum PafAliasAddressCountryIsoEnum {
  Gbr = "GBR",
  Imn = "IMN",
  Jey = "JEY",
  Ggy = "GGY",
...
export enum PafAliasAddressCountryIso2Enum {
  Gb = "GB",
  Im = "IM",
  Je = "JE",
  Gg = "GG",
...
export enum PafAliasAddressDatasetEnum {
  Pafa = "pafa",
}

export enum PafAliasAddressLanguageEnum {
  En = "en",
}
 ...
 */
export class PafAliasAddress extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "country" })
  country: PafAliasAddressCountryEnum;

  @SpeakeasyMetadata()
  @Expose({ name: "country_iso" })
  countryIso: PafAliasAddressCountryIsoEnum;

  @SpeakeasyMetadata()
  @Expose({ name: "country_iso_2" })
  countryIso2: PafAliasAddressCountryIso2Enum;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "dataset" })
  dataset: PafAliasAddressDatasetEnum;
  ...
  language: PafAliasAddressLanguageEnum;
