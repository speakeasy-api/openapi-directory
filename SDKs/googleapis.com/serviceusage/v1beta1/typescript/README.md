...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/googleapis.com/serviceusage/v1beta1/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/googleapis.com/serviceusage/v1beta1/typescript
```
...
```typescript
import {
  ServiceusageOperationsListRequest,
  ServiceusageOperationsListResponse
