...
class ListMapsResponseEntryPricingPlanEnum(str, Enum):
...
class ListMapsResponseEntry:
    r"""Contains details of an existing map resource in your Amazon Web Services account."""
    ...
    pricing_plan: Optional[ListMapsResponseEntryPricingPlanEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PricingPlan'), 'exclude': lambda f: f is None }})  
