...
class ListSlotTypesResponse:
    ...
    slot_type_summaries: Optional[list[shared_slottypesummary.SlotTypeSummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('slotTypeSummaries'), 'exclude': lambda f: f is None }})  
