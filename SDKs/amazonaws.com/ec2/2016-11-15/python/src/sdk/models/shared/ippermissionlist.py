...
class IPPermissionListIPRanges:
...
@dataclasses.dataclass
class IPPermissionListIpv6Ranges:
...
@dataclasses.dataclass
class IPPermissionListUserIDGroupPairs:
...
class IPPermissionList:
    ...
    ip_ranges: Optional[list[IPPermissionListIPRanges]] = dataclasses.field(default=None)  
    ipv6_ranges: Optional[list[IPPermissionListIpv6Ranges]] = dataclasses.field(default=None)  
    prefix_list_ids: Optional[list[IPPermissionListPrefixListIds]] = dataclasses.field(default=None)  
    to_port: Optional[int] = dataclasses.field(default=None)  
    user_id_group_pairs: Optional[list[IPPermissionListUserIDGroupPairs]] = dataclasses.field(default=None)  
