...
type EssentialcontactsProjectsContactsCreateSecurity struct {
...
type EssentialcontactsProjectsContactsCreateRequest struct {
	...
	GoogleCloudEssentialcontactsV1ContactInput *shared.GoogleCloudEssentialcontactsV1ContactInput `request:"mediaType=application/json"`
	// OAuth access token.
...
type EssentialcontactsProjectsContactsCreateResponse struct {
	ContentType string
	// Successful response
