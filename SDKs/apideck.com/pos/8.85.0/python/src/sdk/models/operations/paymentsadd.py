...
from ..shared import createpospaymentresponse as shared_createpospaymentresponse
...
class PaymentsAddRequest:
    headers: PaymentsAddHeaders = dataclasses.field()
    query_params: PaymentsAddQueryParams = dataclasses.field()
    request: shared_pospayment.PosPaymentInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: PaymentsAddSecurity = dataclasses.field()
...
class PaymentsAddResponse:
    ...
    create_pos_payment_response: Optional[shared_createpospaymentresponse.CreatePosPaymentResponse] = dataclasses.field(default=None)
