...
export class BackgroundRemoval {
  ...
  **/
  postRemovebg(
  ...
  ): Promise<operations.PostRemovebgResponse> {
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.PostRemovebgResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.removeBgJsonResponse = httpRes?.data;
            }
