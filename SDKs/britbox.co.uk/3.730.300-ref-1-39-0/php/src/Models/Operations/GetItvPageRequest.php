...
class GetItvPageRequest
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetItvPageItemDetailExpandEnum $itemDetailExpand
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=item_detail_expand')]
    public ?GetItvPageItemDetailExpandEnum $itemDetailExpand = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetItvPageItemDetailSelectSeasonEnum $itemDetailSelectSeason
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=item_detail_select_season')]
    public ?GetItvPageItemDetailSelectSeasonEnum $itemDetailSelectSeason = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetItvPageTextEntryFormatEnum $textEntryFormat
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=text_entry_format')]
    public ?GetItvPageTextEntryFormatEnum $textEntryFormat = null;
