...
type GetNetworkAlertsHistoryPathParams struct {
...
type GetNetworkAlertsHistoryRequest struct {
	PathParams  GetNetworkAlertsHistoryPathParams
	QueryParams GetNetworkAlertsHistoryQueryParams
}
...
type GetNetworkAlertsHistory200ApplicationJSON struct {
	...
	// time when the event that caused the alert occurred
