...
class GetGenericAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGenericAssociationsQueryParams:
...
@dataclasses.dataclass
class GetGenericAssociationsRequest:
    path_params: GetGenericAssociationsPathParams = dataclasses.field()
    query_params: GetGenericAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetGenericAssociationsResponse:
