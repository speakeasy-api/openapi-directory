...
class FileGetNodeFilePropertiesFromComputeNodeRequest:
    headers: FileGetNodeFilePropertiesFromComputeNodeHeaders = dataclasses.field()
    path_params: FileGetNodeFilePropertiesFromComputeNodePathParams = dataclasses.field()
    query_params: FileGetNodeFilePropertiesFromComputeNodeQueryParams = dataclasses.field()
