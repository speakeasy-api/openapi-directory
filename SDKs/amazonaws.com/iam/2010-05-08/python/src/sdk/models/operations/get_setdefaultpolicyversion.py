...
@dataclasses.dataclass
class GetSetDefaultPolicyVersionHeaders:
...
class GetSetDefaultPolicyVersionRequest:
    headers: GetSetDefaultPolicyVersionHeaders = dataclasses.field()
    query_params: GetSetDefaultPolicyVersionQueryParams = dataclasses.field()
