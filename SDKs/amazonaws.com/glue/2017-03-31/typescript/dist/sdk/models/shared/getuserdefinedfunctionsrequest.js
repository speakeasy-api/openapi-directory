...
exports.GetUserDefinedFunctionsRequest = void 0;
...
var GetUserDefinedFunctionsRequest = /** @class */ (function (_super) {
    ...
    ], GetUserDefinedFunctionsRequest.prototype, "catalogId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=DatabaseName" }),
        __metadata("design:type", String)
    ], GetUserDefinedFunctionsRequest.prototype, "databaseName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MaxResults" }),
        __metadata("design:type", Number)
    ], GetUserDefinedFunctionsRequest.prototype, "maxResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], GetUserDefinedFunctionsRequest.prototype, "nextToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Pattern" }),
        __metadata("design:type", String)
    ], GetUserDefinedFunctionsRequest.prototype, "pattern", void 0);
