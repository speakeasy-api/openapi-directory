...
class BatchGetBuildBatchesRequest:
    ...
    batch_get_build_batches_input: shared_batchgetbuildbatchesinput.BatchGetBuildBatchesInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
