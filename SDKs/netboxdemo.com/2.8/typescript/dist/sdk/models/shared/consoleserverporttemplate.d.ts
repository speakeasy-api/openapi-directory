...
export declare enum ConsoleServerPortTemplateTypeLabelEnum {
    De9 = "DE-9",
    Db25 = "DB-25",
    Rj11 = "RJ-11",
    Rj12 = "RJ-12",
...
export declare class ConsoleServerPortTemplateType extends SpeakeasyBase {
    label: ConsoleServerPortTemplateTypeLabelEnum;
    value: ConsoleServerPortTemplateTypeValueEnum;
}
export declare class ConsoleServerPortTemplate extends SpeakeasyBase {
