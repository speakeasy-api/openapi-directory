...
public class UpdateSigningBasketPsuDataRequest {
    ...
    public UpdateSigningBasketPsuDataRequest withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public UpdateSigningBasketPsuDataRequest withPSUAccept(String psuAccept) {
    ...
    public UpdateSigningBasketPsuDataRequest withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public UpdateSigningBasketPsuDataRequest withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public UpdateSigningBasketPsuDataRequest withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public UpdateSigningBasketPsuDataRequest withPSUCorporateID(String psuCorporateID) {
    ...
    public UpdateSigningBasketPsuDataRequest withPSUCorporateIDType(String psuCorporateIDType) {
    ...
    public UpdateSigningBasketPsuDataRequest withPSUDeviceID(String psuDeviceID) {
    ...
    public UpdateSigningBasketPsuDataRequest withPSUGeoLocation(String psuGeoLocation) {
    ...
    public UpdateSigningBasketPsuDataRequest withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public UpdateSigningBasketPsuDataRequest withPsuId(String psuId) {
        this.psuId = psuId;
        return this;
    }
    ...
    public UpdateSigningBasketPsuDataRequest withPSUIDType(String psuIDType) {
    ...
    public UpdateSigningBasketPsuDataRequest withPSUIPAddress(String psuIPAddress) {
    ...
    public UpdateSigningBasketPsuDataRequest withPSUIPPort(String psuIPPort) {
    ...
    public UpdateSigningBasketPsuDataRequest withPSUUserAgent(String psuUserAgent) {
    ...
    public UpdateSigningBasketPsuDataRequest withRequestBody(Object requestBody) {
    ...
    public UpdateSigningBasketPsuDataRequest withSignature(String signature) {
    ...
    public UpdateSigningBasketPsuDataRequest withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public UpdateSigningBasketPsuDataRequest withXRequestID(String xRequestID) {
    ...
    public UpdateSigningBasketPsuDataRequest withAuthorisationId(String authorisationId) {
    ...
    public UpdateSigningBasketPsuDataRequest withBasketId(String basketId) {
        this.basketId = basketId;
        return this;
    }
    
    public UpdateSigningBasketPsuDataRequest(@JsonProperty("X-Request-ID") String xRequestID, @JsonProperty("authorisationId") String authorisationId, @JsonProperty("basketId") String basketId) {
        this.xRequestID = xRequestID;
        this.authorisationId = authorisationId;
        this.basketId = basketId;
  }
