...
from ..shared import listentitiesfilter as shared_listentitiesfilter
...
class ListEntitiesRequestBody:
    ...
    filters: Optional[list[shared_listentitiesfilter.ListEntitiesFilter]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filters'), 'exclude': lambda f: f is None }})
    r"""<p>A list of objects that filter the request.</p> <note> <p>Only one object is accepted as a valid input.</p> </note>"""  
