...
exports.ApiSpecOutput = exports.ApiSpecInput = void 0;
 ...
 * An ApiSpec describes a version of an API in a structured way. ApiSpecs provide formal descriptions that consumers can use to use a version. ApiSpec resources are intended to be fully-resolved descriptions of an ApiVersion. When specs consist of multiple files, these should be bundled together (e.g. in a zip archive) and stored as a unit. Multiple specs can exist to provide representations in different API description formats. Synchronization of these representations would be provided by tooling and background services.
 */
var ApiSpecOutput = /** @class */ (function (_super) {
    __extends(ApiSpecOutput, _super);
    function ApiSpecOutput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "annotations" }),
        __metadata("design:type", Object)
    ], ApiSpecOutput.prototype, "annotations", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    ], ApiSpecOutput.prototype, "createTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "description" }),
        __metadata("design:type", String)
    ], ApiSpecOutput.prototype, "description", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "filename" }),
        __metadata("design:type", String)
    ], ApiSpecOutput.prototype, "filename", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "hash" }),
        __metadata("design:type", String)
    ], ApiSpecOutput.prototype, "hash", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "labels" }),
        __metadata("design:type", Object)
    ], ApiSpecOutput.prototype, "labels", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "mimeType" }),
        __metadata("design:type", String)
    ], ApiSpecOutput.prototype, "mimeType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "name" }),
        __metadata("design:type", String)
    ], ApiSpecOutput.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", Date)
    ], ApiSpecOutput.prototype, "revisionCreateTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "revisionId" }),
        __metadata("design:type", String)
    ], ApiSpecOutput.prototype, "revisionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", Date)
    ], ApiSpecOutput.prototype, "revisionUpdateTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "sizeBytes" }),
        __metadata("design:type", Number)
    ], ApiSpecOutput.prototype, "sizeBytes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "sourceUri" }),
        __metadata("design:type", String)
    ], ApiSpecOutput.prototype, "sourceUri", void 0);
    return ApiSpecOutput;
}(utils_1.SpeakeasyBase));
exports.ApiSpecOutput = ApiSpecOutput;
