...
class GetModelGenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetModelGenotypeAssociationsQueryParams:
...
@dataclasses.dataclass
class GetModelGenotypeAssociationsRequest:
    path_params: GetModelGenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetModelGenotypeAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetModelGenotypeAssociationsResponse:
