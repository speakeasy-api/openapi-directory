...
type WritablePowerOutletConnectionStatusEnum string

const (
	WritablePowerOutletConnectionStatusEnumFalse WritablePowerOutletConnectionStatusEnum = "false"
	WritablePowerOutletConnectionStatusEnumTrue  WritablePowerOutletConnectionStatusEnum = "true"
)

func (e *WritablePowerOutletConnectionStatusEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "false":
		fallthrough
	case "true":
		*e = WritablePowerOutletConnectionStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WritablePowerOutletConnectionStatusEnum: %s", s)
	}
}
...
func (e *WritablePowerOutletFeedLegEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "B":
		fallthrough
	case "C":
		*e = WritablePowerOutletFeedLegEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WritablePowerOutletFeedLegEnum: %s", s)
	}
}
...
func (e *WritablePowerOutletTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "ita-o":
		fallthrough
	case "hdot-cx":
		*e = WritablePowerOutletTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WritablePowerOutletTypeEnum: %s", s)
	}
}

type WritablePowerOutletInput struct {
	Cable            *NestedCableInput                        `json:"cable,omitempty"`
	ConnectionStatus *WritablePowerOutletConnectionStatusEnum `json:"connection_status,omitempty"`
