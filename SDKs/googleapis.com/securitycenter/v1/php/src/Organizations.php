...
class Organizations 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsAssetsRunDiscoveryResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/assets:runDiscovery', \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsAssetsRunDiscoveryRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}:cancel', \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsCancelRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/sources', \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsSourcesCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/findings', \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsSourcesFindingsCreateRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "findingInput", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{resource}:getIamPolicy', \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsSourcesGetIamPolicyRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{resource}:setIamPolicy', \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsSourcesSetIamPolicyRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{resource}:testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsSourcesTestIamPermissionsRequest::class, $request);
