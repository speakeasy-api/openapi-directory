...
class TextOperatorOptions:
    ...
    exact_match_with_operator: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('exactMatchWithOperator'), 'exclude': lambda f: f is None }})
