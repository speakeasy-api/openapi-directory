...
class ListSecretsRequest:
    ...
    include_planned_deletion: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('IncludePlannedDeletion'), 'exclude': lambda f: f is None }})  
