...
export class IapProjectsIapTunnelLocationsDestGroupsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IapProjectsIapTunnelLocationsDestGroupsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=tunnelDestGroupId",
  })
...
export class IapProjectsIapTunnelLocationsDestGroupsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
