...
exports.PreviewSyncService = void 0;
...
var PreviewSyncService = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=acl_enabled" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reachability_webhooks_enabled" }),
        __metadata("design:type", Boolean)
...
exports.PreviewSyncService = PreviewSyncService;
