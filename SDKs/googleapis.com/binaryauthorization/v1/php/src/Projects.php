...
class Projects 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\BinaryauthorizationProjectsAttestorsCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/attestors', \OpenAPI\OpenAPI\Models\Operations\BinaryauthorizationProjectsAttestorsCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\BinaryauthorizationProjectsAttestorsDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/attestors', \OpenAPI\OpenAPI\Models\Operations\BinaryauthorizationProjectsAttestorsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\BinaryauthorizationProjectsAttestorsUpdateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{attestor}:validateAttestationOccurrence', \OpenAPI\OpenAPI\Models\Operations\BinaryauthorizationProjectsAttestorsValidateAttestationOccurrenceRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{resource}:getIamPolicy', \OpenAPI\OpenAPI\Models\Operations\BinaryauthorizationProjectsPolicyGetIamPolicyRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{resource}:setIamPolicy', \OpenAPI\OpenAPI\Models\Operations\BinaryauthorizationProjectsPolicySetIamPolicyRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{resource}:testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\BinaryauthorizationProjectsPolicyTestIamPermissionsRequest::class, $request);
