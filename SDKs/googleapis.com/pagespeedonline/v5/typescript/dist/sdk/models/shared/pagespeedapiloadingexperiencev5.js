...
var PagespeedApiLoadingExperienceV5 = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "initial_url" }),
        __metadata("design:type", String)
    ], PagespeedApiLoadingExperienceV5.prototype, "initialUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: userpageloadmetricv5_1.UserPageLoadMetricV5 }),
        (0, class_transformer_1.Expose)({ name: "metrics" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], userpageloadmetricv5_1.UserPageLoadMetricV5);
            }
            return obj;
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "origin_fallback" }),
        __metadata("design:type", Boolean)
    ], PagespeedApiLoadingExperienceV5.prototype, "originFallback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "overall_category" }),
        __metadata("design:type", String)
