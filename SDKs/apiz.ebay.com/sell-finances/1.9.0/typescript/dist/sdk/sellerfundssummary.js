...
exports.SellerFundsSummary = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var SellerFundsSummary = /** @class */ (function () {
    function SellerFundsSummary(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    SellerFundsSummary.prototype.getSellerFundsSummary = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetSellerFundsSummaryRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/seller_funds_summary";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.sellerFundsSummaryResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
...
exports.SellerFundsSummary = SellerFundsSummary;
