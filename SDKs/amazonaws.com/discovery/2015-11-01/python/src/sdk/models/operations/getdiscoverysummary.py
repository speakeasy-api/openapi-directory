...
from ..shared import getdiscoverysummaryresponse as shared_getdiscoverysummaryresponse
...
class GetDiscoverySummaryHeaders:
    x_amz_target: GetDiscoverySummaryXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDiscoverySummaryRequest:
    headers: GetDiscoverySummaryHeaders = dataclasses.field()
...
class GetDiscoverySummaryResponse:
    ...
    get_discovery_summary_response: Optional[shared_getdiscoverysummaryresponse.GetDiscoverySummaryResponse] = dataclasses.field(default=None)
