...
public class ListLoggingConfigurationsRequest {
    ...
    public ListLoggingConfigurationsRequestBody requestBody;

    public ListLoggingConfigurationsRequest withRequestBody(ListLoggingConfigurationsRequestBody requestBody) {
    ...
    public ListLoggingConfigurationsRequest withMaxResults(String maxResults) {
    ...
    public ListLoggingConfigurationsRequest(@JsonProperty("RequestBody") ListLoggingConfigurationsRequestBody requestBody) {
        this.requestBody = requestBody;
  }
}
