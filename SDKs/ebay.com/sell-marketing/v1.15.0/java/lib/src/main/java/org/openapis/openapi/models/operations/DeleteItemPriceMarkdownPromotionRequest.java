...
public class DeleteItemPriceMarkdownPromotionRequest {
    ...
    public DeleteItemPriceMarkdownPromotionRequest withPromotionId(String promotionId) {
        this.promotionId = promotionId;
        return this;
    }
    
    public DeleteItemPriceMarkdownPromotionRequest(@JsonProperty("promotion_id") String promotionId) {
        this.promotionId = promotionId;
  }
}
