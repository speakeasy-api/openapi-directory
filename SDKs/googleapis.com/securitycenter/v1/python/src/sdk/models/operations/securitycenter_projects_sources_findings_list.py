...
class SecuritycenterProjectsSourcesFindingsListPathParams:
    parent: str = dataclasses.field(metadata={'path_param': { 'field_name': 'parent', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class SecuritycenterProjectsSourcesFindingsListQueryParams:
...
class SecuritycenterProjectsSourcesFindingsListRequest:
    path_params: SecuritycenterProjectsSourcesFindingsListPathParams = dataclasses.field()
    query_params: SecuritycenterProjectsSourcesFindingsListQueryParams = dataclasses.field()
    security: SecuritycenterProjectsSourcesFindingsListSecurity = dataclasses.field()
