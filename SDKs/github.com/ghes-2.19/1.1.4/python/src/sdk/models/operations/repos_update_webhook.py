...
class ReposUpdateWebhookRequestBody:
    ...
    add_events: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('add_events') }})
    config: Optional[ReposUpdateWebhookRequestBodyConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('config') }})
    events: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('events') }})
    remove_events: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('remove_events') }})
    

@dataclasses.dataclass
class ReposUpdateWebhookRequest:
    path_params: ReposUpdateWebhookPathParams = dataclasses.field()
    request: Optional[ReposUpdateWebhookRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
