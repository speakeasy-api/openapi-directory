...
class ListSipAuthCallsCredentialListMappingListSipAuthCallsCredentialListMappingResponse:
    contents: Optional[list[shared_api_v2010_account_sip_sip_domain_sip_auth_sip_auth_calls_sip_auth_calls_credential_list_mapping.APIV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contents') }})
...
class ListSipAuthCallsCredentialListMappingRequest:
    path_params: ListSipAuthCallsCredentialListMappingPathParams = dataclasses.field()
    query_params: ListSipAuthCallsCredentialListMappingQueryParams = dataclasses.field()
    security: ListSipAuthCallsCredentialListMappingSecurity = dataclasses.field()
