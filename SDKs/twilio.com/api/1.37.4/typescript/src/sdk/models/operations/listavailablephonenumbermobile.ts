...
export const ListAvailablePhoneNumberMobileServerList = [
	"https://api.twilio.com",
] as const;


export class ListAvailablePhoneNumberMobilePathParams extends SpeakeasyBase {
...
export class ListAvailablePhoneNumberMobileQueryParams extends SpeakeasyBase {
...
export class ListAvailablePhoneNumberMobileSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=http;subtype=basic" })
  accountSidAuthToken: shared.SchemeAccountSidAuthToken;
}


export class ListAvailablePhoneNumberMobileListAvailablePhoneNumberMobileResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=available_phone_numbers", elemType: shared.ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile })
...
export class ListAvailablePhoneNumberMobileRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  serverURL?: string;
...
export class ListAvailablePhoneNumberMobileResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
