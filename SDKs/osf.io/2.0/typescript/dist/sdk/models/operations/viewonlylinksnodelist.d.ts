...
export declare class ViewOnlyLinksNodeListRequest extends SpeakeasyBase {
    /**
 ...
 */
export declare enum ViewOnlyLinksNodeListNodeAttributesCategoryEnum {
    Analysis = "analysis",
 ...
 */
export declare class ViewOnlyLinksNodeListNodeAttributes extends SpeakeasyBase {
    /**
     * The category of the node, as selected by project contributors.
     */
 ...
 */
export declare class ViewOnlyLinksNodeListNodeLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class ViewOnlyLinksNodeListNodeRelationships extends SpeakeasyBase {
    /**
...
export declare class ViewOnlyLinksNodeListNode extends SpeakeasyBase {
    /**
     * The properties of the node entity.
     */
...
export declare class ViewOnlyLinksNodeListResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
