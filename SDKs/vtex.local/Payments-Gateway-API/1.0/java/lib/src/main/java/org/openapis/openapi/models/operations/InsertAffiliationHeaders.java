...
public class InsertAffiliationHeaders {
    /**
    ...
    public InsertAffiliationHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public InsertAffiliationHeaders withContentType(String contentType) {
    ...
    public InsertAffiliationHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public InsertAffiliationHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
