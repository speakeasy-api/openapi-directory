...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.matters = new matters_1.Matters(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
