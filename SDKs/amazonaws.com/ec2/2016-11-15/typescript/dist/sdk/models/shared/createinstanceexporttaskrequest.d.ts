 ...
 */
export declare enum CreateInstanceExportTaskRequestExportToS3TaskContainerFormatEnum {
    Ova = "ova"
}
/**
 * The format for the exported image.
 */
export declare enum CreateInstanceExportTaskRequestExportToS3TaskDiskImageFormatEnum {
    Vmdk = "VMDK",
    Raw = "RAW",
    Vhd = "VHD"
}
 ...
 */
export declare class CreateInstanceExportTaskRequestExportToS3Task extends SpeakeasyBase {
 ...
 */
export declare enum CreateInstanceExportTaskRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateInstanceExportTaskRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateInstanceExportTaskRequestTagSpecifications extends SpeakeasyBase {
 ...
 */
export declare enum CreateInstanceExportTaskRequestTargetEnvironmentEnum {
    Citrix = "citrix",
    Vmware = "vmware",
    Microsoft = "microsoft"
}
export declare class CreateInstanceExportTaskRequest extends SpeakeasyBase {
    description?: string;
