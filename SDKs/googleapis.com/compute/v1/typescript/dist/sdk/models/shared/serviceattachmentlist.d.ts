 ...
 */
export declare enum ServiceAttachmentListWarningCodeEnum {
...
export declare class ServiceAttachmentListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ServiceAttachmentListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class ServiceAttachmentList extends SpeakeasyBase {
    /**
