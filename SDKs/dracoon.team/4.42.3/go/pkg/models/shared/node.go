...
type NodeClassificationEnum int
...
func (e NodeClassificationEnum) ToPointer() *NodeClassificationEnum {
	return &e
}
...
func (e *NodeClassificationEnum) UnmarshalJSON(data []byte) error {
	...
	case 3:
		fallthrough
	case 4:
		*e = NodeClassificationEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NodeClassificationEnum: %v", v)
	}
}
