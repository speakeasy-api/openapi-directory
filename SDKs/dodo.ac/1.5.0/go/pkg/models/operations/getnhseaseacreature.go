...
type GetNhSeaSeaCreaturePathParams struct {
...
type GetNhSeaSeaCreatureQueryParams struct {
...
type GetNhSeaSeaCreatureHeaders struct {
...
type GetNhSeaSeaCreatureRequest struct {
	PathParams  GetNhSeaSeaCreaturePathParams
	QueryParams GetNhSeaSeaCreatureQueryParams
	Headers     GetNhSeaSeaCreatureHeaders
}
