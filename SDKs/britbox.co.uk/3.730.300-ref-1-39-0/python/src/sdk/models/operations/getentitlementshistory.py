...
from ..shared import itventitlementshistory as shared_itventitlementshistory
...
class GetEntitlementsHistoryResponse:
    ...
    itv_entitlements_history: Optional[shared_itventitlementshistory.ItvEntitlementsHistory] = dataclasses.field(default=None)
