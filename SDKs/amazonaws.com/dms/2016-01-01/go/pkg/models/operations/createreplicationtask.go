...
func (e CreateReplicationTaskXAmzTargetEnum) ToPointer() *CreateReplicationTaskXAmzTargetEnum {
	return &e
}
...
func (e *CreateReplicationTaskXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonDMSv20160101.CreateReplicationTask":
		*e = CreateReplicationTaskXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateReplicationTaskXAmzTargetEnum: %v", v)
	}
}
