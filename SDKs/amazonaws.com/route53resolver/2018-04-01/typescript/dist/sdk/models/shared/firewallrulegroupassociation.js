...
var firewallrulegroupassociationstatusenum_1 = require("./firewallrulegroupassociationstatusenum");
var mutationprotectionstatusenum_1 = require("./mutationprotectionstatusenum");
var class_transformer_1 = require("class-transformer");
/**
 * An association between a firewall rule group and a VPC, which enables DNS filtering for the VPC.
 */
var FirewallRuleGroupAssociation = /** @class */ (function (_super) {
    __extends(FirewallRuleGroupAssociation, _super);
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "FirewallRuleGroupId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ManagedOwnerName" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "MutationProtection" }),
        __metadata("design:type", String)
