...
public class GetUsersUserIdApiKeysQueryParams {
    /**
     * Used for pagination.  When a list request has more records available, cursors are provided in the response headers `X-Files-Cursor-Next` and `X-Files-Cursor-Prev`.  Send one of those cursor value here to resume an existing list from the next available record.  Note: many of our SDKs have iterator methods that will automatically handle cursor-based pagination.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=cursor")
    public String cursor;
    public GetUsersUserIdApiKeysQueryParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public GetUsersUserIdApiKeysQueryParams withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersUserIdApiKeysQueryParams withFilterGt(java.util.Map<String, Object> filterGt) {
    ...
    public GetUsersUserIdApiKeysQueryParams withFilterGteq(java.util.Map<String, Object> filterGteq) {
    ...
    public GetUsersUserIdApiKeysQueryParams withFilterLike(java.util.Map<String, Object> filterLike) {
    ...
    public GetUsersUserIdApiKeysQueryParams withFilterLt(java.util.Map<String, Object> filterLt) {
    ...
    public GetUsersUserIdApiKeysQueryParams withFilterLteq(java.util.Map<String, Object> filterLteq) {
    ...
    public GetUsersUserIdApiKeysQueryParams withPerPage(Integer perPage) {
    ...
    public GetUsersUserIdApiKeysQueryParams withSortBy(java.util.Map<String, Object> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
