...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CanvasDataAnalyticsSummaryResponse res = sdk.canvas.canvasDataAnalyticsSummary(req);
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CanvasDataSeriesAnalyticsResponse res = sdk.canvas.canvasDataSeriesAnalytics(req);
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CanvasDetailsResponse res = sdk.canvas.canvasDetails(req);
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CanvasListResponse res = sdk.canvas.canvasList(req);
