...
class GetAutoScalingGroupRecommendationsRequest:
    ...
    get_auto_scaling_group_recommendations_request: shared_getautoscalinggrouprecommendationsrequest.GetAutoScalingGroupRecommendationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
