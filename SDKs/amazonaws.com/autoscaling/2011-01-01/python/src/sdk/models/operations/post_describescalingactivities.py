...
class PostDescribeScalingActivitiesQueryParams:
    action: PostDescribeScalingActivitiesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeScalingActivitiesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeScalingActivitiesRequest:
    headers: PostDescribeScalingActivitiesHeaders = dataclasses.field()
    query_params: PostDescribeScalingActivitiesQueryParams = dataclasses.field()
