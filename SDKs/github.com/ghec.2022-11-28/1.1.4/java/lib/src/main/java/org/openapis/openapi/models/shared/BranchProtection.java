...
public class BranchProtection {
    ...
    public BranchProtectionAllowForkSyncing allowForkSyncing;
    public BranchProtection withAllowForkSyncing(BranchProtectionAllowForkSyncing allowForkSyncing) {
    ...
    public BranchProtectionLockBranch lockBranch;
    public BranchProtection withLockBranch(BranchProtectionLockBranch lockBranch) {
