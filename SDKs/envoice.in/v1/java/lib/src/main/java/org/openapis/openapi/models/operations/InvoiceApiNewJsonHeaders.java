...
public class InvoiceApiNewJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiNewJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiNewJsonHeaders withXAuthSecret(String xAuthSecret) {
