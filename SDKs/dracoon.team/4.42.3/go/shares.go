...
func (s *shares) CreateDownloadShare(ctx context.Context, request operations.CreateDownloadShareRequest) (*operations.CreateDownloadShareResponse, error) {
	baseURL := s.serverURL
	...
	case httpRes.StatusCode == 400:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.CreateDownloadShare400ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// Please keep in mind that due to various restrictions of different telecommunication providers, non-ASCII characters
// may not be displayed correctly in short messages (SMS).
func (s *shares) CreateUploadShare(ctx context.Context, request operations.CreateUploadShareRequest) (*operations.CreateUploadShareResponse, error) {
	baseURL := s.serverURL
	...
	case httpRes.StatusCode == 400:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.CreateUploadShare400ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *shares) DeleteDownloadShares(ctx context.Context, request operations.DeleteDownloadSharesRequest) (*operations.DeleteDownloadSharesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/shares/downloads"
...
func (s *shares) DeleteUploadShares(ctx context.Context, request operations.DeleteUploadSharesRequest) (*operations.DeleteUploadSharesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/shares/uploads"
...
func (s *shares) RemoveDownloadShare(ctx context.Context, request operations.RemoveDownloadShareRequest) (*operations.RemoveDownloadShareResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v4/shares/downloads/{share_id}", request, nil)
	if err != nil {
...
func (s *shares) RemoveUploadShare(ctx context.Context, request operations.RemoveUploadShareRequest) (*operations.RemoveUploadShareResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v4/shares/uploads/{share_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *shares) RequestDownloadShareQr(ctx context.Context, request operations.RequestDownloadShareQrRequest) (*operations.RequestDownloadShareQrResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v4/shares/downloads/{share_id}/qr", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
//
// </details>
func (s *shares) RequestDownloadShares(ctx context.Context, request operations.RequestDownloadSharesRequest) (*operations.RequestDownloadSharesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/shares/downloads"
...
func (s *shares) RequestUploadShareQr(ctx context.Context, request operations.RequestUploadShareQrRequest) (*operations.RequestUploadShareQrResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v4/shares/uploads/{share_id}/qr", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
//
// </details>
func (s *shares) RequestUploadShares(ctx context.Context, request operations.RequestUploadSharesRequest) (*operations.RequestUploadSharesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/shares/uploads"
...
func (s *shares) SendDownloadShareLinkViaEmail(ctx context.Context, request operations.SendDownloadShareLinkViaEmailRequest) (*operations.SendDownloadShareLinkViaEmailResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v4/shares/downloads/{share_id}/email", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *shares) SendUploadShareLinkViaEmail(ctx context.Context, request operations.SendUploadShareLinkViaEmailRequest) (*operations.SendUploadShareLinkViaEmailResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v4/shares/uploads/{share_id}/email", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *shares) UpdateDownloadShare(ctx context.Context, request operations.UpdateDownloadShareRequest) (*operations.UpdateDownloadShareResponse, error) {
	...
	case httpRes.StatusCode == 400:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.UpdateDownloadShare400ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *shares) UpdateDownloadShares(ctx context.Context, request operations.UpdateDownloadSharesRequest) (*operations.UpdateDownloadSharesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/shares/downloads"
...
func (s *shares) UpdateUploadShare(ctx context.Context, request operations.UpdateUploadShareRequest) (*operations.UpdateUploadShareResponse, error) {
	...
	case httpRes.StatusCode == 400:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.UpdateUploadShare400ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// ### Further Information:
// Maximum number of shares is 200
func (s *shares) UpdateUploadShares(ctx context.Context, request operations.UpdateUploadSharesRequest) (*operations.UpdateUploadSharesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/shares/uploads"
