...
class ListDeploymentsHistoryFilterEnum(str, Enum):
    r"""<p>The filter for the list of deployments. Choose one of the following options:</p> <ul> <li> <p> <code>ALL</code> – The list includes all deployments.</p> </li> <li> <p> <code>LATEST_ONLY</code> – The list includes only the latest revision of each deployment.</p> </li> </ul> <p>Default: <code>LATEST_ONLY</code> </p>"""
    ALL = 'ALL'
...
class ListDeploymentsRequest:
    ...
    parent_target_arn: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'parentTargetArn', 'style': 'form', 'explode': True }})
    ...
    r"""The <a href=\\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\\">ARN</a> of the target IoT thing or thing group."""  
