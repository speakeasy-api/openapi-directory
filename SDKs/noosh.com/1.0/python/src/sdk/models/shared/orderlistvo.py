...
import dataclasses
from ..shared import ordersimplevo as shared_ordersimplevo
...
class OrderListVO:
    r"""Java type: com.noosh.nooshapi.vo.OrderListVO"""
    
    results: Optional[list[shared_ordersimplevo.OrderSimpleVO]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
