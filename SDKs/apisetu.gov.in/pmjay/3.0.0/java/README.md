...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PmjayRequestBody req = new PmjayRequestBody() {{
                certificateParameters = new PmjayRequestBodyCertificateParameters() {{
                    dob = "31-12-1980";
                    fullName = "Sunil Kumar";
                    udf1 = "PMJAY0000";
                    udf2 = "JAMMU AND KASHMIR,HIMACHAL PRADESH,PUNJAB,CHANDIGARH,UTTARAKHAND,HARYANA,DELHI,RAJASTHAN,UTTAR PRADE";
                }};
            ...
            PmjayResponse res = sdk.apIs.pmjay(req, new PmjaySecurity() {{
