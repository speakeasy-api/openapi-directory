...
export class GetPresidentialContributionsByStateRequest extends SpeakeasyBase {
  /**
   *
   * @remarks
...
export class GetPresidentialContributionsByStateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
