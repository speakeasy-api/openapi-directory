...
type TagmanagerAccountsContainersVersionsRestoreSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type TagmanagerAccountsContainersVersionsRestorePathParams struct {
	// The GTM Account ID.
...
type TagmanagerAccountsContainersVersionsRestoreQueryParams struct {
	// V1 error format.
...
type TagmanagerAccountsContainersVersionsRestoreRequest struct {
...
type TagmanagerAccountsContainersVersionsRestoreResponse struct {
	// Successful response
