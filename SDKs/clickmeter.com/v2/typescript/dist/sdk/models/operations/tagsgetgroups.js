...
exports.TagsGetGroupsResponse = exports.TagsGetGroupsRequest = exports.TagsGetGroupsStatusEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Status of the datapoint
 */
var TagsGetGroupsStatusEnum;
(function (TagsGetGroupsStatusEnum) {
    TagsGetGroupsStatusEnum["Deleted"] = "deleted";
    TagsGetGroupsStatusEnum["Active"] = "active";
})(TagsGetGroupsStatusEnum = exports.TagsGetGroupsStatusEnum || (exports.TagsGetGroupsStatusEnum = {}));
var TagsGetGroupsRequest = /** @class */ (function (_super) {
    ...
    ], TagsGetGroupsRequest.prototype, "createdAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=createdBefore",
        }),
        __metadata("design:type", String)
    ], TagsGetGroupsRequest.prototype, "createdBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], TagsGetGroupsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], TagsGetGroupsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], TagsGetGroupsRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=tagId",
        }),
        __metadata("design:type", Number)
    ], TagsGetGroupsRequest.prototype, "tagId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=textSearch",
        }),
        __metadata("design:type", String)
    ], TagsGetGroupsRequest.prototype, "textSearch", void 0);
    return TagsGetGroupsRequest;
}(utils_1.SpeakeasyBase));
exports.TagsGetGroupsRequest = TagsGetGroupsRequest;
var TagsGetGroupsResponse = /** @class */ (function (_super) {
    ...
    ], TagsGetGroupsResponse.prototype, "rawResponse", void 0);
    return TagsGetGroupsResponse;
}(utils_1.SpeakeasyBase));
exports.TagsGetGroupsResponse = TagsGetGroupsResponse;
