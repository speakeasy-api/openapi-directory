...
class AuthorizerDescription:
    ...
    status: Optional[shared_authorizerstatus_enum.AuthorizerStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
