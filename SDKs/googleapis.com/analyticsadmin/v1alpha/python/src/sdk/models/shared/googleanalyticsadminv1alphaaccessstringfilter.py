...
class GoogleAnalyticsAdminV1alphaAccessStringFilter:
    ...
    match_type: Optional[GoogleAnalyticsAdminV1alphaAccessStringFilterMatchTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('matchType'), 'exclude': lambda f: f is None }})
    r"""The match type for this filter."""  
