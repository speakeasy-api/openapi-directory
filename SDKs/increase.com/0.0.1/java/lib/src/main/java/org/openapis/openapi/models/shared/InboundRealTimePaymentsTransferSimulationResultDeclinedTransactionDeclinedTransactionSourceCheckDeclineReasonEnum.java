 ...
 */
public enum InboundRealTimePaymentsTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCheckDeclineReasonEnum {
    ...
    private InboundRealTimePaymentsTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCheckDeclineReasonEnum(String value) {
        this.value = value;
    }
}
