...
class OrderApiNewJsonRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\OrderCreateApiModel $orderCreateApiModel;
	...
	{
		$this->orderCreateApiModel = new \OpenAPI\OpenAPI\Models\Shared\OrderCreateApiModel();
		$this->xAuthKey = "";
		$this->xAuthSecret = "";
	}
}
