...
export class PutOrganisationsPartyIdBusinessNamesProductIdRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class PutOrganisationsPartyIdBusinessNamesProductIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
