...
public class CreateFilePaymentsRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateFilePaymentsRawHeaders withAuthorization(String authorization) {
    ...
    public CreateFilePaymentsRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateFilePaymentsRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateFilePaymentsRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateFilePaymentsRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateFilePaymentsRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateFilePaymentsRawHeaders withXJwsSignature(String xJwsSignature) {
