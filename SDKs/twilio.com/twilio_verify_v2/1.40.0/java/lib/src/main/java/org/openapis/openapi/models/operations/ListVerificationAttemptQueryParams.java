...
public class ListVerificationAttemptQueryParams {
    ...
    public ListVerificationAttemptQueryParams withChannel(org.openapis.openapi.models.shared.VerificationAttemptEnumChannelsEnum channel) {
    ...
    public Long page;
    public ListVerificationAttemptQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListVerificationAttemptQueryParams withPageToken(String pageToken) {
    ...
    public ListVerificationAttemptQueryParams withStatus(org.openapis.openapi.models.shared.VerificationAttemptEnumConversionStatusEnum status) {
        this.status = status;
        return this;
    }
