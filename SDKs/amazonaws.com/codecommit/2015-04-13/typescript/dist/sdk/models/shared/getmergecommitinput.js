...
exports.GetMergeCommitInput = void 0;
...
var GetMergeCommitInput = /** @class */ (function (_super) {
    __extends(GetMergeCommitInput, _super);
    ...
    ], GetMergeCommitInput.prototype, "conflictDetailLevel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=conflictResolutionStrategy" }),
        __metadata("design:type", String)
    ], GetMergeCommitInput.prototype, "conflictResolutionStrategy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=destinationCommitSpecifier" }),
        __metadata("design:type", String)
    ], GetMergeCommitInput.prototype, "destinationCommitSpecifier", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=repositoryName" }),
        __metadata("design:type", String)
    ], GetMergeCommitInput.prototype, "repositoryName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sourceCommitSpecifier" }),
        __metadata("design:type", String)
    ], GetMergeCommitInput.prototype, "sourceCommitSpecifier", void 0);
    return GetMergeCommitInput;
