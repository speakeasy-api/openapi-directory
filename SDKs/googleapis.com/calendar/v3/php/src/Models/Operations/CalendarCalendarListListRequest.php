...
class CalendarCalendarListListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CalendarCalendarListListMinAccessRoleEnum $minAccessRole
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=minAccessRole')]
    public ?CalendarCalendarListListMinAccessRoleEnum $minAccessRole = null;
