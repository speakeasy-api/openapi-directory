...
export declare class KmsinventoryOrganizationsProtectedResourcesSearchSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class KmsinventoryOrganizationsProtectedResourcesSearchRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class KmsinventoryOrganizationsProtectedResourcesSearchResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
