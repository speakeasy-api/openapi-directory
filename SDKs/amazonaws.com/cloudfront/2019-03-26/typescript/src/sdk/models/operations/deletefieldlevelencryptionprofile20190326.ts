...
export class DeleteFieldLevelEncryptionProfile20190326Request extends SpeakeasyBase {
  /**
...
export class DeleteFieldLevelEncryptionProfile20190326Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
