...
from ..shared import employeepayrolls as shared_employeepayrolls


@dataclass_json
@dataclasses.dataclass
class GetEmployeePayrollsResponse:
    data: shared_employeepayrolls.EmployeePayrolls = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
