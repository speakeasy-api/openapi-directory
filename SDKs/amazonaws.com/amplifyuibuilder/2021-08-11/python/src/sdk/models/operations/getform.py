...
from ..shared import getformresponse as shared_getformresponse
...
class GetFormResponse:
    ...
    get_form_response: Optional[shared_getformresponse.GetFormResponse] = dataclasses.field(default=None)
    r"""Success"""  
