...
class HealthInformationNotification
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\HealthInformationNotificationNotification')]
	...
	{
		$this->notification = new \OpenAPI\OpenAPI\Models\Shared\HealthInformationNotificationNotification();
		$this->requestId = "";
