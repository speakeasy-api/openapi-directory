...
type AndroidenterpriseServiceaccountkeysDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseServiceaccountkeysDeletePathParams struct {
...
type AndroidenterpriseServiceaccountkeysDeleteQueryParams struct {
	// V1 error format.
...
type AndroidenterpriseServiceaccountkeysDeleteRequest struct {
...
type AndroidenterpriseServiceaccountkeysDeleteResponse struct {
	ContentType string
	StatusCode  int
