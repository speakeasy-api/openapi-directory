...
class Receipts 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\ReceiptsPhotoToCSVResponse
    {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ReceiptsPhotoToCSVResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->receiptsPhotoToCSV200ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
            ...
            if (Utils\Utils::matchContentType($contentType, 'text/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->receiptsPhotoToCSV200TextJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
