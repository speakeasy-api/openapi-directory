...
class ToolresultsProjectsHistoriesExecutionsStepsTestCasesListRequest:
    ...
    r"""A Step id. Note: This step must include a TestExecutionStep. Required."""  
    ...
    r"""The maximum number of TestCases to fetch. Default value: 100. The server will use this default if the field is not set or has a value of 0. Optional."""  
