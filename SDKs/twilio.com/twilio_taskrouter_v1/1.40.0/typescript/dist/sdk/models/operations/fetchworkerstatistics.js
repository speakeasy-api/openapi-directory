...
exports.FetchWorkerStatisticsResponse = exports.FetchWorkerStatisticsRequest = exports.FetchWorkerStatisticsSecurity = exports.FetchWorkerStatisticsServerList = void 0;
...
var FetchWorkerStatisticsSecurity = /** @class */ (function (_super) {
    ...
    ], FetchWorkerStatisticsSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], FetchWorkerStatisticsSecurity.prototype, "username", void 0);
...
var FetchWorkerStatisticsRequest = /** @class */ (function (_super) {
    ...
    ], FetchWorkerStatisticsRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=FriendlyName",
        }),
        __metadata("design:type", String)
    ], FetchWorkerStatisticsRequest.prototype, "friendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Minutes",
        }),
        __metadata("design:type", Number)
    ], FetchWorkerStatisticsRequest.prototype, "minutes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], FetchWorkerStatisticsRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskChannel",
        }),
        __metadata("design:type", String)
    ], FetchWorkerStatisticsRequest.prototype, "taskChannel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskQueueName",
        }),
        __metadata("design:type", String)
    ], FetchWorkerStatisticsRequest.prototype, "taskQueueName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskQueueSid",
        }),
        __metadata("design:type", String)
    ], FetchWorkerStatisticsRequest.prototype, "taskQueueSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], FetchWorkerStatisticsRequest.prototype, "workspaceSid", void 0);
...
var FetchWorkerStatisticsResponse = /** @class */ (function (_super) {
    ...
    ], FetchWorkerStatisticsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
