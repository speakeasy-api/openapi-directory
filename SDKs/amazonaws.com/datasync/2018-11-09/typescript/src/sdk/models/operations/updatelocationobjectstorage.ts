...
export enum UpdateLocationObjectStorageXAmzTargetEnum {
    FmrsServiceUpdateLocationObjectStorage = "FmrsService.UpdateLocationObjectStorage"
}


export class UpdateLocationObjectStorageHeaders extends SpeakeasyBase {
...
export class UpdateLocationObjectStorageResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
