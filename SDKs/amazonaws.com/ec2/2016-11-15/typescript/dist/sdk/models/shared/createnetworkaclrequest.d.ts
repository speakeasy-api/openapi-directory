 ...
 */
export declare enum CreateNetworkAclRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateNetworkAclRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateNetworkAclRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: CreateNetworkAclRequestTagSpecificationsResourceTypeEnum;
    tags?: CreateNetworkAclRequestTagSpecificationsTags[];
}
export declare class CreateNetworkAclRequest extends SpeakeasyBase {
    dryRun?: boolean;
