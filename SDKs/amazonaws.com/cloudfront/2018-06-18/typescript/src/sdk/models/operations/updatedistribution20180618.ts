 ...
 */
export class UpdateDistribution20180618RequestBodyDistributionConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateDistribution20180618RequestBody extends SpeakeasyBase {
  /**
   * A distribution configuration.
   */
  @SpeakeasyMetadata()
...
export class UpdateDistribution20180618Request extends SpeakeasyBase {
  /**
...
export class UpdateDistribution20180618Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
