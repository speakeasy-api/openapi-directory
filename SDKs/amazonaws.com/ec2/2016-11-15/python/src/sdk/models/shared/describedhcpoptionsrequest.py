...
class DescribeDhcpOptionsRequest:
    ...
    dhcp_options_ids: Optional[list[str]] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeDhcpOptionsRequestFilters]] = dataclasses.field(default=None)  
