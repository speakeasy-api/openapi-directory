...
public class CreateResponsePlanRequestBody {
    ...
    public CreateResponsePlanRequestBody(@JsonProperty("incidentTemplate") CreateResponsePlanRequestBodyIncidentTemplate incidentTemplate, @JsonProperty("name") String name) {
        this.incidentTemplate = incidentTemplate;
        this.name = name;
  }
}
