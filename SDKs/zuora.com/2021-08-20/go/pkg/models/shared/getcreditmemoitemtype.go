...
type GETCreditMemoItemTypeCreditFromItemSourceEnum string

const (
	GETCreditMemoItemTypeCreditFromItemSourceEnumInvoiceItem    GETCreditMemoItemTypeCreditFromItemSourceEnum = "InvoiceItem"
	GETCreditMemoItemTypeCreditFromItemSourceEnumCreditMemoItem GETCreditMemoItemTypeCreditFromItemSourceEnum = "CreditMemoItem"
)

func (e *GETCreditMemoItemTypeCreditFromItemSourceEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "InvoiceItem":
		fallthrough
	case "CreditMemoItem":
		*e = GETCreditMemoItemTypeCreditFromItemSourceEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETCreditMemoItemTypeCreditFromItemSourceEnum: %s", s)
	}
}
...
// GETCreditMemoItemTypeSourceItemTypeEnum - The type of the source item.
//
...
type GETCreditMemoItemTypeSourceItemTypeEnum string

const (
	GETCreditMemoItemTypeSourceItemTypeEnumSubscriptionComponent GETCreditMemoItemTypeSourceItemTypeEnum = "SubscriptionComponent"
	GETCreditMemoItemTypeSourceItemTypeEnumInvoiceDetail         GETCreditMemoItemTypeSourceItemTypeEnum = "InvoiceDetail"
	GETCreditMemoItemTypeSourceItemTypeEnumProductRatePlanCharge GETCreditMemoItemTypeSourceItemTypeEnum = "ProductRatePlanCharge"
)

func (e *GETCreditMemoItemTypeSourceItemTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "ProductRatePlanCharge":
		*e = GETCreditMemoItemTypeSourceItemTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETCreditMemoItemTypeSourceItemTypeEnum: %s", s)
	}
}
...
type GETCreditMemoItemTypeTaxModeEnum string

const (
	GETCreditMemoItemTypeTaxModeEnumTaxExclusive GETCreditMemoItemTypeTaxModeEnum = "TaxExclusive"
	GETCreditMemoItemTypeTaxModeEnumTaxInclusive GETCreditMemoItemTypeTaxModeEnum = "TaxInclusive"
)

func (e *GETCreditMemoItemTypeTaxModeEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "TaxExclusive":
		fallthrough
	case "TaxInclusive":
		*e = GETCreditMemoItemTypeTaxModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETCreditMemoItemTypeTaxModeEnum: %s", s)
	}
}
...
type GETCreditMemoItemTypeTaxationItems struct {
...
type GETCreditMemoItemType struct {
	...
	//
	CreditFromItemSource *GETCreditMemoItemTypeCreditFromItemSourceEnum `json:"creditFromItemSource,omitempty"`
	...
	// - If a credit memo is created from a product rate plan charge, the value of this field is `ProductRatePlanCharge`.
	//
	SourceItemType *GETCreditMemoItemTypeSourceItemTypeEnum `json:"sourceItemType,omitempty"`
	...
	//
	TaxMode *GETCreditMemoItemTypeTaxModeEnum `json:"taxMode,omitempty"`
	// Container for the taxation items of the credit memo item.
	//
	// **Note**: This field is only available if you set the `zuora-version` request header to `239.0` or later.
	//
	TaxationItems *GETCreditMemoItemTypeTaxationItems `json:"taxationItems,omitempty"`
