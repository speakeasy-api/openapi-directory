...
class GetSecurityPolicyResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetSecurityPolicyResponse $getSecurityPolicyResponse
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetSecurityPolicyResponse $getSecurityPolicyResponse = null;
	...
	{
		$this->contentType = "";
		$this->getSecurityPolicyResponse = null;
