...
func (e GoogleCloudDocumentaiV1ProcessorStateEnum) ToPointer() *GoogleCloudDocumentaiV1ProcessorStateEnum {
	return &e
}
...
func (e *GoogleCloudDocumentaiV1ProcessorStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "FAILED":
		fallthrough
	case "DELETING":
		*e = GoogleCloudDocumentaiV1ProcessorStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudDocumentaiV1ProcessorStateEnum: %v", v)
	}
}
