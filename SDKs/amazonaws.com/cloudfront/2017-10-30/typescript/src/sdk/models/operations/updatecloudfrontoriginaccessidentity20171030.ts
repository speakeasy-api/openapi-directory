 ...
 */
export class UpdateCloudFrontOriginAccessIdentity20171030RequestBodyCloudFrontOriginAccessIdentityConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateCloudFrontOriginAccessIdentity20171030RequestBody extends SpeakeasyBase {
  /**
   * Origin access identity configuration. Send a <code>GET</code> request to the <code>/<i>CloudFront API version</i>/CloudFront/identity ID/config</code> resource.
   */
  @SpeakeasyMetadata()
