 ...
 */
public enum DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateTargetingTypeEnum {
    ...
    private DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateTargetingTypeEnum(String value) {
        this.value = value;
    }
}
