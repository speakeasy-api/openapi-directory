...
exports.CreateCustomRoutingAcceleratorRequest = void 0;
...
var CreateCustomRoutingAcceleratorRequest = /** @class */ (function (_super) {
    ...
    ], CreateCustomRoutingAcceleratorRequest.prototype, "enabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=IdempotencyToken" }),
        __metadata("design:type", String)
    ], CreateCustomRoutingAcceleratorRequest.prototype, "idempotencyToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=IpAddressType" }),
        __metadata("design:type", String)
    ], CreateCustomRoutingAcceleratorRequest.prototype, "ipAddressType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=IpAddresses" }),
        __metadata("design:type", Array)
    ], CreateCustomRoutingAcceleratorRequest.prototype, "ipAddresses", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], CreateCustomRoutingAcceleratorRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Tags", elemType: tag_1.Tag }),
        __metadata("design:type", Array)
    ], CreateCustomRoutingAcceleratorRequest.prototype, "tags", void 0);
