...
class ComputeNodeGetRemoteLoginSettingsRequest:
    headers: ComputeNodeGetRemoteLoginSettingsHeaders = dataclasses.field()
    path_params: ComputeNodeGetRemoteLoginSettingsPathParams = dataclasses.field()
    query_params: ComputeNodeGetRemoteLoginSettingsQueryParams = dataclasses.field()
...
class ComputeNodeGetRemoteLoginSettingsResponse:
    ...
    compute_node_get_remote_login_settings_result: Optional[Any] = dataclasses.field(default=None)
