...
public class AvatarsGetCreditCardSecurity {
    ...
    public AvatarsGetCreditCardSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public AvatarsGetCreditCardSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public AvatarsGetCreditCardSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public AvatarsGetCreditCardSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
