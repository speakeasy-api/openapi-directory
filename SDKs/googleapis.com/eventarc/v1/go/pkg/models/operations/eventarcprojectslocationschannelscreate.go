...
type EventarcProjectsLocationsChannelsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type EventarcProjectsLocationsChannelsCreatePathParams struct {
	// Required. The parent collection in which to add this channel.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type EventarcProjectsLocationsChannelsCreateQueryParams struct {
	// V1 error format.
...
type EventarcProjectsLocationsChannelsCreateResponse struct {
	ContentType string
	// Successful response
