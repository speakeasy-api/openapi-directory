...
@dataclasses.dataclass
class RejectCertificateTransferHeaders:
...
class RejectCertificateTransferRequest:
    headers: RejectCertificateTransferHeaders = dataclasses.field()
    path_params: RejectCertificateTransferPathParams = dataclasses.field()
    request: RejectCertificateTransferRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class RejectCertificateTransferResponse:
    ...
    transfer_already_completed_exception: Optional[Any] = dataclasses.field(default=None)
