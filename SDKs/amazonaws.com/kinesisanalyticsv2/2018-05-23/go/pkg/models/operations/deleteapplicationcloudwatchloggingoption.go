...
func (e *DeleteApplicationCloudWatchLoggingOptionXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "KinesisAnalytics_20180523.DeleteApplicationCloudWatchLoggingOption":
		*e = DeleteApplicationCloudWatchLoggingOptionXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for DeleteApplicationCloudWatchLoggingOptionXAmzTargetEnum: %s", s)
	}
}
