...
class APIV2010AccountUsageUsageRecordUsageRecordToday:
    ...
    category: Optional[shared_usage_record_today_enum_category_enum.UsageRecordTodayEnumCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category'), 'exclude': lambda f: f is None }})  
