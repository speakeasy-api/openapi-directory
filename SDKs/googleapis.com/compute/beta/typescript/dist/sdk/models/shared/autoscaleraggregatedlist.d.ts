...
import { AutoscalersScopedList } from "./autoscalersscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum AutoscalerAggregatedListWarningCodeEnum {
...
export declare class AutoscalerAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class AutoscalerAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: AutoscalerAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: AutoscalerAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class AutoscalerAggregatedList extends SpeakeasyBase {
    /**
