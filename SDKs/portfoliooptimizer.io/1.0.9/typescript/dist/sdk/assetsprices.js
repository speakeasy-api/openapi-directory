...
exports.AssetsPrices = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var AssetsPrices = /** @class */ (function () {
    function AssetsPrices(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
     */
    AssetsPrices.prototype.postAssetsPricesAdjusted = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostAssetsPricesAdjustedRequestBody(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/assets/prices/adjusted";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostAssetsPricesAdjustedResponse({
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.postAssetsPricesAdjusted200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.PostAssetsPricesAdjusted200ApplicationJSON);
                    }
                    break;
            }
            return res;
     ...
     *
     */
    AssetsPrices.prototype.postAssetsPricesAdjustedForward = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostAssetsPricesAdjustedForwardRequestBody(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/assets/prices/adjusted/forward";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "request", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostAssetsPricesAdjustedForwardResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.postAssetsPricesAdjustedForward200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.PostAssetsPricesAdjustedForward200ApplicationJSON);
                    }
                    break;
            }
            return res;
...
exports.AssetsPrices = AssetsPrices;
