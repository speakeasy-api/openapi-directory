...
var CreateCompositionHookServerList = []string{
...
func (e *CreateCompositionHookCreateCompositionHookRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateCompositionHookCreateCompositionHookRequestStatusCallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCompositionHookCreateCompositionHookRequestStatusCallbackMethodEnum: %s", s)
	}
}
