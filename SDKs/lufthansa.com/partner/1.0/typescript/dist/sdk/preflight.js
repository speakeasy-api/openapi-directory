...
var Preflight = /** @class */ (function () {
     ...
     */
    Preflight.prototype.autoCheckIn = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AutoCheckInRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/preflight/autocheckin/{ticketnumber}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.AutoCheckInResponse({
