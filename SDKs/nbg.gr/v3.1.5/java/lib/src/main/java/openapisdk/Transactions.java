...
public class Transactions {
    ...
    **/
    public openapisdk.models.operations.GetAccountsAccountIdStatementsStatementIdTransactionsResponse getAccountsAccountIdStatementsStatementIdTransactions(openapisdk.models.operations.GetAccountsAccountIdStatementsStatementIdTransactionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/accounts/{accountId}/statements/{statementId}/transactions", request.pathParams);
        ...
        openapisdk.models.operations.GetAccountsAccountIdStatementsStatementIdTransactionsResponse res = new openapisdk.models.operations.GetAccountsAccountIdStatementsStatementIdTransactionsResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.ObReadTransaction6 out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ObReadTransaction6.class);
