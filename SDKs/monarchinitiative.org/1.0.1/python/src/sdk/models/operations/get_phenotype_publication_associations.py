...
class GetPhenotypePublicationAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPhenotypePublicationAssociationsQueryParams:
...
class GetPhenotypePublicationAssociationsRequest:
    path_params: GetPhenotypePublicationAssociationsPathParams = dataclasses.field()
    query_params: GetPhenotypePublicationAssociationsQueryParams = dataclasses.field()
