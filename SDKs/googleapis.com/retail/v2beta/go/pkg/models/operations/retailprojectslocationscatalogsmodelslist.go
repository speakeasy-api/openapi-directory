...
type RetailProjectsLocationsCatalogsModelsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RetailProjectsLocationsCatalogsModelsListPathParams struct {
...
type RetailProjectsLocationsCatalogsModelsListQueryParams struct {
	// V1 error format.
...
type RetailProjectsLocationsCatalogsModelsListRequest struct {
...
type RetailProjectsLocationsCatalogsModelsListResponse struct {
	ContentType string
	// Successful response
	GoogleCloudRetailV2betaListModelsResponse *shared.GoogleCloudRetailV2betaListModelsResponse
	StatusCode                                int
