...
export class ListAuthorizedConnectAppListAuthorizedConnectAppResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.ApiV2010AccountAuthorizedConnectApp })
  @Expose({ name: "authorized_connect_apps" })
  @Type(() => shared.ApiV2010AccountAuthorizedConnectApp)
