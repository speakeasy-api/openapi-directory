...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/googleapis.com/authorizedbuyersmarketplace/v1/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/googleapis.com/authorizedbuyersmarketplace/v1/typescript
```
...
```typescript
import {
  AuthorizedbuyersmarketplaceBuyersAuctionPackagesListRequest,
  AuthorizedbuyersmarketplaceBuyersAuctionPackagesListResponse
