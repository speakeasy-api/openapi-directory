...
class SDK:
    ...
    def redact_message(self, request: shared.RedactTransaction, security: operations.RedactMessageSecurity) -> operations.RedactMessageResponse:
        ...
        res = operations.RedactMessageResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        ...
        if http_res.status_code == 204:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorInvalidID])
