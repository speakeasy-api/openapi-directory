...
export class NetworksecurityProjectsLocationsUrlListsDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsUrlListsDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsUrlListsDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
