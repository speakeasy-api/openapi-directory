...
class TflAPIPresentationEntitiesPlaceCategory:
    ...
    available_keys: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('availableKeys'), 'exclude': lambda f: f is None }})  
