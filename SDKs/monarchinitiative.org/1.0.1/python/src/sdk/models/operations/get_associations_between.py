...
class GetAssociationsBetweenPathParams:
...
@dataclasses.dataclass
class GetAssociationsBetweenQueryParams:
...
class GetAssociationsBetweenRequest:
    path_params: GetAssociationsBetweenPathParams = dataclasses.field()
    query_params: GetAssociationsBetweenQueryParams = dataclasses.field()
