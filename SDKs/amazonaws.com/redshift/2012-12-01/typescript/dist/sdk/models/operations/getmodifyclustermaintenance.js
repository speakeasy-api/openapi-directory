...
exports.GetModifyClusterMaintenanceResponse = exports.GetModifyClusterMaintenanceRequest = exports.GetModifyClusterMaintenanceHeaders = exports.GetModifyClusterMaintenanceQueryParams = exports.GetModifyClusterMaintenanceVersionEnum = exports.GetModifyClusterMaintenanceActionEnum = void 0;
...
var GetModifyClusterMaintenanceQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=DeferMaintenance" }),
        __metadata("design:type", Boolean)
    ], GetModifyClusterMaintenanceQueryParams.prototype, "deferMaintenance", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=DeferMaintenanceDuration" }),
        __metadata("design:type", Number)
    ], GetModifyClusterMaintenanceQueryParams.prototype, "deferMaintenanceDuration", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=DeferMaintenanceEndTime" }),
        __metadata("design:type", Date)
    ], GetModifyClusterMaintenanceQueryParams.prototype, "deferMaintenanceEndTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=DeferMaintenanceIdentifier" }),
        __metadata("design:type", String)
    ], GetModifyClusterMaintenanceQueryParams.prototype, "deferMaintenanceIdentifier", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=DeferMaintenanceStartTime" }),
        __metadata("design:type", Date)
...
exports.GetModifyClusterMaintenanceQueryParams = GetModifyClusterMaintenanceQueryParams;
...
exports.GetModifyClusterMaintenanceHeaders = GetModifyClusterMaintenanceHeaders;
