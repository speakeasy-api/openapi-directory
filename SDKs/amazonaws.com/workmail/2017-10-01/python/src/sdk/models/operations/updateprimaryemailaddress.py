...
class UpdatePrimaryEmailAddressRequest:
    ...
    update_primary_email_address_request: shared_updateprimaryemailaddressrequest.UpdatePrimaryEmailAddressRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
