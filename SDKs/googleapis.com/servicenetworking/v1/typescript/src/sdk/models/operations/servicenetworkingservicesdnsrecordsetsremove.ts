...
export class ServicenetworkingServicesDnsRecordSetsRemoveSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ServicenetworkingServicesDnsRecordSetsRemoveSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ServicenetworkingServicesDnsRecordSetsRemoveSecurity extends SpeakeasyBase {
...
export class ServicenetworkingServicesDnsRecordSetsRemoveRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ServicenetworkingServicesDnsRecordSetsRemoveResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
