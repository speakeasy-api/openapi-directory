...
class DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOS:
    ...
    as_device_from_crc: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSAsDeviceFromCrc] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('as_device_from_crc'), 'exclude': lambda f: f is None }})
    r"""QoS metrics on screen shares by a participant who joined the meeting via a Cloud Room Connector."""  
    as_device_to_crc: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSAsDeviceToCrc] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('as_device_to_crc'), 'exclude': lambda f: f is None }})
    r"""QoS metrics on screen shares output being received by a participant who joined the meeting via a Cloud Room Connector."""  
    as_input: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSQOSObject] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('as_input'), 'exclude': lambda f: f is None }})
    r"""Quality of service object."""  
    as_output: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSQOSObject] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('as_output'), 'exclude': lambda f: f is None }})
    r"""Quality of service object."""  
    audio_device_from_crc: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSAudioDeviceFromCrc] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('audio_device_from_crc'), 'exclude': lambda f: f is None }})
    r"""QoS metrics on audio being sent by a participant who joined the meeting via a Cloud Room Connector."""  
    audio_device_to_crc: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSAudioDeviceToCrc] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('audio_device_to_crc'), 'exclude': lambda f: f is None }})
    r"""QoS metrics on audio received by a participant who joined the meeting via a Cloud Room Connector."""  
    audio_input: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSQOSObject1] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('audio_input'), 'exclude': lambda f: f is None }})
    r"""Quality of Service object."""  
    audio_output: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSQOSObject1] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('audio_output'), 'exclude': lambda f: f is None }})
    r"""Quality of Service object."""  
    cpu_usage: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSCPUUsage] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cpu_usage'), 'exclude': lambda f: f is None }})  
    ...
    r"""Date-time of QOS"""  
    video_device_from_crc: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSVideoDeviceFromCrc] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('video_device_from_crc'), 'exclude': lambda f: f is None }})
    r"""QoS metrics on video input being sent from a Cloud Room Connector used by the participant to join the meeting."""  
    video_device_to_crc: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSVideoDeviceToCrc] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('video_device_to_crc'), 'exclude': lambda f: f is None }})
    r"""QoS metrics on video output received by a participant who joined the meeting via a Cloud Room Connector."""  
    video_input: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSQOSObject] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('video_input'), 'exclude': lambda f: f is None }})
    r"""Quality of service object."""  
    video_output: Optional[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSQOSObject] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('video_output'), 'exclude': lambda f: f is None }})
    r"""Quality of service object."""  
...
class DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOS:
    ...
    user_qos: Optional[list[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOS]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('user_qos'), 'exclude': lambda f: f is None }})
...
class DashboardWebinarParticipantsQOSParticipantQOSList:
    ...
    participants: Optional[list[DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOS]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('participants'), 'exclude': lambda f: f is None }})
