...
export class APIs {
   ...
   */
  gicer(
    req: operations.GicerRequestBody,
    security: operations.GicerSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GicerResponse = new operations.GicerResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
      switch (true) {
        ...
        case httpRes?.status == 400:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.gicer400ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Gicer400ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 401:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.gicer401ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Gicer401ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 404:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.gicer404ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Gicer404ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 500:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.gicer500ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Gicer500ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 502:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.gicer502ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Gicer502ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 503:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.gicer503ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Gicer503ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 504:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.gicer504ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Gicer504ApplicationJSON
            );
          }
          break;
      }
