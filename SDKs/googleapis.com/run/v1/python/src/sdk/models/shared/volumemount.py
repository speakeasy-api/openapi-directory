...
class VolumeMount:
    ...
    r"""Required. Path within the container at which the volume should be mounted. Must not contain ':'."""  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})
    r"""Required. The name of the volume. There must be a corresponding Volume with the same name."""  
    ...
    r"""Only true is accepted for Secret Volumes. Defaults to true for Secrets Volumes."""  
    ...
    r"""Path within the volume from which the container's volume should be mounted. Defaults to \\"\\" (volume's root)."""  
