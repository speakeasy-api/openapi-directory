...
export class Type2017BoulderElectionExpenditures {
  ...
  **/
  search2017BoulderElectionExpenditures(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.Search2017BoulderElectionExpendituresResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
