...
var User = /** @class */ (function () {
    ...
    User.prototype.getUserUsername = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/user/{username}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetUserUsernameResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getUserUsername200ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetUserUsername200ApplicationJSON);
                    }
                    break;
            }
            return res;
    ...
    User.prototype.getUserUsernameTokenKind = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/user/{username}/token/{kind}", req);
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetUserUsernameTokenKindResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
