...
func (e UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpLeaseTimeEnum) ToPointer() *UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpLeaseTimeEnum {
	return &e
}
...
func (e *UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpLeaseTimeEnum) UnmarshalJSON(data []byte) error {
	...
	case "30 minutes":
		fallthrough
	case "4 hours":
		*e = UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpLeaseTimeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpLeaseTimeEnum: %v", v)
	}
}
...
func (e UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpModeEnum) ToPointer() *UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpModeEnum {
	return &e
}
...
func (e *UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "dhcpRelay":
		fallthrough
	case "dhcpServer":
		*e = UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpModeEnum: %v", v)
	}
}
...
func (e UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpOptionsTypeEnum) ToPointer() *UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpOptionsTypeEnum {
	return &e
}
...
func (e *UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpOptionsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "ip":
		fallthrough
	case "text":
		*e = UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpOptionsTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpOptionsTypeEnum: %v", v)
	}
}
...
func (e UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDNSNameserversOptionEnum) ToPointer() *UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDNSNameserversOptionEnum {
	return &e
}
...
func (e *UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDNSNameserversOptionEnum) UnmarshalJSON(data []byte) error {
	...
	case "googlePublicDns":
		fallthrough
	case "openDns":
		*e = UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDNSNameserversOptionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDNSNameserversOptionEnum: %v", v)
	}
}
