...
class PatientsOnpatientAccessReadPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PatientsOnpatientAccessReadQueryParams:
...
@dataclasses.dataclass
class PatientsOnpatientAccessReadSecurity:
    drchrono_oauth2: shared_security.SchemeDrchronoOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class PatientsOnpatientAccessReadRequest:
    path_params: PatientsOnpatientAccessReadPathParams = dataclasses.field()
    query_params: PatientsOnpatientAccessReadQueryParams = dataclasses.field()
    security: PatientsOnpatientAccessReadSecurity = dataclasses.field()
