...
export class OsloginUsersSshPublicKeysGetSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class OsloginUsersSshPublicKeysGetSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class OsloginUsersSshPublicKeysGetSecurity extends SpeakeasyBase {
...
export class OsloginUsersSshPublicKeysGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class OsloginUsersSshPublicKeysGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
