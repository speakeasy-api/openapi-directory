...
var ApplyPaymentType = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: paymentdebitmemoapplicationapplyrequesttype_1.PaymentDebitMemoApplicationApplyRequestType }),
        (0, class_transformer_1.Expose)({ name: "debitMemos" }),
        (0, class_transformer_1.Type)(function () { return paymentdebitmemoapplicationapplyrequesttype_1.PaymentDebitMemoApplicationApplyRequestType; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: paymentinvoiceapplicationapplyrequesttype_1.PaymentInvoiceApplicationApplyRequestType }),
        (0, class_transformer_1.Expose)({ name: "invoices" }),
        (0, class_transformer_1.Type)(function () { return paymentinvoiceapplicationapplyrequesttype_1.PaymentInvoiceApplicationApplyRequestType; }),
        __metadata("design:type", Array)
