...
var ControllersListMeta = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: controllersfilterdata_1.ControllersFilterData }),
        (0, class_transformer_1.Expose)({ name: "filter" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], controllersfilterdata_1.ControllersFilterData);
            }
            return obj;
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subtotals" }),
        __metadata("design:type", Object)
