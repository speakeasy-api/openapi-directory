...
func (s *itemPriority) GetItemPriorityFeed(ctx context.Context, request operations.GetItemPriorityFeedRequest) (*operations.GetItemPriorityFeedResponse, error) {
	baseURL := s.serverURL
