...
class GetApplicationRevisionRequest:
    headers: GetApplicationRevisionHeaders = dataclasses.field()
    request: shared_getapplicationrevisioninput.GetApplicationRevisionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
