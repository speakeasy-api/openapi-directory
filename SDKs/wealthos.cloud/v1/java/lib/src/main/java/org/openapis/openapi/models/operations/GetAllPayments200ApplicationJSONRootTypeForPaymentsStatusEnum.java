 ...
 */
public enum GetAllPayments200ApplicationJSONRootTypeForPaymentsStatusEnum {
    ...
    private GetAllPayments200ApplicationJSONRootTypeForPaymentsStatusEnum(String value) {
        this.value = value;
    }
}
