...
class SearchGeoGeojsonQueryParams:
...
@dataclasses.dataclass
class SearchGeoGeojsonRequest:
    query_params: SearchGeoGeojsonQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchGeoGeojsonResponse:
