...
export class TypeTypePointOceanNetcdfTrack {
  ...
  **/
  searchTypePointOceanNetcdfTrack(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.SearchTypePointOceanNetcdfTrackResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
