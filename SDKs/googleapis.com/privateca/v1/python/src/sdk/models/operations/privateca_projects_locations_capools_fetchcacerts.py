...
class PrivatecaProjectsLocationsCaPoolsFetchCaCertsRequest:
    ...
    r"""Required. The resource name for the CaPool in the format `projects/*/locations/*/caPools/*`."""  
    ...
    r"""JSONP"""  
    fetch_ca_certs_request: Optional[shared_fetchcacertsrequest.FetchCaCertsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
