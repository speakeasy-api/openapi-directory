...
export class ListConfigurationAddressListConfigurationAddressResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.ConversationsV1ConfigurationAddress })
  @Expose({ name: "address_configurations" })
  @Type(() => shared.ConversationsV1ConfigurationAddress)
  addressConfigurations?: shared.ConversationsV1ConfigurationAddress[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListConfigurationAddressListConfigurationAddressResponseMeta)
