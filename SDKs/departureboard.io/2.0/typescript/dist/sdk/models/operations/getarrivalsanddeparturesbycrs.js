...
exports.GetArrivalsAndDeparturesByCRSResponse = exports.GetArrivalsAndDeparturesByCRSRequest = void 0;
...
var GetArrivalsAndDeparturesByCRSRequest = /** @class */ (function (_super) {
    ...
    ], GetArrivalsAndDeparturesByCRSRequest.prototype, "crs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=apiKey",
        }),
        __metadata("design:type", String)
    ], GetArrivalsAndDeparturesByCRSRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filterStation",
        }),
        __metadata("design:type", String)
    ], GetArrivalsAndDeparturesByCRSRequest.prototype, "filterStation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filterType",
        }),
        __metadata("design:type", String)
    ], GetArrivalsAndDeparturesByCRSRequest.prototype, "filterType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=numServices",
        }),
        __metadata("design:type", Number)
    ], GetArrivalsAndDeparturesByCRSRequest.prototype, "numServices", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=serviceDetails",
        }),
        __metadata("design:type", Boolean)
    ], GetArrivalsAndDeparturesByCRSRequest.prototype, "serviceDetails", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeOffset",
        }),
        __metadata("design:type", Number)
    ], GetArrivalsAndDeparturesByCRSRequest.prototype, "timeOffset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeWindow",
        }),
        __metadata("design:type", Number)
    ], GetArrivalsAndDeparturesByCRSRequest.prototype, "timeWindow", void 0);
...
var GetArrivalsAndDeparturesByCRSResponse = /** @class */ (function (_super) {
    ...
    ], GetArrivalsAndDeparturesByCRSResponse.prototype, "rawResponse", void 0);
