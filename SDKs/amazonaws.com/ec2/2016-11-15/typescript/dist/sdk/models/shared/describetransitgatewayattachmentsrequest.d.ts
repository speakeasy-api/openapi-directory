 ...
 */
export declare class DescribeTransitGatewayAttachmentsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTransitGatewayAttachmentsRequest extends SpeakeasyBase {
    dryRun?: boolean;
