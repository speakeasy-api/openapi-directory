...
class Adexchangebuyer2AccountsFinalizedProposalsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\Adexchangebuyer2AccountsFinalizedProposalsListFilterSyntaxEnum $filterSyntax
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=filterSyntax')]
    public ?Adexchangebuyer2AccountsFinalizedProposalsListFilterSyntaxEnum $filterSyntax = null;
