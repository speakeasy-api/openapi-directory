...
exports.LedgerAccountsDeleteResponse = exports.LedgerAccountsDeleteRequest = exports.LedgerAccountsDeleteSecurity = void 0;
...
exports.LedgerAccountsDeleteSecurity = LedgerAccountsDeleteSecurity;
var LedgerAccountsDeleteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], LedgerAccountsDeleteRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], LedgerAccountsDeleteRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], LedgerAccountsDeleteRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], LedgerAccountsDeleteRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], LedgerAccountsDeleteRequest.prototype, "xApideckServiceId", void 0);
    return LedgerAccountsDeleteRequest;
}(utils_1.SpeakeasyBase));
exports.LedgerAccountsDeleteRequest = LedgerAccountsDeleteRequest;
var LedgerAccountsDeleteResponse = /** @class */ (function (_super) {
    ...
    ], LedgerAccountsDeleteResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.LedgerAccountsDeleteResponse = LedgerAccountsDeleteResponse;
