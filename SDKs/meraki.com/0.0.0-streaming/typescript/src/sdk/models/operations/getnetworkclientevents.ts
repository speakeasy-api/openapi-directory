...
export class GetNetworkClientEventsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetNetworkClientEventsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getNetworkClientEvents200ApplicationJSONObjects?: Record<string, any>[];
}
