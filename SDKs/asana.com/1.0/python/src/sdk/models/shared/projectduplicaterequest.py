...
class ProjectDuplicateRequest:
    ...
    include: Optional[ProjectDuplicateRequestIncludeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('include'), 'exclude': lambda f: f is None }})
    r"""The elements that will be duplicated to the new project. Tasks are always included."""  
