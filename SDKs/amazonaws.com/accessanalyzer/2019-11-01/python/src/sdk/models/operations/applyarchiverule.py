...
class ApplyArchiveRuleRequest:
    ...
    request_body: ApplyArchiveRuleRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
