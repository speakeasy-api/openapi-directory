...
export class Licenses {
  ...
  licenseList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.LicenseListResponse =
        new operations.LicenseListResponse({
  ...
  licensesRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.LicensesReadResponse =
        new operations.LicensesReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
