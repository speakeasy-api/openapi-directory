...
var ListCarrierServicesResponseBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: ListCarrierServicesResponseBodyService }),
        (0, class_transformer_1.Expose)({ name: "services" }),
        (0, class_transformer_1.Type)(function () { return ListCarrierServicesResponseBodyService; }),
