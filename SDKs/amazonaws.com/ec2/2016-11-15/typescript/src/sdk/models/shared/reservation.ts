 ...
 */
export class ReservationGroups extends SpeakeasyBase {
  @SpeakeasyMetadata()
  groupId?: string;
 ...
 */
export enum ReservationInstancesArchitectureEnum {
  I386 = "i386",
  X8664 = "x86_64",
  Arm64 = "arm64",
  X8664Mac = "x86_64_mac",
 ...
 */
export enum ReservationInstancesBlockDeviceMappingsEbsStatusEnum {
  Attaching = "attaching",
  Attached = "attached",
  Detaching = "detaching",
  Detached = "detached",
 ...
 */
export class ReservationInstancesBlockDeviceMappingsEbs extends SpeakeasyBase {
  @SpeakeasyMetadata()
  attachTime?: Date;
 ...
 */
export class ReservationInstancesBlockDeviceMappings extends SpeakeasyBase {
  @SpeakeasyMetadata()
  deviceName?: string;
 ...
 */
export enum ReservationInstancesBootModeEnum {
 ...
 */
export enum ReservationInstancesCapacityReservationSpecificationCapacityReservationPreferenceEnum {
  Open = "open",
  None = "none",
}
 ...
 */
export class ReservationInstancesCapacityReservationSpecificationCapacityReservationTarget extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class ReservationInstancesCapacityReservationSpecification extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class ReservationInstancesCpuOptions extends SpeakeasyBase {
  @SpeakeasyMetadata()
  coreCount?: number;
 ...
 */
export enum ReservationInstancesCurrentInstanceBootModeEnum {
  LegacyBios = "legacy-bios",
  Uefi = "uefi",
}
 ...
 */
export class ReservationInstancesElasticGpuAssociations extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class ReservationInstancesElasticInferenceAcceleratorAssociations extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class ReservationInstancesEnclaveOptions extends SpeakeasyBase {
  @SpeakeasyMetadata()
  enabled?: boolean;
}
 ...
 */
export class ReservationInstancesHibernationOptions extends SpeakeasyBase {
  @SpeakeasyMetadata()
  configured?: boolean;
}
 ...
 */
export enum ReservationInstancesHypervisorEnum {
  Ovm = "ovm",
  Xen = "xen",
}
 ...
 */
export class ReservationInstancesIamInstanceProfile extends SpeakeasyBase {
  @SpeakeasyMetadata()
  arn?: string;
 ...
 */
export enum ReservationInstancesInstanceLifecycleEnum {
  Spot = "spot",
  Scheduled = "scheduled",
}
 ...
 * The instance type.
 */
export enum ReservationInstancesInstanceTypeEnum {
  A1Medium = "a1.medium",
  A1Large = "a1.large",
  A1Xlarge = "a1.xlarge",
 ...
 */
export class ReservationInstancesLicenses extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum ReservationInstancesMaintenanceOptionsAutoRecoveryEnum {
  Disabled = "disabled",
  Default = "default",
}
 ...
 */
export class ReservationInstancesMaintenanceOptions extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum ReservationInstancesMetadataOptionsHttpEndpointEnum {
  Disabled = "disabled",
  Enabled = "enabled",
}
 ...
 */
export enum ReservationInstancesMetadataOptionsHttpProtocolIpv6Enum {
  Disabled = "disabled",
  Enabled = "enabled",
}
 ...
 */
export enum ReservationInstancesMetadataOptionsHttpTokensEnum {
  Optional = "optional",
  Required = "required",
}
 ...
 */
export enum ReservationInstancesMetadataOptionsInstanceMetadataTagsEnum {
  Disabled = "disabled",
  Enabled = "enabled",
}
 ...
 */
export enum ReservationInstancesMetadataOptionsStateEnum {
  Pending = "pending",
  Applied = "applied",
}
 ...
 */
export class ReservationInstancesMetadataOptions extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum ReservationInstancesMonitoringStateEnum {
  Disabled = "disabled",
  Disabling = "disabling",
  Enabled = "enabled",
  Pending = "pending",
 ...
 */
export class ReservationInstancesMonitoring extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class ReservationInstancesNetworkInterfacesAssociation extends SpeakeasyBase {
  @SpeakeasyMetadata()
  carrierIp?: string;
 ...
 * The attachment state.
 */
export enum ReservationInstancesNetworkInterfacesAttachmentStatusEnum {
  Attaching = "attaching",
  Attached = "attached",
  Detaching = "detaching",
  Detached = "detached",
 ...
 */
export class ReservationInstancesNetworkInterfacesAttachment extends SpeakeasyBase {
  @SpeakeasyMetadata()
  attachTime?: Date;
 ...
 * Describes a security group.
 */
export class ReservationInstancesNetworkInterfacesGroups extends SpeakeasyBase {
  @SpeakeasyMetadata()
  groupId?: string;
 ...
 */
export class ReservationInstancesNetworkInterfacesIpv4Prefixes extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipv4Prefix?: string;
}
 ...
 */
export class ReservationInstancesNetworkInterfacesIpv6Addresses extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipv6Address?: string;
}
 ...
 */
export class ReservationInstancesNetworkInterfacesIpv6Prefixes extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipv6Prefix?: string;
}
 ...
 */
export class ReservationInstancesNetworkInterfacesPrivateIpAddressesAssociation extends SpeakeasyBase {
  @SpeakeasyMetadata()
  carrierIp?: string;
 ...
 */
export class ReservationInstancesNetworkInterfacesPrivateIpAddresses extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum ReservationInstancesNetworkInterfacesStatusEnum {
  Available = "available",
 ...
 */
export class ReservationInstancesNetworkInterfaces extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: ReservationInstancesNetworkInterfacesGroups })
 ...
 */
export enum ReservationInstancesPlacementTenancyEnum {
  Default = "default",
  Dedicated = "dedicated",
  Host = "host",
}
 ...
 */
export class ReservationInstancesPlacement extends SpeakeasyBase {
  @SpeakeasyMetadata()
  affinity?: string;
 ...
 */
export enum ReservationInstancesPlatformEnum {
  Windows = "Windows",
}
 ...
 */
export enum ReservationInstancesPrivateDnsNameOptionsHostnameTypeEnum {
  IpName = "ip-name",
 ...
 */
export class ReservationInstancesPrivateDnsNameOptions extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum ReservationInstancesProductCodesProductCodeTypeEnum {
  Devpay = "devpay",
 ...
 */
export class ReservationInstancesProductCodes extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum ReservationInstancesRootDeviceTypeEnum {
  Ebs = "ebs",
 ...
 * Describes a security group.
 */
export class ReservationInstancesSecurityGroups extends SpeakeasyBase {
  @SpeakeasyMetadata()
  groupId?: string;
 ...
 */
export enum ReservationInstancesStateNameEnum {
  Pending = "pending",
  Running = "running",
 ...
 * The current state of the instance.
 */
export class ReservationInstancesState extends SpeakeasyBase {
  @SpeakeasyMetadata()
  code?: number;
 ...
 */
export class ReservationInstancesStateReason extends SpeakeasyBase {
  @SpeakeasyMetadata()
  code?: string;
 ...
 * Describes a tag.
 */
export class ReservationInstancesTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export enum ReservationInstancesVirtualizationTypeEnum {
  Hvm = "hvm",
 ...
 */
export class ReservationInstances extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: ReservationInstancesBlockDeviceMappings })
  ...
  @SpeakeasyMetadata({ elemType: ReservationInstancesElasticGpuAssociations })
  ...
  @SpeakeasyMetadata({ elemType: ReservationInstancesLicenses })
  ...
  @SpeakeasyMetadata({ elemType: ReservationInstancesNetworkInterfaces })
  ...
  @SpeakeasyMetadata({ elemType: ReservationInstancesProductCodes })
  ...
  @SpeakeasyMetadata({ elemType: ReservationInstancesSecurityGroups })
  ...
  @SpeakeasyMetadata({ elemType: ReservationInstancesTags })
...
export class Reservation extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: ReservationGroups })
  groups?: ReservationGroups[];

  @SpeakeasyMetadata({ elemType: ReservationInstances })
