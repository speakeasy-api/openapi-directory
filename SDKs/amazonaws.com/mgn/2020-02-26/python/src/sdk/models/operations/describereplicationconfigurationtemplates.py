...
class DescribeReplicationConfigurationTemplatesRequestBody:
    ...
    r"""Request to describe Replication Configuration template by max results."""  
    next_token: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('nextToken'), 'exclude': lambda f: f is None }})
    r"""Request to describe Replication Configuration template by next token."""  
    ...
    r"""Request to describe Replication Configuration template by template IDs."""  
