...
exports.DeleteCorsPolicyResponse = exports.DeleteCorsPolicyRequest = exports.DeleteCorsPolicyXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var DeleteCorsPolicyXAmzTargetEnum;
...
})(DeleteCorsPolicyXAmzTargetEnum = exports.DeleteCorsPolicyXAmzTargetEnum || (exports.DeleteCorsPolicyXAmzTargetEnum = {}));
var DeleteCorsPolicyRequest = /** @class */ (function (_super) {
    ...
    ], DeleteCorsPolicyRequest.prototype, "deleteCorsPolicyInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], DeleteCorsPolicyRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], DeleteCorsPolicyRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], DeleteCorsPolicyRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], DeleteCorsPolicyRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], DeleteCorsPolicyRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], DeleteCorsPolicyRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], DeleteCorsPolicyRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], DeleteCorsPolicyRequest.prototype, "xAmzTarget", void 0);
    return DeleteCorsPolicyRequest;
}(utils_1.SpeakeasyBase));
exports.DeleteCorsPolicyRequest = DeleteCorsPolicyRequest;
var DeleteCorsPolicyResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], DeleteCorsPolicyResponse.prototype, "rawResponse", void 0);
    return DeleteCorsPolicyResponse;
}(utils_1.SpeakeasyBase));
exports.DeleteCorsPolicyResponse = DeleteCorsPolicyResponse;
