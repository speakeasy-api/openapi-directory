...
public class ReposUpdateBranchProtectionRequestBody {
    ...
    public Boolean allowForkSyncing;
    public ReposUpdateBranchProtectionRequestBody withAllowForkSyncing(Boolean allowForkSyncing) {
    ...
    public ReposUpdateBranchProtectionRequestBody withLockBranch(Boolean lockBranch) {
