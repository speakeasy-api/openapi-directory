...
class ListPublicKeysRequest:
    headers: ListPublicKeysHeaders = dataclasses.field()
    query_params: ListPublicKeysQueryParams = dataclasses.field()
    request: shared_listpublickeysrequest.ListPublicKeysRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
