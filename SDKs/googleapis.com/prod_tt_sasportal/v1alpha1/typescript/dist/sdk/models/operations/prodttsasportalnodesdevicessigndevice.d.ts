...
export declare class ProdTtSasportalNodesDevicesSignDeviceSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalNodesDevicesSignDeviceSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
