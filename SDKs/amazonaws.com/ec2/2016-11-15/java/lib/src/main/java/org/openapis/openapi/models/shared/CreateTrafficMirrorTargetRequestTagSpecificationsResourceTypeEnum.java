 ...
 */
public enum CreateTrafficMirrorTargetRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateTrafficMirrorTargetRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
