...
func (e CreateOrganization201ApplicationJSONLicensingModelEnum) ToPointer() *CreateOrganization201ApplicationJSONLicensingModelEnum {
	return &e
}
...
func (e *CreateOrganization201ApplicationJSONLicensingModelEnum) UnmarshalJSON(data []byte) error {
	...
	case "per-device":
		fallthrough
	case "subscription":
		*e = CreateOrganization201ApplicationJSONLicensingModelEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOrganization201ApplicationJSONLicensingModelEnum: %v", v)
	}
}
