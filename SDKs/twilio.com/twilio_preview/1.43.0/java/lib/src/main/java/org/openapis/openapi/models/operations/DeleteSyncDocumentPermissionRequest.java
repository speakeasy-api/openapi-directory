...
public class DeleteSyncDocumentPermissionRequest {
    ...
    public DeleteSyncDocumentPermissionRequest(@JsonProperty("DocumentSid") String documentSid, @JsonProperty("Identity") String identity, @JsonProperty("ServiceSid") String serviceSid) {
        this.documentSid = documentSid;
        this.identity = identity;
        this.serviceSid = serviceSid;
  }
