...
class DeprecateThingTypeRequestBody:
    undo_deprecate: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('undoDeprecate') }})
    

@dataclasses.dataclass
class DeprecateThingTypeRequest:
    headers: DeprecateThingTypeHeaders = dataclasses.field()
    path_params: DeprecateThingTypePathParams = dataclasses.field()
    request: DeprecateThingTypeRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
