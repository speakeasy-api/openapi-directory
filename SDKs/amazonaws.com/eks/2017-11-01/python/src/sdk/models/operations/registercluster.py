...
class RegisterClusterRequestBodyConnectorConfig:
    ...
    provider: Optional[shared_connectorconfigprovider_enum.ConnectorConfigProviderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('provider') }})
...
class RegisterClusterRequestBody:
    connector_config: RegisterClusterRequestBodyConnectorConfig = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('connectorConfig') }})
...
class RegisterClusterRequest:
    headers: RegisterClusterHeaders = dataclasses.field()
    request: RegisterClusterRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
