...
public class ListQueueListQueueResponse {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("queues")
    public openapisdk.models.shared.ApiV2010AccountQueue[] queues;
    public ListQueueListQueueResponse withQueues(openapisdk.models.shared.ApiV2010AccountQueue[] queues) {
        this.queues = queues;
        return this;
    }
    @JsonInclude(Include.NON_ABSENT)
