...
var TaxonomyServices = /** @class */ (function () {
    ...
    TaxonomyServices.prototype.taxonomyAttractions = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.TaxonomyAttractionsResponse({
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.taxonomyAttractions200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.TaxonomyAttractions200ApplicationJSON);
                    }
                    break;
            }
            return res;
    ...
    TaxonomyServices.prototype.taxonomyCategories = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TaxonomyCategoriesResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.taxonomyCategories200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.TaxonomyCategories200ApplicationJSON);
                    }
                    break;
            }
            return res;
    ...
    TaxonomyServices.prototype.taxonomyDestinations = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TaxonomyDestinationsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.taxonomyDestinations200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.TaxonomyDestinations200ApplicationJSON);
                    }
                    break;
            }
            return res;
