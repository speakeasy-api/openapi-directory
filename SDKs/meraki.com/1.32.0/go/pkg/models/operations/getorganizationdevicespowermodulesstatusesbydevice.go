...
func (e GetOrganizationDevicesPowerModulesStatusesByDeviceTagsFilterTypeEnum) ToPointer() *GetOrganizationDevicesPowerModulesStatusesByDeviceTagsFilterTypeEnum {
	return &e
}
...
func (e *GetOrganizationDevicesPowerModulesStatusesByDeviceTagsFilterTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "withAllTags":
		fallthrough
	case "withAnyTags":
		*e = GetOrganizationDevicesPowerModulesStatusesByDeviceTagsFilterTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationDevicesPowerModulesStatusesByDeviceTagsFilterTypeEnum: %v", v)
	}
}
...
func (e GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONProductTypeEnum) ToPointer() *GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONProductTypeEnum {
	return &e
}
...
func (e *GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONProductTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "systemsManager":
		fallthrough
	case "wireless":
		*e = GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONProductTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONProductTypeEnum: %v", v)
	}
}
...
type GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONSlotsNumberEnum int64
...
func (e GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONSlotsNumberEnum) ToPointer() *GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONSlotsNumberEnum {
	return &e
}
...
func (e *GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONSlotsNumberEnum) UnmarshalJSON(data []byte) error {
	...
	case 1:
		fallthrough
	case 2:
		*e = GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONSlotsNumberEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONSlotsNumberEnum: %v", v)
	}
}
...
func (e GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONSlotsStatusEnum) ToPointer() *GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONSlotsStatusEnum {
	return &e
}
...
func (e *GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONSlotsStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "not connected":
		fallthrough
	case "powering":
		*e = GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONSlotsStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationDevicesPowerModulesStatusesByDevice200ApplicationJSONSlotsStatusEnum: %v", v)
	}
}
