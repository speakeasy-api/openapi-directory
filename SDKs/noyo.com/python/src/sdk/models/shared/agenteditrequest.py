...
class AgentEditRequestAgentDetails:
    r"""AgentEditRequestAgentDetails
...
class AgentEditRequest:
    ...
    agent_details: Optional[AgentEditRequestAgentDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('agent_details') }})
