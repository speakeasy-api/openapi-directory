...
type UpdateNetworkSiteHeaders struct {
...
type UpdateNetworkSiteRequestBody struct {
...
type UpdateNetworkSiteRequest struct {
	Headers UpdateNetworkSiteHeaders
	Request UpdateNetworkSiteRequestBody `request:"mediaType=application/json"`
}
