...
exports.TaxRate = exports.TaxRateInput = exports.TaxRateTaxRateStatusEnum = exports.TaxRateComponents = void 0;
var utils_1 = require("../../../internal/utils");
var class_transformer_1 = require("class-transformer");
var TaxRateComponents = /** @class */ (function (_super) {
    __extends(TaxRateComponents, _super);
    function TaxRateComponents() {
    ...
    ], TaxRateComponents.prototype, "compound", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "id" }),
        __metadata("design:type", String)
    ], TaxRateComponents.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "name" }),
        __metadata("design:type", String)
    ], TaxRateComponents.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "rate" }),
        __metadata("design:type", Number)
    ], TaxRateComponents.prototype, "rate", void 0);
    return TaxRateComponents;
}(utils_1.SpeakeasyBase));
exports.TaxRateComponents = TaxRateComponents;
/**
 * Tax rate status
 */
var TaxRateTaxRateStatusEnum;
...
})(TaxRateTaxRateStatusEnum = exports.TaxRateTaxRateStatusEnum || (exports.TaxRateTaxRateStatusEnum = {}));
var TaxRateInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: TaxRateComponents }),
        (0, class_transformer_1.Expose)({ name: "components" }),
        (0, class_transformer_1.Type)(function () { return TaxRateComponents; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "effective_tax_rate" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "original_tax_rate_id" }),
        __metadata("design:type", String)
    ], TaxRateInput.prototype, "originalTaxRateId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "report_tax_type" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "tax_payable_account_id" }),
        __metadata("design:type", String)
    ], TaxRateInput.prototype, "taxPayableAccountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "tax_remitted_account_id" }),
        __metadata("design:type", String)
    ], TaxRateInput.prototype, "taxRemittedAccountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "total_tax_rate" }),
        __metadata("design:type", Number)
...
exports.TaxRateInput = TaxRateInput;
