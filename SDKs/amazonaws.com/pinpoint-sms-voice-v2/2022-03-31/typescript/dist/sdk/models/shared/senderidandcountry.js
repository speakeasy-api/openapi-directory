...
exports.SenderIdAndCountry = void 0;
 ...
 */
var SenderIdAndCountry = /** @class */ (function (_super) {
    __extends(SenderIdAndCountry, _super);
    function SenderIdAndCountry() {
    ...
    ], SenderIdAndCountry.prototype, "isoCountryCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "SenderId" }),
        __metadata("design:type", String)
    ], SenderIdAndCountry.prototype, "senderId", void 0);
