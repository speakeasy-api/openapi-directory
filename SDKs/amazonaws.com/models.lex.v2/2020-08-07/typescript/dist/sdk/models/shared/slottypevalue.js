...
var samplevalue_1 = require("./samplevalue");
// SlotTypeValue
/**
...
var SlotTypeValue = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sampleValue" }),
        __metadata("design:type", samplevalue_1.SampleValue)
    ], SlotTypeValue.prototype, "sampleValue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=synonyms", elemType: samplevalue_1.SampleValue }),
