...
class GetNamesNotOfficialSearchRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNamesNotOfficialSearchEmbedEnum $embed
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=embed')]
    public ?GetNamesNotOfficialSearchEmbedEnum $embed = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNamesNotOfficialSearchExactSpellingEnum $exactSpelling
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=exactSpelling')]
    public ?GetNamesNotOfficialSearchExactSpellingEnum $exactSpelling = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\GetNamesNotOfficialSearchOutputFormatEnum $outputFormat
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNamesNotOfficialSearchOutputSrsEnum $outputSRS
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=outputSRS')]
    public ?GetNamesNotOfficialSearchOutputSrsEnum $outputSRS = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNamesNotOfficialSearchOutputStyleEnum $outputStyle
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=outputStyle')]
    public ?GetNamesNotOfficialSearchOutputStyleEnum $outputStyle = null;
    
    /**
     * The distance to move the accessPoint away from the curb and towards the inside of the parcel (in metres). Ignored if locationDescriptor not set to accessPoint.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNamesNotOfficialSearchSortByEnum $sortBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortBy')]
    public ?GetNamesNotOfficialSearchSortByEnum $sortBy = null;
	...
	public function __construct()
	{
		...
		$this->name = "";
		$this->outputFormat = \OpenAPI\OpenAPI\Models\Operations\GetNamesNotOfficialSearchOutputFormatEnum::JSON;
		$this->outputSRS = null;
