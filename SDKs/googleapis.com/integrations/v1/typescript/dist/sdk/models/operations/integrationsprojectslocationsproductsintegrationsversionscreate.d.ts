...
export declare class IntegrationsProjectsLocationsProductsIntegrationsVersionsCreateSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class IntegrationsProjectsLocationsProductsIntegrationsVersionsCreateRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class IntegrationsProjectsLocationsProductsIntegrationsVersionsCreateResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
