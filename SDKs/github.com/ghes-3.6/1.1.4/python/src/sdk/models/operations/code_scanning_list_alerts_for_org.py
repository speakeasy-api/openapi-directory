...
class CodeScanningListAlertsForOrgSortEnum(str, Enum):
...
class CodeScanningListAlertsForOrgRequest:
    ...
    r"""A cursor, as given in the [Link header](https://docs.github.com/enterprise-server@3.6/rest/overview/resources-in-the-rest-api#link-header). If specified, the query only searches for results after this cursor."""  
    before: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'before', 'style': 'form', 'explode': True }})
    r"""A cursor, as given in the [Link header](https://docs.github.com/enterprise-server@3.6/rest/overview/resources-in-the-rest-api#link-header). If specified, the query only searches for results before this cursor."""  
    ...
    sort: Optional[CodeScanningListAlertsForOrgSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""The property by which to sort the results."""  
...
@dataclasses.dataclass
class CodeScanningListAlertsForOrg503ApplicationJSON:
...
@dataclasses.dataclass
class CodeScanningListAlertsForOrgResponse:
    ...
    r"""Response"""  
    code_scanning_list_alerts_for_org_503_application_json_object: Optional[CodeScanningListAlertsForOrg503ApplicationJSON] = dataclasses.field(default=None)
    r"""Service unavailable"""  
