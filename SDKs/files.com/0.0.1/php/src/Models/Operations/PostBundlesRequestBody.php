...
class PostBundlesRequestBody
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostBundlesRequestBodyPermissionsEnum $permissions
     */
	#[SpeakeasyMetadata('multipartForm:name=permissions')]
    public ?PostBundlesRequestBodyPermissionsEnum $permissions = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostBundlesRequestBodyWatermarkAttachmentFile $watermarkAttachmentFile
     */
	#[SpeakeasyMetadata('multipartForm:file=true')]
    public ?PostBundlesRequestBodyWatermarkAttachmentFile $watermarkAttachmentFile = null;
