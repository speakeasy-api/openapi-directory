...
import { VpnGatewaysScopedList } from "./vpngatewaysscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum VpnGatewayAggregatedListWarningCodeEnum {
...
export declare class VpnGatewayAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class VpnGatewayAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: VpnGatewayAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: VpnGatewayAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class VpnGatewayAggregatedList extends SpeakeasyBase {
    /**
