...
exports.TopONDResponse = exports.TopONDRequest = exports.TopONDSecurity = void 0;
...
var TopONDRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], TopONDRequest.prototype, "accept", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=catalogues",
        }),
        __metadata("design:type", String)
    ], TopONDRequest.prototype, "catalogues", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=origin",
        }),
        __metadata("design:type", String)
    ], TopONDRequest.prototype, "origin", void 0);
...
var TopONDResponse = /** @class */ (function (_super) {
    ...
    ], TopONDResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", String)
