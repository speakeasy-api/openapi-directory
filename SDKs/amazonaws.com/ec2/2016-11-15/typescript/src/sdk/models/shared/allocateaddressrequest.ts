 ...
 */
export enum AllocateAddressRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class AllocateAddressRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class AllocateAddressRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: AllocateAddressRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: AllocateAddressRequestTagSpecificationsTags })
  tags?: AllocateAddressRequestTagSpecificationsTags[];
}

export class AllocateAddressRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  address?: string;
  ...
  @SpeakeasyMetadata({ elemType: AllocateAddressRequestTagSpecifications })
