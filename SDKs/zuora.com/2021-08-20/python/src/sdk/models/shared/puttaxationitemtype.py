...
class PUTTaxationItemTypeFinanceInformation:
...
class PUTTaxationItemTypeTaxRateTypeEnum(str, Enum):
...
class PUTTaxationItemType:
    ...
    finance_information: Optional[PUTTaxationItemTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the taxation item."""  
    ...
    r"""The name of the taxation item to be updated."""  
    ...
    tax_rate_type: Optional[PUTTaxationItemTypeTaxRateTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxRateType'), 'exclude': lambda f: f is None }})
    r"""The type of the tax rate applied to the credit or debit memo."""  
