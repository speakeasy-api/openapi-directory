...
func (e ProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum) ToPointer() *ProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum {
	return &e
}

func (e *ProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = ProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum: %v", v)
	}
}
