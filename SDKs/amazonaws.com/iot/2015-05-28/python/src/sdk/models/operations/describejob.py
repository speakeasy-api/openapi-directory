...
from ..shared import describejobresponse as shared_describejobresponse
...
class DescribeJobResponse:
    ...
    describe_job_response: Optional[shared_describejobresponse.DescribeJobResponse] = dataclasses.field(default=None)
