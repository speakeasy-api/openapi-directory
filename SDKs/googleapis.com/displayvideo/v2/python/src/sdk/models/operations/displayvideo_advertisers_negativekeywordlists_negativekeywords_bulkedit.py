...
class DisplayvideoAdvertisersNegativeKeywordListsNegativeKeywordsBulkEditRequest:
    ...
    bulk_edit_negative_keywords_request_input: Optional[shared_bulkeditnegativekeywordsrequest.BulkEditNegativeKeywordsRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
