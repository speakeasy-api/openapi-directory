...
export declare class SDK {
     ...
     */
    getCustomRulePolicy(req: operations.GetCustomRulePolicyRequest, config?: AxiosRequestConfig): Promise<operations.GetCustomRulePolicyResponse>;
    /**
     ...
     */
    getOrganizationCustomRulePolicy(req: operations.GetOrganizationCustomRulePolicyRequest, config?: AxiosRequestConfig): Promise<operations.GetOrganizationCustomRulePolicyResponse>;
    /**
     ...
     */
    getResourceEvaluationSummary(req: operations.GetResourceEvaluationSummaryRequest, config?: AxiosRequestConfig): Promise<operations.GetResourceEvaluationSummaryResponse>;
    /**
     ...
     */
    listConformancePackComplianceScores(req: operations.ListConformancePackComplianceScoresRequest, config?: AxiosRequestConfig): Promise<operations.ListConformancePackComplianceScoresResponse>;
    /**
     ...
     */
    listResourceEvaluations(req: operations.ListResourceEvaluationsRequest, config?: AxiosRequestConfig): Promise<operations.ListResourceEvaluationsResponse>;
    /**
     ...
     */
    startResourceEvaluation(req: operations.StartResourceEvaluationRequest, config?: AxiosRequestConfig): Promise<operations.StartResourceEvaluationResponse>;
    /**
