...
class Settings:
    ...
    def get_all_settings(self) -> operations.GetAllSettingsResponse:
        ...
        url = base_url.removesuffix('/') + '/indexes/books/settings'
        ...
        res = operations.GetAllSettingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def reset_all_settings(self) -> operations.ResetAllSettingsResponse:
        ...
        res = operations.ResetAllSettingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_settings(self, request: operations.UpdateSettingsRequestBody) -> operations.UpdateSettingsResponse:
        r"""Update settings
        Update settings
        """
        base_url = self._server_url
