...
func (s *SDK) CreateKeyspace(ctx context.Context, request operations.CreateKeyspaceRequest) (*operations.CreateKeyspaceResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "CreateKeyspaceRequest", "json")
	if err != nil {
...
func (s *SDK) DeleteKeyspace(ctx context.Context, request operations.DeleteKeyspaceRequest) (*operations.DeleteKeyspaceResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DeleteKeyspaceRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) GetKeyspace(ctx context.Context, request operations.GetKeyspaceRequest) (*operations.GetKeyspaceResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetKeyspaceRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) ListKeyspaces(ctx context.Context, request operations.ListKeyspacesRequest) (*operations.ListKeyspacesResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListKeyspacesRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
