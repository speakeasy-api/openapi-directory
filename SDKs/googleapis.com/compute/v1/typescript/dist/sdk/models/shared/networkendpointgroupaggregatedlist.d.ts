 ...
 */
export declare enum NetworkEndpointGroupAggregatedListWarningCodeEnum {
...
export declare class NetworkEndpointGroupAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NetworkEndpointGroupAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class NetworkEndpointGroupAggregatedList extends SpeakeasyBase {
    /**
