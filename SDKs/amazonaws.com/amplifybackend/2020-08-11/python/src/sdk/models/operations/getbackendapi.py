...
class GetBackendAPIRequestBodyResourceConfigConflictResolutionResolutionStrategyEnum(str, Enum):
...
class GetBackendAPIRequestBodyResourceConfigConflictResolution:
    ...
    resolution_strategy: Optional[GetBackendAPIRequestBodyResourceConfigConflictResolutionResolutionStrategyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ResolutionStrategy'), 'exclude': lambda f: f is None }})  
    
class GetBackendAPIRequestBodyResourceConfigDefaultAuthTypeModeEnum(str, Enum):
...
class GetBackendAPIRequestBodyResourceConfigDefaultAuthType:
    ...
    mode: Optional[GetBackendAPIRequestBodyResourceConfigDefaultAuthTypeModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Mode'), 'exclude': lambda f: f is None }})  
    settings: Optional[GetBackendAPIRequestBodyResourceConfigDefaultAuthTypeSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Settings'), 'exclude': lambda f: f is None }})  
...
class GetBackendAPIRequestBodyResourceConfig:
    ...
    conflict_resolution: Optional[GetBackendAPIRequestBodyResourceConfigConflictResolution] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ConflictResolution'), 'exclude': lambda f: f is None }})  
    default_auth_type: Optional[GetBackendAPIRequestBodyResourceConfigDefaultAuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DefaultAuthType'), 'exclude': lambda f: f is None }})  
...
class GetBackendAPIRequestBody:
    ...
    resource_config: Optional[GetBackendAPIRequestBodyResourceConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resourceConfig'), 'exclude': lambda f: f is None }})
    r"""The resource config for the data model, configured as a part of the Amplify project."""  
...
class GetBackendAPIRequest:
    ...
    request_body: GetBackendAPIRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
