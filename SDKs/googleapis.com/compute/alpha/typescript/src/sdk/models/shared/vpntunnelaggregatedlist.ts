 ...
 */
export enum VpnTunnelAggregatedListWarningCodeEnum {
...
export class VpnTunnelAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class VpnTunnelAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: VpnTunnelAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class VpnTunnelAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: VpnTunnelsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, VpnTunnelsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], VpnTunnelsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
