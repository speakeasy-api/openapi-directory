...
var Customers = /** @class */ (function () {
    ...
    **/
    Customers.prototype.prodTtSasportalCustomersList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ProdTtSasportalCustomersListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1alpha1/customers";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.sasPortalListCustomersResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
