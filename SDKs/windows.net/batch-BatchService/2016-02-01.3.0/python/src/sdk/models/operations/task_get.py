...
class TaskGetRequest:
    headers: TaskGetHeaders = dataclasses.field()
    path_params: TaskGetPathParams = dataclasses.field()
    query_params: TaskGetQueryParams = dataclasses.field()
...
class TaskGetResponse:
    ...
    cloud_task: Optional[Any] = dataclasses.field(default=None)
