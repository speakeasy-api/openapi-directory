...
from ..shared import getcollectionusersresponse as shared_getcollectionusersresponse
...
class CollectionUsersAllSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class CollectionUsersAllRequest:
...
class CollectionUsersAllResponse:
    ...
    r"""Bad Request"""  
    get_collection_users_response: Optional[shared_getcollectionusersresponse.GetCollectionUsersResponse] = dataclasses.field(default=None)
    r"""Users"""  
