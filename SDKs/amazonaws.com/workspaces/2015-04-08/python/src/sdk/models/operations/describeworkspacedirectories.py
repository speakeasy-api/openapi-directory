...
class DescribeWorkspaceDirectoriesRequest:
    ...
    describe_workspace_directories_request: shared_describeworkspacedirectoriesrequest.DescribeWorkspaceDirectoriesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
