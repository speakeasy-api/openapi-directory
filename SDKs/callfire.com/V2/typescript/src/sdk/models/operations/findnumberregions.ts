...
export class FindNumberRegionsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FindNumberRegionsRequest extends SpeakeasyBase {
  /**
   * A city name
   */
...
export class FindNumberRegionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
