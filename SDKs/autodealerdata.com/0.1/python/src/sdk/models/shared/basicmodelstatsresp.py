...
from ..shared import basicmodelstats as shared_basicmodelstats


@dataclass_json
@dataclasses.dataclass
class BasicModelStatsResp:
    data: list[shared_basicmodelstats.BasicModelStats] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
