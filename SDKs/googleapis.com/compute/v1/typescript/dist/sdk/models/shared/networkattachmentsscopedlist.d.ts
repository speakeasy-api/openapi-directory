 ...
 */
export declare enum NetworkAttachmentsScopedListWarningCodeEnum {
...
export declare class NetworkAttachmentsScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NetworkAttachmentsScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class NetworkAttachmentsScopedList extends SpeakeasyBase {
    /**
