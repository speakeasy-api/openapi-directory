...
public class PutMobileDeviceAccessOverrideRequest {
    ...
    public PutMobileDeviceAccessOverrideRequest(@JsonProperty("PutMobileDeviceAccessOverrideRequest") org.openapis.openapi.models.shared.PutMobileDeviceAccessOverrideRequest putMobileDeviceAccessOverrideRequest, @JsonProperty("X-Amz-Target") PutMobileDeviceAccessOverrideXAmzTargetEnum xAmzTarget) {
        this.putMobileDeviceAccessOverrideRequest = putMobileDeviceAccessOverrideRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
