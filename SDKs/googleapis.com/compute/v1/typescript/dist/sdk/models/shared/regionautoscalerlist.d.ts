 ...
 */
export declare enum RegionAutoscalerListWarningCodeEnum {
...
export declare class RegionAutoscalerListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class RegionAutoscalerListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class RegionAutoscalerList extends SpeakeasyBase {
    /**
