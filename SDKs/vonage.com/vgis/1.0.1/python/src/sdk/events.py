...
class Events:
    ...
    def get_event(self, request: operations.GetEventRequest) -> operations.GetEventResponse:
        ...
        url = utils.generate_url(operations.GetEventRequest, base_url, '/self/events/{id}', request)
    ...
    def get_events_count(self, request: operations.GetEventsCountRequest) -> operations.GetEventsCountResponse:
        ...
        query_params = utils.get_query_params(operations.GetEventsCountRequest, request)
        ...
        res = operations.GetEventsCountResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
