...
type ContentAccountsReturncarrierListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentAccountsReturncarrierListPathParams struct {
	// Required. The Merchant Center Account Id under which the Return Carrier is to be linked.
	AccountID string `pathParam:"style=simple,explode=false,name=accountId"`
}

type ContentAccountsReturncarrierListQueryParams struct {
	// V1 error format.
...
type ContentAccountsReturncarrierListRequest struct {
...
type ContentAccountsReturncarrierListResponse struct {
	ContentType string
	// Successful response
