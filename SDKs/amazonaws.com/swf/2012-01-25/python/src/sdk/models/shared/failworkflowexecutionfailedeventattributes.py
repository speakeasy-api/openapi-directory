...
class FailWorkflowExecutionFailedEventAttributes:
    r"""Provides the details of the <code>FailWorkflowExecutionFailed</code> event."""
    
    cause: shared_failworkflowexecutionfailedcause_enum.FailWorkflowExecutionFailedCauseEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cause') }})  
