...
class PostDisableTransitGatewayRouteTablePropagationQueryParams:
    action: PostDisableTransitGatewayRouteTablePropagationActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDisableTransitGatewayRouteTablePropagationVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDisableTransitGatewayRouteTablePropagationRequest:
    headers: PostDisableTransitGatewayRouteTablePropagationHeaders = dataclasses.field()
    query_params: PostDisableTransitGatewayRouteTablePropagationQueryParams = dataclasses.field()
