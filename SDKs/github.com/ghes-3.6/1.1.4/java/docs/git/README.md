...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateBlobRequest req = new GitCreateBlobRequest(                new GitCreateBlobRequestBody("ipsa") {{
                                encoding = "totam";
                            }};, "quae", "molestiae");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateCommitRequest req = new GitCreateCommitRequest(                new GitCreateCommitRequestBody("eveniet", "qui") {{
                                author = new GitCreateCommitRequestBodyAuthor("cum", "iure") {{
                                    date = OffsetDateTime.parse("2022-06-09T15:08:05.768Z");
                                }};;
                                committer = new GitCreateCommitRequestBodyCommitter() {{
                                    date = OffsetDateTime.parse("2021-07-27T21:33:31.354Z");
                                    email = "Juanita99@yahoo.com";
                                    name = "Renee Metz";
                                }};;
                                parents = new String[]{{
                                    add("alias"),
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateRefRequest req = new GitCreateRefRequest(                new GitCreateRefRequestBody("minima", "dolore") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateTagRequest req = new GitCreateTagRequest(                new GitCreateTagRequestBody("quae", "recusandae", "omnis", GitCreateTagRequestBodyTypeEnum.COMMIT) {{
                                tagger = new GitCreateTagRequestBodyTagger("molestiae", "ex") {{
                                    date = OffsetDateTime.parse("2022-05-14T22:22:36.102Z");
                                }};;
                            }};, "adipisci", "debitis");            
    ...
    public static void main(String[] args) {
        try {
            ...
            GitCreateTreeRequest req = new GitCreateTreeRequest(                new GitCreateTreeRequestBody(                new org.openapis.openapi.models.operations.GitCreateTreeRequestBodyTree[]{{
                                                ...
                                                add(new GitCreateTreeRequestBodyTree() {{
                                                    content = "quis";
                                                    mode = GitCreateTreeRequestBodyTreeModeEnum.FORTY_THOUSAND;
                                                    path = "reiciendis";
                                                    sha = "provident";
                                                ...
                                                add(new GitCreateTreeRequestBodyTree() {{
                                                    content = "ullam";
                                                    mode = GitCreateTreeRequestBodyTreeModeEnum.ONE_HUNDRED_THOUSAND_SIX_HUNDRED_AND_FORTY_FOUR;
                                                    path = "animi";
                                                    sha = "nostrum";
                                                    type = GitCreateTreeRequestBodyTreeTypeEnum.TREE;
                                                }}),
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitDeleteRefRequest req = new GitDeleteRefRequest("ex", "aliquid", "accusantium");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetBlobRequest req = new GitGetBlobRequest("repellat", "doloribus", "ullam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetCommitRequest req = new GitGetCommitRequest("in", "nam", "earum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetRefRequest req = new GitGetRefRequest("officia", "laborum", "placeat");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetTagRequest req = new GitGetTagRequest("modi", "voluptatibus", "molestias");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetTreeRequest req = new GitGetTreeRequest("officiis", "sapiente", "cumque") {{
                recursive = "vitae";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitListMatchingRefsRequest req = new GitListMatchingRefsRequest("rerum", "tempora", "quis");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitUpdateRefRequest req = new GitUpdateRefRequest(                new GitUpdateRefRequestBody("inventore") {{
                                force = false;
                            }};, "fugit", "cumque", "quae");            
