...
class Error403NGPIIS:
    ...
    tpp_messages: Optional[list[shared_tppmessage403_piis.TppMessage403PIIS]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tppMessages'), 'exclude': lambda f: f is None }})  
