...
public class Emails {
    ...
    public org.openapis.openapi.models.operations.EmailValidationResponse emailValidation(org.openapis.openapi.models.operations.EmailValidationRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/emails");
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.EmailValidationQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.EmailResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.EmailResponse.class);
