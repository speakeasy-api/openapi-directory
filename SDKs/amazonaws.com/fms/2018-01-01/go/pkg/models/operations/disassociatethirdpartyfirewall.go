...
type DisassociateThirdPartyFirewallHeaders struct {
...
type DisassociateThirdPartyFirewallRequest struct {
	Headers DisassociateThirdPartyFirewallHeaders
	Request shared.DisassociateThirdPartyFirewallRequest `request:"mediaType=application/json"`
}
