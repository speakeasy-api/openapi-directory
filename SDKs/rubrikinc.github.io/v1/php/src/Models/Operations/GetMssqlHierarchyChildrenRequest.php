...
class GetMssqlHierarchyChildrenRequest
{
    /**
     ...
     * 
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\GetMssqlHierarchyChildrenObjectTypeEnum> $objectType
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetMssqlHierarchyChildrenSLAAssignmentEnum $slaAssignment
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sla_assignment')]
    public ?GetMssqlHierarchyChildrenSLAAssignmentEnum $slaAssignment = null;
    
    /**
     * Determines whether SQL Server instances are fetched with additional privilege checks.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetMssqlHierarchyChildrenSnappableStatusEnum $snappableStatus
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=snappable_status')]
    public ?GetMssqlHierarchyChildrenSnappableStatusEnum $snappableStatus = null;
    
    /**
     * Attribute to sort the results on.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetMssqlHierarchyChildrenSortByEnum $sortBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort_by')]
    public ?GetMssqlHierarchyChildrenSortByEnum $sortBy = null;
    
    /**
     * Sort order, either ascending or descending.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetMssqlHierarchyChildrenSortOrderEnum $sortOrder
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort_order')]
    public ?GetMssqlHierarchyChildrenSortOrderEnum $sortOrder = null;
