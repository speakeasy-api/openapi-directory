...
class CreateBatchResponseBodyOptionalLink:
    r"""CreateBatchResponseBodyOptionalLink
...
@dataclass_json
@dataclasses.dataclass
class CreateBatchResponseBodyLabelDownload:
    r"""CreateBatchResponseBodyLabelDownload
...
class CreateBatchResponseBody:
    ...
    batch_errors_url: CreateBatchResponseBodyOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('batch_errors_url') }})
    ...
    form_download: CreateBatchResponseBodyOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('form_download') }})
    forms: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('forms') }})
    label_download: CreateBatchResponseBodyLabelDownload = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('label_download') }})
