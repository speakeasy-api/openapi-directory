...
export enum ListEntitledApplicationsXAmzTargetEnum {
  PhotonAdminProxyServiceListEntitledApplications = "PhotonAdminProxyService.ListEntitledApplications",
}

export class ListEntitledApplicationsRequest extends SpeakeasyBase {
...
export class ListEntitledApplicationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
