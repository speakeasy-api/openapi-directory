 ...
 */
export class DescribeVerifiedAccessInstancesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeVerifiedAccessInstancesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
