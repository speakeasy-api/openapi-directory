...
from ..shared import api_v2010_account_available_phone_number_country_available_phone_number_local as shared_api_v2010_account_available_phone_number_country_available_phone_number_local
...
class ListAvailablePhoneNumberLocalListAvailablePhoneNumberLocalResponse:
    available_phone_numbers: Optional[list[shared_api_v2010_account_available_phone_number_country_available_phone_number_local.APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('available_phone_numbers') }})
...
class ListAvailablePhoneNumberLocalRequest:
    path_params: ListAvailablePhoneNumberLocalPathParams = dataclasses.field()
    query_params: ListAvailablePhoneNumberLocalQueryParams = dataclasses.field()
    security: ListAvailablePhoneNumberLocalSecurity = dataclasses.field()
...
class ListAvailablePhoneNumberLocalResponse:
    ...
    list_available_phone_number_local_response: Optional[ListAvailablePhoneNumberLocalListAvailablePhoneNumberLocalResponse] = dataclasses.field(default=None)
