...
class GamesApplicationsGetEndPointQueryParams:
    ...
    end_point_type: Optional[GamesApplicationsGetEndPointEndPointTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'endPointType', 'style': 'form', 'explode': True }})
...
class GamesApplicationsGetEndPointRequest:
    query_params: GamesApplicationsGetEndPointQueryParams = dataclasses.field()
    security: GamesApplicationsGetEndPointSecurity = dataclasses.field()
...
class GamesApplicationsGetEndPointResponse:
    ...
    end_point: Optional[shared_endpoint.EndPoint] = dataclasses.field(default=None)
