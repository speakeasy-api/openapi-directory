...
class DeleteFunctionConcurrencyRequest:
    headers: DeleteFunctionConcurrencyHeaders = dataclasses.field()
    path_params: DeleteFunctionConcurrencyPathParams = dataclasses.field()
