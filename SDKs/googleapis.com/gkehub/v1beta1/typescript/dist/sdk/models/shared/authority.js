...
exports.Authority = exports.AuthorityInput = void 0;
...
var AuthorityInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=oidcJwks" }),
        __metadata("design:type", String)
    ], AuthorityInput.prototype, "oidcJwks", void 0);
    return AuthorityInput;
}(utils_1.SpeakeasyBase));
exports.AuthorityInput = AuthorityInput;
// Authority
/**
 * Authority encodes how Google will recognize identities from this Membership. See the workload identity documentation for more details: https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
**/
var Authority = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=identityProvider" }),
        __metadata("design:type", String)
