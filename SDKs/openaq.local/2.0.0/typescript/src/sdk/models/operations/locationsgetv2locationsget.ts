...
export class LocationsGetV2LocationsGetQueryParams extends SpeakeasyBase {
...
export class LocationsGetV2LocationsGetRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: LocationsGetV2LocationsGetQueryParams;
}


export class LocationsGetV2LocationsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
