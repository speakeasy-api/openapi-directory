...
class DeploymentmanagerTypeProvidersUpdateRequest:
    ...
    type_provider_path_parameter: str = dataclasses.field(metadata={'path_param': { 'field_name': 'typeProvider', 'style': 'simple', 'explode': False }})
    r"""The name of the type provider for this request."""  
    ...
    type_provider1: Optional[shared_typeprovider.TypeProvider] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
