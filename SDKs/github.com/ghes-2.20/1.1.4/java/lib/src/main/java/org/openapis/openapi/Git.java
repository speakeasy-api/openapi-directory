...
public class Git {
    ...
    public org.openapis.openapi.models.operations.GitListMatchingRefsResponse gitListMatchingRefs(org.openapis.openapi.models.operations.GitListMatchingRefsRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GitListMatchingRefsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
