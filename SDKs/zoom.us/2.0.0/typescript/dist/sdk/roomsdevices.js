...
exports.RoomsDevices = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var RoomsDevices = /** @class */ (function () {
    function RoomsDevices(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    RoomsDevices.prototype.changeZoomRoomsAppVersion = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ChangeZoomRoomsAppVersionRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/rooms/{roomId}/devices/{deviceId}/app_version", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 204:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.changeZoomRoomsAppVersion204ApplicationJSONAny = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
...
exports.RoomsDevices = RoomsDevices;
