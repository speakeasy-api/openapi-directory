...
export class VmmigrationProjectsLocationsSourcesDatacenterConnectorsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsSourcesDatacenterConnectorsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=datacenterConnectorId",
  })
...
export class VmmigrationProjectsLocationsSourcesDatacenterConnectorsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
