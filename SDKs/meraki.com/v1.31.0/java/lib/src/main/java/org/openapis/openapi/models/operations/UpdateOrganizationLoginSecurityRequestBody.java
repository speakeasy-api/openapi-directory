...
public class UpdateOrganizationLoginSecurityRequestBody {
    ...
    public UpdateOrganizationLoginSecurityRequestBodyApiAuthentication apiAuthentication;
    public UpdateOrganizationLoginSecurityRequestBody withApiAuthentication(UpdateOrganizationLoginSecurityRequestBodyApiAuthentication apiAuthentication) {
