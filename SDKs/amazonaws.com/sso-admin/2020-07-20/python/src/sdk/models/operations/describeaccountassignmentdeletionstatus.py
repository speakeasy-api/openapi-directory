...
class DescribeAccountAssignmentDeletionStatusRequest:
    ...
    describe_account_assignment_deletion_status_request: shared_describeaccountassignmentdeletionstatusrequest.DescribeAccountAssignmentDeletionStatusRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
