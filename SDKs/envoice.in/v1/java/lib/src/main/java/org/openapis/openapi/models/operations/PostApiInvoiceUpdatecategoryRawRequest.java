...
public class PostApiInvoiceUpdatecategoryRawRequest {
    ...
    public PostApiInvoiceUpdatecategoryRawRequest(@JsonProperty("RequestBody") byte[] requestBody, @JsonProperty("x-auth-key") String xAuthKey, @JsonProperty("x-auth-secret") String xAuthSecret) {
        this.requestBody = requestBody;
        this.xAuthKey = xAuthKey;
        this.xAuthSecret = xAuthSecret;
  }
