...
type GetReadSetExportJobPathParams struct {
	// The job's ID.
...
type GetReadSetExportJobHeaders struct {
...
type GetReadSetExportJobRequest struct {
	PathParams GetReadSetExportJobPathParams
	Headers    GetReadSetExportJobHeaders
}
