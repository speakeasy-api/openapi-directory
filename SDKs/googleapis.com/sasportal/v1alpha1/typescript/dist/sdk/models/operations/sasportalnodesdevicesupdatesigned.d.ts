...
export declare class SasportalNodesDevicesUpdateSignedSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesDevicesUpdateSignedSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesDevicesUpdateSignedSecurity extends SpeakeasyBase {
    option1?: SasportalNodesDevicesUpdateSignedSecurityOption1;
    option2?: SasportalNodesDevicesUpdateSignedSecurityOption2;
}
