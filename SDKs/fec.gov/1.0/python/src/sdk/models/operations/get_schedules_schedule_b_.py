...
class GetSchedulesScheduleBQueryParams:
    ...
    spender_committee_designation: Optional[list[GetSchedulesScheduleBSpenderCommitteeDesignationEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'spender_committee_designation', 'style': 'form', 'explode': True }})
    spender_committee_org_type: Optional[list[GetSchedulesScheduleBSpenderCommitteeOrgTypeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'spender_committee_org_type', 'style': 'form', 'explode': True }})
    spender_committee_type: Optional[list[GetSchedulesScheduleBSpenderCommitteeTypeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'spender_committee_type', 'style': 'form', 'explode': True }})
...
class GetSchedulesScheduleBRequest:
    query_params: GetSchedulesScheduleBQueryParams = dataclasses.field()
