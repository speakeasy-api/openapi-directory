...
class UpdatePaymentCancellationPsuDataPathParams:
...
@dataclasses.dataclass
class UpdatePaymentCancellationPsuDataHeaders:
...
@dataclasses.dataclass
class UpdatePaymentCancellationPsuDataSecurity:
...
@dataclasses.dataclass
class UpdatePaymentCancellationPsuDataRequest:
    headers: UpdatePaymentCancellationPsuDataHeaders = dataclasses.field()
    path_params: UpdatePaymentCancellationPsuDataPathParams = dataclasses.field()
    security: UpdatePaymentCancellationPsuDataSecurity = dataclasses.field()
...
class UpdatePaymentCancellationPsuDataResponse:
    ...
    update_payment_cancellation_psu_data_200_application_json_one_of: Optional[Any] = dataclasses.field(default=None)
