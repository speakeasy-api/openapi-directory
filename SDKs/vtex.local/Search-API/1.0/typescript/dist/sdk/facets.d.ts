...
export declare class Facets {
     ...
     * ```
     */
    facetscategory(req: operations.FacetscategoryRequest, config?: AxiosRequestConfig): Promise<operations.FacetscategoryResponse>;
    /**
     * Get Category Facets
     *
     * @remarks
     ...
     * ```
     */
    getApiCatalogSystemPubFacetsCategoryCategoryId(req: operations.GetApiCatalogSystemPubFacetsCategoryCategoryIdRequest, config?: AxiosRequestConfig): Promise<operations.GetApiCatalogSystemPubFacetsCategoryCategoryIdResponse>;
}
