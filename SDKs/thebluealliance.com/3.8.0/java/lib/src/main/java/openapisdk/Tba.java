...
public class Tba {
	...
	public Tba(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public openapisdk.models.operations.GetStatusResponse getStatus(openapisdk.models.operations.GetStatusRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.ApiStatus out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ApiStatus.class);
                res.apiStatus = out;
            }
        }
