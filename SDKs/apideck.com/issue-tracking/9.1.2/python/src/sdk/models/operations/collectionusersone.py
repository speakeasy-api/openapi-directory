...
from ..shared import getcollectionuserresponse as shared_getcollectionuserresponse
...
class CollectionUsersOneResponse:
    ...
    r"""Bad Request"""  
    get_collection_user_response: Optional[shared_getcollectionuserresponse.GetCollectionUserResponse] = dataclasses.field(default=None)
    r"""User"""  
