...
class GetImportClientVpnClientCertificateRevocationListQueryParams:
    action: GetImportClientVpnClientCertificateRevocationListActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    certificate_revocation_list: str = dataclasses.field(metadata={'query_param': { 'field_name': 'CertificateRevocationList', 'style': 'form', 'explode': True }})
    client_vpn_endpoint_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'ClientVpnEndpointId', 'style': 'form', 'explode': True }})
    version: GetImportClientVpnClientCertificateRevocationListVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetImportClientVpnClientCertificateRevocationListRequest:
    headers: GetImportClientVpnClientCertificateRevocationListHeaders = dataclasses.field()
    query_params: GetImportClientVpnClientCertificateRevocationListQueryParams = dataclasses.field()
