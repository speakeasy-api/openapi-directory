...
var Taxonomies = /** @class */ (function () {
    ...
    Taxonomies.prototype.taxonomiesList = function (config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.TaxonomiesListResponse({
    ...
    Taxonomies.prototype.taxonomiesRead = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/taxonomies/{taxonomy_id}/", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.TaxonomiesReadResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
