...
exports.PostAccountAccessConsentsResponse = exports.PostAccountAccessConsentsRequest = exports.PostAccountAccessConsentsSecurity = void 0;
...
var PostAccountAccessConsentsRequest = /** @class */ (function (_super) {
    ...
    ], PostAccountAccessConsentsRequest.prototype, "obReadConsent1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=sandbox-id",
        }),
        __metadata("design:type", String)
    ], PostAccountAccessConsentsRequest.prototype, "sandboxId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], PostAccountAccessConsentsRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], PostAccountAccessConsentsRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], PostAccountAccessConsentsRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], PostAccountAccessConsentsRequest.prototype, "xFapiInteractionId", void 0);
...
var PostAccountAccessConsentsResponse = /** @class */ (function (_super) {
    ...
    ], PostAccountAccessConsentsResponse.prototype, "rawResponse", void 0);
