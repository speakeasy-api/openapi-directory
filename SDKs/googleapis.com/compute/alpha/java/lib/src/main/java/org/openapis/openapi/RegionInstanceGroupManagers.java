...
public class RegionInstanceGroupManagers {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersResumeInstancesResponse computeRegionInstanceGroupManagersResumeInstances(org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersResumeInstancesRequest request, org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersResumeInstancesSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersResumeInstancesRequest.class, baseUrl, "/projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/resumeInstances", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "regionInstanceGroupManagersResumeInstancesRequest", "json");
        req.setBody(serializedRequestBody);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersResumeInstancesRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersStartInstancesResponse computeRegionInstanceGroupManagersStartInstances(org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersStartInstancesRequest request, org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersStartInstancesSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersStartInstancesRequest.class, baseUrl, "/projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/startInstances", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "regionInstanceGroupManagersStartInstancesRequest", "json");
        req.setBody(serializedRequestBody);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersStartInstancesRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersStopInstancesResponse computeRegionInstanceGroupManagersStopInstances(org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersStopInstancesRequest request, org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersStopInstancesSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersStopInstancesRequest.class, baseUrl, "/projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/stopInstances", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "regionInstanceGroupManagersStopInstancesRequest", "json");
        req.setBody(serializedRequestBody);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersStopInstancesRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersSuspendInstancesResponse computeRegionInstanceGroupManagersSuspendInstances(org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersSuspendInstancesRequest request, org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersSuspendInstancesSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersSuspendInstancesRequest.class, baseUrl, "/projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/suspendInstances", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "regionInstanceGroupManagersSuspendInstancesRequest", "json");
        req.setBody(serializedRequestBody);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeRegionInstanceGroupManagersSuspendInstancesRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
