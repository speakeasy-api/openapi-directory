...
exports.GetPensionRevisionByNumberResponse = exports.GetPensionRevisionByNumberRequest = void 0;
...
var GetPensionRevisionByNumberRequest = /** @class */ (function (_super) {
    ...
    ], GetPensionRevisionByNumberRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetPensionRevisionByNumberRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetPensionRevisionByNumberRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PensionId",
        }),
        __metadata("design:type", String)
    ], GetPensionRevisionByNumberRequest.prototype, "pensionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RevisionNumber",
        }),
        __metadata("design:type", String)
    ], GetPensionRevisionByNumberRequest.prototype, "revisionNumber", void 0);
    return GetPensionRevisionByNumberRequest;
}(utils_1.SpeakeasyBase));
exports.GetPensionRevisionByNumberRequest = GetPensionRevisionByNumberRequest;
var GetPensionRevisionByNumberResponse = /** @class */ (function (_super) {
    ...
    ], GetPensionRevisionByNumberResponse.prototype, "rawResponse", void 0);
    return GetPensionRevisionByNumberResponse;
}(utils_1.SpeakeasyBase));
exports.GetPensionRevisionByNumberResponse = GetPensionRevisionByNumberResponse;
