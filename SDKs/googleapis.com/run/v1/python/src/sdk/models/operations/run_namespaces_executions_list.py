...
class RunNamespacesExecutionsListRequest:
    path_params: RunNamespacesExecutionsListPathParams = dataclasses.field()
    query_params: RunNamespacesExecutionsListQueryParams = dataclasses.field()
    security: RunNamespacesExecutionsListSecurity = dataclasses.field()
