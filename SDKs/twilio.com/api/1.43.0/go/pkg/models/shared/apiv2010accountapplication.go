...
func (e APIV2010AccountApplicationSmsFallbackMethodEnum) ToPointer() *APIV2010AccountApplicationSmsFallbackMethodEnum {
	return &e
}
...
func (e *APIV2010AccountApplicationSmsFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountApplicationSmsFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountApplicationSmsFallbackMethodEnum: %v", v)
	}
}
...
func (e APIV2010AccountApplicationSmsMethodEnum) ToPointer() *APIV2010AccountApplicationSmsMethodEnum {
	return &e
}
...
func (e *APIV2010AccountApplicationSmsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountApplicationSmsMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountApplicationSmsMethodEnum: %v", v)
	}
}
...
func (e APIV2010AccountApplicationStatusCallbackMethodEnum) ToPointer() *APIV2010AccountApplicationStatusCallbackMethodEnum {
	return &e
}
...
func (e *APIV2010AccountApplicationStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountApplicationStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountApplicationStatusCallbackMethodEnum: %v", v)
	}
}
...
func (e APIV2010AccountApplicationVoiceFallbackMethodEnum) ToPointer() *APIV2010AccountApplicationVoiceFallbackMethodEnum {
	return &e
}
...
func (e *APIV2010AccountApplicationVoiceFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountApplicationVoiceFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountApplicationVoiceFallbackMethodEnum: %v", v)
	}
}
...
func (e APIV2010AccountApplicationVoiceMethodEnum) ToPointer() *APIV2010AccountApplicationVoiceMethodEnum {
	return &e
}
...
func (e *APIV2010AccountApplicationVoiceMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountApplicationVoiceMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountApplicationVoiceMethodEnum: %v", v)
	}
}
