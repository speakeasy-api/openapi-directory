...
class AbortMultipartUploadPathParams:
...
@dataclasses.dataclass
class AbortMultipartUploadHeaders:
...
class AbortMultipartUploadRequest:
    headers: AbortMultipartUploadHeaders = dataclasses.field()
    path_params: AbortMultipartUploadPathParams = dataclasses.field()
