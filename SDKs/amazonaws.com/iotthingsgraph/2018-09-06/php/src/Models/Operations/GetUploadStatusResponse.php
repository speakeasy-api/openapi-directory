...
class GetUploadStatusResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetUploadStatusResponse $getUploadStatusResponse
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetUploadStatusResponse $getUploadStatusResponse = null;
	...
	{
		$this->contentType = "";
		$this->getUploadStatusResponse = null;
