...
class PostDescribeLocalGatewayVirtualInterfaceGroupsQueryParams:
    action: PostDescribeLocalGatewayVirtualInterfaceGroupsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeLocalGatewayVirtualInterfaceGroupsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeLocalGatewayVirtualInterfaceGroupsRequest:
    headers: PostDescribeLocalGatewayVirtualInterfaceGroupsHeaders = dataclasses.field()
    query_params: PostDescribeLocalGatewayVirtualInterfaceGroupsQueryParams = dataclasses.field()
