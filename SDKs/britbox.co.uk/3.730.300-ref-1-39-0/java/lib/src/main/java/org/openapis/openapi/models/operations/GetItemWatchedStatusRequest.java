...
public class GetItemWatchedStatusRequest {
    ...
    public GetItemWatchedStatusRequest withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GetItemWatchedStatusRequest withItemId(String itemId) {
        this.itemId = itemId;
        return this;
    }
    ...
    public GetItemWatchedStatusRequest withLang(String lang) {
        this.lang = lang;
        return this;
    }
    
    public GetItemWatchedStatusRequest(@JsonProperty("itemId") String itemId) {
        this.itemId = itemId;
  }
}
