...
class AnalyticsManagementAccountUserLinksListRequest:
    ...
    r"""Account ID to retrieve the user links for."""  
    ...
    r"""The maximum number of account-user links to include in this response."""  
    ...
    r"""An index of the first account-user link to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter."""  
