...
var AccountStatusDataQualityIssue = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "displayedValue" }),
        __metadata("design:type", String)
    ], AccountStatusDataQualityIssue.prototype, "displayedValue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: accountstatusexampleitem_1.AccountStatusExampleItem }),
        (0, class_transformer_1.Expose)({ name: "exampleItems" }),
        (0, class_transformer_1.Type)(function () { return accountstatusexampleitem_1.AccountStatusExampleItem; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "lastChecked" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "numItems" }),
