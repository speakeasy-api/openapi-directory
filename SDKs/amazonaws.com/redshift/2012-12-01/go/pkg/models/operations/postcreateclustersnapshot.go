...
func (e *POSTCreateClusterSnapshotActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "CreateClusterSnapshot":
		*e = POSTCreateClusterSnapshotActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTCreateClusterSnapshotActionEnum: %s", s)
	}
}
...
func (e *POSTCreateClusterSnapshotVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2012-12-01":
		*e = POSTCreateClusterSnapshotVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTCreateClusterSnapshotVersionEnum: %s", s)
	}
}
