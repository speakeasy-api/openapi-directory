...
class UpdateNetworkSwitchLinkAggregationRequestBody:
    ...
    switch_ports: Optional[list[UpdateNetworkSwitchLinkAggregationRequestBodySwitchPorts]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('switchPorts'), 'exclude': lambda f: f is None }})
    r"""Array of switch or stack ports for updating aggregation group. Minimum 2 and maximum 8 ports are supported."""  
    switch_profile_ports: Optional[list[UpdateNetworkSwitchLinkAggregationRequestBodySwitchProfilePorts]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('switchProfilePorts'), 'exclude': lambda f: f is None }})
    r"""Array of switch profile ports for updating aggregation group. Minimum 2 and maximum 8 ports are supported."""  
...
class UpdateNetworkSwitchLinkAggregationRequest:
    ...
    request_body: Optional[UpdateNetworkSwitchLinkAggregationRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
