...
export class ListAlphaSenderListAlphaSenderResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.MessagingV1ServiceAlphaSender })
  @Expose({ name: "alpha_senders" })
  @Type(() => shared.MessagingV1ServiceAlphaSender)
  alphaSenders?: shared.MessagingV1ServiceAlphaSender[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListAlphaSenderListAlphaSenderResponseMeta)
