...
import dataclasses
from ..shared import opponentseason as shared_opponentseason
...
class TeamSeason:
    ...
    opponent_stat: Optional[shared_opponentseason.OpponentSeason] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('OpponentStat'), 'exclude': lambda f: f is None }})  
