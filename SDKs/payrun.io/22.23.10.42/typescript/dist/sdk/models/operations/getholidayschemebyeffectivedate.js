...
exports.GetHolidaySchemeByEffectiveDateResponse = exports.GetHolidaySchemeByEffectiveDateRequest = void 0;
...
var GetHolidaySchemeByEffectiveDateRequest = /** @class */ (function (_super) {
    ...
    ], GetHolidaySchemeByEffectiveDateRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeByEffectiveDateRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EffectiveDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetHolidaySchemeByEffectiveDateRequest.prototype, "effectiveDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeByEffectiveDateRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=HolidaySchemeId",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeByEffectiveDateRequest.prototype, "holidaySchemeId", void 0);
...
var GetHolidaySchemeByEffectiveDateResponse = /** @class */ (function (_super) {
    ...
    ], GetHolidaySchemeByEffectiveDateResponse.prototype, "rawResponse", void 0);
