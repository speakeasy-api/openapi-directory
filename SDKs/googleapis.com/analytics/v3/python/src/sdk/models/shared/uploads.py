...
class Uploads:
    r"""Upload collection lists Analytics uploads to which the user has access. Each custom data source can have a set of uploads. Each resource in the upload collection corresponds to a single Analytics data upload."""
    
    items: Optional[list[shared_upload.Upload]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
    r"""A list of uploads."""  
    ...
    r"""Link to next page for this upload collection."""  
    ...
    r"""Link to previous page for this upload collection."""  
