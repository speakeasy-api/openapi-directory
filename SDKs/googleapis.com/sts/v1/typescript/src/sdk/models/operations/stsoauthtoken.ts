...
export class StsOauthtokenQueryParams extends SpeakeasyBase {
...
export class StsOauthtokenRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class StsOauthtokenResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
