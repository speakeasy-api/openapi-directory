...
var managedservice_1 = require("./managedservice");
...
var ListServicesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: managedservice_1.ManagedService }),
        (0, class_transformer_1.Expose)({ name: "services" }),
        (0, class_transformer_1.Type)(function () { return managedservice_1.ManagedService; }),
