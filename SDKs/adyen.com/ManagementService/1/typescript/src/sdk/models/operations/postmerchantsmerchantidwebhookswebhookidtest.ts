...
export class PostMerchantsMerchantIdWebhooksWebhookIdTestSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PostMerchantsMerchantIdWebhooksWebhookIdTestRequest extends SpeakeasyBase {
...
export class PostMerchantsMerchantIdWebhooksWebhookIdTestResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
