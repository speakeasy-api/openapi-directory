...
type GetSearchRvAutoCompleteQueryParams struct {
	...
	Field         shared.APIKeyEnum6         `queryParam:"style=form,explode=true,name=field"`
	...
	SortBy        *shared.InventoryTypeEnum1 `queryParam:"style=form,explode=true,name=sort_by"`
