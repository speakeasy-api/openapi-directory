...
class TagmanagerAccountsContainersCombineSettingSourceEnum(str, Enum):
    r"""Specify the source of config setting after combine"""
...
class TagmanagerAccountsContainersCombineRequest:
    ...
    r"""JSONP"""  
    container_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'containerId', 'style': 'form', 'explode': True }})
    r"""ID of container that will be merged into the current container."""  
    ...
    setting_source: Optional[TagmanagerAccountsContainersCombineSettingSourceEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'settingSource', 'style': 'form', 'explode': True }})
    r"""Specify the source of config setting after combine"""  
