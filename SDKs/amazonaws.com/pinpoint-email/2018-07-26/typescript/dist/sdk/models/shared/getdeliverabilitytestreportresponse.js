...
var GetDeliverabilityTestReportResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "DeliverabilityTestReport" }),
        (0, class_transformer_1.Type)(function () { return deliverabilitytestreport_1.DeliverabilityTestReport; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: ispplacement_1.IspPlacement }),
        (0, class_transformer_1.Expose)({ name: "IspPlacements" }),
        (0, class_transformer_1.Type)(function () { return ispplacement_1.IspPlacement; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "OverallPlacement" }),
        (0, class_transformer_1.Type)(function () { return placementstatistics_1.PlacementStatistics; }),
