...
func (e UpdateTaskReservationUpdateTaskReservationRequestConferenceRecordingStatusCallbackMethodEnum) ToPointer() *UpdateTaskReservationUpdateTaskReservationRequestConferenceRecordingStatusCallbackMethodEnum {
	return &e
}

func (e *UpdateTaskReservationUpdateTaskReservationRequestConferenceRecordingStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateTaskReservationUpdateTaskReservationRequestConferenceRecordingStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateTaskReservationUpdateTaskReservationRequestConferenceRecordingStatusCallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateTaskReservationUpdateTaskReservationRequestConferenceStatusCallbackMethodEnum) ToPointer() *UpdateTaskReservationUpdateTaskReservationRequestConferenceStatusCallbackMethodEnum {
	return &e
}

func (e *UpdateTaskReservationUpdateTaskReservationRequestConferenceStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateTaskReservationUpdateTaskReservationRequestConferenceStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateTaskReservationUpdateTaskReservationRequestConferenceStatusCallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateTaskReservationUpdateTaskReservationRequestRecordingStatusCallbackMethodEnum) ToPointer() *UpdateTaskReservationUpdateTaskReservationRequestRecordingStatusCallbackMethodEnum {
	return &e
}

func (e *UpdateTaskReservationUpdateTaskReservationRequestRecordingStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateTaskReservationUpdateTaskReservationRequestRecordingStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateTaskReservationUpdateTaskReservationRequestRecordingStatusCallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateTaskReservationUpdateTaskReservationRequestStatusCallbackMethodEnum) ToPointer() *UpdateTaskReservationUpdateTaskReservationRequestStatusCallbackMethodEnum {
	return &e
}

func (e *UpdateTaskReservationUpdateTaskReservationRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateTaskReservationUpdateTaskReservationRequestStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateTaskReservationUpdateTaskReservationRequestStatusCallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateTaskReservationUpdateTaskReservationRequestWaitMethodEnum) ToPointer() *UpdateTaskReservationUpdateTaskReservationRequestWaitMethodEnum {
	return &e
}

func (e *UpdateTaskReservationUpdateTaskReservationRequestWaitMethodEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateTaskReservationUpdateTaskReservationRequestWaitMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateTaskReservationUpdateTaskReservationRequestWaitMethodEnum: %v", v)
	}
}
