...
class TrusthubV1CustomerProfileCustomerProfileEvaluation:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the customer_profile resource."""  
    ...
    status: Optional[shared_customer_profile_evaluation_enum_status_enum.CustomerProfileEvaluationEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
