...
class AudioContentTypeAssignedTargetingOptionDetails:
    ...
    audio_content_type: Optional[AudioContentTypeAssignedTargetingOptionDetailsAudioContentTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('audioContentType') }})
