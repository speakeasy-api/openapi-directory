...
func (s *Users) UsersAdd(ctx context.Context, request operations.UsersAddRequest) (*operations.UsersAddResponse, error) {
	...
	res := &operations.UsersAddResponse{
...
// UsersAll - List users
// List users
func (s *Users) UsersAll(ctx context.Context, request operations.UsersAllRequest) (*operations.UsersAllResponseOutput, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/crm/users"
	...
	res := &operations.UsersAllResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetUsersResponseOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Users) UsersDelete(ctx context.Context, request operations.UsersDeleteRequest) (*operations.UsersDeleteResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/crm/users/{id}", request.PathParams)
...
// UsersOne - Get user
// Get user
func (s *Users) UsersOne(ctx context.Context, request operations.UsersOneRequest) (*operations.UsersOneResponseOutput, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/crm/users/{id}", request.PathParams)
	...
	res := &operations.UsersOneResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetUserResponseOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
