 ...
 */
export class DescribeClientVpnConnectionsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeClientVpnConnectionsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: DescribeClientVpnConnectionsRequestFilters })
  filters?: DescribeClientVpnConnectionsRequestFilters[];
