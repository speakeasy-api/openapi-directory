 ...
 */
export class DescribeLocalGatewayRouteTablesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeLocalGatewayRouteTablesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
  ...
  filters?: DescribeLocalGatewayRouteTablesRequestFilters[];
