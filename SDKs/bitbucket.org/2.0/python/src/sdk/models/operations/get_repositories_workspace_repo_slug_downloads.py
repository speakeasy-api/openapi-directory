...
class GetRepositoriesWorkspaceRepoSlugDownloadsRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugDownloadsPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugDownloadsSecurity = dataclasses.field()
