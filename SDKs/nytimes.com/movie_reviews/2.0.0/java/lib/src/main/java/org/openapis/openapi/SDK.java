...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.GetCriticsResourceTypeJsonResponse getCriticsResourceTypeJson(org.openapis.openapi.models.operations.GetCriticsResourceTypeJsonRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.GetCriticsResourceTypeJsonResponse res = new org.openapis.openapi.models.operations.GetCriticsResourceTypeJsonResponse(contentType, httpRes.statusCode()) {{
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.operations.GetCriticsResourceTypeJSON200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetCriticsResourceTypeJSON200ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.GetReviewsSearchJsonResponse getReviewsSearchJson(org.openapis.openapi.models.operations.GetReviewsSearchJsonRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/reviews/search.json");
        ...
        org.openapis.openapi.models.operations.GetReviewsSearchJsonResponse res = new org.openapis.openapi.models.operations.GetReviewsSearchJsonResponse(contentType, httpRes.statusCode()) {{
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetReviewsSearchJSON200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetReviewsSearchJSON200ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.GetReviewsResourceTypeJsonResponse getReviewsResourceTypeJson(org.openapis.openapi.models.operations.GetReviewsResourceTypeJsonRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.GetReviewsResourceTypeJsonResponse res = new org.openapis.openapi.models.operations.GetReviewsResourceTypeJsonResponse(contentType, httpRes.statusCode()) {{
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetReviewsResourceTypeJSON200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetReviewsResourceTypeJSON200ApplicationJSON.class);
