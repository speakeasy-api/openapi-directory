 ...
 */
export declare class DescribeVerifiedAccessInstanceLoggingConfigurationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeVerifiedAccessInstanceLoggingConfigurationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeVerifiedAccessInstanceLoggingConfigurationsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
