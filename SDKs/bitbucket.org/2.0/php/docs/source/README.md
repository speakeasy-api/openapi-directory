...
try {
    ...
    $request->commit = 'ullam';
    $request->path = 'in';
    $request->q = 'nam';
    $request->renames = 'earum';
    ...
    $response = $sdk->source->getRepositoriesWorkspaceRepoSlugFilehistoryCommitPath($request, $requestSecurity);
...
try {
    ...
    $response = $sdk->source->getRepositoriesWorkspaceRepoSlugSrc($request, $requestSecurity);
...
try {
    ...
    $response = $sdk->source->getRepositoriesWorkspaceRepoSlugSrcCommitPath($request, $requestSecurity);
...
try {
    ...
    $request->author = 'inventore';
    $request->branch = 'fugit';
    $request->files = 'cumque';
    $request->message = 'quae';
    $request->parents = 'perferendis';
    $request->repoSlug = 'velit';
    $request->workspace = 'aspernatur';

    $requestSecurity = new PostRepositoriesWorkspaceRepoSlugSrcSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';

    $response = $sdk->source->postRepositoriesWorkspaceRepoSlugSrc($request, $requestSecurity);
