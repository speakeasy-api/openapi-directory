...
from ..shared import getimportjobsresponse as shared_getimportjobsresponse


@dataclasses.dataclass
class GetImportJobsPathParams:
    application_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'application-id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetImportJobsQueryParams:
...
class GetImportJobsRequest:
    headers: GetImportJobsHeaders = dataclasses.field()
    path_params: GetImportJobsPathParams = dataclasses.field()
    query_params: GetImportJobsQueryParams = dataclasses.field()
...
class GetImportJobsResponse:
    ...
    get_import_jobs_response: Optional[shared_getimportjobsresponse.GetImportJobsResponse] = dataclasses.field(default=None)
