...
class GETCreditMemoTypeStatusEnum(str, Enum):
...
class GETCreditMemoTypeTaxStatusEnum(str, Enum):
...
class GETCreditMemoTypeTransferredToAccountingEnum(str, Enum):
...
class GETCreditMemoType:
    ...
    """  
    status: Optional[GETCreditMemoTypeStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The status of the credit memo."""  
    ...
    tax_status: Optional[GETCreditMemoTypeTaxStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxStatus'), 'exclude': lambda f: f is None }})
    r"""The status of tax calculation related to the credit memo.
    ...
    **Note**: This field is only applicable to tax calculation by third-party tax engines.
    ...
    transferred_to_accounting: Optional[GETCreditMemoTypeTransferredToAccountingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transferredToAccounting'), 'exclude': lambda f: f is None }})
    r"""Whether the credit memo was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite."""  
    ...
    r"""The date and time when the credit memo was last updated, in `yyyy-mm-dd hh:mm:ss` format. For example, 2017-03-01 15:36:10."""  
