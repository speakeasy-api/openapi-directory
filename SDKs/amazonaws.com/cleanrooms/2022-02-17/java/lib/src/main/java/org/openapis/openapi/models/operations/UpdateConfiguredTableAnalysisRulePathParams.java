...
public class UpdateConfiguredTableAnalysisRulePathParams {
    /**
    ...
    public UpdateConfiguredTableAnalysisRulePathParams withAnalysisRuleType(UpdateConfiguredTableAnalysisRuleAnalysisRuleTypeEnum analysisRuleType) {
    ...
    public UpdateConfiguredTableAnalysisRulePathParams withConfiguredTableIdentifier(String configuredTableIdentifier) {
