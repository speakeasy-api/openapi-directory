...
public class PostCreditMemoEmailRequestType {
    ...
    public PostCreditMemoEmailRequestTypeIncludeAdditionalEmailAddressesEnum includeAdditionalEmailAddresses;
    public PostCreditMemoEmailRequestType withIncludeAdditionalEmailAddresses(PostCreditMemoEmailRequestTypeIncludeAdditionalEmailAddressesEnum includeAdditionalEmailAddresses) {
    ...
    public PostCreditMemoEmailRequestTypeUseEmailTemplateSettingEnum useEmailTemplateSetting;
    public PostCreditMemoEmailRequestType withUseEmailTemplateSetting(PostCreditMemoEmailRequestTypeUseEmailTemplateSettingEnum useEmailTemplateSetting) {
