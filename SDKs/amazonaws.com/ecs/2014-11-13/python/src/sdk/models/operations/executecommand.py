...
class ExecuteCommandRequest:
    ...
    execute_command_request: shared_executecommandrequest.ExecuteCommandRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
