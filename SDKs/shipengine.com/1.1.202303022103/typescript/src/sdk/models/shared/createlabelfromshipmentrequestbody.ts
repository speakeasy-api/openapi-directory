 ...
 */
export enum CreateLabelFromShipmentRequestBodyDisplaySchemeEnum {
  Label = "label",
  QrCode = "qr_code",
 ...
 *
 */
export enum CreateLabelFromShipmentRequestBodyLabelFormatEnum {
  Pdf = "pdf",
  Png = "png",
  Zpl = "zpl",
}
 ...
 *
 */
export enum CreateLabelFromShipmentRequestBodyLabelLayoutEnum {
  Fourx6 = "4x6",
  Letter = "letter",
}
