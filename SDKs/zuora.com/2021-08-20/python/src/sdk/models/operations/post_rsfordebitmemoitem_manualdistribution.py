...
from ..shared import postrevenueschedulebytransactiontype as shared_postrevenueschedulebytransactiontype
...
class POSTRSforDebitMemoItemManualDistributionRequest:
    ...
    r"""The unique ID of a debit memo item. You can get the debit memo item ID from the response of [Get debit memo items](https://www.zuora.com/developer/api-reference/#operation/GET_DebitMemoItems)."""  
    post_revenue_schedule_by_transaction_type: shared_postrevenueschedulebytransactiontype.POSTRevenueScheduleByTransactionType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
