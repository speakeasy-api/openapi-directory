...
class EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\EnterpriseCrmFrontendsEventbusProtoEventParameters $diffParams
     */
    ...
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?EnterpriseCrmFrontendsEventbusProtoEventParameters $diffParams = null;
     ...
     * LINT.IfChange This message is used for processing and persisting (when applicable) key value pair parameters for each event in the event bus. Please see
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\EnterpriseCrmFrontendsEventbusProtoEventParameters $eventParams
     */
	#[\JMS\Serializer\Annotation\SerializedName('eventParams')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\EnterpriseCrmFrontendsEventbusProtoEventParameters')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?EnterpriseCrmFrontendsEventbusProtoEventParameters $eventParams = null;
