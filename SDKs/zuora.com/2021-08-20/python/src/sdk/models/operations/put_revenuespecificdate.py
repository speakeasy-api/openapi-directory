...
from ..shared import putspecificdateallocationtype as shared_putspecificdateallocationtype
...
class PUTRevenueSpecificDateRequest:
    ...
    put_specific_date_allocation_type: shared_putspecificdateallocationtype.PUTSpecificDateAllocationType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
