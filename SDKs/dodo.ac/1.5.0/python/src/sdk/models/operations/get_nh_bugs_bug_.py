...
class GetNhBugsBugRequest:
    ...
    bug: str = dataclasses.field(metadata={'path_param': { 'field_name': 'bug', 'style': 'simple', 'explode': False }})
    r"""The name of the bug you wish to retrieve information about."""  
...
class GetNhBugsBugResponse:
    ...
    r"""Could not find the specified bug."""  
    ...
    nh_bug: Optional[shared_nhbug.NHBug] = dataclasses.field(default=None)
