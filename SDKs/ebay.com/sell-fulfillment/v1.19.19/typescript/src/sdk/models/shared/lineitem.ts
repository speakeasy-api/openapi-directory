...
export class LineItem extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: AppliedPromotion })
  @Expose({ name: "appliedPromotions" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "discountedLineItemCost" })
  @Type(() => Amount)
   ...
   */
  @SpeakeasyMetadata({ elemType: EbayCollectAndRemitTax })
  @Expose({ name: "ebayCollectAndRemitTaxes" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "ebayCollectedCharges" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "lineItemFulfillmentInstructions" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "lineItemFulfillmentStatus" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "listingMarketplaceId" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "purchaseMarketplaceId" })
   ...
   */
  @SpeakeasyMetadata({ elemType: LineItemRefund })
  @Expose({ name: "refunds" })
  @Type(() => LineItemRefund)
