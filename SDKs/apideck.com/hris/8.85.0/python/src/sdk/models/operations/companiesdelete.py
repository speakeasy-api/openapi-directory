...
from ..shared import deletehriscompanyresponse as shared_deletehriscompanyresponse
...
class CompaniesDeleteRequest:
    headers: CompaniesDeleteHeaders = dataclasses.field()
    path_params: CompaniesDeletePathParams = dataclasses.field()
    query_params: CompaniesDeleteQueryParams = dataclasses.field()
    security: CompaniesDeleteSecurity = dataclasses.field()
...
class CompaniesDeleteResponse:
    ...
    delete_hris_company_response: Optional[shared_deletehriscompanyresponse.DeleteHrisCompanyResponse] = dataclasses.field(default=None)
