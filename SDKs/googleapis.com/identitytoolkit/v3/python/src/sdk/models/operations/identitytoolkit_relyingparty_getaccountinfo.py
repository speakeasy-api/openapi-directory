...
class IdentitytoolkitRelyingpartyGetAccountInfoRequest:
    ...
    identitytoolkit_relyingparty_get_account_info_request: Optional[shared_identitytoolkitrelyingpartygetaccountinforequest.IdentitytoolkitRelyingpartyGetAccountInfoRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
