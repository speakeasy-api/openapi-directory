...
class ListResourceDelegatesRequest:
    ...
    list_resource_delegates_request: shared_listresourcedelegatesrequest.ListResourceDelegatesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
