...
class PutTraceSegmentsRequestBody:
    ...
    trace_segment_documents: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TraceSegmentDocuments') }})
    r"""A string containing a JSON document defining one or more segments or subsegments."""  
    

@dataclasses.dataclass
class PutTraceSegmentsRequest:
    
    request_body: PutTraceSegmentsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
