...
export class PreprintProviders {
  ...
  preprintProviderDetail(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.PreprintProviderDetailResponse =
        new operations.PreprintProviderDetailResponse({
  ...
  preprintProviderLicensesList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PreprintProviderLicensesListResponse =
        new operations.PreprintProviderLicensesListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  preprintProviderList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PreprintProviderListResponse =
        new operations.PreprintProviderListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  preprintProviderTaxonomiesList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PreprintProviderTaxonomiesListResponse =
        new operations.PreprintProviderTaxonomiesListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  preprintProvidersPreprintsList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PreprintProvidersPreprintsListResponse =
        new operations.PreprintProvidersPreprintsListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
