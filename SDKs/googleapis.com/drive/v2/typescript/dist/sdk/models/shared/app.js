...
exports.App = exports.AppIcons = void 0;
...
var App = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=createInFolderTemplate" }),
        __metadata("design:type", String)
    ], App.prototype, "createInFolderTemplate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=createUrl" }),
        __metadata("design:type", String)
    ], App.prototype, "createUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=hasDriveWideScope" }),
        __metadata("design:type", Boolean)
    ], App.prototype, "hasDriveWideScope", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=icons", elemType: AppIcons }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=installed" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=openUrlTemplate" }),
        __metadata("design:type", String)
    ], App.prototype, "openUrlTemplate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=primaryFileExtensions" }),
        __metadata("design:type", Array)
    ], App.prototype, "primaryFileExtensions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=primaryMimeTypes" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=secondaryFileExtensions" }),
        __metadata("design:type", Array)
    ], App.prototype, "secondaryFileExtensions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=secondaryMimeTypes" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=supportsCreate" }),
        __metadata("design:type", Boolean)
    ], App.prototype, "supportsCreate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=supportsImport" }),
        __metadata("design:type", Boolean)
    ], App.prototype, "supportsImport", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=supportsMultiOpen" }),
        __metadata("design:type", Boolean)
    ], App.prototype, "supportsMultiOpen", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=supportsOfflineCreate" }),
        __metadata("design:type", Boolean)
    ], App.prototype, "supportsOfflineCreate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=useByDefault" }),
        __metadata("design:type", Boolean)
