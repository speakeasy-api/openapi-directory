...
export class EnterpriseAdminRemoveAllCustomLabelsFromSelfHostedRunnerForEnterpriseRequest extends SpeakeasyBase {
  /**
 ...
 * Response
 */
export class EnterpriseAdminRemoveAllCustomLabelsFromSelfHostedRunnerForEnterprise200ApplicationJSON extends SpeakeasyBase {
...
export class EnterpriseAdminRemoveAllCustomLabelsFromSelfHostedRunnerForEnterpriseResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
