...
public class AddressValidationResult {
    ...
    public AddressValidationResult(@JsonProperty("matched_address") AddressValidationResultPartialAddress matchedAddress, @JsonProperty("messages") ResponseMessage[] messages, @JsonProperty("original_address") Address originalAddress, @JsonProperty("status") AddressValidationStatusEnum status) {
        this.matchedAddress = matchedAddress;
        this.messages = messages;
        this.originalAddress = originalAddress;
        this.status = status;
