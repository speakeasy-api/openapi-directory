...
from ..shared import updatedrivegroupresponse as shared_updatedrivegroupresponse
from typing import Optional


@dataclasses.dataclass
class DriveGroupsUpdateSecurity:
...
class DriveGroupsUpdateRequest:
    ...
    drive_group_input: shared_drivegroup.DriveGroupInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class DriveGroupsUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_drive_group_response: Optional[shared_updatedrivegroupresponse.UpdateDriveGroupResponse] = dataclasses.field(default=None)
    r"""DriveGroups"""  
