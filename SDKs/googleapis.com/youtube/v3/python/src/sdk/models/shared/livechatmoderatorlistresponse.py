...
from ..shared import livechatmoderator as shared_livechatmoderator
...
class LiveChatModeratorListResponse:
    ...
    items: Optional[list[shared_livechatmoderator.LiveChatModerator]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
