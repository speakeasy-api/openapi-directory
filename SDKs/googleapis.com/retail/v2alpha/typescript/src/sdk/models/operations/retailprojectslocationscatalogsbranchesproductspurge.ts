...
export class RetailProjectsLocationsCatalogsBranchesProductsPurgeSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsBranchesProductsPurgeRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsBranchesProductsPurgeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
