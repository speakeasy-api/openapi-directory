...
func (e InstallationGhes2RepositorySelectionEnum) ToPointer() *InstallationGhes2RepositorySelectionEnum {
	return &e
}
...
func (e *InstallationGhes2RepositorySelectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "all":
		fallthrough
	case "selected":
		*e = InstallationGhes2RepositorySelectionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for InstallationGhes2RepositorySelectionEnum: %v", v)
	}
}
