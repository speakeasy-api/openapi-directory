...
class GamesApplicationsGetQueryParams:
    ...
    platform_type: Optional[GamesApplicationsGetPlatformTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'platformType', 'style': 'form', 'explode': True }})
...
class GamesApplicationsGetRequest:
    path_params: GamesApplicationsGetPathParams = dataclasses.field()
    query_params: GamesApplicationsGetQueryParams = dataclasses.field()
    security: GamesApplicationsGetSecurity = dataclasses.field()
