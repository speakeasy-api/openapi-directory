...
export class TravelpartnerAccountsReconciliationReportsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=includeMatchedPrices",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=includeNonScoring",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=includePixels",
  })
...
export class TravelpartnerAccountsReconciliationReportsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
