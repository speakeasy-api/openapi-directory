...
type FirebaseappcheckProjectsAppsExchangeDeviceCheckTokenRequest struct {
	...
	GoogleFirebaseAppcheckV1ExchangeDeviceCheckTokenRequest *shared.GoogleFirebaseAppcheckV1ExchangeDeviceCheckTokenRequest `request:"mediaType=application/json"`
	// OAuth access token.
