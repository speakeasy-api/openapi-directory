 ...
 */
export enum RepositoryMergeCommitMessageEnum {
  PrBody = "PR_BODY",
  PrTitle = "PR_TITLE",
  Blank = "BLANK",
}
 ...
 */
export enum RepositoryMergeCommitTitleEnum {
  PrTitle = "PR_TITLE",
 ...
 * - `BLANK` - default to a blank commit message.
 */
export enum RepositorySquashMergeCommitMessageEnum {
  PrBody = "PR_BODY",
 ...
 */
export enum RepositorySquashMergeCommitTitleEnum {
  PrTitle = "PR_TITLE",
 ...
 * - `BLANK` - default to a blank commit message.
 */
export enum RepositoryTemplateRepositoryMergeCommitMessageEnum {
  PrBody = "PR_BODY",
  PrTitle = "PR_TITLE",
  Blank = "BLANK",
}
 ...
 * - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
 */
export enum RepositoryTemplateRepositoryMergeCommitTitleEnum {
  PrTitle = "PR_TITLE",
  MergeMessage = "MERGE_MESSAGE",
}
 ...
 * - `BLANK` - default to a blank commit message.
 */
export enum RepositoryTemplateRepositorySquashMergeCommitMessageEnum {
  PrBody = "PR_BODY",
  CommitMessages = "COMMIT_MESSAGES",
  Blank = "BLANK",
}
 ...
 * - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
 */
export enum RepositoryTemplateRepositorySquashMergeCommitTitleEnum {
  PrTitle = "PR_TITLE",
  CommitOrPrTitle = "COMMIT_OR_PR_TITLE",
}
...
export class RepositoryTemplateRepository extends SpeakeasyBase {
  ...
  mergeCommitMessage?: RepositoryTemplateRepositoryMergeCommitMessageEnum;
  ...
  mergeCommitTitle?: RepositoryTemplateRepositoryMergeCommitTitleEnum;
  ...
  squashMergeCommitMessage?: RepositoryTemplateRepositorySquashMergeCommitMessageEnum;
  ...
  squashMergeCommitTitle?: RepositoryTemplateRepositorySquashMergeCommitTitleEnum;
...
export class Repository extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "merge_commit_message" })
  mergeCommitMessage?: RepositoryMergeCommitMessageEnum;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "merge_commit_title" })
  mergeCommitTitle?: RepositoryMergeCommitTitleEnum;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "squash_merge_commit_message" })
  squashMergeCommitMessage?: RepositorySquashMergeCommitMessageEnum;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "squash_merge_commit_title" })
  squashMergeCommitTitle?: RepositorySquashMergeCommitTitleEnum;
