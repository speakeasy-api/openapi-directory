...
class GetDiseaseModelTaxonAssociationsRequest:
    path_params: GetDiseaseModelTaxonAssociationsPathParams = dataclasses.field()
    query_params: GetDiseaseModelTaxonAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetDiseaseModelTaxonAssociationsResponse:
