...
func newMachineLearning(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *machineLearning {
...
func (s *machineLearning) GetDeliveryPrediction(ctx context.Context, request shared.DeliveryPredictionPayload) (*operations.GetDeliveryPredictionResponse, error) {
	...
	res := &operations.GetDeliveryPredictionResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DeliveryPredictionResponse
