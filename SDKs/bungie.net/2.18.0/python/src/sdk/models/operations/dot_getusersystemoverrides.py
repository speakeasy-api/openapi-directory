...
class DotGetUserSystemOverrides200Wildcard:
    ...
    response: Optional[dict[str, shared_common_models_coresystem.CommonModelsCoreSystem]] = dataclasses.field(default=None)  
    throttle_seconds: Optional[int] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class DotGetUserSystemOverridesResponse:
