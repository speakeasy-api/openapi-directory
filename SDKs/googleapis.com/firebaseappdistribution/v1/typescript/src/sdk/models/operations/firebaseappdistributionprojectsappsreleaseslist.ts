...
export class FirebaseappdistributionProjectsAppsReleasesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseappdistributionProjectsAppsReleasesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseappdistributionProjectsAppsReleasesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
