...
class ListOutgoingCallerIDRequest:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the OutgoingCallerId resources to read."""  
    ...
    r"""The string that identifies the OutgoingCallerId resources to read."""  
    ...
    r"""The phone number of the OutgoingCallerId resources to read."""  
...
class ListOutgoingCallerIDListOutgoingCallerIDResponse:
    ...
    outgoing_caller_ids: Optional[list[shared_api_v2010_account_outgoing_caller_id.APIV2010AccountOutgoingCallerID]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('outgoing_caller_ids'), 'exclude': lambda f: f is None }})  
