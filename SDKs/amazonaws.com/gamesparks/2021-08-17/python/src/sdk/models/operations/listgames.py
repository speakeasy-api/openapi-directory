...
from ..shared import listgamesresult as shared_listgamesresult
...
class ListGamesResponse:
    ...
    list_games_result: Optional[shared_listgamesresult.ListGamesResult] = dataclasses.field(default=None)
    r"""Success"""  
