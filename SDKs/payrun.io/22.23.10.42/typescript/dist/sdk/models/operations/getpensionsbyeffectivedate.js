...
exports.GetPensionsByEffectiveDateResponse = exports.GetPensionsByEffectiveDateRequest = void 0;
...
var GetPensionsByEffectiveDateRequest = /** @class */ (function (_super) {
    ...
    ], GetPensionsByEffectiveDateRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetPensionsByEffectiveDateRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EffectiveDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetPensionsByEffectiveDateRequest.prototype, "effectiveDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetPensionsByEffectiveDateRequest.prototype, "employerId", void 0);
    return GetPensionsByEffectiveDateRequest;
}(utils_1.SpeakeasyBase));
exports.GetPensionsByEffectiveDateRequest = GetPensionsByEffectiveDateRequest;
var GetPensionsByEffectiveDateResponse = /** @class */ (function (_super) {
    ...
    ], GetPensionsByEffectiveDateResponse.prototype, "rawResponse", void 0);
    return GetPensionsByEffectiveDateResponse;
}(utils_1.SpeakeasyBase));
exports.GetPensionsByEffectiveDateResponse = GetPensionsByEffectiveDateResponse;
