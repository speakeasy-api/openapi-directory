...
class GetGenePublicationAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGenePublicationAssociationsQueryParams:
...
@dataclasses.dataclass
class GetGenePublicationAssociationsRequest:
    path_params: GetGenePublicationAssociationsPathParams = dataclasses.field()
    query_params: GetGenePublicationAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetGenePublicationAssociationsResponse:
