...
public class AdvancedMachineFeatures {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("numaNodeCount")
    public Integer numaNodeCount;
    public AdvancedMachineFeatures withNumaNodeCount(Integer numaNodeCount) {
    ...
    public AdvancedMachineFeaturesPerformanceMonitoringUnitEnum performanceMonitoringUnit;
    public AdvancedMachineFeatures withPerformanceMonitoringUnit(AdvancedMachineFeaturesPerformanceMonitoringUnitEnum performanceMonitoringUnit) {
