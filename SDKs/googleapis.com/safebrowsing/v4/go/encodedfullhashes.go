...
func NewEncodedFullHashes(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *EncodedFullHashes {
	return &EncodedFullHashes{
