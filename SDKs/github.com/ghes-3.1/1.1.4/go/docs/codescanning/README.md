...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningDeleteAnalysis(ctx, operations.CodeScanningDeleteAnalysisRequest{
        AnalysisID: 848944,
        ConfirmDelete: sdk.String("sequi"),
        Owner: "natus",
        Repo: "impedit",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListAlertInstances(ctx, operations.CodeScanningListAlertInstancesRequest{
        ...
        Owner: "ducimus",
        Page: sdk.Int64(4048),
        PerPage: sdk.Int64(639473),
        Ref: sdk.String("tempora"),
        Repo: "ipsam",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListAlertsForRepo(ctx, operations.CodeScanningListAlertsForRepoRequest{
        Owner: "ea",
        Page: sdk.Int64(136900),
        PerPage: sdk.Int64(428224),
        Ref: sdk.String("possimus"),
        Repo: "magnam",
        State: shared.CodeScanningAlertStateEnumOpen.ToPointer(),
        ToolGUID: sdk.String("ex"),
        ToolName: sdk.String("laudantium"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListRecentAnalyses(ctx, operations.CodeScanningListRecentAnalysesRequest{
        Owner: "dicta",
        Page: sdk.Int64(224317),
        PerPage: sdk.Int64(980700),
        Ref: sdk.String("quasi"),
        Repo: "ex",
        SarifID: sdk.String("6c81cd8e-b078-4ac3-a3be-1dad7dbd0b53"),
        ToolGUID: sdk.String("nulla"),
        ToolName: sdk.String("excepturi"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningUploadSarif(ctx, operations.CodeScanningUploadSarifRequest{
        RequestBody: operations.CodeScanningUploadSarifRequestBody{
            ...
            Ref: "impedit",
            Sarif: "corporis",
            StartedAt: types.MustTimeFromString("2022-08-08T04:23:21.555Z"),
            ToolName: sdk.String("inventore"),
        },
        Owner: "magnam",
        Repo: "ea",
    })
