...
import dataclasses
from ..shared import signaldevice as shared_signaldevice
from ..shared import signaluser as shared_signaluser
...
class SignalEvaluateRequest:
    ...
    r"""A unique ID that identifies the end user in your system. This ID is used to correlate requests by a user with multiple Items. The max length for this field is 36 characters. Personally identifiable information, such as an email address or phone number, should not be used in the `client_user_id`."""  
