...
from ..shared import optiongroupmembership as shared_optiongroupmembership
...
class DbInstanceList:
    ...
    option_group_membership: Optional[shared_optiongroupmembership.OptionGroupMembership] = dataclasses.field(default=None)
