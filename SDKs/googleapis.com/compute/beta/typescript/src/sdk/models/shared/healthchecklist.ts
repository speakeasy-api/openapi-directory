 ...
 */
export enum HealthCheckListWarningCodeEnum {
...
export class HealthCheckListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class HealthCheckListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: HealthCheckListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class HealthCheckList extends SpeakeasyBase {
  /**
