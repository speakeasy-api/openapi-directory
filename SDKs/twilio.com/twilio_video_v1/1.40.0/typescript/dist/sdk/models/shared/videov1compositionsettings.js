...
var VideoV1CompositionSettings = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "aws_credentials_sid" }),
        __metadata("design:type", String)
    ], VideoV1CompositionSettings.prototype, "awsCredentialsSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "aws_s3_url" }),
        __metadata("design:type", String)
    ], VideoV1CompositionSettings.prototype, "awsS3Url", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "aws_storage_enabled" }),
        __metadata("design:type", Boolean)
    ], VideoV1CompositionSettings.prototype, "awsStorageEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "encryption_enabled" }),
        __metadata("design:type", Boolean)
    ], VideoV1CompositionSettings.prototype, "encryptionEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "encryption_key_sid" }),
        __metadata("design:type", String)
