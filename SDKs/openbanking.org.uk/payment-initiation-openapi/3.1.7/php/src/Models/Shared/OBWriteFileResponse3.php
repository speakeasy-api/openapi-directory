...
class OBWriteFileResponse3
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteFileResponse3Data')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\OBWriteFileResponse3Data();
		$this->links = null;
		$this->meta = null;
	}
}
