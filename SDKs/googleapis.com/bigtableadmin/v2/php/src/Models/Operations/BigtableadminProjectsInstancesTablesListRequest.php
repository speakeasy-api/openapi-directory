...
class BigtableadminProjectsInstancesTablesListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\BigtableadminProjectsInstancesTablesListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?BigtableadminProjectsInstancesTablesListViewEnum $view = null;
