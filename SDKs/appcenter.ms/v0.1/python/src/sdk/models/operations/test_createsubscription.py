...
class TestCreateSubscriptionSecurity:
...
class TestCreateSubscriptionSubscription:
    ...
    tier: Optional[TestCreateSubscriptionSubscriptionSubscriptionTier] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tier'), 'exclude': lambda f: f is None }})  
...
class TestCreateSubscriptionResponse:
    ...
    subscription: Optional[TestCreateSubscriptionSubscription] = dataclasses.field(default=None)
    r"""OK"""  
