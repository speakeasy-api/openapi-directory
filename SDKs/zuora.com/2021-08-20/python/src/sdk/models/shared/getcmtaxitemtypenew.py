...
class GETCMTaxItemTypeNewFinanceInformation:
...
class GETCMTaxItemTypeNewTaxRateTypeEnum(str, Enum):
...
class GETCMTaxItemTypeNew:
    ...
    finance_information: Optional[GETCMTaxItemTypeNewFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the taxation item."""  
    ...
    tax_rate_type: Optional[GETCMTaxItemTypeNewTaxRateTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxRateType'), 'exclude': lambda f: f is None }})
    r"""The type of the tax rate."""  
