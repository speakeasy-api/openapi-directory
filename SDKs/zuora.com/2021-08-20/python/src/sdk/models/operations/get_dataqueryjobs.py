...
class GETDataQueryJobsQueryStatusEnum(str, Enum):
    r"""Filters the list of query jobs by status."""
    ACCEPTED = 'accepted'
...
class GETDataQueryJobsRequest:
    ...
    r"""Specifies the maximum number of query jobs to return."""  
    query_status: Optional[GETDataQueryJobsQueryStatusEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'queryStatus', 'style': 'form', 'explode': True }})
    r"""Filters the list of query jobs by status."""  
