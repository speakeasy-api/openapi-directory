...
class DeregisterContainerInstanceRequest:
    ...
    deregister_container_instance_request: shared_deregistercontainerinstancerequest.DeregisterContainerInstanceRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
