...
type CloudsupportProjectsUpdateCasesSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudsupportProjectsUpdateCasesPathParams struct {
	// The resource name for the case.
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type CloudsupportProjectsUpdateCasesQueryParams struct {
	// V1 error format.
...
type CloudsupportProjectsUpdateCasesRequest struct {
	PathParams  CloudsupportProjectsUpdateCasesPathParams
	QueryParams CloudsupportProjectsUpdateCasesQueryParams
	Request     *shared.CaseInput `request:"mediaType=application/json"`
	Security    CloudsupportProjectsUpdateCasesSecurity
}

type CloudsupportProjectsUpdateCasesResponse struct {
	// Successful response
	Case        *shared.Case
	ContentType string
	StatusCode  int
