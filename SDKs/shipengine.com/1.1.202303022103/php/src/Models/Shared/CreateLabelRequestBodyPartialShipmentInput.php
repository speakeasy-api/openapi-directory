...
class CreateLabelRequestBodyPartialShipmentInput
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CreateLabelRequestBodyPartialShipmentDeliveryConfirmationEnum $confirmation
     */
	#[\JMS\Serializer\Annotation\SerializedName('confirmation')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateLabelRequestBodyPartialShipmentDeliveryConfirmationEnum>')]
    public CreateLabelRequestBodyPartialShipmentDeliveryConfirmationEnum $confirmation;
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CreateLabelRequestBodyPartialShipmentInternationalShipmentOptionsInput $customs
     */
	#[\JMS\Serializer\Annotation\SerializedName('customs')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateLabelRequestBodyPartialShipmentInternationalShipmentOptionsInput')]
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CreateLabelRequestBodyPartialShipmentInsuranceProviderEnum $insuranceProvider
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_provider')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateLabelRequestBodyPartialShipmentInsuranceProviderEnum>')]
    public CreateLabelRequestBodyPartialShipmentInsuranceProviderEnum $insuranceProvider;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateLabelRequestBodyPartialShipmentOriginTypeEnum $originType
     */
	#[\JMS\Serializer\Annotation\SerializedName('origin_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateLabelRequestBodyPartialShipmentOriginTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateLabelRequestBodyPartialShipmentOriginTypeEnum $originType = null;
	...
	public function __construct()
	{
		...
		$this->carrierId = "";
		$this->confirmation = \OpenAPI\OpenAPI\Models\Shared\CreateLabelRequestBodyPartialShipmentDeliveryConfirmationEnum::NONE;
		$this->customs = new \OpenAPI\OpenAPI\Models\Shared\CreateLabelRequestBodyPartialShipmentInternationalShipmentOptionsInput();
		$this->externalOrderId = null;
		$this->externalShipmentId = null;
		$this->insuranceProvider = \OpenAPI\OpenAPI\Models\Shared\CreateLabelRequestBodyPartialShipmentInsuranceProviderEnum::NONE;
		$this->items = null;
