...
from ..shared import evaluationfiltervariable_enum as shared_evaluationfiltervariable_enum
...
class DescribeEvaluationsInput:
    ...
    filter_variable: Optional[shared_evaluationfiltervariable_enum.EvaluationFilterVariableEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('FilterVariable') }})
