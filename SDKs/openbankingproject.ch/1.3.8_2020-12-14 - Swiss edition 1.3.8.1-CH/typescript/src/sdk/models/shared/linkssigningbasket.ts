...
export class LinksSigningBasket extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "startAuthorisation" })
  @Type(() => HrefType)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "startAuthorisationWithAuthenticationMethodSelection" })
  @Type(() => HrefType)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "startAuthorisationWithEncryptedPsuAuthentication" })
  @Type(() => HrefType)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "startAuthorisationWithPsuAuthentication" })
  @Type(() => HrefType)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "startAuthorisationWithPsuIdentification" })
  @Type(() => HrefType)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "startAuthorisationWithTransactionAuthorisation" })
  @Type(() => HrefType)
