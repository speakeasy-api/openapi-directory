...
func (e LogEventStatusEnum) ToPointer() *LogEventStatusEnum {
	return &e
}
...
func (e *LogEventStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case 0:
		fallthrough
	case 2:
		*e = LogEventStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for LogEventStatusEnum: %v", v)
	}
}
