...
type GamesConfigurationAchievementConfigurationsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type GamesConfigurationAchievementConfigurationsListPathParams struct {
	// The application ID from the Google Play developer console.
	ApplicationID string `pathParam:"style=simple,explode=false,name=applicationId"`
}

type GamesConfigurationAchievementConfigurationsListQueryParams struct {
	// V1 error format.
...
type GamesConfigurationAchievementConfigurationsListRequest struct {
...
type GamesConfigurationAchievementConfigurationsListResponse struct {
	// Successful response
