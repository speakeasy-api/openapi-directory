 ...
 */
public enum DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum {
    ...
    private DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum(String value) {
        this.value = value;
    }
}
