...
export class DatafusionProjectsLocationsInstancesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatafusionProjectsLocationsInstancesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatafusionProjectsLocationsInstancesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
