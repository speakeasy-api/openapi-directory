...
class UpdateArchiveRuleRequestBody:
    ...
    r"""A filter to match for the rules to update. Only rules that match the filter are updated."""  
...
class UpdateArchiveRuleRequest:
    ...
    r"""The name of the analyzer to update the archive rules for."""  
    request_body: UpdateArchiveRuleRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    rule_name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ruleName', 'style': 'simple', 'explode': False }})
    r"""The name of the rule to update."""  
