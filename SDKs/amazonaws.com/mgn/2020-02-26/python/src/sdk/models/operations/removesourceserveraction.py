...
class RemoveSourceServerActionRequestBody:
    ...
    r"""Source server post migration custom action ID to remove."""  
    source_server_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceServerID') }})
    r"""Source server ID of the post migration custom action to remove."""  
    

@dataclasses.dataclass
class RemoveSourceServerActionRequest:
    
    request_body: RemoveSourceServerActionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class RemoveSourceServerActionResponse:
    ...
    remove_source_server_action_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
