 ...
 */
public enum DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum {
    ...
    private DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum(String value) {
        this.value = value;
    }
}
