...
exports.TransactionsRefreshRequest = void 0;
var utils_1 = require("../../../internal/utils");
// TransactionsRefreshRequest
/**
 * TransactionsRefreshRequest defines the request schema for `/transactions/refresh`
**/
var TransactionsRefreshRequest = /** @class */ (function (_super) {
    __extends(TransactionsRefreshRequest, _super);
    function TransactionsRefreshRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=access_token" }),
        __metadata("design:type", String)
    ], TransactionsRefreshRequest.prototype, "accessToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=client_id" }),
        __metadata("design:type", String)
    ], TransactionsRefreshRequest.prototype, "clientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=secret" }),
        __metadata("design:type", String)
    ], TransactionsRefreshRequest.prototype, "secret", void 0);
