...
@dataclasses.dataclass
class MirrorTimelineAttachmentsListQueryParams:
...
class MirrorTimelineAttachmentsListRequest:
    path_params: MirrorTimelineAttachmentsListPathParams = dataclasses.field()
    query_params: MirrorTimelineAttachmentsListQueryParams = dataclasses.field()
    security: MirrorTimelineAttachmentsListSecurity = dataclasses.field()
