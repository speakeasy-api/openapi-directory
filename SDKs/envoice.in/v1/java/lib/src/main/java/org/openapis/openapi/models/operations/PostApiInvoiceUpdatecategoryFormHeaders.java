...
public class PostApiInvoiceUpdatecategoryFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PostApiInvoiceUpdatecategoryFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public PostApiInvoiceUpdatecategoryFormHeaders withXAuthSecret(String xAuthSecret) {
