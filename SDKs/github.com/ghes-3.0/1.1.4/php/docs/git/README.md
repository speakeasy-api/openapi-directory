...
try {
    ...
    $request->requestBody->content = 'dolore';
    $request->requestBody->encoding = 'laborum';
    $request->owner = 'sed';
    $request->repo = 'in';
...
try {
    ...
    $request->requestBody->author->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-04-21T22:21:50.112Z');
    $request->requestBody->author->email = 'Gene38@gmail.com';
    $request->requestBody->author->name = 'Rogelio Bins V';
    $request->requestBody->committer = new GitCreateCommitRequestBodyCommitter();
    $request->requestBody->committer->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-03-06T01:38:10.905Z');
    $request->requestBody->committer->email = 'Laron.Gerlach40@gmail.com';
    $request->requestBody->committer->name = 'Isaac Wolf';
    $request->requestBody->message = 'voluptate';
    ...
    $request->requestBody->signature = 'praesentium';
    $request->requestBody->tree = 'facilis';
...
try {
    ...
    $request->requestBody->ref = 'ipsam';
    $request->requestBody->sha = 'debitis';
    $request->owner = 'rem';
    $request->repo = 'sit';
...
try {
    ...
    $request->requestBody->message = 'nobis';
    $request->requestBody->object = 'error';
    $request->requestBody->tag = 'veniam';
    $request->requestBody->tagger = new GitCreateTagRequestBodyTagger();
    $request->requestBody->tagger->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-01-28T16:22:09.125Z');
    $request->requestBody->tagger->email = 'Saige90@hotmail.com';
    $request->requestBody->tagger->name = 'Lorraine King IV';
...
try {
    ...
    $request->requestBody->baseTree = 'laboriosam';
...
try {
    ...
    $request->recursive = 'culpa';
    $request->repo = 'expedita';
    $request->treeSha = 'magnam';
