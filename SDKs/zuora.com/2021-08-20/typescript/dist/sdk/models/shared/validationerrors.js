...
var ValidationErrors = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: validationreasons_1.ValidationReasons }),
        (0, class_transformer_1.Expose)({ name: "reasons" }),
        (0, class_transformer_1.Type)(function () { return validationreasons_1.ValidationReasons; }),
