...
export class Environment extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: EnvironmentDimensionValueEntry })
   ...
   */
  @SpeakeasyMetadata({ elemType: ShardSummary })
  @Expose({ name: "shardSummaries" })
  @Type(() => ShardSummary)
