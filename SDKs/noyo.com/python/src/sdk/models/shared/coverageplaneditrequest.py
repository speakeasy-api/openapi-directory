...
class CoveragePlanEditRequestBenefitDetailsEnum(str, Enum):
...
class CoveragePlanEditRequest:
    ...
    benefit_details: Optional[CoveragePlanEditRequestBenefitDetailsEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('benefit_details'), 'exclude': lambda f: f is None }})
    r"""The add-on benefits offered by the plan."""  
    cobra_rules: Optional[CoveragePlanEditRequestCobraRules] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cobra_rules'), 'exclude': lambda f: f is None }})
    r"""COBRA rules for the group medical plan"""  
