...
public class ConsentFlow {
    ...
    **/
     ...
     * 
    **/
    public openapisdk.models.operations.PostV05ConsentsHipNotifyResponse postV05ConsentsHipNotify(openapisdk.models.operations.PostV05ConsentsHipNotifyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v0.5/consents/hip/notify");
        ...
        openapisdk.models.operations.PostV05ConsentsHipNotifyResponse res = new openapisdk.models.operations.PostV05ConsentsHipNotifyResponse() {{
            errorResponse = null;
            body = null;
            errorResponse = null;
            body = null;
