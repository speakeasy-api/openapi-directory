...
exports.GetApiInvoiceAllcategoriesResponse = exports.GetApiInvoiceAllcategoriesRequest = void 0;
...
var GetApiInvoiceAllcategoriesRequest = /** @class */ (function (_super) {
    ...
    ], GetApiInvoiceAllcategoriesRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-key",
        }),
        __metadata("design:type", String)
    ], GetApiInvoiceAllcategoriesRequest.prototype, "xAuthKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-secret",
        }),
        __metadata("design:type", String)
    ], GetApiInvoiceAllcategoriesRequest.prototype, "xAuthSecret", void 0);
    return GetApiInvoiceAllcategoriesRequest;
}(utils_1.SpeakeasyBase));
exports.GetApiInvoiceAllcategoriesRequest = GetApiInvoiceAllcategoriesRequest;
var GetApiInvoiceAllcategoriesResponse = /** @class */ (function (_super) {
    ...
    ], GetApiInvoiceAllcategoriesResponse.prototype, "rawResponse", void 0);
    return GetApiInvoiceAllcategoriesResponse;
}(utils_1.SpeakeasyBase));
exports.GetApiInvoiceAllcategoriesResponse = GetApiInvoiceAllcategoriesResponse;
