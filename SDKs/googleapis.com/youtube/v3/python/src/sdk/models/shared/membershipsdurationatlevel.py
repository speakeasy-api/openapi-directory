...
class MembershipsDurationAtLevel:
    ...
    r"""The date and time when the user became a continuous member for the given level."""  
    ...
    r"""The cumulative time the user has been a member for the given level in complete months (the time is rounded down to the nearest integer)."""  
