...
type CreateRoomRequestClassificationEnum int
...
func (e CreateRoomRequestClassificationEnum) ToPointer() *CreateRoomRequestClassificationEnum {
	return &e
}
...
func (e *CreateRoomRequestClassificationEnum) UnmarshalJSON(data []byte) error {
	...
	case 3:
		fallthrough
	case 4:
		*e = CreateRoomRequestClassificationEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateRoomRequestClassificationEnum: %v", v)
	}
}
...
func (e CreateRoomRequestNewGroupMemberAcceptanceEnum) ToPointer() *CreateRoomRequestNewGroupMemberAcceptanceEnum {
	return &e
}
...
func (e *CreateRoomRequestNewGroupMemberAcceptanceEnum) UnmarshalJSON(data []byte) error {
	...
	case "autoallow":
		fallthrough
	case "pending":
		*e = CreateRoomRequestNewGroupMemberAcceptanceEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateRoomRequestNewGroupMemberAcceptanceEnum: %v", v)
	}
}
