...
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum(str, Enum):
    r"""Required. Identifies the type of assigned targeting options to list. Supported targeting types: * `TARGETING_TYPE_CHANNEL`"""
...
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListRequest:
    ...
    r"""Required. The ID of the partner."""  
    ...
    r"""A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListPartnerAssignedTargetingOptions` method. If not specified, the first page of results will be returned."""  
