...
public class LinkTokenCreateRequestUser {
    ...
    public LinkTokenCreateRequestUser withAddress(UserAddress address) {
    ...
    public LinkTokenCreateRequestUser withIdNumber(UserIDNumber idNumber) {
    ...
    public LinkTokenCreateRequestUser withName(UserName name) {
        this.name = name;
        return this;
    }
