...
class DescribeReplicationInstancesResponse:
    ...
    replication_instances: Optional[list[shared_replicationinstance.ReplicationInstance]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ReplicationInstances'), 'exclude': lambda f: f is None }})  
