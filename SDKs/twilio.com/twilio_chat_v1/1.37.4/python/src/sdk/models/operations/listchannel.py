...
class ListChannelListChannelResponse:
    channels: Optional[list[shared_chat_v1_service_channel.ChatV1ServiceChannel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('channels') }})
