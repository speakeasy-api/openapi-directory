...
class PostLoadBalancersIDActionsAttachToNetworkRequestBody:
    ...
    r"""ID of an existing network to attach the Load Balancer to"""  
    ...
    r"""IP to request to be assigned to this Load Balancer; if you do not provide this then you will be auto assigned an IP address"""  
...
class PostLoadBalancersIDActionsAttachToNetworkRequest:
    ...
    request_body: Optional[PostLoadBalancersIDActionsAttachToNetworkRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class PostLoadBalancersIDActionsAttachToNetworkActionResponseAction:
    ...
    error: PostLoadBalancersIDActionsAttachToNetworkActionResponseActionError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    r"""Error message for the Action if error occurred, otherwise null"""  
    ...
    resources: list[PostLoadBalancersIDActionsAttachToNetworkActionResponseActionResources] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources') }})
    ...
    status: PostLoadBalancersIDActionsAttachToNetworkActionResponseActionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Status of the Action"""  
...
class PostLoadBalancersIDActionsAttachToNetworkActionResponse:
    r"""The `action` key contains the `attach_to_network` Action"""
    
    action: PostLoadBalancersIDActionsAttachToNetworkActionResponseAction = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action') }})  
