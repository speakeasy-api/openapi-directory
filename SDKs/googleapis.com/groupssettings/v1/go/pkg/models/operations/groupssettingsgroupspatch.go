...
type GroupsSettingsGroupsPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type GroupsSettingsGroupsPatchPathParams struct {
	// The group's email address.
	GroupUniqueID string `pathParam:"style=simple,explode=false,name=groupUniqueId"`
}

type GroupsSettingsGroupsPatchQueryParams struct {
...
type GroupsSettingsGroupsPatchRequest struct {
...
type GroupsSettingsGroupsPatchResponse struct {
	ContentType string
	// Successful response
