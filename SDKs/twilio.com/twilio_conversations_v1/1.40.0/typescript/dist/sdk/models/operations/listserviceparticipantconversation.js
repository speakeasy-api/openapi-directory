...
exports.ListServiceParticipantConversationResponse = exports.ListServiceParticipantConversationListServiceParticipantConversationResponse = exports.ListServiceParticipantConversationListServiceParticipantConversationResponseMeta = exports.ListServiceParticipantConversationRequest = exports.ListServiceParticipantConversationSecurity = exports.ListServiceParticipantConversationServerList = void 0;
...
var ListServiceParticipantConversationSecurity = /** @class */ (function (_super) {
    ...
    ], ListServiceParticipantConversationSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListServiceParticipantConversationSecurity.prototype, "username", void 0);
...
var ListServiceParticipantConversationRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListServiceParticipantConversationRequest.prototype, "address", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ChatServiceSid",
        }),
        __metadata("design:type", String)
    ], ListServiceParticipantConversationRequest.prototype, "chatServiceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Identity",
        }),
        __metadata("design:type", String)
    ], ListServiceParticipantConversationRequest.prototype, "identity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListServiceParticipantConversationRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListServiceParticipantConversationRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListServiceParticipantConversationRequest.prototype, "pageToken", void 0);
...
var ListServiceParticipantConversationListServiceParticipantConversationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.ConversationsV1ServiceServiceParticipantConversation; }),
...
var ListServiceParticipantConversationResponse = /** @class */ (function (_super) {
    ...
    ], ListServiceParticipantConversationResponse.prototype, "rawResponse", void 0);
