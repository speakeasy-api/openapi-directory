...
export class DataplexProjectsLocationsDataAttributeBindingsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsDataAttributeBindingsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsDataAttributeBindingsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
