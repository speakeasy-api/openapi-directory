...
@dataclasses.dataclass
class PoolEnableAutoScaleHeaders:
...
class PoolEnableAutoScaleRequest:
    headers: PoolEnableAutoScaleHeaders = dataclasses.field()
    path_params: PoolEnableAutoScalePathParams = dataclasses.field()
    query_params: PoolEnableAutoScaleQueryParams = dataclasses.field()
