...
class ListUserListUserResponse:
    ...
    users: Optional[list[shared_ip_messaging_v1_service_user.IPMessagingV1ServiceUser]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('users'), 'exclude': lambda f: f is None }})  
