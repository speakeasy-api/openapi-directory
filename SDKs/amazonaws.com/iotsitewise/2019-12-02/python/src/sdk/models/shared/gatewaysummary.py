...
class GatewaySummary:
    ...
    gateway_capability_summaries: Optional[list[shared_gatewaycapabilitysummary.GatewayCapabilitySummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('gatewayCapabilitySummaries') }})
