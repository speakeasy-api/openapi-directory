...
class SolutionSummary:
    r"""Provides a summary of the properties of a solution. For a complete listing, call the <a href=\\"https://docs.aws.amazon.com/personalize/latest/dg/API_DescribeSolution.html\\">DescribeSolution</a> API."""
