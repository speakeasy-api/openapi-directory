...
class DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDWatchRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDWatchPathParams = dataclasses.field()
    security: DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDWatchSecurity = dataclasses.field()
