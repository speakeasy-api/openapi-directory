  ...
  **/
  deleteGroupUsersId(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.DeleteGroupUsersIdResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  getGroupUsers(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetGroupUsersResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  patchGroupUsersId(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PatchGroupUsersIdResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  postGroupUsers(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostGroupUsersResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
