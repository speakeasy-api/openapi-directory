...
exports.GetAssociationFilterResponse = exports.GetAssociationFilterRequest = exports.GetAssociationFilterQueryParams = void 0;
...
var GetAssociationFilterQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=datasource" }),
        __metadata("design:type", String)
    ], GetAssociationFilterQueryParams.prototype, "datasource", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=datastructure" }),
        __metadata("design:type", String)
    ], GetAssociationFilterQueryParams.prototype, "datastructure", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=datatype" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=disease" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=pathway" }),
        __metadata("design:type", String)
    ], GetAssociationFilterQueryParams.prototype, "pathway", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=scorevalue_max" }),
        __metadata("design:type", Number)
    ], GetAssociationFilterQueryParams.prototype, "scorevalueMax", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=scorevalue_min" }),
        __metadata("design:type", Number)
    ], GetAssociationFilterQueryParams.prototype, "scorevalueMin", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=scorevalue_types" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=target_class" }),
        __metadata("design:type", String)
    ], GetAssociationFilterQueryParams.prototype, "targetClass", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=therapeutic_area" }),
        __metadata("design:type", String)
    ], GetAssociationFilterQueryParams.prototype, "therapeuticArea", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=uniprotkw" }),
        __metadata("design:type", String)
    ], GetAssociationFilterQueryParams.prototype, "uniprotkw", void 0);
    return GetAssociationFilterQueryParams;
}(utils_1.SpeakeasyBase));
exports.GetAssociationFilterQueryParams = GetAssociationFilterQueryParams;
...
exports.GetAssociationFilterRequest = GetAssociationFilterRequest;
...
exports.GetAssociationFilterResponse = GetAssociationFilterResponse;
