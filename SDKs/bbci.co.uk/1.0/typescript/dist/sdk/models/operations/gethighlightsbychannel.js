...
exports.GetHighlightsByChannelResponse = exports.GetHighlightsByChannelRequest = void 0;
...
var GetHighlightsByChannelRequest = /** @class */ (function (_super) {
    ...
    ], GetHighlightsByChannelRequest.prototype, "availability", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=channel",
        }),
        __metadata("design:type", String)
    ], GetHighlightsByChannelRequest.prototype, "channel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=lang" }),
        __metadata("design:type", String)
    ], GetHighlightsByChannelRequest.prototype, "lang", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=live" }),
        __metadata("design:type", Boolean)
    ], GetHighlightsByChannelRequest.prototype, "live", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=mixin" }),
        __metadata("design:type", String)
    ], GetHighlightsByChannelRequest.prototype, "mixin", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=rights",
        }),
        __metadata("design:type", String)
    ], GetHighlightsByChannelRequest.prototype, "rights", void 0);
    return GetHighlightsByChannelRequest;
}(utils_1.SpeakeasyBase));
exports.GetHighlightsByChannelRequest = GetHighlightsByChannelRequest;
var GetHighlightsByChannelResponse = /** @class */ (function (_super) {
    ...
    ], GetHighlightsByChannelResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.GetHighlightsByChannelResponse = GetHighlightsByChannelResponse;
