...
var Ratings = /** @class */ (function () {
    function Ratings(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Ratings.prototype.getConferenceSpRatings = function (req, config) {
     ...
     * SP+ rating data
    **/
    Ratings.prototype.getSpRatings = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Ratings.prototype.getSrsRatings = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
