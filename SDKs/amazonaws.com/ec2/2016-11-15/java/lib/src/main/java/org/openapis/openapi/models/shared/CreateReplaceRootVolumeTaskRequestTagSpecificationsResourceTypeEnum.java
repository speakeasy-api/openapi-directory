 ...
 */
public enum CreateReplaceRootVolumeTaskRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateReplaceRootVolumeTaskRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
