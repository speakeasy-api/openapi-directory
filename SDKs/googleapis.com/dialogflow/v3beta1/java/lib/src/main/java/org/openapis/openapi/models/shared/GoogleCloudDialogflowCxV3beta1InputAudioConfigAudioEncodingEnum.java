 ...
 */
public enum GoogleCloudDialogflowCxV3beta1InputAudioConfigAudioEncodingEnum {
    ...
    private GoogleCloudDialogflowCxV3beta1InputAudioConfigAudioEncodingEnum(String value) {
        this.value = value;
    }
}
