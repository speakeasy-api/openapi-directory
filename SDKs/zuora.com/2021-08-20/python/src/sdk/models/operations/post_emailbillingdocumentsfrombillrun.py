...
class POSTEmailBillingDocumentsfromBillRunRequest:
    ...
    r"""The ID of the bill run. For example, 2c92c8f95d0c886e015d11287a8f0f8b."""  
    post_email_billing_docfrom_bill_run_type: shared_postemailbillingdocfrombillruntype.POSTEmailBillingDocfromBillRunType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
