...
type ContentBuyongoogleprogramsRequestreviewSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentBuyongoogleprogramsRequestreviewPathParams struct {
...
type ContentBuyongoogleprogramsRequestreviewQueryParams struct {
	// V1 error format.
...
type ContentBuyongoogleprogramsRequestreviewRequest struct {
...
type ContentBuyongoogleprogramsRequestreviewResponse struct {
	ContentType string
	StatusCode  int
