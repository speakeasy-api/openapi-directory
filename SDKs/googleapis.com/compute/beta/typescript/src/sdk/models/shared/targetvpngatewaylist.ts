 ...
 */
export enum TargetVpnGatewayListWarningCodeEnum {
...
export class TargetVpnGatewayListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetVpnGatewayListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: TargetVpnGatewayListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: TargetVpnGatewayListWarningData })
  @Expose({ name: "data" })
  @Type(() => TargetVpnGatewayListWarningData)
  data?: TargetVpnGatewayListWarningData[];
 ...
 */
export class TargetVpnGatewayList extends SpeakeasyBase {
  /**
