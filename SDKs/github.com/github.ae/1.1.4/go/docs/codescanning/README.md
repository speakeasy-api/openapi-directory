...
<https://docs.github.com/github-ae@latest/rest/reference/code-scanning#delete-a-code-scanning-analysis-from-a-repository>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningDeleteAnalysis(ctx, operations.CodeScanningDeleteAnalysisRequest{
        AnalysisID: 565421,
        ConfirmDelete: sdk.String("temporibus"),
        Owner: "qui",
        Repo: "neque",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/code-scanning#get-a-code-scanning-alert>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/code-scanning#get-a-code-scanning-analysis-for-a-repository>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/code-scanning#list-recent-code-scanning-analyses-for-a-repository>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/code-scanning#list-instances-of-a-code-scanning-alert>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListAlertInstances(ctx, operations.CodeScanningListAlertInstancesRequest{
        AlertNumber: 746994,
        Owner: "nobis",
        Page: sdk.Int64(92596),
        PerPage: sdk.Int64(903720),
        Ref: sdk.String("ipsum"),
        Repo: "veritatis",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/code-scanning#list-code-scanning-alerts-by-organization>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListAlertsForOrg(ctx, operations.CodeScanningListAlertsForOrgRequest{
        ...
        ToolGUID: sdk.String("labore"),
        ToolName: sdk.String("adipisci"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/code-scanning#list-code-scanning-alerts-for-a-repository>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListAlertsForRepo(ctx, operations.CodeScanningListAlertsForRepoRequest{
        ...
        ToolGUID: sdk.String("repellendus"),
        ToolName: sdk.String("porro"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/code-scanning#list-code-scanning-analyses-for-a-repository>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningListRecentAnalyses(ctx, operations.CodeScanningListRecentAnalysesRequest{
        Direction: shared.DirectionEnumDesc.ToPointer(),
        Owner: "ut",
        Page: sdk.Int64(703495),
        PerPage: sdk.Int64(586410),
        Ref: sdk.String("qui"),
        Repo: "quae",
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/code-scanning#update-a-code-scanning-alert>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/code-scanning#upload-a-sarif-file>
...
func main() {
    ...
    res, err := s.CodeScanning.CodeScanningUploadSarif(ctx, operations.CodeScanningUploadSarifRequest{
        RequestBody: operations.CodeScanningUploadSarifRequestBody{
            ...
            Ref: "ipsum",
            Sarif: "delectus",
            StartedAt: types.MustTimeFromString("2022-10-08T10:17:36.770Z"),
