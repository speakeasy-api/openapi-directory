...
class GetCommitteesRequest:
    ...
    r"""The one-letter
        code of the filing frequency:
             ...
             - W Waived
    """  
    max_first_f1_date: Optional[date] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'max_first_f1_date', 'style': 'form', 'explode': True }})
    r"""Filter for committees whose first Form 1 was received on or before this date."""  
    ...
    r"""Filter for committees whose first filing was received on or before this date."""  
    ...
    r"""Filter for committees whose latest Form 1 was received on or before this date."""  
    min_first_f1_date: Optional[date] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'min_first_f1_date', 'style': 'form', 'explode': True }})
    r"""Filter for committees whose first Form 1 was received on or after this date."""  
    ...
    r"""Filter for committees whose first filing was received on or after this date."""  
    ...
    r"""Filter for committees whose latest Form 1 was received on or after this date."""  
