...
exports.SearchTypeBlsSeriesResponse = exports.SearchTypeBlsSeriesRequest = exports.SearchTypeBlsSeriesQueryParams = void 0;
...
var SearchTypeBlsSeriesQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_bls_series.area" }),
        __metadata("design:type", String)
    ], SearchTypeBlsSeriesQueryParams.prototype, "searchTypeBlsSeriesArea", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_bls_series.industry" }),
        __metadata("design:type", String)
    ], SearchTypeBlsSeriesQueryParams.prototype, "searchTypeBlsSeriesIndustry", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_bls_series.item" }),
        __metadata("design:type", String)
    ], SearchTypeBlsSeriesQueryParams.prototype, "searchTypeBlsSeriesItem", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_bls_series.measure_data_type" }),
        __metadata("design:type", String)
    ], SearchTypeBlsSeriesQueryParams.prototype, "searchTypeBlsSeriesMeasureDataType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_bls_series.seasonality" }),
        __metadata("design:type", String)
    ], SearchTypeBlsSeriesQueryParams.prototype, "searchTypeBlsSeriesSeasonality", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_bls_series.sector" }),
        __metadata("design:type", String)
    ], SearchTypeBlsSeriesQueryParams.prototype, "searchTypeBlsSeriesSector", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_bls_series.survey_name" }),
        __metadata("design:type", String)
...
exports.SearchTypeBlsSeriesQueryParams = SearchTypeBlsSeriesQueryParams;
...
exports.SearchTypeBlsSeriesRequest = SearchTypeBlsSeriesRequest;
...
exports.SearchTypeBlsSeriesResponse = SearchTypeBlsSeriesResponse;
