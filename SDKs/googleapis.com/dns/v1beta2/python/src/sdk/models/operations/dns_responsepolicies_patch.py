...
class DNSResponsePoliciesPatchRequest:
    ...
    response_policy_path_parameter: str = dataclasses.field(metadata={'path_param': { 'field_name': 'responsePolicy', 'style': 'simple', 'explode': False }})
    ...
    response_policy1: Optional[shared_responsepolicy.ResponsePolicy] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
