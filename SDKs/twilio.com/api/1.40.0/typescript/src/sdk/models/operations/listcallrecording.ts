...
export const ListCallRecordingServerList = ["https://api.twilio.com"] as const;
...
export class ListCallRecordingListCallRecordingResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.ApiV2010AccountCallCallRecording })
  @Expose({ name: "recordings" })
  @Type(() => shared.ApiV2010AccountCallCallRecording)
