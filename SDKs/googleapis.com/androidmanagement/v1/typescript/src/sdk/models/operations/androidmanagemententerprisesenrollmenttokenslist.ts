...
export class AndroidmanagementEnterprisesEnrollmentTokensListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AndroidmanagementEnterprisesEnrollmentTokensListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AndroidmanagementEnterprisesEnrollmentTokensListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
