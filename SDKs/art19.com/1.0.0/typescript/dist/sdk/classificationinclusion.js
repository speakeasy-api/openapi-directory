...
var ClassificationInclusion = /** @class */ (function () {
     ...
     *
     */
    ClassificationInclusion.prototype.getClassificationInclusions = function (req, security, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetClassificationInclusionsResponse({
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/vnd.api+json")) {
                        res.getClassificationInclusions200ApplicationVndApiPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetClassificationInclusions200ApplicationVndApiPlusJson);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    if (utils.matchContentType(contentType, "application/vnd.api+json")) {
                        res.getClassificationInclusions400ApplicationVndApiPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetClassificationInclusions400ApplicationVndApiPlusJson);
                    }
                    break;
     ...
     */
    ClassificationInclusion.prototype.getClassificationInclusionsId = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetClassificationInclusionsIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/classification_inclusions/{id}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetClassificationInclusionsIdResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
                headers: utils.getHeadersFromResponse(httpRes.headers),
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/vnd.api+json")) {
                        res.getClassificationInclusionsId200ApplicationVndApiPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetClassificationInclusionsId200ApplicationVndApiPlusJson);
                    }
                    break;
