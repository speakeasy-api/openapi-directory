...
exports.GetProfileResponse = exports.GetProfileRequest = void 0;
...
var GetProfileRequest = /** @class */ (function (_super) {
    ...
    ], GetProfileRequest.prototype, "accept", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Content-Type",
        }),
        __metadata("design:type", String)
    ], GetProfileRequest.prototype, "contentType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=alternativeKey",
        }),
        __metadata("design:type", String)
    ], GetProfileRequest.prototype, "alternativeKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=profileId",
        }),
        __metadata("design:type", String)
    ], GetProfileRequest.prototype, "profileId", void 0);
...
var GetProfileResponse = /** @class */ (function (_super) {
    ...
    ], GetProfileResponse.prototype, "getProfile200ApplicationJSONAnies", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
