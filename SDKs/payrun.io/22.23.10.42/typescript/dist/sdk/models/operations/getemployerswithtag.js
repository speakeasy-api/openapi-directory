...
exports.GetEmployersWithTagResponse = exports.GetEmployersWithTagRequest = void 0;
...
var GetEmployersWithTagRequest = /** @class */ (function (_super) {
    ...
    ], GetEmployersWithTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetEmployersWithTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetEmployersWithTagRequest.prototype, "tagId", void 0);
    return GetEmployersWithTagRequest;
}(utils_1.SpeakeasyBase));
exports.GetEmployersWithTagRequest = GetEmployersWithTagRequest;
var GetEmployersWithTagResponse = /** @class */ (function (_super) {
    ...
    ], GetEmployersWithTagResponse.prototype, "rawResponse", void 0);
    return GetEmployersWithTagResponse;
}(utils_1.SpeakeasyBase));
exports.GetEmployersWithTagResponse = GetEmployersWithTagResponse;
