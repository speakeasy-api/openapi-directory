...
from ..shared import createpermitresult as shared_createpermitresult
...
class PostCreatePermitResponse:
    ...
    create_permit_result: Optional[shared_createpermitresult.CreatePermitResult] = dataclasses.field(default=None)
