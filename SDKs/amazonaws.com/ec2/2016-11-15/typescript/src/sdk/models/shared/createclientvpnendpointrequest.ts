 ...
 */
export enum CreateClientVpnEndpointRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateClientVpnEndpointRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateClientVpnEndpointRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateClientVpnEndpointRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: ClientVpnAuthenticationRequest })
