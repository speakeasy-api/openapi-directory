...
class GoogleCloudVisionV1p1beta1AnnotateImageRequest:
    r"""GoogleCloudVisionV1p1beta1AnnotateImageRequest
    ...
    image: Optional[shared_googlecloudvisionv1p1beta1image.GoogleCloudVisionV1p1beta1Image] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('image') }})
