...
type CloudassetProjectsExportAssetsSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudassetProjectsExportAssetsPathParams struct {
...
type CloudassetProjectsExportAssetsQueryParams struct {
	// V1 error format.
...
type CloudassetProjectsExportAssetsRequest struct {
	PathParams  CloudassetProjectsExportAssetsPathParams
	QueryParams CloudassetProjectsExportAssetsQueryParams
	Request     *shared.ExportAssetsRequest `request:"mediaType=application/json"`
	Security    CloudassetProjectsExportAssetsSecurity
}

type CloudassetProjectsExportAssetsResponse struct {
	ContentType string
	// Successful response
