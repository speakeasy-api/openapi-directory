...
class DescribeTrustedAdvisorChecksRequest:
    ...
    describe_trusted_advisor_checks_request: shared_describetrustedadvisorchecksrequest.DescribeTrustedAdvisorChecksRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
