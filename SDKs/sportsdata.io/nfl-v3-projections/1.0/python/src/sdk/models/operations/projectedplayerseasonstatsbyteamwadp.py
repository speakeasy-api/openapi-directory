...
class ProjectedPlayerSeasonStatsByTeamWAdpFormatEnum(str, Enum):
...
class ProjectedPlayerSeasonStatsByTeamWAdpRequest:
    
    format: ProjectedPlayerSeasonStatsByTeamWAdpFormatEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'format', 'style': 'simple', 'explode': False }})
    r"""Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>."""  
...
@dataclasses.dataclass
class ProjectedPlayerSeasonStatsByTeamWAdpResponse:
