...
exports.GetPayLineFromEmployeeResponse = exports.GetPayLineFromEmployeeRequest = void 0;
...
var GetPayLineFromEmployeeRequest = /** @class */ (function (_super) {
    ...
    ], GetPayLineFromEmployeeRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetPayLineFromEmployeeRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], GetPayLineFromEmployeeRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetPayLineFromEmployeeRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayLineId",
        }),
        __metadata("design:type", String)
    ], GetPayLineFromEmployeeRequest.prototype, "payLineId", void 0);
    return GetPayLineFromEmployeeRequest;
}(utils_1.SpeakeasyBase));
exports.GetPayLineFromEmployeeRequest = GetPayLineFromEmployeeRequest;
var GetPayLineFromEmployeeResponse = /** @class */ (function (_super) {
    ...
    ], GetPayLineFromEmployeeResponse.prototype, "rawResponse", void 0);
    return GetPayLineFromEmployeeResponse;
}(utils_1.SpeakeasyBase));
exports.GetPayLineFromEmployeeResponse = GetPayLineFromEmployeeResponse;
