...
export class GetDiseaseVariantAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetDiseaseVariantAssociationsQueryParams extends SpeakeasyBase {
...
export class GetDiseaseVariantAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetDiseaseVariantAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
