...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/amadeus.com/amadeus-travel-recommendations/1.0.3/python
```
...
* `get_recommended_location` - GET recommended destinations
