...
public class Discovery {
     ...
     * 
    **/
    public openapisdk.models.operations.PostV05CareContextsDiscoverResponse postV05CareContextsDiscover(openapisdk.models.operations.PostV05CareContextsDiscoverRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v0.5/care-contexts/discover");
        ...
        openapisdk.models.operations.PostV05CareContextsDiscoverResponse res = new openapisdk.models.operations.PostV05CareContextsDiscoverResponse() {{
            errorResponse = null;
            errorResponse = null;
            body = null;
            errorResponse = null;
     ...
     * 
    **/
    public openapisdk.models.operations.PostV05CareContextsOnDiscoverResponse postV05CareContextsOnDiscover(openapisdk.models.operations.PostV05CareContextsOnDiscoverRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v0.5/care-contexts/on-discover");
        ...
        openapisdk.models.operations.PostV05CareContextsOnDiscoverResponse res = new openapisdk.models.operations.PostV05CareContextsOnDiscoverResponse() {{
            errorResponse = null;
            errorResponse = null;
            body = null;
            errorResponse = null;
