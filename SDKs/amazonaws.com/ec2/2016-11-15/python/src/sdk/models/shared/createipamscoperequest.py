...
class CreateIpamScopeRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateIpamScopeRequestTagSpecifications:
    ...
    resource_type: Optional[CreateIpamScopeRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateIpamScopeRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateIpamScopeRequest:
    ...
    tag_specifications: Optional[list[CreateIpamScopeRequestTagSpecifications]] = dataclasses.field(default=None)  
