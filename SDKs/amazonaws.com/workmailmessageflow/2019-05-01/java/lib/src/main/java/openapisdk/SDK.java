...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.GetRawMessageContentResponse getRawMessageContent(openapisdk.models.operations.GetRawMessageContentRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/messages/{messageId}", request.pathParams);
        ...
        openapisdk.models.operations.GetRawMessageContentResponse res = new openapisdk.models.operations.GetRawMessageContentResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GetRawMessageContentResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetRawMessageContentResponse.class);
    ...
    **/
    public openapisdk.models.operations.PutRawMessageContentResponse putRawMessageContent(openapisdk.models.operations.PutRawMessageContentRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/messages/{messageId}", request.pathParams);
        ...
        openapisdk.models.operations.PutRawMessageContentResponse res = new openapisdk.models.operations.PutRawMessageContentResponse() {{
