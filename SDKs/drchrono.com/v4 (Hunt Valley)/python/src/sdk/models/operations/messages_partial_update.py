...
class MessagesPartialUpdatePathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class MessagesPartialUpdateQueryParams:
...
@dataclasses.dataclass
class MessagesPartialUpdateSecurity:
    drchrono_oauth2: shared_security.SchemeDrchronoOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class MessagesPartialUpdateRequest:
    path_params: MessagesPartialUpdatePathParams = dataclasses.field()
    query_params: MessagesPartialUpdateQueryParams = dataclasses.field()
    security: MessagesPartialUpdateSecurity = dataclasses.field()
    

@dataclasses.dataclass
class MessagesPartialUpdateResponse:
