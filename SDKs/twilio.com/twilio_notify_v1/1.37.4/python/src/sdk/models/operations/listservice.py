...
class ListServiceListServiceResponse:
    ...
    services: Optional[list[shared_notify_v1_service.NotifyV1Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('services') }})
