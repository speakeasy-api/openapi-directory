...
exports.SearchTypePointAmerifluxLevel2Response = exports.SearchTypePointAmerifluxLevel2Request = exports.SearchTypePointAmerifluxLevel2QueryParams = void 0;
...
var SearchTypePointAmerifluxLevel2QueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_ameriflux_level2.contact" }),
        __metadata("design:type", String)
    ], SearchTypePointAmerifluxLevel2QueryParams.prototype, "searchTypePointAmerifluxLevel2Contact", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_ameriflux_level2.ecosystem_type" }),
        __metadata("design:type", String)
    ], SearchTypePointAmerifluxLevel2QueryParams.prototype, "searchTypePointAmerifluxLevel2EcosystemType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_ameriflux_level2.site_id" }),
        __metadata("design:type", String)
...
exports.SearchTypePointAmerifluxLevel2QueryParams = SearchTypePointAmerifluxLevel2QueryParams;
