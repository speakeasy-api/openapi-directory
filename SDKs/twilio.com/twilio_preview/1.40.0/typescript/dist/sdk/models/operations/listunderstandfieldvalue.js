...
exports.ListUnderstandFieldValueResponse = exports.ListUnderstandFieldValueListUnderstandFieldValueResponse = exports.ListUnderstandFieldValueListUnderstandFieldValueResponseMeta = exports.ListUnderstandFieldValueRequest = exports.ListUnderstandFieldValueSecurity = exports.ListUnderstandFieldValueServerList = void 0;
...
var ListUnderstandFieldValueSecurity = /** @class */ (function (_super) {
    ...
    ], ListUnderstandFieldValueSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListUnderstandFieldValueSecurity.prototype, "username", void 0);
...
var ListUnderstandFieldValueRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListUnderstandFieldValueRequest.prototype, "assistantSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=FieldTypeSid",
        }),
        __metadata("design:type", String)
    ], ListUnderstandFieldValueRequest.prototype, "fieldTypeSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Language",
        }),
        __metadata("design:type", String)
    ], ListUnderstandFieldValueRequest.prototype, "language", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListUnderstandFieldValueRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListUnderstandFieldValueRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListUnderstandFieldValueRequest.prototype, "pageToken", void 0);
...
var ListUnderstandFieldValueListUnderstandFieldValueResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.PreviewUnderstandAssistantFieldTypeFieldValue,
        }),
        (0, class_transformer_1.Expose)({ name: "field_values" }),
        (0, class_transformer_1.Type)(function () { return shared.PreviewUnderstandAssistantFieldTypeFieldValue; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListUnderstandFieldValueListUnderstandFieldValueResponseMeta; }),
...
var ListUnderstandFieldValueResponse = /** @class */ (function (_super) {
    ...
    ], ListUnderstandFieldValueResponse.prototype, "rawResponse", void 0);
