...
import dataclasses
from ..shared import createtransitgatewayconnectrequestoptions as shared_createtransitgatewayconnectrequestoptions
from enum import Enum
from typing import Optional

class CreateTransitGatewayConnectRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateTransitGatewayConnectRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
class CreateTransitGatewayConnectRequestTagSpecifications:
    ...
    resource_type: Optional[CreateTransitGatewayConnectRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateTransitGatewayConnectRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateTransitGatewayConnectRequest:
    
    options: shared_createtransitgatewayconnectrequestoptions.CreateTransitGatewayConnectRequestOptions = dataclasses.field()  
    transport_transit_gateway_attachment_id: str = dataclasses.field()  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateTransitGatewayConnectRequestTagSpecifications]] = dataclasses.field(default=None)  
