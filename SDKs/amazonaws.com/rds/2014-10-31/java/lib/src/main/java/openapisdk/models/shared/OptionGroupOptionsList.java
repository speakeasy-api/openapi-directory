...
public class OptionGroupOptionsList {
    ...
    public java.util.Map<String, Object>[] optionsConflictsWith;
    public OptionGroupOptionsList withOptionsConflictsWith(java.util.Map<String, Object>[] optionsConflictsWith) {
        this.optionsConflictsWith = optionsConflictsWith;
        return this;
    }
    public java.util.Map<String, Object>[] optionsDependedOn;
    public OptionGroupOptionsList withOptionsDependedOn(java.util.Map<String, Object>[] optionsDependedOn) {
