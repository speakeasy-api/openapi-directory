...
@dataclasses.dataclass
class GetNetworkWirelessUsageHistoryQueryParams:
    ...
    band: Optional[GetNetworkWirelessUsageHistoryBandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'band', 'style': 'form', 'explode': True }})
...
class GetNetworkWirelessUsageHistoryRequest:
    path_params: GetNetworkWirelessUsageHistoryPathParams = dataclasses.field()
    query_params: GetNetworkWirelessUsageHistoryQueryParams = dataclasses.field()
...
class GetNetworkWirelessUsageHistoryResponse:
    ...
    get_network_wireless_usage_history_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
