...
func (e *CreateLabelFromShipmentRequestBodyDisplaySchemeEnum) UnmarshalJSON(data []byte) error {
	...
	case "label_and_qr_code":
		*e = CreateLabelFromShipmentRequestBodyDisplaySchemeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateLabelFromShipmentRequestBodyDisplaySchemeEnum: %s", s)
	}
}
...
func (e *CreateLabelFromShipmentRequestBodyLabelFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "png":
		fallthrough
	case "zpl":
		*e = CreateLabelFromShipmentRequestBodyLabelFormatEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateLabelFromShipmentRequestBodyLabelFormatEnum: %s", s)
	}
}
...
func (e *CreateLabelFromShipmentRequestBodyLabelLayoutEnum) UnmarshalJSON(data []byte) error {
	...
	case "4x6":
		fallthrough
	case "letter":
		*e = CreateLabelFromShipmentRequestBodyLabelLayoutEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateLabelFromShipmentRequestBodyLabelLayoutEnum: %s", s)
	}
}
