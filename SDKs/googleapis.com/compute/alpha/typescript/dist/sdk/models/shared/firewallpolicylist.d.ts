 ...
 */
export declare enum FirewallPolicyListWarningCodeEnum {
...
export declare class FirewallPolicyListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class FirewallPolicyListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class FirewallPolicyList extends SpeakeasyBase {
    /**
