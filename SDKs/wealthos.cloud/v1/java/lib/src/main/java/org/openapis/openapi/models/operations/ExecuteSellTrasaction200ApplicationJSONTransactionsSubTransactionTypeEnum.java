 ...
 */
public enum ExecuteSellTrasaction200ApplicationJSONTransactionsSubTransactionTypeEnum {
    ...
    private ExecuteSellTrasaction200ApplicationJSONTransactionsSubTransactionTypeEnum(String value) {
        this.value = value;
    }
}
