...
class UpdateOrganizationAdminRequestBodyNetworks:
    ...
    r"""The privilege of the dashboard administrator on the network. Can be one of 'full', 'read-only', 'guest-ambassador' or 'monitor-only'"""  
...
class UpdateOrganizationAdminRequestBodyTagsAccessEnum(str, Enum):
    r"""The privilege of the dashboard administrator on the tag. Can be one of 'full', 'read-only', 'guest-ambassador' or 'monitor-only'"""
    FULL = 'full'
...
class UpdateOrganizationAdminRequestBodyTags:
    ...
    access: UpdateOrganizationAdminRequestBodyTagsAccessEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('access') }})
    r"""The privilege of the dashboard administrator on the tag. Can be one of 'full', 'read-only', 'guest-ambassador' or 'monitor-only'"""  
