...
export declare enum WritableConsoleServerPortConnectionStatusEnum {
    False = "false",
    True = "true"
}
/**
 * Physical port type
 */
export declare enum WritableConsoleServerPortTypeEnum {
    De9 = "de-9",
    Db25 = "db-25",
    Rj11 = "rj-11",
    Rj12 = "rj-12",
...
export declare class WritableConsoleServerPortInput extends SpeakeasyBase {
