...
from ..shared import deleteconsumerresponse as shared_deleteconsumerresponse
...
@dataclasses.dataclass
class ConsumersDeleteResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    delete_consumer_response: Optional[shared_deleteconsumerresponse.DeleteConsumerResponse] = dataclasses.field(default=None)
    r"""Consumer deleted"""  
