...
class PostRevokeDbSecurityGroupIngressQueryParams:
    action: PostRevokeDbSecurityGroupIngressActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostRevokeDbSecurityGroupIngressVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostRevokeDbSecurityGroupIngressRequest:
    headers: PostRevokeDbSecurityGroupIngressHeaders = dataclasses.field()
    query_params: PostRevokeDbSecurityGroupIngressQueryParams = dataclasses.field()
