...
func (e *RegisterOrganizationDelegatedAdminXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.RegisterOrganizationDelegatedAdmin":
		*e = RegisterOrganizationDelegatedAdminXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for RegisterOrganizationDelegatedAdminXAmzTargetEnum: %s", s)
	}
}

type RegisterOrganizationDelegatedAdminHeaders struct {
...
type RegisterOrganizationDelegatedAdminRequest struct {
	Headers RegisterOrganizationDelegatedAdminHeaders
	Request shared.RegisterOrganizationDelegatedAdminRequest `request:"mediaType=application/json"`
}
