...
class ContinueDeploymentRequest:
    headers: ContinueDeploymentHeaders = dataclasses.field()
    request: shared_continuedeploymentinput.ContinueDeploymentInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
