 ...
 */
export enum GetDeviceSwitchPorts200ApplicationJSONAccessPolicyTypeEnum {
 ...
 * Profile attributes
 */
export class GetDeviceSwitchPorts200ApplicationJSONProfile extends SpeakeasyBase {
  /**
 ...
 */
export enum GetDeviceSwitchPorts200ApplicationJSONStpGuardEnum {
 ...
 */
export enum GetDeviceSwitchPorts200ApplicationJSONTypeEnum {
  Access = "access",
  Trunk = "trunk",
}
 ...
 */
export enum GetDeviceSwitchPorts200ApplicationJSONUdldEnum {
  AlertOnly = "Alert only",
  Enforce = "Enforce",
}

export class GetDeviceSwitchPorts200ApplicationJSON extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "profile" })
  @Type(() => GetDeviceSwitchPorts200ApplicationJSONProfile)
...
export class GetDeviceSwitchPortsResponse extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GetDeviceSwitchPorts200ApplicationJSON })
