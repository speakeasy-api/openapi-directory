...
class UpdateNetworkAlertsSettingsRequestBodyAlerts:
    ...
    r"""The type of alert"""  
    alert_destinations: Optional[UpdateNetworkAlertsSettingsRequestBodyAlertsAlertDestinations] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('alertDestinations'), 'exclude': lambda f: f is None }})
    r"""A hash of destinations for this specific alert"""  
...
class UpdateNetworkAlertsSettingsRequestBody:
    ...
    alerts: Optional[list[UpdateNetworkAlertsSettingsRequestBodyAlerts]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('alerts'), 'exclude': lambda f: f is None }})
    r"""Alert-specific configuration for each type. Only alerts that pertain to the network can be updated."""  
    default_destinations: Optional[UpdateNetworkAlertsSettingsRequestBodyDefaultDestinations] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('defaultDestinations'), 'exclude': lambda f: f is None }})
    r"""The network-wide destinations for all alerts on the network."""  
...
class UpdateNetworkAlertsSettingsRequest:
    ...
    request_body: Optional[UpdateNetworkAlertsSettingsRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
