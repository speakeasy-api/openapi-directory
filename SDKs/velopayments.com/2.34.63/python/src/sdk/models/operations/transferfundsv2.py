...
from ..shared import transferrequestv2 as shared_transferrequestv2
...
class TransferFundsV2Request:
    ...
    transfer_request_v2: shared_transferrequestv2.TransferRequestV2 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Body"""  
