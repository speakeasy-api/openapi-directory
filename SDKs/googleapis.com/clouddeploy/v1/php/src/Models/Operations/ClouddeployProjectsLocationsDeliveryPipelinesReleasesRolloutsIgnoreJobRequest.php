...
class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsIgnoreJobRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\IgnoreJobRequest $ignoreJobRequest = null;
