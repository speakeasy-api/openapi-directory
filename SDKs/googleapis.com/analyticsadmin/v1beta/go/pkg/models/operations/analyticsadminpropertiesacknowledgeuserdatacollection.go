...
type AnalyticsadminPropertiesAcknowledgeUserDataCollectionRequest struct {
	...
	Request     *shared.GoogleAnalyticsAdminV1betaAcknowledgeUserDataCollectionRequest `request:"mediaType=application/json"`
...
type AnalyticsadminPropertiesAcknowledgeUserDataCollectionResponse struct {
	ContentType                                                     string
	GoogleAnalyticsAdminV1betaAcknowledgeUserDataCollectionResponse map[string]interface{}
	StatusCode                                                      int64
}
