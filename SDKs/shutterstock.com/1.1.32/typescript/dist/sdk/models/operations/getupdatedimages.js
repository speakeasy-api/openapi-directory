...
exports.GetUpdatedImagesResponse = exports.GetUpdatedImagesRequest = exports.GetUpdatedImagesTypeEnum = exports.GetUpdatedImagesSortEnum = exports.GetUpdatedImagesSecurity = void 0;
...
var GetUpdatedImagesRequest = /** @class */ (function (_super) {
    ...
    ], GetUpdatedImagesRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=interval",
        }),
        __metadata("design:type", String)
    ], GetUpdatedImagesRequest.prototype, "interval", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetUpdatedImagesRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetUpdatedImagesRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetUpdatedImagesRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=start_date;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetUpdatedImagesRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=type" }),
        __metadata("design:type", Array)
    ], GetUpdatedImagesRequest.prototype, "type", void 0);
...
var GetUpdatedImagesResponse = /** @class */ (function (_super) {
    ...
    ], GetUpdatedImagesResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
