...
public class SearchdocumentsRequest {
    ...
    public SearchdocumentsRequest(@JsonProperty("Accept") String accept, @JsonProperty("Content-Type") String contentType, @JsonProperty("REST-Range") String restRange, @JsonProperty("acronym") String acronym) {
        this.accept = accept;
        this.contentType = contentType;
        this.restRange = restRange;
        this.acronym = acronym;
