...
exports.AdexchangebuyerMarketplacenotesInsertResponse = exports.AdexchangebuyerMarketplacenotesInsertRequest = exports.AdexchangebuyerMarketplacenotesInsertSecurity = void 0;
...
var AdexchangebuyerMarketplacenotesInsertRequest = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerMarketplacenotesInsertRequest.prototype, "addOrderNotesRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacenotesInsertRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacenotesInsertRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacenotesInsertRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacenotesInsertRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdexchangebuyerMarketplacenotesInsertRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=proposalId",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacenotesInsertRequest.prototype, "proposalId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacenotesInsertRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerMarketplacenotesInsertRequest.prototype, "userIp", void 0);
...
var AdexchangebuyerMarketplacenotesInsertResponse = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerMarketplacenotesInsertResponse.prototype, "rawResponse", void 0);
