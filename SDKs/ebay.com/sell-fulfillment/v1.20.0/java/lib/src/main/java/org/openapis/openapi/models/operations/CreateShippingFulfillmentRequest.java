...
public class CreateShippingFulfillmentRequest {
    ...
    public CreateShippingFulfillmentRequest(@JsonProperty("ShippingFulfillmentDetails") org.openapis.openapi.models.shared.ShippingFulfillmentDetails shippingFulfillmentDetails, @JsonProperty("orderId") String orderId) {
        this.shippingFulfillmentDetails = shippingFulfillmentDetails;
        this.orderId = orderId;
  }
}
