...
exports.PostPackageServiceJsonResponse = exports.PostPackageServiceJsonRequest = exports.PostPackageServiceJsonRequestBody = exports.PostPackageServiceJsonRequestBodyPackage = void 0;
...
var PostPackageServiceJsonRequest = /** @class */ (function (_super) {
    ...
    ], PostPackageServiceJsonRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=_charset_",
        }),
        __metadata("design:type", String)
    ], PostPackageServiceJsonRequest.prototype, "charset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=cmd" }),
        __metadata("design:type", String)
    ], PostPackageServiceJsonRequest.prototype, "cmd", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=force" }),
        __metadata("design:type", Boolean)
    ], PostPackageServiceJsonRequest.prototype, "force", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=groupName",
        }),
        __metadata("design:type", String)
    ], PostPackageServiceJsonRequest.prototype, "groupName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=packageName",
        }),
        __metadata("design:type", String)
    ], PostPackageServiceJsonRequest.prototype, "packageName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=packageVersion",
        }),
        __metadata("design:type", String)
    ], PostPackageServiceJsonRequest.prototype, "packageVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=path",
        }),
        __metadata("design:type", String)
    ], PostPackageServiceJsonRequest.prototype, "path", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=recursive",
        }),
        __metadata("design:type", Boolean)
    ], PostPackageServiceJsonRequest.prototype, "recursive", void 0);
...
var PostPackageServiceJsonResponse = /** @class */ (function (_super) {
    ...
    ], PostPackageServiceJsonResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", String)
