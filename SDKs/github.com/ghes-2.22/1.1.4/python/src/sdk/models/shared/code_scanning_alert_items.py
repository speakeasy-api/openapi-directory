...
class CodeScanningAlertItems:
    ...
    classification: shared_code_scanning_alert_classification_enum.CodeScanningAlertClassificationEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('classification') }})
    ...
    instance: shared_code_scanning_alert_instance.CodeScanningAlertInstance = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('instance') }})  
