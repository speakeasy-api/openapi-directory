...
import dataclasses
from ..shared import shipmentrequestbasevo as shared_shipmentrequestbasevo
...
class ShipmentDetailVO:
    ...
    locations: Optional[list[shared_shipmentrequestbasevo.ShipmentRequestBaseVO]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('locations'), 'exclude': lambda f: f is None }})  
