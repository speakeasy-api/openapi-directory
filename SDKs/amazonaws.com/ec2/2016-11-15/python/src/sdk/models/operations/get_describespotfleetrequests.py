...
class GETDescribeSpotFleetRequestsRequest:
    ...
    action: GETDescribeSpotFleetRequestsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    version: GETDescribeSpotFleetRequestsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
    ...
    spot_fleet_request_id: Optional[list[str]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'SpotFleetRequestId', 'style': 'form', 'explode': True }})
