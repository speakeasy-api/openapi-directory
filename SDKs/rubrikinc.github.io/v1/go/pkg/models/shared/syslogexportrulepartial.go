...
type SyslogExportRulePartial struct {
	...
	Facility *SyslogFacilityEnum `json:"facility,omitempty"`
	Hostname *string             `json:"hostname,omitempty"`
	Port     *int                `json:"port,omitempty"`
	// The network protocol to use, either UDP or TCP.
	Protocol *TransportLayerProtocolEnum `json:"protocol,omitempty"`
	// The syslog message severity based on RFC 5424.
	Severity *SyslogSeverityEnum `json:"severity,omitempty"`
}
