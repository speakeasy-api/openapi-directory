...
public class GoogleCloudDialogflowCxV3QueryResult {
    ...
    public GoogleCloudDialogflowCxV3QueryResult withCurrentPage(GoogleCloudDialogflowCxV3Page currentPage) {
    ...
    public GoogleCloudDialogflowCxV3QueryResult withDiagnosticInfo(java.util.Map<String, Object> diagnosticInfo) {
    ...
    public GoogleCloudDialogflowCxV3QueryResult withDtmf(GoogleCloudDialogflowCxV3DtmfInput dtmf) {
        this.dtmf = dtmf;
        return this;
    }
    ...
    public GoogleCloudDialogflowCxV3QueryResult withIntent(GoogleCloudDialogflowCxV3Intent intent) {
        this.intent = intent;
        return this;
    }
    ...
    public GoogleCloudDialogflowCxV3QueryResult withIntentDetectionConfidence(Float intentDetectionConfidence) {
    ...
    public GoogleCloudDialogflowCxV3QueryResult withLanguageCode(String languageCode) {
    ...
    public GoogleCloudDialogflowCxV3QueryResult withMatch(GoogleCloudDialogflowCxV3Match match) {
        this.match = match;
        return this;
    }
    ...
    public GoogleCloudDialogflowCxV3QueryResult withParameters(java.util.Map<String, Object> parameters) {
    ...
    public GoogleCloudDialogflowCxV3ResponseMessage[] responseMessages;

    public GoogleCloudDialogflowCxV3QueryResult withResponseMessages(GoogleCloudDialogflowCxV3ResponseMessage[] responseMessages) {
    ...
    public GoogleCloudDialogflowCxV3SentimentAnalysisResult sentimentAnalysisResult;

    public GoogleCloudDialogflowCxV3QueryResult withSentimentAnalysisResult(GoogleCloudDialogflowCxV3SentimentAnalysisResult sentimentAnalysisResult) {
    ...
    public GoogleCloudDialogflowCxV3QueryResult withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public GoogleCloudDialogflowCxV3QueryResult withTranscript(String transcript) {
    ...
    public GoogleCloudDialogflowCxV3QueryResult withTriggerEvent(String triggerEvent) {
    ...
    public GoogleCloudDialogflowCxV3QueryResult withTriggerIntent(String triggerIntent) {
    ...
    public GoogleCloudDialogflowCxV3QueryResult withWebhookPayloads(java.util.Map<String, Object>[] webhookPayloads) {
    ...
    public GoogleCloudDialogflowCxV3QueryResult withWebhookStatuses(GoogleRpcStatus[] webhookStatuses) {
