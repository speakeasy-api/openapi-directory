...
func (e ListPolicyAttachmentsXAmzConsistencyLevelEnum) ToPointer() *ListPolicyAttachmentsXAmzConsistencyLevelEnum {
	return &e
}
...
func (e *ListPolicyAttachmentsXAmzConsistencyLevelEnum) UnmarshalJSON(data []byte) error {
	...
	case "SERIALIZABLE":
		fallthrough
	case "EVENTUAL":
		*e = ListPolicyAttachmentsXAmzConsistencyLevelEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListPolicyAttachmentsXAmzConsistencyLevelEnum: %v", v)
	}
}
...
type ListPolicyAttachmentsRequest struct {
	...
	RequestBody       ListPolicyAttachmentsRequestBody `request:"mediaType=application/json"`
