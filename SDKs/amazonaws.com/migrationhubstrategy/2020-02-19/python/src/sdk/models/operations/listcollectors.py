...
from ..shared import listcollectorsresponse as shared_listcollectorsresponse
...
class ListCollectorsResponse:
    ...
    list_collectors_response: Optional[shared_listcollectorsresponse.ListCollectorsResponse] = dataclasses.field(default=None)
    r"""Success"""  
