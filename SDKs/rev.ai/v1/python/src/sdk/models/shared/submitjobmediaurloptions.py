...
class SubmitJobMediaURLOptionsCustomVocabularies:
    r"""SubmitJobMediaURLOptionsCustomVocabularies
...
class SubmitJobMediaURLOptions:
    r"""SubmitJobMediaURLOptions
    Rev.ai Job Options Object Model
    """
    
    media_url: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('media_url') }})
    ...
    custom_vocabularies: Optional[list[SubmitJobMediaURLOptionsCustomVocabularies]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('custom_vocabularies') }})
    ...
    language: Optional[SubmitJobMediaURLOptionsLanguageEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('language') }})
