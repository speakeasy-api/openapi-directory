...
export class VideoProcessingDetails extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "editorSuggestionsAvailability" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "fileDetailsAvailability" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "processingFailureReason" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "processingIssuesAvailability" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "processingProgress" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "tagSuggestionsAvailability" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "thumbnailsAvailability" })
