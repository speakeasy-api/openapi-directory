...
class Projects 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\SqlProjectsInstancesGetDiskShrinkConfigResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/getDiskShrinkConfig', \OpenAPI\OpenAPI\Models\Operations\SqlProjectsInstancesGetDiskShrinkConfigRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/performDiskShrink', \OpenAPI\OpenAPI\Models\Operations\SqlProjectsInstancesPerformDiskShrinkRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/rescheduleMaintenance', \OpenAPI\OpenAPI\Models\Operations\SqlProjectsInstancesRescheduleMaintenanceRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/resetReplicaSize', \OpenAPI\OpenAPI\Models\Operations\SqlProjectsInstancesResetReplicaSizeRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/startExternalSync', \OpenAPI\OpenAPI\Models\Operations\SqlProjectsInstancesStartExternalSyncRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/verifyExternalSyncSettings', \OpenAPI\OpenAPI\Models\Operations\SqlProjectsInstancesVerifyExternalSyncSettingsRequest::class, $request);
