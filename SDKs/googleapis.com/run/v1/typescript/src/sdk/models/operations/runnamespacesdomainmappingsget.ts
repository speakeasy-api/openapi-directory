...
export class RunNamespacesDomainmappingsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunNamespacesDomainmappingsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunNamespacesDomainmappingsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
