...
var Rules = /** @class */ (function () {
     ...
     * Display the traffic shaping settings rules for an MX network
     */
    Rules.prototype.getNetworkApplianceTrafficShapingRules = function (req, config) {
     ...
     * Display the traffic shaping settings for a SSID on an MR network
     */
    Rules.prototype.getNetworkWirelessSsidTrafficShapingRules = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update the traffic shaping settings rules for an MX network
     */
    Rules.prototype.updateNetworkApplianceTrafficShapingRules = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update the traffic shaping settings for an SSID on an MR network
     */
    Rules.prototype.updateNetworkWirelessSsidTrafficShapingRules = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
