 ...
 */
export enum RouteListWarningCodeEnum {
...
export class RouteListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class RouteListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: RouteListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class RouteList extends SpeakeasyBase {
  /**
