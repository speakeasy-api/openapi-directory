...
public class GetLegalSearchQueryParams {
    ...
    public GetLegalSearchQueryParams withAoRequestorType(GetLegalSearchAoRequestorTypeEnum[] aoRequestorType) {
    ...
    public GetLegalSearchQueryParams withCaseCitationRequireAll(Boolean caseCitationRequireAll) {
    ...
    public GetLegalSearchQueryParams withCaseDocCategoryId(GetLegalSearchCaseDocCategoryIDEnum[] caseDocCategoryId) {
    ...
    public GetLegalSearchQueryParams withCaseRegulatoryCitation(String[] caseRegulatoryCitation) {
    ...
    public GetLegalSearchQueryParams withCaseStatutoryCitation(String[] caseStatutoryCitation) {
    ...
    public String sort;
    public GetLegalSearchQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
