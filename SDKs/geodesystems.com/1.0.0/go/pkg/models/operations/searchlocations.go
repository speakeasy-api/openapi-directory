...
type SearchLocationsQueryParams struct {
	...
	// Location
	SearchDbLocationsLocation *string `queryParam:"style=form,explode=true,name=search.db_locations.location"`
	// Name
	SearchDbLocationsName *string `queryParam:"style=form,explode=true,name=search.db_locations.name"`
	// Type
	SearchDbLocationsType *string `queryParam:"style=form,explode=true,name=search.db_locations.type"`
	// Number to skip
