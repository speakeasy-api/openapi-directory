...
export declare class PublicAdvertisedPrefixes {
     ...
     */
    computePublicAdvertisedPrefixesAnnounce(req: operations.ComputePublicAdvertisedPrefixesAnnounceRequest, security: operations.ComputePublicAdvertisedPrefixesAnnounceSecurity, config?: AxiosRequestConfig): Promise<operations.ComputePublicAdvertisedPrefixesAnnounceResponse>;
    /**
     ...
     */
    computePublicAdvertisedPrefixesWithdraw(req: operations.ComputePublicAdvertisedPrefixesWithdrawRequest, security: operations.ComputePublicAdvertisedPrefixesWithdrawSecurity, config?: AxiosRequestConfig): Promise<operations.ComputePublicAdvertisedPrefixesWithdrawResponse>;
}
