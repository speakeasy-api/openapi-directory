...
public class BillingbudgetsBillingAccountsBudgetsCreateRequest {
    ...
    public openapisdk.models.shared.GoogleCloudBillingBudgetsV1beta1CreateBudgetRequestInput request;
    public BillingbudgetsBillingAccountsBudgetsCreateRequest withRequest(openapisdk.models.shared.GoogleCloudBillingBudgetsV1beta1CreateBudgetRequestInput request) {
