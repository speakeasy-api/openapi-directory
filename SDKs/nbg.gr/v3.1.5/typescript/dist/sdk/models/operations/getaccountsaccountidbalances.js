...
exports.GetAccountsAccountIdBalancesResponse = exports.GetAccountsAccountIdBalancesRequest = exports.GetAccountsAccountIdBalancesSecurity = void 0;
...
var GetAccountsAccountIdBalancesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetAccountsAccountIdBalancesRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=sandbox-id",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdBalancesRequest.prototype, "sandboxId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdBalancesRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdBalancesRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdBalancesRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdBalancesRequest.prototype, "xFapiInteractionId", void 0);
...
var GetAccountsAccountIdBalancesResponse = /** @class */ (function (_super) {
    ...
    ], GetAccountsAccountIdBalancesResponse.prototype, "rawResponse", void 0);
