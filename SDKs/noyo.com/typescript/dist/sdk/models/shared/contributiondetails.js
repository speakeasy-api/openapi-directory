...
var ContributionDetails = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=contribution_rule" }),
        __metadata("design:type", String)
    ], ContributionDetails.prototype, "contributionRule", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=contribution_rule_type" }),
        __metadata("design:type", String)
    ], ContributionDetails.prototype, "contributionRuleType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=contribution_source" }),
        __metadata("design:type", String)
    ], ContributionDetails.prototype, "contributionSource", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=contribution_target" }),
        __metadata("design:type", String)
