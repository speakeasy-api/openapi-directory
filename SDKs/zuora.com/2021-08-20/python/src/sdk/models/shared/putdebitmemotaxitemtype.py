...
class PutDebitMemoTaxItemTypeFinanceInformation:
    r"""Container for the finance information related to the taxation item in the debit memo item."""
...
class PutDebitMemoTaxItemTypeTaxRateTypeEnum(str, Enum):
...
class PutDebitMemoTaxItemType:
    ...
    r"""The ID of the taxation item in the debit memo item."""  
    amount: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('amount'), 'exclude': lambda f: f is None }})
    r"""The amount of the taxation item in the debit memo item."""  
    finance_information: Optional[PutDebitMemoTaxItemTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the taxation item in the debit memo item."""  
    ...
    tax_rate_type: Optional[PutDebitMemoTaxItemTypeTaxRateTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxRateType'), 'exclude': lambda f: f is None }})
    r"""The type of the tax rate applied to the debit memo."""  
