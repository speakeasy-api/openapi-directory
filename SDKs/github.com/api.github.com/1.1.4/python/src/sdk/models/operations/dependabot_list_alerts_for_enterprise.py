...
from ..shared import dependabot_alert_with_repository as shared_dependabot_alert_with_repository
...
class DependabotListAlertsForEnterpriseRequest:
    ...
    r"""A cursor, as given in the [Link header](https://docs.github.com/rest/overview/resources-in-the-rest-api#link-header). If specified, the query only searches for results after this cursor."""  
    before: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'before', 'style': 'form', 'explode': True }})
    r"""A cursor, as given in the [Link header](https://docs.github.com/rest/overview/resources-in-the-rest-api#link-header). If specified, the query only searches for results before this cursor."""  
...
@dataclasses.dataclass
class DependabotListAlertsForEnterpriseResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    basic_error: Optional[shared_basic_error.BasicError] = dataclasses.field(default=None)
    r"""Forbidden"""  
    dependabot_alert_with_repositories: Optional[list[shared_dependabot_alert_with_repository.DependabotAlertWithRepository]] = dataclasses.field(default=None)
    r"""Response"""  
