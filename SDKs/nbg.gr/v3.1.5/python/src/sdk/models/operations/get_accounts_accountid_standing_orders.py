...
from ..shared import obreadstandingorder6 as shared_obreadstandingorder6
...
class GetAccountsAccountIDStandingOrdersRequest:
    headers: GetAccountsAccountIDStandingOrdersHeaders = dataclasses.field()
    path_params: GetAccountsAccountIDStandingOrdersPathParams = dataclasses.field()
    security: GetAccountsAccountIDStandingOrdersSecurity = dataclasses.field()
...
class GetAccountsAccountIDStandingOrdersResponse:
    ...
    ob_read_standing_order6: Optional[shared_obreadstandingorder6.ObReadStandingOrder6] = dataclasses.field(default=None)
