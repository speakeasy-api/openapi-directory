...
from ..shared import eventtrigger as shared_eventtrigger
from ..shared import serviceconfig as shared_serviceconfig
from ..shared import googlecloudfunctionsv2statemessage as shared_googlecloudfunctionsv2statemessage
...
class Function:
    ...
    state_messages: Optional[list[shared_googlecloudfunctionsv2statemessage.GoogleCloudFunctionsV2StateMessage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('stateMessages') }})
