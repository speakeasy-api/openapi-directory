...
class GetV2CallDataRecordsJSONRequest:
    ...
    """  
    has_call: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'has_call', 'style': 'form', 'explode': True }})
    r"""Return only call data records which have or do not have a call logged for them"""  
    ids: Optional[list[int]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'ids', 'style': 'form', 'explode': False }})
    r"""IDs of call data records to fetch. If a record can't be found, that record won't be returned and your request will be successful"""  
    ...
    r"""Filters list by person_id. Multiple person ids can be applied"""  
...
@dataclasses.dataclass
class GetV2CallDataRecordsJSONResponse:
