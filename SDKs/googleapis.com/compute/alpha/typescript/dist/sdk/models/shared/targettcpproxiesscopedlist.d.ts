 ...
 */
export declare enum TargetTcpProxiesScopedListWarningCodeEnum {
...
export declare class TargetTcpProxiesScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetTcpProxiesScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class TargetTcpProxiesScopedList extends SpeakeasyBase {
    /**
