...
public class Adexchangebuyer2AccountsCreativesDealAssociationsRemoveRequest {
    ...
    public Adexchangebuyer2AccountsCreativesDealAssociationsRemoveRequest(@JsonProperty("accountId") String accountId, @JsonProperty("creativeId") String creativeId) {
        this.accountId = accountId;
        this.creativeId = creativeId;
  }
}
