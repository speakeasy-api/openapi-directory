...
public class GetSpacesSpaceIdEmployersAllQueryParams {
    /**
     * EmployeeNumber of the employer contract
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=EmployeeNumber")
    public String employeeNumber;
    public GetSpacesSpaceIdEmployersAllQueryParams withEmployeeNumber(String employeeNumber) {
    ...
    public GetSpacesSpaceIdEmployersAllQueryParams withWithContractingPartner(String withContractingPartner) {
