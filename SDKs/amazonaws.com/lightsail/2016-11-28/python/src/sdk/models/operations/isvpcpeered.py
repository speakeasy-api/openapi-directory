...
from ..shared import isvpcpeeredresult as shared_isvpcpeeredresult
...
class IsVpcPeeredHeaders:
    x_amz_target: IsVpcPeeredXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class IsVpcPeeredRequest:
    headers: IsVpcPeeredHeaders = dataclasses.field()
...
class IsVpcPeeredResponse:
    ...
    is_vpc_peered_result: Optional[shared_isvpcpeeredresult.IsVpcPeeredResult] = dataclasses.field(default=None)
