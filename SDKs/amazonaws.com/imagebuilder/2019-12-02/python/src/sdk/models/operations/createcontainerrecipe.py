...
class CreateContainerRecipeRequestBodyTargetRepository:
    ...
    service: Optional[shared_containerrepositoryservice_enum.ContainerRepositoryServiceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('service') }})
...
class CreateContainerRecipeRequestBody:
    ...
    container_type: CreateContainerRecipeRequestBodyContainerTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('containerType') }})
    ...
    target_repository: CreateContainerRecipeRequestBodyTargetRepository = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('targetRepository') }})
    ...
    dockerfile_template_uri: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dockerfileTemplateUri') }})
    image_os_version_override: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('imageOsVersionOverride') }})
    instance_configuration: Optional[CreateContainerRecipeRequestBodyInstanceConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('instanceConfiguration') }})
    kms_key_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('kmsKeyId') }})
    platform_override: Optional[CreateContainerRecipeRequestBodyPlatformOverrideEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('platformOverride') }})
...
class CreateContainerRecipeRequest:
    headers: CreateContainerRecipeHeaders = dataclasses.field()
    request: CreateContainerRecipeRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
