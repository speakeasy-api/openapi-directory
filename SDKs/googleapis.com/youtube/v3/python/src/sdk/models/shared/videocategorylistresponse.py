...
from ..shared import videocategory as shared_videocategory
...
class VideoCategoryListResponse:
    ...
    items: Optional[list[shared_videocategory.VideoCategory]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
