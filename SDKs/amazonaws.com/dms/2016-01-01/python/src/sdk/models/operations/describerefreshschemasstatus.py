...
class DescribeRefreshSchemasStatusRequest:
    ...
    describe_refresh_schemas_status_message: shared_describerefreshschemasstatusmessage.DescribeRefreshSchemasStatusMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
