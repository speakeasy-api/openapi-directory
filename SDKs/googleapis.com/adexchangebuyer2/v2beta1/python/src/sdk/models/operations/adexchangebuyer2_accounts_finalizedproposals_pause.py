...
class Adexchangebuyer2AccountsFinalizedProposalsPauseRequest:
    ...
    pause_proposal_deals_request: Optional[shared_pauseproposaldealsrequest.PauseProposalDealsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
