...
try {
    ...
    $request->analysisId = 509342;
    $request->confirmDelete = 'quisquam';
...
try {
    ...
    $request->alertNumber = 373813;
    $request->owner = 'ab';
    $request->page = 587600;
    $request->perPage = 9688;
    $request->ref = 'tempora';
...
try {
    ...
    $request->toolGuid = 'quod';
    $request->toolName = 'dignissimos';
...
try {
    ...
    $request->toolGuid = 'odio';
    $request->toolName = 'occaecati';
...
try {
    ...
    $request->requestBody->commitSha = 'accusantium';
    $request->requestBody->ref = 'porro';
    $request->requestBody->sarif = 'eum';
    $request->requestBody->startedAt = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-12-24T16:30:16.544Z');
    $request->requestBody->toolName = 'consequuntur';
