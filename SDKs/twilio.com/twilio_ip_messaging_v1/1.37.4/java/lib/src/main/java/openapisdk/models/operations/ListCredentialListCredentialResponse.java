...
public class ListCredentialListCredentialResponse {
    ...
    public openapisdk.models.shared.IpMessagingV1Credential[] credentials;
    public ListCredentialListCredentialResponse withCredentials(openapisdk.models.shared.IpMessagingV1Credential[] credentials) {
