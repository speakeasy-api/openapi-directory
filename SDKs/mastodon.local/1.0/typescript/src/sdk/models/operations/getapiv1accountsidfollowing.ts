...
export class GetApiV1AccountsIdFollowingSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetApiV1AccountsIdFollowingRequest extends SpeakeasyBase {
  /**
...
export class GetApiV1AccountsIdFollowingResponse extends SpeakeasyBase {
  /**
   * Success
   */
