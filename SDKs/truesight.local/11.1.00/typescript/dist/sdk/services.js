...
var Services = /** @class */ (function () {
    ...
    **/
    Services.prototype.getOneService = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetOneServiceRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/hardware/services/{serviceId}", req.pathParams);
    ...
    **/
    Services.prototype.getServices = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetServicesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/hardware/services";
        var client = this._defaultClient;
