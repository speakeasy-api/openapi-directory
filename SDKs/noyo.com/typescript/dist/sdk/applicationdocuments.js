...
var ApplicationDocuments = /** @class */ (function () {
    ...
    **/
    ApplicationDocuments.prototype.createApplicationDocument = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/api/v1/applications/{application_id}/documents", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.applicationDocumentResult = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    ApplicationDocuments.prototype.editApplicationDocument = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/v1/applications/{application_id}/documents/{document_id}/{version}", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    ApplicationDocuments.prototype.getApplicationDocument = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/v1/applications/{application_id}/documents/{document_id}", req.pathParams);
        var client = this._defaultClient;
    ...
    ApplicationDocuments.prototype.getApplicationDocuments = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.paginatedApplicationDocumentResult = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
