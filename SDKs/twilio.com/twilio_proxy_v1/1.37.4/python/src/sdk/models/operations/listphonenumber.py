...
class ListPhoneNumberListPhoneNumberResponse:
    ...
    phone_numbers: Optional[list[shared_proxy_v1_service_phone_number.ProxyV1ServicePhoneNumber]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('phone_numbers') }})
