...
type DisplayvideoAdvertisersNegativeKeywordListsNegativeKeywordsReplaceSecurity struct {
...
type DisplayvideoAdvertisersNegativeKeywordListsNegativeKeywordsReplaceRequest struct {
	...
	ReplaceNegativeKeywordsRequestInput *shared.ReplaceNegativeKeywordsRequestInput `request:"mediaType=application/json"`
	// OAuth access token.
...
type DisplayvideoAdvertisersNegativeKeywordListsNegativeKeywordsReplaceResponse struct {
	ContentType string
	// Successful response
