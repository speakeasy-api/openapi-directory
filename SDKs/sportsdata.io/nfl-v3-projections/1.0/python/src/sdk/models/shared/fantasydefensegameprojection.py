...
class FantasyDefenseGameProjection:
    ...
    fantasy_defense_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FantasyDefenseID'), 'exclude': lambda f: f is None }})  
