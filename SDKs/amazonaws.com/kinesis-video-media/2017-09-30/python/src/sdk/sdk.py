...
SERVERS = [
    ...
    r"""The Kinesis Video Media multi-region endpoint"""
    "https://kinesisvideo.{region}.amazonaws.com",
    r"""The Kinesis Video Media multi-region endpoint"""
    "http://kinesisvideo.{region}.amazonaws.com.cn",
    r"""The Kinesis Video Media endpoint for China (Beijing) and China (Ningxia)"""
    ...
    def get_media(self, request: operations.GetMediaRequest) -> operations.GetMediaResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetMediaOutput])
