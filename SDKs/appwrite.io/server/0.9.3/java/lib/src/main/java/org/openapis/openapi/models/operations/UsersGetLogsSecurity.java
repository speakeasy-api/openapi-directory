...
public class UsersGetLogsSecurity {
    ...
    public UsersGetLogsSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public UsersGetLogsSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public UsersGetLogsSecurity(@JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.key = key;
        this.project = project;
  }
}
