...
class Metadata 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteArtifactVersionMetaDataResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/versions/{version}/meta', \OpenAPI\OpenAPI\Models\Operations\DeleteArtifactVersionMetaDataRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/meta', \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataRequest::class, $request);
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataByContentRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataByContentResponse
     */
	public function getArtifactMetaDataByContent(
        \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataByContentRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataByContentResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/meta', \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataByContentRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataByContentResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataByGlobalIdRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataByGlobalIdResponse
     */
	public function getArtifactMetaDataByGlobalId(
        \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataByGlobalIdRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataByGlobalIdResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ids/{globalId}/meta', \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataByGlobalIdRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetArtifactMetaDataByGlobalIdResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/versions/{version}/meta', \OpenAPI\OpenAPI\Models\Operations\GetArtifactVersionMetaDataRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/meta', \OpenAPI\OpenAPI\Models\Operations\UpdateArtifactMetaDataRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/versions/{version}/meta', \OpenAPI\OpenAPI\Models\Operations\UpdateArtifactVersionMetaDataRequest::class, $request);
