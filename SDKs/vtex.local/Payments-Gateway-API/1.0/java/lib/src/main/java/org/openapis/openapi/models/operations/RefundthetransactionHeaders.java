...
public class RefundthetransactionHeaders {
    /**
    ...
    public RefundthetransactionHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public RefundthetransactionHeaders withContentType(String contentType) {
    ...
    public RefundthetransactionHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public RefundthetransactionHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
