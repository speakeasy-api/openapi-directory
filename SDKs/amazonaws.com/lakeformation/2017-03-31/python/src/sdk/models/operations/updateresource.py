...
class UpdateResourceRequestBody:
    ...
    r"""The new role to use for the given resource registered in Lake Formation."""  
    

@dataclasses.dataclass
class UpdateResourceRequest:
    
    request_body: UpdateResourceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
