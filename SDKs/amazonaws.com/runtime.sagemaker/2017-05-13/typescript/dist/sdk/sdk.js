...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.invokeEndpoint = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/endpoints/{EndpointName}/invocations", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.InvokeEndpointResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.invokeEndpointOutput = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.InvokeEndpointOutput);
                    }
                    break;
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 484:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.internalDependencyException = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 485:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.modelNotReadyException = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.invokeEndpointAsync = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/endpoints/{EndpointName}/async-invocations#X-Amzn-SageMaker-InputLocation", req);
        var client = this._securityClient || this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.InvokeEndpointAsyncResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 202:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.invokeEndpointAsyncOutput = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.InvokeEndpointAsyncOutput);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 480:
                    if (utils.matchContentType(contentType, "application/json")) {
