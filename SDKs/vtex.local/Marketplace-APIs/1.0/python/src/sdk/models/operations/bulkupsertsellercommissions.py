...
from ..shared import bulkupsertsellercommissionsrequest as shared_bulkupsertsellercommissionsrequest
...
class BulkUpsertSellerCommissionsRequest:
    ...
    request_body: list[shared_bulkupsertsellercommissionsrequest.BulkUpsertSellerCommissionsRequest] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class BulkUpsertSellerCommissionsResponse:
