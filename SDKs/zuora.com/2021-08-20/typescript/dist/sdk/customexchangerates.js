...
var CustomExchangeRates = /** @class */ (function () {
    ...
    CustomExchangeRates.prototype.getCustomExchangeRates = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/custom-exchange-rates/{currency}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GETCustomExchangeRatesResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.getCustomExchangeRatesType = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GETCustomExchangeRatesType);
                    }
                    break;
            }
            return res;
