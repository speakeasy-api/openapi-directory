...
class PatchRemoteServersIDRequestBody:
    ...
    one_drive_account_type: Optional[PatchRemoteServersIDRequestBodyOneDriveAccountTypeEnum] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'one_drive_account_type' }})
    ...
    server_certificate: Optional[PatchRemoteServersIDRequestBodyServerCertificateEnum] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'server_certificate' }})
    server_host_key: Optional[str] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'server_host_key' }})
    server_type: Optional[PatchRemoteServersIDRequestBodyServerTypeEnum] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'server_type' }})
    ssl: Optional[PatchRemoteServersIDRequestBodySslEnum] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'ssl' }})
...
class PatchRemoteServersIDRequest:
    path_params: PatchRemoteServersIDPathParams = dataclasses.field()
    request: Optional[PatchRemoteServersIDRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})
