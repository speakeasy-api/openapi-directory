 ...
 */
export class RegistrationsProvidersListFileAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsProvidersListFileLinks extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsProvidersListFileRelationships extends SpeakeasyBase {
  /**
...
export class RegistrationsProvidersListFile extends SpeakeasyBase {
  /**
   * The properties of the file entity.
   */
  @SpeakeasyMetadata()
