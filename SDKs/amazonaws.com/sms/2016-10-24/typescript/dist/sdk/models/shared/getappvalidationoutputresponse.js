...
var GetAppValidationOutputResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: validationoutput_1.ValidationOutput }),
        (0, class_transformer_1.Expose)({ name: "validationOutputList" }),
        (0, class_transformer_1.Type)(function () { return validationoutput_1.ValidationOutput; }),
