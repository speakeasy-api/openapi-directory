...
class TopicRuleDestination:
    r"""A topic rule destination."""
    
    arn: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('arn'), 'exclude': lambda f: f is None }})  
    created_at: Optional[datetime] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('createdAt'), 'encoder': utils.datetimeisoformat(True), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso'), 'exclude': lambda f: f is None }})  
    http_url_properties: Optional[shared_httpurldestinationproperties.HTTPURLDestinationProperties] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('httpUrlProperties'), 'exclude': lambda f: f is None }})  
    ...
    vpc_properties: Optional[shared_vpcdestinationproperties.VpcDestinationProperties] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('vpcProperties'), 'exclude': lambda f: f is None }})  
