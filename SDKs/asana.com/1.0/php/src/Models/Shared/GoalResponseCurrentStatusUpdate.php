...
class GoalResponseCurrentStatusUpdate
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GoalResponseCurrentStatusUpdateResourceSubtypeEnum $resourceSubtype
     */
	#[\JMS\Serializer\Annotation\SerializedName('resource_subtype')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GoalResponseCurrentStatusUpdateResourceSubtypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GoalResponseCurrentStatusUpdateResourceSubtypeEnum $resourceSubtype = null;
