...
func (e *UpdateNetworkWirelessAlternateManagementInterfaceRequestBodyProtocolsEnum) UnmarshalJSON(data []byte) error {
	...
	case "snmp":
		fallthrough
	case "syslog":
		*e = UpdateNetworkWirelessAlternateManagementInterfaceRequestBodyProtocolsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessAlternateManagementInterfaceRequestBodyProtocolsEnum: %s", s)
	}
}
