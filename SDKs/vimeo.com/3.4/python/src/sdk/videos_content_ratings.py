...
class VideosContentRatings:
    ...
    def get_content_ratings(self) -> operations.GetContentRatingsResponse:
        ...
        res = operations.GetContentRatingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/vnd.vimeo.contentrating+json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.ContentRating]])
