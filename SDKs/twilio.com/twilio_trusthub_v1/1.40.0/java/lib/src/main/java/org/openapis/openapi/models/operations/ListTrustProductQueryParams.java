...
public class ListTrustProductQueryParams {
    ...
    public Long page;
    public ListTrustProductQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListTrustProductQueryParams withPageToken(String pageToken) {
    ...
    public ListTrustProductQueryParams withStatus(org.openapis.openapi.models.shared.TrustProductEnumStatusEnum status) {
        this.status = status;
        return this;
    }
