...
class PostGetNotificationConfigurationListRequest:
    security: PostGetNotificationConfigurationListSecurity = dataclasses.field()
...
class PostGetNotificationConfigurationListResponse:
    ...
    get_notification_configuration_list_response: Optional[Any] = dataclasses.field(default=None)
