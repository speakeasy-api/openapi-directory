...
export class OrganizationDeleteAvatarSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class OrganizationDeleteAvatarRequest extends SpeakeasyBase {
  /**
...
export enum OrganizationDeleteAvatarDefaultApplicationJSONErrorCodeEnum {
...
export class OrganizationDeleteAvatarDefaultApplicationJSONError extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
 ...
 * Error
 */
export class OrganizationDeleteAvatarDefaultApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => OrganizationDeleteAvatarDefaultApplicationJSONError)
 ...
 */
export enum OrganizationDeleteAvatar200ApplicationJSONOriginEnum {
  Appcenter = "appcenter",
  Hockeyapp = "hockeyapp",
}
 ...
 * Success
 */
export class OrganizationDeleteAvatar200ApplicationJSON extends SpeakeasyBase {
  /**
...
export class OrganizationDeleteAvatarResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
