...
class GamesPlayersGetQueryParams:
    ...
    player_id_consistency_token: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'playerIdConsistencyToken', 'style': 'form', 'explode': True }})
...
class GamesPlayersGetRequest:
    path_params: GamesPlayersGetPathParams = dataclasses.field()
    query_params: GamesPlayersGetQueryParams = dataclasses.field()
    security: GamesPlayersGetSecurity = dataclasses.field()
