...
exports.InvoiceApiUriResponse = exports.InvoiceApiUriRequest = void 0;
...
var InvoiceApiUriRequest = /** @class */ (function (_super) {
    ...
    ], InvoiceApiUriRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-key",
        }),
        __metadata("design:type", String)
    ], InvoiceApiUriRequest.prototype, "xAuthKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-secret",
        }),
        __metadata("design:type", String)
    ], InvoiceApiUriRequest.prototype, "xAuthSecret", void 0);
    return InvoiceApiUriRequest;
}(utils_1.SpeakeasyBase));
exports.InvoiceApiUriRequest = InvoiceApiUriRequest;
var InvoiceApiUriResponse = /** @class */ (function (_super) {
    ...
    ], InvoiceApiUriResponse.prototype, "rawResponse", void 0);
    return InvoiceApiUriResponse;
}(utils_1.SpeakeasyBase));
exports.InvoiceApiUriResponse = InvoiceApiUriResponse;
