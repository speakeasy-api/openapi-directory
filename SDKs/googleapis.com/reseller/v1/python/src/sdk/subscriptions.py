...
class Subscriptions:
    ...
    def reseller_subscriptions_activate(self, request: operations.ResellerSubscriptionsActivateRequest) -> operations.ResellerSubscriptionsActivateResponse:
        r"""Activates a subscription previously suspended by the reseller. If you did not suspend the customer subscription and it is suspended for any other reason, such as for abuse or a pending ToS acceptance, this call will not reactivate the customer subscription.
        """
    ...
    def reseller_subscriptions_change_plan(self, request: operations.ResellerSubscriptionsChangePlanRequest) -> operations.ResellerSubscriptionsChangePlanResponse:
        r"""Updates a subscription plan. Use this method to update a plan for a 30-day trial or a flexible plan subscription to an annual commitment plan with monthly or yearly payments. How a plan is updated differs depending on the plan and the products. For more information, see the description in [manage subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions#update_subscription_plan).
        """
    ...
    def reseller_subscriptions_change_renewal_settings(self, request: operations.ResellerSubscriptionsChangeRenewalSettingsRequest) -> operations.ResellerSubscriptionsChangeRenewalSettingsResponse:
        r"""Updates a user license's renewal settings. This is applicable for accounts with annual commitment plans only. For more information, see the description in [manage subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions#update_renewal).
        """
    ...
    def reseller_subscriptions_change_seats(self, request: operations.ResellerSubscriptionsChangeSeatsRequest) -> operations.ResellerSubscriptionsChangeSeatsResponse:
        r"""Updates a subscription's user license settings. For more information about updating an annual commitment plan or a flexible plan subscription’s licenses, see [Manage Subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions#update_subscription_seat).
        """
    ...
    def reseller_subscriptions_delete(self, request: operations.ResellerSubscriptionsDeleteRequest) -> operations.ResellerSubscriptionsDeleteResponse:
        r"""Cancels, suspends, or transfers a subscription to direct.
        """
    ...
    def reseller_subscriptions_get(self, request: operations.ResellerSubscriptionsGetRequest) -> operations.ResellerSubscriptionsGetResponse:
        r"""Gets a specific subscription. The `subscriptionId` can be found using the [Retrieve all reseller subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions#get_all_subscriptions) method. For more information about retrieving a specific subscription, see the information descrived in [manage subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions#get_subscription).
        """
    ...
    def reseller_subscriptions_list(self, request: operations.ResellerSubscriptionsListRequest) -> operations.ResellerSubscriptionsListResponse:
        r"""Lists of subscriptions managed by the reseller. The list can be all subscriptions, all of a customer's subscriptions, or all of a customer's transferable subscriptions. Optionally, this method can filter the response by a `customerNamePrefix`. For more information, see [manage subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions).
        """
    ...
    def reseller_subscriptions_start_paid_service(self, request: operations.ResellerSubscriptionsStartPaidServiceRequest) -> operations.ResellerSubscriptionsStartPaidServiceResponse:
        r"""Immediately move a 30-day free trial subscription to a paid service subscription. This method is only applicable if a payment plan has already been set up for the 30-day trial subscription. For more information, see [manage subscriptions](/admin-sdk/reseller/v1/how-tos/manage_subscriptions#paid_service).
        """
