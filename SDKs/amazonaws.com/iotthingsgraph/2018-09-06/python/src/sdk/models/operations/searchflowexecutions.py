...
class SearchFlowExecutionsRequest:
    ...
    search_flow_executions_request: shared_searchflowexecutionsrequest.SearchFlowExecutionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
