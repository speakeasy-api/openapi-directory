...
class VersionMetaData:
    ...
    state: Optional[shared_artifactstate_enum.ArtifactStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
