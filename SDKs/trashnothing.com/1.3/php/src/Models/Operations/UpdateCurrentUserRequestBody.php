...
class UpdateCurrentUserRequestBody
{
     ...
     * 
     * @var ?int $emailSearchAlerts
     */
	#[SpeakeasyMetadata('multipartForm:name=email_search_alerts')]
    public ?int $emailSearchAlerts = null;
     ...
     */
	#[SpeakeasyMetadata('multipartForm:name=last_listings_view,dateTimeFormat=Y-m-d\TH:i:s.up')]
     ...
     * 
     * 
     * @var ?int $notifyAboutReposts
     */
	#[SpeakeasyMetadata('multipartForm:name=notify_about_reposts')]
    public ?int $notifyAboutReposts = null;
     ...
     * 
     * 
     * @var ?string $publicPostSources
     */
	#[SpeakeasyMetadata('multipartForm:name=public_post_sources')]
    public ?string $publicPostSources = null;
     ...
     * 
     * 
     * @var ?int $showAllGroupPosts
     */
	#[SpeakeasyMetadata('multipartForm:name=show_all_group_posts')]
    public ?int $showAllGroupPosts = null;
     ...
     * 
     * 
     * @var ?int $specialNotices
     */
	#[SpeakeasyMetadata('multipartForm:name=special_notices')]
    public ?int $specialNotices = null;
