...
exports.LedgerAccountsOneResponse = exports.LedgerAccountsOneRequest = exports.LedgerAccountsOneSecurity = void 0;
...
exports.LedgerAccountsOneSecurity = LedgerAccountsOneSecurity;
var LedgerAccountsOneRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], LedgerAccountsOneRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], LedgerAccountsOneRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], LedgerAccountsOneRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], LedgerAccountsOneRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], LedgerAccountsOneRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], LedgerAccountsOneRequest.prototype, "xApideckServiceId", void 0);
    return LedgerAccountsOneRequest;
}(utils_1.SpeakeasyBase));
exports.LedgerAccountsOneRequest = LedgerAccountsOneRequest;
var LedgerAccountsOneResponse = /** @class */ (function (_super) {
    ...
    ], LedgerAccountsOneResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.LedgerAccountsOneResponse = LedgerAccountsOneResponse;
