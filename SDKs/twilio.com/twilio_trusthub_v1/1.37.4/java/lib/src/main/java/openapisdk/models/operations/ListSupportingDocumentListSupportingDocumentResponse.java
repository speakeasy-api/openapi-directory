...
public class ListSupportingDocumentListSupportingDocumentResponse {
    ...
    public openapisdk.models.shared.TrusthubV1SupportingDocument[] results;
    public ListSupportingDocumentListSupportingDocumentResponse withResults(openapisdk.models.shared.TrusthubV1SupportingDocument[] results) {
