...
class Campaign 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CloneCampaignRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\CloneCampaignSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\CloneCampaignResponse
     */
	public function cloneCampaign(
        \OpenAPI\OpenAPI\Models\Operations\CloneCampaignRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\CloneCampaignSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\CloneCampaignResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign/{campaign_id}/clone', \OpenAPI\OpenAPI\Models\Operations\CloneCampaignRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "cloneCampaignRequest", "json");
        if ($body === null) {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CloneCampaignResponse();
        ...
        if ($httpResponse->getStatusCode() === 201) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->cloneCampaign201ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
     ...
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateCampaignSecurity $security
	...
	public function createCampaign(
        ...
        \OpenAPI\OpenAPI\Models\Operations\CreateCampaignSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateCampaignResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign');
        ...
        if ($httpResponse->getStatusCode() === 201) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createCampaign201ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
     ...
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteCampaignSecurity $security
	...
	public function deleteCampaign(
        ...
        \OpenAPI\OpenAPI\Models\Operations\DeleteCampaignSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteCampaignResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign/{campaign_id}', \OpenAPI\OpenAPI\Models\Operations\DeleteCampaignRequest::class, $request);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\EndCampaignRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\EndCampaignSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\EndCampaignResponse
     */
	public function endCampaign(
        \OpenAPI\OpenAPI\Models\Operations\EndCampaignRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\EndCampaignSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\EndCampaignResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign/{campaign_id}/end', \OpenAPI\OpenAPI\Models\Operations\EndCampaignRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\EndCampaignResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\FindCampaignByAdReferenceRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\FindCampaignByAdReferenceSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\FindCampaignByAdReferenceResponse
     */
	public function findCampaignByAdReference(
        \OpenAPI\OpenAPI\Models\Operations\FindCampaignByAdReferenceRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\FindCampaignByAdReferenceSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\FindCampaignByAdReferenceResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign/find_campaign_by_ad_reference');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\FindCampaignByAdReferenceRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\FindCampaignByAdReferenceResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->campaigns = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\Campaigns', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 400 or $httpResponse->getStatusCode() === 404 or $httpResponse->getStatusCode() === 409 or $httpResponse->getStatusCode() === 500) {
        }
     ...
     * @param \OpenAPI\OpenAPI\Models\Operations\GetCampaignSecurity $security
	...
	public function getCampaign(
        ...
        \OpenAPI\OpenAPI\Models\Operations\GetCampaignSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\GetCampaignResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign/{campaign_id}', \OpenAPI\OpenAPI\Models\Operations\GetCampaignRequest::class, $request);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetCampaignByNameRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\GetCampaignByNameSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\GetCampaignByNameResponse
     */
	public function getCampaignByName(
        \OpenAPI\OpenAPI\Models\Operations\GetCampaignByNameRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\GetCampaignByNameSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\GetCampaignByNameResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign/get_campaign_by_name');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\GetCampaignByNameRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetCampaignByNameResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * @param \OpenAPI\OpenAPI\Models\Operations\GetCampaignsSecurity $security
	...
	public function getCampaigns(
        ...
        \OpenAPI\OpenAPI\Models\Operations\GetCampaignsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\GetCampaignsResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->campaignPagedCollectionResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CampaignPagedCollectionResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 400 or $httpResponse->getStatusCode() === 409 or $httpResponse->getStatusCode() === 500) {
        }
     ...
     * @param \OpenAPI\OpenAPI\Models\Operations\PauseCampaignSecurity $security
	...
	public function pauseCampaign(
        ...
        \OpenAPI\OpenAPI\Models\Operations\PauseCampaignSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\PauseCampaignResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign/{campaign_id}/pause', \OpenAPI\OpenAPI\Models\Operations\PauseCampaignRequest::class, $request);
     ...
     * @param \OpenAPI\OpenAPI\Models\Operations\ResumeCampaignSecurity $security
	...
	public function resumeCampaign(
        ...
        \OpenAPI\OpenAPI\Models\Operations\ResumeCampaignSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ResumeCampaignResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign/{campaign_id}/resume', \OpenAPI\OpenAPI\Models\Operations\ResumeCampaignRequest::class, $request);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\SuggestItemsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\SuggestItemsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\SuggestItemsResponse
     */
	public function suggestItems(
        \OpenAPI\OpenAPI\Models\Operations\SuggestItemsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\SuggestItemsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\SuggestItemsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign/{campaign_id}/suggest_items', \OpenAPI\OpenAPI\Models\Operations\SuggestItemsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\SuggestItemsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\SuggestItemsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->targetedAdsPagedCollection = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\TargetedAdsPagedCollection', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 400 or $httpResponse->getStatusCode() === 404 or $httpResponse->getStatusCode() === 409 or $httpResponse->getStatusCode() === 500) {
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateAdRateStrategyRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateAdRateStrategySecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateAdRateStrategyResponse
     */
	public function updateAdRateStrategy(
        \OpenAPI\OpenAPI\Models\Operations\UpdateAdRateStrategyRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\UpdateAdRateStrategySecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateAdRateStrategyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign/{campaign_id}/update_ad_rate_strategy', \OpenAPI\OpenAPI\Models\Operations\UpdateAdRateStrategyRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateAdrateStrategyRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateAdRateStrategyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignBudgetRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignBudgetSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignBudgetResponse
     */
	public function updateCampaignBudget(
        \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignBudgetRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignBudgetSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignBudgetResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign/{campaign_id}/update_campaign_budget', \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignBudgetRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateCampaignBudgetRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignBudgetResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignIdentificationRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignIdentificationSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignIdentificationResponse
     */
	public function updateCampaignIdentification(
        \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignIdentificationRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignIdentificationSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignIdentificationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/ad_campaign/{campaign_id}/update_campaign_identification', \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignIdentificationRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateCampaignIdentificationRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignIdentificationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
