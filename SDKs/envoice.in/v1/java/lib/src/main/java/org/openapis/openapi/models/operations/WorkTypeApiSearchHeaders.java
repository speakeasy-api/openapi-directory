...
public class WorkTypeApiSearchHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public WorkTypeApiSearchHeaders withXAuthKey(String xAuthKey) {
    ...
    public WorkTypeApiSearchHeaders withXAuthSecret(String xAuthSecret) {
