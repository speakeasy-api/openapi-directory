...
type PostPortfolioOptimizationMinimumUlcerIndexRequestBodyAssets struct {
	// assetPrices[t] is the price of the asset at the time t
	AssetPrices []float64 `json:"assetPrices"`
}

type PostPortfolioOptimizationMinimumUlcerIndexRequestBodyConstraints struct {
...
type PostPortfolioOptimizationMinimumUlcerIndexRequestBody struct {
	Assets      []PostPortfolioOptimizationMinimumUlcerIndexRequestBodyAssets     `json:"assets"`
...
type PostPortfolioOptimizationMinimumUlcerIndexResponse struct {
	ContentType string
	StatusCode  int
