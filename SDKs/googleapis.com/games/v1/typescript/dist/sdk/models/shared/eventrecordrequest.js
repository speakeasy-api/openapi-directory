...
var EventRecordRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "currentTimeMillis" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: eventperiodupdate_1.EventPeriodUpdate }),
        (0, class_transformer_1.Expose)({ name: "timePeriods" }),
        (0, class_transformer_1.Type)(function () { return eventperiodupdate_1.EventPeriodUpdate; }),
