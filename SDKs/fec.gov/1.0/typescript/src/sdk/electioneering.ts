...
export class Electioneering {
  ...
  getElectioneering(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetElectioneeringResponse =
        new operations.GetElectioneeringResponse({
      ...
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.electioneeringPage = utils.objectToClass(
              httpRes?.data,
              shared.ElectioneeringPage
            );
          }
          break;
      }
  ...
  getElectioneeringAggregates(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/electioneering/aggregates/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetElectioneeringAggregatesResponse =
        new operations.GetElectioneeringAggregatesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.electioneeringByCandidatePage = utils.objectToClass(
              httpRes?.data,
              shared.ElectioneeringByCandidatePage
            );
          }
          break;
      }
  ...
  getElectioneeringByCandidate(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/electioneering/by_candidate/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetElectioneeringByCandidateResponse =
        new operations.GetElectioneeringByCandidateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getElectioneeringTotalsByCandidate(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/electioneering/totals/by_candidate/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetElectioneeringTotalsByCandidateResponse =
        new operations.GetElectioneeringTotalsByCandidateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ecTotalsByCandidatePage = utils.objectToClass(
              httpRes?.data,
              shared.ECTotalsByCandidatePage
            );
          }
          break;
      }
