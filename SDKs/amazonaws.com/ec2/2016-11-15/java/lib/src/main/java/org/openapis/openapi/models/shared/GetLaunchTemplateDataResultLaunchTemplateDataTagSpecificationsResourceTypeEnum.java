 ...
 */
public enum GetLaunchTemplateDataResultLaunchTemplateDataTagSpecificationsResourceTypeEnum {
    ...
    private GetLaunchTemplateDataResultLaunchTemplateDataTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
