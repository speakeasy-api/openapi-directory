...
public class DeleteCustomActionTypeResponse {
    ...
    public DeleteCustomActionTypeResponse withStatusCode(Integer statusCode) {
    ...
    public DeleteCustomActionTypeResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public DeleteCustomActionTypeResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
