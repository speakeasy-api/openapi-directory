...
from ..shared import invoiceupdateattachmentapimodel as shared_invoiceupdateattachmentapimodel
from ..shared import invoiceupdateitemapimodel as shared_invoiceupdateitemapimodel
...
class InvoiceUpdateAPIModel:
    ...
    attachments: Optional[list[shared_invoiceupdateattachmentapimodel.InvoiceUpdateAttachmentAPIModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Attachments'), 'exclude': lambda f: f is None }, 'form': { 'field_name': 'Attachments', 'json': True }})
    ...
    items: Optional[list[shared_invoiceupdateitemapimodel.InvoiceUpdateItemAPIModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Items'), 'exclude': lambda f: f is None }, 'form': { 'field_name': 'Items', 'json': True }})
    ...
    status: Optional[InvoiceUpdateAPIModelStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Status'), 'exclude': lambda f: f is None }, 'form': { 'field_name': 'Status' }})
    r"""Indicate the status of the invoice (paid/unpaid/overdue)"""  
