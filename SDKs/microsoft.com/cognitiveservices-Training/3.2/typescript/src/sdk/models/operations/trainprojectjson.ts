 ...
 */
export enum TrainProjectJsonTrainingTypeEnum {
  Regular = "Regular",
  Advanced = "Advanced",
}

export class TrainProjectJsonRequest extends SpeakeasyBase {
  /**
...
export class TrainProjectJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
