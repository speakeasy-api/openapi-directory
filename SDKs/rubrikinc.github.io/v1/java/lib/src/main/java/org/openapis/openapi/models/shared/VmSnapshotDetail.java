...
/**
 * VmSnapshotDetail - Snapshot details.
 */
public class VmSnapshotDetail {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("archivalLocationIds")
    public String[] archivalLocationIds;

    public VmSnapshotDetail withArchivalLocationIds(String[] archivalLocationIds) {
    ...
    public VmSnapshotDetail withCloudState(Long cloudState) {
    ...
    public VmSnapshotDetail withCloudStorageTier(SnapshotCloudStorageTierEnum cloudStorageTier) {
    ...
    public VmSnapshotDetail withConfig(String config) {
        this.config = config;
        return this;
    }
    ...
    public VmSnapshotDetail withConsistencyLevel(String consistencyLevel) {
    ...
    public VmSnapshotDetail withDate(OffsetDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public VmSnapshotDetail withExpirationDate(OffsetDateTime expirationDate) {
    ...
    public VmSnapshotDetail withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public VmSnapshotDetail withIndexState(Long indexState) {
    ...
    public VmSnapshotDetail withIsCorrupt(Boolean isCorrupt) {
    ...
    public VmSnapshotDetail withIsCustomRetentionApplied(Boolean isCustomRetentionApplied) {
    ...
    public VmSnapshotDetail withIsOnDemandSnapshot(Boolean isOnDemandSnapshot) {
    ...
    public VmSnapshotDetail withIsPlacedOnLegalHold(Boolean isPlacedOnLegalHold) {
    ...
    public VmSnapshotDetail withIsRetainedByRetentionLockSla(Boolean isRetainedByRetentionLockSla) {
    ...
    public VmSnapshotDetail withParentSnapshotId(String parentSnapshotId) {
    ...
    public VmSnapshotDetail withReplicationLocationIds(String[] replicationLocationIds) {
    ...
    public VmSnapshotDetail withSlaId(String slaId) {
        this.slaId = slaId;
        return this;
    }
    ...
    public VmSnapshotDetail withSlaName(String slaName) {
        this.slaName = slaName;
        return this;
    }
    
    @JsonProperty("snapshotDiskDetails")
    public VmSnapshotDiskDetail[] snapshotDiskDetails;

    public VmSnapshotDetail withSnapshotDiskDetails(VmSnapshotDiskDetail[] snapshotDiskDetails) {
        this.snapshotDiskDetails = snapshotDiskDetails;
        return this;
    }
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("snapshotDiskIds")
    public String[] snapshotDiskIds;

    public VmSnapshotDetail withSnapshotDiskIds(String[] snapshotDiskIds) {
        this.snapshotDiskIds = snapshotDiskIds;
        return this;
    }
    ...
    public VmSnapshotDetail withSnapshotRetentionInfo(SnapshotRetentionInfo snapshotRetentionInfo) {
    ...
    public VmSnapshotDetail withSourceObjectType(String sourceObjectType) {
    ...
    public VmSnapshotDetail withVNicsInfo(VmwareVNicBindingInfo[] vNicsInfo) {
    ...
    public VirtualMachineSummary virtualMachine;

    public VmSnapshotDetail withVirtualMachine(VirtualMachineSummary virtualMachine) {
    ...
    public VmSnapshotDetail withVmName(String vmName) {
        this.vmName = vmName;
        return this;
    }
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("vmwareTagList")
    public String[] vmwareTagList;

    public VmSnapshotDetail withVmwareTagList(String[] vmwareTagList) {
        this.vmwareTagList = vmwareTagList;
        return this;
    }
    
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("vmxFileContent")
    public String vmxFileContent;

    public VmSnapshotDetail withVmxFileContent(String vmxFileContent) {
        this.vmxFileContent = vmxFileContent;
        return this;
    }
    
    public VmSnapshotDetail(@JsonProperty("date") OffsetDateTime date, @JsonProperty("id") String id, @JsonProperty("isCustomRetentionApplied") Boolean isCustomRetentionApplied, @JsonProperty("isOnDemandSnapshot") Boolean isOnDemandSnapshot, @JsonProperty("replicationLocationIds") String[] replicationLocationIds, @JsonProperty("slaId") String slaId, @JsonProperty("slaName") String slaName, @JsonProperty("snapshotDiskDetails") VmSnapshotDiskDetail[] snapshotDiskDetails, @JsonProperty("vmName") String vmName) {
        this.date = date;
        this.id = id;
        this.isCustomRetentionApplied = isCustomRetentionApplied;
        this.isOnDemandSnapshot = isOnDemandSnapshot;
