...
class AccesscontextmanagerAccessPoliciesGetIamPolicyRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\GetIamPolicyRequest $getIamPolicyRequest = null;
