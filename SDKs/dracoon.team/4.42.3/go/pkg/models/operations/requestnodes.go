...
func (e RequestNodesXSdsDateFormatEnum) ToPointer() *RequestNodesXSdsDateFormatEnum {
	return &e
}
...
func (e *RequestNodesXSdsDateFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "EPOCH":
		fallthrough
	case "LEET":
		*e = RequestNodesXSdsDateFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RequestNodesXSdsDateFormatEnum: %v", v)
	}
}
