...
export class DirectoryOrgunitsDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DirectoryOrgunitsDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DirectoryOrgunitsDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
