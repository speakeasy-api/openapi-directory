...
class CreatePayeeAddress2CountryEnum(str, Enum):
    AF = "AF"
    AX = "AX"
    AL = "AL"
    DZ = "DZ"
...
class CreatePayeeAddress2:
    ...
    country: CreatePayeeAddress2CountryEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('country') }})
