...
from ..shared import api_v2010_account_available_phone_number_country_available_phone_number_mobile as shared_api_v2010_account_available_phone_number_country_available_phone_number_mobile


LIST_AVAILABLE_PHONE_NUMBER_MOBILE_SERVERS = [
	"https://api.twilio.com",
]


@dataclasses.dataclass
class ListAvailablePhoneNumberMobilePathParams:
...
@dataclasses.dataclass
class ListAvailablePhoneNumberMobileQueryParams:
...
@dataclasses.dataclass
class ListAvailablePhoneNumberMobileSecurity:
    account_sid_auth_token: shared_security.SchemeAccountSidAuthToken = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'http', 'sub_type': 'basic' }})
    

@dataclass_json
@dataclasses.dataclass
class ListAvailablePhoneNumberMobileListAvailablePhoneNumberMobileResponse:
    available_phone_numbers: Optional[list[shared_api_v2010_account_available_phone_number_country_available_phone_number_mobile.APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('available_phone_numbers') }})
...
@dataclasses.dataclass
class ListAvailablePhoneNumberMobileRequest:
    path_params: ListAvailablePhoneNumberMobilePathParams = dataclasses.field()
    query_params: ListAvailablePhoneNumberMobileQueryParams = dataclasses.field()
    security: ListAvailablePhoneNumberMobileSecurity = dataclasses.field()
...
class ListAvailablePhoneNumberMobileResponse:
    ...
    list_available_phone_number_mobile_response: Optional[ListAvailablePhoneNumberMobileListAvailablePhoneNumberMobileResponse] = dataclasses.field(default=None)
