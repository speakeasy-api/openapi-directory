...
var Similar = /** @class */ (function () {
    function Similar(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Similar.prototype.getSimilar = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getSimilar200ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
