 ...
 * The instance type.
 */
export declare enum DescribeSpotPriceHistoryResultSpotPriceHistoryInstanceTypeEnum {
    A1Medium = "a1.medium",
    A1Large = "a1.large",
    A1Xlarge = "a1.xlarge",
 ...
 */
export declare enum DescribeSpotPriceHistoryResultSpotPriceHistoryProductDescriptionEnum {
 ...
 */
export declare class DescribeSpotPriceHistoryResultSpotPriceHistory extends SpeakeasyBase {
