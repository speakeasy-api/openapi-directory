 ...
 */
export declare enum PutAlternateContactRequestBodyAlternateContactTypeEnum {
    Billing = "BILLING",
    Operations = "OPERATIONS",
    Security = "SECURITY"
}
export declare class PutAlternateContactRequestBody extends SpeakeasyBase {
    /**
     ...
     * Specifies which alternate contact you want to create or update.
     */
    alternateContactType: PutAlternateContactRequestBodyAlternateContactTypeEnum;
    /**
...
export declare class PutAlternateContactRequest extends SpeakeasyBase {
    requestBody: PutAlternateContactRequestBody;
...
export declare class PutAlternateContactResponse extends SpeakeasyBase {
    /**
