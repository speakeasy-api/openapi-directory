...
public class ListUsageRecordYesterdayQueryParams {
    ...
    public ListUsageRecordYesterdayQueryParams withCategory(org.openapis.openapi.models.shared.UsageRecordYesterdayEnumCategoryEnum category) {
    ...
    public Long page;
    public ListUsageRecordYesterdayQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListUsageRecordYesterdayQueryParams withPageToken(String pageToken) {
