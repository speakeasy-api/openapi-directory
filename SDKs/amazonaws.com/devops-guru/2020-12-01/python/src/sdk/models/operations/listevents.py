...
class ListEventsRequestBodyFilters:
    ...
    event_time_range: Optional[shared_eventtimerange.EventTimeRange] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('EventTimeRange') }})
...
class ListEventsRequestBody:
    filters: ListEventsRequestBodyFilters = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Filters') }})
...
class ListEventsRequest:
    headers: ListEventsHeaders = dataclasses.field()
    query_params: ListEventsQueryParams = dataclasses.field()
    request: ListEventsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
