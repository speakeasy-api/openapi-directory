...
type FileProjectsLocationsInstancesSharesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type FileProjectsLocationsInstancesSharesListPathParams struct {
...
type FileProjectsLocationsInstancesSharesListQueryParams struct {
	// V1 error format.
...
type FileProjectsLocationsInstancesSharesListRequest struct {
...
type FileProjectsLocationsInstancesSharesListResponse struct {
	ContentType string
	// Successful response
