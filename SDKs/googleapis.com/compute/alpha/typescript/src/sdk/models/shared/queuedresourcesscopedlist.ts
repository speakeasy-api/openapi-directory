 ...
 */
export enum QueuedResourcesScopedListWarningCodeEnum {
...
export class QueuedResourcesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class QueuedResourcesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: QueuedResourcesScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => QueuedResourcesScopedListWarningData)
...
export class QueuedResourcesScopedList extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "warning" })
  @Type(() => QueuedResourcesScopedListWarning)
