 ...
 */
export class DescribeVpcEndpointServiceConfigurationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeVpcEndpointServiceConfigurationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({
    elemType: DescribeVpcEndpointServiceConfigurationsRequestFilters,
  })
