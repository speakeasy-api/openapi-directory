...
class AnnotationStoreItem:
    ...
    store_format: shared_storeformat_enum.StoreFormatEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('storeFormat') }})  
