...
func (e DescribeIdentityProviderXAmzTargetEnum) ToPointer() *DescribeIdentityProviderXAmzTargetEnum {
	return &e
}
...
func (e *DescribeIdentityProviderXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSCognitoIdentityProviderService.DescribeIdentityProvider":
		*e = DescribeIdentityProviderXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeIdentityProviderXAmzTargetEnum: %v", v)
	}
}
