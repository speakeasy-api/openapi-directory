...
export declare class ChatSpacesMessagesUpdateSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ChatSpacesMessagesUpdateSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ChatSpacesMessagesUpdateSecurity extends SpeakeasyBase {
    option1?: ChatSpacesMessagesUpdateSecurityOption1;
    option2?: ChatSpacesMessagesUpdateSecurityOption2;
}
