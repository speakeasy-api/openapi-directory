 ...
 */
export enum InstanceGroupManagerResizeRequestsListResponseWarningCodeEnum {
...
export class InstanceGroupManagerResizeRequestsListResponseWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceGroupManagerResizeRequestsListResponseWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: InstanceGroupManagerResizeRequestsListResponseWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({
    elemType: InstanceGroupManagerResizeRequestsListResponseWarningData,
  })
  @Expose({ name: "data" })
  @Type(() => InstanceGroupManagerResizeRequestsListResponseWarningData)
  data?: InstanceGroupManagerResizeRequestsListResponseWarningData[];
 ...
 */
export class InstanceGroupManagerResizeRequestsListResponse extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceGroupManagerResizeRequest })
  @Expose({ name: "items" })
  ...
  warning?: InstanceGroupManagerResizeRequestsListResponseWarning;
}
