...
class Error405NGPISCANC:
    ...
    tpp_messages: Optional[list[shared_tppmessage405_pis_canc.TppMessage405PISCANC]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tppMessages'), 'exclude': lambda f: f is None }})  
