...
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum(str, Enum):
...
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetPathParams:
    advertiser_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'advertiserId', 'style': 'simple', 'explode': False }})
    assigned_targeting_option_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'assignedTargetingOptionId', 'style': 'simple', 'explode': False }})
    line_item_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'lineItemId', 'style': 'simple', 'explode': False }})
    targeting_type: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetQueryParams:
...
@dataclasses.dataclass
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetRequest:
    path_params: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetSecurity = dataclasses.field()
    

@dataclasses.dataclass
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    assigned_targeting_option: Optional[shared_assignedtargetingoption.AssignedTargetingOption] = dataclasses.field(default=None)
