...
class PostGetAccountAuthorizationDetailsQueryParams:
    action: PostGetAccountAuthorizationDetailsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetAccountAuthorizationDetailsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetAccountAuthorizationDetailsRequest:
    headers: PostGetAccountAuthorizationDetailsHeaders = dataclasses.field()
    query_params: PostGetAccountAuthorizationDetailsQueryParams = dataclasses.field()
