...
class GETPaymentItemPartCollectionType:
    ...
    item_parts: Optional[list[shared_getpaymentitemparttypewithsuccess.GETPaymentItemPartTypewithSuccess]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('itemParts'), 'exclude': lambda f: f is None }})
    r"""Container for payment part items."""  
