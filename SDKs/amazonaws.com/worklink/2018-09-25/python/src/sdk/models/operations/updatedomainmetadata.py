...
class UpdateDomainMetadataRequest:
    headers: UpdateDomainMetadataHeaders = dataclasses.field()
    request: UpdateDomainMetadataRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateDomainMetadataResponse:
    ...
    update_domain_metadata_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
