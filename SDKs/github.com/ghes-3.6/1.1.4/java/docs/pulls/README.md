...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCheckIfMergedRequest req = new PullsCheckIfMergedRequest("ducimus", 567846L, "dolores");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateRequest req = new PullsCreateRequest(                new PullsCreateRequestBody("error", "veritatis") {{
                                body = "ducimus";
                                draft = false;
                                issue = 1L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReplyForReviewCommentRequest req = new PullsCreateReplyForReviewCommentRequest(                new PullsCreateReplyForReviewCommentRequestBody("similique");, 763165L, "ex", 311486L, "commodi");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReviewRequest req = new PullsCreateReviewRequest("officiis", 810839L, "quidem") {{
                requestBody = new PullsCreateReviewRequestBody() {{
                    ...
                    comments = new org.openapis.openapi.models.operations.PullsCreateReviewRequestBodyComments[]{{
                        add(new PullsCreateReviewRequestBodyComments("sint", "vero") {{
                            body = "dolorem";
                            line = 28L;
                            path = "modi";
                            position = 59383L;
                        ...
                        add(new PullsCreateReviewRequestBodyComments("dicta", "earum") {{
                            body = "sequi";
                            line = 28L;
                            path = "repudiandae";
                            position = 741232L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReviewCommentRequest req = new PullsCreateReviewCommentRequest(                new PullsCreateReviewCommentRequestBody("dolores", "nam", 115898L, "consequuntur") {{
                                inReplyTo = 2L;
                                position = 899867L;
                                side = PullsCreateReviewCommentRequestBodySideEnum.RIGHT;
                                startLine = 56877L;
                                startSide = PullsCreateReviewCommentRequestBodyStartSideEnum.RIGHT;
                            }};, "maiores", 87382L, "quasi");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDeletePendingReviewRequest req = new PullsDeletePendingReviewRequest("laboriosam", 863471L, "libero", 566506L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDeleteReviewCommentRequest req = new PullsDeleteReviewCommentRequest(578210L, "nemo", "aliquam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDismissReviewRequest req = new PullsDismissReviewRequest(                new PullsDismissReviewRequestBody("nostrum") {{
                                event = PullsDismissReviewRequestBodyEventEnum.DISMISS;
                            }};, "doloribus", 757364L, "sint", 314573L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetRequest req = new PullsGetRequest("hic", 657319L, "quas");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetReviewRequest req = new PullsGetReviewRequest("totam", 564667L, "odio", 51170L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetReviewCommentRequest req = new PullsGetReviewCommentRequest(901163L, "architecto", "quos");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListRequest req = new PullsListRequest("iste", "assumenda") {{
                base = "tempore";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListCommentsForReviewRequest req = new PullsListCommentsForReviewRequest("ipsum", 238011L, "saepe", 644420L) {{
                page = 42924L;
                perPage = 339756L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListCommitsRequest req = new PullsListCommitsRequest("veniam", 727481L, "architecto") {{
                page = 584593L;
                perPage = 475589L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListFilesRequest req = new PullsListFilesRequest("eligendi", 820023L, "non") {{
                page = 298187L;
                perPage = 932296L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListRequestedReviewersRequest req = new PullsListRequestedReviewersRequest("sed", 993002L, "veniam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewCommentsRequest req = new PullsListReviewCommentsRequest("consequuntur", 813880L, "laudantium") {{
                direction = PullsListReviewCommentsDirectionEnum.ASC;
                page = 863477L;
                perPage = 227362L;
                since = OffsetDateTime.parse("2022-12-06T20:51:23.545Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewCommentsForRepoRequest req = new PullsListReviewCommentsForRepoRequest("facilis", "tempore") {{
                direction = PullsListReviewCommentsForRepoDirectionEnum.ASC;
                page = 977518L;
                perPage = 310840L;
                since = OffsetDateTime.parse("2021-07-25T09:39:55.976Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewsRequest req = new PullsListReviewsRequest("quis", 391933L, "libero") {{
                page = 794507L;
                perPage = 815200L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsMergeRequest req = new PullsMergeRequest("facilis", 217663L, "ad") {{
                requestBody = new PullsMergeRequestBody() {{
                    commitMessage = "voluptatibus";
                    commitTitle = "voluptatibus";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsRequestReviewersRequest req = new PullsRequestReviewersRequest("eligendi", 853606L, "unde") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateRequest req = new PullsUpdateRequest("iusto", 491201L, "libero") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateBranchRequest req = new PullsUpdateBranchRequest("saepe", 734814L, "veniam") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateReviewRequest req = new PullsUpdateReviewRequest(                new PullsUpdateReviewRequestBody("reiciendis");, "earum", 444121L, "praesentium", 367046L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateReviewCommentRequest req = new PullsUpdateReviewCommentRequest(                new PullsUpdateReviewCommentRequestBody("repellat");, 789770L, "sequi", "nihil");            
