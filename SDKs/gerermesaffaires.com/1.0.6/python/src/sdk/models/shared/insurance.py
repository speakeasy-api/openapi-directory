...
class InsuranceLevelEnum(str, Enum):
...
class Insurance:
    ...
    level: Optional[InsuranceLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Level'), 'exclude': lambda f: f is None }})  
