...
class DfareportingFilesListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DfareportingFilesListScopeEnum $scope
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=scope')]
    public ?DfareportingFilesListScopeEnum $scope = null;
    
    /**
     * The field by which to sort the list.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DfareportingFilesListSortFieldEnum $sortField
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortField')]
    public ?DfareportingFilesListSortFieldEnum $sortField = null;
    
    /**
     * Order of sorted results.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DfareportingFilesListSortOrderEnum $sortOrder
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortOrder')]
    public ?DfareportingFilesListSortOrderEnum $sortOrder = null;
