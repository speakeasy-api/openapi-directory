...
var Languages = /** @class */ (function () {
    function Languages(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Language Listings
    **/
    Languages.prototype.getResourcesLanguagesJson = function (req, config) {
    ...
    **/
    Languages.prototype.getResourcesLanguagesIdJson = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
