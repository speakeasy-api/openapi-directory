...
func (e GetNetworkWirelessConnectionStatsBandEnum) ToPointer() *GetNetworkWirelessConnectionStatsBandEnum {
	return &e
}
...
func (e *GetNetworkWirelessConnectionStatsBandEnum) UnmarshalJSON(data []byte) error {
	...
	case "5":
		fallthrough
	case "6":
		*e = GetNetworkWirelessConnectionStatsBandEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessConnectionStatsBandEnum: %v", v)
	}
}
