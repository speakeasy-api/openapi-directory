...
public class Videos {
    ...
    **/
    public openapisdk.models.operations.VideointelligenceVideosAnnotateResponse videointelligenceVideosAnnotate(openapisdk.models.operations.VideointelligenceVideosAnnotateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/videos:annotate");
        ...
        openapisdk.models.operations.VideointelligenceVideosAnnotateResponse res = new openapisdk.models.operations.VideointelligenceVideosAnnotateResponse() {{
