...
var ConfigSFLOW = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "collector" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "encoding_type" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "flows_per_min" }),
        __metadata("design:type", Number)
    ], ConfigSFLOW.prototype, "flowsPerMin", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "include_samples" }),
        __metadata("design:type", String)
    ], ConfigSFLOW.prototype, "includeSamples", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "records_per_sample" }),
        __metadata("design:type", String)
    ], ConfigSFLOW.prototype, "recordsPerSample", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "samples_per_datagram" }),
        __metadata("design:type", String)
