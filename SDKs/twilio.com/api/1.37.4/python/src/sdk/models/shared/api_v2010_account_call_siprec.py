...
class APIV2010AccountCallSiprec:
    ...
    status: Optional[shared_siprec_enum_status_enum.SiprecEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
