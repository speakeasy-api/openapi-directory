...
exports.CreateConfigInput = exports.CreateConfigInputCountryEnum = void 0;
 ...
 */
var CreateConfigInputCountryEnum;
...
})(CreateConfigInputCountryEnum = exports.CreateConfigInputCountryEnum || (exports.CreateConfigInputCountryEnum = {}));
/**
...
var CreateConfigInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_affiliations_and_insurances" }),
        __metadata("design:type", Number)
    ], CreateConfigInput.prototype, "datasetAffiliationsAndInsurances", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_alert_in_media" }),
        __metadata("design:type", Number)
    ], CreateConfigInput.prototype, "datasetAlertInMedia", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_business_background" }),
        __metadata("design:type", Number)
    ], CreateConfigInput.prototype, "datasetBusinessBackground", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_criminal_record" }),
        __metadata("design:type", Number)
    ], CreateConfigInput.prototype, "datasetCriminalRecord", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_driving_licenses" }),
        __metadata("design:type", Number)
    ], CreateConfigInput.prototype, "datasetDrivingLicenses", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_international_background" }),
        __metadata("design:type", Number)
    ], CreateConfigInput.prototype, "datasetInternationalBackground", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_legal_background" }),
        __metadata("design:type", Number)
    ], CreateConfigInput.prototype, "datasetLegalBackground", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_personal_identity" }),
        __metadata("design:type", Number)
    ], CreateConfigInput.prototype, "datasetPersonalIdentity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_professional_background" }),
        __metadata("design:type", Number)
    ], CreateConfigInput.prototype, "datasetProfessionalBackground", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_taxes_and_finances" }),
        __metadata("design:type", Number)
    ], CreateConfigInput.prototype, "datasetTaxesAndFinances", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_traffic_fines" }),
        __metadata("design:type", Number)
    ], CreateConfigInput.prototype, "datasetTrafficFines", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_vehicle_information" }),
        __metadata("design:type", Number)
    ], CreateConfigInput.prototype, "datasetVehicleInformation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=dataset_vehicle_permits" }),
        __metadata("design:type", Number)
...
exports.CreateConfigInput = CreateConfigInput;
