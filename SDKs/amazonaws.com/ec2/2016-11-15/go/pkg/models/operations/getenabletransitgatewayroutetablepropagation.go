...
func (e GETEnableTransitGatewayRouteTablePropagationActionEnum) ToPointer() *GETEnableTransitGatewayRouteTablePropagationActionEnum {
	return &e
}
...
func (e *GETEnableTransitGatewayRouteTablePropagationActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "EnableTransitGatewayRouteTablePropagation":
		*e = GETEnableTransitGatewayRouteTablePropagationActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETEnableTransitGatewayRouteTablePropagationActionEnum: %v", v)
	}
}
...
func (e GETEnableTransitGatewayRouteTablePropagationVersionEnum) ToPointer() *GETEnableTransitGatewayRouteTablePropagationVersionEnum {
	return &e
}
...
func (e *GETEnableTransitGatewayRouteTablePropagationVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2016-11-15":
		*e = GETEnableTransitGatewayRouteTablePropagationVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETEnableTransitGatewayRouteTablePropagationVersionEnum: %v", v)
	}
}
