...
func (e GetCandidatesTotalsByOfficeOfficeEnum) ToPointer() *GetCandidatesTotalsByOfficeOfficeEnum {
	return &e
}
...
func (e *GetCandidatesTotalsByOfficeOfficeEnum) UnmarshalJSON(data []byte) error {
	...
	case "S":
		fallthrough
	case "P":
		*e = GetCandidatesTotalsByOfficeOfficeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCandidatesTotalsByOfficeOfficeEnum: %v", v)
	}
}
