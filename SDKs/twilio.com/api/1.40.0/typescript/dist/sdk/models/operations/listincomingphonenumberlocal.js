...
exports.ListIncomingPhoneNumberLocalResponse = exports.ListIncomingPhoneNumberLocalListIncomingPhoneNumberLocalResponse = exports.ListIncomingPhoneNumberLocalRequest = exports.ListIncomingPhoneNumberLocalSecurity = exports.ListIncomingPhoneNumberLocalServerList = void 0;
...
var ListIncomingPhoneNumberLocalSecurity = /** @class */ (function (_super) {
    ...
    ], ListIncomingPhoneNumberLocalSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListIncomingPhoneNumberLocalSecurity.prototype, "username", void 0);
...
var ListIncomingPhoneNumberLocalRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListIncomingPhoneNumberLocalRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Beta" }),
        __metadata("design:type", Boolean)
    ], ListIncomingPhoneNumberLocalRequest.prototype, "beta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=FriendlyName",
        }),
        __metadata("design:type", String)
    ], ListIncomingPhoneNumberLocalRequest.prototype, "friendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Origin",
        }),
        __metadata("design:type", String)
    ], ListIncomingPhoneNumberLocalRequest.prototype, "origin", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListIncomingPhoneNumberLocalRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListIncomingPhoneNumberLocalRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListIncomingPhoneNumberLocalRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PhoneNumber",
        }),
        __metadata("design:type", String)
    ], ListIncomingPhoneNumberLocalRequest.prototype, "phoneNumber", void 0);
...
var ListIncomingPhoneNumberLocalListIncomingPhoneNumberLocalResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal; }),
...
var ListIncomingPhoneNumberLocalResponse = /** @class */ (function (_super) {
    ...
    ], ListIncomingPhoneNumberLocalResponse.prototype, "rawResponse", void 0);
