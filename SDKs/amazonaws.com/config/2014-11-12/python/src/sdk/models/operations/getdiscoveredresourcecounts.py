...
class GetDiscoveredResourceCountsRequest:
    ...
    get_discovered_resource_counts_request: shared_getdiscoveredresourcecountsrequest.GetDiscoveredResourceCountsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
