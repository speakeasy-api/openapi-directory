...
export declare class Contacts {
    ...
    **/
    getUserContact(req: operations.GetUserContactRequest, config?: AxiosRequestConfig): Promise<operations.GetUserContactResponse>;
    /**
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Medium`
    **/
    getUserContacts(req: operations.GetUserContactsRequest, config?: AxiosRequestConfig): Promise<operations.GetUserContactsResponse>;
    /**
