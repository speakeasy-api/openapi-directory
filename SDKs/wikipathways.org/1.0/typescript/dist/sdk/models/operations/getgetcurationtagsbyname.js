...
exports.GetGetCurationTagsByNameResponse = exports.GetGetCurationTagsByNameRequest = exports.GetGetCurationTagsByNameFormatEnum = void 0;
...
var GetGetCurationTagsByNameRequest = /** @class */ (function (_super) {
    ...
    ], GetGetCurationTagsByNameRequest.prototype, "format", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=tagName",
        }),
        __metadata("design:type", String)
    ], GetGetCurationTagsByNameRequest.prototype, "tagName", void 0);
...
var GetGetCurationTagsByNameResponse = /** @class */ (function (_super) {
    ...
    ], GetGetCurationTagsByNameResponse.prototype, "rawResponse", void 0);
