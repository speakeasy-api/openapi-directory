 ...
 */
export declare class DescribeLocalGatewayVirtualInterfaceGroupsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeLocalGatewayVirtualInterfaceGroupsRequest extends SpeakeasyBase {
    dryRun?: boolean;
