...
public class LabrpSecurity {
    ...
    public LabrpSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public LabrpSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public LabrpSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
