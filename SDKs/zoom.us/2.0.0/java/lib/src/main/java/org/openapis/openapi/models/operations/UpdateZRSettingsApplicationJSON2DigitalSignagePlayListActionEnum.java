 ...
 * 
 */
public enum UpdateZRSettingsApplicationJSON2DigitalSignagePlayListActionEnum {
    ADD("add"),
    UPDATE("update"),
    DELETE("delete");
    ...
    private UpdateZRSettingsApplicationJSON2DigitalSignagePlayListActionEnum(String value) {
        this.value = value;
    }
}
