...
export class CreateInternationalStandingOrdersRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateInternationalStandingOrdersRawRequest extends SpeakeasyBase {
  /**
...
export class CreateInternationalStandingOrdersRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
