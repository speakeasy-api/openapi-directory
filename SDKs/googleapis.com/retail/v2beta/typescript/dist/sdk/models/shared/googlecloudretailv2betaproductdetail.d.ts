...
import { GoogleCloudRetailV2betaProduct, GoogleCloudRetailV2betaProductInput } from "./googlecloudretailv2betaproduct";
/**
 * Detailed product information associated with a user event.
 */
export declare class GoogleCloudRetailV2betaProductDetailInput extends SpeakeasyBase {
    /**
 ...
 * Detailed product information associated with a user event.
 */
export declare class GoogleCloudRetailV2betaProductDetail extends SpeakeasyBase {
    /**
     * Product captures all metadata information of items to be recommended or searched.
     */
