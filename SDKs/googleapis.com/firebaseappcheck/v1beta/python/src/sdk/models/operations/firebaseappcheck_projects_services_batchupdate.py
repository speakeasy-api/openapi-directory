...
from ..shared import security as shared_security
from ..shared import googlefirebaseappcheckv1betabatchupdateservicesrequest as shared_googlefirebaseappcheckv1betabatchupdateservicesrequest
from ..shared import googlefirebaseappcheckv1betabatchupdateservicesresponse as shared_googlefirebaseappcheckv1betabatchupdateservicesresponse
...
class FirebaseappcheckProjectsServicesBatchUpdateRequest:
    ...
    request: Optional[shared_googlefirebaseappcheckv1betabatchupdateservicesrequest.GoogleFirebaseAppcheckV1betaBatchUpdateServicesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class FirebaseappcheckProjectsServicesBatchUpdateResponse:
    ...
    google_firebase_appcheck_v1beta_batch_update_services_response: Optional[shared_googlefirebaseappcheckv1betabatchupdateservicesresponse.GoogleFirebaseAppcheckV1betaBatchUpdateServicesResponse] = dataclasses.field(default=None)
