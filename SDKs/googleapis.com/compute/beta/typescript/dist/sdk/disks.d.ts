...
export declare class Disks {
     ...
     */
    computeDisksBulkInsert(req: operations.ComputeDisksBulkInsertRequest, security: operations.ComputeDisksBulkInsertSecurity, config?: AxiosRequestConfig): Promise<operations.ComputeDisksBulkInsertResponse>;
    /**
     ...
     */
    computeDisksStartAsyncReplication(req: operations.ComputeDisksStartAsyncReplicationRequest, security: operations.ComputeDisksStartAsyncReplicationSecurity, config?: AxiosRequestConfig): Promise<operations.ComputeDisksStartAsyncReplicationResponse>;
    /**
     * Stops asynchronous replication. Can be invoked either on the primary or on the secondary disk.
     */
    computeDisksStopAsyncReplication(req: operations.ComputeDisksStopAsyncReplicationRequest, security: operations.ComputeDisksStopAsyncReplicationSecurity, config?: AxiosRequestConfig): Promise<operations.ComputeDisksStopAsyncReplicationResponse>;
    /**
     * Stops asynchronous replication for a consistency group of disks. Can be invoked either in the primary or secondary scope.
     */
    computeDisksStopGroupAsyncReplication(req: operations.ComputeDisksStopGroupAsyncReplicationRequest, security: operations.ComputeDisksStopGroupAsyncReplicationSecurity, config?: AxiosRequestConfig): Promise<operations.ComputeDisksStopGroupAsyncReplicationResponse>;
    /**
