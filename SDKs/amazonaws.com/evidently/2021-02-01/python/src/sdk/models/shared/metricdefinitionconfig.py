...
class MetricDefinitionConfig:
    r"""This structure defines a metric that you want to use to evaluate the variations during a launch or experiment."""
    
    entity_id_key: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entityIdKey') }})  
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})  
    value_key: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('valueKey') }})  
