...
func (e GetCommentXAmzTargetEnum) ToPointer() *GetCommentXAmzTargetEnum {
	return &e
}
...
func (e *GetCommentXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "CodeCommit_20150413.GetComment":
		*e = GetCommentXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCommentXAmzTargetEnum: %v", v)
	}
}
