...
from ..shared import proxycreatecontact as shared_proxycreatecontact
...
class ObjectPOSTContactRequest:
    ...
    proxy_create_contact: shared_proxycreatecontact.ProxyCreateContact = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
