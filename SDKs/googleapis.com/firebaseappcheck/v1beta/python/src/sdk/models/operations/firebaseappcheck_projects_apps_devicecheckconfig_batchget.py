...
from ..shared import security as shared_security
from ..shared import googlefirebaseappcheckv1betabatchgetdevicecheckconfigsresponse as shared_googlefirebaseappcheckv1betabatchgetdevicecheckconfigsresponse
...
class FirebaseappcheckProjectsAppsDeviceCheckConfigBatchGetResponse:
    ...
    google_firebase_appcheck_v1beta_batch_get_device_check_configs_response: Optional[shared_googlefirebaseappcheckv1betabatchgetdevicecheckconfigsresponse.GoogleFirebaseAppcheckV1betaBatchGetDeviceCheckConfigsResponse] = dataclasses.field(default=None)
