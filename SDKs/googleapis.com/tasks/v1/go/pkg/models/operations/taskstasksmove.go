...
type TasksTasksMoveSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type TasksTasksMovePathParams struct {
	// Task identifier.
...
type TasksTasksMoveQueryParams struct {
	// V1 error format.
