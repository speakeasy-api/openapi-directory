...
class ListAssessmentTemplatesRequest:
    ...
    list_assessment_templates_request: shared_listassessmenttemplatesrequest.ListAssessmentTemplatesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
