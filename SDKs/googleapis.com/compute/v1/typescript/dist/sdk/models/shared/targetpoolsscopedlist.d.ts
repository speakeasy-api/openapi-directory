 ...
 */
export declare enum TargetPoolsScopedListWarningCodeEnum {
...
export declare class TargetPoolsScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetPoolsScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class TargetPoolsScopedList extends SpeakeasyBase {
    /**
