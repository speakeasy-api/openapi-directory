...
class GlobalAddresses 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesTestIamPermissionsResponse
     */
	public function computeGlobalAddressesTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/addresses/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
