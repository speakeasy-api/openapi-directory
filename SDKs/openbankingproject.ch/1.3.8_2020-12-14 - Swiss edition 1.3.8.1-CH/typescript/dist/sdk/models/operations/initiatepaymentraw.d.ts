...
export declare class InitiatePaymentRawSecurity extends SpeakeasyBase {
    bearerAuthOAuth?: string;
}
export declare class InitiatePaymentRawRequest extends SpeakeasyBase {
    /**
...
export declare class InitiatePaymentRawResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Bad Request
     */
