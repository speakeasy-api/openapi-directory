...
class OrderTask:
    r"""The type that defines the fields for the <b> getOrderTask</b> response."""
    ...
    r"""The path to the call URI used to retrieve the task."""  
    ...
    r"""The schema version number associated with the create task."""  
