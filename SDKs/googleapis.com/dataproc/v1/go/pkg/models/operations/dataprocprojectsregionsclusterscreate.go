...
func (e *DataprocProjectsRegionsClustersCreateActionOnFailedPrimaryWorkersEnum) UnmarshalJSON(data []byte) error {
	...
	case "NO_ACTION":
		fallthrough
	case "DELETE":
		*e = DataprocProjectsRegionsClustersCreateActionOnFailedPrimaryWorkersEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for DataprocProjectsRegionsClustersCreateActionOnFailedPrimaryWorkersEnum: %s", s)
	}
}
