...
class InitiatePaymentMultipartSecurity:
...
@dataclasses.dataclass
class InitiatePaymentMultipartRequest:
    ...
    * periodic-payments
    """  
    periodic_payment_initiation_multipart_body: shared_periodicpaymentinitiationmultipartbody.PeriodicPaymentInitiationMultipartBody = dataclasses.field(metadata={'request': { 'media_type': 'multipart/form-data' }})
...
@dataclasses.dataclass
class InitiatePaymentMultipartResponse:
