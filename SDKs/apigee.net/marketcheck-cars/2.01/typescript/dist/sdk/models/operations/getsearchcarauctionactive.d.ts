 ...
 */
export declare enum GetSearchCarAuctionActiveTitleTypeEnum {
    Clean = "clean",
    Salvage = "salvage"
}
export declare class GetSearchCarAuctionActiveRequest extends SpeakeasyBase {
    /**
     ...
     * To filter on title type
     */
    titleType?: GetSearchCarAuctionActiveTitleTypeEnum;
    /**
...
export declare class GetSearchCarAuctionActiveResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Error
     */
