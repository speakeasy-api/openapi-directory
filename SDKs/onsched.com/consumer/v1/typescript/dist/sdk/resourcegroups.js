...
var ResourceGroups = /** @class */ (function () {
     ...
     */
    ResourceGroups.prototype.getConsumerV1Resourcegroups = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetConsumerV1ResourcegroupsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/consumer/v1/resourcegroups";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetConsumerV1ResourcegroupsResponse({
     ...
     */
    ResourceGroups.prototype.getConsumerV1ResourcegroupsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetConsumerV1ResourcegroupsIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/consumer/v1/resourcegroups/{id}", req);
        var client = this._securityClient || this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetConsumerV1ResourcegroupsIdResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
