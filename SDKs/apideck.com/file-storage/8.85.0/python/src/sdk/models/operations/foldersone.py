...
from ..shared import getfolderresponse as shared_getfolderresponse
...
@dataclasses.dataclass
class FoldersOneSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class FoldersOneRequest:
    headers: FoldersOneHeaders = dataclasses.field()
    path_params: FoldersOnePathParams = dataclasses.field()
    query_params: FoldersOneQueryParams = dataclasses.field()
    security: FoldersOneSecurity = dataclasses.field()
    

@dataclasses.dataclass
class FoldersOneResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    get_folder_response: Optional[shared_getfolderresponse.GetFolderResponse] = dataclasses.field(default=None)
