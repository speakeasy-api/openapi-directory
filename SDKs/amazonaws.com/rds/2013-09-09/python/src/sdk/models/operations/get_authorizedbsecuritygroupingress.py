...
class GetAuthorizeDbSecurityGroupIngressQueryParams:
    action: GetAuthorizeDbSecurityGroupIngressActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    db_security_group_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'DBSecurityGroupName', 'style': 'form', 'explode': True }})
    version: GetAuthorizeDbSecurityGroupIngressVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAuthorizeDbSecurityGroupIngressRequest:
    headers: GetAuthorizeDbSecurityGroupIngressHeaders = dataclasses.field()
    query_params: GetAuthorizeDbSecurityGroupIngressQueryParams = dataclasses.field()
