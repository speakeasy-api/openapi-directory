...
class ConnectionProfile:
    ...
    bigquery_profile: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('bigqueryProfile') }})
    ...
    postgresql_profile: Optional[shared_postgresqlprofile.PostgresqlProfile] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('postgresqlProfile') }})
