 ...
 * An inventory source.
 */
export class InventorySourceInput extends SpeakeasyBase {
  /**
   * Whether the inventory source has a guaranteed or non-guaranteed delivery.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: CreativeConfig })
  @Expose({ name: "creativeConfigs" })
  @Type(() => CreativeConfig)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "inventorySourceType" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "readWriteAccessors" })
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "status" })
  @Type(() => InventorySourceStatusInput)
...
export class InventorySource extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "inventorySourceProductType" })
