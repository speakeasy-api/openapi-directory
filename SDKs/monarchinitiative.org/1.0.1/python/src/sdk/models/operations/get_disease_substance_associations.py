...
class GetDiseaseSubstanceAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetDiseaseSubstanceAssociationsQueryParams:
...
class GetDiseaseSubstanceAssociationsRequest:
    path_params: GetDiseaseSubstanceAssociationsPathParams = dataclasses.field()
    query_params: GetDiseaseSubstanceAssociationsQueryParams = dataclasses.field()
