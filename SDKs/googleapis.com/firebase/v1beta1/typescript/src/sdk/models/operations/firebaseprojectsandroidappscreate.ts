...
export class FirebaseProjectsAndroidAppsCreateSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseProjectsAndroidAppsCreateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class FirebaseProjectsAndroidAppsCreateSecurity extends SpeakeasyBase {
...
export class FirebaseProjectsAndroidAppsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseProjectsAndroidAppsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
