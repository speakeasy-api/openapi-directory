...
class RequestAllSystemRescueKeyPairsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestAllSystemRescueKeyPairsXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestAllSystemRescueKeyPairsXSdsDateFormatEnum $xSdsDateFormat = null;
