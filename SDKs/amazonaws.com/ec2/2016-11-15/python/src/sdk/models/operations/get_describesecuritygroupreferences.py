...
class GETDescribeSecurityGroupReferencesVersionEnum(str, Enum):
...
class GETDescribeSecurityGroupReferencesRequest:
    ...
    action: GETDescribeSecurityGroupReferencesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    group_id: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'GroupId', 'style': 'form', 'explode': True }})
    r"""The IDs of the security groups in your account."""  
    version: GETDescribeSecurityGroupReferencesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
