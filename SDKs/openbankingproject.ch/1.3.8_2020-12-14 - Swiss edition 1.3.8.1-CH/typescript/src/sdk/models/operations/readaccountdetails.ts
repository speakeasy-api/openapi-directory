...
export class ReadAccountDetailsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=account-id" })
  accountId: string;
}


export class ReadAccountDetailsQueryParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=withBalance" })
  withBalance?: boolean;
}


export class ReadAccountDetailsHeaders extends SpeakeasyBase {
...
export class ReadAccountDetailsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=http;subtype=bearer" })
  bearerAuthOAuth?: shared.SchemeBearerAuthOAuth;
}


export class ReadAccountDetails200ApplicationJson extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=account" })
  account: shared.AccountDetails;
}


export class ReadAccountDetailsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class ReadAccountDetailsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
