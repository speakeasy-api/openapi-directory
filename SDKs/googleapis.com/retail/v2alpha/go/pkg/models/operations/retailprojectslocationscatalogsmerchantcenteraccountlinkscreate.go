...
type RetailProjectsLocationsCatalogsMerchantCenterAccountLinksCreateSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type RetailProjectsLocationsCatalogsMerchantCenterAccountLinksCreateRequest struct {
	// V1 error format.
...
type RetailProjectsLocationsCatalogsMerchantCenterAccountLinksCreateResponse struct {
	ContentType string
	// Successful response
