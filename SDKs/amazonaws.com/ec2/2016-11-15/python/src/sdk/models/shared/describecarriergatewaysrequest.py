...
class DescribeCarrierGatewaysRequest:
    ...
    carrier_gateway_ids: Optional[list[str]] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeCarrierGatewaysRequestFilters]] = dataclasses.field(default=None)  
