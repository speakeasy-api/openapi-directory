 ...
 */
export enum VpnTunnelsScopedListWarningCodeEnum {
...
export class VpnTunnelsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class VpnTunnelsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: VpnTunnelsScopedListWarningData })
  @Expose({ name: "data" })
...
export class VpnTunnelsScopedList extends SpeakeasyBase {
  /**
   * A list of VPN tunnels contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: VpnTunnel })
  @Expose({ name: "vpnTunnels" })
  @Type(() => VpnTunnel)
