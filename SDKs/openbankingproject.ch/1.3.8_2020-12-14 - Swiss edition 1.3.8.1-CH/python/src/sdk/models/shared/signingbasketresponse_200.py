...
class SigningBasketResponse200:
    r"""Body of the JSON response for a successful get signing basket request.
    ...
    """  
    links: Optional[shared__linkssigningbasket.LinksSigningBasket] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('_links'), 'exclude': lambda f: f is None }})
    ...
    """  
    consents: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('consents'), 'exclude': lambda f: f is None }})
    r"""A list of consentIds."""  
    payments: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payments'), 'exclude': lambda f: f is None }})
