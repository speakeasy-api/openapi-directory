...
class SearchCseListImgDominantColorEnum(str, Enum):
...
class SearchCseListImgSizeEnum(str, Enum):
...
class SearchCseListImgTypeEnum(str, Enum):
...
class SearchCseListSafeEnum(str, Enum):
...
class SearchCseListSearchTypeEnum(str, Enum):
    SEARCH_TYPE_UNDEFINED = "searchTypeUndefined"
    IMAGE = "image"

class SearchCseListSiteSearchFilterEnum(str, Enum):
