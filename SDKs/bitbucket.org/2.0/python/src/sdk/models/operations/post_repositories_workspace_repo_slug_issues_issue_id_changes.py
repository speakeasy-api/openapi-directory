...
class PostRepositoriesWorkspaceRepoSlugIssuesIssueIDChangesRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugIssuesIssueIDChangesPathParams = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: PostRepositoriesWorkspaceRepoSlugIssuesIssueIDChangesSecurity = dataclasses.field()
