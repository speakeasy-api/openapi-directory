...
type UpdateEventDestinationHeaders struct {
...
type UpdateEventDestinationRequest struct {
	Headers UpdateEventDestinationHeaders
	Request shared.UpdateEventDestinationRequest `request:"mediaType=application/json"`
}
