...
export class SharedLinksAddSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SharedLinksAddRequest extends SpeakeasyBase {
...
export class SharedLinksAddResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
