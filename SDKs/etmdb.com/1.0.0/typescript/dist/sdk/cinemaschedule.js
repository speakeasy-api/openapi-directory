...
exports.CinemaSchedule = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var CinemaSchedule = /** @class */ (function () {
    function CinemaSchedule(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CinemaSchedule.prototype.cinemaScheduleSearchRead = function (req, config) {
     ...
     * [ref]: https://etmdb.com/en/movie-list/-updated_date
    **/
    CinemaSchedule.prototype.cinemaScheduleSearchallRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.CinemaSchedule = CinemaSchedule;
