...
public class AndroidpublisherEditsExpansionfilesPatchQueryParams {
    ...
    public AndroidpublisherEditsExpansionfilesPatchQueryParams withDollarXgafv(openapisdk.models.shared.XgafvEnum dollarXgafv) {
        this.dollarXgafv = dollarXgafv;
        return this;
    }
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=access_token")
    public String accessToken;
    public AndroidpublisherEditsExpansionfilesPatchQueryParams withAccessToken(String accessToken) {
    ...
    public AndroidpublisherEditsExpansionfilesPatchQueryParams withCallback(String callback) {
    ...
    public AndroidpublisherEditsExpansionfilesPatchQueryParams withUploadType(String uploadType) {
        this.uploadType = uploadType;
        return this;
    }
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=upload_protocol")
    public String uploadProtocol;
    public AndroidpublisherEditsExpansionfilesPatchQueryParams withUploadProtocol(String uploadProtocol) {
