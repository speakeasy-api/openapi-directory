...
type StoredValueIssueResponseResultCodeEnum string

const (
	StoredValueIssueResponseResultCodeEnumSuccess          StoredValueIssueResponseResultCodeEnum = "Success"
	StoredValueIssueResponseResultCodeEnumRefused          StoredValueIssueResponseResultCodeEnum = "Refused"
	StoredValueIssueResponseResultCodeEnumError            StoredValueIssueResponseResultCodeEnum = "Error"
	StoredValueIssueResponseResultCodeEnumNotEnoughBalance StoredValueIssueResponseResultCodeEnum = "NotEnoughBalance"
)

func (e StoredValueIssueResponseResultCodeEnum) ToPointer() *StoredValueIssueResponseResultCodeEnum {
	return &e
}

func (e *StoredValueIssueResponseResultCodeEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "NotEnoughBalance":
		*e = StoredValueIssueResponseResultCodeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for StoredValueIssueResponseResultCodeEnum: %v", v)
	}
}
...
type StoredValueIssueResponse struct {
	...
	// * **NotEnoughBalance** – The amount on the payment method is lower than the amount given in the request. Only applicable to balance checks.
	//
	ResultCode *StoredValueIssueResponseResultCodeEnum `json:"resultCode,omitempty"`
