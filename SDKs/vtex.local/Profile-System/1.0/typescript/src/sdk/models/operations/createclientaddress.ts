...
export class CreateClientAddressRequest extends SpeakeasyBase {
  /**
...
export class CreateClientAddressResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  createClientAddress201ApplicationJSONObject?: Record<string, any>;
