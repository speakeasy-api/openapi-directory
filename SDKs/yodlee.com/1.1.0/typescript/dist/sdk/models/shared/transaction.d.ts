...
export declare enum TransactionContainerEnum {
    Bank = "bank",
...
export declare enum TransactionBaseTypeEnum {
    Credit = "CREDIT",
    Debit = "DEBIT"
}
export declare enum TransactionCategorySourceEnum {
    System = "SYSTEM",
    User = "USER"
}
export declare enum TransactionCategoryTypeEnum {
    Transfer = "TRANSFER",
...
export declare enum TransactionSourceTypeEnum {
...
export declare enum TransactionSubTypeEnum {
    AuthHold = "AUTH_HOLD",
...
export declare class Transaction extends SpeakeasyBase {
    container?: TransactionContainerEnum;
    accountId?: number;
    amount?: Money;
    baseType?: TransactionBaseTypeEnum;
    category?: string;
    categoryId?: number;
    categorySource?: TransactionCategorySourceEnum;
    categoryType?: TransactionCategoryTypeEnum;
    checkNumber?: string;
    commission?: Money;
    createdDate?: string;
    cusipNumber?: string;
