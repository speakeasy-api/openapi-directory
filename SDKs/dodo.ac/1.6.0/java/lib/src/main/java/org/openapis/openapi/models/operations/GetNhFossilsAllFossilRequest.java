...
public class GetNhFossilsAllFossilRequest {
    ...
    public GetNhFossilsAllFossilRequest(@JsonProperty("Accept-Version") String acceptVersion, @JsonProperty("X-API-KEY") String xApiKey, @JsonProperty("fossil") String fossil) {
        this.acceptVersion = acceptVersion;
        this.xApiKey = xApiKey;
        this.fossil = fossil;
  }
