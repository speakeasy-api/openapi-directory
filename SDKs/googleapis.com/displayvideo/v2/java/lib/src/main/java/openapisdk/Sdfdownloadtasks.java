...
public class Sdfdownloadtasks {
    ...
    **/
    public openapisdk.models.operations.DisplayvideoSdfdownloadtasksCreateResponse displayvideoSdfdownloadtasksCreate(openapisdk.models.operations.DisplayvideoSdfdownloadtasksCreateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v2/sdfdownloadtasks");
        ...
        openapisdk.models.operations.DisplayvideoSdfdownloadtasksCreateResponse res = new openapisdk.models.operations.DisplayvideoSdfdownloadtasksCreateResponse() {{
            operation = null;
        }};
