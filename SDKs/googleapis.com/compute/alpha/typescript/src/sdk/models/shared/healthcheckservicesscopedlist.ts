 ...
 */
export enum HealthCheckServicesScopedListWarningCodeEnum {
...
export class HealthCheckServicesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class HealthCheckServicesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: HealthCheckServicesScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: HealthCheckServicesScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => HealthCheckServicesScopedListWarningData)
  data?: HealthCheckServicesScopedListWarningData[];
...
export class HealthCheckServicesScopedList extends SpeakeasyBase {
  /**
   * A list of HealthCheckServices contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: HealthCheckService })
  @Expose({ name: "resources" })
  @Type(() => HealthCheckService)
  resources?: HealthCheckService[];
  ...
  warning?: HealthCheckServicesScopedListWarning;
}
