...
exports.DeletePayScheduleTagResponse = exports.DeletePayScheduleTagRequest = void 0;
...
var DeletePayScheduleTagRequest = /** @class */ (function (_super) {
    ...
    ], DeletePayScheduleTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeletePayScheduleTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeletePayScheduleTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayScheduleId",
        }),
        __metadata("design:type", String)
    ], DeletePayScheduleTagRequest.prototype, "payScheduleId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], DeletePayScheduleTagRequest.prototype, "tagId", void 0);
...
var DeletePayScheduleTagResponse = /** @class */ (function (_super) {
    ...
    ], DeletePayScheduleTagResponse.prototype, "rawResponse", void 0);
