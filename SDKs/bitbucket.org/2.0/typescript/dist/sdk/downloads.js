...
var Downloads = /** @class */ (function () {
    ...
    **/
    Downloads.prototype.deleteRepositoriesWorkspaceRepoSlugDownloadsFilename = function (req, config) {
    ...
    **/
    Downloads.prototype.getRepositoriesWorkspaceRepoSlugDownloads = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *     Hello World
    **/
    Downloads.prototype.getRepositoriesWorkspaceRepoSlugDownloadsFilename = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Downloads.prototype.postRepositoriesWorkspaceRepoSlugDownloads = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
