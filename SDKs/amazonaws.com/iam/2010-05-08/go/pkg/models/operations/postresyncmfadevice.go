...
func (e *POSTResyncMFADeviceActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "ResyncMFADevice":
		*e = POSTResyncMFADeviceActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTResyncMFADeviceActionEnum: %s", s)
	}
}
...
func (e *POSTResyncMFADeviceVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2010-05-08":
		*e = POSTResyncMFADeviceVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTResyncMFADeviceVersionEnum: %s", s)
	}
}
