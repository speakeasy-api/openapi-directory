...
class GoogleCloudDialogflowV2beta1SuggestionFaqAnswer:
    r"""Represents suggested answer from \\"frequently asked questions\\"."""
    ...
    r"""Output only. The piece of text from the `source` knowledge base document."""  
    ...
    r"""Output only. The corresponding FAQ question."""  
    source: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('source'), 'exclude': lambda f: f is None }})
    r"""Output only. Indicates which Knowledge Document this answer was extracted from. Format: `projects//locations//agent/knowledgeBases//documents/`."""  
