...
public class UpdateReceivable3PathParams {
    /**
     * quote's internal identifier
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=quoteId")
    public String quoteId;
    public UpdateReceivable3PathParams withQuoteId(String quoteId) {
    ...
    public UpdateReceivable3PathParams withReceivableId(Long receivableId) {
