...
exports.InvoiceAdjustments = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var InvoiceAdjustments = /** @class */ (function () {
    function InvoiceAdjustments(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    InvoiceAdjustments.prototype.objectDeleteInvoiceAdjustment = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ObjectDeleteInvoiceAdjustmentRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/object/invoice-adjustment/{id}", req.pathParams);
    ...
    **/
    InvoiceAdjustments.prototype.objectGetInvoiceAdjustment = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.proxyGetInvoiceAdjustment = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
    ...
    **/
    InvoiceAdjustments.prototype.objectPostInvoiceAdjustment = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ObjectPostInvoiceAdjustmentRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/object/invoice-adjustment";
    ...
    **/
    InvoiceAdjustments.prototype.objectPutInvoiceAdjustment = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.InvoiceAdjustments = InvoiceAdjustments;
