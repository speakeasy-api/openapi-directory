...
class DescribeDocumentClassifierRequest:
    ...
    describe_document_classifier_request: shared_describedocumentclassifierrequest.DescribeDocumentClassifierRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
