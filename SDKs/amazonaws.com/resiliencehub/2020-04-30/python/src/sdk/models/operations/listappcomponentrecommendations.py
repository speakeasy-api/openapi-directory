...
from ..shared import listappcomponentrecommendationsresponse as shared_listappcomponentrecommendationsresponse
...
class ListAppComponentRecommendationsRequest:
    ...
    request_body: ListAppComponentRecommendationsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListAppComponentRecommendationsResponse:
    ...
    list_app_component_recommendations_response: Optional[shared_listappcomponentrecommendationsresponse.ListAppComponentRecommendationsResponse] = dataclasses.field(default=None)
    r"""Success"""  
