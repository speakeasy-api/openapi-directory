...
exports.GetActivePayInstructionsReportOutputResponse = exports.GetActivePayInstructionsReportOutputRequest = void 0;
...
var GetActivePayInstructionsReportOutputRequest = /** @class */ (function (_super) {
    ...
    ], GetActivePayInstructionsReportOutputRequest.prototype, "activeOn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Api-Version",
        }),
        __metadata("design:type", String)
    ], GetActivePayInstructionsReportOutputRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetActivePayInstructionsReportOutputRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EmployeeKey",
        }),
        __metadata("design:type", String)
    ], GetActivePayInstructionsReportOutputRequest.prototype, "employeeKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EmployerKey",
        }),
        __metadata("design:type", String)
    ], GetActivePayInstructionsReportOutputRequest.prototype, "employerKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=FromDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetActivePayInstructionsReportOutputRequest.prototype, "fromDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ToDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetActivePayInstructionsReportOutputRequest.prototype, "toDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Type" }),
        __metadata("design:type", String)
    ], GetActivePayInstructionsReportOutputRequest.prototype, "type", void 0);
...
var GetActivePayInstructionsReportOutputResponse = /** @class */ (function (_super) {
    ...
    ], GetActivePayInstructionsReportOutputResponse.prototype, "rawResponse", void 0);
