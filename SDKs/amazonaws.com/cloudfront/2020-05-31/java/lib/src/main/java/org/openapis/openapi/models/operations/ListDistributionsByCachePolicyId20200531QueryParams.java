...
public class ListDistributionsByCachePolicyId20200531QueryParams {
    /**
    ...
    public ListDistributionsByCachePolicyId20200531QueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListDistributionsByCachePolicyId20200531QueryParams withMaxItems(String maxItems) {
