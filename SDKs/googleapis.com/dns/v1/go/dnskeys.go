...
func (s *dnsKeys) DNSDNSKeysGet(ctx context.Context, request operations.DNSDNSKeysGetRequest) (*operations.DNSDNSKeysGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/dns/v1/projects/{project}/managedZones/{managedZone}/dnsKeys/{dnsKeyId}", request.PathParams, nil)
...
func (s *dnsKeys) DNSDNSKeysList(ctx context.Context, request operations.DNSDNSKeysListRequest) (*operations.DNSDNSKeysListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/dns/v1/projects/{project}/managedZones/{managedZone}/dnsKeys", request.PathParams, nil)
