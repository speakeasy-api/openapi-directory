...
class PutRepositoriesWorkspaceRepoSlugIssuesIssueIDRequest:
    path_params: PutRepositoriesWorkspaceRepoSlugIssuesIssueIDPathParams = dataclasses.field()
    security: PutRepositoriesWorkspaceRepoSlugIssuesIssueIDSecurity = dataclasses.field()
