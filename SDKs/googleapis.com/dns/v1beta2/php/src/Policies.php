...
class Policies 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DnsPoliciesCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1beta2/projects/{project}/policies', \OpenAPI\OpenAPI\Models\Operations\DnsPoliciesCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1beta2/projects/{project}/policies/{policy}', \OpenAPI\OpenAPI\Models\Operations\DnsPoliciesDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1beta2/projects/{project}/policies/{policy}', \OpenAPI\OpenAPI\Models\Operations\DnsPoliciesGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1beta2/projects/{project}/policies', \OpenAPI\OpenAPI\Models\Operations\DnsPoliciesListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1beta2/projects/{project}/policies/{policy}', \OpenAPI\OpenAPI\Models\Operations\DnsPoliciesPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1beta2/projects/{project}/policies/{policy}', \OpenAPI\OpenAPI\Models\Operations\DnsPoliciesUpdateRequest::class, $request);
