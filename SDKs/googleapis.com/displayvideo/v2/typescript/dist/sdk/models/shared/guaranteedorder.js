...
exports.GuaranteedOrder = exports.GuaranteedOrderInput = exports.GuaranteedOrderExchangeEnum = void 0;
var utils_1 = require("../../../internal/utils");
var guaranteedorderstatus_1 = require("./guaranteedorderstatus");
var class_transformer_1 = require("class-transformer");
/**
 * Required. Immutable. The exchange where the guaranteed order originated.
 */
var GuaranteedOrderExchangeEnum;
...
})(GuaranteedOrderExchangeEnum = exports.GuaranteedOrderExchangeEnum || (exports.GuaranteedOrderExchangeEnum = {}));
/**
...
var GuaranteedOrderInput = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "defaultCampaignId" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "readWriteAdvertiserId" }),
        __metadata("design:type", String)
    ], GuaranteedOrderInput.prototype, "readWriteAdvertiserId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "readWritePartnerId" }),
        __metadata("design:type", String)
    ], GuaranteedOrderInput.prototype, "readWritePartnerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "status" }),
        (0, class_transformer_1.Type)(function () { return guaranteedorderstatus_1.GuaranteedOrderStatusInput; }),
        __metadata("design:type", guaranteedorderstatus_1.GuaranteedOrderStatusInput)
    ], GuaranteedOrderInput.prototype, "status", void 0);
    return GuaranteedOrderInput;
}(utils_1.SpeakeasyBase));
exports.GuaranteedOrderInput = GuaranteedOrderInput;
/**
 * A guaranteed order. Guaranteed orders are parent entity of guaranteed inventory sources. When creating a guaranteed inventory source, a guaranteed order ID must be assigned to the inventory source.
 */
var GuaranteedOrder = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "defaultAdvertiserId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "legacyGuaranteedOrderId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "status" }),
        (0, class_transformer_1.Type)(function () { return guaranteedorderstatus_1.GuaranteedOrderStatus; }),
        __metadata("design:type", guaranteedorderstatus_1.GuaranteedOrderStatus)
...
exports.GuaranteedOrder = GuaranteedOrder;
