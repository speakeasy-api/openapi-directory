...
class DfareportingAdvertiserLandingPagesListRequest:
    path_params: DfareportingAdvertiserLandingPagesListPathParams = dataclasses.field()
    query_params: DfareportingAdvertiserLandingPagesListQueryParams = dataclasses.field()
    security: DfareportingAdvertiserLandingPagesListSecurity = dataclasses.field()
