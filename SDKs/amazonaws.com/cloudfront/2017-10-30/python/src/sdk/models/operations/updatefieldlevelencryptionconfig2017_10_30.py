...
class UpdateFieldLevelEncryptionConfig20171030PathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'Id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class UpdateFieldLevelEncryptionConfig20171030Headers:
...
class UpdateFieldLevelEncryptionConfig20171030Request:
    headers: UpdateFieldLevelEncryptionConfig20171030Headers = dataclasses.field()
    path_params: UpdateFieldLevelEncryptionConfig20171030PathParams = dataclasses.field()
