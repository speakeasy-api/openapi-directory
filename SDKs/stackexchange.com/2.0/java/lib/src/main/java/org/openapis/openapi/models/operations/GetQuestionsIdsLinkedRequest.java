...
public class GetQuestionsIdsLinkedRequest {
    ...
    public GetQuestionsIdsLinkedRequest withCallback(String callback) {
    ...
    public GetQuestionsIdsLinkedRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetQuestionsIdsLinkedRequest withFromdate(Long fromdate) {
    ...
    public GetQuestionsIdsLinkedRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetQuestionsIdsLinkedRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetQuestionsIdsLinkedRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetQuestionsIdsLinkedRequest withOrder(GetQuestionsIdsLinkedOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetQuestionsIdsLinkedRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetQuestionsIdsLinkedRequest withPagesize(Long pagesize) {
    ...
    public GetQuestionsIdsLinkedRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetQuestionsIdsLinkedRequest withSort(GetQuestionsIdsLinkedSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetQuestionsIdsLinkedRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetQuestionsIdsLinkedRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
