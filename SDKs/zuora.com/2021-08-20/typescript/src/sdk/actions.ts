...
export class Actions {
  ...
  actionPOSTamend(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ActionPOSTamendResponse =
        new operations.ActionPOSTamendResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.proxyActionamendResponse = utils.objectToClass(
              httpRes?.data,
              shared.ProxyActionamendResponse
            );
          }
          break;
  ...
  actionPOSTcreate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ActionPOSTcreateResponse =
        new operations.ActionPOSTcreateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.saveResults = utils.objectToClass(
              httpRes?.data,
              shared.SaveResult,
              resFieldDepth
            );
  ...
  actionPOSTdelete(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ActionPOSTdeleteResponse =
        new operations.ActionPOSTdeleteResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.deleteResults = [];
            const resFieldDepth: number = utils.getResFieldDepth(res);
            res.deleteResults = utils.objectToClass(
              httpRes?.data,
              shared.DeleteResult,
              resFieldDepth
            );
  ...
  actionPOSTexecute(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ActionPOSTexecuteResponse =
        new operations.ActionPOSTexecuteResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.executeResults = [];
            const resFieldDepth: number = utils.getResFieldDepth(res);
            res.executeResults = utils.objectToClass(
              httpRes?.data,
              shared.ExecuteResult,
              resFieldDepth
            );
          }
          break;
  ...
  actionPOSTgenerate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ActionPOSTgenerateResponse =
        new operations.ActionPOSTgenerateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  actionPOSTquery(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ActionPOSTqueryResponse =
        new operations.ActionPOSTqueryResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.proxyActionqueryResponse = utils.objectToClass(
              httpRes?.data,
              shared.ProxyActionqueryResponse
            );
          }
          break;
        case httpRes?.status == 401:
  ...
  actionPOSTqueryMore(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ActionPOSTqueryMoreResponse =
        new operations.ActionPOSTqueryMoreResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.proxyActionqueryMoreResponse = utils.objectToClass(
              httpRes?.data,
              shared.ProxyActionqueryMoreResponse
            );
          }
          break;
        case httpRes?.status == 401:
  ...
  actionPOSTsubscribe(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ActionPOSTsubscribeResponse =
        new operations.ActionPOSTsubscribeResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            const resFieldDepth: number = utils.getResFieldDepth(res);
            res.subscribeResults = utils.objectToClass(
              httpRes?.data,
  ...
  actionPOSTupdate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ActionPOSTupdateResponse =
        new operations.ActionPOSTupdateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
