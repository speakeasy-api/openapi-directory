...
export class ComputeFutureReservationsUpdateSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ComputeFutureReservationsUpdateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ComputeFutureReservationsUpdateSecurity extends SpeakeasyBase {
...
export class ComputeFutureReservationsUpdateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ComputeFutureReservationsUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
