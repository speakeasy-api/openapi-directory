...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Fitcer(ctx, operations.FitcerRequestBody{
        CertificateParameters: &operations.FitcerRequestBodyCertificateParameters{
            FullName: "Sunil Kumar",
            UID: "123412341234",
        ...
        Format: operations.FitcerRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.FitcerSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.APIs.Rvcer(ctx, operations.RvcerRequestBody{
        CertificateParameters: &operations.RvcerRequestBodyCertificateParameters{
            FullName: "Sunil Kumar",
            UID: "123412341234",
            ChasisNo: "MBLKC12EFBGJ08420. As per your Vehicle Registration Certificate.",
            RegNo: "DL01AA0101. As per your Vehicle Registration Certificate.",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
            Consent: shared.ConsentArtifactSchemaConsent{
                ConsentID: "ea9c43aa-7f5a-4bf3-a0be-e1caa24737ba",
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Vhinsc(ctx, operations.VhinscRequestBody{
        CertificateParameters: &operations.VhinscRequestBodyCertificateParameters{
            FullName: "Sunil Kumar",
            UID: "123412341234",
            ChasisNo: "MA3EJKD1S00A06535",
            RegNo: "DL01AA0101",
            SwdName: "Veer Pratap Singh",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
            Consent: shared.ConsentArtifactSchemaConsent{
                ConsentID: "ea9c43aa-7f5a-4bf3-a0be-e1caa24737ba",
        ...
        Format: operations.VhinscRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.VhinscSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Vhtax(ctx, operations.VhtaxRequestBody{
        CertificateParameters: &operations.VhtaxRequestBodyCertificateParameters{
            FullName: "Sunil Kumar",
            UID: "123412341234",
            ChasisNo: "MBLKC12EFBGJ08420. As per your Vehicle Registration Certificate.",
            RegNo: "DL01AA0101 As per your Vehicle Registration Certificate",
            SwdName: "Person Name. As per your Vehicle Registration Certificate",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
            Consent: shared.ConsentArtifactSchemaConsent{
                ConsentID: "ea9c43aa-7f5a-4bf3-a0be-e1caa24737ba",
        ...
        Format: operations.VhtaxRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.VhtaxSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
