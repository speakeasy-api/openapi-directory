...
import { SslPoliciesScopedList } from "./sslpoliciesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum SslPoliciesAggregatedListWarningCodeEnum {
...
export declare class SslPoliciesAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class SslPoliciesAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: SslPoliciesAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: SslPoliciesAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class SslPoliciesAggregatedList extends SpeakeasyBase {
    etag?: string;
    /**
     ...
     */
    items?: Record<string, SslPoliciesScopedList>;
    /**
