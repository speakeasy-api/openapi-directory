 ...
 */
export declare enum InterconnectAttachmentAggregatedListWarningCodeEnum {
...
export declare class InterconnectAttachmentAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InterconnectAttachmentAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class InterconnectAttachmentAggregatedList extends SpeakeasyBase {
    /**
