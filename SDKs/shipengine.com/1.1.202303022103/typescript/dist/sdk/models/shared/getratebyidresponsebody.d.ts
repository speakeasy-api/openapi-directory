 ...
 */
export declare enum GetRateByIdResponseBodyRateTypeEnum {
    Check = "check",
    Shipment = "shipment"
}
/**
 ...
 */
export declare enum GetRateByIdResponseBodyValidationStatusEnum {
    Valid = "valid",
    Invalid = "invalid",
...
export declare class GetRateByIdResponseBody extends SpeakeasyBase {
     ...
     */
    rateId: string;
    rateType: GetRateByIdResponseBodyRateTypeEnum;
    /**
     ...
     */
    trackable: boolean;
    validationStatus: GetRateByIdResponseBodyValidationStatusEnum;
    /**
