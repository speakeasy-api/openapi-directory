...
var Bca = /** @class */ (function () {
    function Bca(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Bca.prototype.getBusinessCurrentAccounts = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetBusinessCurrentAccountsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/business-current-accounts";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/prs.openbanking.opendata.v1.3+json")) {
                        res.getBusinessCurrentAccounts200ApplicationPrsOpenbankingOpendataV13PlusJsonObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    Bca.prototype.headBusinessCurrentAccounts = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
