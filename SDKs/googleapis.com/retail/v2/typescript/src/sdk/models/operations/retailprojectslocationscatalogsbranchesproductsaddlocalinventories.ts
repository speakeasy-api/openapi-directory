...
export class RetailProjectsLocationsCatalogsBranchesProductsAddLocalInventoriesSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsBranchesProductsAddLocalInventoriesRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsBranchesProductsAddLocalInventoriesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
