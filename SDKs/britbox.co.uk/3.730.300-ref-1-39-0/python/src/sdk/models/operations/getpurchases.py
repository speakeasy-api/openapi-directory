...
from ..shared import purchase as shared_purchase
...
class GetPurchasesResponse:
    ...
    purchases: Optional[list[shared_purchase.Purchase]] = dataclasses.field(default=None)
    r"""A list of all purchases made under the account."""  
