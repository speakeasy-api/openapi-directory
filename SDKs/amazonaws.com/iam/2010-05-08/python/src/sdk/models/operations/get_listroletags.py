...
class GetListRoleTagsQueryParams:
    action: GetListRoleTagsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    role_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'RoleName', 'style': 'form', 'explode': True }})
    version: GetListRoleTagsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListRoleTagsRequest:
    headers: GetListRoleTagsHeaders = dataclasses.field()
    query_params: GetListRoleTagsQueryParams = dataclasses.field()
