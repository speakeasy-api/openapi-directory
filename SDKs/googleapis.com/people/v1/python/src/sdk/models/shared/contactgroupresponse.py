...
class ContactGroupResponse:
    r"""The response for a specific contact group."""
    
    contact_group: Optional[shared_contactgroup.ContactGroup] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contactGroup'), 'exclude': lambda f: f is None }})
    r"""A contact group."""  
    ...
    r"""The original requested resource name."""  
