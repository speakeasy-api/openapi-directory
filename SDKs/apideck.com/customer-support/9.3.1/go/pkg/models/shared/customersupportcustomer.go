...
func (e CustomerSupportCustomerStatusEnum) ToPointer() *CustomerSupportCustomerStatusEnum {
	return &e
}
...
func (e *CustomerSupportCustomerStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "gdpr-erasure-request":
		fallthrough
	case "unknown":
		*e = CustomerSupportCustomerStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CustomerSupportCustomerStatusEnum: %v", v)
	}
}
