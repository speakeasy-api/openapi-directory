...
export class NetworkservicesProjectsLocationsTlsRoutesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworkservicesProjectsLocationsTlsRoutesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworkservicesProjectsLocationsTlsRoutesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
