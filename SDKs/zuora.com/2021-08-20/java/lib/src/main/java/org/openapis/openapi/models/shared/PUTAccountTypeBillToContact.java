...
public class PUTAccountTypeBillToContact {
    ...
    public PUTAccountTypeBillToContact withAddress1(String address1) {
    ...
    public PUTAccountTypeBillToContact withAddress2(String address2) {
    ...
    @JsonProperty("city")
    public String city;
    public PUTAccountTypeBillToContact withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public PUTAccountTypeBillToContact withCountry(String country) {
    ...
    public PUTAccountTypeBillToContact withCounty(String county) {
        this.county = county;
        return this;
    }
    ...
    @JsonProperty("fax")
    public String fax;
    public PUTAccountTypeBillToContact withFax(String fax) {
        this.fax = fax;
        return this;
    }
    ...
    public PUTAccountTypeBillToContact withFirstName(String firstName) {
    ...
    public PUTAccountTypeBillToContact withHomePhone(String homePhone) {
    ...
    public PUTAccountTypeBillToContact withLastName(String lastName) {
    ...
    public PUTAccountTypeBillToContact withMobilePhone(String mobilePhone) {
    ...
    public PUTAccountTypeBillToContact withNickname(String nickname) {
    ...
    public PUTAccountTypeBillToContact withOtherPhone(String otherPhone) {
    ...
    public PUTAccountTypeBillToContact withOtherPhoneType(String otherPhoneType) {
    ...
    public PUTAccountTypeBillToContact withPersonalEmail(String personalEmail) {
    ...
    @JsonProperty("state")
    public String state;
    public PUTAccountTypeBillToContact withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public PUTAccountTypeBillToContact withTaxRegion(String taxRegion) {
    ...
    public PUTAccountTypeBillToContact withWorkEmail(String workEmail) {
    ...
    public PUTAccountTypeBillToContact withWorkPhone(String workPhone) {
    ...
    public PUTAccountTypeBillToContact withZipCode(String zipCode) {
