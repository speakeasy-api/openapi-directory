...
class RealtimebiddingBiddersPretargetingConfigsCreateRequest:
    path_params: RealtimebiddingBiddersPretargetingConfigsCreatePathParams = dataclasses.field()
    query_params: RealtimebiddingBiddersPretargetingConfigsCreateQueryParams = dataclasses.field()
    security: RealtimebiddingBiddersPretargetingConfigsCreateSecurity = dataclasses.field()
    request: Optional[shared_pretargetingconfig.PretargetingConfigInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
