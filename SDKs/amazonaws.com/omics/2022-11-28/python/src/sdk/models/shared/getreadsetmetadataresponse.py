...
from ..shared import readsetfiles as shared_readsetfiles
...
class GetReadSetMetadataResponse:
    ...
    files: Optional[shared_readsetfiles.ReadSetFiles] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('files'), 'exclude': lambda f: f is None }})  
