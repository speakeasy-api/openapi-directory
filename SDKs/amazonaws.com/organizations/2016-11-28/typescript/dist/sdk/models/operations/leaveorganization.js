...
exports.LeaveOrganizationResponse = exports.LeaveOrganizationRequest = exports.LeaveOrganizationXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var LeaveOrganizationXAmzTargetEnum;
...
})(LeaveOrganizationXAmzTargetEnum = exports.LeaveOrganizationXAmzTargetEnum || (exports.LeaveOrganizationXAmzTargetEnum = {}));
var LeaveOrganizationRequest = /** @class */ (function (_super) {
    ...
    ], LeaveOrganizationRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], LeaveOrganizationRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], LeaveOrganizationRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], LeaveOrganizationRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], LeaveOrganizationRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], LeaveOrganizationRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], LeaveOrganizationRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], LeaveOrganizationRequest.prototype, "xAmzTarget", void 0);
    return LeaveOrganizationRequest;
}(utils_1.SpeakeasyBase));
exports.LeaveOrganizationRequest = LeaveOrganizationRequest;
var LeaveOrganizationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], LeaveOrganizationResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.LeaveOrganizationResponse = LeaveOrganizationResponse;
