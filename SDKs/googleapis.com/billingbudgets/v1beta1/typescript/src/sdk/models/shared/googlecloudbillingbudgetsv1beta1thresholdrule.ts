 ...
 */
export enum GoogleCloudBillingBudgetsV1beta1ThresholdRuleSpendBasisEnum {
 ...
 */
export class GoogleCloudBillingBudgetsV1beta1ThresholdRule extends SpeakeasyBase {
  /**
   * Optional. The type of basis used to determine if spend has passed the threshold. Behavior defaults to CURRENT_SPEND if not set.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "spendBasis" })
