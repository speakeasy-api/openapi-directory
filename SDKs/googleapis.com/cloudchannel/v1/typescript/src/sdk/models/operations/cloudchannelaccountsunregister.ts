...
export class CloudchannelAccountsUnregisterSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsUnregisterRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsUnregisterResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
