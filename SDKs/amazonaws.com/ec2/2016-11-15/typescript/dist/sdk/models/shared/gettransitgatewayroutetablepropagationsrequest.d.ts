 ...
 */
export declare class GetTransitGatewayRouteTablePropagationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetTransitGatewayRouteTablePropagationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: GetTransitGatewayRouteTablePropagationsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
