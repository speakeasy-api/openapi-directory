...
var Stats = /** @class */ (function () {
    ...
    **/
    Stats.prototype.getAdvancedTeamGameStats = function (req, config) {
    ...
    **/
    Stats.prototype.getAdvancedTeamSeasonStats = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Stat category list
    **/
    Stats.prototype.getStatCategories = function (config) {
        var baseURL = this._serverURL;
     ...
     * Team season stats
    **/
    Stats.prototype.getTeamSeasonStats = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
