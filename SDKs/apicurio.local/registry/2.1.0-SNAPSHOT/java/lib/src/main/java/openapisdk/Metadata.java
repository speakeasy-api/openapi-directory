...
public class Metadata {
    ...
    **/
    public openapisdk.models.operations.DeleteArtifactVersionMetaDataResponse deleteArtifactVersionMetaData(openapisdk.models.operations.DeleteArtifactVersionMetaDataRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/groups/{groupId}/artifacts/{artifactId}/versions/{version}/meta", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.GetArtifactMetaDataResponse getArtifactMetaData(openapisdk.models.operations.GetArtifactMetaDataRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/groups/{groupId}/artifacts/{artifactId}/meta", request.pathParams);
    ...
    **/
     ...
     * 
    **/
    public openapisdk.models.operations.GetArtifactVersionMetaDataByContentResponse getArtifactVersionMetaDataByContent(openapisdk.models.operations.GetArtifactVersionMetaDataByContentRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/groups/{groupId}/artifacts/{artifactId}/meta", request.pathParams);
        ...
        openapisdk.models.operations.GetArtifactVersionMetaDataByContentResponse res = new openapisdk.models.operations.GetArtifactVersionMetaDataByContentResponse() {{
            versionMetaData = null;
            error = null;
            error = null;
        }};
