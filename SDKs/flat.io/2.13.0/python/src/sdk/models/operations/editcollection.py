...
class EditCollectionRequest:
    ...
    """  
    collection_modification: Optional[shared_collectionmodification.CollectionModification] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
