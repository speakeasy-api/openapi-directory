...
export class DisplayvideoCustomListsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoCustomListsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoCustomListsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
