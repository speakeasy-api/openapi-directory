...
public class CreateCustomerHeaders {
    /**
    ...
    public CreateCustomerHeaders withXSdsDateFormat(CreateCustomerXSdsDateFormatEnum xSdsDateFormat) {
    ...
    public CreateCustomerHeaders withXSdsServiceToken(String xSdsServiceToken) {
