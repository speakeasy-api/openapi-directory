...
class GETListsFormatSortOrderEnum(str, Enum):
    r"""Sets the sort order of the result set"""
    ASC = 'ASC'
    DESC = 'DESC'
...
class GETListsFormatRequest:
    ...
    r"""YYYY-MM-DD  The date the best-seller list was published on NYTimes.com (compare bestsellers-date)"""  
    ...
    list_: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'list', 'style': 'form', 'explode': True }})
...
class GETListsFormat200ApplicationJSONResults:
    ...
    book_details: Optional[list[GETListsFormat200ApplicationJSONResultsBookDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('book_details'), 'exclude': lambda f: f is None }})  
    ...
    isbns: Optional[list[GETListsFormat200ApplicationJSONResultsIsbns]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('isbns'), 'exclude': lambda f: f is None }})  
    ...
    reviews: Optional[list[GETListsFormat200ApplicationJSONResultsReviews]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reviews'), 'exclude': lambda f: f is None }})  
...
class GETListsFormat200ApplicationJSON:
    ...
    results: Optional[list[GETListsFormat200ApplicationJSONResults]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
