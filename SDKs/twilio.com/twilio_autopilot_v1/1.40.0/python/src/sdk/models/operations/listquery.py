...
class ListQueryRequest:
    ...
    r"""The SID of the [Assistant](https://www.twilio.com/docs/autopilot/api/assistant) that is the parent of the resources to read."""  
    ...
    r"""The [ISO language-country](https://docs.oracle.com/cd/E13214_01/wli/docs92/xref/xqisocodes.html) string that specifies the language used by the Query resources to read. For example: `en-US`."""  
    ...
    r"""The status of the resources to read. Can be: `pending-review`, `reviewed`, or `discarded`"""  
...
class ListQueryListQueryResponse:
    ...
    meta: Optional[ListQueryListQueryResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    queries: Optional[list[shared_autopilot_v1_assistant_query.AutopilotV1AssistantQuery]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('queries'), 'exclude': lambda f: f is None }})  
