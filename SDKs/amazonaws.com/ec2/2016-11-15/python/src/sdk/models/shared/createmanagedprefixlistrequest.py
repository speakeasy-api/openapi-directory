...
class CreateManagedPrefixListRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateManagedPrefixListRequestTagSpecifications:
    ...
    resource_type: Optional[CreateManagedPrefixListRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateManagedPrefixListRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateManagedPrefixListRequest:
    
    address_family: str = dataclasses.field()  
    max_entries: int = dataclasses.field()  
    prefix_list_name: str = dataclasses.field()  
    client_token: Optional[str] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    entries: Optional[list[shared_addprefixlistentry.AddPrefixListEntry]] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateManagedPrefixListRequestTagSpecifications]] = dataclasses.field(default=None)  
