...
exports.SuggestStatus = void 0;
var utils_1 = require("../../../internal/utils");
// SuggestStatus
/**
 * Contains the resource id (<code>rid</code>) and the time it took to process the request (<code>timems</code>).
**/
var SuggestStatus = /** @class */ (function (_super) {
    __extends(SuggestStatus, _super);
    function SuggestStatus() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rid" }),
        __metadata("design:type", String)
    ], SuggestStatus.prototype, "rid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timems" }),
