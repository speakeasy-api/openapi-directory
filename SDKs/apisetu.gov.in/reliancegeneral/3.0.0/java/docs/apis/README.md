    ...
    public static void main(String[] args) {
        try {
            ...
            CripcRequestBody req = new CripcRequestBody(CripcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new CripcRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "M", "123", "Policy Copy,Endorsement Copy");;
    ...
    public static void main(String[] args) {
        try {
            ...
            CvipcRequestBody req = new CvipcRequestBody(CvipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new CvipcRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "M", "123", "Policy Copy,Endorsement Copy");;
    ...
    public static void main(String[] args) {
        try {
            ...
            HlipcRequestBody req = new HlipcRequestBody(HlipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HlipcRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "M", "123", "Policy Copy,Endorsement Copy");;
    ...
    public static void main(String[] args) {
        try {
            ...
            MiipcRequestBody req = new MiipcRequestBody(MiipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new MiipcRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "M", "123", "Policy Copy,Endorsement Copy");;
            ...
            MiipcResponse res = sdk.apIs.miipc(req, new MiipcSecurity("culpa", "doloribus") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            TripcRequestBody req = new TripcRequestBody(TripcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new TripcRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "M", "123", "Policy Copy,Endorsement Copy");;
            ...
            TripcResponse res = sdk.apIs.tripc(req, new TripcSecurity("animi", "enim") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            TwipcRequestBody req = new TwipcRequestBody(TwipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new TwipcRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "M", "123", "Policy Copy,Endorsement Copy");;
