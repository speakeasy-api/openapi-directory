...
class CreateReturnLabelResponseBodyOutput
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyDisplaySchemeEnum $displayScheme
     */
	#[\JMS\Serializer\Annotation\SerializedName('display_scheme')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyDisplaySchemeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateReturnLabelResponseBodyDisplaySchemeEnum $displayScheme = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyOptionalLink $formDownload
     */
	#[\JMS\Serializer\Annotation\SerializedName('form_download')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyOptionalLink')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateReturnLabelResponseBodyOptionalLink $formDownload = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyOptionalLink $insuranceClaim
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_claim')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyOptionalLink')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateReturnLabelResponseBodyOptionalLink $insuranceClaim = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyMonetaryValue $insuranceCost
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_cost')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyMonetaryValue')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateReturnLabelResponseBodyMonetaryValue $insuranceCost = null;
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyLabelDownload')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateReturnLabelResponseBodyLabelDownload $labelDownload = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyLabelFormatEnum $labelFormat
     */
	#[\JMS\Serializer\Annotation\SerializedName('label_format')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyLabelFormatEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateReturnLabelResponseBodyLabelFormatEnum $labelFormat = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyLabelLayoutEnum $labelLayout
     */
	#[\JMS\Serializer\Annotation\SerializedName('label_layout')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyLabelLayoutEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateReturnLabelResponseBodyLabelLayoutEnum $labelLayout = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyMonetaryValue $shipmentCost
     */
	#[\JMS\Serializer\Annotation\SerializedName('shipment_cost')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyMonetaryValue')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateReturnLabelResponseBodyMonetaryValue $shipmentCost = null;
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyLabelStatusEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateReturnLabelResponseBodyLabelStatusEnum $status = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyTrackingStatusEnum $trackingStatus
     */
	#[\JMS\Serializer\Annotation\SerializedName('tracking_status')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateReturnLabelResponseBodyTrackingStatusEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateReturnLabelResponseBodyTrackingStatusEnum $trackingStatus = null;
