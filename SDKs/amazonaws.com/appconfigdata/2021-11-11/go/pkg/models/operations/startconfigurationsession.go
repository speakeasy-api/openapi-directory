...
type StartConfigurationSessionHeaders struct {
...
type StartConfigurationSessionRequest struct {
	Headers StartConfigurationSessionHeaders
	Request StartConfigurationSessionRequestBody `request:"mediaType=application/json"`
}
