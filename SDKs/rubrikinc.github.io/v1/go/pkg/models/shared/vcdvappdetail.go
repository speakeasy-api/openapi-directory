...
// VcdVappDetailSLAAssignmentEnum - The SLA assignment type. Direct SLA assignment means that a SLA Domain was configured directly on the Rubrik object by the user. Derived SLA assignment means that the Rubrik object inherits an SLA Domain from its parent Rubrik object.
type VcdVappDetailSLAAssignmentEnum string

const (
	VcdVappDetailSLAAssignmentEnumDerived    VcdVappDetailSLAAssignmentEnum = "Derived"
	VcdVappDetailSLAAssignmentEnumDirect     VcdVappDetailSLAAssignmentEnum = "Direct"
	VcdVappDetailSLAAssignmentEnumUnassigned VcdVappDetailSLAAssignmentEnum = "Unassigned"
)

func (e VcdVappDetailSLAAssignmentEnum) ToPointer() *VcdVappDetailSLAAssignmentEnum {
	return &e
}

func (e *VcdVappDetailSLAAssignmentEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "Direct":
		fallthrough
	case "Unassigned":
		*e = VcdVappDetailSLAAssignmentEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for VcdVappDetailSLAAssignmentEnum: %v", v)
	}
}

// VcdVappDetail - Detailed information about a vApp object.
type VcdVappDetail struct {
	...
	SLAAssignment VcdVappDetailSLAAssignmentEnum `json:"slaAssignment"`
