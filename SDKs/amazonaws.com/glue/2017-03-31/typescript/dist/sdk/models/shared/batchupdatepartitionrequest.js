...
var BatchUpdatePartitionRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: batchupdatepartitionrequestentry_1.BatchUpdatePartitionRequestEntry }),
        (0, class_transformer_1.Expose)({ name: "Entries" }),
        (0, class_transformer_1.Type)(function () { return batchupdatepartitionrequestentry_1.BatchUpdatePartitionRequestEntry; }),
