...
exports.ListUsageTriggerResponse = exports.ListUsageTriggerListUsageTriggerResponse = exports.ListUsageTriggerRequest = exports.ListUsageTriggerSecurity = exports.ListUsageTriggerServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListUsageTriggerServerList = ["https://api.twilio.com"];
var ListUsageTriggerSecurity = /** @class */ (function (_super) {
    ...
    ], ListUsageTriggerSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListUsageTriggerSecurity.prototype, "username", void 0);
...
var ListUsageTriggerRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListUsageTriggerRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListUsageTriggerRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListUsageTriggerRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListUsageTriggerRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Recurring",
        }),
        __metadata("design:type", String)
    ], ListUsageTriggerRequest.prototype, "recurring", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TriggerBy",
        }),
        __metadata("design:type", String)
    ], ListUsageTriggerRequest.prototype, "triggerBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=UsageCategory",
        }),
        __metadata("design:type", String)
    ], ListUsageTriggerRequest.prototype, "usageCategory", void 0);
...
var ListUsageTriggerListUsageTriggerResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ApiV2010AccountUsageUsageTrigger }),
        (0, class_transformer_1.Expose)({ name: "usage_triggers" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountUsageUsageTrigger; }),
...
var ListUsageTriggerResponse = /** @class */ (function (_super) {
    ...
    ], ListUsageTriggerResponse.prototype, "rawResponse", void 0);
