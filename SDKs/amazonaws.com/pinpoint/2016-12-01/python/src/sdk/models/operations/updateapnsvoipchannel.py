...
from ..shared import updateapnsvoipchannelresponse as shared_updateapnsvoipchannelresponse
...
@dataclasses.dataclass
class UpdateApnsVoipChannelHeaders:
...
class UpdateApnsVoipChannelRequestBody:
    apns_voip_channel_request: UpdateApnsVoipChannelRequestBodyApnsVoipChannelRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('APNSVoipChannelRequest') }})
    

@dataclasses.dataclass
class UpdateApnsVoipChannelRequest:
    headers: UpdateApnsVoipChannelHeaders = dataclasses.field()
    path_params: UpdateApnsVoipChannelPathParams = dataclasses.field()
    request: UpdateApnsVoipChannelRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateApnsVoipChannelResponse:
    ...
    update_apns_voip_channel_response: Optional[shared_updateapnsvoipchannelresponse.UpdateApnsVoipChannelResponse] = dataclasses.field(default=None)
