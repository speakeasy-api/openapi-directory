...
class OsconfigProjectsGuestPoliciesCreateRequest
{
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\GuestPolicyInput $guestPolicyInput = null;
     ...
     * 
     * @var ?string $guestPolicyId
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=guestPolicyId')]
    public ?string $guestPolicyId = null;
