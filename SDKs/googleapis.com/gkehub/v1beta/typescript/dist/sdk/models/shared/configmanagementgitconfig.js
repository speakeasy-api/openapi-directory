...
exports.ConfigManagementGitConfig = void 0;
var utils_1 = require("../../../internal/utils");
// ConfigManagementGitConfig
/**
 * Git repo configuration for a single cluster.
**/
var ConfigManagementGitConfig = /** @class */ (function (_super) {
    __extends(ConfigManagementGitConfig, _super);
    function ConfigManagementGitConfig() {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=httpsProxy" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=syncBranch" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=syncRev" }),
        __metadata("design:type", String)
...
exports.ConfigManagementGitConfig = ConfigManagementGitConfig;
