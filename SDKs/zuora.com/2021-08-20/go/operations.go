...
func (s *Operations) PostBillingPreview(ctx context.Context, request operations.PostBillingPreviewRequest) (*operations.PostBillingPreviewResponse, error) {
...
func (s *Operations) PostTransactionInvoicePayment(ctx context.Context, request operations.PostTransactionInvoicePaymentRequest) (*operations.PostTransactionInvoicePaymentResponse, error) {
	baseURL := s._serverURL
