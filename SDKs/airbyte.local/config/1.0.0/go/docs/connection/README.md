...
func main() {
    ...
    res, err := s.Connection.CreateConnection(ctx, shared.ConnectionCreate{
        ...
        Prefix: sdk.String("laborum"),
        ResourceRequirements: &shared.ResourceRequirements{
            CPULimit: sdk.String("accusamus"),
            CPURequest: sdk.String("non"),
            MemoryLimit: sdk.String("occaecati"),
            MemoryRequest: sdk.String("enim"),
        },
        ...
        SourceCatalogID: sdk.String("8f3a6699-7074-4ba4-869b-6e2141959890"),
...
func main() {
    ...
    res, err := s.Connection.SearchConnections(ctx, shared.ConnectionSearch{
        ConnectionID: sdk.String("14429074-7477-48a7-bd46-6d28c10ab3cd"),
        Destination: &shared.DestinationSearch{
            ConnectionConfiguration: sdk.String("quo"),
            DestinationDefinitionID: sdk.String("a4251904-e523-4c7e-8bc7-178e4796f2a7"),
            DestinationID: sdk.String("0c688282-aa48-4256-af22-2e9817ee17cb"),
            DestinationName: sdk.String("vero"),
            Name: sdk.String("Frances Turner"),
            WorkspaceID: sdk.String("7b95bc0a-b3c2-40c4-b378-9fd871f99dd2"),
        },
        DestinationID: sdk.String("efd121aa-6f1e-4674-bdb0-4f15756082d6"),
        ...
        Source: &shared.SourceSearch{
            ConnectionConfiguration: sdk.String("iste"),
            Name: sdk.String("Ms. Kenneth Ledner"),
            SourceDefinitionID: sdk.String("a1840394-c260-471f-93f5-f0642dac7af5"),
            SourceID: sdk.String("15cc413a-a63a-4ae8-9678-64dbb675fd5e"),
            SourceName: sdk.String("aliquid"),
            WorkspaceID: sdk.String("0b375ed4-f6fb-4ee4-9f33-317fe35b60eb"),
        },
        SourceID: sdk.String("1ea42655-5ba3-4c28-b44e-d53b88f3a8d8"),
...
func main() {
    ...
    res, err := s.Connection.UpdateConnection(ctx, shared.ConnectionUpdate{
        ...
        ResourceRequirements: &shared.ResourceRequirements{
            CPULimit: sdk.String("enim"),
            CPURequest: sdk.String("laboriosam"),
            MemoryLimit: sdk.String("velit"),
            MemoryRequest: sdk.String("a"),
        },
        Schedule: &shared.ConnectionSchedule{
        ...
        ScheduleType: shared.ConnectionScheduleTypeEnumBasic.ToPointer(),
        SourceCatalogID: sdk.String("73e922a5-7a15-4be3-a060-807e2b6e3ab8"),
