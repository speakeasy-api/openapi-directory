...
from ..shared import getsegmentversionsresponse as shared_getsegmentversionsresponse


@dataclasses.dataclass
class GetSegmentVersionsPathParams:
...
@dataclasses.dataclass
class GetSegmentVersionsQueryParams:
...
@dataclasses.dataclass
class GetSegmentVersionsHeaders:
...
class GetSegmentVersionsRequest:
    headers: GetSegmentVersionsHeaders = dataclasses.field()
    path_params: GetSegmentVersionsPathParams = dataclasses.field()
    query_params: GetSegmentVersionsQueryParams = dataclasses.field()
...
class GetSegmentVersionsResponse:
    ...
    get_segment_versions_response: Optional[shared_getsegmentversionsresponse.GetSegmentVersionsResponse] = dataclasses.field(default=None)
