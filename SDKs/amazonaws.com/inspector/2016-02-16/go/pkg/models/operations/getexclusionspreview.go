...
func (e GetExclusionsPreviewXAmzTargetEnum) ToPointer() *GetExclusionsPreviewXAmzTargetEnum {
	return &e
}
...
func (e *GetExclusionsPreviewXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "InspectorService.GetExclusionsPreview":
		*e = GetExclusionsPreviewXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetExclusionsPreviewXAmzTargetEnum: %v", v)
	}
}
