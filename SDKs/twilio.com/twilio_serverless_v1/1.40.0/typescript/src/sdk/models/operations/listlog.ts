...
export const ListLogServerList = ["https://serverless.twilio.com"] as const;
...
export class ListLogListLogResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.ServerlessV1ServiceEnvironmentLog })
  @Expose({ name: "logs" })
  @Type(() => shared.ServerlessV1ServiceEnvironmentLog)
  logs?: shared.ServerlessV1ServiceEnvironmentLog[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListLogListLogResponseMeta)
