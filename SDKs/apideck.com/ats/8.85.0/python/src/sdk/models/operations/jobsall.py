...
class JobsAllRequest:
    headers: JobsAllHeaders = dataclasses.field()
    query_params: JobsAllQueryParams = dataclasses.field()
    security: JobsAllSecurity = dataclasses.field()
