...
class ListSyncListRequest:
    ...
    r"""The SID of the [Sync Service](https://www.twilio.com/docs/sync/api/service) with the Sync List resources to read."""  
...
class ListSyncListListSyncListResponse:
    ...
    lists: Optional[list[shared_sync_v1_service_sync_list.SyncV1ServiceSyncList]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lists'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListSyncListListSyncListResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
