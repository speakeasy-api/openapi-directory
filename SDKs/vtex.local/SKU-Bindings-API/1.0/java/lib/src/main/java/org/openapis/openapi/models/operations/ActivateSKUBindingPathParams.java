...
public class ActivateSKUBindingPathParams {
    /**
    ...
    public ActivateSKUBindingPathParams withSellerId(String sellerId) {
    ...
    public ActivateSKUBindingPathParams withSkuSellerId(String skuSellerId) {
