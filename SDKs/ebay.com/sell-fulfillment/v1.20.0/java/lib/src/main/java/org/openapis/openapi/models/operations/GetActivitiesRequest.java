...
public class GetActivitiesRequest {
    ...
    public GetActivitiesRequest withPaymentDisputeId(String paymentDisputeId) {
        this.paymentDisputeId = paymentDisputeId;
        return this;
    }
    
    public GetActivitiesRequest(@JsonProperty("payment_dispute_id") String paymentDisputeId) {
        this.paymentDisputeId = paymentDisputeId;
  }
}
