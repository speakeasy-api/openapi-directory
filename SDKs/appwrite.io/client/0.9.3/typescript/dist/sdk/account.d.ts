...
export declare class Account {
     ...
     */
    accountCreate(req: operations.AccountCreateRequestBody, security: operations.AccountCreateSecurity, config?: AxiosRequestConfig): Promise<operations.AccountCreateResponse>;
    /**
     ...
     */
    accountCreateAnonymousSession(config?: AxiosRequestConfig): Promise<operations.AccountCreateAnonymousSessionResponse>;
    /**
     * Create Account JWT
     *
     * @remarks
     ...
     */
    accountCreateJWT(config?: AxiosRequestConfig): Promise<operations.AccountCreateJWTResponse>;
    /**
     ...
     *
     */
    accountCreateOAuth2Session(req: operations.AccountCreateOAuth2SessionRequest, security: operations.AccountCreateOAuth2SessionSecurity, config?: AxiosRequestConfig): Promise<operations.AccountCreateOAuth2SessionResponse>;
    /**
     ...
     */
    accountCreateSession(req: operations.AccountCreateSessionRequestBody, security: operations.AccountCreateSessionSecurity, config?: AxiosRequestConfig): Promise<operations.AccountCreateSessionResponse>;
    /**
