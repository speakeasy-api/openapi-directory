...
type FileProjectsLocationsBackupsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type FileProjectsLocationsBackupsCreatePathParams struct {
...
type FileProjectsLocationsBackupsCreateQueryParams struct {
	// V1 error format.
...
type FileProjectsLocationsBackupsCreateRequest struct {
...
type FileProjectsLocationsBackupsCreateResponse struct {
	ContentType string
	// Successful response
