...
export class DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum {
...
export class DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsGetResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
