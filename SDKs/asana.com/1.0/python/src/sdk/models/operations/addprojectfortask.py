...
class AddProjectForTaskRequestBody:
    ...
    data: Optional[shared_taskaddprojectrequest.TaskAddProjectRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
    

@dataclasses.dataclass
class AddProjectForTaskRequest:
    
    request_body: AddProjectForTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The project to add the task to."""  
...
class AddProjectForTask200ApplicationJSON:
    r"""Successfully added the specified project to the task."""
