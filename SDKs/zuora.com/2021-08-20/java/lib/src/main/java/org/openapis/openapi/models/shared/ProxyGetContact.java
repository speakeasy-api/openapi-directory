...
/**
 * ProxyGetContact - Container for custom fields of a Contact object.
 * 
 */
public class ProxyGetContact {
    /**
    ...
    public ProxyGetContact withAccountId(String accountId) {
    ...
    public ProxyGetContact withAddress1(String address1) {
    ...
    public ProxyGetContact withAddress2(String address2) {
    ...
    @JsonProperty("City")
    public String city;
    public ProxyGetContact withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public ProxyGetContact withCountry(String country) {
    ...
    public ProxyGetContact withCounty(String county) {
        this.county = county;
        return this;
    }
    ...
    public ProxyGetContact withCreatedById(String createdById) {
    ...
    public ProxyGetContact withCreatedDate(OffsetDateTime createdDate) {
    ...
    public ProxyGetContact withDescription(String description) {
    ...
    @JsonProperty("Fax")
    public String fax;
    public ProxyGetContact withFax(String fax) {
        this.fax = fax;
        return this;
    }
    ...
    public ProxyGetContact withFirstName(String firstName) {
    ...
    public ProxyGetContact withHomePhone(String homePhone) {
    ...
    @JsonProperty("Id")
    public String id;
    public ProxyGetContact withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ProxyGetContact withLastName(String lastName) {
    ...
    public ProxyGetContact withMobilePhone(String mobilePhone) {
    ...
    public ProxyGetContact withNickName(String nickName) {
    ...
    public ProxyGetContact withOtherPhone(String otherPhone) {
    ...
    public ProxyGetContact withOtherPhoneType(String otherPhoneType) {
    ...
    public ProxyGetContact withPersonalEmail(String personalEmail) {
    ...
    public ProxyGetContact withPostalCode(String postalCode) {
    ...
    @JsonProperty("State")
    public String state;
    public ProxyGetContact withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public ProxyGetContact withTaxRegion(String taxRegion) {
    ...
    public ProxyGetContact withUpdatedById(String updatedById) {
    ...
    public ProxyGetContact withUpdatedDate(OffsetDateTime updatedDate) {
    ...
    public ProxyGetContact withWorkEmail(String workEmail) {
    ...
    public ProxyGetContact withWorkPhone(String workPhone) {
