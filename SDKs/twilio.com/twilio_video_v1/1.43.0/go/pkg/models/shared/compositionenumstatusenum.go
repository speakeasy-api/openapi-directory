...
func (e CompositionEnumStatusEnum) ToPointer() *CompositionEnumStatusEnum {
	return &e
}
...
func (e *CompositionEnumStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "deleted":
		fallthrough
	case "failed":
		*e = CompositionEnumStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CompositionEnumStatusEnum: %v", v)
	}
}
