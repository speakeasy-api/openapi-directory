...
class DescribeFeatureTransformationRequest:
    ...
    describe_feature_transformation_request: shared_describefeaturetransformationrequest.DescribeFeatureTransformationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
