...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateBlobRequest req = new GitCreateBlobRequest(                new GitCreateBlobRequestBody("tenetur") {{
                                encoding = "amet";
                            }};, "tempore", "accusamus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateCommitRequest req = new GitCreateCommitRequest(                new GitCreateCommitRequestBody("numquam", "enim") {{
                                author = new GitCreateCommitRequestBodyAuthor("dolorem", "sapiente") {{
                                    date = OffsetDateTime.parse("2022-01-21T14:54:44.081Z");
                                }};;
                                committer = new GitCreateCommitRequestBodyCommitter() {{
                                    date = OffsetDateTime.parse("2022-04-16T06:31:32.314Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateRefRequest req = new GitCreateRefRequest(                new GitCreateRefRequestBody("dolores", "distinctio") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateTagRequest req = new GitCreateTagRequest(                new GitCreateTagRequestBody("quam", "molestias", "temporibus", GitCreateTagRequestBodyTypeEnum.COMMIT) {{
                                tagger = new GitCreateTagRequestBodyTagger("neque", "fugit") {{
                                    date = OffsetDateTime.parse("2022-07-06T20:37:36.497Z");
                                }};;
                            }};, "sunt", "ullam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitDeleteRefRequest req = new GitDeleteRefRequest("adipisci", "dolorum", "architecto");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetBlobRequest req = new GitGetBlobRequest("quae", "aut", "quas");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetCommitRequest req = new GitGetCommitRequest("itaque", "consequatur", "est");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetRefRequest req = new GitGetRefRequest("repellendus", "porro", "doloribus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetTagRequest req = new GitGetTagRequest("ut", "facilis", "cupiditate");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetTreeRequest req = new GitGetTreeRequest("qui", "quae", "laudantium") {{
                recursive = "odio";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitListMatchingRefsRequest req = new GitListMatchingRefsRequest("occaecati", "voluptatibus", "quisquam") {{
                page = 876506L;
                perPage = 606476L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitUpdateRefRequest req = new GitUpdateRefRequest(                new GitUpdateRefRequestBody("quis") {{
                                force = false;
