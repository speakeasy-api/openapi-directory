 ...
 */
export declare enum InstanceTemplateListWarningCodeEnum {
...
export declare class InstanceTemplateListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InstanceTemplateListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InstanceTemplateListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InstanceTemplateListWarningData[];
    /**
 ...
 */
export declare class InstanceTemplateList extends SpeakeasyBase {
    /**
