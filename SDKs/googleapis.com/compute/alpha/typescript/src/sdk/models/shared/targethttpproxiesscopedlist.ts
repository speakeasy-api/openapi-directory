 ...
 */
export enum TargetHttpProxiesScopedListWarningCodeEnum {
...
export class TargetHttpProxiesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetHttpProxiesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: TargetHttpProxiesScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: TargetHttpProxiesScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => TargetHttpProxiesScopedListWarningData)
  data?: TargetHttpProxiesScopedListWarningData[];
...
export class TargetHttpProxiesScopedList extends SpeakeasyBase {
  /**
   * A list of TargetHttpProxies contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: TargetHttpProxy })
  @Expose({ name: "targetHttpProxies" })
