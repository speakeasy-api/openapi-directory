...
class ContinueAsNewWorkflowExecutionDecisionAttributes:
    r"""ContinueAsNewWorkflowExecutionDecisionAttributes
    ...
    workflow_type_version: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('workflowTypeVersion') }})
