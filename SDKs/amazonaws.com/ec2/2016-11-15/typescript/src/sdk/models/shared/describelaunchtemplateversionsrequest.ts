 ...
 */
export class DescribeLaunchTemplateVersionsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeLaunchTemplateVersionsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeLaunchTemplateVersionsRequestFilters })
