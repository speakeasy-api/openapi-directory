...
public class CancelGiftCardTransactionHeaders {
    /**
    ...
    public CancelGiftCardTransactionHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public CancelGiftCardTransactionHeaders withContentType(String contentType) {
