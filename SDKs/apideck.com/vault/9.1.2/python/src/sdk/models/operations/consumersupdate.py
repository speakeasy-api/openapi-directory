...
from ..shared import updateconsumerrequest as shared_updateconsumerrequest
from ..shared import updateconsumerresponse as shared_updateconsumerresponse
from typing import Optional


@dataclasses.dataclass
class ConsumersUpdateSecurity:
...
class ConsumersUpdateRequest:
    ...
    update_consumer_request: shared_updateconsumerrequest.UpdateConsumerRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ConsumersUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_consumer_response: Optional[shared_updateconsumerresponse.UpdateConsumerResponse] = dataclasses.field(default=None)
    r"""Consumer updated"""  
