...
var Ontology = /** @class */ (function () {
    ...
    **/
    Ontology.prototype.getOntDagsUsingGet = function (req, config) {
    ...
    **/
    Ontology.prototype.getTermUsingGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Ontology.prototype.isDescendantOfUsingGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
