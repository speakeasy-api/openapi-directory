...
var User = /** @class */ (function () {
    ...
    User.prototype.apiKeyOwner = function (config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.ApiKeyOwnerResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.apiKeyOwner200ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.ApiKeyOwner200ApplicationJSON);
                    }
                    break;
            }
            return res;
