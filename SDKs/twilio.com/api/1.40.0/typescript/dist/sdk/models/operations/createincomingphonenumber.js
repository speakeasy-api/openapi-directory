...
exports.CreateIncomingPhoneNumberResponse = exports.CreateIncomingPhoneNumberRequest = exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequest = exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestVoiceMethodEnum = exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestVoiceFallbackMethodEnum = exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestStatusCallbackMethodEnum = exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestSmsMethodEnum = exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestSmsFallbackMethodEnum = exports.CreateIncomingPhoneNumberSecurity = exports.CreateIncomingPhoneNumberServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.CreateIncomingPhoneNumberServerList = [
...
var CreateIncomingPhoneNumberSecurity = /** @class */ (function (_super) {
    ...
    ], CreateIncomingPhoneNumberSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], CreateIncomingPhoneNumberSecurity.prototype, "username", void 0);
    return CreateIncomingPhoneNumberSecurity;
}(utils_1.SpeakeasyBase));
exports.CreateIncomingPhoneNumberSecurity = CreateIncomingPhoneNumberSecurity;
/**
 * The HTTP method that we should use to call `sms_fallback_url`. Can be: `GET` or `POST` and defaults to `POST`.
 */
var CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestSmsFallbackMethodEnum;
...
})(CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestSmsFallbackMethodEnum = exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestSmsFallbackMethodEnum || (exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestSmsFallbackMethodEnum = {}));
/**
 * The HTTP method that we should use to call `sms_url`. Can be: `GET` or `POST` and defaults to `POST`.
 */
var CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestSmsMethodEnum;
...
})(CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestSmsMethodEnum = exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestSmsMethodEnum || (exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestSmsMethodEnum = {}));
/**
 * The HTTP method we should use to call `status_callback`. Can be: `GET` or `POST` and defaults to `POST`.
 */
var CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestStatusCallbackMethodEnum;
...
})(CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestStatusCallbackMethodEnum = exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestStatusCallbackMethodEnum || (exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestStatusCallbackMethodEnum = {}));
/**
 * The HTTP method that we should use to call `voice_fallback_url`. Can be: `GET` or `POST` and defaults to `POST`.
 */
var CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestVoiceFallbackMethodEnum;
...
})(CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestVoiceFallbackMethodEnum = exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestVoiceFallbackMethodEnum || (exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestVoiceFallbackMethodEnum = {}));
/**
 * The HTTP method that we should use to call `voice_url`. Can be: `GET` or `POST` and defaults to `POST`.
 */
var CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestVoiceMethodEnum;
...
})(CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestVoiceMethodEnum = exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestVoiceMethodEnum || (exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequestVoiceMethodEnum = {}));
var CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=AreaCode" }),
        __metadata("design:type", String)
...
exports.CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequest = CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequest;
var CreateIncomingPhoneNumberRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CreateIncomingPhoneNumberRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "request, media_type=application/x-www-form-urlencoded",
        }),
        __metadata("design:type", CreateIncomingPhoneNumberCreateIncomingPhoneNumberRequest)
    ], CreateIncomingPhoneNumberRequest.prototype, "requestBody", void 0);
    return CreateIncomingPhoneNumberRequest;
}(utils_1.SpeakeasyBase));
exports.CreateIncomingPhoneNumberRequest = CreateIncomingPhoneNumberRequest;
var CreateIncomingPhoneNumberResponse = /** @class */ (function (_super) {
    ...
    ], CreateIncomingPhoneNumberResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.CreateIncomingPhoneNumberResponse = CreateIncomingPhoneNumberResponse;
