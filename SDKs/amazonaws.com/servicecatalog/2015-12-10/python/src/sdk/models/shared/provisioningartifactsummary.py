...
class ProvisioningArtifactSummary:
    r"""Summary information about a provisioning artifact (also known as a version) for a product."""
    ...
    provisioning_artifact_metadata: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ProvisioningArtifactMetadata'), 'exclude': lambda f: f is None }})  
