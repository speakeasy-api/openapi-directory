...
var BatchStopJobRunResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: batchstopjobrunerror_1.BatchStopJobRunError }),
        (0, class_transformer_1.Expose)({ name: "Errors" }),
        (0, class_transformer_1.Type)(function () { return batchstopjobrunerror_1.BatchStopJobRunError; }),
        __metadata("design:type", Array)
    ], BatchStopJobRunResponse.prototype, "errors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: batchstopjobrunsuccessfulsubmission_1.BatchStopJobRunSuccessfulSubmission }),
        (0, class_transformer_1.Expose)({ name: "SuccessfulSubmissions" }),
        (0, class_transformer_1.Type)(function () { return batchstopjobrunsuccessfulsubmission_1.BatchStopJobRunSuccessfulSubmission; }),
        __metadata("design:type", Array)
