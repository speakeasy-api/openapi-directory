...
exports.GetPresidentialContributionsByStateResponse = exports.GetPresidentialContributionsByStateRequest = void 0;
...
var GetPresidentialContributionsByStateRequest = /** @class */ (function (_super) {
    ...
    ], GetPresidentialContributionsByStateRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=candidate_id",
        }),
        __metadata("design:type", Array)
    ], GetPresidentialContributionsByStateRequest.prototype, "candidateId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=election_year",
        }),
        __metadata("design:type", Array)
    ], GetPresidentialContributionsByStateRequest.prototype, "electionYear", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetPresidentialContributionsByStateRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetPresidentialContributionsByStateRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetPresidentialContributionsByStateRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_hide_null",
        }),
        __metadata("design:type", Boolean)
    ], GetPresidentialContributionsByStateRequest.prototype, "sortHideNull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_null_only",
        }),
        __metadata("design:type", Boolean)
    ], GetPresidentialContributionsByStateRequest.prototype, "sortNullOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_nulls_last",
        }),
        __metadata("design:type", Boolean)
    ], GetPresidentialContributionsByStateRequest.prototype, "sortNullsLast", void 0);
...
var GetPresidentialContributionsByStateResponse = /** @class */ (function (_super) {
    ...
    ], GetPresidentialContributionsByStateResponse.prototype, "rawResponse", void 0);
