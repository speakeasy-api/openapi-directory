...
class ComputeInstancesSetShieldedVmIntegrityPolicyRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\ShieldedVmIntegrityPolicy $shieldedVmIntegrityPolicy = null;
