...
class ConferenceHangupResponseMessageEnum(str, Enum):
    r"""Response message"""
...
class ConferenceHangupResponse:
    ...
    message: ConferenceHangupResponseMessageEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Message') }})
    r"""Response message"""  
