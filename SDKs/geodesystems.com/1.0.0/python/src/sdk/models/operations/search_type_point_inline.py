...
class SearchTypePointInlineQueryParams:
...
@dataclasses.dataclass
class SearchTypePointInlineRequest:
    query_params: SearchTypePointInlineQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypePointInlineResponse:
