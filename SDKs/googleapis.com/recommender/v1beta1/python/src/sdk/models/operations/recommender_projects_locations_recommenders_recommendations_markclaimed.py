...
from ..shared import security as shared_security
from ..shared import googlecloudrecommenderv1beta1markrecommendationclaimedrequest as shared_googlecloudrecommenderv1beta1markrecommendationclaimedrequest
...
class RecommenderProjectsLocationsRecommendersRecommendationsMarkClaimedRequest:
    ...
    request: Optional[shared_googlecloudrecommenderv1beta1markrecommendationclaimedrequest.GoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
