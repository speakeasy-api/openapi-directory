...
class GooglePrivacyDlpV2ReplaceValueConfig:
    ...
    new_value: Optional[shared_googleprivacydlpv2value.GooglePrivacyDlpV2Value] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('newValue'), 'exclude': lambda f: f is None }})
