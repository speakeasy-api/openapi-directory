 ...
 */
export declare class AuditLogAPI {
     ...
     */
    getAuditLogEvents(req: operations.GetAuditLogEventsRequest, config?: AxiosRequestConfig): Promise<operations.GetAuditLogEventsResponse>;
}
