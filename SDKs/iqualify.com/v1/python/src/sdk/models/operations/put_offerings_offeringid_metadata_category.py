...
class PutOfferingsOfferingIDMetadataCategoryRequest:
    path_params: PutOfferingsOfferingIDMetadataCategoryPathParams = dataclasses.field()
    request: PutOfferingsOfferingIDMetadataCategoryRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
