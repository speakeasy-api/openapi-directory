...
exports.RestoreTableToPointInTimeResponse = exports.RestoreTableToPointInTimeRequest = exports.RestoreTableToPointInTimeXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var RestoreTableToPointInTimeXAmzTargetEnum;
...
})(RestoreTableToPointInTimeXAmzTargetEnum = exports.RestoreTableToPointInTimeXAmzTargetEnum || (exports.RestoreTableToPointInTimeXAmzTargetEnum = {}));
var RestoreTableToPointInTimeRequest = /** @class */ (function (_super) {
    ...
    ], RestoreTableToPointInTimeRequest.prototype, "restoreTableToPointInTimeInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], RestoreTableToPointInTimeRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], RestoreTableToPointInTimeRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], RestoreTableToPointInTimeRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], RestoreTableToPointInTimeRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], RestoreTableToPointInTimeRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], RestoreTableToPointInTimeRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], RestoreTableToPointInTimeRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], RestoreTableToPointInTimeRequest.prototype, "xAmzTarget", void 0);
    return RestoreTableToPointInTimeRequest;
}(utils_1.SpeakeasyBase));
exports.RestoreTableToPointInTimeRequest = RestoreTableToPointInTimeRequest;
var RestoreTableToPointInTimeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], RestoreTableToPointInTimeResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.RestoreTableToPointInTimeResponse = RestoreTableToPointInTimeResponse;
