...
type VmmigrationProjectsLocationsSourcesMigratingVmsReplicationCyclesListPathParams struct {
	// Required. The parent, which owns this collection of ReplicationCycles.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type VmmigrationProjectsLocationsSourcesMigratingVmsReplicationCyclesListQueryParams struct {
	// V1 error format.
