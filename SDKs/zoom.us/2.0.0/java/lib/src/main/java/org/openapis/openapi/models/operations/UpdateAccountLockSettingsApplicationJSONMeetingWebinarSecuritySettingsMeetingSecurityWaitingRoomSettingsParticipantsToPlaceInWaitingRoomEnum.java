 ...
 */
public enum UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurityWaitingRoomSettingsParticipantsToPlaceInWaitingRoomEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2");
    ...
    private UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurityWaitingRoomSettingsParticipantsToPlaceInWaitingRoomEnum(String value) {
        this.value = value;
    }
}
