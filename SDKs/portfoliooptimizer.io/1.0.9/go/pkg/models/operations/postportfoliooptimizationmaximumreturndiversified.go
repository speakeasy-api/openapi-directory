...
type PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints struct {
	...
	DeltaReturn *float64 `json:"deltaReturn,omitempty"`
	// The relative tolerance over the maximum return portfolio volatility, if applicable
	DeltaVolatility *float64 `json:"deltaVolatility,omitempty"`
...
type PostPortfolioOptimizationMaximumReturnDiversifiedRequestBody struct {
	...
	Constraints   *PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints `json:"constraints,omitempty"`
}

type PostPortfolioOptimizationMaximumReturnDiversifiedRequest struct {
	Request PostPortfolioOptimizationMaximumReturnDiversifiedRequestBody `request:"mediaType=application/json"`
}

// PostPortfolioOptimizationMaximumReturnDiversified200ApplicationJSON - OK
type PostPortfolioOptimizationMaximumReturnDiversified200ApplicationJSON struct {
	// assetsWeights[i] is the weight of the asset i in the portfolio, in percentage
	AssetsWeights []float64 `json:"assetsWeights"`
}

type PostPortfolioOptimizationMaximumReturnDiversifiedResponse struct {
	ContentType string
	StatusCode  int
