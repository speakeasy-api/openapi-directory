...
export enum ListNotebookMetadataXAmzTargetEnum {
  AmazonAthenaListNotebookMetadata = "AmazonAthena.ListNotebookMetadata",
}

export class ListNotebookMetadataRequest extends SpeakeasyBase {
...
export class ListNotebookMetadataResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
