...
from ..shared import security as shared_security
from ..shared import trackcountryavailability as shared_trackcountryavailability
...
class AndroidpublisherEditsCountryavailabilityGetRequest:
    path_params: AndroidpublisherEditsCountryavailabilityGetPathParams = dataclasses.field()
    query_params: AndroidpublisherEditsCountryavailabilityGetQueryParams = dataclasses.field()
    security: AndroidpublisherEditsCountryavailabilityGetSecurity = dataclasses.field()
...
class AndroidpublisherEditsCountryavailabilityGetResponse:
    ...
    track_country_availability: Optional[shared_trackcountryavailability.TrackCountryAvailability] = dataclasses.field(default=None)
