...
type ApplicationDetail2 struct {
	ApplicationARN                                 string                                          `json:"ApplicationARN"`
	ApplicationConfigurationDescription            *ApplicationConfigurationDescription1           `json:"ApplicationConfigurationDescription,omitempty"`
