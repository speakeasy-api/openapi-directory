...
var VerificationTokens = /** @class */ (function () {
    function VerificationTokens(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    VerificationTokens.prototype.mybusinessverificationsVerificationTokensGenerate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MybusinessverificationsVerificationTokensGenerateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/verificationTokens:generate";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.generateVerificationTokenResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
