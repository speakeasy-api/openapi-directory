...
class GoogleCloudChannelV1Column:
    ...
    data_type: Optional[GoogleCloudChannelV1ColumnDataTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dataType') }})
