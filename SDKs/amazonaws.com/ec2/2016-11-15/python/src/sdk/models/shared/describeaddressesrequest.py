...
class DescribeAddressesRequestFilters:
...
class DescribeAddressesRequest:
    ...
    filters: Optional[list[DescribeAddressesRequestFilters]] = dataclasses.field(default=None)  
    public_ips: Optional[list[str]] = dataclasses.field(default=None)  
