...
func (s *campaign) CloneCampaign(ctx context.Context, request operations.CloneCampaignRequest, security operations.CloneCampaignSecurity) (*operations.CloneCampaignResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/clone", request, nil)
	if err != nil {
...
func (s *campaign) DeleteCampaign(ctx context.Context, request operations.DeleteCampaignRequest, security operations.DeleteCampaignSecurity) (*operations.DeleteCampaignResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *campaign) EndCampaign(ctx context.Context, request operations.EndCampaignRequest, security operations.EndCampaignSecurity) (*operations.EndCampaignResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/end", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *campaign) PauseCampaign(ctx context.Context, request operations.PauseCampaignRequest, security operations.PauseCampaignSecurity) (*operations.PauseCampaignResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/pause", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *campaign) ResumeCampaign(ctx context.Context, request operations.ResumeCampaignRequest, security operations.ResumeCampaignSecurity) (*operations.ResumeCampaignResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/resume", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *campaign) SuggestItems(ctx context.Context, request operations.SuggestItemsRequest, security operations.SuggestItemsSecurity) (*operations.SuggestItemsResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/suggest_items", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *campaign) UpdateAdRateStrategy(ctx context.Context, request operations.UpdateAdRateStrategyRequest, security operations.UpdateAdRateStrategySecurity) (*operations.UpdateAdRateStrategyResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/update_ad_rate_strategy", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *campaign) UpdateCampaignBudget(ctx context.Context, request operations.UpdateCampaignBudgetRequest, security operations.UpdateCampaignBudgetSecurity) (*operations.UpdateCampaignBudgetResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/update_campaign_budget", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *campaign) UpdateCampaignIdentification(ctx context.Context, request operations.UpdateCampaignIdentificationRequest, security operations.UpdateCampaignIdentificationSecurity) (*operations.UpdateCampaignIdentificationResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/update_campaign_identification", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
