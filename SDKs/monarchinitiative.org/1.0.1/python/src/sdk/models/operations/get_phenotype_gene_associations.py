...
class GetPhenotypeGeneAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPhenotypeGeneAssociationsQueryParams:
...
@dataclasses.dataclass
class GetPhenotypeGeneAssociationsRequest:
    path_params: GetPhenotypeGeneAssociationsPathParams = dataclasses.field()
    query_params: GetPhenotypeGeneAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetPhenotypeGeneAssociationsResponse:
