...
class ArtifactRules 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\CreateArtifactRuleResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/rules', \OpenAPI\OpenAPI\Models\Operations\CreateArtifactRuleRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/rules/{rule}', \OpenAPI\OpenAPI\Models\Operations\DeleteArtifactRuleRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/rules', \OpenAPI\OpenAPI\Models\Operations\DeleteArtifactRulesRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/rules/{rule}', \OpenAPI\OpenAPI\Models\Operations\GetArtifactRuleConfigRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/rules', \OpenAPI\OpenAPI\Models\Operations\ListArtifactRulesRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/test', \OpenAPI\OpenAPI\Models\Operations\TestUpdateArtifactRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/artifacts/{artifactId}/rules/{rule}', \OpenAPI\OpenAPI\Models\Operations\UpdateArtifactRuleConfigRequest::class, $request);
