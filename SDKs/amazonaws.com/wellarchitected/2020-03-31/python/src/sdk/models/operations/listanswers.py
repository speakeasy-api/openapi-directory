...
from ..shared import listanswersoutput as shared_listanswersoutput


@dataclasses.dataclass
class ListAnswersPathParams:
...
class ListAnswersRequest:
    headers: ListAnswersHeaders = dataclasses.field()
    path_params: ListAnswersPathParams = dataclasses.field()
    query_params: ListAnswersQueryParams = dataclasses.field()
...
class ListAnswersResponse:
    ...
    list_answers_output: Optional[shared_listanswersoutput.ListAnswersOutput] = dataclasses.field(default=None)
