...
public class PostApiRnbPvtImportCalculatorConfigurationHeaders {
    /**
     * HTTP Client Negotiation Accept Header. Indicates the types of responses the client can understand.
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Accept")
    public String accept;
    public PostApiRnbPvtImportCalculatorConfigurationHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public PostApiRnbPvtImportCalculatorConfigurationHeaders withContentType(String contentType) {
    ...
    public PostApiRnbPvtImportCalculatorConfigurationHeaders withXVTEXAccumulateWithManualPrices(Boolean xVTEXAccumulateWithManualPrices) {
    ...
    public PostApiRnbPvtImportCalculatorConfigurationHeaders withXVTEXCalculatorName(String xVTEXCalculatorName) {
    ...
    public PostApiRnbPvtImportCalculatorConfigurationHeaders withXVTEXClusterExpression(String xVTEXClusterExpression) {
    ...
    public PostApiRnbPvtImportCalculatorConfigurationHeaders withXVTEXClusterOperator(String xVTEXClusterOperator) {
    ...
    public PostApiRnbPvtImportCalculatorConfigurationHeaders withXVTEXCumulative(Boolean xVTEXCumulative) {
    ...
    public PostApiRnbPvtImportCalculatorConfigurationHeaders withXVTEXEndDate(String xVTEXEndDate) {
    ...
    public PostApiRnbPvtImportCalculatorConfigurationHeaders withXVTEXStartDate(String xVTEXStartDate) {
