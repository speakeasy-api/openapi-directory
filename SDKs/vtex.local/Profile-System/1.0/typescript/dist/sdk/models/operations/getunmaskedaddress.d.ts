...
export declare class GetUnmaskedAddressRequest extends SpeakeasyBase {
    /**
...
export declare class GetUnmaskedAddressResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * OK
     */
    getUnmaskedAddress200ApplicationJSONObject?: Record<string, any>;
    statusCode: number;
