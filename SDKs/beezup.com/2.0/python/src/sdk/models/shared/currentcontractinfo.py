...
class CurrentContractInfo:
    r"""CurrentContractInfo
    Get the conditions of your current contract
    """
    
    links: shared_currentcontractinfolinks.CurrentContractInfoLinks = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('links') }})
