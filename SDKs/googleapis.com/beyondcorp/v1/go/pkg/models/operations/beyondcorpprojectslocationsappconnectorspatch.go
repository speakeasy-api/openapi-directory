...
type BeyondcorpProjectsLocationsAppConnectorsPatchSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type BeyondcorpProjectsLocationsAppConnectorsPatchRequest struct {
	// V1 error format.
...
type BeyondcorpProjectsLocationsAppConnectorsPatchResponse struct {
	ContentType string
	// Successful response
