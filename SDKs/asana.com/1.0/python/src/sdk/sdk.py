...
class SDK:
    r"""This is the interface for interacting with the [Asana Platform](https://developers.asana.com). Our API reference is generated from our [OpenAPI spec] (https://raw.githubusercontent.com/Asana/developer-docs/master/defs/asana_oas.yaml)."""
    ...
    **Note:** You can use certain project endpoints to operate on [user task lists](/docs/user-task-lists) ([My Tasks](https://asana.com/guide/help/fundamentals/my-tasks)) by substituting the `{project_gid}` with the `{user_task_list_gid}`. For example, you can perform operations on the custom fields of a [user task list](/docs/user-task-lists) by using the following projects endpoints: [Add a custom field to a project](/docs/add-a-custom-field-to-a-project), [Remove a custom field from a project](/docs/remove-a-custom-field-from-a-project) and [Get a project's custom fields](/docs/get-a-projects-custom-fields)
    ...
    def _init_sdks(self):
        ...
        self.audit_log_api = AuditLogAPI(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.custom_field_settings = CustomFieldSettings(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.goal_relationships = GoalRelationships(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.organization_exports = OrganizationExports(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.portfolio_memberships = PortfolioMemberships(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.project_briefs = ProjectBriefs(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.project_memberships = ProjectMemberships(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.project_statuses = ProjectStatuses(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.status_updates = StatusUpdates(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.team_memberships = TeamMemberships(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.user_task_lists = UserTaskLists(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.workspace_memberships = WorkspaceMemberships(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
