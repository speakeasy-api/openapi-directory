 ...
 */
public enum CreateVpcPeeringConnectionRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateVpcPeeringConnectionRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
