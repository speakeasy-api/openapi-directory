...
from ..shared import getbackendapimodelsresponse as shared_getbackendapimodelsresponse
...
class GetBackendAPIModelsRequest:
    headers: GetBackendAPIModelsHeaders = dataclasses.field()
    path_params: GetBackendAPIModelsPathParams = dataclasses.field()
    request: GetBackendAPIModelsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetBackendAPIModelsResponse:
    ...
    get_backend_api_models_response: Optional[shared_getbackendapimodelsresponse.GetBackendAPIModelsResponse] = dataclasses.field(default=None)
