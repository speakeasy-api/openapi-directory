...
class Conversion:
    ...
    def convert(self, request: operations.ConvertRequestBody) -> operations.ConvertResponse:
    ...
    def convert_url(self, request: operations.ConvertURLRequest) -> operations.ConvertURLResponse:
        ...
        query_params = utils.get_query_params(operations.ConvertURLRequest, request)
        ...
        res = operations.ConvertURLResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
