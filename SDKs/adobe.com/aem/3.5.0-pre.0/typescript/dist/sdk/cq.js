...
var Cq = /** @class */ (function () {
    function Cq(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    Cq.prototype.getLoginPage = function (config) {
    ...
    Cq.prototype.postCqActions = function (req, config) {
