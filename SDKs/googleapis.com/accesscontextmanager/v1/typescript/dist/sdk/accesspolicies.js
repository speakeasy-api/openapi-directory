...
var AccessPolicies = /** @class */ (function () {
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesAccessLevelsCreate = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/{parent}/accessLevels", req.pathParams);
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesAccessLevelsReplaceAll = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AccesscontextmanagerAccessPoliciesAccessLevelsReplaceAllRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/accessLevels:replaceAll", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesGetIamPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesServicePerimetersCommit = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AccesscontextmanagerAccessPoliciesServicePerimetersCommitRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/servicePerimeters:commit", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesServicePerimetersCreate = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/servicePerimeters", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesServicePerimetersReplaceAll = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AccesscontextmanagerAccessPoliciesServicePerimetersReplaceAllRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/servicePerimeters:replaceAll", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesServicePerimetersTestIamPermissions = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesSetIamPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
