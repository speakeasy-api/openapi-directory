...
from ..shared import shipmentlocationpersistvo as shared_shipmentlocationpersistvo
...
class PutShipmentLocationJSONRequest:
    ...
    shipment_location_persist_vo: Optional[shared_shipmentlocationpersistvo.ShipmentLocationPersistVO] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
