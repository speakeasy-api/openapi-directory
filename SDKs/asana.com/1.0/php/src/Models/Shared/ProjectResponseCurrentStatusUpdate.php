...
class ProjectResponseCurrentStatusUpdate
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ProjectResponseCurrentStatusUpdateResourceSubtypeEnum $resourceSubtype
     */
	#[\JMS\Serializer\Annotation\SerializedName('resource_subtype')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ProjectResponseCurrentStatusUpdateResourceSubtypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ProjectResponseCurrentStatusUpdateResourceSubtypeEnum $resourceSubtype = null;
