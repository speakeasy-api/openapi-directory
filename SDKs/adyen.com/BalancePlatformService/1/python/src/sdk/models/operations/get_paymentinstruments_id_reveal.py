...
from ..shared import paymentinstrumentrevealinfo as shared_paymentinstrumentrevealinfo
...
class GetPaymentInstrumentsIDRevealResponse:
    ...
    payment_instrument_reveal_info: Optional[shared_paymentinstrumentrevealinfo.PaymentInstrumentRevealInfo] = dataclasses.field(default=None)
