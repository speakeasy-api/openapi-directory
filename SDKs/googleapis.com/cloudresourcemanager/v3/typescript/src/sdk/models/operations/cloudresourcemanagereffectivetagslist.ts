...
export class CloudresourcemanagerEffectiveTagsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudresourcemanagerEffectiveTagsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudresourcemanagerEffectiveTagsListSecurity extends SpeakeasyBase {
...
export class CloudresourcemanagerEffectiveTagsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudresourcemanagerEffectiveTagsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
