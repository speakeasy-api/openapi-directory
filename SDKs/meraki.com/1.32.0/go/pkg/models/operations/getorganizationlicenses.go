...
func (e GetOrganizationLicenses200ApplicationJSONStateEnum) ToPointer() *GetOrganizationLicenses200ApplicationJSONStateEnum {
	return &e
}
...
func (e *GetOrganizationLicenses200ApplicationJSONStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "unused":
		fallthrough
	case "unusedActive":
		*e = GetOrganizationLicenses200ApplicationJSONStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationLicenses200ApplicationJSONStateEnum: %v", v)
	}
}
