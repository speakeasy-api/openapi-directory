...
public class GetListQueryParams {
    /**
     * The type of device the content is targeting.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=device")
    public String device;
    public GetListQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetListQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GetListQueryParams withItemType(org.openapis.openapi.models.shared.ItemTypeEnum itemType) {
    ...
    public String lang;
    public GetListQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetListQueryParams withMaxRating(String maxRating) {
    ...
    public GetListQueryParams withOrder(org.openapis.openapi.models.shared.ListOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetListQueryParams withOrderBy(org.openapis.openapi.models.shared.ListOrderByEnum orderBy) {
    ...
    public Integer page;
    public GetListQueryParams withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public GetListQueryParams withPageSize(Integer pageSize) {
    ...
    public String param;
    public GetListQueryParams withParam(String param) {
        this.param = param;
        return this;
    }
    ...
    public GetListQueryParams withSegments(String[] segments) {
    ...
    public String sub;
    public GetListQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
