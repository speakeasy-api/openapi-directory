...
exports.UserStatisticeDailyValueV1StatisticsIndividualDailyResponse = exports.UserStatisticeDailyValueV1StatisticsIndividualDailyRequest = exports.UserStatisticeDailyValueV1StatisticsIndividualDaily200ApplicationJson = exports.UserStatisticeDailyValueV1StatisticsIndividualDaily200ApplicationJsonResult = exports.UserStatisticeDailyValueV1StatisticsIndividualDailyQueryParams = void 0;
...
exports.UserStatisticeDailyValueV1StatisticsIndividualDailyQueryParams = UserStatisticeDailyValueV1StatisticsIndividualDailyQueryParams;
var UserStatisticeDailyValueV1StatisticsIndividualDaily200ApplicationJsonResult = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CorneringCount" }),
        __metadata("design:type", Number)
    ], UserStatisticeDailyValueV1StatisticsIndividualDaily200ApplicationJsonResult.prototype, "corneringCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=DayDrivingTime" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=DriverTripsCount" }),
        __metadata("design:type", Number)
    ], UserStatisticeDailyValueV1StatisticsIndividualDaily200ApplicationJsonResult.prototype, "driverTripsCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=DrivingTime" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=PhoneUsageOverSpeedDistanceMile" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=PhoneUsageOverSpeedDurationMin" }),
        __metadata("design:type", Number)
...
var UserStatisticeDailyValueV1StatisticsIndividualDaily200ApplicationJson = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Result", elemType: UserStatisticeDailyValueV1StatisticsIndividualDaily200ApplicationJsonResult }),
        __metadata("design:type", Array)
