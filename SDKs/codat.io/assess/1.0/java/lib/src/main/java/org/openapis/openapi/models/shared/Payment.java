...
public class Payment {
    ...
    public Payment withAccountRef(AccountRef accountRef) {
    ...
    public Payment withCustomerRef(CustomerRef customerRef) {
    ...
    public Payment withLines(PaymentLine[] lines) {
        this.lines = lines;
        return this;
    }
    ...
    public PaymentPaymentMethodRef paymentMethodRef;

    public Payment withPaymentMethodRef(PaymentPaymentMethodRef paymentMethodRef) {
    ...
    public PaymentSupplementalData supplementalData;

    public Payment withSupplementalData(PaymentSupplementalData supplementalData) {
