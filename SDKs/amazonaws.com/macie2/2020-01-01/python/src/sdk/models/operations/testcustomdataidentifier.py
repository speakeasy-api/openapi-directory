...
class TestCustomDataIdentifierRequestBody:
    ...
    sample_text: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('sampleText') }})
...
class TestCustomDataIdentifierRequest:
    headers: TestCustomDataIdentifierHeaders = dataclasses.field()
    request: TestCustomDataIdentifierRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
