...
@dataclasses.dataclass
class FilesOneSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class FilesOneRequest:
    headers: FilesOneHeaders = dataclasses.field()
    path_params: FilesOnePathParams = dataclasses.field()
    query_params: FilesOneQueryParams = dataclasses.field()
    security: FilesOneSecurity = dataclasses.field()
    

@dataclasses.dataclass
class FilesOneResponse:
