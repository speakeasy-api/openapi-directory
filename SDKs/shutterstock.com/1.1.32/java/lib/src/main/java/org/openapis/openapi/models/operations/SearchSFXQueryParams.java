...
public class SearchSFXQueryParams {
    /**
    ...
    public SearchSFXQueryParams withAddedDate(LocalDate addedDate) {
    ...
    public SearchSFXQueryParams withAddedDateEnd(LocalDate addedDateEnd) {
    ...
    public SearchSFXQueryParams withAddedDateStart(LocalDate addedDateStart) {
    ...
    public SearchSFXQueryParams withDuration(Long duration) {
    ...
    public SearchSFXQueryParams withDurationFrom(Long durationFrom) {
    ...
    public SearchSFXQueryParams withDurationTo(Long durationTo) {
    ...
    public SearchSFXQueryParams withLanguage(org.openapis.openapi.models.shared.LanguageEnum language) {
    ...
    public Long page;
    public SearchSFXQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public SearchSFXQueryParams withPerPage(Long perPage) {
    ...
    public String query;
    public SearchSFXQueryParams withQuery(String query) {
        this.query = query;
        return this;
    }
    ...
    public Boolean safe;
    public SearchSFXQueryParams withSafe(Boolean safe) {
        this.safe = safe;
        return this;
    }
    ...
    public SearchSFXQueryParams withSort(SearchSFXSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public SearchSFXQueryParams withView(SearchSFXViewEnum view) {
        this.view = view;
        return this;
    }
