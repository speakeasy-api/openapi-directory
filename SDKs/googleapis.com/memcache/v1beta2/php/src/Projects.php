...
class Projects 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesApplyParametersResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/{name}:applyParameters', \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesApplyParametersRequest::class, $request);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesApplySoftwareUpdateRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesApplySoftwareUpdateSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesApplySoftwareUpdateResponse
     */
	public function memcacheProjectsLocationsInstancesApplySoftwareUpdate(
        \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesApplySoftwareUpdateRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesApplySoftwareUpdateSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesApplySoftwareUpdateResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/{instance}:applySoftwareUpdate', \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesApplySoftwareUpdateRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "applySoftwareUpdateRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesApplySoftwareUpdateRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesApplySoftwareUpdateResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/{parent}/instances', \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/{parent}/instances', \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/{name}', \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/{instance}:rescheduleMaintenance', \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesRescheduleMaintenanceRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/{name}:updateParameters', \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsInstancesUpdateParametersRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/{name}/locations', \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/{name}:cancel', \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsOperationsCancelRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/{name}', \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsOperationsDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/{name}', \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsOperationsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/{name}/operations', \OpenAPI\OpenAPI\Models\Operations\MemcacheProjectsLocationsOperationsListRequest::class, $request);
