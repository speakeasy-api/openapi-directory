...
public class GetContainersFloatingIpsHeaders {
    /**
    ...
    public GetContainersFloatingIpsHeaders withXAuthProjectId(String xAuthProjectId) {
    ...
    public GetContainersFloatingIpsHeaders withXAuthToken(String xAuthToken) {
