...
class BatchReadRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\BatchReadXAmzConsistencyLevelEnum $xAmzConsistencyLevel
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=x-amz-consistency-level')]
    public ?BatchReadXAmzConsistencyLevelEnum $xAmzConsistencyLevel = null;
	...
	{
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\BatchReadRequestBody();
