...
public class Destiny2GetLeaderboardsQueryParams {
    /**
    ...
    public Destiny2GetLeaderboardsQueryParams withMaxtop(Integer maxtop) {
        this.maxtop = maxtop;
        return this;
    }
    ...
    public String modes;
    public Destiny2GetLeaderboardsQueryParams withModes(String modes) {
        this.modes = modes;
        return this;
    }
    ...
    public Destiny2GetLeaderboardsQueryParams withStatid(String statid) {
        this.statid = statid;
        return this;
    }
