...
func (s *SDK) DeleteSession(ctx context.Context, request operations.DeleteSessionRequest) (*operations.DeleteSessionResponse, error) {
	...
	url := utils.GenerateURL(ctx, baseURL, "/bots/{botId}/botAliases/{botAliasId}/botLocales/{localeId}/sessions/{sessionId}", request.PathParams, nil)
...
func (s *SDK) RecognizeText(ctx context.Context, request operations.RecognizeTextRequest) (*operations.RecognizeTextResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/bots/{botId}/botAliases/{botAliasId}/botLocales/{localeId}/sessions/{sessionId}/text", request.PathParams, nil)
...
func (s *SDK) RecognizeUtterance(ctx context.Context, request operations.RecognizeUtteranceRequest) (*operations.RecognizeUtteranceResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/bots/{botId}/botAliases/{botAliasId}/botLocales/{localeId}/sessions/{sessionId}/utterance#Content-Type", request.PathParams, nil)
