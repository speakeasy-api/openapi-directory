...
class Rotation:
    r"""Information about a rotation in an on-call schedule."""
    ...
    recurrence: Optional[shared_recurrencesettings.RecurrenceSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Recurrence'), 'exclude': lambda f: f is None }})  
