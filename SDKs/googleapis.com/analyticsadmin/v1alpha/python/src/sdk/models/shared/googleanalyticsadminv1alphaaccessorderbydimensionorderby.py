...
class GoogleAnalyticsAdminV1alphaAccessOrderByDimensionOrderBy:
    ...
    order_type: Optional[GoogleAnalyticsAdminV1alphaAccessOrderByDimensionOrderByOrderTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('orderType'), 'exclude': lambda f: f is None }})
    r"""Controls the rule for dimension value ordering."""  
