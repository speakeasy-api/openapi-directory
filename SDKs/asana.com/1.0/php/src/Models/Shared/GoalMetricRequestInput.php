...
class GoalMetricRequestInput
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GoalMetricRequestProgressSourceEnum $progressSource
     */
	#[\JMS\Serializer\Annotation\SerializedName('progress_source')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GoalMetricRequestProgressSourceEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GoalMetricRequestProgressSourceEnum $progressSource = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GoalMetricRequestUnitEnum $unit
     */
	#[\JMS\Serializer\Annotation\SerializedName('unit')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GoalMetricRequestUnitEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GoalMetricRequestUnitEnum $unit = null;
