...
class ListOpenWorkflowExecutionsRequest:
    ...
    list_open_workflow_executions_input: shared_listopenworkflowexecutionsinput.ListOpenWorkflowExecutionsInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
