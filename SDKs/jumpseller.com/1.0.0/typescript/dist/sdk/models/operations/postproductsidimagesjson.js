...
exports.PostProductsIdImagesJsonResponse = exports.PostProductsIdImagesJsonRequest = void 0;
...
var PostProductsIdImagesJsonRequest = /** @class */ (function (_super) {
    ...
    ], PostProductsIdImagesJsonRequest.prototype, "imageEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PostProductsIdImagesJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PostProductsIdImagesJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PostProductsIdImagesJsonRequest.prototype, "login", void 0);
    return PostProductsIdImagesJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PostProductsIdImagesJsonRequest = PostProductsIdImagesJsonRequest;
var PostProductsIdImagesJsonResponse = /** @class */ (function (_super) {
    ...
    ], PostProductsIdImagesJsonResponse.prototype, "rawResponse", void 0);
    return PostProductsIdImagesJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PostProductsIdImagesJsonResponse = PostProductsIdImagesJsonResponse;
