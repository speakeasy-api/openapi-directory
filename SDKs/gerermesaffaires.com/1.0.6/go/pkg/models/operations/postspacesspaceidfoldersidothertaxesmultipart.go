...
func (e PostSpacesSpaceIDFoldersIDOtherTaxesMultipartFormDataAccountingWorkbookEnum) ToPointer() *PostSpacesSpaceIDFoldersIDOtherTaxesMultipartFormDataAccountingWorkbookEnum {
	return &e
}
...
func (e *PostSpacesSpaceIDFoldersIDOtherTaxesMultipartFormDataAccountingWorkbookEnum) UnmarshalJSON(data []byte) error {
	...
	case "other":
		fallthrough
	case "permanent":
		*e = PostSpacesSpaceIDFoldersIDOtherTaxesMultipartFormDataAccountingWorkbookEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostSpacesSpaceIDFoldersIDOtherTaxesMultipartFormDataAccountingWorkbookEnum: %v", v)
	}
}
...
type PostSpacesSpaceIDFoldersIDOtherTaxesMultipartRequest struct {
	...
	RequestBody PostSpacesSpaceIDFoldersIDOtherTaxesMultipartFormData1 `request:"mediaType=multipart/form-data"`
