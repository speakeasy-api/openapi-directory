...
var InputUpdate = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "InputParallelismUpdate" }),
        (0, class_transformer_1.Type)(function () { return inputparallelismupdate_1.InputParallelismUpdate; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "InputProcessingConfigurationUpdate" }),
        (0, class_transformer_1.Type)(function () { return inputprocessingconfigurationupdate_1.InputProcessingConfigurationUpdate; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "InputSchemaUpdate" }),
        (0, class_transformer_1.Type)(function () { return inputschemaupdate_1.InputSchemaUpdate; }),
        __metadata("design:type", inputschemaupdate_1.InputSchemaUpdate)
    ], InputUpdate.prototype, "inputSchemaUpdate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "KinesisFirehoseInputUpdate" }),
        (0, class_transformer_1.Type)(function () { return kinesisfirehoseinputupdate_1.KinesisFirehoseInputUpdate; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "KinesisStreamsInputUpdate" }),
        (0, class_transformer_1.Type)(function () { return kinesisstreamsinputupdate_1.KinesisStreamsInputUpdate; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "NamePrefixUpdate" }),
        __metadata("design:type", String)
