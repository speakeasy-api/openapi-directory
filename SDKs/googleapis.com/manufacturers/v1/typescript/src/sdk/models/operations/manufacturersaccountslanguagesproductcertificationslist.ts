...
export class ManufacturersAccountsLanguagesProductCertificationsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ManufacturersAccountsLanguagesProductCertificationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ManufacturersAccountsLanguagesProductCertificationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  listProductCertificationsResponse?: shared.ListProductCertificationsResponse;
