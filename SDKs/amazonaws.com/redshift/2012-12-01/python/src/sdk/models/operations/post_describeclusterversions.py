...
class PostDescribeClusterVersionsQueryParams:
    action: PostDescribeClusterVersionsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeClusterVersionsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeClusterVersionsRequest:
    headers: PostDescribeClusterVersionsHeaders = dataclasses.field()
    query_params: PostDescribeClusterVersionsQueryParams = dataclasses.field()
