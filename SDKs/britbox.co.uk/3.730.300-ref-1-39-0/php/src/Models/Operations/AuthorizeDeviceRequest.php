...
class AuthorizeDeviceRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\DeviceAuthorizationCode $deviceAuthorizationCode;
	...
	{
		$this->deviceAuthorizationCode = new \OpenAPI\OpenAPI\Models\Shared\DeviceAuthorizationCode();
		$this->ff = null;
		$this->lang = null;
	}
}
