...
func (e DescribeImageTagsXAmzTargetEnum) ToPointer() *DescribeImageTagsXAmzTargetEnum {
	return &e
}
...
func (e *DescribeImageTagsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "SpencerFrontendService.DescribeImageTags":
		*e = DescribeImageTagsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeImageTagsXAmzTargetEnum: %v", v)
	}
}

type DescribeImageTagsRequest struct {
	DescribeImageTagsRequest shared.DescribeImageTagsRequest `request:"mediaType=application/json"`
