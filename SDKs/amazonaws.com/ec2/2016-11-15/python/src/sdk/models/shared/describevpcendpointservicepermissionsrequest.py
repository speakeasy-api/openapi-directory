...
class DescribeVpcEndpointServicePermissionsRequestFilters:
...
class DescribeVpcEndpointServicePermissionsRequest:
    ...
    filters: Optional[list[DescribeVpcEndpointServicePermissionsRequestFilters]] = dataclasses.field(default=None)  
