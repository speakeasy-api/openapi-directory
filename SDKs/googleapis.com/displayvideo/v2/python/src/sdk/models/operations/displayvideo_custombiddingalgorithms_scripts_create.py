...
class DisplayvideoCustomBiddingAlgorithmsScriptsCreateRequest:
    ...
    r"""Required. The ID of the custom bidding algorithm that owns the script."""  
    ...
    r"""The ID of the advertiser that owns the parent custom bidding algorithm."""  
    alt: Optional[shared_alt_enum.AltEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'alt', 'style': 'form', 'explode': True }})
    r"""Data format for response."""  
    callback: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'callback', 'style': 'form', 'explode': True }})
    r"""JSONP"""  
    custom_bidding_script_input: Optional[shared_custombiddingscript.CustomBiddingScriptInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    ...
    r"""The ID of the partner that owns the parent custom bidding algorithm. Only this partner will have write access to this custom bidding script."""  
