...
class UpdateApplicationSettingsRequestBodyWriteApplicationSettingsRequest:
    r"""Specifies the default settings for an application."""
    ...
    event_tagging_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EventTaggingEnabled'), 'exclude': lambda f: f is None }})  
...
class UpdateApplicationSettingsRequestBody:
    ...
    write_application_settings_request: UpdateApplicationSettingsRequestBodyWriteApplicationSettingsRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('WriteApplicationSettingsRequest') }})
    r"""Specifies the default settings for an application."""  
