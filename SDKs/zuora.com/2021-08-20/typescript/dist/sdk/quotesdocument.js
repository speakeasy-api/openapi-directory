...
var QuotesDocument = /** @class */ (function () {
    ...
    QuotesDocument.prototype.postQuotesDocument = function (req, config) {
        ...
        try {
            _a = utils.serializeRequestBody(req, "postQuoteDocType", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.POSTQuotesDocumentResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.postQuoteDocResponseType = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.POSTQuoteDocResponseType);
                    }
                    break;
            }
            return res;
