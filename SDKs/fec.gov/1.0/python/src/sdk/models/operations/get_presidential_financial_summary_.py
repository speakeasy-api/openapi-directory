...
from ..shared import presidentialsummarypage as shared_presidentialsummarypage
...
class GetPresidentialFinancialSummaryRequest:
    query_params: GetPresidentialFinancialSummaryQueryParams = dataclasses.field()
...
class GetPresidentialFinancialSummaryResponse:
    ...
    presidential_summary_page: Optional[shared_presidentialsummarypage.PresidentialSummaryPage] = dataclasses.field(default=None)
