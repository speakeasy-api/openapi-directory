...
type GetClientAddressesPathParams struct {
...
type GetClientAddressesQueryParams struct {
...
type GetClientAddressesHeaders struct {
...
type GetClientAddressesRequest struct {
	PathParams  GetClientAddressesPathParams
	QueryParams GetClientAddressesQueryParams
	Headers     GetClientAddressesHeaders
}

type GetClientAddressesResponse struct {
	ContentType string
	// OK
	GetClientAddresses200ApplicationJSONAnies []interface{}
	StatusCode                                int
