...
class JobsProjectsJobsListRequest:
    path_params: JobsProjectsJobsListPathParams = dataclasses.field()
    query_params: JobsProjectsJobsListQueryParams = dataclasses.field()
    security: JobsProjectsJobsListSecurity = dataclasses.field()
