...
public class DescribeInstanceAccessControlAttributeConfigurationResponse {
    ...
    public org.openapis.openapi.models.shared.DescribeInstanceAccessControlAttributeConfigurationResponse describeInstanceAccessControlAttributeConfigurationResponse;

    public DescribeInstanceAccessControlAttributeConfigurationResponse withDescribeInstanceAccessControlAttributeConfigurationResponse(org.openapis.openapi.models.shared.DescribeInstanceAccessControlAttributeConfigurationResponse describeInstanceAccessControlAttributeConfigurationResponse) {
    ...
    public DescribeInstanceAccessControlAttributeConfigurationResponse withStatusCode(Integer statusCode) {
    ...
    public DescribeInstanceAccessControlAttributeConfigurationResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public DescribeInstanceAccessControlAttributeConfigurationResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
