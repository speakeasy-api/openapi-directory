...
class GetFirewallDomainListRequest:
    ...
    get_firewall_domain_list_request: shared_getfirewalldomainlistrequest.GetFirewallDomainListRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
