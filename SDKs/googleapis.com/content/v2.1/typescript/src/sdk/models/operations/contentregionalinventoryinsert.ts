...
export class ContentRegionalinventoryInsertSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentRegionalinventoryInsertRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentRegionalinventoryInsertResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
