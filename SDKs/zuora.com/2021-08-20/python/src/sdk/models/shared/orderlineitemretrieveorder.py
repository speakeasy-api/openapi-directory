...
class OrderLineItemRetrieveOrderItemStateEnum(str, Enum):
    r"""The state of an Order Line Item. See [Order Line Item states, Order states, and state transitions](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AB_Order_Line_Item_States_and_Order_States) for more information."""
    EXECUTING = 'Executing'
...
class OrderLineItemRetrieveOrder:
    ...
    item_state: Optional[OrderLineItemRetrieveOrderItemStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('itemState'), 'exclude': lambda f: f is None }})
    r"""The state of an Order Line Item. See [Order Line Item states, Order states, and state transitions](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AB_Order_Line_Item_States_and_Order_States) for more information."""  
    item_type: Optional[OrderLineItemRetrieveOrderItemTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('itemType'), 'exclude': lambda f: f is None }})
    r"""The type of the Order Line Item."""  
    ...
    r"""The Id of an existing account, which is set as the sold-to contact of the order line item."""  
    sold_to_data: Optional[shared_ordercontactretrieveorder.OrderContactRetrieveOrder] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('soldToData'), 'exclude': lambda f: f is None }})
    ...
    tax_mode: Optional[OrderLineItemRetrieveOrderTaxModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxMode'), 'exclude': lambda f: f is None }})
    r"""The tax mode for the Order Line Item."""  
