...
type ContainerProjectsZonesClustersResourceLabelsSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContainerProjectsZonesClustersResourceLabelsPathParams struct {
...
type ContainerProjectsZonesClustersResourceLabelsQueryParams struct {
	// V1 error format.
...
type ContainerProjectsZonesClustersResourceLabelsRequest struct {
...
type ContainerProjectsZonesClustersResourceLabelsResponse struct {
	ContentType string
	// Successful response
