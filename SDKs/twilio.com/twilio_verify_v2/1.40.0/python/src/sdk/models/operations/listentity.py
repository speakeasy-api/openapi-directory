...
class ListEntityListEntityResponse:
    ...
    entities: Optional[list[shared_verify_v2_service_entity.VerifyV2ServiceEntity]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entities'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListEntityListEntityResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
