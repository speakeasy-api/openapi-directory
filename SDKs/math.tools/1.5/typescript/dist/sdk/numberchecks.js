...
var NumberChecks = /** @class */ (function () {
     ...
     */
    NumberChecks.prototype.getNumbersIsCube = function (req, security, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetNumbersIsCubeResponse({
     ...
     */
    NumberChecks.prototype.getNumbersIsPalindrome = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetNumbersIsPalindromeResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     */
    NumberChecks.prototype.getNumbersIsSquare = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetNumbersIsSquareResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     */
    NumberChecks.prototype.getNumbersIsTriangle = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetNumbersIsTriangleResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     */
    NumberChecks.prototype.getNumbersPrimeIsFermatPrime = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    NumberChecks.prototype.getNumbersPrimeIsFibonacciPrime = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    NumberChecks.prototype.getNumbersPrimeIsMersennePrime = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    NumberChecks.prototype.getNumbersPrimeIsPartitionPrime = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    NumberChecks.prototype.getNumbersPrimeIsPellPrime = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    NumberChecks.prototype.getNumbersPrimeIsPerfect = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    NumberChecks.prototype.getNumbersPrimeIsPrime = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
