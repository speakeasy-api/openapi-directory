...
func (e *UpdateNetworkApplianceVlanRequestBodyDhcpHandlingEnum) UnmarshalJSON(data []byte) error {
	...
	case "Run a DHCP server":
		*e = UpdateNetworkApplianceVlanRequestBodyDhcpHandlingEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceVlanRequestBodyDhcpHandlingEnum: %s", s)
	}
}
...
func (e *UpdateNetworkApplianceVlanRequestBodyDhcpLeaseTimeEnum) UnmarshalJSON(data []byte) error {
	...
	case "30 minutes":
		fallthrough
	case "4 hours":
		*e = UpdateNetworkApplianceVlanRequestBodyDhcpLeaseTimeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceVlanRequestBodyDhcpLeaseTimeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkApplianceVlanRequestBodyDhcpOptionsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "ip":
		fallthrough
	case "text":
		*e = UpdateNetworkApplianceVlanRequestBodyDhcpOptionsTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceVlanRequestBodyDhcpOptionsTypeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkApplianceVlanRequestBodyIpv6PrefixAssignmentsOriginTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "independent":
		fallthrough
	case "internet":
		*e = UpdateNetworkApplianceVlanRequestBodyIpv6PrefixAssignmentsOriginTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceVlanRequestBodyIpv6PrefixAssignmentsOriginTypeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkApplianceVlanRequestBodyTemplateVlanTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "same":
		fallthrough
	case "unique":
		*e = UpdateNetworkApplianceVlanRequestBodyTemplateVlanTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceVlanRequestBodyTemplateVlanTypeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkApplianceVlan200ApplicationJSONDhcpHandlingEnum) UnmarshalJSON(data []byte) error {
	...
	case "Relay DHCP to another server":
		fallthrough
	case "Run a DHCP server":
		*e = UpdateNetworkApplianceVlan200ApplicationJSONDhcpHandlingEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceVlan200ApplicationJSONDhcpHandlingEnum: %s", s)
	}
}
...
func (e *UpdateNetworkApplianceVlan200ApplicationJSONDhcpLeaseTimeEnum) UnmarshalJSON(data []byte) error {
	...
	case "30 minutes":
		fallthrough
	case "4 hours":
		*e = UpdateNetworkApplianceVlan200ApplicationJSONDhcpLeaseTimeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceVlan200ApplicationJSONDhcpLeaseTimeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkApplianceVlan200ApplicationJSONDhcpOptionsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "ip":
		fallthrough
	case "text":
		*e = UpdateNetworkApplianceVlan200ApplicationJSONDhcpOptionsTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceVlan200ApplicationJSONDhcpOptionsTypeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkApplianceVlan200ApplicationJSONIpv6PrefixAssignmentsOriginTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "independent":
		fallthrough
	case "internet":
		*e = UpdateNetworkApplianceVlan200ApplicationJSONIpv6PrefixAssignmentsOriginTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceVlan200ApplicationJSONIpv6PrefixAssignmentsOriginTypeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkApplianceVlan200ApplicationJSONTemplateVlanTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "same":
		fallthrough
	case "unique":
		*e = UpdateNetworkApplianceVlan200ApplicationJSONTemplateVlanTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceVlan200ApplicationJSONTemplateVlanTypeEnum: %s", s)
	}
}
