...
class News:
    ...
    original_source: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('OriginalSource'), 'exclude': lambda f: f is None }})  
    original_source_url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('OriginalSourceUrl'), 'exclude': lambda f: f is None }})  
    ...
    player_id2: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PlayerID2'), 'exclude': lambda f: f is None }})  
    ...
    team_id2: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TeamID2'), 'exclude': lambda f: f is None }})  
    ...
    time_ago: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TimeAgo'), 'exclude': lambda f: f is None }})  
