...
public class Electioneering {
    ...
    public org.openapis.openapi.models.operations.GetElectioneeringResponse getElectioneering(org.openapis.openapi.models.operations.GetElectioneeringRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetElectioneeringQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.GetElectioneeringAggregatesResponse getElectioneeringAggregates(org.openapis.openapi.models.operations.GetElectioneeringAggregatesRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetElectioneeringAggregatesQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
    ...
    public org.openapis.openapi.models.operations.GetElectioneeringByCandidateResponse getElectioneeringByCandidate(org.openapis.openapi.models.operations.GetElectioneeringByCandidateRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetElectioneeringByCandidateQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
    ...
    public org.openapis.openapi.models.operations.GetElectioneeringTotalsByCandidateResponse getElectioneeringTotalsByCandidate(org.openapis.openapi.models.operations.GetElectioneeringTotalsByCandidateRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetElectioneeringTotalsByCandidateQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
