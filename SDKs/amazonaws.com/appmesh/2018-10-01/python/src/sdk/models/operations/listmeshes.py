...
from ..shared import listmeshesoutput as shared_listmeshesoutput
...
class ListMeshesRequest:
    ...
    r"""The maximum number of mesh results returned by <code>ListMeshes</code> in paginated
    ...
    r"""<p>The <code>nextToken</code> value returned from a previous paginated
...
class ListMeshesResponse:
    ...
    list_meshes_output: Optional[shared_listmeshesoutput.ListMeshesOutput] = dataclasses.field(default=None)
    r"""Success"""  
