...
class DestroyReplicaRequest:
    path_params: DestroyReplicaPathParams = dataclasses.field()
...
class DestroyReplicaResponse:
    ...
    destroy_replica_401_application_json_object: Optional[DestroyReplica401ApplicationJSON] = dataclasses.field(default=None)
