...
public class Orders {
    ...
    public org.openapis.openapi.models.operations.ListOrdersResponse listOrders(org.openapis.openapi.models.operations.ListOrdersRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ListOrdersRequest.class, baseUrl, "/companies/{companyId}/connections/{connectionId}/data/commerce-orders", request, null);
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.Orders out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.Orders.class);
                res.orders = out;
            }
        }
