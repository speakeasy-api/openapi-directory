...
class GetDescribeTargetGroupsQueryParams:
    action: GetDescribeTargetGroupsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDescribeTargetGroupsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    ...
    target_group_arns: Optional[list[str]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'TargetGroupArns', 'style': 'form', 'explode': True }})
...
class GetDescribeTargetGroupsRequest:
    headers: GetDescribeTargetGroupsHeaders = dataclasses.field()
    query_params: GetDescribeTargetGroupsQueryParams = dataclasses.field()
