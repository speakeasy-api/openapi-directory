...
/**
 * SDK - <fullname>Amazon Kinesis Data Streams Service API Reference</fullname> <p>Amazon Kinesis Data Streams is a managed service that scales elastically for real-time processing of streaming big data.</p>
 * 
 * https://docs.aws.amazon.com/kinesis/ - Amazon Web Services documentation
 * 
 * @package OpenAPI\OpenAPI
 * @access public
 * @see https://docs.aws.amazon.com/kinesis/
 */
class SDK
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\AddTagsToStreamRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\AddTagsToStreamResponse
     */
	public function addTagsToStream(
        \OpenAPI\OpenAPI\Models\Operations\AddTagsToStreamRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\AddTagsToStreamResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.AddTagsToStream');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "addTagsToStreamInput", "json");
        if ($body === null) {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\AddTagsToStreamResponse();
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.CreateStream');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createStreamInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DecreaseStreamRetentionPeriodRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DecreaseStreamRetentionPeriodResponse
     */
	public function decreaseStreamRetentionPeriod(
        \OpenAPI\OpenAPI\Models\Operations\DecreaseStreamRetentionPeriodRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DecreaseStreamRetentionPeriodResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.DecreaseStreamRetentionPeriod');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "decreaseStreamRetentionPeriodInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DecreaseStreamRetentionPeriodResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.DeleteStream');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteStreamInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeregisterStreamConsumerRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeregisterStreamConsumerResponse
     */
	public function deregisterStreamConsumer(
        \OpenAPI\OpenAPI\Models\Operations\DeregisterStreamConsumerRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeregisterStreamConsumerResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.DeregisterStreamConsumer');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deregisterStreamConsumerInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeregisterStreamConsumerResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.DescribeLimits');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.DescribeStream');
        ...
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeStreamRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeStreamConsumerRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeStreamConsumerResponse
     */
	public function describeStreamConsumer(
        \OpenAPI\OpenAPI\Models\Operations\DescribeStreamConsumerRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeStreamConsumerResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.DescribeStreamConsumer');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeStreamConsumerInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeStreamConsumerResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeStreamConsumerOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeStreamConsumerOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeStreamSummaryRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeStreamSummaryResponse
     */
	public function describeStreamSummary(
        \OpenAPI\OpenAPI\Models\Operations\DescribeStreamSummaryRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeStreamSummaryResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.DescribeStreamSummary');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeStreamSummaryInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeStreamSummaryResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeStreamSummaryOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeStreamSummaryOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DisableEnhancedMonitoringRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DisableEnhancedMonitoringResponse
     */
	public function disableEnhancedMonitoring(
        \OpenAPI\OpenAPI\Models\Operations\DisableEnhancedMonitoringRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DisableEnhancedMonitoringResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.DisableEnhancedMonitoring');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "disableEnhancedMonitoringInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DisableEnhancedMonitoringResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->enhancedMonitoringOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\EnhancedMonitoringOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\EnableEnhancedMonitoringRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\EnableEnhancedMonitoringResponse
     */
	public function enableEnhancedMonitoring(
        \OpenAPI\OpenAPI\Models\Operations\EnableEnhancedMonitoringRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\EnableEnhancedMonitoringResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.EnableEnhancedMonitoring');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "enableEnhancedMonitoringInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\EnableEnhancedMonitoringResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.GetRecords');
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->kmsOptInRequired = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 489) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->kmsThrottlingException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.GetShardIterator');
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\IncreaseStreamRetentionPeriodRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\IncreaseStreamRetentionPeriodResponse
     */
	public function increaseStreamRetentionPeriod(
        \OpenAPI\OpenAPI\Models\Operations\IncreaseStreamRetentionPeriodRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\IncreaseStreamRetentionPeriodResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.IncreaseStreamRetentionPeriod');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "increaseStreamRetentionPeriodInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\IncreaseStreamRetentionPeriodResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListShardsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListShardsResponse
     */
	public function listShards(
        \OpenAPI\OpenAPI\Models\Operations\ListShardsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListShardsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.ListShards');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listShardsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListShardsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listShardsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListShardsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListStreamConsumersRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListStreamConsumersResponse
     */
	public function listStreamConsumers(
        \OpenAPI\OpenAPI\Models\Operations\ListStreamConsumersRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListStreamConsumersResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.ListStreamConsumers');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listStreamConsumersInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ListStreamConsumersRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListStreamConsumersResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listStreamConsumersOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListStreamConsumersOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.ListStreams');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.ListTagsForStream');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listTagsForStreamInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\MergeShardsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\MergeShardsResponse
     */
	public function mergeShards(
        \OpenAPI\OpenAPI\Models\Operations\MergeShardsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\MergeShardsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.MergeShards');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "mergeShardsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\MergeShardsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.PutRecord');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "putRecordInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->putRecordOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\PutRecordOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\PutRecordsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\PutRecordsResponse
     */
	public function putRecords(
        \OpenAPI\OpenAPI\Models\Operations\PutRecordsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\PutRecordsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.PutRecords');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "putRecordsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PutRecordsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->putRecordsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\PutRecordsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\RegisterStreamConsumerRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\RegisterStreamConsumerResponse
     */
	public function registerStreamConsumer(
        \OpenAPI\OpenAPI\Models\Operations\RegisterStreamConsumerRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\RegisterStreamConsumerResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.RegisterStreamConsumer');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "registerStreamConsumerInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\RegisterStreamConsumerResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->registerStreamConsumerOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\RegisterStreamConsumerOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\RemoveTagsFromStreamRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\RemoveTagsFromStreamResponse
     */
	public function removeTagsFromStream(
        \OpenAPI\OpenAPI\Models\Operations\RemoveTagsFromStreamRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\RemoveTagsFromStreamResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.RemoveTagsFromStream');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "removeTagsFromStreamInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\RemoveTagsFromStreamResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\SplitShardRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\SplitShardResponse
     */
	public function splitShard(
        \OpenAPI\OpenAPI\Models\Operations\SplitShardRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\SplitShardResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.SplitShard');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "splitShardInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\SplitShardResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StartStreamEncryptionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\StartStreamEncryptionResponse
     */
	public function startStreamEncryption(
        \OpenAPI\OpenAPI\Models\Operations\StartStreamEncryptionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\StartStreamEncryptionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.StartStreamEncryption');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "startStreamEncryptionInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StartStreamEncryptionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StopStreamEncryptionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\StopStreamEncryptionResponse
     */
	public function stopStreamEncryption(
        \OpenAPI\OpenAPI\Models\Operations\StopStreamEncryptionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\StopStreamEncryptionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.StopStreamEncryption');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "stopStreamEncryptionInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StopStreamEncryptionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateShardCountRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateShardCountResponse
     */
	public function updateShardCount(
        \OpenAPI\OpenAPI\Models\Operations\UpdateShardCountRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateShardCountResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.UpdateShardCount');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateShardCountInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateShardCountResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateShardCountOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateShardCountOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateStreamModeRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateStreamModeResponse
     */
	public function updateStreamMode(
        \OpenAPI\OpenAPI\Models\Operations\UpdateStreamModeRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateStreamModeResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=Kinesis_20131202.UpdateStreamMode');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateStreamModeInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateStreamModeResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
