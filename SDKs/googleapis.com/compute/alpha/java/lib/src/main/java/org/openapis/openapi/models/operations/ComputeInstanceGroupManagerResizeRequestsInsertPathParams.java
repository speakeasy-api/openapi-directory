...
public class ComputeInstanceGroupManagerResizeRequestsInsertPathParams {
    /**
    ...
    public ComputeInstanceGroupManagerResizeRequestsInsertPathParams withInstanceGroupManager(String instanceGroupManager) {
    ...
    public ComputeInstanceGroupManagerResizeRequestsInsertPathParams withProject(String project) {
    ...
    public String zone;
    public ComputeInstanceGroupManagerResizeRequestsInsertPathParams withZone(String zone) {
        this.zone = zone;
        return this;
    }
