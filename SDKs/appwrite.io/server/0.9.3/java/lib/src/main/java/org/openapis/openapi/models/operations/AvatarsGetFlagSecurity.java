...
public class AvatarsGetFlagSecurity {
    ...
    public AvatarsGetFlagSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public AvatarsGetFlagSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
