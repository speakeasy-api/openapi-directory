...
func (e PaymentInstructionV3TransmissionTypeEnum) ToPointer() *PaymentInstructionV3TransmissionTypeEnum {
	return &e
}
...
func (e *PaymentInstructionV3TransmissionTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "LOCAL":
		fallthrough
	case "SWIFT":
		*e = PaymentInstructionV3TransmissionTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PaymentInstructionV3TransmissionTypeEnum: %v", v)
	}
}
