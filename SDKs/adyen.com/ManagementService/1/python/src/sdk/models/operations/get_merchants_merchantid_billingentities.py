...
from ..shared import billingentitiesresponse as shared_billingentitiesresponse
...
class GetMerchantsMerchantIDBillingEntitiesSecurity:
...
class GetMerchantsMerchantIDBillingEntitiesRequest:
    ...
    r"""The name of the billing entity."""  
    

@dataclasses.dataclass
class GetMerchantsMerchantIDBillingEntitiesResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    billing_entities_response: Optional[shared_billingentitiesresponse.BillingEntitiesResponse] = dataclasses.field(default=None)
