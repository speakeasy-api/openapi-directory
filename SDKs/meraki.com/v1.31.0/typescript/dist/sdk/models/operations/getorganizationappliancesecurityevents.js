...
exports.GetOrganizationApplianceSecurityEventsResponse = exports.GetOrganizationApplianceSecurityEventsRequest = exports.GetOrganizationApplianceSecurityEventsSortOrderEnum = void 0;
...
var GetOrganizationApplianceSecurityEventsRequest = /** @class */ (function (_super) {
    ...
    ], GetOrganizationApplianceSecurityEventsRequest.prototype, "endingBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=organizationId",
        }),
        __metadata("design:type", String)
    ], GetOrganizationApplianceSecurityEventsRequest.prototype, "organizationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=perPage",
        }),
        __metadata("design:type", Number)
    ], GetOrganizationApplianceSecurityEventsRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sortOrder",
        }),
        __metadata("design:type", String)
    ], GetOrganizationApplianceSecurityEventsRequest.prototype, "sortOrder", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=startingAfter",
        }),
        __metadata("design:type", String)
    ], GetOrganizationApplianceSecurityEventsRequest.prototype, "startingAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t0" }),
        __metadata("design:type", String)
    ], GetOrganizationApplianceSecurityEventsRequest.prototype, "t0", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t1" }),
        __metadata("design:type", String)
    ], GetOrganizationApplianceSecurityEventsRequest.prototype, "t1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timespan",
        }),
        __metadata("design:type", Number)
    ], GetOrganizationApplianceSecurityEventsRequest.prototype, "timespan", void 0);
...
var GetOrganizationApplianceSecurityEventsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetOrganizationApplianceSecurityEventsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Array)
    ], GetOrganizationApplianceSecurityEventsResponse.prototype, "getOrganizationApplianceSecurityEvents200ApplicationJSONObjects", void 0);
