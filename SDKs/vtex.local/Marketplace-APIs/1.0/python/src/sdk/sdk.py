...
from . import utils
from .matched_offers import MatchedOffers
from .notification import Notification
from .sales_channel_mapping import SalesChannelMapping
from .seller_commissions import SellerCommissions
from .seller_invite import SellerInvite
...
class SDK:
    ...
    sales_channel_mapping: SalesChannelMapping
    r"""Mapping between a marketplace's sales channel and a seller's affiliate."""
    seller_commissions: SellerCommissions
    r"""Get sellers' data"""
    seller_invite: SellerInvite
    ...
    def _init_sdks(self):
        self.matched_offers = MatchedOffers(
            self._client,
        ...
        self.sales_channel_mapping = SalesChannelMapping(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.seller_commissions = SellerCommissions(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.seller_invite = SellerInvite(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
