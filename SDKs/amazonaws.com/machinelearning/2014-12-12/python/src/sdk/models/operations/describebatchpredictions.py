...
class DescribeBatchPredictionsRequest:
    ...
    describe_batch_predictions_input: shared_describebatchpredictionsinput.DescribeBatchPredictionsInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
