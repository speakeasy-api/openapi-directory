...
var Fleet = /** @class */ (function () {
    ...
    Fleet.prototype.getFleetFleetname = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/fleet/{fleetname}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetFleetFleetnameResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getFleetFleetname200ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetFleetFleetname200ApplicationJSON);
                    }
                    break;
            }
            return res;
