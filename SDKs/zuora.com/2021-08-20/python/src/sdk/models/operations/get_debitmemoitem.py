...
from ..shared import getdebitmemoitemtype as shared_getdebitmemoitemtype
...
class GETDebitMemoItemResponse:
    ...
    get_debit_memo_item_type: Optional[shared_getdebitmemoitemtype.GETDebitMemoItemType] = dataclasses.field(default=None)  
