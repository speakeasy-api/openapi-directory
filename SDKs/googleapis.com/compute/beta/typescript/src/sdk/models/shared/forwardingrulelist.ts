 ...
 */
export enum ForwardingRuleListWarningCodeEnum {
...
export class ForwardingRuleListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ForwardingRuleListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: ForwardingRuleListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class ForwardingRuleList extends SpeakeasyBase {
  /**
