...
type IamLocationsWorkforcePoolsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type IamLocationsWorkforcePoolsListPathParams struct {
	// The location of the pool. Format: `locations/{location}`.
	Location string `pathParam:"style=simple,explode=false,name=location"`
}

type IamLocationsWorkforcePoolsListQueryParams struct {
	// V1 error format.
...
type IamLocationsWorkforcePoolsListRequest struct {
	PathParams  IamLocationsWorkforcePoolsListPathParams
	QueryParams IamLocationsWorkforcePoolsListQueryParams
	Security    IamLocationsWorkforcePoolsListSecurity
}

type IamLocationsWorkforcePoolsListResponse struct {
	ContentType string
	// Successful response
	ListWorkforcePoolsResponse *shared.ListWorkforcePoolsResponse
	StatusCode                 int
