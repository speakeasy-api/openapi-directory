...
from ..shared import deleteuserresponse as shared_deleteuserresponse
...
class UsersDeleteRequest:
    headers: UsersDeleteHeaders = dataclasses.field()
...
class UsersDeleteResponse:
    ...
    delete_user_response: Optional[shared_deleteuserresponse.DeleteUserResponse] = dataclasses.field(default=None)
