...
class ListCredentialPublicKeyListCredentialPublicKeyResponse:
    ...
    credentials: Optional[list[shared_accounts_v1_credential_credential_public_key.AccountsV1CredentialCredentialPublicKey]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListCredentialPublicKeyListCredentialPublicKeyResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
