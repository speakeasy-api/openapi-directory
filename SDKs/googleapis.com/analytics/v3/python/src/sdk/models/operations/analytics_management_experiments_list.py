...
class AnalyticsManagementExperimentsListRequest:
    ...
    r"""The maximum number of experiments to include in this response."""  
    ...
    r"""An index of the first experiment to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter."""  
