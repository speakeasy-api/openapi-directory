...
var Versions = /** @class */ (function () {
    ...
    **/
    Versions.prototype.createArtifactVersion = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/versions", req.pathParams);
    ...
    **/
    Versions.prototype.getArtifactVersion = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/versions/{version}", req.pathParams);
        var client = this._defaultClient;
    ...
    **/
    Versions.prototype.updateArtifactVersionState = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/versions/{version}/state", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
