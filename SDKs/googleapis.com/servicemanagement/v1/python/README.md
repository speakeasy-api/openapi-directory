...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/googleapis.com/servicemanagement/v1/python
```
...
res = s.operations.servicemanagement_operations_get(req, operations.ServicemanagementOperationsGetSecurity(
