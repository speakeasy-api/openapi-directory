...
class Services:
    ...
    def delete_setup_v1_services_allocations_id_(self, request: operations.DeleteSetupV1ServicesAllocationsIDRequest) -> operations.DeleteSetupV1ServicesAllocationsIDResponse:
        ...
        url = utils.generate_url(operations.DeleteSetupV1ServicesAllocationsIDRequest, base_url, '/setup/v1/services/allocations/{id}', request)
        ...
        res = operations.DeleteSetupV1ServicesAllocationsIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_setup_v1_services_block_id_(self, request: operations.DeleteSetupV1ServicesBlockIDRequest) -> operations.DeleteSetupV1ServicesBlockIDResponse:
        ...
        url = utils.generate_url(operations.DeleteSetupV1ServicesBlockIDRequest, base_url, '/setup/v1/services/block/{id}', request)
        ...
        res = operations.DeleteSetupV1ServicesBlockIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_setup_v1_services_calendar_id_(self, request: operations.DeleteSetupV1ServicesCalendarIDRequest) -> operations.DeleteSetupV1ServicesCalendarIDResponse:
        r"""Delete Service Links
        <p>Use this endpoint to <b>Delete</b> service links from the calendar specified. A valid <b>calendar id</b> is required.</p>
        """
        base_url = self._server_url
        
        url = utils.generate_url(operations.DeleteSetupV1ServicesCalendarIDRequest, base_url, '/setup/v1/services/calendar/{id}', request)
        ...
        res = operations.DeleteSetupV1ServicesCalendarIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ServiceCalendarViewModel])
    ...
    def delete_setup_v1_services_id_(self, request: operations.DeleteSetupV1ServicesIDRequest) -> operations.DeleteSetupV1ServicesIDResponse:
        ...
        url = utils.generate_url(operations.DeleteSetupV1ServicesIDRequest, base_url, '/setup/v1/services/{id}', request)
        ...
        res = operations.DeleteSetupV1ServicesIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_setup_v1_services_id_deleteimage(self, request: operations.DeleteSetupV1ServicesIDDeleteimageRequest) -> operations.DeleteSetupV1ServicesIDDeleteimageResponse:
        r"""Delete Service Image
        <p>Use this endpoint to permanently <b>Delete</b> a previously uploaded service image. A valid <b>service id</b> is required.</p>
        """
        base_url = self._server_url
        
        url = utils.generate_url(operations.DeleteSetupV1ServicesIDDeleteimageRequest, base_url, '/setup/v1/services/{id}/deleteimage', request)
        ...
        res = operations.DeleteSetupV1ServicesIDDeleteimageResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_setup_v1_services(self, request: operations.GetSetupV1ServicesRequest) -> operations.GetSetupV1ServicesResponse:
        ...
        query_params = utils.get_query_params(operations.GetSetupV1ServicesRequest, request)
        ...
        res = operations.GetSetupV1ServicesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_setup_v1_services_allocations_id_(self, request: operations.GetSetupV1ServicesAllocationsIDRequest) -> operations.GetSetupV1ServicesAllocationsIDResponse:
        ...
        url = utils.generate_url(operations.GetSetupV1ServicesAllocationsIDRequest, base_url, '/setup/v1/services/allocations/{id}', request)
        ...
        res = operations.GetSetupV1ServicesAllocationsIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_setup_v1_services_blocks_id_(self, request: operations.GetSetupV1ServicesBlocksIDRequest) -> operations.GetSetupV1ServicesBlocksIDResponse:
        ...
        url = utils.generate_url(operations.GetSetupV1ServicesBlocksIDRequest, base_url, '/setup/v1/services/blocks/{id}', request)
        ...
        res = operations.GetSetupV1ServicesBlocksIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_setup_v1_services_id_(self, request: operations.GetSetupV1ServicesIDRequest) -> operations.GetSetupV1ServicesIDResponse:
        ...
        url = utils.generate_url(operations.GetSetupV1ServicesIDRequest, base_url, '/setup/v1/services/{id}', request)
        ...
        res = operations.GetSetupV1ServicesIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_setup_v1_services_id_allocations(self, request: operations.GetSetupV1ServicesIDAllocationsRequest) -> operations.GetSetupV1ServicesIDAllocationsResponse:
        ...
        url = utils.generate_url(operations.GetSetupV1ServicesIDAllocationsRequest, base_url, '/setup/v1/services/{id}/allocations', request)
        
        query_params = utils.get_query_params(operations.GetSetupV1ServicesIDAllocationsRequest, request)
        ...
        res = operations.GetSetupV1ServicesIDAllocationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_setup_v1_services_id_availability(self, request: operations.GetSetupV1ServicesIDAvailabilityRequest) -> operations.GetSetupV1ServicesIDAvailabilityResponse:
        ...
        url = utils.generate_url(operations.GetSetupV1ServicesIDAvailabilityRequest, base_url, '/setup/v1/services/{id}/availability', request)
        ...
        res = operations.GetSetupV1ServicesIDAvailabilityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ServiceAvailabilityViewModel])
    ...
    def get_setup_v1_services_id_blocks(self, request: operations.GetSetupV1ServicesIDBlocksRequest) -> operations.GetSetupV1ServicesIDBlocksResponse:
        ...
        url = utils.generate_url(operations.GetSetupV1ServicesIDBlocksRequest, base_url, '/setup/v1/services/{id}/blocks', request)
        
        query_params = utils.get_query_params(operations.GetSetupV1ServicesIDBlocksRequest, request)
        ...
        res = operations.GetSetupV1ServicesIDBlocksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ServiceBlockListViewModel])
    ...
    def get_setup_v1_services_id_calendar(self, request: operations.GetSetupV1ServicesIDCalendarRequest) -> operations.GetSetupV1ServicesIDCalendarResponse:
        ...
        url = utils.generate_url(operations.GetSetupV1ServicesIDCalendarRequest, base_url, '/setup/v1/services/{id}/calendar', request)
        
        query_params = utils.get_query_params(operations.GetSetupV1ServicesIDCalendarRequest, request)
        ...
        res = operations.GetSetupV1ServicesIDCalendarResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_setup_v1_services_id_resources(self, request: operations.GetSetupV1ServicesIDResourcesRequest) -> operations.GetSetupV1ServicesIDResourcesResponse:
        ...
        url = utils.generate_url(operations.GetSetupV1ServicesIDResourcesRequest, base_url, '/setup/v1/services/{id}/resources', request)
        
        query_params = utils.get_query_params(operations.GetSetupV1ServicesIDResourcesRequest, request)
        ...
        res = operations.GetSetupV1ServicesIDResourcesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_setup_v1_services(self, request: shared.ServiceInputModel) -> operations.PostSetupV1ServicesResponse:
        r"""Create Service
        ...
        res = operations.PostSetupV1ServicesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_setup_v1_services_calendar(self, request: shared.ServiceCalendarInputModel) -> operations.PostSetupV1ServicesCalendarResponse:
        r"""Link Service to Calendar
        ...
        res = operations.PostSetupV1ServicesCalendarResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_setup_v1_services_id_allocations(self, request: operations.PostSetupV1ServicesIDAllocationsRequest) -> operations.PostSetupV1ServicesIDAllocationsResponse:
        ...
        url = utils.generate_url(operations.PostSetupV1ServicesIDAllocationsRequest, base_url, '/setup/v1/services/{id}/allocations', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "service_allocation_input_model", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        ...
        res = operations.PostSetupV1ServicesIDAllocationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_setup_v1_services_id_allocations_bulk(self, request: operations.PostSetupV1ServicesIDAllocationsBulkRequest) -> operations.PostSetupV1ServicesIDAllocationsBulkResponse:
        ...
        url = utils.generate_url(operations.PostSetupV1ServicesIDAllocationsBulkRequest, base_url, '/setup/v1/services/{id}/allocations/bulk', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "service_allocations_input_model", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        ...
        res = operations.PostSetupV1ServicesIDAllocationsBulkResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.ServiceAllocationViewModel]])
    ...
    def post_setup_v1_services_id_block(self, request: operations.PostSetupV1ServicesIDBlockRequest) -> operations.PostSetupV1ServicesIDBlockResponse:
        ...
        url = utils.generate_url(operations.PostSetupV1ServicesIDBlockRequest, base_url, '/setup/v1/services/{id}/block', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "service_block_input_model", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        ...
        res = operations.PostSetupV1ServicesIDBlockResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ServiceBlockViewModel])
    ...
    def post_setup_v1_services_id_uploadimage(self, request: operations.PostSetupV1ServicesIDUploadimageRequest) -> operations.PostSetupV1ServicesIDUploadimageResponse:
        ...
        url = utils.generate_url(operations.PostSetupV1ServicesIDUploadimageRequest, base_url, '/setup/v1/services/{id}/uploadimage', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "service_image_input_model", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        ...
        res = operations.PostSetupV1ServicesIDUploadimageResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def put_setup_v1_services_allocations_id_(self, request: operations.PutSetupV1ServicesAllocationsIDRequest) -> operations.PutSetupV1ServicesAllocationsIDResponse:
        ...
        url = utils.generate_url(operations.PutSetupV1ServicesAllocationsIDRequest, base_url, '/setup/v1/services/allocations/{id}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "service_allocation_update_model", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        ...
        res = operations.PutSetupV1ServicesAllocationsIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def put_setup_v1_services_block_id_(self, request: operations.PutSetupV1ServicesBlockIDRequest) -> operations.PutSetupV1ServicesBlockIDResponse:
        ...
        url = utils.generate_url(operations.PutSetupV1ServicesBlockIDRequest, base_url, '/setup/v1/services/block/{id}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "service_block_update_model", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        ...
        res = operations.PutSetupV1ServicesBlockIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def put_setup_v1_services_id_(self, request: operations.PutSetupV1ServicesIDRequest) -> operations.PutSetupV1ServicesIDResponse:
        ...
        url = utils.generate_url(operations.PutSetupV1ServicesIDRequest, base_url, '/setup/v1/services/{id}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "service_update_model", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        ...
        res = operations.PutSetupV1ServicesIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def put_setup_v1_services_id_availability(self, request: operations.PutSetupV1ServicesIDAvailabilityRequest) -> operations.PutSetupV1ServicesIDAvailabilityResponse:
        ...
        url = utils.generate_url(operations.PutSetupV1ServicesIDAvailabilityRequest, base_url, '/setup/v1/services/{id}/availability', request)
        ...
        res = operations.PutSetupV1ServicesIDAvailabilityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def put_setup_v1_services_id_recover(self, request: operations.PutSetupV1ServicesIDRecoverRequest) -> operations.PutSetupV1ServicesIDRecoverResponse:
        ...
        url = utils.generate_url(operations.PutSetupV1ServicesIDRecoverRequest, base_url, '/setup/v1/services/{id}/recover', request)
        ...
        res = operations.PutSetupV1ServicesIDRecoverResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
