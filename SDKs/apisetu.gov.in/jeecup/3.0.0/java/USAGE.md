    ...
    public static void main(String[] args) {
        try {
            ...
            AdcrdRequestBody req = new AdcrdRequestBody(AdcrdRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new AdcrdRequestBodyCertificateParameters("2000001", "31-12-1980", "2018", "Sunil Kumar");;
            ...
            AdcrdResponse res = sdk.apIs.adcrd(req, new AdcrdSecurity("molestiae", "minus") {{
