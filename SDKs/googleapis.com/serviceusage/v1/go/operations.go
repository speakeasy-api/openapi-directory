...
func (s *operationsT) ServiceusageOperationsCancel(ctx context.Context, request operations.ServiceusageOperationsCancelRequest, security operations.ServiceusageOperationsCancelSecurity) (*operations.ServiceusageOperationsCancelResponse, error) {
	baseURL := s.serverURL
...
func (s *operationsT) ServiceusageOperationsDelete(ctx context.Context, request operations.ServiceusageOperationsDeleteRequest, security operations.ServiceusageOperationsDeleteSecurity) (*operations.ServiceusageOperationsDeleteResponse, error) {
	baseURL := s.serverURL
