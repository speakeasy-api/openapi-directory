...
@dataclasses.dataclass
class PoolGetRequest:
    headers: PoolGetHeaders = dataclasses.field()
    path_params: PoolGetPathParams = dataclasses.field()
    query_params: PoolGetQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class PoolGetResponse:
    content_type: str = dataclasses.field()
    headers: dict[str, list[str]] = dataclasses.field()
    status_code: int = dataclasses.field()
    batch_error: Optional[Any] = dataclasses.field(default=None)
    cloud_pool: Optional[Any] = dataclasses.field(default=None)
