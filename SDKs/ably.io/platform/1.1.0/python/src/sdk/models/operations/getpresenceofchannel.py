...
@dataclasses.dataclass
class GetPresenceOfChannelHeaders:
...
class GetPresenceOfChannelRequest:
    headers: GetPresenceOfChannelHeaders = dataclasses.field()
    path_params: GetPresenceOfChannelPathParams = dataclasses.field()
    query_params: GetPresenceOfChannelQueryParams = dataclasses.field()
