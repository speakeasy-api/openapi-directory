...
export class CreateDomesticStandingOrdersRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateDomesticStandingOrdersRawRequest extends SpeakeasyBase {
  /**
...
export class CreateDomesticStandingOrdersRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
