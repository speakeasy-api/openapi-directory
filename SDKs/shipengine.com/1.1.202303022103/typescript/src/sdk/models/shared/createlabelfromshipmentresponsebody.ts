 ...
 */
export enum CreateLabelFromShipmentResponseBodyDisplaySchemeEnum {
  Label = "label",
  QrCode = "qr_code",
 ...
 *
 */
export enum CreateLabelFromShipmentResponseBodyLabelFormatEnum {
  Pdf = "pdf",
  Png = "png",
  Zpl = "zpl",
}
 ...
 *
 */
export enum CreateLabelFromShipmentResponseBodyLabelLayoutEnum {
  Fourx6 = "4x6",
  Letter = "letter",
}
 ...
 *
 */
export enum CreateLabelFromShipmentResponseBodyLabelStatusEnum {
 ...
 */
export enum CreateLabelFromShipmentResponseBodyTrackingStatusEnum {
  Unknown = "unknown",
...
export class CreateLabelFromShipmentResponseBodyOutput extends SpeakeasyBase {
  ...
  @Type(() => CreateLabelFromShipmentResponseBodyOptionalLink)
  ...
  @Type(() => CreateLabelFromShipmentResponseBodyMonetaryValue)
  ...
  @Type(() => CreateLabelFromShipmentResponseBodyLabelDownload)
