...
const (
	TagResourceXAmzTargetEnumGlobalAcceleratorV20180706TagResource TagResourceXAmzTargetEnum = "GlobalAccelerator_V20180706.TagResource"
)
...
func (e *TagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "GlobalAccelerator_V20180706.TagResource":
