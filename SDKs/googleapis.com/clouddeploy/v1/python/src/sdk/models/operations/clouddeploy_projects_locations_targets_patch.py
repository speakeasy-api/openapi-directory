...
class ClouddeployProjectsLocationsTargetsPatchRequest:
    path_params: ClouddeployProjectsLocationsTargetsPatchPathParams = dataclasses.field()
    query_params: ClouddeployProjectsLocationsTargetsPatchQueryParams = dataclasses.field()
    security: ClouddeployProjectsLocationsTargetsPatchSecurity = dataclasses.field()
