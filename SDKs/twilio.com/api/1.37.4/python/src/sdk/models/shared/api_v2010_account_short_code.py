...
class APIV2010AccountShortCode:
    ...
    sms_fallback_method: Optional[APIV2010AccountShortCodeSmsFallbackMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sms_fallback_method') }})
    ...
    sms_method: Optional[APIV2010AccountShortCodeSmsMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sms_method') }})
