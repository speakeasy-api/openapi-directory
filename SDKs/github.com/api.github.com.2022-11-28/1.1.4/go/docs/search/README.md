...
func main() {
    ...
    res, err := s.Search.SearchCode(ctx, operations.SearchCodeRequest{
        ...
        Page: sdk.Int64(95123),
        PerPage: sdk.Int64(555194),
        Q: "odio",
...
func main() {
    ...
    res, err := s.Search.SearchCommits(ctx, operations.SearchCommitsRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(780789),
        PerPage: sdk.Int64(400470),
        Q: "mollitia",
...
func main() {
    ...
    res, err := s.Search.SearchIssuesAndPullRequests(ctx, operations.SearchIssuesAndPullRequestsRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(92851),
        PerPage: sdk.Int64(860027),
        Q: "magni",
        Sort: operations.SearchIssuesAndPullRequestsSortEnumReactionsHeart.ToPointer(),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Search.SearchLabels(ctx, operations.SearchLabelsRequest{
        ...
        Page: sdk.Int64(950661),
        PerPage: sdk.Int64(771078),
        Q: "unde",
        RepositoryID: 281454,
...
func main() {
    ...
    res, err := s.Search.SearchRepos(ctx, operations.SearchReposRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(987384),
        PerPage: sdk.Int64(926027),
        Q: "quisquam",
        Sort: operations.SearchReposSortEnumUpdated.ToPointer(),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Search.SearchTopics(ctx, operations.SearchTopicsRequest{
        Page: sdk.Int64(491380),
        PerPage: sdk.Int64(614346),
        Q: "provident",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Search.SearchUsers(ctx, operations.SearchUsersRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(573247),
        PerPage: sdk.Int64(44252),
        Q: "eaque",
        Sort: operations.SearchUsersSortEnumRepositories.ToPointer(),
    })
    if err != nil {
        log.Fatal(err)
    }
