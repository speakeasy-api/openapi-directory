...
class GetNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum(str, Enum):
...
class GetNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum(str, Enum):
...
@dataclasses.dataclass
class GetNetworkSwitchAccessPolicy200ApplicationJSONDot1x:
    r"""802.1x Settings"""
    
    control_direction: Optional[GetNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('controlDirection'), 'exclude': lambda f: f is None }})
    r"""Supports either 'both' or 'inbound'. Set to 'inbound' to allow unauthorized egress on the switchport. Set to 'both' to control both traffic directions with authorization. Defaults to 'both'"""  
    
class GetNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetNetworkSwitchAccessPolicy200ApplicationJSONRadiusCriticalAuth:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetNetworkSwitchAccessPolicy200ApplicationJSONRadius:
    r"""Object for RADIUS Settings"""
    
    critical_auth: Optional[GetNetworkSwitchAccessPolicy200ApplicationJSONRadiusCriticalAuth] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('criticalAuth'), 'exclude': lambda f: f is None }})
    r"""Critical auth settings for when authentication is rejected by the RADIUS server"""  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetNetworkSwitchAccessPolicy200ApplicationJSONRadiusAccountingServers:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetNetworkSwitchAccessPolicy200ApplicationJSONRadiusServers:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetNetworkSwitchAccessPolicy200ApplicationJSON:
    r"""Successful operation"""
    
    access_policy_type: Optional[GetNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('accessPolicyType'), 'exclude': lambda f: f is None }})
    r"""Access Type of the policy. Automatically 'Hybrid authentication' when hostMode is 'Multi-Domain'."""  
    dot1x: Optional[GetNetworkSwitchAccessPolicy200ApplicationJSONDot1x] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dot1x'), 'exclude': lambda f: f is None }})
    r"""802.1x Settings"""  
    ...
    host_mode: Optional[GetNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('hostMode'), 'exclude': lambda f: f is None }})
    r"""Choose the Host Mode for the access policy."""  
    ...
    radius: Optional[GetNetworkSwitchAccessPolicy200ApplicationJSONRadius] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radius'), 'exclude': lambda f: f is None }})
    r"""Object for RADIUS Settings"""  
    ...
    radius_accounting_servers: Optional[list[GetNetworkSwitchAccessPolicy200ApplicationJSONRadiusAccountingServers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radiusAccountingServers'), 'exclude': lambda f: f is None }})
    ...
    radius_servers: Optional[list[GetNetworkSwitchAccessPolicy200ApplicationJSONRadiusServers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('radiusServers'), 'exclude': lambda f: f is None }})
...
class GetNetworkSwitchAccessPolicyResponse:
    ...
    get_network_switch_access_policy_200_application_json_object: Optional[GetNetworkSwitchAccessPolicy200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
