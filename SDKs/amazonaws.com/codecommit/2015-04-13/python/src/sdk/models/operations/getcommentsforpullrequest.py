...
class GetCommentsForPullRequestQueryParams:
...
@dataclasses.dataclass
class GetCommentsForPullRequestHeaders:
...
class GetCommentsForPullRequestRequest:
    headers: GetCommentsForPullRequestHeaders = dataclasses.field()
    query_params: GetCommentsForPullRequestQueryParams = dataclasses.field()
    request: shared_getcommentsforpullrequestinput.GetCommentsForPullRequestInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
