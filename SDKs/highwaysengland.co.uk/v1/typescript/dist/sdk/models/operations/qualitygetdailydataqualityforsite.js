...
exports.QualityGetDailyDataQualityForSiteResponse = exports.QualityGetDailyDataQualityForSiteRequest = void 0;
...
var QualityGetDailyDataQualityForSiteRequest = /** @class */ (function (_super) {
    ...
    ], QualityGetDailyDataQualityForSiteRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=siteId",
        }),
        __metadata("design:type", String)
    ], QualityGetDailyDataQualityForSiteRequest.prototype, "siteId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=start_date",
        }),
        __metadata("design:type", String)
    ], QualityGetDailyDataQualityForSiteRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=version",
        }),
        __metadata("design:type", String)
    ], QualityGetDailyDataQualityForSiteRequest.prototype, "version", void 0);
...
var QualityGetDailyDataQualityForSiteResponse = /** @class */ (function (_super) {
    ...
    ], QualityGetDailyDataQualityForSiteResponse.prototype, "rawResponse", void 0);
