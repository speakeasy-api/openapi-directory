...
class GetNamesNearEmbedEnum(str, Enum):
...
class GetNamesNearOutputSrsEnum(str, Enum):
...
class GetNamesNearRequest:
    ...
    r"""A radius (in kilometres) around the centre point."""  
    feature_point: str = dataclasses.field(metadata={'query_param': { 'field_name': 'featurePoint', 'style': 'form', 'explode': True }})
    r"""A geographic coordinate specifying the centre point of the search area.  Must be specified as a string of the form 'longitude,latitude' (WGS84).  e.g. -120,51"""  
    ...
    r"""The format of the output."""  
    embed: Optional[GetNamesNearEmbedEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'embed', 'style': 'form', 'explode': True }})
    r"""A flag to indicate whether to embed the corresponding 'feature' into each matching name"""  
    ...
    output_srs: Optional[GetNamesNearOutputSrsEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outputSRS', 'style': 'form', 'explode': True }})
    r"""The EPSG code of the spatial reference system (SRS) to use for output geometries."""  
