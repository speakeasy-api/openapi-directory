...
public class GetEnhancedProfitAndLossRequest {
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=companyId")
    public String companyId;

    public GetEnhancedProfitAndLossRequest withCompanyId(String companyId) {
    ...
    public GetEnhancedProfitAndLossRequest withConnectionId(String connectionId) {
    ...
    public GetEnhancedProfitAndLossRequest withIncludeDisplayNames(Boolean includeDisplayNames) {
    ...
    public GetEnhancedProfitAndLossRequest withNumberOfPeriods(Long numberOfPeriods) {
    ...
    public GetEnhancedProfitAndLossRequest withPeriodLength(Long periodLength) {
    ...
    public GetEnhancedProfitAndLossRequest withReportDate(String reportDate) {
        this.reportDate = reportDate;
        return this;
    }
    
    public GetEnhancedProfitAndLossRequest(@JsonProperty("companyId") String companyId, @JsonProperty("connectionId") String connectionId, @JsonProperty("numberOfPeriods") Long numberOfPeriods, @JsonProperty("periodLength") Long periodLength, @JsonProperty("reportDate") String reportDate) {
        this.companyId = companyId;
        this.connectionId = connectionId;
        this.numberOfPeriods = numberOfPeriods;
        this.periodLength = periodLength;
