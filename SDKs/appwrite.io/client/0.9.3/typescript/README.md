...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/appwrite.io/client/0.9.3/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/appwrite.io/client/0.9.3/typescript
```
