...
exports.LinksOptimiseLink = void 0;
...
var LinksOptimiseLink = /** @class */ (function (_super) {
    __extends(LinksOptimiseLink, _super);
    function LinksOptimiseLink() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=allOptionalParamsProvided" }),
        __metadata("design:type", Boolean)
    ], LinksOptimiseLink.prototype, "allOptionalParamsProvided", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=allRequiredParamsProvided" }),
        __metadata("design:type", Boolean)
    ], LinksOptimiseLink.prototype, "allRequiredParamsProvided", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=description" }),
        __metadata("design:type", String)
    ], LinksOptimiseLink.prototype, "description", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=docUrl" }),
        __metadata("design:type", String)
    ], LinksOptimiseLink.prototype, "docUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=href" }),
        __metadata("design:type", String)
    ], LinksOptimiseLink.prototype, "href", void 0);
    __decorate([
    ...
    ], LinksOptimiseLink.prototype, "info", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=label" }),
        __metadata("design:type", String)
    ], LinksOptimiseLink.prototype, "label", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=method" }),
        __metadata("design:type", String)
    ], LinksOptimiseLink.prototype, "method", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=operationId" }),
        __metadata("design:type", String)
    ], LinksOptimiseLink.prototype, "operationId", void 0);
    __decorate([
    ...
    ], LinksOptimiseLink.prototype, "parameters", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=urlTemplated" }),
        __metadata("design:type", Boolean)
    ], LinksOptimiseLink.prototype, "urlTemplated", void 0);
    return LinksOptimiseLink;
}(utils_1.SpeakeasyBase));
exports.LinksOptimiseLink = LinksOptimiseLink;
