...
exports.GetPayRunsWithTagResponse = exports.GetPayRunsWithTagRequest = void 0;
...
var GetPayRunsWithTagRequest = /** @class */ (function (_super) {
    ...
    ], GetPayRunsWithTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetPayRunsWithTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetPayRunsWithTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayScheduleId",
        }),
        __metadata("design:type", String)
    ], GetPayRunsWithTagRequest.prototype, "payScheduleId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetPayRunsWithTagRequest.prototype, "tagId", void 0);
    return GetPayRunsWithTagRequest;
}(utils_1.SpeakeasyBase));
exports.GetPayRunsWithTagRequest = GetPayRunsWithTagRequest;
var GetPayRunsWithTagResponse = /** @class */ (function (_super) {
    ...
    ], GetPayRunsWithTagResponse.prototype, "rawResponse", void 0);
    return GetPayRunsWithTagResponse;
}(utils_1.SpeakeasyBase));
exports.GetPayRunsWithTagResponse = GetPayRunsWithTagResponse;
