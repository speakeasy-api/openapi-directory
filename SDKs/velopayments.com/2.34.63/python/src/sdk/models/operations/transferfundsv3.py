...
from ..shared import transferrequestv3 as shared_transferrequestv3
...
class TransferFundsV3Request:
    ...
    r"""The 'from' source account id, which will be debited"""  
    transfer_request_v3: shared_transferrequestv3.TransferRequestV3 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Body"""  
