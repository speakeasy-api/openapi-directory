        ...
        case httpRes?.status == 415:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.projectsAddCollaborator415ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.ProjectsAddCollaborator415ApplicationJSON
              );
          }
          break;
        ...
        case httpRes?.status == 415:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.projectsGetPermissionForUser415ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.ProjectsGetPermissionForUser415ApplicationJSON
              );
          }
          break;
        case httpRes?.status == 422:
        ...
        case httpRes?.status == 415:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.projectsListCollaborators415ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.ProjectsListCollaborators415ApplicationJSON
              );
          }
          break;
        case httpRes?.status == 422:
        ...
        case httpRes?.status == 415:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.projectsListForUser415ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.ProjectsListForUser415ApplicationJSON
              );
          }
          break;
        case httpRes?.status == 422:
        ...
        case httpRes?.status == 415:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.projectsRemoveCollaborator415ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.ProjectsRemoveCollaborator415ApplicationJSON
              );
          }
          break;
        case httpRes?.status == 422:
