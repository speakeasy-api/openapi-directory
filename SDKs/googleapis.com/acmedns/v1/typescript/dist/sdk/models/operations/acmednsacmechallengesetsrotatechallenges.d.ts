...
export declare class AcmednsAcmeChallengeSetsRotateChallengesRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class AcmednsAcmeChallengeSetsRotateChallengesResponse extends SpeakeasyBase {
    /**
     * Successful response
     */
