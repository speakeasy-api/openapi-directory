...
func (e *GetUsersIdsQuestionsUnansweredOrderEnum) UnmarshalJSON(data []byte) error {
	...
	case "desc":
		fallthrough
	case "asc":
		*e = GetUsersIdsQuestionsUnansweredOrderEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersIdsQuestionsUnansweredOrderEnum: %s", s)
	}
}
...
func (e *GetUsersIdsQuestionsUnansweredSortEnum) UnmarshalJSON(data []byte) error {
	...
	case "creation":
		fallthrough
	case "votes":
		*e = GetUsersIdsQuestionsUnansweredSortEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersIdsQuestionsUnansweredSortEnum: %s", s)
	}
}
