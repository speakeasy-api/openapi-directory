...
public class PutConfigurationSetVdmOptionsRequest {
    ...
    public PutConfigurationSetVdmOptionsRequest(@JsonProperty("ConfigurationSetName") String configurationSetName, @JsonProperty("RequestBody") PutConfigurationSetVdmOptionsRequestBody requestBody) {
        this.configurationSetName = configurationSetName;
        this.requestBody = requestBody;
  }
}
