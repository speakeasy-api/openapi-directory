...
from ..shared import createmessageresponse as shared_createmessageresponse
...
@dataclasses.dataclass
class MessagesAddSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class MessagesAddRequest:
    headers: MessagesAddHeaders = dataclasses.field()
    query_params: MessagesAddQueryParams = dataclasses.field()
    request: shared_message.MessageInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: MessagesAddSecurity = dataclasses.field()
    

@dataclasses.dataclass
class MessagesAddResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    create_message_response: Optional[shared_createmessageresponse.CreateMessageResponse] = dataclasses.field(default=None)
