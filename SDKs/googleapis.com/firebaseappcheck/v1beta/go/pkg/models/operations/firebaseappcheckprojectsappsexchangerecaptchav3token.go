...
type FirebaseappcheckProjectsAppsExchangeRecaptchaV3TokenRequest struct {
	...
	GoogleFirebaseAppcheckV1betaExchangeRecaptchaV3TokenRequest *shared.GoogleFirebaseAppcheckV1betaExchangeRecaptchaV3TokenRequest `request:"mediaType=application/json"`
	// OAuth access token.
