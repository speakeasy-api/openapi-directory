...
class DatastoreProjectsExportRequest:
    ...
    google_datastore_admin_v1beta1_export_entities_request: Optional[shared_googledatastoreadminv1beta1exportentitiesrequest.GoogleDatastoreAdminV1beta1ExportEntitiesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
