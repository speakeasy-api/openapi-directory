...
class TagResourceRequestBody:
    ...
    r"""Required. The Amazon Resource Name (ARN) associated with the resource you want to tag."""  
    tags: list[shared_tag.Tag] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Tags') }})
    r"""Required. A list of objects specifying each key name and value. Number of objects allowed: 1-50."""  
