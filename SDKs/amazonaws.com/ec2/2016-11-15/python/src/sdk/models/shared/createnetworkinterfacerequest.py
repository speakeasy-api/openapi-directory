...
import dataclasses
from ..shared import networkinterfacecreationtype_enum as shared_networkinterfacecreationtype_enum
from enum import Enum
from typing import Optional


@dataclasses.dataclass
class CreateNetworkInterfaceRequestIpv4Prefixes:
...
@dataclasses.dataclass
class CreateNetworkInterfaceRequestIpv6Addresses:
...
@dataclasses.dataclass
class CreateNetworkInterfaceRequestIpv6Prefixes:
    r"""Describes the IPv4 prefix option for a network interface."""
...
@dataclasses.dataclass
class CreateNetworkInterfaceRequestPrivateIPAddresses:
...
class CreateNetworkInterfaceRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateNetworkInterfaceRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateNetworkInterfaceRequestTagSpecifications:
    ...
    resource_type: Optional[CreateNetworkInterfaceRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateNetworkInterfaceRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateNetworkInterfaceRequest:
    ...
    interface_type: Optional[shared_networkinterfacecreationtype_enum.NetworkInterfaceCreationTypeEnum] = dataclasses.field(default=None)  
    ipv4_prefix_count: Optional[int] = dataclasses.field(default=None)  
    ipv4_prefixes: Optional[list[CreateNetworkInterfaceRequestIpv4Prefixes]] = dataclasses.field(default=None)  
    ipv6_address_count: Optional[int] = dataclasses.field(default=None)  
    ipv6_addresses: Optional[list[CreateNetworkInterfaceRequestIpv6Addresses]] = dataclasses.field(default=None)  
    ipv6_prefix_count: Optional[int] = dataclasses.field(default=None)  
    ipv6_prefixes: Optional[list[CreateNetworkInterfaceRequestIpv6Prefixes]] = dataclasses.field(default=None)  
    private_ip_address: Optional[str] = dataclasses.field(default=None)  
    private_ip_addresses: Optional[list[CreateNetworkInterfaceRequestPrivateIPAddresses]] = dataclasses.field(default=None)  
    secondary_private_ip_address_count: Optional[int] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateNetworkInterfaceRequestTagSpecifications]] = dataclasses.field(default=None)  
