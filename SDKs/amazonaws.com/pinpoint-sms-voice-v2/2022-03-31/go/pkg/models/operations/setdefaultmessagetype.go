...
type SetDefaultMessageTypeHeaders struct {
...
type SetDefaultMessageTypeRequest struct {
	Headers SetDefaultMessageTypeHeaders
	Request shared.SetDefaultMessageTypeRequest `request:"mediaType=application/json"`
}
