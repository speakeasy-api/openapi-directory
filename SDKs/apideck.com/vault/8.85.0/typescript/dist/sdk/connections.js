...
var Connections = /** @class */ (function () {
     ...
     *
    **/
    Connections.prototype.connectionSettingsAll = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ConnectionSettingsAllRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/vault/connections/{unified_api}/{service_id}/{resource}/config", req.pathParams);
    ...
    **/
    Connections.prototype.connectionSettingsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Connections.prototype.connectionsAdd = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ConnectionsAddRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/vault/connections/{unified_api}/{service_id}", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
     ...
     *
    **/
    Connections.prototype.connectionsAll = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Connections.prototype.connectionsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Connections.prototype.connectionsImport = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ConnectionsImportRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/vault/connections/{unified_api}/{service_id}/import", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
     ...
     * Get a connection
    **/
    Connections.prototype.connectionsOne = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Connections.prototype.connectionsRevoke = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/vault/revoke/{service_id}/{application_id}", req.pathParams);
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     *
    **/
    Connections.prototype.connectionsToken = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ConnectionsTokenRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/vault/connections/{unified_api}/{service_id}/token", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
     ...
     * Update a connection
    **/
    Connections.prototype.connectionsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
