...
public class GetUsersIdPrivilegesRequest {
    ...
    public GetUsersIdPrivilegesRequest withCallback(String callback) {
    ...
    public GetUsersIdPrivilegesRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdPrivilegesRequest withId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public GetUsersIdPrivilegesRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdPrivilegesRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdPrivilegesRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    public GetUsersIdPrivilegesRequest(@JsonProperty("id") Long id, @JsonProperty("site") String site) {
        this.id = id;
        this.site = site;
  }
}
