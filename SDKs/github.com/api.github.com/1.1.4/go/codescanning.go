...
func (s *CodeScanning) CodeScanningListAlertsInstances(ctx context.Context, request operations.CodeScanningListAlertsInstancesRequest) (*operations.CodeScanningListAlertsInstancesResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.CodeScanningListAlertsInstancesResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	...
	case httpRes.StatusCode == 503:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.CodeScanningListAlertsInstances503ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}

			res.CodeScanningListAlertsInstances503ApplicationJSONObject = out
		}
	}
