...
class EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails
{
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Shared\EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot> $eventExecutionSnapshot
     */
	#[\JMS\Serializer\Annotation\SerializedName('eventExecutionSnapshot')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Shared\EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\EnterpriseCrmFrontendsEventbusProtoEventExecutionDetailsEventExecutionStateEnum $eventExecutionState
     */
	#[\JMS\Serializer\Annotation\SerializedName('eventExecutionState')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\EnterpriseCrmFrontendsEventbusProtoEventExecutionDetailsEventExecutionStateEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?EnterpriseCrmFrontendsEventbusProtoEventExecutionDetailsEventExecutionStateEnum $eventExecutionState = null;
