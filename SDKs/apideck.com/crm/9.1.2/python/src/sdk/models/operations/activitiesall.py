...
from ..shared import activitiesfilter as shared_activitiesfilter
from ..shared import badrequestresponse as shared_badrequestresponse
from ..shared import getactivitiesresponse as shared_getactivitiesresponse
...
class ActivitiesAllRequest:
    ...
    filter: Optional[shared_activitiesfilter.ActivitiesFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    r"""Apply filters"""  
...
class ActivitiesAllResponse:
    ...
    r"""Bad Request"""  
    get_activities_response: Optional[shared_getactivitiesresponse.GetActivitiesResponse] = dataclasses.field(default=None)
    r"""Activities"""  
