...
export class Users {
  ...
  usersCreateSshSigningKeyForAuthenticatedUser(
    req: operations.UsersCreateSshSigningKeyForAuthenticatedUserRequestBody,
    config?: AxiosRequestConfig
  ): Promise<operations.UsersCreateSshSigningKeyForAuthenticatedUserResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.UsersCreateSshSigningKeyForAuthenticatedUserRequestBody(
          req
        );
    }

    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/user/ssh_signing_keys";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersCreateSshSigningKeyForAuthenticatedUserResponse =
        new operations.UsersCreateSshSigningKeyForAuthenticatedUserResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.sshSigningKey = utils.objectToClass(
              httpRes?.data,
              shared.SshSigningKey
            );
          }
          break;
        case httpRes?.status == 304:
  ...
  usersDeleteSshSigningKeyForAuthenticatedUser(
    req: operations.UsersDeleteSshSigningKeyForAuthenticatedUserRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UsersDeleteSshSigningKeyForAuthenticatedUserResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UsersDeleteSshSigningKeyForAuthenticatedUserRequest(
        req
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersDeleteSshSigningKeyForAuthenticatedUserResponse =
        new operations.UsersDeleteSshSigningKeyForAuthenticatedUserResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  usersGetSshSigningKeyForAuthenticatedUser(
    req: operations.UsersGetSshSigningKeyForAuthenticatedUserRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UsersGetSshSigningKeyForAuthenticatedUserResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UsersGetSshSigningKeyForAuthenticatedUserRequest(
        req
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersGetSshSigningKeyForAuthenticatedUserResponse =
        new operations.UsersGetSshSigningKeyForAuthenticatedUserResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  usersListSshSigningKeysForAuthenticatedUser(
    req: operations.UsersListSshSigningKeysForAuthenticatedUserRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UsersListSshSigningKeysForAuthenticatedUserResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UsersListSshSigningKeysForAuthenticatedUserRequest(
        req
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersListSshSigningKeysForAuthenticatedUserResponse =
        new operations.UsersListSshSigningKeysForAuthenticatedUserResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.sshSigningKeys = [];
            const resFieldDepth: number = utils.getResFieldDepth(res);
            res.sshSigningKeys = utils.objectToClass(
              httpRes?.data,
              shared.SshSigningKey,
              resFieldDepth
            );
  ...
  usersListSshSigningKeysForUser(
    req: operations.UsersListSshSigningKeysForUserRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UsersListSshSigningKeysForUserResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UsersListSshSigningKeysForUserResponse =
        new operations.UsersListSshSigningKeysForUserResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
