...
@dataclasses.dataclass
class AndroidpublisherMonetizationSubscriptionsCreateQueryParams:
...
class AndroidpublisherMonetizationSubscriptionsCreateRequest:
    path_params: AndroidpublisherMonetizationSubscriptionsCreatePathParams = dataclasses.field()
    query_params: AndroidpublisherMonetizationSubscriptionsCreateQueryParams = dataclasses.field()
    security: AndroidpublisherMonetizationSubscriptionsCreateSecurity = dataclasses.field()
    request: Optional[shared_subscription.SubscriptionInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
