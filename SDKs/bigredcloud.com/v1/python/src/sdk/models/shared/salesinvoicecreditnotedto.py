...
from ..shared import producttrandto as shared_producttrandto
...
class SalesInvoiceCreditNoteDto:
    r"""Information of Sales Credit Note to create."""
    ...
    product_trans: Optional[list[shared_producttrandto.ProductTranDto]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('productTrans'), 'exclude': lambda f: f is None }})  
