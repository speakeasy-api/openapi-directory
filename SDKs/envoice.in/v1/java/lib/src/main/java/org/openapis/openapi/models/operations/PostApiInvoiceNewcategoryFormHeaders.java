...
public class PostApiInvoiceNewcategoryFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PostApiInvoiceNewcategoryFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public PostApiInvoiceNewcategoryFormHeaders withXAuthSecret(String xAuthSecret) {
