 ...
 */
public enum CreateTrafficMirrorSessionRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateTrafficMirrorSessionRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
