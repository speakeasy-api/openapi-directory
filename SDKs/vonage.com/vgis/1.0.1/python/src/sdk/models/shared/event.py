...
class Event:
    ...
    direction: EventDirectionEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('direction') }})
    r"""Direction of the event"""  
    ...
    state: EventStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
    r"""Status of the event"""  
    ...
    r"""External identifier of the event"""  
    sms_data: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('smsData'), 'exclude': lambda f: f is None }})  
