...
export class ApigatewayProjectsLocationsApisConfigsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ApigatewayProjectsLocationsApisConfigsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ApigatewayProjectsLocationsApisConfigsListResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
