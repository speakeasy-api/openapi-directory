...
var LanguageModels = /** @class */ (function () {
    ...
    **/
    LanguageModels.prototype.deleteModel = function (req, config) {
    ...
    **/
    LanguageModels.prototype.getTrainedModelLearningCurve = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    LanguageModels.prototype.getTrainedModelMetrics = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    LanguageModels.prototype.getTrainedModels = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
