...
export class DrivelabelsLabelsRevisionsPermissionsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DrivelabelsLabelsRevisionsPermissionsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
