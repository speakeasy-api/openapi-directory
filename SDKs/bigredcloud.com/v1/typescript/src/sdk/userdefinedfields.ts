...
export class UserDefinedFields {
  ...
  userDefinedFieldsGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.UserDefinedFieldsGetResponse =
        new operations.UserDefinedFieldsGetResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.pageResultUserDefinedFieldDto = utils.objectToClass(
              httpRes?.data,
              shared.PageResultUserDefinedFieldDto
            );
          }
          break;
      }
