...
func (e CloudidentityGroupsSearchViewEnum) ToPointer() *CloudidentityGroupsSearchViewEnum {
	return &e
}
...
func (e *CloudidentityGroupsSearchViewEnum) UnmarshalJSON(data []byte) error {
	...
	case "BASIC":
		fallthrough
	case "FULL":
		*e = CloudidentityGroupsSearchViewEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CloudidentityGroupsSearchViewEnum: %v", v)
	}
}
