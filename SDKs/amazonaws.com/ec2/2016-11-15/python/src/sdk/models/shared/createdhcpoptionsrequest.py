...
class CreateDhcpOptionsRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateDhcpOptionsRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateDhcpOptionsRequestTagSpecifications:
    ...
    resource_type: Optional[CreateDhcpOptionsRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateDhcpOptionsRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateDhcpOptionsRequest:
    
    dhcp_configurations: list[CreateDhcpOptionsRequestDhcpConfigurations] = dataclasses.field()  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateDhcpOptionsRequestTagSpecifications]] = dataclasses.field(default=None)  
