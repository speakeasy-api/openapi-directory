...
class ListEndUserTypeListEndUserTypeResponse:
    ...
    end_user_types: Optional[list[shared_numbers_v2_regulatory_compliance_end_user_type.NumbersV2RegulatoryComplianceEndUserType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('end_user_types'), 'exclude': lambda f: f is None }})  
