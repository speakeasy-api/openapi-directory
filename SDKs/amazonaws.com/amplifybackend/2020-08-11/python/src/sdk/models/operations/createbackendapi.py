...
class CreateBackendAPIRequestBodyResourceConfigConflictResolution:
    r"""CreateBackendAPIRequestBodyResourceConfigConflictResolution
...
class CreateBackendAPIRequestBodyResourceConfigDefaultAuthTypeSettings:
    r"""CreateBackendAPIRequestBodyResourceConfigDefaultAuthTypeSettings
...
class CreateBackendAPIRequestBodyResourceConfigDefaultAuthType:
    r"""CreateBackendAPIRequestBodyResourceConfigDefaultAuthType
    ...
    settings: Optional[CreateBackendAPIRequestBodyResourceConfigDefaultAuthTypeSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Settings') }})
    

@dataclass_json
@dataclasses.dataclass
class CreateBackendAPIRequestBodyResourceConfig:
    r"""CreateBackendAPIRequestBodyResourceConfig
    ...
    conflict_resolution: Optional[CreateBackendAPIRequestBodyResourceConfigConflictResolution] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ConflictResolution') }})
    default_auth_type: Optional[CreateBackendAPIRequestBodyResourceConfigDefaultAuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DefaultAuthType') }})
...
class CreateBackendAPIRequestBody:
    ...
    resource_config: CreateBackendAPIRequestBodyResourceConfig = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceConfig') }})
...
class CreateBackendAPIRequest:
    headers: CreateBackendAPIHeaders = dataclasses.field()
    path_params: CreateBackendAPIPathParams = dataclasses.field()
    request: CreateBackendAPIRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
