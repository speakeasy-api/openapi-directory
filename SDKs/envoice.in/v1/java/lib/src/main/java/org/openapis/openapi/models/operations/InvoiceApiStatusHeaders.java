...
public class InvoiceApiStatusHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiStatusHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiStatusHeaders withXAuthSecret(String xAuthSecret) {
