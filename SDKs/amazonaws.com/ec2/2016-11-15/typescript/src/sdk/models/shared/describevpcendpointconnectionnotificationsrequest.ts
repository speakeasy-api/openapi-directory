 ...
 */
export class DescribeVpcEndpointConnectionNotificationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeVpcEndpointConnectionNotificationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  filters?: DescribeVpcEndpointConnectionNotificationsRequestFilters[];
