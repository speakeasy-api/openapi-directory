...
class CreateSubmissionPathParams:
...
@dataclasses.dataclass
class CreateSubmissionSecurity:
    o_auth2: shared_security.SchemeOAuth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class CreateSubmissionRequest:
    path_params: CreateSubmissionPathParams = dataclasses.field()
    ...
    security: CreateSubmissionSecurity = dataclasses.field()
