...
class GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDDiffRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDDiffPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDDiffSecurity = dataclasses.field()
