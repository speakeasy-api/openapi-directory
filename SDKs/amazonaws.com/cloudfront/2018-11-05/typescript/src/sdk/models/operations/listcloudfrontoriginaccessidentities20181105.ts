...
export class ListCloudFrontOriginAccessIdentities20181105Request extends SpeakeasyBase {
  /**
...
export class ListCloudFrontOriginAccessIdentities20181105Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
