...
class GetCloudFrontOriginAccessIdentity20171030Request:
    headers: GetCloudFrontOriginAccessIdentity20171030Headers = dataclasses.field()
    path_params: GetCloudFrontOriginAccessIdentity20171030PathParams = dataclasses.field()
