 ...
 */
export declare enum CreateImageRequestBlockDeviceMappingsEbsVolumeTypeEnum {
    Standard = "standard",
    Io1 = "io1",
    Io2 = "io2",
    Gp2 = "gp2",
 ...
 */
export declare class CreateImageRequestBlockDeviceMappingsEbs extends SpeakeasyBase {
 ...
 */
export declare class CreateImageRequestBlockDeviceMappings extends SpeakeasyBase {
    deviceName?: string;
 ...
 */
export declare enum CreateImageRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateImageRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateImageRequestTagSpecifications extends SpeakeasyBase {
