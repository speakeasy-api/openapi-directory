...
type ContainerProjectsLocationsClustersCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContainerProjectsLocationsClustersCreatePathParams struct {
	// The parent (project and location) where the cluster will be created. Specified in the format `projects/*/locations/*`.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ContainerProjectsLocationsClustersCreateQueryParams struct {
	// V1 error format.
...
type ContainerProjectsLocationsClustersCreateResponse struct {
	ContentType string
	// Successful response
