...
class DescribeCanariesRequestBody:
    ...
    r"""Specify this parameter to limit how many canaries are returned each time you use the <code>DescribeCanaries</code> operation. If you omit this parameter, the default of 100 is used."""  
...
class DescribeCanariesRequest:
    ...
    request_body: DescribeCanariesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
