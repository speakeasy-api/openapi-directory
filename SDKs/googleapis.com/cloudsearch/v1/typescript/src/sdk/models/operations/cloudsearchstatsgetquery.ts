...
export class CloudsearchStatsGetQuerySecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudsearchStatsGetQuerySecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudsearchStatsGetQuerySecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudsearchStatsGetQuerySecurity extends SpeakeasyBase {
...
export class CloudsearchStatsGetQueryRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudsearchStatsGetQueryResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
