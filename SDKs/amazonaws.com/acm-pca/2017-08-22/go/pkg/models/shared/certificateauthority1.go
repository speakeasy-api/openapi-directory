...
type CertificateAuthority1 struct {
	Arn                               *string                             `json:"Arn,omitempty"`
	CertificateAuthorityConfiguration *CertificateAuthorityConfiguration1 `json:"CertificateAuthorityConfiguration,omitempty"`
