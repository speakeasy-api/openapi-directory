...
try {
    ...
    $request->requestBody->content = 'fugiat';
    $request->requestBody->encoding = 'vel';
...
try {
    ...
    $request->requestBody->author->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-09-18T05:25:42.565Z');
    $request->requestBody->author->email = 'Mekhi.Ritchie@hotmail.com';
    $request->requestBody->author->name = 'Lela Shields';
    $request->requestBody->committer = new GitCreateCommitRequestBodyCommitter();
    $request->requestBody->committer->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-12-15T04:58:32.488Z');
    $request->requestBody->committer->email = 'Darlene_Kirlin@hotmail.com';
    $request->requestBody->committer->name = 'Jesus Yost';
    $request->requestBody->message = 'quidem';
    ...
    $request->requestBody->signature = 'adipisci';
    $request->requestBody->tree = 'non';
    $request->owner = 'amet';
    $request->repo = 'beatae';
...
try {
    ...
    $request->requestBody->message = 'corporis';
    $request->requestBody->object = 'harum';
    $request->requestBody->tag = 'laboriosam';
    $request->requestBody->tagger = new GitCreateTagRequestBodyTagger();
    $request->requestBody->tagger->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-01-31T09:28:16.792Z');
    $request->requestBody->tagger->email = 'Beth.Tillman@hotmail.com';
    $request->requestBody->tagger->name = 'Yolanda Hirthe';
...
try {
    ...
    $request->requestBody->baseTree = 'minus';
...
try {
    ...
    $request->owner = 'hic';
    $request->recursive = 'exercitationem';
    $request->repo = 'nobis';
    $request->treeSha = 'sit';
...
try {
    ...
    $request->requestBody->sha = 'facilis';
