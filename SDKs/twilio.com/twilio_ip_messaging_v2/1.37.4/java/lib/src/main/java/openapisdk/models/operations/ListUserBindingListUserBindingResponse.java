...
public class ListUserBindingListUserBindingResponse {
    ...
    public openapisdk.models.shared.IpMessagingV2ServiceUserUserBinding[] bindings;
    public ListUserBindingListUserBindingResponse withBindings(openapisdk.models.shared.IpMessagingV2ServiceUserUserBinding[] bindings) {
