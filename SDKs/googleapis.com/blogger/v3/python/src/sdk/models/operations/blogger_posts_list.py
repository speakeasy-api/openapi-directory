...
class BloggerPostsListSortOptionEnum(str, Enum):
    r"""Sort direction applied to post list."""
...
class BloggerPostsListRequest:
    ...
    sort_option: Optional[BloggerPostsListSortOptionEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sortOption', 'style': 'form', 'explode': True }})
    r"""Sort direction applied to post list."""  
