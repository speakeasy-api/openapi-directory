...
class SchemaResponseBlocksReadRegistrationSchemaBlockAttributesBlockTypeEnum(str, Enum):
...
class SchemaResponseBlocksReadRegistrationSchemaBlockAttributes:
    ...
    block_type: Optional[SchemaResponseBlocksReadRegistrationSchemaBlockAttributesBlockTypeEnum] = dataclasses.field(default=None)
    r"""A string that represents the type of input that the schema will take and the UI element that appears to the user on the frontend."""  
...
class SchemaResponseBlocksReadRegistrationSchemaBlock:
    ...
    attributes: Optional[SchemaResponseBlocksReadRegistrationSchemaBlockAttributes] = dataclasses.field(default=None)
    r"""The attributes of the Registration Schema Block."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The unique identifier of the Registration Schema Block."""  
    links: Optional[SchemaResponseBlocksReadRegistrationSchemaBlockLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the  Registration Schema Block."""  
    relationships: Optional[SchemaResponseBlocksReadRegistrationSchemaBlockRelationships] = dataclasses.field(default=None)
    r"""Links to other entities or entity collections that have a relationship to the Schema Response Action."""  
