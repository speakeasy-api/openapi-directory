...
class CloudchannelAccountsCustomersListPurchasableOffersRequest
{
     ...
     * 
     * @var ?string $changeOfferPurchaseEntitlement
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=changeOfferPurchase.entitlement')]
    public ?string $changeOfferPurchaseEntitlement = null;
	...
	public function __construct()
	{
		...
		$this->alt = null;
		$this->callback = null;
		$this->changeOfferPurchaseEntitlement = null;
		$this->changeOfferPurchaseNewSku = null;
		$this->createEntitlementPurchaseSku = null;
		$this->customer = "";
		$this->fields = null;
		$this->key = null;
