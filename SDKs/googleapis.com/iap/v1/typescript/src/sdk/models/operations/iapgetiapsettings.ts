...
export class IapGetIapSettingsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IapGetIapSettingsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IapGetIapSettingsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
