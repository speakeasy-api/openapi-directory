...
class SearchTypeEsriImageserverQueryParams:
...
@dataclasses.dataclass
class SearchTypeEsriImageserverRequest:
    query_params: SearchTypeEsriImageserverQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeEsriImageserverResponse:
