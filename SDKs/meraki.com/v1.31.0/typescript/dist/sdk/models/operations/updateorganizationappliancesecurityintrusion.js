...
exports.UpdateOrganizationApplianceSecurityIntrusionResponse = exports.UpdateOrganizationApplianceSecurityIntrusionRequest = exports.UpdateOrganizationApplianceSecurityIntrusionRequestBody = exports.UpdateOrganizationApplianceSecurityIntrusionRequestBodyAllowedRules = void 0;
...
var UpdateOrganizationApplianceSecurityIntrusionRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: UpdateOrganizationApplianceSecurityIntrusionRequestBodyAllowedRules,
        }),
        (0, class_transformer_1.Expose)({ name: "allowedRules" }),
        (0, class_transformer_1.Type)(function () { return UpdateOrganizationApplianceSecurityIntrusionRequestBodyAllowedRules; }),
...
var UpdateOrganizationApplianceSecurityIntrusionRequest = /** @class */ (function (_super) {
    ...
    ], UpdateOrganizationApplianceSecurityIntrusionRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=organizationId",
        }),
        __metadata("design:type", String)
    ], UpdateOrganizationApplianceSecurityIntrusionRequest.prototype, "organizationId", void 0);
...
var UpdateOrganizationApplianceSecurityIntrusionResponse = /** @class */ (function (_super) {
    ...
    ], UpdateOrganizationApplianceSecurityIntrusionResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
