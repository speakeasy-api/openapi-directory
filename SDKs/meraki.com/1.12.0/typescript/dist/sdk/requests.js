...
var Requests = /** @class */ (function () {
     ...
     * ```
    **/
    Requests.prototype.createNetworkPiiRequest = function (req, config) {
        var _a;
     ...
     * ```
    **/
    Requests.prototype.deleteNetworkPiiRequest = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Requests.prototype.getNetworkPiiRequest = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Requests.prototype.getNetworkPiiRequests = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
