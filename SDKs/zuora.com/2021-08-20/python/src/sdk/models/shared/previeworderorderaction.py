...
class PreviewOrderOrderAction:
    type: PreviewOrderOrderActionTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
    add_product: Optional[shared_previeworderrateplanoverride.PreviewOrderRatePlanOverride] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('addProduct') }})
    ...
    create_subscription: Optional[shared_previewordercreatesubscription.PreviewOrderCreateSubscription] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('createSubscription') }})
    ...
    update_product: Optional[shared_previeworderrateplanupdate.PreviewOrderRatePlanUpdate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('updateProduct') }})
