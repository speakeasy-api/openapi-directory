...
exports.ListSyncSyncListPermissionResponse = exports.ListSyncSyncListPermissionListSyncSyncListPermissionResponse = exports.ListSyncSyncListPermissionListSyncSyncListPermissionResponseMeta = exports.ListSyncSyncListPermissionRequest = exports.ListSyncSyncListPermissionSecurity = exports.ListSyncSyncListPermissionServerList = void 0;
...
var ListSyncSyncListPermissionSecurity = /** @class */ (function (_super) {
    ...
    ], ListSyncSyncListPermissionSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSyncSyncListPermissionSecurity.prototype, "username", void 0);
...
var ListSyncSyncListPermissionRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListSyncSyncListPermissionRequest.prototype, "listSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListSyncSyncListPermissionRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSyncSyncListPermissionRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSyncSyncListPermissionRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListSyncSyncListPermissionRequest.prototype, "serviceSid", void 0);
...
var ListSyncSyncListPermissionListSyncSyncListPermissionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListSyncSyncListPermissionListSyncSyncListPermissionResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.PreviewSyncServiceSyncListSyncListPermission,
        }),
        (0, class_transformer_1.Expose)({ name: "permissions" }),
        (0, class_transformer_1.Type)(function () { return shared.PreviewSyncServiceSyncListSyncListPermission; }),
...
var ListSyncSyncListPermissionResponse = /** @class */ (function (_super) {
    ...
    ], ListSyncSyncListPermissionResponse.prototype, "rawResponse", void 0);
