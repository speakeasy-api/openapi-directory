...
func (e *SchedulePickupResponseBodyPartialAddressAddressResidentialIndicatorEnum) UnmarshalJSON(data []byte) error {
	...
	case "yes":
		fallthrough
	case "no":
		*e = SchedulePickupResponseBodyPartialAddressAddressResidentialIndicatorEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for SchedulePickupResponseBodyPartialAddressAddressResidentialIndicatorEnum: %s", s)
	}
}
