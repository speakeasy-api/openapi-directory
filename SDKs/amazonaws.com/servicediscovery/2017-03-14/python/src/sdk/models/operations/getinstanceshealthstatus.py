...
class GetInstancesHealthStatusRequest:
    ...
    get_instances_health_status_request: shared_getinstanceshealthstatusrequest.GetInstancesHealthStatusRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
