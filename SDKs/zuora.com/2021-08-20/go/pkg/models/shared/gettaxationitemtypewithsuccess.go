...
type GETTaxationItemTypewithSuccessFinanceInformation struct {
...
type GETTaxationItemTypewithSuccessTaxRateTypeEnum string

const (
	GETTaxationItemTypewithSuccessTaxRateTypeEnumPercentage GETTaxationItemTypewithSuccessTaxRateTypeEnum = "Percentage"
	GETTaxationItemTypewithSuccessTaxRateTypeEnumFlatFee    GETTaxationItemTypewithSuccessTaxRateTypeEnum = "FlatFee"
)

func (e *GETTaxationItemTypewithSuccessTaxRateTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Percentage":
		fallthrough
	case "FlatFee":
		*e = GETTaxationItemTypewithSuccessTaxRateTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETTaxationItemTypewithSuccessTaxRateTypeEnum: %s", s)
	}
}
...
type GETTaxationItemTypewithSuccess struct {
	...
	//
	FinanceInformation *GETTaxationItemTypewithSuccessFinanceInformation `json:"financeInformation,omitempty"`
	...
	//
	TaxRateType *GETTaxationItemTypewithSuccessTaxRateTypeEnum `json:"taxRateType,omitempty"`
