 ...
 */
export declare class DescribeCapacityReservationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeCapacityReservationsRequest extends SpeakeasyBase {
    capacityReservationIds?: string[];
    dryRun?: boolean;
    filters?: DescribeCapacityReservationsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
}
