...
class ListKeyListKeyResponse:
    ...
    keys: Optional[list[shared_api_v2010_account_key.APIV2010AccountKey]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('keys') }})
...
class ListKeyRequest:
    path_params: ListKeyPathParams = dataclasses.field()
    query_params: ListKeyQueryParams = dataclasses.field()
    security: ListKeySecurity = dataclasses.field()
...
class ListKeyResponse:
    ...
    list_key_response: Optional[ListKeyListKeyResponse] = dataclasses.field(default=None)
