 ...
 */
export enum AddressValidationResultPartialAddressAddressResidentialIndicatorEnum {
  Unknown = "unknown",
  Yes = "yes",
  No = "no",
}
 ...
 */
export class AddressValidationResultPartialAddress extends SpeakeasyBase {
  /**
 ...
 */
export class AddressValidationResult extends SpeakeasyBase {
  /**
   * The matched address found by the Shipengine API
   */
  @SpeakeasyMetadata()
  @Expose({ name: "matched_address" })
  @Type(() => AddressValidationResultPartialAddress)
