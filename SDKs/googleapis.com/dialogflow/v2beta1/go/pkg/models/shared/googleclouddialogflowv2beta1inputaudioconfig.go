...
func (e GoogleCloudDialogflowV2beta1InputAudioConfigAudioEncodingEnum) ToPointer() *GoogleCloudDialogflowV2beta1InputAudioConfigAudioEncodingEnum {
	return &e
}
...
func (e *GoogleCloudDialogflowV2beta1InputAudioConfigAudioEncodingEnum) UnmarshalJSON(data []byte) error {
	...
	case "AUDIO_ENCODING_SPEEX_WITH_HEADER_BYTE":
		*e = GoogleCloudDialogflowV2beta1InputAudioConfigAudioEncodingEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudDialogflowV2beta1InputAudioConfigAudioEncodingEnum: %v", v)
	}
}
...
func (e GoogleCloudDialogflowV2beta1InputAudioConfigModelVariantEnum) ToPointer() *GoogleCloudDialogflowV2beta1InputAudioConfigModelVariantEnum {
	return &e
}
...
func (e *GoogleCloudDialogflowV2beta1InputAudioConfigModelVariantEnum) UnmarshalJSON(data []byte) error {
	...
	case "USE_STANDARD":
		fallthrough
	case "USE_ENHANCED":
		*e = GoogleCloudDialogflowV2beta1InputAudioConfigModelVariantEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudDialogflowV2beta1InputAudioConfigModelVariantEnum: %v", v)
	}
}
