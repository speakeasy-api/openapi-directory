...
export class JobsProjectsCompaniesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class JobsProjectsCompaniesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class JobsProjectsCompaniesListSecurity extends SpeakeasyBase {
...
export class JobsProjectsCompaniesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class JobsProjectsCompaniesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
