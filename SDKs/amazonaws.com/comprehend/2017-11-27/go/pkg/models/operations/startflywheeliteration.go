...
type StartFlywheelIterationHeaders struct {
...
type StartFlywheelIterationRequest struct {
	Headers StartFlywheelIterationHeaders
	Request shared.StartFlywheelIterationRequest `request:"mediaType=application/json"`
}
