...
class Pico 
{
     ...
     * 
     * @return \OpenAPI\OpenAPI\Models\Operations\PicoGetResponse
     */
	public function picoGet(
    ): \OpenAPI\OpenAPI\Models\Operations\PicoGetResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/api/pico');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PicoGetResponse();
