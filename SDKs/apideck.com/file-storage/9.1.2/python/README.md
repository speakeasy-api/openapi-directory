...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apideck.com/file-storage/9.1.2/python
```
...
* `files_update` - Rename or move File
