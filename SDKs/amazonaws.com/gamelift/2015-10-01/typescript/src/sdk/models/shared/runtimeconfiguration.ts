...
export class RuntimeConfiguration extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "GameSessionActivationTimeoutSeconds" })
  gameSessionActivationTimeoutSeconds?: number;

  @SpeakeasyMetadata()
  @Expose({ name: "MaxConcurrentGameSessionActivations" })
  maxConcurrentGameSessionActivations?: number;

  @SpeakeasyMetadata({ elemType: ServerProcess })
  @Expose({ name: "ServerProcesses" })
  @Type(() => ServerProcess)
