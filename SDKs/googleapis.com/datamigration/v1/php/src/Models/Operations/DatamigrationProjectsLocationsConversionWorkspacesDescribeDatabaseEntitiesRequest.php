...
class DatamigrationProjectsLocationsConversionWorkspacesDescribeDatabaseEntitiesRequest
{
     ...
     * The tree to fetch.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DatamigrationProjectsLocationsConversionWorkspacesDescribeDatabaseEntitiesTreeEnum $tree
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=tree')]
    public ?DatamigrationProjectsLocationsConversionWorkspacesDescribeDatabaseEntitiesTreeEnum $tree = null;
