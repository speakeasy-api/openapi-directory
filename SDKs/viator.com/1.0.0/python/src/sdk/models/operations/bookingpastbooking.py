...
class BookingPastbooking200ApplicationJSONDataItemSummariesMerchantTermsAndConditions:
    ...
    cancellation_from_tour_date: Optional[list[BookingPastbooking200ApplicationJSONDataItemSummariesMerchantTermsAndConditionsCancellationFromTourDate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cancellationFromTourDate') }})
...
class BookingPastbooking200ApplicationJSONDataItemSummaries:
    ...
    merchant_terms_and_conditions: Optional[BookingPastbooking200ApplicationJSONDataItemSummariesMerchantTermsAndConditions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('merchantTermsAndConditions') }})
    ...
    traveller_age_bands: Optional[list[BookingPastbooking200ApplicationJSONDataItemSummariesTravellerAgeBands]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('travellerAgeBands') }})
...
class BookingPastbooking200ApplicationJSONData:
    ...
    **object** containing pricing matrix information
    ...
    item_summaries: Optional[list[BookingPastbooking200ApplicationJSONDataItemSummaries]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itemSummaries') }})
    itinerary_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itineraryId') }})
    rules_applied: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('rulesApplied') }})
    sort_order: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sortOrder') }})
...
class BookingPastbooking200ApplicationJSON:
    data: Optional[BookingPastbooking200ApplicationJSONData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class BookingPastbookingRequest:
    headers: BookingPastbookingHeaders = dataclasses.field()
    query_params: BookingPastbookingQueryParams = dataclasses.field()
