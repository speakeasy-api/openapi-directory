...
class UpdateDeletionProtectionRequest:
    headers: UpdateDeletionProtectionHeaders = dataclasses.field()
    request: UpdateDeletionProtectionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateDeletionProtectionResponse:
    ...
    update_deletion_protection_output: Optional[dict[str, Any]] = dataclasses.field(default=None)
