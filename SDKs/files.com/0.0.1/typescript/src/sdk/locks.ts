  ...
  **/
  deleteLocksPath(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.DeleteLocksPathResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  lockListForPath(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.LockListForPathResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  postLocksPath(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostLocksPathResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
