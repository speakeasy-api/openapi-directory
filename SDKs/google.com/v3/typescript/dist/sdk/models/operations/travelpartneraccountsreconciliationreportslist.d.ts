...
export declare class TravelpartnerAccountsReconciliationReportsListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class TravelpartnerAccountsReconciliationReportsListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
