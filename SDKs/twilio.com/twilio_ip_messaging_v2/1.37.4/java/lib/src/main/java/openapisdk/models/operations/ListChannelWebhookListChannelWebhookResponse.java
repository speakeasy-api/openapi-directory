...
public class ListChannelWebhookListChannelWebhookResponse {
    ...
    public openapisdk.models.shared.IpMessagingV2ServiceChannelChannelWebhook[] webhooks;
    public ListChannelWebhookListChannelWebhookResponse withWebhooks(openapisdk.models.shared.IpMessagingV2ServiceChannelChannelWebhook[] webhooks) {
