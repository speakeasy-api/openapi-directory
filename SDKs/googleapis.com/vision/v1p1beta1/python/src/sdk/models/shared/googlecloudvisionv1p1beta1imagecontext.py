...
class GoogleCloudVisionV1p1beta1ImageContext:
    ...
    crop_hints_params: Optional[shared_googlecloudvisionv1p1beta1crophintsparams.GoogleCloudVisionV1p1beta1CropHintsParams] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cropHintsParams'), 'exclude': lambda f: f is None }})
    ...
    lat_long_rect: Optional[shared_googlecloudvisionv1p1beta1latlongrect.GoogleCloudVisionV1p1beta1LatLongRect] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('latLongRect'), 'exclude': lambda f: f is None }})
    r"""Rectangle determined by min and max `LatLng` pairs."""  
    product_search_params: Optional[shared_googlecloudvisionv1p1beta1productsearchparams.GoogleCloudVisionV1p1beta1ProductSearchParams] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('productSearchParams'), 'exclude': lambda f: f is None }})
    r"""Parameters for a product search request."""  
    text_detection_params: Optional[shared_googlecloudvisionv1p1beta1textdetectionparams.GoogleCloudVisionV1p1beta1TextDetectionParams] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('textDetectionParams'), 'exclude': lambda f: f is None }})
    r"""Parameters for text detections. This is used to control TEXT_DETECTION and DOCUMENT_TEXT_DETECTION features."""  
    web_detection_params: Optional[shared_googlecloudvisionv1p1beta1webdetectionparams.GoogleCloudVisionV1p1beta1WebDetectionParams] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('webDetectionParams'), 'exclude': lambda f: f is None }})
