...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksCreateSuiteRequest req = new ChecksCreateSuiteRequest(                new ChecksCreateSuiteRequestBody("fugit");, "accusamus", "inventore");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksGetRequest req = new ChecksGetRequest(250622L, "et", "dolorum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksGetSuiteRequest req = new ChecksGetSuiteRequest(672048L, "placeat", "velit");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListAnnotationsRequest req = new ChecksListAnnotationsRequest(432148L, "autem", "nobis") {{
                page = 557369L;
                perPage = 829603L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListForRefRequest req = new ChecksListForRefRequest("nulla", "voluptas", "libero") {{
                appId = 96549L;
                checkName = "tempora";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListForSuiteRequest req = new ChecksListForSuiteRequest(476477L, "magnam", "odio") {{
                checkName = "eius";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListSuitesForRefRequest req = new ChecksListSuitesForRefRequest("reprehenderit", "quidem", "fugiat") {{
                appId = 283519L;
                checkName = "eum";
                page = 379927L;
                perPage = 826871L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksRerequestRunRequest req = new ChecksRerequestRunRequest(181151L, "praesentium", "quisquam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksRerequestSuiteRequest req = new ChecksRerequestSuiteRequest(86377L, "ipsa", "id");            
        ...
        try {
            ...
            ChecksSetSuitesPreferencesRequest req = new ChecksSetSuitesPreferencesRequest(                new ChecksSetSuitesPreferencesRequestBody() {{
                                autoTriggerChecks = new org.openapis.openapi.models.operations.ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks[]{{
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(778696L, false) {{
                                        appId = 206594L;
                                        setting = false;
                                    }}),
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(777408L, false) {{
                                        appId = 847276L;
                                        setting = false;
                                    }}),
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(259422L, false) {{
                                        appId = 681359L;
                                        setting = false;
                                    }}),
                                }};
