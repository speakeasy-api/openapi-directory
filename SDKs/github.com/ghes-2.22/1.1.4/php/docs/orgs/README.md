...
try {
    ...
    $request->org = 'illum';
    $request->username = 'Americo_Weber';
...
try {
    ...
    $request->requestBody->config->insecureSsl = 8620.63;
    ...
    $request->requestBody->name = 'Dora Mosciski';
...
try {
    ...
    $request->username = 'Andre.Goldner';
...
try {
    ...
    $request->perPage = 457059;
    $request->since = 508390;
...
try {
    ...
    $request->username = 'Jayson.Goldner';
...
try {
    ...
    $request->filter = OrgsListOutsideCollaboratorsFilterEnum::TWOFA_DISABLED;
    $request->org = 'officia';
    $request->page = 381397;
    $request->perPage = 399161;
...
try {
    ...
    $request->username = 'Madalyn.Osinski53';
...
try {
    ...
    $request->org = 'enim';
    $request->username = 'Bernie_Skiles';
...
try {
    ...
    $request->org = 'ex';
    $request->username = 'Earl.Hammes56';
...
try {
    ...
    $request->username = 'Beatrice_Parker2';
...
try {
    ...
    $request->requestBody->billingEmail = 'alias';
    $request->requestBody->blog = '"http://github.blog"';
    $request->requestBody->company = 'Wehner - Jakubowski';
    ...
    $request->requestBody->name = 'Myron Spinka';
    $request->requestBody->twitterUsername = 'culpa';
    $request->org = 'dolor';
