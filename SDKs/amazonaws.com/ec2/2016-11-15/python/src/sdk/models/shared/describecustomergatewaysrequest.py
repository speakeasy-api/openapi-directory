...
class DescribeCustomerGatewaysRequestFilters:
...
class DescribeCustomerGatewaysRequest:
    r"""Contains the parameters for DescribeCustomerGateways."""
    
    customer_gateway_ids: Optional[list[str]] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeCustomerGatewaysRequestFilters]] = dataclasses.field(default=None)  
