 ...
 */
public class MeetingCreate201ApplicationXMLRecurrence {
    /**
    ...
    public MeetingCreate201ApplicationXMLRecurrence withEndDateTime(OffsetDateTime endDateTime) {
    ...
    public MeetingCreate201ApplicationXMLRecurrence withEndTimes(Long endTimes) {
    ...
    public MeetingCreate201ApplicationXMLRecurrence withMonthlyDay(Long monthlyDay) {
    ...
    public MeetingCreate201ApplicationXMLRecurrenceMonthlyWeekEnum monthlyWeek;
    public MeetingCreate201ApplicationXMLRecurrence withMonthlyWeek(MeetingCreate201ApplicationXMLRecurrenceMonthlyWeekEnum monthlyWeek) {
    ...
    public MeetingCreate201ApplicationXMLRecurrenceMonthlyWeekDayEnum monthlyWeekDay;
    public MeetingCreate201ApplicationXMLRecurrence withMonthlyWeekDay(MeetingCreate201ApplicationXMLRecurrenceMonthlyWeekDayEnum monthlyWeekDay) {
    ...
    public MeetingCreate201ApplicationXMLRecurrence withRepeatInterval(Long repeatInterval) {
    ...
    public MeetingCreate201ApplicationXMLRecurrence withType(MeetingCreate201ApplicationXMLRecurrenceTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public MeetingCreate201ApplicationXMLRecurrenceWeeklyDaysEnum weeklyDays;
    public MeetingCreate201ApplicationXMLRecurrence withWeeklyDays(MeetingCreate201ApplicationXMLRecurrenceWeeklyDaysEnum weeklyDays) {
