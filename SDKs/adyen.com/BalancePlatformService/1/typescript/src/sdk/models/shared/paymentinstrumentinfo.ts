 ...
 *
 */
export enum PaymentInstrumentInfoStatusEnum {
  Active = "Active",
  Closed = "Closed",
  Inactive = "Inactive",
  Lost = "Lost",
 ...
 */
export enum PaymentInstrumentInfoTypeEnum {
  BankAccount = "bankAccount",
  Card = "card",
}

export class PaymentInstrumentInfo extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "issuingCountryCode" })
