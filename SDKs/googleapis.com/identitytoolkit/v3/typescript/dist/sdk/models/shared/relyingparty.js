...
var Relyingparty = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "androidInstallApp" }),
        __metadata("design:type", Boolean)
    ], Relyingparty.prototype, "androidInstallApp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "androidMinimumVersion" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "canHandleCodeInApp" }),
        __metadata("design:type", Boolean)
    ], Relyingparty.prototype, "canHandleCodeInApp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "captchaResp" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "continueUrl" }),
        __metadata("design:type", String)
