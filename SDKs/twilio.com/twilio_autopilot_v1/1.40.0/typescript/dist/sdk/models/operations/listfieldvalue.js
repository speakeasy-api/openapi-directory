...
exports.ListFieldValueResponse = exports.ListFieldValueListFieldValueResponse = exports.ListFieldValueListFieldValueResponseMeta = exports.ListFieldValueRequest = exports.ListFieldValueSecurity = exports.ListFieldValueServerList = void 0;
...
var ListFieldValueSecurity = /** @class */ (function (_super) {
    ...
    ], ListFieldValueSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListFieldValueSecurity.prototype, "username", void 0);
...
var ListFieldValueRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListFieldValueRequest.prototype, "assistantSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=FieldTypeSid",
        }),
        __metadata("design:type", String)
    ], ListFieldValueRequest.prototype, "fieldTypeSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Language",
        }),
        __metadata("design:type", String)
    ], ListFieldValueRequest.prototype, "language", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListFieldValueRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListFieldValueRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListFieldValueRequest.prototype, "pageToken", void 0);
...
var ListFieldValueListFieldValueResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "field_values" }),
        (0, class_transformer_1.Type)(function () { return shared.AutopilotV1AssistantFieldTypeFieldValue; }),
        __metadata("design:type", Array)
    ], ListFieldValueListFieldValueResponse.prototype, "fieldValues", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListFieldValueListFieldValueResponseMeta; }),
...
var ListFieldValueResponse = /** @class */ (function (_super) {
    ...
    ], ListFieldValueResponse.prototype, "rawResponse", void 0);
