...
class FourDoauthorizationRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\FourDoauthorizationRequest $fourDoauthorizationRequest;
	...
	{
		$this->fourDoauthorizationRequest = new \OpenAPI\OpenAPI\Models\Shared\FourDoauthorizationRequest();
		$this->accept = "";
		$this->contentType = "";
