...
exports.GetCheckoutCustomFieldsJsonResponse = exports.GetCheckoutCustomFieldsJsonRequest = void 0;
...
var GetCheckoutCustomFieldsJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetCheckoutCustomFieldsJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetCheckoutCustomFieldsJsonRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetCheckoutCustomFieldsJsonRequest.prototype, "login", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetCheckoutCustomFieldsJsonRequest.prototype, "page", void 0);
    return GetCheckoutCustomFieldsJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetCheckoutCustomFieldsJsonRequest = GetCheckoutCustomFieldsJsonRequest;
var GetCheckoutCustomFieldsJsonResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.CheckoutCustomField }),
    ...
    ], GetCheckoutCustomFieldsJsonResponse.prototype, "rawResponse", void 0);
    return GetCheckoutCustomFieldsJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetCheckoutCustomFieldsJsonResponse = GetCheckoutCustomFieldsJsonResponse;
