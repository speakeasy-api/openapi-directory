...
export class MybusinessAccountsLocationsFetchVerificationOptionsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinessAccountsLocationsFetchVerificationOptionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
