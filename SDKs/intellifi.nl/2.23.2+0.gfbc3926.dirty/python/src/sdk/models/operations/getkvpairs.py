...
class GetKvPairsRequest:
    ...
    kv_key: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'kv_key', 'style': 'form', 'explode': True }})
    r"""Filter on the key-value pair key value."""  
...
class GetKvPairs200ApplicationJSON:
    r"""A JSON object containing a list of key-value pairs"""
    ...
    results: Optional[list[shared_keyvaluepair.KeyValuePair]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
...
class GetKvPairsResponse:
    ...
    get_kv_pairs_200_application_json_object: Optional[GetKvPairs200ApplicationJSON] = dataclasses.field(default=None)
    r"""A JSON object containing a list of key-value pairs"""  
