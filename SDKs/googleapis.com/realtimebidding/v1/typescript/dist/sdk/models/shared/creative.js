...
exports.Creative = exports.CreativeInput = exports.CreativeCreativeFormatEnum = exports.CreativeRestrictedCategoriesEnum = exports.CreativeDeclaredRestrictedCategoriesEnum = exports.CreativeDeclaredAttributesEnum = void 0;
...
var CreativeInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=creativeServingDecision" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=declaredAttributes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=declaredRestrictedCategories" }),
        __metadata("design:type", Array)
    ], CreativeInput.prototype, "declaredRestrictedCategories", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=declaredVendorIds" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=renderUrl" }),
        __metadata("design:type", String)
