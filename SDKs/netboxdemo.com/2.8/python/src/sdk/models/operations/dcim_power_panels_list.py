...
class DcimPowerPanelsListQueryParams:
    ...
    rack_group_id_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'rack_group_id__n', 'style': 'form', 'explode': True }})
...
@dataclass_json
@dataclasses.dataclass
class DcimPowerPanelsList200ApplicationJSON:
    count: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('count') }})
    results: list[shared_powerpanel.PowerPanel] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    next: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('next') }})
    previous: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('previous') }})
    

@dataclasses.dataclass
class DcimPowerPanelsListRequest:
    query_params: DcimPowerPanelsListQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class DcimPowerPanelsListResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    dcim_power_panels_list_200_application_json_object: Optional[DcimPowerPanelsList200ApplicationJSON] = dataclasses.field(default=None)
