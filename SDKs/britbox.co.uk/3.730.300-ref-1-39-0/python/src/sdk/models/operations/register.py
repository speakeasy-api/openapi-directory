...
from ..shared import registrationrequest as shared_registrationrequest
...
class RegisterRequest:
    ...
    registration_request: shared_registrationrequest.RegistrationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
