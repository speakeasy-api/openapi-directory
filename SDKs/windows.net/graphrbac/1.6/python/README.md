...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/windows.net/graphrbac/1.6/python
```
...
### application_password_credentials
...
### service_principal_app_role_assigned_to
...
### service_principal_password_credentials
