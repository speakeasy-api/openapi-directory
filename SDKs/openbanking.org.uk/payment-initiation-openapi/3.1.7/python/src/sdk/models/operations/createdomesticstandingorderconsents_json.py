...
from ..shared import obwritedomesticstandingorderconsent5 as shared_obwritedomesticstandingorderconsent5
...
class CreateDomesticStandingOrderConsentsJSONRequest:
    ...
    ob_write_domestic_standing_order_consent5: shared_obwritedomesticstandingorderconsent5.OBWriteDomesticStandingOrderConsent5 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Default"""  
...
@dataclasses.dataclass
class CreateDomesticStandingOrderConsentsJSONResponse:
    ...
    r"""Domestic Standing Order Consents Created"""  
