...
public class PhoneValidateResponse {
    ...
    public PhoneValidateResponse(@JsonProperty("country") String country, @JsonProperty("country-code") String countryCode, @JsonProperty("country-code3") String countryCode3, @JsonProperty("currency-code") String currencyCode, @JsonProperty("international-calling-code") String internationalCallingCode, @JsonProperty("international-number") String internationalNumber, @JsonProperty("is-mobile") Boolean isMobile, @JsonProperty("local-number") String localNumber, @JsonProperty("location") String location, @JsonProperty("prefix-network") String prefixNetwork, @JsonProperty("type") String type, @JsonProperty("valid") Boolean valid) {
        this.country = country;
        this.countryCode = countryCode;
        this.countryCode3 = countryCode3;
        this.currencyCode = currencyCode;
