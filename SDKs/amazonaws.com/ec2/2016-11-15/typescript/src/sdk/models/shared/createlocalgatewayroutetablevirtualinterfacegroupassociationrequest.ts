 ...
 */
export enum CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({
    elemType:
      CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecificationsTags,
  })
  tags?: CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecificationsTags[];
}

export class CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
  ...
  @SpeakeasyMetadata({
    elemType:
      CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecifications,
  })
