...
class General 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Shared\DisablePermitRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\PostDisablePermitSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\PostDisablePermitResponse
     */
	public function postDisablePermit(
        \OpenAPI\OpenAPI\Models\Shared\DisablePermitRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\PostDisablePermitSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\PostDisablePermitResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/disablePermit');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PostDisablePermitResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->disablePermitResult = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DisablePermitResult', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 400 or $httpResponse->getStatusCode() === 401 or $httpResponse->getStatusCode() === 403 or $httpResponse->getStatusCode() === 422 or $httpResponse->getStatusCode() === 500) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
