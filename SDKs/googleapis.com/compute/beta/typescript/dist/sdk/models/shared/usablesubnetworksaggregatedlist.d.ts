 ...
 */
export declare enum UsableSubnetworksAggregatedListWarningCodeEnum {
...
export declare class UsableSubnetworksAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class UsableSubnetworksAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class UsableSubnetworksAggregatedList extends SpeakeasyBase {
    /**
