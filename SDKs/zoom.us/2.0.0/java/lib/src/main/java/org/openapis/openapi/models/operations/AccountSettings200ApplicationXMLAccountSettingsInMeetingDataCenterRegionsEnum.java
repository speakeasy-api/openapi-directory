 ...
 * 
 */
public enum AccountSettings200ApplicationXMLAccountSettingsInMeetingDataCenterRegionsEnum {
    EU("EU"),
    HK("HK"),
    AU("AU"),
    IN("IN"),
    ...
    private AccountSettings200ApplicationXMLAccountSettingsInMeetingDataCenterRegionsEnum(String value) {
        this.value = value;
    }
}
