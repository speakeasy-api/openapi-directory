...
class DataflowProjectsLocationsJobsMessagesListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DataflowProjectsLocationsJobsMessagesListMinimumImportanceEnum $minimumImportance
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=minimumImportance')]
    public ?DataflowProjectsLocationsJobsMessagesListMinimumImportanceEnum $minimumImportance = null;
