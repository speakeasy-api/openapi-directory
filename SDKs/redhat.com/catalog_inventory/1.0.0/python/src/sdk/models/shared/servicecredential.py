...
class ServiceCredential:
    ...
    service_credential_type_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('service_credential_type_id') }})
