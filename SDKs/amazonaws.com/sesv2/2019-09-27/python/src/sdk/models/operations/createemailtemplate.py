...
class CreateEmailTemplateRequestBody:
    ...
    template_content: CreateEmailTemplateRequestBodyTemplateContent = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TemplateContent') }})
    r"""The content of the email, composed of a subject line, an HTML part, and a text-only part."""  
