...
export class TypeTypeDocumentPdf {
  ...
  searchTypeDocumentPdf(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_document_pdf";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeDocumentPdfResponse =
        new operations.SearchTypeDocumentPdfResponse({
