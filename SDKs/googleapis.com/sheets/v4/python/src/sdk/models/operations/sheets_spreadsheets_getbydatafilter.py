...
class SheetsSpreadsheetsGetByDataFilterRequest:
    ...
    get_spreadsheet_by_data_filter_request: Optional[shared_getspreadsheetbydatafilterrequest.GetSpreadsheetByDataFilterRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
