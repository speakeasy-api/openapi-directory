...
export class CreateInternationalPaymentsRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateInternationalPaymentsRawRequest extends SpeakeasyBase {
  /**
...
export class CreateInternationalPaymentsRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
