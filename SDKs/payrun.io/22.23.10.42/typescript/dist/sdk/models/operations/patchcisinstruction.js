...
exports.PatchCisInstructionResponse = exports.PatchCisInstructionRequest = void 0;
...
var PatchCisInstructionRequest = /** @class */ (function (_super) {
    ...
    ], PatchCisInstructionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], PatchCisInstructionRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=CisInstructionId",
        }),
        __metadata("design:type", String)
    ], PatchCisInstructionRequest.prototype, "cisInstructionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], PatchCisInstructionRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], PatchCisInstructionRequest.prototype, "subContractorId", void 0);
...
var PatchCisInstructionResponse = /** @class */ (function (_super) {
    ...
    ], PatchCisInstructionResponse.prototype, "rawResponse", void 0);
