...
class ListPhoneNumberRequest:
    ...
    r"""The SID of the Trunk from which to read the PhoneNumber resources."""  
...
class ListPhoneNumberListPhoneNumberResponse:
    ...
    phone_numbers: Optional[list[shared_trunking_v1_trunk_phone_number.TrunkingV1TrunkPhoneNumber]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('phone_numbers'), 'exclude': lambda f: f is None }})  
