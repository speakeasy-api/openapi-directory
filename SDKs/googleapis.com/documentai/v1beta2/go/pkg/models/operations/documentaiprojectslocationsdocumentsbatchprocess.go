...
type DocumentaiProjectsLocationsDocumentsBatchProcessRequest struct {
	...
	GoogleCloudDocumentaiV1beta2BatchProcessDocumentsRequest *shared.GoogleCloudDocumentaiV1beta2BatchProcessDocumentsRequest `request:"mediaType=application/json"`
	// OAuth access token.
