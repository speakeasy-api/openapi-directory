...
class GetEBSVolumeRecommendationsRequest:
    ...
    get_ebs_volume_recommendations_request: shared_getebsvolumerecommendationsrequest.GetEBSVolumeRecommendationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
