...
export class RetailProjectsLocationsCatalogsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
