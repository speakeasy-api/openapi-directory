...
export declare class RegionDisks {
     ...
     */
    computeRegionDisksBulkInsert(req: operations.ComputeRegionDisksBulkInsertRequest, security: operations.ComputeRegionDisksBulkInsertSecurity, config?: AxiosRequestConfig): Promise<operations.ComputeRegionDisksBulkInsertResponse>;
    /**
     ...
     */
    computeRegionDisksStartAsyncReplication(req: operations.ComputeRegionDisksStartAsyncReplicationRequest, security: operations.ComputeRegionDisksStartAsyncReplicationSecurity, config?: AxiosRequestConfig): Promise<operations.ComputeRegionDisksStartAsyncReplicationResponse>;
    /**
     * Stops asynchronous replication. Can be invoked either on the primary or on the secondary disk.
     */
    computeRegionDisksStopAsyncReplication(req: operations.ComputeRegionDisksStopAsyncReplicationRequest, security: operations.ComputeRegionDisksStopAsyncReplicationSecurity, config?: AxiosRequestConfig): Promise<operations.ComputeRegionDisksStopAsyncReplicationResponse>;
    /**
     * Stops asynchronous replication for a consistency group of disks. Can be invoked either in the primary or secondary scope.
     */
    computeRegionDisksStopGroupAsyncReplication(req: operations.ComputeRegionDisksStopGroupAsyncReplicationRequest, security: operations.ComputeRegionDisksStopGroupAsyncReplicationSecurity, config?: AxiosRequestConfig): Promise<operations.ComputeRegionDisksStopGroupAsyncReplicationResponse>;
    /**
