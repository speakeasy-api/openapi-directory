...
class ListExportCustomJobListExportCustomJobResponse:
    ...
    jobs: Optional[list[shared_bulkexports_v1_export_export_custom_job.BulkexportsV1ExportExportCustomJob]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('jobs'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListExportCustomJobListExportCustomJobResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
