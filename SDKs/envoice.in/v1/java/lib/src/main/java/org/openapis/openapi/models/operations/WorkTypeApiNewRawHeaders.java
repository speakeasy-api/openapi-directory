...
public class WorkTypeApiNewRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public WorkTypeApiNewRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public WorkTypeApiNewRawHeaders withXAuthSecret(String xAuthSecret) {
