...
exports.GetProductsCategoryCategoryIdJsonResponse = exports.GetProductsCategoryCategoryIdJsonRequest = void 0;
...
var GetProductsCategoryCategoryIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetProductsCategoryCategoryIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=category_id",
        }),
        __metadata("design:type", Number)
    ], GetProductsCategoryCategoryIdJsonRequest.prototype, "categoryId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locale",
        }),
        __metadata("design:type", String)
    ], GetProductsCategoryCategoryIdJsonRequest.prototype, "locale", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetProductsCategoryCategoryIdJsonRequest.prototype, "login", void 0);
    return GetProductsCategoryCategoryIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetProductsCategoryCategoryIdJsonRequest = GetProductsCategoryCategoryIdJsonRequest;
var GetProductsCategoryCategoryIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], GetProductsCategoryCategoryIdJsonResponse.prototype, "rawResponse", void 0);
    return GetProductsCategoryCategoryIdJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetProductsCategoryCategoryIdJsonResponse = GetProductsCategoryCategoryIdJsonResponse;
