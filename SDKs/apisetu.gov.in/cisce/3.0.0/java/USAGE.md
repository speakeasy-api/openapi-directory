    ...
    public static void main(String[] args) {
        try {
            ...
            HpcerRequestBody req = new HpcerRequestBody(HpcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HpcerRequestBodyCertificateParameters("6374638", "31-12-1980", "Sunil Kumar", "1234567/001", "123412341234", "2016");;
            ...
            HpcerResponse res = sdk.apIs.hpcer(req, new HpcerSecurity("molestiae", "minus") {{
