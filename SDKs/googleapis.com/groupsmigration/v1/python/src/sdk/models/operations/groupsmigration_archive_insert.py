...
@dataclasses.dataclass
class GroupsmigrationArchiveInsertQueryParams:
...
class GroupsmigrationArchiveInsertRequest:
    path_params: GroupsmigrationArchiveInsertPathParams = dataclasses.field()
    query_params: GroupsmigrationArchiveInsertQueryParams = dataclasses.field()
    security: GroupsmigrationArchiveInsertSecurity = dataclasses.field()
