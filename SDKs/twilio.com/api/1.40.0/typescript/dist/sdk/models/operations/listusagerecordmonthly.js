...
exports.ListUsageRecordMonthlyResponse = exports.ListUsageRecordMonthlyListUsageRecordMonthlyResponse = exports.ListUsageRecordMonthlyRequest = exports.ListUsageRecordMonthlySecurity = exports.ListUsageRecordMonthlyServerList = void 0;
...
var ListUsageRecordMonthlySecurity = /** @class */ (function (_super) {
    ...
    ], ListUsageRecordMonthlySecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordMonthlySecurity.prototype, "username", void 0);
...
var ListUsageRecordMonthlyRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListUsageRecordMonthlyRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Category",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordMonthlyRequest.prototype, "category", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EndDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListUsageRecordMonthlyRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=IncludeSubaccounts",
        }),
        __metadata("design:type", Boolean)
    ], ListUsageRecordMonthlyRequest.prototype, "includeSubaccounts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListUsageRecordMonthlyRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListUsageRecordMonthlyRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordMonthlyRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListUsageRecordMonthlyRequest.prototype, "startDate", void 0);
...
var ListUsageRecordMonthlyListUsageRecordMonthlyResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.ApiV2010AccountUsageUsageRecordUsageRecordMonthly,
        }),
        (0, class_transformer_1.Expose)({ name: "usage_records" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountUsageUsageRecordUsageRecordMonthly; }),
...
var ListUsageRecordMonthlyResponse = /** @class */ (function (_super) {
    ...
    ], ListUsageRecordMonthlyResponse.prototype, "rawResponse", void 0);
