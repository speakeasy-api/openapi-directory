...
var Parties = /** @class */ (function () {
    function Parties(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Parties.prototype.getAccountsAccountIdParties = function (req, config) {
    ...
    **/
    Parties.prototype.getAccountsAccountIdParty = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Get Party
    **/
    Parties.prototype.getParty = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
