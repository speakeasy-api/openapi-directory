...
class GetWorkspacesWorkspaceProjectsProjectKeyDeployKeysKeyIDSecurity:
...
class GetWorkspacesWorkspaceProjectsProjectKeyDeployKeysKeyIDRequest:
    ...
    r"""The key ID matching the project deploy key."""  
...
@dataclasses.dataclass
class GetWorkspacesWorkspaceProjectsProjectKeyDeployKeysKeyIDResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    error: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""If the specified workspace or project is not accessible to the current user"""  
    project_deploy_key: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Project deploy key matching the key ID"""  
