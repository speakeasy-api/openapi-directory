...
@dataclasses.dataclass
class CollectionsListCollectionRelationships:
...
class CollectionsListCollection:
    ...
    attributes: Optional[CollectionsListCollectionAttributes] = dataclasses.field(default=None)
    r"""The properties of the collection."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The unique identifier of the collection."""  
    links: Optional[CollectionsListCollectionLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the entity."""  
    relationships: Optional[CollectionsListCollectionRelationships] = dataclasses.field(default=None)
    r"""URLs to other entities or entity collections that have a relationship to the node entity."""  
