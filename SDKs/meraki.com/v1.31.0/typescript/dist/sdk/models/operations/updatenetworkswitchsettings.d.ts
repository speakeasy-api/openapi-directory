 ...
 * Per switch exception (combined, redundant, useNetworkSetting)
 */
export declare enum UpdateNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum {
    Combined = "combined",
    Redundant = "redundant",
    UseNetworkSetting = "useNetworkSetting"
}
export declare class UpdateNetworkSwitchSettings200ApplicationJSONPowerExceptions extends SpeakeasyBase {
    /**
     * Per switch exception (combined, redundant, useNetworkSetting)
     */
 ...
 */
export declare class UpdateNetworkSwitchSettings200ApplicationJSON extends SpeakeasyBase {
    /**
     * Exceptions on a per switch basis to "useCombinedPower"
     */
