...
class PostGetAttributesQueryParams:
    ...
    action: PostGetAttributesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: PostGetAttributesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class PostGetAttributesRequest:
    query_params: PostGetAttributesQueryParams = dataclasses.field()
