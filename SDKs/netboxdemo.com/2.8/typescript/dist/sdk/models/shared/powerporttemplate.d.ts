...
export declare enum PowerPortTemplateTypeLabelEnum {
    C6 = "C6",
    C8 = "C8",
    C14 = "C14",
    C16 = "C16",
...
export declare class PowerPortTemplateType extends SpeakeasyBase {
    label: PowerPortTemplateTypeLabelEnum;
