...
export class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsCreateTargetingTypeEnum {
...
export class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsCreateResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
