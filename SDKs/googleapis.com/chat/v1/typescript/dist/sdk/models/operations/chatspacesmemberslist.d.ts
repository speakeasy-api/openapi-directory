...
export declare class ChatSpacesMembersListSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ChatSpacesMembersListSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ChatSpacesMembersListSecurityOption3 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
