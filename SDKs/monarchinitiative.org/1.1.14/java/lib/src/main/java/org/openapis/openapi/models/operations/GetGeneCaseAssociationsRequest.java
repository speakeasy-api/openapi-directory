...
public class GetGeneCaseAssociationsRequest {
    ...
    public GetGeneCaseAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGeneCaseAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGeneCaseAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGeneCaseAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGeneCaseAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGeneCaseAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGeneCaseAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGeneCaseAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGeneCaseAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGeneCaseAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGeneCaseAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGeneCaseAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGeneCaseAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
