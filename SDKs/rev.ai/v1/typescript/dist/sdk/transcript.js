...
var Transcript = /** @class */ (function () {
    ...
    Transcript.prototype.getTranscriptById = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/jobs/{id}/transcript", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetTranscriptByIdResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/vnd.rev.transcript.v1.0+json")) {
                        res.transcript = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.Transcript);
                    }
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    if (utils.matchContentType(contentType, "application/problem+json")) {
                        res.getTranscriptById401ApplicationProblemPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetTranscriptById401ApplicationProblemPlusJson);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 404:
                    if (utils.matchContentType(contentType, "application/problem+json")) {
                        res.getTranscriptById404ApplicationProblemPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetTranscriptById404ApplicationProblemPlusJson);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 406:
                    if (utils.matchContentType(contentType, "application/problem+json")) {
                        res.getTranscriptById406ApplicationProblemPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetTranscriptById406ApplicationProblemPlusJson);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 409:
                    if (utils.matchContentType(contentType, "application/problem+json")) {
                        res.getTranscriptById409ApplicationProblemPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetTranscriptById409ApplicationProblemPlusJson);
                    }
                    break;
            }
            return res;
