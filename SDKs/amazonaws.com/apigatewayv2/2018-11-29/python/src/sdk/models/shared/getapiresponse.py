...
class GetAPIResponseCorsConfiguration:
    r"""GetAPIResponseCorsConfiguration
...
class GetAPIResponse:
    ...
    cors_configuration: Optional[GetAPIResponseCorsConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CorsConfiguration') }})
