...
public class InvoiceApiChangeStatusRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiChangeStatusRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiChangeStatusRawHeaders withXAuthSecret(String xAuthSecret) {
