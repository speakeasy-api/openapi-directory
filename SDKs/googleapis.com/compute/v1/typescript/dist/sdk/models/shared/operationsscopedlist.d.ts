 ...
 */
export declare enum OperationsScopedListWarningCodeEnum {
...
export declare class OperationsScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class OperationsScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class OperationsScopedList extends SpeakeasyBase {
    /**
