...
export class TypeTypeSoundingCod {
  ...
  searchTypeSoundingCod(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_sounding_cod";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeSoundingCodResponse =
        new operations.SearchTypeSoundingCodResponse({
