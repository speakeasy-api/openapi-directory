...
class GetCustomFieldsForWorkspace200ApplicationJSON:
    r"""Successfully retrieved all custom fields for the given workspace."""
    
    data: Optional[list[shared_customfieldresponse.CustomFieldResponse]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
