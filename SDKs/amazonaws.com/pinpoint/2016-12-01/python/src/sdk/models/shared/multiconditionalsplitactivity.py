...
class MultiConditionalSplitActivity:
    ...
    branches: Optional[list[shared_multiconditionalbranch.MultiConditionalBranch]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Branches') }})
    default_activity: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DefaultActivity') }})
