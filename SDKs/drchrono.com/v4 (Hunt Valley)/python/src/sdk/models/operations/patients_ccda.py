...
class PatientsCcdaPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PatientsCcdaQueryParams:
...
@dataclasses.dataclass
class PatientsCcdaSecurity:
    drchrono_oauth2: shared_security.SchemeDrchronoOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class PatientsCcdaRequest:
    path_params: PatientsCcdaPathParams = dataclasses.field()
    query_params: PatientsCcdaQueryParams = dataclasses.field()
    security: PatientsCcdaSecurity = dataclasses.field()
