...
exports.GetEmployeeSecretResponse = exports.GetEmployeeSecretRequest = void 0;
...
var GetEmployeeSecretRequest = /** @class */ (function (_super) {
    ...
    ], GetEmployeeSecretRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetEmployeeSecretRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], GetEmployeeSecretRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetEmployeeSecretRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SecretId",
        }),
        __metadata("design:type", String)
    ], GetEmployeeSecretRequest.prototype, "secretId", void 0);
...
var GetEmployeeSecretResponse = /** @class */ (function (_super) {
    ...
    ], GetEmployeeSecretResponse.prototype, "rawResponse", void 0);
