...
public class ProvincesQueryParams {
    /**
    ...
    public ProvincesQueryParams withOptional(ProvincesOptionalEnum optional) {
    ...
    public Long year;
    public ProvincesQueryParams withYear(Long year) {
        this.year = year;
        return this;
    }
