...
export class ClouddeployProjectsLocationsTargetsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ClouddeployProjectsLocationsTargetsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ClouddeployProjectsLocationsTargetsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
