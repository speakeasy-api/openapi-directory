...
public class InvokeWithResponseStreamRequestBody {
    /**
    ...
    public InvokeWithResponseStreamRequestBody withPayload(String payload) {
        this.payload = payload;
        return this;
    }
    
    public InvokeWithResponseStreamRequestBody(){}
}
