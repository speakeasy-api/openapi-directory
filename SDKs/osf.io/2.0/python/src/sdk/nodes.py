...
class Nodes:
    ...
    def nodes_draft_registrations_list(self, request: operations.NodesDraftRegistrationsListRequest) -> operations.NodesDraftRegistrationsListResponse:
        r"""List all draft registrations
