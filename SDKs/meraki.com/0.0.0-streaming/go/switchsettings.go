...
func (s *switchSettings) GetNetworkSwitchSettingsDhcpServerPolicy(ctx context.Context, request operations.GetNetworkSwitchSettingsDhcpServerPolicyRequest) (*operations.GetNetworkSwitchSettingsDhcpServerPolicyResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/networks/{networkId}/switch/settings/dhcpServerPolicy", request.PathParams, nil)
	...
	res := &operations.GetNetworkSwitchSettingsDhcpServerPolicyResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetNetworkSwitchSettingsDhcpServerPolicy200ApplicationJSONObject = out
		}
	}
...
func (s *switchSettings) GetNetworkSwitchSettingsDscpToCosMappings(ctx context.Context, request operations.GetNetworkSwitchSettingsDscpToCosMappingsRequest) (*operations.GetNetworkSwitchSettingsDscpToCosMappingsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/networks/{networkId}/switch/settings/dscpToCosMappings", request.PathParams, nil)
	...
	res := &operations.GetNetworkSwitchSettingsDscpToCosMappingsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetNetworkSwitchSettingsDscpToCosMappings200ApplicationJSONObject = out
		}
	}
...
func (s *switchSettings) UpdateNetworkSwitchSettingsDhcpServerPolicy(ctx context.Context, request operations.UpdateNetworkSwitchSettingsDhcpServerPolicyRequest) (*operations.UpdateNetworkSwitchSettingsDhcpServerPolicyResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/networks/{networkId}/switch/settings/dhcpServerPolicy", request.PathParams, nil)
	...
	res := &operations.UpdateNetworkSwitchSettingsDhcpServerPolicyResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.UpdateNetworkSwitchSettingsDhcpServerPolicy200ApplicationJSONObject = out
		}
	}
...
func (s *switchSettings) UpdateNetworkSwitchSettingsDscpToCosMappings(ctx context.Context, request operations.UpdateNetworkSwitchSettingsDscpToCosMappingsRequest) (*operations.UpdateNetworkSwitchSettingsDscpToCosMappingsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/networks/{networkId}/switch/settings/dscpToCosMappings", request.PathParams, nil)
	...
	res := &operations.UpdateNetworkSwitchSettingsDscpToCosMappingsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.UpdateNetworkSwitchSettingsDscpToCosMappings200ApplicationJSONObject = out
		}
	}
