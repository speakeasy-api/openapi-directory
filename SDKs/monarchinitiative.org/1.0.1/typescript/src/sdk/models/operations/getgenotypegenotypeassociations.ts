...
export class GetGenotypeGenotypeAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGenotypeGenotypeAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGenotypeGenotypeAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGenotypeGenotypeAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
