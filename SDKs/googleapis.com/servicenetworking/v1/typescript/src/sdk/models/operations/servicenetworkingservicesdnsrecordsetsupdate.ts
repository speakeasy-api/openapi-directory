...
export class ServicenetworkingServicesDnsRecordSetsUpdateSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ServicenetworkingServicesDnsRecordSetsUpdateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ServicenetworkingServicesDnsRecordSetsUpdateSecurity extends SpeakeasyBase {
...
export class ServicenetworkingServicesDnsRecordSetsUpdateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ServicenetworkingServicesDnsRecordSetsUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
