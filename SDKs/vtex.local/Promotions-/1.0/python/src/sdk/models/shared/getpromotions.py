...
class GetPromotionsScope:
    ...
    r"""Determines if the promotion applies to all products in the Catalog (`true`) or not (`false`)."""  
    ...
    r"""Quantity of brands which activate or deactivate the promotion."""  
    ...
    r"""Quantity of categories which activate or deactivate the promotion."""  
    ...
    r"""Quantity of collections which activate or deactivate the promotion."""  
    ...
    r"""Quantity of products which activate or deactivate the promotion."""  
    ...
    r"""Quantity of sellers which activate or deactivate the promotion."""  
    ...
    r"""If set to `true`, this promotion will be applied to any seller present on the `sellers` field. If set to `false`, sellers present on that field will make this promotion not to be applied."""  
    ...
    r"""Quantity of SKUs which activate or deactivate the promotion."""  
...
@dataclasses.dataclass
class GetPromotions:
    r"""Object with information about a promotion."""
    ...
    r"""Array with campaign audiences that activate this promotion."""  
    ...
    r"""Date and time when the promotion was last modified (UTC)."""  
    ...
    scope: Optional[GetPromotionsScope] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('scope'), 'exclude': lambda f: f is None }})
    r"""Scope of the promotion."""  
    status: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""Status of the promotion."""  
    type: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Defines the type of promotion."""  
