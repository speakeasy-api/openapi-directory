...
public class ContactsUpdateRequest {
    ...
    public ContactsUpdateRequest(@JsonProperty("ContactInput") org.openapis.openapi.models.shared.ContactInput contactInput, @JsonProperty("id") String id, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.contactInput = contactInput;
        this.id = id;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
