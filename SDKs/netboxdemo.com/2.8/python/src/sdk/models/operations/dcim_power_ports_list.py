...
class DcimPowerPortsListQueryParams:
    allocated_draw: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'allocated_draw', 'style': 'form', 'explode': True }})
    allocated_draw_gt: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'allocated_draw__gt', 'style': 'form', 'explode': True }})
    allocated_draw_gte: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'allocated_draw__gte', 'style': 'form', 'explode': True }})
    allocated_draw_lt: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'allocated_draw__lt', 'style': 'form', 'explode': True }})
    allocated_draw_lte: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'allocated_draw__lte', 'style': 'form', 'explode': True }})
    allocated_draw_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'allocated_draw__n', 'style': 'form', 'explode': True }})
    ...
    maximum_draw: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'maximum_draw', 'style': 'form', 'explode': True }})
    maximum_draw_gt: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'maximum_draw__gt', 'style': 'form', 'explode': True }})
    maximum_draw_gte: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'maximum_draw__gte', 'style': 'form', 'explode': True }})
    maximum_draw_lt: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'maximum_draw__lt', 'style': 'form', 'explode': True }})
    maximum_draw_lte: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'maximum_draw__lte', 'style': 'form', 'explode': True }})
    maximum_draw_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'maximum_draw__n', 'style': 'form', 'explode': True }})
...
class DcimPowerPortsListRequest:
    query_params: DcimPowerPortsListQueryParams = dataclasses.field()
...
class DcimPowerPortsListResponse:
    ...
    dcim_power_ports_list_200_application_json_object: Optional[DcimPowerPortsList200ApplicationJSON] = dataclasses.field(default=None)
