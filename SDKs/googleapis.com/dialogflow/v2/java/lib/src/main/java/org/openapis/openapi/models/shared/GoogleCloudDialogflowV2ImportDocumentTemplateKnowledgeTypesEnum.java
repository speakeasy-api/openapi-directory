...
public enum GoogleCloudDialogflowV2ImportDocumentTemplateKnowledgeTypesEnum {
    ...
    private GoogleCloudDialogflowV2ImportDocumentTemplateKnowledgeTypesEnum(String value) {
        this.value = value;
    }
}
