...
public class GetV2SuccessesJsonQueryParams {
    /**
    ...
    public Long[] ids;
    public GetV2SuccessesJsonQueryParams withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2SuccessesJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2SuccessesJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public Long page;
    public GetV2SuccessesJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2SuccessesJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2SuccessesJsonQueryParams withPersonId(Long[] personId) {
    ...
    public GetV2SuccessesJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2SuccessesJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public GetV2SuccessesJsonQueryParams withUpdatedAt(String[] updatedAt) {
