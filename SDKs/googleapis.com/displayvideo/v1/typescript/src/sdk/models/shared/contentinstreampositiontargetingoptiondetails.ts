 ...
 */
export enum ContentInstreamPositionTargetingOptionDetailsContentInstreamPositionEnum {
 ...
 */
export class ContentInstreamPositionTargetingOptionDetails extends SpeakeasyBase {
  /**
   * Output only. The content instream position.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "contentInstreamPosition" })
