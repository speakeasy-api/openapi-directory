 ...
 */
export enum PublicDelegatedPrefixAggregatedListWarningCodeEnum {
...
export class PublicDelegatedPrefixAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class PublicDelegatedPrefixAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
 ...
 * Successful response
 */
export class PublicDelegatedPrefixAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: PublicDelegatedPrefixesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, PublicDelegatedPrefixesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], PublicDelegatedPrefixesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
