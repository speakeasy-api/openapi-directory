...
func (s *Teams) AddUserForTeam(ctx context.Context, request operations.AddUserForTeamRequest) (*operations.AddUserForTeamResponse, error) {
	...
	url := utils.GenerateURL(ctx, baseURL, "/teams/{team_gid}/addUser", request.PathParams)
...
func (s *Teams) GetTeam(ctx context.Context, request operations.GetTeamRequest) (*operations.GetTeamResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/teams/{team_gid}", request.PathParams)
...
func (s *Teams) GetTeamsForOrganization(ctx context.Context, request operations.GetTeamsForOrganizationRequest) (*operations.GetTeamsForOrganizationResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/organizations/{workspace_gid}/teams", request.PathParams)
...
func (s *Teams) GetTeamsForUser(ctx context.Context, request operations.GetTeamsForUserRequest) (*operations.GetTeamsForUserResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/users/{user_gid}/teams", request.PathParams)
...
func (s *Teams) RemoveUserForTeam(ctx context.Context, request operations.RemoveUserForTeamRequest) (*operations.RemoveUserForTeamResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/teams/{team_gid}/removeUser", request.PathParams)
