 ...
 */
export declare class DescribePublicIpv4PoolsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribePublicIpv4PoolsRequest extends SpeakeasyBase {
