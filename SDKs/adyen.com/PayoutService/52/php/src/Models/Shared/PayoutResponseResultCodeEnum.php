 ...
 */
enum PayoutResponseResultCodeEnum: string
{
    case AUTHENTICATION_FINISHED = 'AuthenticationFinished';
    case AUTHENTICATION_NOT_REQUIRED = 'AuthenticationNotRequired';
    case AUTHORISED = 'Authorised';
    case CANCELLED = 'Cancelled';
    case CHALLENGE_SHOPPER = 'ChallengeShopper';
    case ERROR = 'Error';
    case IDENTIFY_SHOPPER = 'IdentifyShopper';
    case PENDING = 'Pending';
    case PRESENT_TO_SHOPPER = 'PresentToShopper';
    case RECEIVED = 'Received';
    case REDIRECT_SHOPPER = 'RedirectShopper';
