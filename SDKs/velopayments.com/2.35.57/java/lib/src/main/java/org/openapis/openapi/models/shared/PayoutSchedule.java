...
public class PayoutSchedule {
    ...
    public PayoutSchedule(@JsonProperty("notificationsEnabled") Boolean notificationsEnabled, @JsonProperty("scheduleStatus") String scheduleStatus, @JsonProperty("scheduledAt") OffsetDateTime scheduledAt, @JsonProperty("scheduledByPrincipalId") String scheduledByPrincipalId, @JsonProperty("scheduledFor") OffsetDateTime scheduledFor) {
        this.notificationsEnabled = notificationsEnabled;
        this.scheduleStatus = scheduleStatus;
        this.scheduledAt = scheduledAt;
        this.scheduledByPrincipalId = scheduledByPrincipalId;
