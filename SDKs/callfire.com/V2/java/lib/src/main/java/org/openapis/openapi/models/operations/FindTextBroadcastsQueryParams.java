...
public class FindTextBroadcastsQueryParams {
    /**
     * Limit fields received in response. E.g. fields: id, name or fields items (id, name), see more at [partial response](https://developers.callfire.com/docs.html#partial-response) page.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=fields")
    public String fields;
    public FindTextBroadcastsQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public FindTextBroadcastsQueryParams withIntervalBegin(Long intervalBegin) {
    ...
    public FindTextBroadcastsQueryParams withIntervalEnd(Long intervalEnd) {
    ...
    public String label;
    public FindTextBroadcastsQueryParams withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public FindTextBroadcastsQueryParams withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public String name;
    public FindTextBroadcastsQueryParams withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public FindTextBroadcastsQueryParams withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public FindTextBroadcastsQueryParams withRunning(Boolean running) {
    ...
    public FindTextBroadcastsQueryParams withScheduled(Boolean scheduled) {
