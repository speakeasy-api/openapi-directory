...
class EndpointInfo:
    ...
    source_agent_uri: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceAgentUri'), 'exclude': lambda f: f is None }})
    r"""URI of the source telemetry agent this packet originates from."""  
