...
class Session:
    ...
    def post_session(self, request: operations.PostSessionRequestBody) -> operations.PostSessionResponse:
        ...
        res = operations.PostSessionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
