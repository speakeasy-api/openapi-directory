...
export declare class GetMerchandisedProductsSecurity extends SpeakeasyBase {
    clientCredentials: string;
}
export declare class GetMerchandisedProductsRequest extends SpeakeasyBase {
    /**
...
export declare class GetMerchandisedProductsResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
