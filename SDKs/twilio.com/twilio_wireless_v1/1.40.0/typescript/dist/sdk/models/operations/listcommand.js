...
exports.ListCommandResponse = exports.ListCommandListCommandResponse = exports.ListCommandListCommandResponseMeta = exports.ListCommandRequest = exports.ListCommandSecurity = exports.ListCommandServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListCommandServerList = ["https://wireless.twilio.com"];
var ListCommandSecurity = /** @class */ (function (_super) {
    ...
    ], ListCommandSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListCommandSecurity.prototype, "username", void 0);
...
var ListCommandRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListCommandRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListCommandRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListCommandRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListCommandRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Sim" }),
        __metadata("design:type", String)
    ], ListCommandRequest.prototype, "sim", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListCommandRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Transport",
        }),
        __metadata("design:type", String)
    ], ListCommandRequest.prototype, "transport", void 0);
...
var ListCommandListCommandResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.WirelessV1Command }),
        (0, class_transformer_1.Expose)({ name: "commands" }),
        (0, class_transformer_1.Type)(function () { return shared.WirelessV1Command; }),
        __metadata("design:type", Array)
    ], ListCommandListCommandResponse.prototype, "commands", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListCommandListCommandResponseMeta; }),
...
var ListCommandResponse = /** @class */ (function (_super) {
    ...
    ], ListCommandResponse.prototype, "rawResponse", void 0);
