 ...
 */
export declare class SearchTransitGatewayMulticastGroupsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class SearchTransitGatewayMulticastGroupsRequest extends SpeakeasyBase {
    dryRun?: boolean;
