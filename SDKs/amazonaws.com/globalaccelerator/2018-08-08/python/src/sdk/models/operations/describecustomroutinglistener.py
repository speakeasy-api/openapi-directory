...
class DescribeCustomRoutingListenerRequest:
    ...
    describe_custom_routing_listener_request: shared_describecustomroutinglistenerrequest.DescribeCustomRoutingListenerRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
