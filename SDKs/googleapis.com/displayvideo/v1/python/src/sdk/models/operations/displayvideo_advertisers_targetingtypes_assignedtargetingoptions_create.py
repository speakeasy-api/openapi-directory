...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreateRequest:
    path_params: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreatePathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreateQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreateSecurity = dataclasses.field()
