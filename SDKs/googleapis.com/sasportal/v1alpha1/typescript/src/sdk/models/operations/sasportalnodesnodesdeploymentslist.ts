...
export class SasportalNodesNodesDeploymentsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SasportalNodesNodesDeploymentsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class SasportalNodesNodesDeploymentsListSecurity extends SpeakeasyBase {
...
export class SasportalNodesNodesDeploymentsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SasportalNodesNodesDeploymentsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
