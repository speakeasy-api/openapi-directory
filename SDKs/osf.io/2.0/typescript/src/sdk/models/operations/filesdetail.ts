 ...
 */
export class FilesDetailFileAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class FilesDetailFileLinks extends SpeakeasyBase {
  /**
 ...
 */
export class FilesDetailFileRelationships extends SpeakeasyBase {
  /**
...
export class FilesDetailFile extends SpeakeasyBase {
  /**
   * The properties of the file entity.
   */
  @SpeakeasyMetadata()
