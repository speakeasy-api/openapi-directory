...
var GetOfferingStatusResult = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: offeringstatus_1.OfferingStatus }),
        (0, class_transformer_1.Expose)({ name: "current" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], offeringstatus_1.OfferingStatus);
            }
            return obj;
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: offeringstatus_1.OfferingStatus }),
        (0, class_transformer_1.Expose)({ name: "nextPeriod" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
