...
class BatchResponseSubscriberVidResponse:
    ...
    results: list[shared_subscribervidresponse.SubscriberVidResponse] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results') }})  
    ...
    status: BatchResponseSubscriberVidResponseStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
