...
class CollectionSearch:
    ...
    order: Optional[CollectionSearchOrderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('order'), 'exclude': lambda f: f is None }})
    r"""The field by which to order."""  
    order_direction: Optional[CollectionSearchOrderDirectionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('order_direction'), 'exclude': lambda f: f is None }})
    r"""Direction of ordering"""  
