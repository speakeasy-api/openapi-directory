...
class ListOriginRequestPolicies20200531QueryParams:
    ...
    type: Optional[ListOriginRequestPolicies20200531TypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'Type', 'style': 'form', 'explode': True }})
...
class ListOriginRequestPolicies20200531Request:
    headers: ListOriginRequestPolicies20200531Headers = dataclasses.field()
    query_params: ListOriginRequestPolicies20200531QueryParams = dataclasses.field()
