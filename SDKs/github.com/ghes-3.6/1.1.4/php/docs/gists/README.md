...
try {
    ...
    $request->files = [
        'molestiae' => new GistsCreateRequestBodyFiles(),
    ];
...
try {
    ...
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-08-21T19:13:25.245Z');
...
try {
    ...
    $request->gistId = 'recusandae';
    $request->page = 607249;
    $request->perPage = 309251;
...
try {
    ...
    $request->page = 477646;
    $request->perPage = 403218;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-05-14T22:22:36.102Z');
...
try {
    ...
    $request->page = 238413;
    $request->perPage = 890653;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-19T04:44:11.304Z');
...
try {
    ...
    $request->requestBody->files = [
        'quis' => new GistsUpdateRequestBody1Files2(),
        'reiciendis' => new GistsUpdateRequestBody1Files2(),
        'aspernatur' => new GistsUpdateRequestBody1Files2(),
    ];
    $request->gistId = 'quasi';
...
try {
    ...
    $request->requestBody->body = 'Body of the attachment';
    $request->commentId = 657020;
    $request->gistId = 'nostrum';
