...
export class AccountHolderDetails extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "bankAggregatorDataReference" })
   ...
   */
  @SpeakeasyMetadata({ elemType: LegalArrangementDetail })
   ...
   */
  @SpeakeasyMetadata({ elemType: PayoutMethod })
   ...
   */
  @SpeakeasyMetadata({ elemType: StoreDetail })
