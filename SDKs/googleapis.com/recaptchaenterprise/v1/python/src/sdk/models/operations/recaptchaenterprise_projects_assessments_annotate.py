...
class RecaptchaenterpriseProjectsAssessmentsAnnotateRequest:
    ...
    r"""Required. The resource name of the Assessment, in the format \\"projects/{project}/assessments/{assessment}\\"."""  
    ...
    google_cloud_recaptchaenterprise_v1_annotate_assessment_request: Optional[shared_googlecloudrecaptchaenterprisev1annotateassessmentrequest.GoogleCloudRecaptchaenterpriseV1AnnotateAssessmentRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
