...
class CreateClusterRequestBodyKubernetesNetworkConfig:
    ...
    service_ipv4_cidr: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('serviceIpv4Cidr') }})
...
class CreateClusterRequestBody:
    ...
    resources_vpc_config: CreateClusterRequestBodyResourcesVpcConfig = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourcesVpcConfig') }})
    ...
    kubernetes_network_config: Optional[CreateClusterRequestBodyKubernetesNetworkConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('kubernetesNetworkConfig') }})
    logging: Optional[CreateClusterRequestBodyLogging] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('logging') }})
...
class CreateClusterRequest:
    ...
    request: CreateClusterRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
