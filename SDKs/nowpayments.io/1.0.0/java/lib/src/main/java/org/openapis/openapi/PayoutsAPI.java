...
public class PayoutsAPI {
    ...
    public org.openapis.openapi.models.operations.VerifyPayoutResponse verifyPayout(org.openapis.openapi.models.operations.VerifyPayoutRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.VerifyPayoutPathParams.class, baseUrl, "/v1/payout/{withdrawals-id}/verify", request.pathParams, null);
