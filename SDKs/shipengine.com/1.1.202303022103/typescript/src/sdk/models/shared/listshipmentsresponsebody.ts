 ...
 */
export enum ListShipmentsResponseBodyPartialShipmentDeliveryConfirmationEnum {
  None = "none",
  Delivery = "delivery",
  Signature = "signature",
 ...
 */
export enum ListShipmentsResponseBodyPartialShipmentInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export enum ListShipmentsResponseBodyPartialShipmentInternationalShipmentOptionsNonDeliveryEnum {
 ...
 */
export enum ListShipmentsResponseBodyPartialShipmentInsuranceProviderEnum {
  None = "none",
 ...
 */
export enum ListShipmentsResponseBodyPartialShipmentOriginTypeEnum {
  Pickup = "pickup",
  DropOff = "drop_off",
}
 ...
 */
export enum ListShipmentsResponseBodyPartialShipmentShipmentStatusEnum {
  Pending = "pending",
...
export class ListShipmentsResponseBodyPartialShipment extends SpeakeasyBase {
  ...
  @Type(() => ListShipmentsResponseBodyPartialShipmentWeight)
...
export class ListShipmentsResponseBody extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "links" })
  @Type(() => ListShipmentsResponseBodyPaginationLink)
   ...
   */
  @SpeakeasyMetadata({ elemType: ListShipmentsResponseBodyPartialShipment })
  @Expose({ name: "shipments" })
  @Type(() => ListShipmentsResponseBodyPartialShipment)
