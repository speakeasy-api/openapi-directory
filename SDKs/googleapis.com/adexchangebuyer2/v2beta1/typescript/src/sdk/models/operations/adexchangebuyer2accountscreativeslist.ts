...
export class Adexchangebuyer2AccountsCreativesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class Adexchangebuyer2AccountsCreativesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class Adexchangebuyer2AccountsCreativesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
