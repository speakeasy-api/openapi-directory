...
public class Library {
     ...
     */
    public org.openapis.openapi.models.operations.GetLibraryResponse getLibrary(org.openapis.openapi.models.operations.GetLibraryRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetLibraryPathParams.class, baseUrl, "/organizations/{organizationUuid}/library", request.pathParams, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetLibraryQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.LibraryResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.LibraryResponse.class);
