...
public class GetGroupSettings200ApplicationJSON1EmailNotification {
    /**
    ...
    public GetGroupSettings200ApplicationJSON1EmailNotification withAlternativeHostReminder(Boolean alternativeHostReminder) {
    ...
    public GetGroupSettings200ApplicationJSON1EmailNotification withCancelMeetingReminder(Boolean cancelMeetingReminder) {
    ...
    public GetGroupSettings200ApplicationJSON1EmailNotification withCloudRecordingAvailableReminder(Boolean cloudRecordingAvailableReminder) {
    ...
    public GetGroupSettings200ApplicationJSON1EmailNotification withJbhReminder(Boolean jbhReminder) {
    ...
    public GetGroupSettings200ApplicationJSON1EmailNotification withScheduleForHostReminder(Boolean scheduleForHostReminder) {
