...
export class TypeTypeImageAirport {
  ...
  searchTypeImageAirport(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_image_airport";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeImageAirportResponse =
        new operations.SearchTypeImageAirportResponse({
