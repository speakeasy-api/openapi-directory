...
var ListTestGridSessionActionsResult = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: testgridsessionaction_1.TestGridSessionAction }),
        (0, class_transformer_1.Expose)({ name: "actions" }),
        (0, class_transformer_1.Type)(function () { return testgridsessionaction_1.TestGridSessionAction; }),
