...
export enum NybAddressCountryEnum {
  England = "England",
  Scotland = "Scotland",
  Wales = "Wales",
...
export enum NybAddressCountryIsoEnum {
  Gbr = "GBR",
  Imn = "IMN",
  Jey = "JEY",
  Ggy = "GGY",
...
export enum NybAddressCountryIso2Enum {
  Gb = "GB",
  Im = "IM",
  Je = "JE",
  Gg = "GG",
...
export enum NybAddressDatasetEnum {
  Nyb = "nyb",
}

export enum NybAddressLanguageEnum {
  En = "en",
}
 ...
 */
export class NybAddress extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "country" })
  country: NybAddressCountryEnum;

  @SpeakeasyMetadata()
  @Expose({ name: "country_iso" })
  countryIso: NybAddressCountryIsoEnum;

  @SpeakeasyMetadata()
  @Expose({ name: "country_iso_2" })
  countryIso2: NybAddressCountryIso2Enum;
  ...
  language: NybAddressLanguageEnum;
