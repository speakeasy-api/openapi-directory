...
exports.FetchWorkspaceStatisticsResponse = exports.FetchWorkspaceStatisticsRequest = exports.FetchWorkspaceStatisticsSecurity = exports.FetchWorkspaceStatisticsServerList = void 0;
...
var FetchWorkspaceStatisticsSecurity = /** @class */ (function (_super) {
    ...
    ], FetchWorkspaceStatisticsSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], FetchWorkspaceStatisticsSecurity.prototype, "username", void 0);
...
var FetchWorkspaceStatisticsRequest = /** @class */ (function (_super) {
    ...
    ], FetchWorkspaceStatisticsRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Minutes",
        }),
        __metadata("design:type", Number)
    ], FetchWorkspaceStatisticsRequest.prototype, "minutes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SplitByWaitTime",
        }),
        __metadata("design:type", String)
    ], FetchWorkspaceStatisticsRequest.prototype, "splitByWaitTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], FetchWorkspaceStatisticsRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskChannel",
        }),
        __metadata("design:type", String)
    ], FetchWorkspaceStatisticsRequest.prototype, "taskChannel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], FetchWorkspaceStatisticsRequest.prototype, "workspaceSid", void 0);
...
var FetchWorkspaceStatisticsResponse = /** @class */ (function (_super) {
    ...
    ], FetchWorkspaceStatisticsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
