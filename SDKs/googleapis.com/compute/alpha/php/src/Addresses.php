...
class Addresses 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeAddressesTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeAddressesTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeAddressesTestIamPermissionsResponse
     */
	public function computeAddressesTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeAddressesTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeAddressesTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeAddressesTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/regions/{region}/addresses/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeAddressesTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeAddressesTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeAddressesTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
