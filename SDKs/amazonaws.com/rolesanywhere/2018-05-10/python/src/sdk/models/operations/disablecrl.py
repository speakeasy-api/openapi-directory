...
class DisableCrlRequest:
    ...
    crl_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'crlId', 'style': 'simple', 'explode': False }})
    r"""The unique identifier of the certificate revocation list (CRL)."""  
