...
class GetBucketMetricDataRequest:
    ...
    get_bucket_metric_data_request: shared_getbucketmetricdatarequest.GetBucketMetricDataRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
