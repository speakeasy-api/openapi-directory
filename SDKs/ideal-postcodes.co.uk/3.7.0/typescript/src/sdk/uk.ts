...
export class Uk {
   ...
   */
  addressCleanse(
    req: operations.AddressCleanseRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.AddressCleanseResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.AddressCleanseRequest(req);
    }

    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/cleanse/addresses";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AddressCleanseResponse =
        new operations.AddressCleanseResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.cleanseResponse = utils.objectToClass(
              httpRes?.data,
              shared.CleanseResponse
            );
          }
          break;
        ...
        case httpRes?.status == 429:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.rateLimitedResponse = utils.objectToClass(
              httpRes?.data,
              shared.RateLimitedResponse
            );
          }
          break;
      }
   ...
   */
  addresses(
    req: operations.AddressesRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.AddressesResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AddressesResponse =
        new operations.AddressesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.addressResponse = utils.objectToClass(
              httpRes?.data,
              shared.AddressResponse
            );
          }
          break;
        case httpRes?.status == 400:
        ...
        case httpRes?.status == 404:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.postcodeNotFoundResponse = utils.objectToClass(
              httpRes?.data,
              shared.PostcodeNotFoundResponse
            );
          }
          break;
      }
   ...
   */
  postcodes(
    req: operations.PostcodesRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostcodesResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostcodesResponse =
        new operations.PostcodesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.postcodeResponse = utils.objectToClass(
              httpRes?.data,
              shared.PostcodeResponse
            );
          }
          break;
        case httpRes?.status == 400:
   ...
   */
  udprn(
    req: operations.UDPRNRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UDPRNResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UDPRNRequest(req);
    }

    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/udprn/{udprn}", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UDPRNResponse = new operations.UDPRNResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.udprnResponse = utils.objectToClass(
              httpRes?.data,
              shared.UDPRNResponse
            );
          }
          break;
        case httpRes?.status == 404:
   ...
   */
  umprn(
    req: operations.UMPRNRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UMPRNResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.UMPRNRequest(req);
    }

    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/umprn/{umprn}", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UMPRNResponse = new operations.UMPRNResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.umprnResponse = utils.objectToClass(
              httpRes?.data,
              shared.UMPRNResponse
            );
          }
          break;
        case httpRes?.status == 404:
