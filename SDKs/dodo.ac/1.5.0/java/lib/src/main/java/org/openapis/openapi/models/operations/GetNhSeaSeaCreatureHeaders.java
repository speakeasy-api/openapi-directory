...
public class GetNhSeaSeaCreatureHeaders {
    /**
    ...
    public GetNhSeaSeaCreatureHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhSeaSeaCreatureHeaders withXApiKey(String xApiKey) {
