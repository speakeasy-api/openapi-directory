...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.serverStatistics = new serverstatistics_1.ServerStatistics(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
