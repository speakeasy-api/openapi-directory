 ...
 */
public enum GetZRLocationSettings200ApplicationJSON1MeetingSecurityEncryptionTypeEnum {
    ...
    private GetZRLocationSettings200ApplicationJSON1MeetingSecurityEncryptionTypeEnum(String value) {
        this.value = value;
    }
}
