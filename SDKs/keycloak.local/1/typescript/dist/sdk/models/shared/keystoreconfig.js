...
var KeyStoreConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "realmAlias" }),
        __metadata("design:type", String)
    ], KeyStoreConfig.prototype, "realmAlias", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "realmCertificate" }),
        __metadata("design:type", Boolean)
    ], KeyStoreConfig.prototype, "realmCertificate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "storePassword" }),
        __metadata("design:type", String)
    ], KeyStoreConfig.prototype, "storePassword", void 0);
    return KeyStoreConfig;
}(utils_1.SpeakeasyBase));
exports.KeyStoreConfig = KeyStoreConfig;
