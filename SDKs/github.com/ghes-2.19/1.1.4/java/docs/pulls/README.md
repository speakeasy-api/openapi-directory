...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCheckIfMergedRequest req = new PullsCheckIfMergedRequest("voluptatum", 622385L, "hic");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateRequest req = new PullsCreateRequest(                new PullsCreateRequestBody("expedita", "debitis") {{
                                body = "neque";
                                draft = false;
                                issue = 1L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReplyForReviewCommentRequest req = new PullsCreateReplyForReviewCommentRequest(                new PullsCreateReplyForReviewCommentRequestBody("dolorum");, 548361L, "accusamus", 272683L, "atque");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReviewRequest req = new PullsCreateReviewRequest("fugit", 282699L, "fugiat") {{
                requestBody = new PullsCreateReviewRequestBody() {{
                    ...
                    comments = new org.openapis.openapi.models.operations.PullsCreateReviewRequestBodyComments[]{{
                        add(new PullsCreateReviewRequestBodyComments("esse", "ipsam") {{
                            body = "expedita";
                            line = 28L;
                            path = "magnam";
                            position = 7884L;
                        ...
                        add(new PullsCreateReviewRequestBodyComments("repudiandae", "corporis") {{
                            body = "sit";
                            line = 28L;
                            path = "voluptatum";
                            position = 558065L;
                        ...
                        add(new PullsCreateReviewRequestBodyComments("sed", "sit") {{
                            body = "et";
                            line = 28L;
                            path = "blanditiis";
                            position = 405942L;
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.PullsCreateReviewCommentAlternativeRequest;
import org.openapis.openapi.models.operations.PullsCreateReviewCommentAlternativeRequestBody;
import org.openapis.openapi.models.operations.PullsCreateReviewCommentAlternativeResponse;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReviewCommentAlternativeRequest req = new PullsCreateReviewCommentAlternativeRequest(                new PullsCreateReviewCommentAlternativeRequestBody("saepe") {{
                                inReplyTo = 622231L;
                            }};, "consequatur", 279068L, "reiciendis");            

            PullsCreateReviewCommentAlternativeResponse res = sdk.pulls.pullsCreateReviewCommentAlternative(req);

            if (res.legacyReviewComment != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDeletePendingReviewRequest req = new PullsDeletePendingReviewRequest("dolorem", 690894L, "dicta", 99416L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDeleteReviewCommentRequest req = new PullsDeleteReviewCommentRequest(577140L, "labore", "quidem");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDismissReviewRequest req = new PullsDismissReviewRequest(                new PullsDismissReviewRequestBody("atque") {{
                                event = ""APPROVE"";
                            }};, "laborum", 724148L, "tenetur", 388867L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetRequest req = new PullsGetRequest("alias", 227084L, "deserunt");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetReviewRequest req = new PullsGetReviewRequest("voluptate", 600392L, "reiciendis", 588740L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetReviewCommentRequest req = new PullsGetReviewCommentRequest(833819L, "delectus", "voluptates");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListRequest req = new PullsListRequest("perferendis", "est") {{
                base = "quidem";
                direction = PullsListDirectionEnum.ASC;
                head = "facere";
                page = 685092L;
                perPage = 509807L;
                sort = PullsListSortEnum.POPULARITY;
                state = PullsListStateEnum.CLOSED;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListCommentsForReviewRequest req = new PullsListCommentsForReviewRequest("voluptatem", 790840L, "repudiandae", 97243L) {{
                page = 542457L;
                perPage = 442036L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListCommitsRequest req = new PullsListCommitsRequest("asperiores", 519952L, "suscipit") {{
                page = 693957L;
                perPage = 806670L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListFilesRequest req = new PullsListFilesRequest("et", 461007L, "amet") {{
                page = 826825L;
                perPage = 410301L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListRequestedReviewersRequest req = new PullsListRequestedReviewersRequest("atque", 623295L, "officiis") {{
                page = 886961L;
                perPage = 880107L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewCommentsRequest req = new PullsListReviewCommentsRequest("natus", 328303L, "aspernatur") {{
                direction = PullsListReviewCommentsDirectionEnum.ASC;
                page = 980581L;
                perPage = 544647L;
                since = OffsetDateTime.parse("2021-02-19T05:54:38.127Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewCommentsForRepoRequest req = new PullsListReviewCommentsForRepoRequest("suscipit", "repudiandae") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewsRequest req = new PullsListReviewsRequest("labore", 968287L, "doloremque") {{
                page = 919783L;
                perPage = 116098L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsMergeRequest req = new PullsMergeRequest("accusantium", 106429L, "dolores") {{
                requestBody = new PullsMergeRequestBody() {{
                    commitMessage = "enim";
                    commitTitle = "laboriosam";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsRequestReviewersRequest req = new PullsRequestReviewersRequest("consequuntur", 145870L, "id") {{
    ...
    public static void main(String[] args) {
        try {
            ...
            PullsSubmitReviewRequest req = new PullsSubmitReviewRequest(                new PullsSubmitReviewRequestBody(PullsSubmitReviewRequestBodyEventEnum.APPROVE) {{
                                body = "vero";
                            }};, "doloremque", 434156L, "ipsa", 517612L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateRequest req = new PullsUpdateRequest("quae", 474668L, "eveniet") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateBranchRequest req = new PullsUpdateBranchRequest("ratione", 672582L, "distinctio") {{
                requestBody = new PullsUpdateBranchRequestBody() {{
                    expectedHeadSha = "voluptatum";
                }};;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateReviewRequest req = new PullsUpdateReviewRequest(                new PullsUpdateReviewRequestBody("rem");, "aliquam", 320565L, "repellat", 3099L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateReviewCommentRequest req = new PullsUpdateReviewCommentRequest(                new PullsUpdateReviewCommentRequestBody("corporis");, 597303L, "nihil", "mollitia");            
