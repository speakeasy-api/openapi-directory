...
public class CrashesGetCrashAttachmentLocationRequest {
    ...
    public CrashesGetCrashAttachmentLocationRequest(@JsonProperty("app_name") String appName, @JsonProperty("attachment_id") String attachmentId, @JsonProperty("crash_id") String crashId, @JsonProperty("owner_name") String ownerName) {
        this.appName = appName;
        this.attachmentId = attachmentId;
        this.crashId = crashId;
        this.ownerName = ownerName;
