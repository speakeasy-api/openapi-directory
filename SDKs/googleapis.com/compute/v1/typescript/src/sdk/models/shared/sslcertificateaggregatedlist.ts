...
import { SslCertificatesScopedList } from "./sslcertificatesscopedlist";
import { Expose, Transform, Type } from "class-transformer";

/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export enum SslCertificateAggregatedListWarningCodeEnum {
...
export class SslCertificateAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SslCertificateAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: SslCertificateAggregatedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: SslCertificateAggregatedListWarningData })
  @Expose({ name: "data" })
  @Type(() => SslCertificateAggregatedListWarningData)
  data?: SslCertificateAggregatedListWarningData[];
 ...
 * Successful response
 */
export class SslCertificateAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: SslCertificatesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, SslCertificatesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], SslCertificatesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
