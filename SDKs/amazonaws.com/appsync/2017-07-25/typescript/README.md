...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/amazonaws.com/appsync/2017-07-25/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/amazonaws.com/appsync/2017-07-25/typescript
```
...
sdk.associateApi(req).then((res: AssociateApiResponse | AxiosError) => {
   // handle response
});
```
