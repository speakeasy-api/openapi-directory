...
var OrderinvoicesCreateRefundInvoiceRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "refundOnlyOption" }),
        (0, class_transformer_1.Type)(function () { return orderinvoicescustombatchrequestentrycreaterefundinvoicerefundoption_1.OrderinvoicesCustomBatchRequestEntryCreateRefundInvoiceRefundOption; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "returnOption" }),
        (0, class_transformer_1.Type)(function () { return orderinvoicescustombatchrequestentrycreaterefundinvoicereturnoption_1.OrderinvoicesCustomBatchRequestEntryCreateRefundInvoiceReturnOption; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shipmentinvoice_1.ShipmentInvoice }),
        (0, class_transformer_1.Expose)({ name: "shipmentInvoices" }),
        (0, class_transformer_1.Type)(function () { return shipmentinvoice_1.ShipmentInvoice; }),
