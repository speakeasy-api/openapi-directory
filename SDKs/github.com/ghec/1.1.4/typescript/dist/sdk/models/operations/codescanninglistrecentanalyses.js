...
exports.CodeScanningListRecentAnalysesResponse = exports.CodeScanningListRecentAnalyses503ApplicationJSON = exports.CodeScanningListRecentAnalysesRequest = exports.CodeScanningListRecentAnalysesSortEnum = void 0;
 ...
 */
var CodeScanningListRecentAnalysesSortEnum;
(function (CodeScanningListRecentAnalysesSortEnum) {
    CodeScanningListRecentAnalysesSortEnum["Created"] = "created";
})(CodeScanningListRecentAnalysesSortEnum = exports.CodeScanningListRecentAnalysesSortEnum || (exports.CodeScanningListRecentAnalysesSortEnum = {}));
var CodeScanningListRecentAnalysesRequest = /** @class */ (function (_super) {
    ...
    ], CodeScanningListRecentAnalysesRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=owner",
        }),
        __metadata("design:type", String)
    ], CodeScanningListRecentAnalysesRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], CodeScanningListRecentAnalysesRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], CodeScanningListRecentAnalysesRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ref" }),
        __metadata("design:type", String)
    ], CodeScanningListRecentAnalysesRequest.prototype, "ref", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], CodeScanningListRecentAnalysesRequest.prototype, "repo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sarif_id",
        }),
        __metadata("design:type", String)
    ], CodeScanningListRecentAnalysesRequest.prototype, "sarifId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], CodeScanningListRecentAnalysesRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=tool_guid",
        }),
        __metadata("design:type", String)
    ], CodeScanningListRecentAnalysesRequest.prototype, "toolGuid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=tool_name",
        }),
        __metadata("design:type", String)
    ], CodeScanningListRecentAnalysesRequest.prototype, "toolName", void 0);
    return CodeScanningListRecentAnalysesRequest;
}(utils_1.SpeakeasyBase));
exports.CodeScanningListRecentAnalysesRequest = CodeScanningListRecentAnalysesRequest;
/**
 * Service unavailable
 */
...
exports.CodeScanningListRecentAnalyses503ApplicationJSON = CodeScanningListRecentAnalyses503ApplicationJSON;
var CodeScanningListRecentAnalysesResponse = /** @class */ (function (_super) {
    ...
    ], CodeScanningListRecentAnalysesResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.BasicError)
    ], CodeScanningListRecentAnalysesResponse.prototype, "basicError", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.CodeScanningAnalysis }),
...
exports.CodeScanningListRecentAnalysesResponse = CodeScanningListRecentAnalysesResponse;
