...
public class PhoneNumberValidationQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=false,name=api_key")
    public String apiKey;
    public PhoneNumberValidationQueryParams withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public String query;
    public PhoneNumberValidationQueryParams withQuery(String query) {
        this.query = query;
        return this;
    }
