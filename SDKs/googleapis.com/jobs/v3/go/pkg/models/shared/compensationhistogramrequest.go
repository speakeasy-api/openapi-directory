...
func (e CompensationHistogramRequestTypeEnum) ToPointer() *CompensationHistogramRequestTypeEnum {
	return &e
}
...
func (e *CompensationHistogramRequestTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "ANNUALIZED_TOTAL":
		*e = CompensationHistogramRequestTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CompensationHistogramRequestTypeEnum: %v", v)
	}
}
