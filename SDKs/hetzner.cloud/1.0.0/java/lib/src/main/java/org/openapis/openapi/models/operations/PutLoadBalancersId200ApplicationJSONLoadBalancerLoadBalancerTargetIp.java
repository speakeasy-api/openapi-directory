 ...
 */
public class PutLoadBalancersId200ApplicationJSONLoadBalancerLoadBalancerTargetIp {
    /**
     * IP of a server that belongs to the same customer (public IPv4/IPv6) or private IP in a Subnetwork type vswitch.
     */
    @JsonProperty("ip")
    public String ip;
    public PutLoadBalancersId200ApplicationJSONLoadBalancerLoadBalancerTargetIp withIp(String ip) {
        this.ip = ip;
        return this;
    }
