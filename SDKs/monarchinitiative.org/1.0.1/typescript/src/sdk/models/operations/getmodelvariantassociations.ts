...
export class GetModelVariantAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetModelVariantAssociationsQueryParams extends SpeakeasyBase {
...
export class GetModelVariantAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetModelVariantAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
