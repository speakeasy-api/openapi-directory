...
var SessionManagement = /** @class */ (function () {
     ...
     */
    SessionManagement.prototype.authorizeIframe = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AuthorizeIframeRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{client_id}/iframe", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.AuthorizeIframeResponse({
