...
export class OBWriteDomesticScheduledResponse5Data extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: OBWriteDomesticScheduledResponse5DataCharges })
  @Expose({ name: "Charges" })
  @Type(() => OBWriteDomesticScheduledResponse5DataCharges)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "DomesticScheduledPaymentId" })
