...
public class PostConfigApacheSlingGetServletQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=enable.html")
    public Boolean enableHtml;
    public PostConfigApacheSlingGetServletQueryParams withEnableHtml(Boolean enableHtml) {
    ...
    public PostConfigApacheSlingGetServletQueryParams withEnableHtmlAtTypeHint(String enableHtmlAtTypeHint) {
    ...
    public PostConfigApacheSlingGetServletQueryParams withEnableTxt(Boolean enableTxt) {
    ...
    public PostConfigApacheSlingGetServletQueryParams withEnableTxtAtTypeHint(String enableTxtAtTypeHint) {
    ...
    public PostConfigApacheSlingGetServletQueryParams withEnableXml(Boolean enableXml) {
    ...
    public PostConfigApacheSlingGetServletQueryParams withEnableXmlAtTypeHint(String enableXmlAtTypeHint) {
    ...
    public PostConfigApacheSlingGetServletQueryParams withJsonMaximumresults(String jsonMaximumresults) {
    ...
    public PostConfigApacheSlingGetServletQueryParams withJsonMaximumresultsAtTypeHint(String jsonMaximumresultsAtTypeHint) {
