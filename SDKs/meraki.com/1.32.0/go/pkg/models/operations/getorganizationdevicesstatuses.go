...
func (e GetOrganizationDevicesStatusesProductTypesEnum) ToPointer() *GetOrganizationDevicesStatusesProductTypesEnum {
	return &e
}
...
func (e *GetOrganizationDevicesStatusesProductTypesEnum) UnmarshalJSON(data []byte) error {
	...
	case "systemsManager":
		fallthrough
	case "wireless":
		*e = GetOrganizationDevicesStatusesProductTypesEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationDevicesStatusesProductTypesEnum: %v", v)
	}
}
...
func (e GetOrganizationDevicesStatusesStatusesEnum) ToPointer() *GetOrganizationDevicesStatusesStatusesEnum {
	return &e
}
...
func (e *GetOrganizationDevicesStatusesStatusesEnum) UnmarshalJSON(data []byte) error {
	...
	case "offline":
		fallthrough
	case "online":
		*e = GetOrganizationDevicesStatusesStatusesEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationDevicesStatusesStatusesEnum: %v", v)
	}
}
...
func (e GetOrganizationDevicesStatusesTagsFilterTypeEnum) ToPointer() *GetOrganizationDevicesStatusesTagsFilterTypeEnum {
	return &e
}
...
func (e *GetOrganizationDevicesStatusesTagsFilterTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "withAllTags":
		fallthrough
	case "withAnyTags":
		*e = GetOrganizationDevicesStatusesTagsFilterTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationDevicesStatusesTagsFilterTypeEnum: %v", v)
	}
}
