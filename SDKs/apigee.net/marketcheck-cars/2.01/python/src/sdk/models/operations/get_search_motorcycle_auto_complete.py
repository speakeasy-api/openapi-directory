...
class GetSearchMotorcycleAutoCompleteRequest:
    ...
    field: GetSearchMotorcycleAutoCompleteFieldEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'field', 'style': 'form', 'explode': True }})
    r"""Field name for which you want auto-completion"""  
    ...
    sort_by: Optional[GetSearchMotorcycleAutoCompleteSortByEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort_by', 'style': 'form', 'explode': True }})
    r"""Sort the response, either by index or count(default)"""  
