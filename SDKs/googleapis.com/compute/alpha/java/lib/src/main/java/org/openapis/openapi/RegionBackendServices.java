...
public class RegionBackendServices {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeRegionBackendServicesSetSecurityPolicyResponse computeRegionBackendServicesSetSecurityPolicy(org.openapis.openapi.models.operations.ComputeRegionBackendServicesSetSecurityPolicyRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeRegionBackendServicesSetSecurityPolicyPathParams.class, baseUrl, "/projects/{project}/regions/{region}/backendServices/{backendService}/setSecurityPolicy", request.pathParams, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeRegionBackendServicesSetSecurityPolicyQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
