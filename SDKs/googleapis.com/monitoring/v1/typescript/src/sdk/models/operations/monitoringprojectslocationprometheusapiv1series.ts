...
export class MonitoringProjectsLocationPrometheusApiV1SeriesSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MonitoringProjectsLocationPrometheusApiV1SeriesSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class MonitoringProjectsLocationPrometheusApiV1SeriesSecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class MonitoringProjectsLocationPrometheusApiV1SeriesSecurity extends SpeakeasyBase {
...
export class MonitoringProjectsLocationPrometheusApiV1SeriesRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
  ...
  querySeriesRequest?: shared.QuerySeriesRequest;
...
export class MonitoringProjectsLocationPrometheusApiV1SeriesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
