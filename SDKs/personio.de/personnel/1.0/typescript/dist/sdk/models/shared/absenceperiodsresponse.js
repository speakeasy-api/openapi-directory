...
var AbsencePeriodsResponseDataAttributesEmployee = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=attributes", elemType: AbsencePeriodsResponseDataAttributesEmployeeAttributes }),
...
var AbsencePeriodsResponseDataAttributesTimeOffType = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=attributes", elemType: AbsencePeriodsResponseDataAttributesTimeOffTypeAttributes }),
        __metadata("design:type", Array)
...
var AbsencePeriodsResponseDataAttributes = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=days_count" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=half_day_end" }),
        __metadata("design:type", Number)
    ], AbsencePeriodsResponseDataAttributes.prototype, "halfDayEnd", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=half_day_start" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=time_off_type" }),
...
var AbsencePeriodsResponseData = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=attributes", elemType: AbsencePeriodsResponseDataAttributes }),
        __metadata("design:type", Array)
