...
func (e *GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreakTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "HYPHEN":
		fallthrough
	case "LINE_BREAK":
		*e = GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreakTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreakTypeEnum: %s", s)
	}
}
