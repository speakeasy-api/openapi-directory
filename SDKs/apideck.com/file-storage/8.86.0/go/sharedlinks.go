...
// List SharedLinks
func (s *SharedLinks) SharedLinksAll(ctx context.Context, request operations.SharedLinksAllRequest) (*operations.SharedLinksAllResponseOutput, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/file-storage/shared-links"
	...
	res := &operations.SharedLinksAllResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetSharedLinksResponseOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SharedLinks) SharedLinksDelete(ctx context.Context, request operations.SharedLinksDeleteRequest) (*operations.SharedLinksDeleteResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/file-storage/shared-links/{id}", request.PathParams)
...
// Get Shared Link
func (s *SharedLinks) SharedLinksOne(ctx context.Context, request operations.SharedLinksOneRequest) (*operations.SharedLinksOneResponseOutput, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/file-storage/shared-links/{id}", request.PathParams)
	...
	res := &operations.SharedLinksOneResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
