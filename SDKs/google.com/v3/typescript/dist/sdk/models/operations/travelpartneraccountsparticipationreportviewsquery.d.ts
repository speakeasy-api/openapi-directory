...
export declare class TravelpartnerAccountsParticipationReportViewsQueryRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class TravelpartnerAccountsParticipationReportViewsQueryResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
