...
class GoogleCloudBillingBudgetsV1beta1ThresholdRule:
    ...
    spend_basis: Optional[GoogleCloudBillingBudgetsV1beta1ThresholdRuleSpendBasisEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('spendBasis'), 'exclude': lambda f: f is None }})
    r"""Optional. The type of basis used to determine if spend has passed the threshold. Behavior defaults to CURRENT_SPEND if not set."""  
