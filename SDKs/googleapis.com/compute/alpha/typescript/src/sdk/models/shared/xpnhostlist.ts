 ...
 */
export enum XpnHostListWarningCodeEnum {
...
export class XpnHostListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class XpnHostListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: XpnHostListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class XpnHostList extends SpeakeasyBase {
  /**
