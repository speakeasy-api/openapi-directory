...
var Organizations = /** @class */ (function () {
     ...
     */
    Organizations.prototype.getOrgArticles = function (req, config) {
     ...
     * It supports pagination, each page will contain `30` users by default.
     */
    Organizations.prototype.getOrgUsers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    Organizations.prototype.getOrganization = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/organizations/{username}", req);
        var client = this._securityClient || this._defaultClient;
