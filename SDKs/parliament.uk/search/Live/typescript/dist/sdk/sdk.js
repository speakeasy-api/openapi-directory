...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.description = new description_1.Description(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
