...
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#add-an-email-address-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#check-if-a-user-follows-another-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#check-if-a-person-is-followed-by-the-authenticated-user>
...
Adds a GPG key to the authenticated user's GitHub account. Requires that you are authenticated via Basic Auth, or OAuth with at least `write:gpg_key` [scope](https://docs.github.com/enterprise-server@3.7/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#create-a-gpg-key-for-the-authenticated-user>
...
Adds a public SSH key to the authenticated user's GitHub account. Requires that you are authenticated via Basic Auth, or OAuth with at least `write:public_key` [scope](https://docs.github.com/enterprise-server@3.7/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#create-a-public-ssh-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#create-an-ssh-signing-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#delete-an-email-address-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#delete-a-gpg-key-for-the-authenticated-user>
...
Removes a public SSH key from the authenticated user's GitHub account. Requires that you are authenticated via Basic Auth or via OAuth with at least `admin:public_key` [scope](https://docs.github.com/enterprise-server@3.7/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#delete-a-public-ssh-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#delete-a-ssh-signing-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#follow-a-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#get-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#get-a-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#get-contextual-information-for-a-user>
...
func main() {
    ...
    res, err := s.Users.UsersGetContextForUser(ctx, operations.UsersGetContextForUserRequest{
        SubjectID: sdk.String("ipsum"),
        SubjectType: operations.UsersGetContextForUserSubjectTypeEnumPullRequest.ToPointer(),
        Username: "Patience77",
    })
    if err != nil {
        log.Fatal(err)
...
View extended details for a single GPG key. Requires that you are authenticated via Basic Auth or via OAuth with at least `read:gpg_key` [scope](https://docs.github.com/enterprise-server@3.7/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#get-a-gpg-key-for-the-authenticated-user>
...
View extended details for a single public SSH key. Requires that you are authenticated via Basic Auth or via OAuth with at least `read:public_key` [scope](https://docs.github.com/enterprise-server@3.7/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#get-a-public-ssh-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#get-a-ssh-signing-key-for-the-authenticated-user>
...
Note: Pagination is powered exclusively by the `since` parameter. Use the [Link header](https://docs.github.com/enterprise-server@3.7/rest/overview/resources-in-the-rest-api#link-header) to get the URL for the next page of users.

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-users>
...
func main() {
    ...
    res, err := s.Users.UsersList(ctx, operations.UsersListRequest{
        PerPage: sdk.Int64(840992),
        Since: sdk.Int64(59023),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-email-addresses-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Users.UsersListEmailsForAuthenticatedUser(ctx, operations.UsersListEmailsForAuthenticatedUserRequest{
        Page: sdk.Int64(879208),
        PerPage: sdk.Int64(810982),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-the-people-the-authenticated-user-follows>
...
func main() {
    ...
    res, err := s.Users.UsersListFollowedByAuthenticatedUser(ctx, operations.UsersListFollowedByAuthenticatedUserRequest{
        Page: sdk.Int64(464878),
        PerPage: sdk.Int64(627756),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-followers-of-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Users.UsersListFollowersForAuthenticatedUser(ctx, operations.UsersListFollowersForAuthenticatedUserRequest{
        Page: sdk.Int64(962408),
        PerPage: sdk.Int64(904983),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-followers-of-a-user>
...
func main() {
    ...
    res, err := s.Users.UsersListFollowersForUser(ctx, operations.UsersListFollowersForUserRequest{
        Page: sdk.Int64(813975),
        PerPage: sdk.Int64(748723),
        Username: "Santina83",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-the-people-a-user-follows>
...
func main() {
    ...
    res, err := s.Users.UsersListFollowingForUser(ctx, operations.UsersListFollowingForUserRequest{
        Page: sdk.Int64(947515),
        PerPage: sdk.Int64(278050),
        Username: "Dereck.Lockman",
    })
    if err != nil {
        log.Fatal(err)
    }
...
Lists the current user's GPG keys. Requires that you are authenticated via Basic Auth or via OAuth with at least `read:gpg_key` [scope](https://docs.github.com/enterprise-server@3.7/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-gpg-keys-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Users.UsersListGpgKeysForAuthenticatedUser(ctx, operations.UsersListGpgKeysForAuthenticatedUserRequest{
        Page: sdk.Int64(456599),
        PerPage: sdk.Int64(968205),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-gpg-keys-for-a-user>
...
func main() {
    ...
    res, err := s.Users.UsersListGpgKeysForUser(ctx, operations.UsersListGpgKeysForUserRequest{
        Page: sdk.Int64(611792),
        PerPage: sdk.Int64(226196),
        Username: "Krista.Armstrong55",
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-public-email-addresses-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Users.UsersListPublicEmailsForAuthenticatedUser(ctx, operations.UsersListPublicEmailsForAuthenticatedUserRequest{
        Page: sdk.Int64(502509),
        PerPage: sdk.Int64(559937),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-public-keys-for-a-user>
...
func main() {
    ...
    res, err := s.Users.UsersListPublicKeysForUser(ctx, operations.UsersListPublicKeysForUserRequest{
        Page: sdk.Int64(28362),
        PerPage: sdk.Int64(591774),
        Username: "Keely_Erdman70",
    })
    if err != nil {
        log.Fatal(err)
    }
...
Lists the public SSH keys for the authenticated user's GitHub account. Requires that you are authenticated via Basic Auth or via OAuth with at least `read:public_key` [scope](https://docs.github.com/enterprise-server@3.7/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-public-ssh-keys-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Users.UsersListPublicSSHKeysForAuthenticatedUser(ctx, operations.UsersListPublicSSHKeysForAuthenticatedUserRequest{
        Page: sdk.Int64(983060),
        PerPage: sdk.Int64(622968),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-public-ssh-signing-keys-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Users.UsersListSSHSigningKeysForAuthenticatedUser(ctx, operations.UsersListSSHSigningKeysForAuthenticatedUserRequest{
        Page: sdk.Int64(926119),
        PerPage: sdk.Int64(955962),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#list-ssh-signing-keys-for-a-user>
...
func main() {
    ...
    res, err := s.Users.UsersListSSHSigningKeysForUser(ctx, operations.UsersListSSHSigningKeysForUserRequest{
        Page: sdk.Int64(234964),
        PerPage: sdk.Int64(958280),
        Username: "Wilbert_Senger96",
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users#unfollow-a-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/users/#update-the-authenticated-user>
