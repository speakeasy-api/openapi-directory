...
class GetDiseaseModelAssociationsRequest:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""CURIE identifier of disease, e.g. OMIM:605543, DOID:678. Equivalent IDs can be used with same results"""  
...
@dataclasses.dataclass
class GetDiseaseModelAssociationsResponse:
