...
export class FetchExportContentsByIdSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FetchExportContentsByIdRequest extends SpeakeasyBase {
  /**
...
export class FetchExportContentsByIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
