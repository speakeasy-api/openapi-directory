...
public class InvoiceApiSendToClientFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiSendToClientFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiSendToClientFormHeaders withXAuthSecret(String xAuthSecret) {
