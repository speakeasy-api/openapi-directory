...
try {
    ...
    $request->clientSecret = 'nostrum';
    $request->fingerprint = 'mollitia';
    $request->note = 'Update all gems';
    $request->noteUrl = 'provident';
    $request->scopes = [
        'animi',
        'ex',
        'aliquid',
...
try {
    ...
    $request->authorizationId = 999278;
...
try {
    ...
    $request->authorizationId = 351893;
...
try {
    ...
    $request->requestBody->clientSecret = 'nam';
    $request->requestBody->fingerprint = 'earum';
    $request->requestBody->note = 'Update all gems';
    $request->requestBody->noteUrl = 'officia';
...
try {
    ...
    $request->requestBody->clientSecret = 'officiis';
    $request->requestBody->note = 'Update all gems';
    ...
    $request->clientId = 'inventore';
    $request->fingerprint = 'fugit';
...
try {
    ...
    $request->requestBody->note = 'Update all gems';
    $request->requestBody->noteUrl = 'eos';
    ...
    $request->authorizationId = 940782;
