...
class CitiesGetv1V1CitiesGetRequest
{
     ...
     * Order by a field
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CitiesGetv1V1CitiesGetOrderByCitiesOrderEnum $orderBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=order_by')]
    public ?CitiesGetv1V1CitiesGetOrderByCitiesOrderEnum $orderBy = null;
     ...
     * Define sort order.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CitiesGetv1V1CitiesGetSortSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?CitiesGetv1V1CitiesGetSortSortEnum $sort = null;
