...
type BeyondcorpProjectsLocationsAppConnectionsCreateRequest struct {
	...
	GoogleCloudBeyondcorpAppconnectionsV1AppConnectionInput *shared.GoogleCloudBeyondcorpAppconnectionsV1AppConnectionInput `request:"mediaType=application/json"`
	// OAuth access token.
