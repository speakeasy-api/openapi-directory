...
exports.ReposGetCombinedStatusForRefResponse = exports.ReposGetCombinedStatusForRefRequest = void 0;
...
var ReposGetCombinedStatusForRefRequest = /** @class */ (function (_super) {
    ...
    ], ReposGetCombinedStatusForRefRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], ReposGetCombinedStatusForRefRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], ReposGetCombinedStatusForRefRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=ref" }),
        __metadata("design:type", String)
    ], ReposGetCombinedStatusForRefRequest.prototype, "ref", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], ReposGetCombinedStatusForRefRequest.prototype, "repo", void 0);
...
var ReposGetCombinedStatusForRefResponse = /** @class */ (function (_super) {
    ...
    ], ReposGetCombinedStatusForRefResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
