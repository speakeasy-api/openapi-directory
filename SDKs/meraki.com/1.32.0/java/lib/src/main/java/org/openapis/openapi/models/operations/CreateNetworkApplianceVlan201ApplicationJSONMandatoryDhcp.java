 ...
 */
public class CreateNetworkApplianceVlan201ApplicationJSONMandatoryDhcp {
    /**
    ...
    public CreateNetworkApplianceVlan201ApplicationJSONMandatoryDhcp withEnabled(Boolean enabled) {
        this.enabled = enabled;
        return this;
    }
    
    public CreateNetworkApplianceVlan201ApplicationJSONMandatoryDhcp(){}
}
