...
var Me = /** @class */ (function () {
    ...
    **/
    Me.prototype.disconnectVendor = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DisconnectVendorRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/me/vendors/{vendor}", req.pathParams);
    ...
    **/
    Me.prototype.getMe = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getMe200ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
