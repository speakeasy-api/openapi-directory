...
type NetworkservicesProjectsLocationsServiceBindingsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type NetworkservicesProjectsLocationsServiceBindingsCreatePathParams struct {
	// Required. The parent resource of the ServiceBinding. Must be in the format `projects/*/locations/global`.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type NetworkservicesProjectsLocationsServiceBindingsCreateQueryParams struct {
	// V1 error format.
	...
	ServiceBindingID *string `queryParam:"style=form,explode=true,name=serviceBindingId"`
...
type NetworkservicesProjectsLocationsServiceBindingsCreateResponse struct {
	ContentType string
	// Successful response
