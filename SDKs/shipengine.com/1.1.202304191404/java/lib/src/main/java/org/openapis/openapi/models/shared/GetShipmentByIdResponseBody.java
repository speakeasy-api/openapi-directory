...
public class GetShipmentByIdResponseBody {
    ...
    public GetShipmentByIdResponseBody withIsReturn(Boolean isReturn) {
    ...
    public GetShipmentByIdResponseBody(@JsonProperty("advanced_options") AdvancedShipmentOptions advancedOptions, @JsonProperty("carrier_id") String carrierId, @JsonProperty("confirmation") GetShipmentByIdResponseBodyDeliveryConfirmationEnum confirmation, @JsonProperty("created_at") OffsetDateTime createdAt, @JsonProperty("customs") GetShipmentByIdResponseBodyInternationalShipmentOptions customs, @JsonProperty("insurance_provider") GetShipmentByIdResponseBodyInsuranceProviderEnum insuranceProvider, @JsonProperty("modified_at") OffsetDateTime modifiedAt, @JsonProperty("packages") Package[] packages, @JsonProperty("return_to") ShippingAddress returnTo, @JsonProperty("service_code") String serviceCode, @JsonProperty("ship_date") OffsetDateTime shipDate, @JsonProperty("ship_from") ShippingAddress shipFrom, @JsonProperty("ship_to") ShippingAddress shipTo, @JsonProperty("shipment_id") String shipmentId, @JsonProperty("shipment_status") GetShipmentByIdResponseBodyShipmentStatusEnum shipmentStatus, @JsonProperty("tags") Tag[] tags, @JsonProperty("total_weight") GetShipmentByIdResponseBodyWeight totalWeight, @JsonProperty("warehouse_id") String warehouseId) {
        this.advancedOptions = advancedOptions;
        this.carrierId = carrierId;
        this.confirmation = confirmation;
        this.createdAt = createdAt;
