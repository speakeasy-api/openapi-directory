...
func (e DependencyEdgeLabelEnum) ToPointer() *DependencyEdgeLabelEnum {
	return &e
}
...
func (e *DependencyEdgeLabelEnum) UnmarshalJSON(data []byte) error {
	...
	case "MES":
		fallthrough
	case "NCOMP":
		*e = DependencyEdgeLabelEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DependencyEdgeLabelEnum: %v", v)
	}
}
