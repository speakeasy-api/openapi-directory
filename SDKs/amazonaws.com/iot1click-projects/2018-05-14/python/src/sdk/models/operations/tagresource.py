...
class TagResourceRequestBody:
    ...
    r"""The new or modifying tag(s) for the resource. See <a href=\\"https://docs.aws.amazon.com/iot-1-click/latest/developerguide/1click-appendix.html#1click-limits\\">AWS IoT 1-Click Service Limits</a> for the maximum number of tags allowed per resource."""  
...
class TagResourceRequest:
    ...
    r"""The ARN of the resouce for which tag(s) should be added or modified."""  
