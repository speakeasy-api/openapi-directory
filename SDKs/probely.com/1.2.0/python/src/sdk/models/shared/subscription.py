...
class SubscriptionInput:
    ...
    coupon_ids: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('coupon_ids'), 'exclude': lambda f: f is None }})
    r"""Coupon ids"""  
