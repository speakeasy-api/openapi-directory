...
import dataclasses
from ..shared import nameasurebodyelem as shared_nameasurebodyelem
...
class NAMeasureResponse:
    ...
    body: Optional[list[shared_nameasurebodyelem.NAMeasureBodyElem]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('body'), 'exclude': lambda f: f is None }})  
