...
from ..shared import certificaterepresentation as shared_certificaterepresentation
...
class PostRealmClientsIDCertificatesAttrGenerateResponse:
    ...
    certificate_representation: Optional[shared_certificaterepresentation.CertificateRepresentation] = dataclasses.field(default=None)
    r"""success"""  
