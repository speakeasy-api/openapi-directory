...
public class PosPayment {
    ...
    public PosPayment(@JsonProperty("amount") Double amount, @JsonProperty("currency") CurrencyEnum currency, @JsonProperty("customer_id") String customerId, @JsonProperty("order_id") String orderId, @JsonProperty("source_id") String sourceId, @JsonProperty("tender_id") String tenderId) {
        this.amount = amount;
        this.currency = currency;
        this.customerId = customerId;
        this.orderId = orderId;
