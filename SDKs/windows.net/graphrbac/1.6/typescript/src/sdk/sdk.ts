 ...
 */
export const ServerList = ["https://graph.windows.net"] as const;
...
export class SDK {
  ...
  constructor(props?: SDKProps) {
    ...
    this.servicePrincipalAppRoleAssignedTo =
      new ServicePrincipalAppRoleAssignedTo(
        this._defaultClient,
        this._securityClient,
        this._serverURL,
        this._language,
    ...
    this.servicePrincipalAppRoleAssignments =
      new ServicePrincipalAppRoleAssignments(
        this._defaultClient,
        this._securityClient,
        this._serverURL,
        this._language,
    ...
    this.servicePrincipalPasswordCredentials =
      new ServicePrincipalPasswordCredentials(
        this._defaultClient,
        this._securityClient,
        this._serverURL,
        this._language,
