...
class ListSyncDocumentListSyncDocumentResponse:
    ...
    documents: Optional[list[shared_preview_sync_service_document.PreviewSyncServiceDocument]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('documents'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListSyncDocumentListSyncDocumentResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
