...
class Goals:
    r"""A goal collection lists Analytics goals to which the user has access. Each view (profile) can have a set of goals. Each resource in the Goal collection corresponds to a single Analytics goal."""
    
    items: Optional[list[shared_goal.Goal]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
    r"""A list of goals."""  
    ...
    r"""Link to next page for this goal collection."""  
    ...
    r"""Link to previous page for this goal collection."""  
