...
export class IdsProjectsLocationsEndpointsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IdsProjectsLocationsEndpointsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IdsProjectsLocationsEndpointsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
