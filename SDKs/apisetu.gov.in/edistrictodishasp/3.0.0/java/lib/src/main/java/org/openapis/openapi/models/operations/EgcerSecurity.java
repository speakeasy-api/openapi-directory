...
public class EgcerSecurity {
    ...
    public EgcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public EgcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public EgcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
