 ...
 */
export enum TargetInstancesScopedListWarningCodeEnum {
...
export class TargetInstancesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetInstancesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetInstancesScopedListWarningData })
  @Expose({ name: "data" })
...
export class TargetInstancesScopedList extends SpeakeasyBase {
  /**
