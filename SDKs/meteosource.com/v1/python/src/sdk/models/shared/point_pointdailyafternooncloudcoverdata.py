...
class PointPointDailyAfternoonCloudCoverData:
    ...
    r"""Percentage of sky covered by high clouds. (afternoon avg)
    Unit: \%
    """  
    ...
    r"""Percentage of sky covered by low clouds. (afternoon avg)
    Unit: \%
    """  
    ...
    r"""Percentage of sky covered by middle clouds. (afternoon avg)
    Unit: \%
    """  
    ...
    r"""Percentage of sky covered by clouds. (afternoon avg)
    Unit: \%
    """  
