...
public class PhoneUserCallLogs200ApplicationXMLCallLogsSite {
    /**
    ...
    public String id;
    public PhoneUserCallLogs200ApplicationXMLCallLogsSite withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public String name;
    public PhoneUserCallLogs200ApplicationXMLCallLogsSite withName(String name) {
        this.name = name;
        return this;
    }
