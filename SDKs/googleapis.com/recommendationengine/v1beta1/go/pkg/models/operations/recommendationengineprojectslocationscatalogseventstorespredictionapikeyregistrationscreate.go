...
type RecommendationengineProjectsLocationsCatalogsEventStoresPredictionAPIKeyRegistrationsCreateRequest struct {
	...
	GoogleCloudRecommendationengineV1beta1CreatePredictionAPIKeyRegistrationRequest *shared.GoogleCloudRecommendationengineV1beta1CreatePredictionAPIKeyRegistrationRequest `request:"mediaType=application/json"`
	// OAuth access token.
