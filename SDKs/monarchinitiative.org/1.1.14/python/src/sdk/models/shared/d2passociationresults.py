...
class D2PAssociationResults:
    ...
    associations: Optional[list[shared_d2passociation.D2PAssociation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('associations'), 'exclude': lambda f: f is None }})
    r"""Complete representation of full disease to phenotype association, plus evidence"""  
