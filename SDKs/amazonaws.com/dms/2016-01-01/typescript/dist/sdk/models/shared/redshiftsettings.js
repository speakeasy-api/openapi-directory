...
var RedshiftSettings = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "AcceptAnyDate" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CaseSensitiveNames" }),
        __metadata("design:type", Boolean)
    ], RedshiftSettings.prototype, "caseSensitiveNames", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CompUpdate" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "EmptyAsNull" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ExplicitIds" }),
        __metadata("design:type", Boolean)
    ], RedshiftSettings.prototype, "explicitIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "FileTransferUploadStreams" }),
        __metadata("design:type", Number)
    ], RedshiftSettings.prototype, "fileTransferUploadStreams", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "LoadTimeout" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        ...
        __metadata("design:type", Boolean)
    ], RedshiftSettings.prototype, "mapBooleanAsBoolean", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RemoveQuotes" }),
        __metadata("design:type", Boolean)
    ], RedshiftSettings.prototype, "removeQuotes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ReplaceChars" }),
        __metadata("design:type", String)
    ], RedshiftSettings.prototype, "replaceChars", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ReplaceInvalidChars" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TrimBlanks" }),
        __metadata("design:type", Boolean)
    ], RedshiftSettings.prototype, "trimBlanks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TruncateColumns" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "WriteBufferSize" }),
        __metadata("design:type", Number)
