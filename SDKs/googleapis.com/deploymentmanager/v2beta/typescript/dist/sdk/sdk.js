...
var typeproviders_1 = require("./typeproviders");
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.compositeTypes = new compositetypes_1.CompositeTypes(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.typeProviders = new typeproviders_1.TypeProviders(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
