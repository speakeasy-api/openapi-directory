 ...
 */
export declare enum CopySnapshotRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CopySnapshotRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CopySnapshotRequestTagSpecifications extends SpeakeasyBase {
