...
class GetGenePhenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGenePhenotypeAssociationsQueryParams:
...
class GetGenePhenotypeAssociationsRequest:
    path_params: GetGenePhenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetGenePhenotypeAssociationsQueryParams = dataclasses.field()
