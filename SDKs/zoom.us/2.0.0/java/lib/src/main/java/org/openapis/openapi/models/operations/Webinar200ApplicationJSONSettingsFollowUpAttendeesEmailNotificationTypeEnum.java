 ...
 */
public enum Webinar200ApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private Webinar200ApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
