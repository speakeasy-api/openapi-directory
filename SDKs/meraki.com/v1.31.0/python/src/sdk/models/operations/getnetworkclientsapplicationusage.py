...
class GetNetworkClientsApplicationUsageSsidNumberEnum(str, Enum):
    r"""An SSID number to include. If not specified, eveusage histories application usagents for all SSIDs will be returned."""
    ZERO = '0'
    ONE = '1'
    TWO = '2'
    THREE = '3'
...
class GetNetworkClientsApplicationUsageRequest:
    ...
    ssid_number: Optional[GetNetworkClientsApplicationUsageSsidNumberEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'ssidNumber', 'style': 'form', 'explode': True }})
    r"""An SSID number to include. If not specified, eveusage histories application usagents for all SSIDs will be returned."""  
...
class GetNetworkClientsApplicationUsageResponse:
    ...
    get_network_clients_application_usage_200_application_json_objects: Optional[list[dict[str, Any]]] = dataclasses.field(default=None)
