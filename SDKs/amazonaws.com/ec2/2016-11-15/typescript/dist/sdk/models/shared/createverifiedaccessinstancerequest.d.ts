 ...
 */
export declare enum CreateVerifiedAccessInstanceRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateVerifiedAccessInstanceRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateVerifiedAccessInstanceRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateVerifiedAccessInstanceRequest extends SpeakeasyBase {
    clientToken?: string;
    description?: string;
    dryRun?: boolean;
