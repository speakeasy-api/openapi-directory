...
exports.GetTagsFromSubContractorRevisionResponse = exports.GetTagsFromSubContractorRevisionRequest = void 0;
...
var GetTagsFromSubContractorRevisionRequest = /** @class */ (function (_super) {
    ...
    ], GetTagsFromSubContractorRevisionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagsFromSubContractorRevisionRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EffectiveDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetTagsFromSubContractorRevisionRequest.prototype, "effectiveDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagsFromSubContractorRevisionRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], GetTagsFromSubContractorRevisionRequest.prototype, "subContractorId", void 0);
...
var GetTagsFromSubContractorRevisionResponse = /** @class */ (function (_super) {
    ...
    ], GetTagsFromSubContractorRevisionResponse.prototype, "rawResponse", void 0);
