...
class ListUserPoolClientsRequest:
    ...
    list_user_pool_clients_request: shared_listuserpoolclientsrequest.ListUserPoolClientsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
