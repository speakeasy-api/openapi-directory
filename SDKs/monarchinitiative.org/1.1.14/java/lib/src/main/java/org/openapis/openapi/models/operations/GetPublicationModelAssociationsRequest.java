...
public class GetPublicationModelAssociationsRequest {
    ...
    public GetPublicationModelAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPublicationModelAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPublicationModelAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPublicationModelAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPublicationModelAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPublicationModelAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPublicationModelAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPublicationModelAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPublicationModelAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPublicationModelAssociationsRequest withRelation(String relation) {
    ...
    public GetPublicationModelAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPublicationModelAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPublicationModelAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPublicationModelAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPublicationModelAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPublicationModelAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPublicationModelAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPublicationModelAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
