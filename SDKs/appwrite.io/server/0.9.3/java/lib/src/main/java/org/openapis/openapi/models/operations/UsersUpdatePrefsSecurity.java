...
public class UsersUpdatePrefsSecurity {
    ...
    public UsersUpdatePrefsSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public UsersUpdatePrefsSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public UsersUpdatePrefsSecurity(@JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.key = key;
        this.project = project;
  }
}
