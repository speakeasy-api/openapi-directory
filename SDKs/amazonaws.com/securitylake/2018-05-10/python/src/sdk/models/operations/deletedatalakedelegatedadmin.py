...
class DeleteDatalakeDelegatedAdminRequest:
    ...
    r"""The account ID the Security Lake delegated administrator."""  
...
class DeleteDatalakeDelegatedAdminResponse:
    ...
    delete_datalake_delegated_admin_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
