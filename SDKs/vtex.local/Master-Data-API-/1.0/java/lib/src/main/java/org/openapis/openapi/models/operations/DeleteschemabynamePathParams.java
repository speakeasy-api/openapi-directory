...
public class DeleteschemabynamePathParams {
    /**
    ...
    public DeleteschemabynamePathParams withDataEntityName(String dataEntityName) {
    ...
    public DeleteschemabynamePathParams withSchemaName(String schemaName) {
