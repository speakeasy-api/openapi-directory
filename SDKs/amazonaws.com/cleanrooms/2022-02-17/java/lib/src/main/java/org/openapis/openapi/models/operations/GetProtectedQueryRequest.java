...
public class GetProtectedQueryRequest {
    ...
    public GetProtectedQueryRequest(@JsonProperty("membershipIdentifier") String membershipIdentifier, @JsonProperty("protectedQueryIdentifier") String protectedQueryIdentifier) {
        this.membershipIdentifier = membershipIdentifier;
        this.protectedQueryIdentifier = protectedQueryIdentifier;
  }
}
