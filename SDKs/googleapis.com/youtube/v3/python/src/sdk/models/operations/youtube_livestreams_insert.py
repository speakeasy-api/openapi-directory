...
class YoutubeLiveStreamsInsertSecurity:
    option1: Optional[YoutubeLiveStreamsInsertSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubeLiveStreamsInsertSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class YoutubeLiveStreamsInsertRequest:
    query_params: YoutubeLiveStreamsInsertQueryParams = dataclasses.field()
    security: YoutubeLiveStreamsInsertSecurity = dataclasses.field()
