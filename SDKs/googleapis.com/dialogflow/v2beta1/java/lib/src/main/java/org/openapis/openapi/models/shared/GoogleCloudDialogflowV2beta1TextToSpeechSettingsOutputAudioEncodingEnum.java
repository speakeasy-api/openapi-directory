 ...
 */
public enum GoogleCloudDialogflowV2beta1TextToSpeechSettingsOutputAudioEncodingEnum {
    ...
    private GoogleCloudDialogflowV2beta1TextToSpeechSettingsOutputAudioEncodingEnum(String value) {
        this.value = value;
    }
}
