...
type Adexchangebuyer2AccountsPublisherProfilesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type Adexchangebuyer2AccountsPublisherProfilesListPathParams struct {
	// Account ID of the buyer.
	AccountID string `pathParam:"style=simple,explode=false,name=accountId"`
}

type Adexchangebuyer2AccountsPublisherProfilesListQueryParams struct {
	// V1 error format.
...
type Adexchangebuyer2AccountsPublisherProfilesListRequest struct {
...
type Adexchangebuyer2AccountsPublisherProfilesListResponse struct {
	ContentType string
	// Successful response
