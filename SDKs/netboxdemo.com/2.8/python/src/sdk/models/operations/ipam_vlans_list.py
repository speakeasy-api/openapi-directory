...
class IpamVlansListQueryParams:
    ...
    vid_gt: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'vid__gt', 'style': 'form', 'explode': True }})
    vid_gte: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'vid__gte', 'style': 'form', 'explode': True }})
    vid_lt: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'vid__lt', 'style': 'form', 'explode': True }})
    vid_lte: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'vid__lte', 'style': 'form', 'explode': True }})
    vid_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'vid__n', 'style': 'form', 'explode': True }})
...
class IpamVlansList200ApplicationJSON:
    ...
    results: list[shared_vlan.Vlan] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class IpamVlansListRequest:
    query_params: IpamVlansListQueryParams = dataclasses.field()
...
class IpamVlansListResponse:
    ...
    ipam_vlans_list_200_application_json_object: Optional[IpamVlansList200ApplicationJSON] = dataclasses.field(default=None)
