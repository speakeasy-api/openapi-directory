...
class ApIs:
    ...
    def rpcer(self, request: operations.RpcerRequest) -> operations.RpcerResponse:
        r"""Pharmacist Renewal certificate
        API to verify Pharmacist Renewal certificate.
        """
        
        base_url = self._server_url
        
        url = base_url.removesuffix("/") + "/rpcer/certificate"
        ...
        res = operations.RpcerResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            pass
        elif r.status_code == 400:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Rpcer400ApplicationJSON])
                res.rpcer_400_application_json_object = out
        elif r.status_code == 401:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Rpcer401ApplicationJSON])
                res.rpcer_401_application_json_object = out
        elif r.status_code == 404:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Rpcer404ApplicationJSON])
                res.rpcer_404_application_json_object = out
        elif r.status_code == 500:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Rpcer500ApplicationJSON])
                res.rpcer_500_application_json_object = out
        elif r.status_code == 502:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Rpcer502ApplicationJSON])
                res.rpcer_502_application_json_object = out
        elif r.status_code == 503:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Rpcer503ApplicationJSON])
                res.rpcer_503_application_json_object = out
        elif r.status_code == 504:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Rpcer504ApplicationJSON])
                res.rpcer_504_application_json_object = out
