...
class ListIncomingTypedLinksRequestBody:
    ...
    object_reference: ListIncomingTypedLinksRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ObjectReference') }})
    r"""The reference that identifies an object."""  
    consistency_level: Optional[ListIncomingTypedLinksRequestBodyConsistencyLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ConsistencyLevel'), 'exclude': lambda f: f is None }})
    r"""The consistency level to execute the request at."""  
    ...
    filter_typed_link: Optional[ListIncomingTypedLinksRequestBodyFilterTypedLink] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FilterTypedLink'), 'exclude': lambda f: f is None }})
    r"""Identifies the schema Amazon Resource Name (ARN) and facet name for the typed link."""  
...
class ListIncomingTypedLinksRequest:
    ...
    request_body: ListIncomingTypedLinksRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
