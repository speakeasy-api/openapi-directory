...
class TimeSlicedTcbNetMetricsForEvergreenTypeEnum(str, Enum):
    REGULAR = "Regular"
    DISCOUNT = "Discount"
...
class TimeSlicedTcbNetMetricsForEvergreen:
    ...
    type: Optional[TimeSlicedTcbNetMetricsForEvergreenTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
