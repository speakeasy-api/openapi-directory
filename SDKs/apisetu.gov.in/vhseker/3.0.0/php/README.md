...
use \OpenAPI\OpenAPI\Models\Operations\VochseRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\VochseRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\VochseRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\VochseSecurity;
...
try {
    ...
    $request->certificateParameters = new VochseRequestBodyCertificateParameters();
    $request->certificateParameters->dob = '31-12-1980';
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->regno = '123456';
    $request->certificateParameters->year = '2020';
    $request->certificateParameters->type = 'MARCH,SAY';
    ...
    $request->format = VochseRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new VochseSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->vochse($request, $requestSecurity);
...
* [vochse](docs/apis/README.md#vochse) - Vocational Higher Secondary
