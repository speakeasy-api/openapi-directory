...
class GlobalRules 
{
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/rules/{rule}', \OpenAPI\OpenAPI\Models\Operations\DeleteGlobalRuleRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/rules/{rule}', \OpenAPI\OpenAPI\Models\Operations\GetGlobalRuleConfigRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/rules/{rule}', \OpenAPI\OpenAPI\Models\Operations\UpdateGlobalRuleConfigRequest::class, $request);
