...
class TeamRepository:
    r"""A team's access to a repository."""
    ...
    permissions: Optional[TeamRepositoryPermissions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('permissions'), 'exclude': lambda f: f is None }})  
