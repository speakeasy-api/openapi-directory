...
class ConversationsV1ConversationConversationMessageConversationMessageReceipt:
    ...
    status: Optional[shared_conversation_message_receipt_enum_delivery_status_enum.ConversationMessageReceiptEnumDeliveryStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
