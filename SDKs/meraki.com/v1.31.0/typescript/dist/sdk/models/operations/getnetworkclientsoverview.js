...
exports.GetNetworkClientsOverviewResponse = exports.GetNetworkClientsOverviewRequest = void 0;
...
var GetNetworkClientsOverviewRequest = /** @class */ (function (_super) {
    ...
    ], GetNetworkClientsOverviewRequest.prototype, "networkId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=resolution",
        }),
        __metadata("design:type", Number)
    ], GetNetworkClientsOverviewRequest.prototype, "resolution", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t0" }),
        __metadata("design:type", String)
    ], GetNetworkClientsOverviewRequest.prototype, "t0", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t1" }),
        __metadata("design:type", String)
    ], GetNetworkClientsOverviewRequest.prototype, "t1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timespan",
        }),
        __metadata("design:type", Number)
    ], GetNetworkClientsOverviewRequest.prototype, "timespan", void 0);
...
var GetNetworkClientsOverviewResponse = /** @class */ (function (_super) {
    ...
    ], GetNetworkClientsOverviewResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
