...
class Message 
{
     ...
     * @param \OpenAPI\OpenAPI\Models\Operations\GetMessagesSecurity $security
	...
	public function getMessages(
        ...
        \OpenAPI\OpenAPI\Models\Operations\GetMessagesSecurity $security,
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetMessagesSendRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\GetMessagesSendSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\GetMessagesSendResponse
     */
	public function getMessagesSend(
        \OpenAPI\OpenAPI\Models\Operations\GetMessagesSendRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\GetMessagesSendSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\GetMessagesSendResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/messages/send');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\GetMessagesSendRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetMessagesSendResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetMessagesIdRelatedReceivedMessagesRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\GetMessagesIdRelatedReceivedMessagesSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\GetMessagesIdRelatedReceivedMessagesResponse
     */
	public function getMessagesIdRelatedReceivedMessages(
        \OpenAPI\OpenAPI\Models\Operations\GetMessagesIdRelatedReceivedMessagesRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\GetMessagesIdRelatedReceivedMessagesSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\GetMessagesIdRelatedReceivedMessagesResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/messages/{id}/relatedReceivedMessages', \OpenAPI\OpenAPI\Models\Operations\GetMessagesIdRelatedReceivedMessagesRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetMessagesIdRelatedReceivedMessagesResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\PostMessagesRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\PostMessagesSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\PostMessagesResponse
     */
	public function postMessages(
        \OpenAPI\OpenAPI\Models\Operations\PostMessagesRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\PostMessagesSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\PostMessagesResponse
    {
        ...
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\PostMessagesRequest::class, $request, null));
