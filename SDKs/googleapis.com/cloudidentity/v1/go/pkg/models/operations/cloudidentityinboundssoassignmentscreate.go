...
type CloudidentityInboundSsoAssignmentsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudidentityInboundSsoAssignmentsCreateQueryParams struct {
	// V1 error format.
...
type CloudidentityInboundSsoAssignmentsCreateResponse struct {
	ContentType string
	// Successful response
