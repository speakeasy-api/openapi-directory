...
class AnalyticsManagementProfileFilterLinksPatchRequest:
    path_params: AnalyticsManagementProfileFilterLinksPatchPathParams = dataclasses.field()
    query_params: AnalyticsManagementProfileFilterLinksPatchQueryParams = dataclasses.field()
    security: AnalyticsManagementProfileFilterLinksPatchSecurity = dataclasses.field()
