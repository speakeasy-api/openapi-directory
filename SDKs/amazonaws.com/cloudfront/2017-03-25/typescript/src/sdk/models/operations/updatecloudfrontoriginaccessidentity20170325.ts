 ...
 */
export class UpdateCloudFrontOriginAccessIdentity20170325RequestBodyCloudFrontOriginAccessIdentityConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateCloudFrontOriginAccessIdentity20170325RequestBody extends SpeakeasyBase {
  /**
   * Origin access identity configuration. Send a <code>GET</code> request to the <code>/<i>CloudFront API version</i>/CloudFront/identity ID/config</code> resource.
   */
  @SpeakeasyMetadata()
...
export class UpdateCloudFrontOriginAccessIdentity20170325Request extends SpeakeasyBase {
  /**
   * The identity's id.
   */
...
export class UpdateCloudFrontOriginAccessIdentity20170325Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
