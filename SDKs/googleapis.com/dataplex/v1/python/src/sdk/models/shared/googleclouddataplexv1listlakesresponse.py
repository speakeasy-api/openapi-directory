...
class GoogleCloudDataplexV1ListLakesResponse:
    ...
    lakes: Optional[list[shared_googleclouddataplexv1lake.GoogleCloudDataplexV1Lake]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lakes'), 'exclude': lambda f: f is None }})
    r"""Lakes under the given parent location."""  
