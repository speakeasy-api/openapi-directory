...
export class CommitStatuses {
  ...
  getRepositoriesWorkspaceRepoSlugCommitCommitStatuses(
    ...
    security: operations.GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesSecurity(
          security
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesResponse =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesResponse(
          {
  ...
  getRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKey(
    ...
    security: operations.GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeySecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeyRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeySecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeyResponse =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeyResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.commitstatus = utils.objectToClass(httpRes?.data);
          }
          break;
        case httpRes?.status == 401:
          break;
  ...
  postRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuild(
    ...
    security: operations.PostRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.PostRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildResponse =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  putRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKey(
    ...
    security: operations.PutRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeySecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.PutRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.PutRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeyRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.PutRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeySecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PutRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeyResponse =
        new operations.PutRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeyResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
