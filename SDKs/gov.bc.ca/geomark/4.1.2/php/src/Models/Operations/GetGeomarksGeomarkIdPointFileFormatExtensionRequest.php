...
class GetGeomarksGeomarkIdPointFileFormatExtensionRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\GetGeomarksGeomarkIdPointFileFormatExtensionFileFormatExtensionEnum $fileFormatExtension
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetGeomarksGeomarkIdPointFileFormatExtensionSridEnum $srid
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=srid')]
    public ?GetGeomarksGeomarkIdPointFileFormatExtensionSridEnum $srid = null;
    
	public function __construct()
	{
		$this->fileFormatExtension = \OpenAPI\OpenAPI\Models\Operations\GetGeomarksGeomarkIdPointFileFormatExtensionFileFormatExtensionEnum::JSON;
		$this->geomarkId = "";
		$this->srid = null;
	}
}
