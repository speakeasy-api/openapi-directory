...
public class PostTruckOptimalDirectionsOutputFormatRequest {
    ...
    public PostTruckOptimalDirectionsOutputFormatRequest withCorrectSide(Boolean correctSide) {
    ...
    public PostTruckOptimalDirectionsOutputFormatRequest withCriteria(PostTruckOptimalDirectionsOutputFormatCriteriaEnum criteria) {
    ...
    public PostTruckOptimalDirectionsOutputFormatRequest withDeparture(OffsetDateTime departure) {
    ...
    public PostTruckOptimalDirectionsOutputFormatRequest withDisable(String disable) {
    ...
    public PostTruckOptimalDirectionsOutputFormatRequest withDistanceUnit(PostTruckOptimalDirectionsOutputFormatDistanceUnitEnum distanceUnit) {
    ...
    public PostTruckOptimalDirectionsOutputFormatRequest withOutputFormat(PostTruckOptimalDirectionsOutputFormatOutputFormatEnum outputFormat) {
    ...
    public PostTruckOptimalDirectionsOutputFormatRequest withOutputSRS(PostTruckOptimalDirectionsOutputFormatOutputSrsEnum outputSRS) {
    ...
    public PostTruckOptimalDirectionsOutputFormatRequest withPartition(String partition) {
    ...
    public PostTruckOptimalDirectionsOutputFormatRequest withPoints(String points) {
        this.points = points;
        return this;
    }
    ...
    public PostTruckOptimalDirectionsOutputFormatRequest withRoundTrip(Boolean roundTrip) {
    ...
    public PostTruckOptimalDirectionsOutputFormatRequest withRouteDescription(String routeDescription) {
    ...
    public PostTruckOptimalDirectionsOutputFormatRequest withTruckRouteMultiplier(Long truckRouteMultiplier) {
        this.truckRouteMultiplier = truckRouteMultiplier;
        return this;
    }
    
    public PostTruckOptimalDirectionsOutputFormatRequest(@JsonProperty("outputFormat") PostTruckOptimalDirectionsOutputFormatOutputFormatEnum outputFormat, @JsonProperty("points") String points) {
        this.outputFormat = outputFormat;
        this.points = points;
  }
}
