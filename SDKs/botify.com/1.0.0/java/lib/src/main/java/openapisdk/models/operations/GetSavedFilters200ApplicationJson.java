...
public class GetSavedFilters200ApplicationJson {
    ...
    public openapisdk.models.shared.ProjectSavedFilter[] results;
    public GetSavedFilters200ApplicationJson withResults(openapisdk.models.shared.ProjectSavedFilter[] results) {
