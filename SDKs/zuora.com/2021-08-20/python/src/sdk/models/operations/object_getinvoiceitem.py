...
from ..shared import proxygetinvoiceitem as shared_proxygetinvoiceitem
...
class ObjectGETInvoiceItemResponse:
    ...
    proxy_get_invoice_item: Optional[shared_proxygetinvoiceitem.ProxyGetInvoiceItem] = dataclasses.field(default=None)  
