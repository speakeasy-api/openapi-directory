...
from ..shared import freddiereporttype_enum as shared_freddiereporttype_enum
...
class AssetReportCreateRequest:
    ...
    access_tokens: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('access_tokens') }})
    ...
    report_type: Optional[shared_freddiereporttype_enum.FreddieReportTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('report_type'), 'exclude': lambda f: f is None }})
