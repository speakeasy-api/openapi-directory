...
public class OBWriteDomesticConsentResponse5DataInitiationRemittanceInformation {
    ...
    public OBWriteDomesticConsentResponse5DataInitiationRemittanceInformation withReference(String reference) {
    ...
    public OBWriteDomesticConsentResponse5DataInitiationRemittanceInformation withUnstructured(String unstructured) {
        this.unstructured = unstructured;
        return this;
    }
    
    public OBWriteDomesticConsentResponse5DataInitiationRemittanceInformation(){}
}
