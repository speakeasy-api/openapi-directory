...
export class GetSubstanceParticipantInAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetSubstanceParticipantInAssociationsQueryParams extends SpeakeasyBase {
...
export class GetSubstanceParticipantInAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetSubstanceParticipantInAssociationsResponse extends SpeakeasyBase {
