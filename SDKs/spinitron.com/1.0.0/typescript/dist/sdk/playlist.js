...
var Playlist = /** @class */ (function () {
    function Playlist(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    Playlist.prototype.getPlaylists = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getPlaylists200ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
     ...
     *
    **/
    Playlist.prototype.getPlaylistsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
