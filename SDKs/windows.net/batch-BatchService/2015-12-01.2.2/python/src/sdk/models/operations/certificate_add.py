...
from ..shared import certificateaddparameter as shared_certificateaddparameter
...
class CertificateAddRequest:
    ...
    certificate_add_parameter: shared_certificateaddparameter.CertificateAddParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Specifies the certificate to be added."""  
