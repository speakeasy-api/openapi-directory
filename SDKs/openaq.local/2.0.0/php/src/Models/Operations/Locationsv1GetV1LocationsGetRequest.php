...
class Locationsv1GetV1LocationsGetRequest
{
     ...
     * Order by a field
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\Locationsv1GetV1LocationsGetOrderByLocationsOrderEnum $orderBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=order_by')]
    public ?Locationsv1GetV1LocationsGetOrderByLocationsOrderEnum $orderBy = null;
     ...
     * Sort Direction
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\Locationsv1GetV1LocationsGetSortSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?Locationsv1GetV1LocationsGetSortSortEnum $sort = null;
