...
class DescribeFileCachesRequest:
    ...
    file_cache_ids: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FileCacheIds'), 'exclude': lambda f: f is None }})  
