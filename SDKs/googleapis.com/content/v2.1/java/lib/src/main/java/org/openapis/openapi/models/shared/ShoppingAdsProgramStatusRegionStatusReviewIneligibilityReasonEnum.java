 ...
 */
public enum ShoppingAdsProgramStatusRegionStatusReviewIneligibilityReasonEnum {
    ...
    private ShoppingAdsProgramStatusRegionStatusReviewIneligibilityReasonEnum(String value) {
        this.value = value;
    }
}
