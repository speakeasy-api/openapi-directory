...
type IssueStateReasonEnum string

const (
	IssueStateReasonEnumCompleted  IssueStateReasonEnum = "completed"
	IssueStateReasonEnumReopened   IssueStateReasonEnum = "reopened"
	IssueStateReasonEnumNotPlanned IssueStateReasonEnum = "not_planned"
)

func (e IssueStateReasonEnum) ToPointer() *IssueStateReasonEnum {
	return &e
}

func (e *IssueStateReasonEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "reopened":
		fallthrough
	case "not_planned":
		*e = IssueStateReasonEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for IssueStateReasonEnum: %v", v)
	}
}
...
type Issue struct {
	...
	StateReason *IssueStateReasonEnum `json:"state_reason,omitempty"`
