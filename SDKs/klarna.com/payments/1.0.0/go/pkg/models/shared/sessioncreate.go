...
type SessionCreateAcquiringChannelEnum string

const (
	SessionCreateAcquiringChannelEnumEcommerce SessionCreateAcquiringChannelEnum = "ECOMMERCE"
	SessionCreateAcquiringChannelEnumInStore   SessionCreateAcquiringChannelEnum = "IN_STORE"
...
type SessionCreateIntentEnum string

const (
	SessionCreateIntentEnumBuy            SessionCreateIntentEnum = "buy"
...
// SessionCreateInput - session_request
type SessionCreateInput struct {
	...
	AcquiringChannel *SessionCreateAcquiringChannelEnum `json:"acquiring_channel,omitempty"`
	...
	Intent *SessionCreateIntentEnum `json:"intent,omitempty"`
