...
class MonitoringProjectsNotificationChannelsVerifyRequest:
    ...
    r"""Required. The notification channel to verify."""  
    ...
    verify_notification_channel_request: Optional[shared_verifynotificationchannelrequest.VerifyNotificationChannelRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
