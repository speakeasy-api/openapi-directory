...
exports.CalendarAclPatchResponse = exports.CalendarAclPatchRequest = exports.CalendarAclPatchSecurity = void 0;
...
var CalendarAclPatchRequest = /** @class */ (function (_super) {
    ...
    ], CalendarAclPatchRequest.prototype, "aclRule", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], CalendarAclPatchRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=calendarId",
        }),
        __metadata("design:type", String)
    ], CalendarAclPatchRequest.prototype, "calendarId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], CalendarAclPatchRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], CalendarAclPatchRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], CalendarAclPatchRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], CalendarAclPatchRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], CalendarAclPatchRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ruleId",
        }),
        __metadata("design:type", String)
    ], CalendarAclPatchRequest.prototype, "ruleId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sendNotifications",
        }),
        __metadata("design:type", Boolean)
    ], CalendarAclPatchRequest.prototype, "sendNotifications", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], CalendarAclPatchRequest.prototype, "userIp", void 0);
...
var CalendarAclPatchResponse = /** @class */ (function (_super) {
    ...
    ], CalendarAclPatchResponse.prototype, "rawResponse", void 0);
