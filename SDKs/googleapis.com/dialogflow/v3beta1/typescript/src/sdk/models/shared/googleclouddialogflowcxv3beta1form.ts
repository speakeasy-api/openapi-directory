...
} from "./googleclouddialogflowcxv3beta1formparameter";
...
export class GoogleCloudDialogflowCxV3beta1Form extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudDialogflowCxV3beta1FormParameter })
...
export class GoogleCloudDialogflowCxV3beta1FormInput extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    elemType: GoogleCloudDialogflowCxV3beta1FormParameterInput,
  })
  @Expose({ name: "parameters" })
