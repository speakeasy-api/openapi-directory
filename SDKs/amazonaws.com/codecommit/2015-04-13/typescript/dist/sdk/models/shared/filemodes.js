...
**/
var FileModes = /** @class */ (function (_super) {
    __extends(FileModes, _super);
    function FileModes() {
    ...
    ], FileModes.prototype, "base", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=destination" }),
        __metadata("design:type", String)
    ], FileModes.prototype, "destination", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=source" }),
        __metadata("design:type", String)
    ], FileModes.prototype, "source", void 0);
    return FileModes;
