...
class SSHPublicKey:
    ...
    date_imported: datetime = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('DateImported'), 'encoder': utils.datetimeisoformat(False), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso') }})
