...
class CreateVpnGatewayRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateVpnGatewayRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
class CreateVpnGatewayRequestTagSpecifications:
    ...
    resource_type: Optional[CreateVpnGatewayRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateVpnGatewayRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateVpnGatewayRequest:
    r"""Contains the parameters for CreateVpnGateway."""
    
    type: shared_gatewaytype_enum.GatewayTypeEnum = dataclasses.field()  
    ...
    tag_specifications: Optional[list[CreateVpnGatewayRequestTagSpecifications]] = dataclasses.field(default=None)  
