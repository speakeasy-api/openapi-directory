...
class ListSecretVersionIdsRequest:
    ...
    list_secret_version_ids_request: shared_listsecretversionidsrequest.ListSecretVersionIdsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
