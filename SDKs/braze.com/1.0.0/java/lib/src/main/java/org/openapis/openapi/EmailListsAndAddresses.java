...
public class EmailListsAndAddresses {
    ...
    public org.openapis.openapi.models.operations.QueryHardBouncedEmailsResponse queryHardBouncedEmails(org.openapis.openapi.models.operations.QueryHardBouncedEmailsRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.QueryHardBouncedEmailsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.QueryListOfUnsubscribedEmailAddressesResponse queryListOfUnsubscribedEmailAddresses(org.openapis.openapi.models.operations.QueryListOfUnsubscribedEmailAddressesRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.QueryListOfUnsubscribedEmailAddressesQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
