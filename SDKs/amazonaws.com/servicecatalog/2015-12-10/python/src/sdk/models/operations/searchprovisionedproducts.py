...
class SearchProvisionedProductsRequest:
    ...
    search_provisioned_products_input: shared_searchprovisionedproductsinput.SearchProvisionedProductsInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
