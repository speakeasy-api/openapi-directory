...
public class ModifyDBInstanceMessage {
    ...
    public ModifyDBInstanceMessage withAutomationMode(AutomationModeEnum automationMode) {
    ...
    public ModifyDBInstanceMessage withAwsBackupRecoveryPointArn(String awsBackupRecoveryPointArn) {
    ...
    public ModifyDBInstanceMessage withCertificateRotationRestart(Boolean certificateRotationRestart) {
    ...
    public ModifyDBInstanceMessage withEnableCustomerOwnedIp(Boolean enableCustomerOwnedIp) {
    ...
    public ModifyDBInstanceMessage withManageMasterUserPassword(Boolean manageMasterUserPassword) {
    ...
    public ModifyDBInstanceMessage withMasterUserSecretKmsKeyId(String masterUserSecretKmsKeyId) {
    ...
    public ModifyDBInstanceMessage withMaxAllocatedStorage(Long maxAllocatedStorage) {
    ...
    public ModifyDBInstanceMessage withNetworkType(String networkType) {
    ...
    public ModifyDBInstanceMessage withPerformanceInsightsRetentionPeriod(Long performanceInsightsRetentionPeriod) {
    ...
    public ModifyDBInstanceMessage withProcessorFeatures(ProcessorFeatureList[] processorFeatures) {
    ...
    public ModifyDBInstanceMessage withReplicaMode(ReplicaModeEnum replicaMode) {
        this.replicaMode = replicaMode;
        return this;
    }
    
    
    public Long resumeFullAutomationModeMinutes;
    public ModifyDBInstanceMessage withResumeFullAutomationModeMinutes(Long resumeFullAutomationModeMinutes) {
    ...
    public ModifyDBInstanceMessage withRotateMasterUserPassword(Boolean rotateMasterUserPassword) {
    ...
    public ModifyDBInstanceMessage withStorageThroughput(Long storageThroughput) {
    ...
    public ModifyDBInstanceMessage withUseDefaultProcessorFeatures(Boolean useDefaultProcessorFeatures) {
