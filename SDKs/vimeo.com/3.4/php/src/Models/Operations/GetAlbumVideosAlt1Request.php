...
class GetAlbumVideosAlt1Request
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetAlbumVideosAlt1DirectionEnum $direction
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=direction')]
    public ?GetAlbumVideosAlt1DirectionEnum $direction = null;
    
    /**
     * The attribute by which to filter the results.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetAlbumVideosAlt1FilterEnum $filter
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=filter')]
    public ?GetAlbumVideosAlt1FilterEnum $filter = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetAlbumVideosAlt1SortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?GetAlbumVideosAlt1SortEnum $sort = null;
