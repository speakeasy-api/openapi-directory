...
from ..shared import proxycreateproduct as shared_proxycreateproduct
...
class ObjectPOSTProductRequest:
    ...
    proxy_create_product: shared_proxycreateproduct.ProxyCreateProduct = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
