...
type DirectoryCustomersPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DirectoryCustomersPatchPathParams struct {
	// Id of the customer to be updated
	CustomerKey string `pathParam:"style=simple,explode=false,name=customerKey"`
}

type DirectoryCustomersPatchQueryParams struct {
	// V1 error format.
...
type DirectoryCustomersPatchRequest struct {
...
type DirectoryCustomersPatchResponse struct {
	ContentType string
	// Successful response
