...
class APIV2010AccountUsageUsageRecordUsageRecordThisMonth:
    ...
    category: Optional[shared_usage_record_this_month_enum_category_enum.UsageRecordThisMonthEnumCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category'), 'exclude': lambda f: f is None }})  
