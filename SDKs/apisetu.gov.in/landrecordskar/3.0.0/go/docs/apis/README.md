...
func main() {
    ...
    res, err := s.APIs.Cncer(ctx, operations.CncerRequestBody{
        ...
        Format: operations.CncerRequestBodyFormatEnumXML,
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Mutan(ctx, operations.MutanRequestBody{
        CertificateParameters: &operations.MutanRequestBodyCertificateParameters{
        ...
        Format: operations.MutanRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.MutanSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
