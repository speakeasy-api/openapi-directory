...
export class AndroiddeviceprovisioningCustomersConfigurationsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AndroiddeviceprovisioningCustomersConfigurationsPatchResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
