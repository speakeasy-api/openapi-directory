...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateNetworkSyslogServers200ApplicationJSONServers:
...
class UpdateNetworkSyslogServers200ApplicationJSON:
    ...
    servers: Optional[list[UpdateNetworkSyslogServers200ApplicationJSONServers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('servers'), 'exclude': lambda f: f is None }})
...
class UpdateNetworkSyslogServersResponse:
    ...
    update_network_syslog_servers_200_application_json_object: Optional[UpdateNetworkSyslogServers200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
