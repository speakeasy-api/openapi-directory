...
class OrganizationExportResponse:
    ...
    *Note: May be null if the export is still in progress or
    ...
    state: Optional[OrganizationExportResponseStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
    r"""The current state of the export."""  
