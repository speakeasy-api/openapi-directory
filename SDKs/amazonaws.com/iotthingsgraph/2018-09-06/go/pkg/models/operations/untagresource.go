...
const (
	UntagResourceXAmzTargetEnumIotThingsGraphFrontEndServiceUntagResource UntagResourceXAmzTargetEnum = "IotThingsGraphFrontEndService.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "IotThingsGraphFrontEndService.UntagResource":
