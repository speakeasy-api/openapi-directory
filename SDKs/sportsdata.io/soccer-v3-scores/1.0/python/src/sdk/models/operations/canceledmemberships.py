...
from ..shared import canceledmembership as shared_canceledmembership
...
class CanceledMembershipsResponse:
    ...
    canceled_membership: Optional[shared_canceledmembership.CanceledMembership] = dataclasses.field(default=None)  
