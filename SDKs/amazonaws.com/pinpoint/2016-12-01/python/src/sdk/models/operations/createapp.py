...
class CreateAppRequestBody:
    create_application_request: CreateAppRequestBodyCreateApplicationRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('CreateApplicationRequest') }})
