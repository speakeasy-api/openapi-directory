...
exports.ScheduleActivityTaskFailedEventAttributes = void 0;
var utils_1 = require("../../../internal/utils");
var activitytype_1 = require("./activitytype");
var scheduleactivitytaskfailedcauseenum_1 = require("./scheduleactivitytaskfailedcauseenum");
// ScheduleActivityTaskFailedEventAttributes
/**
 * Provides the details of the <code>ScheduleActivityTaskFailed</code> event.
**/
var ScheduleActivityTaskFailedEventAttributes = /** @class */ (function (_super) {
    __extends(ScheduleActivityTaskFailedEventAttributes, _super);
    ...
    ], ScheduleActivityTaskFailedEventAttributes.prototype, "activityId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=activityType" }),
        __metadata("design:type", activitytype_1.ActivityType)
    ], ScheduleActivityTaskFailedEventAttributes.prototype, "activityType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cause" }),
        __metadata("design:type", String)
    ], ScheduleActivityTaskFailedEventAttributes.prototype, "cause", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=decisionTaskCompletedEventId" }),
        __metadata("design:type", Number)
    ], ScheduleActivityTaskFailedEventAttributes.prototype, "decisionTaskCompletedEventId", void 0);
