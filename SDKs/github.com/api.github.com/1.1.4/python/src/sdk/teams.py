...
class Teams:
    ...
    def teams_add_member_legacy(self, request: operations.TeamsAddMemberLegacyRequest) -> operations.TeamsAddMemberLegacyResponse:
        ...
        **Note:** When you have team synchronization set up for a team with your organization's identity provider (IdP), you will see an error if you attempt to use the API for making changes to the team's membership. If you have access to manage group membership in your IdP, you can manage GitHub team membership through your identity provider, which automatically adds and removes team members in an organization. For more information, see \"[Synchronizing teams between your identity provider and GitHub](https://help.github.com/articles/synchronizing-teams-between-your-identity-provider-and-github/).\"
        ...
        if r.status_code == 204:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.TeamsAddMemberLegacy422ApplicationJSON])
                res.teams_add_member_legacy_422_application_json_object = out
    ...
    def teams_add_or_update_membership_for_user_in_org(self, request: operations.TeamsAddOrUpdateMembershipForUserInOrgRequest) -> operations.TeamsAddOrUpdateMembershipForUserInOrgResponse:
        ...
        **Note:** You can also specify a team by `org_id` and `team_id` using the route `PUT /organizations/{org_id}/team/{team_id}/memberships/{username}`.
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.TeamsAddOrUpdateMembershipForUserInOrg422ApplicationJSON])
                res.teams_add_or_update_membership_for_user_in_org_422_application_json_object = out
    ...
    def teams_add_or_update_membership_for_user_legacy(self, request: operations.TeamsAddOrUpdateMembershipForUserLegacyRequest) -> operations.TeamsAddOrUpdateMembershipForUserLegacyResponse:
        ...
        **Note:** When you have team synchronization set up for a team with your organization's identity provider (IdP), you will see an error if you attempt to use the API for making changes to the team's membership. If you have access to manage group membership in your IdP, you can manage GitHub team membership through your identity provider, which automatically adds and removes team members in an organization. For more information, see \"[Synchronizing teams between your identity provider and GitHub](https://help.github.com/articles/synchronizing-teams-between-your-identity-provider-and-github/).\"
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.TeamsAddOrUpdateMembershipForUserLegacy422ApplicationJSON])
                res.teams_add_or_update_membership_for_user_legacy_422_application_json_object = out
    ...
    def teams_create_or_update_idp_group_connections_in_org(self, request: operations.TeamsCreateOrUpdateIdpGroupConnectionsInOrgRequest) -> operations.TeamsCreateOrUpdateIdpGroupConnectionsInOrgResponse:
        ...
        **Note:** You can also specify a team by `org_id` and `team_id` using the route `PATCH /organizations/{org_id}/team/{team_id}/team-sync/group-mappings`.
        ...
        url = utils.generate_url(base_url, "/orgs/{org}/teams/{team_slug}/team-sync/group-mappings", request.path_params)
        ...
        res = operations.TeamsCreateOrUpdateIdpGroupConnectionsInOrgResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GroupMapping])
    ...
    def teams_create_or_update_idp_group_connections_legacy(self, request: operations.TeamsCreateOrUpdateIdpGroupConnectionsLegacyRequest) -> operations.TeamsCreateOrUpdateIdpGroupConnectionsLegacyResponse:
        ...
        **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Create or update IdP group connections`](https://docs.github.com/rest/reference/teams#create-or-update-idp-group-connections) endpoint.
        ...
        url = utils.generate_url(base_url, "/teams/{team_id}/team-sync/group-mappings", request.path_params)
        ...
        res = operations.TeamsCreateOrUpdateIdpGroupConnectionsLegacyResponse(status_code=r.status_code, content_type=content_type)
    ...
    def teams_list_idp_groups_for_legacy(self, request: operations.TeamsListIdpGroupsForLegacyRequest) -> operations.TeamsListIdpGroupsForLegacyResponse:
        ...
        **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List IdP groups for a team`](https://docs.github.com/rest/reference/teams#list-idp-groups-for-a-team) endpoint.
        ...
        res = operations.TeamsListIdpGroupsForLegacyResponse(status_code=r.status_code, content_type=content_type)
    ...
    def teams_list_idp_groups_for_org(self, request: operations.TeamsListIdpGroupsForOrgRequest) -> operations.TeamsListIdpGroupsForOrgResponse:
        ...
        url = utils.generate_url(base_url, "/orgs/{org}/team-sync/groups", request.path_params)
        ...
        res = operations.TeamsListIdpGroupsForOrgResponse(status_code=r.status_code, content_type=content_type)
    ...
    def teams_list_idp_groups_in_org(self, request: operations.TeamsListIdpGroupsInOrgRequest) -> operations.TeamsListIdpGroupsInOrgResponse:
        ...
        **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/{org_id}/team/{team_id}/team-sync/group-mappings`.
        ...
        res = operations.TeamsListIdpGroupsInOrgResponse(status_code=r.status_code, content_type=content_type)
    ...
    def teams_list_pending_invitations_in_org(self, request: operations.TeamsListPendingInvitationsInOrgRequest) -> operations.TeamsListPendingInvitationsInOrgResponse:
        ...
        **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/{org_id}/team/{team_id}/invitations`.
        ...
        url = utils.generate_url(base_url, "/orgs/{org}/teams/{team_slug}/invitations", request.path_params)
        ...
        res = operations.TeamsListPendingInvitationsInOrgResponse(status_code=r.status_code, content_type=content_type)
    ...
    def teams_list_pending_invitations_legacy(self, request: operations.TeamsListPendingInvitationsLegacyRequest) -> operations.TeamsListPendingInvitationsLegacyResponse:
        ...
        **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List pending team invitations`](https://docs.github.com/rest/reference/teams#list-pending-team-invitations) endpoint.
        ...
        url = utils.generate_url(base_url, "/teams/{team_id}/invitations", request.path_params)
        ...
        res = operations.TeamsListPendingInvitationsLegacyResponse(status_code=r.status_code, content_type=content_type)
