 ...
 */
export enum InterconnectAttachmentsScopedListWarningCodeEnum {
...
export class InterconnectAttachmentsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InterconnectAttachmentsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: InterconnectAttachmentsScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: InterconnectAttachmentsScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => InterconnectAttachmentsScopedListWarningData)
  data?: InterconnectAttachmentsScopedListWarningData[];
...
export class InterconnectAttachmentsScopedList extends SpeakeasyBase {
  /**
   * A list of interconnect attachments contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: InterconnectAttachment })
