...
export class GetOSBrowsers {
  ...
  osBrowsers(
    ...
    security: operations.OsBrowsersSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.OsBrowsersSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.OsBrowsersResponse =
        new operations.OsBrowsersResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.osBrowsers = utils.objectToClass(
              httpRes?.data,
              shared.OsBrowsers
            );
          }
