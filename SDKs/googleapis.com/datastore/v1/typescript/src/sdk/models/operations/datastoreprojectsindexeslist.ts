...
export class DatastoreProjectsIndexesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatastoreProjectsIndexesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class DatastoreProjectsIndexesListSecurity extends SpeakeasyBase {
...
export class DatastoreProjectsIndexesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatastoreProjectsIndexesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
