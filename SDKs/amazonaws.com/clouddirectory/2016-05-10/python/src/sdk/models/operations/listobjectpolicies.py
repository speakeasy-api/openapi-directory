...
class ListObjectPoliciesRequestBody:
    ...
    object_reference: ListObjectPoliciesRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ObjectReference') }})
    r"""The reference that identifies an object."""  
...
class ListObjectPoliciesRequest:
    ...
    request_body: ListObjectPoliciesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
