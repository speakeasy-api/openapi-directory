...
from ..shared import deleteuserendpointsresponse as shared_deleteuserendpointsresponse
...
class DeleteUserEndpointsRequest:
    headers: DeleteUserEndpointsHeaders = dataclasses.field()
    path_params: DeleteUserEndpointsPathParams = dataclasses.field()
...
class DeleteUserEndpointsResponse:
    ...
    delete_user_endpoints_response: Optional[shared_deleteuserendpointsresponse.DeleteUserEndpointsResponse] = dataclasses.field(default=None)
