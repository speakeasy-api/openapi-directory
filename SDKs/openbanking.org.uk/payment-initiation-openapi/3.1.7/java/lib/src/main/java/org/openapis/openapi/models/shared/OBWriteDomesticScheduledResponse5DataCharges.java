...
public class OBWriteDomesticScheduledResponse5DataCharges {
    ...
    public OBWriteDomesticScheduledResponse5DataCharges(@JsonProperty("Amount") OBActiveOrHistoricCurrencyAndAmount amount, @JsonProperty("ChargeBearer") OBChargeBearerType1CodeEnum chargeBearer, @JsonProperty("Type") String type) {
        this.amount = amount;
        this.chargeBearer = chargeBearer;
        this.type = type;
  }
