...
export declare enum GETDeleteStackSetActionEnum {
 ...
 */
export declare enum GETDeleteStackSetCallAsEnum {
    Self = "SELF",
    DelegatedAdmin = "DELEGATED_ADMIN"
}
export declare enum GETDeleteStackSetVersionEnum {
    TwoThousandAndTen0515 = "2010-05-15"
}
export declare class GETDeleteStackSetRequest extends SpeakeasyBase {
...
export declare class GETDeleteStackSetResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
