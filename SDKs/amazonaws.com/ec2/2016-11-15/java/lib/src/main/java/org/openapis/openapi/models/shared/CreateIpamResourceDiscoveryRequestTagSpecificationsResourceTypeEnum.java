 ...
 */
public enum CreateIpamResourceDiscoveryRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateIpamResourceDiscoveryRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
