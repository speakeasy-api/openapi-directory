...
public class NHFishSouth {
    ...
    public NHFishSouthAvailabilityArray[] availabilityArray;

    public NHFishSouth withAvailabilityArray(NHFishSouthAvailabilityArray[] availabilityArray) {
    ...
    public NHFishSouth withMonths(String months) {
        this.months = months;
        return this;
    }
    ...
    public NHFishSouth withMonthsArray(Long[] monthsArray) {
    ...
    public NHFishSouthTimesByMonth timesByMonth;

    public NHFishSouth withTimesByMonth(NHFishSouthTimesByMonth timesByMonth) {
