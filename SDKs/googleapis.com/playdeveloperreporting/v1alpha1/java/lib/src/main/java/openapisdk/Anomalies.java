...
public class Anomalies {
    ...
    **/
    public openapisdk.models.operations.PlaydeveloperreportingAnomaliesListResponse playdeveloperreportingAnomaliesList(openapisdk.models.operations.PlaydeveloperreportingAnomaliesListRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1alpha1/{parent}/anomalies", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GooglePlayDeveloperReportingV1alpha1ListAnomaliesResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GooglePlayDeveloperReportingV1alpha1ListAnomaliesResponse.class);
