...
var Document = /** @class */ (function () {
    ...
    Document.prototype.getDocumentIdAspectIdCivixIndexIdCivixDocumentId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
                new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/document/id/{aspectId}/{civixIndexId}/{civixDocumentId}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdResponse({
    ...
    Document.prototype.getDocumentIdAspectIdCivixIndexIdCivixDocumentIdSearchSearchString = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
                new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdSearchSearchStringRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/document/id/{aspectId}/{civixIndexId}/{civixDocumentId}/search/{searchString}", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdSearchSearchStringResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    Document.prototype.getDocumentIdAspectIdCivixIndexIdCivixDocumentIdXml = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
                new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdXmlRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/document/id/{aspectId}/{civixIndexId}/{civixDocumentId}/xml", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdXmlResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    Document.prototype.getDocumentIdAspectIdCivixIndexIdCivixDocumentIdXmlSearchSearchString = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
                new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdXmlSearchSearchStringRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/document/id/{aspectId}/{civixIndexId}/{civixDocumentId}/xml/search/{searchString}", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetDocumentIdAspectIdCivixIndexIdCivixDocumentIdXmlSearchSearchStringResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
