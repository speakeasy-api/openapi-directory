...
class VMUtilizationMetrics:
    ...
    cpu_average: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cpuAverage'), 'exclude': lambda f: f is None }})
    ...
    r"""Average CPU usage, percent."""  
    cpu_max: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cpuMax'), 'exclude': lambda f: f is None }})
    ...
    r"""Max CPU usage, percent."""  
    disk_io_rate_average: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('diskIoRateAverage'), 'exclude': lambda f: f is None }})
    ...
    r"""Average disk IO rate, in kilobytes per second."""  
    disk_io_rate_max: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('diskIoRateMax'), 'exclude': lambda f: f is None }})
    ...
    r"""Max disk IO rate, in kilobytes per second."""  
    memory_average: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('memoryAverage'), 'exclude': lambda f: f is None }})
    ...
    r"""Average memory usage, percent."""  
    memory_max: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('memoryMax'), 'exclude': lambda f: f is None }})
    ...
    r"""Max memory usage, percent."""  
    network_throughput_average: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('networkThroughputAverage'), 'exclude': lambda f: f is None }})
    ...
    r"""Average network throughput (combined transmit-rates and receive-rates), in kilobytes per second."""  
    network_throughput_max: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('networkThroughputMax'), 'exclude': lambda f: f is None }})
