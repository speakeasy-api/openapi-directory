...
from ..shared import structureresource as shared_structureresource
...
class StructureResponseManyJSONAPI:
    r"""StructureResponseManyJSONAPI
...
@dataclass_json
@dataclasses.dataclass
class StructureResponseManyToplevelLinks:
    r"""StructureResponseManyToplevelLinks
...
@dataclass_json
@dataclasses.dataclass
class StructureResponseManyResponseMetaImplementationImplementationMaintainer:
    r"""StructureResponseManyResponseMetaImplementationImplementationMaintainer
...
@dataclass_json
@dataclasses.dataclass
class StructureResponseManyResponseMetaImplementation:
    r"""StructureResponseManyResponseMetaImplementation
    ...
    maintainer: Optional[StructureResponseManyResponseMetaImplementationImplementationMaintainer] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('maintainer') }})
...
@dataclass_json
@dataclasses.dataclass
class StructureResponseManyResponseMetaProvider:
    r"""StructureResponseManyResponseMetaProvider
...
@dataclass_json
@dataclasses.dataclass
class StructureResponseManyResponseMetaResponseMetaQuery:
    r"""StructureResponseManyResponseMetaResponseMetaQuery
...
@dataclass_json
@dataclasses.dataclass
class StructureResponseManyResponseMeta:
    r"""StructureResponseManyResponseMeta
    ...
    query: StructureResponseManyResponseMetaResponseMetaQuery = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('query') }})
    ...
    implementation: Optional[StructureResponseManyResponseMetaImplementation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('implementation') }})
    last_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('last_id') }})
    provider: Optional[StructureResponseManyResponseMetaProvider] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('provider') }})
...
class StructureResponseMany:
    r"""StructureResponseMany
    errors are not allowed
    """
    
    data: Any = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
    meta: StructureResponseManyResponseMeta = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    ...
    jsonapi: Optional[StructureResponseManyJSONAPI] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('jsonapi') }})
    links: Optional[StructureResponseManyToplevelLinks] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('links') }})
