 ...
 */
export class CreateScheduleRequestBodyFlexibleTimeWindow extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum CreateScheduleRequestBodyStateEnum {
  Enabled = "ENABLED",
  Disabled = "DISABLED",
}
 ...
 */
export class CreateScheduleRequestBodyTarget extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "Arn" })
  arn?: string;
...
export class CreateScheduleRequestBody extends SpeakeasyBase {
  /**
  ...
  @Type(() => CreateScheduleRequestBodyFlexibleTimeWindow)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "Target" })
  @Type(() => CreateScheduleRequestBodyTarget)
