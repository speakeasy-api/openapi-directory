...
public class GetProfileByVersionPathParams {
    /**
    ...
    public GetProfileByVersionPathParams withProfileId(String profileId) {
    ...
    public GetProfileByVersionPathParams withProfileVersionId(String profileVersionId) {
