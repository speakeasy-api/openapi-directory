...
class ProjectDescription:
    ...
    placement_template: Optional[shared_placementtemplate.PlacementTemplate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('placementTemplate') }})
