...
class AppengineAppsAuthorizedCertificatesGetRequest
{
     ...
     * 
     * @var string $authorizedCertificatesId
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\AppengineAppsAuthorizedCertificatesGetViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?AppengineAppsAuthorizedCertificatesGetViewEnum $view = null;
