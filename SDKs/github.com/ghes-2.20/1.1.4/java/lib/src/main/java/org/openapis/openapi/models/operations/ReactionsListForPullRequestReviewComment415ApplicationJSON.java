...
public class ReactionsListForPullRequestReviewComment415ApplicationJSON {
    ...
    public ReactionsListForPullRequestReviewComment415ApplicationJSON(@JsonProperty("documentation_url") String documentationUrl, @JsonProperty("message") String message) {
        this.documentationUrl = documentationUrl;
        this.message = message;
  }
}
