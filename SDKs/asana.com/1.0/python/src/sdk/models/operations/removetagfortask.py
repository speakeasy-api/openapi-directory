...
class RemoveTagForTaskRequestBody:
    r"""The tag to remove from the task."""
    
    data: Optional[shared_taskremovetagrequest.TaskRemoveTagRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
    

@dataclasses.dataclass
class RemoveTagForTaskRequest:
    
    request_body: RemoveTagForTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The tag to remove from the task."""  
...
class RemoveTagForTask200ApplicationJSON:
    r"""Successfully removed the specified tag from the task."""
