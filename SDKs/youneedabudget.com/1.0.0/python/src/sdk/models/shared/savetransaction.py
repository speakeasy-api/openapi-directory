...
class SaveTransaction:
    ...
    cleared: Optional[SaveTransactionClearedEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cleared'), 'exclude': lambda f: f is None }})
    r"""The cleared status of the transaction"""  
    flag_color: Optional[SaveTransactionFlagColorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flag_color'), 'exclude': lambda f: f is None }})
    r"""The transaction flag"""  
