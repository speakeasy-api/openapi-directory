 ...
 */
public class CreateNetworkWirelessRfProfile201ApplicationJSONTwoFourGhzSettings {
    /**
    ...
    public CreateNetworkWirelessRfProfile201ApplicationJSONTwoFourGhzSettings withAxEnabled(Boolean axEnabled) {
    ...
    public CreateNetworkWirelessRfProfile201ApplicationJSONTwoFourGhzSettings withMaxPower(Long maxPower) {
    ...
    public CreateNetworkWirelessRfProfile201ApplicationJSONTwoFourGhzSettings withMinBitrate(Float minBitrate) {
    ...
    public CreateNetworkWirelessRfProfile201ApplicationJSONTwoFourGhzSettings withMinPower(Long minPower) {
    ...
    @JsonProperty("rxsop")
    public Long rxsop;
    public CreateNetworkWirelessRfProfile201ApplicationJSONTwoFourGhzSettings withRxsop(Long rxsop) {
        this.rxsop = rxsop;
        return this;
    }
    ...
    public CreateNetworkWirelessRfProfile201ApplicationJSONTwoFourGhzSettings withValidAutoChannels(Long[] validAutoChannels) {
