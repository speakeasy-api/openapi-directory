...
from ..shared import getrepositoryinput as shared_getrepositoryinput
from ..shared import getrepositoryoutput as shared_getrepositoryoutput
...
class GetRepositoryHeaders:
    x_amz_target: GetRepositoryXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRepositoryRequest:
    headers: GetRepositoryHeaders = dataclasses.field()
    request: shared_getrepositoryinput.GetRepositoryInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetRepositoryResponse:
    ...
    get_repository_output: Optional[shared_getrepositoryoutput.GetRepositoryOutput] = dataclasses.field(default=None)
