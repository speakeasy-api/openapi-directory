...
exports.GetRealmClientsIdRolesResponse = exports.GetRealmClientsIdRolesRequest = void 0;
...
var GetRealmClientsIdRolesRequest = /** @class */ (function (_super) {
    ...
    ], GetRealmClientsIdRolesRequest.prototype, "briefRepresentation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=first" }),
        __metadata("design:type", Number)
    ], GetRealmClientsIdRolesRequest.prototype, "first", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], GetRealmClientsIdRolesRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=max" }),
        __metadata("design:type", Number)
    ], GetRealmClientsIdRolesRequest.prototype, "max", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=realm",
        }),
        __metadata("design:type", String)
    ], GetRealmClientsIdRolesRequest.prototype, "realm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=search",
        }),
        __metadata("design:type", String)
    ], GetRealmClientsIdRolesRequest.prototype, "search", void 0);
    return GetRealmClientsIdRolesRequest;
}(utils_1.SpeakeasyBase));
exports.GetRealmClientsIdRolesRequest = GetRealmClientsIdRolesRequest;
var GetRealmClientsIdRolesResponse = /** @class */ (function (_super) {
    ...
    ], GetRealmClientsIdRolesResponse.prototype, "rawResponse", void 0);
    return GetRealmClientsIdRolesResponse;
}(utils_1.SpeakeasyBase));
exports.GetRealmClientsIdRolesResponse = GetRealmClientsIdRolesResponse;
