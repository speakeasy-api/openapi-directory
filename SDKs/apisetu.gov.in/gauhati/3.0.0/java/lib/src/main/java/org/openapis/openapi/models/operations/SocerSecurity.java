...
public class SocerSecurity {
    ...
    public SocerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public SocerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public SocerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
