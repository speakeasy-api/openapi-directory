 ...
 */
public enum CreateVerifiedAccessTrustProviderRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateVerifiedAccessTrustProviderRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
