...
public class PostPortfolioOptimizationInverseVarianceWeightedRequestBody {
    ...
    public PostPortfolioOptimizationInverseVarianceWeightedRequestBody(@JsonProperty("assets") Long assets, @JsonProperty("assetsVariances") Double[] assetsVariances) {
        this.assets = assets;
        this.assetsVariances = assetsVariances;
  }
}
