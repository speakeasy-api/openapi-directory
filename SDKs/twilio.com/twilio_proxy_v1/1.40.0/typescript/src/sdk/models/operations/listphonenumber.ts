...
export const ListPhoneNumberServerList = ["https://proxy.twilio.com"] as const;
...
export class ListPhoneNumberListPhoneNumberResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.ProxyV1ServicePhoneNumber })
  @Expose({ name: "phone_numbers" })
  @Type(() => shared.ProxyV1ServicePhoneNumber)
