...
type DatalabelingProjectsInstructionsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DatalabelingProjectsInstructionsListPathParams struct {
	// Required. Instruction resource parent, format: projects/{project_id}
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type DatalabelingProjectsInstructionsListQueryParams struct {
	// V1 error format.
...
type DatalabelingProjectsInstructionsListRequest struct {
...
type DatalabelingProjectsInstructionsListResponse struct {
	ContentType string
	// Successful response
