...
class DriveGroupsUpdateRequest:
    headers: DriveGroupsUpdateHeaders = dataclasses.field()
    path_params: DriveGroupsUpdatePathParams = dataclasses.field()
    query_params: DriveGroupsUpdateQueryParams = dataclasses.field()
    request: shared_drivegroup.DriveGroupInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: DriveGroupsUpdateSecurity = dataclasses.field()
