...
import dataclasses
from ..shared import createtransitgatewaypeeringattachmentrequestoptions as shared_createtransitgatewaypeeringattachmentrequestoptions
from enum import Enum
from typing import Optional

class CreateTransitGatewayPeeringAttachmentRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateTransitGatewayPeeringAttachmentRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateTransitGatewayPeeringAttachmentRequestTagSpecifications:
    ...
    resource_type: Optional[CreateTransitGatewayPeeringAttachmentRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateTransitGatewayPeeringAttachmentRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateTransitGatewayPeeringAttachmentRequest:
    
    peer_account_id: str = dataclasses.field()  
    peer_region: str = dataclasses.field()  
    peer_transit_gateway_id: str = dataclasses.field()  
    transit_gateway_id: str = dataclasses.field()  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    options: Optional[shared_createtransitgatewaypeeringattachmentrequestoptions.CreateTransitGatewayPeeringAttachmentRequestOptions] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateTransitGatewayPeeringAttachmentRequestTagSpecifications]] = dataclasses.field(default=None)  
