...
export declare enum GoogleCloudPolicysimulatorV1beta1BindingExplanationAccessEnum {
...
export declare enum GoogleCloudPolicysimulatorV1beta1BindingExplanationRelevanceEnum {
    HeuristicRelevanceUnspecified = "HEURISTIC_RELEVANCE_UNSPECIFIED",
    Normal = "NORMAL",
    High = "HIGH"
}
export declare enum GoogleCloudPolicysimulatorV1beta1BindingExplanationRolePermissionEnum {
...
export declare enum GoogleCloudPolicysimulatorV1beta1BindingExplanationRolePermissionRelevanceEnum {
    HeuristicRelevanceUnspecified = "HEURISTIC_RELEVANCE_UNSPECIFIED",
    Normal = "NORMAL",
    High = "HIGH"
}
