 ...
 */
export class DescribeNetworkInsightsAnalysesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeNetworkInsightsAnalysesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
