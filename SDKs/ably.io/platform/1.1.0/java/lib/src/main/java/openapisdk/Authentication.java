...
public class Authentication {
    ...
    **/
    public openapisdk.models.operations.RequestAccessTokenResponse requestAccessToken(openapisdk.models.operations.RequestAccessTokenRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/keys/{keyName}/requestToken", request.pathParams);
        ...
        openapisdk.models.operations.RequestAccessTokenResponse res = new openapisdk.models.operations.RequestAccessTokenResponse() {{
            tokenDetails = null;
            body = null;
            body = null;
            body = null;
        ...
        if (httpRes.statusCode() >= 200 && httpRes.statusCode() < 300) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.TokenDetails out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.TokenDetails.class);
