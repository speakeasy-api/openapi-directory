...
**/
export class CreateLabelResponseBodyOptionalLink extends SpeakeasyBase {
 ...
 * 
**/
export class CreateLabelResponseBodyMonetaryValue extends SpeakeasyBase {
 ...
 * 
**/
export class CreateLabelResponseBodyLabelDownload extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=href" })
  href?: string;
 ...
 * 
**/
export class CreateLabelResponseBodyOutput extends SpeakeasyBase {
