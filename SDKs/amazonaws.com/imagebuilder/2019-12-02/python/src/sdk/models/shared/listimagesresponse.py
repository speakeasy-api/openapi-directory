...
class ListImagesResponse:
    ...
    image_version_list: Optional[list[shared_imageversion.ImageVersion]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('imageVersionList'), 'exclude': lambda f: f is None }})  
