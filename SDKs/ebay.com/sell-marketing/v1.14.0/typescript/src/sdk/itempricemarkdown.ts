...
export class ItemPriceMarkdown {
  ...
  createItemPriceMarkdownPromotion(
    req: shared.ItemPriceMarkdown,
    security: operations.CreateItemPriceMarkdownPromotionSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.CreateItemPriceMarkdownPromotionSecurity(
        security
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CreateItemPriceMarkdownPromotionResponse =
        new operations.CreateItemPriceMarkdownPromotionResponse({
  ...
  deleteItemPriceMarkdownPromotion(
    ...
    security: operations.DeleteItemPriceMarkdownPromotionSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DeleteItemPriceMarkdownPromotionSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DeleteItemPriceMarkdownPromotionResponse =
        new operations.DeleteItemPriceMarkdownPromotionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getItemPriceMarkdownPromotion(
    ...
    security: operations.GetItemPriceMarkdownPromotionSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetItemPriceMarkdownPromotionResponse =
        new operations.GetItemPriceMarkdownPromotionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.itemPriceMarkdown = utils.objectToClass(
              httpRes?.data,
              shared.ItemPriceMarkdown
            );
          }
          break;
  ...
  updateItemPriceMarkdownPromotion(
    ...
    security: operations.UpdateItemPriceMarkdownPromotionSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.UpdateItemPriceMarkdownPromotionSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UpdateItemPriceMarkdownPromotionResponse =
        new operations.UpdateItemPriceMarkdownPromotionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
