...
var BatchGetCommitsOutput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: batchgetcommitserror_1.BatchGetCommitsError }),
        (0, class_transformer_1.Expose)({ name: "errors" }),
        (0, class_transformer_1.Type)(function () { return batchgetcommitserror_1.BatchGetCommitsError; }),
        __metadata("design:type", Array)
