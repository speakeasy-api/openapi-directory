...
func (e *VoiceV1ByocTrunkStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = VoiceV1ByocTrunkStatusCallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for VoiceV1ByocTrunkStatusCallbackMethodEnum: %s", s)
	}
}
...
func (e *VoiceV1ByocTrunkVoiceFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = VoiceV1ByocTrunkVoiceFallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for VoiceV1ByocTrunkVoiceFallbackMethodEnum: %s", s)
	}
}
...
func (e *VoiceV1ByocTrunkVoiceMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = VoiceV1ByocTrunkVoiceMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for VoiceV1ByocTrunkVoiceMethodEnum: %s", s)
	}
}
