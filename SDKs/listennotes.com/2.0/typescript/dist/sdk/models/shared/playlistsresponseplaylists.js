...
exports.PlaylistsResponsePlaylists = void 0;
...
var PlaylistsResponsePlaylists = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=episode_count" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_timestamp_ms" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=podcast_count" }),
        __metadata("design:type", Number)
