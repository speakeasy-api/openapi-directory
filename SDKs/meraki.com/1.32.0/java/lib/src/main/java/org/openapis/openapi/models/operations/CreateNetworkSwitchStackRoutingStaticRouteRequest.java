...
public class CreateNetworkSwitchStackRoutingStaticRouteRequest {
    ...
    public CreateNetworkSwitchStackRoutingStaticRouteRequest(@JsonProperty("RequestBody") CreateNetworkSwitchStackRoutingStaticRouteRequestBody requestBody, @JsonProperty("networkId") String networkId, @JsonProperty("switchStackId") String switchStackId) {
        this.requestBody = requestBody;
        this.networkId = networkId;
        this.switchStackId = switchStackId;
  }
