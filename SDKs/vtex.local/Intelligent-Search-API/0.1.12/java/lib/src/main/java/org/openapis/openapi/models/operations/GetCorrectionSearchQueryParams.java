...
public class GetCorrectionSearchQueryParams {
    /**
    ...
    public GetCorrectionSearchQueryParams withLocale(String locale) {
        this.locale = locale;
        return this;
    }
    ...
    public String query;
    public GetCorrectionSearchQueryParams withQuery(String query) {
        this.query = query;
        return this;
    }
