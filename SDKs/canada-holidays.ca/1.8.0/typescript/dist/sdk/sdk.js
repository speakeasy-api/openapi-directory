 ...
 */
exports.ServerList = ["https://canada-holidays.ca"];
/**
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.provinces = new provinces_1.Provinces(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
