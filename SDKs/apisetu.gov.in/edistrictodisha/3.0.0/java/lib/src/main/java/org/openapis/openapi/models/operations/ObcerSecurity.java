...
public class ObcerSecurity {
    ...
    public ObcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public ObcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public ObcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
