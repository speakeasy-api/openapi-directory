...
class AddOrUpdateEmergencyContactsRequest:
    path_params: AddOrUpdateEmergencyContactsPathParams = dataclasses.field()
    request: shared_emergencycontact.EmergencyContact = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: AddOrUpdateEmergencyContactsSecurity = dataclasses.field()
