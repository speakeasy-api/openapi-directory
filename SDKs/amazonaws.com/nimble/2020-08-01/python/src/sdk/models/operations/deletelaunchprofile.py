...
from ..shared import deletelaunchprofileresponse as shared_deletelaunchprofileresponse
...
class DeleteLaunchProfileRequest:
    headers: DeleteLaunchProfileHeaders = dataclasses.field()
    path_params: DeleteLaunchProfilePathParams = dataclasses.field()
...
class DeleteLaunchProfileResponse:
    ...
    delete_launch_profile_response: Optional[shared_deletelaunchprofileresponse.DeleteLaunchProfileResponse] = dataclasses.field(default=None)
