...
@dataclasses.dataclass
class DataprocProjectsRegionsClustersCreateQueryParams:
    dollar_xgafv: Optional[shared__xgafv_enum.XgafvEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': '$.xgafv', 'style': 'form', 'explode': True }})
    access_token: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'access_token', 'style': 'form', 'explode': True }})
    action_on_failed_primary_workers: Optional[DataprocProjectsRegionsClustersCreateActionOnFailedPrimaryWorkersEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'actionOnFailedPrimaryWorkers', 'style': 'form', 'explode': True }})
...
class DataprocProjectsRegionsClustersCreateRequest:
    path_params: DataprocProjectsRegionsClustersCreatePathParams = dataclasses.field()
    query_params: DataprocProjectsRegionsClustersCreateQueryParams = dataclasses.field()
    security: DataprocProjectsRegionsClustersCreateSecurity = dataclasses.field()
