...
class SearchTypeDocumentDocQueryParams:
...
@dataclasses.dataclass
class SearchTypeDocumentDocRequest:
    query_params: SearchTypeDocumentDocQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeDocumentDocResponse:
