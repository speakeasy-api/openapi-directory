...
from ..shared import createcustomersupportcustomerresponse as shared_createcustomersupportcustomerresponse
...
class CustomersAddRequest:
    headers: CustomersAddHeaders = dataclasses.field()
    query_params: CustomersAddQueryParams = dataclasses.field()
    ...
    security: CustomersAddSecurity = dataclasses.field()
...
class CustomersAddResponse:
    ...
    create_customer_support_customer_response: Optional[shared_createcustomersupportcustomerresponse.CreateCustomerSupportCustomerResponse] = dataclasses.field(default=None)
