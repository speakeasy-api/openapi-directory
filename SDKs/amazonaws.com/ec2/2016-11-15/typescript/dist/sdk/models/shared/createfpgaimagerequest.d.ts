 ...
 */
export declare enum CreateFpgaImageRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateFpgaImageRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateFpgaImageRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: CreateFpgaImageRequestTagSpecificationsResourceTypeEnum;
    tags?: CreateFpgaImageRequestTagSpecificationsTags[];
}
export declare class CreateFpgaImageRequest extends SpeakeasyBase {
    clientToken?: string;
    description?: string;
    dryRun?: boolean;
