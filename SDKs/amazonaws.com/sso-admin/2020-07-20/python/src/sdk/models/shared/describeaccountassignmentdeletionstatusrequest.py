...
class DescribeAccountAssignmentDeletionStatusRequest:
    account_assignment_deletion_request_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('AccountAssignmentDeletionRequestId') }})
