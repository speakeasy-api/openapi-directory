...
class ListFirewallDomainsRequest:
    ...
    list_firewall_domains_request: shared_listfirewalldomainsrequest.ListFirewallDomainsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
