...
class GetNetworkClientsApplicationUsageRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNetworkClientsApplicationUsageSsidNumberEnum $ssidNumber
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=ssidNumber')]
    public ?GetNetworkClientsApplicationUsageSsidNumberEnum $ssidNumber = null;
