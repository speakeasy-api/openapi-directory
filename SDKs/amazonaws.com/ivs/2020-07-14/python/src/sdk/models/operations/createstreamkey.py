...
class CreateStreamKeyRequest:
    headers: CreateStreamKeyHeaders = dataclasses.field()
    request: CreateStreamKeyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
