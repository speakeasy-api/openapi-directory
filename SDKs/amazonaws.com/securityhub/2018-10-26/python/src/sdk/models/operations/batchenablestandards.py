...
class BatchEnableStandardsRequestBody:
    ...
    standards_subscription_requests: list[shared_standardssubscriptionrequest.StandardsSubscriptionRequest] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StandardsSubscriptionRequests') }})
    r"""The list of standards checks to enable."""  
    

@dataclasses.dataclass
class BatchEnableStandardsRequest:
    
    request_body: BatchEnableStandardsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
