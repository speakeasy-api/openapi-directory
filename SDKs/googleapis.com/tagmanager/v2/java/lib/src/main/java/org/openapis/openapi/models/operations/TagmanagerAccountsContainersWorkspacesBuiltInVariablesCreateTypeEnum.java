...
public enum TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateTypeEnum {
    ...
    private TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateTypeEnum(String value) {
        this.value = value;
    }
}
