 ...
 */
public class InboundAchTransferSimulationResultTransactionTransactionSourceCardDisputeAcceptance {
    /**
    ...
    public InboundAchTransferSimulationResultTransactionTransactionSourceCardDisputeAcceptance withAcceptedAt(OffsetDateTime acceptedAt) {
    ...
    public InboundAchTransferSimulationResultTransactionTransactionSourceCardDisputeAcceptance withCardDisputeId(String cardDisputeId) {
    ...
    public InboundAchTransferSimulationResultTransactionTransactionSourceCardDisputeAcceptance withTransactionId(String transactionId) {
