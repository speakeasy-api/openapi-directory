...
public class GetAccountsAccountIdStatementsStatementIdHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=sandbox-id")
    public String sandboxId;
    public GetAccountsAccountIdStatementsStatementIdHeaders withSandboxId(String sandboxId) {
        this.sandboxId = sandboxId;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-customer-user-agent")
    public String xCustomerUserAgent;
    public GetAccountsAccountIdStatementsStatementIdHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public GetAccountsAccountIdStatementsStatementIdHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public GetAccountsAccountIdStatementsStatementIdHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
        this.xFapiCustomerIpAddress = xFapiCustomerIpAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-fapi-interaction-id")
    public String xFapiInteractionId;
    public GetAccountsAccountIdStatementsStatementIdHeaders withXFapiInteractionId(String xFapiInteractionId) {
