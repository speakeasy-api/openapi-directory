...
export class ContentOrdersCaptureOrderSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentOrdersCaptureOrderRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentOrdersCaptureOrderResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
