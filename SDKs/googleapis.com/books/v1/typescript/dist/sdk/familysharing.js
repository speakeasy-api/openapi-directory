...
var Familysharing = /** @class */ (function () {
    ...
    **/
    Familysharing.prototype.booksFamilysharingGetFamilyInfo = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.familyInfo = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Familysharing.prototype.booksFamilysharingShare = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Familysharing.prototype.booksFamilysharingUnshare = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
