...
class Accounts:
    ...
    def analyticsadmin_accounts_list(self, request: operations.AnalyticsadminAccountsListRequest) -> operations.AnalyticsadminAccountsListResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GoogleAnalyticsAdminV1betaListAccountsResponse])
                res.google_analytics_admin_v1beta_list_accounts_response = out
    ...
    def analyticsadmin_accounts_provision_account_ticket(self, request: operations.AnalyticsadminAccountsProvisionAccountTicketRequest) -> operations.AnalyticsadminAccountsProvisionAccountTicketResponse:
        ...
        url = base_url.removesuffix("/") + "/v1beta/accounts:provisionAccountTicket"
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GoogleAnalyticsAdminV1betaProvisionAccountTicketResponse])
                res.google_analytics_admin_v1beta_provision_account_ticket_response = out
    ...
    def analyticsadmin_accounts_search_change_history_events(self, request: operations.AnalyticsadminAccountsSearchChangeHistoryEventsRequest) -> operations.AnalyticsadminAccountsSearchChangeHistoryEventsResponse:
        ...
        url = utils.generate_url(base_url, "/v1beta/{account}:searchChangeHistoryEvents", request.path_params)
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsResponse])
                res.google_analytics_admin_v1beta_search_change_history_events_response = out
