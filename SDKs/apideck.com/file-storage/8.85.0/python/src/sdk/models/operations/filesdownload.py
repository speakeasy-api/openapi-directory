...
class FilesDownloadPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class FilesDownloadHeaders:
...
@dataclasses.dataclass
class FilesDownloadSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class FilesDownloadRequest:
    headers: FilesDownloadHeaders = dataclasses.field()
    path_params: FilesDownloadPathParams = dataclasses.field()
    security: FilesDownloadSecurity = dataclasses.field()
...
class FilesDownloadResponse:
    ...
    files_download_200_wildcard_binary_string: Optional[bytes] = dataclasses.field(default=None)
