...
public class DistributionGroupsDeleteForOrgPathParams {
    /**
    ...
    public DistributionGroupsDeleteForOrgPathParams withDistributionGroupName(String distributionGroupName) {
    ...
    public DistributionGroupsDeleteForOrgPathParams withOrgName(String orgName) {
