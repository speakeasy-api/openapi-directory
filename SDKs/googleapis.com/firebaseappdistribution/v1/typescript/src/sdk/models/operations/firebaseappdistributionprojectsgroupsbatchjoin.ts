...
export class FirebaseappdistributionProjectsGroupsBatchJoinSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseappdistributionProjectsGroupsBatchJoinRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseappdistributionProjectsGroupsBatchJoinResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
