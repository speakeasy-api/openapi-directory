...
from ..shared import getcustomersupportcustomersresponse as shared_getcustomersupportcustomersresponse
...
class CustomersAllSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class CustomersAllRequest:
...
@dataclasses.dataclass
class CustomersAllResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    get_customer_support_customers_response: Optional[shared_getcustomersupportcustomersresponse.GetCustomerSupportCustomersResponse] = dataclasses.field(default=None)
    r"""CustomerSupportCustomers"""  
