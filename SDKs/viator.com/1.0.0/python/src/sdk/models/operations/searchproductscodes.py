...
class SearchProductsCodesRequestBody:
    ...
    r"""**currency code** for the currency in which to display product pricing"""  
    ...
    r"""**array** of product codes to search for"""  
...
class SearchProductsCodesRequest:
    ...
    request_body: Optional[SearchProductsCodesRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class SearchProductsCodes200ApplicationJSONData:
    ...
    *one of* the following:
    ...
    r"""**list** of category identifiers *this* product falls under
    ...
    currency_code: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('currencyCode'), 'exclude': lambda f: f is None }})
    r"""**currency** in which *this* product's pricing is displayed"""  
    ...
    r"""**currency-formatted suggested sell 'from' price** of *this* product"""  
    ...
    r"""**natural-language description** of *this* product (short)"""  
    ...
    r"""**sort order** for *this* search result"""  
    ...
    r"""**indicator**: `true` if a special offer is available for *this* product. If `true`, this means that the `specialOffer` field in the response from the [/product] service will contain a text string providing details of the special offer which you may wish to display in your product search results. E.g. 'Book by May 27 to save 34% off our previously offered price!'"""  
    ...
    r"""**list** of subcategory identifiers that *this* product falls under
    ...
    r"""**URL** for *this* product's high-resolution thumbnail image"""  
...
class SearchProductsCodes200ApplicationJSON:
    ...
    data: Optional[list[SearchProductsCodes200ApplicationJSONData]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
