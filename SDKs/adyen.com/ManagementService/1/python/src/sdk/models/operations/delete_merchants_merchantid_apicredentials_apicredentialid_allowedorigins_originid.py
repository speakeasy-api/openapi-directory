...
@dataclasses.dataclass
class DeleteMerchantsMerchantIDAPICredentialsAPICredentialIDAllowedOriginsOriginIDRequest:
...
@dataclasses.dataclass
class DeleteMerchantsMerchantIDAPICredentialsAPICredentialIDAllowedOriginsOriginIDResponse:
