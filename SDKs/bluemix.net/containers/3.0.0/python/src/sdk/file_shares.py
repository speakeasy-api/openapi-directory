...
class FileShares:
    ...
    def delete_volumes_fs_name_(self, request: operations.DeleteVolumesFsNameRequest) -> operations.DeleteVolumesFsNameResponse:
        ...
        url = utils.generate_url(operations.DeleteVolumesFsNameRequest, base_url, '/volumes/fs/{name}', request)
        ...
        res = operations.DeleteVolumesFsNameResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_volumes_fs_flavors_json(self, request: operations.GetVolumesFsFlavorsJSONRequest) -> operations.GetVolumesFsFlavorsJSONResponse:
        ...
        res = operations.GetVolumesFsFlavorsJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_volumes_fs_json(self, request: operations.GetVolumesFsJSONRequest) -> operations.GetVolumesFsJSONResponse:
        ...
        res = operations.GetVolumesFsJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.Fileshare]])
                res.fileshares = out
        elif http_res.status_code in [401, 500]:
            pass
    ...
    def get_volumes_fs_name_json(self, request: operations.GetVolumesFsNameJSONRequest) -> operations.GetVolumesFsNameJSONResponse:
        ...
        url = utils.generate_url(operations.GetVolumesFsNameJSONRequest, base_url, '/volumes/fs/{name}/json', request)
        ...
        res = operations.GetVolumesFsNameJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.GetFileshareDetails]])
    ...
    def post_volumes_fs_create(self, request: operations.PostVolumesFsCreateRequest) -> operations.PostVolumesFsCreateResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "fileshare_param", 'json')
        ...
        res = operations.PostVolumesFsCreateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
