...
public class GetUsersQueryParams {
    ...
    public GetUsersQueryParams withAssignment(String assignment) {
    ...
    public GetUsersQueryParams withCountry(String country) {
    ...
    public GetUsersQueryParams withLinkedProfile(String linkedProfile) {
    ...
    public GetUsersQueryParams withMinimumContributions(Double minimumContributions) {
    ...
    public GetUsersQueryParams withOwnedBy(String ownedBy) {
    ...
    public GetUsersQueryParams withSubmittedAfter(OffsetDateTime submittedAfter) {
    ...
    public GetUsersQueryParams withSubmittedBefore(OffsetDateTime submittedBefore) {
    ...
    public GetUsersQueryParams withUsername(String username) {
