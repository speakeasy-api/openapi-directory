 ...
 */
export declare enum MachineImageListWarningCodeEnum {
...
export declare class MachineImageListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class MachineImageListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class MachineImageList extends SpeakeasyBase {
    /**
