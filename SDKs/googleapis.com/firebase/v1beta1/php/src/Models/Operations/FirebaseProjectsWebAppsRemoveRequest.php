...
class FirebaseProjectsWebAppsRemoveRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\RemoveWebAppRequest $removeWebAppRequest = null;
