...
exports.ProPlanOrGreater = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ProPlanOrGreater = /** @class */ (function () {
    function ProPlanOrGreater(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ProPlanOrGreater.prototype.daysSupplyDaysSupplyGet = function (req, config) {
     ...
     * The available brand and region names can be retrieved from their respective endpoints.
    **/
    ProPlanOrGreater.prototype.daysToSellDaysToSellGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ProPlanOrGreater.prototype.getDealersGetDealersByIdGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ProPlanOrGreater.prototype.getDealersGetDealersByRegionGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ProPlanOrGreater.prototype.getDealersGetDealersGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ProPlanOrGreater.prototype.getHistory2VehicleHistoryGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.ProPlanOrGreater = ProPlanOrGreater;
