...
class CalendarCalendarListDeleteRequest:
    path_params: CalendarCalendarListDeletePathParams = dataclasses.field()
    query_params: CalendarCalendarListDeleteQueryParams = dataclasses.field()
    security: CalendarCalendarListDeleteSecurity = dataclasses.field()
