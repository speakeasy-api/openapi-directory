 ...
 */
export class DescribeTrafficMirrorSessionsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeTrafficMirrorSessionsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeTrafficMirrorSessionsRequestFilters })
  filters?: DescribeTrafficMirrorSessionsRequestFilters[];
