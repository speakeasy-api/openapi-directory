...
class RunNamespacesDomainmappingsListRequest:
    path_params: RunNamespacesDomainmappingsListPathParams = dataclasses.field()
    query_params: RunNamespacesDomainmappingsListQueryParams = dataclasses.field()
    security: RunNamespacesDomainmappingsListSecurity = dataclasses.field()
