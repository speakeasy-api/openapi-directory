...
public class GetContainersGroupsNameOrIdHeaders {
    /**
    ...
    public GetContainersGroupsNameOrIdHeaders withXAuthProjectId(String xAuthProjectId) {
    ...
    public GetContainersGroupsNameOrIdHeaders withXAuthToken(String xAuthToken) {
