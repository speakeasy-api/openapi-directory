...
class PatchJob:
    ...
    instance_details_summary: Optional[shared_patchjobinstancedetailssummary.PatchJobInstanceDetailsSummary] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('instanceDetailsSummary') }})
    ...
    patch_deployment: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('patchDeployment') }})
    percent_complete: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('percentComplete') }})
    ...
    state: Optional[PatchJobStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
