...
class GetUserDefinedFunctionsRequest:
    ...
    get_user_defined_functions_request: shared_getuserdefinedfunctionsrequest.GetUserDefinedFunctionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
