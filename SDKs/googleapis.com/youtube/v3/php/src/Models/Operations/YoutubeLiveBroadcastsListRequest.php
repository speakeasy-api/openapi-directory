...
class YoutubeLiveBroadcastsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\YoutubeLiveBroadcastsListBroadcastStatusEnum $broadcastStatus
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=broadcastStatus')]
    public ?YoutubeLiveBroadcastsListBroadcastStatusEnum $broadcastStatus = null;
    
    /**
     * Return only broadcasts with the selected type.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\YoutubeLiveBroadcastsListBroadcastTypeEnum $broadcastType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=broadcastType')]
    public ?YoutubeLiveBroadcastsListBroadcastTypeEnum $broadcastType = null;
