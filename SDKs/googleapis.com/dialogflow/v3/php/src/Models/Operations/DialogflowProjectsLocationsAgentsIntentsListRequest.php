...
class DialogflowProjectsLocationsAgentsIntentsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DialogflowProjectsLocationsAgentsIntentsListIntentViewEnum $intentView
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=intentView')]
    public ?DialogflowProjectsLocationsAgentsIntentsListIntentViewEnum $intentView = null;
