...
from ..shared import listprofileobjecttypesresponse as shared_listprofileobjecttypesresponse
...
class ListProfileObjectTypesRequest:
    headers: ListProfileObjectTypesHeaders = dataclasses.field()
    path_params: ListProfileObjectTypesPathParams = dataclasses.field()
    query_params: ListProfileObjectTypesQueryParams = dataclasses.field()
...
class ListProfileObjectTypesResponse:
    ...
    list_profile_object_types_response: Optional[shared_listprofileobjecttypesresponse.ListProfileObjectTypesResponse] = dataclasses.field(default=None)
