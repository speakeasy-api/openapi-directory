 ...
 */
export declare class DescribeVpcEndpointsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeVpcEndpointsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeVpcEndpointsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
