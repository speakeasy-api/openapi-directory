...
func (e SpotSetTypeExtendedOperatorEnum) ToPointer() *SpotSetTypeExtendedOperatorEnum {
	return &e
}
...
func (e *SpotSetTypeExtendedOperatorEnum) UnmarshalJSON(data []byte) error {
	...
	case "starts":
		fallthrough
	case "ends":
		*e = SpotSetTypeExtendedOperatorEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SpotSetTypeExtendedOperatorEnum: %v", v)
	}
}
...
func (e SpotSetTypeExtendedTypeEnum) ToPointer() *SpotSetTypeExtendedTypeEnum {
	return &e
}
...
func (e *SpotSetTypeExtendedTypeEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "extended":
		*e = SpotSetTypeExtendedTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SpotSetTypeExtendedTypeEnum: %v", v)
	}
}
