...
class SecurityTag:
    ...
    direct_security_groups: Optional[list[shared_reference.Reference]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('direct_security_groups'), 'exclude': lambda f: f is None }})  
