...
exports.GetNotificationsUnreadResponse = exports.GetNotificationsUnreadRequest = void 0;
...
var GetNotificationsUnreadRequest = /** @class */ (function (_super) {
    ...
    ], GetNotificationsUnreadRequest.prototype, "callback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetNotificationsUnreadRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetNotificationsUnreadRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pagesize",
        }),
        __metadata("design:type", Number)
    ], GetNotificationsUnreadRequest.prototype, "pagesize", void 0);
...
var GetNotificationsUnreadResponse = /** @class */ (function (_super) {
    ...
    ], GetNotificationsUnreadResponse.prototype, "rawResponse", void 0);
