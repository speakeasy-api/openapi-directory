...
export class CertificatemanagerProjectsLocationsCertificateIssuanceConfigsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CertificatemanagerProjectsLocationsCertificateIssuanceConfigsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CertificatemanagerProjectsLocationsCertificateIssuanceConfigsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
