...
public class ComputeNodeDeleteUserHeaders {
    ...
    public ComputeNodeDeleteUserHeaders withOcpDate(String ocpDate) {
    ...
    public ComputeNodeDeleteUserHeaders withReturnClientRequestId(Boolean returnClientRequestId) {
