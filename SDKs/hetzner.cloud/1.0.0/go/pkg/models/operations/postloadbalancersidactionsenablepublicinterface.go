...
func (e PostLoadBalancersIDActionsEnablePublicInterfaceActionResponseActionStatusEnum) ToPointer() *PostLoadBalancersIDActionsEnablePublicInterfaceActionResponseActionStatusEnum {
	return &e
}
...
func (e *PostLoadBalancersIDActionsEnablePublicInterfaceActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostLoadBalancersIDActionsEnablePublicInterfaceActionResponseActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostLoadBalancersIDActionsEnablePublicInterfaceActionResponseActionStatusEnum: %v", v)
	}
}
