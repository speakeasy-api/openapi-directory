...
func (e VideoV1CompositionHookStatusCallbackMethodEnum) ToPointer() *VideoV1CompositionHookStatusCallbackMethodEnum {
	return &e
}
...
func (e *VideoV1CompositionHookStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = VideoV1CompositionHookStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for VideoV1CompositionHookStatusCallbackMethodEnum: %v", v)
	}
}
