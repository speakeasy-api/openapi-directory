...
export declare class Billing {
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/billing#export-advanced-security-active-committers-data-for-enterprise} - API method documentation
     */
     ...
     * The total number of repositories with committer information is tracked by the `total_count` field.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.4/rest/reference/billing#get-github-advanced-security-active-committers-for-an-organization} - API method documentation
     */
