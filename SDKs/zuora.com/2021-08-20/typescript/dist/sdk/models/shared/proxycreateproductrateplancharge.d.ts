 ...
 *
 */
export declare enum ProxyCreateProductRatePlanChargeIncludeChildrenNSEnum {
    Yes = "Yes",
    No = "No"
}
/**
 ...
 *
 */
export declare enum ProxyCreateProductRatePlanChargeItemTypeNSEnum {
    Inventory = "Inventory",
 ...
 *
 */
export declare enum ProxyCreateProductRatePlanChargePriceIncreaseOptionEnum {
 ...
 *
 */
export declare enum ProxyCreateProductRatePlanChargeRevRecEndNSEnum {
 ...
 *
 */
export declare enum ProxyCreateProductRatePlanChargeRevRecStartNSEnum {
    ChargePeriodStart = "Charge Period Start",
    RevRecTriggerDate = "Rev Rec Trigger Date",
    UseNetSuiteRevRecTemplate = "Use NetSuite Rev Rec Template"
}
 ...
 *
 */
export declare enum ProxyCreateProductRatePlanChargeUsageRecordRatingOptionEnum {
 ...
 *
 */
export declare class ProxyCreateProductRatePlanCharge extends SpeakeasyBase {
    /**
     ...
     *
     */
    includeChildrenNS?: ProxyCreateProductRatePlanChargeIncludeChildrenNSEnum;
    /**
     ...
     *
     */
    itemTypeNS?: ProxyCreateProductRatePlanChargeItemTypeNSEnum;
     ...
     *
     */
    priceIncreaseOption?: ProxyCreateProductRatePlanChargePriceIncreaseOptionEnum;
    /**
     ...
     *
     */
    revRecEndNS?: ProxyCreateProductRatePlanChargeRevRecEndNSEnum;
    /**
     * Start date condition of the corresponding item in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).
     *
     * @remarks
     *
     */
    revRecStartNS?: ProxyCreateProductRatePlanChargeRevRecStartNSEnum;
    /**
     ...
     *
     */
    usageRecordRatingOption?: ProxyCreateProductRatePlanChargeUsageRecordRatingOptionEnum;
    /**
