...
class CreateFirewallRuleRequest:
    ...
    create_firewall_rule_request: shared_createfirewallrulerequest.CreateFirewallRuleRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
