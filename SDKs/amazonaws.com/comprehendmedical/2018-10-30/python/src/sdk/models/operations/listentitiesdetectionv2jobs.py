...
class ListEntitiesDetectionV2JobsRequest:
    ...
    list_entities_detection_v2_jobs_request: shared_listentitiesdetectionv2jobsrequest.ListEntitiesDetectionV2JobsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
