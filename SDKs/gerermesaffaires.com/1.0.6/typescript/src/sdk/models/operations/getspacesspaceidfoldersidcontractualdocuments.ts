 ...
 */
export enum GetSpacesSpaceIdFoldersIdContractualDocumentsTypeEnum {
  Contract = "contract",
...
export class GetSpacesSpaceIdFoldersIdContractualDocumentsRequest extends SpeakeasyBase {
  /**
...
export class GetSpacesSpaceIdFoldersIdContractualDocumentsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: shared.ContractualDocument })
