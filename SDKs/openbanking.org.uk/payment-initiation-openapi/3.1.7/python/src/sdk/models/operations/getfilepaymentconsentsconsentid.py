...
class GetFilePaymentConsentsConsentIDRequest:
    headers: GetFilePaymentConsentsConsentIDHeaders = dataclasses.field()
    path_params: GetFilePaymentConsentsConsentIDPathParams = dataclasses.field()
    security: GetFilePaymentConsentsConsentIDSecurity = dataclasses.field()
