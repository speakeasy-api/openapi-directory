...
class AccountsGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\AccountsGetRequestOptions $options
     */
	#[\JMS\Serializer\Annotation\SerializedName('options')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\AccountsGetRequestOptions')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?AccountsGetRequestOptions $options = null;
