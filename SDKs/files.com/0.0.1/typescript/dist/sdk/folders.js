...
var Folders = /** @class */ (function () {
    ...
    **/
    Folders.prototype.folderListForPath = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FolderListForPathRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/folders/{path}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.fileEntities = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
     ...
     * Create folder
    **/
    Folders.prototype.postFoldersPath = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
