...
class PredefinedMetricSpecification:
    ...
    predefined_metric_type: shared_metrictype_enum.MetricTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('PredefinedMetricType') }})
