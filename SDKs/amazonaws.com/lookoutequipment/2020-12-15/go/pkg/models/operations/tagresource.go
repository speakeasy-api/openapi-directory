...
const (
	TagResourceXAmzTargetEnumAwsLookoutEquipmentFrontendServiceTagResource TagResourceXAmzTargetEnum = "AWSLookoutEquipmentFrontendService.TagResource"
)
...
func (e *TagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AWSLookoutEquipmentFrontendService.TagResource":
