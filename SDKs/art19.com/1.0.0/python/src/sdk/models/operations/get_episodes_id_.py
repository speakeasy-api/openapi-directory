...
class GetEpisodesIDRequest:
    path_params: GetEpisodesIDPathParams = dataclasses.field()
...
class GetEpisodesIDResponse:
    ...
    get_episodes_id_200_application_vnd_api_plus_json_object: Optional[GetEpisodesID200ApplicationVndAPIPlusJSON] = dataclasses.field(default=None)
