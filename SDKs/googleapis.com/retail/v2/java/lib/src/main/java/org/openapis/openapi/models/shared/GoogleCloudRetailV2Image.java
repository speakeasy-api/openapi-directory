...
public class GoogleCloudRetailV2Image {
    ...
    public GoogleCloudRetailV2Image withHeight(Integer height) {
        this.height = height;
        return this;
    }
    ...
    public GoogleCloudRetailV2Image withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public GoogleCloudRetailV2Image withWidth(Integer width) {
        this.width = width;
        return this;
    }
