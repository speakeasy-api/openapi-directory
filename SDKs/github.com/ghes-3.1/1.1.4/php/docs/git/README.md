...
try {
    ...
    $request->requestBody->encoding = 'unde';
...
try {
    ...
    $request->requestBody->author->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2020-04-25T13:15:32.117Z');
    $request->requestBody->author->email = 'Viviane_Aufderhar@gmail.com';
    $request->requestBody->author->name = 'Tammy Medhurst';
    $request->requestBody->committer = new GitCreateCommitRequestBodyCommitter();
    $request->requestBody->committer->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-08-05T13:00:56.741Z');
    $request->requestBody->committer->email = 'Katrina27@yahoo.com';
    $request->requestBody->committer->name = 'Mrs. Johanna Jacobson';
    $request->requestBody->message = 'praesentium';
    $request->requestBody->parents = [
        'quaerat',
        'incidunt',
        'ipsam',
    ];
    $request->requestBody->signature = 'debitis';
    $request->requestBody->tree = 'rem';
    $request->owner = 'sit';
    $request->repo = 'nobis';
...
try {
    ...
    $request->requestBody->ref = 'error';
    $request->requestBody->sha = 'veniam';
...
try {
    ...
    $request->requestBody->object = 'nulla';
    $request->requestBody->tag = 'magni';
    $request->requestBody->tagger = new GitCreateTagRequestBodyTagger();
    $request->requestBody->tagger->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-05T23:00:32.306Z');
    $request->requestBody->tagger->email = 'Ernesto.King51@gmail.com';
    $request->requestBody->tagger->name = 'Mabel Robel';
...
try {
    ...
    $request->requestBody->baseTree = 'expedita';
...
try {
    ...
    $request->owner = 'esse';
    $request->recursive = 'ipsam';
    $request->repo = 'sit';
    $request->treeSha = 'voluptatum';
