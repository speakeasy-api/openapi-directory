...
var ListOrganizationAdminAccountsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: adminaccount_1.AdminAccount }),
        (0, class_transformer_1.Expose)({ name: "AdminAccounts" }),
        (0, class_transformer_1.Type)(function () { return adminaccount_1.AdminAccount; }),
