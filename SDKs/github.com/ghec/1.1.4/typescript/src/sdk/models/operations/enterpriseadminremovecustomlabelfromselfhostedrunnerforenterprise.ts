...
export class EnterpriseAdminRemoveCustomLabelFromSelfHostedRunnerForEnterpriseRequest extends SpeakeasyBase {
  /**
 ...
 * Response
 */
export class EnterpriseAdminRemoveCustomLabelFromSelfHostedRunnerForEnterprise200ApplicationJSON extends SpeakeasyBase {
...
export class EnterpriseAdminRemoveCustomLabelFromSelfHostedRunnerForEnterpriseResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
