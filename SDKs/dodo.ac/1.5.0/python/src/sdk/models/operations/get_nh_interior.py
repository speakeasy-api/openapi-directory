...
class GetNhInteriorColorEnum(str, Enum):
    AQUA = 'Aqua'
    BEIGE = 'Beige'
    BLACK = 'Black'
    BLUE = 'Blue'
...
class GetNhInteriorRequest:
    ...
    color: Optional[list[GetNhInteriorColorEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'color', 'style': 'form', 'explode': True }})
    ...
    r"""When set to `true`, only interior item names are returned. Instead of an array of objects with all details, the return will be an array of strings."""  
    

@dataclasses.dataclass
class GetNhInteriorResponse:
    ...
    nh_interiors: Optional[list[shared_nhinterior.NHInterior]] = dataclasses.field(default=None)
