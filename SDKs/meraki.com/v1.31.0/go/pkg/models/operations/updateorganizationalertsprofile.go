...
type UpdateOrganizationAlertsProfilePathParams struct {
...
func (e *UpdateOrganizationAlertsProfileRequestBodyAlertConditionInterfaceEnum) UnmarshalJSON(data []byte) error {
	...
	case "wan1":
		fallthrough
	case "wan2":
		*e = UpdateOrganizationAlertsProfileRequestBodyAlertConditionInterfaceEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationAlertsProfileRequestBodyAlertConditionInterfaceEnum: %s", s)
	}
}
...
func (e *UpdateOrganizationAlertsProfileRequestBodyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "wanStatus":
		fallthrough
	case "wanUtilization":
		*e = UpdateOrganizationAlertsProfileRequestBodyTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOrganizationAlertsProfileRequestBodyTypeEnum: %s", s)
	}
}
...
type UpdateOrganizationAlertsProfileRequest struct {
	PathParams UpdateOrganizationAlertsProfilePathParams
	Request    *UpdateOrganizationAlertsProfileRequestBody `request:"mediaType=application/json"`
}
