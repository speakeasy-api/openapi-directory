...
class PostSpacesIDCompanyEntitiesPersonIDDetailsRequestBodyAddress:
...
class PostSpacesIDCompanyEntitiesPersonIDDetailsRequestBody:
    ...
    address: Optional[PostSpacesIDCompanyEntitiesPersonIDDetailsRequestBodyAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Address'), 'exclude': lambda f: f is None }})  
...
class PostSpacesIDCompanyEntitiesPersonIDDetailsRequest:
    ...
    request_body: PostSpacesIDCompanyEntitiesPersonIDDetailsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Contact details to add or replace (Designation and Phone or Mail are mandatory)"""  
