...
class PostPortfolioOptimizationMinimumVarianceRequestBody:
    ...
    constraints: Optional[PostPortfolioOptimizationMinimumVarianceRequestBodyConstraints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('constraints') }})
...
class PostPortfolioOptimizationMinimumVarianceRequest:
    request: PostPortfolioOptimizationMinimumVarianceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class PostPortfolioOptimizationMinimumVarianceResponse:
    ...
    post_portfolio_optimization_minimum_variance_200_application_json_object: Optional[PostPortfolioOptimizationMinimumVariance200ApplicationJSON] = dataclasses.field(default=None)
