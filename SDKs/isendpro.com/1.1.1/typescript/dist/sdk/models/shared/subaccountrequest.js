...
var SubaccountRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subAccountAddCredit" }),
        __metadata("design:type", String)
    ], SubaccountRequest.prototype, "subAccountAddCredit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subAccountCountryCode" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subAccountPrice" }),
        __metadata("design:type", String)
    ], SubaccountRequest.prototype, "subAccountPrice", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subAccountRestrictionStop" }),
        __metadata("design:type", String)
    ], SubaccountRequest.prototype, "subAccountRestrictionStop", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subAccountRestrictionTime" }),
        __metadata("design:type", String)
