...
exports.InvokeEndpointAsyncResponse = exports.InvokeEndpointAsyncRequest = exports.InvokeEndpointAsyncHeaders = exports.InvokeEndpointAsyncPathParams = void 0;
...
exports.InvokeEndpointAsyncPathParams = InvokeEndpointAsyncPathParams;
var InvokeEndpointAsyncHeaders = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "header, style=simple;explode=false;name=X-Amzn-SageMaker-Accept" }),
        __metadata("design:type", String)
    ], InvokeEndpointAsyncHeaders.prototype, "xAmznSageMakerAccept", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "header, style=simple;explode=false;name=X-Amzn-SageMaker-Content-Type" }),
        __metadata("design:type", String)
    ], InvokeEndpointAsyncHeaders.prototype, "xAmznSageMakerContentType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "header, style=simple;explode=false;name=X-Amzn-SageMaker-Custom-Attributes" }),
        __metadata("design:type", String)
    ], InvokeEndpointAsyncHeaders.prototype, "xAmznSageMakerCustomAttributes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "header, style=simple;explode=false;name=X-Amzn-SageMaker-Inference-Id" }),
        __metadata("design:type", String)
    ], InvokeEndpointAsyncHeaders.prototype, "xAmznSageMakerInferenceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "header, style=simple;explode=false;name=X-Amzn-SageMaker-InputLocation" }),
        __metadata("design:type", String)
    ], InvokeEndpointAsyncHeaders.prototype, "xAmznSageMakerInputLocation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "header, style=simple;explode=false;name=X-Amzn-SageMaker-RequestTTLSeconds" }),
        __metadata("design:type", Number)
    ], InvokeEndpointAsyncHeaders.prototype, "xAmznSageMakerRequestTTLSeconds", void 0);
    return InvokeEndpointAsyncHeaders;
}(utils_1.SpeakeasyBase));
exports.InvokeEndpointAsyncHeaders = InvokeEndpointAsyncHeaders;
