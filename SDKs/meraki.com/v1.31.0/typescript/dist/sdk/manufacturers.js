...
var Manufacturers = /** @class */ (function () {
    function Manufacturers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return metrics for organization's top clients by data usage (in mb) over given time range, grouped by manufacturer.
     */
    Manufacturers.prototype.getOrganizationSummaryTopClientsManufacturersByUsage = function (req, config) {
