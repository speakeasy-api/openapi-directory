...
export class Reports {
  ...
  adsensehostReportsGenerate(
    ...
    security: operations.AdsensehostReportsGenerateSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.AdsensehostReportsGenerateSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AdsensehostReportsGenerateResponse =
        new operations.AdsensehostReportsGenerateResponse({
