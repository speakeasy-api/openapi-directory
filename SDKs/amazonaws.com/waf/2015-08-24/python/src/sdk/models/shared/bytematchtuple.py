...
class ByteMatchTuple:
    ...
    positional_constraint: shared_positionalconstraint_enum.PositionalConstraintEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('PositionalConstraint') }})
    target_string: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('TargetString') }})
