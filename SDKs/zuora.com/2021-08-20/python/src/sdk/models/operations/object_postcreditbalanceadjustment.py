...
from ..shared import proxycreatecreditbalanceadjustment as shared_proxycreatecreditbalanceadjustment
...
class ObjectPOSTCreditBalanceAdjustmentRequest:
    ...
    proxy_create_credit_balance_adjustment: shared_proxycreatecreditbalanceadjustment.ProxyCreateCreditBalanceAdjustment = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
