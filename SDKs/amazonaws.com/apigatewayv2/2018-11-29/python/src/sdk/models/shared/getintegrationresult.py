...
class GetIntegrationResultTLSConfig:
    r"""GetIntegrationResultTLSConfig
...
class GetIntegrationResult:
    ...
    tls_config: Optional[GetIntegrationResultTLSConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('TlsConfig') }})
