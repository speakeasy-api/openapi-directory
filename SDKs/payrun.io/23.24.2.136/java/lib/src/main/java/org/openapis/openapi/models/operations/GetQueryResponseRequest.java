...
public class GetQueryResponseRequest {
    ...
    public GetQueryResponseRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("Query") org.openapis.openapi.models.shared.Query query) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.query = query;
  }
