...
export enum StopSNOMEDCTInferenceJobXAmzTargetEnum {
  ComprehendMedical20181030StopSNOMEDCTInferenceJob = "ComprehendMedical_20181030.StopSNOMEDCTInferenceJob",
}

export class StopSNOMEDCTInferenceJobRequest extends SpeakeasyBase {
...
export class StopSNOMEDCTInferenceJobResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
