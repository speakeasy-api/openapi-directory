...
func (s *SDK) CreateANewQuestion(ctx context.Context, request operations.CreateANewQuestionRequestBody) (*operations.CreateANewQuestionResponse, error) {
	...
	res := &operations.CreateANewQuestionResponse{
...
func (s *SDK) ListAllQuestions(ctx context.Context) (*operations.ListAllQuestionsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/questions"
	...
	res := &operations.ListAllQuestionsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
