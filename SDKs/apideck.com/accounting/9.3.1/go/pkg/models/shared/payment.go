...
func (e PaymentAllocationsAllocationTypeEnum) ToPointer() *PaymentAllocationsAllocationTypeEnum {
	return &e
}
...
func (e *PaymentAllocationsAllocationTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "over_payment":
		fallthrough
	case "pre_payment":
		*e = PaymentAllocationsAllocationTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PaymentAllocationsAllocationTypeEnum: %v", v)
	}
}
...
func (e PaymentPaymentStatusEnum) ToPointer() *PaymentPaymentStatusEnum {
	return &e
}
...
func (e *PaymentPaymentStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "voided":
		fallthrough
	case "deleted":
		*e = PaymentPaymentStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PaymentPaymentStatusEnum: %v", v)
	}
}
...
func (e PaymentPaymentTypeEnum) ToPointer() *PaymentPaymentTypeEnum {
	return &e
}
...
func (e *PaymentPaymentTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "accounts_payable_prepayment":
		*e = PaymentPaymentTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PaymentPaymentTypeEnum: %v", v)
	}
}
