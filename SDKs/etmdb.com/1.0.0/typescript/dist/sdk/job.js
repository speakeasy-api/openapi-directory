...
var Job = /** @class */ (function () {
    function Job(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Job.prototype.jobSearchRead = function (req, config) {
     ...
     * [ref]: https://etmdb.com/en/job-list/-updated_date
    **/
    Job.prototype.jobSearchallRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
