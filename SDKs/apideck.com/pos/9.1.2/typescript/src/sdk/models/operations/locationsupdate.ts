...
export class LocationsUpdateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class LocationsUpdateRequest extends SpeakeasyBase {
...
export class LocationsUpdateResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
