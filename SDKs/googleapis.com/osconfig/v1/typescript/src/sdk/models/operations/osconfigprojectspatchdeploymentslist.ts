...
export class OsconfigProjectsPatchDeploymentsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class OsconfigProjectsPatchDeploymentsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class OsconfigProjectsPatchDeploymentsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
