...
export declare class GetOrganisationsPartyIdRolesRequest extends SpeakeasyBase {
    /**
     * The API key.
     */
    apiKey: string;
...
export declare class GetOrganisationsPartyIdRolesResponse extends SpeakeasyBase {
    contentType: string;
