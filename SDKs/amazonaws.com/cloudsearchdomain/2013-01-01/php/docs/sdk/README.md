...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\SuggestRequest;
use \OpenAPI\OpenAPI\Models\Operations\SuggestFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\SuggestPrettyEnum;
...
try {
    ...
    $request->format = SuggestFormatEnum::SDK;
    $request->pretty = SuggestPrettyEnum::TRUE;
    $request->q = 'dolorum';
    $request->size = 118274;
    $request->suggester = 'nam';

    $response = $sdk->sdk->suggest($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\UploadDocumentsRequest;
use \OpenAPI\OpenAPI\Models\Operations\UploadDocumentsContentTypeEnum;
use \OpenAPI\OpenAPI\Models\Operations\UploadDocumentsRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\UploadDocumentsFormatEnum;
...
try {
    ...
    $request->contentType = UploadDocumentsContentTypeEnum::APPLICATION_XML;
    $request->requestBody = new UploadDocumentsRequestBody();
    $request->requestBody->documents = 'occaecati';
    ...
    $request->format = UploadDocumentsFormatEnum::SDK;

    $response = $sdk->sdk->uploadDocuments($request);

    if ($response->uploadDocumentsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
