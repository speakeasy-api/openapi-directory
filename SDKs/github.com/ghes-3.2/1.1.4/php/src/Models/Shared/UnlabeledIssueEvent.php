...
class UnlabeledIssueEvent
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\UnlabeledIssueEventLabel')]
	...
	public function __construct()
	{
		...
		$this->event = "";
		$this->id = 0;
		$this->label = new \OpenAPI\OpenAPI\Models\Shared\UnlabeledIssueEventLabel();
		$this->nodeId = "";
