...
class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsCreateRequest:
    ...
    r"""Required. The ID of the insertion order the assigned targeting option will belong to."""  
    ...
    assigned_targeting_option_input: Optional[shared_assignedtargetingoption.AssignedTargetingOptionInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
