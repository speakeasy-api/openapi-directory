 ...
 */
export enum NodesContributorsReadContributorAttributesPermissionEnum {
  Read = "read",
  Write = "write",
  Admin = "admin",
}
 ...
 */
export class NodesContributorsReadContributorAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class NodesContributorsReadContributorLinks extends SpeakeasyBase {
  /**
 ...
 */
export class NodesContributorsReadContributorRelationships extends SpeakeasyBase {
  /**
...
export class NodesContributorsReadContributor extends SpeakeasyBase {
  /**
   * The properties of the contributor entity.
   */
  @SpeakeasyMetadata()
