...
from ..shared import jobdisableparameter as shared_jobdisableparameter
...
class JobDisableRequest:
    ...
    job_disable_parameter: shared_jobdisableparameter.JobDisableParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    ...
    r"""The id of the job to disable."""  
