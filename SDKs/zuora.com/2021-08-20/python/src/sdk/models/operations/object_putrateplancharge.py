...
from ..shared import proxymodifyrateplancharge as shared_proxymodifyrateplancharge
...
class ObjectPUTRatePlanChargeRequest:
    ...
    r"""Object id"""  
    proxy_modify_rate_plan_charge: shared_proxymodifyrateplancharge.ProxyModifyRatePlanCharge = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
