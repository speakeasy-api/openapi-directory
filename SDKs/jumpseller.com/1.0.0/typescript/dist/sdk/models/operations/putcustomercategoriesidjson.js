...
exports.PutCustomerCategoriesIdJsonResponse = exports.PutCustomerCategoriesIdJsonRequest = void 0;
...
var PutCustomerCategoriesIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], PutCustomerCategoriesIdJsonRequest.prototype, "customerCategoryEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PutCustomerCategoriesIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PutCustomerCategoriesIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PutCustomerCategoriesIdJsonRequest.prototype, "login", void 0);
    return PutCustomerCategoriesIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PutCustomerCategoriesIdJsonRequest = PutCustomerCategoriesIdJsonRequest;
var PutCustomerCategoriesIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], PutCustomerCategoriesIdJsonResponse.prototype, "rawResponse", void 0);
    return PutCustomerCategoriesIdJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PutCustomerCategoriesIdJsonResponse = PutCustomerCategoriesIdJsonResponse;
