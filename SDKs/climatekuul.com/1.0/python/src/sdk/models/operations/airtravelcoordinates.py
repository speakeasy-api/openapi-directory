...
class AirtravelCoordinatesRequestBody:
    ...
    r"""Number of passengers (like: 1, 2 ,3 )"""  
    ...
    r"""Travel class can be 'First Class', 'Economy', 'Business' or 'Premium Economy'"""  
    travel_mode: str = dataclasses.field(metadata={'form': { 'field_name': 'travel_mode' }})
    r"""Travel mode can be 'one way' or 'round trip'"""  
...
class AirtravelCoordinatesRequest:
    ...
    request_body: Optional[AirtravelCoordinatesRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
