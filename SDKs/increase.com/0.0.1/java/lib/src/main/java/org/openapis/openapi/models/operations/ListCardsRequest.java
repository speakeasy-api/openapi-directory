...
public class ListCardsRequest {
    ...
    public ListCardsRequest withCreatedAtAfter(OffsetDateTime createdAtAfter) {
    ...
    public ListCardsRequest withCreatedAtBefore(OffsetDateTime createdAtBefore) {
    ...
    public ListCardsRequest withCreatedAtOnOrAfter(OffsetDateTime createdAtOnOrAfter) {
    ...
    public ListCardsRequest withCreatedAtOnOrBefore(OffsetDateTime createdAtOnOrBefore) {
    ...
    public Long limit;
    public ListCardsRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
