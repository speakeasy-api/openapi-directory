...
var CollectionResponseExtensionActionDefinitionForwardPaging = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: extensionactiondefinition_1.ExtensionActionDefinition }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return extensionactiondefinition_1.ExtensionActionDefinition; }),
