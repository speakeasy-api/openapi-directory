...
from ..shared import userrating as shared_userrating
...
class GetItemRatingRequest:
    ...
    r"""The id of the item to get the rating info for."""  
...
class GetItemRatingResponse:
    ...
    r"""Bad request."""  
    user_rating: Optional[shared_userrating.UserRating] = dataclasses.field(default=None)
    r"""OK"""  
