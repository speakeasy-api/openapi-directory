...
class ProvideAnomalyFeedbackRequest:
    ...
    feedback: shared_anomalyfeedbacktype_enum.AnomalyFeedbackTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Feedback') }})  
