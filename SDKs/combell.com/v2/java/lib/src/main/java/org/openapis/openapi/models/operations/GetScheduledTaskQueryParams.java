...
public class GetScheduledTaskQueryParams {
    /**
     * Linux hosting domain name.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=domain_name")
    public String domainName;
    public GetScheduledTaskQueryParams withDomainName(String domainName) {
    ...
    public GetScheduledTaskQueryParams withScheduledTaskId(String scheduledTaskId) {
