...
export class GetVariantGeneAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetVariantGeneAssociationsQueryParams extends SpeakeasyBase {
...
export class GetVariantGeneAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetVariantGeneAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
