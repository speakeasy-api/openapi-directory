...
type GetNhToolsQueryParams struct {
...
type GetNhToolsRequest struct {
	QueryParams GetNhToolsQueryParams
	Headers     GetNhToolsHeaders
}

type GetNhToolsResponse struct {
	ContentType string
