 ...
 */
public enum UpdateNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum {
    ...
    private UpdateNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum(String value) {
        this.value = value;
    }
}
