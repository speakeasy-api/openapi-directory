...
export class GetOrganisationsPartyIdRolesRoleIdRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class GetOrganisationsPartyIdRolesRoleIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
