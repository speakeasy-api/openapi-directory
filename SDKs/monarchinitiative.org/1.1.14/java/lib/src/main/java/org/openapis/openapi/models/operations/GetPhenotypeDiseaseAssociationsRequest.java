...
public class GetPhenotypeDiseaseAssociationsRequest {
    ...
    public GetPhenotypeDiseaseAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPhenotypeDiseaseAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPhenotypeDiseaseAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPhenotypeDiseaseAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPhenotypeDiseaseAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPhenotypeDiseaseAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPhenotypeDiseaseAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPhenotypeDiseaseAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPhenotypeDiseaseAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPhenotypeDiseaseAssociationsRequest withRelation(String relation) {
    ...
    public GetPhenotypeDiseaseAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPhenotypeDiseaseAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPhenotypeDiseaseAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPhenotypeDiseaseAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPhenotypeDiseaseAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPhenotypeDiseaseAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPhenotypeDiseaseAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPhenotypeDiseaseAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
