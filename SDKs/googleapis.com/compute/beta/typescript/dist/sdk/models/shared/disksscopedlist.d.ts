 ...
 */
export declare enum DisksScopedListWarningCodeEnum {
...
export declare class DisksScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class DisksScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class DisksScopedList extends SpeakeasyBase {
    /**
