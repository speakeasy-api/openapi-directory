...
<https://docs.github.com/enterprise-server@3.0/rest/reference/checks#create-a-check-run>
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/checks#create-a-check-suite>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksCreateSuiteRequest req = new ChecksCreateSuiteRequest(                new ChecksCreateSuiteRequestBody("deserunt");, "quam", "ipsum");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/checks#get-a-check-run>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksGetRequest req = new ChecksGetRequest(277628L, "qui", "cupiditate");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/checks#get-a-check-suite>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksGetSuiteRequest req = new ChecksGetSuiteRequest(807581L, "pariatur", "soluta");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/checks#list-check-run-annotations>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListAnnotationsRequest req = new ChecksListAnnotationsRequest(117531L, "laborum", "totam") {{
                page = 276894L;
                perPage = 132068L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/checks#list-check-runs-for-a-git-reference>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListForRefRequest req = new ChecksListForRefRequest("dolores", "distinctio", "facilis") {{
                appId = 396060L;
                checkName = "quam";
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/checks#list-check-runs-in-a-check-suite>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListForSuiteRequest req = new ChecksListForSuiteRequest(144847L, "magni", "odio") {{
                checkName = "sunt";
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/checks#list-check-suites-for-a-git-reference>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListSuitesForRefRequest req = new ChecksListSuitesForRefRequest("cumque", "soluta", "nobis") {{
                appId = 92596L;
                checkName = "saepe";
                page = 217450L;
                perPage = 83422L;
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/checks#rerequest-a-check-suite>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksRerequestSuiteRequest req = new ChecksRerequestSuiteRequest(749255L, "quos", "tempore");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/checks#update-repository-preferences-for-check-suites>
        ...
        try {
            ...
            ChecksSetSuitesPreferencesRequest req = new ChecksSetSuitesPreferencesRequest(                new ChecksSetSuitesPreferencesRequestBody() {{
                                autoTriggerChecks = new org.openapis.openapi.models.operations.ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks[]{{
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(961937L, false) {{
                                        appId = 45614L;
                                        setting = false;
                                    }}),
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(292147L, false) {{
                                        appId = 209157L;
                                        setting = false;
                                    }}),
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(240829L, false) {{
                                        appId = 286915L;
                                        setting = false;
                                    }}),
                                }};
...
API method documentation
<https://docs.github.com/enterprise-server@3.0/rest/reference/checks#update-a-check-run>
