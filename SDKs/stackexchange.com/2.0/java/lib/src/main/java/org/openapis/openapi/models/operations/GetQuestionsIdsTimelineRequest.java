...
public class GetQuestionsIdsTimelineRequest {
    ...
    public GetQuestionsIdsTimelineRequest withCallback(String callback) {
    ...
    public GetQuestionsIdsTimelineRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetQuestionsIdsTimelineRequest withFromdate(Long fromdate) {
    ...
    public GetQuestionsIdsTimelineRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetQuestionsIdsTimelineRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetQuestionsIdsTimelineRequest withPagesize(Long pagesize) {
    ...
    public GetQuestionsIdsTimelineRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetQuestionsIdsTimelineRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetQuestionsIdsTimelineRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
