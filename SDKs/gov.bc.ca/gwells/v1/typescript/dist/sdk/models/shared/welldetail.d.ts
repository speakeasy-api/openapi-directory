...
export declare class WellDetail extends SpeakeasyBase {
    ...
    city?: string;
    comments?: string;
    companyOfPersonResponsible: OrganizationNameList;
    constructionEndDate?: Date;
    constructionStartDate?: Date;
    coordinateAcquisitionCode?: string;
    decommissionDescriptionSet: DecommissionDescription[];
    ...
    linerTo?: string;
    linerperforationSet: LinerPerforation[];
    lithologydescriptionSet: LithologyDescription[];
    longitude?: string;
