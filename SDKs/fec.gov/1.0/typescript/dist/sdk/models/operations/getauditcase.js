...
exports.GetAuditCaseResponse = exports.GetAuditCaseRequest = exports.GetAuditCaseQueryParams = void 0;
...
var GetAuditCaseQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=audit_case_id" }),
        __metadata("design:type", Array)
    ], GetAuditCaseQueryParams.prototype, "auditCaseId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=audit_id" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=max_election_cycle" }),
        __metadata("design:type", Number)
    ], GetAuditCaseQueryParams.prototype, "maxElectionCycle", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=min_election_cycle" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=primary_category_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=qq" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sub_category_id" }),
        __metadata("design:type", String)
    ], GetAuditCaseQueryParams.prototype, "subCategoryId", void 0);
    return GetAuditCaseQueryParams;
}(utils_1.SpeakeasyBase));
exports.GetAuditCaseQueryParams = GetAuditCaseQueryParams;
...
exports.GetAuditCaseRequest = GetAuditCaseRequest;
...
exports.GetAuditCaseResponse = GetAuditCaseResponse;
