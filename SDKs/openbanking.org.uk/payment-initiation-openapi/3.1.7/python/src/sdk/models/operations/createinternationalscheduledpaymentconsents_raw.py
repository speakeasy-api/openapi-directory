...
class CreateInternationalScheduledPaymentConsentsRawSecurity:
    
    tppo_auth2_security: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class CreateInternationalScheduledPaymentConsentsRawRequest:
...
@dataclasses.dataclass
class CreateInternationalScheduledPaymentConsentsRawResponse:
