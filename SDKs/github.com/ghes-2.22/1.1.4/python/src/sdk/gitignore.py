...
class Gitignore:
    ...
    def gitignore_get_all_templates(self) -> operations.GitignoreGetAllTemplatesResponse:
        ...
        https://docs.github.com/enterprise-server@2.22/rest/reference/gitignore#get-all-gitignore-templates - API method documentation
        """
    ...
    def gitignore_get_template(self, request: operations.GitignoreGetTemplateRequest) -> operations.GitignoreGetTemplateResponse:
        ...
        https://docs.github.com/enterprise-server@2.22/rest/reference/gitignore#get-a-gitignore-template - API method documentation
        """
