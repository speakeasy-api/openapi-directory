...
exports.GetFulfillmentsJsonResponse = exports.GetFulfillmentsJsonRequest = void 0;
...
var GetFulfillmentsJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetFulfillmentsJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetFulfillmentsJsonRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetFulfillmentsJsonRequest.prototype, "login", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetFulfillmentsJsonRequest.prototype, "page", void 0);
    return GetFulfillmentsJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetFulfillmentsJsonRequest = GetFulfillmentsJsonRequest;
var GetFulfillmentsJsonResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.Fulfillment }),
    ...
    ], GetFulfillmentsJsonResponse.prototype, "rawResponse", void 0);
    return GetFulfillmentsJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetFulfillmentsJsonResponse = GetFulfillmentsJsonResponse;
