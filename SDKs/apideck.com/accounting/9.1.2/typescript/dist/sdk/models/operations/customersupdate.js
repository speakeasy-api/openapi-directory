...
exports.CustomersUpdateResponse = exports.CustomersUpdateRequest = exports.CustomersUpdateSecurity = void 0;
...
var CustomersUpdateRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", shared.AccountingCustomerInput)
    ], CustomersUpdateRequest.prototype, "accountingCustomerInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], CustomersUpdateRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], CustomersUpdateRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], CustomersUpdateRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], CustomersUpdateRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], CustomersUpdateRequest.prototype, "xApideckServiceId", void 0);
...
var CustomersUpdateResponse = /** @class */ (function (_super) {
    ...
    ], CustomersUpdateResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    ], CustomersUpdateResponse.prototype, "updateCustomerResponse", void 0);
