...
export const ListConnectAppServerList = ["https://api.twilio.com"] as const;
...
export class ListConnectAppListConnectAppResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.ApiV2010AccountConnectApp })
  @Expose({ name: "connect_apps" })
  @Type(() => shared.ApiV2010AccountConnectApp)
