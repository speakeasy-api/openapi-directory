...
public class HarvestOrderRequest {
    ...
    public HarvestOrderRequest(@JsonProperty("accountId") Integer accountId, @JsonProperty("beezUPOrderId") String beezUPOrderId, @JsonProperty("marketplaceTechnicalCode") String marketplaceTechnicalCode) {
        this.accountId = accountId;
        this.beezUPOrderId = beezUPOrderId;
        this.marketplaceTechnicalCode = marketplaceTechnicalCode;
  }
