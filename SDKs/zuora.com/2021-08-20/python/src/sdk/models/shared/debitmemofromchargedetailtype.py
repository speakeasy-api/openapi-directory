...
class DebitMemoFromChargeDetailTypeFinanceInformation:
    r"""Container for the finance information related to the product rate plan charge associated with the debit memo."""
...
class DebitMemoFromChargeDetailType:
    ...
    r"""The ID of the product rate plan charge that the debit memo is created from.
    ...
    **Note**: This field is only available if you set the `zuora-version` request header to `257.0` or later.
    ...
    r"""The amount of the debit memo item.
    ...
    **Note**: This field is only available if you set the `zuora-version` request header to `257.0` or later.
    """  
    finance_information: Optional[DebitMemoFromChargeDetailTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the product rate plan charge associated with the debit memo."""  
    ...
    **Note**: This field is not available if you set the `zuora-version` request header to `224.0` or later.
    ...
    r"""The service end date of the debit memo item. If not specified, the effective end date of the corresponding product rate plan will be used."""  
    ...
    r"""The service start date of the debit memo item. If not specified, the effective start date of the corresponding product rate plan will be used."""  
