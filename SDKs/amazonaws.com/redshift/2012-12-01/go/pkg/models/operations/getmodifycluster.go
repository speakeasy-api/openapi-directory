...
func (e *GETModifyClusterActionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "ModifyCluster":
		*e = GETModifyClusterActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETModifyClusterActionEnum: %s", s)
	}
}
...
func (e *GETModifyClusterVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2012-12-01":
		*e = GETModifyClusterVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETModifyClusterVersionEnum: %s", s)
	}
}
