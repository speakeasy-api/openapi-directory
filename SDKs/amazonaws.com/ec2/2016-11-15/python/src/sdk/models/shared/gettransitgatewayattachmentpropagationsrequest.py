...
class GetTransitGatewayAttachmentPropagationsRequestFilters:
...
class GetTransitGatewayAttachmentPropagationsRequest:
    ...
    filters: Optional[list[GetTransitGatewayAttachmentPropagationsRequestFilters]] = dataclasses.field(default=None)  
