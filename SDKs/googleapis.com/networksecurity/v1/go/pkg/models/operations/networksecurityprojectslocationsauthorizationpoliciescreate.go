...
type NetworksecurityProjectsLocationsAuthorizationPoliciesCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type NetworksecurityProjectsLocationsAuthorizationPoliciesCreatePathParams struct {
...
type NetworksecurityProjectsLocationsAuthorizationPoliciesCreateQueryParams struct {
	// V1 error format.
	...
	AuthorizationPolicyID *string `queryParam:"style=form,explode=true,name=authorizationPolicyId"`
	// JSONP
...
type NetworksecurityProjectsLocationsAuthorizationPoliciesCreateResponse struct {
	ContentType string
	// Successful response
