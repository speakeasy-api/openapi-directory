...
public class DeregisterClusterResponse {
    ...
    public DeregisterClusterResponse withAccessDeniedException(Object accessDeniedException) {
    ...
    public org.openapis.openapi.models.shared.DeregisterClusterResponse deregisterClusterResponse;

    public DeregisterClusterResponse withDeregisterClusterResponse(org.openapis.openapi.models.shared.DeregisterClusterResponse deregisterClusterResponse) {
    ...
    public DeregisterClusterResponse withStatusCode(Integer statusCode) {
    ...
    public DeregisterClusterResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public DeregisterClusterResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
