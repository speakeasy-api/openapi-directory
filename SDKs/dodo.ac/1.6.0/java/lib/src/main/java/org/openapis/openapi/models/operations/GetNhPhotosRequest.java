...
public class GetNhPhotosRequest {
    ...
    public GetNhPhotosRequest withAcceptVersion(String acceptVersion) {
    ...
    public GetNhPhotosRequest withXApiKey(String xApiKey) {
    ...
    public GetNhPhotosRequest withExcludedetails(String excludedetails) {
        this.excludedetails = excludedetails;
        return this;
    }
    
    public GetNhPhotosRequest(@JsonProperty("Accept-Version") String acceptVersion, @JsonProperty("X-API-KEY") String xApiKey) {
        this.acceptVersion = acceptVersion;
        this.xApiKey = xApiKey;
  }
}
