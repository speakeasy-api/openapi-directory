...
export class GetAutomationRunsRequest extends SpeakeasyBase {
  /**
...
export class GetAutomationRunsResponse extends SpeakeasyBase {
  /**
   * A list of AutomationRuns objects.
   */
  @SpeakeasyMetadata({ elemType: shared.AutomationRunEntity })
