...
class AccountSummaries:
    ...
    def analyticsadmin_account_summaries_list(self, request: operations.AnalyticsadminAccountSummariesListRequest) -> operations.AnalyticsadminAccountSummariesListResponse:
        r"""Returns summaries of all accounts accessible by the caller.
        """
        
        base_url = self._server_url
        
        url = base_url.removesuffix("/") + "/v1beta/accountSummaries"
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GoogleAnalyticsAdminV1betaListAccountSummariesResponse])
                res.google_analytics_admin_v1beta_list_account_summaries_response = out
