...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GamesByDateRequest req = new GamesByDateRequest("unde", GamesByDateFormatEnum.JSON);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GamesByDateBasicRequest req = new GamesByDateBasicRequest("corrupti", GamesByDateBasicFormatEnum.JSON);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PlayersByTeamRequest req = new PlayersByTeamRequest(PlayersByTeamFormatEnum.XML, "suscipit");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PlayersByTeamBasicRequest req = new PlayersByTeamBasicRequest(PlayersByTeamBasicFormatEnum.XML, "minus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SchedulesRequest req = new SchedulesRequest(SchedulesFormatEnum.JSON, "iusto");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SchedulesBasicRequest req = new SchedulesBasicRequest(SchedulesBasicFormatEnum.JSON, "nisi");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            StandingsRequest req = new StandingsRequest(StandingsFormatEnum.JSON, "ab");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            TeamGameLogsBySeasonRequest req = new TeamGameLogsBySeasonRequest(TeamGameLogsBySeasonFormatEnum.XML, "veritatis", "deserunt", "perferendis");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            TeamGameStatsByDateRequest req = new TeamGameStatsByDateRequest("ipsam", TeamGameStatsByDateFormatEnum.JSON);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            TeamSeasonStatsRequest req = new TeamSeasonStatsRequest(TeamSeasonStatsFormatEnum.JSON, "quo");            
