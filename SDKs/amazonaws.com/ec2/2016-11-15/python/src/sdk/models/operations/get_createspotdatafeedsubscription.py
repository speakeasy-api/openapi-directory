...
class GETCreateSpotDatafeedSubscriptionRequest:
    ...
    r"""The name of the Amazon S3 bucket in which to store the Spot Instance data feed. For more information about bucket names, see <a href=\\"https://docs.aws.amazon.com/AmazonS3/latest/dev/BucketRestrictions.html#bucketnamingrules\\">Rules for bucket naming</a> in the <i>Amazon S3 Developer Guide</i>."""  
    ...
    r"""The prefix for the data feed file names."""  
