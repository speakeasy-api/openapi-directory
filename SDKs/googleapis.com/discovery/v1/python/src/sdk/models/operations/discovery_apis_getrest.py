...
from ..shared import restdescription as shared_restdescription
...
class DiscoveryApisGetRestResponse:
    ...
    rest_description: Optional[shared_restdescription.RestDescription] = dataclasses.field(default=None)
