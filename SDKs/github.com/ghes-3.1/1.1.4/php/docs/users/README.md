...
try {
    ...
    $request->targetUser = 'libero';
    $request->username = 'Letitia_Blanda83';
...
try {
    ...
    $request->armoredPublicKey = 'aperiam';
...
try {
    ...
    $request->username = 'Rosendo_Legros26';
...
try {
    ...
    $request->perPage = 769047;
    $request->since = 302878;
...
try {
    ...
    $request->page = 671528;
    $request->perPage = 748973;
    $request->username = 'Rosa36';
...
try {
    ...
    $request->page = 642804;
    $request->perPage = 584640;
    $request->username = 'Imelda.Crona32';
...
try {
    ...
    $request->username = 'Candace_Connelly';
...
try {
    ...
    $request->page = 199879;
    $request->perPage = 57909;
    $request->username = 'King.Greenfelder';
