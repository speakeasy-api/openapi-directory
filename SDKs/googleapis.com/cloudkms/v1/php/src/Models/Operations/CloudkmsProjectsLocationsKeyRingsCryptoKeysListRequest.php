...
class CloudkmsProjectsLocationsKeyRingsCryptoKeysListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CloudkmsProjectsLocationsKeyRingsCryptoKeysListVersionViewEnum $versionView
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=versionView')]
    public ?CloudkmsProjectsLocationsKeyRingsCryptoKeysListVersionViewEnum $versionView = null;
