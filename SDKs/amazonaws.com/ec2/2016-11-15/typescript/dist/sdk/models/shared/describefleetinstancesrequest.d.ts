 ...
 */
export declare class DescribeFleetInstancesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeFleetInstancesRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeFleetInstancesRequestFilters[];
    fleetId: string;
    maxResults?: number;
    nextToken?: string;
}
