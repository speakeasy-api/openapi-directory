...
class DescribeEcsClustersRequest:
    ...
    describe_ecs_clusters_request: shared_describeecsclustersrequest.DescribeEcsClustersRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
