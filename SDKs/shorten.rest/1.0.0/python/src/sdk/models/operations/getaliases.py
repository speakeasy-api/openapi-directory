...
class GetAliasesRequest:
    ...
    r"""An ID returned by a previous query to continue aliases retrieval (see lastId in response)"""  
    ...
    r"""The domain name to get the aliases for (string without `http/https` or `/`)"""  
...
class GetAliasesResponse:
    ...
    r"""returns Array of aliases with lastId"""  
