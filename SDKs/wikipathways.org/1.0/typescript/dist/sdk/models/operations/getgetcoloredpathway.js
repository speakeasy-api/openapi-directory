...
exports.GetGetColoredPathwayResponse = exports.GetGetColoredPathwayRequest = exports.GetGetColoredPathwayFormatEnum = void 0;
...
var GetGetColoredPathwayRequest = /** @class */ (function (_super) {
    ...
    ], GetGetColoredPathwayRequest.prototype, "color", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fileType",
        }),
        __metadata("design:type", String)
    ], GetGetColoredPathwayRequest.prototype, "fileType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=format",
        }),
        __metadata("design:type", String)
    ], GetGetColoredPathwayRequest.prototype, "format", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=graphId",
        }),
        __metadata("design:type", Array)
    ], GetGetColoredPathwayRequest.prototype, "graphId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=pwId" }),
        __metadata("design:type", String)
    ], GetGetColoredPathwayRequest.prototype, "pwId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=revision",
        }),
        __metadata("design:type", String)
    ], GetGetColoredPathwayRequest.prototype, "revision", void 0);
...
var GetGetColoredPathwayResponse = /** @class */ (function (_super) {
    ...
    ], GetGetColoredPathwayResponse.prototype, "rawResponse", void 0);
