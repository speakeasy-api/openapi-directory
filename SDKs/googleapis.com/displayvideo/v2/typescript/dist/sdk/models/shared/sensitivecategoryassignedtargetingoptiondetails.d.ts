 ...
 */
export declare enum SensitiveCategoryAssignedTargetingOptionDetailsExcludedSensitiveCategoryEnum {
 ...
 */
export declare class SensitiveCategoryAssignedTargetingOptionDetails extends SpeakeasyBase {
    /**
     * Required. An enum for the DV360 Sensitive category content classified to be EXCLUDED.
     */
