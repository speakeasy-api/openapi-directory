...
@dataclasses.dataclass
class CompanyNotificationIDDefaultApplicationJSON:
...
class CompanyNotificationIDResponse:
    ...
    company_notification_id_200_application_json_objects: Optional[list[CompanyNotificationID200ApplicationJSON]] = dataclasses.field(default=None)
    r"""List of monitor webhooks"""  
    company_notification_id_default_application_json_object: Optional[CompanyNotificationIDDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Detailed information about the error"""  
