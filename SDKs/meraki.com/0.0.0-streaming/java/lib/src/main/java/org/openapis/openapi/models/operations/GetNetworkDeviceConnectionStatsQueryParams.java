...
public class GetNetworkDeviceConnectionStatsQueryParams {
    /**
     * Filter results by AP Tag
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=apTag")
    public String apTag;
    public GetNetworkDeviceConnectionStatsQueryParams withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkDeviceConnectionStatsQueryParams withBand(GetNetworkDeviceConnectionStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public Long ssid;
    public GetNetworkDeviceConnectionStatsQueryParams withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetNetworkDeviceConnectionStatsQueryParams withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetNetworkDeviceConnectionStatsQueryParams withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkDeviceConnectionStatsQueryParams withTimespan(Float timespan) {
    ...
    public Long vlan;
    public GetNetworkDeviceConnectionStatsQueryParams withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
