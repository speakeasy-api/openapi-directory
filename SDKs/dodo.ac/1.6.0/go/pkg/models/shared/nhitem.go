...
func (e NHItemMaterialTypeEnum) ToPointer() *NHItemMaterialTypeEnum {
	return &e
}
...
func (e *NHItemMaterialTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Egg":
		fallthrough
	case "Plant":
		*e = NHItemMaterialTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NHItemMaterialTypeEnum: %v", v)
	}
}
...
func (e NHItemPlantTypeEnum) ToPointer() *NHItemPlantTypeEnum {
	return &e
}
...
func (e *NHItemPlantTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Bush":
		fallthrough
	case "Tree":
		*e = NHItemPlantTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NHItemPlantTypeEnum: %v", v)
	}
}
