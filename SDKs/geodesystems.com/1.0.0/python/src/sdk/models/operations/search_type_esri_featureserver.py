...
class SearchTypeEsriFeatureserverQueryParams:
...
@dataclasses.dataclass
class SearchTypeEsriFeatureserverRequest:
    query_params: SearchTypeEsriFeatureserverQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeEsriFeatureserverResponse:
