...
from ..shared import cloudjobschedule as shared_cloudjobschedule
...
class JobScheduleGetRequest:
    ...
    r"""The id of the job schedule to get."""  
...
class JobScheduleGetResponse:
    ...
    cloud_job_schedule: Optional[shared_cloudjobschedule.CloudJobSchedule] = dataclasses.field(default=None)  
