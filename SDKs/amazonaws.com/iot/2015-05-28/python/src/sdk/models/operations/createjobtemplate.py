...
class CreateJobTemplateRequestBody:
    ...
    abort_config: Optional[CreateJobTemplateRequestBodyAbortConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('abortConfig') }})
    ...
    job_executions_rollout_config: Optional[CreateJobTemplateRequestBodyJobExecutionsRolloutConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('jobExecutionsRolloutConfig') }})
    presigned_url_config: Optional[CreateJobTemplateRequestBodyPresignedURLConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('presignedUrlConfig') }})
    tags: Optional[list[shared_tag.Tag]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tags') }})
    timeout_config: Optional[CreateJobTemplateRequestBodyTimeoutConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('timeoutConfig') }})
    

@dataclasses.dataclass
class CreateJobTemplateRequest:
    headers: CreateJobTemplateHeaders = dataclasses.field()
    path_params: CreateJobTemplatePathParams = dataclasses.field()
    request: CreateJobTemplateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
