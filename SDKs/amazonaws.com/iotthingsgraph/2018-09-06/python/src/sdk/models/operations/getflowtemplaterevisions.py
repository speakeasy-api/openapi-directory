...
class GetFlowTemplateRevisionsRequest:
    ...
    get_flow_template_revisions_request: shared_getflowtemplaterevisionsrequest.GetFlowTemplateRevisionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
