...
class GetQuoteAuthorsSearchQueryParams:
...
class GetQuoteAuthorsSearchRequest:
    query_params: GetQuoteAuthorsSearchQueryParams = dataclasses.field()
    security: GetQuoteAuthorsSearchSecurity = dataclasses.field()
