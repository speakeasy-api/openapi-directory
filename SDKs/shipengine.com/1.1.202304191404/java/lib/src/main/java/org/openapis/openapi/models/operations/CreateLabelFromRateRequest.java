...
public class CreateLabelFromRateRequest {
    ...
    public CreateLabelFromRateRequest(@JsonProperty("create_label_from_rate_request_body") org.openapis.openapi.models.shared.CreateLabelFromRateRequestBody createLabelFromRateRequestBody, @JsonProperty("rate_id") String rateId) {
        this.createLabelFromRateRequestBody = createLabelFromRateRequestBody;
        this.rateId = rateId;
  }
}
