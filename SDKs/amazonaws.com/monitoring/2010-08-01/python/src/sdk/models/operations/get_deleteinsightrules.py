...
class GETDeleteInsightRulesRequest:
    ...
    r"""An array of the rule names to delete. If you need to find out the names of your rules, use <a href=\\"https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_DescribeInsightRules.html\\">DescribeInsightRules</a>."""  
