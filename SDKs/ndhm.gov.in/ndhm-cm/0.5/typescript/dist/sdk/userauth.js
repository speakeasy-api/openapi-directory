...
var UserAuth = /** @class */ (function () {
     ...
     *
    **/
    UserAuth.prototype.postV05UsersAuthConfirm = function (req, config) {
        var _a;
     ...
     *
    **/
    UserAuth.prototype.postV05UsersAuthFetchModes = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    UserAuth.prototype.postV05UsersAuthInit = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    UserAuth.prototype.postV05UsersAuthOnNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
