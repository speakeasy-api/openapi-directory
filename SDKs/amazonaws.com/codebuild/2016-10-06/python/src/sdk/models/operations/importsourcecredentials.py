...
class ImportSourceCredentialsRequest:
    ...
    import_source_credentials_input: shared_importsourcecredentialsinput.ImportSourceCredentialsInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
