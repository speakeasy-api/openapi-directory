...
public class AndroidpublisherReviewsGetRequest {
    ...
    public AndroidpublisherReviewsGetRequest withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public AndroidpublisherReviewsGetRequest withAccessToken(String accessToken) {
    ...
    public AndroidpublisherReviewsGetRequest withCallback(String callback) {
    ...
    public AndroidpublisherReviewsGetRequest withUploadType(String uploadType) {
    ...
    public AndroidpublisherReviewsGetRequest withUploadProtocol(String uploadProtocol) {
