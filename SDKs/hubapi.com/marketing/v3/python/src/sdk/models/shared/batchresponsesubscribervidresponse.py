...
from ..shared import subscribervidresponse as shared_subscribervidresponse
...
class BatchResponseSubscriberVidResponse:
    ...
    results: list[shared_subscribervidresponse.SubscriberVidResponse] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    ...
    status: BatchResponseSubscriberVidResponseStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
