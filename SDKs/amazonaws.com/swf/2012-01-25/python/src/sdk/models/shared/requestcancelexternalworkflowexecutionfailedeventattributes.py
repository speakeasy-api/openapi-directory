...
class RequestCancelExternalWorkflowExecutionFailedEventAttributes:
    r"""Provides the details of the <code>RequestCancelExternalWorkflowExecutionFailed</code> event."""
    
    cause: shared_requestcancelexternalworkflowexecutionfailedcause_enum.RequestCancelExternalWorkflowExecutionFailedCauseEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cause') }})  
