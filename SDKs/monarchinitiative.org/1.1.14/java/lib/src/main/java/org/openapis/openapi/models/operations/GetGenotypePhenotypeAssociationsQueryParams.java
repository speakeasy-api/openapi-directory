...
public class GetGenotypePhenotypeAssociationsQueryParams {
    /**
    ...
    public GetGenotypePhenotypeAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGenotypePhenotypeAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGenotypePhenotypeAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetGenotypePhenotypeAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGenotypePhenotypeAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGenotypePhenotypeAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetGenotypePhenotypeAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public String q;
    public GetGenotypePhenotypeAssociationsQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGenotypePhenotypeAssociationsQueryParams withRelation(String relation) {
    ...
    public Long rows;
    public GetGenotypePhenotypeAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetGenotypePhenotypeAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public String sort;
    public GetGenotypePhenotypeAssociationsQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetGenotypePhenotypeAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetGenotypePhenotypeAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGenotypePhenotypeAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGenotypePhenotypeAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
