...
class GetCandidateCandidateIDFilingsPathParams:
...
@dataclasses.dataclass
class GetCandidateCandidateIDFilingsQueryParams:
...
class GetCandidateCandidateIDFilingsRequest:
    path_params: GetCandidateCandidateIDFilingsPathParams = dataclasses.field()
    query_params: GetCandidateCandidateIDFilingsQueryParams = dataclasses.field()
