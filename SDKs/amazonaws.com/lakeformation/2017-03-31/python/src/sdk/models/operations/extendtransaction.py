...
class ExtendTransactionRequestBody:
    ...
    r"""The transaction to extend."""  
    

@dataclasses.dataclass
class ExtendTransactionRequest:
    
    request_body: ExtendTransactionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ExtendTransactionResponse:
    ...
    extend_transaction_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
