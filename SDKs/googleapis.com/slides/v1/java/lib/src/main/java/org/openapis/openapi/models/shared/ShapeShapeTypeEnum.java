 ...
 */
public enum ShapeShapeTypeEnum {
    ...
    IRREGULAR_SEAL1("IRREGULAR_SEAL_1"),
    IRREGULAR_SEAL2("IRREGULAR_SEAL_2"),
    ...
    ROUND1_RECTANGLE("ROUND_1_RECTANGLE"),
    ROUND2_DIAGONAL_RECTANGLE("ROUND_2_DIAGONAL_RECTANGLE"),
    ROUND2_SAME_RECTANGLE("ROUND_2_SAME_RECTANGLE"),
    RIGHT_TRIANGLE("RIGHT_TRIANGLE"),
    SMILEY_FACE("SMILEY_FACE"),
    SNIP1_RECTANGLE("SNIP_1_RECTANGLE"),
    SNIP2_DIAGONAL_RECTANGLE("SNIP_2_DIAGONAL_RECTANGLE"),
    SNIP2_SAME_RECTANGLE("SNIP_2_SAME_RECTANGLE"),
    ...
    ELLIPSE_RIBBON2("ELLIPSE_RIBBON_2"),
    ...
    private ShapeShapeTypeEnum(String value) {
        this.value = value;
    }
}
