...
exports.EurekaInfoResponse = exports.EurekaInfoRequest = exports.EurekaInfoQueryParams = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var EurekaInfoQueryParams = /** @class */ (function (_super) {
    __extends(EurekaInfoQueryParams, _super);
    function EurekaInfoQueryParams() {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=options" }),
        __metadata("design:type", String)
    ], EurekaInfoQueryParams.prototype, "options", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=params" }),
        __metadata("design:type", String)
    ], EurekaInfoQueryParams.prototype, "params", void 0);
    return EurekaInfoQueryParams;
}(utils_1.SpeakeasyBase));
exports.EurekaInfoQueryParams = EurekaInfoQueryParams;
var EurekaInfoRequest = /** @class */ (function (_super) {
    __extends(EurekaInfoRequest, _super);
    function EurekaInfoRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
exports.EurekaInfoRequest = EurekaInfoRequest;
var EurekaInfoResponse = /** @class */ (function (_super) {
    __extends(EurekaInfoResponse, _super);
    function EurekaInfoResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.EurekaInfoResponse = EurekaInfoResponse;
