...
var General = /** @class */ (function () {
    ...
    **/
    General.prototype.postCreateTestCardRanges = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostCreateTestCardRangesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/createTestCardRanges";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.createTestCardRangesResult = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
