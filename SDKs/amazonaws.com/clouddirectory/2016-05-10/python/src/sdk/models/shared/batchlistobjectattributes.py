...
class BatchListObjectAttributes:
    r"""Represents the output of a <a>ListObjectAttributes</a> operation."""
    ...
    facet_filter: Optional[shared_schemafacet.SchemaFacet] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FacetFilter'), 'exclude': lambda f: f is None }})  
