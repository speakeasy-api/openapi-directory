...
export declare class General {
     ...
     */
    postCreatePermit(req: shared.CreatePermitRequest, security: operations.PostCreatePermitSecurity, config?: AxiosRequestConfig): Promise<operations.PostCreatePermitResponse>;
    /**
     ...
     */
    postDisablePermit(req: shared.DisablePermitRequest, security: operations.PostDisablePermitSecurity, config?: AxiosRequestConfig): Promise<operations.PostDisablePermitResponse>;
    /**
