...
class TestFunction20200531PathParams:
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'Name', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class TestFunction20200531Headers:
...
class TestFunction20200531Request:
    headers: TestFunction20200531Headers = dataclasses.field()
    path_params: TestFunction20200531PathParams = dataclasses.field()
