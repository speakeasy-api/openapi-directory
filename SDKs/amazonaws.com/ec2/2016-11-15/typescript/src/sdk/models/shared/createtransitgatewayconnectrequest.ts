 ...
 */
export enum CreateTransitGatewayConnectRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateTransitGatewayConnectRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateTransitGatewayConnectRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateTransitGatewayConnectRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
