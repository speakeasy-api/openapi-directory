...
var ReverseGeocoding = /** @class */ (function () {
    function ReverseGeocoding(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ReverseGeocoding.prototype.getSearchVersionNumberReverseGeocodeCrossStreetPositionExt = function (req, config) {
    ...
    **/
    ReverseGeocoding.prototype.getSearchVersionNumberReverseGeocodePositionExt = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
