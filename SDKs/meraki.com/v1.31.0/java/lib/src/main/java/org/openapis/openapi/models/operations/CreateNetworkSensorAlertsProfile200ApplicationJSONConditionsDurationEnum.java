 ...
 */
public enum CreateNetworkSensorAlertsProfile200ApplicationJSONConditionsDurationEnum {
    ZERO("0"),
    SIXTY("60"),
    ...
    private CreateNetworkSensorAlertsProfile200ApplicationJSONConditionsDurationEnum(String value) {
        this.value = value;
    }
}
