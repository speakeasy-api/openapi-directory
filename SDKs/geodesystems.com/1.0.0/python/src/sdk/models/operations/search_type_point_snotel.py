...
class SearchTypePointSnotelQueryParams:
    ...
    search_type_point_snotel_huc_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_snotel.huc_id', 'style': 'form', 'explode': True }})
    search_type_point_snotel_huc_name: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_snotel.huc_name', 'style': 'form', 'explode': True }})
    search_type_point_snotel_network: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_snotel.network', 'style': 'form', 'explode': True }})
    search_type_point_snotel_site_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_snotel.site_id', 'style': 'form', 'explode': True }})
    search_type_point_snotel_site_number: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_snotel.site_number', 'style': 'form', 'explode': True }})
    search_type_point_snotel_state: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_snotel.state', 'style': 'form', 'explode': True }})
...
class SearchTypePointSnotelRequest:
    query_params: SearchTypePointSnotelQueryParams = dataclasses.field()
