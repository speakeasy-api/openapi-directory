...
class Connectors:
    ...
    def delete_connector(self, request: operations.DeleteConnectorRequest) -> operations.DeleteConnectorResponse:
        ...
        url = utils.generate_url(operations.DeleteConnectorRequest, base_url, '/v1/connectors/{id}', request)
    ...
    def get_connector(self, request: operations.GetConnectorRequest) -> operations.GetConnectorResponse:
        ...
        url = utils.generate_url(operations.GetConnectorRequest, base_url, '/v1/connectors/{id}', request)
        
        query_params = utils.get_query_params(operations.GetConnectorRequest, request)
        ...
        res = operations.GetConnectorResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def patch_connector(self, request: operations.PatchConnectorRequest) -> operations.PatchConnectorResponse:
        ...
        url = utils.generate_url(operations.PatchConnectorRequest, base_url, '/v1/connectors/{id}', request)
        ...
        res = operations.PatchConnectorResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.PatchConnector201ApplicationJSON])
    ...
    def post_connectors(self, request: operations.PostConnectorsRequestBody) -> operations.PostConnectorsResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.PostConnectors200ApplicationJSON])
