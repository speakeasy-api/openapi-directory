...
public class ReferenceData {
    ...
    **/
    public openapisdk.models.operations.SeatDetailsResponse seatDetails(openapisdk.models.operations.SeatDetailsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/references/seatdetails/{aircraftCode}/{cabinCode}", request.pathParams);
        ...
        openapisdk.models.operations.SeatDetailsResponse res = new openapisdk.models.operations.SeatDetailsResponse() {{
