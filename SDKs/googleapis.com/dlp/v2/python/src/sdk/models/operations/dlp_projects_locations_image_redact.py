...
class DlpProjectsLocationsImageRedactRequest:
    ...
    google_privacy_dlp_v2_redact_image_request: Optional[shared_googleprivacydlpv2redactimagerequest.GooglePrivacyDlpV2RedactImageRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
