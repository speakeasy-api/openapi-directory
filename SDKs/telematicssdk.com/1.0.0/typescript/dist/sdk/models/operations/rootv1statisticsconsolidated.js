...
exports.RootV1StatisticsConsolidatedResponse = exports.RootV1StatisticsConsolidatedRequest = void 0;
...
var RootV1StatisticsConsolidatedRequest = /** @class */ (function (_super) {
    ...
    ], RootV1StatisticsConsolidatedRequest.prototype, "appId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=CompanyId",
        }),
        __metadata("design:type", String)
    ], RootV1StatisticsConsolidatedRequest.prototype, "companyId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DeviceToken",
        }),
        __metadata("design:type", String)
    ], RootV1StatisticsConsolidatedRequest.prototype, "deviceToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EndDate",
        }),
        __metadata("design:type", String)
    ], RootV1StatisticsConsolidatedRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=InstanceId",
        }),
        __metadata("design:type", String)
    ], RootV1StatisticsConsolidatedRequest.prototype, "instanceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate",
        }),
        __metadata("design:type", String)
    ], RootV1StatisticsConsolidatedRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Tag" }),
        __metadata("design:type", String)
    ], RootV1StatisticsConsolidatedRequest.prototype, "tag", void 0);
...
var RootV1StatisticsConsolidatedResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], RootV1StatisticsConsolidatedResponse.prototype, "rawResponse", void 0);
