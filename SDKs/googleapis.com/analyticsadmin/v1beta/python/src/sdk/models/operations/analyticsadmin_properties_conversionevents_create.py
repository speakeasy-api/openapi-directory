...
class AnalyticsadminPropertiesConversionEventsCreateRequest:
    ...
    google_analytics_admin_v1beta_conversion_event_input: Optional[shared_googleanalyticsadminv1betaconversionevent.GoogleAnalyticsAdminV1betaConversionEventInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
