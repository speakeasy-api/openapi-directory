...
from ..shared import poolupdatepropertiesparameter as shared_poolupdatepropertiesparameter
...
class PoolUpdatePropertiesRequest:
    ...
    r"""The id of the pool to update."""  
    pool_update_properties_parameter: shared_poolupdatepropertiesparameter.PoolUpdatePropertiesParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
