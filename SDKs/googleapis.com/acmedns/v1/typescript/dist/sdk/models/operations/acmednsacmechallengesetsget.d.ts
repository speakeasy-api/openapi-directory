...
export declare class AcmednsAcmeChallengeSetsGetRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class AcmednsAcmeChallengeSetsGetResponse extends SpeakeasyBase {
    /**
     * Successful response
     */
