...
class OBWriteDomesticResponse5
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticResponse5Data')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticResponse5Data();
		$this->links = null;
		$this->meta = null;
	}
}
