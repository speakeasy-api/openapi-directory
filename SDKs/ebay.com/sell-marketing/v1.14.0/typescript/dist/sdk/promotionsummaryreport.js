...
var PromotionSummaryReport = /** @class */ (function () {
     ...
     */
    PromotionSummaryReport.prototype.getPromotionSummaryReport = function (req, security, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetPromotionSummaryReportResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.summaryReportResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.SummaryReportResponse);
                    }
                    break;
