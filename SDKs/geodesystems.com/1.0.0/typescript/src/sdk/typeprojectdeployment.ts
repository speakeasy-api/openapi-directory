...
export class TypeProjectDeployment {
  ...
  searchProjectDeployment(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/project_deployment";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchProjectDeploymentResponse =
        new operations.SearchProjectDeploymentResponse({
