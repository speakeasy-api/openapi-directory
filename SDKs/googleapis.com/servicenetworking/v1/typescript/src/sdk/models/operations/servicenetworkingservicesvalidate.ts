...
export class ServicenetworkingServicesValidateSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ServicenetworkingServicesValidateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ServicenetworkingServicesValidateSecurity extends SpeakeasyBase {
...
export class ServicenetworkingServicesValidateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ServicenetworkingServicesValidateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
