...
public class ProcessorSignalDecisionReportRequest {
    ...
    public ProcessorSignalDecisionReportRequest withAmountInstantlyAvailable(Double amountInstantlyAvailable) {
    ...
    public ProcessorSignalDecisionReportRequest withClientId(String clientId) {
    ...
    public ProcessorSignalDecisionReportRequest withClientTransactionId(String clientTransactionId) {
    ...
    public ProcessorSignalDecisionReportRequest withDaysFundsOnHold(Long daysFundsOnHold) {
    ...
    public ProcessorSignalDecisionReportRequest withDecisionOutcome(SignalDecisionOutcomeEnum decisionOutcome) {
    ...
    public ProcessorSignalDecisionReportRequest withInitiated(Boolean initiated) {
    ...
    public ProcessorSignalDecisionReportRequest withPaymentMethod(SignalPaymentMethodEnum paymentMethod) {
    ...
    public ProcessorSignalDecisionReportRequest withProcessorToken(String processorToken) {
    ...
    public ProcessorSignalDecisionReportRequest withSecret(String secret) {
        this.secret = secret;
        return this;
    }
