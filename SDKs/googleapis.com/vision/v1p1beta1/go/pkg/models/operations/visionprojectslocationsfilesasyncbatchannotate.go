...
type VisionProjectsLocationsFilesAsyncBatchAnnotateRequest struct {
	...
	GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest *shared.GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest `request:"mediaType=application/json"`
	// OAuth access token.
