...
exports.UpdateHrisCompanyResponse = void 0;
...
var UpdateHrisCompanyResponse = /** @class */ (function (_super) {
    ...
    ], UpdateHrisCompanyResponse.prototype, "data", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=operation" }),
        __metadata("design:type", String)
    ], UpdateHrisCompanyResponse.prototype, "operation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resource" }),
        __metadata("design:type", String)
    ], UpdateHrisCompanyResponse.prototype, "resource", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=service" }),
        __metadata("design:type", String)
    ], UpdateHrisCompanyResponse.prototype, "service", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=status" }),
        __metadata("design:type", String)
    ], UpdateHrisCompanyResponse.prototype, "status", void 0);
    __decorate([
