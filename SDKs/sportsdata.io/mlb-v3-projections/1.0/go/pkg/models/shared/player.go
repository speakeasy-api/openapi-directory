...
type Player struct {
	BatHand                             *string `json:"BatHand,omitempty"`
	...
	SportsDataID                        *string `json:"SportsDataID,omitempty"`
	...
	ThrowHand                           *string `json:"ThrowHand,omitempty"`
	UpcomingGameID                      *int64  `json:"UpcomingGameID,omitempty"`
