 ...
 */
export declare enum GetNetworkDeviceConnectionStatsBandEnum {
    Two4 = "2.4",
    Five = "5"
}
export declare class GetNetworkDeviceConnectionStatsRequest extends SpeakeasyBase {
    /**
...
export declare class GetNetworkDeviceConnectionStatsResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
