...
class GenerateDataKeyPairRequest:
    ...
    generate_data_key_pair_request: shared_generatedatakeypairrequest.GenerateDataKeyPairRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
