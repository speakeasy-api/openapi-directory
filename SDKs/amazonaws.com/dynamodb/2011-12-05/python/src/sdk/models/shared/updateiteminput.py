...
class UpdateItemInput:
    ...
    attribute_updates: dict[str, shared_attributevalueupdate.AttributeValueUpdate] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AttributeUpdates') }})
    r"""Map of attribute name to the new value and action for the update. The attribute names specify the attributes to modify, and cannot contain any primary key attributes."""  
