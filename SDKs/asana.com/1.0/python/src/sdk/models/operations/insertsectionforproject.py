...
class InsertSectionForProjectRequestBody:
    r"""The section's move action."""
    
    data: Optional[shared_projectsectioninsertrequest.ProjectSectionInsertRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
...
class InsertSectionForProjectRequest:
    ...
    request_body: InsertSectionForProjectRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The section's move action."""  
...
class InsertSectionForProject200ApplicationJSON:
    r"""Successfully moved the specified section."""
