...
func (e ClaimIntoOrganizationRequestBodyLicensesModeEnum) ToPointer() *ClaimIntoOrganizationRequestBodyLicensesModeEnum {
	return &e
}
...
func (e *ClaimIntoOrganizationRequestBodyLicensesModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "addDevices":
		fallthrough
	case "renew":
		*e = ClaimIntoOrganizationRequestBodyLicensesModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ClaimIntoOrganizationRequestBodyLicensesModeEnum: %v", v)
	}
}
