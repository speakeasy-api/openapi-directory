...
type PutInvoiceTypeTransferredToAccountingEnum string

const (
	PutInvoiceTypeTransferredToAccountingEnumProcessing PutInvoiceTypeTransferredToAccountingEnum = "Processing"
	PutInvoiceTypeTransferredToAccountingEnumYes        PutInvoiceTypeTransferredToAccountingEnum = "Yes"
	PutInvoiceTypeTransferredToAccountingEnumError      PutInvoiceTypeTransferredToAccountingEnum = "Error"
	PutInvoiceTypeTransferredToAccountingEnumIgnore     PutInvoiceTypeTransferredToAccountingEnum = "Ignore"
)

func (e *PutInvoiceTypeTransferredToAccountingEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Error":
		fallthrough
	case "Ignore":
		*e = PutInvoiceTypeTransferredToAccountingEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PutInvoiceTypeTransferredToAccountingEnum: %s", s)
	}
}

// PutInvoiceType - Container for custom fields of an Invoice object.
type PutInvoiceType struct {
	...
	//
	TransferredToAccounting *PutInvoiceTypeTransferredToAccountingEnum `json:"transferredToAccounting,omitempty"`
}
