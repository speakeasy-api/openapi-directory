...
class ListChannelListChannelResponse:
    channels: Optional[list[shared_chat_v2_service_channel.ChatV2ServiceChannel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('channels') }})
