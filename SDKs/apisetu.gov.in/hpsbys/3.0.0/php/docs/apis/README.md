...
* [rsbyc](#rsbyc) - Health Card/ Certificate
...
use \OpenAPI\OpenAPI\Models\Operations\RsbycRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\RsbycRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\RsbycRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\RsbycSecurity;
...
try {
    ...
    $request->certificateParameters = new RsbycRequestBodyCertificateParameters();
    ...
    $request->format = RsbycRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new RsbycSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->rsbyc($request, $requestSecurity);
