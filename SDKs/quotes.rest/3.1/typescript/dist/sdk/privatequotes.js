...
var PrivateQuotes = /** @class */ (function () {
     ...
     *
    **/
    PrivateQuotes.prototype.deleteQuote = function (req, config) {
    ...
    **/
    PrivateQuotes.prototype.getQuote = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.quoteResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    break;
    ...
    **/
    PrivateQuotes.prototype.getQuoteList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PrivateQuotes.prototype.patchQuote = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PrivateQuotes.prototype.postQuote = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PrivateQuotes.prototype.postQuoteTagsAdd = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PrivateQuotes.prototype.postQuoteTagsRemove = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PrivateQuotes.prototype.putQuote = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
