...
class RunPipelineActivityRequestBody:
    ...
    payloads: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payloads') }})
    r"""The sample message payloads on which the pipeline activity is run."""  
    pipeline_activity: RunPipelineActivityRequestBodyPipelineActivity = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pipelineActivity') }})
    r"""An activity that performs a transformation on a message."""  
...
class RunPipelineActivityRequest:
    ...
    request_body: RunPipelineActivityRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
