...
class AdexchangebuyerPretargetingConfigInsertRequest:
    path_params: AdexchangebuyerPretargetingConfigInsertPathParams = dataclasses.field()
    query_params: AdexchangebuyerPretargetingConfigInsertQueryParams = dataclasses.field()
    security: AdexchangebuyerPretargetingConfigInsertSecurity = dataclasses.field()
