...
var Records = /** @class */ (function () {
    function Records(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Records.prototype.chromeuxreportRecordsQueryRecord = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ChromeuxreportRecordsQueryRecordRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/records:queryRecord";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.queryResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
