 ...
 */
export declare enum PurchaseHostReservationRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class PurchaseHostReservationRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class PurchaseHostReservationRequestTagSpecifications extends SpeakeasyBase {
...
export declare class PurchaseHostReservationRequest extends SpeakeasyBase {
    clientToken?: string;
