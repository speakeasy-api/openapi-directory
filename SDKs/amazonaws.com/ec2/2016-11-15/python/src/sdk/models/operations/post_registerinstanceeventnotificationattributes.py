...
class PostRegisterInstanceEventNotificationAttributesQueryParams:
    action: PostRegisterInstanceEventNotificationAttributesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostRegisterInstanceEventNotificationAttributesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostRegisterInstanceEventNotificationAttributesRequest:
    headers: PostRegisterInstanceEventNotificationAttributesHeaders = dataclasses.field()
    query_params: PostRegisterInstanceEventNotificationAttributesQueryParams = dataclasses.field()
