...
class DescribeCustomKeyStoresRequest:
    ...
    describe_custom_key_stores_request: shared_describecustomkeystoresrequest.DescribeCustomKeyStoresRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
