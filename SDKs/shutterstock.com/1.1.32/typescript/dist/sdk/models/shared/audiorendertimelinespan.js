...
var AudioRenderTimelineSpan = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: audiorendertimelinespaninstrumentgroup_1.AudioRenderTimelineSpanInstrumentGroup }),
        (0, class_transformer_1.Expose)({ name: "instrument_groups" }),
        (0, class_transformer_1.Type)(function () { return audiorendertimelinespaninstrumentgroup_1.AudioRenderTimelineSpanInstrumentGroup; }),
        __metadata("design:type", Array)
    ], AudioRenderTimelineSpan.prototype, "instrumentGroups", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: audiorendertimelinespanregion_1.AudioRenderTimelineSpanRegion }),
        (0, class_transformer_1.Expose)({ name: "regions" }),
        (0, class_transformer_1.Type)(function () { return audiorendertimelinespanregion_1.AudioRenderTimelineSpanRegion; }),
        __metadata("design:type", Array)
    ], AudioRenderTimelineSpan.prototype, "regions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "span_type" }),
        __metadata("design:type", String)
    ], AudioRenderTimelineSpan.prototype, "spanType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "tempo" }),
        __metadata("design:type", Number)
    ], AudioRenderTimelineSpan.prototype, "tempo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: audiorendertimelinespantempochanges_1.AudioRenderTimelineSpanTempoChanges }),
        (0, class_transformer_1.Expose)({ name: "tempo_changes" }),
        (0, class_transformer_1.Type)(function () { return audiorendertimelinespantempochanges_1.AudioRenderTimelineSpanTempoChanges; }),
        __metadata("design:type", Array)
