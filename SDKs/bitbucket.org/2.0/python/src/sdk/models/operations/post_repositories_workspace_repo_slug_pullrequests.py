...
class PostRepositoriesWorkspaceRepoSlugPullrequestsRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugPullrequestsPathParams = dataclasses.field()
    security: PostRepositoriesWorkspaceRepoSlugPullrequestsSecurity = dataclasses.field()
