...
var Swagger = /** @class */ (function () {
    function Swagger(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Swagger.prototype.deleteSwagger = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteSwaggerRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/swagger/{id}", req.pathParams);
    ...
    **/
    Swagger.prototype.updateSwagger = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Swagger.prototype.uploadSwagger = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
