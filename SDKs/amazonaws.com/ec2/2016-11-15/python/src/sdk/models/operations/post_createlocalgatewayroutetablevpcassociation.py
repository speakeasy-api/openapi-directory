...
class PostCreateLocalGatewayRouteTableVpcAssociationQueryParams:
    action: PostCreateLocalGatewayRouteTableVpcAssociationActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCreateLocalGatewayRouteTableVpcAssociationVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCreateLocalGatewayRouteTableVpcAssociationRequest:
    headers: PostCreateLocalGatewayRouteTableVpcAssociationHeaders = dataclasses.field()
    query_params: PostCreateLocalGatewayRouteTableVpcAssociationQueryParams = dataclasses.field()
