...
export class GetContactHistorySecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetContactHistoryRequest extends SpeakeasyBase {
  /**
...
export class GetContactHistoryResponse extends SpeakeasyBase {
  /**
