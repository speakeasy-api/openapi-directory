...
func (e PostServersIDActionsDisableBackupActionResponseActionStatusEnum) ToPointer() *PostServersIDActionsDisableBackupActionResponseActionStatusEnum {
	return &e
}
...
func (e *PostServersIDActionsDisableBackupActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsDisableBackupActionResponseActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsDisableBackupActionResponseActionStatusEnum: %v", v)
	}
}
