...
func (e APIV2010AccountShortCodeSmsFallbackMethodEnum) ToPointer() *APIV2010AccountShortCodeSmsFallbackMethodEnum {
	return &e
}
...
func (e *APIV2010AccountShortCodeSmsFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountShortCodeSmsFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountShortCodeSmsFallbackMethodEnum: %v", v)
	}
}
...
func (e APIV2010AccountShortCodeSmsMethodEnum) ToPointer() *APIV2010AccountShortCodeSmsMethodEnum {
	return &e
}
...
func (e *APIV2010AccountShortCodeSmsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountShortCodeSmsMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountShortCodeSmsMethodEnum: %v", v)
	}
}
