...
export declare class ClassifyImageUrlWithNoStoreRawRequest extends SpeakeasyBase {
    /**
...
export declare class ClassifyImageUrlWithNoStoreRawResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    /**
     * Error response
