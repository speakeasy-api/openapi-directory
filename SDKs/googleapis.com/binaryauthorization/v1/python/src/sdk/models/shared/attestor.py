...
class AttestorInput:
    ...
    user_owned_grafeas_note: Optional[shared_userownedgrafeasnote.UserOwnedGrafeasNoteInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('userOwnedGrafeasNote'), 'exclude': lambda f: f is None }})
...
class Attestor:
    ...
    user_owned_grafeas_note: Optional[shared_userownedgrafeasnote.UserOwnedGrafeasNote] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('userOwnedGrafeasNote'), 'exclude': lambda f: f is None }})
    r"""An user owned Grafeas note references a Grafeas Attestation.Authority Note created by the user."""  
