...
func main() {
    ...
    res, err := s.Gists.GistsCreate(ctx, operations.GistsCreateRequestBody{
        ...
        Files: map[string]GistsCreateRequestBodyFiles{
            "natus": operations.GistsCreateRequestBodyFiles{
                Content: "occaecati",
            },
            "suscipit": operations.GistsCreateRequestBodyFiles{
                Content: "adipisci",
            },
        },
...
func main() {
    ...
    res, err := s.Gists.GistsList(ctx, operations.GistsListRequest{
        Page: sdk.Int64(479754),
        PerPage: sdk.Int64(457059),
        Since: types.MustTimeFromString("2021-01-15T15:03:36.543Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Gists.GistsListForUser(ctx, operations.GistsListForUserRequest{
        Page: sdk.Int64(483706),
        PerPage: sdk.Int64(271252),
        Since: types.MustTimeFromString("2022-08-06T14:46:31.435Z"),
        Username: "Darrion67",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Gists.GistsListPublic(ctx, operations.GistsListPublicRequest{
        ...
        Since: types.MustTimeFromString("2022-03-28T13:55:18.249Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Gists.GistsListStarred(ctx, operations.GistsListStarredRequest{
        Page: sdk.Int64(399161),
        PerPage: sdk.Int64(21973),
        Since: types.MustTimeFromString("2022-08-17T05:09:58.137Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
    ...
    res, err := s.Gists.GistsUpdate(ctx, operations.GistsUpdateRequest{
        RequestBody: operations.GistsUpdateRequestBody1{
            ...
            Files: map[string]interface{}{
                "possimus": operations.GistsUpdateRequestBody1Files3{
                    Content: sdk.String("mollitia"),
                    Filename: sdk.String("laborum"),
                },
                "libero": operations.GistsUpdateRequestBody1Files1{
                    Content: "deleniti",
                    Filename: sdk.String("enim"),
                },
                "vitae": operations.GistsUpdateRequestBody1Files3{
                    Content: sdk.String("ex"),
                    Filename: sdk.String("quo"),
                },
            },
        },
        GistID: "ex",
