 ...
 */
public enum WebinarUpdateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private WebinarUpdateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
