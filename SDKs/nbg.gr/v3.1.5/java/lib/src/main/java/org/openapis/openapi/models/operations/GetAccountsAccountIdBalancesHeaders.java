...
public class GetAccountsAccountIdBalancesHeaders {
    /**
     * The unique id of the sandbox to be used
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=sandbox-id")
    public String sandboxId;
    public GetAccountsAccountIdBalancesHeaders withSandboxId(String sandboxId) {
    ...
    public GetAccountsAccountIdBalancesHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public GetAccountsAccountIdBalancesHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public GetAccountsAccountIdBalancesHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public GetAccountsAccountIdBalancesHeaders withXFapiInteractionId(String xFapiInteractionId) {
