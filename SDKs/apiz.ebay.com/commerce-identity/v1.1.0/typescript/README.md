...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/apiz.ebay.com/commerce-identity/v1.1.0/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/apiz.ebay.com/commerce-identity/v1.1.0/typescript
```
