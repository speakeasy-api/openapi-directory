...
func (e PostServersIDActionsShutdownActionResponseActionStatusEnum) ToPointer() *PostServersIDActionsShutdownActionResponseActionStatusEnum {
	return &e
}
...
func (e *PostServersIDActionsShutdownActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsShutdownActionResponseActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsShutdownActionResponseActionStatusEnum: %v", v)
	}
}
