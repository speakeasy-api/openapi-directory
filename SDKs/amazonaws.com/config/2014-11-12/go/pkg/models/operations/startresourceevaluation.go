...
type StartResourceEvaluationHeaders struct {
...
type StartResourceEvaluationRequest struct {
	Headers StartResourceEvaluationHeaders
	Request shared.StartResourceEvaluationRequest `request:"mediaType=application/json"`
}
