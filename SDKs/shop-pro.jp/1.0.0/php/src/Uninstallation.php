...
class Uninstallation 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteInstallationResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/appstore/v1/installation.json');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeleteInstallationResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->deleteInstallation200ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\DeleteInstallation200ApplicationJSON', 'json');
            }
        }
