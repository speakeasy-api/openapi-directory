...
try {
    ...
    $request->certificateParameters->name = '4 Characters of Name';
    $request->certificateParameters->refNo = 'XXXX/XX/2017';
...
* [psprt](docs/apis/README.md#psprt) - Passport/ Passport Verification
