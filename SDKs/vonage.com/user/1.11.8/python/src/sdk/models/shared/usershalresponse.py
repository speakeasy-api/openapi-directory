...
from ..shared import usersembeddedobject as shared_usersembeddedobject
...
class UsersHalResponse:
    embedded: Optional[shared_usersembeddedobject.UsersEmbeddedObject] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_embedded') }})
