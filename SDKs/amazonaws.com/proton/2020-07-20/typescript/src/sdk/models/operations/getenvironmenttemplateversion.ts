...
export enum GetEnvironmentTemplateVersionXAmzTargetEnum {
  AwsProton20200720GetEnvironmentTemplateVersion = "AwsProton20200720.GetEnvironmentTemplateVersion",
}

export class GetEnvironmentTemplateVersionRequest extends SpeakeasyBase {
...
export class GetEnvironmentTemplateVersionResponse extends SpeakeasyBase {
  /**
