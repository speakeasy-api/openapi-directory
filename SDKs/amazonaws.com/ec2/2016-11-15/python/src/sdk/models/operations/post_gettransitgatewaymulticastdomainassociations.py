...
class PostGetTransitGatewayMulticastDomainAssociationsQueryParams:
    action: PostGetTransitGatewayMulticastDomainAssociationsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetTransitGatewayMulticastDomainAssociationsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetTransitGatewayMulticastDomainAssociationsRequest:
    headers: PostGetTransitGatewayMulticastDomainAssociationsHeaders = dataclasses.field()
    query_params: PostGetTransitGatewayMulticastDomainAssociationsQueryParams = dataclasses.field()
