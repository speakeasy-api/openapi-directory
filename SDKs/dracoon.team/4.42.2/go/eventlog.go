...
//
// </details>
func (s *eventlog) RequestAuditNodeInfo(ctx context.Context, request operations.RequestAuditNodeInfoRequest) (*operations.RequestAuditNodeInfoResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/eventlog/audits/node_info"
	...
	res := &operations.RequestAuditNodeInfoResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.AuditNodeInfoResponse
