...
class TaskrouterV1WorkspaceWorkspaceCumulativeStatistics:
    ...
    tasks_created: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tasks_created'), 'exclude': lambda f: f is None }})
    r"""The total number of Tasks created."""  
