...
class GETEntityConnectionsTypeEnum(str, Enum):
    r"""Specifies whether to retrieve inbound or outbound connections for an entity.
...
class GETEntityConnectionsRequest:
    ...
    type: Optional[GETEntityConnectionsTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
    r"""Specifies whether to retrieve inbound or outbound connections for an entity.
