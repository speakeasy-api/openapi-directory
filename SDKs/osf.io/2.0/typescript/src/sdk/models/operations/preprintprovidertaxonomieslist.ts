 ...
 */
export class PreprintProviderTaxonomiesListTaxonomyAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class PreprintProviderTaxonomiesListTaxonomyLinks extends SpeakeasyBase {
  /**
 ...
 * OK
 */
export class PreprintProviderTaxonomiesListTaxonomy extends SpeakeasyBase {
  /**
   * The properties of the taxonomy entity.
   */
  @SpeakeasyMetadata()
