...
exports.ListExecutionResponse = exports.ListExecutionListExecutionResponse = exports.ListExecutionListExecutionResponseMeta = exports.ListExecutionRequest = exports.ListExecutionSecurity = exports.ListExecutionServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListExecutionServerList = ["https://studio.twilio.com"];
var ListExecutionSecurity = /** @class */ (function (_super) {
    ...
    ], ListExecutionSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListExecutionSecurity.prototype, "username", void 0);
    return ListExecutionSecurity;
}(utils_1.SpeakeasyBase));
exports.ListExecutionSecurity = ListExecutionSecurity;
var ListExecutionRequest = /** @class */ (function (_super) {
    ...
    ], ListExecutionRequest.prototype, "dateCreatedFrom", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreatedTo;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ListExecutionRequest.prototype, "dateCreatedTo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=FlowSid",
        }),
        __metadata("design:type", String)
    ], ListExecutionRequest.prototype, "flowSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListExecutionRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListExecutionRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListExecutionRequest.prototype, "pageToken", void 0);
    return ListExecutionRequest;
}(utils_1.SpeakeasyBase));
exports.ListExecutionRequest = ListExecutionRequest;
...
exports.ListExecutionListExecutionResponseMeta = ListExecutionListExecutionResponseMeta;
/**
 * OK
 */
var ListExecutionListExecutionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.StudioV1FlowExecution }),
        (0, class_transformer_1.Expose)({ name: "executions" }),
        (0, class_transformer_1.Type)(function () { return shared.StudioV1FlowExecution; }),
        __metadata("design:type", Array)
    ], ListExecutionListExecutionResponse.prototype, "executions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListExecutionListExecutionResponseMeta; }),
...
exports.ListExecutionListExecutionResponse = ListExecutionListExecutionResponse;
var ListExecutionResponse = /** @class */ (function (_super) {
    ...
    ], ListExecutionResponse.prototype, "rawResponse", void 0);
    return ListExecutionResponse;
}(utils_1.SpeakeasyBase));
exports.ListExecutionResponse = ListExecutionResponse;
