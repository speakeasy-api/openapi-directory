...
class CreateFargateProfileRequestBody:
    fargate_profile_name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('fargateProfileName') }})
    pod_execution_role_arn: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('podExecutionRoleArn') }})
...
class CreateFargateProfileRequest:
    headers: CreateFargateProfileHeaders = dataclasses.field()
    path_params: CreateFargateProfilePathParams = dataclasses.field()
    request: CreateFargateProfileRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
