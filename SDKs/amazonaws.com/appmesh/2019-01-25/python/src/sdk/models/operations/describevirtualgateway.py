...
from ..shared import describevirtualgatewayoutput as shared_describevirtualgatewayoutput
...
class DescribeVirtualGatewayRequest:
    headers: DescribeVirtualGatewayHeaders = dataclasses.field()
    path_params: DescribeVirtualGatewayPathParams = dataclasses.field()
    query_params: DescribeVirtualGatewayQueryParams = dataclasses.field()
...
class DescribeVirtualGatewayResponse:
    ...
    describe_virtual_gateway_output: Optional[shared_describevirtualgatewayoutput.DescribeVirtualGatewayOutput] = dataclasses.field(default=None)
