...
class PutUsersRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the Users dataset you are adding the user or users to."""  
    users: list[shared_user.User] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('users') }})
    r"""A list of user data."""  
    

@dataclasses.dataclass
class PutUsersRequest:
    
    request_body: PutUsersRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
