...
public class CreateNetworkFirmwareUpgradesRollbackRequest {
    ...
    public CreateNetworkFirmwareUpgradesRollbackRequest(@JsonProperty("RequestBody") CreateNetworkFirmwareUpgradesRollbackRequestBody requestBody, @JsonProperty("networkId") String networkId) {
        this.requestBody = requestBody;
        this.networkId = networkId;
  }
}
