...
exports.Commit = exports.CommitStats = exports.CommitParents = exports.CommitFiles = exports.CommitCommit = exports.CommitCommitTree = exports.CommitCommitGitUser = exports.CommitSimpleUser = void 0;
...
exports.CommitSimpleUser = CommitSimpleUser;
// CommitCommitGitUser
/**
...
exports.CommitCommitGitUser = CommitCommitGitUser;
...
var Commit = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=files", elemType: CommitFiles }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=parents", elemType: CommitParents }),
        __metadata("design:type", Array)
