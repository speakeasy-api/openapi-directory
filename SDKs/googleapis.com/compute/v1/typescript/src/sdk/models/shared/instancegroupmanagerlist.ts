 ...
 */
export enum InstanceGroupManagerListWarningCodeEnum {
...
export class InstanceGroupManagerListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceGroupManagerListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceGroupManagerListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class InstanceGroupManagerList extends SpeakeasyBase {
  /**
