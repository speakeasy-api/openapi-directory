...
export const ListDeviceServerList = ["https://microvisor.twilio.com"] as const;
...
export class ListDeviceListDeviceResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.MicrovisorV1Device })
  @Expose({ name: "devices" })
  @Type(() => shared.MicrovisorV1Device)
  devices?: shared.MicrovisorV1Device[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListDeviceListDeviceResponseMeta)
