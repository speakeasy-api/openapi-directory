...
export class IapUpdateIapSettingsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IapUpdateIapSettingsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IapUpdateIapSettingsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
