...
exports.InvoicesDeleteResponse = exports.InvoicesDeleteRequest = exports.InvoicesDeleteSecurity = void 0;
...
exports.InvoicesDeleteSecurity = InvoicesDeleteSecurity;
var InvoicesDeleteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], InvoicesDeleteRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], InvoicesDeleteRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], InvoicesDeleteRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], InvoicesDeleteRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], InvoicesDeleteRequest.prototype, "xApideckServiceId", void 0);
    return InvoicesDeleteRequest;
}(utils_1.SpeakeasyBase));
exports.InvoicesDeleteRequest = InvoicesDeleteRequest;
var InvoicesDeleteResponse = /** @class */ (function (_super) {
    ...
    ], InvoicesDeleteResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.InvoicesDeleteResponse = InvoicesDeleteResponse;
