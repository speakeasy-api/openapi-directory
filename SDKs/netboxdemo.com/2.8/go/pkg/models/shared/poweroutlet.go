...
func (e *PowerOutletConnectionStatusLabelEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Not Connected":
		fallthrough
	case "Connected":
		*e = PowerOutletConnectionStatusLabelEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PowerOutletConnectionStatusLabelEnum: %s", s)
	}
}

type PowerOutletConnectionStatusValueEnum string

const (
	PowerOutletConnectionStatusValueEnumFalse PowerOutletConnectionStatusValueEnum = "false"
	PowerOutletConnectionStatusValueEnumTrue  PowerOutletConnectionStatusValueEnum = "true"
)

func (e *PowerOutletConnectionStatusValueEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "false":
		fallthrough
	case "true":
		*e = PowerOutletConnectionStatusValueEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PowerOutletConnectionStatusValueEnum: %s", s)
	}
}

type PowerOutletConnectionStatus struct {
	Label PowerOutletConnectionStatusLabelEnum `json:"label"`
	Value PowerOutletConnectionStatusValueEnum `json:"value"`
}
...
func (e *PowerOutletFeedLegLabelEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "B":
		fallthrough
	case "C":
		*e = PowerOutletFeedLegLabelEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PowerOutletFeedLegLabelEnum: %s", s)
	}
}
...
func (e *PowerOutletFeedLegValueEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "B":
		fallthrough
	case "C":
		*e = PowerOutletFeedLegValueEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PowerOutletFeedLegValueEnum: %s", s)
	}
}
...
func (e *PowerOutletTypeLabelEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "ITA Type O":
		fallthrough
	case "HDOT Cx":
		*e = PowerOutletTypeLabelEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PowerOutletTypeLabelEnum: %s", s)
	}
}
...
func (e *PowerOutletTypeValueEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "ita-o":
		fallthrough
	case "hdot-cx":
		*e = PowerOutletTypeValueEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PowerOutletTypeValueEnum: %s", s)
	}
}
