...
export class GetSubstanceRoleAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetSubstanceRoleAssociationsQueryParams extends SpeakeasyBase {
...
export class GetSubstanceRoleAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetSubstanceRoleAssociationsResponse extends SpeakeasyBase {
