 ...
 */
export declare enum GoogleCloudKmsV1CryptoKeyVersionAlgorithmEnum {
 ...
 */
export declare enum GoogleCloudKmsV1CryptoKeyVersionProtectionLevelEnum {
 ...
 */
export declare enum GoogleCloudKmsV1CryptoKeyVersionStateEnum {
 ...
 */
export declare class GoogleCloudKmsV1CryptoKeyVersion extends SpeakeasyBase {
    /**
     * Output only. The CryptoKeyVersionAlgorithm that this CryptoKeyVersion supports.
     */
