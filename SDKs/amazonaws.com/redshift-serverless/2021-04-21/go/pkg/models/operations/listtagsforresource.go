...
const (
	ListTagsForResourceXAmzTargetEnumRedshiftServerlessListTagsForResource ListTagsForResourceXAmzTargetEnum = "RedshiftServerless.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "RedshiftServerless.ListTagsForResource":
