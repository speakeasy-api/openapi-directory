...
class ListCustomerProfileEvaluationListCustomerProfileEvaluationResponse:
    ...
    meta: Optional[ListCustomerProfileEvaluationListCustomerProfileEvaluationResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    results: Optional[list[shared_trusthub_v1_customer_profile_customer_profile_evaluation.TrusthubV1CustomerProfileCustomerProfileEvaluation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
