 ...
 *
 */
export enum GETJournalEntryDetailTypeStatusEnum {
  Created = "Created",
  Cancelled = "Cancelled",
}
 ...
 */
export enum GETJournalEntryDetailTypeTransferredToAccountingEnum {
  No = "No",
 ...
 *
 */
export class GETJournalEntryDetailType extends SpeakeasyBase {
  /**
