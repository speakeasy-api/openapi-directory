...
public class GetTotalsEntityTypeQueryParams {
    ...
    public GetTotalsEntityTypeQueryParams withMaxFirstF1Date(LocalDate maxFirstF1Date) {
    ...
    public GetTotalsEntityTypeQueryParams withMinFirstF1Date(LocalDate minFirstF1Date) {
