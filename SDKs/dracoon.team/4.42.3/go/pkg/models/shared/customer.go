...
func (e CustomerCustomerContractTypeEnum) ToPointer() *CustomerCustomerContractTypeEnum {
	return &e
}
...
func (e *CustomerCustomerContractTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "free":
		fallthrough
	case "pay":
		*e = CustomerCustomerContractTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CustomerCustomerContractTypeEnum: %v", v)
	}
}
