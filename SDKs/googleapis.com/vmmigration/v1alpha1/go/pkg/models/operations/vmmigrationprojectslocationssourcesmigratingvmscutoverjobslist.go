...
type VmmigrationProjectsLocationsSourcesMigratingVmsCutoverJobsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type VmmigrationProjectsLocationsSourcesMigratingVmsCutoverJobsListPathParams struct {
	// Required. The parent, which owns this collection of migrating VMs.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type VmmigrationProjectsLocationsSourcesMigratingVmsCutoverJobsListQueryParams struct {
	// V1 error format.
...
type VmmigrationProjectsLocationsSourcesMigratingVmsCutoverJobsListRequest struct {
...
type VmmigrationProjectsLocationsSourcesMigratingVmsCutoverJobsListResponse struct {
	ContentType string
	// Successful response
