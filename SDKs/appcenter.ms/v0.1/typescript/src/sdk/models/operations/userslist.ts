...
export enum UsersListDefaultApplicationJSONErrorCodeEnum {
...
export class UsersListDefaultApplicationJSONError extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
 ...
 * Error
 */
export class UsersListDefaultApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => UsersListDefaultApplicationJSONError)
 ...
 */
export enum UsersList200ApplicationJSONOriginEnum {
  Appcenter = "appcenter",
  Hockeyapp = "hockeyapp",
  Codepush = "codepush",
}

export enum UsersList200ApplicationJSONPermissionsEnum {
  Manager = "manager",
  Developer = "developer",
  Viewer = "viewer",
  Tester = "tester",
...
export class UsersListResponse extends SpeakeasyBase {
   ...
   * Success
   */
  @SpeakeasyMetadata({ elemType: UsersList200ApplicationJSON })
