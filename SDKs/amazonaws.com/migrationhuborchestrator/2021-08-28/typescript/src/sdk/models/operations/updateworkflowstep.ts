 ...
 */
export enum UpdateWorkflowStepRequestBodyStatusEnum {
 ...
 */
export enum UpdateWorkflowStepRequestBodyStepActionTypeEnum {
  Manual = "MANUAL",
  Automated = "AUTOMATED",
}
 ...
 */
export class UpdateWorkflowStepRequestBodyWorkflowStepAutomationConfiguration extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "command" })
...
export class UpdateWorkflowStepRequestBody extends SpeakeasyBase {
  /**
  ...
  @Type(() => UpdateWorkflowStepRequestBodyWorkflowStepAutomationConfiguration)
  workflowStepAutomationConfiguration?: UpdateWorkflowStepRequestBodyWorkflowStepAutomationConfiguration;
}

export class UpdateWorkflowStepRequest extends SpeakeasyBase {
