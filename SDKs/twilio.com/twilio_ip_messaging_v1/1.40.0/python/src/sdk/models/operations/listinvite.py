...
class ListInviteListInviteResponse:
    ...
    invites: Optional[list[shared_ip_messaging_v1_service_channel_invite.IPMessagingV1ServiceChannelInvite]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('invites'), 'exclude': lambda f: f is None }})  
