...
import { NotificationEndpointsScopedList } from "./notificationendpointsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum NotificationEndpointAggregatedListWarningCodeEnum {
...
export declare class NotificationEndpointAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NotificationEndpointAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: NotificationEndpointAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: NotificationEndpointAggregatedListWarningData[];
    /**
 ...
 */
export declare class NotificationEndpointAggregatedList extends SpeakeasyBase {
    /**
     ...
     */
    items?: Record<string, NotificationEndpointsScopedList>;
    /**
     * Type of resource.
     */
    kind?: string;
     ...
     * [Output Only] Informational warning message.
     */
    warning?: NotificationEndpointAggregatedListWarning;
}
