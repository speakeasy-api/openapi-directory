...
public class GetMeCommentsQueryParams {
    /**
    ...
    public GetMeCommentsQueryParams withCallback(String callback) {
    ...
    public GetMeCommentsQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeCommentsQueryParams withFromdate(Long fromdate) {
    ...
    public String max;
    public GetMeCommentsQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetMeCommentsQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetMeCommentsQueryParams withOrder(GetMeCommentsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetMeCommentsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeCommentsQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetMeCommentsQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetMeCommentsQueryParams withSort(GetMeCommentsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetMeCommentsQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
