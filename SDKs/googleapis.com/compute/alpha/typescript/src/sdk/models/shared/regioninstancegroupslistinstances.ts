 ...
 */
export enum RegionInstanceGroupsListInstancesWarningCodeEnum {
...
export class RegionInstanceGroupsListInstancesWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class RegionInstanceGroupsListInstancesWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: RegionInstanceGroupsListInstancesWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class RegionInstanceGroupsListInstances extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceWithNamedPorts })
  @Expose({ name: "items" })
