...
exports.GetAccountsAccountIdStatementsStatementIdResponse = exports.GetAccountsAccountIdStatementsStatementIdRequest = exports.GetAccountsAccountIdStatementsStatementIdSecurity = void 0;
...
var GetAccountsAccountIdStatementsStatementIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=sandbox-id",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdRequest.prototype, "sandboxId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=statementId",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdRequest.prototype, "statementId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdStatementsStatementIdRequest.prototype, "xFapiInteractionId", void 0);
...
var GetAccountsAccountIdStatementsStatementIdResponse = /** @class */ (function (_super) {
    ...
    ], GetAccountsAccountIdStatementsStatementIdResponse.prototype, "rawResponse", void 0);
