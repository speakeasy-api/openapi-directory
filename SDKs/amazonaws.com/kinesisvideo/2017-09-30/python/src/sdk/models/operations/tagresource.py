...
class TagResourceRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the signaling channel to which you want to add tags."""  
    tags: list[shared_tag.Tag] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Tags') }})
    r"""A list of tags to associate with the specified signaling channel. Each tag is a key-value pair."""  
