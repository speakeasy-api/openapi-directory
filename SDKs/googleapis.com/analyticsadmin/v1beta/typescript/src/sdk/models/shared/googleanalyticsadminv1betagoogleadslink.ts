...
**/
export class GoogleAnalyticsAdminV1betaGoogleAdsLink extends SpeakeasyBase {
 ...
 * A link between a GA4 property and a Google Ads account.
**/
export class GoogleAnalyticsAdminV1betaGoogleAdsLinkInput extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=adsPersonalizationEnabled" })
  adsPersonalizationEnabled?: boolean;
