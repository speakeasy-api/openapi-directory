...
exports.PostContainersFloatingIpsIpReleaseResponse = exports.PostContainersFloatingIpsIpReleaseRequest = void 0;
...
var PostContainersFloatingIpsIpReleaseRequest = /** @class */ (function (_super) {
    ...
    ], PostContainersFloatingIpsIpReleaseRequest.prototype, "xAuthProjectId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Auth-Token",
        }),
        __metadata("design:type", String)
    ], PostContainersFloatingIpsIpReleaseRequest.prototype, "xAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=ip" }),
        __metadata("design:type", String)
    ], PostContainersFloatingIpsIpReleaseRequest.prototype, "ip", void 0);
...
var PostContainersFloatingIpsIpReleaseResponse = /** @class */ (function (_super) {
    ...
    ], PostContainersFloatingIpsIpReleaseResponse.prototype, "rawResponse", void 0);
