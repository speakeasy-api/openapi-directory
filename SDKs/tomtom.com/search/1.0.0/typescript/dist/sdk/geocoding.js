...
var Geocoding = /** @class */ (function () {
    function Geocoding(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Geocoding.prototype.getSearchVersionNumberGeocodeQueryExt = function (req, config) {
    ...
    **/
    Geocoding.prototype.getSearchVersionNumberStructuredGeocodeExt = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
