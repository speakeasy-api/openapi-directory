...
class Shares:
    ...
    def create_download_share(self, request: operations.CreateDownloadShareRequest) -> operations.CreateDownloadShareResponse:
        ...
        * `password` is limited to **1024** characters.
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "create_download_share_request", 'json')
        ...
        res = operations.CreateDownloadShareResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DownloadShare])
    ...
    def create_upload_share(self, request: operations.CreateUploadShareRequest) -> operations.CreateUploadShareResponse:
        ...
        * `password` is limited to **1024** characters.
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_upload_share_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateUploadShareResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UploadShare])
    ...
    def delete_download_shares(self, request: operations.DeleteDownloadSharesRequest) -> operations.DeleteDownloadSharesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_download_shares_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteDownloadSharesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_upload_shares(self, request: operations.DeleteUploadSharesRequest) -> operations.DeleteUploadSharesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_upload_shares_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteUploadSharesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_download_share(self, request: operations.RemoveDownloadShareRequest) -> operations.RemoveDownloadShareResponse:
        ...
        url = utils.generate_url(operations.RemoveDownloadShareRequest, base_url, '/v4/shares/downloads/{share_id}', request)
        ...
        res = operations.RemoveDownloadShareResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_upload_share(self, request: operations.RemoveUploadShareRequest) -> operations.RemoveUploadShareResponse:
        ...
        url = utils.generate_url(operations.RemoveUploadShareRequest, base_url, '/v4/shares/uploads/{share_id}', request)
        ...
        res = operations.RemoveUploadShareResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_download_share(self, request: operations.RequestDownloadShareRequest) -> operations.RequestDownloadShareResponse:
        ...
        url = utils.generate_url(operations.RequestDownloadShareRequest, base_url, '/v4/shares/downloads/{share_id}', request)
        ...
        res = operations.RequestDownloadShareResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_download_share_qr(self, request: operations.RequestDownloadShareQrRequest) -> operations.RequestDownloadShareQrResponse:
        ...
        url = utils.generate_url(operations.RequestDownloadShareQrRequest, base_url, '/v4/shares/downloads/{share_id}/qr', request)
        ...
        res = operations.RequestDownloadShareQrResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_download_shares(self, request: operations.RequestDownloadSharesRequest) -> operations.RequestDownloadSharesResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestDownloadSharesRequest, request)
        ...
        res = operations.RequestDownloadSharesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DownloadShareList])
    ...
    def request_upload_share(self, request: operations.RequestUploadShareRequest) -> operations.RequestUploadShareResponse:
        ...
        url = utils.generate_url(operations.RequestUploadShareRequest, base_url, '/v4/shares/uploads/{share_id}', request)
        ...
        res = operations.RequestUploadShareResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_upload_share_qr(self, request: operations.RequestUploadShareQrRequest) -> operations.RequestUploadShareQrResponse:
        ...
        url = utils.generate_url(operations.RequestUploadShareQrRequest, base_url, '/v4/shares/uploads/{share_id}/qr', request)
        ...
        res = operations.RequestUploadShareQrResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_upload_shares(self, request: operations.RequestUploadSharesRequest) -> operations.RequestUploadSharesResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestUploadSharesRequest, request)
        ...
        res = operations.RequestUploadSharesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UploadShareList])
    ...
    def send_download_share_link_via_email(self, request: operations.SendDownloadShareLinkViaEmailRequest) -> operations.SendDownloadShareLinkViaEmailResponse:
        ...
        * Forbidden characters in the email body: [`<`, `>`]
        ...
        url = utils.generate_url(operations.SendDownloadShareLinkViaEmailRequest, base_url, '/v4/shares/downloads/{share_id}/email', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "download_share_link_email", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SendDownloadShareLinkViaEmailResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def send_upload_share_link_via_email(self, request: operations.SendUploadShareLinkViaEmailRequest) -> operations.SendUploadShareLinkViaEmailResponse:
        ...
        * Forbidden characters in the email body: [`<`, `>`]
        ...
        url = utils.generate_url(operations.SendUploadShareLinkViaEmailRequest, base_url, '/v4/shares/uploads/{share_id}/email', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "upload_share_link_email", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SendUploadShareLinkViaEmailResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_download_share(self, request: operations.UpdateDownloadShareRequest) -> operations.UpdateDownloadShareResponse:
        ...
        * `password` is limited to **1024** characters.
        ...
        url = utils.generate_url(operations.UpdateDownloadShareRequest, base_url, '/v4/shares/downloads/{share_id}', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_download_share_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateDownloadShareResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_download_shares(self, request: operations.UpdateDownloadSharesRequest) -> operations.UpdateDownloadSharesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_download_shares_bulk_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateDownloadSharesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code in [200, 204]:
            pass
        elif http_res.status_code in [400, 401, 403, 404, 406, 412, 502]:
    ...
    def update_upload_share(self, request: operations.UpdateUploadShareRequest) -> operations.UpdateUploadShareResponse:
        ...
        * `password` is limited to **1024** characters.
        ...
        url = utils.generate_url(operations.UpdateUploadShareRequest, base_url, '/v4/shares/uploads/{share_id}', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_upload_share_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateUploadShareResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_upload_shares(self, request: operations.UpdateUploadSharesRequest) -> operations.UpdateUploadSharesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_upload_shares_bulk_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateUploadSharesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
