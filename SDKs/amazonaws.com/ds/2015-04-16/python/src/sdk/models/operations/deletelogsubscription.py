...
class DeleteLogSubscriptionRequest:
    ...
    delete_log_subscription_request: shared_deletelogsubscriptionrequest.DeleteLogSubscriptionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
