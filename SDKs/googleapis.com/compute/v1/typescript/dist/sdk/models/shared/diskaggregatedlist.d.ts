...
import { DisksScopedList } from "./disksscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum DiskAggregatedListWarningCodeEnum {
...
export declare class DiskAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class DiskAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: DiskAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: DiskAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class DiskAggregatedList extends SpeakeasyBase {
    /**
