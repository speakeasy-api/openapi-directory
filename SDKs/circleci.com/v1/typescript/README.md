...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/circleci.com/v1/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/circleci.com/v1/typescript
```
