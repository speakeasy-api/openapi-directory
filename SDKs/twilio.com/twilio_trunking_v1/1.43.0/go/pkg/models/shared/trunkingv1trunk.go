...
// TrunkingV1TrunkDisasterRecoveryMethodEnum - The HTTP method we use to call the `disaster_recovery_url`. Can be: `GET` or `POST`.
...
func (e TrunkingV1TrunkDisasterRecoveryMethodEnum) ToPointer() *TrunkingV1TrunkDisasterRecoveryMethodEnum {
	return &e
}

func (e *TrunkingV1TrunkDisasterRecoveryMethodEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = TrunkingV1TrunkDisasterRecoveryMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TrunkingV1TrunkDisasterRecoveryMethodEnum: %v", v)
	}
}
