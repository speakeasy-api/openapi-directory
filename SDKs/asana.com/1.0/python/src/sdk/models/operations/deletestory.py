...
class DeleteStoryRequest:
    path_params: DeleteStoryPathParams = dataclasses.field()
    query_params: DeleteStoryQueryParams = dataclasses.field()
...
class DeleteStoryResponse:
    ...
    delete_story_200_application_json_object: Optional[DeleteStory200ApplicationJSON] = dataclasses.field(default=None)
