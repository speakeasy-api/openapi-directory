...
class FileGetNodeFilePropertiesFromTaskRequest:
    headers: FileGetNodeFilePropertiesFromTaskHeaders = dataclasses.field()
    path_params: FileGetNodeFilePropertiesFromTaskPathParams = dataclasses.field()
    query_params: FileGetNodeFilePropertiesFromTaskQueryParams = dataclasses.field()
