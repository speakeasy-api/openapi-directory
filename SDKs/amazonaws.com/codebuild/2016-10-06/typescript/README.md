...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/amazonaws.com/codebuild/2016-10-06/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/amazonaws.com/codebuild/2016-10-06/typescript
```
...
const req: BatchDeleteBuildsRequest = {
  ...
  xAmzTarget: BatchDeleteBuildsXAmzTargetEnum.CodeBuild20161006BatchDeleteBuilds,
};
