...
class ApigatewayAuditConfig:
    ...
    audit_log_configs: Optional[list[shared_apigatewayauditlogconfig.ApigatewayAuditLogConfig]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auditLogConfigs'), 'exclude': lambda f: f is None }})
