...
class ListMerchantAPICredentialsResponse:
    ...
    data: Optional[list[shared_apicredential.APICredential]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""The list of API credentials."""  
