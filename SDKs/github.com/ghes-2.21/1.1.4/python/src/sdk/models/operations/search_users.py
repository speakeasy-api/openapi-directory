...
class SearchUsersSortEnum(str, Enum):
    r"""Sorts the results of your query by number of `followers` or `repositories`, or when the person `joined` GitHub Enterprise Server. Default: [best match](https://docs.github.com/enterprise-server@2.21/rest/reference/search#ranking-search-results)"""
    FOLLOWERS = 'followers'
