...
class ListCredentialListCredentialResponse:
    ...
    credentials: Optional[list[shared_notify_v1_credential.NotifyV1Credential]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials'), 'exclude': lambda f: f is None }})  
