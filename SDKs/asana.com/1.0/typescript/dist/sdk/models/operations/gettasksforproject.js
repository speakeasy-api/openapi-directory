...
exports.GetTasksForProjectResponse = exports.GetTasksForProject200ApplicationJSON = exports.GetTasksForProjectRequest = void 0;
...
var GetTasksForProjectRequest = /** @class */ (function (_super) {
    ...
    ], GetTasksForProjectRequest.prototype, "completedSince", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetTasksForProjectRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", String)
    ], GetTasksForProjectRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=opt_fields",
        }),
        __metadata("design:type", Array)
    ], GetTasksForProjectRequest.prototype, "optFields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=opt_pretty",
        }),
        __metadata("design:type", Boolean)
    ], GetTasksForProjectRequest.prototype, "optPretty", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=project_gid",
        }),
        __metadata("design:type", String)
    ], GetTasksForProjectRequest.prototype, "projectGid", void 0);
...
var GetTasksForProjectResponse = /** @class */ (function (_super) {
    ...
    ], GetTasksForProjectResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
