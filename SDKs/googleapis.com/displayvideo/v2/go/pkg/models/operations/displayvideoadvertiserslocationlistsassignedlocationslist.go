...
type DisplayvideoAdvertisersLocationListsAssignedLocationsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DisplayvideoAdvertisersLocationListsAssignedLocationsListPathParams struct {
...
type DisplayvideoAdvertisersLocationListsAssignedLocationsListQueryParams struct {
	// V1 error format.
...
type DisplayvideoAdvertisersLocationListsAssignedLocationsListRequest struct {
...
type DisplayvideoAdvertisersLocationListsAssignedLocationsListResponse struct {
	ContentType string
	// Successful response
