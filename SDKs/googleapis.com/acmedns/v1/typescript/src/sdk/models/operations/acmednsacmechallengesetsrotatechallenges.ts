...
export class AcmednsAcmeChallengeSetsRotateChallengesRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "pathParam, style=simple;explode=false;name=rootDomain",
  })
  rootDomain: string;
...
export class AcmednsAcmeChallengeSetsRotateChallengesResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
  acmeChallengeSet?: shared.AcmeChallengeSet;
