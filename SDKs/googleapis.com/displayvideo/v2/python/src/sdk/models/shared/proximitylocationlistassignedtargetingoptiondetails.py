...
class ProximityLocationListAssignedTargetingOptionDetails:
    ...
    proximity_radius: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('proximityRadius') }})
    proximity_radius_unit: Optional[ProximityLocationListAssignedTargetingOptionDetailsProximityRadiusUnitEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('proximityRadiusUnit') }})
