...
class PutConfigurationSetSuppressionOptionsRequest:
    headers: PutConfigurationSetSuppressionOptionsHeaders = dataclasses.field()
    path_params: PutConfigurationSetSuppressionOptionsPathParams = dataclasses.field()
    request: PutConfigurationSetSuppressionOptionsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class PutConfigurationSetSuppressionOptionsResponse:
    ...
    put_configuration_set_suppression_options_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
