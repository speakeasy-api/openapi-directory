...
class GamesApplicationsGetEndPointRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GamesApplicationsGetEndPointEndPointTypeEnum $endPointType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=endPointType')]
    public ?GamesApplicationsGetEndPointEndPointTypeEnum $endPointType = null;
