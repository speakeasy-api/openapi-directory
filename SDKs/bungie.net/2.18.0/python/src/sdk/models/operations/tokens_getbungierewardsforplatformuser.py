...
class TokensGetBungieRewardsForPlatformUserRequest:
    ...
    r"""users platform membershipId for requested user rewards. If not self, elevated permissions are required."""  
    membership_type: int = dataclasses.field(metadata={'path_param': { 'field_name': 'membershipType', 'style': 'simple', 'explode': False }})
    r"""The target Destiny 2 membership type."""  
    

@dataclasses.dataclass
class TokensGetBungieRewardsForPlatformUser200Wildcard:
