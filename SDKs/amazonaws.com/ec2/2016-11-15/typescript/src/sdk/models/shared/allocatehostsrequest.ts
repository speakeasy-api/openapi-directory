 ...
 */
export enum AllocateHostsRequestAutoPlacementEnum {
  On = "on",
  Off = "off",
}
 ...
 */
export enum AllocateHostsRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class AllocateHostsRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class AllocateHostsRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: AllocateHostsRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: AllocateHostsRequestTagSpecificationsTags })
  tags?: AllocateHostsRequestTagSpecificationsTags[];
}

export class AllocateHostsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: AllocateHostsRequestTagSpecifications })
