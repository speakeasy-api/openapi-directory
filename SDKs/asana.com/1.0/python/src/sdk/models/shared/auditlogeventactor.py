...
class AuditLogEventActorActorTypeEnum(str, Enum):
    r"""The type of actor.
...
class AuditLogEventActor:
    ...
    actor_type: Optional[AuditLogEventActorActorTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('actor_type'), 'exclude': lambda f: f is None }})
    r"""The type of actor.
    Can be one of `user`, `asana`, `asana_support`, `anonymous`, or `external_administrator`.
    """  
