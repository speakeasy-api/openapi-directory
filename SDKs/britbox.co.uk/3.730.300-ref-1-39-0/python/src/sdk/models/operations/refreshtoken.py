...
from ..shared import tokenrefreshrequest as shared_tokenrefreshrequest
...
class RefreshTokenRequest:
    ...
    token_refresh_request: shared_tokenrefreshrequest.TokenRefreshRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
