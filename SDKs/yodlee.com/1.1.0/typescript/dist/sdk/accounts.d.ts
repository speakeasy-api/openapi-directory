...
export declare class Accounts {
    ...
    **/
    createManualAccount(req: operations.CreateManualAccountRequest, config?: AxiosRequestConfig): Promise<operations.CreateManualAccountResponse>;
    /**
    ...
    **/
    evaluateAddress(req: operations.EvaluateAddressRequest, config?: AxiosRequestConfig): Promise<operations.EvaluateAddressResponse>;
    /**
    ...
    **/
    getHistoricalBalances(req: operations.GetHistoricalBalancesRequest, config?: AxiosRequestConfig): Promise<operations.GetHistoricalBalancesResponse>;
    /**
