...
type SecuritycenterProjectsNotificationConfigsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type SecuritycenterProjectsNotificationConfigsGetPathParams struct {
...
type SecuritycenterProjectsNotificationConfigsGetQueryParams struct {
	// V1 error format.
...
type SecuritycenterProjectsNotificationConfigsGetRequest struct {
...
type SecuritycenterProjectsNotificationConfigsGetResponse struct {
	ContentType string
	// Successful response
