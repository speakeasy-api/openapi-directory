...
class GetPullRequestOverrideStateRequest:
    ...
    get_pull_request_override_state_input: shared_getpullrequestoverridestateinput.GetPullRequestOverrideStateInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
