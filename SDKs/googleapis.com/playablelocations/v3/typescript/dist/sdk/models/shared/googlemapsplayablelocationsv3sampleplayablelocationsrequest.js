...
exports.GoogleMapsPlayablelocationsV3SamplePlayableLocationsRequest = void 0;
var utils_1 = require("../../../internal/utils");
var googlemapsplayablelocationsv3sampleareafilter_1 = require("./googlemapsplayablelocationsv3sampleareafilter");
var googlemapsplayablelocationsv3samplecriterion_1 = require("./googlemapsplayablelocationsv3samplecriterion");
...
var GoogleMapsPlayablelocationsV3SamplePlayableLocationsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=areaFilter" }),
        __metadata("design:type", googlemapsplayablelocationsv3sampleareafilter_1.GoogleMapsPlayablelocationsV3SampleAreaFilter)
    ], GoogleMapsPlayablelocationsV3SamplePlayableLocationsRequest.prototype, "areaFilter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=criteria", elemType: googlemapsplayablelocationsv3samplecriterion_1.GoogleMapsPlayablelocationsV3SampleCriterion }),
...
exports.GoogleMapsPlayablelocationsV3SamplePlayableLocationsRequest = GoogleMapsPlayablelocationsV3SamplePlayableLocationsRequest;
