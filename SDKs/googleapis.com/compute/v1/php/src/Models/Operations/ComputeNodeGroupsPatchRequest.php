...
class ComputeNodeGroupsPatchRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\NodeGroup $nodeGroup1 = null;
     ...
     * 
     * @var string $nodeGroupPathParameter
     */
	#[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=nodeGroup')]
    public string $nodeGroupPathParameter;
