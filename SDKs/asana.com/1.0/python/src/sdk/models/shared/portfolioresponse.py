...
class PortfolioResponseCurrentStatusUpdateResourceSubtypeEnum(str, Enum):
...
class PortfolioResponseCurrentStatusUpdate:
    ...
    resource_subtype: Optional[PortfolioResponseCurrentStatusUpdateResourceSubtypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resource_subtype'), 'exclude': lambda f: f is None }})
    r"""The subtype of this resource. Different subtypes retain many of the same fields and behavior, but may render differently in Asana or represent resources with different semantic meaning.
    The `resource_subtype`s for `status` objects represent the type of their parent.
    """  
...
class PortfolioResponse:
    ...
    color: Optional[PortfolioResponseColorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('color'), 'exclude': lambda f: f is None }})
    r"""Color of the portfolio."""  
