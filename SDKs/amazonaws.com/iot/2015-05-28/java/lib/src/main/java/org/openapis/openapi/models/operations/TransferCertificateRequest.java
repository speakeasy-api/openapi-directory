...
public class TransferCertificateRequest {
    ...
    public TransferCertificateRequest(@JsonProperty("RequestBody") TransferCertificateRequestBody requestBody, @JsonProperty("certificateId") String certificateId, @JsonProperty("targetAwsAccount") String targetAwsAccount) {
        this.requestBody = requestBody;
        this.certificateId = certificateId;
        this.targetAwsAccount = targetAwsAccount;
  }
