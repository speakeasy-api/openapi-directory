...
func main() {
    ...
    res, err := s.APIs.Hvcer(ctx, operations.HvcerRequestBody{
        ...
        Format: operations.HvcerRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.HvcerSecurity{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Svcer(ctx, operations.SvcerRequestBody{
        CertificateParameters: &operations.SvcerRequestBodyCertificateParameters{
            Dob: "dd-mm-yyyy",
            FullName: "Sunil Kumar",
            Roll: "18110000",
            Yop: "2018",
        ...
        Format: operations.SvcerRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.SvcerSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
