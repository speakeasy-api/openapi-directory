...
func (s *versions) Getversion(ctx context.Context, request operations.GetversionRequest) (*operations.GetversionResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/api/dataentities/{dataEntityName}/documents/{id}/versions/{versionId}", request, nil)
	if err != nil {
...
func (s *versions) Listversions(ctx context.Context, request operations.ListversionsRequest) (*operations.ListversionsResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/api/dataentities/{dataEntityName}/documents/{id}/versions", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
