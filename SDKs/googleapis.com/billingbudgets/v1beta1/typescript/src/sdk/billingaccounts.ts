      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleCloudBillingBudgetsV1beta1Budget = utils.objectToClass(
              httpRes?.data,
              shared.GoogleCloudBillingBudgetsV1beta1Budget
            );
          }
          break;
      }
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleCloudBillingBudgetsV1beta1ListBudgetsResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse
              );
          }
          break;
      }
