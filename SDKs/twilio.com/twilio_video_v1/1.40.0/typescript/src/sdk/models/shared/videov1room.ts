...
export class VideoV1Room extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "empty_room_timeout" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "max_concurrent_published_tracks" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "max_participant_duration" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "record_participants_on_connect" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "unused_room_timeout" })
