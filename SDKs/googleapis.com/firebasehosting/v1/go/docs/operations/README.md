...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Operations.FirebasehostingOperationsDelete(ctx, operations.FirebasehostingOperationsDeleteRequest{
        DollarXgafv: shared.XgafvEnumTwo.ToPointer(),
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Operations.FirebasehostingOperationsList(ctx, operations.FirebasehostingOperationsListRequest{
