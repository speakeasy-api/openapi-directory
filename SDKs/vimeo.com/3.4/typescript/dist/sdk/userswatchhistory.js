...
var UsersWatchHistory = /** @class */ (function () {
    ...
    **/
    UsersWatchHistory.prototype.deleteFromWatchHistory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteFromWatchHistoryRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/me/watched/videos/{video_id}", req.pathParams);
    ...
    **/
    UsersWatchHistory.prototype.deleteWatchHistory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    UsersWatchHistory.prototype.getWatchHistory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
