...
var TaskrouterV1WorkspaceEvent = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=actor_sid" }),
        __metadata("design:type", String)
    ], TaskrouterV1WorkspaceEvent.prototype, "actorSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=actor_type" }),
        __metadata("design:type", String)
    ], TaskrouterV1WorkspaceEvent.prototype, "actorType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=actor_url" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=event_data" }),
        __metadata("design:type", Object)
    ], TaskrouterV1WorkspaceEvent.prototype, "eventData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=event_date" }),
        __metadata("design:type", Date)
    ], TaskrouterV1WorkspaceEvent.prototype, "eventDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=event_date_ms" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=source_ip_address" }),
        __metadata("design:type", String)
