...
var ReferenceData = /** @class */ (function () {
     ...
     */
    ReferenceData.prototype.seatDetails = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SeatDetailsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/references/seatdetails/{aircraftCode}/{cabinCode}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.SeatDetailsResponse({
