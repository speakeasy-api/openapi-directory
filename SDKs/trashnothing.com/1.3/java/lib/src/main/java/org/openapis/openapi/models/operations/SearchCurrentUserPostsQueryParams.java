...
public class SearchCurrentUserPostsQueryParams {
    /**
    ...
    public SearchCurrentUserPostsQueryParams withDateMax(OffsetDateTime dateMax) {
    ...
    public SearchCurrentUserPostsQueryParams withDateMin(OffsetDateTime dateMin) {
    ...
    public SearchCurrentUserPostsQueryParams withDevicePixelRatio(Double devicePixelRatio) {
    ...
    public SearchCurrentUserPostsQueryParams withGroupIds(String groupIds) {
    ...
    public SearchCurrentUserPostsQueryParams withIncludeReposts(Long includeReposts) {
    ...
    public SearchCurrentUserPostsQueryParams withLatitude(Double latitude) {
    ...
    public SearchCurrentUserPostsQueryParams withLongitude(Double longitude) {
    ...
    public SearchCurrentUserPostsQueryParams withOutcomes(String outcomes) {
    ...
    public Long page;
    public SearchCurrentUserPostsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public SearchCurrentUserPostsQueryParams withPerPage(Long perPage) {
    ...
    public SearchCurrentUserPostsQueryParams withRadius(Double radius) {
        this.radius = radius;
        return this;
    }
    ...
    public SearchCurrentUserPostsQueryParams withSearch(String search) {
        this.search = search;
        return this;
    }
    ...
    public SearchCurrentUserPostsQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public SearchCurrentUserPostsQueryParams withSources(String sources) {
    ...
    public String types;
    public SearchCurrentUserPostsQueryParams withTypes(String types) {
        this.types = types;
        return this;
    }
    ...
    public SearchCurrentUserPostsQueryParams withUserState(String userState) {
