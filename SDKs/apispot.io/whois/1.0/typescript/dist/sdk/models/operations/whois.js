...
exports.WhoisResponse = exports.WhoisRequest = exports.WhoisFormatEnum = void 0;
...
var WhoisRequest = /** @class */ (function (_super) {
    ...
    ], WhoisRequest.prototype, "domain", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=format",
        }),
        __metadata("design:type", String)
    ], WhoisRequest.prototype, "format", void 0);
    return WhoisRequest;
...
var WhoisResponse = /** @class */ (function (_super) {
    ...
    ], WhoisResponse.prototype, "rawResponse", void 0);
