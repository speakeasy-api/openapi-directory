...
export class GetRtiTransactionSummariesFromEmployerRequest extends SpeakeasyBase {
  /**
...
export class GetRtiTransactionSummariesFromEmployerResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
