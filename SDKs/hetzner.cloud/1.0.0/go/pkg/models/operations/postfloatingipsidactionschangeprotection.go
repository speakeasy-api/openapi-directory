...
func (e *PostFloatingIpsIDActionsChangeProtectionActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostFloatingIpsIDActionsChangeProtectionActionResponseActionStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PostFloatingIpsIDActionsChangeProtectionActionResponseActionStatusEnum: %s", s)
	}
}
