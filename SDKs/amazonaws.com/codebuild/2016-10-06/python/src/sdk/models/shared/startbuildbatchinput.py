...
class StartBuildBatchInput:
    ...
    build_batch_config_override: Optional[shared_projectbuildbatchconfig.ProjectBuildBatchConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('buildBatchConfigOverride') }})
    build_timeout_in_minutes_override: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('buildTimeoutInMinutesOverride') }})
    ...
    report_build_batch_status_override: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reportBuildBatchStatusOverride') }})
