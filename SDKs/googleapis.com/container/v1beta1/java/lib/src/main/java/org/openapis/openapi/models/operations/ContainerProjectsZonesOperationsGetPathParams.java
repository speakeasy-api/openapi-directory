...
public class ContainerProjectsZonesOperationsGetPathParams {
    /**
    ...
    public ContainerProjectsZonesOperationsGetPathParams withOperationId(String operationId) {
    ...
    public ContainerProjectsZonesOperationsGetPathParams withProjectId(String projectId) {
    ...
    public String zone;
    public ContainerProjectsZonesOperationsGetPathParams withZone(String zone) {
        this.zone = zone;
        return this;
    }
