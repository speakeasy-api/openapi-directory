 ...
 * @access public
 */
class GetUserResponseOutput
{
	#[\JMS\Serializer\Annotation\SerializedName('data')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\UserOutput')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\UserOutput();
		$this->operation = "";
		$this->resource = "";
		$this->service = "";
		$this->status = "";
