...
class DeleteTopicRuleRequest:
    headers: DeleteTopicRuleHeaders = dataclasses.field()
    path_params: DeleteTopicRulePathParams = dataclasses.field()
