...
from ..shared import objectnotdetachedexception as shared_objectnotdetachedexception
...
@dataclass_json
@dataclasses.dataclass
class DeleteObjectRequestBodyObjectReference:
    r"""DeleteObjectRequestBodyObjectReference
...
class DeleteObjectRequestBody:
    object_reference: DeleteObjectRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ObjectReference') }})
    

@dataclasses.dataclass
class DeleteObjectRequest:
    headers: DeleteObjectHeaders = dataclasses.field()
    request: DeleteObjectRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteObjectResponse:
    ...
    delete_object_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    ...
    object_not_detached_exception: Optional[shared_objectnotdetachedexception.ObjectNotDetachedException] = dataclasses.field(default=None)
