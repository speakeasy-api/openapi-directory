...
class ModifyClusterRequest:
    ...
    backup_retention_policy: shared_backupretentionpolicy.BackupRetentionPolicy = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('BackupRetentionPolicy') }})  
