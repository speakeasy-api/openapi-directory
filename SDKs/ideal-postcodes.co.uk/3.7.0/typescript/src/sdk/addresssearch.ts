...
export class AddressSearch {
  ...
  addressAutocomplete(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AddressAutocompleteResponse =
        new operations.AddressAutocompleteResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.autocompleteResponse = utils.objectToClass(
              httpRes?.data,
              shared.AutocompleteResponse
            );
          }
          break;
   ...
   */
  resolve(
    req: operations.ResolveRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ResolveResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ResolveResponse = new operations.ResolveResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.gbrResolveAddressResponse = utils.objectToClass(
              httpRes?.data,
              shared.GbrResolveAddressResponse
            );
          }
          break;
   ...
   */
  resolveUsa(
    req: operations.ResolveUsaRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ResolveUsaResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ResolveUsaResponse =
        new operations.ResolveUsaResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.usaResolveAddressResponse = utils.objectToClass(
              httpRes?.data,
              shared.UsaResolveAddressResponse
            );
          }
          break;
        case httpRes?.status == 404:
