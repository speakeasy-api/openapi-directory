 ...
 */
export enum ExportImageRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class ExportImageRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class ExportImageRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: ExportImageRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: ExportImageRequestTagSpecificationsTags })
  tags?: ExportImageRequestTagSpecificationsTags[];
}

export class ExportImageRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken?: string;
  ...
  @SpeakeasyMetadata({ elemType: ExportImageRequestTagSpecifications })
