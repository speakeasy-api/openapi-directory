...
public class ListServiceListServiceResponse {
    ...
    public openapisdk.models.shared.NotifyV1Service[] services;
    public ListServiceListServiceResponse withServices(openapisdk.models.shared.NotifyV1Service[] services) {
