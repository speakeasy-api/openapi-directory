...
export enum DisassociateFraudsterXAmzTargetEnum {
  VoiceIDDisassociateFraudster = "VoiceID.DisassociateFraudster",
}

export class DisassociateFraudsterRequest extends SpeakeasyBase {
...
export class DisassociateFraudsterResponse extends SpeakeasyBase {
  /**
