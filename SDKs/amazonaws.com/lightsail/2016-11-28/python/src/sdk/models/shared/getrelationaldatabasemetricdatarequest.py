...
class GetRelationalDatabaseMetricDataRequest:
    ...
    metric_name: shared_relationaldatabasemetricname_enum.RelationalDatabaseMetricNameEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('metricName') }})
