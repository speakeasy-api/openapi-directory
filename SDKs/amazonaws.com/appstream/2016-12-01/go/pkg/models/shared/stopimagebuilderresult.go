...
// StopImageBuilderResultImageBuilder
// Describes a virtual machine that is used to create an image.
type StopImageBuilderResultImageBuilder struct {
...
type StopImageBuilderResult struct {
	ImageBuilder *StopImageBuilderResultImageBuilder `json:"ImageBuilder,omitempty"`
}
