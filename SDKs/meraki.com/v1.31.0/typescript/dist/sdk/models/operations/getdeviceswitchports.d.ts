 ...
 */
export declare enum GetDeviceSwitchPorts200ApplicationJSONAccessPolicyTypeEnum {
 ...
 * Profile attributes
 */
export declare class GetDeviceSwitchPorts200ApplicationJSONProfile extends SpeakeasyBase {
    /**
 ...
 */
export declare enum GetDeviceSwitchPorts200ApplicationJSONStpGuardEnum {
 ...
 */
export declare enum GetDeviceSwitchPorts200ApplicationJSONTypeEnum {
    Access = "access",
    Trunk = "trunk"
}
/**
 ...
 */
export declare enum GetDeviceSwitchPorts200ApplicationJSONUdldEnum {
    AlertOnly = "Alert only",
    Enforce = "Enforce"
}
export declare class GetDeviceSwitchPorts200ApplicationJSON extends SpeakeasyBase {
    /**
     ...
     * The type of the access policy of the switch port. Only applicable to access ports. Can be one of 'Open', 'Custom access policy', 'MAC allow list' or 'Sticky MAC allow list'.
     */
    accessPolicyType?: GetDeviceSwitchPorts200ApplicationJSONAccessPolicyTypeEnum;
    /**
     ...
     * Profile attributes
     */
    profile?: GetDeviceSwitchPorts200ApplicationJSONProfile;
    /**
     ...
     * The state of the STP guard ('disabled', 'root guard', 'bpdu guard' or 'loop guard').
     */
    stpGuard?: GetDeviceSwitchPorts200ApplicationJSONStpGuardEnum;
    /**
     ...
     * The type of the switch port ('trunk' or 'access').
     */
    type?: GetDeviceSwitchPorts200ApplicationJSONTypeEnum;
    /**
     * The action to take when Unidirectional Link is detected (Alert only, Enforce). Default configuration is Alert only.
     */
    udld?: GetDeviceSwitchPorts200ApplicationJSONUdldEnum;
    /**
