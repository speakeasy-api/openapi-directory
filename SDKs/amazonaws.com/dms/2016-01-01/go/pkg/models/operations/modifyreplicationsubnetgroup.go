...
func (e ModifyReplicationSubnetGroupXAmzTargetEnum) ToPointer() *ModifyReplicationSubnetGroupXAmzTargetEnum {
	return &e
}
...
func (e *ModifyReplicationSubnetGroupXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonDMSv20160101.ModifyReplicationSubnetGroup":
		*e = ModifyReplicationSubnetGroupXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ModifyReplicationSubnetGroupXAmzTargetEnum: %v", v)
	}
}

type ModifyReplicationSubnetGroupRequest struct {
	ModifyReplicationSubnetGroupMessage shared.ModifyReplicationSubnetGroupMessage `request:"mediaType=application/json"`
