...
var InAppProduct = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=managedProductTaxesAndComplianceSettings" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=subscriptionTaxesAndComplianceSettings" }),
