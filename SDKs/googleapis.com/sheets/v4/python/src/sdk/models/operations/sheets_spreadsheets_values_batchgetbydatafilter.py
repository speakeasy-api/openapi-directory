...
class SheetsSpreadsheetsValuesBatchGetByDataFilterRequest:
    ...
    batch_get_values_by_data_filter_request: Optional[shared_batchgetvaluesbydatafilterrequest.BatchGetValuesByDataFilterRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
