...
func (e GetOrganizationDevicesAvailabilitiesTagsFilterTypeEnum) ToPointer() *GetOrganizationDevicesAvailabilitiesTagsFilterTypeEnum {
	return &e
}
...
func (e *GetOrganizationDevicesAvailabilitiesTagsFilterTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "withAllTags":
		fallthrough
	case "withAnyTags":
		*e = GetOrganizationDevicesAvailabilitiesTagsFilterTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationDevicesAvailabilitiesTagsFilterTypeEnum: %v", v)
	}
}
...
func (e GetOrganizationDevicesAvailabilities200ApplicationJSONProductTypeEnum) ToPointer() *GetOrganizationDevicesAvailabilities200ApplicationJSONProductTypeEnum {
	return &e
}
...
func (e *GetOrganizationDevicesAvailabilities200ApplicationJSONProductTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "systemsManager":
		fallthrough
	case "wireless":
		*e = GetOrganizationDevicesAvailabilities200ApplicationJSONProductTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationDevicesAvailabilities200ApplicationJSONProductTypeEnum: %v", v)
	}
}
...
func (e GetOrganizationDevicesAvailabilities200ApplicationJSONStatusEnum) ToPointer() *GetOrganizationDevicesAvailabilities200ApplicationJSONStatusEnum {
	return &e
}
...
func (e *GetOrganizationDevicesAvailabilities200ApplicationJSONStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "offline":
		fallthrough
	case "online":
		*e = GetOrganizationDevicesAvailabilities200ApplicationJSONStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationDevicesAvailabilities200ApplicationJSONStatusEnum: %v", v)
	}
}
