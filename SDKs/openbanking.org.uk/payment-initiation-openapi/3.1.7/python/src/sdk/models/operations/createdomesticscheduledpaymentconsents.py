...
from ..shared import obwritedomesticscheduledconsent4 as shared_obwritedomesticscheduledconsent4
...
class CreateDomesticScheduledPaymentConsentsRequests:
    ...
    ob_write_domestic_scheduled_consent4: Optional[shared_obwritedomesticscheduledconsent4.ObWriteDomesticScheduledConsent4] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    ob_write_domestic_scheduled_consent5: Optional[shared_obwritedomesticscheduledconsent4.ObWriteDomesticScheduledConsent4] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class CreateDomesticScheduledPaymentConsentsRequest:
    headers: CreateDomesticScheduledPaymentConsentsHeaders = dataclasses.field()
    request: CreateDomesticScheduledPaymentConsentsRequests = dataclasses.field()
    security: CreateDomesticScheduledPaymentConsentsSecurity = dataclasses.field()
