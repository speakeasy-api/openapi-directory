 ...
 * The launch template.
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesLaunchTemplateSpecification extends SpeakeasyBase {
 ...
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsAcceleratorCount extends SpeakeasyBase {
    max?: number;
    min?: number;
}
export declare enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsAcceleratorManufacturersEnum {
    Nvidia = "nvidia",
    Amd = "amd",
    AmazonWebServices = "amazon-web-services",
    Xilinx = "xilinx"
}
export declare enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsAcceleratorNamesEnum {
    A100 = "a100",
    V100 = "v100",
    K80 = "k80",
    T4 = "t4",
 ...
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsAcceleratorTotalMemoryMiB extends SpeakeasyBase {
    max?: number;
    min?: number;
}
export declare enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsAcceleratorTypesEnum {
    Gpu = "gpu",
    Fpga = "fpga",
    Inference = "inference"
}
 ...
 */
export declare enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsBareMetalEnum {
    Included = "included",
    Required = "required",
    Excluded = "excluded"
}
 ...
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsBaselineEbsBandwidthMbps extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsBurstablePerformanceEnum {
    Included = "included",
    Required = "required",
    Excluded = "excluded"
}
export declare enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsCpuManufacturersEnum {
    Intel = "intel",
    Amd = "amd",
    AmazonWebServices = "amazon-web-services"
}
export declare enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsInstanceGenerationsEnum {
    Current = "current",
    Previous = "previous"
}
/**
 ...
 */
export declare enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsLocalStorageEnum {
    Included = "included",
    Required = "required",
    Excluded = "excluded"
}
export declare enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsLocalStorageTypesEnum {
    Hdd = "hdd",
    Ssd = "ssd"
}
/**
 ...
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsMemoryGiBPerVCpu extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsMemoryMiB extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsNetworkBandwidthGbps extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsNetworkInterfaceCount extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsTotalLocalStorageGB extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsVCpuCount extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirements extends SpeakeasyBase {
 ...
 */
export declare enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceTypeEnum {
    A1Medium = "a1.medium",
    A1Large = "a1.large",
    A1Xlarge = "a1.xlarge",
 ...
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesPlacement extends SpeakeasyBase {
    groupName?: string;
}
/**
 * Any parameters that you specify override the same parameters in the launch template.
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverridesOverrides extends SpeakeasyBase {
 ...
 */
export declare class CreateFleetResultErrorsLaunchTemplateAndOverrides extends SpeakeasyBase {
 ...
 */
export declare enum CreateFleetResultErrorsLifecycleEnum {
    Spot = "spot",
    OnDemand = "on-demand"
}
/**
 ...
 */
export declare class CreateFleetResultErrors extends SpeakeasyBase {
    errorCode?: string;
    errorMessage?: string;
 ...
 * The instance type.
 */
export declare enum CreateFleetResultInstancesInstanceTypeEnum {
    A1Medium = "a1.medium",
    A1Large = "a1.large",
    A1Xlarge = "a1.xlarge",
    A12xlarge = "a1.2xlarge",
 ...
 * The launch template.
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesLaunchTemplateSpecification extends SpeakeasyBase {
    launchTemplateId?: string;
    launchTemplateName?: string;
    version?: string;
}
 ...
 * <p>The minimum and maximum number of accelerators (GPUs, FPGAs, or Amazon Web Services Inferentia chips) on an instance.</p> <p>To exclude accelerator-enabled instance types, set <code>Max</code> to <code>0</code>.</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsAcceleratorCount extends SpeakeasyBase {
    max?: number;
    min?: number;
}
export declare enum CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsAcceleratorManufacturersEnum {
    Nvidia = "nvidia",
    Amd = "amd",
    AmazonWebServices = "amazon-web-services",
    Xilinx = "xilinx"
}
export declare enum CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsAcceleratorNamesEnum {
    A100 = "a100",
    V100 = "v100",
    K80 = "k80",
    T4 = "t4",
 ...
 * <p>The minimum and maximum amount of total accelerator memory, in MiB.</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsAcceleratorTotalMemoryMiB extends SpeakeasyBase {
    max?: number;
    min?: number;
}
export declare enum CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsAcceleratorTypesEnum {
    Gpu = "gpu",
    Fpga = "fpga",
    Inference = "inference"
}
 ...
 * <p>Indicates whether bare metal instance types must be included, excluded, or required.</p> <ul> <li> <p>To include bare metal instance types, specify <code>included</code>.</p> </li> <li> <p>To require only bare metal instance types, specify <code>required</code>.</p> </li> <li> <p>To exclude bare metal instance types, specify <code>excluded</code>.</p> </li> </ul> <p>Default: <code>excluded</code> </p>
 */
export declare enum CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsBareMetalEnum {
    Included = "included",
    Required = "required",
    Excluded = "excluded"
}
 ...
 * <p>The minimum and maximum baseline bandwidth to Amazon EBS, in Mbps. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-optimized.html">Amazon EBS–optimized instances</a> in the <i>Amazon EC2 User Guide</i>.</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsBaselineEbsBandwidthMbps extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * <p>Indicates whether burstable performance T instance types are included, excluded, or required. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html">Burstable performance instances</a>.</p> <ul> <li> <p>To include burstable performance instance types, specify <code>included</code>.</p> </li> <li> <p>To require only burstable performance instance types, specify <code>required</code>.</p> </li> <li> <p>To exclude burstable performance instance types, specify <code>excluded</code>.</p> </li> </ul> <p>Default: <code>excluded</code> </p>
 */
export declare enum CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsBurstablePerformanceEnum {
    Included = "included",
    Required = "required",
    Excluded = "excluded"
}
export declare enum CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsCpuManufacturersEnum {
    Intel = "intel",
    Amd = "amd",
    AmazonWebServices = "amazon-web-services"
}
export declare enum CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsInstanceGenerationsEnum {
    Current = "current",
    Previous = "previous"
}
/**
 * <p>Indicates whether instance types with instance store volumes are included, excluded, or required. For more information, <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/InstanceStorage.html">Amazon EC2 instance store</a> in the <i>Amazon EC2 User Guide</i>.</p> <ul> <li> <p>To include instance types with instance store volumes, specify <code>included</code>.</p> </li> <li> <p>To require only instance types with instance store volumes, specify <code>required</code>.</p> </li> <li> <p>To exclude instance types with instance store volumes, specify <code>excluded</code>.</p> </li> </ul> <p>Default: <code>included</code> </p>
 */
export declare enum CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsLocalStorageEnum {
    Included = "included",
    Required = "required",
    Excluded = "excluded"
}
export declare enum CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsLocalStorageTypesEnum {
    Hdd = "hdd",
    Ssd = "ssd"
}
/**
 * <p>The minimum and maximum amount of memory per vCPU, in GiB.</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsMemoryGiBPerVCpu extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * The minimum and maximum amount of memory, in MiB.
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsMemoryMiB extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * <p>The minimum and maximum amount of network bandwidth, in gigabits per second (Gbps).</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsNetworkBandwidthGbps extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * <p>The minimum and maximum number of network interfaces.</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsNetworkInterfaceCount extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * <p>The minimum and maximum amount of total local storage, in GB.</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsTotalLocalStorageGB extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * The minimum and maximum number of vCPUs.
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsVCpuCount extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * <p>The attributes for the instance types. When you specify instance attributes, Amazon EC2 will identify instance types with those attributes.</p> <note> <p>If you specify <code>InstanceRequirements</code>, you can't specify <code>InstanceType</code>.</p> </note>
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirements extends SpeakeasyBase {
 ...
 * <p>The instance type.</p> <p> <code>mac1.metal</code> is not supported as a launch template override.</p> <note> <p>If you specify <code>InstanceType</code>, you can't specify <code>InstanceRequirements</code>.</p> </note>
 */
export declare enum CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceTypeEnum {
    A1Medium = "a1.medium",
    A1Large = "a1.large",
    A1Xlarge = "a1.xlarge",
    A12xlarge = "a1.2xlarge",
 ...
 * The location where the instance launched, if applicable.
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesPlacement extends SpeakeasyBase {
    groupName?: string;
}
/**
 * Any parameters that you specify override the same parameters in the launch template.
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverridesOverrides extends SpeakeasyBase {
    availabilityZone?: string;
    imageId?: string;
 ...
 * The launch templates and overrides that were used for launching the instances. The values that you specify in the Overrides replace the values in the launch template.
 */
export declare class CreateFleetResultInstancesLaunchTemplateAndOverrides extends SpeakeasyBase {
 ...
 */
export declare enum CreateFleetResultInstancesLifecycleEnum {
    Spot = "spot",
    OnDemand = "on-demand"
}
/**
 ...
 */
export declare enum CreateFleetResultInstancesPlatformEnum {
    Windows = "Windows"
}
/**
 * Describes the instances that were launched by the fleet.
 */
export declare class CreateFleetResultInstances extends SpeakeasyBase {
    instanceIds?: string[];
