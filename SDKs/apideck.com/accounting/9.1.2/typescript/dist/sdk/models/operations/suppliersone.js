...
exports.SuppliersOneResponse = exports.SuppliersOneRequest = exports.SuppliersOneSecurity = void 0;
...
exports.SuppliersOneSecurity = SuppliersOneSecurity;
var SuppliersOneRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], SuppliersOneRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], SuppliersOneRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], SuppliersOneRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], SuppliersOneRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], SuppliersOneRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], SuppliersOneRequest.prototype, "xApideckServiceId", void 0);
    return SuppliersOneRequest;
}(utils_1.SpeakeasyBase));
exports.SuppliersOneRequest = SuppliersOneRequest;
var SuppliersOneResponse = /** @class */ (function (_super) {
    ...
    ], SuppliersOneResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.SuppliersOneResponse = SuppliersOneResponse;
