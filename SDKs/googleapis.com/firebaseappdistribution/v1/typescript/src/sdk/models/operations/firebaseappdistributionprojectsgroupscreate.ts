...
export class FirebaseappdistributionProjectsGroupsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseappdistributionProjectsGroupsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseappdistributionProjectsGroupsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
