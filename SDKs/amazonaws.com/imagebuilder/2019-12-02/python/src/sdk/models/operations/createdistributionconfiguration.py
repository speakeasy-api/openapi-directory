...
class CreateDistributionConfigurationHeaders:
...
class CreateDistributionConfigurationRequest:
    headers: CreateDistributionConfigurationHeaders = dataclasses.field()
    request: CreateDistributionConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
