...
class CategoriesGroups:
    ...
    def get_category_groups(self, request: operations.GetCategoryGroupsRequest) -> operations.GetCategoryGroupsResponse:
        ...
        url = utils.generate_url(operations.GetCategoryGroupsRequest, base_url, '/categories/{category}/groups', request)
        
        query_params = utils.get_query_params(operations.GetCategoryGroupsRequest, request)
        ...
        res = operations.GetCategoryGroupsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
