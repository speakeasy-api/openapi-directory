...
class AdsenseAccountsPaymentsListSecurity:
    option1: Optional[AdsenseAccountsPaymentsListSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AdsenseAccountsPaymentsListSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class AdsenseAccountsPaymentsListRequest:
    path_params: AdsenseAccountsPaymentsListPathParams = dataclasses.field()
    query_params: AdsenseAccountsPaymentsListQueryParams = dataclasses.field()
    security: AdsenseAccountsPaymentsListSecurity = dataclasses.field()
