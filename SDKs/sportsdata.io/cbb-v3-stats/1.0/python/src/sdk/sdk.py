...
class SDK:
    ...
    def league_hierarchy(self, request: operations.LeagueHierarchyRequest) -> operations.LeagueHierarchyResponse:
        ...
        url = utils.generate_url(operations.LeagueHierarchyRequest, base_url, '/{format}/LeagueHierarchy', request)
        ...
        res = operations.LeagueHierarchyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def tournament_hierarchy(self, request: operations.TournamentHierarchyRequest) -> operations.TournamentHierarchyResponse:
        ...
        url = utils.generate_url(operations.TournamentHierarchyRequest, base_url, '/{format}/Tournament/{season}', request)
        ...
        res = operations.TournamentHierarchyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.Tournament])
                res.tournament = out
