...
from ..shared import getallordersresponsetype as shared_getallordersresponsetype


@dataclasses.dataclass
class GetAllOrdersQueryParams:
...
class GetAllOrdersRequest:
    headers: GetAllOrdersHeaders = dataclasses.field()
    query_params: GetAllOrdersQueryParams = dataclasses.field()
...
class GetAllOrdersResponse:
    ...
    get_all_orders_response_type: Optional[shared_getallordersresponsetype.GetAllOrdersResponseType] = dataclasses.field(default=None)
