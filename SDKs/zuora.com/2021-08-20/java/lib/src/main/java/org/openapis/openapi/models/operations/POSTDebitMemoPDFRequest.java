...
public class POSTDebitMemoPDFRequest {
    ...
    public POSTDebitMemoPDFRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public POSTDebitMemoPDFRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public POSTDebitMemoPDFRequest withDebitMemoId(String debitMemoId) {
