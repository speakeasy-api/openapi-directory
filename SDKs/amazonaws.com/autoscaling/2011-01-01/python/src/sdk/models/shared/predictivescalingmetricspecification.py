...
import dataclasses
from ..shared import predictivescalingcustomizedcapacitymetric as shared_predictivescalingcustomizedcapacitymetric
from ..shared import predictivescalingcustomizedloadmetric as shared_predictivescalingcustomizedloadmetric
from ..shared import predictivescalingcustomizedscalingmetric as shared_predictivescalingcustomizedscalingmetric
...
class PredictiveScalingMetricSpecification:
    ...
    customized_capacity_metric_specification: Optional[shared_predictivescalingcustomizedcapacitymetric.PredictiveScalingCustomizedCapacityMetric] = dataclasses.field(default=None)  
    customized_load_metric_specification: Optional[shared_predictivescalingcustomizedloadmetric.PredictiveScalingCustomizedLoadMetric] = dataclasses.field(default=None)  
    customized_scaling_metric_specification: Optional[shared_predictivescalingcustomizedscalingmetric.PredictiveScalingCustomizedScalingMetric] = dataclasses.field(default=None)  
