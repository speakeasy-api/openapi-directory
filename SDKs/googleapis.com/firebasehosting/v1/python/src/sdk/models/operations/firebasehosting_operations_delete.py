...
@dataclasses.dataclass
class FirebasehostingOperationsDeleteQueryParams:
...
class FirebasehostingOperationsDeleteRequest:
    path_params: FirebasehostingOperationsDeletePathParams = dataclasses.field()
    query_params: FirebasehostingOperationsDeleteQueryParams = dataclasses.field()
