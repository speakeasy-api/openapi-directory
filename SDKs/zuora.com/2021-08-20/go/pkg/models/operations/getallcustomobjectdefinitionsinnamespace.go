...
type GETAllCustomObjectDefinitionsInNamespaceSelectEnum string

const (
	GETAllCustomObjectDefinitionsInNamespaceSelectEnumType GETAllCustomObjectDefinitionsInNamespaceSelectEnum = "type"
)

func (e *GETAllCustomObjectDefinitionsInNamespaceSelectEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	switch s {
	case "type":
		*e = GETAllCustomObjectDefinitionsInNamespaceSelectEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETAllCustomObjectDefinitionsInNamespaceSelectEnum: %s", s)
	}
}
