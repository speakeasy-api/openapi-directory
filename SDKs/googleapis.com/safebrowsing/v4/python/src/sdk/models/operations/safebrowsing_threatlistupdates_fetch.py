...
class SafebrowsingThreatListUpdatesFetchRequest:
    ...
    google_security_safebrowsing_v4_fetch_threat_list_updates_request: Optional[shared_googlesecuritysafebrowsingv4fetchthreatlistupdatesrequest.GoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
