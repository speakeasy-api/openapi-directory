...
class ObjectDeleteInvoiceAdjustmentPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectDeleteInvoiceAdjustmentHeaders:
...
class ObjectDeleteInvoiceAdjustmentRequest:
    headers: ObjectDeleteInvoiceAdjustmentHeaders = dataclasses.field()
    path_params: ObjectDeleteInvoiceAdjustmentPathParams = dataclasses.field()
    

@dataclasses.dataclass
class ObjectDeleteInvoiceAdjustmentResponse:
