...
export class RunNamespacesJobsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunNamespacesJobsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunNamespacesJobsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
