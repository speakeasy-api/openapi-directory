...
type PrivatecaProjectsLocationsCaPoolsCertificateAuthoritiesDisableSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type PrivatecaProjectsLocationsCaPoolsCertificateAuthoritiesDisablePathParams struct {
...
type PrivatecaProjectsLocationsCaPoolsCertificateAuthoritiesDisableQueryParams struct {
	// V1 error format.
...
type PrivatecaProjectsLocationsCaPoolsCertificateAuthoritiesDisableRequest struct {
...
type PrivatecaProjectsLocationsCaPoolsCertificateAuthoritiesDisableResponse struct {
	ContentType string
	// Successful response
