...
public class CecerSecurity {
    ...
    public CecerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public CecerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public CecerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
