...
class UpdateUnderstandFieldTypeRequest:
    ...
    request_body: Optional[UpdateUnderstandFieldTypeUpdateUnderstandFieldTypeRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
