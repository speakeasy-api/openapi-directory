...
type GetHostHierarchyObjectRequest struct {
	// ID of the host hierarchy object.
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetHostHierarchyObject200ApplicationJSONShareTypeEnum string

const (
	GetHostHierarchyObject200ApplicationJSONShareTypeEnumNfs GetHostHierarchyObject200ApplicationJSONShareTypeEnum = "NFS"
	GetHostHierarchyObject200ApplicationJSONShareTypeEnumSmb GetHostHierarchyObject200ApplicationJSONShareTypeEnum = "SMB"
)

func (e GetHostHierarchyObject200ApplicationJSONShareTypeEnum) ToPointer() *GetHostHierarchyObject200ApplicationJSONShareTypeEnum {
	return &e
}

func (e *GetHostHierarchyObject200ApplicationJSONShareTypeEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "NFS":
		fallthrough
	case "SMB":
		*e = GetHostHierarchyObject200ApplicationJSONShareTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetHostHierarchyObject200ApplicationJSONShareTypeEnum: %v", v)
	}
}

// GetHostHierarchyObject200ApplicationJSON - Details of the hierarchy object.
type GetHostHierarchyObject200ApplicationJSON struct {
	...
	DescendantCount shared.HostHierarchyObjectDescendantCount `json:"descendantCount"`
	...
	Filesets []shared.FilesetSummary `json:"filesets,omitempty"`
	...
	NasBaseConfig *shared.NasBaseConfig `json:"nasBaseConfig,omitempty"`
	// Types of object that can be present in the host/share hierarchy.
	ObjectType shared.HostObjectTypeEnum `json:"objectType"`
	...
	ShareType           *GetHostHierarchyObject200ApplicationJSONShareTypeEnum `json:"shareType,omitempty"`
	// Specifies the method used to apply an SLA Domain to an object. Possible values are Derived, Direct, and Unassigned.
	SLAAssignment *shared.SLAAssignmentEnum `json:"slaAssignment,omitempty"`
...
type GetHostHierarchyObjectResponse struct {
	ContentType string
	StatusCode  int
	RawResponse *http.Response
	// Details of the hierarchy object.
	GetHostHierarchyObject200ApplicationJSONObject *GetHostHierarchyObject200ApplicationJSON
}
