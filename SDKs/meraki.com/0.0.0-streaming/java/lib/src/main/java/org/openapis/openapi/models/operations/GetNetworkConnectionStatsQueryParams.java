...
public class GetNetworkConnectionStatsQueryParams {
    /**
     * Filter results by AP Tag
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=apTag")
    public String apTag;
    public GetNetworkConnectionStatsQueryParams withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkConnectionStatsBandEnum band;
    public GetNetworkConnectionStatsQueryParams withBand(GetNetworkConnectionStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public Long ssid;
    public GetNetworkConnectionStatsQueryParams withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetNetworkConnectionStatsQueryParams withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetNetworkConnectionStatsQueryParams withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkConnectionStatsQueryParams withTimespan(Float timespan) {
    ...
    public Long vlan;
    public GetNetworkConnectionStatsQueryParams withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
