...
public class Auth {
     ...
     */
    public org.openapis.openapi.models.operations.GetAccessTokenResponse getAccessToken(org.openapis.openapi.models.shared.TokenRequest request, org.openapis.openapi.models.operations.GetAccessTokenSecurity security) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.TokenError out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.TokenError.class);
                res.tokenError = out;
            }
        }
