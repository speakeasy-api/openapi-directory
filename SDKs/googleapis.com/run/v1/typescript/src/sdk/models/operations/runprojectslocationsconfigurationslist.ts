...
export class RunProjectsLocationsConfigurationsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunProjectsLocationsConfigurationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunProjectsLocationsConfigurationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
