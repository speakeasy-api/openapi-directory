...
func (e MergeBranchesBySquashXAmzTargetEnum) ToPointer() *MergeBranchesBySquashXAmzTargetEnum {
	return &e
}
...
func (e *MergeBranchesBySquashXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "CodeCommit_20150413.MergeBranchesBySquash":
		*e = MergeBranchesBySquashXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for MergeBranchesBySquashXAmzTargetEnum: %v", v)
	}
}
