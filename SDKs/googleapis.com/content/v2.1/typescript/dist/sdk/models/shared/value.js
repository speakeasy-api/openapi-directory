...
var Value = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "carrierRateName" }),
        __metadata("design:type", String)
    ], Value.prototype, "carrierRateName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "flatRate" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "noShipping" }),
        __metadata("design:type", Boolean)
    ], Value.prototype, "noShipping", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "pricePercentage" }),
        __metadata("design:type", String)
    ], Value.prototype, "pricePercentage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subtableName" }),
        __metadata("design:type", String)
