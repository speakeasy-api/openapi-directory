...
class PostDescribeAutoScalingInstancesQueryParams:
    action: PostDescribeAutoScalingInstancesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeAutoScalingInstancesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeAutoScalingInstancesRequest:
    headers: PostDescribeAutoScalingInstancesHeaders = dataclasses.field()
    query_params: PostDescribeAutoScalingInstancesQueryParams = dataclasses.field()
