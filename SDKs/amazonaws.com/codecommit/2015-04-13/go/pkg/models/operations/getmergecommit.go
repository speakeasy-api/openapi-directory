...
func (e GetMergeCommitXAmzTargetEnum) ToPointer() *GetMergeCommitXAmzTargetEnum {
	return &e
}
...
func (e *GetMergeCommitXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "CodeCommit_20150413.GetMergeCommit":
		*e = GetMergeCommitXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetMergeCommitXAmzTargetEnum: %v", v)
	}
}
