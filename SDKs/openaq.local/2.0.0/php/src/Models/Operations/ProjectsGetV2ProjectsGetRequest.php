...
class ProjectsGetV2ProjectsGetRequest
{
     ...
     * An enumeration.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ProjectsGetV2ProjectsGetOrderByProjectsOrderEnum $orderBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=order_by')]
    public ?ProjectsGetV2ProjectsGetOrderByProjectsOrderEnum $orderBy = null;
     ...
     * Define sort order.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ProjectsGetV2ProjectsGetSortSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?ProjectsGetV2ProjectsGetSortSortEnum $sort = null;
