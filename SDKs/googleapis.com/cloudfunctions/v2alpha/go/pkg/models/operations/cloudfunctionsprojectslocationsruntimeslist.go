...
type CloudfunctionsProjectsLocationsRuntimesListSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type CloudfunctionsProjectsLocationsRuntimesListRequest struct {
	// V1 error format.
...
type CloudfunctionsProjectsLocationsRuntimesListResponse struct {
	ContentType string
	// Successful response
