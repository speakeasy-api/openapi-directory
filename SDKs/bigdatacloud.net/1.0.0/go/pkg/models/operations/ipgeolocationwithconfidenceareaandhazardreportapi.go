...
type IPGeolocationWithConfidenceAreaAndHazardReportAPIQueryParams struct {
...
type IPGeolocationWithConfidenceAreaAndHazardReportAPIRequest struct {
	QueryParams IPGeolocationWithConfidenceAreaAndHazardReportAPIQueryParams
}

type IPGeolocationWithConfidenceAreaAndHazardReportAPIResponse struct {
	ContentType string
	StatusCode  int
