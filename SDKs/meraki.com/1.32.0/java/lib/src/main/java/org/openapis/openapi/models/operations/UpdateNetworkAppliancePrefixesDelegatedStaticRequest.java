...
public class UpdateNetworkAppliancePrefixesDelegatedStaticRequest {
    ...
    public UpdateNetworkAppliancePrefixesDelegatedStaticRequest(@JsonProperty("networkId") String networkId, @JsonProperty("staticDelegatedPrefixId") String staticDelegatedPrefixId) {
        this.networkId = networkId;
        this.staticDelegatedPrefixId = staticDelegatedPrefixId;
  }
}
