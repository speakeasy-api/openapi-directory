...
exports.OutletsGetOutletsByGeolocationResponse = exports.OutletsGetOutletsByGeolocationRequest = void 0;
...
var OutletsGetOutletsByGeolocationRequest = /** @class */ (function (_super) {
    ...
    ], OutletsGetOutletsByGeolocationRequest.prototype, "devid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=latitude",
        }),
        __metadata("design:type", Number)
    ], OutletsGetOutletsByGeolocationRequest.prototype, "latitude", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=longitude",
        }),
        __metadata("design:type", Number)
    ], OutletsGetOutletsByGeolocationRequest.prototype, "longitude", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=max_distance",
        }),
        __metadata("design:type", Number)
    ], OutletsGetOutletsByGeolocationRequest.prototype, "maxDistance", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=max_results",
        }),
        __metadata("design:type", Number)
    ], OutletsGetOutletsByGeolocationRequest.prototype, "maxResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=signature",
        }),
        __metadata("design:type", String)
    ], OutletsGetOutletsByGeolocationRequest.prototype, "signature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=token" }),
        __metadata("design:type", String)
    ], OutletsGetOutletsByGeolocationRequest.prototype, "token", void 0);
...
var OutletsGetOutletsByGeolocationResponse = /** @class */ (function (_super) {
    ...
    ], OutletsGetOutletsByGeolocationResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
