...
exports.PostContainersNameOrIdStopResponse = exports.PostContainersNameOrIdStopRequest = void 0;
...
var PostContainersNameOrIdStopRequest = /** @class */ (function (_super) {
    ...
    ], PostContainersNameOrIdStopRequest.prototype, "xAuthProjectId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Auth-Token",
        }),
        __metadata("design:type", String)
    ], PostContainersNameOrIdStopRequest.prototype, "xAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=name_or_id",
        }),
        __metadata("design:type", String)
    ], PostContainersNameOrIdStopRequest.prototype, "nameOrId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t" }),
        __metadata("design:type", Number)
    ], PostContainersNameOrIdStopRequest.prototype, "t", void 0);
...
var PostContainersNameOrIdStopResponse = /** @class */ (function (_super) {
    ...
    ], PostContainersNameOrIdStopResponse.prototype, "rawResponse", void 0);
