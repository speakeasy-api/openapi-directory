...
var Organization = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "asset_count" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "download_token" }),
        __metadata("design:type", String)
    ], Organization.prototype, "downloadToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "download_token_created_at" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "export_token_counter" }),
        __metadata("design:type", Number)
    ], Organization.prototype, "exportTokenCounter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "export_token_created_at" }),
        __metadata("design:type", Number)
    ], Organization.prototype, "exportTokenCreatedAt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "export_token_last_used_at" }),
        __metadata("design:type", Number)
    ], Organization.prototype, "exportTokenLastUsedAt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "export_token_last_used_by" }),
        __metadata("design:type", String)
