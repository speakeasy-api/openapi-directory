...
export class DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum {
...
export class DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
