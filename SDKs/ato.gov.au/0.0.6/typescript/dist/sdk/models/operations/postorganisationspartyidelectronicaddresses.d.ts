...
export declare class PostOrganisationsPartyIdElectronicAddressesRequest extends SpeakeasyBase {
    /**
     * The API key.
     */
    apiKey: string;
...
export declare class PostOrganisationsPartyIdElectronicAddressesResponse extends SpeakeasyBase {
    contentType: string;
