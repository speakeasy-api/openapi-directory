...
class DirectoryResourcesBuildingsUpdateRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DirectoryResourcesBuildingsUpdateCoordinatesSourceEnum $coordinatesSource
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=coordinatesSource')]
    public ?DirectoryResourcesBuildingsUpdateCoordinatesSourceEnum $coordinatesSource = null;
