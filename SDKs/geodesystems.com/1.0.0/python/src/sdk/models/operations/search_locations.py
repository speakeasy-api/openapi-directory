...
class SearchLocationsQueryParams:
    ...
    search_db_locations_location: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_locations.location', 'style': 'form', 'explode': True }})
    search_db_locations_name: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_locations.name', 'style': 'form', 'explode': True }})
    search_db_locations_type: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_locations.type', 'style': 'form', 'explode': True }})
...
class SearchLocationsRequest:
    query_params: SearchLocationsQueryParams = dataclasses.field()
