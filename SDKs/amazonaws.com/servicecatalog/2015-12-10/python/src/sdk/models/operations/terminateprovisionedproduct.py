...
class TerminateProvisionedProductRequest:
    ...
    terminate_provisioned_product_input: shared_terminateprovisionedproductinput.TerminateProvisionedProductInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
