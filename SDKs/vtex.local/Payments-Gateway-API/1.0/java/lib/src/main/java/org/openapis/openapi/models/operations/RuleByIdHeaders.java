...
public class RuleByIdHeaders {
    ...
    public RuleByIdHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public RuleByIdHeaders withContentType(String contentType) {
    ...
    public RuleByIdHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public RuleByIdHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
