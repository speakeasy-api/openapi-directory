...
class SearchProjectVisitQueryParams:
...
@dataclasses.dataclass
class SearchProjectVisitRequest:
    query_params: SearchProjectVisitQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectVisitResponse:
