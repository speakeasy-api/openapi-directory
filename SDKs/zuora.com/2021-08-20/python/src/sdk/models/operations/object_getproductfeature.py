...
from ..shared import proxygetproductfeature as shared_proxygetproductfeature
...
class ObjectGETProductFeatureResponse:
    ...
    proxy_get_product_feature: Optional[shared_proxygetproductfeature.ProxyGetProductFeature] = dataclasses.field(default=None)  
