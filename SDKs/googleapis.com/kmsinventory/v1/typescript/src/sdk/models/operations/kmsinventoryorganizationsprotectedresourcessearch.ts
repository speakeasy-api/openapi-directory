...
export class KmsinventoryOrganizationsProtectedResourcesSearchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class KmsinventoryOrganizationsProtectedResourcesSearchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=cryptoKey",
  })
  cryptoKey?: string;
...
export class KmsinventoryOrganizationsProtectedResourcesSearchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
