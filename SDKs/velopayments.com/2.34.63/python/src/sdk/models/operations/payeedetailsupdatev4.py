...
from ..shared import updatepayeedetailsrequestv4 as shared_updatepayeedetailsrequestv4
...
class PayeeDetailsUpdateV4Request:
    ...
    update_payee_details_request_v4_input: shared_updatepayeedetailsrequestv4.UpdatePayeeDetailsRequestV4Input = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
