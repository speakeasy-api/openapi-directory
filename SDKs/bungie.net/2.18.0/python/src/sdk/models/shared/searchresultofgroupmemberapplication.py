...
import dataclasses
from ..shared import groupsv2_groupmemberapplication as shared_groupsv2_groupmemberapplication
...
class SearchResultOfGroupMemberApplication:
    ...
    results: Optional[list[shared_groupsv2_groupmemberapplication.GroupsV2GroupMemberApplication]] = dataclasses.field(default=None)  
