...
type CloudchannelAccountsCustomersEntitlementsChangeRenewalSettingsPathParams struct {
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type CloudchannelAccountsCustomersEntitlementsChangeRenewalSettingsQueryParams struct {
...
type CloudchannelAccountsCustomersEntitlementsChangeRenewalSettingsSecurity struct {
...
type CloudchannelAccountsCustomersEntitlementsChangeRenewalSettingsResponse struct {
	ContentType                string
