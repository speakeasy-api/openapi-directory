...
func (e *GetSearchOrderEnum) UnmarshalJSON(data []byte) error {
	...
	case "desc":
		fallthrough
	case "asc":
		*e = GetSearchOrderEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSearchOrderEnum: %s", s)
	}
}
...
func (e *GetSearchSortEnum) UnmarshalJSON(data []byte) error {
	...
	case "votes":
		fallthrough
	case "relevance":
		*e = GetSearchSortEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSearchSortEnum: %s", s)
	}
}
