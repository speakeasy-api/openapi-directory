...
func NewNumberGeneration(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *NumberGeneration {
...
func (s *NumberGeneration) GetNumbersRandom(ctx context.Context, request operations.GetNumbersRandomRequest) (*operations.GetNumbersRandomResponse, error) {
	...
	res := &operations.GetNumbersRandomResponse{
