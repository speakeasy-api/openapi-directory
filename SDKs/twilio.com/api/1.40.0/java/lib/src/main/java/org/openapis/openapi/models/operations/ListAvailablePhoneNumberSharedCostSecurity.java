...
public class ListAvailablePhoneNumberSharedCostSecurity {
    ...
    public ListAvailablePhoneNumberSharedCostSecurity withPassword(String password) {
    ...
    public ListAvailablePhoneNumberSharedCostSecurity withUsername(String username) {
