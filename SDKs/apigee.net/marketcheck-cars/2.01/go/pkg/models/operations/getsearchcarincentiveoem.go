...
// GetSearchCarIncentiveOemOfferTypeEnum - The type of the incentive
...
func (e *GetSearchCarIncentiveOemOfferTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "finance":
		fallthrough
	case "cash":
		*e = GetSearchCarIncentiveOemOfferTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSearchCarIncentiveOemOfferTypeEnum: %s", s)
	}
}
