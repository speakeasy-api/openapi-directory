...
export class RedisProjectsLocationsInstancesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RedisProjectsLocationsInstancesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RedisProjectsLocationsInstancesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
