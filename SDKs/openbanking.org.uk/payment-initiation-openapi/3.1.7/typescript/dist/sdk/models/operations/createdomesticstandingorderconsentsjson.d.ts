...
export declare class CreateDomesticStandingOrderConsentsJsonSecurity extends SpeakeasyBase {
    tppoAuth2Security: string;
}
export declare class CreateDomesticStandingOrderConsentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateDomesticStandingOrderConsentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
