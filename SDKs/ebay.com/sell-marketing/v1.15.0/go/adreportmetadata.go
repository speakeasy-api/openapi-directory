...
func (s *adReportMetadata) GetReportMetadata(ctx context.Context, security operations.GetReportMetadataSecurity) (*operations.GetReportMetadataResponse, error) {
	baseURL := s.serverURL
...
func (s *adReportMetadata) GetReportMetadataForReportType(ctx context.Context, request operations.GetReportMetadataForReportTypeRequest, security operations.GetReportMetadataForReportTypeSecurity) (*operations.GetReportMetadataForReportTypeResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_report_metadata/{report_type}", request, nil)
	if err != nil {
