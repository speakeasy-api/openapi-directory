...
exports.GetLifecyclePoliciesResponse = exports.GetLifecyclePoliciesRequest = exports.GetLifecyclePoliciesStateEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * The activation state.
 */
var GetLifecyclePoliciesStateEnum;
...
})(GetLifecyclePoliciesStateEnum = exports.GetLifecyclePoliciesStateEnum || (exports.GetLifecyclePoliciesStateEnum = {}));
var GetLifecyclePoliciesRequest = /** @class */ (function (_super) {
    ...
    ], GetLifecyclePoliciesRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], GetLifecyclePoliciesRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], GetLifecyclePoliciesRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], GetLifecyclePoliciesRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], GetLifecyclePoliciesRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], GetLifecyclePoliciesRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], GetLifecyclePoliciesRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=policyIds",
        }),
        __metadata("design:type", Array)
    ], GetLifecyclePoliciesRequest.prototype, "policyIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=resourceTypes",
        }),
        __metadata("design:type", Array)
    ], GetLifecyclePoliciesRequest.prototype, "resourceTypes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=state" }),
        __metadata("design:type", String)
    ], GetLifecyclePoliciesRequest.prototype, "state", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=tagsToAdd",
        }),
        __metadata("design:type", Array)
    ], GetLifecyclePoliciesRequest.prototype, "tagsToAdd", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=targetTags",
        }),
        __metadata("design:type", Array)
    ], GetLifecyclePoliciesRequest.prototype, "targetTags", void 0);
...
var GetLifecyclePoliciesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetLifecyclePoliciesResponse.prototype, "rawResponse", void 0);
