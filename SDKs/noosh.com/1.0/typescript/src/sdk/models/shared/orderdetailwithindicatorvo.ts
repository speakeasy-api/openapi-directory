 ...
 */
export class OrderDetailWithIndicatorVO extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: OrderDetailBaseVO })
  @Expose({ name: "change_orders" })
  @Type(() => OrderDetailBaseVO)
  ...
  @SpeakeasyMetadata({ elemType: OrderItemSimpleVO })
  @Expose({ name: "order_items" })
  @Type(() => OrderItemSimpleVO)
