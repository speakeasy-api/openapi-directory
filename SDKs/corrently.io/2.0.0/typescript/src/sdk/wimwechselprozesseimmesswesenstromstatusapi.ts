...
export class WiMWechselprozesseImMesswesenStromStatusAPI {
  ...
  wimstatus(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.WimstatusResponse =
        new operations.WimstatusResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.wimstatus200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Wimstatus200ApplicationJSON
            );
          }
          break;
      }
