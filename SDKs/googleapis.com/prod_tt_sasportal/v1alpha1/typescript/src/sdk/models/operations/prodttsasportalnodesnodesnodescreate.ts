...
export class ProdTtSasportalNodesNodesNodesCreateSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ProdTtSasportalNodesNodesNodesCreateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ProdTtSasportalNodesNodesNodesCreateSecurity extends SpeakeasyBase {
  ...
  option1?: ProdTtSasportalNodesNodesNodesCreateSecurityOption1;

  @SpeakeasyMetadata({ data: "security, option=true" })
  option2?: ProdTtSasportalNodesNodesNodesCreateSecurityOption2;
}
