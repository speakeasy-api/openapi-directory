...
export declare class CreateNewCustomerProfilev2Request extends SpeakeasyBase {
    /**
...
export declare class CreateNewCustomerProfilev2Response extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
