...
class TaskExecutionInformation:
    ...
    r"""Gets or sets the number of times the task has been requeued by the Batch service as the result of a user request."""  
    ...
    r"""Gets or sets the time at which the task completed. This property is set only if the task is in the Completed state."""  
    ...
    r"""Gets or sets the exit code of the task. This property is set only if the task is in completed state."""  
    ...
    r"""Gets or sets the most recent time at which the task has been requeued by the Batch service as the result of a user request."""  
    ...
    r"""Gets or sets the time at which the task started running. If the task has been restarted or retried, this is the most recent time at which the task started running."""  
