...
class CreateReturnLabelResponseBodyOptionalLink:
    r"""CreateReturnLabelResponseBodyOptionalLink
...
class CreateReturnLabelResponseBodyMonetaryValue:
    r"""CreateReturnLabelResponseBodyMonetaryValue
...
class CreateReturnLabelResponseBodyLabelDownload:
    r"""CreateReturnLabelResponseBodyLabelDownload
...
class CreateReturnLabelResponseBodyOutput:
    r"""CreateReturnLabelResponseBodyOutput
    ...
    form_download: Optional[CreateReturnLabelResponseBodyOptionalLink] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('form_download') }})
    insurance_claim: Optional[CreateReturnLabelResponseBodyOptionalLink] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('insurance_claim') }})
    insurance_cost: Optional[CreateReturnLabelResponseBodyMonetaryValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('insurance_cost') }})
    ...
    label_download: Optional[CreateReturnLabelResponseBodyLabelDownload] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('label_download') }})
    ...
    shipment_cost: Optional[CreateReturnLabelResponseBodyMonetaryValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('shipment_cost') }})
