...
class GetAPICatalogSystemPubProductsOffersProductIDRequest:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetAPICatalogSystemPubProductsOffersProductID200ApplicationJSONOffers:
    ...
    offers_per_sales_channel: list[GetAPICatalogSystemPubProductsOffersProductID200ApplicationJSONOffersOffersPerSalesChannel] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('OffersPerSalesChannel') }})
...
class GetAPICatalogSystemPubProductsOffersProductID200ApplicationJSON:
    ...
    main_image: GetAPICatalogSystemPubProductsOffersProductID200ApplicationJSONMainImage = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MainImage') }})
    r"""General information of the main image of the SKU."""  
    ...
    r"""SKU complete name."""  
    offers: list[GetAPICatalogSystemPubProductsOffersProductID200ApplicationJSONOffers] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Offers') }})
...
@dataclasses.dataclass
class GetAPICatalogSystemPubProductsOffersProductIDResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    get_api_catalog_system_pub_products_offers_product_id_200_application_json_objects: Optional[list[GetAPICatalogSystemPubProductsOffersProductID200ApplicationJSON]] = dataclasses.field(default=None)
    r"""OK"""  
