...
class PartialFindResultDiscussionTopicContract:
    items: Optional[list[shared_discussiontopiccontract.DiscussionTopicContract]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
