 ...
 */
public class GetPickupsResponseBodyPaginationLink {
    /**
    ...
    public GetPickupsResponseBodyPaginationLink withFirst(Link first) {
        this.first = first;
        return this;
    }
    ...
    public GetPickupsResponseBodyPaginationLink withLast(Link last) {
        this.last = last;
        return this;
    }
    ...
    public GetPickupsResponseBodyPaginationLink withNext(OptionalLink next) {
        this.next = next;
        return this;
    }
    ...
    public GetPickupsResponseBodyPaginationLink withPrev(OptionalLink prev) {
        this.prev = prev;
        return this;
    }
    
    public GetPickupsResponseBodyPaginationLink(@JsonProperty("first") Link first, @JsonProperty("last") Link last, @JsonProperty("next") OptionalLink next, @JsonProperty("prev") OptionalLink prev) {
        this.first = first;
        this.last = last;
        this.next = next;
        this.prev = prev;
