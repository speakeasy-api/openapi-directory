...
from ..shared import createsharedlinkresponse as shared_createsharedlinkresponse
...
@dataclasses.dataclass
class SharedLinksAddSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class SharedLinksAddRequest:
    headers: SharedLinksAddHeaders = dataclasses.field()
    query_params: SharedLinksAddQueryParams = dataclasses.field()
    request: shared_sharedlink.SharedLinkInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: SharedLinksAddSecurity = dataclasses.field()
    

@dataclasses.dataclass
class SharedLinksAddResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    create_shared_link_response: Optional[shared_createsharedlinkresponse.CreateSharedLinkResponse] = dataclasses.field(default=None)
