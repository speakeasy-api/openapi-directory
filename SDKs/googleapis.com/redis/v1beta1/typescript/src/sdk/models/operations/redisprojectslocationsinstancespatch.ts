...
export class RedisProjectsLocationsInstancesPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RedisProjectsLocationsInstancesPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RedisProjectsLocationsInstancesPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
