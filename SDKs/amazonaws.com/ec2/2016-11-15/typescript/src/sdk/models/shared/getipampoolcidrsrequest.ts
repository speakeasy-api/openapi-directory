 ...
 */
export class GetIpamPoolCidrsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class GetIpamPoolCidrsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: GetIpamPoolCidrsRequestFilters })
