...
class ImChatSessions200ApplicationXMLSessionsTypeEnum(str, Enum):
    r"""IM chat session type."""
    GROUP = 'Group'
    ONE_1 = '1:1'
...
class ImChatSessions200ApplicationXMLSessions:
    ...
    last_message_sent_time: Optional[datetime] = dataclasses.field(default=None)
    r"""Last message sent time."""  
    name: Optional[str] = dataclasses.field(default=None)
    r"""Meeting topic."""  
    session_id: Optional[str] = dataclasses.field(default=None)
    r"""IM chat session ID."""  
    type: Optional[ImChatSessions200ApplicationXMLSessionsTypeEnum] = dataclasses.field(default=None)
    r"""IM chat session type."""  
    

@dataclasses.dataclass
class ImChatSessions200ApplicationXML:
    r"""Pagination object."""
    ...
    sessions: Optional[list[ImChatSessions200ApplicationXMLSessions]] = dataclasses.field(default=None)
...
class ImChatSessions200ApplicationJSONSessions:
    ...
    last_message_sent_time: Optional[datetime] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('last_message_sent_time'), 'encoder': utils.datetimeisoformat(True), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso'), 'exclude': lambda f: f is None }})
    r"""Last message sent time."""  
    ...
    r"""IM chat session ID."""  
    type: Optional[ImChatSessions200ApplicationJSONSessionsTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""IM chat session type."""  
...
class ImChatSessions200ApplicationJSON:
    ...
    r"""The amount of records returns within a single API call."""  
    sessions: Optional[list[ImChatSessions200ApplicationJSONSessions]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sessions'), 'exclude': lambda f: f is None }})
    r"""Array of session objects."""  
