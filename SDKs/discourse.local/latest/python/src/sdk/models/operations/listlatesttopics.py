...
class ListLatestTopics200ApplicationJSONTopicListTopics:
    ...
    posters: Optional[list[ListLatestTopics200ApplicationJSONTopicListTopicsPosters]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('posters'), 'exclude': lambda f: f is None }})  
...
class ListLatestTopics200ApplicationJSONTopicList:
    ...
    topics: Optional[list[ListLatestTopics200ApplicationJSONTopicListTopics]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('topics'), 'exclude': lambda f: f is None }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ListLatestTopics200ApplicationJSONUsers:
...
class ListLatestTopics200ApplicationJSON:
    ...
    topic_list: Optional[ListLatestTopics200ApplicationJSONTopicList] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('topic_list'), 'exclude': lambda f: f is None }})  
    users: Optional[list[ListLatestTopics200ApplicationJSONUsers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('users'), 'exclude': lambda f: f is None }})  
...
class ListLatestTopicsResponse:
    ...
    list_latest_topics_200_application_json_object: Optional[ListLatestTopics200ApplicationJSON] = dataclasses.field(default=None)
    r"""topic updated"""  
