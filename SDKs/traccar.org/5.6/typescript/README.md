...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/traccar.org/5.6/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/traccar.org/5.6/typescript
```
