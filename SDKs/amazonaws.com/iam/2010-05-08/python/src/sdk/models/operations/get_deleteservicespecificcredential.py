...
class GetDeleteServiceSpecificCredentialQueryParams:
    action: GetDeleteServiceSpecificCredentialActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteServiceSpecificCredentialVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteServiceSpecificCredentialRequest:
    headers: GetDeleteServiceSpecificCredentialHeaders = dataclasses.field()
    query_params: GetDeleteServiceSpecificCredentialQueryParams = dataclasses.field()
