...
class DirectoryChromeosdevicesPatchRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DirectoryChromeosdevicesPatchProjectionEnum $projection
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=projection')]
    public ?DirectoryChromeosdevicesPatchProjectionEnum $projection = null;
