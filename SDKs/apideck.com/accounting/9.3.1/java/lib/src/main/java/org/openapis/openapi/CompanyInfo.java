...
public class CompanyInfo {
     ...
     */
    public org.openapis.openapi.models.operations.CompanyInfoOneResponse companyInfoOne(org.openapis.openapi.models.operations.CompanyInfoOneRequest request, org.openapis.openapi.models.operations.CompanyInfoOneSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/accounting/company-info");
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.CompanyInfoOneRequest.class, request, null);
        if (queryParams != null) {
        ...
        org.openapis.openapi.models.operations.CompanyInfoOneResponse res = new org.openapis.openapi.models.operations.CompanyInfoOneResponse(contentType, httpRes.statusCode()) {{
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.GetCompanyInfoResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.GetCompanyInfoResponse.class);
