...
public class GetMeWritePermissionsRequest {
    ...
    public GetMeWritePermissionsRequest withCallback(String callback) {
    ...
    public GetMeWritePermissionsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeWritePermissionsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeWritePermissionsRequest withPagesize(Long pagesize) {
    ...
    public GetMeWritePermissionsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    public GetMeWritePermissionsRequest(@JsonProperty("site") String site) {
        this.site = site;
  }
}
