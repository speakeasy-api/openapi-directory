...
public class ListUsageRecordListUsageRecordResponse {
    ...
    public openapisdk.models.shared.WirelessV1SimUsageRecord[] usageRecords;
    public ListUsageRecordListUsageRecordResponse withUsageRecords(openapisdk.models.shared.WirelessV1SimUsageRecord[] usageRecords) {
