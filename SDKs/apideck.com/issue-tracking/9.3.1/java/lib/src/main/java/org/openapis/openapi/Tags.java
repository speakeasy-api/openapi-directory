...
public class Tags {
     ...
     */
    public org.openapis.openapi.models.operations.CollectionTagsAllResponse collectionTagsAll(org.openapis.openapi.models.operations.CollectionTagsAllRequest request, org.openapis.openapi.models.operations.CollectionTagsAllSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.CollectionTagsAllRequest.class, baseUrl, "/issue-tracking/collections/{collection_id}/tags", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.CollectionTagsAllRequest.class, request, null);
        if (queryParams != null) {
        ...
        org.openapis.openapi.models.operations.CollectionTagsAllResponse res = new org.openapis.openapi.models.operations.CollectionTagsAllResponse(contentType, httpRes.statusCode()) {{
            getCollectionTagsResponse = null;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.GetCollectionTagsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.GetCollectionTagsResponse.class);
