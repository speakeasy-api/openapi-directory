...
class PostCommentForPullRequestRequest:
    ...
    post_comment_for_pull_request_input: shared_postcommentforpullrequestinput.PostCommentForPullRequestInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
