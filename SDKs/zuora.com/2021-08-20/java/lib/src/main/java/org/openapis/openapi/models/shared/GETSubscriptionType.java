...
/**
 * GETSubscriptionType - Container for custom fields of a Subscription object.
 * 
 */
public class GETSubscriptionType {
    ...
    public GETSubscriptionType withCpqBundleJsonIdQT(String cpqBundleJsonIdQT) {
    ...
    public GETSubscriptionType withIntegrationIdNS(String integrationIdNS) {
    ...
    public GETSubscriptionType withIntegrationStatusNS(String integrationStatusNS) {
    ...
    public GETSubscriptionType withOpportunityCloseDateQT(LocalDate opportunityCloseDateQT) {
    ...
    public GETSubscriptionType withOpportunityNameQT(String opportunityNameQT) {
    ...
    public GETSubscriptionType withProjectNS(String projectNS) {
    ...
    public GETSubscriptionType withQuoteBusinessTypeQT(String quoteBusinessTypeQT) {
    ...
    public GETSubscriptionType withQuoteNumberQT(String quoteNumberQT) {
    ...
    public GETSubscriptionType withQuoteTypeQT(String quoteTypeQT) {
    ...
    public GETSubscriptionType withSalesOrderNS(String salesOrderNS) {
    ...
    public GETSubscriptionType withSyncDateNS(String syncDateNS) {
    ...
    public GETSubscriptionType withAccountId(String accountId) {
    ...
    public GETSubscriptionType withAccountName(String accountName) {
    ...
    public GETSubscriptionType withAccountNumber(String accountNumber) {
    ...
    public GETSubscriptionType withAutoRenew(Boolean autoRenew) {
    ...
    public GETSubscriptionType withContractEffectiveDate(LocalDate contractEffectiveDate) {
    ...
    public GETSubscriptionType withContractedMrr(Double contractedMrr) {
    ...
    public GETSubscriptionType withCurrentTerm(Long currentTerm) {
    ...
    public GETSubscriptionType withCurrentTermPeriodType(String currentTermPeriodType) {
    ...
    public GETSubscriptionType withCustomerAcceptanceDate(LocalDate customerAcceptanceDate) {
    ...
    @JsonProperty("id")
    public String id;
    public GETSubscriptionType withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GETSubscriptionType withInitialTerm(Long initialTerm) {
    ...
    public GETSubscriptionType withInitialTermPeriodType(String initialTermPeriodType) {
    ...
    public GETSubscriptionType withInvoiceOwnerAccountId(String invoiceOwnerAccountId) {
    ...
    public GETSubscriptionType withInvoiceOwnerAccountName(String invoiceOwnerAccountName) {
    ...
    public GETSubscriptionType withInvoiceOwnerAccountNumber(String invoiceOwnerAccountNumber) {
    ...
    public GETSubscriptionType withInvoiceSeparately(String invoiceSeparately) {
    ...
    @JsonProperty("notes")
    public String notes;
    public GETSubscriptionType withNotes(String notes) {
        this.notes = notes;
        return this;
    }
    ...
    public GETSubscriptionType withOrderNumber(String orderNumber) {
    ...
    public GETSubscriptionType withRatePlans(GETSubscriptionRatePlanType[] ratePlans) {
    ...
    public GETSubscriptionType withRenewalSetting(String renewalSetting) {
    ...
    public GETSubscriptionType withRenewalTerm(Long renewalTerm) {
    ...
    public GETSubscriptionType withRenewalTermPeriodType(String renewalTermPeriodType) {
    ...
    public GETSubscriptionType withRevision(String revision) {
    ...
    public GETSubscriptionType withServiceActivationDate(LocalDate serviceActivationDate) {
    ...
    public GETSubscriptionType withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public GETSubscriptionType withSubscriptionEndDate(LocalDate subscriptionEndDate) {
    ...
    public GETSubscriptionType withSubscriptionNumber(String subscriptionNumber) {
    ...
    public GETSubscriptionType withSubscriptionStartDate(LocalDate subscriptionStartDate) {
    ...
    public GETSubscriptionType withTermEndDate(LocalDate termEndDate) {
    ...
    public GETSubscriptionType withTermStartDate(LocalDate termStartDate) {
    ...
    public GETSubscriptionType withTermType(String termType) {
    ...
    public GETSubscriptionType withTotalContractedValue(Double totalContractedValue) {
