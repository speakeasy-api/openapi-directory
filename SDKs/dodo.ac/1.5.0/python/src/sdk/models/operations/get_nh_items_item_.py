...
from ..shared import nhitem as shared_nhitem
from typing import Optional


@dataclasses.dataclass
class GetNhItemsItemRequest:
...
class GetNhItemsItemResponse:
    ...
    nh_item: Optional[shared_nhitem.NHItem] = dataclasses.field(default=None)
