...
var DescribeRecommendationExportJobsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: recommendationexportjob_1.RecommendationExportJob }),
        (0, class_transformer_1.Expose)({ name: "recommendationExportJobs" }),
        (0, class_transformer_1.Type)(function () { return recommendationexportjob_1.RecommendationExportJob; }),
