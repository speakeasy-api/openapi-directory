...
class GETDebitMemoItemTypewithSuccessSourceItemTypeEnum(str, Enum):
...
class GETDebitMemoItemTypewithSuccessTaxModeEnum(str, Enum):
...
class GETDebitMemoItemTypewithSuccess:
    ...
    **Note**: This field is not available if you set the `zuora-version` request header to `257.0` or later.
    ...
    r"""The description of the debit memo item.
    
    **Note**: This field is only available if you set the `zuora-version` request header to `257.0` or later.
    """  
    finance_information: Optional[GETDebitMemoItemTypewithSuccessFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the debit memo item."""  
    ...
    source_item_type: Optional[GETDebitMemoItemTypewithSuccessSourceItemTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceItemType'), 'exclude': lambda f: f is None }})
    r"""The type of the source item."""  
    ...
    taxation_items: Optional[GETDebitMemoItemTypewithSuccessTaxationItems] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxationItems'), 'exclude': lambda f: f is None }})
    r"""Container for the taxation items of the debit memo item.
    ...
    **Note**: This field is not available if you set the `zuora-version` request header to `239.0` or later.
    """  
    tax_mode: Optional[GETDebitMemoItemTypewithSuccessTaxModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxMode'), 'exclude': lambda f: f is None }})
    r"""The tax mode of the debit memo item, indicating whether the amount of the debit memo item includes tax."""  
