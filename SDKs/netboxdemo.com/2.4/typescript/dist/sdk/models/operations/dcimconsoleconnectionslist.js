...
exports.DcimConsoleConnectionsListResponse = exports.DcimConsoleConnectionsList200ApplicationJSON = exports.DcimConsoleConnectionsListRequest = void 0;
...
var DcimConsoleConnectionsListRequest = /** @class */ (function (_super) {
    ...
    ], DcimConsoleConnectionsListRequest.prototype, "connectionStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=device",
        }),
        __metadata("design:type", String)
    ], DcimConsoleConnectionsListRequest.prototype, "device", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], DcimConsoleConnectionsListRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], DcimConsoleConnectionsListRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], DcimConsoleConnectionsListRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=site" }),
        __metadata("design:type", String)
    ], DcimConsoleConnectionsListRequest.prototype, "site", void 0);
...
var DcimConsoleConnectionsListResponse = /** @class */ (function (_super) {
    ...
    ], DcimConsoleConnectionsListResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
