...
class PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDApproveRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDApprovePathParams = dataclasses.field()
    security: PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDApproveSecurity = dataclasses.field()
