...
class SearchTypeImageAirportQueryParams:
...
@dataclasses.dataclass
class SearchTypeImageAirportRequest:
    query_params: SearchTypeImageAirportQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeImageAirportResponse:
