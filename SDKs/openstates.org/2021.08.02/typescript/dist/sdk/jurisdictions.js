...
exports.Jurisdictions = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var Jurisdictions = /** @class */ (function () {
    function Jurisdictions(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Jurisdictions.prototype.jurisdictionDetailJurisdictionsJurisdictionIdGet = function (req, config) {
    ...
    **/
    Jurisdictions.prototype.jurisdictionListJurisdictionsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
