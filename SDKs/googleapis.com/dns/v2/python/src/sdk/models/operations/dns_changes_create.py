...
class DNSChangesCreateSecurity:
    option1: Optional[DNSChangesCreateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSChangesCreateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DNSChangesCreateRequest:
    path_params: DNSChangesCreatePathParams = dataclasses.field()
    query_params: DNSChangesCreateQueryParams = dataclasses.field()
    security: DNSChangesCreateSecurity = dataclasses.field()
    request: Optional[shared_change.Change] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
