...
class GetDescribeLoadBalancersQueryParams:
    action: GetDescribeLoadBalancersActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDescribeLoadBalancersVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeLoadBalancersRequest:
    headers: GetDescribeLoadBalancersHeaders = dataclasses.field()
    query_params: GetDescribeLoadBalancersQueryParams = dataclasses.field()
