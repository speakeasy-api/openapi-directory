...
class GetSecurityConfigResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetSecurityConfigResponse $getSecurityConfigResponse
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetSecurityConfigResponse $getSecurityConfigResponse = null;
	...
	{
		$this->contentType = "";
		$this->getSecurityConfigResponse = null;
