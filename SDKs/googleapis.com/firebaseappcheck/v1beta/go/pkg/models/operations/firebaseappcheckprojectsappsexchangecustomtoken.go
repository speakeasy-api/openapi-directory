...
type FirebaseappcheckProjectsAppsExchangeCustomTokenRequest struct {
	...
	GoogleFirebaseAppcheckV1betaExchangeCustomTokenRequest *shared.GoogleFirebaseAppcheckV1betaExchangeCustomTokenRequest `request:"mediaType=application/json"`
	// OAuth access token.
