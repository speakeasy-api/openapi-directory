 ...
 *
 */
var LicenseTypes = /** @class */ (function () {
    function LicenseTypes(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    LicenseTypes.prototype.getClassificationsLicenseTypes = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetClassificationsLicenseTypesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/classifications/license-types";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetClassificationsLicenseTypesResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        ...
                        res.licenseTypes = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.LicenseType, resFieldDepth);
                    }
                    break;
