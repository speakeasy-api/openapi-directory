...
exports.CreateRuleGroupRequest = void 0;
...
var CreateRuleGroupRequest = /** @class */ (function (_super) {
    ...
    ], CreateRuleGroupRequest.prototype, "capacity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Description" }),
        __metadata("design:type", String)
    ], CreateRuleGroupRequest.prototype, "description", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=DryRun" }),
        __metadata("design:type", Boolean)
    ], CreateRuleGroupRequest.prototype, "dryRun", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=RuleGroup" }),
        __metadata("design:type", rulegroup_1.RuleGroup)
    ], CreateRuleGroupRequest.prototype, "ruleGroup", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=RuleGroupName" }),
        __metadata("design:type", String)
    ], CreateRuleGroupRequest.prototype, "ruleGroupName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Rules" }),
        __metadata("design:type", String)
    ], CreateRuleGroupRequest.prototype, "rules", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Tags", elemType: tag_1.Tag }),
        __metadata("design:type", Array)
    ], CreateRuleGroupRequest.prototype, "tags", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Type" }),
        __metadata("design:type", String)
    ], CreateRuleGroupRequest.prototype, "type", void 0);
