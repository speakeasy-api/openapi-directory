...
from ..shared import googlecloudvideointelligencev1p1beta1_videocontext as shared_googlecloudvideointelligencev1p1beta1_videocontext

class GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestFeaturesEnum(str, Enum):
...
class GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest:
    r"""GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest
    Video annotation request.
    """
    
    features: Optional[list[GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestFeaturesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('features') }})
    ...
    video_context: Optional[shared_googlecloudvideointelligencev1p1beta1_videocontext.GoogleCloudVideointelligenceV1p1beta1VideoContext] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('videoContext') }})
