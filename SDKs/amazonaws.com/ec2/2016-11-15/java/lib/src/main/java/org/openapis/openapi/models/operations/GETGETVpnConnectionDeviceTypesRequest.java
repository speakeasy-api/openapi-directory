...
public class GETGETVpnConnectionDeviceTypesRequest {
    ...
    public GETGETVpnConnectionDeviceTypesRequest(@JsonProperty("Action") GETGETVpnConnectionDeviceTypesActionEnum action, @JsonProperty("Version") GETGETVpnConnectionDeviceTypesVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
