...
type StoreDetailAndSubmitRequestEntityTypeEnum string

const (
	StoreDetailAndSubmitRequestEntityTypeEnumNaturalPerson StoreDetailAndSubmitRequestEntityTypeEnum = "NaturalPerson"
