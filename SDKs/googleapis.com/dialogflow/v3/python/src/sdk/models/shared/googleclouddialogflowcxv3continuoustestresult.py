...
class GoogleCloudDialogflowCxV3ContinuousTestResult:
    ...
    result: Optional[GoogleCloudDialogflowCxV3ContinuousTestResultResultEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})
    r"""The result of this continuous test run, i.e. whether all the tests in this continuous test run pass or not."""  
