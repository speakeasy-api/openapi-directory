...
public class GetEvidenceResponse {
    ...
    public org.openapis.openapi.models.shared.GetEvidenceResponse getEvidenceResponse;

    public GetEvidenceResponse withGetEvidenceResponse(org.openapis.openapi.models.shared.GetEvidenceResponse getEvidenceResponse) {
    ...
    public GetEvidenceResponse withStatusCode(Integer statusCode) {
    ...
    public GetEvidenceResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public GetEvidenceResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
