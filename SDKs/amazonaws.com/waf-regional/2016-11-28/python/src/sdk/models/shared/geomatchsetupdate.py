...
class GeoMatchSetUpdate:
    ...
    geo_match_constraint: shared_geomatchconstraint.GeoMatchConstraint = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('GeoMatchConstraint') }})  
