...
public class IdeahubPlatformsPropertiesIdeaActivitiesCreateRequest {
    ...
    public openapisdk.models.shared.GoogleSearchIdeahubV1alphaIdeaActivity request;
    public IdeahubPlatformsPropertiesIdeaActivitiesCreateRequest withRequest(openapisdk.models.shared.GoogleSearchIdeahubV1alphaIdeaActivity request) {
