...
func (e *GetUsersIdsCommentsToidOrderEnum) UnmarshalJSON(data []byte) error {
	...
	case "desc":
		fallthrough
	case "asc":
		*e = GetUsersIdsCommentsToidOrderEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersIdsCommentsToidOrderEnum: %s", s)
	}
}
...
func (e *GetUsersIdsCommentsToidSortEnum) UnmarshalJSON(data []byte) error {
	...
	case "creation":
		fallthrough
	case "votes":
		*e = GetUsersIdsCommentsToidSortEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersIdsCommentsToidSortEnum: %s", s)
	}
}
