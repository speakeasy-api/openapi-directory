...
type GetV2SuccessesJSONQueryParams struct {
...
type GetV2SuccessesJSONRequest struct {
	QueryParams GetV2SuccessesJSONQueryParams
}

type GetV2SuccessesJSONResponse struct {
	Body        []byte
	ContentType string
	StatusCode  int
