...
class DisplayvideoAdvertisersLocationListsAssignedLocationsBulkEditRequest:
    ...
    bulk_edit_assigned_locations_request_input: Optional[shared_bulkeditassignedlocationsrequest.BulkEditAssignedLocationsRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
