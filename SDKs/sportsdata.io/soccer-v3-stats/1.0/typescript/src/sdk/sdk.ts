...
export class SDK {
  ...
  boxScoresByDateByCompetition(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.BoxScoresByDateByCompetitionResponse =
        new operations.BoxScoresByDateByCompetitionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  boxScoresDeltaByDateByCompetition(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.BoxScoresDeltaByDateByCompetitionResponse =
        new operations.BoxScoresDeltaByDateByCompetitionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
