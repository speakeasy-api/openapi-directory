 ...
 */
export enum SecurityPoliciesAggregatedListWarningCodeEnum {
...
export class SecurityPoliciesAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SecurityPoliciesAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: SecurityPoliciesAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class SecurityPoliciesAggregatedList extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "etag" })
  etag?: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: SecurityPoliciesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, SecurityPoliciesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], SecurityPoliciesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
