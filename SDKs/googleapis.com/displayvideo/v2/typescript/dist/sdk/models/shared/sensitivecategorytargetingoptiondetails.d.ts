 ...
 */
export declare enum SensitiveCategoryTargetingOptionDetailsSensitiveCategoryEnum {
 ...
 */
export declare class SensitiveCategoryTargetingOptionDetails extends SpeakeasyBase {
    /**
     * Output only. An enum for the DV360 Sensitive category content classifier.
     */
