...
func (s *listingViolation) GetListingViolations(ctx context.Context, request operations.GetListingViolationsRequest, security operations.GetListingViolationsSecurity) (*operations.GetListingViolationsResponse, error) {
	baseURL := s.serverURL
...
func (s *listingViolation) SuppressViolation(ctx context.Context, request shared.SuppressViolationRequest, security operations.SuppressViolationSecurity) (*operations.SuppressViolationResponse, error) {
	baseURL := s.serverURL
