...
public class OralQuestions {
	...
	public OralQuestions(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
     ...
     */
    public org.openapis.openapi.models.operations.PublishedOralQuestionGetResponse publishedOralQuestionGet(org.openapis.openapi.models.operations.PublishedOralQuestionGetRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/oralquestions/list");
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.PublishedOralQuestionGetRequest.class, request, null);
        if (queryParams != null) {
        ...
        org.openapis.openapi.models.operations.PublishedOralQuestionGetResponse res = new org.openapis.openapi.models.operations.PublishedOralQuestionGetResponse(contentType, httpRes.statusCode()) {{
