...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/googleapis.com/privateca/v1beta1/python
```
...
res = s.projects.privateca_projects_locations_list(req, operations.PrivatecaProjectsLocationsListSecurity(
