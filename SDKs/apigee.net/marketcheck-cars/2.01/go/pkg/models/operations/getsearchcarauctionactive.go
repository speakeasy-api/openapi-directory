...
type GetSearchCarAuctionActiveTitleTypeEnum string

const (
	GetSearchCarAuctionActiveTitleTypeEnumClean   GetSearchCarAuctionActiveTitleTypeEnum = "clean"
	GetSearchCarAuctionActiveTitleTypeEnumSalvage GetSearchCarAuctionActiveTitleTypeEnum = "salvage"
)

func (e *GetSearchCarAuctionActiveTitleTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "clean":
		fallthrough
	case "salvage":
		*e = GetSearchCarAuctionActiveTitleTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSearchCarAuctionActiveTitleTypeEnum: %s", s)
	}
}
...
type GetSearchCarAuctionActiveQueryParams struct {
	...
	TitleType *GetSearchCarAuctionActiveTitleTypeEnum `queryParam:"style=form,explode=true,name=title_type"`
