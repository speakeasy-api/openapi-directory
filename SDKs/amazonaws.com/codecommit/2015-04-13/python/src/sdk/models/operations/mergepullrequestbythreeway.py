...
class MergePullRequestByThreeWayRequest:
    ...
    merge_pull_request_by_three_way_input: shared_mergepullrequestbythreewayinput.MergePullRequestByThreeWayInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
