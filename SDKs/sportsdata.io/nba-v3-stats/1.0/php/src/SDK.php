...
class SDK
{
     ...
     * All-Stars
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\AllStarsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\AllStarsResponse
     */
	public function allStars(
        \OpenAPI\OpenAPI\Models\Operations\AllStarsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\AllStarsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/{format}/AllStars/{season}', \OpenAPI\OpenAPI\Models\Operations\AllStarsRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\AllStarsResponse();
