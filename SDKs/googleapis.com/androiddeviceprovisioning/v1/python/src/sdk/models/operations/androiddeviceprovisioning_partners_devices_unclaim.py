...
class AndroiddeviceprovisioningPartnersDevicesUnclaimRequest:
    ...
    unclaim_device_request: Optional[shared_unclaimdevicerequest.UnclaimDeviceRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
