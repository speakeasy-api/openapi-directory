...
class PostDescribeDbClusterEndpointsQueryParams:
    action: PostDescribeDbClusterEndpointsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeDbClusterEndpointsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeDbClusterEndpointsRequest:
    headers: PostDescribeDbClusterEndpointsHeaders = dataclasses.field()
    query_params: PostDescribeDbClusterEndpointsQueryParams = dataclasses.field()
