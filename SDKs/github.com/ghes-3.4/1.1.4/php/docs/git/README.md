...
try {
    ...
    $request->requestBody->encoding = 'doloremque';
...
try {
    ...
    $request->requestBody->author->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-11-23T03:40:41.154Z');
    $request->requestBody->author->email = 'Emil95@gmail.com';
    $request->requestBody->author->name = 'Oscar Ullrich';
    $request->requestBody->committer = new GitCreateCommitRequestBodyCommitter();
    $request->requestBody->committer->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-03-17T06:13:21.698Z');
    $request->requestBody->committer->email = 'Davin.Upton@yahoo.com';
    $request->requestBody->committer->name = 'Amelia Harvey';
    $request->requestBody->message = 'illo';
    $request->requestBody->parents = [
        'quidem',
        'eveniet',
    ];
    $request->requestBody->signature = 'non';
    $request->requestBody->tree = 'vero';
...
try {
    ...
    $request->requestBody->ref = 'ipsa';
    $request->requestBody->sha = 'totam';
    $request->owner = 'quae';
...
try {
    ...
    $request->requestBody->message = 'eveniet';
    $request->requestBody->object = 'qui';
    $request->requestBody->tag = 'cum';
    $request->requestBody->tagger = new GitCreateTagRequestBodyTagger();
    $request->requestBody->tagger->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-07T04:58:25.283Z');
    $request->requestBody->tagger->email = 'Margarette_Rau@gmail.com';
    $request->requestBody->tagger->name = 'Mrs. Geraldine Zulauf';
...
try {
    ...
    $request->requestBody->baseTree = 'alias';
...
try {
    ...
    $request->recursive = 'eum';
    $request->repo = 'nemo';
    $request->treeSha = 'recusandae';
