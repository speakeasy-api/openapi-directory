...
exports.ExportSystemAdvisoriesResponse = exports.ExportSystemAdvisoriesRequest = exports.ExportSystemAdvisoriesSecurity = void 0;
...
var ExportSystemAdvisoriesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ExportSystemAdvisoriesRequest.prototype, "filterAdvisoryType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[description]",
        }),
        __metadata("design:type", String)
    ], ExportSystemAdvisoriesRequest.prototype, "filterDescription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[id]",
        }),
        __metadata("design:type", String)
    ], ExportSystemAdvisoriesRequest.prototype, "filterId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[public_date]",
        }),
        __metadata("design:type", String)
    ], ExportSystemAdvisoriesRequest.prototype, "filterPublicDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[severity]",
        }),
        __metadata("design:type", String)
    ], ExportSystemAdvisoriesRequest.prototype, "filterSeverity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[synopsis]",
        }),
        __metadata("design:type", String)
    ], ExportSystemAdvisoriesRequest.prototype, "filterSynopsis", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=inventory_id",
        }),
        __metadata("design:type", String)
    ], ExportSystemAdvisoriesRequest.prototype, "inventoryId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=search",
        }),
        __metadata("design:type", String)
    ], ExportSystemAdvisoriesRequest.prototype, "search", void 0);
...
var ExportSystemAdvisoriesResponse = /** @class */ (function (_super) {
    ...
    ], ExportSystemAdvisoriesResponse.prototype, "rawResponse", void 0);
    __decorate([
