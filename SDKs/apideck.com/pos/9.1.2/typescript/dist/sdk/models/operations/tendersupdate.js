...
exports.TendersUpdateResponse = exports.TendersUpdateRequest = exports.TendersUpdateSecurity = void 0;
...
exports.TendersUpdateSecurity = TendersUpdateSecurity;
var TendersUpdateRequest = /** @class */ (function (_super) {
    ...
    ], TendersUpdateRequest.prototype, "tenderInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], TendersUpdateRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], TendersUpdateRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], TendersUpdateRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], TendersUpdateRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], TendersUpdateRequest.prototype, "xApideckServiceId", void 0);
    return TendersUpdateRequest;
}(utils_1.SpeakeasyBase));
exports.TendersUpdateRequest = TendersUpdateRequest;
var TendersUpdateResponse = /** @class */ (function (_super) {
    ...
    ], TendersUpdateResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.TendersUpdateResponse = TendersUpdateResponse;
