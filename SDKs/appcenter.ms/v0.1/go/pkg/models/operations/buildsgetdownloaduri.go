...
func (e BuildsGetDownloadURIDownloadTypeEnum) ToPointer() *BuildsGetDownloadURIDownloadTypeEnum {
	return &e
}
...
func (e *BuildsGetDownloadURIDownloadTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "mapping":
		fallthrough
	case "bundle":
		*e = BuildsGetDownloadURIDownloadTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for BuildsGetDownloadURIDownloadTypeEnum: %v", v)
	}
}
