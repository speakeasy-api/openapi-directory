...
class DeploymentmanagerDeploymentsInsertRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DeploymentmanagerDeploymentsInsertCreatePolicyEnum $createPolicy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=createPolicy')]
    public ?DeploymentmanagerDeploymentsInsertCreatePolicyEnum $createPolicy = null;
