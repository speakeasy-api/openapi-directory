...
public class GetApiV2SpotinsertionsQueryParams {
    /**
    ...
    public GetApiV2SpotinsertionsQueryParams withOrderById(GetApiV2SpotinsertionsOrderByIDEnum orderById) {
    ...
    public GetApiV2SpotinsertionsQueryParams withPageSize(Integer pageSize) {
    ...
    public GetApiV2SpotinsertionsQueryParams withPageStart(Integer pageStart) {
