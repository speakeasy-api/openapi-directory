 ...
 */
export class DescribeTrafficMirrorFiltersRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeTrafficMirrorFiltersRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeTrafficMirrorFiltersRequestFilters })
