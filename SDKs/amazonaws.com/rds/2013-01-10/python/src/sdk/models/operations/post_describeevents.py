...
class PostDescribeEventsQueryParams:
    action: PostDescribeEventsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeEventsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeEventsRequest:
    headers: PostDescribeEventsHeaders = dataclasses.field()
    query_params: PostDescribeEventsQueryParams = dataclasses.field()
