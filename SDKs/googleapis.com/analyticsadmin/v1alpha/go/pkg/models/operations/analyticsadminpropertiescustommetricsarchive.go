...
type AnalyticsadminPropertiesCustomMetricsArchiveSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AnalyticsadminPropertiesCustomMetricsArchivePathParams struct {
	// Required. The name of the CustomMetric to archive. Example format: properties/1234/customMetrics/5678
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type AnalyticsadminPropertiesCustomMetricsArchiveQueryParams struct {
	// V1 error format.
...
type AnalyticsadminPropertiesCustomMetricsArchiveRequest struct {
...
type AnalyticsadminPropertiesCustomMetricsArchiveResponse struct {
	ContentType string
	// Successful response
