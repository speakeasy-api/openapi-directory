 ...
 */
public enum CreateIntegrationResponseResponseContentHandlingStrategyEnum {
    ...
    private CreateIntegrationResponseResponseContentHandlingStrategyEnum(String value) {
        this.value = value;
    }
}
