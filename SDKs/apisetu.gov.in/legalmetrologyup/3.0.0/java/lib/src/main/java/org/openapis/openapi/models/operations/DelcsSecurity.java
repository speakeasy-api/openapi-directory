...
public class DelcsSecurity {
    ...
    public DelcsSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public DelcsSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public DelcsSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
