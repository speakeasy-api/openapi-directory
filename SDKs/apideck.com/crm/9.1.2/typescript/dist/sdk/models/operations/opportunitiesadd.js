...
exports.OpportunitiesAddResponse = exports.OpportunitiesAddRequest = exports.OpportunitiesAddSecurity = void 0;
...
var OpportunitiesAddRequest = /** @class */ (function (_super) {
    ...
    ], OpportunitiesAddRequest.prototype, "opportunityInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], OpportunitiesAddRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], OpportunitiesAddRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], OpportunitiesAddRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], OpportunitiesAddRequest.prototype, "xApideckServiceId", void 0);
...
var OpportunitiesAddResponse = /** @class */ (function (_super) {
    ...
    ], OpportunitiesAddResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
