 ...
 */
public enum DisplayvideoTargetingTypesTargetingOptionsSearchTargetingTypeEnum {
    ...
    private DisplayvideoTargetingTypesTargetingOptionsSearchTargetingTypeEnum(String value) {
        this.value = value;
    }
}
