...
class DeleteAuditSuppressionRequestBody:
    ...
    resource_identifier: DeleteAuditSuppressionRequestBodyResourceIdentifier = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resourceIdentifier') }})
    r"""Information that identifies the noncompliant resource."""  
...
class DeleteAuditSuppressionRequest:
    ...
    request_body: DeleteAuditSuppressionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
