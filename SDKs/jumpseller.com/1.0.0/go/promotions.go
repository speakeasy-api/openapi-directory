...
func (s *Promotions) GetPromotionsJSON(ctx context.Context, request operations.GetPromotionsJSONRequest) (*operations.GetPromotionsJSONResponse, error) {
	baseURL := s._serverURL
...
func (s *Promotions) PostPromotionsJSON(ctx context.Context, request operations.PostPromotionsJSONRequest) (*operations.PostPromotionsJSONResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/promotions.json"
