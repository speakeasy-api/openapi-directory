...
export class DataplexProjectsLocationsLakesZonesAssetsActionsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsLakesZonesAssetsActionsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsLakesZonesAssetsActionsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
