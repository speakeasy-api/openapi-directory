...
func (e GetDiseaseGeneAssociationsAssociationTypeEnum) ToPointer() *GetDiseaseGeneAssociationsAssociationTypeEnum {
	return &e
}
...
func (e *GetDiseaseGeneAssociationsAssociationTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "non_causal":
		fallthrough
	case "both":
		*e = GetDiseaseGeneAssociationsAssociationTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDiseaseGeneAssociationsAssociationTypeEnum: %v", v)
	}
}
