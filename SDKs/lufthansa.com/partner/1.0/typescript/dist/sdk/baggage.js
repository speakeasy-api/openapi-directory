...
var Baggage = /** @class */ (function () {
     ...
     */
    Baggage.prototype.baggageTripAndContact = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BaggageTripAndContactRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/baggage/baggagetripandcontact/{searchID}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.BaggageTripAndContactResponse({
