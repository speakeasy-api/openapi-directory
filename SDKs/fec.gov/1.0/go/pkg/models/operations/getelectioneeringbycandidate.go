...
func (e GetElectioneeringByCandidateOfficeEnum) ToPointer() *GetElectioneeringByCandidateOfficeEnum {
	return &e
}

func (e *GetElectioneeringByCandidateOfficeEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "senate":
		fallthrough
	case "president":
		*e = GetElectioneeringByCandidateOfficeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetElectioneeringByCandidateOfficeEnum: %v", v)
	}
}
