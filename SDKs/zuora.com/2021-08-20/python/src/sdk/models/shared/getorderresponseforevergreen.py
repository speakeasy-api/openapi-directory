...
class GetOrderResponseForEvergreen:
    ...
    order: Optional[shared_orderforevergreen.OrderForEvergreen] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('order'), 'exclude': lambda f: f is None }})
    ...
    reasons: Optional[list[GetOrderResponseForEvergreenReasons]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reasons'), 'exclude': lambda f: f is None }})  
