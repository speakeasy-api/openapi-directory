...
var DevEndpoint = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=PrivateAddress" }),
        __metadata("design:type", String)
    ], DevEndpoint.prototype, "privateAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=PublicAddress" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=YarnEndpointAddress" }),
        __metadata("design:type", String)
    ], DevEndpoint.prototype, "yarnEndpointAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ZeppelinRemoteSparkInterpreterPort" }),
        __metadata("design:type", Number)
