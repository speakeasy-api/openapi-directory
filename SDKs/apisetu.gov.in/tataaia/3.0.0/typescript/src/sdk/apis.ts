...
export class APIs {
   ...
   */
  prcpt(
    req: operations.PrcptRequestBody,
    security: operations.PrcptSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PrcptResponse = new operations.PrcptResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
      switch (true) {
        ...
        case httpRes?.status == 400:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.prcpt400ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Prcpt400ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 401:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.prcpt401ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Prcpt401ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 404:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.prcpt404ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Prcpt404ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 500:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.prcpt500ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Prcpt500ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 502:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.prcpt502ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Prcpt502ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 503:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.prcpt503ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Prcpt503ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 504:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.prcpt504ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Prcpt504ApplicationJSON
            );
          }
          break;
      }
