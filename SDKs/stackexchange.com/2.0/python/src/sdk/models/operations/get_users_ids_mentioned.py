...
class GetUsersIdsMentionedQueryParams:
    ...
    order: Optional[GetUsersIdsMentionedOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetUsersIdsMentionedSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetUsersIdsMentionedRequest:
    path_params: GetUsersIdsMentionedPathParams = dataclasses.field()
    query_params: GetUsersIdsMentionedQueryParams = dataclasses.field()
