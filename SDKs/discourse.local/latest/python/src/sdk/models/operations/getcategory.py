...
class GetCategory200ApplicationJSONCategory:
    ...
    group_permissions: list[GetCategory200ApplicationJSONCategoryGroupPermissions] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('group_permissions') }})  
    ...
    required_tag_groups: list[GetCategory200ApplicationJSONCategoryRequiredTagGroups] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('required_tag_groups') }})  
...
class GetCategory200ApplicationJSON:
    ...
    category: GetCategory200ApplicationJSONCategory = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category') }})  
...
class GetCategoryResponse:
    ...
    get_category_200_application_json_object: Optional[GetCategory200ApplicationJSON] = dataclasses.field(default=None)
    r"""response"""  
