...
exports.GetNextDeparturesByCRSResponse = exports.GetNextDeparturesByCRSRequest = void 0;
...
var GetNextDeparturesByCRSRequest = /** @class */ (function (_super) {
    ...
    ], GetNextDeparturesByCRSRequest.prototype, "crs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=apiKey",
        }),
        __metadata("design:type", String)
    ], GetNextDeparturesByCRSRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filterList",
        }),
        __metadata("design:type", String)
    ], GetNextDeparturesByCRSRequest.prototype, "filterList", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=serviceDetails",
        }),
        __metadata("design:type", Boolean)
    ], GetNextDeparturesByCRSRequest.prototype, "serviceDetails", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeOffset",
        }),
        __metadata("design:type", Number)
    ], GetNextDeparturesByCRSRequest.prototype, "timeOffset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeWindow",
        }),
        __metadata("design:type", Number)
    ], GetNextDeparturesByCRSRequest.prototype, "timeWindow", void 0);
...
var GetNextDeparturesByCRSResponse = /** @class */ (function (_super) {
    ...
    ], GetNextDeparturesByCRSResponse.prototype, "rawResponse", void 0);
