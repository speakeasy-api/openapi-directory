...
export class InventoryperwarehouseRequest extends SpeakeasyBase {
  /**
...
export class Inventoryperwarehouse200ApplicationJSON extends SpeakeasyBase {
  /**
...
export class InventoryperwarehouseResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   * OK
   */
  @SpeakeasyMetadata({ elemType: Inventoryperwarehouse200ApplicationJSON })
