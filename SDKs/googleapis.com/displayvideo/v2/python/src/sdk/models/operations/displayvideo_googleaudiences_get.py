...
class DisplayvideoGoogleAudiencesGetRequest:
    ...
    r"""Required. The ID of the Google audience to fetch."""  
    ...
    r"""The ID of the advertiser that has access to the fetched Google audience."""  
    ...
    r"""The ID of the partner that has access to the fetched Google audience."""  
