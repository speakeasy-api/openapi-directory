...
public class Opportunity {
    ...
    public Opportunity withContactIds(String[] contactIds) {
    ...
    public Opportunity(@JsonProperty("primary_contact_id") String primaryContactId, @JsonProperty("title") String title) {
        this.primaryContactId = primaryContactId;
        this.title = title;
  }
}
