 ...
 */
public enum CreateNetworkSensorAlertsProfileRequestBodyConditionsDurationEnum {
    ZERO(0L),
    SIXTY(60L),
    ...
    private CreateNetworkSensorAlertsProfileRequestBodyConditionsDurationEnum(Long value) {
        this.value = value;
    }
}
