...
func (s *Search) GetNamesChanges(ctx context.Context, request operations.GetNamesChangesRequest) (*operations.GetNamesChangesResponse, error) {
...
func (s *Search) GetNamesDecisionsRecent(ctx context.Context, request operations.GetNamesDecisionsRecentRequest) (*operations.GetNamesDecisionsRecentResponse, error) {
	baseURL := s._serverURL
...
func (s *Search) GetNamesDecisionsYear(ctx context.Context, request operations.GetNamesDecisionsYearRequest) (*operations.GetNamesDecisionsYearResponse, error) {
	baseURL := s._serverURL
...
func (s *Search) GetNamesInside(ctx context.Context, request operations.GetNamesInsideRequest) (*operations.GetNamesInsideResponse, error) {
	baseURL := s._serverURL
...
func (s *Search) GetNamesNear(ctx context.Context, request operations.GetNamesNearRequest) (*operations.GetNamesNearResponse, error) {
	baseURL := s._serverURL
...
func (s *Search) GetNamesNotOfficialSearch(ctx context.Context, request operations.GetNamesNotOfficialSearchRequest) (*operations.GetNamesNotOfficialSearchResponse, error) {
	baseURL := s._serverURL
...
func (s *Search) GetNamesOfficialSearch(ctx context.Context, request operations.GetNamesOfficialSearchRequest) (*operations.GetNamesOfficialSearchResponse, error) {
	baseURL := s._serverURL
...
func (s *Search) GetNamesSearch(ctx context.Context, request operations.GetNamesSearchRequest) (*operations.GetNamesSearchResponse, error) {
	baseURL := s._serverURL
