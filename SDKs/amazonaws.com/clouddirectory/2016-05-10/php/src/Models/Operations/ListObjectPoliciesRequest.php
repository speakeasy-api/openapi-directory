...
class ListObjectPoliciesRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ListObjectPoliciesXAmzConsistencyLevelEnum $xAmzConsistencyLevel
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=x-amz-consistency-level')]
    public ?ListObjectPoliciesXAmzConsistencyLevelEnum $xAmzConsistencyLevel = null;
	...
	public function __construct()
	{
		...
		$this->nextToken = null;
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\ListObjectPoliciesRequestBody();
