...
export class ContentAccountsCustombatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentAccountsCustombatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentAccountsCustombatchResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
