...
@dataclasses.dataclass
class RegistrationsProvidersListFileAttributes:
...
@dataclasses.dataclass
class RegistrationsProvidersListFileLinks:
...
@dataclasses.dataclass
class RegistrationsProvidersListFileRelationships:
...
class RegistrationsProvidersListFile:
    ...
    attributes: Optional[RegistrationsProvidersListFileAttributes] = dataclasses.field(default=None)
    r"""The properties of the file entity."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The identifier of the file entity."""  
    links: Optional[RegistrationsProvidersListFileLinks] = dataclasses.field(default=None)
    r"""Links to alternative representations of the file entity."""  
    relationships: Optional[RegistrationsProvidersListFileRelationships] = dataclasses.field(default=None)
    r"""Links to other entities or entity collections that have a relationship to the file entity."""  
