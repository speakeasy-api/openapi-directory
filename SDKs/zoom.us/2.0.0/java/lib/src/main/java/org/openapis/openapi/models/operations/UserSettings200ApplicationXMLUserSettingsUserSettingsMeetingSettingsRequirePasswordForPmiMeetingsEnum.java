 ...
 * 
 */
public enum UserSettings200ApplicationXMLUserSettingsUserSettingsMeetingSettingsRequirePasswordForPmiMeetingsEnum {
    JBH_ONLY("jbh_only"),
    ALL("all"),
    NONE("none");
    ...
    private UserSettings200ApplicationXMLUserSettingsUserSettingsMeetingSettingsRequirePasswordForPmiMeetingsEnum(String value) {
        this.value = value;
    }
}
