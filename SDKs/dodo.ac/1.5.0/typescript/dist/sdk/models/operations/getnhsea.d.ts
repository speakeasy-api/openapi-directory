...
export declare class GetNhSeaRequest extends SpeakeasyBase {
    /**
...
export declare class GetNhSeaResponse extends SpeakeasyBase {
    contentType: string;
    /**
     ...
     */
    nhSeaCreatures?: shared.NHSeaCreature[];
    statusCode: number;
