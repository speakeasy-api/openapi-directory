...
class OpportunitiesAddRequest:
    headers: OpportunitiesAddHeaders = dataclasses.field()
    query_params: OpportunitiesAddQueryParams = dataclasses.field()
    request: shared_opportunity.OpportunityInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: OpportunitiesAddSecurity = dataclasses.field()
