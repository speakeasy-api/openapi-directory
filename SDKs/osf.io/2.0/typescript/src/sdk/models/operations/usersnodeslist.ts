 ...
 */
export enum UsersNodesListNodeAttributesCategoryEnum {
  Analysis = "analysis",
 ...
 */
export class UsersNodesListNodeAttributes extends SpeakeasyBase {
  /**
   * The category of the node, as selected by project contributors.
   */
  @SpeakeasyMetadata()
 ...
 */
export class UsersNodesListNodeLinks extends SpeakeasyBase {
  /**
 ...
 */
export class UsersNodesListNodeRelationships extends SpeakeasyBase {
  /**
...
export class UsersNodesListNode extends SpeakeasyBase {
  /**
   * The properties of the node entity.
   */
  @SpeakeasyMetadata()
