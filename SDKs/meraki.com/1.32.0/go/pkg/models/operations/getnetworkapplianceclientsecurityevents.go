...
func (e GetNetworkApplianceClientSecurityEventsSortOrderEnum) ToPointer() *GetNetworkApplianceClientSecurityEventsSortOrderEnum {
	return &e
}
...
func (e *GetNetworkApplianceClientSecurityEventsSortOrderEnum) UnmarshalJSON(data []byte) error {
	...
	case "ascending":
		fallthrough
	case "descending":
		*e = GetNetworkApplianceClientSecurityEventsSortOrderEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkApplianceClientSecurityEventsSortOrderEnum: %v", v)
	}
}
