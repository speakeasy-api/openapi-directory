 ...
 */
export declare class DescribeCarrierGatewaysRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeCarrierGatewaysRequest extends SpeakeasyBase {
