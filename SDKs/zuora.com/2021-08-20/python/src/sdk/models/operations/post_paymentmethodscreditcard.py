...
from ..shared import postpaymentmethodtype as shared_postpaymentmethodtype
...
class POSTPaymentMethodsCreditCardRequest:
    ...
    post_payment_method_type: shared_postpaymentmethodtype.POSTPaymentMethodType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
