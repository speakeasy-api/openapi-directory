...
public class GetItemQueryParams {
    /**
     * The type of device the content is targeting.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=device")
    public String device;
    public GetItemQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetItemQueryParams withExpand(GetItemExpandEnum expand) {
        this.expand = expand;
        return this;
    }
    ...
    public GetItemQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public String lang;
    public GetItemQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetItemQueryParams withMaxRating(String maxRating) {
    ...
    public GetItemQueryParams withSegments(String[] segments) {
    ...
    public GetItemQueryParams withSelectSeason(GetItemSelectSeasonEnum selectSeason) {
    ...
    public String sub;
    public GetItemQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
    ...
    public GetItemQueryParams withUseCustomId(Boolean useCustomId) {
