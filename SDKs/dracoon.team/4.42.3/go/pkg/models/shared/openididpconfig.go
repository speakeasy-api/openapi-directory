...
func (e OpenIDIdpConfigFlowEnum) ToPointer() *OpenIDIdpConfigFlowEnum {
	return &e
}
...
func (e *OpenIDIdpConfigFlowEnum) UnmarshalJSON(data []byte) error {
	...
	case "authorization_code":
		fallthrough
	case "hybrid":
		*e = OpenIDIdpConfigFlowEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for OpenIDIdpConfigFlowEnum: %v", v)
	}
}
...
func (e OpenIDIdpConfigUserInfoSourceEnum) ToPointer() *OpenIDIdpConfigUserInfoSourceEnum {
	return &e
}
...
func (e *OpenIDIdpConfigUserInfoSourceEnum) UnmarshalJSON(data []byte) error {
	...
	case "user_info_endpoint":
		fallthrough
	case "id_token":
		*e = OpenIDIdpConfigUserInfoSourceEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for OpenIDIdpConfigUserInfoSourceEnum: %v", v)
	}
}
