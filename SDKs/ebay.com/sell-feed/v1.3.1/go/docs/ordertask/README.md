...
func main() {
    ...
    res, err := s.OrderTask.CreateOrderTask(ctx, shared.CreateOrderTaskRequest{
        FeedType: sdk.String("esse"),
        FilterCriteria: &shared.OrderFilterCriteria{
            CreationDateRange: &shared.DateRange{
                From: sdk.String("totam"),
                To: sdk.String("porro"),
            },
            ModifiedDateRange: &shared.DateRange{
                From: sdk.String("dolorum"),
                To: sdk.String("dicta"),
            },
            OrderStatus: sdk.String("nam"),
        },
        SchemaVersion: sdk.String("officia"),
    }, operations.CreateOrderTaskSecurity{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.OrderTask.GetOrderTask(ctx, operations.GetOrderTaskRequest{
        TaskID: "occaecati",
    }, operations.GetOrderTaskSecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.OrderTask.GetOrderTasks(ctx, operations.GetOrderTasksRequest{
        DateRange: sdk.String("fugit"),
        FeedType: sdk.String("deleniti"),
        Limit: sdk.String("hic"),
        LookBackDays: sdk.String("optio"),
        Offset: sdk.String("totam"),
        ScheduleID: sdk.String("beatae"),
    }, operations.GetOrderTasksSecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
    ...
    if res.OrderTaskCollection != nil {
        // handle response
    }
}
```
