...
public class DescribeAggregateComplianceByConfigRulesRequest {
    ...
    public DescribeAggregateComplianceByConfigRulesRequest(@JsonProperty("DescribeAggregateComplianceByConfigRulesRequest") org.openapis.openapi.models.shared.DescribeAggregateComplianceByConfigRulesRequest describeAggregateComplianceByConfigRulesRequest, @JsonProperty("X-Amz-Target") DescribeAggregateComplianceByConfigRulesXAmzTargetEnum xAmzTarget) {
        this.describeAggregateComplianceByConfigRulesRequest = describeAggregateComplianceByConfigRulesRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
