...
type ApigeeregistryProjectsLocationsApisDeploymentsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ApigeeregistryProjectsLocationsApisDeploymentsListPathParams struct {
	// Required. The parent, which owns this collection of deployments. Format: `projects/*/locations/*/apis/*`
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ApigeeregistryProjectsLocationsApisDeploymentsListQueryParams struct {
	// V1 error format.
...
type ApigeeregistryProjectsLocationsApisDeploymentsListRequest struct {
...
type ApigeeregistryProjectsLocationsApisDeploymentsListResponse struct {
	ContentType string
	// Successful response
