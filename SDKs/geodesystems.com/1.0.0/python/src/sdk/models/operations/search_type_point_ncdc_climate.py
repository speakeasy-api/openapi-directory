...
class SearchTypePointNcdcClimateQueryParams:
...
@dataclasses.dataclass
class SearchTypePointNcdcClimateRequest:
    query_params: SearchTypePointNcdcClimateQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypePointNcdcClimateResponse:
