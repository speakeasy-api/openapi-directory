...
class GetRetiredObjectCountUsingGetPathParams:
...
@dataclasses.dataclass
class GetRetiredObjectCountUsingGetRequest:
    path_params: GetRetiredObjectCountUsingGetPathParams = dataclasses.field()
    

@dataclasses.dataclass
class GetRetiredObjectCountUsingGetResponse:
