...
export class MybusinessAccountsLocationsReviewsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinessAccountsLocationsReviewsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
