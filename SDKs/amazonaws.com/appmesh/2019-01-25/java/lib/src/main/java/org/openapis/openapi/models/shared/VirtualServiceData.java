...
public class VirtualServiceData {
    ...
    public VirtualServiceData(@JsonProperty("meshName") String meshName, @JsonProperty("metadata") ResourceMetadata metadata, @JsonProperty("spec") VirtualServiceSpec spec, @JsonProperty("status") VirtualServiceStatus status, @JsonProperty("virtualServiceName") String virtualServiceName) {
        this.meshName = meshName;
        this.metadata = metadata;
        this.spec = spec;
        this.status = status;
