...
class MeetingRecordingRegistrantsRecordingRegistrationListRegistrants:
    ...
    custom_questions: Optional[list[MeetingRecordingRegistrantsRecordingRegistrationListRegistrantsCustomQuestions]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('custom_questions'), 'exclude': lambda f: f is None }})
    r"""Custom questions."""  
...
class MeetingRecordingRegistrantsRecordingRegistrationList:
    ...
    registrants: Optional[list[MeetingRecordingRegistrantsRecordingRegistrationListRegistrants]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('registrants'), 'exclude': lambda f: f is None }})
