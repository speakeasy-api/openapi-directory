...
class DeleteImagePermissionsRequest:
    ...
    delete_image_permissions_request: shared_deleteimagepermissionsrequest.DeleteImagePermissionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
