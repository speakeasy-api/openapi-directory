...
exports.GetInternationalPaymentsInternationalPaymentIdPaymentDetailsResponse = exports.GetInternationalPaymentsInternationalPaymentIdPaymentDetailsRequest = exports.GetInternationalPaymentsInternationalPaymentIdPaymentDetailsSecurity = void 0;
...
exports.GetInternationalPaymentsInternationalPaymentIdPaymentDetailsSecurity = GetInternationalPaymentsInternationalPaymentIdPaymentDetailsSecurity;
var GetInternationalPaymentsInternationalPaymentIdPaymentDetailsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetInternationalPaymentsInternationalPaymentIdPaymentDetailsRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=InternationalPaymentId",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentsInternationalPaymentIdPaymentDetailsRequest.prototype, "internationalPaymentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentsInternationalPaymentIdPaymentDetailsRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentsInternationalPaymentIdPaymentDetailsRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentsInternationalPaymentIdPaymentDetailsRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentsInternationalPaymentIdPaymentDetailsRequest.prototype, "xFapiInteractionId", void 0);
    return GetInternationalPaymentsInternationalPaymentIdPaymentDetailsRequest;
}(utils_1.SpeakeasyBase));
exports.GetInternationalPaymentsInternationalPaymentIdPaymentDetailsRequest = GetInternationalPaymentsInternationalPaymentIdPaymentDetailsRequest;
var GetInternationalPaymentsInternationalPaymentIdPaymentDetailsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetInternationalPaymentsInternationalPaymentIdPaymentDetailsResponse.prototype, "rawResponse", void 0);
    return GetInternationalPaymentsInternationalPaymentIdPaymentDetailsResponse;
}(utils_1.SpeakeasyBase));
exports.GetInternationalPaymentsInternationalPaymentIdPaymentDetailsResponse = GetInternationalPaymentsInternationalPaymentIdPaymentDetailsResponse;
