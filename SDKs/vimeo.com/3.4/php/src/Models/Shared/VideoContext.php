...
class VideoContext
{
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\VideoContextActionEnum $action
     */
	#[\JMS\Serializer\Annotation\SerializedName('action')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VideoContextActionEnum>')]
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Shared\VideoContextActionEnum::ADDED_TO;
		$this->resource = [];
		$this->resourceType = "";
	}
}
