...
class UsageOveragePricingUpdatePriceChangeOptionEnum(str, Enum):
    NO_CHANGE = "NoChange"
...
class UsageOveragePricingUpdate:
    ...
    price_change_option: Optional[UsageOveragePricingUpdatePriceChangeOptionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('priceChangeOption') }})
