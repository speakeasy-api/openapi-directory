 ...
 */
export class RegistrationsWikisListWikiAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsWikisListWikiLinks extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsWikisListWikiRelationships extends SpeakeasyBase {
  /**
...
export class RegistrationsWikisListWiki extends SpeakeasyBase {
  /**
   * The properties of the wiki.
   */
  @SpeakeasyMetadata()
