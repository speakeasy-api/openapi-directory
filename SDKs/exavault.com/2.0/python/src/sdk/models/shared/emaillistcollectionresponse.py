...
class EmailListCollectionResponse:
    r"""Response object for list of email lists"""
    
    data: Optional[list[shared_emaillist.EmailList]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
