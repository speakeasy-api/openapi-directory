...
public class QueryPredictionsJsonRequest {
    ...
    public QueryPredictionsJsonRequest(@JsonProperty("PredictionQueryToken") org.openapis.openapi.models.shared.PredictionQueryToken predictionQueryToken, @JsonProperty("Training-Key") String trainingKey, @JsonProperty("projectId") String projectId) {
        this.predictionQueryToken = predictionQueryToken;
        this.trainingKey = trainingKey;
        this.projectId = projectId;
  }
