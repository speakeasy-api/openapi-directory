...
public class ListDistributionsByResponseHeadersPolicyId20200531QueryParams {
    /**
    ...
    public ListDistributionsByResponseHeadersPolicyId20200531QueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListDistributionsByResponseHeadersPolicyId20200531QueryParams withMaxItems(String maxItems) {
