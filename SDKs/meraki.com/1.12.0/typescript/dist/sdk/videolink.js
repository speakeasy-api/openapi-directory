...
var VideoLink = /** @class */ (function () {
    function VideoLink(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    VideoLink.prototype.getDeviceCameraVideoLink = function (req, config) {
