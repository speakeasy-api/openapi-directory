...
class UpdateInventoryForAnItemApplicationJSONQuantity:
    ...
    r"""Inventory Count"""  
    unit: UpdateInventoryForAnItemApplicationJSONQuantityUnitEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('unit') }})
    r"""The unit of measurement. Example: 'EACH'"""  
...
class UpdateInventoryForAnItemApplicationJSON:
    ...
    quantity: UpdateInventoryForAnItemApplicationJSONQuantity = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('quantity') }})
    r"""Quantity that has been ordered by the customers but not yet shipped"""  
...
class UpdateInventoryForAnItemJSONRequest:
    ...
    request_body: UpdateInventoryForAnItemApplicationJSON = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""File fields"""  
    ...
    r"""The shipNode for which the inventory is to be updated."""  
...
class UpdateInventoryForAnItemJSON200ApplicationXMLQuantityUnitEnum(str, Enum):
    r"""The unit of measurement. Example: 'EACH'"""
    EACH = 'EACH'
...
class UpdateInventoryForAnItemJSON200ApplicationXMLQuantity:
    ...
    r"""Inventory Count"""  
    unit: UpdateInventoryForAnItemJSON200ApplicationXMLQuantityUnitEnum = dataclasses.field()
    r"""The unit of measurement. Example: 'EACH'"""  
...
class UpdateInventoryForAnItemJSON200ApplicationXML:
    ...
    quantity: UpdateInventoryForAnItemJSON200ApplicationXMLQuantity = dataclasses.field()
    r"""Quantity that has been ordered by the customers but not yet shipped"""  
    sku: str = dataclasses.field()
    r"""A seller-provided Product ID. Response will have decoded value."""  
    
class UpdateInventoryForAnItemJSON200ApplicationJSONQuantityUnitEnum(str, Enum):
    r"""The unit of measurement. Example: 'EACH'"""
    EACH = 'EACH'
...
class UpdateInventoryForAnItemJSON200ApplicationJSONQuantity:
    ...
    amount: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('amount') }})
    r"""Inventory Count"""  
    unit: UpdateInventoryForAnItemJSON200ApplicationJSONQuantityUnitEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('unit') }})
    r"""The unit of measurement. Example: 'EACH'"""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateInventoryForAnItemJSON200ApplicationJSON:
    r"""Successful Operation"""
    
    quantity: UpdateInventoryForAnItemJSON200ApplicationJSONQuantity = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('quantity') }})
    r"""Quantity that has been ordered by the customers but not yet shipped"""  
    sku: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sku') }})
    r"""A seller-provided Product ID. Response will have decoded value."""  
...
class UpdateInventoryForAnItemJSONResponse:
    ...
    update_inventory_for_an_item_json_200_application_json_object: Optional[UpdateInventoryForAnItemJSON200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful Operation"""  
