...
class ProductItemAPIModel:
    ...
    r"""Product item id"""  
    minimum_quantity: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MinimumQuantity'), 'exclude': lambda f: f is None }})
    r"""Minimum required quantity in order to buy a work item"""  
