...
public class CreateOrganizationNetworkRequestBody {
    ...
    public CreateOrganizationNetworkRequestBody(@JsonProperty("name") String name, @JsonProperty("productTypes") CreateOrganizationNetworkRequestBodyProductTypesEnum[] productTypes) {
        this.name = name;
        this.productTypes = productTypes;
  }
}
