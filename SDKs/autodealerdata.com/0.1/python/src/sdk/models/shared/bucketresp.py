...
from ..shared import bucketentry as shared_bucketentry


@dataclass_json
@dataclasses.dataclass
class BucketResp:
    data: list[shared_bucketentry.BucketEntry] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
