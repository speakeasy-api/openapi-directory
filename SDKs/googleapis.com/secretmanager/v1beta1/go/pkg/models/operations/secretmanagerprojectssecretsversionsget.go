...
type SecretmanagerProjectsSecretsVersionsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type SecretmanagerProjectsSecretsVersionsGetPathParams struct {
...
type SecretmanagerProjectsSecretsVersionsGetQueryParams struct {
	// V1 error format.
...
type SecretmanagerProjectsSecretsVersionsGetRequest struct {
...
type SecretmanagerProjectsSecretsVersionsGetResponse struct {
	ContentType string
	// Successful response
