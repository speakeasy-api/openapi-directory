...
export const ListUserServerList = ["https://chat.twilio.com"] as const;
...
export class ListUserListUserResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListUserListUserResponseMeta)
  meta?: ListUserListUserResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.ChatV1ServiceUser })
  @Expose({ name: "users" })
  @Type(() => shared.ChatV1ServiceUser)
