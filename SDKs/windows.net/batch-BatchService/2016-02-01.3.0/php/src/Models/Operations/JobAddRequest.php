...
class JobAddRequest
{
     ...
     * The job to be added.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\JobAddParameter $jobAddParameter
     */
	#[SpeakeasyMetadata('request:mediaType=application/json')]
    public \OpenAPI\OpenAPI\Models\Shared\JobAddParameter $jobAddParameter;
	...
	{
		$this->jobAddParameter = new \OpenAPI\OpenAPI\Models\Shared\JobAddParameter();
		$this->apiVersion = "";
