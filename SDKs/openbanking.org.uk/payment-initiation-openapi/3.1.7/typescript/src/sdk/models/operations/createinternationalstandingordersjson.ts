...
export class CreateInternationalStandingOrdersJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateInternationalStandingOrdersJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateInternationalStandingOrdersJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
