 ...
 */
export enum BackendServiceListWarningCodeEnum {
...
export class BackendServiceListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class BackendServiceListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: BackendServiceListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: BackendServiceListWarningData })
  @Expose({ name: "data" })
  @Type(() => BackendServiceListWarningData)
  data?: BackendServiceListWarningData[];
 ...
 */
export class BackendServiceList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: BackendService })
  @Expose({ name: "items" })
  @Type(() => BackendService)
