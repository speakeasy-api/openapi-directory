...
public class ReactionsCreateForPullRequestReviewComment415ApplicationJSON {
    ...
    public ReactionsCreateForPullRequestReviewComment415ApplicationJSON(@JsonProperty("documentation_url") String documentationUrl, @JsonProperty("message") String message) {
        this.documentationUrl = documentationUrl;
        this.message = message;
  }
}
