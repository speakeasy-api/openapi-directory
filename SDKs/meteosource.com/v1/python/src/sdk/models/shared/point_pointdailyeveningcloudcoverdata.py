...
class PointPointDailyEveningCloudCoverData:
    ...
    r"""Percentage of sky covered by high clouds. (evening avg)
    Unit: \%
    """  
    ...
    r"""Percentage of sky covered by low clouds. (evening avg)
    Unit: \%
    """  
    ...
    r"""Percentage of sky covered by middle clouds. (evening avg)
    Unit: \%
    """  
    ...
    r"""Percentage of sky covered by clouds. (evening avg)
    Unit: \%
    """  
