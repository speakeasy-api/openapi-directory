...
class DatastoreProjectsIndexesDeleteSecurity:
    ...
    option1: Optional[DatastoreProjectsIndexesDeleteSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[DatastoreProjectsIndexesDeleteSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class DatastoreProjectsIndexesDeleteRequest:
    ...
    r"""The resource ID of the index to delete."""  
