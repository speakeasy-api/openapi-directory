...
func (e GETCopyClusterSnapshotActionEnum) ToPointer() *GETCopyClusterSnapshotActionEnum {
	return &e
}
...
func (e *GETCopyClusterSnapshotActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "CopyClusterSnapshot":
		*e = GETCopyClusterSnapshotActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETCopyClusterSnapshotActionEnum: %v", v)
	}
}
...
func (e GETCopyClusterSnapshotVersionEnum) ToPointer() *GETCopyClusterSnapshotVersionEnum {
	return &e
}
...
func (e *GETCopyClusterSnapshotVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2012-12-01":
		*e = GETCopyClusterSnapshotVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETCopyClusterSnapshotVersionEnum: %v", v)
	}
}
