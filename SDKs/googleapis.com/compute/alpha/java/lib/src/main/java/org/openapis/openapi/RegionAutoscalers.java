...
public class RegionAutoscalers {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeRegionAutoscalersTestIamPermissionsResponse computeRegionAutoscalersTestIamPermissions(org.openapis.openapi.models.operations.ComputeRegionAutoscalersTestIamPermissionsRequest request, org.openapis.openapi.models.operations.ComputeRegionAutoscalersTestIamPermissionsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeRegionAutoscalersTestIamPermissionsRequest.class, baseUrl, "/projects/{project}/regions/{region}/autoscalers/{resource}/testIamPermissions", request, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeRegionAutoscalersTestIamPermissionsRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.ComputeRegionAutoscalersTestIamPermissionsResponse res = new org.openapis.openapi.models.operations.ComputeRegionAutoscalersTestIamPermissionsResponse(contentType, httpRes.statusCode()) {{
