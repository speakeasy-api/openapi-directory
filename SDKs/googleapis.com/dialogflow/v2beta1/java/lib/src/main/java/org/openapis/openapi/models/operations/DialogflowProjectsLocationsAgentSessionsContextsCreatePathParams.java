...
public class DialogflowProjectsLocationsAgentSessionsContextsCreatePathParams {
    /**
    ...
    public DialogflowProjectsLocationsAgentSessionsContextsCreatePathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
