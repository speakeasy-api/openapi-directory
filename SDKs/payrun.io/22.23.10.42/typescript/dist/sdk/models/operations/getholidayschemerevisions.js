...
exports.GetHolidaySchemeRevisionsResponse = exports.GetHolidaySchemeRevisionsRequest = void 0;
...
var GetHolidaySchemeRevisionsRequest = /** @class */ (function (_super) {
    ...
    ], GetHolidaySchemeRevisionsRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeRevisionsRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeRevisionsRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=HolidaySchemeId",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeRevisionsRequest.prototype, "holidaySchemeId", void 0);
...
var GetHolidaySchemeRevisionsResponse = /** @class */ (function (_super) {
    ...
    ], GetHolidaySchemeRevisionsResponse.prototype, "rawResponse", void 0);
