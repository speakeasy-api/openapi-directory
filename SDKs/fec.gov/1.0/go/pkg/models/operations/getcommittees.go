...
func (e *GetCommitteesCommitteeTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Y":
		fallthrough
	case "Z":
		*e = GetCommitteesCommitteeTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCommitteesCommitteeTypeEnum: %s", s)
	}
}
...
func (e *GetCommitteesDesignationEnum) UnmarshalJSON(data []byte) error {
	...
	case "B":
		fallthrough
	case "D":
		*e = GetCommitteesDesignationEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCommitteesDesignationEnum: %s", s)
	}
}
...
func (e *GetCommitteesFilingFrequencyEnum) UnmarshalJSON(data []byte) error {
	...
	case "-A":
		fallthrough
	case "-T":
		*e = GetCommitteesFilingFrequencyEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCommitteesFilingFrequencyEnum: %s", s)
	}
}
...
func (e *GetCommitteesOrganizationTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "V":
		fallthrough
	case "W":
		*e = GetCommitteesOrganizationTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCommitteesOrganizationTypeEnum: %s", s)
	}
}
