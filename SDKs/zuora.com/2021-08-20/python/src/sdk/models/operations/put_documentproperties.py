...
class PUTDocumentPropertiesRequest:
    ...
    r"""The unique ID of document properties to be updated. For example, 402892c74c9193cd014c96bbe7c101f9."""  
    put_document_properties_type: shared_putdocumentpropertiestype.PUTDocumentPropertiesType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
