...
const (
	...
	DocumentDetailDocumentTypeEnumCompanyRegistrationScreening DocumentDetailDocumentTypeEnum = "COMPANY_REGISTRATION_SCREENING"
	DocumentDetailDocumentTypeEnumConstitutionalDocument       DocumentDetailDocumentTypeEnum = "CONSTITUTIONAL_DOCUMENT"
	...
	DocumentDetailDocumentTypeEnumSupportingDocuments          DocumentDetailDocumentTypeEnum = "SUPPORTING_DOCUMENTS"
)
...
func (e *DocumentDetailDocumentTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "BSN":
		fallthrough
	case "COMPANY_REGISTRATION_SCREENING":
		fallthrough
	case "CONSTITUTIONAL_DOCUMENT":
		fallthrough
