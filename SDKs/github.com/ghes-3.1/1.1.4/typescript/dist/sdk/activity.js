...
var Activity = /** @class */ (function () {
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#check-if-a-repository-is-starred-by-the-authenticated-user - API method documentation
    **/
    Activity.prototype.activityCheckRepoIsStarredByAuthenticatedUser = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/user/starred/{owner}/{repo}", req.pathParams);
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#delete-a-repository-subscription - API method documentation
    **/
    Activity.prototype.activityDeleteRepoSubscription = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/repos/{owner}/{repo}/subscription", req.pathParams);
        var client = this._defaultClient;
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#delete-a-thread-subscription - API method documentation
    **/
    Activity.prototype.activityDeleteThreadSubscription = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/notifications/threads/{thread_id}/subscription", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "delete" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#get-feeds - API method documentation
    **/
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.feed = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#get-a-repository-subscription - API method documentation
    **/
    Activity.prototype.activityGetRepoSubscription = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.repositorySubscription = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 403:
                    if (utils.matchContentType(contentType, "application/json")) {
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#get-a-thread - API method documentation
    **/
    Activity.prototype.activityGetThread = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/notifications/threads/{thread_id}", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.thread = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 304:
                    break;
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#get-a-thread-subscription-for-the-authenticated-user - API method documentation
    **/
    Activity.prototype.activityGetThreadSubscriptionForAuthenticatedUser = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.threadSubscription = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 304:
                    break;
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-events-for-the-authenticated-user - API method documentation
    **/
    Activity.prototype.activityListEventsForAuthenticatedUser = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{username}/events", req.pathParams);
        var client = this._defaultClient;
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-notifications-for-the-authenticated-user - API method documentation
    **/
    Activity.prototype.activityListNotificationsForAuthenticatedUser = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.threads = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 304:
                    break;
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-organization-events-for-the-authenticated-user - API method documentation
    **/
    Activity.prototype.activityListOrgEventsForAuthenticatedUser = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{username}/events/orgs/{org}", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-public-events - API method documentation
    **/
    Activity.prototype.activityListPublicEvents = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 503:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.activityListPublicEvents503ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-public-events-for-a-network-of-repositories - API method documentation
    **/
    Activity.prototype.activityListPublicEventsForRepoNetwork = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ActivityListPublicEventsForRepoNetworkRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/networks/{owner}/{repo}/events", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-public-events-for-a-user - API method documentation
    **/
    Activity.prototype.activityListPublicEventsForUser = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ActivityListPublicEventsForUserRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{username}/events/public", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-public-organization-events - API method documentation
    **/
    Activity.prototype.activityListPublicOrgEvents = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ActivityListPublicOrgEventsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/orgs/{org}/events", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-events-received-by-the-authenticated-user - API method documentation
    **/
    Activity.prototype.activityListReceivedEventsForUser = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ActivityListReceivedEventsForUserRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{username}/received_events", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-public-events-received-by-a-user - API method documentation
    **/
    Activity.prototype.activityListReceivedPublicEventsForUser = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ActivityListReceivedPublicEventsForUserRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{username}/received_events/public", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-repository-events - API method documentation
    **/
    Activity.prototype.activityListRepoEvents = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/repos/{owner}/{repo}/events", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-repository-notifications-for-the-authenticated-user - API method documentation
    **/
    Activity.prototype.activityListRepoNotificationsForAuthenticatedUser = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/repos/{owner}/{repo}/notifications", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-repositories-starred-by-the-authenticated-user - API method documentation
    **/
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    ...
                    if (utils.matchContentType(contentType, "application/vnd.github.v3.star+json")) {
                        res.starredRepositories = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 304:
                    break;
     ...
     * You can also find out _when_ stars were created by passing the following custom [media type](https://docs.github.com/enterprise-server@3.1/rest/overview/media-types/) via the `Accept` header:
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-repositories-starred-by-a-user - API method documentation
    **/
    Activity.prototype.activityListReposStarredByUser = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{username}/starred", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.activityListReposStarredByUser200ApplicationJSONAnyOf = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-repositories-watched-by-a-user - API method documentation
    **/
    Activity.prototype.activityListReposWatchedByUser = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{username}/subscriptions", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     * You can also find out _when_ stars were created by passing the following custom [media type](https://docs.github.com/enterprise-server@3.1/rest/overview/media-types/) via the `Accept` header:
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-stargazers - API method documentation
    **/
    Activity.prototype.activityListStargazersForRepo = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/repos/{owner}/{repo}/stargazers", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.activityListStargazersForRepo200ApplicationJSONAnyOf = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 422:
                    if (utils.matchContentType(contentType, "application/json")) {
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-repositories-watched-by-the-authenticated-user - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#list-watchers - API method documentation
    **/
    Activity.prototype.activityListWatchersForRepo = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/repos/{owner}/{repo}/subscribers", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#mark-notifications-as-read - API method documentation
    **/
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 202:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.activityMarkNotificationsAsRead202ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#mark-repository-notifications-as-read - API method documentation
    **/
    Activity.prototype.activityMarkRepoNotificationsAsRead = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 202:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.activityMarkRepoNotificationsAsRead202ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 205:
                    break;
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#mark-a-thread-as-read - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#set-a-repository-subscription - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#set-a-thread-subscription - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#star-a-repository-for-the-authenticated-user - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/activity#unstar-a-repository-for-the-authenticated-user - API method documentation
    **/
