...
class InitiateVaultLockRequestBodyPolicy:
    r"""InitiateVaultLockRequestBodyPolicy
...
class InitiateVaultLockRequestBody:
    policy: Optional[InitiateVaultLockRequestBodyPolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('policy') }})
    

@dataclasses.dataclass
class InitiateVaultLockRequest:
    headers: InitiateVaultLockHeaders = dataclasses.field()
    path_params: InitiateVaultLockPathParams = dataclasses.field()
    request: InitiateVaultLockRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class InitiateVaultLockResponse:
    ...
    initiate_vault_lock_output: Optional[dict[str, Any]] = dataclasses.field(default=None)
