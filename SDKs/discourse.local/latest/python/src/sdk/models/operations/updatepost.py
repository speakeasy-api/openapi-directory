...
class UpdatePostRequestBody:
    ...
    post: Optional[UpdatePostRequestBodyPost] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('post'), 'exclude': lambda f: f is None }})  
...
class UpdatePostRequest:
    ...
    request_body: Optional[UpdatePostRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdatePost200ApplicationJSONPost:
    ...
    actions_summary: Optional[list[UpdatePost200ApplicationJSONPostActionsSummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('actions_summary'), 'exclude': lambda f: f is None }})  
...
class UpdatePost200ApplicationJSON:
    ...
    post: Optional[UpdatePost200ApplicationJSONPost] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('post'), 'exclude': lambda f: f is None }})  
