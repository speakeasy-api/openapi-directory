...
public class InitiatePaymentMultipartHeaders {
    /**
    ...
    public InitiatePaymentMultipartHeaders withConsentID(String consentID) {
    ...
    public InitiatePaymentMultipartHeaders withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public InitiatePaymentMultipartHeaders withPSUAccept(String psuAccept) {
    ...
    public InitiatePaymentMultipartHeaders withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public InitiatePaymentMultipartHeaders withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public InitiatePaymentMultipartHeaders withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public InitiatePaymentMultipartHeaders withPSUCorporateID(String psuCorporateID) {
    ...
    public InitiatePaymentMultipartHeaders withPSUCorporateIDType(String psuCorporateIDType) {
    ...
    public InitiatePaymentMultipartHeaders withPSUDeviceID(String psuDeviceID) {
    ...
    public InitiatePaymentMultipartHeaders withPSUGeoLocation(String psuGeoLocation) {
    ...
    public InitiatePaymentMultipartHeaders withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public String psuId;
    public InitiatePaymentMultipartHeaders withPsuId(String psuId) {
        this.psuId = psuId;
        return this;
    }
    ...
    public InitiatePaymentMultipartHeaders withPSUIDType(String psuIDType) {
    ...
    public InitiatePaymentMultipartHeaders withPSUIPAddress(String psuIPAddress) {
    ...
    public InitiatePaymentMultipartHeaders withPSUIPPort(String psuIPPort) {
    ...
    public InitiatePaymentMultipartHeaders withPSUUserAgent(String psuUserAgent) {
    ...
    public InitiatePaymentMultipartHeaders withSignature(String signature) {
    ...
    public InitiatePaymentMultipartHeaders withTPPBrandLoggingInformation(String tppBrandLoggingInformation) {
    ...
    public InitiatePaymentMultipartHeaders withTPPExplicitAuthorisationPreferred(Boolean tppExplicitAuthorisationPreferred) {
    ...
    public InitiatePaymentMultipartHeaders withTPPNokRedirectURI(String tppNokRedirectURI) {
    ...
    public InitiatePaymentMultipartHeaders withTPPNotificationContentPreferred(String tppNotificationContentPreferred) {
    ...
    public InitiatePaymentMultipartHeaders withTPPNotificationURI(String tppNotificationURI) {
    ...
    public InitiatePaymentMultipartHeaders withTPPRedirectPreferred(Boolean tppRedirectPreferred) {
    ...
    public InitiatePaymentMultipartHeaders withTPPRedirectURI(String tppRedirectURI) {
    ...
    public InitiatePaymentMultipartHeaders withTPPRejectionNoFundsPreferred(Boolean tppRejectionNoFundsPreferred) {
    ...
    public InitiatePaymentMultipartHeaders withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public InitiatePaymentMultipartHeaders withXRequestID(String xRequestID) {
