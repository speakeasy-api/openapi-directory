...
public class PostRepositoriesWorkspaceRepoSlugIssuesIssueIdChangesResponse {
    ...
    public PostRepositoriesWorkspaceRepoSlugIssuesIssueIdChangesResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
