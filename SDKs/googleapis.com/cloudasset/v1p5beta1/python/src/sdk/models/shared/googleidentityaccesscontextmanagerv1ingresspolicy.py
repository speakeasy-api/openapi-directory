...
class GoogleIdentityAccesscontextmanagerV1IngressPolicy:
    ...
    ingress_from: Optional[shared_googleidentityaccesscontextmanagerv1ingressfrom.GoogleIdentityAccesscontextmanagerV1IngressFrom] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ingressFrom'), 'exclude': lambda f: f is None }})
    ...
    ingress_to: Optional[shared_googleidentityaccesscontextmanagerv1ingressto.GoogleIdentityAccesscontextmanagerV1IngressTo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ingressTo'), 'exclude': lambda f: f is None }})
