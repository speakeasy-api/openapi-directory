...
func main() {
    ...
    res, err := s.SDK.GetClip(ctx, operations.GetClipRequest{
        RequestBody: operations.GetClipRequestBody{
            ClipFragmentSelector: operations.GetClipRequestBodyClipFragmentSelector{
                ...
                TimestampRange: &shared.ClipTimestampRange{
                    EndTimestamp: types.MustTimeFromString("2022-01-14T06:18:51.036Z"),
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.GetDASHStreamingSessionURL(ctx, operations.GetDASHStreamingSessionURLRequest{
        RequestBody: operations.GetDASHStreamingSessionURLRequestBody{
            DASHFragmentSelector: &operations.GetDASHStreamingSessionURLRequestBodyDASHFragmentSelector{
                FragmentSelectorType: shared.DASHFragmentSelectorTypeEnumProducerTimestamp.ToPointer(),
                TimestampRange: &shared.DASHTimestampRange{
                    EndTimestamp: types.MustTimeFromString("2022-11-30T04:44:49.578Z"),
                    StartTimestamp: types.MustTimeFromString("2022-12-17T05:46:24.151Z"),
                },
            },
            DisplayFragmentNumber: operations.GetDASHStreamingSessionURLRequestBodyDisplayFragmentNumberEnumAlways.ToPointer(),
            DisplayFragmentTimestamp: operations.GetDASHStreamingSessionURLRequestBodyDisplayFragmentTimestampEnumNever.ToPointer(),
            Expires: sdk.Int64(957156),
            MaxManifestFragmentResults: sdk.Int64(778157),
            PlaybackMode: operations.GetDASHStreamingSessionURLRequestBodyPlaybackModeEnumLive.ToPointer(),
            StreamARN: sdk.String("at"),
            StreamName: sdk.String("at"),
        },
    ...
    if res.GetDASHStreamingSessionURLOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.GetHLSStreamingSessionURL(ctx, operations.GetHLSStreamingSessionURLRequest{
        RequestBody: operations.GetHLSStreamingSessionURLRequestBody{
            ContainerFormat: operations.GetHLSStreamingSessionURLRequestBodyContainerFormatEnumMpegTs.ToPointer(),
            DiscontinuityMode: operations.GetHLSStreamingSessionURLRequestBodyDiscontinuityModeEnumAlways.ToPointer(),
            DisplayFragmentTimestamp: operations.GetHLSStreamingSessionURLRequestBodyDisplayFragmentTimestampEnumNever.ToPointer(),
            Expires: sdk.Int64(639921),
            HLSFragmentSelector: &operations.GetHLSStreamingSessionURLRequestBodyHLSFragmentSelector{
                FragmentSelectorType: shared.HLSFragmentSelectorTypeEnumServerTimestamp.ToPointer(),
                TimestampRange: &shared.HLSTimestampRange{
                    EndTimestamp: types.MustTimeFromString("2022-06-18T20:36:37.412Z"),
                    StartTimestamp: types.MustTimeFromString("2020-09-22T07:34:53.140Z"),
                },
            },
            MaxMediaPlaylistFragmentResults: sdk.Int64(521848),
            PlaybackMode: operations.GetHLSStreamingSessionURLRequestBodyPlaybackModeEnumLive.ToPointer(),
            StreamARN: sdk.String("commodi"),
            StreamName: sdk.String("molestiae"),
        },
    ...
    if res.GetHLSStreamingSessionURLOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.SDK.GetImages(ctx, operations.GetImagesRequest{
        ...
        RequestBody: operations.GetImagesRequestBody{
            EndTimestamp: types.MustTimeFromString("2022-05-20T13:30:46.463Z"),
            Format: operations.GetImagesRequestBodyFormatEnumJpeg,
            FormatConfig: map[string]string{
                "dolor": "natus",
                "laboriosam": "hic",
                "saepe": "fuga",
            },
            HeightPixels: sdk.Int64(449950),
            ImageSelectorType: operations.GetImagesRequestBodyImageSelectorTypeEnumProducerTimestamp,
            MaxResults: sdk.Int64(613064),
            NextToken: sdk.String("iure"),
            SamplingInterval: 902349,
            StartTimestamp: types.MustTimeFromString("2022-10-20T12:36:28.767Z"),
            StreamARN: sdk.String("ipsa"),
            StreamName: sdk.String("reiciendis"),
            WidthPixels: sdk.Int64(666767),
        },
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.GetMediaForFragmentList(ctx, operations.GetMediaForFragmentListRequest{
        RequestBody: operations.GetMediaForFragmentListRequestBody{
            Fragments: []string{
                "omnis",
                "nemo",
            },
            StreamARN: sdk.String("minima"),
            StreamName: sdk.String("excepturi"),
        },
    ...
    if res.GetMediaForFragmentListOutput != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.ListFragments(ctx, operations.ListFragmentsRequest{
        MaxResults: sdk.String("dolorem"),
        NextToken: sdk.String("culpa"),
        RequestBody: operations.ListFragmentsRequestBody{
            FragmentSelector: &operations.ListFragmentsRequestBodyFragmentSelector{
                FragmentSelectorType: shared.FragmentSelectorTypeEnumProducerTimestamp.ToPointer(),
                TimestampRange: &shared.TimestampRange{
                    EndTimestamp: types.MustTimeFromString("2021-01-15T20:18:47.519Z"),
                    StartTimestamp: types.MustTimeFromString("2022-06-30T02:19:51.375Z"),
                },
            },
    ...
    if res.ListFragmentsOutput != nil {
        // handle response
    }
}
```
