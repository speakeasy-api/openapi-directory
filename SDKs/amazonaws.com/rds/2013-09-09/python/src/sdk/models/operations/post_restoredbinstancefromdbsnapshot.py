...
class PostRestoreDbInstanceFromDbSnapshotQueryParams:
    action: PostRestoreDbInstanceFromDbSnapshotActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostRestoreDbInstanceFromDbSnapshotVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostRestoreDbInstanceFromDbSnapshotRequest:
    headers: PostRestoreDbInstanceFromDbSnapshotHeaders = dataclasses.field()
    query_params: PostRestoreDbInstanceFromDbSnapshotQueryParams = dataclasses.field()
