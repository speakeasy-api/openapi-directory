...
export class Metrics {
   ...
   */
  documentSimilarity(
    req: operations.DocumentSimilarityRequestBody,
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/1.0/DocumentSimilarity.json";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DocumentSimilarityResponse =
        new operations.DocumentSimilarityResponse({
