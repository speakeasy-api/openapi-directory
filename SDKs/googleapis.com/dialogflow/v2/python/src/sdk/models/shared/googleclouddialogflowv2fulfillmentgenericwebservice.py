...
class GoogleCloudDialogflowV2FulfillmentGenericWebService:
    ...
    r"""Optional. The password for HTTP Basic authentication."""  
    ...
    r"""Optional. The HTTP request headers to send together with fulfillment requests."""  
    ...
    r"""Optional. The user name for HTTP Basic authentication."""  
