...
class DialogflowProjectsLocationsConversationModelsUndeploySecurity:
    ...
    option1: Optional[DialogflowProjectsLocationsConversationModelsUndeploySecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[DialogflowProjectsLocationsConversationModelsUndeploySecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class DialogflowProjectsLocationsConversationModelsUndeployRequest:
    ...
    r"""Required. The conversation model to undeploy. Format: `projects//conversationModels/`"""  
