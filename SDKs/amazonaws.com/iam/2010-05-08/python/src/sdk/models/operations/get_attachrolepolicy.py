...
class GetAttachRolePolicyQueryParams:
    action: GetAttachRolePolicyActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetAttachRolePolicyVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAttachRolePolicyRequest:
    headers: GetAttachRolePolicyHeaders = dataclasses.field()
    query_params: GetAttachRolePolicyQueryParams = dataclasses.field()
