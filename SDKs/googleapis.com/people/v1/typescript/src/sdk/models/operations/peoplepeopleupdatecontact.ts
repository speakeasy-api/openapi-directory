...
export class PeoplePeopleUpdateContactSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export enum PeoplePeopleUpdateContactSourcesEnum {
...
export class PeoplePeopleUpdateContactRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=updatePersonFields",
  })
...
export class PeoplePeopleUpdateContactResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
