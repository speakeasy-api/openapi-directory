...
class CreateEgressOnlyInternetGatewayRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateEgressOnlyInternetGatewayRequestTagSpecifications:
    ...
    resource_type: Optional[CreateEgressOnlyInternetGatewayRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateEgressOnlyInternetGatewayRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateEgressOnlyInternetGatewayRequest:
    ...
    tag_specifications: Optional[list[CreateEgressOnlyInternetGatewayRequestTagSpecifications]] = dataclasses.field(default=None)  
