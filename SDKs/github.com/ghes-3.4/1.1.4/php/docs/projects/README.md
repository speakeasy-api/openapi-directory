...
try {
    ...
    $request->projectId = 282837;
    $request->username = 'Matteo60';
...
try {
    ...
    $request->requestBody->name = 'Carrie Douglas';
...
try {
    ...
    $request->requestBody->name = 'Lewis Denesik';
...
try {
    ...
    $request->projectId = 266408;
    $request->username = 'Flo_Gusikowski73';
...
try {
    ...
    $request->columnId = 727547;
    $request->page = 189753;
    $request->perPage = 289913;
...
try {
    ...
    $request->projectId = 621169;
    $request->username = 'Arvel_Kuphal';
