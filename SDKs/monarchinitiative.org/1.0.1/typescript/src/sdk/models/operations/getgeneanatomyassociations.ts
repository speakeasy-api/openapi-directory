...
export class GetGeneAnatomyAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGeneAnatomyAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGeneAnatomyAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGeneAnatomyAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
