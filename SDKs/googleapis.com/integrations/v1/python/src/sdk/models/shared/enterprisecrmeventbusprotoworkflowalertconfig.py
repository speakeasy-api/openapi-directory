...
class EnterpriseCrmEventbusProtoWorkflowAlertConfig:
    ...
    r"""For an EXPECTED_MIN threshold, this aggregation_period must be lesser than 24 hours."""  
    ...
    r"""A name to identify this alert. This will be displayed in the alert subject. If set, this name should be unique within the scope of the workflow."""  
    client_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('clientId'), 'exclude': lambda f: f is None }})
    r"""Client associated with this alert configuration."""  
    ...
    metric_type: Optional[EnterpriseCrmEventbusProtoWorkflowAlertConfigMetricTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metricType'), 'exclude': lambda f: f is None }})  
    ...
    threshold_type: Optional[EnterpriseCrmEventbusProtoWorkflowAlertConfigThresholdTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('thresholdType'), 'exclude': lambda f: f is None }})
    r"""The threshold type, whether lower(expected_min) or upper(expected_max), for which this alert is being configured. If value falls below expected_min or exceeds expected_max, an alert will be fired."""  
