...
from ..shared import licenseaudioresult as shared_licenseaudioresult
...
class LicenseAudioResultDataList:
    r"""List of audio license results"""
    
    data: Optional[list[shared_licenseaudioresult.LicenseAudioResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""License results"""  
