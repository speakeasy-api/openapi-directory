...
public class GetNhBugsRequest {
    ...
    public GetNhBugsRequest withAcceptVersion(String acceptVersion) {
    ...
    public GetNhBugsRequest withXApiKey(String xApiKey) {
    ...
    public GetNhBugsRequest withExcludedetails(String excludedetails) {
    ...
    public GetNhBugsRequest withMonth(String month) {
        this.month = month;
        return this;
    }
    ...
    public GetNhBugsRequest withThumbsize(Long thumbsize) {
        this.thumbsize = thumbsize;
        return this;
    }
    
    public GetNhBugsRequest(@JsonProperty("Accept-Version") String acceptVersion, @JsonProperty("X-API-KEY") String xApiKey) {
        this.acceptVersion = acceptVersion;
        this.xApiKey = xApiKey;
  }
}
