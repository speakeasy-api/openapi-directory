...
exports.PostAuthResponse = exports.PostAuthRequest = exports.PostAuthQueryParams = void 0;
...
var PostAuthQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=client_secret" }),
        __metadata("design:type", String)
    ], PostAuthQueryParams.prototype, "clientSecret", void 0);
    return PostAuthQueryParams;
}(utils_1.SpeakeasyBase));
exports.PostAuthQueryParams = PostAuthQueryParams;
...
exports.PostAuthResponse = PostAuthResponse;
