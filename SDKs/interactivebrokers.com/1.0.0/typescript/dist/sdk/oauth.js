...
var OAuth = /** @class */ (function () {
    ...
    OAuth.prototype.postOauthAccessToken = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostOauthAccessTokenResponse({
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.postOauthAccessToken200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.PostOauthAccessToken200ApplicationJSON);
                    }
                    break;
    ...
    OAuth.prototype.postOauthLiveSessionToken = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostOauthLiveSessionTokenResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.postOauthLiveSessionToken200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.PostOauthLiveSessionToken200ApplicationJSON);
                    }
                    break;
                case [400, 401, 403, 408].includes(httpRes === null || httpRes === void 0 ? void 0 : httpRes.status):
                    break;
    ...
    OAuth.prototype.postOauthRequestToken = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostOauthRequestTokenResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.postOauthRequestToken200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.PostOauthRequestToken200ApplicationJSON);
                    }
                    break;
                case [400, 401, 403, 408].includes(httpRes === null || httpRes === void 0 ? void 0 : httpRes.status):
                    break;
