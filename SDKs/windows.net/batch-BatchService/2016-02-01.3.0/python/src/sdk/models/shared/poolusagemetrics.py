...
class PoolUsageMetrics:
    ...
    r"""The cross data center network egress in GiB from the pool during this interval."""  
    data_ingress_gi_b: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dataIngressGiB') }})
    r"""The cross data center network ingress in GiB to the pool during this interval."""  
    ...
    r"""The end time of the aggregation interval."""  
    pool_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('poolId') }})
    r"""The id of the pool whose metrics are being aggregated."""  
