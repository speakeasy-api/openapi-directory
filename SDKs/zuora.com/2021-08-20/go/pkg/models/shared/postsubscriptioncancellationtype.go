...
type POSTSubscriptionCancellationTypeRunBillingEnum string

const (
	POSTSubscriptionCancellationTypeRunBillingEnumTrue  POSTSubscriptionCancellationTypeRunBillingEnum = "true"
	POSTSubscriptionCancellationTypeRunBillingEnumFalse POSTSubscriptionCancellationTypeRunBillingEnum = "false"
)

func (e *POSTSubscriptionCancellationTypeRunBillingEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "true":
		fallthrough
	case "false":
		*e = POSTSubscriptionCancellationTypeRunBillingEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTSubscriptionCancellationTypeRunBillingEnum: %s", s)
	}
}
...
type POSTSubscriptionCancellationType struct {
	...
	// in the request header.
	//
	RunBilling *POSTSubscriptionCancellationTypeRunBillingEnum `json:"runBilling,omitempty"`
