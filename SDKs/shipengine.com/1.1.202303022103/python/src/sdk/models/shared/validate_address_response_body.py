...
class ValidateAddressResponseBodyPartialAddressAddressResidentialIndicatorEnum(str, Enum):
...
class ValidateAddressResponseBodyPartialAddress:
    ...
    address_residential_indicator: ValidateAddressResponseBodyPartialAddressAddressResidentialIndicatorEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address_residential_indicator') }})
...
class ValidateAddressResponseBody:
    ...
    matched_address: ValidateAddressResponseBodyPartialAddress = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('matched_address') }})
