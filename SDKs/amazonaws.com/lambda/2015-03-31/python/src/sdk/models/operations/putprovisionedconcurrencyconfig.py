...
class PutProvisionedConcurrencyConfigRequestBody:
    ...
    provisioned_concurrent_executions: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ProvisionedConcurrentExecutions') }})
    r"""The amount of provisioned concurrency to allocate for the version or alias."""  
...
class PutProvisionedConcurrencyConfigRequest:
    ...
    request_body: PutProvisionedConcurrencyConfigRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
