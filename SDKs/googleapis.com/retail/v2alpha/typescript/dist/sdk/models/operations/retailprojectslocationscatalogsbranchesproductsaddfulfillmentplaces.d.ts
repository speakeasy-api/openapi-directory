...
export declare class RetailProjectsLocationsCatalogsBranchesProductsAddFulfillmentPlacesSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class RetailProjectsLocationsCatalogsBranchesProductsAddFulfillmentPlacesRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class RetailProjectsLocationsCatalogsBranchesProductsAddFulfillmentPlacesResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
