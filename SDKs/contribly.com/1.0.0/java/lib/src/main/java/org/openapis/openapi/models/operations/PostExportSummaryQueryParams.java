...
public class PostExportSummaryQueryParams {
    /**
    ...
    public PostExportSummaryQueryParams withAssignment(String assignment) {
    ...
    public PostExportSummaryQueryParams withCountry(String country) {
    ...
    public PostExportSummaryQueryParams withCreatedAfter(OffsetDateTime createdAfter) {
    ...
    public PostExportSummaryQueryParams withCreatedBefore(OffsetDateTime createdBefore) {
    ...
    public PostExportSummaryQueryParams withGeohash(String geohash) {
    ...
    public PostExportSummaryQueryParams withHasLocation(Boolean hasLocation) {
    ...
    public PostExportSummaryQueryParams withLatLong(String latLong) {
    ...
    public PostExportSummaryQueryParams withMediaType(String mediaType) {
    ...
    public PostExportSummaryQueryParams withOwnedBy(String ownedBy) {
    ...
    public String q;
    public PostExportSummaryQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public PostExportSummaryQueryParams withRadius(Double radius) {
        this.radius = radius;
        return this;
    }
    ...
    public PostExportSummaryQueryParams withUrlWords(String urlWords) {
    ...
    public String user;
    public PostExportSummaryQueryParams withUser(String user) {
        this.user = user;
        return this;
    }
