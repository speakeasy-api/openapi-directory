 ...
 * 
 */
public class UpdateAccountLockSettingsApplicationJSON1RecordingIpAddressAccessControl {
    /**
    ...
    public UpdateAccountLockSettingsApplicationJSON1RecordingIpAddressAccessControl withEnable(Boolean enable) {
        this.enable = enable;
        return this;
    }
    ...
    public UpdateAccountLockSettingsApplicationJSON1RecordingIpAddressAccessControl withIpAddressesOrRanges(String ipAddressesOrRanges) {
