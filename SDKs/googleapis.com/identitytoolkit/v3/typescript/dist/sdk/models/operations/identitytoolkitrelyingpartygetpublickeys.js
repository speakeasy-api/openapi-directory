...
exports.IdentitytoolkitRelyingpartyGetPublicKeysResponse = exports.IdentitytoolkitRelyingpartyGetPublicKeysRequest = exports.IdentitytoolkitRelyingpartyGetPublicKeysSecurity = void 0;
...
exports.IdentitytoolkitRelyingpartyGetPublicKeysSecurity = IdentitytoolkitRelyingpartyGetPublicKeysSecurity;
var IdentitytoolkitRelyingpartyGetPublicKeysRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyGetPublicKeysRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyGetPublicKeysRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyGetPublicKeysRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyGetPublicKeysRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], IdentitytoolkitRelyingpartyGetPublicKeysRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyGetPublicKeysRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyGetPublicKeysRequest.prototype, "userIp", void 0);
    return IdentitytoolkitRelyingpartyGetPublicKeysRequest;
}(utils_1.SpeakeasyBase));
exports.IdentitytoolkitRelyingpartyGetPublicKeysRequest = IdentitytoolkitRelyingpartyGetPublicKeysRequest;
var IdentitytoolkitRelyingpartyGetPublicKeysResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], IdentitytoolkitRelyingpartyGetPublicKeysResponse.prototype, "rawResponse", void 0);
    return IdentitytoolkitRelyingpartyGetPublicKeysResponse;
}(utils_1.SpeakeasyBase));
exports.IdentitytoolkitRelyingpartyGetPublicKeysResponse = IdentitytoolkitRelyingpartyGetPublicKeysResponse;
