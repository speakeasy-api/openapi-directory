...
exports.AuditLogItemModel = void 0;
...
var AuditLogItemModel = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=actionTarget" }),
        __metadata("design:type", String)
    ], AuditLogItemModel.prototype, "actionTarget", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=auditLogDateTime" }),
        __metadata("design:type", Date)
    ], AuditLogItemModel.prototype, "auditLogDateTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=auditLogId" }),
        __metadata("design:type", Number)
    ], AuditLogItemModel.prototype, "auditLogId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=auditLogType" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=where" }),
        __metadata("design:type", String)
...
exports.AuditLogItemModel = AuditLogItemModel;
