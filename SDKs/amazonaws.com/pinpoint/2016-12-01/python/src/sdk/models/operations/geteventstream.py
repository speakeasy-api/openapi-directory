...
from ..shared import geteventstreamresponse as shared_geteventstreamresponse


@dataclasses.dataclass
class GetEventStreamPathParams:
...
class GetEventStreamRequest:
    headers: GetEventStreamHeaders = dataclasses.field()
    path_params: GetEventStreamPathParams = dataclasses.field()
...
class GetEventStreamResponse:
    ...
    get_event_stream_response: Optional[shared_geteventstreamresponse.GetEventStreamResponse] = dataclasses.field(default=None)
