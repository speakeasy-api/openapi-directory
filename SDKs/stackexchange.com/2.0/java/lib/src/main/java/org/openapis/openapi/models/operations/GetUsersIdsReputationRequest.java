...
public class GetUsersIdsReputationRequest {
    ...
    public GetUsersIdsReputationRequest withCallback(String callback) {
    ...
    public GetUsersIdsReputationRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdsReputationRequest withFromdate(Long fromdate) {
    ...
    public GetUsersIdsReputationRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetUsersIdsReputationRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdsReputationRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdsReputationRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetUsersIdsReputationRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetUsersIdsReputationRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
