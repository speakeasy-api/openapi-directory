...
from ..shared import kyccardcheckresult as shared_kyccardcheckresult
...
class KYCVerificationResult:
    ...
    cards: Optional[list[shared_kyccardcheckresult.KYCCardCheckResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cards'), 'exclude': lambda f: f is None }})
    r"""The results of the checks on the cards."""  
