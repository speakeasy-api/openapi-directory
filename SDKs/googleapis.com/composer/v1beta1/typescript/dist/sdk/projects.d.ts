...
export declare class Projects {
     ...
     */
    composerProjectsLocationsEnvironmentsCheckUpgrade(req: operations.ComposerProjectsLocationsEnvironmentsCheckUpgradeRequest, security: operations.ComposerProjectsLocationsEnvironmentsCheckUpgradeSecurity, config?: AxiosRequestConfig): Promise<operations.ComposerProjectsLocationsEnvironmentsCheckUpgradeResponse>;
    /**
     ...
     */
    composerProjectsLocationsEnvironmentsRestartWebServer(req: operations.ComposerProjectsLocationsEnvironmentsRestartWebServerRequest, security: operations.ComposerProjectsLocationsEnvironmentsRestartWebServerSecurity, config?: AxiosRequestConfig): Promise<operations.ComposerProjectsLocationsEnvironmentsRestartWebServerResponse>;
    /**
