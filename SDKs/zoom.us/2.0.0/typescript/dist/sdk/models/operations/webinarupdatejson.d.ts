...
export declare class WebinarUpdateJsonSecurity extends SpeakeasyBase {
    oAuth: string;
}
/**
 ...
 */
export declare enum WebinarUpdateApplicationJSONRecurrenceMonthlyWeekEnum {
    Minus1 = "-1",
    One = "1",
    Two = "2",
    Three = "3",
 ...
 */
export declare enum WebinarUpdateApplicationJSONRecurrenceMonthlyWeekDayEnum {
    One = "1",
    Two = "2",
    Three = "3",
    Four = "4",
 ...
 */
export declare enum WebinarUpdateApplicationJSONRecurrenceTypeEnum {
    One = "1",
    Two = "2",
    Three = "3"
}
 ...
 */
export declare enum WebinarUpdateApplicationJSONSettingsApprovalTypeEnum {
    Zero = "0",
    One = "1",
    Two = "2"
}
 ...
 */
export declare enum WebinarUpdateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum {
    Zero = "0",
    One = "1",
    Two = "2",
    Three = "3",
 ...
 */
export declare enum WebinarUpdateApplicationJSONSettingsFollowUpAbsenteesEmailNotificationTypeEnum {
    Zero = "0",
    One = "1",
    Two = "2",
    Three = "3",
 ...
 */
export declare enum WebinarUpdateApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum {
    Zero = "0",
    One = "1",
    Two = "2",
    Three = "3",
 ...
 */
export declare enum WebinarUpdateApplicationJSONSettingsRegistrationTypeEnum {
    One = "1",
    Two = "2",
    Three = "3"
}
 ...
 */
export declare enum WebinarUpdateApplicationJSONTypeEnum {
    Five = "5",
    Six = "6",
    Nine = "9"
}
...
export declare class WebinarUpdateJsonRequest extends SpeakeasyBase {
    /**
     * Webinar.
     */
...
export declare class WebinarUpdateJsonResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
