...
func (s *Operations) MetastoreOperationsCancel(ctx context.Context, request operations.MetastoreOperationsCancelRequest) (*operations.MetastoreOperationsCancelResponse, error) {
	...
	res := &operations.MetastoreOperationsCancelResponse{
