...
class StorageNotificationsGetSecurity:
    option1: Optional[StorageNotificationsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageNotificationsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[StorageNotificationsGetSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[StorageNotificationsGetSecurityOption4] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option5: Optional[StorageNotificationsGetSecurityOption5] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class StorageNotificationsGetRequest:
    path_params: StorageNotificationsGetPathParams = dataclasses.field()
    query_params: StorageNotificationsGetQueryParams = dataclasses.field()
    security: StorageNotificationsGetSecurity = dataclasses.field()
