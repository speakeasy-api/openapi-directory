...
func (e DisablePolicyTypeXAmzTargetEnum) ToPointer() *DisablePolicyTypeXAmzTargetEnum {
	return &e
}
...
func (e *DisablePolicyTypeXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSOrganizationsV20161128.DisablePolicyType":
		*e = DisablePolicyTypeXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DisablePolicyTypeXAmzTargetEnum: %v", v)
	}
}
