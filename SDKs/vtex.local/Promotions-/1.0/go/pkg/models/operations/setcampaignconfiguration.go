...
type SetcampaignconfigurationRequestBodyTargetConfigurationsAffiliates struct {
	// Affiliate ID.
...
type SetcampaignconfigurationRequestBodyTargetConfigurationsBrands struct {
	// Brand ID.
	ID *string `json:"id,omitempty"`
	// Brand Name.
	Name *string `json:"name,omitempty"`
...
type SetcampaignconfigurationRequestBodyTargetConfigurationsCategories struct {
	// Category ID.
	ID *string `json:"id,omitempty"`
	// Category Name.
	Name *string `json:"name,omitempty"`
...
type SetcampaignconfigurationRequestBodyTargetConfigurationsCollections struct {
	// Collection ID.
	ID *string `json:"id,omitempty"`
	// Collection Name.
	Name *string `json:"name,omitempty"`
...
type SetcampaignconfigurationRequestBodyTargetConfigurationsListCategory1BuyTogether struct {
	// Category ID.
	ID *string `json:"id,omitempty"`
	// Category name.
	Name *string `json:"name,omitempty"`
...
type SetcampaignconfigurationRequestBodyTargetConfigurationsPaymentsMethods struct {
	// Payment Method ID.
	ID *string `json:"id,omitempty"`
	// Payment Method Name.
	Name *string `json:"name,omitempty"`
...
type SetcampaignconfigurationRequestBodyTargetConfigurationsProducts struct {
	// Product ID.
	ID *string `json:"id,omitempty"`
	// Product Name.
	Name *string `json:"name,omitempty"`
...
type SetcampaignconfigurationRequestBodyTargetConfigurationsSkus struct {
	// SKU ID.
	ID *string `json:"id,omitempty"`
	// SKU Name.
	Name *string `json:"name,omitempty"`
...
type SetcampaignconfigurationRequestBodyTargetConfigurationsZipCodeRanges struct {
...
type SetcampaignconfigurationRequestBodyTargetConfigurations struct {
	// Marketplace order identifier. The discount will apply to selected affiliates.
	Affiliates []SetcampaignconfigurationRequestBodyTargetConfigurationsAffiliates `json:"affiliates,omitempty"`
	...
	Brands []SetcampaignconfigurationRequestBodyTargetConfigurationsBrands `json:"brands,omitempty"`
	...
	Categories []SetcampaignconfigurationRequestBodyTargetConfigurationsCategories `json:"categories,omitempty"`
	...
	Collections []SetcampaignconfigurationRequestBodyTargetConfigurationsCollections `json:"collections,omitempty"`
	...
	ListCategory1BuyTogether []SetcampaignconfigurationRequestBodyTargetConfigurationsListCategory1BuyTogether `json:"listCategory1BuyTogether,omitempty"`
	...
	PaymentsMethods []SetcampaignconfigurationRequestBodyTargetConfigurationsPaymentsMethods `json:"paymentsMethods,omitempty"`
	...
	Products []SetcampaignconfigurationRequestBodyTargetConfigurationsProducts `json:"products,omitempty"`
	...
	Skus []SetcampaignconfigurationRequestBodyTargetConfigurationsSkus `json:"skus,omitempty"`
	...
	ZipCodeRanges []SetcampaignconfigurationRequestBodyTargetConfigurationsZipCodeRanges `json:"zipCodeRanges,omitempty"`
}

type SetcampaignconfigurationRequestBody struct {
	...
	LastModified *SetcampaignconfigurationRequestBodyLastModified `json:"lastModified,omitempty"`
	// Campaign audience name.
	Name *string `json:"name,omitempty"`
	// Array that contains all target audience that the campaign audience will be valid.
	TargetConfigurations []SetcampaignconfigurationRequestBodyTargetConfigurations `json:"targetConfigurations,omitempty"`
}
...
type Setcampaignconfiguration200ApplicationJSONLastModified struct {
...
type Setcampaignconfiguration200ApplicationJSONTargetConfigurationsAffiliates struct {
	// Affiliate ID.
	ID *string `json:"id,omitempty"`
	// Affiliate Name.
	Name *string `json:"name,omitempty"`
...
type Setcampaignconfiguration200ApplicationJSONTargetConfigurationsBrands struct {
	// Brand ID.
	ID *string `json:"id,omitempty"`
	// Brand Name.
	Name *string `json:"name,omitempty"`
...
type Setcampaignconfiguration200ApplicationJSONTargetConfigurationsCategories struct {
	// Category ID.
	ID *string `json:"id,omitempty"`
	// Category Name.
	Name *string `json:"name,omitempty"`
...
type Setcampaignconfiguration200ApplicationJSONTargetConfigurationsCollections struct {
	// Collection ID.
	ID *string `json:"id,omitempty"`
	// Collection Name.
	Name *string `json:"name,omitempty"`
...
type Setcampaignconfiguration200ApplicationJSONTargetConfigurationsPaymentsMethods struct {
	// Payment Method ID.
	ID *string `json:"id,omitempty"`
	// Payment Method Name.
	Name *string `json:"name,omitempty"`
...
type Setcampaignconfiguration200ApplicationJSONTargetConfigurationsProducts struct {
	// Product ID.
	ID *string `json:"id,omitempty"`
	// Product Name.
	Name *string `json:"name,omitempty"`
...
type Setcampaignconfiguration200ApplicationJSONTargetConfigurationsSkus struct {
	// SKU ID.
	ID *string `json:"id,omitempty"`
	// SKU Name.
	Name *string `json:"name,omitempty"`
...
type Setcampaignconfiguration200ApplicationJSONTargetConfigurationsZipCodeRanges struct {
	// Defines if the zip code applies the campaign audience.
	Inclusive *bool `json:"inclusive,omitempty"`
}

// Setcampaignconfiguration200ApplicationJSONTargetConfigurations - Object with information about the target audience.
type Setcampaignconfiguration200ApplicationJSONTargetConfigurations struct {
	// Marketplace order identifier. The discount will apply to selected affiliates.
	Affiliates []Setcampaignconfiguration200ApplicationJSONTargetConfigurationsAffiliates `json:"affiliates,omitempty"`
	// Defines if the trade policy IDs are exclusive.
	AreSalesChannelIdsExclusive *bool `json:"areSalesChannelIdsExclusive,omitempty"`
	// Object composed by the brands that will activate or deactivate the campaign audience.
	Brands []Setcampaignconfiguration200ApplicationJSONTargetConfigurationsBrands `json:"brands,omitempty"`
	// If set to `true`, this campaign audience will be applied to any brand present on the `brands` field. If set to `false`, brands present on that field will make this campaign audience not to be applied.
	BrandsAreInclusive *bool `json:"brandsAreInclusive,omitempty"`
	// Campaign Audiences that activate this promotion.
	Campaigns   []interface{} `json:"campaigns,omitempty"`
	CardIssuers []interface{} `json:"cardIssuers,omitempty"`
	// Object composed by the categories that will activate or deactivate the campaign audience.
	Categories []Setcampaignconfiguration200ApplicationJSONTargetConfigurationsCategories `json:"categories,omitempty"`
	// If set to `true`, this campaign audience will be applied to any category present on the `categories` field. If set to `false`, categories present on that field will make this campaign audience not to be applied.
	CategoriesAreInclusive *bool `json:"categoriesAreInclusive,omitempty"`
	// An expression to use with clusters.
	ClusterExpressions []string `json:"clusterExpressions,omitempty"`
	ClusterOperator    *string  `json:"clusterOperator,omitempty"`
	// Object composed by the collections that will activate or deactivate the campaign audience.
	Collections []Setcampaignconfiguration200ApplicationJSONTargetConfigurationsCollections `json:"collections,omitempty"`
	// Collections that will generate the promotion, type **Buy Together**, **More for less**, **Progressive Discount**, **Buy One Get One**.
	Collections1BuyTogether []string      `json:"collections1BuyTogether,omitempty"`
	Collections2BuyTogether []interface{} `json:"collections2BuyTogether,omitempty"`
	// If set to `true`, this campaign audience will be applied to any collection present on the `collections` field. If set to `false`, collections present on that field will make this campaign audience not to be applied.
	...
	Origin *string `json:"origin,omitempty"`
	// Array composed by all the Payments Methods.
	PaymentsMethods []Setcampaignconfiguration200ApplicationJSONTargetConfigurationsPaymentsMethods `json:"paymentsMethods,omitempty"`
	PaymentsRules   []interface{}                                                                   `json:"paymentsRules,omitempty"`
	// Percentual discount value list.
	PercentualDiscountValueList []float64 `json:"percentualDiscountValueList,omitempty"`
	// Object composed by the products that will activate or deactivate the campaign audience.
	Products []Setcampaignconfiguration200ApplicationJSONTargetConfigurationsProducts `json:"products,omitempty"`
	// If set to `true`, this campaign audience will be applied to any product present on the `products` field. If set to `false`, products present on that field will make this campaign audience not to be applied.
	ProductsAreInclusive   *bool         `json:"productsAreInclusive,omitempty"`
	ProductsSpecifications []interface{} `json:"productsSpecifications,omitempty"`
	// Quantity to affect **Buy Together** promotion.
	...
	ShouldDistributeDiscountAmongMatchedItems *bool `json:"shouldDistributeDiscountAmongMatchedItems,omitempty"`
	// Object composed by the SKUs that will activate or deactivate the campaign audience.
	Skus []Setcampaignconfiguration200ApplicationJSONTargetConfigurationsSkus `json:"skus,omitempty"`
	// If set to `true`, this campaign audience will be applied to any SKU present on the `skus` field. If set to `false`, SKUs present on that field will make this campaign audience not to be applied.
	SkusAreInclusive *bool `json:"skusAreInclusive,omitempty"`
	// The discount will be granted if the shipping method is the same as the one given.
	SlasIds            []string      `json:"slasIds,omitempty"`
	...
	UseNewProgressiveAlgorithm *bool `json:"useNewProgressiveAlgorithm,omitempty"`
	// Range of the zip code that applies the campaign audience.
	ZipCodeRanges []Setcampaignconfiguration200ApplicationJSONTargetConfigurationsZipCodeRanges `json:"zipCodeRanges,omitempty"`
}

// Setcampaignconfiguration200ApplicationJSON - OK
type Setcampaignconfiguration200ApplicationJSON struct {
	// Start date of the campaign audience in UTC format.
	BeginDateUtc *string `json:"beginDateUtc,omitempty"`
	// End date of the campaign audience in UTC format.
	EndDateUtc *string `json:"endDateUtc,omitempty"`
	...
	LastModified *Setcampaignconfiguration200ApplicationJSONLastModified `json:"lastModified,omitempty"`
	// Campaign audience name.
	Name *string `json:"name,omitempty"`
	// Array that contains all target audience that the campaign audience will be valid.
	TargetConfigurations []Setcampaignconfiguration200ApplicationJSONTargetConfigurations `json:"targetConfigurations,omitempty"`
}

type SetcampaignconfigurationResponse struct {
	ContentType string
	// OK
