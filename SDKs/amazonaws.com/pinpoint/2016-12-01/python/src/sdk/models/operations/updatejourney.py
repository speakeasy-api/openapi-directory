...
from ..shared import updatejourneyresponse as shared_updatejourneyresponse


@dataclasses.dataclass
class UpdateJourneyPathParams:
...
class UpdateJourneyRequestBodyWriteJourneyRequest:
    r"""UpdateJourneyRequestBodyWriteJourneyRequest
...
class UpdateJourneyRequestBody:
    write_journey_request: UpdateJourneyRequestBodyWriteJourneyRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('WriteJourneyRequest') }})
    

@dataclasses.dataclass
class UpdateJourneyRequest:
    headers: UpdateJourneyHeaders = dataclasses.field()
    path_params: UpdateJourneyPathParams = dataclasses.field()
    request: UpdateJourneyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateJourneyResponse:
    ...
    update_journey_response: Optional[shared_updatejourneyresponse.UpdateJourneyResponse] = dataclasses.field(default=None)
