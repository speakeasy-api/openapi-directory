...
exports.ObjectAccessControls = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ObjectAccessControls = /** @class */ (function () {
    function ObjectAccessControls(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ObjectAccessControls.prototype.storageObjectAccessControlsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.StorageObjectAccessControlsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/b/{bucket}/o/{object}/acl/{entity}", req.pathParams);
    ...
    **/
    ObjectAccessControls.prototype.storageObjectAccessControlsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ObjectAccessControls.prototype.storageObjectAccessControlsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.StorageObjectAccessControlsInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/b/{bucket}/o/{object}/acl", req.pathParams);
    ...
    **/
    ObjectAccessControls.prototype.storageObjectAccessControlsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ObjectAccessControls.prototype.storageObjectAccessControlsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ObjectAccessControls.prototype.storageObjectAccessControlsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.ObjectAccessControls = ObjectAccessControls;
