...
class GetEmployeesFromPayScheduleOnEffectiveDateRequest:
    headers: GetEmployeesFromPayScheduleOnEffectiveDateHeaders = dataclasses.field()
    path_params: GetEmployeesFromPayScheduleOnEffectiveDatePathParams = dataclasses.field()
