...
func (e GetAutoScalingGroupRecommendationsXAmzTargetEnum) ToPointer() *GetAutoScalingGroupRecommendationsXAmzTargetEnum {
	return &e
}
...
func (e *GetAutoScalingGroupRecommendationsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "ComputeOptimizerService.GetAutoScalingGroupRecommendations":
		*e = GetAutoScalingGroupRecommendationsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetAutoScalingGroupRecommendationsXAmzTargetEnum: %v", v)
	}
}

type GetAutoScalingGroupRecommendationsRequest struct {
	GetAutoScalingGroupRecommendationsRequest shared.GetAutoScalingGroupRecommendationsRequest `request:"mediaType=application/json"`
