...
class ContactcenterinsightsProjectsLocationsViewsDeleteRequest:
    ...
    r"""Required. The name of the view to delete."""  
    ...
    r"""If set to true, all of this conversation's analyses will also be deleted. Otherwise, the request will only succeed if the conversation has no analyses."""  
