...
class Actions:
    ...
    def actions_set_actions_oidc_custom_issuer_policy_for_enterprise(self, request: operations.ActionsSetActionsOidcCustomIssuerPolicyForEnterpriseRequest) -> operations.ActionsSetActionsOidcCustomIssuerPolicyForEnterpriseResponse:
        r"""Set the GitHub Actions OIDC custom issuer policy for an enterprise
        ...
        url = utils.generate_url(operations.ActionsSetActionsOidcCustomIssuerPolicyForEnterpriseRequest, base_url, '/enterprises/{enterprise}/actions/oidc/customization/issuer', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "actions_oidc_custom_issuer_policy_for_enterprise", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ActionsSetActionsOidcCustomIssuerPolicyForEnterpriseResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
