...
exports.OpportunitiesDeleteResponse = exports.OpportunitiesDeleteRequest = exports.OpportunitiesDeleteSecurity = void 0;
...
exports.OpportunitiesDeleteSecurity = OpportunitiesDeleteSecurity;
var OpportunitiesDeleteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], OpportunitiesDeleteRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], OpportunitiesDeleteRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], OpportunitiesDeleteRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], OpportunitiesDeleteRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], OpportunitiesDeleteRequest.prototype, "xApideckServiceId", void 0);
    return OpportunitiesDeleteRequest;
}(utils_1.SpeakeasyBase));
exports.OpportunitiesDeleteRequest = OpportunitiesDeleteRequest;
var OpportunitiesDeleteResponse = /** @class */ (function (_super) {
    ...
    ], OpportunitiesDeleteResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.OpportunitiesDeleteResponse = OpportunitiesDeleteResponse;
