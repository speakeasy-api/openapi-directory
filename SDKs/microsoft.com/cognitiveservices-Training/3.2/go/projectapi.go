...
func (s *ProjectAPI) ExportProject(ctx context.Context, request operations.ExportProjectRequest) (*operations.ExportProjectResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/projects/{projectId}/export", request.PathParams)
...
func (s *ProjectAPI) PublishIteration(ctx context.Context, request operations.PublishIterationRequest) (*operations.PublishIterationResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/projects/{projectId}/iterations/{iterationId}/publish", request.PathParams)
...
func (s *ProjectAPI) UpdateIteration(ctx context.Context, request operations.UpdateIterationRequest) (*operations.UpdateIterationResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/projects/{projectId}/iterations/{iterationId}", request.PathParams)
...
func (s *ProjectAPI) UpdateProject(ctx context.Context, request operations.UpdateProjectRequest) (*operations.UpdateProjectResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/projects/{projectId}", request.PathParams)
