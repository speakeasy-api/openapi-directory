...
public class GetResourcesMediaJsonQueryParams {
    /**
    ...
    public GetResourcesMediaJsonQueryParams withCollectionId(Integer collectionId) {
    ...
    public GetResourcesMediaJsonQueryParams withContentAuthoredBeforeDate(LocalDate contentAuthoredBeforeDate) {
    ...
    public GetResourcesMediaJsonQueryParams withContentAuthoredInRange(String contentAuthoredInRange) {
    ...
    public GetResourcesMediaJsonQueryParams withContentAuthoredSinceDate(LocalDate contentAuthoredSinceDate) {
    ...
    public GetResourcesMediaJsonQueryParams withContentPublishedBeforeDate(LocalDate contentPublishedBeforeDate) {
    ...
    public GetResourcesMediaJsonQueryParams withContentPublishedInRange(String contentPublishedInRange) {
    ...
    public GetResourcesMediaJsonQueryParams withContentPublishedSinceDate(LocalDate contentPublishedSinceDate) {
    ...
    public GetResourcesMediaJsonQueryParams withContentReviewedBeforeDate(LocalDate contentReviewedBeforeDate) {
    ...
    public GetResourcesMediaJsonQueryParams withContentReviewedInRange(String contentReviewedInRange) {
    ...
    public GetResourcesMediaJsonQueryParams withContentReviewedSinceDate(LocalDate contentReviewedSinceDate) {
    ...
    public GetResourcesMediaJsonQueryParams withContentUpdatedBeforeDate(LocalDate contentUpdatedBeforeDate) {
    ...
    public GetResourcesMediaJsonQueryParams withContentUpdatedInRange(String contentUpdatedInRange) {
    ...
    public GetResourcesMediaJsonQueryParams withContentUpdatedSinceDate(LocalDate contentUpdatedSinceDate) {
    ...
    public GetResourcesMediaJsonQueryParams withCreatedBy(String createdBy) {
    ...
    public GetResourcesMediaJsonQueryParams withCustomThumbnailUrl(String customThumbnailUrl) {
    ...
    public GetResourcesMediaJsonQueryParams withCustomThumbnailUrlContains(String customThumbnailUrlContains) {
    ...
    public GetResourcesMediaJsonQueryParams withDateContentAuthored(LocalDate dateContentAuthored) {
    ...
    public GetResourcesMediaJsonQueryParams withDateContentPublished(LocalDate dateContentPublished) {
    ...
    public GetResourcesMediaJsonQueryParams withDateContentReviewed(LocalDate dateContentReviewed) {
    ...
    public GetResourcesMediaJsonQueryParams withDateContentUpdated(LocalDate dateContentUpdated) {
    ...
    public GetResourcesMediaJsonQueryParams withDateSyndicationCaptured(LocalDate dateSyndicationCaptured) {
    ...
    public GetResourcesMediaJsonQueryParams withDateSyndicationUpdated(LocalDate dateSyndicationUpdated) {
    ...
    public GetResourcesMediaJsonQueryParams withDescriptionContains(String descriptionContains) {
    ...
    public String hash;
    public GetResourcesMediaJsonQueryParams withHash(String hash) {
        this.hash = hash;
        return this;
    }
    ...
    public GetResourcesMediaJsonQueryParams withHashContains(String hashContains) {
    ...
    public GetResourcesMediaJsonQueryParams withLanguageId(Long languageId) {
    ...
    public GetResourcesMediaJsonQueryParams withLanguageIsoCode(String languageIsoCode) {
    ...
    public GetResourcesMediaJsonQueryParams withLanguageName(String languageName) {
    ...
    public Integer max;
    public GetResourcesMediaJsonQueryParams withMax(Integer max) {
        this.max = max;
        return this;
    }
    ...
    public GetResourcesMediaJsonQueryParams withMediaTypes(String mediaTypes) {
    ...
    public String name;
    public GetResourcesMediaJsonQueryParams withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public GetResourcesMediaJsonQueryParams withNameContains(String nameContains) {
    ...
    public GetResourcesMediaJsonQueryParams withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public String order;
    public GetResourcesMediaJsonQueryParams withOrder(String order) {
        this.order = order;
        return this;
    }
    ...
    public GetResourcesMediaJsonQueryParams withRestrictToSet(String restrictToSet) {
    ...
    public String sort;
    public GetResourcesMediaJsonQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetResourcesMediaJsonQueryParams withSourceAcronym(String sourceAcronym) {
    ...
    public GetResourcesMediaJsonQueryParams withSourceAcronymContains(String sourceAcronymContains) {
    ...
    public GetResourcesMediaJsonQueryParams withSourceId(Long sourceId) {
    ...
    public GetResourcesMediaJsonQueryParams withSourceName(String sourceName) {
    ...
    public GetResourcesMediaJsonQueryParams withSourceNameContains(String sourceNameContains) {
    ...
    public GetResourcesMediaJsonQueryParams withSourceUrl(String sourceUrl) {
    ...
    public GetResourcesMediaJsonQueryParams withSourceUrlContains(String sourceUrlContains) {
    ...
    public GetResourcesMediaJsonQueryParams withSyndicationCapturedBeforeDate(LocalDate syndicationCapturedBeforeDate) {
    ...
    public GetResourcesMediaJsonQueryParams withSyndicationCapturedInRange(String syndicationCapturedInRange) {
    ...
    public GetResourcesMediaJsonQueryParams withSyndicationCapturedSinceDate(LocalDate syndicationCapturedSinceDate) {
    ...
    public GetResourcesMediaJsonQueryParams withSyndicationUpdatedBeforeDate(LocalDate syndicationUpdatedBeforeDate) {
    ...
    public GetResourcesMediaJsonQueryParams withSyndicationUpdatedInRange(String syndicationUpdatedInRange) {
    ...
    public GetResourcesMediaJsonQueryParams withSyndicationUpdatedSinceDate(LocalDate syndicationUpdatedSinceDate) {
    ...
    public GetResourcesMediaJsonQueryParams withSyndicationVisibleBeforeDate(LocalDate syndicationVisibleBeforeDate) {
    ...
    public GetResourcesMediaJsonQueryParams withSyndicationVisibleInRange(LocalDate syndicationVisibleInRange) {
    ...
    public GetResourcesMediaJsonQueryParams withSyndicationVisibleSinceDate(LocalDate syndicationVisibleSinceDate) {
    ...
    public GetResourcesMediaJsonQueryParams withTagIds(String tagIds) {
        this.tagIds = tagIds;
        return this;
    }
