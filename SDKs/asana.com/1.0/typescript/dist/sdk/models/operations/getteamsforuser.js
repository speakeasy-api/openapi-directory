...
exports.GetTeamsForUserResponse = exports.GetTeamsForUser200ApplicationJSON = exports.GetTeamsForUserRequest = void 0;
...
var GetTeamsForUserRequest = /** @class */ (function (_super) {
    ...
    ], GetTeamsForUserRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", String)
    ], GetTeamsForUserRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=opt_fields",
        }),
        __metadata("design:type", Array)
    ], GetTeamsForUserRequest.prototype, "optFields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=opt_pretty",
        }),
        __metadata("design:type", Boolean)
    ], GetTeamsForUserRequest.prototype, "optPretty", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=organization",
        }),
        __metadata("design:type", String)
    ], GetTeamsForUserRequest.prototype, "organization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=user_gid",
        }),
        __metadata("design:type", String)
    ], GetTeamsForUserRequest.prototype, "userGid", void 0);
...
var GetTeamsForUser200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.TeamCompact }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return shared.TeamCompact; }),
        __metadata("design:type", Array)
...
var GetTeamsForUserResponse = /** @class */ (function (_super) {
    ...
    ], GetTeamsForUserResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
