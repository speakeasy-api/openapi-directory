...
from ..shared import scheduleeefile as shared_scheduleeefile
...
class ScheduleEEfilePage:
    ...
    results: Optional[list[shared_scheduleeefile.ScheduleEEfile]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
