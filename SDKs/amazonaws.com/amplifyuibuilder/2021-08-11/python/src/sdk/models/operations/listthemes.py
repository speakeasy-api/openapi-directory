...
from ..shared import listthemesresponse as shared_listthemesresponse
...
class ListThemesRequest:
    ...
    r"""The maximum number of theme results to return in the response."""  
...
class ListThemesResponse:
    ...
    list_themes_response: Optional[shared_listthemesresponse.ListThemesResponse] = dataclasses.field(default=None)
    r"""Success"""  
