...
type GetNhFossilsIndividualsQueryParams struct {
...
type GetNhFossilsIndividualsHeaders struct {
...
type GetNhFossilsIndividualsRequest struct {
	QueryParams GetNhFossilsIndividualsQueryParams
	Headers     GetNhFossilsIndividualsHeaders
}

type GetNhFossilsIndividualsResponse struct {
	ContentType string
