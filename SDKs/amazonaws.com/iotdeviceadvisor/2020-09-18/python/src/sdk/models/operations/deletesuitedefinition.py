...
class DeleteSuiteDefinitionRequest:
    headers: DeleteSuiteDefinitionHeaders = dataclasses.field()
    path_params: DeleteSuiteDefinitionPathParams = dataclasses.field()
...
class DeleteSuiteDefinitionResponse:
    ...
    delete_suite_definition_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
