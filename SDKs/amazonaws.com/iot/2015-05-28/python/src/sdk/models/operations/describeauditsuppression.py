...
from ..shared import describeauditsuppressionresponse as shared_describeauditsuppressionresponse
...
class DescribeAuditSuppressionRequestBody:
    ...
    resource_identifier: DescribeAuditSuppressionRequestBodyResourceIdentifier = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceIdentifier') }})
    

@dataclasses.dataclass
class DescribeAuditSuppressionRequest:
    headers: DescribeAuditSuppressionHeaders = dataclasses.field()
    request: DescribeAuditSuppressionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DescribeAuditSuppressionResponse:
    ...
    describe_audit_suppression_response: Optional[shared_describeauditsuppressionresponse.DescribeAuditSuppressionResponse] = dataclasses.field(default=None)
