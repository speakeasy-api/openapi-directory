...
class APIV2010AccountUsageUsageRecordUsageRecordMonthly:
    ...
    category: Optional[shared_usage_record_monthly_enum_category_enum.UsageRecordMonthlyEnumCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('category') }})
