...
type SearchTypeServiceGroupQueryParams struct {
...
type SearchTypeServiceGroupRequest struct {
	QueryParams SearchTypeServiceGroupQueryParams
}

type SearchTypeServiceGroupResponse struct {
	ContentType string
	StatusCode  int
