 ...
 */
export declare enum RegionDiskTypeListWarningCodeEnum {
...
export declare class RegionDiskTypeListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class RegionDiskTypeListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class RegionDiskTypeList extends SpeakeasyBase {
    /**
