...
class AnalyticsManagementCustomMetricsGetSecurity:
    option1: Optional[AnalyticsManagementCustomMetricsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementCustomMetricsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class AnalyticsManagementCustomMetricsGetRequest:
    path_params: AnalyticsManagementCustomMetricsGetPathParams = dataclasses.field()
    query_params: AnalyticsManagementCustomMetricsGetQueryParams = dataclasses.field()
    security: AnalyticsManagementCustomMetricsGetSecurity = dataclasses.field()
