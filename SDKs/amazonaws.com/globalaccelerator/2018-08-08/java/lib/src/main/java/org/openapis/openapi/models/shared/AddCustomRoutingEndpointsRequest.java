...
public class AddCustomRoutingEndpointsRequest {
    ...
    public AddCustomRoutingEndpointsRequest(@JsonProperty("EndpointConfigurations") CustomRoutingEndpointConfiguration[] endpointConfigurations, @JsonProperty("EndpointGroupArn") String endpointGroupArn) {
        this.endpointConfigurations = endpointConfigurations;
        this.endpointGroupArn = endpointGroupArn;
  }
}
