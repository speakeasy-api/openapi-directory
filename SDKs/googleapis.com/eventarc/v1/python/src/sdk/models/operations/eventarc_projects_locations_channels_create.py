...
class EventarcProjectsLocationsChannelsCreateRequest:
    ...
    r"""Required. The parent collection in which to add this channel."""  
    ...
    r"""Required. The user-provided ID to be assigned to the channel."""  
    channel_input: Optional[shared_channel.ChannelInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    ...
    r"""Required. If set, validate the request and preview the review, but do not post it."""  
