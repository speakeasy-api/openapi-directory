...
public class CreateOrganizationAdaptivePolicyAclRequestBodyRules {
    ...
    public CreateOrganizationAdaptivePolicyAclRequestBodyRules(@JsonProperty("policy") CreateOrganizationAdaptivePolicyAclRequestBodyRulesPolicyEnum policy, @JsonProperty("protocol") CreateOrganizationAdaptivePolicyAclRequestBodyRulesProtocolEnum protocol) {
        this.policy = policy;
        this.protocol = protocol;
  }
}
