...
var NotifyV1Service = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=alexa_skill_id" }),
        __metadata("design:type", String)
    ], NotifyV1Service.prototype, "alexaSkillId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=apn_credential_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=default_alexa_notification_protocol_version" }),
        __metadata("design:type", String)
    ], NotifyV1Service.prototype, "defaultAlexaNotificationProtocolVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=default_apn_notification_protocol_version" }),
        __metadata("design:type", String)
    ], NotifyV1Service.prototype, "defaultApnNotificationProtocolVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=default_fcm_notification_protocol_version" }),
        __metadata("design:type", String)
    ], NotifyV1Service.prototype, "defaultFcmNotificationProtocolVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=default_gcm_notification_protocol_version" }),
        __metadata("design:type", String)
    ], NotifyV1Service.prototype, "defaultGcmNotificationProtocolVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=delivery_callback_enabled" }),
        __metadata("design:type", Boolean)
    ], NotifyV1Service.prototype, "deliveryCallbackEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=delivery_callback_url" }),
        __metadata("design:type", String)
    ], NotifyV1Service.prototype, "deliveryCallbackUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=facebook_messenger_page_id" }),
        __metadata("design:type", String)
    ], NotifyV1Service.prototype, "facebookMessengerPageId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=fcm_credential_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=gcm_credential_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=log_enabled" }),
        __metadata("design:type", Boolean)
