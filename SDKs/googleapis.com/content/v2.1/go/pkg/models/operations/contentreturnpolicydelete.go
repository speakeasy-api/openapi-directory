...
type ContentReturnpolicyDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentReturnpolicyDeletePathParams struct {
...
type ContentReturnpolicyDeleteQueryParams struct {
	// V1 error format.
...
type ContentReturnpolicyDeleteRequest struct {
...
type ContentReturnpolicyDeleteResponse struct {
	ContentType string
	StatusCode  int
