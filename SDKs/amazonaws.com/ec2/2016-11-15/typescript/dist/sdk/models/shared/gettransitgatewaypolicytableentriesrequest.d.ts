 ...
 */
export declare class GetTransitGatewayPolicyTableEntriesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetTransitGatewayPolicyTableEntriesRequest extends SpeakeasyBase {
    dryRun?: boolean;
