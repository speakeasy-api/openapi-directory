...
var Sla = /** @class */ (function () {
    function Sla(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    Sla.prototype.calculateSLA = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CalculateSLARequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/logistics/pvt/shipping/calculate";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.CalculateSLAResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        ...
                        res.calculateSLA200ApplicationJSONArrays = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.CalculateSla200ApplicationJSON, resFieldDepth);
                    }
                    break;
            }
            return res;
