...
public class ListModelBuildResponse {
    ...
    public ListModelBuildResponse withStatusCode(Integer statusCode) {
    ...
    public ListModelBuildResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
        this.rawResponse = rawResponse;
        return this;
    }
    
    public ListModelBuildResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
