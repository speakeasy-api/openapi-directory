...
public class GetTruckOptimalRouteOutputFormatRequest {
    ...
    public GetTruckOptimalRouteOutputFormatRequest withCorrectSide(Boolean correctSide) {
    ...
    public GetTruckOptimalRouteOutputFormatRequest withCriteria(GetTruckOptimalRouteOutputFormatCriteriaEnum criteria) {
    ...
    public GetTruckOptimalRouteOutputFormatRequest withDeparture(OffsetDateTime departure) {
    ...
    public GetTruckOptimalRouteOutputFormatRequest withDisable(String disable) {
    ...
    public GetTruckOptimalRouteOutputFormatRequest withDistanceUnit(GetTruckOptimalRouteOutputFormatDistanceUnitEnum distanceUnit) {
    ...
    public GetTruckOptimalRouteOutputFormatRequest withOutputFormat(GetTruckOptimalRouteOutputFormatOutputFormatEnum outputFormat) {
    ...
    public GetTruckOptimalRouteOutputFormatRequest withOutputSRS(GetTruckOptimalRouteOutputFormatOutputSrsEnum outputSRS) {
    ...
    public GetTruckOptimalRouteOutputFormatRequest withPartition(String partition) {
    ...
    public GetTruckOptimalRouteOutputFormatRequest withPoints(String points) {
        this.points = points;
        return this;
    }
    ...
    public GetTruckOptimalRouteOutputFormatRequest withRoundTrip(Boolean roundTrip) {
    ...
    public GetTruckOptimalRouteOutputFormatRequest withRouteDescription(String routeDescription) {
    ...
    public GetTruckOptimalRouteOutputFormatRequest withTruckRouteMultiplier(Long truckRouteMultiplier) {
        this.truckRouteMultiplier = truckRouteMultiplier;
        return this;
    }
    
    public GetTruckOptimalRouteOutputFormatRequest(@JsonProperty("outputFormat") GetTruckOptimalRouteOutputFormatOutputFormatEnum outputFormat, @JsonProperty("points") String points) {
        this.outputFormat = outputFormat;
        this.points = points;
  }
}
