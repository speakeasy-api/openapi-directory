...
export enum GetMeMentionedOrderEnum {
  Desc = "desc",
  Asc = "asc",
}

export enum GetMeMentionedSortEnum {
  Creation = "creation",
  Votes = "votes",
}

export class GetMeMentionedRequest extends SpeakeasyBase {
  /**
...
export class GetMeMentionedResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
