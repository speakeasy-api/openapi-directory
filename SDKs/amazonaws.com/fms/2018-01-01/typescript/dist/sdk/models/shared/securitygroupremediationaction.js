...
var SecurityGroupRemediationAction = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RemediationActionType" }),
        __metadata("design:type", String)
    ], SecurityGroupRemediationAction.prototype, "remediationActionType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RemediationResult" }),
        (0, class_transformer_1.Type)(function () { return securitygroupruledescription_1.SecurityGroupRuleDescription; }),
