...
import { InstanceGroupManagersScopedList } from "./instancegroupmanagersscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum InstanceGroupManagerAggregatedListWarningCodeEnum {
...
export declare class InstanceGroupManagerAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InstanceGroupManagerAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InstanceGroupManagerAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InstanceGroupManagerAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class InstanceGroupManagerAggregatedList extends SpeakeasyBase {
    /**
