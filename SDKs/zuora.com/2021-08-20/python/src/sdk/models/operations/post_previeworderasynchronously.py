...
class POSTPreviewOrderAsynchronouslyRequest:
    ...
    post_order_preview_request_type: shared_postorderpreviewrequesttype.POSTOrderPreviewRequestType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class POSTPreviewOrderAsynchronously202ApplicationJSON:
    ...
    r"""The ID of an asynchronous job that will be returned for tracking the status and result of the job."""  
