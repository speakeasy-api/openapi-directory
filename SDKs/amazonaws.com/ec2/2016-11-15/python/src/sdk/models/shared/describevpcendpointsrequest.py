...
class DescribeVpcEndpointsRequestFilters:
...
class DescribeVpcEndpointsRequest:
    ...
    filters: Optional[list[DescribeVpcEndpointsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    vpc_endpoint_ids: Optional[list[str]] = dataclasses.field(default=None)  
