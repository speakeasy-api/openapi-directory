...
type GetNhToolsToolPathParams struct {
	// The name of the interior item you wish to retrieve information about.
	Tool string `pathParam:"style=simple,explode=false,name=tool"`
}

type GetNhToolsToolQueryParams struct {
...
type GetNhToolsToolHeaders struct {
...
type GetNhToolsToolRequest struct {
	PathParams  GetNhToolsToolPathParams
	QueryParams GetNhToolsToolQueryParams
	Headers     GetNhToolsToolHeaders
}

type GetNhToolsToolResponse struct {
	ContentType string
