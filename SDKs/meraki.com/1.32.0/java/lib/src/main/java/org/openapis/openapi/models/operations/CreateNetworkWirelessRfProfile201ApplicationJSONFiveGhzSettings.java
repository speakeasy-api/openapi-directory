 ...
 */
public class CreateNetworkWirelessRfProfile201ApplicationJSONFiveGhzSettings {
    /**
    ...
    public CreateNetworkWirelessRfProfile201ApplicationJSONFiveGhzSettings withChannelWidth(String channelWidth) {
    ...
    public CreateNetworkWirelessRfProfile201ApplicationJSONFiveGhzSettings withMaxPower(Long maxPower) {
    ...
    public CreateNetworkWirelessRfProfile201ApplicationJSONFiveGhzSettings withMinBitrate(Long minBitrate) {
    ...
    public CreateNetworkWirelessRfProfile201ApplicationJSONFiveGhzSettings withMinPower(Long minPower) {
    ...
    public CreateNetworkWirelessRfProfile201ApplicationJSONFiveGhzSettings withRxsop(Long rxsop) {
        this.rxsop = rxsop;
        return this;
    }
    ...
    public CreateNetworkWirelessRfProfile201ApplicationJSONFiveGhzSettings withValidAutoChannels(Long[] validAutoChannels) {
        this.validAutoChannels = validAutoChannels;
        return this;
    }
    
    public CreateNetworkWirelessRfProfile201ApplicationJSONFiveGhzSettings(){}
}
