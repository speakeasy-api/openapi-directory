...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/rapidapi.com/football-prediction/2/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/rapidapi.com/football-prediction/2/typescript
```
