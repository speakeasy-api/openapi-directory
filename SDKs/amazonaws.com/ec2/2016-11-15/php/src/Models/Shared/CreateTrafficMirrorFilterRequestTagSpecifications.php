 ...
 * @access public
 */
class CreateTrafficMirrorFilterRequestTagSpecifications
{
	
    public ?CreateTrafficMirrorFilterRequestTagSpecificationsResourceTypeEnum $resourceType = null;
    
    /**
     * $tags
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Shared\CreateTrafficMirrorFilterRequestTagSpecificationsTags> $tags
     */
