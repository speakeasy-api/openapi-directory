...
public class ListLabelsQueryParams {
    ...
    public ListLabelsQueryParams withLabelStatus(org.openapis.openapi.models.shared.LabelStatusEnum labelStatus) {
    ...
    public ListLabelsQueryParams withSortDir(ListLabelsSortDirSortDirEnum sortDir) {
