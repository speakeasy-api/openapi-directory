...
exports.CreateAlphaSenderResponse = exports.CreateAlphaSenderRequest = exports.CreateAlphaSenderCreateAlphaSenderRequest = exports.CreateAlphaSenderSecurity = exports.CreateAlphaSenderServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.CreateAlphaSenderServerList = [
...
var CreateAlphaSenderSecurity = /** @class */ (function (_super) {
    ...
    ], CreateAlphaSenderSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], CreateAlphaSenderSecurity.prototype, "username", void 0);
    return CreateAlphaSenderSecurity;
}(utils_1.SpeakeasyBase));
exports.CreateAlphaSenderSecurity = CreateAlphaSenderSecurity;
var CreateAlphaSenderCreateAlphaSenderRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=AlphaSender" }),
        __metadata("design:type", String)
    ], CreateAlphaSenderCreateAlphaSenderRequest.prototype, "alphaSender", void 0);
    return CreateAlphaSenderCreateAlphaSenderRequest;
}(utils_1.SpeakeasyBase));
exports.CreateAlphaSenderCreateAlphaSenderRequest = CreateAlphaSenderCreateAlphaSenderRequest;
var CreateAlphaSenderRequest = /** @class */ (function (_super) {
    ...
    ], CreateAlphaSenderRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], CreateAlphaSenderRequest.prototype, "serviceSid", void 0);
    return CreateAlphaSenderRequest;
}(utils_1.SpeakeasyBase));
exports.CreateAlphaSenderRequest = CreateAlphaSenderRequest;
var CreateAlphaSenderResponse = /** @class */ (function (_super) {
    ...
    ], CreateAlphaSenderResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.CreateAlphaSenderResponse = CreateAlphaSenderResponse;
