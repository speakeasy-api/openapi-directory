...
export class DeleteFieldLevelEncryptionConfig20200531Request extends SpeakeasyBase {
  /**
...
export class DeleteFieldLevelEncryptionConfig20200531Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
