...
export class GetUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsIdTransactionInformationsIdInformationRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsIdTransactionInformationsIdInformationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
