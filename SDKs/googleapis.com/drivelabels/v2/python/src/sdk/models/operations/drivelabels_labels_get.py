...
class DrivelabelsLabelsGetQueryParams:
    ...
    view: Optional[DrivelabelsLabelsGetViewEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class DrivelabelsLabelsGetRequest:
    path_params: DrivelabelsLabelsGetPathParams = dataclasses.field()
    query_params: DrivelabelsLabelsGetQueryParams = dataclasses.field()
