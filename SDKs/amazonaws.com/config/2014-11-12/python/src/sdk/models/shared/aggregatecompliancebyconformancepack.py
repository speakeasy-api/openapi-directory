...
class AggregateComplianceByConformancePack:
    ...
    compliance: Optional[shared_aggregateconformancepackcompliance.AggregateConformancePackCompliance] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Compliance') }})
