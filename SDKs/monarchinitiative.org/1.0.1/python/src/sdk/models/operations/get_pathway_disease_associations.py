...
class GetPathwayDiseaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPathwayDiseaseAssociationsQueryParams:
...
@dataclasses.dataclass
class GetPathwayDiseaseAssociationsRequest:
    path_params: GetPathwayDiseaseAssociationsPathParams = dataclasses.field()
    query_params: GetPathwayDiseaseAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetPathwayDiseaseAssociationsResponse:
