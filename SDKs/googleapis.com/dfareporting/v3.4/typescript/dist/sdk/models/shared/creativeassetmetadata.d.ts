...
export declare enum CreativeAssetMetadataDetectedFeaturesEnum {
...
export declare enum CreativeAssetMetadataWarnedValidationRulesEnum {
 ...
 */
export declare class CreativeAssetMetadata extends SpeakeasyBase {
    /**
     * Creative Asset ID.
     */
