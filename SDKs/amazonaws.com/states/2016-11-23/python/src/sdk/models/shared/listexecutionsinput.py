...
class ListExecutionsInput:
    ...
    status_filter: Optional[shared_executionstatus_enum.ExecutionStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('statusFilter'), 'exclude': lambda f: f is None }})  
