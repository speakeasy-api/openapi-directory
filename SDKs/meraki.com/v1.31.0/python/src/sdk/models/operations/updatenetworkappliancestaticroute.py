...
class UpdateNetworkApplianceStaticRouteRequestBody:
    ...
    gateway_vlan_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('gatewayVlanId'), 'exclude': lambda f: f is None }})
    r"""The gateway IP (next hop) VLAN ID of the static route"""  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})
    r"""The name of the static route"""  
    reserved_ip_ranges: Optional[list[UpdateNetworkApplianceStaticRouteRequestBodyReservedIPRanges]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reservedIpRanges'), 'exclude': lambda f: f is None }})
...
class UpdateNetworkApplianceStaticRouteRequest:
    ...
    request_body: Optional[UpdateNetworkApplianceStaticRouteRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
