...
class GetGeneAnatomyAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGeneAnatomyAssociationsQueryParams:
...
@dataclasses.dataclass
class GetGeneAnatomyAssociationsRequest:
    path_params: GetGeneAnatomyAssociationsPathParams = dataclasses.field()
    query_params: GetGeneAnatomyAssociationsQueryParams = dataclasses.field()
