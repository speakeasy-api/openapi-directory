...
public class MediaAsset {
     ...
     * 
    **/
    public openapisdk.models.operations.GetMediaAssetsResponse getMediaAssets(openapisdk.models.operations.GetMediaAssetsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/media_assets");
        ...
        openapisdk.models.operations.GetMediaAssetsResponse res = new openapisdk.models.operations.GetMediaAssetsResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/vnd.api+json")) {
                ...
                openapisdk.models.operations.GetMediaAssets200ApplicationVndApiPlusJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetMediaAssets200ApplicationVndApiPlusJson.class);
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/vnd.api+json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.GetMediaAssets400ApplicationVndApiPlusJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetMediaAssets400ApplicationVndApiPlusJson.class);
     ...
     * 
    **/
    public openapisdk.models.operations.GetMediaAssetsIdResponse getMediaAssetsId(openapisdk.models.operations.GetMediaAssetsIdRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/media_assets/{id}", request.pathParams);
        ...
        openapisdk.models.operations.GetMediaAssetsIdResponse res = new openapisdk.models.operations.GetMediaAssetsIdResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/vnd.api+json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.GetMediaAssetsId200ApplicationVndApiPlusJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetMediaAssetsId200ApplicationVndApiPlusJson.class);
