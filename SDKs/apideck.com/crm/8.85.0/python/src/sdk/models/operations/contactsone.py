...
class ContactsOneRequest:
    headers: ContactsOneHeaders = dataclasses.field()
    path_params: ContactsOnePathParams = dataclasses.field()
    query_params: ContactsOneQueryParams = dataclasses.field()
    security: ContactsOneSecurity = dataclasses.field()
