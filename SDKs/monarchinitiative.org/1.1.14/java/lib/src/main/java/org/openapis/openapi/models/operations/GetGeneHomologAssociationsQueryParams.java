...
public class GetGeneHomologAssociationsQueryParams {
    /**
    ...
    public GetGeneHomologAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGeneHomologAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGeneHomologAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetGeneHomologAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGeneHomologAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGeneHomologAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetGeneHomologAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGeneHomologAssociationsQueryParams withHomologyType(GetGeneHomologAssociationsHomologyTypeEnum homologyType) {
    ...
    public Long rows;
    public GetGeneHomologAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetGeneHomologAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public Long start;
    public GetGeneHomologAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetGeneHomologAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGeneHomologAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGeneHomologAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
