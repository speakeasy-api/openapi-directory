...
func (e GETDescribeClustersActionEnum) ToPointer() *GETDescribeClustersActionEnum {
	return &e
}

func (e *GETDescribeClustersActionEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "DescribeClusters":
		*e = GETDescribeClustersActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeClustersActionEnum: %v", v)
	}
}
...
func (e GETDescribeClustersVersionEnum) ToPointer() *GETDescribeClustersVersionEnum {
	return &e
}

func (e *GETDescribeClustersVersionEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "2012-12-01":
		*e = GETDescribeClustersVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeClustersVersionEnum: %v", v)
	}
}
