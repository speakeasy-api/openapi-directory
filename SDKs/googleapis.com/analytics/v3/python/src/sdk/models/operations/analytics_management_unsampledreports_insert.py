...
class AnalyticsManagementUnsampledReportsInsertRequest:
    ...
    unsampled_report_input: Optional[shared_unsampledreport.UnsampledReportInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
