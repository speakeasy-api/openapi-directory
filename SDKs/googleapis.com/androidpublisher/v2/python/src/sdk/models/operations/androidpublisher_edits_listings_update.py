...
@dataclasses.dataclass
class AndroidpublisherEditsListingsUpdateQueryParams:
...
class AndroidpublisherEditsListingsUpdateRequest:
    path_params: AndroidpublisherEditsListingsUpdatePathParams = dataclasses.field()
    query_params: AndroidpublisherEditsListingsUpdateQueryParams = dataclasses.field()
    security: AndroidpublisherEditsListingsUpdateSecurity = dataclasses.field()
