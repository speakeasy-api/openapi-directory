...
public class GetItems200ApplicationJSONResults1 {
    /**
    ...
    public GetItems200ApplicationJSONResults1 withCodeHex(String codeHex) {
    ...
    public GetItems200ApplicationJSONResults1 withConfigRequest(java.util.Map<String, Object> configRequest) {
    ...
    public GetItems200ApplicationJSONResults1 withCustom(Object custom) {
        this.custom = custom;
        return this;
    }
    ...
    public GetItems200ApplicationJSONResults1 withGeoCoords(org.openapis.openapi.models.shared.GeoCoordsReadOnly geoCoords) {
    ...
    public GetItems200ApplicationJSONResults1 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetItems200ApplicationJSONResults1 withIsPresent(Boolean isPresent) {
    ...
    public GetItems200ApplicationJSONResults1 withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public GetItems200ApplicationJSONResults1 withLocation(org.openapis.openapi.models.shared.Location location) {
    ...
    public GetItems200ApplicationJSONResults1 withLocationRequest(String locationRequest) {
    ...
    public GetItems200ApplicationJSONResults1 withMetadata(java.util.Map<String, Object> metadata) {
    ...
    public GetItems200ApplicationJSONResults1 withMoveCount(Long moveCount) {
    ...
    public GetItems200ApplicationJSONResults1 withProtocol(org.openapis.openapi.models.shared.ItemProtocolEnum protocol) {
    ...
    public GetItems200ApplicationJSONResults1 withSets(String[] sets) {
        this.sets = sets;
        return this;
    }
    ...
    public GetItems200ApplicationJSONResults1 withTechnology(org.openapis.openapi.models.shared.TechnologyEnum technology) {
    ...
    public GetItems200ApplicationJSONResults1 withTimeCreated(String timeCreated) {
    ...
    public GetItems200ApplicationJSONResults1 withTimeLastPresent(String timeLastPresent) {
    ...
    public GetItems200ApplicationJSONResults1 withTimeMoved(String timeMoved) {
    ...
    public GetItems200ApplicationJSONResults1 withTimeUpdated(String timeUpdated) {
    ...
    public GetItems200ApplicationJSONResults1 withType(org.openapis.openapi.models.shared.ItemTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GetItems200ApplicationJSONResults1 withUrl(String url) {
        this.url = url;
        return this;
    }
    
    public GetItems200ApplicationJSONResults1(){}
}
