...
export class PatchCompaniesCompanyIdTerminalLogosSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PatchCompaniesCompanyIdTerminalLogosRequest extends SpeakeasyBase {
...
export class PatchCompaniesCompanyIdTerminalLogosResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
