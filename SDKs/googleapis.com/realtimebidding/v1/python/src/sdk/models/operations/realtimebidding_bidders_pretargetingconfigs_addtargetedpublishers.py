...
class RealtimebiddingBiddersPretargetingConfigsAddTargetedPublishersRequest:
    ...
    add_targeted_publishers_request: Optional[shared_addtargetedpublishersrequest.AddTargetedPublishersRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
