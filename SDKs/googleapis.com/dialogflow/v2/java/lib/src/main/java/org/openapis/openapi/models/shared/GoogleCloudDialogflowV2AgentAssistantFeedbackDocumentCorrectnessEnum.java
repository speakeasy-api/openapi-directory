 ...
 */
public enum GoogleCloudDialogflowV2AgentAssistantFeedbackDocumentCorrectnessEnum {
    ...
    private GoogleCloudDialogflowV2AgentAssistantFeedbackDocumentCorrectnessEnum(String value) {
        this.value = value;
    }
}
