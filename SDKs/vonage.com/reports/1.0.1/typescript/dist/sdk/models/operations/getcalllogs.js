...
exports.GetCallLogsResponse = exports.GetCallLogsRequest = exports.GetCallLogsSecurity = exports.GetCallLogsQueryParams = exports.GetCallLogsPathParams = void 0;
...
exports.GetCallLogsPathParams = GetCallLogsPathParams;
var GetCallLogsQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=destination_user" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=end:gte" }),
        __metadata("design:type", String)
    ], GetCallLogsQueryParams.prototype, "endGte", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=end:lte" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=source_user" }),
        __metadata("design:type", String)
    ], GetCallLogsQueryParams.prototype, "sourceUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=start:gte" }),
        __metadata("design:type", String)
    ], GetCallLogsQueryParams.prototype, "startGte", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=start:lte" }),
        __metadata("design:type", String)
...
exports.GetCallLogsQueryParams = GetCallLogsQueryParams;
