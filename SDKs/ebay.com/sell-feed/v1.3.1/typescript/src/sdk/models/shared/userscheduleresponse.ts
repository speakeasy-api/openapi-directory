...
export class UserScheduleResponse extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "preferredTriggerDayOfMonth" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "preferredTriggerDayOfWeek" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "preferredTriggerHour" })
