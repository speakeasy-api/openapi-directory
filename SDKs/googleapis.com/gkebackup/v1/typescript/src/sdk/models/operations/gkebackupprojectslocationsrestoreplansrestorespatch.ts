...
export class GkebackupProjectsLocationsRestorePlansRestoresPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsRestorePlansRestoresPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsRestorePlansRestoresPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
