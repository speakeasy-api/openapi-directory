...
from ..shared import autorefresh as shared_autorefresh
...
from ..shared import fullaccountnumberlist as shared_fullaccountnumberlist
from ..shared import accountholder as shared_accountholder
from ..shared import loanpayoffdetails as shared_loanpayoffdetails
from ..shared import paymentprofile as shared_paymentprofile
from ..shared import accountprofile as shared_accountprofile
from ..shared import rewardbalance as shared_rewardbalance

class AccountContainerEnum(str, Enum):
    BANK = "bank"
...
class AccountAccountStatusEnum(str, Enum):
    ACTIVE = "ACTIVE"
    INACTIVE = "INACTIVE"
...
class AccountAggregationSourceEnum(str, Enum):
    SYSTEM = "SYSTEM"
    USER = "USER"

class AccountClassificationEnum(str, Enum):
    OTHER = "OTHER"
    PERSONAL = "PERSONAL"
    CORPORATE = "CORPORATE"
...
class AccountFrequencyEnum(str, Enum):
    DAILY = "DAILY"
    ONE_TIME = "ONE_TIME"
    WEEKLY = "WEEKLY"
...
class AccountHomeInsuranceTypeEnum(str, Enum):
...
class AccountInterestRateTypeEnum(str, Enum):
    FIXED = "FIXED"
    VARIABLE = "VARIABLE"
    UNKNOWN = "UNKNOWN"
    OTHER = "OTHER"

class AccountLifeInsuranceTypeEnum(str, Enum):
    OTHER = "OTHER"
...
class AccountOauthMigrationStatusEnum(str, Enum):
    IN_PROGRESS = "IN_PROGRESS"
    TO_BE_MIGRATED = "TO_BE_MIGRATED"
    COMPLETED = "COMPLETED"

class AccountPolicyStatusEnum(str, Enum):
    ACTIVE = "ACTIVE"
    INACTIVE = "INACTIVE"
    OTHER = "OTHER"

class AccountRepaymentPlanTypeEnum(str, Enum):
    STANDARD = "STANDARD"
    GRADUATED = "GRADUATED"
    EXTENDED = "EXTENDED"
...
class AccountSourceAccountStatusEnum(str, Enum):
...
class AccountUserClassificationEnum(str, Enum):
    BUSINESS = "BUSINESS"
    PERSONAL = "PERSONAL"

class AccountValuationTypeEnum(str, Enum):
    SYSTEM = "SYSTEM"
    MANUAL = "MANUAL"
...
class Account:
    ...
    container: Optional[AccountContainerEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CONTAINER') }})
    ...
    account_status: Optional[AccountAccountStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('accountStatus') }})
    ...
    aggregation_source: Optional[AccountAggregationSourceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('aggregationSource') }})
    ...
    auto_refresh: Optional[shared_autorefresh.AutoRefresh] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('autoRefresh') }})
    ...
    classification: Optional[AccountClassificationEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('classification') }})
    ...
    frequency: Optional[AccountFrequencyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('frequency') }})
    ...
    full_account_number_list: Optional[shared_fullaccountnumberlist.FullAccountNumberList] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fullAccountNumberList') }})
    ...
    home_insurance_type: Optional[AccountHomeInsuranceTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('homeInsuranceType') }})
    ...
    interest_rate_type: Optional[AccountInterestRateTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('interestRateType') }})
    ...
    life_insurance_type: Optional[AccountLifeInsuranceTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('lifeInsuranceType') }})
    ...
    oauth_migration_status: Optional[AccountOauthMigrationStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('oauthMigrationStatus') }})
    ...
    payment_profile: Optional[shared_paymentprofile.PaymentProfile] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('paymentProfile') }})
    ...
    policy_status: Optional[AccountPolicyStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('policyStatus') }})
    ...
    profile: Optional[shared_accountprofile.AccountProfile] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('profile') }})
    ...
    repayment_plan_type: Optional[AccountRepaymentPlanTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('repaymentPlanType') }})
    ...
    source_account_status: Optional[AccountSourceAccountStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sourceAccountStatus') }})
    ...
    user_classification: Optional[AccountUserClassificationEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('userClassification') }})
    valuation_type: Optional[AccountValuationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('valuationType') }})
