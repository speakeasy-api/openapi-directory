...
class DescribeRiskConfigurationRequest:
    ...
    describe_risk_configuration_request: shared_describeriskconfigurationrequest.DescribeRiskConfigurationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
