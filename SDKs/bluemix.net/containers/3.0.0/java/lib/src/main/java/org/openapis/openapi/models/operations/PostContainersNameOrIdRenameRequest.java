...
public class PostContainersNameOrIdRenameRequest {
    ...
    public PostContainersNameOrIdRenameRequest(@JsonProperty("X-Auth-Project-Id") String xAuthProjectId, @JsonProperty("X-Auth-Token") String xAuthToken, @JsonProperty("name") String name, @JsonProperty("name_or_id") String nameOrId) {
        this.xAuthProjectId = xAuthProjectId;
        this.xAuthToken = xAuthToken;
        this.name = name;
        this.nameOrId = nameOrId;
