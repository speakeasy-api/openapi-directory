...
class PatchMerchantsMerchantIDTerminalLogosSecurity:
...
@dataclasses.dataclass
class PatchMerchantsMerchantIDTerminalLogosRequest:
    ...
    r"""The terminal model. Allowed values: E355, VX675WIFIBT, VX680, VX690, VX700, VX820, M400, MX925, P400Plus, UX300, UX410, V200cPlus, V240mPlus, V400cPlus, V400m, e280, e285, e285p, S1E, S1EL, S1F2, S1L, S1U, S7T."""  
    logo: Optional[shared_logo.Logo] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    

@dataclasses.dataclass
class PatchMerchantsMerchantIDTerminalLogosResponse:
