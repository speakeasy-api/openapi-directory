...
class DisassociateDrtRoleHeaders:
    x_amz_target: DisassociateDrtRoleXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateDrtRoleRequest:
    headers: DisassociateDrtRoleHeaders = dataclasses.field()
...
class DisassociateDrtRoleResponse:
    ...
    disassociate_drt_role_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
