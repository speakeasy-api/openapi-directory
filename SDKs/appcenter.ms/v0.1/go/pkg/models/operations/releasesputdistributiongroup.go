...
func (e ReleasesPutDistributionGroup404ApplicationJSONCodeEnum) ToPointer() *ReleasesPutDistributionGroup404ApplicationJSONCodeEnum {
	return &e
}
...
func (e *ReleasesPutDistributionGroup404ApplicationJSONCodeEnum) UnmarshalJSON(data []byte) error {
	...
	case "TooManyRequests":
		*e = ReleasesPutDistributionGroup404ApplicationJSONCodeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ReleasesPutDistributionGroup404ApplicationJSONCodeEnum: %v", v)
	}
}
