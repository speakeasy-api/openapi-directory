...
public class UpdateNetworkApplianceStaticRouteRequestBodyReservedIpRanges {
    ...
    public UpdateNetworkApplianceStaticRouteRequestBodyReservedIpRanges(@JsonProperty("comment") String comment, @JsonProperty("end") String end, @JsonProperty("start") String start) {
        this.comment = comment;
        this.end = end;
        this.start = start;
  }
