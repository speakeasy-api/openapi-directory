...
class GetTagsRequest:
    ...
    r"""The workspace to filter tags on."""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetTags200ApplicationJSON:
    r"""Successfully retrieved the specified set of tags."""
    
    data: Optional[list[shared_tagcompact.TagCompact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
