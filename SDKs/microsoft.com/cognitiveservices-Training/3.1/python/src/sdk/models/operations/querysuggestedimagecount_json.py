...
class QuerySuggestedImageCountJSONRequest:
    ...
    r"""The project id."""  
    tag_filter: shared_tagfilter.TagFilter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
@dataclasses.dataclass
class QuerySuggestedImageCountJSONResponse:
    ...
    r"""Error response"""  
    query_suggested_image_count_json_200_application_json_object: Optional[dict[str, int]] = dataclasses.field(default=None)
    r"""OK"""  
