...
var HealthCheck = /** @class */ (function (_super) {
    ...
    ], HealthCheck.prototype, "command", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=interval" }),
        __metadata("design:type", Number)
    ], HealthCheck.prototype, "interval", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=retries" }),
        __metadata("design:type", Number)
    ], HealthCheck.prototype, "retries", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startPeriod" }),
        __metadata("design:type", Number)
    ], HealthCheck.prototype, "startPeriod", void 0);
    __decorate([
