...
exports.GetQuoteAuthorsSearchResponse = exports.GetQuoteAuthorsSearchRequest = exports.GetQuoteAuthorsSearchSecurity = void 0;
...
var GetQuoteAuthorsSearchRequest = /** @class */ (function (_super) {
    ...
    ], GetQuoteAuthorsSearchRequest.prototype, "detailed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=language",
        }),
        __metadata("design:type", String)
    ], GetQuoteAuthorsSearchRequest.prototype, "language", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetQuoteAuthorsSearchRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=query" }),
        __metadata("design:type", String)
    ], GetQuoteAuthorsSearchRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=start" }),
        __metadata("design:type", Number)
    ], GetQuoteAuthorsSearchRequest.prototype, "start", void 0);
...
var GetQuoteAuthorsSearchResponse = /** @class */ (function (_super) {
    ...
    ], GetQuoteAuthorsSearchResponse.prototype, "rawResponse", void 0);
