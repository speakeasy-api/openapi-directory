...
from ..shared import deletesegmentresponse as shared_deletesegmentresponse


@dataclasses.dataclass
class DeleteSegmentPathParams:
...
class DeleteSegmentRequest:
    headers: DeleteSegmentHeaders = dataclasses.field()
    path_params: DeleteSegmentPathParams = dataclasses.field()
...
class DeleteSegmentResponse:
    ...
    delete_segment_response: Optional[shared_deletesegmentresponse.DeleteSegmentResponse] = dataclasses.field(default=None)
