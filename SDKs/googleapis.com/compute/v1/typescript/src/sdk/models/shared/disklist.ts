 ...
 */
export enum DiskListWarningCodeEnum {
...
export class DiskListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class DiskListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: DiskListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: DiskListWarningData })
  @Expose({ name: "data" })
  @Type(() => DiskListWarningData)
  data?: DiskListWarningData[];
 ...
 */
export class DiskList extends SpeakeasyBase {
  /**
