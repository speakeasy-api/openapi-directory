...
class PaymentsresellersubscriptionPartnersSubscriptionsCancelRequest:
    ...
    r"""Required. The name of the subscription resource to be cancelled. It will have the format of \\"partners/{partner_id}/subscriptions/{subscription_id}\\" """  
    ...
    google_cloud_payments_reseller_subscription_v1_cancel_subscription_request: Optional[shared_googlecloudpaymentsresellersubscriptionv1cancelsubscriptionrequest.GoogleCloudPaymentsResellerSubscriptionV1CancelSubscriptionRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
