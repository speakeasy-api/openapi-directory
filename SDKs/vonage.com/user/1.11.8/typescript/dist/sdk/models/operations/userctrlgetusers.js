...
exports.UserCtrlGetUsersResponse = exports.UserCtrlGetUsersRequest = exports.UserCtrlGetUsersSecurity = void 0;
...
var UserCtrlGetUsersRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], UserCtrlGetUsersRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=email" }),
        __metadata("design:type", String)
    ], UserCtrlGetUsersRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=first_name",
        }),
        __metadata("design:type", String)
    ], UserCtrlGetUsersRequest.prototype, "firstName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=last_name",
        }),
        __metadata("design:type", String)
    ], UserCtrlGetUsersRequest.prototype, "lastName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=login_name",
        }),
        __metadata("design:type", String)
    ], UserCtrlGetUsersRequest.prototype, "loginName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], UserCtrlGetUsersRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], UserCtrlGetUsersRequest.prototype, "pageSize", void 0);
...
var UserCtrlGetUsersResponse = /** @class */ (function (_super) {
    ...
    ], UserCtrlGetUsersResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
