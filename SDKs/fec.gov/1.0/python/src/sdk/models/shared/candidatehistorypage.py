...
class CandidateHistoryPage:
    ...
    results: Optional[list[shared_candidatehistory.CandidateHistory]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
