...
class YoutubePlaylistsInsertSecurity:
    option1: Optional[YoutubePlaylistsInsertSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubePlaylistsInsertSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[YoutubePlaylistsInsertSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class YoutubePlaylistsInsertRequest:
    query_params: YoutubePlaylistsInsertQueryParams = dataclasses.field()
    security: YoutubePlaylistsInsertSecurity = dataclasses.field()
    request: Optional[shared_playlist.Playlist] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
