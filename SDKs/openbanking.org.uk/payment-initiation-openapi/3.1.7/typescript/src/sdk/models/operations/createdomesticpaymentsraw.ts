...
export class CreateDomesticPaymentsRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateDomesticPaymentsRawRequest extends SpeakeasyBase {
  /**
...
export class CreateDomesticPaymentsRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
