...
public class GETListUsersRequest {
    ...
    public GETListUsersRequest withAction(GETListUsersActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETListUsersRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public GETListUsersRequest withMaxItems(Long maxItems) {
    ...
    public GETListUsersRequest withPathPrefix(String pathPrefix) {
    ...
    public GETListUsersRequest withVersion(GETListUsersVersionEnum version) {
    ...
    public GETListUsersRequest withXAmzAlgorithm(String xAmzAlgorithm) {
    ...
    public GETListUsersRequest withXAmzContentSha256(String xAmzContentSha256) {
    ...
    public GETListUsersRequest withXAmzCredential(String xAmzCredential) {
    ...
    public GETListUsersRequest withXAmzDate(String xAmzDate) {
    ...
    public GETListUsersRequest withXAmzSecurityToken(String xAmzSecurityToken) {
    ...
    public GETListUsersRequest withXAmzSignature(String xAmzSignature) {
    ...
    public GETListUsersRequest withXAmzSignedHeaders(String xAmzSignedHeaders) {
        this.xAmzSignedHeaders = xAmzSignedHeaders;
        return this;
    }
    
    public GETListUsersRequest(@JsonProperty("Action") GETListUsersActionEnum action, @JsonProperty("Version") GETListUsersVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
