...
export class GetEcRequest extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=penalty",
  })
  penalty?: number;
   ...
   *
   */
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=reqId" })
  reqId?: string;
}

export class GetEcResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
