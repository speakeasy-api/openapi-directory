...
class MessagingV1ServiceAlphaSender:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the AlphaSender resource."""  
    alpha_sender: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('alpha_sender'), 'exclude': lambda f: f is None }})
    r"""The Alphanumeric Sender ID string."""  
    ...
    r"""An array of values that describe whether the number can receive calls or messages. Can be: `SMS`."""  
    ...
    r"""The unique string that we created to identify the AlphaSender resource."""  
    url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('url'), 'exclude': lambda f: f is None }})
    r"""The absolute URL of the AlphaSender resource."""  
