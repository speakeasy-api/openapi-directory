...
class ListAccountsForProvisionedPermissionSetRequest:
    ...
    list_accounts_for_provisioned_permission_set_request: shared_listaccountsforprovisionedpermissionsetrequest.ListAccountsForProvisionedPermissionSetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
