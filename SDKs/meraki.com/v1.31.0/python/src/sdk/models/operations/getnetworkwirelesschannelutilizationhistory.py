...
class GetNetworkWirelessChannelUtilizationHistoryRequest:
    ...
    r"""Filter results by AP tag to return AP channel utilization metrics for devices labeled with the given tag; either :clientId or :deviceSerial must be jointly specified."""  
    ...
    r"""Filter results by network client to return per-device, per-band AP channel utilization metrics inner joined by the queried client's connection history."""  
    ...
    r"""Filter results by device to return AP channel utilization metrics for the queried device; either :band or :clientId must be jointly specified."""  
    ...
    r"""The time resolution in seconds for returned data. The valid resolutions are: 600, 1200, 3600, 14400, 86400. The default is 86400."""  
...
class GetNetworkWirelessChannelUtilizationHistory200ApplicationJSON:
    ...
    utilization80211: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('utilization80211'), 'exclude': lambda f: f is None }})
    r"""Average wifi utilization"""  
    utilization_non80211: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('utilizationNon80211'), 'exclude': lambda f: f is None }})
    r"""Average signal interference"""  
    utilization_total: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('utilizationTotal'), 'exclude': lambda f: f is None }})
    r"""Total channel utilization"""  
...
class GetNetworkWirelessChannelUtilizationHistoryResponse:
    ...
    get_network_wireless_channel_utilization_history_200_application_json_objects: Optional[list[GetNetworkWirelessChannelUtilizationHistory200ApplicationJSON]] = dataclasses.field(default=None)
