...
var ConfigPROXY = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "TCP_NODELAY" }),
        __metadata("design:type", Number)
    ], ConfigPROXY.prototype, "tcpNodelay", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "client_to_server" }),
        __metadata("design:type", String)
    ], ConfigPROXY.prototype, "clientToServer", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "disconnect_delay" }),
        __metadata("design:type", Number)
    ], ConfigPROXY.prototype, "disconnectDelay", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "max_connects" }),
        __metadata("design:type", Number)
    ], ConfigPROXY.prototype, "maxConnects", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "portno" }),
        __metadata("design:type", Number)
    ], ConfigPROXY.prototype, "portno", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "pre_connect" }),
        __metadata("design:type", String)
    ], ConfigPROXY.prototype, "preConnect", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "server_to_client" }),
        __metadata("design:type", String)
