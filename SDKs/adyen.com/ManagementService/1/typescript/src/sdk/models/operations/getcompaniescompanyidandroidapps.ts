...
export class GetCompaniesCompanyIdAndroidAppsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetCompaniesCompanyIdAndroidAppsRequest extends SpeakeasyBase {
  /**
...
export class GetCompaniesCompanyIdAndroidAppsResponse extends SpeakeasyBase {
  /**
