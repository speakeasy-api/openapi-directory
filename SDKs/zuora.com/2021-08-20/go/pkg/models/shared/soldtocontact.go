...
type SoldToContactOtherPhoneTypeEnum string

const (
	SoldToContactOtherPhoneTypeEnumWork   SoldToContactOtherPhoneTypeEnum = "Work"
	SoldToContactOtherPhoneTypeEnumMobile SoldToContactOtherPhoneTypeEnum = "Mobile"
	SoldToContactOtherPhoneTypeEnumHome   SoldToContactOtherPhoneTypeEnum = "Home"
	SoldToContactOtherPhoneTypeEnumOther  SoldToContactOtherPhoneTypeEnum = "Other"
)

func (e *SoldToContactOtherPhoneTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Home":
		fallthrough
	case "Other":
		*e = SoldToContactOtherPhoneTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for SoldToContactOtherPhoneTypeEnum: %s", s)
	}
}

// SoldToContact - Container for custom fields of a Contact object.
type SoldToContact struct {
	...
	//
	OtherPhoneType *SoldToContactOtherPhoneTypeEnum `json:"otherPhoneType,omitempty"`
