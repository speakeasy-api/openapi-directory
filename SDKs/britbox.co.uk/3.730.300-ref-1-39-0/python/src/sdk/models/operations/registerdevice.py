...
from ..shared import deviceregistrationrequest as shared_deviceregistrationrequest
...
class RegisterDeviceRequest:
    ...
    device_registration_request: shared_deviceregistrationrequest.DeviceRegistrationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
