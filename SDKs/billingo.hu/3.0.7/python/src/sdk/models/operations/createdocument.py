...
from ..shared import documentinsert as shared_documentinsert
...
class CreateDocumentRequest:
    request: shared_documentinsert.DocumentInsert = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
