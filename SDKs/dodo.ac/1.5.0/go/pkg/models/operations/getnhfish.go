...
type GetNhFishQueryParams struct {
...
type GetNhFishRequest struct {
	QueryParams GetNhFishQueryParams
	Headers     GetNhFishHeaders
}

type GetNhFishResponse struct {
	ContentType string
