...
exports.AudioFeaturesObject = void 0;
...
var AudioFeaturesObject = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=acousticness" }),
        __metadata("design:type", Number)
    ], AudioFeaturesObject.prototype, "acousticness", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=analysis_url" }),
        __metadata("design:type", String)
    ], AudioFeaturesObject.prototype, "analysisUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=danceability" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=instrumentalness" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=liveness" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=speechiness" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=track_href" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=valence" }),
        __metadata("design:type", Number)
    ], AudioFeaturesObject.prototype, "valence", void 0);
    return AudioFeaturesObject;
}(utils_1.SpeakeasyBase));
exports.AudioFeaturesObject = AudioFeaturesObject;
