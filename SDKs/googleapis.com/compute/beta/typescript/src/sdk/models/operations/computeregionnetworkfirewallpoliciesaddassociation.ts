...
export class ComputeRegionNetworkFirewallPoliciesAddAssociationSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ComputeRegionNetworkFirewallPoliciesAddAssociationSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ComputeRegionNetworkFirewallPoliciesAddAssociationSecurity extends SpeakeasyBase {
...
export class ComputeRegionNetworkFirewallPoliciesAddAssociationRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ComputeRegionNetworkFirewallPoliciesAddAssociationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
