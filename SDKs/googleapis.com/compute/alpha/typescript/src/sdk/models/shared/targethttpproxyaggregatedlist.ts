 ...
 */
export enum TargetHttpProxyAggregatedListWarningCodeEnum {
...
export class TargetHttpProxyAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetHttpProxyAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetHttpProxyAggregatedListWarningData })
  @Expose({ name: "data" })
