...
export class PrivatecaProjectsLocationsCertificateTemplatesPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PrivatecaProjectsLocationsCertificateTemplatesPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class PrivatecaProjectsLocationsCertificateTemplatesPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
