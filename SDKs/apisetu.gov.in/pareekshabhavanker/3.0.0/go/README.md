...
```bash
go get github.com/speakeasy-api/openapi-directory/SDKs/apisetu.gov.in/pareekshabhavanker/3.0.0/go
```
...
* [Sslcr](docs/apis/README.md#sslcr) - Class X School Leaving Certificate
