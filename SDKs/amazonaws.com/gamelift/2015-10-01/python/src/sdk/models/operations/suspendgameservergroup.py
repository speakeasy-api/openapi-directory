...
class SuspendGameServerGroupRequest:
    ...
    suspend_game_server_group_input: shared_suspendgameservergroupinput.SuspendGameServerGroupInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
