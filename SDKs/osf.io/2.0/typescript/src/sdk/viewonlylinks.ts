...
export class ViewOnlyLinks {
  ...
  viewOnlyLinksNodeList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ViewOnlyLinksNodeListResponse =
        new operations.ViewOnlyLinksNodeListResponse({
  ...
  viewOnlyLinksRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ViewOnlyLinksReadResponse =
        new operations.ViewOnlyLinksReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
