...
export class DatapipelinesProjectsLocationsPipelinesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatapipelinesProjectsLocationsPipelinesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatapipelinesProjectsLocationsPipelinesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
