...
class CreateContractResponse:
    ...
    links: Optional[shared_createcontractresponselinks.CreateContractResponseLinks] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('links'), 'exclude': lambda f: f is None }})  
