...
public class PostRouteOutputFormatRequest {
    ...
    public PostRouteOutputFormatRequest withCorrectSide(Boolean correctSide) {
    ...
    public PostRouteOutputFormatRequest withCriteria(PostRouteOutputFormatCriteriaEnum criteria) {
    ...
    public PostRouteOutputFormatRequest withDeparture(OffsetDateTime departure) {
    ...
    public PostRouteOutputFormatRequest withDisable(String disable) {
    ...
    public PostRouteOutputFormatRequest withDistanceUnit(PostRouteOutputFormatDistanceUnitEnum distanceUnit) {
    ...
    public PostRouteOutputFormatRequest withOutputFormat(PostRouteOutputFormatOutputFormatEnum outputFormat) {
    ...
    public PostRouteOutputFormatOutputSrsEnum outputSRS;

    public PostRouteOutputFormatRequest withOutputSRS(PostRouteOutputFormatOutputSrsEnum outputSRS) {
    ...
    public PostRouteOutputFormatRequest withPoints(String points) {
        this.points = points;
        return this;
    }
    ...
    public PostRouteOutputFormatRequest withRoundTrip(Boolean roundTrip) {
    ...
    public PostRouteOutputFormatRequest withRouteDescription(String routeDescription) {
        this.routeDescription = routeDescription;
        return this;
    }
    
    public PostRouteOutputFormatRequest(@JsonProperty("outputFormat") PostRouteOutputFormatOutputFormatEnum outputFormat, @JsonProperty("points") String points) {
        this.outputFormat = outputFormat;
        this.points = points;
  }
}
