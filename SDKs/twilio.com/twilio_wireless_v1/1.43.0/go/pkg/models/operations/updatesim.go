...
func (e UpdateSimUpdateSimRequestCommandsCallbackMethodEnum) ToPointer() *UpdateSimUpdateSimRequestCommandsCallbackMethodEnum {
	return &e
}
...
func (e *UpdateSimUpdateSimRequestCommandsCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateSimUpdateSimRequestCommandsCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateSimUpdateSimRequestCommandsCallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateSimUpdateSimRequestSmsFallbackMethodEnum) ToPointer() *UpdateSimUpdateSimRequestSmsFallbackMethodEnum {
	return &e
}
...
func (e *UpdateSimUpdateSimRequestSmsFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateSimUpdateSimRequestSmsFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateSimUpdateSimRequestSmsFallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateSimUpdateSimRequestSmsMethodEnum) ToPointer() *UpdateSimUpdateSimRequestSmsMethodEnum {
	return &e
}
...
func (e *UpdateSimUpdateSimRequestSmsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateSimUpdateSimRequestSmsMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateSimUpdateSimRequestSmsMethodEnum: %v", v)
	}
}
...
func (e UpdateSimUpdateSimRequestVoiceFallbackMethodEnum) ToPointer() *UpdateSimUpdateSimRequestVoiceFallbackMethodEnum {
	return &e
}
...
func (e *UpdateSimUpdateSimRequestVoiceFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateSimUpdateSimRequestVoiceFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateSimUpdateSimRequestVoiceFallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateSimUpdateSimRequestVoiceMethodEnum) ToPointer() *UpdateSimUpdateSimRequestVoiceMethodEnum {
	return &e
}
...
func (e *UpdateSimUpdateSimRequestVoiceMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateSimUpdateSimRequestVoiceMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateSimUpdateSimRequestVoiceMethodEnum: %v", v)
	}
}
