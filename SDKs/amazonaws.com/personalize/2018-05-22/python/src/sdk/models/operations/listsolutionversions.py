...
class ListSolutionVersionsRequest:
    ...
    list_solution_versions_request: shared_listsolutionversionsrequest.ListSolutionVersionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
