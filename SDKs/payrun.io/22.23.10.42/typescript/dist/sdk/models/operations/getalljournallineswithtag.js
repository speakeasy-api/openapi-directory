...
exports.GetAllJournalLinesWithTagResponse = exports.GetAllJournalLinesWithTagRequest = void 0;
...
var GetAllJournalLinesWithTagRequest = /** @class */ (function (_super) {
    ...
    ], GetAllJournalLinesWithTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetAllJournalLinesWithTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetAllJournalLinesWithTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetAllJournalLinesWithTagRequest.prototype, "tagId", void 0);
...
var GetAllJournalLinesWithTagResponse = /** @class */ (function (_super) {
    ...
    ], GetAllJournalLinesWithTagResponse.prototype, "rawResponse", void 0);
