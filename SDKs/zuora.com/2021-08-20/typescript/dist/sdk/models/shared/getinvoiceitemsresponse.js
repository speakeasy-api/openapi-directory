...
var GetInvoiceItemsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=invoiceItems" }),
        __metadata("design:type", Array)
    ], GetInvoiceItemsResponse.prototype, "invoiceItems", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=nextPage" }),
        __metadata("design:type", String)
    ], GetInvoiceItemsResponse.prototype, "nextPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=success" }),
        __metadata("design:type", Boolean)
    ], GetInvoiceItemsResponse.prototype, "success", void 0);
