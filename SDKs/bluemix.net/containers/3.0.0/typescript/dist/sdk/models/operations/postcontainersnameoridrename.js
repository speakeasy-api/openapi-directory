...
exports.PostContainersNameOrIdRenameResponse = exports.PostContainersNameOrIdRenameRequest = void 0;
...
var PostContainersNameOrIdRenameRequest = /** @class */ (function (_super) {
    ...
    ], PostContainersNameOrIdRenameRequest.prototype, "xAuthProjectId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Auth-Token",
        }),
        __metadata("design:type", String)
    ], PostContainersNameOrIdRenameRequest.prototype, "xAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], PostContainersNameOrIdRenameRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=name_or_id",
        }),
        __metadata("design:type", String)
    ], PostContainersNameOrIdRenameRequest.prototype, "nameOrId", void 0);
...
var PostContainersNameOrIdRenameResponse = /** @class */ (function (_super) {
    ...
    ], PostContainersNameOrIdRenameResponse.prototype, "rawResponse", void 0);
