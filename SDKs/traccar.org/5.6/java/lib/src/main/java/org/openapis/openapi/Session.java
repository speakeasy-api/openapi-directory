...
public class Session {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.PostSessionResponse postSession(org.openapis.openapi.models.operations.PostSessionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/session");
