 ...
 */
export declare enum ForwardingRuleListWarningCodeEnum {
...
export declare class ForwardingRuleListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ForwardingRuleListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: ForwardingRuleListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: ForwardingRuleListWarningData[];
    /**
 ...
 */
export declare class ForwardingRuleList extends SpeakeasyBase {
    /**
