...
export declare class Uk {
     ...
     *
     */
    addressCleanse(req: operations.AddressCleanseRequest, config?: AxiosRequestConfig): Promise<operations.AddressCleanseResponse>;
    /**
     * Extract Addresses
     *
     * @remarks
     ...
     *
     */
    addresses(req: operations.AddressesRequest, config?: AxiosRequestConfig): Promise<operations.AddressesResponse>;
    /**
     * Lookup Postcode
     *
     * @remarks
     ...
     *
     */
    postcodes(req: operations.PostcodesRequest, config?: AxiosRequestConfig): Promise<operations.PostcodesResponse>;
    /**
     * Retrieve by UDPRN
     *
     * @remarks
     ...
     * Test request undergo the usual authentication and restriction rules. This is to help surface any issues that occur during implementation and does not cost you a lookup.
     */
    udprn(req: operations.UDPRNRequest, config?: AxiosRequestConfig): Promise<operations.UDPRNResponse>;
    /**
     * Retrieve by UMPRN
     *
     * @remarks
     ...
     *
     */
    umprn(req: operations.UMPRNRequest, config?: AxiosRequestConfig): Promise<operations.UMPRNResponse>;
}
