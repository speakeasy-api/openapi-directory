...
from ..shared import facetinuseexception as shared_facetinuseexception
...
@dataclass_json
@dataclasses.dataclass
class DeleteFacetRequestBody:
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Name') }})
    

@dataclasses.dataclass
class DeleteFacetRequest:
    headers: DeleteFacetHeaders = dataclasses.field()
    request: DeleteFacetRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteFacetResponse:
    ...
    delete_facet_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    facet_in_use_exception: Optional[shared_facetinuseexception.FacetInUseException] = dataclasses.field(default=None)
