...
export class FindKeywordLeaseConfigsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FindKeywordLeaseConfigsRequest extends SpeakeasyBase {
  /**
...
export class FindKeywordLeaseConfigsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
