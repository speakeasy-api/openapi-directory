...
export class GetSearchCarRecentsQueryParams extends SpeakeasyBase {
...
export class GetSearchCarRecentsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: GetSearchCarRecentsQueryParams;
}


export class GetSearchCarRecentsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
