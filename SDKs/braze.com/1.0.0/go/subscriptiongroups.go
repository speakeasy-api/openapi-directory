...
func NewSubscriptionGroups(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *SubscriptionGroups {
...
func (s *SubscriptionGroups) ListUserSSubscriptionGroupSms(ctx context.Context, request operations.ListUserSSubscriptionGroupSmsRequest) (*operations.ListUserSSubscriptionGroupSmsResponse, error) {
...
//
// ```
func (s *SubscriptionGroups) ListUserSSubscriptionGroupStatusSms(ctx context.Context, request operations.ListUserSSubscriptionGroupStatusSmsRequest) (*operations.ListUserSSubscriptionGroupStatusSmsResponse, error) {
	baseURL := s._serverURL
