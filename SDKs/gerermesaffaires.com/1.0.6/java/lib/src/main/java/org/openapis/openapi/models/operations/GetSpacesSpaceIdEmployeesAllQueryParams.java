...
public class GetSpacesSpaceIdEmployeesAllQueryParams {
    /**
     * EmployeeNumber of the employee
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=EmployeeNumber")
    public String employeeNumber;
    public GetSpacesSpaceIdEmployeesAllQueryParams withEmployeeNumber(String employeeNumber) {
    ...
    public GetSpacesSpaceIdEmployeesAllQueryParams withSSNumber(String ssNumber) {
    ...
    public GetSpacesSpaceIdEmployeesAllQueryParams withWithContractingPartner(String withContractingPartner) {
