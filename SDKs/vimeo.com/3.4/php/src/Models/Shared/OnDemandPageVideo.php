...
class OnDemandPageVideo
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoContext $context
     */
	#[\JMS\Serializer\Annotation\SerializedName('context')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoContext')]
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoLicenseEnum $license
     */
	#[\JMS\Serializer\Annotation\SerializedName('license')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoLicenseEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoMetadata $metadata
     */
	#[\JMS\Serializer\Annotation\SerializedName('metadata')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoMetadata')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoProject $parentFolder
     */
	#[\JMS\Serializer\Annotation\SerializedName('parent_folder')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoProject')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OnDemandPageVideoProject $parentFolder = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoPrivacy $privacy
     */
	#[\JMS\Serializer\Annotation\SerializedName('privacy')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoPrivacy')]
     ...
     * 360 spatial data.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoSpatial $spatial
     */
	#[\JMS\Serializer\Annotation\SerializedName('spatial')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoSpatial')]
    public OnDemandPageVideoSpatial $spatial;
    
    /**
     * A collection of stats associated with this video.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoStats $stats
     */
	#[\JMS\Serializer\Annotation\SerializedName('stats')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoStats')]
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoStatusEnum $status
     */
	#[\JMS\Serializer\Annotation\SerializedName('status')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoStatusEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoTranscode $transcode
     */
	#[\JMS\Serializer\Annotation\SerializedName('transcode')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoTranscode')]
    public OnDemandPageVideoTranscode $transcode;
    
    /**
     * The upload information for this video.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUpload $upload
     */
	#[\JMS\Serializer\Annotation\SerializedName('upload')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUpload')]
     ...
     * The video owner.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUser $user
     */
	#[\JMS\Serializer\Annotation\SerializedName('user')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUser')]
	...
	public function __construct()
	{
		$this->categories = [];
		$this->contentRating = [];
		$this->context = new \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoContext();
		$this->createdTime = "";
		$this->description = "";
		$this->duration = 0;
		...
		$this->license = \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoLicenseEnum::BY;
		$this->link = "";
		$this->metadata = new \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoMetadata();
		$this->modifiedTime = "";
		$this->name = "";
		$this->parentFolder = null;
		$this->password = null;
		$this->pictures = new \OpenAPI\OpenAPI\Models\Shared\Picture();
		$this->privacy = new \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoPrivacy();
		$this->releaseTime = "";
		$this->resourceKey = "";
		$this->spatial = new \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoSpatial();
		$this->stats = new \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoStats();
		$this->status = \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoStatusEnum::AVAILABLE;
		$this->tags = [];
		$this->transcode = new \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoTranscode();
		$this->upload = new \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUpload();
		$this->uri = "";
		$this->user = new \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUser();
		$this->width = 0;
	}
}
