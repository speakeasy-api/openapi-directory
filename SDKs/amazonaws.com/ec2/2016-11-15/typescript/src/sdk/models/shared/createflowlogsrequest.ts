 ...
 */
export enum CreateFlowLogsRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateFlowLogsRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateFlowLogsRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateFlowLogsRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateFlowLogsRequestTagSpecificationsTags })
  tags?: CreateFlowLogsRequestTagSpecificationsTags[];
}

export class CreateFlowLogsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken?: string;
  ...
  @SpeakeasyMetadata({ elemType: CreateFlowLogsRequestTagSpecifications })
