...
class CreateImageBuilderStreamingURLResult:
    ...
    streaming_url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StreamingURL'), 'exclude': lambda f: f is None }})  
