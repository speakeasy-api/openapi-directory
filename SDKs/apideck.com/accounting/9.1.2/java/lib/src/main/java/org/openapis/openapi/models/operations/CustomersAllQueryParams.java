...
public class CustomersAllQueryParams {
    ...
    public CustomersAllQueryParams withFilter(org.openapis.openapi.models.shared.CustomersFilter filter) {
        this.filter = filter;
        return this;
    }
    ...
    public CustomersAllQueryParams withPassThrough(java.util.Map<String, Object> passThrough) {
