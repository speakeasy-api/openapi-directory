...
class DescribeNetworkInsightsAccessScopeAnalysesRequestFilters:
...
class DescribeNetworkInsightsAccessScopeAnalysesRequest:
    ...
    analysis_start_time_begin: Optional[datetime] = dataclasses.field(default=None)  
    analysis_start_time_end: Optional[datetime] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeNetworkInsightsAccessScopeAnalysesRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    network_insights_access_scope_analysis_ids: Optional[list[str]] = dataclasses.field(default=None)  
