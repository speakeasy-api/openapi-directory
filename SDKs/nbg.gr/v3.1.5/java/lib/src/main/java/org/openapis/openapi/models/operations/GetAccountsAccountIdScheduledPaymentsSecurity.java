...
public class GetAccountsAccountIdScheduledPaymentsSecurity {
    ...
    public GetAccountsAccountIdScheduledPaymentsSecurity(@JsonProperty("Authorization-Code-Token") String authorizationCodeToken, @JsonProperty("Client-Id") String clientId) {
        this.authorizationCodeToken = authorizationCodeToken;
        this.clientId = clientId;
  }
}
