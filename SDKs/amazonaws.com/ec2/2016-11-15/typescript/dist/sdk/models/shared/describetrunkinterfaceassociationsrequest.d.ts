 ...
 */
export declare class DescribeTrunkInterfaceAssociationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTrunkInterfaceAssociationsRequest extends SpeakeasyBase {
