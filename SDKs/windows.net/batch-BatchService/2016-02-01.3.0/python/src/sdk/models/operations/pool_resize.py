...
from ..shared import poolresizeparameter as shared_poolresizeparameter
from typing import Optional


@dataclasses.dataclass
class PoolResizeRequest:
    ...
    r"""The id of the pool to resize."""  
    pool_resize_parameter: shared_poolresizeparameter.PoolResizeParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
