...
class ConferenceKickResponseMessageEnum(str, Enum):
    r"""Response message"""
...
class ConferenceKickResponse:
    ...
    message: ConferenceKickResponseMessageEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Message') }})
    r"""Response message"""  
