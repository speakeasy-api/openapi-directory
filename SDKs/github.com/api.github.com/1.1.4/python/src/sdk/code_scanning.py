...
class CodeScanning:
    ...
    def code_scanning_list_alerts_instances(self, request: operations.CodeScanningListAlertsInstancesRequest) -> operations.CodeScanningListAlertsInstancesResponse:
        ...
        res = operations.CodeScanningListAlertsInstancesResponse(status_code=r.status_code, content_type=content_type)
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.CodeScanningListAlertsInstances503ApplicationJSON])
                res.code_scanning_list_alerts_instances_503_application_json_object = out
