...
type GetOrganizationClientsBandwidthUsageHistoryPathParams struct {
...
type GetOrganizationClientsBandwidthUsageHistoryRequest struct {
	PathParams  GetOrganizationClientsBandwidthUsageHistoryPathParams
	QueryParams GetOrganizationClientsBandwidthUsageHistoryQueryParams
}
