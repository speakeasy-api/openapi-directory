...
class BalanceSheet:
    ...
    def balance_sheet_one(self, request: operations.BalanceSheetOneRequest, security: operations.BalanceSheetOneSecurity) -> operations.BalanceSheetOneResponse:
        r"""Get BalanceSheet
        Get BalanceSheet
        """
        ...
        query_params = utils.get_query_params(operations.BalanceSheetOneRequest, request)
        ...
        res = operations.BalanceSheetOneResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetBalanceSheetResponse])
