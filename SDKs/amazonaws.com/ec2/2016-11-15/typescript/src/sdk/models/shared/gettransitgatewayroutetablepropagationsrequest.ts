 ...
 */
export class GetTransitGatewayRouteTablePropagationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class GetTransitGatewayRouteTablePropagationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({
    elemType: GetTransitGatewayRouteTablePropagationsRequestFilters,
  })
