...
class OpenIDIdpConfig:
    r"""OpenID Connect IDP configuration"""
    ...
    flow: Optional[OpenIDIdpConfigFlowEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flow'), 'exclude': lambda f: f is None }})
    r"""&#128640; Since v4.11.0
    ...
    user_info_source: Optional[OpenIDIdpConfigUserInfoSourceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('userInfoSource'), 'exclude': lambda f: f is None }})
    r"""&#128640; Since v4.23.0
