...
enum InboundCardAuthorizationSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineNetworkDetailsVisaPointOfServiceEntryModeEnum: string
{
    case MANUAL = 'manual';
