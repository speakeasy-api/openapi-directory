 ...
 */
export class DescribeVerifiedAccessGroupsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeVerifiedAccessGroupsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeVerifiedAccessGroupsRequestFilters })
