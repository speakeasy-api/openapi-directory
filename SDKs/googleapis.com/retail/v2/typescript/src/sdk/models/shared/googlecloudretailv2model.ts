 ...
 */
export enum GoogleCloudRetailV2ModelDataStateEnum {
 ...
 */
export enum GoogleCloudRetailV2ModelFilteringOptionEnum {
 ...
 */
export enum GoogleCloudRetailV2ModelPeriodicTuningStateEnum {
 ...
 */
export enum GoogleCloudRetailV2ModelServingStateEnum {
 ...
 */
export enum GoogleCloudRetailV2ModelTrainingStateEnum {
 ...
 */
export class GoogleCloudRetailV2Model extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2ModelServingConfigList })
 ...
 * Metadata that describes the training and serving parameters of a Model. A Model can be associated with a ServingConfig and then queried through the Predict API.
 */
export class GoogleCloudRetailV2ModelInput extends SpeakeasyBase {
  /**
   * Required. The display name of the model. Should be human readable, used to display Recommendation Models in the Retail Cloud Console Dashboard. UTF-8 encoded string with limit of 1024 characters.
   */
  @SpeakeasyMetadata()
