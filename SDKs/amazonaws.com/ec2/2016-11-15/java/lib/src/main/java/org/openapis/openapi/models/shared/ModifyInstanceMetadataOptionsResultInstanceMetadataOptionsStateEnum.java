 ...
 */
public enum ModifyInstanceMetadataOptionsResultInstanceMetadataOptionsStateEnum {
    PENDING("pending"),
    APPLIED("applied");
    ...
    private ModifyInstanceMetadataOptionsResultInstanceMetadataOptionsStateEnum(String value) {
        this.value = value;
    }
}
