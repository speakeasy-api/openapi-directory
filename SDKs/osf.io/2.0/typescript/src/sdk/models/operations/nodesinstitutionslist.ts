 ...
 */
export class NodesInstitutionsListInstitutionAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class NodesInstitutionsListInstitutionLinks extends SpeakeasyBase {
  /**
 ...
 */
export class NodesInstitutionsListInstitutionRelationships extends SpeakeasyBase {
  /**
...
export class NodesInstitutionsListInstitution extends SpeakeasyBase {
  /**
   * The properties of the institution entity.
   */
  @SpeakeasyMetadata()
