...
exports.StoryIdGetResponse = exports.StoryIdGetRequest = exports.StoryIdGetQueryParams = exports.StoryIdGetPathParams = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var StoryIdGetPathParams = /** @class */ (function (_super) {
    __extends(StoryIdGetPathParams, _super);
    function StoryIdGetPathParams() {
...
exports.StoryIdGetPathParams = StoryIdGetPathParams;
var StoryIdGetQueryParams = /** @class */ (function (_super) {
    __extends(StoryIdGetQueryParams, _super);
    function StoryIdGetQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=full" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=include_relationships" }),
        __metadata("design:type", Boolean)
    ], StoryIdGetQueryParams.prototype, "includeRelationships", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=refresh_cache" }),
        __metadata("design:type", Boolean)
    ], StoryIdGetQueryParams.prototype, "refreshCache", void 0);
    return StoryIdGetQueryParams;
}(utils_1.SpeakeasyBase));
exports.StoryIdGetQueryParams = StoryIdGetQueryParams;
var StoryIdGetRequest = /** @class */ (function (_super) {
    __extends(StoryIdGetRequest, _super);
    function StoryIdGetRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
exports.StoryIdGetRequest = StoryIdGetRequest;
var StoryIdGetResponse = /** @class */ (function (_super) {
    __extends(StoryIdGetResponse, _super);
    function StoryIdGetResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.StoryIdGetResponse = StoryIdGetResponse;
