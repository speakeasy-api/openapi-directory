...
var GoogleAppsDriveLabelsV2betaLabelLimits = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "fieldLimits" }),
        (0, class_transformer_1.Type)(function () { return googleappsdrivelabelsv2betafieldlimits_1.GoogleAppsDriveLabelsV2betaFieldLimits; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maxDeletedFields" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maxDraftRevisions" }),
        __metadata("design:type", Number)
    ], GoogleAppsDriveLabelsV2betaLabelLimits.prototype, "maxDraftRevisions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maxFields" }),
        __metadata("design:type", Number)
    ], GoogleAppsDriveLabelsV2betaLabelLimits.prototype, "maxFields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maxTitleLength" }),
        __metadata("design:type", Number)
