...
class CandidateDetailPage:
    ...
    results: Optional[list[shared_candidatedetail.CandidateDetail]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
