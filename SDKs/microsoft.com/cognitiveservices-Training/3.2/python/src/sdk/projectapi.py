...
class ProjectAPI:
    ...
    def export_project(self, request: operations.ExportProjectRequest) -> operations.ExportProjectResponse:
        ...
        url = utils.generate_url(operations.ExportProjectRequest, base_url, '/projects/{projectId}/export', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ProjectExport])
    ...
    def import_project(self, request: operations.ImportProjectRequest) -> operations.ImportProjectResponse:
        ...
        query_params = utils.get_query_params(operations.ImportProjectRequest, request)
        ...
        res = operations.ImportProjectResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def train_project_form(self, request: operations.TrainProjectFormRequest) -> operations.TrainProjectFormResponse:
        r"""Queues project for training."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.TrainProjectFormRequest, base_url, '/projects/{projectId}/train', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "training_parameters", 'form')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.TrainProjectFormRequest, request)
        ...
        res = operations.TrainProjectFormResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def train_project_json(self, request: operations.TrainProjectJSONRequest) -> operations.TrainProjectJSONResponse:
        r"""Queues project for training."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.TrainProjectJSONRequest, base_url, '/projects/{projectId}/train', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "training_parameters", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.TrainProjectJSONRequest, request)
        ...
        res = operations.TrainProjectJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def train_project_raw(self, request: operations.TrainProjectRawRequest) -> operations.TrainProjectRawResponse:
        r"""Queues project for training."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.TrainProjectRawRequest, base_url, '/projects/{projectId}/train', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "request_body", 'raw')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.TrainProjectRawRequest, request)
        ...
        res = operations.TrainProjectRawResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
