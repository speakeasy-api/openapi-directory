 ...
 */
export declare class DescribeNetworkAclsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeNetworkAclsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeNetworkAclsRequestFilters[];
    maxResults?: number;
