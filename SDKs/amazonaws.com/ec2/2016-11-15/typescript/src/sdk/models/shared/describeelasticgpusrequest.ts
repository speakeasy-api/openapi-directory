 ...
 */
export class DescribeElasticGpusRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeElasticGpusRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
  ...
  @SpeakeasyMetadata({ elemType: DescribeElasticGpusRequestFilters })
  filters?: DescribeElasticGpusRequestFilters[];
