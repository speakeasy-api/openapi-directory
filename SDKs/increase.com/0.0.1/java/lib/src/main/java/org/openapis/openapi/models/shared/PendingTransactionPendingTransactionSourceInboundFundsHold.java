 ...
 */
public class PendingTransactionPendingTransactionSourceInboundFundsHold {
    /**
     * The held amount in the minor unit of the account's currency. For dollars, for example, this is cents.
     */
    @JsonProperty("amount")
    public Long amount;
    public PendingTransactionPendingTransactionSourceInboundFundsHold withAmount(Long amount) {
        this.amount = amount;
        return this;
    }
    ...
    public PendingTransactionPendingTransactionSourceInboundFundsHold withAutomaticallyReleasesAt(OffsetDateTime automaticallyReleasesAt) {
    ...
    public PendingTransactionPendingTransactionSourceInboundFundsHold withCurrency(PendingTransactionPendingTransactionSourceInboundFundsHoldCurrencyEnum currency) {
    ...
    public PendingTransactionPendingTransactionSourceInboundFundsHold withHeldTransactionId(String heldTransactionId) {
    ...
    public PendingTransactionPendingTransactionSourceInboundFundsHold withReleasedAt(OffsetDateTime releasedAt) {
    ...
    public PendingTransactionPendingTransactionSourceInboundFundsHold withStatus(PendingTransactionPendingTransactionSourceInboundFundsHoldStatusEnum status) {
        this.status = status;
        return this;
    }
