...
type GkeonpremProjectsLocationsVmwareClustersVmwareNodePoolsCreateSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type GkeonpremProjectsLocationsVmwareClustersVmwareNodePoolsCreateRequest struct {
	// V1 error format.
	...
	VmwareNodePoolID *string `queryParam:"style=form,explode=true,name=vmwareNodePoolId"`
}

type GkeonpremProjectsLocationsVmwareClustersVmwareNodePoolsCreateResponse struct {
	ContentType string
	// Successful response
