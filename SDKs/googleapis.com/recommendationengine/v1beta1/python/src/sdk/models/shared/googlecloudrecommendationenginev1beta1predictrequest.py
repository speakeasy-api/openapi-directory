...
class GoogleCloudRecommendationengineV1beta1PredictRequest:
    r"""GoogleCloudRecommendationengineV1beta1PredictRequest
    ...
    user_event: Optional[shared_googlecloudrecommendationenginev1beta1userevent.GoogleCloudRecommendationengineV1beta1UserEvent] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('userEvent') }})
