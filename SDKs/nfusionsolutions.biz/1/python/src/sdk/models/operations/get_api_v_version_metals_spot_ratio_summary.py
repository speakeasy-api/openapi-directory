...
class GetAPIVVersionMetalsSpotRatioSummaryRequest:
    path_params: GetAPIVVersionMetalsSpotRatioSummaryPathParams = dataclasses.field()
    query_params: GetAPIVVersionMetalsSpotRatioSummaryQueryParams = dataclasses.field()
