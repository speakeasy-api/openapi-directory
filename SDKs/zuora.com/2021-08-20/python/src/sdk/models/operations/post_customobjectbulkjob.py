...
class POSTCustomObjectBulkJobRequest:
    ...
    custom_object_bulk_job_request: shared_customobjectbulkjobrequest.CustomObjectBulkJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
