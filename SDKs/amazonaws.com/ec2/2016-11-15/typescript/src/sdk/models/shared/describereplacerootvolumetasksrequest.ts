 ...
 */
export class DescribeReplaceRootVolumeTasksRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeReplaceRootVolumeTasksRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeReplaceRootVolumeTasksRequestFilters })
