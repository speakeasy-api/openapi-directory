...
var Autocomplete = /** @class */ (function () {
     ...
     */
    Autocomplete.prototype.autoComplete = function (req, serverURL, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AutoCompleteRequest(req);
        }
        var baseURL = operations.AutoCompleteServerList[0];
        if (serverURL) {
            baseURL = serverURL;
        }
        var url = baseURL.replace(/\/$/, "") + "/buscaautocomplete";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.theRootSchema = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.AutoCompleteTheRootSchema);
                    }
                    break;
            }
            return res;
