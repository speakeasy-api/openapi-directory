...
class GetDescribeAnalysisSchemesQueryParams:
    action: GetDescribeAnalysisSchemesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    domain_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'DomainName', 'style': 'form', 'explode': True }})
    version: GetDescribeAnalysisSchemesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    analysis_scheme_names: Optional[list[str]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'AnalysisSchemeNames', 'style': 'form', 'explode': True }})
...
class GetDescribeAnalysisSchemesRequest:
    headers: GetDescribeAnalysisSchemesHeaders = dataclasses.field()
    query_params: GetDescribeAnalysisSchemesQueryParams = dataclasses.field()
