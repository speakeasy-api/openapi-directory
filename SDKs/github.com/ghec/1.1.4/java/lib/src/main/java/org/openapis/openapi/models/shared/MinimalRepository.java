...
public class MinimalRepository {
    ...
    public MinimalRepository withHasDiscussions(Boolean hasDiscussions) {
    ...
    public MinimalRepository withRoleName(String roleName) {
    ...
    public MinimalRepository withSecurityAndAnalysis(SecurityAndAnalysis securityAndAnalysis) {
    ...
    public MinimalRepository withWebCommitSignoffRequired(Boolean webCommitSignoffRequired) {
