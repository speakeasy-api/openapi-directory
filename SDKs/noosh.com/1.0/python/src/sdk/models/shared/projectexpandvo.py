...
import dataclasses
from ..shared import projectdetailvo as shared_projectdetailvo
...
class ProjectExpandVO:
    r"""Java type: com.noosh.nooshapi.vo.ProjectExpandVO"""
    
    result: Optional[shared_projectdetailvo.ProjectDetailVO] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})
