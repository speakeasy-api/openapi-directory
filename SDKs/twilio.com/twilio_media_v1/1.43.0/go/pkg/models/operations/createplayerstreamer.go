...
func (e CreatePlayerStreamerCreatePlayerStreamerRequestStatusCallbackMethodEnum) ToPointer() *CreatePlayerStreamerCreatePlayerStreamerRequestStatusCallbackMethodEnum {
	return &e
}
...
func (e *CreatePlayerStreamerCreatePlayerStreamerRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreatePlayerStreamerCreatePlayerStreamerRequestStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreatePlayerStreamerCreatePlayerStreamerRequestStatusCallbackMethodEnum: %v", v)
	}
}
