 ...
 */
export declare class UpdateFindingsRequestBodyFilters extends SpeakeasyBase {
 ...
 * The updated note.
 */
export declare class UpdateFindingsRequestBodyNote extends SpeakeasyBase {
    text?: string;
    updatedBy?: string;
}
/**
 ...
 */
export declare enum UpdateFindingsRequestBodyRecordStateEnum {
    Active = "ACTIVE",
    Archived = "ARCHIVED"
}
