...
class UpdateNsxvManagerRequest:
    ...
    r"""entity id"""  
    nsxv_manager_data_source: Optional[shared_nsxvmanagerdatasource.NSXVManagerDataSource] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
