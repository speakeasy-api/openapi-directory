...
// SendMessageRequestBody5TextViberServiceAction
// Node for Viber action buttons.
type SendMessageRequestBody5TextViberServiceAction struct {
...
type SendMessageRequestBody5TextViberService struct {
	Action   *SendMessageRequestBody5TextViberServiceAction       `json:"action,omitempty"`
...
// SendMessageRequestBody5ImageViberServiceAction
// Node for Viber action buttons.
type SendMessageRequestBody5ImageViberServiceAction struct {
	Text *string `json:"text,omitempty"`
	URL  *string `json:"url,omitempty"`
}
...
type SendMessageRequestBody5ImageViberService struct {
	Action   *SendMessageRequestBody5ImageViberServiceAction       `json:"action,omitempty"`
...
type SendMessageRequestBody5VideoChannelEnum string

const (
	SendMessageRequestBody5VideoChannelEnumViberService SendMessageRequestBody5VideoChannelEnum = "viber_service"
)

type SendMessageRequestBody5VideoMessageTypeEnum string

const (
	SendMessageRequestBody5VideoMessageTypeEnumVideo SendMessageRequestBody5VideoMessageTypeEnum = "video"
)

type SendMessageRequestBody5VideoViberServiceCategoryEnum string

const (
	SendMessageRequestBody5VideoViberServiceCategoryEnumTransaction SendMessageRequestBody5VideoViberServiceCategoryEnum = "transaction"
	SendMessageRequestBody5VideoViberServiceCategoryEnumPromotion   SendMessageRequestBody5VideoViberServiceCategoryEnum = "promotion"
)

type SendMessageRequestBody5VideoViberService struct {
	Category *SendMessageRequestBody5VideoViberServiceCategoryEnum `json:"category,omitempty"`
...
type SendMessageRequestBody5Video struct {
	Channel      SendMessageRequestBody5VideoChannelEnum     `json:"channel"`
	ClientRef    *string                                     `json:"client_ref,omitempty"`
	From         string                                      `json:"from"`
	MessageType  SendMessageRequestBody5VideoMessageTypeEnum `json:"message_type"`
	To           string                                      `json:"to"`
	ViberService *SendMessageRequestBody5VideoViberService   `json:"viber_service,omitempty"`
	Video        interface{}                                 `json:"video"`
}

type SendMessageRequestBody5FileChannelEnum string

const (
	SendMessageRequestBody5FileChannelEnumViberService SendMessageRequestBody5FileChannelEnum = "viber_service"
)
...
type SendMessageRequestBody5FileViberServiceCategoryEnum string

const (
	SendMessageRequestBody5FileViberServiceCategoryEnumTransaction SendMessageRequestBody5FileViberServiceCategoryEnum = "transaction"
	SendMessageRequestBody5FileViberServiceCategoryEnumPromotion   SendMessageRequestBody5FileViberServiceCategoryEnum = "promotion"
)

type SendMessageRequestBody5FileViberService struct {
	Category *SendMessageRequestBody5FileViberServiceCategoryEnum `json:"category,omitempty"`
	TTL      *int64                                               `json:"ttl,omitempty"`
	Type     *string                                              `json:"type,omitempty"`
}

type SendMessageRequestBody5File struct {
	Channel      SendMessageRequestBody5FileChannelEnum     `json:"channel"`
	ClientRef    *string                                    `json:"client_ref,omitempty"`
	File         interface{}                                `json:"file"`
	From         string                                     `json:"from"`
	MessageType  SendMessageRequestBody5FileMessageTypeEnum `json:"message_type"`
	To           string                                     `json:"to"`
	ViberService *SendMessageRequestBody5FileViberService   `json:"viber_service,omitempty"`
}
