...
class DoubleclicksearchReportsGetIDMappingFileRequest:
    path_params: DoubleclicksearchReportsGetIDMappingFilePathParams = dataclasses.field()
    query_params: DoubleclicksearchReportsGetIDMappingFileQueryParams = dataclasses.field()
    security: DoubleclicksearchReportsGetIDMappingFileSecurity = dataclasses.field()
...
class DoubleclicksearchReportsGetIDMappingFileResponse:
    ...
    id_mapping_file: Optional[dict[str, Any]] = dataclasses.field(default=None)
