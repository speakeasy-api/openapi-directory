...
class AccesscontextmanagerOrganizationsGcpUserAccessBindingsPatchRequest:
    ...
    gcp_user_access_binding: Optional[shared_gcpuseraccessbinding.GcpUserAccessBinding] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    ...
    r"""Required. Only the fields specified in this mask are updated. Because name and group_key cannot be changed, update_mask is required and may only contain the following fields: `access_levels`, `dry_run_access_levels`. update_mask { paths: \\"access_levels\\" }"""  
