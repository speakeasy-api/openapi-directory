...
class CreateInstanceEventWindowRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateInstanceEventWindowRequestTagSpecifications:
    ...
    resource_type: Optional[CreateInstanceEventWindowRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateInstanceEventWindowRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateInstanceEventWindowRequest:
    ...
    tag_specifications: Optional[list[CreateInstanceEventWindowRequestTagSpecifications]] = dataclasses.field(default=None)  
