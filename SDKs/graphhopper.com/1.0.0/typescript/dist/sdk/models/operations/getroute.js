...
exports.GetRouteResponse = exports.GetRouteRequest = exports.GetRouteQueryParams = exports.GetRouteCurbsideEnum = exports.GetRouteAlgorithmEnum = void 0;
...
var GetRouteQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=algorithm" }),
        __metadata("design:type", String)
    ], GetRouteQueryParams.prototype, "algorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alternative_route.max_paths" }),
        __metadata("design:type", Number)
    ], GetRouteQueryParams.prototype, "alternativeRouteMaxPaths", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alternative_route.max_share_factor" }),
        __metadata("design:type", Number)
    ], GetRouteQueryParams.prototype, "alternativeRouteMaxShareFactor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alternative_route.max_weight_factor" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=block_area" }),
        __metadata("design:type", String)
    ], GetRouteQueryParams.prototype, "blockArea", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=calc_points" }),
        __metadata("design:type", Boolean)
    ], GetRouteQueryParams.prototype, "calcPoints", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ch.disable" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=heading_penalty" }),
        __metadata("design:type", Number)
    ], GetRouteQueryParams.prototype, "headingPenalty", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=instructions" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=optimize" }),
        __metadata("design:type", String)
    ], GetRouteQueryParams.prototype, "optimize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=pass_through" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=points_encoded" }),
        __metadata("design:type", Boolean)
    ], GetRouteQueryParams.prototype, "pointsEncoded", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=round_trip.distance" }),
        __metadata("design:type", Number)
    ], GetRouteQueryParams.prototype, "roundTripDistance", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=round_trip.seed" }),
        __metadata("design:type", Number)
...
exports.GetRouteQueryParams = GetRouteQueryParams;
