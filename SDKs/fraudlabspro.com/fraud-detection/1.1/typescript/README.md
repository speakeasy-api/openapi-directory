...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/fraudlabspro.com/fraud-detection/1.1/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/fraudlabspro.com/fraud-detection/1.1/typescript
```
