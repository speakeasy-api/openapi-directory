...
var Account = /** @class */ (function () {
     ...
     */
    Account.prototype.accountCreate = function (req, security, config) {
        var _a;
     ...
     */
    Account.prototype.accountCreateAnonymousSession = function (config) {
        var baseURL = this._serverURL;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.AccountCreateAnonymousSessionResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     */
    Account.prototype.accountCreateJWT = function (config) {
        var baseURL = this._serverURL;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.AccountCreateJWTResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.jwt = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.Jwt);
                    }
                    break;
            }
            return res;
     ...
     *
     */
    Account.prototype.accountCreateOAuth2Session = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AccountCreateOAuth2SessionRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/account/sessions/oauth2/{provider}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.AccountCreateOAuth2SessionResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     */
    Account.prototype.accountCreateSession = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.AccountCreateSessionResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
