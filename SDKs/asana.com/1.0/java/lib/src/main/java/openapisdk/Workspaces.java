...
public class Workspaces {
    ...
    **/
    public openapisdk.models.operations.AddUserForWorkspaceResponse addUserForWorkspace(openapisdk.models.operations.AddUserForWorkspaceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/workspaces/{workspace_gid}/addUser", request.pathParams);
        ...
        openapisdk.models.operations.AddUserForWorkspaceResponse res = new openapisdk.models.operations.AddUserForWorkspaceResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.operations.AddUserForWorkspace200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.AddUserForWorkspace200ApplicationJson.class);
    ...
    **/
    public openapisdk.models.operations.GetWorkspaceResponse getWorkspace(openapisdk.models.operations.GetWorkspaceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/workspaces/{workspace_gid}", request.pathParams);
    ...
    public openapisdk.models.operations.GetWorkspacesResponse getWorkspaces(openapisdk.models.operations.GetWorkspacesRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.GetWorkspaces200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetWorkspaces200ApplicationJson.class);
    ...
    **/
    public openapisdk.models.operations.RemoveUserForWorkspaceResponse removeUserForWorkspace(openapisdk.models.operations.RemoveUserForWorkspaceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/workspaces/{workspace_gid}/removeUser", request.pathParams);
        ...
        openapisdk.models.operations.RemoveUserForWorkspaceResponse res = new openapisdk.models.operations.RemoveUserForWorkspaceResponse() {{
        ...
        if (httpRes.statusCode() == 204) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.RemoveUserForWorkspace204ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.RemoveUserForWorkspace204ApplicationJson.class);
