...
class SheetsSpreadsheetsValuesBatchClearByDataFilterRequest:
    ...
    batch_clear_values_by_data_filter_request: Optional[shared_batchclearvaluesbydatafilterrequest.BatchClearValuesByDataFilterRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
