...
from ..shared import workgroupexpandvo as shared_workgroupexpandvo
...
class GetWorkgroupDetailResponse:
    ...
    workgroup_expand_vo: Optional[shared_workgroupexpandvo.WorkgroupExpandVO] = dataclasses.field(default=None)
