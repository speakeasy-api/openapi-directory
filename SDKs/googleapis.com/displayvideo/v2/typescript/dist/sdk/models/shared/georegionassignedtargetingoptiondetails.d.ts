 ...
 */
export declare enum GeoRegionAssignedTargetingOptionDetailsGeoRegionTypeEnum {
 ...
 */
export declare class GeoRegionAssignedTargetingOptionDetails extends SpeakeasyBase {
    /**
 ...
 * Details for assigned geographic region targeting option. This will be populated in the details field of an AssignedTargetingOption when targeting_type is `TARGETING_TYPE_GEO_REGION`.
 */
export declare class GeoRegionAssignedTargetingOptionDetailsInput extends SpeakeasyBase {
    /**
     * Indicates if this option is being negatively targeted.
     */
    negative?: boolean;
