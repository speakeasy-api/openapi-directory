...
var DataFlow = /** @class */ (function () {
     ...
     *
     */
    DataFlow.prototype.postV05HealthInformationHipRequestJson = function (req, serverURL, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05HealthInformationHipRequestJsonRequest(req);
        }
        var baseURL = operations.PostV05HealthInformationHipRequestJsonServerList[0];
        if (serverURL) {
            baseURL = serverURL;
        }
        ...
        try {
            _a = utils.serializeRequestBody(req, "hipHealthInformationRequest", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
     ...
     *
     */
    DataFlow.prototype.postV05HealthInformationHipRequestRaw = function (req, serverURL, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05HealthInformationHipRequestRawRequest(req);
        }
        var baseURL = operations.PostV05HealthInformationHipRequestRawServerList[0];
        if (serverURL) {
            baseURL = serverURL;
        }
        var url = baseURL.replace(/\/$/, "") + "/v0.5/health-information/hip/request";
