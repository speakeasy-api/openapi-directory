...
class UpdateResourceServerRequest:
    ...
    update_resource_server_request: shared_updateresourceserverrequest.UpdateResourceServerRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
