...
export class GkebackupProjectsLocationsBackupPlansBackupsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsBackupPlansBackupsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsBackupPlansBackupsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
