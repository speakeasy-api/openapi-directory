...
try {
    ...
    $request->targetUser = 'praesentium';
...
try {
    ...
    $request->username = 'Sierra_Rolfson66';
...
try {
    ...
    $request->armoredPublicKey = 'atque';
...
try {
    $request = new UsersDeleteEmailForAuthenticatedUserRequestBody1();
    $request->emails = [
        'username@example.com',
        'username@example.com',
        'username@example.com',
...
try {
    ...
    $request->subjectId = 'quam';
    $request->subjectType = UsersGetContextForUserSubjectTypeEnum::ISSUE;
    $request->username = 'Loyal95';
...
try {
    ...
    $request->perPage = 801816;
    $request->since = 951103;
...
try {
    ...
    $request->page = 451807;
    $request->perPage = 461754;
    $request->username = 'Polly_Brown79';
...
try {
    ...
    $request->page = 451589;
    $request->perPage = 77992;
    $request->username = 'Raven.Schneider40';
...
try {
    ...
    $request->page = 153097;
    $request->perPage = 657141;
    $request->username = 'Clint.Rosenbaum';
...
try {
    ...
    $request->page = 470321;
    $request->perPage = 945190;
    $request->username = 'Vicenta25';
