...
class GetMedicalVocabularyRequest:
    ...
    get_medical_vocabulary_request: shared_getmedicalvocabularyrequest.GetMedicalVocabularyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
