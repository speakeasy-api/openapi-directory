...
class APIInformation 
{
     ...
     * 
     * @return \OpenAPI\OpenAPI\Models\Operations\GetApiVersionResponse
     */
	public function getApiVersion(
    ): \OpenAPI\OpenAPI\Models\Operations\GetApiVersionResponse
    {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetApiVersionResponse();
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetHealthResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->apiHealthStatus = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ApiHealthStatus', 'json');
            }
        }
