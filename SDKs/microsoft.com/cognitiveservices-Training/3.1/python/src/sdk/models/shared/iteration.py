...
class Iteration:
    ...
    r"""Gets the time this iteration was last modified."""  
    training_time_in_minutes: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('trainingTimeInMinutes'), 'exclude': lambda f: f is None }})
    r"""Gets the training time for the iteration."""  
