...
func (e *UpdateOAuthClientRequestClientTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "confidential":
		fallthrough
	case "public":
		*e = UpdateOAuthClientRequestClientTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOAuthClientRequestClientTypeEnum: %s", s)
	}
}
...
func (e *UpdateOAuthClientRequestGrantTypesEnum) UnmarshalJSON(data []byte) error {
	...
	case "password":
		fallthrough
	case "refresh_token":
		*e = UpdateOAuthClientRequestGrantTypesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateOAuthClientRequestGrantTypesEnum: %s", s)
	}
}
