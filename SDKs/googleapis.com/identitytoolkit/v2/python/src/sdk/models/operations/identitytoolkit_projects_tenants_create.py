...
class IdentitytoolkitProjectsTenantsCreateRequest:
    ...
    r"""The parent resource name where the tenant will be created. For example, \\"projects/project1\\"."""  
    ...
    google_cloud_identitytoolkit_admin_v2_tenant_input: Optional[shared_googlecloudidentitytoolkitadminv2tenant.GoogleCloudIdentitytoolkitAdminV2TenantInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
