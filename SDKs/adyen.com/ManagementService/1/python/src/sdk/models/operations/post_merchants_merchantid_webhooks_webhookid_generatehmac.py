...
class PostMerchantsMerchantIDWebhooksWebhookIDGenerateHmacSecurity:
...
@dataclasses.dataclass
class PostMerchantsMerchantIDWebhooksWebhookIDGenerateHmacRequest:
...
@dataclasses.dataclass
class PostMerchantsMerchantIDWebhooksWebhookIDGenerateHmacResponse:
