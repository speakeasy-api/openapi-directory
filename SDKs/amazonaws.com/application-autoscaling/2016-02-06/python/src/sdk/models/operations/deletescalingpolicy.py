...
class DeleteScalingPolicyRequest:
    ...
    delete_scaling_policy_request: shared_deletescalingpolicyrequest.DeleteScalingPolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
