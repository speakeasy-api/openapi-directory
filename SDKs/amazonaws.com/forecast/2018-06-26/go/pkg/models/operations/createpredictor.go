...
func (e CreatePredictorXAmzTargetEnum) ToPointer() *CreatePredictorXAmzTargetEnum {
	return &e
}
...
func (e *CreatePredictorXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonForecast.CreatePredictor":
		*e = CreatePredictorXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreatePredictorXAmzTargetEnum: %v", v)
	}
}
