...
class GenerateTemplateRequest:
    ...
    template_format: Optional[shared_outputformat_enum.OutputFormatEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('templateFormat'), 'exclude': lambda f: f is None }})  
