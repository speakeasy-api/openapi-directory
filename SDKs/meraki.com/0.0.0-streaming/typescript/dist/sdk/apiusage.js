...
var APIUsage = /** @class */ (function () {
    function APIUsage(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * List the API requests made by an organization
     */
    APIUsage.prototype.getOrganizationApiRequests = function (req, config) {
     ...
     * Return an aggregated overview of API requests data
     */
    APIUsage.prototype.getOrganizationApiRequestsOverview = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
