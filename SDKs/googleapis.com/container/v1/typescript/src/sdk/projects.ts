...
export class Projects {
  ...
  containerProjectsLocationsClustersGetJwks(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/jwks", req);
  ...
  containerProjectsLocationsClustersNodePoolsSetSize(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{name}:setSize", req);
  ...
  containerProjectsLocationsClustersSetAddons(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{name}:setAddons", req);
