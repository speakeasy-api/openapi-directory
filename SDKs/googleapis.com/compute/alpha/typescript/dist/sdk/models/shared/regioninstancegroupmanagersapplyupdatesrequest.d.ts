 ...
 */
export declare enum RegionInstanceGroupManagersApplyUpdatesRequestMaximalActionEnum {
    None = "NONE",
    Refresh = "REFRESH",
    Replace = "REPLACE",
    Restart = "RESTART"
 ...
 */
export declare enum RegionInstanceGroupManagersApplyUpdatesRequestMinimalActionEnum {
    None = "NONE",
    Refresh = "REFRESH",
    Replace = "REPLACE",
    Restart = "RESTART"
 ...
 */
export declare enum RegionInstanceGroupManagersApplyUpdatesRequestMostDisruptiveAllowedActionEnum {
    None = "NONE",
    Refresh = "REFRESH",
    Replace = "REPLACE",
    Restart = "RESTART"
 ...
 */
export declare class RegionInstanceGroupManagersApplyUpdatesRequest extends SpeakeasyBase {
    /**
