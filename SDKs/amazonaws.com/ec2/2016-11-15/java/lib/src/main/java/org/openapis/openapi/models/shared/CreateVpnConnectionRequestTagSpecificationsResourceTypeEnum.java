 ...
 */
public enum CreateVpnConnectionRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateVpnConnectionRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
