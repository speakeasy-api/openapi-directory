...
export class OsconfigProjectsPatchJobsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class OsconfigProjectsPatchJobsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class OsconfigProjectsPatchJobsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
