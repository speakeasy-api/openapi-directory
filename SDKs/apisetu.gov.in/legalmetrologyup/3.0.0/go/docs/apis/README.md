...
func main() {
    ...
    res, err := s.APIs.Delcs(ctx, operations.DelcsRequestBody{
        ...
        Format: operations.DelcsRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.DelcsSecurity{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Palcs(ctx, operations.PalcsRequestBody{
        CertificateParameters: &operations.PalcsRequestBodyCertificateParameters{
            ApplicationNo: "181527xxxxxxx7",
            LicenseNo: "53453xxxxxx11",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
        ...
        Format: operations.PalcsRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.PalcsSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Relcs(ctx, operations.RelcsRequestBody{
        CertificateParameters: &operations.RelcsRequestBodyCertificateParameters{
            ApplicationNo: "181527xxxxxxx7",
            LicenseNo: "53453xxxxxx11",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
        ...
        Format: operations.RelcsRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.RelcsSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
