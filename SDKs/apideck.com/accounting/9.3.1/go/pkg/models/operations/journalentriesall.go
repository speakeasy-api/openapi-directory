...
type JournalEntriesAllSecurity struct {
	APIKey string `security:"scheme,type=apiKey,subtype=header,name=Authorization"`
}

type JournalEntriesAllRequest struct {
...
type JournalEntriesAllResponse struct {
	// Bad Request
	BadRequestResponse *shared.BadRequestResponse
	ContentType        string
	// JournalEntry
	GetJournalEntriesResponse *shared.GetJournalEntriesResponse
