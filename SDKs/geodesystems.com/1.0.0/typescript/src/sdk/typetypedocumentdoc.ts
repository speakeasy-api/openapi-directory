...
export class TypeTypeDocumentDoc {
  ...
  searchTypeDocumentDoc(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_document_doc";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeDocumentDocResponse =
        new operations.SearchTypeDocumentDocResponse({
