...
class DrivelabelsLabelsRevisionsPermissionsCreateRequest:
    ...
    google_apps_drive_labels_v2beta_label_permission: Optional[shared_googleappsdrivelabelsv2betalabelpermission.GoogleAppsDriveLabelsV2betaLabelPermission] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
