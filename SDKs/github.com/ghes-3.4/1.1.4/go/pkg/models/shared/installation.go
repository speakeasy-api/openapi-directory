...
func (e InstallationRepositorySelectionEnum) ToPointer() *InstallationRepositorySelectionEnum {
	return &e
}
...
func (e *InstallationRepositorySelectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "all":
		fallthrough
	case "selected":
		*e = InstallationRepositorySelectionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for InstallationRepositorySelectionEnum: %v", v)
	}
}
