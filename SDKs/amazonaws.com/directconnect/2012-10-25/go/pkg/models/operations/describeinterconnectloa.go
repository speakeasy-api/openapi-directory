...
func (e DescribeInterconnectLoaXAmzTargetEnum) ToPointer() *DescribeInterconnectLoaXAmzTargetEnum {
	return &e
}
...
func (e *DescribeInterconnectLoaXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "OvertureService.DescribeInterconnectLoa":
		*e = DescribeInterconnectLoaXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeInterconnectLoaXAmzTargetEnum: %v", v)
	}
}
