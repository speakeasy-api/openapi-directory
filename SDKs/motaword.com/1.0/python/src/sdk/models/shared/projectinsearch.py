...
class ProjectInSearch:
    ...
    price: Optional[ProjectInSearchPrice] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('price') }})
    price_without_discount: Optional[ProjectInSearchPriceWithoutDiscount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('price_without_discount') }})
    ...
    search_result_reason: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('search_result_reason') }})
