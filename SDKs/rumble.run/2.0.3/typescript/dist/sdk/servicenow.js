...
var ServiceNow = /** @class */ (function () {
    ...
    **/
    ServiceNow.prototype.snowExportAssetsCsv = function (req, config) {
    ...
    **/
    ServiceNow.prototype.snowExportAssetsJson = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ServiceNow.prototype.snowExportServicesCsv = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
