...
type StartPaymentInitiationCancellationAuthorisationRequestBodyType string

const (
	StartPaymentInitiationCancellationAuthorisationRequestBodyTypeAny                           StartPaymentInitiationCancellationAuthorisationRequestBodyType = "any"
	StartPaymentInitiationCancellationAuthorisationRequestBodyTypeUpdatePsuAuthentication       StartPaymentInitiationCancellationAuthorisationRequestBodyType = "updatePsuAuthentication"
	StartPaymentInitiationCancellationAuthorisationRequestBodyTypeSelectPsuAuthenticationMethod StartPaymentInitiationCancellationAuthorisationRequestBodyType = "selectPsuAuthenticationMethod"
	StartPaymentInitiationCancellationAuthorisationRequestBodyTypeTransactionAuthorisation      StartPaymentInitiationCancellationAuthorisationRequestBodyType = "transactionAuthorisation"
)

type StartPaymentInitiationCancellationAuthorisationRequestBody struct {
	Any                           interface{}
	...
	Type StartPaymentInitiationCancellationAuthorisationRequestBodyType
}

func CreateStartPaymentInitiationCancellationAuthorisationRequestBodyAny(any interface{}) StartPaymentInitiationCancellationAuthorisationRequestBody {
	typ := StartPaymentInitiationCancellationAuthorisationRequestBodyTypeAny

	return StartPaymentInitiationCancellationAuthorisationRequestBody{
		Any:  &any,
		Type: typ,
	}
}

func CreateStartPaymentInitiationCancellationAuthorisationRequestBodyUpdatePsuAuthentication(updatePsuAuthentication shared.UpdatePsuAuthentication) StartPaymentInitiationCancellationAuthorisationRequestBody {
	typ := StartPaymentInitiationCancellationAuthorisationRequestBodyTypeUpdatePsuAuthentication
...
func CreateStartPaymentInitiationCancellationAuthorisationRequestBodySelectPsuAuthenticationMethod(selectPsuAuthenticationMethod shared.SelectPsuAuthenticationMethod) StartPaymentInitiationCancellationAuthorisationRequestBody {
	typ := StartPaymentInitiationCancellationAuthorisationRequestBodyTypeSelectPsuAuthenticationMethod
...
func CreateStartPaymentInitiationCancellationAuthorisationRequestBodyTransactionAuthorisation(transactionAuthorisation shared.TransactionAuthorisation) StartPaymentInitiationCancellationAuthorisationRequestBody {
	typ := StartPaymentInitiationCancellationAuthorisationRequestBodyTypeTransactionAuthorisation
...
func (u *StartPaymentInitiationCancellationAuthorisationRequestBody) UnmarshalJSON(data []byte) error {
	var d *json.Decoder
	...
	if err := d.Decode(&any); err == nil {
		u.Any = any
		u.Type = StartPaymentInitiationCancellationAuthorisationRequestBodyTypeAny
		return nil
	}
	...
	if err := d.Decode(&updatePsuAuthentication); err == nil {
		...
		u.Type = StartPaymentInitiationCancellationAuthorisationRequestBodyTypeUpdatePsuAuthentication
		return nil
	}
	...
	if err := d.Decode(&selectPsuAuthenticationMethod); err == nil {
		...
		u.Type = StartPaymentInitiationCancellationAuthorisationRequestBodyTypeSelectPsuAuthenticationMethod
		return nil
	}
	...
	if err := d.Decode(&transactionAuthorisation); err == nil {
		...
		u.Type = StartPaymentInitiationCancellationAuthorisationRequestBodyTypeTransactionAuthorisation
		return nil
	}
...
func (u StartPaymentInitiationCancellationAuthorisationRequestBody) MarshalJSON() ([]byte, error) {
	if u.Any != nil {
...
type StartPaymentInitiationCancellationAuthorisationRequest struct {
	...
	Request    *StartPaymentInitiationCancellationAuthorisationRequestBody `request:"mediaType=application/json"`
