...
exports.GetProductsIdImagesImageIdJsonResponse = exports.GetProductsIdImagesImageIdJsonRequest = void 0;
...
var GetProductsIdImagesImageIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetProductsIdImagesImageIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetProductsIdImagesImageIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=image_id",
        }),
        __metadata("design:type", Number)
    ], GetProductsIdImagesImageIdJsonRequest.prototype, "imageId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetProductsIdImagesImageIdJsonRequest.prototype, "login", void 0);
    return GetProductsIdImagesImageIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetProductsIdImagesImageIdJsonRequest = GetProductsIdImagesImageIdJsonRequest;
var GetProductsIdImagesImageIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], GetProductsIdImagesImageIdJsonResponse.prototype, "rawResponse", void 0);
    return GetProductsIdImagesImageIdJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetProductsIdImagesImageIdJsonResponse = GetProductsIdImagesImageIdJsonResponse;
