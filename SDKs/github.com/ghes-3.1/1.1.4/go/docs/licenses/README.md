...
<https://docs.github.com/enterprise-server@3.1/rest/reference/licenses#get-a-license>
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/licenses#get-all-commonly-used-licenses>
...
func main() {
    ...
    res, err := s.Licenses.LicensesGetAllCommonlyUsed(ctx, operations.LicensesGetAllCommonlyUsedRequest{
        ...
        Page: sdk.Int64(58534),
        PerPage: sdk.Int64(271113),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/licenses/#get-the-license-for-a-repository>
