...
var Activities = /** @class */ (function () {
     ...
     *
     */
    Activities.prototype.postV2ActivitiesJson = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV2ActivitiesJsonRequestBody(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v2/activities.json";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostV2ActivitiesJsonResponse({
