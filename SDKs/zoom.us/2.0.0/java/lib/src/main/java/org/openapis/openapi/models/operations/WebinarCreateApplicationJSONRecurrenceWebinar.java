 ...
 */
public class WebinarCreateApplicationJSONRecurrenceWebinar {
    /**
    ...
    public WebinarCreateApplicationJSONRecurrenceWebinar withEndDateTime(OffsetDateTime endDateTime) {
    ...
    public WebinarCreateApplicationJSONRecurrenceWebinar withEndTimes(Long endTimes) {
    ...
    public WebinarCreateApplicationJSONRecurrenceWebinar withMonthlyDay(Long monthlyDay) {
    ...
    public WebinarCreateApplicationJSONRecurrenceWebinarMonthlyWeekEnum monthlyWeek;
    public WebinarCreateApplicationJSONRecurrenceWebinar withMonthlyWeek(WebinarCreateApplicationJSONRecurrenceWebinarMonthlyWeekEnum monthlyWeek) {
    ...
    public WebinarCreateApplicationJSONRecurrenceWebinarMonthlyWeekDayEnum monthlyWeekDay;
    public WebinarCreateApplicationJSONRecurrenceWebinar withMonthlyWeekDay(WebinarCreateApplicationJSONRecurrenceWebinarMonthlyWeekDayEnum monthlyWeekDay) {
    ...
    public WebinarCreateApplicationJSONRecurrenceWebinar withRepeatInterval(Long repeatInterval) {
     ...
     */
    @JsonProperty("type")
    public WebinarCreateApplicationJSONRecurrenceWebinarTypeEnum type;
    public WebinarCreateApplicationJSONRecurrenceWebinar withType(WebinarCreateApplicationJSONRecurrenceWebinarTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public WebinarCreateApplicationJSONRecurrenceWebinar withWeeklyDays(String weeklyDays) {
