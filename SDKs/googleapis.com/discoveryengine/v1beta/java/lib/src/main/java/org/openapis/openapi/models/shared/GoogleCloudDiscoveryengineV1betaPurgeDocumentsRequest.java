...
public class GoogleCloudDiscoveryengineV1betaPurgeDocumentsRequest {
    ...
    public GoogleCloudDiscoveryengineV1betaPurgeDocumentsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GoogleCloudDiscoveryengineV1betaPurgeDocumentsRequest withForce(Boolean force) {
        this.force = force;
        return this;
    }
