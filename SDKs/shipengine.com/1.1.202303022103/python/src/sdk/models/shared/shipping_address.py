...
class ShippingAddressAddressResidentialIndicatorEnum(str, Enum):
...
class ShippingAddress:
    ...
    address_residential_indicator: ShippingAddressAddressResidentialIndicatorEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address_residential_indicator') }})
    ...
    r"""Additional text about how to handle the shipment at this address."""  
