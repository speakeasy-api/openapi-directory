...
public class GetRevisionsIdsRequest {
    ...
    public GetRevisionsIdsRequest withCallback(String callback) {
    ...
    public GetRevisionsIdsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetRevisionsIdsRequest withFromdate(Long fromdate) {
    ...
    public GetRevisionsIdsRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetRevisionsIdsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetRevisionsIdsRequest withPagesize(Long pagesize) {
    ...
    public GetRevisionsIdsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetRevisionsIdsRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetRevisionsIdsRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
