...
var Auth = /** @class */ (function () {
     ...
     *
     */
    Auth.prototype.getAccessToken = function (req, security, config) {
        var _a;
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.GetAccessTokenSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                ...
                default:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.tokenError = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.TokenError);
                    }
                    break;
            }
            return res;
