...
class Privilege 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetPrivilegesResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/privilege');
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->sellingPrivileges = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\SellingPrivileges', 'json');
            }
        }
