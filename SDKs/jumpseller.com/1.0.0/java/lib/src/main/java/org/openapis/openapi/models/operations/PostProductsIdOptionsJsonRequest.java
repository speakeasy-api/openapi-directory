...
public class PostProductsIdOptionsJsonRequest {
    ...
    public PostProductsIdOptionsJsonRequest(@JsonProperty("ProductOptionEdit") org.openapis.openapi.models.shared.ProductOptionEdit productOptionEdit, @JsonProperty("authtoken") String authtoken, @JsonProperty("id") Integer id, @JsonProperty("login") String login) {
        this.productOptionEdit = productOptionEdit;
        this.authtoken = authtoken;
        this.id = id;
        this.login = login;
