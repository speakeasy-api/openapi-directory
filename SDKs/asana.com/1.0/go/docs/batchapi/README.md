...
func main() {
    ...
    res, err := s.BatchAPI.CreateBatchRequest(ctx, operations.CreateBatchRequestRequest{
        RequestBody: operations.CreateBatchRequestRequestBody{
            Data: &shared.BatchRequest{
                Actions: []shared.BatchRequestAction{
                    shared.BatchRequestAction{
                        ...
                        Method: shared.BatchRequestActionMethodEnumGet,
                        Options: &shared.BatchRequestActionOptions{
                            ...
                            Limit: sdk.Int64(50),
                            Offset: sdk.Int64(eyJ0eXAiOJiKV1iQLCJhbGciOiJIUzI1NiJ9),
                        },
    ...
    if res.CreateBatchRequest200ApplicationJSONObject != nil {
        // handle response
    }
}
```
