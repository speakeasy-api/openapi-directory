...
public class GetAppsAccessTokensDeAuthenticateQueryParams {
    /**
    ...
    public GetAppsAccessTokensDeAuthenticateQueryParams withCallback(String callback) {
    ...
    public GetAppsAccessTokensDeAuthenticateQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public Long page;
    public GetAppsAccessTokensDeAuthenticateQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetAppsAccessTokensDeAuthenticateQueryParams withPagesize(Long pagesize) {
