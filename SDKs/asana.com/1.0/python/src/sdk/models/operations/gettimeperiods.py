...
class GetTimePeriods200ApplicationJSON:
    r"""Successfully retrieved the requested time periods."""
    
    data: Optional[list[shared_timeperiodcompact.TimePeriodCompact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
