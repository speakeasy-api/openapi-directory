...
public class Prime {
    ...
    **/
    public openapisdk.models.operations.GetNumbersPrimeFactorsResponse getNumbersPrimeFactors(openapisdk.models.operations.GetNumbersPrimeFactorsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/numbers/prime/factors");
        ...
        openapisdk.models.operations.GetNumbersPrimeFactorsResponse res = new openapisdk.models.operations.GetNumbersPrimeFactorsResponse() {{
        }};
