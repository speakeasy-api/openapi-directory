...
export class CollectionTicketCommentsDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CollectionTicketCommentsDeleteRequest extends SpeakeasyBase {
  /**
   * The collection ID
   */
  @SpeakeasyMetadata({
...
export class CollectionTicketCommentsDeleteResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
