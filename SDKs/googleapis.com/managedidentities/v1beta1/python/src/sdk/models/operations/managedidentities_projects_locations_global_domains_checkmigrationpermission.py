...
from ..shared import checkmigrationpermissionresponse as shared_checkmigrationpermissionresponse
...
class ManagedidentitiesProjectsLocationsGlobalDomainsCheckMigrationPermissionResponse:
    ...
    check_migration_permission_response: Optional[shared_checkmigrationpermissionresponse.CheckMigrationPermissionResponse] = dataclasses.field(default=None)
