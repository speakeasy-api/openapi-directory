...
exports.GetBarcodeEncodeResponse = exports.GetBarcodeEncodeRequest = exports.GetBarcodeEncodeSecurity = exports.GetBarcodeEncodeQueryParams = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var GetBarcodeEncodeQueryParams = /** @class */ (function (_super) {
    __extends(GetBarcodeEncodeQueryParams, _super);
    function GetBarcodeEncodeQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=barcodeformat" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=totalheight" }),
        __metadata("design:type", Number)
    ], GetBarcodeEncodeQueryParams.prototype, "totalheight", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=widthfactor" }),
        __metadata("design:type", Number)
    ], GetBarcodeEncodeQueryParams.prototype, "widthfactor", void 0);
    return GetBarcodeEncodeQueryParams;
}(utils_1.SpeakeasyBase));
exports.GetBarcodeEncodeQueryParams = GetBarcodeEncodeQueryParams;
var GetBarcodeEncodeSecurity = /** @class */ (function (_super) {
    __extends(GetBarcodeEncodeSecurity, _super);
    function GetBarcodeEncodeSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
exports.GetBarcodeEncodeSecurity = GetBarcodeEncodeSecurity;
var GetBarcodeEncodeRequest = /** @class */ (function (_super) {
    __extends(GetBarcodeEncodeRequest, _super);
    function GetBarcodeEncodeRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
exports.GetBarcodeEncodeRequest = GetBarcodeEncodeRequest;
var GetBarcodeEncodeResponse = /** @class */ (function (_super) {
    __extends(GetBarcodeEncodeResponse, _super);
    function GetBarcodeEncodeResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.GetBarcodeEncodeResponse = GetBarcodeEncodeResponse;
