...
var BankAccountValidation = /** @class */ (function () {
    function BankAccountValidation(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    BankAccountValidation.prototype.postValidateBankAccountIdentification = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new shared.BankAccountIdentificationValidationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/validateBankAccountIdentification";
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.PostValidateBankAccountIdentificationSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostValidateBankAccountIdentificationResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.void = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
