...
export class CloudchannelAccountsCustomersListPurchasableSkusRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=changeOfferPurchase.changeType",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=createEntitlementPurchase.product",
  })
