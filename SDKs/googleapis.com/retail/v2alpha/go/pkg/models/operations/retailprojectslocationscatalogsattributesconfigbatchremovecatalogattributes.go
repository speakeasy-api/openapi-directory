...
type RetailProjectsLocationsCatalogsAttributesConfigBatchRemoveCatalogAttributesRequest struct {
	...
	GoogleCloudRetailV2alphaBatchRemoveCatalogAttributesRequest *shared.GoogleCloudRetailV2alphaBatchRemoveCatalogAttributesRequest `request:"mediaType=application/json"`
	// OAuth access token.
