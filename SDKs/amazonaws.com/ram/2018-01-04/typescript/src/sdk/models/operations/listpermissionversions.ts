...
export class ListPermissionVersionsRequestBody extends SpeakeasyBase {
  /**
...
export class ListPermissionVersionsRequest extends SpeakeasyBase {
...
export class ListPermissionVersionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
