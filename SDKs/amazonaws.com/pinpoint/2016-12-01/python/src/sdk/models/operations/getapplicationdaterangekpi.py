...
from ..shared import getapplicationdaterangekpiresponse as shared_getapplicationdaterangekpiresponse
...
class GetApplicationDateRangeKpiRequest:
    headers: GetApplicationDateRangeKpiHeaders = dataclasses.field()
    path_params: GetApplicationDateRangeKpiPathParams = dataclasses.field()
    query_params: GetApplicationDateRangeKpiQueryParams = dataclasses.field()
...
class GetApplicationDateRangeKpiResponse:
    ...
    get_application_date_range_kpi_response: Optional[shared_getapplicationdaterangekpiresponse.GetApplicationDateRangeKpiResponse] = dataclasses.field(default=None)
