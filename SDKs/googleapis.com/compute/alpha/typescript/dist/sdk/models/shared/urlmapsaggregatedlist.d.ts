 ...
 */
export declare enum UrlMapsAggregatedListWarningCodeEnum {
...
export declare class UrlMapsAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class UrlMapsAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class UrlMapsAggregatedList extends SpeakeasyBase {
    /**
