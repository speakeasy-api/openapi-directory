...
@dataclasses.dataclass
class BooksBookshelvesGetQueryParams:
...
class BooksBookshelvesGetRequest:
    path_params: BooksBookshelvesGetPathParams = dataclasses.field()
    query_params: BooksBookshelvesGetQueryParams = dataclasses.field()
    security: BooksBookshelvesGetSecurity = dataclasses.field()
