...
exports.GetBadgesIdsRecipientsResponse = exports.GetBadgesIdsRecipientsRequest = void 0;
...
var GetBadgesIdsRecipientsRequest = /** @class */ (function (_super) {
    ...
    ], GetBadgesIdsRecipientsRequest.prototype, "callback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetBadgesIdsRecipientsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fromdate",
        }),
        __metadata("design:type", Number)
    ], GetBadgesIdsRecipientsRequest.prototype, "fromdate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=ids" }),
        __metadata("design:type", String)
    ], GetBadgesIdsRecipientsRequest.prototype, "ids", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetBadgesIdsRecipientsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pagesize",
        }),
        __metadata("design:type", Number)
    ], GetBadgesIdsRecipientsRequest.prototype, "pagesize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=site" }),
        __metadata("design:type", String)
    ], GetBadgesIdsRecipientsRequest.prototype, "site", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=todate",
        }),
        __metadata("design:type", Number)
    ], GetBadgesIdsRecipientsRequest.prototype, "todate", void 0);
...
var GetBadgesIdsRecipientsResponse = /** @class */ (function (_super) {
    ...
    ], GetBadgesIdsRecipientsResponse.prototype, "rawResponse", void 0);
