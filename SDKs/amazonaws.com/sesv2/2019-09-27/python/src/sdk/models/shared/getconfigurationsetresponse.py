...
from ..shared import vdmoptions as shared_vdmoptions
...
class GetConfigurationSetResponse:
    ...
    suppression_options: Optional[shared_suppressionoptions.SuppressionOptions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SuppressionOptions'), 'exclude': lambda f: f is None }})  
    ...
    vdm_options: Optional[shared_vdmoptions.VdmOptions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VdmOptions'), 'exclude': lambda f: f is None }})  
