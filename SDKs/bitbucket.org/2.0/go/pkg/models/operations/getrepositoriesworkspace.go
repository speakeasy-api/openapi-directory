...
func (e GetRepositoriesWorkspaceRoleEnum) ToPointer() *GetRepositoriesWorkspaceRoleEnum {
	return &e
}
...
func (e *GetRepositoriesWorkspaceRoleEnum) UnmarshalJSON(data []byte) error {
	...
	case "member":
		fallthrough
	case "owner":
		*e = GetRepositoriesWorkspaceRoleEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetRepositoriesWorkspaceRoleEnum: %v", v)
	}
}
