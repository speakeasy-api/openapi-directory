...
class GoogleCloudVisionV1p1beta1BatchAnnotateFilesRequest:
    ...
    requests: Optional[list[shared_googlecloudvisionv1p1beta1annotatefilerequest.GoogleCloudVisionV1p1beta1AnnotateFileRequest]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('requests'), 'exclude': lambda f: f is None }})
