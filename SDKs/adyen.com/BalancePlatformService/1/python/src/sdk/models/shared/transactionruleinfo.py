...
class TransactionRuleInfoEntryModesEnum(str, Enum):
    BARCODE = 'barcode'
    CHIP = 'chip'
    COF = 'cof'
...
class TransactionRuleInfoProcessingTypesEnum(str, Enum):
...
class TransactionRuleInfoStatusEnum(str, Enum):
...
class TransactionRuleInfoTypeEnum(str, Enum):
...
class TransactionRuleInfo:
    ...
    type: TransactionRuleInfoTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Type of conditions provided in the rule.
    ...
    """  
    entry_modes: Optional[list[TransactionRuleInfoEntryModesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entryModes'), 'exclude': lambda f: f is None }})
    ...
    processing_types: Optional[list[TransactionRuleInfoProcessingTypesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('processingTypes'), 'exclude': lambda f: f is None }})
    ...
    """  
    status: Optional[TransactionRuleInfoStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The status of the transaction rule. If you provide a `startDate` in the request, the rule is automatically created
    with an **active** status. 
