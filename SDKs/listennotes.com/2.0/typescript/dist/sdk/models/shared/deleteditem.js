 ...
 *
**/
var DeletedItem = /** @class */ (function (_super) {
    __extends(DeletedItem, _super);
    ...
    ], DeletedItem.prototype, "error", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=id" }),
        __metadata("design:type", String)
    ], DeletedItem.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=status" }),
        __metadata("design:type", String)
    ], DeletedItem.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=title" }),
        __metadata("design:type", String)
    ], DeletedItem.prototype, "title", void 0);
    return DeletedItem;
