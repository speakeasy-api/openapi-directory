...
class DeleteOrganizationConformancePackRequest:
    ...
    delete_organization_conformance_pack_request: shared_deleteorganizationconformancepackrequest.DeleteOrganizationConformancePackRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
