...
from ..shared import coderepositorysortby_enum as shared_coderepositorysortby_enum
from ..shared import coderepositorysortorder_enum as shared_coderepositorysortorder_enum
...
class ListCodeRepositoriesInput:
    ...
    sort_by: Optional[shared_coderepositorysortby_enum.CodeRepositorySortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
    sort_order: Optional[shared_coderepositorysortorder_enum.CodeRepositorySortOrderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortOrder'), 'exclude': lambda f: f is None }})  
