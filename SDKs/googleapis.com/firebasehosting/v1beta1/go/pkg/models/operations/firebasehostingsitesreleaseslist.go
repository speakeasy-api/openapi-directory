...
type FirebasehostingSitesReleasesListSecurity struct {
	Option1 *FirebasehostingSitesReleasesListSecurityOption1 `security:"option"`
	Option2 *FirebasehostingSitesReleasesListSecurityOption2 `security:"option"`
	Option3 *FirebasehostingSitesReleasesListSecurityOption3 `security:"option"`
