...
export declare class UserManagement {
    ...
    **/
    deleteUsersUseridAuthorization(req: operations.DeleteUsersUseridAuthorizationRequest, config?: AxiosRequestConfig): Promise<operations.DeleteUsersUseridAuthorizationResponse>;
    /**
    ...
    **/
    postUsersUseridLink(req: operations.PostUsersUseridLinkRequest, config?: AxiosRequestConfig): Promise<operations.PostUsersUseridLinkResponse>;
}
