...
class DisplayvideoFirstAndThirdPartyAudiencesGetRequest:
    ...
    r"""Required. The ID of the first and third party audience to fetch."""  
    ...
    r"""The ID of the advertiser that has access to the fetched first and third party audience."""  
    ...
    r"""The ID of the partner that has access to the fetched first and third party audience."""  
