...
from ..shared import itvchangeemailrequest as shared_itvchangeemailrequest
...
class ChangeEmailRequest:
    ...
    itv_change_email_request: shared_itvchangeemailrequest.ItvChangeEmailRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
