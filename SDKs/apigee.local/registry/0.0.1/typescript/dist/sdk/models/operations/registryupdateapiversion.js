...
exports.RegistryUpdateApiVersionResponse = exports.RegistryUpdateApiVersionRequest = void 0;
...
var RegistryUpdateApiVersionRequest = /** @class */ (function (_super) {
    ...
    ], RegistryUpdateApiVersionRequest.prototype, "apiVersionInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=allowMissing",
        }),
        __metadata("design:type", Boolean)
    ], RegistryUpdateApiVersionRequest.prototype, "allowMissing", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=api" }),
        __metadata("design:type", String)
    ], RegistryUpdateApiVersionRequest.prototype, "api", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=location",
        }),
        __metadata("design:type", String)
    ], RegistryUpdateApiVersionRequest.prototype, "location", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=project",
        }),
        __metadata("design:type", String)
    ], RegistryUpdateApiVersionRequest.prototype, "project", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=updateMask",
        }),
        __metadata("design:type", String)
    ], RegistryUpdateApiVersionRequest.prototype, "updateMask", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=version",
        }),
        __metadata("design:type", String)
    ], RegistryUpdateApiVersionRequest.prototype, "version", void 0);
...
var RegistryUpdateApiVersionResponse = /** @class */ (function (_super) {
    ...
    ], RegistryUpdateApiVersionResponse.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    ], RegistryUpdateApiVersionResponse.prototype, "rawResponse", void 0);
