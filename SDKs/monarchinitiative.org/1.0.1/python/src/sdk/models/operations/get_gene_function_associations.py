...
class GetGeneFunctionAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGeneFunctionAssociationsQueryParams:
...
@dataclasses.dataclass
class GetGeneFunctionAssociationsRequest:
    path_params: GetGeneFunctionAssociationsPathParams = dataclasses.field()
    query_params: GetGeneFunctionAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetGeneFunctionAssociationsResponse:
