 ...
 */
export enum SchedulePickupResponseBodyPartialAddressAddressResidentialIndicatorEnum {
  Unknown = "unknown",
  Yes = "yes",
  No = "no",
}
 ...
 */
export class SchedulePickupResponseBodyPartialAddress extends SpeakeasyBase {
  /**
 ...
 */
export class SchedulePickupResponseBodyOutput extends SpeakeasyBase {
  /**
  ...
  @Type(() => SchedulePickupResponseBodyPartialAddress)
