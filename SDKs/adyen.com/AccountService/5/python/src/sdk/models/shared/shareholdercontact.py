...
class ShareholderContact:
    ...
    """  
    shareholder_reference: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shareholderReference'), 'exclude': lambda f: f is None }})
    r"""Your reference for the shareholder entry."""  
