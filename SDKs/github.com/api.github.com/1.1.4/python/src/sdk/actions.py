...
class Actions:
    ...
    def actions_create_or_update_environment_secret(self, request: operations.ActionsCreateOrUpdateEnvironmentSecretRequest) -> operations.ActionsCreateOrUpdateEnvironmentSecretResponse:
        ...
        url = utils.generate_url(base_url, "/repositories/{repository_id}/environments/{environment_name}/secrets/{secret_name}", request.path_params)
        ...
        res = operations.ActionsCreateOrUpdateEnvironmentSecretResponse(status_code=r.status_code, content_type=content_type)
    ...
    def actions_delete_environment_secret(self, request: operations.ActionsDeleteEnvironmentSecretRequest) -> operations.ActionsDeleteEnvironmentSecretResponse:
        ...
        res = operations.ActionsDeleteEnvironmentSecretResponse(status_code=r.status_code, content_type=content_type)
    ...
    def actions_get_environment_public_key(self, request: operations.ActionsGetEnvironmentPublicKeyRequest) -> operations.ActionsGetEnvironmentPublicKeyResponse:
        ...
        url = utils.generate_url(base_url, "/repositories/{repository_id}/environments/{environment_name}/secrets/public-key", request.path_params)
        ...
        res = operations.ActionsGetEnvironmentPublicKeyResponse(status_code=r.status_code, content_type=content_type)
    ...
    def actions_get_environment_secret(self, request: operations.ActionsGetEnvironmentSecretRequest) -> operations.ActionsGetEnvironmentSecretResponse:
        ...
        res = operations.ActionsGetEnvironmentSecretResponse(status_code=r.status_code, content_type=content_type)
    ...
    def actions_get_pending_deployments_for_run(self, request: operations.ActionsGetPendingDeploymentsForRunRequest) -> operations.ActionsGetPendingDeploymentsForRunResponse:
        ...
        url = utils.generate_url(base_url, "/repos/{owner}/{repo}/actions/runs/{run_id}/pending_deployments", request.path_params)
        ...
        res = operations.ActionsGetPendingDeploymentsForRunResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.PendingDeployment]])
    ...
    def actions_get_reviews_for_run(self, request: operations.ActionsGetReviewsForRunRequest) -> operations.ActionsGetReviewsForRunResponse:
        ...
        url = utils.generate_url(base_url, "/repos/{owner}/{repo}/actions/runs/{run_id}/approvals", request.path_params)
        ...
        res = operations.ActionsGetReviewsForRunResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.EnvironmentApprovals]])
    ...
    def actions_get_workflow_run_usage(self, request: operations.ActionsGetWorkflowRunUsageRequest) -> operations.ActionsGetWorkflowRunUsageResponse:
        ...
        url = utils.generate_url(base_url, "/repos/{owner}/{repo}/actions/runs/{run_id}/timing", request.path_params)
        ...
        res = operations.ActionsGetWorkflowRunUsageResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.WorkflowRunUsage])
    ...
    def actions_get_workflow_usage(self, request: operations.ActionsGetWorkflowUsageRequest) -> operations.ActionsGetWorkflowUsageResponse:
        ...
        url = utils.generate_url(base_url, "/repos/{owner}/{repo}/actions/workflows/{workflow_id}/timing", request.path_params)
        ...
        res = operations.ActionsGetWorkflowUsageResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.WorkflowUsage])
    ...
    def actions_list_environment_secrets(self, request: operations.ActionsListEnvironmentSecretsRequest) -> operations.ActionsListEnvironmentSecretsResponse:
        ...
        url = utils.generate_url(base_url, "/repositories/{repository_id}/environments/{environment_name}/secrets", request.path_params)
        ...
        res = operations.ActionsListEnvironmentSecretsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ActionsListEnvironmentSecrets200ApplicationJSON])
    ...
    def actions_review_pending_deployments_for_run(self, request: operations.ActionsReviewPendingDeploymentsForRunRequest) -> operations.ActionsReviewPendingDeploymentsForRunResponse:
        ...
        res = operations.ActionsReviewPendingDeploymentsForRunResponse(status_code=r.status_code, content_type=content_type)
