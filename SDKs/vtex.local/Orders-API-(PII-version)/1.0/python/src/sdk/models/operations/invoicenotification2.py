...
class InvoiceNotification2Request:
...
@dataclasses.dataclass
class InvoiceNotification2Response:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    invoice_notification2_200_application_json_object: Optional[InvoiceNotification2200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""  
