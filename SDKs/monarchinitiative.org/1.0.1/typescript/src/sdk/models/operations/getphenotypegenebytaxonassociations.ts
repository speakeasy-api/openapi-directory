...
export class GetPhenotypeGeneByTaxonAssociationsPathParams extends SpeakeasyBase {
...
export class GetPhenotypeGeneByTaxonAssociationsQueryParams extends SpeakeasyBase {
...
export class GetPhenotypeGeneByTaxonAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetPhenotypeGeneByTaxonAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
