...
class PostGroupsGroupIDUsersRequest:
    path_params: PostGroupsGroupIDUsersPathParams = dataclasses.field()
    request: Optional[PostGroupsGroupIDUsersRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})
