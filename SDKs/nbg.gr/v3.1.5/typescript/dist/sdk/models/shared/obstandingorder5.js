...
var OBStandingOrder5 = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "LastPaymentDateTime" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "NextPaymentAmount" }),
        (0, class_transformer_1.Type)(function () { return obactiveorhistoriccurrencyandamount_1.OBActiveOrHistoricCurrencyAndAmount; }),
        __metadata("design:type", obactiveorhistoriccurrencyandamount_1.OBActiveOrHistoricCurrencyAndAmount)
    ], OBStandingOrder5.prototype, "nextPaymentAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "NextPaymentDateTime" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "StandingOrderId" }),
        __metadata("design:type", String)
    ], OBStandingOrder5.prototype, "standingOrderId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "StandingOrderStatusCode" }),
        __metadata("design:type", String)
