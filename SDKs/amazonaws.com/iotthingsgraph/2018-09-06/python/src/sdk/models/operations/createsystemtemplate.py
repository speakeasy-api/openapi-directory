...
class CreateSystemTemplateRequest:
    ...
    create_system_template_request: shared_createsystemtemplaterequest.CreateSystemTemplateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
