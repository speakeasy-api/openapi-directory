 ...
 */
export enum CreateAndValidateShipmentDeliveryConfirmationEnum {
  None = "none",
  Delivery = "delivery",
  Signature = "signature",
 ...
 */
export enum CreateAndValidateShipmentInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export enum CreateAndValidateShipmentInternationalShipmentOptionsNonDeliveryEnum {
 ...
 */
export enum CreateAndValidateShipmentInsuranceProviderEnum {
  None = "none",
 ...
 */
export enum CreateAndValidateShipmentOriginTypeEnum {
  Pickup = "pickup",
  DropOff = "drop_off",
}
 ...
 */
export enum CreateAndValidateShipmentShipmentStatusEnum {
  Pending = "pending",
...
export class CreateAndValidateShipment extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "customs" })
  @Type(() => CreateAndValidateShipmentInternationalShipmentOptions)
  ...
  @Type(() => CreateAndValidateShipmentWeight)
