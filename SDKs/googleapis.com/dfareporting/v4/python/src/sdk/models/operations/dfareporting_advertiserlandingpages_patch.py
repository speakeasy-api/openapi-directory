...
class DfareportingAdvertiserLandingPagesPatchRequest:
    ...
    landing_page: Optional[shared_landingpage.LandingPage] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class DfareportingAdvertiserLandingPagesPatchResponse:
    ...
    landing_page: Optional[shared_landingpage.LandingPage] = dataclasses.field(default=None)
