...
public class GenerateNonceRequest {
    ...
    public GenerateNonceRequest withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GenerateNonceRequest withLang(String lang) {
        this.lang = lang;
        return this;
    }
    
    public GenerateNonceRequest(){}
}
