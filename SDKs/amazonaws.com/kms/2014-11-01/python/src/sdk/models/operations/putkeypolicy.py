...
class PutKeyPolicyRequest:
    headers: PutKeyPolicyHeaders = dataclasses.field()
    request: shared_putkeypolicyrequest.PutKeyPolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
