...
exports.GetCharityOrgsResponse = exports.GetCharityOrgsRequest = exports.GetCharityOrgsSecurity = void 0;
...
exports.GetCharityOrgsSecurity = GetCharityOrgsSecurity;
var GetCharityOrgsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetCharityOrgsRequest.prototype, "xEbayCMarketplaceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", String)
    ], GetCharityOrgsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", String)
    ], GetCharityOrgsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q" }),
        __metadata("design:type", String)
    ], GetCharityOrgsRequest.prototype, "q", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=registration_ids",
        }),
        __metadata("design:type", String)
    ], GetCharityOrgsRequest.prototype, "registrationIds", void 0);
    return GetCharityOrgsRequest;
}(utils_1.SpeakeasyBase));
exports.GetCharityOrgsRequest = GetCharityOrgsRequest;
var GetCharityOrgsResponse = /** @class */ (function (_super) {
    ...
    ], GetCharityOrgsResponse.prototype, "rawResponse", void 0);
    return GetCharityOrgsResponse;
}(utils_1.SpeakeasyBase));
exports.GetCharityOrgsResponse = GetCharityOrgsResponse;
