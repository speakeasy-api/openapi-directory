...
public class WellList {
    ...
    public WellListAlternativeSpecsSubmittedIfRequiredEnum alternativeSpecsSubmitted;
    public WellList withAlternativeSpecsSubmitted(WellListAlternativeSpecsSubmittedIfRequiredEnum alternativeSpecsSubmitted) {
    ...
    public WellListHydroFracturingPerformedEnum hydroFracturingPerformed;
    public WellList withHydroFracturingPerformed(WellListHydroFracturingPerformedEnum hydroFracturingPerformed) {
    ...
    public WellListWellDisinfectedEnum wellDisinfected;
    public WellList withWellDisinfected(WellListWellDisinfectedEnum wellDisinfected) {
    ...
    public WellListOrientationOfWellEnum wellOrientation;
    public WellList withWellOrientation(WellListOrientationOfWellEnum wellOrientation) {
