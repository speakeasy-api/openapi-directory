...
exports.SearchSearchResponse = exports.SearchSearchRequest = exports.SearchSearchQueryParams = exports.SearchSearchPathParams = void 0;
...
var SearchSearchPathParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=search_term" }),
        __metadata("design:type", String)
    ], SearchSearchPathParams.prototype, "searchTerm", void 0);
    return SearchSearchPathParams;
}(utils_1.SpeakeasyBase));
exports.SearchSearchPathParams = SearchSearchPathParams;
var SearchSearchQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=include_addresses" }),
        __metadata("design:type", Boolean)
    ], SearchSearchQueryParams.prototype, "includeAddresses", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=include_outlets" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=match_route_by_suburb" }),
        __metadata("design:type", Boolean)
    ], SearchSearchQueryParams.prototype, "matchRouteBySuburb", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=match_stop_by_gtfs_stop_id" }),
        __metadata("design:type", Boolean)
    ], SearchSearchQueryParams.prototype, "matchStopByGtfsStopId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=match_stop_by_suburb" }),
        __metadata("design:type", Boolean)
...
exports.SearchSearchQueryParams = SearchSearchQueryParams;
