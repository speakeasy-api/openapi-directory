...
export class LatestV1GetV1LatestGetQueryParams extends SpeakeasyBase {
...
export class LatestV1GetV1LatestGetRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: LatestV1GetV1LatestGetQueryParams;
}


export class LatestV1GetV1LatestGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
