...
class Issue:
    ...
    pull_request: Optional[IssuePullRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pull_request'), 'exclude': lambda f: f is None }})  
