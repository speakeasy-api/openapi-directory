...
class DisplayvideoAdvertisersCreativesDeleteRequest:
    path_params: DisplayvideoAdvertisersCreativesDeletePathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersCreativesDeleteQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersCreativesDeleteSecurity = dataclasses.field()
