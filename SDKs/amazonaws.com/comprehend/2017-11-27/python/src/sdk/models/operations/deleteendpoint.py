...
from ..shared import deleteendpointrequest as shared_deleteendpointrequest
...
class DeleteEndpointRequest:
    ...
    request: shared_deleteendpointrequest.DeleteEndpointRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteEndpointResponse:
    ...
    delete_endpoint_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
