...
func (e TravelTimeGetOverlayDirectionEnum) ToPointer() *TravelTimeGetOverlayDirectionEnum {
	return &e
}
...
func (e *TravelTimeGetOverlayDirectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "From":
		fallthrough
	case "To":
		*e = TravelTimeGetOverlayDirectionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TravelTimeGetOverlayDirectionEnum: %v", v)
	}
}
