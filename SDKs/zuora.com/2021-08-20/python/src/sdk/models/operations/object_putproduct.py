...
class ObjectPutProductPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectPutProductQueryParams:
...
class ObjectPutProductRequest:
    headers: ObjectPutProductHeaders = dataclasses.field()
    path_params: ObjectPutProductPathParams = dataclasses.field()
    query_params: ObjectPutProductQueryParams = dataclasses.field()
