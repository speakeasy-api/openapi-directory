...
class CreateProjectRequest:
    ...
    request: shared_createprojectrequest.CreateProjectRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateProjectResponse:
    ...
    project_already_exists_exception: Optional[Any] = dataclasses.field(default=None)
    project_configuration_exception: Optional[Any] = dataclasses.field(default=None)
    project_creation_failed_exception: Optional[Any] = dataclasses.field(default=None)
