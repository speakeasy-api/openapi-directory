...
exports.CreateDedicatedIpPoolResponse = exports.CreateDedicatedIpPoolRequest = exports.CreateDedicatedIpPoolRequestBody = exports.CreateDedicatedIpPoolRequestBodyScalingModeEnum = void 0;
 ...
 */
var CreateDedicatedIpPoolRequestBodyScalingModeEnum;
(function (CreateDedicatedIpPoolRequestBodyScalingModeEnum) {
    CreateDedicatedIpPoolRequestBodyScalingModeEnum["Standard"] = "STANDARD";
    CreateDedicatedIpPoolRequestBodyScalingModeEnum["Managed"] = "MANAGED";
})(CreateDedicatedIpPoolRequestBodyScalingModeEnum = exports.CreateDedicatedIpPoolRequestBodyScalingModeEnum || (exports.CreateDedicatedIpPoolRequestBodyScalingModeEnum = {}));
var CreateDedicatedIpPoolRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ScalingMode" }),
        __metadata("design:type", String)
    ], CreateDedicatedIpPoolRequestBody.prototype, "scalingMode", void 0);
    __decorate([
...
exports.CreateDedicatedIpPoolRequestBody = CreateDedicatedIpPoolRequestBody;
var CreateDedicatedIpPoolRequest = /** @class */ (function (_super) {
    ...
    ], CreateDedicatedIpPoolRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], CreateDedicatedIpPoolRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreateDedicatedIpPoolRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreateDedicatedIpPoolRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreateDedicatedIpPoolRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreateDedicatedIpPoolRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreateDedicatedIpPoolRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreateDedicatedIpPoolRequest.prototype, "xAmzSignedHeaders", void 0);
...
var CreateDedicatedIpPoolResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreateDedicatedIpPoolResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
