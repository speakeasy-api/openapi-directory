...
class StreamDescription:
    r"""Represents the output for <a>DescribeStream</a>."""
    ...
    has_more_shards: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('HasMoreShards') }})  
    ...
    shards: list[shared_shard.Shard] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Shards') }})  
