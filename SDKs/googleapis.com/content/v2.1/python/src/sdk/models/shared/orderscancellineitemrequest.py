...
class OrdersCancelLineItemRequest:
    ...
    r"""The ID of the line item to cancel. Either lineItemId or productId is required."""  
    ...
    r"""The quantity to cancel."""  
    reason: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is None }})
    r"""The reason for the cancellation. Acceptable values are: - \\"`customerInitiatedCancel`\\" - \\"`invalidCoupon`\\" - \\"`malformedShippingAddress`\\" - \\"`noInventory`\\" - \\"`other`\\" - \\"`priceError`\\" - \\"`shippingPriceError`\\" - \\"`taxError`\\" - \\"`undeliverableShippingAddress`\\" - \\"`unsupportedPoBoxAddress`\\" - \\"`failedToCaptureFunds`\\" """  
