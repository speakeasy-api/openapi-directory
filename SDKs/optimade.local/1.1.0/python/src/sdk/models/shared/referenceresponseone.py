...
class ReferenceResponseOneJSONAPI:
    r"""ReferenceResponseOneJSONAPI
...
@dataclass_json
@dataclasses.dataclass
class ReferenceResponseOneToplevelLinks:
    r"""ReferenceResponseOneToplevelLinks
...
@dataclass_json
@dataclasses.dataclass
class ReferenceResponseOneResponseMetaImplementationImplementationMaintainer:
    r"""ReferenceResponseOneResponseMetaImplementationImplementationMaintainer
...
@dataclass_json
@dataclasses.dataclass
class ReferenceResponseOneResponseMetaImplementation:
    r"""ReferenceResponseOneResponseMetaImplementation
    ...
    maintainer: Optional[ReferenceResponseOneResponseMetaImplementationImplementationMaintainer] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('maintainer') }})
...
@dataclass_json
@dataclasses.dataclass
class ReferenceResponseOneResponseMetaProvider:
    r"""ReferenceResponseOneResponseMetaProvider
...
@dataclass_json
@dataclasses.dataclass
class ReferenceResponseOneResponseMetaResponseMetaQuery:
    r"""ReferenceResponseOneResponseMetaResponseMetaQuery
...
@dataclass_json
@dataclasses.dataclass
class ReferenceResponseOneResponseMeta:
    r"""ReferenceResponseOneResponseMeta
    ...
    query: ReferenceResponseOneResponseMetaResponseMetaQuery = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('query') }})
    ...
    implementation: Optional[ReferenceResponseOneResponseMetaImplementation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('implementation') }})
    last_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('last_id') }})
    provider: Optional[ReferenceResponseOneResponseMetaProvider] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('provider') }})
...
class ReferenceResponseOne:
    r"""ReferenceResponseOne
    errors are not allowed
    """
    
    data: Any = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
    meta: ReferenceResponseOneResponseMeta = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    ...
    jsonapi: Optional[ReferenceResponseOneJSONAPI] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('jsonapi') }})
    links: Optional[ReferenceResponseOneToplevelLinks] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('links') }})
