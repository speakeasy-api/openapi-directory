...
class PutSnippetsWorkspaceEncodedIDCommentsCommentIDRequest:
    path_params: PutSnippetsWorkspaceEncodedIDCommentsCommentIDPathParams = dataclasses.field()
    security: PutSnippetsWorkspaceEncodedIDCommentsCommentIDSecurity = dataclasses.field()
