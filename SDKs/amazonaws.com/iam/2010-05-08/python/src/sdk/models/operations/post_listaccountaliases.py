...
class PostListAccountAliasesQueryParams:
    action: PostListAccountAliasesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostListAccountAliasesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostListAccountAliasesRequest:
    headers: PostListAccountAliasesHeaders = dataclasses.field()
    query_params: PostListAccountAliasesQueryParams = dataclasses.field()
