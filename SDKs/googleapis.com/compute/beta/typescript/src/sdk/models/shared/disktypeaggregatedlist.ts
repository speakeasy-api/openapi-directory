 ...
 */
export enum DiskTypeAggregatedListWarningCodeEnum {
...
export class DiskTypeAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class DiskTypeAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: DiskTypeAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class DiskTypeAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: DiskTypesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, DiskTypesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], DiskTypesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
