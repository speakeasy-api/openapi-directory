...
public class CommunicationProfiles {
    ...
    **/
    public openapisdk.models.operations.ObjectGetCommunicationProfileResponse objectGetCommunicationProfile(openapisdk.models.operations.ObjectGetCommunicationProfileRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/object/communication-profile/{id}", request.pathParams);
        ...
        openapisdk.models.operations.ObjectGetCommunicationProfileResponse res = new openapisdk.models.operations.ObjectGetCommunicationProfileResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                ...
                openapisdk.models.shared.ProxyGetCommunicationProfile out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ProxyGetCommunicationProfile.class);
