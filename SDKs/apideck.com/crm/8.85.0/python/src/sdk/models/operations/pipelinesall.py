...
from ..shared import getpipelinesresponse as shared_getpipelinesresponse
...
class PipelinesAllRequest:
    headers: PipelinesAllHeaders = dataclasses.field()
    query_params: PipelinesAllQueryParams = dataclasses.field()
    security: PipelinesAllSecurity = dataclasses.field()
...
class PipelinesAllResponse:
    ...
    get_pipelines_response: Optional[shared_getpipelinesresponse.GetPipelinesResponse] = dataclasses.field(default=None)
