...
class DatatransferApplicationsGetSecurity:
    option1: Optional[DatatransferApplicationsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DatatransferApplicationsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DatatransferApplicationsGetRequest:
    path_params: DatatransferApplicationsGetPathParams = dataclasses.field()
    query_params: DatatransferApplicationsGetQueryParams = dataclasses.field()
    security: DatatransferApplicationsGetSecurity = dataclasses.field()
