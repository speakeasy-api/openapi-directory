...
class GetDiseasePathwayAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetDiseasePathwayAssociationsQueryParams:
...
class GetDiseasePathwayAssociationsRequest:
    path_params: GetDiseasePathwayAssociationsPathParams = dataclasses.field()
    query_params: GetDiseasePathwayAssociationsQueryParams = dataclasses.field()
