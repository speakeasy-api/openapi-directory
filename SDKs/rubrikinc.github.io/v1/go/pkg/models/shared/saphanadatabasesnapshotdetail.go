...
type SapHanaDatabaseSnapshotDetailBackupTypeEnum string

const (
	SapHanaDatabaseSnapshotDetailBackupTypeEnumFull        SapHanaDatabaseSnapshotDetailBackupTypeEnum = "FULL"
	SapHanaDatabaseSnapshotDetailBackupTypeEnumIncremental SapHanaDatabaseSnapshotDetailBackupTypeEnum = "INCREMENTAL"
)

func (e SapHanaDatabaseSnapshotDetailBackupTypeEnum) ToPointer() *SapHanaDatabaseSnapshotDetailBackupTypeEnum {
	return &e
}

func (e *SapHanaDatabaseSnapshotDetailBackupTypeEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "FULL":
		fallthrough
	case "INCREMENTAL":
		*e = SapHanaDatabaseSnapshotDetailBackupTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SapHanaDatabaseSnapshotDetailBackupTypeEnum: %v", v)
	}
}

// SapHanaDatabaseSnapshotDetail - Returns details about a snapshot.
type SapHanaDatabaseSnapshotDetail struct {
	...
	BackupType SapHanaDatabaseSnapshotDetailBackupTypeEnum `json:"backupType"`
