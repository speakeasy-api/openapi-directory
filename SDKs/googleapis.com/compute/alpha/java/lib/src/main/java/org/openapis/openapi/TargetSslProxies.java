...
public class TargetSslProxies {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeTargetSslProxiesTestIamPermissionsResponse computeTargetSslProxiesTestIamPermissions(org.openapis.openapi.models.operations.ComputeTargetSslProxiesTestIamPermissionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeTargetSslProxiesTestIamPermissionsPathParams.class, baseUrl, "/projects/{project}/global/targetSslProxies/{resource}/testIamPermissions", request.pathParams, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeTargetSslProxiesTestIamPermissionsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.ComputeTargetSslProxiesTestIamPermissionsResponse res = new org.openapis.openapi.models.operations.ComputeTargetSslProxiesTestIamPermissionsResponse() {{
