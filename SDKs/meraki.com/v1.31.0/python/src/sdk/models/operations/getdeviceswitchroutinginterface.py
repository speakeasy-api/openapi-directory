...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetDeviceSwitchRoutingInterface200ApplicationJSONOspfSettings:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetDeviceSwitchRoutingInterface200ApplicationJSONOspfV3:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetDeviceSwitchRoutingInterface200ApplicationJSON:
    ...
    r"""IPv4 address"""  
    ipv6: Optional[GetDeviceSwitchRoutingInterface200ApplicationJSONIpv6] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ipv6'), 'exclude': lambda f: f is None }})
    r"""IPv6 addressing"""  
    ...
    r"""The name"""  
    ospf_settings: Optional[GetDeviceSwitchRoutingInterface200ApplicationJSONOspfSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ospfSettings'), 'exclude': lambda f: f is None }})
    r"""IPv4 OSPF Settings"""  
    ospf_v3: Optional[GetDeviceSwitchRoutingInterface200ApplicationJSONOspfV3] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ospfV3'), 'exclude': lambda f: f is None }})
    r"""IPv6 OSPF Settings"""  
...
class GetDeviceSwitchRoutingInterfaceResponse:
    ...
    get_device_switch_routing_interface_200_application_json_object: Optional[GetDeviceSwitchRoutingInterface200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
