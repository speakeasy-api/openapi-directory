...
type ContentReturnpolicyonlinePatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentReturnpolicyonlinePatchPathParams struct {
...
type ContentReturnpolicyonlinePatchQueryParams struct {
	// V1 error format.
...
type ContentReturnpolicyonlinePatchResponse struct {
	ContentType string
	// Successful response
