...
class StorageBucketAccessControlsInsertRequest:
    ...
    bucket_access_control: Optional[shared_bucketaccesscontrol.BucketAccessControl] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
