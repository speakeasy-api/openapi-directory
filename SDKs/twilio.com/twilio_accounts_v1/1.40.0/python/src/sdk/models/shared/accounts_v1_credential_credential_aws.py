...
class AccountsV1CredentialCredentialAws:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the AWS resource."""  
    ...
    r"""The unique string that we created to identify the AWS resource."""  
