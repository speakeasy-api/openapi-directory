...
type AnalyticsadminPropertiesDisplayVideo360AdvertiserLinkProposalsCreateRequest struct {
	...
	GoogleAnalyticsAdminV1alphaDisplayVideo360AdvertiserLinkProposalInput *shared.GoogleAnalyticsAdminV1alphaDisplayVideo360AdvertiserLinkProposalInput `request:"mediaType=application/json"`
	// OAuth access token.
