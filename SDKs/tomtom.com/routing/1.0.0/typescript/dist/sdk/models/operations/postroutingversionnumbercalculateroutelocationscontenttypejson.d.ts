...
export declare class PostRoutingVersionNumberCalculateRouteLocationsContentTypeJsonRequest extends SpeakeasyBase {
    /**
...
export declare class PostRoutingVersionNumberCalculateRouteLocationsContentTypeJsonResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
