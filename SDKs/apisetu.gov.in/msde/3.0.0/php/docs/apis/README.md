...
use \OpenAPI\OpenAPI\Models\Operations\IticrRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\IticrRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\IticrRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\IticrSecurity;
...
try {
    ...
    $request->certificateParameters = new IticrRequestBodyCertificateParameters();
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->certno = '18XXXXXXX';
    ...
    $request->format = IticrRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new IticrSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->iticr($request, $requestSecurity);
