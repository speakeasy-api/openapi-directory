...
class Tenancy:
    ...
    def tenancy_choices_list(self) -> operations.TenancyChoicesListResponse:
        ...
        res = operations.TenancyChoicesListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def tenancy_choices_read(self, request: operations.TenancyChoicesReadRequest) -> operations.TenancyChoicesReadResponse:
        ...
        url = utils.generate_url(operations.TenancyChoicesReadRequest, base_url, '/tenancy/_choices/{id}/', request)
        ...
        res = operations.TenancyChoicesReadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        

        return res

    def tenancy_tenant_groups_create(self, request: shared.TenantGroupInput) -> operations.TenancyTenantGroupsCreateResponse:
        base_url = self._server_url
    ...
    def tenancy_tenant_groups_partial_update(self, request: operations.TenancyTenantGroupsPartialUpdateRequest) -> operations.TenancyTenantGroupsPartialUpdateResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "tenant_group_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
