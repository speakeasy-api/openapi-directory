...
public class UpdateUploadResponse {
    ...
    public UpdateUploadResponse withStatusCode(Integer statusCode) {
    ...
    public UpdateUploadResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public org.openapis.openapi.models.shared.UpdateUploadResult updateUploadResult;

    public UpdateUploadResponse withUpdateUploadResult(org.openapis.openapi.models.shared.UpdateUploadResult updateUploadResult) {
        this.updateUploadResult = updateUploadResult;
        return this;
    }
    
    public UpdateUploadResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
