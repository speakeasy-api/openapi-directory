...
from ..shared import updateremoteidrequestv4 as shared_updateremoteidrequestv4
...
class PostV4PayeesPayeeIDRemoteIDUpdateRequest:
    ...
    update_remote_id_request_v4: shared_updateremoteidrequestv4.UpdateRemoteIDRequestV4 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
