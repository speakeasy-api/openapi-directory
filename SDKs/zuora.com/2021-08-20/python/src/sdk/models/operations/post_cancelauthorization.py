...
class POSTCancelAuthorizationRequest:
    ...
    r"""The unique ID of the payment method where the authorization is cancelled."""  
    post_void_authorize: shared_postvoidauthorize.POSTVoidAuthorize = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
