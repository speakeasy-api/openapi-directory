...
class GroupMetadataConnectionsUsers:
    r"""Information about the members or moderators of this group."""
...
class GroupMetadataConnectionsVideos:
    r"""Information about the videos contained within this group."""
...
class GroupMetadataConnections:
    ...
    users: GroupMetadataConnectionsUsers = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('users') }})
    r"""Information about the members or moderators of this group."""  
    videos: GroupMetadataConnectionsVideos = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('videos') }})
    r"""Information about the videos contained within this group."""  
...
class GroupMetadataInteractionsJoin:
    r"""An action indicating that someone has joined the group. This data requires a bearer token with the `private` scope."""
    
    added: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('added') }})
    r"""Whether the authenticated user has followed this group. This data requires a bearer token with the `private` scope."""  
    added_time: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('added_time') }})
    r"""The time in ISO 8601 format when the user joined this group. This data requires a bearer token with the `private` scope."""  
    title: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('title') }})
    r"""The user's title, or the null value if not applicable. This data requires a bearer token with the `private` scope."""  
    type: GroupMetadataInteractionsJoinTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Whether the authenticated user is a moderator or subscriber. This data requires a bearer token with the `private` scope.
    ...
    """  
    uri: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('uri') }})
    r"""The URI for following. PUT to this URI to follow, or DELETE to this URI to unfollow. This data requires a bearer token with the `private` scope."""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GroupMetadataInteractions:
    r"""User actions that have involved the group. This data requires a bearer token with the `private` scope."""
    
    join: GroupMetadataInteractionsJoin = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('join') }})
    r"""An action indicating that someone has joined the group. This data requires a bearer token with the `private` scope."""  
...
class GroupMetadata:
    ...
    connections: GroupMetadataConnections = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connections') }})
    r"""A collection of information that is connected to this resource."""  
    interactions: GroupMetadataInteractions = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('interactions') }})
    r"""User actions that have involved the group. This data requires a bearer token with the `private` scope."""  
    
class GroupPrivacyCommentEnum(str, Enum):
    r"""Who can comment on the group:
...
class GroupPrivacyInviteEnum(str, Enum):
    r"""Who can invite new members to the group:
...
class GroupPrivacyVideosEnum(str, Enum):
    r"""Who can add videos to the group:
...
@dataclasses.dataclass
class GroupPrivacy:
    r"""The group's privacy settings."""
    
    comment: GroupPrivacyCommentEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('comment') }})
    r"""Who can comment on the group:
     ...
     * `members` - Only members can comment on the group.
    """  
    invite: GroupPrivacyInviteEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('invite') }})
    r"""Who can invite new members to the group:
     ...
     * `members` - Only group members can invite new members to join.
    """  
    join: GroupPrivacyJoinEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('join') }})
    r"""Who can join the group:
     ...
     * `members` - Only people with a Vimeo account can join the group.
    """  
    videos: GroupPrivacyVideosEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('videos') }})
    r"""Who can add videos to the group:
     ...
     * `members` - Only group members can add videos to the group.
    """  
    view: GroupPrivacyViewEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('view') }})
    r"""Who can view the group:
...
class GroupUserContentFilterEnum(str, Enum):
...
class GroupUserMetadataConnections:
    ...
    albums: GroupUserMetadataConnectionsAlbums = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('albums') }})
    r"""Information about the albums created by this user."""  
    appearances: GroupUserMetadataConnectionsAppearances = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('appearances') }})
    r"""Information about the appearances of this user in other videos."""  
    block: GroupUserMetadataConnectionsBlock = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('block') }})
    r"""Information on the users that the current user has blocked. This data requires a bearer token with the `private` scope."""  
    categories: GroupUserMetadataConnectionsCategories = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('categories') }})
    r"""Information about this user's followed categories."""  
    channels: GroupUserMetadataConnectionsChannels = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('channels') }})
    r"""Information about this user's subscribed channels."""  
    feed: GroupUserMetadataConnectionsFeed = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('feed') }})
    r"""Information about this user's feed."""  
    folders: GroupUserMetadataConnectionsFolders = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('folders') }})
    r"""Information about this user's folders."""  
    followers: GroupUserMetadataConnectionsFollowers = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('followers') }})
    r"""Information about the user's followers."""  
    following: GroupUserMetadataConnectionsFollowing = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('following') }})
    r"""Information about the users that the current user is following."""  
    groups: GroupUserMetadataConnectionsGroups = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('groups') }})
    r"""Information about the groups created by this user."""  
    likes: GroupUserMetadataConnectionsLikes = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('likes') }})
    r"""Information about the videos that this user has liked."""  
    moderated_channels: GroupUserMetadataConnectionsModeratedChannels = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('moderated_channels') }})
    r"""Information about the channels that this user moderates."""  
    pictures: GroupUserMetadataConnectionsPictures = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pictures') }})
    r"""Information about this user's portraits."""  
    portfolios: GroupUserMetadataConnectionsPortfolios = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('portfolios') }})
    r"""Information about this user's portfolios."""  
    recommended_channels: GroupUserMetadataConnectionsRecommendedChannels = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('recommended_channels') }})
    r"""A collection of recommended channels for the current user to follow. This data requires a bearer token with the `private` scope."""  
    recommended_users: GroupUserMetadataConnectionsRecommendedUsers = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('recommended_users') }})
    r"""A Collection of recommended users for the current user to follow. This data requires a bearer token with the `private` scope."""  
    shared: GroupUserMetadataConnectionsShared = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shared') }})
    r"""Information about the videos that have been shared with this user."""  
    videos: GroupUserMetadataConnectionsVideos = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('videos') }})
    r"""Information about the videos uploaded by this user."""  
    watched_videos: GroupUserMetadataConnectionsWatchedVideos = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('watched_videos') }})
    r"""Information about the videos that this user has watched."""  
    watchlater: GroupUserMetadataConnectionsWatchlater = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('watchlater') }})
    r"""Information about the videos that this user wants to watch later."""  
...
class GroupUserMetadataInteractions:
    ...
    block: GroupUserMetadataInteractionsBlock = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('block') }})
    r"""Information related to the block status of this user."""  
    follow: GroupUserMetadataInteractionsFollow = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('follow') }})
    r"""Information related to the followed status of this user."""  
    report: GroupUserMetadataInteractionsReport = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('report') }})
    r"""Information regarding where and how to report a user."""  
    add_privacy_user: Optional[GroupUserMetadataInteractionsAddPrivacyUser] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('add_privacy_user'), 'exclude': lambda f: f is None }})  
...
class GroupUserMetadata:
    ...
    connections: GroupUserMetadataConnections = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connections') }})
    r"""The list of resource URIs related to the user."""  
    interactions: GroupUserMetadataInteractions = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('interactions') }})  
...
class GroupUserPreferencesVideosPrivacy:
    ...
    comments: Optional[GroupUserPreferencesVideosPrivacyCommentsEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('comments'), 'exclude': lambda f: f is None }})
    r"""The user's privacy preference for comments:
    ...
    embed: Optional[GroupUserPreferencesVideosPrivacyEmbedEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('embed'), 'exclude': lambda f: f is None }})
    r"""The user's privacy preference for embeds:
     ...
     * `whitelist` - Only those on the whitelist can embed the user's videos.
    """  
    view: Optional[GroupUserPreferencesVideosPrivacyViewEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('view'), 'exclude': lambda f: f is None }})
    r"""The user's privacy preference for views:
...
class GroupUserPreferencesVideos:
    ...
    privacy: Optional[GroupUserPreferencesVideosPrivacy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('privacy'), 'exclude': lambda f: f is None }})  
...
class GroupUserPreferences:
    ...
    videos: Optional[GroupUserPreferencesVideos] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('videos'), 'exclude': lambda f: f is None }})  
...
class GroupUserUploadQuotaSpace:
    ...
    showing: GroupUserUploadQuotaSpaceShowingEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('showing') }})
    r"""Whether the values of the upload_quota.space fields are for the lifetime quota or the periodic quota."""  
    used: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('used') }})
...
class GroupUserUploadQuota:
    ...
    lifetime: GroupUserUploadQuotaLifetime = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lifetime') }})
    r"""Information about the user's lifetime upload usage."""  
    periodic: GroupUserUploadQuotaPeriodic = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('periodic') }})
    r"""Information about the user's usage for the current period."""  
    space: GroupUserUploadQuotaSpace = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('space') }})
    r"""Information about the user's upload space remaining for the current period."""  
...
@dataclasses.dataclass
class GroupUser:
    r"""The owner of the group."""
    
    account: GroupUserAccountEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('account') }})
    r"""The user's account type:
    ...
    metadata: GroupUserMetadata = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metadata') }})
    r"""The user's metadata."""  
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})
    ...
    upload_quota: GroupUserUploadQuota = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('upload_quota') }})
    r"""Appears only when the user has upload access and is looking at their own user record."""  
    uri: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('uri') }})
    r"""The user's canonical relative URI."""  
    websites: list[GroupUserWebsites] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('websites') }})
    r"""The user's websites."""  
    content_filter: Optional[GroupUserContentFilterEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('content_filter'), 'exclude': lambda f: f is None }})
    r"""The user's content filters:
    ...
    preferences: Optional[GroupUserPreferences] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('preferences'), 'exclude': lambda f: f is None }})  
...
class Group:
    ...
    created_time: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('created_time') }})
    r"""The time in ISO 8601 format when the group was created."""  
    description: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('description') }})
    r"""The group's description."""  
    link: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('link') }})
    r"""The link to the group."""  
    metadata: GroupMetadata = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metadata') }})
    r"""Metadata about the group."""  
    modified_time: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('modified_time') }})
    r"""The time in ISO 8601 format when the group was last modified."""  
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})
    r"""The group's display name."""  
    pictures: shared_picture.Picture = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pictures') }})
    r"""The active picture for this group."""  
    privacy: GroupPrivacy = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('privacy') }})
    r"""The group's privacy settings."""  
    resource_key: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resource_key') }})
    r"""The resource key of the group."""  
    uri: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('uri') }})
    r"""The canonical relative URI of this group."""  
    user: Optional[GroupUser] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('user'), 'exclude': lambda f: f is None }})
    r"""The owner of the group."""  
