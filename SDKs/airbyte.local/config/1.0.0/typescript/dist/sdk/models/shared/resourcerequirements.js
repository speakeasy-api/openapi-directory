...
var ResourceRequirements = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cpu_limit" }),
        __metadata("design:type", String)
    ], ResourceRequirements.prototype, "cpuLimit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cpu_request" }),
        __metadata("design:type", String)
    ], ResourceRequirements.prototype, "cpuRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=memory_limit" }),
        __metadata("design:type", String)
    ], ResourceRequirements.prototype, "memoryLimit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=memory_request" }),
        __metadata("design:type", String)
