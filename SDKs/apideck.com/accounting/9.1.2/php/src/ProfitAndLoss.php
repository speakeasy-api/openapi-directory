...
class ProfitAndLoss 
{
     ...
     * Get Profit and Loss
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ProfitAndLossOneRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ProfitAndLossOneSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ProfitAndLossOneResponse
     */
	public function profitAndLossOne(
        \OpenAPI\OpenAPI\Models\Operations\ProfitAndLossOneRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ProfitAndLossOneSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ProfitAndLossOneResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/accounting/profit-and-loss');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ProfitAndLossOneRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ProfitAndLossOneResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->getProfitAndLossResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetProfitAndLossResponse', 'json');
            }
        }
