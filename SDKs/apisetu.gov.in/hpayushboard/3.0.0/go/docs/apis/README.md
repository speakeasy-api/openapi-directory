...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Rpcer(ctx, operations.RpcerRequestBody{
        CertificateParameters: &operations.RpcerRequestBodyCertificateParameters{
            FullName: "Sunil Kumar",
            RegistrationNo: "1011-I",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
            Consent: shared.ConsentArtifactSchemaConsent{
                ConsentID: "ea9c43aa-7f5a-4bf3-a0be-e1caa24737ba",
        ...
        Format: operations.RpcerRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.RpcerSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
