...
public class ListVoiceCountryListVoiceCountryResponse {
    ...
    public openapisdk.models.shared.PricingV2VoiceVoiceCountry[] countries;
    public ListVoiceCountryListVoiceCountryResponse withCountries(openapisdk.models.shared.PricingV2VoiceVoiceCountry[] countries) {
