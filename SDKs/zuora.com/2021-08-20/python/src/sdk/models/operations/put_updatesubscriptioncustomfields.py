...
class PutUpdateSubscriptionCustomFieldsPathParams:
    subscription_number: str = dataclasses.field(metadata={'path_param': { 'field_name': 'subscriptionNumber', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PutUpdateSubscriptionCustomFieldsHeaders:
    zuora_entity_ids: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Entity-Ids', 'style': 'simple', 'explode': False }})
    zuora_track_id: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Track-Id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PutUpdateSubscriptionCustomFieldsRequest:
    headers: PutUpdateSubscriptionCustomFieldsHeaders = dataclasses.field()
    path_params: PutUpdateSubscriptionCustomFieldsPathParams = dataclasses.field()
...
@dataclasses.dataclass
class PutUpdateSubscriptionCustomFieldsResponse:
