...
class AppengineProjectsLocationsApplicationsRepairPathParams:
...
@dataclasses.dataclass
class AppengineProjectsLocationsApplicationsRepairQueryParams:
...
@dataclasses.dataclass
class AppengineProjectsLocationsApplicationsRepairSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class AppengineProjectsLocationsApplicationsRepairRequest:
    path_params: AppengineProjectsLocationsApplicationsRepairPathParams = dataclasses.field()
    query_params: AppengineProjectsLocationsApplicationsRepairQueryParams = dataclasses.field()
    security: AppengineProjectsLocationsApplicationsRepairSecurity = dataclasses.field()
    request: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class AppengineProjectsLocationsApplicationsRepairResponse:
