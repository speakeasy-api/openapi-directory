            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV1ServiceChannel = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ChatV1ServiceChannel);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createCredential = function (req, security, serverURL, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV1Credential = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ChatV1Credential);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createInvite = function (req, security, serverURL, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV1ServiceChannelInvite = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ChatV1ServiceChannelInvite);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createMember = function (req, security, serverURL, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV1ServiceChannelMember = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ChatV1ServiceChannelMember);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createMessage = function (req, security, serverURL, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV1ServiceChannelMessage = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ChatV1ServiceChannelMessage);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createRole = function (req, security, serverURL, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV1ServiceRole = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ChatV1ServiceRole);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createService = function (req, security, serverURL, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV1Service = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ChatV1Service);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createUser = function (req, security, serverURL, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV1ServiceUser = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ChatV1ServiceUser);
                    }
                    break;
            }
            return res;
