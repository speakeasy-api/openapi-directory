...
public class DrvlcSecurity {
    ...
    public DrvlcSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public DrvlcSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public DrvlcSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
