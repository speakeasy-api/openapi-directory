 ...
 *
 */
export declare enum PaymentInstrumentStatusEnum {
    Active = "Active",
    Closed = "Closed",
    Inactive = "Inactive",
    Lost = "Lost",
 ...
 */
export declare enum PaymentInstrumentTypeEnum {
 ...
 */
export declare class PaymentInstrument extends SpeakeasyBase {
    /**
     ...
     *
     */
    status?: PaymentInstrumentStatusEnum;
    /**
     * Type of payment instrument.
     *
     * @remarks
     ...
     * Possible value: **card**, **bankAccount**.
     */
    type: PaymentInstrumentTypeEnum;
}
