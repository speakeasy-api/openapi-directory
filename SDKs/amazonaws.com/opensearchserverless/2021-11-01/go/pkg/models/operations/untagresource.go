...
const (
	UntagResourceXAmzTargetEnumOpenSearchServerlessUntagResource UntagResourceXAmzTargetEnum = "OpenSearchServerless.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "OpenSearchServerless.UntagResource":
