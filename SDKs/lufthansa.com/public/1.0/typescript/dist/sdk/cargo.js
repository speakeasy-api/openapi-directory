...
var Cargo = /** @class */ (function () {
    ...
    **/
    Cargo.prototype.cargoGetRouteFromDateProductCodeByOriginAndDestinationGet = function (req, config) {
    ...
    **/
    Cargo.prototype.cargoShipmentTrackingByAwbPrefixAndAwbNumberGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
