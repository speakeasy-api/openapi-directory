...
var RichResultsInspectionResult = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: detecteditems_1.DetectedItems }),
        (0, class_transformer_1.Expose)({ name: "detectedItems" }),
        (0, class_transformer_1.Type)(function () { return detecteditems_1.DetectedItems; }),
