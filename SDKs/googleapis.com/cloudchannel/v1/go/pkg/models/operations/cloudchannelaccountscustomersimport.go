...
type CloudchannelAccountsCustomersImportSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudchannelAccountsCustomersImportPathParams struct {
...
type CloudchannelAccountsCustomersImportQueryParams struct {
	// V1 error format.
...
type CloudchannelAccountsCustomersImportRequest struct {
	PathParams  CloudchannelAccountsCustomersImportPathParams
	QueryParams CloudchannelAccountsCustomersImportQueryParams
	Request     *shared.GoogleCloudChannelV1ImportCustomerRequest `request:"mediaType=application/json"`
	Security    CloudchannelAccountsCustomersImportSecurity
}

type CloudchannelAccountsCustomersImportResponse struct {
	ContentType string
	// Successful response
