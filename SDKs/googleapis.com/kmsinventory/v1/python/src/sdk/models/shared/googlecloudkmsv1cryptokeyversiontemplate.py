...
class GoogleCloudKmsV1CryptoKeyVersionTemplateAlgorithmEnum(str, Enum):
...
class GoogleCloudKmsV1CryptoKeyVersionTemplateProtectionLevelEnum(str, Enum):
...
class GoogleCloudKmsV1CryptoKeyVersionTemplate:
    ...
    algorithm: Optional[GoogleCloudKmsV1CryptoKeyVersionTemplateAlgorithmEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('algorithm'), 'exclude': lambda f: f is None }})
    r"""Required. Algorithm to use when creating a CryptoKeyVersion based on this template. For backwards compatibility, GOOGLE_SYMMETRIC_ENCRYPTION is implied if both this field is omitted and CryptoKey.purpose is ENCRYPT_DECRYPT."""  
    protection_level: Optional[GoogleCloudKmsV1CryptoKeyVersionTemplateProtectionLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protectionLevel'), 'exclude': lambda f: f is None }})
    r"""ProtectionLevel to use when creating a CryptoKeyVersion based on this template. Immutable. Defaults to SOFTWARE."""  
