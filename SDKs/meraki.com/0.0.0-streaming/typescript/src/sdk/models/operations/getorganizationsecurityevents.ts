...
export class GetOrganizationSecurityEventsRequest extends SpeakeasyBase {
  /**
...
export class GetOrganizationSecurityEventsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getOrganizationSecurityEvents200ApplicationJSONObjects?: Record<
    string,
    any
  >[];
}
