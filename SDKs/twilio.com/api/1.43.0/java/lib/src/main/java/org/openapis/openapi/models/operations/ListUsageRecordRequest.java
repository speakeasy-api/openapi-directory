...
public class ListUsageRecordRequest {
    ...
    public ListUsageRecordRequest withAccountSid(String accountSid) {
    ...
    public org.openapis.openapi.models.shared.UsageRecordEnumCategoryEnum category;

    public ListUsageRecordRequest withCategory(org.openapis.openapi.models.shared.UsageRecordEnumCategoryEnum category) {
    ...
    public ListUsageRecordRequest withEndDate(LocalDate endDate) {
    ...
    public ListUsageRecordRequest withIncludeSubaccounts(Boolean includeSubaccounts) {
    ...
    public ListUsageRecordRequest withStartDate(LocalDate startDate) {
        this.startDate = startDate;
        return this;
    }
    
    public ListUsageRecordRequest(@JsonProperty("AccountSid") String accountSid) {
        this.accountSid = accountSid;
  }
}
