...
class PutWorkflowRunPropertiesRequest:
    ...
    put_workflow_run_properties_request: shared_putworkflowrunpropertiesrequest.PutWorkflowRunPropertiesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
