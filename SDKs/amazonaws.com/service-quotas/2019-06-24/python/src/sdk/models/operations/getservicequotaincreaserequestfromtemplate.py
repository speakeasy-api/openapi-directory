...
class GetServiceQuotaIncreaseRequestFromTemplateRequest:
    ...
    get_service_quota_increase_request_from_template_request: shared_getservicequotaincreaserequestfromtemplaterequest.GetServiceQuotaIncreaseRequestFromTemplateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
