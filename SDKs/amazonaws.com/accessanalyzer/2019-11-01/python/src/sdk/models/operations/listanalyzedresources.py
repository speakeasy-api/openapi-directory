...
class ListAnalyzedResourcesRequestBody:
    ...
    resource_type: Optional[ListAnalyzedResourcesRequestBodyResourceTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceType') }})
    

@dataclasses.dataclass
class ListAnalyzedResourcesRequest:
    headers: ListAnalyzedResourcesHeaders = dataclasses.field()
    query_params: ListAnalyzedResourcesQueryParams = dataclasses.field()
    request: ListAnalyzedResourcesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
