...
public class Operations {
    ...
    **/
    public openapisdk.models.operations.VaultOperationsCancelResponse vaultOperationsCancel(openapisdk.models.operations.VaultOperationsCancelRequest request) throws Exception {
        ...
        openapisdk.models.operations.VaultOperationsCancelResponse res = new openapisdk.models.operations.VaultOperationsCancelResponse() {{
            empty = null;
        }};
    ...
    **/
    public openapisdk.models.operations.VaultOperationsDeleteResponse vaultOperationsDelete(openapisdk.models.operations.VaultOperationsDeleteRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        openapisdk.models.operations.VaultOperationsDeleteResponse res = new openapisdk.models.operations.VaultOperationsDeleteResponse() {{
            empty = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.VaultOperationsListResponse vaultOperationsList(openapisdk.models.operations.VaultOperationsListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/{name}", request.pathParams);
        ...
        openapisdk.models.operations.VaultOperationsListResponse res = new openapisdk.models.operations.VaultOperationsListResponse() {{
