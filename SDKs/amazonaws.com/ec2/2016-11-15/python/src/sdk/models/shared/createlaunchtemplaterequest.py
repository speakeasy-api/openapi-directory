...
class CreateLaunchTemplateRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateLaunchTemplateRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateLaunchTemplateRequestTagSpecifications:
    ...
    resource_type: Optional[CreateLaunchTemplateRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateLaunchTemplateRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateLaunchTemplateRequest:
    ...
    tag_specifications: Optional[list[CreateLaunchTemplateRequestTagSpecifications]] = dataclasses.field(default=None)  
