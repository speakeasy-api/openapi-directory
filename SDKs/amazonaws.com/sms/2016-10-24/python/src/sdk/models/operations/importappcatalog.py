...
from ..shared import importappcatalogrequest as shared_importappcatalogrequest
...
class ImportAppCatalogHeaders:
    x_amz_target: ImportAppCatalogXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ImportAppCatalogRequest:
    headers: ImportAppCatalogHeaders = dataclasses.field()
    request: shared_importappcatalogrequest.ImportAppCatalogRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class ImportAppCatalogResponse:
    ...
    import_app_catalog_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
