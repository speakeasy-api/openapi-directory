...
class CreateTrafficMirrorSessionRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateTrafficMirrorSessionRequestTagSpecifications:
    ...
    resource_type: Optional[CreateTrafficMirrorSessionRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateTrafficMirrorSessionRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateTrafficMirrorSessionRequest:
    ...
    session_number: int = dataclasses.field()  
    traffic_mirror_filter_id: str = dataclasses.field()  
    traffic_mirror_target_id: str = dataclasses.field()  
    ...
    tag_specifications: Optional[list[CreateTrafficMirrorSessionRequestTagSpecifications]] = dataclasses.field(default=None)  
