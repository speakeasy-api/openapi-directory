...
public class CreateFilePaymentConsentsConsentIdFileHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateFilePaymentConsentsConsentIdFileHeaders withAuthorization(String authorization) {
        this.authorization = authorization;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-customer-user-agent")
    public String xCustomerUserAgent;
    public CreateFilePaymentConsentsConsentIdFileHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateFilePaymentConsentsConsentIdFileHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateFilePaymentConsentsConsentIdFileHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
        this.xFapiCustomerIpAddress = xFapiCustomerIpAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-fapi-interaction-id")
    public String xFapiInteractionId;
    public CreateFilePaymentConsentsConsentIdFileHeaders withXFapiInteractionId(String xFapiInteractionId) {
        this.xFapiInteractionId = xFapiInteractionId;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-idempotency-key")
    public String xIdempotencyKey;
    public CreateFilePaymentConsentsConsentIdFileHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateFilePaymentConsentsConsentIdFileHeaders withXJwsSignature(String xJwsSignature) {
