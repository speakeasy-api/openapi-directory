...
class GetDirectionsOutputFormatRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetDirectionsOutputFormatCriteriaEnum $criteria
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=criteria')]
    public ?GetDirectionsOutputFormatCriteriaEnum $criteria = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetDirectionsOutputFormatDistanceUnitEnum $distanceUnit
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=distanceUnit')]
    public ?GetDirectionsOutputFormatDistanceUnitEnum $distanceUnit = null;
    
    /**
     * Format of representation
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\GetDirectionsOutputFormatOutputFormatEnum $outputFormat
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetDirectionsOutputFormatOutputSrsEnum $outputSRS
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=outputSRS')]
    public ?GetDirectionsOutputFormatOutputSrsEnum $outputSRS = null;
	...
	public function __construct()
	{
		...
		$this->outputFormat = \OpenAPI\OpenAPI\Models\Operations\GetDirectionsOutputFormatOutputFormatEnum::JSON;
		$this->outputSRS = null;
		$this->points = "";
		$this->roundTrip = null;
