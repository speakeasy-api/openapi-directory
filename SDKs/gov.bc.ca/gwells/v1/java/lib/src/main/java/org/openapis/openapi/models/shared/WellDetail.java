...
public class WellDetail {
    ...
    public WellDetailAlternativeSpecsSubmittedIfRequiredEnum alternativeSpecsSubmitted;
    public WellDetail withAlternativeSpecsSubmitted(WellDetailAlternativeSpecsSubmittedIfRequiredEnum alternativeSpecsSubmitted) {
    ...
    public WellDetailHydroFracturingPerformedEnum hydroFracturingPerformed;
    public WellDetail withHydroFracturingPerformed(WellDetailHydroFracturingPerformedEnum hydroFracturingPerformed) {
    ...
    public WellDetailWellDisinfectedEnum wellDisinfected;
    public WellDetail withWellDisinfected(WellDetailWellDisinfectedEnum wellDisinfected) {
    ...
    public WellDetailOrientationOfWellEnum wellOrientation;
    public WellDetail withWellOrientation(WellDetailOrientationOfWellEnum wellOrientation) {
