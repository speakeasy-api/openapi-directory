...
from ..shared import googlecloudretailv2completequeryresponse as shared_googlecloudretailv2completequeryresponse
...
class RetailProjectsLocationsCatalogsCompleteQueryResponse:
    ...
    google_cloud_retail_v2_complete_query_response: Optional[shared_googlecloudretailv2completequeryresponse.GoogleCloudRetailV2CompleteQueryResponse] = dataclasses.field(default=None)
