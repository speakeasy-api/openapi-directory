...
from ..shared import proxycreaterefund as shared_proxycreaterefund
...
class ObjectPOSTRefundRequest:
    ...
    proxy_create_refund: shared_proxycreaterefund.ProxyCreateRefund = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
