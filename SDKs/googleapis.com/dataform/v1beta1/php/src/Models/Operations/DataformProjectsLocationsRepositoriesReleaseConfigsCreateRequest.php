...
class DataformProjectsLocationsRepositoriesReleaseConfigsCreateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\ReleaseConfigInput $releaseConfigInput = null;
