...
class GetCreditsSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    
class GetCreditsCreditableTypeEnum(str, Enum):
    r"""Limit the result to credits linked to this type of entity only.
...
class GetCreditsRequest:
    ...
    r"""Limit the result to credits for the entity with this ID only. If the entity is not
...
class GetCredits400ApplicationVndAPIPlusJSONErrors:
    ...
    source: Optional[GetCredits400ApplicationVndAPIPlusJSONErrorsSource] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('source'), 'exclude': lambda f: f is None }})
    r"""An object containing references to the source of the error, optionally including any of the following members."""  
...
class GetCredits400ApplicationVndAPIPlusJSON:
    ...
    errors: Optional[list[GetCredits400ApplicationVndAPIPlusJSONErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errors'), 'exclude': lambda f: f is None }})
...
class GetCredits200ApplicationVndAPIPlusJSON:
    ...
    data: Optional[list[shared_credit.Credit]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
