...
from ..shared import generatedatakeypairrequest as shared_generatedatakeypairrequest
from ..shared import generatedatakeypairresponse as shared_generatedatakeypairresponse
...
class GenerateDataKeyPairHeaders:
    x_amz_target: GenerateDataKeyPairXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GenerateDataKeyPairRequest:
    headers: GenerateDataKeyPairHeaders = dataclasses.field()
    request: shared_generatedatakeypairrequest.GenerateDataKeyPairRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GenerateDataKeyPairResponse:
    ...
    generate_data_key_pair_response: Optional[shared_generatedatakeypairresponse.GenerateDataKeyPairResponse] = dataclasses.field(default=None)
