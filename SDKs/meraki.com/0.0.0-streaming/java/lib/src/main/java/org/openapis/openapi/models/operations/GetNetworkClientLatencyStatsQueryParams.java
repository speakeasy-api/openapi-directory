...
public class GetNetworkClientLatencyStatsQueryParams {
    /**
     * Filter results by AP Tag
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=apTag")
    public String apTag;
    public GetNetworkClientLatencyStatsQueryParams withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkClientLatencyStatsQueryParams withBand(GetNetworkClientLatencyStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public GetNetworkClientLatencyStatsQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public Long ssid;
    public GetNetworkClientLatencyStatsQueryParams withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetNetworkClientLatencyStatsQueryParams withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetNetworkClientLatencyStatsQueryParams withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkClientLatencyStatsQueryParams withTimespan(Float timespan) {
    ...
    public Long vlan;
    public GetNetworkClientLatencyStatsQueryParams withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
