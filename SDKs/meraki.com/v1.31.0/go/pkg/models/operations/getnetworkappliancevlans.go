...
func (e *GetNetworkApplianceVlans200ApplicationJSONDhcpHandlingEnum) UnmarshalJSON(data []byte) error {
	...
	case "Run a DHCP server":
		*e = GetNetworkApplianceVlans200ApplicationJSONDhcpHandlingEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkApplianceVlans200ApplicationJSONDhcpHandlingEnum: %s", s)
	}
}
...
func (e *GetNetworkApplianceVlans200ApplicationJSONDhcpLeaseTimeEnum) UnmarshalJSON(data []byte) error {
	...
	case "30 minutes":
		fallthrough
	case "4 hours":
		*e = GetNetworkApplianceVlans200ApplicationJSONDhcpLeaseTimeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkApplianceVlans200ApplicationJSONDhcpLeaseTimeEnum: %s", s)
	}
}
...
func (e *GetNetworkApplianceVlans200ApplicationJSONDhcpOptionsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "ip":
		fallthrough
	case "text":
		*e = GetNetworkApplianceVlans200ApplicationJSONDhcpOptionsTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkApplianceVlans200ApplicationJSONDhcpOptionsTypeEnum: %s", s)
	}
}
...
func (e *GetNetworkApplianceVlans200ApplicationJSONIpv6PrefixAssignmentsOriginTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "independent":
		fallthrough
	case "internet":
		*e = GetNetworkApplianceVlans200ApplicationJSONIpv6PrefixAssignmentsOriginTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkApplianceVlans200ApplicationJSONIpv6PrefixAssignmentsOriginTypeEnum: %s", s)
	}
}
...
func (e *GetNetworkApplianceVlans200ApplicationJSONTemplateVlanTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "same":
		fallthrough
	case "unique":
		*e = GetNetworkApplianceVlans200ApplicationJSONTemplateVlanTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkApplianceVlans200ApplicationJSONTemplateVlanTypeEnum: %s", s)
	}
}
