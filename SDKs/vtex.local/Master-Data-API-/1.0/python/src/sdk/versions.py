...
class Versions:
    ...
    def getversion(self, request: operations.GetversionRequest) -> operations.GetversionResponse:
        ...
        url = utils.generate_url(operations.GetversionRequest, base_url, '/api/dataentities/{dataEntityName}/documents/{id}/versions/{versionId}', request)
    ...
    def listversions(self, request: operations.ListversionsRequest) -> operations.ListversionsResponse:
        ...
        url = utils.generate_url(operations.ListversionsRequest, base_url, '/api/dataentities/{dataEntityName}/documents/{id}/versions', request)
    ...
    def putversion(self, request: operations.PutversionRequest) -> operations.PutversionResponse:
        ...
        url = utils.generate_url(operations.PutversionRequest, base_url, '/api/dataentities/{dataEntityName}/documents/{id}/versions/{versionId}', request)
