...
class PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsPathParams = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsSecurity = dataclasses.field()
