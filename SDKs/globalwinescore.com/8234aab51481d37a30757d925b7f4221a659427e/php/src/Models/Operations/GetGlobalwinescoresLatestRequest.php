...
class GetGlobalwinescoresLatestRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetGlobalwinescoresLatestColorEnum $color
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=color')]
    public ?GetGlobalwinescoresLatestColorEnum $color = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetGlobalwinescoresLatestOrderingEnum $ordering
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=ordering')]
    public ?GetGlobalwinescoresLatestOrderingEnum $ordering = null;
