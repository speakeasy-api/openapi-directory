...
use \OpenAPI\OpenAPI\Models\Operations\CvcerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\CvcerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\CvcerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\CvcerSecurity;
...
try {
    ...
    $request->certificateParameters = new CvcerRequestBodyCertificateParameters();
    $request->certificateParameters->dob = '31-12-1980';
    $request->certificateParameters->vcNo = 'XXXX-XXXXXXXXX';
    ...
    $request->format = CvcerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new CvcerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->cvcer($request, $requestSecurity);
