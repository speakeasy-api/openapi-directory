 ...
 */
export enum CreateTransitGatewayRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateTransitGatewayRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateTransitGatewayRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateTransitGatewayRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  description?: string;
  ...
  @SpeakeasyMetadata({ elemType: CreateTransitGatewayRequestTagSpecifications })
