...
class Execute:
    ...
    def delete_proxy(self, request: operations.DeleteProxyRequest, security: operations.DeleteProxySecurity) -> operations.DeleteProxyResponse:
        r"""DELETE
        ...
        **Note**: Vault will proxy all data to the downstream URL and method/verb in the headers.
        ...
        res = operations.DeleteProxyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.DeleteProxy401ApplicationJSON])
    ...
    def get_proxy(self, request: operations.GetProxyRequest, security: operations.GetProxySecurity) -> operations.GetProxyResponse:
        r"""GET
        ...
        **Note**: Vault will proxy all data to the downstream URL and method/verb in the headers.
        ...
        res = operations.GetProxyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetProxy401ApplicationJSON])
    ...
    def options_proxy(self, request: operations.OptionsProxyRequest, security: operations.OptionsProxySecurity) -> operations.OptionsProxyResponse:
        r"""OPTIONS
        ...
        **Note**: Vault will proxy all data to the downstream URL and method/verb in the headers.
        ...
        http_res = client.request('OPTIONS', url, headers=headers)
        content_type = http_res.headers.get('Content-Type')

        res = operations.OptionsProxyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.OptionsProxy401ApplicationJSON])
    ...
    def patch_proxy(self, request: operations.PatchProxyRequest, security: operations.PatchProxySecurity) -> operations.PatchProxyResponse:
        r"""PATCH
        ...
        **Note**: Vault will proxy all data to the downstream URL and method/verb in the headers.
        ...
        res = operations.PatchProxyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.PatchProxy401ApplicationJSON])
    ...
    def post_proxy(self, request: operations.PostProxyRequest, security: operations.PostProxySecurity) -> operations.PostProxyResponse:
        r"""POST
        ...
        **Note**: Vault will proxy all data to the downstream URL and method/verb in the headers.
        ...
        res = operations.PostProxyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.PostProxy401ApplicationJSON])
    ...
    def put_proxy(self, request: operations.PutProxyRequest, security: operations.PutProxySecurity) -> operations.PutProxyResponse:
        r"""PUT
        ...
        **Note**: Vault will proxy all data to the downstream URL and method/verb in the headers.
        ...
        res = operations.PutProxyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.PutProxy401ApplicationJSON])
