...
export class TypeGadgetsCountdown {
  ...
  searchGadgetsCountdown(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/gadgets_countdown";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchGadgetsCountdownResponse =
        new operations.SearchGadgetsCountdownResponse({
