...
class GetPaymentInitiationScaStatusRequest:
    headers: GetPaymentInitiationScaStatusHeaders = dataclasses.field()
    path_params: GetPaymentInitiationScaStatusPathParams = dataclasses.field()
    security: GetPaymentInitiationScaStatusSecurity = dataclasses.field()
