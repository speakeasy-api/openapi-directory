...
public class BigquerydatatransferProjectsTransferConfigsRunsListPathParams {
    /**
    ...
    public BigquerydatatransferProjectsTransferConfigsRunsListPathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
