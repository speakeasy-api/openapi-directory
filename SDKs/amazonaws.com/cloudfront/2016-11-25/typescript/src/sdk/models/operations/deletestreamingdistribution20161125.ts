...
export class DeleteStreamingDistribution20161125Request extends SpeakeasyBase {
  /**
   * The distribution ID.
   */
...
export class DeleteStreamingDistribution20161125Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
