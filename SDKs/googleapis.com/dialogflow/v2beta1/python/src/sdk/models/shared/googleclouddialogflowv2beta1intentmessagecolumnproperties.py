...
class GoogleCloudDialogflowV2beta1IntentMessageColumnProperties:
    ...
    horizontal_alignment: Optional[GoogleCloudDialogflowV2beta1IntentMessageColumnPropertiesHorizontalAlignmentEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('horizontalAlignment'), 'exclude': lambda f: f is None }})
    r"""Optional. Defines text alignment for all cells in this column."""  
