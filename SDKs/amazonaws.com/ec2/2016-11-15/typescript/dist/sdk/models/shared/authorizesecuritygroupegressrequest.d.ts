 ...
 */
export declare class AuthorizeSecurityGroupEgressRequestIpPermissionsIpRanges extends SpeakeasyBase {
    cidrIp?: string;
    description?: string;
}
/**
 ...
 */
export declare class AuthorizeSecurityGroupEgressRequestIpPermissionsIpv6Ranges extends SpeakeasyBase {
    cidrIpv6?: string;
    description?: string;
}
/**
 ...
 */
export declare class AuthorizeSecurityGroupEgressRequestIpPermissionsPrefixListIds extends SpeakeasyBase {
    description?: string;
    prefixListId?: string;
}
/**
 ...
 */
export declare class AuthorizeSecurityGroupEgressRequestIpPermissionsUserIdGroupPairs extends SpeakeasyBase {
    description?: string;
    groupId?: string;
    groupName?: string;
 ...
 */
export declare class AuthorizeSecurityGroupEgressRequestIpPermissions extends SpeakeasyBase {
    fromPort?: number;
    ipProtocol?: string;
 ...
 */
export declare enum AuthorizeSecurityGroupEgressRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class AuthorizeSecurityGroupEgressRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class AuthorizeSecurityGroupEgressRequestTagSpecifications extends SpeakeasyBase {
...
export declare class AuthorizeSecurityGroupEgressRequest extends SpeakeasyBase {
    cidrIp?: string;
    dryRun?: boolean;
    fromPort?: number;
    groupId: string;
