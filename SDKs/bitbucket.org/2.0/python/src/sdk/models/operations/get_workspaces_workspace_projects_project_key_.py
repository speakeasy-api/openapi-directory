...
class GetWorkspacesWorkspaceProjectsProjectKeyRequest:
    path_params: GetWorkspacesWorkspaceProjectsProjectKeyPathParams = dataclasses.field()
    security: GetWorkspacesWorkspaceProjectsProjectKeySecurity = dataclasses.field()
