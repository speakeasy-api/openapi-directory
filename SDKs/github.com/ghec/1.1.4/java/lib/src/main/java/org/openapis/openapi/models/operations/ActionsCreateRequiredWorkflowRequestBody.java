...
public class ActionsCreateRequiredWorkflowRequestBody {
    /**
     * The ID of the repository that contains the workflow file.
     */
    @JsonProperty("repository_id")
    public String repositoryId;
    public ActionsCreateRequiredWorkflowRequestBody withRepositoryId(String repositoryId) {
    ...
    @JsonProperty("scope")
    public ActionsCreateRequiredWorkflowRequestBodyScopeEnum scope;
    public ActionsCreateRequiredWorkflowRequestBody withScope(ActionsCreateRequiredWorkflowRequestBodyScopeEnum scope) {
        this.scope = scope;
        return this;
    }
    ...
    public ActionsCreateRequiredWorkflowRequestBody withSelectedRepositoryIds(Long[] selectedRepositoryIds) {
    ...
    public ActionsCreateRequiredWorkflowRequestBody withWorkflowFilePath(String workflowFilePath) {
