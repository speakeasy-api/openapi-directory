...
class JobScheduleDisableRequest:
    headers: JobScheduleDisableHeaders = dataclasses.field()
    path_params: JobScheduleDisablePathParams = dataclasses.field()
    query_params: JobScheduleDisableQueryParams = dataclasses.field()
