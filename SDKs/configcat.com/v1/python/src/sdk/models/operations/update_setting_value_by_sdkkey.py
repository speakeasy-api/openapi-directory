...
class UpdateSettingValueBySdkkeyRequest:
    ...
    r"""The key or id of the Setting."""  
    ...
    x_configcat_sdkkey: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'X-CONFIGCAT-SDKKEY', 'style': 'simple', 'explode': False }})
    r"""The ConfigCat SDK Key. (https://app.configcat.com/sdkkey)"""  
