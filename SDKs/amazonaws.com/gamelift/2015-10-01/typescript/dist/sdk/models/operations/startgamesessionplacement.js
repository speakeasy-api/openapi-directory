...
exports.StartGameSessionPlacementResponse = exports.StartGameSessionPlacementRequest = exports.StartGameSessionPlacementXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var StartGameSessionPlacementXAmzTargetEnum;
...
})(StartGameSessionPlacementXAmzTargetEnum = exports.StartGameSessionPlacementXAmzTargetEnum || (exports.StartGameSessionPlacementXAmzTargetEnum = {}));
var StartGameSessionPlacementRequest = /** @class */ (function (_super) {
    ...
    ], StartGameSessionPlacementRequest.prototype, "startGameSessionPlacementInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], StartGameSessionPlacementRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], StartGameSessionPlacementRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], StartGameSessionPlacementRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], StartGameSessionPlacementRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], StartGameSessionPlacementRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], StartGameSessionPlacementRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], StartGameSessionPlacementRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], StartGameSessionPlacementRequest.prototype, "xAmzTarget", void 0);
    return StartGameSessionPlacementRequest;
}(utils_1.SpeakeasyBase));
exports.StartGameSessionPlacementRequest = StartGameSessionPlacementRequest;
var StartGameSessionPlacementResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], StartGameSessionPlacementResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.StartGameSessionPlacementResponse = StartGameSessionPlacementResponse;
