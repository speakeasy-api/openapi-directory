...
class SDK:
    r"""MLB scores, stats, and news API."""
    ...
    def batter_vs_pitcher_stats(self, request: operations.BatterVsPitcherStatsRequest) -> operations.BatterVsPitcherStatsResponse:
        ...
        url = utils.generate_url(operations.BatterVsPitcherStatsRequest, base_url, '/{format}/HitterVsPitcher/{hitterid}/{pitcherid}', request)
        ...
        res = operations.BatterVsPitcherStatsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def player_season_away_stats(self, request: operations.PlayerSeasonAwayStatsRequest) -> operations.PlayerSeasonAwayStatsResponse:
        ...
        url = utils.generate_url(operations.PlayerSeasonAwayStatsRequest, base_url, '/{format}/PlayerSeasonAwayStats/{season}', request)
        ...
        res = operations.PlayerSeasonAwayStatsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def player_season_home_stats(self, request: operations.PlayerSeasonHomeStatsRequest) -> operations.PlayerSeasonHomeStatsResponse:
        ...
        url = utils.generate_url(operations.PlayerSeasonHomeStatsRequest, base_url, '/{format}/PlayerSeasonHomeStats/{season}', request)
        ...
        res = operations.PlayerSeasonHomeStatsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def player_season_split_stats(self, request: operations.PlayerSeasonSplitStatsRequest) -> operations.PlayerSeasonSplitStatsResponse:
        ...
        url = utils.generate_url(operations.PlayerSeasonSplitStatsRequest, base_url, '/{format}/PlayerSeasonSplitStats/{season}/{split}', request)
        ...
        res = operations.PlayerSeasonSplitStatsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def player_season_stats_split_by_team(self, request: operations.PlayerSeasonStatsSplitByTeamRequest) -> operations.PlayerSeasonStatsSplitByTeamResponse:
        ...
        url = utils.generate_url(operations.PlayerSeasonStatsSplitByTeamRequest, base_url, '/{format}/PlayerSeasonStatsSplitByTeam/{season}', request)
        ...
        res = operations.PlayerSeasonStatsSplitByTeamResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def team_hitting_vs_starting_pitcher(self, request: operations.TeamHittingVsStartingPitcherRequest) -> operations.TeamHittingVsStartingPitcherResponse:
        ...
        url = utils.generate_url(operations.TeamHittingVsStartingPitcherRequest, base_url, '/{format}/TeamHittersVsPitcher/{gameid}/{team}', request)
        ...
        res = operations.TeamHittingVsStartingPitcherResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
