...
exports.GetOrganizationApplianceVpnStatusesResponse = exports.GetOrganizationApplianceVpnStatusesRequest = void 0;
...
var GetOrganizationApplianceVpnStatusesRequest = /** @class */ (function (_super) {
    ...
    ], GetOrganizationApplianceVpnStatusesRequest.prototype, "endingBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=networkIds",
        }),
        __metadata("design:type", Array)
    ], GetOrganizationApplianceVpnStatusesRequest.prototype, "networkIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=organizationId",
        }),
        __metadata("design:type", String)
    ], GetOrganizationApplianceVpnStatusesRequest.prototype, "organizationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=perPage",
        }),
        __metadata("design:type", Number)
    ], GetOrganizationApplianceVpnStatusesRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=startingAfter",
        }),
        __metadata("design:type", String)
    ], GetOrganizationApplianceVpnStatusesRequest.prototype, "startingAfter", void 0);
...
var GetOrganizationApplianceVpnStatusesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetOrganizationApplianceVpnStatusesResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Array)
    ], GetOrganizationApplianceVpnStatusesResponse.prototype, "getOrganizationApplianceVpnStatuses200ApplicationJSONObjects", void 0);
