...
class PostRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildPathParams = dataclasses.field()
    security: PostRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildSecurity = dataclasses.field()
