...
class Interconnects 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetIamPolicyRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetIamPolicySecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetIamPolicyResponse
     */
	public function computeInterconnectsGetIamPolicy(
        \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetIamPolicyRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetIamPolicySecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetIamPolicyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/interconnects/{resource}/getIamPolicy', \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetIamPolicyRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetIamPolicyRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetIamPolicyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetMacsecConfigRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetMacsecConfigSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetMacsecConfigResponse
     */
	public function computeInterconnectsGetMacsecConfig(
        \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetMacsecConfigRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetMacsecConfigSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetMacsecConfigResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/interconnects/{interconnect}/getMacsecConfig', \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetMacsecConfigRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetMacsecConfigRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsGetMacsecConfigResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->interconnectsGetMacsecConfigResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\InterconnectsGetMacsecConfigResponse', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsSetIamPolicyRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsSetIamPolicySecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsSetIamPolicyResponse
     */
	public function computeInterconnectsSetIamPolicy(
        \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsSetIamPolicyRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsSetIamPolicySecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsSetIamPolicyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/interconnects/{resource}/setIamPolicy', \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsSetIamPolicyRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "globalSetPolicyRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsSetIamPolicyRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeInterconnectsSetIamPolicyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
