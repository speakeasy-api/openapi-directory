...
// GetQuoteBookmarkToggle - Toggle the user bookmark of the given Quote as a user of the API Key.
func (s *quote) GetQuoteBookmarkToggle(ctx context.Context, request operations.GetQuoteBookmarkToggleRequest, security operations.GetQuoteBookmarkToggleSecurity) (*operations.GetQuoteBookmarkToggleResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/quote/bookmark/toggle"
	...
	res := &operations.GetQuoteBookmarkToggleResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// GetQuoteLikeToggle - Toggle the user like of the given Quote as a user of the API Key.
func (s *quote) GetQuoteLikeToggle(ctx context.Context, request operations.GetQuoteLikeToggleRequest, security operations.GetQuoteLikeToggleSecurity) (*operations.GetQuoteLikeToggleResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/quote/like/toggle"
	...
	res := &operations.GetQuoteLikeToggleResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
