...
exports.ImprovementProgram = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ImprovementProgram = /** @class */ (function () {
    function ImprovementProgram(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    ImprovementProgram.prototype.postImprove = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostImproveRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/improve";
...
exports.ImprovementProgram = ImprovementProgram;
