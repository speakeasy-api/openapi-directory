...
class Metrics 
{
	...
	public const GET_PROMETHEUS_METRICS_SERVERS = [
		'http://localhost:8080',
	];
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetPrometheusMetricsResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/metrics');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetPrometheusMetricsResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'text/plain')) {
                $response->getPrometheusMetrics200TextPlainString = $httpResponse->getBody()->getContents();
            }
        }
