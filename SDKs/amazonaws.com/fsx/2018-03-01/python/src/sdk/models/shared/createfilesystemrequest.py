...
from ..shared import createfilesystemontapconfiguration as shared_createfilesystemontapconfiguration
...
class CreateFileSystemRequest:
    r"""The request object used to create a new Amazon FSx file system."""
    ...
    ontap_configuration: Optional[shared_createfilesystemontapconfiguration.CreateFileSystemOntapConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('OntapConfiguration'), 'exclude': lambda f: f is None }})
