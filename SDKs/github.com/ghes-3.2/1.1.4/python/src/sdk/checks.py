...
class Checks:
    ...
    def checks_create(self, request: operations.ChecksCreateRequest) -> operations.ChecksCreateResponse:
        ...
        **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/checks#create-a-check-run - API method documentation
        """
    ...
    def checks_create_suite(self, request: operations.ChecksCreateSuiteRequest) -> operations.ChecksCreateSuiteResponse:
        ...
        **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array and a `null` value for `head_branch`.
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/checks#create-a-check-suite - API method documentation
        """
        base_url = self._server_url
    ...
    def checks_get(self, request: operations.ChecksGetRequest) -> operations.ChecksGetResponse:
        ...
        **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/checks#get-a-check-run - API method documentation
        """
        base_url = self._server_url
    ...
    def checks_get_suite(self, request: operations.ChecksGetSuiteRequest) -> operations.ChecksGetSuiteResponse:
        ...
        **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array and a `null` value for `head_branch`.
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/checks#get-a-check-suite - API method documentation
        """
        base_url = self._server_url
    ...
    def checks_list_annotations(self, request: operations.ChecksListAnnotationsRequest) -> operations.ChecksListAnnotationsResponse:
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/checks#list-check-run-annotations - API method documentation
        """
        base_url = self._server_url
    ...
    def checks_list_for_ref(self, request: operations.ChecksListForRefRequest) -> operations.ChecksListForRefResponse:
        ...
        **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/checks#list-check-runs-for-a-git-reference - API method documentation
        """
        base_url = self._server_url
    ...
    def checks_list_for_suite(self, request: operations.ChecksListForSuiteRequest) -> operations.ChecksListForSuiteResponse:
        ...
        **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/checks#list-check-runs-in-a-check-suite - API method documentation
        """
        base_url = self._server_url
    ...
    def checks_list_suites_for_ref(self, request: operations.ChecksListSuitesForRefRequest) -> operations.ChecksListSuitesForRefResponse:
        ...
        **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array and a `null` value for `head_branch`.
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/checks#list-check-suites-for-a-git-reference - API method documentation
        """
        base_url = self._server_url
    ...
    def checks_rerequest_suite(self, request: operations.ChecksRerequestSuiteRequest) -> operations.ChecksRerequestSuiteResponse:
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/checks#rerequest-a-check-suite - API method documentation
        """
        base_url = self._server_url
    ...
    def checks_set_suites_preferences(self, request: operations.ChecksSetSuitesPreferencesRequest) -> operations.ChecksSetSuitesPreferencesResponse:
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/checks#update-repository-preferences-for-check-suites - API method documentation
        """
        base_url = self._server_url
    ...
    def checks_update(self, request: operations.ChecksUpdateRequest) -> operations.ChecksUpdateResponse:
        ...
        **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
        ...
        https://docs.github.com/enterprise-server@3.2/rest/reference/checks#update-a-check-run - API method documentation
        """
        base_url = self._server_url
