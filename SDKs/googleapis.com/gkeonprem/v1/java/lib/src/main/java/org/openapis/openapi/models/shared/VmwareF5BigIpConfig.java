...
public class VmwareF5BigIpConfig {
    ...
    public VmwareF5BigIpConfig withAddress(String address) {
    ...
    public VmwareF5BigIpConfig withPartition(String partition) {
    ...
    public VmwareF5BigIpConfig withSnatPool(String snatPool) {
