...
public class GETDeregisterInstanceEventNotificationAttributesRequest {
    ...
    public GETDeregisterInstanceEventNotificationAttributesRequest(@JsonProperty("Action") GETDeregisterInstanceEventNotificationAttributesActionEnum action, @JsonProperty("Version") GETDeregisterInstanceEventNotificationAttributesVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
