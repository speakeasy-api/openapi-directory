 ...
 */
export declare enum CreateSecurityGroupRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateSecurityGroupRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateSecurityGroupRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateSecurityGroupRequest extends SpeakeasyBase {
    description: string;
    dryRun?: boolean;
    groupName: string;
