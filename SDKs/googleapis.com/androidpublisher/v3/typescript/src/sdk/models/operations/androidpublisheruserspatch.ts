...
export class AndroidpublisherUsersPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AndroidpublisherUsersPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AndroidpublisherUsersPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
