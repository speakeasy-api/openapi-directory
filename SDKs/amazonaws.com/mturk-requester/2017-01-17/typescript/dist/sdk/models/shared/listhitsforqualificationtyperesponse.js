...
exports.ListHiTsForQualificationTypeResponse = void 0;
...
var ListHiTsForQualificationTypeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=HITs", elemType: hit_1.Hit }),
        __metadata("design:type", Array)
    ], ListHiTsForQualificationTypeResponse.prototype, "hiTs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], ListHiTsForQualificationTypeResponse.prototype, "nextToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=NumResults" }),
        __metadata("design:type", Number)
    ], ListHiTsForQualificationTypeResponse.prototype, "numResults", void 0);
