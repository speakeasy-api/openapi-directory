...
public class GETDescribeTableRestoreStatusRequest {
    ...
    public GETDescribeTableRestoreStatusRequest(@JsonProperty("Action") GETDescribeTableRestoreStatusActionEnum action, @JsonProperty("Version") GETDescribeTableRestoreStatusVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
