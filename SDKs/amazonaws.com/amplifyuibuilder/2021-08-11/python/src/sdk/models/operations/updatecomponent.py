...
from ..shared import updatecomponentresponse as shared_updatecomponentresponse
...
class UpdateComponentRequestBodyUpdatedComponent:
    r"""Updates and saves all of the information about a component, based on component ID."""
...
class UpdateComponentRequestBody:
    ...
    updated_component: UpdateComponentRequestBodyUpdatedComponent = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('updatedComponent') }})
    r"""Updates and saves all of the information about a component, based on component ID."""  
...
class UpdateComponentRequest:
    ...
    r"""The unique ID for the component."""  
    request_body: UpdateComponentRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdateComponentResponse:
    ...
    update_component_response: Optional[shared_updatecomponentresponse.UpdateComponentResponse] = dataclasses.field(default=None)
    r"""Success"""  
