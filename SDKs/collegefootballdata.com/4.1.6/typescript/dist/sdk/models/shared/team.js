...
exports.Team = exports.TeamLocation = void 0;
...
var TeamLocation = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=year_constructed" }),
        __metadata("design:type", Number)
...
exports.TeamLocation = TeamLocation;
var Team = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=alt_color" }),
        __metadata("design:type", String)
    ], Team.prototype, "altColor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=alt_name_1" }),
        __metadata("design:type", String)
    ], Team.prototype, "altName1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=alt_name_2" }),
        __metadata("design:type", String)
    ], Team.prototype, "altName2", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=alt_name_3" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mascot" }),
        __metadata("design:type", String)
