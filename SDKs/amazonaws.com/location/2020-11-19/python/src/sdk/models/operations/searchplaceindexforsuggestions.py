...
from ..shared import searchplaceindexforsuggestionsresponse as shared_searchplaceindexforsuggestionsresponse
...
class SearchPlaceIndexForSuggestionsRequestBody:
    
    text: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Text') }})
    r"""The free-form partial text to use to generate place suggestions. For example, <code>eiffel tow</code>."""  
    ...
    r"""<p>An optional parameter. The maximum number of results returned per request. </p> <p>The default: <code>5</code> </p>"""  
...
class SearchPlaceIndexForSuggestionsRequest:
    ...
    request_body: SearchPlaceIndexForSuggestionsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class SearchPlaceIndexForSuggestionsResponse:
    ...
    search_place_index_for_suggestions_response: Optional[shared_searchplaceindexforsuggestionsresponse.SearchPlaceIndexForSuggestionsResponse] = dataclasses.field(default=None)
    r"""Success"""  
