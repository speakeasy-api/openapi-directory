...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            if (res.chatV2ServiceChannelChannelWebhook != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            if (res.chatV2ServiceChannelInvite != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            if (res.chatV2ServiceChannelMember != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            if (res.chatV2ServiceChannelMessage != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import org.openapis.openapi.models.shared.UserChannelEnumWebhookEnabledTypeEnum;
    ...
    public static void main(String[] args) {
        try {
            ...
            DeleteUserChannelRequest req = new DeleteUserChannelRequest("dolore", "iusto", "dicta") {{
                xTwilioWebhookEnabled = UserChannelEnumWebhookEnabledTypeEnum.FALSE;
            }};            

            DeleteUserChannelResponse res = sdk.sdk.deleteUserChannel(req, new DeleteUserChannelSecurity("enim", "accusamus") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FetchBindingRequest req = new FetchBindingRequest("commodi", "repudiandae");            

            FetchBindingResponse res = sdk.sdk.fetchBinding(req, new FetchBindingSecurity("quae", "ipsum") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});

            if (res.chatV2ServiceBinding != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FetchChannelRequest req = new FetchChannelRequest("quidem", "molestias");            

            FetchChannelResponse res = sdk.sdk.fetchChannel(req, new FetchChannelSecurity("excepturi", "pariatur") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FetchChannelWebhookRequest req = new FetchChannelWebhookRequest("modi", "praesentium", "rem");            

            FetchChannelWebhookResponse res = sdk.sdk.fetchChannelWebhook(req, new FetchChannelWebhookSecurity("voluptates", "quasi") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FetchCredentialRequest req = new FetchCredentialRequest("repudiandae");            

            FetchCredentialResponse res = sdk.sdk.fetchCredential(req, new FetchCredentialSecurity("sint", "veritatis") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FetchInviteRequest req = new FetchInviteRequest("itaque", "incidunt", "enim");            

            FetchInviteResponse res = sdk.sdk.fetchInvite(req, new FetchInviteSecurity("consequatur", "est") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FetchMemberRequest req = new FetchMemberRequest("quibusdam", "explicabo", "deserunt");            

            FetchMemberResponse res = sdk.sdk.fetchMember(req, new FetchMemberSecurity("distinctio", "quibusdam") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FetchMessageRequest req = new FetchMessageRequest("labore", "modi", "qui");            

            FetchMessageResponse res = sdk.sdk.fetchMessage(req, new FetchMessageSecurity("aliquid", "cupiditate") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FetchRoleRequest req = new FetchRoleRequest("quos", "perferendis");            

            FetchRoleResponse res = sdk.sdk.fetchRole(req, new FetchRoleSecurity("magni", "assumenda") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FetchServiceResponse res = sdk.sdk.fetchService(req, new FetchServiceSecurity("alias", "fugit") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FetchUserRequest req = new FetchUserRequest("dolorum", "excepturi");            

            FetchUserResponse res = sdk.sdk.fetchUser(req, new FetchUserSecurity("tempora", "facilis") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FetchUserBindingRequest req = new FetchUserBindingRequest("tempore", "labore", "delectus");            

            FetchUserBindingResponse res = sdk.sdk.fetchUserBinding(req, new FetchUserBindingSecurity("eum", "non") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});

            if (res.chatV2ServiceUserUserBinding != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FetchUserChannelRequest req = new FetchUserChannelRequest("eligendi", "sint", "aliquid");            

            FetchUserChannelResponse res = sdk.sdk.fetchUserChannel(req, new FetchUserChannelSecurity("provident", "necessitatibus") {{
                password = "YOUR_PASSWORD_HERE";
                username = "YOUR_USERNAME_HERE";
            }});

            if (res.chatV2ServiceUserUserChannel != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ListBindingRequest req = new ListBindingRequest("sint") {{
