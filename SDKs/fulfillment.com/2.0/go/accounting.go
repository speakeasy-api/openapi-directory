...
func newAccounting(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *accounting {
	return &accounting{
...
func (s *accounting) GetAccounting(ctx context.Context, request operations.GetAccountingRequest) (*operations.GetAccountingResponse, error) {
	...
	res := &operations.GetAccountingResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.GetAccountingAccountingArrayV2
