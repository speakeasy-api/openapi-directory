...
public class GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey {
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey withCaseInsensitive(Boolean caseInsensitive) {
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey withContains(String[] contains) {
    ...
    public GoogleCloudRetailV2alphaInterval[] intervals;

    public GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey withIntervals(GoogleCloudRetailV2alphaInterval[] intervals) {
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey withOrderBy(String orderBy) {
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey withPrefixes(String[] prefixes) {
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey withQuery(String query) {
        this.query = query;
        return this;
    }
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey withRestrictedValues(String[] restrictedValues) {
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey withReturnMinMax(Boolean returnMinMax) {
