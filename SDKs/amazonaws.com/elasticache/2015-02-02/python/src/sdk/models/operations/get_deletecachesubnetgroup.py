...
class GetDeleteCacheSubnetGroupQueryParams:
    action: GetDeleteCacheSubnetGroupActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteCacheSubnetGroupVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteCacheSubnetGroupRequest:
    headers: GetDeleteCacheSubnetGroupHeaders = dataclasses.field()
    query_params: GetDeleteCacheSubnetGroupQueryParams = dataclasses.field()
