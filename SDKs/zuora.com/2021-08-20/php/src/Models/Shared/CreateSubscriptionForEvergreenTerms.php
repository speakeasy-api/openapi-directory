...
class CreateSubscriptionForEvergreenTerms
{
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CreateSubscriptionForEvergreenTermsInitialTerm $initialTerm
     */
	#[\JMS\Serializer\Annotation\SerializedName('initialTerm')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateSubscriptionForEvergreenTermsInitialTerm')]
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateSubscriptionForEvergreenTermsRenewalSettingEnum $renewalSetting
     */
	#[\JMS\Serializer\Annotation\SerializedName('renewalSetting')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateSubscriptionForEvergreenTermsRenewalSettingEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateSubscriptionForEvergreenTermsRenewalSettingEnum $renewalSetting = null;
	...
	{
		$this->autoRenew = null;
		$this->initialTerm = new \OpenAPI\OpenAPI\Models\Shared\CreateSubscriptionForEvergreenTermsInitialTerm();
