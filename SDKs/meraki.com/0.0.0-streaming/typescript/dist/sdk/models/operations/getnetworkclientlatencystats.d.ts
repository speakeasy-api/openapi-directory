 ...
 */
export declare enum GetNetworkClientLatencyStatsBandEnum {
    Two4 = "2.4",
    Five = "5"
}
export declare class GetNetworkClientLatencyStatsRequest extends SpeakeasyBase {
    /**
     ...
     * Filter results by band (either '2.4' or '5'). Note that data prior to February 2020 will not have band information.
     */
    band?: GetNetworkClientLatencyStatsBandEnum;
    clientId: string;
    /**
...
export declare class GetNetworkClientLatencyStatsResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
     ...
     */
    getNetworkClientLatencyStats200ApplicationJSONObject?: Record<string, any>;
}
