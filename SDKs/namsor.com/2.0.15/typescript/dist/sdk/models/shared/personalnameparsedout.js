...
exports.PersonalNameParsedOut = void 0;
...
var PersonalNameParsedOut = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=firstLastName" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=nameParserType" }),
        __metadata("design:type", String)
    ], PersonalNameParsedOut.prototype, "nameParserType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=nameParserTypeAlt" }),
        __metadata("design:type", String)
