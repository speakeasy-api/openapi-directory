...
var CreateSubscriptionRequest = /** @class */ (function (_super) {
    ...
    ], CreateSubscriptionRequest.prototype, "merchantApplicationName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=merchantApplicationVersion" }),
        __metadata("design:type", String)
    ], CreateSubscriptionRequest.prototype, "merchantApplicationVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=merchantEmailAlert" }),
        __metadata("design:type", String)
    ], CreateSubscriptionRequest.prototype, "merchantEmailAlert", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], CreateSubscriptionRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=targetUrl" }),
        __metadata("design:type", String)
    ], CreateSubscriptionRequest.prototype, "targetUrl", void 0);
