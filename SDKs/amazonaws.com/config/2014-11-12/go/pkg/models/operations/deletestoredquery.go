...
func (e DeleteStoredQueryXAmzTargetEnum) ToPointer() *DeleteStoredQueryXAmzTargetEnum {
	return &e
}
...
func (e *DeleteStoredQueryXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "StarlingDoveService.DeleteStoredQuery":
		*e = DeleteStoredQueryXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DeleteStoredQueryXAmzTargetEnum: %v", v)
	}
}
