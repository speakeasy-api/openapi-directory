...
func (e *GetNetworkClientsRecentDeviceConnectionsEnum) UnmarshalJSON(data []byte) error {
	...
	case "Wired":
		fallthrough
	case "Wireless":
		*e = GetNetworkClientsRecentDeviceConnectionsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkClientsRecentDeviceConnectionsEnum: %s", s)
	}
}
...
func (e *GetNetworkClientsStatusesEnum) UnmarshalJSON(data []byte) error {
	...
	case "Offline":
		fallthrough
	case "Online":
		*e = GetNetworkClientsStatusesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkClientsStatusesEnum: %s", s)
	}
}
...
func (e *GetNetworkClients200ApplicationJSONRecentDeviceConnectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "Wired":
		fallthrough
	case "Wireless":
		*e = GetNetworkClients200ApplicationJSONRecentDeviceConnectionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkClients200ApplicationJSONRecentDeviceConnectionEnum: %s", s)
	}
}
