...
exports.ListUserChannelResponse = exports.ListUserChannelListUserChannelResponse = exports.ListUserChannelListUserChannelResponseMeta = exports.ListUserChannelRequest = exports.ListUserChannelSecurity = exports.ListUserChannelServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListUserChannelServerList = ["https://chat.twilio.com"];
var ListUserChannelSecurity = /** @class */ (function (_super) {
    ...
    ], ListUserChannelSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListUserChannelSecurity.prototype, "username", void 0);
...
var ListUserChannelRequest = /** @class */ (function (_super) {
    ...
    ], ListUserChannelRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListUserChannelRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListUserChannelRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListUserChannelRequest.prototype, "serviceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=UserSid",
        }),
        __metadata("design:type", String)
    ], ListUserChannelRequest.prototype, "userSid", void 0);
...
var ListUserChannelListUserChannelResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ChatV2ServiceUserUserChannel }),
        (0, class_transformer_1.Expose)({ name: "channels" }),
        (0, class_transformer_1.Type)(function () { return shared.ChatV2ServiceUserUserChannel; }),
        __metadata("design:type", Array)
    ], ListUserChannelListUserChannelResponse.prototype, "channels", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListUserChannelListUserChannelResponseMeta; }),
...
var ListUserChannelResponse = /** @class */ (function (_super) {
    ...
    ], ListUserChannelResponse.prototype, "rawResponse", void 0);
