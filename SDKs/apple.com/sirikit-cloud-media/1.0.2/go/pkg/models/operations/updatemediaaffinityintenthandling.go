...
type UpdateMediaAffinityIntentHandlingRequest struct {
	...
	RequestBody                    []shared.UpdateMediaAffinityIntentHandlingInvocation `request:"mediaType=application/json"`
...
type UpdateMediaAffinityIntentHandlingResponse struct {
	...
	UpdateMediaAffinityIntentHandlingInvocationResponses []shared.UpdateMediaAffinityIntentHandlingInvocationResponse
}
