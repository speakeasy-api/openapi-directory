...
public class UpdateFolderHeaders {
    ...
    public UpdateFolderHeaders withXSdsAuthToken(String xSdsAuthToken) {
    ...
    public UpdateFolderHeaders withXSdsDateFormat(UpdateFolderXSdsDateFormatEnum xSdsDateFormat) {
