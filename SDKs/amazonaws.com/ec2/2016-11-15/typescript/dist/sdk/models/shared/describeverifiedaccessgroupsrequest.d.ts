 ...
 */
export declare class DescribeVerifiedAccessGroupsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeVerifiedAccessGroupsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeVerifiedAccessGroupsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
