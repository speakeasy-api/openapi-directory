...
public class FunctionsDeleteSecurity {
    ...
    public FunctionsDeleteSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public FunctionsDeleteSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public FunctionsDeleteSecurity(@JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.key = key;
        this.project = project;
  }
}
