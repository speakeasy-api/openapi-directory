...
class VideoV1RecordingSettings:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the RecordingSettings resource."""  
    ...
    r"""Whether all recordings are written to the `aws_s3_url`. When `false`, all recordings are stored in our cloud."""  
    ...
    r"""Whether all recordings are stored in an encrypted form. The default is `false`."""  
    ...
    r"""The string that you assigned to describe the resource and show the user in the console"""  
