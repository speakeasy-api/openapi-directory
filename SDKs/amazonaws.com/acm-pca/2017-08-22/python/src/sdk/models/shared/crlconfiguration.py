...
from ..shared import s3objectacl_enum as shared_s3objectacl_enum
...
class CrlConfiguration:
    ...
    custom_cname: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CustomCname') }})
    ...
    s3_object_acl: Optional[shared_s3objectacl_enum.S3ObjectACLEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('S3ObjectAcl') }})
