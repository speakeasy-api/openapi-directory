...
class DfareportingChangeLogsListRequest:
    path_params: DfareportingChangeLogsListPathParams = dataclasses.field()
    query_params: DfareportingChangeLogsListQueryParams = dataclasses.field()
    security: DfareportingChangeLogsListSecurity = dataclasses.field()
