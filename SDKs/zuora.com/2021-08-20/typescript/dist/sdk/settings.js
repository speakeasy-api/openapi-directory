...
var Settings = /** @class */ (function () {
    ...
    Settings.prototype.getListAllSettings = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GETListAllSettingsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    ...
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.listAllSettingsResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ListAllSettingsResponse);
                    }
                    break;
            }
            return res;
    ...
    Settings.prototype.postProcessSettingsBatchRequest = function (req, config) {
        ...
        try {
            _a = utils.serializeRequestBody(req, "settingsBatchRequest", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.POSTProcessSettingsBatchRequestResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
                headers: utils.getHeadersFromResponse(httpRes.headers),
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.settingsBatchResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.SettingsBatchResponse);
                    }
                    break;
            }
            return res;
