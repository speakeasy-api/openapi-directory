...
class SearchBlogentryQueryParams:
    ...
    search_blogentry_blogtext: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.blogentry.blogtext', 'style': 'form', 'explode': True }})
...
class SearchBlogentryRequest:
    query_params: SearchBlogentryQueryParams = dataclasses.field()
