...
class RejectPortfolioShareRequest:
    ...
    reject_portfolio_share_input: shared_rejectportfolioshareinput.RejectPortfolioShareInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
