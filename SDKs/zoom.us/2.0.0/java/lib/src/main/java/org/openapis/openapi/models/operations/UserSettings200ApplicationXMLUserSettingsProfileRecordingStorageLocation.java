...
public class UserSettings200ApplicationXMLUserSettingsProfileRecordingStorageLocation {
    /**
    ...
    public UserSettings200ApplicationXMLUserSettingsProfileRecordingStorageLocation withAllowedValues(String[] allowedValues) {
    ...
    public String value;
    public UserSettings200ApplicationXMLUserSettingsProfileRecordingStorageLocation withValue(String value) {
        this.value = value;
        return this;
    }
