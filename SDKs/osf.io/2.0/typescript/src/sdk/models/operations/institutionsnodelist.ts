 ...
 */
export enum InstitutionsNodeListNodeAttributesCategoryEnum {
  Analysis = "analysis",
 ...
 */
export class InstitutionsNodeListNodeAttributes extends SpeakeasyBase {
  /**
   * The category of the node, as selected by project contributors.
   */
  @SpeakeasyMetadata()
 ...
 */
export class InstitutionsNodeListNodeLinks extends SpeakeasyBase {
  /**
 ...
 */
export class InstitutionsNodeListNodeRelationships extends SpeakeasyBase {
  /**
...
export class InstitutionsNodeListNode extends SpeakeasyBase {
  /**
   * The properties of the node entity.
   */
  @SpeakeasyMetadata()
