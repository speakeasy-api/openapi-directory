...
public class RemoveCustomFieldSettingForPortfolioRequest {
    ...
    public RemoveCustomFieldSettingForPortfolioRequest(@JsonProperty("RequestBody") RemoveCustomFieldSettingForPortfolioRequestBody requestBody, @JsonProperty("portfolio_gid") String portfolioGid) {
        this.requestBody = requestBody;
        this.portfolioGid = portfolioGid;
  }
}
