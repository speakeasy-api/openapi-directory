...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksRerequestRunRequest req = new ChecksRerequestRunRequest(715561L, "quod", "odio");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksRerequestSuiteRequest req = new ChecksRerequestSuiteRequest(630448L, "facilis", "vero");            
        ...
        try {
            ...
            ChecksSetSuitesPreferencesRequest req = new ChecksSetSuitesPreferencesRequest(                new ChecksSetSuitesPreferencesRequestBody() {{
                                autoTriggerChecks = new org.openapis.openapi.models.operations.ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks[]{{
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(844550L, false) {{
                                        appId = 293020L;
                                        setting = false;
                                    }}),
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(194342L, false) {{
                                        appId = 848944L;
                                        setting = false;
                                    }}),
                                }};
