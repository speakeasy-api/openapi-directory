...
public class GetV2CrmUsersJsonQueryParams {
    /**
     * Filters crm users by crm_ids
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=false,name=crm_id")
    public String[] crmId;
    public GetV2CrmUsersJsonQueryParams withCrmId(String[] crmId) {
        this.crmId = crmId;
        return this;
    }
    ...
    public Long[] ids;
    public GetV2CrmUsersJsonQueryParams withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2CrmUsersJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2CrmUsersJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public Long page;
    public GetV2CrmUsersJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2CrmUsersJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2CrmUsersJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2CrmUsersJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public GetV2CrmUsersJsonQueryParams withUserGuid(String[] userGuid) {
    ...
    public Long[] userId;
    public GetV2CrmUsersJsonQueryParams withUserId(Long[] userId) {
        this.userId = userId;
        return this;
    }
