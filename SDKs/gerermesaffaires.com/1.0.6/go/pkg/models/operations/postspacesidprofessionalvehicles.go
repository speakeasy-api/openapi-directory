...
func (e PostSpacesIDProfessionalVehiclesRequestBodyLevelEnum) ToPointer() *PostSpacesIDProfessionalVehiclesRequestBodyLevelEnum {
	return &e
}
...
func (e *PostSpacesIDProfessionalVehiclesRequestBodyLevelEnum) UnmarshalJSON(data []byte) error {
	...
	case "regular":
		fallthrough
	case "public":
		*e = PostSpacesIDProfessionalVehiclesRequestBodyLevelEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostSpacesIDProfessionalVehiclesRequestBodyLevelEnum: %v", v)
	}
}
