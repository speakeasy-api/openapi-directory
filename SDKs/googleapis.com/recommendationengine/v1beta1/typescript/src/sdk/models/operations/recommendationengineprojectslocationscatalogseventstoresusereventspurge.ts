...
export class RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsPurgeSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsPurgeRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsPurgeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
