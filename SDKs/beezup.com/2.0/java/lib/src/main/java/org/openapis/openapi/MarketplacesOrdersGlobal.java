...
public class MarketplacesOrdersGlobal {
    ...
    public org.openapis.openapi.models.operations.GetMarketplaceAccountsSynchronizationResponse getMarketplaceAccountsSynchronization(org.openapis.openapi.models.operations.GetMarketplaceAccountsSynchronizationRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetMarketplaceAccountsSynchronizationRequest.class, request, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.HarvestAllResponse harvestAll(org.openapis.openapi.models.operations.HarvestAllRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.HarvestAllRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
