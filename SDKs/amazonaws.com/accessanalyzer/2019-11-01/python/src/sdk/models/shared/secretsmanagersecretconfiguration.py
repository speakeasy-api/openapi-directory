...
class SecretsManagerSecretConfiguration:
    r"""SecretsManagerSecretConfiguration
    ...
    secret_policy: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('secretPolicy') }})
