...
class ObjectPutFeaturePathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectPutFeatureQueryParams:
...
class ObjectPutFeatureRequest:
    headers: ObjectPutFeatureHeaders = dataclasses.field()
    path_params: ObjectPutFeaturePathParams = dataclasses.field()
    query_params: ObjectPutFeatureQueryParams = dataclasses.field()
