...
exports.ListHistoricalGWSResponse = exports.ListHistoricalGWSRequest = exports.ListHistoricalGWSOrderingEnum = exports.ListHistoricalGWSColorEnum = void 0;
...
var ListHistoricalGWSRequest = /** @class */ (function (_super) {
    ...
    ], ListHistoricalGWSRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=color" }),
        __metadata("design:type", String)
    ], ListHistoricalGWSRequest.prototype, "color", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=is_primeurs",
        }),
        __metadata("design:type", Boolean)
    ], ListHistoricalGWSRequest.prototype, "isPrimeurs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], ListHistoricalGWSRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=lwin" }),
        __metadata("design:type", String)
    ], ListHistoricalGWSRequest.prototype, "lwin", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=lwin_11",
        }),
        __metadata("design:type", String)
    ], ListHistoricalGWSRequest.prototype, "lwin11", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], ListHistoricalGWSRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ordering",
        }),
        __metadata("design:type", String)
    ], ListHistoricalGWSRequest.prototype, "ordering", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=vintage",
        }),
        __metadata("design:type", String)
    ], ListHistoricalGWSRequest.prototype, "vintage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=wine_id",
        }),
        __metadata("design:type", Array)
    ], ListHistoricalGWSRequest.prototype, "wineId", void 0);
...
var ListHistoricalGWSResponse = /** @class */ (function (_super) {
    ...
    ], ListHistoricalGWSResponse.prototype, "rawResponse", void 0);
