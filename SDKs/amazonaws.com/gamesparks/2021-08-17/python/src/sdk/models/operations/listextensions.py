...
from ..shared import listextensionsresult as shared_listextensionsresult
...
class ListExtensionsResponse:
    ...
    list_extensions_result: Optional[shared_listextensionsresult.ListExtensionsResult] = dataclasses.field(default=None)
    r"""Success"""  
