...
var ProductRatePlanCharges = /** @class */ (function () {
    ...
    **/
    ProductRatePlanCharges.prototype.objectDeleteProductRatePlanCharge = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/object/product-rate-plan-charge/{id}", req.pathParams);
    ...
    ProductRatePlanCharges.prototype.objectGetProductRatePlanCharge = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.proxyGetProductRatePlanCharge = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
