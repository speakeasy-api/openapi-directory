...
func (e PostServersIDActionsAddToPlacementGroupActionResponseActionStatusEnum) ToPointer() *PostServersIDActionsAddToPlacementGroupActionResponseActionStatusEnum {
	return &e
}
...
func (e *PostServersIDActionsAddToPlacementGroupActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsAddToPlacementGroupActionResponseActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsAddToPlacementGroupActionResponseActionStatusEnum: %v", v)
	}
}
