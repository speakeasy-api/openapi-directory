...
from ..shared import spectemplatelistvo as shared_spectemplatelistvo
...
class GetSpecTemplateListResponse:
    ...
    spec_template_list_vo: Optional[shared_spectemplatelistvo.SpecTemplateListVO] = dataclasses.field(default=None)
