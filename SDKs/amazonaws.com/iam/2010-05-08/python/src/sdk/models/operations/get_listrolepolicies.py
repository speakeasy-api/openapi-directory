...
class GetListRolePoliciesQueryParams:
    action: GetListRolePoliciesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    role_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'RoleName', 'style': 'form', 'explode': True }})
    version: GetListRolePoliciesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListRolePoliciesRequest:
    headers: GetListRolePoliciesHeaders = dataclasses.field()
    query_params: GetListRolePoliciesQueryParams = dataclasses.field()
