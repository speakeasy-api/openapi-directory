...
export class SecretmanagerProjectsSecretsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SecretmanagerProjectsSecretsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SecretmanagerProjectsSecretsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
