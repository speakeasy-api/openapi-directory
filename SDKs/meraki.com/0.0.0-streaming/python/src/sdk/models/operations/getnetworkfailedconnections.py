...
class GetNetworkFailedConnectionsBandEnum(str, Enum):
...
class GetNetworkFailedConnectionsRequest:
    ...
    band: Optional[GetNetworkFailedConnectionsBandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'band', 'style': 'form', 'explode': True }})
    r"""Filter results by band (either '2.4' or '5'). Note that data prior to February 2020 will not have band information."""  
...
@dataclasses.dataclass
class GetNetworkFailedConnectionsResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    get_network_failed_connections_200_application_json_objects: Optional[list[dict[str, Any]]] = dataclasses.field(default=None)
