...
var HealthInformationNotificationNotificationStatusNotificationStatusResponses = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "hiStatus" }),
        __metadata("design:type", String)
...
var HealthInformationNotificationNotificationStatusNotification = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "hipId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: HealthInformationNotificationNotificationStatusNotificationStatusResponses,
        }),
        (0, class_transformer_1.Expose)({ name: "statusResponses" }),
...
var HealthInformationNotificationNotification = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "doneAt" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "notifier" }),
        (0, class_transformer_1.Type)(function () { return HealthInformationNotificationNotificationNotifier; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "statusNotification" }),
        (0, class_transformer_1.Type)(function () { return HealthInformationNotificationNotificationStatusNotification; }),
...
var HealthInformationNotification = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return HealthInformationNotificationNotification; }),
