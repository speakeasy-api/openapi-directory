...
class CloudtasksProjectsLocationsQueuesTasksCancelLeaseRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\CancelLeaseRequest $cancelLeaseRequest = null;
