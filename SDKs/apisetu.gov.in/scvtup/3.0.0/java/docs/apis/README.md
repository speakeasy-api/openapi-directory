    ...
    public static void main(String[] args) {
        try {
            ...
            SkcerRequestBody req = new SkcerRequestBody(SkcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SkcerRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "7894567860", "Aug 2013,Aug 2014,Aug 2015,Aug 2016,Aug 2017");;
            ...
            SkcerResponse res = sdk.apIs.skcer(req, new SkcerSecurity("maiores", "molestiae") {{
...
import java.time.OffsetDateTime;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.SkmstRequestBody;
import org.openapis.openapi.models.operations.SkmstRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.SkmstRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.SkmstResponse;
import org.openapis.openapi.models.operations.SkmstSecurity;
import org.openapis.openapi.models.shared.ConsentArtifactSchema;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsent;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentData;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentDataConsumer;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SkmstRequestBody req = new SkmstRequestBody(SkmstRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SkmstRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "07275499643", "1,2,3,4,Consolidated", "Aug 2013,Aug 2014,Aug 2015,Aug 2016,Aug 2017");;
            ...
            SkmstResponse res = sdk.apIs.skmst(req, new SkmstSecurity("qui", "impedit") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
