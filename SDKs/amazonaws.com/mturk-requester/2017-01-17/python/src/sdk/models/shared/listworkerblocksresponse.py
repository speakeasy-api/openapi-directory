...
class ListWorkerBlocksResponse:
    ...
    worker_blocks: Optional[list[shared_workerblock.WorkerBlock]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('WorkerBlocks'), 'exclude': lambda f: f is None }})  
