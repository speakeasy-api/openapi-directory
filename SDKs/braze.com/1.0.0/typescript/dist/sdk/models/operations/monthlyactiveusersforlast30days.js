...
exports.MonthlyActiveUsersForLast30DaysResponse = exports.MonthlyActiveUsersForLast30DaysRequest = void 0;
...
var MonthlyActiveUsersForLast30DaysRequest = /** @class */ (function (_super) {
    ...
    ], MonthlyActiveUsersForLast30DaysRequest.prototype, "appId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ending_at",
        }),
        __metadata("design:type", String)
    ], MonthlyActiveUsersForLast30DaysRequest.prototype, "endingAt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=length",
        }),
        __metadata("design:type", String)
    ], MonthlyActiveUsersForLast30DaysRequest.prototype, "length", void 0);
...
var MonthlyActiveUsersForLast30DaysResponse = /** @class */ (function (_super) {
    ...
    ], MonthlyActiveUsersForLast30DaysResponse.prototype, "rawResponse", void 0);
