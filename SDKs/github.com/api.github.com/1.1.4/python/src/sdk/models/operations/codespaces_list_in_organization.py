...
class CodespacesListInOrganizationRequest:
...
@dataclasses.dataclass
class CodespacesListInOrganization200ApplicationJSON:
    r"""Response"""
...
@dataclasses.dataclass
class CodespacesListInOrganizationResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    basic_error: Optional[shared_basic_error.BasicError] = dataclasses.field(default=None)
    r"""Requires authentication"""  
    codespaces_list_in_organization_200_application_json_object: Optional[CodespacesListInOrganization200ApplicationJSON] = dataclasses.field(default=None)
    r"""Response"""  
