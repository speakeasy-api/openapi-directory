...
exports.StopKeyPhrasesDetectionJobResponse = exports.StopKeyPhrasesDetectionJobRequest = exports.StopKeyPhrasesDetectionJobXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var StopKeyPhrasesDetectionJobXAmzTargetEnum;
...
})(StopKeyPhrasesDetectionJobXAmzTargetEnum = exports.StopKeyPhrasesDetectionJobXAmzTargetEnum || (exports.StopKeyPhrasesDetectionJobXAmzTargetEnum = {}));
var StopKeyPhrasesDetectionJobRequest = /** @class */ (function (_super) {
    ...
    ], StopKeyPhrasesDetectionJobRequest.prototype, "stopKeyPhrasesDetectionJobRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], StopKeyPhrasesDetectionJobRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], StopKeyPhrasesDetectionJobRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], StopKeyPhrasesDetectionJobRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], StopKeyPhrasesDetectionJobRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], StopKeyPhrasesDetectionJobRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], StopKeyPhrasesDetectionJobRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], StopKeyPhrasesDetectionJobRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], StopKeyPhrasesDetectionJobRequest.prototype, "xAmzTarget", void 0);
...
var StopKeyPhrasesDetectionJobResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], StopKeyPhrasesDetectionJobResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
