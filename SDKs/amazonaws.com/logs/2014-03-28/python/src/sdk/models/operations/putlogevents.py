...
class PutLogEventsRequest:
    ...
    put_log_events_request: shared_putlogeventsrequest.PutLogEventsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
