...
@dataclasses.dataclass
class AndroidpublisherEditsListingsDeleteQueryParams:
...
class AndroidpublisherEditsListingsDeleteRequest:
    path_params: AndroidpublisherEditsListingsDeletePathParams = dataclasses.field()
    query_params: AndroidpublisherEditsListingsDeleteQueryParams = dataclasses.field()
    security: AndroidpublisherEditsListingsDeleteSecurity = dataclasses.field()
