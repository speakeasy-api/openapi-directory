...
class RevocationConfiguration:
    ...
    crl_configuration: Optional[shared_crlconfiguration.CrlConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CrlConfiguration') }})
    ocsp_configuration: Optional[shared_ocspconfiguration.OcspConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('OcspConfiguration') }})
