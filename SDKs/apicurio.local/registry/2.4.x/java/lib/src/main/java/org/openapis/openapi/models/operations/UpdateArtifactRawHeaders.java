...
public class UpdateArtifactRawHeaders {
    /**
    ...
    public UpdateArtifactRawHeaders withXRegistryDescription(String xRegistryDescription) {
    ...
    public UpdateArtifactRawHeaders withXRegistryDescriptionEncoded(String xRegistryDescriptionEncoded) {
    ...
    public UpdateArtifactRawHeaders withXRegistryName(String xRegistryName) {
    ...
    public UpdateArtifactRawHeaders withXRegistryNameEncoded(String xRegistryNameEncoded) {
    ...
    public UpdateArtifactRawHeaders withXRegistryVersion(String xRegistryVersion) {
