...
class CreateDimensionRequestBody:
    ...
    string_values: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('stringValues') }})
    type: CreateDimensionRequestBodyTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
    tags: Optional[list[shared_tag.Tag]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tags') }})
    

@dataclasses.dataclass
class CreateDimensionRequest:
    headers: CreateDimensionHeaders = dataclasses.field()
    path_params: CreateDimensionPathParams = dataclasses.field()
    request: CreateDimensionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
