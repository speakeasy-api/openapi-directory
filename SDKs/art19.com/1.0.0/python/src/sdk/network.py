...
class Network:
    ...
    def get_networks(self, request: operations.GetNetworksRequest, security: operations.GetNetworksSecurity) -> operations.GetNetworksResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/vnd.api+json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetNetworks200ApplicationVndAPIPlusJSON])
                res.get_networks_200_application_vnd_api_plus_json_object = out
        elif http_res.status_code == 400:
            if utils.match_content_type(content_type, 'application/vnd.api+json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetNetworks400ApplicationVndAPIPlusJSON])
    ...
    def get_networks_id_(self, request: operations.GetNetworksIDRequest, security: operations.GetNetworksIDSecurity) -> operations.GetNetworksIDResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/vnd.api+json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetNetworksID200ApplicationVndAPIPlusJSON])
