...
exports.SendUsersMessagesResponse = exports.SendUsersMessagesRequest = exports.SendUsersMessagesRequestBody = exports.SendUsersMessagesRequestBodySendUsersMessageRequest = void 0;
...
var SendUsersMessagesRequestBodySendUsersMessageRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.DirectMessageConfiguration; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.TemplateConfiguration; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TraceId" }),
        __metadata("design:type", String)
    ], SendUsersMessagesRequestBodySendUsersMessageRequest.prototype, "traceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.EndpointSendConfiguration }),
        (0, class_transformer_1.Expose)({ name: "Users" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], shared.EndpointSendConfiguration);
            }
            return obj;
        }, { toClassOnly: true }),
        __metadata("design:type", Object)
...
var SendUsersMessagesRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "SendUsersMessageRequest" }),
        (0, class_transformer_1.Type)(function () { return SendUsersMessagesRequestBodySendUsersMessageRequest; }),
...
var SendUsersMessagesRequest = /** @class */ (function (_super) {
    ...
    ], SendUsersMessagesRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], SendUsersMessagesRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], SendUsersMessagesRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], SendUsersMessagesRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], SendUsersMessagesRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], SendUsersMessagesRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], SendUsersMessagesRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], SendUsersMessagesRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=application-id",
        }),
        __metadata("design:type", String)
    ], SendUsersMessagesRequest.prototype, "applicationId", void 0);
...
var SendUsersMessagesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], SendUsersMessagesResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
