...
public class GETGETNotificationHistoryDeletionTaskRequest {
    ...
    public GETGETNotificationHistoryDeletionTaskRequest withAuthorization(String authorization) {
    ...
    public GETGETNotificationHistoryDeletionTaskRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETGETNotificationHistoryDeletionTaskRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public String id;
    public GETGETNotificationHistoryDeletionTaskRequest withId(String id) {
        this.id = id;
        return this;
    }
