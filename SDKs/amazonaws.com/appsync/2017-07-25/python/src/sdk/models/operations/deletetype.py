...
class DeleteTypeRequest:
    headers: DeleteTypeHeaders = dataclasses.field()
    path_params: DeleteTypePathParams = dataclasses.field()
...
class DeleteTypeResponse:
    ...
    delete_type_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
