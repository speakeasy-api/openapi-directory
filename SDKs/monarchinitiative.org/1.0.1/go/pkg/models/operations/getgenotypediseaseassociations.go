...
type GetGenotypeDiseaseAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetGenotypeDiseaseAssociationsQueryParams struct {
