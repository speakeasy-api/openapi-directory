...
var FilterLogEventsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: filteredlogevent_1.FilteredLogEvent }),
        (0, class_transformer_1.Expose)({ name: "events" }),
        (0, class_transformer_1.Type)(function () { return filteredlogevent_1.FilteredLogEvent; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: searchedlogstream_1.SearchedLogStream }),
        (0, class_transformer_1.Expose)({ name: "searchedLogStreams" }),
        (0, class_transformer_1.Type)(function () { return searchedlogstream_1.SearchedLogStream; }),
        __metadata("design:type", Array)
