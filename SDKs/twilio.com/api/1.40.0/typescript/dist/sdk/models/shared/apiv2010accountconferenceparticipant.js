...
var ApiV2010AccountConferenceParticipant = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "call_sid_to_coach" }),
        __metadata("design:type", String)
    ], ApiV2010AccountConferenceParticipant.prototype, "callSidToCoach", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "coaching" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "end_conference_on_exit" }),
        __metadata("design:type", Boolean)
    ], ApiV2010AccountConferenceParticipant.prototype, "endConferenceOnExit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "hold" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "start_conference_on_enter" }),
        __metadata("design:type", Boolean)
