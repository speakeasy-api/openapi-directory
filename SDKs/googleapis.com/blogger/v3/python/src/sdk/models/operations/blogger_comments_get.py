...
@dataclasses.dataclass
class BloggerCommentsGetQueryParams:
    ...
    view: Optional[BloggerCommentsGetViewEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class BloggerCommentsGetSecurity:
    option1: Optional[BloggerCommentsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[BloggerCommentsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class BloggerCommentsGetRequest:
    path_params: BloggerCommentsGetPathParams = dataclasses.field()
    query_params: BloggerCommentsGetQueryParams = dataclasses.field()
    security: BloggerCommentsGetSecurity = dataclasses.field()
