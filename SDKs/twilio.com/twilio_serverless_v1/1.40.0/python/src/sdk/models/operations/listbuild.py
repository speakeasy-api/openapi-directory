...
class ListBuildRequest:
    ...
    r"""The SID of the Service to read the Build resources from."""  
...
class ListBuildListBuildResponse:
    ...
    builds: Optional[list[shared_serverless_v1_service_build.ServerlessV1ServiceBuild]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('builds'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListBuildListBuildResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
