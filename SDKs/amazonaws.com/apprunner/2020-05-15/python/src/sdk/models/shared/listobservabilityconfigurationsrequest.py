...
class ListObservabilityConfigurationsRequest:
    ...
    latest_only: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('LatestOnly'), 'exclude': lambda f: f is None }})  
