...
var SocketAddress = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ipv4Compat" }),
        __metadata("design:type", Boolean)
    ], SocketAddress.prototype, "ipv4Compat", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "namedPort" }),
        __metadata("design:type", String)
    ], SocketAddress.prototype, "namedPort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "portValue" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "resolverName" }),
        __metadata("design:type", String)
