...
type TagmanagerAccountsUserPermissionsUpdateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type TagmanagerAccountsUserPermissionsUpdatePathParams struct {
	// GTM UserPermission's API relative path. Example: accounts/{account_id}/user_permissions/{user_permission_id}
	Path string `pathParam:"style=simple,explode=false,name=path"`
}

type TagmanagerAccountsUserPermissionsUpdateQueryParams struct {
	// V1 error format.
...
type TagmanagerAccountsUserPermissionsUpdateRequest struct {
	...
	Request     *shared.UserPermission `request:"mediaType=application/json"`
	Security    TagmanagerAccountsUserPermissionsUpdateSecurity
}

type TagmanagerAccountsUserPermissionsUpdateResponse struct {
	ContentType string
	StatusCode  int
