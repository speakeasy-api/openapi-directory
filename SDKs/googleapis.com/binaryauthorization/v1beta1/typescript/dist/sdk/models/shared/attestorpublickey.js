...
var AttestorPublicKey = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "asciiArmoredPgpPublicKey" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "pkixPublicKey" }),
        (0, class_transformer_1.Type)(function () { return pkixpublickey_1.PkixPublicKey; }),
