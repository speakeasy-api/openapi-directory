...
var VenueApi = /** @class */ (function () {
    function VenueApi(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    VenueApi.prototype.venueApiDelete = function (req, config) {
    ...
    **/
    VenueApi.prototype.venueApiGetList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    VenueApi.prototype.venueApiPostReport = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
