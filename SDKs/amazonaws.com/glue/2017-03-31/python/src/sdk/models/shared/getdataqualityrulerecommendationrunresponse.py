...
class GetDataQualityRuleRecommendationRunResponse:
    ...
    recommended_ruleset: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RecommendedRuleset'), 'exclude': lambda f: f is None }})  
