...
type AndroidenterpriseStorelayoutclustersListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseStorelayoutclustersListPathParams struct {
...
type AndroidenterpriseStorelayoutclustersListQueryParams struct {
	// V1 error format.
...
type AndroidenterpriseStorelayoutclustersListRequest struct {
...
type AndroidenterpriseStorelayoutclustersListResponse struct {
	ContentType string
	StatusCode  int
