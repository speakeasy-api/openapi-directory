...
from ..shared import botrecommendationresults as shared_botrecommendationresults
...
class DescribeBotRecommendationResponse:
    ...
    bot_recommendation_results: Optional[shared_botrecommendationresults.BotRecommendationResults] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('botRecommendationResults'), 'exclude': lambda f: f is None }})  
