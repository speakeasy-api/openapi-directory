...
exports.GetPayInstructionFromEmployeeResponse = exports.GetPayInstructionFromEmployeeRequest = void 0;
...
var GetPayInstructionFromEmployeeRequest = /** @class */ (function (_super) {
    ...
    ], GetPayInstructionFromEmployeeRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetPayInstructionFromEmployeeRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], GetPayInstructionFromEmployeeRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetPayInstructionFromEmployeeRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayInstructionId",
        }),
        __metadata("design:type", String)
    ], GetPayInstructionFromEmployeeRequest.prototype, "payInstructionId", void 0);
...
var GetPayInstructionFromEmployeeResponse = /** @class */ (function (_super) {
    ...
    ], GetPayInstructionFromEmployeeResponse.prototype, "rawResponse", void 0);
