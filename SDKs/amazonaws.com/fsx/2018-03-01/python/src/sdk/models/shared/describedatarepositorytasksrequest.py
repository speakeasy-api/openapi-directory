...
import dataclasses
from ..shared import datarepositorytaskfilter as shared_datarepositorytaskfilter
...
class DescribeDataRepositoryTasksRequest:
    ...
    filters: Optional[list[shared_datarepositorytaskfilter.DataRepositoryTaskFilter]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Filters'), 'exclude': lambda f: f is None }})  
