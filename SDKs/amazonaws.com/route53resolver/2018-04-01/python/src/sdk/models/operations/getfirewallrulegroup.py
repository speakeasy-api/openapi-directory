...
class GetFirewallRuleGroupRequest:
    ...
    get_firewall_rule_group_request: shared_getfirewallrulegrouprequest.GetFirewallRuleGroupRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
