...
public class VideosLanguages {
    ...
    public org.openapis.openapi.models.operations.GetLanguagesResponse getLanguages(org.openapis.openapi.models.operations.GetLanguagesRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetLanguagesQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/vnd.vimeo.language+json")) {
