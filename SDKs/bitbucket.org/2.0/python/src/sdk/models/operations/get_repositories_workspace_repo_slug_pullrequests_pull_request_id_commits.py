...
class GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDCommitsRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDCommitsPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDCommitsSecurity = dataclasses.field()
