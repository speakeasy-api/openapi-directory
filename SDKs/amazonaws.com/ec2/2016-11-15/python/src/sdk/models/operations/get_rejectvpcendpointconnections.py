...
class GETRejectVpcEndpointConnectionsRequest:
    ...
    action: GETRejectVpcEndpointConnectionsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    ...
    version: GETRejectVpcEndpointConnectionsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
