...
class ExtrasTopologyMapsList200ApplicationJSON:
    ...
    results: list[shared_topologymap.TopologyMap] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class ExtrasTopologyMapsListRequest:
    query_params: ExtrasTopologyMapsListQueryParams = dataclasses.field()
...
class ExtrasTopologyMapsListResponse:
    ...
    extras_topology_maps_list_200_application_json_object: Optional[ExtrasTopologyMapsList200ApplicationJSON] = dataclasses.field(default=None)
