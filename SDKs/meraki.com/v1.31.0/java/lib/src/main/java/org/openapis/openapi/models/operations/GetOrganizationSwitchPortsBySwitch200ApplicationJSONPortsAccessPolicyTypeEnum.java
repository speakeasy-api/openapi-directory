 ...
 */
public enum GetOrganizationSwitchPortsBySwitch200ApplicationJSONPortsAccessPolicyTypeEnum {
    ...
    private GetOrganizationSwitchPortsBySwitch200ApplicationJSONPortsAccessPolicyTypeEnum(String value) {
        this.value = value;
    }
}
