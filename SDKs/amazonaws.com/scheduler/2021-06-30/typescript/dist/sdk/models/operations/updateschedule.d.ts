 ...
 */
export declare class UpdateScheduleRequestBodyFlexibleTimeWindow extends SpeakeasyBase {
 ...
 */
export declare enum UpdateScheduleRequestBodyStateEnum {
    Enabled = "ENABLED",
    Disabled = "DISABLED"
}
/**
 ...
 */
export declare class UpdateScheduleRequestBodyTarget extends SpeakeasyBase {
    arn?: string;
...
export declare class UpdateScheduleRequestBody extends SpeakeasyBase {
    /**
