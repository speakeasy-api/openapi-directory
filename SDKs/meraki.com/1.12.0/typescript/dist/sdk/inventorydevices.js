...
exports.InventoryDevices = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var InventoryDevices = /** @class */ (function () {
    function InventoryDevices(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    InventoryDevices.prototype.getOrganizationInventoryDevice = function (req, config) {
    ...
    **/
    InventoryDevices.prototype.getOrganizationInventoryDevices = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.InventoryDevices = InventoryDevices;
