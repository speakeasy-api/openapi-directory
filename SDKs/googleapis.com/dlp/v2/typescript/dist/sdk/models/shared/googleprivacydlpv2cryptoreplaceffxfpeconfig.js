...
var GooglePrivacyDlpV2CryptoReplaceFfxFpeConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=commonAlphabet" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=customAlphabet" }),
        __metadata("design:type", String)
    ], GooglePrivacyDlpV2CryptoReplaceFfxFpeConfig.prototype, "customAlphabet", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=radix" }),
        __metadata("design:type", Number)
    ], GooglePrivacyDlpV2CryptoReplaceFfxFpeConfig.prototype, "radix", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=surrogateInfoType" }),
