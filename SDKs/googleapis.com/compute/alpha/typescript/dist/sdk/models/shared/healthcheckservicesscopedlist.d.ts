 ...
 */
export declare enum HealthCheckServicesScopedListWarningCodeEnum {
...
export declare class HealthCheckServicesScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class HealthCheckServicesScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class HealthCheckServicesScopedList extends SpeakeasyBase {
    /**
