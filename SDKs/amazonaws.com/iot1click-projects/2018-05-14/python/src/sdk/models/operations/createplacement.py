...
class CreatePlacementRequest:
    headers: CreatePlacementHeaders = dataclasses.field()
    path_params: CreatePlacementPathParams = dataclasses.field()
    request: CreatePlacementRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreatePlacementResponse:
    ...
    create_placement_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
