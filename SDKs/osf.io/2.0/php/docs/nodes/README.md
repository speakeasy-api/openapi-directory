...
use \OpenAPI\OpenAPI\Models\Operations\NodesAddonReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesAddonReadRequest();
    $request->nodeId = 'reprehenderit';
    $request->provider = 'ut';

    $response = $sdk->nodes->nodesAddonRead($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesAddonsFoldersListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesAddonsFoldersListRequest();
    $request->nodeId = 'maiores';
    $request->provider = 'dicta';

    $response = $sdk->nodes->nodesAddonsFoldersList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesAddonsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesAddonsListRequest();
    $request->nodeId = 'corporis';

    $response = $sdk->nodes->nodesAddonsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesChildrenCreateRequest;
use \OpenAPI\OpenAPI\Models\Operations\NodesChildrenCreateNodeInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesChildrenCreateNodeAttributesInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesChildrenCreateNodeAttributesCategoryEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesChildrenCreateRequest();
    $request->requestBody = new NodesChildrenCreateNodeInput();
    $request->requestBody->attributes = new NodesChildrenCreateNodeAttributesInput();
    $request->requestBody->attributes->category = NodesChildrenCreateNodeAttributesCategoryEnum::DATA;
    $request->requestBody->attributes->description = 'iusto';
    $request->requestBody->attributes->nodeLicense = 'dicta';
    $request->requestBody->attributes->public = false;
    $request->requestBody->attributes->tags = [
        'enim',
        'accusamus',
        'commodi',
    ];
    $request->requestBody->attributes->templateFrom = 'repudiandae';
    $request->requestBody->attributes->title = 'Mr.';
    $request->requestBody->type = 'ipsum';
    $request->nodeId = 'quidem';

    $response = $sdk->nodes->nodesChildrenCreate($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesChildrenListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesChildrenListRequest();
    $request->nodeId = 'molestias';

    $response = $sdk->nodes->nodesChildrenList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesCitationListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesCitationListRequest();
    $request->nodeId = 'excepturi';

    $response = $sdk->nodes->nodesCitationList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesCitationReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesCitationReadRequest();
    $request->nodeId = 'pariatur';
    $request->styleId = 'modi';

    $response = $sdk->nodes->nodesCitationRead($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesCommentCreateRequest;
use \OpenAPI\OpenAPI\Models\Operations\NodesCommentCreateCommentInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesCommentCreateCommentAttributesInput;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesCommentCreateRequest();
    $request->requestBody = new NodesCommentCreateCommentInput();
    $request->requestBody->attributes = new NodesCommentCreateCommentAttributesInput();
    $request->requestBody->attributes->content = 'praesentium';
    $request->nodeId = 'rem';

    $response = $sdk->nodes->nodesCommentCreate($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesCommentsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesCommentsListRequest();
    $request->nodeId = 'voluptates';

    $response = $sdk->nodes->nodesCommentsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsCreateRequest;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsCreateContributorInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsCreateContributorAttributesInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsCreateContributorAttributesPermissionEnum;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsCreateContributorRelationshipsInput;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesContributorsCreateRequest();
    $request->requestBody = new NodesContributorsCreateContributorInput();
    $request->requestBody->attributes = new NodesContributorsCreateContributorAttributesInput();
    $request->requestBody->attributes->bibliographic = false;
    $request->requestBody->attributes->index = 93940;
    $request->requestBody->attributes->permission = NodesContributorsCreateContributorAttributesPermissionEnum::ADMIN;
    $request->requestBody->relationships = new NodesContributorsCreateContributorRelationshipsInput();
    $request->requestBody->relationships->user = 'sint';
    $request->nodeId = 'veritatis';

    $response = $sdk->nodes->nodesContributorsCreate($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsDeleteRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesContributorsDeleteRequest();
    $request->nodeId = 'itaque';
    $request->userId = 'incidunt';

    $response = $sdk->nodes->nodesContributorsDelete($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesContributorsListRequest();
    $request->nodeId = 'enim';

    $response = $sdk->nodes->nodesContributorsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsPartialUpdateRequest;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsPartialUpdateContributorInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsPartialUpdateContributorAttributesInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsPartialUpdateContributorAttributesPermissionEnum;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsPartialUpdateContributorRelationshipsInput;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesContributorsPartialUpdateRequest();
    $request->requestBody = new NodesContributorsPartialUpdateContributorInput();
    $request->requestBody->attributes = new NodesContributorsPartialUpdateContributorAttributesInput();
    $request->requestBody->attributes->bibliographic = false;
    $request->requestBody->attributes->index = 9356;
    $request->requestBody->attributes->permission = NodesContributorsPartialUpdateContributorAttributesPermissionEnum::ADMIN;
    $request->requestBody->relationships = new NodesContributorsPartialUpdateContributorRelationshipsInput();
    $request->requestBody->relationships->user = 'quibusdam';
    $request->nodeId = 'explicabo';
    $request->userId = 'deserunt';

    $response = $sdk->nodes->nodesContributorsPartialUpdate($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesContributorsReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesContributorsReadRequest();
    $request->nodeId = 'distinctio';
    $request->userId = 'quibusdam';

    $response = $sdk->nodes->nodesContributorsRead($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesCreateNodeInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesCreateNodeAttributesInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesCreateNodeAttributesCategoryEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesCreateNodeInput();
    $request->attributes = new NodesCreateNodeAttributesInput();
    $request->attributes->category = NodesCreateNodeAttributesCategoryEnum::DATA;
    $request->attributes->description = 'modi';
    $request->attributes->nodeLicense = 'qui';
    $request->attributes->public = false;
    $request->attributes->tags = [
        'cupiditate',
        'quos',
    ];
    $request->attributes->templateFrom = 'perferendis';
    $request->attributes->title = 'Mr.';
    $request->type = 'assumenda';

    $response = $sdk->nodes->nodesCreate($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesDeleteRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesDeleteRequest();
    $request->nodeId = 'ipsam';

    $response = $sdk->nodes->nodesDelete($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesDraftRegistrationsCreateRequest;
use \OpenAPI\OpenAPI\Models\Operations\NodesDraftRegistrationsCreateDraftRegistrationInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesDraftRegistrationsCreateDraftRegistrationAttributesInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesDraftRegistrationsCreateDraftRegistrationAttributesNodeLicense;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesDraftRegistrationsCreateRequest();
    $request->requestBody = new NodesDraftRegistrationsCreateDraftRegistrationInput();
    $request->requestBody->attributes = new NodesDraftRegistrationsCreateDraftRegistrationAttributesInput();
    $request->requestBody->attributes->category = 'alias';
    $request->requestBody->attributes->description = 'fugit';
    $request->requestBody->attributes->nodeLicense = new NodesDraftRegistrationsCreateDraftRegistrationAttributesNodeLicense();
    $request->requestBody->attributes->nodeLicense->copyrightHolders = [
        'excepturi',
        'tempora',
        'facilis',
    ];
    $request->requestBody->attributes->nodeLicense->year = 735194;
    $request->requestBody->attributes->registrationMetadata = [
        'delectus' => 'eum',
        'non' => 'eligendi',
    ];
    $request->requestBody->attributes->registrationResponses = [
        'aliquid' => 'provident',
        'necessitatibus' => 'sint',
        'officia' => 'dolor',
    ];
    ...
    $request->requestBody->attributes->title = 'Dr.';
    $request->nodeId = 'maiores';

    $response = $sdk->nodes->nodesDraftRegistrationsCreate($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesDraftRegistrationsDeleteRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesDraftRegistrationsDeleteRequest();
    $request->draftId = 'rerum';
    $request->nodeId = 'dicta';

    $response = $sdk->nodes->nodesDraftRegistrationsDelete($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesDraftRegistrationsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesDraftRegistrationsListRequest();
    $request->nodeId = 'magnam';

    $response = $sdk->nodes->nodesDraftRegistrationsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesDraftRegistrationsPartialUpdateRequest;
use \OpenAPI\OpenAPI\Models\Operations\NodesDraftRegistrationsPartialUpdateDraftRegistrationInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesDraftRegistrationsPartialUpdateDraftRegistrationAttributesInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesDraftRegistrationsPartialUpdateDraftRegistrationAttributesNodeLicense;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesDraftRegistrationsPartialUpdateRequest();
    $request->requestBody = new NodesDraftRegistrationsPartialUpdateDraftRegistrationInput();
    $request->requestBody->attributes = new NodesDraftRegistrationsPartialUpdateDraftRegistrationAttributesInput();
    $request->requestBody->attributes->category = 'cumque';
    $request->requestBody->attributes->description = 'facere';
    $request->requestBody->attributes->nodeLicense = new NodesDraftRegistrationsPartialUpdateDraftRegistrationAttributesNodeLicense();
    $request->requestBody->attributes->nodeLicense->copyrightHolders = [
        'aliquid',
        'laborum',
    ];
    $request->requestBody->attributes->nodeLicense->year = 881104;
    $request->requestBody->attributes->registrationMetadata = [
        'occaecati' => 'enim',
    ];
    $request->requestBody->attributes->registrationResponses = [
    ...
    $request->requestBody->attributes->title = 'Mrs.';
    $request->draftId = 'vel';
    $request->nodeId = 'natus';

    $response = $sdk->nodes->nodesDraftRegistrationsPartialUpdate($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesFilesListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesFilesListRequest();
    $request->nodeId = 'omnis';
    $request->provider = 'molestiae';

    $response = $sdk->nodes->nodesFilesList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesFilesReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesFilesReadRequest();
    $request->nodeId = 'perferendis';
    $request->path = 'nihil';
    $request->provider = 'magnam';

    $response = $sdk->nodes->nodesFilesRead($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesForksCreateRequest;
use \OpenAPI\OpenAPI\Models\Operations\NodesForksCreateNodeInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesForksCreateNodeAttributesInput;
use \OpenAPI\OpenAPI\Models\Operations\NodesForksCreateNodeAttributesCategoryEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesForksCreateRequest();
    $request->requestBody = new NodesForksCreateNodeInput();
    $request->requestBody->attributes = new NodesForksCreateNodeAttributesInput();
    $request->requestBody->attributes->category = NodesForksCreateNodeAttributesCategoryEnum::PROJECT;
    $request->requestBody->attributes->description = 'id';
    $request->requestBody->attributes->nodeLicense = 'labore';
    $request->requestBody->attributes->public = false;
    $request->requestBody->attributes->tags = [
        'suscipit',
        'natus',
    ];
    $request->requestBody->attributes->templateFrom = 'nobis';
    $request->requestBody->attributes->title = 'Ms.';
    $request->requestBody->type = 'vero';
    $request->nodeId = 'aspernatur';

    $response = $sdk->nodes->nodesForksCreate($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesForksListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesForksListRequest();
    $request->nodeId = 'architecto';

    $response = $sdk->nodes->nodesForksList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesIdentifiersListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesIdentifiersListRequest();
    $request->nodeId = 'magnam';

    $response = $sdk->nodes->nodesIdentifiersList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesInstitutionsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesInstitutionsListRequest();
    $request->nodeId = 'et';

    $response = $sdk->nodes->nodesInstitutionsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesLinkedNodesListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesLinkedNodesListRequest();
    $request->nodeId = 'excepturi';

    $response = $sdk->nodes->nodesLinkedNodesList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesLogsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesLogsListRequest();
    $request->nodeId = 'ullam';

    $response = $sdk->nodes->nodesLogsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesNodeAddonUpdateRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesNodeAddonUpdateRequest();
    $request->requestBody = [
        'quos' => 'sint',
    ...
    $request->nodeId = 'ad';
    $request->provider = 'eum';

    $response = $sdk->nodes->nodesNodeAddonUpdate($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesPartialUpdateRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesPartialUpdateRequest();
    $request->requestBody = [
        'necessitatibus' => 'odit',
    ];
    $request->nodeId = 'nemo';

    $response = $sdk->nodes->nodesPartialUpdate($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesPreprintsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesPreprintsListRequest();
    $request->nodeId = 'quasi';

    $response = $sdk->nodes->nodesPreprintsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesProvidersListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesProvidersListRequest();
    $request->nodeId = 'iure';

    $response = $sdk->nodes->nodesProvidersList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesProvidersReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesProvidersReadRequest();
    $request->nodeId = 'doloribus';
    $request->provider = 'debitis';

    $response = $sdk->nodes->nodesProvidersRead($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesReadRequest();
    $request->nodeId = 'eius';

    $response = $sdk->nodes->nodesRead($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesRegistrationsListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesRegistrationsListRequest();
    $request->nodeId = 'maxime';

    $response = $sdk->nodes->nodesRegistrationsList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesViewOnlyLinksListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesViewOnlyLinksListRequest();
    $request->nodeId = 'deleniti';

    $response = $sdk->nodes->nodesViewOnlyLinksList($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesViewOnlyLinksReadRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesViewOnlyLinksReadRequest();
    $request->linkId = 'facilis';
    $request->nodeId = 'in';

    $response = $sdk->nodes->nodesViewOnlyLinksRead($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\NodesWikisListRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new NodesWikisListRequest();
    $request->nodeId = 'architecto';

    $response = $sdk->nodes->nodesWikisList($request);
