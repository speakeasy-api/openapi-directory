...
public class GETDescribeEventSubscriptionsQueryParams {
    ...
    public GETDescribeEventSubscriptionsQueryParams withTagKeys(String[] tagKeys) {
    ...
    public GETDescribeEventSubscriptionsQueryParams withTagValues(String[] tagValues) {
