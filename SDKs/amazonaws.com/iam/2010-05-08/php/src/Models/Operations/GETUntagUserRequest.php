...
class GETUntagUserRequest
{
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETUntagUserActionEnum::UNTAG_USER;
		$this->tagKeys = [];
		$this->userName = "";
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETUntagUserVersionEnum::TWO_THOUSAND_AND_TEN0508;
