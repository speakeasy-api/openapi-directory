...
class OpenAQParametersResult:
    ...
    results: list[shared_parametersrow.ParametersRow] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results') }})  
    meta: Optional[OpenAQParametersResultMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
