...
class RequestAuditNodeUserDataRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestAuditNodeUserDataXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestAuditNodeUserDataXSdsDateFormatEnum $xSdsDateFormat = null;
