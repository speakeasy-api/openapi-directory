...
func (s *Discovery) PostV05CareContextsDiscover(ctx context.Context, request operations.PostV05CareContextsDiscoverRequest) (*operations.PostV05CareContextsDiscoverResponse, error) {
	baseURL := operations.PostV05CareContextsDiscoverServerList[0]
	...
	res := &operations.PostV05CareContextsDiscoverResponse{
