...
class UpdateFindingsRequestBodyFilters:
    r"""UpdateFindingsRequestBodyFilters
...
class UpdateFindingsRequestBodyNote:
    r"""UpdateFindingsRequestBodyNote
    The updated note.
    """
...
class UpdateFindingsRequestBody:
    filters: UpdateFindingsRequestBodyFilters = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Filters') }})
    note: Optional[UpdateFindingsRequestBodyNote] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Note') }})
    record_state: Optional[UpdateFindingsRequestBodyRecordStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RecordState') }})
