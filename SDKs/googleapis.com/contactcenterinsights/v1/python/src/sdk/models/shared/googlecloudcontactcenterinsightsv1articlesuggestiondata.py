...
class GoogleCloudContactcenterinsightsV1ArticleSuggestionData:
    ...
    r"""The system's confidence score that this article is a good match for this conversation, ranging from 0.0 (completely uncertain) to 1.0 (completely certain)."""  
    ...
    r"""Map that contains metadata about the Article Suggestion and the document that it originates from."""  
