...
class DescribeFHIRImportJobRequest:
    ...
    describe_fhir_import_job_request: shared_describefhirimportjobrequest.DescribeFHIRImportJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
