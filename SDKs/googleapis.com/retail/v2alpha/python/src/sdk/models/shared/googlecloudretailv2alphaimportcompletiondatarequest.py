...
import dataclasses
from ..shared import googlecloudretailv2alphacompletiondatainputconfig as shared_googlecloudretailv2alphacompletiondatainputconfig
...
class GoogleCloudRetailV2alphaImportCompletionDataRequest:
    ...
    input_config: Optional[shared_googlecloudretailv2alphacompletiondatainputconfig.GoogleCloudRetailV2alphaCompletionDataInputConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('inputConfig'), 'exclude': lambda f: f is None }})
