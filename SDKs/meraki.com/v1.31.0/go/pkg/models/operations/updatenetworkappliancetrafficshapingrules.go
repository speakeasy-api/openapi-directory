...
func (e *UpdateNetworkApplianceTrafficShapingRulesRequestBodyRulesDefinitionsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "localNet":
		fallthrough
	case "port":
		*e = UpdateNetworkApplianceTrafficShapingRulesRequestBodyRulesDefinitionsTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceTrafficShapingRulesRequestBodyRulesDefinitionsTypeEnum: %s", s)
	}
}
