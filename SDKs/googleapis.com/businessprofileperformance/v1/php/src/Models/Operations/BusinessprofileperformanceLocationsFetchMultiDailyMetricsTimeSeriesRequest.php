...
class BusinessprofileperformanceLocationsFetchMultiDailyMetricsTimeSeriesRequest
{
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\BusinessprofileperformanceLocationsFetchMultiDailyMetricsTimeSeriesDailyMetricsEnum> $dailyMetrics
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=dailyMetrics')]
    public ?array $dailyMetrics = null;
