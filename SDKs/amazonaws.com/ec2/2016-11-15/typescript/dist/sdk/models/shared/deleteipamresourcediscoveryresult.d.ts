 ...
 */
export declare class DeleteIpamResourceDiscoveryResultIpamResourceDiscoveryOperatingRegions extends SpeakeasyBase {
    regionName?: string;
}
/**
 ...
 */
export declare enum DeleteIpamResourceDiscoveryResultIpamResourceDiscoveryStateEnum {
 ...
 * Describes a tag.
 */
export declare class DeleteIpamResourceDiscoveryResultIpamResourceDiscoveryTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class DeleteIpamResourceDiscoveryResultIpamResourceDiscovery extends SpeakeasyBase {
    description?: string;
 ...
 * Success
 */
export declare class DeleteIpamResourceDiscoveryResult extends SpeakeasyBase {
