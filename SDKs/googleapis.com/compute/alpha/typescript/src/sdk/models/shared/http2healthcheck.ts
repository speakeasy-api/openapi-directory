 ...
 */
export enum Http2HealthCheckPortSpecificationEnum {
 ...
 */
export enum Http2HealthCheckProxyHeaderEnum {
  None = "NONE",
  ProxyV1 = "PROXY_V1",
}
 ...
 */
export enum Http2HealthCheckWeightReportModeEnum {
  Disable = "DISABLE",
  DryRun = "DRY_RUN",
  Enable = "ENABLE",
}

export class Http2HealthCheck extends SpeakeasyBase {
  /**
