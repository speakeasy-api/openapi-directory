 ...
 */
export class DescribeNetworkInterfacePermissionsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
 ...
 */
export class DescribeNetworkInterfacePermissionsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
