...
export class V2 {
  ...
  getDiscoveryV2Suggest(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetDiscoveryV2SuggestResponse =
        new operations.GetDiscoveryV2SuggestResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          ...
          if (
            ...
            res.getDiscoveryV2Suggest200ApplicationJSONString = JSON.stringify(
              httpRes?.data
            );
          }
          break;
