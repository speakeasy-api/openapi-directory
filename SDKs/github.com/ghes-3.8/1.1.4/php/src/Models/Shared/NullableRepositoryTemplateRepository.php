...
class NullableRepositoryTemplateRepository
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\NullableRepositoryTemplateRepositoryMergeCommitMessageEnum $mergeCommitMessage
     */
	#[\JMS\Serializer\Annotation\SerializedName('merge_commit_message')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\NullableRepositoryTemplateRepositoryMergeCommitMessageEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?NullableRepositoryTemplateRepositoryMergeCommitMessageEnum $mergeCommitMessage = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\NullableRepositoryTemplateRepositoryMergeCommitTitleEnum $mergeCommitTitle
     */
	#[\JMS\Serializer\Annotation\SerializedName('merge_commit_title')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\NullableRepositoryTemplateRepositoryMergeCommitTitleEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?NullableRepositoryTemplateRepositoryMergeCommitTitleEnum $mergeCommitTitle = null;
     ...
     * - `BLANK` - default to a blank commit message.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\NullableRepositoryTemplateRepositorySquashMergeCommitMessageEnum $squashMergeCommitMessage
     */
	#[\JMS\Serializer\Annotation\SerializedName('squash_merge_commit_message')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\NullableRepositoryTemplateRepositorySquashMergeCommitMessageEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?NullableRepositoryTemplateRepositorySquashMergeCommitMessageEnum $squashMergeCommitMessage = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\NullableRepositoryTemplateRepositorySquashMergeCommitTitleEnum $squashMergeCommitTitle
     */
	#[\JMS\Serializer\Annotation\SerializedName('squash_merge_commit_title')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\NullableRepositoryTemplateRepositorySquashMergeCommitTitleEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?NullableRepositoryTemplateRepositorySquashMergeCommitTitleEnum $squashMergeCommitTitle = null;
