...
public class InventoryTask {
    ...
    **/
    public openapisdk.models.operations.CreateInventoryTaskResponse createInventoryTask(openapisdk.models.operations.CreateInventoryTaskRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/inventory_task");
        ...
        openapisdk.models.operations.CreateInventoryTaskResponse res = new openapisdk.models.operations.CreateInventoryTaskResponse() {{
        }};
    ...
    **/
    public openapisdk.models.operations.GetInventoryTaskResponse getInventoryTask(openapisdk.models.operations.GetInventoryTaskRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/inventory_task/{task_id}", request.pathParams);
        ...
        openapisdk.models.operations.GetInventoryTaskResponse res = new openapisdk.models.operations.GetInventoryTaskResponse() {{
            inventoryTask = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.InventoryTask out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.InventoryTask.class);
    ...
    **/
    public openapisdk.models.operations.GetInventoryTasksResponse getInventoryTasks(openapisdk.models.operations.GetInventoryTasksRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/inventory_task");
        ...
        openapisdk.models.operations.GetInventoryTasksResponse res = new openapisdk.models.operations.GetInventoryTasksResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.InventoryTaskCollection out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.InventoryTaskCollection.class);
