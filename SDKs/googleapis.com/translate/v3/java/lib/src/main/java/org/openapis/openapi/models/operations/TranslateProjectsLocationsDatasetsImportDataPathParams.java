...
public class TranslateProjectsLocationsDatasetsImportDataPathParams {
    /**
    ...
    public TranslateProjectsLocationsDatasetsImportDataPathParams withDataset(String dataset) {
