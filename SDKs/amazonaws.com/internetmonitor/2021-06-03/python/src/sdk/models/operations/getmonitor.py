...
from ..shared import getmonitoroutput as shared_getmonitoroutput
...
class GetMonitorResponse:
    ...
    get_monitor_output: Optional[shared_getmonitoroutput.GetMonitorOutput] = dataclasses.field(default=None)
    r"""Success"""  
