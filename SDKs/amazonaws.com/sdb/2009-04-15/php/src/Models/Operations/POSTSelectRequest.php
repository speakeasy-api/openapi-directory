...
class POSTSelectRequest
{
	...
	{
		$this->awsAccessKeyId = "";
		$this->action = \OpenAPI\OpenAPI\Models\Operations\POSTSelectActionEnum::SELECT;
		$this->nextToken = null;
		...
		$this->timestamp = "";
		$this->version = \OpenAPI\OpenAPI\Models\Operations\POSTSelectVersionEnum::TWO_THOUSAND_AND_NINE0415;
	}
}
