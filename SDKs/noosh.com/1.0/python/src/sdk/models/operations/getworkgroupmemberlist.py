...
from ..shared import workgroupmemberslistvo as shared_workgroupmemberslistvo
...
class GetWorkgroupMemberListResponse:
    ...
    workgroup_members_list_vo: Optional[shared_workgroupmemberslistvo.WorkgroupMembersListVO] = dataclasses.field(default=None)
