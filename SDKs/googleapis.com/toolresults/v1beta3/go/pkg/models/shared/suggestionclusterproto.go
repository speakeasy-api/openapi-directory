...
func (e SuggestionClusterProtoCategoryEnum) ToPointer() *SuggestionClusterProtoCategoryEnum {
	return &e
}
...
func (e *SuggestionClusterProtoCategoryEnum) UnmarshalJSON(data []byte) error {
	...
	case "lowContrast":
		fallthrough
	case "implementation":
		*e = SuggestionClusterProtoCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SuggestionClusterProtoCategoryEnum: %v", v)
	}
}
