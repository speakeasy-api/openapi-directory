...
exports.DeleteRtiTransactionResponse = exports.DeleteRtiTransactionRequest = void 0;
...
var DeleteRtiTransactionRequest = /** @class */ (function (_super) {
    ...
    ], DeleteRtiTransactionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeleteRtiTransactionRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeleteRtiTransactionRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RtiTransactionId",
        }),
        __metadata("design:type", String)
    ], DeleteRtiTransactionRequest.prototype, "rtiTransactionId", void 0);
    return DeleteRtiTransactionRequest;
}(utils_1.SpeakeasyBase));
exports.DeleteRtiTransactionRequest = DeleteRtiTransactionRequest;
var DeleteRtiTransactionResponse = /** @class */ (function (_super) {
    ...
    ], DeleteRtiTransactionResponse.prototype, "rawResponse", void 0);
    return DeleteRtiTransactionResponse;
}(utils_1.SpeakeasyBase));
exports.DeleteRtiTransactionResponse = DeleteRtiTransactionResponse;
