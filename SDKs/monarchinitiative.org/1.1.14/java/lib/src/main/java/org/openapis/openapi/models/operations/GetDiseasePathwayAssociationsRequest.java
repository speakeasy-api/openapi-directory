...
public class GetDiseasePathwayAssociationsRequest {
    ...
    public GetDiseasePathwayAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetDiseasePathwayAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetDiseasePathwayAssociationsRequest withEvidence(String evidence) {
    ...
    public GetDiseasePathwayAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetDiseasePathwayAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetDiseasePathwayAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetDiseasePathwayAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetDiseasePathwayAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetDiseasePathwayAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetDiseasePathwayAssociationsRequest withRelation(String relation) {
    ...
    public GetDiseasePathwayAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetDiseasePathwayAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetDiseasePathwayAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetDiseasePathwayAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetDiseasePathwayAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetDiseasePathwayAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetDiseasePathwayAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetDiseasePathwayAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
