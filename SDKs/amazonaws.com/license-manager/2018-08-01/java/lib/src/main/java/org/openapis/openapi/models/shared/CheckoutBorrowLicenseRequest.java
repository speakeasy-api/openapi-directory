...
public class CheckoutBorrowLicenseRequest {
    ...
    public CheckoutBorrowLicenseRequest(@JsonProperty("ClientToken") String clientToken, @JsonProperty("DigitalSignatureMethod") DigitalSignatureMethodEnum digitalSignatureMethod, @JsonProperty("Entitlements") EntitlementData[] entitlements, @JsonProperty("LicenseArn") String licenseArn) {
        this.clientToken = clientToken;
        this.digitalSignatureMethod = digitalSignatureMethod;
        this.entitlements = entitlements;
        this.licenseArn = licenseArn;
