...
from ..shared import security as shared_security
from ..shared import listingslistresponse as shared_listingslistresponse
...
class AndroidpublisherEditsListingsListRequest:
    path_params: AndroidpublisherEditsListingsListPathParams = dataclasses.field()
    query_params: AndroidpublisherEditsListingsListQueryParams = dataclasses.field()
    security: AndroidpublisherEditsListingsListSecurity = dataclasses.field()
...
class AndroidpublisherEditsListingsListResponse:
    ...
    listings_list_response: Optional[shared_listingslistresponse.ListingsListResponse] = dataclasses.field(default=None)
