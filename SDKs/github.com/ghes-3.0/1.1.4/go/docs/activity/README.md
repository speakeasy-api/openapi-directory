...
func main() {
    ...
    res, err := s.Activity.ActivityListNotificationsForAuthenticatedUser(ctx, operations.ActivityListNotificationsForAuthenticatedUserRequest{
        All: sdk.Bool(false),
        Before: types.MustTimeFromString("2022-02-07T18:15:06.372Z"),
        Page: sdk.Int64(141264),
        Participating: sdk.Bool(false),
        PerPage: sdk.Int64(367562),
        Since: types.MustTimeFromString("2022-07-25T21:49:23.340Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Activity.ActivityListPublicEventsForUser(ctx, operations.ActivityListPublicEventsForUserRequest{
        Page: sdk.Int64(841140),
        PerPage: sdk.Int64(149448),
        Username: "Sunny16",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Activity.ActivityListRepoNotificationsForAuthenticatedUser(ctx, operations.ActivityListRepoNotificationsForAuthenticatedUserRequest{
        All: sdk.Bool(false),
        Before: types.MustTimeFromString("2021-11-26T18:45:44.366Z"),
        Owner: "voluptatibus",
        Page: sdk.Int64(16627),
        Participating: sdk.Bool(false),
        PerPage: sdk.Int64(855804),
        Repo: "amet",
        Since: types.MustTimeFromString("2022-03-27T19:22:24.458Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Activity.ActivityMarkNotificationsAsRead(ctx, operations.ActivityMarkNotificationsAsReadRequestBody{
        LastReadAt: types.MustTimeFromString("2022-11-25T05:30:58.706Z"),
        Read: sdk.Bool(false),
    })
    if err != nil {
        log.Fatal(err)
