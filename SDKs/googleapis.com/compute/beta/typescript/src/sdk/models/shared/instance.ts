...
import { ShieldedVmIntegrityPolicy } from "./shieldedvmintegritypolicy";
 ...
 */
export enum InstancePostKeyRevocationActionTypeEnum {
  Noop = "NOOP",
...
export class Instance extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "shieldedVmIntegrityPolicy" })
