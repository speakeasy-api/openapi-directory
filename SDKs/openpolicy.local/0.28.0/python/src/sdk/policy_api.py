...
class PolicyAPI:
    ...
    def delete_policy_module(self, request: operations.DeletePolicyModuleRequest) -> operations.DeletePolicyModuleResponse:
        ...
        url = utils.generate_url(operations.DeletePolicyModuleRequest, base_url, '/v1/policies/{id}', request)
        
        query_params = utils.get_query_params(operations.DeletePolicyModuleRequest, request)
        ...
        res = operations.DeletePolicyModuleResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.DeletePolicyModule200ApplicationJSON])
    ...
    def get_policies(self, request: operations.GetPoliciesRequest) -> operations.GetPoliciesResponse:
        ...
        query_params = utils.get_query_params(operations.GetPoliciesRequest, request)
        ...
        res = operations.GetPoliciesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.TwoHundredResult])
    ...
    def get_policy_module(self, request: operations.GetPolicyModuleRequest) -> operations.GetPolicyModuleResponse:
        ...
        url = utils.generate_url(operations.GetPolicyModuleRequest, base_url, '/v1/policies/{id}', request)
        
        query_params = utils.get_query_params(operations.GetPolicyModuleRequest, request)
        ...
        res = operations.GetPolicyModuleResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def put_policy_module(self, request: operations.PutPolicyModuleRequest) -> operations.PutPolicyModuleResponse:
        ...
        url = utils.generate_url(operations.PutPolicyModuleRequest, base_url, '/v1/policies/{id}', request)
        ...
        query_params = utils.get_query_params(operations.PutPolicyModuleRequest, request)
        ...
        res = operations.PutPolicyModuleResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
