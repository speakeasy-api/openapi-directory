...
type GetRegionOptStatusHeaders struct {
...
type GetRegionOptStatusRequestBody struct {
...
type GetRegionOptStatusRequest struct {
	Headers GetRegionOptStatusHeaders
	Request GetRegionOptStatusRequestBody `request:"mediaType=application/json"`
}
