...
public class ListEmailTemplatesQueryParams {
    /**
    ...
    public ListEmailTemplatesQueryParams withNextToken(String nextToken) {
    ...
    public ListEmailTemplatesQueryParams withPageSize(Long pageSize) {
