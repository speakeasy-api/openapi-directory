 ...
 */
export declare enum InstanceGroupManagersListPerInstanceConfigsRespWarningCodeEnum {
...
export declare class InstanceGroupManagersListPerInstanceConfigsRespWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InstanceGroupManagersListPerInstanceConfigsRespWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InstanceGroupManagersListPerInstanceConfigsRespWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InstanceGroupManagersListPerInstanceConfigsRespWarningData[];
    /**
 ...
 * Successful response
 */
export declare class InstanceGroupManagersListPerInstanceConfigsResp extends SpeakeasyBase {
    /**
