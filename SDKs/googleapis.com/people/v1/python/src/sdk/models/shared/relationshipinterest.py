...
class RelationshipInterest:
    r"""**DEPRECATED**: No data will be returned A person's relationship interest ."""
    ...
    r"""Output only. The value of the relationship interest translated and formatted in the viewer's account locale or the locale specified in the Accept-Language HTTP header."""  
    ...
    r"""The kind of relationship the person is looking for. The value can be custom or one of these predefined values: * `friend` * `date` * `relationship` * `networking`"""  
