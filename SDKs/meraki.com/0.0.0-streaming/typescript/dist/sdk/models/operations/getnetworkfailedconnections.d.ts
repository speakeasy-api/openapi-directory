 ...
 */
export declare enum GetNetworkFailedConnectionsBandEnum {
    Two4 = "2.4",
    Five = "5"
}
export declare class GetNetworkFailedConnectionsRequest extends SpeakeasyBase {
    /**
...
export declare class GetNetworkFailedConnectionsResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
