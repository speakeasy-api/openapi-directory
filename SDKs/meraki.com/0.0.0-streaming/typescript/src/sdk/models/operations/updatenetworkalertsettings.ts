 ...
 */
export class UpdateNetworkAlertSettingsRequestBodyAlertsAlertDestinations extends SpeakeasyBase {
  /**
...
export class UpdateNetworkAlertSettingsRequestBodyAlerts extends SpeakeasyBase {
  /**
   * A hash of destinations for this specific alert
   */
  @SpeakeasyMetadata()
  @Expose({ name: "alertDestinations" })
  @Type(() => UpdateNetworkAlertSettingsRequestBodyAlertsAlertDestinations)
 ...
 */
export class UpdateNetworkAlertSettingsRequestBodyDefaultDestinations extends SpeakeasyBase {
  /**
...
export class UpdateNetworkAlertSettingsRequestBody extends SpeakeasyBase {
  /**
   * Alert-specific configuration for each type. Only alerts that pertain to the network can be updated.
   */
  @SpeakeasyMetadata({ elemType: UpdateNetworkAlertSettingsRequestBodyAlerts })
  @Expose({ name: "alerts" })
  @Type(() => UpdateNetworkAlertSettingsRequestBodyAlerts)
  ...
  @Type(() => UpdateNetworkAlertSettingsRequestBodyDefaultDestinations)
  defaultDestinations?: UpdateNetworkAlertSettingsRequestBodyDefaultDestinations;
}

export class UpdateNetworkAlertSettingsRequest extends SpeakeasyBase {
...
export class UpdateNetworkAlertSettingsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
