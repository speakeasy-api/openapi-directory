...
exports.GetInternationalPaymentsInternationalPaymentIdResponse = exports.GetInternationalPaymentsInternationalPaymentIdRequest = exports.GetInternationalPaymentsInternationalPaymentIdSecurity = void 0;
...
exports.GetInternationalPaymentsInternationalPaymentIdSecurity = GetInternationalPaymentsInternationalPaymentIdSecurity;
var GetInternationalPaymentsInternationalPaymentIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetInternationalPaymentsInternationalPaymentIdRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=InternationalPaymentId",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentsInternationalPaymentIdRequest.prototype, "internationalPaymentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentsInternationalPaymentIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentsInternationalPaymentIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentsInternationalPaymentIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentsInternationalPaymentIdRequest.prototype, "xFapiInteractionId", void 0);
    return GetInternationalPaymentsInternationalPaymentIdRequest;
}(utils_1.SpeakeasyBase));
exports.GetInternationalPaymentsInternationalPaymentIdRequest = GetInternationalPaymentsInternationalPaymentIdRequest;
var GetInternationalPaymentsInternationalPaymentIdResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetInternationalPaymentsInternationalPaymentIdResponse.prototype, "rawResponse", void 0);
    return GetInternationalPaymentsInternationalPaymentIdResponse;
}(utils_1.SpeakeasyBase));
exports.GetInternationalPaymentsInternationalPaymentIdResponse = GetInternationalPaymentsInternationalPaymentIdResponse;
