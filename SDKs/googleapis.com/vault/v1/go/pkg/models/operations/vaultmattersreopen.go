...
type VaultMattersReopenSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type VaultMattersReopenPathParams struct {
	// The matter ID.
	MatterID string `pathParam:"style=simple,explode=false,name=matterId"`
}

type VaultMattersReopenQueryParams struct {
	// V1 error format.
...
type VaultMattersReopenRequest struct {
...
type VaultMattersReopenResponse struct {
	ContentType string
	// Successful response
