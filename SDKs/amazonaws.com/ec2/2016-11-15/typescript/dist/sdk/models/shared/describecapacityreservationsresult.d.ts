 ...
 */
export declare enum DescribeCapacityReservationsResultCapacityReservationsCapacityAllocationsAllocationTypeEnum {
    Used = "used"
}
/**
 * Information about instance capacity usage for a Capacity Reservation.
 */
export declare class DescribeCapacityReservationsResultCapacityReservationsCapacityAllocations extends SpeakeasyBase {
 ...
 */
export declare enum DescribeCapacityReservationsResultCapacityReservationsEndDateTypeEnum {
    Unlimited = "unlimited",
    Limited = "limited"
}
/**
 ...
 */
export declare enum DescribeCapacityReservationsResultCapacityReservationsInstanceMatchCriteriaEnum {
    Open = "open",
    Targeted = "targeted"
}
/**
 ...
 */
export declare enum DescribeCapacityReservationsResultCapacityReservationsInstancePlatformEnum {
 ...
 */
export declare enum DescribeCapacityReservationsResultCapacityReservationsStateEnum {
    Active = "active",
    Expired = "expired",
    Cancelled = "cancelled",
    Pending = "pending",
 ...
 * Describes a tag.
 */
export declare class DescribeCapacityReservationsResultCapacityReservationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare enum DescribeCapacityReservationsResultCapacityReservationsTenancyEnum {
    Default = "default",
    Dedicated = "dedicated"
}
/**
 ...
 */
export declare class DescribeCapacityReservationsResultCapacityReservations extends SpeakeasyBase {
