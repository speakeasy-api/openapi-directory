...
class FirebasehostingSitesVersionsFilesListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\FirebasehostingSitesVersionsFilesListStatusEnum $status
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=status')]
    public ?FirebasehostingSitesVersionsFilesListStatusEnum $status = null;
