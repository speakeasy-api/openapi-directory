...
class GetShipmentByIDResponseBodyDeliveryConfirmationEnum(str, Enum):
...
class GetShipmentByIDResponseBodyInternationalShipmentOptionsPackageContentsEnum(str, Enum):
...
class GetShipmentByIDResponseBodyInternationalShipmentOptionsNonDeliveryEnum(str, Enum):
...
class GetShipmentByIDResponseBodyInternationalShipmentOptions:
    ...
    contents: GetShipmentByIDResponseBodyInternationalShipmentOptionsPackageContentsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contents') }})
    r"""The type of contents in this shipment.  This may impact import duties or customs treatment."""  
    non_delivery: GetShipmentByIDResponseBodyInternationalShipmentOptionsNonDeliveryEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('non_delivery') }})
...
class GetShipmentByIDResponseBodyInsuranceProviderEnum(str, Enum):
...
class GetShipmentByIDResponseBodyOriginTypeEnum(str, Enum):
    r"""Indicates if the package will be picked up or dropped off by the carrier"""
    PICKUP = 'pickup'
    DROP_OFF = 'drop_off'

class GetShipmentByIDResponseBodyShipmentStatusEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetShipmentByIDResponseBodyWeight:
...
class GetShipmentByIDResponseBody:
    ...
    confirmation: GetShipmentByIDResponseBodyDeliveryConfirmationEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('confirmation') }})
    ...
    customs: GetShipmentByIDResponseBodyInternationalShipmentOptions = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('customs') }})
    r"""Customs information.  This is usually only needed for international shipments."""  
    insurance_provider: GetShipmentByIDResponseBodyInsuranceProviderEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('insurance_provider') }})
    ...
    shipment_status: GetShipmentByIDResponseBodyShipmentStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shipment_status') }})
    ...
    total_weight: GetShipmentByIDResponseBodyWeight = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('total_weight') }})
    ...
    origin_type: Optional[GetShipmentByIDResponseBodyOriginTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin_type'), 'exclude': lambda f: f is None }})
    r"""Indicates if the package will be picked up or dropped off by the carrier"""  
