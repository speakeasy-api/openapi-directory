...
export class GetNhFossilsAllRequest extends SpeakeasyBase {
  /**
...
export class GetNhFossilsAllResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata({
    elemType: shared.NHFossilGroupWithIndividualFossilsNoMatched,
  })
