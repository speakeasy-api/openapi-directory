...
export class PostServersIdActionsEnableBackupActionResponseAction extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => PostServersIdActionsEnableBackupActionResponseActionError)
  ...
  @Type(() => PostServersIdActionsEnableBackupActionResponseActionResources)
...
export class PostServersIdActionsEnableBackupActionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "action" })
  @Type(() => PostServersIdActionsEnableBackupActionResponseAction)
