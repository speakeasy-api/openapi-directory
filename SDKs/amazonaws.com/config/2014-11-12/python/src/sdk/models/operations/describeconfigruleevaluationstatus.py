...
class DescribeConfigRuleEvaluationStatusRequest:
    ...
    describe_config_rule_evaluation_status_request: shared_describeconfigruleevaluationstatusrequest.DescribeConfigRuleEvaluationStatusRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
