...
class ListServiceConversationListServiceConversationResponse:
    ...
    conversations: Optional[list[shared_conversations_v1_service_service_conversation.ConversationsV1ServiceServiceConversation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conversations'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListServiceConversationListServiceConversationResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
