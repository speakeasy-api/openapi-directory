...
func (e GetOrganizationInventoryDevicesProductTypesEnum) ToPointer() *GetOrganizationInventoryDevicesProductTypesEnum {
	return &e
}
...
func (e *GetOrganizationInventoryDevicesProductTypesEnum) UnmarshalJSON(data []byte) error {
	...
	case "systemsManager":
		fallthrough
	case "wireless":
		*e = GetOrganizationInventoryDevicesProductTypesEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationInventoryDevicesProductTypesEnum: %v", v)
	}
}
...
func (e GetOrganizationInventoryDevicesTagsFilterTypeEnum) ToPointer() *GetOrganizationInventoryDevicesTagsFilterTypeEnum {
	return &e
}
...
func (e *GetOrganizationInventoryDevicesTagsFilterTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "withAllTags":
		fallthrough
	case "withAnyTags":
		*e = GetOrganizationInventoryDevicesTagsFilterTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationInventoryDevicesTagsFilterTypeEnum: %v", v)
	}
}
...
func (e GetOrganizationInventoryDevicesUsedStateEnum) ToPointer() *GetOrganizationInventoryDevicesUsedStateEnum {
	return &e
}
...
func (e *GetOrganizationInventoryDevicesUsedStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "unused":
		fallthrough
	case "used":
		*e = GetOrganizationInventoryDevicesUsedStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationInventoryDevicesUsedStateEnum: %v", v)
	}
}
