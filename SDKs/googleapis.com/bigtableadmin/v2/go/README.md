...
```bash
go get github.com/speakeasy-api/openapi-directory/SDKs/googleapis.com/bigtableadmin/v2/go
```
...
func main() {
    ...
    res, err := s.Operations.BigtableadminOperationsCancel(ctx, req, operations.BigtableadminOperationsCancelSecurity{
