...
exports.PutPayScheduleResponse = exports.PutPayScheduleRequest = void 0;
...
var PutPayScheduleRequest = /** @class */ (function (_super) {
    ...
    ], PutPayScheduleRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], PutPayScheduleRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], PutPayScheduleRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=application/json" }),
        __metadata("design:type", shared.PaySchedule)
    ], PutPayScheduleRequest.prototype, "paySchedule", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayScheduleId",
        }),
        __metadata("design:type", String)
    ], PutPayScheduleRequest.prototype, "payScheduleId", void 0);
    return PutPayScheduleRequest;
}(utils_1.SpeakeasyBase));
exports.PutPayScheduleRequest = PutPayScheduleRequest;
var PutPayScheduleResponse = /** @class */ (function (_super) {
    ...
    ], PutPayScheduleResponse.prototype, "rawResponse", void 0);
    return PutPayScheduleResponse;
}(utils_1.SpeakeasyBase));
exports.PutPayScheduleResponse = PutPayScheduleResponse;
