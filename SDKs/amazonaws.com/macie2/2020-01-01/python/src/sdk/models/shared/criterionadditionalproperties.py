...
class CriterionAdditionalProperties:
    ...
    eq_exact_match: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('eqExactMatch'), 'exclude': lambda f: f is None }})  
