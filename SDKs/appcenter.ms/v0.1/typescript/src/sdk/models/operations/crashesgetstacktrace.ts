...
export class CrashesGetStacktraceSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CrashesGetStacktraceRequest extends SpeakeasyBase {
  /**
 ...
 * Error
 */
export class CrashesGetStacktraceDefaultApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "message" })
  message: string;
}

export class CrashesGetStacktraceResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
