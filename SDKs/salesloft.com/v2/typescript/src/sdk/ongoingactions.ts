...
export class OngoingActions {
  ...
  postV2OngoingActionsJson(
    req: operations.PostV2OngoingActionsJsonRequestBody,
    config?: AxiosRequestConfig
  ): Promise<operations.PostV2OngoingActionsJsonResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostV2OngoingActionsJsonRequestBody(req);
    }

    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v2/ongoing_actions.json";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.PostV2OngoingActionsJsonResponse =
        new operations.PostV2OngoingActionsJsonResponse({
