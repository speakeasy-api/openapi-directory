...
class PointPointGetRequest
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PointPointGetLanguageLanguageEnum $language
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=language')]
    public ?PointPointGetLanguageLanguageEnum $language = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PointPointGetUnitsUnitsEnum $units
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=units')]
    public ?PointPointGetUnitsUnitsEnum $units = null;
