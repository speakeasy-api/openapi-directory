...
from ..shared import destiny_advanced_awainitializeresponse as shared_destiny_advanced_awainitializeresponse
...
class Destiny2AwaInitializeRequest200Wildcard:
    ...
    response: Optional[shared_destiny_advanced_awainitializeresponse.DestinyAdvancedAwaInitializeResponse] = dataclasses.field(default=None)  
