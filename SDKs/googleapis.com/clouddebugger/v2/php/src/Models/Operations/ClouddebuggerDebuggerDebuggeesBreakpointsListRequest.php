...
class ClouddebuggerDebuggerDebuggeesBreakpointsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ClouddebuggerDebuggerDebuggeesBreakpointsListActionValueEnum $actionValue
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=action.value')]
    public ?ClouddebuggerDebuggerDebuggeesBreakpointsListActionValueEnum $actionValue = null;
	...
	public function __construct()
	{
		...
		$this->debuggeeId = "";
		$this->fields = null;
		$this->includeAllUsers = null;
		$this->includeInactive = null;
		$this->key = null;
		$this->oauthToken = null;
		$this->prettyPrint = null;
		$this->quotaUser = null;
		$this->stripResults = null;
