...
public class FslcsSecurity {
    ...
    public FslcsSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public FslcsSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public FslcsSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
