...
export class ReleasesAvailableToTesterSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ReleasesAvailableToTesterRequest extends SpeakeasyBase {
  /**
 ...
 *
 */
export class ReleasesAvailableToTester200ApplicationJSONBuild extends SpeakeasyBase {
  /**
 ...
 *
 */
export enum ReleasesAvailableToTester200ApplicationJSONDestinationTypeEnum {
  Group = "group",
  Store = "store",
  Tester = "tester",
}
 ...
 */
export enum ReleasesAvailableToTester200ApplicationJSONDestinationsDestinationTypeEnum {
  Group = "group",
  Store = "store",
  Tester = "tester",
}
 ...
 */
export enum ReleasesAvailableToTester200ApplicationJSONDestinationsTypeEnum {
  Intune = "intune",
 ...
 */
export class ReleasesAvailableToTester200ApplicationJSONDestinations extends SpeakeasyBase {
  /**
   * Destination can be either store or group.
   */
  @SpeakeasyMetadata()
...
export class ReleasesAvailableToTester200ApplicationJSONDistributionGroups extends SpeakeasyBase {
  /**
 ...
 * type of the distribution store currently stores type can be intune, googleplay or windows.
 */
export enum ReleasesAvailableToTester200ApplicationJSONDistributionStoresTypeEnum {
  Intune = "intune",
  Googleplay = "googleplay",
  Apple = "apple",
  None = "none",
...
export class ReleasesAvailableToTester200ApplicationJSONDistributionStores extends SpeakeasyBase {
  /**
   * ID identifying a unique distribution store.
   */
  @SpeakeasyMetadata()
 ...
 */
export enum ReleasesAvailableToTester200ApplicationJSONOriginEnum {
  Hockeyapp = "hockeyapp",
  Appcenter = "appcenter",
}
 ...
 */
export class ReleasesAvailableToTester200ApplicationJSON extends SpeakeasyBase {
  /**
   * Build information for the release
   *
   * @remarks
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "build" })
  @Type(() => ReleasesAvailableToTester200ApplicationJSONBuild)
  ...
  @Type(() => ReleasesAvailableToTester200ApplicationJSONDestinations)
  ...
  @Type(() => ReleasesAvailableToTester200ApplicationJSONDistributionGroups)
  ...
  @Type(() => ReleasesAvailableToTester200ApplicationJSONDistributionStores)
...
export class ReleasesAvailableToTesterResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   * Success
   */
  @SpeakeasyMetadata({ elemType: ReleasesAvailableToTester200ApplicationJSON })
