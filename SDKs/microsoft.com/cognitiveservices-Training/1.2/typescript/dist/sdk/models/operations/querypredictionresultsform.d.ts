...
export declare class QueryPredictionResultsFormRequest extends SpeakeasyBase {
    /**
...
export declare class QueryPredictionResultsFormResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    /**
     * OK
