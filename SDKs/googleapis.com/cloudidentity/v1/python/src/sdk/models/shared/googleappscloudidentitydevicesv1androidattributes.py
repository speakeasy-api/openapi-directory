...
class GoogleAppsCloudidentityDevicesV1AndroidAttributes:
    ...
    ownership_privilege: Optional[GoogleAppsCloudidentityDevicesV1AndroidAttributesOwnershipPrivilegeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ownershipPrivilege') }})
