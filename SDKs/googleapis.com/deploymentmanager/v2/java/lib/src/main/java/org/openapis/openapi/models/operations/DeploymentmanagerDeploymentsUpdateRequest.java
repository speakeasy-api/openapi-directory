...
public class DeploymentmanagerDeploymentsUpdateRequest {
    ...
    public DeploymentmanagerDeploymentsUpdateRequest(@JsonProperty("deploymentPathParameter") String deploymentPathParameter, @JsonProperty("project") String project) {
        this.deploymentPathParameter = deploymentPathParameter;
        this.project = project;
  }
}
