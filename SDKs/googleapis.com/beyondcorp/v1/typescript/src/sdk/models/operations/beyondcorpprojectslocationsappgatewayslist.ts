...
export class BeyondcorpProjectsLocationsAppGatewaysListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BeyondcorpProjectsLocationsAppGatewaysListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BeyondcorpProjectsLocationsAppGatewaysListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
