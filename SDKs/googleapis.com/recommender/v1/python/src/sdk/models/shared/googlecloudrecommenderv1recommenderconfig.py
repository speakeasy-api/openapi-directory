...
class GoogleCloudRecommenderV1RecommenderConfigInput:
    ...
    recommender_generation_config: Optional[shared_googlecloudrecommenderv1recommendergenerationconfig.GoogleCloudRecommenderV1RecommenderGenerationConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('recommenderGenerationConfig'), 'exclude': lambda f: f is None }})
