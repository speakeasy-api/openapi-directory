...
var ConfigDhcp = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=add_options" }),
        __metadata("design:type", String)
    ], ConfigDhcp.prototype, "addOptions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=classid" }),
        __metadata("design:type", String)
    ], ConfigDhcp.prototype, "classid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=hwaddr" }),
        __metadata("design:type", String)
