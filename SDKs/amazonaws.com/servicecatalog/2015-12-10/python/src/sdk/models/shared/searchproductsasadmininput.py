...
class SearchProductsAsAdminInput:
    ...
    product_source: Optional[shared_productsource_enum.ProductSourceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ProductSource'), 'exclude': lambda f: f is None }})  
