...
type IntegrationsProjectsLocationsProductsIntegrationtemplatesVersionsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type IntegrationsProjectsLocationsProductsIntegrationtemplatesVersionsCreatePathParams struct {
...
type IntegrationsProjectsLocationsProductsIntegrationtemplatesVersionsCreateQueryParams struct {
	// V1 error format.
...
type IntegrationsProjectsLocationsProductsIntegrationtemplatesVersionsCreateResponse struct {
	ContentType string
	// Successful response
