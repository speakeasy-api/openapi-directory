...
class PerformPostActionRequestBody:
    ...
    post_action_type_id: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('post_action_type_id') }})  
    flag_topic: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flag_topic'), 'exclude': lambda f: f is None }})  
...
class PerformPostActionRequest:
    ...
    request_body: Optional[PerformPostActionRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class PerformPostAction200ApplicationJSONActionsSummary:
    ...
    acted: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('acted'), 'exclude': lambda f: f is None }})  
    can_undo: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('can_undo'), 'exclude': lambda f: f is None }})  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PerformPostAction200ApplicationJSON:
    r"""post updated"""
    
    actions_summary: Optional[list[PerformPostAction200ApplicationJSONActionsSummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('actions_summary'), 'exclude': lambda f: f is None }})  
    ...
    notice: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('notice'), 'exclude': lambda f: f is None }})  
    ...
    reviewable_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reviewable_id'), 'exclude': lambda f: f is None }})  
...
class PerformPostActionResponse:
    ...
    perform_post_action_200_application_json_object: Optional[PerformPostAction200ApplicationJSON] = dataclasses.field(default=None)
    r"""post updated"""  
