...
class GetGeneOrthologDiseaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGeneOrthologDiseaseAssociationsQueryParams:
...
@dataclasses.dataclass
class GetGeneOrthologDiseaseAssociationsRequest:
    path_params: GetGeneOrthologDiseaseAssociationsPathParams = dataclasses.field()
    query_params: GetGeneOrthologDiseaseAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetGeneOrthologDiseaseAssociationsResponse:
