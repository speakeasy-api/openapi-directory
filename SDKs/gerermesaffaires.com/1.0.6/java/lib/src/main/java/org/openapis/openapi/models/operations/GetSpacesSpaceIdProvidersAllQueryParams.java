...
public class GetSpacesSpaceIdProvidersAllQueryParams {
    /**
    ...
    public GetSpacesSpaceIdProvidersAllQueryParams withWithContractingPartner(String withContractingPartner) {
