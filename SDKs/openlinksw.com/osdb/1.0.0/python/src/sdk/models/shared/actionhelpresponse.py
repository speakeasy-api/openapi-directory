...
class ActionHelpResponse:
    ...
    response: shared_actionhelp.ActionHelp = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response') }})  
    status: ActionHelpResponseStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
