...
func (e *PowerPortConnectionStatusLabelEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Not Connected":
		fallthrough
	case "Connected":
		*e = PowerPortConnectionStatusLabelEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PowerPortConnectionStatusLabelEnum: %s", s)
	}
}

type PowerPortConnectionStatusValueEnum string

const (
	PowerPortConnectionStatusValueEnumFalse PowerPortConnectionStatusValueEnum = "false"
	PowerPortConnectionStatusValueEnumTrue  PowerPortConnectionStatusValueEnum = "true"
)

func (e *PowerPortConnectionStatusValueEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "false":
		fallthrough
	case "true":
		*e = PowerPortConnectionStatusValueEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PowerPortConnectionStatusValueEnum: %s", s)
	}
}

type PowerPortConnectionStatus struct {
	Label PowerPortConnectionStatusLabelEnum `json:"label"`
	Value PowerPortConnectionStatusValueEnum `json:"value"`
}
...
func (e *PowerPortTypeLabelEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "CS8465C":
		fallthrough
	case "ITA Type E (CEE 7/5)":
		fallthrough
	case "ITA Type F (CEE 7/4)":
		fallthrough
	case "ITA Type E/F (CEE 7/7)":
		fallthrough
	...
	case "ITA Type N":
		fallthrough
	case "ITA Type O":
		*e = PowerPortTypeLabelEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PowerPortTypeLabelEnum: %s", s)
	}
}
...
func (e *PowerPortTypeValueEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "ita-n":
		fallthrough
	case "ita-o":
		*e = PowerPortTypeValueEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PowerPortTypeValueEnum: %s", s)
	}
}
