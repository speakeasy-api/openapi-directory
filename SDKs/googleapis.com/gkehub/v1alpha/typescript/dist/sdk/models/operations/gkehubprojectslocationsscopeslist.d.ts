...
export declare class GkehubProjectsLocationsScopesListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class GkehubProjectsLocationsScopesListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class GkehubProjectsLocationsScopesListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
