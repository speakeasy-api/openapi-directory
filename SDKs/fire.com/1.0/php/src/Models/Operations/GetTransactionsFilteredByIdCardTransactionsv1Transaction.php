...
class GetTransactionsFilteredByIdCardTransactionsv1Transaction
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetTransactionsFilteredByIdCardTransactionsv1TransactionBatchItemDetails $batchItemDetails
     */
	#[\JMS\Serializer\Annotation\SerializedName('batchItemDetails')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\GetTransactionsFilteredByIdCardTransactionsv1TransactionBatchItemDetails')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetTransactionsFilteredByIdCardTransactionsv1TransactionBatchItemDetails $batchItemDetails = null;
    
    /**
     * Details of the card used (if applicable)
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedCard $card
     */
	#[\JMS\Serializer\Annotation\SerializedName('card')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedCard')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedCard $card = null;
    
    /**
     * The currency.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetTransactionsFilteredByIdCardTransactionsv1TransactionCurrency $currency
     */
	#[\JMS\Serializer\Annotation\SerializedName('currency')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\GetTransactionsFilteredByIdCardTransactionsv1TransactionCurrency')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetTransactionsFilteredByIdCardTransactionsv1TransactionCurrency $currency = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetTransactionsFilteredByIdCardTransactionsv1TransactionDirectDebitDetails $directDebitDetails
     */
	#[\JMS\Serializer\Annotation\SerializedName('directDebitDetails')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\GetTransactionsFilteredByIdCardTransactionsv1TransactionDirectDebitDetails')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetTransactionsFilteredByIdCardTransactionsv1TransactionDirectDebitDetails $directDebitDetails = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetTransactionsFilteredByIdCardTransactionsv1TransactionFxTrade $fxTradeDetails
     */
	#[\JMS\Serializer\Annotation\SerializedName('fxTradeDetails')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\GetTransactionsFilteredByIdCardTransactionsv1TransactionFxTrade')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetTransactionsFilteredByIdCardTransactionsv1TransactionFxTrade $fxTradeDetails = null;
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\GetTransactionsFilteredByIdCardTransactionsv1TransactionProprietarySchemeDetails> $proprietarySchemeDetails
     */
	#[\JMS\Serializer\Annotation\SerializedName('proprietarySchemeDetails')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Operations\GetTransactionsFilteredByIdCardTransactionsv1TransactionProprietarySchemeDetails>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
