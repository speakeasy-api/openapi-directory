...
import dataclasses
from ..shared import nanewschedulebody as shared_nanewschedulebody
...
class NANewScheduleResponse:
    ...
    body: Optional[shared_nanewschedulebody.NANewScheduleBody] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('body'), 'exclude': lambda f: f is None }})  
