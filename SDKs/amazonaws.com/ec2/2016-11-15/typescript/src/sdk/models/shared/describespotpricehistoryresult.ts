 ...
 * The instance type.
 */
export enum DescribeSpotPriceHistoryResultSpotPriceHistoryInstanceTypeEnum {
  A1Medium = "a1.medium",
  A1Large = "a1.large",
  A1Xlarge = "a1.xlarge",
 ...
 */
export enum DescribeSpotPriceHistoryResultSpotPriceHistoryProductDescriptionEnum {
 ...
 */
export class DescribeSpotPriceHistoryResultSpotPriceHistory extends SpeakeasyBase {
  @SpeakeasyMetadata()
