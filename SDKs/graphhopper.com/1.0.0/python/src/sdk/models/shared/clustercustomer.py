...
class ClusterCustomer:
    ...
    address: Optional[shared_clustercustomeraddress.ClusterCustomerAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address'), 'exclude': lambda f: f is None }})  
