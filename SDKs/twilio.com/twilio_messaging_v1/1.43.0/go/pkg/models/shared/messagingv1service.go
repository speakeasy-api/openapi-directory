...
func (e MessagingV1ServiceFallbackMethodEnum) ToPointer() *MessagingV1ServiceFallbackMethodEnum {
	return &e
}
...
func (e *MessagingV1ServiceFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = MessagingV1ServiceFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for MessagingV1ServiceFallbackMethodEnum: %v", v)
	}
}
...
func (e MessagingV1ServiceInboundMethodEnum) ToPointer() *MessagingV1ServiceInboundMethodEnum {
	return &e
}
...
func (e *MessagingV1ServiceInboundMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = MessagingV1ServiceInboundMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for MessagingV1ServiceInboundMethodEnum: %v", v)
	}
}
