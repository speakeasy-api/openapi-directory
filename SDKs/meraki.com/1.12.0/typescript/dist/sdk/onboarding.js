...
var Onboarding = /** @class */ (function () {
    function Onboarding(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Onboarding.prototype.getOrganizationCameraOnboardingStatuses = function (req, config) {
    ...
    **/
    Onboarding.prototype.updateOrganizationCameraOnboardingStatuses = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
