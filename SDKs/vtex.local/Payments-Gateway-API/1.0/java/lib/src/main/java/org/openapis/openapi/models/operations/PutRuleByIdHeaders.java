...
public class PutRuleByIdHeaders {
    /**
    ...
    public PutRuleByIdHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public PutRuleByIdHeaders withContentType(String contentType) {
    ...
    public PutRuleByIdHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public PutRuleByIdHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
