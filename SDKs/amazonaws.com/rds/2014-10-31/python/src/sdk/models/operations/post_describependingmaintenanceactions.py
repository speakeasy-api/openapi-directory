...
class PostDescribePendingMaintenanceActionsQueryParams:
    action: PostDescribePendingMaintenanceActionsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribePendingMaintenanceActionsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribePendingMaintenanceActionsRequest:
    headers: PostDescribePendingMaintenanceActionsHeaders = dataclasses.field()
    query_params: PostDescribePendingMaintenanceActionsQueryParams = dataclasses.field()
