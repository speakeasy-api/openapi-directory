 ...
 */
export declare enum PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawVehicleEngineTypeEnum {
    Combustion = "combustion",
    Electric = "electric"
}
export declare class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawRequest extends SpeakeasyBase {
...
export declare class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
