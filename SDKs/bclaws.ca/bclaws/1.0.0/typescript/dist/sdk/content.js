...
var Content = /** @class */ (function () {
    ...
    **/
    Content.prototype.getContentAspectId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetContentAspectIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/content/{aspectId}", req.pathParams);
    ...
    **/
    Content.prototype.getContentAspectIdCivixDocumentId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetContentAspectIdCivixDocumentIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/content/{aspectId}/{civixDocumentId}", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
