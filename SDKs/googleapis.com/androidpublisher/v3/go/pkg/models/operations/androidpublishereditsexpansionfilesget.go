...
func (e AndroidpublisherEditsExpansionfilesGetExpansionFileTypeEnum) ToPointer() *AndroidpublisherEditsExpansionfilesGetExpansionFileTypeEnum {
	return &e
}

func (e *AndroidpublisherEditsExpansionfilesGetExpansionFileTypeEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "main":
		fallthrough
	case "patch":
		*e = AndroidpublisherEditsExpansionfilesGetExpansionFileTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AndroidpublisherEditsExpansionfilesGetExpansionFileTypeEnum: %v", v)
	}
}
