...
public class ListCredentialListCredentialResponse {
    ...
    public openapisdk.models.shared.NotifyV1Credential[] credentials;
    public ListCredentialListCredentialResponse withCredentials(openapisdk.models.shared.NotifyV1Credential[] credentials) {
