...
var EventItem = /** @class */ (function () {
     ...
     */
    EventItem.prototype.getEventItems = function (req, security, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetEventItemsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.eventItemSearchResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.EventItemSearchResponse);
                    }
                    break;
