...
class DescribeFirewallPolicyRequest:
    ...
    describe_firewall_policy_request: shared_describefirewallpolicyrequest.DescribeFirewallPolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
