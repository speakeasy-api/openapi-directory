...
public class UpdateInventoryForAnItemJsonQueryParams {
    /**
    ...
    public UpdateInventoryForAnItemJsonQueryParams withShipNode(String shipNode) {
    ...
    public String sku;
    public UpdateInventoryForAnItemJsonQueryParams withSku(String sku) {
        this.sku = sku;
        return this;
    }
