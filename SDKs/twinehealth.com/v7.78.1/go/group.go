...
func (s *group) FetchGroup(ctx context.Context, request operations.FetchGroupRequest) (*operations.FetchGroupResponse, error) {
	...
	res := &operations.FetchGroupResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/vnd.api+json`):
			var out *shared.FetchGroupResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *group) FetchGroups(ctx context.Context, request operations.FetchGroupsRequest) (*operations.FetchGroupsResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/group"
	...
	res := &operations.FetchGroupsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
