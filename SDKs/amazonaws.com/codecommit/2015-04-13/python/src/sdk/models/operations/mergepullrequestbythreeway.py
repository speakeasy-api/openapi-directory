...
from ..shared import mergepullrequestbythreewayinput as shared_mergepullrequestbythreewayinput
from ..shared import mergepullrequestbythreewayoutput as shared_mergepullrequestbythreewayoutput

class MergePullRequestByThreeWayXAmzTargetEnum(str, Enum):
    CODE_COMMIT_20150413_MERGE_PULL_REQUEST_BY_THREE_WAY = "CodeCommit_20150413.MergePullRequestByThreeWay"


@dataclasses.dataclass
class MergePullRequestByThreeWayHeaders:
    x_amz_target: MergePullRequestByThreeWayXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class MergePullRequestByThreeWayRequest:
    headers: MergePullRequestByThreeWayHeaders = dataclasses.field()
    request: shared_mergepullrequestbythreewayinput.MergePullRequestByThreeWayInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class MergePullRequestByThreeWayResponse:
    ...
    merge_pull_request_by_three_way_output: Optional[shared_mergepullrequestbythreewayoutput.MergePullRequestByThreeWayOutput] = dataclasses.field(default=None)
