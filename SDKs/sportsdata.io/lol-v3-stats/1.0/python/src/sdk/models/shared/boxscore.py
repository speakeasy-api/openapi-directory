...
class BoxScore:
    ...
    matches: Optional[list[shared_match.Match]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Matches'), 'exclude': lambda f: f is None }})  
