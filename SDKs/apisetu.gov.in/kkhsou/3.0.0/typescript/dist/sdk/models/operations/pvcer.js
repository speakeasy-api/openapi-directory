...
var PvcerRequestBodyCertificateParameters = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ENROL_NO" }),
        __metadata("design:type", String)
    ], PvcerRequestBodyCertificateParameters.prototype, "enrolNO", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=FullName" }),
        __metadata("design:type", String)
    ], PvcerRequestBodyCertificateParameters.prototype, "fullName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=YEAR" }),
        __metadata("design:type", String)
    ], PvcerRequestBodyCertificateParameters.prototype, "year", void 0);
