...
public class ListTrustAnchorsQueryParams {
    /**
    ...
    public ListTrustAnchorsQueryParams withNextToken(String nextToken) {
    ...
    public ListTrustAnchorsQueryParams withPageSize(Long pageSize) {
