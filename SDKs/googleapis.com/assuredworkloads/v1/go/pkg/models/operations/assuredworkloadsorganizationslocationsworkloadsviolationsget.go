...
type AssuredworkloadsOrganizationsLocationsWorkloadsViolationsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AssuredworkloadsOrganizationsLocationsWorkloadsViolationsGetPathParams struct {
...
type AssuredworkloadsOrganizationsLocationsWorkloadsViolationsGetQueryParams struct {
	// V1 error format.
...
type AssuredworkloadsOrganizationsLocationsWorkloadsViolationsGetRequest struct {
...
type AssuredworkloadsOrganizationsLocationsWorkloadsViolationsGetResponse struct {
	ContentType string
	// Successful response
