...
from ..shared import proxymodifycontact as shared_proxymodifycontact
...
class ObjectPUTContactRequest:
    ...
    r"""Object id"""  
    proxy_modify_contact: shared_proxymodifycontact.ProxyModifyContact = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
