...
class AuthGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\AuthGetRequestOptions $options
     */
	#[\JMS\Serializer\Annotation\SerializedName('options')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\AuthGetRequestOptions')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?AuthGetRequestOptions $options = null;
