...
exports.ListCallNotificationResponse = exports.ListCallNotificationListCallNotificationResponse = exports.ListCallNotificationRequest = exports.ListCallNotificationSecurity = exports.ListCallNotificationServerList = void 0;
...
var ListCallNotificationSecurity = /** @class */ (function (_super) {
    ...
    ], ListCallNotificationSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListCallNotificationSecurity.prototype, "username", void 0);
...
var ListCallNotificationRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListCallNotificationRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=CallSid",
        }),
        __metadata("design:type", String)
    ], ListCallNotificationRequest.prototype, "callSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Log" }),
        __metadata("design:type", Number)
    ], ListCallNotificationRequest.prototype, "log", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=MessageDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListCallNotificationRequest.prototype, "messageDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=MessageDate<;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListCallNotificationRequest.prototype, "messageDateLessThan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=MessageDate>;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListCallNotificationRequest.prototype, "messageDateGreaterThan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListCallNotificationRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListCallNotificationRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListCallNotificationRequest.prototype, "pageToken", void 0);
...
var ListCallNotificationListCallNotificationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ApiV2010AccountCallCallNotification }),
        (0, class_transformer_1.Expose)({ name: "notifications" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountCallCallNotification; }),
...
var ListCallNotificationResponse = /** @class */ (function (_super) {
    ...
    ], ListCallNotificationResponse.prototype, "rawResponse", void 0);
