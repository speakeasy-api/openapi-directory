...
exports.DeleteMobileDeviceAccessRuleResponse = exports.DeleteMobileDeviceAccessRuleRequest = exports.DeleteMobileDeviceAccessRuleXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var DeleteMobileDeviceAccessRuleXAmzTargetEnum;
...
})(DeleteMobileDeviceAccessRuleXAmzTargetEnum = exports.DeleteMobileDeviceAccessRuleXAmzTargetEnum || (exports.DeleteMobileDeviceAccessRuleXAmzTargetEnum = {}));
var DeleteMobileDeviceAccessRuleRequest = /** @class */ (function (_super) {
    ...
    ], DeleteMobileDeviceAccessRuleRequest.prototype, "deleteMobileDeviceAccessRuleRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], DeleteMobileDeviceAccessRuleRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], DeleteMobileDeviceAccessRuleRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], DeleteMobileDeviceAccessRuleRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], DeleteMobileDeviceAccessRuleRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], DeleteMobileDeviceAccessRuleRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], DeleteMobileDeviceAccessRuleRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], DeleteMobileDeviceAccessRuleRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], DeleteMobileDeviceAccessRuleRequest.prototype, "xAmzTarget", void 0);
...
var DeleteMobileDeviceAccessRuleResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], DeleteMobileDeviceAccessRuleResponse.prototype, "rawResponse", void 0);
