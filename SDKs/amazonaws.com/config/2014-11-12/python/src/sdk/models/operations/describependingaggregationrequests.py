...
class DescribePendingAggregationRequestsRequest:
    ...
    describe_pending_aggregation_requests_request: shared_describependingaggregationrequestsrequest.DescribePendingAggregationRequestsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
