...
class InboxRegistrationEntity:
    ...
    r"""Id of associated inbox"""  
    inbox_recipient_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('inbox_recipient_id'), 'exclude': lambda f: f is None }})
    r"""Id of associated inbox recipient"""  
    inbox_title: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('inbox_title'), 'exclude': lambda f: f is None }})
    r"""Title of associated inbox"""  
