...
class WritablePowerOutletTemplateInput:
    ...
    feed_leg: Optional[WritablePowerOutletTemplateFeedLegEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('feed_leg'), 'exclude': lambda f: f is None }})
    r"""Phase (for three-phase feeds)"""  
    ...
    type: Optional[WritablePowerOutletTemplateTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
