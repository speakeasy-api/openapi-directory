...
from ..shared import proxycreatebillrun as shared_proxycreatebillrun
...
class ObjectPostBillRunQueryParams:
...
@dataclasses.dataclass
class ObjectPostBillRunHeaders:
    zuora_entity_ids: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Entity-Ids', 'style': 'simple', 'explode': False }})
    zuora_track_id: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Track-Id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectPostBillRunRequest:
    headers: ObjectPostBillRunHeaders = dataclasses.field()
    query_params: ObjectPostBillRunQueryParams = dataclasses.field()
    request: shared_proxycreatebillrun.ProxyCreateBillRun = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class ObjectPostBillRunResponse:
