...
class AccountsV1CredentialCredentialPublicKey:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Credential that the PublicKey resource belongs to."""  
    ...
    r"""The unique string that that we created to identify the PublicKey resource."""  
