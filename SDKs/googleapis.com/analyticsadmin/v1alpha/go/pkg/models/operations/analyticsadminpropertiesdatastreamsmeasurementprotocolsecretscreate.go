...
type AnalyticsadminPropertiesDataStreamsMeasurementProtocolSecretsCreateRequest struct {
	...
	GoogleAnalyticsAdminV1alphaMeasurementProtocolSecretInput *shared.GoogleAnalyticsAdminV1alphaMeasurementProtocolSecretInput `request:"mediaType=application/json"`
	// OAuth access token.
