...
var GetAddressInfoResponseUtxosTokens = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "issueTxid" }),
        __metadata("design:type", String)
...
var GetAddressInfoResponseUtxos = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "blockheight" }),
        __metadata("design:type", Number)
    ], GetAddressInfoResponseUtxos.prototype, "blockheight", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "blocktime" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "scriptPubKey" }),
        __metadata("design:type", Object)
    ], GetAddressInfoResponseUtxos.prototype, "scriptPubKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: GetAddressInfoResponseUtxosTokens }),
        (0, class_transformer_1.Expose)({ name: "tokens" }),
        (0, class_transformer_1.Type)(function () { return GetAddressInfoResponseUtxosTokens; }),
...
var GetAddressInfoResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: GetAddressInfoResponseUtxos }),
        (0, class_transformer_1.Expose)({ name: "utxos" }),
        (0, class_transformer_1.Type)(function () { return GetAddressInfoResponseUtxos; }),
        __metadata("design:type", Array)
