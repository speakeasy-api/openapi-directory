 ...
 */
export class DescribeIpamResourceDiscoveriesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeIpamResourceDiscoveriesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
