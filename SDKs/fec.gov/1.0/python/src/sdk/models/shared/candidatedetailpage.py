...
from ..shared import candidatedetail as shared_candidatedetail
...
class CandidateDetailPage:
    ...
    results: Optional[list[shared_candidatedetail.CandidateDetail]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
