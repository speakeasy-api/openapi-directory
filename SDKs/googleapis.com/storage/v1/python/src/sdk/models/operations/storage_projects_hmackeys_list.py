...
class StorageProjectsHmacKeysListRequest:
    ...
    r"""Name of the project in which to look for HMAC keys."""  
    ...
    r"""Maximum number of items to return in a single page of responses. The service uses this parameter or 250 items, whichever is smaller. The max number of items per page will also be limited by the number of distinct service accounts in the response. If the number of service accounts in a single response is too high, the page will truncated and a next page token will be returned."""  
    ...
    r"""If present, only keys for the given service account are returned."""  
    ...
    r"""Whether or not to show keys in the DELETED state."""  
