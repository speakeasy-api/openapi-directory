...
type ListDistributions20181105QueryParams struct {
...
type ListDistributions20181105Headers struct {
...
type ListDistributions20181105Request struct {
	QueryParams ListDistributions20181105QueryParams
	Headers     ListDistributions20181105Headers
}

type ListDistributions20181105Response struct {
	Body        []byte
	ContentType string
	StatusCode  int
