 ...
 */
export enum PickupPartialAddressAddressResidentialIndicatorEnum {
  Unknown = "unknown",
  Yes = "yes",
  No = "no",
}
 ...
 */
export class PickupPartialAddress extends SpeakeasyBase {
  /**
  ...
  addressResidentialIndicator: PickupPartialAddressAddressResidentialIndicatorEnum;
 ...
 *
 */
export class PickupOutput extends SpeakeasyBase {
  /**
  ...
  @Type(() => PickupPartialAddress)
  pickupAddress?: PickupPartialAddress;
