 ...
 */
export declare enum SslCertificateListWarningCodeEnum {
...
export declare class SslCertificateListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class SslCertificateListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class SslCertificateList extends SpeakeasyBase {
    /**
