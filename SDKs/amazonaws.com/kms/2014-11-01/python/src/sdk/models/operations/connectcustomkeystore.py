...
class ConnectCustomKeyStoreRequest:
    headers: ConnectCustomKeyStoreHeaders = dataclasses.field()
    request: shared_connectcustomkeystorerequest.ConnectCustomKeyStoreRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
