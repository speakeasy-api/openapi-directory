...
class ListAlphaSenderListAlphaSenderResponse:
    ...
    alpha_senders: Optional[list[shared_messaging_v1_service_alpha_sender.MessagingV1ServiceAlphaSender]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('alpha_senders'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListAlphaSenderListAlphaSenderResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
