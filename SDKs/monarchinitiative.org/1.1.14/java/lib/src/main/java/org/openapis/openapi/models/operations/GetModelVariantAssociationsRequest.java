...
public class GetModelVariantAssociationsRequest {
    ...
    public GetModelVariantAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetModelVariantAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetModelVariantAssociationsRequest withEvidence(String evidence) {
    ...
    public GetModelVariantAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetModelVariantAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetModelVariantAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetModelVariantAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetModelVariantAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetModelVariantAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetModelVariantAssociationsRequest withRelation(String relation) {
    ...
    public GetModelVariantAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetModelVariantAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetModelVariantAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetModelVariantAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetModelVariantAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetModelVariantAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetModelVariantAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetModelVariantAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
