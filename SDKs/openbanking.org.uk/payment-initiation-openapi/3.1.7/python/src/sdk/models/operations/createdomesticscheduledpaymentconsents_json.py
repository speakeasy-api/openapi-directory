...
class CreateDomesticScheduledPaymentConsentsJSONSecurity:
...
class CreateDomesticScheduledPaymentConsentsJSONRequest:
    ...
    ob_write_domestic_scheduled_consent4: shared_obwritedomesticscheduledconsent4.OBWriteDomesticScheduledConsent4 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Default"""  
...
@dataclasses.dataclass
class CreateDomesticScheduledPaymentConsentsJSONResponse:
