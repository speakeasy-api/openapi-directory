...
public class POSTUpdateCustomVerificationEmailTemplateRequest {
    ...
    public POSTUpdateCustomVerificationEmailTemplateRequest(@JsonProperty("Action") POSTUpdateCustomVerificationEmailTemplateActionEnum action, @JsonProperty("Version") POSTUpdateCustomVerificationEmailTemplateVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
