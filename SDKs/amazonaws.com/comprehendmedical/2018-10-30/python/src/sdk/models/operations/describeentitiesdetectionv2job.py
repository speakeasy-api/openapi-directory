...
class DescribeEntitiesDetectionV2JobRequest:
    ...
    describe_entities_detection_v2_job_request: shared_describeentitiesdetectionv2jobrequest.DescribeEntitiesDetectionV2JobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
