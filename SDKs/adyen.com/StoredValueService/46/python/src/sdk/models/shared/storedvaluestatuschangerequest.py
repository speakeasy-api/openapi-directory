...
class StoredValueStatusChangeRequestShopperInteractionEnum(str, Enum):
...
class StoredValueStatusChangeRequestStatusEnum(str, Enum):
    r"""The status you want to change to"""
    ACTIVE = 'active'
    INACTIVE = 'inactive'
...
class StoredValueStatusChangeRequest:
    ...
    """  
    status: StoredValueStatusChangeRequestStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""The status you want to change to"""  
    ...
    shopper_interaction: Optional[StoredValueStatusChangeRequestShopperInteractionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shopperInteraction'), 'exclude': lambda f: f is None }})
    r"""Specifies the sales channel, through which the shopper gives their card details, and whether the shopper is a returning customer.
    For the web service API, Adyen assumes Ecommerce shopper interaction by default.
