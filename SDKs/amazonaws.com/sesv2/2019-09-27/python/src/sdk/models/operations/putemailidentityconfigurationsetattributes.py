...
@dataclasses.dataclass
class PutEmailIdentityConfigurationSetAttributesHeaders:
...
class PutEmailIdentityConfigurationSetAttributesRequest:
    headers: PutEmailIdentityConfigurationSetAttributesHeaders = dataclasses.field()
    path_params: PutEmailIdentityConfigurationSetAttributesPathParams = dataclasses.field()
    request: PutEmailIdentityConfigurationSetAttributesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
