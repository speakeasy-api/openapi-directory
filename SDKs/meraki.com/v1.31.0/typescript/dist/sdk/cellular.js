...
exports.Cellular = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var Cellular = /** @class */ (function () {
    function Cellular(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return the SIM and APN configurations for a cellular device.
     */
    Cellular.prototype.getDeviceCellularSims = function (req, config) {
     ...
     * Updates the SIM and APN configurations for a cellular device.
     */
    Cellular.prototype.updateDeviceCellularSims = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
