...
func (e ListTagOptionsXAmzTargetEnum) ToPointer() *ListTagOptionsXAmzTargetEnum {
	return &e
}
...
func (e *ListTagOptionsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWS242ServiceCatalogService.ListTagOptions":
		*e = ListTagOptionsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListTagOptionsXAmzTargetEnum: %v", v)
	}
}

type ListTagOptionsRequest struct {
	ListTagOptionsInput shared.ListTagOptionsInput `request:"mediaType=application/json"`
	// Pagination limit
