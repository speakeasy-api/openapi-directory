...
from ..shared import querybatchresponsev4 as shared_querybatchresponsev4
...
class QueryBatchStatusV4Response:
    ...
    query_batch_response_v4: Optional[shared_querybatchresponsev4.QueryBatchResponseV4] = dataclasses.field(default=None)
    r"""Get Batch Status"""  
