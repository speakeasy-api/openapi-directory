...
exports.SentryImpactRiskObject = void 0;
...
var SentryImpactRiskObject = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Palermo_scale_max" }),
        __metadata("design:type", String)
    ], SentryImpactRiskObject.prototype, "palermoScaleMax", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=absolute_magnitude" }),
        __metadata("design:type", String)
    ], SentryImpactRiskObject.prototype, "absoluteMagnitude", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=average_lunar_distance" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=impact_probability" }),
        __metadata("design:type", String)
    ], SentryImpactRiskObject.prototype, "impactProbability", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=is_active_sentry_object" }),
        __metadata("design:type", Boolean)
    ], SentryImpactRiskObject.prototype, "isActiveSentryObject", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_obs" }),
        __metadata("design:type", String)
    ], SentryImpactRiskObject.prototype, "lastObs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_obs_jd" }),
        __metadata("design:type", String)
    ], SentryImpactRiskObject.prototype, "lastObsJd", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=palermo_scale_ave" }),
        __metadata("design:type", String)
    ], SentryImpactRiskObject.prototype, "palermoScaleAve", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=potential_impacts" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sentryId" }),
        __metadata("design:type", String)
    ], SentryImpactRiskObject.prototype, "sentryId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=torino_scale" }),
        __metadata("design:type", String)
    ], SentryImpactRiskObject.prototype, "torinoScale", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=v_infinity" }),
        __metadata("design:type", String)
    ], SentryImpactRiskObject.prototype, "vInfinity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=year_range_max" }),
        __metadata("design:type", String)
    ], SentryImpactRiskObject.prototype, "yearRangeMax", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=year_range_min" }),
        __metadata("design:type", String)
    ], SentryImpactRiskObject.prototype, "yearRangeMin", void 0);
    return SentryImpactRiskObject;
}(utils_1.SpeakeasyBase));
exports.SentryImpactRiskObject = SentryImpactRiskObject;
