...
export class TestGetTestRunsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class TestGetTestRunsRequest extends SpeakeasyBase {
  /**
 ...
 */
export class TestGetTestRunsTestRunTestRunStatistics extends SpeakeasyBase {
  /**
 ...
 * Summary single test run on Xamarin Test Cloud
 */
export class TestGetTestRunsTestRun extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "stats" })
  @Type(() => TestGetTestRunsTestRunTestRunStatistics)
...
export class TestGetTestRunsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   * OK
   */
  @SpeakeasyMetadata({ elemType: TestGetTestRunsTestRun })
