...
class CoveragePlanCreateRequestCobraRules:
    r"""CoveragePlanCreateRequestCobraRules
...
class CoveragePlanCreateRequest:
    ...
    cobra_rules: Optional[CoveragePlanCreateRequestCobraRules] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cobra_rules') }})
