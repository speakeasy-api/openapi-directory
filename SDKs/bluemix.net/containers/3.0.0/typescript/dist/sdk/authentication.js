...
var Authentication = /** @class */ (function () {
    ...
    Authentication.prototype.getTlskey = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetTlskeyResponse({
    ...
    Authentication.prototype.putTlskeyRefresh = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PutTlskeyRefreshResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.certificateRefresh = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.CertificateRefresh);
                    }
                    break;
                case [401, 500].includes(httpRes === null || httpRes === void 0 ? void 0 : httpRes.status):
                    break;
