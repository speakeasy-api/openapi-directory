...
public class Journey {
	...
	public Journey(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.JourneyJourneyResultsResponse journeyJourneyResults(org.openapis.openapi.models.operations.JourneyJourneyResultsRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.TflApiPresentationEntitiesJourneyPlannerItineraryResult out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.TflApiPresentationEntitiesJourneyPlannerItineraryResult.class);
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.JourneyMetaResponse journeyMeta() throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/Journey/Meta/Modes");
