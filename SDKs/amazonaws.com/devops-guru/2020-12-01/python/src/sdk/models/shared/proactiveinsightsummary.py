...
class ProactiveInsightSummary:
    r"""Details about a proactive insight. This object is returned by <code>DescribeInsight.</code>"""
    
    associated_resource_arns: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AssociatedResourceArns'), 'exclude': lambda f: f is None }})  
