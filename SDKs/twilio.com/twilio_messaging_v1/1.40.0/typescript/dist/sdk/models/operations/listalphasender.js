...
exports.ListAlphaSenderResponse = exports.ListAlphaSenderListAlphaSenderResponse = exports.ListAlphaSenderListAlphaSenderResponseMeta = exports.ListAlphaSenderRequest = exports.ListAlphaSenderSecurity = exports.ListAlphaSenderServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListAlphaSenderServerList = [
...
var ListAlphaSenderSecurity = /** @class */ (function (_super) {
    ...
    ], ListAlphaSenderSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListAlphaSenderSecurity.prototype, "username", void 0);
    return ListAlphaSenderSecurity;
}(utils_1.SpeakeasyBase));
exports.ListAlphaSenderSecurity = ListAlphaSenderSecurity;
var ListAlphaSenderRequest = /** @class */ (function (_super) {
    ...
    ], ListAlphaSenderRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListAlphaSenderRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListAlphaSenderRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListAlphaSenderRequest.prototype, "serviceSid", void 0);
    return ListAlphaSenderRequest;
}(utils_1.SpeakeasyBase));
exports.ListAlphaSenderRequest = ListAlphaSenderRequest;
...
exports.ListAlphaSenderListAlphaSenderResponseMeta = ListAlphaSenderListAlphaSenderResponseMeta;
/**
 * OK
 */
var ListAlphaSenderListAlphaSenderResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.MessagingV1ServiceAlphaSender }),
        (0, class_transformer_1.Expose)({ name: "alpha_senders" }),
        (0, class_transformer_1.Type)(function () { return shared.MessagingV1ServiceAlphaSender; }),
        __metadata("design:type", Array)
    ], ListAlphaSenderListAlphaSenderResponse.prototype, "alphaSenders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListAlphaSenderListAlphaSenderResponseMeta; }),
...
exports.ListAlphaSenderListAlphaSenderResponse = ListAlphaSenderListAlphaSenderResponse;
var ListAlphaSenderResponse = /** @class */ (function (_super) {
    ...
    ], ListAlphaSenderResponse.prototype, "rawResponse", void 0);
    return ListAlphaSenderResponse;
}(utils_1.SpeakeasyBase));
exports.ListAlphaSenderResponse = ListAlphaSenderResponse;
