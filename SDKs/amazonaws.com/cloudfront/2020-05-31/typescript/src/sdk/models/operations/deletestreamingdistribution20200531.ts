...
export class DeleteStreamingDistribution20200531Request extends SpeakeasyBase {
  /**
   * The distribution ID.
   */
...
export class DeleteStreamingDistribution20200531Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
