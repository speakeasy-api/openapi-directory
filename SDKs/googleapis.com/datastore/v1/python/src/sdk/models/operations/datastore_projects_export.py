...
from ..shared import googledatastoreadminv1exportentitiesrequest as shared_googledatastoreadminv1exportentitiesrequest
...
class DatastoreProjectsExportRequest:
    ...
    google_datastore_admin_v1_export_entities_request: Optional[shared_googledatastoreadminv1exportentitiesrequest.GoogleDatastoreAdminV1ExportEntitiesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
