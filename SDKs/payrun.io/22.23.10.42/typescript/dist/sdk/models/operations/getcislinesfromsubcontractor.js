...
exports.GetCisLinesFromSubContractorResponse = exports.GetCisLinesFromSubContractorRequest = void 0;
...
var GetCisLinesFromSubContractorRequest = /** @class */ (function (_super) {
    ...
    ], GetCisLinesFromSubContractorRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetCisLinesFromSubContractorRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetCisLinesFromSubContractorRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], GetCisLinesFromSubContractorRequest.prototype, "subContractorId", void 0);
    return GetCisLinesFromSubContractorRequest;
}(utils_1.SpeakeasyBase));
exports.GetCisLinesFromSubContractorRequest = GetCisLinesFromSubContractorRequest;
var GetCisLinesFromSubContractorResponse = /** @class */ (function (_super) {
    ...
    ], GetCisLinesFromSubContractorResponse.prototype, "rawResponse", void 0);
    return GetCisLinesFromSubContractorResponse;
}(utils_1.SpeakeasyBase));
exports.GetCisLinesFromSubContractorResponse = GetCisLinesFromSubContractorResponse;
