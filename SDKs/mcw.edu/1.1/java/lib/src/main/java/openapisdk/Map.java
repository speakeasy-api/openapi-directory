...
public class Map {
    ...
    **/
    public openapisdk.models.operations.GetMapsBySpeciesUsingGetResponse getMapsBySpeciesUsingGet(openapisdk.models.operations.GetMapsBySpeciesUsingGetRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/maps/{speciesTypeKey}", request.pathParams);
        ...
        openapisdk.models.operations.GetMapsBySpeciesUsingGetResponse res = new openapisdk.models.operations.GetMapsBySpeciesUsingGetResponse() {{
            body = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
