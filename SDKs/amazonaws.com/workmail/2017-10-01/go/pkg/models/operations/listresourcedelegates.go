...
func (e ListResourceDelegatesXAmzTargetEnum) ToPointer() *ListResourceDelegatesXAmzTargetEnum {
	return &e
}
...
func (e *ListResourceDelegatesXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "WorkMailService.ListResourceDelegates":
		*e = ListResourceDelegatesXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListResourceDelegatesXAmzTargetEnum: %v", v)
	}
}
