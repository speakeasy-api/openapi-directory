...
from ..shared import jobscheduleupdateparameter as shared_jobscheduleupdateparameter
...
class JobScheduleUpdateRequest:
    ...
    job_schedule_update_parameter: shared_jobscheduleupdateparameter.JobScheduleUpdateParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
