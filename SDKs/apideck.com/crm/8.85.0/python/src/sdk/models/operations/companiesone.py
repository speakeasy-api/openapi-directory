...
from ..shared import getcompanyresponse as shared_getcompanyresponse
...
class CompaniesOneResponse:
    ...
    get_company_response: Optional[shared_getcompanyresponse.GetCompanyResponse] = dataclasses.field(default=None)
