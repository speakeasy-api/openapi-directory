...
type BankTransferEventListRequest struct {
	...
	BankTransferType *BankTransferEventListBankTransferTypeEnum `json:"bank_transfer_type,omitempty"`
	...
	Direction *BankTransferEventListDirectionEnum `json:"direction,omitempty"`
