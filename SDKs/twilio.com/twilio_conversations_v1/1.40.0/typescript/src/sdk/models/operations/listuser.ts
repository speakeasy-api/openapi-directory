...
export const ListUserServerList = ["https://conversations.twilio.com"] as const;
...
export class ListUserListUserResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.ConversationsV1User })
  @Expose({ name: "users" })
  @Type(() => shared.ConversationsV1User)
