...
import { HttpHealthCheck1 } from "./httphealthcheck1";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum HttpHealthCheckListWarningCodeEnum {
...
export declare class HttpHealthCheckListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class HttpHealthCheckListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: HttpHealthCheckListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: HttpHealthCheckListWarningData[];
    /**
 ...
 */
export declare class HttpHealthCheckList extends SpeakeasyBase {
    /**
