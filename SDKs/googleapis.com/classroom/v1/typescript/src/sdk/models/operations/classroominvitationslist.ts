...
export class ClassroomInvitationsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ClassroomInvitationsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ClassroomInvitationsListSecurity extends SpeakeasyBase {
...
export class ClassroomInvitationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ClassroomInvitationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
