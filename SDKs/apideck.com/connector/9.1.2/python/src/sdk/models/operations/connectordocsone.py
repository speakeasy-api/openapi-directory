...
class ConnectorDocsOneRequest:
    ...
    doc_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'doc_id', 'style': 'simple', 'explode': False }})
    r"""ID of the Doc"""  
...
class ConnectorDocsOneResponse:
    ...
    connector_docs_one_200_text_markdown_markdown_string: Optional[str] = dataclasses.field(default=None)
    r"""Connectors"""  
