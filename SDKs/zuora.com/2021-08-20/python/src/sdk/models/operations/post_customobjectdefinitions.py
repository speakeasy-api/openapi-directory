...
class POSTCustomObjectDefinitionsRequest:
    ...
    post_custom_object_definitions_request: shared_postcustomobjectdefinitionsrequest.PostCustomObjectDefinitionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
