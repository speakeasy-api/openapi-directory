...
class PutMetadataRequestBody:
    ...
    r"""ARN of the channel into which metadata is inserted. This channel must have an active stream."""  
    metadata: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metadata') }})
    r"""Metadata to insert into the stream. Maximum: 1 KB per request."""  
    

@dataclasses.dataclass
class PutMetadataRequest:
    
    request_body: PutMetadataRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
