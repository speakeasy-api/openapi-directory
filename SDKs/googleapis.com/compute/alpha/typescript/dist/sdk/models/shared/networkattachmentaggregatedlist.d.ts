...
import { NetworkAttachmentsScopedList } from "./networkattachmentsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum NetworkAttachmentAggregatedListWarningCodeEnum {
...
export declare class NetworkAttachmentAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NetworkAttachmentAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: NetworkAttachmentAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: NetworkAttachmentAggregatedListWarningData[];
    /**
 ...
 */
export declare class NetworkAttachmentAggregatedList extends SpeakeasyBase {
    /**
     ...
     */
    items?: Record<string, NetworkAttachmentsScopedList>;
    kind?: string;
    /**
