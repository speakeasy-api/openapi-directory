...
public class ArticleGetListQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=maximumBillBeeArticleId")
    public Long maximumBillBeeArticleId;
    public ArticleGetListQueryParams withMaximumBillBeeArticleId(Long maximumBillBeeArticleId) {
    ...
    public ArticleGetListQueryParams withMinCreatedAt(OffsetDateTime minCreatedAt) {
    ...
    public ArticleGetListQueryParams withMinimumBillBeeArticleId(Long minimumBillBeeArticleId) {
    ...
    public Integer page;
    public ArticleGetListQueryParams withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public ArticleGetListQueryParams withPageSize(Integer pageSize) {
