...
class Article:
    ...
    org_facet: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('org_facet'), 'exclude': lambda f: f is None }})  
