  ...
  **/
  getCertificatesIdActions(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetCertificatesIdActionsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  getCertificatesIdActionsActionId(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetCertificatesIdActionsActionIdResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  postCertificatesIdActionsRetry(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostCertificatesIdActionsRetryResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
