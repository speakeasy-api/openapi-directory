...
public class UpdateNetworkApplianceFirewallOneToOneNatRulesRequestBody {
    ...
    public UpdateNetworkApplianceFirewallOneToOneNatRulesRequestBody(@JsonProperty("rules") UpdateNetworkApplianceFirewallOneToOneNatRulesRequestBodyRules[] rules) {
        this.rules = rules;
  }
}
