 ...
 * ~
 */
export enum DeliveryReportDeliveryCategoryEnum {
  NoData = "NO_DATA",
  OptedOut = "OPTED_OUT",
  Bounced = "BOUNCED",
 ...
 * ~
 */
export enum DeliveryReportDeliveryStateEnum {
  Delivered = "DELIVERED",
 ...
 * ~
 */
export class DeliveryReport extends SpeakeasyBase {
  /**
   * ~
   */
  @SpeakeasyMetadata()
