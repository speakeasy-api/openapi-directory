...
export class AppengineAppsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AppengineAppsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AppengineAppsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
