...
public class GetSpotById200ApplicationJSON1 {
    /**
    ...
    public GetSpotById200ApplicationJSON1AntennaReportLocations[] antennaReportLocations;
    public GetSpotById200ApplicationJSON1 withAntennaReportLocations(GetSpotById200ApplicationJSON1AntennaReportLocations[] antennaReportLocations) {
    ...
    public GetSpotById200ApplicationJSON1 withConfig(java.util.Map<String, Object> config) {
        this.config = config;
        return this;
    }
    ...
    public GetSpotById200ApplicationJSON1 withConfigRequest(java.util.Map<String, Object> configRequest) {
    ...
    public GetSpotById200ApplicationJSON1 withGeoCoords(org.openapis.openapi.models.shared.GeoCoords geoCoords) {
    ...
    @JsonProperty("id")
    public String id;
    public GetSpotById200ApplicationJSON1 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetSpotById200ApplicationJSON1 withIsOnline(Boolean isOnline) {
    ...
    public GetSpotById200ApplicationJSON1 withReportLocation(org.openapis.openapi.models.shared.Location reportLocation) {
    ...
    public GetSpotById200ApplicationJSON1 withRequestCounter(Long requestCounter) {
    ...
    public GetSpotById200ApplicationJSON1 withSenses(java.util.Map<String, Object> senses) {
        this.senses = senses;
        return this;
    }
    ...
    public GetSpotById200ApplicationJSON1 withSensesRequest(java.util.Map<String, Object> sensesRequest) {
    ...
    public GetSpotById200ApplicationJSON1 withSerialNumber(Long serialNumber) {
    ...
    public GetSpotById200ApplicationJSON1 withStatus(Object status) {
        this.status = status;
        return this;
    }
    ...
    public GetSpotById200ApplicationJSON1 withTimeCreated(String timeCreated) {
    ...
    public GetSpotById200ApplicationJSON1 withTimeUpdated(String timeUpdated) {
    ...
    @JsonProperty("url")
    public String url;
    public GetSpotById200ApplicationJSON1 withUrl(String url) {
        this.url = url;
        return this;
    }
