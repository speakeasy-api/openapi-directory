...
var Appointments = /** @class */ (function () {
    ...
    **/
    Appointments.prototype.getSetupV1AppointmentsId = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/setup/v1/appointments/{id}", req.pathParams);
        var client = this._securityClient;
    ...
    **/
    Appointments.prototype.putSetupV1AppointmentsIdReassignResourceResourceId = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/setup/v1/appointments/{id}/reassign/resource/{resourceId}", req.pathParams);
        var client = this._securityClient;
