...
class OBWriteInternationalScheduledResponse6
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalScheduledResponse6Data')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalScheduledResponse6Data();
		$this->links = null;
		$this->meta = null;
	}
}
