 ...
 */
export enum RegistrationsLinkedNodesListNodeAttributesCategoryEnum {
  Analysis = "analysis",
 ...
 */
export class RegistrationsLinkedNodesListNodeAttributes extends SpeakeasyBase {
  /**
   * The category of the node, as selected by project contributors.
   */
  @SpeakeasyMetadata()
 ...
 */
export class RegistrationsLinkedNodesListNodeLinks extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsLinkedNodesListNodeRelationships extends SpeakeasyBase {
  /**
...
export class RegistrationsLinkedNodesListNode extends SpeakeasyBase {
  /**
   * The properties of the node entity.
   */
  @SpeakeasyMetadata()
