...
class InvestmentsHoldingsGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\InvestmentHoldingsGetRequestOptions $options
     */
	#[\JMS\Serializer\Annotation\SerializedName('options')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\InvestmentHoldingsGetRequestOptions')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?InvestmentHoldingsGetRequestOptions $options = null;
