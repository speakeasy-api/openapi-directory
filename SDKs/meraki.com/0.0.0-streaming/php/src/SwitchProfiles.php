...
class SwitchProfiles 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetOrganizationConfigTemplateSwitchProfilesResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/organizations/{organizationId}/configTemplates/{configTemplateId}/switchProfiles', \OpenAPI\OpenAPI\Models\Operations\GetOrganizationConfigTemplateSwitchProfilesRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->getOrganizationConfigTemplateSwitchProfiles200ApplicationJSONObjects = $serializer->deserialize((string)$httpResponse->getBody(), 'array<array<string, mixed>>', 'json');
            }
        }
