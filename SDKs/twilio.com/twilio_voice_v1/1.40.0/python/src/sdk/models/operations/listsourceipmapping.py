...
class ListSourceIPMappingListSourceIPMappingResponse:
    ...
    meta: Optional[ListSourceIPMappingListSourceIPMappingResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    source_ip_mappings: Optional[list[shared_voice_v1_source_ip_mapping.VoiceV1SourceIPMapping]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('source_ip_mappings'), 'exclude': lambda f: f is None }})  
