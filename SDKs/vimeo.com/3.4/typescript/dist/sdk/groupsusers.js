...
var GroupsUsers = /** @class */ (function () {
    function GroupsUsers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    GroupsUsers.prototype.checkIfUserJoinedGroup = function (req, config) {
    ...
    **/
    GroupsUsers.prototype.checkIfUserJoinedGroupAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    GroupsUsers.prototype.getGroupMembers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    GroupsUsers.prototype.getUserGroups = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    GroupsUsers.prototype.getUserGroupsAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetUserGroupsAlt1Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/me/groups";
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
