 ...
 */
export enum PacketMirroringListWarningCodeEnum {
...
export class PacketMirroringListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class PacketMirroringListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: PacketMirroringListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class PacketMirroringList extends SpeakeasyBase {
  /**
