...
class SearchTypeSoundingGsdQueryParams:
...
@dataclasses.dataclass
class SearchTypeSoundingGsdRequest:
    query_params: SearchTypeSoundingGsdQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeSoundingGsdResponse:
