...
func (e DpsMessageDpsMessageMessageStatusEnum) ToPointer() *DpsMessageDpsMessageMessageStatusEnum {
	return &e
}
...
func (e *DpsMessageDpsMessageMessageStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "Ignored":
		fallthrough
	case "Information":
		*e = DpsMessageDpsMessageMessageStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DpsMessageDpsMessageMessageStatusEnum: %v", v)
	}
}
