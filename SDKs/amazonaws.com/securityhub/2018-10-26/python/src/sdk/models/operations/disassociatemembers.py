...
class DisassociateMembersRequestBody:
    ...
    r"""The account IDs of the member accounts to disassociate from the administrator account."""  
    

@dataclasses.dataclass
class DisassociateMembersRequest:
    
    request_body: DisassociateMembersRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
