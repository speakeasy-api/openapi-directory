...
export class JobsProjectsJobsSearchSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class JobsProjectsJobsSearchSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class JobsProjectsJobsSearchSecurity extends SpeakeasyBase {
...
export class JobsProjectsJobsSearchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class JobsProjectsJobsSearchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
