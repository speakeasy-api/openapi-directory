...
func (e *OsloginUsersSSHPublicKeysDeleteOperatingSystemTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "LINUX":
		fallthrough
	case "WINDOWS":
		*e = OsloginUsersSSHPublicKeysDeleteOperatingSystemTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for OsloginUsersSSHPublicKeysDeleteOperatingSystemTypeEnum: %s", s)
	}
}
