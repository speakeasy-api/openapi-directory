...
exports.GetCommentariesFromPayRunResponse = exports.GetCommentariesFromPayRunRequest = void 0;
...
var GetCommentariesFromPayRunRequest = /** @class */ (function (_super) {
    ...
    ], GetCommentariesFromPayRunRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetCommentariesFromPayRunRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetCommentariesFromPayRunRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayRunId",
        }),
        __metadata("design:type", String)
    ], GetCommentariesFromPayRunRequest.prototype, "payRunId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayScheduleId",
        }),
        __metadata("design:type", String)
    ], GetCommentariesFromPayRunRequest.prototype, "payScheduleId", void 0);
    return GetCommentariesFromPayRunRequest;
}(utils_1.SpeakeasyBase));
exports.GetCommentariesFromPayRunRequest = GetCommentariesFromPayRunRequest;
var GetCommentariesFromPayRunResponse = /** @class */ (function (_super) {
    ...
    ], GetCommentariesFromPayRunResponse.prototype, "rawResponse", void 0);
    return GetCommentariesFromPayRunResponse;
}(utils_1.SpeakeasyBase));
exports.GetCommentariesFromPayRunResponse = GetCommentariesFromPayRunResponse;
