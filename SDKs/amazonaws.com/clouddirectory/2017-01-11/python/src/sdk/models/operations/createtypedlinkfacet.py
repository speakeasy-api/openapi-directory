...
class CreateTypedLinkFacetRequestBodyFacet:
    ...
    identity_attribute_order: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('IdentityAttributeOrder') }})
...
class CreateTypedLinkFacetRequestBody:
    facet: CreateTypedLinkFacetRequestBodyFacet = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Facet') }})
    

@dataclasses.dataclass
class CreateTypedLinkFacetRequest:
    headers: CreateTypedLinkFacetHeaders = dataclasses.field()
    request: CreateTypedLinkFacetRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateTypedLinkFacetResponse:
    ...
    create_typed_link_facet_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
