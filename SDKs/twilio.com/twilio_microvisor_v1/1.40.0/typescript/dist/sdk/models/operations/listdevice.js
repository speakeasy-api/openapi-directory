...
exports.ListDeviceResponse = exports.ListDeviceListDeviceResponse = exports.ListDeviceListDeviceResponseMeta = exports.ListDeviceRequest = exports.ListDeviceSecurity = exports.ListDeviceServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListDeviceServerList = ["https://microvisor.twilio.com"];
var ListDeviceSecurity = /** @class */ (function (_super) {
    ...
    ], ListDeviceSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListDeviceSecurity.prototype, "username", void 0);
...
var ListDeviceRequest = /** @class */ (function (_super) {
    ...
    ], ListDeviceRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListDeviceRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListDeviceRequest.prototype, "pageToken", void 0);
...
var ListDeviceListDeviceResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.MicrovisorV1Device }),
        (0, class_transformer_1.Expose)({ name: "devices" }),
        (0, class_transformer_1.Type)(function () { return shared.MicrovisorV1Device; }),
        __metadata("design:type", Array)
    ], ListDeviceListDeviceResponse.prototype, "devices", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListDeviceListDeviceResponseMeta; }),
...
var ListDeviceResponse = /** @class */ (function (_super) {
    ...
    ], ListDeviceResponse.prototype, "rawResponse", void 0);
