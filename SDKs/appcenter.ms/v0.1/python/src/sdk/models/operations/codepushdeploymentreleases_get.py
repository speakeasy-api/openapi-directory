...
class CodePushDeploymentReleasesGetSecurity:
    
    api_token: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'X-API-Token' }})  
    

@dataclasses.dataclass
class CodePushDeploymentReleasesGetRequest:
...
@dataclasses.dataclass
class CodePushDeploymentReleasesGetDefaultApplicationJSON:
    r"""Error"""
...
class CodePushDeploymentReleasesGet200ApplicationJSONReleaseMethodEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CodePushDeploymentReleasesGet200ApplicationJSON:
    ...
    diff_package_map: Optional[dict[str, CodePushDeploymentReleasesGet200ApplicationJSONDiffPackageMap]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('diff_package_map'), 'exclude': lambda f: f is None }})  
    ...
    release_method: Optional[CodePushDeploymentReleasesGet200ApplicationJSONReleaseMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('release_method'), 'exclude': lambda f: f is None }})
    r"""The release method is unknown if unspecified"""  
...
class CodePushDeploymentReleasesGetResponse:
    ...
    code_push_deployment_releases_get_200_application_json_anies: Optional[list[CodePushDeploymentReleasesGet200ApplicationJSON]] = dataclasses.field(default=None)
    r"""Success"""  
    code_push_deployment_releases_get_default_application_json_object: Optional[CodePushDeploymentReleasesGetDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error"""  
