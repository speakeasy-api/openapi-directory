...
export class GkehubProjectsLocationsMembershipsGenerateExclusivityManifestSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkehubProjectsLocationsMembershipsGenerateExclusivityManifestRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=crdManifest",
  })
  crdManifest?: string;
...
export class GkehubProjectsLocationsMembershipsGenerateExclusivityManifestResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
