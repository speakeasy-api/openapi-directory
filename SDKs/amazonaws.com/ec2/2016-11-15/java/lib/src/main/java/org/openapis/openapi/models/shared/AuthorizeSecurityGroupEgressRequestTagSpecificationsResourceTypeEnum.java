 ...
 */
public enum AuthorizeSecurityGroupEgressRequestTagSpecificationsResourceTypeEnum {
    ...
    private AuthorizeSecurityGroupEgressRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
