...
class AppengineAppsDomainMappingsCreateQueryParams:
    ...
    override_strategy: Optional[AppengineAppsDomainMappingsCreateOverrideStrategyEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'overrideStrategy', 'style': 'form', 'explode': True }})
...
class AppengineAppsDomainMappingsCreateRequest:
    path_params: AppengineAppsDomainMappingsCreatePathParams = dataclasses.field()
    query_params: AppengineAppsDomainMappingsCreateQueryParams = dataclasses.field()
    security: AppengineAppsDomainMappingsCreateSecurity = dataclasses.field()
