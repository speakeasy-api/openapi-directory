...
export class GoogleCloudVisionV1p2beta1WebDetection extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    elemType: GoogleCloudVisionV1p2beta1WebDetectionWebLabel,
  })
   ...
   */
  @SpeakeasyMetadata({
    elemType: GoogleCloudVisionV1p2beta1WebDetectionWebPage,
  })
   ...
   */
  @SpeakeasyMetadata({
    elemType: GoogleCloudVisionV1p2beta1WebDetectionWebEntity,
  })
