...
class ListAssessmentRunsRequest:
    ...
    list_assessment_runs_request: shared_listassessmentrunsrequest.ListAssessmentRunsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
