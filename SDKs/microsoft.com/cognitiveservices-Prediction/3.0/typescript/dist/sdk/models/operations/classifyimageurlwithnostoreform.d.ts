...
export declare class ClassifyImageUrlWithNoStoreFormRequest extends SpeakeasyBase {
    /**
...
export declare class ClassifyImageUrlWithNoStoreFormResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    /**
     * Error response
