...
type CreateStatusForObject201ApplicationJSON struct {
	Data *shared.StatusUpdateResponse `json:"data,omitempty"`
}

type CreateStatusForObjectResponse struct {
	ContentType string
	...
	CreateStatusForObject201ApplicationJSONObject *CreateStatusForObject201ApplicationJSON
}
