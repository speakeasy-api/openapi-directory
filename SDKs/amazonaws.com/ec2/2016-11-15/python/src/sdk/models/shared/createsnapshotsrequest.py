...
import dataclasses
from ..shared import copytagsfromsource_enum as shared_copytagsfromsource_enum
from ..shared import instancespecification as shared_instancespecification
from enum import Enum
from typing import Optional

class CreateSnapshotsRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateSnapshotsRequestTagSpecifications:
    ...
    resource_type: Optional[CreateSnapshotsRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateSnapshotsRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateSnapshotsRequest:
    
    instance_specification: shared_instancespecification.InstanceSpecification = dataclasses.field()  
    copy_tags_from_source: Optional[shared_copytagsfromsource_enum.CopyTagsFromSourceEnum] = dataclasses.field(default=None)  
    description: Optional[str] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    outpost_arn: Optional[str] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateSnapshotsRequestTagSpecifications]] = dataclasses.field(default=None)  
