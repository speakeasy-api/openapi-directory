...
var ActivityLinks = /** @class */ (function (_super) {
    __extends(ActivityLinks, _super);
    ...
    ], ActivityLinks.prototype, "comments", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=project" }),
        __metadata("design:type", href_1.Href)
    ], ActivityLinks.prototype, "project", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=self" }),
        __metadata("design:type", href_1.Href)
    ], ActivityLinks.prototype, "self", void 0);
