...
class GetRemoveUserFromGroupQueryParams:
    action: GetRemoveUserFromGroupActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetRemoveUserFromGroupVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRemoveUserFromGroupRequest:
    headers: GetRemoveUserFromGroupHeaders = dataclasses.field()
    query_params: GetRemoveUserFromGroupQueryParams = dataclasses.field()
