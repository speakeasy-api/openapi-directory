...
class DescribeGeofenceCollectionResponsePricingPlanEnum(str, Enum):
...
class DescribeGeofenceCollectionResponse:
    ...
    pricing_plan: Optional[DescribeGeofenceCollectionResponsePricingPlanEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PricingPlan'), 'exclude': lambda f: f is None }})  
