...
class DeleteDataCellsFilterRequest:
    ...
    request_body: DeleteDataCellsFilterRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DeleteDataCellsFilterResponse:
    ...
    delete_data_cells_filter_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
