...
class ImageApi 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetTaggedImageCountResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'text/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getTaggedImageCount200TextJSONInt32Integer = $serializer->deserialize((string)$httpResponse->getBody(), 'int', 'json');
            }
        }
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetUntaggedImageCountResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'text/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getUntaggedImageCount200TextJSONInt32Integer = $serializer->deserialize((string)$httpResponse->getBody(), 'int', 'json');
            }
        }
