...
class DeleteAssignedTargetingOptionsRequest:
    r"""A request listing which assigned targeting options of a given targeting type should be deleted."""
    
    assigned_targeting_option_ids: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assignedTargetingOptionIds'), 'exclude': lambda f: f is None }})
    r"""Required. The assigned targeting option IDs to delete."""  
    targeting_type: Optional[DeleteAssignedTargetingOptionsRequestTargetingTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('targetingType'), 'exclude': lambda f: f is None }})
    r"""Required. Identifies the type of this assigned targeting option."""  
