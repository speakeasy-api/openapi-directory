...
public class PostPortfolioSimulationRebalancingDriftWeightRequestBody {
    ...
    public PostPortfolioSimulationRebalancingDriftWeightRequestBody(@JsonProperty("assets") PostPortfolioSimulationRebalancingDriftWeightRequestBodyAssets[] assets, @JsonProperty("portfolios") PostPortfolioSimulationRebalancingDriftWeightRequestBodyPortfolios[] portfolios) {
        this.assets = assets;
        this.portfolios = portfolios;
  }
}
