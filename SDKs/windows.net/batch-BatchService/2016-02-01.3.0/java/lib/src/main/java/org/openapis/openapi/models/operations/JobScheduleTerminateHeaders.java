...
public class JobScheduleTerminateHeaders {
    /**
    ...
    public JobScheduleTerminateHeaders withIfMatch(String ifMatch) {
    ...
    public JobScheduleTerminateHeaders withIfModifiedSince(String ifModifiedSince) {
    ...
    public JobScheduleTerminateHeaders withIfNoneMatch(String ifNoneMatch) {
    ...
    public JobScheduleTerminateHeaders withIfUnmodifiedSince(String ifUnmodifiedSince) {
    ...
    public JobScheduleTerminateHeaders withClientRequestId(String clientRequestId) {
    ...
    public JobScheduleTerminateHeaders withOcpDate(String ocpDate) {
    ...
    public JobScheduleTerminateHeaders withReturnClientRequestId(Boolean returnClientRequestId) {
