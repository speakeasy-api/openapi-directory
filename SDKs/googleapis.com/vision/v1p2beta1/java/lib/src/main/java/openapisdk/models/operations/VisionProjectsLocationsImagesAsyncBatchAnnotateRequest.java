...
public class VisionProjectsLocationsImagesAsyncBatchAnnotateRequest {
    ...
    public VisionProjectsLocationsImagesAsyncBatchAnnotateRequest withRequest(openapisdk.models.shared.GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest request) {
