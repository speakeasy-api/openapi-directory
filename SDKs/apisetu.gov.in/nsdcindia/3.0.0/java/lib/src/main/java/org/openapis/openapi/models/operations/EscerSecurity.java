...
public class EscerSecurity {
    ...
    public EscerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public EscerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public EscerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
