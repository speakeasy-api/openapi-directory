...
class General:
    ...
    def post_transfers(self, request: operations.PostTransfersRequest) -> operations.PostTransfersResponse:
        r"""Transfer funds.
        ...
        res = operations.PostTransfersResponse(status_code=r.status_code, content_type=content_type)
