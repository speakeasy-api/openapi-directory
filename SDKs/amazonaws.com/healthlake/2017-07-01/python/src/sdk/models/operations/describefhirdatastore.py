...
class DescribeFHIRDatastoreRequest:
    ...
    describe_fhir_datastore_request: shared_describefhirdatastorerequest.DescribeFHIRDatastoreRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
