...
class ProfileFilterLinks:
    ...
    items: Optional[list[shared_profilefilterlink.ProfileFilterLink]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
