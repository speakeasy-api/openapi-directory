...
public class WelshPafAddress {
    ...
    public WelshPafAddress withAdministrativeCounty(String administrativeCounty) {
    ...
    public WelshPafAddress withBuildingName(String buildingName) {
    ...
    public WelshPafAddress withBuildingNumber(String buildingNumber) {
        this.buildingNumber = buildingNumber;
        return this;
    }
    
    @JsonProperty("country")
    public WelshPafAddressCountryEnum country;
    public WelshPafAddress withCountry(WelshPafAddressCountryEnum country) {
        this.country = country;
        return this;
    }
    
    @JsonProperty("country_iso")
    public WelshPafAddressCountryIsoEnum countryIso;
    public WelshPafAddress withCountryIso(WelshPafAddressCountryIsoEnum countryIso) {
        this.countryIso = countryIso;
        return this;
    }
    
    @JsonProperty("country_iso_2")
    public WelshPafAddressCountryIso2Enum countryIso2;
    public WelshPafAddress withCountryIso2(WelshPafAddressCountryIso2Enum countryIso2) {
    ...
    public WelshPafAddress withCounty(String county) {
        this.county = county;
        return this;
    }
    ...
    public WelshPafAddress withCountyCode(String countyCode) {
        this.countyCode = countyCode;
        return this;
    }
    
    @JsonProperty("dataset")
    public WelshPafAddressDatasetEnum dataset;
    public WelshPafAddress withDataset(WelshPafAddressDatasetEnum dataset) {
    ...
    public WelshPafAddress withDeliveryPointSuffix(String deliveryPointSuffix) {
    ...
    public WelshPafAddress withDepartmentName(String departmentName) {
    ...
    public WelshPafAddress withDependantLocality(String dependantLocality) {
    ...
    public WelshPafAddress withDependantThoroughfare(String dependantThoroughfare) {
    ...
    public WelshPafAddress withDistrict(String district) {
    ...
    public WelshPafAddress withDoubleDependantLocality(String doubleDependantLocality) {
    ...
    public WelshPafAddress withEastings(Object eastings) {
    ...
    @JsonProperty("id")
    public String id;
    public WelshPafAddress withId(String id) {
        this.id = id;
        return this;
    }
    
    @JsonProperty("language")
    public WelshPafAddressLanguageEnum language;
    public WelshPafAddress withLanguage(WelshPafAddressLanguageEnum language) {
    ...
    public WelshPafAddress withLatitude(Object latitude) {
    ...
    @JsonProperty("line_1")
    public String line1;
    public WelshPafAddress withLine1(String line1) {
        this.line1 = line1;
        return this;
    }
    ...
    @JsonProperty("line_2")
    public String line2;
    public WelshPafAddress withLine2(String line2) {
        this.line2 = line2;
        return this;
    }
    ...
    @JsonProperty("line_3")
    public String line3;
    public WelshPafAddress withLine3(String line3) {
        this.line3 = line3;
        return this;
    }
    ...
    public WelshPafAddress withLongitude(Object longitude) {
    ...
    public WelshPafAddress withNorthings(Object northings) {
    ...
    public WelshPafAddress withOrganisationName(String organisationName) {
    ...
    @JsonProperty("po_box")
    public String poBox;
    public WelshPafAddress withPoBox(String poBox) {
        this.poBox = poBox;
        return this;
    }
    ...
    public WelshPafAddress withPostTown(String postTown) {
    ...
    public WelshPafAddress withPostalCounty(String postalCounty) {
    ...
    public WelshPafAddress withPostcode(String postcode) {
    ...
    public WelshPafAddress withPostcodeInward(String postcodeInward) {
    ...
    public WelshPafAddress withPostcodeOutward(String postcodeOutward) {
    ...
    public WelshPafAddress withPostcodeType(PafPostcodeTypeEnum postcodeType) {
    ...
    public WelshPafAddress withPremise(String premise) {
    ...
    public WelshPafAddress withSuOrganisationIndicator(String suOrganisationIndicator) {
    ...
    public WelshPafAddress withSubBuildingName(String subBuildingName) {
    ...
    public WelshPafAddress withThoroughfare(String thoroughfare) {
    ...
    public WelshPafAddress withTraditionalCounty(String traditionalCounty) {
    ...
    public WelshPafAddress withUdprn(Integer udprn) {
        this.udprn = udprn;
        return this;
    }
    ...
    @JsonProperty("umprn")
    public Object umprn;
    public WelshPafAddress withUmprn(Object umprn) {
        this.umprn = umprn;
        return this;
    }
    ...
    @JsonProperty("uprn")
    public String uprn;
    public WelshPafAddress withUprn(String uprn) {
        this.uprn = uprn;
        return this;
    }
    ...
    @JsonProperty("ward")
    public String ward;
    public WelshPafAddress withWard(String ward) {
        this.ward = ward;
        return this;
    }
