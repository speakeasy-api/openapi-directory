 ...
 */
export declare class UpdateOrganizationLoginSecurityRequestBodyApiAuthenticationIpRestrictionsForKeys extends SpeakeasyBase {
    /**
 ...
 */
export declare class UpdateOrganizationLoginSecurityRequestBodyApiAuthentication extends SpeakeasyBase {
    /**
     * Details for API-only IP restrictions.
     */
 ...
 * Details for API-only IP restrictions.
 */
export declare class UpdateOrganizationLoginSecurity200ApplicationJSONApiAuthenticationIpRestrictionsForKeys extends SpeakeasyBase {
    /**
     * Boolean indicating whether the organization will restrict API key (not Dashboard GUI) usage to a specific list of IP addresses or CIDR ranges.
     */
    enabled?: boolean;
 ...
 * Details for indicating whether organization will restrict access to API (but not Dashboard) to certain IP addresses.
 */
export declare class UpdateOrganizationLoginSecurity200ApplicationJSONApiAuthentication extends SpeakeasyBase {
    /**
     * Details for API-only IP restrictions.
     */
 ...
 */
export declare class UpdateOrganizationLoginSecurity200ApplicationJSON extends SpeakeasyBase {
    /**
     * Number of consecutive failed login attempts after which users' accounts will be locked.
     */
    accountLockoutAttempts?: number;
