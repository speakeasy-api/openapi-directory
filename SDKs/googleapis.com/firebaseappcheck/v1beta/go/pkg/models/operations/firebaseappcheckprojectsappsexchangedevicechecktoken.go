...
type FirebaseappcheckProjectsAppsExchangeDeviceCheckTokenRequest struct {
	...
	GoogleFirebaseAppcheckV1betaExchangeDeviceCheckTokenRequest *shared.GoogleFirebaseAppcheckV1betaExchangeDeviceCheckTokenRequest `request:"mediaType=application/json"`
	// OAuth access token.
