    ...
    public static void main(String[] args) {
        try {
            ...
            RvcerRequestBody req = new RvcerRequestBody(RvcerRequestBodyFormatEnum.XML, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new RvcerRequestBodyCertificateParameters("Sunil Kumar", "123412341234", "MA3EJKD1D00A06531", "DL01AA0101 As per your Vehicle Registration Certificate");;
