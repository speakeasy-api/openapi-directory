...
var GeocodingAPI = /** @class */ (function () {
    ...
    GeocodingAPI.prototype.getGeocode = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetGeocodeResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.geocodingResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GeocodingResponse);
                    }
                    break;
                default:
                    if (utils.matchContentType(contentType, "application/json")) {
