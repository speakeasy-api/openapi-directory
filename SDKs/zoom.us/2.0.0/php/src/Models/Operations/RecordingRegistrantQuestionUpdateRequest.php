...
class RecordingRegistrantQuestionUpdateRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\RecordingRegistrantQuestionUpdateRecordingRegistrantQuestions $requestBody
     */
	...
	{
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\RecordingRegistrantQuestionUpdateRecordingRegistrantQuestions();
		$this->meetingId = "";
	}
}
