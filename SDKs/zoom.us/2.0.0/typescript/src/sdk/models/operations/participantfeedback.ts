 ...
 */
export enum ParticipantFeedback200ApplicationXMLParticipantsQualityEnum {
  Good = "GOOD",
  NotGood = "NOT GOOD",
}

export class ParticipantFeedback200ApplicationXMLParticipants extends SpeakeasyBase {
  /**
 ...
 *
 */
export class ParticipantFeedback200ApplicationXML extends SpeakeasyBase {
  /**
   * The next page token is used to paginate through large result sets. A next page token will be returned whenever the set of available results exceeds the current page size. The expiration period for this token is 15 minutes.
   */
  @SpeakeasyMetadata()
...
export class ParticipantFeedback200ApplicationJSON extends SpeakeasyBase {
  ...
  @Type(() => ParticipantFeedback200ApplicationJSONParticipants)
