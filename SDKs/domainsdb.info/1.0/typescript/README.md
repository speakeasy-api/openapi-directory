...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/domainsdb.info/1.0/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/domainsdb.info/1.0/typescript
```
