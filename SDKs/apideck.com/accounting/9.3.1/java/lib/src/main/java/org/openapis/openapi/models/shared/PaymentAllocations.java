...
public class PaymentAllocations {
    ...
    public PaymentAllocations withAmount(Double amount) {
        this.amount = amount;
        return this;
    }
    ...
    public PaymentAllocations withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public PaymentAllocations withType(PaymentAllocationsAllocationTypeEnum type) {
        this.type = type;
        return this;
    }
