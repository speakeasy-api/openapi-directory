...
export class UpdateTrustStoreRequestBody extends SpeakeasyBase {
  /**
   * A list of CA certificates to add to the trust store.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "certificatesToAdd" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "certificatesToDelete" })
...
export class UpdateTrustStoreRequest extends SpeakeasyBase {
