...
public class AccountSettingsRequest {
    ...
    public AccountSettingsRequest withAccountId(String accountId) {
    ...
    public AccountSettingsRequest withCustomQueryFields(String customQueryFields) {
    ...
    public AccountSettingsRequest withOption(AccountSettingsOptionEnum option) {
        this.option = option;
        return this;
    }
