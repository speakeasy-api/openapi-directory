...
class GetScreenshotsTargetScreenshotTestIDTargetVersionIDTargetResultIDComparisonBaseResultIDSecurity:
...
class GetScreenshotsTargetScreenshotTestIDTargetVersionIDTargetResultIDComparisonBaseResultIDRequest:
    ...
    target_result_id: int = dataclasses.field(metadata={'path_param': { 'field_name': 'target_result_id', 'style': 'simple', 'explode': False }})
    r"""result id of the target Screenshot Test"""  
...
class GetScreenshotsTargetScreenshotTestIDTargetVersionIDTargetResultIDComparisonBaseResultIDResponse:
    ...
    single_comparison_test: Optional[shared_single_comparison_test.SingleComparisonTest] = dataclasses.field(default=None)
