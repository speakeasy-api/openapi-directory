...
class EnterpriseCrmEventbusProtoTaskExecutionDetailsTaskAttemptStats:
    ...
    r"""The end time of the task execution for current attempt."""  
    ...
    r"""The start time of the task execution for current attempt. This could be in the future if it's been scheduled."""  
