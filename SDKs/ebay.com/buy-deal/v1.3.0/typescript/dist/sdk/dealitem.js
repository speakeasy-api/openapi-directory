...
var DealItem = /** @class */ (function () {
     ...
     */
    DealItem.prototype.getDealItems = function (req, security, config) {
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.GetDealItemsSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetDealItemsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.dealItemSearchResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.DealItemSearchResponse);
                    }
                    break;
