...
public class FetchServiceConversationScopedWebhookRequest {
    ...
    public FetchServiceConversationScopedWebhookRequest(@JsonProperty("ChatServiceSid") String chatServiceSid, @JsonProperty("ConversationSid") String conversationSid, @JsonProperty("Sid") String sid) {
        this.chatServiceSid = chatServiceSid;
        this.conversationSid = conversationSid;
        this.sid = sid;
  }
