...
export class GetGoalRelationshipRequest extends SpeakeasyBase {
  /**
 ...
 */
export class GetGoalRelationship200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "data" })
...
export class GetGoalRelationshipResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
