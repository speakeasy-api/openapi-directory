...
export class PaymentMethodSnapshots {
  ...
  objectGETPaymentMethodSnapshot(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ObjectGETPaymentMethodSnapshotResponse =
        new operations.ObjectGETPaymentMethodSnapshotResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.proxyGetPaymentMethodSnapshot = utils.objectToClass(
              httpRes?.data,
              shared.ProxyGetPaymentMethodSnapshot
            );
          }
          break;
