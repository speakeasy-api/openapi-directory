...
import dataclasses
from ..shared import custom_generate_response as shared_custom_generate_response
...
class CustomGenerate:
    ...
    data: Optional[shared_custom_generate_response.CustomGenerateResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
