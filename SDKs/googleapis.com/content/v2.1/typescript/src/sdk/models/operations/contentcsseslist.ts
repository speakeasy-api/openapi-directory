...
export class ContentCssesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentCssesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentCssesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
