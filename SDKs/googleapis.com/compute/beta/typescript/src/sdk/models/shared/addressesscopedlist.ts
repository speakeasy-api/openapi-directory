 ...
 */
export enum AddressesScopedListWarningCodeEnum {
...
export class AddressesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class AddressesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: AddressesScopedListWarningData })
  @Expose({ name: "data" })
...
export class AddressesScopedList extends SpeakeasyBase {
  /**
