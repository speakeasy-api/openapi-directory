...
public class GetRelationalDatabaseSnapshotsRequest {
    ...
    public GetRelationalDatabaseSnapshotsRequest(@JsonProperty("GetRelationalDatabaseSnapshotsRequest") org.openapis.openapi.models.shared.GetRelationalDatabaseSnapshotsRequest getRelationalDatabaseSnapshotsRequest, @JsonProperty("X-Amz-Target") GetRelationalDatabaseSnapshotsXAmzTargetEnum xAmzTarget) {
        this.getRelationalDatabaseSnapshotsRequest = getRelationalDatabaseSnapshotsRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
