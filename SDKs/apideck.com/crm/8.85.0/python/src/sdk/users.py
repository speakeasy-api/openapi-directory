...
class Users:
    ...
    def users_add(self, request: operations.UsersAddRequest) -> operations.UsersAddResponse:
        r"""Create user
        Create user
        """
        ...
        res = operations.UsersAddResponse(status_code=r.status_code, content_type=content_type)
    ...
    def users_all(self, request: operations.UsersAllRequest) -> operations.UsersAllResponseOutput:
        r"""List users
        List users
        """
        ...
        res = operations.UsersAllResponseOutput(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetUsersResponseOutput])
    ...
    def users_delete(self, request: operations.UsersDeleteRequest) -> operations.UsersDeleteResponse:
        ...
        url = utils.generate_url(base_url, "/crm/users/{id}", request.path_params)
    ...
    def users_one(self, request: operations.UsersOneRequest) -> operations.UsersOneResponseOutput:
        r"""Get user
        Get user
        """
        ...
        res = operations.UsersOneResponseOutput(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetUserResponseOutput])
