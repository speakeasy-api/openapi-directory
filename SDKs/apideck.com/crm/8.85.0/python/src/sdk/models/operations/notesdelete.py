...
class NotesDeleteRequest:
    headers: NotesDeleteHeaders = dataclasses.field()
    path_params: NotesDeletePathParams = dataclasses.field()
    query_params: NotesDeleteQueryParams = dataclasses.field()
    security: NotesDeleteSecurity = dataclasses.field()
