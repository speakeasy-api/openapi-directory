...
type RunProjectsLocationsServicesGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RunProjectsLocationsServicesGetPathParams struct {
...
type RunProjectsLocationsServicesGetQueryParams struct {
	// V1 error format.
...
type RunProjectsLocationsServicesGetRequest struct {
...
type RunProjectsLocationsServicesGetResponse struct {
	ContentType string
	// Successful response
