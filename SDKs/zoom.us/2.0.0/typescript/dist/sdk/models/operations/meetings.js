...
exports.MeetingsResponse = exports.MeetingsRequest = exports.MeetingsGroupList = exports.MeetingsGroupListMeetings = exports.MeetingsSecurity = exports.MeetingsQueryParams = exports.MeetingsTypeEnum = exports.MeetingsPathParams = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var MeetingsPathParams = /** @class */ (function (_super) {
    __extends(MeetingsPathParams, _super);
    function MeetingsPathParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=userId" }),
        __metadata("design:type", String)
    ], MeetingsPathParams.prototype, "userId", void 0);
    return MeetingsPathParams;
}(utils_1.SpeakeasyBase));
exports.MeetingsPathParams = MeetingsPathParams;
...
var MeetingsQueryParams = /** @class */ (function (_super) {
    __extends(MeetingsQueryParams, _super);
    function MeetingsQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=next_page_token" }),
        __metadata("design:type", String)
    ], MeetingsQueryParams.prototype, "nextPageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page_number" }),
        __metadata("design:type", String)
    ], MeetingsQueryParams.prototype, "pageNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page_size" }),
        __metadata("design:type", Number)
    ], MeetingsQueryParams.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=type" }),
        __metadata("design:type", String)
    ], MeetingsQueryParams.prototype, "type", void 0);
    return MeetingsQueryParams;
}(utils_1.SpeakeasyBase));
exports.MeetingsQueryParams = MeetingsQueryParams;
...
var MeetingsGroupList = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=meetings", elemType: MeetingsGroupListMeetings }),
...
var MeetingsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", MeetingsPathParams)
    ], MeetingsRequest.prototype, "pathParams", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", MeetingsQueryParams)
    ], MeetingsRequest.prototype, "queryParams", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", MeetingsSecurity)
    ], MeetingsRequest.prototype, "security", void 0);
