...
class ListImagesRequestBody:
    ...
    owner: Optional[ListImagesRequestBodyOwnerEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('owner') }})
...
class ListImagesRequest:
    ...
    request: ListImagesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
