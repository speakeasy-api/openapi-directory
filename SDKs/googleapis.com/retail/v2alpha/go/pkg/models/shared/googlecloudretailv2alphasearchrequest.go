...
func (e *GoogleCloudRetailV2alphaSearchRequestRelevanceThresholdEnum) UnmarshalJSON(data []byte) error {
	...
	case "LOW":
		fallthrough
	case "LOWEST":
		*e = GoogleCloudRetailV2alphaSearchRequestRelevanceThresholdEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudRetailV2alphaSearchRequestRelevanceThresholdEnum: %s", s)
	}
}
...
func (e *GoogleCloudRetailV2alphaSearchRequestSearchModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "FACETED_SEARCH_ONLY":
		*e = GoogleCloudRetailV2alphaSearchRequestSearchModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudRetailV2alphaSearchRequestSearchModeEnum: %s", s)
	}
}
