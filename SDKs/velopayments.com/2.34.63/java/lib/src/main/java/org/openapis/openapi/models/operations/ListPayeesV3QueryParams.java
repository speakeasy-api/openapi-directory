...
public class ListPayeesV3QueryParams {
    ...
    public ListPayeesV3QueryParams withOnboardedStatus(String onboardedStatus) {
    ...
    public ListPayeesV3QueryParams withPayeeType(String payeeType) {
    ...
    public ListPayeesV3QueryParams withWatchlistStatus(String watchlistStatus) {
