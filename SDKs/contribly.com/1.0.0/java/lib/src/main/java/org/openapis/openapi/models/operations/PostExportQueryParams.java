...
public class PostExportQueryParams {
    /**
    ...
    public PostExportQueryParams withAssignment(String assignment) {
    ...
    public PostExportQueryParams withCombined(Boolean combined) {
    ...
    public PostExportQueryParams withCountry(String country) {
    ...
    public PostExportQueryParams withCreatedAfter(OffsetDateTime createdAfter) {
    ...
    public PostExportQueryParams withCreatedBefore(OffsetDateTime createdBefore) {
    ...
    public PostExportQueryParams withFormat(String format) {
        this.format = format;
        return this;
    }
    ...
    public PostExportQueryParams withGeohash(String geohash) {
    ...
    public PostExportQueryParams withHasLocation(Boolean hasLocation) {
    ...
    public PostExportQueryParams withIndividual(Boolean individual) {
    ...
    public Boolean json;
    public PostExportQueryParams withJson(Boolean json) {
        this.json = json;
        return this;
    }
    ...
    public PostExportQueryParams withLatLong(String latLong) {
    ...
    public PostExportQueryParams withMediaType(String mediaType) {
    ...
    public PostExportQueryParams withOwnedBy(String ownedBy) {
    ...
    public String q;
    public PostExportQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public PostExportQueryParams withRadius(Double radius) {
        this.radius = radius;
        return this;
    }
    ...
    public PostExportQueryParams withTagged(Boolean tagged) {
        this.tagged = tagged;
        return this;
    }
    ...
    public PostExportQueryParams withUrlWords(String urlWords) {
    ...
    public String user;
    public PostExportQueryParams withUser(String user) {
        this.user = user;
        return this;
    }
