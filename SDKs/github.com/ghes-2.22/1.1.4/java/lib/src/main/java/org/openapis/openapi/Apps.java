...
public class Apps {
    ...
    public org.openapis.openapi.models.operations.AppsCreateInstallationAccessTokenResponse appsCreateInstallationAccessToken(org.openapis.openapi.models.operations.AppsCreateInstallationAccessTokenRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 201) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.AppsCreateInstallationAccessToken415ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.AppsCreateInstallationAccessToken415ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.AppsGetBySlugResponse appsGetBySlug(org.openapis.openapi.models.operations.AppsGetBySlugRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.AppsGetBySlug415ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.AppsGetBySlug415ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.AppsGetInstallationResponse appsGetInstallation(org.openapis.openapi.models.operations.AppsGetInstallationRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.InstallationGhes2 out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.InstallationGhes2.class);
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.AppsGetInstallation415ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.AppsGetInstallation415ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.AppsListInstallationsForAuthenticatedUserResponse appsListInstallationsForAuthenticatedUser(org.openapis.openapi.models.operations.AppsListInstallationsForAuthenticatedUserRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.AppsListInstallationsForAuthenticatedUser415ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.AppsListInstallationsForAuthenticatedUser415ApplicationJSON.class);
