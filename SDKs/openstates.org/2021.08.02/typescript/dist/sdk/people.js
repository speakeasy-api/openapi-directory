...
var People = /** @class */ (function () {
    ...
    **/
    People.prototype.peopleGeoPeopleGeoGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PeopleGeoPeopleGeoGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/people.geo";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.personList = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    People.prototype.peopleSearchPeopleGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
