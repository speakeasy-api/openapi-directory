 ...
 */
public enum GoogleCloudRetailV2CatalogAttributeExactSearchableOptionEnum {
    ...
    private GoogleCloudRetailV2CatalogAttributeExactSearchableOptionEnum(String value) {
        this.value = value;
    }
}
