...
class CreateConnectionPolicyTargetRequest:
    ...
    request_body: Optional[CreateConnectionPolicyTargetCreateConnectionPolicyTargetRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
