...
**/
var FederatedUser = /** @class */ (function (_super) {
    __extends(FederatedUser, _super);
    ...
    ], FederatedUser.prototype, "accessKeyId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=accountId" }),
        __metadata("design:type", String)
    ], FederatedUser.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=arn" }),
        __metadata("design:type", String)
    ], FederatedUser.prototype, "arn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=principalId" }),
        __metadata("design:type", String)
    ], FederatedUser.prototype, "principalId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sessionContext" }),
        __metadata("design:type", sessioncontext_1.SessionContext)
    ], FederatedUser.prototype, "sessionContext", void 0);
