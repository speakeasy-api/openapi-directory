...
class ProtocolSnmptcpSetConfigRequest:
    path_params: ProtocolSnmptcpSetConfigPathParams = dataclasses.field()
...
class ProtocolSnmptcpSetConfigResponse:
    ...
    protocol_snmptcp_set_config_200_application_json_string: Optional[str] = dataclasses.field(default=None)
