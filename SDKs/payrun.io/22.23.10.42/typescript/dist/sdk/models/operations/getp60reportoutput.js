...
exports.GetP60ReportOutputResponse = exports.GetP60ReportOutputRequest = void 0;
...
var GetP60ReportOutputRequest = /** @class */ (function (_super) {
    ...
    ], GetP60ReportOutputRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetP60ReportOutputRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EmployeeCodes",
        }),
        __metadata("design:type", String)
    ], GetP60ReportOutputRequest.prototype, "employeeCodes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EmployerKey",
        }),
        __metadata("design:type", String)
    ], GetP60ReportOutputRequest.prototype, "employerKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=MaxIndex",
        }),
        __metadata("design:type", String)
    ], GetP60ReportOutputRequest.prototype, "maxIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartIndex",
        }),
        __metadata("design:type", String)
    ], GetP60ReportOutputRequest.prototype, "startIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaxYear",
        }),
        __metadata("design:type", String)
    ], GetP60ReportOutputRequest.prototype, "taxYear", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TransformDefinitionKey",
        }),
        __metadata("design:type", String)
    ], GetP60ReportOutputRequest.prototype, "transformDefinitionKey", void 0);
...
var GetP60ReportOutputResponse = /** @class */ (function (_super) {
    ...
    ], GetP60ReportOutputResponse.prototype, "rawResponse", void 0);
