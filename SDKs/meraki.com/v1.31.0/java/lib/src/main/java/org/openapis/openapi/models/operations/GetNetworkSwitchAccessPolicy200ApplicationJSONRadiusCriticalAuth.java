 ...
 */
public class GetNetworkSwitchAccessPolicy200ApplicationJSONRadiusCriticalAuth {
    /**
    ...
    public GetNetworkSwitchAccessPolicy200ApplicationJSONRadiusCriticalAuth withDataVlanId(Long dataVlanId) {
    ...
    public GetNetworkSwitchAccessPolicy200ApplicationJSONRadiusCriticalAuth withSuspendPortBounce(Boolean suspendPortBounce) {
    ...
    public GetNetworkSwitchAccessPolicy200ApplicationJSONRadiusCriticalAuth withVoiceVlanId(Long voiceVlanId) {
