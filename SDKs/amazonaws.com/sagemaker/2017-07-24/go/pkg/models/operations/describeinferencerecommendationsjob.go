...
type DescribeInferenceRecommendationsJobHeaders struct {
...
type DescribeInferenceRecommendationsJobRequest struct {
	Headers DescribeInferenceRecommendationsJobHeaders
	Request shared.DescribeInferenceRecommendationsJobRequest `request:"mediaType=application/json"`
}
