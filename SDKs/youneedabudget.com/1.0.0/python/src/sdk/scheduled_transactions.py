...
class ScheduledTransactions:
    ...
    def get_scheduled_transaction_by_id(self, request: operations.GetScheduledTransactionByIDRequest) -> operations.GetScheduledTransactionByIDResponse:
        ...
        res = operations.GetScheduledTransactionByIDResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ScheduledTransactionResponse])
    ...
    def get_scheduled_transactions(self, request: operations.GetScheduledTransactionsRequest) -> operations.GetScheduledTransactionsResponse:
        ...
        res = operations.GetScheduledTransactionsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ScheduledTransactionsResponse])
