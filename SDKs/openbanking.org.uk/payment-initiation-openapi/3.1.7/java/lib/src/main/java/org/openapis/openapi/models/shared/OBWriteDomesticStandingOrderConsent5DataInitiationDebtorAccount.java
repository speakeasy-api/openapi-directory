...
public class OBWriteDomesticStandingOrderConsent5DataInitiationDebtorAccount {
    ...
    public OBWriteDomesticStandingOrderConsent5DataInitiationDebtorAccount(@JsonProperty("Identification") String identification, @JsonProperty("SchemeName") String schemeName) {
        this.identification = identification;
        this.schemeName = schemeName;
  }
}
