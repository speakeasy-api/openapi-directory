...
export class GetPhenotypeGenotypeAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetPhenotypeGenotypeAssociationsQueryParams extends SpeakeasyBase {
...
export class GetPhenotypeGenotypeAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetPhenotypeGenotypeAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
