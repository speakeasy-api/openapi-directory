...
public class Disk {
    ...
    public Disk withEnableConfidentialCompute(Boolean enableConfidentialCompute) {
    ...
    public Disk withSelfLinkWithId(String selfLinkWithId) {
    ...
    public Disk withSourceInstantSnapshot(String sourceInstantSnapshot) {
    ...
    public Disk withSourceInstantSnapshotId(String sourceInstantSnapshotId) {
    ...
    public Disk withStoragePool(String storagePool) {
