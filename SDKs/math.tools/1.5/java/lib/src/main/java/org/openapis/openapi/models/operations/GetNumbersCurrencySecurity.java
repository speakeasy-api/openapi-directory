...
public class GetNumbersCurrencySecurity {
    ...
    public GetNumbersCurrencySecurity withXMathtoolsApiSecret(String xMathtoolsApiSecret) {
        this.xMathtoolsApiSecret = xMathtoolsApiSecret;
        return this;
    }
    
    public GetNumbersCurrencySecurity(@JsonProperty("X-Mathtools-Api-Secret") String xMathtoolsApiSecret) {
        this.xMathtoolsApiSecret = xMathtoolsApiSecret;
  }
}
