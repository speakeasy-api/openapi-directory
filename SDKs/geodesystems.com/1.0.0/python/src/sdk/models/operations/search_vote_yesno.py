...
class SearchVoteYesnoQueryParams:
    ...
    search_db_vote_yesno_vote: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_vote_yesno.vote', 'style': 'form', 'explode': True }})
...
class SearchVoteYesnoRequest:
    query_params: SearchVoteYesnoQueryParams = dataclasses.field()
