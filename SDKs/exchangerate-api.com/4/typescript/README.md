...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/exchangerate-api.com/4/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/exchangerate-api.com/4/typescript
```
