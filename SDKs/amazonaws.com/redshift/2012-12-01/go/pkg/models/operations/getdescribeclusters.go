...
func (e *GETDescribeClustersActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DescribeClusters":
		*e = GETDescribeClustersActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeClustersActionEnum: %s", s)
	}
}
...
func (e *GETDescribeClustersVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2012-12-01":
		*e = GETDescribeClustersVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeClustersVersionEnum: %s", s)
	}
}
