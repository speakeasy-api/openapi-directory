...
class LocationsGetV2LocationsGetRequest
{
     ...
     * Order by a field
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\LocationsGetV2LocationsGetOrderByLocationsOrderEnum $orderBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=order_by')]
    public ?LocationsGetV2LocationsGetOrderByLocationsOrderEnum $orderBy = null;
     ...
     * Sort Direction
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\LocationsGetV2LocationsGetSortSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?LocationsGetV2LocationsGetSortSortEnum $sort = null;
