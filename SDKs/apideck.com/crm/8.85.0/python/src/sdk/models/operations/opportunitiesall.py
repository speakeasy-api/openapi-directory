...
from ..shared import opportunitiesfilter as shared_opportunitiesfilter
from ..shared import opportunitiessort as shared_opportunitiessort
from ..shared import security as shared_security
from ..shared import badrequestresponse as shared_badrequestresponse
from ..shared import getopportunitiesresponse as shared_getopportunitiesresponse
...
class OpportunitiesAllQueryParams:
    ...
    filter: Optional[shared_opportunitiesfilter.OpportunitiesFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    ...
    sort: Optional[shared_opportunitiessort.OpportunitiesSort] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'deepObject', 'explode': True }})
...
class OpportunitiesAllRequest:
    headers: OpportunitiesAllHeaders = dataclasses.field()
    query_params: OpportunitiesAllQueryParams = dataclasses.field()
    security: OpportunitiesAllSecurity = dataclasses.field()
...
class OpportunitiesAllResponse:
    ...
    get_opportunities_response: Optional[shared_getopportunitiesresponse.GetOpportunitiesResponse] = dataclasses.field(default=None)
