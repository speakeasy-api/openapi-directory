...
exports.GetMergeOptionsInput = void 0;
...
var GetMergeOptionsInput = /** @class */ (function (_super) {
    __extends(GetMergeOptionsInput, _super);
    ...
    ], GetMergeOptionsInput.prototype, "conflictDetailLevel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=conflictResolutionStrategy" }),
        __metadata("design:type", String)
    ], GetMergeOptionsInput.prototype, "conflictResolutionStrategy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=destinationCommitSpecifier" }),
        __metadata("design:type", String)
    ], GetMergeOptionsInput.prototype, "destinationCommitSpecifier", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=repositoryName" }),
        __metadata("design:type", String)
    ], GetMergeOptionsInput.prototype, "repositoryName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sourceCommitSpecifier" }),
        __metadata("design:type", String)
    ], GetMergeOptionsInput.prototype, "sourceCommitSpecifier", void 0);
    return GetMergeOptionsInput;
