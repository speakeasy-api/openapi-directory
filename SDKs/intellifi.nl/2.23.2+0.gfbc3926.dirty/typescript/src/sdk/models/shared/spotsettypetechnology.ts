 ...
 */
export enum SpotSetTypeTechnologyTypeEnum {
  Technology = "technology",
}

export class SpotSetTypeTechnologyInput extends SpeakeasyBase {
  /**
   * Type of technology that was used to detect this item.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "item_technology" })
...
export class SpotSetTypeTechnology extends SpeakeasyBase {
  /**
