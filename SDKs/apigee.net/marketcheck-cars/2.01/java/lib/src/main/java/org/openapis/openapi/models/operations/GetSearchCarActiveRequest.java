...
public class GetSearchCarActiveRequest {
    ...
    public GetSearchCarActiveRequest withActiveInventoryDateRange(String activeInventoryDateRange) {
    ...
    public GetSearchCarActiveRequest withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withAppendApiKey(Boolean appendApiKey) {
    ...
    public GetSearchCarActiveRequest withBaseExteriorColor(String baseExteriorColor) {
    ...
    public GetSearchCarActiveRequest withBaseInteriorColor(String baseInteriorColor) {
    ...
    public GetSearchCarActiveRequest withBodySubtype(String bodySubtype) {
    ...
    public GetSearchCarActiveRequest withBodyType(String bodyType) {
    ...
    public GetSearchCarActiveRequest withCarType(org.openapis.openapi.models.shared.CarCarTypeEnum carType) {
    ...
    public GetSearchCarActiveRequest withCarfax1Owner(org.openapis.openapi.models.shared.Carfax1OwnerEnum carfax1Owner) {
    ...
    public GetSearchCarActiveRequest withCarfaxCleanTitle(org.openapis.openapi.models.shared.CarfaxCleanTitleEnum carfaxCleanTitle) {
    ...
    public String city;
    public GetSearchCarActiveRequest withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withCityMpgRange(String cityMpgRange) {
    ...
    public GetSearchCarActiveRequest withCountry(org.openapis.openapi.models.shared.CarCountryEnum country) {
    ...
    public GetSearchCarActiveRequest withCylinders(String cylinders) {
    ...
    public GetSearchCarActiveRequest withDealerId(String dealerId) {
    ...
    public GetSearchCarActiveRequest withDealerType(org.openapis.openapi.models.shared.DealerTypeEnum dealerType) {
    ...
    public GetSearchCarActiveRequest withDedup(Boolean dedup) {
        this.dedup = dedup;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withDom180Range(String dom180Range) {
    ...
    public GetSearchCarActiveRequest withDomActiveRange(String domActiveRange) {
    ...
    public GetSearchCarActiveRequest withDomRange(String domRange) {
    ...
    public String doors;
    public GetSearchCarActiveRequest withDoors(String doors) {
        this.doors = doors;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withDrivetrain(String drivetrain) {
    ...
    public GetSearchCarActiveRequest withEngine(String engine) {
        this.engine = engine;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withEngineAspiration(String engineAspiration) {
    ...
    public GetSearchCarActiveRequest withEngineBlock(String engineBlock) {
    ...
    public GetSearchCarActiveRequest withEngineSize(String engineSize) {
    ...
    public GetSearchCarActiveRequest withEngineSizeRange(String engineSizeRange) {
    ...
    public GetSearchCarActiveRequest withExcludeCertified(Boolean excludeCertified) {
    ...
    public GetSearchCarActiveRequest withExcludeDealerIds(String excludeDealerIds) {
    ...
    public GetSearchCarActiveRequest withExcludeSources(String excludeSources) {
    ...
    public GetSearchCarActiveRequest withExteriorColor(String exteriorColor) {
    ...
    public GetSearchCarActiveRequest withFacetSort(org.openapis.openapi.models.shared.FacetSortEnum facetSort) {
    ...
    public GetSearchCarActiveRequest withFacets(String facets) {
        this.facets = facets;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withFinanceDownPayment(String financeDownPayment) {
    ...
    public GetSearchCarActiveRequest withFinanceDownPaymentPer(String financeDownPaymentPer) {
    ...
    public GetSearchCarActiveRequest withFinanceEmp(String financeEmp) {
    ...
    public GetSearchCarActiveRequest withFinanceLoanApr(String financeLoanApr) {
    ...
    public GetSearchCarActiveRequest withFinanceLoanTerm(String financeLoanTerm) {
    ...
    public GetSearchCarActiveRequest withFirstSeenAtMcDays(String firstSeenAtMcDays) {
    ...
    public GetSearchCarActiveRequest withFirstSeenAtMcRange(String firstSeenAtMcRange) {
    ...
    public GetSearchCarActiveRequest withFirstSeenAtSourceDays(String firstSeenAtSourceDays) {
    ...
    public GetSearchCarActiveRequest withFirstSeenAtSourceRange(String firstSeenAtSourceRange) {
    ...
    public GetSearchCarActiveRequest withFirstSeenDays(String firstSeenDays) {
    ...
    public GetSearchCarActiveRequest withFirstSeenRange(String firstSeenRange) {
    ...
    public GetSearchCarActiveRequest withFuelType(String fuelType) {
    ...
    public GetSearchCarActiveRequest withHighValueFeatures(String highValueFeatures) {
    ...
    public GetSearchCarActiveRequest withHighwayMpgRange(String highwayMpgRange) {
    ...
    public GetSearchCarActiveRequest withInTransit(org.openapis.openapi.models.shared.InTransitEnum inTransit) {
    ...
    public GetSearchCarActiveRequest withIncludeFinance(Boolean includeFinance) {
    ...
    public GetSearchCarActiveRequest withIncludeLease(Boolean includeLease) {
    ...
    public GetSearchCarActiveRequest withIncludeNonVinListings(Boolean includeNonVinListings) {
    ...
    public GetSearchCarActiveRequest withIncludeRelevantLinks(Boolean includeRelevantLinks) {
    ...
    public GetSearchCarActiveRequest withInteriorColor(String interiorColor) {
    ...
    public GetSearchCarActiveRequest withInventoryCountRange(String inventoryCountRange) {
    ...
    public GetSearchCarActiveRequest withLastSeenDays(String lastSeenDays) {
    ...
    public GetSearchCarActiveRequest withLastSeenRange(String lastSeenRange) {
    ...
    public GetSearchCarActiveRequest withLatitude(Double latitude) {
    ...
    public GetSearchCarActiveRequest withLeaseDownPayment(String leaseDownPayment) {
    ...
    public GetSearchCarActiveRequest withLeaseEmp(String leaseEmp) {
    ...
    public GetSearchCarActiveRequest withLeaseTerm(String leaseTerm) {
    ...
    public GetSearchCarActiveRequest withLongitude(Double longitude) {
    ...
    public String make;
    public GetSearchCarActiveRequest withMake(String make) {
        this.make = make;
        return this;
    }
    ...
    public String match;
    public GetSearchCarActiveRequest withMatch(String match) {
        this.match = match;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withMilesRange(String milesRange) {
    ...
    public GetSearchCarActiveRequest withMinPhotoLinks(String minPhotoLinks) {
    ...
    public GetSearchCarActiveRequest withMinPhotoLinksCached(String minPhotoLinksCached) {
    ...
    public String mm;
    public GetSearchCarActiveRequest withMm(String mm) {
        this.mm = mm;
        return this;
    }
    ...
    public String model;
    public GetSearchCarActiveRequest withModel(String model) {
        this.model = model;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withMsaCode(String msaCode) {
    ...
    public GetSearchCarActiveRequest withMsrpRange(String msrpRange) {
    ...
    public GetSearchCarActiveRequest withNodedup(Boolean nodedup) {
    ...
    public GetSearchCarActiveRequest withOwned(Boolean owned) {
        this.owned = owned;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withPhotoLinks(Boolean photoLinks) {
    ...
    public GetSearchCarActiveRequest withPhotoLinksCached(Boolean photoLinksCached) {
    ...
    public Boolean plot;
    public GetSearchCarActiveRequest withPlot(Boolean plot) {
        this.plot = plot;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withPowertrainType(String powertrainType) {
    ...
    public GetSearchCarActiveRequest withPriceChange(org.openapis.openapi.models.shared.PriceChangeEnum priceChange) {
    ...
    public GetSearchCarActiveRequest withPriceChangeRange(String priceChangeRange) {
    ...
    public GetSearchCarActiveRequest withPriceRange(String priceRange) {
    ...
    public GetSearchCarActiveRequest withRadius(Integer radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withRangeFacets(String rangeFacets) {
    ...
    public Integer rows;
    public GetSearchCarActiveRequest withRows(Integer rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withSeatingCapacity(String seatingCapacity) {
    ...
    public GetSearchCarActiveRequest withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withSortOrder(org.openapis.openapi.models.shared.SortOrderEnum sortOrder) {
    ...
    public GetSearchCarActiveRequest withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withStart(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public String state;
    public GetSearchCarActiveRequest withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public String stats;
    public GetSearchCarActiveRequest withStats(String stats) {
        this.stats = stats;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withStockNo(String stockNo) {
    ...
    public GetSearchCarActiveRequest withTaxonomyVins(String taxonomyVins) {
    ...
    public GetSearchCarActiveRequest withTransmission(String transmission) {
    ...
    public String trim;
    public GetSearchCarActiveRequest withTrim(String trim) {
        this.trim = trim;
        return this;
    }
    ...
    public String trimO;
    public GetSearchCarActiveRequest withTrimO(String trimO) {
        this.trimO = trimO;
        return this;
    }
    ...
    public String trimR;
    public GetSearchCarActiveRequest withTrimR(String trimR) {
        this.trimR = trimR;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withVehicleType(String vehicleType) {
    ...
    public String vin;
    public GetSearchCarActiveRequest withVin(String vin) {
        this.vin = vin;
        return this;
    }
    ...
    public String vins;
    public GetSearchCarActiveRequest withVins(String vins) {
        this.vins = vins;
        return this;
    }
    ...
    public String year;
    public GetSearchCarActiveRequest withYear(String year) {
        this.year = year;
        return this;
    }
    ...
    public GetSearchCarActiveRequest withYearRange(String yearRange) {
    ...
    public String ymm;
    public GetSearchCarActiveRequest withYmm(String ymm) {
        this.ymm = ymm;
        return this;
    }
    ...
    public String ymmt;
    public GetSearchCarActiveRequest withYmmt(String ymmt) {
        this.ymmt = ymmt;
        return this;
    }
    ...
    public String zip;
    public GetSearchCarActiveRequest withZip(String zip) {
        this.zip = zip;
        return this;
    }
