...
class RecurringTieredPricingUpdatePriceChangeOptionEnum(str, Enum):
    NO_CHANGE = "NoChange"
...
class RecurringTieredPricingUpdate:
    price_change_option: Optional[RecurringTieredPricingUpdatePriceChangeOptionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('priceChangeOption') }})
