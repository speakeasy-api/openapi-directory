...
from ..shared import listuserprofilesresponse as shared_listuserprofilesresponse
...
class ListUserProfilesResponse:
    ...
    list_user_profiles_response: Optional[shared_listuserprofilesresponse.ListUserProfilesResponse] = dataclasses.field(default=None)
    r"""Success"""  
