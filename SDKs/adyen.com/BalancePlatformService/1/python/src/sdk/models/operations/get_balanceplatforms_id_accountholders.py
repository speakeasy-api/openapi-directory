...
from ..shared import paginatedaccountholdersresponse as shared_paginatedaccountholdersresponse
...
class GetBalancePlatformsIDAccountHoldersResponse:
    ...
    paginated_account_holders_response: Optional[shared_paginatedaccountholdersresponse.PaginatedAccountHoldersResponse] = dataclasses.field(default=None)
