...
import dataclasses
from ..shared import googleclouddialogflowv2beta1agentassistantfeedbacksummarizationfeedback as shared_googleclouddialogflowv2beta1agentassistantfeedbacksummarizationfeedback
...
class GoogleCloudDialogflowV2beta1AgentAssistantFeedback:
    ...
    answer_relevance: Optional[GoogleCloudDialogflowV2beta1AgentAssistantFeedbackAnswerRelevanceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('answerRelevance'), 'exclude': lambda f: f is None }})
    r"""Optional. Whether or not the suggested answer is relevant. For example: * Query: \\"Can I change my mailing address?\\" * Suggested document says: \\"Items must be returned/exchanged within 60 days of the purchase date.\\" * answer_relevance: AnswerRelevance.IRRELEVANT"""  
    document_correctness: Optional[GoogleCloudDialogflowV2beta1AgentAssistantFeedbackDocumentCorrectnessEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('documentCorrectness'), 'exclude': lambda f: f is None }})
    r"""Optional. Whether or not the information in the document is correct. For example: * Query: \\"Can I return the package in 2 days once received?\\" * Suggested document says: \\"Items must be returned/exchanged within 60 days of the purchase date.\\" * Ground truth: \\"No return or exchange is allowed.\\" * [document_correctness]: INCORRECT"""  
    document_efficiency: Optional[GoogleCloudDialogflowV2beta1AgentAssistantFeedbackDocumentEfficiencyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('documentEfficiency'), 'exclude': lambda f: f is None }})
    r"""Optional. Whether or not the suggested document is efficient. For example, if the document is poorly written, hard to understand, hard to use or too long to find useful information, document_efficiency is DocumentEfficiency.INEFFICIENT."""  
    summarization_feedback: Optional[shared_googleclouddialogflowv2beta1agentassistantfeedbacksummarizationfeedback.GoogleCloudDialogflowV2beta1AgentAssistantFeedbackSummarizationFeedback] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('summarizationFeedback'), 'exclude': lambda f: f is None }})
