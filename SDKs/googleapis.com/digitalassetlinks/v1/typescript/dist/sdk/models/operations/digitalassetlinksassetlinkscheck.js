...
exports.DigitalassetlinksAssetlinksCheckResponse = exports.DigitalassetlinksAssetlinksCheckRequest = exports.DigitalassetlinksAssetlinksCheckQueryParams = void 0;
...
var DigitalassetlinksAssetlinksCheckQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=source.androidApp.certificate.sha256Fingerprint" }),
        __metadata("design:type", String)
    ], DigitalassetlinksAssetlinksCheckQueryParams.prototype, "sourceAndroidAppCertificateSha256Fingerprint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=source.androidApp.packageName" }),
        __metadata("design:type", String)
    ], DigitalassetlinksAssetlinksCheckQueryParams.prototype, "sourceAndroidAppPackageName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=source.web.site" }),
        __metadata("design:type", String)
    ], DigitalassetlinksAssetlinksCheckQueryParams.prototype, "sourceWebSite", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=target.androidApp.certificate.sha256Fingerprint" }),
        __metadata("design:type", String)
    ], DigitalassetlinksAssetlinksCheckQueryParams.prototype, "targetAndroidAppCertificateSha256Fingerprint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=target.androidApp.packageName" }),
        __metadata("design:type", String)
    ], DigitalassetlinksAssetlinksCheckQueryParams.prototype, "targetAndroidAppPackageName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=target.web.site" }),
        __metadata("design:type", String)
...
exports.DigitalassetlinksAssetlinksCheckQueryParams = DigitalassetlinksAssetlinksCheckQueryParams;
...
exports.DigitalassetlinksAssetlinksCheckRequest = DigitalassetlinksAssetlinksCheckRequest;
...
exports.DigitalassetlinksAssetlinksCheckResponse = DigitalassetlinksAssetlinksCheckResponse;
