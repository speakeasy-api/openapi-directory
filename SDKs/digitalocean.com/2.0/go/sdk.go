...
func New(opts ...SDKOption) *SDK {
	...
	sdk.OneClickApplications = NewOneClickApplications(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.BlockStorage = NewBlockStorage(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.BlockStorageActions = NewBlockStorageActions(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.CDNEndpoints = NewCdnEndpoints(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.ContainerRegistry = NewContainerRegistry(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.DomainRecords = NewDomainRecords(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.DropletActions = NewDropletActions(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.ProjectResources = NewProjectResources(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
