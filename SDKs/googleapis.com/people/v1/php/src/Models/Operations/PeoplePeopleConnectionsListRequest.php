...
class PeoplePeopleConnectionsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PeoplePeopleConnectionsListSortOrderEnum $sortOrder
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortOrder')]
    public ?PeoplePeopleConnectionsListSortOrderEnum $sortOrder = null;
    
    /**
     * Optional. A mask of what source types to return. Defaults to READ_SOURCE_TYPE_CONTACT and READ_SOURCE_TYPE_PROFILE if not set.
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\PeoplePeopleConnectionsListSourcesEnum> $sources
     */
	...
	public function __construct()
	{
		...
		$this->quotaUser = null;
		$this->requestMaskIncludeField = null;
