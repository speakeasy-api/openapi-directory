...
// groups - Registry artifacts can be collected together using groups. This section includes all of the primary operations related to groups.
type groups struct {
...
func (s *groups) ListGroups(ctx context.Context, request operations.ListGroupsRequest) (*operations.ListGroupsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GroupSearchResults
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
