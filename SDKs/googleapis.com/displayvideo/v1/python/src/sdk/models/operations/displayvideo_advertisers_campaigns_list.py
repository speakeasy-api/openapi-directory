...
class DisplayvideoAdvertisersCampaignsListRequest:
    path_params: DisplayvideoAdvertisersCampaignsListPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersCampaignsListQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersCampaignsListSecurity = dataclasses.field()
