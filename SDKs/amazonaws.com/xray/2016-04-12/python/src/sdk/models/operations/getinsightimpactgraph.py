...
class GetInsightImpactGraphRequest:
    headers: GetInsightImpactGraphHeaders = dataclasses.field()
    request: GetInsightImpactGraphRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
