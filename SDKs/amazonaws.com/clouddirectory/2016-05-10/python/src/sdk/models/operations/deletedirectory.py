...
from ..shared import directorynotdisabledexception as shared_directorynotdisabledexception
...
class DeleteDirectoryResponse:
    ...
    directory_not_disabled_exception: Optional[shared_directorynotdisabledexception.DirectoryNotDisabledException] = dataclasses.field(default=None)
