...
import dataclasses
from ..shared import freelistingsprogramstatusreviewineligibilityreasondetails as shared_freelistingsprogramstatusreviewineligibilityreasondetails
...
class FreeListingsProgramStatusRegionStatusEligibilityStatusEnum(str, Enum):
    r"""Eligibility status of the standard free listing program."""
...
class FreeListingsProgramStatusRegionStatus:
    ...
    eligibility_status: Optional[FreeListingsProgramStatusRegionStatusEligibilityStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('eligibilityStatus'), 'exclude': lambda f: f is None }})
    r"""Eligibility status of the standard free listing program."""  
    ...
    review_eligibility_status: Optional[FreeListingsProgramStatusRegionStatusReviewEligibilityStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reviewEligibilityStatus'), 'exclude': lambda f: f is None }})
    r"""If a program is eligible for review in a specific region. Only visible if `eligibilityStatus` is `DISAPPROVED`."""  
    review_ineligibility_reason: Optional[FreeListingsProgramStatusRegionStatusReviewIneligibilityReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reviewIneligibilityReason'), 'exclude': lambda f: f is None }})
    r"""Review ineligibility reason if account is not eligible for review."""  
    ...
    review_ineligibility_reason_details: Optional[shared_freelistingsprogramstatusreviewineligibilityreasondetails.FreeListingsProgramStatusReviewIneligibilityReasonDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reviewIneligibilityReasonDetails'), 'exclude': lambda f: f is None }})
