...
var Keys = /** @class */ (function () {
     ...
     *
    **/
    Keys.prototype.checkKeyUsability = function (req, config) {
     ...
     *
    **/
    Keys.prototype.downloadUsageHistory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Keys.prototype.monitorKeyUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
