...
type CreatePermissionRequest struct {
	RequestBody       CreatePermissionRequestBody `request:"mediaType=application/json"`
...
type CreatePermissionResponse struct {
	ContentType string
	// Success
	CreatePermissionResponse *shared.CreatePermissionResponse
	...
	PermissionLimitExceededException interface{}
