...
public class GetListingRequest {
    ...
    public GetListingRequest withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public GetListingRequest withAppendApiKey(Boolean appendApiKey) {
    ...
    public String id;
    public GetListingRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetListingRequest withIncludeRelevantLinks(Boolean includeRelevantLinks) {
