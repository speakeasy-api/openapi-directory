...
public class Stats {
    ...
    public org.openapis.openapi.models.operations.GetAdvancedTeamGameStatsResponse getAdvancedTeamGameStats(org.openapis.openapi.models.operations.GetAdvancedTeamGameStatsRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetAdvancedTeamGameStatsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.GetAdvancedTeamSeasonStatsResponse getAdvancedTeamSeasonStats(org.openapis.openapi.models.operations.GetAdvancedTeamSeasonStatsRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetAdvancedTeamSeasonStatsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
    ...
    public org.openapis.openapi.models.operations.GetTeamSeasonStatsResponse getTeamSeasonStats(org.openapis.openapi.models.operations.GetTeamSeasonStatsRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetTeamSeasonStatsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
