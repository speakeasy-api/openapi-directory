...
public class DescribeBotRecommendationRequest {
    ...
    public DescribeBotRecommendationRequest(@JsonProperty("botId") String botId, @JsonProperty("botRecommendationId") String botRecommendationId, @JsonProperty("botVersion") String botVersion, @JsonProperty("localeId") String localeId) {
        this.botId = botId;
        this.botRecommendationId = botRecommendationId;
        this.botVersion = botVersion;
        this.localeId = localeId;
