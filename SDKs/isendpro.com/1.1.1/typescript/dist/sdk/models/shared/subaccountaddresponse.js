...
var SubaccountAddResponseEtatEtat = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subAccountKeyId" }),
        __metadata("design:type", String)
    ], SubaccountAddResponseEtatEtat.prototype, "subAccountKeyId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subAccountLogin" }),
        __metadata("design:type", String)
...
var SubaccountAddResponseEtat = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: SubaccountAddResponseEtatEtat }),
        (0, class_transformer_1.Expose)({ name: "etat" }),
        (0, class_transformer_1.Type)(function () { return SubaccountAddResponseEtatEtat; }),
...
var SubaccountAddResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "etat" }),
        (0, class_transformer_1.Type)(function () { return SubaccountAddResponseEtat; }),
