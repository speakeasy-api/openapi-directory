...
var SellerStandardsProfile = /** @class */ (function () {
    ...
    **/
    SellerStandardsProfile.prototype.findSellerStandardsProfiles = function (req, config) {
    ...
    **/
    SellerStandardsProfile.prototype.getSellerStandardsProfile = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
