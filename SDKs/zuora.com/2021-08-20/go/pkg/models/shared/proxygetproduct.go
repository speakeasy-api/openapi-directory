...
type ProxyGetProductItemTypeNSEnum string

const (
	ProxyGetProductItemTypeNSEnumInventory    ProxyGetProductItemTypeNSEnum = "Inventory"
	ProxyGetProductItemTypeNSEnumNonInventory ProxyGetProductItemTypeNSEnum = "Non Inventory"
	ProxyGetProductItemTypeNSEnumService      ProxyGetProductItemTypeNSEnum = "Service"
)

func (e *ProxyGetProductItemTypeNSEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Non Inventory":
		fallthrough
	case "Service":
		*e = ProxyGetProductItemTypeNSEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ProxyGetProductItemTypeNSEnum: %s", s)
	}
}
...
type ProxyGetProduct struct {
	...
	//
	ItemTypeNS *ProxyGetProductItemTypeNSEnum `json:"ItemType__NS,omitempty"`
