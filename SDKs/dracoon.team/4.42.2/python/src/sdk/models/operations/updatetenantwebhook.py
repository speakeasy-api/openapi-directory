...
class UpdateTenantWebhookXSdsDateFormatEnum(str, Enum):
...
class UpdateTenantWebhookRequest:
    ...
    r"""Webhook ID"""  
    x_sds_date_format: Optional[UpdateTenantWebhookXSdsDateFormatEnum] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'X-Sds-Date-Format', 'style': 'simple', 'explode': False }})
    r"""Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) & [leettime.de](http://leettime.de/))"""  
