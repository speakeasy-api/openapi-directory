...
from ..shared import pdfuploadattributes as shared_pdfuploadattributes
...
class DocumentUploadStatusAttributesStatusEnum(str, Enum):
...
class DocumentUploadStatusAttributes:
    ...
    status: DocumentUploadStatusAttributesStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Document upload status."""  
    ...
    * `DOC202` - Error during processing by upstream system. Processing failed and upload must be resubmitted. Detail field will provide additional details where available.
    ...
    r"""Human readable error description. Only present if status = \\"error\\" """  
    updated_at: Optional[datetime] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('updated_at'), 'encoder': utils.datetimeisoformat(True), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso'), 'exclude': lambda f: f is None }})
    r"""The last time the submission was updated"""  
    uploaded_pdf: Optional[shared_pdfuploadattributes.PdfUploadAttributes] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('uploaded_pdf'), 'exclude': lambda f: f is None }})  
