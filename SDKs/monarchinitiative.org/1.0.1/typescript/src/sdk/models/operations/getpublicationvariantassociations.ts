...
export class GetPublicationVariantAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetPublicationVariantAssociationsQueryParams extends SpeakeasyBase {
