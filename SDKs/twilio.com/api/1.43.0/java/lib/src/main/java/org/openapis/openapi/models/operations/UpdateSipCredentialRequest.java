...
public class UpdateSipCredentialRequest {
    ...
    public UpdateSipCredentialRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("CredentialListSid") String credentialListSid, @JsonProperty("Sid") String sid) {
        this.accountSid = accountSid;
        this.credentialListSid = credentialListSid;
        this.sid = sid;
  }
