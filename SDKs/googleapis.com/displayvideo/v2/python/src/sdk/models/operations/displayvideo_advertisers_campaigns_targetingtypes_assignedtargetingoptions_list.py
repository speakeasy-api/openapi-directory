...
class DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsListRequest:
    path_params: DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsListPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsListQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsListSecurity = dataclasses.field()
