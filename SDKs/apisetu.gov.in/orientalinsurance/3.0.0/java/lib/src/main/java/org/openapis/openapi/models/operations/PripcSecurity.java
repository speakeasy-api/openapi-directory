...
public class PripcSecurity {
    ...
    public PripcSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public PripcSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public PripcSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
