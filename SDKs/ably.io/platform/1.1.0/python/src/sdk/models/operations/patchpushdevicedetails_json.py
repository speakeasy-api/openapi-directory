...
class PatchPushDeviceDetailsJSONRequest:
    
    device_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'device_id', 'style': 'simple', 'explode': False }})
    r"""Device's ID."""  
    device_details_input: Optional[shared_devicedetails.DeviceDetailsInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class PatchPushDeviceDetailsJSONResponse:
