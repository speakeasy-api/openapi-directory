...
import dataclasses
from ..shared import downloadhistory as shared_downloadhistory
...
class DownloadHistoryDataList:
    r"""List of download events"""
    
    data: Optional[list[shared_downloadhistory.DownloadHistory]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""Download events"""  
