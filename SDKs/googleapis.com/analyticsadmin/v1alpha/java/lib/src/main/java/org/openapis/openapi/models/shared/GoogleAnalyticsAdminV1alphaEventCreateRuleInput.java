 ...
 */
public class GoogleAnalyticsAdminV1alphaEventCreateRuleInput {
    /**
    ...
    public GoogleAnalyticsAdminV1alphaEventCreateRuleInput withDestinationEvent(String destinationEvent) {
    ...
    public GoogleAnalyticsAdminV1alphaEventCreateRuleInput withEventConditions(GoogleAnalyticsAdminV1alphaMatchingCondition[] eventConditions) {
    ...
    public GoogleAnalyticsAdminV1alphaEventCreateRuleInput withParameterMutations(GoogleAnalyticsAdminV1alphaParameterMutation[] parameterMutations) {
    ...
    public GoogleAnalyticsAdminV1alphaEventCreateRuleInput withSourceCopyParameters(Boolean sourceCopyParameters) {
        this.sourceCopyParameters = sourceCopyParameters;
        return this;
    }
    
    public GoogleAnalyticsAdminV1alphaEventCreateRuleInput(){}
}
