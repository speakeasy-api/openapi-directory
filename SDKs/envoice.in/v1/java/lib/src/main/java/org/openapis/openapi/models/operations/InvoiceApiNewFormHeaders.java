...
public class InvoiceApiNewFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiNewFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiNewFormHeaders withXAuthSecret(String xAuthSecret) {
