...
export class ContainerProjectsZonesClustersResourceLabelsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContainerProjectsZonesClustersResourceLabelsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsZonesClustersResourceLabelsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
