...
class ListSupportingDocumentTypeListSupportingDocumentTypeResponse:
    ...
    supporting_document_types: Optional[list[shared_trusthub_v1_supporting_document_type.TrusthubV1SupportingDocumentType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('supporting_document_types'), 'exclude': lambda f: f is None }})  
