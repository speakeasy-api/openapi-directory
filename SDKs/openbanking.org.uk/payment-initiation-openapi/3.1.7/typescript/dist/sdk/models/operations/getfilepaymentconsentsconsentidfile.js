...
exports.GetFilePaymentConsentsConsentIdFileResponse = exports.GetFilePaymentConsentsConsentIdFileRequest = exports.GetFilePaymentConsentsConsentIdFileSecurity = void 0;
...
exports.GetFilePaymentConsentsConsentIdFileSecurity = GetFilePaymentConsentsConsentIdFileSecurity;
var GetFilePaymentConsentsConsentIdFileRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetFilePaymentConsentsConsentIdFileRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConsentId",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentConsentsConsentIdFileRequest.prototype, "consentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentConsentsConsentIdFileRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentConsentsConsentIdFileRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentConsentsConsentIdFileRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentConsentsConsentIdFileRequest.prototype, "xFapiInteractionId", void 0);
    return GetFilePaymentConsentsConsentIdFileRequest;
}(utils_1.SpeakeasyBase));
exports.GetFilePaymentConsentsConsentIdFileRequest = GetFilePaymentConsentsConsentIdFileRequest;
var GetFilePaymentConsentsConsentIdFileResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetFilePaymentConsentsConsentIdFileResponse.prototype, "rawResponse", void 0);
    return GetFilePaymentConsentsConsentIdFileResponse;
}(utils_1.SpeakeasyBase));
exports.GetFilePaymentConsentsConsentIdFileResponse = GetFilePaymentConsentsConsentIdFileResponse;
