...
var Privilege = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: Privilege }),
        (0, class_transformer_1.Expose)({ name: "childPrivileges" }),
        (0, class_transformer_1.Type)(function () { return Privilege; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "isOuScopable" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "privilegeName" }),
        __metadata("design:type", String)
