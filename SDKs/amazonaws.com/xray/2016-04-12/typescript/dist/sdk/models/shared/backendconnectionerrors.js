...
var BackendConnectionErrors = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "ConnectionRefusedCount" }),
        __metadata("design:type", Number)
    ], BackendConnectionErrors.prototype, "connectionRefusedCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "HTTPCode4XXCount" }),
        __metadata("design:type", Number)
    ], BackendConnectionErrors.prototype, "httpCode4XXCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "HTTPCode5XXCount" }),
        __metadata("design:type", Number)
    ], BackendConnectionErrors.prototype, "httpCode5XXCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "OtherCount" }),
        __metadata("design:type", Number)
    ], BackendConnectionErrors.prototype, "otherCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TimeoutCount" }),
        __metadata("design:type", Number)
    ], BackendConnectionErrors.prototype, "timeoutCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "UnknownHostCount" }),
        __metadata("design:type", Number)
