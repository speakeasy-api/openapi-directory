...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.ListFragmentsResponse listFragments(org.openapis.openapi.models.operations.ListFragmentsRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ListFragmentsRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
