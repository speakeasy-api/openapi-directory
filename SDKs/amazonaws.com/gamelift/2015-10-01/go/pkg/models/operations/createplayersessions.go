...
func (e CreatePlayerSessionsXAmzTargetEnum) ToPointer() *CreatePlayerSessionsXAmzTargetEnum {
	return &e
}
...
func (e *CreatePlayerSessionsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "GameLift.CreatePlayerSessions":
		*e = CreatePlayerSessionsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreatePlayerSessionsXAmzTargetEnum: %v", v)
	}
}

type CreatePlayerSessionsRequest struct {
	CreatePlayerSessionsInput shared.CreatePlayerSessionsInput   `request:"mediaType=application/json"`
