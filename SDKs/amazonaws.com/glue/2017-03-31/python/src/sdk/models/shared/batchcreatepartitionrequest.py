...
class BatchCreatePartitionRequest:
    ...
    partition_input_list: list[shared_partitioninput.PartitionInput] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PartitionInputList') }})  
