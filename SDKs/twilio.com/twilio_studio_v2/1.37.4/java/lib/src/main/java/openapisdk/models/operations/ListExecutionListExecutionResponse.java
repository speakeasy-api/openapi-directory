...
public class ListExecutionListExecutionResponse {
    ...
    public openapisdk.models.shared.StudioV2FlowExecution[] executions;
    public ListExecutionListExecutionResponse withExecutions(openapisdk.models.shared.StudioV2FlowExecution[] executions) {
