...
export class GetIndividualsPartyIdLicensesProductIdRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class GetIndividualsPartyIdLicensesProductIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
