...
class ListAssetsResponse:
    ...
    list_assets_results: Optional[list[shared_listassetsresult.ListAssetsResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('listAssetsResults') }})
