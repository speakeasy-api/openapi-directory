...
export class RetailProjectsLocationsCatalogsModelsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsModelsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsModelsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
