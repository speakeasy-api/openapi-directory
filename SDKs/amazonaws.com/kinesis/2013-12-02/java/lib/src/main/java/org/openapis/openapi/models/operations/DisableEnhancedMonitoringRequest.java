...
public class DisableEnhancedMonitoringRequest {
    ...
    public DisableEnhancedMonitoringRequest(@JsonProperty("DisableEnhancedMonitoringInput") org.openapis.openapi.models.shared.DisableEnhancedMonitoringInput disableEnhancedMonitoringInput, @JsonProperty("X-Amz-Target") DisableEnhancedMonitoringXAmzTargetEnum xAmzTarget) {
        this.disableEnhancedMonitoringInput = disableEnhancedMonitoringInput;
        this.xAmzTarget = xAmzTarget;
  }
}
