...
exports.DefaultResources = void 0;
var utils_1 = require("../../../internal/utils");
// DefaultResources
/**
 * The default resources associated with the Project.
**/
var DefaultResources = /** @class */ (function (_super) {
    __extends(DefaultResources, _super);
    function DefaultResources() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=hostingSite" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=realtimeDatabaseInstance" }),
        __metadata("design:type", String)
    ], DefaultResources.prototype, "realtimeDatabaseInstance", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=storageBucket" }),
        __metadata("design:type", String)
