...
public class GETSubscriptionsByKeyRequest {
    ...
    public GETSubscriptionsByKeyRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETSubscriptionsByKeyRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETSubscriptionsByKeyRequest withChargeDetail(String chargeDetail) {
    ...
    public GETSubscriptionsByKeyRequest withSubscriptionKey(String subscriptionKey) {
