...
class PutJobSuccessResultRequest:
    ...
    put_job_success_result_input: shared_putjobsuccessresultinput.PutJobSuccessResultInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class PutJobSuccessResultResponse:
    ...
    r"""OutputVariablesSizeExceededException"""  
