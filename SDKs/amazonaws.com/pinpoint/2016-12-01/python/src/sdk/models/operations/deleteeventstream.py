...
from ..shared import deleteeventstreamresponse as shared_deleteeventstreamresponse
...
@dataclasses.dataclass
class DeleteEventStreamHeaders:
...
class DeleteEventStreamRequest:
    headers: DeleteEventStreamHeaders = dataclasses.field()
    path_params: DeleteEventStreamPathParams = dataclasses.field()
...
class DeleteEventStreamResponse:
    ...
    delete_event_stream_response: Optional[shared_deleteeventstreamresponse.DeleteEventStreamResponse] = dataclasses.field(default=None)
