...
export class FilesUpdateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FilesUpdateRequest extends SpeakeasyBase {
...
export class FilesUpdateResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
