...
@dataclasses.dataclass
class GetDeauthorizeDataShareHeaders:
...
class GetDeauthorizeDataShareRequest:
    headers: GetDeauthorizeDataShareHeaders = dataclasses.field()
    query_params: GetDeauthorizeDataShareQueryParams = dataclasses.field()
