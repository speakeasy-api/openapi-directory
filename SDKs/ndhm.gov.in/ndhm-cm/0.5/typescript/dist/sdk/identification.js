...
var Identification = /** @class */ (function () {
    function Identification(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    Identification.prototype.postV05PatientsFind = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05PatientsFindRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v0.5/patients/find";
