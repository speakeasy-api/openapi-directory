...
public class Templates {
    ...
    public org.openapis.openapi.models.operations.CopyTemplateResponse copyTemplate(org.openapis.openapi.models.operations.CopyTemplateRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.CopyTemplateRequest.class, request, null);
        if (queryParams != null) {
        ...
        org.openapis.openapi.models.operations.CopyTemplateResponse res = new org.openapis.openapi.models.operations.CopyTemplateResponse(contentType, httpRes.statusCode()) {{
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.CreateTemplateResponse createTemplate(org.openapis.openapi.models.shared.TemplateDefinitionNew request) throws Exception {
        String baseUrl = this._serverUrl;
    ...
    public org.openapis.openapi.models.operations.DeleteTemplateResponse deleteTemplate(org.openapis.openapi.models.operations.DeleteTemplateRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.DeleteTemplateRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.DeleteTemplateResponse res = new org.openapis.openapi.models.operations.DeleteTemplateResponse(contentType, httpRes.statusCode()) {{
    ...
    public org.openapis.openapi.models.operations.GetEditorUrlResponse getEditorUrl(org.openapis.openapi.models.operations.GetEditorUrlRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetEditorUrlRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.GetEditorUrlResponse res = new org.openapis.openapi.models.operations.GetEditorUrlResponse(contentType, httpRes.statusCode()) {{
    ...
    public org.openapis.openapi.models.operations.GetTemplateResponse getTemplate(org.openapis.openapi.models.operations.GetTemplateRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetTemplateRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
    ...
    public org.openapis.openapi.models.operations.GetTemplatesResponse getTemplates() throws Exception {
        ...
        org.openapis.openapi.models.operations.GetTemplatesResponse res = new org.openapis.openapi.models.operations.GetTemplatesResponse(contentType, httpRes.statusCode()) {{
    ...
    public org.openapis.openapi.models.operations.UpdateTemplateResponse updateTemplate(org.openapis.openapi.models.operations.UpdateTemplateRequest request) throws Exception {
        ...
        req.setMethod("PUT");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "templateDefinitionNew", "json");
        if (serializedRequestBody == null) {
            throw new Exception("Request body is required");
        }
        req.setBody(serializedRequestBody);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.UpdateTemplateRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
