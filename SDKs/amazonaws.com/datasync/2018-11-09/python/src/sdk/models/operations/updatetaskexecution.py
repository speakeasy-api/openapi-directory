...
class UpdateTaskExecutionRequest:
    ...
    update_task_execution_request: shared_updatetaskexecutionrequest.UpdateTaskExecutionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
