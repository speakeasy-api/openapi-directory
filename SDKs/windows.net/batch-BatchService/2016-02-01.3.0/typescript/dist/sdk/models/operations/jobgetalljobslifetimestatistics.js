...
exports.JobGetAllJobsLifetimeStatisticsResponse = exports.JobGetAllJobsLifetimeStatisticsRequest = void 0;
...
var JobGetAllJobsLifetimeStatisticsRequest = /** @class */ (function (_super) {
    ...
    ], JobGetAllJobsLifetimeStatisticsRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], JobGetAllJobsLifetimeStatisticsRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], JobGetAllJobsLifetimeStatisticsRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], JobGetAllJobsLifetimeStatisticsRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], JobGetAllJobsLifetimeStatisticsRequest.prototype, "timeout", void 0);
    return JobGetAllJobsLifetimeStatisticsRequest;
}(utils_1.SpeakeasyBase));
exports.JobGetAllJobsLifetimeStatisticsRequest = JobGetAllJobsLifetimeStatisticsRequest;
var JobGetAllJobsLifetimeStatisticsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.JobStatistics)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], JobGetAllJobsLifetimeStatisticsResponse.prototype, "rawResponse", void 0);
    return JobGetAllJobsLifetimeStatisticsResponse;
}(utils_1.SpeakeasyBase));
exports.JobGetAllJobsLifetimeStatisticsResponse = JobGetAllJobsLifetimeStatisticsResponse;
