...
class Transactions:
    ...
    def get_transactions(self, request: operations.GetTransactionsRequest, security: operations.GetTransactionsSecurity) -> operations.GetTransactionsResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.TransactionSearchResponse])
    ...
    def get_transactions_id(self, request: operations.GetTransactionsIDRequest, security: operations.GetTransactionsIDSecurity) -> operations.GetTransactionsIDResponse:
        r"""Get a transaction
