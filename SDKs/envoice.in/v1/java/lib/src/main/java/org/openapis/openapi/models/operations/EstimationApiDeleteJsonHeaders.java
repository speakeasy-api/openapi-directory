...
public class EstimationApiDeleteJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public EstimationApiDeleteJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public EstimationApiDeleteJsonHeaders withXAuthSecret(String xAuthSecret) {
