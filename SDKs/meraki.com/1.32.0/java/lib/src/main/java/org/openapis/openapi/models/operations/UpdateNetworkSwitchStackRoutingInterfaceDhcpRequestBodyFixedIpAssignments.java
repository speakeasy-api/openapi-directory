...
public class UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyFixedIpAssignments {
    ...
    public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyFixedIpAssignments(@JsonProperty("ip") String ip, @JsonProperty("mac") String mac, @JsonProperty("name") String name) {
        this.ip = ip;
        this.mac = mac;
        this.name = name;
  }
