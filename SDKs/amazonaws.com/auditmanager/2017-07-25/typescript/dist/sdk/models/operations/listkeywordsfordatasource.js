...
exports.ListKeywordsForDataSourceResponse = exports.ListKeywordsForDataSourceRequest = exports.ListKeywordsForDataSourceSourceEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 *  The control mapping data source that the keywords apply to.
 */
var ListKeywordsForDataSourceSourceEnum;
...
})(ListKeywordsForDataSourceSourceEnum = exports.ListKeywordsForDataSourceSourceEnum || (exports.ListKeywordsForDataSourceSourceEnum = {}));
var ListKeywordsForDataSourceRequest = /** @class */ (function (_super) {
    ...
    ], ListKeywordsForDataSourceRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], ListKeywordsForDataSourceRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], ListKeywordsForDataSourceRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], ListKeywordsForDataSourceRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], ListKeywordsForDataSourceRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], ListKeywordsForDataSourceRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], ListKeywordsForDataSourceRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=maxResults",
        }),
        __metadata("design:type", Number)
    ], ListKeywordsForDataSourceRequest.prototype, "maxResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=nextToken",
        }),
        __metadata("design:type", String)
    ], ListKeywordsForDataSourceRequest.prototype, "nextToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=source",
        }),
        __metadata("design:type", String)
    ], ListKeywordsForDataSourceRequest.prototype, "source", void 0);
    return ListKeywordsForDataSourceRequest;
}(utils_1.SpeakeasyBase));
exports.ListKeywordsForDataSourceRequest = ListKeywordsForDataSourceRequest;
var ListKeywordsForDataSourceResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ListKeywordsForDataSourceResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.ListKeywordsForDataSourceResponse = ListKeywordsForDataSourceResponse;
