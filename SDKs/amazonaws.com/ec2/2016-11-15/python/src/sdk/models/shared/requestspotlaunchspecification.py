...
class RequestSpotLaunchSpecificationBlockDeviceMappingsEbsVolumeTypeEnum(str, Enum):
...
class RequestSpotLaunchSpecificationBlockDeviceMappingsEbs:
    ...
    volume_type: Optional[RequestSpotLaunchSpecificationBlockDeviceMappingsEbsVolumeTypeEnum] = dataclasses.field(default=None)  
...
class RequestSpotLaunchSpecificationBlockDeviceMappings:
    ...
    ebs: Optional[RequestSpotLaunchSpecificationBlockDeviceMappingsEbs] = dataclasses.field(default=None)  
...
class RequestSpotLaunchSpecificationInstanceTypeEnum(str, Enum):
...
class RequestSpotLaunchSpecificationMonitoring:
    r"""<p>Indicates whether basic or detailed monitoring is enabled for the instance.</p> <p>Default: Disabled</p>"""
...
class RequestSpotLaunchSpecificationNetworkInterfaces:
    ...
    ipv4_prefixes: Optional[list[RequestSpotLaunchSpecificationNetworkInterfacesIpv4Prefixes]] = dataclasses.field(default=None)  
    ipv6_address_count: Optional[int] = dataclasses.field(default=None)  
    ipv6_addresses: Optional[list[RequestSpotLaunchSpecificationNetworkInterfacesIpv6Addresses]] = dataclasses.field(default=None)  
    ipv6_prefix_count: Optional[int] = dataclasses.field(default=None)  
    ipv6_prefixes: Optional[list[RequestSpotLaunchSpecificationNetworkInterfacesIpv6Prefixes]] = dataclasses.field(default=None)  
    ...
    private_ip_address: Optional[str] = dataclasses.field(default=None)  
    private_ip_addresses: Optional[list[RequestSpotLaunchSpecificationNetworkInterfacesPrivateIPAddresses]] = dataclasses.field(default=None)  
...
class RequestSpotLaunchSpecificationPlacementTenancyEnum(str, Enum):
...
class RequestSpotLaunchSpecificationPlacement:
    ...
    tenancy: Optional[RequestSpotLaunchSpecificationPlacementTenancyEnum] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class RequestSpotLaunchSpecification:
    r"""Describes the launch specification for an instance."""
    
    addressing_type: Optional[str] = dataclasses.field(default=None)  
    block_device_mappings: Optional[list[RequestSpotLaunchSpecificationBlockDeviceMappings]] = dataclasses.field(default=None)  
    ebs_optimized: Optional[bool] = dataclasses.field(default=None)  
    iam_instance_profile: Optional[RequestSpotLaunchSpecificationIamInstanceProfile] = dataclasses.field(default=None)  
    image_id: Optional[str] = dataclasses.field(default=None)  
    instance_type: Optional[RequestSpotLaunchSpecificationInstanceTypeEnum] = dataclasses.field(default=None)  
    kernel_id: Optional[str] = dataclasses.field(default=None)  
    key_name: Optional[str] = dataclasses.field(default=None)  
    monitoring: Optional[RequestSpotLaunchSpecificationMonitoring] = dataclasses.field(default=None)  
    network_interfaces: Optional[list[RequestSpotLaunchSpecificationNetworkInterfaces]] = dataclasses.field(default=None)  
    placement: Optional[RequestSpotLaunchSpecificationPlacement] = dataclasses.field(default=None)  
