...
class GetDescribeValidDbInstanceModificationsQueryParams:
    action: GetDescribeValidDbInstanceModificationsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDescribeValidDbInstanceModificationsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeValidDbInstanceModificationsRequest:
    headers: GetDescribeValidDbInstanceModificationsHeaders = dataclasses.field()
    query_params: GetDescribeValidDbInstanceModificationsQueryParams = dataclasses.field()
