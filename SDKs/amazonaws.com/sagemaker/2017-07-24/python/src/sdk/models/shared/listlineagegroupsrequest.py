...
from ..shared import sortlineagegroupsby_enum as shared_sortlineagegroupsby_enum
...
class ListLineageGroupsRequest:
    ...
    sort_by: Optional[shared_sortlineagegroupsby_enum.SortLineageGroupsByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
