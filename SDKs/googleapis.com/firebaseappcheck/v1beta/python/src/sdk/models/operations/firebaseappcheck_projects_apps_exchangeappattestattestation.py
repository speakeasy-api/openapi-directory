...
from ..shared import security as shared_security
from ..shared import googlefirebaseappcheckv1betaexchangeappattestattestationrequest as shared_googlefirebaseappcheckv1betaexchangeappattestattestationrequest
from ..shared import googlefirebaseappcheckv1betaexchangeappattestattestationresponse as shared_googlefirebaseappcheckv1betaexchangeappattestattestationresponse
...
class FirebaseappcheckProjectsAppsExchangeAppAttestAttestationRequest:
    ...
    request: Optional[shared_googlefirebaseappcheckv1betaexchangeappattestattestationrequest.GoogleFirebaseAppcheckV1betaExchangeAppAttestAttestationRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class FirebaseappcheckProjectsAppsExchangeAppAttestAttestationResponse:
    ...
    google_firebase_appcheck_v1beta_exchange_app_attest_attestation_response: Optional[shared_googlefirebaseappcheckv1betaexchangeappattestattestationresponse.GoogleFirebaseAppcheckV1betaExchangeAppAttestAttestationResponse] = dataclasses.field(default=None)
