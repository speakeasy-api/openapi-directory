...
class GetV2CrmUsersJSONRequest:
    ...
    r"""Filters crm users by crm_ids"""  
    ids: Optional[list[int]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'ids', 'style': 'form', 'explode': False }})
    r"""IDs of crm users to fetch. If a record can't be found, that record won't be returned and your request will be successful"""  
    ...
    r"""Key to sort on, must be one of: id, updated_at. Defaults to id"""  
    ...
    r"""Filters crm users by user guids"""  
    ...
    r"""Filters crm users by user_ids"""  
