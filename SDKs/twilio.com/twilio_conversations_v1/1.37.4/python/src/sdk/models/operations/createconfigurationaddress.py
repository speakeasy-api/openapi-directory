...
class CreateConfigurationAddressRequest:
    security: CreateConfigurationAddressSecurity = dataclasses.field()
    request: Optional[CreateConfigurationAddressCreateConfigurationAddressRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
