...
class Error400SBSAdditionalErrors:
    ...
    code: shared_messagecode400_sbs_enum.MessageCode400SBSEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})
    r"""Message codes defined for signing baskets for HTTP Error code 400 (BAD_REQUEST)."""  
...
class Error400SBS:
    ...
    additional_errors: Optional[list[Error400SBSAdditionalErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalErrors'), 'exclude': lambda f: f is None }})
