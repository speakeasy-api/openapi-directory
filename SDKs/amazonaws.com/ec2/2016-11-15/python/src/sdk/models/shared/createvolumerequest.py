...
class CreateVolumeRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateVolumeRequestTagSpecifications:
    ...
    resource_type: Optional[CreateVolumeRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateVolumeRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateVolumeRequest:
    ...
    tag_specifications: Optional[list[CreateVolumeRequestTagSpecifications]] = dataclasses.field(default=None)  
