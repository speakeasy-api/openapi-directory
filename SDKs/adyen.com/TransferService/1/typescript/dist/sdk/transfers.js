...
var Transfers = /** @class */ (function () {
     ...
     */
    Transfers.prototype.postTransfers = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new shared.TransferInfoOld(req);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostTransfersResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.transferOld = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.TransferOld);
                    }
                    break;
