...
class PatientAuthNotificationAcknowledgementAcknowledgement:
    ...
    status: PatientAuthNotificationAcknowledgementAcknowledgementStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
...
class PatientAuthNotificationAcknowledgement:
    ...
    acknowledgement: Optional[PatientAuthNotificationAcknowledgementAcknowledgement] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('acknowledgement'), 'exclude': lambda f: f is None }})  
