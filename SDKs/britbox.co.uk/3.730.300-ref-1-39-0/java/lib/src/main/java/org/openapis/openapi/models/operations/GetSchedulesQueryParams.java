...
public class GetSchedulesQueryParams {
    ...
    public GetSchedulesQueryParams withChannels(String[] channels) {
    ...
    public GetSchedulesQueryParams withDate(LocalDate date) {
        this.date = date;
        return this;
    }
    ...
    public GetSchedulesQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetSchedulesQueryParams withDuration(Integer duration) {
    ...
    public GetSchedulesQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public Integer hour;
    public GetSchedulesQueryParams withHour(Integer hour) {
        this.hour = hour;
        return this;
    }
    ...
    public GetSchedulesQueryParams withIntersect(Boolean intersect) {
    ...
    public String lang;
    public GetSchedulesQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetSchedulesQueryParams withSegments(String[] segments) {
    ...
    public String sub;
    public GetSchedulesQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
