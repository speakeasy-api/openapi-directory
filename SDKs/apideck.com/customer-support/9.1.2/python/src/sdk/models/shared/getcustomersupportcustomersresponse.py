...
import dataclasses
from ..shared import customersupportcustomer as shared_customersupportcustomer
...
class GetCustomerSupportCustomersResponse:
    r"""CustomerSupportCustomers"""
    
    data: list[shared_customersupportcustomer.CustomerSupportCustomer] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
