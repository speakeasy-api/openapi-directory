...
class GetSeasonsRequest:
    ...
    r"""Limit the result to seasons with a title containing this parameter in a case-insensitive way."""  
    series_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'series_id', 'style': 'form', 'explode': True }})
    r"""Limit the result to seasons owned by this series."""  
...
class GetSeasons400ApplicationVndAPIPlusJSONErrors:
    ...
    source: Optional[GetSeasons400ApplicationVndAPIPlusJSONErrorsSource] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('source'), 'exclude': lambda f: f is None }})
    r"""An object containing references to the source of the error, optionally including any of the following members."""  
...
class GetSeasons400ApplicationVndAPIPlusJSON:
    ...
    errors: Optional[list[GetSeasons400ApplicationVndAPIPlusJSONErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errors'), 'exclude': lambda f: f is None }})
...
class GetSeasons200ApplicationVndAPIPlusJSON:
    ...
    data: Optional[list[shared_season.Season]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
