...
var Device = /** @class */ (function () {
     ...
     */
    Device.prototype.detectDevice = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new shared.DeviceFeatures(req);
        }
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.DetectDeviceSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.DetectDeviceResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.deviceInfo = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.DeviceInfo);
                    }
                    break;
