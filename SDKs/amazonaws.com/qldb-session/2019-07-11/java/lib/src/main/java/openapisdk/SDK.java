...
/** SDK Documentation: https://docs.aws.amazon.com/qldb/ - Amazon Web Services documentation**/
public class SDK {
    ...
    **/
    public openapisdk.models.operations.SendCommandResponse sendCommand(openapisdk.models.operations.SendCommandRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=QLDBSession.SendCommand");
        ...
        openapisdk.models.operations.SendCommandResponse res = new openapisdk.models.operations.SendCommandResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.SendCommandResult out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.SendCommandResult.class);
