...
var JobLogs = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=JobCompletionReportURI" }),
        __metadata("design:type", String)
    ], JobLogs.prototype, "jobCompletionReportURI", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=JobFailureLogURI" }),
        __metadata("design:type", String)
    ], JobLogs.prototype, "jobFailureLogURI", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=JobSuccessLogURI" }),
        __metadata("design:type", String)
