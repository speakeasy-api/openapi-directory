...
export class GetNetworksIdActionsActionIdActionResponseAction extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => GetNetworksIdActionsActionIdActionResponseActionError)
  ...
  @Type(() => GetNetworksIdActionsActionIdActionResponseActionResources)
...
export class GetNetworksIdActionsActionIdActionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "action" })
  @Type(() => GetNetworksIdActionsActionIdActionResponseAction)
