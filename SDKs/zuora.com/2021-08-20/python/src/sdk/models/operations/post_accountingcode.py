...
from ..shared import postaccountingcodetype as shared_postaccountingcodetype
...
class POSTAccountingCodeRequest:
    ...
    post_accounting_code_type: shared_postaccountingcodetype.POSTAccountingCodeType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
