...
from ..shared import getrouteresponseresponse as shared_getrouteresponseresponse
...
class GetRouteResponseRequest:
    headers: GetRouteResponseHeaders = dataclasses.field()
    path_params: GetRouteResponsePathParams = dataclasses.field()
...
class GetRouteResponseResponse:
    ...
    get_route_response_response: Optional[shared_getrouteresponseresponse.GetRouteResponseResponse] = dataclasses.field(default=None)
