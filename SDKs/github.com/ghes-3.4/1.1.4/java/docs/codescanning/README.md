...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningDeleteAnalysisRequest req = new CodeScanningDeleteAnalysisRequest(399499L, "inventore", "magnam") {{
                confirmDelete = "ea";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetAlertRequest req = new CodeScanningGetAlertRequest(775220L, "consectetur", "recusandae");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetAnalysisRequest req = new CodeScanningGetAnalysisRequest(132487L, "minima", "eaque");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningGetSarifRequest req = new CodeScanningGetSarifRequest("a", "libero", "aut");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListAlertInstancesRequest req = new CodeScanningListAlertInstancesRequest(11427L, "deleniti", "impedit") {{
                page = 304582L;
                perPage = 146946L;
                ref = "accusamus";
            }};            
...
import org.openapis.openapi.models.operations.CodeScanningListAlertsForRepoSortEnum;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListAlertsForRepoRequest req = new CodeScanningListAlertsForRepoRequest("inventore", "non") {{
                direction = DirectionEnum.ASC;
                page = 677412L;
                perPage = 672048L;
                ref = "placeat";
                sort = CodeScanningListAlertsForRepoSortEnum.CREATED;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningListRecentAnalysesRequest req = new CodeScanningListRecentAnalysesRequest("quas", "assumenda") {{
                page = 860552L;
                perPage = 379034L;
                ref = "libero";
    ...
    public static void main(String[] args) {
        try {
            ...
            CodeScanningUpdateAlertRequest req = new CodeScanningUpdateAlertRequest(                new CodeScanningUpdateAlertRequestBody(CodeScanningAlertSetStateEnum.OPEN) {{
                                dismissedReason = CodeScanningAlertDismissedReasonEnum.LESS_THAN_NIL_GREATER_THAN;
                            }};, 591935L, "ipsa", "molestiae");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodeScanningUploadSarifRequest req = new CodeScanningUploadSarifRequest(                new CodeScanningUploadSarifRequestBody("magnam", "odio", "eius") {{
                                checkoutUri = "file:///github/workspace/";
                                startedAt = OffsetDateTime.parse("2022-07-18T12:12:30.628Z");
                                toolName = "rem";
                            }};, "fuga", "reprehenderit");            
