...
var VmUtilizationMetrics = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "cpuAveragePercent" }),
        __metadata("design:type", Number)
    ], VmUtilizationMetrics.prototype, "cpuAveragePercent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cpuMaxPercent" }),
        __metadata("design:type", Number)
    ], VmUtilizationMetrics.prototype, "cpuMaxPercent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "diskIoRateAverageKbps" }),
        __metadata("design:type", String)
    ], VmUtilizationMetrics.prototype, "diskIoRateAverageKbps", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "diskIoRateMaxKbps" }),
        __metadata("design:type", String)
    ], VmUtilizationMetrics.prototype, "diskIoRateMaxKbps", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "memoryAveragePercent" }),
        __metadata("design:type", Number)
    ], VmUtilizationMetrics.prototype, "memoryAveragePercent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "memoryMaxPercent" }),
        __metadata("design:type", Number)
    ], VmUtilizationMetrics.prototype, "memoryMaxPercent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "networkThroughputAverageKbps" }),
        __metadata("design:type", String)
    ], VmUtilizationMetrics.prototype, "networkThroughputAverageKbps", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "networkThroughputMaxKbps" }),
        __metadata("design:type", String)
