...
class GETBillingDocumentsRequest
{
     ...
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=documentDate,dateTimeFormat=Y-m-d')]
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GETBillingDocumentsStatusEnum $status
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=status')]
    public ?GETBillingDocumentsStatusEnum $status = null;
