...
var Api = /** @class */ (function () {
     ...
     */
    Api.prototype.cloudtasksApiQueueUpdate = function (req, security, config) {
        var _a;
        ...
        try {
            _a = utils.serializeRequestBody(req, "httpBody", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.CloudtasksApiQueueUpdateSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.CloudtasksApiQueueUpdateResponse({
