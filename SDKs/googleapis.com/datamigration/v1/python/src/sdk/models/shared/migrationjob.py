...
from ..shared import dumpflags as shared_dumpflags
...
class MigrationJobInput:
    ...
    dump_flags: Optional[shared_dumpflags.DumpFlags] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dumpFlags') }})
