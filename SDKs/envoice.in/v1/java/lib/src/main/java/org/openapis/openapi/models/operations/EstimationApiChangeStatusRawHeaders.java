...
public class EstimationApiChangeStatusRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public EstimationApiChangeStatusRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public EstimationApiChangeStatusRawHeaders withXAuthSecret(String xAuthSecret) {
