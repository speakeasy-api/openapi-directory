...
class UpdateAnomalyDetectorRequestBody:
    ...
    r"""The ARN of the detector to update."""  
    anomaly_detector_config: Optional[UpdateAnomalyDetectorRequestBodyAnomalyDetectorConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AnomalyDetectorConfig'), 'exclude': lambda f: f is None }})
    r"""Contains information about a detector's configuration."""  
    ...
    r"""The updated detector description."""  
    ...
    r"""The Amazon Resource Name (ARN) of an AWS KMS encryption key."""  
    

@dataclasses.dataclass
class UpdateAnomalyDetectorRequest:
    
    request_body: UpdateAnomalyDetectorRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
