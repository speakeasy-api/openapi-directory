...
import { ServiceConnectService } from "./serviceconnectservice";
 ...
 */
export class ServiceConnectConfiguration extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "enabled" })
  enabled: boolean;
  ...
  @SpeakeasyMetadata({ elemType: ServiceConnectService })
