...
public class Messaging {
     ...
     * ```
    **/
    public openapisdk.models.operations.GetUpcomingScheduledCampaignsAndCanvasesResponse getUpcomingScheduledCampaignsAndCanvases(openapisdk.models.operations.GetUpcomingScheduledCampaignsAndCanvasesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/messages/scheduled_broadcasts");
        ...
        openapisdk.models.operations.GetUpcomingScheduledCampaignsAndCanvasesResponse res = new openapisdk.models.operations.GetUpcomingScheduledCampaignsAndCanvasesResponse() {{
        }};
    ...
    **/
    public openapisdk.models.operations.ScheduleApiTriggeredCanvasesResponse scheduleApiTriggeredCanvases(openapisdk.models.operations.ScheduleApiTriggeredCanvasesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/canvas/trigger/schedule/create");
        ...
        openapisdk.models.operations.ScheduleApiTriggeredCanvasesResponse res = new openapisdk.models.operations.ScheduleApiTriggeredCanvasesResponse() {{
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
