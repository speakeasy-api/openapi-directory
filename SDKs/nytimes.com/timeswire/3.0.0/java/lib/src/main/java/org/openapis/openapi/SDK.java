...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.GetContentJsonResponse getContentJson(org.openapis.openapi.models.operations.GetContentJsonRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.operations.GetContentJSON200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetContentJSON200ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.GetContentSourceSectionJsonResponse getContentSourceSectionJson(org.openapis.openapi.models.operations.GetContentSourceSectionJsonRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetContentSourceSectionJSON200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetContentSourceSectionJSON200ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.GetContentSourceSectionTimePeriodJsonResponse getContentSourceSectionTimePeriodJson(org.openapis.openapi.models.operations.GetContentSourceSectionTimePeriodJsonRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetContentSourceSectionTimePeriodJSON200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetContentSourceSectionTimePeriodJSON200ApplicationJSON.class);
