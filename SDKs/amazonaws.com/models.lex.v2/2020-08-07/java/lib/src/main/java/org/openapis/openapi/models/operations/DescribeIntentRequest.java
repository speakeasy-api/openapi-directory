...
public class DescribeIntentRequest {
    ...
    public DescribeIntentRequest(@JsonProperty("botId") String botId, @JsonProperty("botVersion") String botVersion, @JsonProperty("intentId") String intentId, @JsonProperty("localeId") String localeId) {
        this.botId = botId;
        this.botVersion = botVersion;
        this.intentId = intentId;
        this.localeId = localeId;
