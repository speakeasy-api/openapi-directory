 ...
 */
export declare enum CreateSubnetCidrReservationRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateSubnetCidrReservationRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateSubnetCidrReservationRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateSubnetCidrReservationRequest extends SpeakeasyBase {
    cidr: string;
    description?: string;
    dryRun?: boolean;
