...
@dataclasses.dataclass
class ConnectorsProjectsLocationsConnectionsListQueryParams:
    ...
    view: Optional[ConnectorsProjectsLocationsConnectionsListViewEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
...
class ConnectorsProjectsLocationsConnectionsListRequest:
    path_params: ConnectorsProjectsLocationsConnectionsListPathParams = dataclasses.field()
    query_params: ConnectorsProjectsLocationsConnectionsListQueryParams = dataclasses.field()
    security: ConnectorsProjectsLocationsConnectionsListSecurity = dataclasses.field()
