...
public class UpdateNetworkApplianceFirewallCellularFirewallRulesRequestBodyRules {
    ...
    public UpdateNetworkApplianceFirewallCellularFirewallRulesRequestBodyRules(@JsonProperty("destCidr") String destCidr, @JsonProperty("policy") UpdateNetworkApplianceFirewallCellularFirewallRulesRequestBodyRulesPolicyEnum policy, @JsonProperty("protocol") UpdateNetworkApplianceFirewallCellularFirewallRulesRequestBodyRulesProtocolEnum protocol, @JsonProperty("srcCidr") String srcCidr) {
        this.destCidr = destCidr;
        this.policy = policy;
        this.protocol = protocol;
        this.srcCidr = srcCidr;
