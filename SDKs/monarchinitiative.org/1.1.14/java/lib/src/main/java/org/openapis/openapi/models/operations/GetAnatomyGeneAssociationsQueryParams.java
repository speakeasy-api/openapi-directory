...
public class GetAnatomyGeneAssociationsQueryParams {
    /**
    ...
    public GetAnatomyGeneAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetAnatomyGeneAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetAnatomyGeneAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetAnatomyGeneAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetAnatomyGeneAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetAnatomyGeneAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetAnatomyGeneAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public String q;
    public GetAnatomyGeneAssociationsQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetAnatomyGeneAssociationsQueryParams withRelation(String relation) {
    ...
    public Long rows;
    public GetAnatomyGeneAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetAnatomyGeneAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public String sort;
    public GetAnatomyGeneAssociationsQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetAnatomyGeneAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetAnatomyGeneAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetAnatomyGeneAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetAnatomyGeneAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
