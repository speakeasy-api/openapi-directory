...
class CloudsupportProjectsCasesEscalateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\EscalateCaseRequest $escalateCaseRequest = null;
