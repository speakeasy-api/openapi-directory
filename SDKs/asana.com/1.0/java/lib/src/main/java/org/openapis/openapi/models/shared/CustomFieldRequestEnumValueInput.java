 ...
 */
public class CustomFieldRequestEnumValueInput {
    /**
    ...
    public CustomFieldRequestEnumValueInput withColor(String color) {
        this.color = color;
        return this;
    }
    ...
    public CustomFieldRequestEnumValueInput withEnabled(Boolean enabled) {
    ...
    public CustomFieldRequestEnumValueInput withName(String name) {
        this.name = name;
        return this;
    }
    
    public CustomFieldRequestEnumValueInput(){}
}
