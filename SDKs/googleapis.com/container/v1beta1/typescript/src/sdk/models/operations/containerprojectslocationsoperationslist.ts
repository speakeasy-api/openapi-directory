...
export class ContainerProjectsLocationsOperationsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContainerProjectsLocationsOperationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsLocationsOperationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
