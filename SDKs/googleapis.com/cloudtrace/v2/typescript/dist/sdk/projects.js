...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.cloudtraceProjectsTracesBatchWrite = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudtraceProjectsTracesBatchWriteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2/{name}/traces:batchWrite", req.pathParams);
    ...
    **/
    Projects.prototype.cloudtraceProjectsTracesSpansCreateSpan = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.span = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
