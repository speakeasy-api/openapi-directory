...
public class NrcerSecurity {
    ...
    public NrcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public NrcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public NrcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
