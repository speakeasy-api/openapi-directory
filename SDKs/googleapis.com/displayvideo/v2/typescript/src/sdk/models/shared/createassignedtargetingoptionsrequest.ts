 ...
 */
export enum CreateAssignedTargetingOptionsRequestTargetingTypeEnum {
 ...
 */
export class CreateAssignedTargetingOptionsRequestInput extends SpeakeasyBase {
  /**
   * Required. The assigned targeting options to create and add.
   */
  @SpeakeasyMetadata({ elemType: AssignedTargetingOptionInput })
  @Expose({ name: "assignedTargetingOptions" })
  @Type(() => AssignedTargetingOptionInput)
