...
from ..shared import getlayerversionpolicyresponse as shared_getlayerversionpolicyresponse
...
class GetLayerVersionPolicyRequest:
    headers: GetLayerVersionPolicyHeaders = dataclasses.field()
    path_params: GetLayerVersionPolicyPathParams = dataclasses.field()
...
class GetLayerVersionPolicyResponse:
    ...
    get_layer_version_policy_response: Optional[shared_getlayerversionpolicyresponse.GetLayerVersionPolicyResponse] = dataclasses.field(default=None)
