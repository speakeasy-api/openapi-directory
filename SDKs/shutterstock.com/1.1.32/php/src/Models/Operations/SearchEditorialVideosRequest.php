...
class SearchEditorialVideosRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\SearchEditorialVideosResolutionEnum $resolution
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=resolution')]
    public ?SearchEditorialVideosResolutionEnum $resolution = null;
    
    /**
     * Sort by
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\SearchEditorialVideosSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?SearchEditorialVideosSortEnum $sort = null;
