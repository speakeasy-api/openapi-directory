...
type PatchSpacesSpaceIDFoldersIDCustomerPathParams struct {
	// Id of the folder
...
func (e *PatchSpacesSpaceIDFoldersIDCustomerRequestBodyLevelEnum) UnmarshalJSON(data []byte) error {
	...
	case "regular":
		fallthrough
	case "public":
		*e = PatchSpacesSpaceIDFoldersIDCustomerRequestBodyLevelEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PatchSpacesSpaceIDFoldersIDCustomerRequestBodyLevelEnum: %s", s)
	}
}
...
type PatchSpacesSpaceIDFoldersIDCustomerRequest struct {
	PathParams PatchSpacesSpaceIDFoldersIDCustomerPathParams
	// Customer to modify (except name, class and archivaldate)
	Request PatchSpacesSpaceIDFoldersIDCustomerRequestBody `request:"mediaType=application/json"`
}
