...
from ..shared import proxymodifycreditbalanceadjustment as shared_proxymodifycreditbalanceadjustment
...
class ObjectPUTCreditBalanceAdjustmentRequest:
    ...
    r"""Object id"""  
    proxy_modify_credit_balance_adjustment: shared_proxymodifycreditbalanceadjustment.ProxyModifyCreditBalanceAdjustment = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
