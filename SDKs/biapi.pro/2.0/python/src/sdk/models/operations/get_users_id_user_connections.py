...
@dataclasses.dataclass
class GetUsersIDUserConnections200ApplicationJSON:
    r"""connections"""
...
class GetUsersIDUserConnectionsResponse:
    ...
    get_users_id_user_connections_200_application_json_object: Optional[GetUsersIDUserConnections200ApplicationJSON] = dataclasses.field(default=None)
    r"""connections"""  
