...
class CloudassetBatchGetAssetsHistoryRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CloudassetBatchGetAssetsHistoryContentTypeEnum $contentType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=contentType')]
    public ?CloudassetBatchGetAssetsHistoryContentTypeEnum $contentType = null;
