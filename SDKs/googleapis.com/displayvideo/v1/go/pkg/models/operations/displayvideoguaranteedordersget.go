...
type DisplayvideoGuaranteedOrdersGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DisplayvideoGuaranteedOrdersGetPathParams struct {
...
type DisplayvideoGuaranteedOrdersGetQueryParams struct {
	// V1 error format.
...
type DisplayvideoGuaranteedOrdersGetRequest struct {
...
type DisplayvideoGuaranteedOrdersGetResponse struct {
	ContentType string
	// Successful response
