...
class GetOperationsForResourceRequest:
    ...
    get_operations_for_resource_request: shared_getoperationsforresourcerequest.GetOperationsForResourceRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
