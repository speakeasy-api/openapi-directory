...
from ..shared import createpayeescsvrequestv4 as shared_createpayeescsvrequestv4
from ..shared import createpayeescsvresponsev4 as shared_createpayeescsvresponsev4
...
class V4CreatePayeeMultipartFormData:
    ...
    file: Optional[list[shared_createpayeescsvrequestv4.CreatePayeesCSVRequestV4]] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'file', 'json': True }})
    r"""CSV File of payee data"""  
    payor_id: Optional[str] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'payorId' }})  
    

@dataclasses.dataclass
class V4CreatePayeeMultipartResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    create_payees_csv_response_v4: Optional[shared_createpayeescsvresponsev4.CreatePayeesCSVResponseV4] = dataclasses.field(default=None)
