...
from ..shared import drivegroupsfilter as shared_drivegroupsfilter
from ..shared import security as shared_security
from ..shared import badrequestresponse as shared_badrequestresponse
from ..shared import getdrivegroupsresponse as shared_getdrivegroupsresponse
...
class DriveGroupsAllQueryParams:
    cursor: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'cursor', 'style': 'form', 'explode': True }})
    filter: Optional[shared_drivegroupsfilter.DriveGroupsFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
...
@dataclasses.dataclass
class DriveGroupsAllSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class DriveGroupsAllRequest:
    headers: DriveGroupsAllHeaders = dataclasses.field()
    query_params: DriveGroupsAllQueryParams = dataclasses.field()
    security: DriveGroupsAllSecurity = dataclasses.field()
    

@dataclasses.dataclass
class DriveGroupsAllResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    get_drive_groups_response: Optional[shared_getdrivegroupsresponse.GetDriveGroupsResponse] = dataclasses.field(default=None)
