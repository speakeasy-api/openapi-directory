...
var ConfigAPI = /** @class */ (function () {
    function ConfigAPI(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * ---
     */
    ConfigAPI.prototype.getConfig = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.twoHundredSingleResult = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.TwoHundredSingleResult);
                    }
                    break;
