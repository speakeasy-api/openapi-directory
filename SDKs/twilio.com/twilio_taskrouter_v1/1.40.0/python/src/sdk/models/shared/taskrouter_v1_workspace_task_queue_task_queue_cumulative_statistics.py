...
class TaskrouterV1WorkspaceTaskQueueTaskQueueCumulativeStatistics:
    ...
    r"""The total number of Reservations accepted for Tasks in the TaskQueue."""  
    ...
    r"""The total number of Reservations canceled for Tasks in the TaskQueue."""  
    ...
    r"""The total number of Reservations created for Tasks in the TaskQueue."""  
    ...
    r"""The total number of Reservations rejected for Tasks in the TaskQueue."""  
    ...
    r"""The total number of Reservations rescinded."""  
    ...
    r"""The total number of Reservations that timed out for Tasks in the TaskQueue."""  
    ...
    r"""The total number of Tasks canceled in the TaskQueue."""  
    ...
    r"""The total number of Tasks completed in the TaskQueue."""  
    ...
    r"""The total number of Tasks deleted in the TaskQueue."""  
    ...
    r"""The total number of Tasks entered into the TaskQueue."""  
    ...
    wait_duration_in_queue_until_accepted: Optional[Any] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('wait_duration_in_queue_until_accepted'), 'exclude': lambda f: f is None }})
    r"""The relative wait duration statistics (`avg`, `min`, `max`, `total`) for Tasks accepted while in the TaskQueue. Calculation is based on the time when the Tasks entered the TaskQueue."""  
    ...
    r"""The wait duration statistics (`avg`, `min`, `max`, `total`) for Tasks accepted while in the TaskQueue. Calculation is based on the time when the Tasks were created. For transfers, the wait duration is counted from the moment ***the Task was created***, and not from when the transfer was initiated."""  
    ...
    r"""The wait duration statistics (`avg`, `min`, `max`, `total`) for Tasks canceled while in the TaskQueue."""  
