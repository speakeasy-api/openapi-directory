...
class ConfigManagementMembershipState:
    ...
    **Anthos Config Management**: State for a single cluster.
    ...
    binauthz_state: Optional[shared_configmanagementbinauthzstate.ConfigManagementBinauthzState] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('binauthzState') }})
