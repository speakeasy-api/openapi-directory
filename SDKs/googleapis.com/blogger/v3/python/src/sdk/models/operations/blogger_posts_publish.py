...
class BloggerPostsPublishQueryParams:
    ...
    publish_date: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'publishDate', 'style': 'form', 'explode': True }})
...
class BloggerPostsPublishRequest:
    path_params: BloggerPostsPublishPathParams = dataclasses.field()
    query_params: BloggerPostsPublishQueryParams = dataclasses.field()
    security: BloggerPostsPublishSecurity = dataclasses.field()
