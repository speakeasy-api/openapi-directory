...
exports.ListMetricResponse = exports.ListMetricListMetricResponse = exports.ListMetricListMetricResponseMeta = exports.ListMetricRequest = exports.ListMetricSecurity = exports.ListMetricServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListMetricServerList = ["https://insights.twilio.com"];
var ListMetricSecurity = /** @class */ (function (_super) {
    ...
    ], ListMetricSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListMetricSecurity.prototype, "username", void 0);
...
var ListMetricRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListMetricRequest.prototype, "callSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Direction",
        }),
        __metadata("design:type", String)
    ], ListMetricRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Edge" }),
        __metadata("design:type", String)
    ], ListMetricRequest.prototype, "edge", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListMetricRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListMetricRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListMetricRequest.prototype, "pageToken", void 0);
...
var ListMetricListMetricResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListMetricListMetricResponseMeta; }),
        __metadata("design:type", ListMetricListMetricResponseMeta)
    ], ListMetricListMetricResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.InsightsV1CallMetric }),
        (0, class_transformer_1.Expose)({ name: "metrics" }),
        (0, class_transformer_1.Type)(function () { return shared.InsightsV1CallMetric; }),
...
var ListMetricResponse = /** @class */ (function (_super) {
    ...
    ], ListMetricResponse.prototype, "rawResponse", void 0);
