...
func (e UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBodyRulesPortRulesProtocolEnum) ToPointer() *UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBodyRulesPortRulesProtocolEnum {
	return &e
}
...
func (e *UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBodyRulesPortRulesProtocolEnum) UnmarshalJSON(data []byte) error {
	...
	case "tcp":
		fallthrough
	case "udp":
		*e = UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBodyRulesPortRulesProtocolEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBodyRulesPortRulesProtocolEnum: %v", v)
	}
}
...
func (e UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBodyRulesUplinkEnum) ToPointer() *UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBodyRulesUplinkEnum {
	return &e
}
...
func (e *UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBodyRulesUplinkEnum) UnmarshalJSON(data []byte) error {
	...
	case "internet1":
		fallthrough
	case "internet2":
		*e = UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBodyRulesUplinkEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBodyRulesUplinkEnum: %v", v)
	}
}
