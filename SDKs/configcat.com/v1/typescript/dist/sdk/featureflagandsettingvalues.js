...
var FeatureFlagAndSettingValues = /** @class */ (function () {
    ...
    FeatureFlagAndSettingValues.prototype.getSettingValue = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/environments/{environmentId}/settings/{settingId}/value", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetSettingValueResponse({
    ...
    FeatureFlagAndSettingValues.prototype.getSettingValues = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/configs/{configId}/environments/{environmentId}/values", req);
        var client = this._securityClient || this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetSettingValuesResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/hal+json")) {
                        res.configSettingValuesModel = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ConfigSettingValuesModel);
                    }
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.configSettingValuesModel = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ConfigSettingValuesModel);
                    }
    ...
    FeatureFlagAndSettingValues.prototype.replaceSettingValue = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ReplaceSettingValueResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    FeatureFlagAndSettingValues.prototype.updateSettingValue = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.UpdateSettingValueResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
