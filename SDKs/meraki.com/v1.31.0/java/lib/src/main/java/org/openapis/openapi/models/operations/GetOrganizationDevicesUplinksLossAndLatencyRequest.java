...
public class GetOrganizationDevicesUplinksLossAndLatencyRequest {
    ...
    public String ip;
    public GetOrganizationDevicesUplinksLossAndLatencyRequest withIp(String ip) {
        this.ip = ip;
        return this;
    }
    ...
    public GetOrganizationDevicesUplinksLossAndLatencyRequest withOrganizationId(String organizationId) {
    ...
    public String t0;
    public GetOrganizationDevicesUplinksLossAndLatencyRequest withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetOrganizationDevicesUplinksLossAndLatencyRequest withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetOrganizationDevicesUplinksLossAndLatencyRequest withTimespan(Float timespan) {
    ...
    public GetOrganizationDevicesUplinksLossAndLatencyRequest withUplink(GetOrganizationDevicesUplinksLossAndLatencyUplinkEnum uplink) {
        this.uplink = uplink;
        return this;
    }
