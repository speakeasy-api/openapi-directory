...
from ..shared import proxymodifyaccount as shared_proxymodifyaccount
...
class ObjectPUTAccountRequest:
    ...
    r"""Object id"""  
    proxy_modify_account: shared_proxymodifyaccount.ProxyModifyAccount = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
