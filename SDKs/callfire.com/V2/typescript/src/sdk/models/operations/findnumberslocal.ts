...
export class FindNumbersLocalSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FindNumbersLocalRequest extends SpeakeasyBase {
  /**
   * A city name
   */
...
export class FindNumbersLocalResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
