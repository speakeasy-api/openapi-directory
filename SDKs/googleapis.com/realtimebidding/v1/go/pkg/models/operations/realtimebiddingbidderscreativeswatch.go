...
type RealtimebiddingBiddersCreativesWatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RealtimebiddingBiddersCreativesWatchPathParams struct {
...
type RealtimebiddingBiddersCreativesWatchQueryParams struct {
	// V1 error format.
...
type RealtimebiddingBiddersCreativesWatchRequest struct {
...
type RealtimebiddingBiddersCreativesWatchResponse struct {
	ContentType string
	StatusCode  int
