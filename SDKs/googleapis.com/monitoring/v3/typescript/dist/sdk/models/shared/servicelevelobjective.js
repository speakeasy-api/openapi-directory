...
exports.ServiceLevelObjective = exports.ServiceLevelObjectiveCalendarPeriodEnum = void 0;
var utils_1 = require("../../../internal/utils");
var servicelevelindicator_1 = require("./servicelevelindicator");
var class_transformer_1 = require("class-transformer");
/**
 * A calendar period, semantically "since the start of the current ". At this time, only DAY, WEEK, FORTNIGHT, and MONTH are supported.
 */
var ServiceLevelObjectiveCalendarPeriodEnum;
...
})(ServiceLevelObjectiveCalendarPeriodEnum = exports.ServiceLevelObjectiveCalendarPeriodEnum || (exports.ServiceLevelObjectiveCalendarPeriodEnum = {}));
/**
...
var ServiceLevelObjective = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "rollingPeriod" }),
        __metadata("design:type", String)
    ], ServiceLevelObjective.prototype, "rollingPeriod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "serviceLevelIndicator" }),
        (0, class_transformer_1.Type)(function () { return servicelevelindicator_1.ServiceLevelIndicator; }),
        __metadata("design:type", servicelevelindicator_1.ServiceLevelIndicator)
