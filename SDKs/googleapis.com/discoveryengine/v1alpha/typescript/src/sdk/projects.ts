...
export class Projects {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleCloudDiscoveryengineV1alphaDocument = utils.objectToClass(
              httpRes?.data,
  ...
  discoveryengineProjectsLocationsDataStoresBranchesDocumentsImport(
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/v1alpha/{parent}/documents:import",
      req
    );
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleCloudDiscoveryengineV1alphaListDocumentsResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleCloudDiscoveryengineV1alphaListDocumentsResponse
              );
          }
          break;
      }
  ...
  discoveryengineProjectsLocationsDataStoresServingConfigsRecommend(
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/v1alpha/{servingConfig}:recommend",
      req
    );
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleCloudDiscoveryengineV1alphaRecommendResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleCloudDiscoveryengineV1alphaRecommendResponse
              );
          }
          break;
      }
  ...
  discoveryengineProjectsLocationsDataStoresUserEventsCollect(
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/v1alpha/{parent}/userEvents:collect",
      req
    );
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
  ...
  discoveryengineProjectsLocationsDataStoresUserEventsImport(
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/v1alpha/{parent}/userEvents:import",
      req
    );
  ...
  discoveryengineProjectsLocationsDataStoresUserEventsWrite(
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/v1alpha/{parent}/userEvents:write",
      req
    );
