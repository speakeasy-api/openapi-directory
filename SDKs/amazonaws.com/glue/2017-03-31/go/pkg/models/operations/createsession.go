...
func (e CreateSessionXAmzTargetEnum) ToPointer() *CreateSessionXAmzTargetEnum {
	return &e
}
...
func (e *CreateSessionXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSGlue.CreateSession":
		*e = CreateSessionXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateSessionXAmzTargetEnum: %v", v)
	}
}
