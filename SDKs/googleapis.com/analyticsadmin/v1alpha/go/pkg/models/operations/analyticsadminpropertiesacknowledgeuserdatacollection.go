...
type AnalyticsadminPropertiesAcknowledgeUserDataCollectionRequest struct {
	...
	GoogleAnalyticsAdminV1alphaAcknowledgeUserDataCollectionRequest *shared.GoogleAnalyticsAdminV1alphaAcknowledgeUserDataCollectionRequest `request:"mediaType=application/json"`
	// OAuth access token.
