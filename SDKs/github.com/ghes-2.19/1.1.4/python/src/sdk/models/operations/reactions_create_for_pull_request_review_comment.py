...
class ReactionsCreateForPullRequestReviewCommentRequestBody:
    content: ReactionsCreateForPullRequestReviewCommentRequestBodyContentEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('content') }})
...
class ReactionsCreateForPullRequestReviewCommentRequest:
    path_params: ReactionsCreateForPullRequestReviewCommentPathParams = dataclasses.field()
    request: Optional[ReactionsCreateForPullRequestReviewCommentRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class ReactionsCreateForPullRequestReviewCommentResponse:
    ...
    reactions_create_for_pull_request_review_comment_415_application_json_object: Optional[ReactionsCreateForPullRequestReviewComment415ApplicationJSON] = dataclasses.field(default=None)
