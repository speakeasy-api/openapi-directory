...
class CreateSipAuthRegistrationsCredentialListMappingRequest:
    path_params: CreateSipAuthRegistrationsCredentialListMappingPathParams = dataclasses.field()
    security: CreateSipAuthRegistrationsCredentialListMappingSecurity = dataclasses.field()
    request: Optional[CreateSipAuthRegistrationsCredentialListMappingCreateSipAuthRegistrationsCredentialListMappingRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
