...
var Services = /** @class */ (function () {
    ...
    Services.prototype.getV05HiServicesServiceId = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v0.5/hi-services/{service-id}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetV05HiServicesServiceIdResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.serviceProfileResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ServiceProfileResponse);
                    }
