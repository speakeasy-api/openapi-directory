...
func (s *Gateway) PostV05CareContextsOnDiscover(ctx context.Context, request operations.PostV05CareContextsOnDiscoverRequest) (*operations.PostV05CareContextsOnDiscoverResponse, error) {
	baseURL := s._serverURL
...
func (s *Gateway) PostV05ConsentsHipOnNotify(ctx context.Context, request operations.PostV05ConsentsHipOnNotifyRequest) (*operations.PostV05ConsentsHipOnNotifyResponse, error) {
	baseURL := s._serverURL
...
func (s *Gateway) PostV05HealthInformationHipOnRequest(ctx context.Context, request operations.PostV05HealthInformationHipOnRequestRequest) (*operations.PostV05HealthInformationHipOnRequestResponse, error) {
	baseURL := s._serverURL
...
func (s *Gateway) PostV05LinksLinkAddContexts(ctx context.Context, request operations.PostV05LinksLinkAddContextsRequest) (*operations.PostV05LinksLinkAddContextsResponse, error) {
	baseURL := s._serverURL
...
func (s *Gateway) PostV05LinksLinkOnConfirm(ctx context.Context, request operations.PostV05LinksLinkOnConfirmRequest) (*operations.PostV05LinksLinkOnConfirmResponse, error) {
	baseURL := s._serverURL
...
func (s *Gateway) PostV05LinksLinkOnInit(ctx context.Context, request operations.PostV05LinksLinkOnInitRequest) (*operations.PostV05LinksLinkOnInitResponse, error) {
	baseURL := s._serverURL
...
func (s *Gateway) PostV05PatientsProfileOnShare(ctx context.Context, request operations.PostV05PatientsProfileOnShareRequest) (*operations.PostV05PatientsProfileOnShareResponse, error) {
	baseURL := s._serverURL
...
func (s *Gateway) PostV05PatientsSmsNotify(ctx context.Context, request operations.PostV05PatientsSmsNotifyRequest) (*operations.PostV05PatientsSmsNotifyResponse, error) {
	baseURL := s._serverURL
