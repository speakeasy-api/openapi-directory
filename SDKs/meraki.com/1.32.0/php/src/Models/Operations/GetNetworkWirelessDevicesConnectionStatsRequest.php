...
class GetNetworkWirelessDevicesConnectionStatsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNetworkWirelessDevicesConnectionStatsBandEnum $band
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=band')]
    public ?GetNetworkWirelessDevicesConnectionStatsBandEnum $band = null;
