...
@dataclasses.dataclass
class TestGetAllTestRunsForSeriesRequest:
...
@dataclasses.dataclass
class TestGetAllTestRunsForSeriesTestRunTestRunStatistics:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TestGetAllTestRunsForSeriesTestRun:
    r"""Summary single test run on Xamarin Test Cloud"""
    ...
    stats: Optional[TestGetAllTestRunsForSeriesTestRunTestRunStatistics] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('stats'), 'exclude': lambda f: f is None }})
    r"""Summary single test run on Xamarin Test Cloud"""  
...
class TestGetAllTestRunsForSeriesResponse:
    ...
    test_runs: Optional[list[TestGetAllTestRunsForSeriesTestRun]] = dataclasses.field(default=None)
    r"""OK"""  
