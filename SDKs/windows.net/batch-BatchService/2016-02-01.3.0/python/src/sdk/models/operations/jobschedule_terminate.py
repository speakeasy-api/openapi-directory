...
@dataclasses.dataclass
class JobScheduleTerminateHeaders:
...
class JobScheduleTerminateRequest:
    headers: JobScheduleTerminateHeaders = dataclasses.field()
    path_params: JobScheduleTerminatePathParams = dataclasses.field()
    query_params: JobScheduleTerminateQueryParams = dataclasses.field()
