...
class GetTeamMembershipsForTeam200ApplicationJSON:
    r"""Successfully retrieved the requested team's memberships."""
    
    data: Optional[list[shared_teammembershipcompact.TeamMembershipCompact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
