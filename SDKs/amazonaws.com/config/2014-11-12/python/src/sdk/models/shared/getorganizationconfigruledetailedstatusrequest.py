...
class GetOrganizationConfigRuleDetailedStatusRequest:
    ...
    filters: Optional[shared_statusdetailfilters.StatusDetailFilters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Filters'), 'exclude': lambda f: f is None }})  
