...
exports.FetchTaskQueueCumulativeStatisticsResponse = exports.FetchTaskQueueCumulativeStatisticsRequest = exports.FetchTaskQueueCumulativeStatisticsSecurity = exports.FetchTaskQueueCumulativeStatisticsServerList = void 0;
...
var FetchTaskQueueCumulativeStatisticsSecurity = /** @class */ (function (_super) {
    ...
    ], FetchTaskQueueCumulativeStatisticsSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], FetchTaskQueueCumulativeStatisticsSecurity.prototype, "username", void 0);
...
var FetchTaskQueueCumulativeStatisticsRequest = /** @class */ (function (_super) {
    ...
    ], FetchTaskQueueCumulativeStatisticsRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Minutes",
        }),
        __metadata("design:type", Number)
    ], FetchTaskQueueCumulativeStatisticsRequest.prototype, "minutes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SplitByWaitTime",
        }),
        __metadata("design:type", String)
    ], FetchTaskQueueCumulativeStatisticsRequest.prototype, "splitByWaitTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], FetchTaskQueueCumulativeStatisticsRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskChannel",
        }),
        __metadata("design:type", String)
    ], FetchTaskQueueCumulativeStatisticsRequest.prototype, "taskChannel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TaskQueueSid",
        }),
        __metadata("design:type", String)
    ], FetchTaskQueueCumulativeStatisticsRequest.prototype, "taskQueueSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], FetchTaskQueueCumulativeStatisticsRequest.prototype, "workspaceSid", void 0);
...
var FetchTaskQueueCumulativeStatisticsResponse = /** @class */ (function (_super) {
    ...
    ], FetchTaskQueueCumulativeStatisticsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
