...
class CreateServiceConversationMessageRequest:
    headers: CreateServiceConversationMessageHeaders = dataclasses.field()
    path_params: CreateServiceConversationMessagePathParams = dataclasses.field()
    security: CreateServiceConversationMessageSecurity = dataclasses.field()
    request: Optional[CreateServiceConversationMessageCreateServiceConversationMessageRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
