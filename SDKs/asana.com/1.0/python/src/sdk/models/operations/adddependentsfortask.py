...
class AddDependentsForTaskRequestBody:
    r"""The list of tasks to add as dependents."""
    
    data: Optional[shared_modifydependentsrequest.ModifyDependentsRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
...
class AddDependentsForTaskRequest:
    ...
    request_body: AddDependentsForTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The list of tasks to add as dependents."""  
...
class AddDependentsForTask200ApplicationJSON:
    r"""Successfully set the specified dependents on the given task."""
