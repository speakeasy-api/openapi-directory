...
class PostTruckDirectionsOutputFormatRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostTruckDirectionsOutputFormatCriteriaEnum $criteria
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=criteria')]
    public ?PostTruckDirectionsOutputFormatCriteriaEnum $criteria = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostTruckDirectionsOutputFormatDistanceUnitEnum $distanceUnit
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=distanceUnit')]
    public ?PostTruckDirectionsOutputFormatDistanceUnitEnum $distanceUnit = null;
    
    /**
     * Format of representation
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\PostTruckDirectionsOutputFormatOutputFormatEnum $outputFormat
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostTruckDirectionsOutputFormatOutputSrsEnum $outputSRS
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=outputSRS')]
    public ?PostTruckDirectionsOutputFormatOutputSrsEnum $outputSRS = null;
	...
	public function __construct()
	{
		...
		$this->outputFormat = \OpenAPI\OpenAPI\Models\Operations\PostTruckDirectionsOutputFormatOutputFormatEnum::JSON;
		$this->outputSRS = null;
		$this->partition = null;
		$this->points = "";
		$this->roundTrip = null;
