...
class DescribeRetentionConfigurationsRequest:
    ...
    describe_retention_configurations_request: shared_describeretentionconfigurationsrequest.DescribeRetentionConfigurationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DescribeRetentionConfigurationsResponse:
    ...
    r"""NoSuchRetentionConfigurationException"""  
