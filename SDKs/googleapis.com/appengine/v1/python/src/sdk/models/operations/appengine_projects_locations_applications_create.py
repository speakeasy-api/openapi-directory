...
class AppengineProjectsLocationsApplicationsCreateRequest:
    ...
    r"""Part of `parent`. See documentation of `projectsId`."""  
    projects_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'projectsId', 'style': 'simple', 'explode': False }})
    r"""Part of `parent`. The project and location in which the application should be created, specified in the format projects/*/locations/*"""  
    ...
    application_input: Optional[shared_application.ApplicationInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
