 ...
 */
export declare class DescribeInstancesResultReservationsGroups extends SpeakeasyBase {
    groupId?: string;
    groupName?: string;
}
/**
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesArchitectureEnum {
    I386 = "i386",
    X8664 = "x86_64",
    Arm64 = "arm64",
    X8664Mac = "x86_64_mac",
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesBlockDeviceMappingsEbsStatusEnum {
    Attaching = "attaching",
    Attached = "attached",
    Detaching = "detaching",
    Detached = "detached"
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesBlockDeviceMappingsEbs extends SpeakeasyBase {
    attachTime?: Date;
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesBlockDeviceMappings extends SpeakeasyBase {
    deviceName?: string;
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesBootModeEnum {
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesCapacityReservationSpecificationCapacityReservationPreferenceEnum {
    Open = "open",
    None = "none"
}
/**
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesCapacityReservationSpecificationCapacityReservationTarget extends SpeakeasyBase {
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesCapacityReservationSpecification extends SpeakeasyBase {
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesCpuOptions extends SpeakeasyBase {
    coreCount?: number;
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesCurrentInstanceBootModeEnum {
    LegacyBios = "legacy-bios",
    Uefi = "uefi"
}
/**
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesElasticGpuAssociations extends SpeakeasyBase {
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesElasticInferenceAcceleratorAssociations extends SpeakeasyBase {
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesEnclaveOptions extends SpeakeasyBase {
    enabled?: boolean;
}
/**
 * Indicates whether the instance is enabled for hibernation.
 */
export declare class DescribeInstancesResultReservationsInstancesHibernationOptions extends SpeakeasyBase {
    configured?: boolean;
}
/**
 * The hypervisor type of the instance. The value <code>xen</code> is used for both Xen and Nitro hypervisors.
 */
export declare enum DescribeInstancesResultReservationsInstancesHypervisorEnum {
    Ovm = "ovm",
    Xen = "xen"
}
/**
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesIamInstanceProfile extends SpeakeasyBase {
    arn?: string;
    id?: string;
}
/**
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesInstanceLifecycleEnum {
    Spot = "spot",
    Scheduled = "scheduled"
}
/**
 * The instance type.
 */
export declare enum DescribeInstancesResultReservationsInstancesInstanceTypeEnum {
    A1Medium = "a1.medium",
    A1Large = "a1.large",
    A1Xlarge = "a1.xlarge",
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesLicenses extends SpeakeasyBase {
    licenseConfigurationArn?: string;
}
/**
 * Provides information on the current automatic recovery behavior of your instance.
 */
export declare enum DescribeInstancesResultReservationsInstancesMaintenanceOptionsAutoRecoveryEnum {
    Disabled = "disabled",
    Default = "default"
}
/**
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesMaintenanceOptions extends SpeakeasyBase {
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesMetadataOptionsHttpEndpointEnum {
    Disabled = "disabled",
    Enabled = "enabled"
}
/**
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesMetadataOptionsHttpProtocolIpv6Enum {
    Disabled = "disabled",
    Enabled = "enabled"
}
/**
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesMetadataOptionsHttpTokensEnum {
    Optional = "optional",
    Required = "required"
}
/**
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesMetadataOptionsInstanceMetadataTagsEnum {
    Disabled = "disabled",
    Enabled = "enabled"
}
/**
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesMetadataOptionsStateEnum {
    Pending = "pending",
    Applied = "applied"
}
/**
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesMetadataOptions extends SpeakeasyBase {
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesMonitoringStateEnum {
    Disabled = "disabled",
    Disabling = "disabling",
    Enabled = "enabled",
    Pending = "pending"
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesMonitoring extends SpeakeasyBase {
    state?: DescribeInstancesResultReservationsInstancesMonitoringStateEnum;
}
/**
 * The association information for an Elastic IPv4 associated with the network interface.
 */
export declare class DescribeInstancesResultReservationsInstancesNetworkInterfacesAssociation extends SpeakeasyBase {
    carrierIp?: string;
 ...
 * The attachment state.
 */
export declare enum DescribeInstancesResultReservationsInstancesNetworkInterfacesAttachmentStatusEnum {
    Attaching = "attaching",
    Attached = "attached",
    Detaching = "detaching",
    Detached = "detached"
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesNetworkInterfacesAttachment extends SpeakeasyBase {
    attachTime?: Date;
    attachmentId?: string;
    deleteOnTermination?: boolean;
    deviceIndex?: number;
 ...
 * Describes a security group.
 */
export declare class DescribeInstancesResultReservationsInstancesNetworkInterfacesGroups extends SpeakeasyBase {
    groupId?: string;
    groupName?: string;
}
/**
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesNetworkInterfacesIpv4Prefixes extends SpeakeasyBase {
    ipv4Prefix?: string;
}
/**
 * Describes an IPv6 address.
 */
export declare class DescribeInstancesResultReservationsInstancesNetworkInterfacesIpv6Addresses extends SpeakeasyBase {
    ipv6Address?: string;
}
/**
 * Information about an IPv6 prefix.
 */
export declare class DescribeInstancesResultReservationsInstancesNetworkInterfacesIpv6Prefixes extends SpeakeasyBase {
    ipv6Prefix?: string;
}
/**
 * The association information for an Elastic IP address for the network interface.
 */
export declare class DescribeInstancesResultReservationsInstancesNetworkInterfacesPrivateIpAddressesAssociation extends SpeakeasyBase {
    carrierIp?: string;
    customerOwnedIp?: string;
    ipOwnerId?: string;
    publicDnsName?: string;
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesNetworkInterfacesPrivateIpAddresses extends SpeakeasyBase {
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesNetworkInterfacesStatusEnum {
    Available = "available",
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesNetworkInterfaces extends SpeakeasyBase {
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesPlacementTenancyEnum {
    Default = "default",
    Dedicated = "dedicated",
    Host = "host"
}
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesPlacement extends SpeakeasyBase {
    affinity?: string;
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesPlatformEnum {
    Windows = "Windows"
}
/**
 * The type of hostname to assign to an instance.
 */
export declare enum DescribeInstancesResultReservationsInstancesPrivateDnsNameOptionsHostnameTypeEnum {
    IpName = "ip-name",
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesPrivateDnsNameOptions extends SpeakeasyBase {
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesProductCodesProductCodeTypeEnum {
    Devpay = "devpay",
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesProductCodes extends SpeakeasyBase {
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesRootDeviceTypeEnum {
    Ebs = "ebs",
 ...
 * Describes a security group.
 */
export declare class DescribeInstancesResultReservationsInstancesSecurityGroups extends SpeakeasyBase {
    groupId?: string;
    groupName?: string;
}
/**
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesStateNameEnum {
    Pending = "pending",
    Running = "running",
 ...
 * The current state of the instance.
 */
export declare class DescribeInstancesResultReservationsInstancesState extends SpeakeasyBase {
    code?: number;
 ...
 */
export declare class DescribeInstancesResultReservationsInstancesStateReason extends SpeakeasyBase {
    code?: string;
    message?: string;
}
/**
 * Describes a tag.
 */
export declare class DescribeInstancesResultReservationsInstancesTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare enum DescribeInstancesResultReservationsInstancesVirtualizationTypeEnum {
    Hvm = "hvm",
 ...
 */
export declare class DescribeInstancesResultReservationsInstances extends SpeakeasyBase {
 ...
 */
export declare class DescribeInstancesResultReservations extends SpeakeasyBase {
