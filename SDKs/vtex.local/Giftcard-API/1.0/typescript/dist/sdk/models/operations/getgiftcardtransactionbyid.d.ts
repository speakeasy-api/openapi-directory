...
export declare class GetGiftCardTransactionbyIDRequest extends SpeakeasyBase {
    /**
...
export declare class GetGiftCardTransactionbyIDResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
    rawResponse?: AxiosResponse;
    response5?: shared.Response5;
}
