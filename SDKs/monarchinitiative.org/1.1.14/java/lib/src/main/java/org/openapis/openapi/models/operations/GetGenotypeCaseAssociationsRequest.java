...
public class GetGenotypeCaseAssociationsRequest {
    ...
    public GetGenotypeCaseAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGenotypeCaseAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGenotypeCaseAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGenotypeCaseAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGenotypeCaseAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGenotypeCaseAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGenotypeCaseAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGenotypeCaseAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGenotypeCaseAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGenotypeCaseAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGenotypeCaseAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGenotypeCaseAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGenotypeCaseAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
