...
public class SkmstSecurity {
    ...
    public SkmstSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public SkmstSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public SkmstSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
