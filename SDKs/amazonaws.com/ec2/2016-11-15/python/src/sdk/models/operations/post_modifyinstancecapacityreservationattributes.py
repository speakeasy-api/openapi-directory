...
class PostModifyInstanceCapacityReservationAttributesQueryParams:
    action: PostModifyInstanceCapacityReservationAttributesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostModifyInstanceCapacityReservationAttributesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostModifyInstanceCapacityReservationAttributesRequest:
    headers: PostModifyInstanceCapacityReservationAttributesHeaders = dataclasses.field()
    query_params: PostModifyInstanceCapacityReservationAttributesQueryParams = dataclasses.field()
