...
class ObjectDeleteInvoiceItemAdjustmentPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectDeleteInvoiceItemAdjustmentHeaders:
...
class ObjectDeleteInvoiceItemAdjustmentRequest:
    headers: ObjectDeleteInvoiceItemAdjustmentHeaders = dataclasses.field()
    path_params: ObjectDeleteInvoiceItemAdjustmentPathParams = dataclasses.field()
