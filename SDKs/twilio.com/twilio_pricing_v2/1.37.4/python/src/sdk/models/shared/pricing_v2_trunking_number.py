...
class PricingV2TrunkingNumber:
    ...
    originating_call_price: Optional[PricingV2TrunkingNumberOriginatingCallPrice] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('originating_call_price') }})
    ...
    terminating_prefix_prices: Optional[list[PricingV2TrunkingNumberTerminatingPrefixPrices]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('terminating_prefix_prices') }})
