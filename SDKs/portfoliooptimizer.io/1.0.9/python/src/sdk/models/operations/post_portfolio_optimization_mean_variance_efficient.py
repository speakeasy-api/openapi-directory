...
class PostPortfolioOptimizationMeanVarianceEfficientRequestBody:
    ...
    constraints: PostPortfolioOptimizationMeanVarianceEfficientRequestBodyConstraints = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('constraints') }})  
