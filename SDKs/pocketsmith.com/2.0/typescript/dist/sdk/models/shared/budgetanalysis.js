...
var BudgetAnalysis = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "average_actual_amount" }),
        __metadata("design:type", Number)
    ], BudgetAnalysis.prototype, "averageActualAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "average_forecast_amount" }),
        __metadata("design:type", Number)
    ...
    ], BudgetAnalysis.prototype, "currencyCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "total_actual_amount" }),
        __metadata("design:type", Number)
    ], BudgetAnalysis.prototype, "totalActualAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "total_forecast_amount" }),
        __metadata("design:type", Number)
    ], BudgetAnalysis.prototype, "totalForecastAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "total_over_by" }),
        __metadata("design:type", Number)
    ], BudgetAnalysis.prototype, "totalOverBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "total_under_by" }),
        __metadata("design:type", Number)
    ], BudgetAnalysis.prototype, "totalUnderBy", void 0);
    return BudgetAnalysis;
}(utils_1.SpeakeasyBase));
exports.BudgetAnalysis = BudgetAnalysis;
