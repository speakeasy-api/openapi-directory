...
exports.ExternalEvents = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ExternalEvents = /** @class */ (function () {
    function ExternalEvents(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ExternalEvents.prototype.getExternalEvents = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetExternalEventsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/external_events";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.externalEventEntities = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
     ...
     * Show External Event
    **/
    ExternalEvents.prototype.getExternalEventsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetExternalEventsIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/external_events/{id}", req.pathParams);
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.externalEventEntity = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
    ...
    **/
    ExternalEvents.prototype.postExternalEvents = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
