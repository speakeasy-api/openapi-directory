...
public class GetModelPhenotypeAssociationsRequest {
    ...
    public GetModelPhenotypeAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetModelPhenotypeAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetModelPhenotypeAssociationsRequest withEvidence(String evidence) {
    ...
    public GetModelPhenotypeAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetModelPhenotypeAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetModelPhenotypeAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetModelPhenotypeAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetModelPhenotypeAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetModelPhenotypeAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetModelPhenotypeAssociationsRequest withRelation(String relation) {
    ...
    public GetModelPhenotypeAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetModelPhenotypeAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetModelPhenotypeAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetModelPhenotypeAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetModelPhenotypeAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetModelPhenotypeAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetModelPhenotypeAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetModelPhenotypeAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
