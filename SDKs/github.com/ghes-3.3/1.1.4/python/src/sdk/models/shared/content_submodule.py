...
class ContentSubmoduleTypeEnum(str, Enum):
    SUBMODULE = 'submodule'
...
class ContentSubmodule:
    r"""An object describing a submodule"""
    ...
    type: ContentSubmoduleTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})  
