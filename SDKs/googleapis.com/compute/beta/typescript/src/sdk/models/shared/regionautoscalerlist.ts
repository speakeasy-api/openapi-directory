 ...
 */
export enum RegionAutoscalerListWarningCodeEnum {
...
export class RegionAutoscalerListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class RegionAutoscalerListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: RegionAutoscalerListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: RegionAutoscalerListWarningData })
  @Expose({ name: "data" })
  @Type(() => RegionAutoscalerListWarningData)
  data?: RegionAutoscalerListWarningData[];
 ...
 */
export class RegionAutoscalerList extends SpeakeasyBase {
  /**
