...
class AddressValidatingShipmentDeliveryConfirmationEnum(str, Enum):
...
class AddressValidatingShipmentInternationalShipmentOptionsPackageContentsEnum(str, Enum):
...
class AddressValidatingShipmentInternationalShipmentOptionsNonDeliveryEnum(str, Enum):
...
class AddressValidatingShipmentInternationalShipmentOptionsInput:
    ...
    contents: AddressValidatingShipmentInternationalShipmentOptionsPackageContentsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contents') }})
    r"""The type of contents in this shipment.  This may impact import duties or customs treatment."""  
    non_delivery: AddressValidatingShipmentInternationalShipmentOptionsNonDeliveryEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('non_delivery') }})
...
class AddressValidatingShipmentInsuranceProviderEnum(str, Enum):
...
class AddressValidatingShipmentOriginTypeEnum(str, Enum):
    r"""Indicates if the package will be picked up or dropped off by the carrier"""
    PICKUP = 'pickup'
    DROP_OFF = 'drop_off'

class AddressValidatingShipmentValidateAddressEnum(str, Enum):
...
class AddressValidatingShipmentInput:
    ...
    confirmation: Optional[AddressValidatingShipmentDeliveryConfirmationEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('confirmation'), 'exclude': lambda f: f is None }})
    r"""The type of delivery confirmation that is required for this shipment."""  
    customs: Optional[AddressValidatingShipmentInternationalShipmentOptionsInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('customs'), 'exclude': lambda f: f is None }})
    ...
    """  
    insurance_provider: Optional[AddressValidatingShipmentInsuranceProviderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('insurance_provider'), 'exclude': lambda f: f is None }})
    ...
    origin_type: Optional[AddressValidatingShipmentOriginTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin_type'), 'exclude': lambda f: f is None }})
    r"""Indicates if the package will be picked up or dropped off by the carrier"""  
    ...
    validate_address: Optional[AddressValidatingShipmentValidateAddressEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('validate_address'), 'exclude': lambda f: f is None }})  
