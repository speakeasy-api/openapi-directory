...
public class ListBookingsQueryParams {
    /**
    ...
    public ListBookingsQueryParams withCreated(java.util.Map<String, Object> created) {
    ...
    public ListBookingsQueryParams withEnd(java.util.Map<String, Object> end) {
        this.end = end;
        return this;
    }
    ...
    public ListBookingsQueryParams withOffset(Double offset) {
        this.offset = offset;
        return this;
    }
    ...
    public Double size;
    public ListBookingsQueryParams withSize(Double size) {
        this.size = size;
        return this;
    }
    ...
    public ListBookingsQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public ListBookingsQueryParams withStart(java.util.Map<String, Object> start) {
        this.start = start;
        return this;
    }
    ...
    public ListBookingsQueryParams withUpdated(java.util.Map<String, Object> updated) {
