...
export class IntegrationsProjectsLocationsConnectionsRuntimeActionSchemasListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsConnectionsRuntimeActionSchemasListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsConnectionsRuntimeActionSchemasListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
