 ...
 */
public enum WebinarCreate201ApplicationXMLSettingsQuestionAndAnswerAnswerQuestionsEnum {
    ONLY("only"),
    ALL("all");
    ...
    private WebinarCreate201ApplicationXMLSettingsQuestionAndAnswerAnswerQuestionsEnum(String value) {
        this.value = value;
    }
}
