...
public class Messages {
     ...
     * Create Message
    **/
    public openapisdk.models.operations.MessagesAddResponse messagesAdd(openapisdk.models.operations.MessagesAddRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/sms/messages");
        ...
        openapisdk.models.operations.MessagesAddResponse res = new openapisdk.models.operations.MessagesAddResponse() {{
        ...
        if (httpRes.statusCode() == 201) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.CreateMessageResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateMessageResponse.class);
     ...
     * List Messages
    **/
    public openapisdk.models.operations.MessagesAllResponse messagesAll(openapisdk.models.operations.MessagesAllRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/sms/messages");
        ...
        openapisdk.models.operations.MessagesAllResponse res = new openapisdk.models.operations.MessagesAllResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GetMessagesResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetMessagesResponse.class);
    ...
    **/
    public openapisdk.models.operations.MessagesDeleteResponse messagesDelete(openapisdk.models.operations.MessagesDeleteRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/sms/messages/{id}", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DeleteMessageResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DeleteMessageResponse.class);
     ...
     * Get Message
    **/
    public openapisdk.models.operations.MessagesOneResponse messagesOne(openapisdk.models.operations.MessagesOneRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/sms/messages/{id}", request.pathParams);
        ...
        openapisdk.models.operations.MessagesOneResponse res = new openapisdk.models.operations.MessagesOneResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GetMessageResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetMessageResponse.class);
    ...
    public openapisdk.models.operations.MessagesUpdateResponse messagesUpdate(openapisdk.models.operations.MessagesUpdateRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.UpdateMessageResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.UpdateMessageResponse.class);
