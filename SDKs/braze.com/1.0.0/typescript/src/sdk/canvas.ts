...
export class Canvas {
  ...
  canvasDataAnalyticsSummary(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CanvasDataAnalyticsSummaryResponse =
        new operations.CanvasDataAnalyticsSummaryResponse({
  ...
  canvasDataSeriesAnalytics(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CanvasDataSeriesAnalyticsResponse =
        new operations.CanvasDataSeriesAnalyticsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  canvasDetails(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CanvasDetailsResponse =
        new operations.CanvasDetailsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  canvasList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CanvasListResponse =
        new operations.CanvasListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
