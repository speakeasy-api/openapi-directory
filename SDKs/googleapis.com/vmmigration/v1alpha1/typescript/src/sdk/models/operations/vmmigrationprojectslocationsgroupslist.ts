...
export class VmmigrationProjectsLocationsGroupsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsGroupsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsGroupsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
