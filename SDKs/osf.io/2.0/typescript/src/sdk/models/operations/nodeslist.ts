 ...
 */
export enum NodesListNodeAttributesCategoryEnum {
  Analysis = "analysis",
 ...
 */
export class NodesListNodeAttributes extends SpeakeasyBase {
  /**
   * The category of the node, as selected by project contributors.
   */
  @SpeakeasyMetadata()
 ...
 */
export class NodesListNodeLinks extends SpeakeasyBase {
  /**
 ...
 */
export class NodesListNodeRelationships extends SpeakeasyBase {
  /**
...
export class NodesListNode extends SpeakeasyBase {
  /**
   * The properties of the node entity.
   */
  @SpeakeasyMetadata()
