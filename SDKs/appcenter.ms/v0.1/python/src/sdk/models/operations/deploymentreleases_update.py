...
class DeploymentReleasesUpdateRequestBody:
    r"""Release modification. All fields are optional and only provided fields will get updated."""
...
class DeploymentReleasesUpdateRequest:
    ...
    release_label: str = dataclasses.field(metadata={'path_param': { 'field_name': 'release_label', 'style': 'simple', 'explode': False }})
    r"""release label"""  
    request_body: DeploymentReleasesUpdateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Release modification. All fields are optional and only provided fields will get updated."""  
...
class DeploymentReleasesUpdate200ApplicationJSONReleaseMethodEnum(str, Enum):
...
class DeploymentReleasesUpdate200ApplicationJSON:
    ...
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('description'), 'exclude': lambda f: f is None }})  
    diff_package_map: Optional[dict[str, DeploymentReleasesUpdate200ApplicationJSONDiffPackageMap]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('diff_package_map'), 'exclude': lambda f: f is None }})  
    is_disabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('is_disabled'), 'exclude': lambda f: f is None }})  
    is_mandatory: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('is_mandatory'), 'exclude': lambda f: f is None }})  
    ...
    release_method: Optional[DeploymentReleasesUpdate200ApplicationJSONReleaseMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('release_method'), 'exclude': lambda f: f is None }})
    r"""The release method is unknown if unspecified"""  
...
@dataclasses.dataclass
class DeploymentReleasesUpdateResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    deployment_releases_update_200_application_json_object: Optional[DeploymentReleasesUpdate200ApplicationJSON] = dataclasses.field(default=None)
    r"""Success"""  
    deployment_releases_update_default_application_json_object: Optional[DeploymentReleasesUpdateDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error"""  
