...
public class InsertRuleHeaders {
    /**
    ...
    public InsertRuleHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public InsertRuleHeaders withContentType(String contentType) {
    ...
    public InsertRuleHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public InsertRuleHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
