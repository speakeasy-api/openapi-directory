...
export enum DescribeMatchmakingRuleSetsXAmzTargetEnum {
  GameLiftDescribeMatchmakingRuleSets = "GameLift.DescribeMatchmakingRuleSets",
}

export class DescribeMatchmakingRuleSetsRequest extends SpeakeasyBase {
...
export class DescribeMatchmakingRuleSetsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
