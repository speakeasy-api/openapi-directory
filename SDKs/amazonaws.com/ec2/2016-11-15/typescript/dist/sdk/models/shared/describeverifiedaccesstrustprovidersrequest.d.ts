 ...
 */
export declare class DescribeVerifiedAccessTrustProvidersRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeVerifiedAccessTrustProvidersRequest extends SpeakeasyBase {
    dryRun?: boolean;
