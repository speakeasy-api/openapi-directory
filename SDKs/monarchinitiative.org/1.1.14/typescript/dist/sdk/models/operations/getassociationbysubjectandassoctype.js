...
exports.GetAssociationBySubjectAndAssocTypeResponse = exports.GetAssociationBySubjectAndAssocTypeRequest = void 0;
...
var GetAssociationBySubjectAndAssocTypeRequest = /** @class */ (function (_super) {
    ...
    ], GetAssociationBySubjectAndAssocTypeRequest.prototype, "associationType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=evidence",
        }),
        __metadata("design:type", String)
    ], GetAssociationBySubjectAndAssocTypeRequest.prototype, "evidence", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=exclude_automatic_assertions",
        }),
        __metadata("design:type", Boolean)
    ], GetAssociationBySubjectAndAssocTypeRequest.prototype, "excludeAutomaticAssertions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=object",
        }),
        __metadata("design:type", String)
    ], GetAssociationBySubjectAndAssocTypeRequest.prototype, "object", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=rows" }),
        __metadata("design:type", Number)
    ], GetAssociationBySubjectAndAssocTypeRequest.prototype, "rows", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=start" }),
        __metadata("design:type", Number)
    ], GetAssociationBySubjectAndAssocTypeRequest.prototype, "start", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=subject",
        }),
        __metadata("design:type", String)
    ], GetAssociationBySubjectAndAssocTypeRequest.prototype, "subject", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=unselect_evidence",
        }),
        __metadata("design:type", Boolean)
    ], GetAssociationBySubjectAndAssocTypeRequest.prototype, "unselectEvidence", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=use_compact_associations",
        }),
        __metadata("design:type", Boolean)
    ], GetAssociationBySubjectAndAssocTypeRequest.prototype, "useCompactAssociations", void 0);
...
var GetAssociationBySubjectAndAssocTypeResponse = /** @class */ (function (_super) {
    ...
    ], GetAssociationBySubjectAndAssocTypeResponse.prototype, "rawResponse", void 0);
