...
var DescribeOrganizationConformancePacksResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: organizationconformancepack_1.OrganizationConformancePack }),
        (0, class_transformer_1.Expose)({ name: "OrganizationConformancePacks" }),
        (0, class_transformer_1.Type)(function () { return organizationconformancepack_1.OrganizationConformancePack; }),
