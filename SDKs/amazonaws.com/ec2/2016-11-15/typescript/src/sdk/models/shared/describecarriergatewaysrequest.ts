 ...
 */
export class DescribeCarrierGatewaysRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeCarrierGatewaysRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: DescribeCarrierGatewaysRequestFilters })
