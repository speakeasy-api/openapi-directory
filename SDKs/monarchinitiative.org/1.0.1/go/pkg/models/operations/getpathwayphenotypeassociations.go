...
type GetPathwayPhenotypeAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetPathwayPhenotypeAssociationsQueryParams struct {
