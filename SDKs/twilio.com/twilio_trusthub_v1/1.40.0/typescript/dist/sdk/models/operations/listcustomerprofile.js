...
exports.ListCustomerProfileResponse = exports.ListCustomerProfileListCustomerProfileResponse = exports.ListCustomerProfileListCustomerProfileResponseMeta = exports.ListCustomerProfileRequest = exports.ListCustomerProfileSecurity = exports.ListCustomerProfileServerList = void 0;
...
var ListCustomerProfileSecurity = /** @class */ (function (_super) {
    ...
    ], ListCustomerProfileSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListCustomerProfileSecurity.prototype, "username", void 0);
...
var ListCustomerProfileRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListCustomerProfileRequest.prototype, "friendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListCustomerProfileRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListCustomerProfileRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListCustomerProfileRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PolicySid",
        }),
        __metadata("design:type", String)
    ], ListCustomerProfileRequest.prototype, "policySid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListCustomerProfileRequest.prototype, "status", void 0);
...
var ListCustomerProfileListCustomerProfileResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListCustomerProfileListCustomerProfileResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.TrusthubV1CustomerProfile }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return shared.TrusthubV1CustomerProfile; }),
...
var ListCustomerProfileResponse = /** @class */ (function (_super) {
    ...
    ], ListCustomerProfileResponse.prototype, "rawResponse", void 0);
