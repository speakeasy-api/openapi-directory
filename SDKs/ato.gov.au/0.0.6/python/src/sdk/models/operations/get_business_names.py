...
@dataclasses.dataclass
class GetBusinessNamesResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    business_names: Optional[list[shared_business_name.BusinessName]] = dataclasses.field(default=None)
    r"""A list of business names was retrieved successfully"""  
