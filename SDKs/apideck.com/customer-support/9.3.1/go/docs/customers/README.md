...
func main() {
    ...
    if res.GetCustomerSupportCustomersResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    if res.DeleteCustomerSupportCustomerResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    if res.GetCustomerSupportCustomerResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    if res.UpdateCustomerSupportCustomerResponse != nil {
        // handle response
    }
}
```
