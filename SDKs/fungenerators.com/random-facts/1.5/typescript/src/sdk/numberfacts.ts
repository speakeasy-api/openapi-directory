...
export class NumberFacts {
  ...
  getFactNumbers(
    ...
    security: operations.GetFactNumbersSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.GetFactNumbersSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetFactNumbersResponse =
        new operations.GetFactNumbersResponse({
