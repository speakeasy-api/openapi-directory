...
public class PrfndSecurity {
    ...
    public PrfndSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public PrfndSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public PrfndSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
