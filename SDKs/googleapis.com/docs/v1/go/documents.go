...
func (s *documents) DocsDocumentsBatchUpdate(ctx context.Context, request operations.DocsDocumentsBatchUpdateRequest, security operations.DocsDocumentsBatchUpdateSecurity) (*operations.DocsDocumentsBatchUpdateResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/documents/{documentId}:batchUpdate", request, nil)
...
func (s *documents) DocsDocumentsGet(ctx context.Context, request operations.DocsDocumentsGetRequest, security operations.DocsDocumentsGetSecurity) (*operations.DocsDocumentsGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/documents/{documentId}", request, nil)
