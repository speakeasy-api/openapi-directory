...
class ComputeNodeEnableSchedulingRequest:
    headers: ComputeNodeEnableSchedulingHeaders = dataclasses.field()
    path_params: ComputeNodeEnableSchedulingPathParams = dataclasses.field()
    query_params: ComputeNodeEnableSchedulingQueryParams = dataclasses.field()
