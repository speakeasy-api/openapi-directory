...
export class RunNamespacesJobsReplaceJobSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunNamespacesJobsReplaceJobRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunNamespacesJobsReplaceJobResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
