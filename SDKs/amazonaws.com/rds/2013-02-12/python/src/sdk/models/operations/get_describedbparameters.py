...
class GetDescribeDbParametersQueryParams:
    action: GetDescribeDbParametersActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDescribeDbParametersVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeDbParametersRequest:
    headers: GetDescribeDbParametersHeaders = dataclasses.field()
    query_params: GetDescribeDbParametersQueryParams = dataclasses.field()
