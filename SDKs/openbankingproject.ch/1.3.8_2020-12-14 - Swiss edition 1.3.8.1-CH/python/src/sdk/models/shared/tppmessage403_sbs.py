...
from ..shared import messagecode403_sbs_enum as shared_messagecode403_sbs_enum
...
class TppMessage403Sbs:
    ...
    code: shared_messagecode403_sbs_enum.MessageCode403SbsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('code') }})
