...
class DescribeExportConfigurationsRequest:
    ...
    describe_export_configurations_request: shared_describeexportconfigurationsrequest.DescribeExportConfigurationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
