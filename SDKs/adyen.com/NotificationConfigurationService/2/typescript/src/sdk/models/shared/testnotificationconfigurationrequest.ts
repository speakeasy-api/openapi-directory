...
export enum TestNotificationConfigurationRequestEventTypesEnum {
...
export class TestNotificationConfigurationRequest extends SpeakeasyBase {
  /**
  ...
  eventTypes?: TestNotificationConfigurationRequestEventTypesEnum[];
