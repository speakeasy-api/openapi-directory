...
class SearchTypeServiceGroupQueryParams:
...
@dataclasses.dataclass
class SearchTypeServiceGroupRequest:
    query_params: SearchTypeServiceGroupQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeServiceGroupResponse:
