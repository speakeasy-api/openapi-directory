...
class PostAccountHolderTransactionListRequest:
    security: PostAccountHolderTransactionListSecurity = dataclasses.field()
...
class PostAccountHolderTransactionListResponse:
    ...
    account_holder_transaction_list_response: Optional[Any] = dataclasses.field(default=None)
