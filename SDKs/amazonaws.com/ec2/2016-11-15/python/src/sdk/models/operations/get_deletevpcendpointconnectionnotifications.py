...
class GETDeleteVpcEndpointConnectionNotificationsRequest:
    ...
    action: GETDeleteVpcEndpointConnectionNotificationsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    connection_notification_id: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'ConnectionNotificationId', 'style': 'form', 'explode': True }})
    r"""The IDs of the notifications."""  
    version: GETDeleteVpcEndpointConnectionNotificationsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
