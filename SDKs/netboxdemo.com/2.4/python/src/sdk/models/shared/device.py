...
class Device:
    ...
    parent_device: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('parent_device'), 'exclude': lambda f: f is None }})  
    ...
    primary_ip: Optional[shared_deviceipaddress.DeviceIPAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('primary_ip'), 'exclude': lambda f: f is None }})  
    primary_ip4: Optional[shared_deviceipaddress.DeviceIPAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('primary_ip4'), 'exclude': lambda f: f is None }})  
    primary_ip6: Optional[shared_deviceipaddress.DeviceIPAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('primary_ip6'), 'exclude': lambda f: f is None }})  
    ...
    virtual_chassis: Optional[shared_devicevirtualchassis.DeviceVirtualChassis] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('virtual_chassis'), 'exclude': lambda f: f is None }})  
