...
func (e PatchSpacesSpaceIDFoldersIDProviderRequestBodyLevelEnum) ToPointer() *PatchSpacesSpaceIDFoldersIDProviderRequestBodyLevelEnum {
	return &e
}
...
func (e *PatchSpacesSpaceIDFoldersIDProviderRequestBodyLevelEnum) UnmarshalJSON(data []byte) error {
	...
	case "regular":
		fallthrough
	case "public":
		*e = PatchSpacesSpaceIDFoldersIDProviderRequestBodyLevelEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PatchSpacesSpaceIDFoldersIDProviderRequestBodyLevelEnum: %v", v)
	}
}
