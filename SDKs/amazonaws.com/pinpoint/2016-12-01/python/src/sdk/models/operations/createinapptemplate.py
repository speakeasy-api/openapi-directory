...
class CreateInAppTemplateRequestBody:
    ...
    in_app_template_request: CreateInAppTemplateRequestBodyInAppTemplateRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InAppTemplateRequest') }})
    r"""InApp Template Request."""  
...
class CreateInAppTemplateRequest:
    ...
    request_body: CreateInAppTemplateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
