...
class RequestCancelWorkflowExecutionRequest:
    ...
    request_cancel_workflow_execution_input: shared_requestcancelworkflowexecutioninput.RequestCancelWorkflowExecutionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
