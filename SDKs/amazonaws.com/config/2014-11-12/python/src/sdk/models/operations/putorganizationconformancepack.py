...
class PutOrganizationConformancePackRequest:
    ...
    put_organization_conformance_pack_request: shared_putorganizationconformancepackrequest.PutOrganizationConformancePackRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class PutOrganizationConformancePackResponse:
    ...
    r"""MaxNumberOfOrganizationConformancePacksExceededException"""  
    ...
    r"""OrganizationConformancePackTemplateValidationException"""  
