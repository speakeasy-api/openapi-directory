...
export class TypeTypeEsriGpserver {
  ...
  searchTypeEsriGpserver(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_esri_gpserver";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeEsriGpserverResponse =
        new operations.SearchTypeEsriGpserverResponse({
