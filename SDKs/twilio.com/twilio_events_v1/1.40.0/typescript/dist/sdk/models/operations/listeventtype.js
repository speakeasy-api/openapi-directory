...
exports.ListEventTypeResponse = exports.ListEventTypeListEventTypeResponse = exports.ListEventTypeListEventTypeResponseMeta = exports.ListEventTypeRequest = exports.ListEventTypeSecurity = exports.ListEventTypeServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListEventTypeServerList = ["https://events.twilio.com"];
var ListEventTypeSecurity = /** @class */ (function (_super) {
    ...
    ], ListEventTypeSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListEventTypeSecurity.prototype, "username", void 0);
...
var ListEventTypeRequest = /** @class */ (function (_super) {
    ...
    ], ListEventTypeRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListEventTypeRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListEventTypeRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SchemaId",
        }),
        __metadata("design:type", String)
    ], ListEventTypeRequest.prototype, "schemaId", void 0);
...
var ListEventTypeListEventTypeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListEventTypeListEventTypeResponseMeta; }),
        __metadata("design:type", ListEventTypeListEventTypeResponseMeta)
    ], ListEventTypeListEventTypeResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.EventsV1EventType }),
        (0, class_transformer_1.Expose)({ name: "types" }),
        (0, class_transformer_1.Type)(function () { return shared.EventsV1EventType; }),
...
var ListEventTypeResponse = /** @class */ (function (_super) {
    ...
    ], ListEventTypeResponse.prototype, "rawResponse", void 0);
