...
type GetVariantDiseaseAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetVariantDiseaseAssociationsQueryParams struct {
