...
func newAdministered(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *administered {
	return &administered{
...
func (s *administered) GetAdministeredIdentitiesMe(ctx context.Context) (*operations.GetAdministeredIdentitiesMeResponse, error) {
	baseURL := s.serverURL
