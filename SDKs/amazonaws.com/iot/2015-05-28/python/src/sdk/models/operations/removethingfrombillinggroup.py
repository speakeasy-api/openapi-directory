...
class RemoveThingFromBillingGroupHeaders:
...
class RemoveThingFromBillingGroupRequest:
    headers: RemoveThingFromBillingGroupHeaders = dataclasses.field()
    request: RemoveThingFromBillingGroupRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class RemoveThingFromBillingGroupResponse:
    ...
    remove_thing_from_billing_group_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
