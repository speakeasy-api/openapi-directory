...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CompanySearchNumber200ApplicationJSON:
...
class CompanySearchNumberResponse:
    ...
    company_search_number_200_application_json_objects: Optional[list[CompanySearchNumber200ApplicationJSON]] = dataclasses.field(default=None)
    r"""List of companies"""  
    company_search_number_default_application_json_object: Optional[CompanySearchNumberDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Detailed information about the error"""  
