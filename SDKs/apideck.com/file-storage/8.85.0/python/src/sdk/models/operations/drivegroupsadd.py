...
class DriveGroupsAddRequest:
    headers: DriveGroupsAddHeaders = dataclasses.field()
    query_params: DriveGroupsAddQueryParams = dataclasses.field()
    request: shared_drivegroup.DriveGroupInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: DriveGroupsAddSecurity = dataclasses.field()
