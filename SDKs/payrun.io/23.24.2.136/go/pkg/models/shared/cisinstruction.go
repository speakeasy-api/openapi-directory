...
func (e CisInstructionCisInstructionPayFrequencyEnum) ToPointer() *CisInstructionCisInstructionPayFrequencyEnum {
	return &e
}
...
func (e *CisInstructionCisInstructionPayFrequencyEnum) UnmarshalJSON(data []byte) error {
	...
	case "Monthly":
		fallthrough
	case "Weekly":
		*e = CisInstructionCisInstructionPayFrequencyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CisInstructionCisInstructionPayFrequencyEnum: %v", v)
	}
}
...
func (e CisInstructionCisInstructionUOMEnum) ToPointer() *CisInstructionCisInstructionUOMEnum {
	return &e
}
...
func (e *CisInstructionCisInstructionUOMEnum) UnmarshalJSON(data []byte) error {
	...
	case "Year":
		fallthrough
	case "Unit":
		*e = CisInstructionCisInstructionUOMEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CisInstructionCisInstructionUOMEnum: %v", v)
	}
}
