...
class CreateSubtaskForTaskRequest:
    ...
    request_body: CreateSubtaskForTaskRequestBodyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The new subtask to create."""  
...
class CreateSubtaskForTask201ApplicationJSON:
    r"""Successfully created the specified subtask."""
