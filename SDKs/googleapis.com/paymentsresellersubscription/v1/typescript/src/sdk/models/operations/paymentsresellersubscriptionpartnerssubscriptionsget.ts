...
export class PaymentsresellersubscriptionPartnersSubscriptionsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class PaymentsresellersubscriptionPartnersSubscriptionsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
