...
class RemoveBgMultipart
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RemoveBgMultipartBgImageFile $bgImageFile
     */
	#[SpeakeasyMetadata('multipartForm:file=true')]
    public ?RemoveBgMultipartBgImageFile $bgImageFile = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RemoveBgMultipartChannelsEnum $channels
     */
	#[SpeakeasyMetadata('multipartForm:name=channels')]
    public ?RemoveBgMultipartChannelsEnum $channels = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RemoveBgMultipartFormatEnum $format
     */
	#[SpeakeasyMetadata('multipartForm:name=format')]
    public ?RemoveBgMultipartFormatEnum $format = null;
    
    /**
     * Source image file (binary). (If this parameter is present, the other image source parameters must be empty.)
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RemoveBgMultipartImageFile $imageFile
     */
	#[SpeakeasyMetadata('multipartForm:file=true')]
    public ?RemoveBgMultipartImageFile $imageFile = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RemoveBgMultipartSizeEnum $size
     */
	#[SpeakeasyMetadata('multipartForm:name=size')]
    public ?RemoveBgMultipartSizeEnum $size = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RemoveBgMultipartTypeEnum $type
     */
	#[SpeakeasyMetadata('multipartForm:name=type')]
    public ?RemoveBgMultipartTypeEnum $type = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RemoveBgMultipartTypeLevelEnum $typeLevel
     */
	#[SpeakeasyMetadata('multipartForm:name=type_level')]
    public ?RemoveBgMultipartTypeLevelEnum $typeLevel = null;
