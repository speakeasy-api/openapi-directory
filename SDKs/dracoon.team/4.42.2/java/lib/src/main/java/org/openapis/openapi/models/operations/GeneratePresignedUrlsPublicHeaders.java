...
public class GeneratePresignedUrlsPublicHeaders {
    /**
    ...
    public GeneratePresignedUrlsPublicHeaders withXSdsDateFormat(GeneratePresignedUrlsPublicXSdsDateFormatEnum xSdsDateFormat) {
