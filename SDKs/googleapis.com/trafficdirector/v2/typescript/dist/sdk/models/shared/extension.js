...
var Extension = /** @class */ (function (_super) {
    ...
    ], Extension.prototype, "category", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=disabled" }),
        __metadata("design:type", Boolean)
    ], Extension.prototype, "disabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], Extension.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=typeDescriptor" }),
        __metadata("design:type", String)
    ], Extension.prototype, "typeDescriptor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=version" }),
        __metadata("design:type", buildversion_1.BuildVersion)
    ], Extension.prototype, "version", void 0);
    return Extension;
