...
exports.GETRetiredObjectDiffUsingGETResponse = exports.GETRetiredObjectDiffUsingGETRequest = void 0;
...
var GETRetiredObjectDiffUsingGETRequest = /** @class */ (function (_super) {
    ...
    ], GETRetiredObjectDiffUsingGETRequest.prototype, "dateFromYYYYMMDD", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=dateToYYYYMMDD",
        }),
        __metadata("design:type", String)
    ], GETRetiredObjectDiffUsingGETRequest.prototype, "dateToYYYYMMDD", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=speciesTypeKey",
        }),
        __metadata("design:type", Number)
    ], GETRetiredObjectDiffUsingGETRequest.prototype, "speciesTypeKey", void 0);
...
var GETRetiredObjectDiffUsingGETResponse = /** @class */ (function (_super) {
    ...
    ], GETRetiredObjectDiffUsingGETResponse.prototype, "rawResponse", void 0);
