...
class GetAPIVVersionMetalsSpotPerformanceRequest:
    path_params: GetAPIVVersionMetalsSpotPerformancePathParams = dataclasses.field()
    query_params: GetAPIVVersionMetalsSpotPerformanceQueryParams = dataclasses.field()
