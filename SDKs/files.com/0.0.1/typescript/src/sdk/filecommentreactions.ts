  ...
  **/
  deleteFileCommentReactionsId(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.DeleteFileCommentReactionsIdResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  postFileCommentReactions(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostFileCommentReactionsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
