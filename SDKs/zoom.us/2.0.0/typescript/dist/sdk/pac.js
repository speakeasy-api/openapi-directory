...
var Pac = /** @class */ (function () {
    function Pac(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Pac.prototype.userPaCs = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UserPaCsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{userId}/pac", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.userPACs200ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
