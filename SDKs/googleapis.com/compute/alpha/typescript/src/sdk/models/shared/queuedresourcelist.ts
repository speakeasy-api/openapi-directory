 ...
 */
export enum QueuedResourceListWarningCodeEnum {
...
export class QueuedResourceListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class QueuedResourceListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: QueuedResourceListWarningData })
  @Expose({ name: "data" })
  @Type(() => QueuedResourceListWarningData)
 ...
 * Successful response
 */
export class QueuedResourceList extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "warning" })
  @Type(() => QueuedResourceListWarning)
