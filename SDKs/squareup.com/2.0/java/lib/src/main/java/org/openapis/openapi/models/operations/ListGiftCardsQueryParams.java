...
public class ListGiftCardsQueryParams {
    /**
    ...
    public ListGiftCardsQueryParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public ListGiftCardsQueryParams withCustomerId(String customerId) {
    ...
    public Long limit;
    public ListGiftCardsQueryParams withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public String state;
    public ListGiftCardsQueryParams withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public String type;
    public ListGiftCardsQueryParams withType(String type) {
        this.type = type;
        return this;
    }
