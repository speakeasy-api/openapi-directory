...
func main() {
    ...
    res, err := s.Orgs.OrgsListAppInstallations(ctx, operations.OrgsListAppInstallationsRequest{
        Org: "animi",
        Page: sdk.Int64(769967),
        PerPage: sdk.Int64(373040),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Orgs.OrgsListForAuthenticatedUser(ctx, operations.OrgsListForAuthenticatedUserRequest{
        Page: sdk.Int64(668234),
        PerPage: sdk.Int64(621666),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Orgs.OrgsListForUser(ctx, operations.OrgsListForUserRequest{
        Page: sdk.Int64(456885),
        PerPage: sdk.Int64(288570),
        Username: "Arvel11",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Orgs.OrgsListMembers(ctx, operations.OrgsListMembersRequest{
        ...
        Role: operations.OrgsListMembersRoleEnumAdmin.ToPointer(),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Orgs.OrgsUpdate(ctx, operations.OrgsUpdateRequest{
        RequestBody: &operations.OrgsUpdateRequestBody{
            ...
            Company: sdk.String("Treutel, Reynolds and Mayer"),
            ...
            Email: sdk.String("Mayra_Larkin@yahoo.com"),
            ...
            TwitterUsername: sdk.String("repudiandae"),
        },
        Org: "accusantium",
    })
    if err != nil {
