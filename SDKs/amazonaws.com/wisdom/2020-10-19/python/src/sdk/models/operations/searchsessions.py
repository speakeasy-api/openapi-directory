...
from ..shared import searchsessionsresponse as shared_searchsessionsresponse
...
class SearchSessionsRequestBody:
    ...
    search_expression: SearchSessionsRequestBodySearchExpression = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('searchExpression') }})
    r"""The search expression."""  
...
class SearchSessionsRequest:
    ...
    request_body: SearchSessionsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class SearchSessionsResponse:
    ...
    search_sessions_response: Optional[shared_searchsessionsresponse.SearchSessionsResponse] = dataclasses.field(default=None)
    r"""Success"""  
