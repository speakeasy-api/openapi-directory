...
export class PutOrganisationsPartyIdElectronicAddressesAddressIdRequest extends SpeakeasyBase {
  /**
...
export class PutOrganisationsPartyIdElectronicAddressesAddressIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
