...
func (e GoogleCloudRetailV2alphaProductAvailabilityEnum) ToPointer() *GoogleCloudRetailV2alphaProductAvailabilityEnum {
	return &e
}

func (e *GoogleCloudRetailV2alphaProductAvailabilityEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "PREORDER":
		fallthrough
	case "BACKORDER":
		*e = GoogleCloudRetailV2alphaProductAvailabilityEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudRetailV2alphaProductAvailabilityEnum: %v", v)
	}
}
...
func (e GoogleCloudRetailV2alphaProductTypeEnum) ToPointer() *GoogleCloudRetailV2alphaProductTypeEnum {
	return &e
}

func (e *GoogleCloudRetailV2alphaProductTypeEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "VARIANT":
		fallthrough
	case "COLLECTION":
		*e = GoogleCloudRetailV2alphaProductTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudRetailV2alphaProductTypeEnum: %v", v)
	}
}
