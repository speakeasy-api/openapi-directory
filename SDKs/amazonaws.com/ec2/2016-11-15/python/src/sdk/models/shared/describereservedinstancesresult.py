...
class DescribeReservedInstancesResultReservedInstancesCurrencyCodeEnum(str, Enum):
    r"""The currency of the Reserved Instance. It's specified using ISO 4217 standard currency codes. At this time, the only supported currency is <code>USD</code>."""
    USD = 'USD'

class DescribeReservedInstancesResultReservedInstancesInstanceTenancyEnum(str, Enum):
    r"""The tenancy of the instance."""
    DEFAULT = 'default'
    DEDICATED = 'dedicated'
    HOST = 'host'

class DescribeReservedInstancesResultReservedInstancesInstanceTypeEnum(str, Enum):
    r"""The instance type on which the Reserved Instance can be used."""
    A1_MEDIUM = 'a1.medium'
    A1_LARGE = 'a1.large'
    A1_XLARGE = 'a1.xlarge'
...
class DescribeReservedInstancesResultReservedInstancesOfferingClassEnum(str, Enum):
    r"""The offering class of the Reserved Instance."""
    STANDARD = 'standard'
    CONVERTIBLE = 'convertible'

class DescribeReservedInstancesResultReservedInstancesOfferingTypeEnum(str, Enum):
    r"""The Reserved Instance offering type."""
...
class DescribeReservedInstancesResultReservedInstancesProductDescriptionEnum(str, Enum):
    r"""The Reserved Instance product platform description."""
    LINUX_UNIX = 'Linux/UNIX'
    LINUX_UNIX_AMAZON_VPC_ = 'Linux/UNIX (Amazon VPC)'
    WINDOWS = 'Windows'
    WINDOWS_AMAZON_VPC_ = 'Windows (Amazon VPC)'

class DescribeReservedInstancesResultReservedInstancesRecurringChargesFrequencyEnum(str, Enum):
    r"""The frequency of the recurring charge."""
    HOURLY = 'Hourly'
...
class DescribeReservedInstancesResultReservedInstancesRecurringCharges:
    ...
    frequency: Optional[DescribeReservedInstancesResultReservedInstancesRecurringChargesFrequencyEnum] = dataclasses.field(default=None)  
    
class DescribeReservedInstancesResultReservedInstancesScopeEnum(str, Enum):
    r"""The scope of the Reserved Instance."""
    AVAILABILITY_ZONE = 'Availability Zone'
    REGION = 'Region'

class DescribeReservedInstancesResultReservedInstancesStateEnum(str, Enum):
    r"""The state of the Reserved Instance purchase."""
...
@dataclasses.dataclass
class DescribeReservedInstancesResultReservedInstancesTags:
    r"""Describes a tag."""
...
class DescribeReservedInstancesResultReservedInstances:
    r"""Describes a Reserved Instance."""
    
    availability_zone: Optional[str] = dataclasses.field(default=None)  
    currency_code: Optional[DescribeReservedInstancesResultReservedInstancesCurrencyCodeEnum] = dataclasses.field(default=None)  
    ...
    instance_tenancy: Optional[DescribeReservedInstancesResultReservedInstancesInstanceTenancyEnum] = dataclasses.field(default=None)  
    instance_type: Optional[DescribeReservedInstancesResultReservedInstancesInstanceTypeEnum] = dataclasses.field(default=None)  
    offering_class: Optional[DescribeReservedInstancesResultReservedInstancesOfferingClassEnum] = dataclasses.field(default=None)  
    offering_type: Optional[DescribeReservedInstancesResultReservedInstancesOfferingTypeEnum] = dataclasses.field(default=None)  
    product_description: Optional[DescribeReservedInstancesResultReservedInstancesProductDescriptionEnum] = dataclasses.field(default=None)  
    recurring_charges: Optional[list[DescribeReservedInstancesResultReservedInstancesRecurringCharges]] = dataclasses.field(default=None)  
    reserved_instances_id: Optional[str] = dataclasses.field(default=None)  
    scope: Optional[DescribeReservedInstancesResultReservedInstancesScopeEnum] = dataclasses.field(default=None)  
    start: Optional[datetime] = dataclasses.field(default=None)  
    state: Optional[DescribeReservedInstancesResultReservedInstancesStateEnum] = dataclasses.field(default=None)  
    tags: Optional[list[DescribeReservedInstancesResultReservedInstancesTags]] = dataclasses.field(default=None)  
    usage_price: Optional[float] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class DescribeReservedInstancesResult:
    r"""Contains the output for DescribeReservedInstances."""
    
    reserved_instances: Optional[list[DescribeReservedInstancesResultReservedInstances]] = dataclasses.field(default=None)  
