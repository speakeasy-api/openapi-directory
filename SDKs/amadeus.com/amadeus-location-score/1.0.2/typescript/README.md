...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/amadeus.com/amadeus-location-score/1.0.2/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/amadeus.com/amadeus-location-score/1.0.2/typescript
```
