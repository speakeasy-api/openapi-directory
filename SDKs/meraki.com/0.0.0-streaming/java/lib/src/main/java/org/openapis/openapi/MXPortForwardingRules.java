...
public class MXPortForwardingRules {
	...
	public MXPortForwardingRules(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
