...
type AppInvitationsCreatePathParams struct {
...
type AppInvitationsCreateRequest struct {
	PathParams AppInvitationsCreatePathParams
	// The email of the user to invite
	Request  *AppInvitationsCreateRequestBody `request:"mediaType=application/json"`
	Security AppInvitationsCreateSecurity
}
