...
func (s *changes) DNSChangesCreate(ctx context.Context, request operations.DNSChangesCreateRequest) (*operations.DNSChangesCreateResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/dns/v1/projects/{project}/managedZones/{managedZone}/changes", request.PathParams, nil)
...
func (s *changes) DNSChangesGet(ctx context.Context, request operations.DNSChangesGetRequest) (*operations.DNSChangesGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/dns/v1/projects/{project}/managedZones/{managedZone}/changes/{changeId}", request.PathParams, nil)
