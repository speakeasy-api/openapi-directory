...
export declare class NetworksecurityProjectsLocationsAddressGroupsCreateSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class NetworksecurityProjectsLocationsAddressGroupsCreateRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class NetworksecurityProjectsLocationsAddressGroupsCreateResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
