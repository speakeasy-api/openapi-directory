...
from ..shared import listincomingtypedlinksresponse as shared_listincomingtypedlinksresponse
...
class ListIncomingTypedLinksRequestBodyFilterTypedLink:
    r"""ListIncomingTypedLinksRequestBodyFilterTypedLink
...
class ListIncomingTypedLinksRequestBodyObjectReference:
    r"""ListIncomingTypedLinksRequestBodyObjectReference
...
class ListIncomingTypedLinksRequestBody:
    object_reference: ListIncomingTypedLinksRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ObjectReference') }})
    consistency_level: Optional[ListIncomingTypedLinksRequestBodyConsistencyLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ConsistencyLevel') }})
    ...
    filter_typed_link: Optional[ListIncomingTypedLinksRequestBodyFilterTypedLink] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('FilterTypedLink') }})
...
class ListIncomingTypedLinksRequest:
    headers: ListIncomingTypedLinksHeaders = dataclasses.field()
    request: ListIncomingTypedLinksRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class ListIncomingTypedLinksResponse:
    ...
    list_incoming_typed_links_response: Optional[shared_listincomingtypedlinksresponse.ListIncomingTypedLinksResponse] = dataclasses.field(default=None)
