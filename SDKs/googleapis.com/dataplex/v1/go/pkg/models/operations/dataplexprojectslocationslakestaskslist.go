...
type DataplexProjectsLocationsLakesTasksListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DataplexProjectsLocationsLakesTasksListPathParams struct {
	// Required. The resource name of the parent lake: projects/{project_number}/locations/{location_id}/lakes/{lake_id}.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type DataplexProjectsLocationsLakesTasksListQueryParams struct {
	// V1 error format.
...
type DataplexProjectsLocationsLakesTasksListRequest struct {
...
type DataplexProjectsLocationsLakesTasksListResponse struct {
	ContentType string
	// Successful response
