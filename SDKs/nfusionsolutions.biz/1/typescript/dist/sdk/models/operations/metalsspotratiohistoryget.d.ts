 ...
 */
export declare enum MetalsSpotRatioHistoryGETFormatEnum {
    Json = "json",
    Xml = "xml"
}
export declare class MetalsSpotRatioHistoryGETRequest extends SpeakeasyBase {
    /**
     ...
     * to override content negotiation specify a value of json or xml
     */
    format?: MetalsSpotRatioHistoryGETFormatEnum;
    /**
...
export declare class MetalsSpotRatioHistoryGETResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    /**
     * Success
