...
class ObjectDeleteBillRunPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectDeleteBillRunHeaders:
...
class ObjectDeleteBillRunRequest:
    headers: ObjectDeleteBillRunHeaders = dataclasses.field()
    path_params: ObjectDeleteBillRunPathParams = dataclasses.field()
