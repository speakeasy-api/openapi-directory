...
type ApigeeregistryProjectsLocationsApisVersionsSpecsDeleteRevisionSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ApigeeregistryProjectsLocationsApisVersionsSpecsDeleteRevisionPathParams struct {
...
type ApigeeregistryProjectsLocationsApisVersionsSpecsDeleteRevisionQueryParams struct {
	// V1 error format.
...
type ApigeeregistryProjectsLocationsApisVersionsSpecsDeleteRevisionRequest struct {
...
type ApigeeregistryProjectsLocationsApisVersionsSpecsDeleteRevisionResponse struct {
	// Successful response
