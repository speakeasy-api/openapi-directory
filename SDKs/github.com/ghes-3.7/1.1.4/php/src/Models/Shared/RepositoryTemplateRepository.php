...
class RepositoryTemplateRepository
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RepositoryTemplateRepositoryMergeCommitMessageEnum $mergeCommitMessage
     */
	#[\JMS\Serializer\Annotation\SerializedName('merge_commit_message')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\RepositoryTemplateRepositoryMergeCommitMessageEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?RepositoryTemplateRepositoryMergeCommitMessageEnum $mergeCommitMessage = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RepositoryTemplateRepositoryMergeCommitTitleEnum $mergeCommitTitle
     */
	#[\JMS\Serializer\Annotation\SerializedName('merge_commit_title')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\RepositoryTemplateRepositoryMergeCommitTitleEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?RepositoryTemplateRepositoryMergeCommitTitleEnum $mergeCommitTitle = null;
     ...
     * - `BLANK` - default to a blank commit message.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RepositoryTemplateRepositorySquashMergeCommitMessageEnum $squashMergeCommitMessage
     */
	#[\JMS\Serializer\Annotation\SerializedName('squash_merge_commit_message')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\RepositoryTemplateRepositorySquashMergeCommitMessageEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?RepositoryTemplateRepositorySquashMergeCommitMessageEnum $squashMergeCommitMessage = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\RepositoryTemplateRepositorySquashMergeCommitTitleEnum $squashMergeCommitTitle
     */
	#[\JMS\Serializer\Annotation\SerializedName('squash_merge_commit_title')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\RepositoryTemplateRepositorySquashMergeCommitTitleEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?RepositoryTemplateRepositorySquashMergeCommitTitleEnum $squashMergeCommitTitle = null;
