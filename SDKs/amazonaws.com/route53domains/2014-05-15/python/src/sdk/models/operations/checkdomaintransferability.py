...
class CheckDomainTransferabilityRequest:
    ...
    check_domain_transferability_request: shared_checkdomaintransferabilityrequest.CheckDomainTransferabilityRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
