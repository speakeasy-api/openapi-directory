...
exports.ListInteractionChannelInviteResponse = exports.ListInteractionChannelInviteListInteractionChannelInviteResponse = exports.ListInteractionChannelInviteListInteractionChannelInviteResponseMeta = exports.ListInteractionChannelInviteRequest = exports.ListInteractionChannelInviteSecurity = exports.ListInteractionChannelInviteServerList = void 0;
...
var ListInteractionChannelInviteSecurity = /** @class */ (function (_super) {
    ...
    ], ListInteractionChannelInviteSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListInteractionChannelInviteSecurity.prototype, "username", void 0);
...
var ListInteractionChannelInviteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListInteractionChannelInviteRequest.prototype, "channelSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=InteractionSid",
        }),
        __metadata("design:type", String)
    ], ListInteractionChannelInviteRequest.prototype, "interactionSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListInteractionChannelInviteRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListInteractionChannelInviteRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListInteractionChannelInviteRequest.prototype, "pageToken", void 0);
...
var ListInteractionChannelInviteListInteractionChannelInviteResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.FlexV1InteractionInteractionChannelInteractionChannelInvite,
        }),
        (0, class_transformer_1.Expose)({ name: "invites" }),
        (0, class_transformer_1.Type)(function () { return shared.FlexV1InteractionInteractionChannelInteractionChannelInvite; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListInteractionChannelInviteListInteractionChannelInviteResponseMeta; }),
...
var ListInteractionChannelInviteResponse = /** @class */ (function (_super) {
    ...
    ], ListInteractionChannelInviteResponse.prototype, "rawResponse", void 0);
