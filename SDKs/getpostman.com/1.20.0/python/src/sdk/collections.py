...
class Collections:
    ...
    def all_collections(self) -> operations.AllCollectionsResponse:
        ...
        res = operations.AllCollectionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.AllCollections200ApplicationJSON])
    ...
    def create_a_fork(self, request: operations.CreateAForkRequest) -> operations.CreateAForkResponse:
        ...
        url = utils.generate_url(operations.CreateAForkRequest, base_url, '/collections/fork/{collection_uid}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "request_body", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.CreateAForkRequest, request)
        ...
        res = operations.CreateAForkResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        

        return res

    def create_collection(self, request: operations.CreateCollectionRequestBody) -> operations.CreateCollectionResponse:
        r"""Create Collection
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.CreateCollection400ApplicationJSON])
    ...
    def delete_collection(self, request: operations.DeleteCollectionRequest) -> operations.DeleteCollectionResponse:
        ...
        url = utils.generate_url(operations.DeleteCollectionRequest, base_url, '/collections/{collection_uid}', request)
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.DeleteCollection404ApplicationJSON])
                res.delete_collection_404_application_json_object = out

        return res

    def merge_a_fork(self, request: operations.MergeAForkRequestBody) -> operations.MergeAForkResponse:
        r"""Merge a Fork
        ...
        res = operations.MergeAForkResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def single_collection(self, request: operations.SingleCollectionRequest) -> operations.SingleCollectionResponse:
        ...
        url = utils.generate_url(operations.SingleCollectionRequest, base_url, '/collections/{collection_uid}', request)
        ...
        res = operations.SingleCollectionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.SingleCollection200ApplicationJSON])
    ...
    def update_collection(self, request: operations.UpdateCollectionRequest) -> operations.UpdateCollectionResponse:
        ...
        url = utils.generate_url(operations.UpdateCollectionRequest, base_url, '/collections/{collection_uid}', request)
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.UpdateCollection400ApplicationJSON])
                res.update_collection_400_application_json_object = out
        elif http_res.status_code == 403:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.UpdateCollection403ApplicationJSON])
                res.update_collection_403_application_json_object = out
        elif http_res.status_code == 404:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.UpdateCollection404ApplicationJSON])
