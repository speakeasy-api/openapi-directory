...
func (e SpotSetTypeListTypeEnum) ToPointer() *SpotSetTypeListTypeEnum {
	return &e
}
...
func (e *SpotSetTypeListTypeEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "list":
		*e = SpotSetTypeListTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SpotSetTypeListTypeEnum: %v", v)
	}
}
