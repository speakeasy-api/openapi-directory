...
from ..shared import updatebaiduchannelresponse as shared_updatebaiduchannelresponse
...
class UpdateBaiduChannelRequestBody:
    baidu_channel_request: UpdateBaiduChannelRequestBodyBaiduChannelRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('BaiduChannelRequest') }})
    

@dataclasses.dataclass
class UpdateBaiduChannelRequest:
    headers: UpdateBaiduChannelHeaders = dataclasses.field()
    path_params: UpdateBaiduChannelPathParams = dataclasses.field()
    request: UpdateBaiduChannelRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateBaiduChannelResponse:
    ...
    update_baidu_channel_response: Optional[shared_updatebaiduchannelresponse.UpdateBaiduChannelResponse] = dataclasses.field(default=None)
