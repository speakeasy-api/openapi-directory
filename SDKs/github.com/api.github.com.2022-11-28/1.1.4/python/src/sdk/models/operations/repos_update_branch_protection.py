...
class ReposUpdateBranchProtectionRequestBodyRequiredPullRequestReviews:
    ...
    r"""Whether the most recent push must be approved by someone other than the person who pushed it. Default: `false`."""  
...
class ReposUpdateBranchProtectionRequestBody:
    ...
    allow_fork_syncing: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('allow_fork_syncing'), 'exclude': lambda f: f is None }})
    r"""Whether users can pull changes from upstream when the branch is locked. Set to `true` to allow fork syncing. Set to `false` to prevent fork syncing. Default: `false`."""  
    ...
    lock_branch: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lock_branch'), 'exclude': lambda f: f is None }})
    r"""Whether to set the branch as read-only. If this is true, users will not be able to push to the branch. Default: `false`."""  
...
class ReposUpdateBranchProtectionRequest:
    ...
    r"""The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/graphql)."""  
