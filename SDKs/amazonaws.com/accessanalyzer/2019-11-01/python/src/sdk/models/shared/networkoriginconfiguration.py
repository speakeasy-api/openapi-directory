...
class NetworkOriginConfiguration:
    ...
    internet_configuration: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('internetConfiguration') }})
