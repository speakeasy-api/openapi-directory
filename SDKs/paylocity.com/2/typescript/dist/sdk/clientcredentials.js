...
var ClientCredentials = /** @class */ (function () {
    function ClientCredentials(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ClientCredentials.prototype.addClientSecret = function (req, config) {
        var _a;
