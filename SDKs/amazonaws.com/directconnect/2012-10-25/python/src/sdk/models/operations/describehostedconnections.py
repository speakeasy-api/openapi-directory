...
class DescribeHostedConnectionsRequest:
    ...
    describe_hosted_connections_request: shared_describehostedconnectionsrequest.DescribeHostedConnectionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
