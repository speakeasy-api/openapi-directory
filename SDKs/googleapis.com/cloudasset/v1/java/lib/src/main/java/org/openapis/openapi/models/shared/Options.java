...
public class Options {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("includeDenyPolicyAnalysis")
    public Boolean includeDenyPolicyAnalysis;

    public Options withIncludeDenyPolicyAnalysis(Boolean includeDenyPolicyAnalysis) {
