...
var Upgrades = /** @class */ (function () {
    function Upgrades(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Get firmware upgrade information for an organization
     */
    Upgrades.prototype.getOrganizationFirmwareUpgrades = function (req, config) {
     ...
     * Get firmware upgrade status for the filtered devices
     */
    Upgrades.prototype.getOrganizationFirmwareUpgradesByDevice = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
