...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/adyen.com/BinLookupService/53/python
```
...
* `post_get3ds_availability` - Check if 3D Secure is available
* `post_get_cost_estimate` - Get a fees cost estimate
