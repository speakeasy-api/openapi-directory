...
export class Certificate {
  ...
  getCertificatePdf(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new shared.CertificateRequest(req);
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.GetCertificatePdfSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetCertificatePdfResponse =
        new operations.GetCertificatePdfResponse({
