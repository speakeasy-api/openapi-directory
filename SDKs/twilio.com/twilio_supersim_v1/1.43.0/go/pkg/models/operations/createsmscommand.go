...
func (e CreateSmsCommandCreateSmsCommandRequestCallbackMethodEnum) ToPointer() *CreateSmsCommandCreateSmsCommandRequestCallbackMethodEnum {
	return &e
}
...
func (e *CreateSmsCommandCreateSmsCommandRequestCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateSmsCommandCreateSmsCommandRequestCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateSmsCommandCreateSmsCommandRequestCallbackMethodEnum: %v", v)
	}
}
