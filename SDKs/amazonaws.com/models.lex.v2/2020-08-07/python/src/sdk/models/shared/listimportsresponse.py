...
class ListImportsResponse:
    ...
    import_summaries: Optional[list[shared_importsummary.ImportSummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('importSummaries') }})
