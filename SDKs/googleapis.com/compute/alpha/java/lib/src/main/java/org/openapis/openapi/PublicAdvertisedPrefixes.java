...
public class PublicAdvertisedPrefixes {
     ...
     */
    public org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesAnnounceResponse computePublicAdvertisedPrefixesAnnounce(org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesAnnounceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesAnnouncePathParams.class, baseUrl, "/projects/{project}/global/publicAdvertisedPrefixes/{publicAdvertisedPrefix}/announce", request.pathParams, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesAnnounceQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesWithdrawResponse computePublicAdvertisedPrefixesWithdraw(org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesWithdrawRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesWithdrawPathParams.class, baseUrl, "/projects/{project}/global/publicAdvertisedPrefixes/{publicAdvertisedPrefix}/withdraw", request.pathParams, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesWithdrawQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
