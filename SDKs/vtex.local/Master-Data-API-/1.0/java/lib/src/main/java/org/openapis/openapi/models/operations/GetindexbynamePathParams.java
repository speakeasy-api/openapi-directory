...
public class GetindexbynamePathParams {
    /**
    ...
    public GetindexbynamePathParams withDataEntityName(String dataEntityName) {
    ...
    public GetindexbynamePathParams withIndexName(String indexName) {
