...
from ..shared import postrevenueschedulebytransactionratablycmtype as shared_postrevenueschedulebytransactionratablycmtype
...
class POSTRSforCreditMemoItemDistributeByDateRangeRequest:
    ...
    post_revenue_schedule_by_transaction_ratably_cm_type: shared_postrevenueschedulebytransactionratablycmtype.POSTRevenueScheduleByTransactionRatablyCMType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
