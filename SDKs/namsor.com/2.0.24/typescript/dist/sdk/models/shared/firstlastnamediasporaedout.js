...
var FirstLastNameDiasporaedOut = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ethnicitiesTop" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ethnicityAlt" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "lifted" }),
    ...
    ], FirstLastNameDiasporaedOut.prototype, "probabilityAltCalibrated", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "probabilityCalibrated" }),
        __metadata("design:type", Number)
    ], FirstLastNameDiasporaedOut.prototype, "probabilityCalibrated", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
