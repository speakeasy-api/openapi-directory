...
from ..shared import profiletokenrequest as shared_profiletokenrequest
...
class GetProfileTokenRequest:
    ...
    profile_token_request: shared_profiletokenrequest.ProfileTokenRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
