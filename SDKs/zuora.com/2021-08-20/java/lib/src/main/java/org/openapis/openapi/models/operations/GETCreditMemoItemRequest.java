...
public class GETCreditMemoItemRequest {
    ...
    public GETCreditMemoItemRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETCreditMemoItemRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETCreditMemoItemRequest withCmitemid(String cmitemid) {
    ...
    public GETCreditMemoItemRequest withCreditMemoId(String creditMemoId) {
    ...
    public GETCreditMemoItemRequest withZuoraVersion(String zuoraVersion) {
