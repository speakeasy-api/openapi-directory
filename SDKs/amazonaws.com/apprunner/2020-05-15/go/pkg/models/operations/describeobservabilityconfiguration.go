...
type DescribeObservabilityConfigurationHeaders struct {
...
type DescribeObservabilityConfigurationRequest struct {
	Headers DescribeObservabilityConfigurationHeaders
	Request shared.DescribeObservabilityConfigurationRequest `request:"mediaType=application/json"`
}
