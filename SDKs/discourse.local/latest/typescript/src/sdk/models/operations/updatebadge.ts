...
export class UpdateBadge200ApplicationJSONBadge extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateBadge200ApplicationJSONBadgeTypes extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "id" })
  id: number;
 ...
 * success response
 */
export class UpdateBadge200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "badge" })
  @Type(() => UpdateBadge200ApplicationJSONBadge)
  badge: UpdateBadge200ApplicationJSONBadge;

  @SpeakeasyMetadata({ elemType: UpdateBadge200ApplicationJSONBadgeTypes })
  @Expose({ name: "badge_types" })
  @Type(() => UpdateBadge200ApplicationJSONBadgeTypes)
