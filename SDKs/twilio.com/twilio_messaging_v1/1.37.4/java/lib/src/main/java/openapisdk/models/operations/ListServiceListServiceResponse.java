...
public class ListServiceListServiceResponse {
    ...
    public openapisdk.models.shared.MessagingV1Service[] services;
    public ListServiceListServiceResponse withServices(openapisdk.models.shared.MessagingV1Service[] services) {
