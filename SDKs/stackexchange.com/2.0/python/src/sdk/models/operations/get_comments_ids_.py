...
class GetCommentsIdsPathParams:
    ids: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ids', 'style': 'simple', 'explode': False }})
    
class GetCommentsIdsOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetCommentsIdsSortEnum(str, Enum):
    CREATION = "creation"
    VOTES = "votes"


@dataclasses.dataclass
class GetCommentsIdsQueryParams:
    ...
    order: Optional[GetCommentsIdsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetCommentsIdsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetCommentsIdsRequest:
    path_params: GetCommentsIdsPathParams = dataclasses.field()
    query_params: GetCommentsIdsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetCommentsIdsResponse:
