...
public class MeetingCreate201ApplicationXMLSettingsLanguageInterpretationInterpreters {
    /**
     * Email address of the interpreter.
     */
    
    public String email;
    public MeetingCreate201ApplicationXMLSettingsLanguageInterpretationInterpreters withEmail(String email) {
        this.email = email;
        return this;
    }
    ...
    public MeetingCreate201ApplicationXMLSettingsLanguageInterpretationInterpreters withLanguages(String languages) {
