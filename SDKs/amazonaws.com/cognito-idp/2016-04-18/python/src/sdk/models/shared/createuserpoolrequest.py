...
class CreateUserPoolRequest:
    r"""Represents the request to create a user pool."""
    ...
    schema: Optional[list[shared_schemaattributetype.SchemaAttributeType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Schema'), 'exclude': lambda f: f is None }})  
