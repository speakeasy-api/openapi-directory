...
public class GetNumbersNodSecurity {
    ...
    public GetNumbersNodSecurity withXMathtoolsApiSecret(String xMathtoolsApiSecret) {
        this.xMathtoolsApiSecret = xMathtoolsApiSecret;
        return this;
    }
    
    public GetNumbersNodSecurity(@JsonProperty("X-Mathtools-Api-Secret") String xMathtoolsApiSecret) {
        this.xMathtoolsApiSecret = xMathtoolsApiSecret;
  }
}
