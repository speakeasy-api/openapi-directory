...
from ..shared import testorderdeliverydetails as shared_testorderdeliverydetails
from ..shared import testorderlineitem as shared_testorderlineitem
from ..shared import testorderpickupdetails as shared_testorderpickupdetails
...
class TestOrder:
    ...
    delivery_details: Optional[shared_testorderdeliverydetails.TestOrderDeliveryDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deliveryDetails'), 'exclude': lambda f: f is None }})  
    ...
    pickup_details: Optional[shared_testorderpickupdetails.TestOrderPickupDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pickupDetails'), 'exclude': lambda f: f is None }})  
    ...
    r"""Required. The billing address. Acceptable values are: - \\"`dwight`\\" - \\"`jim`\\" - \\"`pam`\\" """  
    ...
    predefined_email: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('predefinedEmail'), 'exclude': lambda f: f is None }})
    ...
    r"""Promotions associated with the order."""  
