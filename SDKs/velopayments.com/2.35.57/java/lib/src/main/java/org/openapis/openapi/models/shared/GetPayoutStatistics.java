...
public class GetPayoutStatistics {
    ...
    public GetPayoutStatistics(@JsonProperty("thisMonthFailedPaymentsCount") Long thisMonthFailedPaymentsCount, @JsonProperty("thisMonthPayoutsCount") Long thisMonthPayoutsCount) {
        this.thisMonthFailedPaymentsCount = thisMonthFailedPaymentsCount;
        this.thisMonthPayoutsCount = thisMonthPayoutsCount;
  }
}
