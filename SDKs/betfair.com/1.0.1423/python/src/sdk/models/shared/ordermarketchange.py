...
import dataclasses
from ..shared import orderrunnerchange as shared_orderrunnerchange
...
class OrderMarketChange:
    ...
    r"""Market Id - the id of the market the order is on"""  
    orc: Optional[list[shared_orderrunnerchange.OrderRunnerChange]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('orc'), 'exclude': lambda f: f is None }})
    r"""Order Changes - a list of changes to orders on a selection"""  
