...
func (s *Videos) AddVideoPlaylistVideo(ctx context.Context, request operations.AddVideoPlaylistVideoRequest) (*operations.AddVideoPlaylistVideoResponse, error) {
...
func (s *Videos) GetVideoPlaylistVideos(ctx context.Context, request operations.GetVideoPlaylistVideosRequest) (*operations.GetVideoPlaylistVideosResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/video-playlists/{playlistId}/videos", request.PathParams)
...
func (s *Videos) GetUsersMeSubscriptionsVideos(ctx context.Context, request operations.GetUsersMeSubscriptionsVideosRequest) (*operations.GetUsersMeSubscriptionsVideosResponse, error) {
	baseURL := s._serverURL
...
func (s *Videos) GetUsersMeVideos(ctx context.Context, request operations.GetUsersMeVideosRequest) (*operations.GetUsersMeVideosResponse, error) {
	baseURL := s._serverURL
...
func (s *Videos) GetUsersMeVideosImports(ctx context.Context, request operations.GetUsersMeVideosImportsRequest) (*operations.GetUsersMeVideosImportsResponse, error) {
	baseURL := s._serverURL
