...
class BaseF3PFiling:
    ...
    cash_on_hand_beginning_period: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cash_on_hand_beginning_period') }})
    ...
    debts_owed_to_committee: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('debts_owed_to_committee') }})
    ...
    expenditure_subject_to_limits: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('expenditure_subject_to_limits') }})
    ...
    general_election: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('general_election') }})
    ...
    net_contributions_cycle_to_date: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('net_contributions_cycle_to_date') }})
    net_operating_expenditures_cycle_to_date: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('net_operating_expenditures_cycle_to_date') }})
    ...
    primary_election: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('primary_election') }})
    ...
    subtotal_summary_period: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('subtotal_summary_period') }})
    ...
    treasurer_first_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('treasurer_first_name') }})
    treasurer_last_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('treasurer_last_name') }})
    treasurer_middle_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('treasurer_middle_name') }})
