...
@dataclasses.dataclass
class DisplayvideoFirstAndThirdPartyAudiencesGetQueryParams:
...
class DisplayvideoFirstAndThirdPartyAudiencesGetRequest:
    path_params: DisplayvideoFirstAndThirdPartyAudiencesGetPathParams = dataclasses.field()
    query_params: DisplayvideoFirstAndThirdPartyAudiencesGetQueryParams = dataclasses.field()
    security: DisplayvideoFirstAndThirdPartyAudiencesGetSecurity = dataclasses.field()
