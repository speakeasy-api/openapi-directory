 ...
 */
export declare enum CreateTrafficMirrorTargetRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateTrafficMirrorTargetRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateTrafficMirrorTargetRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateTrafficMirrorTargetRequest extends SpeakeasyBase {
    clientToken?: string;
    description?: string;
    dryRun?: boolean;
