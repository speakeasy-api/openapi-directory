 ...
 *
 */
export class PutDebitMemoTaxItemTypeFinanceInformation extends SpeakeasyBase {
  /**
 ...
 *
 */
export enum PutDebitMemoTaxItemTypeTaxRateTypeEnum {
 ...
 *
 */
export class PutDebitMemoTaxItemType extends SpeakeasyBase {
  /**
