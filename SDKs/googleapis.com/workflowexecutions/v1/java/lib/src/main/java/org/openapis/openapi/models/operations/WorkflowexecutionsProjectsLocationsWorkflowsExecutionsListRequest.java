...
public class WorkflowexecutionsProjectsLocationsWorkflowsExecutionsListRequest {
    ...
    public WorkflowexecutionsProjectsLocationsWorkflowsExecutionsListRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public WorkflowexecutionsProjectsLocationsWorkflowsExecutionsListRequest withOrderBy(String orderBy) {
    ...
    public WorkflowexecutionsProjectsLocationsWorkflowsExecutionsListRequest(@JsonProperty("parent") String parent) {
        this.parent = parent;
  }
}
