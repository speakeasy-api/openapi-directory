...
public class ListCredentialListCredentialResponse {
    ...
    public openapisdk.models.shared.ConversationsV1Credential[] credentials;
    public ListCredentialListCredentialResponse withCredentials(openapisdk.models.shared.ConversationsV1Credential[] credentials) {
