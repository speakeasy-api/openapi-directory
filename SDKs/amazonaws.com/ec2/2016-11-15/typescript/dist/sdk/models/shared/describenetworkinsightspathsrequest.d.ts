 ...
 */
export declare class DescribeNetworkInsightsPathsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeNetworkInsightsPathsRequest extends SpeakeasyBase {
    dryRun?: boolean;
