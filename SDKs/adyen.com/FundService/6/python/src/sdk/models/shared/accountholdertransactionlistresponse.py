...
import dataclasses
from ..shared import accounttransactionlist as shared_accounttransactionlist
...
class AccountHolderTransactionListResponse:
    ...
    account_transaction_lists: Optional[list[shared_accounttransactionlist.AccountTransactionList]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('accountTransactionLists'), 'exclude': lambda f: f is None }})
    r"""A list of the transactions."""  
