...
from ..shared import updatemerchantresponse as shared_updatemerchantresponse
...
class MerchantsUpdateRequest:
    headers: MerchantsUpdateHeaders = dataclasses.field()
    path_params: MerchantsUpdatePathParams = dataclasses.field()
    query_params: MerchantsUpdateQueryParams = dataclasses.field()
    request: shared_merchant.MerchantInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: MerchantsUpdateSecurity = dataclasses.field()
...
class MerchantsUpdateResponse:
    ...
    update_merchant_response: Optional[shared_updatemerchantresponse.UpdateMerchantResponse] = dataclasses.field(default=None)
