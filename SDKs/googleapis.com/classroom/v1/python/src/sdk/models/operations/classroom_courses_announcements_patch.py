...
class ClassroomCoursesAnnouncementsPatchRequest:
    path_params: ClassroomCoursesAnnouncementsPatchPathParams = dataclasses.field()
    query_params: ClassroomCoursesAnnouncementsPatchQueryParams = dataclasses.field()
    security: ClassroomCoursesAnnouncementsPatchSecurity = dataclasses.field()
