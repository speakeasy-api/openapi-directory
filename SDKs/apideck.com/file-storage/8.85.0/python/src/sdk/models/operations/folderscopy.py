...
from ..shared import copyfolderrequest as shared_copyfolderrequest
...
@dataclasses.dataclass
class FoldersCopySecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class FoldersCopyRequest:
    headers: FoldersCopyHeaders = dataclasses.field()
    path_params: FoldersCopyPathParams = dataclasses.field()
    query_params: FoldersCopyQueryParams = dataclasses.field()
    request: shared_copyfolderrequest.CopyFolderRequestInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: FoldersCopySecurity = dataclasses.field()
    

@dataclasses.dataclass
class FoldersCopyResponse:
