...
class AnalyticsManagementWebpropertyUserLinksListRequest:
    ...
    r"""Account ID which the given web property belongs to."""  
    web_property_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'webPropertyId', 'style': 'simple', 'explode': False }})
    r"""Web Property ID for the webProperty-user links to retrieve. Can either be a specific web property ID or '~all', which refers to all the web properties that user has access to."""  
    ...
    r"""The maximum number of webProperty-user Links to include in this response."""  
    ...
    r"""An index of the first webProperty-user link to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter."""  
