...
class InboundAchTransferSimulationResultTransactionTransactionSourceCheckTransferReturn
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultTransactionTransactionSourceCheckTransferReturnReasonEnum $reason
     */
	#[\JMS\Serializer\Annotation\SerializedName('reason')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultTransactionTransactionSourceCheckTransferReturnReasonEnum>')]
    public InboundAchTransferSimulationResultTransactionTransactionSourceCheckTransferReturnReasonEnum $reason;
	...
	{
		$this->fileId = "";
		$this->reason = \OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultTransactionTransactionSourceCheckTransferReturnReasonEnum::MAIL_DELIVERY_FAILURE;
