...
class GetConformancePackComplianceDetailsRequest:
    ...
    get_conformance_pack_compliance_details_request: shared_getconformancepackcompliancedetailsrequest.GetConformancePackComplianceDetailsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
