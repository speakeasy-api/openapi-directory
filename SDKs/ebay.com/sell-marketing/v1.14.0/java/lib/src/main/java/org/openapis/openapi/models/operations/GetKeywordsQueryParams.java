...
public class GetKeywordsQueryParams {
    ...
    public GetKeywordsQueryParams withAdGroupIds(String adGroupIds) {
    ...
    public GetKeywordsQueryParams withKeywordStatus(String keywordStatus) {
    ...
    public String limit;
    public GetKeywordsQueryParams withLimit(String limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetKeywordsQueryParams withOffset(String offset) {
        this.offset = offset;
        return this;
    }
