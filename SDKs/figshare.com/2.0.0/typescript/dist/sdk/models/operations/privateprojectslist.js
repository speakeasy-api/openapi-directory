...
exports.PrivateProjectsListResponse = exports.PrivateProjectsListRequest = exports.PrivateProjectsListStorageEnum = exports.PrivateProjectsListOrderDirectionEnum = exports.PrivateProjectsListOrderEnum = exports.PrivateProjectsListSecurity = void 0;
...
var PrivateProjectsListRequest = /** @class */ (function (_super) {
    ...
    ], PrivateProjectsListRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], PrivateProjectsListRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=order" }),
        __metadata("design:type", String)
    ], PrivateProjectsListRequest.prototype, "order", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=order_direction",
        }),
        __metadata("design:type", String)
    ], PrivateProjectsListRequest.prototype, "orderDirection", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], PrivateProjectsListRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], PrivateProjectsListRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=roles" }),
        __metadata("design:type", String)
    ], PrivateProjectsListRequest.prototype, "roles", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=storage",
        }),
        __metadata("design:type", String)
    ], PrivateProjectsListRequest.prototype, "storage", void 0);
...
var PrivateProjectsListResponse = /** @class */ (function (_super) {
    ...
    ], PrivateProjectsListResponse.prototype, "rawResponse", void 0);
