...
class SearchTypePointWsbbGgpQueryParams:
    ...
    search_type_point_wsbb_ggp_author: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_wsbb_ggp.author', 'style': 'form', 'explode': True }})
    search_type_point_wsbb_ggp_instrument: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_wsbb_ggp.instrument', 'style': 'form', 'explode': True }})
    search_type_point_wsbb_ggp_station: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_wsbb_ggp.station', 'style': 'form', 'explode': True }})
...
class SearchTypePointWsbbGgpRequest:
    query_params: SearchTypePointWsbbGgpQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypePointWsbbGgpResponse:
