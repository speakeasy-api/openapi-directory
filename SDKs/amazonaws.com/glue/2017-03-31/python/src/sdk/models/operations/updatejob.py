...
from ..shared import updatejobresponse as shared_updatejobresponse
...
class UpdateJobResponse:
    ...
    update_job_response: Optional[shared_updatejobresponse.UpdateJobResponse] = dataclasses.field(default=None)
