...
class DeleteAlertPolicyRequest:
    path_params: DeleteAlertPolicyPathParams = dataclasses.field()
...
class DeleteAlertPolicyResponse:
    ...
    delete_alert_policy_401_application_json_object: Optional[DeleteAlertPolicy401ApplicationJSON] = dataclasses.field(default=None)
