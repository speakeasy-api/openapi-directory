...
public class Adexchangebuyer2BiddersFilterSetsBidMetricsListPathParams {
    /**
    ...
    public Adexchangebuyer2BiddersFilterSetsBidMetricsListPathParams withFilterSetName(String filterSetName) {
