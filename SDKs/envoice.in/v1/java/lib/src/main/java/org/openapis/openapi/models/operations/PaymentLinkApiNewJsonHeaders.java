...
public class PaymentLinkApiNewJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PaymentLinkApiNewJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public PaymentLinkApiNewJsonHeaders withXAuthSecret(String xAuthSecret) {
