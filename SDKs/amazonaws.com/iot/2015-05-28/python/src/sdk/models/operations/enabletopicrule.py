...
class EnableTopicRuleRequest:
    headers: EnableTopicRuleHeaders = dataclasses.field()
    path_params: EnableTopicRulePathParams = dataclasses.field()
