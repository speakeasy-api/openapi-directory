...
import org.openapis.openapi.models.operations.IlpmtRequestBody;
import org.openapis.openapi.models.operations.IlpmtRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.IlpmtRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.IlpmtResponse;
import org.openapis.openapi.models.operations.IlpmtSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            IlpmtRequestBody req = new IlpmtRequestBody(IlpmtRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new IlpmtRequestBodyCertificateParameters("Sunil Kumar", "123412341234", "94XXX", "98765XXXXX");;
            ...
            IlpmtResponse res = sdk.apIs.ilpmt(req, new IlpmtSecurity("maiores", "molestiae") {{
