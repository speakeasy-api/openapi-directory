...
class PutDataCatalogEncryptionSettingsRequest:
    ...
    data_catalog_encryption_settings: shared_datacatalogencryptionsettings.DataCatalogEncryptionSettings = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DataCatalogEncryptionSettings') }})  
