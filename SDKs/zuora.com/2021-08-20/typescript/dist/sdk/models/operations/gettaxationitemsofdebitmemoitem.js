...
exports.GETTaxationItemsOfDebitMemoItemResponse = exports.GETTaxationItemsOfDebitMemoItem200ApplicationJSON = exports.GETTaxationItemsOfDebitMemoItemRequest = void 0;
...
var GETTaxationItemsOfDebitMemoItemRequest = /** @class */ (function (_super) {
    ...
    ], GETTaxationItemsOfDebitMemoItemRequest.prototype, "zuoraEntityIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Zuora-Track-Id",
        }),
        __metadata("design:type", String)
    ], GETTaxationItemsOfDebitMemoItemRequest.prototype, "zuoraTrackId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=debitMemoId",
        }),
        __metadata("design:type", String)
    ], GETTaxationItemsOfDebitMemoItemRequest.prototype, "debitMemoId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=dmitemid",
        }),
        __metadata("design:type", String)
    ], GETTaxationItemsOfDebitMemoItemRequest.prototype, "dmitemid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GETTaxationItemsOfDebitMemoItemRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageSize",
        }),
        __metadata("design:type", Number)
    ], GETTaxationItemsOfDebitMemoItemRequest.prototype, "pageSize", void 0);
...
var GETTaxationItemsOfDebitMemoItem200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.GETDMTaxItemTypeNew }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return shared.GETDMTaxItemTypeNew; }),
...
var GETTaxationItemsOfDebitMemoItemResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GETTaxationItemsOfDebitMemoItemResponse.prototype, "rawResponse", void 0);
