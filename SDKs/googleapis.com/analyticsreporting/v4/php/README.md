...
* [analyticsreportingReportsBatchGet](docs/reports/README.md#analyticsreportingreportsbatchget) - Returns the Analytics data.

### [userActivity](docs/useractivity/README.md)

* [analyticsreportingUserActivitySearch](docs/useractivity/README.md#analyticsreportinguseractivitysearch) - Returns User Activity data.
