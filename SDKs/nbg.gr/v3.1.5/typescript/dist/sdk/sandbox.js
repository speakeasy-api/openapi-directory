...
var Sandbox = /** @class */ (function () {
     ...
     * Delete Sandbox
    **/
    Sandbox.prototype.deleteSandboxSandboxId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteSandboxSandboxIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/sandbox/{sandboxId}", req.pathParams);
     ...
     * Export Sandbox
    **/
    Sandbox.prototype.getSandboxSandboxId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.sandbox = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.sandbox = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
     ...
     * Create Sandbox
    **/
    Sandbox.prototype.postSandbox = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Import Sandbox
    **/
    Sandbox.prototype.putSandbox = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
