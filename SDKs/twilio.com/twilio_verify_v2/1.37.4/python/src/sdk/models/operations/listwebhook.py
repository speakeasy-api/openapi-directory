...
class ListWebhookListWebhookResponse:
    ...
    webhooks: Optional[list[shared_verify_v2_service_webhook.VerifyV2ServiceWebhook]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('webhooks') }})
