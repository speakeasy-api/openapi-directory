 ...
 */
export declare enum PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJsonVehicleEngineTypeEnum {
    Combustion = "combustion",
    Electric = "electric"
}
export declare class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJsonRequest extends SpeakeasyBase {
    /**
     ...
     * Engine type of the vehicle.
     */
    vehicleEngineType?: PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJsonVehicleEngineTypeEnum;
    /**
...
export declare class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJsonResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
