...
public class GetTagsTagsInfoRequest {
    ...
    public GetTagsTagsInfoRequest withCallback(String callback) {
    ...
    public GetTagsTagsInfoRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetTagsTagsInfoRequest withFromdate(Long fromdate) {
    ...
    public GetTagsTagsInfoRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetTagsTagsInfoRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetTagsTagsInfoRequest withOrder(GetTagsTagsInfoOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetTagsTagsInfoRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetTagsTagsInfoRequest withPagesize(Long pagesize) {
    ...
    public GetTagsTagsInfoRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetTagsTagsInfoRequest withSort(GetTagsTagsInfoSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetTagsTagsInfoRequest withTags(String tags) {
        this.tags = tags;
        return this;
    }
    ...
    public GetTagsTagsInfoRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetTagsTagsInfoRequest(@JsonProperty("site") String site, @JsonProperty("tags") String tags) {
        this.site = site;
        this.tags = tags;
  }
}
