...
exports.OnDemandEssentials = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var OnDemandEssentials = /** @class */ (function () {
    function OnDemandEssentials(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    OnDemandEssentials.prototype.createVod = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateVodRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{user_id}/ondemand/pages", req.pathParams);
    ...
    **/
    OnDemandEssentials.prototype.createVodAlt1 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateVodAlt1Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/me/ondemand/pages";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    OnDemandEssentials.prototype.deleteVodDraft = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteVodDraftRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ondemand/pages/{ondemand_id}", req.pathParams);
        var client = this._securityClient;
    ...
    **/
    OnDemandEssentials.prototype.editVod = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    OnDemandEssentials.prototype.getUserVods = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    OnDemandEssentials.prototype.getUserVodsAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    OnDemandEssentials.prototype.getVod = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.OnDemandEssentials = OnDemandEssentials;
