...
class UpdateConfigurationSetEventDestinationRequest:
    ...
    r"""The name of the configuration set that contains the event destination that you want to modify."""  
    ...
    r"""The name of the event destination that you want to modify."""  
