...
type ContainerProjectsZonesClustersSetMasterAuthSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContainerProjectsZonesClustersSetMasterAuthPathParams struct {
...
type ContainerProjectsZonesClustersSetMasterAuthQueryParams struct {
	// V1 error format.
...
type ContainerProjectsZonesClustersSetMasterAuthRequest struct {
...
type ContainerProjectsZonesClustersSetMasterAuthResponse struct {
	ContentType string
	// Successful response
