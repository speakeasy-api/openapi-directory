...
class DescribeDimensionKeysRequest:
    ...
    describe_dimension_keys_request: shared_describedimensionkeysrequest.DescribeDimensionKeysRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
