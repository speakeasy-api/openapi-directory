...
export class SDK {
  ...
  **/
  getClip(
  ...
  ): Promise<operations.GetClipResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetClipRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/getClip";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetClipResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.getClipOutput = httpRes?.data;
            }
            break;
          ...
          case httpRes?.status == 484:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.unsupportedStreamMediaTypeException = httpRes?.data;
            }
            break;
          case httpRes?.status == 485:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.missingCodecPrivateDataException = httpRes?.data;
            }
            break;
          case httpRes?.status == 486:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.invalidCodecPrivateDataException = httpRes?.data;
            }
            break;
          case httpRes?.status == 487:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.invalidMediaFrameException = httpRes?.data;
            }
            break;
  ...
  **/
  getDashStreamingSessionUrl(
    req: operations.GetDashStreamingSessionUrlRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetDashStreamingSessionUrlResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetDashStreamingSessionUrlRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/getDASHStreamingSessionURL";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetDashStreamingSessionUrlResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.getDASHStreamingSessionURLOutput = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  getHlsStreamingSessionUrl(
    req: operations.GetHlsStreamingSessionUrlRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetHlsStreamingSessionUrlResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetHlsStreamingSessionUrlRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/getHLSStreamingSessionURL";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetHlsStreamingSessionUrlResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.getHLSStreamingSessionURLOutput = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  getMediaForFragmentList(
    req: operations.GetMediaForFragmentListRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetMediaForFragmentListResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetMediaForFragmentListRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/getMediaForFragmentList";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetMediaForFragmentListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.getMediaForFragmentListOutput = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  listFragments(
    req: operations.ListFragmentsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ListFragmentsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ListFragmentsRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/listFragments";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ListFragmentsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.listFragmentsOutput = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.matchContentType(contentType, `application/json`)) {
