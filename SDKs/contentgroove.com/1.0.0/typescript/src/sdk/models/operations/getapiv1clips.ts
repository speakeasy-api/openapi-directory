...
export class GetApiV1ClipsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum GetApiV1ClipsSortEnum {
...
export class GetApiV1ClipsRequest extends SpeakeasyBase {
  /**
...
export class GetApiV1ClipsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
