...
class BatchGetViewResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\BatchGetViewOutput $batchGetViewOutput
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\BatchGetViewOutput $batchGetViewOutput = null;
