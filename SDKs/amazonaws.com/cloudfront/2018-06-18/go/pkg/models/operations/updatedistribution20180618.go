...
type UpdateDistribution20180618PathParams struct {
	// The distribution's id.
	ID string `pathParam:"style=simple,explode=false,name=Id"`
}

type UpdateDistribution20180618Headers struct {
...
type UpdateDistribution20180618RequestBodyDistributionConfig struct {
...
type UpdateDistribution20180618RequestBody struct {
	// A distribution configuration.
	DistributionConfig UpdateDistribution20180618RequestBodyDistributionConfig
}

type UpdateDistribution20180618Request struct {
	PathParams UpdateDistribution20180618PathParams
	Headers    UpdateDistribution20180618Headers
	Request    []byte `request:"mediaType=text/xml"`
}

type UpdateDistribution20180618Response struct {
	Body        []byte
	ContentType string
	StatusCode  int
