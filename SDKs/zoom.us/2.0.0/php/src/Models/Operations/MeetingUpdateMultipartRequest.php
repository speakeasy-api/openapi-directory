...
class MeetingUpdateMultipartRequest
{
     ...
     * Meeting
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\MeetingUpdateMultipartFormData3 $requestBody
     */
	...
	{
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\MeetingUpdateMultipartFormData3();
		$this->meetingId = 0;
