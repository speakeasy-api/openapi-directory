...
class AndroidpublisherEditsImagesUploadRequest:
    ...
    r"""Language localization code (a BCP-47 language tag; for example, \\"de-AT\\" for Austrian German). Providing a language that is not supported by the App is a no-op."""  
