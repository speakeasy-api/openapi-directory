...
public class POSTRevenueScheduleByDateRangeTypeRevenueEvent {
    ...
    public POSTRevenueScheduleByDateRangeTypeRevenueEventEventTypeEnum eventType;
    public POSTRevenueScheduleByDateRangeTypeRevenueEvent withEventType(POSTRevenueScheduleByDateRangeTypeRevenueEventEventTypeEnum eventType) {
    ...
    public POSTRevenueScheduleByDateRangeTypeRevenueEvent withEventTypeSystemId(String eventTypeSystemId) {
    ...
    @JsonProperty("notes")
    public String notes;
    public POSTRevenueScheduleByDateRangeTypeRevenueEvent withNotes(String notes) {
        this.notes = notes;
        return this;
    }
