...
export class DemilestonedIssueEventMilestone extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "title" })
  title: string;
}
 ...
 */
export class DemilestonedIssueEvent extends SpeakeasyBase {
  /**
   * Simple User
   */
  @SpeakeasyMetadata()
  ...
  @Type(() => DemilestonedIssueEventMilestone)
