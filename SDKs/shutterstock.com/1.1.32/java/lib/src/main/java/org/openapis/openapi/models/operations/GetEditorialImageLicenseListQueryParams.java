...
public class GetEditorialImageLicenseListQueryParams {
    ...
    public GetEditorialImageLicenseListQueryParams withDownloadAvailability(GetEditorialImageLicenseListDownloadAvailabilityEnum downloadAvailability) {
    ...
    public GetEditorialImageLicenseListQueryParams withTeamHistory(Boolean teamHistory) {
