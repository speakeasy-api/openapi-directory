...
export class DatalineageProjectsLocationsProcessesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatalineageProjectsLocationsProcessesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatalineageProjectsLocationsProcessesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
