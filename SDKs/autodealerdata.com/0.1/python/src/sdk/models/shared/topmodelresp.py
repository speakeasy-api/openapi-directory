...
from ..shared import topmodelentry as shared_topmodelentry


@dataclass_json
@dataclasses.dataclass
class TopModelResp:
    data: list[shared_topmodelentry.TopModelEntry] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
