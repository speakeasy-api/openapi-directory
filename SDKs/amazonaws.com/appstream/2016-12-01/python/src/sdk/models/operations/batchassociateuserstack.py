...
class BatchAssociateUserStackRequest:
    ...
    batch_associate_user_stack_request: shared_batchassociateuserstackrequest.BatchAssociateUserStackRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
