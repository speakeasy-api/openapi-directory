...
type GETReceiveMessageAttributeNamesEnum string

const (
	GETReceiveMessageAttributeNamesEnumAll                                   GETReceiveMessageAttributeNamesEnum = "All"
	GETReceiveMessageAttributeNamesEnumPolicy                                GETReceiveMessageAttributeNamesEnum = "Policy"
	GETReceiveMessageAttributeNamesEnumVisibilityTimeout                     GETReceiveMessageAttributeNamesEnum = "VisibilityTimeout"
	GETReceiveMessageAttributeNamesEnumMaximumMessageSize                    GETReceiveMessageAttributeNamesEnum = "MaximumMessageSize"
	GETReceiveMessageAttributeNamesEnumMessageRetentionPeriod                GETReceiveMessageAttributeNamesEnum = "MessageRetentionPeriod"
	GETReceiveMessageAttributeNamesEnumApproximateNumberOfMessages           GETReceiveMessageAttributeNamesEnum = "ApproximateNumberOfMessages"
	GETReceiveMessageAttributeNamesEnumApproximateNumberOfMessagesNotVisible GETReceiveMessageAttributeNamesEnum = "ApproximateNumberOfMessagesNotVisible"
	GETReceiveMessageAttributeNamesEnumCreatedTimestamp                      GETReceiveMessageAttributeNamesEnum = "CreatedTimestamp"
	GETReceiveMessageAttributeNamesEnumLastModifiedTimestamp                 GETReceiveMessageAttributeNamesEnum = "LastModifiedTimestamp"
	GETReceiveMessageAttributeNamesEnumQueueArn                              GETReceiveMessageAttributeNamesEnum = "QueueArn"
	GETReceiveMessageAttributeNamesEnumApproximateNumberOfMessagesDelayed    GETReceiveMessageAttributeNamesEnum = "ApproximateNumberOfMessagesDelayed"
	GETReceiveMessageAttributeNamesEnumDelaySeconds                          GETReceiveMessageAttributeNamesEnum = "DelaySeconds"
	GETReceiveMessageAttributeNamesEnumReceiveMessageWaitTimeSeconds         GETReceiveMessageAttributeNamesEnum = "ReceiveMessageWaitTimeSeconds"
	GETReceiveMessageAttributeNamesEnumRedrivePolicy                         GETReceiveMessageAttributeNamesEnum = "RedrivePolicy"
	GETReceiveMessageAttributeNamesEnumFifoQueue                             GETReceiveMessageAttributeNamesEnum = "FifoQueue"
	GETReceiveMessageAttributeNamesEnumContentBasedDeduplication             GETReceiveMessageAttributeNamesEnum = "ContentBasedDeduplication"
	GETReceiveMessageAttributeNamesEnumKmsMasterKeyID                        GETReceiveMessageAttributeNamesEnum = "KmsMasterKeyId"
	GETReceiveMessageAttributeNamesEnumKmsDataKeyReusePeriodSeconds          GETReceiveMessageAttributeNamesEnum = "KmsDataKeyReusePeriodSeconds"
	GETReceiveMessageAttributeNamesEnumDeduplicationScope                    GETReceiveMessageAttributeNamesEnum = "DeduplicationScope"
	GETReceiveMessageAttributeNamesEnumFifoThroughputLimit                   GETReceiveMessageAttributeNamesEnum = "FifoThroughputLimit"
	GETReceiveMessageAttributeNamesEnumRedriveAllowPolicy                    GETReceiveMessageAttributeNamesEnum = "RedriveAllowPolicy"
...
type GETReceiveMessageRequest struct {
	...
	AttributeNames []GETReceiveMessageAttributeNamesEnum `queryParam:"style=form,explode=true,name=AttributeNames"`
