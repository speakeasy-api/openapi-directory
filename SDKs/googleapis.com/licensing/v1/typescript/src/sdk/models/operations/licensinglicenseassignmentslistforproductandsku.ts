...
export class LicensingLicenseAssignmentsListForProductAndSkuSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class LicensingLicenseAssignmentsListForProductAndSkuRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class LicensingLicenseAssignmentsListForProductAndSkuResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
