...
func (e *CreateEntityResponseTypeStatusEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Provisioned":
		fallthrough
	case "Unprovisioned":
		*e = CreateEntityResponseTypeStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateEntityResponseTypeStatusEnum: %s", s)
	}
}
