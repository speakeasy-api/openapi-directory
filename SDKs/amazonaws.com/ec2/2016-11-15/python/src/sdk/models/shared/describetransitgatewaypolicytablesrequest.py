...
class DescribeTransitGatewayPolicyTablesRequest:
    ...
    filters: Optional[list[DescribeTransitGatewayPolicyTablesRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    transit_gateway_policy_table_ids: Optional[list[str]] = dataclasses.field(default=None)  
