 ...
 */
public enum ReposUpdateInformationAboutPagesSiteRequestBody3Source2PathEnum {
    ROOT("/"),
    ROOT_DOCS("/docs");
    ...
    private ReposUpdateInformationAboutPagesSiteRequestBody3Source2PathEnum(String value) {
        this.value = value;
    }
}
