...
const (
	TagResourceXAmzTargetEnumAwsKendraRerankingFrontendServiceTagResource TagResourceXAmzTargetEnum = "AWSKendraRerankingFrontendService.TagResource"
)
...
func (e *TagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AWSKendraRerankingFrontendService.TagResource":
