 ...
 */
export declare enum CustomFieldResponseAsanaCreatedFieldEnum {
 ...
 */
export declare class CustomFieldResponseDateValue extends SpeakeasyBase {
    /**
...
export declare class CustomFieldResponse extends SpeakeasyBase {
     ...
     * *Conditional*. A unique identifier to associate this field with the template source of truth.
     */
    asanaCreatedField?: CustomFieldResponseAsanaCreatedFieldEnum;
