...
from ..shared import robotdeployment as shared_robotdeployment
...
class DescribeDeploymentJobResponse:
    ...
    robot_deployment_summary: Optional[list[shared_robotdeployment.RobotDeployment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('robotDeploymentSummary') }})
