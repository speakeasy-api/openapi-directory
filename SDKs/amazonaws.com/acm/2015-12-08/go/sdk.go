...
func (s *SDK) AddTagsToCertificate(ctx context.Context, request operations.AddTagsToCertificateRequest) (*operations.AddTagsToCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.AddTagsToCertificate"
	...
	res := &operations.AddTagsToCertificateResponse{
...
func (s *SDK) DeleteCertificate(ctx context.Context, request operations.DeleteCertificateRequest) (*operations.DeleteCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.DeleteCertificate"
...
func (s *SDK) DescribeCertificate(ctx context.Context, request operations.DescribeCertificateRequest) (*operations.DescribeCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.DescribeCertificate"
...
func (s *SDK) ExportCertificate(ctx context.Context, request operations.ExportCertificateRequest) (*operations.ExportCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.ExportCertificate"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ExportCertificateResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetAccountConfiguration(ctx context.Context, request operations.GetAccountConfigurationRequest) (*operations.GetAccountConfigurationResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.GetAccountConfiguration"
	...
	res := &operations.GetAccountConfigurationResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetAccountConfigurationResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetCertificate(ctx context.Context, request operations.GetCertificateRequest) (*operations.GetCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.GetCertificate"
...
func (s *SDK) ImportCertificate(ctx context.Context, request operations.ImportCertificateRequest) (*operations.ImportCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.ImportCertificate"
...
func (s *SDK) ListCertificates(ctx context.Context, request operations.ListCertificatesRequest) (*operations.ListCertificatesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.ListCertificates"
...
func (s *SDK) ListTagsForCertificate(ctx context.Context, request operations.ListTagsForCertificateRequest) (*operations.ListTagsForCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.ListTagsForCertificate"
	...
	res := &operations.ListTagsForCertificateResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListTagsForCertificateResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) PutAccountConfiguration(ctx context.Context, request operations.PutAccountConfigurationRequest) (*operations.PutAccountConfigurationResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.PutAccountConfiguration"
	...
	res := &operations.PutAccountConfigurationResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) RemoveTagsFromCertificate(ctx context.Context, request operations.RemoveTagsFromCertificateRequest) (*operations.RemoveTagsFromCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.RemoveTagsFromCertificate"
	...
	res := &operations.RemoveTagsFromCertificateResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) RenewCertificate(ctx context.Context, request operations.RenewCertificateRequest) (*operations.RenewCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.RenewCertificate"
	...
	res := &operations.RenewCertificateResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) RequestCertificate(ctx context.Context, request operations.RequestCertificateRequest) (*operations.RequestCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.RequestCertificate"
	...
	res := &operations.RequestCertificateResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.RequestCertificateResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ResendValidationEmail(ctx context.Context, request operations.ResendValidationEmailRequest) (*operations.ResendValidationEmailResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.ResendValidationEmail"
	...
	res := &operations.ResendValidationEmailResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) UpdateCertificateOptions(ctx context.Context, request operations.UpdateCertificateOptionsRequest) (*operations.UpdateCertificateOptionsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=CertificateManager.UpdateCertificateOptions"
	...
	res := &operations.UpdateCertificateOptionsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
