...
export class DatastreamProjectsLocationsConnectionProfilesDiscoverSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatastreamProjectsLocationsConnectionProfilesDiscoverRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatastreamProjectsLocationsConnectionProfilesDiscoverResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
