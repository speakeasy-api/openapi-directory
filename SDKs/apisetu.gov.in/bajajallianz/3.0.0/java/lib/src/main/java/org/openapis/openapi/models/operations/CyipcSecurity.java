...
public class CyipcSecurity {
    ...
    public CyipcSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public CyipcSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public CyipcSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
