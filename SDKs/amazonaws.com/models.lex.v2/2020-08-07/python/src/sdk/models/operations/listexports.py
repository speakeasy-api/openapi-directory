...
class ListExportsRequestBodySortBy:
    ...
    attribute: Optional[shared_exportsortattribute_enum.ExportSortAttributeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attribute') }})
...
class ListExportsRequestBody:
    ...
    sort_by: Optional[ListExportsRequestBodySortBy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sortBy') }})
    

@dataclasses.dataclass
class ListExportsRequest:
    headers: ListExportsHeaders = dataclasses.field()
    query_params: ListExportsQueryParams = dataclasses.field()
    request: ListExportsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
