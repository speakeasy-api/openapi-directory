...
export class GkebackupProjectsLocationsRestorePlansRestoresDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsRestorePlansRestoresDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsRestorePlansRestoresDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
