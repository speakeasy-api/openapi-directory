...
public class GetRecordsQueryParams {
    ...
    public GetRecordsQueryParams withIncludeMessage(GetRecordsIncludeMessageEnum includeMessage) {
    ...
    public GetRecordsQueryParams withShowConcatenated(GetRecordsShowConcatenatedEnum showConcatenated) {
