...
class SecuritycenterOrganizationsSourcesFindingsUpdateSecurityMarksRequest:
    ...
    google_cloud_securitycenter_v1beta1_security_marks: Optional[shared_googlecloudsecuritycenterv1beta1securitymarks.GoogleCloudSecuritycenterV1beta1SecurityMarks] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    ...
    r"""The time at which the updated SecurityMarks take effect."""  
    ...
    r"""The FieldMask to use when updating the security marks resource."""  
