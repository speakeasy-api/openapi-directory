...
import { InstantSnapshotsScopedList } from "./instantsnapshotsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum InstantSnapshotAggregatedListWarningCodeEnum {
...
export declare class InstantSnapshotAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InstantSnapshotAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InstantSnapshotAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InstantSnapshotAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class InstantSnapshotAggregatedList extends SpeakeasyBase {
    /**
     ...
     */
    items?: Record<string, InstantSnapshotsScopedList>;
    /**
     ...
     * [Output Only] Informational warning message.
     */
    warning?: InstantSnapshotAggregatedListWarning;
}
