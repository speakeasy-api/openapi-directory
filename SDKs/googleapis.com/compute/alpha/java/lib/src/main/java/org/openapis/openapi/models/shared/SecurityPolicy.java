...
public class SecurityPolicy {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("cloudArmorConfig")
    public SecurityPolicyCloudArmorConfig cloudArmorConfig;

    public SecurityPolicy withCloudArmorConfig(SecurityPolicyCloudArmorConfig cloudArmorConfig) {
    ...
    public SecurityPolicyUserDefinedField[] userDefinedFields;

    public SecurityPolicy withUserDefinedFields(SecurityPolicyUserDefinedField[] userDefinedFields) {
