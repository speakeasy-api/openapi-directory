...
class GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDDiffstatRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDDiffstatPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDDiffstatSecurity = dataclasses.field()
