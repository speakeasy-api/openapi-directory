...
public class UpdateNetworkApplianceFirewallInboundFirewallRulesRequestBodyRules {
    ...
    public UpdateNetworkApplianceFirewallInboundFirewallRulesRequestBodyRules(@JsonProperty("destCidr") String destCidr, @JsonProperty("policy") UpdateNetworkApplianceFirewallInboundFirewallRulesRequestBodyRulesPolicyEnum policy, @JsonProperty("protocol") UpdateNetworkApplianceFirewallInboundFirewallRulesRequestBodyRulesProtocolEnum protocol, @JsonProperty("srcCidr") String srcCidr) {
        this.destCidr = destCidr;
        this.policy = policy;
        this.protocol = protocol;
        this.srcCidr = srcCidr;
