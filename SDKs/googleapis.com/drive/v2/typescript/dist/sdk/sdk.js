...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.children = new children_1.Children(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.parents = new parents_1.Parents(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
