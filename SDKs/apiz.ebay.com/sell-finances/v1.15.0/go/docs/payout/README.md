...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Payout.GetPayoutSummary(ctx, operations.GetPayoutSummaryRequest{
        XEbayCMarketplaceID: sdk.String("unde"),
        Filter: sdk.String("nulla"),
    }, operations.GetPayoutSummarySecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
    ...
    if res.PayoutSummaryResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Payout.GetPayouts(ctx, operations.GetPayoutsRequest{
        XEbayCMarketplaceID: sdk.String("corrupti"),
        Filter: sdk.String("illum"),
        Limit: sdk.String("vel"),
        Offset: sdk.String("error"),
        Sort: sdk.String("deserunt"),
    }, operations.GetPayoutsSecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
