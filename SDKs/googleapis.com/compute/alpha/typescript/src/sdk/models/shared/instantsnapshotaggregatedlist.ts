 ...
 */
export enum InstantSnapshotAggregatedListWarningCodeEnum {
...
export class InstantSnapshotAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstantSnapshotAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstantSnapshotAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class InstantSnapshotAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: InstantSnapshotsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, InstantSnapshotsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], InstantSnapshotsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
