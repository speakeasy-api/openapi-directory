...
class IPMessagingV2ServiceUserUserBinding:
    ...
    binding_type: Optional[shared_user_binding_enum_binding_type_enum.UserBindingEnumBindingTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('binding_type') }})
