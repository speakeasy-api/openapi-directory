...
from ..shared import ukrvsearchresponse as shared_ukrvsearchresponse
...
class GetSearchRvUkActiveRequest:
    ...
    availability_status: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'availability_status', 'style': 'form', 'explode': True }})
    r"""To filter rv on their availability_status"""  
    ...
    berths: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'berths', 'style': 'form', 'explode': True }})
    r"""To filter rv on their berths"""  
    category: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'category', 'style': 'form', 'explode': True }})
    r"""Filter RV listings on category"""  
    chassis: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'chassis', 'style': 'form', 'explode': True }})
    r"""To filter rv on their chassis"""  
    ...
    drive_type: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'drive_type', 'style': 'form', 'explode': True }})
    r"""To filter rv on their drive_type"""  
    ...
    exterior_length_range: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'exterior_length_range', 'style': 'form', 'explode': True }})
    r"""width range to filter listings on exterior_length in the range given. Range to be given in the format - min-max e.g. 4-8"""  
    ...
    interior_length_range: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'interior_length_range', 'style': 'form', 'explode': True }})
    r"""width range to filter listings on interior_length in the range given. Range to be given in the format - min-max e.g. 4-8"""  
    ...
    mtplm: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'mtplm', 'style': 'form', 'explode': True }})
    r"""To filter rv on mtplm"""  
    ...
    steering: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'steering', 'style': 'form', 'explode': True }})
    r"""To filter rv on their steering"""  
    ...
    r"""To filter rv on their sub-category"""  
    ...
    width_range: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'width_range', 'style': 'form', 'explode': True }})
    r"""width range to filter listings on width in the range given. Range to be given in the format - min-max e.g. 4-8"""  
...
class GetSearchRvUkActiveResponse:
    ...
    ukrv_search_response: Optional[shared_ukrvsearchresponse.UKRVSearchResponse] = dataclasses.field(default=None)
