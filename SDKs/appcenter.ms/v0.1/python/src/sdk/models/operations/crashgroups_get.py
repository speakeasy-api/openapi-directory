...
@dataclasses.dataclass
class CrashGroupsGetDefaultApplicationJSON:
    r"""Error"""
    
    message: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message') }})  
    
class CrashGroupsGet200ApplicationJSONReasonFrameLanguageEnum(str, Enum):
...
class CrashGroupsGet200ApplicationJSONReasonFrame:
    ...
    language: Optional[CrashGroupsGet200ApplicationJSONReasonFrameLanguageEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('language'), 'exclude': lambda f: f is None }})
    r"""programming language of the frame"""  
...
class CrashGroupsGet200ApplicationJSONStatusEnum(str, Enum):
    OPEN = 'open'
    CLOSED = 'closed'
    IGNORED = 'ignored'
...
class CrashGroupsGet200ApplicationJSON:
    ...
    status: CrashGroupsGet200ApplicationJSONStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
    ...
    reason_frame: Optional[CrashGroupsGet200ApplicationJSONReasonFrame] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason_frame'), 'exclude': lambda f: f is None }})
    r"""frame belonging to the reason of the crash"""  
...
class CrashGroupsGetResponse:
    ...
    crash_groups_get_200_application_json_object: Optional[CrashGroupsGet200ApplicationJSON] = dataclasses.field(default=None)
    r"""Success"""  
    crash_groups_get_default_application_json_object: Optional[CrashGroupsGetDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error"""  
