...
class PostMarketingV3MarketingEventsEventsExternalEventIDCompleteCompleteRequest:
    ...
    marketing_event_complete_request_params: shared_marketingeventcompleterequestparams.MarketingEventCompleteRequestParams = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
