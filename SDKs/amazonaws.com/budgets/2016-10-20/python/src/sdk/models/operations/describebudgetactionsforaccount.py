...
class DescribeBudgetActionsForAccountRequest:
    ...
    describe_budget_actions_for_account_request: shared_describebudgetactionsforaccountrequest.DescribeBudgetActionsForAccountRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
