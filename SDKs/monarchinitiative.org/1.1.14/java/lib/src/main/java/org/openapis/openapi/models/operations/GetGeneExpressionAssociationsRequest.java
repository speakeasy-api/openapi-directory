...
public class GetGeneExpressionAssociationsRequest {
    ...
    public GetGeneExpressionAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGeneExpressionAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGeneExpressionAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGeneExpressionAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGeneExpressionAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGeneExpressionAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGeneExpressionAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGeneExpressionAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGeneExpressionAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGeneExpressionAssociationsRequest withRelation(String relation) {
    ...
    public GetGeneExpressionAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGeneExpressionAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGeneExpressionAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetGeneExpressionAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGeneExpressionAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGeneExpressionAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGeneExpressionAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGeneExpressionAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
