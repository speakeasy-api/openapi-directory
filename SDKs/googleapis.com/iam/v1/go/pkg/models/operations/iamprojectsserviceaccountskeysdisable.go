...
type IamProjectsServiceAccountsKeysDisableSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type IamProjectsServiceAccountsKeysDisablePathParams struct {
...
type IamProjectsServiceAccountsKeysDisableQueryParams struct {
	// V1 error format.
...
type IamProjectsServiceAccountsKeysDisableRequest struct {
...
type IamProjectsServiceAccountsKeysDisableResponse struct {
	ContentType string
	// Successful response
