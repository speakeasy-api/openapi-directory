...
public class BalanceSheet {
	...
	public BalanceSheet(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
     ...
     */
    public org.openapis.openapi.models.operations.BalanceSheetOneResponse balanceSheetOne(org.openapis.openapi.models.operations.BalanceSheetOneRequest request, org.openapis.openapi.models.operations.BalanceSheetOneSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/accounting/balance-sheet");
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.BalanceSheetOneRequest.class, request, null);
        if (queryParams != null) {
        ...
        org.openapis.openapi.models.operations.BalanceSheetOneResponse res = new org.openapis.openapi.models.operations.BalanceSheetOneResponse(contentType, httpRes.statusCode()) {{
            getBalanceSheetResponse = null;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.GetBalanceSheetResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.GetBalanceSheetResponse.class);
