...
var Federation = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: backendmetastore_1.BackendMetastore }),
        (0, class_transformer_1.Expose)({ name: "backendMetastores" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], backendmetastore_1.BackendMetastore);
            }
            return obj;
        }, { toClassOnly: true }),
