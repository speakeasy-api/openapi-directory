...
class ObjectPostRefundQueryParams:
...
class ObjectPostRefundRequest:
    headers: ObjectPostRefundHeaders = dataclasses.field()
    query_params: ObjectPostRefundQueryParams = dataclasses.field()
