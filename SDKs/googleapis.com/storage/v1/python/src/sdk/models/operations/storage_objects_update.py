...
class StorageObjectsUpdatePredefinedACLEnum(str, Enum):
...
class StorageObjectsUpdateQueryParams:
    ...
    predefined_acl: Optional[StorageObjectsUpdatePredefinedACLEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'predefinedAcl', 'style': 'form', 'explode': True }})
