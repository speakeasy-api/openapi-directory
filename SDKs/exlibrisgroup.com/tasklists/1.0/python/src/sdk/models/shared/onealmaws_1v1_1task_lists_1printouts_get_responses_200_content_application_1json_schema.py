...
class Onealmaws1v11taskLists1printoutsGetResponses200ContentApplication1jsonSchemaPrintout:
    ...
    printer: Optional[Onealmaws1v11taskLists1printoutsGetResponses200ContentApplication1jsonSchemaPrintoutPrinter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('printer'), 'exclude': lambda f: f is None }})
    r"""The printer."""  
    ...
    status: Optional[Onealmaws1v11taskLists1printoutsGetResponses200ContentApplication1jsonSchemaPrintoutStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""Status of the printout (Pending/Printed/Canceled)."""  
...
class Onealmaws1v11taskLists1printoutsGetResponses200ContentApplication1jsonSchema:
    ...
    printout: Optional[list[Onealmaws1v11taskLists1printoutsGetResponses200ContentApplication1jsonSchemaPrintout]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('printout'), 'exclude': lambda f: f is None }})
    r"""printout object."""  
