...
public class ApiInformation {
    ...
    **/
    public openapisdk.models.operations.GetEndpointsResponse getEndpoints(openapisdk.models.operations.GetEndpointsRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/vnd.vimeo.endpoint+json")) {
