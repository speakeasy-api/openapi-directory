...
class SDK:
    r"""Code against the Bitbucket API to automate simple tasks, embed Bitbucket data into your own site, build mobile or desktop apps, or even add custom UI add-ons into Bitbucket itself using the Connect framework.
    ...
    * Every time a user pushes commits or creates a pull request, you may want to
    ...
    def _init_sdks(self):
        ...
        self.branch_restrictions = BranchRestrictions(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.branching_model = BranchingModel(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.commit_statuses = CommitStatuses(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
