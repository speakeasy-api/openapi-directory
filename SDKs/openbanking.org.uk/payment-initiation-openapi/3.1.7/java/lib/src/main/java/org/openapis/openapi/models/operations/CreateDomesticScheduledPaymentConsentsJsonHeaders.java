...
public class CreateDomesticScheduledPaymentConsentsJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticScheduledPaymentConsentsJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateDomesticScheduledPaymentConsentsJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticScheduledPaymentConsentsJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticScheduledPaymentConsentsJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateDomesticScheduledPaymentConsentsJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateDomesticScheduledPaymentConsentsJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticScheduledPaymentConsentsJsonHeaders withXJwsSignature(String xJwsSignature) {
