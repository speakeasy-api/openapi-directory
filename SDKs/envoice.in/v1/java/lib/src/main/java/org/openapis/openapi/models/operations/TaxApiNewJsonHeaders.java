...
public class TaxApiNewJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public TaxApiNewJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public TaxApiNewJsonHeaders withXAuthSecret(String xAuthSecret) {
