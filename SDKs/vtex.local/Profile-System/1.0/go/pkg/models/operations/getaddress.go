...
type GetAddressQueryParams struct {
...
type GetAddressRequest struct {
	...
	QueryParams GetAddressQueryParams
...
type GetAddressResponse struct {
	ContentType string
	// OK
	GetAddress200ApplicationJSONObject map[string]interface{}
	StatusCode                         int
