...
class AddTenantProjectRequest:
    r"""Request to add a newly created and configured tenant project to a tenancy unit."""
    ...
    r"""Required. Tag of the added project. Must be less than 128 characters. Required."""  
