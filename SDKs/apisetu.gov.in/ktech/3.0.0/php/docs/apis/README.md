...
* [cocer](#cocer) - Company Related Certificate
* [rfcer](#rfcer) - Registration Certificate of Firm/ Company
...
use \OpenAPI\OpenAPI\Models\Operations\CocerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\CocerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\CocerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\CocerSecurity;
...
try {
    ...
    $request->certificateParameters = new CocerRequestBodyCertificateParameters();
    $request->certificateParameters->certType = 'Registration';
    $request->certificateParameters->companyName = 'Solution Pollution BMS';
    $request->certificateParameters->regNo = 'IT/Registration/0477/2019-20';
    $request->certificateParameters->sector = 'IT';
    ...
    $request->format = CocerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new CocerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->cocer($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\RfcerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\RfcerRequestBodyCertificateParameters;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchema;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsent;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentData;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentDataConsumer;
...
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentUser;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaSignature;
use \OpenAPI\OpenAPI\Models\Operations\RfcerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\RfcerSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new RfcerRequestBody();
    $request->certificateParameters = new RfcerRequestBodyCertificateParameters();
    $request->certificateParameters->certType = 'Registration';
    $request->certificateParameters->companyName = 'Solution Pollution BMS';
    $request->certificateParameters->regNo = 'IT/Registration/0477/2019-20';
    $request->certificateParameters->sector = 'IT';
    ...
    $request->format = RfcerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new RfcerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->rfcer($request, $requestSecurity);
