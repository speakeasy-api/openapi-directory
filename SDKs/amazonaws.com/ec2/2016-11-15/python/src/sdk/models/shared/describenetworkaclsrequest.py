...
class DescribeNetworkAclsRequestFilters:
...
class DescribeNetworkAclsRequest:
    ...
    filters: Optional[list[DescribeNetworkAclsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    network_acl_ids: Optional[list[str]] = dataclasses.field(default=None)  
