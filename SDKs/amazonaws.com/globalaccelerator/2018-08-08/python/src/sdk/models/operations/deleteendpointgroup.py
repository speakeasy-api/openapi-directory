...
class DeleteEndpointGroupRequest:
    ...
    delete_endpoint_group_request: shared_deleteendpointgrouprequest.DeleteEndpointGroupRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
