...
class GetGroupVersionResponse:
    ...
    definition: Optional[shared_groupversion.GroupVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Definition'), 'exclude': lambda f: f is None }})  
