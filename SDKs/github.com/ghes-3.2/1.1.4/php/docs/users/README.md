...
try {
    ...
    $request->targetUser = 'reiciendis';
    $request->username = 'Toby.Buckridge79';
...
try {
    ...
    $request->armoredPublicKey = 'provident';
...
try {
    ...
    $request->username = 'Olga.Donnelly';
...
try {
    ...
    $request->subjectId = 'expedita';
    $request->subjectType = UsersGetContextForUserSubjectTypeEnum::REPOSITORY;
    $request->username = 'Patrick85';
...
try {
    ...
    $request->page = 770544;
    $request->perPage = 274040;
    $request->username = 'Sydnie77';
...
try {
    ...
    $request->page = 558283;
    $request->perPage = 772057;
    $request->username = 'Hilda.Romaguera10';
...
try {
    ...
    $request->page = 930877;
    $request->perPage = 875452;
    $request->username = 'Maud.Bins79';
...
try {
    ...
    $request->page = 738152;
    $request->perPage = 382342;
    $request->username = 'Sven.Weber31';
