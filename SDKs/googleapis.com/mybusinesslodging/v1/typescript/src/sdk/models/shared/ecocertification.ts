 ...
 * Awarded exception.
 */
export enum EcoCertificationAwardedExceptionEnum {
 ...
 */
export enum EcoCertificationEcoCertificateEnum {
 ...
 */
export class EcoCertification extends SpeakeasyBase {
  /**
