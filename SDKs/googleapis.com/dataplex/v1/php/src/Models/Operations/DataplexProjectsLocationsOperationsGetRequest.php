...
class DataplexProjectsLocationsOperationsGetRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DataplexProjectsLocationsOperationsGetViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?DataplexProjectsLocationsOperationsGetViewEnum $view = null;
