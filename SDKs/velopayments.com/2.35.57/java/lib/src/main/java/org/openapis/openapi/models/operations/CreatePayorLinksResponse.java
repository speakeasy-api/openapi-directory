...
public class CreatePayorLinksResponse {
    ...
    public CreatePayorLinksResponse withStatusCode(Integer statusCode) {
    ...
    public CreatePayorLinksResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public CreatePayorLinksResponse withInlineResponse400(org.openapis.openapi.models.shared.InlineResponse400 inlineResponse400) {
    ...
    public CreatePayorLinksResponse withInlineResponse403(org.openapis.openapi.models.shared.InlineResponse403 inlineResponse403) {
    ...
    public CreatePayorLinksResponse withInlineResponse404(org.openapis.openapi.models.shared.InlineResponse404 inlineResponse404) {
        this.inlineResponse404 = inlineResponse404;
        return this;
    }
    
    public CreatePayorLinksResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
