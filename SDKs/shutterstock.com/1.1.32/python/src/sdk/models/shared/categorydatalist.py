...
class CategoryDataList:
    r"""List of categories that images can belong to"""
    
    data: Optional[list[shared_category.Category]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""Categories"""  
