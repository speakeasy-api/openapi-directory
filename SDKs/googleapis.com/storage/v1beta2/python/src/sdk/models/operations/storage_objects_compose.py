...
class StorageObjectsComposeRequest:
    ...
    r"""Name of the bucket containing the source objects. The destination object is stored in this bucket."""  
    destination_object: str = dataclasses.field(metadata={'path_param': { 'field_name': 'destinationObject', 'style': 'simple', 'explode': False }})
    r"""Name of the new object."""  
    alt: Optional[shared_alt_enum.AltEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'alt', 'style': 'form', 'explode': True }})
    r"""Data format for the response."""  
    compose_request: Optional[shared_composerequest.ComposeRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
