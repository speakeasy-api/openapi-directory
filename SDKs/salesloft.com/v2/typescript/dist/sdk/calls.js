...
var Calls = /** @class */ (function () {
     ...
     *
     */
    Calls.prototype.getV2ActivitiesCallsJson = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetV2ActivitiesCallsJsonRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v2/activities/calls.json";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetV2ActivitiesCallsJsonResponse({
     ...
     *
     */
    Calls.prototype.getV2ActivitiesCallsIdJson = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetV2ActivitiesCallsIdJsonRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2/activities/calls/{id}.json", req);
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetV2ActivitiesCallsIdJsonResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     */
    Calls.prototype.postV2ActivitiesCallsJson = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostV2ActivitiesCallsJsonResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
