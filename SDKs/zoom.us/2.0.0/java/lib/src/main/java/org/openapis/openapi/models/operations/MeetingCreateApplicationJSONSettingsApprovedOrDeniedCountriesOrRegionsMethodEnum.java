 ...
 */
public enum MeetingCreateApplicationJSONSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum {
    APPROVE("approve"),
    DENY("deny");
    ...
    private MeetingCreateApplicationJSONSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum(String value) {
        this.value = value;
    }
}
