...
class OrgsUpdateRequestBodyMembersAllowedRepositoryCreationTypeEnum(str, Enum):
    r"""Specifies which types of repositories non-admin organization members can create. `private` is only available to repositories that are part of an organization on GitHub Enterprise Cloud.
...
class OrgsUpdateRequestBody:
    ...
    r"""Whether GitHub Advanced Security is automatically enabled for new repositories.
    ...
    r"""Whether Dependabot alerts is automatically enabled for new repositories.
    ...
    r"""Whether Dependabot security updates is automatically enabled for new repositories.
    ...
    r"""Whether dependency graph is automatically enabled for new repositories.
    ...
    **Note:** This parameter is deprecated and will be removed in the future. Its return value ignores internal repositories. Using this parameter overrides values set in `members_can_create_repositories`. See the parameter deprecation notice in the operation description for details.
    ...
    r"""Whether organization members can create private GitHub Pages sites. Existing published sites will not be impacted."""  
    ...
    r"""Whether organization members can create public GitHub Pages sites. Existing published sites will not be impacted."""  
    ...
    r"""Whether secret scanning is automatically enabled for new repositories.
    ...
    r"""If `secret_scanning_push_protection_custom_link_enabled` is true, the URL that will be displayed to contributors who are blocked from pushing a secret."""  
    ...
    r"""Whether secret scanning push protection is automatically enabled for new repositories.
    ...
    r"""Whether contributors to organization repositories are required to sign off on commits they make through GitHub's web interface."""  
