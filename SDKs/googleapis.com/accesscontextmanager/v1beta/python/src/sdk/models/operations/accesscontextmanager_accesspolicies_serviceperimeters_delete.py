...
class AccesscontextmanagerAccessPoliciesServicePerimetersDeleteRequest:
    path_params: AccesscontextmanagerAccessPoliciesServicePerimetersDeletePathParams = dataclasses.field()
    query_params: AccesscontextmanagerAccessPoliciesServicePerimetersDeleteQueryParams = dataclasses.field()
    security: AccesscontextmanagerAccessPoliciesServicePerimetersDeleteSecurity = dataclasses.field()
