...
class HpcerRequestBodyCertificateParameters:
    ...
    cuid: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CUID') }})
    r"""Candidate ID"""  
    ...
    r"""Full name"""  
    idxn: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('IDXN') }})
    r"""Index Number"""  
    uid: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('UID') }})
    r"""Aadhaar number"""  
    yoe: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('YOE') }})
    r"""Year Of Examination -YYYY"""  
