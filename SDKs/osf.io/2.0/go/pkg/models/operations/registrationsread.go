...
type RegistrationsReadRegistrationAttributesCategoryEnum string

const (
	RegistrationsReadRegistrationAttributesCategoryEnumAnalysis           RegistrationsReadRegistrationAttributesCategoryEnum = "analysis"
	RegistrationsReadRegistrationAttributesCategoryEnumCommunication      RegistrationsReadRegistrationAttributesCategoryEnum = "communication"
	RegistrationsReadRegistrationAttributesCategoryEnumData               RegistrationsReadRegistrationAttributesCategoryEnum = "data"
	RegistrationsReadRegistrationAttributesCategoryEnumHypothesis         RegistrationsReadRegistrationAttributesCategoryEnum = "hypothesis"
	RegistrationsReadRegistrationAttributesCategoryEnumInstrumentation    RegistrationsReadRegistrationAttributesCategoryEnum = "instrumentation"
	RegistrationsReadRegistrationAttributesCategoryEnumMethodsAndMeasures RegistrationsReadRegistrationAttributesCategoryEnum = "methods and measures"
	RegistrationsReadRegistrationAttributesCategoryEnumProcedure          RegistrationsReadRegistrationAttributesCategoryEnum = "procedure"
	RegistrationsReadRegistrationAttributesCategoryEnumProject            RegistrationsReadRegistrationAttributesCategoryEnum = "project"
	RegistrationsReadRegistrationAttributesCategoryEnumSoftware           RegistrationsReadRegistrationAttributesCategoryEnum = "software"
	RegistrationsReadRegistrationAttributesCategoryEnumOther              RegistrationsReadRegistrationAttributesCategoryEnum = "other"
)

func (e RegistrationsReadRegistrationAttributesCategoryEnum) ToPointer() *RegistrationsReadRegistrationAttributesCategoryEnum {
	return &e
}

func (e *RegistrationsReadRegistrationAttributesCategoryEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "software":
		fallthrough
	case "other":
		*e = RegistrationsReadRegistrationAttributesCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RegistrationsReadRegistrationAttributesCategoryEnum: %v", v)
	}
}

// RegistrationsReadRegistrationAttributes - The properties of the registration entity.
type RegistrationsReadRegistrationAttributes struct {
...
type RegistrationsReadRegistrationLinks struct {
...
type RegistrationsReadRegistrationRelationships struct {
...
type RegistrationsReadRegistration struct {
