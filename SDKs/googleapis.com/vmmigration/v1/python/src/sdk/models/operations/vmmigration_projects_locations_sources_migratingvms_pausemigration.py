...
class VmmigrationProjectsLocationsSourcesMigratingVmsPauseMigrationRequest:
    path_params: VmmigrationProjectsLocationsSourcesMigratingVmsPauseMigrationPathParams = dataclasses.field()
    query_params: VmmigrationProjectsLocationsSourcesMigratingVmsPauseMigrationQueryParams = dataclasses.field()
    security: VmmigrationProjectsLocationsSourcesMigratingVmsPauseMigrationSecurity = dataclasses.field()
