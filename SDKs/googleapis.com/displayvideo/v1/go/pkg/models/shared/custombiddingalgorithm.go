...
func (e CustomBiddingAlgorithmCustomBiddingAlgorithmStateEnum) ToPointer() *CustomBiddingAlgorithmCustomBiddingAlgorithmStateEnum {
	return &e
}

func (e *CustomBiddingAlgorithmCustomBiddingAlgorithmStateEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "DORMANT":
		fallthrough
	case "SUSPENDED":
		*e = CustomBiddingAlgorithmCustomBiddingAlgorithmStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CustomBiddingAlgorithmCustomBiddingAlgorithmStateEnum: %v", v)
	}
}
