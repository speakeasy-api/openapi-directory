...
class DescribeApplicationRequest:
    ...
    describe_application_request: shared_describeapplicationrequest.DescribeApplicationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
