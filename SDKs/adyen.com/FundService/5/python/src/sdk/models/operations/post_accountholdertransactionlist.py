...
from ..shared import accountholdertransactionlistresponse as shared_accountholdertransactionlistresponse
...
class PostAccountHolderTransactionListResponse:
    ...
    account_holder_transaction_list_response: Optional[shared_accountholdertransactionlistresponse.AccountHolderTransactionListResponse] = dataclasses.field(default=None)
