...
var Versions = /** @class */ (function () {
    ...
    Versions.prototype.getversion = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/api/dataentities/{acronym}/documents/{id}/versions/{versionId}", req);
    ...
    Versions.prototype.listversions = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/dataentities/{acronym}/documents/{id}/versions", req);
        var client = this._securityClient || this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "get", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    Versions.prototype.putversion = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.putversion = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.Putversion);
                    }
                    break;
            }
            return res;
