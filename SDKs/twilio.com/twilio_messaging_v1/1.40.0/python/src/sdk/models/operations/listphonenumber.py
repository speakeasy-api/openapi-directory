...
class ListPhoneNumberRequest:
    ...
    r"""The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to read the resources from."""  
...
class ListPhoneNumberListPhoneNumberResponse:
    ...
    meta: Optional[ListPhoneNumberListPhoneNumberResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    phone_numbers: Optional[list[shared_messaging_v1_service_phone_number.MessagingV1ServicePhoneNumber]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('phone_numbers'), 'exclude': lambda f: f is None }})  
