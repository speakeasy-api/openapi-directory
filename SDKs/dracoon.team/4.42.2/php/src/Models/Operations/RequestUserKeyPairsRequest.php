...
class RequestUserKeyPairsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestUserKeyPairsXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestUserKeyPairsXSdsDateFormatEnum $xSdsDateFormat = null;
