...
public class Webinar200ApplicationJSONSettingsFollowUpAttendeesEmailNotification {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    public Webinar200ApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum type;
    public Webinar200ApplicationJSONSettingsFollowUpAttendeesEmailNotification withType(Webinar200ApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum type) {
        this.type = type;
        return this;
    }
