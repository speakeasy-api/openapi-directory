...
public class LinksShareStoreLink {
    /**
    ...
    public LinksShareStoreLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksShareStoreLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksShareStoreLink withDescription(String description) {
    ...
    public LinksShareStoreLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksShareStoreLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksShareStoreLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksShareStoreLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksShareStoreLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksShareStoreLink withOperationId(String operationId) {
    ...
    public LinksShareStoreLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksShareStoreLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksShareStoreLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
