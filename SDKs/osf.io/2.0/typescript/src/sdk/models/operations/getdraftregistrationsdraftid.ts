...
export class GetDraftRegistrationsDraftIdRequest extends SpeakeasyBase {
  /**
...
export class GetDraftRegistrationsDraftIdDraftRegistrationAttributesNodeLicense extends SpeakeasyBase {
  /**
 ...
 */
export class GetDraftRegistrationsDraftIdDraftRegistrationAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class GetDraftRegistrationsDraftIdDraftRegistrationLinks extends SpeakeasyBase {
  /**
 ...
 */
export class GetDraftRegistrationsDraftIdDraftRegistrationRelationships extends SpeakeasyBase {
  /**
 ...
 * OK
 */
export class GetDraftRegistrationsDraftIdDraftRegistration extends SpeakeasyBase {
  /**
   * The properties of the Draft Registration entity.
   */
  @SpeakeasyMetadata()
...
export class GetDraftRegistrationsDraftIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
