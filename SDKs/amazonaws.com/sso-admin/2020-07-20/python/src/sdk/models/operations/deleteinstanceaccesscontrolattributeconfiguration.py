...
class DeleteInstanceAccessControlAttributeConfigurationRequest:
    ...
    delete_instance_access_control_attribute_configuration_request: shared_deleteinstanceaccesscontrolattributeconfigurationrequest.DeleteInstanceAccessControlAttributeConfigurationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
