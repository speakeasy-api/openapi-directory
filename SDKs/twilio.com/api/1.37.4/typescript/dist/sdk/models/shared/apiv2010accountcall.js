...
var ApiV2010AccountCall = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=forwarded_from" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=from_formatted" }),
        __metadata("design:type", String)
    ], ApiV2010AccountCall.prototype, "fromFormatted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=group_sid" }),
        __metadata("design:type", String)
    ], ApiV2010AccountCall.prototype, "groupSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=parent_call_sid" }),
        __metadata("design:type", String)
    ], ApiV2010AccountCall.prototype, "parentCallSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=phone_number_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=queue_time" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=to_formatted" }),
        __metadata("design:type", String)
