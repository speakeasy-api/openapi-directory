...
public class DpicrSecurity {
    ...
    public DpicrSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public DpicrSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public DpicrSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
