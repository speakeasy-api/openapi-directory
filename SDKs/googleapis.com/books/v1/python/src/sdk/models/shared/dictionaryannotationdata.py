...
class DictionaryAnnotationdata:
    ...
    data: Optional[shared_dictlayerdata.Dictlayerdata] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
