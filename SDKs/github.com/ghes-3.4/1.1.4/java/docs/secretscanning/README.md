...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SecretScanningGetAlertRequest req = new SecretScanningGetAlertRequest(644223L, "modi", "sunt");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SecretScanningListAlertsForEnterpriseRequest req = new SecretScanningListAlertsForEnterpriseRequest("impedit") {{
                after = "eius";
                before = "voluptatum";
                perPage = 60078L;
                resolution = "at";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SecretScanningListAlertsForOrgRequest req = new SecretScanningListAlertsForOrgRequest("aspernatur") {{
                page = 80284L;
                perPage = 193236L;
                resolution = "fugit";
                secretType = "fuga";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SecretScanningListAlertsForRepoRequest req = new SecretScanningListAlertsForRepoRequest("eaque", "dolorem") {{
                page = 101854L;
                perPage = 44929L;
                resolution = "aspernatur";
                secretType = "nulla";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SecretScanningListLocationsForAlertRequest req = new SecretScanningListLocationsForAlertRequest(73574L, "magnam", "delectus") {{
                page = 255064L;
                perPage = 760279L;
            }};            
