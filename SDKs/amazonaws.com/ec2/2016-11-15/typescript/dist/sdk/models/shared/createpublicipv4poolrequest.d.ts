 ...
 */
export declare enum CreatePublicIpv4PoolRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreatePublicIpv4PoolRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreatePublicIpv4PoolRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreatePublicIpv4PoolRequest extends SpeakeasyBase {
    dryRun?: boolean;
