...
class FSxWindowsFileServerVolumeConfiguration:
    ...
    authorization_config: shared_fsxwindowsfileserverauthorizationconfig.FSxWindowsFileServerAuthorizationConfig = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('authorizationConfig') }})
    file_system_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('fileSystemId') }})
    root_directory: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('rootDirectory') }})
