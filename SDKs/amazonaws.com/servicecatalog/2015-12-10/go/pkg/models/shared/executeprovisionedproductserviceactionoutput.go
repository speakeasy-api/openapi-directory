...
type ExecuteProvisionedProductServiceActionOutputRecordDetail struct {
...
type ExecuteProvisionedProductServiceActionOutput struct {
	RecordDetail *ExecuteProvisionedProductServiceActionOutputRecordDetail `json:"RecordDetail,omitempty"`
}
