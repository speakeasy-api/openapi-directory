...
class DescribeDatabaseXAmzTargetEnum(str, Enum):
    TIMESTREAM_20181101_DESCRIBE_DATABASE = "Timestream_20181101.DescribeDatabase"


@dataclasses.dataclass
class DescribeDatabaseHeaders:
    x_amz_target: DescribeDatabaseXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeDatabaseRequest:
    headers: DescribeDatabaseHeaders = dataclasses.field()
