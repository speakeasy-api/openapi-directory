...
public class GetCallQoS200ApplicationXMLCallerQosSendingQos {
    /**
    ...
    public GetCallQoS200ApplicationXMLCallerQosSendingQos withAvgLoss(String avgLoss) {
    ...
    public GetCallQoS200ApplicationXMLCallerQosSendingQos withBitrate(String bitrate) {
    ...
    public GetCallQoS200ApplicationXMLCallerQosSendingQos withJitter(String jitter) {
        this.jitter = jitter;
        return this;
    }
    ...
    public GetCallQoS200ApplicationXMLCallerQosSendingQos withMaxLoss(String maxLoss) {
    ...
    public String mos;
    public GetCallQoS200ApplicationXMLCallerQosSendingQos withMos(String mos) {
        this.mos = mos;
        return this;
    }
    ...
    public GetCallQoS200ApplicationXMLCallerQosSendingQos withNetworkDelay(String networkDelay) {
