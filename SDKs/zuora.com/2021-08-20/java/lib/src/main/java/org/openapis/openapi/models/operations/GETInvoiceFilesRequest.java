...
public class GETInvoiceFilesRequest {
    ...
    public GETInvoiceFilesRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETInvoiceFilesRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETInvoiceFilesRequest withPageSize(Long pageSize) {
