...
export class SDK {
  ...
  addTagsToStream(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AddTagsToStreamResponse =
        new operations.AddTagsToStreamResponse({
  ...
  decreaseStreamRetentionPeriod(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DecreaseStreamRetentionPeriodResponse =
        new operations.DecreaseStreamRetentionPeriodResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  deregisterStreamConsumer(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DeregisterStreamConsumerResponse =
        new operations.DeregisterStreamConsumerResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  describeStreamConsumer(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DescribeStreamConsumerResponse =
        new operations.DescribeStreamConsumerResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.describeStreamConsumerOutput = utils.objectToClass(
              httpRes?.data,
              shared.DescribeStreamConsumerOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  describeStreamSummary(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DescribeStreamSummaryResponse =
        new operations.DescribeStreamSummaryResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.describeStreamSummaryOutput = utils.objectToClass(
              httpRes?.data,
              shared.DescribeStreamSummaryOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  disableEnhancedMonitoring(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DisableEnhancedMonitoringResponse =
        new operations.DisableEnhancedMonitoringResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.enhancedMonitoringOutput = utils.objectToClass(
              httpRes?.data,
              shared.EnhancedMonitoringOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  enableEnhancedMonitoring(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.EnableEnhancedMonitoringResponse =
        new operations.EnableEnhancedMonitoringResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getRecords(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=Kinesis_20131202.GetRecords";
  ...
  increaseStreamRetentionPeriod(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.IncreaseStreamRetentionPeriodResponse =
        new operations.IncreaseStreamRetentionPeriodResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  listShards(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=Kinesis_20131202.ListShards";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListShardsResponse =
        new operations.ListShardsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listShardsOutput = utils.objectToClass(
              httpRes?.data,
              shared.ListShardsOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  listStreamConsumers(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListStreamConsumersResponse =
        new operations.ListStreamConsumersResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listStreamConsumersOutput = utils.objectToClass(
              httpRes?.data,
              shared.ListStreamConsumersOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  mergeShards(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.MergeShardsResponse =
        new operations.MergeShardsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  putRecord(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=Kinesis_20131202.PutRecord";
  ...
  putRecords(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=Kinesis_20131202.PutRecords";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PutRecordsResponse =
        new operations.PutRecordsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.putRecordsOutput = utils.objectToClass(
              httpRes?.data,
              shared.PutRecordsOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  registerStreamConsumer(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RegisterStreamConsumerResponse =
        new operations.RegisterStreamConsumerResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.registerStreamConsumerOutput = utils.objectToClass(
              httpRes?.data,
              shared.RegisterStreamConsumerOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  removeTagsFromStream(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RemoveTagsFromStreamResponse =
        new operations.RemoveTagsFromStreamResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  splitShard(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=Kinesis_20131202.SplitShard";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SplitShardResponse =
        new operations.SplitShardResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  startStreamEncryption(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.StartStreamEncryptionResponse =
        new operations.StartStreamEncryptionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  stopStreamEncryption(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.StopStreamEncryptionResponse =
        new operations.StopStreamEncryptionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  updateShardCount(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UpdateShardCountResponse =
        new operations.UpdateShardCountResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.updateShardCountOutput = utils.objectToClass(
              httpRes?.data,
              shared.UpdateShardCountOutput
            );
          }
          break;
        case httpRes?.status == 480:
   ...
   */
  updateStreamMode(
    req: operations.UpdateStreamModeRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UpdateStreamModeResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UpdateStreamModeResponse =
        new operations.UpdateStreamModeResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
