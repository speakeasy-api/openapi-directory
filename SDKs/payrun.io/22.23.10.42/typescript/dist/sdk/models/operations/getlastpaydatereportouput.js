...
exports.GetLastPayDateReportOuputResponse = exports.GetLastPayDateReportOuputRequest = void 0;
...
var GetLastPayDateReportOuputRequest = /** @class */ (function (_super) {
    ...
    ], GetLastPayDateReportOuputRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetLastPayDateReportOuputRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EmployeeKey",
        }),
        __metadata("design:type", String)
    ], GetLastPayDateReportOuputRequest.prototype, "employeeKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EmployerKey",
        }),
        __metadata("design:type", String)
    ], GetLastPayDateReportOuputRequest.prototype, "employerKey", void 0);
...
var GetLastPayDateReportOuputResponse = /** @class */ (function (_super) {
    ...
    ], GetLastPayDateReportOuputResponse.prototype, "rawResponse", void 0);
