...
class GoogleCloudPrivatecatalogproducerV1beta1CreateAssociationRequest:
    ...
    association: Optional[shared_googlecloudprivatecatalogproducerv1beta1association.GoogleCloudPrivatecatalogproducerV1beta1Association] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('association'), 'exclude': lambda f: f is None }})
