...
class VideoV1RoomRoomParticipant:
    ...
    status: Optional[shared_room_participant_enum_status_enum.RoomParticipantEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
