...
exports.PretargetingConfig = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var PretargetingConfig = /** @class */ (function () {
    function PretargetingConfig(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    PretargetingConfig.prototype.adexchangebuyerPretargetingConfigDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AdexchangebuyerPretargetingConfigDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/pretargetingconfigs/{accountId}/{configId}", req.pathParams);
    ...
    **/
    PretargetingConfig.prototype.adexchangebuyerPretargetingConfigGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.pretargetingConfig = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    PretargetingConfig.prototype.adexchangebuyerPretargetingConfigInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AdexchangebuyerPretargetingConfigInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/pretargetingconfigs/{accountId}", req.pathParams);
    ...
    **/
    PretargetingConfig.prototype.adexchangebuyerPretargetingConfigList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.pretargetingConfigList = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    PretargetingConfig.prototype.adexchangebuyerPretargetingConfigPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PretargetingConfig.prototype.adexchangebuyerPretargetingConfigUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
