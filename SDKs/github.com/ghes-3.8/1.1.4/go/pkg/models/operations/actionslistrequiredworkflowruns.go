...
type ActionsListRequiredWorkflowRunsQueryParams struct {
	...
	CheckSuiteID *int64 `queryParam:"style=form,explode=true,name=check_suite_id"`
...
type ActionsListRequiredWorkflowRuns200ApplicationJSON struct {
	TotalCount   int64                `json:"total_count"`
	WorkflowRuns []shared.WorkflowRun `json:"workflow_runs"`
}

type ActionsListRequiredWorkflowRunsResponse struct {
	ContentType string
