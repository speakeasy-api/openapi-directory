 ...
 */
public class SearchCurrentUserPosts200ApplicationJSON {
    /**
    ...
    public SearchCurrentUserPosts200ApplicationJSON withEndIndex(Long endIndex) {
    ...
    public SearchCurrentUserPosts200ApplicationJSON withGroupIds(String[] groupIds) {
    ...
    public SearchCurrentUserPosts200ApplicationJSON withNumPages(Long numPages) {
    ...
    public SearchCurrentUserPosts200ApplicationJSON withNumPosts(Long numPosts) {
    ...
    @JsonProperty("page")
    public Long page;
    public SearchCurrentUserPosts200ApplicationJSON withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public SearchCurrentUserPosts200ApplicationJSON withPerPage(Long perPage) {
    ...
    public SearchCurrentUserPosts200ApplicationJSON withPosts(org.openapis.openapi.models.shared.PostSearchResult[] posts) {
        this.posts = posts;
        return this;
    }
    ...
    public SearchCurrentUserPosts200ApplicationJSON withStartIndex(Long startIndex) {
