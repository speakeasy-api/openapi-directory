...
/**
 * UpdateGroupSettingsApplicationJSON2GroupSettingsAuthenticationUpdateAuthenticationOptionTypeEnum -  Authentication type. Specify one of the following authentication types for the authentication profile:&lt;br&gt;
 ...
 */
public enum UpdateGroupSettingsApplicationJSON2GroupSettingsAuthenticationUpdateAuthenticationOptionTypeEnum {
    ...
    private UpdateGroupSettingsApplicationJSON2GroupSettingsAuthenticationUpdateAuthenticationOptionTypeEnum(String value) {
        this.value = value;
    }
}
