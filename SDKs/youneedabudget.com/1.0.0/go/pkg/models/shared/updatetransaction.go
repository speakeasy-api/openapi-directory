...
// UpdateTransactionClearedEnum - The cleared status of the transaction
...
func (e *UpdateTransactionClearedEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "uncleared":
		fallthrough
	case "reconciled":
		*e = UpdateTransactionClearedEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateTransactionClearedEnum: %s", s)
	}
}

// UpdateTransactionFlagColorEnum - The transaction flag
...
func (e *UpdateTransactionFlagColorEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "purple":
		fallthrough
	case "null":
		*e = UpdateTransactionFlagColorEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateTransactionFlagColorEnum: %s", s)
	}
}
