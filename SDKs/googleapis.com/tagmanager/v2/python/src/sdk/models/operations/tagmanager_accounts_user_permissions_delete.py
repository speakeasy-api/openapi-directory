...
class TagmanagerAccountsUserPermissionsDeleteRequest:
    ...
    type: Optional[list[TagmanagerAccountsUserPermissionsDeleteTypeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
    r"""The types of built-in variables to delete."""  
