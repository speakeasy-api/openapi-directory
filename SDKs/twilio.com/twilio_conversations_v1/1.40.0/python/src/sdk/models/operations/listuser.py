...
class ListUserListUserResponse:
    ...
    users: Optional[list[shared_conversations_v1_user.ConversationsV1User]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('users'), 'exclude': lambda f: f is None }})  
