 ...
 */
public enum UpdateNetworkApplianceVlan200ApplicationJSONDhcpHandlingEnum {
    ...
    private UpdateNetworkApplianceVlan200ApplicationJSONDhcpHandlingEnum(String value) {
        this.value = value;
    }
}
