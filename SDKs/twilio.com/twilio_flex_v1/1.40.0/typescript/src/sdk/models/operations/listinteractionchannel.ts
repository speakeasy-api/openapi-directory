...
export class ListInteractionChannelListInteractionChannelResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.FlexV1InteractionInteractionChannel })
  @Expose({ name: "channels" })
  @Type(() => shared.FlexV1InteractionInteractionChannel)
  channels?: shared.FlexV1InteractionInteractionChannel[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListInteractionChannelListInteractionChannelResponseMeta)
