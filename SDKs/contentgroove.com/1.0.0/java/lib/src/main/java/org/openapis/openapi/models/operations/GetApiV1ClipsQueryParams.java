...
public class GetApiV1ClipsQueryParams {
    /**
    ...
    public GetApiV1ClipsQueryParams withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetApiV1ClipsQueryParams withPage(java.util.Map<String, Object> page) {
        this.page = page;
        return this;
    }
    ...
    public GetApiV1ClipsQueryParams withSort(GetApiV1ClipsSortEnum sort) {
        this.sort = sort;
        return this;
    }
