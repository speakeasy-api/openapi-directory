...
import dataclasses
from ..shared import signaldecisionoutcome_enum as shared_signaldecisionoutcome_enum
from ..shared import signalpaymentmethod_enum as shared_signalpaymentmethod_enum
...
class SignalDecisionReportRequest:
    ...
    """  
    decision_outcome: Optional[shared_signaldecisionoutcome_enum.SignalDecisionOutcomeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('decision_outcome'), 'exclude': lambda f: f is None }})
    ...
    """  
    payment_method: Optional[shared_signalpaymentmethod_enum.SignalPaymentMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payment_method'), 'exclude': lambda f: f is None }})
