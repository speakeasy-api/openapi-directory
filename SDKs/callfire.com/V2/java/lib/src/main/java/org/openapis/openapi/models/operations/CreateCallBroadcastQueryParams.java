...
public class CreateCallBroadcastQueryParams {
    /**
     * Specify whether to immediately start this campaign (not required)
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=start")
    public Boolean start;
    public CreateCallBroadcastQueryParams withStart(Boolean start) {
        this.start = start;
        return this;
    }
    ...
    public CreateCallBroadcastQueryParams withStrictValidation(Boolean strictValidation) {
