...
from ..shared import proxycreateinvoiceadjustment as shared_proxycreateinvoiceadjustment
...
class ObjectPOSTInvoiceAdjustmentRequest:
    ...
    proxy_create_invoice_adjustment: shared_proxycreateinvoiceadjustment.ProxyCreateInvoiceAdjustment = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
