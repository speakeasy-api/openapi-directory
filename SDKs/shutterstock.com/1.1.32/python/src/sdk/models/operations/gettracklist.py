...
from ..shared import audiodatalist as shared_audiodatalist
...
class GetTrackListResponse:
    ...
    audio_data_list: Optional[shared_audiodatalist.AudioDataList] = dataclasses.field(default=None)
    r"""OK"""  
