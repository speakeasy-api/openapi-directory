...
func (e DisableKinesisStreamingDestinationXAmzTargetEnum) ToPointer() *DisableKinesisStreamingDestinationXAmzTargetEnum {
	return &e
}
...
func (e *DisableKinesisStreamingDestinationXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "DynamoDB_20120810.DisableKinesisStreamingDestination":
		*e = DisableKinesisStreamingDestinationXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DisableKinesisStreamingDestinationXAmzTargetEnum: %v", v)
	}
}
