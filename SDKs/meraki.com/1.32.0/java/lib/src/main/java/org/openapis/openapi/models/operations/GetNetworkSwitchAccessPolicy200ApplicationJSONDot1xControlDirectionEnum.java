 ...
 */
public enum GetNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum {
    BOTH("both"),
    INBOUND("inbound");
    ...
    private GetNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum(String value) {
        this.value = value;
    }
}
