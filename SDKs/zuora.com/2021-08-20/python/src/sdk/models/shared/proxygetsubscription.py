...
class ProxyGetSubscription:
    ...
    **Values**: `true`, `false`
    ...
    r"""The date on which the subscription was canceled."""  
    ...
    **Note**: This field is required in the subscribe call. If you set the value of this field to null and both the ServiceActivationDate and ContractAcceptanceDate fields are not required, the subscribe call still returns success, but the new subscription is in `DRAFT` status. To activate the subscription, you must set a valid date to this field.
    ...
    r"""The user ID of the person who created the subscription. **Character limit**: 32 **Values**: automatically generated"""  
    ...
    **Character limit**: 32 **Values**: automatically generated
    ...
    r"""The length of the period for the current subscription term. If TermType is set to `TERMED`, this field is required and must be greater than `0`. If TermType is set to `EVERGREEN`, this value is ignored. Default is `0`.
    ...
    **Required**: If TermType is Termed **Values**: `RENEW_WITH_SPECIFIC_TERM `(default), `RENEW_TO_EVERGREEN`
    ...
    r"""The length of the period for the subscription renewal term. This field can be updated when **Status** is `Draft`.
    ...
    **Note:** To get this field, you must set the Zuora WSDL version to 107.0 or over in the `X-Zuora-WSDL-Version` header parameter.
    ...
    r"""The date when the subscription is activated. This field can be updated when **Status** is `Draft`."""  
    ...
    **Character limit**: 29 **Values**: automatically generated
    ...
    r"""This field can be updated when **Status** is `Draft`. The date when the subscription term ends. If the subscription is evergreen, the TermEndDate value is null or is the cancelation date, as appropriate. **Character limit**: 29 **Values**: automatically generated"""  
