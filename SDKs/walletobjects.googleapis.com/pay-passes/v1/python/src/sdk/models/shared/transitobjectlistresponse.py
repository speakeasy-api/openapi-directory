...
class TransitObjectListResponse:
    ...
    resources: Optional[list[shared_transitobject.TransitObject]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources'), 'exclude': lambda f: f is None }})
