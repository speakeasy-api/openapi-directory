...
public class GetNetworkClientConnectionStatsQueryParams {
    /**
     * Filter results by AP Tag
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=apTag")
    public String apTag;
    public GetNetworkClientConnectionStatsQueryParams withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkClientConnectionStatsQueryParams withBand(GetNetworkClientConnectionStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public Long ssid;
    public GetNetworkClientConnectionStatsQueryParams withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetNetworkClientConnectionStatsQueryParams withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetNetworkClientConnectionStatsQueryParams withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkClientConnectionStatsQueryParams withTimespan(Float timespan) {
    ...
    public Long vlan;
    public GetNetworkClientConnectionStatsQueryParams withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
