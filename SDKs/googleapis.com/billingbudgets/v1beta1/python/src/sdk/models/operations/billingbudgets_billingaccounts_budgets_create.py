...
class BillingbudgetsBillingAccountsBudgetsCreateRequest:
    ...
    r"""Required. The name of the billing account to create the budget in. Values are of the form `billingAccounts/{billingAccountId}`."""  
    ...
    google_cloud_billing_budgets_v1beta1_create_budget_request_input: Optional[shared_googlecloudbillingbudgetsv1beta1createbudgetrequest.GoogleCloudBillingBudgetsV1beta1CreateBudgetRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
