...
var Quality = /** @class */ (function () {
    function Quality(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Quality.prototype.qualityGetDailyDataQualityForSite = function (req, config) {
    ...
    **/
    Quality.prototype.qualityGetOverallDataQualityForSites = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
