...
func (e *GETSetLoadBalancerPoliciesOfListenerActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "SetLoadBalancerPoliciesOfListener":
		*e = GETSetLoadBalancerPoliciesOfListenerActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETSetLoadBalancerPoliciesOfListenerActionEnum: %s", s)
	}
}
...
func (e *GETSetLoadBalancerPoliciesOfListenerVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2012-06-01":
		*e = GETSetLoadBalancerPoliciesOfListenerVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETSetLoadBalancerPoliciesOfListenerVersionEnum: %s", s)
	}
}
