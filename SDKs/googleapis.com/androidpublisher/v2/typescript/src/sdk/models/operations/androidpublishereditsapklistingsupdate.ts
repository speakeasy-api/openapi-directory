...
export class AndroidpublisherEditsApklistingsUpdateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AndroidpublisherEditsApklistingsUpdateRequest extends SpeakeasyBase {
...
export class AndroidpublisherEditsApklistingsUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
