...
public class PutUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsIdTransactionInformationsRequest {
    ...
    public PutUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsIdTransactionInformationsRequest(@JsonProperty("id_account") Long idAccount, @JsonProperty("id_connection") Long idConnection, @JsonProperty("id_transaction") Long idTransaction, @JsonProperty("id_user") String idUser) {
        this.idAccount = idAccount;
        this.idConnection = idConnection;
        this.idTransaction = idTransaction;
        this.idUser = idUser;
