...
var EventIntegrationAssociation = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "ClientAssociationMetadata" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "EventBridgeRuleName" }),
        __metadata("design:type", String)
    ], EventIntegrationAssociation.prototype, "eventBridgeRuleName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "EventIntegrationAssociationArn" }),
        __metadata("design:type", String)
    ], EventIntegrationAssociation.prototype, "eventIntegrationAssociationArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "EventIntegrationAssociationId" }),
        __metadata("design:type", String)
    ], EventIntegrationAssociation.prototype, "eventIntegrationAssociationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "EventIntegrationName" }),
        __metadata("design:type", String)
