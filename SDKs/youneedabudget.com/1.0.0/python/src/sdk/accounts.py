...
class Accounts:
    ...
    def create_account(self, request: operations.CreateAccountRequest) -> operations.CreateAccountResponse:
        ...
        url = utils.generate_url(operations.CreateAccountRequest, base_url, '/budgets/{budget_id}/accounts', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "post_account_wrapper", 'json')
    ...
    def get_account_by_id(self, request: operations.GetAccountByIDRequest) -> operations.GetAccountByIDResponse:
        ...
        url = utils.generate_url(operations.GetAccountByIDRequest, base_url, '/budgets/{budget_id}/accounts/{account_id}', request)
    ...
    def get_accounts(self, request: operations.GetAccountsRequest) -> operations.GetAccountsResponse:
        ...
        url = utils.generate_url(operations.GetAccountsRequest, base_url, '/budgets/{budget_id}/accounts', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AccountsResponse])
