...
func (s *Media) ChromepolicyMediaUpload(ctx context.Context, request operations.ChromepolicyMediaUploadRequest) (*operations.ChromepolicyMediaUploadResponse, error) {
