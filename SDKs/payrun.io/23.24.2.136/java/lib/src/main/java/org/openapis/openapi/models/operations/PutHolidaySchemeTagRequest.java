...
public class PutHolidaySchemeTagRequest {
    ...
    public PutHolidaySchemeTagRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("EmployerId") String employerId, @JsonProperty("HolidaySchemeId") String holidaySchemeId, @JsonProperty("TagId") String tagId) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.employerId = employerId;
        this.holidaySchemeId = holidaySchemeId;
