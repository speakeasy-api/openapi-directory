...
export class CreateDomesticPaymentConsentsRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateDomesticPaymentConsentsRawRequest extends SpeakeasyBase {
  /**
...
export class CreateDomesticPaymentConsentsRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
