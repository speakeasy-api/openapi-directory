...
type AndroidenterpriseStorelayoutclustersDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseStorelayoutclustersDeletePathParams struct {
...
type AndroidenterpriseStorelayoutclustersDeleteQueryParams struct {
	// V1 error format.
...
type AndroidenterpriseStorelayoutclustersDeleteRequest struct {
...
type AndroidenterpriseStorelayoutclustersDeleteResponse struct {
	ContentType string
	StatusCode  int
