...
export class DeleteFieldLevelEncryptionProfile20180618Request extends SpeakeasyBase {
  /**
...
export class DeleteFieldLevelEncryptionProfile20180618Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
