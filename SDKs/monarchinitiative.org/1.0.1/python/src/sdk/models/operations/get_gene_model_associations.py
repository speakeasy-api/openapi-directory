...
class GetGeneModelAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGeneModelAssociationsQueryParams:
...
class GetGeneModelAssociationsRequest:
    path_params: GetGeneModelAssociationsPathParams = dataclasses.field()
    query_params: GetGeneModelAssociationsQueryParams = dataclasses.field()
