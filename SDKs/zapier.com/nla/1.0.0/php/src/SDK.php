...
class SDK
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\CheckResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/api/v1/check/');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CheckResponse();
     ...
     * @return \OpenAPI\OpenAPI\Models\Operations\ExecuteAppActionEndpointResponse
     */
	public function executeAppActionEndpoint(
        \OpenAPI\OpenAPI\Models\Operations\ExecuteAppActionEndpointRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ExecuteAppActionEndpointSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ExecuteAppActionEndpointResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/api/v1/exposed/{exposed_app_action_id}/execute/', \OpenAPI\OpenAPI\Models\Operations\ExecuteAppActionEndpointRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "executeRequest", "json");
        if ($body === null) {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ExecuteAppActionEndpointResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/api/v1/configuration-link/');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetConfigurationLinkResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/api/v1/exposed/');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListExposedActionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->exposedActionResponseSchema = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ExposedActionResponseSchema', 'json');
            }
        }
