 ...
 */
export declare enum AddressValidatingShipmentDeliveryConfirmationEnum {
    None = "none",
    Delivery = "delivery",
    Signature = "signature",
 ...
 */
export declare enum AddressValidatingShipmentInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export declare enum AddressValidatingShipmentInternationalShipmentOptionsNonDeliveryEnum {
 ...
 */
export declare enum AddressValidatingShipmentInsuranceProviderEnum {
    None = "none",
 ...
 */
export declare enum AddressValidatingShipmentOriginTypeEnum {
    Pickup = "pickup",
    DropOff = "drop_off"
}
/**
 ...
 */
export declare enum AddressValidatingShipmentValidateAddressEnum {
