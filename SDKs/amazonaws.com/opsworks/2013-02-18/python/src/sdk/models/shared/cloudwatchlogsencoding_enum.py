...
class CloudWatchLogsEncodingEnum(str, Enum):
    r"""Specifies the encoding of the log file so that the file can be read correctly. The default is <code>utf_8</code>. Encodings supported by Python <code>codecs.decode()</code> can be used here."""
    ASCII = 'ascii'
    BIG5 = 'big5'
    BIG5HKSCS = 'big5hkscs'
    CP037 = 'cp037'
