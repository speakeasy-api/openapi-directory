...
type BaremetalsolutionProjectsLocationsProvisioningQuotasListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type BaremetalsolutionProjectsLocationsProvisioningQuotasListPathParams struct {
	// Required. Parent value for ListProvisioningQuotasRequest.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type BaremetalsolutionProjectsLocationsProvisioningQuotasListQueryParams struct {
	// V1 error format.
...
type BaremetalsolutionProjectsLocationsProvisioningQuotasListRequest struct {
...
type BaremetalsolutionProjectsLocationsProvisioningQuotasListResponse struct {
	ContentType string
	// Successful response
