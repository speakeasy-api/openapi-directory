...
type CertificatemanagerProjectsLocationsCertificatesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CertificatemanagerProjectsLocationsCertificatesListPathParams struct {
...
type CertificatemanagerProjectsLocationsCertificatesListQueryParams struct {
	// V1 error format.
...
type CertificatemanagerProjectsLocationsCertificatesListRequest struct {
...
type CertificatemanagerProjectsLocationsCertificatesListResponse struct {
	ContentType string
	// Successful response
