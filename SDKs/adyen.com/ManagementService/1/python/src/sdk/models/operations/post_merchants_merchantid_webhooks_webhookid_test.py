...
from ..shared import testwebhookrequest as shared_testwebhookrequest
from ..shared import testwebhookresponse as shared_testwebhookresponse
...
class PostMerchantsMerchantIDWebhooksWebhookIDTestRequest:
    ...
    test_webhook_request: Optional[shared_testwebhookrequest.TestWebhookRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class PostMerchantsMerchantIDWebhooksWebhookIDTestResponse:
    ...
    test_webhook_response: Optional[shared_testwebhookresponse.TestWebhookResponse] = dataclasses.field(default=None)
