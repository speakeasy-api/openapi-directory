...
class AttachPolicyRequestBodyObjectReference:
    r"""AttachPolicyRequestBodyObjectReference
...
class AttachPolicyRequestBodyPolicyReference:
    r"""AttachPolicyRequestBodyPolicyReference
    The reference that identifies an object.
    """
...
class AttachPolicyRequestBody:
    object_reference: AttachPolicyRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ObjectReference') }})
    policy_reference: AttachPolicyRequestBodyPolicyReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('PolicyReference') }})
    

@dataclasses.dataclass
class AttachPolicyRequest:
    headers: AttachPolicyHeaders = dataclasses.field()
    request: AttachPolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
