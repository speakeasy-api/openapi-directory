...
export class Labels {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleAppsDriveLabelsV2betaLabel = utils.objectToClass(
              httpRes?.data,
              shared.GoogleAppsDriveLabelsV2betaLabel
            );
          }
          break;
      }
  ...
  drivelabelsLabelsDelta(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v2beta/{name}:delta", req);
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleAppsDriveLabelsV2betaDeltaUpdateLabelResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleAppsDriveLabelsV2betaDeltaUpdateLabelResponse
              );
          }
          break;
      }
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleAppsDriveLabelsV2betaListLabelsResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleAppsDriveLabelsV2betaListLabelsResponse
              );
          }
          break;
      }
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleAppsDriveLabelsV2betaListLabelLocksResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleAppsDriveLabelsV2betaListLabelLocksResponse
              );
          }
          break;
      }
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleAppsDriveLabelsV2betaBatchUpdateLabelPermissionsResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleAppsDriveLabelsV2betaBatchUpdateLabelPermissionsResponse
              );
          }
          break;
      }
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleAppsDriveLabelsV2betaLabelPermission =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleAppsDriveLabelsV2betaLabelPermission
              );
          }
          break;
      }
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.googleAppsDriveLabelsV2betaListLabelPermissionsResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.GoogleAppsDriveLabelsV2betaListLabelPermissionsResponse
              );
          }
          break;
      }
