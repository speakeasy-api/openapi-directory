...
class ProviderLevelEnum(str, Enum):
...
class Provider:
    ...
    level: Optional[ProviderLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Level'), 'exclude': lambda f: f is None }})  
