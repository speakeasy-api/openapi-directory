...
from ..shared import createsessionrequest as shared_createsessionrequest
from ..shared import createsessionresponse as shared_createsessionresponse
from enum import Enum
from typing import Any, Optional

class CreateSessionXAmzTargetEnum(str, Enum):
...
class CreateSessionRequest:
    ...
    create_session_request: shared_createsessionrequest.CreateSessionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    x_amz_target: CreateSessionXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})  
