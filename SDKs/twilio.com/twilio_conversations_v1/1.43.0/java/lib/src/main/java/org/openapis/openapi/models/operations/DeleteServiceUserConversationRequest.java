...
public class DeleteServiceUserConversationRequest {
    ...
    public DeleteServiceUserConversationRequest(@JsonProperty("ChatServiceSid") String chatServiceSid, @JsonProperty("ConversationSid") String conversationSid, @JsonProperty("UserSid") String userSid) {
        this.chatServiceSid = chatServiceSid;
        this.conversationSid = conversationSid;
        this.userSid = userSid;
  }
