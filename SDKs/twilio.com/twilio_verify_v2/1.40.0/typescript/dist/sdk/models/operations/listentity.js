...
exports.ListEntityResponse = exports.ListEntityListEntityResponse = exports.ListEntityListEntityResponseMeta = exports.ListEntityRequest = exports.ListEntitySecurity = exports.ListEntityServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListEntityServerList = ["https://verify.twilio.com"];
var ListEntitySecurity = /** @class */ (function (_super) {
    ...
    ], ListEntitySecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListEntitySecurity.prototype, "username", void 0);
...
var ListEntityRequest = /** @class */ (function (_super) {
    ...
    ], ListEntityRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListEntityRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListEntityRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListEntityRequest.prototype, "serviceSid", void 0);
...
var ListEntityListEntityResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.VerifyV2ServiceEntity }),
        (0, class_transformer_1.Expose)({ name: "entities" }),
        (0, class_transformer_1.Type)(function () { return shared.VerifyV2ServiceEntity; }),
        __metadata("design:type", Array)
    ], ListEntityListEntityResponse.prototype, "entities", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListEntityListEntityResponseMeta; }),
...
var ListEntityResponse = /** @class */ (function (_super) {
    ...
    ], ListEntityResponse.prototype, "rawResponse", void 0);
