...
func (s *WorkType) WorkTypeAPIDelete(ctx context.Context, request operations.WorkTypeAPIDeleteRequest) (*operations.WorkTypeAPIDeleteResponse, error) {
	baseURL := s._serverURL
...
func (s *WorkType) WorkTypeAPINew(ctx context.Context, request operations.WorkTypeAPINewRequest) (*operations.WorkTypeAPINewResponse, error) {
	baseURL := s._serverURL
...
func (s *WorkType) WorkTypeAPIUpdate(ctx context.Context, request operations.WorkTypeAPIUpdateRequest) (*operations.WorkTypeAPIUpdateResponse, error) {
	baseURL := s._serverURL
