...
var BucketAutoclass = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=toggleTime" }),
...
var BucketBilling = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=requesterPays" }),
        __metadata("design:type", Boolean)
...
var BucketCors = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=maxAgeSeconds" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=responseHeader" }),
        __metadata("design:type", Array)
...
var BucketCustomPlacementConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dataLocations" }),
        __metadata("design:type", Array)
...
var BucketEncryption = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=defaultKmsKeyName" }),
...
var BucketIamConfigurationBucketPolicyOnly = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=lockedTime" }),
        __metadata("design:type", Date)
...
var BucketIamConfiguration = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=bucketPolicyOnly" }),
        __metadata("design:type", BucketIamConfigurationBucketPolicyOnly)
    ], BucketIamConfiguration.prototype, "bucketPolicyOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=publicAccessPrevention" }),
        __metadata("design:type", String)
    ], BucketIamConfiguration.prototype, "publicAccessPrevention", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=uniformBucketLevelAccess" }),
...
var BucketLifecycleRuleCondition = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=customTimeBefore" }),
        __metadata("design:type", Date)
    ], BucketLifecycleRuleCondition.prototype, "customTimeBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=daysSinceCustomTime" }),
        __metadata("design:type", Number)
    ], BucketLifecycleRuleCondition.prototype, "daysSinceCustomTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=daysSinceNoncurrentTime" }),
        __metadata("design:type", Number)
    ], BucketLifecycleRuleCondition.prototype, "daysSinceNoncurrentTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=isLive" }),
        __metadata("design:type", Boolean)
    ], BucketLifecycleRuleCondition.prototype, "isLive", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=matchesPattern" }),
        __metadata("design:type", String)
    ], BucketLifecycleRuleCondition.prototype, "matchesPattern", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=matchesPrefix" }),
        __metadata("design:type", Array)
    ], BucketLifecycleRuleCondition.prototype, "matchesPrefix", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=matchesStorageClass" }),
        __metadata("design:type", Array)
    ], BucketLifecycleRuleCondition.prototype, "matchesStorageClass", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=matchesSuffix" }),
        __metadata("design:type", Array)
    ], BucketLifecycleRuleCondition.prototype, "matchesSuffix", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=noncurrentTimeBefore" }),
        __metadata("design:type", Date)
    ], BucketLifecycleRuleCondition.prototype, "noncurrentTimeBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=numNewerVersions" }),
        __metadata("design:type", Number)
...
var BucketLifecycle = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rule", elemType: BucketLifecycleRule }),
        __metadata("design:type", Array)
...
var BucketLogging = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=logBucket" }),
        __metadata("design:type", String)
    ], BucketLogging.prototype, "logBucket", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=logObjectPrefix" }),
        __metadata("design:type", String)
...
var BucketRetentionPolicy = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=effectiveTime" }),
        __metadata("design:type", Date)
    ], BucketRetentionPolicy.prototype, "effectiveTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=isLocked" }),
        __metadata("design:type", Boolean)
    ], BucketRetentionPolicy.prototype, "isLocked", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=retentionPeriod" }),
        __metadata("design:type", String)
...
var BucketWebsite = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mainPageSuffix" }),
        __metadata("design:type", String)
    ], BucketWebsite.prototype, "mainPageSuffix", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=notFoundPage" }),
        __metadata("design:type", String)
...
var Bucket = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=acl", elemType: bucketaccesscontrol_1.BucketAccessControl }),
        __metadata("design:type", Array)
    ], Bucket.prototype, "acl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=autoclass" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cors", elemType: BucketCors }),
        __metadata("design:type", Array)
    ], Bucket.prototype, "cors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=customPlacementConfig" }),
        __metadata("design:type", BucketCustomPlacementConfig)
    ], Bucket.prototype, "customPlacementConfig", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=defaultEventBasedHold" }),
        __metadata("design:type", Boolean)
    ], Bucket.prototype, "defaultEventBasedHold", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=defaultObjectAcl", elemType: objectaccesscontrol_1.ObjectAccessControl }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=iamConfiguration" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=metageneration" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rpo" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timeCreated" }),
        __metadata("design:type", Date)
