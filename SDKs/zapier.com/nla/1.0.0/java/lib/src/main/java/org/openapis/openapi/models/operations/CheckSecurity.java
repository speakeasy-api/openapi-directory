...
public class CheckSecurity {
    ...
    public CheckSecurity withAccessPointApiKeyHeader(String accessPointApiKeyHeader) {
    ...
    public CheckSecurity withAccessPointApiKeyQuery(String accessPointApiKeyQuery) {
    ...
    public CheckSecurity withAccessPointOAuth(String accessPointOAuth) {
    ...
    public CheckSecurity withSessionAuth(String sessionAuth) {
