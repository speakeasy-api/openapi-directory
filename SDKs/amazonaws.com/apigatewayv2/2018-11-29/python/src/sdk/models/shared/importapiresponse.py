...
class ImportAPIResponseCorsConfiguration:
    r"""ImportAPIResponseCorsConfiguration
...
class ImportAPIResponse:
    ...
    cors_configuration: Optional[ImportAPIResponseCorsConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CorsConfiguration') }})
