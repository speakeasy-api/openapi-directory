...
public class PresenceItem3 {
    ...
    public PresenceItem3 withCodeHex(String codeHex) {
    ...
    public PresenceItem3 withConfigRequest(java.util.Map<String, Object> configRequest) {
    ...
    public PresenceItem3 withCustom(Object custom) {
        this.custom = custom;
        return this;
    }
    ...
    public PresenceItem3 withGeoCoords(GeoCoordsReadOnly geoCoords) {
    ...
    public PresenceItem3 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public PresenceItem3 withIsPresent(Boolean isPresent) {
    ...
    public PresenceItem3 withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public PresenceItem3 withLocationRequest(String locationRequest) {
    ...
    public PresenceItem3 withLocationUrl(String locationUrl) {
    ...
    public PresenceItem3 withMetadata(java.util.Map<String, Object> metadata) {
    ...
    public PresenceItem3 withMoveCount(Long moveCount) {
    ...
    public PresenceItem3 withProtocol(ItemProtocolEnum protocol) {
    ...
    public PresenceItem3 withSets(String[] sets) {
        this.sets = sets;
        return this;
    }
    ...
    public PresenceItem3 withTechnology(TechnologyEnum technology) {
    ...
    public PresenceItem3 withTimeCreated(String timeCreated) {
    ...
    public PresenceItem3 withTimeLastPresent(String timeLastPresent) {
    ...
    public PresenceItem3 withTimeMoved(String timeMoved) {
    ...
    public PresenceItem3 withTimeUpdated(String timeUpdated) {
    ...
    public PresenceItem3 withType(ItemTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public PresenceItem3 withUrl(String url) {
        this.url = url;
        return this;
    }
    
    public PresenceItem3(){}
}
