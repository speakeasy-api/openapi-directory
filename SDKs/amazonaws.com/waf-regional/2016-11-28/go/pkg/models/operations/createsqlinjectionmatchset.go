...
const (
	CreateSQLInjectionMatchSetXAmzTargetEnumAwswafRegional20161128CreateSQLInjectionMatchSet CreateSQLInjectionMatchSetXAmzTargetEnum = "AWSWAF_Regional_20161128.CreateSqlInjectionMatchSet"
)
