...
type DeletePoolXAmzTargetEnum string
...
type DeletePoolHeaders struct {
	...
	XAmzTarget        DeletePoolXAmzTargetEnum `header:"style=simple,explode=false,name=X-Amz-Target"`
}

type DeletePoolRequest struct {
	Headers DeletePoolHeaders
	Request shared.DeletePoolRequest `request:"mediaType=application/json"`
}
