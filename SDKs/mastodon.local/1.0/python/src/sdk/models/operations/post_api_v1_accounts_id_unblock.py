...
class PostAPIV1AccountsIDUnblockSecurity:
    
    bearer_auth: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'http', 'sub_type': 'bearer', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class PostAPIV1AccountsIDUnblockRequest:
...
@dataclasses.dataclass
class PostAPIV1AccountsIDUnblockResponse:
    ...
    r"""Successfully unblocked, or account was already not blocked"""  
