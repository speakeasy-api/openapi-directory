...
class StartNetworkInsightsAccessScopeAnalysisRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class StartNetworkInsightsAccessScopeAnalysisRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class StartNetworkInsightsAccessScopeAnalysisRequestTagSpecifications:
    ...
    resource_type: Optional[StartNetworkInsightsAccessScopeAnalysisRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[StartNetworkInsightsAccessScopeAnalysisRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class StartNetworkInsightsAccessScopeAnalysisRequest:
    ...
    network_insights_access_scope_id: str = dataclasses.field()  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[StartNetworkInsightsAccessScopeAnalysisRequestTagSpecifications]] = dataclasses.field(default=None)  
