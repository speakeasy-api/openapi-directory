...
public class GetDeviceWirelessConnectionStatsRequest {
    ...
    public String apTag;
    public GetDeviceWirelessConnectionStatsRequest withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetDeviceWirelessConnectionStatsRequest withBand(GetDeviceWirelessConnectionStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public GetDeviceWirelessConnectionStatsRequest withSerial(String serial) {
        this.serial = serial;
        return this;
    }
    ...
    public Long ssid;
    public GetDeviceWirelessConnectionStatsRequest withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetDeviceWirelessConnectionStatsRequest withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetDeviceWirelessConnectionStatsRequest withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetDeviceWirelessConnectionStatsRequest withTimespan(Float timespan) {
    ...
    public Long vlan;
    public GetDeviceWirelessConnectionStatsRequest withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
