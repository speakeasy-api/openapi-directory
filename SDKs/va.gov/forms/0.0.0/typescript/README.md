...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/va.gov/forms/0.0.0/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/va.gov/forms/0.0.0/typescript
```
