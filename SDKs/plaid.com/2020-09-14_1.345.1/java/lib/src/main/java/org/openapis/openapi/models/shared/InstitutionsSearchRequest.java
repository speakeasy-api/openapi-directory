...
public class InstitutionsSearchRequest {
    ...
    public InstitutionsSearchRequest(@JsonProperty("country_codes") CountryCodeEnum[] countryCodes, @JsonProperty("products") ProductsEnum[] products, @JsonProperty("query") String query) {
        this.countryCodes = countryCodes;
        this.products = products;
        this.query = query;
  }
