...
class ListResolverRuleAssociationsRequest:
    ...
    list_resolver_rule_associations_request: shared_listresolverruleassociationsrequest.ListResolverRuleAssociationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
