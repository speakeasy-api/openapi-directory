...
public class UpdatepartialdocumentRequest {
    ...
    public UpdatepartialdocumentRequest(@JsonProperty("Accept") String accept, @JsonProperty("RequestBody") java.util.Map<String, Object> requestBody, @JsonProperty("acronym") String acronym, @JsonProperty("id") String id) {
        this.accept = accept;
        this.requestBody = requestBody;
        this.acronym = acronym;
        this.id = id;
