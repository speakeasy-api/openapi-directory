...
class IdentityGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\IdentityGetRequestOptions $options
     */
	#[\JMS\Serializer\Annotation\SerializedName('options')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\IdentityGetRequestOptions')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?IdentityGetRequestOptions $options = null;
