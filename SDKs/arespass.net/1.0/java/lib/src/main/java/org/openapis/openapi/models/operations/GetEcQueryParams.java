...
public class GetEcQueryParams {
    ...
    public GetEcQueryParams withOutputFormat(String outputFormat) {
    ...
    public GetEcQueryParams withPassword(String password) {
    ...
    public GetEcQueryParams withPenalty(Double penalty) {
    ...
    public String reqId;
    public GetEcQueryParams withReqId(String reqId) {
        this.reqId = reqId;
        return this;
    }
