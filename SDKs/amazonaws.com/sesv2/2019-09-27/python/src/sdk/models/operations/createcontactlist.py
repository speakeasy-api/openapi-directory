...
class CreateContactListHeaders:
...
class CreateContactListRequest:
    headers: CreateContactListHeaders = dataclasses.field()
    request: CreateContactListRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
