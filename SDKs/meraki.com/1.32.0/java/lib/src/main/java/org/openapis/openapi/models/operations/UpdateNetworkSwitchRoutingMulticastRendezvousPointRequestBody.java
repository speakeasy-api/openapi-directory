...
public class UpdateNetworkSwitchRoutingMulticastRendezvousPointRequestBody {
    ...
    public UpdateNetworkSwitchRoutingMulticastRendezvousPointRequestBody(@JsonProperty("interfaceIp") String interfaceIp, @JsonProperty("multicastGroup") String multicastGroup) {
        this.interfaceIp = interfaceIp;
        this.multicastGroup = multicastGroup;
  }
}
