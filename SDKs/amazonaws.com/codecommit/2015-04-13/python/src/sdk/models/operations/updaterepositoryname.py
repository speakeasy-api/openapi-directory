...
class UpdateRepositoryNameRequest:
    headers: UpdateRepositoryNameHeaders = dataclasses.field()
    request: shared_updaterepositorynameinput.UpdateRepositoryNameInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
