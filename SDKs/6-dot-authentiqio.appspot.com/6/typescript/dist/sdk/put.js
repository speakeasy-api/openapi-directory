...
var Put = /** @class */ (function () {
    function Put(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    Put.prototype.keyBind = function (req, config) {
        var _a;
     ...
     *
    **/
    Put.prototype.signUpdate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
