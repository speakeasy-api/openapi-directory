...
type ContainerProjectsZonesClustersLoggingSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContainerProjectsZonesClustersLoggingPathParams struct {
...
type ContainerProjectsZonesClustersLoggingQueryParams struct {
	// V1 error format.
...
type ContainerProjectsZonesClustersLoggingRequest struct {
	PathParams  ContainerProjectsZonesClustersLoggingPathParams
	QueryParams ContainerProjectsZonesClustersLoggingQueryParams
	Request     *shared.SetLoggingServiceRequest `request:"mediaType=application/json"`
	Security    ContainerProjectsZonesClustersLoggingSecurity
}

type ContainerProjectsZonesClustersLoggingResponse struct {
	ContentType string
	// Successful response
