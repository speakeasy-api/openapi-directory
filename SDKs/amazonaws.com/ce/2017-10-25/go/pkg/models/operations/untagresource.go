...
const (
	UntagResourceXAmzTargetEnumAwsInsightsIndexServiceUntagResource UntagResourceXAmzTargetEnum = "AWSInsightsIndexService.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AWSInsightsIndexService.UntagResource":
