 ...
 */
export declare enum ReservationListWarningCodeEnum {
...
export declare class ReservationListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ReservationListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: ReservationListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: ReservationListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class ReservationList extends SpeakeasyBase {
    /**
