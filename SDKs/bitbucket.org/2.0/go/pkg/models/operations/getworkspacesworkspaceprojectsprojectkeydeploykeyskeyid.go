...
type GetWorkspacesWorkspaceProjectsProjectKeyDeployKeysKeyIDPathParams struct {
...
type GetWorkspacesWorkspaceProjectsProjectKeyDeployKeysKeyIDRequest struct {
	PathParams GetWorkspacesWorkspaceProjectsProjectKeyDeployKeysKeyIDPathParams
	Security   GetWorkspacesWorkspaceProjectsProjectKeyDeployKeysKeyIDSecurity
}
