...
class RunProjectsLocationsConfigurationsListRequest:
    path_params: RunProjectsLocationsConfigurationsListPathParams = dataclasses.field()
    query_params: RunProjectsLocationsConfigurationsListQueryParams = dataclasses.field()
    security: RunProjectsLocationsConfigurationsListSecurity = dataclasses.field()
