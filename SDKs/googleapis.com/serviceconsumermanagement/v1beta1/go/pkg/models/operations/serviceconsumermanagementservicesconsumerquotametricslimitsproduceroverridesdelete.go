...
func (e ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteForceOnlyEnum) ToPointer() *ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteForceOnlyEnum {
	return &e
}
...
func (e *ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteForceOnlyEnum) UnmarshalJSON(data []byte) error {
	...
	case "LIMIT_DECREASE_PERCENTAGE_TOO_HIGH":
		*e = ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteForceOnlyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteForceOnlyEnum: %v", v)
	}
}
