...
public class DisassociateDeviceFromPlacementRequest {
    ...
    public DisassociateDeviceFromPlacementRequest(@JsonProperty("deviceTemplateName") String deviceTemplateName, @JsonProperty("placementName") String placementName, @JsonProperty("projectName") String projectName) {
        this.deviceTemplateName = deviceTemplateName;
        this.placementName = placementName;
        this.projectName = projectName;
  }
