...
class ListDomainDeliverabilityCampaignsRequest:
    ...
    r"""The last day that you want to obtain deliverability data for. This value has to be less than or equal to 30 days after the value of the <code>StartDate</code> parameter."""  
    start_date: datetime = dataclasses.field(metadata={'query_param': { 'field_name': 'StartDate', 'style': 'form', 'explode': True }})
    r"""The first day that you want to obtain deliverability data for."""  
