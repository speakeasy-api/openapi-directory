...
class UpdateRateBasedRuleRequest:
    ...
    update_rate_based_rule_request: shared_updateratebasedrulerequest.UpdateRateBasedRuleRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
