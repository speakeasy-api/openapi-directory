...
class UpdateMatchmakingConfigurationRequest:
    ...
    update_matchmaking_configuration_input: shared_updatematchmakingconfigurationinput.UpdateMatchmakingConfigurationInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
