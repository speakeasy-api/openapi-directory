 ...
 */
export class GetIpamDiscoveredResourceCidrsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class GetIpamDiscoveredResourceCidrsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: GetIpamDiscoveredResourceCidrsRequestFilters })
