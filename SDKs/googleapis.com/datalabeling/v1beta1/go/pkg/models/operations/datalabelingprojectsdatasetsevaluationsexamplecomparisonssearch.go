...
type DatalabelingProjectsDatasetsEvaluationsExampleComparisonsSearchRequest struct {
	...
	GoogleCloudDatalabelingV1beta1SearchExampleComparisonsRequest *shared.GoogleCloudDatalabelingV1beta1SearchExampleComparisonsRequest `request:"mediaType=application/json"`
	// OAuth access token.
