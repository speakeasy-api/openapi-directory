...
var EventNotification = /** @class */ (function () {
    function EventNotification(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    EventNotification.prototype.createEventNotification = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateEventNotificationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/event-notifications";
