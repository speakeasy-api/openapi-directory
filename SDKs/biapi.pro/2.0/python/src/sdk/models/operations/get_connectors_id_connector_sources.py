...
class GetConnectorsIDConnectorSourcesResponse:
    ...
    get_connectors_id_connector_sources_200_application_json_object: Optional[GetConnectorsIDConnectorSources200ApplicationJSON] = dataclasses.field(default=None)
    r"""sources"""  
