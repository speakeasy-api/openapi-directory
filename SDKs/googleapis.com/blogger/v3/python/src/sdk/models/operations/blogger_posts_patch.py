...
class BloggerPostsPatchRequest:
    path_params: BloggerPostsPatchPathParams = dataclasses.field()
    query_params: BloggerPostsPatchQueryParams = dataclasses.field()
    security: BloggerPostsPatchSecurity = dataclasses.field()
