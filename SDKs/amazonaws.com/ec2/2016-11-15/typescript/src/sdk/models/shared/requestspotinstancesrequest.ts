 ...
 */
export enum RequestSpotInstancesRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class RequestSpotInstancesRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class RequestSpotInstancesRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum RequestSpotInstancesRequestTypeEnum {
  OneTime = "one-time",
 ...
 */
export class RequestSpotInstancesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: RequestSpotInstancesRequestTagSpecifications })
