...
public class ListRoomParticipantPublishedTrackSecurity {
    ...
    public ListRoomParticipantPublishedTrackSecurity withPassword(String password) {
    ...
    public ListRoomParticipantPublishedTrackSecurity withUsername(String username) {
