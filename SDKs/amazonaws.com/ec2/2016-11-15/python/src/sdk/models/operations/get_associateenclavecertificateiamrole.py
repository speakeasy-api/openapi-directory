...
class GETAssociateEnclaveCertificateIamRoleRequest:
    ...
    certificate_arn: str = dataclasses.field(metadata={'query_param': { 'field_name': 'CertificateArn', 'style': 'form', 'explode': True }})
    r"""The ARN of the ACM certificate with which to associate the IAM role."""  
    role_arn: str = dataclasses.field(metadata={'query_param': { 'field_name': 'RoleArn', 'style': 'form', 'explode': True }})
    r"""The ARN of the IAM role to associate with the ACM certificate. You can associate up to 16 IAM roles with an ACM certificate."""  
