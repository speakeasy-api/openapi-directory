 ...
 */
export declare enum SubnetworksScopedListWarningCodeEnum {
...
export declare class SubnetworksScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class SubnetworksScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class SubnetworksScopedList extends SpeakeasyBase {
    /**
