...
func (s *pipelines) GenomicsPipelinesRun(ctx context.Context, request operations.GenomicsPipelinesRunRequest, security operations.GenomicsPipelinesRunSecurity) (*operations.GenomicsPipelinesRunResponse, error) {
	baseURL := s.serverURL
