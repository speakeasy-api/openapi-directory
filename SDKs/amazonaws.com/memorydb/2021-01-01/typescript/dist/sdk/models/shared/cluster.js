...
var Cluster = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ACLName" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=AvailabilityMode" }),
        __metadata("design:type", String)
    ], Cluster.prototype, "availabilityMode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ClusterEndpoint" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=EnginePatchVersion" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=NodeType" }),
        __metadata("design:type", String)
    ], Cluster.prototype, "nodeType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=NumberOfShards" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ParameterGroupStatus" }),
        __metadata("design:type", String)
    ], Cluster.prototype, "parameterGroupStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=PendingUpdates" }),
        __metadata("design:type", clusterpendingupdates_1.ClusterPendingUpdates)
    ], Cluster.prototype, "pendingUpdates", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SecurityGroups", elemType: securitygroupmembership_1.SecurityGroupMembership }),
        __metadata("design:type", Array)
    ], Cluster.prototype, "securityGroups", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Shards", elemType: shard_1.Shard }),
        __metadata("design:type", Array)
    ], Cluster.prototype, "shards", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SnapshotRetentionLimit" }),
        __metadata("design:type", Number)
    ], Cluster.prototype, "snapshotRetentionLimit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SnapshotWindow" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SnsTopicStatus" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TLSEnabled" }),
        __metadata("design:type", Boolean)
