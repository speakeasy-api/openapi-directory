 ...
 */
export const ServerList = ["https://nla.zapier.com"] as const;
...
export class SDK {
  ...
  check(config?: AxiosRequestConfig): Promise<operations.CheckResponse> {
    ...
    const url: string = baseURL.replace(/\/$/, "") + "/api/v1/check/";
  ...
  executeAppActionEndpoint(
    req: operations.ExecuteAppActionEndpointRequest,
    security: operations.ExecuteAppActionEndpointSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ExecuteAppActionEndpointResponse> {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ExecuteAppActionEndpointResponse =
        new operations.ExecuteAppActionEndpointResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.executeResponse = utils.objectToClass(
              httpRes?.data,
              shared.ExecuteResponse
            );
          }
          break;
  ...
  getConfigurationLink(
    config?: AxiosRequestConfig
  ): Promise<operations.GetConfigurationLinkResponse> {
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api/v1/configuration-link/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetConfigurationLinkResponse =
        new operations.GetConfigurationLinkResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  listExposedActions(
    config?: AxiosRequestConfig
  ): Promise<operations.ListExposedActionsResponse> {
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/api/v1/exposed/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListExposedActionsResponse =
        new operations.ListExposedActionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.exposedActionResponseSchema = utils.objectToClass(
              httpRes?.data,
              shared.ExposedActionResponseSchema
            );
          }
          break;
      }
