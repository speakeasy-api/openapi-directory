...
func (e *GetNetworksIDActionsActionIDActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = GetNetworksIDActionsActionIDActionResponseActionStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworksIDActionsActionIDActionResponseActionStatusEnum: %s", s)
	}
}
