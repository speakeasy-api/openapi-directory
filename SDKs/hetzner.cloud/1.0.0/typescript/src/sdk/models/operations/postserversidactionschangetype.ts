...
export class PostServersIdActionsChangeTypeActionResponseAction extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => PostServersIdActionsChangeTypeActionResponseActionError)
  ...
  @Type(() => PostServersIdActionsChangeTypeActionResponseActionResources)
...
export class PostServersIdActionsChangeTypeActionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "action" })
  @Type(() => PostServersIdActionsChangeTypeActionResponseAction)
