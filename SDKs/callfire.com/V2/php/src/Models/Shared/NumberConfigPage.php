...
/**
 * NumberConfigPage - Represents a page with results returned by query operation. Check [pagination](https://developers.callfire.com/docs.html#pagination) page for more information about pagination in CallFire API.
 * 
...
class NumberConfigPage
{
     ...
     * $items
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Shared\NumberConfig> $items
     */
	#[\JMS\Serializer\Annotation\SerializedName('items')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Shared\NumberConfig>')]
