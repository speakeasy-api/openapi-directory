...
from ..shared import proxygetcreditbalanceadjustment as shared_proxygetcreditbalanceadjustment
...
class ObjectGETCreditBalanceAdjustmentResponse:
    ...
    proxy_get_credit_balance_adjustment: Optional[shared_proxygetcreditbalanceadjustment.ProxyGetCreditBalanceAdjustment] = dataclasses.field(default=None)  
