...
class UpdatePaymentRequest:
    ...
    request_body: list[shared_paymenthistory.PaymentHistory] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Payment history object that you would like to update."""  
...
class UpdatePaymentResponse:
    ...
    r"""Payment history updated successfully."""  
