...
class DeleteRepositoriesWorkspaceRepoSlugHooksUIDRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugHooksUIDPathParams = dataclasses.field()
    security: DeleteRepositoriesWorkspaceRepoSlugHooksUIDSecurity = dataclasses.field()
