...
export class NetworkmanagementProjectsLocationsGlobalConnectivityTestsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworkmanagementProjectsLocationsGlobalConnectivityTestsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=testId",
  })
  testId?: string;
...
export class NetworkmanagementProjectsLocationsGlobalConnectivityTestsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
