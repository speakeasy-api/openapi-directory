...
use \OpenAPI\OpenAPI\Models\Operations\DgmstRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\DgmstRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\DgmstRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\DgmstSecurity;
...
try {
    ...
    $request->certificateParameters = new DgmstRequestBodyCertificateParameters();
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->rroll = '17001020013';
    $request->certificateParameters->sem = '1 / First Year,2 / First Year,3 / Second Year,4 / Second Year,5 / Third Year,6 / Third Year';
    ...
    $request->format = DgmstRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new DgmstSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->dgmst($request, $requestSecurity);
