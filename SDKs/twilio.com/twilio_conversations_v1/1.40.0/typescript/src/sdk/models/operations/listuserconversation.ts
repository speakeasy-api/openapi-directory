...
export class ListUserConversationListUserConversationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.ConversationsV1UserUserConversation })
  @Expose({ name: "conversations" })
  @Type(() => shared.ConversationsV1UserUserConversation)
  conversations?: shared.ConversationsV1UserUserConversation[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListUserConversationListUserConversationResponseMeta)
