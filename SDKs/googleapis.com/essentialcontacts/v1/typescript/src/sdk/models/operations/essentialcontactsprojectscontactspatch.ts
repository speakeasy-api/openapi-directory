...
export class EssentialcontactsProjectsContactsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class EssentialcontactsProjectsContactsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class EssentialcontactsProjectsContactsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
