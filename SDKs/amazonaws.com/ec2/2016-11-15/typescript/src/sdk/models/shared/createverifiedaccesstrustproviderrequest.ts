 ...
 */
export enum CreateVerifiedAccessTrustProviderRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateVerifiedAccessTrustProviderRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateVerifiedAccessTrustProviderRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateVerifiedAccessTrustProviderRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken?: string;
