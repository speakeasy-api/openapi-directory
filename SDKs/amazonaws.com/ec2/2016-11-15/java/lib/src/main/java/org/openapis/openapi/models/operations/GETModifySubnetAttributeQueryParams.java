...
public class GETModifySubnetAttributeQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=Action")
    public GETModifySubnetAttributeActionEnum action;
    public GETModifySubnetAttributeQueryParams withAction(GETModifySubnetAttributeActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETModifySubnetAttributeQueryParams withAssignIpv6AddressOnCreation(GETModifySubnetAttributeAssignIpv6AddressOnCreation assignIpv6AddressOnCreation) {
    ...
    public GETModifySubnetAttributeQueryParams withCustomerOwnedIpv4Pool(String customerOwnedIpv4Pool) {
    ...
    public GETModifySubnetAttributeQueryParams withDisableLniAtDeviceIndex(GETModifySubnetAttributeDisableLniAtDeviceIndex disableLniAtDeviceIndex) {
    ...
    public GETModifySubnetAttributeQueryParams withEnableDns64(GETModifySubnetAttributeEnableDns64 enableDns64) {
    ...
    public GETModifySubnetAttributeQueryParams withEnableLniAtDeviceIndex(Long enableLniAtDeviceIndex) {
    ...
    public GETModifySubnetAttributeQueryParams withEnableResourceNameDnsAAAARecordOnLaunch(GETModifySubnetAttributeEnableResourceNameDNSAaaaRecordOnLaunch enableResourceNameDnsAAAARecordOnLaunch) {
    ...
    public GETModifySubnetAttributeQueryParams withEnableResourceNameDnsARecordOnLaunch(GETModifySubnetAttributeEnableResourceNameDNSARecordOnLaunch enableResourceNameDnsARecordOnLaunch) {
    ...
    public GETModifySubnetAttributeQueryParams withMapCustomerOwnedIpOnLaunch(GETModifySubnetAttributeMapCustomerOwnedIPOnLaunch mapCustomerOwnedIpOnLaunch) {
    ...
    public GETModifySubnetAttributeQueryParams withMapPublicIpOnLaunch(GETModifySubnetAttributeMapPublicIPOnLaunch mapPublicIpOnLaunch) {
    ...
    public GETModifySubnetAttributeQueryParams withPrivateDnsHostnameTypeOnLaunch(GETModifySubnetAttributePrivateDNSHostnameTypeOnLaunchEnum privateDnsHostnameTypeOnLaunch) {
    ...
    public GETModifySubnetAttributeQueryParams withSubnetId(String subnetId) {
    ...
    public GETModifySubnetAttributeQueryParams withVersion(GETModifySubnetAttributeVersionEnum version) {
