 ...
 */
export enum CreateInternetGatewayRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateInternetGatewayRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateInternetGatewayRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateInternetGatewayRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
