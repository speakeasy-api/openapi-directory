 ...
 */
export class SearchLocalGatewayRoutesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class SearchLocalGatewayRoutesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: SearchLocalGatewayRoutesRequestFilters })
