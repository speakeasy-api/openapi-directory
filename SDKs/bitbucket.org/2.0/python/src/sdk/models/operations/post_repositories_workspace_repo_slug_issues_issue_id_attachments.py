...
class PostRepositoriesWorkspaceRepoSlugIssuesIssueIDAttachmentsRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugIssuesIssueIDAttachmentsPathParams = dataclasses.field()
    security: PostRepositoriesWorkspaceRepoSlugIssuesIssueIDAttachmentsSecurity = dataclasses.field()
