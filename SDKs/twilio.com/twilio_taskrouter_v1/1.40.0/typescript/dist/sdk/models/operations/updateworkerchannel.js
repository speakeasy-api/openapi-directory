...
exports.UpdateWorkerChannelResponse = exports.UpdateWorkerChannelRequest = exports.UpdateWorkerChannelUpdateWorkerChannelRequest = exports.UpdateWorkerChannelSecurity = exports.UpdateWorkerChannelServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.UpdateWorkerChannelServerList = [
...
var UpdateWorkerChannelSecurity = /** @class */ (function (_super) {
    ...
    ], UpdateWorkerChannelSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], UpdateWorkerChannelSecurity.prototype, "username", void 0);
    return UpdateWorkerChannelSecurity;
}(utils_1.SpeakeasyBase));
exports.UpdateWorkerChannelSecurity = UpdateWorkerChannelSecurity;
var UpdateWorkerChannelUpdateWorkerChannelRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=Capacity" }),
...
exports.UpdateWorkerChannelUpdateWorkerChannelRequest = UpdateWorkerChannelUpdateWorkerChannelRequest;
var UpdateWorkerChannelRequest = /** @class */ (function (_super) {
    ...
    ], UpdateWorkerChannelRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=Sid" }),
        __metadata("design:type", String)
    ], UpdateWorkerChannelRequest.prototype, "sid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkerSid",
        }),
        __metadata("design:type", String)
    ], UpdateWorkerChannelRequest.prototype, "workerSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], UpdateWorkerChannelRequest.prototype, "workspaceSid", void 0);
    return UpdateWorkerChannelRequest;
}(utils_1.SpeakeasyBase));
exports.UpdateWorkerChannelRequest = UpdateWorkerChannelRequest;
var UpdateWorkerChannelResponse = /** @class */ (function (_super) {
    ...
    ], UpdateWorkerChannelResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.UpdateWorkerChannelResponse = UpdateWorkerChannelResponse;
