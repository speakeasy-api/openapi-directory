...
var FirmwareRiskRiskSummary = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "client_tools_risk" }),
        __metadata("design:type", String)
    ], FirmwareRiskRiskSummary.prototype, "clientToolsRisk", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "crypto_risk" }),
        __metadata("design:type", String)
    ], FirmwareRiskRiskSummary.prototype, "cryptoRisk", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kernel_risk" }),
        __metadata("design:type", String)
    ], FirmwareRiskRiskSummary.prototype, "kernelRisk", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "net_services_risk" }),
        __metadata("design:type", String)
...
var FirmwareRisk = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "risk_summary" }),
        (0, class_transformer_1.Type)(function () { return FirmwareRiskRiskSummary; }),
        __metadata("design:type", FirmwareRiskRiskSummary)
    ], FirmwareRisk.prototype, "riskSummary", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: vulnerablecomponent_1.VulnerableComponent }),
        (0, class_transformer_1.Expose)({ name: "vulnerable_components" }),
        (0, class_transformer_1.Type)(function () { return vulnerablecomponent_1.VulnerableComponent; }),
