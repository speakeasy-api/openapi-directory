...
class GetDomainResponse:
    ...
    get_domain_200_application_json_any: Optional[Any] = dataclasses.field(default=None)
    get_domain_401_application_json_object: Optional[GetDomain401ApplicationJSON] = dataclasses.field(default=None)
