...
class SyncV1ServiceSyncListSyncListItem:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the List Item resource."""  
    ...
    r"""The identity of the List Item's creator. If the item is created from the client SDK, the value matches the Access Token's `identity` field. If the item was created from the REST API, the value is `system`."""  
    ...
    r"""An arbitrary, schema-less object that the List Item stores. Can be up to 16 KiB in length."""  
    ...
    r"""The date and time in GMT when the List Item expires and will be deleted, specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. If the List Item does not expire, this value is `null`. The List Item resource might not be deleted immediately after it expires."""  
    ...
    r"""The automatically generated index of the List Item. The `index` values of the List Items in a Sync List can have gaps in their sequence."""  
    ...
    r"""The SID of the Sync List that contains the List Item."""  
    ...
    r"""The current revision of the item, represented as a string."""  
    ...
    r"""The absolute URL of the List Item resource."""  
