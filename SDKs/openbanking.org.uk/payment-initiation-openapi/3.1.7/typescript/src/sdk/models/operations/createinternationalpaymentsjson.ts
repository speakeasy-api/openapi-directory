...
export class CreateInternationalPaymentsJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateInternationalPaymentsJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateInternationalPaymentsJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
