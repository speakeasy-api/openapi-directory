...
export class Dashboards {
  ...
  dashboardCRC(
    ...
    security: operations.DashboardCRCSecurity,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DashboardCRCResponse =
        new operations.DashboardCRCResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardCRC200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.DashboardCrc200ApplicationJSON
            );
          }
  ...
  dashboardClientFeedback(
    ...
    security: operations.DashboardClientFeedbackSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardClientFeedbackResponse =
        new operations.DashboardClientFeedbackResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardClientFeedback200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.DashboardClientFeedback200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardClientFeedbackDetail(
    ...
    security: operations.DashboardClientFeedbackDetailSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardClientFeedbackDetailResponse =
        new operations.DashboardClientFeedbackDetailResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardClientFeedbackDetail200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.DashboardClientFeedbackDetail200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardIM(
    ...
    security: operations.DashboardIMSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardIMResponse =
        new operations.DashboardIMResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardIM200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.DashboardIm200ApplicationJSON
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardIssueDetailZoomRoom(
    ...
    security: operations.DashboardIssueDetailZoomRoomSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardIssueDetailZoomRoomResponse =
        new operations.DashboardIssueDetailZoomRoomResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardIssueDetailZoomRoom200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.DashboardIssueDetailZoomRoom200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardIssueZoomRoom(
    ...
    security: operations.DashboardIssueZoomRoomSecurity,
    config?: AxiosRequestConfig
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/metrics/issues/zoomrooms";
    if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardIssueZoomRoomResponse =
        new operations.DashboardIssueZoomRoomResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardIssueZoomRoom200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.DashboardIssueZoomRoom200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardMeetingDetail(
    ...
    security: operations.DashboardMeetingDetailSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardMeetingDetailResponse =
        new operations.DashboardMeetingDetailResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.meetingMetrics = utils.objectToClass(
              httpRes?.data,
              operations.DashboardMeetingDetailMeetingMetrics
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardMeetingParticipantQOS(
    ...
    security: operations.DashboardMeetingParticipantQOSSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DashboardMeetingParticipantQOSSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardMeetingParticipantQOSResponse =
        new operations.DashboardMeetingParticipantQOSResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.participantQOS = utils.objectToClass(
              httpRes?.data,
              operations.DashboardMeetingParticipantQOSParticipantQOS
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardMeetingParticipantShare(
    ...
    security: operations.DashboardMeetingParticipantShareSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DashboardMeetingParticipantShareSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardMeetingParticipantShareResponse =
        new operations.DashboardMeetingParticipantShareResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardMeetingParticipantShare200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.DashboardMeetingParticipantShare200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardMeetingParticipants(
    ...
    security: operations.DashboardMeetingParticipantsSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardMeetingParticipantsResponse =
        new operations.DashboardMeetingParticipantsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardMeetingParticipants200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.DashboardMeetingParticipants200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardMeetingParticipantsQOS(
    ...
    security: operations.DashboardMeetingParticipantsQOSSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DashboardMeetingParticipantsQOSSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardMeetingParticipantsQOSResponse =
        new operations.DashboardMeetingParticipantsQOSResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.participantQOSList = utils.objectToClass(
              httpRes?.data,
              operations.DashboardMeetingParticipantsQOSParticipantQOSList
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardMeetings(
    ...
    security: operations.DashboardMeetingsSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardMeetingsResponse =
        new operations.DashboardMeetingsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardMeetings200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.DashboardMeetings200ApplicationJSON
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardWebinarDetail(
    ...
    security: operations.DashboardWebinarDetailSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardWebinarDetailResponse =
        new operations.DashboardWebinarDetailResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.webinarMetrics = utils.objectToClass(
              httpRes?.data,
              operations.DashboardWebinarDetailWebinarMetrics
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardWebinarParticipantQOS(
    ...
    security: operations.DashboardWebinarParticipantQOSSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DashboardWebinarParticipantQOSSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardWebinarParticipantQOSResponse =
        new operations.DashboardWebinarParticipantQOSResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.participantQOS = utils.objectToClass(
              httpRes?.data,
              operations.DashboardWebinarParticipantQOSParticipantQOS
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardWebinarParticipantShare(
    ...
    security: operations.DashboardWebinarParticipantShareSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DashboardWebinarParticipantShareSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardWebinarParticipantShareResponse =
        new operations.DashboardWebinarParticipantShareResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardWebinarParticipantShare200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.DashboardWebinarParticipantShare200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardWebinarParticipants(
    ...
    security: operations.DashboardWebinarParticipantsSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardWebinarParticipantsResponse =
        new operations.DashboardWebinarParticipantsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardWebinarParticipants200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.DashboardWebinarParticipants200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardWebinarParticipantsQOS(
    ...
    security: operations.DashboardWebinarParticipantsQOSSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DashboardWebinarParticipantsQOSSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardWebinarParticipantsQOSResponse =
        new operations.DashboardWebinarParticipantsQOSResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.participantQOSList = utils.objectToClass(
              httpRes?.data,
              operations.DashboardWebinarParticipantsQOSParticipantQOSList
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardWebinars(
    ...
    security: operations.DashboardWebinarsSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardWebinarsResponse =
        new operations.DashboardWebinarsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardWebinars200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.DashboardWebinars200ApplicationJSON
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardZoomRoom(
    ...
    security: operations.DashboardZoomRoomSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardZoomRoomResponse =
        new operations.DashboardZoomRoomResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.zoomRoom = utils.objectToClass(
              httpRes?.data,
              operations.DashboardZoomRoomZoomRoom
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardZoomRoomIssue(
    ...
    security: operations.DashboardZoomRoomIssueSecurity,
    config?: AxiosRequestConfig
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/metrics/zoomrooms/issues";
    if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardZoomRoomIssueResponse =
        new operations.DashboardZoomRoomIssueResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dashboardZoomRoomIssue200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.DashboardZoomRoomIssue200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  dashboardZoomRooms(
    ...
    security: operations.DashboardZoomRoomsSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DashboardZoomRoomsResponse =
        new operations.DashboardZoomRoomsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.zoomRoomList = utils.objectToClass(
              httpRes?.data,
              operations.DashboardZoomRoomsZoomRoomList
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getCallLogMetricsDetails(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetCallLogMetricsDetailsResponse =
        new operations.GetCallLogMetricsDetailsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getCallLogMetricsDetails200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetCallLogMetricsDetails200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getCallQoS(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetCallQoSResponse =
        new operations.GetCallQoSResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getCallQoS200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.GetCallQoS200ApplicationJSON
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  listCallLogsMetrics(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListCallLogsMetricsResponse =
        new operations.ListCallLogsMetricsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listCallLogsMetrics200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.ListCallLogsMetrics200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  listMeetingSatisfaction(
    ...
    security: operations.ListMeetingSatisfactionSecurity,
    config?: AxiosRequestConfig
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/metrics/client/satisfaction";
    if (!(security instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListMeetingSatisfactionResponse =
        new operations.ListMeetingSatisfactionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listMeetingSatisfaction200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.ListMeetingSatisfaction200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  participantFeedback(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ParticipantFeedbackResponse =
        new operations.ParticipantFeedbackResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.participantFeedback200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.ParticipantFeedback200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  participantWebinarFeedback(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ParticipantWebinarFeedbackResponse =
        new operations.ParticipantWebinarFeedbackResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.participantWebinarFeedback200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.ParticipantWebinarFeedback200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
