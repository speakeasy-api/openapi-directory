...
class GetPhenotypeDiseaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPhenotypeDiseaseAssociationsQueryParams:
...
class GetPhenotypeDiseaseAssociationsRequest:
    path_params: GetPhenotypeDiseaseAssociationsPathParams = dataclasses.field()
    query_params: GetPhenotypeDiseaseAssociationsQueryParams = dataclasses.field()
