...
class ReactionsListForReleaseContentEnum(str, Enum):
    r"""Returns a single [reaction type](https://docs.github.com/enterprise-server@3.3/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a release."""
    PLUS_1 = '+1'
    LAUGH = 'laugh'
    HEART = 'heart'
    HOORAY = 'hooray'
