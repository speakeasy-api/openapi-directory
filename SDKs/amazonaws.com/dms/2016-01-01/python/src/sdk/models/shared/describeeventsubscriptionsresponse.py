...
class DescribeEventSubscriptionsResponse:
    ...
    event_subscriptions_list: Optional[list[shared_eventsubscription.EventSubscription]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EventSubscriptionsList'), 'exclude': lambda f: f is None }})  
