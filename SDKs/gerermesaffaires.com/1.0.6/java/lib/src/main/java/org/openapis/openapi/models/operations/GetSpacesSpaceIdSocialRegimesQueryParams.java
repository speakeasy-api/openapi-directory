...
public class GetSpacesSpaceIdSocialRegimesQueryParams {
    /**
    ...
    public GetSpacesSpaceIdSocialRegimesQueryParams withWithContractingPartner(String withContractingPartner) {
