...
class GetSfxDetailsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetSfxDetailsLibraryEnum $library
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=library')]
    public ?GetSfxDetailsLibraryEnum $library = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetSfxDetailsViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?GetSfxDetailsViewEnum $view = null;
