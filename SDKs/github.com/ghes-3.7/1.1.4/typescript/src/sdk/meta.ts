...
export class Meta {
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.7/rest/reference/meta#get-github-meta-information} - API method documentation
   */
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.7/rest/reference/meta#get-octocat} - API method documentation
   */
  metaGetOctocat(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.7/rest/meta#get-the-zen-of-github} - API method documentation
   */
  metaGetZen(
    config?: AxiosRequestConfig
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@3.7/rest/overview/resources-in-the-rest-api#root-endpoint} - API method documentation
   */
