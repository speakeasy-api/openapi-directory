...
public class CodeScanning {
    ...
    **/
    public openapisdk.models.operations.CodeScanningListAlertsInstancesResponse codeScanningListAlertsInstances(openapisdk.models.operations.CodeScanningListAlertsInstancesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        openapisdk.models.operations.CodeScanningListAlertsInstancesResponse res = new openapisdk.models.operations.CodeScanningListAlertsInstancesResponse() {{
            codeScanningAlertInstances = null;
            basicError = null;
            basicError = null;
            codeScanningListAlertsInstances503ApplicationJSONObject = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.CodeScanningListAlertsInstances503ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.CodeScanningListAlertsInstances503ApplicationJson.class);
