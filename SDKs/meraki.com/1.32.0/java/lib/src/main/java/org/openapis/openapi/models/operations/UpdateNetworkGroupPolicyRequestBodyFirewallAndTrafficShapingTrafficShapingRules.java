...
public class UpdateNetworkGroupPolicyRequestBodyFirewallAndTrafficShapingTrafficShapingRules {
    ...
    public UpdateNetworkGroupPolicyRequestBodyFirewallAndTrafficShapingTrafficShapingRules(@JsonProperty("definitions") UpdateNetworkGroupPolicyRequestBodyFirewallAndTrafficShapingTrafficShapingRulesDefinitions[] definitions) {
        this.definitions = definitions;
  }
}
