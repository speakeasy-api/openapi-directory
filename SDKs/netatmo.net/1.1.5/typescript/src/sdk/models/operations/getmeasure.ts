...
export class GetmeasureSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 *
 */
export enum GetmeasureScaleEnum {
  Max = "max",
  Thirtymin = "30min",
  Onehour = "1hour",
  Threehours = "3hours",
...
export enum GetmeasureTypeEnum {
...
export class GetmeasureRequest extends SpeakeasyBase {
  /**
...
export class GetmeasureResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
