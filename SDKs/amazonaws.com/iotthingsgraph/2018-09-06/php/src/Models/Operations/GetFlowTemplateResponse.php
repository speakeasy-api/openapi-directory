...
class GetFlowTemplateResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetFlowTemplateResponse $getFlowTemplateResponse
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetFlowTemplateResponse $getFlowTemplateResponse = null;
	...
	{
		$this->contentType = "";
		$this->getFlowTemplateResponse = null;
