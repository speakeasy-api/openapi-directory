...
class DisplayvideoAdvertisersCreativesListRequest:
    path_params: DisplayvideoAdvertisersCreativesListPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersCreativesListQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersCreativesListSecurity = dataclasses.field()
