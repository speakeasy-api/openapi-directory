...
from ..shared import drivegroup as shared_drivegroup
...
class GetDriveGroupsResponse:
    data: list[shared_drivegroup.DriveGroup] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
