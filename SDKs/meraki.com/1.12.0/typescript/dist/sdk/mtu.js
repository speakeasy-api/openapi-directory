...
var Mtu = /** @class */ (function () {
    function Mtu(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Mtu.prototype.getNetworkSwitchMtu = function (req, config) {
    ...
    **/
    Mtu.prototype.updateNetworkSwitchMtu = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
