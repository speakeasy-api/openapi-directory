...
class DisplayvideoGoogleAudiencesGetPathParams:
    google_audience_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'googleAudienceId', 'style': 'simple', 'explode': False }})
...
class DisplayvideoGoogleAudiencesGetRequest:
    path_params: DisplayvideoGoogleAudiencesGetPathParams = dataclasses.field()
    query_params: DisplayvideoGoogleAudiencesGetQueryParams = dataclasses.field()
    security: DisplayvideoGoogleAudiencesGetSecurity = dataclasses.field()
...
class DisplayvideoGoogleAudiencesGetResponse:
    ...
    google_audience: Optional[shared_googleaudience.GoogleAudience] = dataclasses.field(default=None)
