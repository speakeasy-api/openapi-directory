...
var Stops = /** @class */ (function () {
    function Stops(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Stops.prototype.stopsStopDetails = function (req, config) {
    ...
    **/
    Stops.prototype.stopsStopsByGeolocation = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Stops.prototype.stopsStopsForRoute = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
