...
export class TypeProjectCasestudy {
  ...
  searchProjectCasestudy(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/project_casestudy";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchProjectCasestudyResponse =
        new operations.SearchProjectCasestudyResponse({
