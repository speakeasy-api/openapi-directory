...
class SearchLocalfilesQueryParams:
...
@dataclasses.dataclass
class SearchLocalfilesRequest:
    query_params: SearchLocalfilesQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchLocalfilesResponse:
