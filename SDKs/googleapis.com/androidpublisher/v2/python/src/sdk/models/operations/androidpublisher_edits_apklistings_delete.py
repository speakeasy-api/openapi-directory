...
class AndroidpublisherEditsApklistingsDeleteRequest:
    path_params: AndroidpublisherEditsApklistingsDeletePathParams = dataclasses.field()
    query_params: AndroidpublisherEditsApklistingsDeleteQueryParams = dataclasses.field()
    security: AndroidpublisherEditsApklistingsDeleteSecurity = dataclasses.field()
