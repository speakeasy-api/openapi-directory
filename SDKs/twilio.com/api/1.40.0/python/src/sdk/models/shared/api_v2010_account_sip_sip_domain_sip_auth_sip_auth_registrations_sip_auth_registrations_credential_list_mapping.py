...
class APIV2010AccountSipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the CredentialListMapping resource."""  
    ...
    r"""The unique string that that we created to identify the CredentialListMapping resource."""  
