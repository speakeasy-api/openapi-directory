...
class StagedEmployeeCustomBooleanFields
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\StagedEmployeeCustomBooleanFieldsCategoryEnum $category
     */
	#[\JMS\Serializer\Annotation\SerializedName('category')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\StagedEmployeeCustomBooleanFieldsCategoryEnum>')]
	...
	{
		$this->category = \OpenAPI\OpenAPI\Models\Shared\StagedEmployeeCustomBooleanFieldsCategoryEnum::PAYROLL_AND_HR;
		$this->label = "";
		$this->value = false;
	}
}
