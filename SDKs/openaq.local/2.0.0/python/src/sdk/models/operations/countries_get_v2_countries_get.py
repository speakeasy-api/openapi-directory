...
class CountriesGetV2CountriesGetOrderByCountriesOrderEnum(str, Enum):
    r"""An enumeration."""
    COUNTRY = 'country'
...
class CountriesGetV2CountriesGetSortSortEnum(str, Enum):
    r"""An enumeration."""
    ASC = 'asc'
    DESC = 'desc'
...
class CountriesGetV2CountriesGetRequest:
    ...
    order_by: Optional[CountriesGetV2CountriesGetOrderByCountriesOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order_by', 'style': 'form', 'explode': True }})
    r"""An enumeration."""  
    page: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'page', 'style': 'form', 'explode': True }})
    r"""Paginate through results."""  
    sort: Optional[CountriesGetV2CountriesGetSortSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""Define sort order."""  
