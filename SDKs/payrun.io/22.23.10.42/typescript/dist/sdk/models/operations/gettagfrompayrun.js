...
exports.GetTagFromPayRunResponse = exports.GetTagFromPayRunRequest = void 0;
...
var GetTagFromPayRunRequest = /** @class */ (function (_super) {
    ...
    ], GetTagFromPayRunRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayRunRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayRunRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayRunId",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayRunRequest.prototype, "payRunId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayScheduleId",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayRunRequest.prototype, "payScheduleId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayRunRequest.prototype, "tagId", void 0);
    return GetTagFromPayRunRequest;
}(utils_1.SpeakeasyBase));
exports.GetTagFromPayRunRequest = GetTagFromPayRunRequest;
var GetTagFromPayRunResponse = /** @class */ (function (_super) {
    ...
    ], GetTagFromPayRunResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.GetTagFromPayRunResponse = GetTagFromPayRunResponse;
