...
export class Documents {
  ...
  languageDocumentsAnalyzeEntities(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta2/documents:analyzeEntities";
  ...
  languageDocumentsAnalyzeEntitySentiment(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta2/documents:analyzeEntitySentiment";
  ...
  languageDocumentsAnalyzeSentiment(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta2/documents:analyzeSentiment";
  ...
  languageDocumentsAnalyzeSyntax(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta2/documents:analyzeSyntax";
  ...
  languageDocumentsAnnotateText(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta2/documents:annotateText";
  ...
  languageDocumentsClassifyText(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta2/documents:classifyText";
