...
public class Device {
    ...
    public Device withParentDevice(NestedDevice parentDevice) {
    ...
    public Device withPrimaryIp(NestedIpAddress primaryIp) {
    ...
    public Device withPrimaryIp4(NestedIpAddress primaryIp4) {
    ...
    public Device withPrimaryIp6(NestedIpAddress primaryIp6) {
    ...
    public Device withVirtualChassis(NestedVirtualChassis virtualChassis) {
