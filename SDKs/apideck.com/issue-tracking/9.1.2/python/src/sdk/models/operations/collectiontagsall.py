...
from ..shared import getcollectiontagsresponse as shared_getcollectiontagsresponse
...
class CollectionTagsAllSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class CollectionTagsAllRequest:
...
@dataclasses.dataclass
class CollectionTagsAllResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    get_collection_tags_response: Optional[shared_getcollectiontagsresponse.GetCollectionTagsResponse] = dataclasses.field(default=None)
    r"""List Tags"""  
