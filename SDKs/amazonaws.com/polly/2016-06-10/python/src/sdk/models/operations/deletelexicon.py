...
class DeleteLexiconRequest:
    headers: DeleteLexiconHeaders = dataclasses.field()
    path_params: DeleteLexiconPathParams = dataclasses.field()
...
class DeleteLexiconResponse:
    ...
    delete_lexicon_output: Optional[dict[str, Any]] = dataclasses.field(default=None)
