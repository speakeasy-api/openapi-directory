...
class DisplayvideoAdvertisersChannelsCreateRequest:
    path_params: DisplayvideoAdvertisersChannelsCreatePathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersChannelsCreateQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersChannelsCreateSecurity = dataclasses.field()
