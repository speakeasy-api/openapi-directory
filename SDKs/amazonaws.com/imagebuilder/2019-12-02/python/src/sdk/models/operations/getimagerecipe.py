...
from ..shared import getimagereciperesponse as shared_getimagereciperesponse
...
class GetImageRecipeRequest:
    headers: GetImageRecipeHeaders = dataclasses.field()
    query_params: GetImageRecipeQueryParams = dataclasses.field()
...
class GetImageRecipeResponse:
    ...
    get_image_recipe_response: Optional[shared_getimagereciperesponse.GetImageRecipeResponse] = dataclasses.field(default=None)
