...
class ListSyncMapRequest:
    ...
    r"""The SID of the [Sync Service](https://www.twilio.com/docs/sync/api/service) with the Sync Map resources to read."""  
...
class ListSyncMapListSyncMapResponse:
    ...
    maps: Optional[list[shared_sync_v1_service_sync_map.SyncV1ServiceSyncMap]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maps'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListSyncMapListSyncMapResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
