 ...
 */
export enum CreateVpnGatewayRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateVpnGatewayRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateVpnGatewayRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateVpnGatewayRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateVpnGatewayRequestTagSpecificationsTags })
 ...
 */
export class CreateVpnGatewayRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: CreateVpnGatewayRequestTagSpecifications })
