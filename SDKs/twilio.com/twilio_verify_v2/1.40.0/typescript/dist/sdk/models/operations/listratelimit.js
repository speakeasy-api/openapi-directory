...
exports.ListRateLimitResponse = exports.ListRateLimitListRateLimitResponse = exports.ListRateLimitListRateLimitResponseMeta = exports.ListRateLimitRequest = exports.ListRateLimitSecurity = exports.ListRateLimitServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListRateLimitServerList = ["https://verify.twilio.com"];
var ListRateLimitSecurity = /** @class */ (function (_super) {
    ...
    ], ListRateLimitSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListRateLimitSecurity.prototype, "username", void 0);
...
var ListRateLimitRequest = /** @class */ (function (_super) {
    ...
    ], ListRateLimitRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListRateLimitRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListRateLimitRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListRateLimitRequest.prototype, "serviceSid", void 0);
...
var ListRateLimitListRateLimitResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListRateLimitListRateLimitResponseMeta; }),
        __metadata("design:type", ListRateLimitListRateLimitResponseMeta)
    ], ListRateLimitListRateLimitResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.VerifyV2ServiceRateLimit }),
        (0, class_transformer_1.Expose)({ name: "rate_limits" }),
        (0, class_transformer_1.Type)(function () { return shared.VerifyV2ServiceRateLimit; }),
...
var ListRateLimitResponse = /** @class */ (function (_super) {
    ...
    ], ListRateLimitResponse.prototype, "rawResponse", void 0);
