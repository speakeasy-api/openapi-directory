...
export enum DeleteRecommenderXAmzTargetEnum {
  AmazonPersonalizeDeleteRecommender = "AmazonPersonalize.DeleteRecommender",
}

export class DeleteRecommenderRequest extends SpeakeasyBase {
...
export class DeleteRecommenderResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
