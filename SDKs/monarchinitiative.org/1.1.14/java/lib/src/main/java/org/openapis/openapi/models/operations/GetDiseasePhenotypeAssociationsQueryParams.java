...
public class GetDiseasePhenotypeAssociationsQueryParams {
    /**
    ...
    public GetDiseasePhenotypeAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetDiseasePhenotypeAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetDiseasePhenotypeAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetDiseasePhenotypeAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetDiseasePhenotypeAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public String q;
    public GetDiseasePhenotypeAssociationsQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsQueryParams withRelation(String relation) {
    ...
    public Long rows;
    public GetDiseasePhenotypeAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetDiseasePhenotypeAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public String sort;
    public GetDiseasePhenotypeAssociationsQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetDiseasePhenotypeAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetDiseasePhenotypeAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetDiseasePhenotypeAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
