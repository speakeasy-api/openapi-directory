...
var Webhooks = /** @class */ (function () {
    ...
    **/
    Webhooks.prototype.addWebhook = function (req, config) {
        var _a;
    ...
    **/
    Webhooks.prototype.getWehooksList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.webhookCollectionResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Webhooks.prototype.regenerateWebhookToken = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegenerateWebhookTokenRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/webhooks/regenerate-token/{id}", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
    ...
    **/
    Webhooks.prototype.resendWebhookActivityEntry = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ResendWebhookActivityEntryRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/webhooks/resend/{activityId}", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "post", headers: headers }, config));
        return r.then(function (httpRes) {
