...
type StoresCreatePathParams struct {
...
type StoresCreateRequest struct {
	PathParams StoresCreatePathParams
	// The store request
	Request  StoresCreateRequestBody `request:"mediaType=application/json"`
	Security StoresCreateSecurity
}
