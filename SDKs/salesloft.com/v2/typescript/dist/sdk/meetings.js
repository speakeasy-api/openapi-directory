...
var Meetings = /** @class */ (function () {
     ...
     *
     */
    Meetings.prototype.getV2MeetingsJson = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetV2MeetingsJsonRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v2/meetings.json";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetV2MeetingsJsonResponse({
     ...
     *
     */
    Meetings.prototype.putV2MeetingsIdJson = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PutV2MeetingsIdJsonRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2/meetings/{id}.json", req);
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PutV2MeetingsIdJsonResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
