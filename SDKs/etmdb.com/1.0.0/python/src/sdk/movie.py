...
class Movie:
    ...
    def movie_search_read(self, request: operations.MovieSearchReadRequest) -> operations.MovieSearchReadResponse:
        ...
        * You can use both Amharic or English charset/font to search
        ...
        url = utils.generate_url(operations.MovieSearchReadRequest, base_url, '/api/v1/movie/search/{movie_title}', request)
        ...
        res = operations.MovieSearchReadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
