...
class TestListDeviceSetsOfOwnerSecurity:
    
    api_token: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'X-API-Token' }})  
    

@dataclasses.dataclass
class TestListDeviceSetsOfOwnerRequest:
...
@dataclasses.dataclass
class TestListDeviceSetsOfOwnerDeviceSetDeviceConfigurationsImage:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TestListDeviceSetsOfOwnerDeviceSetDeviceConfigurationsModel:
...
class TestListDeviceSetsOfOwnerDeviceSetDeviceConfigurations:
    ...
    image: Optional[TestListDeviceSetsOfOwnerDeviceSetDeviceConfigurationsImage] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('image'), 'exclude': lambda f: f is None }})  
    model: Optional[TestListDeviceSetsOfOwnerDeviceSetDeviceConfigurationsModel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model'), 'exclude': lambda f: f is None }})  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TestListDeviceSetsOfOwnerDeviceSetDeviceSetOwner:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TestListDeviceSetsOfOwnerDeviceSet:
    r"""The name and devices of the device set"""
    
    device_configurations: list[TestListDeviceSetsOfOwnerDeviceSetDeviceConfigurations] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deviceConfigurations') }})  
    id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id') }})
    r"""Identifier of the device set"""  
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})
    r"""Name of the device set"""  
    owner: TestListDeviceSetsOfOwnerDeviceSetDeviceSetOwner = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('owner') }})
    r"""The owner of a device set"""  
...
@dataclasses.dataclass
class TestListDeviceSetsOfOwnerResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    device_sets: Optional[list[TestListDeviceSetsOfOwnerDeviceSet]] = dataclasses.field(default=None)
    r"""OK"""  
