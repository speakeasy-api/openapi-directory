...
exports.ListCredentialAwsResponse = exports.ListCredentialAwsListCredentialAwsResponse = exports.ListCredentialAwsListCredentialAwsResponseMeta = exports.ListCredentialAwsRequest = exports.ListCredentialAwsSecurity = exports.ListCredentialAwsServerList = void 0;
...
var ListCredentialAwsSecurity = /** @class */ (function (_super) {
    ...
    ], ListCredentialAwsSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListCredentialAwsSecurity.prototype, "username", void 0);
...
var ListCredentialAwsRequest = /** @class */ (function (_super) {
    ...
    ], ListCredentialAwsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListCredentialAwsRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListCredentialAwsRequest.prototype, "pageToken", void 0);
...
var ListCredentialAwsListCredentialAwsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.AccountsV1CredentialCredentialAws }),
        (0, class_transformer_1.Expose)({ name: "credentials" }),
        (0, class_transformer_1.Type)(function () { return shared.AccountsV1CredentialCredentialAws; }),
        __metadata("design:type", Array)
    ], ListCredentialAwsListCredentialAwsResponse.prototype, "credentials", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListCredentialAwsListCredentialAwsResponseMeta; }),
...
var ListCredentialAwsResponse = /** @class */ (function (_super) {
    ...
    ], ListCredentialAwsResponse.prototype, "rawResponse", void 0);
