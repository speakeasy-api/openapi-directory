...
func (e CreateCustomerXSdsDateFormatEnum) ToPointer() *CreateCustomerXSdsDateFormatEnum {
	return &e
}
...
func (e *CreateCustomerXSdsDateFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "EPOCH":
		fallthrough
	case "LEET":
		*e = CreateCustomerXSdsDateFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCustomerXSdsDateFormatEnum: %v", v)
	}
}
