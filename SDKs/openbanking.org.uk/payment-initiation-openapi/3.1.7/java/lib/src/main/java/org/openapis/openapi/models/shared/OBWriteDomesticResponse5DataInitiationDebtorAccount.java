...
public class OBWriteDomesticResponse5DataInitiationDebtorAccount {
    ...
    public OBWriteDomesticResponse5DataInitiationDebtorAccount(@JsonProperty("Identification") String identification, @JsonProperty("SchemeName") String schemeName) {
        this.identification = identification;
        this.schemeName = schemeName;
  }
}
