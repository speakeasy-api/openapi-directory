...
class GetVcdHierarchyChildrenV1Request
{
    /**
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetVcdHierarchyChildrenV1ObjectTypeEnum $objectType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=object_type')]
    public ?GetVcdHierarchyChildrenV1ObjectTypeEnum $objectType = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetVcdHierarchyChildrenV1SLAAssignmentEnum $slaAssignment
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sla_assignment')]
    public ?GetVcdHierarchyChildrenV1SLAAssignmentEnum $slaAssignment = null;
    
    /**
     * Filters vCD hierarchy objects based on the specified query value.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetVcdHierarchyChildrenV1SnappableStatusEnum $snappableStatus
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=snappable_status')]
    public ?GetVcdHierarchyChildrenV1SnappableStatusEnum $snappableStatus = null;
    
    /**
     * Attribute to sort the results on.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetVcdHierarchyChildrenV1SortByEnum $sortBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort_by')]
    public ?GetVcdHierarchyChildrenV1SortByEnum $sortBy = null;
    
    /**
     * Order for sorting the results, either ascending or descending.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetVcdHierarchyChildrenV1SortOrderEnum $sortOrder
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort_order')]
    public ?GetVcdHierarchyChildrenV1SortOrderEnum $sortOrder = null;
