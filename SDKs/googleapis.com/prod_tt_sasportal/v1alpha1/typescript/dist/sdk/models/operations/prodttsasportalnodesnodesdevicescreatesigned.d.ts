...
export declare class ProdTtSasportalNodesNodesDevicesCreateSignedSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalNodesNodesDevicesCreateSignedSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
