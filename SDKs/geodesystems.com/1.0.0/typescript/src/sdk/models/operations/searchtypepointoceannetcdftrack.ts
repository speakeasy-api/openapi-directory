...
export class SearchTypePointOceanNetcdfTrackRequest extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=search.type_point_ocean_netcdf_track.platform",
  })
...
export class SearchTypePointOceanNetcdfTrackResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
