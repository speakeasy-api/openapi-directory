...
class CreateInstanceProfileRequest:
    ...
    create_instance_profile_request: shared_createinstanceprofilerequest.CreateInstanceProfileRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
