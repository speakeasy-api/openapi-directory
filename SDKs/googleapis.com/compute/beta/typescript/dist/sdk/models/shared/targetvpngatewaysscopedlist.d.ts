 ...
 */
export declare enum TargetVpnGatewaysScopedListWarningCodeEnum {
...
export declare class TargetVpnGatewaysScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetVpnGatewaysScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class TargetVpnGatewaysScopedList extends SpeakeasyBase {
    /**
