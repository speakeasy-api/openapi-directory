...
class SearchTablesByLFTagsRequestBody:
    ...
    r"""A list of conditions (<code>LFTag</code> structures) to search for in table resources."""  
...
class SearchTablesByLFTagsRequest:
    ...
    request_body: SearchTablesByLFTagsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
