...
func (e InputMappingLocationEnum) ToPointer() *InputMappingLocationEnum {
	return &e
}
...
func (e *InputMappingLocationEnum) UnmarshalJSON(data []byte) error {
	...
	case "BODY":
		fallthrough
	case "HEADER":
		*e = InputMappingLocationEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for InputMappingLocationEnum: %v", v)
	}
}
