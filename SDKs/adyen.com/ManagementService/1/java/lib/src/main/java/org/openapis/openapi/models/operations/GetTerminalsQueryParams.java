...
public class GetTerminalsQueryParams {
    /**
    ...
    public GetTerminalsQueryParams withBrandModels(String brandModels) {
    ...
    public GetTerminalsQueryParams withCountries(String countries) {
    ...
    public GetTerminalsQueryParams withMerchantIds(String merchantIds) {
    ...
    public GetTerminalsQueryParams withPageNumber(Integer pageNumber) {
    ...
    public GetTerminalsQueryParams withPageSize(Integer pageSize) {
    ...
    public GetTerminalsQueryParams withSearchQuery(String searchQuery) {
    ...
    public GetTerminalsQueryParams withStoreIds(String storeIds) {
