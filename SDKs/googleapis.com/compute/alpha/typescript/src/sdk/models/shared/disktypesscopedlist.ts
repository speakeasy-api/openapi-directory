 ...
 */
export enum DiskTypesScopedListWarningCodeEnum {
...
export class DiskTypesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class DiskTypesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: DiskTypesScopedListWarningData })
  @Expose({ name: "data" })
...
export class DiskTypesScopedList extends SpeakeasyBase {
  /**
   * [Output Only] A list of disk types contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: DiskType })
  @Expose({ name: "diskTypes" })
  @Type(() => DiskType)
  diskTypes?: DiskType[];
