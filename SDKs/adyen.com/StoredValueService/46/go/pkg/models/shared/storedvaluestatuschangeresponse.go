...
type StoredValueStatusChangeResponseResultCodeEnum string

const (
	StoredValueStatusChangeResponseResultCodeEnumSuccess          StoredValueStatusChangeResponseResultCodeEnum = "Success"
	StoredValueStatusChangeResponseResultCodeEnumRefused          StoredValueStatusChangeResponseResultCodeEnum = "Refused"
	StoredValueStatusChangeResponseResultCodeEnumError            StoredValueStatusChangeResponseResultCodeEnum = "Error"
...
type StoredValueStatusChangeResponse struct {
	...
	// * **NotEnoughBalance** – The amount on the payment method is lower than the amount given in the request. Only applicable to balance checks.
	//
	ResultCode *StoredValueStatusChangeResponseResultCodeEnum `json:"resultCode,omitempty"`
