...
class ListReceivedGrantsRequest:
    ...
    list_received_grants_request: shared_listreceivedgrantsrequest.ListReceivedGrantsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
