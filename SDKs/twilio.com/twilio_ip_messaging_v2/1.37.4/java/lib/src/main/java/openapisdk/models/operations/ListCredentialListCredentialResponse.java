...
public class ListCredentialListCredentialResponse {
    ...
    public openapisdk.models.shared.IpMessagingV2Credential[] credentials;
    public ListCredentialListCredentialResponse withCredentials(openapisdk.models.shared.IpMessagingV2Credential[] credentials) {
