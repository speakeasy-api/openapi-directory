...
class AddItemForPortfolioRequestBody:
    r"""Information about the item being inserted."""
    
    data: Optional[shared_portfolioadditemrequest.PortfolioAddItemRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
...
class AddItemForPortfolioRequest:
    ...
    request_body: AddItemForPortfolioRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Information about the item being inserted."""  
...
class AddItemForPortfolio200ApplicationJSON:
    r"""Successfully added the item to the portfolio."""
