...
**/
public class AccountSettingsUpdateApplicationJsonUpdateAccountSettingsSecurityPasswordRequirement {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("consecutive_characters_length")
    public Long consecutiveCharactersLength;
    public AccountSettingsUpdateApplicationJsonUpdateAccountSettingsSecurityPasswordRequirement withConsecutiveCharactersLength(Long consecutiveCharactersLength) {
    ...
    public AccountSettingsUpdateApplicationJsonUpdateAccountSettingsSecurityPasswordRequirement withHaveSpecialCharacter(Boolean haveSpecialCharacter) {
    ...
    public AccountSettingsUpdateApplicationJsonUpdateAccountSettingsSecurityPasswordRequirement withMinimumPasswordLength(Long minimumPasswordLength) {
    ...
    public AccountSettingsUpdateApplicationJsonUpdateAccountSettingsSecurityPasswordRequirement withWeakEnhanceDetection(Boolean weakEnhanceDetection) {
