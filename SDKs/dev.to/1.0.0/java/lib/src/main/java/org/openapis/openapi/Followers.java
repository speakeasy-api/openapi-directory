...
public class Followers {
	...
	public Followers(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.GetFollowersResponse getFollowers(org.openapis.openapi.models.operations.GetFollowersRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/api/followers/users");
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.operations.GetFollowers200ApplicationJSON[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetFollowers200ApplicationJSON[].class);
