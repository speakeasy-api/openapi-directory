...
<https://docs.github.com/enterprise-server@2.22/rest/reference/markdown#render-a-markdown-document>
...
API method documentation
<https://docs.github.com/enterprise-server@2.22/rest/reference/markdown#render-a-markdown-document-in-raw-mode>
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Markdown.MarkdownRenderRaw(ctx, "ex")
    if err != nil {
        log.Fatal(err)
    }
