...
class SearchTypePointOceanCsvSadoMeteoQueryParams:
...
@dataclasses.dataclass
class SearchTypePointOceanCsvSadoMeteoRequest:
    query_params: SearchTypePointOceanCsvSadoMeteoQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypePointOceanCsvSadoMeteoResponse:
