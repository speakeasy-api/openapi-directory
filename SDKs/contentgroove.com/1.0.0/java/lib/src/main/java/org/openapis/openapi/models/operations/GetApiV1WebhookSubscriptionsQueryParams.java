...
public class GetApiV1WebhookSubscriptionsQueryParams {
    /**
    ...
    public GetApiV1WebhookSubscriptionsQueryParams withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetApiV1WebhookSubscriptionsQueryParams withSort(GetApiV1WebhookSubscriptionsSortEnum sort) {
        this.sort = sort;
        return this;
    }
