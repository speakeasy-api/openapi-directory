...
func (s *Destiny2) Destiny2SearchDestinyPlayer(ctx context.Context, request operations.Destiny2SearchDestinyPlayerRequest) (*operations.Destiny2SearchDestinyPlayerResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.Destiny2SearchDestinyPlayerResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
