...
var ListPipelinesOutput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: pipelineidname_1.PipelineIdName }),
        (0, class_transformer_1.Expose)({ name: "pipelineIdList" }),
        (0, class_transformer_1.Type)(function () { return pipelineidname_1.PipelineIdName; }),
