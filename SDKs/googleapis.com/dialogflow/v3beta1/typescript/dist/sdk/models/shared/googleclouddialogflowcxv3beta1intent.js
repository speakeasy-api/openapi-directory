...
exports.GoogleCloudDialogflowCxV3beta1Intent = void 0;
var utils_1 = require("../../../internal/utils");
var googleclouddialogflowcxv3beta1intentparameter_1 = require("./googleclouddialogflowcxv3beta1intentparameter");
var googleclouddialogflowcxv3beta1intenttrainingphrase_1 = require("./googleclouddialogflowcxv3beta1intenttrainingphrase");
...
var GoogleCloudDialogflowCxV3beta1Intent = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: googleclouddialogflowcxv3beta1intentparameter_1.GoogleCloudDialogflowCxV3beta1IntentParameter,
        }),
        (0, class_transformer_1.Expose)({ name: "parameters" }),
        (0, class_transformer_1.Type)(function () { return googleclouddialogflowcxv3beta1intentparameter_1.GoogleCloudDialogflowCxV3beta1IntentParameter; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: googleclouddialogflowcxv3beta1intenttrainingphrase_1.GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase,
        }),
        (0, class_transformer_1.Expose)({ name: "trainingPhrases" }),
        (0, class_transformer_1.Type)(function () { return googleclouddialogflowcxv3beta1intenttrainingphrase_1.GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase; }),
        __metadata("design:type", Array)
    ], GoogleCloudDialogflowCxV3beta1Intent.prototype, "trainingPhrases", void 0);
    return GoogleCloudDialogflowCxV3beta1Intent;
}(utils_1.SpeakeasyBase));
exports.GoogleCloudDialogflowCxV3beta1Intent = GoogleCloudDialogflowCxV3beta1Intent;
