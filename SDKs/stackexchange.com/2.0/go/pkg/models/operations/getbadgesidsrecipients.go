...
type GetBadgesIdsRecipientsPathParams struct {
	// Number list (semicolon delimited).
	Ids string `pathParam:"style=simple,explode=false,name=ids"`
}

type GetBadgesIdsRecipientsQueryParams struct {
