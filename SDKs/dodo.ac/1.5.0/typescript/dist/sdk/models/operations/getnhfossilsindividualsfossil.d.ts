...
export declare class GetNhFossilsIndividualsFossilRequest extends SpeakeasyBase {
    /**
...
export declare class GetNhFossilsIndividualsFossilResponse extends SpeakeasyBase {
    contentType: string;
    /**
