...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum {
...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
  ...
  targetingType: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum;
...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
