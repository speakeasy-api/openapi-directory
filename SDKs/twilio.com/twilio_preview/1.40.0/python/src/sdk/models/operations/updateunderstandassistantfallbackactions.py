...
class UpdateUnderstandAssistantFallbackActionsRequest:
    ...
    request_body: Optional[UpdateUnderstandAssistantFallbackActionsUpdateUnderstandAssistantFallbackActionsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
