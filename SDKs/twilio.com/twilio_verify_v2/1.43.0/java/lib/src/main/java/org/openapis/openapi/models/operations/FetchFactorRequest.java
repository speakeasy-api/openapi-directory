...
public class FetchFactorRequest {
    ...
    public FetchFactorRequest withIdentity(String identity) {
    ...
    public FetchFactorRequest withServiceSid(String serviceSid) {
    ...
    public FetchFactorRequest withSid(String sid) {
        this.sid = sid;
        return this;
    }
    
    public FetchFactorRequest(@JsonProperty("Identity") String identity, @JsonProperty("ServiceSid") String serviceSid, @JsonProperty("Sid") String sid) {
        this.identity = identity;
        this.serviceSid = serviceSid;
        this.sid = sid;
  }
