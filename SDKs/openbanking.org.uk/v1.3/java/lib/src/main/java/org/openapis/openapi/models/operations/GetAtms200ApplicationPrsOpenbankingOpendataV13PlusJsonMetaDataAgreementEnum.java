...
public enum GetAtms200ApplicationPrsOpenbankingOpendataV13PlusJsonMetaDataAgreementEnum {
    ...
    private GetAtms200ApplicationPrsOpenbankingOpendataV13PlusJsonMetaDataAgreementEnum(String value) {
        this.value = value;
    }
}
