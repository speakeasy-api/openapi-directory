...
class Onev21volumes1actionsPostRequestBodyContentApplication1jsonSchemaAnyOf1:
    ...
    type: Onev21volumes1actionsPostRequestBodyContentApplication1jsonSchemaAnyOf1TypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
