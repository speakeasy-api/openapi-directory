...
from ..shared import obreadparty3 as shared_obreadparty3
...
class GetAccountsAccountIDPartiesRequest:
    headers: GetAccountsAccountIDPartiesHeaders = dataclasses.field()
    path_params: GetAccountsAccountIDPartiesPathParams = dataclasses.field()
    security: GetAccountsAccountIDPartiesSecurity = dataclasses.field()
...
class GetAccountsAccountIDPartiesResponse:
    ...
    ob_read_party3: Optional[shared_obreadparty3.ObReadParty3] = dataclasses.field(default=None)
