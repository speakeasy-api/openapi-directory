...
var Connectivity = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "freeWifi" }),
        __metadata("design:type", Boolean)
    ], Connectivity.prototype, "freeWifi", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "freeWifiException" }),
        __metadata("design:type", String)
    ], Connectivity.prototype, "freeWifiException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "publicAreaWifiAvailable" }),
        __metadata("design:type", Boolean)
    ], Connectivity.prototype, "publicAreaWifiAvailable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "publicAreaWifiAvailableException" }),
        __metadata("design:type", String)
    ], Connectivity.prototype, "publicAreaWifiAvailableException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "publicInternetTerminal" }),
        __metadata("design:type", Boolean)
    ], Connectivity.prototype, "publicInternetTerminal", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "publicInternetTerminalException" }),
        __metadata("design:type", String)
    ], Connectivity.prototype, "publicInternetTerminalException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "wifiAvailable" }),
        __metadata("design:type", Boolean)
    ], Connectivity.prototype, "wifiAvailable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "wifiAvailableException" }),
        __metadata("design:type", String)
