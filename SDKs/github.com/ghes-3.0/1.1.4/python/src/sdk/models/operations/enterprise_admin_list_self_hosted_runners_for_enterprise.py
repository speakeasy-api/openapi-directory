...
class EnterpriseAdminListSelfHostedRunnersForEnterprise200ApplicationJSON:
    ...
    runners: Optional[list[shared_runner.Runner]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('runners'), 'exclude': lambda f: f is None }})  
