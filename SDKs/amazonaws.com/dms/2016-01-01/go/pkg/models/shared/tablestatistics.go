...
type TableStatistics struct {
	AppliedDdls                  *int64     `json:"AppliedDdls,omitempty"`
	AppliedDeletes               *int64     `json:"AppliedDeletes,omitempty"`
	AppliedInserts               *int64     `json:"AppliedInserts,omitempty"`
	AppliedUpdates               *int64     `json:"AppliedUpdates,omitempty"`
