...
exports.PutEmployerTagResponse = exports.PutEmployerTagRequest = void 0;
...
var PutEmployerTagRequest = /** @class */ (function (_super) {
    ...
    ], PutEmployerTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], PutEmployerTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], PutEmployerTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], PutEmployerTagRequest.prototype, "tagId", void 0);
    return PutEmployerTagRequest;
}(utils_1.SpeakeasyBase));
exports.PutEmployerTagRequest = PutEmployerTagRequest;
var PutEmployerTagResponse = /** @class */ (function (_super) {
    ...
    ], PutEmployerTagResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.PutEmployerTagResponse = PutEmployerTagResponse;
