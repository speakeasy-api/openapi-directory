...
class GoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequest:
    ...
    list_update_requests: Optional[list[shared_googlesecuritysafebrowsingv4fetchthreatlistupdatesrequestlistupdaterequest.GoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequestListUpdateRequest]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('listUpdateRequests') }})
