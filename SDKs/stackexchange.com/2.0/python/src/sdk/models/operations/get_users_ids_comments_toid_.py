...
class GetUsersIdsCommentsToidPathParams:
    ...
    toid: int = dataclasses.field(metadata={'path_param': { 'field_name': 'toid', 'style': 'simple', 'explode': False }})
...
class GetUsersIdsCommentsToidQueryParams:
    ...
    order: Optional[GetUsersIdsCommentsToidOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetUsersIdsCommentsToidSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetUsersIdsCommentsToidRequest:
    path_params: GetUsersIdsCommentsToidPathParams = dataclasses.field()
    query_params: GetUsersIdsCommentsToidQueryParams = dataclasses.field()
