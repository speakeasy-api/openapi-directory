...
export class GetGeneDiseaseAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}

export enum GetGeneDiseaseAssociationsAssociationTypeEnum {
    Causal = "causal",
...
export class GetGeneDiseaseAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGeneDiseaseAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGeneDiseaseAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
