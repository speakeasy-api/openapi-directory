...
from ..shared import getordertyperesponse as shared_getordertyperesponse
...
class OrderTypesOneRequest:
    headers: OrderTypesOneHeaders = dataclasses.field()
    path_params: OrderTypesOnePathParams = dataclasses.field()
    query_params: OrderTypesOneQueryParams = dataclasses.field()
    security: OrderTypesOneSecurity = dataclasses.field()
    

@dataclasses.dataclass
class OrderTypesOneResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    get_order_type_response: Optional[shared_getordertyperesponse.GetOrderTypeResponse] = dataclasses.field(default=None)
