...
class SearchContactQueryParams:
    ...
    search_db_contact_email: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_contact.email', 'style': 'form', 'explode': True }})
    search_db_contact_institution: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_contact.institution', 'style': 'form', 'explode': True }})
    search_db_contact_name: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_contact.name', 'style': 'form', 'explode': True }})
...
class SearchContactRequest:
    query_params: SearchContactQueryParams = dataclasses.field()
