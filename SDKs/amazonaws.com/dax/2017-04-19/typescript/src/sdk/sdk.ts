...
export class SDK {
  ...
  createCluster(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AmazonDAXV3.CreateCluster";
  ...
  decreaseReplicationFactor(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DecreaseReplicationFactorResponse =
        new operations.DecreaseReplicationFactorResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.decreaseReplicationFactorResponse = utils.objectToClass(
              httpRes?.data,
              shared.DecreaseReplicationFactorResponse
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  deleteCluster(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AmazonDAXV3.DeleteCluster";
  ...
  describeDefaultParameters(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DescribeDefaultParametersResponse =
        new operations.DescribeDefaultParametersResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.describeDefaultParametersResponse = utils.objectToClass(
              httpRes?.data,
              shared.DescribeDefaultParametersResponse
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  describeEvents(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AmazonDAXV3.DescribeEvents";
  ...
  increaseReplicationFactor(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.IncreaseReplicationFactorResponse =
        new operations.IncreaseReplicationFactorResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.increaseReplicationFactorResponse = utils.objectToClass(
              httpRes?.data,
              shared.IncreaseReplicationFactorResponse
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  listTags(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AmazonDAXV3.ListTags";
  ...
  rebootNode(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AmazonDAXV3.RebootNode";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RebootNodeResponse =
        new operations.RebootNodeResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.rebootNodeResponse = utils.objectToClass(
              httpRes?.data,
              shared.RebootNodeResponse
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  tagResource(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AmazonDAXV3.TagResource";
  ...
  untagResource(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AmazonDAXV3.UntagResource";
  ...
  updateCluster(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AmazonDAXV3.UpdateCluster";
