...
export class ListDeployedDevicesFleetListDeployedDevicesFleetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.PreviewDeployedDevicesFleet })
  @Expose({ name: "fleets" })
  @Type(() => shared.PreviewDeployedDevicesFleet)
  fleets?: shared.PreviewDeployedDevicesFleet[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListDeployedDevicesFleetListDeployedDevicesFleetResponseMeta)
