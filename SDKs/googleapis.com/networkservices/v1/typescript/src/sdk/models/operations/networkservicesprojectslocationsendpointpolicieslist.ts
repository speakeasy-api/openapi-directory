...
export class NetworkservicesProjectsLocationsEndpointPoliciesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworkservicesProjectsLocationsEndpointPoliciesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworkservicesProjectsLocationsEndpointPoliciesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
