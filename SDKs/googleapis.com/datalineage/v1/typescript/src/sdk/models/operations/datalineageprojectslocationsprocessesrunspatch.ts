...
export class DatalineageProjectsLocationsProcessesRunsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatalineageProjectsLocationsProcessesRunsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatalineageProjectsLocationsProcessesRunsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
