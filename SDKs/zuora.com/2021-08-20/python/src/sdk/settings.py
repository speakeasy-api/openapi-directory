...
class Settings:
    ...
    def get_list_all_settings(self, request: operations.GETListAllSettingsRequest) -> operations.GETListAllSettingsResponse:
        ...
        res = operations.GETListAllSettingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListAllSettingsResponse])
    ...
    def post_process_settings_batch_request(self, request: operations.POSTProcessSettingsBatchRequestRequest) -> operations.POSTProcessSettingsBatchRequestResponse:
        ...
        * All the children requests of the single requests.
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "settings_batch_request", 'json')
        ...
        res = operations.POSTProcessSettingsBatchRequestResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SettingsBatchResponse])
