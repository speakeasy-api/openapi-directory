...
class CreateEndpointMessage:
    ...
    endpoint_identifier: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EndpointIdentifier') }})  
    endpoint_type: shared_replicationendpointtypevalue_enum.ReplicationEndpointTypeValueEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EndpointType') }})  
    engine_name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EngineName') }})  
