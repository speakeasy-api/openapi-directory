...
exports.GetHolidaySchemeRevisionByNumberResponse = exports.GetHolidaySchemeRevisionByNumberRequest = void 0;
...
var GetHolidaySchemeRevisionByNumberRequest = /** @class */ (function (_super) {
    ...
    ], GetHolidaySchemeRevisionByNumberRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeRevisionByNumberRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeRevisionByNumberRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=HolidaySchemeId",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeRevisionByNumberRequest.prototype, "holidaySchemeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RevisionNumber",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeRevisionByNumberRequest.prototype, "revisionNumber", void 0);
...
var GetHolidaySchemeRevisionByNumberResponse = /** @class */ (function (_super) {
    ...
    ], GetHolidaySchemeRevisionByNumberResponse.prototype, "rawResponse", void 0);
