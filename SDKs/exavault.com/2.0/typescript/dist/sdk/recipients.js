...
var Recipients = /** @class */ (function () {
    ...
    Recipients.prototype.resendInvitationsForShare = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/recipients/shares/invites/{shareId}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.ResendInvitationsForShareResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.shareRecipientsResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ShareRecipientsResponse);
                    }
                    break;
            }
            return res;
