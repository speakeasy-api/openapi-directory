...
from ..shared import getpullrequestoverridestateinput as shared_getpullrequestoverridestateinput
from ..shared import getpullrequestoverridestateoutput as shared_getpullrequestoverridestateoutput
...
class GetPullRequestOverrideStateHeaders:
    x_amz_target: GetPullRequestOverrideStateXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetPullRequestOverrideStateRequest:
    headers: GetPullRequestOverrideStateHeaders = dataclasses.field()
    request: shared_getpullrequestoverridestateinput.GetPullRequestOverrideStateInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetPullRequestOverrideStateResponse:
    ...
    get_pull_request_override_state_output: Optional[shared_getpullrequestoverridestateoutput.GetPullRequestOverrideStateOutput] = dataclasses.field(default=None)
