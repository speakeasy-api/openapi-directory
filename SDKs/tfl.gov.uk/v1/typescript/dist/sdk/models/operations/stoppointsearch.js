...
exports.StopPointSearchResponse = exports.StopPointSearchRequest = void 0;
...
var StopPointSearchRequest = /** @class */ (function (_super) {
    ...
    ], StopPointSearchRequest.prototype, "faresOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=includeHubs",
        }),
        __metadata("design:type", Boolean)
    ], StopPointSearchRequest.prototype, "includeHubs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=lines" }),
        __metadata("design:type", Array)
    ], StopPointSearchRequest.prototype, "lines", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=maxResults",
        }),
        __metadata("design:type", Number)
    ], StopPointSearchRequest.prototype, "maxResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=modes" }),
        __metadata("design:type", Array)
    ], StopPointSearchRequest.prototype, "modes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=query",
        }),
        __metadata("design:type", String)
    ], StopPointSearchRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=tflOperatedNationalRailStationsOnly",
        }),
        __metadata("design:type", Boolean)
    ], StopPointSearchRequest.prototype, "tflOperatedNationalRailStationsOnly", void 0);
    return StopPointSearchRequest;
}(utils_1.SpeakeasyBase));
exports.StopPointSearchRequest = StopPointSearchRequest;
var StopPointSearchResponse = /** @class */ (function (_super) {
    ...
    ], StopPointSearchResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.StopPointSearchResponse = StopPointSearchResponse;
