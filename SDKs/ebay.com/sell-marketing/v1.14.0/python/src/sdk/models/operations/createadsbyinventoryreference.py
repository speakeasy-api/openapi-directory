...
class CreateAdsByInventoryReferenceRequest:
    ...
    create_ads_by_inventory_reference_request: shared_createadsbyinventoryreferencerequest.CreateAdsByInventoryReferenceRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""This request object defines the fields used in the <b>createAdsByInventoryReference</b> request."""  
