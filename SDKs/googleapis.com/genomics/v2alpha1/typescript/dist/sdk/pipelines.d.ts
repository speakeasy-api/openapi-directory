...
export declare class Pipelines {
     ...
     */
    genomicsPipelinesRun(req: operations.GenomicsPipelinesRunRequest, security: operations.GenomicsPipelinesRunSecurity, config?: AxiosRequestConfig): Promise<operations.GenomicsPipelinesRunResponse>;
}
