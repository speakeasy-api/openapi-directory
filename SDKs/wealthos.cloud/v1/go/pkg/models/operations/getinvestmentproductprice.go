...
func (e GetInvestmentProductPriceCategoryIDEnum) ToPointer() *GetInvestmentProductPriceCategoryIDEnum {
	return &e
}
...
func (e *GetInvestmentProductPriceCategoryIDEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "funds":
		*e = GetInvestmentProductPriceCategoryIDEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetInvestmentProductPriceCategoryIDEnum: %v", v)
	}
}
