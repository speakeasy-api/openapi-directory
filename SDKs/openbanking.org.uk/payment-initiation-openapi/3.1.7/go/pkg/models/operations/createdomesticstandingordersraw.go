...
type CreateDomesticStandingOrdersRawSecurity struct {
	PSUOAuth2Security shared.SchemePsuoAuth2Security `security:"scheme,type=oauth2"`
}

type CreateDomesticStandingOrdersRawHeaders struct {
...
type CreateDomesticStandingOrdersRawRequest struct {
	Headers CreateDomesticStandingOrdersRawHeaders
	// Default
	Request  []byte `request:"mediaType=application/jose+jwe"`
	Security CreateDomesticStandingOrdersRawSecurity
}

type CreateDomesticStandingOrdersRawResponse struct {
	Body        []byte
	ContentType string
