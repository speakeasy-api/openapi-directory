...
export class MlProjectsPredictSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MlProjectsPredictRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MlProjectsPredictResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
