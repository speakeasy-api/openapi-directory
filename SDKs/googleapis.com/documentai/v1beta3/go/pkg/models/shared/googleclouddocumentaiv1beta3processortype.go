...
func (e *GoogleCloudDocumentaiV1beta3ProcessorTypeLaunchStageEnum) UnmarshalJSON(data []byte) error {
	...
	case "GA":
		fallthrough
	case "DEPRECATED":
		*e = GoogleCloudDocumentaiV1beta3ProcessorTypeLaunchStageEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudDocumentaiV1beta3ProcessorTypeLaunchStageEnum: %s", s)
	}
}
