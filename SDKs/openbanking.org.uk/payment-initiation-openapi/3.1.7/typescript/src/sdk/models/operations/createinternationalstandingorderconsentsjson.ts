...
export class CreateInternationalStandingOrderConsentsJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateInternationalStandingOrderConsentsJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateInternationalStandingOrderConsentsJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
