...
class GoogleCloudDiscoveryengineV1alphaRecommendResponse:
    ...
    results: Optional[list[shared_googleclouddiscoveryenginev1alpharecommendresponserecommendationresult.GoogleCloudDiscoveryengineV1alphaRecommendResponseRecommendationResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})
