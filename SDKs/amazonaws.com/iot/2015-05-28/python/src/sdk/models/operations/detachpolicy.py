...
class DetachPolicyRequest:
    headers: DetachPolicyHeaders = dataclasses.field()
    path_params: DetachPolicyPathParams = dataclasses.field()
    request: DetachPolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
