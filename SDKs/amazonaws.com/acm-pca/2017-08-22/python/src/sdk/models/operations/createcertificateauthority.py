...
class CreateCertificateAuthorityRequest:
    ...
    create_certificate_authority_request: shared_createcertificateauthorityrequest.CreateCertificateAuthorityRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
