...
public class UpdateentiredocumentQueryParams {
    /**
    ...
    public UpdateentiredocumentQueryParams withSchema(String schema) {
        this.schema = schema;
        return this;
    }
    ...
    public String where;
    public UpdateentiredocumentQueryParams withWhere(String where) {
        this.where = where;
        return this;
    }
