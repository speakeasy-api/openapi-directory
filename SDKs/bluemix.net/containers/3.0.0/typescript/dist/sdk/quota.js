...
var Quota = /** @class */ (function () {
    function Quota(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Quota.prototype.getContainersQuota = function (req, config) {
    ...
    **/
    Quota.prototype.getContainersUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Quota.prototype.putContainersQuota = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
