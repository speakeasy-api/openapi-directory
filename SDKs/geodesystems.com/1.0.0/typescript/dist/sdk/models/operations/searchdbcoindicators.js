...
exports.SearchDbCoIndicatorsResponse = exports.SearchDbCoIndicatorsRequest = exports.SearchDbCoIndicatorsQueryParams = void 0;
...
var SearchDbCoIndicatorsQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_db_co_indicators.description" }),
        __metadata("design:type", String)
    ], SearchDbCoIndicatorsQueryParams.prototype, "searchDbDbCoIndicatorsDescription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_db_co_indicators.domain" }),
        __metadata("design:type", String)
    ], SearchDbCoIndicatorsQueryParams.prototype, "searchDbDbCoIndicatorsDomain", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_db_co_indicators.geo_name" }),
        __metadata("design:type", String)
    ], SearchDbCoIndicatorsQueryParams.prototype, "searchDbDbCoIndicatorsGeoName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_db_co_indicators.indicatorName" }),
        __metadata("design:type", String)
    ], SearchDbCoIndicatorsQueryParams.prototype, "searchDbDbCoIndicatorsIndicatorName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_db_co_indicators.location" }),
        __metadata("design:type", String)
    ], SearchDbCoIndicatorsQueryParams.prototype, "searchDbDbCoIndicatorsLocation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_db_co_indicators.measure" }),
        __metadata("design:type", Number)
    ], SearchDbCoIndicatorsQueryParams.prototype, "searchDbDbCoIndicatorsMeasure", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_db_co_indicators.subdomain" }),
        __metadata("design:type", String)
...
exports.SearchDbCoIndicatorsQueryParams = SearchDbCoIndicatorsQueryParams;
...
exports.SearchDbCoIndicatorsRequest = SearchDbCoIndicatorsRequest;
...
exports.SearchDbCoIndicatorsResponse = SearchDbCoIndicatorsResponse;
