...
export declare class GetTransactionsByIdv1Request extends SpeakeasyBase {
    ican: number;
    limit: number;
    offset: number;
}
 ...
 */
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionBatchItemDetails extends SpeakeasyBase {
    /**
 ...
 */
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionRelatedCard extends SpeakeasyBase {
    alias?: string;
    cardId?: number;
 ...
 */
export declare enum GetTransactionsByIdv1CardTransactionsv1TransactionCurrencyCodeEnum {
    Eur = "EUR",
    Gbp = "GBP"
}
/**
 * The currency.
 */
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionCurrency extends SpeakeasyBase {
    /**
     * The three letter code for the currency - either `EUR` or `GBP`.
     */
 ...
 */
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionDirectDebitDetails extends SpeakeasyBase {
    /**
 ...
 */
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionFxTrade extends SpeakeasyBase {
    /**
...
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionProprietarySchemeDetails extends SpeakeasyBase {
    /**
...
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionRelatedPartyRelatedPartyCardPaymentCardMerchant extends SpeakeasyBase {
...
export declare enum GetTransactionsByIdv1CardTransactionsv1TransactionRelatedPartyRelatedPartyCardPaymentTypeEnum {
 ...
 */
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionRelatedPartyRelatedPartyCardPayment extends SpeakeasyBase {
...
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionRelatedPartyRelatedPartyPayeeAccount extends SpeakeasyBase {
    /**
...
export declare enum GetTransactionsByIdv1CardTransactionsv1TransactionRelatedPartyRelatedPartyPayeeTypeEnum {
    WithdrawalAccount = "WITHDRAWAL_ACCOUNT"
}
/**
 * Details of the related third party involved in the transaction.
 */
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionRelatedPartyRelatedPartyPayee extends SpeakeasyBase {
...
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionRelatedPartyRelatedPartyExternalAccountAccount extends SpeakeasyBase {
    /**
...
export declare enum GetTransactionsByIdv1CardTransactionsv1TransactionRelatedPartyRelatedPartyExternalAccountTypeEnum {
    ExternalAccount = "EXTERNAL_ACCOUNT"
}
/**
 * Details of the related third party involved in the transaction.
 */
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionRelatedPartyRelatedPartyExternalAccount extends SpeakeasyBase {
...
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionRelatedPartyRelatedPartyFireAccountAccount extends SpeakeasyBase {
    /**
     * the Account Number of the account.
     */
    accountNumber?: string;
...
export declare enum GetTransactionsByIdv1CardTransactionsv1TransactionRelatedPartyRelatedPartyFireAccountTypeEnum {
    FireAccount = "FIRE_ACCOUNT"
}
/**
 * Details of the related third party involved in the transaction.
 */
export declare class GetTransactionsByIdv1CardTransactionsv1TransactionRelatedPartyRelatedPartyFireAccount extends SpeakeasyBase {
...
export declare class GetTransactionsByIdv1CardTransactionsv1Transaction extends SpeakeasyBase {
    /**
 ...
 */
export declare class GetTransactionsByIdv1CardTransactionsv1 extends SpeakeasyBase {
    /**
...
export declare class GetTransactionsByIdv1Response extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
