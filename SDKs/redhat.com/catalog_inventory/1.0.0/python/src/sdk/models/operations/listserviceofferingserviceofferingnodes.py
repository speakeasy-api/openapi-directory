...
class ListServiceOfferingServiceOfferingNodesRequest:
    path_params: ListServiceOfferingServiceOfferingNodesPathParams = dataclasses.field()
    query_params: ListServiceOfferingServiceOfferingNodesQueryParams = dataclasses.field()
