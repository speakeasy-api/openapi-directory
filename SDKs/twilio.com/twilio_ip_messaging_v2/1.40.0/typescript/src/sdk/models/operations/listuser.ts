...
export const ListUserServerList = ["https://ip-messaging.twilio.com"] as const;
...
export class ListUserListUserResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.IpMessagingV2ServiceUser })
  @Expose({ name: "users" })
  @Type(() => shared.IpMessagingV2ServiceUser)
