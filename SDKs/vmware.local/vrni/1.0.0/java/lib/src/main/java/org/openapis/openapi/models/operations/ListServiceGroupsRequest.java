...
public class ListServiceGroupsRequest {
    ...
    public ListServiceGroupsRequest withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public ListServiceGroupsRequest withEndTime(Double endTime) {
    ...
    public ListServiceGroupsRequest withSize(Double size) {
        this.size = size;
        return this;
    }
    ...
    public ListServiceGroupsRequest withStartTime(Double startTime) {
