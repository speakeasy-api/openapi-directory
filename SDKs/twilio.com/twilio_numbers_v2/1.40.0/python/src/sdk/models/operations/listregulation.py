...
class ListRegulationRequest:
    ...
    r"""The type of phone number that the regulatory requiremnt is restricting."""  
...
class ListRegulationListRegulationResponse:
    ...
    meta: Optional[ListRegulationListRegulationResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    results: Optional[list[shared_numbers_v2_regulatory_compliance_regulation.NumbersV2RegulatoryComplianceRegulation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
