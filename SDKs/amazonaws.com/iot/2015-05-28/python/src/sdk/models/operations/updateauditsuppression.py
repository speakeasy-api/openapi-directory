...
class UpdateAuditSuppressionRequestBodyResourceIdentifier:
    r"""UpdateAuditSuppressionRequestBodyResourceIdentifier
...
class UpdateAuditSuppressionRequestBody:
    ...
    resource_identifier: UpdateAuditSuppressionRequestBodyResourceIdentifier = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceIdentifier') }})
...
class UpdateAuditSuppressionRequest:
    headers: UpdateAuditSuppressionHeaders = dataclasses.field()
    request: UpdateAuditSuppressionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateAuditSuppressionResponse:
    ...
    update_audit_suppression_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
