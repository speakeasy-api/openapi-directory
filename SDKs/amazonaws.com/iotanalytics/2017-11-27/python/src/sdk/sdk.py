...
class SDK:
    ...
    def batch_put_message(self, request: operations.BatchPutMessageRequest) -> operations.BatchPutMessageResponse:
        ...
        res = operations.BatchPutMessageResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BatchPutMessageResponse])
    ...
    def cancel_pipeline_reprocessing(self, request: operations.CancelPipelineReprocessingRequest) -> operations.CancelPipelineReprocessingResponse:
        ...
        res = operations.CancelPipelineReprocessingResponse(status_code=r.status_code, content_type=content_type)
    ...
    def create_dataset_content(self, request: operations.CreateDatasetContentRequest) -> operations.CreateDatasetContentResponse:
        ...
        res = operations.CreateDatasetContentResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateDatasetContentResponse])
    ...
    def create_datastore(self, request: operations.CreateDatastoreRequest) -> operations.CreateDatastoreResponse:
        ...
        res = operations.CreateDatastoreResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateDatastoreResponse])
    ...
    def delete_dataset_content(self, request: operations.DeleteDatasetContentRequest) -> operations.DeleteDatasetContentResponse:
        ...
        res = operations.DeleteDatasetContentResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_datastore(self, request: operations.DeleteDatastoreRequest) -> operations.DeleteDatastoreResponse:
        ...
        res = operations.DeleteDatastoreResponse(status_code=r.status_code, content_type=content_type)
    ...
    def describe_channel(self, request: operations.DescribeChannelRequest) -> operations.DescribeChannelResponse:
        ...
        res = operations.DescribeChannelResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeChannelResponse])
    ...
    def describe_datastore(self, request: operations.DescribeDatastoreRequest) -> operations.DescribeDatastoreResponse:
        ...
        res = operations.DescribeDatastoreResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeDatastoreResponse])
    ...
    def get_dataset_content(self, request: operations.GetDatasetContentRequest) -> operations.GetDatasetContentResponse:
        ...
        res = operations.GetDatasetContentResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetDatasetContentResponse])
    ...
    def list_dataset_contents(self, request: operations.ListDatasetContentsRequest) -> operations.ListDatasetContentsResponse:
        ...
        res = operations.ListDatasetContentsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListDatasetContentsResponse])
    ...
    def list_datastores(self, request: operations.ListDatastoresRequest) -> operations.ListDatastoresResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListDatastoresResponse])
    ...
    def run_pipeline_activity(self, request: operations.RunPipelineActivityRequest) -> operations.RunPipelineActivityResponse:
        ...
        res = operations.RunPipelineActivityResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.RunPipelineActivityResponse])
    ...
    def sample_channel_data(self, request: operations.SampleChannelDataRequest) -> operations.SampleChannelDataResponse:
        ...
        res = operations.SampleChannelDataResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SampleChannelDataResponse])
    ...
    def start_pipeline_reprocessing(self, request: operations.StartPipelineReprocessingRequest) -> operations.StartPipelineReprocessingResponse:
        ...
        res = operations.StartPipelineReprocessingResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StartPipelineReprocessingResponse])
    ...
    def update_dataset(self, request: operations.UpdateDatasetRequest) -> operations.UpdateDatasetResponse:
        ...
        res = operations.UpdateDatasetResponse(status_code=r.status_code, content_type=content_type)
    ...
    def update_datastore(self, request: operations.UpdateDatastoreRequest) -> operations.UpdateDatastoreResponse:
        ...
        res = operations.UpdateDatastoreResponse(status_code=r.status_code, content_type=content_type)
