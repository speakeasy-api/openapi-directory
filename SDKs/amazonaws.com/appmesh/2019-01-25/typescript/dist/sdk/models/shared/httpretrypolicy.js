...
exports.HttpRetryPolicy = void 0;
...
var HttpRetryPolicy = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=httpRetryEvents" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=perRetryTimeout" }),
        __metadata("design:type", duration_1.Duration)
    ], HttpRetryPolicy.prototype, "perRetryTimeout", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=tcpRetryEvents" }),
        __metadata("design:type", Array)
