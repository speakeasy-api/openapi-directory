...
export class DeleteCloudFrontOriginAccessIdentity20180618Request extends SpeakeasyBase {
  /**
...
export class DeleteCloudFrontOriginAccessIdentity20180618Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
