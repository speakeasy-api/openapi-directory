...
class CreateTokenHeaders:
    x_amz_target: CreateTokenXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateTokenRequest:
    ...
    request: shared_createtokenrequest.CreateTokenRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
