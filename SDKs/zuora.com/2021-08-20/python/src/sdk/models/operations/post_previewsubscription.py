...
from ..shared import postsubscriptionpreviewtype as shared_postsubscriptionpreviewtype
...
class POSTPreviewSubscriptionRequest:
    ...
    post_subscription_preview_type: shared_postsubscriptionpreviewtype.POSTSubscriptionPreviewType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
