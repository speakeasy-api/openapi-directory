...
func (e InvoiceLineItemTypeEnum) ToPointer() *InvoiceLineItemTypeEnum {
	return &e
}
...
func (e *InvoiceLineItemTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "info":
		fallthrough
	case "sub_total":
		*e = InvoiceLineItemTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for InvoiceLineItemTypeEnum: %v", v)
	}
}
