...
from ..shared import getticketresponse as shared_getticketresponse
...
@dataclasses.dataclass
class CollectionTicketsOneRequest:
...
class CollectionTicketsOneResponse:
    ...
    r"""Bad Request"""  
    get_ticket_response: Optional[shared_getticketresponse.GetTicketResponse] = dataclasses.field(default=None)
    r"""Get a Ticket"""  
