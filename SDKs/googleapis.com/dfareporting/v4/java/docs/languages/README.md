...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DfareportingLanguagesListRequest req = new DfareportingLanguagesListRequest("tempore") {{
            ...
            DfareportingLanguagesListResponse res = sdk.languages.dfareportingLanguagesList(req, new DfareportingLanguagesListSecurity("excepturi", "ipsa") {{
