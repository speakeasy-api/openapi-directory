...
* [licer](#licer) - Insurance Policy - Life
* [prcpt](#prcpt) - Premium Receipt
...
import org.openapis.openapi.models.operations.LicerSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            LicerRequestBody req = new LicerRequestBody(LicerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new LicerRequestBodyCertificateParameters("Sunil Kumar", "C000000013", "21-11-2006");;
            ...
            LicerResponse res = sdk.apIs.licer(req, new LicerSecurity("maiores", "molestiae") {{
...
import java.time.OffsetDateTime;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.PrcptRequestBody;
import org.openapis.openapi.models.operations.PrcptRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.PrcptRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.PrcptResponse;
import org.openapis.openapi.models.operations.PrcptSecurity;
import org.openapis.openapi.models.shared.ConsentArtifactSchema;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsent;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentData;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentDataConsumer;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PrcptRequestBody req = new PrcptRequestBody(PrcptRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new PrcptRequestBodyCertificateParameters("Sunil Kumar", "28-01-2016", "Previous Year, Current Year", "C000000217");;
            ...
            PrcptResponse res = sdk.apIs.prcpt(req, new PrcptSecurity("qui", "impedit") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
