...
class GetNetworkApplianceClientSecurityEventsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNetworkApplianceClientSecurityEventsSortOrderEnum $sortOrder
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortOrder')]
    public ?GetNetworkApplianceClientSecurityEventsSortOrderEnum $sortOrder = null;
