...
export declare class GetResponseHeadersPolicyConfig20200531Request extends SpeakeasyBase {
    /**
...
export declare class GetResponseHeadersPolicyConfig20200531Response extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
