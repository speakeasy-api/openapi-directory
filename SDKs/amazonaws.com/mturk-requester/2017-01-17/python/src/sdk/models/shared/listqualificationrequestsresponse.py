...
class ListQualificationRequestsResponse:
    ...
    qualification_requests: Optional[list[shared_qualificationrequest.QualificationRequest]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('QualificationRequests'), 'exclude': lambda f: f is None }})  
