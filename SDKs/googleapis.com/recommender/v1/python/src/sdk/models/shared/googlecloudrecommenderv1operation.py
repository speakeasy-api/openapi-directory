...
class GoogleCloudRecommenderV1Operation:
    r"""GoogleCloudRecommenderV1Operation
    ...
    path_value_matchers: Optional[dict[str, shared_googlecloudrecommenderv1valuematcher.GoogleCloudRecommenderV1ValueMatcher]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pathValueMatchers') }})
    ...
    value_matcher: Optional[shared_googlecloudrecommenderv1valuematcher.GoogleCloudRecommenderV1ValueMatcher] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('valueMatcher') }})
