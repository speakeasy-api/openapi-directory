...
class GetDescribeEnvironmentManagedActionHistoryRequest:
    headers: GetDescribeEnvironmentManagedActionHistoryHeaders = dataclasses.field()
    query_params: GetDescribeEnvironmentManagedActionHistoryQueryParams = dataclasses.field()
