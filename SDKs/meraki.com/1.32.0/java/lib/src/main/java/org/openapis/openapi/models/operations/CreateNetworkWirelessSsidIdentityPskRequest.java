...
public class CreateNetworkWirelessSsidIdentityPskRequest {
    ...
    public CreateNetworkWirelessSsidIdentityPskRequest(@JsonProperty("RequestBody") CreateNetworkWirelessSsidIdentityPskRequestBody requestBody, @JsonProperty("networkId") String networkId, @JsonProperty("number") String number) {
        this.requestBody = requestBody;
        this.networkId = networkId;
        this.number = number;
  }
