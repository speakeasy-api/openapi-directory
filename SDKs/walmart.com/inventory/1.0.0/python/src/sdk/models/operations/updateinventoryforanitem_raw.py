...
class UpdateInventoryForAnItemApplicationXMLQuantityUnitEnum(str, Enum):
...
class UpdateInventoryForAnItemApplicationXMLQuantity:
    ...
    r"""Inventory Count"""  
    unit: UpdateInventoryForAnItemApplicationXMLQuantityUnitEnum = dataclasses.field()
    r"""The unit of measurement. Example: 'EACH'"""  
...
class UpdateInventoryForAnItemApplicationXML:
    ...
    quantity: UpdateInventoryForAnItemApplicationXMLQuantity = dataclasses.field()
    r"""Quantity that has been ordered by the customers but not yet shipped"""  
...
class UpdateInventoryForAnItemRaw200ApplicationXMLQuantityUnitEnum(str, Enum):
    r"""The unit of measurement. Example: 'EACH'"""
    EACH = 'EACH'
...
class UpdateInventoryForAnItemRaw200ApplicationXMLQuantity:
    ...
    amount: float = dataclasses.field()
    r"""Inventory Count"""  
    unit: UpdateInventoryForAnItemRaw200ApplicationXMLQuantityUnitEnum = dataclasses.field()
    r"""The unit of measurement. Example: 'EACH'"""  
...
class UpdateInventoryForAnItemRaw200ApplicationXML:
    ...
    quantity: UpdateInventoryForAnItemRaw200ApplicationXMLQuantity = dataclasses.field()
    r"""Quantity that has been ordered by the customers but not yet shipped"""  
    sku: str = dataclasses.field()
    r"""A seller-provided Product ID. Response will have decoded value."""  
    
class UpdateInventoryForAnItemRaw200ApplicationJSONQuantityUnitEnum(str, Enum):
    r"""The unit of measurement. Example: 'EACH'"""
    EACH = 'EACH'
...
class UpdateInventoryForAnItemRaw200ApplicationJSONQuantity:
    ...
    r"""Inventory Count"""  
    unit: UpdateInventoryForAnItemRaw200ApplicationJSONQuantityUnitEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('unit') }})
    r"""The unit of measurement. Example: 'EACH'"""  
...
class UpdateInventoryForAnItemRaw200ApplicationJSON:
    ...
    quantity: UpdateInventoryForAnItemRaw200ApplicationJSONQuantity = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('quantity') }})
    r"""Quantity that has been ordered by the customers but not yet shipped"""  
...
class UpdateInventoryForAnItemRawResponse:
    ...
    update_inventory_for_an_item_raw_200_application_json_object: Optional[UpdateInventoryForAnItemRaw200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful Operation"""  
