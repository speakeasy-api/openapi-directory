...
class WorkerResource:
    ...
    r"""Optional. CPU request and limit for a single Airflow worker replica."""  
    ...
    r"""Optional. Maximum number of workers for autoscaling."""  
    ...
    r"""Optional. Memory (GB) request and limit for a single Airflow worker replica."""  
    min_count: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('minCount'), 'exclude': lambda f: f is None }})
    r"""Optional. Minimum number of workers for autoscaling."""  
    ...
    r"""Optional. Storage (GB) request and limit for a single Airflow worker replica."""  
