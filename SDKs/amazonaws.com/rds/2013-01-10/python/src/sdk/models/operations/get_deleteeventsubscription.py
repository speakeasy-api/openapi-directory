...
class GetDeleteEventSubscriptionQueryParams:
    action: GetDeleteEventSubscriptionActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    subscription_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'SubscriptionName', 'style': 'form', 'explode': True }})
    version: GetDeleteEventSubscriptionVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteEventSubscriptionRequest:
    headers: GetDeleteEventSubscriptionHeaders = dataclasses.field()
    query_params: GetDeleteEventSubscriptionQueryParams = dataclasses.field()
