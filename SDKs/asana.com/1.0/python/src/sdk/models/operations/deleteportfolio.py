...
class DeletePortfolioRequest:
    path_params: DeletePortfolioPathParams = dataclasses.field()
    query_params: DeletePortfolioQueryParams = dataclasses.field()
...
class DeletePortfolioResponse:
    ...
    delete_portfolio_200_application_json_object: Optional[DeletePortfolio200ApplicationJSON] = dataclasses.field(default=None)
