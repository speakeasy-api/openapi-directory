...
exports.ViewOnlyLinks = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ViewOnlyLinks = /** @class */ (function () {
    function ViewOnlyLinks(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ViewOnlyLinks.prototype.viewOnlyLinksNodeList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ViewOnlyLinksNodeListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/view_only_links/{link_id}/nodes/", req.pathParams);
     ...
     * If the request is unsuccessful, an `errors` key containing information about the failure will be returned. Refer to the [list of error codes](#tag/Errors-and-Error-Codes) to understand why this request may have failed.
    **/
    ViewOnlyLinks.prototype.viewOnlyLinksRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ViewOnlyLinksReadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/view_only_links/{link_id}/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
...
exports.ViewOnlyLinks = ViewOnlyLinks;
