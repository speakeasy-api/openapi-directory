...
func (e StopRunXAmzTargetEnum) ToPointer() *StopRunXAmzTargetEnum {
	return &e
}
...
func (e *StopRunXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "DeviceFarm_20150623.StopRun":
		*e = StopRunXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for StopRunXAmzTargetEnum: %v", v)
	}
}

type StopRunRequest struct {
	StopRunRequest    shared.StopRunRequest `request:"mediaType=application/json"`
