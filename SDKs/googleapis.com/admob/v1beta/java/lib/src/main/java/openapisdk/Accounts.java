...
public class Accounts {
    ...
    **/
    public openapisdk.models.operations.AdmobAccountsAdSourcesListResponse admobAccountsAdSourcesList(openapisdk.models.operations.AdmobAccountsAdSourcesListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1beta/{parent}/adSources", request.pathParams);
        ...
        openapisdk.models.operations.AdmobAccountsAdSourcesListResponse res = new openapisdk.models.operations.AdmobAccountsAdSourcesListResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.ListAdSourcesResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ListAdSourcesResponse.class);
    ...
    **/
    public openapisdk.models.operations.AdmobAccountsAdUnitsListResponse admobAccountsAdUnitsList(openapisdk.models.operations.AdmobAccountsAdUnitsListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1beta/{parent}/adUnits", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.AdmobAccountsAppsListResponse admobAccountsAppsList(openapisdk.models.operations.AdmobAccountsAppsListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1beta/{parent}/apps", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.AdmobAccountsMediationReportGenerateResponse admobAccountsMediationReportGenerate(openapisdk.models.operations.AdmobAccountsMediationReportGenerateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1beta/{parent}/mediationReport:generate", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.AdmobAccountsNetworkReportGenerateResponse admobAccountsNetworkReportGenerate(openapisdk.models.operations.AdmobAccountsNetworkReportGenerateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1beta/{parent}/networkReport:generate", request.pathParams);
