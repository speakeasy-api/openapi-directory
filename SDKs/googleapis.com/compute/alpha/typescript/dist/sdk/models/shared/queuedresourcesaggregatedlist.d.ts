...
import { QueuedResourcesScopedList } from "./queuedresourcesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum QueuedResourcesAggregatedListWarningCodeEnum {
...
export declare class QueuedResourcesAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class QueuedResourcesAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: QueuedResourcesAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: QueuedResourcesAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class QueuedResourcesAggregatedList extends SpeakeasyBase {
    /**
     ...
     */
    items?: Record<string, QueuedResourcesScopedList>;
    /**
     ...
     * [Output Only] Informational warning message.
     */
    warning?: QueuedResourcesAggregatedListWarning;
}
