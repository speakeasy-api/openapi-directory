...
class POSTBillingDocumentFilesDeletionJobRequest:
    ...
    post_billing_document_files_deletion_job_request: shared_postbillingdocumentfilesdeletionjobrequest.POSTBillingDocumentFilesDeletionJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
