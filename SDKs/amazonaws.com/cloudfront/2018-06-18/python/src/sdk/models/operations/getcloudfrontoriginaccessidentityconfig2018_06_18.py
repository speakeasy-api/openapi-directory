...
class GetCloudFrontOriginAccessIdentityConfig20180618Request:
    headers: GetCloudFrontOriginAccessIdentityConfig20180618Headers = dataclasses.field()
    path_params: GetCloudFrontOriginAccessIdentityConfig20180618PathParams = dataclasses.field()
