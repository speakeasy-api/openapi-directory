...
class GetEc2InstanceRecommendationsRequest:
    ...
    get_ec2_instance_recommendations_request: shared_getec2instancerecommendationsrequest.GetEc2InstanceRecommendationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
