...
var ManagedScaling = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "instanceWarmupPeriod" }),
        __metadata("design:type", Number)
    ], ManagedScaling.prototype, "instanceWarmupPeriod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maximumScalingStepSize" }),
        __metadata("design:type", Number)
    ], ManagedScaling.prototype, "maximumScalingStepSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "minimumScalingStepSize" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "targetCapacity" }),
        __metadata("design:type", Number)
