...
export class GetUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsclustersRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export class GetUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsclusters200ApplicationJSON extends SpeakeasyBase {
  /**
...
export class GetUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsclustersResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
