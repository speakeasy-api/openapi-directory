...
class ListPendingInvitationResourcesRequestBodyResourceRegionScopeEnum(str, Enum):
...
class ListPendingInvitationResourcesRequestBody:
    ...
    r"""Specifies the <a href=\\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\\">Amazon Resoure Name (ARN)</a> of the invitation. You can use <a>GetResourceShareInvitations</a> to find the ARN of the invitation."""  
    ...
    resource_region_scope: Optional[ListPendingInvitationResourcesRequestBodyResourceRegionScopeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resourceRegionScope'), 'exclude': lambda f: f is None }})
    r"""<p>Specifies that you want the results to include only resources that have the specified scope.</p> <ul> <li> <p> <code>ALL</code> – the results include both global and regional resources or resource types.</p> </li> <li> <p> <code>GLOBAL</code> – the results include only global resources or resource types.</p> </li> <li> <p> <code>REGIONAL</code> – the results include only regional resources or resource types.</p> </li> </ul> <p>The default value is <code>ALL</code>.</p>"""  
...
class ListPendingInvitationResourcesRequest:
    ...
    request_body: ListPendingInvitationResourcesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
