...
type GETCMTaxItemTypeTaxRateTypeEnum string

const (
	GETCMTaxItemTypeTaxRateTypeEnumPercentage GETCMTaxItemTypeTaxRateTypeEnum = "Percentage"
	GETCMTaxItemTypeTaxRateTypeEnumFlatFee    GETCMTaxItemTypeTaxRateTypeEnum = "FlatFee"
)

func (e *GETCMTaxItemTypeTaxRateTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Percentage":
		fallthrough
	case "FlatFee":
		*e = GETCMTaxItemTypeTaxRateTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETCMTaxItemTypeTaxRateTypeEnum: %s", s)
	}
}
...
type GETCMTaxItemType struct {
	...
	//
	TaxRateType *GETCMTaxItemTypeTaxRateTypeEnum `json:"taxRateType,omitempty"`
