...
class ListTablesRequest:
    ...
    connected_database: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ConnectedDatabase'), 'exclude': lambda f: f is None }})  
    ...
    schema_pattern: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SchemaPattern'), 'exclude': lambda f: f is None }})  
    ...
    table_pattern: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TablePattern'), 'exclude': lambda f: f is None }})  
