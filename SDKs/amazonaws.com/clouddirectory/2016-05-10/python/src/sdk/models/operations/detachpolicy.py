...
class DetachPolicyRequestBody:
    object_reference: DetachPolicyRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ObjectReference') }})
    policy_reference: DetachPolicyRequestBodyPolicyReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('PolicyReference') }})
