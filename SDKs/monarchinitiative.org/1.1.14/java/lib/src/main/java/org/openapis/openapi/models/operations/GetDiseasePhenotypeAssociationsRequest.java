...
public class GetDiseasePhenotypeAssociationsRequest {
    ...
    public GetDiseasePhenotypeAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetDiseasePhenotypeAssociationsRequest withEvidence(String evidence) {
    ...
    public GetDiseasePhenotypeAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetDiseasePhenotypeAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetDiseasePhenotypeAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetDiseasePhenotypeAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsRequest withRelation(String relation) {
    ...
    public GetDiseasePhenotypeAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetDiseasePhenotypeAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetDiseasePhenotypeAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetDiseasePhenotypeAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
