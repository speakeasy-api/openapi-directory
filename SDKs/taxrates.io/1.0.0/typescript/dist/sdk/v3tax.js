...
var V3Tax = /** @class */ (function () {
    ...
    V3Tax.prototype.allTaxRates = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.AllTaxRatesResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        ...
                        res.allTaxRates200ApplicationJSONObjects = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.AllTaxRates200ApplicationJSON, resFieldDepth);
                    }
                    break;
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 500:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.allTaxRates500ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.AllTaxRates500ApplicationJSON);
                    }
                    break;
            }
            return res;
