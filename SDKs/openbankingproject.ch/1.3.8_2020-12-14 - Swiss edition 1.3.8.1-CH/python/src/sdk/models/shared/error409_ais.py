...
class Error409AISAdditionalErrors:
    ...
    code: shared_messagecode409_ais_enum.MessageCode409AISEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})
...
class Error409AIS:
    ...
    additional_errors: Optional[list[Error409AISAdditionalErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalErrors'), 'exclude': lambda f: f is None }})
