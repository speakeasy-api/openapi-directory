...
public class UpsertSellerCommissionsQueryParams {
    /**
    ...
    public UpsertSellerCommissionsQueryParams withAccountName(String accountName) {
    ...
    public UpsertSellerCommissionsQueryParams withEnvironment(String environment) {
