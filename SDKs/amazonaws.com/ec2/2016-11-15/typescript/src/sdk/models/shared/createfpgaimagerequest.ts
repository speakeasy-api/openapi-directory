 ...
 */
export enum CreateFpgaImageRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateFpgaImageRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateFpgaImageRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateFpgaImageRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateFpgaImageRequestTagSpecificationsTags })
  tags?: CreateFpgaImageRequestTagSpecificationsTags[];
}

export class CreateFpgaImageRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken?: string;
  ...
  @SpeakeasyMetadata({ elemType: CreateFpgaImageRequestTagSpecifications })
