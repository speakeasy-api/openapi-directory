...
exports.GetNetworkPiiPiiKeysResponse = exports.GetNetworkPiiPiiKeysRequest = void 0;
...
var GetNetworkPiiPiiKeysRequest = /** @class */ (function (_super) {
    ...
    ], GetNetworkPiiPiiKeysRequest.prototype, "bluetoothMac", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=email" }),
        __metadata("design:type", String)
    ], GetNetworkPiiPiiKeysRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=imei" }),
        __metadata("design:type", String)
    ], GetNetworkPiiPiiKeysRequest.prototype, "imei", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=mac" }),
        __metadata("design:type", String)
    ], GetNetworkPiiPiiKeysRequest.prototype, "mac", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=networkId",
        }),
        __metadata("design:type", String)
    ], GetNetworkPiiPiiKeysRequest.prototype, "networkId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=serial",
        }),
        __metadata("design:type", String)
    ], GetNetworkPiiPiiKeysRequest.prototype, "serial", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=username",
        }),
        __metadata("design:type", String)
    ], GetNetworkPiiPiiKeysRequest.prototype, "username", void 0);
...
var GetNetworkPiiPiiKeysResponse = /** @class */ (function (_super) {
    ...
    ], GetNetworkPiiPiiKeysResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
