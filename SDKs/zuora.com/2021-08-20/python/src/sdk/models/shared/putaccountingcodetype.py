...
class PUTAccountingCodeTypeTypeEnum(str, Enum):
    r"""Accounting code type. You cannot change the type of an accounting code from `AccountsReceivable` to a different type.
...
class PUTAccountingCodeType:
    ...
    type: Optional[PUTAccountingCodeTypeTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Accounting code type. You cannot change the type of an accounting code from `AccountsReceivable` to a different type.
