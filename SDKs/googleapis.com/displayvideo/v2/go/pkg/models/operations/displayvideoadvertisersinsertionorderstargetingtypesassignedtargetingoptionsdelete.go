...
func (e *DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "TARGETING_TYPE_SESSION_POSITION":
		*e = DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum: %s", s)
	}
}
