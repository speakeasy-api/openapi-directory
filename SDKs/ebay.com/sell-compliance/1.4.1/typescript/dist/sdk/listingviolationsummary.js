...
var ListingViolationSummary = /** @class */ (function () {
     ...
     */
    ListingViolationSummary.prototype.getListingViolationsSummary = function (req, security, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetListingViolationsSummaryResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json;charset=UTF-8")) {
                        res.complianceSummary = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ComplianceSummary);
                    }
                    break;
