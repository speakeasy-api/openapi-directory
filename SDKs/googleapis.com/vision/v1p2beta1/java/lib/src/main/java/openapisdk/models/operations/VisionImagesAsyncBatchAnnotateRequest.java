...
public class VisionImagesAsyncBatchAnnotateRequest {
    ...
    public openapisdk.models.shared.GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest request;
    public VisionImagesAsyncBatchAnnotateRequest withRequest(openapisdk.models.shared.GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest request) {
