...
class ListByocTrunkListByocTrunkResponse:
    ...
    byoc_trunks: Optional[list[shared_voice_v1_byoc_trunk.VoiceV1ByocTrunk]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('byoc_trunks'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListByocTrunkListByocTrunkResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
