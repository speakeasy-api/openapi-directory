...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/googleapis.com/documentai/v1beta3/python
```
...
* `documentai_projects_locations_processor_types_get` - Gets a processor type detail.
...
* `documentai_projects_locations_processors_processor_versions_import_processor_version` - Imports a processor version from source processor version.
