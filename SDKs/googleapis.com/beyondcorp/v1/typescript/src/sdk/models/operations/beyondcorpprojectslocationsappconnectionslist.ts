...
export class BeyondcorpProjectsLocationsAppConnectionsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BeyondcorpProjectsLocationsAppConnectionsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BeyondcorpProjectsLocationsAppConnectionsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
