...
public class SubscriberResource {
    ...
    public SubscriberResource(@JsonProperty("accountId") String accountId, @JsonProperty("sourceTypes") SourceType[] sourceTypes, @JsonProperty("subscriptionId") String subscriptionId) {
        this.accountId = accountId;
        this.sourceTypes = sourceTypes;
        this.subscriptionId = subscriptionId;
  }
