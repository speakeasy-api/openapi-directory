...
class ComputeOrganizationSecurityPoliciesCopyRulesRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?string $sourceSecurityPolicy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sourceSecurityPolicy')]
    public ?string $sourceSecurityPolicy = null;
	...
	public function __construct()
	{
		...
		$this->requestId = null;
		$this->securityPolicy = "";
		$this->sourceSecurityPolicy = null;
