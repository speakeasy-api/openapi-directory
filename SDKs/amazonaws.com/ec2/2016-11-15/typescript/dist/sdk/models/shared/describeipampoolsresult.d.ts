 ...
 */
export declare enum DescribeIpamPoolsResultIpamPoolsAddressFamilyEnum {
    Ipv4 = "ipv4",
    Ipv6 = "ipv6"
}
/**
 ...
 */
export declare class DescribeIpamPoolsResultIpamPoolsAllocationResourceTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare enum DescribeIpamPoolsResultIpamPoolsAwsServiceEnum {
    Ec2 = "ec2"
}
/**
 * In IPAM, a scope is the highest-level container within IPAM. An IPAM contains two default scopes. Each scope represents the IP space for a single network. The private scope is intended for all private IP address space. The public scope is intended for all public IP address space. Scopes enable you to reuse IP addresses across multiple unconnected networks without causing IP address overlap or conflict.
 */
export declare enum DescribeIpamPoolsResultIpamPoolsIpamScopeTypeEnum {
    Public = "public",
    Private = "private"
}
/**
 ...
 */
export declare enum DescribeIpamPoolsResultIpamPoolsPublicIpSourceEnum {
    Amazon = "amazon",
    Byoip = "byoip"
}
/**
 ...
 */
export declare enum DescribeIpamPoolsResultIpamPoolsStateEnum {
 ...
 * Describes a tag.
 */
export declare class DescribeIpamPoolsResultIpamPoolsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class DescribeIpamPoolsResultIpamPools extends SpeakeasyBase {
 ...
 * Success
 */
export declare class DescribeIpamPoolsResult extends SpeakeasyBase {
