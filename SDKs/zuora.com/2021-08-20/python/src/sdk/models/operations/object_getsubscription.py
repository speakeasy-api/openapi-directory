...
class ObjectGetSubscriptionPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectGetSubscriptionQueryParams:
    fields: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class ObjectGetSubscriptionHeaders:
...
@dataclasses.dataclass
class ObjectGetSubscriptionRequest:
    headers: ObjectGetSubscriptionHeaders = dataclasses.field()
    path_params: ObjectGetSubscriptionPathParams = dataclasses.field()
    query_params: ObjectGetSubscriptionQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class ObjectGetSubscriptionResponse:
    content_type: str = dataclasses.field()
    headers: dict[str, list[str]] = dataclasses.field()
    status_code: int = dataclasses.field()
    proxy_get_subscription: Optional[dict[str, Any]] = dataclasses.field(default=None)
