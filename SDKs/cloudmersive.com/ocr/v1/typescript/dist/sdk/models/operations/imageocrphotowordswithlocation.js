...
exports.ImageOcrPhotoWordsWithLocationResponse = exports.ImageOcrPhotoWordsWithLocationRequest = exports.ImageOcrPhotoWordsWithLocationRequestBody = exports.ImageOcrPhotoWordsWithLocationRequestBodyImageFile = exports.ImageOcrPhotoWordsWithLocationSecurity = void 0;
...
var ImageOcrPhotoWordsWithLocationRequest = /** @class */ (function (_super) {
    ...
    ], ImageOcrPhotoWordsWithLocationRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=diagnostics",
        }),
        __metadata("design:type", String)
    ], ImageOcrPhotoWordsWithLocationRequest.prototype, "diagnostics", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=language",
        }),
        __metadata("design:type", String)
    ], ImageOcrPhotoWordsWithLocationRequest.prototype, "language", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=preprocessing",
        }),
        __metadata("design:type", String)
    ], ImageOcrPhotoWordsWithLocationRequest.prototype, "preprocessing", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=recognitionMode",
        }),
        __metadata("design:type", String)
    ], ImageOcrPhotoWordsWithLocationRequest.prototype, "recognitionMode", void 0);
...
var ImageOcrPhotoWordsWithLocationResponse = /** @class */ (function (_super) {
    ...
    ], ImageOcrPhotoWordsWithLocationResponse.prototype, "rawResponse", void 0);
