...
class LatestV1GetV1LatestGetOrderByLocationsOrderEnum(str, Enum):
    r"""An enumeration."""
    CITY = 'city'
    COUNTRY = 'country'
    LOCATION = 'location'
...
class LatestV1GetV1LatestGetSortSortEnum(str, Enum):
    r"""An enumeration."""
    ASC = 'asc'
    DESC = 'desc'
...
class LatestV1GetV1LatestGetRequest:
    ...
    order_by: Optional[LatestV1GetV1LatestGetOrderByLocationsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order_by', 'style': 'form', 'explode': True }})
    r"""Order by a field"""  
    ...
    r"""Type of Sensor"""  
    sort: Optional[LatestV1GetV1LatestGetSortSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""Sort Direction"""  
