 ...
 */
export enum UpdateShipmentResponseBodyDeliveryConfirmationEnum {
  None = "none",
  Delivery = "delivery",
  Signature = "signature",
 ...
 */
export enum UpdateShipmentResponseBodyInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export enum UpdateShipmentResponseBodyInternationalShipmentOptionsNonDeliveryEnum {
 ...
 */
export class UpdateShipmentResponseBodyInternationalShipmentOptions extends SpeakeasyBase {
  /**
 ...
 */
export enum UpdateShipmentResponseBodyInsuranceProviderEnum {
  None = "none",
 ...
 */
export enum UpdateShipmentResponseBodyOriginTypeEnum {
  Pickup = "pickup",
  DropOff = "drop_off",
}
 ...
 */
export enum UpdateShipmentResponseBodyShipmentStatusEnum {
  Pending = "pending",
 ...
 */
export class UpdateShipmentResponseBodyWeight extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "unit" })
  unit: WeightUnitEnum;
 ...
 *
 */
export class UpdateShipmentResponseBody extends SpeakeasyBase {
  /**
   * The address validation
   */
  @SpeakeasyMetadata()
  @Expose({ name: "address_validation" })
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "customs" })
  @Type(() => UpdateShipmentResponseBodyInternationalShipmentOptions)
  ...
  @Type(() => UpdateShipmentResponseBodyWeight)
