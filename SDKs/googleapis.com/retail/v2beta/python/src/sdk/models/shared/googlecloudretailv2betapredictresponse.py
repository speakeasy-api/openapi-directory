...
import dataclasses
from ..shared import googlecloudretailv2betapredictresponsepredictionresult as shared_googlecloudretailv2betapredictresponsepredictionresult
...
class GoogleCloudRetailV2betaPredictResponse:
    ...
    results: Optional[list[shared_googlecloudretailv2betapredictresponsepredictionresult.GoogleCloudRetailV2betaPredictResponsePredictionResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})
