...
class SearchMediaVideoChannelQueryParams:
...
@dataclasses.dataclass
class SearchMediaVideoChannelRequest:
    query_params: SearchMediaVideoChannelQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchMediaVideoChannelResponse:
