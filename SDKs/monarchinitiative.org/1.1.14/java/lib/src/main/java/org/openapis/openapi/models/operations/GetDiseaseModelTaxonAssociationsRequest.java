...
public class GetDiseaseModelTaxonAssociationsRequest {
    ...
    public GetDiseaseModelTaxonAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetDiseaseModelTaxonAssociationsRequest withEvidence(String evidence) {
    ...
    public GetDiseaseModelTaxonAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetDiseaseModelTaxonAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetDiseaseModelTaxonAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetDiseaseModelTaxonAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetDiseaseModelTaxonAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetDiseaseModelTaxonAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetDiseaseModelTaxonAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetDiseaseModelTaxonAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetDiseaseModelTaxonAssociationsRequest withTaxon(String taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetDiseaseModelTaxonAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetDiseaseModelTaxonAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetDiseaseModelTaxonAssociationsRequest(@JsonProperty("id") String id, @JsonProperty("taxon") String taxon) {
        this.id = id;
        this.taxon = taxon;
  }
}
