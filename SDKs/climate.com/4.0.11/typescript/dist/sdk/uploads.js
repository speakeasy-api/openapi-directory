...
var Uploads = /** @class */ (function () {
    ...
    **/
    Uploads.prototype.chunkedUpload = function (req, config) {
    ...
    **/
    Uploads.prototype.fetchUploadStatusById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Uploads.prototype.fetchUploadStatuses = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *    </details>
    **/
    Uploads.prototype.postUpload = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
