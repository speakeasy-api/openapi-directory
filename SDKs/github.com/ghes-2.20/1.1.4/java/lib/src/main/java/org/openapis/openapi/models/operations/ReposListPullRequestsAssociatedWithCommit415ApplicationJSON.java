...
public class ReposListPullRequestsAssociatedWithCommit415ApplicationJSON {
    ...
    public ReposListPullRequestsAssociatedWithCommit415ApplicationJSON(@JsonProperty("documentation_url") String documentationUrl, @JsonProperty("message") String message) {
        this.documentationUrl = documentationUrl;
        this.message = message;
  }
}
