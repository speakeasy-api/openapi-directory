...
class NetworkReportSpec:
    ...
    dimension_filters: Optional[list[shared_networkreportspecdimensionfilter.NetworkReportSpecDimensionFilter]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dimensionFilters') }})
    dimensions: Optional[list[NetworkReportSpecDimensionsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dimensions') }})
    ...
    metrics: Optional[list[NetworkReportSpecMetricsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('metrics') }})
    sort_conditions: Optional[list[shared_networkreportspecsortcondition.NetworkReportSpecSortCondition]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sortConditions') }})
