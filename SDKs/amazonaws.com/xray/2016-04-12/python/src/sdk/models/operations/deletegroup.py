...
class DeleteGroupRequestBody:
    ...
    r"""The ARN of the group that was generated on creation."""  
...
class DeleteGroupRequest:
    ...
    request_body: DeleteGroupRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
