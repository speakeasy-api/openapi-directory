...
exports.ListConferenceResponse = exports.ListConferenceListConferenceResponse = exports.ListConferenceRequest = exports.ListConferenceSecurity = exports.ListConferenceServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListConferenceServerList = ["https://api.twilio.com"];
...
var ListConferenceRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListConferenceRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreated;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListConferenceRequest.prototype, "dateCreated", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreated<;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListConferenceRequest.prototype, "dateCreatedLessThan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreated>;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListConferenceRequest.prototype, "dateCreatedGreaterThan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateUpdated;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListConferenceRequest.prototype, "dateUpdated", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateUpdated<;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListConferenceRequest.prototype, "dateUpdatedLessThan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateUpdated>;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListConferenceRequest.prototype, "dateUpdatedGreaterThan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
...
var ListConferenceListConferenceResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ApiV2010AccountConference }),
        (0, class_transformer_1.Expose)({ name: "conferences" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountConference; }),
