...
public class ActionPOSTdeleteRequest {
    ...
    public org.openapis.openapi.models.shared.ProxyActiondeleteRequest proxyActiondeleteRequest;
    public ActionPOSTdeleteRequest withProxyActiondeleteRequest(org.openapis.openapi.models.shared.ProxyActiondeleteRequest proxyActiondeleteRequest) {
        this.proxyActiondeleteRequest = proxyActiondeleteRequest;
        return this;
    }
    ...
    public ActionPOSTdeleteRequest withXZuoraWSDLVersion(String xZuoraWSDLVersion) {
    ...
    public ActionPOSTdeleteRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public ActionPOSTdeleteRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public ActionPOSTdeleteRequest withRejectUnknownFields(Boolean rejectUnknownFields) {
