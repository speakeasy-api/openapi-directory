...
try {
    ...
    $request->requestBody->headSha = 'dolorum';
...
try {
    ...
    $request->checkRunId = 785153;
    $request->owner = 'doloribus';
    $request->page = 281730;
    $request->perPage = 703495;
...
try {
    ...
    $request->appId = 181631;
    $request->checkName = 'quae';
    $request->filter = ChecksListForRefFilterEnum::ALL;
    $request->owner = 'odio';
    $request->page = 580447;
    $request->perPage = 977496;
...
try {
    ...
    $request->checkName = 'quis';
    $request->checkSuiteId = 218403;
    $request->filter = ChecksListForSuiteFilterEnum::ALL;
    $request->owner = 'voluptate';
    $request->page = 231701;
    $request->perPage = 878870;
...
try {
    ...
    $request->appId = 941378;
    $request->checkName = 'distinctio';
    $request->owner = 'quod';
    $request->page = 486160;
    $request->perPage = 630448;
    $request->ref = 'facilis';
    $request->repo = 'vero';
