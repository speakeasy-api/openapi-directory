...
from ..shared import workgroupattributelistvo as shared_workgroupattributelistvo
...
class GetProductTypeListOfWorkgroupResponse:
    ...
    workgroup_attribute_list_vo: Optional[shared_workgroupattributelistvo.WorkgroupAttributeListVO] = dataclasses.field(default=None)
