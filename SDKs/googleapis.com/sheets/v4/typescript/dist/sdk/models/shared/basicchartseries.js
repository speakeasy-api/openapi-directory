...
var BasicChartSeries = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "lineStyle" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: basicseriesdatapointstyleoverride_1.BasicSeriesDataPointStyleOverride }),
        (0, class_transformer_1.Expose)({ name: "styleOverrides" }),
        (0, class_transformer_1.Type)(function () { return basicseriesdatapointstyleoverride_1.BasicSeriesDataPointStyleOverride; }),
