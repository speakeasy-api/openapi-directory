...
from ..shared import chargeupdate as shared_chargeupdate
...
class RatePlanUpdate:
    ...
    charge_updates: Optional[list[shared_chargeupdate.ChargeUpdate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('chargeUpdates') }})
