...
class DeleteAuditSuppressionRequestBody:
    ...
    resource_identifier: DeleteAuditSuppressionRequestBodyResourceIdentifier = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceIdentifier') }})
    

@dataclasses.dataclass
class DeleteAuditSuppressionRequest:
    headers: DeleteAuditSuppressionHeaders = dataclasses.field()
    request: DeleteAuditSuppressionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteAuditSuppressionResponse:
    ...
    delete_audit_suppression_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
