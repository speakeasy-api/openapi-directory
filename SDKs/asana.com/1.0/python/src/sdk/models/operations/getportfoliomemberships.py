...
class GetPortfolioMembershipsRequest:
    ...
    r"""The portfolio to filter results on."""  
...
class GetPortfolioMemberships200ApplicationJSON:
    r"""Successfully retrieved portfolio memberships."""
    
    data: Optional[list[shared_portfoliomembershipcompact.PortfolioMembershipCompact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
