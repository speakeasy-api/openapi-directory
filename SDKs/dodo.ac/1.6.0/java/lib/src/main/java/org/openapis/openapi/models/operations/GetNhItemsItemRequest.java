...
public class GetNhItemsItemRequest {
    ...
    public GetNhItemsItemRequest withAcceptVersion(String acceptVersion) {
    ...
    public GetNhItemsItemRequest withXApiKey(String xApiKey) {
    ...
    public GetNhItemsItemRequest withItem(String item) {
        this.item = item;
        return this;
    }
    ...
    public GetNhItemsItemRequest withThumbsize(Long thumbsize) {
        this.thumbsize = thumbsize;
        return this;
    }
    
    public GetNhItemsItemRequest(@JsonProperty("Accept-Version") String acceptVersion, @JsonProperty("X-API-KEY") String xApiKey, @JsonProperty("item") String item) {
        this.acceptVersion = acceptVersion;
        this.xApiKey = xApiKey;
        this.item = item;
  }
