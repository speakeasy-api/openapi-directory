...
class CreateReplicationJobRequest:
    ...
    create_replication_job_request: shared_createreplicationjobrequest.CreateReplicationJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class CreateReplicationJobResponse:
    ...
    r"""NoConnectorsAvailableException"""  
