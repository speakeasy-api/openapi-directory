...
public class TokensGetPartnerOfferSkuHistoryPathParams {
    /**
    ...
    public TokensGetPartnerOfferSkuHistoryPathParams withPartnerApplicationId(Integer partnerApplicationId) {
    ...
    public TokensGetPartnerOfferSkuHistoryPathParams withTargetBnetMembershipId(Long targetBnetMembershipId) {
