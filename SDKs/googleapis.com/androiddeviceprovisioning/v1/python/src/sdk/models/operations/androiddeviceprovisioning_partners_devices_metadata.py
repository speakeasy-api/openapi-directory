...
class AndroiddeviceprovisioningPartnersDevicesMetadataRequest:
    ...
    update_device_metadata_request: Optional[shared_updatedevicemetadatarequest.UpdateDeviceMetadataRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
