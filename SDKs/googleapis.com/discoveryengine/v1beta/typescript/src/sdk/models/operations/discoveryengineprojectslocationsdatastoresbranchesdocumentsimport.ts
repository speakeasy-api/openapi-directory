...
export class DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsImportSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsImportRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsImportResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
