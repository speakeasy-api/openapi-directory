...
export class ListUnderstandQueryListUnderstandQueryResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListUnderstandQueryListUnderstandQueryResponseMeta)
  meta?: ListUnderstandQueryListUnderstandQueryResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.PreviewUnderstandAssistantQuery })
  @Expose({ name: "queries" })
  @Type(() => shared.PreviewUnderstandAssistantQuery)
