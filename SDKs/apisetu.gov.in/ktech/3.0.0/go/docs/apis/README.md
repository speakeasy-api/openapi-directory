...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Rfcer(ctx, operations.RfcerRequestBody{
        CertificateParameters: &operations.RfcerRequestBodyCertificateParameters{
            CertType: "Registration",
            CompanyName: "Solution Pollution BMS",
            RegNo: "IT/Registration/0477/2019-20",
            Sector: "IT",
        ...
        Format: operations.RfcerRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.RfcerSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
