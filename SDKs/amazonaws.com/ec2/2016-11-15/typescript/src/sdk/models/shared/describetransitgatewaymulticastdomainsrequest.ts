 ...
 */
export class DescribeTransitGatewayMulticastDomainsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeTransitGatewayMulticastDomainsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
