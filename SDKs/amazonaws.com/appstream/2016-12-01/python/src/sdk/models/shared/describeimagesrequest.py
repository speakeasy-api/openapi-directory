...
class DescribeImagesRequest:
    ...
    type: Optional[shared_visibilitytype_enum.VisibilityTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Type'), 'exclude': lambda f: f is None }})  
