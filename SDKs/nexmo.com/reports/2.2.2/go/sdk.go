...
func (s *SDK) CancelReport(ctx context.Context, request operations.CancelReportRequest) (*operations.CancelReportResponse, error) {
	...
	url := utils.GenerateURL(ctx, baseURL, "/v2/reports/{report_id}", request.PathParams)
	...
	case httpRes.StatusCode == 401:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CancelReport401ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CancelReport404ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 409:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CancelReport409ApplicationJSONAny = out
		}
	}
...
func (s *SDK) CreateAsyncReport(ctx context.Context, request operations.CreateAsyncReportRequest) (*operations.CreateAsyncReportResponse, error) {
	...
	case httpRes.StatusCode == 400:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CreateAsyncReport400ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 401:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CreateAsyncReport401ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 403:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CreateAsyncReport403ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 422:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CreateAsyncReport422ApplicationJSONAny = out
		}
	}
...
func (s *SDK) DownloadReport(ctx context.Context, request operations.DownloadReportRequest) (*operations.DownloadReportResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v3/media/{file_id}", request.PathParams)
	...
	case httpRes.StatusCode == 401:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.DownloadReport401ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 404:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.DownloadReport404ApplicationJSONAny = out
		}
	}
...
func (s *SDK) GetRecords(ctx context.Context, request operations.GetRecordsRequest) (*operations.GetRecordsResponse, error) {
	...
	case httpRes.StatusCode == 403:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetRecords403ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 422:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
...
func (s *SDK) GetReport(ctx context.Context, request operations.GetReportRequest) (*operations.GetReportResponse, error) {
	...
	case httpRes.StatusCode == 401:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetReport401ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 404:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetReport404ApplicationJSONAny = out
		}
	}
...
func (s *SDK) ListReports(ctx context.Context, request operations.ListReportsRequest) (*operations.ListReportsResponse, error) {
	...
	case httpRes.StatusCode == 400:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ListReports400ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 401:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ListReports401ApplicationJSONAny = out
		}
	}
