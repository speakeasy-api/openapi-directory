...
exports.TaskAddCollectionResponse = exports.TaskAddCollectionRequest = void 0;
...
var TaskAddCollectionRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", shared.TaskAddCollectionParameter)
    ], TaskAddCollectionRequest.prototype, "taskAddCollectionParameter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=api-version",
        }),
        __metadata("design:type", String)
    ], TaskAddCollectionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], TaskAddCollectionRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=jobId",
        }),
        __metadata("design:type", String)
    ], TaskAddCollectionRequest.prototype, "jobId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], TaskAddCollectionRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], TaskAddCollectionRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], TaskAddCollectionRequest.prototype, "timeout", void 0);
...
var TaskAddCollectionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], TaskAddCollectionResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.TaskAddCollectionResult)
