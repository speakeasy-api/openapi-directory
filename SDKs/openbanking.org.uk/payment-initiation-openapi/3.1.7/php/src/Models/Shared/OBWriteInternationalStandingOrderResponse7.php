...
class OBWriteInternationalStandingOrderResponse7
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7Data')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7Data();
		$this->links = null;
		$this->meta = null;
	}
}
