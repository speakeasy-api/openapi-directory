...
func main() {
    ...
    res, err := s.ScheduleMesages.GetUpcomingScheduledCampaignsAndCanvases(ctx, operations.GetUpcomingScheduledCampaignsAndCanvasesRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.ScheduleMesages.ScheduleAPITriggeredCanvases(ctx, operations.ScheduleAPITriggeredCanvasesRequestBody{
        ...
        Recipients: []ScheduleAPITriggeredCanvasesRequestBodyRecipients{
            operations.ScheduleAPITriggeredCanvasesRequestBodyRecipients{
                ...
                TriggerProperties: sdk.String("at"),
