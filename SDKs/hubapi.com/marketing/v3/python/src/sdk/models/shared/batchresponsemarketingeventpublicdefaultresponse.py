...
class BatchResponseMarketingEventPublicDefaultResponse:
    ...
    results: list[shared_marketingeventpublicdefaultresponse.MarketingEventPublicDefaultResponse] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results') }})  
    ...
    status: BatchResponseMarketingEventPublicDefaultResponseStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
