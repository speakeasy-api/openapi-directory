...
public class AndroidpublisherReviewsGetQueryParams {
    ...
    public AndroidpublisherReviewsGetQueryParams withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public AndroidpublisherReviewsGetQueryParams withAccessToken(String accessToken) {
    ...
    public AndroidpublisherReviewsGetQueryParams withAlt(org.openapis.openapi.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
    ...
    public AndroidpublisherReviewsGetQueryParams withCallback(String callback) {
    ...
    public AndroidpublisherReviewsGetQueryParams withUploadType(String uploadType) {
    ...
    public AndroidpublisherReviewsGetQueryParams withUploadProtocol(String uploadProtocol) {
