...
type PostRoutingVersionNumberCalculateRouteLocationsContentTypeRawPathParams struct {
...
type PostRoutingVersionNumberCalculateRouteLocationsContentTypeRawQueryParams struct {
...
type PostRoutingVersionNumberCalculateRouteLocationsContentTypeRawRequest struct {
	PathParams  PostRoutingVersionNumberCalculateRouteLocationsContentTypeRawPathParams
	QueryParams PostRoutingVersionNumberCalculateRouteLocationsContentTypeRawQueryParams
	Request     []byte `request:"mediaType=application/xml"`
}

type PostRoutingVersionNumberCalculateRouteLocationsContentTypeRawResponse struct {
	ContentType string
	StatusCode  int
