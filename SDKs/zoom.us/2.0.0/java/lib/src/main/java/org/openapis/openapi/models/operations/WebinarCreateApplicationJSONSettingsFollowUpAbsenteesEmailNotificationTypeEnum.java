 ...
 */
public enum WebinarCreateApplicationJSONSettingsFollowUpAbsenteesEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private WebinarCreateApplicationJSONSettingsFollowUpAbsenteesEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
