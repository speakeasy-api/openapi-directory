...
public class OrderApiChangeShippingDetailsJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public OrderApiChangeShippingDetailsJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public OrderApiChangeShippingDetailsJsonHeaders withXAuthSecret(String xAuthSecret) {
