...
var Downloads = /** @class */ (function () {
     ...
     * Get File
    **/
    Downloads.prototype.downloadFile = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DownloadFileRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/downloads/{dir}/{subdir}/{filename}", req.pathParams);
            ...
            switch (true) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.errorResponseBody = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
