...
class ListRecordingListRecordingResponse:
    ...
    recordings: Optional[list[shared_api_v2010_account_recording.APIV2010AccountRecording]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('recordings') }})
...
class ListRecordingRequest:
    path_params: ListRecordingPathParams = dataclasses.field()
