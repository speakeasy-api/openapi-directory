 ...
 */
export enum IpAddressesListWarningCodeEnum {
...
export class IpAddressesListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class IpAddressesListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: IpAddressesListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class IpAddressesList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: InternalIpAddress })
  @Expose({ name: "items" })
