...
export class GetRemoteBandwidthSnapshotsRequest extends SpeakeasyBase {
  /**
...
export class GetRemoteBandwidthSnapshotsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: shared.RemoteBandwidthSnapshotEntity })
