...
class SubaccountCreateMarketIDEnum(str, Enum):
    DA_DK = 'da-DK'
    DE_AT = 'de-AT'
    DE_CH = 'de-CH'
    DE_DE = 'de-DE'
...
class SubaccountCreate:
    ...
    market_id: Optional[SubaccountCreateMarketIDEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('marketId'), 'exclude': lambda f: f is None }})  
