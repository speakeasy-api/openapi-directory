...
var DescribeAggregateComplianceByConformancePacksResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: aggregatecompliancebyconformancepack_1.AggregateComplianceByConformancePack }),
        (0, class_transformer_1.Expose)({ name: "AggregateComplianceByConformancePacks" }),
        (0, class_transformer_1.Type)(function () { return aggregatecompliancebyconformancepack_1.AggregateComplianceByConformancePack; }),
