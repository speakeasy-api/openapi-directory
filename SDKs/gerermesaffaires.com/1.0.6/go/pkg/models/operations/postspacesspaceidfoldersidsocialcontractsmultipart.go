...
func (e PostSpacesSpaceIDFoldersIDSocialContractsMultipartFormDataAccountingWorkbookEnum) ToPointer() *PostSpacesSpaceIDFoldersIDSocialContractsMultipartFormDataAccountingWorkbookEnum {
	return &e
}
...
func (e *PostSpacesSpaceIDFoldersIDSocialContractsMultipartFormDataAccountingWorkbookEnum) UnmarshalJSON(data []byte) error {
	...
	case "other":
		fallthrough
	case "permanent":
		*e = PostSpacesSpaceIDFoldersIDSocialContractsMultipartFormDataAccountingWorkbookEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostSpacesSpaceIDFoldersIDSocialContractsMultipartFormDataAccountingWorkbookEnum: %v", v)
	}
}
