...
exports.ListHostedNumbersAuthorizationDocumentResponse = exports.ListHostedNumbersAuthorizationDocumentListHostedNumbersAuthorizationDocumentResponse = exports.ListHostedNumbersAuthorizationDocumentListHostedNumbersAuthorizationDocumentResponseMeta = exports.ListHostedNumbersAuthorizationDocumentRequest = exports.ListHostedNumbersAuthorizationDocumentSecurity = exports.ListHostedNumbersAuthorizationDocumentServerList = void 0;
...
var ListHostedNumbersAuthorizationDocumentSecurity = /** @class */ (function (_super) {
    ...
    ], ListHostedNumbersAuthorizationDocumentSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListHostedNumbersAuthorizationDocumentSecurity.prototype, "username", void 0);
...
var ListHostedNumbersAuthorizationDocumentRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListHostedNumbersAuthorizationDocumentRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListHostedNumbersAuthorizationDocumentRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListHostedNumbersAuthorizationDocumentRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListHostedNumbersAuthorizationDocumentRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListHostedNumbersAuthorizationDocumentRequest.prototype, "status", void 0);
...
var ListHostedNumbersAuthorizationDocumentListHostedNumbersAuthorizationDocumentResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.PreviewHostedNumbersAuthorizationDocument; }),
...
var ListHostedNumbersAuthorizationDocumentResponse = /** @class */ (function (_super) {
    ...
    ], ListHostedNumbersAuthorizationDocumentResponse.prototype, "rawResponse", void 0);
