...
type DeleteAppVersionResourceHeaders struct {
...
type DeleteAppVersionResourceRequestBody struct {
	...
	LogicalResourceID *DeleteAppVersionResourceRequestBodyLogicalResourceID `json:"logicalResourceId,omitempty"`
...
type DeleteAppVersionResourceRequest struct {
	Headers DeleteAppVersionResourceHeaders
	Request DeleteAppVersionResourceRequestBody `request:"mediaType=application/json"`
}
