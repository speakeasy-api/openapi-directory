...
public class UserUpdateUserQueryParams {
    /**
    ...
    public UserUpdateUserQueryParams withAccountNumber(String accountNumber) {
    ...
    public UserUpdateUserQueryParams withExternalEntityNumber(String externalEntityNumber) {
    ...
    public UserUpdateUserQueryParams withGuardian(Integer guardian) {
    ...
    public UserUpdateUserQueryParams withGymNumber(String gymNumber) {
    ...
    public UserUpdateUserQueryParams withIntroduceBy(Integer introduceBy) {
    ...
    public String name;
    public UserUpdateUserQueryParams withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UserUpdateUserQueryParams withNumber(String number) {
        this.number = number;
        return this;
    }
    ...
    public UserUpdateUserQueryParams withTypeId(Integer typeId) {
        this.typeId = typeId;
        return this;
    }
    ...
    public UserUpdateUserQueryParams withUserId(Integer userId) {
        this.userId = userId;
        return this;
    }
