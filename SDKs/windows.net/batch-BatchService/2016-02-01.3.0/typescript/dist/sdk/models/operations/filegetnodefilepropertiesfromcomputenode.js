...
exports.FileGetNodeFilePropertiesFromComputeNodeResponse = exports.FileGetNodeFilePropertiesFromComputeNodeRequest = void 0;
...
var FileGetNodeFilePropertiesFromComputeNodeRequest = /** @class */ (function (_super) {
    ...
    ], FileGetNodeFilePropertiesFromComputeNodeRequest.prototype, "ifModifiedSince", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=If-Unmodified-Since",
        }),
        __metadata("design:type", String)
    ], FileGetNodeFilePropertiesFromComputeNodeRequest.prototype, "ifUnmodifiedSince", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=api-version",
        }),
        __metadata("design:type", String)
    ], FileGetNodeFilePropertiesFromComputeNodeRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], FileGetNodeFilePropertiesFromComputeNodeRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=fileName",
        }),
        __metadata("design:type", String)
    ], FileGetNodeFilePropertiesFromComputeNodeRequest.prototype, "fileName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=nodeId",
        }),
        __metadata("design:type", String)
    ], FileGetNodeFilePropertiesFromComputeNodeRequest.prototype, "nodeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], FileGetNodeFilePropertiesFromComputeNodeRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=poolId",
        }),
        __metadata("design:type", String)
    ], FileGetNodeFilePropertiesFromComputeNodeRequest.prototype, "poolId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], FileGetNodeFilePropertiesFromComputeNodeRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], FileGetNodeFilePropertiesFromComputeNodeRequest.prototype, "timeout", void 0);
...
var FileGetNodeFilePropertiesFromComputeNodeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], FileGetNodeFilePropertiesFromComputeNodeResponse.prototype, "rawResponse", void 0);
