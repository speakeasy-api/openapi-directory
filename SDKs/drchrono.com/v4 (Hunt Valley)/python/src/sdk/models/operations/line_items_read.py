...
class LineItemsReadPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class LineItemsReadQueryParams:
...
class LineItemsReadRequest:
    path_params: LineItemsReadPathParams = dataclasses.field()
    query_params: LineItemsReadQueryParams = dataclasses.field()
    security: LineItemsReadSecurity = dataclasses.field()
