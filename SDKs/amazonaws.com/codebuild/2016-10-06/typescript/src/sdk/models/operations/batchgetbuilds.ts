...
export enum BatchGetBuildsXAmzTargetEnum {
  CodeBuild20161006BatchGetBuilds = "CodeBuild_20161006.BatchGetBuilds",
}

export class BatchGetBuildsRequest extends SpeakeasyBase {
...
export class BatchGetBuildsResponse extends SpeakeasyBase {
  /**
   * Success
   */
  @SpeakeasyMetadata()
