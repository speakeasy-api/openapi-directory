...
func (e *UpdateStageRequestBodyDefaultRouteSettingsLoggingLevelEnum) UnmarshalJSON(data []byte) error {
	...
	case "INFO":
		fallthrough
	case "OFF":
		*e = UpdateStageRequestBodyDefaultRouteSettingsLoggingLevelEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateStageRequestBodyDefaultRouteSettingsLoggingLevelEnum: %s", s)
	}
}
