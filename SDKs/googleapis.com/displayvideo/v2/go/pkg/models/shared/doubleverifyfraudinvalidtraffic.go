...
func (e DoubleVerifyFraudInvalidTrafficAvoidedFraudOptionEnum) ToPointer() *DoubleVerifyFraudInvalidTrafficAvoidedFraudOptionEnum {
	return &e
}
...
func (e *DoubleVerifyFraudInvalidTrafficAvoidedFraudOptionEnum) UnmarshalJSON(data []byte) error {
	...
	case "AD_IMPRESSION_FRAUD_2":
		*e = DoubleVerifyFraudInvalidTrafficAvoidedFraudOptionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DoubleVerifyFraudInvalidTrafficAvoidedFraudOptionEnum: %v", v)
	}
}
