...
var GetDomainSuggestionsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: domainsuggestion_1.DomainSuggestion }),
        (0, class_transformer_1.Expose)({ name: "SuggestionsList" }),
        (0, class_transformer_1.Type)(function () { return domainsuggestion_1.DomainSuggestion; }),
