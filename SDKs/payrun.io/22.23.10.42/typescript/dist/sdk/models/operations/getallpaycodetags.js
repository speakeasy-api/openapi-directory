...
exports.GetAllPayCodeTagsResponse = exports.GetAllPayCodeTagsRequest = void 0;
...
var GetAllPayCodeTagsRequest = /** @class */ (function (_super) {
    ...
    ], GetAllPayCodeTagsRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetAllPayCodeTagsRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetAllPayCodeTagsRequest.prototype, "employerId", void 0);
    return GetAllPayCodeTagsRequest;
}(utils_1.SpeakeasyBase));
exports.GetAllPayCodeTagsRequest = GetAllPayCodeTagsRequest;
var GetAllPayCodeTagsResponse = /** @class */ (function (_super) {
    ...
    ], GetAllPayCodeTagsResponse.prototype, "rawResponse", void 0);
    return GetAllPayCodeTagsResponse;
}(utils_1.SpeakeasyBase));
exports.GetAllPayCodeTagsResponse = GetAllPayCodeTagsResponse;
