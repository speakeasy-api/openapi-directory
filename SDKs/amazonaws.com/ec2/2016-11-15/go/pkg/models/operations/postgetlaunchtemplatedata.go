...
func (e POSTGetLaunchTemplateDataActionEnum) ToPointer() *POSTGetLaunchTemplateDataActionEnum {
	return &e
}
...
func (e *POSTGetLaunchTemplateDataActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "GetLaunchTemplateData":
		*e = POSTGetLaunchTemplateDataActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTGetLaunchTemplateDataActionEnum: %v", v)
	}
}
...
func (e POSTGetLaunchTemplateDataVersionEnum) ToPointer() *POSTGetLaunchTemplateDataVersionEnum {
	return &e
}
...
func (e *POSTGetLaunchTemplateDataVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2016-11-15":
		*e = POSTGetLaunchTemplateDataVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTGetLaunchTemplateDataVersionEnum: %v", v)
	}
}
