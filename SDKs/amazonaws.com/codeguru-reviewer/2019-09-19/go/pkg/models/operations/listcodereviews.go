...
func (e ListCodeReviewsTypeEnum) ToPointer() *ListCodeReviewsTypeEnum {
	return &e
}
...
func (e *ListCodeReviewsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "RepositoryAnalysis":
		*e = ListCodeReviewsTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListCodeReviewsTypeEnum: %v", v)
	}
}
