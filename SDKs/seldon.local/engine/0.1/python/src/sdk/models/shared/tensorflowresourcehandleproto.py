...
class TensorflowResourceHandleProto:
    r"""Protocol buffer representing a handle to a tensorflow resource. Handles are not valid across executions, but can be serialized back and forth from within a single run."""
    ...
    r"""Hash code for the type of the resource. Is only valid in the same device and in the same execution."""  
    ...
    r"""For debug-only, the name of the type pointed to by this handle, if available."""  
