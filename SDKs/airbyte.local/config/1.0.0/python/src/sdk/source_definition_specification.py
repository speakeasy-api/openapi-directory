...
class SourceDefinitionSpecification:
    ...
    def get_source_definition_specification(self, request: shared.SourceDefinitionIDWithWorkspaceID) -> operations.GetSourceDefinitionSpecificationResponse:
        ...
        res = operations.GetSourceDefinitionSpecificationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SourceDefinitionSpecificationRead])
