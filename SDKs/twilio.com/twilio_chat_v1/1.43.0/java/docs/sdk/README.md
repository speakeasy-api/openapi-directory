...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            if (res.chatV1ServiceChannel != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            if (res.chatV1ServiceChannelInvite != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            if (res.chatV1ServiceChannelMember != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            if (res.chatV1ServiceChannelMessage != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
