...
type RunNamespacesTasksGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RunNamespacesTasksGetPathParams struct {
...
type RunNamespacesTasksGetQueryParams struct {
	// V1 error format.
...
type RunNamespacesTasksGetRequest struct {
...
type RunNamespacesTasksGetResponse struct {
	ContentType string
	StatusCode  int
