...
func (e RequestGroupsXSdsDateFormatEnum) ToPointer() *RequestGroupsXSdsDateFormatEnum {
	return &e
}
...
func (e *RequestGroupsXSdsDateFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "EPOCH":
		fallthrough
	case "LEET":
		*e = RequestGroupsXSdsDateFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RequestGroupsXSdsDateFormatEnum: %v", v)
	}
}
