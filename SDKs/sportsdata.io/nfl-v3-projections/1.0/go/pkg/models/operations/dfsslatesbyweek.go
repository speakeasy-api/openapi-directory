...
func (e DfsSlatesByWeekFormatEnum) ToPointer() *DfsSlatesByWeekFormatEnum {
	return &e
}
...
func (e *DfsSlatesByWeekFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = DfsSlatesByWeekFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DfsSlatesByWeekFormatEnum: %v", v)
	}
}
