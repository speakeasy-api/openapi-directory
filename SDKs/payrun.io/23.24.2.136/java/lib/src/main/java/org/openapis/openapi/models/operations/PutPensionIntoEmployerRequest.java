...
public class PutPensionIntoEmployerRequest {
    ...
    public PutPensionIntoEmployerRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("EmployerId") String employerId, @JsonProperty("Pension") org.openapis.openapi.models.shared.Pension pension, @JsonProperty("PensionId") String pensionId) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.employerId = employerId;
        this.pension = pension;
