...
export class PerformPostActionRequestBody extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "flag_topic" })
  flagTopic?: boolean;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "post_action_type_id" })
  postActionTypeId: number;
}

export class PerformPostActionRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PerformPostAction200ApplicationJSONActionsSummary extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "acted" })
  acted?: boolean;
 ...
 * post updated
 */
export class PerformPostAction200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata({
    elemType: PerformPostAction200ApplicationJSONActionsSummary,
  })
  @Expose({ name: "actions_summary" })
  @Type(() => PerformPostAction200ApplicationJSONActionsSummary)
...
export class PerformPostActionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
