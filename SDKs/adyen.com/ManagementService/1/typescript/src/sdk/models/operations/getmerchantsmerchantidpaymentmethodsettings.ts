...
export class GetMerchantsMerchantIdPaymentMethodSettingsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetMerchantsMerchantIdPaymentMethodSettingsRequest extends SpeakeasyBase {
  /**
...
export class GetMerchantsMerchantIdPaymentMethodSettingsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
