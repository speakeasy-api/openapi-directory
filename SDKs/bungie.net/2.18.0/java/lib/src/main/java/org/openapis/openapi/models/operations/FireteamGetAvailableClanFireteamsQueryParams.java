...
public class FireteamGetAvailableClanFireteamsQueryParams {
    /**
    ...
    public FireteamGetAvailableClanFireteamsQueryParams withExcludeImmediate(Boolean excludeImmediate) {
    ...
    public FireteamGetAvailableClanFireteamsQueryParams withLangFilter(String langFilter) {
