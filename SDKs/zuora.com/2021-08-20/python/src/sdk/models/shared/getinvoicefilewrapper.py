...
import dataclasses
from ..shared import getinvoicetype as shared_getinvoicetype
...
class GETInvoiceFileWrapper:
    ...
    invoices: Optional[list[shared_getinvoicetype.GETInvoiceType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('invoices'), 'exclude': lambda f: f is None }})
    r"""Contains information about one or more invoices:"""  
