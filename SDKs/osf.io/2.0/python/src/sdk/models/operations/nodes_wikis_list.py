...
class NodesWikisListWiki:
    ...
    relationships: NodesWikisListWikiRelationships = dataclasses.field()
    r"""URLs to other entities or entity collections that have a relationship to the wiki."""  
    type: str = dataclasses.field()
    r"""The type identifier of the wiki (`wikis`)."""  
    attributes: Optional[NodesWikisListWikiAttributes] = dataclasses.field(default=None)
    r"""The properties of the wiki."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The identifier of the wiki."""  
    links: Optional[NodesWikisListWikiLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the wiki."""  
