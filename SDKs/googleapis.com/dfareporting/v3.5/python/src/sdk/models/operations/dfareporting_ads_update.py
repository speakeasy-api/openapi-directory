...
class DfareportingAdsUpdateSecurity:
...
@dataclasses.dataclass
class DfareportingAdsUpdateRequest:
    ...
    ad: Optional[shared_ad.Ad] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class DfareportingAdsUpdateResponse:
