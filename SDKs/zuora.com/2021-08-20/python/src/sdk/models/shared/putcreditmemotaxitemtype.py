...
class PutCreditMemoTaxItemTypeFinanceInformation:
    r"""Container for the finance information related to the taxation item in the credit memo item."""
...
class PutCreditMemoTaxItemTypeTaxRateTypeEnum(str, Enum):
...
class PutCreditMemoTaxItemType:
    r"""Container for custom fields of a Credit Taxation Item object."""
    
    id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id') }})
    r"""The ID of the taxation item in the credit memo item."""  
    amount: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('amount'), 'exclude': lambda f: f is None }})
    r"""The amount of the taxation item in the credit memo item."""  
    finance_information: Optional[PutCreditMemoTaxItemTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the taxation item in the credit memo item."""  
    ...
    tax_rate_type: Optional[PutCreditMemoTaxItemTypeTaxRateTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxRateType'), 'exclude': lambda f: f is None }})
    r"""The type of the tax rate applied to the credit memo."""  
