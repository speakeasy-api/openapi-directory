...
public class GetOrganizationSensorReadingsHistoryQueryParams {
    /**
     * A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=endingBefore")
    public String endingBefore;
    public GetOrganizationSensorReadingsHistoryQueryParams withEndingBefore(String endingBefore) {
    ...
    public GetOrganizationSensorReadingsHistoryQueryParams withMetrics(String[] metrics) {
    ...
    public GetOrganizationSensorReadingsHistoryQueryParams withNetworkIds(String[] networkIds) {
    ...
    public Long perPage;
    public GetOrganizationSensorReadingsHistoryQueryParams withPerPage(Long perPage) {
    ...
    public GetOrganizationSensorReadingsHistoryQueryParams withSerials(String[] serials) {
    ...
    public GetOrganizationSensorReadingsHistoryQueryParams withStartingAfter(String startingAfter) {
    ...
    public String t0;
    public GetOrganizationSensorReadingsHistoryQueryParams withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetOrganizationSensorReadingsHistoryQueryParams withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetOrganizationSensorReadingsHistoryQueryParams withTimespan(Float timespan) {
