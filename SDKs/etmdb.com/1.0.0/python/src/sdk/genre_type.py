...
class GenreType:
    ...
    def genre_type_search_read(self, request: operations.GenreTypeSearchReadRequest) -> operations.GenreTypeSearchReadResponse:
        ...
        * __{genre_description}__: Used as a key word to search genre types
        ...
        url = utils.generate_url(operations.GenreTypeSearchReadRequest, base_url, '/api/v1/genre-type/search/{genre_description}', request)
        ...
        res = operations.GenreTypeSearchReadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
