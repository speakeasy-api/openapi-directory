...
var Export = /** @class */ (function () {
     ...
     * ```
    **/
    Export.prototype.appSessionsByTime = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AppSessionsByTimeRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/sessions/data_series";
    ...
    **/
    Export.prototype.campaignAnalytics = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.campaignDetails = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.campaignList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.canvasDataAnalyticsSummary = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.canvasDataSeriesAnalytics = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.canvasDetails = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.canvasList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Export.prototype.customEventsAnalytics = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * | 5XX              | Internal server error, you should retry with exponential backoff |
    **/
    Export.prototype.customEventsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.dailyActiveUsersByDate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.dailyNewUsersByDate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.kpIsForDailyAppUninstallsByDate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.monthlyActiveUsersForLast30Days = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.newsFeedCardAnalytics = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.newsFeedCardsDetails = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.newsFeedCardsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.segmentAnalytics = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.segmentDetails = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.segmentList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    Export.prototype.sendAnalytics = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
