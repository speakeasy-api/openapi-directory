...
export declare class Billing {
     ...
     *
     */
    accountPlanAddonCancel(req: operations.AccountPlanAddonCancelRequest, security: operations.AccountPlanAddonCancelSecurity, config?: AxiosRequestConfig): Promise<operations.AccountPlanAddonCancelResponse>;
    /**
     ...
     */
    getPlanUsage(req: operations.GetPlanUsageRequest, security: operations.GetPlanUsageSecurity, config?: AxiosRequestConfig): Promise<operations.GetPlanUsageResponse>;
}
