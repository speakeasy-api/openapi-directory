...
from ..shared import updatemerchantwebhookrequest as shared_updatemerchantwebhookrequest
from ..shared import webhook as shared_webhook
from typing import Optional


@dataclasses.dataclass
class PatchMerchantsMerchantIDWebhooksWebhookIDSecurity:
...
@dataclasses.dataclass
class PatchMerchantsMerchantIDWebhooksWebhookIDRequest:
    ...
    update_merchant_webhook_request: Optional[shared_updatemerchantwebhookrequest.UpdateMerchantWebhookRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    

@dataclasses.dataclass
class PatchMerchantsMerchantIDWebhooksWebhookIDResponse:
