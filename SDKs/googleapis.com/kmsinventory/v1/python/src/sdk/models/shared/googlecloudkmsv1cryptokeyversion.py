...
import dataclasses
from ..shared import googlecloudkmsv1externalprotectionleveloptions as shared_googlecloudkmsv1externalprotectionleveloptions
from ..shared import googlecloudkmsv1keyoperationattestation as shared_googlecloudkmsv1keyoperationattestation
from dataclasses_json import Undefined, dataclass_json
from enum import Enum
from sdk import utils
from typing import Optional

class GoogleCloudKmsV1CryptoKeyVersionAlgorithmEnum(str, Enum):
...
class GoogleCloudKmsV1CryptoKeyVersionProtectionLevelEnum(str, Enum):
...
class GoogleCloudKmsV1CryptoKeyVersionStateEnum(str, Enum):
...
class GoogleCloudKmsV1CryptoKeyVersion:
    ...
    algorithm: Optional[GoogleCloudKmsV1CryptoKeyVersionAlgorithmEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('algorithm'), 'exclude': lambda f: f is None }})
    r"""Output only. The CryptoKeyVersionAlgorithm that this CryptoKeyVersion supports."""  
    attestation: Optional[shared_googlecloudkmsv1keyoperationattestation.GoogleCloudKmsV1KeyOperationAttestation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attestation'), 'exclude': lambda f: f is None }})
    ...
    external_protection_level_options: Optional[shared_googlecloudkmsv1externalprotectionleveloptions.GoogleCloudKmsV1ExternalProtectionLevelOptions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('externalProtectionLevelOptions'), 'exclude': lambda f: f is None }})
    ...
    protection_level: Optional[GoogleCloudKmsV1CryptoKeyVersionProtectionLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protectionLevel'), 'exclude': lambda f: f is None }})
    r"""Output only. The ProtectionLevel describing how crypto operations are performed with this CryptoKeyVersion."""  
    ...
    state: Optional[GoogleCloudKmsV1CryptoKeyVersionStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
    r"""The current state of the CryptoKeyVersion."""  
