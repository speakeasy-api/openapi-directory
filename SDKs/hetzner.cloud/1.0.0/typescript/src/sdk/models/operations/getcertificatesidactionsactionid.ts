...
export class GetCertificatesIdActionsActionIdActionResponseAction extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => GetCertificatesIdActionsActionIdActionResponseActionError)
  ...
  @Type(() => GetCertificatesIdActionsActionIdActionResponseActionResources)
...
export class GetCertificatesIdActionsActionIdActionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "action" })
  @Type(() => GetCertificatesIdActionsActionIdActionResponseAction)
