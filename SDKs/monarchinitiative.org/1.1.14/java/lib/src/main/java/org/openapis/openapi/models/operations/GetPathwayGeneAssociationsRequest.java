...
public class GetPathwayGeneAssociationsRequest {
    ...
    public GetPathwayGeneAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPathwayGeneAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPathwayGeneAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPathwayGeneAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPathwayGeneAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPathwayGeneAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPathwayGeneAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPathwayGeneAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPathwayGeneAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPathwayGeneAssociationsRequest withRelation(String relation) {
    ...
    public GetPathwayGeneAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPathwayGeneAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPathwayGeneAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPathwayGeneAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPathwayGeneAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPathwayGeneAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPathwayGeneAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPathwayGeneAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
