...
func (e ScanXAmzTargetEnum) ToPointer() *ScanXAmzTargetEnum {
	return &e
}
...
func (e *ScanXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "DynamoDB_20111205.Scan":
		*e = ScanXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ScanXAmzTargetEnum: %v", v)
	}
}
