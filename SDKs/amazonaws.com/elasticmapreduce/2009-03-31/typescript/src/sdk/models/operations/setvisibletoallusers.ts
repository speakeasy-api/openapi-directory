...
export enum SetVisibleToAllUsersXAmzTargetEnum {
  ElasticMapReduceSetVisibleToAllUsers = "ElasticMapReduce.SetVisibleToAllUsers",
}

export class SetVisibleToAllUsersRequest extends SpeakeasyBase {
...
export class SetVisibleToAllUsersResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
