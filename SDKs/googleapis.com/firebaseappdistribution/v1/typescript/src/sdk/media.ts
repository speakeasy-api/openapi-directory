...
export class Media {
  ...
  firebaseappdistributionMediaUpload(
  ...
  ): Promise<operations.FirebaseappdistributionMediaUploadResponse> {
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.FirebaseappdistributionMediaUploadSecurity(
        security
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.FirebaseappdistributionMediaUploadResponse =
        new operations.FirebaseappdistributionMediaUploadResponse({
