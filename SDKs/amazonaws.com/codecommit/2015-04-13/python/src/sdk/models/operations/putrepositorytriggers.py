...
class PutRepositoryTriggersRequest:
    headers: PutRepositoryTriggersHeaders = dataclasses.field()
    request: shared_putrepositorytriggersinput.PutRepositoryTriggersInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
