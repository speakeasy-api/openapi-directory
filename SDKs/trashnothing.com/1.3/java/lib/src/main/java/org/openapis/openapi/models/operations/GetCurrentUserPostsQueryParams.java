...
public class GetCurrentUserPostsQueryParams {
    /**
    ...
    public GetCurrentUserPostsQueryParams withDateMax(OffsetDateTime dateMax) {
    ...
    public GetCurrentUserPostsQueryParams withDateMin(OffsetDateTime dateMin) {
    ...
    public GetCurrentUserPostsQueryParams withDevicePixelRatio(Double devicePixelRatio) {
    ...
    public GetCurrentUserPostsQueryParams withGroupIds(String groupIds) {
    ...
    public GetCurrentUserPostsQueryParams withIncludeReposts(Long includeReposts) {
    ...
    public GetCurrentUserPostsQueryParams withLatitude(Double latitude) {
    ...
    public GetCurrentUserPostsQueryParams withLongitude(Double longitude) {
    ...
    public GetCurrentUserPostsQueryParams withOutcomes(String outcomes) {
    ...
    public Long page;
    public GetCurrentUserPostsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetCurrentUserPostsQueryParams withPerPage(Long perPage) {
    ...
    public GetCurrentUserPostsQueryParams withRadius(Double radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetCurrentUserPostsQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetCurrentUserPostsQueryParams withSources(String sources) {
    ...
    public String types;
    public GetCurrentUserPostsQueryParams withTypes(String types) {
        this.types = types;
        return this;
    }
    ...
    public GetCurrentUserPostsQueryParams withUserState(String userState) {
