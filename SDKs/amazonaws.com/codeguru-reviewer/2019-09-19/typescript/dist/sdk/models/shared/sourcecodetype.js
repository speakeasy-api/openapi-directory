...
var SourceCodeType = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "BranchDiff" }),
        (0, class_transformer_1.Type)(function () { return branchdiffsourcecodetype_1.BranchDiffSourceCodeType; }),
        __metadata("design:type", branchdiffsourcecodetype_1.BranchDiffSourceCodeType)
    ], SourceCodeType.prototype, "branchDiff", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CommitDiff" }),
        (0, class_transformer_1.Type)(function () { return commitdiffsourcecodetype_1.CommitDiffSourceCodeType; }),
        __metadata("design:type", commitdiffsourcecodetype_1.CommitDiffSourceCodeType)
    ], SourceCodeType.prototype, "commitDiff", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RepositoryHead" }),
        (0, class_transformer_1.Type)(function () { return repositoryheadsourcecodetype_1.RepositoryHeadSourceCodeType; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "S3BucketRepository" }),
        (0, class_transformer_1.Type)(function () { return s3bucketrepository_1.S3BucketRepository; }),
