...
class Customers 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\CloudidentityCustomersUserinvitationsCancelResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}:cancel', \OpenAPI\OpenAPI\Models\Operations\CloudidentityCustomersUserinvitationsCancelRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}:isInvitableUser', \OpenAPI\OpenAPI\Models\Operations\CloudidentityCustomersUserinvitationsIsInvitableUserRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}/userinvitations', \OpenAPI\OpenAPI\Models\Operations\CloudidentityCustomersUserinvitationsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}:send', \OpenAPI\OpenAPI\Models\Operations\CloudidentityCustomersUserinvitationsSendRequest::class, $request);
