...
from ..shared import filetagresponsevo as shared_filetagresponsevo
...
class GetFileTagsResponse:
    ...
    file_tag_response_vo: Optional[shared_filetagresponsevo.FileTagResponseVO] = dataclasses.field(default=None)
