...
export class ContentProductdeliverytimeDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentProductdeliverytimeDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentProductdeliverytimeDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
