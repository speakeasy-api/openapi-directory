...
class NullableIssueStateReasonEnum(str, Enum):
    r"""The reason for the current state"""
    COMPLETED = 'completed'
    REOPENED = 'reopened'
...
class NullableIssue:
    ...
    state_reason: Optional[NullableIssueStateReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state_reason'), 'exclude': lambda f: f is None }})
    r"""The reason for the current state"""  
