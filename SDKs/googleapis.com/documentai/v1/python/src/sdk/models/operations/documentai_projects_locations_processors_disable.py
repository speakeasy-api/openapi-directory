...
class DocumentaiProjectsLocationsProcessorsDisableSecurity:
...
@dataclasses.dataclass
class DocumentaiProjectsLocationsProcessorsDisableRequest:
    
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'name', 'style': 'simple', 'explode': False }})
    r"""Required. The processor resource name to be disabled."""  
...
@dataclasses.dataclass
class DocumentaiProjectsLocationsProcessorsDisableResponse:
