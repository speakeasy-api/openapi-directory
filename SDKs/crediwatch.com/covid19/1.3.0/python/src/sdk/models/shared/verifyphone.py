...
from ..shared import placecall as shared_placecall
...
class VerifyPhone:
    data: shared_placecall.PlaceCall = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
