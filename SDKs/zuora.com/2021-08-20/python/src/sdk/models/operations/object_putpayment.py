...
class ObjectPutPaymentPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectPutPaymentQueryParams:
...
class ObjectPutPaymentRequest:
    headers: ObjectPutPaymentHeaders = dataclasses.field()
    path_params: ObjectPutPaymentPathParams = dataclasses.field()
    query_params: ObjectPutPaymentQueryParams = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class ObjectPutPaymentResponse:
