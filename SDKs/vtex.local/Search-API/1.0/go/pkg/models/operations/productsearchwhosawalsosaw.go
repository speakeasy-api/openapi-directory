...
var ProductSearchWhoSawAlsoSawServerList = []string{
	"http://example.com/.{environment}.com.br",
}

type ProductSearchWhoSawAlsoSawPathParams struct {
	// Product unique identifier.
	ProductID int64 `pathParam:"style=simple,explode=false,name=productId"`
}

type ProductSearchWhoSawAlsoSawHeaders struct {
...
type ProductSearchWhoSawAlsoSawRequest struct {
	PathParams ProductSearchWhoSawAlsoSawPathParams
	Headers    ProductSearchWhoSawAlsoSawHeaders
	ServerURL  *string
}

type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsImages struct {
	// Image ID.
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsKitItems struct {
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsReferenceID struct {
	// Reference Code.
	Key string `json:"Key"`
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamples struct {
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion0 struct {
	// Delivery SLA per types.
	DeliverySLAPerTypes []interface{} `json:"DeliverySlaPerTypes"`
	// Region.
	Region string `json:"Region"`
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion struct {
	// Delivery SLA ID.
	Zero *ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion0 `json:"0,omitempty"`
}

type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferInstallments struct {
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallmentsSellerMerchantInstallments struct {
	// Count.
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallments struct {
	// Count.
	Count int64 `json:"count"`
	// Has interest rate.
	HasInterestRate bool `json:"hasInterestRate"`
	...
	SellerMerchantInstallments []ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallmentsSellerMerchantInstallments `json:"sellerMerchantInstallments"`
	// Total.
	Total int64 `json:"total"`
	// Value.
	Value int64 `json:"value"`
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptions struct {
	// Bin.
	Bin string `json:"bin"`
	// Installments.
	Installments []ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallments `json:"installments"`
	// Payment group name.
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsPaymentSystems struct {
	// Available payments.
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferPaymentOptions struct {
	// Available accounts.
	...
	// installment options.
	InstallmentOptions []ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptions `json:"installmentOptions"`
	// Payment systems.
	PaymentSystems []ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsPaymentSystems `json:"paymentSystems"`
	// Payments.
	Payments []interface{} `json:"payments"`
}

// ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOffer - AKA Commertial Condition.
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOffer struct {
	...
	DeliverySLASamples []ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamples `json:"DeliverySlaSamples"`
	// Delivery SLA samples per region.
	DeliverySLASamplesPerRegion ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion `json:"DeliverySlaSamplesPerRegion"`
	// Discount hightlight.
	...
	Installments []ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferInstallments `json:"Installments"`
	...
	// Payment options.
	PaymentOptions ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOfferPaymentOptions `json:"PaymentOptions"`
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellers struct {
	// URL to add the product to the cart.
	AddToCartLink string `json:"addToCartLink"`
	// AKA Commertial Condition.
	CommertialOffer ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellersCommertialOffer `json:"commertialOffer"`
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSONItems struct {
	// Videos.
	...
	Images []ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsImages `json:"images"`
	// If the SKU is part of a kit.
	IsKit bool `json:"isKit"`
	// SKU ID.
	ItemID string `json:"itemId"`
	// Array with information of SKUs components from a Kit.
	KitItems []ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsKitItems `json:"kitItems"`
	...
	// Reference code ID.
	ReferenceID []ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsReferenceID `json:"referenceId"`
	// Array of SKU sellers.
	Sellers []ProductSearchWhoSawAlsoSaw200ApplicationJSONItemsSellers `json:"sellers"`
...
type ProductSearchWhoSawAlsoSaw200ApplicationJSON struct {
	...
	Items []ProductSearchWhoSawAlsoSaw200ApplicationJSONItems `json:"items"`
	// Product URL.
...
type ProductSearchWhoSawAlsoSawResponse struct {
	ContentType string
	// OK
