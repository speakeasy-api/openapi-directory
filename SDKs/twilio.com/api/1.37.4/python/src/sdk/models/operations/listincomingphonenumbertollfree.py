...
class ListIncomingPhoneNumberTollFreeListIncomingPhoneNumberTollFreeResponse:
    ...
    incoming_phone_numbers: Optional[list[shared_api_v2010_account_incoming_phone_number_incoming_phone_number_toll_free.APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('incoming_phone_numbers') }})
...
class ListIncomingPhoneNumberTollFreeRequest:
    path_params: ListIncomingPhoneNumberTollFreePathParams = dataclasses.field()
    query_params: ListIncomingPhoneNumberTollFreeQueryParams = dataclasses.field()
    security: ListIncomingPhoneNumberTollFreeSecurity = dataclasses.field()
