...
exports.GetConsumerV1CustomersResponse = exports.GetConsumerV1CustomersRequest = void 0;
...
var GetConsumerV1CustomersRequest = /** @class */ (function (_super) {
    ...
    ], GetConsumerV1CustomersRequest.prototype, "deleted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=email" }),
        __metadata("design:type", String)
    ], GetConsumerV1CustomersRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=groupId",
        }),
        __metadata("design:type", String)
    ], GetConsumerV1CustomersRequest.prototype, "groupId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=lastname",
        }),
        __metadata("design:type", String)
    ], GetConsumerV1CustomersRequest.prototype, "lastname", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetConsumerV1CustomersRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locationId",
        }),
        __metadata("design:type", String)
    ], GetConsumerV1CustomersRequest.prototype, "locationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], GetConsumerV1CustomersRequest.prototype, "offset", void 0);
...
var GetConsumerV1CustomersResponse = /** @class */ (function (_super) {
    ...
    ], GetConsumerV1CustomersResponse.prototype, "rawResponse", void 0);
