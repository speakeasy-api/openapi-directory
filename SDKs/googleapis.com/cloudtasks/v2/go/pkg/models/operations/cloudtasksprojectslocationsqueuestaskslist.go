...
func (e *CloudtasksProjectsLocationsQueuesTasksListResponseViewEnum) UnmarshalJSON(data []byte) error {
	...
	case "BASIC":
		fallthrough
	case "FULL":
		*e = CloudtasksProjectsLocationsQueuesTasksListResponseViewEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CloudtasksProjectsLocationsQueuesTasksListResponseViewEnum: %s", s)
	}
}
