...
export class GetGenotypeVariantAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGenotypeVariantAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGenotypeVariantAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGenotypeVariantAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
