...
class GetDisassociateTransitGatewayRouteTableVersionEnum(str, Enum):
    TWO_THOUSAND_AND_SIXTEEN_11_15 = "2016-11-15"


@dataclasses.dataclass
class GetDisassociateTransitGatewayRouteTableQueryParams:
    action: GetDisassociateTransitGatewayRouteTableActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDisassociateTransitGatewayRouteTableVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    dry_run: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'DryRun', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetDisassociateTransitGatewayRouteTableHeaders:
...
class GetDisassociateTransitGatewayRouteTableRequest:
    headers: GetDisassociateTransitGatewayRouteTableHeaders = dataclasses.field()
    query_params: GetDisassociateTransitGatewayRouteTableQueryParams = dataclasses.field()
