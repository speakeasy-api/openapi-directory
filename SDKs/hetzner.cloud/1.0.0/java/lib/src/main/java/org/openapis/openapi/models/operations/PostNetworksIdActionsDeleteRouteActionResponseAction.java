...
public class PostNetworksIdActionsDeleteRouteActionResponseAction {
    ...
    public PostNetworksIdActionsDeleteRouteActionResponseAction(@JsonProperty("command") String command, @JsonProperty("error") PostNetworksIdActionsDeleteRouteActionResponseActionError error, @JsonProperty("finished") String finished, @JsonProperty("id") Long id, @JsonProperty("progress") Double progress, @JsonProperty("resources") PostNetworksIdActionsDeleteRouteActionResponseActionResources[] resources, @JsonProperty("started") String started, @JsonProperty("status") PostNetworksIdActionsDeleteRouteActionResponseActionStatusEnum status) {
        this.command = command;
        this.error = error;
        this.finished = finished;
        this.id = id;
