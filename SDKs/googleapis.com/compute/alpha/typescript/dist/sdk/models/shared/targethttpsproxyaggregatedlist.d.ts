...
import { TargetHttpsProxiesScopedList } from "./targethttpsproxiesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum TargetHttpsProxyAggregatedListWarningCodeEnum {
...
export declare class TargetHttpsProxyAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetHttpsProxyAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: TargetHttpsProxyAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: TargetHttpsProxyAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class TargetHttpsProxyAggregatedList extends SpeakeasyBase {
    /**
