...
type FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenRequest struct {
	...
	GoogleFirebaseAppcheckV1ExchangeRecaptchaEnterpriseTokenRequest *shared.GoogleFirebaseAppcheckV1ExchangeRecaptchaEnterpriseTokenRequest `request:"mediaType=application/json"`
	// OAuth access token.
