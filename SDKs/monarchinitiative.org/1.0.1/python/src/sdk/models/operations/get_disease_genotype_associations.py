...
class GetDiseaseGenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetDiseaseGenotypeAssociationsQueryParams:
...
@dataclasses.dataclass
class GetDiseaseGenotypeAssociationsRequest:
    path_params: GetDiseaseGenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetDiseaseGenotypeAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetDiseaseGenotypeAssociationsResponse:
