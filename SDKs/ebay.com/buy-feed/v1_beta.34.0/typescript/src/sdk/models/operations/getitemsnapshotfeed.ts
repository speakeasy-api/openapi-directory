...
export class GetItemSnapshotFeedSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetItemSnapshotFeedRequest extends SpeakeasyBase {
  /**
...
export class GetItemSnapshotFeedResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
