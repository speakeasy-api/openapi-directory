...
class DisableSagemakerServicecatalogPortfolioRequest:
    ...
    x_amz_target: DisableSagemakerServicecatalogPortfolioXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})  
...
class DisableSagemakerServicecatalogPortfolioResponse:
    ...
    disable_sagemaker_servicecatalog_portfolio_output: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
