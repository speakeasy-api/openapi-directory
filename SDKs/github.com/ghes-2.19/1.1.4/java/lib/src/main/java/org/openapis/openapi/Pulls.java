...
public class Pulls {
    ...
    public org.openapis.openapi.models.operations.PullsCreateReviewCommentAlternativeResponse pullsCreateReviewCommentAlternative(org.openapis.openapi.models.operations.PullsCreateReviewCommentAlternativeRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.PullsCreateReviewCommentAlternativePathParams.class, baseUrl, "/repos/{owner}/{repo}/pulls/{pull_number}/comments", request.pathParams, null);
    ...
    public org.openapis.openapi.models.operations.PullsListRequestedReviewersResponse pullsListRequestedReviewers(org.openapis.openapi.models.operations.PullsListRequestedReviewersRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.PullsListRequestedReviewersQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
