...
class ListServiceInstancesRequest:
    ...
    list_service_instances_input: shared_listserviceinstancesinput.ListServiceInstancesInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
