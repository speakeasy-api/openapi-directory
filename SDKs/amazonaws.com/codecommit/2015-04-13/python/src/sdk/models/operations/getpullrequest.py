...
from ..shared import getpullrequestinput as shared_getpullrequestinput
from ..shared import getpullrequestoutput as shared_getpullrequestoutput
...
class GetPullRequestHeaders:
    x_amz_target: GetPullRequestXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetPullRequestRequest:
    headers: GetPullRequestHeaders = dataclasses.field()
    request: shared_getpullrequestinput.GetPullRequestInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetPullRequestResponse:
    ...
    get_pull_request_output: Optional[shared_getpullrequestoutput.GetPullRequestOutput] = dataclasses.field(default=None)
