 ...
 */
export enum ResourcePolicyListWarningCodeEnum {
...
export class ResourcePolicyListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ResourcePolicyListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: ResourcePolicyListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class ResourcePolicyList extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "etag" })
  etag?: string;
