...
func New(opts ...SDKOption) *SDK {
	...
	sdk.LinuxHostings = newLinuxHostings(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.MySQLDatabases = newMySQLDatabases(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.ProvisioningJobs = newProvisioningJobs(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.SSLCertificateRequests = newSSLCertificateRequests(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.SSLCertificates = newSSLCertificates(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.Servicepacks = newServicepacks(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.WindowsHostings = newWindowsHostings(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
