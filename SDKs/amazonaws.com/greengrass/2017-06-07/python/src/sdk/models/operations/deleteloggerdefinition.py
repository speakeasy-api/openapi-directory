...
class DeleteLoggerDefinitionRequest:
    headers: DeleteLoggerDefinitionHeaders = dataclasses.field()
    path_params: DeleteLoggerDefinitionPathParams = dataclasses.field()
...
class DeleteLoggerDefinitionResponse:
    ...
    delete_logger_definition_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
