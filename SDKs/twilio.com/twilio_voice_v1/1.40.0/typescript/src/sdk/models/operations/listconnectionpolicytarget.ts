...
export class ListConnectionPolicyTargetListConnectionPolicyTargetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListConnectionPolicyTargetListConnectionPolicyTargetResponseMeta)
  meta?: ListConnectionPolicyTargetListConnectionPolicyTargetResponseMeta;

  @SpeakeasyMetadata({
    elemType: shared.VoiceV1ConnectionPolicyConnectionPolicyTarget,
  })
  @Expose({ name: "targets" })
  @Type(() => shared.VoiceV1ConnectionPolicyConnectionPolicyTarget)
