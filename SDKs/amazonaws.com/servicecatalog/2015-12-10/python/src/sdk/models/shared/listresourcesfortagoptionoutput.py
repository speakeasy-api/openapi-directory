...
class ListResourcesForTagOptionOutput:
    ...
    resource_details: Optional[list[shared_resourcedetail.ResourceDetail]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ResourceDetails'), 'exclude': lambda f: f is None }})  
