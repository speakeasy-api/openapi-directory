...
class DeleteGroupRequest:
    ...
    request: DeleteGroupRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteGroupResponse:
    ...
    delete_group_result: Optional[dict[str, Any]] = dataclasses.field(default=None)
