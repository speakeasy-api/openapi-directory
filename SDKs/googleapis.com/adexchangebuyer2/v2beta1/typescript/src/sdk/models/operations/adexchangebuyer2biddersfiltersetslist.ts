...
export class Adexchangebuyer2BiddersFilterSetsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class Adexchangebuyer2BiddersFilterSetsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "pathParam, style=simple;explode=false;name=ownerName",
  })
  ownerName: string;
...
export class Adexchangebuyer2BiddersFilterSetsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
