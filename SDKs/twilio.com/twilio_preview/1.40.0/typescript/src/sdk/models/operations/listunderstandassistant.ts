...
export class ListUnderstandAssistantListUnderstandAssistantResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.PreviewUnderstandAssistant })
  @Expose({ name: "assistants" })
  @Type(() => shared.PreviewUnderstandAssistant)
  assistants?: shared.PreviewUnderstandAssistant[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListUnderstandAssistantListUnderstandAssistantResponseMeta)
