...
from ..shared import proxygetproduct as shared_proxygetproduct
...
class ObjectGETProductResponse:
    ...
    proxy_get_product: Optional[shared_proxygetproduct.ProxyGetProduct] = dataclasses.field(default=None)  
