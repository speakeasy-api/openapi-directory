...
class ListDataSessionRequest:
    ...
    r"""The SID of the [Sim resource](https://www.twilio.com/docs/wireless/api/sim-resource) with the Data Sessions to read."""  
...
class ListDataSessionListDataSessionResponse:
    ...
    data_sessions: Optional[list[shared_wireless_v1_sim_data_session.WirelessV1SimDataSession]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data_sessions'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListDataSessionListDataSessionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
