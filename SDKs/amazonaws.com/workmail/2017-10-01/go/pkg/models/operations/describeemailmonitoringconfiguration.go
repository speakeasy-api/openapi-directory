...
type DescribeEmailMonitoringConfigurationHeaders struct {
...
type DescribeEmailMonitoringConfigurationRequest struct {
	Headers DescribeEmailMonitoringConfigurationHeaders
	Request shared.DescribeEmailMonitoringConfigurationRequest `request:"mediaType=application/json"`
}
