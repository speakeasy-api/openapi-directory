...
export enum DescribeMapRunXAmzTargetEnum {
  AWSStepFunctionsDescribeMapRun = "AWSStepFunctions.DescribeMapRun",
}

export class DescribeMapRunRequest extends SpeakeasyBase {
...
export class DescribeMapRunResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
