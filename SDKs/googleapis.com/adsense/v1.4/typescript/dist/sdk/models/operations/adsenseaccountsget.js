...
exports.AdsenseAccountsGetResponse = exports.AdsenseAccountsGetRequest = exports.AdsenseAccountsGetSecurity = exports.AdsenseAccountsGetSecurityOption2 = exports.AdsenseAccountsGetSecurityOption1 = void 0;
...
exports.AdsenseAccountsGetSecurityOption1 = AdsenseAccountsGetSecurityOption1;
...
exports.AdsenseAccountsGetSecurityOption2 = AdsenseAccountsGetSecurityOption2;
...
exports.AdsenseAccountsGetSecurity = AdsenseAccountsGetSecurity;
var AdsenseAccountsGetRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AdsenseAccountsGetRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdsenseAccountsGetRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdsenseAccountsGetRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdsenseAccountsGetRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdsenseAccountsGetRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdsenseAccountsGetRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdsenseAccountsGetRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=tree" }),
        __metadata("design:type", Boolean)
    ], AdsenseAccountsGetRequest.prototype, "tree", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdsenseAccountsGetRequest.prototype, "userIp", void 0);
    return AdsenseAccountsGetRequest;
}(utils_1.SpeakeasyBase));
exports.AdsenseAccountsGetRequest = AdsenseAccountsGetRequest;
var AdsenseAccountsGetResponse = /** @class */ (function (_super) {
    ...
    ], AdsenseAccountsGetResponse.prototype, "rawResponse", void 0);
    return AdsenseAccountsGetResponse;
}(utils_1.SpeakeasyBase));
exports.AdsenseAccountsGetResponse = AdsenseAccountsGetResponse;
