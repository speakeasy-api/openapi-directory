...
class AnalyzeSentimentRequest:
    ...
    encoding_type: Optional[AnalyzeSentimentRequestEncodingTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('encodingType') }})
