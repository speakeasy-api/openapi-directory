...
class ConfigureChannelCatalogCategoryRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\ConfigureCategoryRequest $configureCategoryRequest;
    
	public function __construct()
	{
		$this->channelCatalogId = "";
		$this->configureCategoryRequest = new \OpenAPI\OpenAPI\Models\Shared\ConfigureCategoryRequest();
	}
}
