    ...
    public static void main(String[] args) {
        try {
            ...
            SkmstRequestBody req = new SkmstRequestBody(SkmstRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SkmstRequestBodyCertificateParameters("DEDH P,GI S,GI W,MESC,LCOM EW,LCOM Tac,CHME Q,AA/APP,SSR/NAM,Direct Entry El,ITSC S", "12345-T", "Valsura,Shivaji,Dronacharya,SignalSchool,NIAT");;
