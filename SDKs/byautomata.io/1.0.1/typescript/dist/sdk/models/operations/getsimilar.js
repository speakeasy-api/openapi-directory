...
exports.GetSimilarResponse = exports.GetSimilarRequest = exports.GetSimilar200ApplicationJson = exports.GetSimilarQueryParams = void 0;
...
var GetSimilar200ApplicationJson = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=companies", elemType: shared.SimilarCompany }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=input_company" }),
...
exports.GetSimilar200ApplicationJson = GetSimilar200ApplicationJson;
