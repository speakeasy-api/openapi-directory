...
exports.DeleteHolidaySchemeTagResponse = exports.DeleteHolidaySchemeTagRequest = void 0;
...
var DeleteHolidaySchemeTagRequest = /** @class */ (function (_super) {
    ...
    ], DeleteHolidaySchemeTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeleteHolidaySchemeTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeleteHolidaySchemeTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=HolidaySchemeId",
        }),
        __metadata("design:type", String)
    ], DeleteHolidaySchemeTagRequest.prototype, "holidaySchemeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], DeleteHolidaySchemeTagRequest.prototype, "tagId", void 0);
    return DeleteHolidaySchemeTagRequest;
}(utils_1.SpeakeasyBase));
exports.DeleteHolidaySchemeTagRequest = DeleteHolidaySchemeTagRequest;
var DeleteHolidaySchemeTagResponse = /** @class */ (function (_super) {
    ...
    ], DeleteHolidaySchemeTagResponse.prototype, "rawResponse", void 0);
    return DeleteHolidaySchemeTagResponse;
}(utils_1.SpeakeasyBase));
exports.DeleteHolidaySchemeTagResponse = DeleteHolidaySchemeTagResponse;
