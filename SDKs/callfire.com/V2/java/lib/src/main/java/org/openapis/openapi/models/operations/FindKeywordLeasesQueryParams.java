...
public class FindKeywordLeasesQueryParams {
    /**
     * Limit fields received in response. E.g. fields: id, name or fields items (id, name), see more at [partial response](https://developers.callfire.com/docs.html#partial-response) page.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=fields")
    public String fields;
    public FindKeywordLeasesQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public FindKeywordLeasesQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public FindKeywordLeasesQueryParams withLabelName(String labelName) {
    ...
    public FindKeywordLeasesQueryParams withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public FindKeywordLeasesQueryParams withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
