...
class ShareProfileRequest
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\ShareProfileRequestPatient')]
	...
	{
		$this->patient = new \OpenAPI\OpenAPI\Models\Shared\ShareProfileRequestPatient();
		$this->requestId = "";
