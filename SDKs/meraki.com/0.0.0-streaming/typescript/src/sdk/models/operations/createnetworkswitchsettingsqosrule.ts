 ...
 */
export enum CreateNetworkSwitchSettingsQosRuleRequestBodyProtocolEnum {
  Any = "ANY",
  Tcp = "TCP",
  Udp = "UDP",
}

export class CreateNetworkSwitchSettingsQosRuleRequestBody extends SpeakeasyBase {
  /**
...
export class CreateNetworkSwitchSettingsQosRuleRequest extends SpeakeasyBase {
...
export class CreateNetworkSwitchSettingsQosRuleResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  createNetworkSwitchSettingsQosRule201ApplicationJSONObject?: Record<
    string,
    any
  >;
}
