...
var Certificates = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=AwsHardwareCertificate" }),
        __metadata("design:type", String)
    ], Certificates.prototype, "awsHardwareCertificate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ClusterCertificate" }),
        __metadata("design:type", String)
    ], Certificates.prototype, "clusterCertificate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ClusterCsr" }),
        __metadata("design:type", String)
    ], Certificates.prototype, "clusterCsr", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=HsmCertificate" }),
        __metadata("design:type", String)
    ], Certificates.prototype, "hsmCertificate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ManufacturerHardwareCertificate" }),
        __metadata("design:type", String)
