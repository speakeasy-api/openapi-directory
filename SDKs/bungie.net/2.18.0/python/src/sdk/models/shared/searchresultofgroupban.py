...
import dataclasses
from ..shared import groupsv2_groupban as shared_groupsv2_groupban
...
class SearchResultOfGroupBan:
    ...
    results: Optional[list[shared_groupsv2_groupban.GroupsV2GroupBan]] = dataclasses.field(default=None)  
