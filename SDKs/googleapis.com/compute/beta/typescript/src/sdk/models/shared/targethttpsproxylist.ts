 ...
 */
export enum TargetHttpsProxyListWarningCodeEnum {
...
export class TargetHttpsProxyListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetHttpsProxyListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetHttpsProxyListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class TargetHttpsProxyList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetHttpsProxy })
  @Expose({ name: "items" })
