...
func (e EsimProfileEnumStatusEnum) ToPointer() *EsimProfileEnumStatusEnum {
	return &e
}
...
func (e *EsimProfileEnumStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "installed":
		fallthrough
	case "failed":
		*e = EsimProfileEnumStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EsimProfileEnumStatusEnum: %v", v)
	}
}
