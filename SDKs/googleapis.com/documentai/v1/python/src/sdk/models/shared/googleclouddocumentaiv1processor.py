...
class GoogleCloudDocumentaiV1ProcessorStateEnum(str, Enum):
...
class GoogleCloudDocumentaiV1Processor:
    ...
    state: Optional[GoogleCloudDocumentaiV1ProcessorStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
    r"""Output only. The state of the processor."""  
