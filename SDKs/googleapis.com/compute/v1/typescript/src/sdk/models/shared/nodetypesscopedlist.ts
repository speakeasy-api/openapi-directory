 ...
 */
export enum NodeTypesScopedListWarningCodeEnum {
...
export class NodeTypesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NodeTypesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: NodeTypesScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: NodeTypesScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => NodeTypesScopedListWarningData)
  data?: NodeTypesScopedListWarningData[];
...
export class NodeTypesScopedList extends SpeakeasyBase {
  /**
   * [Output Only] A list of node types contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: NodeType })
  @Expose({ name: "nodeTypes" })
  @Type(() => NodeType)
  nodeTypes?: NodeType[];
