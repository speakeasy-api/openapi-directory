...
class CreateStreamingImageRequest:
    headers: CreateStreamingImageHeaders = dataclasses.field()
    path_params: CreateStreamingImagePathParams = dataclasses.field()
    request: CreateStreamingImageRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
