...
class Parcels:
    ...
    def get_parcels_pids_site_id_output_format_(self, request: operations.GetParcelsPidsSiteIDOutputFormatRequest) -> operations.GetParcelsPidsSiteIDOutputFormatResponse:
        ...
        url = utils.generate_url(operations.GetParcelsPidsSiteIDOutputFormatRequest, base_url, '/parcels/pids/{siteID}.{outputFormat}', request)
        ...
        res = operations.GetParcelsPidsSiteIDOutputFormatResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
