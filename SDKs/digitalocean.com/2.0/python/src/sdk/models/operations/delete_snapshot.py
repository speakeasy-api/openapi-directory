...
class DeleteSnapshotRequest:
    path_params: DeleteSnapshotPathParams = dataclasses.field()
...
class DeleteSnapshotResponse:
    ...
    delete_snapshot_401_application_json_object: Optional[DeleteSnapshot401ApplicationJSON] = dataclasses.field(default=None)
