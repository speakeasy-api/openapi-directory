...
class DestinyComponentsInventoryDestinyCurrenciesComponent:
    ...
    item_quantities: Optional[dict[str, int]] = dataclasses.field(default=None)
    r"""A dictionary - keyed by the item's hash identifier (DestinyInventoryItemDefinition), and whose value is the amount of that item you have across all available inventory buckets for purchasing.
