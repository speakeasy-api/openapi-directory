...
class OrderBillingAddress:
    ...
    r"""Address of the Order's Billing Address"""  
    city: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('city'), 'exclude': lambda f: f is None }})
    r"""City of the Order's Billing Address"""  
    country: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('country'), 'exclude': lambda f: f is None }})
    r"""Country code of the Order's Billing Address (ISO 3166-1 alpha-2)"""  
    ...
    r"""Country name of the Order's Billing Address"""  
    ...
    r"""Municipality of the Order's Billing Address"""  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})
    r"""Name of the Order's Billing Address"""  
    ...
    r"""Postal code of the Order's Billing Address"""  
    region: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('region'), 'exclude': lambda f: f is None }})
    r"""Region code of the Order's Billing Address (Use the FIPS standard - http://www.geonames.org/countries/)"""  
    ...
    r"""Street number of the Order's Billing Address"""  
    ...
    r"""Surname of the Order's Billing Address"""  
