...
export class NetworksecurityProjectsLocationsTlsInspectionPoliciesCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsTlsInspectionPoliciesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=tlsInspectionPolicyId",
  })
...
export class NetworksecurityProjectsLocationsTlsInspectionPoliciesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
