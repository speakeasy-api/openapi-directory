...
type GETDescribeTypeRegistrationQueryParams struct {
...
type GETDescribeTypeRegistrationHeaders struct {
...
type GETDescribeTypeRegistrationRequest struct {
	QueryParams GETDescribeTypeRegistrationQueryParams
	Headers     GETDescribeTypeRegistrationHeaders
}
