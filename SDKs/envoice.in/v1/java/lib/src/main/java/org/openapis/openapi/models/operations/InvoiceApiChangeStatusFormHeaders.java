...
public class InvoiceApiChangeStatusFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiChangeStatusFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiChangeStatusFormHeaders withXAuthSecret(String xAuthSecret) {
