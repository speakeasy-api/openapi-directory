...
exports.PoolRemoveNodesResponse = exports.PoolRemoveNodesRequest = void 0;
...
var PoolRemoveNodesRequest = /** @class */ (function (_super) {
    ...
    ], PoolRemoveNodesRequest.prototype, "ifMatch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=If-Modified-Since",
        }),
        __metadata("design:type", String)
    ], PoolRemoveNodesRequest.prototype, "ifModifiedSince", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=If-None-Match",
        }),
        __metadata("design:type", String)
    ], PoolRemoveNodesRequest.prototype, "ifNoneMatch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=If-Unmodified-Since",
        }),
        __metadata("design:type", String)
    ], PoolRemoveNodesRequest.prototype, "ifUnmodifiedSince", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=application/json" }),
        __metadata("design:type", shared.NodeRemoveParameter)
    ], PoolRemoveNodesRequest.prototype, "nodeRemoveParameter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=api-version",
        }),
        __metadata("design:type", String)
    ], PoolRemoveNodesRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], PoolRemoveNodesRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], PoolRemoveNodesRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=poolId",
        }),
        __metadata("design:type", String)
    ], PoolRemoveNodesRequest.prototype, "poolId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], PoolRemoveNodesRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], PoolRemoveNodesRequest.prototype, "timeout", void 0);
...
var PoolRemoveNodesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], PoolRemoveNodesResponse.prototype, "rawResponse", void 0);
