...
export class SecuritycenterProjectsWebSecurityScannerSettingsCalculateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SecuritycenterProjectsWebSecurityScannerSettingsCalculateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SecuritycenterProjectsWebSecurityScannerSettingsCalculateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
