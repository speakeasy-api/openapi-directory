...
class PostCreateLbCookieStickinessPolicyQueryParams:
    action: PostCreateLbCookieStickinessPolicyActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCreateLbCookieStickinessPolicyVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCreateLbCookieStickinessPolicyRequest:
    headers: PostCreateLbCookieStickinessPolicyHeaders = dataclasses.field()
    query_params: PostCreateLbCookieStickinessPolicyQueryParams = dataclasses.field()
