...
class ReleasesGetLatestByHashSecurity:
...
class ReleasesGetLatestByHashRequest:
    ...
    r"""The hash of the release or 'latest' to get the latest release from all the distribution groups assigned to the current user."""  
...
class ReleasesGetLatestByHash404ApplicationJSONCodeEnum(str, Enum):
...
class ReleasesGetLatestByHash404ApplicationJSON:
    ...
    code: ReleasesGetLatestByHash404ApplicationJSONCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
    message: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message') }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ReleasesGetLatestByHash200ApplicationJSONBuild:
...
class ReleasesGetLatestByHash200ApplicationJSONDestinationTypeEnum(str, Enum):
...
class ReleasesGetLatestByHash200ApplicationJSONDestinationsDestinationTypeEnum(str, Enum):
    r"""Destination can be either store or group."""
    GROUP = 'group'
    STORE = 'store'
    TESTER = 'tester'

class ReleasesGetLatestByHash200ApplicationJSONDestinationsTypeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ReleasesGetLatestByHash200ApplicationJSONDestinations:
    ...
    destination_type: Optional[ReleasesGetLatestByHash200ApplicationJSONDestinationsDestinationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destination_type'), 'exclude': lambda f: f is None }})
    r"""Destination can be either store or group."""  
    ...
    type: Optional[ReleasesGetLatestByHash200ApplicationJSONDestinationsTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""type of the distribution store currently stores type can be intune, googleplay or windows."""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ReleasesGetLatestByHash200ApplicationJSONDistributionGroups:
...
class ReleasesGetLatestByHash200ApplicationJSONDistributionStoresTypeEnum(str, Enum):
    r"""type of the distribution store currently stores type can be intune, googleplay or windows."""
    INTUNE = 'intune'
    GOOGLEPLAY = 'googleplay'
    APPLE = 'apple'
...
class ReleasesGetLatestByHash200ApplicationJSONDistributionStores:
    ...
    publishing_status: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('publishing_status'), 'exclude': lambda f: f is None }})
    r"""publishing status of the release in the store."""  
    type: Optional[ReleasesGetLatestByHash200ApplicationJSONDistributionStoresTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""type of the distribution store currently stores type can be intune, googleplay or windows."""  
    
class ReleasesGetLatestByHash200ApplicationJSONOriginEnum(str, Enum):
    r"""The release's origin"""
    HOCKEYAPP = 'hockeyapp'
    APPCENTER = 'appcenter'

class ReleasesGetLatestByHash200ApplicationJSONProvisioningProfileTypeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ReleasesGetLatestByHash200ApplicationJSON:
    ...
    r"""The app's OS."""  
    build: Optional[ReleasesGetLatestByHash200ApplicationJSONBuild] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('build'), 'exclude': lambda f: f is None }})
    r"""Contains metadata about the build that produced the release being uploaded"""  
    ...
    destination_type: Optional[ReleasesGetLatestByHash200ApplicationJSONDestinationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destination_type'), 'exclude': lambda f: f is None }})
    r"""OBSOLETE. Will be removed in next version. The destination type.<br>
    <b>group</b>: The release distributed to internal groups and distribution_groups details will be returned.<br>
    <b>store</b>: The release distributed to external stores and distribution_stores details will be returned.<br>
    <b>tester</b>: The release distributed testers details will be returned.<br>
    """  
    destinations: Optional[list[ReleasesGetLatestByHash200ApplicationJSONDestinations]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destinations'), 'exclude': lambda f: f is None }})
    ...
    distribution_groups: Optional[list[ReleasesGetLatestByHash200ApplicationJSONDistributionGroups]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('distribution_groups'), 'exclude': lambda f: f is None }})
    r"""OBSOLETE. Will be removed in next version. A list of distribution groups that are associated with this release."""  
    distribution_stores: Optional[list[ReleasesGetLatestByHash200ApplicationJSONDistributionStores]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('distribution_stores'), 'exclude': lambda f: f is None }})
    ...
    origin: Optional[ReleasesGetLatestByHash200ApplicationJSONOriginEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin'), 'exclude': lambda f: f is None }})
    r"""The release's origin"""  
    ...
    provisioning_profile_type: Optional[ReleasesGetLatestByHash200ApplicationJSONProvisioningProfileTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('provisioning_profile_type'), 'exclude': lambda f: f is None }})
    r"""The type of the provisioning profile for the requested app version."""  
...
class ReleasesGetLatestByHashResponse:
    ...
    releases_get_latest_by_hash_200_application_json_object: Optional[ReleasesGetLatestByHash200ApplicationJSON] = dataclasses.field(default=None)
    r"""If called with a specific `release_hash` return the app's 'display_name'' and 'buildIdentifier'. If 'release_hash' is 'latest' return the full release details of the latest release that was distributed to the current user (from all the distribution groups)."""  
    releases_get_latest_by_hash_404_application_json_object: Optional[ReleasesGetLatestByHash404ApplicationJSON] = dataclasses.field(default=None)
    r"""Error codes:
    - `not_found` - A release or an app can't be found.
    - `no_releases_for_user` - No releases available for that user (will only be returned when `release_hash` is `latest`)
    """  
