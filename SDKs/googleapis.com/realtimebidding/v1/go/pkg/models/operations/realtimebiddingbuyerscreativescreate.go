...
type RealtimebiddingBuyersCreativesCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RealtimebiddingBuyersCreativesCreatePathParams struct {
...
type RealtimebiddingBuyersCreativesCreateQueryParams struct {
	// V1 error format.
...
type RealtimebiddingBuyersCreativesCreateRequest struct {
...
type RealtimebiddingBuyersCreativesCreateResponse struct {
	ContentType string
	// Successful response
