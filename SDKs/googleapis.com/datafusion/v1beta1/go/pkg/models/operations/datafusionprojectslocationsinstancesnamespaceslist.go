...
func (e *DatafusionProjectsLocationsInstancesNamespacesListViewEnum) UnmarshalJSON(data []byte) error {
	...
	case "NAMESPACE_VIEW_FULL":
		*e = DatafusionProjectsLocationsInstancesNamespacesListViewEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for DatafusionProjectsLocationsInstancesNamespacesListViewEnum: %s", s)
	}
}
