...
from ..shared import incoming_phone_number_local_enum_address_requirement_enum as shared_incoming_phone_number_local_enum_address_requirement_enum
from ..shared import incoming_phone_number_local_enum_emergency_address_status_enum as shared_incoming_phone_number_local_enum_emergency_address_status_enum
...
class APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal:
    ...
    address_requirements: Optional[shared_incoming_phone_number_local_enum_address_requirement_enum.IncomingPhoneNumberLocalEnumAddressRequirementEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('address_requirements') }})
    ...
    capabilities: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalCapabilities] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('capabilities') }})
    ...
    emergency_address_status: Optional[shared_incoming_phone_number_local_enum_emergency_address_status_enum.IncomingPhoneNumberLocalEnumEmergencyAddressStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('emergency_address_status') }})
    emergency_status: Optional[shared_incoming_phone_number_local_enum_emergency_status_enum.IncomingPhoneNumberLocalEnumEmergencyStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('emergency_status') }})
    ...
    sms_fallback_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalSmsFallbackMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sms_fallback_method') }})
    ...
    sms_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalSmsMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sms_method') }})
    ...
    status_callback_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalStatusCallbackMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status_callback_method') }})
    ...
    voice_fallback_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalVoiceFallbackMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voice_fallback_method') }})
    ...
    voice_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalVoiceMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voice_method') }})
    voice_receive_mode: Optional[shared_incoming_phone_number_local_enum_voice_receive_mode_enum.IncomingPhoneNumberLocalEnumVoiceReceiveModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voice_receive_mode') }})
