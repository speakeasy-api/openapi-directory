...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/chompthis.com/1.0.0-oas3/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/chompthis.com/1.0.0-oas3/typescript
```
