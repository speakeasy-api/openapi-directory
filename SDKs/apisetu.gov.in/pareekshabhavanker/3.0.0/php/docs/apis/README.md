...
* [sslcr](#sslcr) - Class X School Leaving Certificate
...
use \OpenAPI\OpenAPI\Models\Operations\SslcrRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\SslcrRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\SslcrRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\SslcrSecurity;
...
try {
    ...
    $request->certificateParameters = new SslcrRequestBodyCertificateParameters();
    ...
    $request->certificateParameters->year = '2018,2019,2020';
    ...
    $request->format = SslcrRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new SslcrSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->sslcr($request, $requestSecurity);
