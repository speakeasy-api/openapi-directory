...
class ResourcePolicySnapshotSchedulePolicyRetentionPolicy
{
	...
	#[\JMS\Serializer\Annotation\SerializedName('onPolicySwitch')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ResourcePolicySnapshotSchedulePolicyRetentionPolicyOnPolicySwitchEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ResourcePolicySnapshotSchedulePolicyRetentionPolicyOnPolicySwitchEnum $onPolicySwitch = null;
