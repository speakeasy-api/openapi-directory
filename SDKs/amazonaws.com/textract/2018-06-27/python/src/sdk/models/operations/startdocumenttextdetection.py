...
class StartDocumentTextDetectionRequest:
    headers: StartDocumentTextDetectionHeaders = dataclasses.field()
    request: shared_startdocumenttextdetectionrequest.StartDocumentTextDetectionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
