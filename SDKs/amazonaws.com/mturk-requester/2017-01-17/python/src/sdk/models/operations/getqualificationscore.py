...
class GetQualificationScoreRequest:
    ...
    get_qualification_score_request: shared_getqualificationscorerequest.GetQualificationScoreRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
