...
export class RefundTransactionLogs {
  ...
  objectGETRefundTransactionLog(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ObjectGETRefundTransactionLogResponse =
        new operations.ObjectGETRefundTransactionLogResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.proxyGetRefundTransactionLog = utils.objectToClass(
              httpRes?.data,
              shared.ProxyGetRefundTransactionLog
            );
          }
          break;
