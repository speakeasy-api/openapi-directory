...
from ..shared import referencefiles as shared_referencefiles
from ..shared import referencestatus_enum as shared_referencestatus_enum
...
class GetReferenceMetadataResponse:
    ...
    files: Optional[shared_referencefiles.ReferenceFiles] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('files'), 'exclude': lambda f: f is None }})  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})  
    status: Optional[shared_referencestatus_enum.ReferenceStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
