...
class DisplayvideoInventorySourcesEditInventorySourceReadWriteAccessorsRequest:
    ...
    r"""Required. The ID of inventory source to update."""  
    ...
    r"""JSONP"""  
    edit_inventory_source_read_write_accessors_request: Optional[shared_editinventorysourcereadwriteaccessorsrequest.EditInventorySourceReadWriteAccessorsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
