...
func (e GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestFeaturesEnum) ToPointer() *GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestFeaturesEnum {
	return &e
}

func (e *GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestFeaturesEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "PERSON_DETECTION":
		*e = GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestFeaturesEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestFeaturesEnum: %v", v)
	}
}
