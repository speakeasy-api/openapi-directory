...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/reliancegeneral/3.0.0/python
```
...
req = operations.CripcRequestBody(
    certificate_parameters=operations.CripcRequestBodyCertificateParameters(
        ...
        gender="M",
        policy_no="123",
        policy_type="Policy Copy,Endorsement Copy",
    ),
