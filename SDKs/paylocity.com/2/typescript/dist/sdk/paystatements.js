...
var PayStatements = /** @class */ (function () {
    ...
    **/
    PayStatements.prototype.getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYear = function (req, config) {
    ...
    **/
    PayStatements.prototype.getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PayStatements.prototype.getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYear = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PayStatements.prototype.getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
