...
use \OpenAPI\OpenAPI\Models\Operations\GovidRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\GovidRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\GovidRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\GovidSecurity;
...
try {
    ...
    $request->certificateParameters = new GovidRequestBodyCertificateParameters();
    $request->certificateParameters->dob = '31-12-1980';
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->regnNo = 'I-99-A';
    ...
    $request->format = GovidRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new GovidSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->govid($request, $requestSecurity);
...
* [govid](docs/apis/README.md#govid) - ID Card
