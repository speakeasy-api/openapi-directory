...
from ..shared import security as shared_security
from ..shared import googlefirebaseappcheckv1exchangedevicechecktokenrequest as shared_googlefirebaseappcheckv1exchangedevicechecktokenrequest
...
class FirebaseappcheckProjectsAppsExchangeDeviceCheckTokenRequest:
    ...
    request: Optional[shared_googlefirebaseappcheckv1exchangedevicechecktokenrequest.GoogleFirebaseAppcheckV1ExchangeDeviceCheckTokenRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
