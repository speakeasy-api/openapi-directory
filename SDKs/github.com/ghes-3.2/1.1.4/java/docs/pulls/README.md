...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCheckIfMergedRequest req = new PullsCheckIfMergedRequest("impedit", 166047L, "soluta");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateRequest req = new PullsCreateRequest(                new PullsCreateRequestBody("repudiandae", "nam") {{
                                body = "dolore";
                                draft = false;
                                issue = 1L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReplyForReviewCommentRequest req = new PullsCreateReplyForReviewCommentRequest(                new PullsCreateReplyForReviewCommentRequestBody("dignissimos");, 205566L, "quo", 535468L, "quibusdam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReviewRequest req = new PullsCreateReviewRequest("iure", 139072L, "voluptatibus") {{
                requestBody = new PullsCreateReviewRequestBody() {{
                    ...
                    comments = new org.openapis.openapi.models.operations.PullsCreateReviewRequestBodyComments[]{{
                        add(new PullsCreateReviewRequestBodyComments("libero", "architecto") {{
                            body = "quibusdam";
                            line = 28L;
                            path = "inventore";
                            position = 818034L;
                        ...
                        add(new PullsCreateReviewRequestBodyComments("aliquam", "velit") {{
                            body = "voluptatibus";
                            line = 28L;
                            path = "quia";
                            position = 782090L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReviewCommentRequest req = new PullsCreateReviewCommentRequest(                new PullsCreateReviewCommentRequestBody("vel", "ea", 107617L, "vero") {{
                                inReplyTo = 2L;
                                position = 568218L;
                                side = PullsCreateReviewCommentRequestBodySideEnum.LEFT;
                                startLine = 246557L;
                                startSide = PullsCreateReviewCommentRequestBodyStartSideEnum.LEFT;
                            }};, "perspiciatis", 935302L, "dicta");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDeletePendingReviewRequest req = new PullsDeletePendingReviewRequest("impedit", 975884L, "iste", 932562L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDeleteReviewCommentRequest req = new PullsDeleteReviewCommentRequest(2677L, "nisi", "itaque");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDismissReviewRequest req = new PullsDismissReviewRequest(                new PullsDismissReviewRequestBody("velit") {{
                                event = PullsDismissReviewRequestBodyEventEnum.DISMISS;
                            }};, "laborum", 250398L, "dolor", 483394L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetRequest req = new PullsGetRequest("sit", 39992L, "consequatur");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetReviewRequest req = new PullsGetReviewRequest("officia", 927403L, "ea", 693153L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetReviewCommentRequest req = new PullsGetReviewCommentRequest(377406L, "facilis", "placeat");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListRequest req = new PullsListRequest("perspiciatis", "expedita") {{
                base = "deleniti";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListCommentsForReviewRequest req = new PullsListCommentsForReviewRequest("impedit", 373040L, "corporis", 668234L) {{
                page = 621666L;
                perPage = 456885L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListCommitsRequest req = new PullsListCommitsRequest("labore", 85066L, "vero") {{
                page = 233173L;
                perPage = 112427L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListFilesRequest req = new PullsListFilesRequest("inventore", 212434L, "ad") {{
                page = 183033L;
                perPage = 611328L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListRequestedReviewersRequest req = new PullsListRequestedReviewersRequest("ex", 367626L, "soluta");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewCommentsRequest req = new PullsListReviewCommentsRequest("libero", 526907L, "dolorum") {{
                direction = PullsListReviewCommentsDirectionEnum.ASC;
                page = 144691L;
                perPage = 545L;
                since = OffsetDateTime.parse("2022-07-29T17:28:50.439Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewCommentsForRepoRequest req = new PullsListReviewCommentsForRepoRequest("quae", "modi") {{
                direction = PullsListReviewCommentsForRepoDirectionEnum.ASC;
                page = 348357L;
                perPage = 932394L;
                since = OffsetDateTime.parse("2022-10-14T09:06:41.387Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewsRequest req = new PullsListReviewsRequest("nulla", 714376L, "maxime") {{
                page = 157222L;
                perPage = 159146L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsMergeRequest req = new PullsMergeRequest("nostrum", 605712L, "libero") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsRequestReviewersRequest req = new PullsRequestReviewersRequest("dolore", 755106L, "distinctio") {{
    ...
    public static void main(String[] args) {
        try {
            ...
            PullsSubmitReviewRequest req = new PullsSubmitReviewRequest(                new PullsSubmitReviewRequestBody(PullsSubmitReviewRequestBodyEventEnum.REQUEST_CHANGES) {{
                                body = "provident";
                            }};, "accusamus", 896480L, "tempore", 575078L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateRequest req = new PullsUpdateRequest("ea", 421819L, "ipsam") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateBranchRequest req = new PullsUpdateBranchRequest("voluptatibus", 737279L, "at") {{
                requestBody = new PullsUpdateBranchRequestBody() {{
                    expectedHeadSha = "alias";
                }};;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateReviewRequest req = new PullsUpdateReviewRequest(                new PullsUpdateReviewRequestBody("quia");, "quidem", 684126L, "repudiandae", 34070L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateReviewCommentRequest req = new PullsUpdateReviewCommentRequest(                new PullsUpdateReviewCommentRequestBody("expedita");, 885208L, "eos", "quibusdam");            
