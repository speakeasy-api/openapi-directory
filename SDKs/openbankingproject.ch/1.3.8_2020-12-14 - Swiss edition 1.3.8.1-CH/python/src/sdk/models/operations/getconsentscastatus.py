...
class GetConsentScaStatusRequest:
    headers: GetConsentScaStatusHeaders = dataclasses.field()
    path_params: GetConsentScaStatusPathParams = dataclasses.field()
    security: GetConsentScaStatusSecurity = dataclasses.field()
