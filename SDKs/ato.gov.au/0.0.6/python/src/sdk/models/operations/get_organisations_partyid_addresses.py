...
class GetOrganisationsPartyIDAddressesRequest:
...
@dataclasses.dataclass
class GetOrganisationsPartyIDAddressesResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    addresses: Optional[list[shared_address.Address]] = dataclasses.field(default=None)
    r"""Addresses were retrieved successfully"""  
