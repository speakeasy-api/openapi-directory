 ...
 */
export enum GetNetworkClientConnectionStatsBandEnum {
  Two4 = "2.4",
  Five = "5",
}

export class GetNetworkClientConnectionStatsRequest extends SpeakeasyBase {
  /**
  ...
  band?: GetNetworkClientConnectionStatsBandEnum;
...
export class GetNetworkClientConnectionStatsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getNetworkClientConnectionStats200ApplicationJSONObject?: Record<string, any>;
}
