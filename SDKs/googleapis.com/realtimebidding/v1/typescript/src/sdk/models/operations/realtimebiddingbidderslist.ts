...
export class RealtimebiddingBiddersListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RealtimebiddingBiddersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RealtimebiddingBiddersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  listBiddersResponse?: shared.ListBiddersResponse;
