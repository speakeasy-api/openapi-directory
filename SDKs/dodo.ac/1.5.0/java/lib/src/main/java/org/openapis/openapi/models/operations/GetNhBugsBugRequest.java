...
public class GetNhBugsBugRequest {
    ...
    public GetNhBugsBugRequest withAcceptVersion(String acceptVersion) {
    ...
    public GetNhBugsBugRequest withXApiKey(String xApiKey) {
    ...
    public String bug;
    public GetNhBugsBugRequest withBug(String bug) {
        this.bug = bug;
        return this;
    }
    ...
    public GetNhBugsBugRequest withThumbsize(Long thumbsize) {
