...
exports.UpdateServiceConversationParticipantResponse = exports.UpdateServiceConversationParticipantRequest = exports.UpdateServiceConversationParticipantUpdateServiceConversationParticipantRequest = exports.UpdateServiceConversationParticipantSecurity = exports.UpdateServiceConversationParticipantServerList = void 0;
...
var UpdateServiceConversationParticipantSecurity = /** @class */ (function (_super) {
    ...
    ], UpdateServiceConversationParticipantSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], UpdateServiceConversationParticipantSecurity.prototype, "username", void 0);
...
var UpdateServiceConversationParticipantRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], UpdateServiceConversationParticipantRequest.prototype, "chatServiceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConversationSid",
        }),
        __metadata("design:type", String)
    ], UpdateServiceConversationParticipantRequest.prototype, "conversationSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "request, media_type=application/x-www-form-urlencoded",
        }),
        __metadata("design:type", UpdateServiceConversationParticipantUpdateServiceConversationParticipantRequest)
    ], UpdateServiceConversationParticipantRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=Sid" }),
        __metadata("design:type", String)
    ], UpdateServiceConversationParticipantRequest.prototype, "sid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Twilio-Webhook-Enabled",
        }),
        __metadata("design:type", String)
    ], UpdateServiceConversationParticipantRequest.prototype, "xTwilioWebhookEnabled", void 0);
...
var UpdateServiceConversationParticipantResponse = /** @class */ (function (_super) {
    ...
    ], UpdateServiceConversationParticipantResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
