...
exports.ListDependentPhoneNumberResponse = exports.ListDependentPhoneNumberListDependentPhoneNumberResponse = exports.ListDependentPhoneNumberRequest = exports.ListDependentPhoneNumberSecurity = exports.ListDependentPhoneNumberServerList = void 0;
...
var ListDependentPhoneNumberSecurity = /** @class */ (function (_super) {
    ...
    ], ListDependentPhoneNumberSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListDependentPhoneNumberSecurity.prototype, "username", void 0);
...
var ListDependentPhoneNumberRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListDependentPhoneNumberRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=AddressSid",
        }),
        __metadata("design:type", String)
    ], ListDependentPhoneNumberRequest.prototype, "addressSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListDependentPhoneNumberRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListDependentPhoneNumberRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListDependentPhoneNumberRequest.prototype, "pageToken", void 0);
...
var ListDependentPhoneNumberListDependentPhoneNumberResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.ApiV2010AccountAddressDependentPhoneNumber,
        }),
        (0, class_transformer_1.Expose)({ name: "dependent_phone_numbers" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountAddressDependentPhoneNumber; }),
...
var ListDependentPhoneNumberResponse = /** @class */ (function (_super) {
    ...
    ], ListDependentPhoneNumberResponse.prototype, "rawResponse", void 0);
