...
class SearchTypePointNoaaCarbonQueryParams:
    ...
    search_type_point_noaa_carbon_lab_id_number: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_carbon.lab_id_number', 'style': 'form', 'explode': True }})
    search_type_point_noaa_carbon_measurement_group: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_carbon.measurement_group', 'style': 'form', 'explode': True }})
    search_type_point_noaa_carbon_parameter: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_carbon.parameter', 'style': 'form', 'explode': True }})
    search_type_point_noaa_carbon_project: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_carbon.project', 'style': 'form', 'explode': True }})
    search_type_point_noaa_carbon_site_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_carbon.site_id', 'style': 'form', 'explode': True }})
...
class SearchTypePointNoaaCarbonRequest:
    query_params: SearchTypePointNoaaCarbonQueryParams = dataclasses.field()
