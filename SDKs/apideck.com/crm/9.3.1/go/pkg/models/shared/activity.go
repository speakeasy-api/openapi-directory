...
func (e ActivityShowAsEnum) ToPointer() *ActivityShowAsEnum {
	return &e
}

func (e *ActivityShowAsEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "free":
		fallthrough
	case "busy":
		*e = ActivityShowAsEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ActivityShowAsEnum: %v", v)
	}
}
