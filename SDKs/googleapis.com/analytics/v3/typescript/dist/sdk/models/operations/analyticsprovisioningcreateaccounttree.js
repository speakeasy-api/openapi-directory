...
exports.AnalyticsProvisioningCreateAccountTreeResponse = exports.AnalyticsProvisioningCreateAccountTreeRequest = exports.AnalyticsProvisioningCreateAccountTreeSecurity = void 0;
...
var AnalyticsProvisioningCreateAccountTreeRequest = /** @class */ (function (_super) {
    ...
    ], AnalyticsProvisioningCreateAccountTreeRequest.prototype, "accountTreeRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AnalyticsProvisioningCreateAccountTreeRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AnalyticsProvisioningCreateAccountTreeRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AnalyticsProvisioningCreateAccountTreeRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AnalyticsProvisioningCreateAccountTreeRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AnalyticsProvisioningCreateAccountTreeRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AnalyticsProvisioningCreateAccountTreeRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AnalyticsProvisioningCreateAccountTreeRequest.prototype, "userIp", void 0);
...
var AnalyticsProvisioningCreateAccountTreeResponse = /** @class */ (function (_super) {
    ...
    ], AnalyticsProvisioningCreateAccountTreeResponse.prototype, "rawResponse", void 0);
