...
type BatchGetDataQualityResultHeaders struct {
...
type BatchGetDataQualityResultRequest struct {
	Headers BatchGetDataQualityResultHeaders
	Request shared.BatchGetDataQualityResultRequest `request:"mediaType=application/json"`
}
