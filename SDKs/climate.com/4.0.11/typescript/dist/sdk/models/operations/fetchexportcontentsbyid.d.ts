...
export declare class FetchExportContentsByIdSecurity extends SpeakeasyBase {
    apiKey?: string;
    oauth2AuthorizationCode?: string;
}
export declare class FetchExportContentsByIdRequest extends SpeakeasyBase {
    /**
...
export declare class FetchExportContentsByIdResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    /**
     * Not Modified
