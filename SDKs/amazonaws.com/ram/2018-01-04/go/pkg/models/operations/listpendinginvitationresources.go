...
type ListPendingInvitationResourcesRequestBodyResourceRegionScopeEnum string

const (
	ListPendingInvitationResourcesRequestBodyResourceRegionScopeEnumAll      ListPendingInvitationResourcesRequestBodyResourceRegionScopeEnum = "ALL"
	ListPendingInvitationResourcesRequestBodyResourceRegionScopeEnumRegional ListPendingInvitationResourcesRequestBodyResourceRegionScopeEnum = "REGIONAL"
...
type ListPendingInvitationResourcesRequest struct {
	RequestBody       ListPendingInvitationResourcesRequestBody `request:"mediaType=application/json"`
