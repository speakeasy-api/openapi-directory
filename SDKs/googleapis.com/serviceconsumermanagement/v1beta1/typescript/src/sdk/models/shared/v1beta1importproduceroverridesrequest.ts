...
export enum V1Beta1ImportProducerOverridesRequestForceOnlyEnum {
 ...
 */
export class V1Beta1ImportProducerOverridesRequest extends SpeakeasyBase {
  /**
  ...
  @Type(() => V1Beta1OverrideInlineSource)
