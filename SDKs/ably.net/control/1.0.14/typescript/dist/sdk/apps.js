...
var Apps = /** @class */ (function () {
    ...
    **/
    Apps.prototype.deleteAppsId = function (req, config) {
    ...
    **/
    Apps.prototype.getAccountsAccountIdApps = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Apps.prototype.patchAppsId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Apps.prototype.postAccountsAccountIdApps = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Apps.prototype.postAppsIdPkcs12 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
