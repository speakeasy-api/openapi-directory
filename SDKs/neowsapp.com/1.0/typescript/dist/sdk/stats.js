...
var Stats = /** @class */ (function () {
    ...
    Stats.prototype.retrieveCurrentNeoStatistics = function (config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.RetrieveCurrentNeoStatisticsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.statistics = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.Statistics);
                    }
                    break;
