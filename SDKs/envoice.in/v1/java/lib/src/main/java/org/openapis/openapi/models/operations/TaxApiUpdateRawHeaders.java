...
public class TaxApiUpdateRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public TaxApiUpdateRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public TaxApiUpdateRawHeaders withXAuthSecret(String xAuthSecret) {
