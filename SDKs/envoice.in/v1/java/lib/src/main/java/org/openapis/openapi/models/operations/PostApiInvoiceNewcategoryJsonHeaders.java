...
public class PostApiInvoiceNewcategoryJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PostApiInvoiceNewcategoryJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public PostApiInvoiceNewcategoryJsonHeaders withXAuthSecret(String xAuthSecret) {
