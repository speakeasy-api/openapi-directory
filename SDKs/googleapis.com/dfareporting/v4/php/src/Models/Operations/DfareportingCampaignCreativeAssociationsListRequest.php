...
class DfareportingCampaignCreativeAssociationsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DfareportingCampaignCreativeAssociationsListSortOrderEnum $sortOrder
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortOrder')]
    public ?DfareportingCampaignCreativeAssociationsListSortOrderEnum $sortOrder = null;
