 ...
 * 
 */
public enum GetDirectDebitsForMandateUuidDirectDebitsDirectDebitStatusEnum {
    RECIEVED("RECIEVED"),
    ...
    private GetDirectDebitsForMandateUuidDirectDebitsDirectDebitStatusEnum(String value) {
        this.value = value;
    }
}
