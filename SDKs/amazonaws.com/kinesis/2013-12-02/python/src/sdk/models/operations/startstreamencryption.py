...
class StartStreamEncryptionRequest:
    ...
    start_stream_encryption_input: shared_startstreamencryptioninput.StartStreamEncryptionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
