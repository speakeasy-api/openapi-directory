 ...
 */
public class PostBenefitsDocumentUploadValidateDocument500ApplicationJSON {
    /**
    ...
    public PostBenefitsDocumentUploadValidateDocument500ApplicationJSON withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public PostBenefitsDocumentUploadValidateDocument500ApplicationJSON withDetail(String detail) {
        this.detail = detail;
        return this;
    }
    ...
    public PostBenefitsDocumentUploadValidateDocument500ApplicationJSON withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public PostBenefitsDocumentUploadValidateDocument500ApplicationJSON withTitle(String title) {
        this.title = title;
        return this;
    }
    
    public PostBenefitsDocumentUploadValidateDocument500ApplicationJSON(){}
}
