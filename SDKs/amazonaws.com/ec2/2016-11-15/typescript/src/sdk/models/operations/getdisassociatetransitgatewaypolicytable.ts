...
export enum GETDisassociateTransitGatewayPolicyTableActionEnum {
  DisassociateTransitGatewayPolicyTable = "DisassociateTransitGatewayPolicyTable",
}

export enum GETDisassociateTransitGatewayPolicyTableVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETDisassociateTransitGatewayPolicyTableRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETDisassociateTransitGatewayPolicyTableResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
