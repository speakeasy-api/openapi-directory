...
public class GetNetworkWirelessDevicesConnectionStatsRequest {
    ...
    public String apTag;
    public GetNetworkWirelessDevicesConnectionStatsRequest withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkWirelessDevicesConnectionStatsRequest withBand(GetNetworkWirelessDevicesConnectionStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public GetNetworkWirelessDevicesConnectionStatsRequest withNetworkId(String networkId) {
    ...
    public Long ssid;
    public GetNetworkWirelessDevicesConnectionStatsRequest withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetNetworkWirelessDevicesConnectionStatsRequest withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetNetworkWirelessDevicesConnectionStatsRequest withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkWirelessDevicesConnectionStatsRequest withTimespan(Float timespan) {
    ...
    public Long vlan;
    public GetNetworkWirelessDevicesConnectionStatsRequest withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
