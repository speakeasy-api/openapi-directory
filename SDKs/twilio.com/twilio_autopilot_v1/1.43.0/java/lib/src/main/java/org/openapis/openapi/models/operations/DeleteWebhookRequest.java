...
public class DeleteWebhookRequest {
    ...
    public DeleteWebhookRequest withAssistantSid(String assistantSid) {
    ...
    public DeleteWebhookRequest(@JsonProperty("AssistantSid") String assistantSid, @JsonProperty("Sid") String sid) {
        this.assistantSid = assistantSid;
        this.sid = sid;
  }
}
