 ...
 */
public enum ProvisionByoipCidrRequestPoolTagSpecificationsResourceTypeEnum {
    ...
    private ProvisionByoipCidrRequestPoolTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
