...
public class GetCaseGenotypeAssociationsRequest {
    ...
    public GetCaseGenotypeAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetCaseGenotypeAssociationsRequest withEvidence(String evidence) {
    ...
    public GetCaseGenotypeAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetCaseGenotypeAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetCaseGenotypeAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetCaseGenotypeAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetCaseGenotypeAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetCaseGenotypeAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetCaseGenotypeAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetCaseGenotypeAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetCaseGenotypeAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetCaseGenotypeAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetCaseGenotypeAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
