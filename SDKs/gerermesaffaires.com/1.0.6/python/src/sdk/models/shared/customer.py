...
class CustomerLevelEnum(str, Enum):
...
class Customer:
    ...
    level: Optional[CustomerLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Level'), 'exclude': lambda f: f is None }})  
