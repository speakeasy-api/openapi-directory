...
type ScriptProjectsVersionsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ScriptProjectsVersionsCreatePathParams struct {
	// The script project's Drive ID.
	ScriptID string `pathParam:"style=simple,explode=false,name=scriptId"`
}

type ScriptProjectsVersionsCreateQueryParams struct {
	// V1 error format.
...
type ScriptProjectsVersionsCreateRequest struct {
...
type ScriptProjectsVersionsCreateResponse struct {
	ContentType string
	StatusCode  int
