...
class DeleteKubernetesClusterRequest:
    path_params: DeleteKubernetesClusterPathParams = dataclasses.field()
...
class DeleteKubernetesClusterResponse:
    ...
    delete_kubernetes_cluster_401_application_json_object: Optional[DeleteKubernetesCluster401ApplicationJSON] = dataclasses.field(default=None)
