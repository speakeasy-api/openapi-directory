...
class DisplayvideoAdvertisersCampaignsDeleteSecurity:
    option1: Optional[DisplayvideoAdvertisersCampaignsDeleteSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DisplayvideoAdvertisersCampaignsDeleteSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DisplayvideoAdvertisersCampaignsDeleteRequest:
    path_params: DisplayvideoAdvertisersCampaignsDeletePathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersCampaignsDeleteQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersCampaignsDeleteSecurity = dataclasses.field()
