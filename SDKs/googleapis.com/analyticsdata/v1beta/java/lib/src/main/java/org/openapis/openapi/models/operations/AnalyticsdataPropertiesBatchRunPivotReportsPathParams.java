...
public class AnalyticsdataPropertiesBatchRunPivotReportsPathParams {
    /**
    ...
    public AnalyticsdataPropertiesBatchRunPivotReportsPathParams withProperty(String property) {
