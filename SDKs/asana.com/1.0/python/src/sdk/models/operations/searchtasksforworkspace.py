...
class SearchTasksForWorkspaceRequest:
    ...
    r"""Comma-separated list of project IDs"""  
    resource_subtype: Optional[SearchTasksForWorkspaceResourceSubtypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'resource_subtype', 'style': 'form', 'explode': True }})
    r"""Filters results by the task's resource_subtype"""  
    ...
    r"""Default `false`"""  
    sort_by: Optional[SearchTasksForWorkspaceSortByEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort_by', 'style': 'form', 'explode': True }})
    r"""One of `due_date`, `created_at`, `completed_at`, `likes`, or `modified_at`, defaults to `modified_at`"""  
