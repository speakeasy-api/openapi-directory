...
class PrivateUser:
    ...
    plan: Optional[PrivateUserPlan] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('plan'), 'exclude': lambda f: f is None }})  
