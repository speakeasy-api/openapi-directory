...
class WebinarUpdateApplicationJSONRecurrence
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\WebinarUpdateApplicationJSONRecurrenceMonthlyWeekEnum $monthlyWeek
     */
	#[\JMS\Serializer\Annotation\SerializedName('monthly_week')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\WebinarUpdateApplicationJSONRecurrenceMonthlyWeekEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?WebinarUpdateApplicationJSONRecurrenceMonthlyWeekEnum $monthlyWeek = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\WebinarUpdateApplicationJSONRecurrenceMonthlyWeekDayEnum $monthlyWeekDay
     */
	#[\JMS\Serializer\Annotation\SerializedName('monthly_week_day')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\WebinarUpdateApplicationJSONRecurrenceMonthlyWeekDayEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?WebinarUpdateApplicationJSONRecurrenceMonthlyWeekDayEnum $monthlyWeekDay = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\WebinarUpdateApplicationJSONRecurrenceTypeEnum $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\WebinarUpdateApplicationJSONRecurrenceTypeEnum>')]
    public WebinarUpdateApplicationJSONRecurrenceTypeEnum $type;
     ...
     *  <br>`1`  - Sunday. <br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` -  Thursday.<br>`6` - Friday.<br>`7` - Saturday.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\WebinarUpdateApplicationJSONRecurrenceWeeklyDaysEnum $weeklyDays
     */
	#[\JMS\Serializer\Annotation\SerializedName('weekly_days')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\WebinarUpdateApplicationJSONRecurrenceWeeklyDaysEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?WebinarUpdateApplicationJSONRecurrenceWeeklyDaysEnum $weeklyDays = null;
	...
	public function __construct()
	{
		...
		$this->type = \OpenAPI\OpenAPI\Models\Operations\WebinarUpdateApplicationJSONRecurrenceTypeEnum::ONE;
