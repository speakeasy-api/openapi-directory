...
class AssociateConfigurationItemsToApplicationRequest:
    ...
    associate_configuration_items_to_application_request: shared_associateconfigurationitemstoapplicationrequest.AssociateConfigurationItemsToApplicationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
