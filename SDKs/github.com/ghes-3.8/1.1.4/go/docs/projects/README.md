...
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#add-project-collaborator>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#create-a-project-card>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#create-a-project-column>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#create-a-user-project>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#create-an-organization-project>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#create-a-repository-project>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#delete-a-project>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#delete-a-project-card>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#delete-a-project-column>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#get-a-project>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#get-a-project-card>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#get-a-project-column>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#get-project-permission-for-a-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#list-project-cards>
...
func main() {
    ...
    res, err := s.Projects.ProjectsListCards(ctx, operations.ProjectsListCardsRequest{
        ...
        ColumnID: 326903,
        Page: sdk.Int64(102446),
        PerPage: sdk.Int64(181476),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#list-project-collaborators>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#list-project-columns>
...
func main() {
    ...
    res, err := s.Projects.ProjectsListColumns(ctx, operations.ProjectsListColumnsRequest{
        Page: sdk.Int64(506343),
        PerPage: sdk.Int64(220528),
        ProjectID: 349898,
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#list-organization-projects>
...
func main() {
    ...
    res, err := s.Projects.ProjectsListForOrg(ctx, operations.ProjectsListForOrgRequest{
        Org: "expedita",
        Page: sdk.Int64(706411),
        PerPage: sdk.Int64(769634),
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#list-repository-projects>
...
func main() {
    ...
    res, err := s.Projects.ProjectsListForRepo(ctx, operations.ProjectsListForRepoRequest{
        Owner: "nemo",
        Page: sdk.Int64(633987),
        PerPage: sdk.Int64(159393),
        Repo: "amet",
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#list-user-projects>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#move-a-project-card>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#move-a-project-column>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#remove-project-collaborator>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#update-a-project>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#update-a-project-card>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/projects#update-a-project-column>
