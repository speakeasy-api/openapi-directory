...
export class Tiers {
  ...
  **/
  sqlTiersList(
    ...
    const url: string = utils.generateURL(baseURL, "/v1/projects/{project}/tiers", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.SqlTiersListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
