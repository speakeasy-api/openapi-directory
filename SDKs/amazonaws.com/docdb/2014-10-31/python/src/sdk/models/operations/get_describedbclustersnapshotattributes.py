...
class GetDescribeDbClusterSnapshotAttributesRequest:
    headers: GetDescribeDbClusterSnapshotAttributesHeaders = dataclasses.field()
    query_params: GetDescribeDbClusterSnapshotAttributesQueryParams = dataclasses.field()
