 ...
 */
public enum DescribeInstancesResultReservationsInstancesPlacementTenancyEnum {
    DEFAULT_("default"),
    DEDICATED("dedicated"),
    HOST("host");
    ...
    private DescribeInstancesResultReservationsInstancesPlacementTenancyEnum(String value) {
        this.value = value;
    }
}
