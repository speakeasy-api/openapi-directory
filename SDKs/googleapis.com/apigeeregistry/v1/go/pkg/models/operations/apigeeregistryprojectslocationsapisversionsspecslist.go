...
type ApigeeregistryProjectsLocationsApisVersionsSpecsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ApigeeregistryProjectsLocationsApisVersionsSpecsListPathParams struct {
	// Required. The parent, which owns this collection of specs. Format: `projects/*/locations/*/apis/*/versions/*`
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ApigeeregistryProjectsLocationsApisVersionsSpecsListQueryParams struct {
	// V1 error format.
...
type ApigeeregistryProjectsLocationsApisVersionsSpecsListRequest struct {
...
type ApigeeregistryProjectsLocationsApisVersionsSpecsListResponse struct {
	ContentType string
	// Successful response
