...
var Beleg = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "Beleg-Codes" }),
        __metadata("design:type", Array)
    ], Beleg.prototype, "belegCodes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "Beleg-Typen" }),
        __metadata("design:type", Array)
    ], Beleg.prototype, "belegTypen", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "Belegdaten" }),
        (0, class_transformer_1.Type)(function () { return signiertebelegdaten_1.SignierteBelegdaten; }),
        __metadata("design:type", signiertebelegdaten_1.SignierteBelegdaten)
    ], Beleg.prototype, "belegdaten", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "JWS" }),
        __metadata("design:type", String)
    ], Beleg.prototype, "jws", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "QR" }),
        __metadata("design:type", String)
    ], Beleg.prototype, "qr", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "QR-Link" }),
        __metadata("design:type", String)
    ], Beleg.prototype, "qrLink", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "Registrierkasse-UUID" }),
        __metadata("design:type", String)
    ], Beleg.prototype, "registrierkasseUUID", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "Signaturerstellungseinheit-UUID" }),
        __metadata("design:type", String)
    ], Beleg.prototype, "signaturerstellungseinheitUUID", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "_href" }),
        __metadata("design:type", String)
    ], Beleg.prototype, "href", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "_uuid" }),
        __metadata("design:type", String)
