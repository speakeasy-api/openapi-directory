 ...
 */
export class BackendServiceFailoverPolicy extends SpeakeasyBase {
  /**
   * This can be set to true only if the protocol is TCP. The default is false.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "disableConnectionDrainOnFailover" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "dropTrafficIfUnhealthy" })
