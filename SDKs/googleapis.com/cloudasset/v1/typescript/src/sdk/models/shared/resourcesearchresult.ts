...
export class ResourceSearchResult extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: AttachedResource })
  @Expose({ name: "attachedResources" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "parentFullResourceName" })
   ...
   */
  @SpeakeasyMetadata({ elemType: RelatedResources })
  @Expose({ name: "relationships" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, RelatedResources> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], RelatedResources);
      }
      return obj;
    },
    { toClassOnly: true }
