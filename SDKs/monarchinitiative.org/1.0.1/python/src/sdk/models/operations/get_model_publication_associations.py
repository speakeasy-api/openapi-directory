...
class GetModelPublicationAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetModelPublicationAssociationsQueryParams:
...
@dataclasses.dataclass
class GetModelPublicationAssociationsRequest:
    path_params: GetModelPublicationAssociationsPathParams = dataclasses.field()
    query_params: GetModelPublicationAssociationsQueryParams = dataclasses.field()
