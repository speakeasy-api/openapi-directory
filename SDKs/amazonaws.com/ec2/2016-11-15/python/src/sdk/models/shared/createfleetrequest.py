...
from ..shared import fleetlaunchtemplateconfiglistrequest as shared_fleetlaunchtemplateconfiglistrequest
from ..shared import fleettype_enum as shared_fleettype_enum
from ..shared import ondemandoptionsrequest as shared_ondemandoptionsrequest
from ..shared import spotoptionsrequest as shared_spotoptionsrequest
from ..shared import targetcapacityspecificationrequest as shared_targetcapacityspecificationrequest
from datetime import datetime
from enum import Enum
from typing import Optional

class CreateFleetRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateFleetRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateFleetRequestTagSpecifications:
    ...
    resource_type: Optional[CreateFleetRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateFleetRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateFleetRequest:
    
    launch_template_configs: list[shared_fleetlaunchtemplateconfiglistrequest.FleetLaunchTemplateConfigListRequest] = dataclasses.field()  
    target_capacity_specification: shared_targetcapacityspecificationrequest.TargetCapacitySpecificationRequest = dataclasses.field()  
    ...
    on_demand_options: Optional[shared_ondemandoptionsrequest.OnDemandOptionsRequest] = dataclasses.field(default=None)  
    replace_unhealthy_instances: Optional[bool] = dataclasses.field(default=None)  
    spot_options: Optional[shared_spotoptionsrequest.SpotOptionsRequest] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateFleetRequestTagSpecifications]] = dataclasses.field(default=None)  
    terminate_instances_with_expiration: Optional[bool] = dataclasses.field(default=None)  
    type: Optional[shared_fleettype_enum.FleetTypeEnum] = dataclasses.field(default=None)  
