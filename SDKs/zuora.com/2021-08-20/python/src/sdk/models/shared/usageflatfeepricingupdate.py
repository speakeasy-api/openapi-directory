...
class UsageFlatFeePricingUpdatePriceChangeOptionEnum(str, Enum):
    NO_CHANGE = "NoChange"
...
class UsageFlatFeePricingUpdate:
    ...
    price_change_option: Optional[UsageFlatFeePricingUpdatePriceChangeOptionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('priceChangeOption') }})
