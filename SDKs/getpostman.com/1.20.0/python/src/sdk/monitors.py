...
class Monitors:
    ...
    def all_monitors(self) -> operations.AllMonitorsResponse:
        ...
        res = operations.AllMonitorsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.AllMonitors200ApplicationJSON])
                res.all_monitors_200_application_json_object = out

        return res

    def create_monitor(self, request: operations.CreateMonitorRequestBody) -> operations.CreateMonitorResponse:
        r"""Create Monitor
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.CreateMonitor200ApplicationJSON])
                res.create_monitor_200_application_json_object = out
        elif http_res.status_code == 400:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.CreateMonitor400ApplicationJSON])
    ...
    def delete_monitor(self, request: operations.DeleteMonitorRequest) -> operations.DeleteMonitorResponse:
        ...
        url = utils.generate_url(operations.DeleteMonitorRequest, base_url, '/monitors/{monitor_uid}', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.DeleteMonitor200ApplicationJSON])
                res.delete_monitor_200_application_json_object = out
        elif http_res.status_code == 404:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.DeleteMonitor404ApplicationJSON])
    ...
    def run_a_monitor(self, request: operations.RunAMonitorRequest) -> operations.RunAMonitorResponse:
        ...
        url = utils.generate_url(operations.RunAMonitorRequest, base_url, '/monitors/{monitor_uid}/run', request)
        ...
        res = operations.RunAMonitorResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.RunAMonitor200ApplicationJSON])
    ...
    def single_monitor(self, request: operations.SingleMonitorRequest) -> operations.SingleMonitorResponse:
        ...
        url = utils.generate_url(operations.SingleMonitorRequest, base_url, '/monitors/{monitor_uid}', request)
        ...
        res = operations.SingleMonitorResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.SingleMonitor200ApplicationJSON])
                res.single_monitor_200_application_json_object = out
        elif http_res.status_code == 404:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.SingleMonitor404ApplicationJSON])
    ...
    def update_monitor(self, request: operations.UpdateMonitorRequest) -> operations.UpdateMonitorResponse:
        ...
        url = utils.generate_url(operations.UpdateMonitorRequest, base_url, '/monitors/{monitor_uid}', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.UpdateMonitor200ApplicationJSON])
