 ...
 */
export class DescribeVerifiedAccessEndpointsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeVerifiedAccessEndpointsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
