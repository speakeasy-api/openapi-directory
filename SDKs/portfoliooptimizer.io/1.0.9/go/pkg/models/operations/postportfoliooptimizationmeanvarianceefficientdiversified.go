...
type PostPortfolioOptimizationMeanVarianceEfficientDiversifiedRequestBodyConstraints struct {
...
type PostPortfolioOptimizationMeanVarianceEfficientDiversifiedRequestBody struct {
...
type PostPortfolioOptimizationMeanVarianceEfficientDiversifiedResponse struct {
	ContentType string
	StatusCode  int
