...
func (e *GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "SHOT_AND_FRAME_MODE":
		*e = GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionModeEnum: %s", s)
	}
}
