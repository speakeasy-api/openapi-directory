...
func (e *DescribeAggregateComplianceByConfigRulesXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "StarlingDoveService.DescribeAggregateComplianceByConfigRules":
		*e = DescribeAggregateComplianceByConfigRulesXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeAggregateComplianceByConfigRulesXAmzTargetEnum: %s", s)
	}
}
