...
public class WebmastersSitemapsGetRequest {
    ...
    public WebmastersSitemapsGetRequest withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public WebmastersSitemapsGetRequest withAccessToken(String accessToken) {
    ...
    public WebmastersSitemapsGetRequest withCallback(String callback) {
    ...
    public WebmastersSitemapsGetRequest withUploadType(String uploadType) {
    ...
    public WebmastersSitemapsGetRequest withUploadProtocol(String uploadProtocol) {
