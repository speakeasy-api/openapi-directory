...
var ConnectorDocs = /** @class */ (function () {
     ...
     * Get Connector Doc content
     */
    ConnectorDocs.prototype.connectorDocsOne = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ConnectorDocsOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/connector/connectors/{id}/docs/{doc_id}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.ConnectorDocsOneResponse({
...
exports.ConnectorDocs = ConnectorDocs;
