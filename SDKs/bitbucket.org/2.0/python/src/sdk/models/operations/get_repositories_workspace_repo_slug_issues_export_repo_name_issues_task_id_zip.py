...
class GetRepositoriesWorkspaceRepoSlugIssuesExportRepoNameIssuesTaskIDZipRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugIssuesExportRepoNameIssuesTaskIDZipPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugIssuesExportRepoNameIssuesTaskIDZipSecurity = dataclasses.field()
