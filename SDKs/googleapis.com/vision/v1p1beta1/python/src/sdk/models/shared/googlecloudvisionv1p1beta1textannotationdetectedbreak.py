...
class GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak:
    ...
    type: Optional[GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreakTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Detected break type."""  
