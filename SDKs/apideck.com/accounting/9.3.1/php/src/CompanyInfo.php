...
class CompanyInfo 
{
     ...
     * Get company info
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CompanyInfoOneRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\CompanyInfoOneSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\CompanyInfoOneResponse
     */
	public function companyInfoOne(
        \OpenAPI\OpenAPI\Models\Operations\CompanyInfoOneRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\CompanyInfoOneSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\CompanyInfoOneResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/accounting/company-info');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\CompanyInfoOneRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CompanyInfoOneResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->getCompanyInfoResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetCompanyInfoResponse', 'json');
            }
        }
