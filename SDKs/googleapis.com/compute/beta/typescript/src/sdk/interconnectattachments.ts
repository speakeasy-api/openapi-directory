...
export class InterconnectAttachments {
  ...
  computeInterconnectAttachmentsTestIamPermissions(
    req: operations.ComputeInterconnectAttachmentsTestIamPermissionsRequest,
    security: operations.ComputeInterconnectAttachmentsTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeInterconnectAttachmentsTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.ComputeInterconnectAttachmentsTestIamPermissionsRequest(
          req
        );
    }
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/projects/{project}/regions/{region}/interconnectAttachments/{resource}/testIamPermissions",
      req
    );
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ComputeInterconnectAttachmentsTestIamPermissionsSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeInterconnectAttachmentsTestIamPermissionsResponse =
        new operations.ComputeInterconnectAttachmentsTestIamPermissionsResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
