...
export class AuthAuthkeyGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AuthAuthkeyGetRequest extends SpeakeasyBase {
  /**
   * User's device name
   */
  @SpeakeasyMetadata({
...
export class AuthAuthkeyGetResponse extends SpeakeasyBase {
  /**
   * Access Denied
   */
  @SpeakeasyMetadata()
