...
type ConnectorsProjectsLocationsConnectionsActionsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ConnectorsProjectsLocationsConnectionsActionsListPathParams struct {
...
type ConnectorsProjectsLocationsConnectionsActionsListQueryParams struct {
	// V1 error format.
...
type ConnectorsProjectsLocationsConnectionsActionsListRequest struct {
...
type ConnectorsProjectsLocationsConnectionsActionsListResponse struct {
	ContentType string
	// Successful response
