...
class Update:
    r"""Represents a request to perform an <code>UpdateItem</code> operation."""
    ...
    update_expression: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('UpdateExpression') }})  
