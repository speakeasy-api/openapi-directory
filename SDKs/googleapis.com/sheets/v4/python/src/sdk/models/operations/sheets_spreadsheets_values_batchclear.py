...
class SheetsSpreadsheetsValuesBatchClearRequest:
    ...
    batch_clear_values_request: Optional[shared_batchclearvaluesrequest.BatchClearValuesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
