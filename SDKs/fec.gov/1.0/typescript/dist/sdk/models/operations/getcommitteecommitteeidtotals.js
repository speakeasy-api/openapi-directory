...
exports.GetCommitteeCommitteeIdTotalsResponse = exports.GetCommitteeCommitteeIdTotalsRequest = void 0;
...
var GetCommitteeCommitteeIdTotalsRequest = /** @class */ (function (_super) {
    ...
    ], GetCommitteeCommitteeIdTotalsRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=committee_id",
        }),
        __metadata("design:type", String)
    ], GetCommitteeCommitteeIdTotalsRequest.prototype, "committeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=cycle" }),
        __metadata("design:type", Array)
    ], GetCommitteeCommitteeIdTotalsRequest.prototype, "cycle", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetCommitteeCommitteeIdTotalsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetCommitteeCommitteeIdTotalsRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetCommitteeCommitteeIdTotalsRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_hide_null",
        }),
        __metadata("design:type", Boolean)
    ], GetCommitteeCommitteeIdTotalsRequest.prototype, "sortHideNull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_null_only",
        }),
        __metadata("design:type", Boolean)
    ], GetCommitteeCommitteeIdTotalsRequest.prototype, "sortNullOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_nulls_last",
        }),
        __metadata("design:type", Boolean)
    ], GetCommitteeCommitteeIdTotalsRequest.prototype, "sortNullsLast", void 0);
...
var GetCommitteeCommitteeIdTotalsResponse = /** @class */ (function (_super) {
    ...
    ], GetCommitteeCommitteeIdTotalsResponse.prototype, "rawResponse", void 0);
