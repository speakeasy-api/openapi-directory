...
@dataclasses.dataclass
class CloudidentityCustomersUserinvitationsCancelQueryParams:
...
class CloudidentityCustomersUserinvitationsCancelRequest:
    path_params: CloudidentityCustomersUserinvitationsCancelPathParams = dataclasses.field()
    query_params: CloudidentityCustomersUserinvitationsCancelQueryParams = dataclasses.field()
