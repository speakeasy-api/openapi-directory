...
exports.GetAccountsAccountIdTransactionsResponse = exports.GetAccountsAccountIdTransactionsRequest = void 0;
...
var GetAccountsAccountIdTransactionsRequest = /** @class */ (function (_super) {
    ...
    ], GetAccountsAccountIdTransactionsRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[category]",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdTransactionsRequest.prototype, "filterCategory", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[since];dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], GetAccountsAccountIdTransactionsRequest.prototype, "filterSince", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[status]",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdTransactionsRequest.prototype, "filterStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[tag]",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdTransactionsRequest.prototype, "filterTag", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[until];dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], GetAccountsAccountIdTransactionsRequest.prototype, "filterUntil", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page[size]",
        }),
        __metadata("design:type", Number)
    ], GetAccountsAccountIdTransactionsRequest.prototype, "pageSize", void 0);
...
var GetAccountsAccountIdTransactionsResponse = /** @class */ (function (_super) {
    ...
    ], GetAccountsAccountIdTransactionsResponse.prototype, "rawResponse", void 0);
