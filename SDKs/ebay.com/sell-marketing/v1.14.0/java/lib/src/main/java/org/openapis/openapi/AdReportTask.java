...
public class AdReportTask {
     ...
     */
    public org.openapis.openapi.models.operations.CreateReportTaskResponse createReportTask(org.openapis.openapi.models.operations.CreateReportTaskRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.CreateReportTaskResponse res = new org.openapis.openapi.models.operations.CreateReportTaskResponse() {{
        }};
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.DeleteReportTaskResponse deleteReportTask(org.openapis.openapi.models.operations.DeleteReportTaskRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.DeleteReportTaskPathParams.class, baseUrl, "/ad_report_task/{report_task_id}", request.pathParams, null);
        ...
        org.openapis.openapi.models.operations.DeleteReportTaskResponse res = new org.openapis.openapi.models.operations.DeleteReportTaskResponse() {{
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
        res.rawResponse = httpRes;
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.GetReportTaskResponse getReportTask(org.openapis.openapi.models.operations.GetReportTaskRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetReportTaskPathParams.class, baseUrl, "/ad_report_task/{report_task_id}", request.pathParams, null);
        ...
        org.openapis.openapi.models.operations.GetReportTaskResponse res = new org.openapis.openapi.models.operations.GetReportTaskResponse() {{
            reportTask = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.GetReportTasksResponse getReportTasks(org.openapis.openapi.models.operations.GetReportTasksRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/ad_report_task");
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetReportTasksQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
        ...
        org.openapis.openapi.models.operations.GetReportTasksResponse res = new org.openapis.openapi.models.operations.GetReportTasksResponse() {{
