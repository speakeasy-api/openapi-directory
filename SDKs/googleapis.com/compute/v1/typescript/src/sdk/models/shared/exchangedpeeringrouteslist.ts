 ...
 */
export enum ExchangedPeeringRoutesListWarningCodeEnum {
...
export class ExchangedPeeringRoutesListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ExchangedPeeringRoutesListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: ExchangedPeeringRoutesListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class ExchangedPeeringRoutesList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: ExchangedPeeringRoute })
  @Expose({ name: "items" })
