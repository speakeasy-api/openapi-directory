...
public class PostOrganisationsPartyIdElectronicAddressesRequest {
    ...
    public PostOrganisationsPartyIdElectronicAddressesRequest(@JsonProperty("apiKey") String apiKey, @JsonProperty("electronic-addressInput") org.openapis.openapi.models.shared.ElectronicAddressInput electronicAddressInput, @JsonProperty("partyId") String partyId) {
        this.apiKey = apiKey;
        this.electronicAddressInput = electronicAddressInput;
        this.partyId = partyId;
  }
