...
class UpdateDynamicThingGroupRequestBody:
    thing_group_properties: UpdateDynamicThingGroupRequestBodyThingGroupProperties = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('thingGroupProperties') }})
...
class UpdateDynamicThingGroupRequest:
    headers: UpdateDynamicThingGroupHeaders = dataclasses.field()
    path_params: UpdateDynamicThingGroupPathParams = dataclasses.field()
    request: UpdateDynamicThingGroupRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
