...
from ..shared import supplierparty as shared_supplierparty
...
class AccountingSupplierParty:
    ...
    party: Optional[shared_supplierparty.SupplierParty] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('party') }})
