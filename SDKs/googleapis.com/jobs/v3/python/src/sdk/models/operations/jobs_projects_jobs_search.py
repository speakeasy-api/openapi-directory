...
class JobsProjectsJobsSearchSecurity:
    option1: Optional[JobsProjectsJobsSearchSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[JobsProjectsJobsSearchSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class JobsProjectsJobsSearchRequest:
    path_params: JobsProjectsJobsSearchPathParams = dataclasses.field()
    query_params: JobsProjectsJobsSearchQueryParams = dataclasses.field()
    security: JobsProjectsJobsSearchSecurity = dataclasses.field()
