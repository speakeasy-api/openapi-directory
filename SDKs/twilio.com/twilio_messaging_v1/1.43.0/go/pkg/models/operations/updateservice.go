...
func (e UpdateServiceUpdateServiceRequestFallbackMethodEnum) ToPointer() *UpdateServiceUpdateServiceRequestFallbackMethodEnum {
	return &e
}
...
func (e *UpdateServiceUpdateServiceRequestFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateServiceUpdateServiceRequestFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateServiceUpdateServiceRequestFallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateServiceUpdateServiceRequestInboundMethodEnum) ToPointer() *UpdateServiceUpdateServiceRequestInboundMethodEnum {
	return &e
}
...
func (e *UpdateServiceUpdateServiceRequestInboundMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateServiceUpdateServiceRequestInboundMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateServiceUpdateServiceRequestInboundMethodEnum: %v", v)
	}
}
