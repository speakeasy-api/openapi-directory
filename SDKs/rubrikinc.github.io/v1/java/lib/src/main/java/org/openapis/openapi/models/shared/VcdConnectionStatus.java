...
public class VcdConnectionStatus {
    ...
    public VcdConnectionStatus withMessage(String message) {
    ...
    public VcdConnectionStatus withStatus(RefreshableObjectConnectionStatusTypeEnum status) {
        this.status = status;
        return this;
    }
    
    public VcdConnectionStatus(@JsonProperty("status") RefreshableObjectConnectionStatusTypeEnum status) {
        this.status = status;
  }
}
