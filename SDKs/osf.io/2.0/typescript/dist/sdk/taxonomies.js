...
var Taxonomies = /** @class */ (function () {
    function Taxonomies(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Taxonomies.prototype.taxonomiesList = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/taxonomies/";
    ...
    **/
    Taxonomies.prototype.taxonomiesRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TaxonomiesReadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/taxonomies/{taxonomy_id}/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
