...
public class ServicenetworkingServicesEnableVpcServiceControlsPathParams {
    /**
    ...
    public ServicenetworkingServicesEnableVpcServiceControlsPathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
