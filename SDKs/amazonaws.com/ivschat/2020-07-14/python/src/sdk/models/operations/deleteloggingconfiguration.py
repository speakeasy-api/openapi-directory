...
class DeleteLoggingConfigurationRequestBody:
    ...
    r"""Identifier of the logging configuration to be deleted."""  
    

@dataclasses.dataclass
class DeleteLoggingConfigurationRequest:
    
    request_body: DeleteLoggingConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
