...
class JoinStorageSessionRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the signaling channel."""  
    

@dataclasses.dataclass
class JoinStorageSessionRequest:
    
    request_body: JoinStorageSessionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
