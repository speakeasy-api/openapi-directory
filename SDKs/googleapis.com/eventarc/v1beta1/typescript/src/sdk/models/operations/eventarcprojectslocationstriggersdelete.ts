...
export class EventarcProjectsLocationsTriggersDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class EventarcProjectsLocationsTriggersDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class EventarcProjectsLocationsTriggersDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
