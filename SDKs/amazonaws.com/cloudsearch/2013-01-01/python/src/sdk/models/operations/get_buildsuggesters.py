...
class GetBuildSuggestersQueryParams:
    action: GetBuildSuggestersActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    domain_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'DomainName', 'style': 'form', 'explode': True }})
    version: GetBuildSuggestersVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetBuildSuggestersRequest:
    headers: GetBuildSuggestersHeaders = dataclasses.field()
    query_params: GetBuildSuggestersQueryParams = dataclasses.field()
