...
class FilerResources:
    ...
    def get_rad_analyst_(self, request: operations.GetRadAnalystRequest) -> operations.GetRadAnalystResponse:
        r"""Use this endpoint to look up the RAD Analyst for a committee.
        ...
        query_params = utils.get_query_params(operations.GetRadAnalystRequest, request)
        ...
        res = operations.GetRadAnalystResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if True:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.RadAnalystPage])
    ...
    def get_state_election_office_(self, request: operations.GetStateElectionOfficeRequest) -> operations.GetStateElectionOfficeResponse:
        r"""State laws and procedures govern elections for state or local offices as well as
        ...
        query_params = utils.get_query_params(operations.GetStateElectionOfficeRequest, request)
        ...
        res = operations.GetStateElectionOfficeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if True:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StateElectionOfficeInfoPage])
