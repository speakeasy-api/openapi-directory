 ...
 */
public enum ReposUpdateInformationAboutPagesSiteRequestBody3BuildTypeEnum {
    LEGACY("legacy"),
    WORKFLOW("workflow");
    ...
    private ReposUpdateInformationAboutPagesSiteRequestBody3BuildTypeEnum(String value) {
        this.value = value;
    }
}
