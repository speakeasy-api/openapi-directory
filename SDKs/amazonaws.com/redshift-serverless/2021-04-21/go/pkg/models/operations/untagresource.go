...
const (
	UntagResourceXAmzTargetEnumRedshiftServerlessUntagResource UntagResourceXAmzTargetEnum = "RedshiftServerless.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "RedshiftServerless.UntagResource":
