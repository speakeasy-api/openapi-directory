...
var Families = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "babysitting" }),
        __metadata("design:type", Boolean)
    ], Families.prototype, "babysitting", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "babysittingException" }),
        __metadata("design:type", String)
    ], Families.prototype, "babysittingException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kidsActivities" }),
        __metadata("design:type", Boolean)
    ], Families.prototype, "kidsActivities", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kidsActivitiesException" }),
        __metadata("design:type", String)
    ], Families.prototype, "kidsActivitiesException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kidsClub" }),
        __metadata("design:type", Boolean)
    ], Families.prototype, "kidsClub", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kidsClubException" }),
        __metadata("design:type", String)
