...
class ListVcenterManagersQueryParams:
...
@dataclasses.dataclass
class ListVcenterManagersSecurity:
    api_key_auth: shared_security.SchemeAPIKeyAuth = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class ListVcenterManagersRequest:
    query_params: ListVcenterManagersQueryParams = dataclasses.field()
    security: ListVcenterManagersSecurity = dataclasses.field()
    

@dataclasses.dataclass
class ListVcenterManagersResponse:
