...
exports.GroupsSettingsGroupsGetResponse = exports.GroupsSettingsGroupsGetRequest = exports.GroupsSettingsGroupsGetSecurity = void 0;
...
var GroupsSettingsGroupsGetRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GroupsSettingsGroupsGetRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], GroupsSettingsGroupsGetRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=groupUniqueId",
        }),
        __metadata("design:type", String)
    ], GroupsSettingsGroupsGetRequest.prototype, "groupUniqueId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], GroupsSettingsGroupsGetRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], GroupsSettingsGroupsGetRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], GroupsSettingsGroupsGetRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], GroupsSettingsGroupsGetRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], GroupsSettingsGroupsGetRequest.prototype, "userIp", void 0);
...
var GroupsSettingsGroupsGetResponse = /** @class */ (function (_super) {
    ...
    ], GroupsSettingsGroupsGetResponse.prototype, "rawResponse", void 0);
