...
func (e *GetOrganizationUplinksStatuses200ApplicationJSONUplinksInterfaceEnum) UnmarshalJSON(data []byte) error {
	...
	case "wan1":
		fallthrough
	case "wan2":
		*e = GetOrganizationUplinksStatuses200ApplicationJSONUplinksInterfaceEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationUplinksStatuses200ApplicationJSONUplinksInterfaceEnum: %s", s)
	}
}
...
func (e *GetOrganizationUplinksStatuses200ApplicationJSONUplinksStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "not connected":
		fallthrough
	case "ready":
		*e = GetOrganizationUplinksStatuses200ApplicationJSONUplinksStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationUplinksStatuses200ApplicationJSONUplinksStatusEnum: %s", s)
	}
}
