...
public class WorkTypeApiNewJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public WorkTypeApiNewJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public WorkTypeApiNewJsonHeaders withXAuthSecret(String xAuthSecret) {
