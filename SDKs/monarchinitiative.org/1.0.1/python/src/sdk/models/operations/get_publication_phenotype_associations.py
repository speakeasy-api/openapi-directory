...
class GetPublicationPhenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPublicationPhenotypeAssociationsQueryParams:
...
@dataclasses.dataclass
class GetPublicationPhenotypeAssociationsRequest:
    path_params: GetPublicationPhenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetPublicationPhenotypeAssociationsQueryParams = dataclasses.field()
