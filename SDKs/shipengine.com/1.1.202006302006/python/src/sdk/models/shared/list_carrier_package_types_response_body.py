...
class ListCarrierPackageTypesResponseBodyPackageType:
    r"""ListCarrierPackageTypesResponseBodyPackageType
...
class ListCarrierPackageTypesResponseBody:
    r"""ListCarrierPackageTypesResponseBody
    A list carrier package types response body
    """
    
    packages: Optional[list[ListCarrierPackageTypesResponseBodyPackageType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('packages') }})
