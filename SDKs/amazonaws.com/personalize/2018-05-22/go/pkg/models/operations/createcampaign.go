...
func (e CreateCampaignXAmzTargetEnum) ToPointer() *CreateCampaignXAmzTargetEnum {
	return &e
}
...
func (e *CreateCampaignXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonPersonalize.CreateCampaign":
		*e = CreateCampaignXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCampaignXAmzTargetEnum: %v", v)
	}
}
