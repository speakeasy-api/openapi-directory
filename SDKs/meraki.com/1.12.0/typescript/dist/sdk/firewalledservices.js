...
exports.FirewalledServices = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var FirewalledServices = /** @class */ (function () {
    function FirewalledServices(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    FirewalledServices.prototype.getNetworkApplianceFirewallFirewalledService = function (req, config) {
    ...
    **/
    FirewalledServices.prototype.getNetworkApplianceFirewallFirewalledServices = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    FirewalledServices.prototype.updateNetworkApplianceFirewallFirewalledService = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.FirewalledServices = FirewalledServices;
