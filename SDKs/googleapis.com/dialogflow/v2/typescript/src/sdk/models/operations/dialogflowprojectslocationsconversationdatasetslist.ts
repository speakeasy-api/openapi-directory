...
export class DialogflowProjectsLocationsConversationDatasetsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsConversationDatasetsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class DialogflowProjectsLocationsConversationDatasetsListSecurity extends SpeakeasyBase {
...
export class DialogflowProjectsLocationsConversationDatasetsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsConversationDatasetsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
