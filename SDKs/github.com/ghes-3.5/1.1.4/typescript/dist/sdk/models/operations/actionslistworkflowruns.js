...
exports.ActionsListWorkflowRunsResponse = exports.ActionsListWorkflowRuns200ApplicationJSON = exports.ActionsListWorkflowRunsRequest = void 0;
...
var ActionsListWorkflowRunsRequest = /** @class */ (function (_super) {
    ...
    ], ActionsListWorkflowRunsRequest.prototype, "actor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=branch",
        }),
        __metadata("design:type", String)
    ], ActionsListWorkflowRunsRequest.prototype, "branch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=check_suite_id",
        }),
        __metadata("design:type", Number)
    ], ActionsListWorkflowRunsRequest.prototype, "checkSuiteId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=created;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ActionsListWorkflowRunsRequest.prototype, "created", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=event" }),
        __metadata("design:type", String)
    ], ActionsListWorkflowRunsRequest.prototype, "event", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=exclude_pull_requests",
        }),
        __metadata("design:type", Boolean)
    ], ActionsListWorkflowRunsRequest.prototype, "excludePullRequests", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=owner",
        }),
        __metadata("design:type", String)
    ], ActionsListWorkflowRunsRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], ActionsListWorkflowRunsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], ActionsListWorkflowRunsRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], ActionsListWorkflowRunsRequest.prototype, "repo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], ActionsListWorkflowRunsRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workflow_id",
        }),
        __metadata("design:type", Object)
    ], ActionsListWorkflowRunsRequest.prototype, "workflowId", void 0);
...
var ActionsListWorkflowRuns200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.WorkflowRun }),
        (0, class_transformer_1.Expose)({ name: "workflow_runs" }),
        (0, class_transformer_1.Type)(function () { return shared.WorkflowRun; }),
...
var ActionsListWorkflowRunsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ActionsListWorkflowRunsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
