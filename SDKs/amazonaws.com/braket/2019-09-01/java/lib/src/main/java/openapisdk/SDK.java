...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.CancelQuantumTaskResponse cancelQuantumTask(openapisdk.models.operations.CancelQuantumTaskRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/quantum-task/{quantumTaskArn}/cancel", request.pathParams);
        ...
        openapisdk.models.operations.CancelQuantumTaskResponse res = new openapisdk.models.operations.CancelQuantumTaskResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.CancelQuantumTaskResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CancelQuantumTaskResponse.class);
    ...
    **/
    public openapisdk.models.operations.CreateQuantumTaskResponse createQuantumTask(openapisdk.models.operations.CreateQuantumTaskRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/quantum-task");
        ...
        openapisdk.models.operations.CreateQuantumTaskResponse res = new openapisdk.models.operations.CreateQuantumTaskResponse() {{
        ...
        if (httpRes.statusCode() == 201) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.CreateQuantumTaskResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateQuantumTaskResponse.class);
    ...
    **/
    public openapisdk.models.operations.GetDeviceResponse getDevice(openapisdk.models.operations.GetDeviceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/device/{deviceArn}", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.GetQuantumTaskResponse getQuantumTask(openapisdk.models.operations.GetQuantumTaskRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/quantum-task/{quantumTaskArn}", request.pathParams);
        ...
        openapisdk.models.operations.GetQuantumTaskResponse res = new openapisdk.models.operations.GetQuantumTaskResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GetQuantumTaskResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetQuantumTaskResponse.class);
    ...
    public openapisdk.models.operations.SearchDevicesResponse searchDevices(openapisdk.models.operations.SearchDevicesRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.SearchDevicesResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.SearchDevicesResponse.class);
    ...
    **/
    public openapisdk.models.operations.SearchQuantumTasksResponse searchQuantumTasks(openapisdk.models.operations.SearchQuantumTasksRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/quantum-tasks");
        ...
        openapisdk.models.operations.SearchQuantumTasksResponse res = new openapisdk.models.operations.SearchQuantumTasksResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.SearchQuantumTasksResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.SearchQuantumTasksResponse.class);
