 ...
 */
export enum ReservationListWarningCodeEnum {
...
export class ReservationListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ReservationListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: ReservationListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class ReservationList extends SpeakeasyBase {
  /**
