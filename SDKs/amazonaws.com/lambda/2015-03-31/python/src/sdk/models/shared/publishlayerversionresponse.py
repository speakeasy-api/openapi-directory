...
class PublishLayerVersionResponse:
    ...
    content: Optional[shared_layerversioncontentoutput.LayerVersionContentOutput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Content'), 'exclude': lambda f: f is None }})  
