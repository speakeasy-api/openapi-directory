 ...
 */
export declare enum GetNetworkClientsLatencyStatsBandEnum {
    Two4 = "2.4",
    Five = "5"
}
export declare class GetNetworkClientsLatencyStatsRequest extends SpeakeasyBase {
    /**
     ...
     * Filter results by band (either '2.4' or '5'). Note that data prior to February 2020 will not have band information.
     */
    band?: GetNetworkClientsLatencyStatsBandEnum;
    /**
...
export declare class GetNetworkClientsLatencyStatsResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
     ...
     */
    getNetworkClientsLatencyStats200ApplicationJSONObjects?: Record<string, any>[];
}
