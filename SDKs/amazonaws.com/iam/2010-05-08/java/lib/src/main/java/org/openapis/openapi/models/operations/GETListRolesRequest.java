...
public class GETListRolesRequest {
    ...
    public GETListRolesRequest withAction(GETListRolesActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETListRolesRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public GETListRolesRequest withMaxItems(Long maxItems) {
    ...
    public GETListRolesRequest withPathPrefix(String pathPrefix) {
    ...
    public GETListRolesRequest withVersion(GETListRolesVersionEnum version) {
    ...
    public GETListRolesRequest withXAmzAlgorithm(String xAmzAlgorithm) {
    ...
    public GETListRolesRequest withXAmzContentSha256(String xAmzContentSha256) {
    ...
    public GETListRolesRequest withXAmzCredential(String xAmzCredential) {
    ...
    public GETListRolesRequest withXAmzDate(String xAmzDate) {
    ...
    public GETListRolesRequest withXAmzSecurityToken(String xAmzSecurityToken) {
    ...
    public GETListRolesRequest withXAmzSignature(String xAmzSignature) {
    ...
    public GETListRolesRequest withXAmzSignedHeaders(String xAmzSignedHeaders) {
        this.xAmzSignedHeaders = xAmzSignedHeaders;
        return this;
    }
    
    public GETListRolesRequest(@JsonProperty("Action") GETListRolesActionEnum action, @JsonProperty("Version") GETListRolesVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
