...
class AddIPRoutesRequest:
    ...
    add_ip_routes_request: shared_addiproutesrequest.AddIPRoutesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class AddIPRoutesResponse:
    ...
    r"""IpRouteLimitExceededException"""  
