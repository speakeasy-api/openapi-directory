...
use \OpenAPI\OpenAPI\Models\Shared\XgafvEnum;
use \OpenAPI\OpenAPI\Models\Shared\AnalyzePackagesRequest;
...
try {
    ...
    $request->dollarXgafv = XgafvEnum::ONE;
    $request->analyzePackagesRequest = new AnalyzePackagesRequest();
    $request->analyzePackagesRequest->packages = [
        new PackageData(),
        new PackageData(),
        new PackageData(),
        new PackageData(),
    ];
    $request->analyzePackagesRequest->resourceUri = 'enim';
...
try {
    ...
    if ($response->listVulnerabilitiesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
