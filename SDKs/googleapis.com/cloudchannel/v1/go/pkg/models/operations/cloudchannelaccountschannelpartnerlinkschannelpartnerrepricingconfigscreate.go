...
type CloudchannelAccountsChannelPartnerLinksChannelPartnerRepricingConfigsCreateRequest struct {
	...
	GoogleCloudChannelV1ChannelPartnerRepricingConfigInput *shared.GoogleCloudChannelV1ChannelPartnerRepricingConfigInput `request:"mediaType=application/json"`
	// OAuth access token.
