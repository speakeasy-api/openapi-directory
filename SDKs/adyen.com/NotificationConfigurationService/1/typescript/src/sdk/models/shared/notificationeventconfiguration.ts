 ...
 */
export enum NotificationEventConfigurationEventTypeEnum {
 ...
 */
export enum NotificationEventConfigurationIncludeModeEnum {
  Exclude = "EXCLUDE",
  Include = "INCLUDE",
}

export class NotificationEventConfiguration extends SpeakeasyBase {
  /**
   * The type of event.
   *
   * @remarks
