...
var as2incomingmessages_1 = require("./as2incomingmessages");
var as2outgoingmessages_1 = require("./as2outgoingmessages");
var as2partners_1 = require("./as2partners");
var as2stations_1 = require("./as2stations");
var automationruns_1 = require("./automationruns");
...
var bundlenotifications_1 = require("./bundlenotifications");
...
var remotebandwidthsnapshots_1 = require("./remotebandwidthsnapshots");
var remoteservers_1 = require("./remoteservers");
var requests_1 = require("./requests");
var sessions_1 = require("./sessions");
var settingschanges_1 = require("./settingschanges");
var sftphostkeys_1 = require("./sftphostkeys");
 ...
 */
exports.ServerList = ["//app.files.com/api/rest/v1"];
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.as2IncomingMessages = new as2incomingmessages_1.As2IncomingMessages(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.as2OutgoingMessages = new as2outgoingmessages_1.As2OutgoingMessages(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.as2Partners = new as2partners_1.As2Partners(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.as2Stations = new as2stations_1.As2Stations(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.automationRuns = new automationruns_1.AutomationRuns(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.bundleNotifications = new bundlenotifications_1.BundleNotifications(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.remoteBandwidthSnapshots = new remotebandwidthsnapshots_1.RemoteBandwidthSnapshots(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.sftpHostKeys = new sftphostkeys_1.SftpHostKeys(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
