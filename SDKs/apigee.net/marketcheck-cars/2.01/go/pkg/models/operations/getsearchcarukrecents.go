...
type GetSearchCarUkRecentsQueryParams struct {
...
type GetSearchCarUkRecentsRequest struct {
	QueryParams GetSearchCarUkRecentsQueryParams
}

type GetSearchCarUkRecentsResponse struct {
	ContentType string
	// Error
	Error       *shared.Error
	StatusCode  int
