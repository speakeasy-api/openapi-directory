...
class ListRoomParticipantSubscribedTrackRequest:
    ...
    r"""The SID of the participant that subscribes to the Track resources to read."""  
    room_sid: str = dataclasses.field(metadata={'path_param': { 'field_name': 'RoomSid', 'style': 'simple', 'explode': False }})
    r"""The SID of the Room resource with the Track resources to read."""  
...
class ListRoomParticipantSubscribedTrackListRoomParticipantSubscribedTrackResponse:
    ...
    meta: Optional[ListRoomParticipantSubscribedTrackListRoomParticipantSubscribedTrackResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    subscribed_tracks: Optional[list[shared_video_v1_room_room_participant_room_participant_subscribed_track.VideoV1RoomRoomParticipantRoomParticipantSubscribedTrack]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('subscribed_tracks'), 'exclude': lambda f: f is None }})  
