...
class ResellerSubscriptionsDeleteQueryParams:
    deletion_type: ResellerSubscriptionsDeleteDeletionTypeEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'deletionType', 'style': 'form', 'explode': True }})
...
class ResellerSubscriptionsDeleteRequest:
    path_params: ResellerSubscriptionsDeletePathParams = dataclasses.field()
    query_params: ResellerSubscriptionsDeleteQueryParams = dataclasses.field()
    security: ResellerSubscriptionsDeleteSecurity = dataclasses.field()
