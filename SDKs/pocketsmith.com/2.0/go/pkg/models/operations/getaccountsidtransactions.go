...
func (e GetAccountsIDTransactionsTypeEnum) ToPointer() *GetAccountsIDTransactionsTypeEnum {
	return &e
}
...
func (e *GetAccountsIDTransactionsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "debit":
		fallthrough
	case "credit":
		*e = GetAccountsIDTransactionsTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetAccountsIDTransactionsTypeEnum: %v", v)
	}
}
