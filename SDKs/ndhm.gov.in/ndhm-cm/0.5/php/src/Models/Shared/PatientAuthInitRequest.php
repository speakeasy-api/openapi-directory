...
class PatientAuthInitRequest
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PatientAuthInitRequestQuery')]
	...
	{
		$this->query = new \OpenAPI\OpenAPI\Models\Shared\PatientAuthInitRequestQuery();
		$this->requestId = "";
