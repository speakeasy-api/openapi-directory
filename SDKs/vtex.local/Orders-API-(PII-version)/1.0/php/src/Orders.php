...
class Orders 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CancelOrder2Request $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CancelOrder2Response
     */
	public function cancelOrder2(
        \OpenAPI\OpenAPI\Models\Operations\CancelOrder2Request $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CancelOrder2Response
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/api/orders/pvt/document/{orderId}/cancel', \OpenAPI\OpenAPI\Models\Operations\CancelOrder2Request::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CancelOrder2Response();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->cancelOrder2200ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\CancelOrder2200ApplicationJSON', 'json');
            }
        }
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetOrder2Request $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetOrder2Response
     */
	public function getOrder2(
        \OpenAPI\OpenAPI\Models\Operations\GetOrder2Request $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetOrder2Response
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/api/orders/pvt/document/{orderId}', \OpenAPI\OpenAPI\Models\Operations\GetOrder2Request::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\GetOrder2Request::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetOrder2Response();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getOrder2200ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\GetOrder2200ApplicationJSON', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListOrders2Request $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListOrders2Response
     */
	public function listOrders2(
        \OpenAPI\OpenAPI\Models\Operations\ListOrders2Request $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListOrders2Response
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/api/orders/extendsearch/orders');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "requestBody", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ListOrders2Request::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListOrders2Response();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StartHandling2Request $request
     * @return \OpenAPI\OpenAPI\Models\Operations\StartHandling2Response
     */
	public function startHandling2(
        \OpenAPI\OpenAPI\Models\Operations\StartHandling2Request $request,
    ): \OpenAPI\OpenAPI\Models\Operations\StartHandling2Response
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/api/orders/pvt/document/{orderId}/actions/start-handling', \OpenAPI\OpenAPI\Models\Operations\StartHandling2Request::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StartHandling2Response();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
