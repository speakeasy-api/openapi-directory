...
class Me:
    ...
    def me_get_me(self) -> operations.MeGetMeResponse:
        ...
        res = operations.MeGetMeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def me_get_me_plan(self) -> operations.MeGetMePlanResponse:
        ...
        res = operations.MeGetMePlanResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
