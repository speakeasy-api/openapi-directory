 ...
 */
export declare enum ExportImageRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class ExportImageRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class ExportImageRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: ExportImageRequestTagSpecificationsResourceTypeEnum;
    tags?: ExportImageRequestTagSpecificationsTags[];
}
export declare class ExportImageRequest extends SpeakeasyBase {
    clientToken?: string;
    description?: string;
