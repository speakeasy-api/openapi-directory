...
exports.CreateDataflowEndpointGroupResponse = exports.CreateDataflowEndpointGroupRequest = exports.CreateDataflowEndpointGroupRequestBody = void 0;
...
var CreateDataflowEndpointGroupRequestBody = /** @class */ (function (_super) {
    ...
    ], CreateDataflowEndpointGroupRequestBody.prototype, "contactPostPassDurationSeconds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "contactPrePassDurationSeconds" }),
        __metadata("design:type", Number)
    ], CreateDataflowEndpointGroupRequestBody.prototype, "contactPrePassDurationSeconds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.EndpointDetails }),
        (0, class_transformer_1.Expose)({ name: "endpointDetails" }),
        (0, class_transformer_1.Type)(function () { return shared.EndpointDetails; }),
...
exports.CreateDataflowEndpointGroupRequestBody = CreateDataflowEndpointGroupRequestBody;
var CreateDataflowEndpointGroupRequest = /** @class */ (function (_super) {
    ...
    ], CreateDataflowEndpointGroupRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], CreateDataflowEndpointGroupRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreateDataflowEndpointGroupRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreateDataflowEndpointGroupRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreateDataflowEndpointGroupRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreateDataflowEndpointGroupRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreateDataflowEndpointGroupRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreateDataflowEndpointGroupRequest.prototype, "xAmzSignedHeaders", void 0);
...
var CreateDataflowEndpointGroupResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreateDataflowEndpointGroupResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.CreateDataflowEndpointGroupResponse = CreateDataflowEndpointGroupResponse;
