...
class GooglePlayDeveloperReportingV1alpha1FreshnessInfoFreshness:
    ...
    aggregation_period: Optional[GooglePlayDeveloperReportingV1alpha1FreshnessInfoFreshnessAggregationPeriodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('aggregationPeriod'), 'exclude': lambda f: f is None }})
    r"""Aggregation period for which data is available."""  
