...
export class FirebaseappdistributionProjectsAppsReleasesBatchDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseappdistributionProjectsAppsReleasesBatchDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseappdistributionProjectsAppsReleasesBatchDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
