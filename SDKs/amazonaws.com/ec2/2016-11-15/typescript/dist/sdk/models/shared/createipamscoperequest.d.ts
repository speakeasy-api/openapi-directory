 ...
 */
export declare enum CreateIpamScopeRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateIpamScopeRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateIpamScopeRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: CreateIpamScopeRequestTagSpecificationsResourceTypeEnum;
    tags?: CreateIpamScopeRequestTagSpecificationsTags[];
}
export declare class CreateIpamScopeRequest extends SpeakeasyBase {
    clientToken?: string;
    description?: string;
    dryRun?: boolean;
    ipamId: string;
