...
public class ListServiceListServiceResponse {
    ...
    public openapisdk.models.shared.ConversationsV1Service[] services;
    public ListServiceListServiceResponse withServices(openapisdk.models.shared.ConversationsV1Service[] services) {
