...
type CreateInternationalStandingOrdersRawSecurity struct {
	PSUOAuth2Security shared.SchemePsuoAuth2Security `security:"scheme,type=oauth2"`
}

type CreateInternationalStandingOrdersRawHeaders struct {
...
type CreateInternationalStandingOrdersRawRequest struct {
	Headers CreateInternationalStandingOrdersRawHeaders
	// Default
	Request  []byte `request:"mediaType=application/jose+jwe"`
	Security CreateInternationalStandingOrdersRawSecurity
}

type CreateInternationalStandingOrdersRawResponse struct {
	Body        []byte
	ContentType string
