...
class RegistryTagAPISpecRevisionRequest:
    ...
    r"""The spec id."""  
    tag_api_spec_revision_request: shared_tagapispecrevisionrequest.TagAPISpecRevisionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
