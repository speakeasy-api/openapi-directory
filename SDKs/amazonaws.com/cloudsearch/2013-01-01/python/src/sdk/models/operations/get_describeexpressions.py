...
class GetDescribeExpressionsQueryParams:
    action: GetDescribeExpressionsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    domain_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'DomainName', 'style': 'form', 'explode': True }})
    version: GetDescribeExpressionsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    deployed: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'Deployed', 'style': 'form', 'explode': True }})
    expression_names: Optional[list[str]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'ExpressionNames', 'style': 'form', 'explode': True }})
...
class GetDescribeExpressionsRequest:
    headers: GetDescribeExpressionsHeaders = dataclasses.field()
    query_params: GetDescribeExpressionsQueryParams = dataclasses.field()
