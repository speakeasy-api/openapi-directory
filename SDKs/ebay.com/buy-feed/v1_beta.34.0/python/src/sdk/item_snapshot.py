...
class ItemSnapshot:
    ...
    def get_item_snapshot_feed(self, request: operations.GetItemSnapshotFeedRequest, security: operations.GetItemSnapshotFeedSecurity) -> operations.GetItemSnapshotFeedResponse:
        ...
        res = operations.GetItemSnapshotFeedResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code in [200, 206]:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ItemSnapshotResponse])
                res.item_snapshot_response = out
