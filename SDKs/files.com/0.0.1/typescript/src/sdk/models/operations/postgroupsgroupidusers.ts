 ...
 */
export enum PostGroupsGroupIdUsersRequestBodyAuthenticationMethodEnum {
  Password = "password",
...
export class PostGroupsGroupIdUsersRequestBodyAvatarFile extends SpeakeasyBase {
 ...
 */
export enum PostGroupsGroupIdUsersRequestBodyRequire2faEnum {
 ...
 */
export enum PostGroupsGroupIdUsersRequestBodySslRequiredEnum {
  UseSystemSetting = "use_system_setting",
  AlwaysRequire = "always_require",
  NeverRequire = "never_require",
}

export class PostGroupsGroupIdUsersRequestBody extends SpeakeasyBase {
  /**
...
export class PostGroupsGroupIdUsersRequest extends SpeakeasyBase {
...
export class PostGroupsGroupIdUsersResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
