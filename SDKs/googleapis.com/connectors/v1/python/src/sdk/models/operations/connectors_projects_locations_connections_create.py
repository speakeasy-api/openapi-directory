...
@dataclasses.dataclass
class ConnectorsProjectsLocationsConnectionsCreateQueryParams:
...
class ConnectorsProjectsLocationsConnectionsCreateRequest:
    path_params: ConnectorsProjectsLocationsConnectionsCreatePathParams = dataclasses.field()
    query_params: ConnectorsProjectsLocationsConnectionsCreateQueryParams = dataclasses.field()
    security: ConnectorsProjectsLocationsConnectionsCreateSecurity = dataclasses.field()
    request: Optional[shared_connection.ConnectionInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
