...
type PaymentsresellersubscriptionPartnersPromotionsFindEligibleRequest struct {
	...
	GoogleCloudPaymentsResellerSubscriptionV1FindEligiblePromotionsRequest *shared.GoogleCloudPaymentsResellerSubscriptionV1FindEligiblePromotionsRequest `request:"mediaType=application/json"`
	// OAuth access token.
