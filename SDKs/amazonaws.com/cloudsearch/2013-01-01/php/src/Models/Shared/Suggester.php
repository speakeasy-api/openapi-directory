...
class Suggester
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\DocumentSuggesterOptions $documentSuggesterOptions
     */
	...
	{
		$this->documentSuggesterOptions = new \OpenAPI\OpenAPI\Models\Shared\DocumentSuggesterOptions();
		$this->suggesterName = "";
	}
}
