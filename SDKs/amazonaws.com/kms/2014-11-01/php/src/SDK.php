...
class SDK
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CancelKeyDeletionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CancelKeyDeletionResponse
     */
	public function cancelKeyDeletion(
        \OpenAPI\OpenAPI\Models\Operations\CancelKeyDeletionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CancelKeyDeletionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.CancelKeyDeletion');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "cancelKeyDeletionRequest", "json");
        if ($body === null) {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CancelKeyDeletionResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->cancelKeyDeletionResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CancelKeyDeletionResponse', 'json');
            }
        }
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->dependencyTimeoutException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 483) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->kmsInternalException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ConnectCustomKeyStoreRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ConnectCustomKeyStoreResponse
     */
	public function connectCustomKeyStore(
        \OpenAPI\OpenAPI\Models\Operations\ConnectCustomKeyStoreRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ConnectCustomKeyStoreResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.ConnectCustomKeyStore');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "connectCustomKeyStoreRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ConnectCustomKeyStoreResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->connectCustomKeyStoreResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->cloudHsmClusterNotActiveException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 481) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->customKeyStoreInvalidStateException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 482) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->customKeyStoreNotFoundException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 483) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->cloudHsmClusterInvalidConfigurationException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.CreateAlias');
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->invalidAliasNameException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 484) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateCustomKeyStoreRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CreateCustomKeyStoreResponse
     */
	public function createCustomKeyStore(
        \OpenAPI\OpenAPI\Models\Operations\CreateCustomKeyStoreRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateCustomKeyStoreResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.CreateCustomKeyStore');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createCustomKeyStoreRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreateCustomKeyStoreResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createCustomKeyStoreResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateCustomKeyStoreResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->cloudHsmClusterInUseException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 481) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->customKeyStoreNameInUseException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 482) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->cloudHsmClusterNotFoundException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 483) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->incorrectTrustAnchorException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 486) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->xksProxyUriInUseException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 489) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->xksProxyUriEndpointInUseException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 490) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->xksProxyUriUnreachableException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 491) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->xksProxyIncorrectAuthenticationCredentialException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 492) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->xksProxyVpcEndpointServiceInUseException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 493) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->xksProxyVpcEndpointServiceNotFoundException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 494) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->xksProxyVpcEndpointServiceInvalidConfigurationException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 495) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->xksProxyInvalidResponseException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 496) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->xksProxyInvalidConfigurationException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.CreateGrant');
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->disabledException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 482) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->invalidGrantTokenException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 486) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.CreateKey');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createKeyRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->tagException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 487) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->xksKeyInvalidConfigurationException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 491) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->xksKeyAlreadyInUseException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 492) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->xksKeyNotFoundException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DecryptRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DecryptResponse
     */
	public function decrypt(
        \OpenAPI\OpenAPI\Models\Operations\DecryptRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DecryptResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.Decrypt');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DecryptResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->invalidCiphertextException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 483) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->keyUnavailableException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 484) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->incorrectKeyException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 485) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->invalidKeyUsageException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 486) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.DeleteAlias');
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteCustomKeyStoreRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeleteCustomKeyStoreResponse
     */
	public function deleteCustomKeyStore(
        \OpenAPI\OpenAPI\Models\Operations\DeleteCustomKeyStoreRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteCustomKeyStoreResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.DeleteCustomKeyStore');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteCustomKeyStoreRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeleteCustomKeyStoreResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->deleteCustomKeyStoreResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->customKeyStoreHasCMKsException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 481) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteImportedKeyMaterialRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeleteImportedKeyMaterialResponse
     */
	public function deleteImportedKeyMaterial(
        \OpenAPI\OpenAPI\Models\Operations\DeleteImportedKeyMaterialRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteImportedKeyMaterialResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.DeleteImportedKeyMaterial');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteImportedKeyMaterialRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeleteImportedKeyMaterialResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeCustomKeyStoresRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeCustomKeyStoresResponse
     */
	public function describeCustomKeyStores(
        \OpenAPI\OpenAPI\Models\Operations\DescribeCustomKeyStoresRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeCustomKeyStoresResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.DescribeCustomKeyStores');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeCustomKeyStoresRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeCustomKeyStoresRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeCustomKeyStoresResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeCustomKeyStoresResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeCustomKeyStoresResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->invalidMarkerException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 482) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.DescribeKey');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeKeyRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DisableKeyRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DisableKeyResponse
     */
	public function disableKey(
        \OpenAPI\OpenAPI\Models\Operations\DisableKeyRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DisableKeyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.DisableKey');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "disableKeyRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DisableKeyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DisableKeyRotationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DisableKeyRotationResponse
     */
	public function disableKeyRotation(
        \OpenAPI\OpenAPI\Models\Operations\DisableKeyRotationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DisableKeyRotationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.DisableKeyRotation');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "disableKeyRotationRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DisableKeyRotationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DisconnectCustomKeyStoreRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DisconnectCustomKeyStoreResponse
     */
	public function disconnectCustomKeyStore(
        \OpenAPI\OpenAPI\Models\Operations\DisconnectCustomKeyStoreRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DisconnectCustomKeyStoreResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.DisconnectCustomKeyStore');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "disconnectCustomKeyStoreRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DisconnectCustomKeyStoreResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->disconnectCustomKeyStoreResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\EnableKeyRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\EnableKeyResponse
     */
	public function enableKey(
        \OpenAPI\OpenAPI\Models\Operations\EnableKeyRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\EnableKeyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.EnableKey');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "enableKeyRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\EnableKeyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\EnableKeyRotationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\EnableKeyRotationResponse
     */
	public function enableKeyRotation(
        \OpenAPI\OpenAPI\Models\Operations\EnableKeyRotationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\EnableKeyRotationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.EnableKeyRotation');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "enableKeyRotationRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\EnableKeyRotationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\EncryptRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\EncryptResponse
     */
	public function encrypt(
        \OpenAPI\OpenAPI\Models\Operations\EncryptRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\EncryptResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.Encrypt');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\EncryptResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyResponse
     */
	public function generateDataKey(
        \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.GenerateDataKey');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "generateDataKeyRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->generateDataKeyResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GenerateDataKeyResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairResponse
     */
	public function generateDataKeyPair(
        \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.GenerateDataKeyPair');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "generateDataKeyPairRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->generateDataKeyPairResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GenerateDataKeyPairResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairWithoutPlaintextRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairWithoutPlaintextResponse
     */
	public function generateDataKeyPairWithoutPlaintext(
        \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairWithoutPlaintextRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairWithoutPlaintextResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.GenerateDataKeyPairWithoutPlaintext');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "generateDataKeyPairWithoutPlaintextRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyPairWithoutPlaintextResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->generateDataKeyPairWithoutPlaintextResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GenerateDataKeyPairWithoutPlaintextResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyWithoutPlaintextRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyWithoutPlaintextResponse
     */
	public function generateDataKeyWithoutPlaintext(
        \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyWithoutPlaintextRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyWithoutPlaintextResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.GenerateDataKeyWithoutPlaintext');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "generateDataKeyWithoutPlaintextRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GenerateDataKeyWithoutPlaintextResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->generateDataKeyWithoutPlaintextResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GenerateDataKeyWithoutPlaintextResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GenerateMacRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GenerateMacResponse
     */
	public function generateMac(
        \OpenAPI\OpenAPI\Models\Operations\GenerateMacRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GenerateMacResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.GenerateMac');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "generateMacRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GenerateMacResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->generateMacResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GenerateMacResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GenerateRandomRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GenerateRandomResponse
     */
	public function generateRandom(
        \OpenAPI\OpenAPI\Models\Operations\GenerateRandomRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GenerateRandomResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.GenerateRandom');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "generateRandomRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GenerateRandomResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->generateRandomResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GenerateRandomResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetKeyPolicyRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetKeyPolicyResponse
     */
	public function getKeyPolicy(
        \OpenAPI\OpenAPI\Models\Operations\GetKeyPolicyRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetKeyPolicyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.GetKeyPolicy');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "getKeyPolicyRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetKeyPolicyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getKeyPolicyResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetKeyPolicyResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetKeyRotationStatusRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetKeyRotationStatusResponse
     */
	public function getKeyRotationStatus(
        \OpenAPI\OpenAPI\Models\Operations\GetKeyRotationStatusRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetKeyRotationStatusResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.GetKeyRotationStatus');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "getKeyRotationStatusRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetKeyRotationStatusResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getKeyRotationStatusResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetKeyRotationStatusResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetParametersForImportRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetParametersForImportResponse
     */
	public function getParametersForImport(
        \OpenAPI\OpenAPI\Models\Operations\GetParametersForImportRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetParametersForImportResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.GetParametersForImport');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "getParametersForImportRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetParametersForImportResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getParametersForImportResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetParametersForImportResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetPublicKeyRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetPublicKeyResponse
     */
	public function getPublicKey(
        \OpenAPI\OpenAPI\Models\Operations\GetPublicKeyRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetPublicKeyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.GetPublicKey');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "getPublicKeyRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getPublicKeyResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetPublicKeyResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ImportKeyMaterialRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ImportKeyMaterialResponse
     */
	public function importKeyMaterial(
        \OpenAPI\OpenAPI\Models\Operations\ImportKeyMaterialRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ImportKeyMaterialResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.ImportKeyMaterial');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "importKeyMaterialRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ImportKeyMaterialResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->importKeyMaterialResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->incorrectKeyMaterialException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 488) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->expiredImportTokenException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 489) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->invalidImportTokenException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.ListAliases');
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListGrantsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListGrantsResponse
     */
	public function listGrants(
        \OpenAPI\OpenAPI\Models\Operations\ListGrantsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListGrantsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.ListGrants');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listGrantsRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ListGrantsRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListGrantsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listGrantsResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListGrantsResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->invalidGrantIdException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 484) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListKeyPoliciesRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListKeyPoliciesResponse
     */
	public function listKeyPolicies(
        \OpenAPI\OpenAPI\Models\Operations\ListKeyPoliciesRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListKeyPoliciesResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.ListKeyPolicies');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listKeyPoliciesRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ListKeyPoliciesRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListKeyPoliciesResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listKeyPoliciesResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListKeyPoliciesResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.ListKeys');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listKeysRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListResourceTagsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListResourceTagsResponse
     */
	public function listResourceTags(
        \OpenAPI\OpenAPI\Models\Operations\ListResourceTagsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListResourceTagsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.ListResourceTags');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listResourceTagsRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ListResourceTagsRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListResourceTagsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listResourceTagsResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListResourceTagsResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListRetirableGrantsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListRetirableGrantsResponse
     */
	public function listRetirableGrants(
        \OpenAPI\OpenAPI\Models\Operations\ListRetirableGrantsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListRetirableGrantsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.ListRetirableGrants');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listRetirableGrantsRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ListRetirableGrantsRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListRetirableGrantsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\PutKeyPolicyRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\PutKeyPolicyResponse
     */
	public function putKeyPolicy(
        \OpenAPI\OpenAPI\Models\Operations\PutKeyPolicyRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\PutKeyPolicyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.PutKeyPolicy');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "putKeyPolicyRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PutKeyPolicyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ReEncryptRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ReEncryptResponse
     */
	public function reEncrypt(
        \OpenAPI\OpenAPI\Models\Operations\ReEncryptRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ReEncryptResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.ReEncrypt');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "reEncryptRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ReEncryptResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->reEncryptResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ReEncryptResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ReplicateKeyRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ReplicateKeyResponse
     */
	public function replicateKey(
        \OpenAPI\OpenAPI\Models\Operations\ReplicateKeyRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ReplicateKeyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.ReplicateKey');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "replicateKeyRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ReplicateKeyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->replicateKeyResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ReplicateKeyResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\RetireGrantRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\RetireGrantResponse
     */
	public function retireGrant(
        \OpenAPI\OpenAPI\Models\Operations\RetireGrantRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\RetireGrantResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.RetireGrant');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "retireGrantRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\RetireGrantResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\RevokeGrantRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\RevokeGrantResponse
     */
	public function revokeGrant(
        \OpenAPI\OpenAPI\Models\Operations\RevokeGrantRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\RevokeGrantResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.RevokeGrant');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "revokeGrantRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\RevokeGrantResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ScheduleKeyDeletionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ScheduleKeyDeletionResponse
     */
	public function scheduleKeyDeletion(
        \OpenAPI\OpenAPI\Models\Operations\ScheduleKeyDeletionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ScheduleKeyDeletionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.ScheduleKeyDeletion');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "scheduleKeyDeletionRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ScheduleKeyDeletionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->scheduleKeyDeletionResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ScheduleKeyDeletionResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\SignRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\SignResponse
     */
	public function sign(
        \OpenAPI\OpenAPI\Models\Operations\SignRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\SignResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.Sign');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "signRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\SignResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->signResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\SignResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.TagResource');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.UntagResource');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.UpdateAlias');
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateCustomKeyStoreRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateCustomKeyStoreResponse
     */
	public function updateCustomKeyStore(
        \OpenAPI\OpenAPI\Models\Operations\UpdateCustomKeyStoreRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateCustomKeyStoreResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.UpdateCustomKeyStore');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateCustomKeyStoreRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateCustomKeyStoreResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateCustomKeyStoreResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->cloudHsmClusterNotRelatedException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 484) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateKeyDescriptionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateKeyDescriptionResponse
     */
	public function updateKeyDescription(
        \OpenAPI\OpenAPI\Models\Operations\UpdateKeyDescriptionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateKeyDescriptionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.UpdateKeyDescription');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateKeyDescriptionRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateKeyDescriptionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdatePrimaryRegionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdatePrimaryRegionResponse
     */
	public function updatePrimaryRegion(
        \OpenAPI\OpenAPI\Models\Operations\UpdatePrimaryRegionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdatePrimaryRegionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.UpdatePrimaryRegion');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updatePrimaryRegionRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdatePrimaryRegionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\VerifyRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\VerifyResponse
     */
	public function verify(
        \OpenAPI\OpenAPI\Models\Operations\VerifyRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\VerifyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.Verify');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "verifyRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\VerifyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->verifyResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\VerifyResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->kmsInvalidSignatureException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\VerifyMacRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\VerifyMacResponse
     */
	public function verifyMac(
        \OpenAPI\OpenAPI\Models\Operations\VerifyMacRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\VerifyMacResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=TrentService.VerifyMac');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "verifyMacRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\VerifyMacResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->verifyMacResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\VerifyMacResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->kmsInvalidMacException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 487) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
