...
const (
	ListTagsForResourceXAmzTargetEnumBackupOnPremisesV20210101ListTagsForResource ListTagsForResourceXAmzTargetEnum = "BackupOnPremises_v20210101.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "BackupOnPremises_v20210101.ListTagsForResource":
