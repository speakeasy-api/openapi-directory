...
class RealtimebiddingBiddersPublisherConnectionsBatchRejectRequest:
    ...
    r"""Required. The bidder for whom publisher connections will be rejected. Format: `bidders/{bidder}` where `{bidder}` is the account ID of the bidder."""  
    ...
    batch_reject_publisher_connections_request: Optional[shared_batchrejectpublisherconnectionsrequest.BatchRejectPublisherConnectionsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
