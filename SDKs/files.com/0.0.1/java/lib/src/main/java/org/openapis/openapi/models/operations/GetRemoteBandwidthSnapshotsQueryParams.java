...
public class GetRemoteBandwidthSnapshotsQueryParams {
    /**
     * Used for pagination.  When a list request has more records available, cursors are provided in the response headers `X-Files-Cursor-Next` and `X-Files-Cursor-Prev`.  Send one of those cursor value here to resume an existing list from the next available record.  Note: many of our SDKs have iterator methods that will automatically handle cursor-based pagination.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=cursor")
    public String cursor;
    public GetRemoteBandwidthSnapshotsQueryParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public GetRemoteBandwidthSnapshotsQueryParams withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetRemoteBandwidthSnapshotsQueryParams withFilterGt(java.util.Map<String, Object> filterGt) {
    ...
    public GetRemoteBandwidthSnapshotsQueryParams withFilterGteq(java.util.Map<String, Object> filterGteq) {
    ...
    public GetRemoteBandwidthSnapshotsQueryParams withFilterLike(java.util.Map<String, Object> filterLike) {
    ...
    public GetRemoteBandwidthSnapshotsQueryParams withFilterLt(java.util.Map<String, Object> filterLt) {
    ...
    public GetRemoteBandwidthSnapshotsQueryParams withFilterLteq(java.util.Map<String, Object> filterLteq) {
    ...
    public GetRemoteBandwidthSnapshotsQueryParams withPerPage(Integer perPage) {
    ...
    public GetRemoteBandwidthSnapshotsQueryParams withSortBy(java.util.Map<String, Object> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
