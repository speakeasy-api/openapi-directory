...
class PermissionType:
    ...
    can_add_collaborators: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('can_add_collaborators'), 'exclude': lambda f: f is None }})  
    ...
    can_view: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('can_view'), 'exclude': lambda f: f is None }})  
