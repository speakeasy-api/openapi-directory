...
class GetV2TeamTemplateAttachmentsJSONRequest:
    
    ids: Optional[list[int]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'ids', 'style': 'form', 'explode': False }})
    r"""IDs of team template attachments to fetch. If a record can't be found, that record won't be returned and your request will be successful"""  
    ...
    team_template_id: Optional[list[int]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'team_template_id', 'style': 'form', 'explode': False }})
    r"""Filters template attachments by team template IDs"""  
    

@dataclasses.dataclass
class GetV2TeamTemplateAttachmentsJSONResponse:
