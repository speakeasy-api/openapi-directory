...
export class AndroidpublisherEditsApklistingsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AndroidpublisherEditsApklistingsListRequest extends SpeakeasyBase {
  /**
...
export class AndroidpublisherEditsApklistingsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
