...
export declare class InventoryperdockRequest extends SpeakeasyBase {
    /**
...
export declare class Inventoryperdock200ApplicationJSON extends SpeakeasyBase {
    /**
...
export declare class InventoryperdockResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * OK
     */
