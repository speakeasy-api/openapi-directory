...
const (
	UntagResourceXAmzTargetEnumAwsStepFunctionsUntagResource UntagResourceXAmzTargetEnum = "AWSStepFunctions.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "AWSStepFunctions.UntagResource":
