...
from ..shared import storecreationrequest as shared_storecreationrequest
from typing import Optional


@dataclasses.dataclass
class PostMerchantsMerchantIDStoresSecurity:
...
@dataclasses.dataclass
class PostMerchantsMerchantIDStoresRequest:
    ...
    store_creation_request: Optional[shared_storecreationrequest.StoreCreationRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    

@dataclasses.dataclass
class PostMerchantsMerchantIDStoresResponse:
