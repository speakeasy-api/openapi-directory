...
class GetListAttachedRolePoliciesQueryParams:
    action: GetListAttachedRolePoliciesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    role_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'RoleName', 'style': 'form', 'explode': True }})
    version: GetListAttachedRolePoliciesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListAttachedRolePoliciesRequest:
    headers: GetListAttachedRolePoliciesHeaders = dataclasses.field()
    query_params: GetListAttachedRolePoliciesQueryParams = dataclasses.field()
