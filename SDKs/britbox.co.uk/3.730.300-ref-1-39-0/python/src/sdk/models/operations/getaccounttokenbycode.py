...
from ..shared import accounttokenbycoderequest as shared_accounttokenbycoderequest
...
class GetAccountTokenByCodeRequest:
    ...
    account_token_by_code_request: shared_accounttokenbycoderequest.AccountTokenByCodeRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
