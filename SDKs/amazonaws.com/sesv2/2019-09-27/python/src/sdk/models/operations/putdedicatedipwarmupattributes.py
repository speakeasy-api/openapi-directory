...
class PutDedicatedIPWarmupAttributesRequest:
    headers: PutDedicatedIPWarmupAttributesHeaders = dataclasses.field()
    path_params: PutDedicatedIPWarmupAttributesPathParams = dataclasses.field()
    request: PutDedicatedIPWarmupAttributesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
