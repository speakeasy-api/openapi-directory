...
class StorageObjectAccessControlsDeleteSecurity:
    option1: Optional[StorageObjectAccessControlsDeleteSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageObjectAccessControlsDeleteSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class StorageObjectAccessControlsDeleteRequest:
    path_params: StorageObjectAccessControlsDeletePathParams = dataclasses.field()
    query_params: StorageObjectAccessControlsDeleteQueryParams = dataclasses.field()
    security: StorageObjectAccessControlsDeleteSecurity = dataclasses.field()
