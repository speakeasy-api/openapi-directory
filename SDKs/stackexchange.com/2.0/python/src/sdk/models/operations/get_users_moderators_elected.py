...
class GetUsersModeratorsElectedQueryParams:
    ...
    order: Optional[GetUsersModeratorsElectedOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetUsersModeratorsElectedSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetUsersModeratorsElectedRequest:
    query_params: GetUsersModeratorsElectedQueryParams = dataclasses.field()
