...
class GetDeleteLoadBalancerPolicyQueryParams:
    action: GetDeleteLoadBalancerPolicyActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteLoadBalancerPolicyVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteLoadBalancerPolicyRequest:
    headers: GetDeleteLoadBalancerPolicyHeaders = dataclasses.field()
    query_params: GetDeleteLoadBalancerPolicyQueryParams = dataclasses.field()
