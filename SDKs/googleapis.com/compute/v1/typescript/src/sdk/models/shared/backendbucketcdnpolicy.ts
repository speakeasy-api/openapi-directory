 ...
 */
export enum BackendBucketCdnPolicyCacheModeEnum {
 ...
 */
export class BackendBucketCdnPolicy extends SpeakeasyBase {
  /**
   * Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.
   */
  @SpeakeasyMetadata({
    elemType: BackendBucketCdnPolicyBypassCacheOnRequestHeader,
  })
   ...
   */
  @SpeakeasyMetadata({ elemType: BackendBucketCdnPolicyNegativeCachingPolicy })
