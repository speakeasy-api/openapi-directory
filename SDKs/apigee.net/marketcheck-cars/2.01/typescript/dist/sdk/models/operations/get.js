...
exports.GetResponse = exports.GetRequest = exports.GetCountryEnum = void 0;
var utils_1 = require("../../../internal/utils");
/**
 * To filter listing on Country in which they are listed
 */
var GetCountryEnum;
(function (GetCountryEnum) {
    GetCountryEnum["Us"] = "US";
    GetCountryEnum["Ca"] = "CA";
    GetCountryEnum["Uk"] = "UK";
})(GetCountryEnum = exports.GetCountryEnum || (exports.GetCountryEnum = {}));
var GetRequest = /** @class */ (function (_super) {
    ...
    ], GetRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=country",
        }),
        __metadata("design:type", String)
    ], GetRequest.prototype, "country", void 0);
    return GetRequest;
