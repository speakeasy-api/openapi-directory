...
type DeactivateSKUBindingPathParams struct {
...
type DeactivateSKUBindingHeaders struct {
...
type DeactivateSKUBindingRequest struct {
	PathParams DeactivateSKUBindingPathParams
	Headers    DeactivateSKUBindingHeaders
}

type DeactivateSKUBindingResponse struct {
	ContentType string
	StatusCode  int
