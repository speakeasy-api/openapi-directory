...
export class ChatSpacesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ChatSpacesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ChatSpacesListSecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ChatSpacesListSecurity extends SpeakeasyBase {
