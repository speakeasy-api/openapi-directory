...
public class GETEnableLoggingQueryParams {
    ...
    public GETEnableLoggingQueryParams withLogDestinationType(GETEnableLoggingLogDestinationTypeEnum logDestinationType) {
    ...
    public GETEnableLoggingQueryParams withLogExports(String[] logExports) {
