...
func (e ProductUpdateAPIModelStatusEnum) ToPointer() *ProductUpdateAPIModelStatusEnum {
	return &e
}
...
func (e *ProductUpdateAPIModelStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "NotAvailable":
		fallthrough
	case "Inactive":
		*e = ProductUpdateAPIModelStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ProductUpdateAPIModelStatusEnum: %v", v)
	}
}
