...
class ListConversationMessageListConversationMessageResponse:
    ...
    messages: Optional[list[shared_conversations_v1_conversation_conversation_message.ConversationsV1ConversationConversationMessage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('messages'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListConversationMessageListConversationMessageResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
