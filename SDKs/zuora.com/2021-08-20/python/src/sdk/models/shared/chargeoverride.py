...
class ChargeOverrideBilling:
    ...
    bill_cycle_type: Optional[ChargeOverrideBillingBillCycleTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billCycleType') }})
    billing_period: Optional[ChargeOverrideBillingBillingPeriodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billingPeriod') }})
    billing_period_alignment: Optional[ChargeOverrideBillingBillingPeriodAlignmentEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billingPeriodAlignment') }})
    billing_timing: Optional[ChargeOverrideBillingBillingTimingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billingTiming') }})
    ...
    weekly_bill_cycle_day: Optional[ChargeOverrideBillingWeeklyBillCycleDayEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('weeklyBillCycleDay') }})
    

@dataclass_json
@dataclasses.dataclass
class ChargeOverridePricing:
    r"""ChargeOverridePricing
...
class ChargeOverride:
    ...
    billing: Optional[ChargeOverrideBilling] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billing') }})
    ...
    pricing: Optional[ChargeOverridePricing] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pricing') }})
    ...
    rev_rec_trigger_condition: Optional[ChargeOverrideRevRecTriggerConditionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('revRecTriggerCondition') }})
    revenue_recognition_rule_name: Optional[ChargeOverrideRevenueRecognitionRuleNameEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('revenueRecognitionRuleName') }})
    start_date: Optional[shared_triggerparams.TriggerParams] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('startDate') }})
