...
class GetLoadBalancersIDMetrics200ApplicationJSONMetrics:
    ...
    r"""Resolution of results in seconds."""  
    time_series: dict[str, GetLoadBalancersIDMetrics200ApplicationJSONMetricsTimeSeries] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('time_series') }})
...
class GetLoadBalancersIDMetrics200ApplicationJSON:
    ...
    metrics: GetLoadBalancersIDMetrics200ApplicationJSONMetrics = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metrics') }})  
