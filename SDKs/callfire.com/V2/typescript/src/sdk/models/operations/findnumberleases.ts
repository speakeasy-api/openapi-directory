...
export class FindNumberLeasesSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FindNumberLeasesRequest extends SpeakeasyBase {
  /**
   * A city name
   */
...
export class FindNumberLeasesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
