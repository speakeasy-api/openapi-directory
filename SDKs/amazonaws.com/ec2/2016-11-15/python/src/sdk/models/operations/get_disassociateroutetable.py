...
class GetDisassociateRouteTableQueryParams:
    action: GetDisassociateRouteTableActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    association_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'AssociationId', 'style': 'form', 'explode': True }})
    version: GetDisassociateRouteTableVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDisassociateRouteTableRequest:
    headers: GetDisassociateRouteTableHeaders = dataclasses.field()
    query_params: GetDisassociateRouteTableQueryParams = dataclasses.field()
