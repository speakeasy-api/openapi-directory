...
class Meeting200ApplicationXMLRecurrence
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\Meeting200ApplicationXMLRecurrenceMonthlyWeekEnum $monthlyWeek
     */
	
    public ?Meeting200ApplicationXMLRecurrenceMonthlyWeekEnum $monthlyWeek = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\Meeting200ApplicationXMLRecurrenceMonthlyWeekDayEnum $monthlyWeekDay
     */
	
    public ?Meeting200ApplicationXMLRecurrenceMonthlyWeekDayEnum $monthlyWeekDay = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\Meeting200ApplicationXMLRecurrenceTypeEnum $type
     */
     ...
     *  <br>`1`  - Sunday. <br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` -  Thursday.<br>`6` - Friday.<br>`7` - Saturday.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\Meeting200ApplicationXMLRecurrenceWeeklyDaysEnum $weeklyDays
     */
	
    public ?Meeting200ApplicationXMLRecurrenceWeeklyDaysEnum $weeklyDays = null;
	...
	public function __construct()
	{
		...
		$this->type = \OpenAPI\OpenAPI\Models\Operations\Meeting200ApplicationXMLRecurrenceTypeEnum::ONE;
