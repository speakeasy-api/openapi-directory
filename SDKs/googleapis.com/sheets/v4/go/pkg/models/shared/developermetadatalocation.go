...
func (e DeveloperMetadataLocationLocationTypeEnum) ToPointer() *DeveloperMetadataLocationLocationTypeEnum {
	return &e
}
...
func (e *DeveloperMetadataLocationLocationTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "SHEET":
		fallthrough
	case "SPREADSHEET":
		*e = DeveloperMetadataLocationLocationTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DeveloperMetadataLocationLocationTypeEnum: %v", v)
	}
}
