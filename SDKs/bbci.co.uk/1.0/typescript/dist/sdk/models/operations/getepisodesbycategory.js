...
exports.GetEpisodesByCategoryResponse = exports.GetEpisodesByCategoryRequest = exports.GetEpisodesByCategorySortEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * The sort order of the results.
 */
var GetEpisodesByCategorySortEnum;
...
})(GetEpisodesByCategorySortEnum = exports.GetEpisodesByCategorySortEnum || (exports.GetEpisodesByCategorySortEnum = {}));
var GetEpisodesByCategoryRequest = /** @class */ (function (_super) {
    ...
    ], GetEpisodesByCategoryRequest.prototype, "availability", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=category",
        }),
        __metadata("design:type", String)
    ], GetEpisodesByCategoryRequest.prototype, "category", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=lang" }),
        __metadata("design:type", String)
    ], GetEpisodesByCategoryRequest.prototype, "lang", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetEpisodesByCategoryRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetEpisodesByCategoryRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=rights",
        }),
        __metadata("design:type", String)
    ], GetEpisodesByCategoryRequest.prototype, "rights", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetEpisodesByCategoryRequest.prototype, "sort", void 0);
    return GetEpisodesByCategoryRequest;
}(utils_1.SpeakeasyBase));
exports.GetEpisodesByCategoryRequest = GetEpisodesByCategoryRequest;
var GetEpisodesByCategoryResponse = /** @class */ (function (_super) {
    ...
    ], GetEpisodesByCategoryResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.GetEpisodesByCategoryResponse = GetEpisodesByCategoryResponse;
