...
class BatchCheckLayerAvailabilityRequest:
    ...
    batch_check_layer_availability_request: shared_batchchecklayeravailabilityrequest.BatchCheckLayerAvailabilityRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
