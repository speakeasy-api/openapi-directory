 ...
 */
public enum AddInternalNumbers201ApplicationJSONInternalNumbersLanguagesEnum {
    EN_GB("en-GB"),
    EN_US("en-US"),
    DEDE("de-DE");
    ...
    private AddInternalNumbers201ApplicationJSONInternalNumbersLanguagesEnum(String value) {
        this.value = value;
    }
}
