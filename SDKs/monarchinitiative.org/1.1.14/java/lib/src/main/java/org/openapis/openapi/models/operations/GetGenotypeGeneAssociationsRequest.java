...
public class GetGenotypeGeneAssociationsRequest {
    ...
    public GetGenotypeGeneAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGenotypeGeneAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGenotypeGeneAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGenotypeGeneAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGenotypeGeneAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGenotypeGeneAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGenotypeGeneAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGenotypeGeneAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGenotypeGeneAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGenotypeGeneAssociationsRequest withRelation(String relation) {
    ...
    public GetGenotypeGeneAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGenotypeGeneAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGenotypeGeneAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetGenotypeGeneAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGenotypeGeneAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGenotypeGeneAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGenotypeGeneAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGenotypeGeneAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
