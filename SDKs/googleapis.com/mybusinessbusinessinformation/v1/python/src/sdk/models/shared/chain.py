...
class Chain:
    ...
    r"""Required. The chain's resource name, in the format `chains/{chain_id}`."""  
    websites: Optional[list[shared_chainuri.ChainURI]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('websites'), 'exclude': lambda f: f is None }})
