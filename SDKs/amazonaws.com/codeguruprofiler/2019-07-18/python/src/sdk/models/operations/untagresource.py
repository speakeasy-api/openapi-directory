...
class UntagResourceRequest:
    ...
    r"""The Amazon Resource Name (ARN) of the resource that contains the tags to remove."""  
    tag_keys: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'tagKeys', 'style': 'form', 'explode': True }})
    r"""A list of tag keys. Existing tags of resources with keys in this list are removed from the specified resource."""  
