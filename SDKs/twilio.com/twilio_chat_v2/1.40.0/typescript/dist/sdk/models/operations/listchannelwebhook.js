...
exports.ListChannelWebhookResponse = exports.ListChannelWebhookListChannelWebhookResponse = exports.ListChannelWebhookListChannelWebhookResponseMeta = exports.ListChannelWebhookRequest = exports.ListChannelWebhookSecurity = exports.ListChannelWebhookServerList = void 0;
...
var ListChannelWebhookSecurity = /** @class */ (function (_super) {
    ...
    ], ListChannelWebhookSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListChannelWebhookSecurity.prototype, "username", void 0);
...
var ListChannelWebhookRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListChannelWebhookRequest.prototype, "channelSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListChannelWebhookRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListChannelWebhookRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListChannelWebhookRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListChannelWebhookRequest.prototype, "serviceSid", void 0);
...
var ListChannelWebhookListChannelWebhookResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListChannelWebhookListChannelWebhookResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ChatV2ServiceChannelChannelWebhook }),
        (0, class_transformer_1.Expose)({ name: "webhooks" }),
        (0, class_transformer_1.Type)(function () { return shared.ChatV2ServiceChannelChannelWebhook; }),
...
var ListChannelWebhookResponse = /** @class */ (function (_super) {
    ...
    ], ListChannelWebhookResponse.prototype, "rawResponse", void 0);
