...
class GetPipelineTestReportTestCaseReasonsRequest:
...
class GetPipelineTestReportTestCaseReasonsResponse:
    ...
    r"""No account, repository, pipeline, step or test case with the UUID provided exists for the pipeline with the UUID provided."""  
