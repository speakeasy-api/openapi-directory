...
class Locationsv1GetV1LocationsLocationIDGetRequest:
    path_params: Locationsv1GetV1LocationsLocationIDGetPathParams = dataclasses.field()
    query_params: Locationsv1GetV1LocationsLocationIDGetQueryParams = dataclasses.field()
