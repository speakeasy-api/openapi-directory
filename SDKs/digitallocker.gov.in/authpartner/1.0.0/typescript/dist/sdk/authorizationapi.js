...
var AuthorizationApi = /** @class */ (function () {
    function AuthorizationApi(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    AuthorizationApi.prototype.getDeviceCodeId = function (req, config) {
        var _a;
