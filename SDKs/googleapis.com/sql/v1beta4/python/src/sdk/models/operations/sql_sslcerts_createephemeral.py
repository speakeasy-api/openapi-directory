...
class SQLSslCertsCreateEphemeralRequest:
    ...
    ssl_certs_create_ephemeral_request: Optional[shared_sslcertscreateephemeralrequest.SslCertsCreateEphemeralRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
