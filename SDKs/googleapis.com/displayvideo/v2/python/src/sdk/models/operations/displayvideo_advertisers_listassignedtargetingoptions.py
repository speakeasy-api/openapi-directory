...
@dataclasses.dataclass
class DisplayvideoAdvertisersListAssignedTargetingOptionsQueryParams:
...
class DisplayvideoAdvertisersListAssignedTargetingOptionsRequest:
    path_params: DisplayvideoAdvertisersListAssignedTargetingOptionsPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersListAssignedTargetingOptionsQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersListAssignedTargetingOptionsSecurity = dataclasses.field()
