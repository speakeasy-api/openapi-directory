...
export class Stores {
   ...
   */
  storesOne(
    req: operations.StoresOneRequest,
    security: operations.StoresOneSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.StoresOneResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.StoresOneRequest(req);
    }

    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/ecommerce/store";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.StoresOneResponse =
        new operations.StoresOneResponse({
