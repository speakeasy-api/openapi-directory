...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.firebasestorageProjectsBucketsAddFirebase = function (req, config) {
        var _a;
    ...
    **/
    Projects.prototype.firebasestorageProjectsBucketsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.firebasestorageProjectsBucketsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.firebasestorageProjectsBucketsRemoveFirebase = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
