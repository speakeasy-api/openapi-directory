...
type SearchTypeGtfsTripRequest struct {
	...
	// Bikes Allowed
	SearchTypeGtfsTripBikesAllowed *string `queryParam:"style=form,explode=true,name=search.type_gtfs_trip.bikes_allowed"`
	// Stop IDS
	SearchTypeGtfsTripStopIds *string `queryParam:"style=form,explode=true,name=search.type_gtfs_trip.stop_ids"`
	// Trip ID
	SearchTypeGtfsTripTripID *string `queryParam:"style=form,explode=true,name=search.type_gtfs_trip.trip_id"`
	// Wheelchair Accessible
	SearchTypeGtfsTripWheelchairAccessible *string `queryParam:"style=form,explode=true,name=search.type_gtfs_trip.wheelchair_accessible"`
	// Number to skip
