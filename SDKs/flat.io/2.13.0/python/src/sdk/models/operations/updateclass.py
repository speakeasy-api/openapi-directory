...
class UpdateClassRequest:
    ...
    class_update: Optional[shared_classupdate.ClassUpdate] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    r"""Details of the Class"""  
