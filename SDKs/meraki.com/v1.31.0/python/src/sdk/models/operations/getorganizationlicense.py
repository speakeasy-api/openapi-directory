...
@dataclasses.dataclass
class GetOrganizationLicense200ApplicationJSONPermanentlyQueuedLicenses:
...
class GetOrganizationLicense200ApplicationJSONStateEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetOrganizationLicense200ApplicationJSON:
    ...
    order_number: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('orderNumber'), 'exclude': lambda f: f is None }})
    r"""Order number"""  
    permanently_queued_licenses: Optional[list[GetOrganizationLicense200ApplicationJSONPermanentlyQueuedLicenses]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('permanentlyQueuedLicenses'), 'exclude': lambda f: f is None }})
    ...
    state: Optional[GetOrganizationLicense200ApplicationJSONStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
    r"""The state of the license. All queued licenses have a status of `recentlyQueued`."""  
...
class GetOrganizationLicenseResponse:
    ...
    get_organization_license_200_application_json_object: Optional[GetOrganizationLicense200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
