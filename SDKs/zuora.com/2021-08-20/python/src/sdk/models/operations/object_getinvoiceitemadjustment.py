...
from ..shared import proxygetinvoiceitemadjustment as shared_proxygetinvoiceitemadjustment
...
class ObjectGETInvoiceItemAdjustmentResponse:
    ...
    proxy_get_invoice_item_adjustment: Optional[shared_proxygetinvoiceitemadjustment.ProxyGetInvoiceItemAdjustment] = dataclasses.field(default=None)  
