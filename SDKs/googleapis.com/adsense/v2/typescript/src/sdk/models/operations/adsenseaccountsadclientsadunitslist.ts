...
export class AdsenseAccountsAdclientsAdunitsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdsenseAccountsAdclientsAdunitsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class AdsenseAccountsAdclientsAdunitsListSecurity extends SpeakeasyBase {
...
export class AdsenseAccountsAdclientsAdunitsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdsenseAccountsAdclientsAdunitsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
