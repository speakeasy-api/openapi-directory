...
class ListExecutionListExecutionResponse:
    executions: Optional[list[shared_studio_v1_flow_execution.StudioV1FlowExecution]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('executions') }})
