...
class PolicyControllerMonitoringConfig:
    ...
    backends: Optional[list[PolicyControllerMonitoringConfigBackendsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('backends'), 'exclude': lambda f: f is None }})
