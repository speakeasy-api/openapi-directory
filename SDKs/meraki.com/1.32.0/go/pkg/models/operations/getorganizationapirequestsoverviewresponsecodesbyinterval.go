...
type GetOrganizationAPIRequestsOverviewResponseCodesByIntervalVersionEnum int64
...
func (e GetOrganizationAPIRequestsOverviewResponseCodesByIntervalVersionEnum) ToPointer() *GetOrganizationAPIRequestsOverviewResponseCodesByIntervalVersionEnum {
	return &e
}
...
func (e *GetOrganizationAPIRequestsOverviewResponseCodesByIntervalVersionEnum) UnmarshalJSON(data []byte) error {
	...
	case 0:
		fallthrough
	case 1:
		*e = GetOrganizationAPIRequestsOverviewResponseCodesByIntervalVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationAPIRequestsOverviewResponseCodesByIntervalVersionEnum: %v", v)
	}
}
