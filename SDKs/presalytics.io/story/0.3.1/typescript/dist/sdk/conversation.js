...
var Conversation = /** @class */ (function () {
    ...
    **/
    Conversation.prototype.storyIdMessagesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.StoryIdMessagesGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{id}/messages", req.pathParams);
    ...
    **/
    Conversation.prototype.storyIdMessagesPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
