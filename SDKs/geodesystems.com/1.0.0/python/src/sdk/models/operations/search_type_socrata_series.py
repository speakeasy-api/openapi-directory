...
class SearchTypeSocrataSeriesQueryParams:
...
@dataclasses.dataclass
class SearchTypeSocrataSeriesRequest:
    query_params: SearchTypeSocrataSeriesQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeSocrataSeriesResponse:
