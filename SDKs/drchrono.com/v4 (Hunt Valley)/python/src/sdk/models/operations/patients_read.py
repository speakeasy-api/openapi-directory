...
class PatientsReadPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PatientsReadQueryParams:
...
@dataclasses.dataclass
class PatientsReadSecurity:
    drchrono_oauth2: shared_security.SchemeDrchronoOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class PatientsReadRequest:
    path_params: PatientsReadPathParams = dataclasses.field()
    query_params: PatientsReadQueryParams = dataclasses.field()
    security: PatientsReadSecurity = dataclasses.field()
    

@dataclasses.dataclass
class PatientsReadResponse:
