...
export declare class GetCarDealerInventoryActiveRequest extends SpeakeasyBase {
    /**
...
export declare class GetCarDealerInventoryActiveResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Error
     */
