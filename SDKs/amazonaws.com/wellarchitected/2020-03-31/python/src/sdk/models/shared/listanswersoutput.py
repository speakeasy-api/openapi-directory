...
class ListAnswersOutput:
    r"""Output of a list answers call."""
    
    answer_summaries: Optional[list[shared_answersummary.AnswerSummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AnswerSummaries'), 'exclude': lambda f: f is None }})
    r"""List of answer summaries of lens review in a workload."""  
