...
var InsightsV1CallAnnotation = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=call_score" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=connectivity_issue" }),
        __metadata("design:type", String)
    ], InsightsV1CallAnnotation.prototype, "connectivityIssue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=incident" }),
        __metadata("design:type", String)
    ], InsightsV1CallAnnotation.prototype, "incident", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=quality_issues" }),
