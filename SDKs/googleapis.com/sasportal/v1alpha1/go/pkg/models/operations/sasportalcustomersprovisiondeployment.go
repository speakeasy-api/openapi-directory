...
type SasportalCustomersProvisionDeploymentRequest struct {
	...
	SasPortalProvisionDeploymentRequest *shared.SasPortalProvisionDeploymentRequest `request:"mediaType=application/json"`
	// OAuth access token.
...
type SasportalCustomersProvisionDeploymentResponse struct {
	ContentType string
	// Successful response
