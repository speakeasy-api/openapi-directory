...
public class Info {
     ...
     */
    public org.openapis.openapi.models.operations.GetVersionResponse getVersion(org.openapis.openapi.models.operations.GetVersionSecurity security) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.VersionResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.VersionResponse.class);
