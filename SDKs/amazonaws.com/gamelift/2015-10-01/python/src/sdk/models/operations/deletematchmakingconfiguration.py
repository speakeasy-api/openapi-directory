...
class DeleteMatchmakingConfigurationRequest:
    ...
    delete_matchmaking_configuration_input: shared_deletematchmakingconfigurationinput.DeleteMatchmakingConfigurationInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
