...
public class ListIPSetsRequest {
    ...
    public ListIPSetsRequest withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public ListIPSetsRequest withEndTime(Double endTime) {
    ...
    public Double size;
    public ListIPSetsRequest withSize(Double size) {
        this.size = size;
        return this;
    }
    ...
    public ListIPSetsRequest withStartTime(Double startTime) {
