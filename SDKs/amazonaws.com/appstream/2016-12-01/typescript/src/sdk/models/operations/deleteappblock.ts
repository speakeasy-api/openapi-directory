...
export enum DeleteAppBlockXAmzTargetEnum {
  PhotonAdminProxyServiceDeleteAppBlock = "PhotonAdminProxyService.DeleteAppBlock",
}

export class DeleteAppBlockRequest extends SpeakeasyBase {
...
export class DeleteAppBlockResponse extends SpeakeasyBase {
  /**
