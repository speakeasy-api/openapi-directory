...
class GetCategoriesIDTransactionsTypeEnum(str, Enum):
...
class GetCategoriesIDTransactionsRequest:
    ...
    r"""A comma-separated list of category IDs."""  
    ...
    type: Optional[GetCategoriesIDTransactionsTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
    r"""Limit to transactions of this type."""  
