...
class DeleteRepositoriesWorkspaceRepoSlugDownloadsFilenameRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugDownloadsFilenamePathParams = dataclasses.field()
    security: DeleteRepositoriesWorkspaceRepoSlugDownloadsFilenameSecurity = dataclasses.field()
