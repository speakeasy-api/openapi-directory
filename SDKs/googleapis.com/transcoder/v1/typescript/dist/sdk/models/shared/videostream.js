...
var VideoStream = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "h264" }),
        (0, class_transformer_1.Type)(function () { return h264codecsettings_1.H264CodecSettings; }),
        __metadata("design:type", h264codecsettings_1.H264CodecSettings)
    ], VideoStream.prototype, "h264", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "h265" }),
        (0, class_transformer_1.Type)(function () { return h265codecsettings_1.H265CodecSettings; }),
        __metadata("design:type", h265codecsettings_1.H265CodecSettings)
    ], VideoStream.prototype, "h265", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "vp9" }),
        (0, class_transformer_1.Type)(function () { return vp9codecsettings_1.Vp9CodecSettings; }),
