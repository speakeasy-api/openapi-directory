 ...
 */
export declare enum AcceleratorTypeListWarningCodeEnum {
...
export declare class AcceleratorTypeListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class AcceleratorTypeListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class AcceleratorTypeList extends SpeakeasyBase {
    /**
