...
@dataclasses.dataclass
class DataprocProjectsRegionsWorkflowTemplatesGetQueryParams:
...
class DataprocProjectsRegionsWorkflowTemplatesGetRequest:
    path_params: DataprocProjectsRegionsWorkflowTemplatesGetPathParams = dataclasses.field()
    query_params: DataprocProjectsRegionsWorkflowTemplatesGetQueryParams = dataclasses.field()
    security: DataprocProjectsRegionsWorkflowTemplatesGetSecurity = dataclasses.field()
