...
@dataclasses.dataclass
class AndroidpublisherEditsApksUploadQueryParams:
...
class AndroidpublisherEditsApksUploadRequest:
    path_params: AndroidpublisherEditsApksUploadPathParams = dataclasses.field()
    query_params: AndroidpublisherEditsApksUploadQueryParams = dataclasses.field()
    security: AndroidpublisherEditsApksUploadSecurity = dataclasses.field()
...
class AndroidpublisherEditsApksUploadResponse:
    ...
    apk: Optional[shared_apk.Apk] = dataclasses.field(default=None)
