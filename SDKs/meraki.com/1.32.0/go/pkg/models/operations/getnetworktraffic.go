...
func (e GetNetworkTrafficDeviceTypeEnum) ToPointer() *GetNetworkTrafficDeviceTypeEnum {
	return &e
}
...
func (e *GetNetworkTrafficDeviceTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "switch":
		fallthrough
	case "wireless":
		*e = GetNetworkTrafficDeviceTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkTrafficDeviceTypeEnum: %v", v)
	}
}
