...
var Groups = /** @class */ (function () {
    ...
    **/
    Groups.prototype.groupsSettingsGroupsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupsSettingsGroupsGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{groupUniqueId}", req.pathParams);
    ...
    **/
    Groups.prototype.groupsSettingsGroupsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupsSettingsGroupsPatchRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{groupUniqueId}", req.pathParams);
    ...
    **/
    Groups.prototype.groupsSettingsGroupsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupsSettingsGroupsUpdateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{groupUniqueId}", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
