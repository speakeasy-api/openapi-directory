...
class RegistrationsContributorsReadContributorAttributesPermissionEnum(str, Enum):
...
class RegistrationsContributorsReadContributorAttributes:
    ...
    permission: Optional[RegistrationsContributorsReadContributorAttributesPermissionEnum] = dataclasses.field(default=None)
    r"""The permission level of the contributor. The default value is 'write'."""  
...
@dataclasses.dataclass
class RegistrationsContributorsReadContributorRelationships:
...
class RegistrationsContributorsReadContributor:
    ...
    relationships: RegistrationsContributorsReadContributorRelationships = dataclasses.field()
    r"""URLs to other entities or entity collections that have a relationship to the contributor entity."""  
    type: str = dataclasses.field()
    r"""The type identifier of the contributor entity (`contributors`)."""  
    attributes: Optional[RegistrationsContributorsReadContributorAttributes] = dataclasses.field(default=None)
    r"""The properties of the contributor entity."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The identifier of the contributor entity. Contributor identifiers have the form {node_id}-{user_id}."""  
    links: Optional[RegistrationsContributorsReadContributorLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the contributor entity."""  
