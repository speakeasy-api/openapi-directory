...
public class GetUsersIdsQuestionsRequest {
    ...
    public GetUsersIdsQuestionsRequest withCallback(String callback) {
    ...
    public GetUsersIdsQuestionsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdsQuestionsRequest withFromdate(Long fromdate) {
    ...
    public GetUsersIdsQuestionsRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetUsersIdsQuestionsRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetUsersIdsQuestionsRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetUsersIdsQuestionsRequest withOrder(GetUsersIdsQuestionsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetUsersIdsQuestionsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdsQuestionsRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdsQuestionsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetUsersIdsQuestionsRequest withSort(GetUsersIdsQuestionsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetUsersIdsQuestionsRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetUsersIdsQuestionsRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
