...
class Info 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetVersionResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/info/version');
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->versionResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\VersionResponse', 'json');
            }
        }
