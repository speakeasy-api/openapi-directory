...
class UpdateFieldLevelEncryptionConfig20200531RequestBodyFieldLevelEncryptionConfig:
...
@dataclasses.dataclass
class UpdateFieldLevelEncryptionConfig20200531RequestBody:
    
    field_level_encryption_config: UpdateFieldLevelEncryptionConfig20200531RequestBodyFieldLevelEncryptionConfig = dataclasses.field()
    r"""A complex data type that includes the profile configurations specified for field-level encryption."""  
