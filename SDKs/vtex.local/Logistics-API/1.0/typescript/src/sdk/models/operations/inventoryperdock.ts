...
export class InventoryperdockRequest extends SpeakeasyBase {
  /**
...
export class Inventoryperdock200ApplicationJSON extends SpeakeasyBase {
  /**
...
export class InventoryperdockResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   * OK
   */
  @SpeakeasyMetadata({ elemType: Inventoryperdock200ApplicationJSON })
