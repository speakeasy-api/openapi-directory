...
from ..shared import storedvalueloadresponse as shared_storedvalueloadresponse
from typing import Optional


@dataclasses.dataclass
class PostLoadSecurity:
...
class PostLoadResponse:
    ...
    stored_value_load_response: Optional[shared_storedvalueloadresponse.StoredValueLoadResponse] = dataclasses.field(default=None)
