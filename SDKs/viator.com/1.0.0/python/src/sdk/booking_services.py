...
class BookingServices:
    ...
    def booking_availability(self, request: operations.BookingAvailabilityRequest) -> operations.BookingAvailabilityResponse:
        ...
        res = operations.BookingAvailabilityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingAvailability200ApplicationJSON])
    ...
    def booking_availability_dates(self, request: operations.BookingAvailabilityDatesRequest) -> operations.BookingAvailabilityDatesResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.BookingAvailabilityDatesRequest, request)
        ...
        res = operations.BookingAvailabilityDatesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingAvailabilityDates200ApplicationJSON])
    ...
    def booking_availability_tourgrades(self, request: operations.BookingAvailabilityTourgradesRequest) -> operations.BookingAvailabilityTourgradesResponse:
        ...
        **Note**: Availability data is limited to a period of **12 months** into the future from the present time on the production server and **6 months** on the sandbox server.
        ...
        res = operations.BookingAvailabilityTourgradesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingAvailabilityTourgrades200ApplicationJSON])
    ...
    def booking_availability_tourgrades_pricingmatrix(self, request: operations.BookingAvailabilityTourgradesPricingmatrixRequest) -> operations.BookingAvailabilityTourgradesPricingmatrixResponse:
        ...
        res = operations.BookingAvailabilityTourgradesPricingmatrixResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingAvailabilityTourgradesPricingmatrix200ApplicationJSON])
    ...
    def booking_book(self, request: operations.BookingBookRequest) -> operations.BookingBookResponse:
        ...
        res = operations.BookingBookResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingBook200ApplicationJSON])
    ...
    def booking_calculateprice(self, request: operations.BookingCalculatepriceRequest) -> operations.BookingCalculatepriceResponse:
        ...
        res = operations.BookingCalculatepriceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingCalculateprice200ApplicationJSON])
    ...
    def booking_hotels(self, request: operations.BookingHotelsRequest) -> operations.BookingHotelsResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.BookingHotelsRequest, request)
        ...
        res = operations.BookingHotelsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingHotels200ApplicationJSON])
    ...
    def booking_mybookings(self, request: operations.BookingMybookingsRequest) -> operations.BookingMybookingsResponse:
        ...
        **Provide either:** 
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.BookingMybookingsRequest, request)
        ...
        res = operations.BookingMybookingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingMybookings200ApplicationJSON])
    ...
    def booking_pastbooking(self, request: operations.BookingPastbookingRequest) -> operations.BookingPastbookingResponse:
        ...
        **Departure details**
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.BookingPastbookingRequest, request)
        ...
        res = operations.BookingPastbookingResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingPastbooking200ApplicationJSON])
    ...
    def booking_pricingmatrix(self, request: operations.BookingPricingmatrixRequest) -> operations.BookingPricingmatrixResponse:
        ...
        res = operations.BookingPricingmatrixResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingPricingmatrix200ApplicationJSON])
    ...
    def booking_status(self, request: operations.BookingStatusRequest) -> operations.BookingStatusResponse:
        ...
        **Exceeding the rate limit**
        ...
        res = operations.BookingStatusResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingStatus200ApplicationJSON])
    ...
    def booking_status_items(self, request: operations.BookingStatusItemsRequest) -> operations.BookingStatusItemsResponse:
        ...
        res = operations.BookingStatusItemsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingStatusItems200ApplicationJSON])
    ...
    def booking_voucher(self, request: operations.BookingVoucherRequest) -> operations.BookingVoucherResponse:
        ...
        **or** 
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.BookingVoucherRequest, request)
        ...
        res = operations.BookingVoucherResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.BookingVoucher200ApplicationJSON])
                res.booking_voucher_200_application_json_object = out

        return res

    def cancel_booking(self, request: operations.CancelBookingRequest, server_url: Optional[str] = None) -> operations.CancelBookingResponse:
        ...
        **Note**: 
        ...
        url = utils.generate_url(operations.CancelBookingRequest, base_url, '/bookings/{booking-reference}/cancel', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "cancellation_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.CancelBooking400ApplicationJSON])
                res.cancel_booking_400_application_json_object = out
        elif http_res.status_code == 401:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.FourHundredAndOneUNAUTHORIZED])
                res.four_hundred_and_one_unauthorized = out
        elif http_res.status_code == 404:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.CancelBooking404ApplicationJSON])
                res.cancel_booking_404_application_json_object = out
        elif http_res.status_code == 406:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.FourHundredAndSixNOTACCEPTABLE])
                res.four_hundred_and_six_not_acceptable = out
        elif http_res.status_code == 500:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.FiveHundredINTERNALSERVERERROR])
                res.five_hundred_internal_server_error = out
        elif http_res.status_code == 503:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.FiveHundredAndThreeSERVICEUNAVAILABLE])
                res.five_hundred_and_three_service_unavailable = out

        return res

    def cancel_booking_quote(self, request: operations.CancelBookingQuoteRequest, server_url: Optional[str] = None) -> operations.CancelBookingQuoteResponse:
        ...
        **Note**: 
        ...
        url = utils.generate_url(operations.CancelBookingQuoteRequest, base_url, '/bookings/{booking-reference}/cancel-quote', request)
        ...
        res = operations.CancelBookingQuoteResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CancelBookingQuoteResponse])
    ...
    def cancellation_reasons(self, request: operations.CancellationReasonsRequest, server_url: Optional[str] = None) -> operations.CancellationReasonsResponse:
        ...
        **Note**: 
        ...
        res = operations.CancellationReasonsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.CancellationReasonsResponse]])
