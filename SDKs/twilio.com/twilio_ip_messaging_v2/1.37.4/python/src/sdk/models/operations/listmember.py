...
class ListMemberListMemberResponse:
    members: Optional[list[shared_ip_messaging_v2_service_channel_member.IPMessagingV2ServiceChannelMember]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('members') }})
