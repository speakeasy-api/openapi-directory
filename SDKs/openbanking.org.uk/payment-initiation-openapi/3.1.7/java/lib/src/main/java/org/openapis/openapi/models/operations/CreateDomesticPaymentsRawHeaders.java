...
public class CreateDomesticPaymentsRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticPaymentsRawHeaders withAuthorization(String authorization) {
    ...
    public CreateDomesticPaymentsRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticPaymentsRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticPaymentsRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateDomesticPaymentsRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateDomesticPaymentsRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticPaymentsRawHeaders withXJwsSignature(String xJwsSignature) {
