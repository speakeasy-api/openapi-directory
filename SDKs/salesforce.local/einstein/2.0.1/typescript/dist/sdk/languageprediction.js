...
var LanguagePrediction = /** @class */ (function () {
    function LanguagePrediction(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    LanguagePrediction.prototype.intentMultipart = function (req, config) {
        var _a;
    ...
    **/
    LanguagePrediction.prototype.sentimentMultipart = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.LanguagePrediction = LanguagePrediction;
