...
class ViolationEvent:
    r"""Information about a Device Defender security profile behavior violation."""
    ...
    metric_value: Optional[shared_metricvalue.MetricValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metricValue'), 'exclude': lambda f: f is None }})  
    ...
    violation_event_time: Optional[datetime] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('violationEventTime'), 'encoder': utils.datetimeisoformat(True), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso'), 'exclude': lambda f: f is None }})  
    violation_event_type: Optional[shared_violationeventtype_enum.ViolationEventTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('violationEventType'), 'exclude': lambda f: f is None }})  
