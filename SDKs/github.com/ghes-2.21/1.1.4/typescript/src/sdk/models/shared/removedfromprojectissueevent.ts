...
export class RemovedFromProjectIssueEventProjectCard extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class RemovedFromProjectIssueEvent extends SpeakeasyBase {
  /**
   * Simple User
   */
  @SpeakeasyMetadata()
  ...
  @Type(() => RemovedFromProjectIssueEventProjectCard)
