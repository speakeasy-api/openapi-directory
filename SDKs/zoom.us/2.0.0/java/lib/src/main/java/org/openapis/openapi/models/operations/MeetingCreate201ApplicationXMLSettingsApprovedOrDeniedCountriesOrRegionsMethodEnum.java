 ...
 */
public enum MeetingCreate201ApplicationXMLSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum {
    APPROVE("approve"),
    DENY("deny");
    ...
    private MeetingCreate201ApplicationXMLSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum(String value) {
        this.value = value;
    }
}
