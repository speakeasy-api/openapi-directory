...
class Deprecated:
    ...
    def bulk_create_transactions(self, request: operations.BulkCreateTransactionsRequest) -> operations.BulkCreateTransactionsResponse:
        ...
        res = operations.BulkCreateTransactionsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BulkResponse])
