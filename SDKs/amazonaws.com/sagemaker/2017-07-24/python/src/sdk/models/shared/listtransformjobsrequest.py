...
class ListTransformJobsRequest:
    ...
    status_equals: Optional[shared_transformjobstatus_enum.TransformJobStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StatusEquals'), 'exclude': lambda f: f is None }})  
