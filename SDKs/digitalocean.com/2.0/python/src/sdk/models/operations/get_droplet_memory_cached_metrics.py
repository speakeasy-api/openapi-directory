...
class GetDropletMemoryCachedMetrics200ApplicationJSONData:
    result: list[GetDropletMemoryCachedMetrics200ApplicationJSONDataResult] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('result') }})
    result_type: GetDropletMemoryCachedMetrics200ApplicationJSONDataResultTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('resultType') }})
...
class GetDropletMemoryCachedMetrics200ApplicationJSON:
    data: GetDropletMemoryCachedMetrics200ApplicationJSONData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
    status: GetDropletMemoryCachedMetrics200ApplicationJSONStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class GetDropletMemoryCachedMetricsRequest:
    query_params: GetDropletMemoryCachedMetricsQueryParams = dataclasses.field()
...
class GetDropletMemoryCachedMetricsResponse:
    ...
    get_droplet_memory_cached_metrics_200_application_json_object: Optional[GetDropletMemoryCachedMetrics200ApplicationJSON] = dataclasses.field(default=None)
    get_droplet_memory_cached_metrics_401_application_json_object: Optional[GetDropletMemoryCachedMetrics401ApplicationJSON] = dataclasses.field(default=None)
