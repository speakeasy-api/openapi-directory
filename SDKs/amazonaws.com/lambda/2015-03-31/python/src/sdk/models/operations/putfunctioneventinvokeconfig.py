...
class PutFunctionEventInvokeConfigRequestBody:
    ...
    destination_config: Optional[PutFunctionEventInvokeConfigRequestBodyDestinationConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DestinationConfig'), 'exclude': lambda f: f is None }})
    r"""A configuration object that specifies the destination of an event after Lambda processes it."""  
...
class PutFunctionEventInvokeConfigRequest:
    ...
    request_body: PutFunctionEventInvokeConfigRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
