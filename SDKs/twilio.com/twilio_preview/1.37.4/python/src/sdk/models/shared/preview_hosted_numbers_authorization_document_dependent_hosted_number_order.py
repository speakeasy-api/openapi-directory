...
class PreviewHostedNumbersAuthorizationDocumentDependentHostedNumberOrder:
    ...
    capabilities: Optional[PreviewHostedNumbersAuthorizationDocumentDependentHostedNumberOrderCapabilities] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('capabilities') }})
    ...
    status: Optional[shared_dependent_hosted_number_order_enum_status_enum.DependentHostedNumberOrderEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
    ...
    verification_type: Optional[shared_dependent_hosted_number_order_enum_verification_type_enum.DependentHostedNumberOrderEnumVerificationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('verification_type') }})
