...
class ComputeReservationsUpdateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\Reservation $reservation1 = null;
     ...
     * 
     * @var string $reservationPathParameter
     */
	#[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=reservation')]
    public string $reservationPathParameter;
