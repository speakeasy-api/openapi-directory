...
type ViewOnlyLinksNodeListNodeAttributesCategoryEnum string

const (
	ViewOnlyLinksNodeListNodeAttributesCategoryEnumAnalysis           ViewOnlyLinksNodeListNodeAttributesCategoryEnum = "analysis"
	ViewOnlyLinksNodeListNodeAttributesCategoryEnumCommunication      ViewOnlyLinksNodeListNodeAttributesCategoryEnum = "communication"
	ViewOnlyLinksNodeListNodeAttributesCategoryEnumData               ViewOnlyLinksNodeListNodeAttributesCategoryEnum = "data"
	ViewOnlyLinksNodeListNodeAttributesCategoryEnumHypothesis         ViewOnlyLinksNodeListNodeAttributesCategoryEnum = "hypothesis"
	ViewOnlyLinksNodeListNodeAttributesCategoryEnumInstrumentation    ViewOnlyLinksNodeListNodeAttributesCategoryEnum = "instrumentation"
	ViewOnlyLinksNodeListNodeAttributesCategoryEnumMethodsAndMeasures ViewOnlyLinksNodeListNodeAttributesCategoryEnum = "methods and measures"
	ViewOnlyLinksNodeListNodeAttributesCategoryEnumProcedure          ViewOnlyLinksNodeListNodeAttributesCategoryEnum = "procedure"
	ViewOnlyLinksNodeListNodeAttributesCategoryEnumProject            ViewOnlyLinksNodeListNodeAttributesCategoryEnum = "project"
	ViewOnlyLinksNodeListNodeAttributesCategoryEnumSoftware           ViewOnlyLinksNodeListNodeAttributesCategoryEnum = "software"
	ViewOnlyLinksNodeListNodeAttributesCategoryEnumOther              ViewOnlyLinksNodeListNodeAttributesCategoryEnum = "other"
)

func (e ViewOnlyLinksNodeListNodeAttributesCategoryEnum) ToPointer() *ViewOnlyLinksNodeListNodeAttributesCategoryEnum {
	return &e
}

func (e *ViewOnlyLinksNodeListNodeAttributesCategoryEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "software":
		fallthrough
	case "other":
		*e = ViewOnlyLinksNodeListNodeAttributesCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ViewOnlyLinksNodeListNodeAttributesCategoryEnum: %v", v)
	}
}

// ViewOnlyLinksNodeListNodeAttributes - The properties of the node entity.
type ViewOnlyLinksNodeListNodeAttributes struct {
...
type ViewOnlyLinksNodeListNodeLinks struct {
...
type ViewOnlyLinksNodeListNodeRelationships struct {
...
type ViewOnlyLinksNodeListNode struct {
