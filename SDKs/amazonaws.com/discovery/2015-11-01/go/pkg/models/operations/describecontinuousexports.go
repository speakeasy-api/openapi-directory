...
func (e DescribeContinuousExportsXAmzTargetEnum) ToPointer() *DescribeContinuousExportsXAmzTargetEnum {
	return &e
}
...
func (e *DescribeContinuousExportsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSPoseidonService_V2015_11_01.DescribeContinuousExports":
		*e = DescribeContinuousExportsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeContinuousExportsXAmzTargetEnum: %v", v)
	}
}
