...
exports.ObjectT = exports.ObjectOwner = exports.ObjectCustomerEncryption = void 0;
...
var ObjectCustomerEncryption = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=keySha256" }),
        __metadata("design:type", String)
    ], ObjectCustomerEncryption.prototype, "keySha256", void 0);
    return ObjectCustomerEncryption;
}(utils_1.SpeakeasyBase));
exports.ObjectCustomerEncryption = ObjectCustomerEncryption;
// ObjectOwner
/**
...
var ObjectT = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=acl", elemType: objectaccesscontrol_1.ObjectAccessControl }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cacheControl" }),
        __metadata("design:type", String)
    ], ObjectT.prototype, "cacheControl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=componentCount" }),
        __metadata("design:type", Number)
    ], ObjectT.prototype, "componentCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=contentDisposition" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=crc32c" }),
        __metadata("design:type", String)
    ], ObjectT.prototype, "crc32c", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=customTime" }),
        __metadata("design:type", Date)
    ], ObjectT.prototype, "customTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=customerEncryption" }),
        __metadata("design:type", ObjectCustomerEncryption)
    ], ObjectT.prototype, "customerEncryption", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=etag" }),
        __metadata("design:type", String)
    ], ObjectT.prototype, "etag", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=eventBasedHold" }),
        __metadata("design:type", Boolean)
    ], ObjectT.prototype, "eventBasedHold", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ObjectT.prototype, "kmsKeyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=md5Hash" }),
        __metadata("design:type", String)
    ], ObjectT.prototype, "md5Hash", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mediaLink" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=retentionExpirationTime" }),
        __metadata("design:type", Date)
    ], ObjectT.prototype, "retentionExpirationTime", void 0);
    __decorate([
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=temporaryHold" }),
        __metadata("design:type", Boolean)
    ], ObjectT.prototype, "temporaryHold", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timeCreated" }),
        __metadata("design:type", Date)
    ], ObjectT.prototype, "timeCreated", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timeDeleted" }),
        __metadata("design:type", Date)
    ], ObjectT.prototype, "timeDeleted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timeStorageClassUpdated" }),
        __metadata("design:type", Date)
    ], ObjectT.prototype, "timeStorageClassUpdated", void 0);
    __decorate([
