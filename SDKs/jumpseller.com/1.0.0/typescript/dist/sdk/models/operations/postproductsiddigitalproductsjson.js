...
exports.PostProductsIdDigitalProductsJsonResponse = exports.PostProductsIdDigitalProductsJsonRequest = void 0;
...
var PostProductsIdDigitalProductsJsonRequest = /** @class */ (function (_super) {
    ...
    ], PostProductsIdDigitalProductsJsonRequest.prototype, "digitalProductEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PostProductsIdDigitalProductsJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PostProductsIdDigitalProductsJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PostProductsIdDigitalProductsJsonRequest.prototype, "login", void 0);
    return PostProductsIdDigitalProductsJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PostProductsIdDigitalProductsJsonRequest = PostProductsIdDigitalProductsJsonRequest;
var PostProductsIdDigitalProductsJsonResponse = /** @class */ (function (_super) {
    ...
    ], PostProductsIdDigitalProductsJsonResponse.prototype, "rawResponse", void 0);
    return PostProductsIdDigitalProductsJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PostProductsIdDigitalProductsJsonResponse = PostProductsIdDigitalProductsJsonResponse;
