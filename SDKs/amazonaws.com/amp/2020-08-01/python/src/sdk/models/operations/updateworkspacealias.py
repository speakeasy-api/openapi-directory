...
class UpdateWorkspaceAliasRequest:
    headers: UpdateWorkspaceAliasHeaders = dataclasses.field()
    path_params: UpdateWorkspaceAliasPathParams = dataclasses.field()
    request: UpdateWorkspaceAliasRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
