...
class UpdateVirtualInterfaceAttributesRequest:
    ...
    update_virtual_interface_attributes_request: shared_updatevirtualinterfaceattributesrequest.UpdateVirtualInterfaceAttributesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
