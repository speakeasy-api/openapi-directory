...
exports.AnalyticsManagementAccountsListResponse = exports.AnalyticsManagementAccountsListRequest = exports.AnalyticsManagementAccountsListSecurity = exports.AnalyticsManagementAccountsListSecurityOption2 = exports.AnalyticsManagementAccountsListSecurityOption1 = void 0;
...
var AnalyticsManagementAccountsListRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AnalyticsManagementAccountsListRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AnalyticsManagementAccountsListRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AnalyticsManagementAccountsListRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=max-results",
        }),
        __metadata("design:type", Number)
    ], AnalyticsManagementAccountsListRequest.prototype, "maxResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AnalyticsManagementAccountsListRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AnalyticsManagementAccountsListRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AnalyticsManagementAccountsListRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=start-index",
        }),
        __metadata("design:type", Number)
    ], AnalyticsManagementAccountsListRequest.prototype, "startIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AnalyticsManagementAccountsListRequest.prototype, "userIp", void 0);
...
var AnalyticsManagementAccountsListResponse = /** @class */ (function (_super) {
    ...
    ], AnalyticsManagementAccountsListResponse.prototype, "rawResponse", void 0);
