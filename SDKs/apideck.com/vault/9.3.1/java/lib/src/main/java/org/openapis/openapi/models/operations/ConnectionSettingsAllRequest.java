...
public class ConnectionSettingsAllRequest {
    ...
    public ConnectionSettingsAllRequest(@JsonProperty("resource") String resource, @JsonProperty("service_id") String serviceId, @JsonProperty("unified_api") String unifiedApi, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.resource = resource;
        this.serviceId = serviceId;
        this.unifiedApi = unifiedApi;
        this.xApideckAppId = xApideckAppId;
