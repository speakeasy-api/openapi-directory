...
public class GetRouteOutputFormatRequest {
    ...
    public GetRouteOutputFormatRequest withCorrectSide(Boolean correctSide) {
    ...
    public GetRouteOutputFormatRequest withCriteria(GetRouteOutputFormatCriteriaEnum criteria) {
    ...
    public GetRouteOutputFormatRequest withDeparture(OffsetDateTime departure) {
    ...
    public GetRouteOutputFormatRequest withDisable(String disable) {
    ...
    public GetRouteOutputFormatRequest withDistanceUnit(GetRouteOutputFormatDistanceUnitEnum distanceUnit) {
    ...
    public GetRouteOutputFormatRequest withOutputFormat(GetRouteOutputFormatOutputFormatEnum outputFormat) {
    ...
    public GetRouteOutputFormatRequest withOutputSRS(GetRouteOutputFormatOutputSrsEnum outputSRS) {
    ...
    public GetRouteOutputFormatRequest withPoints(String points) {
        this.points = points;
        return this;
    }
    ...
    public GetRouteOutputFormatRequest withRoundTrip(Boolean roundTrip) {
    ...
    public GetRouteOutputFormatRequest withRouteDescription(String routeDescription) {
        this.routeDescription = routeDescription;
        return this;
    }
    
    public GetRouteOutputFormatRequest(@JsonProperty("outputFormat") GetRouteOutputFormatOutputFormatEnum outputFormat, @JsonProperty("points") String points) {
        this.outputFormat = outputFormat;
        this.points = points;
  }
}
