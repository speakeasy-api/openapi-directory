...
public class CreateDomesticPaymentsJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticPaymentsJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateDomesticPaymentsJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticPaymentsJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticPaymentsJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateDomesticPaymentsJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateDomesticPaymentsJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticPaymentsJsonHeaders withXJwsSignature(String xJwsSignature) {
