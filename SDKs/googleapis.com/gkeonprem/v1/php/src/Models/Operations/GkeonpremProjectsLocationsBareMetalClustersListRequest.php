...
class GkeonpremProjectsLocationsBareMetalClustersListRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GkeonpremProjectsLocationsBareMetalClustersListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?GkeonpremProjectsLocationsBareMetalClustersListViewEnum $view = null;
