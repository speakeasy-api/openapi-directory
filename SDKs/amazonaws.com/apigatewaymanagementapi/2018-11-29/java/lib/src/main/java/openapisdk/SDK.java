...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.DeleteConnectionResponse deleteConnection(openapisdk.models.operations.DeleteConnectionRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/@connections/{connectionId}", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.PostToConnectionResponse postToConnection(openapisdk.models.operations.PostToConnectionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/@connections/{connectionId}", request.pathParams);
        ...
        openapisdk.models.operations.PostToConnectionResponse res = new openapisdk.models.operations.PostToConnectionResponse() {{
            goneException = null;
            limitExceededException = null;
