...
exports.UpdateFirewallPolicyRequest = void 0;
...
var UpdateFirewallPolicyRequest = /** @class */ (function (_super) {
    ...
    ], UpdateFirewallPolicyRequest.prototype, "description", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=DryRun" }),
        __metadata("design:type", Boolean)
    ], UpdateFirewallPolicyRequest.prototype, "dryRun", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=FirewallPolicy" }),
        __metadata("design:type", firewallpolicy_1.FirewallPolicy)
    ], UpdateFirewallPolicyRequest.prototype, "firewallPolicy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=FirewallPolicyArn" }),
        __metadata("design:type", String)
    ], UpdateFirewallPolicyRequest.prototype, "firewallPolicyArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=FirewallPolicyName" }),
        __metadata("design:type", String)
    ], UpdateFirewallPolicyRequest.prototype, "firewallPolicyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=UpdateToken" }),
        __metadata("design:type", String)
    ], UpdateFirewallPolicyRequest.prototype, "updateToken", void 0);
