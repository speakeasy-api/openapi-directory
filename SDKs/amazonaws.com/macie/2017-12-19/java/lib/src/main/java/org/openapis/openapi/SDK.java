...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.ListS3ResourcesResponse listS3Resources(org.openapis.openapi.models.operations.ListS3ResourcesRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ListS3ResourcesQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
