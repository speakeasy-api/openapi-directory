...
class SearchTypeEsriLayerQueryParams:
    ...
    search_type_esri_layer_layer_type: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_esri_layer.layer_type', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchTypeEsriLayerRequest:
    query_params: SearchTypeEsriLayerQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeEsriLayerResponse:
