...
class GoogleCloudRetailV2SearchResponseFacetFacetValue:
    ...
    interval: Optional[shared_googlecloudretailv2interval.GoogleCloudRetailV2Interval] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('interval'), 'exclude': lambda f: f is None }})
