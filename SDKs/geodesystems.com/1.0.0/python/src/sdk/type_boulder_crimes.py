...
class TypeBoulderCrimes:
    ...
    def search_boulder_crimes(self, request: operations.SearchBoulderCrimesRequest) -> operations.SearchBoulderCrimesResponse:
        ...
        query_params = utils.get_query_params(operations.SearchBoulderCrimesRequest, request)
        ...
        res = operations.SearchBoulderCrimesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
