...
class PutDefaultEncryptionConfigurationRequestBody:
    encryption_type: PutDefaultEncryptionConfigurationRequestBodyEncryptionTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('encryptionType') }})
...
class PutDefaultEncryptionConfigurationRequest:
    headers: PutDefaultEncryptionConfigurationHeaders = dataclasses.field()
    request: PutDefaultEncryptionConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
