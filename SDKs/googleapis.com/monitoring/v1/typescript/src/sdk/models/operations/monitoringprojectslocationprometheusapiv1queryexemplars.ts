...
export class MonitoringProjectsLocationPrometheusApiV1QueryExemplarsSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MonitoringProjectsLocationPrometheusApiV1QueryExemplarsSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class MonitoringProjectsLocationPrometheusApiV1QueryExemplarsSecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class MonitoringProjectsLocationPrometheusApiV1QueryExemplarsSecurity extends SpeakeasyBase {
...
export class MonitoringProjectsLocationPrometheusApiV1QueryExemplarsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MonitoringProjectsLocationPrometheusApiV1QueryExemplarsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
