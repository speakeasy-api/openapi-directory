 ...
 */
export enum TargetHttpsProxiesScopedListWarningCodeEnum {
...
export class TargetHttpsProxiesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetHttpsProxiesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetHttpsProxiesScopedListWarningData })
  @Expose({ name: "data" })
...
export class TargetHttpsProxiesScopedList extends SpeakeasyBase {
  /**
   * A list of TargetHttpsProxies contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: TargetHttpsProxy })
  @Expose({ name: "targetHttpsProxies" })
