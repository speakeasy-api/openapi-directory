...
class ProxyGetAmendment:
    ...
    r"""Determines whether the subscription is automatically renewed, or whether it expires at the end of the term and needs to be manually renewed. **Required:** For amendment of type TermsAndConditions when changing the automatic renewal status of a subscription.
    **Values**: true, false
    """  
    ...
    **Character limit**: **Values**: a valid number
    ...
    r"""The period type for the current subscription term. **Values**:
