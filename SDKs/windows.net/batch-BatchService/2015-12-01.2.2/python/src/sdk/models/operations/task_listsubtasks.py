...
class TaskListSubtasksRequest:
    headers: TaskListSubtasksHeaders = dataclasses.field()
    path_params: TaskListSubtasksPathParams = dataclasses.field()
    query_params: TaskListSubtasksQueryParams = dataclasses.field()
...
class TaskListSubtasksResponse:
    ...
    cloud_task_list_subtasks_result: Optional[Any] = dataclasses.field(default=None)
