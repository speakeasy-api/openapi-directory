...
import { HttpsHealthCheck1 } from "./httpshealthcheck1";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum HttpsHealthCheckListWarningCodeEnum {
...
export declare class HttpsHealthCheckListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class HttpsHealthCheckListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: HttpsHealthCheckListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: HttpsHealthCheckListWarningData[];
    /**
 ...
 */
export declare class HttpsHealthCheckList extends SpeakeasyBase {
    /**
