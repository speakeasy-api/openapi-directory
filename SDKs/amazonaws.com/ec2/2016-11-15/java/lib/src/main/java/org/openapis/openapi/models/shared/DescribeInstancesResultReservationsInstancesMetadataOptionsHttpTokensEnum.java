 ...
 */
public enum DescribeInstancesResultReservationsInstancesMetadataOptionsHttpTokensEnum {
    OPTIONAL("optional"),
    REQUIRED("required");
    ...
    private DescribeInstancesResultReservationsInstancesMetadataOptionsHttpTokensEnum(String value) {
        this.value = value;
    }
}
