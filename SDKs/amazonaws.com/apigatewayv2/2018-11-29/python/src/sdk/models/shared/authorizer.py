...
class AuthorizerAuthorizerTypeEnum(str, Enum):
...
class Authorizer:
    ...
    authorizer_type: Optional[AuthorizerAuthorizerTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AuthorizerType'), 'exclude': lambda f: f is None }})  
    ...
    jwt_configuration: Optional[AuthorizerJwtConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('JwtConfiguration'), 'exclude': lambda f: f is None }})  
