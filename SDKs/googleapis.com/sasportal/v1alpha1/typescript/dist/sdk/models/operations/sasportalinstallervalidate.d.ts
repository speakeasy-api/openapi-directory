...
export declare class SasportalInstallerValidateSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalInstallerValidateSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
