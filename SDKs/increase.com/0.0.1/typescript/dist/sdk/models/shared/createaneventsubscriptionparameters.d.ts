 ...
 */
export declare enum CreateAnEventSubscriptionParametersSelectedEventCategoryEnum {
...
export declare class CreateAnEventSubscriptionParameters extends SpeakeasyBase {
    /**
     * If specified, this subscription will only receive webhooks for Events with the specified `category`.
     */
