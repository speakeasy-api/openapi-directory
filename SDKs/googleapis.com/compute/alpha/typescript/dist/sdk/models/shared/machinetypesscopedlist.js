...
exports.MachineTypesScopedList = exports.MachineTypesScopedListWarning = exports.MachineTypesScopedListWarningData = exports.MachineTypesScopedListWarningCodeEnum = void 0;
 ...
 */
var MachineTypesScopedListWarningCodeEnum;
(function (MachineTypesScopedListWarningCodeEnum) {
...
})(MachineTypesScopedListWarningCodeEnum = exports.MachineTypesScopedListWarningCodeEnum || (exports.MachineTypesScopedListWarningCodeEnum = {}));
var MachineTypesScopedListWarningData = /** @class */ (function (_super) {
    __extends(MachineTypesScopedListWarningData, _super);
    function MachineTypesScopedListWarningData() {
    ...
    ], MachineTypesScopedListWarningData.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "value" }),
        __metadata("design:type", String)
    ], MachineTypesScopedListWarningData.prototype, "value", void 0);
    return MachineTypesScopedListWarningData;
}(utils_1.SpeakeasyBase));
exports.MachineTypesScopedListWarningData = MachineTypesScopedListWarningData;
/**
 * [Output Only] An informational warning that appears when the machine types list is empty.
 */
var MachineTypesScopedListWarning = /** @class */ (function (_super) {
    __extends(MachineTypesScopedListWarning, _super);
    function MachineTypesScopedListWarning() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", String)
    ], MachineTypesScopedListWarning.prototype, "code", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: MachineTypesScopedListWarningData }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return MachineTypesScopedListWarningData; }),
        __metadata("design:type", Array)
    ], MachineTypesScopedListWarning.prototype, "data", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "message" }),
        __metadata("design:type", String)
    ], MachineTypesScopedListWarning.prototype, "message", void 0);
    return MachineTypesScopedListWarning;
}(utils_1.SpeakeasyBase));
exports.MachineTypesScopedListWarning = MachineTypesScopedListWarning;
var MachineTypesScopedList = /** @class */ (function (_super) {
    __extends(MachineTypesScopedList, _super);
    function MachineTypesScopedList() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: machinetype_1.MachineType }),
        (0, class_transformer_1.Expose)({ name: "machineTypes" }),
        (0, class_transformer_1.Type)(function () { return machinetype_1.MachineType; }),
        __metadata("design:type", Array)
    ], MachineTypesScopedList.prototype, "machineTypes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "warning" }),
        (0, class_transformer_1.Type)(function () { return MachineTypesScopedListWarning; }),
        __metadata("design:type", MachineTypesScopedListWarning)
    ], MachineTypesScopedList.prototype, "warning", void 0);
    return MachineTypesScopedList;
}(utils_1.SpeakeasyBase));
exports.MachineTypesScopedList = MachineTypesScopedList;
