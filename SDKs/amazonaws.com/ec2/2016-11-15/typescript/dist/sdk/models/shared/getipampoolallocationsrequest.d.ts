 ...
 */
export declare class GetIpamPoolAllocationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetIpamPoolAllocationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
