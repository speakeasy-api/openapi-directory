...
@dataclasses.dataclass
class ToolresultsProjectsHistoriesExecutionsPatchQueryParams:
...
class ToolresultsProjectsHistoriesExecutionsPatchRequest:
    path_params: ToolresultsProjectsHistoriesExecutionsPatchPathParams = dataclasses.field()
    query_params: ToolresultsProjectsHistoriesExecutionsPatchQueryParams = dataclasses.field()
    security: ToolresultsProjectsHistoriesExecutionsPatchSecurity = dataclasses.field()
    request: Optional[shared_execution.Execution] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
