...
class RatePlanUpdate:
    ...
    charge_updates: Optional[list[shared_chargeupdate.ChargeUpdate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('chargeUpdates'), 'exclude': lambda f: f is None }})  
