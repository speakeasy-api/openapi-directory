...
class GetAppLaunchConfigurationRequest:
    ...
    get_app_launch_configuration_request: shared_getapplaunchconfigurationrequest.GetAppLaunchConfigurationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
