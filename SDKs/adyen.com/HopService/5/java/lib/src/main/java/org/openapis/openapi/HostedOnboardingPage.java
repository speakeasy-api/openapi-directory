...
public class HostedOnboardingPage {
	...
	public HostedOnboardingPage(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
     ...
     */
    public org.openapis.openapi.models.operations.PostGetOnboardingUrlResponse postGetOnboardingUrl(org.openapis.openapi.models.shared.GetOnboardingUrlRequest request, org.openapis.openapi.models.operations.PostGetOnboardingUrlSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/getOnboardingUrl");
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.GetOnboardingUrlResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.GetOnboardingUrlResponse.class);
