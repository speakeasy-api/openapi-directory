...
from ..shared import listtestrecommendationsresponse as shared_listtestrecommendationsresponse
...
class ListTestRecommendationsRequest:
    ...
    request_body: ListTestRecommendationsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListTestRecommendationsResponse:
    ...
    list_test_recommendations_response: Optional[shared_listtestrecommendationsresponse.ListTestRecommendationsResponse] = dataclasses.field(default=None)
    r"""Success"""  
