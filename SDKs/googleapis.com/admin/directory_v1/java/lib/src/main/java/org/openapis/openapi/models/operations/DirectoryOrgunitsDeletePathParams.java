...
public class DirectoryOrgunitsDeletePathParams {
    /**
    ...
    public DirectoryOrgunitsDeletePathParams withCustomerId(String customerId) {
    ...
    public DirectoryOrgunitsDeletePathParams withOrgUnitPath(String orgUnitPath) {
