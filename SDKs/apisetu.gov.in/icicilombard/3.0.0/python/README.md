...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/icicilombard/3.0.0/python
```
...
req = operations.CripcRequestBody(
    certificate_parameters=operations.CripcRequestBodyCertificateParameters(
        insured_dob="DD/MM/YYYY",
        policy_no="3001/51962270/00/000",
    ),
...
res = s.ap_is.cripc(req, operations.CripcSecurity(
