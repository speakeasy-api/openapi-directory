 ...
 */
public enum DescribeImagesResultImagesBlockDeviceMappingsEbsVolumeTypeEnum {
    STANDARD("standard"),
    IO1("io1"),
    IO2("io2"),
    GP2("gp2"),
    ...
    private DescribeImagesResultImagesBlockDeviceMappingsEbsVolumeTypeEnum(String value) {
        this.value = value;
    }
}
