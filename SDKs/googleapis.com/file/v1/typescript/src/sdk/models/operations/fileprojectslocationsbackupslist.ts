...
export class FileProjectsLocationsBackupsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FileProjectsLocationsBackupsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FileProjectsLocationsBackupsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
