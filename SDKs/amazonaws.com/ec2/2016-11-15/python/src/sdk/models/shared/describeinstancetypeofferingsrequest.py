...
class DescribeInstanceTypeOfferingsRequest:
    ...
    filters: Optional[list[DescribeInstanceTypeOfferingsRequestFilters]] = dataclasses.field(default=None)  
    location_type: Optional[shared_locationtype_enum.LocationTypeEnum] = dataclasses.field(default=None)  
