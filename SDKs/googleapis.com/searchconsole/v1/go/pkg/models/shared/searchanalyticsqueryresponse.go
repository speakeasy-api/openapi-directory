...
func (e SearchAnalyticsQueryResponseResponseAggregationTypeEnum) ToPointer() *SearchAnalyticsQueryResponseResponseAggregationTypeEnum {
	return &e
}
...
func (e *SearchAnalyticsQueryResponseResponseAggregationTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "BY_PROPERTY":
		fallthrough
	case "BY_PAGE":
		*e = SearchAnalyticsQueryResponseResponseAggregationTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SearchAnalyticsQueryResponseResponseAggregationTypeEnum: %v", v)
	}
}
