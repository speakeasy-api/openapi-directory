...
type AccessapprovalProjectsUpdateAccessApprovalSettingsSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AccessapprovalProjectsUpdateAccessApprovalSettingsPathParams struct {
...
type AccessapprovalProjectsUpdateAccessApprovalSettingsQueryParams struct {
	// V1 error format.
...
type AccessapprovalProjectsUpdateAccessApprovalSettingsResponse struct {
	// Successful response
