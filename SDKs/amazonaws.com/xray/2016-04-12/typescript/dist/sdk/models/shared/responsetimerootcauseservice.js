...
var ResponseTimeRootCauseService = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: responsetimerootcauseentity_1.ResponseTimeRootCauseEntity }),
        (0, class_transformer_1.Expose)({ name: "EntityPath" }),
        (0, class_transformer_1.Type)(function () { return responsetimerootcauseentity_1.ResponseTimeRootCauseEntity; }),
