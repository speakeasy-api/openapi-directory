...
exports.AnalyticsManagementFiltersDeleteResponse = exports.AnalyticsManagementFiltersDeleteRequest = exports.AnalyticsManagementFiltersDeleteSecurity = void 0;
...
var AnalyticsManagementFiltersDeleteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AnalyticsManagementFiltersDeleteRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AnalyticsManagementFiltersDeleteRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AnalyticsManagementFiltersDeleteRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=filterId",
        }),
        __metadata("design:type", String)
    ], AnalyticsManagementFiltersDeleteRequest.prototype, "filterId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AnalyticsManagementFiltersDeleteRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AnalyticsManagementFiltersDeleteRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AnalyticsManagementFiltersDeleteRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AnalyticsManagementFiltersDeleteRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AnalyticsManagementFiltersDeleteRequest.prototype, "userIp", void 0);
...
var AnalyticsManagementFiltersDeleteResponse = /** @class */ (function (_super) {
    ...
    ], AnalyticsManagementFiltersDeleteResponse.prototype, "rawResponse", void 0);
