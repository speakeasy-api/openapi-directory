...
class ListVersionsByFunctionRequest:
    headers: ListVersionsByFunctionHeaders = dataclasses.field()
    path_params: ListVersionsByFunctionPathParams = dataclasses.field()
    query_params: ListVersionsByFunctionQueryParams = dataclasses.field()
