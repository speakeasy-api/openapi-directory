...
exports.PaymentLinkApiAllResponse = exports.PaymentLinkApiAllRequest = void 0;
...
var PaymentLinkApiAllRequest = /** @class */ (function (_super) {
    ...
    ], PaymentLinkApiAllRequest.prototype, "queryOptionsPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=queryOptions.pageSize",
        }),
        __metadata("design:type", Number)
    ], PaymentLinkApiAllRequest.prototype, "queryOptionsPageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-key",
        }),
        __metadata("design:type", String)
    ], PaymentLinkApiAllRequest.prototype, "xAuthKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-secret",
        }),
        __metadata("design:type", String)
    ], PaymentLinkApiAllRequest.prototype, "xAuthSecret", void 0);
    return PaymentLinkApiAllRequest;
}(utils_1.SpeakeasyBase));
exports.PaymentLinkApiAllRequest = PaymentLinkApiAllRequest;
var PaymentLinkApiAllResponse = /** @class */ (function (_super) {
    ...
    ], PaymentLinkApiAllResponse.prototype, "rawResponse", void 0);
    return PaymentLinkApiAllResponse;
}(utils_1.SpeakeasyBase));
exports.PaymentLinkApiAllResponse = PaymentLinkApiAllResponse;
