...
class ListPlayerStreamerListPlayerStreamerResponse:
    ...
    meta: Optional[ListPlayerStreamerListPlayerStreamerResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    player_streamers: Optional[list[shared_media_v1_player_streamer.MediaV1PlayerStreamer]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('player_streamers'), 'exclude': lambda f: f is None }})  
