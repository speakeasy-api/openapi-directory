 ...
 * An enumeration.
 */
export declare enum LatestGetV2LatestLocationIdGetOrderByLocationsOrderEnum {
    City = "city",
    Country = "country",
    Location = "location",
 ...
 * An enumeration.
 */
export declare enum LatestGetV2LatestLocationIdGetSortSortEnum {
    Asc = "asc",
    Desc = "desc"
}
export declare class LatestGetV2LatestLocationIdGetRequest extends SpeakeasyBase {
     ...
     * Order by a field
     */
    orderBy?: LatestGetV2LatestLocationIdGetOrderByLocationsOrderEnum;
    /**
     ...
     * Sort Direction
     */
    sort?: LatestGetV2LatestLocationIdGetSortSortEnum;
    /**
