...
class ResponsePolicies 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/projects/{project}/responsePolicies', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/projects/{project}/responsePolicies/{responsePolicy}', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/projects/{project}/responsePolicies/{responsePolicy}', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/projects/{project}/responsePolicies', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/projects/{project}/responsePolicies/{responsePolicy}', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/projects/{project}/responsePolicies/{responsePolicy}', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesUpdateRequest::class, $request);
