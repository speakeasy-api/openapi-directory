...
export class Map {
  ...
  getChromosomeByAssemblyUsingGET(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GETChromosomeByAssemblyUsingGETResponse =
        new operations.GETChromosomeByAssemblyUsingGETResponse({
  ...
  getChromosomesByAssemblyUsingGET(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/maps/chr/{mapKey}", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETChromosomesByAssemblyUsingGETResponse =
        new operations.GETChromosomesByAssemblyUsingGETResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getMapsBySpeciesUsingGET(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETMapsBySpeciesUsingGETResponse =
        new operations.GETMapsBySpeciesUsingGETResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
