...
var PubsubLocation = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "dropLateData" }),
        __metadata("design:type", Boolean)
    ], PubsubLocation.prototype, "dropLateData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "idLabel" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "timestampLabel" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "trackingSubscription" }),
        __metadata("design:type", String)
    ], PubsubLocation.prototype, "trackingSubscription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "withAttributes" }),
        __metadata("design:type", Boolean)
    ], PubsubLocation.prototype, "withAttributes", void 0);
    return PubsubLocation;
}(utils_1.SpeakeasyBase));
exports.PubsubLocation = PubsubLocation;
