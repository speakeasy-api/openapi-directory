...
var ApplicationGetRequest = /** @class */ (function (_super) {
    ...
    ], ApplicationGetRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ApplicationGetRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], ApplicationGetRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], ApplicationGetRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], ApplicationGetRequest.prototype, "timeout", void 0);
...
var ApplicationGetResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.ApplicationSummary)
