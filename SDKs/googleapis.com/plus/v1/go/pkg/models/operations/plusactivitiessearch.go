...
func (e PlusActivitiesSearchOrderByEnum) ToPointer() *PlusActivitiesSearchOrderByEnum {
	return &e
}
...
func (e *PlusActivitiesSearchOrderByEnum) UnmarshalJSON(data []byte) error {
	...
	case "best":
		fallthrough
	case "recent":
		*e = PlusActivitiesSearchOrderByEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PlusActivitiesSearchOrderByEnum: %v", v)
	}
}
