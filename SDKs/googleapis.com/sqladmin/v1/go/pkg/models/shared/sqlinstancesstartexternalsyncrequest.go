...
func (e SQLInstancesStartExternalSyncRequestSyncModeEnum) ToPointer() *SQLInstancesStartExternalSyncRequestSyncModeEnum {
	return &e
}
...
func (e *SQLInstancesStartExternalSyncRequestSyncModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "ONLINE":
		fallthrough
	case "OFFLINE":
		*e = SQLInstancesStartExternalSyncRequestSyncModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SQLInstancesStartExternalSyncRequestSyncModeEnum: %v", v)
	}
}
