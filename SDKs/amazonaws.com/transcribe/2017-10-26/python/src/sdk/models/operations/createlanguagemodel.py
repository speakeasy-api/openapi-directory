...
class CreateLanguageModelRequest:
    ...
    create_language_model_request: shared_createlanguagemodelrequest.CreateLanguageModelRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
