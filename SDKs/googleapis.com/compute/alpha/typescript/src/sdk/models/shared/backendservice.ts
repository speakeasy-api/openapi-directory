 ...
 */
export enum BackendServiceCompressionModeEnum {
  Automatic = "AUTOMATIC",
  Disabled = "DISABLED",
}
 ...
 */
export enum BackendServiceIpAddressSelectionPolicyEnum {
  Ipv4Only = "IPV4_ONLY",
  Ipv6Only = "IPV6_ONLY",
 ...
 */
export enum BackendServiceLoadBalancingSchemeEnum {
  External = "EXTERNAL",
 ...
 */
export enum BackendServiceLocalityLbPolicyEnum {
 ...
 */
export enum BackendServiceProtocolEnum {
  All = "ALL",
  Grpc = "GRPC",
  Http = "HTTP",
  Http2 = "HTTP2",
 ...
 */
export enum BackendServiceSessionAffinityEnum {
  ClientIp = "CLIENT_IP",
 ...
 */
export enum BackendServiceVpcNetworkScopeEnum {
...
export class BackendService extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "connectionTrackingPolicy" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "customRequestHeaders" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "ipAddressSelectionPolicy" })
   ...
   */
  @SpeakeasyMetadata({
    elemType: BackendServiceLocalityLoadBalancingPolicyConfig,
  })
  @Expose({ name: "localityLbPolicies" })
