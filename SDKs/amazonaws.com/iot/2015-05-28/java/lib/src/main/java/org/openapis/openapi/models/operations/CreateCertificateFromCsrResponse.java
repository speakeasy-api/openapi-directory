...
public class CreateCertificateFromCsrResponse {
    ...
    public org.openapis.openapi.models.shared.CreateCertificateFromCsrResponse createCertificateFromCsrResponse;

    public CreateCertificateFromCsrResponse withCreateCertificateFromCsrResponse(org.openapis.openapi.models.shared.CreateCertificateFromCsrResponse createCertificateFromCsrResponse) {
    ...
    public CreateCertificateFromCsrResponse withStatusCode(Integer statusCode) {
    ...
    public CreateCertificateFromCsrResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public CreateCertificateFromCsrResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
