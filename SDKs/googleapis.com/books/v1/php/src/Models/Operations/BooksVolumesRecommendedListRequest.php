...
class BooksVolumesRecommendedListRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\BooksVolumesRecommendedListMaxAllowedMaturityRatingEnum $maxAllowedMaturityRating
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=maxAllowedMaturityRating')]
    public ?BooksVolumesRecommendedListMaxAllowedMaturityRatingEnum $maxAllowedMaturityRating = null;
