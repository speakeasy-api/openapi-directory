...
class DeleteBotRequest:
    headers: DeleteBotHeaders = dataclasses.field()
    path_params: DeleteBotPathParams = dataclasses.field()
    query_params: DeleteBotQueryParams = dataclasses.field()
