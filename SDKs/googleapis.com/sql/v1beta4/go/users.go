...
func (s *users) SQLUsersDelete(ctx context.Context, request operations.SQLUsersDeleteRequest) (*operations.SQLUsersDeleteResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/sql/v1beta4/projects/{project}/instances/{instance}/users", request.PathParams, nil)
...
func (s *users) SQLUsersGet(ctx context.Context, request operations.SQLUsersGetRequest) (*operations.SQLUsersGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/sql/v1beta4/projects/{project}/instances/{instance}/users/{name}", request.PathParams, nil)
