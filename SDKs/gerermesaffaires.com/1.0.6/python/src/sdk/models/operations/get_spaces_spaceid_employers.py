...
class GetSpacesSpaceIDEmployersRequest:
    ...
    r"""EmployeeNumber of the employer contract"""  
...
class GetSpacesSpaceIDEmployersResponse:
    ...
    get_spaces_space_id_employers_200_application_json_all_ofs: Optional[list[shared_employee.Employee]] = dataclasses.field(default=None)
