...
from ..shared import adcode as shared_adcode
...
class AdsenseAdunitsGetAdCodeSecurity:
    ...
    option1: Optional[AdsenseAdunitsGetAdCodeSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[AdsenseAdunitsGetAdCodeSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class AdsenseAdunitsGetAdCodeResponse:
    ...
    ad_code: Optional[shared_adcode.AdCode] = dataclasses.field(default=None)
