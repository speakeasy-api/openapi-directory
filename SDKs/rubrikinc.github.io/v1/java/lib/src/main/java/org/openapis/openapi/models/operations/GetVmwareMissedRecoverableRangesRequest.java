...
public class GetVmwareMissedRecoverableRangesRequest {
    /**
    ...
    public GetVmwareMissedRecoverableRangesRequest withAfterTime(OffsetDateTime afterTime) {
    ...
    public GetVmwareMissedRecoverableRangesRequest withBeforeTime(OffsetDateTime beforeTime) {
    ...
    public GetVmwareMissedRecoverableRangesRequest withId(String id) {
        this.id = id;
        return this;
    }
    
    public GetVmwareMissedRecoverableRangesRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
