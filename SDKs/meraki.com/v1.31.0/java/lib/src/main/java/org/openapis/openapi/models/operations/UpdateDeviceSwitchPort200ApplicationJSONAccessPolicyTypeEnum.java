 ...
 */
public enum UpdateDeviceSwitchPort200ApplicationJSONAccessPolicyTypeEnum {
    ...
    private UpdateDeviceSwitchPort200ApplicationJSONAccessPolicyTypeEnum(String value) {
        this.value = value;
    }
}
