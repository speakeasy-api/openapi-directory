 ...
 */
export enum CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({
    elemType:
      CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsTags,
  })
  tags?: CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsTags[];
}

export class CreateLocalGatewayRouteTableVpcAssociationRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
  ...
  @SpeakeasyMetadata({
    elemType:
      CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecifications,
  })
