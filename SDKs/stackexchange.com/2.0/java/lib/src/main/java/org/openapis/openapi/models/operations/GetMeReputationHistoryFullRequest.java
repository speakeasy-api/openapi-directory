...
public class GetMeReputationHistoryFullRequest {
    ...
    public GetMeReputationHistoryFullRequest withCallback(String callback) {
    ...
    public GetMeReputationHistoryFullRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeReputationHistoryFullRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeReputationHistoryFullRequest withPagesize(Long pagesize) {
    ...
    public GetMeReputationHistoryFullRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    public GetMeReputationHistoryFullRequest(@JsonProperty("site") String site) {
        this.site = site;
  }
}
