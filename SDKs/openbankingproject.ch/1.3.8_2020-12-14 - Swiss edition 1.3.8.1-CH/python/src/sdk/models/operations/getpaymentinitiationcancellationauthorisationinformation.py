...
class GetPaymentInitiationCancellationAuthorisationInformationPathParams:
...
@dataclasses.dataclass
class GetPaymentInitiationCancellationAuthorisationInformationHeaders:
...
@dataclasses.dataclass
class GetPaymentInitiationCancellationAuthorisationInformationSecurity:
...
@dataclasses.dataclass
class GetPaymentInitiationCancellationAuthorisationInformationRequest:
    headers: GetPaymentInitiationCancellationAuthorisationInformationHeaders = dataclasses.field()
    path_params: GetPaymentInitiationCancellationAuthorisationInformationPathParams = dataclasses.field()
    security: GetPaymentInitiationCancellationAuthorisationInformationSecurity = dataclasses.field()
    

@dataclasses.dataclass
class GetPaymentInitiationCancellationAuthorisationInformationResponse:
