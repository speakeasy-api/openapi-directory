...
type CreateInternationalPaymentsJSONSecurity struct {
	PSUOAuth2Security shared.SchemePsuoAuth2Security `security:"scheme,type=oauth2"`
}

type CreateInternationalPaymentsJSONHeaders struct {
...
type CreateInternationalPaymentsJSONRequest struct {
	Headers CreateInternationalPaymentsJSONHeaders
	// Default
	Request  shared.OBWriteInternational3 `request:"mediaType=application/json"`
	Security CreateInternationalPaymentsJSONSecurity
}

type CreateInternationalPaymentsJSONResponse struct {
	Body        []byte
	ContentType string
