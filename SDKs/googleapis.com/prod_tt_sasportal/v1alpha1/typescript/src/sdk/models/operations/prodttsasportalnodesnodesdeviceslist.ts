...
export class ProdTtSasportalNodesNodesDevicesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ProdTtSasportalNodesNodesDevicesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ProdTtSasportalNodesNodesDevicesListSecurity extends SpeakeasyBase {
...
export class ProdTtSasportalNodesNodesDevicesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ProdTtSasportalNodesNodesDevicesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
