...
class ListIndexRequestBody:
    index_reference: ListIndexRequestBodyIndexReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('IndexReference') }})
...
class ListIndexRequest:
    headers: ListIndexHeaders = dataclasses.field()
    query_params: ListIndexQueryParams = dataclasses.field()
    request: ListIndexRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
