...
class ReceivableCreateDTORateOriginEnum(str, Enum):
    PRICE_PROFILE = 'PRICE_PROFILE'
    PRICE_LIST = 'PRICE_LIST'
    FILLED_MANUALLY = 'FILLED_MANUALLY'
    AUTOCALCULATED = 'AUTOCALCULATED'

class ReceivableCreateDTOTypeEnum(str, Enum):
    SIMPLE = 'SIMPLE'
    CAT = 'CAT'
...
class ReceivableCreateDTO:
    ...
    rate_origin: Optional[ReceivableCreateDTORateOriginEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rateOrigin'), 'exclude': lambda f: f is None }})  
    ...
    type: Optional[ReceivableCreateDTOTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
