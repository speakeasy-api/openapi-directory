...
from ..shared import security as shared_security
from ..shared import debuginstancerequest as shared_debuginstancerequest
...
class AppengineAppsServicesVersionsInstancesDebugRequest:
    path_params: AppengineAppsServicesVersionsInstancesDebugPathParams = dataclasses.field()
    query_params: AppengineAppsServicesVersionsInstancesDebugQueryParams = dataclasses.field()
    security: AppengineAppsServicesVersionsInstancesDebugSecurity = dataclasses.field()
    request: Optional[shared_debuginstancerequest.DebugInstanceRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
