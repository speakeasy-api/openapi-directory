...
@dataclasses.dataclass
class GetNetworkWirelessBluetoothSettings200ApplicationJSON:
...
class GetNetworkWirelessBluetoothSettingsResponse:
    ...
    get_network_wireless_bluetooth_settings_200_application_json_object: Optional[GetNetworkWirelessBluetoothSettings200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
