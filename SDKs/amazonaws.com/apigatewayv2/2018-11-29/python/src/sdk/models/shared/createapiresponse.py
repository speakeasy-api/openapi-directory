...
class CreateAPIResponseCorsConfiguration:
    r"""CreateAPIResponseCorsConfiguration
...
class CreateAPIResponse:
    ...
    cors_configuration: Optional[CreateAPIResponseCorsConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CorsConfiguration') }})
