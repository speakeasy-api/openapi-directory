...
public class BINListDownloadQueryParams {
    /**
    ...
    public BINListDownloadQueryParams withInclude8digit(Boolean include8digit) {
    ...
    public BINListDownloadQueryParams withIncludeIso3(Boolean includeIso3) {
