...
class PrivateArticleDetailsPathParams:
...
class PrivateArticleDetailsRequest:
    path_params: PrivateArticleDetailsPathParams = dataclasses.field()
    security: PrivateArticleDetailsSecurity = dataclasses.field()
