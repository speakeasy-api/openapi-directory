...
from ..shared import security as shared_security
from ..shared import publishxunitxmlfilesrequest as shared_publishxunitxmlfilesrequest
...
class ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXMLFilesRequest:
    path_params: ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXMLFilesPathParams = dataclasses.field()
    query_params: ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXMLFilesQueryParams = dataclasses.field()
    security: ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXMLFilesSecurity = dataclasses.field()
    request: Optional[shared_publishxunitxmlfilesrequest.PublishXunitXMLFilesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
