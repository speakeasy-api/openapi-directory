...
public class POSTRevenueScheduleByTransactionTypeRevenueEvent {
    ...
    public POSTRevenueScheduleByTransactionTypeRevenueEventEventTypeEnum eventType;
    public POSTRevenueScheduleByTransactionTypeRevenueEvent withEventType(POSTRevenueScheduleByTransactionTypeRevenueEventEventTypeEnum eventType) {
    ...
    public POSTRevenueScheduleByTransactionTypeRevenueEvent withEventTypeSystemId(String eventTypeSystemId) {
    ...
    @JsonProperty("notes")
    public String notes;
    public POSTRevenueScheduleByTransactionTypeRevenueEvent withNotes(String notes) {
        this.notes = notes;
        return this;
    }
