...
* [delcs](#delcs) - Dealer License
* [malcs](#malcs) - Manufacturer License
* [palcs](#palcs) - Packers License
* [relcs](#relcs) - Repairer License
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DelcsResponse res = sdk.apIs.delcs(req, new DelcsSecurity("maiores", "molestiae") {{
    ...
    public static void main(String[] args) {
        try {
            ...
            MalcsRequestBody req = new MalcsRequestBody(MalcsRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new MalcsRequestBodyCertificateParameters("181527xxxxxxx7", "53453xxxxxx11");;
            ...
            MalcsResponse res = sdk.apIs.malcs(req, new MalcsSecurity("qui", "impedit") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
...
import java.time.OffsetDateTime;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.PalcsRequestBody;
import org.openapis.openapi.models.operations.PalcsRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.PalcsRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.PalcsResponse;
import org.openapis.openapi.models.operations.PalcsSecurity;
import org.openapis.openapi.models.shared.ConsentArtifactSchema;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsent;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentData;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentDataConsumer;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PalcsRequestBody req = new PalcsRequestBody(PalcsRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new PalcsRequestBodyCertificateParameters("181527xxxxxxx7", "53453xxxxxx11");;
            ...
            PalcsResponse res = sdk.apIs.palcs(req, new PalcsSecurity("iure", "saepe") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
...
import java.time.OffsetDateTime;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.RelcsRequestBody;
import org.openapis.openapi.models.operations.RelcsRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.RelcsRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.RelcsResponse;
import org.openapis.openapi.models.operations.RelcsSecurity;
import org.openapis.openapi.models.shared.ConsentArtifactSchema;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsent;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentData;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentDataConsumer;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            RelcsRequestBody req = new RelcsRequestBody(RelcsRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new RelcsRequestBodyCertificateParameters("181527xxxxxxx7", "53453xxxxxx11");;
            ...
            RelcsResponse res = sdk.apIs.relcs(req, new RelcsSecurity("culpa", "doloribus") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
