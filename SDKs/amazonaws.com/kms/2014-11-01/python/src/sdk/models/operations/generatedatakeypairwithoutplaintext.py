...
class GenerateDataKeyPairWithoutPlaintextRequest:
    headers: GenerateDataKeyPairWithoutPlaintextHeaders = dataclasses.field()
    request: shared_generatedatakeypairwithoutplaintextrequest.GenerateDataKeyPairWithoutPlaintextRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
