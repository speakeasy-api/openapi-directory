...
class CreateAuthorizerResponseAuthorizerTypeEnum(str, Enum):
...
class CreateAuthorizerResponse:
    ...
    authorizer_type: Optional[CreateAuthorizerResponseAuthorizerTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AuthorizerType'), 'exclude': lambda f: f is None }})  
    ...
    jwt_configuration: Optional[CreateAuthorizerResponseJwtConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('JwtConfiguration'), 'exclude': lambda f: f is None }})  
