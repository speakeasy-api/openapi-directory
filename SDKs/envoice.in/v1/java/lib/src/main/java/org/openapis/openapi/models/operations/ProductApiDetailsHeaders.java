...
public class ProductApiDetailsHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ProductApiDetailsHeaders withXAuthKey(String xAuthKey) {
    ...
    public ProductApiDetailsHeaders withXAuthSecret(String xAuthSecret) {
