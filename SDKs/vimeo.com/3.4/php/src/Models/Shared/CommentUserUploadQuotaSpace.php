...
class CommentUserUploadQuotaSpace
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CommentUserUploadQuotaSpaceShowingEnum $showing
     */
	#[\JMS\Serializer\Annotation\SerializedName('showing')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CommentUserUploadQuotaSpaceShowingEnum>')]
	...
	public function __construct()
	{
		$this->free = 0;
		$this->max = 0;
		$this->showing = \OpenAPI\OpenAPI\Models\Shared\CommentUserUploadQuotaSpaceShowingEnum::LIFETIME;
		$this->used = 0;
	}
}
