...
type SavingsOpportunity struct {
	EstimatedMonthlySavings      *EstimatedMonthlySavings `json:"estimatedMonthlySavings,omitempty"`
	SavingsOpportunityPercentage *float64                 `json:"savingsOpportunityPercentage,omitempty"`
}
