...
export class TeamRepositoryPermissions extends SpeakeasyBase {
...
export class TeamRepositoryRepositoryPermissions extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=admin" })
  admin: boolean;
...
export class TeamRepositoryRepositoryTemplateRepositoryOwner extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=avatar_url" })
  avatarUrl?: string;
...
export class TeamRepositoryRepositoryTemplateRepositoryPermissions extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=admin" })
  admin?: boolean;
...
export class TeamRepositoryRepositoryTemplateRepository extends SpeakeasyBase {
...
**/
export class TeamRepository extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=allow_merge_commit" })
  allowMergeCommit?: boolean;
