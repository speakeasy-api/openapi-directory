...
class ResponsePolicyRules 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DnsResponsePolicyRulesCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}/rules', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePolicyRulesCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePolicyRulesDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePolicyRulesGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}/rules', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePolicyRulesListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePolicyRulesPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePolicyRulesUpdateRequest::class, $request);
