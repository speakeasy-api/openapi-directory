...
class GetV2ActionsJSONRequest:
    ...
    r"""Filters actions by cadence_id. Multiple cadence ids can be applied"""  
    due_on: Optional[list[str]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'due_on', 'style': 'form', 'explode': False }})
    r"""Equality filters that are applied to the due_on field. A single filter can be used by itself or combined with other filters to create a range.
    ...
    multitouch_group_id: Optional[list[int]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'multitouch_group_id', 'style': 'form', 'explode': False }})
    r"""Filters actions by multitouch_group_id. Multiple multitouch group ids can be applied"""  
    ...
    r"""Filters actions by person_id. Multiple person ids can be applied"""  
    ...
    r"""Fetch actions by step ID"""  
    type: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
    r"""Filter actions by type"""  
    ...
    r"""Filters actions by the user's guid. Multiple user guids can be applied. The user must be a team admin to filter other users' actions"""  
