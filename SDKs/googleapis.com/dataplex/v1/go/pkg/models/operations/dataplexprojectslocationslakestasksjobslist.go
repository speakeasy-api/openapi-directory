...
type DataplexProjectsLocationsLakesTasksJobsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DataplexProjectsLocationsLakesTasksJobsListPathParams struct {
...
type DataplexProjectsLocationsLakesTasksJobsListQueryParams struct {
	// V1 error format.
...
type DataplexProjectsLocationsLakesTasksJobsListRequest struct {
...
type DataplexProjectsLocationsLakesTasksJobsListResponse struct {
	ContentType string
	// Successful response
