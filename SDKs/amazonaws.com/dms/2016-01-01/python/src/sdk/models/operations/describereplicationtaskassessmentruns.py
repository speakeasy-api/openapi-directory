...
class DescribeReplicationTaskAssessmentRunsRequest:
    ...
    describe_replication_task_assessment_runs_message: shared_describereplicationtaskassessmentrunsmessage.DescribeReplicationTaskAssessmentRunsMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
