 ...
 */
public enum RequestSpotFleetRequestSpotFleetRequestConfigAllocationStrategyEnum {
    ...
    private RequestSpotFleetRequestSpotFleetRequestConfigAllocationStrategyEnum(String value) {
        this.value = value;
    }
}
