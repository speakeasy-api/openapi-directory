 ...
 */
export enum CreateVpcRequestInstanceTenancyEnum {
  Default = "default",
  Dedicated = "dedicated",
  Host = "host",
}
 ...
 */
export enum CreateVpcRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateVpcRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateVpcRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateVpcRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateVpcRequestTagSpecificationsTags })
...
export class CreateVpcRequest extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: CreateVpcRequestTagSpecifications })
