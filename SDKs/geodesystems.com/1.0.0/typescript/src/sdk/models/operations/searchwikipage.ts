...
export class SearchWikipageRequest extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=search.wikipage.category",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=search.wikipage.wikitext",
  })
...
export class SearchWikipageResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
