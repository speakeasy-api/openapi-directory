...
exports.ReposUploadReleaseAssetResponse = exports.ReposUploadReleaseAssetRequest = exports.ReposUploadReleaseAssetServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.ReposUploadReleaseAssetServerList = ["https://{origin}"];
var ReposUploadReleaseAssetRequest = /** @class */ (function (_super) {
    ...
    ], ReposUploadReleaseAssetRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=label" }),
        __metadata("design:type", String)
    ], ReposUploadReleaseAssetRequest.prototype, "label", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], ReposUploadReleaseAssetRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=owner",
        }),
        __metadata("design:type", String)
    ], ReposUploadReleaseAssetRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=release_id",
        }),
        __metadata("design:type", Number)
    ], ReposUploadReleaseAssetRequest.prototype, "releaseId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], ReposUploadReleaseAssetRequest.prototype, "repo", void 0);
...
var ReposUploadReleaseAssetResponse = /** @class */ (function (_super) {
    ...
    ], ReposUploadReleaseAssetResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
