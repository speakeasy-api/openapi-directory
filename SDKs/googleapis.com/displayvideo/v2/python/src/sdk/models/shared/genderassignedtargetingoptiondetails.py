...
class GenderAssignedTargetingOptionDetails:
    ...
    gender: Optional[GenderAssignedTargetingOptionDetailsGenderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('gender') }})
