...
from ..shared import mediatypeholder as shared_mediatypeholder


@dataclass_json
@dataclasses.dataclass
class MediaTypeHolderWrapped:
    ...
    results: Optional[list[shared_mediatypeholder.MediaTypeHolder]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
