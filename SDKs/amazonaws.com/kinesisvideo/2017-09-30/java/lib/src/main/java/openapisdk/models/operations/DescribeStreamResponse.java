...
public class DescribeStreamResponse {
    ...
    public DescribeStreamResponse withClientLimitExceededException(Object clientLimitExceededException) {
    ...
    public DescribeStreamResponse withNotAuthorizedException(Object notAuthorizedException) {
