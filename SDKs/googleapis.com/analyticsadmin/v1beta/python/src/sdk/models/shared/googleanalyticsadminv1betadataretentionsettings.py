...
class GoogleAnalyticsAdminV1betaDataRetentionSettings:
    ...
    event_data_retention: Optional[GoogleAnalyticsAdminV1betaDataRetentionSettingsEventDataRetentionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('eventDataRetention'), 'exclude': lambda f: f is None }})
    r"""The length of time that event-level data is retained."""  
