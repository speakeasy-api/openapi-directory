...
exports.ImportAsProvisionedProductResponse = exports.ImportAsProvisionedProductRequest = exports.ImportAsProvisionedProductXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var ImportAsProvisionedProductXAmzTargetEnum;
...
})(ImportAsProvisionedProductXAmzTargetEnum = exports.ImportAsProvisionedProductXAmzTargetEnum || (exports.ImportAsProvisionedProductXAmzTargetEnum = {}));
var ImportAsProvisionedProductRequest = /** @class */ (function (_super) {
    ...
    ], ImportAsProvisionedProductRequest.prototype, "importAsProvisionedProductInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], ImportAsProvisionedProductRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], ImportAsProvisionedProductRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], ImportAsProvisionedProductRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], ImportAsProvisionedProductRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], ImportAsProvisionedProductRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], ImportAsProvisionedProductRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], ImportAsProvisionedProductRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], ImportAsProvisionedProductRequest.prototype, "xAmzTarget", void 0);
    return ImportAsProvisionedProductRequest;
}(utils_1.SpeakeasyBase));
exports.ImportAsProvisionedProductRequest = ImportAsProvisionedProductRequest;
var ImportAsProvisionedProductResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ImportAsProvisionedProductResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.ImportAsProvisionedProductResponse = ImportAsProvisionedProductResponse;
