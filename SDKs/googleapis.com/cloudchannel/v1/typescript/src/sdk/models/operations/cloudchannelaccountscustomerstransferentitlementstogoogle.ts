...
export class CloudchannelAccountsCustomersTransferEntitlementsToGoogleSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersTransferEntitlementsToGoogleRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersTransferEntitlementsToGoogleResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
