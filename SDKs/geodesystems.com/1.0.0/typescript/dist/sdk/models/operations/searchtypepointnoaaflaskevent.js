...
exports.SearchTypePointNoaaFlaskEventResponse = exports.SearchTypePointNoaaFlaskEventRequest = exports.SearchTypePointNoaaFlaskEventQueryParams = void 0;
...
var SearchTypePointNoaaFlaskEventQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_noaa_flask_event.lab_id_number" }),
        __metadata("design:type", String)
    ], SearchTypePointNoaaFlaskEventQueryParams.prototype, "searchTypePointNoaaFlaskEventLabIdNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_noaa_flask_event.measurement_group" }),
        __metadata("design:type", String)
    ], SearchTypePointNoaaFlaskEventQueryParams.prototype, "searchTypePointNoaaFlaskEventMeasurementGroup", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_noaa_flask_event.parameter" }),
        __metadata("design:type", String)
    ], SearchTypePointNoaaFlaskEventQueryParams.prototype, "searchTypePointNoaaFlaskEventParameter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_noaa_flask_event.project" }),
        __metadata("design:type", String)
    ], SearchTypePointNoaaFlaskEventQueryParams.prototype, "searchTypePointNoaaFlaskEventProject", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_noaa_flask_event.site_id" }),
        __metadata("design:type", String)
...
exports.SearchTypePointNoaaFlaskEventQueryParams = SearchTypePointNoaaFlaskEventQueryParams;
