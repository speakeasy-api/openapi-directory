 ...
 */
export enum CommitmentsScopedListWarningCodeEnum {
...
export class CommitmentsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class CommitmentsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: CommitmentsScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: CommitmentsScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => CommitmentsScopedListWarningData)
  data?: CommitmentsScopedListWarningData[];
...
export class CommitmentsScopedList extends SpeakeasyBase {
  /**
