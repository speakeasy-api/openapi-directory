...
class UpdateComponentConfigurationRequest:
    ...
    update_component_configuration_request: shared_updatecomponentconfigurationrequest.UpdateComponentConfigurationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
