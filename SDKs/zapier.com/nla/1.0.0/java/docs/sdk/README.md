...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CheckResponse res = sdk.sdk.check(new CheckSecurity() {{
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.ExecuteAppActionEndpointRequest;
import org.openapis.openapi.models.operations.ExecuteAppActionEndpointResponse;
import org.openapis.openapi.models.operations.ExecuteAppActionEndpointSecurity;
import org.openapis.openapi.models.shared.ExecuteRequest;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ExecuteAppActionEndpointRequest req = new ExecuteAppActionEndpointRequest(                new ExecuteRequest("corrupti") {{
                                previewOnly = false;
                            }};, "provident");            

            ExecuteAppActionEndpointResponse res = sdk.sdk.executeAppActionEndpoint(req, new ExecuteAppActionEndpointSecurity() {{
                accessPointApiKeyHeader = "YOUR_API_KEY_HERE";
            }});

            if (res.executeResponse != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.GetConfigurationLinkResponse;
import org.openapis.openapi.models.operations.GetConfigurationLinkSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetConfigurationLinkResponse res = sdk.sdk.getConfigurationLink(new GetConfigurationLinkSecurity() {{
                accessPointApiKeyHeader = "YOUR_API_KEY_HERE";
            }});
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.GetExecutionLogEndpointRequest;
import org.openapis.openapi.models.operations.GetExecutionLogEndpointResponse;
import org.openapis.openapi.models.operations.GetExecutionLogEndpointSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetExecutionLogEndpointRequest req = new GetExecutionLogEndpointRequest("distinctio");            

            GetExecutionLogEndpointResponse res = sdk.sdk.getExecutionLogEndpoint(req, new GetExecutionLogEndpointSecurity() {{
                accessPointApiKeyHeader = "YOUR_API_KEY_HERE";
            }});
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.ListExposedActionsResponse;
import org.openapis.openapi.models.operations.ListExposedActionsSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ListExposedActionsResponse res = sdk.sdk.listExposedActions(new ListExposedActionsSecurity() {{
                accessPointApiKeyHeader = "YOUR_API_KEY_HERE";
            }});

            if (res.exposedActionResponseSchema != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
