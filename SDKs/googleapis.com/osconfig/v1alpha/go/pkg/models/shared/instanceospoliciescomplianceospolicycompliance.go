...
func (e *InstanceOSPoliciesComplianceOSPolicyComplianceStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "NO_OS_POLICIES_APPLICABLE":
		*e = InstanceOSPoliciesComplianceOSPolicyComplianceStateEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for InstanceOSPoliciesComplianceOSPolicyComplianceStateEnum: %s", s)
	}
}
