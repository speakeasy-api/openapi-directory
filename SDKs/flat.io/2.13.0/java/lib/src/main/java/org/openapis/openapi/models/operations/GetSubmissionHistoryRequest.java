...
public class GetSubmissionHistoryRequest {
    ...
    public GetSubmissionHistoryRequest(@JsonProperty("assignment") String assignment, @JsonProperty("class") String class_, @JsonProperty("submission") String submission) {
        this.assignment = assignment;
        this.class_ = class_;
        this.submission = submission;
  }
