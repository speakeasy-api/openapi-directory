...
public class LinksGetChannelsLink {
    ...
    public LinksGetChannelsLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksGetChannelsLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksGetChannelsLink withDescription(String description) {
    ...
    public LinksGetChannelsLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksGetChannelsLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksGetChannelsLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksGetChannelsLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksGetChannelsLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksGetChannelsLink withOperationId(String operationId) {
    ...
    public LinksGetChannelsLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksGetChannelsLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksGetChannelsLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
