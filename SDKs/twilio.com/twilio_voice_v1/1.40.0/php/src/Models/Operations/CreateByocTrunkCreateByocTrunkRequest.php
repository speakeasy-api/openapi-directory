...
class CreateByocTrunkCreateByocTrunkRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CreateByocTrunkCreateByocTrunkRequestStatusCallbackMethodEnum $statusCallbackMethod
     */
	#[SpeakeasyMetadata('form:name=StatusCallbackMethod')]
    public ?CreateByocTrunkCreateByocTrunkRequestStatusCallbackMethodEnum $statusCallbackMethod = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CreateByocTrunkCreateByocTrunkRequestVoiceFallbackMethodEnum $voiceFallbackMethod
     */
	#[SpeakeasyMetadata('form:name=VoiceFallbackMethod')]
    public ?CreateByocTrunkCreateByocTrunkRequestVoiceFallbackMethodEnum $voiceFallbackMethod = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CreateByocTrunkCreateByocTrunkRequestVoiceMethodEnum $voiceMethod
     */
	#[SpeakeasyMetadata('form:name=VoiceMethod')]
    public ?CreateByocTrunkCreateByocTrunkRequestVoiceMethodEnum $voiceMethod = null;
