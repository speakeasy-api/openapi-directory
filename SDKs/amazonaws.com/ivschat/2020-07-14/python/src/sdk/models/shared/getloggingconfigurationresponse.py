...
from ..shared import loggingconfigurationstate_enum as shared_loggingconfigurationstate_enum
...
class GetLoggingConfigurationResponse:
    ...
    state: Optional[shared_loggingconfigurationstate_enum.LoggingConfigurationStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})  
