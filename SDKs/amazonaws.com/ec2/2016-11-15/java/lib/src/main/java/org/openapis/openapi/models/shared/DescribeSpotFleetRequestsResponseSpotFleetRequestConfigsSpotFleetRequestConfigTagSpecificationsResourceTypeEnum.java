 ...
 */
public enum DescribeSpotFleetRequestsResponseSpotFleetRequestConfigsSpotFleetRequestConfigTagSpecificationsResourceTypeEnum {
    ...
    private DescribeSpotFleetRequestsResponseSpotFleetRequestConfigsSpotFleetRequestConfigTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
