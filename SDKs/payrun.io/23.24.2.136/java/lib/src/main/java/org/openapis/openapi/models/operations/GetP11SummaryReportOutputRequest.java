...
public class GetP11SummaryReportOutputRequest {
    ...
    public GetP11SummaryReportOutputRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("EmployerKey") String employerKey, @JsonProperty("PayScheduleKey") String payScheduleKey, @JsonProperty("TaxYear") String taxYear) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.employerKey = employerKey;
        this.payScheduleKey = payScheduleKey;
