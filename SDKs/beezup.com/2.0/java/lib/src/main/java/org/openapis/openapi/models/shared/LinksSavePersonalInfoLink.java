...
public class LinksSavePersonalInfoLink {
    ...
    public LinksSavePersonalInfoLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksSavePersonalInfoLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksSavePersonalInfoLink withDescription(String description) {
    ...
    public LinksSavePersonalInfoLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksSavePersonalInfoLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksSavePersonalInfoLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksSavePersonalInfoLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksSavePersonalInfoLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksSavePersonalInfoLink withOperationId(String operationId) {
    ...
    public LinksSavePersonalInfoLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksSavePersonalInfoLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksSavePersonalInfoLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
