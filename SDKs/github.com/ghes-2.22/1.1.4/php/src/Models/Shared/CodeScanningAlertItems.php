...
class CodeScanningAlertItems
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CodeScanningAlertClassificationEnum $classification
     */
	#[\JMS\Serializer\Annotation\SerializedName('classification')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CodeScanningAlertClassificationEnum>')]
	...
	{
		$this->classification = \OpenAPI\OpenAPI\Models\Shared\CodeScanningAlertClassificationEnum::SOURCE;
		...
		$this->htmlUrl = "";
		$this->instance = new \OpenAPI\OpenAPI\Models\Shared\CodeScanningAlertInstance();
		$this->number = 0;
