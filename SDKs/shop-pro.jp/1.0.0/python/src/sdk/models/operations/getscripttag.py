...
class GetScriptTag200ApplicationJSONScriptTag:
    ...
    display_scope: Optional[GetScriptTag200ApplicationJSONScriptTagDisplayScopeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('display_scope'), 'exclude': lambda f: f is None }})
    r"""スクリプトを出力するページ。
...
class GetScriptTag200ApplicationJSON:
    ...
    script_tag: Optional[GetScriptTag200ApplicationJSONScriptTag] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('script_tag'), 'exclude': lambda f: f is None }})  
