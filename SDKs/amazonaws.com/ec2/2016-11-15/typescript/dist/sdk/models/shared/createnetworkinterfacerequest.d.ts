 ...
 */
export declare class CreateNetworkInterfaceRequestIpv4Prefixes extends SpeakeasyBase {
    ipv4Prefix?: string;
}
/**
 * Describes an IPv6 address.
 */
export declare class CreateNetworkInterfaceRequestIpv6Addresses extends SpeakeasyBase {
    ipv6Address?: string;
}
/**
 * Describes the IPv4 prefix option for a network interface.
 */
export declare class CreateNetworkInterfaceRequestIpv6Prefixes extends SpeakeasyBase {
    ipv6Prefix?: string;
}
/**
 * Describes a secondary private IPv4 address for a network interface.
 */
export declare class CreateNetworkInterfaceRequestPrivateIpAddresses extends SpeakeasyBase {
    primary?: boolean;
 ...
 */
export declare enum CreateNetworkInterfaceRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateNetworkInterfaceRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateNetworkInterfaceRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateNetworkInterfaceRequest extends SpeakeasyBase {
    clientToken?: string;
    description?: string;
    dryRun?: boolean;
    groups?: string[];
