...
import { InstanceGroupsScopedList } from "./instancegroupsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum InstanceGroupAggregatedListWarningCodeEnum {
...
export declare class InstanceGroupAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InstanceGroupAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InstanceGroupAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InstanceGroupAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class InstanceGroupAggregatedList extends SpeakeasyBase {
    /**
