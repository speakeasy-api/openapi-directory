...
class CreateIncomingPhoneNumberTollFreeCreateIncomingPhoneNumberTollFreeRequest:
    ...
    r"""The SID of the application that should handle SMS messages sent to the new phone number. If an `sms_application_sid` is present, we ignore all `sms_*_url` values and use those of the application."""  
    ...
    r"""The SID of the application we should use to handle calls to the new phone number. If a `voice_application_sid` is present, we ignore all of the voice urls and use those set on the application. Setting a `voice_application_sid` will automatically delete your `trunk_sid` and vice versa."""  
...
class CreateIncomingPhoneNumberTollFreeRequest:
    ...
    request_body: Optional[CreateIncomingPhoneNumberTollFreeCreateIncomingPhoneNumberTollFreeRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
