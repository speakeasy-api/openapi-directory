...
export class DeleteStreamingDistribution20190326Request extends SpeakeasyBase {
  /**
   * The distribution ID.
   */
...
export class DeleteStreamingDistribution20190326Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
