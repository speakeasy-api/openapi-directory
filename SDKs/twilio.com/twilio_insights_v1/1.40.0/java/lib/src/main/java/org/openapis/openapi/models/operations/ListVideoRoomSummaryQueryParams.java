...
public class ListVideoRoomSummaryQueryParams {
    ...
    public ListVideoRoomSummaryQueryParams withCodec(org.openapis.openapi.models.shared.VideoRoomSummaryEnumCodecEnum[] codec) {
        this.codec = codec;
        return this;
    }
    ...
    public Long page;
    public ListVideoRoomSummaryQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListVideoRoomSummaryQueryParams withPageToken(String pageToken) {
    ...
    public ListVideoRoomSummaryQueryParams withRoomType(org.openapis.openapi.models.shared.VideoRoomSummaryEnumRoomTypeEnum[] roomType) {
