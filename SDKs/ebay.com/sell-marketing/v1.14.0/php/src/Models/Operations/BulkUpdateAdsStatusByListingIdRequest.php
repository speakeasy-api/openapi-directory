...
class BulkUpdateAdsStatusByListingIdRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\BulkUpdateAdStatusByListingIdRequest $bulkUpdateAdStatusByListingIdRequest
     */
	#[SpeakeasyMetadata('request:mediaType=application/json')]
    public \OpenAPI\OpenAPI\Models\Shared\BulkUpdateAdStatusByListingIdRequest $bulkUpdateAdStatusByListingIdRequest;
	...
	{
		$this->bulkUpdateAdStatusByListingIdRequest = new \OpenAPI\OpenAPI\Models\Shared\BulkUpdateAdStatusByListingIdRequest();
		$this->campaignId = "";
	}
}
