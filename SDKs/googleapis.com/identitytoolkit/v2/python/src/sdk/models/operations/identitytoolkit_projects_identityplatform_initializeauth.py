...
class IdentitytoolkitProjectsIdentityPlatformInitializeAuthRequest:
    path_params: IdentitytoolkitProjectsIdentityPlatformInitializeAuthPathParams = dataclasses.field()
    query_params: IdentitytoolkitProjectsIdentityPlatformInitializeAuthQueryParams = dataclasses.field()
    security: IdentitytoolkitProjectsIdentityPlatformInitializeAuthSecurity = dataclasses.field()
...
class IdentitytoolkitProjectsIdentityPlatformInitializeAuthResponse:
    ...
    google_cloud_identitytoolkit_admin_v2_initialize_identity_platform_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
