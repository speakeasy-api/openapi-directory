...
class ListUserChannelListUserChannelResponse:
    channels: Optional[list[shared_chat_v2_service_user_user_channel.ChatV2ServiceUserUserChannel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('channels') }})
