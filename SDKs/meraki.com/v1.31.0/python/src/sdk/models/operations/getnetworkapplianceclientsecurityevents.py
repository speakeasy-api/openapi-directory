...
class GetNetworkApplianceClientSecurityEventsRequest:
    ...
    r"""The beginning of the timespan for the data. Data is gathered after the specified t0 value. The maximum lookback period is 791 days from today."""  
    ...
    r"""The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 791 days. The default is 31 days."""  
...
class GetNetworkApplianceClientSecurityEventsResponse:
    ...
    get_network_appliance_client_security_events_200_application_json_objects: Optional[list[dict[str, Any]]] = dataclasses.field(default=None)
