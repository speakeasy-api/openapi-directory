...
exports.DeleteAccountAccessConsentsConsentIdResponse = exports.DeleteAccountAccessConsentsConsentIdRequest = exports.DeleteAccountAccessConsentsConsentIdSecurity = void 0;
...
var DeleteAccountAccessConsentsConsentIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DeleteAccountAccessConsentsConsentIdRequest.prototype, "consentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=sandbox-id",
        }),
        __metadata("design:type", String)
    ], DeleteAccountAccessConsentsConsentIdRequest.prototype, "sandboxId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], DeleteAccountAccessConsentsConsentIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], DeleteAccountAccessConsentsConsentIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], DeleteAccountAccessConsentsConsentIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], DeleteAccountAccessConsentsConsentIdRequest.prototype, "xFapiInteractionId", void 0);
...
var DeleteAccountAccessConsentsConsentIdResponse = /** @class */ (function (_super) {
    ...
    ], DeleteAccountAccessConsentsConsentIdResponse.prototype, "rawResponse", void 0);
