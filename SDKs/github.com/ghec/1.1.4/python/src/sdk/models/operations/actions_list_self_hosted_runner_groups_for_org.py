...
class ActionsListSelfHostedRunnerGroupsForOrgRequest:
    ...
    visible_to_repository: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'visible_to_repository', 'style': 'form', 'explode': True }})
    r"""Only return runner groups that are allowed to be used by this repository."""  
