...
class PostRepositoriesWorkspaceRepoSlugRefsTagsRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugRefsTagsPathParams = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: PostRepositoriesWorkspaceRepoSlugRefsTagsSecurity = dataclasses.field()
