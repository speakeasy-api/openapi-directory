...
exports.StorageDefaultObjectAccessControlsGetResponse = exports.StorageDefaultObjectAccessControlsGetRequest = exports.StorageDefaultObjectAccessControlsGetSecurity = void 0;
...
var StorageDefaultObjectAccessControlsGetRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], StorageDefaultObjectAccessControlsGetRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=bucket",
        }),
        __metadata("design:type", String)
    ], StorageDefaultObjectAccessControlsGetRequest.prototype, "bucket", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=entity",
        }),
        __metadata("design:type", String)
    ], StorageDefaultObjectAccessControlsGetRequest.prototype, "entity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], StorageDefaultObjectAccessControlsGetRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], StorageDefaultObjectAccessControlsGetRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], StorageDefaultObjectAccessControlsGetRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], StorageDefaultObjectAccessControlsGetRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], StorageDefaultObjectAccessControlsGetRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], StorageDefaultObjectAccessControlsGetRequest.prototype, "userIp", void 0);
...
var StorageDefaultObjectAccessControlsGetResponse = /** @class */ (function (_super) {
    ...
    ], StorageDefaultObjectAccessControlsGetResponse.prototype, "rawResponse", void 0);
