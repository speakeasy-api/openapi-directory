...
func (e *CreateNetworkApplianceVlanRequestBodyIpv6PrefixAssignmentsOriginTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "independent":
		fallthrough
	case "internet":
		*e = CreateNetworkApplianceVlanRequestBodyIpv6PrefixAssignmentsOriginTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkApplianceVlanRequestBodyIpv6PrefixAssignmentsOriginTypeEnum: %s", s)
	}
}
...
func (e *CreateNetworkApplianceVlanRequestBodyTemplateVlanTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "same":
		fallthrough
	case "unique":
		*e = CreateNetworkApplianceVlanRequestBodyTemplateVlanTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkApplianceVlanRequestBodyTemplateVlanTypeEnum: %s", s)
	}
}
...
func (e *CreateNetworkApplianceVlan201ApplicationJSONIpv6PrefixAssignmentsOriginTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "independent":
		fallthrough
	case "internet":
		*e = CreateNetworkApplianceVlan201ApplicationJSONIpv6PrefixAssignmentsOriginTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkApplianceVlan201ApplicationJSONIpv6PrefixAssignmentsOriginTypeEnum: %s", s)
	}
}
...
func (e *CreateNetworkApplianceVlan201ApplicationJSONTemplateVlanTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "same":
		fallthrough
	case "unique":
		*e = CreateNetworkApplianceVlan201ApplicationJSONTemplateVlanTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkApplianceVlan201ApplicationJSONTemplateVlanTypeEnum: %s", s)
	}
}
