...
class FileResponseVO:
    r"""Java type: com.noosh.nooshapi.vo.file.FileResponseVO"""
    
    result: Optional[shared_filevo.FileVO] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})
