...
class BankTransferListRequest:
    ...
    direction: Optional[shared_banktransferdirection_enum.BankTransferDirectionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('direction'), 'exclude': lambda f: f is None }})
