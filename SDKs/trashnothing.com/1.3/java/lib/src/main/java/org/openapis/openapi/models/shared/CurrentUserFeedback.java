...
public class CurrentUserFeedback {
    /**
    ...
    public CurrentUserFeedback withPercentPositive(Double percentPositive) {
    ...
    public CurrentUserFeedback withRestriction(String restriction) {
    ...
    @JsonProperty("score")
    public Long score;
    public CurrentUserFeedback withScore(Long score) {
        this.score = score;
        return this;
    }
