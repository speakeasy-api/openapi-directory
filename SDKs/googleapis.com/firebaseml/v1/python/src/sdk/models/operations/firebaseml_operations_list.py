...
class FirebasemlOperationsListRequest:
    path_params: FirebasemlOperationsListPathParams = dataclasses.field()
    query_params: FirebasemlOperationsListQueryParams = dataclasses.field()
    security: FirebasemlOperationsListSecurity = dataclasses.field()
