...
public class KkidChorelistPutQueryParams {
    ...
    public KkidChorelistPutQueryParams withIdChoreList(Long idChoreList) {
    ...
    public KkidChorelistPutQueryParams withLatitude(Long latitude) {
    ...
    public KkidChorelistPutQueryParams withLongitude(Long longitude) {
    ...
    public KkidChorelistPutQueryParams withNfcTag(String nfcTag) {
        this.nfcTag = nfcTag;
        return this;
    }
    ...
    public String notes;
    public KkidChorelistPutQueryParams withNotes(String notes) {
        this.notes = notes;
        return this;
    }
    ...
    public KkidChorelistPutQueryParams withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public KkidChorelistPutQueryParams withStolen(Boolean stolen) {
        this.stolen = stolen;
        return this;
    }
    ...
    public KkidChorelistPutQueryParams withStolenBy(String stolenBy) {
    ...
    public KkidChorelistPutQueryParams withUpdatedByAutomation(Boolean updatedByAutomation) {
    ...
    public KkidChorelistPutQueryParams withWhereDay(KkidChorelistPutWhereDayEnum whereDay) {
    ...
    public KkidChorelistPutQueryParams withWhereName(String whereName) {
    ...
    public KkidChorelistPutQueryParams withWhereStatus(String whereStatus) {
