...
export enum GetGameSessionLogUrlXAmzTargetEnum {
  GameLiftGetGameSessionLogUrl = "GameLift.GetGameSessionLogUrl",
}

export class GetGameSessionLogUrlRequest extends SpeakeasyBase {
...
export class GetGameSessionLogUrlResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
