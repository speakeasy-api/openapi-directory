...
public class SslcrSecurity {
    ...
    public SslcrSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public SslcrSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public SslcrSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
