...
class GetPutUserPermissionsBoundaryQueryParams:
    action: GetPutUserPermissionsBoundaryActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetPutUserPermissionsBoundaryVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetPutUserPermissionsBoundaryRequest:
    headers: GetPutUserPermissionsBoundaryHeaders = dataclasses.field()
    query_params: GetPutUserPermissionsBoundaryQueryParams = dataclasses.field()
