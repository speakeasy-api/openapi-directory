...
export enum GETDeleteTransitGatewayRouteTableAnnouncementActionEnum {
  DeleteTransitGatewayRouteTableAnnouncement = "DeleteTransitGatewayRouteTableAnnouncement",
}

export enum GETDeleteTransitGatewayRouteTableAnnouncementVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETDeleteTransitGatewayRouteTableAnnouncementRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETDeleteTransitGatewayRouteTableAnnouncementResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
