...
exports.ListRegulationResponse = exports.ListRegulationListRegulationResponse = exports.ListRegulationListRegulationResponseMeta = exports.ListRegulationRequest = exports.ListRegulationSecurity = exports.ListRegulationServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListRegulationServerList = ["https://numbers.twilio.com"];
var ListRegulationSecurity = /** @class */ (function (_super) {
    ...
    ], ListRegulationSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListRegulationSecurity.prototype, "username", void 0);
...
var ListRegulationRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListRegulationRequest.prototype, "endUserType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=IsoCountry",
        }),
        __metadata("design:type", String)
    ], ListRegulationRequest.prototype, "isoCountry", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=NumberType",
        }),
        __metadata("design:type", String)
    ], ListRegulationRequest.prototype, "numberType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListRegulationRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListRegulationRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListRegulationRequest.prototype, "pageToken", void 0);
...
var ListRegulationListRegulationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListRegulationListRegulationResponseMeta; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.NumbersV2RegulatoryComplianceRegulation; }),
...
var ListRegulationResponse = /** @class */ (function (_super) {
    ...
    ], ListRegulationResponse.prototype, "rawResponse", void 0);
