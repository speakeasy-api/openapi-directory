...
class CreateFieldLevelEncryptionConfig20190326RequestBodyFieldLevelEncryptionConfig:
...
class CreateFieldLevelEncryptionConfig20190326RequestBody:
    ...
    field_level_encryption_config: CreateFieldLevelEncryptionConfig20190326RequestBodyFieldLevelEncryptionConfig = dataclasses.field()
    r"""A complex data type that includes the profile configurations specified for field-level encryption."""  
