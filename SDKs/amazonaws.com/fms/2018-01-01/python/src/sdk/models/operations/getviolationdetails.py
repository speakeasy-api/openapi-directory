...
class GetViolationDetailsRequest:
    ...
    get_violation_details_request: shared_getviolationdetailsrequest.GetViolationDetailsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
