 ...
 */
export enum FutureReservationsAggregatedListResponseWarningCodeEnum {
...
export class FutureReservationsAggregatedListResponseWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class FutureReservationsAggregatedListResponseWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
 ...
 */
export class FutureReservationsAggregatedListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "etag" })
  etag?: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: FutureReservationsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, FutureReservationsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], FutureReservationsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
