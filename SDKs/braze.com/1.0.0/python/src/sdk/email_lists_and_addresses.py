...
class EmailListsAndAddresses:
    ...
    def query_hard_bounced_emails(self, request: operations.QueryHardBouncedEmailsRequest) -> operations.QueryHardBouncedEmailsResponse:
        ...
        query_params = utils.get_query_params(operations.QueryHardBouncedEmailsRequest, request)
        ...
        res = operations.QueryHardBouncedEmailsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def query_list_of_unsubscribed_email_addresses(self, request: operations.QueryListOfUnsubscribedEmailAddressesRequest) -> operations.QueryListOfUnsubscribedEmailAddressesResponse:
        ...
        query_params = utils.get_query_params(operations.QueryListOfUnsubscribedEmailAddressesRequest, request)
        ...
        res = operations.QueryListOfUnsubscribedEmailAddressesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
