...
@dataclasses.dataclass
class YoutubereportingJobsGetQueryParams:
...
@dataclasses.dataclass
class YoutubereportingJobsGetSecurity:
    option1: Optional[YoutubereportingJobsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubereportingJobsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class YoutubereportingJobsGetRequest:
    path_params: YoutubereportingJobsGetPathParams = dataclasses.field()
    query_params: YoutubereportingJobsGetQueryParams = dataclasses.field()
    security: YoutubereportingJobsGetSecurity = dataclasses.field()
