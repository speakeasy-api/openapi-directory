...
public class SsmgrSecurity {
    ...
    public SsmgrSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public SsmgrSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public SsmgrSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
