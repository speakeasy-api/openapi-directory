...
class GetLoadBalancerTypesRequest:
    ...
    r"""Can be used to filter Load Balancer types by their name. The response will only contain the Load Balancer type matching the specified name."""  
...
class GetLoadBalancerTypes200ApplicationJSONLoadBalancerTypesPrices:
    ...
    price_hourly: GetLoadBalancerTypes200ApplicationJSONLoadBalancerTypesPricesPriceHourly = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_hourly') }})
    r"""Hourly costs for a Resource in this Location"""  
    price_monthly: GetLoadBalancerTypes200ApplicationJSONLoadBalancerTypesPricesPriceMonthly = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_monthly') }})
    r"""Monthly costs for a Resource in this Location"""  
...
class GetLoadBalancerTypes200ApplicationJSONLoadBalancerTypes:
    ...
    prices: list[GetLoadBalancerTypes200ApplicationJSONLoadBalancerTypesPrices] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('prices') }})
...
class GetLoadBalancerTypes200ApplicationJSON:
    r"""The `load_balancer_types` key in the reply contains an array of Load Balancer type objects with this structure"""
    
    load_balancer_types: list[GetLoadBalancerTypes200ApplicationJSONLoadBalancerTypes] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('load_balancer_types') }})  
