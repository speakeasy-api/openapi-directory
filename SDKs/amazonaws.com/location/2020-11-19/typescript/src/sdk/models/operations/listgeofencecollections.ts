...
export class ListGeofenceCollectionsRequestBody extends SpeakeasyBase {
  /**
...
export class ListGeofenceCollectionsRequest extends SpeakeasyBase {
  /**
   * Pagination limit
   */
  @SpeakeasyMetadata({
  ...
  requestBody: ListGeofenceCollectionsRequestBody;
