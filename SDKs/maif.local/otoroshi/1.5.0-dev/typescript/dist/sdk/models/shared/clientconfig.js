...
var ClientConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "backoffFactor" }),
        __metadata("design:type", Number)
    ], ClientConfig.prototype, "backoffFactor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "callTimeout" }),
        __metadata("design:type", Number)
    ], ClientConfig.prototype, "callTimeout", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "globalTimeout" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "retryInitialDelay" }),
        __metadata("design:type", Number)
    ], ClientConfig.prototype, "retryInitialDelay", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "sampleInterval" }),
        __metadata("design:type", Number)
    ], ClientConfig.prototype, "sampleInterval", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "useCircuitBreaker" }),
