...
class DescribeFleetLocationUtilizationRequest:
    ...
    describe_fleet_location_utilization_input: shared_describefleetlocationutilizationinput.DescribeFleetLocationUtilizationInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
