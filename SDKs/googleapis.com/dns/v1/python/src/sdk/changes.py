...
class Changes:
    ...
    def dns_changes_create(self, request: operations.DNSChangesCreateRequest) -> operations.DNSChangesCreateResponse:
        ...
        url = utils.generate_url(base_url, "/dns/v1/projects/{project}/managedZones/{managedZone}/changes", request.path_params)
    ...
    def dns_changes_get(self, request: operations.DNSChangesGetRequest) -> operations.DNSChangesGetResponse:
        ...
        url = utils.generate_url(base_url, "/dns/v1/projects/{project}/managedZones/{managedZone}/changes/{changeId}", request.path_params)
