...
class Projects 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\OndemandscanningProjectsLocationsOperationsCancelResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}:cancel', \OpenAPI\OpenAPI\Models\Operations\OndemandscanningProjectsLocationsOperationsCancelRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\OndemandscanningProjectsLocationsOperationsDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\OndemandscanningProjectsLocationsOperationsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}/operations', \OpenAPI\OpenAPI\Models\Operations\OndemandscanningProjectsLocationsOperationsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}:wait', \OpenAPI\OpenAPI\Models\Operations\OndemandscanningProjectsLocationsOperationsWaitRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/scans:analyzePackages', \OpenAPI\OpenAPI\Models\Operations\OndemandscanningProjectsLocationsScansAnalyzePackagesRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "analyzePackagesRequestV1", "json");
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{parent}/vulnerabilities', \OpenAPI\OpenAPI\Models\Operations\OndemandscanningProjectsLocationsScansVulnerabilitiesListRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listVulnerabilitiesResponseV1 = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListVulnerabilitiesResponseV1', 'json');
            }
        }
