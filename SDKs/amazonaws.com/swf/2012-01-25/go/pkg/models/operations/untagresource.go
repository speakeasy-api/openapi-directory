...
const (
	UntagResourceXAmzTargetEnumSimpleWorkflowServiceUntagResource UntagResourceXAmzTargetEnum = "SimpleWorkflowService.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "SimpleWorkflowService.UntagResource":
