...
class UpdateInsightRequestBody:
    ...
    filters: Optional[UpdateInsightRequestBodyFilters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Filters'), 'exclude': lambda f: f is None }})
    r"""<p>A collection of attributes that are applied to all active Security Hub-aggregated findings and that result in a subset of findings that are included in this insight.</p> <p>You can filter by up to 10 finding attributes. For each attribute, you can provide up to 20 filter values.</p>"""  
    group_by_attribute: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('GroupByAttribute'), 'exclude': lambda f: f is None }})
    r"""The updated <code>GroupBy</code> attribute that defines this insight."""  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Name'), 'exclude': lambda f: f is None }})
    r"""The updated name for the insight."""  
...
class UpdateInsightRequest:
    ...
    r"""The ARN of the insight that you want to update."""  
    request_body: UpdateInsightRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
