...
class GetLinksTopDomainsPathParams:
...
@dataclasses.dataclass
class GetLinksTopDomainsQueryParams:
...
class GetLinksTopDomainsRequest:
    path_params: GetLinksTopDomainsPathParams = dataclasses.field()
    query_params: GetLinksTopDomainsQueryParams = dataclasses.field()
