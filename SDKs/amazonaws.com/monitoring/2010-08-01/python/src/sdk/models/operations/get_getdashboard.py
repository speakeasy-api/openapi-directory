...
class GetGetDashboardQueryParams:
    action: GetGetDashboardActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    dashboard_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'DashboardName', 'style': 'form', 'explode': True }})
    version: GetGetDashboardVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetGetDashboardRequest:
    headers: GetGetDashboardHeaders = dataclasses.field()
    query_params: GetGetDashboardQueryParams = dataclasses.field()
