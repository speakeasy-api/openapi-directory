...
public class CreateInvitationsResponse {
    ...
    public openapisdk.models.shared.CreateInvitationsResponse createInvitationsResponse;
    public CreateInvitationsResponse withCreateInvitationsResponse(openapisdk.models.shared.CreateInvitationsResponse createInvitationsResponse) {
    ...
    public CreateInvitationsResponse withStatusCode(Long statusCode) {
