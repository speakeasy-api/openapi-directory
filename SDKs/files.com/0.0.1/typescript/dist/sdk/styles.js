...
var Styles = /** @class */ (function () {
    function Styles(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Delete Style
    **/
    Styles.prototype.deleteStylesPath = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteStylesPathRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/styles/{path}", req.pathParams);
     ...
     * Show Style
    **/
    Styles.prototype.getStylesPath = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.styleEntity = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
     ...
     * Update Style
    **/
    Styles.prototype.patchStylesPath = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
