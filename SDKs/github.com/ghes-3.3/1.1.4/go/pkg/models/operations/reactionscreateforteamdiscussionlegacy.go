...
// ReactionsCreateForTeamDiscussionLegacyRequestBodyContentEnum - The [reaction type](https://docs.github.com/enterprise-server@3.3/rest/reference/reactions#reaction-types) to add to the team discussion.
