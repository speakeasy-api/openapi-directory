...
export class SasportalNodesNodesDevicesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SasportalNodesNodesDevicesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class SasportalNodesNodesDevicesListSecurity extends SpeakeasyBase {
...
export class SasportalNodesNodesDevicesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SasportalNodesNodesDevicesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
