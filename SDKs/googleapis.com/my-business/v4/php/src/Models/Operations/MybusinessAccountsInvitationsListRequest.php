...
class MybusinessAccountsInvitationsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MybusinessAccountsInvitationsListTargetTypeEnum $targetType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=targetType')]
    public ?MybusinessAccountsInvitationsListTargetTypeEnum $targetType = null;
