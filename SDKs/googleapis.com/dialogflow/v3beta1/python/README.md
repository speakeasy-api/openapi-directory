...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/googleapis.com/dialogflow/v3beta1/python
```
...
* `dialogflow_projects_locations_agents_create` - Creates an agent in the specified location. Note: You should always train a flow prior to sending it queries. See the [training documentation](https://cloud.google.com/dialogflow/cx/docs/concept/training).
...
* `dialogflow_projects_locations_agents_flows_pages_create` - Creates a page in the specified flow.
