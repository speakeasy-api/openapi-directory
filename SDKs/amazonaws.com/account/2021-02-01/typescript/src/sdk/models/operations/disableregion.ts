...
export class DisableRegionRequestBody extends SpeakeasyBase {
  /**
...
export class DisableRegionRequest extends SpeakeasyBase {
...
export class DisableRegionResponse extends SpeakeasyBase {
  /**
