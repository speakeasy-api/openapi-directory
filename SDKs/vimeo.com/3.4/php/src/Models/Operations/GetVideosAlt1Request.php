...
class GetVideosAlt1Request
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetVideosAlt1DirectionEnum $direction
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=direction')]
    public ?GetVideosAlt1DirectionEnum $direction = null;
    
    /**
     * The attribute by which to filter the results.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetVideosAlt1FilterEnum $filter
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=filter')]
    public ?GetVideosAlt1FilterEnum $filter = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetVideosAlt1SortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?GetVideosAlt1SortEnum $sort = null;
