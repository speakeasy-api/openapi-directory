...
class GoogleCloudDiscoveryengineV1betaRecommendRequest:
    ...
    user_event: Optional[shared_googleclouddiscoveryenginev1betauserevent.GoogleCloudDiscoveryengineV1betaUserEvent] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('userEvent'), 'exclude': lambda f: f is None }})
