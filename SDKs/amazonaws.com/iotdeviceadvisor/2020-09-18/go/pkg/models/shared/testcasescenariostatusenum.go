...
func (e TestCaseScenarioStatusEnum) ToPointer() *TestCaseScenarioStatusEnum {
	return &e
}
...
func (e *TestCaseScenarioStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "PASS_WITH_WARNINGS":
		fallthrough
	case "ERROR":
		*e = TestCaseScenarioStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TestCaseScenarioStatusEnum: %v", v)
	}
}
