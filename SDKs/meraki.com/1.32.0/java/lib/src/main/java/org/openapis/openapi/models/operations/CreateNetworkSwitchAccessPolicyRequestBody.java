...
public class CreateNetworkSwitchAccessPolicyRequestBody {
    ...
    public CreateNetworkSwitchAccessPolicyRequestBody withGuestPortBouncing(Boolean guestPortBouncing) {
    ...
    public CreateNetworkSwitchAccessPolicyRequestBody(@JsonProperty("hostMode") CreateNetworkSwitchAccessPolicyRequestBodyHostModeEnum hostMode, @JsonProperty("name") String name, @JsonProperty("radiusAccountingEnabled") Boolean radiusAccountingEnabled, @JsonProperty("radiusCoaSupportEnabled") Boolean radiusCoaSupportEnabled, @JsonProperty("radiusServers") CreateNetworkSwitchAccessPolicyRequestBodyRadiusServers[] radiusServers, @JsonProperty("radiusTestingEnabled") Boolean radiusTestingEnabled, @JsonProperty("urlRedirectWalledGardenEnabled") Boolean urlRedirectWalledGardenEnabled) {
        this.hostMode = hostMode;
        this.name = name;
        this.radiusAccountingEnabled = radiusAccountingEnabled;
        this.radiusCoaSupportEnabled = radiusCoaSupportEnabled;
