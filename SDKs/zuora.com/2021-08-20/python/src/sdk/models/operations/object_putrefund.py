...
from ..shared import proxymodifyrefund as shared_proxymodifyrefund
...
class ObjectPUTRefundRequest:
    ...
    r"""Object id"""  
    proxy_modify_refund: shared_proxymodifyrefund.ProxyModifyRefund = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
