...
public class ActionPOSTamendRequest {
    ...
    public org.openapis.openapi.models.shared.ProxyActionamendRequest proxyActionamendRequest;
    public ActionPOSTamendRequest withProxyActionamendRequest(org.openapis.openapi.models.shared.ProxyActionamendRequest proxyActionamendRequest) {
        this.proxyActionamendRequest = proxyActionamendRequest;
        return this;
    }
    ...
    public ActionPOSTamendRequest withXZuoraWSDLVersion(String xZuoraWSDLVersion) {
    ...
    public ActionPOSTamendRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public ActionPOSTamendRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public ActionPOSTamendRequest withRejectUnknownFields(Boolean rejectUnknownFields) {
