...
public class UnregisterMFAForSelfRequest {
    ...
    public UnregisterMFAForSelfRequest(@JsonProperty("SelfMFATypeUnregisterRequest") org.openapis.openapi.models.shared.SelfMFATypeUnregisterRequest selfMFATypeUnregisterRequest) {
        this.selfMFATypeUnregisterRequest = selfMFATypeUnregisterRequest;
  }
}
