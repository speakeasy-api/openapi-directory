...
class GetDomesticScheduledPaymentsDomesticScheduledPaymentIDPathParams:
    domestic_scheduled_payment_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'DomesticScheduledPaymentId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetDomesticScheduledPaymentsDomesticScheduledPaymentIDHeaders:
...
@dataclasses.dataclass
class GetDomesticScheduledPaymentsDomesticScheduledPaymentIDSecurity:
    tppo_auth2_security: shared_security.SchemeTppoAuth2Security = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class GetDomesticScheduledPaymentsDomesticScheduledPaymentIDRequest:
    headers: GetDomesticScheduledPaymentsDomesticScheduledPaymentIDHeaders = dataclasses.field()
    path_params: GetDomesticScheduledPaymentsDomesticScheduledPaymentIDPathParams = dataclasses.field()
    security: GetDomesticScheduledPaymentsDomesticScheduledPaymentIDSecurity = dataclasses.field()
