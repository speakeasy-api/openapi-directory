 ...
 */
export enum MachineTypesScopedListWarningCodeEnum {
...
export class MachineTypesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class MachineTypesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: MachineTypesScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: MachineTypesScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => MachineTypesScopedListWarningData)
  data?: MachineTypesScopedListWarningData[];
...
export class MachineTypesScopedList extends SpeakeasyBase {
  /**
   * [Output Only] A list of machine types contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: MachineType })
  @Expose({ name: "machineTypes" })
  @Type(() => MachineType)
