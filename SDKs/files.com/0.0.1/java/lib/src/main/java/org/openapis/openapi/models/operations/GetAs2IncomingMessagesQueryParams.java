...
public class GetAs2IncomingMessagesQueryParams {
    /**
     * As2 Partner ID.  If provided, will return message specific to that partner.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=as2_partner_id")
    public Integer as2PartnerId;
    public GetAs2IncomingMessagesQueryParams withAs2PartnerId(Integer as2PartnerId) {
    ...
    public GetAs2IncomingMessagesQueryParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public GetAs2IncomingMessagesQueryParams withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetAs2IncomingMessagesQueryParams withFilterGt(java.util.Map<String, Object> filterGt) {
    ...
    public GetAs2IncomingMessagesQueryParams withFilterGteq(java.util.Map<String, Object> filterGteq) {
    ...
    public GetAs2IncomingMessagesQueryParams withFilterLike(java.util.Map<String, Object> filterLike) {
    ...
    public GetAs2IncomingMessagesQueryParams withFilterLt(java.util.Map<String, Object> filterLt) {
    ...
    public GetAs2IncomingMessagesQueryParams withFilterLteq(java.util.Map<String, Object> filterLteq) {
    ...
    public GetAs2IncomingMessagesQueryParams withPerPage(Integer perPage) {
    ...
    public GetAs2IncomingMessagesQueryParams withSortBy(java.util.Map<String, Object> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
