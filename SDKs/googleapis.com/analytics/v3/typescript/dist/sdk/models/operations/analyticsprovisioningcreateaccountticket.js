...
exports.AnalyticsProvisioningCreateAccountTicketResponse = exports.AnalyticsProvisioningCreateAccountTicketRequest = exports.AnalyticsProvisioningCreateAccountTicketSecurity = void 0;
...
var AnalyticsProvisioningCreateAccountTicketRequest = /** @class */ (function (_super) {
    ...
    ], AnalyticsProvisioningCreateAccountTicketRequest.prototype, "accountTicketInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AnalyticsProvisioningCreateAccountTicketRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AnalyticsProvisioningCreateAccountTicketRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AnalyticsProvisioningCreateAccountTicketRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AnalyticsProvisioningCreateAccountTicketRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AnalyticsProvisioningCreateAccountTicketRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AnalyticsProvisioningCreateAccountTicketRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AnalyticsProvisioningCreateAccountTicketRequest.prototype, "userIp", void 0);
...
var AnalyticsProvisioningCreateAccountTicketResponse = /** @class */ (function (_super) {
    ...
    ], AnalyticsProvisioningCreateAccountTicketResponse.prototype, "rawResponse", void 0);
