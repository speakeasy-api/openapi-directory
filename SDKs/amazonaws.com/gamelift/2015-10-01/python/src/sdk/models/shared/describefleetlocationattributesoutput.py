...
class DescribeFleetLocationAttributesOutput:
    ...
    location_attributes: Optional[list[shared_locationattributes.LocationAttributes]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('LocationAttributes') }})
