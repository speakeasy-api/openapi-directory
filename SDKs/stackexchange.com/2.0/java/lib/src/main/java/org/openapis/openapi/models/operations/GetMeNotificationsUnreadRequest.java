...
public class GetMeNotificationsUnreadRequest {
    ...
    public GetMeNotificationsUnreadRequest withCallback(String callback) {
    ...
    public GetMeNotificationsUnreadRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeNotificationsUnreadRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeNotificationsUnreadRequest withPagesize(Long pagesize) {
    ...
    public GetMeNotificationsUnreadRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    public GetMeNotificationsUnreadRequest(@JsonProperty("site") String site) {
        this.site = site;
  }
}
