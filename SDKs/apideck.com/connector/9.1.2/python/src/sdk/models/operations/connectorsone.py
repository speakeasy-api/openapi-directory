...
from ..shared import getconnectorresponse as shared_getconnectorresponse
...
class ConnectorsOneResponse:
    ...
    get_connector_response: Optional[shared_getconnectorresponse.GetConnectorResponse] = dataclasses.field(default=None)
    r"""Connectors"""  
