...
class POSTEmailCreditMemoRequest:
    ...
    r"""The ID of a posted credit memo. For example, 8a8082e65b27f6c3015ba45ff82c7172."""  
    post_credit_memo_email_request_type: shared_postcreditmemoemailrequesttype.PostCreditMemoEmailRequestType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
