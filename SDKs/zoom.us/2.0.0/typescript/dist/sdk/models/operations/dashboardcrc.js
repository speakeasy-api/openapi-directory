...
exports.DashboardCrcResponse = exports.DashboardCrcRequest = exports.DashboardCrc200ApplicationJson = exports.DashboardCrc200ApplicationJsonCrcPortsUsage = exports.DashboardCrc200ApplicationJsonCrcPortsUsageCrcPortsHourUsage = exports.DashboardCrcSecurity = exports.DashboardCrcQueryParams = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var DashboardCrcQueryParams = /** @class */ (function (_super) {
    __extends(DashboardCrcQueryParams, _super);
    function DashboardCrcQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=from" }),
        __metadata("design:type", Date)
    ], DashboardCrcQueryParams.prototype, "from", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=to" }),
        __metadata("design:type", Date)
    ], DashboardCrcQueryParams.prototype, "to", void 0);
    return DashboardCrcQueryParams;
}(utils_1.SpeakeasyBase));
exports.DashboardCrcQueryParams = DashboardCrcQueryParams;
...
var DashboardCrc200ApplicationJsonCrcPortsUsageCrcPortsHourUsage = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=max_usage" }),
        __metadata("design:type", Number)
    ], DashboardCrc200ApplicationJsonCrcPortsUsageCrcPortsHourUsage.prototype, "maxUsage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=total_usage" }),
        __metadata("design:type", Number)
...
var DashboardCrc200ApplicationJsonCrcPortsUsage = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=crc_ports_hour_usage", elemType: DashboardCrc200ApplicationJsonCrcPortsUsageCrcPortsHourUsage }),
...
var DashboardCrc200ApplicationJson = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=crc_ports_usage", elemType: DashboardCrc200ApplicationJsonCrcPortsUsage }),
        __metadata("design:type", Array)
...
var DashboardCrcRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", DashboardCrcQueryParams)
    ], DashboardCrcRequest.prototype, "queryParams", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", DashboardCrcSecurity)
    ], DashboardCrcRequest.prototype, "security", void 0);
