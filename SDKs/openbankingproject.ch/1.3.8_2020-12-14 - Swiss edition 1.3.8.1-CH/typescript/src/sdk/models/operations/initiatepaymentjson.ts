...
export class InitiatePaymentJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class InitiatePaymentJsonRequest extends SpeakeasyBase {
  /**
...
export class InitiatePaymentJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
