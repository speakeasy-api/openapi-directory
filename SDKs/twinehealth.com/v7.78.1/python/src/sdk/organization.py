...
class Organization:
    ...
    def fetch_organization(self, request: operations.FetchOrganizationRequest) -> operations.FetchOrganizationResponse:
        r"""Get an organization
        Get an organization record by id.
        """
        base_url = self._server_url
        
        url = utils.generate_url(operations.FetchOrganizationRequest, base_url, '/organization/{id}', request)
        ...
        res = operations.FetchOrganizationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
