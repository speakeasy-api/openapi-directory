...
from ..shared import security as shared_security
from ..shared import listcustombiddingscriptsresponse as shared_listcustombiddingscriptsresponse
...
class DisplayvideoCustomBiddingAlgorithmsScriptsListRequest:
    path_params: DisplayvideoCustomBiddingAlgorithmsScriptsListPathParams = dataclasses.field()
    query_params: DisplayvideoCustomBiddingAlgorithmsScriptsListQueryParams = dataclasses.field()
    security: DisplayvideoCustomBiddingAlgorithmsScriptsListSecurity = dataclasses.field()
...
class DisplayvideoCustomBiddingAlgorithmsScriptsListResponse:
    ...
    list_custom_bidding_scripts_response: Optional[shared_listcustombiddingscriptsresponse.ListCustomBiddingScriptsResponse] = dataclasses.field(default=None)
