...
public class CompleteFileUploadByTokenHeaders {
    /**
    ...
    public CompleteFileUploadByTokenHeaders withXSdsDateFormat(CompleteFileUploadByTokenXSdsDateFormatEnum xSdsDateFormat) {
