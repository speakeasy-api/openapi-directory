...
export enum PowerOutletConnectionStatusLabelEnum {
    NotConnected = "Not Connected",
    Connected = "Connected"
}


export class PowerOutletConnectionStatus extends SpeakeasyBase {
...
export enum PowerOutletFeedLegLabelEnum {
    A = "A",
    B = "B",
    C = "C"
}

export enum PowerOutletFeedLegValueEnum {
    A = "A",
    B = "B",
    C = "C"
}
...
export class PowerOutletFeedLeg extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=label" })
...
export enum PowerOutletTypeLabelEnum {
    C5 = "C5",
    C7 = "C7",
    C13 = "C13",
    C15 = "C15",
...
export enum PowerOutletTypeValueEnum {
...
export class PowerOutletType extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=label" })
