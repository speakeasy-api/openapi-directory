 ...
 */
export enum DataIssueDetailDataIssueSeverityEnum {
 ...
 */
export enum DataIssueDetailDataIssueTypeEnum {
 ...
 */
export class DataIssueDetail extends SpeakeasyBase {
  /**
   * The severity of the data issue.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "dataIssueSeverity" })
