...
from ..shared import getevidenceresponse as shared_getevidenceresponse
...
class GetEvidencePathParams:
    ...
    evidence_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'evidenceId', 'style': 'simple', 'explode': False }})
...
class GetEvidenceRequest:
    headers: GetEvidenceHeaders = dataclasses.field()
    path_params: GetEvidencePathParams = dataclasses.field()
...
class GetEvidenceResponse:
    ...
    get_evidence_response: Optional[shared_getevidenceresponse.GetEvidenceResponse] = dataclasses.field(default=None)
