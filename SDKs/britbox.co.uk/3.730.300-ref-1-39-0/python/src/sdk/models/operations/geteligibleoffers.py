...
from ..shared import eeoffersrequest as shared_eeoffersrequest
from ..shared import eeoffersresponse as shared_eeoffersresponse
...
class GetEligibleOffersRequest:
    ...
    ee_offers_request: shared_eeoffersrequest.EeOffersRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Data for getting the eligible offers."""  
...
class GetEligibleOffersResponse:
    ...
    ee_offers_response: Optional[shared_eeoffersresponse.EeOffersResponse] = dataclasses.field(default=None)
