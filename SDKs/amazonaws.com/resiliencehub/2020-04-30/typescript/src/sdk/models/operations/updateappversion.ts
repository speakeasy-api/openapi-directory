...
export class UpdateAppVersionRequestBody extends SpeakeasyBase {
  /**
...
export class UpdateAppVersionRequest extends SpeakeasyBase {
...
export class UpdateAppVersionResponse extends SpeakeasyBase {
  /**
