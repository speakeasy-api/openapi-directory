...
public class NchscSecurity {
    ...
    public NchscSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public NchscSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public NchscSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
