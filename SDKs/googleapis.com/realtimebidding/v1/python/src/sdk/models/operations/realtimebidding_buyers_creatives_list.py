...
class RealtimebiddingBuyersCreativesListRequest:
    path_params: RealtimebiddingBuyersCreativesListPathParams = dataclasses.field()
    query_params: RealtimebiddingBuyersCreativesListQueryParams = dataclasses.field()
    security: RealtimebiddingBuyersCreativesListSecurity = dataclasses.field()
