...
public class AssetReportRefreshResponse {
    ...
    public AssetReportRefreshResponse withStatusCode(Integer statusCode) {
    ...
    public AssetReportRefreshResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
        this.rawResponse = rawResponse;
        return this;
    }
    
    public AssetReportRefreshResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
