...
class FetchWorkerStatisticsRequest:
    ...
    r"""Only include Workers with `friendly_name` values that match this parameter."""  
    ...
    r"""The `friendly_name` of the TaskQueue for which to fetch Worker statistics."""  
    ...
    r"""The SID of the TaskQueue for which to fetch Worker statistics."""  
