...
class GETPaymentPartTypewithSuccess:
    ...
    r"""The amount of the payment part."""  
    ...
    r"""The date and time when the payment part was created, in `yyyy-mm-dd hh:mm:ss` format. For example, 2017-03-01 15:31:10."""  
    ...
    r"""The ID of the debit memo associated with the payment part."""  
    id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is None }})
    r"""The ID of the payment part."""  
    ...
    r"""The ID of the invoice associated with the payment part."""  
    ...
    r"""The ID of the Zuora user who last updated the payment part."""  
    ...
    r"""The date and time when the payment part was last updated, in `yyyy-mm-dd hh:mm:ss` format. For example, 2017-03-02 15:36:10."""  
