 ...
 */
public enum GetSchemaResponsesSchemaResponseIdSchemaBlocksSchemaResponseBlockIdRegistrationSchemaBlockAttributesBlockTypeEnum {
    ...
    private GetSchemaResponsesSchemaResponseIdSchemaBlocksSchemaResponseBlockIdRegistrationSchemaBlockAttributesBlockTypeEnum(String value) {
        this.value = value;
    }
}
