...
class DeleteApprovalRuleTemplateRequest:
    ...
    delete_approval_rule_template_input: shared_deleteapprovalruletemplateinput.DeleteApprovalRuleTemplateInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DeleteApprovalRuleTemplateResponse:
    ...
    r"""ApprovalRuleTemplateInUseException"""  
