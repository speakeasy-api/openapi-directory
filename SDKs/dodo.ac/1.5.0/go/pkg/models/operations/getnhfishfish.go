...
type GetNhFishFishHeaders struct {
...
type GetNhFishFishRequest struct {
	PathParams  GetNhFishFishPathParams
	QueryParams GetNhFishFishQueryParams
	Headers     GetNhFishFishHeaders
}
