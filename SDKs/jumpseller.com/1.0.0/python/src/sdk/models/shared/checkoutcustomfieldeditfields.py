...
class CheckoutCustomFieldEditFields:
    ...
    area: Optional[CheckoutCustomFieldEditFieldsAreaEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('area'), 'exclude': lambda f: f is None }})
    r"""Area of the CheckoutCustomField"""  
    ...
    type: Optional[CheckoutCustomFieldEditFieldsTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Type of the CheckoutCustomField"""  
