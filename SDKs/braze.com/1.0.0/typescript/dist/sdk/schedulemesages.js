...
var ScheduleMesages = /** @class */ (function () {
    ...
    ScheduleMesages.prototype.getUpcomingScheduledCampaignsAndCanvases = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetUpcomingScheduledCampaignsAndCanvasesResponse({
    ...
    ScheduleMesages.prototype.scheduleApiTriggeredCanvases = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ScheduleApiTriggeredCanvasesRequestBody(req);
        }
        var baseURL = this._serverURL;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ScheduleApiTriggeredCanvasesResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
