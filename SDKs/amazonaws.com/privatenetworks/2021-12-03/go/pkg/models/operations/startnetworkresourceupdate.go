...
type StartNetworkResourceUpdateHeaders struct {
...
type StartNetworkResourceUpdateRequest struct {
	Headers StartNetworkResourceUpdateHeaders
	Request StartNetworkResourceUpdateRequestBody `request:"mediaType=application/json"`
}
