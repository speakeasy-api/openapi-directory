 ...
 */
public enum ReposUpdateInformationAboutPagesSiteRequestBody2BuildTypeEnum {
    LEGACY("legacy"),
    WORKFLOW("workflow");
    ...
    private ReposUpdateInformationAboutPagesSiteRequestBody2BuildTypeEnum(String value) {
        this.value = value;
    }
}
