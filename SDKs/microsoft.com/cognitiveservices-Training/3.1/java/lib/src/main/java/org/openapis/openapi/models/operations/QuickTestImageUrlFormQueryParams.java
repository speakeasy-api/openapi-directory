...
public class QuickTestImageUrlFormQueryParams {
    /**
    ...
    public QuickTestImageUrlFormQueryParams withIterationId(String iterationId) {
    ...
    public QuickTestImageUrlFormQueryParams withStore(Boolean store) {
        this.store = store;
        return this;
    }
