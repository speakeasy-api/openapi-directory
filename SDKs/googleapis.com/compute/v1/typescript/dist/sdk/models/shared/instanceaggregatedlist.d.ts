...
import { InstancesScopedList } from "./instancesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum InstanceAggregatedListWarningCodeEnum {
...
export declare class InstanceAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InstanceAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InstanceAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InstanceAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class InstanceAggregatedList extends SpeakeasyBase {
    /**
