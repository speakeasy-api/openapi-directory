...
class GetDiseasePublicationAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetDiseasePublicationAssociationsQueryParams:
...
@dataclasses.dataclass
class GetDiseasePublicationAssociationsRequest:
    path_params: GetDiseasePublicationAssociationsPathParams = dataclasses.field()
    query_params: GetDiseasePublicationAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetDiseasePublicationAssociationsResponse:
