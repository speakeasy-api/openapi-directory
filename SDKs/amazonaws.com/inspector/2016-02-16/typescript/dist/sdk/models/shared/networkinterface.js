...
var NetworkInterface = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "privateDnsName" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: privateip_1.PrivateIp }),
        (0, class_transformer_1.Expose)({ name: "privateIpAddresses" }),
        (0, class_transformer_1.Type)(function () { return privateip_1.PrivateIp; }),
        __metadata("design:type", Array)
    ], NetworkInterface.prototype, "privateIpAddresses", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "publicDnsName" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: securitygroup_1.SecurityGroup }),
        (0, class_transformer_1.Expose)({ name: "securityGroups" }),
        (0, class_transformer_1.Type)(function () { return securitygroup_1.SecurityGroup; }),
        __metadata("design:type", Array)
