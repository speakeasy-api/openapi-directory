...
class ListRuleNamesByTargetRequest:
    ...
    list_rule_names_by_target_request: shared_listrulenamesbytargetrequest.ListRuleNamesByTargetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
