...
export class Transactions {
  ...
  getAccountsAccountIdStatementsStatementIdTransactions(
    ...
    security: operations.GetAccountsAccountIdStatementsStatementIdTransactionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.GetAccountsAccountIdStatementsStatementIdTransactionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetAccountsAccountIdStatementsStatementIdTransactionsRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetAccountsAccountIdStatementsStatementIdTransactionsSecurity(
          security
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetAccountsAccountIdStatementsStatementIdTransactionsResponse =
        new operations.GetAccountsAccountIdStatementsStatementIdTransactionsResponse(
          {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.obReadTransaction6 = utils.objectToClass(
              httpRes?.data,
              shared.OBReadTransaction6
            );
          }
          if (
  ...
  getAccountsAccountIdTransactions(
    ...
    security: operations.GetAccountsAccountIdTransactionsSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.GetAccountsAccountIdTransactionsSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
