...
class ListSipIPAddressRequest:
    ...
    r"""The IpAccessControlList Sid that identifies the IpAddress resources to read."""  
...
class ListSipIPAddressListSipIPAddressResponse:
    ...
    ip_addresses: Optional[list[shared_api_v2010_account_sip_sip_ip_access_control_list_sip_ip_address.APIV2010AccountSipSipIPAccessControlListSipIPAddress]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ip_addresses'), 'exclude': lambda f: f is None }})  
