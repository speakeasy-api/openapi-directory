...
from ..shared import controllers_packageversionitem as shared_controllers_packageversionitem
...
class ControllersPackageVersionsResponse:
    data: Optional[list[shared_controllers_packageversionitem.ControllersPackageVersionItem]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
