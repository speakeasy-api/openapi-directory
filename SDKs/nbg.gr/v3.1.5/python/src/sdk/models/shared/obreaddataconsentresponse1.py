...
class OBReadDataConsentResponse1:
    ...
    r"""Unique identification as assigned to identify the account access consent resource."""  
    ...
    r"""Date and time at which the resource was created. All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00"""  
    ...
    status: shared_obexternalrequeststatus1code_enum.OBExternalRequestStatus1CodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Status') }})
    ...
    r"""Date and time at which the resource status was updated. All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00"""  
