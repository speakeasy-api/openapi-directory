...
exports.UpdateUserRegistration = void 0;
var utils_1 = require("../../../internal/utils");
var useraddress_1 = require("./useraddress");
var name_1 = require("./name");
var userrequestpreferences_1 = require("./userrequestpreferences");
var UpdateUserRegistration = /** @class */ (function (_super) {
    __extends(UpdateUserRegistration, _super);
    ...
    ], UpdateUserRegistration.prototype, "address", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=email" }),
        __metadata("design:type", String)
    ], UpdateUserRegistration.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=name" }),
        __metadata("design:type", name_1.Name)
    ], UpdateUserRegistration.prototype, "name", void 0);
    __decorate([
    ...
    ], UpdateUserRegistration.prototype, "preferences", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=segmentName" }),
        __metadata("design:type", String)
    ], UpdateUserRegistration.prototype, "segmentName", void 0);
