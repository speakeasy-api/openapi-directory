...
var DescribeTaskResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CurrentTaskExecutionArn" }),
        __metadata("design:type", String)
    ], DescribeTaskResponse.prototype, "currentTaskExecutionArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=DestinationLocationArn" }),
        __metadata("design:type", String)
    ], DescribeTaskResponse.prototype, "destinationLocationArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=DestinationNetworkInterfaceArns" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SourceLocationArn" }),
        __metadata("design:type", String)
    ], DescribeTaskResponse.prototype, "sourceLocationArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SourceNetworkInterfaceArns" }),
        __metadata("design:type", Array)
