...
class PullsListDirectionEnum(str, Enum):
    r"""The direction of the sort. Default: `desc` when sort is `created` or sort is not specified, otherwise `asc`."""
    ASC = 'asc'
    DESC = 'desc'

class PullsListSortEnum(str, Enum):
    r"""What to sort results by. `popularity` will sort by the number of comments. `long-running` will sort by date created and will limit the results to pull requests that have been open for more than a month and have had activity within the past month."""
    CREATED = 'created'
    UPDATED = 'updated'
