...
type VmmigrationProjectsLocationsGroupsListSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type VmmigrationProjectsLocationsGroupsListRequest struct {
	// V1 error format.
...
type VmmigrationProjectsLocationsGroupsListResponse struct {
	ContentType string
	// Successful response
