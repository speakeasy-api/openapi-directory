...
from ..shared import googlecloudmemcachev1beta2maintenancepolicy as shared_googlecloudmemcachev1beta2maintenancepolicy
...
class InstanceInput:
    ...
    maintenance_policy: Optional[shared_googlecloudmemcachev1beta2maintenancepolicy.GoogleCloudMemcacheV1beta2MaintenancePolicyInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('maintenancePolicy') }})
...
class Instance:
    ...
    instance_messages: Optional[list[shared_instancemessage.InstanceMessage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('instanceMessages') }})
    labels: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('labels') }})
    maintenance_policy: Optional[shared_googlecloudmemcachev1beta2maintenancepolicy.GoogleCloudMemcacheV1beta2MaintenancePolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('maintenancePolicy') }})
    ...
    update_available: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('updateAvailable') }})
