...
class SearchRequestBody:
    ...
    address: Optional[SearchRequestBodyAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Address'), 'exclude': lambda f: f is None }})  
...
class SearchRequest:
    ...
    r"""e.g. DevAPIIDVerification"""  
    request_body: Optional[SearchRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
