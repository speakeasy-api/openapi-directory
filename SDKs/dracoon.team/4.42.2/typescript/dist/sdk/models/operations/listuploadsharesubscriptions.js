...
exports.ListUploadShareSubscriptionsResponse = exports.ListUploadShareSubscriptionsRequest = void 0;
...
var ListUploadShareSubscriptionsRequest = /** @class */ (function (_super) {
    ...
    ], ListUploadShareSubscriptionsRequest.prototype, "xSdsAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], ListUploadShareSubscriptionsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], ListUploadShareSubscriptionsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], ListUploadShareSubscriptionsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], ListUploadShareSubscriptionsRequest.prototype, "sort", void 0);
    return ListUploadShareSubscriptionsRequest;
}(utils_1.SpeakeasyBase));
exports.ListUploadShareSubscriptionsRequest = ListUploadShareSubscriptionsRequest;
var ListUploadShareSubscriptionsResponse = /** @class */ (function (_super) {
    ...
    ], ListUploadShareSubscriptionsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.ListUploadShareSubscriptionsResponse = ListUploadShareSubscriptionsResponse;
