...
class GetNamesInsideEmbedEnum(str, Enum):
...
class GetNamesInsideOutputSrsEnum(str, Enum):
...
class GetNamesInsideRequest:
    ...
    r"""A geographic bounding box defining the search area.  Must be specified as a string of the form 'minLongitude,minLatitude,maxLongitude,maxLatitude' (WGS84). e.g. -119,49,-118,50"""  
    ...
    r"""The format of the output."""  
    embed: Optional[GetNamesInsideEmbedEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'embed', 'style': 'form', 'explode': True }})
    r"""A flag to indicate whether to embed the corresponding 'feature' into each matching name"""  
    ...
    output_srs: Optional[GetNamesInsideOutputSrsEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outputSRS', 'style': 'form', 'explode': True }})
    r"""The EPSG code of the spatial reference system (SRS) to use for output geometries."""  
