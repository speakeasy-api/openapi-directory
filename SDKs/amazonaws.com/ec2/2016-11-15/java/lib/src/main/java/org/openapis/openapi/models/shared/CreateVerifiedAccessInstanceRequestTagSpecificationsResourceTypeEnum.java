 ...
 */
public enum CreateVerifiedAccessInstanceRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateVerifiedAccessInstanceRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
