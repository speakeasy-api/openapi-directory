...
public class DccerSecurity {
    ...
    public DccerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public DccerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public DccerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
