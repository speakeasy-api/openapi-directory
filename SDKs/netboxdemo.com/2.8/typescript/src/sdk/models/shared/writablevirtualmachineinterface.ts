...
export enum WritableVirtualMachineInterfaceModeEnum {
  Access = "access",
  Tagged = "tagged",
  TaggedAll = "tagged-all",
}

export enum WritableVirtualMachineInterfaceTypeEnum {
  Virtual = "virtual",
  Lag = "lag",
...
export class WritableVirtualMachineInterfaceInput extends SpeakeasyBase {
  @SpeakeasyMetadata()
