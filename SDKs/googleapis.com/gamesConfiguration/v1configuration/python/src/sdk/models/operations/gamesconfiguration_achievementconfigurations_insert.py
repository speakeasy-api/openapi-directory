...
class GamesConfigurationAchievementConfigurationsInsertRequest:
    ...
    achievement_configuration: Optional[shared_achievementconfiguration.AchievementConfiguration] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
