...
public class PolicytroubleshooterIamTroubleshootRequest {
    ...
    public openapisdk.models.shared.GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyRequest request;
    public PolicytroubleshooterIamTroubleshootRequest withRequest(openapisdk.models.shared.GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyRequest request) {
