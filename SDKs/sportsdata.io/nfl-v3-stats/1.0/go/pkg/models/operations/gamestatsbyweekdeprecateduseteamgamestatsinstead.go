...
func (e *GameStatsByWeekDeprecatedUseTeamGameStatsInsteadFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = GameStatsByWeekDeprecatedUseTeamGameStatsInsteadFormatEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GameStatsByWeekDeprecatedUseTeamGameStatsInsteadFormatEnum: %s", s)
	}
}
