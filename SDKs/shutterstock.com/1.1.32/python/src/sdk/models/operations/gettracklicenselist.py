...
class GetTrackLicenseListDownloadAvailabilityEnum(str, Enum):
...
class GetTrackLicenseListRequest:
    ...
    r"""Show licenses for the specified track ID"""  
    download_availability: Optional[GetTrackLicenseListDownloadAvailabilityEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'download_availability', 'style': 'form', 'explode': True }})
    r"""Filter licenses by download availability"""  
    ...
    r"""Restrict results by license. Prepending a `-` sign will exclude results by license"""  
