...
var InsightImpactGraphService = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: insightimpactgraphedge_1.InsightImpactGraphEdge }),
        (0, class_transformer_1.Expose)({ name: "Edges" }),
        (0, class_transformer_1.Type)(function () { return insightimpactgraphedge_1.InsightImpactGraphEdge; }),
