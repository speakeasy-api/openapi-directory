...
export class ManagedidentitiesProjectsLocationsGlobalDomainsBackupsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ManagedidentitiesProjectsLocationsGlobalDomainsBackupsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ManagedidentitiesProjectsLocationsGlobalDomainsBackupsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
