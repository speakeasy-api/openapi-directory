...
func (e *UpdateIdentityProviderRequestBodyIdentityProviderTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "SignInWithApple":
		fallthrough
	case "OIDC":
		*e = UpdateIdentityProviderRequestBodyIdentityProviderTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateIdentityProviderRequestBodyIdentityProviderTypeEnum: %s", s)
	}
}
