...
class CloudresourcemanagerProjectsListQueryParams:
...
class CloudresourcemanagerProjectsListRequest:
    query_params: CloudresourcemanagerProjectsListQueryParams = dataclasses.field()
    security: CloudresourcemanagerProjectsListSecurity = dataclasses.field()
