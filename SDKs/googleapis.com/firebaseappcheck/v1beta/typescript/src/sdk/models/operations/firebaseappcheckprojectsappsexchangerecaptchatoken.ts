...
export class FirebaseappcheckProjectsAppsExchangeRecaptchaTokenSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseappcheckProjectsAppsExchangeRecaptchaTokenSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class FirebaseappcheckProjectsAppsExchangeRecaptchaTokenSecurity extends SpeakeasyBase {
...
export class FirebaseappcheckProjectsAppsExchangeRecaptchaTokenRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseappcheckProjectsAppsExchangeRecaptchaTokenResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
