...
export declare class BranchRestrictionPolicyRestrictionsAppsOwner extends SpeakeasyBase {
    avatarUrl?: string;
    description?: string;
    eventsUrl?: string;
    hooksUrl?: string;
...
export declare class BranchRestrictionPolicyRestrictionsAppsPermissions extends SpeakeasyBase {
    contents?: string;
    issues?: string;
    metadata?: string;
    singleFile?: string;
}
export declare class BranchRestrictionPolicyRestrictionsApps extends SpeakeasyBase {
    createdAt?: string;
    description?: string;
    events?: string[];
    externalUrl?: string;
