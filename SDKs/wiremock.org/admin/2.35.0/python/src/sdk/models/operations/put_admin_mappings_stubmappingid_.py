...
class PutAdminMappingsStubMappingIDRequestBodyRequest:
    ...
    basic_auth_credentials: Optional[PutAdminMappingsStubMappingIDRequestBodyRequestBasicAuthCredentials] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('basicAuthCredentials'), 'exclude': lambda f: f is None }})
    r"""Pre-emptive basic auth credentials to match against"""  
...
class PutAdminMappingsStubMappingIDRequestBodyResponseDelayDistributionUniformTypeEnum(str, Enum):
    UNIFORM = 'uniform'
...
class PutAdminMappingsStubMappingIDRequestBodyResponseDelayDistributionUniform:
    ...
    type: Optional[PutAdminMappingsStubMappingIDRequestBodyResponseDelayDistributionUniformTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class PutAdminMappingsStubMappingIDRequestBodyResponseDelayDistributionLogNormalTypeEnum(str, Enum):
    LOGNORMAL = 'lognormal'
...
class PutAdminMappingsStubMappingIDRequestBodyResponseDelayDistributionLogNormal:
    ...
    type: Optional[PutAdminMappingsStubMappingIDRequestBodyResponseDelayDistributionLogNormalTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class PutAdminMappingsStubMappingIDRequestBodyResponse:
    ...
    fault: Optional[PutAdminMappingsStubMappingIDRequestBodyResponseFaultEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fault'), 'exclude': lambda f: f is None }})
    r"""The fault to apply (instead of a full, valid response)."""  
...
class PutAdminMappingsStubMappingIDRequestBody:
    ...
    request: Optional[PutAdminMappingsStubMappingIDRequestBodyRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('request'), 'exclude': lambda f: f is None }})  
    ...
    response: Optional[PutAdminMappingsStubMappingIDRequestBodyResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response'), 'exclude': lambda f: f is None }})  
...
class PutAdminMappingsStubMappingIDRequest:
    ...
    request_body: Optional[PutAdminMappingsStubMappingIDRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class PutAdminMappingsStubMappingID200ApplicationJSONRequest:
    ...
    basic_auth_credentials: Optional[PutAdminMappingsStubMappingID200ApplicationJSONRequestBasicAuthCredentials] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('basicAuthCredentials'), 'exclude': lambda f: f is None }})
    r"""Pre-emptive basic auth credentials to match against"""  
    body_patterns: Optional[list[dict[str, Any]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bodyPatterns'), 'exclude': lambda f: f is None }})
    r"""Request body patterns to match against in the <key>: { \\"<predicate>\\": \\"<value>\\" } form"""  
    cookies: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cookies'), 'exclude': lambda f: f is None }})
...
class PutAdminMappingsStubMappingID200ApplicationJSONResponseDelayDistributionUniformTypeEnum(str, Enum):
    UNIFORM = 'uniform'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PutAdminMappingsStubMappingID200ApplicationJSONResponseDelayDistributionUniform:
    r"""Uniformly distributed random response delay."""
    
    lower: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lower'), 'exclude': lambda f: f is None }})  
    type: Optional[PutAdminMappingsStubMappingID200ApplicationJSONResponseDelayDistributionUniformTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
    upper: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('upper'), 'exclude': lambda f: f is None }})  
    
class PutAdminMappingsStubMappingID200ApplicationJSONResponseDelayDistributionLogNormalTypeEnum(str, Enum):
    LOGNORMAL = 'lognormal'
...
class PutAdminMappingsStubMappingID200ApplicationJSONResponseDelayDistributionLogNormal:
    ...
    median: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('median'), 'exclude': lambda f: f is None }})  
    sigma: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sigma'), 'exclude': lambda f: f is None }})  
    type: Optional[PutAdminMappingsStubMappingID200ApplicationJSONResponseDelayDistributionLogNormalTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class PutAdminMappingsStubMappingID200ApplicationJSONResponse:
    ...
    delay_distribution: Optional[Any] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('delayDistribution'), 'exclude': lambda f: f is None }})
    r"""The delay distribution. Valid property configuration is either median/sigma/type or lower/type/upper."""  
    fault: Optional[PutAdminMappingsStubMappingID200ApplicationJSONResponseFaultEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fault'), 'exclude': lambda f: f is None }})
    r"""The fault to apply (instead of a full, valid response)."""  
    fixed_delay_milliseconds: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fixedDelayMilliseconds'), 'exclude': lambda f: f is None }})
    r"""Number of milliseconds to delay be before sending the response."""  
    from_configured_stub: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fromConfiguredStub'), 'exclude': lambda f: f is None }})
...
class PutAdminMappingsStubMappingID200ApplicationJSON:
    ...
    priority: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('priority'), 'exclude': lambda f: f is None }})
    r"""This stub mapping's priority relative to others. 1 is highest."""  
    request: Optional[PutAdminMappingsStubMappingID200ApplicationJSONRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('request'), 'exclude': lambda f: f is None }})  
    required_scenario_state: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('requiredScenarioState'), 'exclude': lambda f: f is None }})
    r"""The required state of the scenario in order for this stub to be matched."""  
    response: Optional[PutAdminMappingsStubMappingID200ApplicationJSONResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response'), 'exclude': lambda f: f is None }})  
    scenario_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('scenarioName'), 'exclude': lambda f: f is None }})
    r"""The name of the scenario that this stub mapping is part of"""  
    uuid: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('uuid'), 'exclude': lambda f: f is None }})
    r"""Alias for the id"""  
