...
var V1 = /** @class */ (function () {
     ...
     * set.
     */
    V1.prototype.servicebrokerGetIamPolicy = function (req, security, config) {
     ...
     */
    V1.prototype.servicebrokerSetIamPolicy = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    V1.prototype.servicebrokerTestIamPermissions = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
