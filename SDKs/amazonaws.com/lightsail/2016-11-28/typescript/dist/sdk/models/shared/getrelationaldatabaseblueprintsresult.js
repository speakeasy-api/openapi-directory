...
var GetRelationalDatabaseBlueprintsResult = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: relationaldatabaseblueprint_1.RelationalDatabaseBlueprint }),
        (0, class_transformer_1.Expose)({ name: "blueprints" }),
        (0, class_transformer_1.Type)(function () { return relationaldatabaseblueprint_1.RelationalDatabaseBlueprint; }),
